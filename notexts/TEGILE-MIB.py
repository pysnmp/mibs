...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:07:16 2021
...
NotificationType, Bits, Integer32, IpAddress, Counter32, ModuleIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, iso, ObjectIdentity, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Integer32", "IpAddress", "Counter32", "ModuleIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "iso", "ObjectIdentity", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSWriteMbps=shareCIFSWriteMbps, tegileArray_notifications=tegileArray_notifications, notificationReadingUnit=notificationReadingUnit, poolImported=poolImported, lunDataSizeLow=lunDataSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorNumber=notificationSensorNumber, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceName=haResourceName, projectLUNs=projectLUNs, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectCompressionEnabled=projectCompressionEnabled, volumeDeleteCompleted=volumeDeleteCompleted, nicTransmitMbps=nicTransmitMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, lunDataSizeHigh=lunDataSizeHigh, lunBlockSize=lunBlockSize, lunTargetGroup=lunTargetGroup, projectShareCount=projectShareCount, fcTargetReadMbps=fcTargetReadMbps, diskDataWriteMbps=diskDataWriteMbps, lunProjectName=lunProjectName, fcTargetName=fcTargetName, diskRandomIOCount=diskRandomIOCount, iscsiTargetAlias=iscsiTargetAlias, haControllerA_Name=haControllerA_Name, diskError=diskError, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolDeleted=poolDeleted, pools=pools, iscsiInitiatorEntry=iscsiInitiatorEntry, haResourceIndex=haResourceIndex, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, ipmiTemperature=ipmiTemperature, shareDeletionFailed=shareDeletionFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, replicationComplete=replicationComplete, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, ipmiMemory=ipmiMemory, lunWriteLatency=lunWriteLatency, diskDataWriteIops=diskDataWriteIops, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskPoolName=diskPoolName, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, poolAvgReadLatency=poolAvgReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareNFSReadIops=shareNFSReadIops, poolDataReadMbps=poolDataReadMbps, projectDeleted=projectDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationStarted=replicationStarted, replicationFailed=replicationFailed, fcInitiatorsTable=fcInitiatorsTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, upgradeFailed=upgradeFailed, diskAlias=diskAlias, diskChassisIdx=diskChassisIdx, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegileConformance=tegileConformance, userLoginFailed=userLoginFailed, iscsiTargetGroupError=iscsiTargetGroupError, iscsiTargetReadLatency=iscsiTargetReadLatency, shareNFSReadMbps=shareNFSReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, fcTargets=fcTargets, projectDataSizeLow=projectDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunReadIops=lunReadIops, haControllerB_Name=haControllerB_Name, haControllerB_Uptime=haControllerB_Uptime, haResourceActiveNode=haResourceActiveNode, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareNFSWriteMbps=shareNFSWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectQuotaSizeHigh=projectQuotaSizeHigh, shareCompressionEnabled=shareCompressionEnabled, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunEntry=lunEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, projectModified=projectModified, disks=disks, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cpuInterrupts=cpuInterrupts, diskTotalReadIops=diskTotalReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileArray=tegileArray, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolTotalSaving=poolTotalSaving, smisServiceStarted=smisServiceStarted, ntpServerTimeDrift=ntpServerTimeDrift, cacheTotalReadIops=cacheTotalReadIops, alertsCleanupCompleted=alertsCleanupCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunSizeHigh=lunSizeHigh, shareDataSizeHigh=shareDataSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, basicCompliance=basicCompliance, poolDataSizeHigh=poolDataSizeHigh, fcProperties=fcProperties, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTargets=iscsiTargets, diskAvgWriteLatency=diskAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAborted=replicationAborted, sharePoolName=sharePoolName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetIndex=fcTargetIndex, smisServiceStartFailed=smisServiceStartFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareMountPoint=shareMountPoint, fcAvgReadLatency=fcAvgReadLatency, replicationTargetDeleted=replicationTargetDeleted, replicationSourceRegistered=replicationSourceRegistered, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetName=iscsiTargetName, notificationSensorSuspect=notificationSensorSuspect, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectEntry=projectEntry, diskAvgReadLatency=diskAvgReadLatency, shareTable=shareTable, adServerTimeDrift=adServerTimeDrift, diskSizeHigh=diskSizeHigh, projectTable=projectTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, netbiosSocketFailure=netbiosSocketFailure, poolTotalWriteMbps=poolTotalWriteMbps, shareQuotaHigh=shareQuotaHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectDeletionFailed=projectDeletionFailed, deleteFolderFailed=deleteFolderFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunSizeLow=lunSizeLow, upgradeTimeout=upgradeTimeout, controllerUp=controllerUp, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalReadIops=poolTotalReadIops, fcTargetGroup=fcTargetGroup, fcInitiatorName=fcInitiatorName, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, sanProperties=sanProperties, shareQuotaFinished=shareQuotaFinished, lunReservedSizeHigh=lunReservedSizeHigh, projectIndex=projectIndex, lunName=lunName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunFreeSizeLow=lunFreeSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeLow=shareReservedSizeLow, fcPortOffline=fcPortOffline, snmpServiceStarted=snmpServiceStarted, snmpServiceStartFailed=snmpServiceStartFailed, cifsTotalReadIops=cifsTotalReadIops, projectPoolName=projectPoolName, diskSequentialIOCount=diskSequentialIOCount, controllerDown=controllerDown, fcPortOnline=fcPortOnline, snmpServiceStopFailed=snmpServiceStopFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, smbSocketFailure=smbSocketFailure, poolDataReadIops=poolDataReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cpuTotalUsage=cpuTotalUsage, lunWriteMbps=lunWriteMbps, poolMetaReadLatency=poolMetaReadLatency, lunTable=lunTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolTotalReadMbps=poolTotalReadMbps, fcTargetsTable=fcTargetsTable, lunGUID=lunGUID, iscsiTargetError=iscsiTargetError, aclMigrationCompleted=aclMigrationCompleted, diskType=diskType, notificationSensorAction=notificationSensorAction, lunReadMbps=lunReadMbps, volumeDeleteFailed=volumeDeleteFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunReadLatency=lunReadLatency, poolDataWriteMbps=poolDataWriteMbps, volumeModifyCompleted=volumeModifyCompleted, sensorFailureEvent=sensorFailureEvent, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheReadMbps=poolReadCacheReadMbps, projectShares=projectShares, poolEntry=poolEntry, ipmiPowerSupply=ipmiPowerSupply, iscsiProperties=iscsiProperties, fcInitiators=fcInitiators, poolExpanded=poolExpanded, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeCompleted=upgradeCompleted, lunPoolName=lunPoolName, snapshotCloningFailed=snapshotCloningFailed, ipmiVoltage=ipmiVoltage, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourcesTable=haResourcesTable, diskDataReadIops=diskDataReadIops, haResourceDescription=haResourceDescription, controllerHardwareModel=controllerHardwareModel, diskTotalWriteMbps=diskTotalWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, nicIndex=nicIndex, nicName=nicName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolUsedSizeHigh=poolUsedSizeHigh, poolProjectCount=poolProjectCount, nvdimmFailInitializationError=nvdimmFailInitializationError, poolMetaWriteIops=poolMetaWriteIops, aclMigrationStarted=aclMigrationStarted, networkInterfaceUp=networkInterfaceUp, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, deleteFolderCompleted=deleteFolderCompleted, poolReadCacheReadIops=poolReadCacheReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", poolExported=poolExported, targetGroupMemberRemoved=targetGroupMemberRemoved, ipmiOther=ipmiOther, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationSeverity=notificationSeverity, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notificationTime=notificationTime, poolReadCacheWriteMbps=poolReadCacheWriteMbps, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolUpgraded=poolUpgraded, poolProjects=poolProjects, tegileCompliances=tegileCompliances, nicReceiveMbps=nicReceiveMbps, lunReservedSizeLow=lunReservedSizeLow, shareName=shareName, nvdimmFailDeviceError=nvdimmFailDeviceError, upgradeDownloadCompleted=upgradeDownloadCompleted, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, diskTable=diskTable, shareCompressedRatio=shareCompressedRatio, lunIndex=lunIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDeletionFailed=poolDeletionFailed, shareCIFSReadLatency=shareCIFSReadLatency, shareDeleted=shareDeleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, PYSNMP_MODULE_ID=tegile, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolUsedSizeLow=poolUsedSizeLow, poolDataWriteLatency=poolDataWriteLatency, nicGroup=nicGroup, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haResourceGroup=haResourceGroup, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolHealth=poolHealth, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, memoryFailure=memoryFailure, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunProtocol=lunProtocol, diskDataReadMbps=diskDataReadMbps, shareDataSizeLow=shareDataSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, poolTotalWriteIops=poolTotalWriteIops, diskIOCount=diskIOCount, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeStarted=upgradeStarted, diskCount=diskCount, upgradeDownloadStarted=upgradeDownloadStarted, fcTotalWriteMbps=fcTotalWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, lunInitiatorGroup=lunInitiatorGroup, cacheTotalWriteIops=cacheTotalWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, currentNotificationGroup=currentNotificationGroup, snapshotDeleteFailed=snapshotDeleteFailed, targetGroupMemberAdded=targetGroupMemberAdded, poolDataSizeLow=poolDataSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, tegileGroups=tegileGroups, poolName=poolName, networkIpmpGroupUp=networkIpmpGroupUp, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolSizeHigh=poolSizeHigh, haResourceStatus=haResourceStatus, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, nvdimmFailSoftError=nvdimmFailSoftError, currentObjectGroup=currentObjectGroup, shareDedupEnabled=shareDedupEnabled, network=network, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskGoneOffline=diskGoneOffline, projectDataSizeHigh=projectDataSizeHigh, haResources=haResources, fcInitiatorEntry=fcInitiatorEntry, snmpServiceStopped=snmpServiceStopped, poolMetaWriteMbps=poolMetaWriteMbps, diskEntry=diskEntry, poolMetaReadIops=poolMetaReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDataWriteIops=poolDataWriteIops, poolFreeSizeLow=poolFreeSizeLow, projectDedupEnabled=projectDedupEnabled, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snapshotCreationFailed=snapshotCreationFailed, notificationDescription=notificationDescription, networkInterfaceDown=networkInterfaceDown, controllerTimeDrift=controllerTimeDrift, shareIndex=shareIndex, poolDegraded=poolDegraded, nicTable=nicTable, notificationEventCode=notificationEventCode, poolAvgWriteLatency=poolAvgWriteLatency, shareCIFSReadMbps=shareCIFSReadMbps, projectName=projectName, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationTargetEntityName=notificationTargetEntityName, replicationResumed=replicationResumed, projectLunCount=projectLunCount, nicEntry=nicEntry, shareNFSWriteIops=shareNFSWriteIops, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolSizeLow=poolSizeLow, diskSlowIo=diskSlowIo, projectFreeSizeLow=projectFreeSizeLow, notifications=notifications, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationObjects=notificationObjects, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunWriteIops=lunWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, ipmiFan=ipmiFan, notificationProps=notificationProps, poolCount=poolCount, lunCompressedRatio=lunCompressedRatio, fcTargetEntry=fcTargetEntry, fcTotalReadIops=fcTotalReadIops, poolIndex=poolIndex, projectQuotaFinished=projectQuotaFinished, properties=properties, fcTargetStatus=fcTargetStatus, iscsiTargetAuth=iscsiTargetAuth, poolCreated=poolCreated, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolTable=poolTable, fcTargetWriteIops=fcTargetWriteIops, diskTotalWriteIops=diskTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationAbandoned=replicationAbandoned, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskState=diskState, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareNFSEnabled=shareNFSEnabled, projectTotalSaving=projectTotalSaving, ipmiCurrent=ipmiCurrent, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetReadLatency=fcTargetReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, poolState=poolState, cacheRAMReads=cacheRAMReads, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nicMTU=nicMTU, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, unknownSensorEvent=unknownSensorEvent, replicationPaused=replicationPaused, notificationComponentName=notificationComponentName, projectQuotaSizeLow=projectQuotaSizeLow, smisServiceStopped=smisServiceStopped, iscsiInitiators=iscsiInitiators, haControllerA_IPAddr=haControllerA_IPAddr, nfsTotalReadIops=nfsTotalReadIops, poolOwnerController=poolOwnerController, nicState=nicState, diskIsOnline=diskIsOnline, fcTargetReadIops=fcTargetReadIops, globalStatistics=globalStatistics, iscsiTotalReadIops=iscsiTotalReadIops, iscsiWriteIops=iscsiWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetEntry=iscsiTargetEntry, poolDataReadLatency=poolDataReadLatency, lunDedupEnabled=lunDedupEnabled, diskSizeLow=diskSizeLow, tegile=tegile, diskIndex=diskIndex, iscsiTargetGroup=iscsiTargetGroup, cpuSystemCalls=cpuSystemCalls, poolReadCacheWriteIops=poolReadCacheWriteIops, shareQuotaLow=shareQuotaLow, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetIndex=iscsiTargetIndex, shareProjectName=shareProjectName, poolMetaReadMbps=poolMetaReadMbps, diskTotalReadMbps=diskTotalReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, testNotification=testNotification, lunCompressionEnabled=lunCompressionEnabled, shareEntry=shareEntry, cacheSSDReads=cacheSSDReads, fcAvgWriteLatency=fcAvgWriteLatency, shareNFSReadLatency=shareNFSReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectFreeSizeHigh=projectFreeSizeHigh)
