...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:36:02 2021
...
Unsigned32, Integer32, ObjectIdentity, Counter64, Counter32, TimeTicks, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, IpAddress, NotificationType, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "ObjectIdentity", "Counter64", "Counter32", "TimeTicks", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "IpAddress", "NotificationType", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunCompressionEnabled=lunCompressionEnabled, cifsTotalReadIops=cifsTotalReadIops, poolTotalSaving=poolTotalSaving, projectLUNs=projectLUNs, replicationFailed=replicationFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, lunDedupEnabled=lunDedupEnabled, nicName=nicName, replicationPaused=replicationPaused, notificationSensorNumber=notificationSensorNumber, fcTargetModifyCompleted=fcTargetModifyCompleted, lunTargetGroup=lunTargetGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, cacheRAMReads=cacheRAMReads, snmpServiceStarted=snmpServiceStarted, shareReservedSizeHigh=shareReservedSizeHigh, poolDataReadMbps=poolDataReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, projectSnapshotSizeLow=projectSnapshotSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationDescription=notificationDescription, ipmiCurrent=ipmiCurrent, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadIops=iscsiTargetReadIops, upgradeTimeout=upgradeTimeout, diskPoolName=diskPoolName, poolDataSizeLow=poolDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, lunSnapshotSizeHigh=lunSnapshotSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerA_Uptime=haControllerA_Uptime, haResourceStatus=haResourceStatus, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourcesTable=haResourcesTable, networkInterfaceDown=networkInterfaceDown, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeStarted=upgradeStarted, iscsiInitiatorsTable=iscsiInitiatorsTable, cpuInterrupts=cpuInterrupts, notificationReadingTriggerValue=notificationReadingTriggerValue, lunBlockSize=lunBlockSize, iscsiInitiatorChapUser=iscsiInitiatorChapUser, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetError=iscsiTargetError, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, smisServiceStopFailed=smisServiceStopFailed, projectTotalSaving=projectTotalSaving, shareEntry=shareEntry, shareCompressionEnabled=shareCompressionEnabled, shareQuotaHigh=shareQuotaHigh, diskSizeLow=diskSizeLow, projectModified=projectModified, lunCompressedRatio=lunCompressedRatio, diskChassisIdx=diskChassisIdx, diskDataReadMbps=diskDataReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationTargetEntityName=notificationTargetEntityName, haResourceGroup=haResourceGroup, projectDeleted=projectDeleted, iscsiTargetName=iscsiTargetName, poolUsedSizeHigh=poolUsedSizeHigh, lunIndex=lunIndex, diskState=diskState, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, aclMigrationCompleted=aclMigrationCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, pools=pools, projectIndex=projectIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectShares=projectShares, haControllerB_Uptime=haControllerB_Uptime, poolQuotaFinished=poolQuotaFinished, currentObjectGroup=currentObjectGroup, nicGroup=nicGroup, projectName=projectName, controllerHardwareModel=controllerHardwareModel, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetIndex=iscsiTargetIndex, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetWriteIops=iscsiTargetWriteIops, lunEntry=lunEntry, controllerUp=controllerUp, lunSizeHigh=lunSizeHigh, lunWriteIops=lunWriteIops, iscsiInitiatorName=iscsiInitiatorName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetAuth=iscsiTargetAuth, poolFreeSizeLow=poolFreeSizeLow, poolProjects=poolProjects, poolIndex=poolIndex, notificationTime=notificationTime, poolReadCacheWriteIops=poolReadCacheWriteIops, projectShareCount=projectShareCount, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolName=poolName, projectFreeSizeLow=projectFreeSizeLow, diskSizeHigh=diskSizeHigh, diskType=diskType, cifsAvgReadLatency=cifsAvgReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, fcTargetIndex=fcTargetIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, deleteFolderCompleted=deleteFolderCompleted, shareCIFSEnabled=shareCIFSEnabled, notificationObjects=notificationObjects, projectDataSizeHigh=projectDataSizeHigh, notificationReadingUnit=notificationReadingUnit, smisServiceStartFailed=smisServiceStartFailed, poolOwnerController=poolOwnerController, projectTable=projectTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunFreeSizeHigh=lunFreeSizeHigh, lunProjectName=lunProjectName, diskError=diskError, cpuSystemCalls=cpuSystemCalls, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectEntry=projectEntry, network=network, shareCIFSReadMbps=shareCIFSReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetAlias=iscsiTargetAlias, snapshotCloneCompleted=snapshotCloneCompleted, tegileConformance=tegileConformance, currentNotificationGroup=currentNotificationGroup, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetReadIops=fcTargetReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetEntry=fcTargetEntry, haControllerA_IPAddr=haControllerA_IPAddr, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunPoolName=lunPoolName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorIndex=fcInitiatorIndex, lunReadMbps=lunReadMbps, replicationSourceRegistered=replicationSourceRegistered, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolEntry=poolEntry, memoryFailure=memoryFailure, poolTotalReadMbps=poolTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSizeLow=lunSizeLow, shareNFSReadLatency=shareNFSReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, fcPortOnline=fcPortOnline, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, nfsTotalReadIops=nfsTotalReadIops, nicTransmitMbps=nicTransmitMbps, upgradeDownloadStarted=upgradeDownloadStarted, lunProtocol=lunProtocol, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, replicationComplete=replicationComplete, cpuTotalUsage=cpuTotalUsage, lunWriteLatency=lunWriteLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunFreeSizeLow=lunFreeSizeLow, diskEntry=diskEntry, lunInitiatorGroup=lunInitiatorGroup, snmpAgentVersion=snmpAgentVersion, shareDataSizeLow=shareDataSizeLow, nicIndex=nicIndex, poolTotalWriteMbps=poolTotalWriteMbps, userLoginFailed=userLoginFailed, fcInitiatorEntry=fcInitiatorEntry, lunReservedSizeLow=lunReservedSizeLow, testNotification=testNotification, fcTotalWriteMbps=fcTotalWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, spareDiskReplaced=spareDiskReplaced, shareCIFSWriteIops=shareCIFSWriteIops, snapshotCreationFailed=snapshotCreationFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargets=fcTargets, diskSlowIo=diskSlowIo, poolTotalWriteIops=poolTotalWriteIops, poolDataWriteMbps=poolDataWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTotalReadIops=iscsiTotalReadIops, nfsTotalWriteIops=nfsTotalWriteIops, poolCount=poolCount, tegileArray=tegileArray, haResourceName=haResourceName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, smisServiceStarted=smisServiceStarted, projectDedupEnabled=projectDedupEnabled, lunName=lunName, iscsiTargetGroup=iscsiTargetGroup, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetWriteIops=fcTargetWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectLunCount=projectLunCount, poolMetaReadMbps=poolMetaReadMbps, replicationResumed=replicationResumed, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolSizeLow=poolSizeLow, tegileArray_notifications=tegileArray_notifications, iscsiInitiators=iscsiInitiators, vmwareNFSDatastores=vmwareNFSDatastores, fcAvgReadLatency=fcAvgReadLatency, shareProjectName=shareProjectName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nvdimmFailSoftError=nvdimmFailSoftError, shareNFSReadIops=shareNFSReadIops, volumeDeleteCompleted=volumeDeleteCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, notificationProps=notificationProps, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDegraded=poolDegraded, iscsiTargetsTable=iscsiTargetsTable, poolReadCacheReadIops=poolReadCacheReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, networkTotalReceiveMbps=networkTotalReceiveMbps, cifsTotalReadMbps=cifsTotalReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, poolImported=poolImported, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotCloningFailed=snapshotCloningFailed, snmpServiceStopFailed=snmpServiceStopFailed, smbSocketFailure=smbSocketFailure, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolUsedSizeLow=poolUsedSizeLow, diskTotalReadMbps=diskTotalReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectCompressionEnabled=projectCompressionEnabled, notificationSensorAction=notificationSensorAction, poolSizeHigh=poolSizeHigh, poolProjectCount=poolProjectCount, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, snapshotRollbackFailed=snapshotRollbackFailed, poolMetaReadLatency=poolMetaReadLatency, diskTotalWriteIops=diskTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiWriteIops=iscsiWriteIops, poolTable=poolTable, sanProperties=sanProperties, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, poolExpanded=poolExpanded, diskIsOnline=diskIsOnline, projectDataSizeLow=projectDataSizeLow, basicCompliance=basicCompliance, lunSnapshotSizeLow=lunSnapshotSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiAvgReadLatency=iscsiAvgReadLatency, lunDataSizeLow=lunDataSizeLow, ipmiVoltage=ipmiVoltage, fcTargetsTable=fcTargetsTable, fcProperties=fcProperties, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationEventCode=notificationEventCode, replicationStarted=replicationStarted, nicReceiveMbps=nicReceiveMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataReadIops=poolDataReadIops, fcInitiatorGroup=fcInitiatorGroup, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpGroupUp=networkIpmpGroupUp, deleteFolderFailed=deleteFolderFailed, shareNFSReadMbps=shareNFSReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, poolDataReadLatency=poolDataReadLatency, diskIndex=diskIndex, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiators=fcInitiators, snapshotDeleteFailed=snapshotDeleteFailed, fcTotalReadIops=fcTotalReadIops, ipmiFan=ipmiFan, poolMetaWriteMbps=poolMetaWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareQuotaFinished=shareQuotaFinished, poolState=poolState, poolMetaWriteLatency=poolMetaWriteLatency, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskTable=diskTable, lunWriteMbps=lunWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, sensorFailureEvent=sensorFailureEvent, poolDataWriteIops=poolDataWriteIops, haResourceDescription=haResourceDescription, tegile=tegile, nicMTU=nicMTU, fcTargetName=fcTargetName, cifsTotalWriteIops=cifsTotalWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolHealth=poolHealth, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, adServerTimeDrift=adServerTimeDrift, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationAborted=replicationAborted, nvdimmFailDeviceError=nvdimmFailDeviceError, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareMountPoint=shareMountPoint, shareDataSizeHigh=shareDataSizeHigh, diskDataWriteMbps=diskDataWriteMbps, shareTable=shareTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSReadLatency=shareCIFSReadLatency, diskAvgReadLatency=diskAvgReadLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolFreeSizeHigh=poolFreeSizeHigh, globalStatistics=globalStatistics, fcPortOffline=fcPortOffline, lunReadLatency=lunReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskCount=diskCount, ipmiPowerSupply=ipmiPowerSupply, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskSequentialIOCount=diskSequentialIOCount, poolDeletionFailed=poolDeletionFailed, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetWriteMbps=fcTargetWriteMbps, shareNFSWriteIops=shareNFSWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiProperties=iscsiProperties, poolDataWriteLatency=poolDataWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, cacheTotalReadIops=cacheTotalReadIops, projectDeletionFailed=projectDeletionFailed, PYSNMP_MODULE_ID=tegile, shareNFSEnabled=shareNFSEnabled, projectQuotaFinished=projectQuotaFinished, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, replicationAbandoned=replicationAbandoned, ipmiMemory=ipmiMemory, poolExported=poolExported, notificationSeverity=notificationSeverity, notificationComponentName=notificationComponentName, haControllerB_Name=haControllerB_Name, iscsiTargets=iscsiTargets, haResources=haResources, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskTotalReadIops=diskTotalReadIops, cacheSSDReads=cacheSSDReads, tegileCompliances=tegileCompliances, fcTargetGroup=fcTargetGroup, controllerTimeDrift=controllerTimeDrift, smisServiceStopped=smisServiceStopped, shareQuotaLow=shareQuotaLow, poolAvgWriteLatency=poolAvgWriteLatency, shareCompressedRatio=shareCompressedRatio, shareCIFSReadIops=shareCIFSReadIops, nicTable=nicTable, shareIndex=shareIndex, cacheTotalWriteMbps=cacheTotalWriteMbps, networkInterfaceUp=networkInterfaceUp, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskRandomIOCount=diskRandomIOCount, netbiosSocketFailure=netbiosSocketFailure, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceIndex=haResourceIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, diskAlias=diskAlias, ipmiThreshold=ipmiThreshold, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, nicState=nicState, diskIOCount=diskIOCount, tegileGroups=tegileGroups, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, lunDataSizeHigh=lunDataSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, notificationSensorSuspect=notificationSensorSuspect, poolDeleted=poolDeleted, ipmiOther=ipmiOther, networkIpmpGroupDown=networkIpmpGroupDown, diskDataReadIops=diskDataReadIops, lunGUID=lunGUID, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, upgradeFailed=upgradeFailed, haResourceActiveNode=haResourceActiveNode, shareDeleted=shareDeleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareNFSWriteMbps=shareNFSWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, controllerDown=controllerDown, shareReservedSizeLow=shareReservedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, haControllerA_Name=haControllerA_Name, snmpServiceStopped=snmpServiceStopped, poolReadCacheReadLatency=poolReadCacheReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, fcTotalWriteIops=fcTotalWriteIops, notifications=notifications, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTotalReadMbps=iscsiTotalReadMbps, poolUpgraded=poolUpgraded, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiTemperature=ipmiTemperature, disks=disks, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTotalReadMbps=fcTotalReadMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolCreated=poolCreated, poolTotalReadIops=poolTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetEntry=iscsiTargetEntry, shareName=shareName, fcTargetStatus=fcTargetStatus, aclMigrationStarted=aclMigrationStarted, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetReadMbps=fcTargetReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, sharePoolName=sharePoolName, diskDataWriteIops=diskDataWriteIops, lunTable=lunTable, poolMetaReadIops=poolMetaReadIops, unknownSensorEvent=unknownSensorEvent, properties=properties, poolAvgReadLatency=poolAvgReadLatency, lunReadIops=lunReadIops, haResourceEntry=haResourceEntry, fcInitiatorName=fcInitiatorName, volumeDeleteFailed=volumeDeleteFailed, nicEntry=nicEntry, replicationTargetDeleted=replicationTargetDeleted, projectPoolName=projectPoolName)
