...
Counter32, ObjectIdentity, Counter64, iso, MibIdentifier, enterprises, IpAddress, Gauge32, TimeTicks, Bits, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Counter64", "iso", "MibIdentifier", "enterprises", "IpAddress", "Gauge32", "TimeTicks", "Bits", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", deleteFolderFailed=deleteFolderFailed, networkInterfaceDown=networkInterfaceDown, globalStatistics=globalStatistics, sensorFailureEvent=sensorFailureEvent, shareSnapshotSizeLow=shareSnapshotSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDedupEnabled=shareDedupEnabled, notificationReadingUnit=notificationReadingUnit, haResourceDescription=haResourceDescription, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorName=iscsiInitiatorName, poolDeleted=poolDeleted, diskDataReadMbps=diskDataReadMbps, projectModified=projectModified, tegileArray_notifications=tegileArray_notifications, fcTargetReadIops=fcTargetReadIops, smisServiceStartFailed=smisServiceStartFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareProjectName=shareProjectName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTotalReadIops=iscsiTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, upgradeDownloadStarted=upgradeDownloadStarted, notificationReadingTriggerValue=notificationReadingTriggerValue, lunProtocol=lunProtocol, fcInitiatorsTable=fcInitiatorsTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, cpuSystemCalls=cpuSystemCalls, diskAvgReadLatency=diskAvgReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolEntry=poolEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareDataSizeLow=shareDataSizeLow, poolDegraded=poolDegraded, netbiosSocketFailure=netbiosSocketFailure, snapshotDeleteFailed=snapshotDeleteFailed, volumeDeleteFailed=volumeDeleteFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargets=fcTargets, shareTable=shareTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunTargetGroup=lunTargetGroup, currentNotificationGroup=currentNotificationGroup, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, notificationObjects=notificationObjects, properties=properties, diskState=diskState, shareCIFSWriteIops=shareCIFSWriteIops, projectDataSizeHigh=projectDataSizeHigh, poolProjects=poolProjects, deleteFolderCompleted=deleteFolderCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskAlias=diskAlias, poolReadCacheReadLatency=poolReadCacheReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, adServerTimeDrift=adServerTimeDrift, cifsTotalReadMbps=cifsTotalReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorIndex=fcInitiatorIndex, notificationComponentName=notificationComponentName, diskIsOnline=diskIsOnline, basicCompliance=basicCompliance, lunTable=lunTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, networkIpmpGroupUp=networkIpmpGroupUp, projectQuotaSizeHigh=projectQuotaSizeHigh, projectDedupEnabled=projectDedupEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunDedupEnabled=lunDedupEnabled, lunDataSizeLow=lunDataSizeLow, diskRandomIOCount=diskRandomIOCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, diskSizeLow=diskSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, notificationSensorAction=notificationSensorAction, controllerDown=controllerDown, iscsiTargetsTable=iscsiTargetsTable, fcTargetWriteMbps=fcTargetWriteMbps, aclMigrationCompleted=aclMigrationCompleted, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourceEntry=haResourceEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolExpanded=poolExpanded, diskPoolName=diskPoolName, poolDataReadLatency=poolDataReadLatency, poolFreeSizeLow=poolFreeSizeLow, userLoginFailed=userLoginFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTotalWriteMbps=fcTotalWriteMbps, diskError=diskError, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationFailed=replicationFailed, projectName=projectName, shareCIFSEnabled=shareCIFSEnabled, ntpServerTimeDrift=ntpServerTimeDrift, unknownSensorEvent=unknownSensorEvent, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskChassisIdx=diskChassisIdx, poolDeletionFailed=poolDeletionFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskIOCount=diskIOCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolUsedSizeLow=poolUsedSizeLow, poolMetaReadIops=poolMetaReadIops, lunName=lunName, vmwareNFSDatastores=vmwareNFSDatastores, shareNFSWriteMbps=shareNFSWriteMbps, poolSizeLow=poolSizeLow, tegileArray=tegileArray, lunBlockSize=lunBlockSize, notificationSensorSuspect=notificationSensorSuspect, poolDataSizeLow=poolDataSizeLow, snmpServiceStopped=snmpServiceStopped, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiatorIndex=iscsiInitiatorIndex, fcProperties=fcProperties, cpuTotalUsage=cpuTotalUsage, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectQuotaSizeLow=projectQuotaSizeLow, diskType=diskType, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tegileCompliances=tegileCompliances, cacheTotalReadMbps=cacheTotalReadMbps, lunSizeLow=lunSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nicName=nicName, upgradeFailed=upgradeFailed, tegileConformance=tegileConformance, diskSlowIo=diskSlowIo, poolQuotaFinished=poolQuotaFinished, shareNFSEnabled=shareNFSEnabled, upgradeCompleted=upgradeCompleted, cacheRAMReads=cacheRAMReads, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolUsedSizeHigh=poolUsedSizeHigh, fcTotalReadMbps=fcTotalReadMbps, cifsTotalReadIops=cifsTotalReadIops, diskEntry=diskEntry, memoryFailure=memoryFailure, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectIndex=projectIndex, nfsTotalReadIops=nfsTotalReadIops, lunReadMbps=lunReadMbps, poolTotalWriteIops=poolTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, ipmiPowerSupply=ipmiPowerSupply, replicationTargetDeleted=replicationTargetDeleted, poolDataWriteMbps=poolDataWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, diskDataWriteMbps=diskDataWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetGroup=fcTargetGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolTotalWriteMbps=poolTotalWriteMbps, shareName=shareName, haResourceStatus=haResourceStatus, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolTotalReadMbps=poolTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, spareDiskReplaced=spareDiskReplaced, volumeQuotaFinished=volumeQuotaFinished, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolCount=poolCount, fcPortOffline=fcPortOffline, nicGroup=nicGroup, cpuInterrupts=cpuInterrupts, shareCIFSReadLatency=shareCIFSReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, replicationComplete=replicationComplete, projectShareCount=projectShareCount, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTotalWriteIops=fcTotalWriteIops, pools=pools, replicationPaused=replicationPaused, iscsiProperties=iscsiProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, controllerUp=controllerUp, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTargetName=fcTargetName, shareIndex=shareIndex, smisServiceStopFailed=smisServiceStopFailed, projectCompressionEnabled=projectCompressionEnabled, haControllerB_Uptime=haControllerB_Uptime, diskDataWriteIops=diskDataWriteIops, lunGUID=lunGUID, iscsiTargetGroupError=iscsiTargetGroupError, notificationProps=notificationProps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolMetaWriteIops=poolMetaWriteIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, haResources=haResources, replicationAborted=replicationAborted, iscsiAvgReadLatency=iscsiAvgReadLatency, notifications=notifications, shareCIFSWriteLatency=shareCIFSWriteLatency, currentObjectGroup=currentObjectGroup, iscsiTargetAlias=iscsiTargetAlias, cacheSSDReads=cacheSSDReads, shareCIFSReadIops=shareCIFSReadIops, lunWriteIops=lunWriteIops, diskGoneOffline=diskGoneOffline, shareEntry=shareEntry, nvdimmFailUnknownError=nvdimmFailUnknownError, poolTable=poolTable, nfsTotalWriteMbps=nfsTotalWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, projectShares=projectShares, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskTotalReadMbps=diskTotalReadMbps, ipmiThreshold=ipmiThreshold, nicIndex=nicIndex, tegile=tegile, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, poolSizeHigh=poolSizeHigh, diskTotalWriteIops=diskTotalWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, nicEntry=nicEntry, nfsTotalWriteIops=nfsTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", shareReservedSizeLow=shareReservedSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, notificationTime=notificationTime, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haResourceActiveNode=haResourceActiveNode, lunInitiatorGroup=lunInitiatorGroup, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, projectTotalSaving=projectTotalSaving, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, poolDataSizeHigh=poolDataSizeHigh, poolIndex=poolIndex, nfsTotalReadMbps=nfsTotalReadMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, lunWriteLatency=lunWriteLatency, iscsiTargetEntry=iscsiTargetEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDataWriteLatency=poolDataWriteLatency, fcTotalReadIops=fcTotalReadIops, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, notificationDescription=notificationDescription, diskSizeHigh=diskSizeHigh, haControllerA_Uptime=haControllerA_Uptime, diskIndex=diskIndex, projectDeletionFailed=projectDeletionFailed, projectFreeSizeLow=projectFreeSizeLow, lunCompressionEnabled=lunCompressionEnabled, diskDataReadIops=diskDataReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, projectEntry=projectEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, network=network, iscsiTargets=iscsiTargets, haResourcesTable=haResourcesTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, nicMTU=nicMTU, cacheTotalWriteIops=cacheTotalWriteIops, controllerTimeDrift=controllerTimeDrift, shareCompressionEnabled=shareCompressionEnabled, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, replicationResumed=replicationResumed, shareQuotaHigh=shareQuotaHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiVoltage=ipmiVoltage, smisServiceStarted=smisServiceStarted, fcTargetsTable=fcTargetsTable, fcTargetReadLatency=fcTargetReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectLunCount=projectLunCount, iscsiTargetName=iscsiTargetName, iscsiTargetGroup=iscsiTargetGroup, poolDataReadIops=poolDataReadIops, snmpServiceStartFailed=snmpServiceStartFailed, shareCIFSReadMbps=shareCIFSReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, notificationSensorNumber=notificationSensorNumber, fcTargetReadMbps=fcTargetReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, poolImported=poolImported, projectLUNs=projectLUNs, lunEntry=lunEntry, ipmiTemperature=ipmiTemperature, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunDataSizeHigh=lunDataSizeHigh, diskCount=diskCount, iscsiTargetReadIops=iscsiTargetReadIops, haResourceName=haResourceName, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareNFSReadIops=shareNFSReadIops, poolMetaReadMbps=poolMetaReadMbps, fcTargetStatus=fcTargetStatus, shareDeletionFailed=shareDeletionFailed, fcInitiators=fcInitiators, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunSizeHigh=lunSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiInitiators=iscsiInitiators, smbSocketFailure=smbSocketFailure, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, volumeDeleteCompleted=volumeDeleteCompleted, shareDataSizeHigh=shareDataSizeHigh, networkInterfaceUp=networkInterfaceUp, cifsAvgReadLatency=cifsAvgReadLatency, poolState=poolState, fcInitiatorEntry=fcInitiatorEntry, notificationTargetEntityName=notificationTargetEntityName, sharePoolName=sharePoolName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, replicationStarted=replicationStarted, nfsAvgReadLatency=nfsAvgReadLatency, upgradeStarted=upgradeStarted, poolExported=poolExported, fcTargetIndex=fcTargetIndex, alertsCleanupCompleted=alertsCleanupCompleted, smisServiceStopped=smisServiceStopped, haControllerA_Name=haControllerA_Name, poolTotalReadIops=poolTotalReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeTimeout=upgradeTimeout, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolOwnerController=poolOwnerController, nicReceiveMbps=nicReceiveMbps, nicTransmitMbps=nicTransmitMbps, poolName=poolName, poolAvgReadLatency=poolAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, shareCompressedRatio=shareCompressedRatio, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolProjectCount=poolProjectCount, fcTargetEntry=fcTargetEntry, shareQuotaLow=shareQuotaLow, poolMetaReadLatency=poolMetaReadLatency, lunReadIops=lunReadIops, diskTable=diskTable, nfsAvgWriteLatency=nfsAvgWriteLatency, controllerHardwareModel=controllerHardwareModel, nicTable=nicTable, poolDataWriteIops=poolDataWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, tegileGroups=tegileGroups, snmpServiceStarted=snmpServiceStarted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetError=iscsiTargetError, nvdimmFailSoftError=nvdimmFailSoftError, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTotalSaving=poolTotalSaving, sanProperties=sanProperties, poolCreated=poolCreated, volumeModifyCompleted=volumeModifyCompleted, lunReservedSizeLow=lunReservedSizeLow, lunWriteMbps=lunWriteMbps, haResourceIndex=haResourceIndex, iscsiTargetIndex=iscsiTargetIndex, snmpAgentVersion=snmpAgentVersion, snapshotCloningFailed=snapshotCloningFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, PYSNMP_MODULE_ID=tegile, projectDataSizeLow=projectDataSizeLow, aclMigrationStarted=aclMigrationStarted, snapshotRollbackCompleted=snapshotRollbackCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, disks=disks, projectFreeSizeHigh=projectFreeSizeHigh, lunReadLatency=lunReadLatency, replicationAbandoned=replicationAbandoned, replicationSourceRegistered=replicationSourceRegistered, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectQuotaFinished=projectQuotaFinished, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, poolMetaWriteMbps=poolMetaWriteMbps, fcPortOnline=fcPortOnline, shareNFSReadLatency=shareNFSReadLatency, diskSequentialIOCount=diskSequentialIOCount, targetGroupCreateCompleted=targetGroupCreateCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotCloneCompleted=snapshotCloneCompleted, upgradeDownloadFailed=upgradeDownloadFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, nicState=nicState, maintenanceModeDisabled=maintenanceModeDisabled, shareDeleted=shareDeleted, lunIndex=lunIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiOther=ipmiOther, lunSnapshotSizeLow=lunSnapshotSizeLow, projectTable=projectTable, fcTargetWriteIops=fcTargetWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, projectPoolName=projectPoolName, ipmiFan=ipmiFan, shareMountPoint=shareMountPoint, shareCreatedSuccessfully=shareCreatedSuccessfully, lunCompressedRatio=lunCompressedRatio, haResourceGroup=haResourceGroup, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, lunFreeSizeLow=lunFreeSizeLow, poolUpgraded=poolUpgraded, iscsiWriteIops=iscsiWriteIops, fcAvgReadLatency=fcAvgReadLatency, lunPoolName=lunPoolName, fcInitiatorName=fcInitiatorName, lunProjectName=lunProjectName, testNotification=testNotification, projectDeleted=projectDeleted, ipmiCurrent=ipmiCurrent, ipmiMemory=ipmiMemory, diagnosticDataUploaded=diagnosticDataUploaded, diskTotalReadIops=diskTotalReadIops, poolHealth=poolHealth, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationEventCode=notificationEventCode, notificationSeverity=notificationSeverity)
