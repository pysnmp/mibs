...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:50:34 2022
...
Unsigned32, Gauge32, ModuleIdentity, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Counter32, TimeTicks, NotificationType, Bits, IpAddress, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Counter32", "TimeTicks", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiProperties=iscsiProperties, diskSizeHigh=diskSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationProps=notificationProps, projectCompressionEnabled=projectCompressionEnabled, poolProjectCount=poolProjectCount, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerA_IPAddr=haControllerA_IPAddr, shareCIFSEnabled=shareCIFSEnabled, poolDegraded=poolDegraded, nvdimmFailSoftError=nvdimmFailSoftError, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, tegile=tegile, poolReadCacheWriteIops=poolReadCacheWriteIops, haResourceActiveNode=haResourceActiveNode, volumeDeleteFailed=volumeDeleteFailed, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectEntry=projectEntry, sanProperties=sanProperties, snapshotCreationFailed=snapshotCreationFailed, fcPortOnline=fcPortOnline, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolFreeSizeLow=poolFreeSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, cacheTotalReadIops=cacheTotalReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, shareIndex=shareIndex, networkInterfaceDown=networkInterfaceDown, poolDeletionFailed=poolDeletionFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, ipmiTemperature=ipmiTemperature, iscsiTargetsTable=iscsiTargetsTable, snapshotRollbackFailed=snapshotRollbackFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, replicationResumed=replicationResumed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskTotalReadMbps=diskTotalReadMbps, lunProtocol=lunProtocol, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCIFSWriteIops=shareCIFSWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, shareCompressedRatio=shareCompressedRatio, iscsiWriteIops=iscsiWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareNFSReadIops=shareNFSReadIops, smbSocketFailure=smbSocketFailure, fcPortOffline=fcPortOffline, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, webdocsUpgradeFailed=webdocsUpgradeFailed, poolTotalSaving=poolTotalSaving, shareCompressionEnabled=shareCompressionEnabled, lunEntry=lunEntry, replicationTargetDeleted=replicationTargetDeleted, nvdimmFailDeviceError=nvdimmFailDeviceError, projectTable=projectTable, diskPoolName=diskPoolName, replicationPaused=replicationPaused, iscsiTotalReadMbps=iscsiTotalReadMbps, fcInitiatorGroup=fcInitiatorGroup, snapshotCloningFailed=snapshotCloningFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskCount=diskCount, diskIndex=diskIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolTotalWriteIops=poolTotalWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetName=iscsiTargetName, ipmiThreshold=ipmiThreshold, snmpServiceStopped=snmpServiceStopped, cacheTotalReadMbps=cacheTotalReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunName=lunName, iscsiInitiatorIndex=iscsiInitiatorIndex, nicTable=nicTable, upgradeDownloadFailed=upgradeDownloadFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolExpanded=poolExpanded, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, poolQuotaFinished=poolQuotaFinished, poolDataWriteLatency=poolDataWriteLatency, currentObjectGroup=currentObjectGroup, tegileArray=tegileArray, iscsiTargetReadIops=iscsiTargetReadIops, lunDataSizeLow=lunDataSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, deleteFolderCompleted=deleteFolderCompleted, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiatorsTable=fcInitiatorsTable, ipmiFan=ipmiFan, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationSensorAction=notificationSensorAction, diskAlias=diskAlias, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTotalReadMbps=fcTotalReadMbps, lunTargetGroup=lunTargetGroup, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolUsedSizeLow=poolUsedSizeLow, poolTable=poolTable, lunTable=lunTable, notificationSeverity=notificationSeverity, projectQuotaFinished=projectQuotaFinished, lunReadMbps=lunReadMbps, haResourceEntry=haResourceEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeTimeout=tdpsUpgradeTimeout, volumeQuotaFinished=volumeQuotaFinished, tegileCompliances=tegileCompliances, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTargetsTable=fcTargetsTable, tegileGroups=tegileGroups, replicationAborted=replicationAborted, targetGroupMemberAdded=targetGroupMemberAdded, shareDataSizeHigh=shareDataSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, nicIndex=nicIndex, haResourceDescription=haResourceDescription, disks=disks, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, shareNFSReadMbps=shareNFSReadMbps, notificationObjects=notificationObjects, cifsTotalReadMbps=cifsTotalReadMbps, poolName=poolName, cifsAvgReadLatency=cifsAvgReadLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, poolTotalReadMbps=poolTotalReadMbps, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, lunCompressedRatio=lunCompressedRatio, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicState=nicState, replicationStarted=replicationStarted, poolReadCacheReadIops=poolReadCacheReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskDataWriteIops=diskDataWriteIops, lunWriteMbps=lunWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationComplete=replicationComplete, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskState=diskState, replicationAbandoned=replicationAbandoned, ntpServerTimeDrift=ntpServerTimeDrift, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetIndex=iscsiTargetIndex, haResources=haResources, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, fcAvgReadLatency=fcAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunGUID=lunGUID, smisServiceStartFailed=smisServiceStartFailed, poolDataReadIops=poolDataReadIops, controllerHardwareModel=controllerHardwareModel, fcInitiatorEntry=fcInitiatorEntry, snmpServiceStopFailed=snmpServiceStopFailed, testNotification=testNotification, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataReadMbps=poolDataReadMbps, diskRandomIOCount=diskRandomIOCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiInitiators=iscsiInitiators, volumeCreatedSuccessfully=volumeCreatedSuccessfully, aclMigrationStarted=aclMigrationStarted, ipmiOther=ipmiOther, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haControllerA_Uptime=haControllerA_Uptime, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunWriteLatency=lunWriteLatency, cpuTotalUsage=cpuTotalUsage, shareNFSReadLatency=shareNFSReadLatency, lunReservedSizeLow=lunReservedSizeLow, fcTargetReadIops=fcTargetReadIops, poolEntry=poolEntry, shareNFSWriteLatency=shareNFSWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, poolOwnerController=poolOwnerController, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, networkIpmpGroupDown=networkIpmpGroupDown, projectIndex=projectIndex, nicTransmitMbps=nicTransmitMbps, notificationReadingUnit=notificationReadingUnit, poolExported=poolExported, snapshotCloneCompleted=snapshotCloneCompleted, diskChassisIdx=diskChassisIdx, volumeDeleteCompleted=volumeDeleteCompleted, diskTotalWriteMbps=diskTotalWriteMbps, diskError=diskError, shareReservedSizeHigh=shareReservedSizeHigh, poolMetaWriteIops=poolMetaWriteIops, cacheRAMReads=cacheRAMReads, currentNotificationGroup=currentNotificationGroup, poolDataSizeLow=poolDataSizeLow, PYSNMP_MODULE_ID=tegile, sensorFailureEvent=sensorFailureEvent, lunSizeLow=lunSizeLow, lunCompressionEnabled=lunCompressionEnabled, snapshotDeleteFailed=snapshotDeleteFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, pools=pools, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSReadIops=shareCIFSReadIops, projectShareCount=projectShareCount, lunReadLatency=lunReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, smisServiceStopped=smisServiceStopped, ipmiCurrent=ipmiCurrent, lunDataSizeHigh=lunDataSizeHigh, iscsiTargetAuth=iscsiTargetAuth, fcTargets=fcTargets, shareDataSizeLow=shareDataSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetWriteLatency=fcTargetWriteLatency, poolMetaReadIops=poolMetaReadIops, projectFreeSizeLow=projectFreeSizeLow, diskIsOnline=diskIsOnline, haResourceGroup=haResourceGroup, shareDeleted=shareDeleted, shareProjectName=shareProjectName, nicMTU=nicMTU, notificationTime=notificationTime, controllerUp=controllerUp, basicCompliance=basicCompliance, lunFreeSizeLow=lunFreeSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskSizeLow=diskSizeLow, nicReceiveMbps=nicReceiveMbps, fcTargetWriteIops=fcTargetWriteIops, cpuSystemCalls=cpuSystemCalls, fcProperties=fcProperties, cacheTotalWriteMbps=cacheTotalWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", poolSizeLow=poolSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, cpuInterrupts=cpuInterrupts, nfsTotalWriteIops=nfsTotalWriteIops, diskTotalReadIops=diskTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, poolDeleted=poolDeleted, ipmiVoltage=ipmiVoltage, fcTargetReadLatency=fcTargetReadLatency, poolCreated=poolCreated, shareMountPoint=shareMountPoint, sharePoolName=sharePoolName, nfsTotalReadIops=nfsTotalReadIops, projectName=projectName, shareName=shareName, diskAvgWriteLatency=diskAvgWriteLatency, fcInitiators=fcInitiators, diskGoneOffline=diskGoneOffline, shareReservedSizeLow=shareReservedSizeLow, upgradeTimeout=upgradeTimeout, fcTotalWriteMbps=fcTotalWriteMbps, ipmiMemory=ipmiMemory, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSEnabled=shareNFSEnabled, upgradeCompleted=upgradeCompleted, lunProjectName=lunProjectName, fcTotalReadIops=fcTotalReadIops, upgradeFailed=upgradeFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerDown=controllerDown, upgradeDownloadStarted=upgradeDownloadStarted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerA_Name=haControllerA_Name, userLoginFailed=userLoginFailed, projectDataSizeHigh=projectDataSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataSizeHigh=poolDataSizeHigh, poolSizeHigh=poolSizeHigh, upgradeStarted=upgradeStarted, projectShares=projectShares, diskIOCount=diskIOCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectModified=projectModified, diskAvgReadLatency=diskAvgReadLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snmpAgentVersion=snmpAgentVersion, projectThresholdExceedWarning=projectThresholdExceedWarning, haControllerB_Uptime=haControllerB_Uptime, projectPoolName=projectPoolName, fcTargetEntry=fcTargetEntry, volumeModifyCompleted=volumeModifyCompleted, nicGroup=nicGroup, projectFreeSizeHigh=projectFreeSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetError=iscsiTargetError, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetIndex=fcTargetIndex, shareQuotaHigh=shareQuotaHigh, network=network, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunPoolName=lunPoolName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectDeleted=projectDeleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, projectLunCount=projectLunCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, notificationDescription=notificationDescription, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareCIFSReadLatency=shareCIFSReadLatency, poolHealth=poolHealth, poolDataReadLatency=poolDataReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, networkInterfaceUp=networkInterfaceUp, diskDataReadMbps=diskDataReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, haResourceStatus=haResourceStatus, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolMetaReadMbps=poolMetaReadMbps, lunBlockSize=lunBlockSize, shareDeletionFailed=shareDeletionFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunSizeHigh=lunSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunDedupEnabled=lunDedupEnabled, deleteFolderFailed=deleteFolderFailed, diskEntry=diskEntry, projectDeletionFailed=projectDeletionFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationComponentName=notificationComponentName, iscsiTargets=iscsiTargets, projectTotalSaving=projectTotalSaving, fcInitiatorName=fcInitiatorName, iscsiTargetAlias=iscsiTargetAlias, fcTargetWriteMbps=fcTargetWriteMbps, memoryFailure=memoryFailure, lunInitiatorGroup=lunInitiatorGroup, aclMigrationCompleted=aclMigrationCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolAvgReadLatency=poolAvgReadLatency, cifsTotalReadIops=cifsTotalReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolMetaWriteMbps=poolMetaWriteMbps, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTargetGroup=fcTargetGroup, smisServiceStarted=smisServiceStarted, diagnosticDataUploaded=diagnosticDataUploaded, tegileArray_notifications=tegileArray_notifications, poolTotalReadIops=poolTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, cacheSSDReads=cacheSSDReads, networkTotalTransmitMbps=networkTotalTransmitMbps, nicEntry=nicEntry, nfsAvgReadLatency=nfsAvgReadLatency, diskTable=diskTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareTable=shareTable, iscsiTargetGroup=iscsiTargetGroup, ipmiPowerSupply=ipmiPowerSupply, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationEventCode=notificationEventCode, poolUsedSizeHigh=poolUsedSizeHigh, properties=properties, poolCount=poolCount, diskSlowIo=diskSlowIo, notificationSensorSuspect=notificationSensorSuspect, haResourcesTable=haResourcesTable, poolDataWriteIops=poolDataWriteIops, fcTotalWriteIops=fcTotalWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareEntry=shareEntry, notifications=notifications, unknownSensorEvent=unknownSensorEvent, shareQuotaFinished=shareQuotaFinished, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, globalStatistics=globalStatistics, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskTotalWriteIops=diskTotalWriteIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceIndex=haResourceIndex, haResourceName=haResourceName, haControllerB_Name=haControllerB_Name, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolProjects=poolProjects, replicationSourceRegistered=replicationSourceRegistered, projectQuotaSizeHigh=projectQuotaSizeHigh, lunReadIops=lunReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, projectDataSizeLow=projectDataSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, replicationFailed=replicationFailed, iscsiTargetEntry=iscsiTargetEntry, snmpServiceStarted=snmpServiceStarted, poolState=poolState, nicName=nicName, spareDiskReplaced=spareDiskReplaced, targetGroupMemberRemoved=targetGroupMemberRemoved, shareDedupEnabled=shareDedupEnabled, poolIndex=poolIndex, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSWriteMbps=shareCIFSWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectLUNs=projectLUNs, shareCIFSWriteLatency=shareCIFSWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tegileConformance=tegileConformance, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorName=iscsiInitiatorName, fcTargetReadMbps=fcTargetReadMbps, poolImported=poolImported, nfsTotalWriteMbps=nfsTotalWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetName=fcTargetName, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskDataWriteMbps=diskDataWriteMbps, shareQuotaLow=shareQuotaLow, poolUpgraded=poolUpgraded, cacheTotalWriteIops=cacheTotalWriteIops, lunWriteIops=lunWriteIops, diskType=diskType, diskSequentialIOCount=diskSequentialIOCount, alertsCleanupCompleted=alertsCleanupCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, controllerTimeDrift=controllerTimeDrift, targetGroupCreateCompleted=targetGroupCreateCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunIndex=lunIndex)
