...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:45:44 2022
...
ObjectIdentity, TimeTicks, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, IpAddress, Integer32, Counter64, MibIdentifier, iso, ModuleIdentity, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", notificationThresholdTriggerValue=notificationThresholdTriggerValue, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationReadingUnit=notificationReadingUnit, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolState=poolState, diskSizeLow=diskSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, diskAvgReadLatency=diskAvgReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, lunProtocol=lunProtocol, diskGoneOffline=diskGoneOffline, diskIndex=diskIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolFreeSizeHigh=poolFreeSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, lunProjectName=lunProjectName, upgradeFailed=upgradeFailed, iscsiTargets=iscsiTargets, notificationSensorNumber=notificationSensorNumber, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicReceiveMbps=nicReceiveMbps, haResourcesTable=haResourcesTable, poolSizeLow=poolSizeLow, diskAlias=diskAlias, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, shareTable=shareTable, shareDedupEnabled=shareDedupEnabled, netbiosSocketFailure=netbiosSocketFailure, projectModified=projectModified, shareDeleted=shareDeleted, poolDataWriteMbps=poolDataWriteMbps, lunWriteIops=lunWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunWriteMbps=lunWriteMbps, haResourceGroup=haResourceGroup, poolExported=poolExported, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationStarted=replicationStarted, nfsAvgWriteLatency=nfsAvgWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorGroup=fcInitiatorGroup, replicationTargetDeleted=replicationTargetDeleted, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationPaused=replicationPaused, lunReservedSizeHigh=lunReservedSizeHigh, volumeDeleteFailed=volumeDeleteFailed, haControllerA_IPAddr=haControllerA_IPAddr, notificationSensorSuspect=notificationSensorSuspect, fcTotalReadMbps=fcTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolUsedSizeLow=poolUsedSizeLow, poolProjects=poolProjects, projectTable=projectTable, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, cifsTotalReadIops=cifsTotalReadIops, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskChassisIdx=diskChassisIdx, iscsiTargetWriteIops=iscsiTargetWriteIops, lunCompressedRatio=lunCompressedRatio, snapshotDeleteFailed=snapshotDeleteFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskError=diskError, fcTargetWriteIops=fcTargetWriteIops, diskDataReadIops=diskDataReadIops, lunInitiatorGroup=lunInitiatorGroup, fcInitiatorEntry=fcInitiatorEntry, nfsTotalReadMbps=nfsTotalReadMbps, lunIndex=lunIndex, notificationSensorAction=notificationSensorAction, shareCIFSWriteIops=shareCIFSWriteIops, haResourceIndex=haResourceIndex, sharePoolName=sharePoolName, tegileCompliances=tegileCompliances, cifsTotalWriteMbps=cifsTotalWriteMbps, cpuTotalUsage=cpuTotalUsage, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationComponentName=notificationComponentName, shareNFSWriteLatency=shareNFSWriteLatency, cpuSystemCalls=cpuSystemCalls, iscsiInitiators=iscsiInitiators, lunBlockSize=lunBlockSize, fcInitiators=fcInitiators, shareMountPoint=shareMountPoint, haControllerB_Uptime=haControllerB_Uptime, currentObjectGroup=currentObjectGroup, poolUpgraded=poolUpgraded, fcTargets=fcTargets, smbSocketFailure=smbSocketFailure, ipmiFan=ipmiFan, cifsTotalWriteIops=cifsTotalWriteIops, notifications=notifications, shareCompressionEnabled=shareCompressionEnabled, shareCompressedRatio=shareCompressedRatio, snmpServiceStartFailed=snmpServiceStartFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, shareDataSizeLow=shareDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTotalReadIops=fcTotalReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tegileGroups=tegileGroups, poolOwnerController=poolOwnerController, snapshotCreationFailed=snapshotCreationFailed, nicTransmitMbps=nicTransmitMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, notificationTargetEntityName=notificationTargetEntityName, networkInterfaceDown=networkInterfaceDown, upgradeDownloadStarted=upgradeDownloadStarted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, lunCompressionEnabled=lunCompressionEnabled, diskTotalReadIops=diskTotalReadIops, shareNFSReadLatency=shareNFSReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, haResourceEntry=haResourceEntry, notificationEventCode=notificationEventCode, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResourceActiveNode=haResourceActiveNode, nfsTotalReadIops=nfsTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, fcPortOffline=fcPortOffline, projectPoolName=projectPoolName, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolTotalWriteIops=poolTotalWriteIops, ipmiCurrent=ipmiCurrent, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, memoryFailure=memoryFailure, haResourceDescription=haResourceDescription, testNotification=testNotification, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunSizeHigh=lunSizeHigh, adServerTimeDrift=adServerTimeDrift, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareName=shareName, fcPortOnline=fcPortOnline, targetGroupMemberRemoved=targetGroupMemberRemoved, smisServiceStarted=smisServiceStarted, lunEntry=lunEntry, shareNFSWriteIops=shareNFSWriteIops, lunSizeLow=lunSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, networkInterfaceUp=networkInterfaceUp, diskAvgWriteLatency=diskAvgWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiMemory=ipmiMemory, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, snmpServiceStarted=snmpServiceStarted, tegileArray_notifications=tegileArray_notifications, iscsiTargetAuth=iscsiTargetAuth, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiTargetIndex=iscsiTargetIndex, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunTargetGroup=lunTargetGroup, diskSlowIo=diskSlowIo, iscsiTargetName=iscsiTargetName, nicTable=nicTable, poolDataReadIops=poolDataReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectIndex=projectIndex, lunWriteLatency=lunWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareQuotaHigh=shareQuotaHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskDataWriteMbps=diskDataWriteMbps, tegileConformance=tegileConformance, iscsiInitiatorEntry=iscsiInitiatorEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskSizeHigh=diskSizeHigh, deleteFolderFailed=deleteFolderFailed, poolIndex=poolIndex, projectDataSizeHigh=projectDataSizeHigh, nicName=nicName, smisServiceStopFailed=smisServiceStopFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskTable=diskTable, deleteFolderCompleted=deleteFolderCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationResumed=replicationResumed, projectDedupEnabled=projectDedupEnabled, pools=pools, diskIOCount=diskIOCount, nicGroup=nicGroup, diskTotalWriteMbps=diskTotalWriteMbps, replicationComplete=replicationComplete, sanProperties=sanProperties, fcProperties=fcProperties, fcInitiatorIndex=fcInitiatorIndex, diskIsOnline=diskIsOnline, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, aclMigrationStarted=aclMigrationStarted, userLoginFailed=userLoginFailed, poolAvgReadLatency=poolAvgReadLatency, sensorFailureEvent=sensorFailureEvent, poolUsedSizeHigh=poolUsedSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetWriteLatency=fcTargetWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, smisServiceStopped=smisServiceStopped, fcTargetReadLatency=fcTargetReadLatency, projectFreeSizeLow=projectFreeSizeLow, controllerTimeDrift=controllerTimeDrift, lunFreeSizeLow=lunFreeSizeLow, poolExpanded=poolExpanded, poolHealth=poolHealth, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcAvgReadLatency=fcAvgReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalReadMbps=poolTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, ipmiPowerSupply=ipmiPowerSupply, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunDataSizeHigh=lunDataSizeHigh, shareQuotaLow=shareQuotaLow, haResourceStatus=haResourceStatus)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, volumeQuotaFinished=volumeQuotaFinished, poolQuotaFinished=poolQuotaFinished, ipmiOther=ipmiOther, nvdimmFailUnknownError=nvdimmFailUnknownError, nicIndex=nicIndex, projectEntry=projectEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetStatus=fcTargetStatus, diskDataReadMbps=diskDataReadMbps, replicationAbandoned=replicationAbandoned, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, poolDeletionFailed=poolDeletionFailed, nfsTotalWriteIops=nfsTotalWriteIops, projectName=projectName, iscsiTargetReadLatency=iscsiTargetReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, PYSNMP_MODULE_ID=tegile, poolMetaReadMbps=poolMetaReadMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, projectShareCount=projectShareCount, shareDeletionFailed=shareDeletionFailed, lunReadLatency=lunReadLatency, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeStarted=upgradeStarted, haControllerB_Name=haControllerB_Name, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareProjectName=shareProjectName, projectLunCount=projectLunCount, maintenanceModeEnabled=maintenanceModeEnabled, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheSSDReads=cacheSSDReads, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, cpuInterrupts=cpuInterrupts, projectQuotaSizeHigh=projectQuotaSizeHigh, basicCompliance=basicCompliance, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetsTable=fcTargetsTable, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, haControllerA_Name=haControllerA_Name, diskTotalReadMbps=diskTotalReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nicMTU=nicMTU, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolCount=poolCount, diskPoolName=diskPoolName, projectTotalSaving=projectTotalSaving, notificationProps=notificationProps, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, smisServiceStartFailed=smisServiceStartFailed, haControllerA_Uptime=haControllerA_Uptime, shareCIFSEnabled=shareCIFSEnabled, notificationTime=notificationTime, vmwareNFSDatastores=vmwareNFSDatastores, snmpServiceStopFailed=snmpServiceStopFailed, poolName=poolName, poolDataSizeHigh=poolDataSizeHigh, poolProjectCount=poolProjectCount, projectCompressionEnabled=projectCompressionEnabled, diskCount=diskCount, upgradeDownloadCompleted=upgradeDownloadCompleted, disks=disks, lunReservedSizeLow=lunReservedSizeLow, iscsiProperties=iscsiProperties, notificationSeverity=notificationSeverity, iscsiTargetError=iscsiTargetError, shareNFSEnabled=shareNFSEnabled, iscsiTargetsTable=iscsiTargetsTable, upgradeTimeout=upgradeTimeout, poolDegraded=poolDegraded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, poolMetaWriteMbps=poolMetaWriteMbps, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectShares=projectShares, diskType=diskType, iscsiInitiatorName=iscsiInitiatorName, fcTargetModifyCompleted=fcTargetModifyCompleted, lunReadMbps=lunReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolMetaReadLatency=poolMetaReadLatency, shareQuotaFinished=shareQuotaFinished, networkTotalReceiveMbps=networkTotalReceiveMbps, haResourceName=haResourceName, projectQuotaSizeLow=projectQuotaSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, tegileArray=tegileArray, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDeletionFailed=projectDeletionFailed, controllerDown=controllerDown, ipmiThreshold=ipmiThreshold, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haResources=haResources, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationAborted=replicationAborted, poolCreated=poolCreated, controllerHardwareModel=controllerHardwareModel, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, unknownSensorEvent=unknownSensorEvent, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolDeleted=poolDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, controllerUp=controllerUp, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskState=diskState, iscsiTargetGroupError=iscsiTargetGroupError, notificationDescription=notificationDescription, projectCreatedSuccessfully=projectCreatedSuccessfully, shareIndex=shareIndex, fcTargetName=fcTargetName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, targetGroupMemberAdded=targetGroupMemberAdded, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cacheRAMReads=cacheRAMReads, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, tegile=tegile, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareEntry=shareEntry, projectLUNs=projectLUNs, diskEntry=diskEntry, projectFreeSizeHigh=projectFreeSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, lunDataSizeLow=lunDataSizeLow, poolTotalSaving=poolTotalSaving, poolDataReadMbps=poolDataReadMbps, fcInitiatorName=fcInitiatorName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, fcTargetGroup=fcTargetGroup, poolTotalWriteMbps=poolTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, aclMigrationCompleted=aclMigrationCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, ipmiVoltage=ipmiVoltage, networkTotalTransmitMbps=networkTotalTransmitMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolEntry=poolEntry, fcTotalWriteIops=fcTotalWriteIops, replicationFailed=replicationFailed, poolSizeHigh=poolSizeHigh, properties=properties, haControllerB_IPAddr=haControllerB_IPAddr, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTable=poolTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, snapshotCloningFailed=snapshotCloningFailed, diskDataWriteIops=diskDataWriteIops, lunReadIops=lunReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetReadMbps=fcTargetReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, cacheTotalReadIops=cacheTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTotalWriteMbps=fcTotalWriteMbps, lunPoolName=lunPoolName, iscsiWriteIops=iscsiWriteIops, nicEntry=nicEntry, projectQuotaFinished=projectQuotaFinished, fcTargetReadIops=fcTargetReadIops, ipmiTemperature=ipmiTemperature, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, spareDiskReplaced=spareDiskReplaced, tdpsUpgradeFailed=tdpsUpgradeFailed, poolMetaReadIops=poolMetaReadIops, lunName=lunName, network=network, projectDeleted=projectDeleted, fcTargetIndex=fcTargetIndex, diskTotalWriteIops=diskTotalWriteIops, fcInitiatorsTable=fcInitiatorsTable, lunGUID=lunGUID, poolImported=poolImported, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetGroup=iscsiTargetGroup, nfsAvgReadLatency=nfsAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareNFSReadIops=shareNFSReadIops, poolTotalReadIops=poolTotalReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, replicationSourceRegistered=replicationSourceRegistered, globalStatistics=globalStatistics, notificationObjects=notificationObjects, lunDedupEnabled=lunDedupEnabled, nfsTotalWriteMbps=nfsTotalWriteMbps, upgradeCompleted=upgradeCompleted, snapshotCloneCompleted=snapshotCloneCompleted, poolDataReadLatency=poolDataReadLatency, nicState=nicState, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunTable=lunTable)
