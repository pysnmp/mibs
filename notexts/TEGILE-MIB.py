...
NotificationType, ObjectIdentity, Gauge32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Unsigned32, ModuleIdentity, Integer32, iso, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Gauge32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "Bits", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", cacheTotalWriteMbps=cacheTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, lunWriteIops=lunWriteIops, lunTargetGroup=lunTargetGroup, poolOwnerController=poolOwnerController, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectName=projectName, deleteFolderCompleted=deleteFolderCompleted, poolDataSizeHigh=poolDataSizeHigh, haControllerA_Name=haControllerA_Name, aclMigrationCompleted=aclMigrationCompleted, notificationEventCode=notificationEventCode, ipmiMemory=ipmiMemory, basicCompliance=basicCompliance, diskTotalWriteMbps=diskTotalWriteMbps, shareProjectName=shareProjectName, snapshotCloningFailed=snapshotCloningFailed, projectTable=projectTable, fcTargetWriteLatency=fcTargetWriteLatency, poolSizeLow=poolSizeLow, fcTargets=fcTargets, lunProjectName=lunProjectName, shareDeleted=shareDeleted, iscsiWriteIops=iscsiWriteIops, poolState=poolState, ipmiFan=ipmiFan, diskSequentialIOCount=diskSequentialIOCount, shareDataSizeHigh=shareDataSizeHigh, tegileArray=tegileArray, nfsTotalReadIops=nfsTotalReadIops, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskError=diskError, controllerUp=controllerUp, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, upgradeStarted=upgradeStarted, shareEntry=shareEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cifsAvgWriteLatency=cifsAvgWriteLatency, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskAvgReadLatency=diskAvgReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, lunDataSizeHigh=lunDataSizeHigh, nicIndex=nicIndex, shareCompressionEnabled=shareCompressionEnabled, diskAvgWriteLatency=diskAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationSensorAction=notificationSensorAction, fcPortOffline=fcPortOffline, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolTotalWriteMbps=poolTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, nicTransmitMbps=nicTransmitMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolUsedSizeLow=poolUsedSizeLow, shareCIFSReadIops=shareCIFSReadIops, fcAvgWriteLatency=fcAvgWriteLatency, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationComponentName=notificationComponentName, sensorFailureEvent=sensorFailureEvent, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haResources=haResources, poolTotalReadIops=poolTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, shareDeletionFailed=shareDeletionFailed, shareQuotaLow=shareQuotaLow, networkTotalTransmitMbps=networkTotalTransmitMbps, tegile=tegile, lunEntry=lunEntry, diskIOCount=diskIOCount, ipmiCurrent=ipmiCurrent, iscsiAvgReadLatency=iscsiAvgReadLatency, poolMetaReadIops=poolMetaReadIops, nicTable=nicTable, snapshotCreationFailed=snapshotCreationFailed, ipmiThreshold=ipmiThreshold, fcTotalReadIops=fcTotalReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, snmpServiceStartFailed=snmpServiceStartFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteMbps=poolDataWriteMbps, sanProperties=sanProperties, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haControllerA_Uptime=haControllerA_Uptime, lunBlockSize=lunBlockSize, fcInitiatorName=fcInitiatorName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, controllerDown=controllerDown, fcTargetStatus=fcTargetStatus, poolTotalWriteIops=poolTotalWriteIops, nicEntry=nicEntry, replicationPaused=replicationPaused, poolHealth=poolHealth, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, currentNotificationGroup=currentNotificationGroup, snmpServiceStopped=snmpServiceStopped, nfsTotalWriteMbps=nfsTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareDedupEnabled=shareDedupEnabled, snapshotCloneCompleted=snapshotCloneCompleted, poolDataWriteLatency=poolDataWriteLatency, netbiosSocketFailure=netbiosSocketFailure, notificationDescription=notificationDescription, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorName=iscsiInitiatorName, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetsTable=fcTargetsTable, shareCIFSReadMbps=shareCIFSReadMbps, shareDataSizeLow=shareDataSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, PYSNMP_MODULE_ID=tegile, notificationTargetEntityName=notificationTargetEntityName, projectCreatedSuccessfully=projectCreatedSuccessfully, shareNFSReadIops=shareNFSReadIops, lunFreeSizeLow=lunFreeSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareMountPoint=shareMountPoint, projectDeletionFailed=projectDeletionFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataReadIops=poolDataReadIops, lunTable=lunTable, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetWriteIops=iscsiTargetWriteIops, deleteFolderFailed=deleteFolderFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, projectLunCount=projectLunCount, poolReadCacheReadLatency=poolReadCacheReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetEntry=iscsiTargetEntry, poolEntry=poolEntry, shareNFSReadLatency=shareNFSReadLatency, network=network, fcInitiators=fcInitiators, shareReservedSizeLow=shareReservedSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskDataReadIops=diskDataReadIops, volumeModifyCompleted=volumeModifyCompleted, haControllerB_IPAddr=haControllerB_IPAddr, cacheTotalReadMbps=cacheTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargets=iscsiTargets, replicationStarted=replicationStarted, ipmiPowerSupply=ipmiPowerSupply, cacheRAMReads=cacheRAMReads, poolQuotaFinished=poolQuotaFinished, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectQuotaSizeLow=projectQuotaSizeLow, ipmiTemperature=ipmiTemperature, diskRandomIOCount=diskRandomIOCount, snmpServiceStarted=snmpServiceStarted, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, globalStatistics=globalStatistics, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haControllerB_Uptime=haControllerB_Uptime, lunReadMbps=lunReadMbps, cacheTotalReadIops=cacheTotalReadIops, projectTotalSaving=projectTotalSaving, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cacheSSDReads=cacheSSDReads, sharePoolName=sharePoolName, lunInitiatorGroup=lunInitiatorGroup, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorEntry=fcInitiatorEntry, diskIsOnline=diskIsOnline, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, poolDeletionFailed=poolDeletionFailed, shareName=shareName, lunReadIops=lunReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaWriteIops=poolMetaWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareTable=shareTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunIndex=lunIndex, adServerTimeDrift=adServerTimeDrift, fcTargetIndex=fcTargetIndex, haResourceStatus=haResourceStatus, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskTotalReadIops=diskTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, volumeQuotaFinished=volumeQuotaFinished, lunPoolName=lunPoolName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetReadIops=fcTargetReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haControllerA_IPAddr=haControllerA_IPAddr, haResourceEntry=haResourceEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationSeverity=notificationSeverity, lunReadLatency=lunReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationAborted=replicationAborted, projectCompressionEnabled=projectCompressionEnabled, diskIndex=diskIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetsTable=iscsiTargetsTable, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareQuotaFinished=shareQuotaFinished, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiVoltage=ipmiVoltage, fcInitiatorsTable=fcInitiatorsTable, iscsiTargetName=iscsiTargetName, projectDeleted=projectDeleted, notificationObjects=notificationObjects, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetIndex=iscsiTargetIndex, haControllerB_Name=haControllerB_Name, nicName=nicName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetGroupError=iscsiTargetGroupError, diskAlias=diskAlias, shareNFSEnabled=shareNFSEnabled, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDeleted=poolDeleted, diskType=diskType, lunWriteLatency=lunWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, diskPoolName=diskPoolName, poolUpgraded=poolUpgraded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunReservedSizeLow=lunReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, fcTargetName=fcTargetName)
mibBuilder.exportSymbols("TEGILE-MIB", unknownSensorEvent=unknownSensorEvent, shareCIFSWriteIops=shareCIFSWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, replicationFailed=replicationFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, fcProperties=fcProperties, tdpsUpgradeFailed=tdpsUpgradeFailed, smisServiceStarted=smisServiceStarted, iscsiTargetGroup=iscsiTargetGroup, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolSizeHigh=poolSizeHigh, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTotalReadMbps=fcTotalReadMbps, upgradeTimeout=upgradeTimeout, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDataWriteIops=poolDataWriteIops, diskSlowIo=diskSlowIo, projectModified=projectModified, lunWriteMbps=lunWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDegraded=poolDegraded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetReadLatency=fcTargetReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, iscsiProperties=iscsiProperties, poolMetaWriteMbps=poolMetaWriteMbps, notificationSensorNumber=notificationSensorNumber, tegileArray_notifications=tegileArray_notifications, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, networkInterfaceDown=networkInterfaceDown, shareSnapshotSizeLow=shareSnapshotSizeLow, diskCount=diskCount, controllerTimeDrift=controllerTimeDrift, fcPortOnline=fcPortOnline, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolTotalSaving=poolTotalSaving, poolExpanded=poolExpanded, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolTotalReadMbps=poolTotalReadMbps, projectShares=projectShares, lunCompressedRatio=lunCompressedRatio, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, smisServiceStartFailed=smisServiceStartFailed, poolAvgReadLatency=poolAvgReadLatency, poolCreated=poolCreated, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeFailed=upgradeFailed, spareDiskReplaced=spareDiskReplaced, smbSocketFailure=smbSocketFailure, shareCIFSEnabled=shareCIFSEnabled, projectDataSizeHigh=projectDataSizeHigh, pools=pools, iscsiTargetAlias=iscsiTargetAlias, notificationProps=notificationProps, diskTotalReadMbps=diskTotalReadMbps, poolDataReadMbps=poolDataReadMbps, aclMigrationStarted=aclMigrationStarted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationAbandoned=replicationAbandoned, shareIndex=shareIndex, projectSnapshotSizeLow=projectSnapshotSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcInitiatorGroup=fcInitiatorGroup, poolAvgWriteLatency=poolAvgWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, shareReservedSizeHigh=shareReservedSizeHigh, diskState=diskState, poolProjects=poolProjects, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nicReceiveMbps=nicReceiveMbps, haResourceName=haResourceName, projectPoolName=projectPoolName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTotalWriteIops=fcTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, replicationTargetDeleted=replicationTargetDeleted, nicState=nicState, fcTargetWriteIops=fcTargetWriteIops, projectDedupEnabled=projectDedupEnabled, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceGroup=haResourceGroup, poolImported=poolImported, lunProtocol=lunProtocol, fcAvgReadLatency=fcAvgReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diagnosticDataUploaded=diagnosticDataUploaded, shareCompressedRatio=shareCompressedRatio, iscsiInitiatorsTable=iscsiInitiatorsTable, tegileGroups=tegileGroups, diskEntry=diskEntry, nfsTotalWriteIops=nfsTotalWriteIops, poolName=poolName, memoryFailure=memoryFailure, diskSizeLow=diskSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunDataSizeLow=lunDataSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, ntpServerTimeDrift=ntpServerTimeDrift, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectQuotaFinished=projectQuotaFinished, snmpServiceStopFailed=snmpServiceStopFailed, lunGUID=lunGUID, shareQuotaHigh=shareQuotaHigh, shareNFSReadMbps=shareNFSReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, properties=properties, cpuSystemCalls=cpuSystemCalls, nvdimmFailSoftError=nvdimmFailSoftError, networkIpmpGroupUp=networkIpmpGroupUp, nfsTotalReadMbps=nfsTotalReadMbps, haResourceIndex=haResourceIndex, poolExported=poolExported, projectLUNs=projectLUNs, lunSizeLow=lunSizeLow, ipmiOther=ipmiOther, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunSizeHigh=lunSizeHigh, diskDataReadMbps=diskDataReadMbps, disks=disks, cpuInterrupts=cpuInterrupts, cifsTotalWriteIops=cifsTotalWriteIops, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationReadingTriggerValue=notificationReadingTriggerValue, projectIndex=projectIndex, notifications=notifications, poolCount=poolCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiTargetError=iscsiTargetError, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationTime=notificationTime, iscsiTotalReadIops=iscsiTotalReadIops, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolProjectCount=poolProjectCount, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationReadingUnit=notificationReadingUnit, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, cifsTotalReadIops=cifsTotalReadIops, poolDataReadLatency=poolDataReadLatency, poolMetaReadMbps=poolMetaReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, lunName=lunName, upgradeCompleted=upgradeCompleted, userLoginFailed=userLoginFailed, haResourcesTable=haResourcesTable, haResourceActiveNode=haResourceActiveNode, diskGoneOffline=diskGoneOffline, replicationResumed=replicationResumed, diskTable=diskTable, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiatorIndex=fcInitiatorIndex, nicMTU=nicMTU, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, upgradeDownloadFailed=upgradeDownloadFailed, tegileCompliances=tegileCompliances, lunReservedSizeHigh=lunReservedSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectEntry=projectEntry, snmpAgentVersion=snmpAgentVersion, poolIndex=poolIndex, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiators=iscsiInitiators, poolMetaWriteLatency=poolMetaWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, smisServiceStopped=smisServiceStopped, haResourceDescription=haResourceDescription, fcTargetGroup=fcTargetGroup, diskDataWriteIops=diskDataWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicGroup=nicGroup, poolTable=poolTable, shareCIFSReadLatency=shareCIFSReadLatency, poolMetaReadLatency=poolMetaReadLatency, projectFreeSizeHigh=projectFreeSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, testNotification=testNotification, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, cifsAvgReadLatency=cifsAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, tegileConformance=tegileConformance, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetAuth=iscsiTargetAuth, projectDataSizeLow=projectDataSizeLow, currentObjectGroup=currentObjectGroup, replicationComplete=replicationComplete, fcTargetReadMbps=fcTargetReadMbps, projectShareCount=projectShareCount, diskSizeHigh=diskSizeHigh)
