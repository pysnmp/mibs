...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:44:58 2024
...
Counter64, Bits, MibIdentifier, Integer32, enterprises, NotificationType, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, Unsigned32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "MibIdentifier", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "Unsigned32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", sensorFailureEvent=sensorFailureEvent, poolReadCacheReadMbps=poolReadCacheReadMbps, upgradeFailed=upgradeFailed, poolMetaWriteLatency=poolMetaWriteLatency, iscsiProperties=iscsiProperties, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTotalReadIops=iscsiTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolDataWriteMbps=poolDataWriteMbps, fcTargets=fcTargets, deleteFolderCompleted=deleteFolderCompleted, haResourceGroup=haResourceGroup, haResources=haResources, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, aclMigrationCompleted=aclMigrationCompleted, currentObjectGroup=currentObjectGroup, iscsiTargetName=iscsiTargetName, poolMetaWriteIops=poolMetaWriteIops, shareCIFSEnabled=shareCIFSEnabled, iscsiImproperTargetGroup=iscsiImproperTargetGroup, volumeModifyCompleted=volumeModifyCompleted, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetIndex=fcTargetIndex, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTotalReadMbps=fcTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, replicationComplete=replicationComplete, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareCIFSReadIops=shareCIFSReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, network=network, tegileConformance=tegileConformance, diskType=diskType, controllerUp=controllerUp, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunProjectName=lunProjectName, diskAvgWriteLatency=diskAvgWriteLatency, poolProjectCount=poolProjectCount, ipmiOther=ipmiOther, pools=pools, lunReadLatency=lunReadLatency, fcInitiators=fcInitiators, poolTotalWriteIops=poolTotalWriteIops, projectDedupEnabled=projectDedupEnabled, notificationSeverity=notificationSeverity, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicEntry=nicEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskDataWriteIops=diskDataWriteIops, nicGroup=nicGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, poolProjects=poolProjects, lunFreeSizeLow=lunFreeSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, smisServiceStopped=smisServiceStopped, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskSizeLow=diskSizeLow, projectLUNs=projectLUNs, snapshotCloneCompleted=snapshotCloneCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, smbSocketFailure=smbSocketFailure, lunDedupEnabled=lunDedupEnabled, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, smisServiceStarted=smisServiceStarted, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, projectShareCount=projectShareCount, volumeQuotaFinished=volumeQuotaFinished, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareProjectName=shareProjectName, fcTargetName=fcTargetName, sharePoolName=sharePoolName, notificationReadingUnit=notificationReadingUnit, maintenanceModeEnabled=maintenanceModeEnabled, fcPortOffline=fcPortOffline, projectFreeSizeHigh=projectFreeSizeHigh, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastores=vmwareNFSDatastores, controllerTimeDrift=controllerTimeDrift, lunSizeHigh=lunSizeHigh, poolUpgraded=poolUpgraded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareNFSReadMbps=shareNFSReadMbps, nicState=nicState, fcTargetReadLatency=fcTargetReadLatency, iscsiInitiators=iscsiInitiators, cifsAvgReadLatency=cifsAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, globalStatistics=globalStatistics, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, diskError=diskError, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolSizeLow=poolSizeLow, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolMetaReadMbps=poolMetaReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectIndex=projectIndex, nicName=nicName, poolDataReadMbps=poolDataReadMbps, poolExported=poolExported, notificationObjects=notificationObjects, networkTotalTransmitMbps=networkTotalTransmitMbps, memoryFailure=memoryFailure, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationTargetEntityName=notificationTargetEntityName, fcInitiatorIndex=fcInitiatorIndex, haResourceName=haResourceName, smisServiceStopFailed=smisServiceStopFailed, diskSlowIo=diskSlowIo, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetGroup=iscsiTargetGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetsTable=fcTargetsTable, diskTotalReadIops=diskTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskTable=diskTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tegileCompliances=tegileCompliances, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationSensorNumber=notificationSensorNumber, smisServiceStartFailed=smisServiceStartFailed, projectQuotaFinished=projectQuotaFinished, fcTotalReadIops=fcTotalReadIops, poolSizeHigh=poolSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, networkInterfaceDown=networkInterfaceDown, projectModified=projectModified, iscsiTargetReadLatency=iscsiTargetReadLatency, projectTable=projectTable, cifsTotalReadIops=cifsTotalReadIops, tegileGroups=tegileGroups, poolTable=poolTable, poolTotalSaving=poolTotalSaving, nfsTotalReadMbps=nfsTotalReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, projectShares=projectShares, diskIsOnline=diskIsOnline, iscsiInitiatorGroup=iscsiInitiatorGroup, haResourcesTable=haResourcesTable, haResourceEntry=haResourceEntry, controllerHardwareModel=controllerHardwareModel, sanProperties=sanProperties, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcAvgWriteLatency=fcAvgWriteLatency, networkIpmpGroupDown=networkIpmpGroupDown, poolDataSizeLow=poolDataSizeLow, properties=properties, fcAvgReadLatency=fcAvgReadLatency, projectDataSizeHigh=projectDataSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorName=iscsiInitiatorName, userLoginFailed=userLoginFailed, targetGroupMemberAdded=targetGroupMemberAdded, poolExpanded=poolExpanded, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunReadIops=lunReadIops, cpuSystemCalls=cpuSystemCalls, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotCreationFailed=snapshotCreationFailed, notificationProps=notificationProps, alertsCleanupCompleted=alertsCleanupCompleted, lunWriteMbps=lunWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolMetaReadIops=poolMetaReadIops, replicationSourceRegistered=replicationSourceRegistered, haControllerB_Uptime=haControllerB_Uptime, snapshotRollbackCompleted=snapshotRollbackCompleted, diskEntry=diskEntry, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationAbandoned=replicationAbandoned, lunCompressionEnabled=lunCompressionEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, haResourceActiveNode=haResourceActiveNode, poolCreated=poolCreated, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, volumeDeleteFailed=volumeDeleteFailed, projectName=projectName, lunBlockSize=lunBlockSize, fcInitiatorsTable=fcInitiatorsTable, ipmiPowerSupply=ipmiPowerSupply, lunWriteLatency=lunWriteLatency, shareDataSizeLow=shareDataSizeLow, poolTotalReadIops=poolTotalReadIops, diskIOCount=diskIOCount, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, snmpServiceStarted=snmpServiceStarted, iscsiTargetGroupError=iscsiTargetGroupError, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolAvgReadLatency=poolAvgReadLatency, ipmiVoltage=ipmiVoltage, poolDataWriteIops=poolDataWriteIops, diskAvgReadLatency=diskAvgReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, poolEntry=poolEntry, shareCIFSReadMbps=shareCIFSReadMbps, cpuInterrupts=cpuInterrupts, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalReadMbps=diskTotalReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetsTable=iscsiTargetsTable, shareReservedSizeHigh=shareReservedSizeHigh, diskAlias=diskAlias, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDataSizeHigh=poolDataSizeHigh, nicIndex=nicIndex, lunTargetGroup=lunTargetGroup, diskCount=diskCount, projectDataSizeLow=projectDataSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunName=lunName, poolReadCacheReadIops=poolReadCacheReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, cacheTotalWriteMbps=cacheTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, poolName=poolName, haResourceIndex=haResourceIndex, lunWriteIops=lunWriteIops, poolTotalReadMbps=poolTotalReadMbps, diskTotalWriteIops=diskTotalWriteIops, replicationFailed=replicationFailed, lunEntry=lunEntry, fcTargetGroup=fcTargetGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunProtocol=lunProtocol, poolAvgWriteLatency=poolAvgWriteLatency, shareIndex=shareIndex, poolDataWriteLatency=poolDataWriteLatency, poolMetaReadLatency=poolMetaReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiTemperature=ipmiTemperature, upgradeCompleted=upgradeCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, snmpServiceStopped=snmpServiceStopped, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunSnapshotSizeLow=lunSnapshotSizeLow, poolOwnerController=poolOwnerController, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, projectEntry=projectEntry, fcTargetReadIops=fcTargetReadIops, upgradeStarted=upgradeStarted, tdpsUpgradeFailed=tdpsUpgradeFailed, projectFreeSizeLow=projectFreeSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaLow=shareQuotaLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareQuotaFinished=shareQuotaFinished, adServerTimeDrift=adServerTimeDrift, fcTargetReadMbps=fcTargetReadMbps, replicationTargetDeleted=replicationTargetDeleted, cacheRAMReads=cacheRAMReads, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCompressionEnabled=shareCompressionEnabled, lunGUID=lunGUID, projectPoolName=projectPoolName, poolFreeSizeLow=poolFreeSizeLow, tegileArray=tegileArray, nicTransmitMbps=nicTransmitMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationPaused=replicationPaused, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haControllerA_Uptime=haControllerA_Uptime, cacheTotalWriteIops=cacheTotalWriteIops, upgradeDownloadStarted=upgradeDownloadStarted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunDataSizeLow=lunDataSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, testNotification=testNotification, fcInitiatorEntry=fcInitiatorEntry, notificationEventCode=notificationEventCode, cifsTotalReadMbps=cifsTotalReadMbps, fcTotalWriteIops=fcTotalWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, cpuTotalUsage=cpuTotalUsage, replicationAborted=replicationAborted, fcProperties=fcProperties, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haControllerA_Name=haControllerA_Name, haControllerA_IPAddr=haControllerA_IPAddr, poolImported=poolImported, iscsiTargetIndex=iscsiTargetIndex, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, volumeDeleteCompleted=volumeDeleteCompleted, controllerDown=controllerDown, deleteFolderFailed=deleteFolderFailed, nfsAvgReadLatency=nfsAvgReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, notificationTime=notificationTime, projectSnapshotSizeLow=projectSnapshotSizeLow, lunCompressedRatio=lunCompressedRatio, ipmiMemory=ipmiMemory, fcTargetEntry=fcTargetEntry, lunFreeSizeHigh=lunFreeSizeHigh, diskDataReadIops=diskDataReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tegile=tegile, iscsiTargetAuth=iscsiTargetAuth, fcTargetWriteIops=fcTargetWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationDescription=notificationDescription, diskDataReadMbps=diskDataReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorIndex=iscsiInitiatorIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, aclMigrationStarted=aclMigrationStarted, snmpAgentVersion=snmpAgentVersion, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, shareDataSizeHigh=shareDataSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkInterfaceUp=networkInterfaceUp, PYSNMP_MODULE_ID=tegile, targetGroupCreateCompleted=targetGroupCreateCompleted, upgradeDownloadFailed=upgradeDownloadFailed, diskChassisIdx=diskChassisIdx, diskDataWriteMbps=diskDataWriteMbps, ipmiCurrent=ipmiCurrent, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceStatus=haResourceStatus, poolQuotaFinished=poolQuotaFinished, replicationStarted=replicationStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nfsTotalReadIops=nfsTotalReadIops, poolTotalWriteMbps=poolTotalWriteMbps, shareQuotaHigh=shareQuotaHigh, nicMTU=nicMTU, notificationSensorAction=notificationSensorAction, diskIndex=diskIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, shareEntry=shareEntry, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, unknownSensorEvent=unknownSensorEvent, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetError=iscsiTargetError, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationComponentName=notificationComponentName, lunIndex=lunIndex, replicationResumed=replicationResumed, shareName=shareName, shareCIFSReadLatency=shareCIFSReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareTable=shareTable, maintenanceModeDisabled=maintenanceModeDisabled, poolDeleted=poolDeleted, notifications=notifications, snapshotCloningFailed=snapshotCloningFailed, diskPoolName=diskPoolName, poolHealth=poolHealth, projectLunCount=projectLunCount, fcPortOnline=fcPortOnline, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareMountPoint=shareMountPoint, basicCompliance=basicCompliance, projectDeletionFailed=projectDeletionFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, disks=disks, snmpServiceStopFailed=snmpServiceStopFailed, poolCount=poolCount, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcInitiatorName=fcInitiatorName, diagnosticDataUploaded=diagnosticDataUploaded, poolDegraded=poolDegraded, poolState=poolState, iscsiInitiatorEntry=iscsiInitiatorEntry, poolUsedSizeLow=poolUsedSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskState=diskState, webdocsUpgradeFailed=webdocsUpgradeFailed, nvdimmFailSoftError=nvdimmFailSoftError, lunPoolName=lunPoolName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareNFSReadLatency=shareNFSReadLatency, lunReadMbps=lunReadMbps, projectDeleted=projectDeleted, cacheTotalReadMbps=cacheTotalReadMbps, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskSequentialIOCount=diskSequentialIOCount, haResourceDescription=haResourceDescription, poolDeletionFailed=poolDeletionFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectTotalSaving=projectTotalSaving, shareDeleted=shareDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunDataSizeHigh=lunDataSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, lunSizeLow=lunSizeLow, ipmiFan=ipmiFan, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetStatus=fcTargetStatus, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tegileArray_notifications=tegileArray_notifications, poolIndex=poolIndex, iscsiWriteIops=iscsiWriteIops, netbiosSocketFailure=netbiosSocketFailure, lunReservedSizeHigh=lunReservedSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, lunTable=lunTable, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheSSDReads=cacheSSDReads, nicTable=nicTable, diskSizeHigh=diskSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, poolDataReadIops=poolDataReadIops, upgradeTimeout=upgradeTimeout, diskGoneOffline=diskGoneOffline, ipmiThreshold=ipmiThreshold, currentNotificationGroup=currentNotificationGroup, haControllerB_Name=haControllerB_Name, shareNFSReadIops=shareNFSReadIops, iscsiTargets=iscsiTargets, iscsiTargetAlias=iscsiTargetAlias, ntpServerTimeDrift=ntpServerTimeDrift, diskRandomIOCount=diskRandomIOCount)
