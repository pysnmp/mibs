...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:55:21 2023
...
enterprises, MibIdentifier, Unsigned32, Gauge32, Counter32, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Bits, NotificationType, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Unsigned32", "Gauge32", "Counter32", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetEntry=fcTargetEntry, iscsiTargetName=iscsiTargetName, haControllerA_IPAddr=haControllerA_IPAddr, netbiosSocketFailure=netbiosSocketFailure, replicationTargetDeleted=replicationTargetDeleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorIndex=fcInitiatorIndex, notificationProps=notificationProps, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetAuth=iscsiTargetAuth, haResourceName=haResourceName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskRandomIOCount=diskRandomIOCount, poolReadCacheReadIops=poolReadCacheReadIops, diskAvgWriteLatency=diskAvgWriteLatency, lunProtocol=lunProtocol, shareNFSReadMbps=shareNFSReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetReadMbps=fcTargetReadMbps, shareIndex=shareIndex, diskCount=diskCount, notificationReadingUnit=notificationReadingUnit, upgradeStarted=upgradeStarted, properties=properties, snapshotCloningFailed=snapshotCloningFailed, projectQuotaFinished=projectQuotaFinished, shareCIFSEnabled=shareCIFSEnabled, fcInitiators=fcInitiators, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadIops=shareNFSReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, tegileGroups=tegileGroups, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetsTable=fcTargetsTable, diskSizeHigh=diskSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationSourceRegistered=replicationSourceRegistered, shareCreatedSuccessfully=shareCreatedSuccessfully, projectPoolName=projectPoolName, fcTargetReadIops=fcTargetReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, projectQuotaSizeHigh=projectQuotaSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationDescription=notificationDescription, poolHealth=poolHealth, lunWriteMbps=lunWriteMbps, nicReceiveMbps=nicReceiveMbps, poolUpgraded=poolUpgraded, shareCIFSReadLatency=shareCIFSReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, diskError=diskError, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSizeLow=lunSizeLow, projectCompressionEnabled=projectCompressionEnabled, targetGroupCreateCompleted=targetGroupCreateCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, controllerUp=controllerUp, diskTable=diskTable, poolTable=poolTable, lunGUID=lunGUID, iscsiInitiatorChapUser=iscsiInitiatorChapUser, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, disks=disks, projectEntry=projectEntry, haResourceDescription=haResourceDescription, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectTable=projectTable, projectDataSizeLow=projectDataSizeLow, poolCreated=poolCreated, fcPortOffline=fcPortOffline, nicMTU=nicMTU, fcTargets=fcTargets, upgradeTimeout=upgradeTimeout, poolTotalReadIops=poolTotalReadIops, replicationResumed=replicationResumed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, aclMigrationStarted=aclMigrationStarted, haResourceActiveNode=haResourceActiveNode, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetsTable=iscsiTargetsTable, notificationTargetEntityName=notificationTargetEntityName, fcInitiatorName=fcInitiatorName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkInterfaceUp=networkInterfaceUp, shareName=shareName, nicGroup=nicGroup, ipmiCurrent=ipmiCurrent, projectFreeSizeLow=projectFreeSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolOwnerController=poolOwnerController, iscsiTargetAlias=iscsiTargetAlias, nvdimmFailDeviceError=nvdimmFailDeviceError, spareDiskReplaced=spareDiskReplaced, diskState=diskState, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareCIFSReadIops=shareCIFSReadIops, poolDataReadMbps=poolDataReadMbps, poolDataWriteMbps=poolDataWriteMbps, poolMetaReadMbps=poolMetaReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskEntry=diskEntry, fcProperties=fcProperties, lunBlockSize=lunBlockSize, fcTargetReadLatency=fcTargetReadLatency, cacheTotalReadIops=cacheTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, tegileArray=tegileArray, projectLunCount=projectLunCount, iscsiWriteIops=iscsiWriteIops, fcPortOnline=fcPortOnline, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, tegileArray_notifications=tegileArray_notifications, fcTargetGroup=fcTargetGroup, diskGoneOffline=diskGoneOffline, projectLUNs=projectLUNs, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcInitiatorGroup=fcInitiatorGroup, iscsiTotalReadIops=iscsiTotalReadIops, poolProjectCount=poolProjectCount, lunReadMbps=lunReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareQuotaLow=shareQuotaLow, shareProjectName=shareProjectName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareDeletionFailed=shareDeletionFailed, globalStatistics=globalStatistics, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationSensorAction=notificationSensorAction, iscsiInitiators=iscsiInitiators, ipmiThreshold=ipmiThreshold, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectDeletionFailed=projectDeletionFailed, projectQuotaSizeLow=projectQuotaSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, diskTotalReadIops=diskTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, diskIsOnline=diskIsOnline, snmpServiceStopped=snmpServiceStopped, poolTotalReadMbps=poolTotalReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, controllerDown=controllerDown, iscsiInitiatorEntry=iscsiInitiatorEntry, diskDataReadMbps=diskDataReadMbps, shareNFSReadLatency=shareNFSReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, snapshotCreationFailed=snapshotCreationFailed, maintenanceModeDisabled=maintenanceModeDisabled, network=network, poolDegraded=poolDegraded, iscsiTargetError=iscsiTargetError, haResourceEntry=haResourceEntry, ipmiMemory=ipmiMemory, iscsiTargets=iscsiTargets, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectDedupEnabled=projectDedupEnabled, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunCompressedRatio=lunCompressedRatio, projectShareCount=projectShareCount, snapshotRollbackCompleted=snapshotRollbackCompleted, tegileConformance=tegileConformance, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, shareNFSWriteMbps=shareNFSWriteMbps, poolDataSizeLow=poolDataSizeLow, fcInitiatorsTable=fcInitiatorsTable, currentObjectGroup=currentObjectGroup, poolAvgWriteLatency=poolAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, iscsiInitiatorName=iscsiInitiatorName, upgradeCompleted=upgradeCompleted, cacheTotalWriteIops=cacheTotalWriteIops, smbSocketFailure=smbSocketFailure, aclMigrationCompleted=aclMigrationCompleted, shareNFSWriteIops=shareNFSWriteIops, upgradeFailed=upgradeFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunDataSizeLow=lunDataSizeLow, poolMetaReadLatency=poolMetaReadLatency, poolMetaReadIops=poolMetaReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolProjects=poolProjects, notificationSeverity=notificationSeverity, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunTargetGroup=lunTargetGroup, nfsTotalWriteIops=nfsTotalWriteIops, notificationComponentName=notificationComponentName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcAvgWriteLatency=fcAvgWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, cacheSSDReads=cacheSSDReads, ipmiVoltage=ipmiVoltage, fcTotalReadMbps=fcTotalReadMbps, projectDataSizeHigh=projectDataSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nfsTotalReadIops=nfsTotalReadIops, lunIndex=lunIndex, poolDataReadIops=poolDataReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, lunInitiatorGroup=lunInitiatorGroup, replicationAborted=replicationAborted, projectDeleted=projectDeleted, volumeQuotaFinished=volumeQuotaFinished, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorEntry=fcInitiatorEntry, lunTable=lunTable, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, poolDataWriteLatency=poolDataWriteLatency, snmpAgentVersion=snmpAgentVersion, sharePoolName=sharePoolName, shareDeleted=shareDeleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, upgradeDownloadStarted=upgradeDownloadStarted, smisServiceStopped=smisServiceStopped, replicationPaused=replicationPaused, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectName=projectName, projectShares=projectShares, testNotification=testNotification, nicEntry=nicEntry, poolReadCacheWriteIops=poolReadCacheWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetWriteMbps=iscsiTargetWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", smisServiceStartFailed=smisServiceStartFailed, replicationFailed=replicationFailed, diskTotalWriteIops=diskTotalWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, memoryFailure=memoryFailure, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, maintenanceModeEnabled=maintenanceModeEnabled, tegileCompliances=tegileCompliances, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snapshotRollbackFailed=snapshotRollbackFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cpuInterrupts=cpuInterrupts, poolTotalSaving=poolTotalSaving, unknownSensorEvent=unknownSensorEvent, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cpuTotalUsage=cpuTotalUsage, cifsTotalWriteIops=cifsTotalWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, fcAvgReadLatency=fcAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetReadLatency=iscsiTargetReadLatency, ipmiPowerSupply=ipmiPowerSupply, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smisServiceStopFailed=smisServiceStopFailed, snapshotCloneCompleted=snapshotCloneCompleted, currentNotificationGroup=currentNotificationGroup, shareMountPoint=shareMountPoint, poolReadCacheReadLatency=poolReadCacheReadLatency, projectModified=projectModified, shareExceedThresholdWarning=shareExceedThresholdWarning, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolDataReadLatency=poolDataReadLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunReadLatency=lunReadLatency, lunDataSizeHigh=lunDataSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskSlowIo=diskSlowIo, haResourceGroup=haResourceGroup, diskTotalReadMbps=diskTotalReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolSizeHigh=poolSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, userLoginFailed=userLoginFailed, poolSizeLow=poolSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, poolAvgReadLatency=poolAvgReadLatency, fcTargetWriteIops=fcTargetWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, nicTable=nicTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunPoolName=lunPoolName, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerTimeDrift=controllerTimeDrift, shareEntry=shareEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, poolEntry=poolEntry, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, networkTotalReceiveMbps=networkTotalReceiveMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskType=diskType, diskDataWriteIops=diskDataWriteIops, sanProperties=sanProperties, diskPoolName=diskPoolName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeDeleteFailed=volumeDeleteFailed, nicState=nicState, iscsiTargetEntry=iscsiTargetEntry, poolDeleted=poolDeleted, poolIndex=poolIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunDedupEnabled=lunDedupEnabled, nicIndex=nicIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTotalReadMbps=iscsiTotalReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, lunName=lunName, smisServiceStarted=smisServiceStarted, projectThresholdExceedWarning=projectThresholdExceedWarning, tegile=tegile, diskSequentialIOCount=diskSequentialIOCount, diskChassisIdx=diskChassisIdx, replicationComplete=replicationComplete, nfsAvgWriteLatency=nfsAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, cifsTotalReadIops=cifsTotalReadIops, shareReservedSizeHigh=shareReservedSizeHigh, poolDeletionFailed=poolDeletionFailed, poolCount=poolCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiFan=ipmiFan, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolDataWriteIops=poolDataWriteIops, shareCompressedRatio=shareCompressedRatio, ipmiOther=ipmiOther, poolState=poolState, basicCompliance=basicCompliance, lunWriteLatency=lunWriteLatency, diskSizeLow=diskSizeLow, deleteFolderFailed=deleteFolderFailed, diskAlias=diskAlias, snmpServiceStarted=snmpServiceStarted, lunCompressionEnabled=lunCompressionEnabled, haControllerA_Name=haControllerA_Name, notificationObjects=notificationObjects, shareCIFSReadMbps=shareCIFSReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskTotalWriteMbps=diskTotalWriteMbps, replicationStarted=replicationStarted, diskIndex=diskIndex, upgradeDownloadFailed=upgradeDownloadFailed, controllerHardwareModel=controllerHardwareModel, poolExpanded=poolExpanded, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolName=poolName, lunEntry=lunEntry, shareDedupEnabled=shareDedupEnabled, deleteFolderCompleted=deleteFolderCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTotalWriteMbps=fcTotalWriteMbps, ipmiTemperature=ipmiTemperature, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectTotalSaving=projectTotalSaving, poolImported=poolImported, ntpServerTimeDrift=ntpServerTimeDrift, sensorFailureEvent=sensorFailureEvent, pools=pools, lunReservedSizeLow=lunReservedSizeLow, poolDataSizeHigh=poolDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTotalWriteIops=fcTotalWriteIops, adServerTimeDrift=adServerTimeDrift, haControllerA_Uptime=haControllerA_Uptime, lunSizeHigh=lunSizeHigh, PYSNMP_MODULE_ID=tegile, snmpServiceStopFailed=snmpServiceStopFailed, notificationEventCode=notificationEventCode, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareReservedSizeLow=shareReservedSizeLow, notifications=notifications, lunProjectName=lunProjectName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicName=nicName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, networkInterfaceDown=networkInterfaceDown, diskDataReadIops=diskDataReadIops, fcTargetName=fcTargetName, shareNFSEnabled=shareNFSEnabled, projectCreatedSuccessfully=projectCreatedSuccessfully, shareTable=shareTable, projectIndex=projectIndex, haResources=haResources, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notificationTime=notificationTime, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolUsedSizeLow=poolUsedSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceStatus=haResourceStatus, iscsiAvgReadLatency=iscsiAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, shareCompressionEnabled=shareCompressionEnabled, lunWriteIops=lunWriteIops, replicationAbandoned=replicationAbandoned, alertsCleanupCompleted=alertsCleanupCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolTotalWriteIops=poolTotalWriteIops, haResourcesTable=haResourcesTable, diskAvgReadLatency=diskAvgReadLatency, shareQuotaFinished=shareQuotaFinished, fcTotalReadIops=fcTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, shareDataSizeLow=shareDataSizeLow, poolExported=poolExported, lunReadIops=lunReadIops, notificationSensorNumber=notificationSensorNumber, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cpuSystemCalls=cpuSystemCalls, haControllerB_Name=haControllerB_Name, diskIOCount=diskIOCount, cifsTotalReadMbps=cifsTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetStatus=fcTargetStatus, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaWriteIops=poolMetaWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiProperties=iscsiProperties, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTargetIndex=fcTargetIndex, haResourceIndex=haResourceIndex)
