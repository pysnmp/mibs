...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:20:08 2022
...
NotificationType, iso, IpAddress, Counter64, Counter32, enterprises, Unsigned32, ObjectIdentity, MibIdentifier, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "IpAddress", "Counter64", "Counter32", "enterprises", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectShares=projectShares, notificationReadingTriggerValue=notificationReadingTriggerValue, cacheSSDReads=cacheSSDReads, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haResourceGroup=haResourceGroup, diskDataWriteIops=diskDataWriteIops, snmpServiceStopped=snmpServiceStopped, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskIOCount=diskIOCount, shareNFSReadIops=shareNFSReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolReadCacheWriteIops=poolReadCacheWriteIops, shareEntry=shareEntry, fcAvgWriteLatency=fcAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, iscsiTargetIndex=iscsiTargetIndex, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectEntry=projectEntry, poolMetaReadMbps=poolMetaReadMbps, network=network, poolExported=poolExported, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nvdimmFailSoftError=nvdimmFailSoftError, lunReservedSizeHigh=lunReservedSizeHigh, diskType=diskType, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haResourceIndex=haResourceIndex, diskTotalWriteMbps=diskTotalWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectLunCount=projectLunCount, poolIndex=poolIndex, diskCount=diskCount, haResourcesTable=haResourcesTable, poolQuotaFinished=poolQuotaFinished, lunReservedSizeLow=lunReservedSizeLow, haControllerB_Uptime=haControllerB_Uptime, snapshotDeleteFailed=snapshotDeleteFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationTargetDeleted=replicationTargetDeleted, shareDedupEnabled=shareDedupEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalSaving=poolTotalSaving, basicCompliance=basicCompliance, haControllerB_IPAddr=haControllerB_IPAddr, projectDeletionFailed=projectDeletionFailed, projectDeleted=projectDeleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haResourceName=haResourceName, nicTransmitMbps=nicTransmitMbps, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, networkInterfaceDown=networkInterfaceDown, poolReadCacheReadIops=poolReadCacheReadIops, haResources=haResources, lunSizeLow=lunSizeLow, fcTargetStatus=fcTargetStatus, cacheRAMReads=cacheRAMReads, iscsiTargetReadMbps=iscsiTargetReadMbps, notifications=notifications, haControllerA_IPAddr=haControllerA_IPAddr, snmpServiceStartFailed=snmpServiceStartFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nicGroup=nicGroup, haControllerA_Uptime=haControllerA_Uptime, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolImported=poolImported, fcTargets=fcTargets, projectQuotaSizeHigh=projectQuotaSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, aclMigrationStarted=aclMigrationStarted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareSnapshotSizeLow=shareSnapshotSizeLow, controllerDown=controllerDown, diagnosticDataUploaded=diagnosticDataUploaded, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDegraded=poolDegraded, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcPortOffline=fcPortOffline, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolTable=poolTable, poolDataSizeLow=poolDataSizeLow, lunDedupEnabled=lunDedupEnabled, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, disks=disks, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunReadMbps=lunReadMbps, diskState=diskState, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTotalReadIops=fcTotalReadIops, projectIndex=projectIndex, cifsAvgReadLatency=cifsAvgReadLatency, shareCompressedRatio=shareCompressedRatio, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, smisServiceStarted=smisServiceStarted, lunFreeSizeHigh=lunFreeSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolUsedSizeHigh=poolUsedSizeHigh, lunReadLatency=lunReadLatency, currentNotificationGroup=currentNotificationGroup, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskIndex=diskIndex, diskAlias=diskAlias, poolName=poolName, snmpServiceStopFailed=snmpServiceStopFailed, cifsTotalWriteIops=cifsTotalWriteIops, nicIndex=nicIndex, iscsiTargetReadIops=iscsiTargetReadIops, tegileGroups=tegileGroups, poolState=poolState, replicationComplete=replicationComplete, lunIndex=lunIndex, projectFreeSizeLow=projectFreeSizeLow, shareQuotaHigh=shareQuotaHigh, poolUpgraded=poolUpgraded, shareCIFSReadIops=shareCIFSReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationComponentName=notificationComponentName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataWriteIops=poolDataWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, networkIpmpGroupDown=networkIpmpGroupDown, diskTable=diskTable, poolDeleted=poolDeleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tdpsUpgradeCompleted=tdpsUpgradeCompleted, controllerUp=controllerUp, ipmiVoltage=ipmiVoltage, projectFreeSizeHigh=projectFreeSizeHigh, shareNFSWriteIops=shareNFSWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, haControllerA_Name=haControllerA_Name, projectCompressionEnabled=projectCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetWriteIops=iscsiTargetWriteIops, memoryFailure=memoryFailure, lunTargetGroup=lunTargetGroup, lunInitiatorGroup=lunInitiatorGroup, lunDataSizeLow=lunDataSizeLow, diskRandomIOCount=diskRandomIOCount, sensorFailureEvent=sensorFailureEvent, haResourceEntry=haResourceEntry, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cpuTotalUsage=cpuTotalUsage, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastores=vmwareNFSDatastores, alertsCleanupCompleted=alertsCleanupCompleted, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, fcInitiatorsTable=fcInitiatorsTable, notificationSeverity=notificationSeverity, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, deleteFolderCompleted=deleteFolderCompleted, ipmiThreshold=ipmiThreshold, maintenanceModeEnabled=maintenanceModeEnabled, replicationAbandoned=replicationAbandoned, diskDataWriteMbps=diskDataWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, controllerHardwareModel=controllerHardwareModel, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationSensorSuspect=notificationSensorSuspect, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceDescription=haResourceDescription, poolDataReadIops=poolDataReadIops, cpuSystemCalls=cpuSystemCalls, intelliFlashSoftwareUp=intelliFlashSoftwareUp, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcInitiators=fcInitiators, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareCIFSReadMbps=shareCIFSReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, projectLUNs=projectLUNs, poolFreeSizeHigh=poolFreeSizeHigh, fcInitiatorName=fcInitiatorName, shareNFSWriteLatency=shareNFSWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunBlockSize=lunBlockSize, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolMetaWriteMbps=poolMetaWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, fcTargetIndex=fcTargetIndex, nicState=nicState, shareCIFSWriteLatency=shareCIFSWriteLatency, cifsTotalReadIops=cifsTotalReadIops, shareProjectName=shareProjectName, iscsiInitiatorGroup=iscsiInitiatorGroup, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectShareCount=projectShareCount, shareName=shareName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetEntry=fcTargetEntry, notificationDescription=notificationDescription, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolProjects=poolProjects, diskSlowIo=diskSlowIo, cacheTotalReadMbps=cacheTotalReadMbps, snmpAgentVersion=snmpAgentVersion, shareCIFSWriteMbps=shareCIFSWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskError=diskError, replicationSourceRegistered=replicationSourceRegistered, diskAvgReadLatency=diskAvgReadLatency, shareDataSizeHigh=shareDataSizeHigh, fcTargetGroup=fcTargetGroup, poolMetaReadIops=poolMetaReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectDataSizeHigh=projectDataSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationSensorAction=notificationSensorAction, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tegileConformance=tegileConformance, diskGoneOffline=diskGoneOffline, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiMemory=ipmiMemory, shareTable=shareTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDataSizeLow=projectDataSizeLow, shareReservedSizeLow=shareReservedSizeLow, diskTotalReadIops=diskTotalReadIops, upgradeStarted=upgradeStarted, diskIsOnline=diskIsOnline, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, upgradeDownloadFailed=upgradeDownloadFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetsTable=iscsiTargetsTable, notificationTime=notificationTime, diskTotalWriteIops=diskTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, volumeModifyCompleted=volumeModifyCompleted, projectDedupEnabled=projectDedupEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiPowerSupply=ipmiPowerSupply, ipmiFan=ipmiFan, haResourceStatus=haResourceStatus, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolReadCacheReadLatency=poolReadCacheReadLatency, smisServiceStopped=smisServiceStopped, shareDeleted=shareDeleted, diskSizeHigh=diskSizeHigh, diskSizeLow=diskSizeLow, poolSizeLow=poolSizeLow, lunCompressedRatio=lunCompressedRatio, poolTotalReadMbps=poolTotalReadMbps, targetGroupMemberAdded=targetGroupMemberAdded, poolSizeHigh=poolSizeHigh, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolOwnerController=poolOwnerController, lunPoolName=lunPoolName, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargets=iscsiTargets, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationSensorNumber=notificationSensorNumber, iscsiTargetEntry=iscsiTargetEntry, poolExpanded=poolExpanded, volumeDeleteFailed=volumeDeleteFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectQuotaFinished=projectQuotaFinished, iscsiWriteIops=iscsiWriteIops, nfsTotalReadIops=nfsTotalReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationPaused=replicationPaused, spareDiskReplaced=spareDiskReplaced, lunProjectName=lunProjectName, fcProperties=fcProperties, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareQuotaFinished=shareQuotaFinished, shareNFSReadMbps=shareNFSReadMbps, lunTable=lunTable, upgradeDownloadStarted=upgradeDownloadStarted, snapshotCreationFailed=snapshotCreationFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalWriteIops=poolTotalWriteIops, poolAvgReadLatency=poolAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, shareMountPoint=shareMountPoint, upgradeFailed=upgradeFailed, testNotification=testNotification, lunName=lunName, cifsAvgWriteLatency=cifsAvgWriteLatency, shareIndex=shareIndex, poolAvgWriteLatency=poolAvgWriteLatency, lunReadIops=lunReadIops, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, netbiosSocketFailure=netbiosSocketFailure, nicTable=nicTable, networkInterfaceUp=networkInterfaceUp, diskPoolName=diskPoolName, iscsiTargetAlias=iscsiTargetAlias, poolProjectCount=poolProjectCount, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareQuotaLow=shareQuotaLow, shareNFSReadLatency=shareNFSReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, lunGUID=lunGUID, tdpsUpgradeFailed=tdpsUpgradeFailed, pools=pools, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectModified=projectModified, iscsiInitiatorIndex=iscsiInitiatorIndex, poolMetaReadLatency=poolMetaReadLatency, smbSocketFailure=smbSocketFailure, smisServiceStopFailed=smisServiceStopFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaWriteIops=poolMetaWriteIops, properties=properties, lunWriteMbps=lunWriteMbps, replicationAborted=replicationAborted, shareNFSEnabled=shareNFSEnabled, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetReadLatency=fcTargetReadLatency, smisServiceStartFailed=smisServiceStartFailed, snmpServiceStarted=snmpServiceStarted, diskTotalReadMbps=diskTotalReadMbps, fcPortOnline=fcPortOnline, projectPoolName=projectPoolName, shareCompressionEnabled=shareCompressionEnabled, nfsAvgWriteLatency=nfsAvgWriteLatency, haResourceActiveNode=haResourceActiveNode, webdocsUpgradeFailed=webdocsUpgradeFailed, poolDataWriteLatency=poolDataWriteLatency, PYSNMP_MODULE_ID=tegile, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tegileArray=tegileArray, upgradeTimeout=upgradeTimeout, nvdimmFailDeviceError=nvdimmFailDeviceError, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunProtocol=lunProtocol, cacheTotalReadIops=cacheTotalReadIops, lunDataSizeHigh=lunDataSizeHigh, shareDeletionFailed=shareDeletionFailed, volumeQuotaFinished=volumeQuotaFinished, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunWriteIops=lunWriteIops, fcTargetWriteIops=fcTargetWriteIops, notificationTargetEntityName=notificationTargetEntityName, replicationResumed=replicationResumed, poolHealth=poolHealth, controllerTimeDrift=controllerTimeDrift, poolCreated=poolCreated, poolDataReadLatency=poolDataReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunSizeHigh=lunSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tegileArray_notifications=tegileArray_notifications, replicationStarted=replicationStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationReadingUnit=notificationReadingUnit, networkIpmpGroupUp=networkIpmpGroupUp, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiInitiatorName=iscsiInitiatorName, diskChassisIdx=diskChassisIdx, nicReceiveMbps=nicReceiveMbps, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetReadIops=fcTargetReadIops, poolEntry=poolEntry, poolCount=poolCount, projectSnapshotSizeLow=projectSnapshotSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, lunWriteLatency=lunWriteLatency, sanProperties=sanProperties, diskAvgWriteLatency=diskAvgWriteLatency, projectName=projectName, poolDataSizeHigh=poolDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationFailed=replicationFailed, iscsiTargetName=iscsiTargetName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, cpuInterrupts=cpuInterrupts, unknownSensorEvent=unknownSensorEvent, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ipmiOther=ipmiOther, sharePoolName=sharePoolName, fcTargetName=fcTargetName, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicName=nicName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcInitiatorEntry=fcInitiatorEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTotalWriteIops=fcTotalWriteIops, nicEntry=nicEntry, iscsiTargetError=iscsiTargetError, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationObjects=notificationObjects, poolDeletionFailed=poolDeletionFailed, globalStatistics=globalStatistics, projectTotalSaving=projectTotalSaving, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorIndex=fcInitiatorIndex, shareSnapshotSizeHigh=shareSnapshotSizeHigh, userLoginFailed=userLoginFailed, tegile=tegile, notificationProps=notificationProps, adServerTimeDrift=adServerTimeDrift, diskDataReadIops=diskDataReadIops, cacheTotalWriteIops=cacheTotalWriteIops, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetAuth=iscsiTargetAuth, fcTargetsTable=fcTargetsTable, lunEntry=lunEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetReadMbps=fcTargetReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolTotalReadIops=poolTotalReadIops, ipmiTemperature=ipmiTemperature, ipmiCurrent=ipmiCurrent, networkTotalReceiveMbps=networkTotalReceiveMbps, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, lunFreeSizeLow=lunFreeSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, projectTable=projectTable, diskEntry=diskEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationEventCode=notificationEventCode, iscsiTargetGroupError=iscsiTargetGroupError, fcAvgReadLatency=fcAvgReadLatency, snapshotCloningFailed=snapshotCloningFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareCIFSReadLatency=shareCIFSReadLatency, upgradeCompleted=upgradeCompleted, nfsTotalReadMbps=nfsTotalReadMbps, nicMTU=nicMTU, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetWriteMbps=fcTargetWriteMbps, tegileCompliances=tegileCompliances, haControllerB_Name=haControllerB_Name, iscsiProperties=iscsiProperties, poolFreeSizeLow=poolFreeSizeLow)
