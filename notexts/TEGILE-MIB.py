...
NotificationType, Unsigned32, Integer32, Gauge32, IpAddress, iso, ModuleIdentity, Counter32, ObjectIdentity, MibIdentifier, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Integer32", "Gauge32", "IpAddress", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, PYSNMP_MODULE_ID=tegile, haResourceStatus=haResourceStatus, replicationTargetDeleted=replicationTargetDeleted, aclMigrationCompleted=aclMigrationCompleted, diskTotalWriteMbps=diskTotalWriteMbps, smisServiceStarted=smisServiceStarted, poolReadCacheReadLatency=poolReadCacheReadLatency, shareDedupEnabled=shareDedupEnabled, nicTransmitMbps=nicTransmitMbps, lunCompressionEnabled=lunCompressionEnabled, shareQuotaLow=shareQuotaLow, disks=disks, poolExpanded=poolExpanded, upgradeFailed=upgradeFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haControllerA_Name=haControllerA_Name, shareMountPoint=shareMountPoint, poolTable=poolTable, shareNFSReadIops=shareNFSReadIops, poolAvgReadLatency=poolAvgReadLatency, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunDedupEnabled=lunDedupEnabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haResourceDescription=haResourceDescription, fcTargetReadLatency=fcTargetReadLatency, shareName=shareName, shareNFSWriteLatency=shareNFSWriteLatency, fcTargetName=fcTargetName, diskTable=diskTable, notificationSensorAction=notificationSensorAction, projectDataSizeLow=projectDataSizeLow, cacheTotalReadIops=cacheTotalReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolCreated=poolCreated, diskCount=diskCount, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiVoltage=ipmiVoltage, iscsiInitiators=iscsiInitiators, iscsiTargetIndex=iscsiTargetIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectShareCount=projectShareCount, shareDeletionFailed=shareDeletionFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolReadCacheReadIops=poolReadCacheReadIops, lunReservedSizeHigh=lunReservedSizeHigh, poolTotalReadIops=poolTotalReadIops, nicMTU=nicMTU, lunReadIops=lunReadIops, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunName=lunName, projectQuotaFinished=projectQuotaFinished, shareReservedSizeLow=shareReservedSizeLow, replicationStarted=replicationStarted, snmpServiceStopped=snmpServiceStopped, haResourceEntry=haResourceEntry, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorIndex=fcInitiatorIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, snmpAgentVersion=snmpAgentVersion, iscsiTargetAlias=iscsiTargetAlias, poolMetaReadMbps=poolMetaReadMbps, shareDataSizeHigh=shareDataSizeHigh, notificationTime=notificationTime, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorSuspect=notificationSensorSuspect, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolMetaWriteLatency=poolMetaWriteLatency, haControllerA_Uptime=haControllerA_Uptime, notificationSensorNumber=notificationSensorNumber, volumeModifyCompleted=volumeModifyCompleted, diskDataReadIops=diskDataReadIops, poolHealth=poolHealth, iscsiTargetReadIops=iscsiTargetReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTotalReadIops=iscsiTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargets=iscsiTargets, intelliFlashSoftwareUp=intelliFlashSoftwareUp, networkIpmpGroupUp=networkIpmpGroupUp, projectShares=projectShares, cpuTotalUsage=cpuTotalUsage, lunDataSizeLow=lunDataSizeLow, cacheRAMReads=cacheRAMReads, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, shareProjectName=shareProjectName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nfsTotalReadIops=nfsTotalReadIops, sanProperties=sanProperties, cifsTotalReadMbps=cifsTotalReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, currentNotificationGroup=currentNotificationGroup, replicationPaused=replicationPaused, tegileConformance=tegileConformance, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunBlockSize=lunBlockSize, poolSizeHigh=poolSizeHigh, projectLunCount=projectLunCount, poolDeleted=poolDeleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcAvgReadLatency=fcAvgReadLatency, notificationComponentName=notificationComponentName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunWriteLatency=lunWriteLatency, poolDataWriteLatency=poolDataWriteLatency, poolDataReadMbps=poolDataReadMbps, projectFreeSizeLow=projectFreeSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, unknownSensorEvent=unknownSensorEvent, notificationObjects=notificationObjects, shareCIFSWriteLatency=shareCIFSWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, projectLUNs=projectLUNs, volumeDeleteFailed=volumeDeleteFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetsTable=fcTargetsTable, lunReadMbps=lunReadMbps, ipmiPowerSupply=ipmiPowerSupply, diskSizeHigh=diskSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunGUID=lunGUID, snapshotCloningFailed=snapshotCloningFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationSeverity=notificationSeverity, projectQuotaSizeLow=projectQuotaSizeLow, shareEntry=shareEntry, tegileCompliances=tegileCompliances, upgradeCompleted=upgradeCompleted, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCompressionEnabled=shareCompressionEnabled, poolUsedSizeLow=poolUsedSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notificationReadingUnit=notificationReadingUnit, ipmiTemperature=ipmiTemperature, poolIndex=poolIndex, fcAvgWriteLatency=fcAvgWriteLatency, poolUpgraded=poolUpgraded, poolDataWriteMbps=poolDataWriteMbps, testNotification=testNotification, projectFreeSizeHigh=projectFreeSizeHigh, targetGroupCreateCompleted=targetGroupCreateCompleted, lunWriteMbps=lunWriteMbps, diskIndex=diskIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareIndex=shareIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalReadMbps=poolTotalReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolAvgWriteLatency=poolAvgWriteLatency, diskEntry=diskEntry, haControllerB_IPAddr=haControllerB_IPAddr, diskRandomIOCount=diskRandomIOCount, upgradeTimeout=upgradeTimeout, lunSizeLow=lunSizeLow, nicGroup=nicGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, shareNFSEnabled=shareNFSEnabled, haResources=haResources, controllerUp=controllerUp, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunEntry=lunEntry, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiOther=ipmiOther, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haResourceGroup=haResourceGroup, replicationComplete=replicationComplete, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolOwnerController=poolOwnerController, lunCompressedRatio=lunCompressedRatio, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetsTable=iscsiTargetsTable, replicationAborted=replicationAborted, diskTotalWriteIops=diskTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, fcTotalWriteIops=fcTotalWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, poolExported=poolExported, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetGroupError=iscsiTargetGroupError, lunFreeSizeHigh=lunFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, upgradeDownloadFailed=upgradeDownloadFailed, diskSizeLow=diskSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nfsTotalWriteIops=nfsTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskAvgReadLatency=diskAvgReadLatency, fcTargetIndex=fcTargetIndex, snmpServiceStartFailed=snmpServiceStartFailed, maintenanceModeEnabled=maintenanceModeEnabled, networkTotalTransmitMbps=networkTotalTransmitMbps, fcPortOnline=fcPortOnline, iscsiWriteIops=iscsiWriteIops, projectModified=projectModified, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolProjectCount=poolProjectCount, notificationProps=notificationProps, lunReservedSizeLow=lunReservedSizeLow, fcProperties=fcProperties, lunFreeSizeLow=lunFreeSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, smisServiceStartFailed=smisServiceStartFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, lunIndex=lunIndex, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, cpuInterrupts=cpuInterrupts, upgradeStarted=upgradeStarted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcPortOffline=fcPortOffline, currentObjectGroup=currentObjectGroup, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcInitiatorGroup=fcInitiatorGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDataReadIops=poolDataReadIops, diskAvgWriteLatency=diskAvgWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, lunSizeHigh=lunSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationResumed=replicationResumed, shareCIFSEnabled=shareCIFSEnabled, fcTargetWriteIops=fcTargetWriteIops, lunInitiatorGroup=lunInitiatorGroup, projectDedupEnabled=projectDedupEnabled, aclMigrationStarted=aclMigrationStarted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", poolQuotaFinished=poolQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicIndex=nicIndex, snmpServiceStopFailed=snmpServiceStopFailed, cifsAvgReadLatency=cifsAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, network=network, poolDeletionFailed=poolDeletionFailed, diskError=diskError, poolSizeLow=poolSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetName=iscsiTargetName, lunTable=lunTable, replicationAbandoned=replicationAbandoned, fcTargetGroup=fcTargetGroup, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectDeleted=projectDeleted, poolDegraded=poolDegraded, poolFreeSizeLow=poolFreeSizeLow, haResourcesTable=haResourcesTable, cacheSSDReads=cacheSSDReads, notificationEventCode=notificationEventCode, shareTable=shareTable, shareCreatedSuccessfully=shareCreatedSuccessfully, diskAlias=diskAlias, iscsiTotalReadMbps=iscsiTotalReadMbps, lunWriteIops=lunWriteIops, spareDiskReplaced=spareDiskReplaced, poolState=poolState, diskGoneOffline=diskGoneOffline, cacheTotalWriteMbps=cacheTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, smbSocketFailure=smbSocketFailure, haResourceActiveNode=haResourceActiveNode, lunProjectName=lunProjectName, alertsCleanupCompleted=alertsCleanupCompleted, globalStatistics=globalStatistics, nicName=nicName, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationDescription=notificationDescription, fcTargets=fcTargets, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskTotalReadMbps=diskTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, projectTable=projectTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareNFSReadMbps=shareNFSReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolCount=poolCount, projectTotalSaving=projectTotalSaving, nicTable=nicTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, tegileArray=tegileArray, networkInterfaceDown=networkInterfaceDown, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, volumeQuotaFinished=volumeQuotaFinished, ipmiFan=ipmiFan, ipmiThreshold=ipmiThreshold, tegile=tegile, upgradeDownloadCompleted=upgradeDownloadCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, projectIndex=projectIndex, snapshotRollbackFailed=snapshotRollbackFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskType=diskType, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStopFailed=smisServiceStopFailed, userLoginFailed=userLoginFailed, replicationSourceRegistered=replicationSourceRegistered, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, fcInitiators=fcInitiators, poolMetaWriteMbps=poolMetaWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, controllerHardwareModel=controllerHardwareModel, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTargetEntry=iscsiTargetEntry, fcTargetStatus=fcTargetStatus, tdpsUpgradeFailed=tdpsUpgradeFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReadLatency=lunReadLatency, shareDataSizeLow=shareDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTotalReadMbps=fcTotalReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolEntry=poolEntry, lunTargetGroup=lunTargetGroup, iscsiInitiatorName=iscsiInitiatorName, poolDataWriteIops=poolDataWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolReadCacheWriteIops=poolReadCacheWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, poolProjects=poolProjects, poolName=poolName, sharePoolName=sharePoolName, webdocsUpgradeFailed=webdocsUpgradeFailed, replicationFailed=replicationFailed, deleteFolderCompleted=deleteFolderCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, diskDataWriteIops=diskDataWriteIops, poolTotalSaving=poolTotalSaving, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, targetGroupMemberAdded=targetGroupMemberAdded, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorEntry=fcInitiatorEntry, diskPoolName=diskPoolName, nicReceiveMbps=nicReceiveMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tegileArray_notifications=tegileArray_notifications, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetEntry=fcTargetEntry, controllerDown=controllerDown, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cifsTotalReadIops=cifsTotalReadIops, iscsiProperties=iscsiProperties, fcTargetReadIops=fcTargetReadIops, cpuSystemCalls=cpuSystemCalls, properties=properties, shareCompressedRatio=shareCompressedRatio, lunProtocol=lunProtocol, nicEntry=nicEntry, diskIOCount=diskIOCount, pools=pools, diskIsOnline=diskIsOnline, sensorFailureEvent=sensorFailureEvent, projectCompressionEnabled=projectCompressionEnabled, haResourceName=haResourceName, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiTargetGroup=iscsiTargetGroup, shareDeleted=shareDeleted, ipmiMemory=ipmiMemory, diskDataWriteMbps=diskDataWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareQuotaFinished=shareQuotaFinished, poolImported=poolImported, diskDataReadMbps=diskDataReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, shareExceedThresholdWarning=shareExceedThresholdWarning, projectPoolName=projectPoolName, lunSnapshotSizeLow=lunSnapshotSizeLow, nicState=nicState, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, controllerTimeDrift=controllerTimeDrift, poolTotalWriteIops=poolTotalWriteIops, projectName=projectName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, memoryFailure=memoryFailure, haControllerB_Name=haControllerB_Name, cifsTotalWriteIops=cifsTotalWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, ntpServerTimeDrift=ntpServerTimeDrift, projectEntry=projectEntry, poolDataSizeLow=poolDataSizeLow, lunPoolName=lunPoolName, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, snmpServiceStarted=snmpServiceStarted, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorName=fcInitiatorName, poolDataReadLatency=poolDataReadLatency, smisServiceStopped=smisServiceStopped, fcInitiatorsTable=fcInitiatorsTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notifications=notifications, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegileGroups=tegileGroups, diskChassisIdx=diskChassisIdx, diskState=diskState, diskTotalReadIops=diskTotalReadIops, shareQuotaHigh=shareQuotaHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskSlowIo=diskSlowIo, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, volumeDeleteCompleted=volumeDeleteCompleted, poolMetaReadLatency=poolMetaReadLatency, basicCompliance=basicCompliance, networkInterfaceUp=networkInterfaceUp, poolDataSizeHigh=poolDataSizeHigh, shareNFSWriteIops=shareNFSWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, netbiosSocketFailure=netbiosSocketFailure, poolMetaWriteIops=poolMetaWriteIops, haResourceIndex=haResourceIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTargetError=iscsiTargetError)
