...
IpAddress, iso, Unsigned32, Counter32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, TimeTicks, Integer32, Gauge32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Unsigned32", "Counter32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "TimeTicks", "Integer32", "Gauge32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectCreatedSuccessfully=projectCreatedSuccessfully, adServerTimeDrift=adServerTimeDrift, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskIndex=diskIndex, upgradeTimeout=upgradeTimeout, iscsiInitiatorIndex=iscsiInitiatorIndex, poolSizeHigh=poolSizeHigh, poolMetaReadLatency=poolMetaReadLatency, projectEntry=projectEntry, iscsiTotalReadMbps=iscsiTotalReadMbps, lunEntry=lunEntry, smisServiceStartFailed=smisServiceStartFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationSensorNumber=notificationSensorNumber, cifsAvgReadLatency=cifsAvgReadLatency, poolEntry=poolEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, userLoginFailed=userLoginFailed, nfsTotalReadIops=nfsTotalReadIops, currentObjectGroup=currentObjectGroup, network=network, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcInitiatorName=fcInitiatorName, replicationAbandoned=replicationAbandoned, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetReadIops=fcTargetReadIops, diskAvgWriteLatency=diskAvgWriteLatency, diskSizeHigh=diskSizeHigh, poolAvgReadLatency=poolAvgReadLatency, diskCount=diskCount, shareNFSReadMbps=shareNFSReadMbps, tegileArray_notifications=tegileArray_notifications, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, notificationSensorAction=notificationSensorAction, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSEnabled=shareNFSEnabled, disks=disks, iscsiTargetIndex=iscsiTargetIndex, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunReservedSizeLow=lunReservedSizeLow, lunTargetGroup=lunTargetGroup, poolIndex=poolIndex, ipmiFan=ipmiFan, fcTargetName=fcTargetName, replicationAborted=replicationAborted, haResourcesTable=haResourcesTable, networkIpmpGroupDown=networkIpmpGroupDown, poolTotalWriteIops=poolTotalWriteIops, upgradeFailed=upgradeFailed, projectDataSizeHigh=projectDataSizeHigh, projectDeletionFailed=projectDeletionFailed, iscsiTargetError=iscsiTargetError, controllerHardwareModel=controllerHardwareModel, tdpsUpgradeFailed=tdpsUpgradeFailed, nfsAvgReadLatency=nfsAvgReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskTable=diskTable, iscsiTargetGroupError=iscsiTargetGroupError, shareDeleted=shareDeleted, snapshotRollbackFailed=snapshotRollbackFailed, lunProjectName=lunProjectName, cacheRAMReads=cacheRAMReads, poolAvgWriteLatency=poolAvgWriteLatency, controllerUp=controllerUp, haResourceGroup=haResourceGroup, poolCreated=poolCreated, cifsTotalWriteIops=cifsTotalWriteIops, pools=pools, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolExpanded=poolExpanded, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetReadIops=iscsiTargetReadIops, fcTotalWriteMbps=fcTotalWriteMbps, projectTotalSaving=projectTotalSaving, fcTargetEntry=fcTargetEntry, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargets=iscsiTargets, projectIndex=projectIndex, shareQuotaLow=shareQuotaLow, poolDeletionFailed=poolDeletionFailed, diskState=diskState, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareReservedSizeLow=shareReservedSizeLow, PYSNMP_MODULE_ID=tegile, networkTotalTransmitMbps=networkTotalTransmitMbps, diskAlias=diskAlias, poolDataSizeHigh=poolDataSizeHigh, shareDataSizeLow=shareDataSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, volumeQuotaFinished=volumeQuotaFinished, iscsiInitiators=iscsiInitiators, replicationStarted=replicationStarted, notificationTargetEntityName=notificationTargetEntityName, basicCompliance=basicCompliance, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolImported=poolImported, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolProjects=poolProjects, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunPoolName=lunPoolName, spareDiskReplaced=spareDiskReplaced, networkInterfaceDown=networkInterfaceDown, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, upgradeCompleted=upgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, nvdimmFailSoftError=nvdimmFailSoftError, nfsTotalWriteIops=nfsTotalWriteIops, poolDataReadLatency=poolDataReadLatency, shareIndex=shareIndex, shareProjectName=shareProjectName, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpGroupUp=networkIpmpGroupUp, shareNFSReadIops=shareNFSReadIops, lunWriteLatency=lunWriteLatency, poolDataSizeLow=poolDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataWriteMbps=poolDataWriteMbps, poolDataWriteLatency=poolDataWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tegile=tegile, poolUsedSizeLow=poolUsedSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolReadCacheReadIops=poolReadCacheReadIops, tegileCompliances=tegileCompliances, poolSizeLow=poolSizeLow, fcInitiatorsTable=fcInitiatorsTable, tegileGroups=tegileGroups, poolDataReadIops=poolDataReadIops, lunReadLatency=lunReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcAvgReadLatency=fcAvgReadLatency, haControllerA_Name=haControllerA_Name, projectQuotaFinished=projectQuotaFinished, haResourceDescription=haResourceDescription, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationEventCode=notificationEventCode, projectQuotaSizeLow=projectQuotaSizeLow, diskRandomIOCount=diskRandomIOCount, currentNotificationGroup=currentNotificationGroup, diskSizeLow=diskSizeLow, haControllerB_Uptime=haControllerB_Uptime, ipmiTemperature=ipmiTemperature, ipmiOther=ipmiOther, fcAvgWriteLatency=fcAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, projectModified=projectModified, shareDedupEnabled=shareDedupEnabled, nicTable=nicTable, projectShares=projectShares, ipmiThreshold=ipmiThreshold, shareDeletionFailed=shareDeletionFailed, projectName=projectName, smisServiceStopFailed=smisServiceStopFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetReadLatency=iscsiTargetReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTotalWriteIops=fcTotalWriteIops, replicationPaused=replicationPaused, lunIndex=lunIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetGroup=iscsiTargetGroup, nicName=nicName, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskEntry=diskEntry, shareNFSWriteIops=shareNFSWriteIops, sharePoolName=sharePoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskPoolName=diskPoolName, notifications=notifications, aclMigrationCompleted=aclMigrationCompleted, haControllerA_Uptime=haControllerA_Uptime, projectDataSizeLow=projectDataSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, lunName=lunName, iscsiTargetAlias=iscsiTargetAlias, nvdimmFailInitializationError=nvdimmFailInitializationError, diskDataWriteIops=diskDataWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, fcInitiators=fcInitiators, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCIFSReadIops=shareCIFSReadIops, poolFreeSizeHigh=poolFreeSizeHigh, poolUpgraded=poolUpgraded, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, aclMigrationStarted=aclMigrationStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolState=poolState, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareCompressedRatio=shareCompressedRatio, cifsTotalReadIops=cifsTotalReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskAvgReadLatency=diskAvgReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, notificationReadingUnit=notificationReadingUnit, haResourceName=haResourceName, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetName=iscsiTargetName, shareQuotaHigh=shareQuotaHigh, diskIsOnline=diskIsOnline, shareCIFSReadMbps=shareCIFSReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTotalReadMbps=poolTotalReadMbps, notificationTime=notificationTime, lunInitiatorGroup=lunInitiatorGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, poolTable=poolTable, lunSizeHigh=lunSizeHigh, lunGUID=lunGUID, snmpServiceStarted=snmpServiceStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, haResourceIndex=haResourceIndex, shareNFSReadLatency=shareNFSReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nfsTotalReadMbps=nfsTotalReadMbps, iscsiProperties=iscsiProperties, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcInitiatorCreateFailed=fcInitiatorCreateFailed, maintenanceModeEnabled=maintenanceModeEnabled, projectShareCount=projectShareCount, projectFreeSizeLow=projectFreeSizeLow, fcProperties=fcProperties, fcInitiatorGroup=fcInitiatorGroup, projectTable=projectTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, controllerTimeDrift=controllerTimeDrift, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectThresholdExceedWarning=projectThresholdExceedWarning)
mibBuilder.exportSymbols("TEGILE-MIB", controllerDown=controllerDown, vmwareNFSDatastores=vmwareNFSDatastores, haResourceActiveNode=haResourceActiveNode, projectDeleted=projectDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskError=diskError, cacheTotalWriteMbps=cacheTotalWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetsTable=iscsiTargetsTable, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTotalReadMbps=fcTotalReadMbps, projectPoolName=projectPoolName, smisServiceStarted=smisServiceStarted, shareEntry=shareEntry, projectCompressionEnabled=projectCompressionEnabled, fcTargetWriteMbps=fcTargetWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaReadMbps=poolMetaReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, nicState=nicState, ipmiCurrent=ipmiCurrent, diagnosticDataUploaded=diagnosticDataUploaded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetReadLatency=fcTargetReadLatency, diskGoneOffline=diskGoneOffline, fcTargetWriteLatency=fcTargetWriteLatency, ipmiMemory=ipmiMemory, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, replicationResumed=replicationResumed, shareCIFSWriteIops=shareCIFSWriteIops, poolName=poolName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cacheSSDReads=cacheSSDReads, poolHealth=poolHealth, iscsiTargetWriteLatency=iscsiTargetWriteLatency, replicationSourceRegistered=replicationSourceRegistered, cifsAvgWriteLatency=cifsAvgWriteLatency, poolOwnerController=poolOwnerController, shareTable=shareTable, notificationDescription=notificationDescription, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, globalStatistics=globalStatistics, shareReservedSizeHigh=shareReservedSizeHigh, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorName=iscsiInitiatorName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectDedupEnabled=projectDedupEnabled, diskDataReadIops=diskDataReadIops, lunTable=lunTable, fcTotalReadIops=fcTotalReadIops, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolDataWriteIops=poolDataWriteIops, poolCount=poolCount, cpuTotalUsage=cpuTotalUsage, unknownSensorEvent=unknownSensorEvent, smbSocketFailure=smbSocketFailure, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, cpuSystemCalls=cpuSystemCalls, shareMountPoint=shareMountPoint, iscsiTargetEntry=iscsiTargetEntry, iscsiWriteIops=iscsiWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, replicationFailed=replicationFailed, nicEntry=nicEntry, projectLUNs=projectLUNs, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectLunCount=projectLunCount, lunBlockSize=lunBlockSize, fcTargetStatus=fcTargetStatus, poolDegraded=poolDegraded, notificationObjects=notificationObjects, diskIOCount=diskIOCount, smisServiceStopped=smisServiceStopped, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaWriteIops=poolMetaWriteIops, properties=properties, haResourceStatus=haResourceStatus, shareSnapshotSizeLow=shareSnapshotSizeLow, snmpAgentVersion=snmpAgentVersion, lunCompressedRatio=lunCompressedRatio, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicGroup=nicGroup, shareExceedThresholdWarning=shareExceedThresholdWarning, sanProperties=sanProperties, networkTotalReceiveMbps=networkTotalReceiveMbps, poolMetaWriteLatency=poolMetaWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, deleteFolderFailed=deleteFolderFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunDataSizeHigh=lunDataSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationComplete=replicationComplete, projectSnapshotSizeLow=projectSnapshotSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerB_Name=haControllerB_Name, cpuInterrupts=cpuInterrupts, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, notificationSeverity=notificationSeverity, fcPortOnline=fcPortOnline, shareQuotaFinished=shareQuotaFinished, testNotification=testNotification, lunCompressionEnabled=lunCompressionEnabled, ipmiVoltage=ipmiVoltage, networkInterfaceUp=networkInterfaceUp, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaReadIops=poolMetaReadIops, volumeModifyCompleted=volumeModifyCompleted, haControllerA_IPAddr=haControllerA_IPAddr, nicTransmitMbps=nicTransmitMbps, fcTargetsTable=fcTargetsTable, snapshotCreationFailed=snapshotCreationFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcInitiatorIndex=fcInitiatorIndex, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSlowIo=diskSlowIo, tegileConformance=tegileConformance, fcPortOffline=fcPortOffline, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, lunSizeLow=lunSizeLow, cacheTotalReadMbps=cacheTotalReadMbps, diskDataReadMbps=diskDataReadMbps, lunReadMbps=lunReadMbps, lunReadIops=lunReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareName=shareName, sensorFailureEvent=sensorFailureEvent, haControllerB_IPAddr=haControllerB_IPAddr, memoryFailure=memoryFailure, poolTotalSaving=poolTotalSaving, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskTotalWriteIops=diskTotalWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicIndex=nicIndex, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceEntry=haResourceEntry, diskType=diskType, poolExported=poolExported, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, volumeDeleteFailed=volumeDeleteFailed, poolTotalReadIops=poolTotalReadIops, volumeDeleteCompleted=volumeDeleteCompleted, upgradeStarted=upgradeStarted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, deleteFolderCompleted=deleteFolderCompleted, diskSequentialIOCount=diskSequentialIOCount, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileArray=tegileArray, nicReceiveMbps=nicReceiveMbps, shareDataSizeHigh=shareDataSizeHigh, shareCompressionEnabled=shareCompressionEnabled, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDeleted=poolDeleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcInitiatorEntry=fcInitiatorEntry, cacheTotalReadIops=cacheTotalReadIops, replicationTargetDeleted=replicationTargetDeleted, poolProjectCount=poolProjectCount, nicMTU=nicMTU, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolQuotaFinished=poolQuotaFinished, diskDataWriteMbps=diskDataWriteMbps, lunWriteIops=lunWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, lunDedupEnabled=lunDedupEnabled, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, ipmiPowerSupply=ipmiPowerSupply, fcTargetIndex=fcTargetIndex, snmpServiceStopped=snmpServiceStopped, netbiosSocketFailure=netbiosSocketFailure, lunFreeSizeLow=lunFreeSizeLow, haResources=haResources, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolMetaWriteMbps=poolMetaWriteMbps, lunProtocol=lunProtocol, diskChassisIdx=diskChassisIdx, lunDataSizeLow=lunDataSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, notificationProps=notificationProps, notificationComponentName=notificationComponentName, fcTargets=fcTargets, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetAuth=iscsiTargetAuth, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, cifsTotalReadMbps=cifsTotalReadMbps)
