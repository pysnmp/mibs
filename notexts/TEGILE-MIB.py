...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:10:27 2022
...
Gauge32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter64, NotificationType, enterprises, IpAddress, iso, Bits, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter64", "NotificationType", "enterprises", "IpAddress", "iso", "Bits", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiThreshold=ipmiThreshold, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, projectPoolName=projectPoolName, snapshotCreationFailed=snapshotCreationFailed, poolTotalSaving=poolTotalSaving, haResourceName=haResourceName, fcTotalReadIops=fcTotalReadIops, fcInitiatorsTable=fcInitiatorsTable, diskSizeHigh=diskSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, poolReadCacheWriteLatency=poolReadCacheWriteLatency, replicationFailed=replicationFailed, diskEntry=diskEntry, shareProjectName=shareProjectName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, smisServiceStopped=smisServiceStopped, lunName=lunName, cacheTotalWriteMbps=cacheTotalWriteMbps, lunSizeLow=lunSizeLow, disks=disks, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationDescription=notificationDescription, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicName=nicName, fcInitiators=fcInitiators, upgradeDownloadCompleted=upgradeDownloadCompleted, projectCompressionEnabled=projectCompressionEnabled, volumeModifyCompleted=volumeModifyCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiWriteIops=iscsiWriteIops, diskError=diskError, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerB_IPAddr=haControllerB_IPAddr, notificationTime=notificationTime, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTotalWriteMbps=fcTotalWriteMbps, properties=properties, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolMetaWriteIops=poolMetaWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, cacheSSDReads=cacheSSDReads, fcTargetReadIops=fcTargetReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, projectFreeSizeLow=projectFreeSizeLow, nicMTU=nicMTU, poolState=poolState, poolReadCacheReadLatency=poolReadCacheReadLatency, diskAvgReadLatency=diskAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, poolTotalWriteIops=poolTotalWriteIops, poolSizeHigh=poolSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, projectQuotaSizeHigh=projectQuotaSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, network=network, replicationAborted=replicationAborted, notificationProps=notificationProps, poolAvgWriteLatency=poolAvgWriteLatency, poolDegraded=poolDegraded, nvdimmFailDeviceError=nvdimmFailDeviceError, smisServiceStartFailed=smisServiceStartFailed, lunProtocol=lunProtocol, iscsiTargetEntry=iscsiTargetEntry, diskIndex=diskIndex, poolDataReadLatency=poolDataReadLatency, aclMigrationCompleted=aclMigrationCompleted, cacheRAMReads=cacheRAMReads, shareIndex=shareIndex, currentObjectGroup=currentObjectGroup, nicTable=nicTable, ipmiCurrent=ipmiCurrent, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolProjectCount=poolProjectCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolProjects=poolProjects, iscsiTargetGroupError=iscsiTargetGroupError, poolDeletionFailed=poolDeletionFailed, smbSocketFailure=smbSocketFailure, notificationEventCode=notificationEventCode, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareDeletionFailed=shareDeletionFailed, lunTable=lunTable, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeStarted=upgradeStarted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, diskCount=diskCount, poolExpanded=poolExpanded, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsTotalWriteMbps=nfsTotalWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, replicationAbandoned=replicationAbandoned, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectDataSizeHigh=projectDataSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskIsOnline=diskIsOnline, adServerTimeDrift=adServerTimeDrift, shareCIFSReadLatency=shareCIFSReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, lunEntry=lunEntry, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetWriteIops=fcTargetWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastores=vmwareNFSDatastores, cacheTotalWriteIops=cacheTotalWriteIops, lunDataSizeHigh=lunDataSizeHigh, nicReceiveMbps=nicReceiveMbps, poolDataReadIops=poolDataReadIops, diskRandomIOCount=diskRandomIOCount, targetGroupCreateCompleted=targetGroupCreateCompleted, poolHealth=poolHealth, lunTargetGroup=lunTargetGroup, shareCIFSReadMbps=shareCIFSReadMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolAvgReadLatency=poolAvgReadLatency, projectTotalSaving=projectTotalSaving, poolQuotaFinished=poolQuotaFinished, snmpServiceStartFailed=snmpServiceStartFailed, lunReadIops=lunReadIops, unknownSensorEvent=unknownSensorEvent, currentNotificationGroup=currentNotificationGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeCompleted=upgradeCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCloneCompleted=snapshotCloneCompleted, nicTransmitMbps=nicTransmitMbps, fcTotalWriteIops=fcTotalWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetName=fcTargetName, projectDedupEnabled=projectDedupEnabled, cpuTotalUsage=cpuTotalUsage, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataReadIops=diskDataReadIops, projectEntry=projectEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetWriteIops=iscsiTargetWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, sharePoolName=sharePoolName, diskSlowIo=diskSlowIo, fcTargetReadMbps=fcTargetReadMbps, nicState=nicState, controllerDown=controllerDown, notificationSeverity=notificationSeverity, shareQuotaLow=shareQuotaLow, shareDeleted=shareDeleted, fcPortOnline=fcPortOnline, nvdimmFailSoftError=nvdimmFailSoftError, lunCompressedRatio=lunCompressedRatio, haResourceGroup=haResourceGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, PYSNMP_MODULE_ID=tegile, fcTargetStatus=fcTargetStatus, networkInterfaceDown=networkInterfaceDown, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, basicCompliance=basicCompliance, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceActiveNode=haResourceActiveNode, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheReadMbps=poolReadCacheReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiTargetReadIops=iscsiTargetReadIops, memoryFailure=memoryFailure, shareDedupEnabled=shareDedupEnabled, shareExceedThresholdWarning=shareExceedThresholdWarning, diskIOCount=diskIOCount, upgradeDownloadStarted=upgradeDownloadStarted, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorEntry=fcInitiatorEntry, diskChassisIdx=diskChassisIdx, iscsiInitiatorIndex=iscsiInitiatorIndex, projectModified=projectModified, poolCount=poolCount, lunPoolName=lunPoolName, replicationResumed=replicationResumed, haControllerB_Uptime=haControllerB_Uptime, ipmiTemperature=ipmiTemperature, aclMigrationStarted=aclMigrationStarted, projectName=projectName, nfsTotalReadMbps=nfsTotalReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolEntry=poolEntry, notificationComponentName=notificationComponentName, haResourceDescription=haResourceDescription, diskTotalReadIops=diskTotalReadIops, haResourcesTable=haResourcesTable, shareCompressedRatio=shareCompressedRatio, tegileArray=tegileArray, networkIpmpGroupDown=networkIpmpGroupDown, lunDataSizeLow=lunDataSizeLow, projectIndex=projectIndex, iscsiProperties=iscsiProperties, iscsiAvgReadLatency=iscsiAvgReadLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, fcInitiatorName=fcInitiatorName, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareQuotaFinished=shareQuotaFinished, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargets=iscsiTargets, projectLunCount=projectLunCount, replicationComplete=replicationComplete, iscsiTargetIndex=iscsiTargetIndex, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetIndex=fcTargetIndex, poolReadCacheReadIops=poolReadCacheReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snmpServiceStopped=snmpServiceStopped, poolMetaReadMbps=poolMetaReadMbps, shareReservedSizeLow=shareReservedSizeLow, diskState=diskState, lunInitiatorGroup=lunInitiatorGroup, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, userLoginFailed=userLoginFailed, sanProperties=sanProperties, ipmiFan=ipmiFan, projectDataSizeLow=projectDataSizeLow, lunBlockSize=lunBlockSize, tegile=tegile, haResourceStatus=haResourceStatus, networkIpmpGroupUp=networkIpmpGroupUp, tegileConformance=tegileConformance, cpuInterrupts=cpuInterrupts)
mibBuilder.exportSymbols("TEGILE-MIB", replicationTargetDeleted=replicationTargetDeleted, notificationSensorNumber=notificationSensorNumber, targetGroupMemberAdded=targetGroupMemberAdded, shareDataSizeLow=shareDataSizeLow, notificationReadingUnit=notificationReadingUnit, iscsiTargetError=iscsiTargetError, diskGoneOffline=diskGoneOffline, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, controllerUp=controllerUp, nfsTotalReadIops=nfsTotalReadIops, projectDeleted=projectDeleted, targetGroupMemberRemoved=targetGroupMemberRemoved, fcProperties=fcProperties, deleteFolderFailed=deleteFolderFailed, poolTable=poolTable, haControllerB_Name=haControllerB_Name, ipmiOther=ipmiOther, snmpAgentVersion=snmpAgentVersion, ipmiVoltage=ipmiVoltage, poolImported=poolImported, diskDataWriteIops=diskDataWriteIops, nicIndex=nicIndex, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolFreeSizeHigh=poolFreeSizeHigh, lunReadLatency=lunReadLatency, pools=pools, fcTargetGroup=fcTargetGroup, iscsiTargetAuth=iscsiTargetAuth, globalStatistics=globalStatistics, poolDataSizeLow=poolDataSizeLow, ipmiMemory=ipmiMemory, haControllerA_Name=haControllerA_Name, controllerHardwareModel=controllerHardwareModel, projectShares=projectShares, diskTotalWriteIops=diskTotalWriteIops, notificationSensorAction=notificationSensorAction, upgradeDownloadFailed=upgradeDownloadFailed, poolCreated=poolCreated, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareQuotaHigh=shareQuotaHigh, shareNFSReadMbps=shareNFSReadMbps, shareDataSizeHigh=shareDataSizeHigh, networkInterfaceUp=networkInterfaceUp, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, cifsTotalWriteIops=cifsTotalWriteIops, diskPoolName=diskPoolName, lunCompressionEnabled=lunCompressionEnabled, shareNFSReadIops=shareNFSReadIops, poolFreeSizeLow=poolFreeSizeLow, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationObjects=notificationObjects, poolTotalReadIops=poolTotalReadIops, lunIndex=lunIndex, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeFailed=upgradeFailed, ipmiPowerSupply=ipmiPowerSupply, lunSizeHigh=lunSizeHigh, smisServiceStopFailed=smisServiceStopFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, haResourceIndex=haResourceIndex, projectShareCount=projectShareCount, iscsiTargetName=iscsiTargetName, fcTargetReadLatency=fcTargetReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteMbps=poolDataWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, diskSizeLow=diskSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, diskAlias=diskAlias, diskTotalWriteMbps=diskTotalWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, haControllerA_Uptime=haControllerA_Uptime, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorName=iscsiInitiatorName, shareTable=shareTable, diskTable=diskTable, iscsiInitiatorsTable=iscsiInitiatorsTable, fcAvgWriteLatency=fcAvgWriteLatency, shareCIFSReadIops=shareCIFSReadIops, lunWriteLatency=lunWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, volumeDeleteFailed=volumeDeleteFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, nvdimmFailInitializationError=nvdimmFailInitializationError, cacheTotalReadMbps=cacheTotalReadMbps, tegileArray_notifications=tegileArray_notifications, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaReadIops=poolMetaReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, nicGroup=nicGroup, diskType=diskType, poolDataReadMbps=poolDataReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskTotalReadMbps=diskTotalReadMbps, fcTargetsTable=fcTargetsTable, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorGroup=fcInitiatorGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectQuotaFinished=projectQuotaFinished, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, netbiosSocketFailure=netbiosSocketFailure, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDeletionFailed=projectDeletionFailed, lunFreeSizeHigh=lunFreeSizeHigh, haResources=haResources, fcTargetEntry=fcTargetEntry, snapshotDeleteFailed=snapshotDeleteFailed, maintenanceModeEnabled=maintenanceModeEnabled, testNotification=testNotification, iscsiTargetGroup=iscsiTargetGroup, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationPaused=replicationPaused, tegileGroups=tegileGroups, cpuSystemCalls=cpuSystemCalls, lunReservedSizeHigh=lunReservedSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDeleted=poolDeleted, diskDataWriteMbps=diskDataWriteMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunWriteMbps=lunWriteMbps, lunProjectName=lunProjectName, nfsAvgWriteLatency=nfsAvgWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunReadMbps=lunReadMbps, lunReservedSizeLow=lunReservedSizeLow, poolExported=poolExported, haResourceEntry=haResourceEntry, poolIndex=poolIndex, projectFreeSizeHigh=projectFreeSizeHigh, shareName=shareName, snmpServiceStarted=snmpServiceStarted, networkTotalTransmitMbps=networkTotalTransmitMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, volumeDeleteCompleted=volumeDeleteCompleted, haControllerA_IPAddr=haControllerA_IPAddr, fcTargets=fcTargets, poolMetaReadLatency=poolMetaReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunWriteIops=lunWriteIops, snapshotCloningFailed=snapshotCloningFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, deleteFolderCompleted=deleteFolderCompleted, poolDataWriteLatency=poolDataWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicEntry=nicEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolName=poolName, shareCIFSWriteLatency=shareCIFSWriteLatency, tegileCompliances=tegileCompliances, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationTargetEntityName=notificationTargetEntityName, poolDataWriteIops=poolDataWriteIops, shareEntry=shareEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectTable=projectTable, initiatorGroupMemberAdded=initiatorGroupMemberAdded, replicationStarted=replicationStarted, fcInitiatorIndex=fcInitiatorIndex, cacheTotalReadIops=cacheTotalReadIops, shareMountPoint=shareMountPoint, poolSizeLow=poolSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notifications=notifications, poolUpgraded=poolUpgraded, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, controllerTimeDrift=controllerTimeDrift, fcTargetWriteLatency=fcTargetWriteLatency, poolOwnerController=poolOwnerController, lunGUID=lunGUID, iscsiTargetAlias=iscsiTargetAlias, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, upgradeTimeout=upgradeTimeout, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeDisabled=maintenanceModeDisabled, poolTotalWriteMbps=poolTotalWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcPortOffline=fcPortOffline, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTotalReadIops=iscsiTotalReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectLUNs=projectLUNs, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps)
