...
TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, iso, Gauge32, enterprises, Counter32, IpAddress, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "Gauge32", "enterprises", "Counter32", "IpAddress", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpGroupUp=networkIpmpGroupUp, shareQuotaLow=shareQuotaLow, testNotification=testNotification, shareQuotaHigh=shareQuotaHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, tdpsUpgradeFailed=tdpsUpgradeFailed, projectDeleted=projectDeleted, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationSensorNumber=notificationSensorNumber, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunTable=lunTable, projectFreeSizeHigh=projectFreeSizeHigh, volumeQuotaFinished=volumeQuotaFinished, projectTable=projectTable, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskTable=diskTable, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskPoolName=diskPoolName, poolIndex=poolIndex, lunReadLatency=lunReadLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsAvgReadLatency=cifsAvgReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareDeleted=shareDeleted, poolTotalWriteMbps=poolTotalWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, userLoginFailed=userLoginFailed, notificationSensorSuspect=notificationSensorSuspect, shareCIFSWriteMbps=shareCIFSWriteMbps, poolDataWriteLatency=poolDataWriteLatency, notificationProps=notificationProps, iscsiTotalReadIops=iscsiTotalReadIops, diskDataWriteIops=diskDataWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, upgradeDownloadCompleted=upgradeDownloadCompleted, globalStatistics=globalStatistics, lunWriteMbps=lunWriteMbps, volumeDeleteFailed=volumeDeleteFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskIOCount=diskIOCount, lunWriteIops=lunWriteIops, poolSizeLow=poolSizeLow, networkInterfaceUp=networkInterfaceUp, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, notificationObjects=notificationObjects, poolDeletionFailed=poolDeletionFailed, projectModified=projectModified, unknownSensorEvent=unknownSensorEvent, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskRandomIOCount=diskRandomIOCount, ipmiOther=ipmiOther, poolDataReadMbps=poolDataReadMbps, nicTransmitMbps=nicTransmitMbps, diskError=diskError, fcTargetWriteMbps=fcTargetWriteMbps, poolProjectCount=poolProjectCount, haControllerA_Name=haControllerA_Name, shareCIFSWriteIops=shareCIFSWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, fcTargetReadIops=fcTargetReadIops, shareIndex=shareIndex, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskAvgReadLatency=diskAvgReadLatency, projectFreeSizeLow=projectFreeSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargetReadMbps=fcTargetReadMbps, shareNFSReadLatency=shareNFSReadLatency, diskChassisIdx=diskChassisIdx, nicMTU=nicMTU, diskDataReadIops=diskDataReadIops, shareProjectName=shareProjectName, nfsTotalWriteIops=nfsTotalWriteIops, controllerHardwareModel=controllerHardwareModel, fcTotalReadMbps=fcTotalReadMbps, poolProjects=poolProjects, shareName=shareName, lunEntry=lunEntry, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskTotalWriteIops=diskTotalWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiProperties=iscsiProperties, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, aclMigrationStarted=aclMigrationStarted, adServerTimeDrift=adServerTimeDrift, replicationTargetDeleted=replicationTargetDeleted, poolImported=poolImported, smisServiceStarted=smisServiceStarted, tegileGroups=tegileGroups, shareSnapshotSizeLow=shareSnapshotSizeLow, shareDeletionFailed=shareDeletionFailed, smisServiceStopped=smisServiceStopped, replicationFailed=replicationFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDedupEnabled=projectDedupEnabled, fcTargetGroup=fcTargetGroup, notificationReadingUnit=notificationReadingUnit, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareReservedSizeLow=shareReservedSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, projectTotalSaving=projectTotalSaving, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationDescription=notificationDescription, poolEntry=poolEntry, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, ipmiVoltage=ipmiVoltage, poolDeleted=poolDeleted, iscsiTargetIndex=iscsiTargetIndex, nicName=nicName, shareDedupEnabled=shareDedupEnabled, tegile=tegile, cifsAvgWriteLatency=cifsAvgWriteLatency, upgradeTimeout=upgradeTimeout, lunIndex=lunIndex, PYSNMP_MODULE_ID=tegile, iscsiTargetName=iscsiTargetName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, networkInterfaceDown=networkInterfaceDown, alertsCleanupCompleted=alertsCleanupCompleted, replicationAborted=replicationAborted, targetGroupMemberRemoved=targetGroupMemberRemoved, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationSourceRegistered=replicationSourceRegistered, lunCompressionEnabled=lunCompressionEnabled, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSWriteIops=shareNFSWriteIops, diskGoneOffline=diskGoneOffline, replicationResumed=replicationResumed, lunGUID=lunGUID, lunBlockSize=lunBlockSize, projectThresholdExceedWarning=projectThresholdExceedWarning, poolUpgraded=poolUpgraded, shareNFSReadIops=shareNFSReadIops, fcTargets=fcTargets, fcInitiatorName=fcInitiatorName, iscsiTargetsTable=iscsiTargetsTable, iscsiWriteIops=iscsiWriteIops, projectDataSizeLow=projectDataSizeLow, ipmiPowerSupply=ipmiPowerSupply, cacheTotalReadIops=cacheTotalReadIops, snmpServiceStopped=snmpServiceStopped, iscsiTargetGroup=iscsiTargetGroup, poolMetaReadLatency=poolMetaReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataSizeLow=poolDataSizeLow, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunWriteLatency=lunWriteLatency, properties=properties, projectPoolName=projectPoolName, tegileConformance=tegileConformance, spareDiskReplaced=spareDiskReplaced, haResourceEntry=haResourceEntry, poolMetaReadIops=poolMetaReadIops, poolTable=poolTable, notificationEventCode=notificationEventCode, fcTargetModifyCompleted=fcTargetModifyCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, smbSocketFailure=smbSocketFailure, diskCount=diskCount, upgradeDownloadFailed=upgradeDownloadFailed, poolName=poolName, diskDataReadMbps=diskDataReadMbps, poolFreeSizeLow=poolFreeSizeLow, lunReadIops=lunReadIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskEntry=diskEntry, cacheRAMReads=cacheRAMReads, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, lunDataSizeLow=lunDataSizeLow, fcInitiators=fcInitiators, poolFreeSizeHigh=poolFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareCompressedRatio=shareCompressedRatio, haControllerA_IPAddr=haControllerA_IPAddr, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetEntry=iscsiTargetEntry, fcProperties=fcProperties, shareEntry=shareEntry, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationTargetEntityName=notificationTargetEntityName, nvdimmFailSoftError=nvdimmFailSoftError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, netbiosSocketFailure=netbiosSocketFailure, lunReservedSizeLow=lunReservedSizeLow, diskSlowIo=diskSlowIo, diskAvgWriteLatency=diskAvgWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, currentObjectGroup=currentObjectGroup, ipmiMemory=ipmiMemory, networkTotalReceiveMbps=networkTotalReceiveMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolDegraded=poolDegraded, haResourceGroup=haResourceGroup, fcTargetStatus=fcTargetStatus, haResourceStatus=haResourceStatus, tegileCompliances=tegileCompliances, smisServiceStopFailed=smisServiceStopFailed, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, memoryFailure=memoryFailure, lunName=lunName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, targetGroupMemberAdded=targetGroupMemberAdded, volumeDeleteCompleted=volumeDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicReceiveMbps=nicReceiveMbps, poolAvgReadLatency=poolAvgReadLatency, currentNotificationGroup=currentNotificationGroup, poolTotalWriteIops=poolTotalWriteIops, poolTotalReadIops=poolTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, fcPortOnline=fcPortOnline, volumeModifyCompleted=volumeModifyCompleted, sanProperties=sanProperties, poolUsedSizeLow=poolUsedSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diagnosticDataUploaded=diagnosticDataUploaded)
mibBuilder.exportSymbols("TEGILE-MIB", nicEntry=nicEntry, diskDataWriteMbps=diskDataWriteMbps, projectIndex=projectIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationComponentName=notificationComponentName, fcInitiatorsTable=fcInitiatorsTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, haControllerA_Uptime=haControllerA_Uptime, upgradeCompleted=upgradeCompleted, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunProjectName=lunProjectName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskTotalReadMbps=diskTotalReadMbps, haControllerB_Uptime=haControllerB_Uptime, disks=disks, poolDataReadLatency=poolDataReadLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunReadMbps=lunReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, controllerTimeDrift=controllerTimeDrift, lunTargetGroup=lunTargetGroup, fcTargetIndex=fcTargetIndex, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetAlias=iscsiTargetAlias, poolExported=poolExported, replicationPaused=replicationPaused, lunSizeHigh=lunSizeHigh, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareDataSizeHigh=shareDataSizeHigh, fcTargetName=fcTargetName, projectLUNs=projectLUNs, poolCount=poolCount, fcInitiatorCreateFailed=fcInitiatorCreateFailed, cpuInterrupts=cpuInterrupts, fcAvgReadLatency=fcAvgReadLatency, fcTotalReadIops=fcTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, shareQuotaFinished=shareQuotaFinished, snapshotCreationFailed=snapshotCreationFailed, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, lunInitiatorGroup=lunInitiatorGroup, notificationSeverity=notificationSeverity, ipmiThreshold=ipmiThreshold, nicTable=nicTable, nfsTotalReadIops=nfsTotalReadIops, pools=pools, projectName=projectName, poolDataWriteMbps=poolDataWriteMbps, poolMetaReadMbps=poolMetaReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, snapshotCloningFailed=snapshotCloningFailed, diskTotalReadIops=diskTotalReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, upgradeDownloadStarted=upgradeDownloadStarted, lunSizeLow=lunSizeLow, poolMetaWriteIops=poolMetaWriteIops, replicationAbandoned=replicationAbandoned, replicationComplete=replicationComplete, sharePoolName=sharePoolName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetsTable=fcTargetsTable, poolExpanded=poolExpanded, diskType=diskType, iscsiInitiatorEntry=iscsiInitiatorEntry, ipmiFan=ipmiFan, lunDataSizeHigh=lunDataSizeHigh, lunDedupEnabled=lunDedupEnabled, webdocsUpgradeFailed=webdocsUpgradeFailed, diskIsOnline=diskIsOnline, replicationStarted=replicationStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, poolDataWriteIops=poolDataWriteIops, nfsAvgReadLatency=nfsAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolCreated=poolCreated, poolReadCacheReadMbps=poolReadCacheReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, cifsTotalReadIops=cifsTotalReadIops, iscsiInitiatorName=iscsiInitiatorName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snmpAgentVersion=snmpAgentVersion, poolReadCacheReadIops=poolReadCacheReadIops, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorsTable=iscsiInitiatorsTable, poolState=poolState, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, ipmiCurrent=ipmiCurrent, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notifications=notifications, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerDown=controllerDown, poolDataSizeHigh=poolDataSizeHigh, lunPoolName=lunPoolName, projectShareCount=projectShareCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolSizeHigh=poolSizeHigh, lunProtocol=lunProtocol, ipmiTemperature=ipmiTemperature, fcInitiatorGroup=fcInitiatorGroup, shareNFSWriteLatency=shareNFSWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, nicGroup=nicGroup, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskSizeLow=diskSizeLow, projectShares=projectShares, tegileArray_notifications=tegileArray_notifications, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorEntry=fcInitiatorEntry, maintenanceModeDisabled=maintenanceModeDisabled, haResourceName=haResourceName, poolOwnerController=poolOwnerController, sensorFailureEvent=sensorFailureEvent, haResourceActiveNode=haResourceActiveNode, cacheSSDReads=cacheSSDReads, deleteFolderFailed=deleteFolderFailed, haControllerB_Name=haControllerB_Name, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cifsTotalReadMbps=cifsTotalReadMbps, fcTargetEntry=fcTargetEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargets=iscsiTargets, notificationTime=notificationTime, network=network, fcTargetReadLatency=fcTargetReadLatency, poolTotalReadMbps=poolTotalReadMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationSensorAction=notificationSensorAction, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareDataSizeLow=shareDataSizeLow, projectLunCount=projectLunCount, projectCompressionEnabled=projectCompressionEnabled, fcPortOffline=fcPortOffline, vmwareNFSDatastores=vmwareNFSDatastores, projectQuotaFinished=projectQuotaFinished, fcTotalWriteMbps=fcTotalWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectQuotaSizeLow=projectQuotaSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicIndex=nicIndex, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, lunReservedSizeHigh=lunReservedSizeHigh, shareNFSEnabled=shareNFSEnabled, upgradeFailed=upgradeFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nicState=nicState, iscsiInitiators=iscsiInitiators, tegileArray=tegileArray, diskSizeHigh=diskSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, basicCompliance=basicCompliance, iscsiTargetAuth=iscsiTargetAuth, controllerUp=controllerUp, iscsiTargetError=iscsiTargetError, haResourcesTable=haResourcesTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cpuSystemCalls=cpuSystemCalls, diskState=diskState, upgradeStarted=upgradeStarted, poolQuotaFinished=poolQuotaFinished, poolHealth=poolHealth, poolDataReadIops=poolDataReadIops, snmpServiceStarted=snmpServiceStarted, projectEntry=projectEntry, haResourceDescription=haResourceDescription, shareTable=shareTable, snmpServiceStartFailed=snmpServiceStartFailed, cpuTotalUsage=cpuTotalUsage, diskAlias=diskAlias, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetWriteLatency=fcTargetWriteLatency, projectDeletionFailed=projectDeletionFailed, haResourceIndex=haResourceIndex, diskIndex=diskIndex, haResources=haResources, shareCIFSEnabled=shareCIFSEnabled, shareExceedThresholdWarning=shareExceedThresholdWarning, shareMountPoint=shareMountPoint, fcTotalWriteIops=fcTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled)
