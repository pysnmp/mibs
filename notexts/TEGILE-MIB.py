...
ModuleIdentity, Counter32, enterprises, IpAddress, Counter64, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier, Bits, Unsigned32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "enterprises", "IpAddress", "Counter64", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetWriteMbps=fcTargetWriteMbps, fcTotalReadIops=fcTotalReadIops, haResourceIndex=haResourceIndex, lunWriteMbps=lunWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, projectDataSizeLow=projectDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectIndex=projectIndex, cpuSystemCalls=cpuSystemCalls, diskAvgReadLatency=diskAvgReadLatency, nicMTU=nicMTU, networkTotalReceiveMbps=networkTotalReceiveMbps, poolSizeHigh=poolSizeHigh, lunSizeLow=lunSizeLow, shareName=shareName, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, networkInterfaceDown=networkInterfaceDown, projectShareCount=projectShareCount, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, poolDeletionFailed=poolDeletionFailed, lunDataSizeLow=lunDataSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, poolIndex=poolIndex, iscsiInitiators=iscsiInitiators, poolEntry=poolEntry, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, sanProperties=sanProperties, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaReadIops=poolMetaReadIops, shareNFSWriteMbps=shareNFSWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationReadingUnit=notificationReadingUnit, nvdimmFailDeviceError=nvdimmFailDeviceError, projectLUNs=projectLUNs, lunName=lunName, lunSizeHigh=lunSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nfsTotalReadIops=nfsTotalReadIops, disks=disks, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectDedupEnabled=projectDedupEnabled, fcInitiatorEntry=fcInitiatorEntry, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunTable=lunTable, fcInitiators=fcInitiators, snapshotDeleteFailed=snapshotDeleteFailed, poolCount=poolCount, notificationTime=notificationTime, poolUsedSizeLow=poolUsedSizeLow, haControllerA_Uptime=haControllerA_Uptime, smbSocketFailure=smbSocketFailure, poolExpanded=poolExpanded, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetIndex=iscsiTargetIndex, poolTotalSaving=poolTotalSaving, iscsiTargets=iscsiTargets, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, userLoginFailed=userLoginFailed, nicTable=nicTable, projectShares=projectShares, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcAvgReadLatency=fcAvgReadLatency, poolAvgWriteLatency=poolAvgWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunWriteLatency=lunWriteLatency, diskSizeHigh=diskSizeHigh, shareDataSizeLow=shareDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationProps=notificationProps, iscsiAvgReadLatency=iscsiAvgReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, pools=pools, diagnosticDataUploaded=diagnosticDataUploaded, nvdimmFailUnknownError=nvdimmFailUnknownError, snmpServiceStopFailed=snmpServiceStopFailed, notificationDescription=notificationDescription, projectEntry=projectEntry, diskIsOnline=diskIsOnline, upgradeCompleted=upgradeCompleted, cpuTotalUsage=cpuTotalUsage, aclMigrationStarted=aclMigrationStarted, nvdimmFailSoftError=nvdimmFailSoftError, poolMetaWriteLatency=poolMetaWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cacheTotalWriteMbps=cacheTotalWriteMbps, haResourceName=haResourceName, networkTotalTransmitMbps=networkTotalTransmitMbps, controllerTimeDrift=controllerTimeDrift, nicState=nicState, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCreationFailed=snapshotCreationFailed, PYSNMP_MODULE_ID=tegile, replicationPaused=replicationPaused, tegile=tegile, shareMountPoint=shareMountPoint, projectCreatedSuccessfully=projectCreatedSuccessfully, poolProjectCount=poolProjectCount, targetGroupMemberRemoved=targetGroupMemberRemoved, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskDataReadMbps=diskDataReadMbps, basicCompliance=basicCompliance, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareNFSWriteLatency=shareNFSWriteLatency, nicName=nicName, unknownSensorEvent=unknownSensorEvent, fcTargetStatus=fcTargetStatus, nicIndex=nicIndex, volumeDeleteFailed=volumeDeleteFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataReadIops=poolDataReadIops, shareNFSReadMbps=shareNFSReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorsTable=fcInitiatorsTable, ipmiOther=ipmiOther, shareDeleted=shareDeleted, projectDeleted=projectDeleted, iscsiTargetAlias=iscsiTargetAlias, lunInitiatorGroup=lunInitiatorGroup, fcPortOnline=fcPortOnline, lunBlockSize=lunBlockSize, aclMigrationCompleted=aclMigrationCompleted, diskTable=diskTable, lunReadMbps=lunReadMbps, projectDeletionFailed=projectDeletionFailed, volumeQuotaFinished=volumeQuotaFinished, replicationAbandoned=replicationAbandoned, shareQuotaHigh=shareQuotaHigh, diskTotalWriteIops=diskTotalWriteIops, haResourceStatus=haResourceStatus, shareNFSReadIops=shareNFSReadIops, upgradeTimeout=upgradeTimeout, lunProtocol=lunProtocol, shareCIFSWriteLatency=shareCIFSWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareTable=shareTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunProjectName=lunProjectName, fcTargetsTable=fcTargetsTable, smisServiceStopFailed=smisServiceStopFailed, replicationComplete=replicationComplete, poolDataWriteMbps=poolDataWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, shareEntry=shareEntry, fcTotalReadMbps=fcTotalReadMbps, poolTotalWriteIops=poolTotalWriteIops, nicEntry=nicEntry, haResourceDescription=haResourceDescription, replicationTargetDeleted=replicationTargetDeleted, nfsTotalReadMbps=nfsTotalReadMbps, lunWriteIops=lunWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataSizeLow=poolDataSizeLow, iscsiTargetsTable=iscsiTargetsTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcProperties=fcProperties, cacheTotalReadIops=cacheTotalReadIops, testNotification=testNotification, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareNFSWriteIops=shareNFSWriteIops, poolSizeLow=poolSizeLow, ipmiTemperature=ipmiTemperature, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetWriteIops=fcTargetWriteIops, lunReservedSizeLow=lunReservedSizeLow, ipmiVoltage=ipmiVoltage, poolCreated=poolCreated, upgradeStarted=upgradeStarted, shareQuotaLow=shareQuotaLow, fcTotalWriteIops=fcTotalWriteIops, lunDataSizeHigh=lunDataSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunGUID=lunGUID, shareCIFSReadIops=shareCIFSReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, targetGroupCreateCompleted=targetGroupCreateCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, upgradeDownloadStarted=upgradeDownloadStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetEntry=iscsiTargetEntry, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationSourceRegistered=replicationSourceRegistered, sharePoolName=sharePoolName, haControllerB_Name=haControllerB_Name, projectPoolName=projectPoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, notificationSensorNumber=notificationSensorNumber, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunReservedSizeHigh=lunReservedSizeHigh, cacheSSDReads=cacheSSDReads, shareCIFSEnabled=shareCIFSEnabled, deleteFolderFailed=deleteFolderFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cifsTotalWriteMbps=cifsTotalWriteMbps, networkInterfaceUp=networkInterfaceUp, smisServiceStartFailed=smisServiceStartFailed, diskGoneOffline=diskGoneOffline, projectFreeSizeLow=projectFreeSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, alertsCleanupCompleted=alertsCleanupCompleted, nfsAvgReadLatency=nfsAvgReadLatency, snmpAgentVersion=snmpAgentVersion, iscsiWriteIops=iscsiWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetAuth=iscsiTargetAuth, diskDataWriteIops=diskDataWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, poolDegraded=poolDegraded, shareCIFSReadMbps=shareCIFSReadMbps, snmpServiceStopped=snmpServiceStopped, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cacheRAMReads=cacheRAMReads, properties=properties, poolExported=poolExported, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskSequentialIOCount=diskSequentialIOCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargets=fcTargets, poolName=poolName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskType=diskType, lunIndex=lunIndex, diskCount=diskCount, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, controllerUp=controllerUp, iscsiTargetError=iscsiTargetError, poolUsedSizeHigh=poolUsedSizeHigh, diskIOCount=diskIOCount, iscsiTotalReadIops=iscsiTotalReadIops, poolDataWriteIops=poolDataWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetGroup=fcTargetGroup, poolFreeSizeLow=poolFreeSizeLow, nicGroup=nicGroup, projectTable=projectTable, haResources=haResources, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceEntry=haResourceEntry, poolReadCacheReadMbps=poolReadCacheReadMbps, poolDeleted=poolDeleted, currentNotificationGroup=currentNotificationGroup, iscsiProperties=iscsiProperties, shareQuotaFinished=shareQuotaFinished, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, ipmiCurrent=ipmiCurrent, ipmiFan=ipmiFan, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolHealth=poolHealth, shareCIFSWriteMbps=shareCIFSWriteMbps, poolImported=poolImported, projectName=projectName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeDownloadCompleted=upgradeDownloadCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskTotalWriteMbps=diskTotalWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, haResourceActiveNode=haResourceActiveNode, iscsiTargetGroupError=iscsiTargetGroupError, projectThresholdExceedWarning=projectThresholdExceedWarning, diskState=diskState, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, haResourceGroup=haResourceGroup, nicTransmitMbps=nicTransmitMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetName=fcTargetName, sensorFailureEvent=sensorFailureEvent, poolOwnerController=poolOwnerController, nicReceiveMbps=nicReceiveMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, projectFreeSizeHigh=projectFreeSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataReadMbps=poolDataReadMbps, spareDiskReplaced=spareDiskReplaced, iscsiInitiatorIndex=iscsiInitiatorIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareIndex=shareIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, snmpServiceStartFailed=snmpServiceStartFailed, diskError=diskError, ipmiThreshold=ipmiThreshold, cpuInterrupts=cpuInterrupts, diskAlias=diskAlias, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunPoolName=lunPoolName, shareProjectName=shareProjectName, fcTargetModifyCompleted=fcTargetModifyCompleted, diskDataWriteMbps=diskDataWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, fcPortOffline=fcPortOffline, replicationAborted=replicationAborted, diskIndex=diskIndex, ipmiPowerSupply=ipmiPowerSupply, nfsTotalWriteMbps=nfsTotalWriteMbps, lunEntry=lunEntry, lunReadIops=lunReadIops, lunCompressionEnabled=lunCompressionEnabled, notificationEventCode=notificationEventCode, poolFreeSizeHigh=poolFreeSizeHigh, projectCompressionEnabled=projectCompressionEnabled, controllerHardwareModel=controllerHardwareModel, shareCompressionEnabled=shareCompressionEnabled, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadMbps=poolMetaReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskPoolName=diskPoolName, lunFreeSizeHigh=lunFreeSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haControllerB_Uptime=haControllerB_Uptime, deleteFolderCompleted=deleteFolderCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, shareDedupEnabled=shareDedupEnabled, volumeDeleteCompleted=volumeDeleteCompleted, diskSlowIo=diskSlowIo, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskChassisIdx=diskChassisIdx, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolMetaReadLatency=poolMetaReadLatency, fcTargetIndex=fcTargetIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTotalWriteMbps=fcTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, globalStatistics=globalStatistics, tdpsUpgradeFailed=tdpsUpgradeFailed, controllerDown=controllerDown, iscsiTargetName=iscsiTargetName, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiatorName=iscsiInitiatorName, replicationResumed=replicationResumed, lunCompressedRatio=lunCompressedRatio, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, smisServiceStopped=smisServiceStopped, snmpServiceStarted=snmpServiceStarted, shareDataSizeHigh=shareDataSizeHigh, shareCompressedRatio=shareCompressedRatio, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcInitiatorIndex=fcInitiatorIndex, netbiosSocketFailure=netbiosSocketFailure, projectLunCount=projectLunCount, vmwareNFSDatastores=vmwareNFSDatastores, shareDeletionFailed=shareDeletionFailed, lunFreeSizeLow=lunFreeSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunDedupEnabled=lunDedupEnabled, fcInitiatorGroup=fcInitiatorGroup, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSEnabled=shareNFSEnabled, poolState=poolState, lunTargetGroup=lunTargetGroup, projectModified=projectModified, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskRandomIOCount=diskRandomIOCount, iscsiTargetWriteIops=iscsiTargetWriteIops, notificationObjects=notificationObjects, maintenanceModeDisabled=maintenanceModeDisabled, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, upgradeFailed=upgradeFailed, ntpServerTimeDrift=ntpServerTimeDrift, notifications=notifications, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetReadMbps=fcTargetReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, tegileCompliances=tegileCompliances, network=network, poolProjects=poolProjects, ipmiMemory=ipmiMemory, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haResourcesTable=haResourcesTable, iscsiTotalReadMbps=iscsiTotalReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, webdocsUpgradeFailed=webdocsUpgradeFailed, projectTotalSaving=projectTotalSaving, shareReservedSizeLow=shareReservedSizeLow, replicationStarted=replicationStarted, smisServiceStarted=smisServiceStarted, cacheTotalWriteIops=cacheTotalWriteIops, poolAvgReadLatency=poolAvgReadLatency, poolUpgraded=poolUpgraded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetReadIops=iscsiTargetReadIops, diskSizeLow=diskSizeLow, tegileConformance=tegileConformance, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, volumeModifyCompleted=volumeModifyCompleted, haControllerA_Name=haControllerA_Name, upgradeDownloadFailed=upgradeDownloadFailed, memoryFailure=memoryFailure, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunReadLatency=lunReadLatency, poolDataReadLatency=poolDataReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationComponentName=notificationComponentName, currentObjectGroup=currentObjectGroup, fcTargetReadLatency=fcTargetReadLatency, notificationSeverity=notificationSeverity, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, notificationSensorSuspect=notificationSensorSuspect, tegileArray=tegileArray, poolReadCacheReadIops=poolReadCacheReadIops, notificationTargetEntityName=notificationTargetEntityName, tegileGroups=tegileGroups, fcTargetReadIops=fcTargetReadIops, poolTable=poolTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, replicationFailed=replicationFailed, poolMetaWriteIops=poolMetaWriteIops, poolDataSizeHigh=poolDataSizeHigh, shareNFSReadLatency=shareNFSReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetEntry=fcTargetEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationSensorAction=notificationSensorAction, adServerTimeDrift=adServerTimeDrift, poolQuotaFinished=poolQuotaFinished, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskTotalReadIops=diskTotalReadIops, diskEntry=diskEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolTotalReadIops=poolTotalReadIops, diskDataReadIops=diskDataReadIops, fcInitiatorName=fcInitiatorName, iscsiInitiatorsTable=iscsiInitiatorsTable)
