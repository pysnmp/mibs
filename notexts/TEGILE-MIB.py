...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:33:09 2023
...
ModuleIdentity, Counter32, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Gauge32, TimeTicks, Bits, Integer32, MibIdentifier, iso, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Gauge32", "TimeTicks", "Bits", "Integer32", "MibIdentifier", "iso", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", nfsTotalWriteMbps=nfsTotalWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDataSizeLow=shareDataSizeLow, replicationTargetDeleted=replicationTargetDeleted, diskTable=diskTable, lunWriteIops=lunWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicState=nicState, lunFreeSizeLow=lunFreeSizeLow, netbiosSocketFailure=netbiosSocketFailure, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicReceiveMbps=nicReceiveMbps, lunName=lunName, PYSNMP_MODULE_ID=tegile, nvdimmFailUnknownError=nvdimmFailUnknownError, poolDataWriteLatency=poolDataWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, poolProjects=poolProjects, fcTargetStatus=fcTargetStatus, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, pools=pools, diskState=diskState, currentObjectGroup=currentObjectGroup, lunReservedSizeHigh=lunReservedSizeHigh, lunCompressionEnabled=lunCompressionEnabled, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, notificationReadingTriggerValue=notificationReadingTriggerValue, smbSocketFailure=smbSocketFailure, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolSizeHigh=poolSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, networkInterfaceDown=networkInterfaceDown, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationProps=notificationProps, poolExported=poolExported, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcPortOffline=fcPortOffline, projectPoolName=projectPoolName, poolExpanded=poolExpanded, snapshotCreationFailed=snapshotCreationFailed, lunDataSizeLow=lunDataSizeLow, aclMigrationStarted=aclMigrationStarted, shareCompressionEnabled=shareCompressionEnabled, diskChassisIdx=diskChassisIdx, lunFreeSizeHigh=lunFreeSizeHigh, poolMetaWriteIops=poolMetaWriteIops, lunTargetGroup=lunTargetGroup, notificationSeverity=notificationSeverity, lunIndex=lunIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareIndex=shareIndex, tegileGroups=tegileGroups, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiInitiators=iscsiInitiators, snapshotCloneCompleted=snapshotCloneCompleted, shareProjectName=shareProjectName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolFreeSizeHigh=poolFreeSizeHigh, cpuSystemCalls=cpuSystemCalls, controllerTimeDrift=controllerTimeDrift, fcTargetModifyCompleted=fcTargetModifyCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, ipmiMemory=ipmiMemory, notificationSensorSuspect=notificationSensorSuspect, poolDataWriteIops=poolDataWriteIops, poolIndex=poolIndex, tegileConformance=tegileConformance, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetName=iscsiTargetName, controllerHardwareModel=controllerHardwareModel, diskIsOnline=diskIsOnline, upgradeCompleted=upgradeCompleted, diskIndex=diskIndex, ipmiOther=ipmiOther, fcTargetWriteIops=fcTargetWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, snmpServiceStopped=snmpServiceStopped, poolMetaReadIops=poolMetaReadIops, nicIndex=nicIndex, globalStatistics=globalStatistics, cacheSSDReads=cacheSSDReads, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTargetIndex=fcTargetIndex, cpuInterrupts=cpuInterrupts, poolDataReadLatency=poolDataReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, targetGroupMemberRemoved=targetGroupMemberRemoved, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolTotalReadIops=poolTotalReadIops, projectQuotaFinished=projectQuotaFinished, fcInitiatorGroup=fcInitiatorGroup, poolUpgraded=poolUpgraded, basicCompliance=basicCompliance, lunProtocol=lunProtocol, lunTable=lunTable, cifsTotalReadMbps=cifsTotalReadMbps, shareNFSReadLatency=shareNFSReadLatency, poolQuotaFinished=poolQuotaFinished, replicationSourceRegistered=replicationSourceRegistered, projectName=projectName, poolName=poolName, iscsiTargetsTable=iscsiTargetsTable, iscsiInitiatorChapUser=iscsiInitiatorChapUser, webdocsUpgradeCompleted=webdocsUpgradeCompleted, smisServiceStarted=smisServiceStarted, diskDataWriteIops=diskDataWriteIops, snmpServiceStarted=snmpServiceStarted, diskSizeHigh=diskSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunSizeHigh=lunSizeHigh, notifications=notifications, poolEntry=poolEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskAlias=diskAlias, diskRandomIOCount=diskRandomIOCount, diskType=diskType, poolReadCacheReadMbps=poolReadCacheReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, tegileArray_notifications=tegileArray_notifications, controllerUp=controllerUp, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunSnapshotSizeLow=lunSnapshotSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetGroup=fcTargetGroup, replicationResumed=replicationResumed, fcTargetReadMbps=fcTargetReadMbps, shareDeletionFailed=shareDeletionFailed, lunPoolName=lunPoolName, poolTotalWriteIops=poolTotalWriteIops, shareQuotaHigh=shareQuotaHigh, notificationReadingUnit=notificationReadingUnit, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, smisServiceStopped=smisServiceStopped, adServerTimeDrift=adServerTimeDrift, upgradeDownloadStarted=upgradeDownloadStarted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskSizeLow=diskSizeLow, poolDataWriteMbps=poolDataWriteMbps, poolSizeLow=poolSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiWriteIops=iscsiWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareNFSReadMbps=shareNFSReadMbps, lunWriteMbps=lunWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, lunReadLatency=lunReadLatency, lunProjectName=lunProjectName, networkInterfaceUp=networkInterfaceUp, poolMetaReadMbps=poolMetaReadMbps, poolDegraded=poolDegraded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haControllerB_Uptime=haControllerB_Uptime, poolReadCacheReadLatency=poolReadCacheReadLatency, fcPortOnline=fcPortOnline, fcTotalWriteIops=fcTotalWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTotalReadIops=fcTotalReadIops, fcAvgReadLatency=fcAvgReadLatency, fcTargetReadLatency=fcTargetReadLatency, diskTotalReadMbps=diskTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, cpuTotalUsage=cpuTotalUsage, lunReservedSizeLow=lunReservedSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, diskEntry=diskEntry, tegileArray=tegileArray, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunDataSizeHigh=lunDataSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTotalReadIops=iscsiTotalReadIops, haControllerA_Name=haControllerA_Name, projectLUNs=projectLUNs, haResourceStatus=haResourceStatus, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haControllerB_Name=haControllerB_Name, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolTotalSaving=poolTotalSaving, notificationTime=notificationTime, cifsTotalWriteMbps=cifsTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, poolOwnerController=poolOwnerController, diskDataReadMbps=diskDataReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareNFSEnabled=shareNFSEnabled, diskAvgReadLatency=diskAvgReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, diskIOCount=diskIOCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, deleteFolderFailed=deleteFolderFailed, cacheTotalReadMbps=cacheTotalReadMbps, diskError=diskError, projectModified=projectModified, replicationAborted=replicationAborted, shareExceedThresholdWarning=shareExceedThresholdWarning, projectTable=projectTable, cifsTotalReadIops=cifsTotalReadIops, poolDataReadIops=poolDataReadIops, lunReadMbps=lunReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, ipmiPowerSupply=ipmiPowerSupply, poolCreated=poolCreated, diskTotalWriteIops=diskTotalWriteIops, shareCIFSReadIops=shareCIFSReadIops, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetAlias=iscsiTargetAlias, memoryFailure=memoryFailure, haResourceEntry=haResourceEntry, iscsiTargetReadIops=iscsiTargetReadIops, shareCIFSReadMbps=shareCIFSReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheTotalReadIops=cacheTotalReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, nvdimmFailSoftError=nvdimmFailSoftError, projectDataSizeHigh=projectDataSizeHigh, poolCount=poolCount, spareDiskReplaced=spareDiskReplaced, poolDataSizeHigh=poolDataSizeHigh, haResources=haResources, lunGUID=lunGUID, ipmiFan=ipmiFan, notificationSensorNumber=notificationSensorNumber, diskSequentialIOCount=diskSequentialIOCount)
mibBuilder.exportSymbols("TEGILE-MIB", testNotification=testNotification, cifsAvgReadLatency=cifsAvgReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerDown=controllerDown, lunBlockSize=lunBlockSize, iscsiTargetIndex=iscsiTargetIndex, fcTargetWriteMbps=fcTargetWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicTable=nicTable, snmpAgentVersion=snmpAgentVersion, iscsiInitiatorEntry=iscsiInitiatorEntry, haResourceName=haResourceName, shareQuotaLow=shareQuotaLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareMountPoint=shareMountPoint, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorEntry=fcInitiatorEntry, snapshotCloningFailed=snapshotCloningFailed, diskTotalWriteMbps=diskTotalWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationFailed=replicationFailed, iscsiTargetEntry=iscsiTargetEntry, haControllerA_Uptime=haControllerA_Uptime, shareTable=shareTable, diskDataReadIops=diskDataReadIops, projectCompressionEnabled=projectCompressionEnabled, fcInitiatorsTable=fcInitiatorsTable, projectQuotaSizeHigh=projectQuotaSizeHigh, sharePoolName=sharePoolName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, shareReservedSizeLow=shareReservedSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notificationEventCode=notificationEventCode, poolMetaWriteMbps=poolMetaWriteMbps, shareNFSWriteIops=shareNFSWriteIops, nicName=nicName, ntpServerTimeDrift=ntpServerTimeDrift, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetAuth=iscsiTargetAuth, sensorFailureEvent=sensorFailureEvent, haResourceIndex=haResourceIndex, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTotalReadMbps=fcTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetError=iscsiTargetError, shareCIFSReadLatency=shareCIFSReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, poolImported=poolImported, shareNFSWriteMbps=shareNFSWriteMbps, nicEntry=nicEntry, fcTotalWriteMbps=fcTotalWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, projectDataSizeLow=projectDataSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpGroupUp=networkIpmpGroupUp, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, poolAvgReadLatency=poolAvgReadLatency, notificationDescription=notificationDescription, haResourceGroup=haResourceGroup, maintenanceModeEnabled=maintenanceModeEnabled, tegile=tegile, aclMigrationCompleted=aclMigrationCompleted, snmpServiceStartFailed=snmpServiceStartFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, ipmiThreshold=ipmiThreshold, lunReadIops=lunReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolState=poolState, cacheRAMReads=cacheRAMReads, fcTargetEntry=fcTargetEntry, nfsTotalReadIops=nfsTotalReadIops, network=network, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiators=fcInitiators, nicMTU=nicMTU, cacheTotalWriteIops=cacheTotalWriteIops, diskDataWriteMbps=diskDataWriteMbps, iscsiTargets=iscsiTargets, properties=properties, poolMetaReadLatency=poolMetaReadLatency, lunWriteLatency=lunWriteLatency, sanProperties=sanProperties, disks=disks, diagnosticDataUploaded=diagnosticDataUploaded, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, replicationStarted=replicationStarted, ipmiCurrent=ipmiCurrent, lunCompressedRatio=lunCompressedRatio, shareDeleted=shareDeleted, nfsTotalWriteIops=nfsTotalWriteIops, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastores=vmwareNFSDatastores, notificationComponentName=notificationComponentName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourceDescription=haResourceDescription, diskSlowIo=diskSlowIo, projectThresholdExceedWarning=projectThresholdExceedWarning, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectCreatedSuccessfully=projectCreatedSuccessfully, deleteFolderCompleted=deleteFolderCompleted, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetGroup=iscsiTargetGroup, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCompressedRatio=shareCompressedRatio, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectFreeSizeLow=projectFreeSizeLow, shareDedupEnabled=shareDedupEnabled, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcInitiatorName=fcInitiatorName, fcTargetName=fcTargetName, notificationSensorAction=notificationSensorAction, nicTransmitMbps=nicTransmitMbps, fcInitiatorIndex=fcInitiatorIndex, diskGoneOffline=diskGoneOffline, fcProperties=fcProperties, shareCIFSWriteIops=shareCIFSWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, haResourceActiveNode=haResourceActiveNode, projectSnapshotSizeLow=projectSnapshotSizeLow, poolUsedSizeLow=poolUsedSizeLow, upgradeStarted=upgradeStarted, poolReadCacheReadIops=poolReadCacheReadIops, ipmiTemperature=ipmiTemperature, userLoginFailed=userLoginFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolTable=poolTable, shareName=shareName, volumeDeleteFailed=volumeDeleteFailed, replicationPaused=replicationPaused, nfsAvgReadLatency=nfsAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, ipmiVoltage=ipmiVoltage, tegileCompliances=tegileCompliances, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunSizeLow=lunSizeLow, shareQuotaFinished=shareQuotaFinished, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectTotalSaving=projectTotalSaving, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorName=iscsiInitiatorName, fcTargets=fcTargets, poolDataSizeLow=poolDataSizeLow, poolDeleted=poolDeleted, projectDeleted=projectDeleted, shareEntry=shareEntry, projectShareCount=projectShareCount, poolFreeSizeLow=poolFreeSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskCount=diskCount, poolDataReadMbps=poolDataReadMbps, upgradeFailed=upgradeFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolHealth=poolHealth, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectIndex=projectIndex, upgradeDownloadFailed=upgradeDownloadFailed, shareNFSReadIops=shareNFSReadIops, haResourcesTable=haResourcesTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiProperties=iscsiProperties, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, smisServiceStopFailed=smisServiceStopFailed, projectEntry=projectEntry, diskPoolName=diskPoolName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectLunCount=projectLunCount, iscsiInitiatorGroup=iscsiInitiatorGroup, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCIFSEnabled=shareCIFSEnabled, notificationObjects=notificationObjects, poolTotalReadMbps=poolTotalReadMbps, lunEntry=lunEntry, shareSnapshotSizeHigh=shareSnapshotSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, projectShares=projectShares, poolProjectCount=poolProjectCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, poolUsedSizeHigh=poolUsedSizeHigh, haControllerA_IPAddr=haControllerA_IPAddr, upgradeTimeout=upgradeTimeout, shareDataSizeHigh=shareDataSizeHigh, nicGroup=nicGroup, currentNotificationGroup=currentNotificationGroup, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetsTable=fcTargetsTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationComplete=replicationComplete, fcTargetReadIops=fcTargetReadIops)
