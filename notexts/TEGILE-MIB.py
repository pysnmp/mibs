...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:11:48 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter32, MibIdentifier, enterprises, TimeTicks, ModuleIdentity, Unsigned32, ObjectIdentity, Bits, iso, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "enterprises", "TimeTicks", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Bits", "iso", "Counter64", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", haResourceName=haResourceName, diskIOCount=diskIOCount, projectQuotaSizeHigh=projectQuotaSizeHigh, cpuSystemCalls=cpuSystemCalls, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorName=iscsiInitiatorName, volumeModifyCompleted=volumeModifyCompleted, shareProjectName=shareProjectName, projectShareCount=projectShareCount, ipmiFan=ipmiFan, poolMetaWriteLatency=poolMetaWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskSizeLow=diskSizeLow, notificationReadingUnit=notificationReadingUnit, diskAlias=diskAlias, cifsAvgReadLatency=cifsAvgReadLatency, nfsTotalReadIops=nfsTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, smisServiceStartFailed=smisServiceStartFailed, poolProjectCount=poolProjectCount, snmpServiceStarted=snmpServiceStarted, networkInterfaceDown=networkInterfaceDown, cifsTotalReadIops=cifsTotalReadIops, lunWriteIops=lunWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunReservedSizeLow=lunReservedSizeLow, fcInitiatorEntry=fcInitiatorEntry, nicName=nicName, iscsiTargetReadIops=iscsiTargetReadIops, tegileConformance=tegileConformance, poolUsedSizeLow=poolUsedSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationSensorNumber=notificationSensorNumber, diskState=diskState, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationReadingTriggerValue=notificationReadingTriggerValue, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, projectIndex=projectIndex, snmpServiceStopped=snmpServiceStopped, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationStarted=replicationStarted, poolTotalReadIops=poolTotalReadIops, lunProjectName=lunProjectName, cpuTotalUsage=cpuTotalUsage, notificationSeverity=notificationSeverity, haResourcesTable=haResourcesTable, projectLunCount=projectLunCount, notificationObjects=notificationObjects, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetGroup=fcTargetGroup, upgradeCompleted=upgradeCompleted, iscsiTargetAuth=iscsiTargetAuth, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunPoolName=lunPoolName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskDataWriteMbps=diskDataWriteMbps, haResourceIndex=haResourceIndex, snmpServiceStopFailed=snmpServiceStopFailed, ipmiPowerSupply=ipmiPowerSupply, haResourceEntry=haResourceEntry, fcProperties=fcProperties, shareNFSWriteLatency=shareNFSWriteLatency, shareMountPoint=shareMountPoint, smbSocketFailure=smbSocketFailure, upgradeStarted=upgradeStarted, nicTable=nicTable, shareCompressedRatio=shareCompressedRatio, diskGoneOffline=diskGoneOffline, replicationFailed=replicationFailed, snapshotRollbackFailed=snapshotRollbackFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, userLoginFailed=userLoginFailed, tegileGroups=tegileGroups, ipmiCurrent=ipmiCurrent, iscsiTargetName=iscsiTargetName, adServerTimeDrift=adServerTimeDrift, replicationSourceRegistered=replicationSourceRegistered, notifications=notifications, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareQuotaHigh=shareQuotaHigh, iscsiInitiators=iscsiInitiators, webdocsUpgradeFailed=webdocsUpgradeFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, shareNFSReadIops=shareNFSReadIops, poolEntry=poolEntry, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, lunDataSizeLow=lunDataSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetName=fcTargetName, projectDedupEnabled=projectDedupEnabled, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolFreeSizeHigh=poolFreeSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, haControllerA_Name=haControllerA_Name, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolMetaReadMbps=poolMetaReadMbps, memoryFailure=memoryFailure, fcTargetStatus=fcTargetStatus, fcTargetReadIops=fcTargetReadIops, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceActiveNode=haResourceActiveNode, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaWriteIops=poolMetaWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, controllerTimeDrift=controllerTimeDrift, tegileArray=tegileArray, fcTargets=fcTargets, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolHealth=poolHealth, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, haResourceDescription=haResourceDescription, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectDataSizeHigh=projectDataSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunReadLatency=lunReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, controllerUp=controllerUp, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolTotalReadMbps=poolTotalReadMbps, aclMigrationStarted=aclMigrationStarted, currentNotificationGroup=currentNotificationGroup, iscsiTargetError=iscsiTargetError, shareQuotaLow=shareQuotaLow, upgradeFailed=upgradeFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskSizeHigh=diskSizeHigh, poolSizeLow=poolSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunEntry=lunEntry, iscsiInitiatorsTable=iscsiInitiatorsTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiInitiatorGroup=iscsiInitiatorGroup, shareEntry=shareEntry, snmpServiceStartFailed=snmpServiceStartFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicTransmitMbps=nicTransmitMbps, projectPoolName=projectPoolName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cpuInterrupts=cpuInterrupts, poolDegraded=poolDegraded, fcAvgReadLatency=fcAvgReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, replicationComplete=replicationComplete, networkIpmpGroupUp=networkIpmpGroupUp, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haResources=haResources, ipmiOther=ipmiOther, shareCIFSWriteLatency=shareCIFSWriteLatency, poolSizeHigh=poolSizeHigh, shareNFSReadMbps=shareNFSReadMbps, poolTotalSaving=poolTotalSaving, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTotalReadIops=fcTotalReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareDedupEnabled=shareDedupEnabled, networkIpmpGroupDown=networkIpmpGroupDown, projectTable=projectTable, diskIsOnline=diskIsOnline, smisServiceStopFailed=smisServiceStopFailed, snapshotCreationFailed=snapshotCreationFailed, fcInitiators=fcInitiators, diskError=diskError, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCIFSReadLatency=shareCIFSReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcPortOffline=fcPortOffline, notificationComponentName=notificationComponentName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcInitiatorsTable=fcInitiatorsTable, notificationSensorSuspect=notificationSensorSuspect, poolTotalWriteMbps=poolTotalWriteMbps, nicMTU=nicMTU, diskSlowIo=diskSlowIo, projectDeleted=projectDeleted, ntpServerTimeDrift=ntpServerTimeDrift, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolIndex=poolIndex, maintenanceModeEnabled=maintenanceModeEnabled, spareDiskReplaced=spareDiskReplaced, sharePoolName=sharePoolName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskAvgReadLatency=diskAvgReadLatency, poolOwnerController=poolOwnerController, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, diskTotalReadIops=diskTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, poolExpanded=poolExpanded, fcTargetEntry=fcTargetEntry, deleteFolderFailed=deleteFolderFailed, shareName=shareName, haControllerA_Uptime=haControllerA_Uptime, replicationAbandoned=replicationAbandoned, poolDataSizeLow=poolDataSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareDeletionFailed=shareDeletionFailed, networkInterfaceUp=networkInterfaceUp, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareIndex=shareIndex, shareReservedSizeLow=shareReservedSizeLow, diskType=diskType, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStarted=smisServiceStarted, projectLUNs=projectLUNs, snapshotCloneCompleted=snapshotCloneCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snapshotCloningFailed=snapshotCloningFailed, diskPoolName=diskPoolName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolQuotaFinished=poolQuotaFinished, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, pools=pools, poolAvgReadLatency=poolAvgReadLatency, fcTargetWriteIops=fcTargetWriteIops, lunCompressionEnabled=lunCompressionEnabled, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, volumeQuotaFinished=volumeQuotaFinished, shareCIFSReadIops=shareCIFSReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, lunCompressedRatio=lunCompressedRatio, upgradeDownloadStarted=upgradeDownloadStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, currentObjectGroup=currentObjectGroup, shareNFSReadLatency=shareNFSReadLatency, shareCompressionEnabled=shareCompressionEnabled, projectQuotaFinished=projectQuotaFinished, projectDeletionFailed=projectDeletionFailed)
mibBuilder.exportSymbols("TEGILE-MIB", diskChassisIdx=diskChassisIdx, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, upgradeTimeout=upgradeTimeout, sanProperties=sanProperties, projectDataSizeLow=projectDataSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunDataSizeHigh=lunDataSizeHigh, lunSizeLow=lunSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareDataSizeLow=shareDataSizeLow, notificationDescription=notificationDescription, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetIndex=iscsiTargetIndex, poolProjects=poolProjects, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcInitiatorIndex=fcInitiatorIndex, diskEntry=diskEntry, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunTargetGroup=lunTargetGroup, poolMetaWriteMbps=poolMetaWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, deleteFolderCompleted=deleteFolderCompleted, ipmiVoltage=ipmiVoltage, ipmiThreshold=ipmiThreshold, replicationPaused=replicationPaused, replicationAborted=replicationAborted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, ipmiMemory=ipmiMemory, cifsAvgWriteLatency=cifsAvgWriteLatency, lunReadIops=lunReadIops, snapshotDeleteFailed=snapshotDeleteFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationTargetDeleted=replicationTargetDeleted, lunTable=lunTable, lunFreeSizeHigh=lunFreeSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, diskDataReadIops=diskDataReadIops, poolReadCacheReadIops=poolReadCacheReadIops, aclMigrationCompleted=aclMigrationCompleted, lunDedupEnabled=lunDedupEnabled, iscsiTargetGroup=iscsiTargetGroup, lunInitiatorGroup=lunInitiatorGroup, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haControllerB_Name=haControllerB_Name, poolState=poolState, network=network, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetGroupError=iscsiTargetGroupError, lunSizeHigh=lunSizeHigh, diskIndex=diskIndex, projectShares=projectShares, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetsTable=fcTargetsTable, nicEntry=nicEntry, snmpAgentVersion=snmpAgentVersion, poolDeleted=poolDeleted, diskSequentialIOCount=diskSequentialIOCount, poolDataReadMbps=poolDataReadMbps, poolTable=poolTable, poolTotalWriteIops=poolTotalWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, lunWriteLatency=lunWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, nicIndex=nicIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiProperties=iscsiProperties, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiatorName=fcInitiatorName, tdpsUpgradeFailed=tdpsUpgradeFailed, basicCompliance=basicCompliance, unknownSensorEvent=unknownSensorEvent, haResourceStatus=haResourceStatus, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationResumed=replicationResumed, projectCreatedSuccessfully=projectCreatedSuccessfully, diskTotalWriteMbps=diskTotalWriteMbps, fcTotalWriteIops=fcTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiInitiatorIndex=iscsiInitiatorIndex, poolImported=poolImported, iscsiTotalReadIops=iscsiTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTargets=iscsiTargets, diskDataReadMbps=diskDataReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolUpgraded=poolUpgraded, shareQuotaFinished=shareQuotaFinished, notificationSensorAction=notificationSensorAction, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectTotalSaving=projectTotalSaving, poolDataSizeHigh=poolDataSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cacheRAMReads=cacheRAMReads, projectCompressionEnabled=projectCompressionEnabled, targetGroupMemberAdded=targetGroupMemberAdded, disks=disks, intelliFlashSoftwareUp=intelliFlashSoftwareUp, upgradeDownloadFailed=upgradeDownloadFailed, sensorFailureEvent=sensorFailureEvent, poolReadCacheReadLatency=poolReadCacheReadLatency, projectModified=projectModified, nvdimmFailDeviceError=nvdimmFailDeviceError, shareTable=shareTable, fcTargetModifyCompleted=fcTargetModifyCompleted, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetIndex=fcTargetIndex, shareNFSWriteIops=shareNFSWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareDeleted=shareDeleted, nicGroup=nicGroup, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, testNotification=testNotification, poolFreeSizeLow=poolFreeSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, poolDeletionFailed=poolDeletionFailed, haResourceGroup=haResourceGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationProps=notificationProps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, globalStatistics=globalStatistics, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskTable=diskTable, poolCount=poolCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, netbiosSocketFailure=netbiosSocketFailure, poolDataWriteIops=poolDataWriteIops, fcInitiatorGroup=fcInitiatorGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, PYSNMP_MODULE_ID=tegile, iscsiWriteIops=iscsiWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, projectEntry=projectEntry, fcPortOnline=fcPortOnline, poolExported=poolExported, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunGUID=lunGUID, shareDataSizeHigh=shareDataSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTotalReadMbps=fcTotalReadMbps, diskCount=diskCount, iscsiAvgReadLatency=iscsiAvgReadLatency, controllerHardwareModel=controllerHardwareModel, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetReadLatency=fcTargetReadLatency, nicReceiveMbps=nicReceiveMbps, lunReservedSizeHigh=lunReservedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskTotalReadMbps=diskTotalReadMbps, lunIndex=lunIndex, poolDataReadIops=poolDataReadIops, projectName=projectName, fcTargetReadMbps=fcTargetReadMbps, poolCreated=poolCreated, cacheTotalReadIops=cacheTotalReadIops, poolUsedSizeHigh=poolUsedSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, tdpsUpgradeCompleted=tdpsUpgradeCompleted, smisServiceStopped=smisServiceStopped, lunWriteMbps=lunWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, lunReadMbps=lunReadMbps, lunProtocol=lunProtocol, lunName=lunName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nvdimmFailSoftError=nvdimmFailSoftError, notificationTime=notificationTime, diskRandomIOCount=diskRandomIOCount, iscsiTargetEntry=iscsiTargetEntry, diskDataWriteIops=diskDataWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cacheSSDReads=cacheSSDReads, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetAlias=iscsiTargetAlias, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileCompliances=tegileCompliances, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSEnabled=shareNFSEnabled, iscsiTargetsTable=iscsiTargetsTable, nicState=nicState, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolName=poolName, poolDataReadLatency=poolDataReadLatency, tegile=tegile, controllerDown=controllerDown, cifsTotalReadMbps=cifsTotalReadMbps, properties=properties, notificationEventCode=notificationEventCode, lunBlockSize=lunBlockSize, volumeDeleteFailed=volumeDeleteFailed, shareCIFSWriteIops=shareCIFSWriteIops, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetWriteMbps=fcTargetWriteMbps)
