...
# Produced by pysmi-1.1.8 at Fri Jan  7 18:06:18 2022
...
NotificationType, IpAddress, Integer32, Bits, Gauge32, Counter32, Counter64, MibIdentifier, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Integer32", "Bits", "Gauge32", "Counter32", "Counter64", "MibIdentifier", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", controllerDown=controllerDown, lunProjectName=lunProjectName, networkIpmpGroupDown=networkIpmpGroupDown, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargets=iscsiTargets, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, netbiosSocketFailure=netbiosSocketFailure, shareDeletionFailed=shareDeletionFailed, shareCIFSEnabled=shareCIFSEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskTotalReadIops=diskTotalReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diagnosticDataUploaded=diagnosticDataUploaded, notificationReadingUnit=notificationReadingUnit, fcTotalWriteMbps=fcTotalWriteMbps, projectIndex=projectIndex, diskDataWriteIops=diskDataWriteIops, poolDataReadMbps=poolDataReadMbps, replicationFailed=replicationFailed, shareCIFSReadIops=shareCIFSReadIops, projectName=projectName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareProjectName=shareProjectName, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolEntry=poolEntry, userLoginFailed=userLoginFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, replicationTargetDeleted=replicationTargetDeleted, haControllerA_Uptime=haControllerA_Uptime, lunName=lunName, shareDataSizeLow=shareDataSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolReadCacheWriteIops=poolReadCacheWriteIops, nicName=nicName, snmpAgentVersion=snmpAgentVersion, shareQuotaHigh=shareQuotaHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, controllerTimeDrift=controllerTimeDrift, poolDataSizeHigh=poolDataSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, disks=disks, upgradeCompleted=upgradeCompleted, diskPoolName=diskPoolName, nicEntry=nicEntry, snmpServiceStartFailed=snmpServiceStartFailed, ipmiMemory=ipmiMemory, shareMountPoint=shareMountPoint, iscsiTargetIndex=iscsiTargetIndex, replicationAborted=replicationAborted, currentObjectGroup=currentObjectGroup, nicGroup=nicGroup, fcTargetGroup=fcTargetGroup, snapshotCreationFailed=snapshotCreationFailed, shareQuotaLow=shareQuotaLow, lunReadIops=lunReadIops, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskIndex=diskIndex, tegileGroups=tegileGroups, lunInitiatorGroup=lunInitiatorGroup, lunEntry=lunEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, nfsTotalReadMbps=nfsTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, shareQuotaFinished=shareQuotaFinished, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nfsAvgWriteLatency=nfsAvgWriteLatency, poolState=poolState, iscsiInitiatorName=iscsiInitiatorName, haResourceDescription=haResourceDescription, lunCompressionEnabled=lunCompressionEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, unknownSensorEvent=unknownSensorEvent, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, iscsiInitiators=iscsiInitiators, poolProjectCount=poolProjectCount, cifsTotalReadIops=cifsTotalReadIops, volumeQuotaFinished=volumeQuotaFinished, notificationDescription=notificationDescription, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolTable=poolTable, shareCIFSWriteIops=shareCIFSWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, lunReadMbps=lunReadMbps, haResources=haResources, lunBlockSize=lunBlockSize, diskType=diskType, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunFreeSizeHigh=lunFreeSizeHigh, diskSlowIo=diskSlowIo, shareCIFSReadMbps=shareCIFSReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaReadLatency=poolMetaReadLatency, haResourceEntry=haResourceEntry, haResourceGroup=haResourceGroup, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationSourceRegistered=replicationSourceRegistered, tegileConformance=tegileConformance, snmpServiceStopped=snmpServiceStopped, poolMetaWriteMbps=poolMetaWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cifsTotalReadMbps=cifsTotalReadMbps, fcAvgReadLatency=fcAvgReadLatency, cpuInterrupts=cpuInterrupts, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snmpServiceStarted=snmpServiceStarted, snapshotCloneCompleted=snapshotCloneCompleted, lunDataSizeLow=lunDataSizeLow, diskAlias=diskAlias, iscsiImproperTargetGroup=iscsiImproperTargetGroup, targetGroupMemberRemoved=targetGroupMemberRemoved, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargets=fcTargets, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationEventCode=notificationEventCode, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiOther=ipmiOther, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunTable=lunTable, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, poolUpgraded=poolUpgraded, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cifsTotalWriteIops=cifsTotalWriteIops, poolFreeSizeLow=poolFreeSizeLow, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunTargetGroup=lunTargetGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, ipmiVoltage=ipmiVoltage, fcInitiatorsTable=fcInitiatorsTable, testNotification=testNotification, notificationTargetEntityName=notificationTargetEntityName, fcTargetEntry=fcTargetEntry, upgradeTimeout=upgradeTimeout, poolExpanded=poolExpanded, poolUsedSizeLow=poolUsedSizeLow, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeFailed=webdocsUpgradeFailed, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastores=vmwareNFSDatastores, tegileCompliances=tegileCompliances, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, diskDataReadIops=diskDataReadIops, notificationTime=notificationTime, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, notificationSeverity=notificationSeverity, projectDeleted=projectDeleted, poolUsedSizeHigh=poolUsedSizeHigh, diskAvgReadLatency=diskAvgReadLatency, controllerUp=controllerUp, shareNFSReadIops=shareNFSReadIops, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetAuth=iscsiTargetAuth, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetsTable=iscsiTargetsTable, fcInitiatorGroup=fcInitiatorGroup, poolImported=poolImported, lunGUID=lunGUID, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunWriteMbps=lunWriteMbps, diskState=diskState, shareEntry=shareEntry, nicTable=nicTable, nfsTotalReadIops=nfsTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haResourcesTable=haResourcesTable, networkInterfaceDown=networkInterfaceDown, networkInterfaceUp=networkInterfaceUp, lunDataSizeHigh=lunDataSizeHigh, networkTotalTransmitMbps=networkTotalTransmitMbps, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cpuTotalUsage=cpuTotalUsage, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCompressedRatio=shareCompressedRatio, haControllerB_Name=haControllerB_Name, diskSizeHigh=diskSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDeleted=poolDeleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, projectShares=projectShares, projectFreeSizeLow=projectFreeSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectDeletionFailed=projectDeletionFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, poolDegraded=poolDegraded, nicIndex=nicIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, diskRandomIOCount=diskRandomIOCount, haControllerA_IPAddr=haControllerA_IPAddr, poolMetaReadIops=poolMetaReadIops, notificationObjects=notificationObjects, projectQuotaFinished=projectQuotaFinished, fcInitiatorIndex=fcInitiatorIndex, sanProperties=sanProperties, memoryFailure=memoryFailure, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snapshotCloningFailed=snapshotCloningFailed, projectPoolName=projectPoolName, projectTable=projectTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareDeleted=shareDeleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, cacheTotalReadMbps=cacheTotalReadMbps, haResourceActiveNode=haResourceActiveNode, nicState=nicState, poolReadCacheReadIops=poolReadCacheReadIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, ipmiFan=ipmiFan, notificationSensorNumber=notificationSensorNumber, poolSizeLow=poolSizeLow, basicCompliance=basicCompliance, lunReservedSizeLow=lunReservedSizeLow, shareDataSizeHigh=shareDataSizeHigh, replicationAbandoned=replicationAbandoned, lunProtocol=lunProtocol, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, upgradeFailed=upgradeFailed)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalWriteMbps=cifsTotalWriteMbps, notifications=notifications, lunPoolName=lunPoolName, haControllerB_Uptime=haControllerB_Uptime, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationStarted=replicationStarted, projectShareCount=projectShareCount, nvdimmFailUnknownError=nvdimmFailUnknownError, shareName=shareName, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetGroupError=iscsiTargetGroupError, poolFreeSizeHigh=poolFreeSizeHigh, poolDataReadLatency=poolDataReadLatency, fcTotalReadMbps=fcTotalReadMbps, replicationComplete=replicationComplete, iscsiTargetName=iscsiTargetName, fcTargetReadMbps=fcTargetReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectLunCount=projectLunCount, lunSizeLow=lunSizeLow, poolCreated=poolCreated, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareNFSReadLatency=shareNFSReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareNFSWriteLatency=shareNFSWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, ipmiThreshold=ipmiThreshold, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareIndex=shareIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolTotalReadIops=poolTotalReadIops, notificationProps=notificationProps, projectThresholdExceedWarning=projectThresholdExceedWarning, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, haResourceName=haResourceName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceIndex=haResourceIndex, sensorFailureEvent=sensorFailureEvent, smisServiceStartFailed=smisServiceStartFailed, diskTotalReadMbps=diskTotalReadMbps, lunIndex=lunIndex, replicationPaused=replicationPaused, diskTable=diskTable, ipmiPowerSupply=ipmiPowerSupply, diskError=diskError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolName=poolName, tegileArray=tegileArray, fcTargetsTable=fcTargetsTable, poolQuotaFinished=poolQuotaFinished, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetIndex=fcTargetIndex, tegile=tegile, shareTable=shareTable, poolMetaWriteLatency=poolMetaWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, smisServiceStopped=smisServiceStopped, fcTargetWriteMbps=fcTargetWriteMbps, nicTransmitMbps=nicTransmitMbps, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiWriteIops=iscsiWriteIops, currentNotificationGroup=currentNotificationGroup, diskIsOnline=diskIsOnline, controllerHardwareModel=controllerHardwareModel, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareCIFSReadLatency=shareCIFSReadLatency, poolTotalWriteMbps=poolTotalWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cacheTotalWriteIops=cacheTotalWriteIops, diskCount=diskCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcProperties=fcProperties, haControllerA_Name=haControllerA_Name, fcTargetStatus=fcTargetStatus, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetName=fcTargetName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectFreeSizeHigh=projectFreeSizeHigh, shareNFSReadMbps=shareNFSReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haResourceStatus=haResourceStatus, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, networkIpmpGroupUp=networkIpmpGroupUp, poolMetaReadMbps=poolMetaReadMbps, ipmiTemperature=ipmiTemperature, projectSnapshotSizeHigh=projectSnapshotSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, poolAvgReadLatency=poolAvgReadLatency, lunReadLatency=lunReadLatency, smbSocketFailure=smbSocketFailure, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDataReadIops=poolDataReadIops, fcPortOffline=fcPortOffline, projectDedupEnabled=projectDedupEnabled, ntpServerTimeDrift=ntpServerTimeDrift, shareCIFSWriteMbps=shareCIFSWriteMbps, diskEntry=diskEntry, poolProjects=poolProjects, projectSnapshotSizeLow=projectSnapshotSizeLow, ipmiCurrent=ipmiCurrent, poolCount=poolCount, lunCompressedRatio=lunCompressedRatio, poolTotalReadMbps=poolTotalReadMbps, poolOwnerController=poolOwnerController, lunDedupEnabled=lunDedupEnabled, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, deleteFolderFailed=deleteFolderFailed, diskDataReadMbps=diskDataReadMbps, projectModified=projectModified, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDeletionFailed=poolDeletionFailed, volumeModifyCompleted=volumeModifyCompleted, diskChassisIdx=diskChassisIdx, shareReservedSizeLow=shareReservedSizeLow, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiProperties=iscsiProperties, volumeDeleteFailed=volumeDeleteFailed, projectEntry=projectEntry, diskGoneOffline=diskGoneOffline, cpuSystemCalls=cpuSystemCalls, projectDataSizeLow=projectDataSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, poolHealth=poolHealth, lunFreeSizeLow=lunFreeSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, sharePoolName=sharePoolName, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, PYSNMP_MODULE_ID=tegile, diskSizeLow=diskSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalWriteMbps=diskTotalWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorName=fcInitiatorName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTotalReadIops=fcTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, diskDataWriteMbps=diskDataWriteMbps, cacheSSDReads=cacheSSDReads, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataSizeLow=poolDataSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTotalWriteIops=poolTotalWriteIops, spareDiskReplaced=spareDiskReplaced, poolSizeHigh=poolSizeHigh, upgradeStarted=upgradeStarted, nicReceiveMbps=nicReceiveMbps, alertsCleanupCompleted=alertsCleanupCompleted, poolExported=poolExported, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolIndex=poolIndex, cacheRAMReads=cacheRAMReads, nicMTU=nicMTU, tegileArray_notifications=tegileArray_notifications, aclMigrationStarted=aclMigrationStarted, adServerTimeDrift=adServerTimeDrift, lunWriteIops=lunWriteIops, poolTotalSaving=poolTotalSaving, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationSensorAction=notificationSensorAction, shareReservedSizeHigh=shareReservedSizeHigh, poolDataWriteLatency=poolDataWriteLatency, replicationResumed=replicationResumed, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, fcInitiators=fcInitiators, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataWriteIops=poolDataWriteIops, fcTargetWriteIops=fcTargetWriteIops, pools=pools, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorEntry=fcInitiatorEntry, lunSnapshotSizeHigh=lunSnapshotSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, properties=properties, lunSizeHigh=lunSizeHigh, network=network, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTargetAlias=iscsiTargetAlias, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunWriteLatency=lunWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, notificationComponentName=notificationComponentName, smisServiceStarted=smisServiceStarted, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetGroup=iscsiTargetGroup, shareDedupEnabled=shareDedupEnabled, diskTotalWriteIops=diskTotalWriteIops, shareNFSWriteIops=shareNFSWriteIops, globalStatistics=globalStatistics, fcPortOnline=fcPortOnline, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, diskIOCount=diskIOCount)
