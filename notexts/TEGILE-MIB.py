...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:37:18 2021
...
Integer32, Unsigned32, ObjectIdentity, IpAddress, Counter64, TimeTicks, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Gauge32, NotificationType, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Gauge32", "NotificationType", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", targetGroupMemberRemoved=targetGroupMemberRemoved, smisServiceStartFailed=smisServiceStartFailed, fcPortOffline=fcPortOffline, cacheTotalReadMbps=cacheTotalReadMbps, lunName=lunName, diskState=diskState, lunDataSizeLow=lunDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetName=fcTargetName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpGroupDown=networkIpmpGroupDown, snmpAgentVersion=snmpAgentVersion, controllerHardwareModel=controllerHardwareModel, nicIndex=nicIndex, iscsiTargetEntry=iscsiTargetEntry, poolDataWriteIops=poolDataWriteIops, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReadIops=lunReadIops, shareTable=shareTable, upgradeCompleted=upgradeCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectFreeSizeHigh=projectFreeSizeHigh, controllerTimeDrift=controllerTimeDrift, fcInitiators=fcInitiators, notificationReadingTriggerValue=notificationReadingTriggerValue, diskAlias=diskAlias, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcAvgWriteLatency=fcAvgWriteLatency, shareReservedSizeLow=shareReservedSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetGroup=iscsiTargetGroup, netbiosSocketFailure=netbiosSocketFailure, poolImported=poolImported, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, smbSocketFailure=smbSocketFailure, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareDeleted=shareDeleted, fcInitiatorIndex=fcInitiatorIndex, snapshotDeleteFailed=snapshotDeleteFailed, cpuTotalUsage=cpuTotalUsage, shareName=shareName, poolTotalWriteMbps=poolTotalWriteMbps, poolExpanded=poolExpanded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationResumed=replicationResumed, networkInterfaceUp=networkInterfaceUp, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, webdocsUpgradeFailed=webdocsUpgradeFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolProjects=poolProjects, iscsiTargetAlias=iscsiTargetAlias, controllerDown=controllerDown, iscsiTargetReadIops=iscsiTargetReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, fcPortOnline=fcPortOnline, poolTotalReadIops=poolTotalReadIops, fcTargetReadLatency=fcTargetReadLatency, shareQuotaHigh=shareQuotaHigh, shareCompressedRatio=shareCompressedRatio, snapshotRollbackFailed=snapshotRollbackFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcInitiatorsTable=fcInitiatorsTable, smisServiceStarted=smisServiceStarted, poolMetaReadIops=poolMetaReadIops, replicationTargetDeleted=replicationTargetDeleted, smisServiceStopped=smisServiceStopped, haControllerB_Uptime=haControllerB_Uptime, targetGroupCreateCompleted=targetGroupCreateCompleted, projectCompressionEnabled=projectCompressionEnabled, notificationSensorSuspect=notificationSensorSuspect, shareDeletionFailed=shareDeletionFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, ipmiFan=ipmiFan, shareCIFSWriteLatency=shareCIFSWriteLatency, poolMetaWriteIops=poolMetaWriteIops, fcInitiatorName=fcInitiatorName, iscsiProperties=iscsiProperties, fcTargetIndex=fcTargetIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, poolFreeSizeLow=poolFreeSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, haResourceStatus=haResourceStatus, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationTargetEntityName=notificationTargetEntityName, diskTotalReadMbps=diskTotalReadMbps, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, replicationStarted=replicationStarted, poolIndex=poolIndex, poolExported=poolExported, iscsiInitiatorsTable=iscsiInitiatorsTable, diskAvgReadLatency=diskAvgReadLatency, shareProjectName=shareProjectName, networkInterfaceDown=networkInterfaceDown, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectName=projectName, aclMigrationCompleted=aclMigrationCompleted, cacheTotalWriteIops=cacheTotalWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ntpServerTimeDrift=ntpServerTimeDrift, diskDataWriteMbps=diskDataWriteMbps, properties=properties, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskChassisIdx=diskChassisIdx, notificationProps=notificationProps, haControllerB_Name=haControllerB_Name, poolUpgraded=poolUpgraded, poolCreated=poolCreated, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snapshotCreationFailed=snapshotCreationFailed, snmpServiceStarted=snmpServiceStarted, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, smisServiceStopFailed=smisServiceStopFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, diskCount=diskCount, intelliFlashSoftwareUp=intelliFlashSoftwareUp, targetGroupMemberAdded=targetGroupMemberAdded, poolDeleted=poolDeleted, poolMetaWriteMbps=poolMetaWriteMbps, lunCompressedRatio=lunCompressedRatio, shareMountPoint=shareMountPoint, fcTargetEntry=fcTargetEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolSizeHigh=poolSizeHigh, lunTargetGroup=lunTargetGroup, tegileArray=tegileArray, shareNFSReadMbps=shareNFSReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, diskDataReadMbps=diskDataReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, diskDataWriteIops=diskDataWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, projectDataSizeLow=projectDataSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, cifsTotalWriteIops=cifsTotalWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotCloningFailed=snapshotCloningFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, lunFreeSizeLow=lunFreeSizeLow, shareCIFSReadIops=shareCIFSReadIops, projectDeletionFailed=projectDeletionFailed, haResourceGroup=haResourceGroup, notificationReadingUnit=notificationReadingUnit, tdpsUpgradeFailed=tdpsUpgradeFailed, shareDataSizeLow=shareDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunProtocol=lunProtocol, disks=disks, lunGUID=lunGUID, iscsiTargetError=iscsiTargetError, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaReadLatency=poolMetaReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, snmpServiceStartFailed=snmpServiceStartFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiCurrent=ipmiCurrent, ipmiThreshold=ipmiThreshold, diskEntry=diskEntry, nicTransmitMbps=nicTransmitMbps, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolMetaReadMbps=poolMetaReadMbps, haControllerA_Name=haControllerA_Name, shareEntry=shareEntry, ipmiVoltage=ipmiVoltage, nvdimmFailDeviceError=nvdimmFailDeviceError, haControllerA_IPAddr=haControllerA_IPAddr, poolDataSizeLow=poolDataSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolQuotaFinished=poolQuotaFinished, shareDedupEnabled=shareDedupEnabled, haResourceActiveNode=haResourceActiveNode, poolCount=poolCount, nicGroup=nicGroup, alertsCleanupCompleted=alertsCleanupCompleted, poolSizeLow=poolSizeLow, projectIndex=projectIndex, poolName=poolName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, diskGoneOffline=diskGoneOffline, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorName=iscsiInitiatorName, projectQuotaFinished=projectQuotaFinished, nicName=nicName, projectModified=projectModified, controllerUp=controllerUp, poolReadCacheWriteLatency=poolReadCacheWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, nicReceiveMbps=nicReceiveMbps, diskRandomIOCount=diskRandomIOCount, haControllerB_IPAddr=haControllerB_IPAddr, replicationPaused=replicationPaused, projectPoolName=projectPoolName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, volumeModifyCompleted=volumeModifyCompleted, poolAvgWriteLatency=poolAvgWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, lunIndex=lunIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectLunCount=projectLunCount, notificationSeverity=notificationSeverity, PYSNMP_MODULE_ID=tegile, iscsiTargetAuth=iscsiTargetAuth, fcTargetGroup=fcTargetGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolTable=poolTable, iscsiTargets=iscsiTargets, notificationTime=notificationTime, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataReadMbps=poolDataReadMbps, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolReadCacheWriteIops=poolReadCacheWriteIops, unknownSensorEvent=unknownSensorEvent, upgradeDownloadFailed=upgradeDownloadFailed, upgradeTimeout=upgradeTimeout, cacheSSDReads=cacheSSDReads, volumeQuotaFinished=volumeQuotaFinished, sensorFailureEvent=sensorFailureEvent, poolAvgReadLatency=poolAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskTotalReadIops=diskTotalReadIops, diskSlowIo=diskSlowIo, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskTotalWriteMbps=diskTotalWriteMbps, poolHealth=poolHealth, adServerTimeDrift=adServerTimeDrift, lunSizeLow=lunSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", haResources=haResources, iscsiTotalReadIops=iscsiTotalReadIops, fcTotalReadMbps=fcTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, cpuInterrupts=cpuInterrupts, lunSnapshotSizeLow=lunSnapshotSizeLow, cacheRAMReads=cacheRAMReads, lunWriteMbps=lunWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunWriteLatency=lunWriteLatency, volumeDeleteFailed=volumeDeleteFailed, diskTable=diskTable, poolOwnerController=poolOwnerController, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, sharePoolName=sharePoolName, shareNFSWriteIops=shareNFSWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, projectShareCount=projectShareCount, shareDataSizeHigh=shareDataSizeHigh, diskError=diskError, iscsiInitiators=iscsiInitiators, diskAvgWriteLatency=diskAvgWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, nicState=nicState, diskTotalWriteIops=diskTotalWriteIops, lunEntry=lunEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunReadLatency=lunReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, cifsTotalReadMbps=cifsTotalReadMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, tegileCompliances=tegileCompliances, poolState=poolState, projectEntry=projectEntry, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareNFSWriteMbps=shareNFSWriteMbps, haResourceName=haResourceName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskSequentialIOCount=diskSequentialIOCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notifications=notifications, poolMetaWriteLatency=poolMetaWriteLatency, lunReadMbps=lunReadMbps, fcTargetWriteIops=fcTargetWriteIops, fcTargetReadMbps=fcTargetReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, userLoginFailed=userLoginFailed, testNotification=testNotification, shareCIFSEnabled=shareCIFSEnabled, lunBlockSize=lunBlockSize, nicEntry=nicEntry, deleteFolderCompleted=deleteFolderCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, replicationComplete=replicationComplete, haResourceEntry=haResourceEntry, tegileConformance=tegileConformance, projectDedupEnabled=projectDedupEnabled, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cifsTotalReadIops=cifsTotalReadIops, projectTable=projectTable, snmpServiceStopped=snmpServiceStopped, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareQuotaFinished=shareQuotaFinished, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectLUNs=projectLUNs, lunTable=lunTable, sanProperties=sanProperties, iscsiTargetsTable=iscsiTargetsTable, nvdimmFailInitializationError=nvdimmFailInitializationError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTargets=fcTargets, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolTotalSaving=poolTotalSaving, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationSensorAction=notificationSensorAction, aclMigrationStarted=aclMigrationStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationFailed=replicationFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskIndex=diskIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, diskSizeLow=diskSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunInitiatorGroup=lunInitiatorGroup, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, currentObjectGroup=currentObjectGroup, iscsiTargetIndex=iscsiTargetIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDegraded=poolDegraded, currentNotificationGroup=currentNotificationGroup, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorGroup=fcInitiatorGroup, notificationObjects=notificationObjects, shareNFSEnabled=shareNFSEnabled, cifsTotalWriteMbps=cifsTotalWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetsTable=fcTargetsTable, shareQuotaLow=shareQuotaLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, ipmiOther=ipmiOther, fcTargetStatus=fcTargetStatus, poolDeletionFailed=poolDeletionFailed, tegileGroups=tegileGroups, replicationAbandoned=replicationAbandoned, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunReservedSizeLow=lunReservedSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationDescription=notificationDescription, projectDataSizeHigh=projectDataSizeHigh, fcProperties=fcProperties, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectFreeSizeLow=projectFreeSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, iscsiWriteIops=iscsiWriteIops, upgradeFailed=upgradeFailed, ipmiMemory=ipmiMemory, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskIsOnline=diskIsOnline, diskPoolName=diskPoolName, haResourcesTable=haResourcesTable, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snmpServiceStopFailed=snmpServiceStopFailed, lunPoolName=lunPoolName, poolDataSizeHigh=poolDataSizeHigh, projectShares=projectShares, poolEntry=poolEntry, poolDataWriteMbps=poolDataWriteMbps, diskType=diskType, tegile=tegile, lunProjectName=lunProjectName, shareIndex=shareIndex, poolUsedSizeHigh=poolUsedSizeHigh, diskDataReadIops=diskDataReadIops, haResourceIndex=haResourceIndex, diskIOCount=diskIOCount, fcAvgReadLatency=fcAvgReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nicTable=nicTable, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiPowerSupply=ipmiPowerSupply, notificationComponentName=notificationComponentName, iscsiAvgReadLatency=iscsiAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, pools=pools, lunSizeHigh=lunSizeHigh, fcTotalWriteIops=fcTotalWriteIops, poolDataReadLatency=poolDataReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectTotalSaving=projectTotalSaving, notificationSensorNumber=notificationSensorNumber, ipmiTemperature=ipmiTemperature, poolTotalWriteIops=poolTotalWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceDescription=haResourceDescription, nvdimmFailSoftError=nvdimmFailSoftError, poolProjectCount=poolProjectCount, iscsiTargetName=iscsiTargetName, poolReadCacheReadIops=poolReadCacheReadIops, lunWriteIops=lunWriteIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, globalStatistics=globalStatistics, replicationAborted=replicationAborted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cpuSystemCalls=cpuSystemCalls, cifsAvgWriteLatency=cifsAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, poolUsedSizeLow=poolUsedSizeLow, fcTotalReadIops=fcTotalReadIops, memoryFailure=memoryFailure, basicCompliance=basicCompliance, projectThresholdExceedWarning=projectThresholdExceedWarning, projectDeleted=projectDeleted, network=network, notificationEventCode=notificationEventCode, diagnosticDataUploaded=diagnosticDataUploaded, poolDataReadIops=poolDataReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, spareDiskReplaced=spareDiskReplaced, nicMTU=nicMTU, tegileArray_notifications=tegileArray_notifications, fcTargetWriteMbps=fcTargetWriteMbps, upgradeStarted=upgradeStarted, diskSizeHigh=diskSizeHigh, networkTotalTransmitMbps=networkTotalTransmitMbps, snapshotCloneCompleted=snapshotCloneCompleted, nfsTotalReadIops=nfsTotalReadIops)
