...
NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, MibIdentifier, TimeTicks, Counter64, Unsigned32, Bits, Gauge32, Counter32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "MibIdentifier", "TimeTicks", "Counter64", "Unsigned32", "Bits", "Gauge32", "Counter32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceEntry=haResourceEntry, shareCIFSWriteMbps=shareCIFSWriteMbps, poolImported=poolImported, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tegileGroups=tegileGroups, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolCount=poolCount, projectCreatedSuccessfully=projectCreatedSuccessfully, shareNFSReadMbps=shareNFSReadMbps, currentNotificationGroup=currentNotificationGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectCompressionEnabled=projectCompressionEnabled, shareNFSWriteIops=shareNFSWriteIops, poolMetaWriteIops=poolMetaWriteIops, poolExpanded=poolExpanded, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorEntry=fcInitiatorEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetIndex=fcTargetIndex, targetGroupMemberRemoved=targetGroupMemberRemoved, haResourceStatus=haResourceStatus, tegile=tegile, poolTotalReadIops=poolTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, controllerUp=controllerUp, lunSizeLow=lunSizeLow, lunWriteMbps=lunWriteMbps, cacheSSDReads=cacheSSDReads, projectShareCount=projectShareCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectTable=projectTable, haResourceIndex=haResourceIndex, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorGroup=fcInitiatorGroup, projectDataSizeHigh=projectDataSizeHigh, replicationFailed=replicationFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, PYSNMP_MODULE_ID=tegile, iscsiTargetAuth=iscsiTargetAuth, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cpuSystemCalls=cpuSystemCalls, shareDataSizeLow=shareDataSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectFreeSizeHigh=projectFreeSizeHigh, haResourcesTable=haResourcesTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nicReceiveMbps=nicReceiveMbps, iscsiTargetsTable=iscsiTargetsTable, ipmiCurrent=ipmiCurrent, diskPoolName=diskPoolName, diskSizeHigh=diskSizeHigh, fcInitiatorIndex=fcInitiatorIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, disks=disks, replicationPaused=replicationPaused, poolTotalReadMbps=poolTotalReadMbps, shareCompressionEnabled=shareCompressionEnabled, shareCIFSWriteIops=shareCIFSWriteIops, ipmiFan=ipmiFan, diskGoneOffline=diskGoneOffline, smisServiceStopFailed=smisServiceStopFailed, ipmiMemory=ipmiMemory, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunCompressionEnabled=lunCompressionEnabled, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetError=iscsiTargetError, nicEntry=nicEntry, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cifsAvgReadLatency=cifsAvgReadLatency, deleteFolderCompleted=deleteFolderCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetIndex=iscsiTargetIndex, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, projectIndex=projectIndex, projectDedupEnabled=projectDedupEnabled, poolDegraded=poolDegraded, lunBlockSize=lunBlockSize, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTable=poolTable, shareNFSReadLatency=shareNFSReadLatency, shareNFSReadIops=shareNFSReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, diskError=diskError, notifications=notifications, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snmpServiceStartFailed=snmpServiceStartFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, fcAvgReadLatency=fcAvgReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, fcPortOffline=fcPortOffline, diskSlowIo=diskSlowIo, poolMetaReadMbps=poolMetaReadMbps, poolMetaReadIops=poolMetaReadIops, projectLUNs=projectLUNs, lunProjectName=lunProjectName, poolExported=poolExported, lunDedupEnabled=lunDedupEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskType=diskType, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, volumeModifyCompleted=volumeModifyCompleted, lunFreeSizeLow=lunFreeSizeLow, projectDataSizeLow=projectDataSizeLow, diskRandomIOCount=diskRandomIOCount, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, poolSizeLow=poolSizeLow, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, netbiosSocketFailure=netbiosSocketFailure, iscsiTotalReadIops=iscsiTotalReadIops, haControllerB_Uptime=haControllerB_Uptime, notificationReadingTriggerValue=notificationReadingTriggerValue, replicationComplete=replicationComplete, lunSnapshotSizeLow=lunSnapshotSizeLow, shareQuotaLow=shareQuotaLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTotalReadMbps=fcTotalReadMbps, nicTransmitMbps=nicTransmitMbps, tegileConformance=tegileConformance, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataSizeHigh=poolDataSizeHigh, lunCompressedRatio=lunCompressedRatio, iscsiTargetEntry=iscsiTargetEntry, smbSocketFailure=smbSocketFailure, shareNFSEnabled=shareNFSEnabled, volumeDeleteCompleted=volumeDeleteCompleted, diskDataWriteMbps=diskDataWriteMbps, iscsiTargets=iscsiTargets, poolTotalWriteIops=poolTotalWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetWriteIops=fcTargetWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiTemperature=ipmiTemperature, nicGroup=nicGroup, iscsiProperties=iscsiProperties, haControllerB_IPAddr=haControllerB_IPAddr, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, ipmiVoltage=ipmiVoltage, fcTargetGroup=fcTargetGroup, shareNFSWriteMbps=shareNFSWriteMbps, unknownSensorEvent=unknownSensorEvent, fcTargetReadLatency=fcTargetReadLatency, upgradeDownloadStarted=upgradeDownloadStarted, cacheTotalReadIops=cacheTotalReadIops, network=network, aclMigrationCompleted=aclMigrationCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, replicationResumed=replicationResumed, nicName=nicName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiInitiators=iscsiInitiators, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunReadLatency=lunReadLatency, diskSizeLow=diskSizeLow, notificationComponentName=notificationComponentName, iscsiTargetAlias=iscsiTargetAlias, poolDeleted=poolDeleted, poolProjects=poolProjects, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunTargetGroup=lunTargetGroup, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorName=iscsiInitiatorName, poolHealth=poolHealth, spareDiskReplaced=spareDiskReplaced, diskState=diskState, lunWriteIops=lunWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTotalReadIops=fcTotalReadIops, shareCIFSReadIops=shareCIFSReadIops, shareCIFSReadLatency=shareCIFSReadLatency, poolDataReadMbps=poolDataReadMbps, properties=properties, fcInitiatorName=fcInitiatorName, poolDataWriteLatency=poolDataWriteLatency, replicationStarted=replicationStarted, smisServiceStopped=smisServiceStopped, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, lunGUID=lunGUID, networkInterfaceDown=networkInterfaceDown, haResourceActiveNode=haResourceActiveNode, projectModified=projectModified, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetStatus=fcTargetStatus, fcAvgWriteLatency=fcAvgWriteLatency, lunDataSizeHigh=lunDataSizeHigh, lunReadIops=lunReadIops, fcTotalWriteIops=fcTotalWriteIops, poolDeletionFailed=poolDeletionFailed, diskTable=diskTable, lunReadMbps=lunReadMbps, poolQuotaFinished=poolQuotaFinished, poolAvgReadLatency=poolAvgReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, projectPoolName=projectPoolName, lunTable=lunTable, cpuTotalUsage=cpuTotalUsage, lunReservedSizeHigh=lunReservedSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tegileArray_notifications=tegileArray_notifications, poolOwnerController=poolOwnerController, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nvdimmFailInitializationError=nvdimmFailInitializationError, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationSensorAction=notificationSensorAction, shareCIFSReadMbps=shareCIFSReadMbps, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, sensorFailureEvent=sensorFailureEvent, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetsTable=fcTargetsTable, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolCreated=poolCreated, shareDedupEnabled=shareDedupEnabled, haResources=haResources, poolMetaReadLatency=poolMetaReadLatency, fcTargets=fcTargets, lunDataSizeLow=lunDataSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcProperties=fcProperties, fcTargetWriteLatency=fcTargetWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetReadIops=fcTargetReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, memoryFailure=memoryFailure, alertsCleanupCompleted=alertsCleanupCompleted, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationSensorNumber=notificationSensorNumber, cpuInterrupts=cpuInterrupts, diskIndex=diskIndex)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetName=fcTargetName, notificationSensorSuspect=notificationSensorSuspect, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskTotalWriteIops=diskTotalWriteIops, sharePoolName=sharePoolName, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, haControllerA_Name=haControllerA_Name, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicState=nicState, haResourceDescription=haResourceDescription, lunWriteLatency=lunWriteLatency, sanProperties=sanProperties, poolDataWriteIops=poolDataWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationAborted=replicationAborted, diskDataReadIops=diskDataReadIops, upgradeFailed=upgradeFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataReadIops=poolDataReadIops, diskIsOnline=diskIsOnline, controllerDown=controllerDown, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectShares=projectShares, smisServiceStarted=smisServiceStarted, haControllerA_Uptime=haControllerA_Uptime, fcInitiators=fcInitiators, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, shareNFSWriteLatency=shareNFSWriteLatency, shareDataSizeHigh=shareDataSizeHigh, diskIOCount=diskIOCount, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceName=haResourceName, shareSnapshotSizeLow=shareSnapshotSizeLow, lunSizeHigh=lunSizeHigh, networkInterfaceUp=networkInterfaceUp, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolAvgWriteLatency=poolAvgWriteLatency, controllerHardwareModel=controllerHardwareModel, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, diskCount=diskCount, lunEntry=lunEntry, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcPortOnline=fcPortOnline, poolTotalWriteMbps=poolTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, projectLunCount=projectLunCount, currentObjectGroup=currentObjectGroup, shareEntry=shareEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolSizeHigh=poolSizeHigh, poolProjectCount=poolProjectCount, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetName=iscsiTargetName, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, adServerTimeDrift=adServerTimeDrift, nicMTU=nicMTU, projectEntry=projectEntry, ipmiPowerSupply=ipmiPowerSupply, userLoginFailed=userLoginFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, shareCompressedRatio=shareCompressedRatio, poolIndex=poolIndex, diskAlias=diskAlias, ipmiOther=ipmiOther, projectDeleted=projectDeleted, fcInitiatorsTable=fcInitiatorsTable, notificationEventCode=notificationEventCode, snapshotDeleteFailed=snapshotDeleteFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, cifsTotalReadIops=cifsTotalReadIops, shareReservedSizeHigh=shareReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskTotalReadIops=diskTotalReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetGroup=iscsiTargetGroup, poolEntry=poolEntry, shareDeletionFailed=shareDeletionFailed, nicTable=nicTable, nfsAvgReadLatency=nfsAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nicIndex=nicIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationSourceRegistered=replicationSourceRegistered, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, poolFreeSizeLow=poolFreeSizeLow, lunName=lunName, lunIndex=lunIndex, maintenanceModeEnabled=maintenanceModeEnabled, poolReadCacheReadIops=poolReadCacheReadIops, projectDeletionFailed=projectDeletionFailed, upgradeCompleted=upgradeCompleted, poolUpgraded=poolUpgraded, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, snmpAgentVersion=snmpAgentVersion, testNotification=testNotification, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, notificationObjects=notificationObjects, diskTotalReadMbps=diskTotalReadMbps, notificationProps=notificationProps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunProtocol=lunProtocol, snapshotCreationFailed=snapshotCreationFailed, globalStatistics=globalStatistics, shareName=shareName, projectName=projectName, diskDataReadMbps=diskDataReadMbps, fcTargetEntry=fcTargetEntry, pools=pools, networkTotalReceiveMbps=networkTotalReceiveMbps, haResourceGroup=haResourceGroup, notificationTargetEntityName=notificationTargetEntityName, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tegileCompliances=tegileCompliances, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeDownloadFailed=upgradeDownloadFailed, nfsTotalReadIops=nfsTotalReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, poolState=poolState, poolDataWriteMbps=poolDataWriteMbps, shareProjectName=shareProjectName, ipmiThreshold=ipmiThreshold, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolFreeSizeHigh=poolFreeSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolName=poolName, ntpServerTimeDrift=ntpServerTimeDrift, cacheTotalReadMbps=cacheTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, projectTotalSaving=projectTotalSaving, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, controllerTimeDrift=controllerTimeDrift, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsTotalWriteIops=nfsTotalWriteIops, shareTable=shareTable, shareQuotaFinished=shareQuotaFinished, notificationTime=notificationTime, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, upgradeTimeout=upgradeTimeout, basicCompliance=basicCompliance, snapshotCloneCompleted=snapshotCloneCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareIndex=shareIndex, lunPoolName=lunPoolName, poolDataReadLatency=poolDataReadLatency, haControllerB_Name=haControllerB_Name, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCIFSEnabled=shareCIFSEnabled, notificationSeverity=notificationSeverity, snmpServiceStarted=snmpServiceStarted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, shareMountPoint=shareMountPoint, tegileArray=tegileArray, notificationReadingUnit=notificationReadingUnit, poolTotalSaving=poolTotalSaving, volumeQuotaFinished=volumeQuotaFinished, nfsTotalWriteMbps=nfsTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, shareQuotaHigh=shareQuotaHigh, aclMigrationStarted=aclMigrationStarted, fcTargetReadMbps=fcTargetReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkTotalTransmitMbps=networkTotalTransmitMbps, projectFreeSizeLow=projectFreeSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, poolDataSizeLow=poolDataSizeLow, notificationDescription=notificationDescription, lunReservedSizeLow=lunReservedSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, upgradeStarted=upgradeStarted, diskDataWriteIops=diskDataWriteIops, projectQuotaFinished=projectQuotaFinished, replicationTargetDeleted=replicationTargetDeleted, replicationAbandoned=replicationAbandoned, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, shareDeleted=shareDeleted, poolReadCacheReadLatency=poolReadCacheReadLatency, cacheRAMReads=cacheRAMReads, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskEntry=diskEntry, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunInitiatorGroup=lunInitiatorGroup)
