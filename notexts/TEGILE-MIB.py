...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Integer32, ObjectIdentity, Counter64, MibIdentifier, Gauge32, iso, TimeTicks, enterprises, IpAddress, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Integer32", "ObjectIdentity", "Counter64", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "enterprises", "IpAddress", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiProperties=iscsiProperties, diskSizeLow=diskSizeLow, nicEntry=nicEntry, shareCIFSWriteLatency=shareCIFSWriteLatency, aclMigrationStarted=aclMigrationStarted, snapshotDeleteFailed=snapshotDeleteFailed, poolExpanded=poolExpanded, cpuSystemCalls=cpuSystemCalls, diskDataReadMbps=diskDataReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareEntry=shareEntry, poolTotalWriteMbps=poolTotalWriteMbps, poolProjectCount=poolProjectCount, shareSnapshotSizeLow=shareSnapshotSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunName=lunName, pools=pools, shareCIFSReadLatency=shareCIFSReadLatency, shareProjectName=shareProjectName, diskDataReadIops=diskDataReadIops, controllerDown=controllerDown, nfsAvgWriteLatency=nfsAvgWriteLatency, disks=disks, smisServiceStopped=smisServiceStopped, fcInitiators=fcInitiators, shareNFSReadIops=shareNFSReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationReadingTriggerValue=notificationReadingTriggerValue, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nicTransmitMbps=nicTransmitMbps, poolDeleted=poolDeleted, iscsiWriteIops=iscsiWriteIops, fcTargetReadLatency=fcTargetReadLatency, iscsiInitiatorName=iscsiInitiatorName, poolFreeSizeHigh=poolFreeSizeHigh, shareDeletionFailed=shareDeletionFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTotalReadMbps=fcTotalReadMbps, poolTotalSaving=poolTotalSaving, notificationThresholdTriggerValue=notificationThresholdTriggerValue, replicationPaused=replicationPaused, projectLUNs=projectLUNs, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectDataSizeHigh=projectDataSizeHigh, upgradeCompleted=upgradeCompleted, poolDataWriteMbps=poolDataWriteMbps, userLoginFailed=userLoginFailed, haControllerA_Name=haControllerA_Name, diskIndex=diskIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationTime=notificationTime, controllerTimeDrift=controllerTimeDrift, cacheRAMReads=cacheRAMReads, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationTargetEntityName=notificationTargetEntityName, notificationEventCode=notificationEventCode, cacheSSDReads=cacheSSDReads, shareNFSReadMbps=shareNFSReadMbps, fcTargetGroup=fcTargetGroup, projectCompressionEnabled=projectCompressionEnabled, shareDedupEnabled=shareDedupEnabled, smisServiceStarted=smisServiceStarted, lunCompressionEnabled=lunCompressionEnabled, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunPoolName=lunPoolName, lunReadLatency=lunReadLatency, nicTable=nicTable, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorGroup=fcInitiatorGroup, fcTargets=fcTargets, haResourceStatus=haResourceStatus, haResourceGroup=haResourceGroup, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunProjectName=lunProjectName, poolImported=poolImported, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiCurrent=ipmiCurrent, poolMetaReadLatency=poolMetaReadLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTable=poolTable, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, diskAvgReadLatency=diskAvgReadLatency, fcTargetStatus=fcTargetStatus, lunFreeSizeHigh=lunFreeSizeHigh, ipmiMemory=ipmiMemory, projectModified=projectModified, lunDataSizeHigh=lunDataSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTotalWriteMbps=fcTotalWriteMbps, unknownSensorEvent=unknownSensorEvent, replicationComplete=replicationComplete, vmwareNFSDatastores=vmwareNFSDatastores, projectName=projectName, projectDedupEnabled=projectDedupEnabled, diskRandomIOCount=diskRandomIOCount, tegile=tegile, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetName=iscsiTargetName, volumeDeleteFailed=volumeDeleteFailed, poolIndex=poolIndex, lunGUID=lunGUID, diskSizeHigh=diskSizeHigh, poolState=poolState, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, network=network, lunCompressedRatio=lunCompressedRatio, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceDescription=haResourceDescription, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, ipmiPowerSupply=ipmiPowerSupply, globalStatistics=globalStatistics, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorIndex=fcInitiatorIndex, diskCount=diskCount, deleteFolderFailed=deleteFolderFailed, cifsTotalReadIops=cifsTotalReadIops, notificationSensorAction=notificationSensorAction, smisServiceStartFailed=smisServiceStartFailed, upgradeDownloadFailed=upgradeDownloadFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunReadIops=lunReadIops, snapshotRollbackCompleted=snapshotRollbackCompleted, poolTotalReadIops=poolTotalReadIops, snmpServiceStartFailed=snmpServiceStartFailed, diskPoolName=diskPoolName, iscsiTargetEntry=iscsiTargetEntry, shareQuotaLow=shareQuotaLow, shareReservedSizeLow=shareReservedSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, fcAvgReadLatency=fcAvgReadLatency, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cifsAvgWriteLatency=cifsAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, haResources=haResources, projectQuotaFinished=projectQuotaFinished, iscsiImproperTargetGroup=iscsiImproperTargetGroup, smbSocketFailure=smbSocketFailure, poolDataReadMbps=poolDataReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiTotalReadIops=iscsiTotalReadIops, lunReservedSizeHigh=lunReservedSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, lunInitiatorGroup=lunInitiatorGroup, poolName=poolName, haResourceActiveNode=haResourceActiveNode, currentNotificationGroup=currentNotificationGroup, fcTargetsTable=fcTargetsTable, diskDataWriteIops=diskDataWriteIops, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDeletionFailed=poolDeletionFailed, poolMetaReadIops=poolMetaReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, shareName=shareName, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, notificationDescription=notificationDescription, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskState=diskState, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerB_Name=haControllerB_Name, haResourceIndex=haResourceIndex, ntpServerTimeDrift=ntpServerTimeDrift, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notifications=notifications, cacheTotalWriteIops=cacheTotalWriteIops, diskDataWriteMbps=diskDataWriteMbps, iscsiTargets=iscsiTargets, adServerTimeDrift=adServerTimeDrift, projectLunCount=projectLunCount, fcInitiatorName=fcInitiatorName, haResourceName=haResourceName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, ipmiThreshold=ipmiThreshold, diskSlowIo=diskSlowIo, notificationComponentName=notificationComponentName, snapshotRollbackFailed=snapshotRollbackFailed, poolEntry=poolEntry, poolDegraded=poolDegraded, replicationTargetDeleted=replicationTargetDeleted, tegileArray_notifications=tegileArray_notifications, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, snapshotCreationFailed=snapshotCreationFailed, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetError=iscsiTargetError, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, networkIpmpGroupUp=networkIpmpGroupUp, networkInterfaceDown=networkInterfaceDown, alertsCleanupCompleted=alertsCleanupCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcProperties=fcProperties, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareTable=shareTable, shareMountPoint=shareMountPoint, tegileConformance=tegileConformance, iscsiTargetReadIops=iscsiTargetReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, diskEntry=diskEntry, tegileArray=tegileArray, shareQuotaHigh=shareQuotaHigh, maintenanceModeDisabled=maintenanceModeDisabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, sensorFailureEvent=sensorFailureEvent, lunWriteMbps=lunWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, haResourcesTable=haResourcesTable, lunTable=lunTable, diskIsOnline=diskIsOnline, iscsiInitiatorsTable=iscsiInitiatorsTable, ipmiVoltage=ipmiVoltage, nfsTotalWriteMbps=nfsTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolUsedSizeHigh=poolUsedSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerA_Uptime=haControllerA_Uptime, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, networkInterfaceUp=networkInterfaceUp, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCIFSReadIops=shareCIFSReadIops, snmpAgentVersion=snmpAgentVersion, poolOwnerController=poolOwnerController, nvdimmFailSoftError=nvdimmFailSoftError)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationSourceRegistered=replicationSourceRegistered, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskType=diskType, projectShareCount=projectShareCount, fcPortOnline=fcPortOnline, ipmiFan=ipmiFan, nicIndex=nicIndex, replicationAborted=replicationAborted, projectDeletionFailed=projectDeletionFailed, poolDataWriteLatency=poolDataWriteLatency, lunBlockSize=lunBlockSize, shareNFSEnabled=shareNFSEnabled, netbiosSocketFailure=netbiosSocketFailure, nicReceiveMbps=nicReceiveMbps, notificationObjects=notificationObjects, properties=properties, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskTotalWriteIops=diskTotalWriteIops, lunSizeLow=lunSizeLow, fcInitiatorEntry=fcInitiatorEntry, fcPortOffline=fcPortOffline, notificationSeverity=notificationSeverity, snapshotCloneCompleted=snapshotCloneCompleted, poolUpgraded=poolUpgraded, cpuInterrupts=cpuInterrupts, replicationStarted=replicationStarted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolExported=poolExported, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskAlias=diskAlias, poolDataSizeHigh=poolDataSizeHigh, ipmiTemperature=ipmiTemperature, poolAvgReadLatency=poolAvgReadLatency, projectTable=projectTable, replicationResumed=replicationResumed, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskError=diskError, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolQuotaFinished=poolQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, diskTotalReadMbps=diskTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, shareDataSizeLow=shareDataSizeLow, projectTotalSaving=projectTotalSaving, networkTotalTransmitMbps=networkTotalTransmitMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTotalReadIops=diskTotalReadIops, spareDiskReplaced=spareDiskReplaced, nicState=nicState, fcTargetWriteLatency=fcTargetWriteLatency, projectDeleted=projectDeleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicMTU=nicMTU, fcTotalReadIops=fcTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerA_IPAddr=haControllerA_IPAddr, snmpServiceStopped=snmpServiceStopped, volumeQuotaFinished=volumeQuotaFinished, poolMetaWriteMbps=poolMetaWriteMbps, replicationFailed=replicationFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetReadIops=fcTargetReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetGroup=iscsiTargetGroup, currentObjectGroup=currentObjectGroup, projectFreeSizeLow=projectFreeSizeLow, haResourceEntry=haResourceEntry, cacheTotalReadIops=cacheTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, nicGroup=nicGroup, diagnosticDataUploaded=diagnosticDataUploaded, shareReservedSizeHigh=shareReservedSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, fcAvgWriteLatency=fcAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, sanProperties=sanProperties, cpuTotalUsage=cpuTotalUsage, fcTotalWriteIops=fcTotalWriteIops, poolCount=poolCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcInitiatorsTable=fcInitiatorsTable, projectPoolName=projectPoolName, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationProps=notificationProps, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetAlias=iscsiTargetAlias, projectIndex=projectIndex, diskTable=diskTable, shareDeleted=shareDeleted, upgradeStarted=upgradeStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, poolDataSizeLow=poolDataSizeLow, shareCompressedRatio=shareCompressedRatio, nfsTotalReadIops=nfsTotalReadIops, diskGoneOffline=diskGoneOffline, lunReadMbps=lunReadMbps, lunEntry=lunEntry, poolProjects=poolProjects, nicName=nicName, poolMetaReadMbps=poolMetaReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, sharePoolName=sharePoolName, upgradeFailed=upgradeFailed, snapshotCloningFailed=snapshotCloningFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetEntry=fcTargetEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskChassisIdx=diskChassisIdx, projectEntry=projectEntry, ipmiOther=ipmiOther, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeTimeout=upgradeTimeout, nfsTotalWriteIops=nfsTotalWriteIops, deleteFolderCompleted=deleteFolderCompleted, networkIpmpGroupDown=networkIpmpGroupDown, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetReadLatency=iscsiTargetReadLatency, poolMetaWriteIops=poolMetaWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, projectDataSizeLow=projectDataSizeLow, tegileCompliances=tegileCompliances, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, volumeModifyCompleted=volumeModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunDataSizeLow=lunDataSizeLow, poolDataReadIops=poolDataReadIops, iscsiInitiators=iscsiInitiators, memoryFailure=memoryFailure, iscsiTotalReadMbps=iscsiTotalReadMbps, lunSizeHigh=lunSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUsedSizeLow=poolUsedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiTargetWriteIops=iscsiTargetWriteIops, shareQuotaFinished=shareQuotaFinished, nfsTotalReadMbps=nfsTotalReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectShares=projectShares, lunFreeSizeLow=lunFreeSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataWriteIops=poolDataWriteIops, testNotification=testNotification, poolHealth=poolHealth, projectQuotaSizeLow=projectQuotaSizeLow, lunTargetGroup=lunTargetGroup, maintenanceModeEnabled=maintenanceModeEnabled, lunIndex=lunIndex, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskIOCount=diskIOCount, iscsiInitiatorIndex=iscsiInitiatorIndex, controllerUp=controllerUp, poolSizeHigh=poolSizeHigh, lunProtocol=lunProtocol, shareNFSWriteLatency=shareNFSWriteLatency, controllerHardwareModel=controllerHardwareModel, shareIndex=shareIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSensorSuspect=notificationSensorSuspect, lunWriteIops=lunWriteIops, lunDedupEnabled=lunDedupEnabled, shareNFSWriteMbps=shareNFSWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, notificationSensorNumber=notificationSensorNumber, haControllerB_Uptime=haControllerB_Uptime, fcTargetWriteMbps=fcTargetWriteMbps, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolCreated=poolCreated, shareDataSizeHigh=shareDataSizeHigh, poolSizeLow=poolSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, basicCompliance=basicCompliance, tegileGroups=tegileGroups, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataReadLatency=poolDataReadLatency, replicationAbandoned=replicationAbandoned, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetWriteIops=fcTargetWriteIops, shareNFSWriteIops=shareNFSWriteIops, fcTargetName=fcTargetName)
