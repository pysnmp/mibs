...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:08:22 2023
...
iso, Unsigned32, Counter64, Gauge32, NotificationType, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, enterprises, Counter32, ModuleIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "enterprises", "Counter32", "ModuleIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", ipmiThreshold=ipmiThreshold, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunWriteMbps=lunWriteMbps, diskDataWriteMbps=diskDataWriteMbps, poolName=poolName, fcPortOffline=fcPortOffline, diskRandomIOCount=diskRandomIOCount, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTotalReadIops=fcTotalReadIops, replicationResumed=replicationResumed, shareCIFSWriteMbps=shareCIFSWriteMbps, diskChassisIdx=diskChassisIdx, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notifications=notifications, vmwareNFSDatastores=vmwareNFSDatastores, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskSlowIo=diskSlowIo, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaWriteMbps=poolMetaWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectCreatedSuccessfully=projectCreatedSuccessfully, snmpServiceStarted=snmpServiceStarted, sensorFailureEvent=sensorFailureEvent, projectQuotaFinished=projectQuotaFinished, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsTotalWriteMbps=cifsTotalWriteMbps, cacheRAMReads=cacheRAMReads, upgradeDownloadStarted=upgradeDownloadStarted, aclMigrationCompleted=aclMigrationCompleted, poolDataReadIops=poolDataReadIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, ipmiFan=ipmiFan, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectFreeSizeLow=projectFreeSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskEntry=diskEntry, iscsiTargetIndex=iscsiTargetIndex, poolExported=poolExported, lunTable=lunTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcInitiatorGroup=fcInitiatorGroup, shareQuotaFinished=shareQuotaFinished, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskAvgWriteLatency=diskAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, tegileCompliances=tegileCompliances, diskSequentialIOCount=diskSequentialIOCount, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolFreeSizeHigh=poolFreeSizeHigh, smisServiceStopFailed=smisServiceStopFailed, fcInitiatorName=fcInitiatorName, poolCreated=poolCreated, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCompressionEnabled=shareCompressionEnabled, maintenanceModeEnabled=maintenanceModeEnabled, haResources=haResources, networkInterfaceDown=networkInterfaceDown, sharePoolName=sharePoolName, basicCompliance=basicCompliance, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareCIFSEnabled=shareCIFSEnabled, haResourceEntry=haResourceEntry, upgradeFailed=upgradeFailed, lunDedupEnabled=lunDedupEnabled, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcPortOnline=fcPortOnline, fcTargetWriteMbps=fcTargetWriteMbps, nicTransmitMbps=nicTransmitMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, shareSnapshotSizeLow=shareSnapshotSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, deleteFolderCompleted=deleteFolderCompleted, poolAvgReadLatency=poolAvgReadLatency, replicationAbandoned=replicationAbandoned, poolDataWriteIops=poolDataWriteIops, shareDeleted=shareDeleted, fcProperties=fcProperties, nicTable=nicTable, diskDataReadIops=diskDataReadIops, nicGroup=nicGroup, poolMetaWriteIops=poolMetaWriteIops, fcTargetEntry=fcTargetEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunPoolName=lunPoolName, poolCount=poolCount, cifsTotalWriteIops=cifsTotalWriteIops, poolQuotaFinished=poolQuotaFinished, shareDeletionFailed=shareDeletionFailed, poolTotalWriteIops=poolTotalWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResourceDescription=haResourceDescription, targetGroupMemberAdded=targetGroupMemberAdded, projectDataSizeHigh=projectDataSizeHigh, poolDataReadLatency=poolDataReadLatency, poolOwnerController=poolOwnerController, fcTargetsTable=fcTargetsTable, shareDataSizeHigh=shareDataSizeHigh, lunSizeHigh=lunSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaReadIops=poolMetaReadIops, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorEntry=iscsiInitiatorEntry, shareIndex=shareIndex, cifsAvgWriteLatency=cifsAvgWriteLatency, diskIndex=diskIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snmpServiceStopped=snmpServiceStopped, fcTargetReadLatency=fcTargetReadLatency, lunReservedSizeLow=lunReservedSizeLow, fcInitiatorsTable=fcInitiatorsTable, diskPoolName=diskPoolName, poolDataSizeLow=poolDataSizeLow, poolUpgraded=poolUpgraded, iscsiTargetReadLatency=iscsiTargetReadLatency, shareQuotaLow=shareQuotaLow, nfsTotalWriteMbps=nfsTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, projectShares=projectShares, projectQuotaSizeLow=projectQuotaSizeLow, tegileArray=tegileArray, notificationDescription=notificationDescription, snmpServiceStopFailed=snmpServiceStopFailed, lunWriteLatency=lunWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, spareDiskReplaced=spareDiskReplaced, projectEntry=projectEntry, shareMountPoint=shareMountPoint, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiCurrent=ipmiCurrent, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, projectIndex=projectIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerA_Uptime=haControllerA_Uptime, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectDeletionFailed=projectDeletionFailed, haControllerB_Name=haControllerB_Name, projectTable=projectTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diagnosticDataUploaded=diagnosticDataUploaded, fcTotalReadMbps=fcTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSEnabled=shareNFSEnabled, notificationReadingUnit=notificationReadingUnit, fcTargets=fcTargets, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, network=network, shareQuotaHigh=shareQuotaHigh, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSReadLatency=shareNFSReadLatency, ipmiTemperature=ipmiTemperature, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectTotalSaving=projectTotalSaving, shareCIFSWriteLatency=shareCIFSWriteLatency, diskSizeLow=diskSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolFreeSizeLow=poolFreeSizeLow, controllerTimeDrift=controllerTimeDrift, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicIndex=nicIndex, shareCIFSReadLatency=shareCIFSReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, notificationEventCode=notificationEventCode, lunSizeLow=lunSizeLow, projectName=projectName, iscsiInitiatorName=iscsiInitiatorName, shareNFSWriteLatency=shareNFSWriteLatency, diskTotalWriteIops=diskTotalWriteIops, fcInitiatorIndex=fcInitiatorIndex, networkIpmpGroupUp=networkIpmpGroupUp, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetGroup=iscsiTargetGroup, shareEntry=shareEntry, fcTargetWriteLatency=fcTargetWriteLatency, lunReadLatency=lunReadLatency, fcInitiatorEntry=fcInitiatorEntry, haResourceStatus=haResourceStatus, poolTotalReadIops=poolTotalReadIops, unknownSensorEvent=unknownSensorEvent, nfsTotalReadIops=nfsTotalReadIops, projectDeleted=projectDeleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationStarted=replicationStarted, haResourceGroup=haResourceGroup, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsTotalReadMbps=cifsTotalReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskIOCount=diskIOCount, diskTable=diskTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, replicationComplete=replicationComplete, poolProjects=poolProjects, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tegileArray_notifications=tegileArray_notifications, diskGoneOffline=diskGoneOffline, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolAvgWriteLatency=poolAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tegile=tegile, iscsiWriteIops=iscsiWriteIops, memoryFailure=memoryFailure, poolDataSizeHigh=poolDataSizeHigh, notificationSeverity=notificationSeverity, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTargetName=iscsiTargetName, nicName=nicName, projectLUNs=projectLUNs, ipmiCriticalInterrupt=ipmiCriticalInterrupt, tdpsUpgradeFailed=tdpsUpgradeFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskAvgReadLatency=diskAvgReadLatency, poolMetaReadMbps=poolMetaReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, projectDataSizeLow=projectDataSizeLow, diskType=diskType, lunReservedSizeHigh=lunReservedSizeHigh, diskError=diskError, shareCreatedSuccessfully=shareCreatedSuccessfully, poolImported=poolImported, haResourcesTable=haResourcesTable, nicEntry=nicEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, diskTotalReadIops=diskTotalReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSWriteMbps=shareNFSWriteMbps, ipmiPowerSupply=ipmiPowerSupply, nfsAvgReadLatency=nfsAvgReadLatency, lunProjectName=lunProjectName, lunReadIops=lunReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunFreeSizeHigh=lunFreeSizeHigh, haControllerB_Uptime=haControllerB_Uptime, netbiosSocketFailure=netbiosSocketFailure, currentObjectGroup=currentObjectGroup, nicReceiveMbps=nicReceiveMbps, diskCount=diskCount, notificationSensorAction=notificationSensorAction, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectDedupEnabled=projectDedupEnabled, poolDegraded=poolDegraded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolProjectCount=poolProjectCount, aclMigrationStarted=aclMigrationStarted, controllerHardwareModel=controllerHardwareModel, lunBlockSize=lunBlockSize, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareNFSReadMbps=shareNFSReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, poolMetaWriteLatency=poolMetaWriteLatency, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiProperties=iscsiProperties, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, volumeModifyCompleted=volumeModifyCompleted, volumeQuotaFinished=volumeQuotaFinished, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, replicationPaused=replicationPaused, shareCompressedRatio=shareCompressedRatio, projectPoolName=projectPoolName, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haControllerA_IPAddr=haControllerA_IPAddr, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tegileGroups=tegileGroups, shareDedupEnabled=shareDedupEnabled, fcTargetModifyCompleted=fcTargetModifyCompleted, lunFreeSizeLow=lunFreeSizeLow, haResourceIndex=haResourceIndex, iscsiTargetError=iscsiTargetError, userLoginFailed=userLoginFailed, fcAvgReadLatency=fcAvgReadLatency, nvdimmFailSoftError=nvdimmFailSoftError, ipmiMemory=ipmiMemory, nicMTU=nicMTU, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetIndex=fcTargetIndex, cpuTotalUsage=cpuTotalUsage, iscsiTargetReadMbps=iscsiTargetReadMbps, lunProtocol=lunProtocol, upgradeDownloadCompleted=upgradeDownloadCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, replicationAborted=replicationAborted, shareDataSizeLow=shareDataSizeLow, smbSocketFailure=smbSocketFailure, shareReservedSizeLow=shareReservedSizeLow, diskIsOnline=diskIsOnline, poolTotalReadMbps=poolTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, shareCIFSReadMbps=shareCIFSReadMbps, adServerTimeDrift=adServerTimeDrift, iscsiTargets=iscsiTargets, cifsTotalReadIops=cifsTotalReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationFailed=replicationFailed, fcTotalWriteIops=fcTotalWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcInitiators=fcInitiators, iscsiTargetAuth=iscsiTargetAuth, cacheSSDReads=cacheSSDReads, notificationProps=notificationProps, notificationTime=notificationTime, projectLunCount=projectLunCount, fcTargetStatus=fcTargetStatus, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, upgradeTimeout=upgradeTimeout, iscsiTargetEntry=iscsiTargetEntry, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, PYSNMP_MODULE_ID=tegile, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationComponentName=notificationComponentName, fcTargetReadMbps=fcTargetReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskAlias=diskAlias, projectShareCount=projectShareCount, poolTable=poolTable, nicState=nicState, iscsiInitiatorIndex=iscsiInitiatorIndex, tegileConformance=tegileConformance, disks=disks, shareName=shareName, notificationSensorSuspect=notificationSensorSuspect, poolDeletionFailed=poolDeletionFailed, diskSizeHigh=diskSizeHigh, snmpAgentVersion=snmpAgentVersion, iscsiTotalReadIops=iscsiTotalReadIops, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolSizeHigh=poolSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, shareNFSWriteIops=shareNFSWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, cpuInterrupts=cpuInterrupts, ipmiVoltage=ipmiVoltage, poolReadCacheReadMbps=poolReadCacheReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationObjects=notificationObjects, diskTotalReadMbps=diskTotalReadMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetName=fcTargetName, lunSnapshotSizeLow=lunSnapshotSizeLow, poolExpanded=poolExpanded, haResourceName=haResourceName, cifsAvgReadLatency=cifsAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, shareTable=shareTable, pools=pools, cacheTotalReadMbps=cacheTotalReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, lunEntry=lunEntry, networkInterfaceUp=networkInterfaceUp, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetsTable=iscsiTargetsTable, lunDataSizeHigh=lunDataSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTargetReadIops=fcTargetReadIops, shareReservedSizeHigh=shareReservedSizeHigh, upgradeCompleted=upgradeCompleted, shareProjectName=shareProjectName, volumeDeleteCompleted=volumeDeleteCompleted, globalStatistics=globalStatistics, diskDataWriteIops=diskDataWriteIops, lunCompressedRatio=lunCompressedRatio, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, smisServiceStopped=smisServiceStopped, lunWriteIops=lunWriteIops, properties=properties, projectThresholdExceedWarning=projectThresholdExceedWarning, fcAvgWriteLatency=fcAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolEntry=poolEntry, networkTotalReceiveMbps=networkTotalReceiveMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, shareNFSReadIops=shareNFSReadIops, iscsiTargetAlias=iscsiTargetAlias, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_Name=haControllerA_Name, cacheTotalReadIops=cacheTotalReadIops, controllerDown=controllerDown, poolSizeLow=poolSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunGUID=lunGUID, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, projectFreeSizeHigh=projectFreeSizeHigh, poolMetaReadLatency=poolMetaReadLatency, volumeDeleteFailed=volumeDeleteFailed, lunName=lunName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, sanProperties=sanProperties, poolHealth=poolHealth, poolState=poolState, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunDataSizeLow=lunDataSizeLow, cpuSystemCalls=cpuSystemCalls, lunTargetGroup=lunTargetGroup, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskTotalWriteMbps=diskTotalWriteMbps, projectModified=projectModified, lunReadMbps=lunReadMbps, controllerUp=controllerUp, iscsiInitiators=iscsiInitiators, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDeleted=poolDeleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, testNotification=testNotification, fcTotalWriteMbps=fcTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunInitiatorGroup=lunInitiatorGroup, poolIndex=poolIndex, poolDataWriteLatency=poolDataWriteLatency, fcTargetGroup=fcTargetGroup, diskState=diskState, lunIndex=lunIndex, poolTotalSaving=poolTotalSaving, snapshotCreationFailed=snapshotCreationFailed, deleteFolderFailed=deleteFolderFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snapshotDeleteFailed=snapshotDeleteFailed, replicationSourceRegistered=replicationSourceRegistered, ipmiOther=ipmiOther, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize)
