...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter64, enterprises, ModuleIdentity, ObjectIdentity, Gauge32, Unsigned32, iso, TimeTicks, MibIdentifier, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter64", "enterprises", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Unsigned32", "iso", "TimeTicks", "MibIdentifier", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolDataWriteIops=poolDataWriteIops, ipmiFan=ipmiFan, diskDataWriteMbps=diskDataWriteMbps, lunReservedSizeLow=lunReservedSizeLow, tegileArray_notifications=tegileArray_notifications, cifsAvgReadLatency=cifsAvgReadLatency, lunBlockSize=lunBlockSize, lunWriteMbps=lunWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps, shareProjectName=shareProjectName, lunSizeHigh=lunSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationEventCode=notificationEventCode, fcProperties=fcProperties, iscsiTargetName=iscsiTargetName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunDedupEnabled=lunDedupEnabled, diskDataReadIops=diskDataReadIops, snapshotDeleteFailed=snapshotDeleteFailed, projectDeletionFailed=projectDeletionFailed, tegileCompliances=tegileCompliances, shareCIFSReadMbps=shareCIFSReadMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, ipmiMemory=ipmiMemory, diskTable=diskTable, netbiosSocketFailure=netbiosSocketFailure, projectPoolName=projectPoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunProtocol=lunProtocol, lunDataSizeHigh=lunDataSizeHigh, diskSizeHigh=diskSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, fcAvgWriteLatency=fcAvgWriteLatency, upgradeFailed=upgradeFailed, diskTotalWriteMbps=diskTotalWriteMbps, nicMTU=nicMTU, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicTable=nicTable, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaReadIops=poolMetaReadIops, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStarted=snmpServiceStarted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, upgradeStarted=upgradeStarted, lunSnapshotSizeLow=lunSnapshotSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, userLoginFailed=userLoginFailed, projectDataSizeHigh=projectDataSizeHigh, properties=properties, projectShareCount=projectShareCount, intelliFlashSoftwareDown=intelliFlashSoftwareDown, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationAbandoned=replicationAbandoned, iscsiTargetIndex=iscsiTargetIndex, haResourceEntry=haResourceEntry, poolUsedSizeLow=poolUsedSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ntpServerTimeDrift=ntpServerTimeDrift, smisServiceStarted=smisServiceStarted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, pools=pools, poolHealth=poolHealth, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetEntry=iscsiTargetEntry, fcInitiators=fcInitiators, nvdimmFailInitializationError=nvdimmFailInitializationError, upgradeDownloadStarted=upgradeDownloadStarted, snapshotRollbackFailed=snapshotRollbackFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, diskGoneOffline=diskGoneOffline, lunDataSizeLow=lunDataSizeLow, projectName=projectName, shareNFSReadMbps=shareNFSReadMbps, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareDeleted=shareDeleted, iscsiTargetWriteIops=iscsiTargetWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareDeletionFailed=shareDeletionFailed, diskState=diskState, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationStarted=replicationStarted, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, shareIndex=shareIndex, smisServiceStopFailed=smisServiceStopFailed, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareSnapshotSizeLow=shareSnapshotSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, haResources=haResources, lunTable=lunTable, shareCompressionEnabled=shareCompressionEnabled, maintenanceModeEnabled=maintenanceModeEnabled, poolEntry=poolEntry, iscsiTargetReadLatency=iscsiTargetReadLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, smisServiceStopped=smisServiceStopped, iscsiWriteIops=iscsiWriteIops, lunCompressionEnabled=lunCompressionEnabled, smbSocketFailure=smbSocketFailure, nicGroup=nicGroup, ipmiVoltage=ipmiVoltage, controllerUp=controllerUp, maintenanceModeDisabled=maintenanceModeDisabled, haControllerB_Uptime=haControllerB_Uptime, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunFreeSizeLow=lunFreeSizeLow, aclMigrationStarted=aclMigrationStarted, shareCIFSWriteMbps=shareCIFSWriteMbps, poolDataReadMbps=poolDataReadMbps, diskIndex=diskIndex, fcPortOffline=fcPortOffline, controllerDown=controllerDown, iscsiTargetError=iscsiTargetError, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeDeleteCompleted=volumeDeleteCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiators=iscsiInitiators, haResourceGroup=haResourceGroup, tegileConformance=tegileConformance, poolState=poolState, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, diskChassisIdx=diskChassisIdx, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTotalWriteIops=fcTotalWriteIops, aclMigrationCompleted=aclMigrationCompleted, diskSizeLow=diskSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationObjects=notificationObjects, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolTotalSaving=poolTotalSaving, iscsiTargetReadIops=iscsiTargetReadIops, poolSizeHigh=poolSizeHigh, poolDegraded=poolDegraded, iscsiInitiatorName=iscsiInitiatorName, replicationSourceRegistered=replicationSourceRegistered, projectCompressionEnabled=projectCompressionEnabled, poolExported=poolExported, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolExpanded=poolExpanded, nfsAvgReadLatency=nfsAvgReadLatency, deleteFolderFailed=deleteFolderFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSReadLatency=shareNFSReadLatency, replicationFailed=replicationFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, unknownSensorEvent=unknownSensorEvent, smisServiceStartFailed=smisServiceStartFailed, shareQuotaFinished=shareQuotaFinished, shareNFSWriteIops=shareNFSWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, ipmiCurrent=ipmiCurrent, iscsiInitiatorIndex=iscsiInitiatorIndex, sanProperties=sanProperties, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, networkIpmpGroupUp=networkIpmpGroupUp, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunReservedSizeHigh=lunReservedSizeHigh, replicationResumed=replicationResumed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunName=lunName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, basicCompliance=basicCompliance, snapshotCloningFailed=snapshotCloningFailed, iscsiTotalReadIops=iscsiTotalReadIops, shareName=shareName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haControllerB_IPAddr=haControllerB_IPAddr, poolMetaReadMbps=poolMetaReadMbps, fcTargetGroup=fcTargetGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haControllerB_Name=haControllerB_Name, projectTotalSaving=projectTotalSaving, poolCreated=poolCreated, cifsTotalWriteMbps=cifsTotalWriteMbps, diskError=diskError, projectEntry=projectEntry, iscsiInitiatorsTable=iscsiInitiatorsTable, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, PYSNMP_MODULE_ID=tegile, shareDataSizeLow=shareDataSizeLow, cpuSystemCalls=cpuSystemCalls, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationSensorAction=notificationSensorAction, lunCompressedRatio=lunCompressedRatio, iscsiProperties=iscsiProperties, tegile=tegile, memoryFailure=memoryFailure, projectLUNs=projectLUNs, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectFreeSizeHigh=projectFreeSizeHigh, cpuInterrupts=cpuInterrupts, haResourceIndex=haResourceIndex, fcPortOnline=fcPortOnline, globalStatistics=globalStatistics, poolProjects=poolProjects, poolReadCacheWriteIops=poolReadCacheWriteIops, poolTable=poolTable, poolUpgraded=poolUpgraded, nicTransmitMbps=nicTransmitMbps, nicState=nicState, controllerHardwareModel=controllerHardwareModel, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolCount=poolCount, snapshotRollbackCompleted=snapshotRollbackCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, diskDataWriteIops=diskDataWriteIops, fcTargetReadIops=fcTargetReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, fcInitiatorEntry=fcInitiatorEntry, adServerTimeDrift=adServerTimeDrift, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDeleted=poolDeleted, upgradeDownloadFailed=upgradeDownloadFailed, notificationReadingUnit=notificationReadingUnit, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nfsTotalWriteIops=nfsTotalWriteIops, replicationPaused=replicationPaused, diskSequentialIOCount=diskSequentialIOCount, snapshotCreationFailed=snapshotCreationFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, notifications=notifications, cacheTotalWriteIops=cacheTotalWriteIops, poolName=poolName, iscsiTargetGroupError=iscsiTargetGroupError, poolQuotaFinished=poolQuotaFinished)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataWriteMbps=poolDataWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetAuth=iscsiTargetAuth, haResourceDescription=haResourceDescription, lunPoolName=lunPoolName, network=network, spareDiskReplaced=spareDiskReplaced, poolDataReadLatency=poolDataReadLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTotalReadMbps=fcTotalReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, lunWriteIops=lunWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResourceActiveNode=haResourceActiveNode, poolDataSizeLow=poolDataSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, lunGUID=lunGUID, projectQuotaFinished=projectQuotaFinished, haControllerA_IPAddr=haControllerA_IPAddr, shareCIFSEnabled=shareCIFSEnabled, diskAlias=diskAlias, lunIndex=lunIndex, iscsiTargetAlias=iscsiTargetAlias, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskTotalWriteIops=diskTotalWriteIops, diskIOCount=diskIOCount, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cpuTotalUsage=cpuTotalUsage, poolReadCacheReadMbps=poolReadCacheReadMbps, networkInterfaceDown=networkInterfaceDown, shareReservedSizeLow=shareReservedSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationSensorSuspect=notificationSensorSuspect, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareDataSizeHigh=shareDataSizeHigh, shareCIFSReadIops=shareCIFSReadIops, fcTargetWriteIops=fcTargetWriteIops, controllerTimeDrift=controllerTimeDrift, shareReservedSizeHigh=shareReservedSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, diskEntry=diskEntry, lunReadLatency=lunReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTargetName=fcTargetName, poolDeletionFailed=poolDeletionFailed, diagnosticDataUploaded=diagnosticDataUploaded, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDataSizeHigh=poolDataSizeHigh, fcTargetReadMbps=fcTargetReadMbps, currentObjectGroup=currentObjectGroup, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCompressedRatio=shareCompressedRatio, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTargets=fcTargets, volumeModifyCompleted=volumeModifyCompleted, currentNotificationGroup=currentNotificationGroup, projectTable=projectTable, nicIndex=nicIndex, notificationTargetEntityName=notificationTargetEntityName, projectFreeSizeLow=projectFreeSizeLow, fcTotalReadIops=fcTotalReadIops, networkInterfaceUp=networkInterfaceUp, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationProps=notificationProps, diskSlowIo=diskSlowIo, shareExceedThresholdWarning=shareExceedThresholdWarning, projectIndex=projectIndex, diskTotalReadMbps=diskTotalReadMbps, shareTable=shareTable, poolFreeSizeHigh=poolFreeSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationDescription=notificationDescription, alertsCleanupCompleted=alertsCleanupCompleted, nfsTotalReadIops=nfsTotalReadIops, projectLunCount=projectLunCount, replicationAborted=replicationAborted, projectDataSizeLow=projectDataSizeLow, upgradeCompleted=upgradeCompleted, diskCount=diskCount, fcInitiatorsTable=fcInitiatorsTable, haResourceStatus=haResourceStatus, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskRandomIOCount=diskRandomIOCount, iscsiTargets=iscsiTargets, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, tegileArray=tegileArray, lunSizeLow=lunSizeLow, lunReadMbps=lunReadMbps, fcTargetsTable=fcTargetsTable, projectCreatedSuccessfully=projectCreatedSuccessfully, cacheTotalReadMbps=cacheTotalReadMbps, volumeDeleteFailed=volumeDeleteFailed, cacheTotalReadIops=cacheTotalReadIops, nicName=nicName, snmpAgentVersion=snmpAgentVersion, shareDedupEnabled=shareDedupEnabled, lunReadIops=lunReadIops, diskDataReadMbps=diskDataReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskType=diskType, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolIndex=poolIndex, projectModified=projectModified, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataReadIops=poolDataReadIops, nvdimmFailSoftError=nvdimmFailSoftError, diskAvgWriteLatency=diskAvgWriteLatency, haControllerA_Uptime=haControllerA_Uptime, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcInitiatorGroup=fcInitiatorGroup, diskIsOnline=diskIsOnline, shareNFSReadIops=shareNFSReadIops, ipmiOther=ipmiOther, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, lunProjectName=lunProjectName, diskPoolName=diskPoolName, shareQuotaLow=shareQuotaLow, iscsiInitiatorEntry=iscsiInitiatorEntry, poolSizeLow=poolSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, fcInitiatorIndex=fcInitiatorIndex, sharePoolName=sharePoolName, cifsAvgWriteLatency=cifsAvgWriteLatency, projectDedupEnabled=projectDedupEnabled, projectShares=projectShares, fcTargetWriteLatency=fcTargetWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeTimeout=upgradeTimeout, cifsTotalReadIops=cifsTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, diskTotalReadIops=diskTotalReadIops, haResourcesTable=haResourcesTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationComponentName=notificationComponentName, notificationTime=notificationTime, haControllerA_Name=haControllerA_Name, targetGroupMemberAdded=targetGroupMemberAdded, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetStatus=fcTargetStatus, notificationSensorNumber=notificationSensorNumber, poolFreeSizeLow=poolFreeSizeLow, lunWriteLatency=lunWriteLatency, cacheSSDReads=cacheSSDReads, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargetWriteMbps=fcTargetWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareQuotaHigh=shareQuotaHigh, iscsiTargetsTable=iscsiTargetsTable, notificationSeverity=notificationSeverity, poolAvgReadLatency=poolAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, ipmiThreshold=ipmiThreshold, poolTotalReadIops=poolTotalReadIops, nicEntry=nicEntry, replicationTargetDeleted=replicationTargetDeleted, snmpServiceStopFailed=snmpServiceStopFailed, snmpServiceStopped=snmpServiceStopped, lunTargetGroup=lunTargetGroup, ipmiPowerSupply=ipmiPowerSupply, shareCIFSWriteIops=shareCIFSWriteIops, cacheRAMReads=cacheRAMReads, projectDeleted=projectDeleted, iscsiTargetGroup=iscsiTargetGroup, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcAvgReadLatency=fcAvgReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, lunEntry=lunEntry, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolMetaReadLatency=poolMetaReadLatency, disks=disks, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunInitiatorGroup=lunInitiatorGroup, projectQuotaSizeLow=projectQuotaSizeLow, poolOwnerController=poolOwnerController, testNotification=testNotification, nicReceiveMbps=nicReceiveMbps, volumeQuotaFinished=volumeQuotaFinished, projectSnapshotSizeLow=projectSnapshotSizeLow, tegileGroups=tegileGroups, fcTargetIndex=fcTargetIndex, ipmiTemperature=ipmiTemperature, poolImported=poolImported, fcTargetReadLatency=fcTargetReadLatency, haResourceName=haResourceName, shareEntry=shareEntry, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareNFSEnabled=shareNFSEnabled, replicationComplete=replicationComplete, poolProjectCount=poolProjectCount, shareMountPoint=shareMountPoint, fcTargetEntry=fcTargetEntry, targetGroupMemberRemoved=targetGroupMemberRemoved)
