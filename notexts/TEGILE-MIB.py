...
iso, Gauge32, Counter64, IpAddress, TimeTicks, NotificationType, Counter32, MibIdentifier, Bits, Unsigned32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter64", "IpAddress", "TimeTicks", "NotificationType", "Counter32", "MibIdentifier", "Bits", "Unsigned32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskTotalWriteIops=diskTotalWriteIops, poolDeleted=poolDeleted, haControllerA_Name=haControllerA_Name, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolExpanded=poolExpanded, diskAlias=diskAlias, shareDeletionFailed=shareDeletionFailed, maintenanceModeDisabled=maintenanceModeDisabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcPortOnline=fcPortOnline, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, shareDeleted=shareDeleted, haControllerA_Uptime=haControllerA_Uptime, poolCount=poolCount, tegileArray_notifications=tegileArray_notifications, notificationSensorSuspect=notificationSensorSuspect, ipmiVoltage=ipmiVoltage, poolTable=poolTable, shareCompressionEnabled=shareCompressionEnabled, network=network, upgradeStarted=upgradeStarted, lunBlockSize=lunBlockSize, lunGUID=lunGUID, diskTotalWriteMbps=diskTotalWriteMbps, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, sharePoolName=sharePoolName, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceName=haResourceName, lunDataSizeLow=lunDataSizeLow, poolDeletionFailed=poolDeletionFailed, volumeModifyCompleted=volumeModifyCompleted, shareNFSEnabled=shareNFSEnabled, poolDataSizeHigh=poolDataSizeHigh, diskDataWriteMbps=diskDataWriteMbps, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicTable=nicTable, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, upgradeDownloadStarted=upgradeDownloadStarted, diskCount=diskCount, poolAvgWriteLatency=poolAvgWriteLatency, poolOwnerController=poolOwnerController, projectName=projectName, lunProjectName=lunProjectName, nvdimmFailInitializationError=nvdimmFailInitializationError, snmpServiceStopped=snmpServiceStopped, globalStatistics=globalStatistics, poolDataWriteMbps=poolDataWriteMbps, poolProjects=poolProjects, fcTargetsTable=fcTargetsTable, lunReadIops=lunReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tegileConformance=tegileConformance, diskTable=diskTable, poolMetaWriteMbps=poolMetaWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, smisServiceStopFailed=smisServiceStopFailed, notificationReadingUnit=notificationReadingUnit, notificationEventCode=notificationEventCode, replicationTargetDeleted=replicationTargetDeleted, networkInterfaceDown=networkInterfaceDown, controllerHardwareModel=controllerHardwareModel, shareDataSizeHigh=shareDataSizeHigh, projectTotalSaving=projectTotalSaving, smisServiceStartFailed=smisServiceStartFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, haResourceGroup=haResourceGroup, poolSizeLow=poolSizeLow, nfsTotalReadIops=nfsTotalReadIops, shareQuotaLow=shareQuotaLow, projectLunCount=projectLunCount, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcPortOffline=fcPortOffline, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationComponentName=notificationComponentName, cacheTotalReadMbps=cacheTotalReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunPoolName=lunPoolName, maintenanceModeEnabled=maintenanceModeEnabled, upgradeFailed=upgradeFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDataWriteIops=poolDataWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, snapshotRollbackFailed=snapshotRollbackFailed, diskIsOnline=diskIsOnline, iscsiTargetReadIops=iscsiTargetReadIops, lunReadMbps=lunReadMbps, sanProperties=sanProperties, ipmiTemperature=ipmiTemperature, cacheRAMReads=cacheRAMReads, poolFreeSizeHigh=poolFreeSizeHigh, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunSizeHigh=lunSizeHigh, notificationTime=notificationTime, alertsCleanupCompleted=alertsCleanupCompleted, lunSizeLow=lunSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetReadMbps=iscsiTargetReadMbps, nicMTU=nicMTU, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectQuotaFinished=projectQuotaFinished, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haResourceActiveNode=haResourceActiveNode, ipmiCurrent=ipmiCurrent, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetGroup=fcTargetGroup, poolTotalReadMbps=poolTotalReadMbps, adServerTimeDrift=adServerTimeDrift, fcTargetReadIops=fcTargetReadIops, snapshotCloneCompleted=snapshotCloneCompleted, tegile=tegile, poolTotalWriteIops=poolTotalWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haResourceDescription=haResourceDescription, lunFreeSizeHigh=lunFreeSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolUpgraded=poolUpgraded, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskSequentialIOCount=diskSequentialIOCount, shareReservedSizeLow=shareReservedSizeLow, controllerDown=controllerDown, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiWriteIops=iscsiWriteIops, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskType=diskType, iscsiTargetAuth=iscsiTargetAuth, poolReadCacheWriteIops=poolReadCacheWriteIops, diskPoolName=diskPoolName, iscsiAvgReadLatency=iscsiAvgReadLatency, replicationComplete=replicationComplete, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationFailed=replicationFailed, tegileCompliances=tegileCompliances, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, poolAvgReadLatency=poolAvgReadLatency, fcProperties=fcProperties, fcInitiatorGroup=fcInitiatorGroup, unknownSensorEvent=unknownSensorEvent, fcTargetModifyCompleted=fcTargetModifyCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, lunDedupEnabled=lunDedupEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolIndex=poolIndex, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, sensorFailureEvent=sensorFailureEvent, fcTotalReadIops=fcTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolExported=poolExported, projectShareCount=projectShareCount, ipmiPowerSupply=ipmiPowerSupply, targetGroupDeleteCompleted=targetGroupDeleteCompleted, notificationSensorAction=notificationSensorAction, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskRandomIOCount=diskRandomIOCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationSourceRegistered=replicationSourceRegistered, lunWriteIops=lunWriteIops, fcTargetStatus=fcTargetStatus, smbSocketFailure=smbSocketFailure, cifsTotalReadMbps=cifsTotalReadMbps, notificationSensorNumber=notificationSensorNumber, intelliFlashSoftwareUp=intelliFlashSoftwareUp, controllerTimeDrift=controllerTimeDrift, tdpsUpgradeFailed=tdpsUpgradeFailed, shareEntry=shareEntry, projectSnapshotSizeLow=projectSnapshotSizeLow, projectDedupEnabled=projectDedupEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, shareNFSWriteIops=shareNFSWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, lunReservedSizeHigh=lunReservedSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectModified=projectModified, iscsiTargetName=iscsiTargetName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetGroup=iscsiTargetGroup, nfsAvgReadLatency=nfsAvgReadLatency, shareProjectName=shareProjectName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourcesTable=haResourcesTable, cacheSSDReads=cacheSSDReads, haControllerA_IPAddr=haControllerA_IPAddr, lunIndex=lunIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareIndex=shareIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunReservedSizeLow=lunReservedSizeLow, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolName=poolName, projectQuotaSizeLow=projectQuotaSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunTable=lunTable, shareNFSReadIops=shareNFSReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCIFSWriteIops=shareCIFSWriteIops, tegileArray=tegileArray, notificationProps=notificationProps, poolTotalWriteMbps=poolTotalWriteMbps, poolMetaReadIops=poolMetaReadIops, PYSNMP_MODULE_ID=tegile, iscsiTargets=iscsiTargets, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nvdimmFailDeviceError=nvdimmFailDeviceError, shareQuotaFinished=shareQuotaFinished, lunFreeSizeLow=lunFreeSizeLow, fcInitiators=fcInitiators, shareCIFSEnabled=shareCIFSEnabled, smisServiceStopped=smisServiceStopped, disks=disks, ntpServerTimeDrift=ntpServerTimeDrift, poolCreated=poolCreated, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetWriteLatency=fcTargetWriteLatency, diskIOCount=diskIOCount, nicEntry=nicEntry, fcTargetReadMbps=fcTargetReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskSizeHigh=diskSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", nicName=nicName, haControllerB_Uptime=haControllerB_Uptime, fcAvgReadLatency=fcAvgReadLatency, lunTargetGroup=lunTargetGroup, volumeQuotaFinished=volumeQuotaFinished, diskIndex=diskIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, diskDataReadMbps=diskDataReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetEntry=iscsiTargetEntry, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataReadMbps=poolDataReadMbps, diskError=diskError, replicationPaused=replicationPaused, cpuSystemCalls=cpuSystemCalls, replicationResumed=replicationResumed, shareQuotaHigh=shareQuotaHigh, fcTargetEntry=fcTargetEntry, lunCompressionEnabled=lunCompressionEnabled, projectDeleted=projectDeleted, iscsiProperties=iscsiProperties, volumeDeleteCompleted=volumeDeleteCompleted, lunDataSizeHigh=lunDataSizeHigh, poolProjectCount=poolProjectCount, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskTotalReadIops=diskTotalReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, projectThresholdExceedWarning=projectThresholdExceedWarning, lunWriteLatency=lunWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, nicGroup=nicGroup, lunReadLatency=lunReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, diskSlowIo=diskSlowIo, shareNFSReadLatency=shareNFSReadLatency, diskDataReadIops=diskDataReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, poolHealth=poolHealth, fcTargetIndex=fcTargetIndex, poolDataSizeLow=poolDataSizeLow, nicIndex=nicIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataWriteLatency=poolDataWriteLatency, replicationStarted=replicationStarted, poolTotalReadIops=poolTotalReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunInitiatorGroup=lunInitiatorGroup, shareTable=shareTable, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, projectFreeSizeLow=projectFreeSizeLow, testNotification=testNotification, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, currentObjectGroup=currentObjectGroup, poolUsedSizeLow=poolUsedSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, projectIndex=projectIndex, replicationAbandoned=replicationAbandoned, fcTargetName=fcTargetName, notificationReadingTriggerValue=notificationReadingTriggerValue, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTargetReadLatency=fcTargetReadLatency, haResourceStatus=haResourceStatus, poolMetaReadMbps=poolMetaReadMbps, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, basicCompliance=basicCompliance, nicReceiveMbps=nicReceiveMbps, cacheTotalReadIops=cacheTotalReadIops, poolDataReadLatency=poolDataReadLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, controllerUp=controllerUp, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, diskEntry=diskEntry, currentNotificationGroup=currentNotificationGroup, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, shareCIFSWriteMbps=shareCIFSWriteMbps, shareMountPoint=shareMountPoint, fcInitiatorName=fcInitiatorName, projectDataSizeHigh=projectDataSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTotalReadIops=iscsiTotalReadIops, lunName=lunName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectTable=projectTable, spareDiskReplaced=spareDiskReplaced, networkIpmpGroupDown=networkIpmpGroupDown, projectDeletionFailed=projectDeletionFailed, iscsiTargetsTable=iscsiTargetsTable, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, replicationAborted=replicationAborted, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareDataSizeLow=shareDataSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDegraded=poolDegraded, shareCIFSReadIops=shareCIFSReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskChassisIdx=diskChassisIdx, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiOther=ipmiOther, fcTotalReadMbps=fcTotalReadMbps, tegileGroups=tegileGroups, poolEntry=poolEntry, notificationDescription=notificationDescription, ipmiMemory=ipmiMemory, snapshotCreationFailed=snapshotCreationFailed, haResources=haResources, networkIpmpGroupUp=networkIpmpGroupUp, shareSnapshotSizeHigh=shareSnapshotSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunProtocol=lunProtocol, projectDataSizeLow=projectDataSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetError=iscsiTargetError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceEntry=haResourceEntry, projectPoolName=projectPoolName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolUsedSizeHigh=poolUsedSizeHigh, cifsTotalReadIops=cifsTotalReadIops, shareCompressedRatio=shareCompressedRatio, lunEntry=lunEntry, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, snmpAgentVersion=snmpAgentVersion, lunWriteMbps=lunWriteMbps, properties=properties, fcInitiatorsTable=fcInitiatorsTable, fcTargetWriteIops=fcTargetWriteIops, upgradeCompleted=upgradeCompleted, poolSizeHigh=poolSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, projectShares=projectShares, shareCIFSReadLatency=shareCIFSReadLatency, poolMetaWriteIops=poolMetaWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, memoryFailure=memoryFailure, poolState=poolState, notificationSeverity=notificationSeverity, diskGoneOffline=diskGoneOffline, snapshotRollbackCompleted=snapshotRollbackCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, nvdimmFailSoftError=nvdimmFailSoftError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiFan=ipmiFan, snmpServiceStarted=snmpServiceStarted, upgradeTimeout=upgradeTimeout, iscsiInitiators=iscsiInitiators, pools=pools, diskState=diskState, deleteFolderCompleted=deleteFolderCompleted, iscsiInitiatorName=iscsiInitiatorName, diskAvgReadLatency=diskAvgReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectEntry=projectEntry, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataReadIops=poolDataReadIops, poolFreeSizeLow=poolFreeSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargets=fcTargets, fcTargetWriteMbps=fcTargetWriteMbps, shareName=shareName, poolImported=poolImported, notifications=notifications, diskTotalReadMbps=diskTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, netbiosSocketFailure=netbiosSocketFailure, shareNFSWriteMbps=shareNFSWriteMbps, fcInitiatorEntry=fcInitiatorEntry, snapshotCloningFailed=snapshotCloningFailed, diskSizeLow=diskSizeLow, userLoginFailed=userLoginFailed, aclMigrationStarted=aclMigrationStarted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, networkTotalTransmitMbps=networkTotalTransmitMbps, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationObjects=notificationObjects, fcTotalWriteIops=fcTotalWriteIops, poolMetaReadLatency=poolMetaReadLatency, nicState=nicState, fcInitiatorIndex=fcInitiatorIndex, nicTransmitMbps=nicTransmitMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, smisServiceStarted=smisServiceStarted, networkInterfaceUp=networkInterfaceUp, haResourceIndex=haResourceIndex, projectLUNs=projectLUNs, ipmiThreshold=ipmiThreshold, iscsiTargetAlias=iscsiTargetAlias, volumeDeleteFailed=volumeDeleteFailed, diskDataWriteIops=diskDataWriteIops, haControllerB_IPAddr=haControllerB_IPAddr)
