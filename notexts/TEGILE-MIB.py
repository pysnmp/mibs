...
# Produced by pysmi-1.1.8 at Thu Feb  9 12:08:33 2023
...
Unsigned32, Integer32, MibIdentifier, enterprises, Bits, ModuleIdentity, Counter32, IpAddress, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "MibIdentifier", "enterprises", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", smbSocketFailure=smbSocketFailure, snmpAgentVersion=snmpAgentVersion, haResourceIndex=haResourceIndex, nicTransmitMbps=nicTransmitMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolFreeSizeHigh=poolFreeSizeHigh, poolOwnerController=poolOwnerController, projectPoolName=projectPoolName, nicGroup=nicGroup, poolDegraded=poolDegraded, fcTargetIndex=fcTargetIndex, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCompressionEnabled=shareCompressionEnabled, deleteFolderFailed=deleteFolderFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, poolExported=poolExported, lunDedupEnabled=lunDedupEnabled, ipmiFan=ipmiFan, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolDeleted=poolDeleted, nfsTotalReadIops=nfsTotalReadIops, shareCIFSReadMbps=shareCIFSReadMbps, upgradeTimeout=upgradeTimeout, projectLunCount=projectLunCount, lunName=lunName, ipmiTemperature=ipmiTemperature, ipmiOther=ipmiOther, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiatorName=fcInitiatorName, diskError=diskError, shareDeletionFailed=shareDeletionFailed, cacheRAMReads=cacheRAMReads, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskDataReadMbps=diskDataReadMbps, userLoginFailed=userLoginFailed, fcTargetsTable=fcTargetsTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeQuotaFinished=volumeQuotaFinished, lunSizeLow=lunSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, projectDeleted=projectDeleted, iscsiTargetAlias=iscsiTargetAlias, currentNotificationGroup=currentNotificationGroup, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetStatus=fcTargetStatus, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notificationDescription=notificationDescription, properties=properties, iscsiProperties=iscsiProperties, fcInitiatorGroup=fcInitiatorGroup, deleteFolderCompleted=deleteFolderCompleted, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStartFailed=smisServiceStartFailed, poolMetaWriteLatency=poolMetaWriteLatency, haControllerA_Name=haControllerA_Name, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalWriteIops=diskTotalWriteIops, smisServiceStopped=smisServiceStopped, nvdimmFailUnknownError=nvdimmFailUnknownError, projectQuotaSizeLow=projectQuotaSizeLow, PYSNMP_MODULE_ID=tegile, notificationSensorNumber=notificationSensorNumber, upgradeCompleted=upgradeCompleted, poolQuotaFinished=poolQuotaFinished, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetsTable=iscsiTargetsTable, lunEntry=lunEntry, ipmiVoltage=ipmiVoltage, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationComplete=replicationComplete, targetGroupMemberRemoved=targetGroupMemberRemoved, aclMigrationStarted=aclMigrationStarted, shareMountPoint=shareMountPoint, poolState=poolState, iscsiTargets=iscsiTargets, shareNFSReadMbps=shareNFSReadMbps, fcInitiators=fcInitiators, haResourceStatus=haResourceStatus, projectQuotaSizeHigh=projectQuotaSizeHigh, diskSizeHigh=diskSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, replicationAborted=replicationAborted, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorsTable=fcInitiatorsTable, cpuTotalUsage=cpuTotalUsage, poolMetaReadMbps=poolMetaReadMbps, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcPortOffline=fcPortOffline, fcTargets=fcTargets, nfsAvgReadLatency=nfsAvgReadLatency, spareDiskReplaced=spareDiskReplaced, volumeDeleteCompleted=volumeDeleteCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, poolAvgWriteLatency=poolAvgWriteLatency, poolProjectCount=poolProjectCount, cpuInterrupts=cpuInterrupts, fcTargetWriteLatency=fcTargetWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, lunBlockSize=lunBlockSize, nicTable=nicTable, replicationFailed=replicationFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, upgradeFailed=upgradeFailed, lunTable=lunTable, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDataReadMbps=poolDataReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, projectEntry=projectEntry, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, smisServiceStarted=smisServiceStarted, tdpsUpgradeFailed=tdpsUpgradeFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notifications=notifications, snmpServiceStarted=snmpServiceStarted, projectCreatedSuccessfully=projectCreatedSuccessfully, poolExpanded=poolExpanded, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCIFSEnabled=shareCIFSEnabled, cifsAvgReadLatency=cifsAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCreatedSuccessfully=shareCreatedSuccessfully, haControllerA_IPAddr=haControllerA_IPAddr, notificationTargetEntityName=notificationTargetEntityName, lunTargetGroup=lunTargetGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectDedupEnabled=projectDedupEnabled, haControllerA_Uptime=haControllerA_Uptime, notificationObjects=notificationObjects, diskDataWriteIops=diskDataWriteIops, poolName=poolName, iscsiInitiators=iscsiInitiators, smisServiceStopFailed=smisServiceStopFailed, diskSequentialIOCount=diskSequentialIOCount, poolAvgReadLatency=poolAvgReadLatency, haResourceName=haResourceName, projectShareCount=projectShareCount, fcTargetReadMbps=fcTargetReadMbps, notificationProps=notificationProps, upgradeDownloadStarted=upgradeDownloadStarted, diskGoneOffline=diskGoneOffline, notificationSeverity=notificationSeverity, maintenanceModeEnabled=maintenanceModeEnabled, diskDataReadIops=diskDataReadIops, cacheTotalReadIops=cacheTotalReadIops, lunReadIops=lunReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunWriteLatency=lunWriteLatency, controllerUp=controllerUp, shareEntry=shareEntry, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceEntry=haResourceEntry, ipmiMemory=ipmiMemory, memoryFailure=memoryFailure, shareNFSEnabled=shareNFSEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareTable=shareTable, shareNFSWriteIops=shareNFSWriteIops, replicationSourceRegistered=replicationSourceRegistered, projectIndex=projectIndex, replicationStarted=replicationStarted, tegileConformance=tegileConformance, cacheTotalReadMbps=cacheTotalReadMbps, projectName=projectName, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, poolTotalSaving=poolTotalSaving, poolReadCacheReadLatency=poolReadCacheReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolIndex=poolIndex, snapshotDeleteFailed=snapshotDeleteFailed, poolEntry=poolEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskIsOnline=diskIsOnline, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetAuth=iscsiTargetAuth, lunProjectName=lunProjectName, nicReceiveMbps=nicReceiveMbps, controllerHardwareModel=controllerHardwareModel, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolCreated=poolCreated, notificationReadingUnit=notificationReadingUnit, poolDataWriteMbps=poolDataWriteMbps, projectShares=projectShares, poolDataReadIops=poolDataReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiWriteIops=iscsiWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskAlias=diskAlias, notificationComponentName=notificationComponentName, poolUsedSizeHigh=poolUsedSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, controllerDown=controllerDown, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareNFSWriteLatency=shareNFSWriteLatency, poolImported=poolImported, nicIndex=nicIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, disks=disks, poolHealth=poolHealth, network=network, iscsiTargetGroup=iscsiTargetGroup, poolTotalReadIops=poolTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, tegileGroups=tegileGroups, iscsiInitiatorEntry=iscsiInitiatorEntry, poolMetaReadLatency=poolMetaReadLatency, tegileArray=tegileArray, shareCIFSWriteLatency=shareCIFSWriteLatency, diskState=diskState, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskSlowIo=diskSlowIo, nfsTotalWriteIops=nfsTotalWriteIops, diskDataWriteMbps=diskDataWriteMbps, shareQuotaLow=shareQuotaLow, lunCompressionEnabled=lunCompressionEnabled, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetReadLatency=fcTargetReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTotalReadIops=fcTotalReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", haResourceActiveNode=haResourceActiveNode, iscsiTargetReadLatency=iscsiTargetReadLatency, diskType=diskType, shareCIFSWriteIops=shareCIFSWriteIops, poolSizeHigh=poolSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, ipmiPowerSupply=ipmiPowerSupply, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheSSDReads=cacheSSDReads, projectCompressionEnabled=projectCompressionEnabled, fcPortOnline=fcPortOnline, fcInitiatorEntry=fcInitiatorEntry, notificationSensorAction=notificationSensorAction, projectLUNs=projectLUNs, haResourcesTable=haResourcesTable, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, maintenanceModeDisabled=maintenanceModeDisabled, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetEntry=fcTargetEntry, diskTotalReadIops=diskTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunSnapshotSizeLow=lunSnapshotSizeLow, sanProperties=sanProperties, shareDedupEnabled=shareDedupEnabled, fcAvgReadLatency=fcAvgReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, globalStatistics=globalStatistics, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunPoolName=lunPoolName, shareDeleted=shareDeleted, diskIOCount=diskIOCount, projectFreeSizeLow=projectFreeSizeLow, replicationPaused=replicationPaused, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haResources=haResources, poolFreeSizeLow=poolFreeSizeLow, fcTargetGroup=fcTargetGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, currentObjectGroup=currentObjectGroup, netbiosSocketFailure=netbiosSocketFailure, poolDataSizeLow=poolDataSizeLow, haControllerB_Name=haControllerB_Name, replicationTargetDeleted=replicationTargetDeleted, lunFreeSizeLow=lunFreeSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetIndex=iscsiTargetIndex, lunWriteIops=lunWriteIops, shareReservedSizeLow=shareReservedSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cifsTotalWriteIops=cifsTotalWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, nicEntry=nicEntry, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, adServerTimeDrift=adServerTimeDrift, sharePoolName=sharePoolName, snmpServiceStopped=snmpServiceStopped, notificationTime=notificationTime, ipmiCriticalInterrupt=ipmiCriticalInterrupt, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tegileArray_notifications=tegileArray_notifications, tegileCompliances=tegileCompliances, fcTotalWriteIops=fcTotalWriteIops, shareName=shareName, networkInterfaceDown=networkInterfaceDown, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectDataSizeHigh=projectDataSizeHigh, controllerTimeDrift=controllerTimeDrift, poolTotalWriteIops=poolTotalWriteIops, fcTargetReadIops=fcTargetReadIops, fcTotalWriteMbps=fcTotalWriteMbps, diskSizeLow=diskSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolSizeLow=poolSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcProperties=fcProperties, diskPoolName=diskPoolName, projectTable=projectTable, shareExceedThresholdWarning=shareExceedThresholdWarning, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetName=iscsiTargetName, shareSnapshotSizeLow=shareSnapshotSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiInitiatorName=iscsiInitiatorName, lunDataSizeHigh=lunDataSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolCount=poolCount, shareDataSizeLow=shareDataSizeLow, haResourceGroup=haResourceGroup, nicState=nicState, lunGUID=lunGUID, diskAvgReadLatency=diskAvgReadLatency, fcTotalReadMbps=fcTotalReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, snapshotCreationFailed=snapshotCreationFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareQuotaFinished=shareQuotaFinished, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheWriteIops=poolReadCacheWriteIops, poolTable=poolTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nicName=nicName, webdocsUpgradeFailed=webdocsUpgradeFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolReadCacheReadMbps=poolReadCacheReadMbps, replicationResumed=replicationResumed, targetGroupCreateCompleted=targetGroupCreateCompleted, poolMetaReadIops=poolMetaReadIops, shareNFSReadIops=shareNFSReadIops, lunProtocol=lunProtocol, nicMTU=nicMTU, lunCompressedRatio=lunCompressedRatio, lunWriteMbps=lunWriteMbps, lunReadLatency=lunReadLatency, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorIndex=fcInitiatorIndex, lunDataSizeLow=lunDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, poolProjects=poolProjects, fcAvgWriteLatency=fcAvgWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, ipmiThreshold=ipmiThreshold, poolDataSizeHigh=poolDataSizeHigh, shareDataSizeHigh=shareDataSizeHigh, projectTotalSaving=projectTotalSaving, pools=pools, lunReadMbps=lunReadMbps, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastores=vmwareNFSDatastores, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectModified=projectModified, shareCIFSReadIops=shareCIFSReadIops, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetName=fcTargetName, ipmiCurrent=ipmiCurrent, lunSizeHigh=lunSizeHigh, networkTotalTransmitMbps=networkTotalTransmitMbps, snapshotRollbackFailed=snapshotRollbackFailed, snapshotCloningFailed=snapshotCloningFailed, shareNFSReadLatency=shareNFSReadLatency, cpuSystemCalls=cpuSystemCalls, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, projectDataSizeLow=projectDataSizeLow, diskChassisIdx=diskChassisIdx, shareProjectName=shareProjectName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskEntry=diskEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, unknownSensorEvent=unknownSensorEvent, tegile=tegile, aclMigrationCompleted=aclMigrationCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationEventCode=notificationEventCode, shareCompressedRatio=shareCompressedRatio, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskIndex=diskIndex, shareIndex=shareIndex, networkIpmpGroupUp=networkIpmpGroupUp, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationAbandoned=replicationAbandoned, diskAvgWriteLatency=diskAvgWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, poolDataReadLatency=poolDataReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolUsedSizeLow=poolUsedSizeLow, upgradeStarted=upgradeStarted, iscsiTotalReadIops=iscsiTotalReadIops, haResourceDescription=haResourceDescription, testNotification=testNotification, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, basicCompliance=basicCompliance, poolTotalReadMbps=poolTotalReadMbps, networkInterfaceUp=networkInterfaceUp, poolUpgraded=poolUpgraded, iscsiTargetError=iscsiTargetError, diskTable=diskTable, snmpServiceStartFailed=snmpServiceStartFailed, diskCount=diskCount, poolMetaWriteIops=poolMetaWriteIops, lunIndex=lunIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetReadIops=iscsiTargetReadIops, sensorFailureEvent=sensorFailureEvent, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareQuotaHigh=shareQuotaHigh)
