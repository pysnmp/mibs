...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress, Unsigned32, TimeTicks, Counter32, Counter64, ObjectIdentity, Integer32, Bits, enterprises, ModuleIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "Integer32", "Bits", "enterprises", "ModuleIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSWriteIops=shareCIFSWriteIops, volumeDeleteFailed=volumeDeleteFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkInterfaceUp=networkInterfaceUp, poolTable=poolTable, shareDeletionFailed=shareDeletionFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, unknownSensorEvent=unknownSensorEvent, network=network, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetWriteIops=fcTargetWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, cacheTotalWriteMbps=cacheTotalWriteMbps, lunTargetGroup=lunTargetGroup, iscsiTargetGroupError=iscsiTargetGroupError, alertsCleanupCompleted=alertsCleanupCompleted, diskDataWriteIops=diskDataWriteIops, lunSizeHigh=lunSizeHigh, nicState=nicState, networkInterfaceDown=networkInterfaceDown, fcTotalWriteIops=fcTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSWriteMbps=shareNFSWriteMbps, poolUpgraded=poolUpgraded, projectEntry=projectEntry, shareNFSEnabled=shareNFSEnabled, iscsiProperties=iscsiProperties, cpuInterrupts=cpuInterrupts, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskTotalReadIops=diskTotalReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, cifsTotalReadMbps=cifsTotalReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, projectName=projectName, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cifsAvgReadLatency=cifsAvgReadLatency, iscsiWriteIops=iscsiWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicTable=nicTable, shareQuotaFinished=shareQuotaFinished, shareQuotaLow=shareQuotaLow, diskTotalWriteMbps=diskTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskAlias=diskAlias, projectDeleted=projectDeleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, fcAvgWriteLatency=fcAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolUsedSizeLow=poolUsedSizeLow, shareCIFSReadIops=shareCIFSReadIops, shareName=shareName, diskState=diskState, replicationResumed=replicationResumed, iscsiTargetIndex=iscsiTargetIndex, diskIOCount=diskIOCount, targetGroupMemberAdded=targetGroupMemberAdded, networkTotalReceiveMbps=networkTotalReceiveMbps, disks=disks, ipmiCurrent=ipmiCurrent, lunEntry=lunEntry, poolDataReadLatency=poolDataReadLatency, projectLunCount=projectLunCount, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, poolDataReadIops=poolDataReadIops, smbSocketFailure=smbSocketFailure, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegileArray=tegileArray, diskDataWriteMbps=diskDataWriteMbps, nicGroup=nicGroup, diskSizeHigh=diskSizeHigh, tegileGroups=tegileGroups, poolDataWriteMbps=poolDataWriteMbps, notifications=notifications, targetGroupMemberRemoved=targetGroupMemberRemoved, cifsTotalReadIops=cifsTotalReadIops, haControllerB_Uptime=haControllerB_Uptime, cacheRAMReads=cacheRAMReads, lunReadLatency=lunReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, sensorFailureEvent=sensorFailureEvent, iscsiTargetsTable=iscsiTargetsTable, lunGUID=lunGUID, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicName=nicName, adServerTimeDrift=adServerTimeDrift, fcAvgReadLatency=fcAvgReadLatency, tegile=tegile, poolState=poolState, lunCompressionEnabled=lunCompressionEnabled, properties=properties, shareTable=shareTable, shareCIFSEnabled=shareCIFSEnabled, poolDataWriteLatency=poolDataWriteLatency, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataSizeHigh=poolDataSizeHigh, fcTargets=fcTargets, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareReservedSizeLow=shareReservedSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, poolExpanded=poolExpanded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskIsOnline=diskIsOnline, projectLUNs=projectLUNs, lunPoolName=lunPoolName, iscsiTargetEntry=iscsiTargetEntry, cacheTotalReadMbps=cacheTotalReadMbps, haResourceActiveNode=haResourceActiveNode, lunProtocol=lunProtocol, poolQuotaFinished=poolQuotaFinished, cacheTotalReadIops=cacheTotalReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCompressionEnabled=shareCompressionEnabled, diagnosticDataUploaded=diagnosticDataUploaded, poolDataReadMbps=poolDataReadMbps, haResourceEntry=haResourceEntry, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcInitiatorsTable=fcInitiatorsTable, shareEntry=shareEntry, lunCompressedRatio=lunCompressedRatio, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskChassisIdx=diskChassisIdx, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, controllerUp=controllerUp, smisServiceStopFailed=smisServiceStopFailed, fcTotalReadIops=fcTotalReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, lunReservedSizeHigh=lunReservedSizeHigh, poolTotalReadMbps=poolTotalReadMbps, sharePoolName=sharePoolName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationEventCode=notificationEventCode, notificationReadingUnit=notificationReadingUnit, nfsAvgReadLatency=nfsAvgReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, diskSlowIo=diskSlowIo, globalStatistics=globalStatistics, snmpServiceStartFailed=snmpServiceStartFailed, lunDataSizeLow=lunDataSizeLow, poolCount=poolCount, shareDedupEnabled=shareDedupEnabled, diskAvgReadLatency=diskAvgReadLatency, smisServiceStartFailed=smisServiceStartFailed, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaWriteMbps=poolMetaWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunBlockSize=lunBlockSize, projectPoolName=projectPoolName, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorIndex=fcInitiatorIndex, fcTargetIndex=fcTargetIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunFreeSizeHigh=lunFreeSizeHigh, spareDiskReplaced=spareDiskReplaced, shareCIFSReadLatency=shareCIFSReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiators=iscsiInitiators, fcTargetStatus=fcTargetStatus, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareMountPoint=shareMountPoint, testNotification=testNotification, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectShares=projectShares, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectTable=projectTable, fcTargetReadIops=fcTargetReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, snapshotDeleteFailed=snapshotDeleteFailed, projectTotalSaving=projectTotalSaving, snapshotCloningFailed=snapshotCloningFailed, projectQuotaFinished=projectQuotaFinished, volumeQuotaFinished=volumeQuotaFinished, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunReadMbps=lunReadMbps, fcTargetReadLatency=fcTargetReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetAuth=iscsiTargetAuth, notificationComponentName=notificationComponentName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolEntry=poolEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haResources=haResources, diskTotalReadMbps=diskTotalReadMbps, notificationDescription=notificationDescription, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, PYSNMP_MODULE_ID=tegile, projectDeletionFailed=projectDeletionFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cpuTotalUsage=cpuTotalUsage, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, lunName=lunName, networkTotalTransmitMbps=networkTotalTransmitMbps, projectModified=projectModified, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, replicationSourceRegistered=replicationSourceRegistered, poolMetaReadLatency=poolMetaReadLatency, fcPortOnline=fcPortOnline, lunReservedSizeLow=lunReservedSizeLow, poolDeletionFailed=poolDeletionFailed, iscsiTargets=iscsiTargets, cacheTotalWriteIops=cacheTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, lunDedupEnabled=lunDedupEnabled, diskCount=diskCount, poolTotalWriteMbps=poolTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, tegileArray_notifications=tegileArray_notifications, shareQuotaHigh=shareQuotaHigh, controllerHardwareModel=controllerHardwareModel, projectDataSizeHigh=projectDataSizeHigh, poolMetaReadIops=poolMetaReadIops, notificationObjects=notificationObjects, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareProjectName=shareProjectName, pools=pools, lunSizeLow=lunSizeLow, deleteFolderCompleted=deleteFolderCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskEntry=diskEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, poolAvgReadLatency=poolAvgReadLatency, replicationFailed=replicationFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup)
mibBuilder.exportSymbols("TEGILE-MIB", notificationProps=notificationProps, poolTotalReadIops=poolTotalReadIops, haControllerA_Name=haControllerA_Name, notificationSensorNumber=notificationSensorNumber, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetName=fcTargetName, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, haControllerA_Uptime=haControllerA_Uptime, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, ipmiTemperature=ipmiTemperature, basicCompliance=basicCompliance, poolProjects=poolProjects, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaReadMbps=poolMetaReadMbps, nicEntry=nicEntry, poolName=poolName, iscsiTargetAlias=iscsiTargetAlias, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, haResourceIndex=haResourceIndex, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, snapshotCreationFailed=snapshotCreationFailed, haResourceGroup=haResourceGroup, lunWriteIops=lunWriteIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, deleteFolderFailed=deleteFolderFailed, replicationAborted=replicationAborted, shareCIFSWriteMbps=shareCIFSWriteMbps, shareDataSizeHigh=shareDataSizeHigh, ipmiThreshold=ipmiThreshold, upgradeDownloadFailed=upgradeDownloadFailed, replicationAbandoned=replicationAbandoned, poolReadCacheReadIops=poolReadCacheReadIops, haResourcesTable=haResourcesTable, snmpServiceStopped=snmpServiceStopped, tegileConformance=tegileConformance, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetModifyCompleted=fcTargetModifyCompleted, fcProperties=fcProperties, shareNFSReadLatency=shareNFSReadLatency, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetWriteLatency=fcTargetWriteLatency, snmpServiceStarted=snmpServiceStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiOther=ipmiOther, memoryFailure=memoryFailure, nfsTotalWriteIops=nfsTotalWriteIops, ipmiMemory=ipmiMemory, cacheSSDReads=cacheSSDReads, cpuSystemCalls=cpuSystemCalls, poolDegraded=poolDegraded, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolFreeSizeLow=poolFreeSizeLow, fcTargetGroup=fcTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerB_IPAddr=haControllerB_IPAddr, projectQuotaSizeLow=projectQuotaSizeLow, poolSizeLow=poolSizeLow, poolProjectCount=poolProjectCount, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetError=iscsiTargetError, poolFreeSizeHigh=poolFreeSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, fcPortOffline=fcPortOffline, fcTargetsTable=fcTargetsTable, shareDeleted=shareDeleted, shareCompressedRatio=shareCompressedRatio, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicReceiveMbps=nicReceiveMbps, nfsTotalReadMbps=nfsTotalReadMbps, notificationSensorSuspect=notificationSensorSuspect, iscsiAvgReadLatency=iscsiAvgReadLatency, projectDedupEnabled=projectDedupEnabled, haResourceStatus=haResourceStatus, lunInitiatorGroup=lunInitiatorGroup, poolExported=poolExported, diskDataReadIops=diskDataReadIops, notificationSensorAction=notificationSensorAction, projectShareCount=projectShareCount, iscsiInitiatorEntry=iscsiInitiatorEntry, poolOwnerController=poolOwnerController, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunReadIops=lunReadIops, notificationTime=notificationTime, diskTotalWriteIops=diskTotalWriteIops, fcTargetReadMbps=fcTargetReadMbps, diskPoolName=diskPoolName, ipmiVoltage=ipmiVoltage, poolSizeHigh=poolSizeHigh, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTotalWriteMbps=fcTotalWriteMbps, nicIndex=nicIndex, projectIndex=projectIndex, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, ipmiPowerSupply=ipmiPowerSupply, tegileCompliances=tegileCompliances, networkIpmpGroupDown=networkIpmpGroupDown, ipmiFan=ipmiFan, poolAvgWriteLatency=poolAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, iscsiTotalReadIops=iscsiTotalReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, notificationSeverity=notificationSeverity, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorIndex=iscsiInitiatorIndex, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haResourceName=haResourceName, shareNFSReadMbps=shareNFSReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, nicMTU=nicMTU, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiInitiatorGroup=iscsiInitiatorGroup, diskType=diskType, lunFreeSizeLow=lunFreeSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, diskTable=diskTable, poolDataWriteIops=poolDataWriteIops, fcTotalReadMbps=fcTotalReadMbps, replicationPaused=replicationPaused, lunIndex=lunIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTotalWriteMbps=iscsiTotalWriteMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, projectCompressionEnabled=projectCompressionEnabled, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, snapshotRollbackFailed=snapshotRollbackFailed, poolMetaWriteIops=poolMetaWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, haControllerB_Name=haControllerB_Name, snmpAgentVersion=snmpAgentVersion, poolIndex=poolIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, aclMigrationCompleted=aclMigrationCompleted, poolTotalWriteIops=poolTotalWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolCreated=poolCreated, fcTargetWriteMbps=fcTargetWriteMbps, volumeModifyCompleted=volumeModifyCompleted, lunProjectName=lunProjectName, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeTimeout=upgradeTimeout, diskGoneOffline=diskGoneOffline, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetName=iscsiTargetName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskDataReadMbps=diskDataReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, lunWriteMbps=lunWriteMbps, netbiosSocketFailure=netbiosSocketFailure, projectDataSizeLow=projectDataSizeLow, replicationStarted=replicationStarted, poolTotalSaving=poolTotalSaving, fcTargetEntry=fcTargetEntry, poolDataSizeLow=poolDataSizeLow, shareNFSReadIops=shareNFSReadIops, shareNFSWriteLatency=shareNFSWriteLatency, poolDeleted=poolDeleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationComplete=replicationComplete, smisServiceStarted=smisServiceStarted, smisServiceStopped=smisServiceStopped, diskIndex=diskIndex, notificationThresholdTriggerValue=notificationThresholdTriggerValue, controllerTimeDrift=controllerTimeDrift, ntpServerTimeDrift=ntpServerTimeDrift, fcInitiators=fcInitiators, iscsiTargetWriteIops=iscsiTargetWriteIops, fcInitiatorName=fcInitiatorName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunTable=lunTable, poolImported=poolImported, shareReservedSizeHigh=shareReservedSizeHigh, fcInitiatorEntry=fcInitiatorEntry, nfsTotalReadIops=nfsTotalReadIops, currentNotificationGroup=currentNotificationGroup, diskSizeLow=diskSizeLow, iscsiInitiatorName=iscsiInitiatorName, sanProperties=sanProperties, fcInitiatorGroup=fcInitiatorGroup, controllerDown=controllerDown, poolHealth=poolHealth, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskError=diskError, aclMigrationStarted=aclMigrationStarted, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, upgradeFailed=upgradeFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, lunWriteLatency=lunWriteLatency, shareIndex=shareIndex, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskAvgWriteLatency=diskAvgWriteLatency, haResourceDescription=haResourceDescription, diskSequentialIOCount=diskSequentialIOCount, upgradeCompleted=upgradeCompleted, userLoginFailed=userLoginFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops)
