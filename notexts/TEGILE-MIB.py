...
iso, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Bits, Counter32, Integer32, NotificationType, IpAddress, Gauge32, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Bits", "Counter32", "Integer32", "NotificationType", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetsTable=iscsiTargetsTable, lunSnapshotSizeLow=lunSnapshotSizeLow, lunTable=lunTable, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetEntry=fcTargetEntry, poolName=poolName, projectEntry=projectEntry, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareDeleted=shareDeleted, networkIpmpGroupDown=networkIpmpGroupDown, diskError=diskError, haResourceEntry=haResourceEntry, iscsiInitiatorGroup=iscsiInitiatorGroup, diskDataWriteIops=diskDataWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolCount=poolCount, lunReadMbps=lunReadMbps, unknownSensorEvent=unknownSensorEvent, ipmiMemory=ipmiMemory, nicTransmitMbps=nicTransmitMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, ipmiThreshold=ipmiThreshold, replicationFailed=replicationFailed, notificationSeverity=notificationSeverity, volumeCreatedSuccessfully=volumeCreatedSuccessfully, sharePoolName=sharePoolName, notificationProps=notificationProps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, volumeDeleteCompleted=volumeDeleteCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, fcPortOnline=fcPortOnline, currentNotificationGroup=currentNotificationGroup, fcInitiatorEntry=fcInitiatorEntry, shareNFSReadIops=shareNFSReadIops, iscsiProperties=iscsiProperties, diskDataReadIops=diskDataReadIops, cpuInterrupts=cpuInterrupts, projectCompressionEnabled=projectCompressionEnabled, snapshotDeleteFailed=snapshotDeleteFailed, lunGUID=lunGUID, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegileGroups=tegileGroups, iscsiTargetAuth=iscsiTargetAuth, globalStatistics=globalStatistics, projectShareCount=projectShareCount, diskDataWriteMbps=diskDataWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, replicationTargetDeleted=replicationTargetDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nfsTotalReadIops=nfsTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskIsOnline=diskIsOnline, diskCount=diskCount, haControllerB_Name=haControllerB_Name, cpuTotalUsage=cpuTotalUsage, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, upgradeDownloadFailed=upgradeDownloadFailed, diskTotalWriteIops=diskTotalWriteIops, replicationStarted=replicationStarted, sanProperties=sanProperties, controllerDown=controllerDown, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSWriteMbps=shareCIFSWriteMbps, shareDataSizeHigh=shareDataSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDataWriteMbps=poolDataWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareIndex=shareIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskIndex=diskIndex, notificationTargetEntityName=notificationTargetEntityName, properties=properties, shareCreatedSuccessfully=shareCreatedSuccessfully, controllerUp=controllerUp, poolAvgWriteLatency=poolAvgWriteLatency, disks=disks, poolExported=poolExported, projectDataSizeHigh=projectDataSizeHigh, lunWriteLatency=lunWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetIndex=fcTargetIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, poolReadCacheWriteIops=poolReadCacheWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectName=projectName, poolFreeSizeHigh=poolFreeSizeHigh, notificationSensorSuspect=notificationSensorSuspect, diskState=diskState, poolDataSizeLow=poolDataSizeLow, shareCIFSReadIops=shareCIFSReadIops, fcTargetStatus=fcTargetStatus, fcPortOffline=fcPortOffline, shareReservedSizeLow=shareReservedSizeLow, networkInterfaceUp=networkInterfaceUp, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunDedupEnabled=lunDedupEnabled, nicMTU=nicMTU, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectShares=projectShares, tegileCompliances=tegileCompliances, iscsiTargetEntry=iscsiTargetEntry, volumeDeleteFailed=volumeDeleteFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snmpAgentVersion=snmpAgentVersion, poolReadCacheWriteLatency=poolReadCacheWriteLatency, haResources=haResources, lunCompressionEnabled=lunCompressionEnabled, poolProjects=poolProjects, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetAlias=iscsiTargetAlias, shareQuotaFinished=shareQuotaFinished, replicationSourceRegistered=replicationSourceRegistered, shareMountPoint=shareMountPoint, nfsAvgReadLatency=nfsAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, fcInitiatorsTable=fcInitiatorsTable, projectModified=projectModified, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snmpServiceStopFailed=snmpServiceStopFailed, poolEntry=poolEntry, diskAlias=diskAlias, smisServiceStartFailed=smisServiceStartFailed, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetReadMbps=fcTargetReadMbps, poolMetaReadMbps=poolMetaReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, ipmiVoltage=ipmiVoltage, diskSequentialIOCount=diskSequentialIOCount, shareNFSEnabled=shareNFSEnabled, ipmiFan=ipmiFan, fcTargetWriteMbps=fcTargetWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTotalReadMbps=poolTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cpuSystemCalls=cpuSystemCalls, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunName=lunName, projectDedupEnabled=projectDedupEnabled, nicIndex=nicIndex, haResourceActiveNode=haResourceActiveNode, upgradeStarted=upgradeStarted, cacheTotalReadMbps=cacheTotalReadMbps, snmpServiceStopped=snmpServiceStopped, poolFreeSizeLow=poolFreeSizeLow, poolMetaReadIops=poolMetaReadIops, diskGoneOffline=diskGoneOffline, basicCompliance=basicCompliance, shareTable=shareTable, targetGroupMemberAdded=targetGroupMemberAdded, upgradeDownloadStarted=upgradeDownloadStarted, cifsTotalWriteMbps=cifsTotalWriteMbps, smbSocketFailure=smbSocketFailure, fcInitiators=fcInitiators, fcTargetModifyCompleted=fcTargetModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, lunTargetGroup=lunTargetGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, volumeQuotaFinished=volumeQuotaFinished, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, poolDataWriteLatency=poolDataWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiatorName=iscsiInitiatorName, upgradeTimeout=upgradeTimeout, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicReceiveMbps=nicReceiveMbps, diskTable=diskTable, haResourceGroup=haResourceGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, memoryFailure=memoryFailure, lunInitiatorGroup=lunInitiatorGroup, nfsTotalWriteMbps=nfsTotalWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, poolDataReadIops=poolDataReadIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataReadLatency=poolDataReadLatency, shareQuotaLow=shareQuotaLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectQuotaFinished=projectQuotaFinished, sensorFailureEvent=sensorFailureEvent, spareDiskReplaced=spareDiskReplaced, cacheTotalWriteMbps=cacheTotalWriteMbps, upgradeCompleted=upgradeCompleted, shareName=shareName, snapshotCreationFailed=snapshotCreationFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, lunFreeSizeLow=lunFreeSizeLow, fcInitiatorName=fcInitiatorName, iscsiTargetError=iscsiTargetError, networkIpmpGroupUp=networkIpmpGroupUp, poolUsedSizeHigh=poolUsedSizeHigh, networkInterfaceDown=networkInterfaceDown, currentObjectGroup=currentObjectGroup, lunReadIops=lunReadIops, fcTargets=fcTargets, lunBlockSize=lunBlockSize, lunProtocol=lunProtocol, diskIOCount=diskIOCount, snapshotCloneCompleted=snapshotCloneCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcProperties=fcProperties, iscsiTargetWriteIops=iscsiTargetWriteIops, controllerTimeDrift=controllerTimeDrift, tdpsUpgradeTimeout=tdpsUpgradeTimeout, tegileConformance=tegileConformance, poolSizeLow=poolSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetName=fcTargetName, poolUpgraded=poolUpgraded, poolSizeHigh=poolSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaWriteMbps=poolMetaWriteMbps, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareDedupEnabled=shareDedupEnabled, haResourceIndex=haResourceIndex, webdocsUpgradeFailed=webdocsUpgradeFailed, lunPoolName=lunPoolName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTotalWriteMbps=fcTotalWriteMbps, poolImported=poolImported, projectQuotaSizeLow=projectQuotaSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationReadingUnit=notificationReadingUnit, network=network)
mibBuilder.exportSymbols("TEGILE-MIB", volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectLUNs=projectLUNs, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, iscsiWriteIops=iscsiWriteIops, lunSizeLow=lunSizeLow, lunIndex=lunIndex, iscsiInitiators=iscsiInitiators, poolProjectCount=poolProjectCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunDataSizeHigh=lunDataSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, upgradeFailed=upgradeFailed, poolDataSizeHigh=poolDataSizeHigh, pools=pools, fcTargetWriteIops=fcTargetWriteIops, poolDeleted=poolDeleted, poolTable=poolTable, haControllerA_Uptime=haControllerA_Uptime, nfsTotalWriteIops=nfsTotalWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, smisServiceStopFailed=smisServiceStopFailed, poolMetaWriteIops=poolMetaWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolOwnerController=poolOwnerController, shareCompressedRatio=shareCompressedRatio, diskSlowIo=diskSlowIo, projectFreeSizeLow=projectFreeSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskType=diskType, diskTotalReadMbps=diskTotalReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, replicationComplete=replicationComplete, maintenanceModeDisabled=maintenanceModeDisabled, fcAvgWriteLatency=fcAvgWriteLatency, diskChassisIdx=diskChassisIdx, cacheSSDReads=cacheSSDReads, nicGroup=nicGroup, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaHigh=shareQuotaHigh, poolAvgReadLatency=poolAvgReadLatency, haResourceDescription=haResourceDescription, smisServiceStarted=smisServiceStarted, lunReadLatency=lunReadLatency, poolTotalReadIops=poolTotalReadIops, ipmiCurrent=ipmiCurrent, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskAvgWriteLatency=diskAvgWriteLatency, controllerHardwareModel=controllerHardwareModel, notifications=notifications, fcTotalWriteIops=fcTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargets=iscsiTargets, shareDataSizeLow=shareDataSizeLow, projectDeletionFailed=projectDeletionFailed, shareProjectName=shareProjectName, ipmiPowerSupply=ipmiPowerSupply, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nicEntry=nicEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskSizeLow=diskSizeLow, shareNFSReadMbps=shareNFSReadMbps, diskAvgReadLatency=diskAvgReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, lunCompressedRatio=lunCompressedRatio, shareNFSWriteLatency=shareNFSWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, poolDegraded=poolDegraded, haResourceStatus=haResourceStatus, PYSNMP_MODULE_ID=tegile, poolIndex=poolIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcInitiatorIndex=fcInitiatorIndex, deleteFolderCompleted=deleteFolderCompleted, projectDataSizeLow=projectDataSizeLow, snmpServiceStarted=snmpServiceStarted, alertsCleanupCompleted=alertsCleanupCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectTable=projectTable, notificationSensorAction=notificationSensorAction, haResourcesTable=haResourcesTable, cacheTotalReadIops=cacheTotalReadIops, projectDeleted=projectDeleted, fcTargetGroup=fcTargetGroup, poolHealth=poolHealth, diskSizeHigh=diskSizeHigh, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskDataReadMbps=diskDataReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunEntry=lunEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskTotalWriteMbps=diskTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolState=poolState, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileArray_notifications=tegileArray_notifications, aclMigrationStarted=aclMigrationStarted, notificationDescription=notificationDescription, notificationTime=notificationTime, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, tegileArray=tegileArray, tegile=tegile, snapshotCloningFailed=snapshotCloningFailed, adServerTimeDrift=adServerTimeDrift, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolReadCacheReadIops=poolReadCacheReadIops, fcTotalReadMbps=fcTotalReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, fcAvgReadLatency=fcAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolCreated=poolCreated, poolUsedSizeLow=poolUsedSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, diagnosticDataUploaded=diagnosticDataUploaded, maintenanceModeEnabled=maintenanceModeEnabled, nicName=nicName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetGroupError=iscsiTargetGroupError, shareCIFSWriteLatency=shareCIFSWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicState=nicState, projectThresholdExceedWarning=projectThresholdExceedWarning, deleteFolderFailed=deleteFolderFailed, shareCIFSWriteIops=shareCIFSWriteIops, shareDeletionFailed=shareDeletionFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunWriteMbps=lunWriteMbps, notificationEventCode=notificationEventCode, userLoginFailed=userLoginFailed, poolDeletionFailed=poolDeletionFailed, diskPoolName=diskPoolName, projectLunCount=projectLunCount, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskTotalReadIops=diskTotalReadIops, replicationAborted=replicationAborted, poolTotalWriteMbps=poolTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, projectQuotaSizeHigh=projectQuotaSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, netbiosSocketFailure=netbiosSocketFailure, lunDataSizeLow=lunDataSizeLow, smisServiceStopped=smisServiceStopped, shareNFSWriteIops=shareNFSWriteIops, lunSizeHigh=lunSizeHigh, projectTotalSaving=projectTotalSaving, nicTable=nicTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskRandomIOCount=diskRandomIOCount, shareCIFSEnabled=shareCIFSEnabled, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, notificationComponentName=notificationComponentName, lunProjectName=lunProjectName, nvdimmFailSoftError=nvdimmFailSoftError, notificationObjects=notificationObjects, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskEntry=diskEntry, poolTotalWriteIops=poolTotalWriteIops, poolDataReadMbps=poolDataReadMbps, haResourceName=haResourceName, ipmiOther=ipmiOther, fcTargetsTable=fcTargetsTable, lunWriteIops=lunWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, projectIndex=projectIndex, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolMetaReadLatency=poolMetaReadLatency, cifsTotalReadIops=cifsTotalReadIops, ipmiTemperature=ipmiTemperature, poolExpanded=poolExpanded, fcTotalReadIops=fcTotalReadIops, shareEntry=shareEntry, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haControllerB_Uptime=haControllerB_Uptime, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetGroup=iscsiTargetGroup, poolDataWriteIops=poolDataWriteIops, projectPoolName=projectPoolName, testNotification=testNotification, replicationPaused=replicationPaused, cacheRAMReads=cacheRAMReads, replicationResumed=replicationResumed, cifsTotalReadMbps=cifsTotalReadMbps, fcTargetReadLatency=fcTargetReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetIndex=iscsiTargetIndex, cifsAvgReadLatency=cifsAvgReadLatency, poolTotalSaving=poolTotalSaving)
