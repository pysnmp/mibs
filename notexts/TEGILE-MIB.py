...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:24:49 2023
...
Gauge32, Unsigned32, enterprises, ModuleIdentity, IpAddress, Counter32, Counter64, MibIdentifier, NotificationType, iso, Bits, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "enterprises", "ModuleIdentity", "IpAddress", "Counter32", "Counter64", "MibIdentifier", "NotificationType", "iso", "Bits", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargets=iscsiTargets, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetGroup=fcTargetGroup, lunCompressionEnabled=lunCompressionEnabled, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteMbps=fcTotalWriteMbps, diskIsOnline=diskIsOnline, fcTargetIndex=fcTargetIndex, projectModified=projectModified, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, controllerDown=controllerDown, haResourceDescription=haResourceDescription, alertsCleanupCompleted=alertsCleanupCompleted, upgradeFailed=upgradeFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiators=iscsiInitiators, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cpuInterrupts=cpuInterrupts, nfsTotalReadIops=nfsTotalReadIops, ipmiTemperature=ipmiTemperature, lunWriteLatency=lunWriteLatency, haResources=haResources, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectEntry=projectEntry, lunBlockSize=lunBlockSize, lunTargetGroup=lunTargetGroup, fcInitiatorEntry=fcInitiatorEntry, upgradeTimeout=upgradeTimeout, replicationResumed=replicationResumed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, iscsiTargetIndex=iscsiTargetIndex, lunReservedSizeLow=lunReservedSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunDedupEnabled=lunDedupEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectDedupEnabled=projectDedupEnabled, projectShareCount=projectShareCount, nvdimmFailSoftError=nvdimmFailSoftError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snmpAgentVersion=snmpAgentVersion, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorEntry=iscsiInitiatorEntry, poolImported=poolImported, nicTransmitMbps=nicTransmitMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaWriteIops=poolMetaWriteIops, lunPoolName=lunPoolName, replicationPaused=replicationPaused, diskGoneOffline=diskGoneOffline, notificationComponentName=notificationComponentName, diskState=diskState, shareCIFSEnabled=shareCIFSEnabled, currentObjectGroup=currentObjectGroup, sharePoolName=sharePoolName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcInitiatorsTable=fcInitiatorsTable, diskTotalWriteIops=diskTotalWriteIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, ipmiCurrent=ipmiCurrent, haResourceName=haResourceName, lunWriteIops=lunWriteIops, lunSizeLow=lunSizeLow, poolTotalSaving=poolTotalSaving, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, upgradeDownloadStarted=upgradeDownloadStarted, notificationSensorAction=notificationSensorAction, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolSizeHigh=poolSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, replicationTargetDeleted=replicationTargetDeleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetName=iscsiTargetName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diagnosticDataUploaded=diagnosticDataUploaded, diskType=diskType, lunDataSizeLow=lunDataSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ntpServerTimeDrift=ntpServerTimeDrift, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSEnabled=shareNFSEnabled, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeFailed=webdocsUpgradeFailed, shareNFSReadLatency=shareNFSReadLatency, shareCIFSReadIops=shareCIFSReadIops, smisServiceStopFailed=smisServiceStopFailed, lunReservedSizeHigh=lunReservedSizeHigh, diskSequentialIOCount=diskSequentialIOCount, networkIpmpGroupDown=networkIpmpGroupDown, lunSnapshotSizeLow=lunSnapshotSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, poolUsedSizeLow=poolUsedSizeLow, lunGUID=lunGUID, sanProperties=sanProperties, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolUpgraded=poolUpgraded, cifsTotalReadMbps=cifsTotalReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiWriteIops=iscsiWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, tegileCompliances=tegileCompliances, nicTable=nicTable, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snapshotCloningFailed=snapshotCloningFailed, fcTargetWriteMbps=fcTargetWriteMbps, snmpServiceStopped=snmpServiceStopped, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectDeleted=projectDeleted, haControllerA_IPAddr=haControllerA_IPAddr, projectCompressionEnabled=projectCompressionEnabled, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolProjectCount=poolProjectCount, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicGroup=nicGroup, notificationDescription=notificationDescription, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskChassisIdx=diskChassisIdx, basicCompliance=basicCompliance, controllerUp=controllerUp, shareTable=shareTable, projectDataSizeLow=projectDataSizeLow, shareNFSWriteIops=shareNFSWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourceActiveNode=haResourceActiveNode, iscsiProperties=iscsiProperties, cacheTotalReadIops=cacheTotalReadIops, projectDataSizeHigh=projectDataSizeHigh, shareCompressedRatio=shareCompressedRatio, fcTargetStatus=fcTargetStatus, notificationTargetEntityName=notificationTargetEntityName, poolQuotaFinished=poolQuotaFinished, shareProjectName=shareProjectName, projectName=projectName, poolDeleted=poolDeleted, cacheTotalReadMbps=cacheTotalReadMbps, cpuTotalUsage=cpuTotalUsage, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haControllerA_Uptime=haControllerA_Uptime, diskDataReadIops=diskDataReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargetName=fcTargetName, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunIndex=lunIndex, cifsAvgWriteLatency=cifsAvgWriteLatency, shareDataSizeLow=shareDataSizeLow, poolDataWriteIops=poolDataWriteIops, projectShares=projectShares, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiThreshold=ipmiThreshold, poolDataReadMbps=poolDataReadMbps, notificationSeverity=notificationSeverity, shareCIFSWriteMbps=shareCIFSWriteMbps, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, lunName=lunName, projectLunCount=projectLunCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectTotalSaving=projectTotalSaving, haResourceGroup=haResourceGroup, shareNFSReadIops=shareNFSReadIops, poolDegraded=poolDegraded, iscsiTargetAlias=iscsiTargetAlias, network=network, poolDataReadIops=poolDataReadIops, upgradeStarted=upgradeStarted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cacheTotalWriteIops=cacheTotalWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, adServerTimeDrift=adServerTimeDrift, nicName=nicName, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareQuotaLow=shareQuotaLow, shareNFSReadMbps=shareNFSReadMbps, shareDataSizeHigh=shareDataSizeHigh, diskSlowIo=diskSlowIo, projectFreeSizeHigh=projectFreeSizeHigh, haResourceStatus=haResourceStatus, nicReceiveMbps=nicReceiveMbps, poolName=poolName, poolTotalReadIops=poolTotalReadIops, projectDeletionFailed=projectDeletionFailed, diskCount=diskCount, tegileGroups=tegileGroups, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkInterfaceDown=networkInterfaceDown, diskTotalReadIops=diskTotalReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolIndex=poolIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, notificationReadingUnit=notificationReadingUnit, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTotalReadIops=fcTotalReadIops, poolSizeLow=poolSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetsTable=fcTargetsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, fcInitiatorName=fcInitiatorName, poolCount=poolCount, poolReadCacheReadLatency=poolReadCacheReadLatency, volumeDeleteFailed=volumeDeleteFailed, ipmiVoltage=ipmiVoltage, poolEntry=poolEntry, replicationFailed=replicationFailed, smisServiceStopped=smisServiceStopped, poolFreeSizeHigh=poolFreeSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunCompressedRatio=lunCompressedRatio, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunWriteMbps=lunWriteMbps, replicationSourceRegistered=replicationSourceRegistered, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareIndex=shareIndex, haResourceEntry=haResourceEntry, globalStatistics=globalStatistics, controllerHardwareModel=controllerHardwareModel, shareDedupEnabled=shareDedupEnabled, ipmiFan=ipmiFan, iscsiTargetWriteIops=iscsiTargetWriteIops, lunProtocol=lunProtocol, shareCompressionEnabled=shareCompressionEnabled)
mibBuilder.exportSymbols("TEGILE-MIB", projectCreatedSuccessfully=projectCreatedSuccessfully, replicationAborted=replicationAborted, lunSizeHigh=lunSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, poolDataSizeHigh=poolDataSizeHigh, diskRandomIOCount=diskRandomIOCount, haControllerB_Uptime=haControllerB_Uptime, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, volumeQuotaFinished=volumeQuotaFinished, diskIndex=diskIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorNumber=notificationSensorNumber, tegile=tegile, shareSnapshotSizeHigh=shareSnapshotSizeHigh, spareDiskReplaced=spareDiskReplaced, poolProjects=poolProjects, aclMigrationCompleted=aclMigrationCompleted, nicIndex=nicIndex, fcTargetWriteIops=fcTargetWriteIops, PYSNMP_MODULE_ID=tegile, replicationStarted=replicationStarted, shareEntry=shareEntry, fcTargetReadLatency=fcTargetReadLatency, shareMountPoint=shareMountPoint, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunReadIops=lunReadIops, poolMetaReadLatency=poolMetaReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationProps=notificationProps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, deleteFolderCompleted=deleteFolderCompleted, fcProperties=fcProperties, volumeModifyCompleted=volumeModifyCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicMTU=nicMTU, iscsiInitiatorsTable=iscsiInitiatorsTable, haControllerA_Name=haControllerA_Name, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolExported=poolExported, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationEventCode=notificationEventCode, tegileArray=tegileArray, fcAvgReadLatency=fcAvgReadLatency, fcTargetEntry=fcTargetEntry, projectLUNs=projectLUNs, projectIndex=projectIndex, unknownSensorEvent=unknownSensorEvent, diskDataReadMbps=diskDataReadMbps, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, networkInterfaceUp=networkInterfaceUp, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareReservedSizeLow=shareReservedSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolTable=poolTable, smbSocketFailure=smbSocketFailure, nfsTotalWriteIops=nfsTotalWriteIops, aclMigrationStarted=aclMigrationStarted, poolDeletionFailed=poolDeletionFailed, diskSizeHigh=diskSizeHigh, nicState=nicState, lunInitiatorGroup=lunInitiatorGroup, ipmiPowerSupply=ipmiPowerSupply, iscsiAvgWriteLatency=iscsiAvgWriteLatency, cifsTotalReadIops=cifsTotalReadIops, snmpServiceStarted=snmpServiceStarted, poolMetaWriteMbps=poolMetaWriteMbps, poolState=poolState, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, sensorFailureEvent=sensorFailureEvent, cacheSSDReads=cacheSSDReads, haResourceIndex=haResourceIndex, deleteFolderFailed=deleteFolderFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, cacheRAMReads=cacheRAMReads, replicationComplete=replicationComplete, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerB_Name=haControllerB_Name, snapshotCloneCompleted=snapshotCloneCompleted, maintenanceModeEnabled=maintenanceModeEnabled, poolDataWriteLatency=poolDataWriteLatency, haResourcesTable=haResourcesTable, snapshotCreationFailed=snapshotCreationFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, ipmiMemory=ipmiMemory, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunReadMbps=lunReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, pools=pools, lunReadLatency=lunReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetsTable=iscsiTargetsTable, controllerTimeDrift=controllerTimeDrift, diskTotalReadMbps=diskTotalReadMbps, smisServiceStarted=smisServiceStarted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareCIFSReadMbps=shareCIFSReadMbps, poolExpanded=poolExpanded, testNotification=testNotification, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tegileConformance=tegileConformance, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiators=fcInitiators, fcTotalWriteIops=fcTotalWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTotalReadMbps=fcTotalReadMbps, smisServiceStartFailed=smisServiceStartFailed, fcPortOffline=fcPortOffline, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskDataWriteIops=diskDataWriteIops, memoryFailure=memoryFailure, diskDataWriteMbps=diskDataWriteMbps, diskPoolName=diskPoolName, poolReadCacheReadIops=poolReadCacheReadIops, poolMetaReadMbps=poolMetaReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, properties=properties, poolFreeSizeLow=poolFreeSizeLow, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, userLoginFailed=userLoginFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, shareQuotaFinished=shareQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunTable=lunTable, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nicEntry=nicEntry, diskEntry=diskEntry, fcTargetWriteLatency=fcTargetWriteLatency, notificationTime=notificationTime, iscsiTargetAuth=iscsiTargetAuth, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorIndex=fcInitiatorIndex, upgradeCompleted=upgradeCompleted, poolAvgReadLatency=poolAvgReadLatency, poolDataReadLatency=poolDataReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, shareName=shareName, cifsTotalWriteIops=cifsTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolDataWriteMbps=poolDataWriteMbps, projectTable=projectTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiOther=ipmiOther, poolHealth=poolHealth, diskTotalWriteMbps=diskTotalWriteMbps, diskSizeLow=diskSizeLow, fcTargets=fcTargets, notificationObjects=notificationObjects, diskError=diskError, diskTable=diskTable, notifications=notifications, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskAlias=diskAlias, diskIOCount=diskIOCount, lunProjectName=lunProjectName, targetGroupMemberAdded=targetGroupMemberAdded, netbiosSocketFailure=netbiosSocketFailure, shareDeleted=shareDeleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcAvgWriteLatency=fcAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcPortOnline=fcPortOnline, lunEntry=lunEntry, poolOwnerController=poolOwnerController, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcInitiatorGroup=fcInitiatorGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkIpmpGroupUp=networkIpmpGroupUp, shareQuotaHigh=shareQuotaHigh, poolCreated=poolCreated, targetGroupCreateCompleted=targetGroupCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, poolMetaReadIops=poolMetaReadIops, lunDataSizeHigh=lunDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, disks=disks, projectPoolName=projectPoolName, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastores=vmwareNFSDatastores, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, replicationAbandoned=replicationAbandoned, iscsiTargetGroup=iscsiTargetGroup)
