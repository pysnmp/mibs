...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:28:05 2021
...
MibIdentifier, Integer32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, ModuleIdentity, Gauge32, IpAddress, Counter64, ObjectIdentity, enterprises, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "ModuleIdentity", "Gauge32", "IpAddress", "Counter64", "ObjectIdentity", "enterprises", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunFreeSizeHigh=lunFreeSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, projectName=projectName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, upgradeCompleted=upgradeCompleted, lunReadIops=lunReadIops, deleteFolderCompleted=deleteFolderCompleted, projectDeleted=projectDeleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunIndex=lunIndex, diskRandomIOCount=diskRandomIOCount, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetStatus=fcTargetStatus, projectFreeSizeHigh=projectFreeSizeHigh, ipmiFan=ipmiFan, shareName=shareName, network=network, poolSizeHigh=poolSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, nicMTU=nicMTU, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicName=nicName, poolExpanded=poolExpanded, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaReadIops=poolMetaReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, shareDataSizeHigh=shareDataSizeHigh, projectFreeSizeLow=projectFreeSizeLow, replicationStarted=replicationStarted, poolTotalReadIops=poolTotalReadIops, projectQuotaFinished=projectQuotaFinished, shareReservedSizeHigh=shareReservedSizeHigh, haControllerA_IPAddr=haControllerA_IPAddr, lunCompressedRatio=lunCompressedRatio, haResourceIndex=haResourceIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolCount=poolCount, shareNFSEnabled=shareNFSEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolTotalReadMbps=poolTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorGroup=fcInitiatorGroup, ipmiThreshold=ipmiThreshold, shareNFSWriteMbps=shareNFSWriteMbps, diskError=diskError, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolDeletionFailed=poolDeletionFailed, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDegraded=poolDegraded, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetGroup=iscsiTargetGroup, cifsTotalReadIops=cifsTotalReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, globalStatistics=globalStatistics, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cacheSSDReads=cacheSSDReads, projectDataSizeLow=projectDataSizeLow, lunDataSizeLow=lunDataSizeLow, diskState=diskState, shareCIFSReadIops=shareCIFSReadIops, lunReadMbps=lunReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, smisServiceStopFailed=smisServiceStopFailed, shareIndex=shareIndex, cifsAvgWriteLatency=cifsAvgWriteLatency, poolDataWriteIops=poolDataWriteIops, poolExported=poolExported, disks=disks, iscsiTargetAuth=iscsiTargetAuth, lunDataSizeHigh=lunDataSizeHigh, lunEntry=lunEntry, haResourceGroup=haResourceGroup, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, snmpServiceStarted=snmpServiceStarted, lunProtocol=lunProtocol, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolCreated=poolCreated, nicState=nicState, shareNFSWriteLatency=shareNFSWriteLatency, projectIndex=projectIndex, properties=properties, netbiosSocketFailure=netbiosSocketFailure, replicationAborted=replicationAborted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, controllerHardwareModel=controllerHardwareModel, haResourceDescription=haResourceDescription, haResourceStatus=haResourceStatus, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haControllerA_Uptime=haControllerA_Uptime, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationTargetEntityName=notificationTargetEntityName, lunSnapshotSizeLow=lunSnapshotSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, shareSnapshotSizeLow=shareSnapshotSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, snmpAgentVersion=snmpAgentVersion, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationAbandoned=replicationAbandoned, networkTotalReceiveMbps=networkTotalReceiveMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nicEntry=nicEntry, projectTotalSaving=projectTotalSaving, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcPortOnline=fcPortOnline, notificationReadingTriggerValue=notificationReadingTriggerValue, diskTable=diskTable, fcTargets=fcTargets, haResources=haResources, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolMetaWriteIops=poolMetaWriteIops, haResourceEntry=haResourceEntry, replicationSourceRegistered=replicationSourceRegistered, shareQuotaFinished=shareQuotaFinished, fcAvgReadLatency=fcAvgReadLatency, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastores=vmwareNFSDatastores, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tegileConformance=tegileConformance, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, ipmiTemperature=ipmiTemperature, upgradeDownloadFailed=upgradeDownloadFailed, haResourcesTable=haResourcesTable, lunInitiatorGroup=lunInitiatorGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, controllerDown=controllerDown, fcTargetName=fcTargetName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, smisServiceStartFailed=smisServiceStartFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetEntry=fcTargetEntry, lunTargetGroup=lunTargetGroup, lunName=lunName, fcTargetWriteMbps=fcTargetWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolProjects=poolProjects, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectTable=projectTable, replicationTargetDeleted=replicationTargetDeleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunWriteLatency=lunWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, userLoginFailed=userLoginFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectPoolName=projectPoolName, snmpServiceStopFailed=snmpServiceStopFailed, adServerTimeDrift=adServerTimeDrift, poolIndex=poolIndex, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, upgradeDownloadStarted=upgradeDownloadStarted, poolTotalWriteMbps=poolTotalWriteMbps, projectShareCount=projectShareCount, poolName=poolName, webdocsUpgradeFailed=webdocsUpgradeFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareProjectName=shareProjectName, diskCount=diskCount, projectLUNs=projectLUNs, lunReservedSizeHigh=lunReservedSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, nfsTotalReadIops=nfsTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareCIFSEnabled=shareCIFSEnabled, haControllerB_Uptime=haControllerB_Uptime, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaReadLatency=poolMetaReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceActiveNode=haResourceActiveNode, poolReadCacheWriteIops=poolReadCacheWriteIops, projectLunCount=projectLunCount, smisServiceStarted=smisServiceStarted, tegile=tegile, unknownSensorEvent=unknownSensorEvent, poolEntry=poolEntry, shareNFSReadIops=shareNFSReadIops, PYSNMP_MODULE_ID=tegile, lunProjectName=lunProjectName, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareDeletionFailed=shareDeletionFailed, iscsiTargetGroupError=iscsiTargetGroupError, sanProperties=sanProperties, iscsiTotalReadIops=iscsiTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, lunWriteMbps=lunWriteMbps, lunWriteIops=lunWriteIops, cacheRAMReads=cacheRAMReads, poolDataSizeHigh=poolDataSizeHigh, tegileGroups=tegileGroups, poolTable=poolTable, deleteFolderFailed=deleteFolderFailed, notificationTime=notificationTime, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, aclMigrationCompleted=aclMigrationCompleted, lunBlockSize=lunBlockSize, ipmiMemory=ipmiMemory, diskTotalReadMbps=diskTotalReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, cpuSystemCalls=cpuSystemCalls, shareCompressedRatio=shareCompressedRatio, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, targetGroupMemberRemoved=targetGroupMemberRemoved, diskTotalWriteIops=diskTotalWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, diagnosticDataUploaded=diagnosticDataUploaded, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiVoltage=ipmiVoltage, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ntpServerTimeDrift=ntpServerTimeDrift, cifsTotalReadMbps=cifsTotalReadMbps, lunPoolName=lunPoolName, replicationFailed=replicationFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, controllerUp=controllerUp, projectModified=projectModified, smisServiceStopped=smisServiceStopped, nicTransmitMbps=nicTransmitMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, lunSizeHigh=lunSizeHigh, lunReadLatency=lunReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetName=iscsiTargetName, haResourceName=haResourceName, shareTable=shareTable, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalWriteMbps=diskTotalWriteMbps, poolHealth=poolHealth, tegileCompliances=tegileCompliances, cacheTotalReadMbps=cacheTotalReadMbps, shareMountPoint=shareMountPoint, shareNFSWriteIops=shareNFSWriteIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareEntry=shareEntry, notificationComponentName=notificationComponentName)
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalReadMbps=fcTotalReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectEntry=projectEntry, fcInitiatorsTable=fcInitiatorsTable, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskAlias=diskAlias, shareDataSizeLow=shareDataSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haControllerA_Name=haControllerA_Name, poolUsedSizeLow=poolUsedSizeLow, lunSizeLow=lunSizeLow, poolTotalWriteIops=poolTotalWriteIops, volumeQuotaFinished=volumeQuotaFinished, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, basicCompliance=basicCompliance, pools=pools, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareQuotaHigh=shareQuotaHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, notificationDescription=notificationDescription, diskEntry=diskEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationEventCode=notificationEventCode, nfsTotalWriteMbps=nfsTotalWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tegileArray_notifications=tegileArray_notifications, networkTotalTransmitMbps=networkTotalTransmitMbps, projectDataSizeHigh=projectDataSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetError=iscsiTargetError, shareDedupEnabled=shareDedupEnabled, iscsiProperties=iscsiProperties, iscsiInitiatorName=iscsiInitiatorName, snapshotRollbackFailed=snapshotRollbackFailed, currentNotificationGroup=currentNotificationGroup, diskDataReadIops=diskDataReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskIsOnline=diskIsOnline, snapshotRollbackCompleted=snapshotRollbackCompleted, poolProjectCount=poolProjectCount, diskSizeLow=diskSizeLow, snapshotCreationFailed=snapshotCreationFailed, fcTotalWriteMbps=fcTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaWriteMbps=poolMetaWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, poolMetaReadMbps=poolMetaReadMbps, lunTable=lunTable, projectQuotaSizeHigh=projectQuotaSizeHigh, cacheTotalReadIops=cacheTotalReadIops, diskPoolName=diskPoolName, diskDataWriteIops=diskDataWriteIops, shareCompressionEnabled=shareCompressionEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, poolReadCacheReadMbps=poolReadCacheReadMbps, fcInitiatorName=fcInitiatorName, nfsAvgWriteLatency=nfsAvgWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationPaused=replicationPaused, notificationProps=notificationProps, poolFreeSizeLow=poolFreeSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetIndex=fcTargetIndex, volumeModifyCompleted=volumeModifyCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetsTable=fcTargetsTable, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetReadIops=iscsiTargetReadIops, networkIpmpGroupDown=networkIpmpGroupDown, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataSizeLow=poolDataSizeLow, projectDeletionFailed=projectDeletionFailed, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetIndex=iscsiTargetIndex, currentObjectGroup=currentObjectGroup, poolTotalSaving=poolTotalSaving, poolDataReadMbps=poolDataReadMbps, diskDataWriteMbps=diskDataWriteMbps, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolUpgraded=poolUpgraded, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, replicationComplete=replicationComplete, shareQuotaLow=shareQuotaLow, testNotification=testNotification, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectShares=projectShares, upgradeTimeout=upgradeTimeout, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolSizeLow=poolSizeLow, tegileArray=tegileArray, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiPowerSupply=ipmiPowerSupply, targetGroupMemberAdded=targetGroupMemberAdded, diskGoneOffline=diskGoneOffline, fcInitiators=fcInitiators, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetReadLatency=fcTargetReadLatency, fcProperties=fcProperties, lunCompressionEnabled=lunCompressionEnabled, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetEntry=iscsiTargetEntry, diskSlowIo=diskSlowIo, upgradeFailed=upgradeFailed, sensorFailureEvent=sensorFailureEvent, iscsiTargets=iscsiTargets, diskAvgReadLatency=diskAvgReadLatency, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetWriteIops=fcTargetWriteIops, poolOwnerController=poolOwnerController, poolImported=poolImported, targetGroupCreateCompleted=targetGroupCreateCompleted, haControllerB_Name=haControllerB_Name, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskDataReadMbps=diskDataReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, poolReadCacheReadLatency=poolReadCacheReadLatency, nicTable=nicTable, fcPortOffline=fcPortOffline, controllerTimeDrift=controllerTimeDrift, shareCIFSReadLatency=shareCIFSReadLatency, networkInterfaceUp=networkInterfaceUp, ipmiCurrent=ipmiCurrent, tdpsUpgradeFailed=tdpsUpgradeFailed, sharePoolName=sharePoolName, shareDeleted=shareDeleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetWriteMbps=iscsiTargetWriteMbps, memoryFailure=memoryFailure, poolDeleted=poolDeleted, iscsiInitiators=iscsiInitiators, notificationSensorAction=notificationSensorAction, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataReadIops=poolDataReadIops, cifsAvgReadLatency=cifsAvgReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunGUID=lunGUID, poolQuotaFinished=poolQuotaFinished, snmpServiceStopped=snmpServiceStopped, cacheTotalWriteMbps=cacheTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, iscsiWriteIops=iscsiWriteIops, notificationSeverity=notificationSeverity, shareNFSReadMbps=shareNFSReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetReadIops=fcTargetReadIops, replicationResumed=replicationResumed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, diskIndex=diskIndex, fcTargetGroup=fcTargetGroup, poolState=poolState, notificationObjects=notificationObjects, poolDataWriteLatency=poolDataWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiOther=ipmiOther, fcTotalReadIops=fcTotalReadIops, diskChassisIdx=diskChassisIdx, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolAvgReadLatency=poolAvgReadLatency, smbSocketFailure=smbSocketFailure, diskTotalReadIops=diskTotalReadIops, spareDiskReplaced=spareDiskReplaced, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notifications=notifications, upgradeStarted=upgradeStarted, notificationSensorSuspect=notificationSensorSuspect, diskType=diskType, lunReservedSizeLow=lunReservedSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, nicReceiveMbps=nicReceiveMbps, fcInitiatorIndex=fcInitiatorIndex, lunDedupEnabled=lunDedupEnabled, shareReservedSizeLow=shareReservedSizeLow, lunFreeSizeLow=lunFreeSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, shareNFSReadLatency=shareNFSReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, diskSequentialIOCount=diskSequentialIOCount, notificationReadingUnit=notificationReadingUnit, nicIndex=nicIndex, nicGroup=nicGroup, fcTotalWriteIops=fcTotalWriteIops, diskIOCount=diskIOCount)
