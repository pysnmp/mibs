...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter32, MibIdentifier, Counter64, enterprises, ModuleIdentity, Bits, TimeTicks, NotificationType, iso, Integer32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter32", "MibIdentifier", "Counter64", "enterprises", "ModuleIdentity", "Bits", "TimeTicks", "NotificationType", "iso", "Integer32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskType=diskType, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, replicationStarted=replicationStarted, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetIndex=iscsiTargetIndex, projectEntry=projectEntry, sanProperties=sanProperties, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareProjectName=shareProjectName, lunEntry=lunEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCIFSReadMbps=shareCIFSReadMbps, tegileConformance=tegileConformance, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStarted=snmpServiceStarted, replicationPaused=replicationPaused, poolState=poolState, replicationFailed=replicationFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, cpuTotalUsage=cpuTotalUsage, notificationTargetEntityName=notificationTargetEntityName, poolTotalSaving=poolTotalSaving, projectQuotaFinished=projectQuotaFinished, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunSizeLow=lunSizeLow, fcAvgReadLatency=fcAvgReadLatency, shareQuotaHigh=shareQuotaHigh, fcInitiatorEntry=fcInitiatorEntry, sensorFailureEvent=sensorFailureEvent, diskDataReadIops=diskDataReadIops, diskSizeLow=diskSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResourceActiveNode=haResourceActiveNode, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, diskRandomIOCount=diskRandomIOCount, lunWriteMbps=lunWriteMbps, cacheSSDReads=cacheSSDReads, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunReservedSizeLow=lunReservedSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, volumeModifyCompleted=volumeModifyCompleted, poolName=poolName, controllerTimeDrift=controllerTimeDrift, haResources=haResources, intelliFlashSoftwareUp=intelliFlashSoftwareUp, networkIpmpGroupUp=networkIpmpGroupUp, projectQuotaSizeLow=projectQuotaSizeLow, diskError=diskError, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcInitiators=fcInitiators, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nicTable=nicTable, upgradeDownloadFailed=upgradeDownloadFailed, projectTable=projectTable, diskState=diskState, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetGroup=fcTargetGroup, testNotification=testNotification, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunDataSizeLow=lunDataSizeLow, fcTargetWriteIops=fcTargetWriteIops, smisServiceStarted=smisServiceStarted, ipmiOther=ipmiOther, shareIndex=shareIndex, shareReservedSizeLow=shareReservedSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskTotalWriteIops=diskTotalWriteIops, ipmiCurrent=ipmiCurrent, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareCompressedRatio=shareCompressedRatio, snapshotDeleteFailed=snapshotDeleteFailed, deleteFolderFailed=deleteFolderFailed, fcInitiatorGroup=fcInitiatorGroup, poolTable=poolTable, poolUpgraded=poolUpgraded, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetError=iscsiTargetError, diskEntry=diskEntry, poolSizeLow=poolSizeLow, shareEntry=shareEntry, nicMTU=nicMTU, lunReservedSizeHigh=lunReservedSizeHigh, cacheTotalReadIops=cacheTotalReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunIndex=lunIndex, tegileGroups=tegileGroups, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, snapshotCreationFailed=snapshotCreationFailed, diskSlowIo=diskSlowIo, projectDeleted=projectDeleted, nicTransmitMbps=nicTransmitMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunTable=lunTable, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetEntry=iscsiTargetEntry, controllerHardwareModel=controllerHardwareModel, cifsTotalReadMbps=cifsTotalReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, networkInterfaceUp=networkInterfaceUp, cifsAvgReadLatency=cifsAvgReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolExported=poolExported, poolDeletionFailed=poolDeletionFailed, projectDeletionFailed=projectDeletionFailed, projectShares=projectShares, tegile=tegile, tdpsUpgradeTimeout=tdpsUpgradeTimeout, spareDiskReplaced=spareDiskReplaced, poolEntry=poolEntry, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectLUNs=projectLUNs, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, ipmiThreshold=ipmiThreshold, projectModified=projectModified, haResourcesTable=haResourcesTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, controllerUp=controllerUp, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTargetEntry=fcTargetEntry, upgradeTimeout=upgradeTimeout, nvdimmFailInitializationError=nvdimmFailInitializationError, fcPortOnline=fcPortOnline, nvdimmFailUnknownError=nvdimmFailUnknownError, projectCreatedSuccessfully=projectCreatedSuccessfully, smbSocketFailure=smbSocketFailure, nfsTotalReadMbps=nfsTotalReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunGUID=lunGUID, nicState=nicState, upgradeCompleted=upgradeCompleted, lunPoolName=lunPoolName, poolIndex=poolIndex, upgradeStarted=upgradeStarted, netbiosSocketFailure=netbiosSocketFailure, sharePoolName=sharePoolName, shareNFSEnabled=shareNFSEnabled, poolQuotaFinished=poolQuotaFinished, poolDataReadLatency=poolDataReadLatency, projectTotalSaving=projectTotalSaving, nfsTotalWriteMbps=nfsTotalWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiators=iscsiInitiators, poolReadCacheReadIops=poolReadCacheReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolMetaReadLatency=poolMetaReadLatency, diskDataReadMbps=diskDataReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, poolDeleted=poolDeleted, disks=disks, diskDataWriteIops=diskDataWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, properties=properties, shareNFSReadIops=shareNFSReadIops, diskTotalWriteMbps=diskTotalWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, ntpServerTimeDrift=ntpServerTimeDrift, notificationEventCode=notificationEventCode, fcInitiatorName=fcInitiatorName, notificationDescription=notificationDescription, lunReadIops=lunReadIops, fcTargetStatus=fcTargetStatus, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaWriteMbps=poolMetaWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, projectPoolName=projectPoolName, notificationObjects=notificationObjects, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolUsedSizeLow=poolUsedSizeLow, haResourceName=haResourceName, shareDataSizeLow=shareDataSizeLow, fcTargetReadIops=fcTargetReadIops, poolTotalWriteMbps=poolTotalWriteMbps, replicationComplete=replicationComplete, snmpServiceStopFailed=snmpServiceStopFailed, shareName=shareName, iscsiTargetReadIops=iscsiTargetReadIops, nfsTotalReadIops=nfsTotalReadIops, tegileCompliances=tegileCompliances, poolDataReadMbps=poolDataReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, snapshotRollbackFailed=snapshotRollbackFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectName=projectName, iscsiTargetReadLatency=iscsiTargetReadLatency, diskIndex=diskIndex, ipmiVoltage=ipmiVoltage, lunWriteLatency=lunWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, poolCount=poolCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareMountPoint=shareMountPoint, iscsiInitiatorsTable=iscsiInitiatorsTable, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, alertsCleanupCompleted=alertsCleanupCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastores=vmwareNFSDatastores, shareNFSWriteMbps=shareNFSWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTotalReadMbps=fcTotalReadMbps, unknownSensorEvent=unknownSensorEvent, cifsTotalReadIops=cifsTotalReadIops, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, shareDeleted=shareDeleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snmpAgentVersion=snmpAgentVersion, fcTargetIndex=fcTargetIndex, iscsiInitiatorName=iscsiInitiatorName, poolTotalReadIops=poolTotalReadIops, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, projectFreeSizeLow=projectFreeSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, ipmiTemperature=ipmiTemperature, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunDataSizeHigh=lunDataSizeHigh, shareTable=shareTable, notificationReadingUnit=notificationReadingUnit, poolMetaWriteLatency=poolMetaWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, lunCompressedRatio=lunCompressedRatio, fcTotalReadIops=fcTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, notificationComponentName=notificationComponentName, targetGroupMemberAdded=targetGroupMemberAdded, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolReadCacheWriteIops=poolReadCacheWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetReadLatency=fcTargetReadLatency, networkInterfaceDown=networkInterfaceDown, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetsTable=iscsiTargetsTable, projectThresholdExceedWarning=projectThresholdExceedWarning, currentObjectGroup=currentObjectGroup, diskTable=diskTable, poolDataWriteMbps=poolDataWriteMbps, poolExpanded=poolExpanded, haResourceStatus=haResourceStatus, shareDeletionFailed=shareDeletionFailed, iscsiTargets=iscsiTargets, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, projectShareCount=projectShareCount, nfsAvgReadLatency=nfsAvgReadLatency, fcPortOffline=fcPortOffline, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTotalReadIops=iscsiTotalReadIops, haControllerB_Name=haControllerB_Name, poolDataSizeLow=poolDataSizeLow, lunBlockSize=lunBlockSize, notificationTime=notificationTime, shareNFSWriteIops=shareNFSWriteIops, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataSizeHigh=poolDataSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, projectDataSizeLow=projectDataSizeLow, notifications=notifications, projectDataSizeHigh=projectDataSizeHigh, userLoginFailed=userLoginFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, tegileArray_notifications=tegileArray_notifications, snapshotRollbackCompleted=snapshotRollbackCompleted, adServerTimeDrift=adServerTimeDrift, aclMigrationCompleted=aclMigrationCompleted, diskTotalReadMbps=diskTotalReadMbps, cpuInterrupts=cpuInterrupts, nicGroup=nicGroup, tegileArray=tegileArray, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectLunCount=projectLunCount, diskIsOnline=diskIsOnline, replicationTargetDeleted=replicationTargetDeleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, pools=pools, snapshotCloningFailed=snapshotCloningFailed, shareDedupEnabled=shareDedupEnabled, network=network, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolFreeSizeHigh=poolFreeSizeHigh, poolProjectCount=poolProjectCount, basicCompliance=basicCompliance, networkTotalTransmitMbps=networkTotalTransmitMbps, memoryFailure=memoryFailure, lunDedupEnabled=lunDedupEnabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargets=fcTargets, poolImported=poolImported, cpuSystemCalls=cpuSystemCalls, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, smisServiceStopped=smisServiceStopped, ipmiMemory=ipmiMemory, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunWriteIops=lunWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, poolOwnerController=poolOwnerController, projectSnapshotSizeLow=projectSnapshotSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, smisServiceStartFailed=smisServiceStartFailed, lunTargetGroup=lunTargetGroup, nfsTotalWriteIops=nfsTotalWriteIops, volumeQuotaFinished=volumeQuotaFinished, fcTargetReadMbps=fcTargetReadMbps, lunProtocol=lunProtocol, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolMetaReadIops=poolMetaReadIops, diskAvgReadLatency=diskAvgReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, diskAlias=diskAlias, lunCompressionEnabled=lunCompressionEnabled, fcTotalWriteIops=fcTotalWriteIops, projectDedupEnabled=projectDedupEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectCompressionEnabled=projectCompressionEnabled, cacheTotalReadMbps=cacheTotalReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskIOCount=diskIOCount, upgradeFailed=upgradeFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haResourceIndex=haResourceIndex, ipmiFan=ipmiFan, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResourceEntry=haResourceEntry, shareCompressionEnabled=shareCompressionEnabled, fcInitiatorsTable=fcInitiatorsTable, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetGroup=iscsiTargetGroup, lunInitiatorGroup=lunInitiatorGroup, lunReadMbps=lunReadMbps, diskSizeHigh=diskSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskPoolName=diskPoolName, notificationSensorSuspect=notificationSensorSuspect, fcTargetName=fcTargetName, poolProjects=poolProjects, shareNFSReadMbps=shareNFSReadMbps, shareDataSizeHigh=shareDataSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smisServiceStopFailed=smisServiceStopFailed, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetAuth=iscsiTargetAuth, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snmpServiceStopped=snmpServiceStopped, lunProjectName=lunProjectName, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetAlias=iscsiTargetAlias, nicReceiveMbps=nicReceiveMbps, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareQuotaFinished=shareQuotaFinished, deleteFolderCompleted=deleteFolderCompleted, lunSizeHigh=lunSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskGoneOffline=diskGoneOffline, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, currentNotificationGroup=currentNotificationGroup, diskCount=diskCount, poolAvgReadLatency=poolAvgReadLatency, diskDataWriteMbps=diskDataWriteMbps, fcTargetsTable=fcTargetsTable, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataWriteIops=poolDataWriteIops, nicEntry=nicEntry, ipmiPowerSupply=ipmiPowerSupply, haResourceDescription=haResourceDescription, haControllerB_IPAddr=haControllerB_IPAddr, haControllerA_Name=haControllerA_Name, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSeverity=notificationSeverity, replicationAbandoned=replicationAbandoned, nvdimmFailDeviceError=nvdimmFailDeviceError, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolDataReadIops=poolDataReadIops, PYSNMP_MODULE_ID=tegile, fcTargetModifyCompleted=fcTargetModifyCompleted, lunName=lunName, poolHealth=poolHealth, iscsiTargetGroupError=iscsiTargetGroupError, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolFreeSizeLow=poolFreeSizeLow, shareQuotaLow=shareQuotaLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cacheRAMReads=cacheRAMReads, projectIndex=projectIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicName=nicName, shareNFSReadLatency=shareNFSReadLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetName=iscsiTargetName, iscsiWriteIops=iscsiWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, poolSizeHigh=poolSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, replicationSourceRegistered=replicationSourceRegistered, iscsiProperties=iscsiProperties, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolMetaReadMbps=poolMetaReadMbps, haControllerA_Uptime=haControllerA_Uptime, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, controllerDown=controllerDown, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, haControllerA_IPAddr=haControllerA_IPAddr, lunSnapshotSizeLow=lunSnapshotSizeLow, fcProperties=fcProperties, cifsAvgWriteLatency=cifsAvgWriteLatency, lunReadLatency=lunReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, webdocsUpgradeFailed=webdocsUpgradeFailed, replicationAborted=replicationAborted, diskChassisIdx=diskChassisIdx, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationResumed=replicationResumed, haResourceGroup=haResourceGroup, shareCIFSReadIops=shareCIFSReadIops, poolTotalWriteIops=poolTotalWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, nicIndex=nicIndex, notificationProps=notificationProps, nfsAvgWriteLatency=nfsAvgWriteLatency, globalStatistics=globalStatistics, poolCreated=poolCreated, poolDegraded=poolDegraded, iscsiTotalReadMbps=iscsiTotalReadMbps, fcInitiatorIndex=fcInitiatorIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded)
