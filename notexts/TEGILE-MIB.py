...
Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64, Gauge32, Integer32, Bits, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64", "Gauge32", "Integer32", "Bits", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskChassisIdx=diskChassisIdx, fcPortOffline=fcPortOffline, cifsAvgWriteLatency=cifsAvgWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationPaused=replicationPaused, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetReadMbps=iscsiTargetReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareQuotaHigh=shareQuotaHigh, fcInitiators=fcInitiators, snmpServiceStopped=snmpServiceStopped, shareCompressionEnabled=shareCompressionEnabled, poolAvgWriteLatency=poolAvgWriteLatency, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, lunCompressedRatio=lunCompressedRatio, diskAvgReadLatency=diskAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetReadIops=fcTargetReadIops, diskType=diskType, poolMetaWriteLatency=poolMetaWriteLatency, poolUsedSizeLow=poolUsedSizeLow, aclMigrationCompleted=aclMigrationCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiCurrent=ipmiCurrent, lunFreeSizeLow=lunFreeSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, sharePoolName=sharePoolName, notificationTime=notificationTime, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkInterfaceDown=networkInterfaceDown, poolDataWriteLatency=poolDataWriteLatency, replicationAborted=replicationAborted, haResourcesTable=haResourcesTable, alertsCleanupCompleted=alertsCleanupCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, ipmiCriticalInterrupt=ipmiCriticalInterrupt, volumeModifyCompleted=volumeModifyCompleted, controllerHardwareModel=controllerHardwareModel, notificationSensorAction=notificationSensorAction, deleteFolderCompleted=deleteFolderCompleted, lunReservedSizeLow=lunReservedSizeLow, poolDeleted=poolDeleted, iscsiInitiatorsTable=iscsiInitiatorsTable, projectDeleted=projectDeleted, nfsTotalReadIops=nfsTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareNFSReadLatency=shareNFSReadLatency, poolProjects=poolProjects, poolMetaWriteIops=poolMetaWriteIops, haControllerA_Uptime=haControllerA_Uptime, poolHealth=poolHealth, nicMTU=nicMTU, snmpServiceStopFailed=snmpServiceStopFailed, cacheTotalReadMbps=cacheTotalReadMbps, notificationProps=notificationProps, nicEntry=nicEntry, lunProtocol=lunProtocol, haResourceDescription=haResourceDescription, poolProjectCount=poolProjectCount, volumeQuotaFinished=volumeQuotaFinished, fcTargetsTable=fcTargetsTable, iscsiAvgReadLatency=iscsiAvgReadLatency, currentObjectGroup=currentObjectGroup, userLoginFailed=userLoginFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunTable=lunTable, fcProperties=fcProperties, diskTable=diskTable, shareCIFSWriteIops=shareCIFSWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicTransmitMbps=nicTransmitMbps, controllerTimeDrift=controllerTimeDrift, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationEventCode=notificationEventCode, replicationTargetDeleted=replicationTargetDeleted, fcTargetIndex=fcTargetIndex, networkIpmpGroupUp=networkIpmpGroupUp, poolDataSizeHigh=poolDataSizeHigh, diskSizeHigh=diskSizeHigh, shareNFSReadMbps=shareNFSReadMbps, lunEntry=lunEntry, poolExported=poolExported, projectName=projectName, snmpServiceStarted=snmpServiceStarted, shareQuotaFinished=shareQuotaFinished, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiProperties=iscsiProperties, poolDegraded=poolDegraded, ipmiMemory=ipmiMemory, diskSizeLow=diskSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorEntry=fcInitiatorEntry, fcTargetWriteMbps=fcTargetWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, diskIsOnline=diskIsOnline, nicReceiveMbps=nicReceiveMbps, lunWriteLatency=lunWriteLatency, haResourceIndex=haResourceIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolDataWriteIops=poolDataWriteIops, poolOwnerController=poolOwnerController, currentNotificationGroup=currentNotificationGroup, projectTotalSaving=projectTotalSaving, fcTargetName=fcTargetName, upgradeDownloadStarted=upgradeDownloadStarted, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetStatus=fcTargetStatus, poolDataReadIops=poolDataReadIops, lunDataSizeLow=lunDataSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareEntry=shareEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunInitiatorGroup=lunInitiatorGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceEntry=haResourceEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectIndex=projectIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskEntry=diskEntry, shareDeleted=shareDeleted, iscsiTargetIndex=iscsiTargetIndex, poolEntry=poolEntry, fcAvgWriteLatency=fcAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolTable=poolTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetEntry=iscsiTargetEntry, poolSizeLow=poolSizeLow, poolDataSizeLow=poolDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, PYSNMP_MODULE_ID=tegile, maintenanceModeEnabled=maintenanceModeEnabled, iscsiInitiatorGroup=iscsiInitiatorGroup, sanProperties=sanProperties, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, notificationDescription=notificationDescription, upgradeDownloadFailed=upgradeDownloadFailed, poolSizeHigh=poolSizeHigh, ipmiVoltage=ipmiVoltage, shareIndex=shareIndex, haControllerB_Uptime=haControllerB_Uptime, diskGoneOffline=diskGoneOffline, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cpuTotalUsage=cpuTotalUsage, snapshotCloneCompleted=snapshotCloneCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDeletionFailed=projectDeletionFailed, lunWriteIops=lunWriteIops, diskRandomIOCount=diskRandomIOCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunDataSizeHigh=lunDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, diskAlias=diskAlias, iscsiWriteIops=iscsiWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, shareNFSReadIops=shareNFSReadIops, fcTotalReadMbps=fcTotalReadMbps, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcInitiatorGroup=fcInitiatorGroup, diskDataReadMbps=diskDataReadMbps, diskIndex=diskIndex, shareCompressedRatio=shareCompressedRatio, pools=pools, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, smisServiceStartFailed=smisServiceStartFailed, tegileArray=tegileArray, nicName=nicName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolFreeSizeLow=poolFreeSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetReadLatency=fcTargetReadLatency, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, cifsTotalReadIops=cifsTotalReadIops, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, sensorFailureEvent=sensorFailureEvent, cifsTotalWriteMbps=cifsTotalWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastores=vmwareNFSDatastores, lunIndex=lunIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiators=iscsiInitiators, cpuInterrupts=cpuInterrupts, projectQuotaSizeLow=projectQuotaSizeLow, projectDataSizeLow=projectDataSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceName=haResourceName, haControllerA_Name=haControllerA_Name, shareDeletionFailed=shareDeletionFailed, diagnosticDataUploaded=diagnosticDataUploaded, lunTargetGroup=lunTargetGroup, diskState=diskState, upgradeStarted=upgradeStarted, poolTotalReadMbps=poolTotalReadMbps, poolExpanded=poolExpanded, cifsTotalReadMbps=cifsTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskIOCount=diskIOCount, shareNFSEnabled=shareNFSEnabled, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, diskDataWriteIops=diskDataWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargets=fcTargets, diskCount=diskCount, iscsiTargetError=iscsiTargetError, lunFreeSizeHigh=lunFreeSizeHigh, network=network, shareDedupEnabled=shareDedupEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargets=iscsiTargets, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nfsTotalWriteIops=nfsTotalWriteIops, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataReadLatency=poolDataReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, haControllerB_IPAddr=haControllerB_IPAddr, diskTotalWriteIops=diskTotalWriteIops, smisServiceStopped=smisServiceStopped)
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicTable=nicTable, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haResourceGroup=haResourceGroup, lunPoolName=lunPoolName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectPoolName=projectPoolName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, targetGroupCreateCompleted=targetGroupCreateCompleted, basicCompliance=basicCompliance, replicationSourceRegistered=replicationSourceRegistered, nicIndex=nicIndex, volumeDeleteCompleted=volumeDeleteCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, shareQuotaLow=shareQuotaLow, lunReadLatency=lunReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, controllerUp=controllerUp, properties=properties, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolTotalReadIops=poolTotalReadIops, poolCreated=poolCreated, fcTargetModifyCompleted=fcTargetModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectModified=projectModified, nvdimmFailUnknownError=nvdimmFailUnknownError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, adServerTimeDrift=adServerTimeDrift, replicationFailed=replicationFailed, notificationComponentName=notificationComponentName, cacheTotalWriteMbps=cacheTotalWriteMbps, replicationResumed=replicationResumed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectShares=projectShares, poolUpgraded=poolUpgraded, snapshotDeleteFailed=snapshotDeleteFailed, snapshotCloningFailed=snapshotCloningFailed, shareDataSizeHigh=shareDataSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationSeverity=notificationSeverity, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiInitiatorEntry=iscsiInitiatorEntry, testNotification=testNotification, ipmiThreshold=ipmiThreshold, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetAuth=iscsiTargetAuth, notificationSensorNumber=notificationSensorNumber, projectDedupEnabled=projectDedupEnabled, nfsAvgReadLatency=nfsAvgReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareTable=shareTable, shareName=shareName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cpuSystemCalls=cpuSystemCalls, lunWriteMbps=lunWriteMbps, memoryFailure=memoryFailure, notificationTargetEntityName=notificationTargetEntityName, cacheSSDReads=cacheSSDReads, poolMetaReadIops=poolMetaReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, poolState=poolState, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, projectEntry=projectEntry, smisServiceStarted=smisServiceStarted, poolTotalWriteIops=poolTotalWriteIops, poolMetaReadLatency=poolMetaReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, shareReservedSizeLow=shareReservedSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, tegileConformance=tegileConformance, tegileGroups=tegileGroups, diskPoolName=diskPoolName, shareNFSWriteIops=shareNFSWriteIops, notifications=notifications, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolCount=poolCount, snapshotRollbackFailed=snapshotRollbackFailed, poolDeletionFailed=poolDeletionFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, ipmiPowerSupply=ipmiPowerSupply, iscsiInitiatorName=iscsiInitiatorName, unknownSensorEvent=unknownSensorEvent, diskTotalWriteMbps=diskTotalWriteMbps, lunSizeHigh=lunSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, nvdimmFailInitializationError=nvdimmFailInitializationError, diskDataReadIops=diskDataReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, globalStatistics=globalStatistics, cifsAvgReadLatency=cifsAvgReadLatency, upgradeTimeout=upgradeTimeout, fcPortOnline=fcPortOnline, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetGroup=iscsiTargetGroup, fcTargetEntry=fcTargetEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, netbiosSocketFailure=netbiosSocketFailure, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareMountPoint=shareMountPoint, lunReadIops=lunReadIops, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, fcTargetWriteIops=fcTargetWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, tegile=tegile, nicGroup=nicGroup, shareDataSizeLow=shareDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, poolReadCacheReadIops=poolReadCacheReadIops, lunProjectName=lunProjectName, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolName=poolName, projectCompressionEnabled=projectCompressionEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cacheRAMReads=cacheRAMReads, projectDataSizeHigh=projectDataSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunGUID=lunGUID, diskAvgWriteLatency=diskAvgWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, haControllerB_Name=haControllerB_Name, diskSlowIo=diskSlowIo, projectQuotaFinished=projectQuotaFinished, fcTotalWriteMbps=fcTotalWriteMbps, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, lunSizeLow=lunSizeLow, disks=disks, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorIndex=fcInitiatorIndex, fcInitiatorName=fcInitiatorName, iscsiTargetName=iscsiTargetName, lunCompressionEnabled=lunCompressionEnabled, networkInterfaceUp=networkInterfaceUp, poolQuotaFinished=poolQuotaFinished, lunReadMbps=lunReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareProjectName=shareProjectName, replicationStarted=replicationStarted, projectShareCount=projectShareCount, ipmiTemperature=ipmiTemperature, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, projectLUNs=projectLUNs, shareCIFSReadMbps=shareCIFSReadMbps, ipmiOther=ipmiOther, upgradeCompleted=upgradeCompleted, diskError=diskError, diskDataWriteMbps=diskDataWriteMbps, haResources=haResources, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcInitiatorsTable=fcInitiatorsTable, iscsiTotalReadMbps=iscsiTotalReadMbps, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectLunCount=projectLunCount, iscsiTargetsTable=iscsiTargetsTable, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, spareDiskReplaced=spareDiskReplaced, ipmiFan=ipmiFan, fcTotalReadIops=fcTotalReadIops, controllerDown=controllerDown, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCreationFailed=snapshotCreationFailed, poolAvgReadLatency=poolAvgReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, poolIndex=poolIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationComplete=replicationComplete, shareCIFSWriteMbps=shareCIFSWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, upgradeFailed=upgradeFailed, poolImported=poolImported, projectTable=projectTable, notificationObjects=notificationObjects, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicState=nicState, snapshotRollbackCompleted=snapshotRollbackCompleted, lunName=lunName, aclMigrationStarted=aclMigrationStarted, replicationAbandoned=replicationAbandoned, shareCIFSReadLatency=shareCIFSReadLatency, snmpAgentVersion=snmpAgentVersion, fcTargetWriteLatency=fcTargetWriteLatency, haResourceStatus=haResourceStatus, fcAvgReadLatency=fcAvgReadLatency, lunBlockSize=lunBlockSize, targetGroupMemberAdded=targetGroupMemberAdded, lunDedupEnabled=lunDedupEnabled, poolTotalSaving=poolTotalSaving, iscsiTargetAlias=iscsiTargetAlias, tegileCompliances=tegileCompliances, smbSocketFailure=smbSocketFailure, tegileArray_notifications=tegileArray_notifications, diskTotalReadMbps=diskTotalReadMbps)
