...
enterprises, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, Unsigned32, NotificationType, Bits, Gauge32, MibIdentifier, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "Unsigned32", "NotificationType", "Bits", "Gauge32", "MibIdentifier", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectCreatedSuccessfully=projectCreatedSuccessfully, poolSizeLow=poolSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareExceedThresholdWarning=shareExceedThresholdWarning, sensorFailureEvent=sensorFailureEvent, lunReservedSizeHigh=lunReservedSizeHigh, projectIndex=projectIndex, poolAvgWriteLatency=poolAvgWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, notificationProps=notificationProps, iscsiInitiatorIndex=iscsiInitiatorIndex, cpuTotalUsage=cpuTotalUsage, fcPortOffline=fcPortOffline, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, volumeDeleteCompleted=volumeDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, lunSizeHigh=lunSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationResumed=replicationResumed, tegileCompliances=tegileCompliances, fcPortOnline=fcPortOnline, haControllerB_Uptime=haControllerB_Uptime, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunBlockSize=lunBlockSize, iscsiTargets=iscsiTargets, cifsTotalWriteMbps=cifsTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, nicState=nicState, diskAlias=diskAlias, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareIndex=shareIndex, snapshotRollbackFailed=snapshotRollbackFailed, fcTotalWriteMbps=fcTotalWriteMbps, fcInitiators=fcInitiators, lunEntry=lunEntry, poolTable=poolTable, iscsiTotalReadIops=iscsiTotalReadIops, diskAvgReadLatency=diskAvgReadLatency, poolTotalWriteMbps=poolTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, poolCount=poolCount, sanProperties=sanProperties, projectDataSizeHigh=projectDataSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, testNotification=testNotification, haControllerA_Name=haControllerA_Name, sharePoolName=sharePoolName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskChassisIdx=diskChassisIdx, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetReadMbps=iscsiTargetReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiProperties=iscsiProperties, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetName=iscsiTargetName, projectFreeSizeLow=projectFreeSizeLow, shareDeleted=shareDeleted, replicationAborted=replicationAborted, shareReservedSizeHigh=shareReservedSizeHigh, tegile=tegile, poolName=poolName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotDeleteFailed=snapshotDeleteFailed, smisServiceStarted=smisServiceStarted, fcInitiatorGroup=fcInitiatorGroup, lunIndex=lunIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, userLoginFailed=userLoginFailed, shareMountPoint=shareMountPoint, netbiosSocketFailure=netbiosSocketFailure, nvdimmFailSoftError=nvdimmFailSoftError, diskDataReadMbps=diskDataReadMbps, poolMetaReadMbps=poolMetaReadMbps, fcTargetReadLatency=fcTargetReadLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tegileConformance=tegileConformance, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcAvgReadLatency=fcAvgReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolDataReadLatency=poolDataReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, volumeDeleteFailed=volumeDeleteFailed, smisServiceStopFailed=smisServiceStopFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, lunName=lunName, diagnosticDataUploaded=diagnosticDataUploaded, shareNFSEnabled=shareNFSEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ntpServerTimeDrift=ntpServerTimeDrift, cpuInterrupts=cpuInterrupts, haResourceIndex=haResourceIndex, iscsiTotalReadMbps=iscsiTotalReadMbps, replicationComplete=replicationComplete, projectPoolName=projectPoolName, notificationSensorNumber=notificationSensorNumber, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetWriteIops=fcTargetWriteIops, replicationPaused=replicationPaused, iscsiTargetIndex=iscsiTargetIndex, projectLunCount=projectLunCount, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDegraded=poolDegraded, replicationStarted=replicationStarted, diskType=diskType, notificationTargetEntityName=notificationTargetEntityName, nicTransmitMbps=nicTransmitMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolUpgraded=poolUpgraded, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, upgradeStarted=upgradeStarted, notificationSeverity=notificationSeverity, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcInitiatorName=fcInitiatorName, fcTargetGroup=fcTargetGroup, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, globalStatistics=globalStatistics, fcTotalWriteIops=fcTotalWriteIops, poolSizeHigh=poolSizeHigh, lunProjectName=lunProjectName, shareCompressionEnabled=shareCompressionEnabled, smisServiceStopped=smisServiceStopped, shareNFSReadIops=shareNFSReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiFan=ipmiFan, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolOwnerController=poolOwnerController, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolMetaReadIops=poolMetaReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, controllerHardwareModel=controllerHardwareModel, projectName=projectName, webdocsUpgradeFailed=webdocsUpgradeFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cifsAvgReadLatency=cifsAvgReadLatency, PYSNMP_MODULE_ID=tegile, notificationSensorAction=notificationSensorAction, lunDataSizeHigh=lunDataSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectTable=projectTable, shareEntry=shareEntry, lunWriteLatency=lunWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, haResourceActiveNode=haResourceActiveNode, poolTotalSaving=poolTotalSaving, shareNFSWriteLatency=shareNFSWriteLatency, diskTable=diskTable, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectShareCount=projectShareCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeModifyCompleted=volumeModifyCompleted, diskIOCount=diskIOCount, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, notificationReadingUnit=notificationReadingUnit, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotCloningFailed=snapshotCloningFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, poolHealth=poolHealth, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheSSDReads=cacheSSDReads, fcTargetsTable=fcTargetsTable, shareCIFSWriteIops=shareCIFSWriteIops, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetAuth=iscsiTargetAuth, shareCreatedSuccessfully=shareCreatedSuccessfully, diskEntry=diskEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicGroup=nicGroup, poolEntry=poolEntry, tegileArray_notifications=tegileArray_notifications, diskTotalReadMbps=diskTotalReadMbps, poolDeleted=poolDeleted, diskAvgWriteLatency=diskAvgWriteLatency, cifsTotalReadIops=cifsTotalReadIops, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetsTable=iscsiTargetsTable, fcTargets=fcTargets, haControllerB_IPAddr=haControllerB_IPAddr, haControllerA_Uptime=haControllerA_Uptime, lunReadMbps=lunReadMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, haResources=haResources, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectQuotaFinished=projectQuotaFinished, snapshotCloneCompleted=snapshotCloneCompleted, deleteFolderCompleted=deleteFolderCompleted, haResourceStatus=haResourceStatus, projectTotalSaving=projectTotalSaving, iscsiInitiatorsTable=iscsiInitiatorsTable, snapshotCreationFailed=snapshotCreationFailed, network=network, poolDataReadMbps=poolDataReadMbps, diskTotalReadIops=diskTotalReadIops, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, lunReadIops=lunReadIops, networkIpmpGroupUp=networkIpmpGroupUp, nfsTotalReadMbps=nfsTotalReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolImported=poolImported, lunDedupEnabled=lunDedupEnabled, shareTable=shareTable, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolCreated=poolCreated, fcTotalReadIops=fcTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tegileArray=tegileArray, snmpServiceStopFailed=snmpServiceStopFailed, upgradeDownloadFailed=upgradeDownloadFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, shareQuotaFinished=shareQuotaFinished, poolMetaWriteMbps=poolMetaWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetName=fcTargetName, networkInterfaceUp=networkInterfaceUp, iscsiWriteIops=iscsiWriteIops, targetGroupCreateCompleted=targetGroupCreateCompleted, cacheRAMReads=cacheRAMReads, snapshotRollbackCompleted=snapshotRollbackCompleted, controllerUp=controllerUp, ipmiTemperature=ipmiTemperature, notificationObjects=notificationObjects, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationComponentName=notificationComponentName)
mibBuilder.exportSymbols("TEGILE-MIB", properties=properties, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupMemberAdded=targetGroupMemberAdded, poolProjectCount=poolProjectCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareDataSizeLow=shareDataSizeLow, shareName=shareName, pools=pools, shareSnapshotSizeLow=shareSnapshotSizeLow, diskSizeHigh=diskSizeHigh, fcTargetReadMbps=fcTargetReadMbps, diskSizeLow=diskSizeLow, ipmiCurrent=ipmiCurrent, poolDataSizeHigh=poolDataSizeHigh, projectLUNs=projectLUNs, diskGoneOffline=diskGoneOffline, projectEntry=projectEntry, lunReadLatency=lunReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcProperties=fcProperties, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haResourceName=haResourceName, tegileGroups=tegileGroups, nfsTotalWriteMbps=nfsTotalWriteMbps, shareQuotaHigh=shareQuotaHigh, shareCIFSReadIops=shareCIFSReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, currentObjectGroup=currentObjectGroup, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolFreeSizeLow=poolFreeSizeLow, haControllerB_Name=haControllerB_Name, fcTargetEntry=fcTargetEntry, projectDataSizeLow=projectDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareQuotaLow=shareQuotaLow, diskSequentialIOCount=diskSequentialIOCount, volumeQuotaFinished=volumeQuotaFinished, poolMetaReadLatency=poolMetaReadLatency, networkInterfaceDown=networkInterfaceDown, projectDeletionFailed=projectDeletionFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haResourceDescription=haResourceDescription, poolProjects=poolProjects, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskState=diskState, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataWriteMbps=poolDataWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiThreshold=ipmiThreshold, snmpServiceStarted=snmpServiceStarted, poolMetaWriteIops=poolMetaWriteIops, poolDataSizeLow=poolDataSizeLow, shareNFSReadLatency=shareNFSReadLatency, notificationTime=notificationTime, projectShares=projectShares, iscsiTargetError=iscsiTargetError, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetGroup=iscsiTargetGroup, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, snmpServiceStopped=snmpServiceStopped, poolExported=poolExported, upgradeDownloadStarted=upgradeDownloadStarted, shareDataSizeHigh=shareDataSizeHigh, haResourceGroup=haResourceGroup, poolDeletionFailed=poolDeletionFailed, upgradeTimeout=upgradeTimeout, fcTargetReadIops=fcTargetReadIops, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcInitiatorsTable=fcInitiatorsTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetAlias=iscsiTargetAlias, ipmiVoltage=ipmiVoltage, nvdimmFailDeviceError=nvdimmFailDeviceError, notifications=notifications, lunProtocol=lunProtocol, upgradeCompleted=upgradeCompleted, aclMigrationCompleted=aclMigrationCompleted, controllerDown=controllerDown, haResourcesTable=haResourcesTable, shareDedupEnabled=shareDedupEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiators=iscsiInitiators, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, notificationEventCode=notificationEventCode, iscsiInitiatorGroup=iscsiInitiatorGroup, aclMigrationStarted=aclMigrationStarted, nicReceiveMbps=nicReceiveMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, maintenanceModeEnabled=maintenanceModeEnabled, nfsTotalReadIops=nfsTotalReadIops, cpuSystemCalls=cpuSystemCalls, smisServiceStartFailed=smisServiceStartFailed, upgradeFailed=upgradeFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolDataWriteLatency=poolDataWriteLatency, snmpAgentVersion=snmpAgentVersion, notificationSensorSuspect=notificationSensorSuspect, fcAvgWriteLatency=fcAvgWriteLatency, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiPowerSupply=ipmiPowerSupply, poolReadCacheWriteIops=poolReadCacheWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nicName=nicName, nfsTotalWriteIops=nfsTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareReservedSizeLow=shareReservedSizeLow, shareDeletionFailed=shareDeletionFailed, lunSizeLow=lunSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicTable=nicTable, diskSlowIo=diskSlowIo, cacheTotalWriteIops=cacheTotalWriteIops, projectDeleted=projectDeleted, iscsiTargetEntry=iscsiTargetEntry, ipmiMemory=ipmiMemory, haControllerA_IPAddr=haControllerA_IPAddr, lunInitiatorGroup=lunInitiatorGroup, poolUsedSizeLow=poolUsedSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolTotalReadIops=poolTotalReadIops, lunTable=lunTable, poolAvgReadLatency=poolAvgReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunGUID=lunGUID, disks=disks, diskTotalWriteMbps=diskTotalWriteMbps, diskDataWriteMbps=diskDataWriteMbps, poolTotalReadMbps=poolTotalReadMbps, lunReservedSizeLow=lunReservedSizeLow, diskIndex=diskIndex, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, nicMTU=nicMTU, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetStatus=fcTargetStatus, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectDedupEnabled=projectDedupEnabled, fcInitiatorEntry=fcInitiatorEntry, poolExpanded=poolExpanded, adServerTimeDrift=adServerTimeDrift, lunDataSizeLow=lunDataSizeLow, shareNFSWriteIops=shareNFSWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationSourceRegistered=replicationSourceRegistered, diskError=diskError, replicationFailed=replicationFailed, currentNotificationGroup=currentNotificationGroup, fcInitiatorIndex=fcInitiatorIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolState=poolState, fcTargetIndex=fcTargetIndex, fcTotalReadMbps=fcTotalReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskRandomIOCount=diskRandomIOCount, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, lunPoolName=lunPoolName, nicIndex=nicIndex, deleteFolderFailed=deleteFolderFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolQuotaFinished=poolQuotaFinished, smbSocketFailure=smbSocketFailure, poolIndex=poolIndex, poolDataWriteIops=poolDataWriteIops, memoryFailure=memoryFailure, haResourceEntry=haResourceEntry, lunTargetGroup=lunTargetGroup, basicCompliance=basicCompliance, shareCIFSWriteMbps=shareCIFSWriteMbps, unknownSensorEvent=unknownSensorEvent, diskCount=diskCount, replicationTargetDeleted=replicationTargetDeleted, controllerTimeDrift=controllerTimeDrift, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicEntry=nicEntry, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, spareDiskReplaced=spareDiskReplaced, projectModified=projectModified, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDataReadIops=poolDataReadIops, shareCIFSReadMbps=shareCIFSReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareProjectName=shareProjectName, lunWriteIops=lunWriteIops, diskIsOnline=diskIsOnline, notificationDescription=notificationDescription, poolTotalWriteIops=poolTotalWriteIops, ipmiOther=ipmiOther, projectCompressionEnabled=projectCompressionEnabled, diskPoolName=diskPoolName, lunCompressedRatio=lunCompressedRatio, cifsTotalReadMbps=cifsTotalReadMbps)
