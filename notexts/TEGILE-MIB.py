...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:14:40 2023
...
TimeTicks, ModuleIdentity, iso, NotificationType, Bits, enterprises, Counter64, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "NotificationType", "Bits", "enterprises", "Counter64", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskSizeHigh=diskSizeHigh, shareDeleted=shareDeleted, ipmiThreshold=ipmiThreshold, replicationComplete=replicationComplete, shareNFSWriteLatency=shareNFSWriteLatency, cacheRAMReads=cacheRAMReads, nicEntry=nicEntry, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskRandomIOCount=diskRandomIOCount, poolReadCacheReadMbps=poolReadCacheReadMbps, nicMTU=nicMTU, controllerTimeDrift=controllerTimeDrift, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunPoolName=lunPoolName, currentNotificationGroup=currentNotificationGroup, poolExported=poolExported, properties=properties, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcInitiatorIndex=fcInitiatorIndex, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, testNotification=testNotification, shareNFSWriteIops=shareNFSWriteIops, cacheTotalReadIops=cacheTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotRollbackFailed=snapshotRollbackFailed, replicationPaused=replicationPaused, poolUsedSizeLow=poolUsedSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastores=vmwareNFSDatastores, tegileArray_notifications=tegileArray_notifications, poolAvgWriteLatency=poolAvgWriteLatency, diskError=diskError, cpuInterrupts=cpuInterrupts, fcTargets=fcTargets, shareQuotaFinished=shareQuotaFinished, projectDedupEnabled=projectDedupEnabled, poolMetaReadIops=poolMetaReadIops, poolDataSizeLow=poolDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, lunSizeHigh=lunSizeHigh, ipmiVoltage=ipmiVoltage, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDegraded=poolDegraded, notificationEventCode=notificationEventCode, projectDeletionFailed=projectDeletionFailed, lunWriteLatency=lunWriteLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDeletionFailed=poolDeletionFailed, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, controllerDown=controllerDown, fcTargetsTable=fcTargetsTable, globalStatistics=globalStatistics, projectDataSizeLow=projectDataSizeLow, shareNFSEnabled=shareNFSEnabled, networkInterfaceUp=networkInterfaceUp, lunTargetGroup=lunTargetGroup, fcTargetWriteIops=fcTargetWriteIops, haControllerB_Uptime=haControllerB_Uptime, notificationSeverity=notificationSeverity, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolState=poolState, upgradeDownloadCompleted=upgradeDownloadCompleted, nicGroup=nicGroup, lunWriteMbps=lunWriteMbps, shareEntry=shareEntry, fcInitiatorEntry=fcInitiatorEntry, shareTable=shareTable, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, ipmiOther=ipmiOther, PYSNMP_MODULE_ID=tegile, poolEntry=poolEntry, lunDataSizeLow=lunDataSizeLow, diskSequentialIOCount=diskSequentialIOCount, poolTotalReadIops=poolTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, projectPoolName=projectPoolName, cacheTotalReadMbps=cacheTotalReadMbps, projectCompressionEnabled=projectCompressionEnabled, tegileConformance=tegileConformance, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunInitiatorGroup=lunInitiatorGroup, iscsiProperties=iscsiProperties, poolFreeSizeHigh=poolFreeSizeHigh, poolIndex=poolIndex, maintenanceModeDisabled=maintenanceModeDisabled, replicationAbandoned=replicationAbandoned, haControllerB_IPAddr=haControllerB_IPAddr, nfsTotalWriteIops=nfsTotalWriteIops, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, poolFreeSizeLow=poolFreeSizeLow, deleteFolderCompleted=deleteFolderCompleted, controllerUp=controllerUp, snapshotCreationFailed=snapshotCreationFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationTargetDeleted=replicationTargetDeleted, diskEntry=diskEntry, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectDataSizeHigh=projectDataSizeHigh, projectQuotaFinished=projectQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareCIFSReadLatency=shareCIFSReadLatency, snmpServiceStopped=snmpServiceStopped, projectQuotaSizeLow=projectQuotaSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, pools=pools, upgradeDownloadFailed=upgradeDownloadFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunDataSizeHigh=lunDataSizeHigh, haResourceStatus=haResourceStatus, networkInterfaceDown=networkInterfaceDown, cacheTotalWriteIops=cacheTotalWriteIops, shareCompressedRatio=shareCompressedRatio, iscsiTargetAlias=iscsiTargetAlias, shareDeletionFailed=shareDeletionFailed, poolHealth=poolHealth, poolDeleted=poolDeleted, poolDataWriteLatency=poolDataWriteLatency, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskTotalWriteMbps=diskTotalWriteMbps, poolProjectCount=poolProjectCount, diagnosticDataUploaded=diagnosticDataUploaded, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskCount=diskCount, volumeDeleteCompleted=volumeDeleteCompleted, lunBlockSize=lunBlockSize, cpuSystemCalls=cpuSystemCalls, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetGroup=fcTargetGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceEntry=haResourceEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerA_Name=haControllerA_Name, diskDataReadIops=diskDataReadIops, notificationObjects=notificationObjects, nvdimmFailDeviceError=nvdimmFailDeviceError, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, fcPortOnline=fcPortOnline, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareReservedSizeLow=shareReservedSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetName=fcTargetName, nicName=nicName, volumeDeleteFailed=volumeDeleteFailed, adServerTimeDrift=adServerTimeDrift, alertsCleanupCompleted=alertsCleanupCompleted, nicTransmitMbps=nicTransmitMbps, fcInitiators=fcInitiators, diskIndex=diskIndex, poolCreated=poolCreated, lunCompressedRatio=lunCompressedRatio, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolDataReadIops=poolDataReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haResourceDescription=haResourceDescription, haResources=haResources, fcTargetReadLatency=fcTargetReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiMemory=ipmiMemory, lunWriteIops=lunWriteIops, lunEntry=lunEntry, iscsiInitiatorEntry=iscsiInitiatorEntry, poolMetaWriteMbps=poolMetaWriteMbps, fcProperties=fcProperties, haResourcesTable=haResourcesTable, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetReadMbps=fcTargetReadMbps, cpuTotalUsage=cpuTotalUsage, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCompressionEnabled=shareCompressionEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, poolUpgraded=poolUpgraded, lunFreeSizeLow=lunFreeSizeLow, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetGroupError=iscsiTargetGroupError, cacheSSDReads=cacheSSDReads, cifsTotalWriteMbps=cifsTotalWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetGroup=iscsiTargetGroup, iscsiWriteIops=iscsiWriteIops, iscsiTargetsTable=iscsiTargetsTable, fcTargetStatus=fcTargetStatus, iscsiTargetError=iscsiTargetError, nicState=nicState, iscsiInitiatorGroup=iscsiInitiatorGroup, ipmiFan=ipmiFan, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolTotalReadMbps=poolTotalReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, poolMetaReadLatency=poolMetaReadLatency, lunProjectName=lunProjectName, projectShares=projectShares, diskSizeLow=diskSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tegile=tegile, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetReadIops=iscsiTargetReadIops, haControllerA_Uptime=haControllerA_Uptime, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, sharePoolName=sharePoolName, poolSizeLow=poolSizeLow, projectShareCount=projectShareCount, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, smisServiceStopped=smisServiceStopped, replicationAborted=replicationAborted, shareNFSReadIops=shareNFSReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectName=projectName, diskIsOnline=diskIsOnline, projectEntry=projectEntry, deleteFolderFailed=deleteFolderFailed, shareReservedSizeHigh=shareReservedSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorIndex=iscsiInitiatorIndex, replicationFailed=replicationFailed, diskAvgReadLatency=diskAvgReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorName=fcInitiatorName, network=network, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize)
mibBuilder.exportSymbols("TEGILE-MIB", upgradeStarted=upgradeStarted, diskType=diskType, volumeQuotaFinished=volumeQuotaFinished, sanProperties=sanProperties, cifsTotalReadIops=cifsTotalReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTotalReadIops=fcTotalReadIops, fcTargetEntry=fcTargetEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, shareName=shareName, shareDataSizeLow=shareDataSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsAvgReadLatency=cifsAvgReadLatency, notificationComponentName=notificationComponentName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolName=poolName, projectThresholdExceedWarning=projectThresholdExceedWarning, poolReadCacheWriteIops=poolReadCacheWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationReadingUnit=notificationReadingUnit, haResourceGroup=haResourceGroup, snapshotCloningFailed=snapshotCloningFailed, lunCompressionEnabled=lunCompressionEnabled, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationTargetEntityName=notificationTargetEntityName, upgradeFailed=upgradeFailed, projectDeleted=projectDeleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTotalReadIops=iscsiTotalReadIops, fcInitiatorGroup=fcInitiatorGroup, fcTotalWriteMbps=fcTotalWriteMbps, lunIndex=lunIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, poolQuotaFinished=poolQuotaFinished, haResourceActiveNode=haResourceActiveNode, shareCIFSReadMbps=shareCIFSReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorAction=notificationSensorAction, cacheTotalWriteMbps=cacheTotalWriteMbps, poolImported=poolImported, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCIFSReadIops=shareCIFSReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, replicationSourceRegistered=replicationSourceRegistered, shareIndex=shareIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolReadCacheWriteLatency=poolReadCacheWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunReadIops=lunReadIops, shareCIFSWriteIops=shareCIFSWriteIops, poolProjects=poolProjects, poolOwnerController=poolOwnerController, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snmpAgentVersion=snmpAgentVersion, poolDataReadLatency=poolDataReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, notifications=notifications, cifsTotalWriteIops=cifsTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectLUNs=projectLUNs, replicationResumed=replicationResumed, upgradeCompleted=upgradeCompleted, userLoginFailed=userLoginFailed, diskChassisIdx=diskChassisIdx, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, currentObjectGroup=currentObjectGroup, diskState=diskState, ipmiCurrent=ipmiCurrent, haControllerB_Name=haControllerB_Name, poolMetaWriteLatency=poolMetaWriteLatency, poolAvgReadLatency=poolAvgReadLatency, fcPortOffline=fcPortOffline, nicTable=nicTable, memoryFailure=memoryFailure, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourceIndex=haResourceIndex, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, unknownSensorEvent=unknownSensorEvent, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorName=iscsiInitiatorName, lunReadLatency=lunReadLatency, iscsiTargets=iscsiTargets, poolMetaWriteIops=poolMetaWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTotalWriteMbps=iscsiTotalWriteMbps, smbSocketFailure=smbSocketFailure, basicCompliance=basicCompliance, poolTotalWriteIops=poolTotalWriteIops, poolTable=poolTable, fcAvgReadLatency=fcAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, notificationSensorNumber=notificationSensorNumber, targetGroupMemberRemoved=targetGroupMemberRemoved, upgradeTimeout=upgradeTimeout, snapshotCloneCompleted=snapshotCloneCompleted, projectTable=projectTable, snmpServiceStopFailed=snmpServiceStopFailed, nfsTotalReadIops=nfsTotalReadIops, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, shareQuotaHigh=shareQuotaHigh, poolSizeHigh=poolSizeHigh, volumeModifyCompleted=volumeModifyCompleted, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, notificationProps=notificationProps, tegileArray=tegileArray, poolMetaReadMbps=poolMetaReadMbps, lunName=lunName, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTotalWriteIops=fcTotalWriteIops, projectModified=projectModified, ntpServerTimeDrift=ntpServerTimeDrift, diskPoolName=diskPoolName, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, netbiosSocketFailure=netbiosSocketFailure, diskIOCount=diskIOCount, ipmiTemperature=ipmiTemperature, smisServiceStopFailed=smisServiceStopFailed, fcTotalReadMbps=fcTotalReadMbps, shareDedupEnabled=shareDedupEnabled, poolCount=poolCount, lunGUID=lunGUID, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetAuth=iscsiTargetAuth, nicReceiveMbps=nicReceiveMbps, nicIndex=nicIndex, replicationStarted=replicationStarted, tdpsUpgradeFailed=tdpsUpgradeFailed, snmpServiceStartFailed=snmpServiceStartFailed, poolDataWriteMbps=poolDataWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, tegileGroups=tegileGroups, nfsTotalReadMbps=nfsTotalReadMbps, projectIndex=projectIndex, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiPowerSupply=ipmiPowerSupply, lunProtocol=lunProtocol, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, aclMigrationStarted=aclMigrationStarted, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, shareDataSizeHigh=shareDataSizeHigh, fcTargetReadIops=fcTargetReadIops, lunReadMbps=lunReadMbps, iscsiTargetName=iscsiTargetName, poolDataWriteIops=poolDataWriteIops, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiators=iscsiInitiators, shareMountPoint=shareMountPoint, diskTotalWriteIops=diskTotalWriteIops, projectLunCount=projectLunCount, notificationReadingTriggerValue=notificationReadingTriggerValue, haControllerA_IPAddr=haControllerA_IPAddr, sensorFailureEvent=sensorFailureEvent, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetWriteLatency=fcTargetWriteLatency, smisServiceStarted=smisServiceStarted, nvdimmFailUnknownError=nvdimmFailUnknownError, poolWriteCacheWriteIops=poolWriteCacheWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, projectFreeSizeHigh=projectFreeSizeHigh, fcTargetIndex=fcTargetIndex, shareExceedThresholdWarning=shareExceedThresholdWarning, shareProjectName=shareProjectName, diskGoneOffline=diskGoneOffline, poolExpanded=poolExpanded, notificationDescription=notificationDescription, maintenanceModeEnabled=maintenanceModeEnabled, snmpServiceStarted=snmpServiceStarted, shareCIFSEnabled=shareCIFSEnabled, lunDedupEnabled=lunDedupEnabled, tegileCompliances=tegileCompliances, lunTable=lunTable, projectTotalSaving=projectTotalSaving, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, spareDiskReplaced=spareDiskReplaced, controllerHardwareModel=controllerHardwareModel, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTotalReadMbps=iscsiTotalReadMbps, diskSlowIo=diskSlowIo, iscsiTargetEntry=iscsiTargetEntry, disks=disks, haResourceName=haResourceName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notificationTime=notificationTime, shareNFSWriteMbps=shareNFSWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskTotalReadIops=diskTotalReadIops, diskDataWriteIops=diskDataWriteIops, poolDataReadMbps=poolDataReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcAvgWriteLatency=fcAvgWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, diskAlias=diskAlias, fcInitiatorsTable=fcInitiatorsTable, diskTable=diskTable)
