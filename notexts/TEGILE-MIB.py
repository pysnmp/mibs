...
iso, Counter32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, IpAddress, ModuleIdentity, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", cacheTotalWriteIops=cacheTotalWriteIops, lunDataSizeLow=lunDataSizeLow, fcTotalWriteIops=fcTotalWriteIops, poolCount=poolCount, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetAuth=iscsiTargetAuth, lunProtocol=lunProtocol, memoryFailure=memoryFailure, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, diskPoolName=diskPoolName, cacheRAMReads=cacheRAMReads, targetGroupMemberAdded=targetGroupMemberAdded, shareDedupEnabled=shareDedupEnabled, projectSnapshotSizeHigh=projectSnapshotSizeHigh, currentNotificationGroup=currentNotificationGroup, poolHealth=poolHealth, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, replicationPaused=replicationPaused, diskIOCount=diskIOCount, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCIFSReadLatency=shareCIFSReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcProperties=fcProperties, deleteFolderCompleted=deleteFolderCompleted, shareCIFSReadIops=shareCIFSReadIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, PYSNMP_MODULE_ID=tegile, controllerUp=controllerUp, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceEntry=haResourceEntry, basicCompliance=basicCompliance, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeDownloadCompleted=upgradeDownloadCompleted, snmpServiceStartFailed=snmpServiceStartFailed, tegile=tegile, diskDataWriteIops=diskDataWriteIops, poolProjects=poolProjects, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetsTable=fcTargetsTable, lunReadMbps=lunReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetReadIops=fcTargetReadIops, replicationResumed=replicationResumed, snapshotCloneCompleted=snapshotCloneCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, sharePoolName=sharePoolName, haControllerA_Uptime=haControllerA_Uptime, iscsiProperties=iscsiProperties, poolQuotaFinished=poolQuotaFinished, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetGroup=iscsiTargetGroup, fcAvgReadLatency=fcAvgReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSnapshotSizeLow=lunSnapshotSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, smbSocketFailure=smbSocketFailure, smisServiceStarted=smisServiceStarted, tegileGroups=tegileGroups, notificationProps=notificationProps, haResources=haResources, shareName=shareName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetName=iscsiTargetName, poolDataReadLatency=poolDataReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectTotalSaving=projectTotalSaving, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskError=diskError, shareReservedSizeHigh=shareReservedSizeHigh, ipmiTemperature=ipmiTemperature, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicName=nicName, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareNFSWriteIops=shareNFSWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, lunEntry=lunEntry, poolImported=poolImported, ipmiCriticalInterrupt=ipmiCriticalInterrupt, network=network, nfsAvgReadLatency=nfsAvgReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, shareNFSWriteMbps=shareNFSWriteMbps, poolExported=poolExported, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectName=projectName, controllerTimeDrift=controllerTimeDrift, diskType=diskType, poolAvgWriteLatency=poolAvgWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, cpuTotalUsage=cpuTotalUsage, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskSizeLow=diskSizeLow, sensorFailureEvent=sensorFailureEvent, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunProjectName=lunProjectName, poolExpanded=poolExpanded, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, volumeDeleteFailed=volumeDeleteFailed, diskIsOnline=diskIsOnline, snapshotCloningFailed=snapshotCloningFailed, sanProperties=sanProperties, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunCompressionEnabled=lunCompressionEnabled, poolDeleted=poolDeleted, diskAvgWriteLatency=diskAvgWriteLatency, poolIndex=poolIndex, networkInterfaceUp=networkInterfaceUp, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunFreeSizeLow=lunFreeSizeLow, shareIndex=shareIndex, nicGroup=nicGroup, fcTargetReadLatency=fcTargetReadLatency, spareDiskReplaced=spareDiskReplaced, controllerDown=controllerDown, cpuSystemCalls=cpuSystemCalls, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolMetaReadLatency=poolMetaReadLatency, lunReadLatency=lunReadLatency, poolOwnerController=poolOwnerController, iscsiTargetError=iscsiTargetError, cacheTotalReadMbps=cacheTotalReadMbps, poolDataSizeLow=poolDataSizeLow, diskRandomIOCount=diskRandomIOCount, haResourceStatus=haResourceStatus, diskTotalReadMbps=diskTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, poolDataWriteMbps=poolDataWriteMbps, shareNFSReadIops=shareNFSReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, lunTable=lunTable, poolDataWriteIops=poolDataWriteIops, iscsiTargetAlias=iscsiTargetAlias, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, diskTotalWriteIops=diskTotalWriteIops, shareNFSEnabled=shareNFSEnabled, diskChassisIdx=diskChassisIdx, lunFreeSizeHigh=lunFreeSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, projectLUNs=projectLUNs, cacheTotalReadIops=cacheTotalReadIops, fcTargetGroup=fcTargetGroup, lunGUID=lunGUID, tegileCompliances=tegileCompliances, poolMetaReadIops=poolMetaReadIops, shareCompressionEnabled=shareCompressionEnabled, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationEventCode=notificationEventCode, fcPortOnline=fcPortOnline, replicationFailed=replicationFailed, projectIndex=projectIndex, projectEntry=projectEntry, projectDeletionFailed=projectDeletionFailed, poolCreated=poolCreated, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskAvgReadLatency=diskAvgReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunSizeLow=lunSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiFan=ipmiFan, networkInterfaceDown=networkInterfaceDown, lunInitiatorGroup=lunInitiatorGroup, lunIndex=lunIndex, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationSeverity=notificationSeverity, iscsiTargetEntry=iscsiTargetEntry, volumeModifyCompleted=volumeModifyCompleted, upgradeCompleted=upgradeCompleted, poolAvgReadLatency=poolAvgReadLatency, shareDataSizeLow=shareDataSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDataReadMbps=poolDataReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, projectLunCount=projectLunCount, fcTargetWriteIops=fcTargetWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, haResourceDescription=haResourceDescription, nfsTotalWriteIops=nfsTotalWriteIops, replicationStarted=replicationStarted, alertsCleanupCompleted=alertsCleanupCompleted, diskDataWriteMbps=diskDataWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceActiveNode=haResourceActiveNode, shareCIFSWriteLatency=shareCIFSWriteLatency, fcPortOffline=fcPortOffline, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haResourceGroup=haResourceGroup, notificationReadingUnit=notificationReadingUnit, poolReadCacheWriteIops=poolReadCacheWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, poolUsedSizeLow=poolUsedSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nfsTotalReadIops=nfsTotalReadIops, poolUsedSizeHigh=poolUsedSizeHigh, userLoginFailed=userLoginFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectQuotaFinished=projectQuotaFinished, ipmiCurrent=ipmiCurrent, lunName=lunName, lunWriteIops=lunWriteIops, notificationSensorNumber=notificationSensorNumber, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haResourceName=haResourceName, cacheSSDReads=cacheSSDReads, poolDataSizeHigh=poolDataSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, snapshotRollbackFailed=snapshotRollbackFailed, upgradeFailed=upgradeFailed, aclMigrationStarted=aclMigrationStarted, diskGoneOffline=diskGoneOffline, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskAlias=diskAlias, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, shareDataSizeHigh=shareDataSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, haControllerA_Name=haControllerA_Name, haControllerB_Name=haControllerB_Name, ipmiVoltage=ipmiVoltage, projectModified=projectModified, volumeQuotaFinished=volumeQuotaFinished, diskDataReadIops=diskDataReadIops, haControllerB_Uptime=haControllerB_Uptime, lunDataSizeHigh=lunDataSizeHigh, fcTotalReadIops=fcTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolReadCacheReadLatency=poolReadCacheReadLatency, poolName=poolName, cifsTotalWriteIops=cifsTotalWriteIops, projectDedupEnabled=projectDedupEnabled, projectThresholdExceedWarning=projectThresholdExceedWarning)
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSReadMbps=shareNFSReadMbps, shareEntry=shareEntry, shareCIFSEnabled=shareCIFSEnabled, aclMigrationCompleted=aclMigrationCompleted, diskEntry=diskEntry, poolFreeSizeHigh=poolFreeSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiWriteIops=iscsiWriteIops, poolEntry=poolEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationReadingTriggerValue=notificationReadingTriggerValue, poolDeletionFailed=poolDeletionFailed, disks=disks, fcInitiators=fcInitiators, diskTable=diskTable, nvdimmFailDeviceError=nvdimmFailDeviceError, snmpAgentVersion=snmpAgentVersion, fcTargetWriteMbps=fcTargetWriteMbps, haResourcesTable=haResourcesTable, smisServiceStopped=smisServiceStopped, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationComplete=replicationComplete, fcTargetIndex=fcTargetIndex, nicMTU=nicMTU, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareTable=shareTable, upgradeDownloadFailed=upgradeDownloadFailed, shareQuotaLow=shareQuotaLow, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetIndex=iscsiTargetIndex, lunSnapshotSizeHigh=lunSnapshotSizeHigh, adServerTimeDrift=adServerTimeDrift, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDegraded=poolDegraded, lunWriteMbps=lunWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, lunPoolName=lunPoolName, vmwareNFSDatastores=vmwareNFSDatastores, lunWriteLatency=lunWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolTable=poolTable, shareCIFSReadMbps=shareCIFSReadMbps, shareDeleted=shareDeleted, poolMetaReadMbps=poolMetaReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerA_IPAddr=haControllerA_IPAddr, tegileArray_notifications=tegileArray_notifications, targetGroupMemberRemoved=targetGroupMemberRemoved, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunReservedSizeHigh=lunReservedSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectPoolName=projectPoolName, projectDataSizeLow=projectDataSizeLow, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetReadMbps=iscsiTargetReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, nicIndex=nicIndex, projectSnapshotSizeLow=projectSnapshotSizeLow, ipmiOther=ipmiOther, fcTargets=fcTargets, globalStatistics=globalStatistics, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolTotalReadIops=poolTotalReadIops, upgradeStarted=upgradeStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkIpmpGroupDown=networkIpmpGroupDown, replicationAbandoned=replicationAbandoned, projectDeleted=projectDeleted, diskDataReadMbps=diskDataReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, pools=pools, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolTotalWriteIops=poolTotalWriteIops, currentObjectGroup=currentObjectGroup, poolUpgraded=poolUpgraded, nvdimmFailSoftError=nvdimmFailSoftError, nfsAvgWriteLatency=nfsAvgWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetEntry=fcTargetEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunReadIops=lunReadIops, diskCount=diskCount, poolFreeSizeLow=poolFreeSizeLow, nicReceiveMbps=nicReceiveMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectShares=projectShares, notificationTime=notificationTime, poolTotalReadMbps=poolTotalReadMbps, fcInitiatorIndex=fcInitiatorIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cifsTotalReadIops=cifsTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, testNotification=testNotification, replicationAborted=replicationAborted, snapshotRollbackCompleted=snapshotRollbackCompleted, snapshotDeleteFailed=snapshotDeleteFailed, smisServiceStartFailed=smisServiceStartFailed, nicEntry=nicEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, poolTotalSaving=poolTotalSaving, fcInitiatorName=fcInitiatorName, diskIndex=diskIndex, replicationSourceRegistered=replicationSourceRegistered, poolMetaWriteIops=poolMetaWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetWriteLatency=fcTargetWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunDedupEnabled=lunDedupEnabled, smisServiceStopFailed=smisServiceStopFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snmpServiceStopped=snmpServiceStopped, shareProjectName=shareProjectName, shareDeletionFailed=shareDeletionFailed, poolProjectCount=poolProjectCount, tegileArray=tegileArray, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerHardwareModel=controllerHardwareModel, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationSensorAction=notificationSensorAction, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationTargetEntityName=notificationTargetEntityName, snapshotCreationFailed=snapshotCreationFailed, unknownSensorEvent=unknownSensorEvent, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectTable=projectTable, poolSizeLow=poolSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nicTable=nicTable, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolSizeHigh=poolSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, ipmiPowerSupply=ipmiPowerSupply, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorName=iscsiInitiatorName, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetName=fcTargetName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunSizeHigh=lunSizeHigh, poolState=poolState, diskSizeHigh=diskSizeHigh, ipmiThreshold=ipmiThreshold, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSlowIo=diskSlowIo, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, ipmiMemory=ipmiMemory, nfsTotalReadMbps=nfsTotalReadMbps, fcInitiatorsTable=fcInitiatorsTable, projectFreeSizeHigh=projectFreeSizeHigh, nicTransmitMbps=nicTransmitMbps, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDataSizeHigh=projectDataSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, notificationObjects=notificationObjects, iscsiInitiatorGroup=iscsiInitiatorGroup, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcInitiatorGroup=fcInitiatorGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTotalReadMbps=fcTotalReadMbps, diskState=diskState, poolDataWriteLatency=poolDataWriteLatency, lunBlockSize=lunBlockSize, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiators=iscsiInitiators, notifications=notifications, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cpuInterrupts=cpuInterrupts, notificationDescription=notificationDescription, maintenanceModeDisabled=maintenanceModeDisabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskTotalReadIops=diskTotalReadIops, shareNFSReadLatency=shareNFSReadLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haResourceIndex=haResourceIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, lunReservedSizeLow=lunReservedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, shareMountPoint=shareMountPoint, deleteFolderFailed=deleteFolderFailed, tegileConformance=tegileConformance, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, notificationComponentName=notificationComponentName, properties=properties, projectCompressionEnabled=projectCompressionEnabled, nicState=nicState, upgradeTimeout=upgradeTimeout, diskSequentialIOCount=diskSequentialIOCount, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargets=iscsiTargets, shareCompressedRatio=shareCompressedRatio, cifsTotalReadMbps=cifsTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorIndex=iscsiInitiatorIndex)
