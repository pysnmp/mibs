...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:38:46 2023
...
Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter32, enterprises, Unsigned32, IpAddress, iso, Gauge32, TimeTicks, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter32", "enterprises", "Unsigned32", "IpAddress", "iso", "Gauge32", "TimeTicks", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcPortOnline=fcPortOnline, diskSequentialIOCount=diskSequentialIOCount, shareNFSWriteIops=shareNFSWriteIops, sharePoolName=sharePoolName, iscsiInitiatorEntry=iscsiInitiatorEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolDataSizeLow=poolDataSizeLow, diskRandomIOCount=diskRandomIOCount, projectDedupEnabled=projectDedupEnabled, poolUsedSizeLow=poolUsedSizeLow, basicCompliance=basicCompliance, projectTotalSaving=projectTotalSaving, disks=disks, poolOwnerController=poolOwnerController, upgradeDownloadCompleted=upgradeDownloadCompleted, cacheTotalReadMbps=cacheTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectCompressionEnabled=projectCompressionEnabled, notificationTime=notificationTime, poolReadCacheReadIops=poolReadCacheReadIops, fcTargetGroup=fcTargetGroup, poolMetaWriteMbps=poolMetaWriteMbps, poolDataReadIops=poolDataReadIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, lunWriteLatency=lunWriteLatency, nicState=nicState, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTotalReadMbps=fcTotalReadMbps, poolDegraded=poolDegraded, lunDataSizeLow=lunDataSizeLow, controllerUp=controllerUp, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDataWriteMbps=poolDataWriteMbps, unknownSensorEvent=unknownSensorEvent, poolDataSizeHigh=poolDataSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, fcTotalWriteIops=fcTotalWriteIops, lunReservedSizeLow=lunReservedSizeLow, fcTargetStatus=fcTargetStatus, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolName=poolName, lunDedupEnabled=lunDedupEnabled, maintenanceModeEnabled=maintenanceModeEnabled, smisServiceStopFailed=smisServiceStopFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskState=diskState, lunWriteMbps=lunWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, ipmiThreshold=ipmiThreshold, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceEntry=haResourceEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareCompressedRatio=shareCompressedRatio, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCIFSReadIops=shareCIFSReadIops, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskCount=diskCount, sanProperties=sanProperties, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, webdocsUpgradeFailed=webdocsUpgradeFailed, networkInterfaceUp=networkInterfaceUp, projectName=projectName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareDeletionFailed=shareDeletionFailed, controllerHardwareModel=controllerHardwareModel, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalReadIops=poolTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, diskEntry=diskEntry, shareNFSWriteLatency=shareNFSWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDeleted=poolDeleted, cacheTotalReadIops=cacheTotalReadIops, nicTable=nicTable, projectPoolName=projectPoolName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, upgradeFailed=upgradeFailed, fcProperties=fcProperties, shareQuotaHigh=shareQuotaHigh, poolQuotaFinished=poolQuotaFinished, aclMigrationStarted=aclMigrationStarted, shareExceedThresholdWarning=shareExceedThresholdWarning, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, poolDataReadMbps=poolDataReadMbps, iscsiTargetName=iscsiTargetName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskTable=diskTable, fcTargetsTable=fcTargetsTable, haControllerA_Uptime=haControllerA_Uptime, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskSizeLow=diskSizeLow, replicationFailed=replicationFailed, lunBlockSize=lunBlockSize, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationProps=notificationProps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, upgradeStarted=upgradeStarted, notificationSeverity=notificationSeverity, volumeDeleteFailed=volumeDeleteFailed, replicationTargetDeleted=replicationTargetDeleted, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareCIFSWriteMbps=shareCIFSWriteMbps, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, projectShareCount=projectShareCount, fcTargetIndex=fcTargetIndex, notificationComponentName=notificationComponentName, nicIndex=nicIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, diskSlowIo=diskSlowIo, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareNFSReadIops=shareNFSReadIops, diskTotalReadMbps=diskTotalReadMbps, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectFreeSizeHigh=projectFreeSizeHigh, diskDataWriteMbps=diskDataWriteMbps, cpuTotalUsage=cpuTotalUsage, userLoginFailed=userLoginFailed, diskIndex=diskIndex, poolSizeLow=poolSizeLow, shareDedupEnabled=shareDedupEnabled, fcInitiatorsTable=fcInitiatorsTable, notificationReadingTriggerValue=notificationReadingTriggerValue, cifsTotalWriteMbps=cifsTotalWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, shareNFSReadMbps=shareNFSReadMbps, diskIOCount=diskIOCount, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorEntry=fcInitiatorEntry, snapshotCloningFailed=snapshotCloningFailed, diskChassisIdx=diskChassisIdx, poolDeletionFailed=poolDeletionFailed, iscsiTargetAlias=iscsiTargetAlias, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcInitiatorName=fcInitiatorName, shareCIFSReadLatency=shareCIFSReadLatency, poolExported=poolExported, projectTable=projectTable, notificationObjects=notificationObjects, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetIndex=iscsiTargetIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectQuotaSizeLow=projectQuotaSizeLow, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolDataWriteLatency=poolDataWriteLatency, lunPoolName=lunPoolName, sensorFailureEvent=sensorFailureEvent, iscsiTargetError=iscsiTargetError, targetGroupMemberAdded=targetGroupMemberAdded, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, poolMetaReadMbps=poolMetaReadMbps, haResourcesTable=haResourcesTable, poolTable=poolTable, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, properties=properties, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareTable=shareTable, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, testNotification=testNotification, nicMTU=nicMTU, cpuSystemCalls=cpuSystemCalls, ipmiVoltage=ipmiVoltage, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceIndex=haResourceIndex, haResourceGroup=haResourceGroup, shareDeleted=shareDeleted, memoryFailure=memoryFailure, shareQuotaFinished=shareQuotaFinished, notificationSensorAction=notificationSensorAction, iscsiTargetEntry=iscsiTargetEntry, lunReadMbps=lunReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationReadingUnit=notificationReadingUnit, projectDataSizeHigh=projectDataSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, poolCount=poolCount, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, snmpAgentVersion=snmpAgentVersion, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nfsAvgWriteLatency=nfsAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationPaused=replicationPaused, shareName=shareName, fcAvgWriteLatency=fcAvgWriteLatency, lunCompressionEnabled=lunCompressionEnabled, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haResourceName=haResourceName, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCompressionEnabled=shareCompressionEnabled, snapshotRollbackFailed=snapshotRollbackFailed, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, projectQuotaFinished=projectQuotaFinished, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetsTable=iscsiTargetsTable, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationEventCode=notificationEventCode, poolState=poolState, projectQuotaSizeHigh=projectQuotaSizeHigh, nicEntry=nicEntry, snmpServiceStopped=snmpServiceStopped, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolEntry=poolEntry, tegileArray=tegileArray, replicationAborted=replicationAborted, nfsTotalReadIops=nfsTotalReadIops, poolMetaWriteIops=poolMetaWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceActiveNode=haResourceActiveNode, projectDeletionFailed=projectDeletionFailed, diskAvgReadLatency=diskAvgReadLatency, ipmiCurrent=ipmiCurrent, cifsTotalReadIops=cifsTotalReadIops, fcTargetEntry=fcTargetEntry, upgradeDownloadStarted=upgradeDownloadStarted, poolProjectCount=poolProjectCount, poolExpanded=poolExpanded, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolProjects=poolProjects, iscsiInitiators=iscsiInitiators, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, replicationSourceRegistered=replicationSourceRegistered, cacheSSDReads=cacheSSDReads, iscsiTargets=iscsiTargets, haControllerB_Name=haControllerB_Name)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalReadMbps=cifsTotalReadMbps, nicGroup=nicGroup, adServerTimeDrift=adServerTimeDrift, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, lunName=lunName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, alertsCleanupCompleted=alertsCleanupCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiators=fcInitiators, lunEntry=lunEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, fcPortOffline=fcPortOffline, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaReadIops=poolMetaReadIops, shareNFSReadLatency=shareNFSReadLatency, projectModified=projectModified, deleteFolderCompleted=deleteFolderCompleted, volumeModifyCompleted=volumeModifyCompleted, shareCIFSReadMbps=shareCIFSReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkInterfaceDown=networkInterfaceDown, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, smisServiceStopped=smisServiceStopped, lunGUID=lunGUID, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareDataSizeLow=shareDataSizeLow, notificationDescription=notificationDescription, shareIndex=shareIndex, volumeQuotaFinished=volumeQuotaFinished, diskSizeHigh=diskSizeHigh, fcTargets=fcTargets, upgradeDownloadFailed=upgradeDownloadFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunFreeSizeHigh=lunFreeSizeHigh, shareReservedSizeLow=shareReservedSizeLow, ipmiMemory=ipmiMemory, iscsiWriteIops=iscsiWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskIsOnline=diskIsOnline, lunSizeHigh=lunSizeHigh, shareEntry=shareEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheTotalWriteIops=cacheTotalWriteIops, diskTotalWriteIops=diskTotalWriteIops, diskGoneOffline=diskGoneOffline, fcTargetWriteIops=fcTargetWriteIops, poolTotalReadMbps=poolTotalReadMbps, smisServiceStartFailed=smisServiceStartFailed, projectLunCount=projectLunCount, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationResumed=replicationResumed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicReceiveMbps=nicReceiveMbps, lunProjectName=lunProjectName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetName=fcTargetName, currentObjectGroup=currentObjectGroup, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, lunTable=lunTable, lunReadIops=lunReadIops, cifsTotalWriteIops=cifsTotalWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, projectDeleted=projectDeleted, ipmiTemperature=ipmiTemperature, lunCompressedRatio=lunCompressedRatio, fcTargetModifyCompleted=fcTargetModifyCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, shareMountPoint=shareMountPoint, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectEntry=projectEntry, nvdimmFailInitializationError=nvdimmFailInitializationError, poolAvgReadLatency=poolAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, PYSNMP_MODULE_ID=tegile, tegileConformance=tegileConformance, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskError=diskError, projectShares=projectShares, diskType=diskType, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, replicationStarted=replicationStarted, lunIndex=lunIndex, projectLUNs=projectLUNs, diskTotalWriteMbps=diskTotalWriteMbps, lunFreeSizeLow=lunFreeSizeLow, poolDataReadLatency=poolDataReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiFan=ipmiFan, ipmiOther=ipmiOther, haResourceDescription=haResourceDescription, maintenanceModeDisabled=maintenanceModeDisabled, upgradeTimeout=upgradeTimeout, spareDiskReplaced=spareDiskReplaced, diskPoolName=diskPoolName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareQuotaLow=shareQuotaLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcInitiatorIndex=fcInitiatorIndex, lunReadLatency=lunReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorName=iscsiInitiatorName, poolCreated=poolCreated, poolTotalWriteMbps=poolTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetAuth=iscsiTargetAuth, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskDataReadIops=diskDataReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, snmpServiceStarted=snmpServiceStarted, smbSocketFailure=smbSocketFailure, diskAlias=diskAlias, controllerTimeDrift=controllerTimeDrift, notificationSensorSuspect=notificationSensorSuspect, deleteFolderFailed=deleteFolderFailed, fcTargetWriteLatency=fcTargetWriteLatency, notifications=notifications, poolTotalSaving=poolTotalSaving, shareCIFSEnabled=shareCIFSEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSizeLow=lunSizeLow, lunProtocol=lunProtocol, nicTransmitMbps=nicTransmitMbps, netbiosSocketFailure=netbiosSocketFailure, poolDataWriteIops=poolDataWriteIops, globalStatistics=globalStatistics, poolImported=poolImported, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haControllerA_Name=haControllerA_Name, projectSnapshotSizeLow=projectSnapshotSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, haControllerB_IPAddr=haControllerB_IPAddr, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, aclMigrationCompleted=aclMigrationCompleted, diskDataWriteIops=diskDataWriteIops, shareProjectName=shareProjectName, snmpServiceStartFailed=snmpServiceStartFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolHealth=poolHealth, cacheRAMReads=cacheRAMReads, networkIpmpGroupUp=networkIpmpGroupUp, projectDataSizeLow=projectDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, tegileArray_notifications=tegileArray_notifications, controllerDown=controllerDown, tegileCompliances=tegileCompliances, intelliFlashSoftwareUp=intelliFlashSoftwareUp, pools=pools, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectIndex=projectIndex, haResources=haResources, projectCreatedSuccessfully=projectCreatedSuccessfully, poolTotalWriteIops=poolTotalWriteIops, diskDataReadMbps=diskDataReadMbps, notificationSensorNumber=notificationSensorNumber, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTotalReadIops=fcTotalReadIops, networkIpmpGroupDown=networkIpmpGroupDown, haResourceStatus=haResourceStatus, haControllerA_IPAddr=haControllerA_IPAddr, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerB_Uptime=haControllerB_Uptime, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareNFSEnabled=shareNFSEnabled, poolUpgraded=poolUpgraded, poolFreeSizeLow=poolFreeSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetReadIops=fcTargetReadIops, nfsTotalReadMbps=nfsTotalReadMbps, replicationComplete=replicationComplete, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiProperties=iscsiProperties, tegileGroups=tegileGroups, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cpuInterrupts=cpuInterrupts, shareDataSizeHigh=shareDataSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, network=network, shareCIFSWriteLatency=shareCIFSWriteLatency, poolSizeHigh=poolSizeHigh, poolIndex=poolIndex, nicName=nicName, tegile=tegile, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, upgradeCompleted=upgradeCompleted, lunWriteIops=lunWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, replicationAbandoned=replicationAbandoned, lunSnapshotSizeHigh=lunSnapshotSizeHigh)
