...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:12:58 2022
...
Integer32, TimeTicks, enterprises, ObjectIdentity, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress, ModuleIdentity, Gauge32, MibIdentifier, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "enterprises", "ObjectIdentity", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress", "ModuleIdentity", "Gauge32", "MibIdentifier", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorGroup=fcInitiatorGroup, diskTotalReadMbps=diskTotalReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolState=poolState, volumeModifyCompleted=volumeModifyCompleted, poolDataReadLatency=poolDataReadLatency, poolUpgraded=poolUpgraded, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectDedupEnabled=projectDedupEnabled, poolOwnerController=poolOwnerController, haControllerA_Uptime=haControllerA_Uptime, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetIndex=iscsiTargetIndex, diskAvgReadLatency=diskAvgReadLatency, upgradeDownloadStarted=upgradeDownloadStarted, lunCompressionEnabled=lunCompressionEnabled, shareCIFSReadMbps=shareCIFSReadMbps, projectLUNs=projectLUNs, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetReadIops=fcTargetReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tegileArray=tegileArray, notificationSensorAction=notificationSensorAction, iscsiInitiatorChapUser=iscsiInitiatorChapUser, sharePoolName=sharePoolName, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, fcAvgReadLatency=fcAvgReadLatency, diskIsOnline=diskIsOnline, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolSizeLow=poolSizeLow, lunReadMbps=lunReadMbps, projectDeletionFailed=projectDeletionFailed, poolDataWriteLatency=poolDataWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskDataReadIops=diskDataReadIops, iscsiTargetAuth=iscsiTargetAuth, userLoginFailed=userLoginFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolImported=poolImported, poolDataReadIops=poolDataReadIops, lunProtocol=lunProtocol, cacheSSDReads=cacheSSDReads, tegileCompliances=tegileCompliances, smisServiceStarted=smisServiceStarted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiMemory=ipmiMemory, projectIndex=projectIndex, shareIndex=shareIndex, deleteFolderFailed=deleteFolderFailed, lunReadIops=lunReadIops, poolAvgReadLatency=poolAvgReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, tegileGroups=tegileGroups, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadIops=poolMetaReadIops, diskAvgWriteLatency=diskAvgWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastores=vmwareNFSDatastores, targetGroupMemberRemoved=targetGroupMemberRemoved, projectTotalSaving=projectTotalSaving, shareProjectName=shareProjectName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolProjectCount=poolProjectCount, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haResourceStatus=haResourceStatus, lunTable=lunTable, iscsiTargetReadLatency=iscsiTargetReadLatency, fcPortOnline=fcPortOnline, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiProperties=iscsiProperties, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetReadLatency=fcTargetReadLatency, iscsiTotalReadIops=iscsiTotalReadIops, nfsTotalWriteMbps=nfsTotalWriteMbps, lunBlockSize=lunBlockSize, volumeQuotaFinished=volumeQuotaFinished, poolCreated=poolCreated, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ipmiTemperature=ipmiTemperature, lunWriteMbps=lunWriteMbps, controllerHardwareModel=controllerHardwareModel, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTotalReadIops=poolTotalReadIops, projectTable=projectTable, volumeDeleteFailed=volumeDeleteFailed, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheReadIops=poolReadCacheReadIops, pools=pools, poolMetaReadMbps=poolMetaReadMbps, diskSizeLow=diskSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, fcTargetWriteIops=fcTargetWriteIops, fcTargetStatus=fcTargetStatus, nfsAvgReadLatency=nfsAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationSourceRegistered=replicationSourceRegistered, haResourceName=haResourceName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectQuotaFinished=projectQuotaFinished, diskAlias=diskAlias, notificationComponentName=notificationComponentName, poolMetaWriteLatency=poolMetaWriteLatency, testNotification=testNotification, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackFailed=snapshotRollbackFailed, snmpServiceStarted=snmpServiceStarted, currentObjectGroup=currentObjectGroup, projectLunCount=projectLunCount, iscsiTargetAlias=iscsiTargetAlias, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetEntry=iscsiTargetEntry, shareNFSReadMbps=shareNFSReadMbps, poolDataSizeHigh=poolDataSizeHigh, haResourceIndex=haResourceIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, controllerTimeDrift=controllerTimeDrift, fcInitiators=fcInitiators, diskCount=diskCount, projectDataSizeLow=projectDataSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, smisServiceStopped=smisServiceStopped, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, shareDeleted=shareDeleted, lunFreeSizeHigh=lunFreeSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, diskState=diskState, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, snmpServiceStopFailed=snmpServiceStopFailed, nvdimmFailSoftError=nvdimmFailSoftError, fcTotalWriteIops=fcTotalWriteIops, lunWriteLatency=lunWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, sensorFailureEvent=sensorFailureEvent, snapshotCreationFailed=snapshotCreationFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectName=projectName, shareQuotaLow=shareQuotaLow, upgradeFailed=upgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeStarted=upgradeStarted, shareDeletionFailed=shareDeletionFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, lunCompressedRatio=lunCompressedRatio, lunWriteIops=lunWriteIops, netbiosSocketFailure=netbiosSocketFailure, replicationAbandoned=replicationAbandoned, poolQuotaFinished=poolQuotaFinished, projectShares=projectShares, shareReservedSizeLow=shareReservedSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectModified=projectModified, shareCIFSWriteLatency=shareCIFSWriteLatency, globalStatistics=globalStatistics, snmpServiceStopped=snmpServiceStopped, fcInitiatorIndex=fcInitiatorIndex, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, smbSocketFailure=smbSocketFailure, diskRandomIOCount=diskRandomIOCount, shareCompressedRatio=shareCompressedRatio, diskTotalWriteIops=diskTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicIndex=nicIndex, diskEntry=diskEntry, cifsAvgReadLatency=cifsAvgReadLatency, projectCompressionEnabled=projectCompressionEnabled, fcTargetName=fcTargetName, iscsiTargetError=iscsiTargetError, projectSnapshotSizeLow=projectSnapshotSizeLow, cacheTotalReadIops=cacheTotalReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiators=iscsiInitiators, notificationReadingUnit=notificationReadingUnit, poolTable=poolTable, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nicReceiveMbps=nicReceiveMbps, lunTargetGroup=lunTargetGroup, shareCIFSReadLatency=shareCIFSReadLatency, ntpServerTimeDrift=ntpServerTimeDrift, diskDataWriteMbps=diskDataWriteMbps, shareCIFSReadIops=shareCIFSReadIops, notificationSeverity=notificationSeverity, targetGroupMemberAdded=targetGroupMemberAdded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationEventCode=notificationEventCode, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareQuotaFinished=shareQuotaFinished, maintenanceModeEnabled=maintenanceModeEnabled, poolReadCacheWriteLatency=poolReadCacheWriteLatency, memoryFailure=memoryFailure, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskTable=diskTable, diskType=diskType, notificationTargetEntityName=notificationTargetEntityName, projectQuotaSizeHigh=projectQuotaSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolReadCacheReadLatency=poolReadCacheReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, nicState=nicState, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, smisServiceStartFailed=smisServiceStartFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, lunFreeSizeLow=lunFreeSizeLow, replicationAborted=replicationAborted, targetGroupCreateCompleted=targetGroupCreateCompleted, poolDeletionFailed=poolDeletionFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolTotalWriteMbps=poolTotalWriteMbps, diskGoneOffline=diskGoneOffline, diskIndex=diskIndex, diskSequentialIOCount=diskSequentialIOCount, fcTargetReadMbps=fcTargetReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, snapshotCloningFailed=snapshotCloningFailed, tegile=tegile, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicName=nicName, currentNotificationGroup=currentNotificationGroup, alertsCleanupCompleted=alertsCleanupCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiOther=ipmiOther, iscsiTargetWriteIops=iscsiTargetWriteIops, diskPoolName=diskPoolName, cifsTotalWriteMbps=cifsTotalWriteMbps, diskDataWriteIops=diskDataWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, lunDataSizeLow=lunDataSizeLow, aclMigrationCompleted=aclMigrationCompleted, fcProperties=fcProperties, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargets=fcTargets, cpuTotalUsage=cpuTotalUsage, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nicMTU=nicMTU, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunPoolName=lunPoolName, lunInitiatorGroup=lunInitiatorGroup, fcTargetGroup=fcTargetGroup, deleteFolderCompleted=deleteFolderCompleted, shareQuotaHigh=shareQuotaHigh, haResourcesTable=haResourcesTable, nfsTotalReadIops=nfsTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nicEntry=nicEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareTable=shareTable, controllerUp=controllerUp, ipmiCurrent=ipmiCurrent, projectSnapshotSizeHigh=projectSnapshotSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolTotalReadMbps=poolTotalReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, haControllerA_Name=haControllerA_Name, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareName=shareName, notifications=notifications, nicTable=nicTable, projectFreeSizeLow=projectFreeSizeLow, poolMetaReadLatency=poolMetaReadLatency, lunName=lunName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareDataSizeHigh=shareDataSizeHigh, fcTotalReadIops=fcTotalReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSWriteIops=shareNFSWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolFreeSizeLow=poolFreeSizeLow, notificationTime=notificationTime, poolDeleted=poolDeleted, lunSizeLow=lunSizeLow, upgradeCompleted=upgradeCompleted, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetGroup=iscsiTargetGroup, networkInterfaceDown=networkInterfaceDown, PYSNMP_MODULE_ID=tegile, fcInitiatorEntry=fcInitiatorEntry, iscsiTargetsTable=iscsiTargetsTable, poolTotalSaving=poolTotalSaving, lunEntry=lunEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationPaused=replicationPaused, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorName=iscsiInitiatorName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiInitiatorEntry=iscsiInitiatorEntry, diskError=diskError, iscsiTargets=iscsiTargets, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cacheRAMReads=cacheRAMReads, iscsiTargetName=iscsiTargetName, nfsAvgWriteLatency=nfsAvgWriteLatency, lunIndex=lunIndex, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunDedupEnabled=lunDedupEnabled, diskChassisIdx=diskChassisIdx, haResources=haResources, poolUsedSizeLow=poolUsedSizeLow, unknownSensorEvent=unknownSensorEvent, aclMigrationStarted=aclMigrationStarted, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nvdimmFailInitializationError=nvdimmFailInitializationError, controllerDown=controllerDown, nfsTotalReadMbps=nfsTotalReadMbps, poolDataReadMbps=poolDataReadMbps, notificationSensorSuspect=notificationSensorSuspect, shareDataSizeLow=shareDataSizeLow, notificationDescription=notificationDescription, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetIndex=fcTargetIndex, replicationResumed=replicationResumed, haResourceDescription=haResourceDescription, cpuInterrupts=cpuInterrupts, notificationSensorNumber=notificationSensorNumber, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunProjectName=lunProjectName, projectCreatedSuccessfully=projectCreatedSuccessfully, diskSlowIo=diskSlowIo, disks=disks, iscsiWriteIops=iscsiWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snapshotDeleteFailed=snapshotDeleteFailed, tegileArray_notifications=tegileArray_notifications, lunSnapshotSizeLow=lunSnapshotSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, shareNFSReadLatency=shareNFSReadLatency, haControllerB_Uptime=haControllerB_Uptime, haControllerB_Name=haControllerB_Name, iscsiTargetWriteMbps=iscsiTargetWriteMbps, tegileConformance=tegileConformance, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiPowerSupply=ipmiPowerSupply, fcPortOffline=fcPortOffline, ipmiFan=ipmiFan, haResourceEntry=haResourceEntry, poolUsedSizeHigh=poolUsedSizeHigh, projectShareCount=projectShareCount, poolExported=poolExported, replicationFailed=replicationFailed, notificationObjects=notificationObjects, poolEntry=poolEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationProps=notificationProps, fcInitiatorsTable=fcInitiatorsTable, fcInitiatorName=fcInitiatorName, shareCompressionEnabled=shareCompressionEnabled, shareEntry=shareEntry, replicationStarted=replicationStarted, poolCount=poolCount, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolTotalWriteIops=poolTotalWriteIops, shareDedupEnabled=shareDedupEnabled, lunReadLatency=lunReadLatency, projectPoolName=projectPoolName, cifsTotalReadMbps=cifsTotalReadMbps, shareMountPoint=shareMountPoint, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, properties=properties, diskIOCount=diskIOCount, basicCompliance=basicCompliance, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolHealth=poolHealth, nfsTotalWriteIops=nfsTotalWriteIops, lunDataSizeHigh=lunDataSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, network=network, cacheTotalReadMbps=cacheTotalReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, poolName=poolName, fcTargetEntry=fcTargetEntry, replicationComplete=replicationComplete, diskSizeHigh=diskSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSReadIops=shareNFSReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, sanProperties=sanProperties, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskDataReadMbps=diskDataReadMbps, snmpAgentVersion=snmpAgentVersion, projectDeleted=projectDeleted, diskTotalReadIops=diskTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, iscsiAvgReadLatency=iscsiAvgReadLatency, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolExpanded=poolExpanded, poolDegraded=poolDegraded, nvdimmFailUnknownError=nvdimmFailUnknownError, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolSizeHigh=poolSizeHigh, haResourceGroup=haResourceGroup, lunGUID=lunGUID, lunSizeHigh=lunSizeHigh, poolDataSizeLow=poolDataSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectDataSizeHigh=projectDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiThreshold=ipmiThreshold, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haControllerB_IPAddr=haControllerB_IPAddr, poolDataWriteIops=poolDataWriteIops, haResourceActiveNode=haResourceActiveNode, shareNFSEnabled=shareNFSEnabled, poolProjects=poolProjects, fcTargetsTable=fcTargetsTable, nicGroup=nicGroup, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolIndex=poolIndex, projectEntry=projectEntry, ipmiVoltage=ipmiVoltage, nicTransmitMbps=nicTransmitMbps, lunReservedSizeLow=lunReservedSizeLow)
