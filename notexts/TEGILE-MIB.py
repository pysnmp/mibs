...
Gauge32, Counter64, Integer32, ObjectIdentity, enterprises, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Unsigned32, NotificationType, MibIdentifier, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Integer32", "ObjectIdentity", "enterprises", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiProperties=iscsiProperties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, volumeDeleteFailed=volumeDeleteFailed, poolDataSizeHigh=poolDataSizeHigh, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationStarted=replicationStarted, lunName=lunName, network=network, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcPortOffline=fcPortOffline, networkIpmpGroupDown=networkIpmpGroupDown, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicTable=nicTable, targetGroupCreateCompleted=targetGroupCreateCompleted, userLoginFailed=userLoginFailed, lunReservedSizeLow=lunReservedSizeLow, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, ipmiTemperature=ipmiTemperature, iscsiTotalWriteMbps=iscsiTotalWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargets=iscsiTargets, shareEntry=shareEntry, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetIndex=fcTargetIndex, fcInitiators=fcInitiators, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nfsTotalReadIops=nfsTotalReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, replicationComplete=replicationComplete, smbSocketFailure=smbSocketFailure, diskSizeHigh=diskSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolEntry=poolEntry, maintenanceModeDisabled=maintenanceModeDisabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolOwnerController=poolOwnerController, replicationAbandoned=replicationAbandoned, fcTargetEntry=fcTargetEntry, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, haControllerB_IPAddr=haControllerB_IPAddr, poolName=poolName, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorGroup=fcInitiatorGroup, poolUsedSizeLow=poolUsedSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcAvgReadLatency=fcAvgReadLatency, iscsiWriteIops=iscsiWriteIops, poolDataReadLatency=poolDataReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationObjects=notificationObjects, shareReservedSizeHigh=shareReservedSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolProjectCount=poolProjectCount, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, cacheTotalReadMbps=cacheTotalReadMbps, lunProtocol=lunProtocol, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectQuotaFinished=projectQuotaFinished, volumeModifyCompleted=volumeModifyCompleted, poolCreated=poolCreated, shareNFSEnabled=shareNFSEnabled, snapshotRollbackFailed=snapshotRollbackFailed, haControllerA_IPAddr=haControllerA_IPAddr, haResourceName=haResourceName, memoryFailure=memoryFailure, smisServiceStartFailed=smisServiceStartFailed, shareDataSizeLow=shareDataSizeLow, cacheTotalReadIops=cacheTotalReadIops, shareTable=shareTable, lunSizeHigh=lunSizeHigh, upgradeFailed=upgradeFailed, notificationComponentName=notificationComponentName, diskAvgWriteLatency=diskAvgWriteLatency, sensorFailureEvent=sensorFailureEvent, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nfsTotalWriteIops=nfsTotalWriteIops, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetsTable=iscsiTargetsTable, poolMetaWriteLatency=poolMetaWriteLatency, diskRandomIOCount=diskRandomIOCount, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationResumed=replicationResumed, shareCreatedSuccessfully=shareCreatedSuccessfully, ntpServerTimeDrift=ntpServerTimeDrift, poolAvgWriteLatency=poolAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, diskTotalReadMbps=diskTotalReadMbps, replicationFailed=replicationFailed, diskDataWriteMbps=diskDataWriteMbps, notifications=notifications, diskType=diskType, shareQuotaLow=shareQuotaLow, cifsTotalWriteIops=cifsTotalWriteIops, lunReadIops=lunReadIops, unknownSensorEvent=unknownSensorEvent, projectName=projectName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalWriteIops=poolTotalWriteIops, projectShareCount=projectShareCount, poolHealth=poolHealth, deleteFolderFailed=deleteFolderFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicIndex=nicIndex, testNotification=testNotification, targetGroupMemberRemoved=targetGroupMemberRemoved, sharePoolName=sharePoolName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerA_Name=haControllerA_Name, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, ipmiOther=ipmiOther, cpuSystemCalls=cpuSystemCalls, iscsiInitiatorEntry=iscsiInitiatorEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationSensorNumber=notificationSensorNumber, networkIpmpGroupUp=networkIpmpGroupUp, netbiosSocketFailure=netbiosSocketFailure, iscsiTotalReadIops=iscsiTotalReadIops, poolDataWriteIops=poolDataWriteIops, cpuInterrupts=cpuInterrupts, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectLunCount=projectLunCount, haResourceEntry=haResourceEntry, diagnosticDataUploaded=diagnosticDataUploaded, diskIsOnline=diskIsOnline, disks=disks, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskAvgReadLatency=diskAvgReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolTotalReadMbps=poolTotalReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, globalStatistics=globalStatistics, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskState=diskState, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, controllerUp=controllerUp, shareMountPoint=shareMountPoint, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, replicationAborted=replicationAborted, poolAvgReadLatency=poolAvgReadLatency, shareDeleted=shareDeleted, poolDataReadIops=poolDataReadIops, deleteFolderCompleted=deleteFolderCompleted, projectPoolName=projectPoolName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolMetaWriteIops=poolMetaWriteIops, notificationProps=notificationProps, projectFreeSizeHigh=projectFreeSizeHigh, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetError=iscsiTargetError, haResources=haResources, nvdimmFailSoftError=nvdimmFailSoftError, shareCompressionEnabled=shareCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskSlowIo=diskSlowIo, notificationDescription=notificationDescription, projectEntry=projectEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetReadLatency=fcTargetReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, haResourcesTable=haResourcesTable, shareIndex=shareIndex, projectModified=projectModified, diskDataWriteIops=diskDataWriteIops, lunReadMbps=lunReadMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationSeverity=notificationSeverity, projectShares=projectShares, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataReadMbps=poolDataReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectTotalSaving=projectTotalSaving, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetGroupError=iscsiTargetGroupError, haResourceIndex=haResourceIndex, sanProperties=sanProperties, iscsiInitiators=iscsiInitiators, ipmiThreshold=ipmiThreshold, shareDataSizeHigh=shareDataSizeHigh, diskIOCount=diskIOCount, tegileGroups=tegileGroups, diskError=diskError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, ipmiPowerSupply=ipmiPowerSupply, poolDegraded=poolDegraded, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargets=fcTargets, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetReadIops=fcTargetReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceStatus=haResourceStatus, tegileArray_notifications=tegileArray_notifications, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, replicationSourceRegistered=replicationSourceRegistered, notificationReadingUnit=notificationReadingUnit, diskTable=diskTable, cacheSSDReads=cacheSSDReads, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolProjects=poolProjects, lunWriteIops=lunWriteIops, projectFreeSizeLow=projectFreeSizeLow, poolIndex=poolIndex, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, spareDiskReplaced=spareDiskReplaced, iscsiTargetGroup=iscsiTargetGroup, diskDataReadMbps=diskDataReadMbps, fcTotalReadMbps=fcTotalReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, projectDeleted=projectDeleted, shareDedupEnabled=shareDedupEnabled, shareName=shareName, aclMigrationCompleted=aclMigrationCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded)
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaHigh=shareQuotaHigh, iscsiTargetIndex=iscsiTargetIndex, poolQuotaFinished=poolQuotaFinished, lunProjectName=lunProjectName, lunIndex=lunIndex, upgradeTimeout=upgradeTimeout, nicState=nicState, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, notificationSensorAction=notificationSensorAction, diskGoneOffline=diskGoneOffline, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, upgradeDownloadFailed=upgradeDownloadFailed, poolTotalReadIops=poolTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectTable=projectTable, poolReadCacheReadMbps=poolReadCacheReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, diskEntry=diskEntry, haControllerB_Uptime=haControllerB_Uptime, smisServiceStarted=smisServiceStarted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareSnapshotSizeLow=shareSnapshotSizeLow, diskSequentialIOCount=diskSequentialIOCount, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetName=fcTargetName, fcProperties=fcProperties, diskTotalReadIops=diskTotalReadIops, poolMetaReadMbps=poolMetaReadMbps, fcPortOnline=fcPortOnline, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolState=poolState, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationSensorSuspect=notificationSensorSuspect, shareCIFSReadIops=shareCIFSReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolReadCacheWriteIops=poolReadCacheWriteIops, poolImported=poolImported, poolCount=poolCount, snapshotCreationFailed=snapshotCreationFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, poolExported=poolExported, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceDescription=haResourceDescription, aclMigrationStarted=aclMigrationStarted, lunWriteMbps=lunWriteMbps, shareProjectName=shareProjectName, snmpServiceStopped=snmpServiceStopped, shareNFSWriteIops=shareNFSWriteIops, snapshotCloningFailed=snapshotCloningFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, poolFreeSizeLow=poolFreeSizeLow, tegileCompliances=tegileCompliances, lunReadLatency=lunReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicName=nicName, fcTargetGroup=fcTargetGroup, nicGroup=nicGroup, iscsiTargetName=iscsiTargetName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetWriteIops=fcTargetWriteIops, lunSizeLow=lunSizeLow, pools=pools, fcInitiatorsTable=fcInitiatorsTable, shareNFSWriteMbps=shareNFSWriteMbps, poolExpanded=poolExpanded, projectCompressionEnabled=projectCompressionEnabled, replicationPaused=replicationPaused, diskPoolName=diskPoolName, ipmiMemory=ipmiMemory, fcTargetsTable=fcTargetsTable, projectIndex=projectIndex, snmpAgentVersion=snmpAgentVersion, shareReservedSizeLow=shareReservedSizeLow, nicEntry=nicEntry, snapshotCloneCompleted=snapshotCloneCompleted, volumeQuotaFinished=volumeQuotaFinished, smisServiceStopped=smisServiceStopped, poolSizeHigh=poolSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, upgradeCompleted=upgradeCompleted, shareDeletionFailed=shareDeletionFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, poolFreeSizeHigh=poolFreeSizeHigh, projectDedupEnabled=projectDedupEnabled, basicCompliance=basicCompliance, shareCIFSEnabled=shareCIFSEnabled, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolSizeLow=poolSizeLow, PYSNMP_MODULE_ID=tegile, adServerTimeDrift=adServerTimeDrift, ipmiCurrent=ipmiCurrent, notificationTime=notificationTime, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectQuotaSizeLow=projectQuotaSizeLow, diskAlias=diskAlias, lunTable=lunTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSReadLatency=shareNFSReadLatency, poolDeletionFailed=poolDeletionFailed, networkInterfaceDown=networkInterfaceDown, cpuTotalUsage=cpuTotalUsage, lunGUID=lunGUID, cifsAvgWriteLatency=cifsAvgWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheRAMReads=cacheRAMReads, tegileConformance=tegileConformance, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, lunDedupEnabled=lunDedupEnabled, lunCompressedRatio=lunCompressedRatio, poolUpgraded=poolUpgraded, cifsTotalReadIops=cifsTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, lunWriteLatency=lunWriteLatency, properties=properties, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareNFSWriteLatency=shareNFSWriteLatency, shareNFSReadIops=shareNFSReadIops, poolMetaReadIops=poolMetaReadIops, iscsiInitiatorName=iscsiInitiatorName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolDeleted=poolDeleted, shareCompressedRatio=shareCompressedRatio, lunEntry=lunEntry, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, controllerDown=controllerDown, projectDataSizeLow=projectDataSizeLow, lunFreeSizeLow=lunFreeSizeLow, controllerHardwareModel=controllerHardwareModel, poolTable=poolTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTotalReadIops=fcTotalReadIops, haResourceActiveNode=haResourceActiveNode, shareQuotaFinished=shareQuotaFinished, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cifsTotalWriteMbps=cifsTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, ipmiFan=ipmiFan, poolTotalWriteMbps=poolTotalWriteMbps, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nicMTU=nicMTU, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcInitiatorEntry=fcInitiatorEntry, diskDataReadIops=diskDataReadIops, iscsiTargetAuth=iscsiTargetAuth, haControllerB_Name=haControllerB_Name, nfsTotalWriteMbps=nfsTotalWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tegileArray=tegileArray, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcTargetStatus=fcTargetStatus, projectDataSizeHigh=projectDataSizeHigh, upgradeStarted=upgradeStarted, cacheTotalWriteMbps=cacheTotalWriteMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunBlockSize=lunBlockSize, fcInitiatorName=fcInitiatorName, haResourceGroup=haResourceGroup, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, poolTotalSaving=poolTotalSaving, poolReadCacheReadIops=poolReadCacheReadIops, lunPoolName=lunPoolName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTotalWriteIops=fcTotalWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snmpServiceStopFailed=snmpServiceStopFailed, lunTargetGroup=lunTargetGroup, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareNFSReadMbps=shareNFSReadMbps, diskIndex=diskIndex, lunDataSizeLow=lunDataSizeLow, tegile=tegile, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSizeLow=diskSizeLow, networkInterfaceUp=networkInterfaceUp, projectLUNs=projectLUNs, diskTotalWriteIops=diskTotalWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, controllerTimeDrift=controllerTimeDrift, iscsiAvgReadLatency=iscsiAvgReadLatency, lunDataSizeHigh=lunDataSizeHigh, nicTransmitMbps=nicTransmitMbps, shareCIFSWriteIops=shareCIFSWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, currentObjectGroup=currentObjectGroup, iscsiTargetEntry=iscsiTargetEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, diskChassisIdx=diskChassisIdx, diskCount=diskCount, poolDataWriteLatency=poolDataWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, replicationTargetDeleted=replicationTargetDeleted)
