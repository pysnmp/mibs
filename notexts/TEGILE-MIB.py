...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:02:55 2022
...
TimeTicks, ObjectIdentity, NotificationType, Unsigned32, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64, ModuleIdentity, enterprises, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64", "ModuleIdentity", "enterprises", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, netbiosSocketFailure=netbiosSocketFailure, diskTotalReadMbps=diskTotalReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, haResourcesTable=haResourcesTable, poolMetaWriteLatency=poolMetaWriteLatency, notificationProps=notificationProps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunEntry=lunEntry, poolSizeHigh=poolSizeHigh, poolTotalWriteIops=poolTotalWriteIops, poolProjects=poolProjects, nfsAvgWriteLatency=nfsAvgWriteLatency, poolProjectCount=poolProjectCount, lunSizeLow=lunSizeLow, ipmiThreshold=ipmiThreshold, ipmiCurrent=ipmiCurrent, fcTargetModifyCompleted=fcTargetModifyCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nicMTU=nicMTU, disks=disks, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, shareDedupEnabled=shareDedupEnabled, projectShareCount=projectShareCount, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haControllerA_Name=haControllerA_Name, adServerTimeDrift=adServerTimeDrift, lunProtocol=lunProtocol, poolMetaWriteIops=poolMetaWriteIops, ntpServerTimeDrift=ntpServerTimeDrift, tegileCompliances=tegileCompliances, shareNFSEnabled=shareNFSEnabled, diskState=diskState, shareQuotaHigh=shareQuotaHigh, iscsiTargetGroupError=iscsiTargetGroupError, shareSnapshotSizeLow=shareSnapshotSizeLow, lunTable=lunTable, lunReadIops=lunReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcInitiatorName=fcInitiatorName, shareDataSizeLow=shareDataSizeLow, cpuSystemCalls=cpuSystemCalls, notificationSensorAction=notificationSensorAction, intelliFlashSoftwareDown=intelliFlashSoftwareDown, replicationPaused=replicationPaused, unknownSensorEvent=unknownSensorEvent, snmpServiceStarted=snmpServiceStarted, targetGroupMemberAdded=targetGroupMemberAdded, poolEntry=poolEntry, haResources=haResources, projectQuotaFinished=projectQuotaFinished, aclMigrationStarted=aclMigrationStarted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunBlockSize=lunBlockSize, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolCreated=poolCreated, diskAvgWriteLatency=diskAvgWriteLatency, controllerTimeDrift=controllerTimeDrift, nfsTotalWriteIops=nfsTotalWriteIops, shareMountPoint=shareMountPoint, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, aclMigrationCompleted=aclMigrationCompleted, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetAuth=iscsiTargetAuth, notificationEventCode=notificationEventCode, iscsiTargets=iscsiTargets, shareCompressedRatio=shareCompressedRatio, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolState=poolState, lunReservedSizeHigh=lunReservedSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, userLoginFailed=userLoginFailed, volumeDeleteFailed=volumeDeleteFailed, diskGoneOffline=diskGoneOffline, shareNFSWriteIops=shareNFSWriteIops, projectName=projectName, haControllerB_Name=haControllerB_Name, haControllerB_IPAddr=haControllerB_IPAddr, lunTargetGroup=lunTargetGroup, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haResourceDescription=haResourceDescription, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationObjects=notificationObjects, projectDeletionFailed=projectDeletionFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, fcPortOnline=fcPortOnline, haResourceActiveNode=haResourceActiveNode, shareCIFSWriteMbps=shareCIFSWriteMbps, lunReadLatency=lunReadLatency, lunInitiatorGroup=lunInitiatorGroup, shareEntry=shareEntry, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notifications=notifications, projectDeleted=projectDeleted, fcTargetName=fcTargetName, shareName=shareName, tegileArray=tegileArray, shareNFSWriteLatency=shareNFSWriteLatency, lunCompressionEnabled=lunCompressionEnabled, poolDataSizeHigh=poolDataSizeHigh, lunWriteLatency=lunWriteLatency, cpuInterrupts=cpuInterrupts, networkIpmpGroupUp=networkIpmpGroupUp, ipmiFan=ipmiFan, diskSlowIo=diskSlowIo, deleteFolderCompleted=deleteFolderCompleted, snapshotCloneCompleted=snapshotCloneCompleted, shareQuotaFinished=shareQuotaFinished, poolName=poolName, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUpgraded=poolUpgraded, deleteFolderFailed=deleteFolderFailed, notificationDescription=notificationDescription, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolDataReadLatency=poolDataReadLatency, tegileArray_notifications=tegileArray_notifications, shareTable=shareTable, poolImported=poolImported, smisServiceStarted=smisServiceStarted, projectFreeSizeHigh=projectFreeSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, replicationSourceRegistered=replicationSourceRegistered, poolDataReadMbps=poolDataReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectSnapshotSizeLow=projectSnapshotSizeLow, poolDeleted=poolDeleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, shareDeleted=shareDeleted, projectLUNs=projectLUNs, projectDedupEnabled=projectDedupEnabled, iscsiTargetError=iscsiTargetError, iscsiAvgReadLatency=iscsiAvgReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargetIndex=fcTargetIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, poolExpanded=poolExpanded, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunGUID=lunGUID, fcTargets=fcTargets, shareCIFSReadIops=shareCIFSReadIops, projectCompressionEnabled=projectCompressionEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareIndex=shareIndex, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, upgradeFailed=upgradeFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectDataSizeLow=projectDataSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, lunSizeHigh=lunSizeHigh, projectTotalSaving=projectTotalSaving, iscsiInitiatorsTable=iscsiInitiatorsTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nvdimmFailSoftError=nvdimmFailSoftError, snapshotCreationFailed=snapshotCreationFailed, poolReadCacheReadIops=poolReadCacheReadIops, upgradeStarted=upgradeStarted, iscsiTargetEntry=iscsiTargetEntry, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetGroup=iscsiTargetGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorEntry=fcInitiatorEntry, notificationComponentName=notificationComponentName, sanProperties=sanProperties, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiWriteIops=iscsiWriteIops, poolUsedSizeLow=poolUsedSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, diskDataReadIops=diskDataReadIops, poolHealth=poolHealth, upgradeCompleted=upgradeCompleted, snapshotRollbackFailed=snapshotRollbackFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, upgradeDownloadStarted=upgradeDownloadStarted, poolTable=poolTable, initiatorGroupMemberAdded=initiatorGroupMemberAdded, currentNotificationGroup=currentNotificationGroup, lunProjectName=lunProjectName, fcInitiatorsTable=fcInitiatorsTable, ipmiMemory=ipmiMemory, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectLunCount=projectLunCount, diskTotalWriteMbps=diskTotalWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nicState=nicState, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetReadIops=iscsiTargetReadIops, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorIndex=fcInitiatorIndex, poolMetaWriteMbps=poolMetaWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetWriteIops=fcTargetWriteIops, diskChassisIdx=diskChassisIdx, fcInitiators=fcInitiators, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpAgentVersion=snmpAgentVersion, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, smisServiceStopped=smisServiceStopped, projectEntry=projectEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, fcTotalReadMbps=fcTotalReadMbps, fcTotalWriteIops=fcTotalWriteIops, poolMetaReadLatency=poolMetaReadLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectPoolName=projectPoolName, fcInitiatorGroup=fcInitiatorGroup, replicationFailed=replicationFailed, smisServiceStopFailed=smisServiceStopFailed, notificationSensorSuspect=notificationSensorSuspect, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, properties=properties, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskAlias=diskAlias, snmpServiceStartFailed=snmpServiceStartFailed, cacheRAMReads=cacheRAMReads, fcProperties=fcProperties, projectQuotaSizeLow=projectQuotaSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, notificationReadingUnit=notificationReadingUnit, lunName=lunName, poolExported=poolExported, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolReadCacheReadLatency=poolReadCacheReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", notificationTime=notificationTime, lunDedupEnabled=lunDedupEnabled, diskDataWriteMbps=diskDataWriteMbps, volumeModifyCompleted=volumeModifyCompleted, poolMetaReadIops=poolMetaReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectIndex=projectIndex, vmwareNFSDatastores=vmwareNFSDatastores, poolDeletionFailed=poolDeletionFailed, lunDataSizeHigh=lunDataSizeHigh, nicTable=nicTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, networkInterfaceUp=networkInterfaceUp, basicCompliance=basicCompliance, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDataReadIops=poolDataReadIops, cacheTotalWriteIops=cacheTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargetGroup=fcTargetGroup, replicationAborted=replicationAborted, nvdimmFailInitializationError=nvdimmFailInitializationError, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolMetaReadMbps=poolMetaReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, globalStatistics=globalStatistics, nicGroup=nicGroup, fcTargetStatus=fcTargetStatus, fcTargetWriteMbps=fcTargetWriteMbps, projectDataSizeHigh=projectDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, sharePoolName=sharePoolName, notificationSensorNumber=notificationSensorNumber, network=network, cacheTotalReadIops=cacheTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, poolIndex=poolIndex, poolSizeLow=poolSizeLow, diskPoolName=diskPoolName, poolTotalReadMbps=poolTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, nicIndex=nicIndex, shareExceedThresholdWarning=shareExceedThresholdWarning, maintenanceModeEnabled=maintenanceModeEnabled, poolDataWriteIops=poolDataWriteIops, currentObjectGroup=currentObjectGroup, shareNFSWriteMbps=shareNFSWriteMbps, diskSequentialIOCount=diskSequentialIOCount, snapshotRollbackCompleted=snapshotRollbackCompleted, poolOwnerController=poolOwnerController, ipmiTemperature=ipmiTemperature, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorIndex=iscsiInitiatorIndex, projectModified=projectModified, smbSocketFailure=smbSocketFailure, networkInterfaceDown=networkInterfaceDown, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunFreeSizeLow=lunFreeSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskTotalReadIops=diskTotalReadIops, fcTargetEntry=fcTargetEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskType=diskType, volumeQuotaFinished=volumeQuotaFinished, snmpServiceStopFailed=snmpServiceStopFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorName=iscsiInitiatorName, nfsTotalWriteMbps=nfsTotalWriteMbps, replicationAbandoned=replicationAbandoned, sensorFailureEvent=sensorFailureEvent, spareDiskReplaced=spareDiskReplaced, pools=pools, cacheSSDReads=cacheSSDReads, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetAlias=iscsiTargetAlias, lunPoolName=lunPoolName, lunReadMbps=lunReadMbps, poolFreeSizeLow=poolFreeSizeLow, fcTargetReadIops=fcTargetReadIops, diskSizeLow=diskSizeLow, snapshotCloningFailed=snapshotCloningFailed, tegileConformance=tegileConformance, iscsiInitiatorEntry=iscsiInitiatorEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunWriteIops=lunWriteIops, replicationTargetDeleted=replicationTargetDeleted, projectFreeSizeLow=projectFreeSizeLow, iscsiProperties=iscsiProperties, poolDataWriteLatency=poolDataWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskRandomIOCount=diskRandomIOCount, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, fcTargetReadLatency=fcTargetReadLatency, lunIndex=lunIndex, shareNFSReadIops=shareNFSReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, poolQuotaFinished=poolQuotaFinished, poolAvgWriteLatency=poolAvgWriteLatency, nicEntry=nicEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, cifsTotalReadIops=cifsTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, poolTotalReadIops=poolTotalReadIops, PYSNMP_MODULE_ID=tegile, upgradeTimeout=upgradeTimeout, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, replicationResumed=replicationResumed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetReadMbps=fcTargetReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, poolDegraded=poolDegraded, shareCIFSEnabled=shareCIFSEnabled, cpuTotalUsage=cpuTotalUsage, testNotification=testNotification, haResourceStatus=haResourceStatus, shareReservedSizeHigh=shareReservedSizeHigh, haResourceIndex=haResourceIndex, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareProjectName=shareProjectName, diskTable=diskTable, lunDataSizeLow=lunDataSizeLow, fcTotalReadIops=fcTotalReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicName=nicName, maintenanceModeDisabled=maintenanceModeDisabled, lunFreeSizeHigh=lunFreeSizeHigh, shareDeletionFailed=shareDeletionFailed, volumeDeleteCompleted=volumeDeleteCompleted, diskCount=diskCount, nicTransmitMbps=nicTransmitMbps, haResourceGroup=haResourceGroup, shareReservedSizeLow=shareReservedSizeLow, poolDataSizeLow=poolDataSizeLow, diskSizeHigh=diskSizeHigh, projectShares=projectShares, iscsiTargetsTable=iscsiTargetsTable, fcPortOffline=fcPortOffline, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareNFSReadLatency=shareNFSReadLatency, diskError=diskError, networkTotalReceiveMbps=networkTotalReceiveMbps, lunReservedSizeLow=lunReservedSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationSeverity=notificationSeverity, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiPowerSupply=ipmiPowerSupply, shareDataSizeHigh=shareDataSizeHigh, poolTotalSaving=poolTotalSaving, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCompressionEnabled=shareCompressionEnabled, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationStarted=replicationStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicReceiveMbps=nicReceiveMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaLow=shareQuotaLow, iscsiTargetIndex=iscsiTargetIndex, diskDataWriteIops=diskDataWriteIops, tegile=tegile, fcAvgWriteLatency=fcAvgWriteLatency, poolAvgReadLatency=poolAvgReadLatency, diskIndex=diskIndex, poolFreeSizeHigh=poolFreeSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, diskIOCount=diskIOCount, projectTable=projectTable, haResourceName=haResourceName, poolCount=poolCount, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tegileGroups=tegileGroups, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, diskDataReadMbps=diskDataReadMbps, lunCompressedRatio=lunCompressedRatio, haResourceEntry=haResourceEntry, snmpServiceStopped=snmpServiceStopped, fcTargetsTable=fcTargetsTable, ipmiOther=ipmiOther, nfsTotalReadIops=nfsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, memoryFailure=memoryFailure, poolTotalWriteMbps=poolTotalWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, replicationComplete=replicationComplete, controllerHardwareModel=controllerHardwareModel, haControllerB_Uptime=haControllerB_Uptime, diskEntry=diskEntry, fcAvgReadLatency=fcAvgReadLatency, diskIsOnline=diskIsOnline, controllerUp=controllerUp, controllerDown=controllerDown, haControllerA_IPAddr=haControllerA_IPAddr, haControllerA_Uptime=haControllerA_Uptime, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency)
