...
Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, iso, NotificationType, ObjectIdentity, TimeTicks, ModuleIdentity, Bits, Integer32, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "iso", "NotificationType", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Bits", "Integer32", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaFinished=shareQuotaFinished, haControllerB_Uptime=haControllerB_Uptime, fcTargetReadIops=fcTargetReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationComponentName=notificationComponentName, upgradeDownloadStarted=upgradeDownloadStarted, upgradeFailed=upgradeFailed, lunReservedSizeLow=lunReservedSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, poolMetaWriteLatency=poolMetaWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskSizeLow=diskSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, upgradeTimeout=upgradeTimeout, smisServiceStopFailed=smisServiceStopFailed, poolDataReadMbps=poolDataReadMbps, ipmiThreshold=ipmiThreshold, networkInterfaceUp=networkInterfaceUp, deleteFolderCompleted=deleteFolderCompleted, aclMigrationCompleted=aclMigrationCompleted, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiProperties=iscsiProperties, snmpAgentVersion=snmpAgentVersion, diskChassisIdx=diskChassisIdx, lunWriteIops=lunWriteIops, ipmiTemperature=ipmiTemperature, diskAvgWriteLatency=diskAvgWriteLatency, cpuInterrupts=cpuInterrupts, fcTargetWriteMbps=fcTargetWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskDataReadIops=diskDataReadIops, shareDeleted=shareDeleted, replicationAborted=replicationAborted, iscsiInitiatorIndex=iscsiInitiatorIndex, poolDeleted=poolDeleted, haResources=haResources, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolImported=poolImported, shareCIFSEnabled=shareCIFSEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, smbSocketFailure=smbSocketFailure, diskTable=diskTable, projectIndex=projectIndex, poolHealth=poolHealth, volumeQuotaFinished=volumeQuotaFinished, diskRandomIOCount=diskRandomIOCount, cifsAvgReadLatency=cifsAvgReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, nfsAvgReadLatency=nfsAvgReadLatency, testNotification=testNotification, nfsAvgWriteLatency=nfsAvgWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectTable=projectTable, lunReadLatency=lunReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargets=iscsiTargets, smisServiceStarted=smisServiceStarted, shareMountPoint=shareMountPoint, haControllerB_IPAddr=haControllerB_IPAddr, poolUsedSizeLow=poolUsedSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationSensorNumber=notificationSensorNumber, lunSizeLow=lunSizeLow, poolTotalSaving=poolTotalSaving, poolDataWriteMbps=poolDataWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalReadMbps=fcTotalReadMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargets=fcTargets, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, replicationPaused=replicationPaused, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, cacheTotalReadMbps=cacheTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, diskGoneOffline=diskGoneOffline, haResourcesTable=haResourcesTable, shareExceedThresholdWarning=shareExceedThresholdWarning, diskType=diskType, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceEntry=haResourceEntry, notificationProps=notificationProps, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, diskState=diskState, replicationAbandoned=replicationAbandoned, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiMemory=ipmiMemory, fcTotalWriteIops=fcTotalWriteIops, lunProtocol=lunProtocol, diskAvgReadLatency=diskAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, notificationReadingTriggerValue=notificationReadingTriggerValue, shareName=shareName, fcTargetReadMbps=fcTargetReadMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, replicationResumed=replicationResumed, projectLunCount=projectLunCount, notificationSensorAction=notificationSensorAction, lunFreeSizeLow=lunFreeSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunCompressionEnabled=lunCompressionEnabled, networkInterfaceDown=networkInterfaceDown, fcTargetsTable=fcTargetsTable, networkIpmpGroupUp=networkIpmpGroupUp, ipmiCurrent=ipmiCurrent, basicCompliance=basicCompliance, fcPortOffline=fcPortOffline, shareEntry=shareEntry, replicationFailed=replicationFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectDataSizeHigh=projectDataSizeHigh, ipmiOther=ipmiOther, notificationDescription=notificationDescription, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareTable=shareTable, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationSeverity=notificationSeverity, notificationTargetEntityName=notificationTargetEntityName, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorIndex=fcInitiatorIndex, nicTransmitMbps=nicTransmitMbps, diskEntry=diskEntry, poolName=poolName, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nvdimmFailDeviceError=nvdimmFailDeviceError, poolTotalWriteMbps=poolTotalWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, cacheRAMReads=cacheRAMReads, sharePoolName=sharePoolName, cpuTotalUsage=cpuTotalUsage, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiWriteIops=iscsiWriteIops, lunName=lunName, diskCount=diskCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nicEntry=nicEntry, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectDedupEnabled=projectDedupEnabled, controllerHardwareModel=controllerHardwareModel, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetWriteLatency=fcTargetWriteLatency, haResourceStatus=haResourceStatus, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorName=fcInitiatorName, projectEntry=projectEntry, ipmiFan=ipmiFan, diskTotalReadIops=diskTotalReadIops, diskSlowIo=diskSlowIo, nicIndex=nicIndex, shareQuotaHigh=shareQuotaHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectName=projectName, lunWriteMbps=lunWriteMbps, poolMetaReadMbps=poolMetaReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareQuotaLow=shareQuotaLow, lunProjectName=lunProjectName, haControllerB_Name=haControllerB_Name, pools=pools, poolAvgReadLatency=poolAvgReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, fcPortOnline=fcPortOnline, fcTargetModifyCompleted=fcTargetModifyCompleted, maintenanceModeEnabled=maintenanceModeEnabled, fcTargetStatus=fcTargetStatus, currentNotificationGroup=currentNotificationGroup, smisServiceStartFailed=smisServiceStartFailed, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetAuth=iscsiTargetAuth, upgradeStarted=upgradeStarted, diskIndex=diskIndex, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, lunReadIops=lunReadIops, shareNFSWriteMbps=shareNFSWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, projectDataSizeLow=projectDataSizeLow, notificationObjects=notificationObjects, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolAvgWriteLatency=poolAvgWriteLatency, nfsTotalReadIops=nfsTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, lunDataSizeHigh=lunDataSizeHigh, poolDataSizeHigh=poolDataSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, poolDeletionFailed=poolDeletionFailed, shareDedupEnabled=shareDedupEnabled, fcTargetEntry=fcTargetEntry, poolSizeLow=poolSizeLow, shareDataSizeHigh=shareDataSizeHigh, tegileCompliances=tegileCompliances, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareCIFSReadIops=shareCIFSReadIops, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, projectFreeSizeLow=projectFreeSizeLow, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorName=iscsiInitiatorName, projectCompressionEnabled=projectCompressionEnabled, diskIOCount=diskIOCount, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, controllerDown=controllerDown, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcTargetGroup=fcTargetGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, volumeModifyCompleted=volumeModifyCompleted, diskError=diskError, snapshotRollbackCompleted=snapshotRollbackCompleted, lunSizeHigh=lunSizeHigh, network=network, poolEntry=poolEntry, poolMetaWriteIops=poolMetaWriteIops, cifsTotalReadIops=cifsTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationSensorSuspect=notificationSensorSuspect, tegile=tegile, poolTotalReadMbps=poolTotalReadMbps, shareDataSizeLow=shareDataSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", lunWriteLatency=lunWriteLatency, shareReservedSizeLow=shareReservedSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceName=haResourceName, volumeDeleteCompleted=volumeDeleteCompleted, shareCompressedRatio=shareCompressedRatio, lunReadMbps=lunReadMbps, diskDataReadMbps=diskDataReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunEntry=lunEntry, cacheTotalWriteIops=cacheTotalWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, haControllerA_Name=haControllerA_Name, poolDegraded=poolDegraded, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicMTU=nicMTU, PYSNMP_MODULE_ID=tegile, shareNFSReadMbps=shareNFSReadMbps, fcProperties=fcProperties, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, alertsCleanupCompleted=alertsCleanupCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, lunGUID=lunGUID, properties=properties, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolCount=poolCount, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectThresholdExceedWarning=projectThresholdExceedWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, snmpServiceStartFailed=snmpServiceStartFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolTable=poolTable, shareReservedSizeHigh=shareReservedSizeHigh, diskSequentialIOCount=diskSequentialIOCount, replicationStarted=replicationStarted, networkIpmpGroupDown=networkIpmpGroupDown, shareProjectName=shareProjectName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolCreated=poolCreated, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, poolState=poolState, nicName=nicName, fcTargetName=fcTargetName, poolUpgraded=poolUpgraded, iscsiTotalReadMbps=iscsiTotalReadMbps, notifications=notifications, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolSizeHigh=poolSizeHigh, notificationReadingUnit=notificationReadingUnit, memoryFailure=memoryFailure, iscsiTargetReadIops=iscsiTargetReadIops, shareIndex=shareIndex, iscsiTargetEntry=iscsiTargetEntry, haControllerA_Uptime=haControllerA_Uptime, poolMetaReadLatency=poolMetaReadLatency, projectShareCount=projectShareCount, shareSnapshotSizeLow=shareSnapshotSizeLow, cacheTotalReadIops=cacheTotalReadIops, smisServiceStopped=smisServiceStopped, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolQuotaFinished=poolQuotaFinished, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiAvgReadLatency=iscsiAvgReadLatency, tegileArray=tegileArray, projectTotalSaving=projectTotalSaving, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetError=iscsiTargetError, fcTargetWriteIops=fcTargetWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareNFSReadLatency=shareNFSReadLatency, haResourceGroup=haResourceGroup, iscsiTotalReadIops=iscsiTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcInitiatorsTable=fcInitiatorsTable, sensorFailureEvent=sensorFailureEvent, diskSizeHigh=diskSizeHigh, shareNFSWriteIops=shareNFSWriteIops, lunTable=lunTable, shareNFSEnabled=shareNFSEnabled, userLoginFailed=userLoginFailed, iscsiTargetName=iscsiTargetName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectShares=projectShares, lunTargetGroup=lunTargetGroup, poolProjectCount=poolProjectCount, haResourceActiveNode=haResourceActiveNode, ntpServerTimeDrift=ntpServerTimeDrift, poolUsedSizeHigh=poolUsedSizeHigh, poolProjects=poolProjects, tegileGroups=tegileGroups, iscsiInitiatorGroup=iscsiInitiatorGroup, diskTotalWriteIops=diskTotalWriteIops, lunPoolName=lunPoolName, snmpServiceStopped=snmpServiceStopped, controllerUp=controllerUp, projectDeletionFailed=projectDeletionFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, deleteFolderFailed=deleteFolderFailed, poolOwnerController=poolOwnerController, diskAlias=diskAlias, nicState=nicState, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotCreationFailed=snapshotCreationFailed, lunIndex=lunIndex, diagnosticDataUploaded=diagnosticDataUploaded, globalStatistics=globalStatistics, volumeDeleteFailed=volumeDeleteFailed, poolExported=poolExported, poolDataWriteIops=poolDataWriteIops, diskDataWriteIops=diskDataWriteIops, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, replicationSourceRegistered=replicationSourceRegistered, nvdimmFailInitializationError=nvdimmFailInitializationError, diskIsOnline=diskIsOnline, replicationComplete=replicationComplete, tegileConformance=tegileConformance, notificationEventCode=notificationEventCode, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectSnapshotSizeHigh=projectSnapshotSizeHigh, sanProperties=sanProperties, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunDedupEnabled=lunDedupEnabled, shareCIFSReadLatency=shareCIFSReadLatency, controllerTimeDrift=controllerTimeDrift, iscsiTargetGroupError=iscsiTargetGroupError, nicGroup=nicGroup, currentObjectGroup=currentObjectGroup, fcInitiators=fcInitiators, netbiosSocketFailure=netbiosSocketFailure, projectQuotaSizeLow=projectQuotaSizeLow, upgradeCompleted=upgradeCompleted, lunBlockSize=lunBlockSize, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolExpanded=poolExpanded, shareCompressionEnabled=shareCompressionEnabled, cpuSystemCalls=cpuSystemCalls, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalWriteIops=poolTotalWriteIops, poolTotalReadIops=poolTotalReadIops, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, shareCIFSReadMbps=shareCIFSReadMbps, diskPoolName=diskPoolName, projectLUNs=projectLUNs, poolDataReadIops=poolDataReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, unknownSensorEvent=unknownSensorEvent, lunCompressedRatio=lunCompressedRatio, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskDataWriteMbps=diskDataWriteMbps, ipmiPowerSupply=ipmiPowerSupply, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectDeleted=projectDeleted, fcTargetIndex=fcTargetIndex, ipmiVoltage=ipmiVoltage, lunDataSizeLow=lunDataSizeLow, disks=disks, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataSizeLow=poolDataSizeLow, fcAvgReadLatency=fcAvgReadLatency, poolIndex=poolIndex, nicTable=nicTable, iscsiTargetAlias=iscsiTargetAlias, shareNFSReadIops=shareNFSReadIops, snmpServiceStarted=snmpServiceStarted, iscsiInitiators=iscsiInitiators, projectQuotaFinished=projectQuotaFinished, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectPoolName=projectPoolName, poolDataWriteLatency=poolDataWriteLatency, spareDiskReplaced=spareDiskReplaced, cacheSSDReads=cacheSSDReads, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcInitiatorEntry=fcInitiatorEntry, shareDeletionFailed=shareDeletionFailed, haResourceIndex=haResourceIndex, projectModified=projectModified, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationTime=notificationTime, nfsTotalReadMbps=nfsTotalReadMbps, tegileArray_notifications=tegileArray_notifications, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, haResourceDescription=haResourceDescription, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetReadLatency=fcTargetReadLatency)
