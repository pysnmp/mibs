...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:31:50 2021
...
Gauge32, TimeTicks, Bits, Integer32, IpAddress, MibIdentifier, ModuleIdentity, enterprises, iso, Counter64, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Bits", "Integer32", "IpAddress", "MibIdentifier", "ModuleIdentity", "enterprises", "iso", "Counter64", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunDataSizeLow=lunDataSizeLow, diskTotalWriteIops=diskTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cacheTotalReadIops=cacheTotalReadIops, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetName=fcTargetName, shareCompressionEnabled=shareCompressionEnabled, nicTable=nicTable, upgradeDownloadFailed=upgradeDownloadFailed, shareNFSWriteIops=shareNFSWriteIops, diskSizeLow=diskSizeLow, controllerHardwareModel=controllerHardwareModel, shareQuotaFinished=shareQuotaFinished, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snapshotRollbackFailed=snapshotRollbackFailed, shareDedupEnabled=shareDedupEnabled, shareCIFSWriteIops=shareCIFSWriteIops, notificationReadingUnit=notificationReadingUnit, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectDedupEnabled=projectDedupEnabled, networkInterfaceDown=networkInterfaceDown, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStartFailed=snmpServiceStartFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, diskError=diskError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicState=nicState, lunIndex=lunIndex, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haResourceIndex=haResourceIndex, smisServiceStartFailed=smisServiceStartFailed, fcTargetsTable=fcTargetsTable, replicationStarted=replicationStarted, lunCompressedRatio=lunCompressedRatio, fcTargetWriteIops=fcTargetWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunEntry=lunEntry, fcTargetReadMbps=fcTargetReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, diskTotalReadMbps=diskTotalReadMbps, poolTotalSaving=poolTotalSaving, poolDeleted=poolDeleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, replicationSourceRegistered=replicationSourceRegistered, ipmiVoltage=ipmiVoltage, lunTargetGroup=lunTargetGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, fcProperties=fcProperties, network=network, diskChassisIdx=diskChassisIdx, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, controllerUp=controllerUp, smisServiceStopFailed=smisServiceStopFailed, fcTargetIndex=fcTargetIndex, adServerTimeDrift=adServerTimeDrift, shareProjectName=shareProjectName, lunTable=lunTable, iscsiTargetGroup=iscsiTargetGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolCount=poolCount, notificationProps=notificationProps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, aclMigrationCompleted=aclMigrationCompleted, shareEntry=shareEntry, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetAlias=iscsiTargetAlias, lunProjectName=lunProjectName, projectCreatedSuccessfully=projectCreatedSuccessfully, nfsTotalWriteMbps=nfsTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, haControllerA_Name=haControllerA_Name, shareQuotaHigh=shareQuotaHigh, smbSocketFailure=smbSocketFailure, iscsiTargetGroupError=iscsiTargetGroupError, haResourceName=haResourceName, controllerDown=controllerDown, nicGroup=nicGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolName=poolName, diskRandomIOCount=diskRandomIOCount, fcTotalReadIops=fcTotalReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, lunDataSizeHigh=lunDataSizeHigh, notificationTime=notificationTime, shareCreatedSuccessfully=shareCreatedSuccessfully, memoryFailure=memoryFailure, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snmpAgentVersion=snmpAgentVersion, fcTargetEntry=fcTargetEntry, poolIndex=poolIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolDataWriteMbps=poolDataWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, fcTargets=fcTargets, cacheTotalWriteIops=cacheTotalWriteIops, lunReadLatency=lunReadLatency, haResourceGroup=haResourceGroup, nicEntry=nicEntry, diskDataWriteIops=diskDataWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolTotalWriteIops=poolTotalWriteIops, poolAvgReadLatency=poolAvgReadLatency, notificationSensorAction=notificationSensorAction, projectQuotaFinished=projectQuotaFinished, tdpsUpgradeFailed=tdpsUpgradeFailed, shareDataSizeHigh=shareDataSizeHigh, projectShares=projectShares, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationTargetEntityName=notificationTargetEntityName, nfsTotalReadMbps=nfsTotalReadMbps, poolProjects=poolProjects, notificationSensorNumber=notificationSensorNumber, poolQuotaFinished=poolQuotaFinished, sharePoolName=sharePoolName, upgradeDownloadStarted=upgradeDownloadStarted, poolMetaReadIops=poolMetaReadIops, lunProtocol=lunProtocol, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haControllerB_Name=haControllerB_Name, projectTotalSaving=projectTotalSaving, pools=pools, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationSeverity=notificationSeverity, upgradeTimeout=upgradeTimeout, basicCompliance=basicCompliance, fcTotalReadMbps=fcTotalReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCIFSEnabled=shareCIFSEnabled, snapshotDeleteFailed=snapshotDeleteFailed, networkInterfaceUp=networkInterfaceUp, projectLUNs=projectLUNs, lunWriteIops=lunWriteIops, haResourceStatus=haResourceStatus, fcInitiatorName=fcInitiatorName, poolFreeSizeHigh=poolFreeSizeHigh, replicationAbandoned=replicationAbandoned, haResourcesTable=haResourcesTable, notifications=notifications, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, upgradeFailed=upgradeFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, poolDegraded=poolDegraded, poolExpanded=poolExpanded, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCIFSReadIops=shareCIFSReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, currentNotificationGroup=currentNotificationGroup, properties=properties, poolFreeSizeLow=poolFreeSizeLow, notificationComponentName=notificationComponentName, tegileGroups=tegileGroups, shareDeleted=shareDeleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiProperties=iscsiProperties, smisServiceStarted=smisServiceStarted, iscsiTargetReadLatency=iscsiTargetReadLatency, cacheSSDReads=cacheSSDReads, diskGoneOffline=diskGoneOffline, diskEntry=diskEntry, shareMountPoint=shareMountPoint, PYSNMP_MODULE_ID=tegile, projectLunCount=projectLunCount, tegile=tegile, haControllerA_IPAddr=haControllerA_IPAddr, poolCreated=poolCreated, haControllerB_Uptime=haControllerB_Uptime, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorGroup=fcInitiatorGroup, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSReadMbps=shareNFSReadMbps, nicMTU=nicMTU, shareDeletionFailed=shareDeletionFailed, poolOwnerController=poolOwnerController, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, networkIpmpGroupDown=networkIpmpGroupDown, cpuTotalUsage=cpuTotalUsage, sanProperties=sanProperties, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorsTable=fcInitiatorsTable, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectDataSizeLow=projectDataSizeLow, lunGUID=lunGUID, diskAvgReadLatency=diskAvgReadLatency, tegileArray=tegileArray, lunCompressionEnabled=lunCompressionEnabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunWriteLatency=lunWriteLatency, testNotification=testNotification, projectDataSizeHigh=projectDataSizeHigh, fcTotalWriteIops=fcTotalWriteIops, replicationPaused=replicationPaused, haResourceEntry=haResourceEntry, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cacheRAMReads=cacheRAMReads, diskTotalReadIops=diskTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, lunFreeSizeLow=lunFreeSizeLow, diskDataReadIops=diskDataReadIops, haResourceActiveNode=haResourceActiveNode, iscsiTargetEntry=iscsiTargetEntry, fcPortOffline=fcPortOffline, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cpuInterrupts=cpuInterrupts, fcInitiators=fcInitiators, diskAlias=diskAlias, cifsAvgWriteLatency=cifsAvgWriteLatency, poolTotalReadMbps=poolTotalReadMbps, poolMetaReadLatency=poolMetaReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiWriteIops=iscsiWriteIops, notificationEventCode=notificationEventCode, diskType=diskType, lunName=lunName, ipmiMemory=ipmiMemory, notificationObjects=notificationObjects, poolTotalWriteMbps=poolTotalWriteMbps, nfsTotalReadIops=nfsTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cacheTotalReadMbps=cacheTotalReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiCurrent=ipmiCurrent, poolDataReadMbps=poolDataReadMbps, volumeModifyCompleted=volumeModifyCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, upgradeStarted=upgradeStarted, replicationComplete=replicationComplete, tegileCompliances=tegileCompliances, shareTable=shareTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, ipmiFan=ipmiFan, volumeDeleteFailed=volumeDeleteFailed, fcTargetStatus=fcTargetStatus, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolHealth=poolHealth, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStopped=snmpServiceStopped, networkTotalReceiveMbps=networkTotalReceiveMbps, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetReadLatency=fcTargetReadLatency, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskIsOnline=diskIsOnline, diskIOCount=diskIOCount, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargets=iscsiTargets, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiPowerSupply=ipmiPowerSupply, diskDataReadMbps=diskDataReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicReceiveMbps=nicReceiveMbps, lunPoolName=lunPoolName, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetName=iscsiTargetName, diskAvgWriteLatency=diskAvgWriteLatency, poolTable=poolTable, controllerTimeDrift=controllerTimeDrift, aclMigrationStarted=aclMigrationStarted, projectDeletionFailed=projectDeletionFailed, poolUsedSizeHigh=poolUsedSizeHigh, poolDataReadIops=poolDataReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskDataWriteMbps=diskDataWriteMbps, fcInitiatorIndex=fcInitiatorIndex, projectPoolName=projectPoolName, haResources=haResources, projectTable=projectTable, projectFreeSizeLow=projectFreeSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, ipmiOther=ipmiOther, nicIndex=nicIndex, unknownSensorEvent=unknownSensorEvent, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskPoolName=diskPoolName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, nicTransmitMbps=nicTransmitMbps, diskIndex=diskIndex, lunInitiatorGroup=lunInitiatorGroup, shareIndex=shareIndex, tegileArray_notifications=tegileArray_notifications, ipmiThreshold=ipmiThreshold, poolReadCacheWriteIops=poolReadCacheWriteIops, sensorFailureEvent=sensorFailureEvent, diskState=diskState, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastores=vmwareNFSDatastores, poolDataReadLatency=poolDataReadLatency, disks=disks, projectQuotaSizeLow=projectQuotaSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, replicationResumed=replicationResumed, fcTotalWriteMbps=fcTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, projectModified=projectModified, cifsTotalReadMbps=cifsTotalReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskSequentialIOCount=diskSequentialIOCount, shareName=shareName, poolProjectCount=poolProjectCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcAvgWriteLatency=fcAvgWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, poolEntry=poolEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunSizeHigh=lunSizeHigh, diskCount=diskCount, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolSizeLow=poolSizeLow, smisServiceStopped=smisServiceStopped, fcTargetModifyCompleted=fcTargetModifyCompleted, lunSizeLow=lunSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSizeHigh=diskSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTotalReadIops=iscsiTotalReadIops, poolTotalReadIops=poolTotalReadIops, fcAvgReadLatency=fcAvgReadLatency, lunWriteMbps=lunWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, currentObjectGroup=currentObjectGroup, iscsiTargetError=iscsiTargetError, deleteFolderFailed=deleteFolderFailed, poolDataSizeHigh=poolDataSizeHigh, fcPortOnline=fcPortOnline, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetIndex=iscsiTargetIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargetReadIops=fcTargetReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolExported=poolExported, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiators=iscsiInitiators, cifsTotalReadIops=cifsTotalReadIops, lunBlockSize=lunBlockSize, poolImported=poolImported, projectSnapshotSizeLow=projectSnapshotSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, poolMetaWriteMbps=poolMetaWriteMbps, fcInitiatorEntry=fcInitiatorEntry, poolMetaReadMbps=poolMetaReadMbps, shareNFSEnabled=shareNFSEnabled, snmpServiceStarted=snmpServiceStarted, replicationFailed=replicationFailed, projectDeleted=projectDeleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunReservedSizeLow=lunReservedSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectEntry=projectEntry, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetReadIops=iscsiTargetReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, haResourceDescription=haResourceDescription, cpuSystemCalls=cpuSystemCalls, projectName=projectName, targetGroupMemberAdded=targetGroupMemberAdded, poolState=poolState, lunReadIops=lunReadIops, poolDeletionFailed=poolDeletionFailed, poolUpgraded=poolUpgraded, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataWriteLatency=poolDataWriteLatency, diskSlowIo=diskSlowIo, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareNFSReadLatency=shareNFSReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetGroup=fcTargetGroup, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTotalReadMbps=iscsiTotalReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, spareDiskReplaced=spareDiskReplaced, iscsiTargetAuth=iscsiTargetAuth, haControllerA_Uptime=haControllerA_Uptime, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationDescription=notificationDescription, volumeQuotaFinished=volumeQuotaFinished, projectShareCount=projectShareCount, nfsTotalWriteIops=nfsTotalWriteIops, nicName=nicName, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskTable=diskTable, poolMetaWriteIops=poolMetaWriteIops, ipmiTemperature=ipmiTemperature, shareReservedSizeLow=shareReservedSizeLow, replicationAborted=replicationAborted, poolDataWriteIops=poolDataWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, netbiosSocketFailure=netbiosSocketFailure, targetGroupMemberRemoved=targetGroupMemberRemoved, globalStatistics=globalStatistics, snapshotCreationFailed=snapshotCreationFailed, upgradeCompleted=upgradeCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, tegileConformance=tegileConformance, iscsiInitiatorEntry=iscsiInitiatorEntry, diskTotalWriteMbps=diskTotalWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, userLoginFailed=userLoginFailed, shareNFSWriteLatency=shareNFSWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, poolAvgWriteLatency=poolAvgWriteLatency, projectIndex=projectIndex, lunReadMbps=lunReadMbps, lunDedupEnabled=lunDedupEnabled, cacheTotalWriteMbps=cacheTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps)
