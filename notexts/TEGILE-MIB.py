...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Gauge32, ModuleIdentity, enterprises, MibIdentifier, TimeTicks, Bits, ObjectIdentity, Counter64, Counter32, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "enterprises", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "Counter64", "Counter32", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationComponentName=notificationComponentName, smisServiceStopFailed=smisServiceStopFailed, fcTargetWriteLatency=fcTargetWriteLatency, diskDataReadIops=diskDataReadIops, smisServiceStopped=smisServiceStopped, iscsiTargetReadLatency=iscsiTargetReadLatency, properties=properties, lunCompressedRatio=lunCompressedRatio, shareCIFSEnabled=shareCIFSEnabled, lunWriteIops=lunWriteIops, lunProtocol=lunProtocol, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationTime=notificationTime, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haResourceIndex=haResourceIndex, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTargetWriteIops=fcTargetWriteIops, iscsiTargets=iscsiTargets, poolWriteCacheWriteIops=poolWriteCacheWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolExpanded=poolExpanded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskSizeLow=diskSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, controllerDown=controllerDown, lunName=lunName, diskSequentialIOCount=diskSequentialIOCount, poolHealth=poolHealth, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, upgradeStarted=upgradeStarted, upgradeTimeout=upgradeTimeout, fcTargetModifyCompleted=fcTargetModifyCompleted, projectLunCount=projectLunCount, iscsiTargetGroup=iscsiTargetGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDataReadMbps=poolDataReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolExported=poolExported, lunBlockSize=lunBlockSize, iscsiAvgWriteLatency=iscsiAvgWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskIsOnline=diskIsOnline, targetGroupMemberRemoved=targetGroupMemberRemoved, ipmiFan=ipmiFan, lunWriteLatency=lunWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpAgentVersion=snmpAgentVersion, haControllerB_Uptime=haControllerB_Uptime, nvdimmFailInitializationError=nvdimmFailInitializationError, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, smisServiceStartFailed=smisServiceStartFailed, projectTable=projectTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nfsTotalWriteMbps=nfsTotalWriteMbps, PYSNMP_MODULE_ID=tegile, fcInitiators=fcInitiators, iscsiTargetAuth=iscsiTargetAuth, poolProjectCount=poolProjectCount, haResourceActiveNode=haResourceActiveNode, tegileArray=tegileArray, upgradeFailed=upgradeFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeDeleteCompleted=volumeDeleteCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, haControllerB_Name=haControllerB_Name, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, sensorFailureEvent=sensorFailureEvent, spareDiskReplaced=spareDiskReplaced, diskDataReadMbps=diskDataReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectPoolName=projectPoolName, controllerHardwareModel=controllerHardwareModel, controllerTimeDrift=controllerTimeDrift, network=network, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, shareNFSEnabled=shareNFSEnabled, poolReadCacheReadLatency=poolReadCacheReadLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiInitiatorName=iscsiInitiatorName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTotalWriteIops=fcTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, haResourceEntry=haResourceEntry, snapshotCloningFailed=snapshotCloningFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, replicationComplete=replicationComplete, nicGroup=nicGroup, networkIpmpGroupUp=networkIpmpGroupUp, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcInitiatorIndex=fcInitiatorIndex, replicationResumed=replicationResumed, projectFreeSizeHigh=projectFreeSizeHigh, cacheRAMReads=cacheRAMReads, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, upgradeCompleted=upgradeCompleted, poolState=poolState, poolMetaReadMbps=poolMetaReadMbps, tegileCompliances=tegileCompliances, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkTotalReceiveMbps=networkTotalReceiveMbps, nvdimmFailSoftError=nvdimmFailSoftError, shareReservedSizeLow=shareReservedSizeLow, shareTable=shareTable, replicationPaused=replicationPaused, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiThreshold=ipmiThreshold, shareDeleted=shareDeleted, poolIndex=poolIndex, fcAvgWriteLatency=fcAvgWriteLatency, projectShareCount=projectShareCount, nicMTU=nicMTU, disks=disks, poolDataReadIops=poolDataReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicTransmitMbps=nicTransmitMbps, replicationAbandoned=replicationAbandoned, lunInitiatorGroup=lunInitiatorGroup, nfsTotalWriteIops=nfsTotalWriteIops, shareMountPoint=shareMountPoint, projectEntry=projectEntry, projectQuotaFinished=projectQuotaFinished, controllerUp=controllerUp, ipmiVoltage=ipmiVoltage, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_Name=haControllerA_Name, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalReadMbps=fcTotalReadMbps, shareCompressionEnabled=shareCompressionEnabled, diskGoneOffline=diskGoneOffline, shareCompressedRatio=shareCompressedRatio, projectDeletionFailed=projectDeletionFailed, diskIOCount=diskIOCount, iscsiTargetName=iscsiTargetName, diskAvgWriteLatency=diskAvgWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolMetaWriteIops=poolMetaWriteIops, fcTargetName=fcTargetName, iscsiTargetReadMbps=iscsiTargetReadMbps, diskChassisIdx=diskChassisIdx, diskSizeHigh=diskSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareName=shareName, cacheTotalReadIops=cacheTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, ipmiCurrent=ipmiCurrent, iscsiInitiators=iscsiInitiators, fcTargets=fcTargets, fcPortOnline=fcPortOnline, fcProperties=fcProperties, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorGroup=iscsiInitiatorGroup, cpuInterrupts=cpuInterrupts, fcTotalWriteMbps=fcTotalWriteMbps, poolTotalReadIops=poolTotalReadIops, maintenanceModeEnabled=maintenanceModeEnabled, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskTotalWriteMbps=diskTotalWriteMbps, haResourceDescription=haResourceDescription, poolSizeLow=poolSizeLow, poolCount=poolCount, shareCIFSReadMbps=shareCIFSReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicName=nicName, tegile=tegile, shareQuotaLow=shareQuotaLow, notificationProps=notificationProps, fcInitiatorEntry=fcInitiatorEntry, notificationObjects=notificationObjects, poolDataWriteLatency=poolDataWriteLatency, smbSocketFailure=smbSocketFailure, fcTargetGroup=fcTargetGroup, fcTargetEntry=fcTargetEntry, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskPoolName=diskPoolName, upgradeDownloadFailed=upgradeDownloadFailed, currentNotificationGroup=currentNotificationGroup, shareNFSWriteIops=shareNFSWriteIops, sanProperties=sanProperties, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunPoolName=lunPoolName, notifications=notifications, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, tegileConformance=tegileConformance, notificationDescription=notificationDescription, networkInterfaceDown=networkInterfaceDown, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetAlias=iscsiTargetAlias, fcTargetStatus=fcTargetStatus, poolQuotaFinished=poolQuotaFinished, nicIndex=nicIndex, poolDataSizeLow=poolDataSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, ipmiPowerSupply=ipmiPowerSupply, notificationSensorNumber=notificationSensorNumber, fcInitiatorsTable=fcInitiatorsTable, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolProjects=poolProjects, iscsiTargetError=iscsiTargetError, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nicTable=nicTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunCompressionEnabled=lunCompressionEnabled, pools=pools, poolName=poolName, iscsiInitiatorEntry=iscsiInitiatorEntry, lunSizeHigh=lunSizeHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDeleted=projectDeleted, diskCount=diskCount, snapshotRollbackFailed=snapshotRollbackFailed, shareQuotaFinished=shareQuotaFinished, poolAvgWriteLatency=poolAvgWriteLatency, snmpServiceStopped=snmpServiceStopped, poolMetaReadLatency=poolMetaReadLatency, poolSizeHigh=poolSizeHigh, poolMetaReadIops=poolMetaReadIops, poolUpgraded=poolUpgraded, replicationTargetDeleted=replicationTargetDeleted, tegileArray_notifications=tegileArray_notifications, lunDataSizeLow=lunDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, diskTotalReadIops=diskTotalReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectLUNs=projectLUNs, fcInitiatorCreateFailed=fcInitiatorCreateFailed, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskSlowIo=diskSlowIo)
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cifsTotalReadMbps=cifsTotalReadMbps, projectName=projectName, networkInterfaceUp=networkInterfaceUp, cifsTotalWriteIops=cifsTotalWriteIops, adServerTimeDrift=adServerTimeDrift, shareNFSReadMbps=shareNFSReadMbps, nicState=nicState, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunGUID=lunGUID, cifsTotalWriteMbps=cifsTotalWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, ntpServerTimeDrift=ntpServerTimeDrift, haResourceStatus=haResourceStatus, projectModified=projectModified, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, poolDeletionFailed=poolDeletionFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolFreeSizeLow=poolFreeSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, nfsAvgReadLatency=nfsAvgReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTotalReadIops=fcTotalReadIops, poolTable=poolTable, iscsiProperties=iscsiProperties, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcPortOffline=fcPortOffline, lunWriteMbps=lunWriteMbps, shareNFSReadIops=shareNFSReadIops, shareDataSizeHigh=shareDataSizeHigh, haResourcesTable=haResourcesTable, vmwareNFSDatastores=vmwareNFSDatastores, diskType=diskType, nicReceiveMbps=nicReceiveMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationStarted=replicationStarted, diskDataWriteIops=diskDataWriteIops, projectIndex=projectIndex, cacheTotalWriteMbps=cacheTotalWriteMbps, diskAlias=diskAlias, lunSnapshotSizeLow=lunSnapshotSizeLow, cacheSSDReads=cacheSSDReads, fcInitiatorGroup=fcInitiatorGroup, projectThresholdExceedWarning=projectThresholdExceedWarning, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskIndex=diskIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationEventCode=notificationEventCode, haResources=haResources, nfsTotalReadIops=nfsTotalReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, poolTotalReadMbps=poolTotalReadMbps, lunEntry=lunEntry, diskState=diskState, lunDedupEnabled=lunDedupEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunTable=lunTable, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotDeleteFailed=snapshotDeleteFailed, lunIndex=lunIndex, poolImported=poolImported, cifsAvgReadLatency=cifsAvgReadLatency, shareIndex=shareIndex, networkIpmpGroupDown=networkIpmpGroupDown, poolUsedSizeHigh=poolUsedSizeHigh, shareQuotaHigh=shareQuotaHigh, fcTargetIndex=fcTargetIndex, upgradeDownloadStarted=upgradeDownloadStarted, projectDedupEnabled=projectDedupEnabled, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationAborted=replicationAborted, shareNFSWriteLatency=shareNFSWriteLatency, shareDedupEnabled=shareDedupEnabled, diskTotalWriteIops=diskTotalWriteIops, diskTable=diskTable, projectFreeSizeLow=projectFreeSizeLow, poolDegraded=poolDegraded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunReadIops=lunReadIops, fcTargetReadLatency=fcTargetReadLatency, projectTotalSaving=projectTotalSaving, volumeDeleteFailed=volumeDeleteFailed, poolDataWriteMbps=poolDataWriteMbps, memoryFailure=memoryFailure, notificationSeverity=notificationSeverity, haResourceGroup=haResourceGroup, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskRandomIOCount=diskRandomIOCount, projectDataSizeLow=projectDataSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, poolCreated=poolCreated, ipmiOther=ipmiOther, shareNFSReadLatency=shareNFSReadLatency, basicCompliance=basicCompliance, shareDataSizeLow=shareDataSizeLow, fcTargetsTable=fcTargetsTable, cpuTotalUsage=cpuTotalUsage, lunSizeLow=lunSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nfsTotalReadMbps=nfsTotalReadMbps, aclMigrationCompleted=aclMigrationCompleted, lunTargetGroup=lunTargetGroup, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, smisServiceStarted=smisServiceStarted, lunReservedSizeLow=lunReservedSizeLow, poolAvgReadLatency=poolAvgReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetIndex=iscsiTargetIndex, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, poolDataWriteIops=poolDataWriteIops, lunReadMbps=lunReadMbps, nicEntry=nicEntry, poolDataSizeHigh=poolDataSizeHigh, poolOwnerController=poolOwnerController, haResourceName=haResourceName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcInitiatorName=fcInitiatorName, shareExceedThresholdWarning=shareExceedThresholdWarning, cpuSystemCalls=cpuSystemCalls, alertsCleanupCompleted=alertsCleanupCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, notificationSensorAction=notificationSensorAction, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetEntry=iscsiTargetEntry, shareDeletionFailed=shareDeletionFailed, snapshotCreationFailed=snapshotCreationFailed, notificationReadingUnit=notificationReadingUnit, unknownSensorEvent=unknownSensorEvent, shareProjectName=shareProjectName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetsTable=iscsiTargetsTable, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectQuotaSizeHigh=projectQuotaSizeHigh, projectDataSizeHigh=projectDataSizeHigh, diskError=diskError, diskAvgReadLatency=diskAvgReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationSourceRegistered=replicationSourceRegistered, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerB_IPAddr=haControllerB_IPAddr, lunReadLatency=lunReadLatency, sharePoolName=sharePoolName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeQuotaFinished=volumeQuotaFinished, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskEntry=diskEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolUsedSizeLow=poolUsedSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcAvgReadLatency=fcAvgReadLatency, poolDataReadLatency=poolDataReadLatency, lunProjectName=lunProjectName, shareCIFSWriteLatency=shareCIFSWriteLatency, shareNFSWriteMbps=shareNFSWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectShares=projectShares, ipmiTemperature=ipmiTemperature, maintenanceModeDisabled=maintenanceModeDisabled, globalStatistics=globalStatistics, aclMigrationStarted=aclMigrationStarted, ipmiMemory=ipmiMemory, haControllerA_Uptime=haControllerA_Uptime, projectCompressionEnabled=projectCompressionEnabled, projectSnapshotSizeHigh=projectSnapshotSizeHigh, tegileGroups=tegileGroups, poolEntry=poolEntry, targetGroupCreateCompleted=targetGroupCreateCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, lunDataSizeHigh=lunDataSizeHigh, diskTotalReadMbps=diskTotalReadMbps, testNotification=testNotification, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsAvgWriteLatency=nfsAvgWriteLatency, userLoginFailed=userLoginFailed, poolDeleted=poolDeleted, replicationFailed=replicationFailed, shareCIFSReadIops=shareCIFSReadIops, volumeModifyCompleted=volumeModifyCompleted, shareEntry=shareEntry, deleteFolderCompleted=deleteFolderCompleted, deleteFolderFailed=deleteFolderFailed, iscsiTargetReadIops=iscsiTargetReadIops)
