...
MibIdentifier, Bits, Counter32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, NotificationType, enterprises, Counter64, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "NotificationType", "enterprises", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunSnapshotSizeHigh=lunSnapshotSizeHigh, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, notificationProps=notificationProps, poolMetaReadIops=poolMetaReadIops, tegile=tegile, nicGroup=nicGroup, diskIndex=diskIndex, poolDataSizeHigh=poolDataSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareCIFSWriteLatency=shareCIFSWriteLatency, diskPoolName=diskPoolName, nfsTotalWriteMbps=nfsTotalWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResources=haResources, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiOther=ipmiOther, tegileGroups=tegileGroups, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorName=iscsiInitiatorName, cacheSSDReads=cacheSSDReads, shareReservedSizeHigh=shareReservedSizeHigh, fcTargets=fcTargets, nfsTotalReadIops=nfsTotalReadIops, alertsCleanupCompleted=alertsCleanupCompleted, shareQuotaLow=shareQuotaLow, lunTable=lunTable, iscsiInitiatorsTable=iscsiInitiatorsTable, diskIsOnline=diskIsOnline, snapshotRollbackCompleted=snapshotRollbackCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunInitiatorGroup=lunInitiatorGroup, diskIOCount=diskIOCount, shareDedupEnabled=shareDedupEnabled, lunReadLatency=lunReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunBlockSize=lunBlockSize, shareDeleted=shareDeleted, controllerHardwareModel=controllerHardwareModel, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiWriteIops=iscsiWriteIops, shareCompressionEnabled=shareCompressionEnabled, shareNFSWriteLatency=shareNFSWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectCompressionEnabled=projectCompressionEnabled, ipmiFan=ipmiFan, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, tegileArray_notifications=tegileArray_notifications, lunDataSizeLow=lunDataSizeLow, shareTable=shareTable, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskCount=diskCount, lunPoolName=lunPoolName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectShareCount=projectShareCount, shareCIFSReadIops=shareCIFSReadIops, lunFreeSizeLow=lunFreeSizeLow, poolUpgraded=poolUpgraded, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nfsTotalWriteIops=nfsTotalWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, smbSocketFailure=smbSocketFailure, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectName=projectName, networkInterfaceUp=networkInterfaceUp, haControllerA_Name=haControllerA_Name, lunWriteIops=lunWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, cacheTotalReadIops=cacheTotalReadIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolExported=poolExported, upgradeFailed=upgradeFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, cpuSystemCalls=cpuSystemCalls, poolAvgWriteLatency=poolAvgWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, notificationObjects=notificationObjects, cifsTotalReadIops=cifsTotalReadIops, replicationStarted=replicationStarted, diskSlowIo=diskSlowIo, notificationThresholdTriggerValue=notificationThresholdTriggerValue, cifsAvgWriteLatency=cifsAvgWriteLatency, lunProtocol=lunProtocol, sensorFailureEvent=sensorFailureEvent, iscsiTargetAuth=iscsiTargetAuth, netbiosSocketFailure=netbiosSocketFailure, fcTargetWriteMbps=fcTargetWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolProjectCount=poolProjectCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tegileConformance=tegileConformance, fcTargetIndex=fcTargetIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskEntry=diskEntry, fcTargetGroup=fcTargetGroup, fcTargetName=fcTargetName, nicState=nicState, volumeDeleteCompleted=volumeDeleteCompleted, shareNFSEnabled=shareNFSEnabled, diskTotalWriteMbps=diskTotalWriteMbps, projectDataSizeHigh=projectDataSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, fcPortOffline=fcPortOffline, diagnosticDataUploaded=diagnosticDataUploaded, cacheRAMReads=cacheRAMReads, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationDescription=notificationDescription, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectDeletionFailed=projectDeletionFailed, cacheTotalReadMbps=cacheTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, haResourceGroup=haResourceGroup, diskSequentialIOCount=diskSequentialIOCount, volumeDeleteFailed=volumeDeleteFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, fcPortOnline=fcPortOnline, diskTotalReadIops=diskTotalReadIops, lunWriteMbps=lunWriteMbps, globalStatistics=globalStatistics, shareReservedSizeLow=shareReservedSizeLow, nicTransmitMbps=nicTransmitMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, smisServiceStarted=smisServiceStarted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolTotalSaving=poolTotalSaving, poolProjects=poolProjects, snapshotRollbackFailed=snapshotRollbackFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSReadIops=shareNFSReadIops, shareDataSizeHigh=shareDataSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, intelliFlashSoftwareUp=intelliFlashSoftwareUp, adServerTimeDrift=adServerTimeDrift, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, testNotification=testNotification, snmpServiceStartFailed=snmpServiceStartFailed, projectDeleted=projectDeleted, projectTotalSaving=projectTotalSaving, shareIndex=shareIndex, lunIndex=lunIndex, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectQuotaFinished=projectQuotaFinished, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, poolDeleted=poolDeleted, fcTargetWriteLatency=fcTargetWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetName=iscsiTargetName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolMetaWriteLatency=poolMetaWriteLatency, lunSizeLow=lunSizeLow, notificationTime=notificationTime, shareDataSizeLow=shareDataSizeLow, notificationComponentName=notificationComponentName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolDegraded=poolDegraded, snmpServiceStopFailed=snmpServiceStopFailed, notificationSensorNumber=notificationSensorNumber, poolCount=poolCount, haControllerB_Uptime=haControllerB_Uptime, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTotalReadMbps=fcTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunProjectName=lunProjectName, poolState=poolState, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, replicationResumed=replicationResumed, projectFreeSizeHigh=projectFreeSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetWriteIops=fcTargetWriteIops, poolOwnerController=poolOwnerController, nicReceiveMbps=nicReceiveMbps, iscsiTargets=iscsiTargets, fcInitiatorIndex=fcInitiatorIndex, replicationSourceRegistered=replicationSourceRegistered, smisServiceStartFailed=smisServiceStartFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, networkIpmpGroupUp=networkIpmpGroupUp, iscsiAvgReadLatency=iscsiAvgReadLatency, projectDedupEnabled=projectDedupEnabled, diskSizeLow=diskSizeLow, diskSizeHigh=diskSizeHigh, haControllerA_Uptime=haControllerA_Uptime, poolFreeSizeLow=poolFreeSizeLow, poolDataWriteLatency=poolDataWriteLatency, projectLunCount=projectLunCount, notificationSeverity=notificationSeverity, projectLUNs=projectLUNs, poolAvgReadLatency=poolAvgReadLatency, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, lunCompressionEnabled=lunCompressionEnabled, notificationSensorAction=notificationSensorAction, network=network, fcInitiatorEntry=fcInitiatorEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcProperties=fcProperties, ipmiPowerSupply=ipmiPowerSupply, poolDataReadMbps=poolDataReadMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTotalWriteMbps=poolTotalWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolDataWriteMbps=poolDataWriteMbps, aclMigrationStarted=aclMigrationStarted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, sharePoolName=sharePoolName, notificationSensorSuspect=notificationSensorSuspect, projectShares=projectShares, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationFailed=replicationFailed, haResourceStatus=haResourceStatus, shareSnapshotSizeHigh=shareSnapshotSizeHigh, smisServiceStopped=smisServiceStopped, lunReadIops=lunReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetGroup=iscsiTargetGroup, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunReservedSizeLow=lunReservedSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", memoryFailure=memoryFailure, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationPaused=replicationPaused, iscsiTargetError=iscsiTargetError, diskChassisIdx=diskChassisIdx, upgradeStarted=upgradeStarted, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunFreeSizeHigh=lunFreeSizeHigh, diskError=diskError, iscsiTargetReadLatency=iscsiTargetReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, upgradeTimeout=upgradeTimeout, nicMTU=nicMTU, iscsiTargetAlias=iscsiTargetAlias, fcTargetReadIops=fcTargetReadIops, haResourceName=haResourceName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunSizeHigh=lunSizeHigh, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, pools=pools, shareMountPoint=shareMountPoint, basicCompliance=basicCompliance, fcTotalWriteMbps=fcTotalWriteMbps, diskAlias=diskAlias, diskDataReadIops=diskDataReadIops, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiators=iscsiInitiators, upgradeCompleted=upgradeCompleted, projectModified=projectModified, projectPoolName=projectPoolName, poolSizeLow=poolSizeLow, properties=properties, nvdimmFailSoftError=nvdimmFailSoftError, shareCIFSWriteIops=shareCIFSWriteIops, shareNFSWriteIops=shareNFSWriteIops, notificationReadingUnit=notificationReadingUnit, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskType=diskType, shareCIFSWriteMbps=shareCIFSWriteMbps, lunName=lunName, fcInitiators=fcInitiators, ipmiCurrent=ipmiCurrent, poolUsedSizeLow=poolUsedSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, lunTargetGroup=lunTargetGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceEntry=haResourceEntry, snmpServiceStarted=snmpServiceStarted, lunDataSizeHigh=lunDataSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcInitiatorName=fcInitiatorName, diskGoneOffline=diskGoneOffline, shareExceedThresholdWarning=shareExceedThresholdWarning, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, networkTotalReceiveMbps=networkTotalReceiveMbps, tegileArray=tegileArray, shareProjectName=shareProjectName, iscsiInitiatorEntry=iscsiInitiatorEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareQuotaHigh=shareQuotaHigh, poolDeletionFailed=poolDeletionFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, tegileCompliances=tegileCompliances, nicIndex=nicIndex, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, cifsAvgReadLatency=cifsAvgReadLatency, lunEntry=lunEntry, fcAvgReadLatency=fcAvgReadLatency, spareDiskReplaced=spareDiskReplaced, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, networkInterfaceDown=networkInterfaceDown, notificationTargetEntityName=notificationTargetEntityName, nfsAvgWriteLatency=nfsAvgWriteLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, lunDedupEnabled=lunDedupEnabled, haResourceDescription=haResourceDescription, snmpServiceStopped=snmpServiceStopped, fcTargetModifyCompleted=fcTargetModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetStatus=fcTargetStatus, fcTargetEntry=fcTargetEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiProperties=iscsiProperties, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, upgradeDownloadFailed=upgradeDownloadFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snmpAgentVersion=snmpAgentVersion, poolTotalReadIops=poolTotalReadIops, iscsiTargetIndex=iscsiTargetIndex, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiatorGroup=fcInitiatorGroup, haResourcesTable=haResourcesTable, snapshotCreationFailed=snapshotCreationFailed, fcTotalReadIops=fcTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, poolDataWriteIops=poolDataWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, poolEntry=poolEntry, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, userLoginFailed=userLoginFailed, lunCompressedRatio=lunCompressedRatio, iscsiTotalReadMbps=iscsiTotalReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectDataSizeLow=projectDataSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, currentObjectGroup=currentObjectGroup, shareCompressedRatio=shareCompressedRatio, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorsTable=fcInitiatorsTable, replicationComplete=replicationComplete, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, replicationTargetDeleted=replicationTargetDeleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskDataWriteMbps=diskDataWriteMbps, ipmiThreshold=ipmiThreshold, snapshotCloneCompleted=snapshotCloneCompleted, haResourceIndex=haResourceIndex, deleteFolderFailed=deleteFolderFailed, controllerTimeDrift=controllerTimeDrift, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolSizeHigh=poolSizeHigh, poolTotalReadMbps=poolTotalReadMbps, fcTargetReadMbps=fcTargetReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, poolTable=poolTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunReadMbps=lunReadMbps, diskState=diskState, shareName=shareName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolImported=poolImported, sanProperties=sanProperties, nicTable=nicTable, shareNFSReadLatency=shareNFSReadLatency, diskTable=diskTable, nicName=nicName, cpuTotalUsage=cpuTotalUsage, poolFreeSizeHigh=poolFreeSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, diskDataWriteIops=diskDataWriteIops, lunWriteLatency=lunWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeQuotaFinished=volumeQuotaFinished, poolExpanded=poolExpanded, upgradeDownloadStarted=upgradeDownloadStarted, shareCIFSReadMbps=shareCIFSReadMbps, currentNotificationGroup=currentNotificationGroup, shareQuotaFinished=shareQuotaFinished, shareEntry=shareEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, volumeModifyCompleted=volumeModifyCompleted, ipmiTemperature=ipmiTemperature, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotDeleteFailed=snapshotDeleteFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haControllerB_Name=haControllerB_Name, nicEntry=nicEntry, projectEntry=projectEntry, controllerDown=controllerDown, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, poolHealth=poolHealth, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectFreeSizeLow=projectFreeSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, disks=disks, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectIndex=projectIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, poolDataReadIops=poolDataReadIops, projectTable=projectTable, lunGUID=lunGUID, PYSNMP_MODULE_ID=tegile, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetsTable=fcTargetsTable, poolMetaReadMbps=poolMetaReadMbps, poolName=poolName, iscsiTotalReadIops=iscsiTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, poolIndex=poolIndex, haResourceActiveNode=haResourceActiveNode, replicationAbandoned=replicationAbandoned, controllerUp=controllerUp, diskRandomIOCount=diskRandomIOCount, cpuInterrupts=cpuInterrupts, poolCreated=poolCreated, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataReadLatency=poolDataReadLatency, iscsiTargetEntry=iscsiTargetEntry, notifications=notifications, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskDataReadMbps=diskDataReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotCloningFailed=snapshotCloningFailed, unknownSensorEvent=unknownSensorEvent, ipmiVoltage=ipmiVoltage, ipmiMemory=ipmiMemory, replicationAborted=replicationAborted)
