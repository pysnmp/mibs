...
Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Counter32, NotificationType, ModuleIdentity, Bits, Gauge32, enterprises, ObjectIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Counter32", "NotificationType", "ModuleIdentity", "Bits", "Gauge32", "enterprises", "ObjectIdentity", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectName=projectName, lunName=lunName, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetStatus=fcTargetStatus, shareCompressionEnabled=shareCompressionEnabled, shareQuotaHigh=shareQuotaHigh, iscsiTargetName=iscsiTargetName, targetGroupCreateCompleted=targetGroupCreateCompleted, snmpServiceStarted=snmpServiceStarted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiInitiatorIndex=iscsiInitiatorIndex, lunTable=lunTable, snmpServiceStopFailed=snmpServiceStopFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSReadIops=shareNFSReadIops, diskType=diskType, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetGroup=fcTargetGroup, lunFreeSizeHigh=lunFreeSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, tegileArray=tegileArray, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationComplete=replicationComplete, sharePoolName=sharePoolName, fcTargets=fcTargets, disks=disks, poolExpanded=poolExpanded, currentObjectGroup=currentObjectGroup, volumeDeleteFailed=volumeDeleteFailed, diskIOCount=diskIOCount, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorIndex=fcInitiatorIndex, cifsTotalReadIops=cifsTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, poolReadCacheReadIops=poolReadCacheReadIops, diskSizeLow=diskSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, poolImported=poolImported, projectPoolName=projectPoolName, haControllerA_Name=haControllerA_Name, poolTable=poolTable, fcProperties=fcProperties, projectLunCount=projectLunCount, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, tegileArray_notifications=tegileArray_notifications, poolTotalReadMbps=poolTotalReadMbps, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetsTable=fcTargetsTable, networkIpmpGroupDown=networkIpmpGroupDown, poolReadCacheWriteMbps=poolReadCacheWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectShareCount=projectShareCount, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetGroupError=iscsiTargetGroupError, tegileConformance=tegileConformance, lunDataSizeHigh=lunDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, projectLUNs=projectLUNs, maintenanceModeEnabled=maintenanceModeEnabled, diskChassisIdx=diskChassisIdx, poolDataReadIops=poolDataReadIops, cpuSystemCalls=cpuSystemCalls, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetsTable=iscsiTargetsTable, currentNotificationGroup=currentNotificationGroup, poolCount=poolCount, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorNumber=notificationSensorNumber, lunGUID=lunGUID, notificationSensorSuspect=notificationSensorSuspect, projectDataSizeHigh=projectDataSizeHigh, poolAvgReadLatency=poolAvgReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetAlias=iscsiTargetAlias, userLoginFailed=userLoginFailed, notificationDescription=notificationDescription, iscsiTargetWriteIops=iscsiTargetWriteIops, notifications=notifications, projectIndex=projectIndex, poolFreeSizeLow=poolFreeSizeLow, haControllerB_Name=haControllerB_Name, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cifsTotalReadMbps=cifsTotalReadMbps, nicIndex=nicIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolFreeSizeHigh=poolFreeSizeHigh, snmpAgentVersion=snmpAgentVersion, nfsTotalWriteMbps=nfsTotalWriteMbps, shareEntry=shareEntry, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectModified=projectModified, lunBlockSize=lunBlockSize, tegileGroups=tegileGroups, haControllerA_IPAddr=haControllerA_IPAddr, poolDataReadLatency=poolDataReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationAbandoned=replicationAbandoned, lunReadLatency=lunReadLatency, sanProperties=sanProperties, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, diskDataReadMbps=diskDataReadMbps, memoryFailure=memoryFailure, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolDataSizeHigh=poolDataSizeHigh, shareDeletionFailed=shareDeletionFailed, nicEntry=nicEntry, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcAvgWriteLatency=fcAvgWriteLatency, diskRandomIOCount=diskRandomIOCount, iscsiTargetReadMbps=iscsiTargetReadMbps, diskAlias=diskAlias, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareCIFSWriteIops=shareCIFSWriteIops, shareNFSWriteIops=shareNFSWriteIops, projectEntry=projectEntry, ipmiVoltage=ipmiVoltage, adServerTimeDrift=adServerTimeDrift, projectQuotaFinished=projectQuotaFinished, projectThresholdExceedWarning=projectThresholdExceedWarning, haResourceIndex=haResourceIndex, haResourceStatus=haResourceStatus, notificationSeverity=notificationSeverity, poolDataWriteIops=poolDataWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, smisServiceStarted=smisServiceStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerA_Uptime=haControllerA_Uptime, poolReadCacheReadMbps=poolReadCacheReadMbps, smisServiceStopped=smisServiceStopped, diskEntry=diskEntry, notificationReadingUnit=notificationReadingUnit, poolSizeHigh=poolSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, iscsiInitiatorGroup=iscsiInitiatorGroup, diskIsOnline=diskIsOnline, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolOwnerController=poolOwnerController, notificationObjects=notificationObjects, fcTargetReadIops=fcTargetReadIops, shareMountPoint=shareMountPoint, shareDataSizeLow=shareDataSizeLow, lunSizeHigh=lunSizeHigh, network=network, projectShares=projectShares, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, aclMigrationCompleted=aclMigrationCompleted, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerUp=controllerUp, fcTotalWriteMbps=fcTotalWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, pools=pools, poolUpgraded=poolUpgraded, fcTargetWriteIops=fcTargetWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCIFSReadLatency=shareCIFSReadLatency, volumeModifyCompleted=volumeModifyCompleted, PYSNMP_MODULE_ID=tegile, replicationTargetDeleted=replicationTargetDeleted, haControllerB_Uptime=haControllerB_Uptime, fcPortOnline=fcPortOnline, smisServiceStartFailed=smisServiceStartFailed, volumeQuotaFinished=volumeQuotaFinished, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, diskTable=diskTable, shareQuotaLow=shareQuotaLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, smbSocketFailure=smbSocketFailure, poolUsedSizeHigh=poolUsedSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolTotalSaving=poolTotalSaving, nicTransmitMbps=nicTransmitMbps, shareName=shareName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, poolDataWriteMbps=poolDataWriteMbps, nicReceiveMbps=nicReceiveMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationStarted=replicationStarted, lunSizeLow=lunSizeLow, controllerDown=controllerDown, poolHealth=poolHealth, shareReservedSizeLow=shareReservedSizeLow, aclMigrationStarted=aclMigrationStarted, upgradeFailed=upgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskAvgReadLatency=diskAvgReadLatency, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, diskGoneOffline=diskGoneOffline, poolCreated=poolCreated, haResourceEntry=haResourceEntry, notificationEventCode=notificationEventCode, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetIndex=iscsiTargetIndex, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolName=poolName, poolProjectCount=poolProjectCount, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cpuTotalUsage=cpuTotalUsage, poolDataSizeLow=poolDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, shareIndex=shareIndex, networkInterfaceDown=networkInterfaceDown, shareDeleted=shareDeleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetEntry=fcTargetEntry, fcInitiatorEntry=fcInitiatorEntry, poolMetaReadMbps=poolMetaReadMbps, snmpServiceStartFailed=snmpServiceStartFailed)
mibBuilder.exportSymbols("TEGILE-MIB", volumeDeleteCompleted=volumeDeleteCompleted, ipmiTemperature=ipmiTemperature, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, networkInterfaceUp=networkInterfaceUp, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorName=iscsiInitiatorName, diskDataWriteIops=diskDataWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, lunEntry=lunEntry, nicGroup=nicGroup, diskSizeHigh=diskSizeHigh, lunInitiatorGroup=lunInitiatorGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargets=iscsiTargets, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunIndex=lunIndex, iscsiTargetReadIops=iscsiTargetReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, lunFreeSizeLow=lunFreeSizeLow, shareQuotaFinished=shareQuotaFinished, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, shareProjectName=shareProjectName, poolState=poolState, poolTotalWriteIops=poolTotalWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, iscsiWriteIops=iscsiWriteIops, shareDedupEnabled=shareDedupEnabled, cacheSSDReads=cacheSSDReads, notificationComponentName=notificationComponentName, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, upgradeStarted=upgradeStarted, deleteFolderFailed=deleteFolderFailed, shareReservedSizeHigh=shareReservedSizeHigh, unknownSensorEvent=unknownSensorEvent, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskSlowIo=diskSlowIo, projectSnapshotSizeHigh=projectSnapshotSizeHigh, upgradeCompleted=upgradeCompleted, cacheTotalWriteIops=cacheTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, diskDataWriteMbps=diskDataWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, replicationFailed=replicationFailed, projectTotalSaving=projectTotalSaving, tegile=tegile, lunWriteMbps=lunWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, snmpServiceStopped=snmpServiceStopped, poolDeletionFailed=poolDeletionFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, smisServiceStopFailed=smisServiceStopFailed, ipmiCurrent=ipmiCurrent, fcTotalWriteIops=fcTotalWriteIops, cpuInterrupts=cpuInterrupts, diskIndex=diskIndex, iscsiTargetGroup=iscsiTargetGroup, projectDataSizeLow=projectDataSizeLow, diskTotalReadIops=diskTotalReadIops, haResourceName=haResourceName, nicMTU=nicMTU, fcTargetWriteLatency=fcTargetWriteLatency, poolExported=poolExported, poolProjects=poolProjects, haResourceGroup=haResourceGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, projectTable=projectTable, properties=properties, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetModifyCompleted=fcTargetModifyCompleted, fcInitiatorsTable=fcInitiatorsTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetReadLatency=fcTargetReadLatency, iscsiProperties=iscsiProperties, tegileCompliances=tegileCompliances, projectDedupEnabled=projectDedupEnabled, netbiosSocketFailure=netbiosSocketFailure, nvdimmFailSoftError=nvdimmFailSoftError, basicCompliance=basicCompliance, replicationSourceRegistered=replicationSourceRegistered, nfsTotalWriteIops=nfsTotalWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunPoolName=lunPoolName, shareExceedThresholdWarning=shareExceedThresholdWarning, diagnosticDataUploaded=diagnosticDataUploaded, ipmiPowerSupply=ipmiPowerSupply, ipmiCriticalInterrupt=ipmiCriticalInterrupt, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunWriteIops=lunWriteIops, lunProtocol=lunProtocol, poolMetaReadIops=poolMetaReadIops, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiators=iscsiInitiators, haResourcesTable=haResourcesTable, testNotification=testNotification, cifsAvgReadLatency=cifsAvgReadLatency, controllerTimeDrift=controllerTimeDrift, poolDataWriteLatency=poolDataWriteLatency, projectDeleted=projectDeleted, poolTotalReadIops=poolTotalReadIops, snapshotCreationFailed=snapshotCreationFailed, notificationTime=notificationTime, shareTable=shareTable, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunWriteLatency=lunWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, sensorFailureEvent=sensorFailureEvent, projectFreeSizeLow=projectFreeSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haResources=haResources, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nicTable=nicTable, shareNFSEnabled=shareNFSEnabled, shareNFSReadLatency=shareNFSReadLatency, diskSequentialIOCount=diskSequentialIOCount, lunReadIops=lunReadIops, haControllerB_IPAddr=haControllerB_IPAddr, nicName=nicName, fcInitiatorName=fcInitiatorName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nfsAvgWriteLatency=nfsAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, iscsiTargetAuth=iscsiTargetAuth, lunDedupEnabled=lunDedupEnabled, shareNFSReadMbps=shareNFSReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetEntry=iscsiTargetEntry, fcTotalReadIops=fcTotalReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, replicationPaused=replicationPaused, snapshotCloningFailed=snapshotCloningFailed, lunCompressedRatio=lunCompressedRatio, lunTargetGroup=lunTargetGroup, lunCompressionEnabled=lunCompressionEnabled, poolSizeLow=poolSizeLow, poolDegraded=poolDegraded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaReadLatency=poolMetaReadLatency, diskCount=diskCount, poolIndex=poolIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunReadMbps=lunReadMbps, poolQuotaFinished=poolQuotaFinished, ipmiFan=ipmiFan, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunProjectName=lunProjectName, shareCompressedRatio=shareCompressedRatio, cacheRAMReads=cacheRAMReads, poolUsedSizeLow=poolUsedSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, shareDataSizeHigh=shareDataSizeHigh, fcTargetIndex=fcTargetIndex, haResourceDescription=haResourceDescription, fcPortOffline=fcPortOffline, diskPoolName=diskPoolName, upgradeTimeout=upgradeTimeout, globalStatistics=globalStatistics, diskDataReadIops=diskDataReadIops, diskState=diskState, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiThreshold=ipmiThreshold, lunDataSizeLow=lunDataSizeLow, nicState=nicState, diskTotalWriteIops=diskTotalWriteIops, replicationAborted=replicationAborted, nfsTotalReadIops=nfsTotalReadIops, fcTargetName=fcTargetName, cifsTotalWriteIops=cifsTotalWriteIops, projectCompressionEnabled=projectCompressionEnabled, poolDeleted=poolDeleted, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiMemory=ipmiMemory, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, poolMetaWriteIops=poolMetaWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDataReadMbps=poolDataReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, diskError=diskError, snapshotRollbackCompleted=snapshotRollbackCompleted, lunReservedSizeLow=lunReservedSizeLow, notificationProps=notificationProps, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorAction=notificationSensorAction, cacheTotalReadIops=cacheTotalReadIops, fcAvgReadLatency=fcAvgReadLatency, ipmiOther=ipmiOther, iscsiTotalReadMbps=iscsiTotalReadMbps, fcInitiators=fcInitiators, poolEntry=poolEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationResumed=replicationResumed, spareDiskReplaced=spareDiskReplaced, haResourceActiveNode=haResourceActiveNode, diskTotalReadMbps=diskTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps)
