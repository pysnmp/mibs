...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:33:35 2021
...
Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, ObjectIdentity, Counter64, Bits, Unsigned32, TimeTicks, ModuleIdentity, enterprises, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "TimeTicks", "ModuleIdentity", "enterprises", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargets=iscsiTargets, projectQuotaSizeLow=projectQuotaSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, diskState=diskState, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskIsOnline=diskIsOnline, volumeModifyCompleted=volumeModifyCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, diskGoneOffline=diskGoneOffline, projectDataSizeHigh=projectDataSizeHigh, upgradeTimeout=upgradeTimeout, fcInitiatorEntry=fcInitiatorEntry, fcProperties=fcProperties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSWriteIops=shareNFSWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolTotalReadIops=poolTotalReadIops, snmpServiceStopped=snmpServiceStopped, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileArray_notifications=tegileArray_notifications, shareCIFSReadMbps=shareCIFSReadMbps, properties=properties, network=network, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, snmpServiceStopFailed=snmpServiceStopFailed, alertsCleanupCompleted=alertsCleanupCompleted, projectTable=projectTable, poolDataReadIops=poolDataReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, lunCompressedRatio=lunCompressedRatio, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, haControllerA_IPAddr=haControllerA_IPAddr, notificationReadingTriggerValue=notificationReadingTriggerValue, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCreationFailed=snapshotCreationFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSReadMbps=shareNFSReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, tegileConformance=tegileConformance, shareTable=shareTable, poolDataWriteIops=poolDataWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSizeHigh=lunSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, tegileGroups=tegileGroups, fcTargetWriteMbps=fcTargetWriteMbps, poolQuotaFinished=poolQuotaFinished, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nfsTotalReadMbps=nfsTotalReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, shareExceedThresholdWarning=shareExceedThresholdWarning, tegileArray=tegileArray, fcTotalWriteMbps=fcTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDeleted=shareDeleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolUpgraded=poolUpgraded, ipmiCriticalInterrupt=ipmiCriticalInterrupt, controllerDown=controllerDown, notificationProps=notificationProps, poolReadCacheWriteIops=poolReadCacheWriteIops, globalStatistics=globalStatistics, projectShareCount=projectShareCount, currentObjectGroup=currentObjectGroup, shareIndex=shareIndex, shareNFSWriteLatency=shareNFSWriteLatency, poolTotalReadMbps=poolTotalReadMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunDataSizeHigh=lunDataSizeHigh, projectLunCount=projectLunCount, shareCompressionEnabled=shareCompressionEnabled, poolSizeHigh=poolSizeHigh, shareName=shareName, notificationComponentName=notificationComponentName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolName=poolName, shareQuotaHigh=shareQuotaHigh, haResources=haResources, haControllerA_Name=haControllerA_Name, ipmiOther=ipmiOther, haResourceStatus=haResourceStatus, notificationReadingUnit=notificationReadingUnit, adServerTimeDrift=adServerTimeDrift, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareCIFSEnabled=shareCIFSEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, memoryFailure=memoryFailure, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationSeverity=notificationSeverity, poolDataSizeLow=poolDataSizeLow, projectIndex=projectIndex, projectFreeSizeLow=projectFreeSizeLow, lunGUID=lunGUID, diskCount=diskCount, lunReadLatency=lunReadLatency, shareNFSReadIops=shareNFSReadIops, lunSizeLow=lunSizeLow, deleteFolderFailed=deleteFolderFailed, iscsiInitiators=iscsiInitiators, iscsiTargetIndex=iscsiTargetIndex, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorName=fcInitiatorName, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareQuotaFinished=shareQuotaFinished, fcTargets=fcTargets, poolDataSizeHigh=poolDataSizeHigh, nicGroup=nicGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, nicIndex=nicIndex, lunTargetGroup=lunTargetGroup, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, unknownSensorEvent=unknownSensorEvent, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, cpuInterrupts=cpuInterrupts, fcTargetEntry=fcTargetEntry, smisServiceStarted=smisServiceStarted, snapshotCloneCompleted=snapshotCloneCompleted, poolIndex=poolIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetGroup=fcTargetGroup, volumeDeleteCompleted=volumeDeleteCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaWriteIops=poolMetaWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, targetGroupCreateCompleted=targetGroupCreateCompleted, replicationResumed=replicationResumed, tegile=tegile, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTotalReadMbps=fcTotalReadMbps, haResourceDescription=haResourceDescription, ipmiPowerSupply=ipmiPowerSupply, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiThreshold=ipmiThreshold, ipmiVoltage=ipmiVoltage, poolDataReadMbps=poolDataReadMbps, fcPortOffline=fcPortOffline, notificationTargetEntityName=notificationTargetEntityName, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiProperties=iscsiProperties, lunReservedSizeLow=lunReservedSizeLow, lunDataSizeLow=lunDataSizeLow, networkInterfaceUp=networkInterfaceUp, diskDataReadMbps=diskDataReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolTotalWriteIops=poolTotalWriteIops, diskRandomIOCount=diskRandomIOCount, lunWriteIops=lunWriteIops, notificationDescription=notificationDescription, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tdpsUpgradeFailed=tdpsUpgradeFailed, poolFreeSizeLow=poolFreeSizeLow, tegileCompliances=tegileCompliances, lunBlockSize=lunBlockSize, fcPortOnline=fcPortOnline, shareMountPoint=shareMountPoint, nfsAvgWriteLatency=nfsAvgWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolAvgWriteLatency=poolAvgWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, cacheSSDReads=cacheSSDReads, notificationSensorSuspect=notificationSensorSuspect, poolImported=poolImported, diskTotalWriteIops=diskTotalWriteIops, poolCount=poolCount, shareNFSEnabled=shareNFSEnabled, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataReadLatency=poolDataReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationStarted=replicationStarted, nfsTotalReadIops=nfsTotalReadIops, lunWriteMbps=lunWriteMbps, snmpAgentVersion=snmpAgentVersion, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareEntry=shareEntry, fcTotalWriteIops=fcTotalWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, diskTotalWriteMbps=diskTotalWriteMbps, diskDataWriteIops=diskDataWriteIops, smisServiceStopFailed=smisServiceStopFailed, projectFreeSizeHigh=projectFreeSizeHigh, nicTable=nicTable, snapshotDeleteFailed=snapshotDeleteFailed, diskIOCount=diskIOCount, shareDedupEnabled=shareDedupEnabled, lunProtocol=lunProtocol, sensorFailureEvent=sensorFailureEvent, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, basicCompliance=basicCompliance, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorsTable=fcInitiatorsTable, fcTargetStatus=fcTargetStatus, poolDataWriteMbps=poolDataWriteMbps, haControllerB_Name=haControllerB_Name, aclMigrationStarted=aclMigrationStarted, upgradeStarted=upgradeStarted, poolReadCacheReadIops=poolReadCacheReadIops, lunDedupEnabled=lunDedupEnabled, replicationAborted=replicationAborted, haResourceGroup=haResourceGroup, projectDataSizeLow=projectDataSizeLow, shareCompressedRatio=shareCompressedRatio, shareReservedSizeLow=shareReservedSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolExpanded=poolExpanded, poolState=poolState, notificationSensorNumber=notificationSensorNumber, diskTotalReadMbps=diskTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, maintenanceModeDisabled=maintenanceModeDisabled, projectPoolName=projectPoolName, shareReservedSizeHigh=shareReservedSizeHigh, haResourceActiveNode=haResourceActiveNode, cacheTotalReadIops=cacheTotalReadIops, projectTotalSaving=projectTotalSaving, lunFreeSizeHigh=lunFreeSizeHigh, diskSlowIo=diskSlowIo, networkTotalTransmitMbps=networkTotalTransmitMbps, networkInterfaceDown=networkInterfaceDown, shareNFSReadLatency=shareNFSReadLatency, shareDataSizeLow=shareDataSizeLow, diskSizeLow=diskSizeLow, maintenanceModeEnabled=maintenanceModeEnabled)
mibBuilder.exportSymbols("TEGILE-MIB", nvdimmFailSoftError=nvdimmFailSoftError, diskType=diskType, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolAvgReadLatency=poolAvgReadLatency, projectDedupEnabled=projectDedupEnabled, fcTargetIndex=fcTargetIndex, haResourceName=haResourceName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationSensorAction=notificationSensorAction, diskTable=diskTable, diskAlias=diskAlias, disks=disks, targetGroupMemberRemoved=targetGroupMemberRemoved, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetName=iscsiTargetName, projectQuotaFinished=projectQuotaFinished, replicationFailed=replicationFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolProjects=poolProjects, upgradeDownloadFailed=upgradeDownloadFailed, replicationAbandoned=replicationAbandoned, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsTotalReadMbps=cifsTotalReadMbps, nicState=nicState, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nicMTU=nicMTU, currentNotificationGroup=currentNotificationGroup, nicEntry=nicEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicTransmitMbps=nicTransmitMbps, iscsiTargetAlias=iscsiTargetAlias, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetReadIops=iscsiTargetReadIops, shareCIFSReadIops=shareCIFSReadIops, aclMigrationCompleted=aclMigrationCompleted, lunProjectName=lunProjectName, lunReadIops=lunReadIops, snmpServiceStarted=snmpServiceStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiFan=ipmiFan, upgradeFailed=upgradeFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargetsTable=iscsiTargetsTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, smbSocketFailure=smbSocketFailure, shareDataSizeHigh=shareDataSizeHigh, smisServiceStopped=smisServiceStopped, iscsiTargetWriteMbps=iscsiTargetWriteMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsAvgReadLatency=cifsAvgReadLatency, notifications=notifications, haResourcesTable=haResourcesTable, snapshotRollbackCompleted=snapshotRollbackCompleted, cifsTotalReadIops=cifsTotalReadIops, shareDeletionFailed=shareDeletionFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTotalReadMbps=iscsiTotalReadMbps, PYSNMP_MODULE_ID=tegile, lunReadMbps=lunReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, projectDeleted=projectDeleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, upgradeCompleted=upgradeCompleted, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, cpuTotalUsage=cpuTotalUsage, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolUsedSizeHigh=poolUsedSizeHigh, poolHealth=poolHealth, smisServiceStartFailed=smisServiceStartFailed, fcTargetName=fcTargetName, volumeDeleteFailed=volumeDeleteFailed, projectCompressionEnabled=projectCompressionEnabled, fcInitiators=fcInitiators, lunWriteLatency=lunWriteLatency, pools=pools, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectModified=projectModified, shareQuotaLow=shareQuotaLow, shareCreatedSuccessfully=shareCreatedSuccessfully, tdpsUpgradeCompleted=tdpsUpgradeCompleted, netbiosSocketFailure=netbiosSocketFailure, notificationObjects=notificationObjects, poolOwnerController=poolOwnerController, nicReceiveMbps=nicReceiveMbps, poolTable=poolTable, controllerUp=controllerUp, nvdimmFailInitializationError=nvdimmFailInitializationError, diskDataReadIops=diskDataReadIops, diskPoolName=diskPoolName, fcTotalReadIops=fcTotalReadIops, cpuSystemCalls=cpuSystemCalls, diskSizeHigh=diskSizeHigh, spareDiskReplaced=spareDiskReplaced, diskEntry=diskEntry, poolUsedSizeLow=poolUsedSizeLow, iscsiInitiatorName=iscsiInitiatorName, notificationTime=notificationTime, diskAvgReadLatency=diskAvgReadLatency, projectEntry=projectEntry, fcTargetsTable=fcTargetsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskSequentialIOCount=diskSequentialIOCount, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, fcAvgReadLatency=fcAvgReadLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunPoolName=lunPoolName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, fcTargetWriteIops=fcTargetWriteIops, poolDeletionFailed=poolDeletionFailed, nicName=nicName, projectSnapshotSizeLow=projectSnapshotSizeLow, diskDataWriteMbps=diskDataWriteMbps, haControllerB_Uptime=haControllerB_Uptime, projectLUNs=projectLUNs, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolMetaReadLatency=poolMetaReadLatency, userLoginFailed=userLoginFailed, diskIndex=diskIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, shareProjectName=shareProjectName, poolMetaReadIops=poolMetaReadIops, volumeQuotaFinished=volumeQuotaFinished, projectName=projectName, projectShares=projectShares, upgradeDownloadStarted=upgradeDownloadStarted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTargetReadIops=fcTargetReadIops, poolEntry=poolEntry, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, replicationPaused=replicationPaused, poolDegraded=poolDegraded, iscsiTargetEntry=iscsiTargetEntry, networkIpmpGroupDown=networkIpmpGroupDown, iscsiWriteIops=iscsiWriteIops, ipmiCurrent=ipmiCurrent, notificationEventCode=notificationEventCode, poolTotalSaving=poolTotalSaving, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunInitiatorGroup=lunInitiatorGroup, lunTable=lunTable, poolMetaReadMbps=poolMetaReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectSnapshotSizeHigh=projectSnapshotSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, lunName=lunName, fcTargetWriteLatency=fcTargetWriteLatency, poolProjectCount=poolProjectCount, shareSnapshotSizeHigh=shareSnapshotSizeHigh, replicationTargetDeleted=replicationTargetDeleted, ipmiMemory=ipmiMemory, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetReadLatency=fcTargetReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, poolSizeLow=poolSizeLow, poolDeleted=poolDeleted, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, deleteFolderCompleted=deleteFolderCompleted, networkIpmpGroupUp=networkIpmpGroupUp, sharePoolName=sharePoolName, fcInitiatorIndex=fcInitiatorIndex, diskTotalReadIops=diskTotalReadIops, lunReservedSizeHigh=lunReservedSizeHigh, testNotification=testNotification, controllerHardwareModel=controllerHardwareModel, iscsiTargetGroup=iscsiTargetGroup, ipmiTemperature=ipmiTemperature, poolCreated=poolCreated, shareNFSWriteMbps=shareNFSWriteMbps, lunEntry=lunEntry, replicationComplete=replicationComplete, cacheTotalReadMbps=cacheTotalReadMbps, haResourceIndex=haResourceIndex, diskError=diskError, iscsiTargetError=iscsiTargetError, diskChassisIdx=diskChassisIdx, iscsiTargetGroupError=iscsiTargetGroupError, controllerTimeDrift=controllerTimeDrift, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolExported=poolExported, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, sanProperties=sanProperties, cacheRAMReads=cacheRAMReads, iscsiTargetAuth=iscsiTargetAuth, lunIndex=lunIndex)
