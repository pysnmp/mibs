...
# Produced by pysmi-1.1.12 at Tue May 28 14:04:16 2024
...
Counter64, Unsigned32, Gauge32, IpAddress, Integer32, iso, ModuleIdentity, Bits, TimeTicks, ObjectIdentity, NotificationType, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Gauge32", "IpAddress", "Integer32", "iso", "ModuleIdentity", "Bits", "TimeTicks", "ObjectIdentity", "NotificationType", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, upgradeDownloadStarted=upgradeDownloadStarted, nicTransmitMbps=nicTransmitMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, replicationAborted=replicationAborted, diskType=diskType, smisServiceStopFailed=smisServiceStopFailed, poolFreeSizeHigh=poolFreeSizeHigh, deleteFolderCompleted=deleteFolderCompleted, shareQuotaLow=shareQuotaLow, notificationSensorSuspect=notificationSensorSuspect, projectPoolName=projectPoolName, projectModified=projectModified, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ipmiPowerSupply=ipmiPowerSupply, poolDataWriteMbps=poolDataWriteMbps, networkInterfaceDown=networkInterfaceDown, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, fcInitiatorIndex=fcInitiatorIndex, shareNFSReadIops=shareNFSReadIops, cpuSystemCalls=cpuSystemCalls, poolCount=poolCount, lunSizeLow=lunSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetError=iscsiTargetError, nfsAvgWriteLatency=nfsAvgWriteLatency, projectDeleted=projectDeleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskSequentialIOCount=diskSequentialIOCount, cifsTotalReadIops=cifsTotalReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolOwnerController=poolOwnerController, tegileCompliances=tegileCompliances, fcInitiatorEntry=fcInitiatorEntry, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetEntry=iscsiTargetEntry, volumeQuotaFinished=volumeQuotaFinished, poolQuotaFinished=poolQuotaFinished, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDegraded=poolDegraded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, smbSocketFailure=smbSocketFailure, haResourceEntry=haResourceEntry, replicationSourceRegistered=replicationSourceRegistered, shareDeleted=shareDeleted, tegileGroups=tegileGroups, poolMetaReadIops=poolMetaReadIops, poolDataWriteLatency=poolDataWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, diskChassisIdx=diskChassisIdx, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationSensorNumber=notificationSensorNumber, upgradeTimeout=upgradeTimeout, fcTotalReadIops=fcTotalReadIops, lunName=lunName, PYSNMP_MODULE_ID=tegile, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectShares=projectShares, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, globalStatistics=globalStatistics, fcInitiators=fcInitiators, intelliFlashSoftwareDown=intelliFlashSoftwareDown, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReadIops=lunReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectIndex=projectIndex, cacheSSDReads=cacheSSDReads, notificationTime=notificationTime, controllerHardwareModel=controllerHardwareModel, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cacheTotalReadMbps=cacheTotalReadMbps, nicName=nicName, lunTargetGroup=lunTargetGroup, snmpServiceStopped=snmpServiceStopped, nfsAvgReadLatency=nfsAvgReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetWriteMbps=fcTargetWriteMbps, iscsiWriteIops=iscsiWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, diskSizeHigh=diskSizeHigh, tegileArray_notifications=tegileArray_notifications, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareCIFSReadIops=shareCIFSReadIops, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, projectDataSizeHigh=projectDataSizeHigh, aclMigrationCompleted=aclMigrationCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, deleteFolderFailed=deleteFolderFailed, cacheTotalWriteIops=cacheTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, nicTable=nicTable, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceActiveNode=haResourceActiveNode, shareNFSEnabled=shareNFSEnabled, aclMigrationStarted=aclMigrationStarted, currentObjectGroup=currentObjectGroup, shareEntry=shareEntry, fcTargets=fcTargets, poolUsedSizeHigh=poolUsedSizeHigh, sanProperties=sanProperties, poolTotalWriteMbps=poolTotalWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cpuInterrupts=cpuInterrupts, diskTotalWriteIops=diskTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, upgradeDownloadFailed=upgradeDownloadFailed, fcInitiatorGroup=fcInitiatorGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCompressedRatio=shareCompressedRatio, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskIsOnline=diskIsOnline, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourcesTable=haResourcesTable, testNotification=testNotification, snmpServiceStopFailed=snmpServiceStopFailed, ipmiTemperature=ipmiTemperature, fcTotalReadMbps=fcTotalReadMbps, shareReservedSizeLow=shareReservedSizeLow, poolCreated=poolCreated, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeStarted=upgradeStarted, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSWriteIops=shareNFSWriteIops, poolImported=poolImported, lunBlockSize=lunBlockSize, memoryFailure=memoryFailure, fcTargetIndex=fcTargetIndex, iscsiTargetReadIops=iscsiTargetReadIops, poolEntry=poolEntry, shareNFSReadMbps=shareNFSReadMbps, notificationTargetEntityName=notificationTargetEntityName, smisServiceStarted=smisServiceStarted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeCompleted=tdpsUpgradeCompleted, ipmiThreshold=ipmiThreshold, ipmiVoltage=ipmiVoltage, lunTable=lunTable, lunFreeSizeHigh=lunFreeSizeHigh, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snapshotCloningFailed=snapshotCloningFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, nicState=nicState, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunDedupEnabled=lunDedupEnabled, adServerTimeDrift=adServerTimeDrift, haResourceIndex=haResourceIndex, upgradeFailed=upgradeFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetGroupError=iscsiTargetGroupError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiProperties=iscsiProperties, diskDataWriteMbps=diskDataWriteMbps, poolState=poolState, properties=properties, replicationPaused=replicationPaused, poolTotalReadMbps=poolTotalReadMbps, ipmiOther=ipmiOther, haResources=haResources, shareCIFSReadMbps=shareCIFSReadMbps, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteMbps=fcTotalWriteMbps, tegileArray=tegileArray, iscsiAvgWriteLatency=iscsiAvgWriteLatency, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunReservedSizeLow=lunReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectLUNs=projectLUNs, poolAvgWriteLatency=poolAvgWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, poolUsedSizeLow=poolUsedSizeLow, diskSizeLow=diskSizeLow, fcTargetEntry=fcTargetEntry, poolAvgReadLatency=poolAvgReadLatency, tegile=tegile, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetGroup=fcTargetGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareDedupEnabled=shareDedupEnabled, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTable=diskTable, shareReservedSizeHigh=shareReservedSizeHigh, ipmiCurrent=ipmiCurrent, webdocsUpgradeFailed=webdocsUpgradeFailed, diskAvgWriteLatency=diskAvgWriteLatency, projectTable=projectTable, diskEntry=diskEntry, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectQuotaSizeHigh=projectQuotaSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationReadingUnit=notificationReadingUnit, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, alertsCleanupCompleted=alertsCleanupCompleted, projectDedupEnabled=projectDedupEnabled, lunWriteLatency=lunWriteLatency, iscsiInitiators=iscsiInitiators, lunIndex=lunIndex, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationReadingTriggerValue=notificationReadingTriggerValue, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, basicCompliance=basicCompliance, lunPoolName=lunPoolName, fcProperties=fcProperties, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicMTU=nicMTU, shareTable=shareTable, notificationEventCode=notificationEventCode, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiTargets=iscsiTargets, iscsiTargetAlias=iscsiTargetAlias, haResourceName=haResourceName, poolProjectCount=poolProjectCount, shareExceedThresholdWarning=shareExceedThresholdWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, poolMetaWriteIops=poolMetaWriteIops, shareQuotaFinished=shareQuotaFinished)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTotalReadIops=iscsiTotalReadIops, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, haControllerB_Name=haControllerB_Name, iscsiInitiatorIndex=iscsiInitiatorIndex, fcPortOffline=fcPortOffline, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolExported=poolExported, replicationStarted=replicationStarted, volumeDeleteFailed=volumeDeleteFailed, poolTable=poolTable, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetStatus=fcTargetStatus, fcAvgReadLatency=fcAvgReadLatency, lunReadMbps=lunReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, nicEntry=nicEntry, lunSizeHigh=lunSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, shareName=shareName, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetAuth=iscsiTargetAuth, ntpServerTimeDrift=ntpServerTimeDrift, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectFreeSizeLow=projectFreeSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareProjectName=shareProjectName, iscsiTargetName=iscsiTargetName, nicIndex=nicIndex, volumeModifyCompleted=volumeModifyCompleted, notificationObjects=notificationObjects, nvdimmFailInitializationError=nvdimmFailInitializationError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectShareCount=projectShareCount, poolName=poolName, projectLunCount=projectLunCount, poolDeleted=poolDeleted, diskCount=diskCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snapshotCloneCompleted=snapshotCloneCompleted, poolDataSizeLow=poolDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, shareCIFSEnabled=shareCIFSEnabled, lunProjectName=lunProjectName, poolDataSizeHigh=poolDataSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, poolDataReadMbps=poolDataReadMbps, fcInitiatorsTable=fcInitiatorsTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskError=diskError, haControllerA_IPAddr=haControllerA_IPAddr, spareDiskReplaced=spareDiskReplaced, shareCompressionEnabled=shareCompressionEnabled, shareQuotaHigh=shareQuotaHigh, poolSizeLow=poolSizeLow, poolExpanded=poolExpanded, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskDataReadIops=diskDataReadIops, ipmiMemory=ipmiMemory, network=network, lunReadLatency=lunReadLatency, shareDataSizeHigh=shareDataSizeHigh, controllerUp=controllerUp, sensorFailureEvent=sensorFailureEvent, replicationTargetDeleted=replicationTargetDeleted, upgradeCompleted=upgradeCompleted, diskGoneOffline=diskGoneOffline, pools=pools, replicationResumed=replicationResumed, snapshotRollbackFailed=snapshotRollbackFailed, notificationDescription=notificationDescription, lunEntry=lunEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolTotalSaving=poolTotalSaving, lunDataSizeHigh=lunDataSizeHigh, unknownSensorEvent=unknownSensorEvent, projectDataSizeLow=projectDataSizeLow, cacheTotalReadIops=cacheTotalReadIops, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, controllerTimeDrift=controllerTimeDrift, poolMetaWriteMbps=poolMetaWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareIndex=shareIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nicGroup=nicGroup, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskIndex=diskIndex, diskAlias=diskAlias, fcInitiatorName=fcInitiatorName, notifications=notifications, replicationFailed=replicationFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetWriteIops=fcTargetWriteIops, disks=disks, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskTotalReadIops=diskTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetName=fcTargetName, replicationComplete=replicationComplete, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nfsTotalReadIops=nfsTotalReadIops, tegileConformance=tegileConformance, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataReadIops=poolDataReadIops, poolUpgraded=poolUpgraded, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskPoolName=diskPoolName, lunReservedSizeHigh=lunReservedSizeHigh, poolProjects=poolProjects, shareNFSReadLatency=shareNFSReadLatency, controllerDown=controllerDown, netbiosSocketFailure=netbiosSocketFailure, projectTotalSaving=projectTotalSaving, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolDataReadLatency=poolDataReadLatency, projectName=projectName, iscsiTargetWriteIops=iscsiTargetWriteIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTotalWriteIops=fcTotalWriteIops, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, projectEntry=projectEntry, vmwareNFSDatastores=vmwareNFSDatastores, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetWriteLatency=fcTargetWriteLatency, projectQuotaFinished=projectQuotaFinished, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationComponentName=notificationComponentName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, lunProtocol=lunProtocol, cacheRAMReads=cacheRAMReads, projectCreatedSuccessfully=projectCreatedSuccessfully, poolSizeHigh=poolSizeHigh, haControllerA_Uptime=haControllerA_Uptime, diskDataReadMbps=diskDataReadMbps, diskSlowIo=diskSlowIo, lunGUID=lunGUID, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcPortOnline=fcPortOnline, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetReadLatency=fcTargetReadLatency, poolTotalReadIops=poolTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunCompressedRatio=lunCompressedRatio, lunWriteMbps=lunWriteMbps, diskIOCount=diskIOCount, lunWriteIops=lunWriteIops, haResourceDescription=haResourceDescription, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetReadIops=fcTargetReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetsTable=fcTargetsTable, diskAvgReadLatency=diskAvgReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, poolHealth=poolHealth, projectCompressionEnabled=projectCompressionEnabled, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareCIFSWriteIops=shareCIFSWriteIops, userLoginFailed=userLoginFailed, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, snmpAgentVersion=snmpAgentVersion, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haControllerB_Uptime=haControllerB_Uptime, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, networkInterfaceUp=networkInterfaceUp, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationProps=notificationProps, iscsiTargetsTable=iscsiTargetsTable, haControllerB_IPAddr=haControllerB_IPAddr, ipmiFan=ipmiFan, haResourceGroup=haResourceGroup, diskState=diskState, sharePoolName=sharePoolName, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicReceiveMbps=nicReceiveMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationSensorAction=notificationSensorAction, poolIndex=poolIndex, diskRandomIOCount=diskRandomIOCount, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haResourceStatus=haResourceStatus, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolReadCacheReadIops=poolReadCacheReadIops, shareDeletionFailed=shareDeletionFailed, cifsTotalReadMbps=cifsTotalReadMbps, poolDataWriteIops=poolDataWriteIops, smisServiceStopped=smisServiceStopped, shareMountPoint=shareMountPoint, smisServiceStartFailed=smisServiceStartFailed, notificationSeverity=notificationSeverity, poolDeletionFailed=poolDeletionFailed, shareDataSizeLow=shareDataSizeLow)
