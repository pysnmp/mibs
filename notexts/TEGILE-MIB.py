...
Unsigned32, enterprises, ObjectIdentity, Gauge32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter64, Counter32, ModuleIdentity, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "ObjectIdentity", "Gauge32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter64", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, lunProjectName=lunProjectName, projectModified=projectModified, iscsiInitiators=iscsiInitiators, poolReadCacheWriteIops=poolReadCacheWriteIops, notificationObjects=notificationObjects, diagnosticDataUploaded=diagnosticDataUploaded, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunSizeHigh=lunSizeHigh, poolDataSizeLow=poolDataSizeLow, diskDataWriteIops=diskDataWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, spareDiskReplaced=spareDiskReplaced, projectSnapshotSizeLow=projectSnapshotSizeLow, poolExported=poolExported, shareIndex=shareIndex, poolDeletionFailed=poolDeletionFailed, smisServiceStarted=smisServiceStarted, vmwareNFSDatastores=vmwareNFSDatastores, poolDataSizeHigh=poolDataSizeHigh, lunWriteIops=lunWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaWriteIops=poolMetaWriteIops, ipmiThreshold=ipmiThreshold, replicationAborted=replicationAborted, fcAvgWriteLatency=fcAvgWriteLatency, networkInterfaceUp=networkInterfaceUp, cacheTotalReadIops=cacheTotalReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunReservedSizeHigh=lunReservedSizeHigh, fcTotalReadIops=fcTotalReadIops, iscsiTargetAuth=iscsiTargetAuth, poolReadCacheReadMbps=poolReadCacheReadMbps, shareNFSReadLatency=shareNFSReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolState=poolState, poolAvgReadLatency=poolAvgReadLatency, replicationPaused=replicationPaused, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareCompressionEnabled=shareCompressionEnabled, disks=disks, ipmiFan=ipmiFan, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetWriteMbps=fcTargetWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolSizeLow=poolSizeLow, poolUpgraded=poolUpgraded, currentObjectGroup=currentObjectGroup, memoryFailure=memoryFailure, poolTotalSaving=poolTotalSaving, lunInitiatorGroup=lunInitiatorGroup, diskRandomIOCount=diskRandomIOCount, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tegileCompliances=tegileCompliances, poolDataWriteMbps=poolDataWriteMbps, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTable=poolTable, snmpServiceStopped=snmpServiceStopped, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, fcPortOffline=fcPortOffline, fcTargets=fcTargets, shareExceedThresholdWarning=shareExceedThresholdWarning, projectTotalSaving=projectTotalSaving, iscsiTargetGroup=iscsiTargetGroup, diskTotalWriteMbps=diskTotalWriteMbps, unknownSensorEvent=unknownSensorEvent, tegile=tegile, fcTargetGroup=fcTargetGroup, haControllerA_Name=haControllerA_Name, poolMetaWriteLatency=poolMetaWriteLatency, networkInterfaceDown=networkInterfaceDown, projectLunCount=projectLunCount, fcTargetReadLatency=fcTargetReadLatency, controllerTimeDrift=controllerTimeDrift, poolReadCacheReadIops=poolReadCacheReadIops, shareNFSEnabled=shareNFSEnabled, currentNotificationGroup=currentNotificationGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, notificationProps=notificationProps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, smbSocketFailure=smbSocketFailure, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cifsTotalReadIops=cifsTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, lunTable=lunTable, testNotification=testNotification, projectDeletionFailed=projectDeletionFailed, lunDataSizeHigh=lunDataSizeHigh, poolTotalWriteIops=poolTotalWriteIops, fcTargetEntry=fcTargetEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, lunProtocol=lunProtocol, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStarted=snmpServiceStarted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicReceiveMbps=nicReceiveMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunWriteLatency=lunWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReadLatency=lunReadLatency, lunDataSizeLow=lunDataSizeLow, projectIndex=projectIndex, fcTargetIndex=fcTargetIndex, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResourceActiveNode=haResourceActiveNode, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalReadIops=poolTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, ipmiOther=ipmiOther, shareQuotaFinished=shareQuotaFinished, lunFreeSizeHigh=lunFreeSizeHigh, poolCount=poolCount, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTotalWriteIops=fcTotalWriteIops, poolDataWriteLatency=poolDataWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolImported=poolImported, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, cpuSystemCalls=cpuSystemCalls, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolAvgWriteLatency=poolAvgWriteLatency, notificationEventCode=notificationEventCode, projectShareCount=projectShareCount, diskTotalReadIops=diskTotalReadIops, adServerTimeDrift=adServerTimeDrift, poolReadCacheWriteLatency=poolReadCacheWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, aclMigrationCompleted=aclMigrationCompleted, upgradeTimeout=upgradeTimeout, nicTable=nicTable, volumeDeleteCompleted=volumeDeleteCompleted, diskSlowIo=diskSlowIo, diskSizeHigh=diskSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, PYSNMP_MODULE_ID=tegile, poolEntry=poolEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotDeleteFailed=snapshotDeleteFailed, diskIndex=diskIndex, tegileArray_notifications=tegileArray_notifications, iscsiTargets=iscsiTargets, nfsTotalWriteIops=nfsTotalWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, tegileGroups=tegileGroups, diskAlias=diskAlias, shareTable=shareTable, poolDataWriteIops=poolDataWriteIops, notificationReadingUnit=notificationReadingUnit, upgradeFailed=upgradeFailed, lunCompressedRatio=lunCompressedRatio, ntpServerTimeDrift=ntpServerTimeDrift, ipmiMemory=ipmiMemory, haResourceDescription=haResourceDescription, diskTable=diskTable, upgradeStarted=upgradeStarted, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiTemperature=ipmiTemperature, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, snapshotRollbackFailed=snapshotRollbackFailed, fcPortOnline=fcPortOnline, replicationComplete=replicationComplete, poolUsedSizeHigh=poolUsedSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, aclMigrationStarted=aclMigrationStarted, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haResources=haResources, poolHealth=poolHealth, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cifsAvgReadLatency=cifsAvgReadLatency, diskEntry=diskEntry, fcTargetReadIops=fcTargetReadIops, replicationSourceRegistered=replicationSourceRegistered, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationSensorAction=notificationSensorAction, fcTargetStatus=fcTargetStatus, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, haResourceEntry=haResourceEntry, poolCreated=poolCreated, diskDataWriteMbps=diskDataWriteMbps, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetIndex=iscsiTargetIndex, shareDeleted=shareDeleted, snmpAgentVersion=snmpAgentVersion, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareReservedSizeHigh=shareReservedSizeHigh, shareQuotaHigh=shareQuotaHigh, lunReadIops=lunReadIops, shareDeletionFailed=shareDeletionFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, diskState=diskState, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, maintenanceModeEnabled=maintenanceModeEnabled, snapshotCloningFailed=snapshotCloningFailed, controllerUp=controllerUp, tegileArray=tegileArray, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareProjectName=shareProjectName, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolUsedSizeLow=poolUsedSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunReservedSizeLow=lunReservedSizeLow, nicIndex=nicIndex, poolProjects=poolProjects, poolIndex=poolIndex, diskCount=diskCount, projectQuotaFinished=projectQuotaFinished, projectEntry=projectEntry, shareName=shareName, poolDeleted=poolDeleted, fcTargetsTable=fcTargetsTable)
mibBuilder.exportSymbols("TEGILE-MIB", diskIsOnline=diskIsOnline, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, poolOwnerController=poolOwnerController, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectLUNs=projectLUNs, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicMTU=nicMTU, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskSequentialIOCount=diskSequentialIOCount, notificationSensorNumber=notificationSensorNumber, poolExpanded=poolExpanded, nicName=nicName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, replicationFailed=replicationFailed, haControllerA_IPAddr=haControllerA_IPAddr, projectFreeSizeLow=projectFreeSizeLow, shareDataSizeHigh=shareDataSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, basicCompliance=basicCompliance, fcTargetWriteIops=fcTargetWriteIops, shareQuotaLow=shareQuotaLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskChassisIdx=diskChassisIdx, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectName=projectName, diskIOCount=diskIOCount, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetEntry=iscsiTargetEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, lunDedupEnabled=lunDedupEnabled, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetAlias=iscsiTargetAlias, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haResourceIndex=haResourceIndex, diskDataReadIops=diskDataReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicState=nicState, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareDedupEnabled=shareDedupEnabled, lunSnapshotSizeLow=lunSnapshotSizeLow, projectShares=projectShares, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, fcInitiators=fcInitiators, poolMetaReadLatency=poolMetaReadLatency, shareCIFSEnabled=shareCIFSEnabled, fcTargetName=fcTargetName, iscsiProperties=iscsiProperties, poolFreeSizeLow=poolFreeSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, tegileConformance=tegileConformance, volumeQuotaFinished=volumeQuotaFinished, nfsTotalReadIops=nfsTotalReadIops, diskError=diskError, iscsiWriteIops=iscsiWriteIops, poolTotalReadMbps=poolTotalReadMbps, notifications=notifications, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareNFSReadIops=shareNFSReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectDataSizeLow=projectDataSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, pools=pools, controllerHardwareModel=controllerHardwareModel, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareNFSWriteIops=shareNFSWriteIops, replicationStarted=replicationStarted, notificationDescription=notificationDescription, projectTable=projectTable, iscsiTargetName=iscsiTargetName, lunReadMbps=lunReadMbps, haControllerB_Uptime=haControllerB_Uptime, fcTotalReadMbps=fcTotalReadMbps, upgradeCompleted=upgradeCompleted, fcInitiatorGroup=fcInitiatorGroup, lunGUID=lunGUID, iscsiTargetReadMbps=iscsiTargetReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolDataReadMbps=poolDataReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, networkTotalReceiveMbps=networkTotalReceiveMbps, projectDeleted=projectDeleted, iscsiTargetError=iscsiTargetError, notificationSeverity=notificationSeverity, lunFreeSizeLow=lunFreeSizeLow, replicationAbandoned=replicationAbandoned, poolProjectCount=poolProjectCount, iscsiTargetGroupError=iscsiTargetGroupError, haResourceGroup=haResourceGroup, projectPoolName=projectPoolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicGroup=nicGroup, shareNFSReadMbps=shareNFSReadMbps, poolName=poolName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haControllerA_Uptime=haControllerA_Uptime, snapshotCreationFailed=snapshotCreationFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, smisServiceStartFailed=smisServiceStartFailed, cacheSSDReads=cacheSSDReads, sharePoolName=sharePoolName, shareMountPoint=shareMountPoint, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskSizeLow=diskSizeLow, volumeDeleteFailed=volumeDeleteFailed, controllerDown=controllerDown, haResourceStatus=haResourceStatus, nicEntry=nicEntry, fcInitiatorsTable=fcInitiatorsTable, projectDataSizeHigh=projectDataSizeHigh, poolDataReadLatency=poolDataReadLatency, ipmiPowerSupply=ipmiPowerSupply, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcInitiatorName=fcInitiatorName, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, targetGroupMemberAdded=targetGroupMemberAdded, network=network, haControllerB_IPAddr=haControllerB_IPAddr, cpuInterrupts=cpuInterrupts, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationTargetEntityName=notificationTargetEntityName, diskAvgWriteLatency=diskAvgWriteLatency, diskDataReadMbps=diskDataReadMbps, poolDegraded=poolDegraded, shareCIFSReadLatency=shareCIFSReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcProperties=fcProperties, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunName=lunName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunIndex=lunIndex, snmpServiceStartFailed=snmpServiceStartFailed, deleteFolderCompleted=deleteFolderCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskTotalReadMbps=diskTotalReadMbps, poolMetaReadIops=poolMetaReadIops, nfsAvgReadLatency=nfsAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, nicTransmitMbps=nicTransmitMbps, diskPoolName=diskPoolName, shareDataSizeLow=shareDataSizeLow, globalStatistics=globalStatistics, poolDataReadIops=poolDataReadIops, lunBlockSize=lunBlockSize, cpuTotalUsage=cpuTotalUsage, lunEntry=lunEntry, userLoginFailed=userLoginFailed, lunSizeLow=lunSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, deleteFolderFailed=deleteFolderFailed, replicationTargetDeleted=replicationTargetDeleted, nvdimmFailUnknownError=nvdimmFailUnknownError, shareEntry=shareEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, ipmiCurrent=ipmiCurrent, fcTargetReadMbps=fcTargetReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, haResourcesTable=haResourcesTable, fcInitiatorIndex=fcInitiatorIndex, snmpServiceStopFailed=snmpServiceStopFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetsTable=iscsiTargetsTable, fcInitiatorEntry=fcInitiatorEntry, cacheRAMReads=cacheRAMReads, ipmiVoltage=ipmiVoltage, properties=properties, smisServiceStopped=smisServiceStopped, notificationTime=notificationTime, diskTotalWriteIops=diskTotalWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, diskType=diskType, shareCompressedRatio=shareCompressedRatio, poolSizeHigh=poolSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, lunPoolName=lunPoolName, shareReservedSizeLow=shareReservedSizeLow, notificationSensorSuspect=notificationSensorSuspect, sanProperties=sanProperties, cacheTotalReadMbps=cacheTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, haResourceName=haResourceName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationComponentName=notificationComponentName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, replicationResumed=replicationResumed, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTotalReadIops=iscsiTotalReadIops, diskGoneOffline=diskGoneOffline, projectDedupEnabled=projectDedupEnabled)
