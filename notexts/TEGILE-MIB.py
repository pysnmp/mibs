...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:54:32 2021
...
Counter64, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, enterprises, iso, Unsigned32, TimeTicks, NotificationType, IpAddress, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "enterprises", "iso", "Unsigned32", "TimeTicks", "NotificationType", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeFailed=webdocsUpgradeFailed, replicationResumed=replicationResumed, fcInitiatorName=fcInitiatorName, diskTable=diskTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolDataSizeLow=poolDataSizeLow, lunWriteMbps=lunWriteMbps, ipmiFan=ipmiFan, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cacheRAMReads=cacheRAMReads, projectDeletionFailed=projectDeletionFailed, spareDiskReplaced=spareDiskReplaced, controllerHardwareModel=controllerHardwareModel, shareCIFSReadIops=shareCIFSReadIops, notificationTime=notificationTime, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationStarted=replicationStarted, projectCreatedSuccessfully=projectCreatedSuccessfully, ipmiPowerSupply=ipmiPowerSupply, iscsiProperties=iscsiProperties, nicEntry=nicEntry, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetName=fcTargetName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolMetaReadMbps=poolMetaReadMbps, poolDataSizeHigh=poolDataSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, poolDataReadIops=poolDataReadIops, poolMetaWriteMbps=poolMetaWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunReservedSizeLow=lunReservedSizeLow, nicTable=nicTable, shareName=shareName, shareSnapshotSizeLow=shareSnapshotSizeLow, snmpServiceStopped=snmpServiceStopped, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareNFSReadIops=shareNFSReadIops, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskIsOnline=diskIsOnline, lunIndex=lunIndex, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectQuotaFinished=projectQuotaFinished, haControllerA_IPAddr=haControllerA_IPAddr, sanProperties=sanProperties, diskAlias=diskAlias, fcTargetIndex=fcTargetIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cifsTotalWriteMbps=cifsTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, haControllerA_Uptime=haControllerA_Uptime, maintenanceModeEnabled=maintenanceModeEnabled, lunFreeSizeLow=lunFreeSizeLow, aclMigrationStarted=aclMigrationStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectTable=projectTable, deleteFolderCompleted=deleteFolderCompleted, upgradeCompleted=upgradeCompleted, snmpServiceStarted=snmpServiceStarted, replicationTargetDeleted=replicationTargetDeleted, diskSizeHigh=diskSizeHigh, nicName=nicName, diskTotalReadIops=diskTotalReadIops, fcTotalReadMbps=fcTotalReadMbps, lunEntry=lunEntry, cifsTotalWriteIops=cifsTotalWriteIops, projectEntry=projectEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, cifsTotalReadIops=cifsTotalReadIops, shareDataSizeLow=shareDataSizeLow, projectDataSizeLow=projectDataSizeLow, diskError=diskError, poolDataReadLatency=poolDataReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, lunTable=lunTable, nicReceiveMbps=nicReceiveMbps, poolTable=poolTable, iscsiTargetsTable=iscsiTargetsTable, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationSensorSuspect=notificationSensorSuspect, fcTotalWriteIops=fcTotalWriteIops, poolName=poolName, projectShares=projectShares, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, volumeModifyCompleted=volumeModifyCompleted, testNotification=testNotification, iscsiTargetName=iscsiTargetName, smisServiceStarted=smisServiceStarted, diskDataWriteIops=diskDataWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, userLoginFailed=userLoginFailed, alertsCleanupCompleted=alertsCleanupCompleted, ipmiVoltage=ipmiVoltage, poolQuotaFinished=poolQuotaFinished, diskAvgReadLatency=diskAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetWriteIops=fcTargetWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nvdimmFailUnknownError=nvdimmFailUnknownError, poolCreated=poolCreated, poolCount=poolCount, projectQuotaSizeHigh=projectQuotaSizeHigh, lunCompressedRatio=lunCompressedRatio, shareCreatedSuccessfully=shareCreatedSuccessfully, haControllerB_Uptime=haControllerB_Uptime, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeDownloadStarted=upgradeDownloadStarted, poolAvgWriteLatency=poolAvgWriteLatency, projectLunCount=projectLunCount, networkInterfaceDown=networkInterfaceDown, projectPoolName=projectPoolName, nfsAvgWriteLatency=nfsAvgWriteLatency, haResourceStatus=haResourceStatus, fcAvgWriteLatency=fcAvgWriteLatency, lunPoolName=lunPoolName, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetGroup=iscsiTargetGroup, lunReservedSizeHigh=lunReservedSizeHigh, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, cpuInterrupts=cpuInterrupts, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDataReadMbps=poolDataReadMbps, smbSocketFailure=smbSocketFailure, diskDataWriteMbps=diskDataWriteMbps, poolImported=poolImported, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunTargetGroup=lunTargetGroup, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunReadMbps=lunReadMbps, deleteFolderFailed=deleteFolderFailed, iscsiTargetIndex=iscsiTargetIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunProjectName=lunProjectName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolFreeSizeHigh=poolFreeSizeHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeFailed=upgradeFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, properties=properties, projectQuotaSizeLow=projectQuotaSizeLow, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareDedupEnabled=shareDedupEnabled, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, networkTotalReceiveMbps=networkTotalReceiveMbps, smisServiceStartFailed=smisServiceStartFailed, notificationReadingUnit=notificationReadingUnit, smisServiceStopped=smisServiceStopped, nfsTotalReadIops=nfsTotalReadIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailDeviceError=nvdimmFailDeviceError, nvdimmFailInitializationError=nvdimmFailInitializationError, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcInitiatorGroup=fcInitiatorGroup, poolExpanded=poolExpanded, fcTotalReadIops=fcTotalReadIops, adServerTimeDrift=adServerTimeDrift, haResourceDescription=haResourceDescription, poolUpgraded=poolUpgraded, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolProjectCount=poolProjectCount, poolUsedSizeHigh=poolUsedSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, diskSequentialIOCount=diskSequentialIOCount, tegileCompliances=tegileCompliances, haResourceIndex=haResourceIndex, iscsiTotalReadMbps=iscsiTotalReadMbps, smisServiceStopFailed=smisServiceStopFailed, shareQuotaFinished=shareQuotaFinished, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCompressedRatio=shareCompressedRatio, sharePoolName=sharePoolName, snapshotDeleteFailed=snapshotDeleteFailed, diskIndex=diskIndex, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSizeLow=lunSizeLow, ipmiThreshold=ipmiThreshold, lunName=lunName, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, lunWriteIops=lunWriteIops, notificationObjects=notificationObjects, shareMountPoint=shareMountPoint, snmpServiceStartFailed=snmpServiceStartFailed, volumeDeleteFailed=volumeDeleteFailed, snapshotRollbackFailed=snapshotRollbackFailed, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetEntry=iscsiTargetEntry, targetGroupCreateCompleted=targetGroupCreateCompleted, fcPortOffline=fcPortOffline, fcInitiators=fcInitiators, shareTable=shareTable, diskChassisIdx=diskChassisIdx, basicCompliance=basicCompliance, shareReservedSizeHigh=shareReservedSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetReadLatency=fcTargetReadLatency, iscsiInitiatorName=iscsiInitiatorName, projectSnapshotSizeLow=projectSnapshotSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteIops=diskTotalWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, haResourceActiveNode=haResourceActiveNode, networkIpmpGroupUp=networkIpmpGroupUp, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDeletionFailed=poolDeletionFailed, shareNFSEnabled=shareNFSEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorsTable=fcInitiatorsTable, poolDataWriteIops=poolDataWriteIops, diskSlowIo=diskSlowIo, nfsTotalWriteMbps=nfsTotalWriteMbps, shareNFSWriteIops=shareNFSWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunDataSizeLow=lunDataSizeLow, projectName=projectName, currentNotificationGroup=currentNotificationGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, haControllerB_Name=haControllerB_Name, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunBlockSize=lunBlockSize, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, sensorFailureEvent=sensorFailureEvent, fcTargets=fcTargets, projectIndex=projectIndex, shareCIFSEnabled=shareCIFSEnabled)
mibBuilder.exportSymbols("TEGILE-MIB", poolHealth=poolHealth, poolUsedSizeLow=poolUsedSizeLow, snapshotCreationFailed=snapshotCreationFailed, poolIndex=poolIndex, diskSizeLow=diskSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolEntry=poolEntry, lunGUID=lunGUID, cifsAvgWriteLatency=cifsAvgWriteLatency, projectModified=projectModified, replicationFailed=replicationFailed, diskCount=diskCount, notifications=notifications, shareCompressionEnabled=shareCompressionEnabled, fcPortOnline=fcPortOnline, ipmiCurrent=ipmiCurrent, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, targetGroupMemberRemoved=targetGroupMemberRemoved, cacheTotalWriteIops=cacheTotalWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, ipmiMemory=ipmiMemory, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectDedupEnabled=projectDedupEnabled, fcTargetStatus=fcTargetStatus, poolSizeLow=poolSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetEntry=fcTargetEntry, iscsiWriteIops=iscsiWriteIops, shareProjectName=shareProjectName, tegileGroups=tegileGroups, diskType=diskType, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, diskTotalReadMbps=diskTotalReadMbps, globalStatistics=globalStatistics, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cifsTotalReadMbps=cifsTotalReadMbps, shareDataSizeHigh=shareDataSizeHigh, fcAvgReadLatency=fcAvgReadLatency, poolProjects=poolProjects, projectShareCount=projectShareCount, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tegile=tegile, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetAlias=iscsiTargetAlias, lunDataSizeHigh=lunDataSizeHigh, ipmiTemperature=ipmiTemperature, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolTotalWriteIops=poolTotalWriteIops, poolState=poolState, notificationEventCode=notificationEventCode, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolTotalSaving=poolTotalSaving, projectCompressionEnabled=projectCompressionEnabled, poolTotalReadIops=poolTotalReadIops, shareIndex=shareIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, upgradeStarted=upgradeStarted, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationSensorNumber=notificationSensorNumber, cpuSystemCalls=cpuSystemCalls, fcTargetGroup=fcTargetGroup, snmpAgentVersion=snmpAgentVersion, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, lunProtocol=lunProtocol, tegileArray=tegileArray, iscsiTargetAuth=iscsiTargetAuth, diskRandomIOCount=diskRandomIOCount, network=network, tegileArray_notifications=tegileArray_notifications, lunSizeHigh=lunSizeHigh, poolMetaWriteIops=poolMetaWriteIops, replicationAborted=replicationAborted, fcProperties=fcProperties, lunReadLatency=lunReadLatency, poolOwnerController=poolOwnerController, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareQuotaLow=shareQuotaLow, tegileConformance=tegileConformance, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, volumeQuotaFinished=volumeQuotaFinished, snapshotCloneCompleted=snapshotCloneCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, disks=disks, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, controllerTimeDrift=controllerTimeDrift, upgradeDownloadCompleted=upgradeDownloadCompleted, snmpServiceStopFailed=snmpServiceStopFailed, nicGroup=nicGroup, poolMetaReadLatency=poolMetaReadLatency, diskDataReadMbps=diskDataReadMbps, poolDeleted=poolDeleted, nicTransmitMbps=nicTransmitMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiOther=ipmiOther, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, replicationPaused=replicationPaused, shareCIFSReadLatency=shareCIFSReadLatency, haResources=haResources, haResourceGroup=haResourceGroup, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastores=vmwareNFSDatastores, shareReservedSizeLow=shareReservedSizeLow, haResourcesTable=haResourcesTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, controllerUp=controllerUp, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiators=iscsiInitiators, nicState=nicState, fcTargetsTable=fcTargetsTable, memoryFailure=memoryFailure, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetError=iscsiTargetError, shareNFSReadMbps=shareNFSReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskState=diskState, lunWriteLatency=lunWriteLatency, replicationComplete=replicationComplete, shareNFSWriteLatency=shareNFSWriteLatency, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetReadMbps=iscsiTargetReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, notificationSensorAction=notificationSensorAction, currentObjectGroup=currentObjectGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, cacheTotalWriteMbps=cacheTotalWriteMbps, haControllerA_Name=haControllerA_Name, poolFreeSizeLow=poolFreeSizeLow, diskPoolName=diskPoolName, cacheSSDReads=cacheSSDReads, fcInitiatorEntry=fcInitiatorEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicMTU=nicMTU, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectLUNs=projectLUNs, poolExported=poolExported, notificationDescription=notificationDescription, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, controllerDown=controllerDown, lunCompressionEnabled=lunCompressionEnabled, cacheTotalReadIops=cacheTotalReadIops, nvdimmFailSoftError=nvdimmFailSoftError, replicationAbandoned=replicationAbandoned, unknownSensorEvent=unknownSensorEvent, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareEntry=shareEntry, shareDeleted=shareDeleted, notificationProps=notificationProps, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetReadIops=iscsiTargetReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, cpuTotalUsage=cpuTotalUsage, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haResourceName=haResourceName, projectDataSizeHigh=projectDataSizeHigh, notificationComponentName=notificationComponentName, nfsAvgReadLatency=nfsAvgReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, shareDeletionFailed=shareDeletionFailed, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorIndex=iscsiInitiatorIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationSeverity=notificationSeverity, haResourceEntry=haResourceEntry, diskIOCount=diskIOCount, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolTotalReadMbps=poolTotalReadMbps, poolDegraded=poolDegraded, projectTotalSaving=projectTotalSaving, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeTimeout=upgradeTimeout, projectDeleted=projectDeleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetReadMbps=fcTargetReadMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunFreeSizeHigh=lunFreeSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, aclMigrationCompleted=aclMigrationCompleted, lunDedupEnabled=lunDedupEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nicIndex=nicIndex, diskGoneOffline=diskGoneOffline, diskEntry=diskEntry, iscsiTargets=iscsiTargets, notificationTargetEntityName=notificationTargetEntityName, notificationReadingTriggerValue=notificationReadingTriggerValue, haControllerB_IPAddr=haControllerB_IPAddr, shareQuotaHigh=shareQuotaHigh, pools=pools, fcInitiatorIndex=fcInitiatorIndex, lunReadIops=lunReadIops)
