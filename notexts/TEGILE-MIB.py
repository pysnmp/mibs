...
ModuleIdentity, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Counter64, Unsigned32, Counter32, MibIdentifier, ObjectIdentity, Integer32, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Counter64", "Unsigned32", "Counter32", "MibIdentifier", "ObjectIdentity", "Integer32", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunWriteLatency=lunWriteLatency, shareNFSReadLatency=shareNFSReadLatency, nicEntry=nicEntry, nicMTU=nicMTU, testNotification=testNotification, fcTargetEntry=fcTargetEntry, notificationDescription=notificationDescription, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, ipmiTemperature=ipmiTemperature, poolReadCacheReadIops=poolReadCacheReadIops, fcPortOnline=fcPortOnline, nvdimmFailSoftError=nvdimmFailSoftError, shareQuotaFinished=shareQuotaFinished, lunBlockSize=lunBlockSize, projectSnapshotSizeLow=projectSnapshotSizeLow, shareNFSEnabled=shareNFSEnabled, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcTargetReadLatency=fcTargetReadLatency, replicationAborted=replicationAborted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunReadMbps=lunReadMbps, diskIOCount=diskIOCount, lunFreeSizeHigh=lunFreeSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskSizeHigh=diskSizeHigh, smisServiceStartFailed=smisServiceStartFailed, lunSizeLow=lunSizeLow, fcTargetName=fcTargetName, lunReservedSizeLow=lunReservedSizeLow, diskAvgReadLatency=diskAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, nfsTotalReadIops=nfsTotalReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunIndex=lunIndex, shareCIFSReadLatency=shareCIFSReadLatency, pools=pools, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskAlias=diskAlias, shareCompressionEnabled=shareCompressionEnabled, tegileCompliances=tegileCompliances, adServerTimeDrift=adServerTimeDrift, smisServiceStopFailed=smisServiceStopFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskIsOnline=diskIsOnline, poolDataSizeLow=poolDataSizeLow, shareCIFSReadIops=shareCIFSReadIops, lunSizeHigh=lunSizeHigh, poolName=poolName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolExpanded=poolExpanded, lunDataSizeHigh=lunDataSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, fcInitiatorName=fcInitiatorName, diskTotalWriteIops=diskTotalWriteIops, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, shareTable=shareTable, fcProperties=fcProperties, fcTargetsTable=fcTargetsTable, fcInitiators=fcInitiators, poolAvgWriteLatency=poolAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, maintenanceModeEnabled=maintenanceModeEnabled, upgradeDownloadStarted=upgradeDownloadStarted, shareReservedSizeHigh=shareReservedSizeHigh, basicCompliance=basicCompliance, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, replicationFailed=replicationFailed, shareCIFSReadMbps=shareCIFSReadMbps, smbSocketFailure=smbSocketFailure, projectQuotaFinished=projectQuotaFinished, poolTotalWriteIops=poolTotalWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haResourceEntry=haResourceEntry, haControllerB_Uptime=haControllerB_Uptime, haControllerA_IPAddr=haControllerA_IPAddr, shareCIFSWriteIops=shareCIFSWriteIops, projectFreeSizeLow=projectFreeSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, controllerUp=controllerUp, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cacheRAMReads=cacheRAMReads, iscsiTargetIndex=iscsiTargetIndex, diskIndex=diskIndex, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolQuotaFinished=poolQuotaFinished, replicationSourceRegistered=replicationSourceRegistered, lunSnapshotSizeLow=lunSnapshotSizeLow, network=network, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, ipmiCurrent=ipmiCurrent, diskState=diskState, projectDataSizeLow=projectDataSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, cacheTotalReadMbps=cacheTotalReadMbps, nicTable=nicTable, diskSequentialIOCount=diskSequentialIOCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, ipmiOther=ipmiOther, volumeQuotaFinished=volumeQuotaFinished, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiProperties=iscsiProperties, cacheSSDReads=cacheSSDReads, shareCIFSWriteMbps=shareCIFSWriteMbps, poolSizeHigh=poolSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, projectTotalSaving=projectTotalSaving, fcTargetModifyCompleted=fcTargetModifyCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, poolUpgraded=poolUpgraded, tdpsUpgradeFailed=tdpsUpgradeFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, upgradeTimeout=upgradeTimeout, poolMetaReadLatency=poolMetaReadLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, upgradeCompleted=upgradeCompleted, projectCompressionEnabled=projectCompressionEnabled, poolHealth=poolHealth, deleteFolderFailed=deleteFolderFailed, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectPoolName=projectPoolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, volumeDeleteFailed=volumeDeleteFailed, snapshotCreationFailed=snapshotCreationFailed, shareMountPoint=shareMountPoint, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeStarted=upgradeStarted, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, shareQuotaHigh=shareQuotaHigh, notificationSeverity=notificationSeverity, lunTable=lunTable, vmwareNFSDatastores=vmwareNFSDatastores, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargets=iscsiTargets, targetGroupDeleteCompleted=targetGroupDeleteCompleted, sensorFailureEvent=sensorFailureEvent, projectEntry=projectEntry, lunName=lunName, haResources=haResources, controllerHardwareModel=controllerHardwareModel, lunReadIops=lunReadIops, shareNFSReadIops=shareNFSReadIops, lunGUID=lunGUID, PYSNMP_MODULE_ID=tegile, projectModified=projectModified, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCIFSEnabled=shareCIFSEnabled, replicationResumed=replicationResumed, poolIndex=poolIndex, iscsiTargetError=iscsiTargetError, lunPoolName=lunPoolName, fcTargetStatus=fcTargetStatus, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, unknownSensorEvent=unknownSensorEvent, fcTotalReadIops=fcTotalReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalWriteIops=fcTotalWriteIops, poolDataReadIops=poolDataReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, memoryFailure=memoryFailure, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snmpServiceStopped=snmpServiceStopped, ipmiFan=ipmiFan, replicationPaused=replicationPaused, haResourceDescription=haResourceDescription, projectName=projectName, iscsiTargetEntry=iscsiTargetEntry, poolUsedSizeHigh=poolUsedSizeHigh, nicReceiveMbps=nicReceiveMbps, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notifications=notifications, diskGoneOffline=diskGoneOffline, projectDedupEnabled=projectDedupEnabled, poolProjectCount=poolProjectCount, ipmiMemory=ipmiMemory, lunWriteIops=lunWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargets=fcTargets, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haResourceIndex=haResourceIndex, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tegileArray=tegileArray, poolProjects=poolProjects, iscsiWriteIops=iscsiWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationSensorAction=notificationSensorAction, haControllerB_Name=haControllerB_Name, projectDeletionFailed=projectDeletionFailed, shareEntry=shareEntry, maintenanceModeDisabled=maintenanceModeDisabled, diskDataWriteMbps=diskDataWriteMbps, nicIndex=nicIndex, upgradeDownloadFailed=upgradeDownloadFailed, ipmiThreshold=ipmiThreshold, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, upgradeFailed=upgradeFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, controllerDown=controllerDown, diskDataWriteIops=diskDataWriteIops, lunCompressionEnabled=lunCompressionEnabled, fcTargetReadMbps=fcTargetReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, poolCount=poolCount, poolDataWriteMbps=poolDataWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareProjectName=shareProjectName, iscsiTargetAlias=iscsiTargetAlias, shareSnapshotSizeLow=shareSnapshotSizeLow, lunDedupEnabled=lunDedupEnabled, spareDiskReplaced=spareDiskReplaced, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpGroupUp=networkIpmpGroupUp, lunEntry=lunEntry, properties=properties, poolMetaReadIops=poolMetaReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolEntry=poolEntry, poolTotalReadIops=poolTotalReadIops, snapshotDeleteFailed=snapshotDeleteFailed, tegileGroups=tegileGroups, sanProperties=sanProperties, iscsiTargetGroup=iscsiTargetGroup, networkInterfaceDown=networkInterfaceDown, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tegile=tegile, networkInterfaceUp=networkInterfaceUp, poolCreated=poolCreated, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, notificationTime=notificationTime, poolUsedSizeLow=poolUsedSizeLow, projectShares=projectShares, diagnosticDataUploaded=diagnosticDataUploaded, currentObjectGroup=currentObjectGroup, cacheTotalWriteIops=cacheTotalWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDeleted=projectDeleted, diskEntry=diskEntry, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskSizeLow=diskSizeLow, diskTotalReadMbps=diskTotalReadMbps, shareDataSizeHigh=shareDataSizeHigh, volumeModifyCompleted=volumeModifyCompleted, controllerTimeDrift=controllerTimeDrift, nicGroup=nicGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunCompressedRatio=lunCompressedRatio, lunProtocol=lunProtocol, notificationReadingUnit=notificationReadingUnit, smisServiceStopped=smisServiceStopped, haResourcesTable=haResourcesTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetWriteIops=fcTargetWriteIops, disks=disks, fcAvgWriteLatency=fcAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, replicationStarted=replicationStarted, tegileConformance=tegileConformance, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, diskTable=diskTable, haResourceName=haResourceName, diskDataReadMbps=diskDataReadMbps, ipmiVoltage=ipmiVoltage, poolFreeSizeLow=poolFreeSizeLow, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetWriteMbps=fcTargetWriteMbps, aclMigrationStarted=aclMigrationStarted, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationEventCode=notificationEventCode, fcInitiatorsTable=fcInitiatorsTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, cpuInterrupts=cpuInterrupts, lunDataSizeLow=lunDataSizeLow, fcTargetReadIops=fcTargetReadIops, notificationSensorSuspect=notificationSensorSuspect, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetAuth=iscsiTargetAuth, snmpServiceStarted=snmpServiceStarted, notificationObjects=notificationObjects, projectTable=projectTable, haControllerA_Uptime=haControllerA_Uptime, fcInitiatorGroup=fcInitiatorGroup, diskError=diskError, poolExported=poolExported, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetGroupError=iscsiTargetGroupError, shareNFSWriteIops=shareNFSWriteIops, poolTable=poolTable, fcTargetIndex=fcTargetIndex, lunReadLatency=lunReadLatency, globalStatistics=globalStatistics, netbiosSocketFailure=netbiosSocketFailure, shareIndex=shareIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTotalReadMbps=fcTotalReadMbps, diskDataReadIops=diskDataReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetReadIops=iscsiTargetReadIops, cacheTotalReadIops=cacheTotalReadIops, snmpAgentVersion=snmpAgentVersion, projectIndex=projectIndex, ipmiPowerSupply=ipmiPowerSupply, smisServiceStarted=smisServiceStarted, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskChassisIdx=diskChassisIdx, poolAvgReadLatency=poolAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationComponentName=notificationComponentName, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcInitiatorEntry=fcInitiatorEntry, alertsCleanupCompleted=alertsCleanupCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicName=nicName, diskPoolName=diskPoolName, haResourceActiveNode=haResourceActiveNode, lunTargetGroup=lunTargetGroup, shareDeleted=shareDeleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiInitiators=iscsiInitiators, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, deleteFolderCompleted=deleteFolderCompleted, projectLUNs=projectLUNs, notificationReadingTriggerValue=notificationReadingTriggerValue, projectCreatedSuccessfully=projectCreatedSuccessfully, projectShareCount=projectShareCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDedupEnabled=shareDedupEnabled, poolImported=poolImported, sharePoolName=sharePoolName, iscsiTotalReadIops=iscsiTotalReadIops, shareCompressedRatio=shareCompressedRatio, replicationComplete=replicationComplete, shareQuotaLow=shareQuotaLow, poolDataWriteIops=poolDataWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, cifsTotalReadIops=cifsTotalReadIops, networkIpmpGroupDown=networkIpmpGroupDown, diskAvgWriteLatency=diskAvgWriteLatency, snapshotCloningFailed=snapshotCloningFailed, shareName=shareName, poolDataReadLatency=poolDataReadLatency, fcTotalWriteMbps=fcTotalWriteMbps, poolDeletionFailed=poolDeletionFailed, poolOwnerController=poolOwnerController, diskType=diskType, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, haControllerA_Name=haControllerA_Name, shareCreatedSuccessfully=shareCreatedSuccessfully, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, nfsTotalWriteIops=nfsTotalWriteIops, notificationProps=notificationProps, nvdimmFailDeviceError=nvdimmFailDeviceError, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolMetaWriteIops=poolMetaWriteIops, diskCount=diskCount, snmpServiceStartFailed=snmpServiceStartFailed, lunProjectName=lunProjectName, poolDataWriteLatency=poolDataWriteLatency, nicState=nicState, iscsiTargetName=iscsiTargetName, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiatorName=iscsiInitiatorName, poolTotalSaving=poolTotalSaving, replicationTargetDeleted=replicationTargetDeleted, fcPortOffline=fcPortOffline, userLoginFailed=userLoginFailed, haControllerB_IPAddr=haControllerB_IPAddr, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolDataReadMbps=poolDataReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcAvgReadLatency=fcAvgReadLatency, projectLunCount=projectLunCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haResourceStatus=haResourceStatus, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolMetaReadMbps=poolMetaReadMbps, poolDeleted=poolDeleted, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareDeletionFailed=shareDeletionFailed, poolState=poolState, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolSizeLow=poolSizeLow, fcInitiatorIndex=fcInitiatorIndex, tegileArray_notifications=tegileArray_notifications, poolMetaWriteLatency=poolMetaWriteLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiInitiatorsTable=iscsiInitiatorsTable, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetGroup=fcTargetGroup, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunWriteMbps=lunWriteMbps, haResourceGroup=haResourceGroup, replicationAbandoned=replicationAbandoned, poolDataSizeHigh=poolDataSizeHigh, poolDegraded=poolDegraded, nfsAvgReadLatency=nfsAvgReadLatency, notificationSensorNumber=notificationSensorNumber, currentNotificationGroup=currentNotificationGroup, cifsTotalReadMbps=cifsTotalReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, cpuTotalUsage=cpuTotalUsage, diskSlowIo=diskSlowIo, diskRandomIOCount=diskRandomIOCount, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectQuotaSizeLow=projectQuotaSizeLow)
