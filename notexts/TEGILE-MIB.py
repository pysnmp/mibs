...
# Produced by pysmi-1.1.0 at Mon Nov 15 20:01:53 2021
...
Counter64, IpAddress, ModuleIdentity, Unsigned32, Counter32, Gauge32, TimeTicks, NotificationType, enterprises, iso, ObjectIdentity, MibIdentifier, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32", "Gauge32", "TimeTicks", "NotificationType", "enterprises", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", volumeDeleteCompleted=volumeDeleteCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, deleteFolderCompleted=deleteFolderCompleted, tegileCompliances=tegileCompliances, poolReadCacheReadLatency=poolReadCacheReadLatency, projectQuotaFinished=projectQuotaFinished, diskDataWriteIops=diskDataWriteIops, poolEntry=poolEntry, lunProjectName=lunProjectName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolDataReadLatency=poolDataReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolOwnerController=poolOwnerController, poolTotalReadMbps=poolTotalReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, controllerTimeDrift=controllerTimeDrift, iscsiInitiators=iscsiInitiators, netbiosSocketFailure=netbiosSocketFailure, poolExported=poolExported, notificationTargetEntityName=notificationTargetEntityName, projectLunCount=projectLunCount, lunWriteMbps=lunWriteMbps, shareDeleted=shareDeleted, lunIndex=lunIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, upgradeDownloadStarted=upgradeDownloadStarted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, deleteFolderFailed=deleteFolderFailed, snapshotRollbackFailed=snapshotRollbackFailed, spareDiskReplaced=spareDiskReplaced, projectThresholdExceedWarning=projectThresholdExceedWarning, snapshotCloningFailed=snapshotCloningFailed, snmpAgentVersion=snmpAgentVersion, volumeDeleteFailed=volumeDeleteFailed, fcInitiatorEntry=fcInitiatorEntry, projectCompressionEnabled=projectCompressionEnabled, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiTemperature=ipmiTemperature, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetGroup=iscsiTargetGroup, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolDegraded=poolDegraded, poolDataSizeLow=poolDataSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, poolTotalSaving=poolTotalSaving, fcPortOffline=fcPortOffline, cifsTotalReadIops=cifsTotalReadIops, fcTargetWriteIops=fcTargetWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataWriteMbps=poolDataWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, upgradeTimeout=upgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, nicState=nicState, lunSnapshotSizeLow=lunSnapshotSizeLow, memoryFailure=memoryFailure, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcInitiatorGroup=fcInitiatorGroup, haControllerB_Name=haControllerB_Name, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cacheTotalWriteMbps=cacheTotalWriteMbps, projectTotalSaving=projectTotalSaving, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunReadMbps=lunReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, projectLUNs=projectLUNs, networkInterfaceUp=networkInterfaceUp, notificationProps=notificationProps, fcTargetModifyCompleted=fcTargetModifyCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicTable=nicTable, poolCount=poolCount, iscsiTargetWriteIops=iscsiTargetWriteIops, notificationObjects=notificationObjects, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTotalReadMbps=fcTotalReadMbps, volumeQuotaFinished=volumeQuotaFinished, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, userLoginFailed=userLoginFailed, unknownSensorEvent=unknownSensorEvent, fcTargetStatus=fcTargetStatus, replicationComplete=replicationComplete, smisServiceStarted=smisServiceStarted, projectDedupEnabled=projectDedupEnabled, poolReadCacheReadIops=poolReadCacheReadIops, shareReservedSizeHigh=shareReservedSizeHigh, lunSizeHigh=lunSizeHigh, shareDataSizeLow=shareDataSizeLow, iscsiTargetError=iscsiTargetError, fcPortOnline=fcPortOnline, lunReservedSizeHigh=lunReservedSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cacheTotalWriteIops=cacheTotalWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, replicationAborted=replicationAborted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadIops=poolMetaReadIops, diskCount=diskCount, projectEntry=projectEntry, fcTargetName=fcTargetName, diskState=diskState, poolWriteCacheWriteIops=poolWriteCacheWriteIops, sanProperties=sanProperties, lunEntry=lunEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorIndex=fcInitiatorIndex, cpuTotalUsage=cpuTotalUsage, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, diskTotalWriteIops=diskTotalWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tegileArray=tegileArray, replicationAbandoned=replicationAbandoned, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareQuotaHigh=shareQuotaHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCIFSReadIops=shareCIFSReadIops, poolHealth=poolHealth, iscsiTargetReadLatency=iscsiTargetReadLatency, poolImported=poolImported, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunProtocol=lunProtocol, nicName=nicName, nicGroup=nicGroup, shareQuotaLow=shareQuotaLow, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetsTable=fcTargetsTable, poolTable=poolTable, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diagnosticDataUploaded=diagnosticDataUploaded, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, shareCIFSEnabled=shareCIFSEnabled, alertsCleanupCompleted=alertsCleanupCompleted, poolDataReadIops=poolDataReadIops, lunCompressedRatio=lunCompressedRatio, iscsiTargetGroupError=iscsiTargetGroupError, projectName=projectName, fcTargetIndex=fcTargetIndex, nicIndex=nicIndex, iscsiInitiatorName=iscsiInitiatorName, lunTargetGroup=lunTargetGroup, shareNFSReadIops=shareNFSReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, replicationResumed=replicationResumed, iscsiTargetName=iscsiTargetName, poolTotalWriteIops=poolTotalWriteIops, disks=disks, smisServiceStopFailed=smisServiceStopFailed, poolUsedSizeHigh=poolUsedSizeHigh, notificationSeverity=notificationSeverity, diskAvgWriteLatency=diskAvgWriteLatency, snmpServiceStarted=snmpServiceStarted, poolMetaWriteMbps=poolMetaWriteMbps, projectModified=projectModified, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataWriteIops=poolDataWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskIOCount=diskIOCount, networkTotalTransmitMbps=networkTotalTransmitMbps, lunDedupEnabled=lunDedupEnabled, shareNFSReadMbps=shareNFSReadMbps, poolSizeHigh=poolSizeHigh, shareMountPoint=shareMountPoint, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cpuInterrupts=cpuInterrupts, notificationEventCode=notificationEventCode, fcTargetReadIops=fcTargetReadIops, adServerTimeDrift=adServerTimeDrift, smbSocketFailure=smbSocketFailure, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetEntry=iscsiTargetEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nfsTotalReadIops=nfsTotalReadIops, replicationTargetDeleted=replicationTargetDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haResourceDescription=haResourceDescription, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationDescription=notificationDescription, projectTable=projectTable, iscsiAvgReadLatency=iscsiAvgReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiators=fcInitiators, cacheSSDReads=cacheSSDReads, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorsTable=fcInitiatorsTable, lunName=lunName, diskDataWriteMbps=diskDataWriteMbps, notifications=notifications, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, ipmiVoltage=ipmiVoltage, nvdimmFailDeviceError=nvdimmFailDeviceError, lunWriteLatency=lunWriteLatency, lunTable=lunTable, lunDataSizeHigh=lunDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargets=iscsiTargets, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaWriteIops=poolMetaWriteIops, diskSlowIo=diskSlowIo, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunReadLatency=lunReadLatency, diskTotalReadMbps=diskTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetReadLatency=fcTargetReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareQuotaFinished=shareQuotaFinished, fcAvgReadLatency=fcAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectDataSizeHigh=projectDataSizeHigh, pools=pools, replicationStarted=replicationStarted, cacheTotalReadIops=cacheTotalReadIops, fcTargets=fcTargets, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskAlias=diskAlias, poolReadCacheWriteLatency=poolReadCacheWriteLatency, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskIndex=diskIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationReadingUnit=notificationReadingUnit, lunCompressionEnabled=lunCompressionEnabled, poolMetaReadMbps=poolMetaReadMbps, sharePoolName=sharePoolName, poolExpanded=poolExpanded, fcTotalWriteIops=fcTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", aclMigrationStarted=aclMigrationStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskDataReadIops=diskDataReadIops, basicCompliance=basicCompliance, cacheTotalReadMbps=cacheTotalReadMbps, diskEntry=diskEntry, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, shareName=shareName, controllerUp=controllerUp, targetGroupMemberAdded=targetGroupMemberAdded, nvdimmFailSoftError=nvdimmFailSoftError, diskAvgReadLatency=diskAvgReadLatency, poolIndex=poolIndex, tegileGroups=tegileGroups, iscsiInitiatorGroup=iscsiInitiatorGroup, poolProjects=poolProjects, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareEntry=shareEntry, currentNotificationGroup=currentNotificationGroup, nicMTU=nicMTU, fcProperties=fcProperties, ipmiOther=ipmiOther, networkInterfaceDown=networkInterfaceDown, shareCompressedRatio=shareCompressedRatio, poolUsedSizeLow=poolUsedSizeLow, lunDataSizeLow=lunDataSizeLow, lunReadIops=lunReadIops, projectQuotaSizeHigh=projectQuotaSizeHigh, diskTable=diskTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetReadIops=iscsiTargetReadIops, poolDataSizeHigh=poolDataSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolMetaReadLatency=poolMetaReadLatency, nicEntry=nicEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, poolState=poolState, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, projectIndex=projectIndex, lunSizeLow=lunSizeLow, shareReservedSizeLow=shareReservedSizeLow, upgradeFailed=upgradeFailed, poolFreeSizeHigh=poolFreeSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeCompleted=upgradeCompleted, tegile=tegile, diskGoneOffline=diskGoneOffline, projectDeletionFailed=projectDeletionFailed, volumeModifyCompleted=volumeModifyCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolCreated=poolCreated, fcTotalWriteMbps=fcTotalWriteMbps, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, lunBlockSize=lunBlockSize, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetGroup=fcTargetGroup, poolFreeSizeLow=poolFreeSizeLow, fcTotalReadIops=fcTotalReadIops, fcInitiatorName=fcInitiatorName, diskDataReadMbps=diskDataReadMbps, PYSNMP_MODULE_ID=tegile, shareIndex=shareIndex, diskRandomIOCount=diskRandomIOCount, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationTime=notificationTime, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, ipmiCurrent=ipmiCurrent, haResourceIndex=haResourceIndex, replicationSourceRegistered=replicationSourceRegistered, shareCIFSWriteIops=shareCIFSWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, diskSizeHigh=diskSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, projectPoolName=projectPoolName, aclMigrationCompleted=aclMigrationCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolAvgWriteLatency=poolAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, iscsiProperties=iscsiProperties, poolDeletionFailed=poolDeletionFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerB_IPAddr=haControllerB_IPAddr, network=network, tegileConformance=tegileConformance, projectShareCount=projectShareCount, tdpsUpgradeFailed=tdpsUpgradeFailed, diskPoolName=diskPoolName, properties=properties, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolUpgraded=poolUpgraded, currentObjectGroup=currentObjectGroup, controllerHardwareModel=controllerHardwareModel, nfsAvgReadLatency=nfsAvgReadLatency, projectDataSizeLow=projectDataSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, intelliFlashSoftwareUp=intelliFlashSoftwareUp, snmpServiceStopped=snmpServiceStopped, globalStatistics=globalStatistics, lunFreeSizeLow=lunFreeSizeLow, smisServiceStopped=smisServiceStopped, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, testNotification=testNotification, poolSizeLow=poolSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareDeletionFailed=shareDeletionFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, shareCIFSReadLatency=shareCIFSReadLatency, projectFreeSizeLow=projectFreeSizeLow, lunReservedSizeLow=lunReservedSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetAlias=iscsiTargetAlias, ipmiMemory=ipmiMemory, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, cacheRAMReads=cacheRAMReads, cpuSystemCalls=cpuSystemCalls, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, lunInitiatorGroup=lunInitiatorGroup, poolDataReadMbps=poolDataReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, poolDeleted=poolDeleted, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolAvgReadLatency=poolAvgReadLatency, shareNFSEnabled=shareNFSEnabled, haControllerA_Uptime=haControllerA_Uptime, ipmiPowerSupply=ipmiPowerSupply, shareTable=shareTable, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiWriteIops=iscsiWriteIops, haControllerA_Name=haControllerA_Name, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskChassisIdx=diskChassisIdx, iscsiTargetsTable=iscsiTargetsTable, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskSizeLow=diskSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectDeleted=projectDeleted, ntpServerTimeDrift=ntpServerTimeDrift, poolTotalWriteMbps=poolTotalWriteMbps, diskError=diskError, haResourceGroup=haResourceGroup, ipmiThreshold=ipmiThreshold, poolName=poolName, haControllerB_Uptime=haControllerB_Uptime, haResourceName=haResourceName, fcTargetEntry=fcTargetEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, replicationPaused=replicationPaused, ipmiFan=ipmiFan, haResourceEntry=haResourceEntry, shareProjectName=shareProjectName, diskTotalWriteMbps=diskTotalWriteMbps, upgradeStarted=upgradeStarted, lunPoolName=lunPoolName, nicReceiveMbps=nicReceiveMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTargetAuth=iscsiTargetAuth, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetIndex=iscsiTargetIndex, haResourcesTable=haResourcesTable, haControllerA_IPAddr=haControllerA_IPAddr, haResourceStatus=haResourceStatus, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunWriteIops=lunWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, nicTransmitMbps=nicTransmitMbps, replicationFailed=replicationFailed, haResources=haResources, notificationSensorNumber=notificationSensorNumber, notificationComponentName=notificationComponentName, snmpServiceStopFailed=snmpServiceStopFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, sensorFailureEvent=sensorFailureEvent, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectShares=projectShares, controllerDown=controllerDown, tegileArray_notifications=tegileArray_notifications, diskIsOnline=diskIsOnline, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolProjectCount=poolProjectCount, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalReadIops=poolTotalReadIops, lunGUID=lunGUID, notificationSensorSuspect=notificationSensorSuspect, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cifsTotalWriteIops=cifsTotalWriteIops, notificationSensorAction=notificationSensorAction, shareNFSReadLatency=shareNFSReadLatency, haResourceActiveNode=haResourceActiveNode, shareDataSizeHigh=shareDataSizeHigh, diskType=diskType, shareCompressionEnabled=shareCompressionEnabled)
