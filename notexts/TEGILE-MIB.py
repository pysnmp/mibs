...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:33:39 2021
...
iso, IpAddress, Unsigned32, NotificationType, Counter64, enterprises, Integer32, MibIdentifier, ObjectIdentity, Counter32, ModuleIdentity, Bits, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "enterprises", "Integer32", "MibIdentifier", "ObjectIdentity", "Counter32", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetWriteLatency=fcTargetWriteLatency, diskSequentialIOCount=diskSequentialIOCount, diskCount=diskCount, snmpAgentVersion=snmpAgentVersion, poolQuotaFinished=poolQuotaFinished, snmpServiceStartFailed=snmpServiceStartFailed, fcInitiatorName=fcInitiatorName, notificationProps=notificationProps, network=network, adServerTimeDrift=adServerTimeDrift, unknownSensorEvent=unknownSensorEvent, fcInitiatorsTable=fcInitiatorsTable, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, currentNotificationGroup=currentNotificationGroup, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationSeverity=notificationSeverity, projectLUNs=projectLUNs, shareCIFSReadLatency=shareCIFSReadLatency, notificationSensorSuspect=notificationSensorSuspect, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, lunDataSizeLow=lunDataSizeLow, cacheRAMReads=cacheRAMReads, replicationComplete=replicationComplete, upgradeStarted=upgradeStarted, controllerTimeDrift=controllerTimeDrift, replicationResumed=replicationResumed, smisServiceStartFailed=smisServiceStartFailed, lunTable=lunTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareDeleted=shareDeleted, fcTargets=fcTargets, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, ipmiThreshold=ipmiThreshold, shareNFSReadMbps=shareNFSReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDataWriteLatency=poolDataWriteLatency, diskTotalWriteMbps=diskTotalWriteMbps, lunReadMbps=lunReadMbps, projectPoolName=projectPoolName, snapshotCloneCompleted=snapshotCloneCompleted, projectLunCount=projectLunCount, nicTransmitMbps=nicTransmitMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, memoryFailure=memoryFailure, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiWriteIops=iscsiWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, notificationSensorNumber=notificationSensorNumber, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCIFSReadIops=shareCIFSReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunInitiatorGroup=lunInitiatorGroup, fcTargetWriteMbps=fcTargetWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, poolTable=poolTable, iscsiTargetReadIops=iscsiTargetReadIops, poolDataReadLatency=poolDataReadLatency, diskSizeHigh=diskSizeHigh, aclMigrationCompleted=aclMigrationCompleted, tegile=tegile, shareCreatedSuccessfully=shareCreatedSuccessfully, poolUsedSizeHigh=poolUsedSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, tegileCompliances=tegileCompliances, diskPoolName=diskPoolName, nicIndex=nicIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargets=iscsiTargets, poolExpanded=poolExpanded, poolCount=poolCount, shareName=shareName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolDataWriteIops=poolDataWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nicGroup=nicGroup, shareTable=shareTable, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolExported=poolExported, replicationPaused=replicationPaused, shareEntry=shareEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunCompressedRatio=lunCompressedRatio, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, poolDataWriteMbps=poolDataWriteMbps, ipmiCurrent=ipmiCurrent, lunReadLatency=lunReadLatency, lunReservedSizeLow=lunReservedSizeLow, lunDedupEnabled=lunDedupEnabled, fcInitiatorGroup=fcInitiatorGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCompressedRatio=shareCompressedRatio, haResourceDescription=haResourceDescription, controllerHardwareModel=controllerHardwareModel, PYSNMP_MODULE_ID=tegile, upgradeDownloadFailed=upgradeDownloadFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, diskTotalReadIops=diskTotalReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, properties=properties, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, upgradeCompleted=upgradeCompleted, shareQuotaLow=shareQuotaLow, nicMTU=nicMTU, projectQuotaFinished=projectQuotaFinished, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, poolTotalReadMbps=poolTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, snapshotDeleteFailed=snapshotDeleteFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, shareDataSizeLow=shareDataSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetReadLatency=fcTargetReadLatency, fcTargetsTable=fcTargetsTable, diskRandomIOCount=diskRandomIOCount, lunWriteLatency=lunWriteLatency, diskAvgReadLatency=diskAvgReadLatency, controllerDown=controllerDown, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerA_Uptime=haControllerA_Uptime, cifsTotalWriteIops=cifsTotalWriteIops, haResourceStatus=haResourceStatus, nfsTotalReadIops=nfsTotalReadIops, haResourceIndex=haResourceIndex, iscsiProperties=iscsiProperties, fcTotalReadMbps=fcTotalReadMbps, poolFreeSizeLow=poolFreeSizeLow, projectDeletionFailed=projectDeletionFailed, tegileArray_notifications=tegileArray_notifications, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskTable=diskTable, iscsiTargetError=iscsiTargetError, lunSizeHigh=lunSizeHigh, deleteFolderFailed=deleteFolderFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskSlowIo=diskSlowIo, iscsiTargetGroupError=iscsiTargetGroupError, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, fcProperties=fcProperties, poolDegraded=poolDegraded, shareNFSWriteIops=shareNFSWriteIops, ipmiFan=ipmiFan, diskIOCount=diskIOCount, projectCreatedSuccessfully=projectCreatedSuccessfully, poolReadCacheReadLatency=poolReadCacheReadLatency, smbSocketFailure=smbSocketFailure, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, sharePoolName=sharePoolName, shareCompressionEnabled=shareCompressionEnabled, snmpServiceStopped=snmpServiceStopped, projectThresholdExceedWarning=projectThresholdExceedWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceGroup=haResourceGroup, projectDeleted=projectDeleted, projectShareCount=projectShareCount, upgradeDownloadStarted=upgradeDownloadStarted, sensorFailureEvent=sensorFailureEvent, cifsTotalReadMbps=cifsTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetGroup=iscsiTargetGroup, shareMountPoint=shareMountPoint, notificationTargetEntityName=notificationTargetEntityName, fcAvgReadLatency=fcAvgReadLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectIndex=projectIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tegileConformance=tegileConformance, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, replicationTargetDeleted=replicationTargetDeleted, ntpServerTimeDrift=ntpServerTimeDrift, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetIndex=iscsiTargetIndex, haControllerA_Name=haControllerA_Name, poolTotalReadIops=poolTotalReadIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskDataReadMbps=diskDataReadMbps, shareNFSReadLatency=shareNFSReadLatency, lunProjectName=lunProjectName, poolProjectCount=poolProjectCount, fcInitiatorIndex=fcInitiatorIndex, haResourceEntry=haResourceEntry, shareDataSizeHigh=shareDataSizeHigh, diskError=diskError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataSizeHigh=poolDataSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolCreated=poolCreated, fcAvgWriteLatency=fcAvgWriteLatency, poolHealth=poolHealth, snapshotCreationFailed=snapshotCreationFailed, fcTotalWriteIops=fcTotalWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolTotalWriteIops=poolTotalWriteIops, projectModified=projectModified, diagnosticDataUploaded=diagnosticDataUploaded, volumeModifyCompleted=volumeModifyCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsTotalWriteMbps=cifsTotalWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, poolIndex=poolIndex, poolDeleted=poolDeleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetName=iscsiTargetName, shareIndex=shareIndex, userLoginFailed=userLoginFailed, poolUpgraded=poolUpgraded, lunBlockSize=lunBlockSize, pools=pools, nicState=nicState, poolSizeLow=poolSizeLow, netbiosSocketFailure=netbiosSocketFailure, snmpServiceStarted=snmpServiceStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, poolAvgWriteLatency=poolAvgWriteLatency, shareDeletionFailed=shareDeletionFailed, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunWriteMbps=lunWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, snapshotRollbackFailed=snapshotRollbackFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, diskEntry=diskEntry, fcTotalWriteMbps=fcTotalWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunIndex=lunIndex, shareQuotaHigh=shareQuotaHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, lunCompressionEnabled=lunCompressionEnabled, haControllerB_IPAddr=haControllerB_IPAddr, aclMigrationStarted=aclMigrationStarted, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetIndex=fcTargetIndex, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, controllerUp=controllerUp, volumeDeleteFailed=volumeDeleteFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, poolMetaWriteMbps=poolMetaWriteMbps, poolMetaReadLatency=poolMetaReadLatency, cpuTotalUsage=cpuTotalUsage, poolUsedSizeLow=poolUsedSizeLow, poolMetaReadMbps=poolMetaReadMbps, fcTargetEntry=fcTargetEntry, poolTotalWriteMbps=poolTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSEnabled=shareNFSEnabled, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationSourceRegistered=replicationSourceRegistered, cacheSSDReads=cacheSSDReads, poolEntry=poolEntry, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskTotalReadMbps=diskTotalReadMbps, projectName=projectName, iscsiInitiators=iscsiInitiators, diskGoneOffline=diskGoneOffline, fcPortOffline=fcPortOffline, nicEntry=nicEntry, testNotification=testNotification, replicationStarted=replicationStarted, lunWriteIops=lunWriteIops, fcTargetReadMbps=fcTargetReadMbps, ipmiTemperature=ipmiTemperature, ipmiOther=ipmiOther, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, currentObjectGroup=currentObjectGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDataReadMbps=poolDataReadMbps, poolMetaWriteIops=poolMetaWriteIops, lunTargetGroup=lunTargetGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationDescription=notificationDescription, notificationTime=notificationTime, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskChassisIdx=diskChassisIdx, notifications=notifications, projectCompressionEnabled=projectCompressionEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectEntry=projectEntry, cpuSystemCalls=cpuSystemCalls, spareDiskReplaced=spareDiskReplaced, poolProjects=poolProjects, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, replicationAborted=replicationAborted, basicCompliance=basicCompliance, haResourcesTable=haResourcesTable, projectDedupEnabled=projectDedupEnabled, tegileArray=tegileArray, shareNFSWriteLatency=shareNFSWriteLatency, snapshotCloningFailed=snapshotCloningFailed, shareCIFSWriteIops=shareCIFSWriteIops, poolTotalSaving=poolTotalSaving, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, lunPoolName=lunPoolName, globalStatistics=globalStatistics, upgradeTimeout=upgradeTimeout, diskType=diskType, lunEntry=lunEntry, projectDataSizeLow=projectDataSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetAlias=iscsiTargetAlias, sanProperties=sanProperties, diskDataWriteMbps=diskDataWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, haResources=haResources, fcTotalReadIops=fcTotalReadIops, diskSizeLow=diskSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunFreeSizeLow=lunFreeSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, shareReservedSizeLow=shareReservedSizeLow, ipmiVoltage=ipmiVoltage, alertsCleanupCompleted=alertsCleanupCompleted, diskIsOnline=diskIsOnline, lunSizeLow=lunSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskIndex=diskIndex, poolImported=poolImported, fcInitiatorEntry=fcInitiatorEntry, shareCIFSEnabled=shareCIFSEnabled, poolDataSizeLow=poolDataSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiInitiatorGroup=iscsiInitiatorGroup, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectShares=projectShares, replicationAbandoned=replicationAbandoned, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareProjectName=shareProjectName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolAvgReadLatency=poolAvgReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, networkInterfaceUp=networkInterfaceUp, targetGroupMemberRemoved=targetGroupMemberRemoved, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeQuotaFinished=volumeQuotaFinished, ipmiMemory=ipmiMemory, iscsiInitiatorName=iscsiInitiatorName, nvdimmFailSoftError=nvdimmFailSoftError, diskDataReadIops=diskDataReadIops, iscsiTargetsTable=iscsiTargetsTable, upgradeFailed=upgradeFailed, fcTargetStatus=fcTargetStatus, projectTotalSaving=projectTotalSaving, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkInterfaceDown=networkInterfaceDown, deleteFolderCompleted=deleteFolderCompleted, tegileGroups=tegileGroups, projectQuotaSizeHigh=projectQuotaSizeHigh, haControllerB_Name=haControllerB_Name, cpuInterrupts=cpuInterrupts, projectFreeSizeHigh=projectFreeSizeHigh, smisServiceStopped=smisServiceStopped, poolMetaReadIops=poolMetaReadIops, lunDataSizeHigh=lunDataSizeHigh, nicReceiveMbps=nicReceiveMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nicName=nicName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceActiveNode=haResourceActiveNode, diskState=diskState, poolState=poolState, lunName=lunName, notificationObjects=notificationObjects, shareNFSReadIops=shareNFSReadIops, nicTable=nicTable, poolReadCacheReadIops=poolReadCacheReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectFreeSizeLow=projectFreeSizeLow, projectTable=projectTable, haControllerA_IPAddr=haControllerA_IPAddr, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetGroup=fcTargetGroup, vmwareNFSDatastores=vmwareNFSDatastores, poolName=poolName, fcPortOnline=fcPortOnline, fcInitiators=fcInitiators, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetName=fcTargetName, disks=disks, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, poolOwnerController=poolOwnerController, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetReadMbps=iscsiTargetReadMbps, poolSizeHigh=poolSizeHigh, smisServiceStopFailed=smisServiceStopFailed, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationReadingUnit=notificationReadingUnit, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationFailed=replicationFailed, cifsTotalReadIops=cifsTotalReadIops, notificationEventCode=notificationEventCode, iscsiTargetAuth=iscsiTargetAuth, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haControllerB_Uptime=haControllerB_Uptime, poolDataReadIops=poolDataReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, diskDataWriteIops=diskDataWriteIops, haResourceName=haResourceName, notificationComponentName=notificationComponentName, notificationReadingTriggerValue=notificationReadingTriggerValue, lunReadIops=lunReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskTotalWriteIops=diskTotalWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDeletionFailed=poolDeletionFailed, networkIpmpGroupUp=networkIpmpGroupUp, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskAlias=diskAlias, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunGUID=lunGUID, iscsiTargetEntry=iscsiTargetEntry, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, cifsAvgReadLatency=cifsAvgReadLatency, notificationSensorAction=notificationSensorAction, lunProtocol=lunProtocol, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetWriteIops=fcTargetWriteIops)
