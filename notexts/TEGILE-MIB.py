...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter32, Counter64, NotificationType, iso, enterprises, Integer32, TimeTicks, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter32", "Counter64", "NotificationType", "iso", "enterprises", "Integer32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", haResourceName=haResourceName, poolDataWriteLatency=poolDataWriteLatency, shareProjectName=shareProjectName, iscsiTargetError=iscsiTargetError, haResources=haResources, poolDataSizeHigh=poolDataSizeHigh, haResourceActiveNode=haResourceActiveNode, nicTransmitMbps=nicTransmitMbps, diskRandomIOCount=diskRandomIOCount, lunTable=lunTable, fcTargetStatus=fcTargetStatus, snmpServiceStopFailed=snmpServiceStopFailed, shareDedupEnabled=shareDedupEnabled, poolSizeHigh=poolSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, lunSizeHigh=lunSizeHigh, network=network, projectFreeSizeLow=projectFreeSizeLow, deleteFolderCompleted=deleteFolderCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolHealth=poolHealth, nfsTotalWriteIops=nfsTotalWriteIops, lunDedupEnabled=lunDedupEnabled, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, nicTable=nicTable, poolIndex=poolIndex, poolCount=poolCount, snapshotCreationFailed=snapshotCreationFailed, smisServiceStopped=smisServiceStopped, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalReadMbps=poolTotalReadMbps, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetAlias=iscsiTargetAlias, poolMetaWriteMbps=poolMetaWriteMbps, fcTotalReadIops=fcTotalReadIops, lunGUID=lunGUID, nfsAvgWriteLatency=nfsAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, diskSlowIo=diskSlowIo, fcInitiatorsTable=fcInitiatorsTable, haResourceStatus=haResourceStatus, iscsiProperties=iscsiProperties, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cpuInterrupts=cpuInterrupts, memoryFailure=memoryFailure, poolTable=poolTable, notificationObjects=notificationObjects, poolCreated=poolCreated, shareDeleted=shareDeleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunCompressedRatio=lunCompressedRatio, sensorFailureEvent=sensorFailureEvent, shareNFSWriteMbps=shareNFSWriteMbps, networkInterfaceUp=networkInterfaceUp, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcInitiatorEntry=fcInitiatorEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectDataSizeLow=projectDataSizeLow, projectTotalSaving=projectTotalSaving, projectLUNs=projectLUNs, lunProtocol=lunProtocol, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcPortOffline=fcPortOffline, lunReservedSizeLow=lunReservedSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haResourceGroup=haResourceGroup, networkIpmpGroupUp=networkIpmpGroupUp, diskError=diskError, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, upgradeCompleted=upgradeCompleted, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nicName=nicName, cifsAvgReadLatency=cifsAvgReadLatency, lunWriteIops=lunWriteIops, sanProperties=sanProperties, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskIOCount=diskIOCount, diskSizeHigh=diskSizeHigh, poolDeletionFailed=poolDeletionFailed, shareCIFSEnabled=shareCIFSEnabled, shareDataSizeLow=shareDataSizeLow, diskAvgReadLatency=diskAvgReadLatency, nicState=nicState, projectCompressionEnabled=projectCompressionEnabled, shareEntry=shareEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskGoneOffline=diskGoneOffline, cacheSSDReads=cacheSSDReads, poolExported=poolExported, haControllerB_Name=haControllerB_Name, poolMetaReadMbps=poolMetaReadMbps, fcTargetIndex=fcTargetIndex, netbiosSocketFailure=netbiosSocketFailure, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargets=iscsiTargets, diskDataReadMbps=diskDataReadMbps, tegileArray_notifications=tegileArray_notifications, iscsiTargetIndex=iscsiTargetIndex, shareNFSReadMbps=shareNFSReadMbps, diskTotalWriteIops=diskTotalWriteIops, smisServiceStartFailed=smisServiceStartFailed, fcInitiators=fcInitiators, snmpAgentVersion=snmpAgentVersion, projectName=projectName, poolDegraded=poolDegraded, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaReadLatency=poolMetaReadLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, notificationSeverity=notificationSeverity, lunSizeLow=lunSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalWriteMbps=diskTotalWriteMbps, poolDataReadMbps=poolDataReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, lunReadIops=lunReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareDataSizeHigh=shareDataSizeHigh, notificationReadingUnit=notificationReadingUnit, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, disks=disks, poolUpgraded=poolUpgraded, poolDeleted=poolDeleted, diskTotalReadIops=diskTotalReadIops, cacheTotalWriteMbps=cacheTotalWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectQuotaSizeHigh=projectQuotaSizeHigh, poolMetaWriteLatency=poolMetaWriteLatency, projectQuotaFinished=projectQuotaFinished, upgradeDownloadFailed=upgradeDownloadFailed, fcTotalReadMbps=fcTotalReadMbps, lunPoolName=lunPoolName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicIndex=nicIndex, diskChassisIdx=diskChassisIdx, globalStatistics=globalStatistics, poolReadCacheReadIops=poolReadCacheReadIops, poolMetaWriteIops=poolMetaWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, adServerTimeDrift=adServerTimeDrift, notificationProps=notificationProps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetEntry=iscsiTargetEntry, cacheTotalReadIops=cacheTotalReadIops, diskCount=diskCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nicReceiveMbps=nicReceiveMbps, ipmiFan=ipmiFan, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationComponentName=notificationComponentName, upgradeTimeout=upgradeTimeout, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetAuth=iscsiTargetAuth, pools=pools, fcInitiatorGroup=fcInitiatorGroup, notificationSensorAction=notificationSensorAction, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, unknownSensorEvent=unknownSensorEvent, cacheTotalWriteIops=cacheTotalWriteIops, smbSocketFailure=smbSocketFailure, poolOwnerController=poolOwnerController, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetReadLatency=iscsiTargetReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, lunDataSizeHigh=lunDataSizeHigh, tegileGroups=tegileGroups, fcTargetEntry=fcTargetEntry, poolName=poolName, cacheTotalReadMbps=cacheTotalReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareCompressedRatio=shareCompressedRatio, haResourceIndex=haResourceIndex, poolEntry=poolEntry, testNotification=testNotification, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, fcAvgWriteLatency=fcAvgWriteLatency, lunDataSizeLow=lunDataSizeLow, notificationEventCode=notificationEventCode, cifsAvgWriteLatency=cifsAvgWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, upgradeDownloadCompleted=upgradeDownloadCompleted, snapshotDeleteFailed=snapshotDeleteFailed, snmpServiceStarted=snmpServiceStarted, tegileArray=tegileArray, lunTargetGroup=lunTargetGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, poolState=poolState, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, ipmiThreshold=ipmiThreshold, iscsiTotalReadMbps=iscsiTotalReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, PYSNMP_MODULE_ID=tegile, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorIndex=iscsiInitiatorIndex, aclMigrationStarted=aclMigrationStarted, lunFreeSizeHigh=lunFreeSizeHigh, volumeModifyCompleted=volumeModifyCompleted, nicGroup=nicGroup, poolTotalWriteMbps=poolTotalWriteMbps, diskSizeLow=diskSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCompressionEnabled=shareCompressionEnabled, ipmiVoltage=ipmiVoltage, iscsiTargetReadIops=iscsiTargetReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, controllerUp=controllerUp, volumeQuotaFinished=volumeQuotaFinished, snapshotCloningFailed=snapshotCloningFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haResourcesTable=haResourcesTable, tegileConformance=tegileConformance, lunEntry=lunEntry, nicMTU=nicMTU, projectEntry=projectEntry, projectDedupEnabled=projectDedupEnabled, deleteFolderFailed=deleteFolderFailed, lunWriteLatency=lunWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskIsOnline=diskIsOnline, poolReadCacheWriteIops=poolReadCacheWriteIops, poolDataWriteIops=poolDataWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetReadLatency=fcTargetReadLatency, shareQuotaFinished=shareQuotaFinished, iscsiInitiatorChapUser=iscsiInitiatorChapUser)
mibBuilder.exportSymbols("TEGILE-MIB", poolExpanded=poolExpanded, currentObjectGroup=currentObjectGroup, iscsiTotalReadIops=iscsiTotalReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, controllerDown=controllerDown, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareIndex=shareIndex, poolAvgWriteLatency=poolAvgWriteLatency, shareName=shareName, replicationFailed=replicationFailed, shareReservedSizeLow=shareReservedSizeLow, poolDataSizeLow=poolDataSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, shareTable=shareTable, diskState=diskState, snmpServiceStartFailed=snmpServiceStartFailed, basicCompliance=basicCompliance, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationSensorSuspect=notificationSensorSuspect, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectModified=projectModified, replicationPaused=replicationPaused, upgradeFailed=upgradeFailed, cpuTotalUsage=cpuTotalUsage, ntpServerTimeDrift=ntpServerTimeDrift, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, currentNotificationGroup=currentNotificationGroup, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolDataWriteMbps=poolDataWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargets=fcTargets, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiMemory=ipmiMemory, poolUsedSizeLow=poolUsedSizeLow, notificationDescription=notificationDescription, fcTargetWriteMbps=fcTargetWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunBlockSize=lunBlockSize, projectDeletionFailed=projectDeletionFailed, upgradeDownloadStarted=upgradeDownloadStarted, shareQuotaLow=shareQuotaLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcAvgReadLatency=fcAvgReadLatency, cifsTotalWriteIops=cifsTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nfsTotalReadMbps=nfsTotalReadMbps, controllerHardwareModel=controllerHardwareModel, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTotalWriteMbps=fcTotalWriteMbps, replicationAbandoned=replicationAbandoned, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareMountPoint=shareMountPoint, networkIpmpGroupDown=networkIpmpGroupDown, shareNFSWriteLatency=shareNFSWriteLatency, notifications=notifications, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorName=fcInitiatorName, replicationAborted=replicationAborted, shareExceedThresholdWarning=shareExceedThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, projectTable=projectTable, snmpServiceStopped=snmpServiceStopped, ipmiTemperature=ipmiTemperature, projectShareCount=projectShareCount, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectShares=projectShares, diskDataWriteMbps=diskDataWriteMbps, fcTargetsTable=fcTargetsTable, lunCompressionEnabled=lunCompressionEnabled, replicationStarted=replicationStarted, fcTotalWriteIops=fcTotalWriteIops, aclMigrationCompleted=aclMigrationCompleted, maintenanceModeEnabled=maintenanceModeEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskDataReadIops=diskDataReadIops, poolTotalReadIops=poolTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, haControllerB_IPAddr=haControllerB_IPAddr, replicationResumed=replicationResumed, projectIndex=projectIndex, poolProjects=poolProjects, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargetName=iscsiTargetName, shareDeletionFailed=shareDeletionFailed, fcProperties=fcProperties, poolFreeSizeHigh=poolFreeSizeHigh, lunReadLatency=lunReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, lunName=lunName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, controllerTimeDrift=controllerTimeDrift, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiInitiators=iscsiInitiators, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetName=fcTargetName, haResourceDescription=haResourceDescription, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationComplete=replicationComplete, projectDataSizeHigh=projectDataSizeHigh, properties=properties, fcPortOnline=fcPortOnline, haControllerA_Uptime=haControllerA_Uptime, poolProjectCount=poolProjectCount, lunInitiatorGroup=lunInitiatorGroup, diskSequentialIOCount=diskSequentialIOCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationTime=notificationTime, nicEntry=nicEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetGroup=iscsiTargetGroup, haControllerA_Name=haControllerA_Name, fcTargetGroup=fcTargetGroup, projectPoolName=projectPoolName, cifsTotalReadMbps=cifsTotalReadMbps, networkInterfaceDown=networkInterfaceDown, poolDataReadIops=poolDataReadIops, diskIndex=diskIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolAvgReadLatency=poolAvgReadLatency, userLoginFailed=userLoginFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, lunReadMbps=lunReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cpuSystemCalls=cpuSystemCalls, lunIndex=lunIndex, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, diskType=diskType, ipmiPowerSupply=ipmiPowerSupply, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheRAMReads=cacheRAMReads, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, nvdimmFailSoftError=nvdimmFailSoftError, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolQuotaFinished=poolQuotaFinished, diskPoolName=diskPoolName, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceEntry=haResourceEntry, tegile=tegile, poolTotalWriteIops=poolTotalWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, spareDiskReplaced=spareDiskReplaced, poolDataReadLatency=poolDataReadLatency, shareNFSWriteIops=shareNFSWriteIops, diskEntry=diskEntry, projectLunCount=projectLunCount, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetsTable=iscsiTargetsTable, projectThresholdExceedWarning=projectThresholdExceedWarning, diskAlias=diskAlias, lunReservedSizeHigh=lunReservedSizeHigh, shareNFSReadIops=shareNFSReadIops, haControllerB_Uptime=haControllerB_Uptime, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiOther=ipmiOther, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, sharePoolName=sharePoolName, poolSizeLow=poolSizeLow, fcTargetReadIops=fcTargetReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetReadMbps=fcTargetReadMbps, smisServiceStopFailed=smisServiceStopFailed, nfsTotalReadIops=nfsTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, poolTotalSaving=poolTotalSaving, lunProjectName=lunProjectName, shareQuotaHigh=shareQuotaHigh, tegileCompliances=tegileCompliances, projectDeleted=projectDeleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, upgradeStarted=upgradeStarted, fcTargetWriteLatency=fcTargetWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, lunWriteMbps=lunWriteMbps, replicationTargetDeleted=replicationTargetDeleted, iscsiWriteIops=iscsiWriteIops, cifsTotalReadIops=cifsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, poolImported=poolImported, snapshotCloneCompleted=snapshotCloneCompleted, ipmiCurrent=ipmiCurrent, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskTable=diskTable, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops)
