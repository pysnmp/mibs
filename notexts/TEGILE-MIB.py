...
NotificationType, Gauge32, MibIdentifier, IpAddress, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ObjectIdentity, Bits, enterprises, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "IpAddress", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ObjectIdentity", "Bits", "enterprises", "Counter32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskSizeHigh=diskSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskDataWriteMbps=diskDataWriteMbps, poolName=poolName, nicName=nicName, poolTable=poolTable, networkTotalReceiveMbps=networkTotalReceiveMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, adServerTimeDrift=adServerTimeDrift, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareIndex=shareIndex, shareDataSizeLow=shareDataSizeLow, controllerUp=controllerUp, shareNFSReadMbps=shareNFSReadMbps, projectTable=projectTable, projectSnapshotSizeLow=projectSnapshotSizeLow, poolExpanded=poolExpanded, diskSequentialIOCount=diskSequentialIOCount, haControllerB_Name=haControllerB_Name, unknownSensorEvent=unknownSensorEvent, diskIsOnline=diskIsOnline, poolOwnerController=poolOwnerController, smbSocketFailure=smbSocketFailure, nvdimmFailDeviceError=nvdimmFailDeviceError, nicState=nicState, globalStatistics=globalStatistics, diskSizeLow=diskSizeLow, replicationSourceRegistered=replicationSourceRegistered, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, ipmiOther=ipmiOther, poolUpgraded=poolUpgraded, fcInitiatorName=fcInitiatorName, haResourceDescription=haResourceDescription, diskPoolName=diskPoolName, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolAvgWriteLatency=poolAvgWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, shareDataSizeHigh=shareDataSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunGUID=lunGUID, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetsTable=iscsiTargetsTable, projectCompressionEnabled=projectCompressionEnabled, cacheRAMReads=cacheRAMReads, poolDataReadLatency=poolDataReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolMetaWriteIops=poolMetaWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, shareDeleted=shareDeleted, haResourcesTable=haResourcesTable, ipmiThreshold=ipmiThreshold, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataReadMbps=poolDataReadMbps, upgradeCompleted=upgradeCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorsTable=fcInitiatorsTable, projectFreeSizeHigh=projectFreeSizeHigh, replicationAbandoned=replicationAbandoned, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snapshotCreationFailed=snapshotCreationFailed, deleteFolderFailed=deleteFolderFailed, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcInitiatorGroup=fcInitiatorGroup, diskIOCount=diskIOCount, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, currentNotificationGroup=currentNotificationGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetEntry=iscsiTargetEntry, nfsTotalReadMbps=nfsTotalReadMbps, diskCount=diskCount, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetReadMbps=fcTargetReadMbps, poolMetaReadLatency=poolMetaReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareName=shareName, pools=pools, lunTable=lunTable, diskTotalWriteIops=diskTotalWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationStarted=replicationStarted, fcAvgReadLatency=fcAvgReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, lunEntry=lunEntry, replicationResumed=replicationResumed, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeDownloadStarted=upgradeDownloadStarted, replicationComplete=replicationComplete, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, sanProperties=sanProperties, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargets=iscsiTargets, notificationObjects=notificationObjects, haResourceStatus=haResourceStatus, diskDataReadMbps=diskDataReadMbps, projectEntry=projectEntry, poolTotalWriteIops=poolTotalWriteIops, smisServiceStopped=smisServiceStopped, smisServiceStartFailed=smisServiceStartFailed, poolFreeSizeHigh=poolFreeSizeHigh, fcInitiatorIndex=fcInitiatorIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataWriteIops=poolDataWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTotalWriteMbps=fcTotalWriteMbps, shareQuotaLow=shareQuotaLow, poolIndex=poolIndex, shareNFSReadLatency=shareNFSReadLatency, lunPoolName=lunPoolName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkInterfaceDown=networkInterfaceDown, iscsiInitiatorIndex=iscsiInitiatorIndex, poolProjects=poolProjects, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskSlowIo=diskSlowIo, shareNFSEnabled=shareNFSEnabled, nicReceiveMbps=nicReceiveMbps, tegileConformance=tegileConformance, iscsiWriteIops=iscsiWriteIops, fcTargetReadIops=fcTargetReadIops, ipmiFan=ipmiFan, notificationProps=notificationProps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, PYSNMP_MODULE_ID=tegile, shareCIFSWriteIops=shareCIFSWriteIops, shareCompressionEnabled=shareCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetGroup=fcTargetGroup, fcProperties=fcProperties, haResourceName=haResourceName, fcTotalReadIops=fcTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetReadIops=iscsiTargetReadIops, testNotification=testNotification, sharePoolName=sharePoolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareProjectName=shareProjectName, nicMTU=nicMTU, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareEntry=shareEntry, haResourceEntry=haResourceEntry, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetName=fcTargetName, nvdimmFailSoftError=nvdimmFailSoftError, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskDataReadIops=diskDataReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskAvgReadLatency=diskAvgReadLatency, cpuInterrupts=cpuInterrupts, shareQuotaHigh=shareQuotaHigh, poolDataWriteMbps=poolDataWriteMbps, shareCIFSEnabled=shareCIFSEnabled, spareDiskReplaced=spareDiskReplaced, ipmiMemory=ipmiMemory, poolDataWriteLatency=poolDataWriteLatency, haControllerB_Uptime=haControllerB_Uptime, fcTargets=fcTargets, aclMigrationStarted=aclMigrationStarted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkIpmpGroupUp=networkIpmpGroupUp, notificationEventCode=notificationEventCode, poolMetaWriteLatency=poolMetaWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceActiveNode=haResourceActiveNode, diskAlias=diskAlias, poolEntry=poolEntry, lunReadMbps=lunReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, notificationSensorNumber=notificationSensorNumber, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetStatus=fcTargetStatus, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiators=iscsiInitiators, netbiosSocketFailure=netbiosSocketFailure, replicationPaused=replicationPaused, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiInitiatorGroup=iscsiInitiatorGroup, lunTargetGroup=lunTargetGroup, poolHealth=poolHealth, cpuSystemCalls=cpuSystemCalls, lunReservedSizeHigh=lunReservedSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, poolUsedSizeHigh=poolUsedSizeHigh, disks=disks, poolDeleted=poolDeleted, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetError=iscsiTargetError, notifications=notifications, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, notificationSensorSuspect=notificationSensorSuspect, shareCIFSReadMbps=shareCIFSReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTotalWriteIops=fcTotalWriteIops, diskDataWriteIops=diskDataWriteIops, notificationComponentName=notificationComponentName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolSizeLow=poolSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, diskRandomIOCount=diskRandomIOCount, upgradeDownloadFailed=upgradeDownloadFailed, controllerDown=controllerDown, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareNFSWriteLatency=shareNFSWriteLatency, lunDataSizeLow=lunDataSizeLow, nfsTotalReadIops=nfsTotalReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareQuotaFinished=shareQuotaFinished, replicationAborted=replicationAborted, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, projectTotalSaving=projectTotalSaving, tegileGroups=tegileGroups, cifsAvgReadLatency=cifsAvgReadLatency, poolQuotaFinished=poolQuotaFinished, basicCompliance=basicCompliance, poolDataSizeLow=poolDataSizeLow, lunCompressedRatio=lunCompressedRatio, haResourceGroup=haResourceGroup, lunProjectName=lunProjectName, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, controllerTimeDrift=controllerTimeDrift, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskChassisIdx=diskChassisIdx)
mibBuilder.exportSymbols("TEGILE-MIB", lunSizeLow=lunSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, shareNFSWriteIops=shareNFSWriteIops, cpuTotalUsage=cpuTotalUsage, poolSizeHigh=poolSizeHigh, poolTotalSaving=poolTotalSaving, currentObjectGroup=currentObjectGroup, diskState=diskState, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolImported=poolImported, fcPortOffline=fcPortOffline, lunProtocol=lunProtocol, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, aclMigrationCompleted=aclMigrationCompleted, diskTable=diskTable, shareMountPoint=shareMountPoint, diskGoneOffline=diskGoneOffline, projectShareCount=projectShareCount, diagnosticDataUploaded=diagnosticDataUploaded, upgradeTimeout=upgradeTimeout, replicationFailed=replicationFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorName=iscsiInitiatorName, diskIndex=diskIndex, fcTargetWriteIops=fcTargetWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationTime=notificationTime, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, deleteFolderCompleted=deleteFolderCompleted, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTotalReadIops=iscsiTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, projectDataSizeLow=projectDataSizeLow, notificationReadingUnit=notificationReadingUnit, projectDeleted=projectDeleted, iscsiTargetAlias=iscsiTargetAlias, projectFreeSizeLow=projectFreeSizeLow, lunBlockSize=lunBlockSize, lunWriteIops=lunWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, poolDegraded=poolDegraded, sensorFailureEvent=sensorFailureEvent, memoryFailure=memoryFailure, shareCIFSReadLatency=shareCIFSReadLatency, haResources=haResources, nicIndex=nicIndex, snmpAgentVersion=snmpAgentVersion, poolMetaReadMbps=poolMetaReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, notificationDescription=notificationDescription, shareCompressedRatio=shareCompressedRatio, poolCreated=poolCreated, shareExceedThresholdWarning=shareExceedThresholdWarning, volumeQuotaFinished=volumeQuotaFinished, projectDeletionFailed=projectDeletionFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorEntry=fcInitiatorEntry, fcTargetIndex=fcTargetIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, targetGroupMemberAdded=targetGroupMemberAdded, nicTable=nicTable, shareDedupEnabled=shareDedupEnabled, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, nicEntry=nicEntry, shareTable=shareTable, snmpServiceStopped=snmpServiceStopped, userLoginFailed=userLoginFailed, volumeDeleteFailed=volumeDeleteFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcPortOnline=fcPortOnline, maintenanceModeDisabled=maintenanceModeDisabled, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_Name=haControllerA_Name, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tegileCompliances=tegileCompliances, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetName=iscsiTargetName, diskError=diskError, volumeDeleteCompleted=volumeDeleteCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, shareReservedSizeLow=shareReservedSizeLow, ipmiVoltage=ipmiVoltage, nfsTotalWriteMbps=nfsTotalWriteMbps, fcTargetsTable=fcTargetsTable, smisServiceStopFailed=smisServiceStopFailed, cacheTotalReadIops=cacheTotalReadIops, poolFreeSizeLow=poolFreeSizeLow, nicGroup=nicGroup, volumeModifyCompleted=volumeModifyCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, cacheTotalWriteIops=cacheTotalWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectModified=projectModified, snmpServiceStartFailed=snmpServiceStartFailed, tegile=tegile, projectDedupEnabled=projectDedupEnabled, projectShares=projectShares, cacheTotalReadMbps=cacheTotalReadMbps, poolProjectCount=poolProjectCount, poolTotalReadMbps=poolTotalReadMbps, nicTransmitMbps=nicTransmitMbps, replicationTargetDeleted=replicationTargetDeleted, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetAuth=iscsiTargetAuth, smisServiceStarted=smisServiceStarted, diskAvgWriteLatency=diskAvgWriteLatency, snapshotCloningFailed=snapshotCloningFailed, tegileArray_notifications=tegileArray_notifications, diskEntry=diskEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationSensorAction=notificationSensorAction, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunName=lunName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeStarted=upgradeStarted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, cacheSSDReads=cacheSSDReads, projectQuotaFinished=projectQuotaFinished, poolTotalReadIops=poolTotalReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, lunWriteLatency=lunWriteLatency, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, nvdimmFailUnknownError=nvdimmFailUnknownError, tegileArray=tegileArray, haResourceIndex=haResourceIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, lunIndex=lunIndex, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerA_Uptime=haControllerA_Uptime, lunFreeSizeLow=lunFreeSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, ipmiCurrent=ipmiCurrent, shareDeletionFailed=shareDeletionFailed, fcInitiators=fcInitiators, ipmiTemperature=ipmiTemperature, poolState=poolState, iscsiInitiatorsTable=iscsiInitiatorsTable, cifsTotalWriteMbps=cifsTotalWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, poolExported=poolExported, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectLunCount=projectLunCount, lunReadIops=lunReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskType=diskType, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkInterfaceUp=networkInterfaceUp, controllerHardwareModel=controllerHardwareModel, projectLUNs=projectLUNs, projectIndex=projectIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadIops=poolMetaReadIops, projectName=projectName, fcTargetEntry=fcTargetEntry, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetReadLatency=fcTargetReadLatency, lunCompressionEnabled=lunCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataReadIops=poolDataReadIops, cifsTotalReadIops=cifsTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareCIFSReadIops=shareCIFSReadIops, projectDataSizeHigh=projectDataSizeHigh, upgradeFailed=upgradeFailed, snmpServiceStarted=snmpServiceStarted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiCriticalInterrupt=ipmiCriticalInterrupt, network=network, notificationSeverity=notificationSeverity, properties=properties, diskTotalReadIops=diskTotalReadIops, poolCount=poolCount, iscsiProperties=iscsiProperties, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunReadLatency=lunReadLatency, poolDeletionFailed=poolDeletionFailed, lunSizeHigh=lunSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, projectPoolName=projectPoolName, shareNFSReadIops=shareNFSReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps)
