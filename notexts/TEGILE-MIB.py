...
Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, MibIdentifier, ObjectIdentity, Integer32, enterprises, Gauge32, TimeTicks, Unsigned32, iso, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "MibIdentifier", "ObjectIdentity", "Integer32", "enterprises", "Gauge32", "TimeTicks", "Unsigned32", "iso", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snapshotCloneCompleted=snapshotCloneCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, tegileArray=tegileArray, pools=pools, iscsiInitiatorChapUser=iscsiInitiatorChapUser, smisServiceStarted=smisServiceStarted, projectLunCount=projectLunCount, notificationEventCode=notificationEventCode, lunFreeSizeLow=lunFreeSizeLow, haResourcesTable=haResourcesTable, poolReadCacheReadIops=poolReadCacheReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetReadMbps=fcTargetReadMbps, shareQuotaLow=shareQuotaLow, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, sharePoolName=sharePoolName, haResourceName=haResourceName, iscsiInitiatorName=iscsiInitiatorName, smisServiceStopFailed=smisServiceStopFailed, cacheRAMReads=cacheRAMReads, properties=properties, snapshotRollbackFailed=snapshotRollbackFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolName=poolName, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, upgradeStarted=upgradeStarted, upgradeDownloadFailed=upgradeDownloadFailed, notificationTargetEntityName=notificationTargetEntityName, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetGroup=iscsiTargetGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, disks=disks, networkInterfaceUp=networkInterfaceUp, poolReadCacheWriteMbps=poolReadCacheWriteMbps, ipmiThreshold=ipmiThreshold, poolIndex=poolIndex, network=network, poolDataSizeLow=poolDataSizeLow, shareIndex=shareIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotCloningFailed=snapshotCloningFailed, haControllerB_Name=haControllerB_Name, fcTargetReadIops=fcTargetReadIops, diskGoneOffline=diskGoneOffline, iscsiTargets=iscsiTargets, volumeDeleteFailed=volumeDeleteFailed, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastores=vmwareNFSDatastores, diskIndex=diskIndex, poolDataReadLatency=poolDataReadLatency, poolDegraded=poolDegraded, notificationProps=notificationProps, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTotalWriteMbps=poolTotalWriteMbps, poolHealth=poolHealth, lunReservedSizeLow=lunReservedSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nicName=nicName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, lunReservedSizeHigh=lunReservedSizeHigh, currentObjectGroup=currentObjectGroup, tegile=tegile, replicationResumed=replicationResumed, poolReadCacheReadLatency=poolReadCacheReadLatency, poolMetaReadLatency=poolMetaReadLatency, projectQuotaFinished=projectQuotaFinished, nvdimmFailDeviceError=nvdimmFailDeviceError, lunCompressionEnabled=lunCompressionEnabled, volumeDeleteCompleted=volumeDeleteCompleted, unknownSensorEvent=unknownSensorEvent, networkTotalTransmitMbps=networkTotalTransmitMbps, diskDataReadIops=diskDataReadIops, lunBlockSize=lunBlockSize, shareNFSReadLatency=shareNFSReadLatency, notificationTime=notificationTime, iscsiTargetReadMbps=iscsiTargetReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, shareMountPoint=shareMountPoint, poolMetaWriteLatency=poolMetaWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectName=projectName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, ipmiMemory=ipmiMemory, diskTotalWriteMbps=diskTotalWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, projectShares=projectShares, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskTotalReadMbps=diskTotalReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorIndex=fcInitiatorIndex, ipmiCurrent=ipmiCurrent, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationFailed=replicationFailed, snmpServiceStarted=snmpServiceStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, spareDiskReplaced=spareDiskReplaced, lunSizeHigh=lunSizeHigh, cacheTotalReadIops=cacheTotalReadIops, projectQuotaSizeHigh=projectQuotaSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, snmpServiceStopped=snmpServiceStopped, diskAvgReadLatency=diskAvgReadLatency, nicMTU=nicMTU, ipmiCriticalInterrupt=ipmiCriticalInterrupt, targetGroupMemberAdded=targetGroupMemberAdded, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, aclMigrationStarted=aclMigrationStarted, replicationStarted=replicationStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectFreeSizeLow=projectFreeSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, deleteFolderCompleted=deleteFolderCompleted, diskDataWriteIops=diskDataWriteIops, fcTargetReadLatency=fcTargetReadLatency, replicationComplete=replicationComplete, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, upgradeDownloadStarted=upgradeDownloadStarted, shareQuotaHigh=shareQuotaHigh, notificationSensorAction=notificationSensorAction, fcAvgWriteLatency=fcAvgWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolSizeLow=poolSizeLow, projectTotalSaving=projectTotalSaving, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkIpmpGroupUp=networkIpmpGroupUp, lunSizeLow=lunSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, ipmiTemperature=ipmiTemperature, replicationSourceRegistered=replicationSourceRegistered, nicGroup=nicGroup, poolUpgraded=poolUpgraded, shareDeleted=shareDeleted, diagnosticDataUploaded=diagnosticDataUploaded, upgradeFailed=upgradeFailed, shareNFSWriteMbps=shareNFSWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunIndex=lunIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectModified=projectModified, iscsiTargetError=iscsiTargetError, replicationAbandoned=replicationAbandoned, iscsiTargetReadLatency=iscsiTargetReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nicTable=nicTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskDataReadMbps=diskDataReadMbps, fcTargetGroup=fcTargetGroup, notificationReadingUnit=notificationReadingUnit, fcTotalReadIops=fcTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, smisServiceStopped=smisServiceStopped, diskAlias=diskAlias, iscsiWriteIops=iscsiWriteIops, shareDataSizeLow=shareDataSizeLow, poolState=poolState, lunCompressedRatio=lunCompressedRatio, poolDeleted=poolDeleted, upgradeCompleted=upgradeCompleted, poolCreated=poolCreated, lunInitiatorGroup=lunInitiatorGroup, diskTotalReadIops=diskTotalReadIops, poolMetaReadIops=poolMetaReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareName=shareName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationObjects=notificationObjects, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskSlowIo=diskSlowIo, diskSequentialIOCount=diskSequentialIOCount, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetsTable=fcTargetsTable, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, controllerDown=controllerDown, ipmiOther=ipmiOther, shareQuotaFinished=shareQuotaFinished, snmpServiceStartFailed=snmpServiceStartFailed, lunFreeSizeHigh=lunFreeSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, projectPoolName=projectPoolName, projectIndex=projectIndex, lunTargetGroup=lunTargetGroup, poolAvgReadLatency=poolAvgReadLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, controllerHardwareModel=controllerHardwareModel, shareDataSizeHigh=shareDataSizeHigh, diskSizeLow=diskSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, nfsAvgReadLatency=nfsAvgReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskRandomIOCount=diskRandomIOCount, lunReadMbps=lunReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, fcInitiatorName=fcInitiatorName, smisServiceStartFailed=smisServiceStartFailed, haResourceIndex=haResourceIndex, fcPortOffline=fcPortOffline, networkInterfaceDown=networkInterfaceDown, lunTable=lunTable, notificationSensorNumber=notificationSensorNumber, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, haResourceGroup=haResourceGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcInitiatorsTable=fcInitiatorsTable, poolDeletionFailed=poolDeletionFailed, haResourceEntry=haResourceEntry, shareCreatedSuccessfully=shareCreatedSuccessfully, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCompressionEnabled=shareCompressionEnabled, poolProjects=poolProjects, poolExported=poolExported, diskIOCount=diskIOCount, poolTotalReadIops=poolTotalReadIops, volumeModifyCompleted=volumeModifyCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, poolAvgWriteLatency=poolAvgWriteLatency, replicationTargetDeleted=replicationTargetDeleted, fcTargets=fcTargets, haResourceStatus=haResourceStatus, fcTargetIndex=fcTargetIndex, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcInitiators=fcInitiators, iscsiInitiators=iscsiInitiators, shareNFSReadIops=shareNFSReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTotalWriteIops=fcTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationAborted=replicationAborted, haControllerA_Uptime=haControllerA_Uptime, notifications=notifications, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunDedupEnabled=lunDedupEnabled, lunEntry=lunEntry)
mibBuilder.exportSymbols("TEGILE-MIB", projectDataSizeLow=projectDataSizeLow, projectDataSizeHigh=projectDataSizeHigh, shareNFSWriteIops=shareNFSWriteIops, basicCompliance=basicCompliance, ipmiVoltage=ipmiVoltage, shareReservedSizeLow=shareReservedSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, cifsAvgReadLatency=cifsAvgReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskPoolName=diskPoolName, haControllerA_Name=haControllerA_Name, projectCompressionEnabled=projectCompressionEnabled, notificationComponentName=notificationComponentName, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetName=iscsiTargetName, sensorFailureEvent=sensorFailureEvent, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nicState=nicState, lunProtocol=lunProtocol, lunWriteLatency=lunWriteLatency, nfsTotalReadIops=nfsTotalReadIops, projectDedupEnabled=projectDedupEnabled, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, cacheTotalReadMbps=cacheTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetEntry=fcTargetEntry, iscsiTotalReadIops=iscsiTotalReadIops, volumeQuotaFinished=volumeQuotaFinished, iscsiProperties=iscsiProperties, cifsTotalWriteIops=cifsTotalWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cpuInterrupts=cpuInterrupts, shareReservedSizeHigh=shareReservedSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareEntry=shareEntry, cifsTotalReadIops=cifsTotalReadIops, poolDataWriteLatency=poolDataWriteLatency, globalStatistics=globalStatistics, shareProjectName=shareProjectName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataReadMbps=poolDataReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, lunDataSizeHigh=lunDataSizeHigh, fcTargetStatus=fcTargetStatus, diskSizeHigh=diskSizeHigh, lunDataSizeLow=lunDataSizeLow, projectTable=projectTable, fcPortOnline=fcPortOnline, fcProperties=fcProperties, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareSnapshotSizeLow=shareSnapshotSizeLow, diskState=diskState, lunProjectName=lunProjectName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskType=diskType, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, projectShareCount=projectShareCount, shareNFSReadMbps=shareNFSReadMbps, nvdimmFailSoftError=nvdimmFailSoftError, controllerTimeDrift=controllerTimeDrift, tegileGroups=tegileGroups, PYSNMP_MODULE_ID=tegile, iscsiTargetAuth=iscsiTargetAuth, haResources=haResources, poolMetaReadMbps=poolMetaReadMbps, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tegileConformance=tegileConformance, maintenanceModeEnabled=maintenanceModeEnabled, projectDeletionFailed=projectDeletionFailed, poolQuotaFinished=poolQuotaFinished, shareCIFSWriteIops=shareCIFSWriteIops, lunReadIops=lunReadIops, shareCIFSReadLatency=shareCIFSReadLatency, notificationSensorSuspect=notificationSensorSuspect, fcAvgReadLatency=fcAvgReadLatency, haResourceDescription=haResourceDescription, memoryFailure=memoryFailure, poolDataWriteIops=poolDataWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, diskIsOnline=diskIsOnline, sanProperties=sanProperties, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicReceiveMbps=nicReceiveMbps, cacheSSDReads=cacheSSDReads, iscsiTargetEntry=iscsiTargetEntry, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, poolFreeSizeLow=poolFreeSizeLow, adServerTimeDrift=adServerTimeDrift, aclMigrationCompleted=aclMigrationCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, tegileCompliances=tegileCompliances, lunWriteMbps=lunWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolExpanded=poolExpanded, iscsiTargetAlias=iscsiTargetAlias, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, poolEntry=poolEntry, lunPoolName=lunPoolName, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcInitiatorEntry=fcInitiatorEntry, snmpServiceStopFailed=snmpServiceStopFailed, diskTotalWriteIops=diskTotalWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetWriteIops=fcTargetWriteIops, poolTotalSaving=poolTotalSaving, nicTransmitMbps=nicTransmitMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSEnabled=shareNFSEnabled, shareCompressedRatio=shareCompressedRatio, poolFreeSizeHigh=poolFreeSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolUsedSizeLow=poolUsedSizeLow, userLoginFailed=userLoginFailed, lunName=lunName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nicIndex=nicIndex, snmpAgentVersion=snmpAgentVersion, poolTable=poolTable, fcInitiatorGroup=fcInitiatorGroup, ntpServerTimeDrift=ntpServerTimeDrift, upgradeTimeout=upgradeTimeout, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolImported=poolImported, lunGUID=lunGUID, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, smbSocketFailure=smbSocketFailure, shareDeletionFailed=shareDeletionFailed, diskCount=diskCount, shareCIFSReadMbps=shareCIFSReadMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolUsedSizeHigh=poolUsedSizeHigh, poolDataReadIops=poolDataReadIops, snapshotCreationFailed=snapshotCreationFailed, cpuTotalUsage=cpuTotalUsage, projectEntry=projectEntry, poolTotalWriteIops=poolTotalWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, poolProjectCount=poolProjectCount, ipmiFan=ipmiFan, fcTargetName=fcTargetName, diskChassisIdx=diskChassisIdx, iscsiTotalReadMbps=iscsiTotalReadMbps, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolSizeHigh=poolSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, replicationPaused=replicationPaused, controllerUp=controllerUp, cpuSystemCalls=cpuSystemCalls, poolOwnerController=poolOwnerController, diskError=diskError, testNotification=testNotification, lunReadLatency=lunReadLatency, nicEntry=nicEntry, poolCount=poolCount, shareTable=shareTable, shareCIFSEnabled=shareCIFSEnabled, notificationDescription=notificationDescription, cifsTotalReadMbps=cifsTotalReadMbps, diskDataWriteMbps=diskDataWriteMbps, diskEntry=diskEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolTotalReadMbps=poolTotalReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunWriteIops=lunWriteIops, haResourceActiveNode=haResourceActiveNode, maintenanceModeDisabled=maintenanceModeDisabled, diskTable=diskTable, fcTargetModifyCompleted=fcTargetModifyCompleted, projectDeleted=projectDeleted, projectLUNs=projectLUNs, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationSeverity=notificationSeverity, iscsiTargetIndex=iscsiTargetIndex, shareNFSWriteLatency=shareNFSWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops)
