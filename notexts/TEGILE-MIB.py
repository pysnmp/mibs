...
Counter32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks, Gauge32, MibIdentifier, IpAddress, Unsigned32, ModuleIdentity, NotificationType, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "Unsigned32", "ModuleIdentity", "NotificationType", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", currentObjectGroup=currentObjectGroup, cifsTotalReadIops=cifsTotalReadIops, sensorFailureEvent=sensorFailureEvent, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationResumed=replicationResumed, nfsAvgReadLatency=nfsAvgReadLatency, poolTotalReadMbps=poolTotalReadMbps, poolCount=poolCount, shareEntry=shareEntry, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunCompressionEnabled=lunCompressionEnabled, haResourceStatus=haResourceStatus, iscsiTargetGroupError=iscsiTargetGroupError, snapshotCloneCompleted=snapshotCloneCompleted, poolTotalWriteMbps=poolTotalWriteMbps, lunDedupEnabled=lunDedupEnabled, poolDeletionFailed=poolDeletionFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationSensorSuspect=notificationSensorSuspect, notificationThresholdTriggerValue=notificationThresholdTriggerValue, controllerDown=controllerDown, lunGUID=lunGUID, poolDataSizeHigh=poolDataSizeHigh, projectName=projectName, sanProperties=sanProperties, snmpAgentVersion=snmpAgentVersion, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskAvgReadLatency=diskAvgReadLatency, memoryFailure=memoryFailure, poolDataWriteIops=poolDataWriteIops, poolName=poolName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskDataReadMbps=diskDataReadMbps, smisServiceStopped=smisServiceStopped, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDegraded=poolDegraded, notificationProps=notificationProps, shareCIFSEnabled=shareCIFSEnabled, lunBlockSize=lunBlockSize, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetAlias=iscsiTargetAlias, targetGroupCreateCompleted=targetGroupCreateCompleted, userLoginFailed=userLoginFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDataSizeLow=projectDataSizeLow, diskIOCount=diskIOCount, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaWriteMbps=poolMetaWriteMbps, notificationComponentName=notificationComponentName, upgradeDownloadFailed=upgradeDownloadFailed, nicMTU=nicMTU, iscsiProperties=iscsiProperties, cacheRAMReads=cacheRAMReads, fcInitiatorName=fcInitiatorName, replicationPaused=replicationPaused, shareNFSWriteLatency=shareNFSWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceEntry=haResourceEntry, controllerTimeDrift=controllerTimeDrift, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, upgradeFailed=upgradeFailed, replicationTargetDeleted=replicationTargetDeleted, shareCIFSReadIops=shareCIFSReadIops, poolProjects=poolProjects, poolMetaReadMbps=poolMetaReadMbps, notificationObjects=notificationObjects, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReadLatency=lunReadLatency, diskTotalReadMbps=diskTotalReadMbps, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, snmpServiceStopFailed=snmpServiceStopFailed, shareQuotaHigh=shareQuotaHigh, projectTable=projectTable, targetGroupDeleteCompleted=targetGroupDeleteCompleted, upgradeCompleted=upgradeCompleted, fcTargetEntry=fcTargetEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, shareQuotaFinished=shareQuotaFinished, webdocsUpgradeFailed=webdocsUpgradeFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataSizeLow=poolDataSizeLow, projectCompressionEnabled=projectCompressionEnabled, notificationDescription=notificationDescription, tegileArray=tegileArray, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolState=poolState, smisServiceStarted=smisServiceStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTotalWriteIops=fcTotalWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskTotalWriteIops=diskTotalWriteIops, disks=disks, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetReadIops=iscsiTargetReadIops, poolDataWriteLatency=poolDataWriteLatency, projectModified=projectModified, poolMetaWriteLatency=poolMetaWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, nicName=nicName, projectLUNs=projectLUNs, snapshotRollbackFailed=snapshotRollbackFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, sharePoolName=sharePoolName, replicationFailed=replicationFailed, poolTable=poolTable, poolFreeSizeHigh=poolFreeSizeHigh, haResourceGroup=haResourceGroup, fcTargetsTable=fcTargetsTable, shareNFSReadLatency=shareNFSReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, fcPortOffline=fcPortOffline, nfsAvgWriteLatency=nfsAvgWriteLatency, tegileArray_notifications=tegileArray_notifications, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTargetGroup=fcTargetGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, maintenanceModeEnabled=maintenanceModeEnabled, notificationReadingUnit=notificationReadingUnit, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskIndex=diskIndex, ipmiVoltage=ipmiVoltage, snapshotCloningFailed=snapshotCloningFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, ipmiPowerSupply=ipmiPowerSupply, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataReadMbps=poolDataReadMbps, lunProjectName=lunProjectName, replicationSourceRegistered=replicationSourceRegistered, projectFreeSizeHigh=projectFreeSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheTotalReadMbps=cacheTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorsTable=fcInitiatorsTable, notificationSensorAction=notificationSensorAction, networkInterfaceUp=networkInterfaceUp, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiOther=ipmiOther, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snapshotRollbackCompleted=snapshotRollbackCompleted, deleteFolderCompleted=deleteFolderCompleted, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetName=fcTargetName, networkIpmpGroupDown=networkIpmpGroupDown, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunIndex=lunIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationComplete=replicationComplete, upgradeDownloadStarted=upgradeDownloadStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetReadIops=fcTargetReadIops, poolUpgraded=poolUpgraded, haResourceIndex=haResourceIndex, cifsTotalReadMbps=cifsTotalReadMbps, diskTotalReadIops=diskTotalReadIops, snapshotDeleteFailed=snapshotDeleteFailed, poolFreeSizeLow=poolFreeSizeLow, lunReadIops=lunReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, diskPoolName=diskPoolName, diskIsOnline=diskIsOnline, lunSizeLow=lunSizeLow, projectTotalSaving=projectTotalSaving, fcTotalReadMbps=fcTotalReadMbps, shareMountPoint=shareMountPoint, poolQuotaFinished=poolQuotaFinished, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskAlias=diskAlias, diskChassisIdx=diskChassisIdx, shareName=shareName, nicTransmitMbps=nicTransmitMbps, volumeDeleteCompleted=volumeDeleteCompleted, projectShareCount=projectShareCount, haResourceName=haResourceName, poolSizeLow=poolSizeLow, nicState=nicState, nicIndex=nicIndex, poolReadCacheReadLatency=poolReadCacheReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, controllerHardwareModel=controllerHardwareModel, iscsiTargets=iscsiTargets, fcTargetStatus=fcTargetStatus, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snmpServiceStopped=snmpServiceStopped, lunTargetGroup=lunTargetGroup, cpuSystemCalls=cpuSystemCalls, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolEntry=poolEntry, diskDataReadIops=diskDataReadIops, ipmiTemperature=ipmiTemperature, projectLunCount=projectLunCount, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunWriteIops=lunWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, haResourcesTable=haResourcesTable, shareNFSReadMbps=shareNFSReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunReadMbps=lunReadMbps, upgradeTimeout=upgradeTimeout, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, targetGroupMemberAdded=targetGroupMemberAdded, tegile=tegile, replicationAborted=replicationAborted, lunInitiatorGroup=lunInitiatorGroup, haResources=haResources, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolMetaReadIops=poolMetaReadIops, poolImported=poolImported, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, network=network, haControllerA_Uptime=haControllerA_Uptime, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTargetIndex=fcTargetIndex, maintenanceModeDisabled=maintenanceModeDisabled, cacheSSDReads=cacheSSDReads, poolHealth=poolHealth, nicGroup=nicGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, volumeModifyCompleted=volumeModifyCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceDescription=haResourceDescription, poolOwnerController=poolOwnerController, shareDataSizeLow=shareDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeLow=shareReservedSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetEntry=iscsiTargetEntry, currentNotificationGroup=currentNotificationGroup, upgradeStarted=upgradeStarted, poolUsedSizeHigh=poolUsedSizeHigh, projectEntry=projectEntry, cifsTotalWriteIops=cifsTotalWriteIops, projectDeletionFailed=projectDeletionFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, lunFreeSizeLow=lunFreeSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, shareReservedSizeHigh=shareReservedSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTotalWriteMbps=fcTotalWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTotalReadIops=fcTotalReadIops, volumeQuotaFinished=volumeQuotaFinished, pools=pools, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcAvgReadLatency=fcAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, adServerTimeDrift=adServerTimeDrift, poolSizeHigh=poolSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareIndex=shareIndex, netbiosSocketFailure=netbiosSocketFailure, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, ipmiFan=ipmiFan, iscsiTargetGroup=iscsiTargetGroup, iscsiInitiators=iscsiInitiators, cacheTotalWriteMbps=cacheTotalWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectFreeSizeLow=projectFreeSizeLow, projectDataSizeHigh=projectDataSizeHigh, poolCreated=poolCreated, smisServiceStartFailed=smisServiceStartFailed, replicationStarted=replicationStarted, nvdimmFailSoftError=nvdimmFailSoftError, lunEntry=lunEntry, haResourceActiveNode=haResourceActiveNode, shareDeletionFailed=shareDeletionFailed, poolIndex=poolIndex, iscsiWriteIops=iscsiWriteIops, diskSequentialIOCount=diskSequentialIOCount, cacheTotalReadIops=cacheTotalReadIops, ipmiThreshold=ipmiThreshold, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, properties=properties, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolExpanded=poolExpanded, replicationAbandoned=replicationAbandoned, ipmiCurrent=ipmiCurrent, shareTable=shareTable, networkInterfaceDown=networkInterfaceDown, nfsTotalReadIops=nfsTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, diskGoneOffline=diskGoneOffline, lunPoolName=lunPoolName, aclMigrationCompleted=aclMigrationCompleted, snmpServiceStartFailed=snmpServiceStartFailed, haControllerA_IPAddr=haControllerA_IPAddr, iscsiAvgReadLatency=iscsiAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolUsedSizeLow=poolUsedSizeLow, shareCompressionEnabled=shareCompressionEnabled, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, cpuInterrupts=cpuInterrupts, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, deleteFolderFailed=deleteFolderFailed, fcTargetReadLatency=fcTargetReadLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haControllerA_Name=haControllerA_Name, nicReceiveMbps=nicReceiveMbps, poolAvgWriteLatency=poolAvgWriteLatency, haControllerB_IPAddr=haControllerB_IPAddr, shareDeleted=shareDeleted, poolExported=poolExported, haControllerB_Name=haControllerB_Name, smbSocketFailure=smbSocketFailure, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, basicCompliance=basicCompliance, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargets=fcTargets, diskTable=diskTable, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diagnosticDataUploaded=diagnosticDataUploaded, unknownSensorEvent=unknownSensorEvent, poolProjectCount=poolProjectCount, notificationSeverity=notificationSeverity, diskTotalWriteMbps=diskTotalWriteMbps, diskEntry=diskEntry, iscsiTargetIndex=iscsiTargetIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskSlowIo=diskSlowIo, diskSizeLow=diskSizeLow, poolMetaReadLatency=poolMetaReadLatency, spareDiskReplaced=spareDiskReplaced, projectIndex=projectIndex, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetsTable=iscsiTargetsTable, cacheTotalWriteIops=cacheTotalWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, lunReservedSizeLow=lunReservedSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, shareDedupEnabled=shareDedupEnabled, lunName=lunName, diskCount=diskCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectPoolName=projectPoolName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectSnapshotSizeLow=projectSnapshotSizeLow, PYSNMP_MODULE_ID=tegile, diskDataWriteIops=diskDataWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, targetGroupMemberRemoved=targetGroupMemberRemoved, diskError=diskError, tegileCompliances=tegileCompliances, nicEntry=nicEntry, testNotification=testNotification, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiMemory=ipmiMemory, cifsAvgReadLatency=cifsAvgReadLatency, diskType=diskType, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, controllerUp=controllerUp, lunWriteLatency=lunWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalWriteIops=poolTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetWriteLatency=fcTargetWriteLatency, shareQuotaLow=shareQuotaLow, aclMigrationStarted=aclMigrationStarted, ntpServerTimeDrift=ntpServerTimeDrift, tegileConformance=tegileConformance, iscsiTargetName=iscsiTargetName, cpuTotalUsage=cpuTotalUsage, shareNFSEnabled=shareNFSEnabled, snmpServiceStarted=snmpServiceStarted, projectDeleted=projectDeleted, poolMetaWriteIops=poolMetaWriteIops, poolDataWriteMbps=poolDataWriteMbps, lunProtocol=lunProtocol, iscsiTargetError=iscsiTargetError, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunWriteMbps=lunWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcPortOnline=fcPortOnline, diskState=diskState, diskSizeHigh=diskSizeHigh, poolDataReadLatency=poolDataReadLatency, globalStatistics=globalStatistics, nicTable=nicTable, lunTable=lunTable, snapshotCreationFailed=snapshotCreationFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, poolTotalReadIops=poolTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, fcInitiators=fcInitiators, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetWriteIops=iscsiTargetWriteIops, lunSizeHigh=lunSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, volumeDeleteFailed=volumeDeleteFailed, lunCompressedRatio=lunCompressedRatio, projectShares=projectShares, fcProperties=fcProperties, shareDataSizeHigh=shareDataSizeHigh, diskDataWriteMbps=diskDataWriteMbps, lunDataSizeLow=lunDataSizeLow, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetAuth=iscsiTargetAuth, shareProjectName=shareProjectName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkTotalTransmitMbps=networkTotalTransmitMbps, tegileGroups=tegileGroups, lunReservedSizeHigh=lunReservedSizeHigh, notificationTargetEntityName=notificationTargetEntityName, notifications=notifications, projectQuotaFinished=projectQuotaFinished, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationTime=notificationTime, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDeleted=poolDeleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, shareCIFSReadMbps=shareCIFSReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, poolTotalSaving=poolTotalSaving, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectDedupEnabled=projectDedupEnabled)
