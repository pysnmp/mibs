...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ModuleIdentity, Unsigned32, NotificationType, iso, enterprises, Gauge32, IpAddress, ObjectIdentity, MibIdentifier, Bits, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "enterprises", "Gauge32", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", cpuSystemCalls=cpuSystemCalls, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, currentObjectGroup=currentObjectGroup, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareCIFSReadMbps=shareCIFSReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetsTable=iscsiTargetsTable, diskIndex=diskIndex, volumeDeleteCompleted=volumeDeleteCompleted, projectDeleted=projectDeleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, diskGoneOffline=diskGoneOffline, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, snmpAgentVersion=snmpAgentVersion, snmpServiceStopped=snmpServiceStopped, nicIndex=nicIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, ipmiVoltage=ipmiVoltage, poolTotalReadMbps=poolTotalReadMbps, memoryFailure=memoryFailure, fcInitiatorIndex=fcInitiatorIndex, projectCompressionEnabled=projectCompressionEnabled, poolProjects=poolProjects, iscsiInitiatorIndex=iscsiInitiatorIndex, ntpServerTimeDrift=ntpServerTimeDrift, fcPortOnline=fcPortOnline, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorGroup=fcInitiatorGroup, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolReadCacheReadLatency=poolReadCacheReadLatency, fcInitiatorName=fcInitiatorName, targetGroupMemberAdded=targetGroupMemberAdded, replicationAborted=replicationAborted, unknownSensorEvent=unknownSensorEvent, shareCIFSWriteIops=shareCIFSWriteIops, lunInitiatorGroup=lunInitiatorGroup, poolSizeHigh=poolSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, lunGUID=lunGUID, poolUsedSizeHigh=poolUsedSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, smbSocketFailure=smbSocketFailure, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, userLoginFailed=userLoginFailed, cifsTotalReadIops=cifsTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetWriteMbps=fcTargetWriteMbps, haResourceName=haResourceName, diskAvgWriteLatency=diskAvgWriteLatency, lunCompressionEnabled=lunCompressionEnabled, diskEntry=diskEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, deleteFolderCompleted=deleteFolderCompleted, iscsiTargetAuth=iscsiTargetAuth, lunCompressedRatio=lunCompressedRatio, projectModified=projectModified, networkIpmpGroupUp=networkIpmpGroupUp, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolAvgReadLatency=poolAvgReadLatency, nicGroup=nicGroup, poolCount=poolCount, haControllerB_Uptime=haControllerB_Uptime, diskPoolName=diskPoolName, controllerTimeDrift=controllerTimeDrift, maintenanceModeEnabled=maintenanceModeEnabled, nicTable=nicTable, smisServiceStarted=smisServiceStarted, shareProjectName=shareProjectName, notificationTargetEntityName=notificationTargetEntityName, diskTotalReadIops=diskTotalReadIops, shareEntry=shareEntry, shareNFSReadLatency=shareNFSReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, cpuTotalUsage=cpuTotalUsage, poolExpanded=poolExpanded, lunProtocol=lunProtocol, cacheTotalReadMbps=cacheTotalReadMbps, diskIsOnline=diskIsOnline, fcTargetsTable=fcTargetsTable, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeModifyCompleted=volumeModifyCompleted, fcTotalReadIops=fcTotalReadIops, fcTargetReadIops=fcTargetReadIops, poolReadCacheReadIops=poolReadCacheReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectIndex=projectIndex, tegileConformance=tegileConformance, nfsTotalReadIops=nfsTotalReadIops, fcAvgWriteLatency=fcAvgWriteLatency, diskDataReadIops=diskDataReadIops, nfsTotalReadMbps=nfsTotalReadMbps, shareIndex=shareIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetEntry=iscsiTargetEntry, cifsTotalWriteIops=cifsTotalWriteIops, fcProperties=fcProperties, lunReservedSizeLow=lunReservedSizeLow, diskTable=diskTable, poolMetaReadIops=poolMetaReadIops, poolDataWriteIops=poolDataWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationStarted=replicationStarted, lunProjectName=lunProjectName, fcTotalReadMbps=fcTotalReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationSensorAction=notificationSensorAction, diskSizeLow=diskSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargets=fcTargets, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerA_Uptime=haControllerA_Uptime, cacheRAMReads=cacheRAMReads, pools=pools, iscsiWriteIops=iscsiWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, upgradeFailed=upgradeFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolCreated=poolCreated, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, adServerTimeDrift=adServerTimeDrift, projectName=projectName, shareCIFSWriteMbps=shareCIFSWriteMbps, projectShares=projectShares, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, volumeDeleteFailed=volumeDeleteFailed, disks=disks, upgradeTimeout=upgradeTimeout, shareNFSEnabled=shareNFSEnabled, snmpServiceStarted=snmpServiceStarted, upgradeCompleted=upgradeCompleted, fcTargetName=fcTargetName, diskTotalWriteIops=diskTotalWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskCount=diskCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationFailed=replicationFailed, vmwareNFSDatastores=vmwareNFSDatastores, notificationReadingUnit=notificationReadingUnit, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolDeletionFailed=poolDeletionFailed, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAbandoned=replicationAbandoned, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nicState=nicState, shareNFSWriteLatency=shareNFSWriteLatency, ipmiCurrent=ipmiCurrent, cacheTotalWriteIops=cacheTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolHealth=poolHealth, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, properties=properties, shareDeleted=shareDeleted, aclMigrationStarted=aclMigrationStarted, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiProperties=iscsiProperties, shareReservedSizeHigh=shareReservedSizeHigh, lunReadIops=lunReadIops, sharePoolName=sharePoolName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationSensorSuspect=notificationSensorSuspect, globalStatistics=globalStatistics, poolDataReadLatency=poolDataReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, haResources=haResources, poolDataReadIops=poolDataReadIops, poolTotalWriteMbps=poolTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, alertsCleanupCompleted=alertsCleanupCompleted, deleteFolderFailed=deleteFolderFailed, poolSizeLow=poolSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunFreeSizeLow=lunFreeSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolDataReadMbps=poolDataReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunDataSizeHigh=lunDataSizeHigh, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorName=iscsiInitiatorName, lunWriteMbps=lunWriteMbps, iscsiTargetError=iscsiTargetError, iscsiInitiatorGroup=iscsiInitiatorGroup, projectQuotaSizeLow=projectQuotaSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationSourceRegistered=replicationSourceRegistered, diskState=diskState, tdpsUpgradeFailed=tdpsUpgradeFailed, poolAvgWriteLatency=poolAvgWriteLatency, diskTotalReadMbps=diskTotalReadMbps, lunReadMbps=lunReadMbps, haResourceStatus=haResourceStatus, poolName=poolName, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectTotalSaving=projectTotalSaving, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, notificationTime=notificationTime, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetIndex=fcTargetIndex, fcTargetReadLatency=fcTargetReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, replicationResumed=replicationResumed, targetGroupMemberRemoved=targetGroupMemberRemoved, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerB_Name=haControllerB_Name, projectQuotaFinished=projectQuotaFinished, shareCIFSEnabled=shareCIFSEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectTable=projectTable, haControllerA_Name=haControllerA_Name, diskIOCount=diskIOCount, diskAvgReadLatency=diskAvgReadLatency, notificationSeverity=notificationSeverity, snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry)
mibBuilder.exportSymbols("TEGILE-MIB", lunSizeHigh=lunSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetGroup=fcTargetGroup, projectEntry=projectEntry, poolUpgraded=poolUpgraded, diagnosticDataUploaded=diagnosticDataUploaded, nfsTotalWriteMbps=nfsTotalWriteMbps, networkInterfaceUp=networkInterfaceUp, diskError=diskError, lunBlockSize=lunBlockSize, replicationComplete=replicationComplete, ipmiOther=ipmiOther, projectPoolName=projectPoolName, iscsiTargetIndex=iscsiTargetIndex, poolQuotaFinished=poolQuotaFinished, nicName=nicName, lunWriteIops=lunWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, haControllerB_IPAddr=haControllerB_IPAddr, tegileArray=tegileArray, diskRandomIOCount=diskRandomIOCount, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCompressedRatio=shareCompressedRatio, lunTargetGroup=lunTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDedupEnabled=projectDedupEnabled, projectShareCount=projectShareCount, upgradeStarted=upgradeStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, shareCompressionEnabled=shareCompressionEnabled, nicEntry=nicEntry, smisServiceStartFailed=smisServiceStartFailed, fcTotalWriteIops=fcTotalWriteIops, snapshotCreationFailed=snapshotCreationFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, diskAlias=diskAlias, haResourceIndex=haResourceIndex, shareQuotaHigh=shareQuotaHigh, snapshotRollbackFailed=snapshotRollbackFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, tegileGroups=tegileGroups, shareDeletionFailed=shareDeletionFailed, shareDataSizeLow=shareDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, controllerHardwareModel=controllerHardwareModel, sanProperties=sanProperties, haResourceGroup=haResourceGroup, fcTargetStatus=fcTargetStatus, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolState=poolState, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectLUNs=projectLUNs, fcTargetReadMbps=fcTargetReadMbps, cacheTotalReadIops=cacheTotalReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, ipmiMemory=ipmiMemory, shareDedupEnabled=shareDedupEnabled, shareQuotaFinished=shareQuotaFinished, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTotalReadIops=iscsiTotalReadIops, projectDataSizeLow=projectDataSizeLow, poolExported=poolExported, iscsiTargetReadIops=iscsiTargetReadIops, diskSlowIo=diskSlowIo, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, replicationTargetDeleted=replicationTargetDeleted, cacheSSDReads=cacheSSDReads, lunTable=lunTable, controllerUp=controllerUp, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareTable=shareTable, cifsTotalReadMbps=cifsTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiThreshold=ipmiThreshold, ipmiFan=ipmiFan, haResourceDescription=haResourceDescription, testNotification=testNotification, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicMTU=nicMTU, lunSizeLow=lunSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, aclMigrationCompleted=aclMigrationCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, sensorFailureEvent=sensorFailureEvent, poolOwnerController=poolOwnerController, replicationPaused=replicationPaused, cifsAvgReadLatency=cifsAvgReadLatency, volumeQuotaFinished=volumeQuotaFinished, shareMountPoint=shareMountPoint, notifications=notifications, lunReadLatency=lunReadLatency, poolMetaReadLatency=poolMetaReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, PYSNMP_MODULE_ID=tegile, notificationComponentName=notificationComponentName, notificationProps=notificationProps, projectFreeSizeLow=projectFreeSizeLow, haResourceEntry=haResourceEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolDeleted=poolDeleted, tegileArray_notifications=tegileArray_notifications, snapshotCloningFailed=snapshotCloningFailed, lunDedupEnabled=lunDedupEnabled, lunIndex=lunIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpServiceStopFailed=snmpServiceStopFailed, fcInitiatorEntry=fcInitiatorEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolUsedSizeLow=poolUsedSizeLow, shareQuotaLow=shareQuotaLow, poolProjectCount=poolProjectCount, poolDataSizeHigh=poolDataSizeHigh, diskDataReadMbps=diskDataReadMbps, poolEntry=poolEntry, shareName=shareName, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunPoolName=lunPoolName, haResourcesTable=haResourcesTable, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetAlias=iscsiTargetAlias, snmpServiceStartFailed=snmpServiceStartFailed, poolDataSizeLow=poolDataSizeLow, tegile=tegile, diskChassisIdx=diskChassisIdx, ipmiTemperature=ipmiTemperature, lunFreeSizeHigh=lunFreeSizeHigh, netbiosSocketFailure=netbiosSocketFailure, controllerDown=controllerDown, poolIndex=poolIndex, fcInitiatorsTable=fcInitiatorsTable, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargets=iscsiTargets, poolTotalWriteIops=poolTotalWriteIops, fcAvgReadLatency=fcAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiators=iscsiInitiators, fcTargetWriteIops=fcTargetWriteIops, shareDataSizeHigh=shareDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, diskDataWriteMbps=diskDataWriteMbps, haResourceActiveNode=haResourceActiveNode, poolTable=poolTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationEventCode=notificationEventCode, lunDataSizeLow=lunDataSizeLow, diskSizeHigh=diskSizeHigh, network=network, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileCompliances=tegileCompliances, networkInterfaceDown=networkInterfaceDown, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolDegraded=poolDegraded, fcInitiators=fcInitiators, projectDeletionFailed=projectDeletionFailed, ipmiPowerSupply=ipmiPowerSupply, diskType=diskType, projectQuotaSizeHigh=projectQuotaSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, lunEntry=lunEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicReceiveMbps=nicReceiveMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkIpmpGroupDown=networkIpmpGroupDown, poolDataWriteLatency=poolDataWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, nicTransmitMbps=nicTransmitMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, spareDiskReplaced=spareDiskReplaced, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTotalSaving=poolTotalSaving, poolImported=poolImported, fcTargetEntry=fcTargetEntry, notificationObjects=notificationObjects, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectLunCount=projectLunCount, fcPortOffline=fcPortOffline, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, notificationDescription=notificationDescription, iscsiTargetName=iscsiTargetName, currentNotificationGroup=currentNotificationGroup, projectDataSizeHigh=projectDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, basicCompliance=basicCompliance, smisServiceStopped=smisServiceStopped, shareReservedSizeLow=shareReservedSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunName=lunName, notificationSensorNumber=notificationSensorNumber, poolFreeSizeLow=poolFreeSizeLow)
