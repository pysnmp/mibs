...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:17:35 2024
...
enterprises, NotificationType, ModuleIdentity, Integer32, Unsigned32, IpAddress, iso, TimeTicks, ObjectIdentity, MibIdentifier, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "iso", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunFreeSizeLow=lunFreeSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, properties=properties, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerB_Uptime=haControllerB_Uptime, lunWriteLatency=lunWriteLatency, tegileArray=tegileArray, shareNFSReadLatency=shareNFSReadLatency, upgradeTimeout=upgradeTimeout, cacheTotalWriteMbps=cacheTotalWriteMbps, poolEntry=poolEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSWriteIops=shareCIFSWriteIops, upgradeFailed=upgradeFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, testNotification=testNotification, pools=pools, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolReadCacheReadLatency=poolReadCacheReadLatency, haControllerA_Name=haControllerA_Name, shareDataSizeLow=shareDataSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetGroupError=iscsiTargetGroupError, currentNotificationGroup=currentNotificationGroup, poolTotalWriteMbps=poolTotalWriteMbps, haResourceGroup=haResourceGroup, ipmiOther=ipmiOther, shareCIFSReadLatency=shareCIFSReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, diskIsOnline=diskIsOnline, poolSizeHigh=poolSizeHigh, iscsiProperties=iscsiProperties, lunReadIops=lunReadIops, shareNFSReadMbps=shareNFSReadMbps, shareTable=shareTable, projectShares=projectShares, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareCompressedRatio=shareCompressedRatio, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolMetaReadLatency=poolMetaReadLatency, lunReadMbps=lunReadMbps, nicName=nicName, nicTable=nicTable, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunName=lunName, shareQuotaLow=shareQuotaLow, ipmiPowerSupply=ipmiPowerSupply, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotCreationFailed=snapshotCreationFailed, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetStatus=fcTargetStatus, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCompressionEnabled=shareCompressionEnabled, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, diskSizeLow=diskSizeLow, lunTable=lunTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerA_Uptime=haControllerA_Uptime, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeDeleteFailed=volumeDeleteFailed, diskTable=diskTable, nvdimmFailUnknownError=nvdimmFailUnknownError, poolName=poolName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolDataWriteIops=poolDataWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, sharePoolName=sharePoolName, poolDeletionFailed=poolDeletionFailed, projectQuotaSizeLow=projectQuotaSizeLow, lunCompressionEnabled=lunCompressionEnabled, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastores=vmwareNFSDatastores, upgradeStarted=upgradeStarted, targetGroupCreateCompleted=targetGroupCreateCompleted, haResourceEntry=haResourceEntry, network=network, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, ipmiFan=ipmiFan, poolFreeSizeHigh=poolFreeSizeHigh, shareEntry=shareEntry, projectLUNs=projectLUNs, fcTargetWriteIops=fcTargetWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, haResources=haResources, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareNFSWriteIops=shareNFSWriteIops, diskTotalWriteIops=diskTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareName=shareName, poolState=poolState, ipmiMemory=ipmiMemory, aclMigrationCompleted=aclMigrationCompleted, lunTargetGroup=lunTargetGroup, networkIpmpGroupDown=networkIpmpGroupDown, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunProtocol=lunProtocol, controllerTimeDrift=controllerTimeDrift, nfsTotalWriteIops=nfsTotalWriteIops, shareMountPoint=shareMountPoint, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunDedupEnabled=lunDedupEnabled, poolUsedSizeHigh=poolUsedSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, projectEntry=projectEntry, poolTotalWriteIops=poolTotalWriteIops, poolOwnerController=poolOwnerController, fcPortOnline=fcPortOnline, iscsiTargetName=iscsiTargetName, poolFreeSizeLow=poolFreeSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, lunReadLatency=lunReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nicEntry=nicEntry, projectIndex=projectIndex, ipmiVoltage=ipmiVoltage, notificationTime=notificationTime, poolAvgReadLatency=poolAvgReadLatency, memoryFailure=memoryFailure, projectSnapshotSizeHigh=projectSnapshotSizeHigh, smisServiceStopFailed=smisServiceStopFailed, projectQuotaFinished=projectQuotaFinished, lunBlockSize=lunBlockSize, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolUsedSizeLow=poolUsedSizeLow, lunWriteIops=lunWriteIops, projectModified=projectModified, notificationDescription=notificationDescription, controllerHardwareModel=controllerHardwareModel, projectFreeSizeHigh=projectFreeSizeHigh, lunCompressedRatio=lunCompressedRatio, nicGroup=nicGroup, diskDataReadMbps=diskDataReadMbps, diskSequentialIOCount=diskSequentialIOCount, tdpsUpgradeTimeout=tdpsUpgradeTimeout, currentObjectGroup=currentObjectGroup, shareProjectName=shareProjectName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, controllerDown=controllerDown, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskIndex=diskIndex, fcTargetName=fcTargetName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, notificationSensorSuspect=notificationSensorSuspect, poolDataWriteLatency=poolDataWriteLatency, haResourcesTable=haResourcesTable, haResourceDescription=haResourceDescription, diskCount=diskCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareReservedSizeHigh=shareReservedSizeHigh, networkInterfaceUp=networkInterfaceUp, replicationFailed=replicationFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, replicationComplete=replicationComplete, fcTargetIndex=fcTargetIndex, fcPortOffline=fcPortOffline, fcTargetGroup=fcTargetGroup, lunProjectName=lunProjectName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetReadMbps=iscsiTargetReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTotalReadMbps=iscsiTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcInitiatorEntry=fcInitiatorEntry, poolCreated=poolCreated, iscsiWriteIops=iscsiWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, shareDataSizeHigh=shareDataSizeHigh, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetAlias=iscsiTargetAlias, haResourceIndex=haResourceIndex, iscsiTargetAuth=iscsiTargetAuth, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetError=iscsiTargetError, poolMetaWriteIops=poolMetaWriteIops, diskRandomIOCount=diskRandomIOCount, diskEntry=diskEntry, diskDataWriteMbps=diskDataWriteMbps, fcTargetEntry=fcTargetEntry, fcTargetWriteMbps=fcTargetWriteMbps, replicationStarted=replicationStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, ipmiTemperature=ipmiTemperature, shareQuotaFinished=shareQuotaFinished, lunInitiatorGroup=lunInitiatorGroup, diskError=diskError, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, poolExported=poolExported, smbSocketFailure=smbSocketFailure, PYSNMP_MODULE_ID=tegile, sanProperties=sanProperties, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nfsTotalReadIops=nfsTotalReadIops, diskSizeHigh=diskSizeHigh, deleteFolderFailed=deleteFolderFailed, iscsiTargetEntry=iscsiTargetEntry, cpuInterrupts=cpuInterrupts, ipmiThreshold=ipmiThreshold, diskTotalReadMbps=diskTotalReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsTotalReadMbps=nfsTotalReadMbps, nicTransmitMbps=nicTransmitMbps, fcInitiators=fcInitiators, shareReservedSizeLow=shareReservedSizeLow, projectDataSizeLow=projectDataSizeLow, lunDataSizeHigh=lunDataSizeHigh, poolImported=poolImported, poolDeleted=poolDeleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetIndex=iscsiTargetIndex, replicationSourceRegistered=replicationSourceRegistered, cifsAvgWriteLatency=cifsAvgWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, shareQuotaHigh=shareQuotaHigh, iscsiTargetsTable=iscsiTargetsTable, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolTable=poolTable, cacheTotalReadIops=cacheTotalReadIops, poolCount=poolCount, poolDataReadIops=poolDataReadIops, shareDedupEnabled=shareDedupEnabled, replicationAbandoned=replicationAbandoned, poolTotalSaving=poolTotalSaving)
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteIops=poolWriteCacheWriteIops, tegileCompliances=tegileCompliances, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, upgradeDownloadStarted=upgradeDownloadStarted, iscsiInitiatorsTable=iscsiInitiatorsTable, poolReadCacheReadIops=poolReadCacheReadIops, diskIOCount=diskIOCount, notificationSensorAction=notificationSensorAction, poolQuotaFinished=poolQuotaFinished, fcInitiatorsTable=fcInitiatorsTable, snmpServiceStarted=snmpServiceStarted, diskTotalReadIops=diskTotalReadIops, iscsiTargets=iscsiTargets, cifsTotalWriteMbps=cifsTotalWriteMbps, projectTable=projectTable, projectFreeSizeLow=projectFreeSizeLow, fcAvgReadLatency=fcAvgReadLatency, basicCompliance=basicCompliance, notifications=notifications, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSReadIops=shareNFSReadIops, networkInterfaceDown=networkInterfaceDown, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cpuSystemCalls=cpuSystemCalls, alertsCleanupCompleted=alertsCleanupCompleted, notificationEventCode=notificationEventCode, ipmiCurrent=ipmiCurrent, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationReadingUnit=notificationReadingUnit, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetsTable=fcTargetsTable, projectTotalSaving=projectTotalSaving, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, snapshotRollbackFailed=snapshotRollbackFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, snmpServiceStartFailed=snmpServiceStartFailed, snmpAgentVersion=snmpAgentVersion, snmpServiceStopped=snmpServiceStopped, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunEntry=lunEntry, fcTotalReadIops=fcTotalReadIops, snapshotCloneCompleted=snapshotCloneCompleted, diagnosticDataUploaded=diagnosticDataUploaded, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetReadIops=fcTargetReadIops, notificationSeverity=notificationSeverity, projectThresholdExceedWarning=projectThresholdExceedWarning, networkTotalTransmitMbps=networkTotalTransmitMbps, smisServiceStopped=smisServiceStopped, tegileArray_notifications=tegileArray_notifications, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationSensorNumber=notificationSensorNumber, targetGroupMemberRemoved=targetGroupMemberRemoved, unknownSensorEvent=unknownSensorEvent, tegile=tegile, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcAvgWriteLatency=fcAvgWriteLatency, diskChassisIdx=diskChassisIdx, fcTotalReadMbps=fcTotalReadMbps, shareDeleted=shareDeleted, replicationAborted=replicationAborted, iscsiTargetWriteIops=iscsiTargetWriteIops, poolIndex=poolIndex, poolProjectCount=poolProjectCount, poolMetaReadMbps=poolMetaReadMbps, poolDataSizeHigh=poolDataSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, haControllerB_Name=haControllerB_Name, volumeCreatedSuccessfully=volumeCreatedSuccessfully, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTotalReadIops=iscsiTotalReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, nicReceiveMbps=nicReceiveMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, smisServiceStartFailed=smisServiceStartFailed, lunPoolName=lunPoolName, tegileGroups=tegileGroups, nvdimmFailSoftError=nvdimmFailSoftError, fcTargets=fcTargets, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haResourceStatus=haResourceStatus, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolHealth=poolHealth, cacheRAMReads=cacheRAMReads, diskSlowIo=diskSlowIo, controllerUp=controllerUp, shareCIFSReadIops=shareCIFSReadIops, nicIndex=nicIndex, diskPoolName=diskPoolName, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorGroup=fcInitiatorGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunSizeHigh=lunSizeHigh, projectShareCount=projectShareCount, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectCompressionEnabled=projectCompressionEnabled, volumeQuotaFinished=volumeQuotaFinished, cpuTotalUsage=cpuTotalUsage, notificationComponentName=notificationComponentName, diskState=diskState, iscsiInitiatorEntry=iscsiInitiatorEntry, diskDataWriteIops=diskDataWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, diskDataReadIops=diskDataReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, userLoginFailed=userLoginFailed, diskTotalWriteMbps=diskTotalWriteMbps, poolDataReadMbps=poolDataReadMbps, diskType=diskType, fcTargetReadLatency=fcTargetReadLatency, lunWriteMbps=lunWriteMbps, replicationPaused=replicationPaused, snmpServiceStopFailed=snmpServiceStopFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, cacheTotalReadMbps=cacheTotalReadMbps, lunGUID=lunGUID, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareIndex=shareIndex, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationProps=notificationProps, projectName=projectName, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataWriteMbps=poolDataWriteMbps, netbiosSocketFailure=netbiosSocketFailure, poolMetaWriteLatency=poolMetaWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolSizeLow=poolSizeLow, shareNFSEnabled=shareNFSEnabled, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, globalStatistics=globalStatistics, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, smisServiceStarted=smisServiceStarted, notificationTargetEntityName=notificationTargetEntityName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicState=nicState, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectPoolName=projectPoolName, disks=disks, deleteFolderCompleted=deleteFolderCompleted, shareCIFSReadMbps=shareCIFSReadMbps, volumeModifyCompleted=volumeModifyCompleted, poolDegraded=poolDegraded, tegileConformance=tegileConformance, ntpServerTimeDrift=ntpServerTimeDrift, diskGoneOffline=diskGoneOffline, cacheSSDReads=cacheSSDReads, aclMigrationStarted=aclMigrationStarted, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationResumed=replicationResumed, projectDeletionFailed=projectDeletionFailed, iscsiTargetGroup=iscsiTargetGroup, poolProjects=poolProjects, iscsiInitiators=iscsiInitiators, cifsTotalReadIops=cifsTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, fcProperties=fcProperties, sensorFailureEvent=sensorFailureEvent, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicMTU=nicMTU, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, diskAlias=diskAlias, poolExpanded=poolExpanded, projectDataSizeHigh=projectDataSizeHigh, diskAvgReadLatency=diskAvgReadLatency, projectDeleted=projectDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTotalWriteMbps=fcTotalWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, poolTotalReadMbps=poolTotalReadMbps, lunIndex=lunIndex, poolDataSizeLow=poolDataSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, spareDiskReplaced=spareDiskReplaced, poolMetaReadIops=poolMetaReadIops, notificationObjects=notificationObjects, poolUpgraded=poolUpgraded, projectDedupEnabled=projectDedupEnabled, poolDataReadLatency=poolDataReadLatency, lunSizeLow=lunSizeLow, upgradeCompleted=upgradeCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeDeleteCompleted=volumeDeleteCompleted, shareDeletionFailed=shareDeletionFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorName=fcInitiatorName, nvdimmFailInitializationError=nvdimmFailInitializationError, adServerTimeDrift=adServerTimeDrift, haResourceName=haResourceName, projectLunCount=projectLunCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated)
