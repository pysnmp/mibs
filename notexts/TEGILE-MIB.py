...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:10:56 2023
...
Bits, MibIdentifier, NotificationType, Integer32, enterprises, ModuleIdentity, iso, IpAddress, TimeTicks, Unsigned32, Counter64, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "Integer32", "enterprises", "ModuleIdentity", "iso", "IpAddress", "TimeTicks", "Unsigned32", "Counter64", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorCreateFailed=fcInitiatorCreateFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, controllerHardwareModel=controllerHardwareModel, haResourceDescription=haResourceDescription, projectModified=projectModified, projectTotalSaving=projectTotalSaving, poolExpanded=poolExpanded, ipmiMemory=ipmiMemory, diskIndex=diskIndex, globalStatistics=globalStatistics, shareDedupEnabled=shareDedupEnabled, snmpServiceStarted=snmpServiceStarted, iscsiInitiatorIndex=iscsiInitiatorIndex, projectQuotaFinished=projectQuotaFinished, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectName=projectName, haResources=haResources, memoryFailure=memoryFailure, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetGroup=fcTargetGroup, poolTable=poolTable, notificationTime=notificationTime, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, nicEntry=nicEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareReservedSizeLow=shareReservedSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunTable=lunTable, networkTotalTransmitMbps=networkTotalTransmitMbps, controllerTimeDrift=controllerTimeDrift, snapshotRollbackCompleted=snapshotRollbackCompleted, diskDataReadIops=diskDataReadIops, poolDataWriteLatency=poolDataWriteLatency, fcProperties=fcProperties, shareName=shareName, upgradeDownloadFailed=upgradeDownloadFailed, projectLUNs=projectLUNs, poolDataReadIops=poolDataReadIops, poolUsedSizeLow=poolUsedSizeLow, shareQuotaHigh=shareQuotaHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, cpuInterrupts=cpuInterrupts, poolUsedSizeHigh=poolUsedSizeHigh, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, notificationComponentName=notificationComponentName, networkTotalReceiveMbps=networkTotalReceiveMbps, unknownSensorEvent=unknownSensorEvent, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, nicState=nicState, iscsiInitiators=iscsiInitiators, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetAuth=iscsiTargetAuth, poolDeletionFailed=poolDeletionFailed, ipmiCurrent=ipmiCurrent, deleteFolderFailed=deleteFolderFailed, haResourceGroup=haResourceGroup, fcTargetReadIops=fcTargetReadIops, iscsiTargetEntry=iscsiTargetEntry, poolReadCacheReadIops=poolReadCacheReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskSizeLow=diskSizeLow, iscsiProperties=iscsiProperties, lunWriteIops=lunWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunBlockSize=lunBlockSize, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetName=fcTargetName, properties=properties, fcTotalWriteMbps=fcTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareMountPoint=shareMountPoint, lunDataSizeHigh=lunDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, networkInterfaceDown=networkInterfaceDown, poolIndex=poolIndex, volumeDeleteFailed=volumeDeleteFailed, controllerDown=controllerDown, shareDeletionFailed=shareDeletionFailed, ipmiFan=ipmiFan, poolTotalReadMbps=poolTotalReadMbps, haResourceEntry=haResourceEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorName=fcInitiatorName, diskAvgReadLatency=diskAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorIndex=fcInitiatorIndex, poolDeleted=poolDeleted, replicationFailed=replicationFailed, shareNFSEnabled=shareNFSEnabled, userLoginFailed=userLoginFailed, cifsTotalReadIops=cifsTotalReadIops, poolSizeHigh=poolSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetIndex=iscsiTargetIndex, replicationSourceRegistered=replicationSourceRegistered, iscsiTotalReadIops=iscsiTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargets=iscsiTargets, shareDeleted=shareDeleted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetError=iscsiTargetError, upgradeTimeout=upgradeTimeout, iscsiTargetName=iscsiTargetName, projectDedupEnabled=projectDedupEnabled, projectShares=projectShares, snmpServiceStopFailed=snmpServiceStopFailed, replicationPaused=replicationPaused, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataWriteMbps=poolDataWriteMbps, tegile=tegile, fcTotalWriteIops=fcTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolDegraded=poolDegraded, haResourceName=haResourceName, upgradeCompleted=upgradeCompleted, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskSlowIo=diskSlowIo, fcTargetWriteIops=fcTargetWriteIops, replicationStarted=replicationStarted, networkIpmpGroupUp=networkIpmpGroupUp, shareDataSizeLow=shareDataSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerB_IPAddr=haControllerB_IPAddr, cifsTotalReadMbps=cifsTotalReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalWriteIops=poolTotalWriteIops, notificationEventCode=notificationEventCode, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunCompressedRatio=lunCompressedRatio, network=network, diskCount=diskCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haControllerB_Name=haControllerB_Name, cacheTotalWriteIops=cacheTotalWriteIops, poolTotalReadIops=poolTotalReadIops, cifsTotalWriteIops=cifsTotalWriteIops, notificationProps=notificationProps, diskDataWriteMbps=diskDataWriteMbps, poolUpgraded=poolUpgraded, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, lunReadLatency=lunReadLatency, poolQuotaFinished=poolQuotaFinished, tegileCompliances=tegileCompliances, notifications=notifications, iscsiTargetReadLatency=iscsiTargetReadLatency, shareEntry=shareEntry, projectPoolName=projectPoolName, diskTotalReadIops=diskTotalReadIops, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationSensorNumber=notificationSensorNumber, diskTotalReadMbps=diskTotalReadMbps, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haControllerB_Uptime=haControllerB_Uptime, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cacheTotalWriteMbps=cacheTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nfsTotalReadMbps=nfsTotalReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, lunEntry=lunEntry, nicGroup=nicGroup, shareProjectName=shareProjectName, projectEntry=projectEntry, notificationObjects=notificationObjects, ipmiTemperature=ipmiTemperature, shareTable=shareTable, poolAvgWriteLatency=poolAvgWriteLatency, diskChassisIdx=diskChassisIdx, notificationReadingTriggerValue=notificationReadingTriggerValue, controllerUp=controllerUp, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, cacheRAMReads=cacheRAMReads, cacheTotalReadMbps=cacheTotalReadMbps, poolFreeSizeLow=poolFreeSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, poolMetaWriteMbps=poolMetaWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolProjects=poolProjects, shareNFSReadMbps=shareNFSReadMbps, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcPortOnline=fcPortOnline, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cpuTotalUsage=cpuTotalUsage, diskGoneOffline=diskGoneOffline, fcPortOffline=fcPortOffline, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nvdimmFailSoftError=nvdimmFailSoftError, notificationDescription=notificationDescription, lunName=lunName, fcTargetReadLatency=fcTargetReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetEntry=fcTargetEntry, iscsiTotalReadMbps=iscsiTotalReadMbps, ipmiOther=ipmiOther, nfsTotalWriteIops=nfsTotalWriteIops, smisServiceStopped=smisServiceStopped, iscsiTargetReadIops=iscsiTargetReadIops, smisServiceStartFailed=smisServiceStartFailed, snapshotRollbackFailed=snapshotRollbackFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationAbandoned=replicationAbandoned, notificationTargetEntityName=notificationTargetEntityName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, pools=pools, notificationSeverity=notificationSeverity, iscsiWriteIops=iscsiWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, spareDiskReplaced=spareDiskReplaced, projectDeleted=projectDeleted, shareSnapshotSizeLow=shareSnapshotSizeLow, poolHealth=poolHealth)
mibBuilder.exportSymbols("TEGILE-MIB", poolMetaReadIops=poolMetaReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, diskDataReadMbps=diskDataReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadLatency=shareNFSReadLatency, nicTable=nicTable, diskTable=diskTable, projectFreeSizeLow=projectFreeSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, replicationComplete=replicationComplete, cifsTotalWriteMbps=cifsTotalWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSReadMbps=shareCIFSReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, diskSizeHigh=diskSizeHigh, fcInitiatorsTable=fcInitiatorsTable, lunWriteLatency=lunWriteLatency, volumeModifyCompleted=volumeModifyCompleted, projectTable=projectTable, projectQuotaSizeLow=projectQuotaSizeLow, cacheSSDReads=cacheSSDReads, nfsTotalWriteMbps=nfsTotalWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, upgradeFailed=upgradeFailed, haResourceActiveNode=haResourceActiveNode, poolDataReadMbps=poolDataReadMbps, fcInitiators=fcInitiators, currentObjectGroup=currentObjectGroup, projectCompressionEnabled=projectCompressionEnabled, poolDataSizeHigh=poolDataSizeHigh, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunDedupEnabled=lunDedupEnabled, haControllerA_Name=haControllerA_Name, poolProjectCount=poolProjectCount, lunTargetGroup=lunTargetGroup, snmpServiceStopped=snmpServiceStopped, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTotalReadMbps=fcTotalReadMbps, poolMetaReadLatency=poolMetaReadLatency, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargetsTable=iscsiTargetsTable, volumeQuotaFinished=volumeQuotaFinished, poolName=poolName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, disks=disks, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, basicCompliance=basicCompliance, iscsiInitiatorEntry=iscsiInitiatorEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationTargetDeleted=replicationTargetDeleted, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotDeleteFailed=snapshotDeleteFailed, haResourcesTable=haResourcesTable, lunWriteMbps=lunWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, sharePoolName=sharePoolName, cacheTotalReadIops=cacheTotalReadIops, lunProjectName=lunProjectName, lunSizeHigh=lunSizeHigh, tegileConformance=tegileConformance, snmpServiceStartFailed=snmpServiceStartFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunProtocol=lunProtocol, iscsiTargetGroup=iscsiTargetGroup, shareQuotaLow=shareQuotaLow, fcTargets=fcTargets, fcTotalReadIops=fcTotalReadIops, lunReservedSizeLow=lunReservedSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, lunReadMbps=lunReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunInitiatorGroup=lunInitiatorGroup, shareIndex=shareIndex, diskState=diskState, notificationSensorSuspect=notificationSensorSuspect, diskIsOnline=diskIsOnline, replicationResumed=replicationResumed, nicReceiveMbps=nicReceiveMbps, diskPoolName=diskPoolName, nfsAvgReadLatency=nfsAvgReadLatency, replicationAborted=replicationAborted, fcInitiatorGroup=fcInitiatorGroup, shareCIFSReadIops=shareCIFSReadIops, nicName=nicName, deleteFolderCompleted=deleteFolderCompleted, ipmiThreshold=ipmiThreshold, tegileGroups=tegileGroups, maintenanceModeDisabled=maintenanceModeDisabled, lunGUID=lunGUID, diskError=diskError, diskIOCount=diskIOCount, tdpsUpgradeCompleted=tdpsUpgradeCompleted, currentNotificationGroup=currentNotificationGroup, poolCreated=poolCreated, nvdimmFailInitializationError=nvdimmFailInitializationError, diskEntry=diskEntry, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haControllerA_Uptime=haControllerA_Uptime, nicMTU=nicMTU, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicTransmitMbps=nicTransmitMbps, snapshotCreationFailed=snapshotCreationFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, smbSocketFailure=smbSocketFailure, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snmpAgentVersion=snmpAgentVersion, fcAvgReadLatency=fcAvgReadLatency, haResourceStatus=haResourceStatus, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolExported=poolExported, sensorFailureEvent=sensorFailureEvent, tegileArray=tegileArray, poolMetaWriteIops=poolMetaWriteIops, lunIndex=lunIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectIndex=projectIndex, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiatorName=iscsiInitiatorName, notificationReadingUnit=notificationReadingUnit, nvdimmFailDeviceError=nvdimmFailDeviceError, shareNFSReadIops=shareNFSReadIops, haResourceIndex=haResourceIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolImported=poolImported, poolState=poolState, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, upgradeStarted=upgradeStarted, networkIpmpGroupDown=networkIpmpGroupDown, snapshotCloneCompleted=snapshotCloneCompleted, projectDataSizeHigh=projectDataSizeHigh, diskType=diskType, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, smisServiceStarted=smisServiceStarted, poolDataWriteIops=poolDataWriteIops, testNotification=testNotification, poolEntry=poolEntry, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, lunDataSizeLow=lunDataSizeLow, diskAlias=diskAlias, shareCompressionEnabled=shareCompressionEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nfsTotalReadIops=nfsTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, poolDataSizeLow=poolDataSizeLow, poolTotalSaving=poolTotalSaving, snapshotCloningFailed=snapshotCloningFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastores=vmwareNFSDatastores, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, poolMetaReadMbps=poolMetaReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, ipmiPowerSupply=ipmiPowerSupply, poolOwnerController=poolOwnerController, lunSizeLow=lunSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, nicIndex=nicIndex, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskTotalWriteIops=diskTotalWriteIops, lunReadIops=lunReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolAvgReadLatency=poolAvgReadLatency, fcTargetIndex=fcTargetIndex, shareCompressedRatio=shareCompressedRatio, cpuSystemCalls=cpuSystemCalls, shareCIFSWriteIops=shareCIFSWriteIops, projectLunCount=projectLunCount, projectQuotaSizeHigh=projectQuotaSizeHigh, ipmiVoltage=ipmiVoltage, netbiosSocketFailure=netbiosSocketFailure, aclMigrationCompleted=aclMigrationCompleted, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolSizeLow=poolSizeLow, poolCount=poolCount, adServerTimeDrift=adServerTimeDrift, fcInitiatorEntry=fcInitiatorEntry, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, projectDataSizeLow=projectDataSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetStatus=fcTargetStatus, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskSequentialIOCount=diskSequentialIOCount, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargetsTable=fcTargetsTable, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, sanProperties=sanProperties, aclMigrationStarted=aclMigrationStarted, lunPoolName=lunPoolName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted)
