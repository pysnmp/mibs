...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, ObjectIdentity, enterprises, NotificationType, Gauge32, Counter64, Unsigned32, Integer32, Counter32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "ObjectIdentity", "enterprises", "NotificationType", "Gauge32", "Counter64", "Unsigned32", "Integer32", "Counter32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskEntry=diskEntry, diskCount=diskCount, poolMetaReadIops=poolMetaReadIops, poolReadCacheReadIops=poolReadCacheReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeTimeout=tdpsUpgradeTimeout, tdpsUpgradeFailed=tdpsUpgradeFailed, diskAvgReadLatency=diskAvgReadLatency, notificationTargetEntityName=notificationTargetEntityName, shareQuotaHigh=shareQuotaHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, ipmiCurrent=ipmiCurrent, shareCIFSWriteLatency=shareCIFSWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, poolCount=poolCount, cacheRAMReads=cacheRAMReads, diskChassisIdx=diskChassisIdx, lunReadIops=lunReadIops, lunWriteMbps=lunWriteMbps, smbSocketFailure=smbSocketFailure, snmpServiceStopped=snmpServiceStopped, fcInitiatorIndex=fcInitiatorIndex, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetName=iscsiTargetName, poolMetaReadMbps=poolMetaReadMbps, poolEntry=poolEntry, poolSizeHigh=poolSizeHigh, fcTotalReadMbps=fcTotalReadMbps, shareTable=shareTable, diskTable=diskTable, targetGroupCreateCompleted=targetGroupCreateCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetError=iscsiTargetError, fcTargetModifyCompleted=fcTargetModifyCompleted, aclMigrationCompleted=aclMigrationCompleted, poolUpgraded=poolUpgraded, poolTotalWriteMbps=poolTotalWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSizeLow=lunSizeLow, haResourceName=haResourceName, notificationObjects=notificationObjects, haResources=haResources, snmpServiceStarted=snmpServiceStarted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, replicationSourceRegistered=replicationSourceRegistered, ipmiVoltage=ipmiVoltage, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcProperties=fcProperties, shareName=shareName, pools=pools, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunGUID=lunGUID, notificationSensorAction=notificationSensorAction, cacheSSDReads=cacheSSDReads, diskRandomIOCount=diskRandomIOCount, notificationThresholdTriggerValue=notificationThresholdTriggerValue, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSEnabled=shareNFSEnabled, fcTargetReadLatency=fcTargetReadLatency, currentObjectGroup=currentObjectGroup, networkInterfaceUp=networkInterfaceUp, tegileCompliances=tegileCompliances, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, smisServiceStartFailed=smisServiceStartFailed, diskAvgWriteLatency=diskAvgWriteLatency, nicIndex=nicIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareNFSReadMbps=shareNFSReadMbps, basicCompliance=basicCompliance, haControllerB_IPAddr=haControllerB_IPAddr, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareCIFSWriteIops=shareCIFSWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunDataSizeHigh=lunDataSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCompressionEnabled=shareCompressionEnabled, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tegileGroups=tegileGroups, replicationComplete=replicationComplete, poolDataWriteMbps=poolDataWriteMbps, shareDataSizeHigh=shareDataSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nicState=nicState, ipmiTemperature=ipmiTemperature, lunDataSizeLow=lunDataSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourceDescription=haResourceDescription, volumeModifyCompleted=volumeModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolFreeSizeLow=poolFreeSizeLow, lunProjectName=lunProjectName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolTotalSaving=poolTotalSaving, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetEntry=iscsiTargetEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, nicMTU=nicMTU, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, ipmiFan=ipmiFan, upgradeDownloadFailed=upgradeDownloadFailed, notificationReadingUnit=notificationReadingUnit, tegileConformance=tegileConformance, diskType=diskType, projectDeletionFailed=projectDeletionFailed, snapshotRollbackFailed=snapshotRollbackFailed, fcTargets=fcTargets, poolDataReadIops=poolDataReadIops, haControllerA_Uptime=haControllerA_Uptime, shareProjectName=shareProjectName, projectDataSizeLow=projectDataSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolUsedSizeHigh=poolUsedSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, lunCompressedRatio=lunCompressedRatio, poolMetaWriteMbps=poolMetaWriteMbps, haResourceEntry=haResourceEntry, nicTable=nicTable, diskSlowIo=diskSlowIo, lunProtocol=lunProtocol, poolMetaReadLatency=poolMetaReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, controllerHardwareModel=controllerHardwareModel, iscsiTargetAuth=iscsiTargetAuth, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcAvgWriteLatency=fcAvgWriteLatency, projectEntry=projectEntry, diskGoneOffline=diskGoneOffline, poolProjectCount=poolProjectCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snapshotCloningFailed=snapshotCloningFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, poolQuotaFinished=poolQuotaFinished, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tegileArray=tegileArray, spareDiskReplaced=spareDiskReplaced, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, fcInitiatorGroup=fcInitiatorGroup, globalStatistics=globalStatistics, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetEntry=fcTargetEntry, projectDeleted=projectDeleted, lunReservedSizeLow=lunReservedSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetAlias=iscsiTargetAlias, poolAvgWriteLatency=poolAvgWriteLatency, shareQuotaFinished=shareQuotaFinished, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetWriteIops=iscsiTargetWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, poolState=poolState, replicationFailed=replicationFailed, poolDataReadMbps=poolDataReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, sharePoolName=sharePoolName, nfsTotalReadIops=nfsTotalReadIops, ntpServerTimeDrift=ntpServerTimeDrift, poolTable=poolTable, cacheTotalReadIops=cacheTotalReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationTime=notificationTime, poolExported=poolExported, haResourceGroup=haResourceGroup, snapshotDeleteFailed=snapshotDeleteFailed, poolHealth=poolHealth, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, disks=disks, lunFreeSizeLow=lunFreeSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDeletionFailed=poolDeletionFailed, cpuInterrupts=cpuInterrupts, iscsiTargetsTable=iscsiTargetsTable, shareCIFSReadLatency=shareCIFSReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, PYSNMP_MODULE_ID=tegile, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, ipmiOther=ipmiOther, projectName=projectName, cifsTotalReadIops=cifsTotalReadIops, lunPoolName=lunPoolName, unknownSensorEvent=unknownSensorEvent, projectShares=projectShares, poolExpanded=poolExpanded, fcTargetReadMbps=fcTargetReadMbps, notificationComponentName=notificationComponentName, fcTargetGroup=fcTargetGroup, nfsTotalReadMbps=nfsTotalReadMbps, projectShareCount=projectShareCount, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notifications=notifications, haResourceIndex=haResourceIndex, snmpServiceStopFailed=snmpServiceStopFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cpuSystemCalls=cpuSystemCalls, lunSizeHigh=lunSizeHigh, shareIndex=shareIndex, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorName=iscsiInitiatorName, projectFreeSizeHigh=projectFreeSizeHigh, fcPortOffline=fcPortOffline, aclMigrationStarted=aclMigrationStarted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunTable=lunTable, fcInitiatorName=fcInitiatorName, shareCIFSReadMbps=shareCIFSReadMbps, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationProps=notificationProps, replicationResumed=replicationResumed, notificationSeverity=notificationSeverity, volumeDeleteCompleted=volumeDeleteCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskDataReadIops=diskDataReadIops, diskSizeLow=diskSizeLow, tegileArray_notifications=tegileArray_notifications, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetName=fcTargetName, snmpServiceStartFailed=snmpServiceStartFailed, snapshotCreationFailed=snapshotCreationFailed, replicationStarted=replicationStarted, poolCreated=poolCreated, cifsAvgReadLatency=cifsAvgReadLatency, replicationTargetDeleted=replicationTargetDeleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tegile=tegile, sanProperties=sanProperties, userLoginFailed=userLoginFailed, projectCompressionEnabled=projectCompressionEnabled, diagnosticDataUploaded=diagnosticDataUploaded, smisServiceStopFailed=smisServiceStopFailed, diskDataReadMbps=diskDataReadMbps, networkIpmpGroupUp=networkIpmpGroupUp)
mibBuilder.exportSymbols("TEGILE-MIB", lunBlockSize=lunBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, lunReadMbps=lunReadMbps, shareDeleted=shareDeleted, fcAvgReadLatency=fcAvgReadLatency, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationSensorSuspect=notificationSensorSuspect, nfsTotalWriteIops=nfsTotalWriteIops, upgradeFailed=upgradeFailed, memoryFailure=memoryFailure, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDeleted=poolDeleted, poolFreeSizeHigh=poolFreeSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunWriteLatency=lunWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, properties=properties, lunWriteIops=lunWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationAbandoned=replicationAbandoned, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, testNotification=testNotification, poolIndex=poolIndex, shareDedupEnabled=shareDedupEnabled, netbiosSocketFailure=netbiosSocketFailure, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteLatency=poolDataWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, nicReceiveMbps=nicReceiveMbps, smisServiceStopped=smisServiceStopped, projectModified=projectModified, projectIndex=projectIndex, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, nicGroup=nicGroup, diskTotalWriteIops=diskTotalWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectTable=projectTable, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, adServerTimeDrift=adServerTimeDrift, poolUsedSizeLow=poolUsedSizeLow, projectDataSizeHigh=projectDataSizeHigh, lunReadLatency=lunReadLatency, diskIsOnline=diskIsOnline, poolAvgReadLatency=poolAvgReadLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationEventCode=notificationEventCode, lunCompressionEnabled=lunCompressionEnabled, diskTotalReadIops=diskTotalReadIops, projectTotalSaving=projectTotalSaving, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareCompressedRatio=shareCompressedRatio, fcPortOnline=fcPortOnline, poolDataReadLatency=poolDataReadLatency, lunTargetGroup=lunTargetGroup, networkTotalTransmitMbps=networkTotalTransmitMbps, cifsTotalReadMbps=cifsTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunIndex=lunIndex, fcTargetsTable=fcTargetsTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolTotalReadMbps=poolTotalReadMbps, ipmiPowerSupply=ipmiPowerSupply, notificationSensorNumber=notificationSensorNumber, lunInitiatorGroup=lunInitiatorGroup, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTargets=iscsiTargets, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskDataWriteIops=diskDataWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, deleteFolderCompleted=deleteFolderCompleted, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareNFSWriteMbps=shareNFSWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolDataSizeLow=poolDataSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, nicTransmitMbps=nicTransmitMbps, poolTotalReadIops=poolTotalReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, ipmiThreshold=ipmiThreshold, diskIOCount=diskIOCount, upgradeStarted=upgradeStarted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareNFSReadLatency=shareNFSReadLatency, sensorFailureEvent=sensorFailureEvent, diskTotalWriteMbps=diskTotalWriteMbps, diskIndex=diskIndex, cifsTotalWriteIops=cifsTotalWriteIops, shareReservedSizeLow=shareReservedSizeLow, iscsiProperties=iscsiProperties, networkInterfaceDown=networkInterfaceDown, fcInitiatorEntry=fcInitiatorEntry, fcTargetIndex=fcTargetIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskDataWriteMbps=diskDataWriteMbps, network=network, shareEntry=shareEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, controllerUp=controllerUp, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, nicName=nicName, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskAlias=diskAlias, lunEntry=lunEntry, poolOwnerController=poolOwnerController, cacheTotalReadMbps=cacheTotalReadMbps, projectQuotaFinished=projectQuotaFinished, diskState=diskState, ipmiMemory=ipmiMemory, fcTotalWriteIops=fcTotalWriteIops, upgradeTimeout=upgradeTimeout, iscsiTargetGroup=iscsiTargetGroup, lunReservedSizeHigh=lunReservedSizeHigh, controllerDown=controllerDown, poolName=poolName, iscsiWriteIops=iscsiWriteIops, replicationAborted=replicationAborted, notificationReadingTriggerValue=notificationReadingTriggerValue, cacheTotalWriteMbps=cacheTotalWriteMbps, smisServiceStarted=smisServiceStarted, diskPoolName=diskPoolName, iscsiInitiatorGroup=iscsiInitiatorGroup, diskError=diskError, alertsCleanupCompleted=alertsCleanupCompleted, controllerTimeDrift=controllerTimeDrift, fcTargetWriteIops=fcTargetWriteIops, deleteFolderFailed=deleteFolderFailed, projectLunCount=projectLunCount, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, haControllerB_Uptime=haControllerB_Uptime, poolDataWriteIops=poolDataWriteIops, iscsiInitiators=iscsiInitiators, cifsTotalWriteMbps=cifsTotalWriteMbps, shareMountPoint=shareMountPoint, volumeQuotaFinished=volumeQuotaFinished, shareCIFSEnabled=shareCIFSEnabled, shareNFSReadIops=shareNFSReadIops, haResourcesTable=haResourcesTable, lunName=lunName, poolImported=poolImported, projectPoolName=projectPoolName, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, shareReservedSizeHigh=shareReservedSizeHigh, replicationPaused=replicationPaused, haResourceStatus=haResourceStatus, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareQuotaLow=shareQuotaLow, haResourceActiveNode=haResourceActiveNode, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcInitiators=fcInitiators, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cpuTotalUsage=cpuTotalUsage, poolReadCacheWriteIops=poolReadCacheWriteIops, poolProjects=poolProjects, fcTargetStatus=fcTargetStatus, nvdimmFailInitializationError=nvdimmFailInitializationError, nicEntry=nicEntry, poolMetaWriteIops=poolMetaWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, haControllerA_Name=haControllerA_Name, diskSequentialIOCount=diskSequentialIOCount, fcTotalReadIops=fcTotalReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareDataSizeLow=shareDataSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, poolDataSizeHigh=poolDataSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, currentNotificationGroup=currentNotificationGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTargetIndex=iscsiTargetIndex, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, notificationDescription=notificationDescription, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolSizeLow=poolSizeLow, fcInitiatorsTable=fcInitiatorsTable, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalWriteIops=poolTotalWriteIops, haControllerB_Name=haControllerB_Name, poolDegraded=poolDegraded, upgradeCompleted=upgradeCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snmpAgentVersion=snmpAgentVersion, iscsiTargetGroupError=iscsiTargetGroupError, projectDedupEnabled=projectDedupEnabled, fcTargetReadIops=fcTargetReadIops, iscsiTargetReadIops=iscsiTargetReadIops)
