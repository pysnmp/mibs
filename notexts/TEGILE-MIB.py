...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:35:14 2023
...
TimeTicks, IpAddress, Counter32, ModuleIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, NotificationType, Counter64, Unsigned32, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "ModuleIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "NotificationType", "Counter64", "Unsigned32", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalSaving=poolTotalSaving, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareNFSReadIops=shareNFSReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, basicCompliance=basicCompliance, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunWriteMbps=lunWriteMbps, diskSizeHigh=diskSizeHigh, ipmiFan=ipmiFan, testNotification=testNotification, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, volumeModifyCompleted=volumeModifyCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nicEntry=nicEntry, poolTotalReadIops=poolTotalReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, unknownSensorEvent=unknownSensorEvent, upgradeTimeout=upgradeTimeout, nfsAvgReadLatency=nfsAvgReadLatency, diskTotalReadIops=diskTotalReadIops, poolFreeSizeLow=poolFreeSizeLow, fcPortOffline=fcPortOffline, poolMetaWriteMbps=poolMetaWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, lunCompressedRatio=lunCompressedRatio, upgradeFailed=upgradeFailed, snapshotCreationFailed=snapshotCreationFailed, shareCIFSReadIops=shareCIFSReadIops, controllerTimeDrift=controllerTimeDrift, haResources=haResources, projectShares=projectShares, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiators=iscsiInitiators, diskAlias=diskAlias, fcInitiatorIndex=fcInitiatorIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, nicName=nicName, PYSNMP_MODULE_ID=tegile, notificationTime=notificationTime, poolCount=poolCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, ipmiOther=ipmiOther, replicationAborted=replicationAborted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, tegileGroups=tegileGroups, shareEntry=shareEntry, alertsCleanupCompleted=alertsCleanupCompleted, nicMTU=nicMTU, lunTargetGroup=lunTargetGroup, poolDataReadIops=poolDataReadIops, poolDataSizeLow=poolDataSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetStatus=fcTargetStatus, snapshotCloningFailed=snapshotCloningFailed, networkInterfaceDown=networkInterfaceDown, iscsiInitiatorName=iscsiInitiatorName, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetEntry=iscsiTargetEntry, fcInitiators=fcInitiators, diskTotalWriteIops=diskTotalWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, projectDataSizeHigh=projectDataSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTotalReadIops=fcTotalReadIops, poolAvgWriteLatency=poolAvgWriteLatency, shareQuotaLow=shareQuotaLow, cifsAvgWriteLatency=cifsAvgWriteLatency, aclMigrationCompleted=aclMigrationCompleted, cpuSystemCalls=cpuSystemCalls, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareNFSWriteIops=shareNFSWriteIops, tegileArray_notifications=tegileArray_notifications, projectDataSizeLow=projectDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cifsAvgReadLatency=cifsAvgReadLatency, diskEntry=diskEntry, lunFreeSizeLow=lunFreeSizeLow, projectQuotaFinished=projectQuotaFinished, haResourceIndex=haResourceIndex, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareReservedSizeLow=shareReservedSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, cifsTotalWriteIops=cifsTotalWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolMetaReadIops=poolMetaReadIops, projectLUNs=projectLUNs, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationSeverity=notificationSeverity, lunInitiatorGroup=lunInitiatorGroup, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snmpServiceStarted=snmpServiceStarted, diskIsOnline=diskIsOnline, nicTransmitMbps=nicTransmitMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargetIndex=iscsiTargetIndex, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationStarted=replicationStarted, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectLunCount=projectLunCount, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetName=fcTargetName, shareTable=shareTable, haControllerB_Name=haControllerB_Name, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSEnabled=shareCIFSEnabled, nfsTotalWriteMbps=nfsTotalWriteMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetIndex=fcTargetIndex, cpuTotalUsage=cpuTotalUsage, iscsiTargetReadMbps=iscsiTargetReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolName=poolName, shareReservedSizeHigh=shareReservedSizeHigh, fcTargets=fcTargets, projectTotalSaving=projectTotalSaving, snmpServiceStopFailed=snmpServiceStopFailed, notificationObjects=notificationObjects, poolUsedSizeLow=poolUsedSizeLow, shareNFSReadMbps=shareNFSReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorsTable=fcInitiatorsTable, notifications=notifications, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectDeleted=projectDeleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, diskDataReadIops=diskDataReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolExpanded=poolExpanded, nicTable=nicTable, diskTable=diskTable, haResourceActiveNode=haResourceActiveNode, poolDeleted=poolDeleted, fcTargetsTable=fcTargetsTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationTargetDeleted=replicationTargetDeleted, lunSnapshotSizeLow=lunSnapshotSizeLow, deleteFolderCompleted=deleteFolderCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, targetGroupMemberRemoved=targetGroupMemberRemoved, cacheTotalReadMbps=cacheTotalReadMbps, diskDataWriteIops=diskDataWriteIops, lunBlockSize=lunBlockSize, shareSnapshotSizeLow=shareSnapshotSizeLow, lunWriteIops=lunWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, poolHealth=poolHealth, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, ipmiTemperature=ipmiTemperature, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorGroup=fcInitiatorGroup, poolSizeHigh=poolSizeHigh, poolDegraded=poolDegraded, properties=properties, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolProjectCount=poolProjectCount, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeDownloadStarted=upgradeDownloadStarted, poolReadCacheReadLatency=poolReadCacheReadLatency, smisServiceStarted=smisServiceStarted, fcTargetWriteMbps=fcTargetWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, tdpsUpgradeFailed=tdpsUpgradeFailed, shareNFSReadLatency=shareNFSReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetReadIops=fcTargetReadIops, replicationResumed=replicationResumed, poolMetaReadLatency=poolMetaReadLatency, diskDataReadMbps=diskDataReadMbps, poolProjects=poolProjects, projectTable=projectTable, adServerTimeDrift=adServerTimeDrift, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsTotalReadMbps=cifsTotalReadMbps, poolMetaReadMbps=poolMetaReadMbps, tegileArray=tegileArray, shareNFSWriteLatency=shareNFSWriteLatency, ipmiMemory=ipmiMemory, smbSocketFailure=smbSocketFailure, shareMountPoint=shareMountPoint, lunCompressionEnabled=lunCompressionEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, cpuInterrupts=cpuInterrupts, shareName=shareName, snapshotDeleteFailed=snapshotDeleteFailed, notificationTargetEntityName=notificationTargetEntityName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetError=iscsiTargetError, controllerHardwareModel=controllerHardwareModel, iscsiTargetAlias=iscsiTargetAlias, shareCIFSWriteIops=shareCIFSWriteIops, diskTotalReadMbps=diskTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolEntry=poolEntry, poolImported=poolImported, fcInitiatorName=fcInitiatorName, haResourcesTable=haResourcesTable, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTotalReadMbps=fcTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, lunPoolName=lunPoolName, poolCreated=poolCreated, haControllerA_Name=haControllerA_Name, haResourceStatus=haResourceStatus, haControllerB_Uptime=haControllerB_Uptime, currentNotificationGroup=currentNotificationGroup, smisServiceStopFailed=smisServiceStopFailed, controllerUp=controllerUp, maintenanceModeEnabled=maintenanceModeEnabled, shareDeletionFailed=shareDeletionFailed, shareDataSizeHigh=shareDataSizeHigh, poolDataWriteMbps=poolDataWriteMbps, notificationDescription=notificationDescription, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunEntry=lunEntry, ipmiThreshold=ipmiThreshold, shareCreatedSuccessfully=shareCreatedSuccessfully, currentObjectGroup=currentObjectGroup, volumeDeleteFailed=volumeDeleteFailed, networkIpmpGroupDown=networkIpmpGroupDown, tegileCompliances=tegileCompliances, diskAvgReadLatency=diskAvgReadLatency, projectModified=projectModified, iscsiProperties=iscsiProperties, shareProjectName=shareProjectName, shareDedupEnabled=shareDedupEnabled)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetGroupError=iscsiTargetGroupError, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectIndex=projectIndex, haResourceDescription=haResourceDescription, networkTotalTransmitMbps=networkTotalTransmitMbps, tegileConformance=tegileConformance, lunProjectName=lunProjectName, memoryFailure=memoryFailure, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaWriteLatency=poolMetaWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolIndex=poolIndex, iscsiTargetName=iscsiTargetName, diskAvgWriteLatency=diskAvgWriteLatency, diskIndex=diskIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cacheSSDReads=cacheSSDReads, snapshotRollbackFailed=snapshotRollbackFailed, poolDataSizeHigh=poolDataSizeHigh, iscsiWriteIops=iscsiWriteIops, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunSizeHigh=lunSizeHigh, volumeQuotaFinished=volumeQuotaFinished, shareCIFSReadLatency=shareCIFSReadLatency, fcPortOnline=fcPortOnline, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSlowIo=diskSlowIo, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, aclMigrationStarted=aclMigrationStarted, volumeDeleteCompleted=volumeDeleteCompleted, cacheRAMReads=cacheRAMReads, upgradeStarted=upgradeStarted, lunReadMbps=lunReadMbps, lunWriteLatency=lunWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, shareNFSEnabled=shareNFSEnabled, fcTotalWriteIops=fcTotalWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, poolUpgraded=poolUpgraded, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, deleteFolderFailed=deleteFolderFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, lunTable=lunTable, diskError=diskError, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTargetEntry=fcTargetEntry, projectPoolName=projectPoolName, haResourceEntry=haResourceEntry, shareQuotaHigh=shareQuotaHigh, snmpServiceStartFailed=snmpServiceStartFailed, disks=disks, fcTotalWriteMbps=fcTotalWriteMbps, poolOwnerController=poolOwnerController, iscsiImproperTargetGroup=iscsiImproperTargetGroup, networkIpmpGroupUp=networkIpmpGroupUp, projectName=projectName, iscsiTargets=iscsiTargets, diagnosticDataUploaded=diagnosticDataUploaded, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, lunReadLatency=lunReadLatency, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunDataSizeHigh=lunDataSizeHigh, notificationReadingUnit=notificationReadingUnit, notificationProps=notificationProps, nfsTotalReadIops=nfsTotalReadIops, replicationAbandoned=replicationAbandoned, replicationComplete=replicationComplete, vmwareNFSDatastores=vmwareNFSDatastores, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDataReadMbps=poolDataReadMbps, smisServiceStopped=smisServiceStopped, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCompressedRatio=shareCompressedRatio, maintenanceModeDisabled=maintenanceModeDisabled, projectSnapshotSizeLow=projectSnapshotSizeLow, diskDataWriteMbps=diskDataWriteMbps, userLoginFailed=userLoginFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicState=nicState, pools=pools, poolExported=poolExported, diskType=diskType, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nvdimmFailDeviceError=nvdimmFailDeviceError, network=network, iscsiTargetsTable=iscsiTargetsTable, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetWriteIops=fcTargetWriteIops, lunIndex=lunIndex, projectDeletionFailed=projectDeletionFailed, poolSizeLow=poolSizeLow, poolAvgReadLatency=poolAvgReadLatency, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, ipmiCurrent=ipmiCurrent, lunDataSizeLow=lunDataSizeLow, lunReservedSizeLow=lunReservedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, upgradeCompleted=upgradeCompleted, diskChassisIdx=diskChassisIdx, shareDeleted=shareDeleted, notificationEventCode=notificationEventCode, shareDataSizeLow=shareDataSizeLow, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetAuth=iscsiTargetAuth, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareIndex=shareIndex, projectQuotaSizeLow=projectQuotaSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, netbiosSocketFailure=netbiosSocketFailure, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskState=diskState, nicIndex=nicIndex, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicReceiveMbps=nicReceiveMbps, lunReadIops=lunReadIops, haControllerA_Uptime=haControllerA_Uptime, nvdimmFailInitializationError=nvdimmFailInitializationError, cacheTotalReadIops=cacheTotalReadIops, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationFailed=replicationFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, projectEntry=projectEntry, projectDedupEnabled=projectDedupEnabled, lunReservedSizeHigh=lunReservedSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, ipmiPowerSupply=ipmiPowerSupply, controllerDown=controllerDown, poolState=poolState, ipmiVoltage=ipmiVoltage, projectShareCount=projectShareCount, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetReadLatency=fcTargetReadLatency, fcProperties=fcProperties, haResourceGroup=haResourceGroup, poolDataWriteLatency=poolDataWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, lunName=lunName, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeDownloadFailed=upgradeDownloadFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskRandomIOCount=diskRandomIOCount, tegile=tegile, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskSequentialIOCount=diskSequentialIOCount, replicationPaused=replicationPaused, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetGroup=fcTargetGroup, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetReadMbps=fcTargetReadMbps, nicGroup=nicGroup, notificationSensorAction=notificationSensorAction, diskPoolName=diskPoolName, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationComponentName=notificationComponentName, ntpServerTimeDrift=ntpServerTimeDrift, fcAvgReadLatency=fcAvgReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, projectCompressionEnabled=projectCompressionEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataReadLatency=poolDataReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, globalStatistics=globalStatistics, lunProtocol=lunProtocol, sharePoolName=sharePoolName, haControllerB_IPAddr=haControllerB_IPAddr, diskSizeLow=diskSizeLow, snmpServiceStopped=snmpServiceStopped, sensorFailureEvent=sensorFailureEvent, diskGoneOffline=diskGoneOffline, lunGUID=lunGUID, diskCount=diskCount, projectQuotaSizeHigh=projectQuotaSizeHigh, shareQuotaFinished=shareQuotaFinished, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, replicationSourceRegistered=replicationSourceRegistered, lunSizeLow=lunSizeLow, smisServiceStartFailed=smisServiceStartFailed, haResourceName=haResourceName, sanProperties=sanProperties, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolTable=poolTable, iscsiTargetGroup=iscsiTargetGroup, networkInterfaceUp=networkInterfaceUp, targetGroupMemberAdded=targetGroupMemberAdded, diskIOCount=diskIOCount, lunDedupEnabled=lunDedupEnabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps)
