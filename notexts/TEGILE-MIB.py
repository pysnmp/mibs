...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:04:58 2021
...
TimeTicks, Gauge32, MibIdentifier, Unsigned32, ModuleIdentity, IpAddress, Integer32, Counter64, Bits, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "Bits", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSEnabled=shareNFSEnabled, iscsiInitiators=iscsiInitiators, lunFreeSizeLow=lunFreeSizeLow, pools=pools, iscsiTargetEntry=iscsiTargetEntry, projectTable=projectTable, diskTable=diskTable, diskType=diskType, projectDedupEnabled=projectDedupEnabled, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, upgradeCompleted=upgradeCompleted, fcTargetName=fcTargetName, lunWriteLatency=lunWriteLatency, lunSizeHigh=lunSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, smisServiceStopped=smisServiceStopped, diskCount=diskCount, diskEntry=diskEntry, projectDataSizeHigh=projectDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetIndex=fcTargetIndex, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, snmpAgentVersion=snmpAgentVersion, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskPoolName=diskPoolName, fcInitiatorName=fcInitiatorName, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalWriteMbps=poolTotalWriteMbps, poolProjects=poolProjects, lunTable=lunTable, diskDataReadMbps=diskDataReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadIops=shareNFSReadIops, lunReservedSizeLow=lunReservedSizeLow, fcTotalWriteIops=fcTotalWriteIops, ipmiMemory=ipmiMemory, shareNFSReadMbps=shareNFSReadMbps, ipmiThreshold=ipmiThreshold, ipmiCurrent=ipmiCurrent, shareSnapshotSizeLow=shareSnapshotSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiProperties=iscsiProperties, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTargetReadIops=fcTargetReadIops, cifsTotalWriteIops=cifsTotalWriteIops, fcTotalReadIops=fcTotalReadIops, cpuSystemCalls=cpuSystemCalls, haResourcesTable=haResourcesTable, vmwareNFSDatastores=vmwareNFSDatastores, networkIpmpGroupDown=networkIpmpGroupDown, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationComponentName=notificationComponentName, notificationSeverity=notificationSeverity, projectQuotaSizeHigh=projectQuotaSizeHigh, networkIpmpGroupUp=networkIpmpGroupUp, poolTable=poolTable, nicEntry=nicEntry, iscsiTargetError=iscsiTargetError, poolTotalWriteIops=poolTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, projectDeleted=projectDeleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, replicationResumed=replicationResumed, iscsiTargets=iscsiTargets, ntpServerTimeDrift=ntpServerTimeDrift, lunProtocol=lunProtocol, shareDeleted=shareDeleted, shareQuotaFinished=shareQuotaFinished, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareIndex=shareIndex, iscsiTotalReadIops=iscsiTotalReadIops, shareMountPoint=shareMountPoint, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, diskState=diskState, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, lunReadMbps=lunReadMbps, fcPortOnline=fcPortOnline, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notifications=notifications, snapshotCloningFailed=snapshotCloningFailed, notificationProps=notificationProps, projectFreeSizeLow=projectFreeSizeLow, fcTargets=fcTargets, haResourceName=haResourceName, maintenanceModeDisabled=maintenanceModeDisabled, fcTotalReadMbps=fcTotalReadMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectLUNs=projectLUNs, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, diagnosticDataUploaded=diagnosticDataUploaded, poolUsedSizeLow=poolUsedSizeLow, sanProperties=sanProperties, poolTotalReadMbps=poolTotalReadMbps, nicTable=nicTable, poolOwnerController=poolOwnerController, volumeQuotaFinished=volumeQuotaFinished, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskDataReadIops=diskDataReadIops, replicationSourceRegistered=replicationSourceRegistered, networkTotalReceiveMbps=networkTotalReceiveMbps, lunWriteIops=lunWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, fcInitiators=fcInitiators, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snmpServiceStopped=snmpServiceStopped, poolAvgReadLatency=poolAvgReadLatency, notificationReadingUnit=notificationReadingUnit, lunDataSizeLow=lunDataSizeLow, diskAvgReadLatency=diskAvgReadLatency, shareProjectName=shareProjectName, lunInitiatorGroup=lunInitiatorGroup, fcTargetWriteLatency=fcTargetWriteLatency, poolDataReadMbps=poolDataReadMbps, haResourceEntry=haResourceEntry, iscsiTargetReadLatency=iscsiTargetReadLatency, memoryFailure=memoryFailure, iscsiTargetWriteIops=iscsiTargetWriteIops, nicIndex=nicIndex, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, notificationSensorSuspect=notificationSensorSuspect, haControllerB_Name=haControllerB_Name, shareCIFSWriteLatency=shareCIFSWriteLatency, smbSocketFailure=smbSocketFailure, shareQuotaLow=shareQuotaLow, adServerTimeDrift=adServerTimeDrift, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, replicationTargetDeleted=replicationTargetDeleted, poolCount=poolCount, sharePoolName=sharePoolName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, ipmiFan=ipmiFan, poolMetaWriteIops=poolMetaWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationEventCode=notificationEventCode, cifsTotalReadIops=cifsTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, globalStatistics=globalStatistics, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationFailed=replicationFailed, haControllerB_IPAddr=haControllerB_IPAddr, projectShareCount=projectShareCount, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolMetaReadIops=poolMetaReadIops, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cacheTotalWriteIops=cacheTotalWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicState=nicState, nfsTotalReadMbps=nfsTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunCompressionEnabled=lunCompressionEnabled, poolExpanded=poolExpanded, projectDataSizeLow=projectDataSizeLow, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunSizeLow=lunSizeLow, projectEntry=projectEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationPaused=replicationPaused, network=network, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotCreationFailed=snapshotCreationFailed, poolSizeHigh=poolSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskIOCount=diskIOCount, iscsiTargetAlias=iscsiTargetAlias, fcTargetGroup=fcTargetGroup, diskSequentialIOCount=diskSequentialIOCount, alertsCleanupCompleted=alertsCleanupCompleted, basicCompliance=basicCompliance, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, networkInterfaceUp=networkInterfaceUp, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, poolDataSizeHigh=poolDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskDataWriteIops=diskDataWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, nfsTotalReadIops=nfsTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, shareEntry=shareEntry, nfsAvgWriteLatency=nfsAvgWriteLatency, poolUpgraded=poolUpgraded, projectShares=projectShares, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolProjectCount=poolProjectCount, smisServiceStarted=smisServiceStarted, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetIndex=iscsiTargetIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, snmpServiceStopFailed=snmpServiceStopFailed, lunDataSizeHigh=lunDataSizeHigh, lunEntry=lunEntry, tegile=tegile, fcTargetWriteIops=fcTargetWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, shareDedupEnabled=shareDedupEnabled, poolDataWriteIops=poolDataWriteIops, poolName=poolName, snapshotRollbackFailed=snapshotRollbackFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectTotalSaving=projectTotalSaving, deleteFolderCompleted=deleteFolderCompleted, notificationTargetEntityName=notificationTargetEntityName, userLoginFailed=userLoginFailed, fcTargetReadLatency=fcTargetReadLatency, projectIndex=projectIndex, diskTotalWriteIops=diskTotalWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, lunName=lunName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, networkTotalTransmitMbps=networkTotalTransmitMbps, controllerUp=controllerUp, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, projectDeletionFailed=projectDeletionFailed)
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSWriteMbps=shareCIFSWriteMbps, fcPortOffline=fcPortOffline, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorIndex=fcInitiatorIndex, notificationObjects=notificationObjects, shareNFSReadLatency=shareNFSReadLatency, lunBlockSize=lunBlockSize, PYSNMP_MODULE_ID=tegile, diskIndex=diskIndex, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcProperties=fcProperties, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolQuotaFinished=poolQuotaFinished, controllerDown=controllerDown, netbiosSocketFailure=netbiosSocketFailure, lunWriteMbps=lunWriteMbps, shareDataSizeLow=shareDataSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunIndex=lunIndex, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationAbandoned=replicationAbandoned, sensorFailureEvent=sensorFailureEvent, diskError=diskError, haResources=haResources, spareDiskReplaced=spareDiskReplaced, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolIndex=poolIndex, notificationSensorNumber=notificationSensorNumber, haControllerA_Name=haControllerA_Name, poolMetaReadMbps=poolMetaReadMbps, shareReservedSizeLow=shareReservedSizeLow, aclMigrationCompleted=aclMigrationCompleted, unknownSensorEvent=unknownSensorEvent, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nfsTotalWriteMbps=nfsTotalWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, disks=disks, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskDataWriteMbps=diskDataWriteMbps, fcInitiatorsTable=fcInitiatorsTable, smisServiceStopFailed=smisServiceStopFailed, shareReservedSizeHigh=shareReservedSizeHigh, currentNotificationGroup=currentNotificationGroup, ipmiTemperature=ipmiTemperature, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkInterfaceDown=networkInterfaceDown, controllerHardwareModel=controllerHardwareModel, iscsiTargetName=iscsiTargetName, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolDeleted=poolDeleted, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, haResourceIndex=haResourceIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snmpServiceStarted=snmpServiceStarted, shareTable=shareTable, volumeDeleteFailed=volumeDeleteFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, projectCompressionEnabled=projectCompressionEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, nicMTU=nicMTU, volumeDeleteCompleted=volumeDeleteCompleted, shareNFSWriteLatency=shareNFSWriteLatency, notificationSensorAction=notificationSensorAction, poolSizeLow=poolSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDegraded=poolDegraded, snapshotCloneCompleted=snapshotCloneCompleted, upgradeTimeout=upgradeTimeout, haResourceActiveNode=haResourceActiveNode, projectQuotaFinished=projectQuotaFinished, nicTransmitMbps=nicTransmitMbps, diskAlias=diskAlias, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolHealth=poolHealth, targetGroupMemberAdded=targetGroupMemberAdded, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeStarted=upgradeStarted, projectPoolName=projectPoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcAvgReadLatency=fcAvgReadLatency, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetStatus=fcTargetStatus, shareCompressionEnabled=shareCompressionEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetsTable=iscsiTargetsTable, smisServiceStartFailed=smisServiceStartFailed, haResourceStatus=haResourceStatus, diskGoneOffline=diskGoneOffline, diskTotalWriteMbps=diskTotalWriteMbps, tegileGroups=tegileGroups, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunPoolName=lunPoolName, nicName=nicName, poolFreeSizeHigh=poolFreeSizeHigh, haResourceGroup=haResourceGroup, poolMetaWriteLatency=poolMetaWriteLatency, shareName=shareName, iscsiTargetReadMbps=iscsiTargetReadMbps, controllerTimeDrift=controllerTimeDrift, lunReadIops=lunReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tegileCompliances=tegileCompliances, nicReceiveMbps=nicReceiveMbps, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cpuTotalUsage=cpuTotalUsage, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunTargetGroup=lunTargetGroup, notificationDescription=notificationDescription, diskIsOnline=diskIsOnline, lunDedupEnabled=lunDedupEnabled, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetsTable=fcTargetsTable, properties=properties, notificationTime=notificationTime, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolDeletionFailed=poolDeletionFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskTotalReadIops=diskTotalReadIops, poolExported=poolExported, tegileArray_notifications=tegileArray_notifications, replicationComplete=replicationComplete, lunGUID=lunGUID, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nvdimmFailSoftError=nvdimmFailSoftError, shareQuotaHigh=shareQuotaHigh, aclMigrationStarted=aclMigrationStarted, snapshotDeleteFailed=snapshotDeleteFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolCreated=poolCreated, projectName=projectName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, replicationStarted=replicationStarted, iscsiInitiatorName=iscsiInitiatorName, haResourceDescription=haResourceDescription, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetWriteMbps=fcTargetWriteMbps, projectModified=projectModified, ipmiOther=ipmiOther, diskSlowIo=diskSlowIo, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSReadIops=shareCIFSReadIops, fcInitiatorEntry=fcInitiatorEntry, tegileConformance=tegileConformance, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetAuth=iscsiTargetAuth, projectFreeSizeHigh=projectFreeSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, lunReadLatency=lunReadLatency, diskChassisIdx=diskChassisIdx, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haControllerA_IPAddr=haControllerA_IPAddr, maintenanceModeEnabled=maintenanceModeEnabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolEntry=poolEntry, shareCompressedRatio=shareCompressedRatio, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareDeletionFailed=shareDeletionFailed, upgradeFailed=upgradeFailed, tegileArray=tegileArray, poolImported=poolImported, replicationAborted=replicationAborted, poolTotalSaving=poolTotalSaving, nicGroup=nicGroup, deleteFolderFailed=deleteFolderFailed, diskSizeLow=diskSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, cacheTotalReadIops=cacheTotalReadIops, shareCIFSReadMbps=shareCIFSReadMbps, poolFreeSizeLow=poolFreeSizeLow, poolTotalReadIops=poolTotalReadIops, lunFreeSizeHigh=lunFreeSizeHigh, diskRandomIOCount=diskRandomIOCount, lunReservedSizeHigh=lunReservedSizeHigh, cacheRAMReads=cacheRAMReads, lunProjectName=lunProjectName, testNotification=testNotification, projectLunCount=projectLunCount, poolState=poolState, cacheSSDReads=cacheSSDReads, ipmiVoltage=ipmiVoltage)
