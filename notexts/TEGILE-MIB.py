...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, MibIdentifier, enterprises, Unsigned32, ModuleIdentity, IpAddress, ObjectIdentity, TimeTicks, Gauge32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "MibIdentifier", "enterprises", "Unsigned32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "TimeTicks", "Gauge32", "iso", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationComplete=replicationComplete, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetName=fcTargetName, memoryFailure=memoryFailure, pools=pools, poolFreeSizeHigh=poolFreeSizeHigh, notificationEventCode=notificationEventCode, lunPoolName=lunPoolName, iscsiTargetAuth=iscsiTargetAuth, replicationResumed=replicationResumed, diskTotalWriteMbps=diskTotalWriteMbps, smisServiceStopped=smisServiceStopped, diskRandomIOCount=diskRandomIOCount, projectDeletionFailed=projectDeletionFailed, lunWriteMbps=lunWriteMbps, haControllerA_Uptime=haControllerA_Uptime, webdocsUpgradeFailed=webdocsUpgradeFailed, snapshotCloningFailed=snapshotCloningFailed, shareNFSWriteIops=shareNFSWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileGroups=tegileGroups, shareCompressedRatio=shareCompressedRatio, targetGroupMemberAdded=targetGroupMemberAdded, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskSequentialIOCount=diskSequentialIOCount, fcTargetWriteMbps=fcTargetWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetGroup=fcTargetGroup, poolOwnerController=poolOwnerController, poolDataSizeLow=poolDataSizeLow, replicationSourceRegistered=replicationSourceRegistered, deleteFolderCompleted=deleteFolderCompleted, diskChassisIdx=diskChassisIdx, ipmiFan=ipmiFan, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolTotalWriteMbps=poolTotalWriteMbps, diskState=diskState, upgradeCompleted=upgradeCompleted, shareDataSizeHigh=shareDataSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, diskAvgWriteLatency=diskAvgWriteLatency, projectPoolName=projectPoolName, diskError=diskError, snapshotCreationFailed=snapshotCreationFailed, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haControllerA_Name=haControllerA_Name, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetReadIops=iscsiTargetReadIops, nicIndex=nicIndex, snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiators=iscsiInitiators, tegileArray=tegileArray, poolDataWriteIops=poolDataWriteIops, notificationSeverity=notificationSeverity, shareNFSWriteMbps=shareNFSWriteMbps, unknownSensorEvent=unknownSensorEvent, nfsAvgReadLatency=nfsAvgReadLatency, nicMTU=nicMTU, projectCreatedSuccessfully=projectCreatedSuccessfully, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetStatus=fcTargetStatus, diskPoolName=diskPoolName, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiProperties=iscsiProperties, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaReadMbps=poolMetaReadMbps, poolExported=poolExported, cacheTotalReadIops=cacheTotalReadIops, fcInitiatorGroup=fcInitiatorGroup, volumeDeleteCompleted=volumeDeleteCompleted, projectQuotaSizeLow=projectQuotaSizeLow, replicationPaused=replicationPaused, sanProperties=sanProperties, diskIOCount=diskIOCount, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareQuotaFinished=shareQuotaFinished, smisServiceStartFailed=smisServiceStartFailed, replicationTargetDeleted=replicationTargetDeleted, nicEntry=nicEntry, networkTotalTransmitMbps=networkTotalTransmitMbps, snmpServiceStarted=snmpServiceStarted, iscsiTargetGroupError=iscsiTargetGroupError, controllerHardwareModel=controllerHardwareModel, fcTargetIndex=fcTargetIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, haResources=haResources, lunDataSizeHigh=lunDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicGroup=nicGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskIndex=diskIndex, lunSizeHigh=lunSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, diskAlias=diskAlias, nfsTotalReadMbps=nfsTotalReadMbps, fcTotalReadIops=fcTotalReadIops, cifsAvgReadLatency=cifsAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, poolTotalWriteIops=poolTotalWriteIops, haResourceStatus=haResourceStatus, shareReservedSizeHigh=shareReservedSizeHigh, lunName=lunName, shareCIFSWriteMbps=shareCIFSWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDeleted=poolDeleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectEntry=projectEntry, fcTargetWriteIops=fcTargetWriteIops, poolDataWriteMbps=poolDataWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotDeleteFailed=snapshotDeleteFailed, shareNFSEnabled=shareNFSEnabled, poolSizeHigh=poolSizeHigh, deleteFolderFailed=deleteFolderFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectCompressionEnabled=projectCompressionEnabled, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTotalReadIops=iscsiTotalReadIops, disks=disks, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunTable=lunTable, ipmiCurrent=ipmiCurrent, iscsiTargetReadLatency=iscsiTargetReadLatency, diskEntry=diskEntry, controllerTimeDrift=controllerTimeDrift, projectIndex=projectIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolAvgReadLatency=poolAvgReadLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, notificationSensorNumber=notificationSensorNumber, iscsiTargetWriteIops=iscsiTargetWriteIops, networkInterfaceDown=networkInterfaceDown, fcInitiatorsTable=fcInitiatorsTable, upgradeFailed=upgradeFailed, poolEntry=poolEntry, smisServiceStopFailed=smisServiceStopFailed, diskCount=diskCount, shareDeleted=shareDeleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareNFSReadLatency=shareNFSReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolTotalSaving=poolTotalSaving, fcTargetWriteLatency=fcTargetWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareNFSReadIops=shareNFSReadIops, projectDeleted=projectDeleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskDataReadMbps=diskDataReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetReadMbps=fcTargetReadMbps, fcTargetReadIops=fcTargetReadIops, lunIndex=lunIndex, projectName=projectName, iscsiInitiatorIndex=iscsiInitiatorIndex, shareMountPoint=shareMountPoint, fcPortOnline=fcPortOnline, lunFreeSizeHigh=lunFreeSizeHigh, shareQuotaLow=shareQuotaLow, iscsiTargetAlias=iscsiTargetAlias, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargets=iscsiTargets, shareEntry=shareEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, notifications=notifications, notificationComponentName=notificationComponentName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaWriteIops=poolMetaWriteIops, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskIsOnline=diskIsOnline, replicationStarted=replicationStarted, lunCompressedRatio=lunCompressedRatio, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectLUNs=projectLUNs, nvdimmFailDeviceError=nvdimmFailDeviceError, haControllerB_Name=haControllerB_Name, cpuTotalUsage=cpuTotalUsage, projectShares=projectShares, replicationFailed=replicationFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, userLoginFailed=userLoginFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunWriteLatency=lunWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolName=poolName, PYSNMP_MODULE_ID=tegile, cpuInterrupts=cpuInterrupts, haControllerA_IPAddr=haControllerA_IPAddr, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcProperties=fcProperties, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, notificationTargetEntityName=notificationTargetEntityName, notificationReadingUnit=notificationReadingUnit, diskGoneOffline=diskGoneOffline, poolDataWriteLatency=poolDataWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, projectModified=projectModified, haResourceActiveNode=haResourceActiveNode, poolQuotaFinished=poolQuotaFinished, shareCIFSWriteIops=shareCIFSWriteIops, aclMigrationStarted=aclMigrationStarted, fcAvgReadLatency=fcAvgReadLatency, testNotification=testNotification, lunFreeSizeLow=lunFreeSizeLow, snmpServiceStopped=snmpServiceStopped, lunReadLatency=lunReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, lunEntry=lunEntry, volumeDeleteFailed=volumeDeleteFailed, nvdimmFailSoftError=nvdimmFailSoftError, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunProjectName=lunProjectName, lunDataSizeLow=lunDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", nfsTotalWriteMbps=nfsTotalWriteMbps, diskDataWriteIops=diskDataWriteIops, cifsTotalReadIops=cifsTotalReadIops, netbiosSocketFailure=netbiosSocketFailure, diskSizeHigh=diskSizeHigh, nicTransmitMbps=nicTransmitMbps, sharePoolName=sharePoolName, iscsiTargetEntry=iscsiTargetEntry, networkIpmpGroupDown=networkIpmpGroupDown, sensorFailureEvent=sensorFailureEvent, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haResourceEntry=haResourceEntry, projectDedupEnabled=projectDedupEnabled, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, notificationSensorSuspect=notificationSensorSuspect, smbSocketFailure=smbSocketFailure, notificationTime=notificationTime, shareCIFSReadIops=shareCIFSReadIops, snmpServiceStartFailed=snmpServiceStartFailed, poolTotalReadIops=poolTotalReadIops, shareCompressionEnabled=shareCompressionEnabled, nicReceiveMbps=nicReceiveMbps, diskType=diskType, networkTotalReceiveMbps=networkTotalReceiveMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolSizeLow=poolSizeLow, ipmiMemory=ipmiMemory, snmpAgentVersion=snmpAgentVersion, nicState=nicState, poolProjects=poolProjects, shareDataSizeLow=shareDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, projectThresholdExceedWarning=projectThresholdExceedWarning, fcInitiators=fcInitiators, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationProps=notificationProps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeDownloadStarted=upgradeDownloadStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiWriteIops=iscsiWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationAborted=replicationAborted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolFreeSizeLow=poolFreeSizeLow, poolDeletionFailed=poolDeletionFailed, shareCIFSEnabled=shareCIFSEnabled, lunSizeLow=lunSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, projectLunCount=projectLunCount, iscsiTargetError=iscsiTargetError, notificationReadingTriggerValue=notificationReadingTriggerValue, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolMetaWriteMbps=poolMetaWriteMbps, poolUsedSizeLow=poolUsedSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, lunBlockSize=lunBlockSize, tegileArray_notifications=tegileArray_notifications, aclMigrationCompleted=aclMigrationCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTable=poolTable, lunInitiatorGroup=lunInitiatorGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, fcInitiatorIndex=fcInitiatorIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunReadMbps=lunReadMbps, nicName=nicName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetEntry=fcTargetEntry, lunTargetGroup=lunTargetGroup, projectTotalSaving=projectTotalSaving, ipmiTemperature=ipmiTemperature, globalStatistics=globalStatistics, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolHealth=poolHealth, tegile=tegile, fcTotalWriteIops=fcTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, shareIndex=shareIndex, haResourcesTable=haResourcesTable, poolDegraded=poolDegraded, haResourceIndex=haResourceIndex, iscsiTargetGroup=iscsiTargetGroup, haControllerB_Uptime=haControllerB_Uptime, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareCIFSReadLatency=shareCIFSReadLatency, maintenanceModeEnabled=maintenanceModeEnabled, fcTargetModifyCompleted=fcTargetModifyCompleted, diskTable=diskTable, shareDeletionFailed=shareDeletionFailed, controllerDown=controllerDown, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiVoltage=ipmiVoltage, haResourceGroup=haResourceGroup, cacheSSDReads=cacheSSDReads, iscsiInitiatorEntry=iscsiInitiatorEntry, lunProtocol=lunProtocol, iscsiTargetReadMbps=iscsiTargetReadMbps, lunCompressionEnabled=lunCompressionEnabled, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcPortOffline=fcPortOffline, networkInterfaceUp=networkInterfaceUp, cpuSystemCalls=cpuSystemCalls, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, cifsTotalWriteIops=cifsTotalWriteIops, lunGUID=lunGUID, projectShareCount=projectShareCount, notificationObjects=notificationObjects, iscsiInitiatorsTable=iscsiInitiatorsTable, diskTotalWriteIops=diskTotalWriteIops, shareTable=shareTable, projectDataSizeHigh=projectDataSizeHigh, poolDataReadLatency=poolDataReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSensorAction=notificationSensorAction, fcTargets=fcTargets, snmpServiceStopFailed=snmpServiceStopFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetsTable=fcTargetsTable, poolMetaReadLatency=poolMetaReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetsTable=iscsiTargetsTable, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiatorName=iscsiInitiatorName, controllerUp=controllerUp, projectTable=projectTable, shareExceedThresholdWarning=shareExceedThresholdWarning, poolImported=poolImported, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cacheRAMReads=cacheRAMReads, shareDedupEnabled=shareDedupEnabled, diskDataWriteMbps=diskDataWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, replicationAbandoned=replicationAbandoned, fcTotalReadMbps=fcTotalReadMbps, haResourceName=haResourceName, tegileCompliances=tegileCompliances, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunReadIops=lunReadIops, iscsiTargetIndex=iscsiTargetIndex, lunDedupEnabled=lunDedupEnabled, poolCreated=poolCreated, fcInitiatorEntry=fcInitiatorEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, upgradeStarted=upgradeStarted, basicCompliance=basicCompliance, diskSizeLow=diskSizeLow, poolCount=poolCount, poolReadCacheReadIops=poolReadCacheReadIops, snapshotRollbackFailed=snapshotRollbackFailed, shareQuotaHigh=shareQuotaHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeTimeout=upgradeTimeout, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, currentObjectGroup=currentObjectGroup, poolTotalReadMbps=poolTotalReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataSizeHigh=poolDataSizeHigh, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetName=iscsiTargetName, nicTable=nicTable, shareName=shareName, tegileConformance=tegileConformance, poolDataReadMbps=poolDataReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiPowerSupply=ipmiPowerSupply, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, haResourceDescription=haResourceDescription, ipmiOther=ipmiOther, nfsTotalReadIops=nfsTotalReadIops, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaReadIops=poolMetaReadIops, diskSlowIo=diskSlowIo, poolState=poolState, poolExpanded=poolExpanded, properties=properties, poolDataReadIops=poolDataReadIops, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetReadLatency=fcTargetReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareProjectName=shareProjectName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, network=network, diskDataReadIops=diskDataReadIops, fcAvgWriteLatency=fcAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, volumeModifyCompleted=volumeModifyCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiThreshold=ipmiThreshold, cifsTotalReadMbps=cifsTotalReadMbps, poolProjectCount=poolProjectCount, lunWriteIops=lunWriteIops, poolUpgraded=poolUpgraded, diskAvgReadLatency=diskAvgReadLatency, notificationDescription=notificationDescription, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolIndex=poolIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, cacheTotalReadMbps=cacheTotalReadMbps, shareReservedSizeLow=shareReservedSizeLow)
