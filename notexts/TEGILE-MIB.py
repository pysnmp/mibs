...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:00:23 2021
...
ObjectIdentity, Bits, Counter64, Unsigned32, NotificationType, Integer32, enterprises, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Gauge32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Counter64", "Unsigned32", "NotificationType", "Integer32", "enterprises", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Gauge32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetReadIops=iscsiTargetReadIops, fcTargetWriteMbps=fcTargetWriteMbps, replicationFailed=replicationFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, nicMTU=nicMTU, ipmiVoltage=ipmiVoltage, poolTotalWriteMbps=poolTotalWriteMbps, diskRandomIOCount=diskRandomIOCount, shareTable=shareTable, diskDataWriteMbps=diskDataWriteMbps, poolExpanded=poolExpanded, tdpsUpgradeFailed=tdpsUpgradeFailed, aclMigrationCompleted=aclMigrationCompleted, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheReadMbps=poolReadCacheReadMbps, shareQuotaHigh=shareQuotaHigh, tegile=tegile, shareDataSizeHigh=shareDataSizeHigh, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, unknownSensorEvent=unknownSensorEvent, shareProjectName=shareProjectName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunReadLatency=lunReadLatency, diskCount=diskCount, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haResourceDescription=haResourceDescription, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheRAMReads=cacheRAMReads, poolSizeHigh=poolSizeHigh, lunInitiatorGroup=lunInitiatorGroup, shareCIFSEnabled=shareCIFSEnabled, shareIndex=shareIndex, fcAvgReadLatency=fcAvgReadLatency, poolDataSizeHigh=poolDataSizeHigh, smisServiceStopFailed=smisServiceStopFailed, notificationEventCode=notificationEventCode, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectTotalSaving=projectTotalSaving, fcTargetGroup=fcTargetGroup, projectFreeSizeLow=projectFreeSizeLow, lunSizeHigh=lunSizeHigh, fcTargetReadIops=fcTargetReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, pools=pools, haControllerB_Uptime=haControllerB_Uptime, lunDataSizeHigh=lunDataSizeHigh, smisServiceStopped=smisServiceStopped, sanProperties=sanProperties, nicIndex=nicIndex, maintenanceModeDisabled=maintenanceModeDisabled, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotCloneCompleted=snapshotCloneCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolDeleted=poolDeleted, poolMetaReadLatency=poolMetaReadLatency, poolTotalWriteIops=poolTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, smbSocketFailure=smbSocketFailure, userLoginFailed=userLoginFailed, poolFreeSizeHigh=poolFreeSizeHigh, currentNotificationGroup=currentNotificationGroup, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, deleteFolderFailed=deleteFolderFailed, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunPoolName=lunPoolName, cifsAvgReadLatency=cifsAvgReadLatency, iscsiTargetIndex=iscsiTargetIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunIndex=lunIndex, shareNFSReadMbps=shareNFSReadMbps, nvdimmFailSoftError=nvdimmFailSoftError, poolName=poolName, lunGUID=lunGUID, lunFreeSizeLow=lunFreeSizeLow, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetWriteLatency=fcTargetWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareCIFSWriteIops=shareCIFSWriteIops, tegileArray_notifications=tegileArray_notifications, tegileArray=tegileArray, projectDeleted=projectDeleted, nicGroup=nicGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotCreationFailed=snapshotCreationFailed, volumeDeleteFailed=volumeDeleteFailed, projectName=projectName, poolProjectCount=poolProjectCount, poolReadCacheReadLatency=poolReadCacheReadLatency, lunBlockSize=lunBlockSize, basicCompliance=basicCompliance, replicationAborted=replicationAborted, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cifsTotalReadMbps=cifsTotalReadMbps, sharePoolName=sharePoolName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunDataSizeLow=lunDataSizeLow, cacheSSDReads=cacheSSDReads, iscsiTargets=iscsiTargets, diskSlowIo=diskSlowIo, nicReceiveMbps=nicReceiveMbps, diskDataReadIops=diskDataReadIops, poolTotalSaving=poolTotalSaving, networkIpmpGroupDown=networkIpmpGroupDown, alertsCleanupCompleted=alertsCleanupCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, poolMetaWriteIops=poolMetaWriteIops, shareQuotaFinished=shareQuotaFinished, projectShares=projectShares, notificationDescription=notificationDescription, lunSnapshotSizeLow=lunSnapshotSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataReadMbps=poolDataReadMbps, fcTargetStatus=fcTargetStatus, poolDataReadIops=poolDataReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, notificationTime=notificationTime, poolUpgraded=poolUpgraded, diskIOCount=diskIOCount, fcAvgWriteLatency=fcAvgWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, controllerUp=controllerUp, poolQuotaFinished=poolQuotaFinished, haControllerA_Uptime=haControllerA_Uptime, diskTotalWriteMbps=diskTotalWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectModified=projectModified, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiators=iscsiInitiators, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolHealth=poolHealth, diskTable=diskTable, upgradeCompleted=upgradeCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, diskDataWriteIops=diskDataWriteIops, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorsTable=iscsiInitiatorsTable, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetWriteIops=iscsiTargetWriteIops, projectIndex=projectIndex, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunTable=lunTable, haControllerB_IPAddr=haControllerB_IPAddr, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nicEntry=nicEntry, iscsiProperties=iscsiProperties, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationProps=notificationProps, lunReadIops=lunReadIops, poolAvgWriteLatency=poolAvgWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectTable=projectTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, replicationStarted=replicationStarted, globalStatistics=globalStatistics, shareDataSizeLow=shareDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, diskPoolName=diskPoolName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolCount=poolCount, lunWriteIops=lunWriteIops, lunCompressionEnabled=lunCompressionEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolDataWriteLatency=poolDataWriteLatency, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareNFSReadIops=shareNFSReadIops, nicTable=nicTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareName=shareName, shareCompressedRatio=shareCompressedRatio, maintenanceModeEnabled=maintenanceModeEnabled, diskEntry=diskEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcProperties=fcProperties, cpuTotalUsage=cpuTotalUsage, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, PYSNMP_MODULE_ID=tegile, lunProtocol=lunProtocol, shareNFSWriteIops=shareNFSWriteIops, diskType=diskType, fcTargetWriteIops=fcTargetWriteIops, currentObjectGroup=currentObjectGroup, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, replicationResumed=replicationResumed, shareReservedSizeLow=shareReservedSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, lunReservedSizeLow=lunReservedSizeLow, network=network, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicTransmitMbps=nicTransmitMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareQuotaLow=shareQuotaLow, haResourceStatus=haResourceStatus, poolReadCacheWriteIops=poolReadCacheWriteIops, poolTotalReadIops=poolTotalReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolUsedSizeLow=poolUsedSizeLow, sensorFailureEvent=sensorFailureEvent, shareNFSReadLatency=shareNFSReadLatency, poolImported=poolImported, projectLUNs=projectLUNs, snapshotCloningFailed=snapshotCloningFailed, ipmiMemory=ipmiMemory, poolTable=poolTable, diskIsOnline=diskIsOnline, aclMigrationStarted=aclMigrationStarted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, projectLunCount=projectLunCount, shareCIFSWriteMbps=shareCIFSWriteMbps, diskIndex=diskIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, poolDataWriteIops=poolDataWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskChassisIdx=diskChassisIdx, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationSensorAction=notificationSensorAction, haResourceGroup=haResourceGroup, shareCIFSReadIops=shareCIFSReadIops, fcPortOnline=fcPortOnline, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetAuth=iscsiTargetAuth, projectDataSizeLow=projectDataSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", cpuSystemCalls=cpuSystemCalls, diskSizeLow=diskSizeLow, adServerTimeDrift=adServerTimeDrift, shareDedupEnabled=shareDedupEnabled, fcTargetsTable=fcTargetsTable, notificationReadingTriggerValue=notificationReadingTriggerValue, targetGroupMemberAdded=targetGroupMemberAdded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorNumber=notificationSensorNumber, cifsAvgWriteLatency=cifsAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationSourceRegistered=replicationSourceRegistered, diskSizeHigh=diskSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolDataReadLatency=poolDataReadLatency, iscsiTargetError=iscsiTargetError, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tegileCompliances=tegileCompliances, poolUsedSizeHigh=poolUsedSizeHigh, testNotification=testNotification, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetEntry=iscsiTargetEntry, diskAvgReadLatency=diskAvgReadLatency, diskTotalWriteIops=diskTotalWriteIops, haResources=haResources, haResourceIndex=haResourceIndex, haControllerA_Name=haControllerA_Name, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunName=lunName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeTimeout=upgradeTimeout, projectPoolName=projectPoolName, smisServiceStarted=smisServiceStarted, fcTargetName=fcTargetName, notificationObjects=notificationObjects, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, networkInterfaceUp=networkInterfaceUp, ipmiPowerSupply=ipmiPowerSupply, projectQuotaFinished=projectQuotaFinished, networkTotalReceiveMbps=networkTotalReceiveMbps, projectShareCount=projectShareCount, fcTargetReadLatency=fcTargetReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTotalWriteIops=fcTotalWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetAlias=iscsiTargetAlias, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snmpAgentVersion=snmpAgentVersion, snmpServiceStarted=snmpServiceStarted, poolOwnerController=poolOwnerController, poolCreated=poolCreated, poolMetaWriteMbps=poolMetaWriteMbps, volumeQuotaFinished=volumeQuotaFinished, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunProjectName=lunProjectName, fcTotalReadMbps=fcTotalReadMbps, nicName=nicName, nfsTotalReadMbps=nfsTotalReadMbps, projectDeletionFailed=projectDeletionFailed, poolExported=poolExported, shareNFSWriteMbps=shareNFSWriteMbps, ipmiOther=ipmiOther, spareDiskReplaced=spareDiskReplaced, poolProjects=poolProjects, cifsTotalWriteIops=cifsTotalWriteIops, deleteFolderCompleted=deleteFolderCompleted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationComplete=replicationComplete, haResourceEntry=haResourceEntry, poolState=poolState, smisServiceStartFailed=smisServiceStartFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorsTable=fcInitiatorsTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetsTable=iscsiTargetsTable, replicationPaused=replicationPaused, iscsiTargetGroup=iscsiTargetGroup, controllerHardwareModel=controllerHardwareModel, upgradeDownloadCompleted=upgradeDownloadCompleted, lunTargetGroup=lunTargetGroup, poolFreeSizeLow=poolFreeSizeLow, poolMetaReadMbps=poolMetaReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, poolSizeLow=poolSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunEntry=lunEntry, networkInterfaceDown=networkInterfaceDown, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiatorName=fcInitiatorName, snmpServiceStartFailed=snmpServiceStartFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcInitiatorGroup=fcInitiatorGroup, projectEntry=projectEntry, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunWriteMbps=lunWriteMbps, shareEntry=shareEntry, nfsTotalWriteIops=nfsTotalWriteIops, memoryFailure=memoryFailure, ipmiTemperature=ipmiTemperature, diskTotalReadIops=diskTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolTotalReadMbps=poolTotalReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskState=diskState, fcPortOffline=fcPortOffline, netbiosSocketFailure=netbiosSocketFailure, diskSequentialIOCount=diskSequentialIOCount, diskError=diskError, fcTotalWriteMbps=fcTotalWriteMbps, cacheTotalReadIops=cacheTotalReadIops, poolDataWriteMbps=poolDataWriteMbps, diskAlias=diskAlias, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareNFSEnabled=shareNFSEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareDeletionFailed=shareDeletionFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, disks=disks, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeStarted=upgradeStarted, vmwareNFSDatastores=vmwareNFSDatastores, haResourceName=haResourceName, snmpServiceStopped=snmpServiceStopped, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cifsTotalReadIops=cifsTotalReadIops, volumeModifyCompleted=volumeModifyCompleted, notificationReadingUnit=notificationReadingUnit, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, projectDedupEnabled=projectDedupEnabled, controllerDown=controllerDown, nvdimmFailInitializationError=nvdimmFailInitializationError, haResourcesTable=haResourcesTable, poolDegraded=poolDegraded, snapshotRollbackFailed=snapshotRollbackFailed, shareCIFSReadLatency=shareCIFSReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiCurrent=ipmiCurrent, iscsiInitiatorEntry=iscsiInitiatorEntry, haControllerA_IPAddr=haControllerA_IPAddr, controllerTimeDrift=controllerTimeDrift, haControllerB_Name=haControllerB_Name, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationComponentName=notificationComponentName, upgradeFailed=upgradeFailed, ipmiThreshold=ipmiThreshold, iscsiInitiatorName=iscsiInitiatorName, shareMountPoint=shareMountPoint, poolEntry=poolEntry, poolDataSizeLow=poolDataSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareDeleted=shareDeleted, replicationAbandoned=replicationAbandoned, notifications=notifications, fcInitiators=fcInitiators, ntpServerTimeDrift=ntpServerTimeDrift, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargets=fcTargets, tegileConformance=tegileConformance, poolDeletionFailed=poolDeletionFailed, fcTargetEntry=fcTargetEntry, fcInitiatorEntry=fcInitiatorEntry, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsTotalWriteMbps=nfsTotalWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, lunReadMbps=lunReadMbps, nfsTotalReadIops=nfsTotalReadIops, lunWriteLatency=lunWriteLatency, tegileGroups=tegileGroups, fcTargetIndex=fcTargetIndex, ipmiFan=ipmiFan, networkIpmpGroupUp=networkIpmpGroupUp, diskDataReadMbps=diskDataReadMbps, notificationSeverity=notificationSeverity, properties=properties, nicState=nicState, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetName=iscsiTargetName, cpuInterrupts=cpuInterrupts, lunSizeLow=lunSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, lunDedupEnabled=lunDedupEnabled, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, poolIndex=poolIndex)
