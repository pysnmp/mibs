...
IpAddress, ObjectIdentity, Unsigned32, iso, NotificationType, Integer32, Counter64, Counter32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Unsigned32", "iso", "NotificationType", "Integer32", "Counter64", "Counter32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", volumeModifyCompleted=volumeModifyCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ipmiCurrent=ipmiCurrent, basicCompliance=basicCompliance, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareTable=shareTable, diskError=diskError, iscsiTotalReadIops=iscsiTotalReadIops, snapshotDeleteFailed=snapshotDeleteFailed, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationTargetDeleted=replicationTargetDeleted, lunCompressionEnabled=lunCompressionEnabled, cacheTotalWriteIops=cacheTotalWriteIops, fcInitiatorGroup=fcInitiatorGroup, projectDeletionFailed=projectDeletionFailed, projectName=projectName, haControllerB_Name=haControllerB_Name, lunSizeHigh=lunSizeHigh, haResourceEntry=haResourceEntry, lunName=lunName, lunDataSizeLow=lunDataSizeLow, volumeDeleteFailed=volumeDeleteFailed, haControllerA_Name=haControllerA_Name, poolMetaWriteIops=poolMetaWriteIops, nicReceiveMbps=nicReceiveMbps, replicationFailed=replicationFailed, poolDataSizeHigh=poolDataSizeHigh, haControllerB_Uptime=haControllerB_Uptime, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, userLoginFailed=userLoginFailed, networkIpmpGroupDown=networkIpmpGroupDown, lunCompressedRatio=lunCompressedRatio, lunSizeLow=lunSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, controllerUp=controllerUp, fcTargetWriteLatency=fcTargetWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorEntry=fcInitiatorEntry, snmpServiceStartFailed=snmpServiceStartFailed, projectIndex=projectIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationSensorAction=notificationSensorAction, tdpsUpgradeCompleted=tdpsUpgradeCompleted, ipmiPowerSupply=ipmiPowerSupply, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunGUID=lunGUID, fcTargetStatus=fcTargetStatus, poolProjectCount=poolProjectCount, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetsTable=iscsiTargetsTable, diskAvgWriteLatency=diskAvgWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, projectCompressionEnabled=projectCompressionEnabled, poolTotalWriteMbps=poolTotalWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cacheRAMReads=cacheRAMReads, fcPortOnline=fcPortOnline, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunInitiatorGroup=lunInitiatorGroup, diskAvgReadLatency=diskAvgReadLatency, cacheSSDReads=cacheSSDReads, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorIndex=fcInitiatorIndex, haResourcesTable=haResourcesTable, upgradeTimeout=upgradeTimeout, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tegileArray=tegileArray, poolTotalReadIops=poolTotalReadIops, diskDataWriteIops=diskDataWriteIops, projectQuotaFinished=projectQuotaFinished, replicationStarted=replicationStarted, nicGroup=nicGroup, nicTable=nicTable, diskDataWriteMbps=diskDataWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataWriteLatency=poolDataWriteLatency, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nfsTotalReadIops=nfsTotalReadIops, replicationComplete=replicationComplete, iscsiTargetAlias=iscsiTargetAlias, aclMigrationStarted=aclMigrationStarted, snapshotCreationFailed=snapshotCreationFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, ipmiThreshold=ipmiThreshold, cifsAvgReadLatency=cifsAvgReadLatency, currentNotificationGroup=currentNotificationGroup, shareCompressionEnabled=shareCompressionEnabled, poolDataSizeLow=poolDataSizeLow, poolUsedSizeLow=poolUsedSizeLow, snmpServiceStopped=snmpServiceStopped, notificationComponentName=notificationComponentName, diskSizeHigh=diskSizeHigh, shareQuotaHigh=shareQuotaHigh, haResourceDescription=haResourceDescription, shareReservedSizeLow=shareReservedSizeLow, network=network, diskTable=diskTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, ipmiFan=ipmiFan, notificationProps=notificationProps, projectLunCount=projectLunCount, snmpServiceStopFailed=snmpServiceStopFailed, projectPoolName=projectPoolName, poolUpgraded=poolUpgraded, lunDedupEnabled=lunDedupEnabled, tegileCompliances=tegileCompliances, currentObjectGroup=currentObjectGroup, poolReadCacheReadLatency=poolReadCacheReadLatency, lunDataSizeHigh=lunDataSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nicState=nicState, projectDataSizeLow=projectDataSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectDeleted=projectDeleted, diskDataReadMbps=diskDataReadMbps, notificationTime=notificationTime, diskSizeLow=diskSizeLow, deleteFolderFailed=deleteFolderFailed, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetAuth=iscsiTargetAuth, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectLUNs=projectLUNs, replicationAborted=replicationAborted, poolHealth=poolHealth, poolExported=poolExported, diskSequentialIOCount=diskSequentialIOCount, notificationObjects=notificationObjects, cacheTotalReadMbps=cacheTotalReadMbps, diskIsOnline=diskIsOnline, fcTotalReadIops=fcTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, lunWriteLatency=lunWriteLatency, poolFreeSizeLow=poolFreeSizeLow, shareDedupEnabled=shareDedupEnabled, projectModified=projectModified, fcPortOffline=fcPortOffline, poolAvgReadLatency=poolAvgReadLatency, shareCIFSEnabled=shareCIFSEnabled, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectDedupEnabled=projectDedupEnabled, poolDataReadIops=poolDataReadIops, lunReservedSizeHigh=lunReservedSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, upgradeDownloadCompleted=upgradeDownloadCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haControllerB_IPAddr=haControllerB_IPAddr, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareDeletionFailed=shareDeletionFailed, maintenanceModeEnabled=maintenanceModeEnabled, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationTargetEntityName=notificationTargetEntityName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetReadMbps=fcTargetReadMbps, tegileConformance=tegileConformance, iscsiTargetReadIops=iscsiTargetReadIops, shareIndex=shareIndex, shareQuotaFinished=shareQuotaFinished, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastores=vmwareNFSDatastores, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiWriteIops=iscsiWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolSizeLow=poolSizeLow, haResourceGroup=haResourceGroup, poolExpanded=poolExpanded, diskDataReadIops=diskDataReadIops, sharePoolName=sharePoolName, shareMountPoint=shareMountPoint, poolAvgWriteLatency=poolAvgWriteLatency, poolDataWriteMbps=poolDataWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, lunProtocol=lunProtocol, projectShares=projectShares, notifications=notifications, diskEntry=diskEntry, projectEntry=projectEntry, poolCount=poolCount, haResourceActiveNode=haResourceActiveNode, iscsiInitiatorsTable=iscsiInitiatorsTable, lunTable=lunTable, iscsiTargetIndex=iscsiTargetIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectFreeSizeLow=projectFreeSizeLow, replicationResumed=replicationResumed, iscsiInitiatorEntry=iscsiInitiatorEntry, ntpServerTimeDrift=ntpServerTimeDrift, poolTable=poolTable, shareDataSizeHigh=shareDataSizeHigh, memoryFailure=memoryFailure, diskTotalWriteIops=diskTotalWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalWriteIops=poolTotalWriteIops, fcTargets=fcTargets, iscsiInitiators=iscsiInitiators, diskIndex=diskIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicMTU=nicMTU, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSWriteLatency=shareNFSWriteLatency, pools=pools, poolState=poolState, lunBlockSize=lunBlockSize, tegileArray_notifications=tegileArray_notifications, controllerDown=controllerDown, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, disks=disks, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, fcProperties=fcProperties, fcTotalReadMbps=fcTotalReadMbps, ipmiVoltage=ipmiVoltage, networkIpmpGroupUp=networkIpmpGroupUp, networkTotalReceiveMbps=networkTotalReceiveMbps, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareEntry=shareEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, poolQuotaFinished=poolQuotaFinished, lunReadMbps=lunReadMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, volumeQuotaFinished=volumeQuotaFinished)
mibBuilder.exportSymbols("TEGILE-MIB", haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTargetGroup=fcTargetGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, networkInterfaceUp=networkInterfaceUp, diskIOCount=diskIOCount, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, PYSNMP_MODULE_ID=tegile, shareNFSReadMbps=shareNFSReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, unknownSensorEvent=unknownSensorEvent, poolMetaWriteMbps=poolMetaWriteMbps, poolEntry=poolEntry, shareCompressedRatio=shareCompressedRatio, shareNFSEnabled=shareNFSEnabled, projectTotalSaving=projectTotalSaving, poolDegraded=poolDegraded, smisServiceStopped=smisServiceStopped, projectSnapshotSizeLow=projectSnapshotSizeLow, diskAlias=diskAlias, lunReadLatency=lunReadLatency, fcTargetsTable=fcTargetsTable, poolProjects=poolProjects, diskCount=diskCount, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, upgradeFailed=upgradeFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, diskTotalReadMbps=diskTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiMemory=ipmiMemory, iscsiInitiatorIndex=iscsiInitiatorIndex, cpuInterrupts=cpuInterrupts, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeDownloadStarted=upgradeDownloadStarted, projectFreeSizeHigh=projectFreeSizeHigh, poolDataReadLatency=poolDataReadLatency, haResourceName=haResourceName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, fcTargetEntry=fcTargetEntry, fcTotalWriteMbps=fcTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTargetError=iscsiTargetError, shareCIFSReadIops=shareCIFSReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, nicEntry=nicEntry, lunReservedSizeLow=lunReservedSizeLow, fcTargetIndex=fcTargetIndex, lunReadIops=lunReadIops, cacheTotalReadIops=cacheTotalReadIops, poolMetaReadLatency=poolMetaReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, netbiosSocketFailure=netbiosSocketFailure, notificationReadingTriggerValue=notificationReadingTriggerValue, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetReadIops=fcTargetReadIops, poolTotalSaving=poolTotalSaving, replicationPaused=replicationPaused, controllerTimeDrift=controllerTimeDrift, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolTotalReadMbps=poolTotalReadMbps, notificationEventCode=notificationEventCode, fcInitiatorsTable=fcInitiatorsTable, poolDeletionFailed=poolDeletionFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, notificationReadingUnit=notificationReadingUnit, fcTargetWriteMbps=fcTargetWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorName=iscsiInitiatorName, smisServiceStopFailed=smisServiceStopFailed, diskChassisIdx=diskChassisIdx, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCIFSReadLatency=shareCIFSReadLatency, snapshotCloningFailed=snapshotCloningFailed, poolDataReadMbps=poolDataReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiTargetName=iscsiTargetName, shareCIFSReadMbps=shareCIFSReadMbps, smisServiceStartFailed=smisServiceStartFailed, iscsiProperties=iscsiProperties, tegile=tegile, poolReadCacheWriteIops=poolReadCacheWriteIops, ipmiTemperature=ipmiTemperature, shareNFSReadLatency=shareNFSReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, poolImported=poolImported, poolIndex=poolIndex, poolOwnerController=poolOwnerController, iscsiTargets=iscsiTargets, notificationSensorSuspect=notificationSensorSuspect, shareDeleted=shareDeleted, fcTargetName=fcTargetName, shareCIFSWriteIops=shareCIFSWriteIops, properties=properties, cpuTotalUsage=cpuTotalUsage, poolMetaReadIops=poolMetaReadIops, upgradeCompleted=upgradeCompleted, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolName=poolName, lunEntry=lunEntry, poolDeleted=poolDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, cifsTotalWriteIops=cifsTotalWriteIops, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetEntry=iscsiTargetEntry, shareQuotaLow=shareQuotaLow, diskState=diskState, fcInitiators=fcInitiators, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cpuSystemCalls=cpuSystemCalls, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolMetaWriteLatency=poolMetaWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, diskTotalReadIops=diskTotalReadIops, shareName=shareName, tegileGroups=tegileGroups, poolUsedSizeHigh=poolUsedSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareProjectName=shareProjectName, maintenanceModeDisabled=maintenanceModeDisabled, haResourceStatus=haResourceStatus, diskSlowIo=diskSlowIo, lunProjectName=lunProjectName, fcTotalWriteIops=fcTotalWriteIops, poolCreated=poolCreated, haResourceIndex=haResourceIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, nicTransmitMbps=nicTransmitMbps, nicIndex=nicIndex, diskGoneOffline=diskGoneOffline, poolFreeSizeHigh=poolFreeSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunPoolName=lunPoolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetReadLatency=fcTargetReadLatency, projectShareCount=projectShareCount, upgradeDownloadFailed=upgradeDownloadFailed, globalStatistics=globalStatistics, nfsAvgWriteLatency=nfsAvgWriteLatency, haResources=haResources, lunWriteIops=lunWriteIops, testNotification=testNotification, shareDataSizeLow=shareDataSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeFailed=tdpsUpgradeFailed, deleteFolderCompleted=deleteFolderCompleted, lunIndex=lunIndex, projectDataSizeHigh=projectDataSizeHigh, notificationSeverity=notificationSeverity, ipmiOther=ipmiOther, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetReadMbps=iscsiTargetReadMbps, snmpServiceStarted=snmpServiceStarted, notificationDescription=notificationDescription, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, replicationAbandoned=replicationAbandoned, lunTargetGroup=lunTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, aclMigrationCompleted=aclMigrationCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, fcAvgReadLatency=fcAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smbSocketFailure=smbSocketFailure, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolMetaReadMbps=poolMetaReadMbps, projectTable=projectTable, alertsCleanupCompleted=alertsCleanupCompleted, fcInitiatorName=fcInitiatorName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, spareDiskReplaced=spareDiskReplaced, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareNFSWriteIops=shareNFSWriteIops, sanProperties=sanProperties, controllerHardwareModel=controllerHardwareModel, lunWriteMbps=lunWriteMbps, diskType=diskType, nicName=nicName, upgradeStarted=upgradeStarted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskPoolName=diskPoolName)
