...
Integer32, enterprises, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, ObjectIdentity, iso, MibIdentifier, ModuleIdentity, NotificationType, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, globalStatistics=globalStatistics, poolMetaWriteLatency=poolMetaWriteLatency, poolProjectCount=poolProjectCount, haResourceStatus=haResourceStatus, replicationComplete=replicationComplete, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolExpanded=poolExpanded, adServerTimeDrift=adServerTimeDrift, PYSNMP_MODULE_ID=tegile, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notificationSensorNumber=notificationSensorNumber, projectName=projectName, upgradeDownloadFailed=upgradeDownloadFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetName=fcTargetName, poolDataReadLatency=poolDataReadLatency, diskSizeLow=diskSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, tegileArray=tegileArray, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tegileArray_notifications=tegileArray_notifications, diskTotalReadMbps=diskTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskRandomIOCount=diskRandomIOCount, targetGroupMemberRemoved=targetGroupMemberRemoved, lunIndex=lunIndex, tegileCompliances=tegileCompliances, notificationComponentName=notificationComponentName, deleteFolderCompleted=deleteFolderCompleted, lunWriteMbps=lunWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, nvdimmFailSoftError=nvdimmFailSoftError, shareTable=shareTable, projectDataSizeHigh=projectDataSizeHigh, shareDataSizeLow=shareDataSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, diskDataWriteMbps=diskDataWriteMbps, tegile=tegile, nicState=nicState, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunEntry=lunEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, projectModified=projectModified, shareNFSWriteIops=shareNFSWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDeletionFailed=poolDeletionFailed, lunDataSizeLow=lunDataSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, haControllerB_Uptime=haControllerB_Uptime, poolDataWriteLatency=poolDataWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolSizeHigh=poolSizeHigh, iscsiProperties=iscsiProperties, poolMetaReadLatency=poolMetaReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, haResourceIndex=haResourceIndex, iscsiTargetGroup=iscsiTargetGroup, deleteFolderFailed=deleteFolderFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, poolProjects=poolProjects, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snmpServiceStartFailed=snmpServiceStartFailed, ipmiThreshold=ipmiThreshold, networkTotalTransmitMbps=networkTotalTransmitMbps, poolImported=poolImported, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeStarted=upgradeStarted, fcTargets=fcTargets, lunFreeSizeLow=lunFreeSizeLow, fcInitiatorName=fcInitiatorName, replicationResumed=replicationResumed, currentNotificationGroup=currentNotificationGroup, basicCompliance=basicCompliance, volumeDeleteFailed=volumeDeleteFailed, projectLUNs=projectLUNs, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ipmiVoltage=ipmiVoltage, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorName=iscsiInitiatorName, snmpServiceStopped=snmpServiceStopped, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haControllerB_Name=haControllerB_Name, webdocsUpgradeFailed=webdocsUpgradeFailed, snmpServiceStarted=snmpServiceStarted, properties=properties, haResourceActiveNode=haResourceActiveNode, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiWriteIops=iscsiWriteIops, snmpAgentVersion=snmpAgentVersion, poolAvgReadLatency=poolAvgReadLatency, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, notificationSensorAction=notificationSensorAction, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolAvgWriteLatency=poolAvgWriteLatency, userLoginFailed=userLoginFailed, projectDedupEnabled=projectDedupEnabled, lunCompressionEnabled=lunCompressionEnabled, lunGUID=lunGUID, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTargetStatus=fcTargetStatus, tdpsUpgradeFailed=tdpsUpgradeFailed, smisServiceStopFailed=smisServiceStopFailed, projectEntry=projectEntry, poolSizeLow=poolSizeLow, poolQuotaFinished=poolQuotaFinished, nfsTotalReadMbps=nfsTotalReadMbps, snapshotCloningFailed=snapshotCloningFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcInitiators=fcInitiators, networkInterfaceUp=networkInterfaceUp, haResources=haResources, currentObjectGroup=currentObjectGroup, fcProperties=fcProperties, upgradeTimeout=upgradeTimeout, diskIsOnline=diskIsOnline, shareProjectName=shareProjectName, diskCount=diskCount, targetGroupCreateCompleted=targetGroupCreateCompleted, lunTable=lunTable, poolTotalReadIops=poolTotalReadIops, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tegileGroups=tegileGroups, replicationFailed=replicationFailed, volumeQuotaFinished=volumeQuotaFinished, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, ipmiOther=ipmiOther, cifsTotalWriteMbps=cifsTotalWriteMbps, poolMetaReadMbps=poolMetaReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetGroup=fcTargetGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDeleted=poolDeleted, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastores=vmwareNFSDatastores, lunReadIops=lunReadIops, pools=pools, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectShares=projectShares, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationPaused=replicationPaused, fcPortOnline=fcPortOnline, nfsTotalWriteMbps=nfsTotalWriteMbps, lunTargetGroup=lunTargetGroup, shareCIFSEnabled=shareCIFSEnabled, smbSocketFailure=smbSocketFailure, diskError=diskError, shareNFSReadIops=shareNFSReadIops, diskGoneOffline=diskGoneOffline, diskChassisIdx=diskChassisIdx, poolDegraded=poolDegraded, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunPoolName=lunPoolName, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunCompressedRatio=lunCompressedRatio, shareCIFSReadIops=shareCIFSReadIops, memoryFailure=memoryFailure, shareEntry=shareEntry, diskIOCount=diskIOCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicIndex=nicIndex, poolExported=poolExported, replicationStarted=replicationStarted, projectDataSizeLow=projectDataSizeLow, shareNFSReadMbps=shareNFSReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationTime=notificationTime, cifsAvgWriteLatency=cifsAvgWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nicTable=nicTable, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalReadIops=nfsTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, testNotification=testNotification, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareQuotaLow=shareQuotaLow, diskAlias=diskAlias, aclMigrationCompleted=aclMigrationCompleted, poolTable=poolTable, iscsiTargetsTable=iscsiTargetsTable, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiInitiators=iscsiInitiators, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, targetGroupMemberAdded=targetGroupMemberAdded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskState=diskState, diskDataReadIops=diskDataReadIops, diskType=diskType, iscsiTargetName=iscsiTargetName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, diskPoolName=diskPoolName, controllerHardwareModel=controllerHardwareModel, notificationTargetEntityName=notificationTargetEntityName, shareCIFSWriteIops=shareCIFSWriteIops, shareDeleted=shareDeleted, notificationSeverity=notificationSeverity, poolCount=poolCount, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetAlias=iscsiTargetAlias, snapshotCreationFailed=snapshotCreationFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareCompressedRatio=shareCompressedRatio, nicMTU=nicMTU, notificationDescription=notificationDescription, shareDedupEnabled=shareDedupEnabled, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, notificationReadingUnit=notificationReadingUnit, shareNFSWriteMbps=shareNFSWriteMbps, notificationEventCode=notificationEventCode, projectDeletionFailed=projectDeletionFailed, poolDataReadIops=poolDataReadIops, poolFreeSizeHigh=poolFreeSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetEntry=fcTargetEntry, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectShareCount=projectShareCount, nfsTotalWriteIops=nfsTotalWriteIops, haResourceName=haResourceName, shareNFSEnabled=shareNFSEnabled, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted)
mibBuilder.exportSymbols("TEGILE-MIB", snmpServiceStopFailed=snmpServiceStopFailed, fcInitiatorIndex=fcInitiatorIndex, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetAuth=iscsiTargetAuth, iscsiInitiatorEntry=iscsiInitiatorEntry, diskSlowIo=diskSlowIo, disks=disks, iscsiTotalReadIops=iscsiTotalReadIops, shareCompressionEnabled=shareCompressionEnabled, diskAvgWriteLatency=diskAvgWriteLatency, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiPowerSupply=ipmiPowerSupply, sensorFailureEvent=sensorFailureEvent, lunSizeHigh=lunSizeHigh, lunDedupEnabled=lunDedupEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, fcPortOffline=fcPortOffline, ipmiCurrent=ipmiCurrent, cacheTotalReadIops=cacheTotalReadIops, poolFreeSizeLow=poolFreeSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunWriteIops=lunWriteIops, ipmiTemperature=ipmiTemperature, shareCIFSReadLatency=shareCIFSReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, shareQuotaHigh=shareQuotaHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolHealth=poolHealth, volumeModifyCompleted=volumeModifyCompleted, haResourceGroup=haResourceGroup, fcTargetReadLatency=fcTargetReadLatency, notifications=notifications, fcTargetWriteLatency=fcTargetWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetIndex=iscsiTargetIndex, diskSizeHigh=diskSizeHigh, haResourcesTable=haResourcesTable, fcInitiatorsTable=fcInitiatorsTable, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerA_Uptime=haControllerA_Uptime, cpuSystemCalls=cpuSystemCalls, smisServiceStopped=smisServiceStopped, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationProps=notificationProps, cacheRAMReads=cacheRAMReads, fcTotalReadIops=fcTotalReadIops, networkIpmpGroupUp=networkIpmpGroupUp, lunFreeSizeHigh=lunFreeSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, lunReadMbps=lunReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTargetError=iscsiTargetError, projectCompressionEnabled=projectCompressionEnabled, poolReadCacheWriteLatency=poolReadCacheWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicTransmitMbps=nicTransmitMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, unknownSensorEvent=unknownSensorEvent, poolName=poolName, poolDataSizeLow=poolDataSizeLow, fcTargetWriteIops=fcTargetWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, ntpServerTimeDrift=ntpServerTimeDrift, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, projectIndex=projectIndex, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicEntry=nicEntry, controllerDown=controllerDown, iscsiTargetEntry=iscsiTargetEntry, aclMigrationStarted=aclMigrationStarted, iscsiTargets=iscsiTargets, notificationObjects=notificationObjects, fcTotalReadMbps=fcTotalReadMbps, haResourceEntry=haResourceEntry, poolMetaReadIops=poolMetaReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, cpuInterrupts=cpuInterrupts, lunSizeLow=lunSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolDataWriteIops=poolDataWriteIops, poolDataReadMbps=poolDataReadMbps, lunBlockSize=lunBlockSize, poolDataWriteMbps=poolDataWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, sanProperties=sanProperties, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunProtocol=lunProtocol, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunDataSizeHigh=lunDataSizeHigh, shareName=shareName, poolUsedSizeHigh=poolUsedSizeHigh, poolOwnerController=poolOwnerController, projectQuotaFinished=projectQuotaFinished, poolMetaWriteIops=poolMetaWriteIops, fcTargetIndex=fcTargetIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, poolDataSizeHigh=poolDataSizeHigh, smisServiceStartFailed=smisServiceStartFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, diskAvgReadLatency=diskAvgReadLatency, sharePoolName=sharePoolName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationTargetDeleted=replicationTargetDeleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetReadMbps=fcTargetReadMbps, controllerUp=controllerUp, projectDeleted=projectDeleted, network=network, poolReadCacheReadLatency=poolReadCacheReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, lunReadLatency=lunReadLatency, fcTargetsTable=fcTargetsTable, shareDataSizeHigh=shareDataSizeHigh, shareIndex=shareIndex, shareReservedSizeLow=shareReservedSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nicName=nicName, cpuTotalUsage=cpuTotalUsage, spareDiskReplaced=spareDiskReplaced, lunName=lunName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationAborted=replicationAborted, upgradeCompleted=upgradeCompleted, diskDataReadMbps=diskDataReadMbps, controllerTimeDrift=controllerTimeDrift, nicReceiveMbps=nicReceiveMbps, fcTargetReadIops=fcTargetReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, poolTotalWriteIops=poolTotalWriteIops, diskDataWriteIops=diskDataWriteIops, diskTable=diskTable, smisServiceStarted=smisServiceStarted, haControllerB_IPAddr=haControllerB_IPAddr, cacheSSDReads=cacheSSDReads, projectPoolName=projectPoolName, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcAvgWriteLatency=fcAvgWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, poolState=poolState, alertsCleanupCompleted=alertsCleanupCompleted, diskEntry=diskEntry, fcTotalWriteIops=fcTotalWriteIops, diskIndex=diskIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSReadLatency=shareNFSReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, cifsTotalReadIops=cifsTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolEntry=poolEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolCreated=poolCreated, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackFailed=snapshotRollbackFailed, projectTable=projectTable, haResourceDescription=haResourceDescription, poolUpgraded=poolUpgraded, upgradeDownloadStarted=upgradeDownloadStarted, upgradeFailed=upgradeFailed, lunWriteLatency=lunWriteLatency, netbiosSocketFailure=netbiosSocketFailure, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareMountPoint=shareMountPoint, tegileConformance=tegileConformance, iscsiInitiatorGroup=iscsiInitiatorGroup, shareNFSWriteLatency=shareNFSWriteLatency, shareQuotaFinished=shareQuotaFinished, iscsiTargetGroupError=iscsiTargetGroupError, nicGroup=nicGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, poolIndex=poolIndex, replicationSourceRegistered=replicationSourceRegistered, lunReservedSizeLow=lunReservedSizeLow, ipmiMemory=ipmiMemory, cifsTotalWriteIops=cifsTotalWriteIops, ipmiFan=ipmiFan, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcInitiatorGroup=fcInitiatorGroup, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetReadLatency=iscsiTargetReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunProjectName=lunProjectName, haControllerA_Name=haControllerA_Name, projectLunCount=projectLunCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted)
