...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, IpAddress, Gauge32, Bits, ObjectIdentity, MibIdentifier, Integer32, NotificationType, enterprises, ModuleIdentity, iso, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "IpAddress", "Gauge32", "Bits", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "enterprises", "ModuleIdentity", "iso", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskAvgReadLatency=diskAvgReadLatency, poolSizeHigh=poolSizeHigh, lunCompressedRatio=lunCompressedRatio, lunReadMbps=lunReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunWriteLatency=lunWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskAvgWriteLatency=diskAvgWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, disks=disks, snapshotCloningFailed=snapshotCloningFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetIndex=fcTargetIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunFreeSizeLow=lunFreeSizeLow, fcPortOnline=fcPortOnline, snapshotDeleteFailed=snapshotDeleteFailed, nicMTU=nicMTU, shareDedupEnabled=shareDedupEnabled, replicationAbandoned=replicationAbandoned, poolTotalReadIops=poolTotalReadIops, haResources=haResources, poolTotalWriteIops=poolTotalWriteIops, notificationComponentName=notificationComponentName, currentObjectGroup=currentObjectGroup, poolMetaWriteMbps=poolMetaWriteMbps, shareCompressionEnabled=shareCompressionEnabled, ipmiOther=ipmiOther, fcTargetReadIops=fcTargetReadIops, nicState=nicState, fcTargetGroup=fcTargetGroup, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceEntry=haResourceEntry, poolOwnerController=poolOwnerController, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcInitiatorName=fcInitiatorName, shareCIFSReadLatency=shareCIFSReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetStatus=fcTargetStatus, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cacheTotalReadMbps=cacheTotalReadMbps, diskTotalReadMbps=diskTotalReadMbps, projectShareCount=projectShareCount, lunWriteMbps=lunWriteMbps, replicationFailed=replicationFailed, controllerDown=controllerDown, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTotalReadMbps=iscsiTotalReadMbps, cacheSSDReads=cacheSSDReads, globalStatistics=globalStatistics, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalReadIops=nfsTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, tegileGroups=tegileGroups, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nvdimmFailUnknownError=nvdimmFailUnknownError, diskSizeHigh=diskSizeHigh, cpuInterrupts=cpuInterrupts, cifsTotalReadIops=cifsTotalReadIops, ipmiFan=ipmiFan, deleteFolderFailed=deleteFolderFailed, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorCreateFailed=fcInitiatorCreateFailed, ntpServerTimeDrift=ntpServerTimeDrift, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargets=iscsiTargets, poolDataWriteLatency=poolDataWriteLatency, poolCreated=poolCreated, diskTotalReadIops=diskTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareEntry=shareEntry, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolTotalWriteMbps=poolTotalWriteMbps, poolTotalSaving=poolTotalSaving, lunGUID=lunGUID, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskPoolName=diskPoolName, tegile=tegile, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolDegraded=poolDegraded, poolUpgraded=poolUpgraded, projectFreeSizeLow=projectFreeSizeLow, lunIndex=lunIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDeleted=poolDeleted, iscsiAvgReadLatency=iscsiAvgReadLatency, replicationTargetDeleted=replicationTargetDeleted, unknownSensorEvent=unknownSensorEvent, diskIndex=diskIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheTotalReadIops=cacheTotalReadIops, replicationComplete=replicationComplete, nvdimmFailInitializationError=nvdimmFailInitializationError, controllerHardwareModel=controllerHardwareModel, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, smisServiceStopped=smisServiceStopped, snmpServiceStopped=snmpServiceStopped, cpuTotalUsage=cpuTotalUsage, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunTargetGroup=lunTargetGroup, shareCIFSEnabled=shareCIFSEnabled, snmpAgentVersion=snmpAgentVersion, notificationDescription=notificationDescription, haResourcesTable=haResourcesTable, fcTargetWriteIops=fcTargetWriteIops, notificationProps=notificationProps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskDataWriteIops=diskDataWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, network=network, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTargetGroup=iscsiTargetGroup, projectLUNs=projectLUNs, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiWriteIops=iscsiWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, upgradeStarted=upgradeStarted, targetGroupMemberRemoved=targetGroupMemberRemoved, tdpsUpgradeFailed=tdpsUpgradeFailed, shareReservedSizeHigh=shareReservedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, lunSizeLow=lunSizeLow, projectDataSizeLow=projectDataSizeLow, sensorFailureEvent=sensorFailureEvent, poolExpanded=poolExpanded, diskSizeLow=diskSizeLow, lunWriteIops=lunWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, poolMetaWriteLatency=poolMetaWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, userLoginFailed=userLoginFailed, notificationObjects=notificationObjects, iscsiTargetError=iscsiTargetError, ipmiTemperature=ipmiTemperature, notificationTargetEntityName=notificationTargetEntityName, nfsTotalWriteMbps=nfsTotalWriteMbps, projectDedupEnabled=projectDedupEnabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationPaused=replicationPaused, lunDedupEnabled=lunDedupEnabled, haControllerB_IPAddr=haControllerB_IPAddr, tegileArray_notifications=tegileArray_notifications, poolReadCacheReadMbps=poolReadCacheReadMbps, projectQuotaFinished=projectQuotaFinished, lunEntry=lunEntry, shareNFSEnabled=shareNFSEnabled, iscsiTargetReadIops=iscsiTargetReadIops, diskCount=diskCount, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTotalWriteIops=fcTotalWriteIops, poolState=poolState, iscsiTargetWriteLatency=iscsiTargetWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, sanProperties=sanProperties, poolDataSizeLow=poolDataSizeLow, projectCompressionEnabled=projectCompressionEnabled, networkIpmpGroupUp=networkIpmpGroupUp, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcAvgWriteLatency=fcAvgWriteLatency, poolMetaReadLatency=poolMetaReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, currentNotificationGroup=currentNotificationGroup, diskState=diskState, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, upgradeCompleted=upgradeCompleted, projectName=projectName, projectDeleted=projectDeleted, iscsiTargetIndex=iscsiTargetIndex, diskRandomIOCount=diskRandomIOCount, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareIndex=shareIndex, tegileArray=tegileArray, projectEntry=projectEntry, shareQuotaLow=shareQuotaLow, poolTotalReadMbps=poolTotalReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskAlias=diskAlias, notificationReadingUnit=notificationReadingUnit, spareDiskReplaced=spareDiskReplaced, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetGroupError=iscsiTargetGroupError, lunName=lunName, lunReadLatency=lunReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunInitiatorGroup=lunInitiatorGroup, diskIOCount=diskIOCount, nicIndex=nicIndex, smisServiceStarted=smisServiceStarted, poolQuotaFinished=poolQuotaFinished, poolFreeSizeLow=poolFreeSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, pools=pools, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetEntry=iscsiTargetEntry, haResourceDescription=haResourceDescription, lunReservedSizeLow=lunReservedSizeLow, poolDataSizeHigh=poolDataSizeHigh, fcTargetReadMbps=fcTargetReadMbps, lunTable=lunTable, snmpServiceStopFailed=snmpServiceStopFailed, cacheRAMReads=cacheRAMReads, cifsTotalReadMbps=cifsTotalReadMbps, fcInitiators=fcInitiators, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskEntry=diskEntry, poolDataWriteMbps=poolDataWriteMbps, poolIndex=poolIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationEventCode=notificationEventCode, poolReadCacheReadIops=poolReadCacheReadIops, poolDeletionFailed=poolDeletionFailed, diskSequentialIOCount=diskSequentialIOCount, diskSlowIo=diskSlowIo, iscsiInitiatorGroup=iscsiInitiatorGroup, lunCompressionEnabled=lunCompressionEnabled, haControllerB_Uptime=haControllerB_Uptime, projectLunCount=projectLunCount, shareCIFSWriteLatency=shareCIFSWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataReadIops=poolDataReadIops, diskTotalWriteMbps=diskTotalWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareCreatedSuccessfully=shareCreatedSuccessfully, lunPoolName=lunPoolName, projectTable=projectTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolExported=poolExported, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, maintenanceModeEnabled=maintenanceModeEnabled, lunFreeSizeHigh=lunFreeSizeHigh, tegileConformance=tegileConformance, fcInitiatorIndex=fcInitiatorIndex, diskGoneOffline=diskGoneOffline, snmpServiceStartFailed=snmpServiceStartFailed, projectDeletionFailed=projectDeletionFailed, lunSizeHigh=lunSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareQuotaFinished=shareQuotaFinished, shareCIFSWriteIops=shareCIFSWriteIops, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, shareSnapshotSizeLow=shareSnapshotSizeLow, nicName=nicName, shareName=shareName, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunBlockSize=lunBlockSize, poolFreeSizeHigh=poolFreeSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, controllerTimeDrift=controllerTimeDrift, fcTargetsTable=fcTargetsTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tegileCompliances=tegileCompliances, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, ipmiThreshold=ipmiThreshold, shareNFSReadIops=shareNFSReadIops, shareCIFSReadMbps=shareCIFSReadMbps, poolImported=poolImported, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, targetGroupCreateCompleted=targetGroupCreateCompleted, diskDataWriteMbps=diskDataWriteMbps, smisServiceStopFailed=smisServiceStopFailed, netbiosSocketFailure=netbiosSocketFailure, diskDataReadMbps=diskDataReadMbps, poolTable=poolTable, ipmiCurrent=ipmiCurrent, nicEntry=nicEntry, fcTotalWriteMbps=fcTotalWriteMbps, PYSNMP_MODULE_ID=tegile, poolProjectCount=poolProjectCount, upgradeDownloadStarted=upgradeDownloadStarted, nicTable=nicTable, networkInterfaceDown=networkInterfaceDown, nicReceiveMbps=nicReceiveMbps, fcTargetName=fcTargetName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceActiveNode=haResourceActiveNode, iscsiInitiators=iscsiInitiators, iscsiTargetName=iscsiTargetName, notificationTime=notificationTime, projectShares=projectShares, fcTargetEntry=fcTargetEntry, testNotification=testNotification, ipmiVoltage=ipmiVoltage, shareProjectName=shareProjectName, shareCIFSReadIops=shareCIFSReadIops, projectModified=projectModified, projectTotalSaving=projectTotalSaving, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, projectFreeSizeHigh=projectFreeSizeHigh, notificationSeverity=notificationSeverity, diskTable=diskTable, lunReadIops=lunReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareNFSWriteIops=shareNFSWriteIops, replicationAborted=replicationAborted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTotalReadMbps=fcTotalReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetAlias=iscsiTargetAlias, haResourceStatus=haResourceStatus, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicTransmitMbps=nicTransmitMbps, notificationSensorAction=notificationSensorAction, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetsTable=iscsiTargetsTable, networkInterfaceUp=networkInterfaceUp, poolMetaReadMbps=poolMetaReadMbps, deleteFolderCompleted=deleteFolderCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, poolName=poolName, volumeDeleteFailed=volumeDeleteFailed, diskTotalWriteIops=diskTotalWriteIops, replicationResumed=replicationResumed, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolSizeLow=poolSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolAvgReadLatency=poolAvgReadLatency, haControllerB_Name=haControllerB_Name, nfsAvgReadLatency=nfsAvgReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCompressedRatio=shareCompressedRatio, projectDataSizeHigh=projectDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, diskError=diskError, memoryFailure=memoryFailure, haResourceIndex=haResourceIndex, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeTimeout=upgradeTimeout, replicationStarted=replicationStarted, fcTargets=fcTargets, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haResourceName=haResourceName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolMetaWriteIops=poolMetaWriteIops, basicCompliance=basicCompliance, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, shareQuotaHigh=shareQuotaHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, controllerUp=controllerUp, networkIpmpGroupDown=networkIpmpGroupDown, lunReservedSizeHigh=lunReservedSizeHigh, replicationSourceRegistered=replicationSourceRegistered, haControllerA_Name=haControllerA_Name, fcProperties=fcProperties, projectSnapshotSizeLow=projectSnapshotSizeLow, shareNFSReadMbps=shareNFSReadMbps, haResourceGroup=haResourceGroup, shareDataSizeHigh=shareDataSizeHigh, cpuSystemCalls=cpuSystemCalls, poolDataReadMbps=poolDataReadMbps, poolHealth=poolHealth, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorGroup=fcInitiatorGroup, shareDeletionFailed=shareDeletionFailed, poolDataReadLatency=poolDataReadLatency, fcInitiatorsTable=fcInitiatorsTable, volumeModifyCompleted=volumeModifyCompleted, diskType=diskType, sharePoolName=sharePoolName, notifications=notifications, poolProjects=poolProjects, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorNumber=notificationSensorNumber, poolReadCacheWriteIops=poolReadCacheWriteIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, properties=properties, smbSocketFailure=smbSocketFailure, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskIsOnline=diskIsOnline, snapshotRollbackFailed=snapshotRollbackFailed, nfsTotalReadMbps=nfsTotalReadMbps, iscsiProperties=iscsiProperties, shareTable=shareTable, shareMountPoint=shareMountPoint, nicGroup=nicGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolCount=poolCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolMetaReadIops=poolMetaReadIops, diskDataReadIops=diskDataReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcAvgReadLatency=fcAvgReadLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunProtocol=lunProtocol, notificationSensorSuspect=notificationSensorSuspect, ipmiMemory=ipmiMemory, snmpServiceStarted=snmpServiceStarted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, volumeQuotaFinished=volumeQuotaFinished, poolEntry=poolEntry, aclMigrationCompleted=aclMigrationCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, aclMigrationStarted=aclMigrationStarted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetReadLatency=fcTargetReadLatency, smisServiceStartFailed=smisServiceStartFailed, upgradeFailed=upgradeFailed, nvdimmFailSoftError=nvdimmFailSoftError, adServerTimeDrift=adServerTimeDrift, cifsAvgReadLatency=cifsAvgReadLatency, fcPortOffline=fcPortOffline, lunProjectName=lunProjectName, projectIndex=projectIndex, projectPoolName=projectPoolName, fcTargetWriteMbps=fcTargetWriteMbps, lunDataSizeLow=lunDataSizeLow, poolUsedSizeLow=poolUsedSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareDeleted=shareDeleted, poolDataWriteIops=poolDataWriteIops)
