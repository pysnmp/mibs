...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:56:47 2021
...
Gauge32, MibIdentifier, IpAddress, NotificationType, enterprises, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, Bits, ModuleIdentity, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "Bits", "ModuleIdentity", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectDataSizeHigh=projectDataSizeHigh, ipmiPowerSupply=ipmiPowerSupply, snmpServiceStarted=snmpServiceStarted, poolMetaWriteLatency=poolMetaWriteLatency, poolTotalReadMbps=poolTotalReadMbps, poolDataReadLatency=poolDataReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkInterfaceDown=networkInterfaceDown, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationReadingUnit=notificationReadingUnit, diagnosticDataUploaded=diagnosticDataUploaded, unknownSensorEvent=unknownSensorEvent, shareCIFSReadMbps=shareCIFSReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, upgradeStarted=upgradeStarted, poolReadCacheReadIops=poolReadCacheReadIops, diskRandomIOCount=diskRandomIOCount, projectLunCount=projectLunCount, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolIndex=poolIndex, diskGoneOffline=diskGoneOffline, replicationSourceRegistered=replicationSourceRegistered, haControllerB_Name=haControllerB_Name, poolName=poolName, smbSocketFailure=smbSocketFailure, fcTargetReadLatency=fcTargetReadLatency, nicTable=nicTable, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, diskTotalWriteIops=diskTotalWriteIops, iscsiProperties=iscsiProperties, poolTable=poolTable, shareDataSizeHigh=shareDataSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationAborted=replicationAborted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tegileCompliances=tegileCompliances, iscsiTargetReadIops=iscsiTargetReadIops, maintenanceModeDisabled=maintenanceModeDisabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationDescription=notificationDescription, notificationSeverity=notificationSeverity, diskChassisIdx=diskChassisIdx, cifsAvgWriteLatency=cifsAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, nvdimmFailUnknownError=nvdimmFailUnknownError, poolAvgReadLatency=poolAvgReadLatency, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiatorName=iscsiInitiatorName, fcTargets=fcTargets, projectDeletionFailed=projectDeletionFailed, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetStatus=fcTargetStatus, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectPoolName=projectPoolName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolDataWriteMbps=poolDataWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, aclMigrationCompleted=aclMigrationCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ipmiMemory=ipmiMemory, volumeDeleteFailed=volumeDeleteFailed, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareDeletionFailed=shareDeletionFailed, properties=properties, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetAlias=iscsiTargetAlias, lunReadIops=lunReadIops, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, basicCompliance=basicCompliance, shareQuotaLow=shareQuotaLow, shareCIFSReadIops=shareCIFSReadIops, fcPortOnline=fcPortOnline, shareNFSReadLatency=shareNFSReadLatency, shareEntry=shareEntry, poolImported=poolImported, notificationEventCode=notificationEventCode, cacheSSDReads=cacheSSDReads, cpuInterrupts=cpuInterrupts, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeFailed=webdocsUpgradeFailed, tegile=tegile, shareMountPoint=shareMountPoint, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeModifyCompleted=volumeModifyCompleted, shareNFSEnabled=shareNFSEnabled, lunGUID=lunGUID, poolFreeSizeLow=poolFreeSizeLow, haResourceEntry=haResourceEntry, diskDataReadMbps=diskDataReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectModified=projectModified, fcTotalReadIops=fcTotalReadIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolTotalReadIops=poolTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, ipmiThreshold=ipmiThreshold, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectIndex=projectIndex, fcTargetEntry=fcTargetEntry, deleteFolderFailed=deleteFolderFailed, smisServiceStartFailed=smisServiceStartFailed, poolDataWriteIops=poolDataWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolDeletionFailed=poolDeletionFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcInitiatorName=fcInitiatorName, netbiosSocketFailure=netbiosSocketFailure, replicationResumed=replicationResumed, diskDataReadIops=diskDataReadIops, fcTargetIndex=fcTargetIndex, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskPoolName=diskPoolName, lunReadLatency=lunReadLatency, fcAvgReadLatency=fcAvgReadLatency, shareCompressedRatio=shareCompressedRatio, poolTotalSaving=poolTotalSaving, notificationSensorAction=notificationSensorAction, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, haResourceIndex=haResourceIndex, snapshotCreationFailed=snapshotCreationFailed, poolSizeHigh=poolSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareProjectName=shareProjectName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareQuotaHigh=shareQuotaHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, currentObjectGroup=currentObjectGroup, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTotalReadIops=iscsiTotalReadIops, poolExported=poolExported, upgradeFailed=upgradeFailed, upgradeDownloadFailed=upgradeDownloadFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, lunReadMbps=lunReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, networkTotalReceiveMbps=networkTotalReceiveMbps, poolMetaWriteMbps=poolMetaWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, diskAvgWriteLatency=diskAvgWriteLatency, nicEntry=nicEntry, volumeDeleteCompleted=volumeDeleteCompleted, projectEntry=projectEntry, haResources=haResources, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetEntry=iscsiTargetEntry, poolEntry=poolEntry, projectDedupEnabled=projectDedupEnabled, diskType=diskType, diskTotalReadIops=diskTotalReadIops, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcInitiatorEntry=fcInitiatorEntry, smisServiceStarted=smisServiceStarted, sharePoolName=sharePoolName, lunWriteIops=lunWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorsTable=fcInitiatorsTable, projectQuotaSizeLow=projectQuotaSizeLow, projectTotalSaving=projectTotalSaving, shareNFSWriteMbps=shareNFSWriteMbps, lunTargetGroup=lunTargetGroup, lunInitiatorGroup=lunInitiatorGroup, diskIsOnline=diskIsOnline, diskDataWriteIops=diskDataWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskState=diskState, shareCIFSWriteLatency=shareCIFSWriteLatency, diskDataWriteMbps=diskDataWriteMbps, replicationTargetDeleted=replicationTargetDeleted, nicReceiveMbps=nicReceiveMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetsTable=iscsiTargetsTable, notificationComponentName=notificationComponentName, projectQuotaFinished=projectQuotaFinished, poolProjectCount=poolProjectCount, tegileArray=tegileArray, haResourceActiveNode=haResourceActiveNode, iscsiInitiators=iscsiInitiators, cacheTotalReadIops=cacheTotalReadIops, diskCount=diskCount, nicState=nicState, shareCompressionEnabled=shareCompressionEnabled, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haResourceDescription=haResourceDescription, cacheRAMReads=cacheRAMReads, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, sanProperties=sanProperties, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, disks=disks, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCIFSReadLatency=shareCIFSReadLatency, poolProjects=poolProjects, poolAvgWriteLatency=poolAvgWriteLatency, diskEntry=diskEntry, haControllerB_IPAddr=haControllerB_IPAddr, networkInterfaceUp=networkInterfaceUp, haControllerB_Uptime=haControllerB_Uptime, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, snapshotRollbackFailed=snapshotRollbackFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, poolMetaReadMbps=poolMetaReadMbps, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareDeleted=shareDeleted, lunEntry=lunEntry, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolDataReadMbps=poolDataReadMbps, nicMTU=nicMTU, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, snmpServiceStopped=snmpServiceStopped, poolDataWriteLatency=poolDataWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, deleteFolderCompleted=deleteFolderCompleted, poolDataSizeLow=poolDataSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, poolSizeLow=poolSizeLow, haResourceGroup=haResourceGroup, poolState=poolState, targetGroupMemberAdded=targetGroupMemberAdded, ipmiTemperature=ipmiTemperature, fcTargetReadIops=fcTargetReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, diskSizeHigh=diskSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationFailed=replicationFailed, lunPoolName=lunPoolName, controllerHardwareModel=controllerHardwareModel, diskTable=diskTable, smisServiceStopped=smisServiceStopped)
mibBuilder.exportSymbols("TEGILE-MIB", lunSnapshotSizeHigh=lunSnapshotSizeHigh, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, ipmiOther=ipmiOther, lunSizeLow=lunSizeLow, snmpAgentVersion=snmpAgentVersion, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDataReadIops=poolDataReadIops, notificationSensorNumber=notificationSensorNumber, diskError=diskError, poolMetaReadIops=poolMetaReadIops, projectName=projectName, lunDataSizeLow=lunDataSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, poolDeleted=poolDeleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cacheTotalWriteMbps=cacheTotalWriteMbps, poolMetaWriteIops=poolMetaWriteIops, shareDedupEnabled=shareDedupEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nfsTotalReadMbps=nfsTotalReadMbps, volumeQuotaFinished=volumeQuotaFinished, cifsTotalReadIops=cifsTotalReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, poolHealth=poolHealth, notificationTime=notificationTime, shareTable=shareTable, notificationProps=notificationProps, diskSlowIo=diskSlowIo, shareNFSReadMbps=shareNFSReadMbps, shareIndex=shareIndex, replicationComplete=replicationComplete, iscsiTargetError=iscsiTargetError, poolUpgraded=poolUpgraded, shareDataSizeLow=shareDataSizeLow, projectShares=projectShares, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunDedupEnabled=lunDedupEnabled, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolTotalWriteMbps=poolTotalWriteMbps, poolCreated=poolCreated, diskTotalWriteMbps=diskTotalWriteMbps, projectTable=projectTable, upgradeCompleted=upgradeCompleted, fcTotalReadMbps=fcTotalReadMbps, ipmiCurrent=ipmiCurrent, tegileArray_notifications=tegileArray_notifications, iscsiTargetWriteIops=iscsiTargetWriteIops, shareName=shareName, testNotification=testNotification, fcPortOffline=fcPortOffline, controllerTimeDrift=controllerTimeDrift, iscsiTargetName=iscsiTargetName, poolDataSizeHigh=poolDataSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, iscsiWriteIops=iscsiWriteIops, lunDataSizeHigh=lunDataSizeHigh, lunProtocol=lunProtocol, poolExpanded=poolExpanded, replicationPaused=replicationPaused, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nvdimmFailInitializationError=nvdimmFailInitializationError, poolCount=poolCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, network=network, iscsiTargets=iscsiTargets, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicIndex=nicIndex, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTargetWriteLatency=fcTargetWriteLatency, PYSNMP_MODULE_ID=tegile, fcProperties=fcProperties, lunBlockSize=lunBlockSize, lunSizeHigh=lunSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetIndex=iscsiTargetIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, poolMetaReadLatency=poolMetaReadLatency, lunName=lunName, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, diskTotalReadMbps=diskTotalReadMbps, diskIndex=diskIndex, globalStatistics=globalStatistics, poolTotalWriteIops=poolTotalWriteIops, projectLUNs=projectLUNs, shareNFSReadIops=shareNFSReadIops, fcTargetName=fcTargetName, adServerTimeDrift=adServerTimeDrift, nicTransmitMbps=nicTransmitMbps, controllerUp=controllerUp, fcTargetReadMbps=fcTargetReadMbps, cpuTotalUsage=cpuTotalUsage, poolOwnerController=poolOwnerController, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiatorIndex=fcInitiatorIndex, tegileConformance=tegileConformance, projectCompressionEnabled=projectCompressionEnabled, snapshotCloningFailed=snapshotCloningFailed, nicName=nicName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, ipmiFan=ipmiFan, poolFreeSizeHigh=poolFreeSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, nfsTotalReadIops=nfsTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareNFSWriteLatency=shareNFSWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haResourcesTable=haResourcesTable, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcInitiators=fcInitiators, shareQuotaFinished=shareQuotaFinished, aclMigrationStarted=aclMigrationStarted, haResourceName=haResourceName, fcTotalWriteIops=fcTotalWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareCreatedSuccessfully=shareCreatedSuccessfully, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTargetGroup=iscsiTargetGroup, projectDataSizeLow=projectDataSizeLow, diskIOCount=diskIOCount, notificationObjects=notificationObjects, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, projectShareCount=projectShareCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunWriteMbps=lunWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, pools=pools, lunReservedSizeHigh=lunReservedSizeHigh, ipmiVoltage=ipmiVoltage, networkIpmpGroupDown=networkIpmpGroupDown, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, targetGroupMemberRemoved=targetGroupMemberRemoved, lunFreeSizeLow=lunFreeSizeLow, replicationAbandoned=replicationAbandoned, networkIpmpGroupUp=networkIpmpGroupUp, cpuSystemCalls=cpuSystemCalls, userLoginFailed=userLoginFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeTimeout=upgradeTimeout, projectDeleted=projectDeleted, tegileGroups=tegileGroups, iscsiInitiatorsTable=iscsiInitiatorsTable, lunIndex=lunIndex, diskSequentialIOCount=diskSequentialIOCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetWriteIops=fcTargetWriteIops, fcTargetsTable=fcTargetsTable, haControllerA_Uptime=haControllerA_Uptime, lunProjectName=lunProjectName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTotalReadMbps=iscsiTotalReadMbps, haControllerA_Name=haControllerA_Name, cifsAvgReadLatency=cifsAvgReadLatency, haResourceStatus=haResourceStatus, nfsTotalWriteMbps=nfsTotalWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, lunWriteLatency=lunWriteLatency, notificationTargetEntityName=notificationTargetEntityName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nfsAvgReadLatency=nfsAvgReadLatency, nicGroup=nicGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, controllerDown=controllerDown, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, notificationSensorSuspect=notificationSensorSuspect, diskAlias=diskAlias, diskSizeLow=diskSizeLow, poolQuotaFinished=poolQuotaFinished, upgradeDownloadCompleted=upgradeDownloadCompleted, lunTable=lunTable, currentNotificationGroup=currentNotificationGroup, cifsTotalWriteIops=cifsTotalWriteIops, notifications=notifications, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, replicationStarted=replicationStarted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolDegraded=poolDegraded, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetWriteMbps=fcTargetWriteMbps, lunCompressedRatio=lunCompressedRatio, memoryFailure=memoryFailure, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted)
