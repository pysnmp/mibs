...
Counter64, IpAddress, NotificationType, Gauge32, Bits, enterprises, iso, ObjectIdentity, Counter32, MibIdentifier, ModuleIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "NotificationType", "Gauge32", "Bits", "enterprises", "iso", "ObjectIdentity", "Counter32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", snmpServiceStarted=snmpServiceStarted, haResourceName=haResourceName, fcPortOnline=fcPortOnline, projectFreeSizeLow=projectFreeSizeLow, netbiosSocketFailure=netbiosSocketFailure, maintenanceModeEnabled=maintenanceModeEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskState=diskState, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, replicationFailed=replicationFailed, smisServiceStopped=smisServiceStopped, poolAvgReadLatency=poolAvgReadLatency, adServerTimeDrift=adServerTimeDrift, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskEntry=diskEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiatorsTable=fcInitiatorsTable, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskTotalReadMbps=diskTotalReadMbps, projectIndex=projectIndex, tegileConformance=tegileConformance, shareDataSizeLow=shareDataSizeLow, poolEntry=poolEntry, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationSourceRegistered=replicationSourceRegistered, notificationProps=notificationProps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, smisServiceStopFailed=smisServiceStopFailed, shareNFSReadIops=shareNFSReadIops, nicTable=nicTable, notificationEventCode=notificationEventCode, poolDataReadMbps=poolDataReadMbps, iscsiWriteIops=iscsiWriteIops, haResourceActiveNode=haResourceActiveNode, shareQuotaFinished=shareQuotaFinished, upgradeTimeout=upgradeTimeout, nicName=nicName, notificationTargetEntityName=notificationTargetEntityName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, replicationComplete=replicationComplete, sanProperties=sanProperties, fcTargets=fcTargets, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorName=iscsiInitiatorName, pools=pools, diskIsOnline=diskIsOnline, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareDeleted=shareDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationStarted=replicationStarted, shareCIFSReadMbps=shareCIFSReadMbps, projectName=projectName, iscsiInitiatorGroup=iscsiInitiatorGroup, cifsAvgReadLatency=cifsAvgReadLatency, poolHealth=poolHealth, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, smisServiceStarted=smisServiceStarted, snmpAgentVersion=snmpAgentVersion, lunInitiatorGroup=lunInitiatorGroup, cacheTotalReadIops=cacheTotalReadIops, cpuInterrupts=cpuInterrupts, basicCompliance=basicCompliance, diskGoneOffline=diskGoneOffline, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareName=shareName, alertsCleanupCompleted=alertsCleanupCompleted, fcTotalReadMbps=fcTotalReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, diskDataWriteMbps=diskDataWriteMbps, lunReadLatency=lunReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, deleteFolderCompleted=deleteFolderCompleted, poolCreated=poolCreated, poolFreeSizeHigh=poolFreeSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, nicReceiveMbps=nicReceiveMbps, tegileGroups=tegileGroups, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haControllerB_Name=haControllerB_Name, haResourceGroup=haResourceGroup, diskType=diskType, tdpsUpgradeFailed=tdpsUpgradeFailed, upgradeCompleted=upgradeCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetGroup=iscsiTargetGroup, lunTargetGroup=lunTargetGroup, volumeModifyCompleted=volumeModifyCompleted, projectCompressionEnabled=projectCompressionEnabled, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareQuotaHigh=shareQuotaHigh, poolTotalWriteIops=poolTotalWriteIops, diskCount=diskCount, snapshotCreationFailed=snapshotCreationFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationSensorSuspect=notificationSensorSuspect, poolDataWriteMbps=poolDataWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, notificationReadingUnit=notificationReadingUnit, projectQuotaSizeLow=projectQuotaSizeLow, cacheRAMReads=cacheRAMReads, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaWriteMbps=poolMetaWriteMbps, lunDedupEnabled=lunDedupEnabled, upgradeDownloadStarted=upgradeDownloadStarted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareTable=shareTable, nfsTotalWriteIops=nfsTotalWriteIops, tegileArray=tegileArray, shareNFSWriteLatency=shareNFSWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCIFSWriteIops=shareCIFSWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTotalWriteMbps=fcTotalWriteMbps, poolCount=poolCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskError=diskError, fcTargetReadMbps=fcTargetReadMbps, poolDataReadLatency=poolDataReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetReadIops=fcTargetReadIops, ipmiMemory=ipmiMemory, smbSocketFailure=smbSocketFailure, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetIndex=iscsiTargetIndex, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haControllerB_Uptime=haControllerB_Uptime, haControllerA_Uptime=haControllerA_Uptime, cifsTotalWriteIops=cifsTotalWriteIops, poolDataWriteLatency=poolDataWriteLatency, lunFreeSizeLow=lunFreeSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetEntry=fcTargetEntry, shareProjectName=shareProjectName, lunBlockSize=lunBlockSize, nvdimmFailInitializationError=nvdimmFailInitializationError, nicGroup=nicGroup, haResourceEntry=haResourceEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolMetaReadLatency=poolMetaReadLatency, diskSlowIo=diskSlowIo, webdocsUpgradeFailed=webdocsUpgradeFailed, poolDataSizeLow=poolDataSizeLow, shareReservedSizeLow=shareReservedSizeLow, sensorFailureEvent=sensorFailureEvent, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haControllerA_Name=haControllerA_Name, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataSizeHigh=poolDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunWriteIops=lunWriteIops, poolExported=poolExported, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cacheSSDReads=cacheSSDReads, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolDeletionFailed=poolDeletionFailed, projectEntry=projectEntry, fcTotalWriteIops=fcTotalWriteIops, poolTotalReadIops=poolTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunTable=lunTable, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetModifyCompleted=fcTargetModifyCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, nfsTotalReadIops=nfsTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectModified=projectModified, diskAlias=diskAlias, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadMbps=poolMetaReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectTotalSaving=projectTotalSaving, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, currentObjectGroup=currentObjectGroup, fcTargetsTable=fcTargetsTable, shareDedupEnabled=shareDedupEnabled, upgradeFailed=upgradeFailed, projectLUNs=projectLUNs, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, networkInterfaceDown=networkInterfaceDown, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerHardwareModel=controllerHardwareModel, lunPoolName=lunPoolName, nicTransmitMbps=nicTransmitMbps, cacheTotalWriteIops=cacheTotalWriteIops, ipmiPowerSupply=ipmiPowerSupply, iscsiProperties=iscsiProperties, lunWriteMbps=lunWriteMbps, poolDegraded=poolDegraded, snapshotCloningFailed=snapshotCloningFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolUpgraded=poolUpgraded, poolDataWriteIops=poolDataWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, volumeDeleteFailed=volumeDeleteFailed, diskChassisIdx=diskChassisIdx, shareNFSWriteIops=shareNFSWriteIops, projectQuotaFinished=projectQuotaFinished, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectDeletionFailed=projectDeletionFailed, controllerTimeDrift=controllerTimeDrift, diskAvgReadLatency=diskAvgReadLatency, spareDiskReplaced=spareDiskReplaced, diskRandomIOCount=diskRandomIOCount, iscsiTargetName=iscsiTargetName, poolSizeLow=poolSizeLow, fcTargetStatus=fcTargetStatus, tegileCompliances=tegileCompliances, lunCompressionEnabled=lunCompressionEnabled, cpuSystemCalls=cpuSystemCalls, globalStatistics=globalStatistics, iscsiTargetAuth=iscsiTargetAuth, controllerDown=controllerDown, projectThresholdExceedWarning=projectThresholdExceedWarning, diskTotalReadIops=diskTotalReadIops, shareQuotaLow=shareQuotaLow, shareNFSReadLatency=shareNFSReadLatency, projectShares=projectShares, poolOwnerController=poolOwnerController, shareExceedThresholdWarning=shareExceedThresholdWarning, projectDataSizeLow=projectDataSizeLow, poolIndex=poolIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, disks=disks, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, notificationSeverity=notificationSeverity, ipmiThreshold=ipmiThreshold, notificationObjects=notificationObjects, iscsiTargetReadIops=iscsiTargetReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores)
mibBuilder.exportSymbols("TEGILE-MIB", poolProjectCount=poolProjectCount, lunProjectName=lunProjectName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunName=lunName, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, sharePoolName=sharePoolName, diskTotalWriteMbps=diskTotalWriteMbps, projectDataSizeHigh=projectDataSizeHigh, notificationComponentName=notificationComponentName, lunDataSizeLow=lunDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTargetGroup=fcTargetGroup, projectShareCount=projectShareCount, controllerUp=controllerUp, iscsiTotalReadMbps=iscsiTotalReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, shareNFSReadMbps=shareNFSReadMbps, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, shareCIFSReadIops=shareCIFSReadIops, fcPortOffline=fcPortOffline, replicationAborted=replicationAborted, shareCIFSEnabled=shareCIFSEnabled, fcTargetName=fcTargetName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, PYSNMP_MODULE_ID=tegile, poolName=poolName, targetGroupMemberAdded=targetGroupMemberAdded, iscsiInitiatorChapUser=iscsiInitiatorChapUser, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareNFSEnabled=shareNFSEnabled, fcInitiatorIndex=fcInitiatorIndex, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareDeletionFailed=shareDeletionFailed, lunGUID=lunGUID, notificationTime=notificationTime, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskIOCount=diskIOCount, snapshotDeleteFailed=snapshotDeleteFailed, lunEntry=lunEntry, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolTotalSaving=poolTotalSaving, diskTable=diskTable, poolState=poolState, diskAvgWriteLatency=diskAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, haResourceIndex=haResourceIndex, fcAvgWriteLatency=fcAvgWriteLatency, ipmiFan=ipmiFan, haResources=haResources, diskIndex=diskIndex, ipmiOther=ipmiOther, lunReservedSizeLow=lunReservedSizeLow, fcTargetReadLatency=fcTargetReadLatency, poolSizeHigh=poolSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, ipmiVoltage=ipmiVoltage, unknownSensorEvent=unknownSensorEvent, smisServiceStartFailed=smisServiceStartFailed, upgradeStarted=upgradeStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationResumed=replicationResumed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, maintenanceModeDisabled=maintenanceModeDisabled, lunReservedSizeHigh=lunReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, replicationTargetDeleted=replicationTargetDeleted, shareCIFSReadLatency=shareCIFSReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectDedupEnabled=projectDedupEnabled, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nvdimmFailDeviceError=nvdimmFailDeviceError, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcInitiatorGroup=fcInitiatorGroup, tegileArray_notifications=tegileArray_notifications, poolProjects=poolProjects, fcInitiators=fcInitiators, haResourceStatus=haResourceStatus, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetError=iscsiTargetError, poolReadCacheReadMbps=poolReadCacheReadMbps, properties=properties, diskSequentialIOCount=diskSequentialIOCount, nicEntry=nicEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, lunReadIops=lunReadIops, lunSizeHigh=lunSizeHigh, fcTargetIndex=fcTargetIndex, projectPoolName=projectPoolName, haResourcesTable=haResourcesTable, poolDataReadIops=poolDataReadIops, lunCompressedRatio=lunCompressedRatio, memoryFailure=memoryFailure, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, nfsAvgReadLatency=nfsAvgReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, projectLunCount=projectLunCount, lunWriteLatency=lunWriteLatency, userLoginFailed=userLoginFailed, upgradeDownloadFailed=upgradeDownloadFailed, ipmiTemperature=ipmiTemperature, lunReadMbps=lunReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectTable=projectTable, poolDeleted=poolDeleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolImported=poolImported, notificationDescription=notificationDescription, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, volumeQuotaFinished=volumeQuotaFinished, fcTotalReadIops=fcTotalReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, currentNotificationGroup=currentNotificationGroup, fcInitiatorName=fcInitiatorName, lunSizeLow=lunSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cifsTotalReadIops=cifsTotalReadIops, shareCompressedRatio=shareCompressedRatio, nvdimmFailSoftError=nvdimmFailSoftError, aclMigrationStarted=aclMigrationStarted, networkInterfaceUp=networkInterfaceUp, notifications=notifications, shareCompressionEnabled=shareCompressionEnabled, tegile=tegile, diskSizeLow=diskSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationPaused=replicationPaused, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, notificationSensorNumber=notificationSensorNumber, poolQuotaFinished=poolQuotaFinished, lunDataSizeHigh=lunDataSizeHigh, poolFreeSizeLow=poolFreeSizeLow, fcProperties=fcProperties, volumeDeleteCompleted=volumeDeleteCompleted, ipmiCurrent=ipmiCurrent, shareCreatedSuccessfully=shareCreatedSuccessfully, testNotification=testNotification, fcTargetWriteIops=fcTargetWriteIops, poolTotalReadMbps=poolTotalReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, nicState=nicState, notificationSensorAction=notificationSensorAction, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareCIFSWriteLatency=shareCIFSWriteLatency, poolTable=poolTable, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskSizeHigh=diskSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, projectDeleted=projectDeleted, iscsiTargetEntry=iscsiTargetEntry, projectFreeSizeHigh=projectFreeSizeHigh, shareIndex=shareIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskPoolName=diskPoolName, shareMountPoint=shareMountPoint, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareDataSizeHigh=shareDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, diskDataReadIops=diskDataReadIops, shareEntry=shareEntry, snmpServiceStopped=snmpServiceStopped, lunIndex=lunIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, nicMTU=nicMTU, shareNFSWriteMbps=shareNFSWriteMbps, replicationAbandoned=replicationAbandoned, lunProtocol=lunProtocol, fcAvgReadLatency=fcAvgReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolMetaReadIops=poolMetaReadIops, iscsiTargets=iscsiTargets, nfsTotalReadMbps=nfsTotalReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationReadingTriggerValue=notificationReadingTriggerValue, cpuTotalUsage=cpuTotalUsage, iscsiTotalReadIops=iscsiTotalReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, network=network, diskDataReadMbps=diskDataReadMbps, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetsTable=iscsiTargetsTable, poolUsedSizeHigh=poolUsedSizeHigh, nicIndex=nicIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaWriteLatency=poolMetaWriteLatency, poolExpanded=poolExpanded, haResourceDescription=haResourceDescription, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorEntry=fcInitiatorEntry)
