...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:19:27 2022
...
Gauge32, ModuleIdentity, ObjectIdentity, Integer32, Bits, Counter32, Unsigned32, IpAddress, iso, NotificationType, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Integer32", "Bits", "Counter32", "Unsigned32", "IpAddress", "iso", "NotificationType", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", smbSocketFailure=smbSocketFailure, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ipmiThreshold=ipmiThreshold, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskSizeLow=diskSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectModified=projectModified, shareDedupEnabled=shareDedupEnabled, notificationEventCode=notificationEventCode, currentObjectGroup=currentObjectGroup, poolUsedSizeHigh=poolUsedSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressionEnabled=shareCompressionEnabled, haResourceDescription=haResourceDescription, poolTotalReadIops=poolTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, disks=disks, notificationComponentName=notificationComponentName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationReadingUnit=notificationReadingUnit, replicationAbandoned=replicationAbandoned, lunInitiatorGroup=lunInitiatorGroup, lunFreeSizeLow=lunFreeSizeLow, diskEntry=diskEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectTotalSaving=projectTotalSaving, cacheRAMReads=cacheRAMReads, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, pools=pools, cifsAvgWriteLatency=cifsAvgWriteLatency, lunCompressionEnabled=lunCompressionEnabled, poolCreated=poolCreated, poolHealth=poolHealth, tegileGroups=tegileGroups, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetAlias=iscsiTargetAlias, diskDataWriteIops=diskDataWriteIops, sanProperties=sanProperties, diskDataReadMbps=diskDataReadMbps, shareCIFSEnabled=shareCIFSEnabled, shareDataSizeHigh=shareDataSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotCreationFailed=snapshotCreationFailed, cacheSSDReads=cacheSSDReads, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunGUID=lunGUID, deleteFolderCompleted=deleteFolderCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationFailed=replicationFailed, ipmiFan=ipmiFan, ipmiOther=ipmiOther, shareNFSReadMbps=shareNFSReadMbps, shareCompressedRatio=shareCompressedRatio, haResourceEntry=haResourceEntry, PYSNMP_MODULE_ID=tegile, poolProjectCount=poolProjectCount, poolDataReadLatency=poolDataReadLatency, sensorFailureEvent=sensorFailureEvent, fcTargetStatus=fcTargetStatus, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunReservedSizeLow=lunReservedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, targetGroupMemberAdded=targetGroupMemberAdded, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationDescription=notificationDescription, iscsiInitiatorGroup=iscsiInitiatorGroup, nicTable=nicTable, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, userLoginFailed=userLoginFailed, iscsiTargetGroupError=iscsiTargetGroupError, nfsTotalReadIops=nfsTotalReadIops, iscsiProperties=iscsiProperties, lunWriteMbps=lunWriteMbps, replicationResumed=replicationResumed, poolName=poolName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectLUNs=projectLUNs, lunWriteIops=lunWriteIops, haResourcesTable=haResourcesTable, diagnosticDataUploaded=diagnosticDataUploaded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, upgradeFailed=upgradeFailed, poolExpanded=poolExpanded, poolWriteCacheWriteIops=poolWriteCacheWriteIops, adServerTimeDrift=adServerTimeDrift, ipmiVoltage=ipmiVoltage, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareName=shareName, shareNFSWriteLatency=shareNFSWriteLatency, nicMTU=nicMTU, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicReceiveMbps=nicReceiveMbps, maintenanceModeDisabled=maintenanceModeDisabled, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiTargetError=iscsiTargetError, upgradeStarted=upgradeStarted, tegileConformance=tegileConformance, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, spareDiskReplaced=spareDiskReplaced, nvdimmFailInitializationError=nvdimmFailInitializationError, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, controllerHardwareModel=controllerHardwareModel, cacheTotalWriteMbps=cacheTotalWriteMbps, diskIsOnline=diskIsOnline, shareDataSizeLow=shareDataSizeLow, poolDataSizeHigh=poolDataSizeHigh, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTotalReadIops=fcTotalReadIops, diskSlowIo=diskSlowIo, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskType=diskType, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSReadLatency=shareNFSReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectShareCount=projectShareCount, cifsTotalReadMbps=cifsTotalReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, diskTotalWriteIops=diskTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, diskSequentialIOCount=diskSequentialIOCount, notificationTargetEntityName=notificationTargetEntityName, shareDeleted=shareDeleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, nicState=nicState, basicCompliance=basicCompliance, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcTargetName=fcTargetName, iscsiAvgReadLatency=iscsiAvgReadLatency, lunTargetGroup=lunTargetGroup, nfsTotalWriteIops=nfsTotalWriteIops, notificationTime=notificationTime, iscsiTargetEntry=iscsiTargetEntry, networkInterfaceUp=networkInterfaceUp, fcTargetsTable=fcTargetsTable, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiInitiatorName=iscsiInitiatorName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareNFSEnabled=shareNFSEnabled, volumeQuotaFinished=volumeQuotaFinished, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nfsTotalReadMbps=nfsTotalReadMbps, diskPoolName=diskPoolName, shareEntry=shareEntry, notificationSeverity=notificationSeverity, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectShares=projectShares, poolAvgWriteLatency=poolAvgWriteLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkIpmpGroupDown=networkIpmpGroupDown, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snmpServiceStopped=snmpServiceStopped, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaWriteLatency=poolMetaWriteLatency, controllerUp=controllerUp, smisServiceStopped=smisServiceStopped, nvdimmFailSoftError=nvdimmFailSoftError, projectQuotaSizeHigh=projectQuotaSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskTable=diskTable, fcInitiatorsTable=fcInitiatorsTable, lunName=lunName, cifsTotalReadIops=cifsTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, projectQuotaFinished=projectQuotaFinished, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetReadMbps=iscsiTargetReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataWriteIops=poolDataWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, fcInitiatorName=fcInitiatorName, lunProjectName=lunProjectName, projectFreeSizeLow=projectFreeSizeLow, volumeDeleteCompleted=volumeDeleteCompleted, diskAlias=diskAlias, sharePoolName=sharePoolName, nicGroup=nicGroup, haControllerA_IPAddr=haControllerA_IPAddr, lunReadMbps=lunReadMbps, fcPortOnline=fcPortOnline, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunDataSizeLow=lunDataSizeLow, poolProjects=poolProjects, iscsiTargetWriteIops=iscsiTargetWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, projectEntry=projectEntry, lunSizeLow=lunSizeLow, lunDedupEnabled=lunDedupEnabled, projectIndex=projectIndex, shareIndex=shareIndex, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTotalReadMbps=iscsiTotalReadMbps, poolSizeHigh=poolSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolOwnerController=poolOwnerController, fcTotalWriteMbps=fcTotalWriteMbps, fcPortOffline=fcPortOffline, projectDataSizeLow=projectDataSizeLow, poolDataReadIops=poolDataReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, controllerTimeDrift=controllerTimeDrift, lunTable=lunTable, projectLunCount=projectLunCount, iscsiTargetsTable=iscsiTargetsTable, poolMetaWriteIops=poolMetaWriteIops, shareQuotaHigh=shareQuotaHigh, poolDataWriteMbps=poolDataWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, notificationSensorNumber=notificationSensorNumber, iscsiTargetReadLatency=iscsiTargetReadLatency, tegileArray_notifications=tegileArray_notifications, smisServiceStarted=smisServiceStarted, fcTargetEntry=fcTargetEntry, haControllerB_Uptime=haControllerB_Uptime, lunWriteLatency=lunWriteLatency, smisServiceStopFailed=smisServiceStopFailed, nicTransmitMbps=nicTransmitMbps, diskSizeHigh=diskSizeHigh, poolDegraded=poolDegraded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, shareReservedSizeLow=shareReservedSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", nvdimmFailDeviceError=nvdimmFailDeviceError, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolTable=poolTable, diskState=diskState, iscsiWriteIops=iscsiWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, lunEntry=lunEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snmpServiceStarted=snmpServiceStarted, volumeDeleteFailed=volumeDeleteFailed, ipmiPowerSupply=ipmiPowerSupply, projectCompressionEnabled=projectCompressionEnabled, poolState=poolState, fcTargetWriteLatency=fcTargetWriteLatency, tegileCompliances=tegileCompliances, cifsTotalWriteIops=cifsTotalWriteIops, replicationStarted=replicationStarted, iscsiTargetReadIops=iscsiTargetReadIops, haResourceGroup=haResourceGroup, notificationProps=notificationProps, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetWriteMbps=fcTargetWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, poolMetaReadIops=poolMetaReadIops, iscsiTotalReadIops=iscsiTotalReadIops, lunBlockSize=lunBlockSize, lunProtocol=lunProtocol, cacheTotalReadIops=cacheTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolAvgReadLatency=poolAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, poolDataSizeLow=poolDataSizeLow, shareQuotaLow=shareQuotaLow, lunReadIops=lunReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcProperties=fcProperties, memoryFailure=memoryFailure, shareMountPoint=shareMountPoint, network=network, diskError=diskError, poolFreeSizeLow=poolFreeSizeLow, diskIndex=diskIndex, smisServiceStartFailed=smisServiceStartFailed, diskChassisIdx=diskChassisIdx, poolDeleted=poolDeleted, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargets=iscsiTargets, fcTargetReadMbps=fcTargetReadMbps, replicationComplete=replicationComplete, shareCIFSWriteLatency=shareCIFSWriteLatency, snmpAgentVersion=snmpAgentVersion, tegileArray=tegileArray, fcTargetModifyCompleted=fcTargetModifyCompleted, diskAvgReadLatency=diskAvgReadLatency, testNotification=testNotification, fcTotalWriteIops=fcTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, projectPoolName=projectPoolName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, notificationSensorAction=notificationSensorAction, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetAuth=iscsiTargetAuth, poolQuotaFinished=poolQuotaFinished, iscsiTargetName=iscsiTargetName, poolExported=poolExported, fcTargetGroup=fcTargetGroup, poolTotalReadMbps=poolTotalReadMbps, fcTargetIndex=fcTargetIndex, lunFreeSizeHigh=lunFreeSizeHigh, shareTable=shareTable, snapshotDeleteFailed=snapshotDeleteFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolCount=poolCount, notificationObjects=notificationObjects, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetGroup=iscsiTargetGroup, lunSizeHigh=lunSizeHigh, shareNFSReadIops=shareNFSReadIops, cpuSystemCalls=cpuSystemCalls, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolReadCacheReadIops=poolReadCacheReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, notifications=notifications, shareNFSWriteIops=shareNFSWriteIops, replicationAborted=replicationAborted, notificationSensorSuspect=notificationSensorSuspect, projectTable=projectTable, iscsiInitiatorsTable=iscsiInitiatorsTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, snapshotCloneCompleted=snapshotCloneCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResourceName=haResourceName, fcTargets=fcTargets, cpuInterrupts=cpuInterrupts, projectName=projectName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, controllerDown=controllerDown, poolMetaReadLatency=poolMetaReadLatency, currentNotificationGroup=currentNotificationGroup, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nicIndex=nicIndex, deleteFolderFailed=deleteFolderFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolFreeSizeHigh=poolFreeSizeHigh, ipmiTemperature=ipmiTemperature, poolReadCacheReadMbps=poolReadCacheReadMbps, ipmiCurrent=ipmiCurrent, poolDataReadMbps=poolDataReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cpuTotalUsage=cpuTotalUsage, volumeModifyCompleted=volumeModifyCompleted, haControllerB_Name=haControllerB_Name, projectFreeSizeHigh=projectFreeSizeHigh, unknownSensorEvent=unknownSensorEvent, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsAvgWriteLatency=nfsAvgWriteLatency, diskCount=diskCount, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcInitiatorIndex=fcInitiatorIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, properties=properties, upgradeDownloadStarted=upgradeDownloadStarted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolSizeLow=poolSizeLow, upgradeTimeout=upgradeTimeout, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetIndex=iscsiTargetIndex, shareDeletionFailed=shareDeletionFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haControllerA_Uptime=haControllerA_Uptime, fcInitiatorEntry=fcInitiatorEntry, diskDataReadIops=diskDataReadIops, haResourceActiveNode=haResourceActiveNode, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectDeleted=projectDeleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiInitiators=iscsiInitiators, netbiosSocketFailure=netbiosSocketFailure, upgradeCompleted=upgradeCompleted, poolDataWriteLatency=poolDataWriteLatency, poolImported=poolImported, fcInitiators=fcInitiators, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceIndex=haResourceIndex, poolEntry=poolEntry, lunPoolName=lunPoolName, shareProjectName=shareProjectName, lunReadLatency=lunReadLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDeletionFailed=poolDeletionFailed, replicationSourceRegistered=replicationSourceRegistered, diskTotalReadIops=diskTotalReadIops, diskTotalWriteMbps=diskTotalWriteMbps, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcInitiatorGroup=fcInitiatorGroup, fcTargetReadLatency=fcTargetReadLatency, haResources=haResources, tegile=tegile, projectDedupEnabled=projectDedupEnabled, aclMigrationCompleted=aclMigrationCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nicName=nicName, ipmiMemory=ipmiMemory, haResourceStatus=haResourceStatus, notificationThresholdTriggerValue=notificationThresholdTriggerValue, aclMigrationStarted=aclMigrationStarted, poolMetaReadMbps=poolMetaReadMbps, nicEntry=nicEntry, diskGoneOffline=diskGoneOffline, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCIFSReadLatency=shareCIFSReadLatency, networkInterfaceDown=networkInterfaceDown, lunIndex=lunIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, replicationPaused=replicationPaused, shareQuotaFinished=shareQuotaFinished, replicationTargetDeleted=replicationTargetDeleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cifsTotalWriteMbps=cifsTotalWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps, diskTotalReadMbps=diskTotalReadMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolUpgraded=poolUpgraded, projectDataSizeHigh=projectDataSizeHigh, fcTargetWriteIops=fcTargetWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, diskIOCount=diskIOCount, lunCompressedRatio=lunCompressedRatio, diskRandomIOCount=diskRandomIOCount, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolIndex=poolIndex, targetGroupCreateCompleted=targetGroupCreateCompleted, globalStatistics=globalStatistics, shareReservedSizeHigh=shareReservedSizeHigh)
