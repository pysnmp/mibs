...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:54:20 2022
...
MibIdentifier, Unsigned32, Counter64, enterprises, TimeTicks, Gauge32, ObjectIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, NotificationType, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Counter64", "enterprises", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "NotificationType", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalWriteMbps=poolTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, lunProtocol=lunProtocol, networkInterfaceUp=networkInterfaceUp, diskSequentialIOCount=diskSequentialIOCount, networkTotalTransmitMbps=networkTotalTransmitMbps, poolEntry=poolEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, controllerHardwareModel=controllerHardwareModel, projectTotalSaving=projectTotalSaving, nvdimmFailUnknownError=nvdimmFailUnknownError, cacheRAMReads=cacheRAMReads, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, tegileArray=tegileArray, ipmiFan=ipmiFan, iscsiInitiatorIndex=iscsiInitiatorIndex, sensorFailureEvent=sensorFailureEvent, projectCreatedSuccessfully=projectCreatedSuccessfully, shareName=shareName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, notificationObjects=notificationObjects, shareNFSEnabled=shareNFSEnabled, poolHealth=poolHealth, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareCIFSReadIops=shareCIFSReadIops, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaReadMbps=poolMetaReadMbps, diskSizeHigh=diskSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snapshotCloningFailed=snapshotCloningFailed, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationAborted=replicationAborted, poolCount=poolCount, diskTotalWriteIops=diskTotalWriteIops, cpuInterrupts=cpuInterrupts, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snmpAgentVersion=snmpAgentVersion, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, volumeModifyCompleted=volumeModifyCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetIndex=fcTargetIndex, ipmiVoltage=ipmiVoltage, upgradeTimeout=upgradeTimeout, diskDataReadIops=diskDataReadIops, haResourceDescription=haResourceDescription, upgradeStarted=upgradeStarted, replicationStarted=replicationStarted, haResourceGroup=haResourceGroup, lunReadMbps=lunReadMbps, iscsiTargetAlias=iscsiTargetAlias, cacheTotalWriteIops=cacheTotalWriteIops, poolDataWriteLatency=poolDataWriteLatency, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationReadingUnit=notificationReadingUnit, lunCompressedRatio=lunCompressedRatio, notificationSeverity=notificationSeverity, notificationSensorSuspect=notificationSensorSuspect, currentNotificationGroup=currentNotificationGroup, unknownSensorEvent=unknownSensorEvent, diskSlowIo=diskSlowIo, ipmiMemory=ipmiMemory, poolReadCacheWriteMbps=poolReadCacheWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolProjects=poolProjects, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, haControllerA_IPAddr=haControllerA_IPAddr, lunIndex=lunIndex, projectDataSizeHigh=projectDataSizeHigh, userLoginFailed=userLoginFailed, projectLUNs=projectLUNs, diskTotalReadIops=diskTotalReadIops, poolAvgReadLatency=poolAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, ipmiOther=ipmiOther, snapshotCreationFailed=snapshotCreationFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunProjectName=lunProjectName, iscsiInitiatorGroup=iscsiInitiatorGroup, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolWriteCacheWriteIops=poolWriteCacheWriteIops, replicationFailed=replicationFailed, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, currentObjectGroup=currentObjectGroup, fcInitiators=fcInitiators, lunDataSizeLow=lunDataSizeLow, lunDataSizeHigh=lunDataSizeHigh, projectTable=projectTable, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetStatus=fcTargetStatus, notificationComponentName=notificationComponentName, lunWriteIops=lunWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, smbSocketFailure=smbSocketFailure, cpuSystemCalls=cpuSystemCalls, cifsTotalReadIops=cifsTotalReadIops, poolDataReadMbps=poolDataReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunReadIops=lunReadIops, shareQuotaHigh=shareQuotaHigh, poolUpgraded=poolUpgraded, projectDedupEnabled=projectDedupEnabled, controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, cpuTotalUsage=cpuTotalUsage, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haControllerB_IPAddr=haControllerB_IPAddr, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectCompressionEnabled=projectCompressionEnabled, snmpServiceStopFailed=snmpServiceStopFailed, projectShares=projectShares, upgradeDownloadStarted=upgradeDownloadStarted, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargets=iscsiTargets, haControllerA_Uptime=haControllerA_Uptime, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, pools=pools, shareNFSWriteMbps=shareNFSWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, sanProperties=sanProperties, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetName=iscsiTargetName, lunFreeSizeHigh=lunFreeSizeHigh, testNotification=testNotification, maintenanceModeDisabled=maintenanceModeDisabled, projectFreeSizeLow=projectFreeSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, poolIndex=poolIndex, haResourceIndex=haResourceIndex, nicReceiveMbps=nicReceiveMbps, iscsiTargetAuth=iscsiTargetAuth, shareCIFSEnabled=shareCIFSEnabled, shareNFSReadLatency=shareNFSReadLatency, haControllerB_Name=haControllerB_Name, notificationSensorNumber=notificationSensorNumber, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunDedupEnabled=lunDedupEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSWriteIops=shareNFSWriteIops, controllerTimeDrift=controllerTimeDrift, fcInitiatorEntry=fcInitiatorEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, lunName=lunName, lunPoolName=lunPoolName, fcTargetName=fcTargetName, networkIpmpGroupUp=networkIpmpGroupUp, fcAvgReadLatency=fcAvgReadLatency, upgradeFailed=upgradeFailed, diskAlias=diskAlias, replicationPaused=replicationPaused, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snmpServiceStopped=snmpServiceStopped, fcPortOnline=fcPortOnline, projectThresholdExceedWarning=projectThresholdExceedWarning, nfsAvgReadLatency=nfsAvgReadLatency, notificationEventCode=notificationEventCode, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetsTable=fcTargetsTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolTotalSaving=poolTotalSaving, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareEntry=shareEntry, cacheSSDReads=cacheSSDReads, projectDeletionFailed=projectDeletionFailed, shareNFSWriteLatency=shareNFSWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, shareDataSizeLow=shareDataSizeLow, iscsiTargetError=iscsiTargetError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolProjectCount=poolProjectCount, fcTotalReadIops=fcTotalReadIops, diskSizeLow=diskSizeLow, shareIndex=shareIndex, aclMigrationCompleted=aclMigrationCompleted, projectFreeSizeHigh=projectFreeSizeHigh, fcTargetReadLatency=fcTargetReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, diagnosticDataUploaded=diagnosticDataUploaded, projectQuotaSizeHigh=projectQuotaSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, haResourceActiveNode=haResourceActiveNode, tegileArray_notifications=tegileArray_notifications, projectDeleted=projectDeleted, volumeQuotaFinished=volumeQuotaFinished, poolDeleted=poolDeleted, volumeDeleteFailed=volumeDeleteFailed, snapshotDeleteFailed=snapshotDeleteFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunBlockSize=lunBlockSize, poolImported=poolImported, lunSizeHigh=lunSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationDescription=notificationDescription, lunGUID=lunGUID, replicationComplete=replicationComplete, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiTargetWriteLatency=iscsiTargetWriteLatency, tegileCompliances=tegileCompliances, notificationTime=notificationTime, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcTargetGroup=fcTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, spareDiskReplaced=spareDiskReplaced, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareTable=shareTable, fcTargetReadMbps=fcTargetReadMbps, haResourceStatus=haResourceStatus, basicCompliance=basicCompliance, disks=disks, diskState=diskState, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolFreeSizeLow=poolFreeSizeLow, fcTargetEntry=fcTargetEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiInitiatorEntry=iscsiInitiatorEntry, nicName=nicName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolTable=poolTable, fcTargetWriteLatency=fcTargetWriteLatency, smisServiceStartFailed=smisServiceStartFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully)
mibBuilder.exportSymbols("TEGILE-MIB", targetGroupCreateCompleted=targetGroupCreateCompleted, deleteFolderCompleted=deleteFolderCompleted, fcInitiatorName=fcInitiatorName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetIndex=iscsiTargetIndex, fcInitiatorIndex=fcInitiatorIndex, iscsiInitiators=iscsiInitiators, lunEntry=lunEntry, haResources=haResources, diskGoneOffline=diskGoneOffline, shareDeletionFailed=shareDeletionFailed, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetEntry=iscsiTargetEntry, aclMigrationStarted=aclMigrationStarted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectEntry=projectEntry, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolMetaWriteIops=poolMetaWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectPoolName=projectPoolName, lunInitiatorGroup=lunInitiatorGroup, diskCount=diskCount, deleteFolderFailed=deleteFolderFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, poolMetaReadLatency=poolMetaReadLatency, poolCreated=poolCreated, shareReservedSizeHigh=shareReservedSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectLunCount=projectLunCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationSensorAction=notificationSensorAction, volumeDeleteCompleted=volumeDeleteCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunWriteMbps=lunWriteMbps, shareCompressionEnabled=shareCompressionEnabled, upgradeCompleted=upgradeCompleted, haResourceName=haResourceName, poolFreeSizeHigh=poolFreeSizeHigh, ipmiPowerSupply=ipmiPowerSupply, properties=properties, shareQuotaLow=shareQuotaLow, iscsiTargetReadMbps=iscsiTargetReadMbps, fcProperties=fcProperties, shareReservedSizeLow=shareReservedSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunReservedSizeLow=lunReservedSizeLow, replicationAbandoned=replicationAbandoned, diskError=diskError, nicIndex=nicIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolTotalReadMbps=poolTotalReadMbps, ipmiThreshold=ipmiThreshold, targetGroupMemberRemoved=targetGroupMemberRemoved, diskIsOnline=diskIsOnline, poolDataReadLatency=poolDataReadLatency, nicTable=nicTable, diskType=diskType, lunSnapshotSizeLow=lunSnapshotSizeLow, snmpServiceStarted=snmpServiceStarted, cifsAvgReadLatency=cifsAvgReadLatency, haControllerA_Name=haControllerA_Name, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskDataReadMbps=diskDataReadMbps, poolTotalReadIops=poolTotalReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareDataSizeHigh=shareDataSizeHigh, poolDataReadIops=poolDataReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, adServerTimeDrift=adServerTimeDrift, network=network, iscsiTargetGroup=iscsiTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDataSizeLow=poolDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, sharePoolName=sharePoolName, ipmiTemperature=ipmiTemperature, diskPoolName=diskPoolName, iscsiTotalReadIops=iscsiTotalReadIops, poolName=poolName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, lunReadLatency=lunReadLatency, poolOwnerController=poolOwnerController, smisServiceStarted=smisServiceStarted, iscsiTargetsTable=iscsiTargetsTable, smisServiceStopFailed=smisServiceStopFailed, tegileConformance=tegileConformance, poolSizeLow=poolSizeLow, haResourcesTable=haResourcesTable, poolExpanded=poolExpanded, poolReadCacheReadIops=poolReadCacheReadIops, projectModified=projectModified, fcTargets=fcTargets, volumeCreatedSuccessfully=volumeCreatedSuccessfully, PYSNMP_MODULE_ID=tegile, shareCompressedRatio=shareCompressedRatio, projectQuotaFinished=projectQuotaFinished, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcInitiatorGroup=fcInitiatorGroup, snmpServiceStartFailed=snmpServiceStartFailed, smisServiceStopped=smisServiceStopped, shareDedupEnabled=shareDedupEnabled, poolMetaReadIops=poolMetaReadIops, tegile=tegile, shareDeleted=shareDeleted, cacheTotalWriteMbps=cacheTotalWriteMbps, diskRandomIOCount=diskRandomIOCount, poolDataWriteIops=poolDataWriteIops, replicationSourceRegistered=replicationSourceRegistered, targetGroupMemberAdded=targetGroupMemberAdded, diskDataWriteMbps=diskDataWriteMbps, poolUsedSizeLow=poolUsedSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTotalWriteIops=fcTotalWriteIops, haResourceEntry=haResourceEntry, diskIOCount=diskIOCount, notificationProps=notificationProps, nicGroup=nicGroup, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicState=nicState, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTargetWriteMbps=fcTargetWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, netbiosSocketFailure=netbiosSocketFailure, lunTargetGroup=lunTargetGroup, diskAvgReadLatency=diskAvgReadLatency, shareProjectName=shareProjectName, nfsTotalReadMbps=nfsTotalReadMbps, poolQuotaFinished=poolQuotaFinished, replicationResumed=replicationResumed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cacheTotalReadIops=cacheTotalReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTotalWriteIops=poolTotalWriteIops, poolDegraded=poolDegraded, notificationTargetEntityName=notificationTargetEntityName, nicEntry=nicEntry, poolDataSizeHigh=poolDataSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareQuotaFinished=shareQuotaFinished, diskDataWriteIops=diskDataWriteIops, lunSizeLow=lunSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, lunTable=lunTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetReadIops=fcTargetReadIops, notifications=notifications, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectName=projectName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolState=poolState, diskEntry=diskEntry, diskTable=diskTable, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiProperties=iscsiProperties, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataWriteMbps=poolDataWriteMbps, memoryFailure=memoryFailure, nicMTU=nicMTU, lunFreeSizeLow=lunFreeSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiatorsTable=fcInitiatorsTable, nvdimmFailSoftError=nvdimmFailSoftError, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolDeletionFailed=poolDeletionFailed, diskIndex=diskIndex, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiWriteIops=iscsiWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, shareMountPoint=shareMountPoint, tegileGroups=tegileGroups, fcTotalReadMbps=fcTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, projectIndex=projectIndex, poolExported=poolExported, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ntpServerTimeDrift=ntpServerTimeDrift, projectShareCount=projectShareCount, iscsiInitiatorName=iscsiInitiatorName, globalStatistics=globalStatistics, diskChassisIdx=diskChassisIdx, iscsiAvgWriteLatency=iscsiAvgWriteLatency, ipmiCurrent=ipmiCurrent, diskTotalReadMbps=diskTotalReadMbps, controllerUp=controllerUp, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolSizeHigh=poolSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, fcPortOffline=fcPortOffline, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nfsTotalReadIops=nfsTotalReadIops)
