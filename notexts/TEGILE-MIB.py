...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:07:23 2023
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Unsigned32, TimeTicks, ObjectIdentity, NotificationType, Integer32, ModuleIdentity, Bits, Counter32, Counter64, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Unsigned32", "TimeTicks", "ObjectIdentity", "NotificationType", "Integer32", "ModuleIdentity", "Bits", "Counter32", "Counter64", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectModified=projectModified, haControllerA_IPAddr=haControllerA_IPAddr, fcTotalWriteMbps=fcTotalWriteMbps, fcTotalWriteIops=fcTotalWriteIops, cpuTotalUsage=cpuTotalUsage, cifsAvgReadLatency=cifsAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, notificationEventCode=notificationEventCode, lunPoolName=lunPoolName, iscsiInitiatorName=iscsiInitiatorName, shareDedupEnabled=shareDedupEnabled, haControllerA_Uptime=haControllerA_Uptime, smisServiceStopped=smisServiceStopped, fcTotalReadIops=fcTotalReadIops, shareCompressionEnabled=shareCompressionEnabled, lunEntry=lunEntry, lunReservedSizeHigh=lunReservedSizeHigh, shareName=shareName, nicReceiveMbps=nicReceiveMbps, currentNotificationGroup=currentNotificationGroup, shareTable=shareTable, shareCIFSReadLatency=shareCIFSReadLatency, projectLunCount=projectLunCount, lunTargetGroup=lunTargetGroup, diskIsOnline=diskIsOnline, poolTotalReadMbps=poolTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataSizeLow=poolDataSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, poolSizeHigh=poolSizeHigh, snmpAgentVersion=snmpAgentVersion, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectDataSizeLow=projectDataSizeLow, haControllerA_Name=haControllerA_Name, notificationSensorAction=notificationSensorAction, projectCompressionEnabled=projectCompressionEnabled, volumeModifyCompleted=volumeModifyCompleted, volumeQuotaFinished=volumeQuotaFinished, shareReservedSizeHigh=shareReservedSizeHigh, diskTotalReadMbps=diskTotalReadMbps, projectPoolName=projectPoolName, fcTargetName=fcTargetName, tegileArray=tegileArray, iscsiTargetAuth=iscsiTargetAuth, ipmiTemperature=ipmiTemperature, upgradeFailed=upgradeFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunSnapshotSizeHigh=lunSnapshotSizeHigh, sanProperties=sanProperties, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorGroup=iscsiInitiatorGroup, tegileGroups=tegileGroups, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskTotalWriteIops=diskTotalWriteIops, replicationResumed=replicationResumed, cpuSystemCalls=cpuSystemCalls, fcInitiatorsTable=fcInitiatorsTable, lunWriteMbps=lunWriteMbps, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCompressedRatio=shareCompressedRatio, tdpsUpgradeTimeout=tdpsUpgradeTimeout, ipmiVoltage=ipmiVoltage, shareNFSWriteIops=shareNFSWriteIops, haResourceIndex=haResourceIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, replicationAbandoned=replicationAbandoned, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicGroup=nicGroup, projectQuotaFinished=projectQuotaFinished, notificationProps=notificationProps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolQuotaFinished=poolQuotaFinished, iscsiTargets=iscsiTargets, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolName=poolName, projectDeletionFailed=projectDeletionFailed, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskSizeHigh=diskSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotCloningFailed=snapshotCloningFailed, nicIndex=nicIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunCompressedRatio=lunCompressedRatio, fcTargetWriteIops=fcTargetWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskRandomIOCount=diskRandomIOCount, shareIndex=shareIndex, nfsTotalReadIops=nfsTotalReadIops, haResourceEntry=haResourceEntry, notifications=notifications, shareDeletionFailed=shareDeletionFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskIndex=diskIndex, diskTotalReadIops=diskTotalReadIops, fcInitiatorIndex=fcInitiatorIndex, smbSocketFailure=smbSocketFailure, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolMetaWriteLatency=poolMetaWriteLatency, shareQuotaFinished=shareQuotaFinished, shareSnapshotSizeHigh=shareSnapshotSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, lunCompressionEnabled=lunCompressionEnabled, snapshotDeleteFailed=snapshotDeleteFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetsTable=iscsiTargetsTable, projectThresholdExceedWarning=projectThresholdExceedWarning, nfsAvgWriteLatency=nfsAvgWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareEntry=shareEntry, haResourceActiveNode=haResourceActiveNode, replicationStarted=replicationStarted, targetGroupMemberRemoved=targetGroupMemberRemoved, poolState=poolState, lunDataSizeHigh=lunDataSizeHigh, diskPoolName=diskPoolName, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolDataWriteLatency=poolDataWriteLatency, poolDeletionFailed=poolDeletionFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, fcAvgReadLatency=fcAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, tegile=tegile, lunIndex=lunIndex, iscsiTotalReadIops=iscsiTotalReadIops, fcPortOffline=fcPortOffline, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetReadIops=iscsiTargetReadIops, lunReservedSizeLow=lunReservedSizeLow, diskState=diskState, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, deleteFolderCompleted=deleteFolderCompleted, poolMetaWriteMbps=poolMetaWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, ipmiPowerSupply=ipmiPowerSupply, fcAvgWriteLatency=fcAvgWriteLatency, projectIndex=projectIndex, cacheRAMReads=cacheRAMReads, diskCount=diskCount, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetAlias=iscsiTargetAlias, cacheSSDReads=cacheSSDReads, poolFreeSizeLow=poolFreeSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, poolTotalReadIops=poolTotalReadIops, shareReservedSizeLow=shareReservedSizeLow, lunDataSizeLow=lunDataSizeLow, tegileArray_notifications=tegileArray_notifications, controllerUp=controllerUp, poolProjectCount=poolProjectCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskSlowIo=diskSlowIo, tegileConformance=tegileConformance, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareMountPoint=shareMountPoint, poolMetaReadLatency=poolMetaReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, lunBlockSize=lunBlockSize, lunInitiatorGroup=lunInitiatorGroup, notificationSensorNumber=notificationSensorNumber, shareNFSReadIops=shareNFSReadIops, fcPortOnline=fcPortOnline, fcTargetReadIops=fcTargetReadIops, shareDataSizeHigh=shareDataSizeHigh, poolDataReadIops=poolDataReadIops, notificationObjects=notificationObjects, projectEntry=projectEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, networkIpmpGroupUp=networkIpmpGroupUp, networkInterfaceDown=networkInterfaceDown, network=network, tegileCompliances=tegileCompliances, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nicName=nicName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolUpgraded=poolUpgraded, diskDataReadIops=diskDataReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, volumeDeleteFailed=volumeDeleteFailed, haControllerB_Name=haControllerB_Name, poolDataWriteIops=poolDataWriteIops, poolExported=poolExported, fcInitiatorEntry=fcInitiatorEntry, haResourcesTable=haResourcesTable, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunTable=lunTable, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolHealth=poolHealth, notificationDescription=notificationDescription, iscsiTargetIndex=iscsiTargetIndex, aclMigrationCompleted=aclMigrationCompleted, diagnosticDataUploaded=diagnosticDataUploaded, notificationSeverity=notificationSeverity, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskGoneOffline=diskGoneOffline, haResourceDescription=haResourceDescription, haResources=haResources, projectSnapshotSizeLow=projectSnapshotSizeLow, projectDataSizeHigh=projectDataSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolCreated=poolCreated, deleteFolderFailed=deleteFolderFailed, poolDataReadLatency=poolDataReadLatency, diskDataWriteIops=diskDataWriteIops, userLoginFailed=userLoginFailed, poolProjects=poolProjects, cacheTotalReadMbps=cacheTotalReadMbps, lunProjectName=lunProjectName, fcProperties=fcProperties, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheTotalWriteIops=cacheTotalWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, poolExpanded=poolExpanded, nvdimmFailSoftError=nvdimmFailSoftError, iscsiInitiators=iscsiInitiators, ipmiCurrent=ipmiCurrent, fcTargets=fcTargets)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskChassisIdx=diskChassisIdx, intelliFlashSoftwareUp=intelliFlashSoftwareUp, spareDiskReplaced=spareDiskReplaced, haResourceName=haResourceName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiTargetGroup=iscsiTargetGroup, projectFreeSizeLow=projectFreeSizeLow, diskIOCount=diskIOCount, projectTotalSaving=projectTotalSaving, fcTotalReadMbps=fcTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, projectQuotaSizeLow=projectQuotaSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, shareQuotaLow=shareQuotaLow, upgradeStarted=upgradeStarted, replicationFailed=replicationFailed, controllerHardwareModel=controllerHardwareModel, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, smisServiceStartFailed=smisServiceStartFailed, shareCIFSReadIops=shareCIFSReadIops, pools=pools, nicState=nicState, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDeleted=poolDeleted, controllerTimeDrift=controllerTimeDrift, cpuInterrupts=cpuInterrupts, poolDegraded=poolDegraded, poolAvgReadLatency=poolAvgReadLatency, fcTargetGroup=fcTargetGroup, diskError=diskError, cacheTotalReadIops=cacheTotalReadIops, iscsiWriteIops=iscsiWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, upgradeTimeout=upgradeTimeout, lunReadIops=lunReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetEntry=iscsiTargetEntry, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snapshotCreationFailed=snapshotCreationFailed, nfsTotalWriteIops=nfsTotalWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, poolReadCacheWriteIops=poolReadCacheWriteIops, lunReadLatency=lunReadLatency, poolCount=poolCount, projectName=projectName, smisServiceStarted=smisServiceStarted, shareDeleted=shareDeleted, properties=properties, notificationReadingUnit=notificationReadingUnit, lunFreeSizeHigh=lunFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, replicationComplete=replicationComplete, poolOwnerController=poolOwnerController, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceGroup=haResourceGroup, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, poolTable=poolTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, replicationSourceRegistered=replicationSourceRegistered, shareProjectName=shareProjectName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, disks=disks, currentObjectGroup=currentObjectGroup, poolImported=poolImported, replicationTargetDeleted=replicationTargetDeleted, cifsTotalReadMbps=cifsTotalReadMbps, ipmiMemory=ipmiMemory, diskType=diskType, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStarted=snmpServiceStarted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskTotalWriteMbps=diskTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, lunReadMbps=lunReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, lunName=lunName, haControllerB_IPAddr=haControllerB_IPAddr, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorEntry=iscsiInitiatorEntry, poolDataSizeHigh=poolDataSizeHigh, poolEntry=poolEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetError=iscsiTargetError, basicCompliance=basicCompliance, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalReadMbps=nfsTotalReadMbps, diskSequentialIOCount=diskSequentialIOCount, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCIFSEnabled=shareCIFSEnabled, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetIndex=fcTargetIndex, upgradeCompleted=upgradeCompleted, diskSizeLow=diskSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetReadLatency=fcTargetReadLatency, shareNFSReadLatency=shareNFSReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, lunDedupEnabled=lunDedupEnabled, lunProtocol=lunProtocol, sharePoolName=sharePoolName, projectLUNs=projectLUNs, ipmiFan=ipmiFan, shareNFSEnabled=shareNFSEnabled, memoryFailure=memoryFailure, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceStatus=haResourceStatus, nicEntry=nicEntry, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haControllerB_Uptime=haControllerB_Uptime, shareNFSReadMbps=shareNFSReadMbps, poolSizeLow=poolSizeLow, ipmiThreshold=ipmiThreshold, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, notificationComponentName=notificationComponentName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunSizeLow=lunSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, nvdimmFailDeviceError=nvdimmFailDeviceError, volumeDeleteCompleted=volumeDeleteCompleted, shareQuotaHigh=shareQuotaHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectShareCount=projectShareCount, nfsAvgReadLatency=nfsAvgReadLatency, notificationSensorSuspect=notificationSensorSuspect, diskAlias=diskAlias, poolDataWriteMbps=poolDataWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, snmpServiceStartFailed=snmpServiceStartFailed, shareNFSWriteLatency=shareNFSWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, replicationAborted=replicationAborted, diskEntry=diskEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetWriteMbps=fcTargetWriteMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, fcTargetReadMbps=fcTargetReadMbps, smisServiceStopFailed=smisServiceStopFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolIndex=poolIndex, unknownSensorEvent=unknownSensorEvent, iscsiProperties=iscsiProperties, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, networkInterfaceUp=networkInterfaceUp, cifsTotalReadIops=cifsTotalReadIops, diskAvgReadLatency=diskAvgReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, lunGUID=lunGUID, diskAvgWriteLatency=diskAvgWriteLatency, notificationTime=notificationTime, netbiosSocketFailure=netbiosSocketFailure, poolMetaWriteIops=poolMetaWriteIops, projectTable=projectTable, PYSNMP_MODULE_ID=tegile, fcInitiatorCreateFailed=fcInitiatorCreateFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetName=iscsiTargetName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunWriteLatency=lunWriteLatency, shareDataSizeLow=shareDataSizeLow, nicMTU=nicMTU, sensorFailureEvent=sensorFailureEvent, ipmiOther=ipmiOther, nicTable=nicTable, nicTransmitMbps=nicTransmitMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, targetGroupCreateCompleted=targetGroupCreateCompleted, projectShares=projectShares, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, testNotification=testNotification, snapshotCloneCompleted=snapshotCloneCompleted, aclMigrationStarted=aclMigrationStarted, poolTotalWriteMbps=poolTotalWriteMbps, projectDeleted=projectDeleted, poolDataReadMbps=poolDataReadMbps, diskDataWriteMbps=diskDataWriteMbps, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, replicationPaused=replicationPaused, fcInitiators=fcInitiators, diskTable=diskTable, lunWriteIops=lunWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetWriteLatency=fcTargetWriteLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskDataReadMbps=diskDataReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, controllerDown=controllerDown, cacheTotalWriteMbps=cacheTotalWriteMbps, snmpServiceStopped=snmpServiceStopped, globalStatistics=globalStatistics, lunSizeHigh=lunSizeHigh)
