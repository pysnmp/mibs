...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:59:55 2021
...
mibBuilder.exportSymbols("TEGILE-MIB", haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nicMTU=nicMTU, shareDeleted=shareDeleted, iscsiTargetsTable=iscsiTargetsTable, lunFreeSizeHigh=lunFreeSizeHigh, poolDeleted=poolDeleted, controllerHardwareModel=controllerHardwareModel, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectShares=projectShares, poolDeletionFailed=poolDeletionFailed, poolCount=poolCount, sharePoolName=sharePoolName, tegileConformance=tegileConformance, nicName=nicName, poolSizeLow=poolSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, memoryFailure=memoryFailure, smbSocketFailure=smbSocketFailure, properties=properties, upgradeStarted=upgradeStarted, notificationSensorNumber=notificationSensorNumber, cpuInterrupts=cpuInterrupts, haResourceGroup=haResourceGroup, shareNFSWriteLatency=shareNFSWriteLatency, fcTargetReadIops=fcTargetReadIops, upgradeFailed=upgradeFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiVoltage=ipmiVoltage, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiators=iscsiInitiators, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notifications=notifications, tegile=tegile, iscsiAvgReadLatency=iscsiAvgReadLatency, poolSizeHigh=poolSizeHigh, poolFreeSizeLow=poolFreeSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, haControllerB_IPAddr=haControllerB_IPAddr, poolDegraded=poolDegraded, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorIndex=fcInitiatorIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, nicGroup=nicGroup, shareDataSizeLow=shareDataSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResources=haResources, lunTargetGroup=lunTargetGroup, fcProperties=fcProperties, shareProjectName=shareProjectName, diskType=diskType, iscsiInitiatorsTable=iscsiInitiatorsTable, lunSnapshotSizeLow=lunSnapshotSizeLow, poolOwnerController=poolOwnerController, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haResourceIndex=haResourceIndex, diskDataReadMbps=diskDataReadMbps, fcTargetWriteIops=fcTargetWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotCloningFailed=snapshotCloningFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTargetReadMbps=iscsiTargetReadMbps, shareNFSReadLatency=shareNFSReadLatency, fcTargetsTable=fcTargetsTable, diskTable=diskTable, poolProjectCount=poolProjectCount, diskTotalReadMbps=diskTotalReadMbps, lunFreeSizeLow=lunFreeSizeLow, cifsTotalReadMbps=cifsTotalReadMbps, notificationComponentName=notificationComponentName, poolExported=poolExported, aclMigrationCompleted=aclMigrationCompleted, poolHealth=poolHealth, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaReadMbps=poolMetaReadMbps, projectIndex=projectIndex, ipmiOther=ipmiOther, aclMigrationStarted=aclMigrationStarted, spareDiskReplaced=spareDiskReplaced, poolEntry=poolEntry, replicationComplete=replicationComplete, shareDedupEnabled=shareDedupEnabled, lunReservedSizeLow=lunReservedSizeLow, controllerUp=controllerUp, ipmiMemory=ipmiMemory, shareDeletionFailed=shareDeletionFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectEntry=projectEntry, projectTable=projectTable, networkTotalTransmitMbps=networkTotalTransmitMbps, snapshotDeleteFailed=snapshotDeleteFailed, shareTable=shareTable, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, shareExceedThresholdWarning=shareExceedThresholdWarning, nicTransmitMbps=nicTransmitMbps, ntpServerTimeDrift=ntpServerTimeDrift, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationDescription=notificationDescription, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetStatus=fcTargetStatus, shareSnapshotSizeLow=shareSnapshotSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskState=diskState, nvdimmFailInitializationError=nvdimmFailInitializationError, lunName=lunName, lunPoolName=lunPoolName, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationSeverity=notificationSeverity, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolAvgReadLatency=poolAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunProtocol=lunProtocol, iscsiTargetAuth=iscsiTargetAuth, fcInitiatorName=fcInitiatorName, shareEntry=shareEntry, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceStatus=haResourceStatus, diskTotalReadIops=diskTotalReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tegileCompliances=tegileCompliances, lunWriteLatency=lunWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectQuotaFinished=projectQuotaFinished, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, PYSNMP_MODULE_ID=tegile, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, volumeModifyCompleted=volumeModifyCompleted, cifsTotalReadIops=cifsTotalReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCompressedRatio=shareCompressedRatio, fcTargetReadMbps=fcTargetReadMbps, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolQuotaFinished=poolQuotaFinished, fcTotalReadIops=fcTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunGUID=lunGUID, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, currentNotificationGroup=currentNotificationGroup, snmpServiceStopFailed=snmpServiceStopFailed, shareDataSizeHigh=shareDataSizeHigh, diskDataWriteIops=diskDataWriteIops, controllerDown=controllerDown, iscsiInitiatorName=iscsiInitiatorName, poolDataWriteMbps=poolDataWriteMbps, lunDataSizeLow=lunDataSizeLow, shareReservedSizeLow=shareReservedSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargets=iscsiTargets, ipmiTemperature=ipmiTemperature, fcPortOnline=fcPortOnline, diskRandomIOCount=diskRandomIOCount, snmpServiceStartFailed=snmpServiceStartFailed, haControllerA_Name=haControllerA_Name, poolExpanded=poolExpanded, webdocsUpgradeFailed=webdocsUpgradeFailed, controllerTimeDrift=controllerTimeDrift, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetGroup=fcTargetGroup, tegileArray_notifications=tegileArray_notifications, poolDataSizeHigh=poolDataSizeHigh, diskAvgWriteLatency=diskAvgWriteLatency, poolMetaReadLatency=poolMetaReadLatency, nicState=nicState, poolReadCacheReadIops=poolReadCacheReadIops, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, testNotification=testNotification, basicCompliance=basicCompliance, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunProjectName=lunProjectName, cacheTotalReadMbps=cacheTotalReadMbps, projectDeleted=projectDeleted, fcTargetIndex=fcTargetIndex, diskAvgReadLatency=diskAvgReadLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationSensorSuspect=notificationSensorSuspect, projectFreeSizeLow=projectFreeSizeLow, ipmiFan=ipmiFan, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTotalWriteIops=fcTotalWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunBlockSize=lunBlockSize, diskError=diskError, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snmpServiceStopped=snmpServiceStopped, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetName=fcTargetName, diskSlowIo=diskSlowIo, intelliFlashSoftwareUp=intelliFlashSoftwareUp, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, targetGroupMemberRemoved=targetGroupMemberRemoved, smisServiceStopFailed=smisServiceStopFailed, cacheTotalReadIops=cacheTotalReadIops, projectDedupEnabled=projectDedupEnabled, shareCreatedSuccessfully=shareCreatedSuccessfully, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareNFSReadMbps=shareNFSReadMbps, netbiosSocketFailure=netbiosSocketFailure, poolTotalSaving=poolTotalSaving, projectQuotaSizeLow=projectQuotaSizeLow, cpuSystemCalls=cpuSystemCalls, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetEntry=iscsiTargetEntry, projectQuotaSizeHigh=projectQuotaSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSWriteIops=shareNFSWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, smisServiceStartFailed=smisServiceStartFailed, disks=disks, lunTable=lunTable, shareQuotaLow=shareQuotaLow, shareCIFSWriteLatency=shareCIFSWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, lunEntry=lunEntry, poolMetaWriteIops=poolMetaWriteIops, lunCompressionEnabled=lunCompressionEnabled, lunInitiatorGroup=lunInitiatorGroup, snmpAgentVersion=snmpAgentVersion)
mibBuilder.exportSymbols("TEGILE-MIB", lunDedupEnabled=lunDedupEnabled, diskSequentialIOCount=diskSequentialIOCount, iscsiTargetAlias=iscsiTargetAlias, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolMetaWriteMbps=poolMetaWriteMbps, poolUsedSizeLow=poolUsedSizeLow, userLoginFailed=userLoginFailed, notificationObjects=notificationObjects, snmpServiceStarted=snmpServiceStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationEventCode=notificationEventCode, shareNFSWriteMbps=shareNFSWriteMbps, haResourcesTable=haResourcesTable, fcAvgReadLatency=fcAvgReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicEntry=nicEntry, notificationTime=notificationTime, lunReadLatency=lunReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, diskChassisIdx=diskChassisIdx, projectLUNs=projectLUNs, currentObjectGroup=currentObjectGroup, deleteFolderCompleted=deleteFolderCompleted, replicationResumed=replicationResumed, poolAvgWriteLatency=poolAvgWriteLatency, notificationTargetEntityName=notificationTargetEntityName, diskIndex=diskIndex, notificationSensorAction=notificationSensorAction, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectLunCount=projectLunCount, haResourceDescription=haResourceDescription, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargets=fcTargets, deleteFolderFailed=deleteFolderFailed, lunDataSizeHigh=lunDataSizeHigh, lunReadIops=lunReadIops, projectModified=projectModified, cacheRAMReads=cacheRAMReads, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTargetReadLatency=fcTargetReadLatency, poolDataWriteIops=poolDataWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunWriteIops=lunWriteIops, networkInterfaceDown=networkInterfaceDown, tdpsUpgradeFailed=tdpsUpgradeFailed, sensorFailureEvent=sensorFailureEvent, fcTotalReadMbps=fcTotalReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareIndex=shareIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceName=haResourceName, projectThresholdExceedWarning=projectThresholdExceedWarning, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationTargetDeleted=replicationTargetDeleted, upgradeCompleted=upgradeCompleted, shareCompressionEnabled=shareCompressionEnabled, shareCIFSWriteIops=shareCIFSWriteIops, volumeQuotaFinished=volumeQuotaFinished, shareNFSReadIops=shareNFSReadIops, shareNFSEnabled=shareNFSEnabled, nicTable=nicTable, diskIOCount=diskIOCount, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolTable=poolTable, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceEntry=haResourceEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectPoolName=projectPoolName, shareMountPoint=shareMountPoint, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareQuotaHigh=shareQuotaHigh, diskDataWriteMbps=diskDataWriteMbps, fcInitiators=fcInitiators, diskAlias=diskAlias, lunSizeLow=lunSizeLow, notificationReadingUnit=notificationReadingUnit, shareCIFSReadMbps=shareCIFSReadMbps, projectDataSizeLow=projectDataSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolTotalWriteIops=poolTotalWriteIops, poolDataReadIops=poolDataReadIops, replicationStarted=replicationStarted, projectCompressionEnabled=projectCompressionEnabled, replicationFailed=replicationFailed, targetGroupMemberAdded=targetGroupMemberAdded, poolCreated=poolCreated, lunCompressedRatio=lunCompressedRatio, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiWriteIops=iscsiWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, shareName=shareName, diskEntry=diskEntry, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetReadIops=iscsiTargetReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haControllerA_Uptime=haControllerA_Uptime, diskGoneOffline=diskGoneOffline, volumeDeleteFailed=volumeDeleteFailed, fcInitiatorsTable=fcInitiatorsTable, projectDeletionFailed=projectDeletionFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, poolTotalReadMbps=poolTotalReadMbps, tegileArray=tegileArray, shareCIFSReadIops=shareCIFSReadIops, networkInterfaceUp=networkInterfaceUp, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haControllerA_IPAddr=haControllerA_IPAddr, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, replicationAborted=replicationAborted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolState=poolState, poolTotalReadIops=poolTotalReadIops, iscsiTargetError=iscsiTargetError, projectCreatedSuccessfully=projectCreatedSuccessfully, diskCount=diskCount, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, adServerTimeDrift=adServerTimeDrift, replicationPaused=replicationPaused, globalStatistics=globalStatistics, poolTotalWriteMbps=poolTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, fcTargetWriteMbps=fcTargetWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, poolMetaReadIops=poolMetaReadIops, iscsiProperties=iscsiProperties, poolFreeSizeHigh=poolFreeSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, nicReceiveMbps=nicReceiveMbps, poolProjects=poolProjects, lunReadMbps=lunReadMbps, snapshotCreationFailed=snapshotCreationFailed, upgradeTimeout=upgradeTimeout, iscsiInitiatorGroup=iscsiInitiatorGroup, nvdimmFailSoftError=nvdimmFailSoftError, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nicIndex=nicIndex, lunSizeHigh=lunSizeHigh, diskPoolName=diskPoolName, fcPortOffline=fcPortOffline, sanProperties=sanProperties, fcTargetWriteLatency=fcTargetWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationSourceRegistered=replicationSourceRegistered, tegileGroups=tegileGroups, lunIndex=lunIndex, diskIsOnline=diskIsOnline, iscsiInitiatorChapUser=iscsiInitiatorChapUser, cifsTotalWriteMbps=cifsTotalWriteMbps, haResourceActiveNode=haResourceActiveNode, iscsiTotalWriteMbps=iscsiTotalWriteMbps, smisServiceStopped=smisServiceStopped, networkIpmpGroupDown=networkIpmpGroupDown, lunWriteMbps=lunWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetEntry=fcTargetEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, network=network, cacheSSDReads=cacheSSDReads, haControllerB_Name=haControllerB_Name, iscsiTargetName=iscsiTargetName, poolName=poolName, projectName=projectName, iscsiTotalReadIops=iscsiTotalReadIops, cpuTotalUsage=cpuTotalUsage, poolUpgraded=poolUpgraded, poolImported=poolImported, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSEnabled=shareCIFSEnabled, pools=pools, fcTargetModifyCompleted=fcTargetModifyCompleted, unknownSensorEvent=unknownSensorEvent, poolDataSizeLow=poolDataSizeLow, diskSizeLow=diskSizeLow, replicationAbandoned=replicationAbandoned, ipmiThreshold=ipmiThreshold, maintenanceModeEnabled=maintenanceModeEnabled, notificationProps=notificationProps, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiCurrent=ipmiCurrent, fcInitiatorEntry=fcInitiatorEntry, poolIndex=poolIndex, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiPowerSupply=ipmiPowerSupply, fcAvgWriteLatency=fcAvgWriteLatency, poolDataReadLatency=poolDataReadLatency, diskDataReadIops=diskDataReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cacheTotalWriteIops=cacheTotalWriteIops, projectTotalSaving=projectTotalSaving)
