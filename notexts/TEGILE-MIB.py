...
MibIdentifier, Gauge32, NotificationType, iso, Unsigned32, Counter32, Bits, IpAddress, Integer32, TimeTicks, ObjectIdentity, Counter64, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "NotificationType", "iso", "Unsigned32", "Counter32", "Bits", "IpAddress", "Integer32", "TimeTicks", "ObjectIdentity", "Counter64", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolOwnerController=poolOwnerController, notificationSensorSuspect=notificationSensorSuspect, projectFreeSizeHigh=projectFreeSizeHigh, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetReadMbps=iscsiTargetReadMbps, poolCount=poolCount, haResourceIndex=haResourceIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunCompressedRatio=lunCompressedRatio, poolProjectCount=poolProjectCount, shareDataSizeHigh=shareDataSizeHigh, poolTotalWriteIops=poolTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicMTU=nicMTU, replicationStarted=replicationStarted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetGroupError=iscsiTargetGroupError, haControllerB_IPAddr=haControllerB_IPAddr, diskChassisIdx=diskChassisIdx, lunTargetGroup=lunTargetGroup, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, sanProperties=sanProperties, diskIOCount=diskIOCount, poolName=poolName, lunIndex=lunIndex, shareReservedSizeLow=shareReservedSizeLow, fcInitiatorsTable=fcInitiatorsTable, controllerDown=controllerDown, ipmiMemory=ipmiMemory, poolReadCacheReadMbps=poolReadCacheReadMbps, lunEntry=lunEntry, fcTotalReadMbps=fcTotalReadMbps, lunSizeHigh=lunSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileArray_notifications=tegileArray_notifications, shareNFSReadMbps=shareNFSReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, diskDataReadMbps=diskDataReadMbps, haResourceActiveNode=haResourceActiveNode, lunSnapshotSizeLow=lunSnapshotSizeLow, properties=properties, projectModified=projectModified, iscsiTargets=iscsiTargets, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskError=diskError, lunReservedSizeLow=lunReservedSizeLow, shareTable=shareTable, diskState=diskState, iscsiAvgReadLatency=iscsiAvgReadLatency, diskGoneOffline=diskGoneOffline, poolMetaWriteLatency=poolMetaWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetStatus=fcTargetStatus, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, networkIpmpGroupDown=networkIpmpGroupDown, notificationTime=notificationTime, networkIpmpGroupUp=networkIpmpGroupUp, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectDeletionFailed=projectDeletionFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSWriteIops=shareNFSWriteIops, notificationObjects=notificationObjects, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationReadingUnit=notificationReadingUnit, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotCloneCompleted=snapshotCloneCompleted, cacheTotalReadMbps=cacheTotalReadMbps, poolAvgReadLatency=poolAvgReadLatency, nicEntry=nicEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectIndex=projectIndex, haControllerB_Uptime=haControllerB_Uptime, snapshotRollbackCompleted=snapshotRollbackCompleted, networkInterfaceDown=networkInterfaceDown, ipmiOther=ipmiOther, iscsiTargetsTable=iscsiTargetsTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunProtocol=lunProtocol, diskDataWriteMbps=diskDataWriteMbps, diskSizeLow=diskSizeLow, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectCompressionEnabled=projectCompressionEnabled, diskDataReadIops=diskDataReadIops, poolDataReadMbps=poolDataReadMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, projectPoolName=projectPoolName, poolMetaReadMbps=poolMetaReadMbps, nicName=nicName, controllerTimeDrift=controllerTimeDrift, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunDataSizeHigh=lunDataSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetIndex=fcTargetIndex, fcTotalWriteIops=fcTotalWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunWriteMbps=lunWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, PYSNMP_MODULE_ID=tegile, poolTotalReadIops=poolTotalReadIops, poolHealth=poolHealth, diskRandomIOCount=diskRandomIOCount, iscsiImproperTargetGroup=iscsiImproperTargetGroup, globalStatistics=globalStatistics, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataSizeHigh=poolDataSizeHigh, lunReadLatency=lunReadLatency, replicationComplete=replicationComplete, fcTargetReadMbps=fcTargetReadMbps, diskSlowIo=diskSlowIo, projectLUNs=projectLUNs, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetAlias=iscsiTargetAlias, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectShareCount=projectShareCount, shareQuotaHigh=shareQuotaHigh, shareNFSWriteMbps=shareNFSWriteMbps, poolQuotaFinished=poolQuotaFinished, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, notificationTargetEntityName=notificationTargetEntityName, snapshotCreationFailed=snapshotCreationFailed, nvdimmFailSoftError=nvdimmFailSoftError, aclMigrationCompleted=aclMigrationCompleted, fcTotalReadIops=fcTotalReadIops, projectName=projectName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareQuotaLow=shareQuotaLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalReadIops=nfsTotalReadIops, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheReadIops=poolReadCacheReadIops, replicationResumed=replicationResumed, diskTotalReadIops=diskTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunGUID=lunGUID, nicTable=nicTable, projectQuotaFinished=projectQuotaFinished, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, lunFreeSizeHigh=lunFreeSizeHigh, poolDataWriteLatency=poolDataWriteLatency, notificationDescription=notificationDescription, poolProjects=poolProjects, tdpsUpgradeTimeout=tdpsUpgradeTimeout, networkTotalReceiveMbps=networkTotalReceiveMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nvdimmFailUnknownError=nvdimmFailUnknownError, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectFreeSizeLow=projectFreeSizeLow, ipmiCurrent=ipmiCurrent, haResourceDescription=haResourceDescription, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTotalReadIops=iscsiTotalReadIops, haResources=haResources, testNotification=testNotification, spareDiskReplaced=spareDiskReplaced, fcPortOnline=fcPortOnline, lunReadIops=lunReadIops, sharePoolName=sharePoolName, fcTargetWriteIops=fcTargetWriteIops, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSEnabled=shareCIFSEnabled, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolState=poolState, poolExported=poolExported, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nfsAvgWriteLatency=nfsAvgWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, poolExpanded=poolExpanded, ipmiFan=ipmiFan, fcAvgReadLatency=fcAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, disks=disks, projectTable=projectTable, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetsTable=fcTargetsTable, nicIndex=nicIndex, iscsiTargetEntry=iscsiTargetEntry, fcTargetReadLatency=fcTargetReadLatency, poolSizeLow=poolSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, memoryFailure=memoryFailure, smbSocketFailure=smbSocketFailure, poolSizeHigh=poolSizeHigh, poolCreated=poolCreated, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationSeverity=notificationSeverity, snmpServiceStopped=snmpServiceStopped, shareIndex=shareIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetName=fcTargetName, webdocsUpgradeFailed=webdocsUpgradeFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, volumeQuotaFinished=volumeQuotaFinished, shareSnapshotSizeLow=shareSnapshotSizeLow, diskIsOnline=diskIsOnline, shareNFSReadLatency=shareNFSReadLatency, nicReceiveMbps=nicReceiveMbps, nfsTotalReadMbps=nfsTotalReadMbps, pools=pools, diskEntry=diskEntry, cifsTotalReadMbps=cifsTotalReadMbps, poolMetaReadIops=poolMetaReadIops, shareProjectName=shareProjectName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetGroup=iscsiTargetGroup, cacheRAMReads=cacheRAMReads, tegileGroups=tegileGroups, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cifsAvgReadLatency=cifsAvgReadLatency, poolDataWriteIops=poolDataWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetIndex=iscsiTargetIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nfsTotalWriteMbps=nfsTotalWriteMbps, diskIndex=diskIndex)
mibBuilder.exportSymbols("TEGILE-MIB", snmpServiceStopFailed=snmpServiceStopFailed, fcTargetEntry=fcTargetEntry, lunDataSizeLow=lunDataSizeLow, cpuSystemCalls=cpuSystemCalls, shareCompressionEnabled=shareCompressionEnabled, shareDeleted=shareDeleted, projectLunCount=projectLunCount, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareQuotaFinished=shareQuotaFinished, diagnosticDataUploaded=diagnosticDataUploaded, tegile=tegile, smisServiceStopped=smisServiceStopped, cacheTotalWriteIops=cacheTotalWriteIops, replicationTargetDeleted=replicationTargetDeleted, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetAuth=iscsiTargetAuth, upgradeTimeout=upgradeTimeout, upgradeFailed=upgradeFailed, lunDedupEnabled=lunDedupEnabled, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiators=iscsiInitiators, shareCompressedRatio=shareCompressedRatio, iscsiWriteIops=iscsiWriteIops, volumeDeleteFailed=volumeDeleteFailed, maintenanceModeDisabled=maintenanceModeDisabled, projectDeleted=projectDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationProps=notificationProps, poolMetaWriteIops=poolMetaWriteIops, ipmiThreshold=ipmiThreshold, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, haResourceGroup=haResourceGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, ipmiPowerSupply=ipmiPowerSupply, diskTotalWriteMbps=diskTotalWriteMbps, replicationPaused=replicationPaused, snmpAgentVersion=snmpAgentVersion, notifications=notifications, nvdimmFailDeviceError=nvdimmFailDeviceError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargets=fcTargets, lunPoolName=lunPoolName, cifsTotalWriteIops=cifsTotalWriteIops, shareName=shareName, nicState=nicState, networkInterfaceUp=networkInterfaceUp, poolImported=poolImported, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareDeletionFailed=shareDeletionFailed, notificationSensorAction=notificationSensorAction, alertsCleanupCompleted=alertsCleanupCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, volumeModifyCompleted=volumeModifyCompleted, adServerTimeDrift=adServerTimeDrift, smisServiceStopFailed=smisServiceStopFailed, replicationAbandoned=replicationAbandoned, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationComponentName=notificationComponentName, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDeletionFailed=poolDeletionFailed, tegileConformance=tegileConformance, poolEntry=poolEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTable=diskTable, shareMountPoint=shareMountPoint, poolDataWriteMbps=poolDataWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, unknownSensorEvent=unknownSensorEvent, shareDataSizeLow=shareDataSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, poolMetaReadLatency=poolMetaReadLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, haResourcesTable=haResourcesTable, haResourceStatus=haResourceStatus, iscsiTargetError=iscsiTargetError, deleteFolderCompleted=deleteFolderCompleted, network=network, poolMetaWriteMbps=poolMetaWriteMbps, lunReadMbps=lunReadMbps, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorEntry=iscsiInitiatorEntry, haControllerB_Name=haControllerB_Name, diskCount=diskCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolFreeSizeLow=poolFreeSizeLow, shareEntry=shareEntry, shareCIFSReadMbps=shareCIFSReadMbps, diskAlias=diskAlias, lunTable=lunTable, fcTargetReadIops=fcTargetReadIops, controllerUp=controllerUp, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cacheTotalReadIops=cacheTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationAborted=replicationAborted, snmpServiceStarted=snmpServiceStarted, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskAvgWriteLatency=diskAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, poolUpgraded=poolUpgraded, iscsiTargetName=iscsiTargetName, fcInitiatorName=fcInitiatorName, iscsiProperties=iscsiProperties, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nicTransmitMbps=nicTransmitMbps, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSReadIops=shareNFSReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, ipmiTemperature=ipmiTemperature, cpuInterrupts=cpuInterrupts, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskTotalWriteIops=diskTotalWriteIops, ntpServerTimeDrift=ntpServerTimeDrift, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, nicGroup=nicGroup, projectShares=projectShares, poolDataReadLatency=poolDataReadLatency, controllerHardwareModel=controllerHardwareModel, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cacheSSDReads=cacheSSDReads, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunSizeLow=lunSizeLow, poolTable=poolTable, poolTotalSaving=poolTotalSaving, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataReadIops=poolDataReadIops, projectDataSizeLow=projectDataSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, projectEntry=projectEntry, cpuTotalUsage=cpuTotalUsage, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolUsedSizeLow=poolUsedSizeLow, upgradeStarted=upgradeStarted, projectDedupEnabled=projectDedupEnabled, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcProperties=fcProperties, haResourceEntry=haResourceEntry, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcInitiators=fcInitiators, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetGroup=fcTargetGroup, notificationSensorNumber=notificationSensorNumber, lunInitiatorGroup=lunInitiatorGroup, poolDegraded=poolDegraded, vmwareNFSDatastores=vmwareNFSDatastores, projectQuotaSizeHigh=projectQuotaSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, lunCompressionEnabled=lunCompressionEnabled, fcPortOffline=fcPortOffline, smisServiceStarted=smisServiceStarted, lunProjectName=lunProjectName, projectTotalSaving=projectTotalSaving, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, notificationEventCode=notificationEventCode, cifsTotalWriteMbps=cifsTotalWriteMbps, tegileArray=tegileArray, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunBlockSize=lunBlockSize, lunWriteIops=lunWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nfsAvgReadLatency=nfsAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerA_Uptime=haControllerA_Uptime, deleteFolderFailed=deleteFolderFailed, poolIndex=poolIndex, aclMigrationStarted=aclMigrationStarted, poolAvgWriteLatency=poolAvgWriteLatency, lunName=lunName, tegileCompliances=tegileCompliances, userLoginFailed=userLoginFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskType=diskType, projectDataSizeHigh=projectDataSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, replicationFailed=replicationFailed, currentNotificationGroup=currentNotificationGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, ipmiVoltage=ipmiVoltage, cifsTotalReadIops=cifsTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, lunWriteLatency=lunWriteLatency, basicCompliance=basicCompliance, haResourceName=haResourceName, diskPoolName=diskPoolName, poolDeleted=poolDeleted, poolDataSizeLow=poolDataSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps)
