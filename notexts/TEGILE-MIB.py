...
Unsigned32, NotificationType, Counter32, Integer32, ObjectIdentity, Gauge32, ModuleIdentity, Bits, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Counter32", "Integer32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Bits", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetGroup=fcTargetGroup, lunDedupEnabled=lunDedupEnabled, haResourceName=haResourceName, cpuTotalUsage=cpuTotalUsage, diskDataWriteIops=diskDataWriteIops, nfsAvgReadLatency=nfsAvgReadLatency, poolHealth=poolHealth, lunEntry=lunEntry, targetGroupMemberAdded=targetGroupMemberAdded, fcProperties=fcProperties, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDataSizeLow=poolDataSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, currentNotificationGroup=currentNotificationGroup, poolSizeLow=poolSizeLow, projectTotalSaving=projectTotalSaving, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, diskSequentialIOCount=diskSequentialIOCount, projectThresholdExceedWarning=projectThresholdExceedWarning, projectIndex=projectIndex, lunTargetGroup=lunTargetGroup, notificationSensorAction=notificationSensorAction, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, replicationAborted=replicationAborted, ipmiFan=ipmiFan, projectDataSizeHigh=projectDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, diskGoneOffline=diskGoneOffline, adServerTimeDrift=adServerTimeDrift, poolReadCacheReadLatency=poolReadCacheReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetIndex=iscsiTargetIndex, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationComplete=replicationComplete, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nicReceiveMbps=nicReceiveMbps, fcInitiators=fcInitiators, snmpServiceStopped=snmpServiceStopped, poolExpanded=poolExpanded, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, upgradeDownloadFailed=upgradeDownloadFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, diskDataReadMbps=diskDataReadMbps, shareQuotaLow=shareQuotaLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, projectLUNs=projectLUNs, snapshotCloneCompleted=snapshotCloneCompleted, replicationResumed=replicationResumed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskTotalWriteMbps=diskTotalWriteMbps, deleteFolderFailed=deleteFolderFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolTable=poolTable, fcTargetStatus=fcTargetStatus, spareDiskReplaced=spareDiskReplaced, lunWriteMbps=lunWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolSizeHigh=poolSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, nicIndex=nicIndex, basicCompliance=basicCompliance, lunProjectName=lunProjectName, lunFreeSizeLow=lunFreeSizeLow, poolDataReadMbps=poolDataReadMbps, poolIndex=poolIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorIndex=iscsiInitiatorIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, projectLunCount=projectLunCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDeleted=poolDeleted, upgradeFailed=upgradeFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCIFSWriteMbps=shareCIFSWriteMbps, disks=disks, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, aclMigrationStarted=aclMigrationStarted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCIFSReadIops=shareCIFSReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, nicGroup=nicGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationSensorSuspect=notificationSensorSuspect, fcTotalWriteMbps=fcTotalWriteMbps, nicName=nicName, poolImported=poolImported, iscsiInitiatorEntry=iscsiInitiatorEntry, cpuInterrupts=cpuInterrupts, poolDataSizeHigh=poolDataSizeHigh, shareDataSizeLow=shareDataSizeLow, haResourceIndex=haResourceIndex, haControllerA_Uptime=haControllerA_Uptime, lunCompressedRatio=lunCompressedRatio, projectQuotaFinished=projectQuotaFinished, nicMTU=nicMTU, diskAlias=diskAlias, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunName=lunName, poolDeletionFailed=poolDeletionFailed, poolTotalWriteIops=poolTotalWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, cacheTotalReadIops=cacheTotalReadIops, notificationProps=notificationProps, volumeModifyCompleted=volumeModifyCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationTargetEntityName=notificationTargetEntityName, lunReadLatency=lunReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheRAMReads=cacheRAMReads, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareQuotaHigh=shareQuotaHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snapshotCreationFailed=snapshotCreationFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, replicationPaused=replicationPaused, nicEntry=nicEntry, smisServiceStopFailed=smisServiceStopFailed, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunReadIops=lunReadIops, poolAvgReadLatency=poolAvgReadLatency, tegileArray_notifications=tegileArray_notifications, projectQuotaSizeLow=projectQuotaSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareNFSReadIops=shareNFSReadIops, iscsiTargetGroupError=iscsiTargetGroupError, lunReadMbps=lunReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, diskState=diskState, poolMetaReadIops=poolMetaReadIops, haControllerB_Name=haControllerB_Name, shareCIFSReadLatency=shareCIFSReadLatency, diskError=diskError, sanProperties=sanProperties, fcTargetsTable=fcTargetsTable, snmpServiceStartFailed=snmpServiceStartFailed, haResources=haResources, shareQuotaFinished=shareQuotaFinished, nfsTotalReadMbps=nfsTotalReadMbps, shareCompressedRatio=shareCompressedRatio, poolCount=poolCount, nvdimmFailUnknownError=nvdimmFailUnknownError, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, snmpServiceStarted=snmpServiceStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, lunDataSizeHigh=lunDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskIOCount=diskIOCount, smbSocketFailure=smbSocketFailure, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressionEnabled=shareCompressionEnabled, aclMigrationCompleted=aclMigrationCompleted, fcTargetEntry=fcTargetEntry, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetName=iscsiTargetName, networkInterfaceDown=networkInterfaceDown, lunReservedSizeHigh=lunReservedSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastores=vmwareNFSDatastores, properties=properties, notifications=notifications, projectCreatedSuccessfully=projectCreatedSuccessfully, lunBlockSize=lunBlockSize, ipmiCriticalInterrupt=ipmiCriticalInterrupt, snapshotDeleteFailed=snapshotDeleteFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiProperties=iscsiProperties, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cifsAvgReadLatency=cifsAvgReadLatency, replicationFailed=replicationFailed, fcAvgReadLatency=fcAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, poolProjectCount=poolProjectCount, diskPoolName=diskPoolName, projectPoolName=projectPoolName, lunDataSizeLow=lunDataSizeLow, fcTargetName=fcTargetName, poolTotalSaving=poolTotalSaving, nfsTotalReadIops=nfsTotalReadIops, maintenanceModeEnabled=maintenanceModeEnabled, notificationObjects=notificationObjects, iscsiTargetsTable=iscsiTargetsTable, fcInitiatorIndex=fcInitiatorIndex, upgradeTimeout=upgradeTimeout, volumeQuotaFinished=volumeQuotaFinished, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolDegraded=poolDegraded, upgradeStarted=upgradeStarted, tegileArray=tegileArray, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ipmiOther=ipmiOther, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolQuotaFinished=poolQuotaFinished, volumeDeleteCompleted=volumeDeleteCompleted, diskSizeHigh=diskSizeHigh, iscsiTargetAuth=iscsiTargetAuth, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, testNotification=testNotification, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationSourceRegistered=replicationSourceRegistered, ipmiTemperature=ipmiTemperature, sensorFailureEvent=sensorFailureEvent, poolAvgWriteLatency=poolAvgWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, smisServiceStartFailed=smisServiceStartFailed, iscsiTargets=iscsiTargets, shareMountPoint=shareMountPoint, poolUpgraded=poolUpgraded, diskTotalWriteIops=diskTotalWriteIops, projectEntry=projectEntry, shareNFSEnabled=shareNFSEnabled, projectTable=projectTable, replicationTargetDeleted=replicationTargetDeleted, notificationComponentName=notificationComponentName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTotalWriteIops=fcTotalWriteIops, currentObjectGroup=currentObjectGroup, globalStatistics=globalStatistics, shareDeleted=shareDeleted, snapshotCloningFailed=snapshotCloningFailed, snmpAgentVersion=snmpAgentVersion, iscsiTargetReadIops=iscsiTargetReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", poolUsedSizeHigh=poolUsedSizeHigh, replicationAbandoned=replicationAbandoned, lunWriteLatency=lunWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareDedupEnabled=shareDedupEnabled, network=network, volumeDeleteFailed=volumeDeleteFailed, lunSizeLow=lunSizeLow, smisServiceStarted=smisServiceStarted, shareProjectName=shareProjectName, haResourceStatus=haResourceStatus, poolCreated=poolCreated, fcTargets=fcTargets, lunCompressionEnabled=lunCompressionEnabled, shareExceedThresholdWarning=shareExceedThresholdWarning, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, poolProjects=poolProjects, cpuSystemCalls=cpuSystemCalls, shareNFSWriteIops=shareNFSWriteIops, diskCount=diskCount, fcTargetReadIops=fcTargetReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, controllerTimeDrift=controllerTimeDrift, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, controllerUp=controllerUp, tegileCompliances=tegileCompliances, poolDataWriteMbps=poolDataWriteMbps, projectDataSizeLow=projectDataSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, diskRandomIOCount=diskRandomIOCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tegileGroups=tegileGroups, fcTotalReadMbps=fcTotalReadMbps, iscsiWriteIops=iscsiWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationReadingUnit=notificationReadingUnit, fcTargetModifyCompleted=fcTargetModifyCompleted, haControllerB_IPAddr=haControllerB_IPAddr, poolState=poolState, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haResourceActiveNode=haResourceActiveNode, shareNFSReadMbps=shareNFSReadMbps, lunWriteIops=lunWriteIops, iscsiInitiators=iscsiInitiators, lunReservedSizeLow=lunReservedSizeLow, diskDataWriteMbps=diskDataWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cacheSSDReads=cacheSSDReads, fcInitiatorName=fcInitiatorName, projectCompressionEnabled=projectCompressionEnabled, shareTable=shareTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolMetaReadMbps=poolMetaReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, fcInitiatorsTable=fcInitiatorsTable, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTotalReadIops=fcTotalReadIops, projectDedupEnabled=projectDedupEnabled, poolOwnerController=poolOwnerController, targetGroupMemberRemoved=targetGroupMemberRemoved, diskDataReadIops=diskDataReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetWriteIops=fcTargetWriteIops, ipmiThreshold=ipmiThreshold, diskAvgWriteLatency=diskAvgWriteLatency, projectDeleted=projectDeleted, fcInitiatorGroup=fcInitiatorGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, shareName=shareName, shareDataSizeHigh=shareDataSizeHigh, networkInterfaceUp=networkInterfaceUp, pools=pools, diskChassisIdx=diskChassisIdx, lunTable=lunTable, iscsiInitiatorName=iscsiInitiatorName, diskEntry=diskEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetAlias=iscsiTargetAlias, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetError=iscsiTargetError, ipmiVoltage=ipmiVoltage, ipmiCurrent=ipmiCurrent, sharePoolName=sharePoolName, fcTargetIndex=fcTargetIndex, ipmiMemory=ipmiMemory, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteLatency=poolDataWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectShareCount=projectShareCount, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolUsedSizeLow=poolUsedSizeLow, userLoginFailed=userLoginFailed, shareReservedSizeHigh=shareReservedSizeHigh, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, notificationTime=notificationTime, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetGroup=iscsiTargetGroup, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectModified=projectModified, poolTotalReadMbps=poolTotalReadMbps, nicState=nicState, haResourceGroup=haResourceGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationSeverity=notificationSeverity, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, projectDeletionFailed=projectDeletionFailed, shareEntry=shareEntry, notificationEventCode=notificationEventCode, poolExported=poolExported, poolEntry=poolEntry, diskTotalReadMbps=diskTotalReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, haResourcesTable=haResourcesTable, tegile=tegile, ipmiPowerSupply=ipmiPowerSupply, snapshotRollbackCompleted=snapshotRollbackCompleted, poolName=poolName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, maintenanceModeDisabled=maintenanceModeDisabled, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, shareCIFSEnabled=shareCIFSEnabled, cifsTotalReadIops=cifsTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, diskTotalReadIops=diskTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcInitiatorEntry=fcInitiatorEntry, diagnosticDataUploaded=diagnosticDataUploaded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationDescription=notificationDescription, poolDataReadLatency=poolDataReadLatency, upgradeDownloadStarted=upgradeDownloadStarted, haControllerA_IPAddr=haControllerA_IPAddr, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectFreeSizeLow=projectFreeSizeLow, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetEntry=iscsiTargetEntry, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, unknownSensorEvent=unknownSensorEvent, projectShares=projectShares, poolFreeSizeLow=poolFreeSizeLow, diskSlowIo=diskSlowIo, iscsiAvgReadLatency=iscsiAvgReadLatency, haResourceDescription=haResourceDescription, iscsiTargetWriteLatency=iscsiTargetWriteLatency, PYSNMP_MODULE_ID=tegile, diskIndex=diskIndex, shareIndex=shareIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceEntry=haResourceEntry, haControllerB_Uptime=haControllerB_Uptime, fcTargetReadLatency=fcTargetReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunSizeHigh=lunSizeHigh, fcPortOffline=fcPortOffline, replicationStarted=replicationStarted, diskSizeLow=diskSizeLow, lunPoolName=lunPoolName, diskIsOnline=diskIsOnline, nicTransmitMbps=nicTransmitMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, lunIndex=lunIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerHardwareModel=controllerHardwareModel, lunInitiatorGroup=lunInitiatorGroup, nicTable=nicTable, fcPortOnline=fcPortOnline, cacheTotalWriteMbps=cacheTotalWriteMbps, diskTable=diskTable, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tegileConformance=tegileConformance, tdpsUpgradeFailed=tdpsUpgradeFailed, upgradeCompleted=upgradeCompleted, poolMetaReadLatency=poolMetaReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, diskAvgReadLatency=diskAvgReadLatency, diskType=diskType, poolDataReadIops=poolDataReadIops, lunGUID=lunGUID, projectName=projectName, memoryFailure=memoryFailure, notificationSensorNumber=notificationSensorNumber, shareReservedSizeLow=shareReservedSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, poolDataWriteIops=poolDataWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunProtocol=lunProtocol, poolFreeSizeHigh=poolFreeSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow)
