...
Gauge32, Counter64, enterprises, Unsigned32, iso, IpAddress, Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ModuleIdentity, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "enterprises", "Unsigned32", "iso", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ModuleIdentity", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkInterfaceDown=networkInterfaceDown, diskTotalWriteMbps=diskTotalWriteMbps, shareDeletionFailed=shareDeletionFailed, ipmiFan=ipmiFan, poolOwnerController=poolOwnerController, replicationComplete=replicationComplete, lunWriteLatency=lunWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiInitiatorEntry=iscsiInitiatorEntry, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, targetGroupMemberAdded=targetGroupMemberAdded, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunCompressedRatio=lunCompressedRatio, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolMetaWriteLatency=poolMetaWriteLatency, replicationStarted=replicationStarted, projectLunCount=projectLunCount, iscsiInitiatorGroup=iscsiInitiatorGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, network=network, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tegileCompliances=tegileCompliances, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunFreeSizeLow=lunFreeSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, notificationProps=notificationProps, replicationTargetDeleted=replicationTargetDeleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetReadLatency=iscsiTargetReadLatency, pools=pools, diskType=diskType, fcInitiatorIndex=fcInitiatorIndex, volumeQuotaFinished=volumeQuotaFinished, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nicIndex=nicIndex, upgradeFailed=upgradeFailed, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDataReadMbps=poolDataReadMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, fcTotalWriteIops=fcTotalWriteIops, lunDataSizeHigh=lunDataSizeHigh, haResourceEntry=haResourceEntry, shareIndex=shareIndex, poolTable=poolTable, projectIndex=projectIndex, projectDeleted=projectDeleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeDeleteFailed=volumeDeleteFailed, tegileArray=tegileArray, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, upgradeCompleted=upgradeCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, replicationResumed=replicationResumed, lunDedupEnabled=lunDedupEnabled, iscsiTargetError=iscsiTargetError, controllerDown=controllerDown, diskTable=diskTable, PYSNMP_MODULE_ID=tegile, snmpAgentVersion=snmpAgentVersion, smisServiceStopped=smisServiceStopped, shareCIFSReadMbps=shareCIFSReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, basicCompliance=basicCompliance, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, globalStatistics=globalStatistics, projectDataSizeHigh=projectDataSizeHigh, projectCompressionEnabled=projectCompressionEnabled, projectSnapshotSizeLow=projectSnapshotSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, replicationFailed=replicationFailed, diskSizeHigh=diskSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunIndex=lunIndex, shareCIFSReadLatency=shareCIFSReadLatency, userLoginFailed=userLoginFailed, cacheTotalReadMbps=cacheTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, spareDiskReplaced=spareDiskReplaced, lunProtocol=lunProtocol, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, maintenanceModeDisabled=maintenanceModeDisabled, ipmiOther=ipmiOther, nicReceiveMbps=nicReceiveMbps, cpuSystemCalls=cpuSystemCalls, diskAvgReadLatency=diskAvgReadLatency, diskGoneOffline=diskGoneOffline, controllerTimeDrift=controllerTimeDrift, poolQuotaFinished=poolQuotaFinished, poolDataReadIops=poolDataReadIops, ipmiPowerSupply=ipmiPowerSupply, poolReadCacheWriteIops=poolReadCacheWriteIops, poolSizeHigh=poolSizeHigh, notificationSensorNumber=notificationSensorNumber, poolName=poolName, cifsTotalReadIops=cifsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, projectModified=projectModified, nfsTotalReadIops=nfsTotalReadIops, volumeDeleteCompleted=volumeDeleteCompleted, shareReservedSizeLow=shareReservedSizeLow, notificationObjects=notificationObjects, currentObjectGroup=currentObjectGroup, shareTable=shareTable, lunTargetGroup=lunTargetGroup, projectThresholdExceedWarning=projectThresholdExceedWarning, notificationComponentName=notificationComponentName, projectQuotaSizeHigh=projectQuotaSizeHigh, shareCompressedRatio=shareCompressedRatio, lunBlockSize=lunBlockSize, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunWriteMbps=lunWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, smisServiceStopFailed=smisServiceStopFailed, poolTotalSaving=poolTotalSaving, lunGUID=lunGUID, notificationDescription=notificationDescription, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, lunInitiatorGroup=lunInitiatorGroup, poolEntry=poolEntry, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetIndex=fcTargetIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, fcPortOnline=fcPortOnline, nfsTotalReadMbps=nfsTotalReadMbps, lunCompressionEnabled=lunCompressionEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, projectDataSizeLow=projectDataSizeLow, snmpServiceStarted=snmpServiceStarted, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetEntry=fcTargetEntry, upgradeDownloadStarted=upgradeDownloadStarted, haResourceGroup=haResourceGroup, poolTotalWriteIops=poolTotalWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetReadLatency=fcTargetReadLatency, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeCreatedSuccessfully=volumeCreatedSuccessfully, properties=properties, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nvdimmFailUnknownError=nvdimmFailUnknownError, poolIndex=poolIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetGroup=fcTargetGroup, snapshotCloningFailed=snapshotCloningFailed, poolDataWriteLatency=poolDataWriteLatency, diskRandomIOCount=diskRandomIOCount, shareCreatedSuccessfully=shareCreatedSuccessfully, shareCompressionEnabled=shareCompressionEnabled, cifsTotalWriteMbps=cifsTotalWriteMbps, poolCount=poolCount, shareDedupEnabled=shareDedupEnabled, fcInitiatorEntry=fcInitiatorEntry, tegileGroups=tegileGroups, poolProjects=poolProjects, cacheSSDReads=cacheSSDReads, poolFreeSizeHigh=poolFreeSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, diskDataWriteIops=diskDataWriteIops, projectName=projectName, snmpServiceStopFailed=snmpServiceStopFailed, shareDataSizeLow=shareDataSizeLow, shareQuotaHigh=shareQuotaHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, poolMetaReadIops=poolMetaReadIops, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunSizeHigh=lunSizeHigh, haResourceIndex=haResourceIndex, poolDataWriteMbps=poolDataWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskCount=diskCount, fcTargetReadIops=fcTargetReadIops, deleteFolderFailed=deleteFolderFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareProjectName=shareProjectName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectQuotaFinished=projectQuotaFinished, nicGroup=nicGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskDataReadIops=diskDataReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cifsTotalReadMbps=cifsTotalReadMbps, tegile=tegile, fcAvgReadLatency=fcAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, notificationSensorSuspect=notificationSensorSuspect, haControllerA_Uptime=haControllerA_Uptime, controllerUp=controllerUp, lunReservedSizeLow=lunReservedSizeLow, fcTargetWriteIops=fcTargetWriteIops, poolExported=poolExported, cacheTotalReadIops=cacheTotalReadIops, poolDegraded=poolDegraded, fcTargetWriteLatency=fcTargetWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, shareEntry=shareEntry, iscsiTargetAlias=iscsiTargetAlias, shareNFSReadLatency=shareNFSReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunName=lunName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diagnosticDataUploaded=diagnosticDataUploaded, projectPoolName=projectPoolName, haResourceDescription=haResourceDescription, netbiosSocketFailure=netbiosSocketFailure, replicationSourceRegistered=replicationSourceRegistered, snmpServiceStartFailed=snmpServiceStartFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReadMbps=lunReadMbps, sharePoolName=sharePoolName, projectDedupEnabled=projectDedupEnabled, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicState=nicState, projectEntry=projectEntry, fcTargets=fcTargets, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetReadMbps=fcTargetReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, nfsTotalWriteIops=nfsTotalWriteIops, poolExpanded=poolExpanded, diskChassisIdx=diskChassisIdx, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSReadMbps=shareNFSReadMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, aclMigrationStarted=aclMigrationStarted, currentNotificationGroup=currentNotificationGroup, poolHealth=poolHealth, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nicMTU=nicMTU, haResourcesTable=haResourcesTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResources=haResources, poolImported=poolImported, diskSequentialIOCount=diskSequentialIOCount, snapshotCreationFailed=snapshotCreationFailed, poolAvgReadLatency=poolAvgReadLatency, notificationSensorAction=notificationSensorAction, nfsAvgWriteLatency=nfsAvgWriteLatency, smisServiceStarted=smisServiceStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, smisServiceStartFailed=smisServiceStartFailed, disks=disks, fcTargetName=fcTargetName, iscsiInitiatorName=iscsiInitiatorName, poolProjectCount=poolProjectCount, tdpsUpgradeFailed=tdpsUpgradeFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationSeverity=notificationSeverity, diskIndex=diskIndex, poolSizeLow=poolSizeLow, poolUpgraded=poolUpgraded, networkIpmpGroupDown=networkIpmpGroupDown, cifsAvgReadLatency=cifsAvgReadLatency, projectDeletionFailed=projectDeletionFailed, shareCIFSReadIops=shareCIFSReadIops, diskState=diskState, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetEntry=iscsiTargetEntry, nicTable=nicTable, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskTotalReadIops=diskTotalReadIops, lunReadLatency=lunReadLatency, diskPoolName=diskPoolName, shareDeleted=shareDeleted, notificationReadingUnit=notificationReadingUnit, targetGroupDeleteCompleted=targetGroupDeleteCompleted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcProperties=fcProperties, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, replicationPaused=replicationPaused, poolCreated=poolCreated, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiWriteIops=iscsiWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, shareReservedSizeHigh=shareReservedSizeHigh, projectFreeSizeLow=projectFreeSizeLow, sensorFailureEvent=sensorFailureEvent, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, sanProperties=sanProperties, lunEntry=lunEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, shareName=shareName, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerB_Name=haControllerB_Name, shareNFSWriteIops=shareNFSWriteIops, fcInitiatorName=fcInitiatorName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiVoltage=ipmiVoltage, poolTotalReadMbps=poolTotalReadMbps, lunPoolName=lunPoolName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notifications=notifications, iscsiInitiatorsTable=iscsiInitiatorsTable, cifsTotalWriteIops=cifsTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolMetaReadMbps=poolMetaReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolState=poolState, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectLUNs=projectLUNs, fcPortOffline=fcPortOffline, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargetsTable=fcTargetsTable, smbSocketFailure=smbSocketFailure, shareCIFSWriteMbps=shareCIFSWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerA_Name=haControllerA_Name, iscsiProperties=iscsiProperties, haControllerB_IPAddr=haControllerB_IPAddr, shareDataSizeHigh=shareDataSizeHigh, shareNFSEnabled=shareNFSEnabled, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskIOCount=diskIOCount, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolMetaWriteMbps=poolMetaWriteMbps, shareNFSReadIops=shareNFSReadIops, diskTotalReadMbps=diskTotalReadMbps, nicEntry=nicEntry, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetAuth=iscsiTargetAuth, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcInitiatorsTable=fcInitiatorsTable, ipmiThreshold=ipmiThreshold, poolTotalReadIops=poolTotalReadIops, tegileConformance=tegileConformance, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDeleted=poolDeleted, ipmiTemperature=ipmiTemperature, nicName=nicName, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haResourceName=haResourceName, testNotification=testNotification, upgradeTimeout=upgradeTimeout, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snapshotCloneCompleted=snapshotCloneCompleted, cpuTotalUsage=cpuTotalUsage, iscsiTargetGroupError=iscsiTargetGroupError, diskSizeLow=diskSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, networkInterfaceUp=networkInterfaceUp, tegileArray_notifications=tegileArray_notifications, fcTotalReadIops=fcTotalReadIops, aclMigrationCompleted=aclMigrationCompleted, deleteFolderCompleted=deleteFolderCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunWriteIops=lunWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haResourceActiveNode=haResourceActiveNode, projectTable=projectTable, lunReadIops=lunReadIops, ipmiMemory=ipmiMemory, poolMetaWriteIops=poolMetaWriteIops, diskIsOnline=diskIsOnline, replicationAborted=replicationAborted, shareQuotaLow=shareQuotaLow, cacheRAMReads=cacheRAMReads, adServerTimeDrift=adServerTimeDrift, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunTable=lunTable, ipmiCurrent=ipmiCurrent, shareCIFSEnabled=shareCIFSEnabled, projectShares=projectShares, iscsiAvgReadLatency=iscsiAvgReadLatency, shareMountPoint=shareMountPoint, fcTargetStatus=fcTargetStatus, memoryFailure=memoryFailure, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiInitiatorIndex=iscsiInitiatorIndex, cifsAvgWriteLatency=cifsAvgWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, unknownSensorEvent=unknownSensorEvent, notificationEventCode=notificationEventCode, webdocsUpgradeFailed=webdocsUpgradeFailed, snapshotRollbackFailed=snapshotRollbackFailed, nicTransmitMbps=nicTransmitMbps, diskSlowIo=diskSlowIo, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolDataReadLatency=poolDataReadLatency, volumeModifyCompleted=volumeModifyCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskTotalWriteIops=diskTotalWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolUsedSizeLow=poolUsedSizeLow, fcInitiators=fcInitiators, poolFreeSizeLow=poolFreeSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, notificationTime=notificationTime, haResourceStatus=haResourceStatus, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, diskEntry=diskEntry, lunProjectName=lunProjectName, projectShareCount=projectShareCount, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskError=diskError, shareQuotaFinished=shareQuotaFinished, poolDeletionFailed=poolDeletionFailed, iscsiTargets=iscsiTargets, fcTargetWriteMbps=fcTargetWriteMbps, lunSizeLow=lunSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunDataSizeLow=lunDataSizeLow, iscsiTargetName=iscsiTargetName, poolDataWriteIops=poolDataWriteIops, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiInitiators=iscsiInitiators, diskAlias=diskAlias, poolReadCacheReadLatency=poolReadCacheReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaReadLatency=poolMetaReadLatency, upgradeStarted=upgradeStarted, diskDataReadMbps=diskDataReadMbps)
