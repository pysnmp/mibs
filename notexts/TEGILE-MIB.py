...
Unsigned32, Integer32, TimeTicks, Counter64, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Gauge32, iso, ObjectIdentity, Bits, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Gauge32", "iso", "ObjectIdentity", "Bits", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", haResourcesTable=haResourcesTable, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareNFSEnabled=shareNFSEnabled, tdpsUpgradeFailed=tdpsUpgradeFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolOwnerController=poolOwnerController, volumeModifyCompleted=volumeModifyCompleted, ipmiOther=ipmiOther, projectThresholdExceedWarning=projectThresholdExceedWarning, snapshotCloneCompleted=snapshotCloneCompleted, projectTotalSaving=projectTotalSaving, fcInitiatorIndex=fcInitiatorIndex, fcPortOffline=fcPortOffline, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorName=fcInitiatorName, diskIndex=diskIndex, lunTable=lunTable, lunCompressedRatio=lunCompressedRatio, controllerUp=controllerUp, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorGroup=iscsiInitiatorGroup, upgradeStarted=upgradeStarted, globalStatistics=globalStatistics, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolFreeSizeLow=poolFreeSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastores=vmwareNFSDatastores, poolDataWriteLatency=poolDataWriteLatency, projectDedupEnabled=projectDedupEnabled, poolSizeLow=poolSizeLow, shareName=shareName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskSequentialIOCount=diskSequentialIOCount, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nicState=nicState, targetGroupCreateCompleted=targetGroupCreateCompleted, lunReadMbps=lunReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, diskSizeHigh=diskSizeHigh, diskEntry=diskEntry, poolTotalWriteIops=poolTotalWriteIops, poolProjectCount=poolProjectCount, haResourceName=haResourceName, replicationAborted=replicationAborted, notificationSensorSuspect=notificationSensorSuspect, haControllerB_Uptime=haControllerB_Uptime, shareDeleted=shareDeleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, PYSNMP_MODULE_ID=tegile, fcTotalReadMbps=fcTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskError=diskError, projectSnapshotSizeLow=projectSnapshotSizeLow, fcPortOnline=fcPortOnline, cacheTotalWriteIops=cacheTotalWriteIops, lunPoolName=lunPoolName, shareQuotaHigh=shareQuotaHigh, cifsTotalReadIops=cifsTotalReadIops, poolCount=poolCount, poolDataWriteIops=poolDataWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolReadCacheWriteIops=poolReadCacheWriteIops, lunDedupEnabled=lunDedupEnabled, projectFreeSizeHigh=projectFreeSizeHigh, replicationStarted=replicationStarted, poolSizeHigh=poolSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, projectModified=projectModified, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargets=fcTargets, notificationSensorNumber=notificationSensorNumber, diskIOCount=diskIOCount, iscsiTotalReadMbps=iscsiTotalReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCompressedRatio=shareCompressedRatio, poolState=poolState, diskAlias=diskAlias, iscsiTargetAlias=iscsiTargetAlias, fcTargetReadIops=fcTargetReadIops, poolUsedSizeHigh=poolUsedSizeHigh, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareNFSWriteIops=shareNFSWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, haResourceDescription=haResourceDescription, diskRandomIOCount=diskRandomIOCount, poolQuotaFinished=poolQuotaFinished, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkTotalReceiveMbps=networkTotalReceiveMbps, maintenanceModeEnabled=maintenanceModeEnabled, iscsiInitiatorIndex=iscsiInitiatorIndex, diskTotalWriteIops=diskTotalWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, basicCompliance=basicCompliance, diskTotalReadMbps=diskTotalReadMbps, notificationComponentName=notificationComponentName, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetError=iscsiTargetError, diskTable=diskTable, notificationEventCode=notificationEventCode, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetIndex=fcTargetIndex, diskGoneOffline=diskGoneOffline, sensorFailureEvent=sensorFailureEvent, notifications=notifications, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolTotalSaving=poolTotalSaving, projectQuotaSizeHigh=projectQuotaSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunInitiatorGroup=lunInitiatorGroup, projectLunCount=projectLunCount, cpuInterrupts=cpuInterrupts, memoryFailure=memoryFailure, shareNFSReadMbps=shareNFSReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetIndex=iscsiTargetIndex, projectPoolName=projectPoolName, shareNFSWriteLatency=shareNFSWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, shareDeletionFailed=shareDeletionFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetGroup=fcTargetGroup, diskType=diskType, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiWriteIops=iscsiWriteIops, lunIndex=lunIndex, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, tegile=tegile, shareQuotaLow=shareQuotaLow, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, notificationDescription=notificationDescription, fcInitiators=fcInitiators, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskTotalReadIops=diskTotalReadIops, fcInitiatorEntry=fcInitiatorEntry, replicationAbandoned=replicationAbandoned, tegileArray=tegileArray, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargets=iscsiTargets, snmpServiceStopped=snmpServiceStopped, poolDataReadIops=poolDataReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolProjects=poolProjects, lunSizeLow=lunSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolMetaReadMbps=poolMetaReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, notificationProps=notificationProps, ipmiMemory=ipmiMemory, volumeDeleteFailed=volumeDeleteFailed, diskDataWriteMbps=diskDataWriteMbps, projectShares=projectShares, projectTable=projectTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolEntry=poolEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolMetaWriteIops=poolMetaWriteIops, spareDiskReplaced=spareDiskReplaced, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareQuotaFinished=shareQuotaFinished, smisServiceStopped=smisServiceStopped, nvdimmFailDeviceError=nvdimmFailDeviceError, shareCIFSWriteMbps=shareCIFSWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareNFSReadIops=shareNFSReadIops, nicGroup=nicGroup, smisServiceStartFailed=smisServiceStartFailed, fcTargetWriteLatency=fcTargetWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunDataSizeHigh=lunDataSizeHigh, poolTotalReadMbps=poolTotalReadMbps, ipmiCurrent=ipmiCurrent, haResourceStatus=haResourceStatus, notificationTargetEntityName=notificationTargetEntityName, cacheTotalReadIops=cacheTotalReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, volumeDeleteCompleted=volumeDeleteCompleted, cpuTotalUsage=cpuTotalUsage, poolUsedSizeLow=poolUsedSizeLow, lunWriteLatency=lunWriteLatency, tegileGroups=tegileGroups, ipmiFan=ipmiFan, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareCIFSReadIops=shareCIFSReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationPaused=replicationPaused, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, lunReadIops=lunReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorName=iscsiInitiatorName, lunProtocol=lunProtocol, notificationSensorAction=notificationSensorAction, poolDeleted=poolDeleted, fcTotalWriteIops=fcTotalWriteIops, network=network, haResourceEntry=haResourceEntry, networkIpmpGroupUp=networkIpmpGroupUp, poolCreated=poolCreated, lunSnapshotSizeLow=lunSnapshotSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diagnosticDataUploaded=diagnosticDataUploaded, properties=properties, userLoginFailed=userLoginFailed, shareMountPoint=shareMountPoint, projectDataSizeLow=projectDataSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunReservedSizeLow=lunReservedSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolHealth=poolHealth, projectEntry=projectEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareCIFSEnabled=shareCIFSEnabled, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunFreeSizeHigh=lunFreeSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, diskPoolName=diskPoolName, diskCount=diskCount, projectLUNs=projectLUNs, lunSizeHigh=lunSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", haResourceActiveNode=haResourceActiveNode, smisServiceStopFailed=smisServiceStopFailed, cacheRAMReads=cacheRAMReads, nfsTotalReadIops=nfsTotalReadIops, nicTable=nicTable, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolFreeSizeHigh=poolFreeSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, shareDedupEnabled=shareDedupEnabled, haResourceGroup=haResourceGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareDataSizeHigh=shareDataSizeHigh, currentObjectGroup=currentObjectGroup, replicationComplete=replicationComplete, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTotalReadIops=fcTotalReadIops, fcTargetsTable=fcTargetsTable, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, disks=disks, projectFreeSizeLow=projectFreeSizeLow, haControllerA_Name=haControllerA_Name, deleteFolderFailed=deleteFolderFailed, nicReceiveMbps=nicReceiveMbps, diskIsOnline=diskIsOnline, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetGroupError=iscsiTargetGroupError, lunGUID=lunGUID, iscsiTargetName=iscsiTargetName, fcTargetReadLatency=fcTargetReadLatency, projectCompressionEnabled=projectCompressionEnabled, adServerTimeDrift=adServerTimeDrift, poolDataWriteMbps=poolDataWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaReadLatency=poolMetaReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, shareReservedSizeLow=shareReservedSizeLow, poolUpgraded=poolUpgraded, diskState=diskState, upgradeTimeout=upgradeTimeout, sharePoolName=sharePoolName, poolTable=poolTable, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiAvgReadLatency=iscsiAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetName=fcTargetName, controllerTimeDrift=controllerTimeDrift, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, diskChassisIdx=diskChassisIdx, replicationResumed=replicationResumed, nvdimmFailUnknownError=nvdimmFailUnknownError, tegileConformance=tegileConformance, projectDeleted=projectDeleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetWriteIops=iscsiTargetWriteIops, shareTable=shareTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tegileArray_notifications=tegileArray_notifications, iscsiInitiators=iscsiInitiators, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectName=projectName, projectDataSizeHigh=projectDataSizeHigh, poolDeletionFailed=poolDeletionFailed, pools=pools, haControllerA_Uptime=haControllerA_Uptime, shareDataSizeLow=shareDataSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetEntry=fcTargetEntry, notificationReadingUnit=notificationReadingUnit, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diskDataWriteIops=diskDataWriteIops, snmpAgentVersion=snmpAgentVersion, ipmiVoltage=ipmiVoltage, poolReadCacheReadLatency=poolReadCacheReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationSeverity=notificationSeverity, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetEntry=iscsiTargetEntry, unknownSensorEvent=unknownSensorEvent, iscsiTargetAuth=iscsiTargetAuth, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, lunEntry=lunEntry, cpuSystemCalls=cpuSystemCalls, networkInterfaceUp=networkInterfaceUp, nicIndex=nicIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiProperties=iscsiProperties, haControllerB_Name=haControllerB_Name, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nfsTotalWriteMbps=nfsTotalWriteMbps, poolDataReadMbps=poolDataReadMbps, poolDegraded=poolDegraded, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetWriteIops=fcTargetWriteIops, lunProjectName=lunProjectName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTotalWriteMbps=fcTotalWriteMbps, replicationTargetDeleted=replicationTargetDeleted, tegileCompliances=tegileCompliances, smisServiceStarted=smisServiceStarted, iscsiTargetReadMbps=iscsiTargetReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, ipmiTemperature=ipmiTemperature, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeFailed=upgradeFailed, diskAvgReadLatency=diskAvgReadLatency, lunTargetGroup=lunTargetGroup, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcInitiatorsTable=fcInitiatorsTable, smbSocketFailure=smbSocketFailure, nicName=nicName, poolMetaReadIops=poolMetaReadIops, poolDataReadLatency=poolDataReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcProperties=fcProperties, poolImported=poolImported, sanProperties=sanProperties, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, ipmiThreshold=ipmiThreshold, lunReadLatency=lunReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSReadMbps=shareCIFSReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, replicationFailed=replicationFailed, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationTime=notificationTime, snapshotCreationFailed=snapshotCreationFailed, netbiosSocketFailure=netbiosSocketFailure, haResources=haResources, aclMigrationStarted=aclMigrationStarted, cacheSSDReads=cacheSSDReads, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunBlockSize=lunBlockSize, diskSlowIo=diskSlowIo, poolName=poolName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nicEntry=nicEntry, projectDeletionFailed=projectDeletionFailed, haResourceIndex=haResourceIndex, poolExported=poolExported, poolTotalWriteMbps=poolTotalWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, poolDataSizeLow=poolDataSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, controllerDown=controllerDown, fcTargetReadMbps=fcTargetReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, lunName=lunName, diskSizeLow=diskSizeLow, snmpServiceStarted=snmpServiceStarted, lunCompressionEnabled=lunCompressionEnabled, shareReservedSizeHigh=shareReservedSizeHigh, poolAvgReadLatency=poolAvgReadLatency, shareProjectName=shareProjectName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareEntry=shareEntry, upgradeCompleted=upgradeCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, maintenanceModeDisabled=maintenanceModeDisabled, shareCompressionEnabled=shareCompressionEnabled, notificationObjects=notificationObjects, projectIndex=projectIndex, poolIndex=poolIndex, testNotification=testNotification, poolTotalReadIops=poolTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetStatus=fcTargetStatus, nicMTU=nicMTU, poolExpanded=poolExpanded, currentNotificationGroup=currentNotificationGroup, networkInterfaceDown=networkInterfaceDown, lunWriteIops=lunWriteIops, fcAvgReadLatency=fcAvgReadLatency, nicTransmitMbps=nicTransmitMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolAvgWriteLatency=poolAvgWriteLatency, projectShareCount=projectShareCount, diskTotalWriteMbps=diskTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, snapshotCloningFailed=snapshotCloningFailed, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTotalReadIops=iscsiTotalReadIops, controllerHardwareModel=controllerHardwareModel, nfsAvgReadLatency=nfsAvgReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerB_IPAddr=haControllerB_IPAddr, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareIndex=shareIndex, diskDataReadIops=diskDataReadIops, ntpServerTimeDrift=ntpServerTimeDrift)
