...
Bits, Gauge32, MibIdentifier, Unsigned32, enterprises, iso, ModuleIdentity, Counter32, TimeTicks, Counter64, ObjectIdentity, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibIdentifier", "Unsigned32", "enterprises", "iso", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskDataWriteMbps=diskDataWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskState=diskState, lunReadMbps=lunReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snapshotCreationFailed=snapshotCreationFailed, fcProperties=fcProperties, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetReadIops=fcTargetReadIops, tegileArray=tegileArray, poolTotalWriteIops=poolTotalWriteIops, poolUpgraded=poolUpgraded, lunGUID=lunGUID, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, replicationAbandoned=replicationAbandoned, snmpServiceStopped=snmpServiceStopped, projectQuotaFinished=projectQuotaFinished, ipmiOther=ipmiOther, iscsiTargetError=iscsiTargetError, upgradeTimeout=upgradeTimeout, projectModified=projectModified, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetGroup=iscsiTargetGroup, currentObjectGroup=currentObjectGroup, diskIndex=diskIndex, diskSizeHigh=diskSizeHigh, diskError=diskError, cacheSSDReads=cacheSSDReads, iscsiTargetName=iscsiTargetName, projectCompressionEnabled=projectCompressionEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunReadLatency=lunReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cifsTotalReadIops=cifsTotalReadIops, snmpServiceStarted=snmpServiceStarted, userLoginFailed=userLoginFailed, snapshotDeleteFailed=snapshotDeleteFailed, poolName=poolName, diskAvgWriteLatency=diskAvgWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, snapshotCloningFailed=snapshotCloningFailed, ipmiTemperature=ipmiTemperature, ipmiFan=ipmiFan, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolImported=poolImported, replicationFailed=replicationFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetWriteMbps=fcTargetWriteMbps, smbSocketFailure=smbSocketFailure, ipmiCurrent=ipmiCurrent, shareCompressedRatio=shareCompressedRatio, iscsiTargetAuth=iscsiTargetAuth, lunCompressedRatio=lunCompressedRatio, diskIsOnline=diskIsOnline, poolExpanded=poolExpanded, disks=disks, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cacheRAMReads=cacheRAMReads, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskAlias=diskAlias, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, nicIndex=nicIndex, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourceActiveNode=haResourceActiveNode, shareDeleted=shareDeleted, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetReadMbps=iscsiTargetReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, fcPortOnline=fcPortOnline, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectFreeSizeLow=projectFreeSizeLow, poolMetaReadIops=poolMetaReadIops, notificationSeverity=notificationSeverity, haResourceGroup=haResourceGroup, haResources=haResources, projectDataSizeHigh=projectDataSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, lunPoolName=lunPoolName, shareNFSWriteMbps=shareNFSWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDeletionFailed=poolDeletionFailed, projectLUNs=projectLUNs, snapshotCloneCompleted=snapshotCloneCompleted, diskIOCount=diskIOCount, ipmiMemory=ipmiMemory, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorsTable=iscsiInitiatorsTable, ntpServerTimeDrift=ntpServerTimeDrift, poolMetaWriteMbps=poolMetaWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, replicationStarted=replicationStarted, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, ipmiVoltage=ipmiVoltage, diskChassisIdx=diskChassisIdx, poolMetaWriteLatency=poolMetaWriteLatency, shareIndex=shareIndex, upgradeDownloadFailed=upgradeDownloadFailed, shareQuotaLow=shareQuotaLow, fcTotalWriteIops=fcTotalWriteIops, diskRandomIOCount=diskRandomIOCount, upgradeCompleted=upgradeCompleted, shareQuotaFinished=shareQuotaFinished, globalStatistics=globalStatistics, poolMetaReadLatency=poolMetaReadLatency, notificationTargetEntityName=notificationTargetEntityName, poolState=poolState, shareNFSEnabled=shareNFSEnabled, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskGoneOffline=diskGoneOffline, lunSizeHigh=lunSizeHigh, poolSizeLow=poolSizeLow, haResourceIndex=haResourceIndex, poolDataWriteIops=poolDataWriteIops, fcTargetWriteIops=fcTargetWriteIops, controllerTimeDrift=controllerTimeDrift, notificationTime=notificationTime, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, targetGroupMemberRemoved=targetGroupMemberRemoved, shareCIFSEnabled=shareCIFSEnabled, haResourceStatus=haResourceStatus, fcTargetGroup=fcTargetGroup, fcPortOffline=fcPortOffline, iscsiProperties=iscsiProperties, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorEntry=fcInitiatorEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareExceedThresholdWarning=shareExceedThresholdWarning, controllerDown=controllerDown, shareEntry=shareEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeDisabled=maintenanceModeDisabled, poolDataReadLatency=poolDataReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorIndex=fcInitiatorIndex, cacheTotalReadMbps=cacheTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, volumeDeleteFailed=volumeDeleteFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResourcesTable=haResourcesTable, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, controllerUp=controllerUp, iscsiInitiators=iscsiInitiators, shareNFSWriteIops=shareNFSWriteIops, projectIndex=projectIndex, diskEntry=diskEntry, volumeDeleteCompleted=volumeDeleteCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, networkIpmpGroupDown=networkIpmpGroupDown, projectQuotaSizeHigh=projectQuotaSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, lunTable=lunTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snmpServiceStopFailed=snmpServiceStopFailed, lunName=lunName, poolMetaReadMbps=poolMetaReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunWriteMbps=lunWriteMbps, notificationReadingUnit=notificationReadingUnit, haControllerA_Name=haControllerA_Name, poolFreeSizeHigh=poolFreeSizeHigh, sensorFailureEvent=sensorFailureEvent, lunWriteIops=lunWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, snmpAgentVersion=snmpAgentVersion, lunDedupEnabled=lunDedupEnabled, lunBlockSize=lunBlockSize, diskDataWriteIops=diskDataWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, lunDataSizeHigh=lunDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSensorNumber=notificationSensorNumber, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationSensorAction=notificationSensorAction, poolDegraded=poolDegraded, poolAvgReadLatency=poolAvgReadLatency, iscsiInitiatorName=iscsiInitiatorName, nicState=nicState, projectEntry=projectEntry, haControllerA_IPAddr=haControllerA_IPAddr, poolSizeHigh=poolSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, smisServiceStopFailed=smisServiceStopFailed, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetEntry=iscsiTargetEntry, poolTotalWriteMbps=poolTotalWriteMbps, poolEntry=poolEntry, lunProtocol=lunProtocol, shareMountPoint=shareMountPoint, nvdimmFailSoftError=nvdimmFailSoftError, haResourceEntry=haResourceEntry, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTotalReadIops=fcTotalReadIops, diskType=diskType, shareCIFSReadIops=shareCIFSReadIops, fcTargetReadLatency=fcTargetReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, nicGroup=nicGroup, shareDataSizeLow=shareDataSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, deleteFolderCompleted=deleteFolderCompleted, fcTargets=fcTargets, haResourceName=haResourceName, notifications=notifications, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCompressionEnabled=shareCompressionEnabled, tegileConformance=tegileConformance, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolProjectCount=poolProjectCount, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTargetReadLatency=iscsiTargetReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tegileArray_notifications=tegileArray_notifications, tegileCompliances=tegileCompliances, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolTotalReadIops=poolTotalReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", replicationComplete=replicationComplete, lunTargetGroup=lunTargetGroup, projectShareCount=projectShareCount, fcTargetsTable=fcTargetsTable, poolDeleted=poolDeleted, iscsiInitiatorEntry=iscsiInitiatorEntry, lunReservedSizeHigh=lunReservedSizeHigh, lunEntry=lunEntry, poolTotalReadMbps=poolTotalReadMbps, poolDataReadMbps=poolDataReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareCIFSReadMbps=shareCIFSReadMbps, lunSizeLow=lunSizeLow, deleteFolderFailed=deleteFolderFailed, pools=pools, adServerTimeDrift=adServerTimeDrift, projectSnapshotSizeHigh=projectSnapshotSizeHigh, sharePoolName=sharePoolName, projectDeleted=projectDeleted, nicMTU=nicMTU, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, unknownSensorEvent=unknownSensorEvent, notificationProps=notificationProps, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, network=network, smisServiceStopped=smisServiceStopped, memoryFailure=memoryFailure, lunReservedSizeLow=lunReservedSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, aclMigrationCompleted=aclMigrationCompleted, properties=properties, vmwareNFSDatastores=vmwareNFSDatastores, poolOwnerController=poolOwnerController, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haResourceDescription=haResourceDescription, controllerHardwareModel=controllerHardwareModel, PYSNMP_MODULE_ID=tegile, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDataWriteMbps=poolDataWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, networkIpmpGroupUp=networkIpmpGroupUp, diskTotalWriteMbps=diskTotalWriteMbps, poolTable=poolTable, alertsCleanupCompleted=alertsCleanupCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, sanProperties=sanProperties, haControllerB_Name=haControllerB_Name, basicCompliance=basicCompliance, testNotification=testNotification, lunSnapshotSizeLow=lunSnapshotSizeLow, shareName=shareName, projectPoolName=projectPoolName, snmpServiceStartFailed=snmpServiceStartFailed, poolHealth=poolHealth, poolCreated=poolCreated, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetStatus=fcTargetStatus, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nicName=nicName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, volumeModifyCompleted=volumeModifyCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerA_Uptime=haControllerA_Uptime, poolCount=poolCount, nfsAvgWriteLatency=nfsAvgWriteLatency, diskCount=diskCount, nicEntry=nicEntry, aclMigrationStarted=aclMigrationStarted, diskTotalWriteIops=diskTotalWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectDataSizeLow=projectDataSizeLow, lunInitiatorGroup=lunInitiatorGroup, replicationResumed=replicationResumed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetIndex=iscsiTargetIndex, poolAvgWriteLatency=poolAvgWriteLatency, ipmiThreshold=ipmiThreshold, networkInterfaceDown=networkInterfaceDown, poolExported=poolExported, projectName=projectName, smisServiceStarted=smisServiceStarted, diskSequentialIOCount=diskSequentialIOCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, cacheTotalReadIops=cacheTotalReadIops, poolTotalSaving=poolTotalSaving, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectTable=projectTable, projectCreatedSuccessfully=projectCreatedSuccessfully, nvdimmFailInitializationError=nvdimmFailInitializationError, diskTotalReadMbps=diskTotalReadMbps, netbiosSocketFailure=netbiosSocketFailure, shareCIFSWriteIops=shareCIFSWriteIops, shareTable=shareTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, diskTable=diskTable, poolFreeSizeLow=poolFreeSizeLow, smisServiceStartFailed=smisServiceStartFailed, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorName=fcInitiatorName, tegile=tegile, shareDedupEnabled=shareDedupEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetIndex=fcTargetIndex, notificationComponentName=notificationComponentName, nvdimmFailUnknownError=nvdimmFailUnknownError, lunReadIops=lunReadIops, diskDataReadMbps=diskDataReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareDeletionFailed=shareDeletionFailed, lunIndex=lunIndex, iscsiWriteIops=iscsiWriteIops, notificationDescription=notificationDescription, iscsiTargets=iscsiTargets, lunProjectName=lunProjectName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareProjectName=shareProjectName, notificationObjects=notificationObjects, nfsTotalReadIops=nfsTotalReadIops, currentNotificationGroup=currentNotificationGroup, spareDiskReplaced=spareDiskReplaced, diskSlowIo=diskSlowIo, nicReceiveMbps=nicReceiveMbps, upgradeFailed=upgradeFailed, tegileGroups=tegileGroups, upgradeDownloadStarted=upgradeDownloadStarted, cpuInterrupts=cpuInterrupts, shareReservedSizeLow=shareReservedSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolDataReadIops=poolDataReadIops, fcInitiators=fcInitiators, diskPoolName=diskPoolName, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, nicTransmitMbps=nicTransmitMbps, diagnosticDataUploaded=diagnosticDataUploaded, diskSizeLow=diskSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, networkInterfaceUp=networkInterfaceUp, haControllerB_Uptime=haControllerB_Uptime, projectShares=projectShares, lunDataSizeLow=lunDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, replicationPaused=replicationPaused, fcTargetName=fcTargetName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cpuSystemCalls=cpuSystemCalls, poolReadCacheReadLatency=poolReadCacheReadLatency, poolProjects=poolProjects, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, upgradeStarted=upgradeStarted, cpuTotalUsage=cpuTotalUsage, lunCompressionEnabled=lunCompressionEnabled, fcTargetEntry=fcTargetEntry, notificationSensorSuspect=notificationSensorSuspect, cifsTotalReadMbps=cifsTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareDataSizeHigh=shareDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorsTable=fcInitiatorsTable, poolDataSizeLow=poolDataSizeLow, poolQuotaFinished=poolQuotaFinished, projectQuotaSizeLow=projectQuotaSizeLow, diskTotalReadIops=diskTotalReadIops, poolDataSizeHigh=poolDataSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, shareQuotaHigh=shareQuotaHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectTotalSaving=projectTotalSaving, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, fcTargetReadMbps=fcTargetReadMbps, shareNFSReadLatency=shareNFSReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, lunWriteLatency=lunWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectDedupEnabled=projectDedupEnabled, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationAborted=replicationAborted, fcInitiatorGroup=fcInitiatorGroup, projectLunCount=projectLunCount, poolIndex=poolIndex, projectFreeSizeHigh=projectFreeSizeHigh, nicTable=nicTable, diskDataReadIops=diskDataReadIops)
