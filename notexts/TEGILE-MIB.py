...
iso, Integer32, NotificationType, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, TimeTicks, MibIdentifier, IpAddress, Bits, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", cacheRAMReads=cacheRAMReads, lunReadMbps=lunReadMbps, sanProperties=sanProperties, iscsiInitiatorsTable=iscsiInitiatorsTable, shareDataSizeLow=shareDataSizeLow, projectName=projectName, unknownSensorEvent=unknownSensorEvent, haControllerB_Name=haControllerB_Name, notificationEventCode=notificationEventCode, currentNotificationGroup=currentNotificationGroup, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetName=iscsiTargetName, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, notificationSeverity=notificationSeverity, snapshotDeleteFailed=snapshotDeleteFailed, lunProjectName=lunProjectName, properties=properties, notificationObjects=notificationObjects, fcTargetReadMbps=fcTargetReadMbps, projectDataSizeHigh=projectDataSizeHigh, shareNFSEnabled=shareNFSEnabled, shareQuotaHigh=shareQuotaHigh, projectQuotaSizeLow=projectQuotaSizeLow, lunCompressionEnabled=lunCompressionEnabled, sensorFailureEvent=sensorFailureEvent, ipmiTemperature=ipmiTemperature, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectDeleted=projectDeleted, pools=pools, iscsiWriteIops=iscsiWriteIops, lunReadIops=lunReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, sharePoolName=sharePoolName, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationResumed=replicationResumed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectIndex=projectIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTotalWriteMbps=fcTotalWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiInitiatorName=iscsiInitiatorName, shareEntry=shareEntry, shareCompressedRatio=shareCompressedRatio, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, poolState=poolState, upgradeDownloadStarted=upgradeDownloadStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareMountPoint=shareMountPoint, iscsiTotalReadMbps=iscsiTotalReadMbps, upgradeStarted=upgradeStarted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorEntry=fcInitiatorEntry, shareNFSWriteLatency=shareNFSWriteLatency, notifications=notifications, shareQuotaFinished=shareQuotaFinished, shareSnapshotSizeLow=shareSnapshotSizeLow, haControllerA_Name=haControllerA_Name, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, snmpAgentVersion=snmpAgentVersion, iscsiTargetGroupError=iscsiTargetGroupError, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSWriteIops=shareNFSWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, haResources=haResources, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cacheTotalReadIops=cacheTotalReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haResourceActiveNode=haResourceActiveNode, nicIndex=nicIndex, shareCIFSWriteIops=shareCIFSWriteIops, ntpServerTimeDrift=ntpServerTimeDrift, poolDeleted=poolDeleted, smisServiceStartFailed=smisServiceStartFailed, nicEntry=nicEntry, projectShares=projectShares, projectDedupEnabled=projectDedupEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolExpanded=poolExpanded, diskGoneOffline=diskGoneOffline, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, upgradeTimeout=upgradeTimeout, notificationSensorSuspect=notificationSensorSuspect, haControllerA_Uptime=haControllerA_Uptime, lunName=lunName, poolTotalWriteIops=poolTotalWriteIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTotalReadMbps=diskTotalReadMbps, network=network, fcTargetWriteMbps=fcTargetWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcPortOffline=fcPortOffline, projectTotalSaving=projectTotalSaving, poolProjects=poolProjects, poolMetaReadLatency=poolMetaReadLatency, cacheSSDReads=cacheSSDReads, iscsiTargetReadMbps=iscsiTargetReadMbps, controllerTimeDrift=controllerTimeDrift, smisServiceStarted=smisServiceStarted, lunWriteMbps=lunWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCIFSReadLatency=shareCIFSReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nfsTotalReadMbps=nfsTotalReadMbps, userLoginFailed=userLoginFailed, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, alertsCleanupCompleted=alertsCleanupCompleted, poolDataReadLatency=poolDataReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, projectTable=projectTable, notificationTargetEntityName=notificationTargetEntityName, nicReceiveMbps=nicReceiveMbps, fcTargetWriteLatency=fcTargetWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectLUNs=projectLUNs, poolMetaReadMbps=poolMetaReadMbps, poolHealth=poolHealth, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolEntry=poolEntry, upgradeCompleted=upgradeCompleted, poolDataReadIops=poolDataReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCloneCompleted=snapshotCloneCompleted, snmpServiceStopFailed=snmpServiceStopFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectShareCount=projectShareCount, lunSnapshotSizeHigh=lunSnapshotSizeHigh, disks=disks, webdocsUpgradeFailed=webdocsUpgradeFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetIndex=fcTargetIndex, smisServiceStopFailed=smisServiceStopFailed, aclMigrationStarted=aclMigrationStarted, ipmiFan=ipmiFan, snapshotRollbackFailed=snapshotRollbackFailed, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, projectThresholdExceedWarning=projectThresholdExceedWarning, haResourceStatus=haResourceStatus, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectEntry=projectEntry, currentObjectGroup=currentObjectGroup, adServerTimeDrift=adServerTimeDrift, diskDataWriteMbps=diskDataWriteMbps, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, diskChassisIdx=diskChassisIdx, fcTotalWriteIops=fcTotalWriteIops, lunSizeHigh=lunSizeHigh, poolUpgraded=poolUpgraded, lunWriteIops=lunWriteIops, volumeDeleteFailed=volumeDeleteFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolDegraded=poolDegraded, poolOwnerController=poolOwnerController, shareProjectName=shareProjectName, tegileGroups=tegileGroups, haResourceIndex=haResourceIndex, basicCompliance=basicCompliance, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, diskState=diskState, lunDataSizeLow=lunDataSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, diskTotalReadIops=diskTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, poolAvgReadLatency=poolAvgReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskDataWriteIops=diskDataWriteIops, poolDataSizeLow=poolDataSizeLow, diskIndex=diskIndex, poolSizeHigh=poolSizeHigh, nicTransmitMbps=nicTransmitMbps, nicTable=nicTable, lunIndex=lunIndex, poolMetaReadIops=poolMetaReadIops, snapshotCloningFailed=snapshotCloningFailed, projectModified=projectModified, replicationPaused=replicationPaused, notificationProps=notificationProps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSReadIops=shareCIFSReadIops, controllerUp=controllerUp, shareName=shareName, poolSizeLow=poolSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetReadLatency=fcTargetReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareReservedSizeHigh=shareReservedSizeHigh, poolDataWriteMbps=poolDataWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTargetStatus=fcTargetStatus, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskPoolName=diskPoolName, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, poolIndex=poolIndex, replicationSourceRegistered=replicationSourceRegistered, nvdimmFailSoftError=nvdimmFailSoftError, shareDeletionFailed=shareDeletionFailed, shareQuotaLow=shareQuotaLow, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskIOCount=diskIOCount, aclMigrationCompleted=aclMigrationCompleted, snmpServiceStartFailed=snmpServiceStartFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, diskSlowIo=diskSlowIo, nicMTU=nicMTU, iscsiTargetAuth=iscsiTargetAuth, projectCompressionEnabled=projectCompressionEnabled, poolDataWriteLatency=poolDataWriteLatency, shareIndex=shareIndex, fcPortOnline=fcPortOnline, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, tdpsUpgradeFailed=tdpsUpgradeFailed, lunTable=lunTable, smbSocketFailure=smbSocketFailure, diskCount=diskCount, projectCreatedSuccessfully=projectCreatedSuccessfully)
mibBuilder.exportSymbols("TEGILE-MIB", diskAvgReadLatency=diskAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskTotalWriteIops=diskTotalWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationSensorNumber=notificationSensorNumber, poolTable=poolTable, networkTotalReceiveMbps=networkTotalReceiveMbps, notificationReadingUnit=notificationReadingUnit, poolImported=poolImported, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationComponentName=notificationComponentName, nfsTotalReadIops=nfsTotalReadIops, diskAlias=diskAlias, lunCompressedRatio=lunCompressedRatio, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetsTable=fcTargetsTable, poolExported=poolExported, tegileArray_notifications=tegileArray_notifications, fcTargetEntry=fcTargetEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, controllerHardwareModel=controllerHardwareModel, poolName=poolName, volumeModifyCompleted=volumeModifyCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareDeleted=shareDeleted, poolFreeSizeHigh=poolFreeSizeHigh, diskIsOnline=diskIsOnline, iscsiInitiatorEntry=iscsiInitiatorEntry, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastores=vmwareNFSDatastores, volumeQuotaFinished=volumeQuotaFinished, diskTable=diskTable, maintenanceModeEnabled=maintenanceModeEnabled, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSizeLow=diskSizeLow, iscsiTargets=iscsiTargets, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceDescription=haResourceDescription, ipmiPowerSupply=ipmiPowerSupply, spareDiskReplaced=spareDiskReplaced, projectPoolName=projectPoolName, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunWriteLatency=lunWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationTime=notificationTime, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskType=diskType, ipmiCurrent=ipmiCurrent, tegile=tegile, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haControllerB_Uptime=haControllerB_Uptime, notificationSensorAction=notificationSensorAction, globalStatistics=globalStatistics, snapshotRollbackCompleted=snapshotRollbackCompleted, poolDataSizeHigh=poolDataSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, lunReadLatency=lunReadLatency, projectDeletionFailed=projectDeletionFailed, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nicName=nicName, iscsiInitiators=iscsiInitiators, replicationStarted=replicationStarted, lunFreeSizeHigh=lunFreeSizeHigh, replicationTargetDeleted=replicationTargetDeleted, haResourceGroup=haResourceGroup, poolDataWriteIops=poolDataWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectLunCount=projectLunCount, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcAvgReadLatency=fcAvgReadLatency, projectDataSizeLow=projectDataSizeLow, shareNFSReadMbps=shareNFSReadMbps, replicationComplete=replicationComplete, lunTargetGroup=lunTargetGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, netbiosSocketFailure=netbiosSocketFailure, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationAbandoned=replicationAbandoned, projectFreeSizeLow=projectFreeSizeLow, memoryFailure=memoryFailure, fcInitiatorName=fcInitiatorName, fcTargetGroup=fcTargetGroup, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalReadIops=poolTotalReadIops, nicState=nicState, iscsiProperties=iscsiProperties, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcTargetName=fcTargetName, upgradeFailed=upgradeFailed, lunDataSizeHigh=lunDataSizeHigh, snapshotCreationFailed=snapshotCreationFailed, lunGUID=lunGUID, nicGroup=nicGroup, cifsTotalWriteIops=cifsTotalWriteIops, fcProperties=fcProperties, shareCIFSWriteLatency=shareCIFSWriteLatency, diskRandomIOCount=diskRandomIOCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataReadMbps=poolDataReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, poolMetaWriteIops=poolMetaWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiThreshold=ipmiThreshold, diskSequentialIOCount=diskSequentialIOCount, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareDataSizeHigh=shareDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetIndex=iscsiTargetIndex, poolFreeSizeLow=poolFreeSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunBlockSize=lunBlockSize, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunDedupEnabled=lunDedupEnabled, testNotification=testNotification, deleteFolderFailed=deleteFolderFailed, shareCIFSEnabled=shareCIFSEnabled, upgradeDownloadCompleted=upgradeDownloadCompleted, networkInterfaceUp=networkInterfaceUp, shareNFSWriteMbps=shareNFSWriteMbps, shareNFSReadIops=shareNFSReadIops, cifsTotalReadIops=cifsTotalReadIops, shareCompressionEnabled=shareCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tegileArray=tegileArray, lunProtocol=lunProtocol, networkInterfaceDown=networkInterfaceDown, poolTotalSaving=poolTotalSaving, lunPoolName=lunPoolName, fcInitiators=fcInitiators, fcInitiatorIndex=fcInitiatorIndex, poolQuotaFinished=poolQuotaFinished, diskDataReadMbps=diskDataReadMbps, cpuInterrupts=cpuInterrupts, cpuSystemCalls=cpuSystemCalls, haResourceName=haResourceName, lunSnapshotSizeLow=lunSnapshotSizeLow, diskError=diskError, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, ipmiOther=ipmiOther, ipmiMemory=ipmiMemory, poolProjectCount=poolProjectCount, haResourcesTable=haResourcesTable, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nfsTotalWriteIops=nfsTotalWriteIops, fcTotalReadIops=fcTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, fcTotalReadMbps=fcTotalReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectQuotaFinished=projectQuotaFinished, nvdimmFailUnknownError=nvdimmFailUnknownError, diskEntry=diskEntry, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalReadMbps=poolTotalReadMbps, ipmiVoltage=ipmiVoltage, controllerDown=controllerDown, snmpServiceStopped=snmpServiceStopped, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolCount=poolCount, tegileCompliances=tegileCompliances, projectQuotaSizeHigh=projectQuotaSizeHigh, shareNFSReadLatency=shareNFSReadLatency, lunFreeSizeLow=lunFreeSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetReadIops=fcTargetReadIops, shareCIFSReadMbps=shareCIFSReadMbps, targetGroupMemberAdded=targetGroupMemberAdded, lunEntry=lunEntry, poolMetaWriteLatency=poolMetaWriteLatency, diskSizeHigh=diskSizeHigh, shareTable=shareTable, networkTotalTransmitMbps=networkTotalTransmitMbps, poolTotalWriteMbps=poolTotalWriteMbps, poolCreated=poolCreated, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationAborted=replicationAborted, replicationFailed=replicationFailed, networkIpmpGroupUp=networkIpmpGroupUp, fcTargets=fcTargets, tdpsUpgradeCompleted=tdpsUpgradeCompleted, PYSNMP_MODULE_ID=tegile, tegileConformance=tegileConformance, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationDescription=notificationDescription, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareDedupEnabled=shareDedupEnabled, deleteFolderCompleted=deleteFolderCompleted, cpuTotalUsage=cpuTotalUsage, lunReservedSizeLow=lunReservedSizeLow)
