...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:26:44 2022
...
enterprises, Bits, MibIdentifier, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, iso, Unsigned32, Gauge32, TimeTicks, Counter32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "iso", "Unsigned32", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolFreeSizeLow=poolFreeSizeLow, snmpServiceStarted=snmpServiceStarted, haControllerA_IPAddr=haControllerA_IPAddr, diskPoolName=diskPoolName, cifsAvgWriteLatency=cifsAvgWriteLatency, diskDataReadMbps=diskDataReadMbps, fcTargetWriteIops=fcTargetWriteIops, notifications=notifications, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, smisServiceStopped=smisServiceStopped, poolTotalReadIops=poolTotalReadIops, replicationStarted=replicationStarted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, controllerDown=controllerDown, lunIndex=lunIndex, shareMountPoint=shareMountPoint, diskIsOnline=diskIsOnline, fcTargets=fcTargets, fcInitiatorsTable=fcInitiatorsTable, fcTargetReadMbps=fcTargetReadMbps, userLoginFailed=userLoginFailed, lunReservedSizeLow=lunReservedSizeLow, lunBlockSize=lunBlockSize, diskError=diskError, upgradeFailed=upgradeFailed, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskGoneOffline=diskGoneOffline, poolImported=poolImported, smisServiceStarted=smisServiceStarted, diskSequentialIOCount=diskSequentialIOCount, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetIndex=fcTargetIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, ipmiFan=ipmiFan, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunProtocol=lunProtocol, poolSizeHigh=poolSizeHigh, shareCompressedRatio=shareCompressedRatio, fcInitiatorGroup=fcInitiatorGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cacheRAMReads=cacheRAMReads, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cpuSystemCalls=cpuSystemCalls, diskType=diskType, testNotification=testNotification, iscsiTargetName=iscsiTargetName, fcInitiatorIndex=fcInitiatorIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcPortOnline=fcPortOnline, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiTargetGroupError=iscsiTargetGroupError, diskTable=diskTable, lunProjectName=lunProjectName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, nicState=nicState, controllerUp=controllerUp, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetGroup=iscsiTargetGroup, notificationSensorSuspect=notificationSensorSuspect, diskIOCount=diskIOCount, ipmiOther=ipmiOther, poolTable=poolTable, deleteFolderFailed=deleteFolderFailed, fcPortOffline=fcPortOffline, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunEntry=lunEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunTable=lunTable, iscsiProperties=iscsiProperties, aclMigrationStarted=aclMigrationStarted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, globalStatistics=globalStatistics, shareCompressionEnabled=shareCompressionEnabled, projectFreeSizeHigh=projectFreeSizeHigh, notificationEventCode=notificationEventCode, poolReadCacheReadMbps=poolReadCacheReadMbps, haResourceActiveNode=haResourceActiveNode, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicTransmitMbps=nicTransmitMbps, disks=disks, tdpsUpgradeFailed=tdpsUpgradeFailed, replicationResumed=replicationResumed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTargetReadLatency=fcTargetReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunReadIops=lunReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeStarted=upgradeStarted, replicationFailed=replicationFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectIndex=projectIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, poolMetaReadLatency=poolMetaReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolUsedSizeHigh=poolUsedSizeHigh, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectTable=projectTable, projectDeleted=projectDeleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiPowerSupply=ipmiPowerSupply, pools=pools, fcTotalWriteMbps=fcTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCIFSReadIops=shareCIFSReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, properties=properties, poolCount=poolCount, shareQuotaLow=shareQuotaLow, shareNFSWriteIops=shareNFSWriteIops, lunWriteIops=lunWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeQuotaFinished=volumeQuotaFinished, fcInitiators=fcInitiators, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareQuotaFinished=shareQuotaFinished, diskTotalWriteIops=diskTotalWriteIops, cpuTotalUsage=cpuTotalUsage, iscsiTargetIndex=iscsiTargetIndex, projectQuotaFinished=projectQuotaFinished, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetWriteIops=iscsiTargetWriteIops, shareReservedSizeLow=shareReservedSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiators=iscsiInitiators, fcInitiatorName=fcInitiatorName, notificationReadingTriggerValue=notificationReadingTriggerValue, projectSnapshotSizeLow=projectSnapshotSizeLow, tegileConformance=tegileConformance, upgradeDownloadFailed=upgradeDownloadFailed, snapshotRollbackFailed=snapshotRollbackFailed, nicEntry=nicEntry, poolUsedSizeLow=poolUsedSizeLow, notificationProps=notificationProps, networkIpmpGroupUp=networkIpmpGroupUp, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, replicationTargetDeleted=replicationTargetDeleted, haResourceIndex=haResourceIndex, projectLUNs=projectLUNs, lunName=lunName, replicationPaused=replicationPaused, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolExpanded=poolExpanded, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetAuth=iscsiTargetAuth, cacheTotalReadIops=cacheTotalReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, smisServiceStartFailed=smisServiceStartFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolDegraded=poolDegraded, diskAlias=diskAlias, projectEntry=projectEntry, poolFreeSizeHigh=poolFreeSizeHigh, fcAvgReadLatency=fcAvgReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataSizeHigh=poolDataSizeHigh, fcTargetStatus=fcTargetStatus, netbiosSocketFailure=netbiosSocketFailure, networkTotalTransmitMbps=networkTotalTransmitMbps, tegileArray_notifications=tegileArray_notifications, shareNFSWriteMbps=shareNFSWriteMbps, poolAvgReadLatency=poolAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaReadMbps=poolMetaReadMbps, notificationSensorNumber=notificationSensorNumber, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationAbandoned=replicationAbandoned, projectLunCount=projectLunCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolAvgWriteLatency=poolAvgWriteLatency, snmpAgentVersion=snmpAgentVersion, replicationAborted=replicationAborted, nvdimmFailUnknownError=nvdimmFailUnknownError, projectShareCount=projectShareCount, basicCompliance=basicCompliance, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSReadMbps=shareNFSReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, diskTotalReadMbps=diskTotalReadMbps, notificationTime=notificationTime, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nfsAvgReadLatency=nfsAvgReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, adServerTimeDrift=adServerTimeDrift, diskState=diskState, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetsTable=fcTargetsTable, poolTotalReadMbps=poolTotalReadMbps, poolProjectCount=poolProjectCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectPoolName=projectPoolName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiWriteIops=iscsiWriteIops, lunPoolName=lunPoolName, nfsTotalWriteIops=nfsTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationTargetEntityName=notificationTargetEntityName, tegileCompliances=tegileCompliances, fcInitiatorEntry=fcInitiatorEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataWriteMbps=poolDataWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiCurrent=ipmiCurrent, network=network, lunReadLatency=lunReadLatency, haResourceGroup=haResourceGroup, poolProjects=poolProjects, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nfsTotalReadMbps=nfsTotalReadMbps, poolQuotaFinished=poolQuotaFinished, shareReservedSizeHigh=shareReservedSizeHigh, shareDeleted=shareDeleted, targetGroupCreateCompleted=targetGroupCreateCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetGroup=fcTargetGroup, aclMigrationCompleted=aclMigrationCompleted, poolHealth=poolHealth, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectTotalSaving=projectTotalSaving, fcTargetWriteMbps=fcTargetWriteMbps, notificationObjects=notificationObjects, haControllerB_Uptime=haControllerB_Uptime, sensorFailureEvent=sensorFailureEvent, nfsTotalReadIops=nfsTotalReadIops, projectName=projectName)
mibBuilder.exportSymbols("TEGILE-MIB", nicName=nicName, haControllerA_Uptime=haControllerA_Uptime, projectShares=projectShares, snmpServiceStopped=snmpServiceStopped, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeTimeout=upgradeTimeout, lunDedupEnabled=lunDedupEnabled, haResources=haResources, shareDataSizeLow=shareDataSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataWriteIops=poolDataWriteIops, poolDeletionFailed=poolDeletionFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haResourceDescription=haResourceDescription, unknownSensorEvent=unknownSensorEvent, iscsiTargetEntry=iscsiTargetEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, controllerTimeDrift=controllerTimeDrift, tegile=tegile, shareCIFSEnabled=shareCIFSEnabled, memoryFailure=memoryFailure, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheReadIops=poolReadCacheReadIops, cacheTotalReadMbps=cacheTotalReadMbps, poolSizeLow=poolSizeLow, fcTargetEntry=fcTargetEntry, projectDedupEnabled=projectDedupEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, notificationSeverity=notificationSeverity, networkInterfaceUp=networkInterfaceUp, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorEntry=iscsiInitiatorEntry, shareNFSReadLatency=shareNFSReadLatency, nicIndex=nicIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nicTable=nicTable, diskChassisIdx=diskChassisIdx, poolTotalWriteMbps=poolTotalWriteMbps, shareIndex=shareIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsTotalWriteMbps=cifsTotalWriteMbps, fcProperties=fcProperties, notificationReadingUnit=notificationReadingUnit, deleteFolderCompleted=deleteFolderCompleted, iscsiTotalReadIops=iscsiTotalReadIops, shareNFSReadIops=shareNFSReadIops, notificationSensorAction=notificationSensorAction, iscsiTargetReadIops=iscsiTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolUpgraded=poolUpgraded, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, volumeModifyCompleted=volumeModifyCompleted, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, haResourceStatus=haResourceStatus, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectModified=projectModified, haControllerB_IPAddr=haControllerB_IPAddr, poolCreated=poolCreated, projectFreeSizeLow=projectFreeSizeLow, iscsiTargets=iscsiTargets, fcTotalReadMbps=fcTotalReadMbps, poolIndex=poolIndex, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolDataSizeLow=poolDataSizeLow, poolEntry=poolEntry, shareCIFSReadLatency=shareCIFSReadLatency, lunSizeHigh=lunSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorName=iscsiInitiatorName, diskRandomIOCount=diskRandomIOCount, lunWriteLatency=lunWriteLatency, spareDiskReplaced=spareDiskReplaced, lunFreeSizeLow=lunFreeSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cifsAvgReadLatency=cifsAvgReadLatency, diskTotalWriteMbps=diskTotalWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteIops=shareCIFSWriteIops, shareProjectName=shareProjectName, projectQuotaSizeHigh=projectQuotaSizeHigh, currentNotificationGroup=currentNotificationGroup, diskTotalReadIops=diskTotalReadIops, ipmiMemory=ipmiMemory, snapshotCloneCompleted=snapshotCloneCompleted, poolDataReadIops=poolDataReadIops, nicMTU=nicMTU, upgradeCompleted=upgradeCompleted, shareDedupEnabled=shareDedupEnabled, lunCompressionEnabled=lunCompressionEnabled, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkInterfaceDown=networkInterfaceDown, lunSnapshotSizeLow=lunSnapshotSizeLow, tegileArray=tegileArray, diskSlowIo=diskSlowIo, lunFreeSizeHigh=lunFreeSizeHigh, nicGroup=nicGroup, cacheTotalWriteIops=cacheTotalWriteIops, sharePoolName=sharePoolName, smbSocketFailure=smbSocketFailure, poolDeleted=poolDeleted, poolMetaWriteLatency=poolMetaWriteLatency, shareDataSizeHigh=shareDataSizeHigh, projectDeletionFailed=projectDeletionFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskSizeHigh=diskSizeHigh, poolExported=poolExported, iscsiTargetReadLatency=iscsiTargetReadLatency, cacheSSDReads=cacheSSDReads, upgradeDownloadStarted=upgradeDownloadStarted, lunDataSizeLow=lunDataSizeLow, ipmiThreshold=ipmiThreshold, fcTotalReadIops=fcTotalReadIops, lunWriteMbps=lunWriteMbps, ipmiVoltage=ipmiVoltage, diskSizeLow=diskSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareTable=shareTable, fcAvgWriteLatency=fcAvgWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunGUID=lunGUID, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationSourceRegistered=replicationSourceRegistered, nicReceiveMbps=nicReceiveMbps, shareEntry=shareEntry, notificationDescription=notificationDescription, haResourceName=haResourceName, diskAvgWriteLatency=diskAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, sanProperties=sanProperties, poolDataWriteLatency=poolDataWriteLatency, lunSizeLow=lunSizeLow, PYSNMP_MODULE_ID=tegile, shareQuotaHigh=shareQuotaHigh, lunTargetGroup=lunTargetGroup, snapshotCloningFailed=snapshotCloningFailed, shareDeletionFailed=shareDeletionFailed, poolName=poolName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectDataSizeHigh=projectDataSizeHigh, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskCount=diskCount, poolTotalSaving=poolTotalSaving, diskIndex=diskIndex, lunReadMbps=lunReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, fcTargetName=fcTargetName, poolOwnerController=poolOwnerController, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cpuInterrupts=cpuInterrupts, shareCIFSReadMbps=shareCIFSReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, diskEntry=diskEntry, haControllerB_Name=haControllerB_Name, haResourcesTable=haResourcesTable, nvdimmFailInitializationError=nvdimmFailInitializationError, shareNFSEnabled=shareNFSEnabled, projectDataSizeLow=projectDataSizeLow, volumeDeleteFailed=volumeDeleteFailed, poolMetaWriteIops=poolMetaWriteIops, haResourceEntry=haResourceEntry, snmpServiceStartFailed=snmpServiceStartFailed, replicationComplete=replicationComplete, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cifsTotalWriteIops=cifsTotalWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, ipmiTemperature=ipmiTemperature, notificationComponentName=notificationComponentName, targetGroupMemberAdded=targetGroupMemberAdded, tegileGroups=tegileGroups, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunCompressedRatio=lunCompressedRatio, lunDataSizeHigh=lunDataSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolState=poolState, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetReadIops=fcTargetReadIops, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetError=iscsiTargetError, controllerHardwareModel=controllerHardwareModel, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTotalWriteIops=fcTotalWriteIops, shareName=shareName)
