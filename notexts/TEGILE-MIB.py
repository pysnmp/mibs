...
Counter32, NotificationType, ModuleIdentity, IpAddress, Counter64, enterprises, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks, Gauge32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "enterprises", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, projectLUNs=projectLUNs, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cacheRAMReads=cacheRAMReads, projectThresholdExceedWarning=projectThresholdExceedWarning, diskType=diskType, sharePoolName=sharePoolName, haResourceEntry=haResourceEntry, fcTargetGroup=fcTargetGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, smbSocketFailure=smbSocketFailure, shareCIFSEnabled=shareCIFSEnabled, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, projectIndex=projectIndex, fcTargetReadMbps=fcTargetReadMbps, poolName=poolName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diskError=diskError, sensorFailureEvent=sensorFailureEvent, projectDataSizeLow=projectDataSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, haControllerA_Name=haControllerA_Name, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetsTable=fcTargetsTable, userLoginFailed=userLoginFailed, lunFreeSizeLow=lunFreeSizeLow, poolDataReadIops=poolDataReadIops, fcInitiatorIndex=fcInitiatorIndex, projectQuotaSizeLow=projectQuotaSizeLow, network=network, snmpAgentVersion=snmpAgentVersion, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, volumeModifyCompleted=volumeModifyCompleted, lunDataSizeLow=lunDataSizeLow, nicState=nicState, snapshotRollbackFailed=snapshotRollbackFailed, networkIpmpGroupUp=networkIpmpGroupUp, projectTotalSaving=projectTotalSaving, ipmiCurrent=ipmiCurrent, fcTargetWriteIops=fcTargetWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, lunWriteMbps=lunWriteMbps, shareCIFSReadIops=shareCIFSReadIops, poolSizeHigh=poolSizeHigh, iscsiTargetAuth=iscsiTargetAuth, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetGroup=iscsiTargetGroup, diskTotalWriteIops=diskTotalWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, testNotification=testNotification, shareQuotaHigh=shareQuotaHigh, shareNFSReadIops=shareNFSReadIops, upgradeDownloadStarted=upgradeDownloadStarted, maintenanceModeEnabled=maintenanceModeEnabled, poolUpgraded=poolUpgraded, basicCompliance=basicCompliance, projectFreeSizeLow=projectFreeSizeLow, ipmiMemory=ipmiMemory, iscsiInitiatorIndex=iscsiInitiatorIndex, controllerUp=controllerUp, poolDataWriteLatency=poolDataWriteLatency, fcPortOnline=fcPortOnline, nvdimmFailInitializationError=nvdimmFailInitializationError, lunProtocol=lunProtocol, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskAlias=diskAlias, haResourceGroup=haResourceGroup, lunGUID=lunGUID, snmpServiceStartFailed=snmpServiceStartFailed, poolTotalWriteIops=poolTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, fcTargets=fcTargets, properties=properties, nvdimmFailDeviceError=nvdimmFailDeviceError, shareCompressionEnabled=shareCompressionEnabled, replicationSourceRegistered=replicationSourceRegistered, lunDedupEnabled=lunDedupEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcProperties=fcProperties, lunName=lunName, projectShares=projectShares, nicTable=nicTable, nvdimmFailSoftError=nvdimmFailSoftError, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTotalReadIops=fcTotalReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareNFSEnabled=shareNFSEnabled, shareNFSReadMbps=shareNFSReadMbps, PYSNMP_MODULE_ID=tegile, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, sanProperties=sanProperties, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationEventCode=notificationEventCode, haControllerA_IPAddr=haControllerA_IPAddr, diskState=diskState, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcInitiatorEntry=fcInitiatorEntry, notificationProps=notificationProps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCompressedRatio=shareCompressedRatio, shareReservedSizeLow=shareReservedSizeLow, deleteFolderFailed=deleteFolderFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cacheSSDReads=cacheSSDReads, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, globalStatistics=globalStatistics, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaFinished=shareQuotaFinished, lunPoolName=lunPoolName, networkInterfaceUp=networkInterfaceUp, notificationReadingUnit=notificationReadingUnit, lunDataSizeHigh=lunDataSizeHigh, fcTargetName=fcTargetName, shareDeleted=shareDeleted, ntpServerTimeDrift=ntpServerTimeDrift, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunReservedSizeLow=lunReservedSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetAlias=iscsiTargetAlias, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSWriteLatency=shareNFSWriteLatency, projectPoolName=projectPoolName, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, haResourceActiveNode=haResourceActiveNode, poolTotalWriteMbps=poolTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, poolState=poolState, diskDataWriteIops=diskDataWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeDeleteFailed=volumeDeleteFailed, haControllerB_Uptime=haControllerB_Uptime, lunWriteIops=lunWriteIops, smisServiceStarted=smisServiceStarted, fcTargetModifyCompleted=fcTargetModifyCompleted, disks=disks, notificationDescription=notificationDescription, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcTargetReadIops=fcTargetReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectEntry=projectEntry, haResourcesTable=haResourcesTable, diskEntry=diskEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, upgradeTimeout=upgradeTimeout, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareName=shareName, projectLunCount=projectLunCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunSizeHigh=lunSizeHigh, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareCreatedSuccessfully=shareCreatedSuccessfully, snapshotDeleteFailed=snapshotDeleteFailed, currentObjectGroup=currentObjectGroup, nfsTotalReadIops=nfsTotalReadIops, diskTable=diskTable, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolExpanded=poolExpanded, upgradeDownloadFailed=upgradeDownloadFailed, iscsiProperties=iscsiProperties, lunSizeLow=lunSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTargetStatus=fcTargetStatus, iscsiTargetWriteIops=iscsiTargetWriteIops, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStarted=snmpServiceStarted, poolOwnerController=poolOwnerController, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicGroup=nicGroup, lunCompressedRatio=lunCompressedRatio, poolMetaReadIops=poolMetaReadIops, poolEntry=poolEntry, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTotalSaving=poolTotalSaving, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, nicTransmitMbps=nicTransmitMbps, projectCompressionEnabled=projectCompressionEnabled, poolImported=poolImported, tegile=tegile, poolReadCacheReadMbps=poolReadCacheReadMbps, poolExported=poolExported, poolUsedSizeLow=poolUsedSizeLow, diskSizeHigh=diskSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTable=poolTable, cacheTotalReadMbps=cacheTotalReadMbps, notificationTime=notificationTime, lunReservedSizeHigh=lunReservedSizeHigh, smisServiceStopFailed=smisServiceStopFailed, diskPoolName=diskPoolName, poolIndex=poolIndex, lunProjectName=lunProjectName, upgradeStarted=upgradeStarted, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiators=fcInitiators, shareProjectName=shareProjectName, fcTargetEntry=fcTargetEntry, haResources=haResources, aclMigrationStarted=aclMigrationStarted, targetGroupCreateCompleted=targetGroupCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetReadLatency=fcTargetReadLatency, poolDataWriteIops=poolDataWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunCompressionEnabled=lunCompressionEnabled, diskSequentialIOCount=diskSequentialIOCount, lunReadMbps=lunReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, shareIndex=shareIndex, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskCount=diskCount, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationAbandoned=replicationAbandoned, ipmiVoltage=ipmiVoltage, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDeleted=poolDeleted, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationObjects=notificationObjects, replicationFailed=replicationFailed, diskDataWriteMbps=diskDataWriteMbps, cpuSystemCalls=cpuSystemCalls, controllerTimeDrift=controllerTimeDrift, tegileArray=tegileArray, snapshotCloneCompleted=snapshotCloneCompleted, poolAvgReadLatency=poolAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", projectDedupEnabled=projectDedupEnabled, haControllerB_Name=haControllerB_Name, cifsAvgReadLatency=cifsAvgReadLatency, projectQuotaFinished=projectQuotaFinished, poolDataSizeHigh=poolDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicEntry=nicEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nicName=nicName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataSizeLow=poolDataSizeLow, cpuInterrupts=cpuInterrupts, lunTargetGroup=lunTargetGroup, iscsiTotalReadIops=iscsiTotalReadIops, fcPortOffline=fcPortOffline, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetEntry=iscsiTargetEntry, networkInterfaceDown=networkInterfaceDown, poolFreeSizeHigh=poolFreeSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiInitiators=iscsiInitiators, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tegileConformance=tegileConformance, replicationPaused=replicationPaused, ipmiThreshold=ipmiThreshold, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargets=iscsiTargets, shareNFSReadLatency=shareNFSReadLatency, notificationSensorSuspect=notificationSensorSuspect, shareMountPoint=shareMountPoint, poolFreeSizeLow=poolFreeSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskSlowIo=diskSlowIo, poolMetaWriteMbps=poolMetaWriteMbps, lunIndex=lunIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationStarted=replicationStarted, iscsiInitiatorName=iscsiInitiatorName, fcInitiatorGroup=fcInitiatorGroup, projectSnapshotSizeLow=projectSnapshotSizeLow, lunWriteLatency=lunWriteLatency, lunBlockSize=lunBlockSize, cifsTotalReadIops=cifsTotalReadIops, projectTable=projectTable, fcTotalReadMbps=fcTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, poolTotalReadIops=poolTotalReadIops, diskChassisIdx=diskChassisIdx, projectModified=projectModified, upgradeFailed=upgradeFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareTable=shareTable, diskDataReadIops=diskDataReadIops, shareDedupEnabled=shareDedupEnabled, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerA_Uptime=haControllerA_Uptime, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nicIndex=nicIndex, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolDeletionFailed=poolDeletionFailed, tegileGroups=tegileGroups, poolQuotaFinished=poolQuotaFinished, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetReadIops=iscsiTargetReadIops, shareCIFSWriteIops=shareCIFSWriteIops, poolProjectCount=poolProjectCount, projectShareCount=projectShareCount, haResourceDescription=haResourceDescription, poolProjects=poolProjects, replicationResumed=replicationResumed, ipmiOther=ipmiOther, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareNFSWriteIops=shareNFSWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, nicMTU=nicMTU, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTargetError=iscsiTargetError, iscsiTargetsTable=iscsiTargetsTable, spareDiskReplaced=spareDiskReplaced, diskDataReadMbps=diskDataReadMbps, cpuTotalUsage=cpuTotalUsage, poolDataWriteMbps=poolDataWriteMbps, poolSizeLow=poolSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationTargetDeleted=replicationTargetDeleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, targetGroupMemberAdded=targetGroupMemberAdded, shareCIFSReadLatency=shareCIFSReadLatency, unknownSensorEvent=unknownSensorEvent, tegileArray_notifications=tegileArray_notifications, diskTotalWriteMbps=diskTotalWriteMbps, poolHealth=poolHealth, fcInitiatorName=fcInitiatorName, notifications=notifications, iscsiTargetReadLatency=iscsiTargetReadLatency, lunEntry=lunEntry, notificationSeverity=notificationSeverity, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorsTable=fcInitiatorsTable, volumeDeleteCompleted=volumeDeleteCompleted, pools=pools, lunTable=lunTable, poolDataReadMbps=poolDataReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, shareEntry=shareEntry, lunInitiatorGroup=lunInitiatorGroup, poolDataReadLatency=poolDataReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, tegileCompliances=tegileCompliances, haControllerB_IPAddr=haControllerB_IPAddr, networkTotalTransmitMbps=networkTotalTransmitMbps, haResourceStatus=haResourceStatus, replicationComplete=replicationComplete, shareSnapshotSizeLow=shareSnapshotSizeLow, projectDeleted=projectDeleted, fcAvgReadLatency=fcAvgReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceIndex=haResourceIndex, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTotalWriteIops=fcTotalWriteIops, smisServiceStopped=smisServiceStopped, notificationSensorAction=notificationSensorAction, smisServiceStartFailed=smisServiceStartFailed, lunReadIops=lunReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotCreationFailed=snapshotCreationFailed, shareDataSizeLow=shareDataSizeLow, controllerHardwareModel=controllerHardwareModel, cacheTotalWriteMbps=cacheTotalWriteMbps, haResourceName=haResourceName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectName=projectName, poolMetaWriteLatency=poolMetaWriteLatency, replicationAborted=replicationAborted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskIndex=diskIndex, lunReadLatency=lunReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, diskAvgReadLatency=diskAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDegraded=poolDegraded, notificationComponentName=notificationComponentName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, snapshotCloningFailed=snapshotCloningFailed, controllerDown=controllerDown, poolCount=poolCount, memoryFailure=memoryFailure, tdpsUpgradeFailed=tdpsUpgradeFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicReceiveMbps=nicReceiveMbps, cacheTotalReadIops=cacheTotalReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationSensorNumber=notificationSensorNumber, poolCreated=poolCreated, poolUsedSizeHigh=poolUsedSizeHigh, diskIsOnline=diskIsOnline, diskSizeLow=diskSizeLow, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, aclMigrationCompleted=aclMigrationCompleted, cacheTotalWriteIops=cacheTotalWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationTargetEntityName=notificationTargetEntityName, diagnosticDataUploaded=diagnosticDataUploaded, diskGoneOffline=diskGoneOffline, snmpServiceStopped=snmpServiceStopped, ipmiFan=ipmiFan, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareQuotaLow=shareQuotaLow, shareDeletionFailed=shareDeletionFailed, diskIOCount=diskIOCount, iscsiTargetName=iscsiTargetName, poolAvgWriteLatency=poolAvgWriteLatency, upgradeCompleted=upgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted)
