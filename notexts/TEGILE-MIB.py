...
# Produced by pysmi-1.1.10 at Fri Nov 10 13:28:40 2023
...
Gauge32, Counter64, Counter32, Bits, ModuleIdentity, TimeTicks, NotificationType, Integer32, enterprises, iso, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Counter32", "Bits", "ModuleIdentity", "TimeTicks", "NotificationType", "Integer32", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunReservedSizeLow=lunReservedSizeLow, replicationPaused=replicationPaused, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, spareDiskReplaced=spareDiskReplaced, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetIndex=fcTargetIndex, poolTotalSaving=poolTotalSaving, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorsTable=iscsiInitiatorsTable, sharePoolName=sharePoolName, notificationSensorSuspect=notificationSensorSuspect, notificationSensorNumber=notificationSensorNumber, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haControllerB_IPAddr=haControllerB_IPAddr, targetGroupCreateCompleted=targetGroupCreateCompleted, poolUsedSizeHigh=poolUsedSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, poolHealth=poolHealth, smisServiceStarted=smisServiceStarted, testNotification=testNotification, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetIndex=iscsiTargetIndex, snapshotDeleteFailed=snapshotDeleteFailed, smbSocketFailure=smbSocketFailure, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, shareExceedThresholdWarning=shareExceedThresholdWarning, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectTable=projectTable, fcInitiatorEntry=fcInitiatorEntry, poolImported=poolImported, controllerUp=controllerUp, poolSizeLow=poolSizeLow, iscsiInitiators=iscsiInitiators, poolMetaReadIops=poolMetaReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, pools=pools, shareCIFSWriteIops=shareCIFSWriteIops, notificationReadingUnit=notificationReadingUnit, notifications=notifications, projectModified=projectModified, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationSeverity=notificationSeverity, nvdimmFailSoftError=nvdimmFailSoftError, projectDataSizeLow=projectDataSizeLow, projectDataSizeHigh=projectDataSizeHigh, nicTransmitMbps=nicTransmitMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, maintenanceModeEnabled=maintenanceModeEnabled, lunIndex=lunIndex, aclMigrationStarted=aclMigrationStarted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcPortOnline=fcPortOnline, iscsiTargetReadLatency=iscsiTargetReadLatency, haResourceGroup=haResourceGroup, diskEntry=diskEntry, alertsCleanupCompleted=alertsCleanupCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectCompressionEnabled=projectCompressionEnabled, controllerDown=controllerDown, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTargetName=fcTargetName, shareQuotaFinished=shareQuotaFinished, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicReceiveMbps=nicReceiveMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCompressedRatio=shareCompressedRatio, tegile=tegile, diskDataWriteIops=diskDataWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetsTable=fcTargetsTable, unknownSensorEvent=unknownSensorEvent, lunGUID=lunGUID, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareDeleted=shareDeleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareReservedSizeHigh=shareReservedSizeHigh, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetEntry=iscsiTargetEntry, nicIndex=nicIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataReadIops=poolDataReadIops, shareCIFSReadMbps=shareCIFSReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolDegraded=poolDegraded, fcTargetStatus=fcTargetStatus, currentNotificationGroup=currentNotificationGroup, snmpServiceStopped=snmpServiceStopped, fcInitiators=fcInitiators, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataReadLatency=poolDataReadLatency, ipmiPowerSupply=ipmiPowerSupply, tdpsUpgradeFailed=tdpsUpgradeFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSWriteIops=shareNFSWriteIops, nicMTU=nicMTU, replicationStarted=replicationStarted, iscsiTargets=iscsiTargets, lunFreeSizeLow=lunFreeSizeLow, notificationProps=notificationProps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunPoolName=lunPoolName, currentObjectGroup=currentObjectGroup, diskIsOnline=diskIsOnline, haResourceEntry=haResourceEntry, nicTable=nicTable, smisServiceStopped=smisServiceStopped, iscsiTotalReadMbps=iscsiTotalReadMbps, lunTargetGroup=lunTargetGroup, poolMetaReadLatency=poolMetaReadLatency, lunCompressedRatio=lunCompressedRatio, shareCompressionEnabled=shareCompressionEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, ipmiThreshold=ipmiThreshold, haControllerA_Name=haControllerA_Name, lunSizeHigh=lunSizeHigh, poolName=poolName, nfsTotalReadIops=nfsTotalReadIops, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, haResourceDescription=haResourceDescription, lunTable=lunTable, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolProjectCount=poolProjectCount, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tegileArray_notifications=tegileArray_notifications, notificationReadingTriggerValue=notificationReadingTriggerValue, upgradeDownloadCompleted=upgradeDownloadCompleted, projectName=projectName, upgradeDownloadFailed=upgradeDownloadFailed, poolDataSizeLow=poolDataSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDataSizeHigh=poolDataSizeHigh, fcProperties=fcProperties, projectQuotaSizeLow=projectQuotaSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, notificationEventCode=notificationEventCode, poolReadCacheWriteIops=poolReadCacheWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTotalWriteMbps=fcTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, deleteFolderFailed=deleteFolderFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTargetWriteIops=fcTargetWriteIops, network=network, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, diagnosticDataUploaded=diagnosticDataUploaded, haControllerB_Uptime=haControllerB_Uptime, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolEntry=poolEntry, lunCompressionEnabled=lunCompressionEnabled, diskTotalReadIops=diskTotalReadIops, tegileConformance=tegileConformance, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolState=poolState, PYSNMP_MODULE_ID=tegile, shareNFSReadIops=shareNFSReadIops, poolUsedSizeLow=poolUsedSizeLow, diskPoolName=diskPoolName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiFan=ipmiFan, lunProjectName=lunProjectName, fcInitiatorGroup=fcInitiatorGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, poolAvgReadLatency=poolAvgReadLatency, shareDedupEnabled=shareDedupEnabled, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, controllerHardwareModel=controllerHardwareModel, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, properties=properties, webdocsUpgradeFailed=webdocsUpgradeFailed, diskSequentialIOCount=diskSequentialIOCount, shareQuotaLow=shareQuotaLow, iscsiInitiatorEntry=iscsiInitiatorEntry, cifsTotalWriteIops=cifsTotalWriteIops, diskTotalReadMbps=diskTotalReadMbps, lunInitiatorGroup=lunInitiatorGroup, tegileArray=tegileArray, projectLunCount=projectLunCount, diskType=diskType, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskDataReadMbps=diskDataReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargets=fcTargets, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, globalStatistics=globalStatistics, haControllerA_Uptime=haControllerA_Uptime, shareQuotaHigh=shareQuotaHigh, lunWriteIops=lunWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, snmpAgentVersion=snmpAgentVersion, iscsiTargetsTable=iscsiTargetsTable, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeQuotaFinished=volumeQuotaFinished, snapshotRollbackFailed=snapshotRollbackFailed, diskTotalWriteMbps=diskTotalWriteMbps, diskRandomIOCount=diskRandomIOCount, nicGroup=nicGroup, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunDedupEnabled=lunDedupEnabled, iscsiTargetError=iscsiTargetError, poolDataWriteMbps=poolDataWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps, diskDataReadIops=diskDataReadIops, projectShareCount=projectShareCount, lunReadMbps=lunReadMbps, lunReservedSizeHigh=lunReservedSizeHigh, shareNFSReadLatency=shareNFSReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareSnapshotSizeHigh=shareSnapshotSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiMemory=ipmiMemory, targetGroupMemberRemoved=targetGroupMemberRemoved, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeDeleteFailed=volumeDeleteFailed, poolAvgWriteLatency=poolAvgWriteLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, shareCIFSReadIops=shareCIFSReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, shareReservedSizeLow=shareReservedSizeLow, poolUpgraded=poolUpgraded, shareDataSizeLow=shareDataSizeLow, fcTotalWriteIops=fcTotalWriteIops, ipmiOther=ipmiOther, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, adServerTimeDrift=adServerTimeDrift, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkInterfaceUp=networkInterfaceUp)
mibBuilder.exportSymbols("TEGILE-MIB", nicName=nicName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDataSizeHigh=shareDataSizeHigh, haResourceStatus=haResourceStatus, poolReadCacheReadLatency=poolReadCacheReadLatency, haControllerB_Name=haControllerB_Name, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cpuTotalUsage=cpuTotalUsage, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsTotalReadIops=cifsTotalReadIops, lunWriteLatency=lunWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, lunEntry=lunEntry, notificationTargetEntityName=notificationTargetEntityName, replicationAbandoned=replicationAbandoned, haControllerA_IPAddr=haControllerA_IPAddr, poolExported=poolExported, poolFreeSizeHigh=poolFreeSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTotalWriteIops=poolTotalWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, poolDataWriteIops=poolDataWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetReadMbps=iscsiTargetReadMbps, projectQuotaFinished=projectQuotaFinished, iscsiTotalReadIops=iscsiTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, haResources=haResources, lunName=lunName, fcTotalReadIops=fcTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, lunReadLatency=lunReadLatency, shareMountPoint=shareMountPoint, replicationTargetDeleted=replicationTargetDeleted, diskTable=diskTable, upgradeStarted=upgradeStarted, upgradeCompleted=upgradeCompleted, sanProperties=sanProperties, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolTotalReadIops=poolTotalReadIops, projectTotalSaving=projectTotalSaving, diskState=diskState, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, targetGroupMemberAdded=targetGroupMemberAdded, networkIpmpGroupUp=networkIpmpGroupUp, networkInterfaceDown=networkInterfaceDown, lunReadIops=lunReadIops, snmpServiceStarted=snmpServiceStarted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectDeletionFailed=projectDeletionFailed, fcTargetEntry=fcTargetEntry, diskTotalWriteIops=diskTotalWriteIops, poolTable=poolTable, snapshotCloningFailed=snapshotCloningFailed, cacheRAMReads=cacheRAMReads, fcTargetReadIops=fcTargetReadIops, poolMetaReadMbps=poolMetaReadMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectSnapshotSizeLow=projectSnapshotSizeLow, projectIndex=projectIndex, poolSizeHigh=poolSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationAborted=replicationAborted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolCreated=poolCreated, cpuSystemCalls=cpuSystemCalls, lunProtocol=lunProtocol, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskGoneOffline=diskGoneOffline, fcTargetGroup=fcTargetGroup, cpuInterrupts=cpuInterrupts, poolOwnerController=poolOwnerController, diskCount=diskCount, fcInitiatorsTable=fcInitiatorsTable, fcPortOffline=fcPortOffline, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskChassisIdx=diskChassisIdx, fcTotalReadMbps=fcTotalReadMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetReadLatency=fcTargetReadLatency, smisServiceStopFailed=smisServiceStopFailed, memoryFailure=memoryFailure, upgradeDownloadStarted=upgradeDownloadStarted, cifsAvgReadLatency=cifsAvgReadLatency, projectShares=projectShares, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectEntry=projectEntry, iscsiProperties=iscsiProperties, vmwareNFSDatastores=vmwareNFSDatastores, poolReadCacheReadIops=poolReadCacheReadIops, haResourceName=haResourceName, notificationObjects=notificationObjects, cacheTotalReadIops=cacheTotalReadIops, haResourcesTable=haResourcesTable, lunDataSizeHigh=lunDataSizeHigh, shareProjectName=shareProjectName, haResourceActiveNode=haResourceActiveNode, replicationComplete=replicationComplete, diskSizeLow=diskSizeLow, upgradeTimeout=upgradeTimeout, cacheTotalReadMbps=cacheTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, shareEntry=shareEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, sensorFailureEvent=sensorFailureEvent, replicationFailed=replicationFailed, notificationTime=notificationTime, diskAvgReadLatency=diskAvgReadLatency, fcInitiatorIndex=fcInitiatorIndex, upgradeFailed=upgradeFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetGroupError=iscsiTargetGroupError, poolFreeSizeLow=poolFreeSizeLow, shareNFSReadMbps=shareNFSReadMbps, lunSizeLow=lunSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, snapshotCreationFailed=snapshotCreationFailed, poolMetaWriteIops=poolMetaWriteIops, shareTable=shareTable, iscsiWriteIops=iscsiWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, controllerTimeDrift=controllerTimeDrift, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetAlias=iscsiTargetAlias, disks=disks, lunDataSizeLow=lunDataSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haResourceIndex=haResourceIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolProjects=poolProjects, userLoginFailed=userLoginFailed, projectLUNs=projectLUNs, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetAuth=iscsiTargetAuth, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tegileGroups=tegileGroups, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTargetName=iscsiTargetName, replicationResumed=replicationResumed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolDeleted=poolDeleted, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorName=fcInitiatorName, diskAlias=diskAlias, diskIOCount=diskIOCount, notificationDescription=notificationDescription, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolTotalReadMbps=poolTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, basicCompliance=basicCompliance, poolDeletionFailed=poolDeletionFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskError=diskError, diskSlowIo=diskSlowIo, diskIndex=diskIndex, netbiosSocketFailure=netbiosSocketFailure, shareIndex=shareIndex, ipmiVoltage=ipmiVoltage, shareName=shareName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareNFSEnabled=shareNFSEnabled, projectDeleted=projectDeleted, ipmiCurrent=ipmiCurrent, tegileCompliances=tegileCompliances, poolExpanded=poolExpanded, networkTotalReceiveMbps=networkTotalReceiveMbps, cacheSSDReads=cacheSSDReads, lunBlockSize=lunBlockSize, notificationComponentName=notificationComponentName, poolDataReadMbps=poolDataReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, poolCount=poolCount, projectPoolName=projectPoolName, lunSnapshotSizeLow=lunSnapshotSizeLow, deleteFolderCompleted=deleteFolderCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunWriteMbps=lunWriteMbps, nicEntry=nicEntry, poolIndex=poolIndex, nicState=nicState, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetGroup=iscsiTargetGroup, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorName=iscsiInitiatorName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, projectDedupEnabled=projectDedupEnabled, notificationSensorAction=notificationSensorAction)
