...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:44:04 2021
...
Bits, Unsigned32, Counter64, IpAddress, NotificationType, Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, diskSlowIo=diskSlowIo, lunIndex=lunIndex, poolSizeLow=poolSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, fcInitiatorIndex=fcInitiatorIndex, networkIpmpGroupDown=networkIpmpGroupDown, shareMountPoint=shareMountPoint, projectTable=projectTable, nicReceiveMbps=nicReceiveMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, memoryFailure=memoryFailure, lunTable=lunTable, shareReservedSizeHigh=shareReservedSizeHigh, poolUpgraded=poolUpgraded, networkIpmpGroupUp=networkIpmpGroupUp, ipmiMemory=ipmiMemory, projectFreeSizeLow=projectFreeSizeLow, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, poolTable=poolTable, upgradeDownloadStarted=upgradeDownloadStarted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haResourceDescription=haResourceDescription, lunProjectName=lunProjectName, replicationFailed=replicationFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsTotalWriteMbps=cifsTotalWriteMbps, lunWriteIops=lunWriteIops, poolDataSizeLow=poolDataSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskChassisIdx=diskChassisIdx, lunBlockSize=lunBlockSize, lunInitiatorGroup=lunInitiatorGroup, nicEntry=nicEntry, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalWriteIops=poolTotalWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorName=fcInitiatorName, replicationTargetDeleted=replicationTargetDeleted, poolEntry=poolEntry, haResourceName=haResourceName, sanProperties=sanProperties, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolName=poolName, nfsTotalWriteMbps=nfsTotalWriteMbps, shareNFSReadLatency=shareNFSReadLatency, sensorFailureEvent=sensorFailureEvent, shareCIFSReadIops=shareCIFSReadIops, diskEntry=diskEntry, poolCount=poolCount, poolProjects=poolProjects, cpuTotalUsage=cpuTotalUsage, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationPaused=replicationPaused, haResourceStatus=haResourceStatus, poolIndex=poolIndex, nicTable=nicTable, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetIndex=fcTargetIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationTime=notificationTime, shareProjectName=shareProjectName, notificationTargetEntityName=notificationTargetEntityName, nicTransmitMbps=nicTransmitMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cacheRAMReads=cacheRAMReads, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectDataSizeHigh=projectDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, diskDataReadIops=diskDataReadIops, diskTable=diskTable, notificationProps=notificationProps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareDeletionFailed=shareDeletionFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetsTable=iscsiTargetsTable, fcTargetsTable=fcTargetsTable, diskGoneOffline=diskGoneOffline, poolExported=poolExported, userLoginFailed=userLoginFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, lunGUID=lunGUID, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetWriteMbps=fcTargetWriteMbps, properties=properties, shareDataSizeLow=shareDataSizeLow, shareNFSReadIops=shareNFSReadIops, lunWriteLatency=lunWriteLatency, replicationResumed=replicationResumed, projectSnapshotSizeLow=projectSnapshotSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, lunReadLatency=lunReadLatency, projectTotalSaving=projectTotalSaving, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTotalWriteIops=fcTotalWriteIops, PYSNMP_MODULE_ID=tegile, diskIsOnline=diskIsOnline, nicState=nicState, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunFreeSizeHigh=lunFreeSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, ipmiCurrent=ipmiCurrent, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationSensorAction=notificationSensorAction, currentNotificationGroup=currentNotificationGroup, cacheTotalReadMbps=cacheTotalReadMbps, diskSequentialIOCount=diskSequentialIOCount, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcInitiators=fcInitiators, cacheTotalReadIops=cacheTotalReadIops, haResourcesTable=haResourcesTable, projectCompressionEnabled=projectCompressionEnabled, smisServiceStopFailed=smisServiceStopFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTotalReadIops=iscsiTotalReadIops, shareQuotaLow=shareQuotaLow, netbiosSocketFailure=netbiosSocketFailure, shareCIFSReadMbps=shareCIFSReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, poolTotalReadMbps=poolTotalReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolUsedSizeLow=poolUsedSizeLow, deleteFolderFailed=deleteFolderFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolFreeSizeLow=poolFreeSizeLow, projectDataSizeLow=projectDataSizeLow, ipmiFan=ipmiFan, lunPoolName=lunPoolName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolDataReadMbps=poolDataReadMbps, lunProtocol=lunProtocol, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetError=iscsiTargetError, lunDedupEnabled=lunDedupEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetGroup=fcTargetGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDataReadIops=poolDataReadIops, projectQuotaSizeHigh=projectQuotaSizeHigh, cifsTotalReadIops=cifsTotalReadIops, cpuInterrupts=cpuInterrupts, lunEntry=lunEntry, lunSizeHigh=lunSizeHigh, iscsiTargetAlias=iscsiTargetAlias, shareNFSReadMbps=shareNFSReadMbps, nicIndex=nicIndex, projectLUNs=projectLUNs, haResources=haResources, fcTargetReadMbps=fcTargetReadMbps, lunCompressedRatio=lunCompressedRatio, ipmiOther=ipmiOther, upgradeCompleted=upgradeCompleted, nvdimmFailSoftError=nvdimmFailSoftError, cifsTotalReadMbps=cifsTotalReadMbps, projectQuotaFinished=projectQuotaFinished, fcTargetReadIops=fcTargetReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, ipmiThreshold=ipmiThreshold, fcTotalReadMbps=fcTotalReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskError=diskError, cpuSystemCalls=cpuSystemCalls, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiInitiators=iscsiInitiators, poolTotalReadIops=poolTotalReadIops, lunReservedSizeHigh=lunReservedSizeHigh, notificationDescription=notificationDescription, lunSizeLow=lunSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, aclMigrationStarted=aclMigrationStarted, haResourceGroup=haResourceGroup, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectShares=projectShares, notificationReadingUnit=notificationReadingUnit, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, poolDataWriteLatency=poolDataWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectThresholdExceedWarning=projectThresholdExceedWarning, ntpServerTimeDrift=ntpServerTimeDrift, diskPoolName=diskPoolName, projectLunCount=projectLunCount, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolImported=poolImported, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorEntry=fcInitiatorEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceActiveNode=haResourceActiveNode, fcInitiatorCreateFailed=fcInitiatorCreateFailed, smisServiceStarted=smisServiceStarted, poolDataReadLatency=poolDataReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorChapUser=iscsiInitiatorChapUser, replicationStarted=replicationStarted, diskRandomIOCount=diskRandomIOCount, iscsiTargetWriteIops=iscsiTargetWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolMetaReadLatency=poolMetaReadLatency, snmpServiceStopped=snmpServiceStopped, targetGroupMemberRemoved=targetGroupMemberRemoved, notificationEventCode=notificationEventCode, volumeModifyCompleted=volumeModifyCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, spareDiskReplaced=spareDiskReplaced, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetStatus=fcTargetStatus, shareIndex=shareIndex, shareDeleted=shareDeleted, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetGroup=iscsiTargetGroup, replicationAbandoned=replicationAbandoned, haControllerB_IPAddr=haControllerB_IPAddr, poolFreeSizeHigh=poolFreeSizeHigh, projectDedupEnabled=projectDedupEnabled, diskTotalReadMbps=diskTotalReadMbps, poolCreated=poolCreated, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectFreeSizeHigh=projectFreeSizeHigh, shareDataSizeHigh=shareDataSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiWriteIops=iscsiWriteIops, sharePoolName=sharePoolName, poolDataWriteIops=poolDataWriteIops, diskDataWriteIops=diskDataWriteIops, networkInterfaceDown=networkInterfaceDown, diskTotalReadIops=diskTotalReadIops, tegileConformance=tegileConformance, haResourceIndex=haResourceIndex, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", diskIndex=diskIndex, adServerTimeDrift=adServerTimeDrift, currentObjectGroup=currentObjectGroup, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeStarted=upgradeStarted, lunTargetGroup=lunTargetGroup, diskTotalWriteMbps=diskTotalWriteMbps, projectIndex=projectIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, deleteFolderCompleted=deleteFolderCompleted, diskIOCount=diskIOCount, lunDataSizeHigh=lunDataSizeHigh, nfsTotalReadIops=nfsTotalReadIops, projectEntry=projectEntry, iscsiInitiatorName=iscsiInitiatorName, projectShareCount=projectShareCount, shareSnapshotSizeLow=shareSnapshotSizeLow, poolOwnerController=poolOwnerController, shareCIFSWriteIops=shareCIFSWriteIops, controllerUp=controllerUp, shareNFSWriteIops=shareNFSWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargets=iscsiTargets, diskSizeHigh=diskSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, haControllerB_Name=haControllerB_Name, fcProperties=fcProperties, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haControllerB_Uptime=haControllerB_Uptime, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, pools=pools, controllerTimeDrift=controllerTimeDrift, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheReadIops=poolReadCacheReadIops, aclMigrationCompleted=aclMigrationCompleted, controllerHardwareModel=controllerHardwareModel, fcTargetName=fcTargetName, haResourceEntry=haResourceEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, projectDeletionFailed=projectDeletionFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cacheSSDReads=cacheSSDReads, tegileGroups=tegileGroups, poolDeleted=poolDeleted, targetGroupCreateCompleted=targetGroupCreateCompleted, poolHealth=poolHealth, fcTargetEntry=fcTargetEntry, projectDeleted=projectDeleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, globalStatistics=globalStatistics, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicName=nicName, tegileArray_notifications=tegileArray_notifications, lunReservedSizeLow=lunReservedSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, projectName=projectName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, controllerDown=controllerDown, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nfsTotalWriteIops=nfsTotalWriteIops, fcPortOffline=fcPortOffline, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalSaving=poolTotalSaving, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolDataWriteMbps=poolDataWriteMbps, diskCount=diskCount, disks=disks, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcAvgReadLatency=fcAvgReadLatency, diskState=diskState, tegileCompliances=tegileCompliances, lunReadMbps=lunReadMbps, snapshotCloningFailed=snapshotCloningFailed, poolMetaWriteIops=poolMetaWriteIops, fcInitiatorGroup=fcInitiatorGroup, snapshotCloneCompleted=snapshotCloneCompleted, upgradeTimeout=upgradeTimeout, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, tegileArray=tegileArray, shareNFSEnabled=shareNFSEnabled, snapshotRollbackFailed=snapshotRollbackFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationComplete=replicationComplete, diskSizeLow=diskSizeLow, diskAvgReadLatency=diskAvgReadLatency, shareEntry=shareEntry, testNotification=testNotification, fcTargetReadLatency=fcTargetReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nfsTotalReadMbps=nfsTotalReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snmpAgentVersion=snmpAgentVersion, lunReadIops=lunReadIops, volumeDeleteFailed=volumeDeleteFailed, fcTargets=fcTargets, smisServiceStartFailed=smisServiceStartFailed, ipmiPowerSupply=ipmiPowerSupply, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetWriteIops=fcTargetWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskDataReadMbps=diskDataReadMbps, fcPortOnline=fcPortOnline, poolMetaReadMbps=poolMetaReadMbps, poolDeletionFailed=poolDeletionFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskTotalWriteIops=diskTotalWriteIops, lunWriteMbps=lunWriteMbps, shareQuotaHigh=shareQuotaHigh, volumeQuotaFinished=volumeQuotaFinished, poolMetaReadIops=poolMetaReadIops, projectPoolName=projectPoolName, shareCIFSReadLatency=shareCIFSReadLatency, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectModified=projectModified, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDegraded=poolDegraded, upgradeFailed=upgradeFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationSourceRegistered=replicationSourceRegistered, nfsAvgReadLatency=nfsAvgReadLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareQuotaFinished=shareQuotaFinished, lunName=lunName, ipmiTemperature=ipmiTemperature, cifsAvgReadLatency=cifsAvgReadLatency, poolExpanded=poolExpanded, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, shareCompressedRatio=shareCompressedRatio, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, notifications=notifications, iscsiTargetIndex=iscsiTargetIndex, networkTotalTransmitMbps=networkTotalTransmitMbps, tegile=tegile, lunDataSizeLow=lunDataSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, poolState=poolState, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareTable=shareTable, poolSizeHigh=poolSizeHigh, iscsiAvgReadLatency=iscsiAvgReadLatency, shareName=shareName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetGroupError=iscsiTargetGroupError, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTotalReadIops=fcTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcInitiatorsTable=fcInitiatorsTable, ipmiVoltage=ipmiVoltage, notificationSeverity=notificationSeverity, snmpServiceStartFailed=snmpServiceStartFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, nicMTU=nicMTU, poolAvgWriteLatency=poolAvgWriteLatency, diskType=diskType, notificationObjects=notificationObjects, poolDataSizeHigh=poolDataSizeHigh, smisServiceStopped=smisServiceStopped, fcTargetWriteLatency=fcTargetWriteLatency, haControllerA_Name=haControllerA_Name, poolAvgReadLatency=poolAvgReadLatency, poolProjectCount=poolProjectCount, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareCompressionEnabled=shareCompressionEnabled, replicationAborted=replicationAborted, diskAlias=diskAlias, iscsiProperties=iscsiProperties, poolMetaWriteLatency=poolMetaWriteLatency, networkInterfaceUp=networkInterfaceUp, notificationSensorNumber=notificationSensorNumber, poolQuotaFinished=poolQuotaFinished, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, network=network, shareReservedSizeLow=shareReservedSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareCIFSEnabled=shareCIFSEnabled, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerA_IPAddr=haControllerA_IPAddr, nicGroup=nicGroup, notificationComponentName=notificationComponentName, poolTotalWriteMbps=poolTotalWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, poolReadCacheWriteIops=poolReadCacheWriteIops, basicCompliance=basicCompliance, shareNFSWriteMbps=shareNFSWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow)
