...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:40:10 2023
...
iso, MibIdentifier, Integer32, TimeTicks, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Bits, NotificationType, Gauge32, enterprises, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Integer32", "TimeTicks", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Bits", "NotificationType", "Gauge32", "enterprises", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunGUID=lunGUID, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTotalReadMbps=fcTotalReadMbps, lunSizeLow=lunSizeLow, diskDataReadMbps=diskDataReadMbps, notificationSensorSuspect=notificationSensorSuspect, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, volumeDeleteCompleted=volumeDeleteCompleted, poolUsedSizeHigh=poolUsedSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ipmiFan=ipmiFan, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorEntry=iscsiInitiatorEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectQuotaSizeHigh=projectQuotaSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, adServerTimeDrift=adServerTimeDrift, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareDataSizeHigh=shareDataSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetIndex=iscsiTargetIndex, notificationReadingUnit=notificationReadingUnit, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, aclMigrationStarted=aclMigrationStarted, controllerUp=controllerUp, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nicReceiveMbps=nicReceiveMbps, ipmiMemory=ipmiMemory, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, currentNotificationGroup=currentNotificationGroup, shareQuotaFinished=shareQuotaFinished, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSEnabled=shareNFSEnabled, lunCompressedRatio=lunCompressedRatio, ntpServerTimeDrift=ntpServerTimeDrift, diskError=diskError, notificationProps=notificationProps, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectModified=projectModified, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunEntry=lunEntry, fcPortOffline=fcPortOffline, controllerHardwareModel=controllerHardwareModel, diskType=diskType, poolTotalWriteIops=poolTotalWriteIops, poolDataSizeHigh=poolDataSizeHigh, poolAvgReadLatency=poolAvgReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, shareQuotaLow=shareQuotaLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDeleted=poolDeleted, upgradeCompleted=upgradeCompleted, projectDataSizeHigh=projectDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, diskPoolName=diskPoolName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiOther=ipmiOther, replicationAbandoned=replicationAbandoned, sharePoolName=sharePoolName, nvdimmFailUnknownError=nvdimmFailUnknownError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cpuInterrupts=cpuInterrupts, ipmiTemperature=ipmiTemperature, shareNFSWriteMbps=shareNFSWriteMbps, cpuTotalUsage=cpuTotalUsage, poolSizeLow=poolSizeLow, lunInitiatorGroup=lunInitiatorGroup, properties=properties, fcInitiatorName=fcInitiatorName, shareNFSWriteLatency=shareNFSWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, nicTransmitMbps=nicTransmitMbps, poolDataReadLatency=poolDataReadLatency, replicationPaused=replicationPaused, diskAlias=diskAlias, cacheSSDReads=cacheSSDReads, poolReadCacheReadLatency=poolReadCacheReadLatency, haControllerB_Uptime=haControllerB_Uptime, notificationTime=notificationTime, poolMetaReadMbps=poolMetaReadMbps, controllerTimeDrift=controllerTimeDrift, poolImported=poolImported, poolReadCacheWriteLatency=poolReadCacheWriteLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tegileGroups=tegileGroups, snapshotRollbackFailed=snapshotRollbackFailed, poolUsedSizeLow=poolUsedSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, smisServiceStartFailed=smisServiceStartFailed, haResourceGroup=haResourceGroup, smisServiceStopped=smisServiceStopped, diagnosticDataUploaded=diagnosticDataUploaded, shareCIFSWriteLatency=shareCIFSWriteLatency, lunReadIops=lunReadIops, diskState=diskState, intelliFlashSoftwareDown=intelliFlashSoftwareDown, aclMigrationCompleted=aclMigrationCompleted, nfsTotalWriteIops=nfsTotalWriteIops, diskAvgReadLatency=diskAvgReadLatency, iscsiWriteIops=iscsiWriteIops, lunReservedSizeLow=lunReservedSizeLow, lunWriteLatency=lunWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, shareDeletionFailed=shareDeletionFailed, shareCompressionEnabled=shareCompressionEnabled, projectDeletionFailed=projectDeletionFailed, poolSizeHigh=poolSizeHigh, haControllerA_Name=haControllerA_Name, networkIpmpGroupUp=networkIpmpGroupUp, poolDataWriteMbps=poolDataWriteMbps, snapshotCreationFailed=snapshotCreationFailed, projectDeleted=projectDeleted, iscsiInitiatorsTable=iscsiInitiatorsTable, shareNFSWriteIops=shareNFSWriteIops, diskDataReadIops=diskDataReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, sensorFailureEvent=sensorFailureEvent, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, notificationDescription=notificationDescription, deleteFolderFailed=deleteFolderFailed, lunCompressionEnabled=lunCompressionEnabled, projectFreeSizeHigh=projectFreeSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceIndex=haResourceIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiProperties=iscsiProperties, globalStatistics=globalStatistics, poolOwnerController=poolOwnerController, projectQuotaSizeLow=projectQuotaSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, tegileCompliances=tegileCompliances, poolDataSizeLow=poolDataSizeLow, tegileConformance=tegileConformance, testNotification=testNotification, fcProperties=fcProperties, notificationComponentName=notificationComponentName, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, webdocsUpgradeFailed=webdocsUpgradeFailed, nicName=nicName, iscsiTargetGroup=iscsiTargetGroup, shareCompressedRatio=shareCompressedRatio, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskSlowIo=diskSlowIo, currentObjectGroup=currentObjectGroup, poolTotalReadIops=poolTotalReadIops, snmpServiceStartFailed=snmpServiceStartFailed, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskSizeLow=diskSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskIndex=diskIndex, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, nvdimmFailInitializationError=nvdimmFailInitializationError, cpuSystemCalls=cpuSystemCalls, snmpAgentVersion=snmpAgentVersion, projectShareCount=projectShareCount, ipmiPowerSupply=ipmiPowerSupply, lunDedupEnabled=lunDedupEnabled, volumeDeleteFailed=volumeDeleteFailed, lunPoolName=lunPoolName, replicationAborted=replicationAborted, projectIndex=projectIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, lunWriteMbps=lunWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haResourceStatus=haResourceStatus, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationStarted=replicationStarted, lunProtocol=lunProtocol, fcTargetGroup=fcTargetGroup, basicCompliance=basicCompliance, iscsiInitiatorGroup=iscsiInitiatorGroup, alertsCleanupCompleted=alertsCleanupCompleted, projectFreeSizeLow=projectFreeSizeLow, snmpServiceStarted=snmpServiceStarted, diskSequentialIOCount=diskSequentialIOCount, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectLUNs=projectLUNs, shareEntry=shareEntry, fcTargetStatus=fcTargetStatus, fcInitiatorsTable=fcInitiatorsTable, projectEntry=projectEntry, shareCreatedSuccessfully=shareCreatedSuccessfully, diskDataWriteIops=diskDataWriteIops, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, fcInitiatorIndex=fcInitiatorIndex, projectDedupEnabled=projectDedupEnabled, poolCreated=poolCreated, nicMTU=nicMTU, iscsiInitiators=iscsiInitiators, projectShares=projectShares, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolQuotaFinished=poolQuotaFinished, lunReadLatency=lunReadLatency, poolUpgraded=poolUpgraded, networkTotalReceiveMbps=networkTotalReceiveMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, nicState=nicState, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, netbiosSocketFailure=netbiosSocketFailure, controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, projectDataSizeLow=projectDataSizeLow, haResourcesTable=haResourcesTable, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, poolMetaWriteIops=poolMetaWriteIops, fcTotalWriteIops=fcTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTotalReadIops=fcTotalReadIops, upgradeFailed=upgradeFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, disks=disks, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunDataSizeLow=lunDataSizeLow, smbSocketFailure=smbSocketFailure, poolMetaReadLatency=poolMetaReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, shareName=shareName, replicationComplete=replicationComplete, nfsAvgReadLatency=nfsAvgReadLatency, poolDataReadMbps=poolDataReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetError=iscsiTargetError, poolHealth=poolHealth, fcTargetWriteMbps=fcTargetWriteMbps, userLoginFailed=userLoginFailed, snmpServiceStopFailed=snmpServiceStopFailed, diskAvgWriteLatency=diskAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", poolExpanded=poolExpanded, poolFreeSizeLow=poolFreeSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, shareReservedSizeLow=shareReservedSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationSensorAction=notificationSensorAction, diskChassisIdx=diskChassisIdx, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, ipmiThreshold=ipmiThreshold, volumeQuotaFinished=volumeQuotaFinished, lunTargetGroup=lunTargetGroup, replicationTargetDeleted=replicationTargetDeleted, projectQuotaFinished=projectQuotaFinished, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, projectTotalSaving=projectTotalSaving, poolDataWriteLatency=poolDataWriteLatency, ipmiVoltage=ipmiVoltage, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTargetReadLatency=iscsiTargetReadLatency, lunSizeHigh=lunSizeHigh, fcTargetEntry=fcTargetEntry, haResourceDescription=haResourceDescription, fcTotalWriteMbps=fcTotalWriteMbps, diskGoneOffline=diskGoneOffline, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareReservedSizeHigh=shareReservedSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, haControllerB_Name=haControllerB_Name, upgradeTimeout=upgradeTimeout, shareQuotaHigh=shareQuotaHigh, tegileArray_notifications=tegileArray_notifications, poolTotalReadMbps=poolTotalReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareNFSReadMbps=shareNFSReadMbps, haResourceName=haResourceName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, diskIsOnline=diskIsOnline, iscsiInitiatorChapUser=iscsiInitiatorChapUser, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, PYSNMP_MODULE_ID=tegile, diskIOCount=diskIOCount, fcTargetReadIops=fcTargetReadIops, poolExported=poolExported, diskEntry=diskEntry, diskTotalReadIops=diskTotalReadIops, lunProjectName=lunProjectName, nicIndex=nicIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectName=projectName, projectCompressionEnabled=projectCompressionEnabled, tegileArray=tegileArray, poolCount=poolCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolName=poolName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, upgradeStarted=upgradeStarted, poolDataReadIops=poolDataReadIops, fcTargetReadLatency=fcTargetReadLatency, shareDeleted=shareDeleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunTable=lunTable, shareDedupEnabled=shareDedupEnabled, ipmiCurrent=ipmiCurrent, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, snmpServiceStopped=snmpServiceStopped, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkInterfaceDown=networkInterfaceDown, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationSourceRegistered=replicationSourceRegistered, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDataWriteIops=poolDataWriteIops, shareNFSReadIops=shareNFSReadIops, notificationEventCode=notificationEventCode, maintenanceModeEnabled=maintenanceModeEnabled, cacheTotalWriteMbps=cacheTotalWriteMbps, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargets=iscsiTargets, projectLunCount=projectLunCount, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectPoolName=projectPoolName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolTable=poolTable, haResources=haResources, shareCIFSReadMbps=shareCIFSReadMbps, replicationFailed=replicationFailed, fcPortOnline=fcPortOnline, shareProjectName=shareProjectName, lunFreeSizeHigh=lunFreeSizeHigh, tegile=tegile, notificationSensorNumber=notificationSensorNumber, sanProperties=sanProperties, lunDataSizeHigh=lunDataSizeHigh, poolProjects=poolProjects, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSEnabled=shareCIFSEnabled, fcTargetName=fcTargetName, iscsiTargetAuth=iscsiTargetAuth, fcInitiatorEntry=fcInitiatorEntry, diskSizeHigh=diskSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareIndex=shareIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, fcTargetReadMbps=fcTargetReadMbps, lunBlockSize=lunBlockSize, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolEntry=poolEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, maintenanceModeDisabled=maintenanceModeDisabled, poolReadCacheReadIops=poolReadCacheReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetWriteIops=fcTargetWriteIops, smisServiceStopFailed=smisServiceStopFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationSeverity=notificationSeverity, lunWriteIops=lunWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, snapshotCloneCompleted=snapshotCloneCompleted, poolTotalSaving=poolTotalSaving, poolAvgWriteLatency=poolAvgWriteLatency, fcAvgReadLatency=fcAvgReadLatency, fcTargetIndex=fcTargetIndex, haControllerA_Uptime=haControllerA_Uptime, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolIndex=poolIndex, nicEntry=nicEntry, memoryFailure=memoryFailure, iscsiInitiatorName=iscsiInitiatorName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, replicationResumed=replicationResumed, poolTotalWriteMbps=poolTotalWriteMbps, diskTable=diskTable, shareMountPoint=shareMountPoint, nfsTotalReadIops=nfsTotalReadIops, shareDataSizeLow=shareDataSizeLow, haResourceActiveNode=haResourceActiveNode, haResourceEntry=haResourceEntry, iscsiTargetName=iscsiTargetName, nfsTotalReadMbps=nfsTotalReadMbps, poolState=poolState, iscsiTargetAlias=iscsiTargetAlias, diskCount=diskCount, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskDataWriteMbps=diskDataWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, haControllerA_IPAddr=haControllerA_IPAddr, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDeletionFailed=poolDeletionFailed, fcTargetsTable=fcTargetsTable, lunReadMbps=lunReadMbps, volumeModifyCompleted=volumeModifyCompleted, notificationObjects=notificationObjects, cacheTotalReadIops=cacheTotalReadIops, upgradeDownloadStarted=upgradeDownloadStarted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolFreeSizeHigh=poolFreeSizeHigh, fcInitiators=fcInitiators, spareDiskReplaced=spareDiskReplaced, lunName=lunName, iscsiTotalReadIops=iscsiTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectTable=projectTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haControllerB_IPAddr=haControllerB_IPAddr, network=network, fcTargets=fcTargets, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareNFSReadLatency=shareNFSReadLatency, poolDegraded=poolDegraded, diskTotalWriteMbps=diskTotalWriteMbps, pools=pools, iscsiTargetReadIops=iscsiTargetReadIops, notifications=notifications, lunFreeSizeLow=lunFreeSizeLow, nicTable=nicTable, iscsiAvgReadLatency=iscsiAvgReadLatency, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunIndex=lunIndex, notificationTargetEntityName=notificationTargetEntityName, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetWriteLatency=fcTargetWriteLatency, poolProjectCount=poolProjectCount, shareTable=shareTable, nicGroup=nicGroup, diskRandomIOCount=diskRandomIOCount, upgradeDownloadCompleted=upgradeDownloadCompleted)
