...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConn=dlswTConn, dlswInterface=dlswInterface, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, DlswTCPAddress=DlswTCPAddress, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitStat=dlswCircuitStat, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacTable=dlswDirMacTable, dlswGroups=dlswGroups, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswNodeVersionString=dlswNodeVersionString, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirCache=dlswDirCache, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitS2Mac=dlswCircuitS2Mac, EndStationLocation=EndStationLocation, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeGroup=dlswNodeGroup, dlswDirCompliance=dlswDirCompliance, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapTConnUp=dlswTrapTConnUp, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfTable=dlswIfTable, dlswDirNBLocationType=dlswDirNBLocationType, LFSize=LFSize, dlswIfEntry=dlswIfEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlsw=dlsw, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVendorID=dlswNodeVendorID, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswIfSapList=dlswIfSapList, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswMIB=dlswMIB, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswSdlc=dlswSdlc, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTrapTConnDown=dlswTrapTConnDown, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNodeNBGroup=dlswNodeNBGroup, dlswTraps=dlswTraps, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapControl=dlswTrapControl, dlswCircuit=dlswCircuit, dlswDomains=dlswDomains, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeVersion=dlswNodeVersion, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitTable=dlswCircuitTable, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirectory=dlswDirectory, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitEntry=dlswCircuitEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirStat=dlswDirStat, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTCPDomain=dlswTCPDomain, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnStat=dlswTConnStat, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, NBName=NBName, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocateCompliance=dlswDirLocateCompliance, MacAddressNC=MacAddressNC, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitState=dlswCircuitState, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateGroup=dlswDirLocateGroup, dlswCompliances=dlswCompliances, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, DlcType=DlcType, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, TAddress=TAddress, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswConformance=dlswConformance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBName=dlswDirNBName, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, null=null, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirGroup=dlswDirGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcp=dlswTConnTcp, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcCompliance=dlswSdlcCompliance, dlswNode=dlswNode, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocate=dlswDirLocate, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperState=dlswTConnOperState, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacMask=dlswDirMacMask, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitOrigin=dlswCircuitOrigin, dlswNodeStatus=dlswNodeStatus)
