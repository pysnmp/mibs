...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacLocation=dlswDirMacLocation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBTable=dlswDirNBTable, dlswDirMacTable=dlswDirMacTable, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirCache=dlswDirCache, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1Sap=dlswCircuitS1Sap, EndStationLocation=EndStationLocation, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTCPDomain=dlswTCPDomain, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, DlcType=DlcType, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirNBCacheHits=dlswDirNBCacheHits, NBName=NBName, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNotificationGroup=dlswNotificationGroup, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcp=dlswTConnTcp, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswConformance=dlswConformance, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswNode=dlswNode, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirGroup=dlswDirGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirectory=dlswDirectory, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS2TAddress=dlswCircuitS2TAddress, LFSize=LFSize, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitTable=dlswCircuitTable, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswIfTable=dlswIfTable, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTrapTConnUp=dlswTrapTConnUp, null=null, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapControl=dlswTrapControl, dlswIfEntry=dlswIfEntry, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBName=dlswDirNBName, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, MacAddressNC=MacAddressNC, dlswTConn=dlswTConn, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateNBGroup=dlswDirLocateNBGroup, TAddress=TAddress, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitOrigin=dlswCircuitOrigin, dlswNodeVersionString=dlswNodeVersionString, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswIfSapList=dlswIfSapList, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirMacMac=dlswDirMacMac, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirLocate=dlswDirLocate, dlswInterface=dlswInterface, dlswGroups=dlswGroups, dlsw=dlsw, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeStatus=dlswNodeStatus, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTraps=dlswTraps, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswMIB=dlswMIB, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirStat=dlswDirStat, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacMask=dlswDirMacMask, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitState=dlswCircuitState, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitStat=dlswCircuitStat, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, DlswTCPAddress=DlswTCPAddress, dlswCircuitStatActives=dlswCircuitStatActives, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperState=dlswTConnOperState, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCompliances=dlswCompliances, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDomains=dlswDomains, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitEntry=dlswCircuitEntry, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStat=dlswTConnStat, dlswDirCompliance=dlswDirCompliance, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuit=dlswCircuit, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlc=dlswSdlc, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation)
