...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcp=dlswTConnTcp, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateMacMac=dlswDirLocateMacMac, DlcType=DlcType, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateNBLocation=dlswDirLocateNBLocation, DlswTCPAddress=DlswTCPAddress, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTraps=dlswTraps, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacStatus=dlswDirMacStatus, dlswDirGroup=dlswDirGroup, dlswCircuitState=dlswCircuitState, dlswDirectory=dlswDirectory, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, NBName=NBName, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirCache=dlswDirCache, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeGroup=dlswNodeGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlsw=dlsw, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirStat=dlswDirStat, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTCPDomain=dlswTCPDomain, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeVersionString=dlswNodeVersionString, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCompliances=dlswCompliances, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBStatus=dlswDirNBStatus, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocate=dlswDirLocate, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswInterface=dlswInterface, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperICRexSents=dlswTConnOperICRexSents, null=null, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBName=dlswDirNBName, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitEntry=dlswCircuitEntry, dlswDirMacEntries=dlswDirMacEntries, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitTable=dlswCircuitTable, dlswMIB=dlswMIB, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperState=dlswTConnOperState, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBTable=dlswDirNBTable, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuit=dlswCircuit, dlswDirLocateNBMatch=dlswDirLocateNBMatch, LFSize=LFSize, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswIfTable=dlswIfTable, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitStatActives=dlswCircuitStatActives, dlswNodeUpTime=dlswNodeUpTime, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDomains=dlswDomains, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBNameType=dlswDirNBNameType, dlswTConnStat=dlswTConnStat, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswIfRowStatus=dlswIfRowStatus, dlswIfEntry=dlswIfEntry, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNodeVendorID=dlswNodeVendorID, dlswGroups=dlswGroups, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitStat=dlswCircuitStat, dlswCircuitGroup=dlswCircuitGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapControl=dlswTrapControl, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirNBEntryType=dlswDirNBEntryType, dlswConformance=dlswConformance, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBGroup=dlswDirNBGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTConn=dlswTConn, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirNBIndex=dlswDirNBIndex, dlswDirMacTable=dlswDirMacTable, TAddress=TAddress, MacAddressNC=MacAddressNC, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirMacMask=dlswDirMacMask, dlswDirMacMac=dlswDirMacMac, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirCompliance=dlswDirCompliance, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNode=dlswNode, dlswNodeVersion=dlswNodeVersion, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswSdlc=dlswSdlc, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, EndStationLocation=EndStationLocation, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswIfSapList=dlswIfSapList, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition)
