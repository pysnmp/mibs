...
mibBuilder.exportSymbols("DLSW-MIB", dlswInterface=dlswInterface, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigTable=dlswTConnConfigTable, TAddress=TAddress, dlswTConnOperCURexSents=dlswTConnOperCURexSents, PYSNMP_MODULE_ID=dlsw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTrapControl=dlswTrapControl, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitStatActives=dlswCircuitStatActives, dlswDomains=dlswDomains, EndStationLocation=EndStationLocation, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirStat=dlswDirStat, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBNameType=dlswDirNBNameType, null=null, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitState=dlswCircuitState, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigIndex=dlswTConnConfigIndex, dlsw=dlsw, dlswTConnStat=dlswTConnStat, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitTable=dlswCircuitTable, dlswDirNBStatus=dlswDirNBStatus, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCompliances=dlswCompliances, dlswIfSapList=dlswIfSapList, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConn=dlswTConn, dlswGroups=dlswGroups, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeGroup=dlswNodeGroup, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitGroup=dlswCircuitGroup, dlswConformance=dlswConformance, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBTable=dlswDirNBTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCircuitUp=dlswTrapCircuitUp, LFSize=LFSize, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswInterfaceGroup=dlswInterfaceGroup, dlswNode=dlswNode, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, DlswTCPAddress=DlswTCPAddress, NBName=NBName, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirectory=dlswDirectory, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirMacEntry=dlswDirMacEntry, dlswDirCache=dlswDirCache, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBIndex=dlswDirNBIndex, dlswSdlc=dlswSdlc, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswMIB=dlswMIB, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBName=dlswDirNBName, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacLocation=dlswDirMacLocation, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuit=dlswCircuit, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacMac=dlswDirMacMac, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitPriority=dlswCircuitPriority, dlswIfTable=dlswIfTable, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirGroup=dlswDirGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcLsTable=dlswSdlcLsTable, dlswTCPDomain=dlswTCPDomain, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfEntry=dlswIfEntry, dlswDirNBGroup=dlswDirNBGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitStat=dlswCircuitStat, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNodeUpTime=dlswNodeUpTime, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTraps=dlswTraps, dlswTConnSpecific=dlswTConnSpecific, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperState=dlswTConnOperState, dlswTConnOperTable=dlswTConnOperTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirMacTable=dlswDirMacTable, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, DlcType=DlcType, MacAddressNC=MacAddressNC, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBEntryType=dlswDirNBEntryType, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacStatus=dlswDirMacStatus, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocate=dlswDirLocate, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirCompliance=dlswDirCompliance, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus)
