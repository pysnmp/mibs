...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirNBEntries=dlswDirNBEntries, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfEntry=dlswIfEntry, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, LFSize=LFSize, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswIfTable=dlswIfTable, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBName=dlswDirNBName, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitState=dlswCircuitState, null=null, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitStat=dlswCircuitStat, DlcType=DlcType, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, EndStationLocation=EndStationLocation, dlswCircuit=dlswCircuit, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirCache=dlswDirCache, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTrapCntlTConn=dlswTrapCntlTConn, TAddress=TAddress, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacMac=dlswDirMacMac, dlswTConnStat=dlswTConnStat, dlsw=dlsw, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCompliances=dlswCompliances, dlswDirGroup=dlswDirGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConn=dlswTConn, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswSdlcGroup=dlswSdlcGroup, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTraps=dlswTraps, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirStat=dlswDirStat, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcp=dlswTConnTcp, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacMatch=dlswDirLocateMacMatch, NBName=NBName, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBIndex=dlswDirNBIndex, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswInterface=dlswInterface, dlswSdlcCompliance=dlswSdlcCompliance, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeStatus=dlswNodeStatus, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapControl=dlswTrapControl, dlswConformance=dlswConformance, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNodeVersion=dlswNodeVersion, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDomains=dlswDomains, dlswIfSapList=dlswIfSapList, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswMIB=dlswMIB, dlswNotificationGroup=dlswNotificationGroup, dlswDirLocate=dlswDirLocate, dlswTConnStatGroup=dlswTConnStatGroup, dlswGroups=dlswGroups, dlswTConnConfigTable=dlswTConnConfigTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirectory=dlswDirectory, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitGroup=dlswCircuitGroup, dlswNodeUpTime=dlswNodeUpTime, dlswSdlc=dlswSdlc, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswNode=dlswNode, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperState=dlswTConnOperState, dlswTConnOperConnectTime=dlswTConnOperConnectTime, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirCompliance=dlswDirCompliance, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2Location=dlswCircuitS2Location, PYSNMP_MODULE_ID=dlsw, dlswTCPDomain=dlswTCPDomain, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, MacAddressNC=MacAddressNC, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacMask=dlswDirMacMask, dlswDirNBLocation=dlswDirNBLocation, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacTable=dlswDirMacTable, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperNRexSents=dlswTConnOperNRexSents)
