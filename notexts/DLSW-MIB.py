...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateCompliance=dlswDirLocateCompliance, null=null, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCompliances=dlswCompliances, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirStat=dlswDirStat, dlswTrapControl=dlswTrapControl, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcp=dlswTConnTcp, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNodeGroup=dlswNodeGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConn=dlswTConn, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBLFSize=dlswDirNBLFSize, dlswTraps=dlswTraps, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCoreCompliance=dlswCoreCompliance, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswIfEntry=dlswIfEntry, dlswDirMacMac=dlswDirMacMac, dlswDirNBGroup=dlswDirNBGroup, dlsw=dlsw, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirCache=dlswDirCache, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacStatus=dlswDirMacStatus, LFSize=LFSize, dlswGroups=dlswGroups, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirGroup=dlswDirGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNode=dlswNode, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuit=dlswCircuit, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitS1Mac=dlswCircuitS1Mac, DlcType=DlcType, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswIfSapList=dlswIfSapList, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirNBStatus=dlswDirNBStatus, dlswDirLocateMacEntry=dlswDirLocateMacEntry, MacAddressNC=MacAddressNC, dlswNodeStatus=dlswNodeStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitStateTime=dlswCircuitStateTime, PYSNMP_MODULE_ID=dlsw, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnNBGroup=dlswTConnNBGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacEntry=dlswDirMacEntry, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBIndex=dlswDirNBIndex, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlc=dlswSdlc, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, NBName=NBName, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitState=dlswCircuitState, dlswDirNBLocation=dlswDirNBLocation, dlswInterface=dlswInterface, dlswTConnStat=dlswTConnStat, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswNodeVersion=dlswNodeVersion, dlswIfTable=dlswIfTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2Location=dlswCircuitS2Location, dlswConformance=dlswConformance, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacTable=dlswDirMacTable, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacRowStatus=dlswDirMacRowStatus, EndStationLocation=EndStationLocation, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirCompliance=dlswDirCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBName=dlswDirNBName, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitTable=dlswCircuitTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTrapCircuitUp=dlswTrapCircuitUp, TAddress=TAddress, dlswTConnOperState=dlswTConnOperState, dlswSdlcCompliance=dlswSdlcCompliance, dlswTCPDomain=dlswTCPDomain, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacEntries=dlswDirMacEntries, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirectory=dlswDirectory, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDomains=dlswDomains, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswMIB=dlswMIB, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocate=dlswDirLocate, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitEntry=dlswCircuitEntry, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB)
