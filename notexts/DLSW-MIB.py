...
mibBuilder.exportSymbols("DLSW-MIB", dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirMacIndex=dlswDirMacIndex, dlswIfTable=dlswIfTable, dlswNodeVersion=dlswNodeVersion, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirStat=dlswDirStat, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, MacAddressNC=MacAddressNC, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirCache=dlswDirCache, dlswCompliances=dlswCompliances, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperTable=dlswTConnOperTable, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeGroup=dlswNodeGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswGroups=dlswGroups, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswIfSapList=dlswIfSapList, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacTable=dlswDirMacTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpCompliance=dlswTConnTcpCompliance, null=null, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnSpecific=dlswTConnSpecific, dlswDirectory=dlswDirectory, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacLocation=dlswDirMacLocation, dlswNodeStatus=dlswNodeStatus, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitEntry=dlswCircuitEntry, dlswTConnStat=dlswTConnStat, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, EndStationLocation=EndStationLocation, DlswTCPAddress=DlswTCPAddress, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBLocation=dlswDirNBLocation, dlswTrapControl=dlswTrapControl, dlswDirNBName=dlswDirNBName, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirNBStatus=dlswDirNBStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacMac=dlswDirMacMac, dlswDirMacEntryType=dlswDirMacEntryType, DlcType=DlcType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNode=dlswNode, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitTable=dlswCircuitTable, dlswDirNBIndex=dlswDirNBIndex, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitState=dlswCircuitState, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitStat=dlswCircuitStat, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirGroup=dlswDirGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcp=dlswTConnTcp, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperState=dlswTConnOperState, dlswTraps=dlswTraps, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuit=dlswCircuit, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateMacMac=dlswDirLocateMacMac, TAddress=TAddress, dlswMIB=dlswMIB, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConn=dlswTConn, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDomains=dlswDomains, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocate=dlswDirLocate, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitS1Mac=dlswCircuitS1Mac, NBName=NBName, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTCPDomain=dlswTCPDomain, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswInterface=dlswInterface, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirCompliance=dlswDirCompliance, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, LFSize=LFSize, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswIfEntry=dlswIfEntry, PYSNMP_MODULE_ID=dlsw, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlsw=dlsw, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlc=dlswSdlc, dlswConformance=dlswConformance, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds)
