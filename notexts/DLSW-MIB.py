...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirStat=dlswDirStat, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTCPDomain=dlswTCPDomain, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswGroups=dlswGroups, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, PYSNMP_MODULE_ID=dlsw, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnStat=dlswTConnStat, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswNodeGroup=dlswNodeGroup, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswIfSapList=dlswIfSapList, dlswIfEntry=dlswIfEntry, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBTable=dlswDirNBTable, dlswInterface=dlswInterface, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuit=dlswCircuit, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlc=dlswSdlc, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapControl=dlswTrapControl, dlswDirMacEntries=dlswDirMacEntries, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDomains=dlswDomains, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirCompliance=dlswDirCompliance, EndStationLocation=EndStationLocation, TAddress=TAddress, dlswCircuitState=dlswCircuitState, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacStatus=dlswDirMacStatus, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeStatus=dlswNodeStatus, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNode=dlswNode, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitStat=dlswCircuitStat, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcGroup=dlswSdlcGroup, NBName=NBName, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcp=dlswTConnTcp, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitTable=dlswCircuitTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitPriority=dlswCircuitPriority, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNodeVersionString=dlswNodeVersionString, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacTable=dlswDirMacTable, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirectory=dlswDirectory, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateCompliance=dlswDirLocateCompliance, dlsw=dlsw, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswMIB=dlswMIB, dlswConformance=dlswConformance, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigTable=dlswTConnConfigTable, dlswCompliances=dlswCompliances, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitEntryTime=dlswCircuitEntryTime, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirGroup=dlswDirGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocate=dlswDirLocate, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitEntry=dlswCircuitEntry, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswSdlcLsTable=dlswSdlcLsTable, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperState=dlswTConnOperState, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacMac=dlswDirMacMac, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBIndex=dlswDirNBIndex, null=null, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTraps=dlswTraps, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirCache=dlswDirCache, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateNBTable=dlswDirLocateNBTable, LFSize=LFSize, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBEntryType=dlswDirNBEntryType, dlswIfTable=dlswIfTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConn=dlswTConn, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBName=dlswDirNBName, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsEntry=dlswSdlcLsEntry, MacAddressNC=MacAddressNC, dlswTConnSpecific=dlswTConnSpecific, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitS2Mac=dlswCircuitS2Mac, DlcType=DlcType)
