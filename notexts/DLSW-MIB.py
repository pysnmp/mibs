...
mibBuilder.exportSymbols("DLSW-MIB", dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDomains=dlswDomains, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswMIB=dlswMIB, dlswCircuitStat=dlswCircuitStat, dlswInterface=dlswInterface, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConn=dlswTConn, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitTable=dlswCircuitTable, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, EndStationLocation=EndStationLocation, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirCache=dlswDirCache, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTraps=dlswTraps, dlswDirNBTable=dlswDirNBTable, dlswNodeGroup=dlswNodeGroup, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnTcp=dlswTConnTcp, dlswIfSapList=dlswIfSapList, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperTDomain=dlswTConnOperTDomain, PYSNMP_MODULE_ID=dlsw, dlswDirGroup=dlswDirGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCompliances=dlswCompliances, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, NBName=NBName, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBName=dlswDirNBName, dlswCircuitOrigin=dlswCircuitOrigin, dlswIfTable=dlswIfTable, dlswTConnStat=dlswTConnStat, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacIndex=dlswDirMacIndex, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswSdlc=dlswSdlc, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperState=dlswTConnOperState, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirCompliance=dlswDirCompliance, LFSize=LFSize, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitGroup=dlswCircuitGroup, dlswTCPDomain=dlswTCPDomain, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirectory=dlswDirectory, dlswTConnOperDiscTime=dlswTConnOperDiscTime, TAddress=TAddress, dlswCircuitState=dlswCircuitState, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnConfigSapList=dlswTConnConfigSapList, DlswTCPAddress=DlswTCPAddress, dlswTrapControl=dlswTrapControl, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnNBGroup=dlswTConnNBGroup, MacAddressNC=MacAddressNC, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswIfEntry=dlswIfEntry, dlswCircuit=dlswCircuit, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacMac=dlswDirMacMac, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswGroups=dlswGroups, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, DlcType=DlcType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeStatus=dlswNodeStatus, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirStat=dlswDirStat, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocate=dlswDirLocate, dlsw=dlsw, dlswNodeVersionString=dlswNodeVersionString, dlswNode=dlswNode, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswConformance=dlswConformance, dlswDirMacMask=dlswDirMacMask, null=null, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain)
