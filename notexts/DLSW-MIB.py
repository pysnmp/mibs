...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTrapControl=dlswTrapControl, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, MacAddressNC=MacAddressNC, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTCPDomain=dlswTCPDomain, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswMIB=dlswMIB, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirStat=dlswDirStat, dlswDirNBTable=dlswDirNBTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateCompliance=dlswDirLocateCompliance, NBName=NBName, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, PYSNMP_MODULE_ID=dlsw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBEntries=dlswDirNBEntries, dlswTrapCntlCircuit=dlswTrapCntlCircuit, DlcType=DlcType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswIfEntry=dlswIfEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCompliances=dlswCompliances, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswGroups=dlswGroups, dlswNodeUpTime=dlswNodeUpTime, null=null, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNode=dlswNode, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacEntryType=dlswDirMacEntryType, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNodeStatus=dlswNodeStatus, dlswTConnTcp=dlswTConnTcp, dlswDirNBName=dlswDirNBName, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTraps=dlswTraps, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacMac=dlswDirMacMac, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswInterface=dlswInterface, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitTable=dlswCircuitTable, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuit=dlswCircuit, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperGroup=dlswTConnOperGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitState=dlswCircuitState, dlswNodeGroup=dlswNodeGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitPriority=dlswCircuitPriority, dlswDomains=dlswDomains, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacMask=dlswDirMacMask, dlswIfSapList=dlswIfSapList, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConn=dlswTConn, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBLocationType=dlswDirNBLocationType, dlswCoreCompliance=dlswCoreCompliance, dlswDirGroup=dlswDirGroup, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacStatus=dlswDirMacStatus, dlswIfRowStatus=dlswIfRowStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswIfTable=dlswIfTable, dlswSdlc=dlswSdlc, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2Sap=dlswCircuitS2Sap, EndStationLocation=EndStationLocation, dlswNotificationGroup=dlswNotificationGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirCache=dlswDirCache, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnStat=dlswTConnStat, TAddress=TAddress, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBEntryType=dlswDirNBEntryType, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacTable=dlswDirMacTable, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocate=dlswDirLocate, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlsw=dlsw, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateGroup=dlswDirLocateGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, DlswTCPAddress=DlswTCPAddress, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirectory=dlswDirectory, LFSize=LFSize, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswConformance=dlswConformance, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperState=dlswTConnOperState, dlswDirCompliance=dlswDirCompliance, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitStatGroup=dlswCircuitStatGroup)
