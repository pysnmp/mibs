...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirCache=dlswDirCache, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcGroup=dlswSdlcGroup, dlswCircuit=dlswCircuit, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswSdlc=dlswSdlc, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeGroup=dlswNodeGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, TAddress=TAddress, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswIfSapList=dlswIfSapList, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, LFSize=LFSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTrapTConnUp=dlswTrapTConnUp, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirStat=dlswDirStat, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswInterface=dlswInterface, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacEntryType=dlswDirMacEntryType, null=null, dlswConformance=dlswConformance, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlsw=dlsw, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBGroup=dlswDirNBGroup, dlswDomains=dlswDomains, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswIfTable=dlswIfTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacMac=dlswDirMacMac, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBEntryType=dlswDirNBEntryType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswGroups=dlswGroups, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnStat=dlswTConnStat, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCompliances=dlswCompliances, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswIfRowStatus=dlswIfRowStatus, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBNameType=dlswDirNBNameType, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBLocation=dlswDirNBLocation, EndStationLocation=EndStationLocation, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirectory=dlswDirectory, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswIfEntry=dlswIfEntry, dlswCircuitStat=dlswCircuitStat, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirCompliance=dlswDirCompliance, dlswDirNBStatus=dlswDirNBStatus, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBName=dlswDirNBName, dlswDirLocate=dlswDirLocate, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapControl=dlswTrapControl, dlswTConn=dlswTConn, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnTcp=dlswTConnTcp, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacTable=dlswDirMacTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, MacAddressNC=MacAddressNC, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, NBName=NBName, dlswTraps=dlswTraps, dlswTConnOperState=dlswTConnOperState, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNode=dlswNode, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTCPDomain=dlswTCPDomain, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, DlcType=DlcType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperTDomain=dlswTConnOperTDomain, PYSNMP_MODULE_ID=dlsw, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitState=dlswCircuitState, dlswDirGroup=dlswDirGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswNodeVendorID=dlswNodeVendorID, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswMIB=dlswMIB, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirMacMask=dlswDirMacMask, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitTable=dlswCircuitTable, dlswDirNBIndex=dlswDirNBIndex)
