...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirCompliance=dlswDirCompliance, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswInterface=dlswInterface, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswIfEntry=dlswIfEntry, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitTable=dlswCircuitTable, dlswGroups=dlswGroups, dlswCircuit=dlswCircuit, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBNameType=dlswDirNBNameType, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitState=dlswCircuitState, null=null, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBStatus=dlswDirNBStatus, dlsw=dlsw, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, DlcType=DlcType, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, MacAddressNC=MacAddressNC, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCompliances=dlswCompliances, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBName=dlswDirNBName, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBLFSize=dlswDirNBLFSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeVersion=dlswNodeVersion, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStat=dlswCircuitStat, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswNodeGroup=dlswNodeGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcp=dlswTConnTcp, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlc=dlswSdlc, dlswDirMacEntry=dlswDirMacEntry, dlswTConnStat=dlswTConnStat, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocate=dlswDirLocate, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitStatActives=dlswCircuitStatActives, dlswTrapTConnDown=dlswTrapTConnDown, dlswIfSapList=dlswIfSapList, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperState=dlswTConnOperState, dlswDirMacMac=dlswDirMacMac, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswSdlcLsEntries=dlswSdlcLsEntries, TAddress=TAddress, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, DlswTCPAddress=DlswTCPAddress, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswMIB=dlswMIB, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacLocation=dlswDirMacLocation, NBName=NBName, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, LFSize=LFSize, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapControl=dlswTrapControl, dlswIfRowStatus=dlswIfRowStatus, dlswDirGroup=dlswDirGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBLocation=dlswDirNBLocation, EndStationLocation=EndStationLocation, dlswDirectory=dlswDirectory, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswConformance=dlswConformance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnStatGroup=dlswTConnStatGroup, dlswTCPDomain=dlswTCPDomain, dlswDomains=dlswDomains, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConn=dlswTConn, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNode=dlswNode, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacTable=dlswDirMacTable, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirCache=dlswDirCache, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswNodeStatus=dlswNodeStatus, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswIfTable=dlswIfTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirStat=dlswDirStat, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperTable=dlswTConnOperTable, dlswTraps=dlswTraps, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitS1Mac=dlswCircuitS1Mac)
