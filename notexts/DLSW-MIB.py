...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlc=dlswSdlc, dlswDirMacMac=dlswDirMacMac, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeGroup=dlswNodeGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBIndex=dlswDirNBIndex, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitTable=dlswCircuitTable, dlswDirectory=dlswDirectory, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNodeVersion=dlswNodeVersion, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswNodeStatus=dlswNodeStatus, dlswCircuitEntry=dlswCircuitEntry, dlswInterface=dlswInterface, EndStationLocation=EndStationLocation, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswInterfaceGroup=dlswInterfaceGroup, NBName=NBName, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitStat=dlswCircuitStat, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswIfTable=dlswIfTable, dlswTConn=dlswTConn, null=null, dlswDirMacEntry=dlswDirMacEntry, dlswTraps=dlswTraps, dlswTConnStat=dlswTConnStat, dlswTCPDomain=dlswTCPDomain, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDomains=dlswDomains, DlcType=DlcType, dlswDirMacLocationType=dlswDirMacLocationType, dlsw=dlsw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBName=dlswDirNBName, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBLocation=dlswDirNBLocation, DlswTCPAddress=DlswTCPAddress, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacLFSize=dlswDirMacLFSize, dlswCompliances=dlswCompliances, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirCompliance=dlswDirCompliance, dlswDirNBEntries=dlswDirNBEntries, dlswDirCache=dlswDirCache, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirStat=dlswDirStat, dlswCircuitState=dlswCircuitState, TAddress=TAddress, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirLocateNBGroup=dlswDirLocateNBGroup, LFSize=LFSize, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswIfEntry=dlswIfEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitGroup=dlswCircuitGroup, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswConformance=dlswConformance, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBTable=dlswDirNBTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswMIB=dlswMIB, dlswDirNBGroup=dlswDirNBGroup, dlswIfSapList=dlswIfSapList, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacMask=dlswDirMacMask, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuit=dlswCircuit, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, MacAddressNC=MacAddressNC, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnTcp=dlswTConnTcp, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswGroups=dlswGroups, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNode=dlswNode, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapControl=dlswTrapControl, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocate=dlswDirLocate, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, PYSNMP_MODULE_ID=dlsw, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts)
