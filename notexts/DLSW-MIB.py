...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitState=dlswCircuitState, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperGroup=dlswTConnOperGroup, dlswConformance=dlswConformance, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirMacMac=dlswDirMacMac, dlswDirLocate=dlswDirLocate, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirNBEntryType=dlswDirNBEntryType, TAddress=TAddress, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapControl=dlswTrapControl, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitTable=dlswCircuitTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacMask=dlswDirMacMask, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacEntries=dlswDirMacEntries, NBName=NBName, dlswDirCache=dlswDirCache, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacTable=dlswDirMacTable, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, LFSize=LFSize, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuit=dlswCircuit, dlswCircuitGroup=dlswCircuitGroup, dlswNodeVersionString=dlswNodeVersionString, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacLocation=dlswDirMacLocation, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswGroups=dlswGroups, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirStat=dlswDirStat, dlswCircuitStat=dlswCircuitStat, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfEntry=dlswIfEntry, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcp=dlswTConnTcp, dlswSdlc=dlswSdlc, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlsw=dlsw, dlswDirMacStatus=dlswDirMacStatus, dlswNodeGroup=dlswNodeGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswIfSapList=dlswIfSapList, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCoreCompliance=dlswCoreCompliance, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnStat=dlswTConnStat, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeVendorID=dlswNodeVendorID, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, null=null, dlswDirectory=dlswDirectory, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirGroup=dlswDirGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBName=dlswDirNBName, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswNode=dlswNode, dlswCircuitEntry=dlswCircuitEntry, DlcType=DlcType, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswInterface=dlswInterface, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNotificationGroup=dlswNotificationGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeStatus=dlswNodeStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperState=dlswTConnOperState, DlswTCPAddress=DlswTCPAddress, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswIfTable=dlswIfTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConn=dlswTConn, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirNBTable=dlswDirNBTable, dlswDirCompliance=dlswDirCompliance, dlswNodeVersion=dlswNodeVersion, EndStationLocation=EndStationLocation, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, MacAddressNC=MacAddressNC, PYSNMP_MODULE_ID=dlsw, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTraps=dlswTraps, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCompliances=dlswCompliances, dlswMIB=dlswMIB, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacEntry=dlswDirMacEntry, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDomains=dlswDomains)
