...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, LFSize=LFSize, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswIfTable=dlswIfTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcp=dlswTConnTcp, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirStat=dlswDirStat, dlswCoreCompliance=dlswCoreCompliance, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlc=dlswSdlc, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTrapTConnDown=dlswTrapTConnDown, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperTable=dlswTConnOperTable, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfEntry=dlswIfEntry, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBName=dlswDirNBName, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitState=dlswCircuitState, dlswDirMacTable=dlswDirMacTable, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnConfigGroup=dlswTConnConfigGroup, NBName=NBName, dlswDirMacStatus=dlswDirMacStatus, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTCPDomain=dlswTCPDomain, dlswCircuit=dlswCircuit, dlswDirMacMask=dlswDirMacMask, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDomains=dlswDomains, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeVersion=dlswNodeVersion, null=null, DlcType=DlcType, dlswDirNBStatus=dlswDirNBStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnStat=dlswTConnStat, dlswDirNBLocation=dlswDirNBLocation, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapControl=dlswTrapControl, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswNode=dlswNode, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCompliances=dlswCompliances, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, DlswTCPAddress=DlswTCPAddress, dlswDirCompliance=dlswDirCompliance, dlswIfSapList=dlswIfSapList, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitTable=dlswCircuitTable, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, TAddress=TAddress, dlswTraps=dlswTraps, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, EndStationLocation=EndStationLocation, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, PYSNMP_MODULE_ID=dlsw, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswInterface=dlswInterface, dlswDirNBEntryType=dlswDirNBEntryType, dlswIfRowStatus=dlswIfRowStatus, dlswTConn=dlswTConn, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirLocate=dlswDirLocate, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirectory=dlswDirectory, dlswCircuitEntry=dlswCircuitEntry, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswConformance=dlswConformance, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeStatus=dlswNodeStatus, dlswDirCache=dlswDirCache, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBTable=dlswDirNBTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswMIB=dlswMIB, dlswTConnStatGroup=dlswTConnStatGroup, dlsw=dlsw, dlswDirGroup=dlswDirGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitStat=dlswCircuitStat, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswGroups=dlswGroups, MacAddressNC=MacAddressNC, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnConfigTable=dlswTConnConfigTable, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacMac=dlswDirMacMac)
