...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, MacAddressNC=MacAddressNC, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, PYSNMP_MODULE_ID=dlsw, dlswGroups=dlswGroups, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBLocation=dlswDirNBLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswIfSapList=dlswIfSapList, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirMacTable=dlswDirMacTable, dlswTConnOperGroup=dlswTConnOperGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswTCPDomain=dlswTCPDomain, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlsw=dlsw, dlswNodeVersion=dlswNodeVersion, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirGroup=dlswDirGroup, dlswIfTable=dlswIfTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswNodeGroup=dlswNodeGroup, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnStat=dlswTConnStat, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBIndex=dlswDirNBIndex, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTraps=dlswTraps, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswNodeUpTime=dlswNodeUpTime, EndStationLocation=EndStationLocation, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirStat=dlswDirStat, TAddress=TAddress, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswSdlc=dlswSdlc, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, NBName=NBName, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, null=null, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapControl=dlswTrapControl, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, LFSize=LFSize, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswNodeStatus=dlswNodeStatus, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConn=dlswTConn, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfEntry=dlswIfEntry, dlswTConnNBGroup=dlswTConnNBGroup, dlswDomains=dlswDomains, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfRowStatus=dlswIfRowStatus, dlswDirCache=dlswDirCache, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBTable=dlswDirNBTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcGroup=dlswSdlcGroup, dlswDirectory=dlswDirectory, dlswCircuitTable=dlswCircuitTable, dlswTConnTcp=dlswTConnTcp, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacMask=dlswDirMacMask, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswConformance=dlswConformance, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirLocate=dlswDirLocate, dlswNotificationGroup=dlswNotificationGroup, dlswCompliances=dlswCompliances, dlswCircuitPriority=dlswCircuitPriority, dlswDirMacMac=dlswDirMacMac, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitStat=dlswCircuitStat, dlswCoreCompliance=dlswCoreCompliance, dlswMIB=dlswMIB, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswNode=dlswNode, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigTable=dlswTConnConfigTable, DlcType=DlcType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswInterface=dlswInterface, dlswDirNBName=dlswDirNBName, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitState=dlswCircuitState, dlswCircuitGroup=dlswCircuitGroup, dlswCircuit=dlswCircuit, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitStatGroup=dlswCircuitStatGroup, DlswTCPAddress=DlswTCPAddress)
