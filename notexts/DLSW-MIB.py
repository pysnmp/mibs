...
mibBuilder.exportSymbols("DLSW-MIB", dlswIfRowStatus=dlswIfRowStatus, PYSNMP_MODULE_ID=dlsw, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswInterface=dlswInterface, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswGroups=dlswGroups, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacTable=dlswDirMacTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, MacAddressNC=MacAddressNC, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacEntries=dlswDirMacEntries, TAddress=TAddress, NBName=NBName, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTCPDomain=dlswTCPDomain, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeGroup=dlswNodeGroup, dlswCircuitStat=dlswCircuitStat, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperState=dlswTConnOperState, LFSize=LFSize, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConn=dlswTConn, dlswDirStat=dlswDirStat, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswNode=dlswNode, dlswIfEntry=dlswIfEntry, dlswDirNBTable=dlswDirNBTable, dlsw=dlsw, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, null=null, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDomains=dlswDomains, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeVersion=dlswNodeVersion, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirCache=dlswDirCache, dlswNotificationGroup=dlswNotificationGroup, DlswTCPAddress=DlswTCPAddress, dlswCompliances=dlswCompliances, dlswDirectory=dlswDirectory, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, DlcType=DlcType, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirMacMask=dlswDirMacMask, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirLocate=dlswDirLocate, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfSapList=dlswIfSapList, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTraps=dlswTraps, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacIndex=dlswDirMacIndex, dlswMIB=dlswMIB, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeVendorID=dlswNodeVendorID, dlswSdlc=dlswSdlc, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBEntries=dlswDirNBEntries, dlswDirGroup=dlswDirGroup, dlswCircuit=dlswCircuit, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapControl=dlswTrapControl, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcp=dlswTConnTcp, dlswTConnStat=dlswTConnStat, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBName=dlswDirNBName, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCoreCompliance=dlswCoreCompliance, dlswNodeStatus=dlswNodeStatus, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitState=dlswCircuitState, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitOrigin=dlswCircuitOrigin, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswIfTable=dlswIfTable, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBIndex=dlswDirNBIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperTable=dlswTConnOperTable, dlswConformance=dlswConformance, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, EndStationLocation=EndStationLocation, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacMac=dlswDirMacMac, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirCompliance=dlswDirCompliance, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacEntry=dlswDirMacEntry)
