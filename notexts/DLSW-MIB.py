...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocate=dlswDirLocate, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLocationType=dlswDirNBLocationType, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitGroup=dlswCircuitGroup, EndStationLocation=EndStationLocation, null=null, dlswIfSapList=dlswIfSapList, dlswGroups=dlswGroups, dlswDirNBName=dlswDirNBName, dlswCircuitPriority=dlswCircuitPriority, dlswMIB=dlswMIB, LFSize=LFSize, dlswTConnStat=dlswTConnStat, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlc=dlswSdlc, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigTable=dlswTConnConfigTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBIndex=dlswDirNBIndex, dlswTConn=dlswTConn, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, TAddress=TAddress, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTCPDomain=dlswTCPDomain, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirStat=dlswDirStat, NBName=NBName, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacTable=dlswDirMacTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitStatActives=dlswCircuitStatActives, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswConformance=dlswConformance, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperEntry=dlswTConnOperEntry, dlswDomains=dlswDomains, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswIfTable=dlswIfTable, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitTable=dlswCircuitTable, dlswInterface=dlswInterface, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBStatus=dlswDirNBStatus, dlswNode=dlswNode, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirCache=dlswDirCache, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirGroup=dlswDirGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, DlcType=DlcType, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuit=dlswCircuit, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswIfEntry=dlswIfEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, DlswTCPAddress=DlswTCPAddress, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirCompliance=dlswDirCompliance, dlswTConnTcp=dlswTConnTcp, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBLocation=dlswDirLocateNBLocation, MacAddressNC=MacAddressNC, dlswTConnOperTDomain=dlswTConnOperTDomain, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacEntry=dlswDirMacEntry, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcGroup=dlswSdlcGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeGroup=dlswNodeGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitState=dlswCircuitState, dlswTConnOperState=dlswTConnOperState, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBLocation=dlswDirNBLocation, dlswInterfaceGroup=dlswInterfaceGroup, dlswTraps=dlswTraps, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirectory=dlswDirectory, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCompliances=dlswCompliances, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeStatus=dlswNodeStatus, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacMask=dlswDirMacMask, dlswDirMacStatus=dlswDirMacStatus, dlswTConnSpecific=dlswTConnSpecific, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBTable=dlswDirNBTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeVendorID=dlswNodeVendorID, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapControl=dlswTrapControl, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlsw=dlsw, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNodeVersion=dlswNodeVersion, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirMacMac=dlswDirMacMac, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBCacheHits=dlswDirNBCacheHits)
