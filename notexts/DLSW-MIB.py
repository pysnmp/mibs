...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirNBEntry=dlswDirNBEntry, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcCompliance=dlswSdlcCompliance, dlswIfTable=dlswIfTable, dlswDirNBStatus=dlswDirNBStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnStat=dlswTConnStat, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, LFSize=LFSize, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLocationType=dlswDirNBLocationType, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswMIB=dlswMIB, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacStatus=dlswDirMacStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswInterface=dlswInterface, dlswDirNBName=dlswDirNBName, dlswSdlc=dlswSdlc, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswIfEntry=dlswIfEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcp=dlswTConnTcp, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswConformance=dlswConformance, dlswCircuitEntryTime=dlswCircuitEntryTime, MacAddressNC=MacAddressNC, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitState=dlswCircuitState, dlswDirMacEntryType=dlswDirMacEntryType, dlswSdlcLsTable=dlswSdlcLsTable, dlswCoreCompliance=dlswCoreCompliance, dlswNode=dlswNode, dlswDirNBIndex=dlswDirNBIndex, dlswGroups=dlswGroups, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswNodeStatus=dlswNodeStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, DlcType=DlcType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTraps=dlswTraps, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeGroup=dlswNodeGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitStat=dlswCircuitStat, dlswCircuitEntry=dlswCircuitEntry, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirGroup=dlswDirGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacLocationType=dlswDirMacLocationType, null=null, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, NBName=NBName, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacMac=dlswDirMacMac, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDomains=dlswDomains, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirLocate=dlswDirLocate, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeVersion=dlswNodeVersion, DlswTCPAddress=DlswTCPAddress, dlswDirMacLocation=dlswDirMacLocation, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, TAddress=TAddress, dlswDirCompliance=dlswDirCompliance, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCircuitDown=dlswTrapCircuitDown, EndStationLocation=EndStationLocation, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirectory=dlswDirectory, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBTable=dlswDirNBTable, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitStatActives=dlswCircuitStatActives, PYSNMP_MODULE_ID=dlsw, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirStat=dlswDirStat, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirCache=dlswDirCache, dlswTConnOperState=dlswTConnOperState, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacTable=dlswDirMacTable, dlswTConn=dlswTConn, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuit=dlswCircuit, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitTable=dlswCircuitTable, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapControl=dlswTrapControl, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlsw=dlsw, dlswCompliances=dlswCompliances, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnConfigTDomain=dlswTConnConfigTDomain)
