...
mibBuilder.exportSymbols("DLSW-MIB", dlswNodeVersion=dlswNodeVersion, dlswSdlc=dlswSdlc, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDomains=dlswDomains, dlswCircuit=dlswCircuit, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswIfSapList=dlswIfSapList, dlswDirLocateMacLocation=dlswDirLocateMacLocation, TAddress=TAddress, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocate=dlswDirLocate, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswInterfaceGroup=dlswInterfaceGroup, null=null, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcp=dlswTConnTcp, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTraps=dlswTraps, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlsw=dlsw, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswNodeStatus=dlswNodeStatus, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitTable=dlswCircuitTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTCPDomain=dlswTCPDomain, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswMIB=dlswMIB, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirStat=dlswDirStat, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitPriority=dlswCircuitPriority, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswIfEntry=dlswIfEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirectory=dlswDirectory, dlswIfTable=dlswIfTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBName=dlswDirNBName, DlswTCPAddress=DlswTCPAddress, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapTConnDown=dlswTrapTConnDown, DlcType=DlcType, dlswNode=dlswNode, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnStat=dlswTConnStat, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, NBName=NBName, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateMacEntry=dlswDirLocateMacEntry, EndStationLocation=EndStationLocation, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitGroup=dlswCircuitGroup, dlswDirCache=dlswDirCache, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, PYSNMP_MODULE_ID=dlsw, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCompliances=dlswCompliances, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacMac=dlswDirMacMac, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirCompliance=dlswDirCompliance, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapControl=dlswTrapControl, dlswCircuitStat=dlswCircuitStat, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacMask=dlswDirMacMask, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNodeVersionString=dlswNodeVersionString, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitState=dlswCircuitState, dlswDirMacTable=dlswDirMacTable, dlswTConn=dlswTConn, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeVendorID=dlswNodeVendorID, dlswDirGroup=dlswDirGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswConformance=dlswConformance, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswGroups=dlswGroups, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperState=dlswTConnOperState, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateNBLocation=dlswDirLocateNBLocation, LFSize=LFSize, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, MacAddressNC=MacAddressNC, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBStatus=dlswDirNBStatus, dlswInterface=dlswInterface, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBTable=dlswDirNBTable, dlswDirNBNameType=dlswDirNBNameType)
