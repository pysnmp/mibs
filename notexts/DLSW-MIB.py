...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacEntry=dlswDirMacEntry, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacIndex=dlswDirMacIndex, DlcType=DlcType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswIfSapList=dlswIfSapList, dlswCircuit=dlswCircuit, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitState=dlswCircuitState, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlsw=dlsw, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, MacAddressNC=MacAddressNC, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, null=null, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswNode=dlswNode, dlswTConnStat=dlswTConnStat, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, EndStationLocation=EndStationLocation, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcGroup=dlswSdlcGroup, dlswIfTable=dlswIfTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitEntry=dlswCircuitEntry, dlswTCPDomain=dlswTCPDomain, dlswMIB=dlswMIB, dlswIfRowStatus=dlswIfRowStatus, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeStatus=dlswNodeStatus, dlswDomains=dlswDomains, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswIfEntry=dlswIfEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswGroups=dlswGroups, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswNodeVersion=dlswNodeVersion, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperTable=dlswTConnOperTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirStat=dlswDirStat, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcp=dlswTConnTcp, dlswCircuitStat=dlswCircuitStat, dlswDirGroup=dlswDirGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlc=dlswSdlc, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBLocation=dlswDirNBLocation, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBMatch=dlswDirLocateNBMatch, TAddress=TAddress, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacTable=dlswDirMacTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacMask=dlswDirMacMask, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirCompliance=dlswDirCompliance, DlswTCPAddress=DlswTCPAddress, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirMacEntries=dlswDirMacEntries, dlswTraps=dlswTraps, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBIndex=dlswDirNBIndex, dlswTConn=dlswTConn, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswConformance=dlswConformance, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, LFSize=LFSize, dlswDirCache=dlswDirCache, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCompliances=dlswCompliances, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirNBName=dlswDirNBName, PYSNMP_MODULE_ID=dlsw, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, NBName=NBName, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCoreCompliance=dlswCoreCompliance, dlswInterface=dlswInterface, dlswDirLocate=dlswDirLocate, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBTable=dlswDirNBTable, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacMac=dlswDirMacMac, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitTable=dlswCircuitTable, dlswTrapControl=dlswTrapControl, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitGroup=dlswCircuitGroup, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirectory=dlswDirectory, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacLocationType=dlswDirMacLocationType)
