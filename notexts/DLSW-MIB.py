...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcp=dlswTConnTcp, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswInterface=dlswInterface, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirLocateNBEntry=dlswDirLocateNBEntry, LFSize=LFSize, dlswNodeVersion=dlswNodeVersion, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswNodeUpTime=dlswNodeUpTime, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitTable=dlswCircuitTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirMacEntry=dlswDirMacEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeGroup=dlswNodeGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitGroup=dlswCircuitGroup, dlswTConnStat=dlswTConnStat, dlswSdlc=dlswSdlc, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, null=null, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitStat=dlswCircuitStat, NBName=NBName, DlswTCPAddress=DlswTCPAddress, dlswDirLocate=dlswDirLocate, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirCache=dlswDirCache, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperState=dlswTConnOperState, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, TAddress=TAddress, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBEntries=dlswDirNBEntries, dlswGroups=dlswGroups, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCompliances=dlswCompliances, dlswMIB=dlswMIB, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperTable=dlswTConnOperTable, dlswDirGroup=dlswDirGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTraps=dlswTraps, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacTable=dlswDirMacTable, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswIfTable=dlswIfTable, EndStationLocation=EndStationLocation, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, MacAddressNC=MacAddressNC, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlsw=dlsw, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBLocation=dlswDirNBLocation, dlswNodeStatus=dlswNodeStatus, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirNBName=dlswDirNBName, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBCacheHits=dlswDirNBCacheHits, DlcType=DlcType, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswNode=dlswNode, dlswDirStat=dlswDirStat, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacMac=dlswDirMacMac, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitState=dlswCircuitState, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfSapList=dlswIfSapList, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacMask=dlswDirMacMask, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConn=dlswTConn, dlswConformance=dlswConformance, dlswDomains=dlswDomains, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirectory=dlswDirectory, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapControl=dlswTrapControl, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTCPDomain=dlswTCPDomain, dlswCircuit=dlswCircuit, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBTable=dlswDirNBTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections)
