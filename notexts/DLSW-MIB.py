...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacMask=dlswDirMacMask, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocate=dlswDirLocate, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirCache=dlswDirCache, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, null=null, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnStat=dlswTConnStat, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeVersionString=dlswNodeVersionString, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirNBName=dlswDirNBName, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuit=dlswCircuit, PYSNMP_MODULE_ID=dlsw, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBLocation=dlswDirNBLocation, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitGroup=dlswCircuitGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacTable=dlswDirMacTable, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnDown=dlswTrapTConnDown, NBName=NBName, dlswMIB=dlswMIB, dlswTrapControl=dlswTrapControl, MacAddressNC=MacAddressNC, dlsw=dlsw, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirCompliance=dlswDirCompliance, dlswCircuitStat=dlswCircuitStat, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlc=dlswSdlc, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitState=dlswCircuitState, DlcType=DlcType, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswNode=dlswNode, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCompliances=dlswCompliances, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswIfEntry=dlswIfEntry, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeVersion=dlswNodeVersion, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitStatGroup=dlswCircuitStatGroup, DlswTCPAddress=DlswTCPAddress, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswIfSapList=dlswIfSapList, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirectory=dlswDirectory, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswInterface=dlswInterface, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperState=dlswTConnOperState, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBNameType=dlswDirNBNameType, dlswTraps=dlswTraps, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, EndStationLocation=EndStationLocation, dlswDirMacMac=dlswDirMacMac, LFSize=LFSize, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDomains=dlswDomains, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswGroups=dlswGroups, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcCompliance=dlswSdlcCompliance, TAddress=TAddress, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcp=dlswTConnTcp, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConn=dlswTConn, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNodeStatus=dlswNodeStatus, dlswConformance=dlswConformance, dlswDirStat=dlswDirStat, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswIfTable=dlswIfTable, dlswTConnOperEntryTime=dlswTConnOperEntryTime)
