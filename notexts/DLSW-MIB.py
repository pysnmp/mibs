...
mibBuilder.exportSymbols("DLSW-MIB", dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswIfSapList=dlswIfSapList, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacMac=dlswDirMacMac, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnSpecific=dlswTConnSpecific, dlswTraps=dlswTraps, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDomains=dlswDomains, dlswDirLocate=dlswDirLocate, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcGroup=dlswSdlcGroup, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBIndex=dlswDirNBIndex, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnNBGroup=dlswTConnNBGroup, DlcType=DlcType, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, NBName=NBName, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeGroup=dlswNodeGroup, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnStat=dlswTConnStat, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswGroups=dlswGroups, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, TAddress=TAddress, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacMask=dlswDirMacMask, PYSNMP_MODULE_ID=dlsw, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsTable=dlswSdlcLsTable, MacAddressNC=MacAddressNC, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigSapList=dlswTConnConfigSapList, DlswTCPAddress=DlswTCPAddress, dlswDirStat=dlswDirStat, dlswDirGroup=dlswDirGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacTable=dlswDirMacTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBGroup=dlswDirNBGroup, LFSize=LFSize, dlswCircuit=dlswCircuit, dlswCompliances=dlswCompliances, dlswCircuitStateTime=dlswCircuitStateTime, dlswIfTable=dlswIfTable, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitState=dlswCircuitState, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBName=dlswDirNBName, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperState=dlswTConnOperState, dlswNodeVersion=dlswNodeVersion, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeUpTime=dlswNodeUpTime, dlswDirCache=dlswDirCache, null=null, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitStat=dlswCircuitStat, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswMIB=dlswMIB, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBTable=dlswDirNBTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapTConnDown=dlswTrapTConnDown, dlswConformance=dlswConformance, dlswTConn=dlswTConn, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswInterface=dlswInterface, dlswDirMacLocationType=dlswDirMacLocationType, dlswIfEntry=dlswIfEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNode=dlswNode, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitPriority=dlswCircuitPriority, dlsw=dlsw, dlswDirCompliance=dlswDirCompliance, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitTable=dlswCircuitTable, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirectory=dlswDirectory, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlc=dlswSdlc, dlswTCPDomain=dlswTCPDomain, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitEntry=dlswCircuitEntry, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTrapControl=dlswTrapControl, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, EndStationLocation=EndStationLocation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacCacheMisses=dlswDirMacCacheMisses)
