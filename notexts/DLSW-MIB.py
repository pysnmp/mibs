...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConn=dlswTConn, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitTable=dlswCircuitTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirNBEntry=dlswDirNBEntry, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirMacTable=dlswDirMacTable, dlswTCPDomain=dlswTCPDomain, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirNBTable=dlswDirNBTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBEntries=dlswDirNBEntries, NBName=NBName, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBEntryType=dlswDirNBEntryType, DlcType=DlcType, PYSNMP_MODULE_ID=dlsw, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateGroup=dlswDirLocateGroup, dlswMIB=dlswMIB, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, EndStationLocation=EndStationLocation, dlswNodeVersion=dlswNodeVersion, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirGroup=dlswDirGroup, dlsw=dlsw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirStat=dlswDirStat, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitPriority=dlswCircuitPriority, null=null, LFSize=LFSize, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuit=dlswCircuit, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBStatus=dlswDirNBStatus, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirMacMask=dlswDirMacMask, dlswDirMacMac=dlswDirMacMac, dlswConformance=dlswConformance, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcGroup=dlswSdlcGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirCompliance=dlswDirCompliance, dlswDirLocateMacEntry=dlswDirLocateMacEntry, DlswTCPAddress=DlswTCPAddress, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswNodeStatus=dlswNodeStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTraps=dlswTraps, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswGroups=dlswGroups, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcp=dlswTConnTcp, dlswIfEntry=dlswIfEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitGroup=dlswCircuitGroup, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitStatActives=dlswCircuitStatActives, dlswCompliances=dlswCompliances, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnStat=dlswTConnStat, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswInterface=dlswInterface, dlswCircuitStat=dlswCircuitStat, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfSapList=dlswIfSapList, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitState=dlswCircuitState, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnNBGroup=dlswTConnNBGroup, MacAddressNC=MacAddressNC, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitEntry=dlswCircuitEntry, dlswDirectory=dlswDirectory, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDomains=dlswDomains, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirCache=dlswDirCache, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswNode=dlswNode, dlswTConnOperTable=dlswTConnOperTable, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapControl=dlswTrapControl, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeGroup=dlswNodeGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocate=dlswDirLocate, dlswNodeVersionString=dlswNodeVersionString, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBIndex=dlswDirNBIndex, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirNBName=dlswDirNBName, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlc=dlswSdlc, dlswNodeVendorID=dlswNodeVendorID, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswIfTable=dlswIfTable, TAddress=TAddress, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl)
