...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitStatActives=dlswCircuitStatActives, dlsw=dlsw, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswGroups=dlswGroups, dlswTraps=dlswTraps, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuit=dlswCircuit, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswSdlcGroup=dlswSdlcGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapControl=dlswTrapControl, dlswMIB=dlswMIB, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConn=dlswTConn, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcCompliance=dlswSdlcCompliance, dlswDomains=dlswDomains, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirCache=dlswDirCache, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVersion=dlswNodeVersion, DlswTCPAddress=DlswTCPAddress, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcp=dlswTConnTcp, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswNodeGroup=dlswNodeGroup, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, EndStationLocation=EndStationLocation, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirGroup=dlswDirGroup, dlswNodeStatus=dlswNodeStatus, NBName=NBName, dlswConformance=dlswConformance, dlswNotificationGroup=dlswNotificationGroup, dlswCompliances=dlswCompliances, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBName=dlswDirNBName, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitState=dlswCircuitState, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperConnectTime=dlswTConnOperConnectTime, LFSize=LFSize, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacMac=dlswDirMacMac, dlswDirNBStatus=dlswDirNBStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswInterfaceGroup=dlswInterfaceGroup, DlcType=DlcType, dlswTCPDomain=dlswTCPDomain, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigIndex=dlswTConnConfigIndex, PYSNMP_MODULE_ID=dlsw, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, TAddress=TAddress, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocate=dlswDirLocate, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirCompliance=dlswDirCompliance, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, MacAddressNC=MacAddressNC, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswIfTable=dlswIfTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNode=dlswNode, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirStat=dlswDirStat, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirectory=dlswDirectory, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswIfSapList=dlswIfSapList, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfEntry=dlswIfEntry, dlswInterface=dlswInterface, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswSdlc=dlswSdlc, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBEntries=dlswDirNBEntries, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, null=null, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBNameType=dlswDirNBNameType, dlswTConnStat=dlswTConnStat, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitStat=dlswCircuitStat, dlswDirMacTable=dlswDirMacTable, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap)
