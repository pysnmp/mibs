...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirectory=dlswDirectory, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperICRexSents=dlswTConnOperICRexSents, TAddress=TAddress, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlc=dlswSdlc, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacLocationType=dlswDirMacLocationType, dlswNodeStatus=dlswNodeStatus, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuit=dlswCircuit, dlswCircuitEntry=dlswCircuitEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirNBEntry=dlswDirNBEntry, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacEntries=dlswDirMacEntries, dlswNodeUpTime=dlswNodeUpTime, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDomains=dlswDomains, dlswDirLocateGroup=dlswDirLocateGroup, dlswIfRowStatus=dlswIfRowStatus, dlswTraps=dlswTraps, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBCacheMisses=dlswDirNBCacheMisses, NBName=NBName, PYSNMP_MODULE_ID=dlsw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfVirtualSegment=dlswIfVirtualSegment, EndStationLocation=EndStationLocation, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacTable=dlswDirMacTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNode=dlswNode, dlswTConnOperState=dlswTConnOperState, dlswIfEntry=dlswIfEntry, dlswDirNBName=dlswDirNBName, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatGroup=dlswTConnStatGroup, dlswMIB=dlswMIB, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapTConnDown=dlswTrapTConnDown, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirMacIndex=dlswDirMacIndex, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, null=null, dlswTConnOperTable=dlswTConnOperTable, dlswDirCompliance=dlswDirCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacStatus=dlswDirMacStatus, dlswTConnTcp=dlswTConnTcp, dlswTCPDomain=dlswTCPDomain, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBEntryType=dlswDirNBEntryType, dlswTrapControl=dlswTrapControl, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitTable=dlswCircuitTable, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCoreCompliance=dlswCoreCompliance, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirGroup=dlswDirGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswInterface=dlswInterface, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, DlcType=DlcType, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlsw=dlsw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswConformance=dlswConformance, dlswDirCache=dlswDirCache, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBEntries=dlswDirNBEntries, dlswIfSapList=dlswIfSapList, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitStat=dlswCircuitStat, dlswCircuitGroup=dlswCircuitGroup, MacAddressNC=MacAddressNC, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBTable=dlswDirNBTable, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNodeGroup=dlswNodeGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, LFSize=LFSize, dlswDirStat=dlswDirStat, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswGroups=dlswGroups, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfTable=dlswIfTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConn=dlswTConn, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBLocation=dlswDirNBLocation, dlswDirMacMac=dlswDirMacMac, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirLocate=dlswDirLocate, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCompliances=dlswCompliances, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitState=dlswCircuitState, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnStat=dlswTConnStat)
