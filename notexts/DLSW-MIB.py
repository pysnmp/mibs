...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNotificationGroup=dlswNotificationGroup, dlswDirCache=dlswDirCache, dlswDirNBEntries=dlswDirNBEntries, dlswIfTable=dlswIfTable, dlswDirMacTable=dlswDirMacTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateNBEntry=dlswDirLocateNBEntry, null=null, EndStationLocation=EndStationLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, TAddress=TAddress, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeGroup=dlswNodeGroup, dlsw=dlsw, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfEntry=dlswIfEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswInterface=dlswInterface, dlswIfRowStatus=dlswIfRowStatus, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlc=dlswSdlc, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirCompliance=dlswDirCompliance, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitStat=dlswCircuitStat, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswNode=dlswNode, dlswTrapControl=dlswTrapControl, dlswTConnOperEntry=dlswTConnOperEntry, NBName=NBName, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConn=dlswTConn, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacMac=dlswDirMacMac, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTraps=dlswTraps, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitState=dlswCircuitState, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCompliances=dlswCompliances, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacEntry=dlswDirMacEntry, DlcType=DlcType, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, MacAddressNC=MacAddressNC, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswInterfaceGroup=dlswInterfaceGroup, PYSNMP_MODULE_ID=dlsw, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitTable=dlswCircuitTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBTable=dlswDirNBTable, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeStatus=dlswNodeStatus, dlswTConnTcp=dlswTConnTcp, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperGroup=dlswTConnOperGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswIfSapList=dlswIfSapList, dlswDirStat=dlswDirStat, dlswTCPDomain=dlswTCPDomain, dlswSdlcGroup=dlswSdlcGroup, dlswMIB=dlswMIB, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswGroups=dlswGroups, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswConformance=dlswConformance, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacLocation=dlswDirMacLocation, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, DlswTCPAddress=DlswTCPAddress, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitGroup=dlswCircuitGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, LFSize=LFSize, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDomains=dlswDomains, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnStat=dlswTConnStat, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirGroup=dlswDirGroup, dlswDirNBName=dlswDirNBName, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocate=dlswDirLocate, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuit=dlswCircuit, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirectory=dlswDirectory, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitEntry=dlswCircuitEntry, dlswTConnConfigTDomain=dlswTConnConfigTDomain)
