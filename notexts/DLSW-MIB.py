...
mibBuilder.exportSymbols("DLSW-MIB", dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS1Mac=dlswCircuitS1Mac, dlsw=dlsw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConn=dlswTConn, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswIfSapList=dlswIfSapList, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuit=dlswCircuit, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocate=dlswDirLocate, dlswTConnStat=dlswTConnStat, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTCPDomain=dlswTCPDomain, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirMacEntry=dlswDirMacEntry, MacAddressNC=MacAddressNC, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirCache=dlswDirCache, dlswDirNBName=dlswDirNBName, dlswDirCompliance=dlswDirCompliance, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperCircuits=dlswTConnOperCircuits, NBName=NBName, dlswDirNBGroup=dlswDirNBGroup, dlswDirectory=dlswDirectory, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswGroups=dlswGroups, dlswCircuitStat=dlswCircuitStat, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, null=null, dlswNodeGroup=dlswNodeGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapControl=dlswTrapControl, dlswTraps=dlswTraps, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswIfEntry=dlswIfEntry, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeStatus=dlswNodeStatus, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, DlcType=DlcType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitTable=dlswCircuitTable, dlswDomains=dlswDomains, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacIndex=dlswDirMacIndex, dlswInterface=dlswInterface, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswNodeVersion=dlswNodeVersion, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswConformance=dlswConformance, DlswTCPAddress=DlswTCPAddress, dlswSdlc=dlswSdlc, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, LFSize=LFSize, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcp=dlswTConnTcp, dlswIfTable=dlswIfTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswMIB=dlswMIB, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirStat=dlswDirStat, dlswDirMacStatus=dlswDirMacStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswNodeVendorID=dlswNodeVendorID, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCoreCompliance=dlswCoreCompliance, dlswDirNBIndex=dlswDirNBIndex, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, TAddress=TAddress, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCompliances=dlswCompliances, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirGroup=dlswDirGroup, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperState=dlswTConnOperState, dlswDirNBLocation=dlswDirNBLocation, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswNode=dlswNode, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, PYSNMP_MODULE_ID=dlsw, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBStatus=dlswDirNBStatus, dlswDirMacMac=dlswDirMacMac, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitState=dlswCircuitState, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswSdlcCompliance=dlswSdlcCompliance, EndStationLocation=EndStationLocation, dlswDirNBTable=dlswDirNBTable, dlswTConnOperICRexSents=dlswTConnOperICRexSents)
