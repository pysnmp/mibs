...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, EndStationLocation=EndStationLocation, dlswTConn=dlswTConn, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcGroup=dlswSdlcGroup, dlswDirectory=dlswDirectory, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnStat=dlswTConnStat, dlswTCPDomain=dlswTCPDomain, DlcType=DlcType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfSapList=dlswIfSapList, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitPriority=dlswCircuitPriority, dlswIfRowStatus=dlswIfRowStatus, dlswTraps=dlswTraps, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlsw=dlsw, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperGroup=dlswTConnOperGroup, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, TAddress=TAddress, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswNode=dlswNode, dlswNodeStatus=dlswNodeStatus, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswMIB=dlswMIB, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirCache=dlswDirCache, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirLocate=dlswDirLocate, dlswDomains=dlswDomains, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuit=dlswCircuit, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswInterface=dlswInterface, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, NBName=NBName, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitTable=dlswCircuitTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapCircuitDown=dlswTrapCircuitDown, MacAddressNC=MacAddressNC, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirCompliance=dlswDirCompliance, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBName=dlswDirNBName, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacMac=dlswDirMacMac, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeGroup=dlswNodeGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacLocation=dlswDirMacLocation, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperState=dlswTConnOperState, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitStat=dlswCircuitStat, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirStat=dlswDirStat, dlswNodeVersion=dlswNodeVersion, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperNQexSents=dlswTConnOperNQexSents, PYSNMP_MODULE_ID=dlsw, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTrapControl=dlswTrapControl, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswCompliances=dlswCompliances, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswNodeUpTime=dlswNodeUpTime, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswIfTable=dlswIfTable, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswInterfaceGroup=dlswInterfaceGroup, dlswGroups=dlswGroups, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacEntry=dlswDirMacEntry, dlswSdlc=dlswSdlc, dlswDirMacLFSize=dlswDirMacLFSize, dlswConformance=dlswConformance, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfEntry=dlswIfEntry, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, LFSize=LFSize, null=null, DlswTCPAddress=DlswTCPAddress, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirMacMask=dlswDirMacMask, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnTcp=dlswTConnTcp, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitState=dlswCircuitState, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry)
