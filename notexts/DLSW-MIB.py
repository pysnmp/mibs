...
mibBuilder.exportSymbols("DLSW-MIB", dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirCompliance=dlswDirCompliance, dlswIfTable=dlswIfTable, dlswCircuit=dlswCircuit, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirGroup=dlswDirGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, TAddress=TAddress, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, null=null, dlswDirCache=dlswDirCache, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswIfSapList=dlswIfSapList, dlswDirLocate=dlswDirLocate, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitPriority=dlswCircuitPriority, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapControl=dlswTrapControl, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNodeStatus=dlswNodeStatus, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBName=dlswDirNBName, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitStat=dlswCircuitStat, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswGroups=dlswGroups, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTraps=dlswTraps, dlswInterface=dlswInterface, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswNodeVersion=dlswNodeVersion, dlswSdlc=dlswSdlc, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirectory=dlswDirectory, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDomains=dlswDomains, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperTDomain=dlswTConnOperTDomain, EndStationLocation=EndStationLocation, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacMac=dlswDirMacMac, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperState=dlswTConnOperState, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacTable=dlswDirMacTable, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLocation=dlswDirNBLocation, dlsw=dlsw, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswMIB=dlswMIB, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocateMacMac=dlswDirLocateMacMac, DlswTCPAddress=DlswTCPAddress, LFSize=LFSize, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitTable=dlswCircuitTable, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirStat=dlswDirStat, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnStat=dlswTConnStat, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCompliances=dlswCompliances, dlswDirNBGroup=dlswDirNBGroup, dlswNode=dlswNode, dlswTrapTConnUp=dlswTrapTConnUp, dlswConformance=dlswConformance, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBCacheHits=dlswDirNBCacheHits, DlcType=DlcType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitState=dlswCircuitState, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeGroup=dlswNodeGroup, dlswCoreCompliance=dlswCoreCompliance, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitStateTime=dlswCircuitStateTime, NBName=NBName, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConn=dlswTConn, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeVersionString=dlswNodeVersionString, dlswIfEntry=dlswIfEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, PYSNMP_MODULE_ID=dlsw, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcp=dlswTConnTcp, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitEntry=dlswCircuitEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, MacAddressNC=MacAddressNC)
