...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBLocationType=dlswDirNBLocationType, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirGroup=dlswDirGroup, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, NBName=NBName, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperTable=dlswTConnOperTable, dlswDirCache=dlswDirCache, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitStatActives=dlswCircuitStatActives, dlswDomains=dlswDomains, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitTable=dlswCircuitTable, LFSize=LFSize, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnStat=dlswTConnStat, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocate=dlswDirLocate, dlsw=dlsw, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswNode=dlswNode, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeStatus=dlswNodeStatus, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswConformance=dlswConformance, dlswDirCompliance=dlswDirCompliance, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirStat=dlswDirStat, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, MacAddressNC=MacAddressNC, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateMacMac=dlswDirLocateMacMac, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCompliances=dlswCompliances, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBName=dlswDirNBName, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTraps=dlswTraps, dlswIfEntry=dlswIfEntry, TAddress=TAddress, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBTable=dlswDirNBTable, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcp=dlswTConnTcp, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswInterfaceGroup=dlswInterfaceGroup, dlswNodeVersion=dlswNodeVersion, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperState=dlswTConnOperState, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBLocation=dlswDirNBLocation, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitState=dlswCircuitState, dlswNodeGroup=dlswNodeGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, EndStationLocation=EndStationLocation, dlswSdlcGroup=dlswSdlcGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNotificationGroup=dlswNotificationGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswInterface=dlswInterface, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConn=dlswTConn, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitStat=dlswCircuitStat, DlswTCPAddress=DlswTCPAddress, dlswDirNBEntries=dlswDirNBEntries, DlcType=DlcType, dlswGroups=dlswGroups, dlswDirNBGroup=dlswDirNBGroup, dlswDirectory=dlswDirectory, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacStatus=dlswDirMacStatus, null=null, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlc=dlswSdlc, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacEntries=dlswDirMacEntries, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTCPDomain=dlswTCPDomain, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswMIB=dlswMIB, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuit=dlswCircuit, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacMask=dlswDirMacMask, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfSapList=dlswIfSapList, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacTable=dlswDirMacTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswIfTable=dlswIfTable, dlswDirMacMac=dlswDirMacMac, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapControl=dlswTrapControl)
