...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitPriority=dlswCircuitPriority, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS2Location=dlswCircuitS2Location, dlswNode=dlswNode, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNodeGroup=dlswNodeGroup, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswIfTable=dlswIfTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlsw=dlsw, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirCache=dlswDirCache, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBRowStatus=dlswDirNBRowStatus, null=null, dlswDomains=dlswDomains, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBStatus=dlswDirNBStatus, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirMacEntries=dlswDirMacEntries, dlswTrapControl=dlswTrapControl, dlswDirStat=dlswDirStat, dlswMIB=dlswMIB, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBTable=dlswDirNBTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeVendorID=dlswNodeVendorID, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeStatus=dlswNodeStatus, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, EndStationLocation=EndStationLocation, DlcType=DlcType, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperCURexSents=dlswTConnOperCURexSents, LFSize=LFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnTcp=dlswTConnTcp, dlswCircuitGroup=dlswCircuitGroup, NBName=NBName, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirNBLocation=dlswDirNBLocation, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, MacAddressNC=MacAddressNC, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnStat=dlswTConnStat, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBEntries=dlswDirNBEntries, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeVersionString=dlswNodeVersionString, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNotificationGroup=dlswNotificationGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTraps=dlswTraps, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitState=dlswCircuitState, dlswTConn=dlswTConn, dlswNodeVersion=dlswNodeVersion, TAddress=TAddress, dlswInterface=dlswInterface, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacTable=dlswDirMacTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBName=dlswDirNBName, dlswIfSapList=dlswIfSapList, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirMacMac=dlswDirMacMac, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswConformance=dlswConformance, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirMacLocationType=dlswDirMacLocationType, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocate=dlswDirLocate, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTCPDomain=dlswTCPDomain, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacIndex=dlswDirMacIndex, dlswCircuit=dlswCircuit, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswGroups=dlswGroups, PYSNMP_MODULE_ID=dlsw, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfEntry=dlswIfEntry, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirCompliance=dlswDirCompliance, dlswDirectory=dlswDirectory, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitEntry=dlswCircuitEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitStat=dlswCircuitStat, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCompliances=dlswCompliances, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirGroup=dlswDirGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlc=dlswSdlc)
