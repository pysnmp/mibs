...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfEntry=dlswIfEntry, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacLocation=dlswDirMacLocation, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBStatus=dlswDirNBStatus, dlswDirNBEntryType=dlswDirNBEntryType, EndStationLocation=EndStationLocation, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirNBLocation=dlswDirNBLocation, dlswNodeStatus=dlswNodeStatus, dlswDirMacMac=dlswDirMacMac, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswIfTable=dlswIfTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCompliances=dlswCompliances, null=null, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocateNBName=dlswDirLocateNBName, dlswNodeVersionString=dlswNodeVersionString, dlswTrapControl=dlswTrapControl, PYSNMP_MODULE_ID=dlsw, dlswDirectory=dlswDirectory, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirCompliance=dlswDirCompliance, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBTable=dlswDirNBTable, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDomains=dlswDomains, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTCPDomain=dlswTCPDomain, dlswTConn=dlswTConn, MacAddressNC=MacAddressNC, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswNode=dlswNode, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswConformance=dlswConformance, DlcType=DlcType, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitState=dlswCircuitState, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperState=dlswTConnOperState, dlswTConnStat=dlswTConnStat, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswIfSapList=dlswIfSapList, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitOrigin=dlswCircuitOrigin, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswInterface=dlswInterface, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, NBName=NBName, dlswDirCache=dlswDirCache, dlswDirNBLFSize=dlswDirNBLFSize, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitStat=dlswCircuitStat, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacTable=dlswDirMacTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeGroup=dlswNodeGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlsw=dlsw, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBName=dlswDirNBName, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirStat=dlswDirStat, dlswMIB=dlswMIB, TAddress=TAddress, LFSize=LFSize, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitTable=dlswCircuitTable, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacEntries=dlswDirMacEntries, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeVersion=dlswNodeVersion, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitEntry=dlswCircuitEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBGroup=dlswDirNBGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTraps=dlswTraps, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlc=dlswSdlc, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuit=dlswCircuit, DlswTCPAddress=DlswTCPAddress, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocate=dlswDirLocate, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirGroup=dlswDirGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswGroups=dlswGroups, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac)
