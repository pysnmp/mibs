...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuit=dlswCircuit, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirStat=dlswDirStat, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswNodeVendorID=dlswNodeVendorID, dlswSdlcGroup=dlswSdlcGroup, dlswSdlc=dlswSdlc, dlswTConnStat=dlswTConnStat, dlswIfSapList=dlswIfSapList, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, DlcType=DlcType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswMIB=dlswMIB, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitTable=dlswCircuitTable, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlsw=dlsw, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNode=dlswNode, dlswDirMacMac=dlswDirMacMac, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitState=dlswCircuitState, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacEntries=dlswDirMacEntries, dlswTCPDomain=dlswTCPDomain, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswConformance=dlswConformance, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBEntries=dlswDirNBEntries, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBName=dlswDirNBName, dlswDomains=dlswDomains, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswInterface=dlswInterface, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigEntryType=dlswTConnConfigEntryType, TAddress=TAddress, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBNameType=dlswDirNBNameType, dlswTrapControl=dlswTrapControl, dlswIfTable=dlswIfTable, dlswNodeVersion=dlswNodeVersion, MacAddressNC=MacAddressNC, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitGroup=dlswCircuitGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConn=dlswTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacMask=dlswDirMacMask, dlswNodeUpTime=dlswNodeUpTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcp=dlswTConnTcp, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswIfEntry=dlswIfEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBTable=dlswDirNBTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, null=null, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirCache=dlswDirCache, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnTcpCompliance=dlswTConnTcpCompliance, DlswTCPAddress=DlswTCPAddress, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitStat=dlswCircuitStat, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocate=dlswDirLocate, dlswGroups=dlswGroups, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeStatus=dlswNodeStatus, dlswDirMacLocation=dlswDirMacLocation, dlswTraps=dlswTraps, NBName=NBName, dlswCircuitEntry=dlswCircuitEntry, EndStationLocation=EndStationLocation, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirectory=dlswDirectory, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacTable=dlswDirMacTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirNBStatus=dlswDirNBStatus, dlswDirMacEntry=dlswDirMacEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, LFSize=LFSize, dlswDirCompliance=dlswDirCompliance, dlswCompliances=dlswCompliances, dlswTConnOperState=dlswTConnOperState, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacLocationType=dlswDirMacLocationType, PYSNMP_MODULE_ID=dlsw)
