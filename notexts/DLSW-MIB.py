...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCompliances=dlswCompliances, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBLocation=dlswDirNBLocation, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNode=dlswNode, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBName=dlswDirNBName, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitState=dlswCircuitState, dlswDirNBEntryType=dlswDirNBEntryType, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnTcp=dlswTConnTcp, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeUpTime=dlswNodeUpTime, dlswIfTable=dlswIfTable, dlswTrapControl=dlswTrapControl, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirMacEntry=dlswDirMacEntry, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitPriority=dlswCircuitPriority, dlswGroups=dlswGroups, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirCache=dlswDirCache, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBEntries=dlswDirNBEntries, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCoreCompliance=dlswCoreCompliance, TAddress=TAddress, dlswDirectory=dlswDirectory, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirCompliance=dlswDirCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlc=dlswSdlc, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacMask=dlswDirMacMask, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlsw=dlsw, dlswDirStat=dlswDirStat, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitStat=dlswCircuitStat, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacMac=dlswDirMacMac, DlcType=DlcType, dlswInterface=dlswInterface, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswNotificationGroup=dlswNotificationGroup, dlswConformance=dlswConformance, dlswCircuit=dlswCircuit, MacAddressNC=MacAddressNC, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, NBName=NBName, dlswDirMacLFSize=dlswDirMacLFSize, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacLocation=dlswDirMacLocation, dlswNodeVersionString=dlswNodeVersionString, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConn=dlswTConn, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnStat=dlswTConnStat, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapCircuitUp=dlswTrapCircuitUp, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTCPDomain=dlswTCPDomain, dlswDomains=dlswDomains, LFSize=LFSize, dlswDirMacTable=dlswDirMacTable, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, null=null, dlswMIB=dlswMIB, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperState=dlswTConnOperState, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, EndStationLocation=EndStationLocation, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTraps=dlswTraps, dlswNodeGroup=dlswNodeGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirLocate=dlswDirLocate, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBEntry=dlswDirNBEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, DlswTCPAddress=DlswTCPAddress, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswIfSapList=dlswIfSapList, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfEntry=dlswIfEntry, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBRowStatus=dlswDirNBRowStatus)
