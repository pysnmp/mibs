...
mibBuilder.exportSymbols("DLSW-MIB", DlswTCPAddress=DlswTCPAddress, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, PYSNMP_MODULE_ID=dlsw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitState=dlswCircuitState, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeGroup=dlswNodeGroup, dlswDirNBName=dlswDirNBName, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS2Location=dlswCircuitS2Location, NBName=NBName, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeVersionString=dlswNodeVersionString, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigTable=dlswTConnConfigTable, null=null, dlswSdlc=dlswSdlc, dlswDirStat=dlswDirStat, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNodeVersion=dlswNodeVersion, dlswTConnStat=dlswTConnStat, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacTable=dlswDirMacTable, dlswDirNBTable=dlswDirNBTable, dlswInterface=dlswInterface, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirMacStatus=dlswDirMacStatus, dlswIfSapList=dlswIfSapList, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacLocationType=dlswDirMacLocationType, dlswIfTable=dlswIfTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperState=dlswTConnOperState, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswMIB=dlswMIB, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacEntries=dlswDirMacEntries, dlswNodeVendorID=dlswNodeVendorID, DlcType=DlcType, dlswTCPDomain=dlswTCPDomain, dlswCircuitPriority=dlswCircuitPriority, dlswDomains=dlswDomains, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTraps=dlswTraps, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuit=dlswCircuit, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacLocation=dlswDirMacLocation, dlswDirCompliance=dlswDirCompliance, dlswIfEntry=dlswIfEntry, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirectory=dlswDirectory, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBIndex=dlswDirNBIndex, dlswDirMacMac=dlswDirMacMac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeStatus=dlswNodeStatus, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcCompliance=dlswSdlcCompliance, dlsw=dlsw, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, MacAddressNC=MacAddressNC, dlswTConnTcp=dlswTConnTcp, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitStat=dlswCircuitStat, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitStatCreates=dlswCircuitStatCreates, EndStationLocation=EndStationLocation, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnSpecific=dlswTConnSpecific, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBLocationType=dlswDirNBLocationType, dlswNode=dlswNode, dlswTrapControl=dlswTrapControl, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirCache=dlswDirCache, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswConformance=dlswConformance, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacMask=dlswDirMacMask, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCompliances=dlswCompliances, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswIfRowStatus=dlswIfRowStatus, dlswTConn=dlswTConn, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBLocation=dlswDirNBLocation, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, LFSize=LFSize, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBGroup=dlswDirNBGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitTable=dlswCircuitTable, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswGroups=dlswGroups, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS1Dlc=dlswCircuitS1Dlc, TAddress=TAddress, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirGroup=dlswDirGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirLocate=dlswDirLocate, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts)
