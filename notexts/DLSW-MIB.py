...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocateGroup=dlswDirLocateGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNode=dlswNode, DlcType=DlcType, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlc=dlswSdlc, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirNBName=dlswDirNBName, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirCache=dlswDirCache, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnStatGroup=dlswTConnStatGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnSpecific=dlswTConnSpecific, dlswGroups=dlswGroups, dlswSdlcLsTable=dlswSdlcLsTable, dlswMIB=dlswMIB, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuit=dlswCircuit, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirCompliance=dlswDirCompliance, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeVersionString=dlswNodeVersionString, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, TAddress=TAddress, dlswNodeVersion=dlswNodeVersion, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitPriority=dlswCircuitPriority, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBEntry=dlswDirNBEntry, dlswInterfaceGroup=dlswInterfaceGroup, NBName=NBName, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeVendorID=dlswNodeVendorID, dlswIfSapList=dlswIfSapList, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswConformance=dlswConformance, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocate=dlswDirLocate, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacTable=dlswDirMacTable, dlswDirGroup=dlswDirGroup, dlswDirStat=dlswDirStat, dlswCircuitTable=dlswCircuitTable, dlsw=dlsw, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswNodeStatus=dlswNodeStatus, dlswIfEntry=dlswIfEntry, DlswTCPAddress=DlswTCPAddress, dlswCircuitEntry=dlswCircuitEntry, null=null, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitStat=dlswCircuitStat, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBTable=dlswDirNBTable, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, EndStationLocation=EndStationLocation, dlswTConnStat=dlswTConnStat, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacStatus=dlswDirMacStatus, dlswTCPDomain=dlswTCPDomain, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitState=dlswCircuitState, dlswDirNBEntries=dlswDirNBEntries, MacAddressNC=MacAddressNC, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacEntry=dlswDirMacEntry, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperState=dlswTConnOperState, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTrapControl=dlswTrapControl, dlswCompliances=dlswCompliances, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTraps=dlswTraps, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswInterface=dlswInterface, PYSNMP_MODULE_ID=dlsw, dlswTConnTcp=dlswTConnTcp, dlswDirMacMask=dlswDirMacMask, dlswDirectory=dlswDirectory, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, LFSize=LFSize, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswIfTable=dlswIfTable, dlswDomains=dlswDomains, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacMac=dlswDirMacMac, dlswTConn=dlswTConn, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr)
