...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacMask=dlswDirMacMask, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirGroup=dlswDirGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeGroup=dlswNodeGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcp=dlswTConnTcp, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTraps=dlswTraps, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfSapList=dlswIfSapList, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBEntry=dlswDirNBEntry, dlswNode=dlswNode, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBEntryType=dlswDirNBEntryType, dlswTCPDomain=dlswTCPDomain, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBEntries=dlswDirNBEntries, dlswNodeUpTime=dlswNodeUpTime, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlsw=dlsw, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, PYSNMP_MODULE_ID=dlsw, MacAddressNC=MacAddressNC, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirStat=dlswDirStat, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, LFSize=LFSize, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBName=dlswDirNBName, dlswDirLocateGroup=dlswDirLocateGroup, dlswIfEntry=dlswIfEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCompliances=dlswCompliances, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnStat=dlswTConnStat, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBLocationType=dlswDirNBLocationType, DlswTCPAddress=DlswTCPAddress, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitState=dlswCircuitState, dlswDomains=dlswDomains, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConn=dlswTConn, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacEntries=dlswDirMacEntries, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswGroups=dlswGroups, dlswNodeVendorID=dlswNodeVendorID, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuit=dlswCircuit, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirMacTable=dlswDirMacTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacMac=dlswDirMacMac, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCoreCompliance=dlswCoreCompliance, EndStationLocation=EndStationLocation, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, TAddress=TAddress, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacLocation=dlswDirMacLocation, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBTable=dlswDirNBTable, dlswDirCache=dlswDirCache, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeStatus=dlswNodeStatus, dlswDirLocate=dlswDirLocate, dlswMIB=dlswMIB, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirectory=dlswDirectory, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswInterface=dlswInterface, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitStat=dlswCircuitStat, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, null=null, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitGroup=dlswCircuitGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperState=dlswTConnOperState, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacIndex=dlswDirMacIndex, dlswNodeVersionString=dlswNodeVersionString, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapControl=dlswTrapControl, dlswCircuitTable=dlswCircuitTable, dlswNodeVersion=dlswNodeVersion, NBName=NBName, DlcType=DlcType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswSdlc=dlswSdlc, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswConformance=dlswConformance, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirCompliance=dlswDirCompliance, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswIfTable=dlswIfTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacEntryType=dlswDirMacEntryType)
