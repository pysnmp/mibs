...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswGroups=dlswGroups, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswIfEntry=dlswIfEntry, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCoreCompliance=dlswCoreCompliance, dlswTConnNBGroup=dlswTConnNBGroup, dlswIfTable=dlswIfTable, dlswDirLocateMacTable=dlswDirLocateMacTable, DlcType=DlcType, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacLocationType=dlswDirMacLocationType, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, MacAddressNC=MacAddressNC, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirStat=dlswDirStat, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitGroup=dlswCircuitGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBStatus=dlswDirNBStatus, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocate=dlswDirLocate, dlswIfSapList=dlswIfSapList, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBName=dlswDirNBName, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperState=dlswTConnOperState, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsTable=dlswSdlcLsTable, dlswConformance=dlswConformance, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitEntry=dlswCircuitEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTCPDomain=dlswTCPDomain, dlswDirMacEntryType=dlswDirMacEntryType, dlswNotificationGroup=dlswNotificationGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirCompliance=dlswDirCompliance, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirNBNameType=dlswDirNBNameType, dlswTConnTcp=dlswTConnTcp, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeVersion=dlswNodeVersion, null=null, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTraps=dlswTraps, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirCache=dlswDirCache, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, TAddress=TAddress, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswMIB=dlswMIB, dlswDirGroup=dlswDirGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, EndStationLocation=EndStationLocation, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcCompliance=dlswSdlcCompliance, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDomains=dlswDomains, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlsw=dlsw, dlswSdlc=dlswSdlc, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitTable=dlswCircuitTable, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacLocation=dlswDirMacLocation, dlswNodeGroup=dlswNodeGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacMac=dlswDirMacMac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacMask=dlswDirMacMask, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, DlswTCPAddress=DlswTCPAddress, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuit=dlswCircuit, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitState=dlswCircuitState, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirectory=dlswDirectory, NBName=NBName, dlswDirMacLFSize=dlswDirMacLFSize, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnStatGroup=dlswTConnStatGroup, dlswCompliances=dlswCompliances, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, LFSize=LFSize, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacTable=dlswDirMacTable, dlswInterface=dlswInterface, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitStat=dlswCircuitStat, dlswTrapControl=dlswTrapControl, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, PYSNMP_MODULE_ID=dlsw, dlswDirNBIndex=dlswDirNBIndex, dlswTConn=dlswTConn, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeStatus=dlswNodeStatus, dlswDirNBTable=dlswDirNBTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNode=dlswNode, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitS2Location=dlswCircuitS2Location, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnStat=dlswTConnStat, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperICRexSents=dlswTConnOperICRexSents)
