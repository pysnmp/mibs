...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapControl=dlswTrapControl, dlswTCPDomain=dlswTCPDomain, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirGroup=dlswDirGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeVersionString=dlswNodeVersionString, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswIfSapList=dlswIfSapList, dlswDirNBName=dlswDirNBName, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNodeVendorID=dlswNodeVendorID, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeGroup=dlswNodeGroup, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, TAddress=TAddress, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateMacMatch=dlswDirLocateMacMatch, LFSize=LFSize, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacMac=dlswDirMacMac, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirCache=dlswDirCache, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirNBTable=dlswDirNBTable, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswInterface=dlswInterface, dlswNodeStatus=dlswNodeStatus, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, NBName=NBName, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, DlcType=DlcType, dlswNotificationGroup=dlswNotificationGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLocation=dlswDirNBLocation, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirectory=dlswDirectory, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTraps=dlswTraps, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcGroup=dlswSdlcGroup, dlswTConnStatGroup=dlswTConnStatGroup, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcp=dlswTConnTcp, dlswConformance=dlswConformance, dlswCompliances=dlswCompliances, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBGroup=dlswDirNBGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperState=dlswTConnOperState, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocate=dlswDirLocate, EndStationLocation=EndStationLocation, dlswDirNBLocationType=dlswDirNBLocationType, dlsw=dlsw, dlswTConnStat=dlswTConnStat, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirStat=dlswDirStat, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuit=dlswCircuit, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConn=dlswTConn, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirCompliance=dlswDirCompliance, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswMIB=dlswMIB, dlswIfTable=dlswIfTable, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, PYSNMP_MODULE_ID=dlsw, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateGroup=dlswDirLocateGroup, dlswSdlc=dlswSdlc, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDomains=dlswDomains, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswIfEntry=dlswIfEntry, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperNQexSents=dlswTConnOperNQexSents, null=null, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, MacAddressNC=MacAddressNC, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBEntries=dlswDirNBEntries, dlswNode=dlswNode, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswGroups=dlswGroups, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitTable=dlswCircuitTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBLFSize=dlswDirNBLFSize, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitState=dlswCircuitState, dlswDirNBCacheMisses=dlswDirNBCacheMisses, DlswTCPAddress=DlswTCPAddress, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacTable=dlswDirMacTable, dlswCircuitStat=dlswCircuitStat, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap)
