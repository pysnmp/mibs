...
mibBuilder.exportSymbols("DLSW-MIB", dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperState=dlswTConnOperState, dlswTConn=dlswTConn, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitStateTime=dlswCircuitStateTime, NBName=NBName, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirCache=dlswDirCache, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCompliances=dlswCompliances, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswConformance=dlswConformance, dlswDirGroup=dlswDirGroup, dlswDirMacEntries=dlswDirMacEntries, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirNBName=dlswDirNBName, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitState=dlswCircuitState, dlswDirNBGroup=dlswDirNBGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDomains=dlswDomains, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirLocate=dlswDirLocate, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcp=dlswTConnTcp, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapControl=dlswTrapControl, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeUpTime=dlswNodeUpTime, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitTable=dlswCircuitTable, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacMask=dlswDirMacMask, dlswDirNBTable=dlswDirNBTable, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeVersionString=dlswNodeVersionString, dlswTConnStat=dlswTConnStat, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacMac=dlswDirMacMac, EndStationLocation=EndStationLocation, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswGroups=dlswGroups, dlswIfSapList=dlswIfSapList, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitStat=dlswCircuitStat, dlswInterface=dlswInterface, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlc=dlswSdlc, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBEntryType=dlswDirNBEntryType, dlswTCPDomain=dlswTCPDomain, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigTable=dlswTConnConfigTable, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNode=dlswNode, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirNBLocation=dlswDirNBLocation, dlsw=dlsw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuit=dlswCircuit, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTraps=dlswTraps, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswIfRowStatus=dlswIfRowStatus, dlswNodeGroup=dlswNodeGroup, dlswIfEntry=dlswIfEntry, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirectory=dlswDirectory, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfTable=dlswIfTable, LFSize=LFSize, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeStatus=dlswNodeStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirStat=dlswDirStat, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswInterfaceGroup=dlswInterfaceGroup, TAddress=TAddress, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBEntries=dlswDirNBEntries, dlswDirNBNameType=dlswDirNBNameType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacTable=dlswDirMacTable, dlswDirMacEntry=dlswDirMacEntry, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirCompliance=dlswDirCompliance, DlcType=DlcType, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBLocation=dlswDirLocateNBLocation, PYSNMP_MODULE_ID=dlsw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirMacLocationType=dlswDirMacLocationType, dlswMIB=dlswMIB, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, MacAddressNC=MacAddressNC, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitGroup=dlswCircuitGroup, null=null, DlswTCPAddress=DlswTCPAddress, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock)
