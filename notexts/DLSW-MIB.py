...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacMask=dlswDirMacMask, dlswDirectory=dlswDirectory, dlswDirLocate=dlswDirLocate, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirCompliance=dlswDirCompliance, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, null=null, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnStatGroup=dlswTConnStatGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuit=dlswCircuit, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswIfEntry=dlswIfEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlsw=dlsw, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, LFSize=LFSize, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacTable=dlswDirMacTable, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, TAddress=TAddress, dlswDomains=dlswDomains, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswIfTable=dlswIfTable, dlswIfSapList=dlswIfSapList, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBGroup=dlswDirNBGroup, dlswTConnTcp=dlswTConnTcp, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTCPDomain=dlswTCPDomain, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, NBName=NBName, dlswNodeGroup=dlswNodeGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBNameType=dlswDirNBNameType, dlswMIB=dlswMIB, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, EndStationLocation=EndStationLocation, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitState=dlswCircuitState, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBName=dlswDirNBName, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacEntryType=dlswDirMacEntryType, MacAddressNC=MacAddressNC, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitStat=dlswCircuitStat, dlswDirStat=dlswDirStat, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConn=dlswTConn, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirCache=dlswDirCache, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswInterface=dlswInterface, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCompliances=dlswCompliances, dlswDirNBLocation=dlswDirNBLocation, dlswNode=dlswNode, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperGroup=dlswTConnOperGroup, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTraps=dlswTraps, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswSdlc=dlswSdlc, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperState=dlswTConnOperState, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswGroups=dlswGroups, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirGroup=dlswDirGroup, dlswDirLocateNBName=dlswDirLocateNBName, DlcType=DlcType, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswConformance=dlswConformance, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapControl=dlswTrapControl, dlswDirNBEntry=dlswDirNBEntry, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeStatus=dlswNodeStatus, dlswTConnStat=dlswTConnStat)
