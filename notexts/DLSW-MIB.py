...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBGroup=dlswDirNBGroup, dlswDirNBEntries=dlswDirNBEntries, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeGroup=dlswNodeGroup, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsTable=dlswSdlcLsTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnStat=dlswTConnStat, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTCPDomain=dlswTCPDomain, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBName=dlswDirNBName, dlsw=dlsw, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswMIB=dlswMIB, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, DlswTCPAddress=DlswTCPAddress, dlswDomains=dlswDomains, MacAddressNC=MacAddressNC, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitState=dlswCircuitState, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacEntry=dlswDirMacEntry, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacEntries=dlswDirMacEntries, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, TAddress=TAddress, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacTable=dlswDirMacTable, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConn=dlswTConn, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswIfEntry=dlswIfEntry, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswNode=dlswNode, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitTable=dlswCircuitTable, dlswNodeVersionString=dlswNodeVersionString, dlswDirCompliance=dlswDirCompliance, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, null=null, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlc=dlswSdlc, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirStat=dlswDirStat, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTraps=dlswTraps, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirNBTable=dlswDirNBTable, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, PYSNMP_MODULE_ID=dlsw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacMask=dlswDirMacMask, DlcType=DlcType, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCompliances=dlswCompliances, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswIfTable=dlswIfTable, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuit=dlswCircuit, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirGroup=dlswDirGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacLocationType=dlswDirMacLocationType, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswNodeVendorID=dlswNodeVendorID, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperGroup=dlswTConnOperGroup, EndStationLocation=EndStationLocation, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, LFSize=LFSize, dlswTConnOperState=dlswTConnOperState, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirectory=dlswDirectory, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcp=dlswTConnTcp, dlswGroups=dlswGroups, dlswNodeStatus=dlswNodeStatus, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswInterface=dlswInterface, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacMac=dlswDirMacMac, dlswNodeVersion=dlswNodeVersion, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocate=dlswDirLocate, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeUpTime=dlswNodeUpTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswConformance=dlswConformance, dlswTrapControl=dlswTrapControl, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirCache=dlswDirCache, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitStat=dlswCircuitStat, NBName=NBName, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswIfSapList=dlswIfSapList, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnStatGroup=dlswTConnStatGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac)
