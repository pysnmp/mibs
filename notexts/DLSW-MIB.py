...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTraps=dlswTraps, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, LFSize=LFSize, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, MacAddressNC=MacAddressNC, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperState=dlswTConnOperState, dlswDirNBEntry=dlswDirNBEntry, dlswSdlc=dlswSdlc, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirCache=dlswDirCache, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, TAddress=TAddress, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeStatus=dlswNodeStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirectory=dlswDirectory, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitTable=dlswCircuitTable, dlswCircuitEntry=dlswCircuitEntry, dlswNodeGroup=dlswNodeGroup, NBName=NBName, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirCompliance=dlswDirCompliance, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNode=dlswNode, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConn=dlswTConn, dlswNodeNBGroup=dlswNodeNBGroup, dlswGroups=dlswGroups, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirNBTable=dlswDirNBTable, EndStationLocation=EndStationLocation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlsw=dlsw, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacLocation=dlswDirMacLocation, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBIndex=dlswDirNBIndex, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBEntries=dlswDirNBEntries, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswConformance=dlswConformance, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfEntry=dlswIfEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacEntryType=dlswDirMacEntryType, null=null, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirNBEntryType=dlswDirNBEntryType, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswIfTable=dlswIfTable, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBName=dlswDirNBName, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, PYSNMP_MODULE_ID=dlsw, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperTable=dlswTConnOperTable, DlcType=DlcType, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitState=dlswCircuitState, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNodeVendorID=dlswNodeVendorID, dlswIfSapList=dlswIfSapList, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswInterface=dlswInterface, dlswMIB=dlswMIB, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacTable=dlswDirMacTable, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDomains=dlswDomains, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcp=dlswTConnTcp, dlswNodeVersion=dlswNodeVersion, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnStat=dlswTConnStat, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirStat=dlswDirStat, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeVersionString=dlswNodeVersionString, dlswTrapControl=dlswTrapControl, dlswCircuitStat=dlswCircuitStat, dlswCompliances=dlswCompliances, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTCPDomain=dlswTCPDomain, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuit=dlswCircuit, dlswSdlcLsTable=dlswSdlcLsTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirGroup=dlswDirGroup, dlswDirLocate=dlswDirLocate, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitS1Dlc=dlswCircuitS1Dlc)
