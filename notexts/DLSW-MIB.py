...
mibBuilder.exportSymbols("DLSW-MIB", dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswInterface=dlswInterface, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirGroup=dlswDirGroup, dlswCircuitPriority=dlswCircuitPriority, dlswNodeStatus=dlswNodeStatus, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlc=dlswSdlc, PYSNMP_MODULE_ID=dlsw, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeVersionString=dlswNodeVersionString, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswIfEntry=dlswIfEntry, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacTable=dlswDirMacTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, DlswTCPAddress=DlswTCPAddress, NBName=NBName, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDomains=dlswDomains, dlswCircuitStat=dlswCircuitStat, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBIndex=dlswDirNBIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNodeUpTime=dlswNodeUpTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcp=dlswTConnTcp, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperState=dlswTConnOperState, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNode=dlswNode, dlswIfTable=dlswIfTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntryType=dlswDirNBEntryType, TAddress=TAddress, MacAddressNC=MacAddressNC, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBTable=dlswDirNBTable, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswConformance=dlswConformance, dlswTConnStat=dlswTConnStat, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCompliances=dlswCompliances, dlswNotificationGroup=dlswNotificationGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocate=dlswDirLocate, dlswDirLocateCompliance=dlswDirLocateCompliance, LFSize=LFSize, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirStat=dlswDirStat, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirNBName=dlswDirNBName, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTraps=dlswTraps, EndStationLocation=EndStationLocation, dlswCircuit=dlswCircuit, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitState=dlswCircuitState, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswMIB=dlswMIB, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateGroup=dlswDirLocateGroup, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirCache=dlswDirCache, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, DlcType=DlcType, dlswDirMacMac=dlswDirMacMac, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirMacMask=dlswDirMacMask, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperTable=dlswTConnOperTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConn=dlswTConn, dlswDirCompliance=dlswDirCompliance, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBStatus=dlswDirNBStatus, dlswTrapControl=dlswTrapControl, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirectory=dlswDirectory, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTCPDomain=dlswTCPDomain, dlswTConnTcpOperTable=dlswTConnTcpOperTable, null=null, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnDown=dlswTrapTConnDown, dlsw=dlsw, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswGroups=dlswGroups, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswIfRowStatus=dlswIfRowStatus, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfSapList=dlswIfSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl)
