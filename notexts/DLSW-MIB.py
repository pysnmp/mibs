...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeVersion=dlswNodeVersion, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswIfTable=dlswIfTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswGroups=dlswGroups, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, MacAddressNC=MacAddressNC, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnStatGroup=dlswTConnStatGroup, dlswCompliances=dlswCompliances, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTCPDomain=dlswTCPDomain, dlswNodeNBGroup=dlswNodeNBGroup, NBName=NBName, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnSpecific=dlswTConnSpecific, DlswTCPAddress=DlswTCPAddress, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirectory=dlswDirectory, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacEntry=dlswDirMacEntry, dlswConformance=dlswConformance, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCoreCompliance=dlswCoreCompliance, dlswInterfaceGroup=dlswInterfaceGroup, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperState=dlswTConnOperState, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitState=dlswCircuitState, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswIfSapList=dlswIfSapList, dlswIfRowStatus=dlswIfRowStatus, dlswSdlc=dlswSdlc, dlswSdlcCompliance=dlswSdlcCompliance, dlswDomains=dlswDomains, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirCompliance=dlswDirCompliance, DlcType=DlcType, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocate=dlswDirLocate, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBName=dlswDirNBName, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBIndex=dlswDirNBIndex, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuit=dlswCircuit, dlswIfEntry=dlswIfEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeGroup=dlswNodeGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswMIB=dlswMIB, dlswInterface=dlswInterface, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNotificationGroup=dlswNotificationGroup, PYSNMP_MODULE_ID=dlsw, dlswCircuitStat=dlswCircuitStat, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, EndStationLocation=EndStationLocation, TAddress=TAddress, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirCache=dlswDirCache, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, null=null, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlsw=dlsw, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirStat=dlswDirStat, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacMac=dlswDirMacMac, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacMask=dlswDirMacMask, dlswTrapControl=dlswTrapControl, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirNBGroup=dlswDirNBGroup, LFSize=LFSize, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConn=dlswTConn, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcp=dlswTConnTcp, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnStat=dlswTConnStat, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswNode=dlswNode, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitTable=dlswCircuitTable, dlswTraps=dlswTraps, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBNameType=dlswDirNBNameType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBTable=dlswDirNBTable, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswNodeUpTime=dlswNodeUpTime, dlswDirGroup=dlswDirGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacTable=dlswDirMacTable, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateNBName=dlswDirLocateNBName, dlswNodeVersionString=dlswNodeVersionString)
