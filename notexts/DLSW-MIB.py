...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocate=dlswDirLocate, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnStat=dlswTConnStat, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuit=dlswCircuit, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS2Location=dlswCircuitS2Location, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigIndex=dlswTConnConfigIndex, LFSize=LFSize, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperState=dlswTConnOperState, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitOrigin=dlswCircuitOrigin, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlsw=dlsw, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswInterface=dlswInterface, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, EndStationLocation=EndStationLocation, dlswTConnStatGroup=dlswTConnStatGroup, null=null, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNodeVersion=dlswNodeVersion, dlswDirNBStatus=dlswDirNBStatus, dlswDirectory=dlswDirectory, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNodeStatus=dlswNodeStatus, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNodeGroup=dlswNodeGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitEntry=dlswCircuitEntry, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitState=dlswCircuitState, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDomains=dlswDomains, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTrapCntlTConn=dlswTrapCntlTConn, PYSNMP_MODULE_ID=dlsw, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirGroup=dlswDirGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirStat=dlswDirStat, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitTable=dlswCircuitTable, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBEntries=dlswDirNBEntries, dlswConformance=dlswConformance, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswSdlc=dlswSdlc, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfSapList=dlswIfSapList, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBIndex=dlswDirNBIndex, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTraps=dlswTraps, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCompliances=dlswCompliances, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirCompliance=dlswDirCompliance, dlswTConn=dlswTConn, dlswNotificationGroup=dlswNotificationGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswGroups=dlswGroups, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfTable=dlswIfTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, DlcType=DlcType, dlswDirCache=dlswDirCache, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitStat=dlswCircuitStat, dlswTrapControl=dlswTrapControl, dlswDirMacMask=dlswDirMacMask, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacTable=dlswDirMacTable, dlswDirNBName=dlswDirNBName, dlswTCPDomain=dlswTCPDomain, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitS2TAddress=dlswCircuitS2TAddress, MacAddressNC=MacAddressNC, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacMac=dlswDirMacMac, dlswDirMacEntryType=dlswDirMacEntryType, dlswIfEntry=dlswIfEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, NBName=NBName, dlswNode=dlswNode, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcp=dlswTConnTcp, dlswDirNBTable=dlswDirNBTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, TAddress=TAddress, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnNBGroup=dlswTConnNBGroup, dlswMIB=dlswMIB, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigEntryType=dlswTConnConfigEntryType)
