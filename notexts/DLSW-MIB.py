...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, NBName=NBName, dlswTCPDomain=dlswTCPDomain, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConn=dlswTConn, dlswTConnConfigEntry=dlswTConnConfigEntry, EndStationLocation=EndStationLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnTcp=dlswTConnTcp, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocateNBGroup=dlswDirLocateNBGroup, DlswTCPAddress=DlswTCPAddress, dlswNodeStatus=dlswNodeStatus, dlswTrapControl=dlswTrapControl, dlswTConnConfigIndex=dlswTConnConfigIndex, dlsw=dlsw, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswIfTable=dlswIfTable, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswIfEntry=dlswIfEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBLocation=dlswDirNBLocation, dlswDirGroup=dlswDirGroup, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirCache=dlswDirCache, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, null=null, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacEntry=dlswDirMacEntry, dlswNode=dlswNode, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, TAddress=TAddress, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirCompliance=dlswDirCompliance, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCompliances=dlswCompliances, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlc=dlswSdlc, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswMIB=dlswMIB, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperState=dlswTConnOperState, dlswIfRowStatus=dlswIfRowStatus, dlswDirStat=dlswDirStat, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswInterface=dlswInterface, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitStatActives=dlswCircuitStatActives, dlswNodeGroup=dlswNodeGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeNBGroup=dlswNodeNBGroup, PYSNMP_MODULE_ID=dlsw, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitPriority=dlswCircuitPriority, dlswTraps=dlswTraps, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirNBGroup=dlswDirNBGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBIndex=dlswDirNBIndex, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, MacAddressNC=MacAddressNC, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitTable=dlswCircuitTable, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirNBStatus=dlswDirNBStatus, dlswDirNBName=dlswDirNBName, dlswTrapTConnUp=dlswTrapTConnUp, dlswGroups=dlswGroups, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacMac=dlswDirMacMac, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, DlcType=DlcType, dlswDirectory=dlswDirectory, dlswConformance=dlswConformance, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDomains=dlswDomains, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswSdlcGroup=dlswSdlcGroup, dlswNodeVersion=dlswNodeVersion, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBEntry=dlswDirNBEntry, dlswCircuit=dlswCircuit, dlswTConnStat=dlswTConnStat, dlswDirLocate=dlswDirLocate, dlswCircuitStat=dlswCircuitStat, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigTable=dlswTConnConfigTable, dlswIfSapList=dlswIfSapList, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitState=dlswCircuitState, LFSize=LFSize, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacMask=dlswDirMacMask, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo)
