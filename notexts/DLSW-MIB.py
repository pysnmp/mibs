...
mibBuilder.exportSymbols("DLSW-MIB", dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirGroup=dlswDirGroup, TAddress=TAddress, MacAddressNC=MacAddressNC, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConn=dlswTConn, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitEntry=dlswCircuitEntry, dlswDirCompliance=dlswDirCompliance, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitPriority=dlswCircuitPriority, dlswCompliances=dlswCompliances, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacEntry=dlswDirMacEntry, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBEntries=dlswDirNBEntries, dlswConformance=dlswConformance, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTCPDomain=dlswTCPDomain, dlswIfSapList=dlswIfSapList, DlswTCPAddress=DlswTCPAddress, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNode=dlswNode, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswIfTable=dlswIfTable, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswSdlc=dlswSdlc, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswMIB=dlswMIB, dlswInterface=dlswInterface, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirCache=dlswDirCache, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitState=dlswCircuitState, dlswTrapControl=dlswTrapControl, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacTable=dlswDirMacTable, dlswTConnOperState=dlswTConnOperState, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuit=dlswCircuit, NBName=NBName, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTraps=dlswTraps, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBLocation=dlswDirNBLocation, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnSpecific=dlswTConnSpecific, dlswDomains=dlswDomains, dlsw=dlsw, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, LFSize=LFSize, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirectory=dlswDirectory, dlswDirLocate=dlswDirLocate, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswNodeStatus=dlswNodeStatus, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBName=dlswDirNBName, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, PYSNMP_MODULE_ID=dlsw, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfEntry=dlswIfEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswGroups=dlswGroups, dlswCircuitStat=dlswCircuitStat, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnStat=dlswTConnStat, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeVersionString=dlswNodeVersionString, dlswDirStat=dlswDirStat, dlswSdlcGroup=dlswSdlcGroup, dlswNodeGroup=dlswNodeGroup, null=null, dlswDirLocateMacTable=dlswDirLocateMacTable, DlcType=DlcType, dlswDirNBIndex=dlswDirNBIndex, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBGroup=dlswDirNBGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswNodeVersion=dlswNodeVersion, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, EndStationLocation=EndStationLocation, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacMask=dlswDirMacMask, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcp=dlswTConnTcp, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys)
