...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeVersionString=dlswNodeVersionString, dlswDirCache=dlswDirCache, dlswDirLocateNBName=dlswDirLocateNBName, dlswIfTable=dlswIfTable, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeGroup=dlswNodeGroup, DlswTCPAddress=DlswTCPAddress, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswInterface=dlswInterface, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, MacAddressNC=MacAddressNC, dlswTConnStat=dlswTConnStat, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuit=dlswCircuit, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirCompliance=dlswDirCompliance, dlsw=dlsw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBLFSize=dlswDirNBLFSize, dlswNode=dlswNode, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapControl=dlswTrapControl, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirectory=dlswDirectory, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitStat=dlswCircuitStat, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacMask=dlswDirMacMask, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBTable=dlswDirNBTable, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirNBNameType=dlswDirNBNameType, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirStat=dlswDirStat, dlswDirMacEntryType=dlswDirMacEntryType, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacEntries=dlswDirMacEntries, dlswTraps=dlswTraps, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswSdlcCompliance=dlswSdlcCompliance, LFSize=LFSize, dlswDirNBIndex=dlswDirNBIndex, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlc=dlswSdlc, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS1Sap=dlswCircuitS1Sap, EndStationLocation=EndStationLocation, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, PYSNMP_MODULE_ID=dlsw, dlswDomains=dlswDomains, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacTable=dlswDirMacTable, TAddress=TAddress, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitPriority=dlswCircuitPriority, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacLocation=dlswDirMacLocation, dlswIfEntry=dlswIfEntry, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacMac=dlswDirMacMac, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswGroups=dlswGroups, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperState=dlswTConnOperState, NBName=NBName, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitTable=dlswCircuitTable, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswConformance=dlswConformance, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperEntry=dlswTConnOperEntry, dlswCompliances=dlswCompliances, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, null=null, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeVersion=dlswNodeVersion, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswMIB=dlswMIB, dlswNodeStatus=dlswNodeStatus, dlswDirMacEntry=dlswDirMacEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, DlcType=DlcType, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConn=dlswTConn, dlswTConnTcp=dlswTConnTcp, dlswDirLocate=dlswDirLocate, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitState=dlswCircuitState, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBName=dlswDirNBName, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo)
