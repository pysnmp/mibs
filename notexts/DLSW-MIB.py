...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacTable=dlswDirMacTable, dlswNodeStatus=dlswNodeStatus, dlswIfRowStatus=dlswIfRowStatus, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirCache=dlswDirCache, dlswDirNBName=dlswDirNBName, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitState=dlswCircuitState, dlswDirMacMask=dlswDirMacMask, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, NBName=NBName, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswSdlcCompliance=dlswSdlcCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTCPDomain=dlswTCPDomain, dlswNodeNBGroup=dlswNodeNBGroup, dlswDomains=dlswDomains, dlswSdlc=dlswSdlc, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCompliances=dlswCompliances, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTrapControl=dlswTrapControl, dlswIfTable=dlswIfTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConn=dlswTConn, dlswCircuitStatGroup=dlswCircuitStatGroup, MacAddressNC=MacAddressNC, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitEntry=dlswCircuitEntry, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, PYSNMP_MODULE_ID=dlsw, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitStat=dlswCircuitStat, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBStatus=dlswDirNBStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacLFSize=dlswDirMacLFSize, TAddress=TAddress, dlswCircuit=dlswCircuit, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNodeGroup=dlswNodeGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, DlswTCPAddress=DlswTCPAddress, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswConformance=dlswConformance, dlswTConnOperState=dlswTConnOperState, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirectory=dlswDirectory, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperCURexSents=dlswTConnOperCURexSents, DlcType=DlcType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBEntry=dlswDirNBEntry, dlswDirGroup=dlswDirGroup, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnSpecific=dlswTConnSpecific, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNode=dlswNode, dlswDirNBEntries=dlswDirNBEntries, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcp=dlswTConnTcp, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBNameType=dlswDirNBNameType, dlswTrapTConnDown=dlswTrapTConnDown, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirMacMac=dlswDirMacMac, dlswMIB=dlswMIB, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeVersion=dlswNodeVersion, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBTable=dlswDirNBTable, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacEntry=dlswDirMacEntry, null=null, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnStat=dlswTConnStat, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNotificationGroup=dlswNotificationGroup, dlswInterface=dlswInterface, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfSapList=dlswIfSapList, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, EndStationLocation=EndStationLocation, dlswDirMacEntries=dlswDirMacEntries, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswGroups=dlswGroups, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirStat=dlswDirStat, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirCompliance=dlswDirCompliance, dlswCircuitS2Mac=dlswCircuitS2Mac, LFSize=LFSize, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTraps=dlswTraps, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswNodeUpTime=dlswNodeUpTime, dlswDirLocate=dlswDirLocate, dlsw=dlsw, dlswCircuitStatCreates=dlswCircuitStatCreates)
