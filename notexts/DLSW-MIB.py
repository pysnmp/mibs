...
mibBuilder.exportSymbols("DLSW-MIB", dlsw=dlsw, dlswDirNBStatus=dlswDirNBStatus, NBName=NBName, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigEntry=dlswTConnConfigEntry, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsTable=dlswSdlcLsTable, LFSize=LFSize, DlcType=DlcType, dlswDirLocateNBName=dlswDirLocateNBName, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBName=dlswDirNBName, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigTable=dlswTConnConfigTable, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirCache=dlswDirCache, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswGroups=dlswGroups, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswIfTable=dlswIfTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTraps=dlswTraps, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNode=dlswNode, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnStat=dlswTConnStat, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateMacTable=dlswDirLocateMacTable, TAddress=TAddress, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitState=dlswCircuitState, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacMac=dlswDirMacMac, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperGroup=dlswTConnOperGroup, null=null, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlc=dlswSdlc, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitEntry=dlswCircuitEntry, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDomains=dlswDomains, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitStat=dlswCircuitStat, dlswDirMacTable=dlswDirMacTable, dlswConformance=dlswConformance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBMatch=dlswDirLocateNBMatch, EndStationLocation=EndStationLocation, dlswMIB=dlswMIB, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCompliances=dlswCompliances, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirectory=dlswDirectory, dlswDirMacLocationType=dlswDirMacLocationType, dlswInterface=dlswInterface, dlswTCPDomain=dlswTCPDomain, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapControl=dlswTrapControl, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacMask=dlswDirMacMask, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswNodeGroup=dlswNodeGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswIfSapList=dlswIfSapList, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBEntries=dlswDirNBEntries, dlswDirStat=dlswDirStat, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirNBTable=dlswDirNBTable, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeStatus=dlswNodeStatus, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocate=dlswDirLocate, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperState=dlswTConnOperState, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirCompliance=dlswDirCompliance, dlswTConn=dlswTConn, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswIfEntry=dlswIfEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswNodeVendorID=dlswNodeVendorID, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitTable=dlswCircuitTable, MacAddressNC=MacAddressNC, dlswCircuit=dlswCircuit, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections)
