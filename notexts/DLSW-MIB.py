...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnConfigEntry=dlswTConnConfigEntry, MacAddressNC=MacAddressNC, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConn=dlswTConn, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStatCreates=dlswCircuitStatCreates, dlsw=dlsw, dlswDirMacMac=dlswDirMacMac, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswConformance=dlswConformance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapControl=dlswTrapControl, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBName=dlswDirNBName, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswGroups=dlswGroups, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBGroup=dlswDirNBGroup, dlswNodeVersionString=dlswNodeVersionString, dlswSdlc=dlswSdlc, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcGroup=dlswSdlcGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDomains=dlswDomains, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacTable=dlswDirMacTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswNodeStatus=dlswNodeStatus, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacIndex=dlswDirMacIndex, dlswMIB=dlswMIB, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswIfTable=dlswIfTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnStat=dlswTConnStat, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperEntry=dlswTConnOperEntry, dlswInterface=dlswInterface, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirStat=dlswDirStat, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperState=dlswTConnOperState, dlswIfEntry=dlswIfEntry, dlswDirectory=dlswDirectory, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBLocation=dlswDirNBLocation, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitStatGroup=dlswCircuitStatGroup, PYSNMP_MODULE_ID=dlsw, dlswDirLocateMacTable=dlswDirLocateMacTable, DlswTCPAddress=DlswTCPAddress, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocate=dlswDirLocate, dlswCompliances=dlswCompliances, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, TAddress=TAddress, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeGroup=dlswNodeGroup, NBName=NBName, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuit=dlswCircuit, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBTable=dlswDirNBTable, DlcType=DlcType, dlswNodeVendorID=dlswNodeVendorID, dlswTConnTcp=dlswTConnTcp, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitState=dlswCircuitState, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS2Location=dlswCircuitS2Location, LFSize=LFSize, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitTable=dlswCircuitTable, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitEntry=dlswCircuitEntry, dlswCoreCompliance=dlswCoreCompliance, dlswTraps=dlswTraps, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigSapList=dlswTConnConfigSapList, EndStationLocation=EndStationLocation, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirCompliance=dlswDirCompliance, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNode=dlswNode, dlswIfSapList=dlswIfSapList, dlswTCPDomain=dlswTCPDomain, dlswDirCache=dlswDirCache, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitStat=dlswCircuitStat, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswIfRowStatus=dlswIfRowStatus, null=null, dlswTConnSpecific=dlswTConnSpecific)
