...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapControl=dlswTrapControl, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswInterface=dlswInterface, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeUpTime=dlswNodeUpTime, dlswDirCompliance=dlswDirCompliance, dlswTCPDomain=dlswTCPDomain, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDomains=dlswDomains, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirCache=dlswDirCache, dlswTConnTcp=dlswTConnTcp, dlswCircuitTable=dlswCircuitTable, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperCircuits=dlswTConnOperCircuits, EndStationLocation=EndStationLocation, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBEntryType=dlswDirNBEntryType, null=null, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnStat=dlswTConnStat, TAddress=TAddress, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswInterfaceGroup=dlswInterfaceGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConn=dlswTConn, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswIfSapList=dlswIfSapList, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacTable=dlswDirMacTable, dlswDirMacIndex=dlswDirMacIndex, dlsw=dlsw, dlswNodeGroup=dlswNodeGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswNode=dlswNode, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitEntry=dlswCircuitEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirStat=dlswDirStat, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswIfTable=dlswIfTable, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirectory=dlswDirectory, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBName=dlswDirNBName, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNodeVersionString=dlswNodeVersionString, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperGroup=dlswTConnOperGroup, dlswConformance=dlswConformance, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperState=dlswTConnOperState, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNotificationGroup=dlswNotificationGroup, dlswGroups=dlswGroups, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacMac=dlswDirMacMac, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBEntry=dlswDirNBEntry, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitStat=dlswCircuitStat, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnSpecific=dlswTConnSpecific, dlswSdlc=dlswSdlc, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitState=dlswCircuitState, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfRowStatus=dlswIfRowStatus, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuit=dlswCircuit, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitGroup=dlswCircuitGroup, NBName=NBName, DlswTCPAddress=DlswTCPAddress, dlswDirLocate=dlswDirLocate, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBTable=dlswDirNBTable, dlswDirMacStatus=dlswDirMacStatus, dlswTraps=dlswTraps, dlswNodeStatus=dlswNodeStatus, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, LFSize=LFSize, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswMIB=dlswMIB, dlswTConnConfigOpens=dlswTConnConfigOpens, DlcType=DlcType, dlswNodeNBGroup=dlswNodeNBGroup, MacAddressNC=MacAddressNC, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirGroup=dlswDirGroup, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeVersion=dlswNodeVersion, dlswTConnOperNRexSents=dlswTConnOperNRexSents, PYSNMP_MODULE_ID=dlsw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswIfEntry=dlswIfEntry, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCompliances=dlswCompliances, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBRowStatus=dlswDirNBRowStatus)
