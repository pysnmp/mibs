...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacMac=dlswDirMacMac, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacIndex=dlswDirMacIndex, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirGroup=dlswDirGroup, null=null, MacAddressNC=MacAddressNC, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacStatus=dlswDirMacStatus, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBName=dlswDirNBName, dlswTraps=dlswTraps, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacMask=dlswDirMacMask, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitStatActives=dlswCircuitStatActives, dlswInterface=dlswInterface, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswNodeVersion=dlswNodeVersion, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitState=dlswCircuitState, dlswNodeGroup=dlswNodeGroup, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnStat=dlswTConnStat, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBIndex=dlswDirNBIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswIfRowStatus=dlswIfRowStatus, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDomains=dlswDomains, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBNameType=dlswDirNBNameType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperNRexSents=dlswTConnOperNRexSents, TAddress=TAddress, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswNodeVersionString=dlswNodeVersionString, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcp=dlswTConnTcp, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, LFSize=LFSize, dlswIfTable=dlswIfTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswNodeStatus=dlswNodeStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirCache=dlswDirCache, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperState=dlswTConnOperState, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirLocate=dlswDirLocate, dlswDirectory=dlswDirectory, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, EndStationLocation=EndStationLocation, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswConformance=dlswConformance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswGroups=dlswGroups, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlsw=dlsw, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitTable=dlswCircuitTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswMIB=dlswMIB, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, NBName=NBName, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTCPDomain=dlswTCPDomain, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitStatCreates=dlswCircuitStatCreates, DlcType=DlcType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConn=dlswTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, PYSNMP_MODULE_ID=dlsw, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCompliances=dlswCompliances, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNode=dlswNode, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTrapControl=dlswTrapControl, DlswTCPAddress=DlswTCPAddress, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirStat=dlswDirStat, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuit=dlswCircuit, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitStat=dlswCircuitStat, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirCompliance=dlswDirCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBEntry=dlswDirNBEntry, dlswIfEntry=dlswIfEntry, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlc=dlswSdlc, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections)
