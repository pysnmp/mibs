...
mibBuilder.exportSymbols("DLSW-MIB", dlswTCPDomain=dlswTCPDomain, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeGroup=dlswNodeGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswIfEntry=dlswIfEntry, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, MacAddressNC=MacAddressNC, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswInterfaceGroup=dlswInterfaceGroup, dlsw=dlsw, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBGroup=dlswDirNBGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnStat=dlswTConnStat, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacLFSize=dlswDirMacLFSize, NBName=NBName, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswGroups=dlswGroups, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTraps=dlswTraps, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapControl=dlswTrapControl, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBEntryType=dlswDirNBEntryType, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocate=dlswDirLocate, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, LFSize=LFSize, dlswSdlcCompliance=dlswSdlcCompliance, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNode=dlswNode, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirNBTable=dlswDirNBTable, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacStatus=dlswDirMacStatus, dlswInterface=dlswInterface, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswSdlc=dlswSdlc, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBName=dlswDirNBName, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitEntry=dlswCircuitEntry, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfSapList=dlswIfSapList, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBStatus=dlswDirNBStatus, dlswTConn=dlswTConn, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCompliances=dlswCompliances, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirCache=dlswDirCache, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDomains=dlswDomains, dlswCircuit=dlswCircuit, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitState=dlswCircuitState, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBEntries=dlswDirNBEntries, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswNodeStatus=dlswNodeStatus, dlswTConnOperState=dlswTConnOperState, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacTable=dlswDirMacTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, TAddress=TAddress, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitStat=dlswCircuitStat, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcp=dlswTConnTcp, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswMIB=dlswMIB, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnNBGroup=dlswTConnNBGroup, PYSNMP_MODULE_ID=dlsw, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, EndStationLocation=EndStationLocation, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswIfTable=dlswIfTable, dlswDirectory=dlswDirectory, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirStat=dlswDirStat, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirCompliance=dlswDirCompliance, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacMask=dlswDirMacMask, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, DlswTCPAddress=DlswTCPAddress, null=null, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswConformance=dlswConformance, DlcType=DlcType)
