...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBGroup=dlswDirNBGroup, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswGroups=dlswGroups, dlswInterface=dlswInterface, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnStat=dlswTConnStat, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacTable=dlswDirMacTable, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTraps=dlswTraps, DlcType=DlcType, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacEntries=dlswDirMacEntries, dlswIfTable=dlswIfTable, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTrapControl=dlswTrapControl, dlswDirCompliance=dlswDirCompliance, dlswDirLocateNBName=dlswDirLocateNBName, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeGroup=dlswNodeGroup, dlswIfRowStatus=dlswIfRowStatus, MacAddressNC=MacAddressNC, dlswDomains=dlswDomains, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, EndStationLocation=EndStationLocation, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswSdlc=dlswSdlc, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswIfSapList=dlswIfSapList, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCompliances=dlswCompliances, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeUpTime=dlswNodeUpTime, dlswDirGroup=dlswDirGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitState=dlswCircuitState, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperState=dlswTConnOperState, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirStat=dlswDirStat, dlswNodeVersion=dlswNodeVersion, dlswNodeVendorID=dlswNodeVendorID, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswConformance=dlswConformance, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBEntryType=dlswDirNBEntryType, NBName=NBName, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitGroup=dlswCircuitGroup, dlswDirectory=dlswDirectory, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConn=dlswTConn, dlsw=dlsw, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocateNBLocation=dlswDirLocateNBLocation, PYSNMP_MODULE_ID=dlsw, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBName=dlswDirNBName, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswNodeVersionString=dlswNodeVersionString, dlswMIB=dlswMIB, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBStatus=dlswDirNBStatus, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirCache=dlswDirCache, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTrapTConnDown=dlswTrapTConnDown, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitTable=dlswCircuitTable, LFSize=LFSize, DlswTCPAddress=DlswTCPAddress, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcp=dlswTConnTcp, dlswNotificationGroup=dlswNotificationGroup, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocate=dlswDirLocate, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitEntry=dlswCircuitEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitStat=dlswCircuitStat, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuit=dlswCircuit, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBTable=dlswDirNBTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBIndex=dlswDirNBIndex, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswIfEntry=dlswIfEntry, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNode=dlswNode, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateMacMac=dlswDirLocateMacMac, null=null, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeStatus=dlswNodeStatus, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirMacMask=dlswDirMacMask, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBEntry=dlswDirNBEntry, TAddress=TAddress, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr)
