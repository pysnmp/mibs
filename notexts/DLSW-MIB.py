...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTCPDomain=dlswTCPDomain, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStat=dlswTConnStat, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBLocationType=dlswDirNBLocationType, dlswIfEntry=dlswIfEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuit=dlswCircuit, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitStatGroup=dlswCircuitStatGroup, DlswTCPAddress=DlswTCPAddress, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBName=dlswDirLocateNBName, dlswInterface=dlswInterface, dlswCompliances=dlswCompliances, dlswDirMacMac=dlswDirMacMac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirGroup=dlswDirGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapControl=dlswTrapControl, dlswCircuitTable=dlswCircuitTable, dlswTConn=dlswTConn, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirCache=dlswDirCache, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirCompliance=dlswDirCompliance, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, EndStationLocation=EndStationLocation, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswIfSapList=dlswIfSapList, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirStat=dlswDirStat, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, DlcType=DlcType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswSdlc=dlswSdlc, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlsw=dlsw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperNRexSents=dlswTConnOperNRexSents, null=null, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswNotificationGroup=dlswNotificationGroup, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperNQexSents=dlswTConnOperNQexSents, TAddress=TAddress, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswMIB=dlswMIB, dlswTConnTcp=dlswTConnTcp, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirectory=dlswDirectory, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswNodeGroup=dlswNodeGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, MacAddressNC=MacAddressNC, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswIfTable=dlswIfTable, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBTable=dlswDirNBTable, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBGroup=dlswDirNBGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitState=dlswCircuitState, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNode=dlswNode, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, LFSize=LFSize, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBName=dlswDirNBName, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlcLsTable=dlswSdlcLsTable, dlswConformance=dlswConformance, dlswDomains=dlswDomains, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTraps=dlswTraps, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCoreCompliance=dlswCoreCompliance, PYSNMP_MODULE_ID=dlsw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperState=dlswTConnOperState, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeStatus=dlswNodeStatus, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirLocate=dlswDirLocate, dlswDirMacEntries=dlswDirMacEntries, dlswGroups=dlswGroups, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, NBName=NBName, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitStat=dlswCircuitStat)
