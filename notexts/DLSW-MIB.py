...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBEntries=dlswDirNBEntries, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBTable=dlswDirNBTable, dlswTraps=dlswTraps, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, EndStationLocation=EndStationLocation, dlswSdlc=dlswSdlc, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnTcp=dlswTConnTcp, dlswMIB=dlswMIB, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCoreCompliance=dlswCoreCompliance, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlsw=dlsw, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTrapControl=dlswTrapControl, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapCircuitUp=dlswTrapCircuitUp, NBName=NBName, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCompliances=dlswCompliances, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfRowStatus=dlswIfRowStatus, DlswTCPAddress=DlswTCPAddress, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitStat=dlswCircuitStat, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, MacAddressNC=MacAddressNC, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswIfEntry=dlswIfEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirectory=dlswDirectory, dlswNodeStatus=dlswNodeStatus, dlswGroups=dlswGroups, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBName=dlswDirNBName, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, LFSize=LFSize, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitState=dlswCircuitState, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswIfSapList=dlswIfSapList, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocate=dlswDirLocate, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuit=dlswCircuit, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperGroup=dlswTConnOperGroup, null=null, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacMask=dlswDirMacMask, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitTable=dlswCircuitTable, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitPriority=dlswCircuitPriority, TAddress=TAddress, dlswTConnConfigTable=dlswTConnConfigTable, dlswIfTable=dlswIfTable, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperState=dlswTConnOperState, dlswDirMacTable=dlswDirMacTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperTable=dlswTConnOperTable, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswConformance=dlswConformance, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNotificationGroup=dlswNotificationGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirGroup=dlswDirGroup, dlswDomains=dlswDomains, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBLFSize=dlswDirNBLFSize, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNode=dlswNode, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirNBIndex=dlswDirNBIndex, dlswDirCache=dlswDirCache, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirStat=dlswDirStat, dlswTConn=dlswTConn, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, DlcType=DlcType, dlswNodeVersion=dlswNodeVersion, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnStat=dlswTConnStat, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnSpecific=dlswTConnSpecific, dlswInterface=dlswInterface, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitEntry=dlswCircuitEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirCompliance=dlswDirCompliance, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, PYSNMP_MODULE_ID=dlsw, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeGroup=dlswNodeGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitS2TAddress=dlswCircuitS2TAddress)
