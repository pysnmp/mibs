...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirNBLocationType=dlswDirNBLocationType, null=null, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocate=dlswDirLocate, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswMIB=dlswMIB, dlswTCPDomain=dlswTCPDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswSdlcGroup=dlswSdlcGroup, dlswDirCache=dlswDirCache, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnTcp=dlswTConnTcp, dlswNodeVersionString=dlswNodeVersionString, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirectory=dlswDirectory, PYSNMP_MODULE_ID=dlsw, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStat=dlswTConnStat, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapTConnUp=dlswTrapTConnUp, dlswIfEntry=dlswIfEntry, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlc=dlswSdlc, dlswIfTable=dlswIfTable, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirStat=dlswDirStat, dlswCircuitState=dlswCircuitState, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, NBName=NBName, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswIfSapList=dlswIfSapList, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCompliances=dlswCompliances, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswGroups=dlswGroups, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBIndex=dlswDirNBIndex, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlsw=dlsw, dlswInterface=dlswInterface, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitTable=dlswCircuitTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDomains=dlswDomains, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateMacLocation=dlswDirLocateMacLocation, DlswTCPAddress=DlswTCPAddress, dlswCircuitStat=dlswCircuitStat, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNode=dlswNode, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, LFSize=LFSize, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirCompliance=dlswDirCompliance, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirNBTable=dlswDirNBTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperState=dlswTConnOperState, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswNodeStatus=dlswNodeStatus, dlswDirNBName=dlswDirNBName, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacTable=dlswDirMacTable, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirGroup=dlswDirGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuit=dlswCircuit, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeVersion=dlswNodeVersion, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeGroup=dlswNodeGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswConformance=dlswConformance, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTraps=dlswTraps, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, TAddress=TAddress, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitS2Mac=dlswCircuitS2Mac, EndStationLocation=EndStationLocation, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, DlcType=DlcType, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapControl=dlswTrapControl, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, MacAddressNC=MacAddressNC, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConn=dlswTConn, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacMac=dlswDirMacMac)
