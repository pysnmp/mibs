...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, LFSize=LFSize, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirCompliance=dlswDirCompliance, dlswDirCache=dlswDirCache, dlswTConnStat=dlswTConnStat, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirMacStatus=dlswDirMacStatus, null=null, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacMask=dlswDirMacMask, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTrapTConnDown=dlswTrapTConnDown, dlswTrapControl=dlswTrapControl, dlswInterface=dlswInterface, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfSapList=dlswIfSapList, NBName=NBName, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNode=dlswNode, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitPriority=dlswCircuitPriority, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, MacAddressNC=MacAddressNC, dlswTConnOperTable=dlswTConnOperTable, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcp=dlswTConnTcp, dlswDirectory=dlswDirectory, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitStat=dlswCircuitStat, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirStat=dlswDirStat, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeGroup=dlswNodeGroup, dlswMIB=dlswMIB, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperState=dlswTConnOperState, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBName=dlswDirNBName, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswGroups=dlswGroups, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTCPDomain=dlswTCPDomain, DlswTCPAddress=DlswTCPAddress, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBNameType=dlswDirNBNameType, dlswTConn=dlswTConn, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBMatch=dlswDirLocateNBMatch, EndStationLocation=EndStationLocation, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocate=dlswDirLocate, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcGroup=dlswSdlcGroup, dlswSdlc=dlswSdlc, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeVersion=dlswNodeVersion, dlsw=dlsw, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirMacEntry=dlswDirMacEntry, DlcType=DlcType, dlswCircuitGroup=dlswCircuitGroup, PYSNMP_MODULE_ID=dlsw, dlswDirNBStatus=dlswDirNBStatus, TAddress=TAddress, dlswDirLocateNBName=dlswDirLocateNBName, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuit=dlswCircuit, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswConformance=dlswConformance, dlswTraps=dlswTraps, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDomains=dlswDomains, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswIfRowStatus=dlswIfRowStatus, dlswNodeStatus=dlswNodeStatus, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBIndex=dlswDirNBIndex, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCompliances=dlswCompliances, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacMac=dlswDirMacMac, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswIfTable=dlswIfTable, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacTable=dlswDirMacTable, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitState=dlswCircuitState, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity)
