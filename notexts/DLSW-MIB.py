...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, DlcType=DlcType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacEntry=dlswDirMacEntry, dlswNodeUpTime=dlswNodeUpTime, MacAddressNC=MacAddressNC, NBName=NBName, PYSNMP_MODULE_ID=dlsw, dlswCircuitState=dlswCircuitState, dlswDirNBTable=dlswDirNBTable, dlswCircuitS2Location=dlswCircuitS2Location, dlswCompliances=dlswCompliances, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeGroup=dlswNodeGroup, EndStationLocation=EndStationLocation, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirectory=dlswDirectory, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsTable=dlswSdlcLsTable, dlswConformance=dlswConformance, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirStat=dlswDirStat, dlswNodeStatus=dlswNodeStatus, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBEntry=dlswDirNBEntry, dlswNodeVersion=dlswNodeVersion, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlc=dlswSdlc, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitTable=dlswCircuitTable, dlswTrapControl=dlswTrapControl, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirMacEntries=dlswDirMacEntries, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuit=dlswCircuit, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswNotificationGroup=dlswNotificationGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTrapTConnDown=dlswTrapTConnDown, dlsw=dlsw, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacEntryType=dlswDirMacEntryType, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirCache=dlswDirCache, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacLocationType=dlswDirMacLocationType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswIfRowStatus=dlswIfRowStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigTable=dlswTConnConfigTable, TAddress=TAddress, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTraps=dlswTraps, dlswNode=dlswNode, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitStatActives=dlswCircuitStatActives, null=null, dlswTConnStat=dlswTConnStat, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnSpecific=dlswTConnSpecific, dlswDomains=dlswDomains, LFSize=LFSize, dlswNodeVendorID=dlswNodeVendorID, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacTable=dlswDirMacTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacMac=dlswDirMacMac, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacLocation=dlswDirMacLocation, dlswDirCompliance=dlswDirCompliance, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, DlswTCPAddress=DlswTCPAddress, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTCPDomain=dlswTCPDomain, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBName=dlswDirNBName, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswInterface=dlswInterface, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBGroup=dlswDirNBGroup, dlswIfTable=dlswIfTable, dlswIfEntry=dlswIfEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConn=dlswTConn, dlswGroups=dlswGroups, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperState=dlswTConnOperState, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitStat=dlswCircuitStat, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateGroup=dlswDirLocateGroup, dlswMIB=dlswMIB, dlswDirLocate=dlswDirLocate, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBNameType=dlswDirNBNameType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcp=dlswTConnTcp, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts)
