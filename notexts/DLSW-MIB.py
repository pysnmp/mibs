...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBName=dlswDirNBName, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitStat=dlswCircuitStat, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperState=dlswTConnOperState, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitState=dlswCircuitState, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirMacEntry=dlswDirMacEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTCPDomain=dlswTCPDomain, dlswIfRowStatus=dlswIfRowStatus, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirStat=dlswDirStat, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeGroup=dlswNodeGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitTable=dlswCircuitTable, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlsw=dlsw, dlswInterface=dlswInterface, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateNBGroup=dlswDirLocateNBGroup, NBName=NBName, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitS2Location=dlswCircuitS2Location, dlswTrapControl=dlswTrapControl, dlswCircuitS1DlcType=dlswCircuitS1DlcType, PYSNMP_MODULE_ID=dlsw, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnStat=dlswTConnStat, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCompliances=dlswCompliances, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperEntry=dlswTConnOperEntry, dlswIfTable=dlswIfTable, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswSdlc=dlswSdlc, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, LFSize=LFSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNotificationGroup=dlswNotificationGroup, dlswConformance=dlswConformance, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTraps=dlswTraps, dlswDirCompliance=dlswDirCompliance, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConn=dlswTConn, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, null=null, dlswDirMacMac=dlswDirMacMac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnUp=dlswTrapTConnUp, TAddress=TAddress, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirNBNameType=dlswDirNBNameType, MacAddressNC=MacAddressNC, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirMacMask=dlswDirMacMask, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswIfSapList=dlswIfSapList, dlswDirLocate=dlswDirLocate, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswSdlcGroup=dlswSdlcGroup, DlcType=DlcType, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirCache=dlswDirCache, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirGroup=dlswDirGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswMIB=dlswMIB, dlswNode=dlswNode, dlswDirectory=dlswDirectory, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDomains=dlswDomains, EndStationLocation=EndStationLocation, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcp=dlswTConnTcp, dlswIfEntry=dlswIfEntry, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswNodeStatus=dlswNodeStatus, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBTable=dlswDirNBTable, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirNBStatus=dlswDirNBStatus, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirMacTable=dlswDirMacTable, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswGroups=dlswGroups, dlswCircuit=dlswCircuit, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts)
