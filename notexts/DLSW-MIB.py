...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcp=dlswTConnTcp, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCompliances=dlswCompliances, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBGroup=dlswDirNBGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNotificationGroup=dlswNotificationGroup, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateGroup=dlswDirLocateGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTraps=dlswTraps, dlswMIB=dlswMIB, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitEntry=dlswCircuitEntry, null=null, dlswDirNBTable=dlswDirNBTable, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, NBName=NBName, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacTable=dlswDirMacTable, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuit=dlswCircuit, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBNameType=dlswDirNBNameType, dlswIfVirtualSegment=dlswIfVirtualSegment, dlsw=dlsw, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacMask=dlswDirMacMask, dlswCircuitStat=dlswCircuitStat, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswIfTable=dlswIfTable, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, LFSize=LFSize, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswNodeStatus=dlswNodeStatus, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperTable=dlswTConnOperTable, dlswDirCompliance=dlswDirCompliance, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConn=dlswTConn, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitState=dlswCircuitState, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBName=dlswDirNBName, MacAddressNC=MacAddressNC, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocate=dlswDirLocate, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfSapList=dlswIfSapList, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacEntries=dlswDirMacEntries, dlswNodeUpTime=dlswNodeUpTime, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirectory=dlswDirectory, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapControl=dlswTrapControl, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTCPDomain=dlswTCPDomain, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDomains=dlswDomains, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswConformance=dlswConformance, DlswTCPAddress=DlswTCPAddress, dlswTConnStat=dlswTConnStat, dlswDirNBIndex=dlswDirNBIndex, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsEntry=dlswSdlcLsEntry, EndStationLocation=EndStationLocation, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateMacMac=dlswDirLocateMacMac, DlcType=DlcType, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirStat=dlswDirStat, dlswDirCache=dlswDirCache, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnStatGroup=dlswTConnStatGroup, dlswIfEntry=dlswIfEntry, dlswCoreCompliance=dlswCoreCompliance, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBEntryType=dlswDirNBEntryType, TAddress=TAddress, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirMacLocation=dlswDirMacLocation, dlswDirMacCacheHits=dlswDirMacCacheHits, PYSNMP_MODULE_ID=dlsw, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirGroup=dlswDirGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswInterface=dlswInterface, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswSdlc=dlswSdlc, dlswNode=dlswNode, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswGroups=dlswGroups, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitTable=dlswCircuitTable, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirMacMac=dlswDirMacMac, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperState=dlswTConnOperState, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBCacheHits=dlswDirNBCacheHits)
