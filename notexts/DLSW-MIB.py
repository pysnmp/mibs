...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, LFSize=LFSize, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, null=null, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswNode=dlswNode, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCompliances=dlswCompliances, dlswInterface=dlswInterface, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBStatus=dlswDirNBStatus, dlswTConnStatGroup=dlswTConnStatGroup, dlswTCPDomain=dlswTCPDomain, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacStatus=dlswDirMacStatus, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnSpecific=dlswTConnSpecific, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitEntry=dlswCircuitEntry, dlswIfSapList=dlswIfSapList, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnStat=dlswTConnStat, dlswDomains=dlswDomains, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacTable=dlswDirMacTable, dlswNodeNBGroup=dlswNodeNBGroup, DlswTCPAddress=DlswTCPAddress, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, MacAddressNC=MacAddressNC, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacMask=dlswDirMacMask, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswNodeStatus=dlswNodeStatus, NBName=NBName, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirMacMac=dlswDirMacMac, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitPriority=dlswCircuitPriority, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirCompliance=dlswDirCompliance, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirCache=dlswDirCache, dlswTConnConfigTable=dlswTConnConfigTable, dlswConformance=dlswConformance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswNodeGroup=dlswNodeGroup, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCoreCompliance=dlswCoreCompliance, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirectory=dlswDirectory, dlswDirMacEntry=dlswDirMacEntry, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBIndex=dlswDirNBIndex, dlswDirNBNameType=dlswDirNBNameType, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, TAddress=TAddress, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocate=dlswDirLocate, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitState=dlswCircuitState, dlswCircuitTable=dlswCircuitTable, dlswDirGroup=dlswDirGroup, EndStationLocation=EndStationLocation, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, PYSNMP_MODULE_ID=dlsw, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuit=dlswCircuit, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperState=dlswTConnOperState, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswMIB=dlswMIB, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlc=dlswSdlc, dlswTConnTcp=dlswTConnTcp, dlswDirStat=dlswDirStat, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitStat=dlswCircuitStat, dlswTConn=dlswTConn, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBName=dlswDirNBName, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTraps=dlswTraps, dlsw=dlsw, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswIfTable=dlswIfTable, dlswGroups=dlswGroups, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapControl=dlswTrapControl, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, DlcType=DlcType, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacEntries=dlswDirMacEntries)
