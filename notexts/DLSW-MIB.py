...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitGroup=dlswCircuitGroup, PYSNMP_MODULE_ID=dlsw, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacMask=dlswDirMacMask, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlsw=dlsw, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswNotificationGroup=dlswNotificationGroup, dlswDirStat=dlswDirStat, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswMIB=dlswMIB, dlswConformance=dlswConformance, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswIfTable=dlswIfTable, MacAddressNC=MacAddressNC, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDomains=dlswDomains, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitStat=dlswCircuitStat, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirGroup=dlswDirGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswGroups=dlswGroups, dlswIfSapList=dlswIfSapList, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeGroup=dlswNodeGroup, dlswDirLocate=dlswDirLocate, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswInterfaceGroup=dlswInterfaceGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirNBName=dlswDirNBName, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVersion=dlswNodeVersion, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacEntry=dlswDirMacEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNode=dlswNode, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnTcp=dlswTConnTcp, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacMac=dlswDirMacMac, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswNodeUpTime=dlswNodeUpTime, dlswDirCompliance=dlswDirCompliance, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTraps=dlswTraps, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, null=null, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswIfEntry=dlswIfEntry, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, TAddress=TAddress, DlcType=DlcType, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConn=dlswTConn, dlswTCPDomain=dlswTCPDomain, dlswDirNBNameType=dlswDirNBNameType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitEntryTime=dlswCircuitEntryTime, LFSize=LFSize, dlswTrapTConnUp=dlswTrapTConnUp, EndStationLocation=EndStationLocation, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirNBLocation=dlswDirNBLocation, dlswTrapControl=dlswTrapControl, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperTDomain=dlswTConnOperTDomain, NBName=NBName, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitState=dlswCircuitState, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacTable=dlswDirMacTable, dlswDirectory=dlswDirectory, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperState=dlswTConnOperState, dlswSdlc=dlswSdlc, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitTable=dlswCircuitTable, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigTable=dlswTConnConfigTable, dlswNodeVersionString=dlswNodeVersionString, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBLFSize=dlswDirNBLFSize, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacLocationType=dlswDirMacLocationType, dlswInterface=dlswInterface, dlswCompliances=dlswCompliances, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBTable=dlswDirNBTable, dlswDirNBStatus=dlswDirNBStatus, dlswTConnStat=dlswTConnStat, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuit=dlswCircuit, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirCache=dlswDirCache, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections)
