...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswGroups=dlswGroups, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirNBGroup=dlswDirNBGroup, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitEntry=dlswCircuitEntry, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlsw=dlsw, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTraps=dlswTraps, null=null, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirectory=dlswDirectory, dlswCompliances=dlswCompliances, dlswDirMacLocation=dlswDirMacLocation, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirLocate=dlswDirLocate, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, PYSNMP_MODULE_ID=dlsw, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitState=dlswCircuitState, dlswDirLocateGroup=dlswDirLocateGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeStatus=dlswNodeStatus, dlswCircuitStatActives=dlswCircuitStatActives, dlswNodeVersion=dlswNodeVersion, dlswTConnOperGroup=dlswTConnOperGroup, dlswIfRowStatus=dlswIfRowStatus, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, LFSize=LFSize, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTCPDomain=dlswTCPDomain, dlswTConn=dlswTConn, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswIfTable=dlswIfTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirGroup=dlswDirGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, TAddress=TAddress, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswInterface=dlswInterface, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacLocationType=dlswDirMacLocationType, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswIfSapList=dlswIfSapList, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, DlcType=DlcType, dlswMIB=dlswMIB, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcp=dlswTConnTcp, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDomains=dlswDomains, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirStat=dlswDirStat, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacTable=dlswDirMacTable, dlswCircuitStatGroup=dlswCircuitStatGroup, MacAddressNC=MacAddressNC, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcGroup=dlswSdlcGroup, dlswNode=dlswNode, dlswCircuitStat=dlswCircuitStat, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, NBName=NBName, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnStatGroup=dlswTConnStatGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswConformance=dlswConformance, DlswTCPAddress=DlswTCPAddress, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuit=dlswCircuit, dlswDirMacEntryType=dlswDirMacEntryType, dlswTrapControl=dlswTrapControl, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperState=dlswTConnOperState, dlswDirCache=dlswDirCache, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirMacMask=dlswDirMacMask, dlswDirNBTable=dlswDirNBTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnStat=dlswTConnStat, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswIfEntry=dlswIfEntry, dlswNodeUpTime=dlswNodeUpTime, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperTable=dlswTConnOperTable, EndStationLocation=EndStationLocation, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirCompliance=dlswDirCompliance, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBName=dlswDirNBName, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswSdlc=dlswSdlc, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitGroup=dlswCircuitGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeVersionString=dlswNodeVersionString, dlswNodeVendorID=dlswNodeVendorID)
