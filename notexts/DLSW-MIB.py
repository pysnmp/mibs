...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswIfTable=dlswIfTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacEntry=dlswDirMacEntry, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacStatus=dlswDirMacStatus, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTrapControl=dlswTrapControl, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirStat=dlswDirStat, dlswInterface=dlswInterface, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlsw=dlsw, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeStatus=dlswNodeStatus, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirMacMac=dlswDirMacMac, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCompliances=dlswCompliances, null=null, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswIfSapList=dlswIfSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperGroup=dlswTConnOperGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBIndex=dlswDirNBIndex, dlswTraps=dlswTraps, TAddress=TAddress, DlcType=DlcType, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnStatGroup=dlswTConnStatGroup, dlswConformance=dlswConformance, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnSpecific=dlswTConnSpecific, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocate=dlswDirLocate, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacEntries=dlswDirMacEntries, dlswGroups=dlswGroups, DlswTCPAddress=DlswTCPAddress, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcp=dlswTConnTcp, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswIfEntry=dlswIfEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacTable=dlswDirMacTable, dlswDirCache=dlswDirCache, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswSdlcLsTable=dlswSdlcLsTable, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirNBRowStatus=dlswDirNBRowStatus, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlc=dlswSdlc, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacIndex=dlswDirMacIndex, dlswTCPDomain=dlswTCPDomain, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, NBName=NBName, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitState=dlswCircuitState, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBEntries=dlswDirNBEntries, dlswNodeVersion=dlswNodeVersion, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirectory=dlswDirectory, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirGroup=dlswDirGroup, dlswMIB=dlswMIB, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNode=dlswNode, dlswDirNBTable=dlswDirNBTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, EndStationLocation=EndStationLocation, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitGroup=dlswCircuitGroup, dlswIfRowStatus=dlswIfRowStatus, dlswTConn=dlswTConn, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBName=dlswDirNBName, dlswDirNBLocation=dlswDirNBLocation, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuit=dlswCircuit, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirNBStatus=dlswDirNBStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitStat=dlswCircuitStat, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDomains=dlswDomains, dlswDirMacMask=dlswDirMacMask, MacAddressNC=MacAddressNC, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnStat=dlswTConnStat, LFSize=LFSize)
