...
mibBuilder.exportSymbols("DLSW-MIB", dlswNodeVersion=dlswNodeVersion, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirGroup=dlswDirGroup, dlswCoreCompliance=dlswCoreCompliance, dlswDomains=dlswDomains, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswInterface=dlswInterface, dlswIfTable=dlswIfTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeGroup=dlswNodeGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcp=dlswTConnTcp, LFSize=LFSize, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, PYSNMP_MODULE_ID=dlsw, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitStat=dlswCircuitStat, dlswCompliances=dlswCompliances, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBTable=dlswDirNBTable, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsTable=dlswSdlcLsTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, null=null, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswNode=dlswNode, dlswCircuitTable=dlswCircuitTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitStateTime=dlswCircuitStateTime, EndStationLocation=EndStationLocation, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitEntry=dlswCircuitEntry, dlsw=dlsw, dlswDirLocateNBName=dlswDirLocateNBName, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperState=dlswTConnOperState, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacTable=dlswDirMacTable, dlswCircuit=dlswCircuit, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswNotificationGroup=dlswNotificationGroup, dlswIfEntry=dlswIfEntry, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBLocationType=dlswDirNBLocationType, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocate=dlswDirLocate, dlswConformance=dlswConformance, dlswSdlcCompliance=dlswSdlcCompliance, MacAddressNC=MacAddressNC, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirCache=dlswDirCache, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitState=dlswCircuitState, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapControl=dlswTrapControl, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswSdlc=dlswSdlc, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacMask=dlswDirMacMask, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirStat=dlswDirStat, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirectory=dlswDirectory, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBName=dlswDirNBName, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswMIB=dlswMIB, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirCompliance=dlswDirCompliance, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswIfSapList=dlswIfSapList, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirMacLocationType=dlswDirMacLocationType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, DlcType=DlcType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswGroups=dlswGroups, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswNodeStatus=dlswNodeStatus, dlswTConnStat=dlswTConnStat, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnSpecific=dlswTConnSpecific, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBEntries=dlswDirNBEntries, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, NBName=NBName, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacMac=dlswDirMacMac, dlswTraps=dlswTraps, TAddress=TAddress, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeUpTime=dlswNodeUpTime, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcpOperTable=dlswTConnTcpOperTable, DlswTCPAddress=DlswTCPAddress, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConn=dlswTConn)
