...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirCompliance=dlswDirCompliance, dlswNodeStatus=dlswNodeStatus, dlswTrapControl=dlswTrapControl, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitStat=dlswCircuitStat, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacMask=dlswDirMacMask, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirStat=dlswDirStat, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBName=dlswDirNBName, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirCache=dlswDirCache, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirNBIndex=dlswDirNBIndex, MacAddressNC=MacAddressNC, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNode=dlswNode, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConn=dlswTConn, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, DlswTCPAddress=DlswTCPAddress, dlswDirMacStatus=dlswDirMacStatus, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswMIB=dlswMIB, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, TAddress=TAddress, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperState=dlswTConnOperState, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTCPDomain=dlswTCPDomain, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateCompliance=dlswDirLocateCompliance, null=null, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswIfSapList=dlswIfSapList, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswInterface=dlswInterface, dlswCircuitTable=dlswCircuitTable, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirectory=dlswDirectory, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDomains=dlswDomains, LFSize=LFSize, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlc=dlswSdlc, dlswDirNBNameType=dlswDirNBNameType, DlcType=DlcType, dlswIfTable=dlswIfTable, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcp=dlswTConnTcp, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, PYSNMP_MODULE_ID=dlsw, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnStat=dlswTConnStat, dlswCircuit=dlswCircuit, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCompliances=dlswCompliances, dlswDirLocate=dlswDirLocate, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapTConnUp=dlswTrapTConnUp, dlswGroups=dlswGroups, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirGroup=dlswDirGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswConformance=dlswConformance, dlswDirNBStatus=dlswDirNBStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, EndStationLocation=EndStationLocation, dlsw=dlsw, dlswNodeVendorID=dlswNodeVendorID, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfEntry=dlswIfEntry, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeGroup=dlswNodeGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnSpecific=dlswTConnSpecific, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswTraps=dlswTraps, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperTDomain=dlswTConnOperTDomain, NBName=NBName, dlswCircuitState=dlswCircuitState, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirMacMac=dlswDirMacMac, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacEntries=dlswDirMacEntries, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnStatGroup=dlswTConnStatGroup)
