...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswIfEntry=dlswIfEntry, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBName=dlswDirLocateNBName, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBTable=dlswDirNBTable, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswInterface=dlswInterface, dlswNodeUpTime=dlswNodeUpTime, dlswNodeStatus=dlswNodeStatus, DlswTCPAddress=DlswTCPAddress, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBLocation=dlswDirNBLocation, dlswTraps=dlswTraps, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBEntries=dlswDirNBEntries, dlswDirGroup=dlswDirGroup, dlswTConnOperTable=dlswTConnOperTable, TAddress=TAddress, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirLocateNBLocation=dlswDirLocateNBLocation, null=null, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCoreCompliance=dlswCoreCompliance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigOpens=dlswTConnConfigOpens, NBName=NBName, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, EndStationLocation=EndStationLocation, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigTable=dlswTConnConfigTable, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, MacAddressNC=MacAddressNC, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitTable=dlswCircuitTable, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBIndex=dlswDirNBIndex, dlswNodeGroup=dlswNodeGroup, dlswCircuit=dlswCircuit, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnTcp=dlswTConnTcp, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlc=dlswSdlc, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcGroup=dlswSdlcGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlcCompliance=dlswSdlcCompliance, dlswNode=dlswNode, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, DlcType=DlcType, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS2Location=dlswCircuitS2Location, dlswGroups=dlswGroups, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirNBEntry=dlswDirNBEntry, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswMIB=dlswMIB, dlswCircuitStatActives=dlswCircuitStatActives, dlswIfSapList=dlswIfSapList, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCompliances=dlswCompliances, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswIfTable=dlswIfTable, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTrapControl=dlswTrapControl, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDomains=dlswDomains, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperEntry=dlswTConnOperEntry, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacLocation=dlswDirMacLocation, dlswDirLocate=dlswDirLocate, dlswDirCompliance=dlswDirCompliance, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, PYSNMP_MODULE_ID=dlsw, LFSize=LFSize, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswConformance=dlswConformance, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirCache=dlswDirCache, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConn=dlswTConn, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlsw=dlsw, dlswTConnSpecific=dlswTConnSpecific, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirMacMac=dlswDirMacMac, dlswTConnOperState=dlswTConnOperState, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStat=dlswTConnStat, dlswCircuitState=dlswCircuitState, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitGroup=dlswCircuitGroup, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirStat=dlswDirStat, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitOrigin=dlswCircuitOrigin, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBName=dlswDirNBName, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirectory=dlswDirectory)
