...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacLocation=dlswDirMacLocation, dlswTrapControl=dlswTrapControl, dlswIfTable=dlswIfTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacTable=dlswDirMacTable, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, NBName=NBName, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacEntry=dlswDirMacEntry, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswConformance=dlswConformance, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcp=dlswTConnTcp, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConn=dlswTConn, dlswDirCache=dlswDirCache, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacEntryType=dlswDirMacEntryType, dlswSdlc=dlswSdlc, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, DlcType=DlcType, dlswDirLocate=dlswDirLocate, dlswTraps=dlswTraps, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitStat=dlswCircuitStat, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, MacAddressNC=MacAddressNC, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeStatus=dlswNodeStatus, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswNodeVersion=dlswNodeVersion, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacMask=dlswDirMacMask, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswIfSapList=dlswIfSapList, dlsw=dlsw, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperState=dlswTConnOperState, null=null, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDomains=dlswDomains, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuit=dlswCircuit, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnNBGroup=dlswTConnNBGroup, dlswCoreCompliance=dlswCoreCompliance, dlswInterface=dlswInterface, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacCacheHits=dlswDirMacCacheHits, TAddress=TAddress, dlswNode=dlswNode, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirStat=dlswDirStat, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitGroup=dlswCircuitGroup, DlswTCPAddress=DlswTCPAddress, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacMac=dlswDirMacMac, dlswSdlcCompliance=dlswSdlcCompliance, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnStat=dlswTConnStat, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirGroup=dlswDirGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswIfEntry=dlswIfEntry, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeGroup=dlswNodeGroup, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitTable=dlswCircuitTable, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitState=dlswCircuitState, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeVendorID=dlswNodeVendorID, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirectory=dlswDirectory, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBName=dlswDirNBName, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnConfigGroup=dlswTConnConfigGroup, EndStationLocation=EndStationLocation, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswGroups=dlswGroups, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, LFSize=LFSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, PYSNMP_MODULE_ID=dlsw, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCompliances=dlswCompliances, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswIfRowStatus=dlswIfRowStatus, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswMIB=dlswMIB, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl)
