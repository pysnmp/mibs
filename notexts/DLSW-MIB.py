...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacMac=dlswDirMacMac, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeVendorID=dlswNodeVendorID, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacTable=dlswDirMacTable, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcGroup=dlswSdlcGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlc=dlswSdlc, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitStat=dlswCircuitStat, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTrapControl=dlswTrapControl, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBLFSize=dlswDirNBLFSize, LFSize=LFSize, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperState=dlswTConnOperState, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperGroup=dlswTConnOperGroup, dlswDomains=dlswDomains, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswNodeStatus=dlswNodeStatus, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswIfSapList=dlswIfSapList, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigEntryType=dlswTConnConfigEntryType, DlswTCPAddress=DlswTCPAddress, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirStat=dlswDirStat, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTraps=dlswTraps, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswInterface=dlswInterface, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswIfTable=dlswIfTable, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, PYSNMP_MODULE_ID=dlsw, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCompliances=dlswCompliances, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirNBStatus=dlswDirNBStatus, dlswDirLocate=dlswDirLocate, MacAddressNC=MacAddressNC, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirNBName=dlswDirNBName, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNode=dlswNode, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirectory=dlswDirectory, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTCPDomain=dlswTCPDomain, TAddress=TAddress, NBName=NBName, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnStat=dlswTConnStat, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, null=null, dlswConformance=dlswConformance, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirCompliance=dlswDirCompliance, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeVersion=dlswNodeVersion, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcp=dlswTConnTcp, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirCache=dlswDirCache, dlswTConn=dlswTConn, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, EndStationLocation=EndStationLocation, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitTable=dlswCircuitTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBTable=dlswDirNBTable, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuit=dlswCircuit, dlswIfEntry=dlswIfEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeGroup=dlswNodeGroup, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirGroup=dlswDirGroup, DlcType=DlcType, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswGroups=dlswGroups, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacMask=dlswDirMacMask, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswMIB=dlswMIB, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlsw=dlsw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitState=dlswCircuitState)
