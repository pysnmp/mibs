...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacTable=dlswDirMacTable, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeGroup=dlswNodeGroup, dlswNodeVersion=dlswNodeVersion, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitPriority=dlswCircuitPriority, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswGroups=dlswGroups, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTraps=dlswTraps, dlswDirLocate=dlswDirLocate, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeUpTime=dlswNodeUpTime, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacMask=dlswDirMacMask, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnStat=dlswTConnStat, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTCPDomain=dlswTCPDomain, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperState=dlswTConnOperState, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTrapControl=dlswTrapControl, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswIfTable=dlswIfTable, dlswNodeVersionString=dlswNodeVersionString, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, DlswTCPAddress=DlswTCPAddress, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, DlcType=DlcType, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswConformance=dlswConformance, dlswDirectory=dlswDirectory, TAddress=TAddress, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, null=null, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeStatus=dlswNodeStatus, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcGroup=dlswSdlcGroup, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBEntry=dlswDirNBEntry, dlswDomains=dlswDomains, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswInterface=dlswInterface, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsEntry=dlswSdlcLsEntry, NBName=NBName, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacLFSize=dlswDirMacLFSize, dlswMIB=dlswMIB, EndStationLocation=EndStationLocation, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacStatus=dlswDirMacStatus, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswIfEntry=dlswIfEntry, dlswDirMacEntries=dlswDirMacEntries, dlswDirCompliance=dlswDirCompliance, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirMacLocation=dlswDirMacLocation, dlswCompliances=dlswCompliances, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitEntry=dlswCircuitEntry, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswIfSapList=dlswIfSapList, dlswDirMacEntry=dlswDirMacEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirGroup=dlswDirGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirCache=dlswDirCache, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigGroup=dlswTConnConfigGroup, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirStat=dlswDirStat, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperEntry=dlswTConnOperEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConn=dlswTConn, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacMac=dlswDirMacMac, dlswSdlcCompliance=dlswSdlcCompliance, dlswSdlc=dlswSdlc, MacAddressNC=MacAddressNC, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNode=dlswNode, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitState=dlswCircuitState, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuit=dlswCircuit, dlswCircuitS2Location=dlswCircuitS2Location, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS2TAddress=dlswCircuitS2TAddress, LFSize=LFSize, dlswDirNBName=dlswDirNBName, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitStat=dlswCircuitStat, dlsw=dlsw, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperCircuits=dlswTConnOperCircuits)
