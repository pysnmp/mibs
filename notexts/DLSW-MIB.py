...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTraps=dlswTraps, LFSize=LFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBStatus=dlswDirNBStatus, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCoreCompliance=dlswCoreCompliance, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacMask=dlswDirMacMask, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlc=dlswSdlc, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitStat=dlswCircuitStat, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirCache=dlswDirCache, dlswIfSapList=dlswIfSapList, null=null, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBName=dlswDirNBName, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfTable=dlswIfTable, dlswIfEntry=dlswIfEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirNBEntry=dlswDirNBEntry, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswGroups=dlswGroups, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapControl=dlswTrapControl, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirStat=dlswDirStat, TAddress=TAddress, dlswTConnTcp=dlswTConnTcp, dlswCircuitS2Location=dlswCircuitS2Location, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirGroup=dlswDirGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, PYSNMP_MODULE_ID=dlsw, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitState=dlswCircuitState, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitStateTime=dlswCircuitStateTime, dlswDomains=dlswDomains, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitPriority=dlswCircuitPriority, dlswNodeVersion=dlswNodeVersion, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswNotificationGroup=dlswNotificationGroup, DlswTCPAddress=DlswTCPAddress, dlswTConnOperState=dlswTConnOperState, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswConformance=dlswConformance, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNode=dlswNode, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, DlcType=DlcType, dlswDirectory=dlswDirectory, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCompliances=dlswCompliances, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBRowStatus=dlswDirNBRowStatus, EndStationLocation=EndStationLocation, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitTable=dlswCircuitTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnStat=dlswTConnStat, dlsw=dlsw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNodeUpTime=dlswNodeUpTime, dlswInterface=dlswInterface, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswIfRowStatus=dlswIfRowStatus, dlswDirCompliance=dlswDirCompliance, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocate=dlswDirLocate, dlswCircuitS2TAddress=dlswCircuitS2TAddress, MacAddressNC=MacAddressNC, dlswDirLocateMacEntry=dlswDirLocateMacEntry, NBName=NBName, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuit=dlswCircuit, dlswDirMacTable=dlswDirMacTable, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBEntries=dlswDirNBEntries, dlswMIB=dlswMIB, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacMac=dlswDirMacMac, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConn=dlswTConn, dlswTConnOperConnectTime=dlswTConnOperConnectTime)
