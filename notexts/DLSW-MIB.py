...
mibBuilder.exportSymbols("DLSW-MIB", dlswTCPDomain=dlswTCPDomain, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocate=dlswDirLocate, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswSdlc=dlswSdlc, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuit=dlswCircuit, dlswCircuitS1Sap=dlswCircuitS1Sap, MacAddressNC=MacAddressNC, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswNode=dlswNode, TAddress=TAddress, LFSize=LFSize, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswMIB=dlswMIB, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBName=dlswDirNBName, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTraps=dlswTraps, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirMacTable=dlswDirMacTable, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirMacMask=dlswDirMacMask, null=null, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlsw=dlsw, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswIfTable=dlswIfTable, dlswDirStat=dlswDirStat, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacMac=dlswDirMacMac, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitStat=dlswCircuitStat, dlswTConnOperState=dlswTConnOperState, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapControl=dlswTrapControl, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitGroup=dlswCircuitGroup, NBName=NBName, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnStat=dlswTConnStat, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswInterface=dlswInterface, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswIfSapList=dlswIfSapList, dlswDirNBTable=dlswDirNBTable, EndStationLocation=EndStationLocation, dlswDirNBNameType=dlswDirNBNameType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirGroup=dlswDirGroup, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswNodeVendorID=dlswNodeVendorID, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirLocateNBName=dlswDirLocateNBName, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitTable=dlswCircuitTable, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswConformance=dlswConformance, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, PYSNMP_MODULE_ID=dlsw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswNodeNBGroup=dlswNodeNBGroup, dlswDomains=dlswDomains, dlswNodeStatus=dlswNodeStatus, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswNotificationGroup=dlswNotificationGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcGroup=dlswSdlcGroup, dlswDirectory=dlswDirectory, DlcType=DlcType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitPriority=dlswCircuitPriority, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitStateTime=dlswCircuitStateTime, dlswIfEntry=dlswIfEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitState=dlswCircuitState, dlswTConnTcp=dlswTConnTcp, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConn=dlswTConn, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeVersion=dlswNodeVersion, dlswGroups=dlswGroups, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCircuitDown=dlswTrapCircuitDown, DlswTCPAddress=DlswTCPAddress, dlswCircuitS2Location=dlswCircuitS2Location, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirCompliance=dlswDirCompliance, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitStatActives=dlswCircuitStatActives, dlswCompliances=dlswCompliances, dlswDirCache=dlswDirCache, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode)
