...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBTable=dlswDirNBTable, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitState=dlswCircuitState, dlswDirLocateMacLocation=dlswDirLocateMacLocation, DlswTCPAddress=DlswTCPAddress, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirCache=dlswDirCache, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirCompliance=dlswDirCompliance, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlsw=dlsw, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirNBName=dlswDirNBName, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcp=dlswTConnTcp, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNode=dlswNode, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswNodeNBGroup=dlswNodeNBGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, TAddress=TAddress, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswInterface=dlswInterface, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTrapControl=dlswTrapControl, dlswDirLocateNBLocation=dlswDirLocateNBLocation, DlcType=DlcType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeVersionString=dlswNodeVersionString, dlswIfEntry=dlswIfEntry, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitOrigin=dlswCircuitOrigin, MacAddressNC=MacAddressNC, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, EndStationLocation=EndStationLocation, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, LFSize=LFSize, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapTConnDown=dlswTrapTConnDown, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirLocate=dlswDirLocate, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirLocateNBMatch=dlswDirLocateNBMatch, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswIfRowStatus=dlswIfRowStatus, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCompliances=dlswCompliances, dlswDirMacIndex=dlswDirMacIndex, dlswDomains=dlswDomains, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitTable=dlswCircuitTable, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfTable=dlswIfTable, dlswTraps=dlswTraps, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswConformance=dlswConformance, dlswCircuitStat=dlswCircuitStat, dlswTConnOperState=dlswTConnOperState, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnStat=dlswTConnStat, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS2Location=dlswCircuitS2Location, null=null, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, NBName=NBName, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNotificationGroup=dlswNotificationGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitPriority=dlswCircuitPriority, dlswNodeGroup=dlswNodeGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswMIB=dlswMIB, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirGroup=dlswDirGroup, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBGroup=dlswDirNBGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperTable=dlswTConnOperTable, dlswTConn=dlswTConn, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBIndex=dlswDirNBIndex, dlswCircuit=dlswCircuit, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirStat=dlswDirStat, dlswCircuitEntry=dlswCircuitEntry, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTCPDomain=dlswTCPDomain, dlswDirectory=dlswDirectory, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswSdlc=dlswSdlc, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBLocationType=dlswDirNBLocationType, dlswNodeStatus=dlswNodeStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacTable=dlswDirMacTable, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswGroups=dlswGroups, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections)
