...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeVersionString=dlswNodeVersionString, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitStat=dlswCircuitStat, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirMacEntry=dlswDirMacEntry, dlswTCPDomain=dlswTCPDomain, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, DlcType=DlcType, dlswDirLocate=dlswDirLocate, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeStatus=dlswNodeStatus, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDomains=dlswDomains, dlswCircuitGroup=dlswCircuitGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCompliances=dlswCompliances, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirStat=dlswDirStat, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBGroup=dlswDirNBGroup, MacAddressNC=MacAddressNC, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConn=dlswTConn, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperTable=dlswTConnOperTable, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswConformance=dlswConformance, dlswDirectory=dlswDirectory, dlswSdlc=dlswSdlc, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNotificationGroup=dlswNotificationGroup, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperState=dlswTConnOperState, dlswIfEntry=dlswIfEntry, null=null, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirGroup=dlswDirGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, TAddress=TAddress, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirMacTable=dlswDirMacTable, dlswIfSapList=dlswIfSapList, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnStat=dlswTConnStat, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirCompliance=dlswDirCompliance, dlswCircuitTable=dlswCircuitTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirCache=dlswDirCache, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuit=dlswCircuit, dlswGroups=dlswGroups, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitState=dlswCircuitState, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacMac=dlswDirMacMac, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitPriority=dlswCircuitPriority, dlswMIB=dlswMIB, dlswNodeUpTime=dlswNodeUpTime, EndStationLocation=EndStationLocation, dlswNodeVersion=dlswNodeVersion, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirMacEntries=dlswDirMacEntries, dlswTraps=dlswTraps, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswInterface=dlswInterface, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacIndex=dlswDirMacIndex, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, NBName=NBName, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcp=dlswTConnTcp, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBEntryType=dlswDirNBEntryType, DlswTCPAddress=DlswTCPAddress, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapTConnDown=dlswTrapTConnDown, dlsw=dlsw, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnNBGroup=dlswTConnNBGroup, LFSize=LFSize, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswIfTable=dlswIfTable, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswNode=dlswNode, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBName=dlswDirNBName, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBIndex=dlswDirNBIndex, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapControl=dlswTrapControl, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswNodeGroup=dlswNodeGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation)
