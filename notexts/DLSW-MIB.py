...
mibBuilder.exportSymbols("DLSW-MIB", dlswTrapCircuitDown=dlswTrapCircuitDown, dlswConformance=dlswConformance, dlswCircuitState=dlswCircuitState, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirectory=dlswDirectory, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirCache=dlswDirCache, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, TAddress=TAddress, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacEntryType=dlswDirMacEntryType, dlswInterfaceGroup=dlswInterfaceGroup, DlcType=DlcType, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcp=dlswTConnTcp, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacStatus=dlswDirMacStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBLocation=dlswDirNBLocation, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswIfSapList=dlswIfSapList, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNode=dlswNode, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitTable=dlswCircuitTable, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswIfEntry=dlswIfEntry, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirNBGroup=dlswDirNBGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBName=dlswDirNBName, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacRowStatus=dlswDirMacRowStatus, dlsw=dlsw, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeStatus=dlswNodeStatus, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitStat=dlswCircuitStat, dlswTConnSpecific=dlswTConnSpecific, dlswIfTable=dlswIfTable, PYSNMP_MODULE_ID=dlsw, dlswTraps=dlswTraps, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConn=dlswTConn, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswGroups=dlswGroups, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocate=dlswDirLocate, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapControl=dlswTrapControl, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswNodeGroup=dlswNodeGroup, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, DlswTCPAddress=DlswTCPAddress, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitEntryTime=dlswCircuitEntryTime, EndStationLocation=EndStationLocation, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTCPDomain=dlswTCPDomain, null=null, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperState=dlswTConnOperState, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirMacEntries=dlswDirMacEntries, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswSdlc=dlswSdlc, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirCompliance=dlswDirCompliance, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacEntry=dlswDirMacEntry, NBName=NBName, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswInterface=dlswInterface, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDomains=dlswDomains, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBTable=dlswDirNBTable, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCompliances=dlswCompliances, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirMacLocation=dlswDirMacLocation, dlswNodeNBGroup=dlswNodeNBGroup, dlswNodeVendorID=dlswNodeVendorID, dlswDirStat=dlswDirStat, dlswTConnOperICRexSents=dlswTConnOperICRexSents, LFSize=LFSize, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswMIB=dlswMIB, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNodeVersion=dlswNodeVersion, dlswDirGroup=dlswDirGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacMac=dlswDirMacMac, MacAddressNC=MacAddressNC, dlswTConnStat=dlswTConnStat, dlswCircuit=dlswCircuit, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacTable=dlswDirMacTable, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirMacMask=dlswDirMacMask, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds)
