...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswNode=dlswNode, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBLFSize=dlswDirNBLFSize, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateCompliance=dlswDirLocateCompliance, LFSize=LFSize, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswMIB=dlswMIB, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBEntries=dlswDirNBEntries, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacMac=dlswDirMacMac, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlsw=dlsw, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS1Dlc=dlswCircuitS1Dlc, null=null, dlswDirNBLocation=dlswDirNBLocation, dlswIfSapList=dlswIfSapList, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirStat=dlswDirStat, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeVendorID=dlswNodeVendorID, dlswSdlc=dlswSdlc, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirLocate=dlswDirLocate, dlswTConnStatGroup=dlswTConnStatGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, MacAddressNC=MacAddressNC, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, NBName=NBName, dlswTConn=dlswTConn, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeUpTime=dlswNodeUpTime, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswSdlcGroup=dlswSdlcGroup, dlswDirCache=dlswDirCache, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswInterface=dlswInterface, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, EndStationLocation=EndStationLocation, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapControl=dlswTrapControl, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirMacTable=dlswDirMacTable, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTCPDomain=dlswTCPDomain, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitTable=dlswCircuitTable, dlswCompliances=dlswCompliances, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswNodeGroup=dlswNodeGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswNodeVersion=dlswNodeVersion, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnSpecific=dlswTConnSpecific, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperState=dlswTConnOperState, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcp=dlswTConnTcp, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfTable=dlswIfTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, DlcType=DlcType, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBTable=dlswDirNBTable, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuit=dlswCircuit, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCoreCompliance=dlswCoreCompliance, TAddress=TAddress, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswGroups=dlswGroups, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfEntry=dlswIfEntry, dlswDirMacLocation=dlswDirMacLocation, dlswTraps=dlswTraps, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitStat=dlswCircuitStat, dlswConformance=dlswConformance, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirCompliance=dlswDirCompliance, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirectory=dlswDirectory, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirGroup=dlswDirGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitStatCreates=dlswCircuitStatCreates, PYSNMP_MODULE_ID=dlsw, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBName=dlswDirNBName, dlswTConnNBGroup=dlswTConnNBGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitState=dlswCircuitState, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnStat=dlswTConnStat, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirNBGroup=dlswDirNBGroup, DlswTCPAddress=DlswTCPAddress, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeStatus=dlswNodeStatus, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfRowStatus=dlswIfRowStatus, dlswDomains=dlswDomains, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted)
