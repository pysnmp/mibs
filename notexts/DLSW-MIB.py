...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocate=dlswDirLocate, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeNBGroup=dlswNodeNBGroup, EndStationLocation=EndStationLocation, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBName=dlswDirNBName, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTCPDomain=dlswTCPDomain, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, LFSize=LFSize, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeUpTime=dlswNodeUpTime, dlswNode=dlswNode, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, PYSNMP_MODULE_ID=dlsw, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitState=dlswCircuitState, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacTable=dlswDirMacTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBGroup=dlswDirNBGroup, MacAddressNC=MacAddressNC, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswMIB=dlswMIB, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfTable=dlswIfTable, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeGroup=dlswNodeGroup, dlswCircuitStatActives=dlswCircuitStatActives, null=null, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacMac=dlswDirMacMac, dlswNodeStatus=dlswNodeStatus, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcGroup=dlswSdlcGroup, dlswNodeVersionString=dlswNodeVersionString, dlswDirectory=dlswDirectory, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirStat=dlswDirStat, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConn=dlswTConn, dlswDirNBEntry=dlswDirNBEntry, dlswDirCompliance=dlswDirCompliance, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirMacEntries=dlswDirMacEntries, dlswInterface=dlswInterface, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswSdlc=dlswSdlc, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTraps=dlswTraps, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBTable=dlswDirNBTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDomains=dlswDomains, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS1DlcType=dlswCircuitS1DlcType, TAddress=TAddress, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperState=dlswTConnOperState, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitTable=dlswCircuitTable, dlswInterfaceGroup=dlswInterfaceGroup, DlcType=DlcType, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnStat=dlswTConnStat, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTrapControl=dlswTrapControl, dlswDirMacStatus=dlswDirMacStatus, dlswDirCache=dlswDirCache, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBLocationType=dlswDirNBLocationType, dlswIfSapList=dlswIfSapList, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuit=dlswCircuit, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswConformance=dlswConformance, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacMask=dlswDirMacMask, dlswGroups=dlswGroups, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitStat=dlswCircuitStat, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCompliances=dlswCompliances, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBIndex=dlswDirNBIndex, dlswDirGroup=dlswDirGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBLocation=dlswDirNBLocation, dlswIfEntry=dlswIfEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlsw=dlsw, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, NBName=NBName, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperTable=dlswTConnOperTable, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeVersion=dlswNodeVersion, dlswDirMacEntry=dlswDirMacEntry)
