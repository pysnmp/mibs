...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirectory=dlswDirectory, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitState=dlswCircuitState, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, DlcType=DlcType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCoreCompliance=dlswCoreCompliance, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDomains=dlswDomains, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswIfEntry=dlswIfEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswIfTable=dlswIfTable, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirStat=dlswDirStat, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirMacLocationType=dlswDirMacLocationType, dlswMIB=dlswMIB, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswInterface=dlswInterface, dlswDirMacMask=dlswDirMacMask, dlswConformance=dlswConformance, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcGroup=dlswSdlcGroup, DlswTCPAddress=DlswTCPAddress, dlswCircuitGroup=dlswCircuitGroup, dlswCircuit=dlswCircuit, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacTable=dlswDirMacTable, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNode=dlswNode, dlswCircuitPriority=dlswCircuitPriority, LFSize=LFSize, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConn=dlswTConn, dlswTrapControl=dlswTrapControl, dlswDirMacMac=dlswDirMacMac, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, null=null, MacAddressNC=MacAddressNC, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBGroup=dlswDirNBGroup, PYSNMP_MODULE_ID=dlsw, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitStat=dlswCircuitStat, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswIfRowStatus=dlswIfRowStatus, dlswDirCompliance=dlswDirCompliance, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirNBLocation=dlswDirNBLocation, NBName=NBName, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBEntryType=dlswDirNBEntryType, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlsw=dlsw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocate=dlswDirLocate, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBStatus=dlswDirNBStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswNodeGroup=dlswNodeGroup, dlswTConnOperState=dlswTConnOperState, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTraps=dlswTraps, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswIfSapList=dlswIfSapList, dlswNodeStatus=dlswNodeStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlc=dlswSdlc, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBName=dlswDirNBName, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacLFSize=dlswDirMacLFSize, dlswCompliances=dlswCompliances, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigTable=dlswTConnConfigTable, TAddress=TAddress, dlswDirMacIndex=dlswDirMacIndex, dlswTConnStat=dlswTConnStat, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacEntries=dlswDirMacEntries, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperTable=dlswTConnOperTable, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirGroup=dlswDirGroup, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, EndStationLocation=EndStationLocation, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitTable=dlswCircuitTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeVersionString=dlswNodeVersionString, dlswNodeVersion=dlswNodeVersion, dlswGroups=dlswGroups, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirNBTable=dlswDirNBTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirCache=dlswDirCache, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigEntry=dlswTConnConfigEntry)
