...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, Counter64, Integer32, MibIdentifier, ObjectIdentity, IpAddress, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "Counter64", "Integer32", "MibIdentifier", "ObjectIdentity", "IpAddress", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("STEELHEAD-MIB", cfKeepaliveTimeout=cfKeepaliveTimeout, crlStatus=crlStatus, cliUserLogout=cliUserLogout, licenseExpiring=licenseExpiring, diskError=diskError, ttSrcHostIp=ttSrcHostIp, neighborDynReqRcvd=neighborDynReqRcvd, health=health, temperatureNormal=temperatureNormal, cfKeepaliveTimeoutClear=cfKeepaliveTimeoutClear, bypassModeClear=bypassModeClear, ttTalkerId=ttTalkerId, peerStatus=peerStatus, linkError=linkError, neighborNatReqRcvd=neighborNatReqRcvd, powerSupplyError=powerSupplyError, sysdetailErrorClear=sysdetailErrorClear, neighborState=neighborState, nghAggrDynReqRcvd=nghAggrDynReqRcvd, bwPassThroughIn=bwPassThroughIn, ttDestHostIp=ttDestHostIp, nghAggrNatDelSent=nghAggrNatDelSent, wearWarning=wearWarning, ttSrcHostByteCount=ttSrcHostByteCount, lanWanLoopError=lanWanLoopError, outofpathSupport=outofpathSupport, rspGeneralError=rspGeneralError, admissionTcpErrorClear=admissionTcpErrorClear, nghAggrRedirReqRcvd=nghAggrRedirReqRcvd, procCrash=procCrash, procName=procName, ttAppPortId=ttAppPortId, bandwidthPassThrough=bandwidthPassThrough, clusterDisconnectedSHAlertClear=clusterDisconnectedSHAlertClear, system=system, nghAggrRedirDelSent=nghAggrRedirDelSent, nfsV2V4=nfsV2V4, rspGeneralClear=rspGeneralClear, bandwidthHC=bandwidthHC, bwHCPortEntry=bwHCPortEntry, bwPortOutWan=bwPortOutWan, licenseExpired=licenseExpired, nghAggrRedirAckSent=nghAggrRedirAckSent, cpuIndivIndex=cpuIndivIndex, ttSrcHostId=ttSrcHostId, ttAppPortByteCount=ttAppPortByteCount, bwPortOutLan=bwPortOutLan, alarms=alarms, nghAggrDynDelSent=nghAggrDynDelSent, config=config, peerHostname=peerHostname, tcpDumpScheduled=tcpDumpScheduled, status=status, cfLatencyExceededClear=cfLatencyExceededClear, ipmi=ipmi, systemDiskFullErrorClear=systemDiskFullErrorClear, nghAggrRedirReqSent=nghAggrRedirReqSent, datastoreSyncFailure=datastoreSyncFailure, licenseErrorClear=licenseErrorClear, temperatureNonCritical=temperatureNonCritical, storageProfSwitchFailed=storageProfSwitchFailed, crlIndex=crlIndex, bwHCPortTable=bwHCPortTable, datastoreSyncFailureClear=datastoreSyncFailureClear, neighborNatReqSent=neighborNatReqSent, bwAggInLan=bwAggInLan, procIndex=procIndex, cpuLoad15=cpuLoad15, admissionCpuError=admissionCpuError, neighborRedirReqSent=neighborRedirReqSent, cpuLoad=cpuLoad, peerVersionMismatch=peerVersionMismatch, asymRouteError=asymRouteError, capabilityStatus=capabilityStatus, admissionMapiErrorClear=admissionMapiErrorClear, cpuIndivUserTime=cpuIndivUserTime, nghAggrConfigured=nghAggrConfigured, bwAggOutWan=bwAggOutWan, bwAggOutLan=bwAggOutLan, secureVaultNeedsRekey=secureVaultNeedsRekey, systemHealth=systemHealth, crlClear=crlClear, neighborDynReqSent=neighborDynReqSent, procNumFailures=procNumFailures, neighborAddress=neighborAddress, cpuIndivUtilEntry=cpuIndivUtilEntry, raidError=raidError, secureVaultNeedsUnlock=secureVaultNeedsUnlock, cfConnFailure=cfConnFailure, topTalkers=topTalkers, flashErrorClear=flashErrorClear, storeCorruptionClear=storeCorruptionClear, hardwareErrorClear=hardwareErrorClear, cpuIndivId=cpuIndivId, bwAggInWan=bwAggInWan, datastoreSyncAddr=datastoreSyncAddr, admissionConnErrorClear=admissionConnErrorClear, linkDuplex=linkDuplex, neighborDynAckSent=neighborDynAckSent, bypassMode=bypassMode, admissionTcpError=admissionTcpError, alarmsPrefix=alarmsPrefix, totalConnections=totalConnections, crlError=crlError, shMaxConnections=shMaxConnections, bwHCPortInLan=bwHCPortInLan, temperatureCritical=temperatureCritical, neighborRedirDelRcvd=neighborRedirDelRcvd, cfConnLostErrClear=cfConnLostErrClear, nghAggrNatAckRcvd=nghAggrNatAckRcvd, bwHCAggInWan=bwHCAggInWan, bwPortEntry=bwPortEntry, memoryErrorClear=memoryErrorClear, peerTable=peerTable, datastoreSync=datastoreSync, cpuLoad5=cpuLoad5, bwPassThroughTotal=bwPassThroughTotal, outofpath=outofpath, nghAggrConnFailures=nghAggrConnFailures, configChange=configChange, ttTalkerIp2=ttTalkerIp2, bwHCPortOutWan=bwHCPortOutWan, admissionCpuErrorClear=admissionCpuErrorClear, neighborDynDelRcvd=neighborDynDelRcvd, ttAppPortTable=ttAppPortTable, cpuUtilClear=cpuUtilClear, nghAggrDynAckSent=nghAggrDynAckSent, bwHCAggInLan=bwHCAggInLan, webUserLogout=webUserLogout, dsCostPerSegment=dsCostPerSegment, nghAggrMaxLatency=nghAggrMaxLatency, confModeEnter=confModeEnter, bwHCPortOutLan=bwHCPortOutLan, upgradeFailure=upgradeFailure, cfReadInfoTimeoutClear=cfReadInfoTimeoutClear, procTable=procTable, asymRouteCount=asymRouteCount, bwHCPortInWan=bwHCPortInWan, nghAggrDynDelRcvd=nghAggrDynDelRcvd, licenseError=licenseError, cfAckTimeoutClear=cfAckTimeoutClear, optimizedConnections=optimizedConnections, peerIndex=peerIndex, dsMissTotal=dsMissTotal, ttAppPort=ttAppPort, pagingActivityClear=pagingActivityClear, bandwidthHCAggregate=bandwidthHCAggregate, sslPeeringSCEPAutoReenrollError=sslPeeringSCEPAutoReenrollError, passthroughConnections=passthroughConnections, linkIoErrorsClear=linkIoErrorsClear, procEntry=procEntry, neighborTable=neighborTable, bandwidthPerPort=bandwidthPerPort, smbAlertClear=smbAlertClear, diskErrorClear=diskErrorClear, nghAggrNatReqSent=nghAggrNatReqSent, crlTable=crlTable, crlNumCdpErr=crlNumCdpErr, bandwidthAggregate=bandwidthAggregate, ttDestHostTable=ttDestHostTable, neighborIndex=neighborIndex, ttSrcHostEntry=ttSrcHostEntry, inpathSupport=inpathSupport, nghAggrDynAckRcvd=nghAggrDynAckRcvd, nghAggrNatAckSent=nghAggrNatAckSent, neighborNatDelRcvd=neighborNatDelRcvd, bwHCPortNumber=bwHCPortNumber, crlErrMsg=crlErrMsg, bandwidthHCPerPort=bandwidthHCPerPort, procExit=procExit, serviceErrorClear=serviceErrorClear, cfLatencyExceeded=cfLatencyExceeded, activeConnections=activeConnections, neighborDynAckRcvd=neighborDynAckRcvd, ttTalkerPort1=ttTalkerPort1, systemClock=systemClock, neighborRedirDelSent=neighborRedirDelSent, crlEntry=crlEntry, neighborNatAckSent=neighborNatAckSent, peerVersion=peerVersion, certsExpiringError=certsExpiringError, tcpDumpStarted=tcpDumpStarted, model=model, configSave=configSave, steelhead=steelhead, cpuIndivIdleTime=cpuIndivIdleTime, nfsV2V4Clear=nfsV2V4Clear, peerAddress=peerAddress, bwPortNumber=bwPortNumber, linkIoErrors=linkIoErrors, serviceError=serviceError, temperatureWarning=temperatureWarning, ttDestHostId=ttDestHostId, sysdetailError=sysdetailError, nghAggrRequestTimeouts=nghAggrRequestTimeouts, secureVaultInitError=secureVaultInitError, pagingActivity=pagingActivity, admissionMemErrorClear=admissionMemErrorClear, PYSNMP_MODULE_ID=steelhead, neighborConnFailures=neighborConnFailures, nghAggrNatDelRcvd=nghAggrNatDelRcvd, fanError=fanError, cfAckTimeout=cfAckTimeout, cpuUtil=cpuUtil, neighborRedirAckSent=neighborRedirAckSent, bwAggHCOutWan=bwAggHCOutWan, raidErrorClear=raidErrorClear, connectionCounts=connectionCounts, optimizationServiceStatusClear=optimizationServiceStatusClear, healthNotes=healthNotes, neighborKeepaliveTimeouts=neighborKeepaliveTimeouts, admissionMemError=admissionMemError, establishedConnections=establishedConnections, trapTest=trapTest, bwPortInLan=bwPortInLan, procStatus=procStatus, cfConnLostErr=cfConnLostErr, smartError=smartError, neighborRequestTimeouts=neighborRequestTimeouts, newUserCreated=newUserCreated, haltErrorClear=haltErrorClear, datastore=datastore, bandwidth=bandwidth, secureVaultClear=secureVaultClear, neighborRedirReqRcvd=neighborRedirReqRcvd, bwPassThroughOut=bwPassThroughOut, flashError=flashError, clusterDisconnectedSHAlertError=clusterDisconnectedSHAlertError, neighborAggregates=neighborAggregates, sslPeeringSCEPAutoReenrollClear=sslPeeringSCEPAutoReenrollClear, smbAlert=smbAlert, confModeExit=confModeExit, nghAggrConnected=nghAggrConnected, rspServiceError=rspServiceError, admissionMapiError=admissionMapiError, systemTemperature=systemTemperature, admissionConnError=admissionConnError, domainJoinError=domainJoinError, activeConfig=activeConfig, optServiceStatus=optServiceStatus, ttTalkerByteCount=ttTalkerByteCount, webUserLogin=webUserLogin, powerSupplyErrorClear=powerSupplyErrorClear, serviceUptime=serviceUptime, haltError=haltError, ttTalkerIp1=ttTalkerIp1, cfReadInfoTimeout=cfReadInfoTimeout, storeCorruption=storeCorruption, cliUserLogin=cliUserLogin, halfClosedConnections=halfClosedConnections, crlFeatureName=crlFeatureName, certsExpiringErrorClear=certsExpiringErrorClear, peerVersionMismatchClear=peerVersionMismatchClear, ttTalkerPort2=ttTalkerPort2)
mibBuilder.exportSymbols("STEELHEAD-MIB", neighborDynDelSent=neighborDynDelSent, neighborIncompatibility=neighborIncompatibility, dsHitsTotal=dsHitsTotal, memoryError=memoryError, halfOpenedConnections=halfOpenedConnections, serviceStatus=serviceStatus, rspServiceClear=rspServiceClear, systemDiskFullError=systemDiskFullError, lanWanLoopClear=lanWanLoopClear, neighborIncompatibilityClear=neighborIncompatibilityClear, optimizationServiceStatusError=optimizationServiceStatusError, cpuIndivUtilTable=cpuIndivUtilTable, cpuIndivSystemTime=cpuIndivSystemTime, cfConnLostEosClear=cfConnLostEosClear, neighborStatus=neighborStatus, nghAggrDynReqSent=nghAggrDynReqSent, ttAppPortEntry=ttAppPortEntry, nghAggrRedirDelRcvd=nghAggrRedirDelRcvd, bwPortInWan=bwPortInWan, neighborRedirAckRcvd=neighborRedirAckRcvd, scheduledJobError=scheduledJobError, linkErrorClear=linkErrorClear, nghAggrRedirAckRcvd=nghAggrRedirAckRcvd, systemVersion=systemVersion, hardwareError=hardwareError, cpuUtil1=cpuUtil1, ttSrcHostTable=ttSrcHostTable, peerModel=peerModel, upgradeFailureClear=upgradeFailureClear, ttDestHostEntry=ttDestHostEntry, bwHCAggOutLan=bwHCAggOutLan, ttDestHostByteCount=ttDestHostByteCount, linkDuplexClear=linkDuplexClear, bwPortTable=bwPortTable, nghAggrKeepaliveTimouts=nghAggrKeepaliveTimouts, neighborNatAckRcvd=neighborNatAckRcvd, neighborMaxLatency=neighborMaxLatency, datastoreSyncPort=datastoreSyncPort, neighborNatDelSent=neighborNatDelSent, ipmiClear=ipmiClear, ttTalkersTable=ttTalkersTable, neighborEntry=neighborEntry, fanErrorClear=fanErrorClear, serialNumber=serialNumber, cfConnRestored=cfConnRestored, asymRouteErrorClear=asymRouteErrorClear, inpath=inpath, datastoreWrapped=datastoreWrapped, ttTalkersEntry=ttTalkersEntry, statistics=statistics, nghAggrNatReqRcvd=nghAggrNatReqRcvd, shMaxBandwidth=shMaxBandwidth, cfConnLostEos=cfConnLostEos, cpuLoad1=cpuLoad1, domainJoinErrorClear=domainJoinErrorClear, dsAveDiskUtilization=dsAveDiskUtilization, peerEntry=peerEntry)
