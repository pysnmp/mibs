...
# ASN.1 source DOT12-IF-MIB
# Source digest sha256:47a34b618a55db7b4c2e3ef3c3a6d1a3baedd5521bae79740da3f7297c5d5235
...
if mibBuilder.loadTexts: dot12MIB.setLastUpdated('1996-02-22 04:52')
...
dot12ConfigTable = MibTable((1, 3, 6, 1, 2, 1, 10, 45, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: dot12ConfigTable.setStatus('current')
dot12ConfigEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 45, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
dot12StatTable = MibTable((1, 3, 6, 1, 2, 1, 10, 45, 1, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: dot12StatTable.setStatus('current')
dot12StatEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 45, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
mibBuilder.exportSymbols("DOT12-IF-MIB", PYSNMP_MODULE_ID=dot12MIB, dot12Commands=dot12Commands, dot12Compliance=dot12Compliance, dot12Compliances=dot12Compliances, dot12ConfigEntry=dot12ConfigEntry, dot12ConfigGroup=dot12ConfigGroup, dot12ConfigTable=dot12ConfigTable, dot12Conformance=dot12Conformance, dot12ControlMode=dot12ControlMode, dot12CurrentFramingType=dot12CurrentFramingType, dot12DesiredFramingType=dot12DesiredFramingType, dot12DesiredPromiscStatus=dot12DesiredPromiscStatus, dot12FramingCapability=dot12FramingCapability, dot12Groups=dot12Groups, dot12HCInHighPriorityOctets=dot12HCInHighPriorityOctets, dot12HCInNormPriorityOctets=dot12HCInNormPriorityOctets, dot12HCOutHighPriorityOctets=dot12HCOutHighPriorityOctets, dot12InDataErrors=dot12InDataErrors, dot12InHighPriorityFrames=dot12InHighPriorityFrames, dot12InHighPriorityOctets=dot12InHighPriorityOctets, dot12InIPMErrors=dot12InIPMErrors, dot12InNormPriorityFrames=dot12InNormPriorityFrames, dot12InNormPriorityOctets=dot12InNormPriorityOctets, dot12InNullAddressedFrames=dot12InNullAddressedFrames, dot12InOversizeFrameErrors=dot12InOversizeFrameErrors, dot12LastTrainingConfig=dot12LastTrainingConfig, dot12MIB=dot12MIB, dot12MIBObjects=dot12MIBObjects, dot12OutHighPriorityFrames=dot12OutHighPriorityFrames, dot12OutHighPriorityOctets=dot12OutHighPriorityOctets, dot12StatEntry=dot12StatEntry, dot12StatTable=dot12StatTable, dot12StatsGroup=dot12StatsGroup, dot12Status=dot12Status, dot12TrainingVersion=dot12TrainingVersion, dot12TransitionIntoTrainings=dot12TransitionIntoTrainings)
