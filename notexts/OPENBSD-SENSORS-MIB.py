...
# ASN.1 source OPENBSD-SENSORS-MIB
# Source digest sha256:91dc813eeb47386d87f888418cb28b095709d19d03605664b6f1ecba2cad8de9
...
if mibBuilder.loadTexts: sensorsMIBObjects.setLastUpdated('2012-09-20 00:00')
...
sensorTable = MibTable((1, 3, 6, 1, 4, 1, 30155, 2, 1, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sensorTable.setStatus('current')
sensorEntry = MibTableRow((1, 3, 6, 1, 4, 1, 30155, 2, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "OPENBSD-SENSORS-MIB", "sensorIndex"))
...
mibBuilder.exportSymbols("OPENBSD-SENSORS-MIB", PYSNMP_MODULE_ID=sensorsMIBObjects, sensorDescr=sensorDescr, sensorDevice=sensorDevice, sensorEntry=sensorEntry, sensorIndex=sensorIndex, sensorNumber=sensorNumber, sensorStatus=sensorStatus, sensorTable=sensorTable, sensorType=sensorType, sensorUnits=sensorUnits, sensorValue=sensorValue, sensors=sensors, sensorsMIBObjects=sensorsMIBObjects)
