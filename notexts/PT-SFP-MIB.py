...
mibBuilder.exportSymbols("PT-SFP-MIB", installState=installState, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, vendorPn=vendorPn, length9m100m=length9m100m, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, rxPower=rxPower, length62m10m=length62m10m, levelRx=levelRx, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, brNominal=brNominal, saleableEntityCode=saleableEntityCode, length9m1km=length9m1km, ptSFP=ptSFP, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, vendorOui=vendorOui, temperature=temperature, vendorName=vendorName, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, ptSFPTable=ptSFPTable, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, connectorType=connectorType, ptSFPFullCompliance=ptSFPFullCompliance, txPower=txPower)
