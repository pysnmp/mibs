...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFP=ptSFP, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui, levelRx=levelRx, length9m1km=length9m1km, ConnectorTypeTC=ConnectorTypeTC, txPower=txPower, length50m10m=length50m10m, vendorRev=vendorRev, temperature=temperature, ptSFPEntry=ptSFPEntry, brNominal=brNominal, vcc=vcc, lengthCopper1m=lengthCopper1m, PYSNMP_MODULE_ID=ptSFP, saleableEntityCode=saleableEntityCode, installState=installState, length9m100m=length9m100m, connectorType=connectorType, ptSFPConformance=ptSFPConformance, rxPower=rxPower, vendorName=vendorName, biasCurrent=biasCurrent, vendorPn=vendorPn, vendorSn=vendorSn, WaveLengthTC=WaveLengthTC, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, installedWavelength=installedWavelength, ptSFPTable=ptSFPTable)
