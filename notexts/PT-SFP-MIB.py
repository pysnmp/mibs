...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPGroups=ptSFPGroups, temperature=temperature, rxPower=rxPower, saleableEntityCode=saleableEntityCode, vendorRev=vendorRev, biasCurrent=biasCurrent, vendorPn=vendorPn, vcc=vcc, PYSNMP_MODULE_ID=ptSFP, length62m10m=length62m10m, vendorSn=vendorSn, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, length9m1km=length9m1km, levelRx=levelRx, vendorName=vendorName, installedSFP=installedSFP, connectorType=connectorType, length9m100m=length9m100m, ptSFPEntry=ptSFPEntry, txPower=txPower, WaveLengthTC=WaveLengthTC, ptSFP=ptSFP, lengthCopper1m=lengthCopper1m, installState=installState, PortInterfaceTC=PortInterfaceTC, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, length50m10m=length50m10m, InstallStateTC=InstallStateTC, brNominal=brNominal, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable)
