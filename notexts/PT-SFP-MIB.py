...
mibBuilder.exportSymbols("PT-SFP-MIB", biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, vendorName=vendorName, vendorOui=vendorOui, length9m1km=length9m1km, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, rxPower=rxPower, vendorSn=vendorSn, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, ConnectorTypeTC=ConnectorTypeTC, installedSFP=installedSFP, lengthCopper1m=lengthCopper1m, length50m10m=length50m10m, connectorType=connectorType, InstallStateTC=InstallStateTC, length9m100m=length9m100m, levelRx=levelRx, brNominal=brNominal, txPower=txPower, installedWavelength=installedWavelength, temperature=temperature, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, ptSFPEntry=ptSFPEntry, vendorPn=vendorPn, WaveLengthTC=WaveLengthTC)
