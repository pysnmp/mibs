...
mibBuilder.exportSymbols("PT-SFP-MIB", txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, brNominal=brNominal, connectorType=connectorType, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, length62m10m=length62m10m, PortInterfaceTC=PortInterfaceTC, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, length9m1km=length9m1km, temperature=temperature, vendorRev=vendorRev, installState=installState, ptSFP=ptSFP, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, length50m10m=length50m10m, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, vendorOui=vendorOui, vendorName=vendorName, lengthCopper1m=lengthCopper1m, vcc=vcc, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, rxPower=rxPower, ptSFPEntry=ptSFPEntry, installedWavelength=installedWavelength, ptSFPTable=ptSFPTable)
