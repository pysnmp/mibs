...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, temperature=temperature, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, installedSFP=installedSFP, ptSFPEntry=ptSFPEntry, saleableEntityCode=saleableEntityCode, rxPower=rxPower, brNominal=brNominal, ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, ConnectorTypeTC=ConnectorTypeTC, ptSFPGroups=ptSFPGroups, length9m100m=length9m100m, vendorName=vendorName, vendorPn=vendorPn, vendorSn=vendorSn, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, txPower=txPower, installState=installState, vendorOui=vendorOui, ptSFP=ptSFP, vendorRev=vendorRev, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, vcc=vcc, levelRx=levelRx)
