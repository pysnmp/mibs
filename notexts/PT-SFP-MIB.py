...
mibBuilder.exportSymbols("PT-SFP-MIB", PortInterfaceTC=PortInterfaceTC, ConnectorTypeTC=ConnectorTypeTC, ptSFPGroups=ptSFPGroups, length62m10m=length62m10m, biasCurrent=biasCurrent, vendorOui=vendorOui, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, saleableEntityCode=saleableEntityCode, installState=installState, ptSFPCompleteGroup=ptSFPCompleteGroup, PYSNMP_MODULE_ID=ptSFP, rxPower=rxPower, txPower=txPower, length50m10m=length50m10m, connectorType=connectorType, ptSFPEntry=ptSFPEntry, levelRx=levelRx, vendorSn=vendorSn, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, temperature=temperature, WaveLengthTC=WaveLengthTC, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, length9m100m=length9m100m, installedWavelength=installedWavelength, vendorPn=vendorPn, vcc=vcc, InstallStateTC=InstallStateTC, vendorName=vendorName, ptSFPTable=ptSFPTable, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev, brNominal=brNominal)
