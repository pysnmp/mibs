...
mibBuilder.exportSymbols("PT-SFP-MIB", temperature=temperature, vendorRev=vendorRev, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, vendorSn=vendorSn, InstallStateTC=InstallStateTC, vendorName=vendorName, length50m10m=length50m10m, vendorOui=vendorOui, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, txPower=txPower, length9m100m=length9m100m, WaveLengthTC=WaveLengthTC, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, vendorPn=vendorPn, lengthCopper1m=lengthCopper1m, installState=installState, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompliances=ptSFPCompliances, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, brNominal=brNominal, saleableEntityCode=saleableEntityCode, rxPower=rxPower, length62m10m=length62m10m, biasCurrent=biasCurrent, installedWavelength=installedWavelength, vcc=vcc, PYSNMP_MODULE_ID=ptSFP, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, length9m1km=length9m1km)
