...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, rxPower=rxPower, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, biasCurrent=biasCurrent, vendorOui=vendorOui, ptSFPCompliances=ptSFPCompliances, installState=installState, vendorName=vendorName, vendorSn=vendorSn, txPower=txPower, levelRx=levelRx, installedWavelength=installedWavelength, temperature=temperature, brNominal=brNominal, InstallStateTC=InstallStateTC, ptSFP=ptSFP, vendorRev=vendorRev, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, ConnectorTypeTC=ConnectorTypeTC, ptSFPTable=ptSFPTable, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, installedSFP=installedSFP, connectorType=connectorType, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, length62m10m=length62m10m, vendorPn=vendorPn, ptSFPCompleteGroup=ptSFPCompleteGroup)
