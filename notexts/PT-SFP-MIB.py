...
mibBuilder.exportSymbols("PT-SFP-MIB", length62m10m=length62m10m, vendorPn=vendorPn, levelRx=levelRx, vendorRev=vendorRev, brNominal=brNominal, installState=installState, temperature=temperature, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, PYSNMP_MODULE_ID=ptSFP, length50m10m=length50m10m, vendorOui=vendorOui, lengthCopper1m=lengthCopper1m, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, vendorName=vendorName, PortInterfaceTC=PortInterfaceTC, ConnectorTypeTC=ConnectorTypeTC, txPower=txPower, ptSFP=ptSFP, ptSFPTable=ptSFPTable, connectorType=connectorType, rxPower=rxPower, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, vcc=vcc, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, installedWavelength=installedWavelength, length9m1km=length9m1km)
