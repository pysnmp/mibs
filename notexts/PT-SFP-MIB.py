...
mibBuilder.exportSymbols("PT-SFP-MIB", length62m10m=length62m10m, length9m100m=length9m100m, installState=installState, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, txPower=txPower, PortInterfaceTC=PortInterfaceTC, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, InstallStateTC=InstallStateTC, length9m1km=length9m1km, length50m10m=length50m10m, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, PYSNMP_MODULE_ID=ptSFP, WaveLengthTC=WaveLengthTC, brNominal=brNominal, lengthCopper1m=lengthCopper1m, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, rxPower=rxPower, vendorOui=vendorOui, vendorSn=vendorSn, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, saleableEntityCode=saleableEntityCode, vendorName=vendorName, vendorPn=vendorPn, temperature=temperature, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, vendorRev=vendorRev, connectorType=connectorType)
