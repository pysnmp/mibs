...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, ptSFPGroups=ptSFPGroups, rxPower=rxPower, vendorOui=vendorOui, installState=installState, vendorSn=vendorSn, temperature=temperature, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, ptSFPConformance=ptSFPConformance, levelRx=levelRx, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, txPower=txPower, PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, ptSFP=ptSFP, vendorName=vendorName, vcc=vcc, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, ptSFPEntry=ptSFPEntry, length9m1km=length9m1km, InstallStateTC=InstallStateTC, vendorPn=vendorPn, connectorType=connectorType, vendorRev=vendorRev, biasCurrent=biasCurrent, length62m10m=length62m10m, brNominal=brNominal, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, PortInterfaceTC=PortInterfaceTC, length50m10m=length50m10m)
