...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, levelRx=levelRx, vcc=vcc, installState=installState, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, vendorSn=vendorSn, WaveLengthTC=WaveLengthTC, length62m10m=length62m10m, length9m100m=length9m100m, temperature=temperature, ptSFPGroups=ptSFPGroups, biasCurrent=biasCurrent, brNominal=brNominal, length9m1km=length9m1km, connectorType=connectorType, ptSFPTable=ptSFPTable, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, ptSFP=ptSFP, length50m10m=length50m10m, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, ptSFPConformance=ptSFPConformance, lengthCopper1m=lengthCopper1m, vendorOui=vendorOui, installedSFP=installedSFP)
