...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, lengthCopper1m=lengthCopper1m, vcc=vcc, ptSFPConformance=ptSFPConformance, temperature=temperature, installedSFP=installedSFP, vendorSn=vendorSn, ptSFPEntry=ptSFPEntry, installState=installState, length50m10m=length50m10m, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, vendorRev=vendorRev, rxPower=rxPower, brNominal=brNominal, ptSFPFullCompliance=ptSFPFullCompliance, ptSFP=ptSFP, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, txPower=txPower, ptSFPTable=ptSFPTable, connectorType=connectorType, InstallStateTC=InstallStateTC, saleableEntityCode=saleableEntityCode, installedWavelength=installedWavelength, vendorName=vendorName, ptSFPGroups=ptSFPGroups, vendorOui=vendorOui, levelRx=levelRx, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, length9m1km=length9m1km, ptSFPCompleteGroup=ptSFPCompleteGroup, PYSNMP_MODULE_ID=ptSFP, ptSFPCompliances=ptSFPCompliances)
