...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, brNominal=brNominal, length62m10m=length62m10m, length9m1km=length9m1km, length50m10m=length50m10m, vcc=vcc, vendorOui=vendorOui, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, txPower=txPower, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, ptSFPConformance=ptSFPConformance, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, rxPower=rxPower, ptSFPEntry=ptSFPEntry, temperature=temperature, vendorPn=vendorPn, vendorSn=vendorSn, saleableEntityCode=saleableEntityCode, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, levelRx=levelRx, length9m100m=length9m100m, connectorType=connectorType, installState=installState, vendorName=vendorName, lengthCopper1m=lengthCopper1m)
