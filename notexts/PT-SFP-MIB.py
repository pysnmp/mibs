...
mibBuilder.exportSymbols("PT-SFP-MIB", biasCurrent=biasCurrent, vendorOui=vendorOui, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, vendorRev=vendorRev, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, vendorName=vendorName, installedWavelength=installedWavelength, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, WaveLengthTC=WaveLengthTC, ptSFP=ptSFP, length9m1km=length9m1km, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, length62m10m=length62m10m, brNominal=brNominal, temperature=temperature, lengthCopper1m=lengthCopper1m, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, levelRx=levelRx, vcc=vcc, ptSFPTable=ptSFPTable, ptSFPGroups=ptSFPGroups, vendorPn=vendorPn, installedSFP=installedSFP, connectorType=connectorType, length50m10m=length50m10m, installState=installState, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, ptSFPConformance=ptSFPConformance)
