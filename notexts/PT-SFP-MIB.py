...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, vcc=vcc, WaveLengthTC=WaveLengthTC, vendorSn=vendorSn, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, levelRx=levelRx, vendorPn=vendorPn, InstallStateTC=InstallStateTC, ptSFPCompliances=ptSFPCompliances, biasCurrent=biasCurrent, vendorOui=vendorOui, rxPower=rxPower, temperature=temperature, vendorName=vendorName, brNominal=brNominal, ptSFP=ptSFP, ptSFPGroups=ptSFPGroups, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev, length9m1km=length9m1km, txPower=txPower, length62m10m=length62m10m, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, PYSNMP_MODULE_ID=ptSFP, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, ptSFPTable=ptSFPTable, length9m100m=length9m100m)
