...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, ConnectorTypeTC=ConnectorTypeTC, vendorSn=vendorSn, biasCurrent=biasCurrent, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, installState=installState, saleableEntityCode=saleableEntityCode, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP, levelRx=levelRx, ptSFPGroups=ptSFPGroups, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, connectorType=connectorType, PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m, rxPower=rxPower, ptSFPTable=ptSFPTable, vendorName=vendorName, WaveLengthTC=WaveLengthTC, ptSFP=ptSFP, length50m10m=length50m10m, ptSFPConformance=ptSFPConformance, installedWavelength=installedWavelength, InstallStateTC=InstallStateTC, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, brNominal=brNominal, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, vcc=vcc)
