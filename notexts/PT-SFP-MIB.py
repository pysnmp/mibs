...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPEntry=ptSFPEntry, length9m1km=length9m1km, temperature=temperature, connectorType=connectorType, txPower=txPower, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, lengthCopper1m=lengthCopper1m, vendorSn=vendorSn, PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, vendorOui=vendorOui, length62m10m=length62m10m, levelRx=levelRx, installedSFP=installedSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, PortInterfaceTC=PortInterfaceTC, vcc=vcc, length9m100m=length9m100m, biasCurrent=biasCurrent, vendorName=vendorName, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, installState=installState, ptSFPGroups=ptSFPGroups, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, rxPower=rxPower, vendorPn=vendorPn, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, ptSFP=ptSFP, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, vendorRev=vendorRev)
