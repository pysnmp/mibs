...
mibBuilder.exportSymbols("PT-SFP-MIB", installedWavelength=installedWavelength, length9m1km=length9m1km, saleableEntityCode=saleableEntityCode, ptSFPEntry=ptSFPEntry, temperature=temperature, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, installedSFP=installedSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, rxPower=rxPower, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, vendorRev=vendorRev, InstallStateTC=InstallStateTC, vendorSn=vendorSn, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, vendorPn=vendorPn, vendorName=vendorName, PYSNMP_MODULE_ID=ptSFP, brNominal=brNominal, length9m100m=length9m100m, vcc=vcc, levelRx=levelRx, length50m10m=length50m10m, txPower=txPower, length62m10m=length62m10m, WaveLengthTC=WaveLengthTC, installState=installState)
