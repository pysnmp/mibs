...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, rxPower=rxPower, installedSFP=installedSFP, txPower=txPower, brNominal=brNominal, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, vcc=vcc, vendorPn=vendorPn, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, vendorRev=vendorRev, ptSFPCompliances=ptSFPCompliances, temperature=temperature, saleableEntityCode=saleableEntityCode, connectorType=connectorType, length50m10m=length50m10m, InstallStateTC=InstallStateTC, vendorName=vendorName, levelRx=levelRx, ptSFP=ptSFP, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, vendorOui=vendorOui, vendorSn=vendorSn, length9m1km=length9m1km, biasCurrent=biasCurrent, length62m10m=length62m10m, installState=installState, PYSNMP_MODULE_ID=ptSFP)
