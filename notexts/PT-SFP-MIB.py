...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m1km=length9m1km, rxPower=rxPower, brNominal=brNominal, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, saleableEntityCode=saleableEntityCode, ptSFPConformance=ptSFPConformance, length9m100m=length9m100m, vcc=vcc, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, levelRx=levelRx, ptSFPGroups=ptSFPGroups, temperature=temperature, vendorSn=vendorSn, ptSFPEntry=ptSFPEntry, txPower=txPower, length50m10m=length50m10m, vendorPn=vendorPn, InstallStateTC=InstallStateTC, vendorOui=vendorOui, ptSFP=ptSFP, ptSFPCompliances=ptSFPCompliances, biasCurrent=biasCurrent, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, vendorRev=vendorRev, length62m10m=length62m10m, installState=installState, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, vendorName=vendorName, ConnectorTypeTC=ConnectorTypeTC)
