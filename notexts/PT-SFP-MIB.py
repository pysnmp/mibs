...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, ptSFPEntry=ptSFPEntry, installedWavelength=installedWavelength, installedSFP=installedSFP, brNominal=brNominal, vendorRev=vendorRev, WaveLengthTC=WaveLengthTC, txPower=txPower, vendorPn=vendorPn, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, ptSFPConformance=ptSFPConformance, ptSFPGroups=ptSFPGroups, vendorName=vendorName, ptSFPCompliances=ptSFPCompliances, ptSFP=ptSFP, temperature=temperature, vcc=vcc, InstallStateTC=InstallStateTC, levelRx=levelRx, vendorOui=vendorOui, connectorType=connectorType, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, rxPower=rxPower, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, ptSFPTable=ptSFPTable, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, length9m100m=length9m100m, PYSNMP_MODULE_ID=ptSFP)
