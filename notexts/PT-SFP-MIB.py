...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorName=vendorName, biasCurrent=biasCurrent, length62m10m=length62m10m, InstallStateTC=InstallStateTC, installedSFP=installedSFP, ptSFPEntry=ptSFPEntry, connectorType=connectorType, vendorSn=vendorSn, brNominal=brNominal, PYSNMP_MODULE_ID=ptSFP, saleableEntityCode=saleableEntityCode, levelRx=levelRx, lengthCopper1m=lengthCopper1m, length9m1km=length9m1km, vendorRev=vendorRev, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, txPower=txPower, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, rxPower=rxPower, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPFullCompliance=ptSFPFullCompliance, PortInterfaceTC=PortInterfaceTC, vendorPn=vendorPn, ptSFP=ptSFP, temperature=temperature, vendorOui=vendorOui, ConnectorTypeTC=ConnectorTypeTC, installState=installState, vcc=vcc, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, ptSFPGroups=ptSFPGroups)
