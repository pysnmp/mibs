...
mibBuilder.exportSymbols("PT-SFP-MIB", length62m10m=length62m10m, levelRx=levelRx, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, PYSNMP_MODULE_ID=ptSFP, ptSFP=ptSFP, txPower=txPower, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, vendorName=vendorName, vendorRev=vendorRev, biasCurrent=biasCurrent, vendorOui=vendorOui, ptSFPConformance=ptSFPConformance, ConnectorTypeTC=ConnectorTypeTC, InstallStateTC=InstallStateTC, lengthCopper1m=lengthCopper1m, brNominal=brNominal, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPGroups=ptSFPGroups, temperature=temperature, ptSFPCompliances=ptSFPCompliances, installState=installState, length9m1km=length9m1km, vendorSn=vendorSn, rxPower=rxPower, saleableEntityCode=saleableEntityCode, vendorPn=vendorPn, ptSFPCompleteGroup=ptSFPCompleteGroup, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, connectorType=connectorType, installedSFP=installedSFP, vcc=vcc)
