...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPConformance=ptSFPConformance, length62m10m=length62m10m, installedSFP=installedSFP, ptSFP=ptSFP, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, rxPower=rxPower, length50m10m=length50m10m, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, temperature=temperature, ptSFPCompliances=ptSFPCompliances, installState=installState, levelRx=levelRx, connectorType=connectorType, lengthCopper1m=lengthCopper1m, ptSFPGroups=ptSFPGroups, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, vendorName=vendorName, brNominal=brNominal, vendorOui=vendorOui, length9m1km=length9m1km, ptSFPTable=ptSFPTable, vcc=vcc, ConnectorTypeTC=ConnectorTypeTC, WaveLengthTC=WaveLengthTC, txPower=txPower, vendorPn=vendorPn, vendorSn=vendorSn, vendorRev=vendorRev)
