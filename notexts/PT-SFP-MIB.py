...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, vendorRev=vendorRev, ptSFP=ptSFP, ptSFPTable=ptSFPTable, length50m10m=length50m10m, PortInterfaceTC=PortInterfaceTC, txPower=txPower, WaveLengthTC=WaveLengthTC, vcc=vcc, length9m100m=length9m100m, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, vendorSn=vendorSn, levelRx=levelRx, rxPower=rxPower, InstallStateTC=InstallStateTC, installedSFP=installedSFP, connectorType=connectorType, vendorName=vendorName, ptSFPCompleteGroup=ptSFPCompleteGroup, installedWavelength=installedWavelength, ConnectorTypeTC=ConnectorTypeTC, temperature=temperature, PYSNMP_MODULE_ID=ptSFP, saleableEntityCode=saleableEntityCode, ptSFPConformance=ptSFPConformance, brNominal=brNominal, length9m1km=length9m1km, vendorPn=vendorPn, biasCurrent=biasCurrent, length62m10m=length62m10m, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups)
