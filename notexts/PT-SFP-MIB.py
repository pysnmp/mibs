...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorSn=vendorSn, installState=installState, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, txPower=txPower, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPConformance=ptSFPConformance, connectorType=connectorType, InstallStateTC=InstallStateTC, ptSFPGroups=ptSFPGroups, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, ptSFPTable=ptSFPTable, installedWavelength=installedWavelength, vendorPn=vendorPn, temperature=temperature, vendorName=vendorName, biasCurrent=biasCurrent, brNominal=brNominal, installedSFP=installedSFP, saleableEntityCode=saleableEntityCode, length9m1km=length9m1km, levelRx=levelRx, ptSFPEntry=ptSFPEntry, lengthCopper1m=lengthCopper1m, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, ptSFP=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, vcc=vcc)
