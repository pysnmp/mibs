...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPEntry=ptSFPEntry, length50m10m=length50m10m, ptSFP=ptSFP, ptSFPGroups=ptSFPGroups, biasCurrent=biasCurrent, vendorSn=vendorSn, length9m100m=length9m100m, saleableEntityCode=saleableEntityCode, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, levelRx=levelRx, txPower=txPower, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, brNominal=brNominal, temperature=temperature, installedSFP=installedSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, vcc=vcc, lengthCopper1m=lengthCopper1m, installState=installState, vendorName=vendorName, length9m1km=length9m1km, length62m10m=length62m10m, vendorPn=vendorPn, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, ptSFPConformance=ptSFPConformance, installedWavelength=installedWavelength, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP)
