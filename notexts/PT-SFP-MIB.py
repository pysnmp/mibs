...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, InstallStateTC=InstallStateTC, vendorOui=vendorOui, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, installedSFP=installedSFP, brNominal=brNominal, ptSFPCompliances=ptSFPCompliances, installState=installState, ptSFPEntry=ptSFPEntry, length9m100m=length9m100m, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, ptSFPTable=ptSFPTable, vcc=vcc, length9m1km=length9m1km, vendorName=vendorName, levelRx=levelRx, ptSFPGroups=ptSFPGroups, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, length50m10m=length50m10m, biasCurrent=biasCurrent, rxPower=rxPower, temperature=temperature, PortInterfaceTC=PortInterfaceTC, installedWavelength=installedWavelength)
