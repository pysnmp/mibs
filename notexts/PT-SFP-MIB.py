...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, ptSFPCompleteGroup=ptSFPCompleteGroup, txPower=txPower, brNominal=brNominal, biasCurrent=biasCurrent, ptSFPEntry=ptSFPEntry, installedSFP=installedSFP, vendorSn=vendorSn, ptSFPTable=ptSFPTable, vendorName=vendorName, connectorType=connectorType, vendorRev=vendorRev, ConnectorTypeTC=ConnectorTypeTC, saleableEntityCode=saleableEntityCode, length9m100m=length9m100m, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, temperature=temperature, ptSFPCompliances=ptSFPCompliances, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, ptSFP=ptSFP, length50m10m=length50m10m, ptSFPGroups=ptSFPGroups, rxPower=rxPower, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, length62m10m=length62m10m, installedWavelength=installedWavelength, WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, vendorOui=vendorOui)
