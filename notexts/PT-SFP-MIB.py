...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, saleableEntityCode=saleableEntityCode, ptSFPConformance=ptSFPConformance, txPower=txPower, ptSFPEntry=ptSFPEntry, installState=installState, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, ptSFPTable=ptSFPTable, vendorSn=vendorSn, ConnectorTypeTC=ConnectorTypeTC, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, length9m100m=length9m100m, installedSFP=installedSFP, vendorName=vendorName, temperature=temperature, vcc=vcc, WaveLengthTC=WaveLengthTC, InstallStateTC=InstallStateTC, connectorType=connectorType, rxPower=rxPower, ptSFPGroups=ptSFPGroups, biasCurrent=biasCurrent, length50m10m=length50m10m, ptSFP=ptSFP, length9m1km=length9m1km, PortInterfaceTC=PortInterfaceTC, installedWavelength=installedWavelength, levelRx=levelRx, lengthCopper1m=lengthCopper1m, vendorRev=vendorRev, vendorPn=vendorPn, length62m10m=length62m10m, brNominal=brNominal)
