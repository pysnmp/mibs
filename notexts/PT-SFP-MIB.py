...
mibBuilder.exportSymbols("PT-SFP-MIB", rxPower=rxPower, installState=installState, WaveLengthTC=WaveLengthTC, installedSFP=installedSFP, PYSNMP_MODULE_ID=ptSFP, vendorSn=vendorSn, biasCurrent=biasCurrent, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, length9m100m=length9m100m, txPower=txPower, vendorName=vendorName, InstallStateTC=InstallStateTC, ptSFPCompleteGroup=ptSFPCompleteGroup, temperature=temperature, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, length9m1km=length9m1km, ptSFPConformance=ptSFPConformance, saleableEntityCode=saleableEntityCode, brNominal=brNominal, installedWavelength=installedWavelength, ConnectorTypeTC=ConnectorTypeTC, length50m10m=length50m10m, ptSFP=ptSFP, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, vcc=vcc, vendorPn=vendorPn, ptSFPTable=ptSFPTable, connectorType=connectorType, vendorOui=vendorOui, length62m10m=length62m10m, levelRx=levelRx, ptSFPGroups=ptSFPGroups)
