...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, installState=installState, ptSFPTable=ptSFPTable, ConnectorTypeTC=ConnectorTypeTC, biasCurrent=biasCurrent, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPGroups=ptSFPGroups, vcc=vcc, length9m1km=length9m1km, installedSFP=installedSFP, vendorRev=vendorRev, installedWavelength=installedWavelength, brNominal=brNominal, levelRx=levelRx, length9m100m=length9m100m, connectorType=connectorType, ptSFPEntry=ptSFPEntry, rxPower=rxPower, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, lengthCopper1m=lengthCopper1m, txPower=txPower, PYSNMP_MODULE_ID=ptSFP, vendorName=vendorName, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, PortInterfaceTC=PortInterfaceTC, temperature=temperature, vendorSn=vendorSn, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, ptSFP=ptSFP)
