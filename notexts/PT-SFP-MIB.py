...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFP=ptSFP, saleableEntityCode=saleableEntityCode, ptSFPFullCompliance=ptSFPFullCompliance, installedWavelength=installedWavelength, length9m100m=length9m100m, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, length62m10m=length62m10m, vendorPn=vendorPn, PortInterfaceTC=PortInterfaceTC, txPower=txPower, brNominal=brNominal, ptSFPCompliances=ptSFPCompliances, connectorType=connectorType, temperature=temperature, length9m1km=length9m1km, InstallStateTC=InstallStateTC, length50m10m=length50m10m, vendorName=vendorName, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, vendorRev=vendorRev, biasCurrent=biasCurrent, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorOui=vendorOui, installState=installState, ptSFPGroups=ptSFPGroups, PYSNMP_MODULE_ID=ptSFP, levelRx=levelRx, rxPower=rxPower, ptSFPEntry=ptSFPEntry)
