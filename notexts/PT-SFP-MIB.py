...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, ptSFPGroups=ptSFPGroups, rxPower=rxPower, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, vendorName=vendorName, installState=installState, WaveLengthTC=WaveLengthTC, PortInterfaceTC=PortInterfaceTC, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, vendorPn=vendorPn, levelRx=levelRx, installedWavelength=installedWavelength, connectorType=connectorType, ConnectorTypeTC=ConnectorTypeTC, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, temperature=temperature, length62m10m=length62m10m, PYSNMP_MODULE_ID=ptSFP, vendorOui=vendorOui, length9m1km=length9m1km, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, brNominal=brNominal, ptSFP=ptSFP, saleableEntityCode=saleableEntityCode, txPower=txPower, ptSFPConformance=ptSFPConformance, vcc=vcc, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev)
