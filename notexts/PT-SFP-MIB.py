...
mibBuilder.exportSymbols("PT-SFP-MIB", installState=installState, vendorOui=vendorOui, installedSFP=installedSFP, rxPower=rxPower, ptSFPFullCompliance=ptSFPFullCompliance, vendorPn=vendorPn, ptSFPTable=ptSFPTable, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, length50m10m=length50m10m, levelRx=levelRx, biasCurrent=biasCurrent, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, vendorSn=vendorSn, brNominal=brNominal, ptSFPGroups=ptSFPGroups, WaveLengthTC=WaveLengthTC, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, PortInterfaceTC=PortInterfaceTC, temperature=temperature, connectorType=connectorType, length9m1km=length9m1km, length62m10m=length62m10m, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPEntry=ptSFPEntry, lengthCopper1m=lengthCopper1m, saleableEntityCode=saleableEntityCode, txPower=txPower, installedWavelength=installedWavelength, vendorRev=vendorRev, vendorName=vendorName)
