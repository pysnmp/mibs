...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFP=ptSFP, biasCurrent=biasCurrent, brNominal=brNominal, rxPower=rxPower, vendorSn=vendorSn, ptSFPFullCompliance=ptSFPFullCompliance, length9m1km=length9m1km, vendorRev=vendorRev, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, temperature=temperature, ptSFPGroups=ptSFPGroups, vendorOui=vendorOui, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, installState=installState, ptSFPTable=ptSFPTable, length50m10m=length50m10m, ConnectorTypeTC=ConnectorTypeTC, PYSNMP_MODULE_ID=ptSFP, installedWavelength=installedWavelength, saleableEntityCode=saleableEntityCode, ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, vcc=vcc, txPower=txPower, length9m100m=length9m100m, vendorName=vendorName, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, connectorType=connectorType, vendorPn=vendorPn)
