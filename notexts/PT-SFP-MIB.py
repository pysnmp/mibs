...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, installState=installState, vendorOui=vendorOui, WaveLengthTC=WaveLengthTC, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, InstallStateTC=InstallStateTC, ptSFPCompliances=ptSFPCompliances, vendorRev=vendorRev, vendorName=vendorName, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, biasCurrent=biasCurrent, length9m100m=length9m100m, rxPower=rxPower, temperature=temperature, ptSFPTable=ptSFPTable, vendorPn=vendorPn, installedWavelength=installedWavelength, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, ptSFPEntry=ptSFPEntry, txPower=txPower, length9m1km=length9m1km, PortInterfaceTC=PortInterfaceTC, connectorType=connectorType, saleableEntityCode=saleableEntityCode, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, length62m10m=length62m10m, vendorSn=vendorSn, length50m10m=length50m10m, levelRx=levelRx, brNominal=brNominal)
