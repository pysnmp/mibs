...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, ptSFP=ptSFP, installedSFP=installedSFP, PYSNMP_MODULE_ID=ptSFP, installedWavelength=installedWavelength, ptSFPTable=ptSFPTable, length62m10m=length62m10m, levelRx=levelRx, saleableEntityCode=saleableEntityCode, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, rxPower=rxPower, ptSFPCompliances=ptSFPCompliances, temperature=temperature, installState=installState, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, length9m1km=length9m1km, brNominal=brNominal, txPower=txPower, vendorSn=vendorSn, connectorType=connectorType, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorOui=vendorOui, ConnectorTypeTC=ConnectorTypeTC, ptSFPEntry=ptSFPEntry, ptSFPGroups=ptSFPGroups, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, vendorName=vendorName, length50m10m=length50m10m, PortInterfaceTC=PortInterfaceTC, ptSFPConformance=ptSFPConformance, vendorRev=vendorRev)
