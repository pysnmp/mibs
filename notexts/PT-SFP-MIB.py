...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, vendorRev=vendorRev, ptSFP=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPEntry=ptSFPEntry, vendorOui=vendorOui, length9m1km=length9m1km, temperature=temperature, PYSNMP_MODULE_ID=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, brNominal=brNominal, vendorName=vendorName, ptSFPConformance=ptSFPConformance, length62m10m=length62m10m, vendorPn=vendorPn, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, txPower=txPower, vcc=vcc, rxPower=rxPower, InstallStateTC=InstallStateTC, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, levelRx=levelRx, installState=installState, length50m10m=length50m10m, ptSFPGroups=ptSFPGroups, biasCurrent=biasCurrent, installedWavelength=installedWavelength, installedSFP=installedSFP, length9m100m=length9m100m, vendorSn=vendorSn, lengthCopper1m=lengthCopper1m, WaveLengthTC=WaveLengthTC, ptSFPCompliances=ptSFPCompliances)
