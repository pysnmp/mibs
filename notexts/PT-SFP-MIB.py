...
mibBuilder.exportSymbols("PT-SFP-MIB", txPower=txPower, InstallStateTC=InstallStateTC, length50m10m=length50m10m, levelRx=levelRx, connectorType=connectorType, vendorSn=vendorSn, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPConformance=ptSFPConformance, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, installedSFP=installedSFP, installedWavelength=installedWavelength, length9m100m=length9m100m, ptSFPGroups=ptSFPGroups, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, vendorOui=vendorOui, brNominal=brNominal, lengthCopper1m=lengthCopper1m, vendorPn=vendorPn, vendorRev=vendorRev, temperature=temperature, ptSFPTable=ptSFPTable, length9m1km=length9m1km, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, vcc=vcc, biasCurrent=biasCurrent, PYSNMP_MODULE_ID=ptSFP, ptSFPCompliances=ptSFPCompliances, saleableEntityCode=saleableEntityCode, length62m10m=length62m10m, ptSFP=ptSFP, WaveLengthTC=WaveLengthTC)
