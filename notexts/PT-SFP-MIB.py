...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorPn=vendorPn, ptSFPEntry=ptSFPEntry, rxPower=rxPower, ptSFPConformance=ptSFPConformance, PYSNMP_MODULE_ID=ptSFP, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, length62m10m=length62m10m, vcc=vcc, ptSFP=ptSFP, installedWavelength=installedWavelength, ptSFPGroups=ptSFPGroups, temperature=temperature, vendorSn=vendorSn, brNominal=brNominal, length9m1km=length9m1km, length50m10m=length50m10m, vendorOui=vendorOui, vendorName=vendorName, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, biasCurrent=biasCurrent, installState=installState, installedSFP=installedSFP, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, WaveLengthTC=WaveLengthTC, levelRx=levelRx, ptSFPCompleteGroup=ptSFPCompleteGroup, txPower=txPower, lengthCopper1m=lengthCopper1m, vendorRev=vendorRev)
