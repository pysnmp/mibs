...
mibBuilder.exportSymbols("PT-SFP-MIB", biasCurrent=biasCurrent, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, levelRx=levelRx, temperature=temperature, vendorOui=vendorOui, ptSFPConformance=ptSFPConformance, vendorName=vendorName, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, vendorRev=vendorRev, saleableEntityCode=saleableEntityCode, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, InstallStateTC=InstallStateTC, PYSNMP_MODULE_ID=ptSFP, ptSFPEntry=ptSFPEntry, PortInterfaceTC=PortInterfaceTC, rxPower=rxPower, WaveLengthTC=WaveLengthTC, ConnectorTypeTC=ConnectorTypeTC, brNominal=brNominal, vendorPn=vendorPn, installedSFP=installedSFP, installedWavelength=installedWavelength, length9m100m=length9m100m, vendorSn=vendorSn, ptSFPCompleteGroup=ptSFPCompleteGroup, txPower=txPower, ptSFP=ptSFP, connectorType=connectorType, vcc=vcc)
