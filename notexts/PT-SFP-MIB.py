...
mibBuilder.exportSymbols("PT-SFP-MIB", length9m1km=length9m1km, ptSFPFullCompliance=ptSFPFullCompliance, installedSFP=installedSFP, ptSFPConformance=ptSFPConformance, temperature=temperature, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, PYSNMP_MODULE_ID=ptSFP, vendorSn=vendorSn, vendorRev=vendorRev, connectorType=connectorType, vendorOui=vendorOui, vendorPn=vendorPn, brNominal=brNominal, length9m100m=length9m100m, InstallStateTC=InstallStateTC, ptSFPCompleteGroup=ptSFPCompleteGroup, WaveLengthTC=WaveLengthTC, rxPower=rxPower, biasCurrent=biasCurrent, txPower=txPower, ptSFP=ptSFP, lengthCopper1m=lengthCopper1m, length50m10m=length50m10m, vendorName=vendorName, saleableEntityCode=saleableEntityCode, PortInterfaceTC=PortInterfaceTC, ptSFPCompliances=ptSFPCompliances, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, vcc=vcc, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, levelRx=levelRx, installState=installState)
