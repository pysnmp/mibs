...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, installState=installState, vendorRev=vendorRev, lengthCopper1m=lengthCopper1m, ptSFPGroups=ptSFPGroups, length9m1km=length9m1km, PYSNMP_MODULE_ID=ptSFP, temperature=temperature, WaveLengthTC=WaveLengthTC, ptSFPEntry=ptSFPEntry, vendorPn=vendorPn, installedWavelength=installedWavelength, biasCurrent=biasCurrent, txPower=txPower, levelRx=levelRx, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, ptSFPCompleteGroup=ptSFPCompleteGroup, InstallStateTC=InstallStateTC, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, vendorOui=vendorOui, saleableEntityCode=saleableEntityCode, vendorName=vendorName, ConnectorTypeTC=ConnectorTypeTC, length9m100m=length9m100m, length50m10m=length50m10m, ptSFP=ptSFP, rxPower=rxPower, ptSFPTable=ptSFPTable, vcc=vcc, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP)
