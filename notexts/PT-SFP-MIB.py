...
mibBuilder.exportSymbols("PT-SFP-MIB", PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, installedWavelength=installedWavelength, vendorName=vendorName, length9m1km=length9m1km, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, ptSFPTable=ptSFPTable, WaveLengthTC=WaveLengthTC, levelRx=levelRx, ptSFPGroups=ptSFPGroups, temperature=temperature, length50m10m=length50m10m, length62m10m=length62m10m, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, vcc=vcc, InstallStateTC=InstallStateTC, brNominal=brNominal, installState=installState, vendorOui=vendorOui, vendorRev=vendorRev, rxPower=rxPower, ptSFPConformance=ptSFPConformance, connectorType=connectorType, saleableEntityCode=saleableEntityCode, installedSFP=installedSFP, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, vendorPn=vendorPn, ConnectorTypeTC=ConnectorTypeTC, vendorSn=vendorSn, ptSFP=ptSFP, biasCurrent=biasCurrent)
