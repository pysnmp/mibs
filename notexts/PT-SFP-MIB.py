...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, vendorOui=vendorOui, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, brNominal=brNominal, saleableEntityCode=saleableEntityCode, WaveLengthTC=WaveLengthTC, connectorType=connectorType, installedSFP=installedSFP, ptSFP=ptSFP, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, vendorRev=vendorRev, lengthCopper1m=lengthCopper1m, InstallStateTC=InstallStateTC, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, txPower=txPower, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompliances=ptSFPCompliances, installedWavelength=installedWavelength, vendorName=vendorName, vendorPn=vendorPn, PortInterfaceTC=PortInterfaceTC, vcc=vcc, ptSFPTable=ptSFPTable, PYSNMP_MODULE_ID=ptSFP, vendorSn=vendorSn, temperature=temperature, biasCurrent=biasCurrent, installState=installState, ptSFPConformance=ptSFPConformance, rxPower=rxPower, length50m10m=length50m10m, ptSFPEntry=ptSFPEntry)
