...
mibBuilder.exportSymbols("PT-SFP-MIB", saleableEntityCode=saleableEntityCode, txPower=txPower, connectorType=connectorType, installState=installState, length9m100m=length9m100m, length62m10m=length62m10m, InstallStateTC=InstallStateTC, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, WaveLengthTC=WaveLengthTC, vendorSn=vendorSn, ptSFPTable=ptSFPTable, biasCurrent=biasCurrent, ptSFPEntry=ptSFPEntry, vcc=vcc, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, temperature=temperature, vendorRev=vendorRev, ConnectorTypeTC=ConnectorTypeTC, length50m10m=length50m10m, brNominal=brNominal, PYSNMP_MODULE_ID=ptSFP, vendorName=vendorName, installedWavelength=installedWavelength, ptSFPFullCompliance=ptSFPFullCompliance, ptSFP=ptSFP, rxPower=rxPower, levelRx=levelRx, length9m1km=length9m1km)
