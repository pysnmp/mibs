...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPTable=ptSFPTable, txPower=txPower, WaveLengthTC=WaveLengthTC, ptSFP=ptSFP, vcc=vcc, installState=installState, saleableEntityCode=saleableEntityCode, rxPower=rxPower, installedSFP=installedSFP, ptSFPConformance=ptSFPConformance, ptSFPEntry=ptSFPEntry, vendorOui=vendorOui, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, biasCurrent=biasCurrent, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, PortInterfaceTC=PortInterfaceTC, vendorRev=vendorRev, temperature=temperature, connectorType=connectorType, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, brNominal=brNominal, vendorSn=vendorSn, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, vendorPn=vendorPn, levelRx=levelRx, installedWavelength=installedWavelength, length9m1km=length9m1km, vendorName=vendorName)
