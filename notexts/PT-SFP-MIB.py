...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, ptSFPConformance=ptSFPConformance, InstallStateTC=InstallStateTC, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, temperature=temperature, vcc=vcc, vendorSn=vendorSn, saleableEntityCode=saleableEntityCode, installedWavelength=installedWavelength, PortInterfaceTC=PortInterfaceTC, vendorRev=vendorRev, length62m10m=length62m10m, ptSFPEntry=ptSFPEntry, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFP=ptSFP, PYSNMP_MODULE_ID=ptSFP, biasCurrent=biasCurrent, vendorPn=vendorPn, length9m100m=length9m100m, rxPower=rxPower, ptSFPTable=ptSFPTable, vendorName=vendorName, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, txPower=txPower, ptSFPCompliances=ptSFPCompliances, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, installState=installState, lengthCopper1m=lengthCopper1m, brNominal=brNominal, length9m1km=length9m1km)
