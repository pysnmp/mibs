...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPConformance=ptSFPConformance, vendorOui=vendorOui, levelRx=levelRx, ptSFPFullCompliance=ptSFPFullCompliance, ConnectorTypeTC=ConnectorTypeTC, installedSFP=installedSFP, biasCurrent=biasCurrent, vendorName=vendorName, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, temperature=temperature, InstallStateTC=InstallStateTC, length9m100m=length9m100m, vendorRev=vendorRev, vcc=vcc, ptSFPCompliances=ptSFPCompliances, length9m1km=length9m1km, length50m10m=length50m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, brNominal=brNominal, vendorPn=vendorPn, txPower=txPower, lengthCopper1m=lengthCopper1m, rxPower=rxPower, PYSNMP_MODULE_ID=ptSFP, WaveLengthTC=WaveLengthTC, saleableEntityCode=saleableEntityCode, connectorType=connectorType, length62m10m=length62m10m, ptSFP=ptSFP, ptSFPEntry=ptSFPEntry, ptSFPTable=ptSFPTable, installState=installState, vendorSn=vendorSn, installedWavelength=installedWavelength)
