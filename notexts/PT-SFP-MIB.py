...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, ptSFPGroups=ptSFPGroups, vendorRev=vendorRev, txPower=txPower, rxPower=rxPower, saleableEntityCode=saleableEntityCode, connectorType=connectorType, ptSFPCompleteGroup=ptSFPCompleteGroup, lengthCopper1m=lengthCopper1m, temperature=temperature, length9m100m=length9m100m, vendorSn=vendorSn, installedWavelength=installedWavelength, vcc=vcc, installState=installState, length62m10m=length62m10m, WaveLengthTC=WaveLengthTC, ptSFPTable=ptSFPTable, vendorOui=vendorOui, biasCurrent=biasCurrent, ptSFPCompliances=ptSFPCompliances, installedSFP=installedSFP, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, levelRx=levelRx, length9m1km=length9m1km, brNominal=brNominal, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, ptSFP=ptSFP, InstallStateTC=InstallStateTC)
