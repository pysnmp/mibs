...
mibBuilder.exportSymbols("PT-SFP-MIB", installState=installState, brNominal=brNominal, WaveLengthTC=WaveLengthTC, vcc=vcc, ptSFPGroups=ptSFPGroups, installedSFP=installedSFP, vendorSn=vendorSn, vendorName=vendorName, length9m100m=length9m100m, PortInterfaceTC=PortInterfaceTC, temperature=temperature, vendorPn=vendorPn, vendorOui=vendorOui, length9m1km=length9m1km, saleableEntityCode=saleableEntityCode, rxPower=rxPower, ptSFPCompleteGroup=ptSFPCompleteGroup, ConnectorTypeTC=ConnectorTypeTC, vendorRev=vendorRev, ptSFPConformance=ptSFPConformance, levelRx=levelRx, PYSNMP_MODULE_ID=ptSFP, biasCurrent=biasCurrent, installedWavelength=installedWavelength, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m, ptSFPCompliances=ptSFPCompliances, connectorType=connectorType, txPower=txPower, ptSFPTable=ptSFPTable, InstallStateTC=InstallStateTC, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, length50m10m=length50m10m, ptSFP=ptSFP)
