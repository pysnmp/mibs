...
mibBuilder.exportSymbols("PT-SFP-MIB", biasCurrent=biasCurrent, ptSFP=ptSFP, installedSFP=installedSFP, vendorPn=vendorPn, connectorType=connectorType, length9m1km=length9m1km, length50m10m=length50m10m, brNominal=brNominal, temperature=temperature, ptSFPEntry=ptSFPEntry, ConnectorTypeTC=ConnectorTypeTC, lengthCopper1m=lengthCopper1m, vendorRev=vendorRev, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, vendorSn=vendorSn, vendorName=vendorName, txPower=txPower, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength, saleableEntityCode=saleableEntityCode, installState=installState, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, levelRx=levelRx, length62m10m=length62m10m, ptSFPGroups=ptSFPGroups, ptSFPCompleteGroup=ptSFPCompleteGroup, rxPower=rxPower, PortInterfaceTC=PortInterfaceTC, length9m100m=length9m100m, ptSFPCompliances=ptSFPCompliances)
