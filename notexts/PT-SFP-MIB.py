...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, WaveLengthTC=WaveLengthTC, ptSFPConformance=ptSFPConformance, ConnectorTypeTC=ConnectorTypeTC, vendorName=vendorName, installedWavelength=installedWavelength, length50m10m=length50m10m, lengthCopper1m=lengthCopper1m, vendorSn=vendorSn, installedSFP=installedSFP, rxPower=rxPower, ptSFPCompleteGroup=ptSFPCompleteGroup, installState=installState, ptSFPCompliances=ptSFPCompliances, length9m1km=length9m1km, biasCurrent=biasCurrent, vendorOui=vendorOui, PortInterfaceTC=PortInterfaceTC, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, PYSNMP_MODULE_ID=ptSFP, length9m100m=length9m100m, length62m10m=length62m10m, ptSFP=ptSFP, connectorType=connectorType, ptSFPEntry=ptSFPEntry, txPower=txPower, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, temperature=temperature, brNominal=brNominal, saleableEntityCode=saleableEntityCode, levelRx=levelRx, vendorPn=vendorPn, vcc=vcc)
