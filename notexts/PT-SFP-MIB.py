...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFP=ptSFP, levelRx=levelRx, length9m100m=length9m100m, installState=installState, biasCurrent=biasCurrent, rxPower=rxPower, installedSFP=installedSFP, vendorOui=vendorOui, ptSFPCompliances=ptSFPCompliances, saleableEntityCode=saleableEntityCode, vendorSn=vendorSn, length62m10m=length62m10m, ConnectorTypeTC=ConnectorTypeTC, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, ptSFPTable=ptSFPTable, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, ptSFPEntry=ptSFPEntry, vcc=vcc, vendorPn=vendorPn, InstallStateTC=InstallStateTC, connectorType=connectorType, PYSNMP_MODULE_ID=ptSFP, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, installedWavelength=installedWavelength, ptSFPFullCompliance=ptSFPFullCompliance, length50m10m=length50m10m, temperature=temperature, ptSFPConformance=ptSFPConformance, WaveLengthTC=WaveLengthTC, vendorName=vendorName, brNominal=brNominal, vendorRev=vendorRev)
