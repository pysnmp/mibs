...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, temperature=temperature, levelRx=levelRx, rxPower=rxPower, ConnectorTypeTC=ConnectorTypeTC, saleableEntityCode=saleableEntityCode, ptSFPConformance=ptSFPConformance, installedSFP=installedSFP, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, vendorOui=vendorOui, ptSFPGroups=ptSFPGroups, length9m1km=length9m1km, vendorPn=vendorPn, length50m10m=length50m10m, vendorSn=vendorSn, ptSFPEntry=ptSFPEntry, vcc=vcc, brNominal=brNominal, ptSFP=ptSFP, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, connectorType=connectorType, length62m10m=length62m10m, txPower=txPower, WaveLengthTC=WaveLengthTC, vendorName=vendorName, PortInterfaceTC=PortInterfaceTC, installedWavelength=installedWavelength, ptSFPTable=ptSFPTable, PYSNMP_MODULE_ID=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorRev=vendorRev, biasCurrent=biasCurrent, installState=installState)
