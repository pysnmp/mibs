...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, vcc=vcc, vendorRev=vendorRev, length9m1km=length9m1km, ptSFP=ptSFP, vendorOui=vendorOui, PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, connectorType=connectorType, temperature=temperature, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPEntry=ptSFPEntry, biasCurrent=biasCurrent, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, ptSFPCompliances=ptSFPCompliances, ptSFPConformance=ptSFPConformance, WaveLengthTC=WaveLengthTC, installedSFP=installedSFP, vendorPn=vendorPn, rxPower=rxPower, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, length9m100m=length9m100m, installState=installState, InstallStateTC=InstallStateTC, ptSFPGroups=ptSFPGroups, PortInterfaceTC=PortInterfaceTC, vendorSn=vendorSn, vendorName=vendorName, txPower=txPower, lengthCopper1m=lengthCopper1m, length62m10m=length62m10m)
