...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, InstallStateTC=InstallStateTC, ptSFPEntry=ptSFPEntry, length9m100m=length9m100m, temperature=temperature, PortInterfaceTC=PortInterfaceTC, vendorPn=vendorPn, brNominal=brNominal, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, ptSFPTable=ptSFPTable, installedSFP=installedSFP, installedWavelength=installedWavelength, txPower=txPower, vendorRev=vendorRev, ptSFPGroups=ptSFPGroups, length62m10m=length62m10m, vendorOui=vendorOui, ConnectorTypeTC=ConnectorTypeTC, ptSFPFullCompliance=ptSFPFullCompliance, vendorSn=vendorSn, ptSFP=ptSFP, vendorName=vendorName, rxPower=rxPower, ptSFPCompliances=ptSFPCompliances, installState=installState, saleableEntityCode=saleableEntityCode, length9m1km=length9m1km, ptSFPCompleteGroup=ptSFPCompleteGroup, length50m10m=length50m10m, ptSFPConformance=ptSFPConformance, connectorType=connectorType)
