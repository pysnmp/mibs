...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, txPower=txPower, installState=installState, length9m100m=length9m100m, ptSFP=ptSFP, vendorName=vendorName, brNominal=brNominal, ptSFPConformance=ptSFPConformance, vendorSn=vendorSn, vendorRev=vendorRev, temperature=temperature, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, saleableEntityCode=saleableEntityCode, ptSFPGroups=ptSFPGroups, length9m1km=length9m1km, connectorType=connectorType, ptSFPFullCompliance=ptSFPFullCompliance, rxPower=rxPower, InstallStateTC=InstallStateTC, ptSFPTable=ptSFPTable, ptSFPEntry=ptSFPEntry, length50m10m=length50m10m, installedWavelength=installedWavelength, vendorOui=vendorOui, PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, ptSFPCompleteGroup=ptSFPCompleteGroup, ConnectorTypeTC=ConnectorTypeTC, ptSFPCompliances=ptSFPCompliances, length62m10m=length62m10m, biasCurrent=biasCurrent, vcc=vcc, installedSFP=installedSFP, PortInterfaceTC=PortInterfaceTC)
