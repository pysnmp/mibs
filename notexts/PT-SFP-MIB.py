...
mibBuilder.exportSymbols("PT-SFP-MIB", connectorType=connectorType, temperature=temperature, rxPower=rxPower, vendorRev=vendorRev, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompliances=ptSFPCompliances, ptSFP=ptSFP, ptSFPGroups=ptSFPGroups, length9m1km=length9m1km, ptSFPEntry=ptSFPEntry, ConnectorTypeTC=ConnectorTypeTC, vendorOui=vendorOui, vendorName=vendorName, ptSFPConformance=ptSFPConformance, brNominal=brNominal, ptSFPTable=ptSFPTable, PortInterfaceTC=PortInterfaceTC, biasCurrent=biasCurrent, installedWavelength=installedWavelength, length9m100m=length9m100m, installState=installState, InstallStateTC=InstallStateTC, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, installedSFP=installedSFP, vendorSn=vendorSn, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, lengthCopper1m=lengthCopper1m, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorPn=vendorPn, levelRx=levelRx, length50m10m=length50m10m)
