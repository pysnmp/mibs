...
mibBuilder.exportSymbols("PT-SFP-MIB", installedWavelength=installedWavelength, ptSFPTable=ptSFPTable, ConnectorTypeTC=ConnectorTypeTC, ptSFPFullCompliance=ptSFPFullCompliance, PYSNMP_MODULE_ID=ptSFP, ptSFPCompliances=ptSFPCompliances, txPower=txPower, WaveLengthTC=WaveLengthTC, installedSFP=installedSFP, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, vendorOui=vendorOui, vendorRev=vendorRev, vcc=vcc, biasCurrent=biasCurrent, connectorType=connectorType, length9m1km=length9m1km, PortInterfaceTC=PortInterfaceTC, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m100m=length9m100m, temperature=temperature, length62m10m=length62m10m, levelRx=levelRx, vendorPn=vendorPn, vendorSn=vendorSn, brNominal=brNominal, lengthCopper1m=lengthCopper1m, length50m10m=length50m10m, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, installState=installState, vendorName=vendorName, InstallStateTC=InstallStateTC, rxPower=rxPower, ptSFPEntry=ptSFPEntry)
