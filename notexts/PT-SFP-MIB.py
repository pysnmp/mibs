...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPCompleteGroup=ptSFPCompleteGroup, levelRx=levelRx, lengthCopper1m=lengthCopper1m, PortInterfaceTC=PortInterfaceTC, txPower=txPower, length62m10m=length62m10m, installState=installState, PYSNMP_MODULE_ID=ptSFP, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, rxPower=rxPower, ptSFP=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, length9m100m=length9m100m, vendorPn=vendorPn, ptSFPCompliances=ptSFPCompliances, connectorType=connectorType, InstallStateTC=InstallStateTC, brNominal=brNominal, ptSFPEntry=ptSFPEntry, length50m10m=length50m10m, WaveLengthTC=WaveLengthTC, biasCurrent=biasCurrent, installedSFP=installedSFP, vendorName=vendorName, vendorOui=vendorOui, installedWavelength=installedWavelength, vcc=vcc, temperature=temperature, vendorSn=vendorSn, saleableEntityCode=saleableEntityCode, ptSFPTable=ptSFPTable, vendorRev=vendorRev, ptSFPGroups=ptSFPGroups, ConnectorTypeTC=ConnectorTypeTC)
