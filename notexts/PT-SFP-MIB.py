...
mibBuilder.exportSymbols("PT-SFP-MIB", levelRx=levelRx, PortInterfaceTC=PortInterfaceTC, vendorName=vendorName, connectorType=connectorType, ptSFPCompliances=ptSFPCompliances, ptSFPEntry=ptSFPEntry, vcc=vcc, length9m100m=length9m100m, ptSFPConformance=ptSFPConformance, installedSFP=installedSFP, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, installState=installState, vendorRev=vendorRev, biasCurrent=biasCurrent, ptSFP=ptSFP, length62m10m=length62m10m, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, ptSFPCompleteGroup=ptSFPCompleteGroup, installedWavelength=installedWavelength, vendorSn=vendorSn, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, rxPower=rxPower, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, WaveLengthTC=WaveLengthTC, temperature=temperature, vendorOui=vendorOui, brNominal=brNominal, lengthCopper1m=lengthCopper1m, length9m1km=length9m1km, ptSFPGroups=ptSFPGroups, txPower=txPower)
