...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, levelRx=levelRx, InstallStateTC=InstallStateTC, saleableEntityCode=saleableEntityCode, rxPower=rxPower, vendorPn=vendorPn, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, vendorName=vendorName, vendorOui=vendorOui, length9m1km=length9m1km, vendorSn=vendorSn, length9m100m=length9m100m, ptSFP=ptSFP, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, ptSFPTable=ptSFPTable, length62m10m=length62m10m, temperature=temperature, ptSFPCompliances=ptSFPCompliances, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP, brNominal=brNominal, biasCurrent=biasCurrent, installState=installState, ptSFPFullCompliance=ptSFPFullCompliance, vendorRev=vendorRev, length50m10m=length50m10m, txPower=txPower, connectorType=connectorType, ConnectorTypeTC=ConnectorTypeTC, vcc=vcc, lengthCopper1m=lengthCopper1m, PYSNMP_MODULE_ID=ptSFP)
