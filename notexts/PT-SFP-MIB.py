...
mibBuilder.exportSymbols("PT-SFP-MIB", WaveLengthTC=WaveLengthTC, length9m100m=length9m100m, levelRx=levelRx, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPCompliances=ptSFPCompliances, vcc=vcc, ptSFP=ptSFP, vendorOui=vendorOui, txPower=txPower, PortInterfaceTC=PortInterfaceTC, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, temperature=temperature, installState=installState, biasCurrent=biasCurrent, length9m1km=length9m1km, ConnectorTypeTC=ConnectorTypeTC, InstallStateTC=InstallStateTC, connectorType=connectorType, vendorSn=vendorSn, PYSNMP_MODULE_ID=ptSFP, ptSFPTable=ptSFPTable, brNominal=brNominal, vendorRev=vendorRev, ptSFPGroups=ptSFPGroups, ptSFPFullCompliance=ptSFPFullCompliance, lengthCopper1m=lengthCopper1m, installedWavelength=installedWavelength, ptSFPConformance=ptSFPConformance, vendorName=vendorName, rxPower=rxPower, installedSFP=installedSFP, vendorPn=vendorPn, ptSFPEntry=ptSFPEntry, length50m10m=length50m10m)
