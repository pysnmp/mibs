...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, installState=installState, vendorSn=vendorSn, length9m1km=length9m1km, installedWavelength=installedWavelength, ptSFPGroups=ptSFPGroups, saleableEntityCode=saleableEntityCode, biasCurrent=biasCurrent, connectorType=connectorType, vendorRev=vendorRev, InstallStateTC=InstallStateTC, ptSFP=ptSFP, vendorOui=vendorOui, vendorName=vendorName, vendorPn=vendorPn, txPower=txPower, lengthCopper1m=lengthCopper1m, ptSFPEntry=ptSFPEntry, ptSFPCompleteGroup=ptSFPCompleteGroup, PYSNMP_MODULE_ID=ptSFP, brNominal=brNominal, ConnectorTypeTC=ConnectorTypeTC, PortInterfaceTC=PortInterfaceTC, ptSFPCompliances=ptSFPCompliances, rxPower=rxPower, temperature=temperature, installedSFP=installedSFP, length62m10m=length62m10m, vcc=vcc, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, ptSFPConformance=ptSFPConformance, levelRx=levelRx, WaveLengthTC=WaveLengthTC, length9m100m=length9m100m)
