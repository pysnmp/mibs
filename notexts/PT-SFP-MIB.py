...
mibBuilder.exportSymbols("PT-SFP-MIB", ptSFPGroups=ptSFPGroups, length50m10m=length50m10m, length62m10m=length62m10m, length9m100m=length9m100m, length9m1km=length9m1km, ptSFPTable=ptSFPTable, InstallStateTC=InstallStateTC, ptSFPEntry=ptSFPEntry, rxPower=rxPower, txPower=txPower, brNominal=brNominal, vendorName=vendorName, vcc=vcc, vendorPn=vendorPn, ptSFPConformance=ptSFPConformance, connectorType=connectorType, lengthCopper1m=lengthCopper1m, biasCurrent=biasCurrent, ConnectorTypeTC=ConnectorTypeTC, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, installedWavelength=installedWavelength, PortInterfaceTC=PortInterfaceTC, ptSFP=ptSFP, installState=installState, temperature=temperature, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPCompleteGroup=ptSFPCompleteGroup, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, PYSNMP_MODULE_ID=ptSFP, vendorRev=vendorRev, vendorSn=vendorSn, vendorOui=vendorOui, levelRx=levelRx)
