...
mibBuilder.exportSymbols("PT-SFP-MIB", vendorRev=vendorRev, temperature=temperature, ConnectorTypeTC=ConnectorTypeTC, vendorPn=vendorPn, installedSFP=installedSFP, installState=installState, ptSFPCompliances=ptSFPCompliances, ptSFPGroups=ptSFPGroups, ptSFPEntry=ptSFPEntry, brNominal=brNominal, installedWavelength=installedWavelength, biasCurrent=biasCurrent, vendorName=vendorName, PYSNMP_MODULE_ID=ptSFP, vcc=vcc, saleableEntityCode=saleableEntityCode, ptSFPCompleteGroup=ptSFPCompleteGroup, rxPower=rxPower, InstallStateTC=InstallStateTC, ptSFP=ptSFP, ptSFPConformance=ptSFPConformance, txPower=txPower, length50m10m=length50m10m, length62m10m=length62m10m, length9m100m=length9m100m, lengthCopper1m=lengthCopper1m, WaveLengthTC=WaveLengthTC, vendorOui=vendorOui, ptSFPTable=ptSFPTable, length9m1km=length9m1km, ptSFPFullCompliance=ptSFPFullCompliance, connectorType=connectorType, vendorSn=vendorSn, levelRx=levelRx, PortInterfaceTC=PortInterfaceTC)
