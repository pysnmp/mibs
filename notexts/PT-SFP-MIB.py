...
mibBuilder.exportSymbols("PT-SFP-MIB", PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, ConnectorTypeTC=ConnectorTypeTC, levelRx=levelRx, ptSFPFullCompliance=ptSFPFullCompliance, ptSFPTable=ptSFPTable, length62m10m=length62m10m, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorName=vendorName, temperature=temperature, biasCurrent=biasCurrent, length9m1km=length9m1km, vendorRev=vendorRev, connectorType=connectorType, saleableEntityCode=saleableEntityCode, vendorOui=vendorOui, length9m100m=length9m100m, ptSFPGroups=ptSFPGroups, ptSFP=ptSFP, ptSFPCompliances=ptSFPCompliances, WaveLengthTC=WaveLengthTC, vcc=vcc, vendorPn=vendorPn, InstallStateTC=InstallStateTC, installedWavelength=installedWavelength, txPower=txPower, ptSFPEntry=ptSFPEntry, rxPower=rxPower, PortInterfaceTC=PortInterfaceTC, installedSFP=installedSFP, installState=installState, length50m10m=length50m10m, vendorSn=vendorSn, brNominal=brNominal, ptSFPConformance=ptSFPConformance)
