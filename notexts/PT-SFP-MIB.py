...
mibBuilder.exportSymbols("PT-SFP-MIB", brNominal=brNominal, txPower=txPower, ptSFPCompleteGroup=ptSFPCompleteGroup, length9m1km=length9m1km, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, vendorSn=vendorSn, temperature=temperature, vcc=vcc, ConnectorTypeTC=ConnectorTypeTC, length50m10m=length50m10m, ptSFPConformance=ptSFPConformance, installedWavelength=installedWavelength, ptSFPEntry=ptSFPEntry, ptSFPFullCompliance=ptSFPFullCompliance, levelRx=levelRx, saleableEntityCode=saleableEntityCode, installState=installState, installedSFP=installedSFP, vendorName=vendorName, PortInterfaceTC=PortInterfaceTC, ptSFPCompliances=ptSFPCompliances, lengthCopper1m=lengthCopper1m, vendorOui=vendorOui, vendorRev=vendorRev, InstallStateTC=InstallStateTC, length62m10m=length62m10m, connectorType=connectorType, PYSNMP_MODULE_ID=ptSFP, ptSFPGroups=ptSFPGroups, rxPower=rxPower, biasCurrent=biasCurrent, ptSFPTable=ptSFPTable, ptSFP=ptSFP, length9m100m=length9m100m)
