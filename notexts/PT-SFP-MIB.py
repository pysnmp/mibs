...
mibBuilder.exportSymbols("PT-SFP-MIB", length50m10m=length50m10m, installState=installState, ptSFP=ptSFP, ptSFPFullCompliance=ptSFPFullCompliance, brNominal=brNominal, txPower=txPower, saleableEntityCode=saleableEntityCode, ptSFPCompliances=ptSFPCompliances, rxPower=rxPower, PortInterfaceTC=PortInterfaceTC, PYSNMP_MODULE_ID=ptSFP, lengthCopper1m=lengthCopper1m, vcc=vcc, biasCurrent=biasCurrent, ptSFPGroups=ptSFPGroups, vendorPn=vendorPn, vendorName=vendorName, ptSFPEntry=ptSFPEntry, ptSFPCompleteGroup=ptSFPCompleteGroup, vendorSn=vendorSn, installedSFP=installedSFP, WaveLengthTC=WaveLengthTC, vendorRev=vendorRev, InstallStateTC=InstallStateTC, ConnectorTypeTC=ConnectorTypeTC, installedWavelength=installedWavelength, length9m100m=length9m100m, connectorType=connectorType, length9m1km=length9m1km, ptSFPConformance=ptSFPConformance, levelRx=levelRx, temperature=temperature, ptSFPTable=ptSFPTable, length62m10m=length62m10m, vendorOui=vendorOui)
