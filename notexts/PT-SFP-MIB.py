...
mibBuilder.exportSymbols("PT-SFP-MIB", InstallStateTC=InstallStateTC, length9m100m=length9m100m, ptSFPFullCompliance=ptSFPFullCompliance, installState=installState, ptSFPConformance=ptSFPConformance, temperature=temperature, ptSFPTable=ptSFPTable, length62m10m=length62m10m, vendorRev=vendorRev, installedWavelength=installedWavelength, saleableEntityCode=saleableEntityCode, vendorName=vendorName, installedSFP=installedSFP, ConnectorTypeTC=ConnectorTypeTC, ptSFPCompleteGroup=ptSFPCompleteGroup, WaveLengthTC=WaveLengthTC, vendorPn=vendorPn, ptSFPEntry=ptSFPEntry, biasCurrent=biasCurrent, length9m1km=length9m1km, connectorType=connectorType, levelRx=levelRx, ptSFP=ptSFP, length50m10m=length50m10m, PYSNMP_MODULE_ID=ptSFP, brNominal=brNominal, vendorOui=vendorOui, rxPower=rxPower, txPower=txPower, vcc=vcc, lengthCopper1m=lengthCopper1m, ptSFPCompliances=ptSFPCompliances, ptSFPGroups=ptSFPGroups, vendorSn=vendorSn, PortInterfaceTC=PortInterfaceTC)
