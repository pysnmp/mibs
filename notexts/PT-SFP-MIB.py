...
mibBuilder.exportSymbols("PT-SFP-MIB", PortInterfaceTC=PortInterfaceTC, WaveLengthTC=WaveLengthTC, installedWavelength=installedWavelength, ptSFPTable=ptSFPTable, rxPower=rxPower, vendorOui=vendorOui, lengthCopper1m=lengthCopper1m, ptSFPFullCompliance=ptSFPFullCompliance, temperature=temperature, ptSFPConformance=ptSFPConformance, length9m1km=length9m1km, ptSFPEntry=ptSFPEntry, installedSFP=installedSFP, ptSFP=ptSFP, vendorName=vendorName, txPower=txPower, levelRx=levelRx, ConnectorTypeTC=ConnectorTypeTC, connectorType=connectorType, brNominal=brNominal, biasCurrent=biasCurrent, vendorRev=vendorRev, length9m100m=length9m100m, ptSFPCompleteGroup=ptSFPCompleteGroup, ptSFPGroups=ptSFPGroups, vendorSn=vendorSn, ptSFPCompliances=ptSFPCompliances, PYSNMP_MODULE_ID=ptSFP, vendorPn=vendorPn, vcc=vcc, length62m10m=length62m10m, saleableEntityCode=saleableEntityCode, length50m10m=length50m10m, InstallStateTC=InstallStateTC, installState=installState)
