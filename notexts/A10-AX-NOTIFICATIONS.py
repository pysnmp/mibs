...
TimeTicks, Bits, IpAddress, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, ObjectIdentity, Counter64, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationLsnPoolName=axNotificationLsnPoolName, axSystemShutdown=axSystemShutdown, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotifications=axNotifications, axSystemNotifications=axSystemNotifications, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationTrueFalse=axNotificationTrueFalse, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axGslbNotifications=axGslbNotifications, axSystemRestart=axSystemRestart, axSystemFanRecover=axSystemFanRecover, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axHighPrioritySyslog=axHighPrioritySyslog, axNotificationUpDown=axNotificationUpDown, axSyslogPriority=axSyslogPriority, axNotificationSLBPort=axNotificationSLBPort, axSslCertificateExpiring=axSslCertificateExpiring, axHAActive=axHAActive, axNotificationPortThreshold=axNotificationPortThreshold, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSyslogTrap=axSyslogTrap, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationObjects=axNotificationObjects, axFan1Failure=axFan1Failure, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServiceConnResume=axServiceConnResume, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axGatewayDown=axGatewayDown, axSyslogTrapObjects=axSyslogTrapObjects, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axFan3Failure=axFan3Failure, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationCertificateName=axNotificationCertificateName, axSlbNotifications=axSlbNotifications, axServiceConnLimit=axServiceConnLimit, axNotificationCurrentUsage=axNotificationCurrentUsage, axSystemLicenseRequired=axSystemLicenseRequired, axGatewayUp=axGatewayUp, axServerDown=axServerDown, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSyslogTrapPrefix=axSyslogTrapPrefix, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServiceUp=axServiceUp, axNotificationShutdownReason=axNotificationShutdownReason, axSyslogModuleName=axSyslogModuleName, axVrrpActive=axVrrpActive, axNotificationNewVcsState=axNotificationNewVcsState, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationLsnProtoType=axNotificationLsnProtoType, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axServerConnResume=axServerConnResume, axVirtualServerPortDown=axVirtualServerPortDown, axSystemTempHigh=axSystemTempHigh, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axSystemLicenseExpired=axSystemLicenseExpired, axVirtualServerUp=axVirtualServerUp, axServerConnLimit=axServerConnLimit, axNotificationMsg=axNotificationMsg, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationOldVcsState=axNotificationOldVcsState, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axSystemControlCpuHigh=axSystemControlCpuHigh, axServerDisabled=axServerDisabled, axNetworkNotifications=axNetworkNotifications, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationDroppedPackets=axNotificationDroppedPackets, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationGslbZoneName=axNotificationGslbZoneName, axAppNotifications=axAppNotifications, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axServerUp=axServerUp, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationGslbSiteName=axNotificationGslbSiteName, axServiceGroupUp=axServiceGroupUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axHAActiveActive=axHAActiveActive, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSystemDataCpuHigh=axSystemDataCpuHigh, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axServerSelectionFailure=axServerSelectionFailure, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axSystemStart=axSystemStart, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemFanFailure=axSystemFanFailure, axNotificationSLBCurConns=axNotificationSLBCurConns, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSyslogMsg=axSyslogMsg, axNotificationTrunkID=axNotificationTrunkID, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationConnLimit=axNotificationConnLimit, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationVirtualServer=axNotificationVirtualServer, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axVirtualServerPortUp=axVirtualServerPortUp, axServerPortCreateDelete=axServerPortCreateDelete, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationDateTime=axNotificationDateTime, axServerCreateDelete=axServerCreateDelete, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axServerConnRateLimit=axServerConnRateLimit, axNotificationPartitionName=axNotificationPartitionName, axVrrpStandby=axVrrpStandby, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationFanName=axNotificationFanName, axNotificationPartitionId=axNotificationPartitionId, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axHAStandby=axHAStandby, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axVirtualServerDown=axVirtualServerDown, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axFan2Failure=axFan2Failure, axNotificationTacasServerHost=axNotificationTacasServerHost, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationSLBServer=axNotificationSLBServer, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNotificationHAGroup=axNotificationHAGroup, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axServiceDown=axServiceDown, axServiceGroupDown=axServiceGroupDown, axNotificationVrid=axNotificationVrid, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axServiceGroupMemberUp=axServiceGroupMemberUp, axVcsStateChange=axVcsStateChange, axNotificationIpAddressType=axNotificationIpAddressType)
