...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationIpAddressType=axNotificationIpAddressType, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axFan1Failure=axFan1Failure, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServiceConnLimit=axServiceConnLimit, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemShutdown=axSystemShutdown, axNotificationConnLimit=axNotificationConnLimit, axNotificationTrueFalse=axNotificationTrueFalse, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axServerDisabled=axServerDisabled, axSystemDropPacketEvent=axSystemDropPacketEvent, axVirtualServerDown=axVirtualServerDown, axServerUp=axServerUp, axNotificationOldVcsState=axNotificationOldVcsState, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationLsnProtoType=axNotificationLsnProtoType, axServerDown=axServerDown, axNotificationDateTime=axNotificationDateTime, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSyslogMsg=axSyslogMsg, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationLsnPoolName=axNotificationLsnPoolName, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSyslogTrapPrefix=axSyslogTrapPrefix, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationCertificateName=axNotificationCertificateName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axNotifications=axNotifications, axAppNotifications=axAppNotifications, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGatewayUp=axGatewayUp, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axServiceConnResume=axServiceConnResume, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemShutdownForReason=axSystemShutdownForReason, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemFanFailure=axSystemFanFailure, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationDroppedPackets=axNotificationDroppedPackets, axHAActiveActive=axHAActiveActive, axServiceDown=axServiceDown, axGslbNotifications=axGslbNotifications, axSystemTempHigh=axSystemTempHigh, axHighPrioritySyslog=axHighPrioritySyslog, axVrrpStandby=axVrrpStandby, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationTrunkID=axNotificationTrunkID, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemFanRecover=axSystemFanRecover, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axServiceGroupMemberDown=axServiceGroupMemberDown, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axSyslogTrap=axSyslogTrap, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSyslogModuleName=axSyslogModuleName, axVirtualServerPortUp=axVirtualServerPortUp, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axServiceConnRateLimit=axServiceConnRateLimit, axServiceGroupDown=axServiceGroupDown, axServerCreateDelete=axServerCreateDelete, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationMsg=axNotificationMsg, axNotificationFanName=axNotificationFanName, axSslServerCertificateErr=axSslServerCertificateErr, axSystemStart=axSystemStart, axHAStandby=axHAStandby, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVrrpActive=axVrrpActive, axVirtualServerUp=axVirtualServerUp, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSystemRestart=axSystemRestart, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axFan2Failure=axFan2Failure, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSyslogTrapObjects=axSyslogTrapObjects, axFan3Failure=axFan3Failure, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationObjects=axNotificationObjects, axServiceUp=axServiceUp, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationNewVcsState=axNotificationNewVcsState, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axHAActive=axHAActive, axNotificationSLBPort=axNotificationSLBPort, axSystemNotifications=axSystemNotifications, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axServerPortCreateDelete=axServerPortCreateDelete, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationPartitionName=axNotificationPartitionName, axNetworkNotifications=axNetworkNotifications, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationPartitionId=axNotificationPartitionId, axServerConnResume=axServerConnResume, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGatewayDown=axGatewayDown, axNotificationSLBServer=axNotificationSLBServer, axServerConnLimit=axServerConnLimit, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServerSelectionFailure=axServerSelectionFailure, axSlbNotifications=axSlbNotifications, axNotificationHAGroup=axNotificationHAGroup, axServiceGroupUp=axServiceGroupUp, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axVcsStateChange=axVcsStateChange, axNotificationUpDown=axNotificationUpDown, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationVrid=axNotificationVrid, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationShutdownReason=axNotificationShutdownReason, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axServerConnRateLimit=axServerConnRateLimit, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axNotificationTacasServerHost=axNotificationTacasServerHost, axServiceGroupMemberUp=axServiceGroupMemberUp, axSyslogPriority=axSyslogPriority)
