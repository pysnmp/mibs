...
Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, TimeTicks, Unsigned32, ObjectIdentity, IpAddress, MibIdentifier, iso, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "TimeTicks", "Unsigned32", "ObjectIdentity", "IpAddress", "MibIdentifier", "iso", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axHAActive=axHAActive, axNotificationCertificateName=axNotificationCertificateName, axSystemRestart=axSystemRestart, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axServiceConnResume=axServiceConnResume, axSystemStart=axSystemStart, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationHAGroup=axNotificationHAGroup, axSystemDataCpuHigh=axSystemDataCpuHigh, axServerDisabled=axServerDisabled, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGatewayDown=axGatewayDown, axSyslogTrapObjects=axSyslogTrapObjects, axVirtualServerUp=axVirtualServerUp, axSystemShutdown=axSystemShutdown, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axHighPrioritySyslog=axHighPrioritySyslog, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationOldVcsState=axNotificationOldVcsState, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSystemLicenseRequired=axSystemLicenseRequired, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationLsnProtoType=axNotificationLsnProtoType, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNotificationVrid=axNotificationVrid, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationNewVcsState=axNotificationNewVcsState, axSyslogTrapPrefix=axSyslogTrapPrefix, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axServiceUp=axServiceUp, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationSLBCurConns=axNotificationSLBCurConns, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationTrueFalse=axNotificationTrueFalse, axServerConnResume=axServerConnResume, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationPartitionId=axNotificationPartitionId, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemNotifications=axSystemNotifications, axNotificationDateTime=axNotificationDateTime, axMemoryUsageHigh=axMemoryUsageHigh, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axServerConnRateLimit=axServerConnRateLimit, axServiceGroupMemberDown=axServiceGroupMemberDown, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axVrrpActive=axVrrpActive, axSyslogModuleName=axSyslogModuleName, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationDroppedPackets=axNotificationDroppedPackets, axSystemControlCpuHigh=axSystemControlCpuHigh, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationMsg=axNotificationMsg, axNotificationConnLimit=axNotificationConnLimit, axNotificationFanName=axNotificationFanName, axServerCreateDelete=axServerCreateDelete, axNotificationSLBPort=axNotificationSLBPort, axNotificationCurrentUsage=axNotificationCurrentUsage, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axFan1Failure=axFan1Failure, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServiceConnLimit=axServiceConnLimit, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axHAActiveActive=axHAActiveActive, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSslServerCertificateErr=axSslServerCertificateErr, axNotifications=axNotifications, axNotificationPortThreshold=axNotificationPortThreshold, axVcsStateChange=axVcsStateChange, axGslbNotifications=axGslbNotifications, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axServerConnLimit=axServerConnLimit, axSlbNotifications=axSlbNotifications, axNotificationTrunkID=axNotificationTrunkID, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNetworkNotifications=axNetworkNotifications, axVirtualServerDown=axVirtualServerDown, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axAppNotifications=axAppNotifications, axSystemFanFailure=axSystemFanFailure, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationUpDown=axNotificationUpDown, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axFan3Failure=axFan3Failure, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axServerDown=axServerDown, axVrrpStandby=axVrrpStandby, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axServiceDown=axServiceDown, axSystemFanRecover=axSystemFanRecover, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSystemTempHigh=axSystemTempHigh, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axServiceGroupUp=axServiceGroupUp, axServerPortCreateDelete=axServerPortCreateDelete, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axSyslogPriority=axSyslogPriority, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axServerSelectionFailure=axServerSelectionFailure, axNotificationIpAddressType=axNotificationIpAddressType, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axHAStandby=axHAStandby, axNotificationObjects=axNotificationObjects, axServiceGroupDown=axServiceGroupDown, axServiceGroupMemberUp=axServiceGroupMemberUp, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationPartitionName=axNotificationPartitionName, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axFan2Failure=axFan2Failure, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axServerUp=axServerUp, axSystemLicenseExpired=axSystemLicenseExpired, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSyslogTrap=axSyslogTrap, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axServiceConnRateLimit=axServiceConnRateLimit, axGatewayUp=axGatewayUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axNotificationSLBServer=axNotificationSLBServer, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationLsnPoolName=axNotificationLsnPoolName, axSyslogMsg=axSyslogMsg, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown)
