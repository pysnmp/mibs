...
Counter32, iso, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, Bits, ModuleIdentity, Integer32, Counter64, TimeTicks, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "Counter64", "TimeTicks", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axSystemLicenseExpired=axSystemLicenseExpired, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationVirtualServer=axNotificationVirtualServer, axServiceDown=axServiceDown, axNotificationPartitionName=axNotificationPartitionName, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationFanName=axNotificationFanName, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationConnLimit=axNotificationConnLimit, axHAStandby=axHAStandby, axSystemNotifications=axSystemNotifications, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axVrrpActive=axVrrpActive, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axFan1Failure=axFan1Failure, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axServiceConnRateLimit=axServiceConnRateLimit, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationLsnProtoType=axNotificationLsnProtoType, axHAActive=axHAActive, axServiceConnResume=axServiceConnResume, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationObjects=axNotificationObjects, axServerConnRateLimit=axServerConnRateLimit, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axVcsStateChange=axVcsStateChange, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSslCertificateExpiring=axSslCertificateExpiring, axServiceUp=axServiceUp, axNotificationNewVcsState=axNotificationNewVcsState, axFan3Failure=axFan3Failure, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationCurrentUsage=axNotificationCurrentUsage, axVirtualServerDown=axVirtualServerDown, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNetworkNotifications=axNetworkNotifications, axServerUp=axServerUp, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axSystemFanRecover=axSystemFanRecover, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationGslbZoneName=axNotificationGslbZoneName, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationTrueFalse=axNotificationTrueFalse, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationVrid=axNotificationVrid, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSystemShutdown=axSystemShutdown, axServiceGroupUp=axServiceGroupUp, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationOldVcsState=axNotificationOldVcsState, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axGatewayDown=axGatewayDown, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNotificationDateTime=axNotificationDateTime, axSyslogTrap=axSyslogTrap, axServerDown=axServerDown, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationTrunkID=axNotificationTrunkID, axNotificationMsg=axNotificationMsg, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationDroppedPackets=axNotificationDroppedPackets, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axFan2Failure=axFan2Failure, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotifications=axNotifications, axServerConnResume=axServerConnResume, axHighPrioritySyslog=axHighPrioritySyslog, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSyslogModuleName=axSyslogModuleName, axNotificationSLBPort=axNotificationSLBPort, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServerSelectionFailure=axServerSelectionFailure, axNotificationCertificateName=axNotificationCertificateName, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axServiceConnLimit=axServiceConnLimit, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axServerConnLimit=axServerConnLimit, axHAActiveActive=axHAActiveActive, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationHAGroup=axNotificationHAGroup, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationIpAddressType=axNotificationIpAddressType, axSystemDataCpuHigh=axSystemDataCpuHigh, axSyslogPriority=axSyslogPriority, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSyslogTrapObjects=axSyslogTrapObjects, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axSystemStart=axSystemStart, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSyslogMsg=axSyslogMsg, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationPortThreshold=axNotificationPortThreshold, axSystemDropPacketEvent=axSystemDropPacketEvent, axSlbNotifications=axSlbNotifications, axGslbNotifications=axGslbNotifications, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axServiceGroupDown=axServiceGroupDown, axSystemFanFailure=axSystemFanFailure, axNotificationSLBServer=axNotificationSLBServer, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationTacasServerHost=axNotificationTacasServerHost, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationPartitionId=axNotificationPartitionId, axAppNotifications=axAppNotifications, axSystemTempHigh=axSystemTempHigh, axSystemRestart=axSystemRestart, axServerDisabled=axServerDisabled, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGatewayUp=axGatewayUp, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axServerCreateDelete=axServerCreateDelete, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSslServerCertificateErr=axSslServerCertificateErr, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationShutdownReason=axNotificationShutdownReason, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationUpDown=axNotificationUpDown, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axVirtualServerPortUp=axVirtualServerPortUp, axVirtualServerUp=axVirtualServerUp, axVrrpStandby=axVrrpStandby, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationGslbSiteName=axNotificationGslbSiteName, axServerPortCreateDelete=axServerPortCreateDelete, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown)
