...
NotificationType, ObjectIdentity, Counter32, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, iso, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter32", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "iso", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axServerPortCreateDelete=axServerPortCreateDelete, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemShutdownForReason=axSystemShutdownForReason, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axServiceGroupMemberUp=axServiceGroupMemberUp, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemTempHigh=axSystemTempHigh, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axServerConnRateLimit=axServerConnRateLimit, axServerDown=axServerDown, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationVrid=axNotificationVrid, axVrrpStandby=axVrrpStandby, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axFan3Failure=axFan3Failure, axNotificationLsnProtoType=axNotificationLsnProtoType, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axHAStandby=axHAStandby, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationHAGroup=axNotificationHAGroup, axNotificationGslbSiteName=axNotificationGslbSiteName, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axServiceDown=axServiceDown, axSyslogTrapPrefix=axSyslogTrapPrefix, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axServerConnResume=axServerConnResume, axSystemLicenseRequired=axSystemLicenseRequired, axSslCertificateExpiring=axSslCertificateExpiring, axSystemShutdown=axSystemShutdown, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationSLBPort=axNotificationSLBPort, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationUpDown=axNotificationUpDown, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSslServerCertificateErr=axSslServerCertificateErr, axServerCreateDelete=axServerCreateDelete, axGatewayUp=axGatewayUp, axHAActive=axHAActive, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axHAActiveActive=axHAActiveActive, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axNetworkNotifications=axNetworkNotifications, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSyslogPriority=axSyslogPriority, axNotificationGslbGroupName=axNotificationGslbGroupName, axSlbNotifications=axSlbNotifications, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axSystemStart=axSystemStart, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axFan1Failure=axFan1Failure, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationCertificateName=axNotificationCertificateName, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServerUp=axServerUp, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationMsg=axNotificationMsg, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axServiceConnResume=axServiceConnResume, axSystemDataCpuHigh=axSystemDataCpuHigh, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemFanRecover=axSystemFanRecover, axServiceGroupDown=axServiceGroupDown, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axMemoryUsageHigh=axMemoryUsageHigh, axVirtualServerPortUp=axVirtualServerPortUp, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axSystemFanFailure=axSystemFanFailure, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axServiceGroupUp=axServiceGroupUp, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axVirtualServerPortDown=axVirtualServerPortDown, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axServerSelectionFailure=axServerSelectionFailure, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationPartitionId=axNotificationPartitionId, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axVrrpActive=axVrrpActive, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axVirtualServerUp=axVirtualServerUp, axFan2Failure=axFan2Failure, axNotificationObjects=axNotificationObjects, axSystemNotifications=axSystemNotifications, axNotificationShutdownReason=axNotificationShutdownReason, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationTrueFalse=axNotificationTrueFalse, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationSLBServer=axNotificationSLBServer, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationPortThreshold=axNotificationPortThreshold, axHardDiskUsageHigh=axHardDiskUsageHigh, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotifications=axNotifications, axSyslogTrapObjects=axSyslogTrapObjects, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axServerConnLimit=axServerConnLimit, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSyslogTrap=axSyslogTrap, axNotificationConnLimit=axNotificationConnLimit, axSyslogMsg=axSyslogMsg, axVcsStateChange=axVcsStateChange, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationOldVcsState=axNotificationOldVcsState, axGslbNotifications=axGslbNotifications, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axVirtualServerDown=axVirtualServerDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axServiceUp=axServiceUp, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationDateTime=axNotificationDateTime, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationIpAddressType=axNotificationIpAddressType, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axServiceConnRateLimit=axServiceConnRateLimit, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axServerDisabled=axServerDisabled, axAppNotifications=axAppNotifications, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationNewVcsState=axNotificationNewVcsState, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axServiceConnLimit=axServiceConnLimit, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationTrunkID=axNotificationTrunkID, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationPartitionName=axNotificationPartitionName, axNotificationFanName=axNotificationFanName, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axSystemControlCpuHigh=axSystemControlCpuHigh, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axHighPrioritySyslog=axHighPrioritySyslog, axSyslogModuleName=axSyslogModuleName, axSystemRestart=axSystemRestart, axSystemDropPacketEvent=axSystemDropPacketEvent, axGatewayDown=axGatewayDown)
