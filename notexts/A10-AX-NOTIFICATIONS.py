...
Counter32, NotificationType, Bits, Gauge32, ModuleIdentity, IpAddress, TimeTicks, Counter64, MibIdentifier, Integer32, ObjectIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Bits", "Gauge32", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter64", "MibIdentifier", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axHighPrioritySyslog=axHighPrioritySyslog, axGatewayUp=axGatewayUp, axSslCertificateExpiring=axSslCertificateExpiring, axSyslogModuleName=axSyslogModuleName, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axServiceDown=axServiceDown, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNetworkNotifications=axNetworkNotifications, axNotificationHAGroup=axNotificationHAGroup, axHAStandby=axHAStandby, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationSLBPort=axNotificationSLBPort, axNotificationDateTime=axNotificationDateTime, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationCertificateName=axNotificationCertificateName, axHAActive=axHAActive, axServerCreateDelete=axServerCreateDelete, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationGslbGroupName=axNotificationGslbGroupName, axSystemNotifications=axSystemNotifications, axNotificationMsg=axNotificationMsg, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axSystemShutdown=axSystemShutdown, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationFanName=axNotificationFanName, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axServiceConnLimit=axServiceConnLimit, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axVrrpActive=axVrrpActive, axGatewayDown=axGatewayDown, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axSystemLicenseExpired=axSystemLicenseExpired, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationSLBServer=axNotificationSLBServer, axVirtualServerDown=axVirtualServerDown, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axSystemFanRecover=axSystemFanRecover, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axHAActiveActive=axHAActiveActive, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationVrid=axNotificationVrid, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServerDisabled=axServerDisabled, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationTrueFalse=axNotificationTrueFalse, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axServiceGroupDown=axServiceGroupDown, axServiceConnRateLimit=axServiceConnRateLimit, axAppNotifications=axAppNotifications, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationCurrentUsage=axNotificationCurrentUsage, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationGslbZoneName=axNotificationGslbZoneName, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axServerDown=axServerDown, axVirtualServerUp=axVirtualServerUp, axNotificationUpDown=axNotificationUpDown, axServerSelectionFailure=axServerSelectionFailure, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axServerUp=axServerUp, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemStart=axSystemStart, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axServiceGroupMemberUp=axServiceGroupMemberUp, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServerConnResume=axServerConnResume, axServiceUp=axServiceUp, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationTrunkID=axNotificationTrunkID, axSystemRestart=axSystemRestart, axNotificationSLBCurConns=axNotificationSLBCurConns, axServerConnLimit=axServerConnLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationPartitionId=axNotificationPartitionId, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationConnLimit=axNotificationConnLimit, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axFan1Failure=axFan1Failure, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axFan2Failure=axFan2Failure, axSslServerCertificateErr=axSslServerCertificateErr, axSyslogMsg=axSyslogMsg, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSyslogPriority=axSyslogPriority, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationDroppedPackets=axNotificationDroppedPackets, axSystemLicenseRequired=axSystemLicenseRequired, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axVcsStateChange=axVcsStateChange, axServiceGroupUp=axServiceGroupUp, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axSyslogTrap=axSyslogTrap, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotifications=axNotifications, axNotificationGslbSiteName=axNotificationGslbSiteName, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationObjects=axNotificationObjects, axNotificationIpAddressType=axNotificationIpAddressType, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axVrrpStandby=axVrrpStandby, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axServiceConnResume=axServiceConnResume, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationNewVcsState=axNotificationNewVcsState, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationOldVcsState=axNotificationOldVcsState, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axGslbNotifications=axGslbNotifications, axHardDiskUsageHigh=axHardDiskUsageHigh, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemFanFailure=axSystemFanFailure, axSystemShutdownForReason=axSystemShutdownForReason, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSystemTempHigh=axSystemTempHigh, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axFan3Failure=axFan3Failure, axSlbNotifications=axSlbNotifications, axNotificationPartitionName=axNotificationPartitionName, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axServerConnRateLimit=axServerConnRateLimit, axSystemDropPacketEvent=axSystemDropPacketEvent, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled)
