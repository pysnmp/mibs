...
NotificationType, MibIdentifier, Counter64, Counter32, iso, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, IpAddress, Integer32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter64", "Counter32", "iso", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "IpAddress", "Integer32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationMsg=axNotificationMsg, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationLsnPoolName=axNotificationLsnPoolName, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axServerDisabled=axServerDisabled, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationFanName=axNotificationFanName, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axSystemTempHigh=axSystemTempHigh, axNotificationDateTime=axNotificationDateTime, axSystemShutdown=axSystemShutdown, axSystemLicenseExpired=axSystemLicenseExpired, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axFan2Failure=axFan2Failure, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axSystemLicenseRequired=axSystemLicenseRequired, axHAActiveActive=axHAActiveActive, axVirtualServerUp=axVirtualServerUp, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationPartitionId=axNotificationPartitionId, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axSslServerCertificateErr=axSslServerCertificateErr, axMemoryUsageHigh=axMemoryUsageHigh, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axServiceDown=axServiceDown, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationUpDown=axNotificationUpDown, axServerConnRateLimit=axServerConnRateLimit, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationDroppedPackets=axNotificationDroppedPackets, axServerSelectionFailure=axServerSelectionFailure, axServiceUp=axServiceUp, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSyslogTrapPrefix=axSyslogTrapPrefix, axVirtualServerDown=axVirtualServerDown, axSystemRestart=axSystemRestart, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axHAActive=axHAActive, axNotificationOldVcsState=axNotificationOldVcsState, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationSLBServer=axNotificationSLBServer, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationObjects=axNotificationObjects, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axAppNotifications=axAppNotifications, axNotificationTrunkID=axNotificationTrunkID, axVirtualServerPortUp=axVirtualServerPortUp, axHAStandby=axHAStandby, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axSlbNotifications=axSlbNotifications, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationVrid=axNotificationVrid, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axVcsStateChange=axVcsStateChange, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axServiceConnResume=axServiceConnResume, axSyslogModuleName=axSyslogModuleName, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationHAGroup=axNotificationHAGroup, axNotificationGslbGroupName=axNotificationGslbGroupName, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axServerCreateDelete=axServerCreateDelete, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axServerConnLimit=axServerConnLimit, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationCertificateName=axNotificationCertificateName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axGslbNotifications=axGslbNotifications, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axSystemNotifications=axSystemNotifications, axNetworkNotifications=axNetworkNotifications, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axServerConnResume=axServerConnResume, axNotificationSLBPort=axNotificationSLBPort, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationVirtualServer=axNotificationVirtualServer, axVrrpStandby=axVrrpStandby, axServerUp=axServerUp, axFan1Failure=axFan1Failure, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axGatewayDown=axGatewayDown, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axSystemShutdownForReason=axSystemShutdownForReason, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotifications=axNotifications, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationShutdownReason=axNotificationShutdownReason, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationGslbZoneName=axNotificationGslbZoneName, axVrrpActive=axVrrpActive, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationTacasServerHost=axNotificationTacasServerHost, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axServiceConnLimit=axServiceConnLimit, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSslCertificateExpiring=axSslCertificateExpiring, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axFan3Failure=axFan3Failure, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGatewayUp=axGatewayUp, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationPartitionName=axNotificationPartitionName, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSyslogMsg=axSyslogMsg, axServiceGroupDown=axServiceGroupDown, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axServerDown=axServerDown, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationConnLimit=axNotificationConnLimit, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationIpAddressType=axNotificationIpAddressType, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axServiceGroupUp=axServiceGroupUp, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axSystemControlCpuHigh=axSystemControlCpuHigh, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axSyslogTrapObjects=axSyslogTrapObjects, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationNewVcsState=axNotificationNewVcsState, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axHighPrioritySyslog=axHighPrioritySyslog, axSystemFanFailure=axSystemFanFailure, axVirtualServerPortDown=axVirtualServerPortDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemFanRecover=axSystemFanRecover, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axSyslogTrap=axSyslogTrap, axSystemStart=axSystemStart, axSyslogPriority=axSyslogPriority, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh)
