...
Integer32, Bits, iso, Counter32, TimeTicks, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "iso", "Counter32", "TimeTicks", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationPartitionId=axNotificationPartitionId, axSyslogModuleName=axSyslogModuleName, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationHAGroup=axNotificationHAGroup, axHighPrioritySyslog=axHighPrioritySyslog, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationCertificateName=axNotificationCertificateName, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axHAStandby=axHAStandby, axServiceGroupDown=axServiceGroupDown, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationPartitionName=axNotificationPartitionName, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axFan2Failure=axFan2Failure, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axVrrpActive=axVrrpActive, axServerDisabled=axServerDisabled, axServiceDown=axServiceDown, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axGslbNotifications=axGslbNotifications, axSlbNotifications=axSlbNotifications, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationFanName=axNotificationFanName, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationObjects=axNotificationObjects, axNotificationNewVcsState=axNotificationNewVcsState, axSslCertificateExpiring=axSslCertificateExpiring, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationCurrentUsage=axNotificationCurrentUsage, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSyslogTrapPrefix=axSyslogTrapPrefix, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axVirtualServerPortUp=axVirtualServerPortUp, axHAActive=axHAActive, axServiceConnRateLimit=axServiceConnRateLimit, axVirtualServerUp=axVirtualServerUp, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axAppNotifications=axAppNotifications, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationSLBCurConns=axNotificationSLBCurConns, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axNotificationShutdownReason=axNotificationShutdownReason, axSystemShutdownForReason=axSystemShutdownForReason, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationLsnProtoType=axNotificationLsnProtoType, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationDateTime=axNotificationDateTime, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemNotifications=axSystemNotifications, axNotificationTrueFalse=axNotificationTrueFalse, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationDroppedPackets=axNotificationDroppedPackets, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axFan1Failure=axFan1Failure, axVrrpStandby=axVrrpStandby, axNotifications=axNotifications, axNotificationPortThreshold=axNotificationPortThreshold, axServiceGroupMemberDown=axServiceGroupMemberDown, axSystemRestart=axSystemRestart, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axSystemTempHigh=axSystemTempHigh, axSyslogTrap=axSyslogTrap, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServerUp=axServerUp, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationVrid=axNotificationVrid, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemShutdown=axSystemShutdown, axHAActiveActive=axHAActiveActive, axNotificationSLBServer=axNotificationSLBServer, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemStart=axSystemStart, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemFanRecover=axSystemFanRecover, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSystemFanFailure=axSystemFanFailure, axNotificationGslbSiteName=axNotificationGslbSiteName, axSystemLicenseRequired=axSystemLicenseRequired, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationVirtualServer=axNotificationVirtualServer, axServerConnResume=axServerConnResume, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axServerSelectionFailure=axServerSelectionFailure, axSyslogPriority=axSyslogPriority, axGatewayDown=axGatewayDown, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationSLBPort=axNotificationSLBPort, axServerDown=axServerDown, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axVirtualServerDown=axVirtualServerDown, axVcsStateChange=axVcsStateChange, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationIpAddressType=axNotificationIpAddressType, axServerConnLimit=axServerConnLimit, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axSyslogMsg=axSyslogMsg, axNotificationMsg=axNotificationMsg, axServiceGroupUp=axServiceGroupUp, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axServiceConnResume=axServiceConnResume, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationTrunkID=axNotificationTrunkID, axNotificationConnLimit=axNotificationConnLimit, axMemoryUsageHigh=axMemoryUsageHigh, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axServiceConnLimit=axServiceConnLimit, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axServerCreateDelete=axServerCreateDelete, axNetworkNotifications=axNetworkNotifications, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axServiceUp=axServiceUp, axNotificationUpDown=axNotificationUpDown, axFan3Failure=axFan3Failure, axSyslogTrapObjects=axSyslogTrapObjects, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axServerConnRateLimit=axServerConnRateLimit, axNotificationOldVcsState=axNotificationOldVcsState, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axGatewayUp=axGatewayUp, axNotificationLsnPoolName=axNotificationLsnPoolName, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal)
