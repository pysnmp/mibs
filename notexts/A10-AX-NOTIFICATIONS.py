...
TimeTicks, Counter64, Gauge32, Counter32, Unsigned32, Bits, IpAddress, MibIdentifier, Integer32, ObjectIdentity, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Gauge32", "Counter32", "Unsigned32", "Bits", "IpAddress", "MibIdentifier", "Integer32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemDataCpuHigh=axSystemDataCpuHigh, axServerUp=axServerUp, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemLicenseRequired=axSystemLicenseRequired, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axServiceUp=axServiceUp, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axServerSelectionFailure=axServerSelectionFailure, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axFan1Failure=axFan1Failure, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationPartitionName=axNotificationPartitionName, axSystemShutdown=axSystemShutdown, axSystemDropPacketEvent=axSystemDropPacketEvent, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationPortThreshold=axNotificationPortThreshold, axGatewayDown=axGatewayDown, axNotificationVirtualServer=axNotificationVirtualServer, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axServiceConnLimit=axServiceConnLimit, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axServerConnRateLimit=axServerConnRateLimit, axSlbNotifications=axSlbNotifications, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationCertificateName=axNotificationCertificateName, axVirtualServerPortDown=axVirtualServerPortDown, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSyslogTrapObjects=axSyslogTrapObjects, axServiceGroupDown=axServiceGroupDown, axSyslogModuleName=axSyslogModuleName, axHAStandby=axHAStandby, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationHAGroup=axNotificationHAGroup, axVcsStateChange=axVcsStateChange, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axSyslogTrap=axSyslogTrap, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axServerConnResume=axServerConnResume, axAppNotifications=axAppNotifications, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationDroppedPackets=axNotificationDroppedPackets, axServerDown=axServerDown, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axHighPrioritySyslog=axHighPrioritySyslog, axNotificationMsg=axNotificationMsg, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axNetworkNotifications=axNetworkNotifications, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axSystemTempHigh=axSystemTempHigh, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axVirtualServerDown=axVirtualServerDown, axVirtualServerPortUp=axVirtualServerPortUp, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axSystemFanRecover=axSystemFanRecover, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axSystemStart=axSystemStart, axSslServerCertificateErr=axSslServerCertificateErr, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axVirtualServerUp=axVirtualServerUp, axServiceConnResume=axServiceConnResume, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSyslogPriority=axSyslogPriority, axServiceDown=axServiceDown, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbNotifications=axGslbNotifications, axHAActive=axHAActive, axNotificationSLBCurConns=axNotificationSLBCurConns, axServerCreateDelete=axServerCreateDelete, axNotificationUpDown=axNotificationUpDown, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationTrunkID=axNotificationTrunkID, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationFanName=axNotificationFanName, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axVrrpStandby=axVrrpStandby, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axSystemNotifications=axSystemNotifications, axNotificationObjects=axNotificationObjects, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationPartitionId=axNotificationPartitionId, axGatewayUp=axGatewayUp, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axServerDisabled=axServerDisabled, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axFan3Failure=axFan3Failure, axServiceGroupMemberDown=axServiceGroupMemberDown, axVrrpActive=axVrrpActive, axServiceConnRateLimit=axServiceConnRateLimit, axSslCertificateExpiring=axSslCertificateExpiring, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationGslbGroupName=axNotificationGslbGroupName, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationDateTime=axNotificationDateTime, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationShutdownReason=axNotificationShutdownReason, axMemoryUsageHigh=axMemoryUsageHigh, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axHAActiveActive=axHAActiveActive, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axSystemFanFailure=axSystemFanFailure, axNotificationVrid=axNotificationVrid, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationSLBPort=axNotificationSLBPort, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axServiceGroupUp=axServiceGroupUp, axServerConnLimit=axServerConnLimit, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationNewVcsState=axNotificationNewVcsState, axSystemLicenseExpired=axSystemLicenseExpired, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSyslogMsg=axSyslogMsg, axNotificationSLBServer=axNotificationSLBServer, axNotificationIpAddressType=axNotificationIpAddressType, axSystemRestart=axSystemRestart, axFan2Failure=axFan2Failure, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axServerPortCreateDelete=axServerPortCreateDelete, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSyslogTrapPrefix=axSyslogTrapPrefix, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationOldVcsState=axNotificationOldVcsState, axNotifications=axNotifications, axNotificationConnLimit=axNotificationConnLimit)
