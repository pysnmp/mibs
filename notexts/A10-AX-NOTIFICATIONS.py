...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Counter32, Gauge32, Counter64, Unsigned32, ObjectIdentity, MibIdentifier, iso, IpAddress, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Counter32", "Gauge32", "Counter64", "Unsigned32", "ObjectIdentity", "MibIdentifier", "iso", "IpAddress", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationLsnProtoType=axNotificationLsnProtoType, axAppNotifications=axAppNotifications, axServiceGroupMemberUp=axServiceGroupMemberUp, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axFan2Failure=axFan2Failure, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationSLBPort=axNotificationSLBPort, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSyslogTrap=axSyslogTrap, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axSystemTempHigh=axSystemTempHigh, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemStart=axSystemStart, axSystemFanFailure=axSystemFanFailure, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axHAActiveActive=axHAActiveActive, axNotificationSLBCurConns=axNotificationSLBCurConns, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationVirtualServer=axNotificationVirtualServer, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axServerDisabled=axServerDisabled, axFan1Failure=axFan1Failure, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axServerUp=axServerUp, axSyslogTrapPrefix=axSyslogTrapPrefix, axSystemLicenseExpired=axSystemLicenseExpired, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axGatewayUp=axGatewayUp, axHAActive=axHAActive, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axGslbNotifications=axGslbNotifications, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axNotificationDateTime=axNotificationDateTime, axServerConnResume=axServerConnResume, axServerPortCreateDelete=axServerPortCreateDelete, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationDroppedPackets=axNotificationDroppedPackets, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemNotifications=axSystemNotifications, axNotificationPartitionId=axNotificationPartitionId, axServerDown=axServerDown, axNotificationOldVcsState=axNotificationOldVcsState, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axFan3Failure=axFan3Failure, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationPartitionName=axNotificationPartitionName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axVcsStateChange=axVcsStateChange, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axHardDiskUsageHigh=axHardDiskUsageHigh, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationMsg=axNotificationMsg, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axHighPrioritySyslog=axHighPrioritySyslog, axServiceGroupUp=axServiceGroupUp, axSyslogMsg=axSyslogMsg, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axServerCreateDelete=axServerCreateDelete, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotifications=axNotifications, axSystemLicenseRequired=axSystemLicenseRequired, axSyslogPriority=axSyslogPriority, axServiceDown=axServiceDown, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVirtualServerPortUp=axVirtualServerPortUp, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axGatewayDown=axGatewayDown, axVirtualServerPortDown=axVirtualServerPortDown, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axServiceConnLimit=axServiceConnLimit, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axServerConnRateLimit=axServerConnRateLimit, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationNewVcsState=axNotificationNewVcsState, axSystemRestart=axSystemRestart, axNotificationVrid=axNotificationVrid, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axSystemFanRecover=axSystemFanRecover, axSystemShutdown=axSystemShutdown, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axVirtualServerDown=axVirtualServerDown, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axServiceGroupDown=axServiceGroupDown, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationLsnPoolName=axNotificationLsnPoolName, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationObjects=axNotificationObjects, axSyslogModuleName=axSyslogModuleName, axNotificationCurrentUsage=axNotificationCurrentUsage, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServerConnLimit=axServerConnLimit, axServerSelectionFailure=axServerSelectionFailure, axHAStandby=axHAStandby, axNotificationTacasServerHost=axNotificationTacasServerHost, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axVirtualServerUp=axVirtualServerUp, axSlbNotifications=axSlbNotifications, axNotificationUpDown=axNotificationUpDown, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axVrrpStandby=axVrrpStandby, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axServiceConnResume=axServiceConnResume, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationConnLimit=axNotificationConnLimit, axNotificationIpAddressType=axNotificationIpAddressType, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationTrunkID=axNotificationTrunkID, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationFanName=axNotificationFanName, axServiceUp=axServiceUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSystemShutdownForReason=axSystemShutdownForReason, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationTrueFalse=axNotificationTrueFalse, axSystemDropPacketEvent=axSystemDropPacketEvent, axNetworkNotifications=axNetworkNotifications, axNotificationHAGroup=axNotificationHAGroup, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axVrrpActive=axVrrpActive, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationSLBServer=axNotificationSLBServer, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationCertificateName=axNotificationCertificateName)
