...
iso, NotificationType, Bits, ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axSystemLicenseRequired=axSystemLicenseRequired, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationSLBPort=axNotificationSLBPort, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axGatewayUp=axGatewayUp, axSyslogMsg=axSyslogMsg, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServerUp=axServerUp, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axServiceDown=axServiceDown, axNotifications=axNotifications, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationTrunkID=axNotificationTrunkID, axHAStandby=axHAStandby, axServiceConnRateLimit=axServiceConnRateLimit, axServerDisabled=axServerDisabled, axMemoryUsageHigh=axMemoryUsageHigh, axFan3Failure=axFan3Failure, axNotificationCertificateName=axNotificationCertificateName, axNotificationGslbGroupName=axNotificationGslbGroupName, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axSystemControlCpuHigh=axSystemControlCpuHigh, axSlbNotifications=axSlbNotifications, axServerSelectionFailure=axServerSelectionFailure, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axServerDown=axServerDown, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationCurrentUsage=axNotificationCurrentUsage, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSyslogModuleName=axSyslogModuleName, axHAActiveActive=axHAActiveActive, axNotificationDateTime=axNotificationDateTime, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axServerConnResume=axServerConnResume, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemRestart=axSystemRestart, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationGslbSiteName=axNotificationGslbSiteName, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axServerCreateDelete=axServerCreateDelete, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationMsg=axNotificationMsg, axSystemFanFailure=axSystemFanFailure, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationUpDown=axNotificationUpDown, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationHAGroup=axNotificationHAGroup, axNotificationPartitionId=axNotificationPartitionId, axSyslogPriority=axSyslogPriority, axNotificationConnLimit=axNotificationConnLimit, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axFan2Failure=axFan2Failure, axSystemFanRecover=axSystemFanRecover, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationPartitionName=axNotificationPartitionName, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axGatewayDown=axGatewayDown, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationGslbZoneName=axNotificationGslbZoneName, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axVirtualServerDown=axVirtualServerDown, axServiceGroupDown=axServiceGroupDown, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSyslogTrap=axSyslogTrap, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axHardDiskUsageHigh=axHardDiskUsageHigh, axVrrpStandby=axVrrpStandby, axGslbNotifications=axGslbNotifications, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationFanName=axNotificationFanName, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axServerConnLimit=axServerConnLimit, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axSslCertificateExpiring=axSslCertificateExpiring, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNetworkNotifications=axNetworkNotifications, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axServiceConnLimit=axServiceConnLimit, axServerConnRateLimit=axServerConnRateLimit, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationLsnProtoType=axNotificationLsnProtoType, axFan1Failure=axFan1Failure, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axSystemNotifications=axSystemNotifications, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationIpAddressType=axNotificationIpAddressType, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axSystemShutdownForReason=axSystemShutdownForReason, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axSystemTempHigh=axSystemTempHigh, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axVirtualServerUp=axVirtualServerUp, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationNewVcsState=axNotificationNewVcsState, axSyslogTrapObjects=axSyslogTrapObjects, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axServiceGroupUp=axServiceGroupUp, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationObjects=axNotificationObjects, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axHAActive=axHAActive, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationTacasServerHost=axNotificationTacasServerHost, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationSLBServer=axNotificationSLBServer, axSystemShutdown=axSystemShutdown, axNotificationVrid=axNotificationVrid, axSystemLicenseExpired=axSystemLicenseExpired, axHighPrioritySyslog=axHighPrioritySyslog, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axServiceUp=axServiceUp, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServiceConnResume=axServiceConnResume, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axVcsStateChange=axVcsStateChange, axAppNotifications=axAppNotifications, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSystemStart=axSystemStart, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationOldVcsState=axNotificationOldVcsState, axSslServerCertificateErr=axSslServerCertificateErr, axVrrpActive=axVrrpActive, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled)
