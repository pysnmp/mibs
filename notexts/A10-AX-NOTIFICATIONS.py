...
ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, NotificationType, ObjectIdentity, Unsigned32, iso, TimeTicks, IpAddress, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "TimeTicks", "IpAddress", "Counter64", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationUpDown=axNotificationUpDown, axServerDown=axServerDown, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axServerConnResume=axServerConnResume, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServerDisabled=axServerDisabled, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axVirtualServerUp=axVirtualServerUp, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axVirtualServerPortDown=axVirtualServerPortDown, axSystemTempHigh=axSystemTempHigh, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemNotifications=axSystemNotifications, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axServiceConnResume=axServiceConnResume, axServiceConnLimit=axServiceConnLimit, axAppNotifications=axAppNotifications, axServiceUp=axServiceUp, axSslCertificateExpiring=axSslCertificateExpiring, axSystemDataCpuHigh=axSystemDataCpuHigh, axServerUp=axServerUp, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationIpAddressType=axNotificationIpAddressType, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSystemControlCpuHigh=axSystemControlCpuHigh, axServerPortCreateDelete=axServerPortCreateDelete, axGatewayUp=axGatewayUp, axSyslogTrap=axSyslogTrap, axNotificationVirtualServer=axNotificationVirtualServer, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotificationShutdownReason=axNotificationShutdownReason, axServiceDown=axServiceDown, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axSystemLicenseExpired=axSystemLicenseExpired, axNetworkNotifications=axNetworkNotifications, axNotificationGslbZoneName=axNotificationGslbZoneName, axServerConnRateLimit=axServerConnRateLimit, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axServiceGroupUp=axServiceGroupUp, axNotificationNewVcsState=axNotificationNewVcsState, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axHAActive=axHAActive, axNotificationSLBServer=axNotificationSLBServer, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axServiceGroupDown=axServiceGroupDown, axFan2Failure=axFan2Failure, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axHAActiveActive=axHAActiveActive, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axVrrpActive=axVrrpActive, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axServerSelectionFailure=axServerSelectionFailure, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationLsnProtoType=axNotificationLsnProtoType, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationCurrentUsage=axNotificationCurrentUsage, axSystemShutdownForReason=axSystemShutdownForReason, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axSyslogPriority=axSyslogPriority, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationGslbGroupName=axNotificationGslbGroupName, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axServiceConnRateLimit=axServiceConnRateLimit, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axMemoryUsageHigh=axMemoryUsageHigh, axSyslogModuleName=axSyslogModuleName, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationSLBPort=axNotificationSLBPort, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axSystemShutdown=axSystemShutdown, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationTacasServerHost=axNotificationTacasServerHost, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotifications=axNotifications, axNotificationSLBCurConns=axNotificationSLBCurConns, axSystemFanRecover=axSystemFanRecover, axNotificationDateTime=axNotificationDateTime, axVcsStateChange=axVcsStateChange, axNotificationHAGroup=axNotificationHAGroup, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axSystemFanFailure=axSystemFanFailure, axServerConnLimit=axServerConnLimit, axSyslogTrapObjects=axSyslogTrapObjects, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationConnLimit=axNotificationConnLimit, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axVrrpStandby=axVrrpStandby, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationFanName=axNotificationFanName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSystemRestart=axSystemRestart, axSyslogMsg=axSyslogMsg, axNotificationLsnPoolName=axNotificationLsnPoolName, axSystemStart=axSystemStart, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationTrunkID=axNotificationTrunkID, axNotificationOldVcsState=axNotificationOldVcsState, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axHighPrioritySyslog=axHighPrioritySyslog, axFan1Failure=axFan1Failure, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationPartitionName=axNotificationPartitionName, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationVrid=axNotificationVrid, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axServerCreateDelete=axServerCreateDelete, axNotificationCertificateName=axNotificationCertificateName, axHAStandby=axHAStandby, axGslbNotifications=axGslbNotifications, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axVirtualServerDown=axVirtualServerDown, axNotificationObjects=axNotificationObjects, axNotificationPartitionId=axNotificationPartitionId, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationMsg=axNotificationMsg, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGatewayDown=axGatewayDown, axSlbNotifications=axSlbNotifications, axFan3Failure=axFan3Failure, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit)
