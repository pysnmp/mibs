...
ModuleIdentity, Unsigned32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, MibIdentifier, IpAddress, TimeTicks, Gauge32, Integer32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "MibIdentifier", "IpAddress", "TimeTicks", "Gauge32", "Integer32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationNewVcsState=axNotificationNewVcsState, axSlbNotifications=axSlbNotifications, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axServerDisabled=axServerDisabled, axServerConnResume=axServerConnResume, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationOldVcsState=axNotificationOldVcsState, axSystemFanRecover=axSystemFanRecover, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axVirtualServerUp=axVirtualServerUp, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axSyslogModuleName=axSyslogModuleName, axAppNotifications=axAppNotifications, axServiceUp=axServiceUp, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSslCertificateExpiring=axSslCertificateExpiring, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationHAGroup=axNotificationHAGroup, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationUpDown=axNotificationUpDown, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationGslbSiteName=axNotificationGslbSiteName, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axSystemLicenseRequired=axSystemLicenseRequired, axSslServerCertificateErr=axSslServerCertificateErr, axSystemFanFailure=axSystemFanFailure, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationObjects=axNotificationObjects, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axSystemStart=axSystemStart, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axFan1Failure=axFan1Failure, axNotificationLsnProtoType=axNotificationLsnProtoType, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axVcsStateChange=axVcsStateChange, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axServerDown=axServerDown, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationTrueFalse=axNotificationTrueFalse, axHighPrioritySyslog=axHighPrioritySyslog, axVirtualServerDown=axVirtualServerDown, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGatewayUp=axGatewayUp, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axServerPortCreateDelete=axServerPortCreateDelete, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axServiceGroupMemberDown=axServiceGroupMemberDown, axHAActiveActive=axHAActiveActive, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServerSelectionFailure=axServerSelectionFailure, axNotificationTrunkID=axNotificationTrunkID, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axSyslogTrapPrefix=axSyslogTrapPrefix, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationMsg=axNotificationMsg, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationGslbZoneName=axNotificationGslbZoneName, axServiceConnResume=axServiceConnResume, axServiceConnLimit=axServiceConnLimit, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationCurrentUsage=axNotificationCurrentUsage, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemShutdownForReason=axSystemShutdownForReason, axServiceConnRateLimit=axServiceConnRateLimit, axServiceGroupDown=axServiceGroupDown, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axSystemDropPacketEvent=axSystemDropPacketEvent, axVirtualServerPortDown=axVirtualServerPortDown, axSyslogTrap=axSyslogTrap, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axServerConnRateLimit=axServerConnRateLimit, axNotificationShutdownReason=axNotificationShutdownReason, axServerUp=axServerUp, axFan2Failure=axFan2Failure, axHAStandby=axHAStandby, axSystemNotifications=axSystemNotifications, axNotificationIpAddressType=axNotificationIpAddressType, axSystemRestart=axSystemRestart, axNotificationDateTime=axNotificationDateTime, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSystemTempHigh=axSystemTempHigh, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationGslbGroupName=axNotificationGslbGroupName, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationSLBServer=axNotificationSLBServer, axSyslogMsg=axSyslogMsg, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationSLBCurConns=axNotificationSLBCurConns, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axServiceGroupUp=axServiceGroupUp, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axServerCreateDelete=axServerCreateDelete, axGatewayDown=axGatewayDown, axServerConnLimit=axServerConnLimit, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSyslogPriority=axSyslogPriority, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axHAActive=axHAActive, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axFan3Failure=axFan3Failure, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemShutdown=axSystemShutdown, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axHardDiskUsageHigh=axHardDiskUsageHigh, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axVrrpActive=axVrrpActive, axNotificationPortThreshold=axNotificationPortThreshold, axNetworkNotifications=axNetworkNotifications, axServiceDown=axServiceDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationVrid=axNotificationVrid, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationDroppedPackets=axNotificationDroppedPackets, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axVrrpStandby=axVrrpStandby, axNotificationFanName=axNotificationFanName, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationPartitionId=axNotificationPartitionId, axNotifications=axNotifications, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationSLBPort=axNotificationSLBPort, axNotificationCertificateName=axNotificationCertificateName, axGslbNotifications=axGslbNotifications, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationConnLimit=axNotificationConnLimit, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationPartitionName=axNotificationPartitionName, axVirtualServerPortUp=axVirtualServerPortUp)
