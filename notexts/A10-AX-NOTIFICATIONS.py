...
Gauge32, Counter64, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, ObjectIdentity, IpAddress, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationPartitionId=axNotificationPartitionId, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemFanRecover=axSystemFanRecover, axNotificationIpAddressType=axNotificationIpAddressType, axServerConnLimit=axServerConnLimit, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationMsg=axNotificationMsg, axGslbNotifications=axGslbNotifications, axSyslogModuleName=axSyslogModuleName, axNotificationVrid=axNotificationVrid, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationVirtualServer=axNotificationVirtualServer, axServiceUp=axServiceUp, axHAActive=axHAActive, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axNotifications=axNotifications, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSyslogPriority=axSyslogPriority, axServerSelectionFailure=axServerSelectionFailure, axSyslogTrap=axSyslogTrap, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationFanName=axNotificationFanName, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axVrrpStandby=axVrrpStandby, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axMemoryUsageHigh=axMemoryUsageHigh, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSystemLicenseExpired=axSystemLicenseExpired, axVrrpActive=axVrrpActive, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationObjects=axNotificationObjects, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSyslogTrapPrefix=axSyslogTrapPrefix, axAppNotifications=axAppNotifications, axServerDown=axServerDown, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServerDisabled=axServerDisabled, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axServerPortCreateDelete=axServerPortCreateDelete, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationTrueFalse=axNotificationTrueFalse, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axFan1Failure=axFan1Failure, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationDateTime=axNotificationDateTime, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationTrunkID=axNotificationTrunkID, axGatewayDown=axGatewayDown, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axServiceGroupDown=axServiceGroupDown, axFan2Failure=axFan2Failure, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationCertificateName=axNotificationCertificateName, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationSLBCurConns=axNotificationSLBCurConns, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axServerConnResume=axServerConnResume, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemShutdownForReason=axSystemShutdownForReason, axSystemNotifications=axSystemNotifications, axServerUp=axServerUp, axNotificationHAGroup=axNotificationHAGroup, axNotificationTacasServerHost=axNotificationTacasServerHost, axHardDiskUsageHigh=axHardDiskUsageHigh, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axSystemControlCpuHigh=axSystemControlCpuHigh, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNetworkNotifications=axNetworkNotifications, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axFan3Failure=axFan3Failure, axSystemTempHigh=axSystemTempHigh, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axVirtualServerPortDown=axVirtualServerPortDown, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axHAActiveActive=axHAActiveActive, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axServiceConnResume=axServiceConnResume, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationLsnPoolName=axNotificationLsnPoolName, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationNewVcsState=axNotificationNewVcsState, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axSystemDropPacketEvent=axSystemDropPacketEvent, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationUpDown=axNotificationUpDown, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemStart=axSystemStart, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationPartitionName=axNotificationPartitionName, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSystemShutdown=axSystemShutdown, axVirtualServerPortUp=axVirtualServerPortUp, axVirtualServerDown=axVirtualServerDown, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemDataCpuHigh=axSystemDataCpuHigh, axSlbNotifications=axSlbNotifications, axGatewayUp=axGatewayUp, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axVirtualServerUp=axVirtualServerUp, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axHighPrioritySyslog=axHighPrioritySyslog, axServerConnRateLimit=axServerConnRateLimit, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationSLBServer=axNotificationSLBServer, axHAStandby=axHAStandby, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationSLBPort=axNotificationSLBPort, axServiceDown=axServiceDown, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axServiceGroupUp=axServiceGroupUp, axSystemRestart=axSystemRestart, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationOldVcsState=axNotificationOldVcsState, axServiceConnLimit=axServiceConnLimit, axNotificationDroppedPackets=axNotificationDroppedPackets, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axVcsStateChange=axVcsStateChange, axSyslogMsg=axSyslogMsg, axSslServerCertificateErr=axSslServerCertificateErr, axSystemFanFailure=axSystemFanFailure, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationConnLimit=axNotificationConnLimit, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axServerCreateDelete=axServerCreateDelete)
