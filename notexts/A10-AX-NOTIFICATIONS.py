...
Bits, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, Counter64, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter64", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationGslbZoneName=axNotificationGslbZoneName, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axServiceConnResume=axServiceConnResume, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axHighPrioritySyslog=axHighPrioritySyslog, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axSyslogTrapObjects=axSyslogTrapObjects, axHAActive=axHAActive, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationPortThreshold=axNotificationPortThreshold, axSystemDropPacketEvent=axSystemDropPacketEvent, axSyslogMsg=axSyslogMsg, axNotificationPartitionId=axNotificationPartitionId, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSyslogPriority=axSyslogPriority, axVcsStateChange=axVcsStateChange, axSyslogTrapPrefix=axSyslogTrapPrefix, axSystemFanFailure=axSystemFanFailure, axVirtualServerPortUp=axVirtualServerPortUp, axSslCertificateExpiring=axSslCertificateExpiring, axSystemLicenseRequired=axSystemLicenseRequired, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axServerDown=axServerDown, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axHAActiveActive=axHAActiveActive, axServiceUp=axServiceUp, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axVrrpActive=axVrrpActive, axNotificationGslbSiteName=axNotificationGslbSiteName, axVrrpStandby=axVrrpStandby, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationMsg=axNotificationMsg, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axGslbNotifications=axGslbNotifications, axFan2Failure=axFan2Failure, axNotificationSLBCurConns=axNotificationSLBCurConns, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axServerConnRateLimit=axServerConnRateLimit, axNetworkNotifications=axNetworkNotifications, axServerDisabled=axServerDisabled, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axServerCreateDelete=axServerCreateDelete, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axSystemNotifications=axSystemNotifications, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSystemRestart=axSystemRestart, axNotificationConnLimit=axNotificationConnLimit, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationIpAddressType=axNotificationIpAddressType, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationSLBServer=axNotificationSLBServer, axSystemLicenseExpired=axSystemLicenseExpired, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationTacasServerHost=axNotificationTacasServerHost, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationVirtualServer=axNotificationVirtualServer, axHAStandby=axHAStandby, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationDateTime=axNotificationDateTime, axNotificationUpDown=axNotificationUpDown, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationShutdownReason=axNotificationShutdownReason, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSslServerCertificateErr=axSslServerCertificateErr, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationLsnProtoType=axNotificationLsnProtoType, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axServiceDown=axServiceDown, axNotificationNewVcsState=axNotificationNewVcsState, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationCertificateName=axNotificationCertificateName, axNotifications=axNotifications, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axSystemFanRecover=axSystemFanRecover, axServerConnResume=axServerConnResume, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationOldVcsState=axNotificationOldVcsState, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationFanName=axNotificationFanName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSyslogTrap=axSyslogTrap, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axMemoryUsageHigh=axMemoryUsageHigh, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationDroppedPackets=axNotificationDroppedPackets, axFan3Failure=axFan3Failure, axNotificationCurrentUsage=axNotificationCurrentUsage, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axGatewayUp=axGatewayUp, axServerConnLimit=axServerConnLimit, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationSLBPort=axNotificationSLBPort, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axAppNotifications=axAppNotifications, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationPartitionName=axNotificationPartitionName, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemControlCpuHigh=axSystemControlCpuHigh, axServerSelectionFailure=axServerSelectionFailure, axNotificationGslbGroupName=axNotificationGslbGroupName, axSystemStart=axSystemStart, axSlbNotifications=axSlbNotifications, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axVirtualServerDown=axVirtualServerDown, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axSystemDataCpuHigh=axSystemDataCpuHigh, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationLsnPoolName=axNotificationLsnPoolName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemTempHigh=axSystemTempHigh, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axFan1Failure=axFan1Failure, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axServiceGroupMemberUp=axServiceGroupMemberUp, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axSyslogModuleName=axSyslogModuleName, axNotificationHAGroup=axNotificationHAGroup, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axVirtualServerUp=axVirtualServerUp, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axServiceGroupUp=axServiceGroupUp, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationVrid=axNotificationVrid, axHardDiskUsageHigh=axHardDiskUsageHigh, axGatewayDown=axGatewayDown, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axServiceGroupDown=axServiceGroupDown, axServerUp=axServerUp, axNotificationObjects=axNotificationObjects, axServiceConnLimit=axServiceConnLimit, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axSystemShutdown=axSystemShutdown, axNotificationTrueFalse=axNotificationTrueFalse, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationTrunkID=axNotificationTrunkID)
