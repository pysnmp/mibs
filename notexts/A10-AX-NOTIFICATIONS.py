...
Integer32, Unsigned32, Gauge32, IpAddress, ModuleIdentity, Counter32, ObjectIdentity, NotificationType, Bits, Counter64, iso, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "ModuleIdentity", "Counter32", "ObjectIdentity", "NotificationType", "Bits", "Counter64", "iso", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationShutdownReason=axNotificationShutdownReason, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axAppNotifications=axAppNotifications, axSyslogPriority=axSyslogPriority, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationIpAddressType=axNotificationIpAddressType, axFan3Failure=axFan3Failure, axSystemTempHigh=axSystemTempHigh, axNotificationPartitionId=axNotificationPartitionId, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationHAGroup=axNotificationHAGroup, axVirtualServerPortDown=axVirtualServerPortDown, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServerUp=axServerUp, axNotificationObjects=axNotificationObjects, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axServerConnRateLimit=axServerConnRateLimit, axNotificationGslbSiteName=axNotificationGslbSiteName, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationConnLimit=axNotificationConnLimit, axSystemDataCpuHigh=axSystemDataCpuHigh, axFan2Failure=axFan2Failure, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axServiceConnResume=axServiceConnResume, axSystemDropPacketEvent=axSystemDropPacketEvent, axGatewayDown=axGatewayDown, axNetworkNotifications=axNetworkNotifications, axServerDown=axServerDown, axNotificationDateTime=axNotificationDateTime, axNotificationVirtualServer=axNotificationVirtualServer, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axVirtualServerDown=axVirtualServerDown, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationUpDown=axNotificationUpDown, axSystemFanFailure=axSystemFanFailure, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axServerDisabled=axServerDisabled, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemShutdown=axSystemShutdown, axNotificationGslbZoneName=axNotificationGslbZoneName, axHighPrioritySyslog=axHighPrioritySyslog, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationVrid=axNotificationVrid, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSystemNotifications=axSystemNotifications, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axGslbNotifications=axGslbNotifications, axNotificationPartitionName=axNotificationPartitionName, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axVrrpActive=axVrrpActive, axNotificationLsnProtoType=axNotificationLsnProtoType, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axSystemControlCpuHigh=axSystemControlCpuHigh, axServerPortCreateDelete=axServerPortCreateDelete, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSyslogTrap=axSyslogTrap, axNotificationTrunkID=axNotificationTrunkID, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSyslogModuleName=axSyslogModuleName, axNotificationNewVcsState=axNotificationNewVcsState, axHAActive=axHAActive, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServiceGroupUp=axServiceGroupUp, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationPortThreshold=axNotificationPortThreshold, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationOldVcsState=axNotificationOldVcsState, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axServerConnResume=axServerConnResume, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationSLBServer=axNotificationSLBServer, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationSLBPort=axNotificationSLBPort, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationSLBCurConns=axNotificationSLBCurConns, axVirtualServerPortUp=axVirtualServerPortUp, axSystemLicenseRequired=axSystemLicenseRequired, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axVcsStateChange=axVcsStateChange, axMemoryUsageHigh=axMemoryUsageHigh, axSyslogMsg=axSyslogMsg, axSystemRestart=axSystemRestart, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axFan1Failure=axFan1Failure, axServerSelectionFailure=axServerSelectionFailure, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationMsg=axNotificationMsg, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationCertificateName=axNotificationCertificateName, axSystemLicenseExpired=axSystemLicenseExpired, axServiceGroupDown=axServiceGroupDown, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axVirtualServerUp=axVirtualServerUp, axServiceConnRateLimit=axServiceConnRateLimit, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axServiceConnLimit=axServiceConnLimit, axVrrpStandby=axVrrpStandby, axHardDiskUsageHigh=axHardDiskUsageHigh, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSslServerCertificateErr=axSslServerCertificateErr, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotifications=axNotifications, axHAStandby=axHAStandby, axHAActiveActive=axHAActiveActive, axServiceDown=axServiceDown, axSystemFanRecover=axSystemFanRecover, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axServiceUp=axServiceUp, axNotificationFanName=axNotificationFanName, axSlbNotifications=axSlbNotifications, axServerConnLimit=axServerConnLimit, axSystemStart=axSystemStart, axGatewayUp=axGatewayUp, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServerCreateDelete=axServerCreateDelete, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axSystemShutdownForReason=axSystemShutdownForReason)
