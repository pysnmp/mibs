...
Counter32, MibIdentifier, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, iso, TimeTicks, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "iso", "TimeTicks", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axSystemNotifications=axSystemNotifications, axVrrpStandby=axVrrpStandby, axAppNotifications=axAppNotifications, axNotificationCurrentUsage=axNotificationCurrentUsage, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationHAGroup=axNotificationHAGroup, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationSLBPort=axNotificationSLBPort, axFan2Failure=axFan2Failure, axVirtualServerDown=axVirtualServerDown, axSyslogTrap=axSyslogTrap, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSlbNotifications=axSlbNotifications, axNotificationTacasServerHost=axNotificationTacasServerHost, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationPartitionId=axNotificationPartitionId, axSslServerCertificateErr=axSslServerCertificateErr, axServerCreateDelete=axServerCreateDelete, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axVrrpActive=axVrrpActive, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axHAActiveActive=axHAActiveActive, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axFan3Failure=axFan3Failure, axServerConnResume=axServerConnResume, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemRestart=axSystemRestart, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationUpDown=axNotificationUpDown, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationShutdownReason=axNotificationShutdownReason, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationVrid=axNotificationVrid, axServiceGroupMemberDown=axServiceGroupMemberDown, axServerSelectionFailure=axServerSelectionFailure, axHAActive=axHAActive, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationLsnProtoType=axNotificationLsnProtoType, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axHardDiskUsageHigh=axHardDiskUsageHigh, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSyslogPriority=axSyslogPriority, axNotificationMsg=axNotificationMsg, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemFanRecover=axSystemFanRecover, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axServerUp=axServerUp, axHAStandby=axHAStandby, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axServerDisabled=axServerDisabled, axSyslogModuleName=axSyslogModuleName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axServiceConnLimit=axServiceConnLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationCertificateName=axNotificationCertificateName, axSystemDropPacketEvent=axSystemDropPacketEvent, axServiceConnResume=axServiceConnResume, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationIpAddressType=axNotificationIpAddressType, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axGslbNotifications=axGslbNotifications, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axNotificationNewVcsState=axNotificationNewVcsState, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSslCertificateExpiring=axSslCertificateExpiring, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationFanName=axNotificationFanName, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axServiceGroupUp=axServiceGroupUp, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationDateTime=axNotificationDateTime, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServiceDown=axServiceDown, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axServiceGroupDown=axServiceGroupDown, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationObjects=axNotificationObjects, axNetworkNotifications=axNetworkNotifications, axServerConnLimit=axServerConnLimit, axVirtualServerUp=axVirtualServerUp, axSystemTempHigh=axSystemTempHigh, axSystemStart=axSystemStart, axVirtualServerPortUp=axVirtualServerPortUp, axGatewayUp=axGatewayUp, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axServerConnRateLimit=axServerConnRateLimit, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationTrunkID=axNotificationTrunkID, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axHighPrioritySyslog=axHighPrioritySyslog, axNotificationDroppedPackets=axNotificationDroppedPackets, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axGatewayDown=axGatewayDown, axSystemFanFailure=axSystemFanFailure, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axSystemLicenseRequired=axSystemLicenseRequired, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationConnLimit=axNotificationConnLimit, axSystemDataCpuHigh=axSystemDataCpuHigh, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationGslbSiteName=axNotificationGslbSiteName, axServerDown=axServerDown, axNotificationOldVcsState=axNotificationOldVcsState, axVcsStateChange=axVcsStateChange, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSyslogMsg=axSyslogMsg, axNotificationPartitionName=axNotificationPartitionName, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationTrueFalse=axNotificationTrueFalse, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotifications=axNotifications, axServiceUp=axServiceUp, axServiceConnRateLimit=axServiceConnRateLimit, axSystemShutdown=axSystemShutdown, axNotificationSLBServer=axNotificationSLBServer, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axFan1Failure=axFan1Failure, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh)
