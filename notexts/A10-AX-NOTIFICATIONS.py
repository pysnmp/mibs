...
Counter32, ObjectIdentity, iso, IpAddress, Integer32, Bits, Gauge32, Counter64, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "iso", "IpAddress", "Integer32", "Bits", "Gauge32", "Counter64", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axServerCreateDelete=axServerCreateDelete, axSyslogTrapObjects=axSyslogTrapObjects, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationHAGroup=axNotificationHAGroup, axNotificationTrunkID=axNotificationTrunkID, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSyslogModuleName=axSyslogModuleName, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationMsg=axNotificationMsg, axSslServerCertificateErr=axSslServerCertificateErr, axNotifications=axNotifications, axSystemTempHigh=axSystemTempHigh, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axServerPortCreateDelete=axServerPortCreateDelete, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axServerConnLimit=axServerConnLimit, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationPortThreshold=axNotificationPortThreshold, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axVrrpStandby=axVrrpStandby, axServiceGroupMemberDown=axServiceGroupMemberDown, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationConnLimit=axNotificationConnLimit, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemFanRecover=axSystemFanRecover, axGslbNotifications=axGslbNotifications, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axHAActiveActive=axHAActiveActive, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationDateTime=axNotificationDateTime, axHardDiskUsageHigh=axHardDiskUsageHigh, axVcsStateChange=axVcsStateChange, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axFan1Failure=axFan1Failure, axNotificationUpDown=axNotificationUpDown, axSystemLicenseExpired=axSystemLicenseExpired, axServiceConnResume=axServiceConnResume, axSyslogPriority=axSyslogPriority, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationGslbZoneName=axNotificationGslbZoneName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServerConnResume=axServerConnResume, axNotificationSLBPort=axNotificationSLBPort, axNotificationPartitionId=axNotificationPartitionId, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationLsnPoolName=axNotificationLsnPoolName, axHAActive=axHAActive, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSyslogMsg=axSyslogMsg, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axVrrpActive=axVrrpActive, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationNewVcsState=axNotificationNewVcsState, axServiceGroupDown=axServiceGroupDown, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemStart=axSystemStart, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSystemRestart=axSystemRestart, axNotificationIpAddressType=axNotificationIpAddressType, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNetworkNotifications=axNetworkNotifications, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axFan2Failure=axFan2Failure, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationVirtualServer=axNotificationVirtualServer, axSystemLicenseRequired=axSystemLicenseRequired, axSystemFanFailure=axSystemFanFailure, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axSystemShutdownForReason=axSystemShutdownForReason, axNotificationOldVcsState=axNotificationOldVcsState, axSystemShutdown=axSystemShutdown, axServerDown=axServerDown, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationSLBServer=axNotificationSLBServer, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationGslbGroupName=axNotificationGslbGroupName, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axSystemDataCpuHigh=axSystemDataCpuHigh, axVirtualServerUp=axVirtualServerUp, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGatewayUp=axGatewayUp, axVirtualServerDown=axVirtualServerDown, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axNotificationVrid=axNotificationVrid, axNotificationDroppedPackets=axNotificationDroppedPackets, axServerUp=axServerUp, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axFan3Failure=axFan3Failure, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axMemoryUsageHigh=axMemoryUsageHigh, axSlbNotifications=axSlbNotifications, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axHAStandby=axHAStandby, axSyslogTrapPrefix=axSyslogTrapPrefix, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axServiceDown=axServiceDown, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axNotificationCertificateName=axNotificationCertificateName, axServerDisabled=axServerDisabled, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axHighPrioritySyslog=axHighPrioritySyslog, axSslCertificateExpiring=axSslCertificateExpiring, axServiceUp=axServiceUp, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationFanName=axNotificationFanName, axNotificationPartitionName=axNotificationPartitionName, axServiceConnLimit=axServiceConnLimit, axServiceGroupUp=axServiceGroupUp, axNotificationTrueFalse=axNotificationTrueFalse, axSystemDropPacketEvent=axSystemDropPacketEvent, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemNotifications=axSystemNotifications, axGatewayDown=axGatewayDown, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axServerConnRateLimit=axServerConnRateLimit, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axServerSelectionFailure=axServerSelectionFailure, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationObjects=axNotificationObjects, axNotificationShutdownReason=axNotificationShutdownReason, axSyslogTrap=axSyslogTrap, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axAppNotifications=axAppNotifications)
