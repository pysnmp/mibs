...
iso, NotificationType, Counter32, MibIdentifier, Counter64, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Gauge32, IpAddress, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter32", "MibIdentifier", "Counter64", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Gauge32", "IpAddress", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axSyslogTrapObjects=axSyslogTrapObjects, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axSyslogModuleName=axSyslogModuleName, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axSystemLicenseExpired=axSystemLicenseExpired, axVirtualServerUp=axVirtualServerUp, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axSystemLicenseRequired=axSystemLicenseRequired, axSystemShutdown=axSystemShutdown, axNotificationHAGroup=axNotificationHAGroup, axHardDiskUsageHigh=axHardDiskUsageHigh, axServerDown=axServerDown, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axSlbNotifications=axSlbNotifications, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axNotificationVrid=axNotificationVrid, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axServerCreateDelete=axServerCreateDelete, axHighPrioritySyslog=axHighPrioritySyslog, axSystemDataCpuHigh=axSystemDataCpuHigh, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServerDisabled=axServerDisabled, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationGslbGroupName=axNotificationGslbGroupName, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axHAStandby=axHAStandby, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axServiceUp=axServiceUp, axVcsStateChange=axVcsStateChange, axMemoryUsageHigh=axMemoryUsageHigh, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationTrueFalse=axNotificationTrueFalse, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axNotificationIpAddressType=axNotificationIpAddressType, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axNotificationPartitionName=axNotificationPartitionName, axServiceConnLimit=axServiceConnLimit, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axSystemFanFailure=axSystemFanFailure, axSyslogMsg=axSyslogMsg, axNotificationDateTime=axNotificationDateTime, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axVirtualServerPortUp=axVirtualServerPortUp, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axServerConnResume=axServerConnResume, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemStart=axSystemStart, axFan2Failure=axFan2Failure, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axVirtualServerPortDown=axVirtualServerPortDown, axServerConnLimit=axServerConnLimit, axNotificationSLBServer=axNotificationSLBServer, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemRestart=axSystemRestart, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationShutdownReason=axNotificationShutdownReason, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNotificationNewVcsState=axNotificationNewVcsState, axSystemFanRecover=axSystemFanRecover, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemDropPacketEvent=axSystemDropPacketEvent, axFan1Failure=axFan1Failure, axSystemControlCpuHigh=axSystemControlCpuHigh, axGatewayDown=axGatewayDown, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axVrrpStandby=axVrrpStandby, axNotificationObjects=axNotificationObjects, axNotificationPartitionId=axNotificationPartitionId, axNotificationLsnPoolName=axNotificationLsnPoolName, axGslbNotifications=axGslbNotifications, axServerUp=axServerUp, axServiceConnResume=axServiceConnResume, axSystemTempHigh=axSystemTempHigh, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationTrunkID=axNotificationTrunkID, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationDroppedPackets=axNotificationDroppedPackets, axServiceGroupMemberUp=axServiceGroupMemberUp, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationGslbZoneName=axNotificationGslbZoneName, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axServiceGroupMemberDown=axServiceGroupMemberDown, axGatewayUp=axGatewayUp, axServiceDown=axServiceDown, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axHAActive=axHAActive, axNotificationOldVcsState=axNotificationOldVcsState, axSystemNotifications=axSystemNotifications, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axSyslogTrapPrefix=axSyslogTrapPrefix, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axHAActiveActive=axHAActiveActive, axSyslogPriority=axSyslogPriority, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationLsnProtoType=axNotificationLsnProtoType, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotifications=axNotifications, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationUpDown=axNotificationUpDown, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axSyslogTrap=axSyslogTrap, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationSLBPort=axNotificationSLBPort, axNotificationConnLimit=axNotificationConnLimit, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axAppNotifications=axAppNotifications, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationCurrentUsage=axNotificationCurrentUsage, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationCertificateName=axNotificationCertificateName, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axSystemShutdownForReason=axSystemShutdownForReason, axVrrpActive=axVrrpActive, axNotificationMsg=axNotificationMsg, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axVirtualServerDown=axVirtualServerDown, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axServiceGroupUp=axServiceGroupUp, axNotificationFanName=axNotificationFanName, axServiceGroupDown=axServiceGroupDown, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axFan3Failure=axFan3Failure, axSslServerCertificateErr=axSslServerCertificateErr, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axSslCertificateExpiring=axSslCertificateExpiring, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNetworkNotifications=axNetworkNotifications, axServerConnRateLimit=axServerConnRateLimit, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axServerSelectionFailure=axServerSelectionFailure, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster)
