...
ObjectIdentity, NotificationType, Bits, ModuleIdentity, Counter64, TimeTicks, Gauge32, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "ModuleIdentity", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axServerDisabled=axServerDisabled, axFan2Failure=axFan2Failure, axSyslogTrapObjects=axSyslogTrapObjects, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axServerConnLimit=axServerConnLimit, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationObjects=axNotificationObjects, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServiceConnResume=axServiceConnResume, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationMsg=axNotificationMsg, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotifications=axNotifications, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axServerCreateDelete=axServerCreateDelete, axSystemShutdownForReason=axSystemShutdownForReason, axNetworkNotifications=axNetworkNotifications, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axServerSelectionFailure=axServerSelectionFailure, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationFanName=axNotificationFanName, axServerUp=axServerUp, axSystemDropPacketEvent=axSystemDropPacketEvent, axFan3Failure=axFan3Failure, axSystemControlCpuHigh=axSystemControlCpuHigh, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axGatewayUp=axGatewayUp, axVirtualServerPortDown=axVirtualServerPortDown, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axVrrpActive=axVrrpActive, axSlbNotifications=axSlbNotifications, axServerConnRateLimit=axServerConnRateLimit, axSyslogMsg=axSyslogMsg, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axServiceGroupMemberUp=axServiceGroupMemberUp, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axServerDown=axServerDown, axNotificationPortThreshold=axNotificationPortThreshold, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axVirtualServerUp=axVirtualServerUp, axHAActive=axHAActive, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axHighPrioritySyslog=axHighPrioritySyslog, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axServiceGroupMemberDown=axServiceGroupMemberDown, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axNotificationPartitionName=axNotificationPartitionName, axHAStandby=axHAStandby, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationPartitionId=axNotificationPartitionId, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationOldVcsState=axNotificationOldVcsState, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationSLBPort=axNotificationSLBPort, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationHAGroup=axNotificationHAGroup, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSyslogModuleName=axSyslogModuleName, axSslCertificateExpiring=axSslCertificateExpiring, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationGslbZoneName=axNotificationGslbZoneName, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axServerConnResume=axServerConnResume, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationTrueFalse=axNotificationTrueFalse, axMemoryUsageHigh=axMemoryUsageHigh, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationTacasServerHost=axNotificationTacasServerHost, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axServiceGroupUp=axServiceGroupUp, axServiceConnLimit=axServiceConnLimit, axVrrpStandby=axVrrpStandby, axNotificationDateTime=axNotificationDateTime, axServerPortCreateDelete=axServerPortCreateDelete, axAppNotifications=axAppNotifications, axSystemRestart=axSystemRestart, axNotificationCurrentUsage=axNotificationCurrentUsage, axVirtualServerDown=axVirtualServerDown, axNotificationGslbSiteName=axNotificationGslbSiteName, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationSLBCurConns=axNotificationSLBCurConns, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axGatewayDown=axGatewayDown, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemShutdown=axSystemShutdown, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axSyslogPriority=axSyslogPriority, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationDroppedPackets=axNotificationDroppedPackets, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationSLBServer=axNotificationSLBServer, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axHAActiveActive=axHAActiveActive, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axSystemFanFailure=axSystemFanFailure, axNotificationTrunkID=axNotificationTrunkID, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axVcsStateChange=axVcsStateChange, axNotificationIpAddressType=axNotificationIpAddressType, axServiceGroupDown=axServiceGroupDown, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServiceDown=axServiceDown, axServiceUp=axServiceUp, axNotificationVrid=axNotificationVrid, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axSystemTempHigh=axSystemTempHigh, axNotificationNewVcsState=axNotificationNewVcsState, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axSystemNotifications=axSystemNotifications, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationConnLimit=axNotificationConnLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axGslbNotifications=axGslbNotifications, axSystemLicenseExpired=axSystemLicenseExpired, axNotificationVirtualServer=axNotificationVirtualServer, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSystemFanRecover=axSystemFanRecover, axSyslogTrap=axSyslogTrap, axFan1Failure=axFan1Failure, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationUpDown=axNotificationUpDown, axSystemDataCpuHigh=axSystemDataCpuHigh, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemStart=axSystemStart, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationCertificateName=axNotificationCertificateName)
