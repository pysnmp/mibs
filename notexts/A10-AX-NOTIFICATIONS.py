...
iso, Bits, Integer32, TimeTicks, Counter32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Unsigned32, IpAddress, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationUpDown=axNotificationUpDown, axSystemShutdown=axSystemShutdown, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axSystemShutdownForReason=axSystemShutdownForReason, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axServerConnResume=axServerConnResume, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axFan2Failure=axFan2Failure, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationGslbSiteName=axNotificationGslbSiteName, axVirtualServerDown=axVirtualServerDown, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axServiceUp=axServiceUp, axNotificationCurrentUsage=axNotificationCurrentUsage, axMemoryUsageHigh=axMemoryUsageHigh, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationConnLimit=axNotificationConnLimit, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axServerConnRateLimit=axServerConnRateLimit, axSyslogPriority=axSyslogPriority, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axServiceConnResume=axServiceConnResume, axNotificationFanName=axNotificationFanName, axSyslogMsg=axSyslogMsg, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axFan3Failure=axFan3Failure, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axSystemFanRecover=axSystemFanRecover, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationLsnPoolName=axNotificationLsnPoolName, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationTacasServerHost=axNotificationTacasServerHost, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationObjects=axNotificationObjects, axNotificationPartitionId=axNotificationPartitionId, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axSslServerCertificateErr=axSslServerCertificateErr, axServerSelectionFailure=axServerSelectionFailure, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axServiceGroupUp=axServiceGroupUp, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axSlbNotifications=axSlbNotifications, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationMsg=axNotificationMsg, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axSyslogTrapPrefix=axSyslogTrapPrefix, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationSLBCurConns=axNotificationSLBCurConns, axSystemDropPacketEvent=axSystemDropPacketEvent, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axSystemRestart=axSystemRestart, axSyslogModuleName=axSyslogModuleName, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axServiceDown=axServiceDown, axHAStandby=axHAStandby, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axSystemLicenseRequired=axSystemLicenseRequired, axHAActiveActive=axHAActiveActive, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axGslbNotifications=axGslbNotifications, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationDateTime=axNotificationDateTime, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axServiceGroupDown=axServiceGroupDown, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axNotificationVrid=axNotificationVrid, axNotificationTrunkID=axNotificationTrunkID, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axServerDown=axServerDown, axGatewayDown=axGatewayDown, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationPartitionName=axNotificationPartitionName, axServiceConnLimit=axServiceConnLimit, axVrrpActive=axVrrpActive, axNotificationSLBPort=axNotificationSLBPort, axVrrpStandby=axVrrpStandby, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSslCertificateExpiring=axSslCertificateExpiring, axNetworkNotifications=axNetworkNotifications, axFan1Failure=axFan1Failure, axSystemStart=axSystemStart, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationOldVcsState=axNotificationOldVcsState, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axServiceGroupMemberUp=axServiceGroupMemberUp, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axSystemNotifications=axSystemNotifications, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axVirtualServerUp=axVirtualServerUp, axServerUp=axServerUp, axHAActive=axHAActive, axSyslogTrapObjects=axSyslogTrapObjects, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNotificationSLBServer=axNotificationSLBServer, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationTrueFalse=axNotificationTrueFalse, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axNotificationShutdownReason=axNotificationShutdownReason, axNotificationLsnProtoType=axNotificationLsnProtoType, axServerConnLimit=axServerConnLimit, axVcsStateChange=axVcsStateChange, axServerPortCreateDelete=axServerPortCreateDelete, axSyslogTrap=axSyslogTrap, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axServerDisabled=axServerDisabled, axGatewayUp=axGatewayUp, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axServerCreateDelete=axServerCreateDelete, axNotifications=axNotifications, axNotificationIpAddressType=axNotificationIpAddressType, axHighPrioritySyslog=axHighPrioritySyslog, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axSystemLicenseExpired=axSystemLicenseExpired, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationHAGroup=axNotificationHAGroup, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationCertificateName=axNotificationCertificateName, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationNewVcsState=axNotificationNewVcsState, axSystemFanFailure=axSystemFanFailure, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axSystemTempHigh=axSystemTempHigh, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axVirtualServerPortDown=axVirtualServerPortDown, axSystemDataCpuHigh=axSystemDataCpuHigh, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axAppNotifications=axAppNotifications)
