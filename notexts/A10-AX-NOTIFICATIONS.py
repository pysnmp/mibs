...
ObjectIdentity, IpAddress, Counter64, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, iso, TimeTicks, NotificationType, Gauge32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "iso", "TimeTicks", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axVirtualServerUp=axVirtualServerUp, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axVirtualServerPortDown=axVirtualServerPortDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axNotificationDroppedPackets=axNotificationDroppedPackets, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axFan2Failure=axFan2Failure, axSystemDataCpuHigh=axSystemDataCpuHigh, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axNotificationPartitionName=axNotificationPartitionName, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationObjects=axNotificationObjects, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationVrid=axNotificationVrid, axSyslogMsg=axSyslogMsg, axServerConnLimit=axServerConnLimit, axHAActive=axHAActive, axNotificationMsg=axNotificationMsg, axSystemLicenseRequired=axSystemLicenseRequired, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationCertificateName=axNotificationCertificateName, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axVcsStateChange=axVcsStateChange, axNotificationSLBServer=axNotificationSLBServer, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axVrrpActive=axVrrpActive, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axGatewayDown=axGatewayDown, axVirtualServerDown=axVirtualServerDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationLsnPoolName=axNotificationLsnPoolName, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axSystemStart=axSystemStart, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axHardDiskUsageHigh=axHardDiskUsageHigh, axServiceGroupDown=axServiceGroupDown, axServerDisabled=axServerDisabled, axNotificationNewVcsState=axNotificationNewVcsState, axServerDown=axServerDown, axServiceGroupMemberDown=axServiceGroupMemberDown, axGatewayUp=axGatewayUp, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemShutdown=axSystemShutdown, axGslbNotifications=axGslbNotifications, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationOldVcsState=axNotificationOldVcsState, axNotificationShutdownReason=axNotificationShutdownReason, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axMemoryUsageHigh=axMemoryUsageHigh, axSyslogModuleName=axSyslogModuleName, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axSystemFanRecover=axSystemFanRecover, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axServiceConnLimit=axServiceConnLimit, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axServerSelectionFailure=axServerSelectionFailure, axNotificationDateTime=axNotificationDateTime, axNotificationLsnProtoType=axNotificationLsnProtoType, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axSystemRestart=axSystemRestart, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationGslbZoneName=axNotificationGslbZoneName, axSlbNotifications=axSlbNotifications, axServiceUp=axServiceUp, axNotificationHAGroup=axNotificationHAGroup, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axHighPrioritySyslog=axHighPrioritySyslog, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationUpDown=axNotificationUpDown, axSyslogTrapObjects=axSyslogTrapObjects, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationPartitionId=axNotificationPartitionId, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axSystemTempHigh=axSystemTempHigh, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axNetworkNotifications=axNetworkNotifications, axNotifications=axNotifications, axVirtualServerPortUp=axVirtualServerPortUp, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axSystemLicenseExpired=axSystemLicenseExpired, axServiceDown=axServiceDown, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationFanName=axNotificationFanName, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axFan3Failure=axFan3Failure, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axServiceGroupUp=axServiceGroupUp, axSslCertificateExpiring=axSslCertificateExpiring, axServiceConnRateLimit=axServiceConnRateLimit, axSystemControlCpuHigh=axSystemControlCpuHigh, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axNotificationSLBCurConns=axNotificationSLBCurConns, axSyslogPriority=axSyslogPriority, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axFan1Failure=axFan1Failure, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axVrrpStandby=axVrrpStandby, axAppNotifications=axAppNotifications, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotificationTrunkID=axNotificationTrunkID, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axSystemShutdownForReason=axSystemShutdownForReason, axServiceConnResume=axServiceConnResume, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationIpAddressType=axNotificationIpAddressType, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemFanFailure=axSystemFanFailure, axSyslogTrap=axSyslogTrap, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServerConnRateLimit=axServerConnRateLimit, axNotificationSLBPort=axNotificationSLBPort, axServerUp=axServerUp, axSslServerCertificateErr=axSslServerCertificateErr, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axHAActiveActive=axHAActiveActive, axSystemNotifications=axSystemNotifications, axServerCreateDelete=axServerCreateDelete, axHAStandby=axHAStandby, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axServerConnResume=axServerConnResume, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationConnLimit=axNotificationConnLimit, axNotificationGslbGroupName=axNotificationGslbGroupName, axServiceGroupMemberUp=axServiceGroupMemberUp, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration)
