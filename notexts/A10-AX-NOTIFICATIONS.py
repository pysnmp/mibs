...
ObjectIdentity, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, iso, Bits, Integer32, NotificationType, Counter32, Counter64, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "iso", "Bits", "Integer32", "NotificationType", "Counter32", "Counter64", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axServiceConnResume=axServiceConnResume, axServerDown=axServerDown, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axServerConnLimit=axServerConnLimit, axServiceGroupDown=axServiceGroupDown, axVcsStateChange=axVcsStateChange, axServiceUp=axServiceUp, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationSLBPort=axNotificationSLBPort, axServiceConnRateLimit=axServiceConnRateLimit, axSystemDataCpuHigh=axSystemDataCpuHigh, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationVirtualServer=axNotificationVirtualServer, axServerCreateDelete=axServerCreateDelete, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationLsnPoolName=axNotificationLsnPoolName, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axSystemShutdownForReason=axSystemShutdownForReason, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSslServerCertificateErr=axSslServerCertificateErr, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axServerPortCreateDelete=axServerPortCreateDelete, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationGslbSiteName=axNotificationGslbSiteName, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axServerUp=axServerUp, axNotificationDateTime=axNotificationDateTime, axNotificationSLBCurConns=axNotificationSLBCurConns, axHAStandby=axHAStandby, axHAActive=axHAActive, axNotificationMsg=axNotificationMsg, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemFanFailure=axSystemFanFailure, axSystemStart=axSystemStart, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axServerConnRateLimit=axServerConnRateLimit, axNotificationIpAddressType=axNotificationIpAddressType, axNotificationCertificateName=axNotificationCertificateName, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axVirtualServerUp=axVirtualServerUp, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axAppNotifications=axAppNotifications, axVirtualServerPortUp=axVirtualServerPortUp, axNotificationFanName=axNotificationFanName, axSyslogMsg=axSyslogMsg, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axGslbNotifications=axGslbNotifications, axVrrpActive=axVrrpActive, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axNotificationPortThreshold=axNotificationPortThreshold, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axSyslogTrapObjects=axSyslogTrapObjects, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationTacasServerHost=axNotificationTacasServerHost, axServerDisabled=axServerDisabled, axGatewayDown=axGatewayDown, axHardDiskUsageHigh=axHardDiskUsageHigh, axNotificationGslbGroupName=axNotificationGslbGroupName, axNotificationObjects=axNotificationObjects, axSystemLicenseExpired=axSystemLicenseExpired, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axSyslogTrap=axSyslogTrap, axSystemRestart=axSystemRestart, axServiceGroupMemberUp=axServiceGroupMemberUp, axSlbNotifications=axSlbNotifications, axNotificationConnLimit=axNotificationConnLimit, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axServerConnResume=axServerConnResume, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axServerSelectionFailure=axServerSelectionFailure, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationPartitionId=axNotificationPartitionId, axVirtualServerDown=axVirtualServerDown, axSystemNotifications=axSystemNotifications, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axHighPrioritySyslog=axHighPrioritySyslog, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axHAActiveActive=axHAActiveActive, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axServiceDown=axServiceDown, axNotificationVrid=axNotificationVrid, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axFan1Failure=axFan1Failure, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axServiceConnLimit=axServiceConnLimit, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axServiceGroupUp=axServiceGroupUp, axNotificationTrunkID=axNotificationTrunkID, axNotificationNewVcsState=axNotificationNewVcsState, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axFan2Failure=axFan2Failure, axSyslogTrapPrefix=axSyslogTrapPrefix, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationOldVcsState=axNotificationOldVcsState, axSystemFanRecover=axSystemFanRecover, axVirtualServerPortDown=axVirtualServerPortDown, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axNetworkNotifications=axNetworkNotifications, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axNotificationUpDown=axNotificationUpDown, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axServiceGroupMemberDown=axServiceGroupMemberDown, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axSystemLicenseRequired=axSystemLicenseRequired, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationPartitionName=axNotificationPartitionName, axNotificationLsnProtoType=axNotificationLsnProtoType, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axGatewayUp=axGatewayUp, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axNotifications=axNotifications, axSystemTempHigh=axSystemTempHigh, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationSLBServer=axNotificationSLBServer, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axNotificationShutdownReason=axNotificationShutdownReason, axFan3Failure=axFan3Failure, axMemoryUsageHigh=axMemoryUsageHigh, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axSystemShutdown=axSystemShutdown, axNotificationHAGroup=axNotificationHAGroup, axSyslogModuleName=axSyslogModuleName, axNotificationTrueFalse=axNotificationTrueFalse, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axVrrpStandby=axVrrpStandby, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axSyslogPriority=axSyslogPriority, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts)
