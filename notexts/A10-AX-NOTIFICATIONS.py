...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Counter64, Bits, NotificationType, IpAddress, ObjectIdentity, ModuleIdentity, Unsigned32, Gauge32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Counter64", "Bits", "NotificationType", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationVrid=axNotificationVrid, axMemoryUsageHigh=axMemoryUsageHigh, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axServiceGroupDown=axServiceGroupDown, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationMsg=axNotificationMsg, axGslbNotifications=axGslbNotifications, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axSystemFanRecover=axSystemFanRecover, axServerCreateDelete=axServerCreateDelete, axSystemLicenseExpired=axSystemLicenseExpired, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axServiceGroupMemberUp=axServiceGroupMemberUp, axSyslogPriority=axSyslogPriority, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axHighPrioritySyslog=axHighPrioritySyslog, axServiceDown=axServiceDown, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationHAGroup=axNotificationHAGroup, axSystemShutdownForReason=axSystemShutdownForReason, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axSystemNotifications=axSystemNotifications, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axSslServerCertificateErr=axSslServerCertificateErr, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axSyslogTrapPrefix=axSyslogTrapPrefix, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axServerSelectionFailure=axServerSelectionFailure, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axVirtualServerUp=axVirtualServerUp, axHAStandby=axHAStandby, axSystemShutdown=axSystemShutdown, axGatewayDown=axGatewayDown, axFan2Failure=axFan2Failure, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axNotificationSLBPort=axNotificationSLBPort, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNotificationUpDown=axNotificationUpDown, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axNotificationLsnProtoType=axNotificationLsnProtoType, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axServerConnResume=axServerConnResume, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axNotificationFanName=axNotificationFanName, axSystemDataCpuHigh=axSystemDataCpuHigh, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axSyslogModuleName=axSyslogModuleName, axSystemControlCpuHigh=axSystemControlCpuHigh, axSystemFanFailure=axSystemFanFailure, axSystemRestart=axSystemRestart, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axFan3Failure=axFan3Failure, axNotificationGslbSiteName=axNotificationGslbSiteName, axNetworkNotifications=axNetworkNotifications, axVcsStateChange=axVcsStateChange, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationObjects=axNotificationObjects, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axHardDiskUsageHigh=axHardDiskUsageHigh, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axSystemTempHigh=axSystemTempHigh, axFan1Failure=axFan1Failure, axServerUp=axServerUp, axServerConnRateLimit=axServerConnRateLimit, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axNotificationShutdownReason=axNotificationShutdownReason, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationDateTime=axNotificationDateTime, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axSystemLicenseRequired=axSystemLicenseRequired, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axServerDown=axServerDown, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemDropPacketEvent=axSystemDropPacketEvent, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axSyslogTrapObjects=axSyslogTrapObjects, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axServerDisabled=axServerDisabled, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axNotificationPartitionId=axNotificationPartitionId, axSyslogMsg=axSyslogMsg, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationCertificateName=axNotificationCertificateName, axNotificationGslbZoneName=axNotificationGslbZoneName, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axServiceGroupMemberDown=axServiceGroupMemberDown, axVirtualServerPortUp=axVirtualServerPortUp, axServiceConnLimit=axServiceConnLimit, axNotifications=axNotifications, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axGatewayUp=axGatewayUp, axServiceConnResume=axServiceConnResume, axAppNotifications=axAppNotifications, axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axVirtualServerDown=axVirtualServerDown, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axHAActive=axHAActive, axNotificationPartitionName=axNotificationPartitionName, axVrrpStandby=axVrrpStandby, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationIpAddressType=axNotificationIpAddressType, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationSLBServer=axNotificationSLBServer, axNotificationOldVcsState=axNotificationOldVcsState, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axServerConnLimit=axServerConnLimit, axNotificationTrunkID=axNotificationTrunkID, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSlbNotifications=axSlbNotifications, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axVirtualServerPortDown=axVirtualServerPortDown, axVrrpActive=axVrrpActive, axNotificationNewVcsState=axNotificationNewVcsState, axNotificationVirtualServer=axNotificationVirtualServer, axServiceUp=axServiceUp, axServiceGroupUp=axServiceGroupUp, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationDroppedPackets=axNotificationDroppedPackets, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axSyslogTrap=axSyslogTrap, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationTrueFalse=axNotificationTrueFalse, axNotificationConnLimit=axNotificationConnLimit, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axNotificationLsnPoolName=axNotificationLsnPoolName, axNotificationGslbGroupName=axNotificationGslbGroupName, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axSystemStart=axSystemStart, axHAActiveActive=axHAActiveActive, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName)
