...
MibIdentifier, Counter64, iso, Bits, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "iso", "Bits", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("A10-AX-NOTIFICATIONS", axLowerPowerSupplyFailure=axLowerPowerSupplyFailure, axGslbZoneServiceAdminDisabled=axGslbZoneServiceAdminDisabled, axNotificationPowerSupplyName=axNotificationPowerSupplyName, axServiceGroupMemberEnabledForNewConn=axServiceGroupMemberEnabledForNewConn, axVrrpActive=axVrrpActive, axNotificationTrueFalse=axNotificationTrueFalse, axSystemSmpResourceHigh=axSystemSmpResourceHigh, axServiceConnRateLimit=axServiceConnRateLimit, axNotificationDroppedPackets=axNotificationDroppedPackets, axNotificationSLBServiceGroupName=axNotificationSLBServiceGroupName, axSslServerCertificateErr=axSslServerCertificateErr, axNotificationGslbSiteName=axNotificationGslbSiteName, axNotifications=axNotifications, axSystemLicenseLoadSuccessful=axSystemLicenseLoadSuccessful, axNotificationServerSelectionFailureReason=axNotificationServerSelectionFailureReason, axSystemControlCpuHigh=axSystemControlCpuHigh, axServerConnRateLimit=axServerConnRateLimit, axNotificationSslServerCertificateErrCounter=axNotificationSslServerCertificateErrCounter, axSyslogMsg=axSyslogMsg, axSystemTempBecomeNormal=axSystemTempBecomeNormal, axGslbSiteOperationalStateUp=axGslbSiteOperationalStateUp, axFileSystemBecomeReadOnly=axFileSystemBecomeReadOnly, axSystemConnectionResourceHigh=axSystemConnectionResourceHigh, axServerConnResume=axServerConnResume, axApplicationBufferReachLimit=axApplicationBufferReachLimit, axNotificationFanName=axNotificationFanName, axServerUp=axServerUp, axVirtualServerPortReachConnRateLimit=axVirtualServerPortReachConnRateLimit, axNetworkTrunkPortsThreshold=axNetworkTrunkPortsThreshold, axServiceGroupDown=axServiceGroupDown, axSystemRelieveDropPacketEvent=axSystemRelieveDropPacketEvent, axVirtualServerDown=axVirtualServerDown, axSystemTempHigh=axSystemTempHigh, axGslbSiteAdminDisabled=axGslbSiteAdminDisabled, axGslbGroupRemovedMaster=axGslbGroupRemovedMaster, axNotificationNewVcsState=axNotificationNewVcsState, axSystemShutdownForReason=axSystemShutdownForReason, axSystemSmpResourceBecomeNormal=axSystemSmpResourceBecomeNormal, axNotificationLsnIpAddress=axNotificationLsnIpAddress, axVirtualServerPortDown=axVirtualServerPortDown, axGslbSiteOperationalStateDown=axGslbSiteOperationalStateDown, axSystemPowerSupplyFailure=axSystemPowerSupplyFailure, axNotificationSLBPort=axNotificationSLBPort, axSystemDropPacketEvent=axSystemDropPacketEvent, axNotificationSLBCurConns=axNotificationSLBCurConns, axNotificationGslbGroupName=axNotificationGslbGroupName, axGslbGroupMemberLeaveGroup=axGslbGroupMemberLeaveGroup, axServerDisabled=axServerDisabled, axNotificationCertificateName=axNotificationCertificateName, axNotificationPartitionResourceName=axNotificationPartitionResourceName, axNotificationDateTime=axNotificationDateTime, axNotificationPortThreshold=axNotificationPortThreshold, axNotificationGslbZoneServiceProto=axNotificationGslbZoneServiceProto, axSystemStart=axSystemStart, axNotificationHAGroup=axNotificationHAGroup, axGslbServiceIpPortStateUp=axGslbServiceIpPortStateUp, axNotificationConnLimit=axNotificationConnLimit, axNotificationLsnFixedNatPortMappingFileChangeType=axNotificationLsnFixedNatPortMappingFileChangeType, axGslbServiceIpPortStateDown=axGslbServiceIpPortStateDown, axSystemFanRecover=axSystemFanRecover, axGslbNotifications=axGslbNotifications, axNotificationVrid=axNotificationVrid, axGslbGroupBecomeMaster=axGslbGroupBecomeMaster, axNotificationLsnExceededTimes=axNotificationLsnExceededTimes, axSystemConnectionResourceBecomeNormal=axSystemConnectionResourceBecomeNormal, axServiceGroupMemberDisabledForNewConn=axServiceGroupMemberDisabledForNewConn, axPartitionResourceUsageWarning=axPartitionResourceUsageWarning, axSystemDataCpuHigh=axSystemDataCpuHigh, axServiceConnLimit=axServiceConnLimit, axVirtualServerPortCreateDelete=axVirtualServerPortCreateDelete, axSyslogTrapPrefix=axSyslogTrapPrefix, axGatewayDown=axGatewayDown, axSystemShutdown=axSystemShutdown, axFan1Failure=axFan1Failure, axGslbSiteSlbDeviceStateUp=axGslbSiteSlbDeviceStateUp, axSecondaryHardDiskFailure=axSecondaryHardDiskFailure, axNotificationPartitionId=axNotificationPartitionId, axNotificationGslbGroupEntity=axNotificationGslbGroupEntity, axHAStandby=axHAStandby, axServiceGroupMemberUp=axServiceGroupMemberUp, axSyslogTrapObjects=axSyslogTrapObjects, axNotificationVirtualServerPortType=axNotificationVirtualServerPortType, axSystemLicensedModuleDisabledForDuration=axSystemLicensedModuleDisabledForDuration, axNotificationSLBServer=axNotificationSLBServer, axNotificationLicensedModuleName=axNotificationLicensedModuleName, axNotificationUpDown=axNotificationUpDown, axNotificationSLBServerPortType=axNotificationSLBServerPortType, axMemoryUsageBecomeNormal=axMemoryUsageBecomeNormal, axVirtualServerReachConnLimit=axVirtualServerReachConnLimit, axServerDown=axServerDown, axNotificationPartitionResourceUsageLevel=axNotificationPartitionResourceUsageLevel, axNotificationLicenseDisableDuration=axNotificationLicenseDisableDuration, axVirtualServerUp=axVirtualServerUp, axServiceGroupMemberDown=axServiceGroupMemberDown, axNotificationLsnPoolName=axNotificationLsnPoolName, axSlbNotifications=axSlbNotifications, axGslbGroupMemberJoinGroup=axGslbGroupMemberJoinGroup, axHardDiskUsageBecomeNormal=axHardDiskUsageBecomeNormal, axPrimaryHardDiskFailure=axPrimaryHardDiskFailure, axSystemPowerSupplyRecover=axSystemPowerSupplyRecover, axServerCreateDelete=axServerCreateDelete, axUpperPowerSupplyFailure=axUpperPowerSupplyFailure, axSystemLicenseExpired=axSystemLicenseExpired, axGatewayUp=axGatewayUp, axNotificationGslbZoneServiceName=axNotificationGslbZoneServiceName, axHAActiveActive=axHAActiveActive, axServiceUp=axServiceUp, axNotificationCurrentUsage=axNotificationCurrentUsage, axNotificationTrunkID=axNotificationTrunkID, axServerConnLimit=axServerConnLimit, axSslCertificateCreateDelete=axSslCertificateCreateDelete, axNotificationLsnFixedNatPortMappingFileName=axNotificationLsnFixedNatPortMappingFileName, axNotificationSlbObjectChange=axNotificationSlbObjectChange, axGslbServiceIpOperationalStateUp=axGslbServiceIpOperationalStateUp, axNotificationConnectionTypeName=axNotificationConnectionTypeName, axServiceGroupUp=axServiceGroupUp, axServerPortCreateDelete=axServerPortCreateDelete, axNotificationVirtualServerPort=axNotificationVirtualServerPort, axVirtualServerPortReachConnLimit=axVirtualServerPortReachConnLimit, axSystemControlCpuBecomeNormal=axSystemControlCpuBecomeNormal, axNotificationIpAddressType=axNotificationIpAddressType, axGslbZoneOperationalStateDown=axGslbZoneOperationalStateDown, axNotificationTacasServerHost=axNotificationTacasServerHost, axNetworkNotifications=axNetworkNotifications, axGslbSiteSlbDeviceStateDown=axGslbSiteSlbDeviceStateDown, axNotificationLsnCurrentUsage=axNotificationLsnCurrentUsage, axGslbZoneAdminEnabled=axGslbZoneAdminEnabled, axNotificationGslbServiceIpAddr=axNotificationGslbServiceIpAddr, axTacacsMonitorServerUpDown=axTacacsMonitorServerUpDown, axNotificationConfiguredThreshold=axNotificationConfiguredThreshold, axNotificationShutdownReason=axNotificationShutdownReason, axSystemLicenseRequired=axSystemLicenseRequired, axNotificationOldVcsState=axNotificationOldVcsState, axSyslogPriority=axSyslogPriority, axSystemRestart=axSystemRestart, axHAActive=axHAActive, axSystemDataCpuBecomeNormal=axSystemDataCpuBecomeNormal, axVirtualServerCreateDelete=axVirtualServerCreateDelete, axVcsStateChange=axVcsStateChange, axSyslogModuleName=axSyslogModuleName, axSyslogTrap=axSyslogTrap, axVrrpStandby=axVrrpStandby, axVirtualServerReachConnRateLimit=axVirtualServerReachConnRateLimit, axGslbServiceIpAdminDisabled=axGslbServiceIpAdminDisabled, axHighPrioritySyslog=axHighPrioritySyslog, axGslbZoneOperationalStateUp=axGslbZoneOperationalStateUp, axMemoryUsageHigh=axMemoryUsageHigh, axServerSelectionFailure=axServerSelectionFailure, axGslbSiteAdminEnabled=axGslbSiteAdminEnabled, axServiceDown=axServiceDown, axSslCertificateExpiring=axSslCertificateExpiring, axNotificationObjects=axNotificationObjects, axGslbServiceIpOperationalStateDown=axGslbServiceIpOperationalStateDown, axFan2Failure=axFan2Failure, axNotificationGslbServiceIpPortType=axNotificationGslbServiceIpPortType, axNotificationGslbSiteSlbDeviceName=axNotificationGslbSiteSlbDeviceName, axFan3Failure=axFan3Failure, axVirtualServerPortUp=axVirtualServerPortUp, axHardDiskUsageHigh=axHardDiskUsageHigh, axAppNotifications=axAppNotifications, axGslbZoneServiceAdminEnabled=axGslbZoneServiceAdminEnabled, axServiceConnResume=axServiceConnResume, axNotificationLsnProtoType=axNotificationLsnProtoType, axSystemNotifications=axSystemNotifications, axGslbZoneServiceOperationalStateUp=axGslbZoneServiceOperationalStateUp, axNotificationVirtualServer=axNotificationVirtualServer, axNotificationGslbSiteIpServerAddr=axNotificationGslbSiteIpServerAddr, axNotificationPartitionName=axNotificationPartitionName, axNotificationCurrentUpPorts=axNotificationCurrentUpPorts, axGslbServiceIpAdminEnabled=axGslbServiceIpAdminEnabled, axGslbZoneAdminDisabled=axGslbZoneAdminDisabled, axNotificationGslbServiceIpName=axNotificationGslbServiceIpName, axSystemFanFailure=axSystemFanFailure, axGslbZoneServiceOperationalStateDown=axGslbZoneServiceOperationalStateDown, axNotificationGslbZoneName=axNotificationGslbZoneName, axNotificationMsg=axNotificationMsg)
