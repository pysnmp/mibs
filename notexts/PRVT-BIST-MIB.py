...
switch, reportsL2IfaceUnit, reportsL2IfacePort, reportsL2IfaceSlot = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "switch", "reportsL2IfaceUnit", "reportsL2IfacePort", "reportsL2IfaceSlot")
...
mibBuilder.exportSymbols("PRVT-BIST-MIB", bistResult=bistResult, portsTestEntry=portsTestEntry, nvramTestTable=nvramTestTable, nvramTestEntry=nvramTestEntry, onboardPowerTestTable=onboardPowerTestTable, uartIndex=uartIndex, bistPorts=bistPorts, portTest=portTest, bistConfig=bistConfig, TestResult=TestResult, prvtBISTObjects=prvtBISTObjects, powerSupplyTestEntry=powerSupplyTestEntry, prvtBISTConformance=prvtBISTConformance, PYSNMP_MODULE_ID=prvtBISTMib, cPUTestEntry=cPUTestEntry, bistStatus=bistStatus, powerSupplyTestResult=powerSupplyTestResult, onboardPowerTestResult=onboardPowerTestResult, onboardPowerTestEntry=onboardPowerTestEntry, cpuTestType=cpuTestType, bistOnboardPower=bistOnboardPower, fanTestResult=fanTestResult, bistTemperatureTest=bistTemperatureTest, powerSupplyIndex=powerSupplyIndex, bistSwitchCore=bistSwitchCore, ramTestResult=ramTestResult, bistCrossbarExistence=bistCrossbarExistence, bistSelfTestExecute=bistSelfTestExecute, bistUART=bistUART, bistCPU=bistCPU, nvramTestResult=nvramTestResult, prvtBISTMib=prvtBISTMib, ramTestTable=ramTestTable, bistPowerSupply=bistPowerSupply, bistTemperature=bistTemperature, cPUTestTable=cPUTestTable, bistRAM=bistRAM, onboardPowerTestType=onboardPowerTestType, nvramTestType=nvramTestType, fanTestEntry=fanTestEntry, cpuTestResult=cpuTestResult, bistFan=bistFan, prvtBISTNotifications=prvtBISTNotifications, bistNVRAM=bistNVRAM, uartExistTestEntry=uartExistTestEntry, ramTestEntry=ramTestEntry, bistUPS=bistUPS, fanTestTable=fanTestTable, ramTestType=ramTestType, portsTestTable=portsTestTable, uartExistTestResult=uartExistTestResult, uartExistTestTable=uartExistTestTable, powerSupplyTestTable=powerSupplyTestTable, bistSelfTestExecuteStatus=bistSelfTestExecuteStatus, bistUPSTest=bistUPSTest, fanIndex=fanIndex)
