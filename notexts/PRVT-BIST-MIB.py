...
mibBuilder.exportSymbols("PRVT-BIST-MIB", powerSupplyIndex=powerSupplyIndex, fanIndex=fanIndex, onboardPowerTestEntry=onboardPowerTestEntry, ramTestEntry=ramTestEntry, ramTestResult=ramTestResult, bistResult=bistResult, bistFan=bistFan, cPUTestTable=cPUTestTable, portsTestTable=portsTestTable, cpuTestResult=cpuTestResult, TestResult=TestResult, bistSwitchCore=bistSwitchCore, prvtBISTMib=prvtBISTMib, nvramTestEntry=nvramTestEntry, nvramTestType=nvramTestType, fanTestEntry=fanTestEntry, onboardPowerTestTable=onboardPowerTestTable, powerSupplyTestResult=powerSupplyTestResult, bistUPSTest=bistUPSTest, portsTestEntry=portsTestEntry, fanTestResult=fanTestResult, onboardPowerTestResult=onboardPowerTestResult, bistRAM=bistRAM, nvramTestTable=nvramTestTable, fanTestTable=fanTestTable, bistCrossbarExistence=bistCrossbarExistence, bistConfig=bistConfig, powerSupplyTestEntry=powerSupplyTestEntry, prvtBISTNotifications=prvtBISTNotifications, bistTemperatureTest=bistTemperatureTest, PYSNMP_MODULE_ID=prvtBISTMib, cPUTestEntry=cPUTestEntry, nvramTestResult=nvramTestResult, bistStatus=bistStatus, portTest=portTest, uartExistTestTable=uartExistTestTable, uartExistTestEntry=uartExistTestEntry, bistOnboardPower=bistOnboardPower, bistNVRAM=bistNVRAM, bistUPS=bistUPS, bistTemperature=bistTemperature, uartIndex=uartIndex, bistPorts=bistPorts, uartExistTestResult=uartExistTestResult, cpuTestType=cpuTestType, ramTestTable=ramTestTable, bistPowerSupply=bistPowerSupply, bistSelfTestExecute=bistSelfTestExecute, bistUART=bistUART, prvtBISTObjects=prvtBISTObjects, bistCPU=bistCPU, ramTestType=ramTestType, powerSupplyTestTable=powerSupplyTestTable, prvtBISTConformance=prvtBISTConformance, bistSelfTestExecuteStatus=bistSelfTestExecuteStatus, onboardPowerTestType=onboardPowerTestType)
