...
reportsL2IfacePort, switch, reportsL2IfaceSlot, reportsL2IfaceUnit = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfacePort", "switch", "reportsL2IfaceSlot", "reportsL2IfaceUnit")
...
mibBuilder.exportSymbols("PRVT-BIST-MIB", onboardPowerTestEntry=onboardPowerTestEntry, PYSNMP_MODULE_ID=prvtBISTMib, fanTestResult=fanTestResult, bistFan=bistFan, prvtBISTObjects=prvtBISTObjects, prvtBISTConformance=prvtBISTConformance, prvtBISTNotifications=prvtBISTNotifications, powerSupplyTestResult=powerSupplyTestResult, bistCPU=bistCPU, ramTestResult=ramTestResult, uartExistTestEntry=uartExistTestEntry, fanTestTable=fanTestTable, ramTestEntry=ramTestEntry, nvramTestResult=nvramTestResult, ramTestType=ramTestType, onboardPowerTestResult=onboardPowerTestResult, bistPowerSupply=bistPowerSupply, nvramTestType=nvramTestType, powerSupplyTestEntry=powerSupplyTestEntry, uartExistTestTable=uartExistTestTable, onboardPowerTestTable=onboardPowerTestTable, cPUTestTable=cPUTestTable, bistTemperatureTest=bistTemperatureTest, bistCrossbarExistence=bistCrossbarExistence, onboardPowerTestType=onboardPowerTestType, portTest=portTest, bistSelfTestExecuteStatus=bistSelfTestExecuteStatus, prvtBISTMib=prvtBISTMib, bistTemperature=bistTemperature, cpuTestResult=cpuTestResult, bistSwitchCore=bistSwitchCore, uartIndex=uartIndex, ramTestTable=ramTestTable, cPUTestEntry=cPUTestEntry, fanIndex=fanIndex, portsTestEntry=portsTestEntry, powerSupplyTestTable=powerSupplyTestTable, bistSelfTestExecute=bistSelfTestExecute, cpuTestType=cpuTestType, portsTestTable=portsTestTable, nvramTestEntry=nvramTestEntry, bistUART=bistUART, bistConfig=bistConfig, bistNVRAM=bistNVRAM, nvramTestTable=nvramTestTable, powerSupplyIndex=powerSupplyIndex, bistStatus=bistStatus, bistPorts=bistPorts, bistRAM=bistRAM, bistUPSTest=bistUPSTest, TestResult=TestResult, bistUPS=bistUPS, uartExistTestResult=uartExistTestResult, fanTestEntry=fanTestEntry, bistResult=bistResult, bistOnboardPower=bistOnboardPower)
