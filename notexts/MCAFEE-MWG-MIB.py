...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Integer32, iso, NotificationType, enterprises, NotificationType, mib_2, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, TimeTicks, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Integer32", "iso", "NotificationType", "enterprises", "NotificationType", "mib-2", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, stCategories=stCategories, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName)
