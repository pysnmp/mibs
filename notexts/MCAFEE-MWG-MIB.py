...
Unsigned32, Counter64, TimeTicks, Bits, Gauge32, NotificationType, IpAddress, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, ObjectIdentity, mib_2, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "TimeTicks", "Bits", "Gauge32", "NotificationType", "IpAddress", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "mib-2", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, mwg=mwg, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, kRevision=kRevision, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trUser=trUser, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stCategories=stCategories, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, kProductName=kProductName, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName)
