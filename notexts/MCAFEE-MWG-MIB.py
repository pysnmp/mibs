...
MibIdentifier, ModuleIdentity, TimeTicks, Gauge32, mib_2, NotificationType, iso, Counter32, Unsigned32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Bits, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Gauge32", "mib-2", "NotificationType", "iso", "Counter32", "Unsigned32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Bits", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCategories=stCategories, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, trSystem=trSystem, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision)
