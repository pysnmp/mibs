...
Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, enterprises, Bits, Integer32, Counter64, NotificationType, iso, mib_2, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "enterprises", "Bits", "Integer32", "Counter64", "NotificationType", "iso", "mib-2", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryName=stCategoryName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, kProductName=kProductName, mwgFTP=mwgFTP, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
