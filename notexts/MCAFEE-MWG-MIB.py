...
Counter64, mib_2, NotificationType, enterprises, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, Unsigned32, iso, Bits, NotificationType, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "NotificationType", "enterprises", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "iso", "Bits", "NotificationType", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, mwgContent=mwgContent, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, notifyReason=notifyReason, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stCategories=stCategories, stConnectedSockets=stConnectedSockets, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, kMajorVersion=kMajorVersion, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, mwg=mwg, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion)
