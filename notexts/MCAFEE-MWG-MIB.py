...
Unsigned32, Gauge32, mib_2, Integer32, ModuleIdentity, Counter64, NotificationType, Counter32, Bits, MibIdentifier, TimeTicks, ObjectIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "mib-2", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "Counter32", "Bits", "MibIdentifier", "TimeTicks", "ObjectIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, mwgInfo=mwgInfo, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stFtpBytesFromServer=stFtpBytesFromServer, kCompanyName=kCompanyName, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, trUser=trUser, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests, trSystem=trSystem, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion)
