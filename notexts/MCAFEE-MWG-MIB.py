...
NotificationType, Counter32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, NotificationType, enterprises, Integer32, Bits, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "NotificationType", "enterprises", "Integer32", "Bits", "mib-2", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, trUser=trUser, trSystem=trSystem, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, mwg=mwg, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stCategories=stCategories, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, kBuildNumber=kBuildNumber, stMimeType=stMimeType, kRevision=kRevision, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion)
