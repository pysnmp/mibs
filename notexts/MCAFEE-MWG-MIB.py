...
ObjectIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter64, iso, ModuleIdentity, Bits, NotificationType, Unsigned32, TimeTicks, NotificationType, Gauge32, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter64", "iso", "ModuleIdentity", "Bits", "NotificationType", "Unsigned32", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, trSystem=trSystem, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName)
