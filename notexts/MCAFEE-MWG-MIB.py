...
Integer32, Counter64, Bits, Unsigned32, iso, mib_2, ModuleIdentity, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, IpAddress, TimeTicks, enterprises, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Bits", "Unsigned32", "iso", "mib-2", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "IpAddress", "TimeTicks", "enterprises", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, mwg=mwg, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, mwgHttp=mwgHttp, stCategoryName=stCategoryName, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, stClientCount=stClientCount, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion)
