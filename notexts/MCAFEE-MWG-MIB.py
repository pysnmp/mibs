...
mib_2, ModuleIdentity, enterprises, ObjectIdentity, Integer32, IpAddress, Counter64, Counter32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, TimeTicks, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "enterprises", "ObjectIdentity", "Integer32", "IpAddress", "Counter64", "Counter32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, mwg=mwg, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stCPULoad=stCPULoad, stClientCount=stClientCount, stCategoryCount=stCategoryCount, trApplication=trApplication, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stCategories=stCategories, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, mwgContent=mwgContent, kRevision=kRevision, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgFTP=mwgFTP, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost)
