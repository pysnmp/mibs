...
Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, ModuleIdentity, enterprises, Bits, MibIdentifier, mib_2, Counter32, ObjectIdentity, Unsigned32, iso, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "ModuleIdentity", "enterprises", "Bits", "MibIdentifier", "mib-2", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, trApplication=trApplication, stMimeType=stMimeType, kRevision=kRevision, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, stCategories=stCategories, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps)
