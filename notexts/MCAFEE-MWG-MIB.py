...
ObjectIdentity, Bits, Integer32, Counter32, mib_2, NotificationType, IpAddress, Gauge32, enterprises, ModuleIdentity, iso, Unsigned32, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Integer32", "Counter32", "mib-2", "NotificationType", "IpAddress", "Gauge32", "enterprises", "ModuleIdentity", "iso", "Unsigned32", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, trSystem=trSystem, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, trUser=trUser, mwgInfo=mwgInfo, stMimeType=stMimeType, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, stCategoryCount=stCategoryCount, trApplication=trApplication, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP)
