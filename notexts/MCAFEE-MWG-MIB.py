...
enterprises, Gauge32, NotificationType, IpAddress, Integer32, Counter64, MibIdentifier, iso, mib_2, ModuleIdentity, Counter32, Bits, TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "NotificationType", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "iso", "mib-2", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, pTSDBVersion=pTSDBVersion, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, trSystem=trSystem, notifySeverity=notifySeverity, stCategories=stCategories, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, kProductName=kProductName, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, kRevision=kRevision, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer)
