...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, Gauge32, ObjectIdentity, Bits, Unsigned32, enterprises, NotificationType, mib_2, iso, TimeTicks, Counter64, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "Bits", "Unsigned32", "enterprises", "NotificationType", "mib-2", "iso", "TimeTicks", "Counter64", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, mwgStatistics=mwgStatistics, notifyReason=notifyReason, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, trApplication=trApplication, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount)
