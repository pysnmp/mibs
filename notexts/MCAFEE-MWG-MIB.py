...
ModuleIdentity, Unsigned32, Counter32, IpAddress, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2, NotificationType, TimeTicks, Bits, Gauge32, NotificationType, Integer32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter32", "IpAddress", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2", "NotificationType", "TimeTicks", "Bits", "Gauge32", "NotificationType", "Integer32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, trUser=trUser, mwgContent=mwgContent, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, trSystem=trSystem)
