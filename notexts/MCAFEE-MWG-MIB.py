...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Bits, IpAddress, mib_2, Gauge32, enterprises, Counter32, iso, MibIdentifier, ModuleIdentity, Counter64, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Bits", "IpAddress", "mib-2", "Gauge32", "enterprises", "Counter32", "iso", "MibIdentifier", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, mwg=mwg, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stCategoryName=stCategoryName, stCategories=stCategories, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, kProductName=kProductName)
