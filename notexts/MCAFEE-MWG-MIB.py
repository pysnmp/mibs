...
Counter64, Integer32, TimeTicks, ObjectIdentity, enterprises, iso, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, mib_2, Bits, Counter32, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "TimeTicks", "ObjectIdentity", "enterprises", "iso", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "mib-2", "Bits", "Counter32", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, trUser=trUser, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, mwgContent=mwgContent, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stClientCount=stClientCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion)
