...
Integer32, IpAddress, enterprises, Gauge32, NotificationType, TimeTicks, ObjectIdentity, ModuleIdentity, Bits, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "enterprises", "Gauge32", "NotificationType", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stTimeForTransaction=stTimeForTransaction, mwgHttp=mwgHttp, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, kProductName=kProductName, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, notifyReason=notifyReason, stHttpRequests=stHttpRequests, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, trSystem=trSystem, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS)
