...
Counter32, ModuleIdentity, Unsigned32, Counter64, mib_2, Integer32, enterprises, TimeTicks, NotificationType, NotificationType, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Unsigned32", "Counter64", "mib-2", "Integer32", "enterprises", "TimeTicks", "NotificationType", "NotificationType", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, trSystem=trSystem, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stCategories=stCategories, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, kBuildNumber=kBuildNumber, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stClientCount=stClientCount)
