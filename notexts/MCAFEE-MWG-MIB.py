...
MibIdentifier, Bits, ObjectIdentity, Unsigned32, IpAddress, iso, NotificationType, NotificationType, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, mib_2, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "iso", "NotificationType", "NotificationType", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "mib-2", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgContent=mwgContent, mwgHttp=mwgHttp, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, mwgHttps=mwgHttps, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stCategories=stCategories, mwg=mwg, mwgInfo=mwgInfo, mwgTraps=mwgTraps, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, stBadReputation=stBadReputation, notifyReason=notifyReason, stMimeType=stMimeType, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, trSystem=trSystem)
