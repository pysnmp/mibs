...
IpAddress, Bits, iso, MibIdentifier, Gauge32, Unsigned32, Integer32, Counter64, enterprises, ObjectIdentity, TimeTicks, NotificationType, NotificationType, mib_2, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "iso", "MibIdentifier", "Gauge32", "Unsigned32", "Integer32", "Counter64", "enterprises", "ObjectIdentity", "TimeTicks", "NotificationType", "NotificationType", "mib-2", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, kProductName=kProductName, stClientCount=stClientCount, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, trUser=trUser, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, mwg=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, kRevision=kRevision, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, mwgFTP=mwgFTP, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic)
