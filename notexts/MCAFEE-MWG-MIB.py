...
MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, IpAddress, iso, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Counter64, NotificationType, TimeTicks, mib_2, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "IpAddress", "iso", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "NotificationType", "TimeTicks", "mib-2", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, notifyReason=notifyReason, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, mwgContent=mwgContent, mwgHttps=mwgHttps, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, stCategories=stCategories, trSystem=trSystem, trUser=trUser, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient)
