...
NotificationType, Gauge32, enterprises, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, MibIdentifier, Counter32, Unsigned32, Integer32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "enterprises", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter32", "Unsigned32", "Integer32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, mwgTraps=mwgTraps, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, pMFEDATVersion=pMFEDATVersion, mwgHttp=mwgHttp, kRevision=kRevision, notifyReason=notifyReason)
