...
NotificationType, Integer32, enterprises, Unsigned32, NotificationType, iso, ObjectIdentity, MibIdentifier, Bits, TimeTicks, mib_2, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "enterprises", "Unsigned32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "mib-2", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, notifySeverity=notifySeverity, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient)
