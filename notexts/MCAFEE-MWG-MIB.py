...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, IpAddress, ObjectIdentity, mib_2, Bits, TimeTicks, Counter64, ModuleIdentity, NotificationType, iso, Gauge32, Integer32, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "IpAddress", "ObjectIdentity", "mib-2", "Bits", "TimeTicks", "Counter64", "ModuleIdentity", "NotificationType", "iso", "Gauge32", "Integer32", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, stClientCount=stClientCount, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stBadReputation=stBadReputation, mwg=mwg, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests)
