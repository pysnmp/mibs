...
Counter32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, mib_2, TimeTicks, ObjectIdentity, ModuleIdentity, MibIdentifier, iso, Gauge32, NotificationType, enterprises, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "mib-2", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "iso", "Gauge32", "NotificationType", "enterprises", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, trUser=trUser, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, trApplication=trApplication, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, mwgContent=mwgContent, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, notifyOriginName=notifyOriginName, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason)
