...
ModuleIdentity, Integer32, NotificationType, iso, Bits, ObjectIdentity, mib_2, Counter64, enterprises, NotificationType, Gauge32, Unsigned32, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "NotificationType", "iso", "Bits", "ObjectIdentity", "mib-2", "Counter64", "enterprises", "NotificationType", "Gauge32", "Unsigned32", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, trSystem=trSystem, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stCPULoad=stCPULoad, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stCategories=stCategories, mwgHttp=mwgHttp, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps)
