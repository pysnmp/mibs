...
Counter64, NotificationType, enterprises, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Unsigned32, iso, Counter32, TimeTicks, NotificationType, Bits, Gauge32, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "enterprises", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Unsigned32", "iso", "Counter32", "TimeTicks", "NotificationType", "Bits", "Gauge32", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stMemConsumed=stMemConsumed, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, mwgContent=mwgContent, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, kMinorVersion=kMinorVersion, stCategories=stCategories, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer)
