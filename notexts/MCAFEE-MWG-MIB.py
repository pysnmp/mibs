...
NotificationType, iso, IpAddress, Integer32, mib_2, ObjectIdentity, Unsigned32, Bits, NotificationType, Gauge32, MibIdentifier, TimeTicks, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "IpAddress", "Integer32", "mib-2", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, mwgFTP=mwgFTP, trApplication=trApplication, stCategories=stCategories, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, stFtpBytesToClient=stFtpBytesToClient, stMimeType=stMimeType, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion)
