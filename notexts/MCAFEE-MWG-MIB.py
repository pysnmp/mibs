...
Unsigned32, IpAddress, Integer32, ObjectIdentity, NotificationType, ModuleIdentity, Gauge32, TimeTicks, Counter64, iso, Bits, MibIdentifier, NotificationType, mib_2, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter64", "iso", "Bits", "MibIdentifier", "NotificationType", "mib-2", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, trUser=trUser, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, mwgHttp=mwgHttp, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, stCategories=stCategories, trSystem=trSystem, kProductName=kProductName, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional)
