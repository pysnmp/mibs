...
Counter64, ModuleIdentity, NotificationType, NotificationType, iso, Unsigned32, mib_2, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter32, Integer32, enterprises, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "NotificationType", "NotificationType", "iso", "Unsigned32", "mib-2", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "enterprises", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, mwg=mwg, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion)
