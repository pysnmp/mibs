...
Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, TimeTicks, MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, iso, NotificationType, mib_2, Counter32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "iso", "NotificationType", "mib-2", "Counter32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, notifyReason=notifyReason, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, mwg=mwg, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, mwgInfo=mwgInfo, trUser=trUser, trSystem=trSystem, mwgHttp=mwgHttp)
