...
Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, NotificationType, TimeTicks, iso, IpAddress, Counter32, Bits, enterprises, NotificationType, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "IpAddress", "Counter32", "Bits", "enterprises", "NotificationType", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, trUser=trUser, notifyAffectedHost=notifyAffectedHost, pAMSignatureVersion=pAMSignatureVersion, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, kRevision=kRevision, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategories=stCategories, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, mwgFTP=mwgFTP, kProductName=kProductName, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber)
