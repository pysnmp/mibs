...
IpAddress, ModuleIdentity, enterprises, Counter32, NotificationType, ObjectIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, mib_2, Unsigned32, Gauge32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "enterprises", "Counter32", "NotificationType", "ObjectIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "mib-2", "Unsigned32", "Gauge32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, trUser=trUser, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, trApplication=trApplication, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, mwgContent=mwgContent, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stClientCount=stClientCount, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stCategoryName=stCategoryName, trSystem=trSystem, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests)
