...
mib_2, IpAddress, Counter32, Integer32, enterprises, Counter64, MibIdentifier, ModuleIdentity, Unsigned32, NotificationType, iso, Bits, Gauge32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Counter32", "Integer32", "enterprises", "Counter64", "MibIdentifier", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "Bits", "Gauge32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, trUser=trUser, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, trApplication=trApplication, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, stCategories=stCategories, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin)
