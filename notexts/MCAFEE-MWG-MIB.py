...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, TimeTicks, mib_2, MibIdentifier, ObjectIdentity, NotificationType, Integer32, Counter64, IpAddress, Counter32, enterprises, ModuleIdentity, NotificationType, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "TimeTicks", "mib-2", "MibIdentifier", "ObjectIdentity", "NotificationType", "Integer32", "Counter64", "IpAddress", "Counter32", "enterprises", "ModuleIdentity", "NotificationType", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, trSystem=trSystem, notifyOrigin=notifyOrigin, stCategories=stCategories, notifyAdditional=notifyAdditional, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, trUser=trUser, mwg=mwg, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, mwgInfo=mwgInfo, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter)
