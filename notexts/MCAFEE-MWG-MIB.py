...
Counter32, IpAddress, mib_2, Bits, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, ModuleIdentity, Gauge32, NotificationType, iso, NotificationType, Integer32, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "mib-2", "Bits", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Gauge32", "NotificationType", "iso", "NotificationType", "Integer32", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, trSystem=trSystem, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stHttpRequests=stHttpRequests, stCategories=stCategories, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, kMinorVersion=kMinorVersion, kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, trApplication=trApplication, stCategoryName=stCategoryName, kCompanyName=kCompanyName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, notifyReason=notifyReason, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, stClientCount=stClientCount, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion)
