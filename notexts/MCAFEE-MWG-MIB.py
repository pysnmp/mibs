...
Counter32, enterprises, mib_2, IpAddress, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, ObjectIdentity, NotificationType, NotificationType, Counter64, MibIdentifier, iso, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "mib-2", "IpAddress", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "ObjectIdentity", "NotificationType", "NotificationType", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, trUser=trUser, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables)
