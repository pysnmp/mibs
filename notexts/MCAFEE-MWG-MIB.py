...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, enterprises, Counter64, Integer32, Gauge32, TimeTicks, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, iso, NotificationType, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "enterprises", "Counter64", "Integer32", "Gauge32", "TimeTicks", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "NotificationType", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, trSystem=trSystem, kMicroVersion=kMicroVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, mwgHttps=mwgHttps, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, kRevision=kRevision, trApplication=trApplication, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, trUser=trUser, stHttpRequests=stHttpRequests, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
