...
Counter32, IpAddress, mib_2, enterprises, Bits, Counter64, ObjectIdentity, ModuleIdentity, Gauge32, NotificationType, NotificationType, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "mib-2", "enterprises", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "Gauge32", "NotificationType", "NotificationType", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, trApplication=trApplication, notifySeverity=notifySeverity, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, notifyOrigin=notifyOrigin, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, kMajorVersion=kMajorVersion, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stMimeType=stMimeType, mwgFTP=mwgFTP, mwgContent=mwgContent, stCategoryCount=stCategoryCount, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stCPULoad=stCPULoad, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, kProductName=kProductName, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected)
