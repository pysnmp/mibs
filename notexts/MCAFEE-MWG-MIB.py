...
Integer32, NotificationType, Counter64, NotificationType, enterprises, TimeTicks, iso, Unsigned32, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, mib_2, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "NotificationType", "enterprises", "TimeTicks", "iso", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "mib-2", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, trUser=trUser, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, mwgFTP=mwgFTP, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, trSystem=trSystem, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stCPULoadRaw=stCPULoadRaw, stCategories=stCategories, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stClientCount=stClientCount, kProductName=kProductName, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps)
