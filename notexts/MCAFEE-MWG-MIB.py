...
IpAddress, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, NotificationType, ModuleIdentity, mib_2, Counter64, Integer32, enterprises, MibIdentifier, iso, Gauge32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "NotificationType", "ModuleIdentity", "mib-2", "Counter64", "Integer32", "enterprises", "MibIdentifier", "iso", "Gauge32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, mwg=mwg, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, kProductVersion=kProductVersion, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, mwgStatistics=mwgStatistics, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, stMemConsumed=stMemConsumed, mwgContent=mwgContent, stHttpsTraffic=stHttpsTraffic)
