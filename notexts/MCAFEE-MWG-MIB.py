...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, Integer32, Counter32, Gauge32, NotificationType, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, enterprises, iso, mib_2, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "Integer32", "Counter32", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "enterprises", "iso", "mib-2", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, trSystem=trSystem, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, stMemConsumed=stMemConsumed, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, stCategoryName=stCategoryName, mwgHttps=mwgHttps, notifyReason=notifyReason, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, kMinorVersion=kMinorVersion, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, trUser=trUser, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, kProductName=kProductName, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReasonString=notifyReasonString)
