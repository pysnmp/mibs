...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Integer32, ObjectIdentity, ModuleIdentity, enterprises, Bits, Counter32, TimeTicks, Unsigned32, mib_2, Gauge32, Counter64, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Integer32", "ObjectIdentity", "ModuleIdentity", "enterprises", "Bits", "Counter32", "TimeTicks", "Unsigned32", "mib-2", "Gauge32", "Counter64", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, stHttpsBytesFromServer=stHttpsBytesFromServer, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, trUser=trUser, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, mwgContent=mwgContent, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, mwgInfo=mwgInfo)
