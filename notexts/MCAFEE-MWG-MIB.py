...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Counter64, ModuleIdentity, TimeTicks, Unsigned32, Gauge32, iso, enterprises, mib_2, Counter32, IpAddress, NotificationType, MibIdentifier, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Counter64", "ModuleIdentity", "TimeTicks", "Unsigned32", "Gauge32", "iso", "enterprises", "mib-2", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, stCategories=stCategories, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stBadReputation=stBadReputation, pMFEDATVersion=pMFEDATVersion, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stMimeType=stMimeType, stCPULoad=stCPULoad, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable)
