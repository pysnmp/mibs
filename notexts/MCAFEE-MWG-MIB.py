...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, ObjectIdentity, Counter32, IpAddress, ModuleIdentity, Bits, TimeTicks, Unsigned32, MibIdentifier, Gauge32, NotificationType, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "ObjectIdentity", "Counter32", "IpAddress", "ModuleIdentity", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "Gauge32", "NotificationType", "Integer32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, kProductVersion=kProductVersion, kCompanyName=kCompanyName, mwgContent=mwgContent, notifyReason=notifyReason, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stClientCount=stClientCount, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stCategories=stCategories, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision)
