...
NotificationType, Bits, mib_2, ModuleIdentity, Counter32, Integer32, Counter64, NotificationType, IpAddress, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Unsigned32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "mib-2", "ModuleIdentity", "Counter32", "Integer32", "Counter64", "NotificationType", "IpAddress", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Unsigned32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, notifyOriginName=notifyOriginName, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, notifyOrigin=notifyOrigin, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, mwg=mwg, notifyReason=notifyReason, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, stCategories=stCategories, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost)
