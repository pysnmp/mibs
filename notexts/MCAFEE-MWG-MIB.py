...
MibIdentifier, ModuleIdentity, Integer32, ObjectIdentity, enterprises, Counter64, Unsigned32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, NotificationType, Bits, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Integer32", "ObjectIdentity", "enterprises", "Counter64", "Unsigned32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "Bits", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, mwgTraps=mwgTraps, kProductName=kProductName, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stClientCount=stClientCount, mwgFTP=mwgFTP, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stCategories=stCategories, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
