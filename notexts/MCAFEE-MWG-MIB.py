...
NotificationType, MibIdentifier, Unsigned32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, NotificationType, TimeTicks, Counter32, ModuleIdentity, enterprises, iso, Bits, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "NotificationType", "TimeTicks", "Counter32", "ModuleIdentity", "enterprises", "iso", "Bits", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, kProductName=kProductName, mwgContent=mwgContent, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, trUser=trUser, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic)
