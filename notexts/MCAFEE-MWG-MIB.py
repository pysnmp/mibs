...
Counter64, MibIdentifier, enterprises, Integer32, Bits, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter32, mib_2, IpAddress, NotificationType, Gauge32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "enterprises", "Integer32", "Bits", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter32", "mib-2", "IpAddress", "NotificationType", "Gauge32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, kRevision=kRevision, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, stCategories=stCategories, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, trUser=trUser)
