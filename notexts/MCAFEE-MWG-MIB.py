...
Counter32, Integer32, Counter64, enterprises, TimeTicks, ModuleIdentity, Gauge32, mib_2, Bits, ObjectIdentity, MibIdentifier, NotificationType, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "enterprises", "TimeTicks", "ModuleIdentity", "Gauge32", "mib-2", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, kRevision=kRevision, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, mwgHttps=mwgHttps, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, mwgStatistics=mwgStatistics, trUser=trUser, kHotfixVersion=kHotfixVersion)
