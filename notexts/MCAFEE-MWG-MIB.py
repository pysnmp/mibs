...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter32, Bits, mib_2, ObjectIdentity, Counter64, ModuleIdentity, Integer32, Gauge32, enterprises, NotificationType, TimeTicks, iso, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter32", "Bits", "mib-2", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "Gauge32", "enterprises", "NotificationType", "TimeTicks", "iso", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpTraffic=stFtpTraffic, trApplication=trApplication, kRevision=kRevision, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, notifyOriginName=notifyOriginName, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, stMimeType=stMimeType, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter)
