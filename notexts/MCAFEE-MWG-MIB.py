...
NotificationType, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter32, Unsigned32, IpAddress, mib_2, Gauge32, enterprises, Counter64, iso, ModuleIdentity, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter32", "Unsigned32", "IpAddress", "mib-2", "Gauge32", "enterprises", "Counter64", "iso", "ModuleIdentity", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, mwg=mwg, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, trSystem=trSystem, kRevision=kRevision, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication)
