...
ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter64, enterprises, iso, NotificationType, Unsigned32, MibIdentifier, mib_2, Counter32, ObjectIdentity, Bits, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter64", "enterprises", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "mib-2", "Counter32", "ObjectIdentity", "Bits", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, mwgHttps=mwgHttps, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, mwgContent=mwgContent, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, notifyReason=notifyReason, kProductName=kProductName, stBadReputation=stBadReputation, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer)
