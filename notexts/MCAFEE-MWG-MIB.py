...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Integer32, Gauge32, NotificationType, Counter32, Bits, NotificationType, Unsigned32, enterprises, ModuleIdentity, TimeTicks, IpAddress, mib_2, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Counter32", "Bits", "NotificationType", "Unsigned32", "enterprises", "ModuleIdentity", "TimeTicks", "IpAddress", "mib-2", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, mwg=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, kProductName=kProductName, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stCategories=stCategories, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
