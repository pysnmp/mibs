...
NotificationType, ObjectIdentity, IpAddress, iso, NotificationType, enterprises, Integer32, MibIdentifier, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, TimeTicks, Counter32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "NotificationType", "enterprises", "Integer32", "MibIdentifier", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "TimeTicks", "Counter32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, stCategories=stCategories, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stCategoryName=stCategoryName, stBadReputation=stBadReputation, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, trUser=trUser, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, mwgFTP=mwgFTP, mwgInfo=mwgInfo, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer)
