...
enterprises, Counter32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ObjectIdentity, NotificationType, mib_2, TimeTicks, Bits, ModuleIdentity, MibIdentifier, NotificationType, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ObjectIdentity", "NotificationType", "mib-2", "TimeTicks", "Bits", "ModuleIdentity", "MibIdentifier", "NotificationType", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, stFtpTraffic=stFtpTraffic, trApplication=trApplication, notifyReason=notifyReason, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, mwg=mwg, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion)
