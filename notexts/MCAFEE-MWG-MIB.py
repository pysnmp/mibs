...
ModuleIdentity, MibIdentifier, Gauge32, iso, NotificationType, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, TimeTicks, Unsigned32, ObjectIdentity, Integer32, Counter32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "iso", "NotificationType", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "Integer32", "Counter32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, stMimeType=stMimeType, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, trApplication=trApplication, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics)
