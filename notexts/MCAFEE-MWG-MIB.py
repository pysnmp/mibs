...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, Integer32, IpAddress, Counter32, Counter64, ModuleIdentity, ObjectIdentity, NotificationType, Bits, MibIdentifier, NotificationType, TimeTicks, Unsigned32, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "Integer32", "IpAddress", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Bits", "MibIdentifier", "NotificationType", "TimeTicks", "Unsigned32", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, stCPULoad=stCPULoad, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, mwg=mwg, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion)
