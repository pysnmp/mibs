...
Counter32, mib_2, ObjectIdentity, iso, Integer32, Counter64, Gauge32, NotificationType, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, enterprises, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "ObjectIdentity", "iso", "Integer32", "Counter64", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stCategoriesTable=stCategoriesTable, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, mwgTraps=mwgTraps, stCategoryName=stCategoryName, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, mwgInfo=mwgInfo, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, trSystem=trSystem, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, kRevision=kRevision, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, kProductName=kProductName, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg)
