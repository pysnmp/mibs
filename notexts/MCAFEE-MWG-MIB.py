...
enterprises, NotificationType, Counter64, Counter32, Integer32, NotificationType, iso, MibIdentifier, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter64", "Counter32", "Integer32", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, mwg=mwg, mwgInfo=mwgInfo, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName, trUser=trUser, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, mwgContent=mwgContent, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason)
