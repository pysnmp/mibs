...
MibIdentifier, IpAddress, enterprises, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter32, Bits, Gauge32, TimeTicks, ObjectIdentity, iso, Integer32, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "enterprises", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "Integer32", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, mwg=mwg, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, trApplication=trApplication, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, mwgFTP=mwgFTP, stClientCount=stClientCount, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, stCategories=stCategories, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stBadReputation=stBadReputation, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic)
