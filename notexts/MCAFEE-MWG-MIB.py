...
Bits, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, Counter32, enterprises, ModuleIdentity, TimeTicks, mib_2, NotificationType, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "Counter32", "enterprises", "ModuleIdentity", "TimeTicks", "mib-2", "NotificationType", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, trUser=trUser, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stClientCount=stClientCount, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, pAMSignatureVersion=pAMSignatureVersion, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, mwgFTP=mwgFTP, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, mwg=mwg, stCategories=stCategories, stHttpRequests=stHttpRequests, trSystem=trSystem, notifyOriginName=notifyOriginName, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, mwgHttp=mwgHttp, notifyReason=notifyReason, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication)
