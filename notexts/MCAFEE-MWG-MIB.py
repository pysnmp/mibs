...
mib_2, ObjectIdentity, ModuleIdentity, Gauge32, Counter32, MibIdentifier, TimeTicks, Unsigned32, iso, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Integer32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter32", "MibIdentifier", "TimeTicks", "Unsigned32", "iso", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Integer32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, trUser=trUser, notifyOriginName=notifyOriginName, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, trSystem=trSystem, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, mwgStatistics=mwgStatistics, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
