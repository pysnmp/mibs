...
Counter32, iso, ModuleIdentity, mib_2, Bits, ObjectIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, enterprises, Unsigned32, NotificationType, MibIdentifier, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ModuleIdentity", "mib-2", "Bits", "ObjectIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "enterprises", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, kRevision=kRevision, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, stCategories=stCategories, mwg=mwg, trSystem=trSystem, kProductName=kProductName, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stClientCount=stClientCount, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser)
