...
iso, Integer32, mib_2, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Bits, NotificationType, MibIdentifier, Unsigned32, Counter64, enterprises, NotificationType, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "mib-2", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Bits", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "enterprises", "NotificationType", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, mwg=mwg, kProductName=kProductName, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, mwgTraps=mwgTraps, trSystem=trSystem, mwgInfo=mwgInfo, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, kCompanyName=kCompanyName, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, trUser=trUser, stClientCount=stClientCount, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, notifyOriginName=notifyOriginName, trApplication=trApplication, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName)
