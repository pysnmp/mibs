...
Gauge32, enterprises, Integer32, MibIdentifier, Unsigned32, Counter64, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, mib_2, Bits, TimeTicks, ObjectIdentity, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Integer32", "MibIdentifier", "Unsigned32", "Counter64", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "mib-2", "Bits", "TimeTicks", "ObjectIdentity", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, mwg=mwg, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, stCPULoad=stCPULoad, trUser=trUser, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, stMimeType=stMimeType, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, stClientCount=stClientCount, trSystem=trSystem, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion)
