...
iso, Counter32, Gauge32, ObjectIdentity, Bits, Integer32, TimeTicks, enterprises, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Gauge32", "ObjectIdentity", "Bits", "Integer32", "TimeTicks", "enterprises", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, mwgContent=mwgContent, trUser=trUser, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, notifySeverity=notifySeverity, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, kProductName=kProductName, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwg=mwg, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, trSystem=trSystem)
