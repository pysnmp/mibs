...
NotificationType, Gauge32, MibIdentifier, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter64, Bits, TimeTicks, Unsigned32, mib_2, enterprises, ObjectIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "TimeTicks", "Unsigned32", "mib-2", "enterprises", "ObjectIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, kRevision=kRevision, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stMimeType=stMimeType, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName)
