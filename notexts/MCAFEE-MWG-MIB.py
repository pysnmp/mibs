...
Gauge32, mib_2, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, iso, TimeTicks, Integer32, Counter32, Unsigned32, MibIdentifier, ObjectIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "iso", "TimeTicks", "Integer32", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, kMajorVersion=kMajorVersion, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, kRevision=kRevision, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, stCategories=stCategories, notifyReasonString=notifyReasonString, stClientCount=stClientCount, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, trUser=trUser, notifyAdditional=notifyAdditional, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, notifySeverity=notifySeverity, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous)
