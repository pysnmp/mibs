...
IpAddress, ObjectIdentity, Gauge32, TimeTicks, Counter32, enterprises, ModuleIdentity, Integer32, NotificationType, Unsigned32, NotificationType, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Gauge32", "TimeTicks", "Counter32", "enterprises", "ModuleIdentity", "Integer32", "NotificationType", "Unsigned32", "NotificationType", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, mwg=mwg, notifySeverity=notifySeverity, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, mwgInfo=mwgInfo, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, mwgContent=mwgContent, kProductName=kProductName, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps)
