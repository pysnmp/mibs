...
Gauge32, IpAddress, TimeTicks, ModuleIdentity, Counter32, Integer32, mib_2, NotificationType, enterprises, Counter64, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "TimeTicks", "ModuleIdentity", "Counter32", "Integer32", "mib-2", "NotificationType", "enterprises", "Counter64", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, trApplication=trApplication, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName)
