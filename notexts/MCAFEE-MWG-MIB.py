...
Unsigned32, Gauge32, TimeTicks, Counter64, IpAddress, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, enterprises, ModuleIdentity, iso, Integer32, mib_2, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "Integer32", "mib-2", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stClientCount=stClientCount, mwgFTP=mwgFTP, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, trUser=trUser, mwgStatistics=mwgStatistics, mwg=mwg, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stCategoryName=stCategoryName, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stCategories=stCategories, stMemConsumed=stMemConsumed, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
