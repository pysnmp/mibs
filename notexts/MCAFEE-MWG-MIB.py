...
TimeTicks, ObjectIdentity, Counter32, iso, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, NotificationType, MibIdentifier, Bits, IpAddress, Unsigned32, Integer32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter32", "iso", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier", "Bits", "IpAddress", "Unsigned32", "Integer32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, stBadReputation=stBadReputation, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, trUser=trUser, stCategories=stCategories, stCPUIOWait=stCPUIOWait, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, kRevision=kRevision, trSystem=trSystem)
