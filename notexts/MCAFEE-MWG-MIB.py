...
MibIdentifier, Unsigned32, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, mib_2, enterprises, Bits, ModuleIdentity, Gauge32, NotificationType, NotificationType, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "mib-2", "enterprises", "Bits", "ModuleIdentity", "Gauge32", "NotificationType", "NotificationType", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, stCategories=stCategories, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, trApplication=trApplication, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stMimeType=stMimeType, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost)
