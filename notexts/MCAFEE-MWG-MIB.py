...
Gauge32, ModuleIdentity, IpAddress, Counter64, NotificationType, enterprises, iso, Bits, ObjectIdentity, Counter32, Unsigned32, TimeTicks, MibIdentifier, mib_2, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "Counter64", "NotificationType", "enterprises", "iso", "Bits", "ObjectIdentity", "Counter32", "Unsigned32", "TimeTicks", "MibIdentifier", "mib-2", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stCategories=stCategories, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, mwg=mwg, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer)
