...
Gauge32, enterprises, TimeTicks, mib_2, ModuleIdentity, IpAddress, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Counter64, Unsigned32, Integer32, NotificationType, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "TimeTicks", "mib-2", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "Integer32", "NotificationType", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, kRevision=kRevision, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, trSystem=trSystem, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stCategories=stCategories, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stMalwareDetected=stMalwareDetected, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stCPULoad=stCPULoad, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, kMinorVersion=kMinorVersion, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer)
