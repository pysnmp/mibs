...
Bits, Counter64, mib_2, NotificationType, ObjectIdentity, iso, MibIdentifier, Gauge32, TimeTicks, enterprises, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "mib-2", "NotificationType", "ObjectIdentity", "iso", "MibIdentifier", "Gauge32", "TimeTicks", "enterprises", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, mwgInfo=mwgInfo, kProductVersion=kProductVersion, trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, mwg=mwg, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stHttpTraffic=stHttpTraffic, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware)
