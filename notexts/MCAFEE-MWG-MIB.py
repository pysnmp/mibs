...
Gauge32, ModuleIdentity, Integer32, enterprises, Counter64, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, MibIdentifier, NotificationType, NotificationType, IpAddress, TimeTicks, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Integer32", "enterprises", "Counter64", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "MibIdentifier", "NotificationType", "NotificationType", "IpAddress", "TimeTicks", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, trApplication=trApplication, kMicroVersion=kMicroVersion, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, mwg=mwg, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, kMajorVersion=kMajorVersion, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, kProductName=kProductName, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion)
