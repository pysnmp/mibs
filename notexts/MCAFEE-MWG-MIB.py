...
enterprises, MibIdentifier, NotificationType, NotificationType, Unsigned32, Counter64, iso, Counter32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, IpAddress, Gauge32, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "NotificationType", "NotificationType", "Unsigned32", "Counter64", "iso", "Counter32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "IpAddress", "Gauge32", "Bits", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, mwg=mwg, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, notifyReason=notifyReason, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, trSystem=trSystem, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stHttpRequests=stHttpRequests, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry)
