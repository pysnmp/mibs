...
ObjectIdentity, Counter32, Counter64, TimeTicks, Gauge32, Bits, MibIdentifier, iso, enterprises, NotificationType, IpAddress, ModuleIdentity, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "Gauge32", "Bits", "MibIdentifier", "iso", "enterprises", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, trApplication=trApplication, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion)
