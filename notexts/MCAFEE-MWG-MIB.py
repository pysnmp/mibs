...
Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, iso, enterprises, ModuleIdentity, Counter32, Counter64, IpAddress, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "iso", "enterprises", "ModuleIdentity", "Counter32", "Counter64", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, trApplication=trApplication, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, trUser=trUser, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, mwgMiscellaneous=mwgMiscellaneous, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, trSystem=trSystem, mwgHttps=mwgHttps)
