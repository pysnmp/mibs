...
IpAddress, enterprises, mib_2, NotificationType, TimeTicks, Bits, MibIdentifier, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Counter32, iso, ObjectIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "mib-2", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Counter32", "iso", "ObjectIdentity", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, trSystem=trSystem, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, trApplication=trApplication, stBadReputation=stBadReputation, stHttpTraffic=stHttpTraffic, stCategoriesEntry=stCategoriesEntry, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, trUser=trUser, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, kProductName=kProductName, mwgTraps=mwgTraps, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, kRevision=kRevision, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, notifyAdditional=notifyAdditional, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter)
