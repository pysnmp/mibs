...
IpAddress, Unsigned32, mib_2, iso, ObjectIdentity, Gauge32, Counter32, enterprises, Bits, Counter64, Integer32, TimeTicks, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "mib-2", "iso", "ObjectIdentity", "Gauge32", "Counter32", "enterprises", "Bits", "Counter64", "Integer32", "TimeTicks", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, trUser=trUser, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, mwgFTP=mwgFTP, mwg=mwg, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMicroVersion=kMicroVersion, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous)
