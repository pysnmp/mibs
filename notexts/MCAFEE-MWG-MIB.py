...
IpAddress, NotificationType, ModuleIdentity, Counter64, iso, MibIdentifier, Bits, ObjectIdentity, Gauge32, enterprises, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "ModuleIdentity", "Counter64", "iso", "MibIdentifier", "Bits", "ObjectIdentity", "Gauge32", "enterprises", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, mwg=mwg, kCustomVersion=kCustomVersion, trApplication=trApplication, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stCPUIOWait=stCPUIOWait, kProductName=kProductName, notifyOrigin=notifyOrigin, kRevision=kRevision, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, trUser=trUser, kCompanyName=kCompanyName, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation)
