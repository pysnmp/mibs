...
Gauge32, Counter64, Integer32, NotificationType, enterprises, TimeTicks, iso, MibIdentifier, Counter32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, mib_2, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Integer32", "NotificationType", "enterprises", "TimeTicks", "iso", "MibIdentifier", "Counter32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "mib-2", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, trApplication=trApplication, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional)
