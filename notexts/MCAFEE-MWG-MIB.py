...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, NotificationType, MibIdentifier, mib_2, iso, Bits, IpAddress, TimeTicks, Counter64, Counter32, ObjectIdentity, ModuleIdentity, NotificationType, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier", "mib-2", "iso", "Bits", "IpAddress", "TimeTicks", "Counter64", "Counter32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, kRevision=kRevision, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, kCompanyName=kCompanyName, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stBadReputation=stBadReputation, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, mwgEngineVersions=mwgEngineVersions, mwg=mwg, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stClientCount=stClientCount, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgContent=mwgContent, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, mwgHttps=mwgHttps, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous)
