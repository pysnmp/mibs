...
Unsigned32, iso, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, NotificationType, enterprises, mib_2, Gauge32, Integer32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "NotificationType", "enterprises", "mib-2", "Gauge32", "Integer32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, mwgContent=mwgContent, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stHttpsBytesToServer=stHttpsBytesToServer, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stCategories=stCategories, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, trSystem=trSystem, notifyOriginName=notifyOriginName)
