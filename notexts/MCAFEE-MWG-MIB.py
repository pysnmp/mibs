...
iso, NotificationType, ObjectIdentity, NotificationType, MibIdentifier, Gauge32, Integer32, Bits, IpAddress, ModuleIdentity, Counter64, Unsigned32, mib_2, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ObjectIdentity", "NotificationType", "MibIdentifier", "Gauge32", "Integer32", "Bits", "IpAddress", "ModuleIdentity", "Counter64", "Unsigned32", "mib-2", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, notifyReason=notifyReason, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, kProductName=kProductName)
