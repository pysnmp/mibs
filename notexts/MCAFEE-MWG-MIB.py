...
TimeTicks, iso, mib_2, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Bits, Unsigned32, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "mib-2", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Bits", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, stClientCount=stClientCount, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, notifyOriginName=notifyOriginName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, pTSDBVersion=pTSDBVersion, mwg=mwg, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity)
