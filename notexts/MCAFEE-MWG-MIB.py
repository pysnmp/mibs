...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, MibIdentifier, iso, Unsigned32, Counter32, TimeTicks, NotificationType, Integer32, Bits, Counter64, Gauge32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "MibIdentifier", "iso", "Unsigned32", "Counter32", "TimeTicks", "NotificationType", "Integer32", "Bits", "Counter64", "Gauge32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stMemConsumed=stMemConsumed, notifyReason=notifyReason, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, mwgStatistics=mwgStatistics, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, kRevision=kRevision, kProductName=kProductName, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, trUser=trUser, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, mwg=mwg)
