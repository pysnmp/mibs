...
mib_2, Counter32, ModuleIdentity, NotificationType, iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, NotificationType, enterprises, Bits, MibIdentifier, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "ModuleIdentity", "NotificationType", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "enterprises", "Bits", "MibIdentifier", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, kProductName=kProductName, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, kCompanyName=kCompanyName, mwgInfo=mwgInfo, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, trUser=trUser, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic)
