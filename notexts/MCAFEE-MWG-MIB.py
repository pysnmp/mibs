...
TimeTicks, mib_2, Integer32, enterprises, ModuleIdentity, MibIdentifier, Unsigned32, Gauge32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Bits, NotificationType, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "Integer32", "enterprises", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Gauge32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Bits", "NotificationType", "iso", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, kRevision=kRevision, kCompanyName=kCompanyName, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost)
