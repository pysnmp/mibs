...
Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, NotificationType, NotificationType, iso, Counter64, ModuleIdentity, MibIdentifier, enterprises, Gauge32, IpAddress, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType", "NotificationType", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "enterprises", "Gauge32", "IpAddress", "mib-2", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, kCompanyName=kCompanyName, notifyReason=notifyReason, mwgTraps=mwgTraps, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMProactiveVersion=pAMProactiveVersion, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient)
