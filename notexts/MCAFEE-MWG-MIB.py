...
ObjectIdentity, NotificationType, Gauge32, Counter64, enterprises, NotificationType, Counter32, TimeTicks, Integer32, ModuleIdentity, mib_2, iso, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Gauge32", "Counter64", "enterprises", "NotificationType", "Counter32", "TimeTicks", "Integer32", "ModuleIdentity", "mib-2", "iso", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, stClientCount=stClientCount, notifyOrigin=notifyOrigin, mwg=mwg, stHttpRequests=stHttpRequests, stFtpTraffic=stFtpTraffic, stCategories=stCategories, kProductVersion=kProductVersion, trUser=trUser, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, notifyReason=notifyReason, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, trApplication=trApplication, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName)
