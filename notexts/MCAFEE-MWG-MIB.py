...
enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, NotificationType, NotificationType, TimeTicks, mib_2, ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress, Counter64, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "NotificationType", "NotificationType", "TimeTicks", "mib-2", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter64", "iso", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName, stCPULoad=stCPULoad, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, notifyReason=notifyReason, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, stCategoryCount=stCategoryCount, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate)
