...
ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, iso, NotificationType, mib_2, NotificationType, Counter32, Integer32, TimeTicks, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "iso", "NotificationType", "mib-2", "NotificationType", "Counter32", "Integer32", "TimeTicks", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, kProductVersion=kProductVersion, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, trUser=trUser, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, kProductName=kProductName, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stCategoriesTable=stCategoriesTable, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry)
