...
Bits, Gauge32, TimeTicks, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, ModuleIdentity, Unsigned32, Counter32, MibIdentifier, mib_2, ObjectIdentity, iso, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "TimeTicks", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter32", "MibIdentifier", "mib-2", "ObjectIdentity", "iso", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, kMajorVersion=kMajorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, trApplication=trApplication, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, kRevision=kRevision, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, kProductName=kProductName, trUser=trUser, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stCategories=stCategories, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction)
