...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks, ObjectIdentity, Bits, Counter32, IpAddress, enterprises, mib_2, NotificationType, MibIdentifier, Counter64, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "enterprises", "mib-2", "NotificationType", "MibIdentifier", "Counter64", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, notifySeverity=notifySeverity, stCategories=stCategories, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, trApplication=trApplication, kMinorVersion=kMinorVersion, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, trUser=trUser, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, kRevision=kRevision, mwgHttp=mwgHttp)
