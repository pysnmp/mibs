...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, iso, Gauge32, Bits, IpAddress, Integer32, mib_2, ObjectIdentity, Counter32, NotificationType, enterprises, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "iso", "Gauge32", "Bits", "IpAddress", "Integer32", "mib-2", "ObjectIdentity", "Counter32", "NotificationType", "enterprises", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, mwg=mwg, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kRevision=kRevision, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, kProductName=kProductName, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, trUser=trUser)
