...
Gauge32, ObjectIdentity, enterprises, Counter64, Counter32, NotificationType, iso, NotificationType, Unsigned32, IpAddress, mib_2, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "enterprises", "Counter64", "Counter32", "NotificationType", "iso", "NotificationType", "Unsigned32", "IpAddress", "mib-2", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, stClientCount=stClientCount, kCustomVersion=kCustomVersion, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, kRevision=kRevision, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, stBadReputation=stBadReputation, trApplication=trApplication, kProductName=kProductName, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, stCategoriesEntry=stCategoriesEntry, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, kMajorVersion=kMajorVersion)
