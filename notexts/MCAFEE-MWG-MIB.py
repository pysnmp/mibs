...
MibIdentifier, enterprises, IpAddress, Bits, NotificationType, Gauge32, ObjectIdentity, mib_2, Integer32, Counter64, ModuleIdentity, NotificationType, iso, Counter32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "IpAddress", "Bits", "NotificationType", "Gauge32", "ObjectIdentity", "mib-2", "Integer32", "Counter64", "ModuleIdentity", "NotificationType", "iso", "Counter32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, kMicroVersion=kMicroVersion, trUser=trUser, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous)
