...
NotificationType, Counter32, NotificationType, ObjectIdentity, enterprises, iso, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity, mib_2, Unsigned32, Bits, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "NotificationType", "ObjectIdentity", "enterprises", "iso", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity", "mib-2", "Unsigned32", "Bits", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, trApplication=trApplication, kProductName=kProductName, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, mwg=mwg, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, trSystem=trSystem, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion)
