...
Counter64, Integer32, Counter32, enterprises, ModuleIdentity, NotificationType, iso, Bits, MibIdentifier, NotificationType, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Counter32", "enterprises", "ModuleIdentity", "NotificationType", "iso", "Bits", "MibIdentifier", "NotificationType", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, kBuildNumber=kBuildNumber, kMajorVersion=kMajorVersion, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, mwgTraps=mwgTraps, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, kRevision=kRevision, stCPULoad=stCPULoad, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter)
