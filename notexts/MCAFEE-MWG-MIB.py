...
enterprises, ObjectIdentity, Gauge32, Counter64, Counter32, NotificationType, iso, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, IpAddress, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Gauge32", "Counter64", "Counter32", "NotificationType", "iso", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "IpAddress", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, kRevision=kRevision, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stCategories=stCategories, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stMimeType=stMimeType)
