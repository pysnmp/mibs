...
Gauge32, Integer32, Bits, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, MibIdentifier, ModuleIdentity, Unsigned32, IpAddress, iso, NotificationType, NotificationType, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Bits", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "MibIdentifier", "ModuleIdentity", "Unsigned32", "IpAddress", "iso", "NotificationType", "NotificationType", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, trApplication=trApplication, stCategories=stCategories, stCPUIOWait=stCPUIOWait, trUser=trUser, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, mwgContent=mwgContent, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, notifyReason=notifyReason, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient)
