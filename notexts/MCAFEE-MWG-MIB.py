...
Counter64, Bits, Unsigned32, iso, enterprises, IpAddress, NotificationType, MibIdentifier, Counter32, TimeTicks, ModuleIdentity, ObjectIdentity, Integer32, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Unsigned32", "iso", "enterprises", "IpAddress", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Integer32", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, mwg=mwg, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, kCompanyName=kCompanyName, trSystem=trSystem, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, trApplication=trApplication, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, kProductVersion=kProductVersion, stCategories=stCategories, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic)
