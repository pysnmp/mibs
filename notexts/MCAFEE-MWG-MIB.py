...
NotificationType, NotificationType, IpAddress, TimeTicks, Gauge32, enterprises, Unsigned32, Integer32, iso, mib_2, ObjectIdentity, Bits, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "enterprises", "Unsigned32", "Integer32", "iso", "mib-2", "ObjectIdentity", "Bits", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trApplication=trApplication, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, trSystem=trSystem)
