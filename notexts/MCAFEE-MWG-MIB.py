...
mib_2, ObjectIdentity, Counter64, IpAddress, TimeTicks, Unsigned32, ModuleIdentity, Gauge32, iso, NotificationType, Integer32, Bits, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "Counter64", "IpAddress", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "iso", "NotificationType", "Integer32", "Bits", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, kProductName=kProductName, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, kProductVersion=kProductVersion, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, mwg=mwg, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stHttpsRequests=stHttpsRequests)
