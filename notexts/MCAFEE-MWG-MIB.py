...
Bits, iso, Unsigned32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Gauge32, Counter64, Integer32, ObjectIdentity, ModuleIdentity, enterprises, MibIdentifier, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Unsigned32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Gauge32", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "enterprises", "MibIdentifier", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, kRevision=kRevision, stCPULoad=stCPULoad, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kCustomVersion=kCustomVersion, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, stMemConsumed=stMemConsumed, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, notifyReason=notifyReason, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer)
