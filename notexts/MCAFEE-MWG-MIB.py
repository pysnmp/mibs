...
ModuleIdentity, iso, Unsigned32, NotificationType, Integer32, ObjectIdentity, mib_2, MibIdentifier, enterprises, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Bits, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "mib-2", "MibIdentifier", "enterprises", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Bits", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, kRevision=kRevision, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stCPULoadRaw=stCPULoadRaw, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, trApplication=trApplication, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, mwgContent=mwgContent, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyAdditional=notifyAdditional, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, mwg=mwg, mwgTraps=mwgTraps, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation)
