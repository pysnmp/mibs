...
Counter64, Gauge32, NotificationType, NotificationType, ModuleIdentity, enterprises, ObjectIdentity, Counter32, IpAddress, TimeTicks, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "NotificationType", "ModuleIdentity", "enterprises", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stHttpTraffic=stHttpTraffic, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, trUser=trUser, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, mwgHttp=mwgHttp, kProductName=kProductName, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer)
