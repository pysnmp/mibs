...
enterprises, Counter32, NotificationType, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter64, mib_2, Bits, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "NotificationType", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter64", "mib-2", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, trApplication=trApplication, kHotfixVersion=kHotfixVersion, kRevision=kRevision, stMemConsumed=stMemConsumed, trSystem=trSystem, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, stMimeType=stMimeType, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, mwg=mwg, stHttpTraffic=stHttpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, mwgInfo=mwgInfo, stCategories=stCategories, PYSNMP_MODULE_ID=mwg)
