...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ObjectIdentity, MibIdentifier, enterprises, NotificationType, NotificationType, ModuleIdentity, Unsigned32, Bits, mib_2, Integer32, TimeTicks, Gauge32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ObjectIdentity", "MibIdentifier", "enterprises", "NotificationType", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "mib-2", "Integer32", "TimeTicks", "Gauge32", "Counter32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, notifyReasonString=notifyReasonString, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, kMinorVersion=kMinorVersion, trApplication=trApplication, trUser=trUser, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHandleConnectToServer=stHandleConnectToServer, kRevision=kRevision, stMalwareDetected=stMalwareDetected, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, kProductName=kProductName, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion)
