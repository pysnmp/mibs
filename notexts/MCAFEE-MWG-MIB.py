...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, Counter64, enterprises, ModuleIdentity, Counter32, IpAddress, TimeTicks, NotificationType, MibIdentifier, Bits, NotificationType, Integer32, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "Counter64", "enterprises", "ModuleIdentity", "Counter32", "IpAddress", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "NotificationType", "Integer32", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stMimeType=stMimeType, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, trApplication=trApplication, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer)
