...
mib_2, NotificationType, TimeTicks, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Gauge32, Counter64, ObjectIdentity, MibIdentifier, NotificationType, Bits, Integer32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "TimeTicks", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Gauge32", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType", "Bits", "Integer32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, trApplication=trApplication, stBadReputation=stBadReputation, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stMimeType=stMimeType, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, trUser=trUser, stMemConsumed=stMemConsumed, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer)
