...
Counter32, ObjectIdentity, ModuleIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, enterprises, MibIdentifier, TimeTicks, Bits, Gauge32, iso, mib_2, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "ModuleIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "enterprises", "MibIdentifier", "TimeTicks", "Bits", "Gauge32", "iso", "mib-2", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kRevision=kRevision, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stCategories=stCategories, stHttpsRequests=stHttpsRequests, stBadReputation=stBadReputation, mwgHttp=mwgHttp, trApplication=trApplication, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion)
