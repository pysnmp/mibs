...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Counter32, ModuleIdentity, Gauge32, Integer32, MibIdentifier, NotificationType, Unsigned32, Bits, ObjectIdentity, enterprises, Counter64, TimeTicks, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Counter32", "ModuleIdentity", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "enterprises", "Counter64", "TimeTicks", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, trSystem=trSystem, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeForTransaction=stTimeForTransaction, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer)
