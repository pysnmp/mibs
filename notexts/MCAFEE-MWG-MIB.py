...
Integer32, Counter32, ModuleIdentity, TimeTicks, iso, Unsigned32, NotificationType, Bits, NotificationType, mib_2, Gauge32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "TimeTicks", "iso", "Unsigned32", "NotificationType", "Bits", "NotificationType", "mib-2", "Gauge32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, mwg=mwg, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, trUser=trUser, stClientCount=stClientCount, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stCategories=stCategories, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked)
