...
Gauge32, Unsigned32, enterprises, Integer32, ModuleIdentity, NotificationType, iso, IpAddress, ObjectIdentity, MibIdentifier, NotificationType, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "enterprises", "Integer32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, trUser=trUser, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, stCPULoad=stCPULoad, notifySeverity=notifySeverity, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount)
