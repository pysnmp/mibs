...
Integer32, ObjectIdentity, IpAddress, TimeTicks, NotificationType, Unsigned32, Gauge32, ModuleIdentity, Counter32, mib_2, MibIdentifier, enterprises, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter32", "mib-2", "MibIdentifier", "enterprises", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, trSystem=trSystem, trUser=trUser, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stMimeType=stMimeType, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stCategories=stCategories, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps)
