...
Counter32, Counter64, IpAddress, mib_2, Unsigned32, iso, enterprises, NotificationType, ModuleIdentity, NotificationType, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "IpAddress", "mib-2", "Unsigned32", "iso", "enterprises", "NotificationType", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, trSystem=trSystem, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName)
