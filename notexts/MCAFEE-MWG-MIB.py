...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, Counter32, Integer32, IpAddress, Bits, NotificationType, mib_2, Gauge32, ObjectIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "Bits", "NotificationType", "mib-2", "Gauge32", "ObjectIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, trSystem=trSystem, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, mwgTraps=mwgTraps, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable)
