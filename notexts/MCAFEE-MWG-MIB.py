...
ModuleIdentity, NotificationType, MibIdentifier, NotificationType, TimeTicks, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Bits, mib_2, IpAddress, iso, ObjectIdentity, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Bits", "mib-2", "IpAddress", "iso", "ObjectIdentity", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, trApplication=trApplication, trSystem=trSystem, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReasonString=notifyReasonString, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, mwg=mwg, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
