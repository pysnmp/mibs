...
Unsigned32, NotificationType, Bits, Integer32, enterprises, ObjectIdentity, IpAddress, ModuleIdentity, TimeTicks, NotificationType, iso, Gauge32, MibIdentifier, Counter64, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Bits", "Integer32", "enterprises", "ObjectIdentity", "IpAddress", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, kMajorVersion=kMajorVersion, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, stMemConsumed=stMemConsumed, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient)
