...
Bits, IpAddress, mib_2, Unsigned32, Counter32, iso, MibIdentifier, enterprises, ModuleIdentity, TimeTicks, Gauge32, NotificationType, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "mib-2", "Unsigned32", "Counter32", "iso", "MibIdentifier", "enterprises", "ModuleIdentity", "TimeTicks", "Gauge32", "NotificationType", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, pAMEngineVersion=pAMEngineVersion, mwg=mwg, kProductVersion=kProductVersion, kRevision=kRevision, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, stCategoryCount=stCategoryCount, mwgContent=mwgContent, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin)
