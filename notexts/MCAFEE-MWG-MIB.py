...
iso, MibIdentifier, ObjectIdentity, TimeTicks, mib_2, IpAddress, Gauge32, Unsigned32, NotificationType, Counter32, Counter64, enterprises, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "ObjectIdentity", "TimeTicks", "mib-2", "IpAddress", "Gauge32", "Unsigned32", "NotificationType", "Counter32", "Counter64", "enterprises", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, kProductName=kProductName, notifyOrigin=notifyOrigin, stMimeType=stMimeType, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, kRevision=kRevision, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stCategories=stCategories, trUser=trUser, mwg=mwg, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
