...
NotificationType, Counter32, ModuleIdentity, enterprises, mib_2, Bits, iso, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, TimeTicks, Integer32, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ModuleIdentity", "enterprises", "mib-2", "Bits", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, kRevision=kRevision, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, trUser=trUser, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stMimeType=stMimeType, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stCategories=stCategories, kMajorVersion=kMajorVersion)
