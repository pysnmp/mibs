...
enterprises, NotificationType, Bits, ModuleIdentity, NotificationType, iso, mib_2, ObjectIdentity, Integer32, Unsigned32, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Bits", "ModuleIdentity", "NotificationType", "iso", "mib-2", "ObjectIdentity", "Integer32", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, mwgStatistics=mwgStatistics, stClientCount=stClientCount, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, trUser=trUser, mwg=mwg, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stCategoryName=stCategoryName, mwgHttp=mwgHttp, stCategories=stCategories, mwgTraps=mwgTraps, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked)
