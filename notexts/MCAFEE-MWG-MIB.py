...
Counter64, Integer32, MibIdentifier, NotificationType, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Gauge32, mib_2, TimeTicks, Bits, IpAddress, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "MibIdentifier", "NotificationType", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Gauge32", "mib-2", "TimeTicks", "Bits", "IpAddress", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, mwgHttp=mwgHttp, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stCategoryName=stCategoryName, trSystem=trSystem, mwg=mwg, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, stClientCount=stClientCount, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion)
