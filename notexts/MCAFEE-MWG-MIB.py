...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, mib_2, enterprises, ModuleIdentity, NotificationType, TimeTicks, Bits, ObjectIdentity, iso, MibIdentifier, Gauge32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "mib-2", "enterprises", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "ObjectIdentity", "iso", "MibIdentifier", "Gauge32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, trUser=trUser, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stFtpBytesToServer=stFtpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, kProductName=kProductName, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, notifyReason=notifyReason, mwg=mwg, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion)
