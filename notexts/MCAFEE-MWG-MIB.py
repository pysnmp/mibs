...
Counter64, iso, ObjectIdentity, enterprises, NotificationType, Counter32, MibIdentifier, Integer32, IpAddress, NotificationType, TimeTicks, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "ObjectIdentity", "enterprises", "NotificationType", "Counter32", "MibIdentifier", "Integer32", "IpAddress", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, notifySeverity=notifySeverity, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stConnectedSockets=stConnectedSockets, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, stHttpsTraffic=stHttpsTraffic, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, mwg=mwg, notifyOriginName=notifyOriginName, trUser=trUser, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, kProductName=kProductName, mwgContent=mwgContent, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg)
