...
Gauge32, ModuleIdentity, enterprises, Counter32, NotificationType, Bits, MibIdentifier, Unsigned32, Counter64, TimeTicks, mib_2, ObjectIdentity, NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "enterprises", "Counter32", "NotificationType", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "mib-2", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, mwg=mwg, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, trSystem=trSystem, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware)
