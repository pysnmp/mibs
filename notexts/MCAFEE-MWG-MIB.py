...
mib_2, Counter64, IpAddress, Bits, Gauge32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity, MibIdentifier, NotificationType, Unsigned32, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "IpAddress", "Bits", "Gauge32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed, stCategories=stCategories, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, kProductVersion=kProductVersion, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, trApplication=trApplication, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp)
