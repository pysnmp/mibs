...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Gauge32, ModuleIdentity, Unsigned32, iso, Counter32, enterprises, Bits, ObjectIdentity, mib_2, Counter64, Integer32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "iso", "Counter32", "enterprises", "Bits", "ObjectIdentity", "mib-2", "Counter64", "Integer32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, kProductName=kProductName, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, mwgContent=mwgContent, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, trUser=trUser, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait)
