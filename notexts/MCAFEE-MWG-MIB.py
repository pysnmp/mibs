...
enterprises, Gauge32, Counter32, Unsigned32, iso, TimeTicks, Integer32, IpAddress, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, Bits, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter32", "Unsigned32", "iso", "TimeTicks", "Integer32", "IpAddress", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, stMemConsumed=stMemConsumed, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, trUser=trUser, trApplication=trApplication, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, mwgInfo=mwgInfo, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, mwg=mwg, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, mwgStatistics=mwgStatistics, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost)
