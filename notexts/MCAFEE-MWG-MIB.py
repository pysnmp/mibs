...
iso, TimeTicks, Integer32, Gauge32, IpAddress, Counter64, ObjectIdentity, Unsigned32, Counter32, mib_2, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Integer32", "Gauge32", "IpAddress", "Counter64", "ObjectIdentity", "Unsigned32", "Counter32", "mib-2", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, kProductName=kProductName, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, kMicroVersion=kMicroVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable)
