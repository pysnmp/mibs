...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, Bits, Unsigned32, Integer32, TimeTicks, Gauge32, Counter64, IpAddress, ModuleIdentity, NotificationType, iso, enterprises, MibIdentifier, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "Bits", "Unsigned32", "Integer32", "TimeTicks", "Gauge32", "Counter64", "IpAddress", "ModuleIdentity", "NotificationType", "iso", "enterprises", "MibIdentifier", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, trUser=trUser, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, mwg=mwg, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, stMimeType=stMimeType, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, stHttpsTraffic=stHttpsTraffic, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation)
