...
iso, ObjectIdentity, Gauge32, Counter64, mib_2, TimeTicks, ModuleIdentity, Integer32, MibIdentifier, NotificationType, Bits, NotificationType, IpAddress, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Gauge32", "Counter64", "mib-2", "TimeTicks", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "Bits", "NotificationType", "IpAddress", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp)
