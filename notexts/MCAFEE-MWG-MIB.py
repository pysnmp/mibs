...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, TimeTicks, MibIdentifier, ObjectIdentity, Integer32, IpAddress, Unsigned32, NotificationType, enterprises, ModuleIdentity, Counter64, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Integer32", "IpAddress", "Unsigned32", "NotificationType", "enterprises", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, mwgInfo=mwgInfo, mwgHttp=mwgHttp, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, mwgHttps=mwgHttps, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName)
