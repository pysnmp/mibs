...
Bits, NotificationType, Counter64, Counter32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, mib_2, ModuleIdentity, NotificationType, IpAddress, Unsigned32, enterprises, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "Counter32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "mib-2", "ModuleIdentity", "NotificationType", "IpAddress", "Unsigned32", "enterprises", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMicroVersion=kMicroVersion, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductVersion=kProductVersion, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, trSystem=trSystem, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, notifyAdditional=notifyAdditional, mwgContent=mwgContent, stMimeType=stMimeType, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer)
