...
IpAddress, MibIdentifier, enterprises, iso, mib_2, NotificationType, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, ObjectIdentity, Unsigned32, Counter64, Gauge32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "enterprises", "iso", "mib-2", "NotificationType", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "Counter64", "Gauge32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, trUser=trUser, stFtpBytesToServer=stFtpBytesToServer, stClientCount=stClientCount, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, mwgFTP=mwgFTP, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount)
