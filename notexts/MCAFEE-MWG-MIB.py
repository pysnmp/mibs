...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, Unsigned32, Counter64, TimeTicks, mib_2, NotificationType, Bits, Integer32, Counter32, ModuleIdentity, MibIdentifier, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "Unsigned32", "Counter64", "TimeTicks", "mib-2", "NotificationType", "Bits", "Integer32", "Counter32", "ModuleIdentity", "MibIdentifier", "iso", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, mwg=mwg, trApplication=trApplication, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, kRevision=kRevision, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stHttpBytesToClient=stHttpBytesToClient, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, trUser=trUser, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, trSystem=trSystem, kProductVersion=kProductVersion, stCategories=stCategories, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName)
