...
TimeTicks, Bits, Gauge32, NotificationType, MibIdentifier, Unsigned32, Integer32, IpAddress, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter64, ObjectIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "Unsigned32", "Integer32", "IpAddress", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stCategories=stCategories, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin)
