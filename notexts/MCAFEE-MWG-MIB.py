...
IpAddress, Integer32, NotificationType, enterprises, Gauge32, ObjectIdentity, iso, NotificationType, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Counter64, mib_2, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "NotificationType", "enterprises", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Counter64", "mib-2", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, stBadReputation=stBadReputation, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, kProductName=kProductName, stCategoriesTable=stCategoriesTable, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
