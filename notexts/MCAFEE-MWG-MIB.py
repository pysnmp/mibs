...
iso, enterprises, ObjectIdentity, NotificationType, ModuleIdentity, Gauge32, Counter32, Unsigned32, IpAddress, mib_2, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Gauge32", "Counter32", "Unsigned32", "IpAddress", "mib-2", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stHttpTraffic=stHttpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stCategoryName=stCategoryName, notifySeverity=notifySeverity, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, kBuildNumber=kBuildNumber, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, kCompanyName=kCompanyName, stMimeType=stMimeType, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, trApplication=trApplication, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, notifyOrigin=notifyOrigin, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables)
