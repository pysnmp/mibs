...
ObjectIdentity, IpAddress, iso, enterprises, TimeTicks, Gauge32, NotificationType, Bits, MibIdentifier, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ModuleIdentity, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "iso", "enterprises", "TimeTicks", "Gauge32", "NotificationType", "Bits", "MibIdentifier", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ModuleIdentity", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stHttpTraffic=stHttpTraffic, mwg=mwg, kProductName=kProductName, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoadRaw=stCPULoadRaw, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, trUser=trUser)
