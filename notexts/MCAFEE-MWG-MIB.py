...
iso, Unsigned32, NotificationType, Integer32, NotificationType, Bits, TimeTicks, enterprises, Gauge32, MibIdentifier, ModuleIdentity, Counter32, ObjectIdentity, mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "Integer32", "NotificationType", "Bits", "TimeTicks", "enterprises", "Gauge32", "MibIdentifier", "ModuleIdentity", "Counter32", "ObjectIdentity", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, trApplication=trApplication, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, mwgMiscellaneous=mwgMiscellaneous, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, mwgEngineVersions=mwgEngineVersions, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, mwg=mwg, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, kRevision=kRevision, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, trUser=trUser, mwgStatistics=mwgStatistics, stMimeType=stMimeType, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString)
