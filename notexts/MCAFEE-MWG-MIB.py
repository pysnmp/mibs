...
Integer32, NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, enterprises, NotificationType, Bits, TimeTicks, IpAddress, MibIdentifier, Unsigned32, Counter32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "enterprises", "NotificationType", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "Unsigned32", "Counter32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, stBadReputation=stBadReputation, kProductName=kProductName, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, stClientCount=stClientCount)
