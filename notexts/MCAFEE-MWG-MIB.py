...
Gauge32, Unsigned32, ModuleIdentity, ObjectIdentity, iso, MibIdentifier, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter32, mib_2, TimeTicks, Bits, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "iso", "MibIdentifier", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter32", "mib-2", "TimeTicks", "Bits", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, mwg=mwg, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType)
