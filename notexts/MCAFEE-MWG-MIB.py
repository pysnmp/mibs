...
Counter64, Unsigned32, NotificationType, enterprises, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, ModuleIdentity, NotificationType, TimeTicks, Bits, Counter32, Integer32, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "NotificationType", "enterprises", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "Counter32", "Integer32", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, mwgTraps=mwgTraps, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, mwgStatistics=mwgStatistics, kRevision=kRevision, trApplication=trApplication, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwg=mwg, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, kMicroVersion=kMicroVersion, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReason=notifyReason, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, stCPULoad=stCPULoad, kMajorVersion=kMajorVersion)
