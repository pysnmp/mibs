...
iso, Gauge32, Unsigned32, mib_2, enterprises, Integer32, NotificationType, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Counter32, Counter64, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Unsigned32", "mib-2", "enterprises", "Integer32", "NotificationType", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Counter32", "Counter64", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, notifyAdditional=notifyAdditional, trApplication=trApplication, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kRevision=kRevision, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, mwgContent=mwgContent, trUser=trUser, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, kHotfixVersion=kHotfixVersion, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName)
