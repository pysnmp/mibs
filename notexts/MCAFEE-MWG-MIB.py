...
NotificationType, iso, MibIdentifier, NotificationType, Counter64, IpAddress, mib_2, Unsigned32, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, TimeTicks, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibIdentifier", "NotificationType", "Counter64", "IpAddress", "mib-2", "Unsigned32", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "TimeTicks", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, kRevision=kRevision, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, trSystem=trSystem, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoad=stCPULoad, mwg=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient)
