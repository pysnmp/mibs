...
NotificationType, Counter32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, TimeTicks, Unsigned32, mib_2, MibIdentifier, IpAddress, ModuleIdentity, enterprises, Integer32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "TimeTicks", "Unsigned32", "mib-2", "MibIdentifier", "IpAddress", "ModuleIdentity", "enterprises", "Integer32", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, kRevision=kRevision, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, mwgTraps=mwgTraps, kProductName=kProductName, stMimeType=stMimeType, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, trUser=trUser, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName)
