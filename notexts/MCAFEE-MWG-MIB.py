...
Counter64, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, enterprises, Gauge32, iso, Integer32, NotificationType, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "enterprises", "Gauge32", "iso", "Integer32", "NotificationType", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, mwgFTP=mwgFTP, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, trSystem=trSystem, stCPUIOWait=stCPUIOWait, kCompanyName=kCompanyName, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, mwgContent=mwgContent, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString)
