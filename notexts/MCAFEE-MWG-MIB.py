...
ModuleIdentity, NotificationType, iso, Unsigned32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, IpAddress, TimeTicks, Gauge32, NotificationType, Counter64, mib_2, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "iso", "Unsigned32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "mib-2", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, kCompanyName=kCompanyName, mwgFTP=mwgFTP, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, trUser=trUser, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, mwgContent=mwgContent, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryName=stCategoryName, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
