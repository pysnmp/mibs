...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Integer32, NotificationType, iso, Bits, Counter64, enterprises, MibIdentifier, mib_2, Gauge32, NotificationType, ObjectIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Integer32", "NotificationType", "iso", "Bits", "Counter64", "enterprises", "MibIdentifier", "mib-2", "Gauge32", "NotificationType", "ObjectIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, trApplication=trApplication, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, kProductName=kProductName, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, notifyReason=notifyReason, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion)
