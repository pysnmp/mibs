...
ModuleIdentity, Bits, Gauge32, iso, Counter32, Integer32, Counter64, IpAddress, NotificationType, ObjectIdentity, mib_2, enterprises, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "iso", "Counter32", "Integer32", "Counter64", "IpAddress", "NotificationType", "ObjectIdentity", "mib-2", "enterprises", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttp=mwgHttp, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, trUser=trUser, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, kCompanyName=kCompanyName, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, stCategories=stCategories, stMimeType=stMimeType, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, stHttpRequests=stHttpRequests, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, mwg=mwg)
