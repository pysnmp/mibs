...
MibIdentifier, Counter32, Counter64, Integer32, IpAddress, enterprises, iso, ObjectIdentity, NotificationType, Gauge32, TimeTicks, NotificationType, Bits, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Counter64", "Integer32", "IpAddress", "enterprises", "iso", "ObjectIdentity", "NotificationType", "Gauge32", "TimeTicks", "NotificationType", "Bits", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, trSystem=trSystem, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, kMajorVersion=kMajorVersion, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, trUser=trUser, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient)
