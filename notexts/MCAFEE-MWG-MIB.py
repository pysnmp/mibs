...
ModuleIdentity, Counter64, Unsigned32, NotificationType, Bits, iso, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "NotificationType", "Bits", "iso", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, trSystem=trSystem, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, kRevision=kRevision, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked)
