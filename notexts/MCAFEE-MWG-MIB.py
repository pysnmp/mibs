...
TimeTicks, Unsigned32, Gauge32, Counter32, NotificationType, NotificationType, ModuleIdentity, Counter64, Bits, ObjectIdentity, Integer32, mib_2, IpAddress, enterprises, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Gauge32", "Counter32", "NotificationType", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "Integer32", "mib-2", "IpAddress", "enterprises", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, mwg=mwg, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, trUser=trUser, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stCategoryName=stCategoryName, kRevision=kRevision, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer)
