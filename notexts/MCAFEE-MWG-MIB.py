...
NotificationType, MibIdentifier, mib_2, Gauge32, Counter64, NotificationType, Integer32, ModuleIdentity, iso, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "mib-2", "Gauge32", "Counter64", "NotificationType", "Integer32", "ModuleIdentity", "iso", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, trSystem=trSystem, notifySeverity=notifySeverity, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, trUser=trUser, stBadReputation=stBadReputation, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware)
