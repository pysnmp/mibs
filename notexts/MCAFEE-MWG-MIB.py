...
Integer32, enterprises, MibIdentifier, Counter32, Gauge32, TimeTicks, ObjectIdentity, Unsigned32, Bits, iso, NotificationType, Counter64, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Bits", "iso", "NotificationType", "Counter64", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, kHotfixVersion=kHotfixVersion, stCPULoad=stCPULoad, stMimeType=stMimeType, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, mwgHttp=mwgHttp, stCategories=stCategories, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, kRevision=kRevision, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stClientCount=stClientCount, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, mwg=mwg, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic)
