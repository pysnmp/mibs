...
Integer32, enterprises, NotificationType, MibIdentifier, ModuleIdentity, iso, Bits, mib_2, NotificationType, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Counter64, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "mib-2", "NotificationType", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Counter64", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stMemConsumed=stMemConsumed, kProductName=kProductName, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, notifyOriginName=notifyOriginName, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics)
