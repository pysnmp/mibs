...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, TimeTicks, Unsigned32, Gauge32, NotificationType, Integer32, Bits, ObjectIdentity, enterprises, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "TimeTicks", "Unsigned32", "Gauge32", "NotificationType", "Integer32", "Bits", "ObjectIdentity", "enterprises", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stMimeType=stMimeType, notifySeverity=notifySeverity, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stCategoryCount=stCategoryCount, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, trUser=trUser, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables)
