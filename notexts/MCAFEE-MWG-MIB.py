...
ModuleIdentity, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Bits, Gauge32, iso, TimeTicks, Counter64, IpAddress, NotificationType, MibIdentifier, ObjectIdentity, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Bits", "Gauge32", "iso", "TimeTicks", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "ObjectIdentity", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, pMFEEngineVersion=pMFEEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReason=notifyReason, stCategories=stCategories, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous)
