...
mib_2, Counter64, Counter32, Gauge32, NotificationType, Bits, NotificationType, ObjectIdentity, Unsigned32, ModuleIdentity, enterprises, iso, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "Counter32", "Gauge32", "NotificationType", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "enterprises", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, stCategories=stCategories, notifyAffectedHost=notifyAffectedHost, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, notifyReason=notifyReason, kProductName=kProductName, kMajorVersion=kMajorVersion, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, mwgFTP=mwgFTP, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, stCategoryCount=stCategoryCount)
