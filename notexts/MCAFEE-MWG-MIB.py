...
Integer32, IpAddress, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32, MibIdentifier, enterprises, Gauge32, TimeTicks, iso, ModuleIdentity, NotificationType, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32", "MibIdentifier", "enterprises", "Gauge32", "TimeTicks", "iso", "ModuleIdentity", "NotificationType", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, notifySeverity=notifySeverity, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, trSystem=trSystem, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName)
