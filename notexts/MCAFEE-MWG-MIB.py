...
Unsigned32, Bits, Counter64, NotificationType, enterprises, mib_2, Integer32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Counter64", "NotificationType", "enterprises", "mib-2", "Integer32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, mwgContent=mwgContent, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, notifyReason=notifyReason, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
