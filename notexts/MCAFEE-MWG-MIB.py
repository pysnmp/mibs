...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, iso, ModuleIdentity, TimeTicks, Integer32, mib_2, NotificationType, Bits, Counter32, NotificationType, MibIdentifier, Counter64, IpAddress, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "iso", "ModuleIdentity", "TimeTicks", "Integer32", "mib-2", "NotificationType", "Bits", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, kMajorVersion=kMajorVersion, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stCategoryName=stCategoryName, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous)
