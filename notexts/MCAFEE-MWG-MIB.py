...
enterprises, Counter64, iso, NotificationType, Integer32, NotificationType, ModuleIdentity, IpAddress, mib_2, Bits, MibIdentifier, Gauge32, Unsigned32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "iso", "NotificationType", "Integer32", "NotificationType", "ModuleIdentity", "IpAddress", "mib-2", "Bits", "MibIdentifier", "Gauge32", "Unsigned32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, trUser=trUser, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString)
