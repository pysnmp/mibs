...
Integer32, Unsigned32, TimeTicks, MibIdentifier, ObjectIdentity, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, enterprises, Counter64, Gauge32, NotificationType, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "enterprises", "Counter64", "Gauge32", "NotificationType", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, trUser=trUser, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, stCategories=stCategories, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, stMimeType=stMimeType, stBadReputation=stBadReputation, mwg=mwg, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed)
