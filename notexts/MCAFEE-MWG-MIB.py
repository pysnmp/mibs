...
ModuleIdentity, iso, NotificationType, enterprises, Bits, ObjectIdentity, NotificationType, IpAddress, Counter32, TimeTicks, Unsigned32, Counter64, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "NotificationType", "enterprises", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "Counter32", "TimeTicks", "Unsigned32", "Counter64", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stCategoryName=stCategoryName, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, stMimeType=stMimeType, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, mwg=mwg, mwgTraps=mwgTraps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
