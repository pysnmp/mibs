...
Integer32, Unsigned32, NotificationType, iso, Counter64, mib_2, Bits, ObjectIdentity, Counter32, MibIdentifier, TimeTicks, IpAddress, NotificationType, enterprises, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "iso", "Counter64", "mib-2", "Bits", "ObjectIdentity", "Counter32", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "enterprises", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, kProductVersion=kProductVersion, trApplication=trApplication, notifyAdditional=notifyAdditional, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, kCompanyName=kCompanyName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, trUser=trUser, mwgHttp=mwgHttp, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, kRevision=kRevision, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent)
