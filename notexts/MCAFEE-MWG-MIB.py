...
Integer32, IpAddress, Counter32, TimeTicks, MibIdentifier, ObjectIdentity, iso, ModuleIdentity, Bits, Gauge32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, mib_2, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "iso", "ModuleIdentity", "Bits", "Gauge32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "mib-2", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, trSystem=trSystem, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, trUser=trUser, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, kRevision=kRevision, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, kProductName=kProductName, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, mwg=mwg, mwgTraps=mwgTraps)
