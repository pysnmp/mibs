...
Unsigned32, NotificationType, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ObjectIdentity, Gauge32, Counter32, mib_2, Bits, Counter64, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter32", "mib-2", "Bits", "Counter64", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, stBadReputation=stBadReputation, mwgTraps=mwgTraps, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, trApplication=trApplication, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, kRevision=kRevision, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stHttpsTraffic=stHttpsTraffic)
