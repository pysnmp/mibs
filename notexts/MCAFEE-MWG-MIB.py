...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, NotificationType, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, ModuleIdentity, Bits, enterprises, TimeTicks, Unsigned32, Integer32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "NotificationType", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "ModuleIdentity", "Bits", "enterprises", "TimeTicks", "Unsigned32", "Integer32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, trUser=trUser, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, mwg=mwg, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity)
