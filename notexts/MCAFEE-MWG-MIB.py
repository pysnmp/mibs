...
Bits, ModuleIdentity, Integer32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Gauge32, iso, ObjectIdentity, MibIdentifier, NotificationType, mib_2, Counter64, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Integer32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Gauge32", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "mib-2", "Counter64", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, mwgFTP=mwgFTP, mwgHttp=mwgHttp, kRevision=kRevision, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, kProductName=kProductName, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, mwg=mwg, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, trUser=trUser, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, mwgContent=mwgContent, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, stHttpsRequests=stHttpsRequests)
