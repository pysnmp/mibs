...
MibIdentifier, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, Counter64, enterprises, iso, mib_2, TimeTicks, Counter32, NotificationType, ObjectIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "Counter64", "enterprises", "iso", "mib-2", "TimeTicks", "Counter32", "NotificationType", "ObjectIdentity", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, trUser=trUser, stCPULoad=stCPULoad, mwg=mwg, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, kRevision=kRevision, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, trApplication=trApplication, kProductName=kProductName, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, mwgHttps=mwgHttps, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, trSystem=trSystem)
