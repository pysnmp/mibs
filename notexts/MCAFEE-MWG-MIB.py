...
NotificationType, iso, ModuleIdentity, TimeTicks, Counter64, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, enterprises, Counter32, Bits, MibIdentifier, NotificationType, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ModuleIdentity", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "enterprises", "Counter32", "Bits", "MibIdentifier", "NotificationType", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, kProductVersion=kProductVersion, stCategories=stCategories, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, mwg=mwg, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName)
