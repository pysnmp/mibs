...
mib_2, Integer32, NotificationType, iso, Bits, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, enterprises, MibIdentifier, Counter32, Unsigned32, IpAddress, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "NotificationType", "iso", "Bits", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "enterprises", "MibIdentifier", "Counter32", "Unsigned32", "IpAddress", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stCategories=stCategories, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stClientCount=stClientCount, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString)
