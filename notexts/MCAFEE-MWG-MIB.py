...
NotificationType, Bits, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Unsigned32, Counter32, IpAddress, NotificationType, iso, MibIdentifier, Integer32, mib_2, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Unsigned32", "Counter32", "IpAddress", "NotificationType", "iso", "MibIdentifier", "Integer32", "mib-2", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, kProductName=kProductName, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stClientCount=stClientCount, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions)
