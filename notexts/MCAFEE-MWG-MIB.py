...
TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, NotificationType, Bits, Unsigned32, ModuleIdentity, IpAddress, Integer32, iso, mib_2, Counter64, Counter32, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "NotificationType", "Bits", "Unsigned32", "ModuleIdentity", "IpAddress", "Integer32", "iso", "mib-2", "Counter64", "Counter32", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, stClientCount=stClientCount, kCompanyName=kCompanyName, mwg=mwg, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, kProductVersion=kProductVersion, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, trApplication=trApplication)
