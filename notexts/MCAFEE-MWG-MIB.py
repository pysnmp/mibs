...
Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32, Counter32, ObjectIdentity, Unsigned32, mib_2, NotificationType, enterprises, Bits, MibIdentifier, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "mib-2", "NotificationType", "enterprises", "Bits", "MibIdentifier", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, notifyReason=notifyReason, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, mwgContent=mwgContent, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, mwg=mwg, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, kMicroVersion=kMicroVersion, trUser=trUser, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, trApplication=trApplication, pAMProactiveVersion=pAMProactiveVersion)
