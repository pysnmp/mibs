...
TimeTicks, iso, Integer32, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, enterprises, ObjectIdentity, MibIdentifier, Gauge32, Counter32, Counter64, IpAddress, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "enterprises", "ObjectIdentity", "MibIdentifier", "Gauge32", "Counter32", "Counter64", "IpAddress", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, stClientCount=stClientCount, notifyOrigin=notifyOrigin, notifyReason=notifyReason, kProductName=kProductName, kRevision=kRevision, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, stCategories=stCategories, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, mwgInfo=mwgInfo, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, trUser=trUser, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed)
