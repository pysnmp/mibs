...
iso, ObjectIdentity, mib_2, Counter64, ModuleIdentity, Integer32, Unsigned32, IpAddress, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, TimeTicks, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "mib-2", "Counter64", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "TimeTicks", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stClientCount=stClientCount, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, PYSNMP_MODULE_ID=mwg)
