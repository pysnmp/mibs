...
ModuleIdentity, mib_2, iso, Bits, Integer32, Counter64, TimeTicks, IpAddress, NotificationType, Unsigned32, enterprises, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "iso", "Bits", "Integer32", "Counter64", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "enterprises", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, trApplication=trApplication, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, trSystem=trSystem, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, stMemConsumed=stMemConsumed, kRevision=kRevision, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, notifySeverity=notifySeverity, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
