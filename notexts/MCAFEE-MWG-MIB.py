...
MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, NotificationType, Bits, ModuleIdentity, mib_2, iso, TimeTicks, Unsigned32, Gauge32, ObjectIdentity, IpAddress, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "NotificationType", "Bits", "ModuleIdentity", "mib-2", "iso", "TimeTicks", "Unsigned32", "Gauge32", "ObjectIdentity", "IpAddress", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, kProductVersion=kProductVersion, mwgContent=mwgContent, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwg=mwg, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, stCategories=stCategories, mwgTraps=mwgTraps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion)
