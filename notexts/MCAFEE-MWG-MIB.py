...
mib_2, NotificationType, TimeTicks, Counter64, ObjectIdentity, iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, enterprises, ModuleIdentity, Bits, Unsigned32, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "TimeTicks", "Counter64", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "enterprises", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stCategoriesTable=stCategoriesTable, mwg=mwg, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, mwgFTP=mwgFTP, stMimeType=stMimeType, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, trApplication=trApplication, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, notifyReason=notifyReason, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName)
