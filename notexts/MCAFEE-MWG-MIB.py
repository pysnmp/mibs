...
ObjectIdentity, NotificationType, Counter32, TimeTicks, Bits, NotificationType, mib_2, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Integer32, Unsigned32, Counter64, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter32", "TimeTicks", "Bits", "NotificationType", "mib-2", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "IpAddress", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, notifyOriginName=notifyOriginName, mwgContent=mwgContent, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, kProductName=kProductName, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, mwg=mwg, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, mwgTraps=mwgTraps, notifyReason=notifyReason, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, trUser=trUser, notifyAdditional=notifyAdditional)
