...
NotificationType, ObjectIdentity, mib_2, enterprises, TimeTicks, ModuleIdentity, NotificationType, Gauge32, Unsigned32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Integer32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "mib-2", "enterprises", "TimeTicks", "ModuleIdentity", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Integer32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stCategories=stCategories, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, notifyAffectedHost=notifyAffectedHost, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, mwgFTP=mwgFTP, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, mwg=mwg, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
