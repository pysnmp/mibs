...
Gauge32, ModuleIdentity, NotificationType, Bits, Counter32, TimeTicks, MibIdentifier, NotificationType, Integer32, mib_2, enterprises, ObjectIdentity, Unsigned32, Counter64, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "TimeTicks", "MibIdentifier", "NotificationType", "Integer32", "mib-2", "enterprises", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, trUser=trUser, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttp=mwgHttp, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, notifyReason=notifyReason, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, mwgInfo=mwgInfo, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, mwg=mwg, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber)
