...
NotificationType, Counter64, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, Bits, iso, ModuleIdentity, Counter32, TimeTicks, enterprises, MibIdentifier, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "Bits", "iso", "ModuleIdentity", "Counter32", "TimeTicks", "enterprises", "MibIdentifier", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, trApplication=trApplication, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, pAMEngineVersion=pAMEngineVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, mwg=mwg, trUser=trUser)
