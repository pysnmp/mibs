...
NotificationType, Bits, Gauge32, Integer32, ModuleIdentity, enterprises, IpAddress, Unsigned32, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter32, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Gauge32", "Integer32", "ModuleIdentity", "enterprises", "IpAddress", "Unsigned32", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter32", "mib-2", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, notifyOrigin=notifyOrigin, mwgContent=mwgContent, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, trUser=trUser, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient)
