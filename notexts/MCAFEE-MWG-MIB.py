...
ObjectIdentity, ModuleIdentity, Unsigned32, iso, Bits, Gauge32, IpAddress, TimeTicks, Integer32, MibIdentifier, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "iso", "Bits", "Gauge32", "IpAddress", "TimeTicks", "Integer32", "MibIdentifier", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, mwgStatistics=mwgStatistics, stMemConsumed=stMemConsumed, kProductName=kProductName, mwg=mwg, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kRevision=kRevision, notifyOrigin=notifyOrigin, trSystem=trSystem, mwgHttp=mwgHttp, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stClientCount=stClientCount, stBadReputation=stBadReputation, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, kProductVersion=kProductVersion, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient)
