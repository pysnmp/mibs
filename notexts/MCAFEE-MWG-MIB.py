...
TimeTicks, MibIdentifier, iso, Bits, Integer32, IpAddress, NotificationType, ModuleIdentity, Counter32, mib_2, enterprises, NotificationType, ObjectIdentity, Counter64, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "iso", "Bits", "Integer32", "IpAddress", "NotificationType", "ModuleIdentity", "Counter32", "mib-2", "enterprises", "NotificationType", "ObjectIdentity", "Counter64", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, trUser=trUser, trSystem=trSystem, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, trApplication=trApplication, mwgHttp=mwgHttp, kHotfixVersion=kHotfixVersion, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient)
