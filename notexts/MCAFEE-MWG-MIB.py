...
Gauge32, TimeTicks, iso, Integer32, ObjectIdentity, enterprises, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, IpAddress, Bits, ModuleIdentity, Counter64, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "iso", "Integer32", "ObjectIdentity", "enterprises", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "IpAddress", "Bits", "ModuleIdentity", "Counter64", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stMimeType=stMimeType, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, mwgContent=mwgContent, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion)
