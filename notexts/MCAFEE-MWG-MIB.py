...
Counter64, Integer32, Bits, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Unsigned32, Gauge32, Counter32, IpAddress, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Bits", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter32", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, trUser=trUser, mwg=mwg, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, notifyReason=notifyReason, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stMimeType=stMimeType, kProductName=kProductName, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware)
