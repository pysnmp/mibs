...
IpAddress, TimeTicks, mib_2, Integer32, NotificationType, enterprises, iso, MibIdentifier, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "mib-2", "Integer32", "NotificationType", "enterprises", "iso", "MibIdentifier", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwg=mwg, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, trApplication=trApplication, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, mwgFTP=mwgFTP, trUser=trUser, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, stCPUIOWait=stCPUIOWait)
