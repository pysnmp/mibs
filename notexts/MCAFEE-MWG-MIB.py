...
iso, Integer32, NotificationType, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, mib_2, TimeTicks, ModuleIdentity, Unsigned32, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "mib-2", "TimeTicks", "ModuleIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, kProductName=kProductName, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, trSystem=trSystem, stMemConsumed=stMemConsumed, mwgHttp=mwgHttp, stCategories=stCategories, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, pMFEEngineVersion=pMFEEngineVersion, mwgFTP=mwgFTP, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, kMinorVersion=kMinorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason)
