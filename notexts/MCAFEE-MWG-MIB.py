...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, NotificationType, NotificationType, Unsigned32, Gauge32, ModuleIdentity, TimeTicks, Bits, Counter32, ObjectIdentity, Counter64, enterprises, mib_2, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "NotificationType", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "TimeTicks", "Bits", "Counter32", "ObjectIdentity", "Counter64", "enterprises", "mib-2", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, mwgHttps=mwgHttps, trSystem=trSystem, notifyReason=notifyReason, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
