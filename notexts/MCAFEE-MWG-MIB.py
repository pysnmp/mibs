...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, iso, Bits, Counter32, enterprises, Counter64, NotificationType, IpAddress, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "iso", "Bits", "Counter32", "enterprises", "Counter64", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeForTransaction=stTimeForTransaction, mwg=mwg, mwgContent=mwgContent, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, kRevision=kRevision, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, notifyReason=notifyReason, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer)
