...
ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, mib_2, TimeTicks, Counter64, MibIdentifier, iso, Bits, ObjectIdentity, Unsigned32, IpAddress, enterprises, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "mib-2", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "enterprises", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, kCompanyName=kCompanyName, mwgInfo=mwgInfo, kProductName=kProductName, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, mwgHttps=mwgHttps, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent)
