...
NotificationType, ObjectIdentity, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Counter32, MibIdentifier, enterprises, TimeTicks, Gauge32, NotificationType, IpAddress, Bits, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Counter32", "MibIdentifier", "enterprises", "TimeTicks", "Gauge32", "NotificationType", "IpAddress", "Bits", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stCPUIOWait=stCPUIOWait, stMemConsumed=stMemConsumed, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, mwgFTP=mwgFTP, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpTraffic=stFtpTraffic, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, trSystem=trSystem, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion)
