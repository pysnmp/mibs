...
Gauge32, Unsigned32, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, iso, Bits, Integer32, NotificationType, TimeTicks, mib_2, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "Bits", "Integer32", "NotificationType", "TimeTicks", "mib-2", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, kProductName=kProductName, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, notifyReason=notifyReason, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, mwg=mwg, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, kRevision=kRevision, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps)
