...
TimeTicks, MibIdentifier, Counter64, NotificationType, Unsigned32, Counter32, Gauge32, mib_2, NotificationType, ObjectIdentity, iso, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Counter64", "NotificationType", "Unsigned32", "Counter32", "Gauge32", "mib-2", "NotificationType", "ObjectIdentity", "iso", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, kMinorVersion=kMinorVersion, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, kProductVersion=kProductVersion, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed)
