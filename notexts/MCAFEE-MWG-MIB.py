...
ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, TimeTicks, Bits, Unsigned32, Gauge32, NotificationType, Counter64, iso, MibIdentifier, Integer32, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "Gauge32", "NotificationType", "Counter64", "iso", "MibIdentifier", "Integer32", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, trSystem=trSystem, kRevision=kRevision, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, trUser=trUser, mwgFTP=mwgFTP, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stCategories=stCategories)
