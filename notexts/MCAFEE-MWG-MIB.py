...
Counter64, Integer32, ObjectIdentity, ModuleIdentity, NotificationType, enterprises, MibIdentifier, Gauge32, iso, Bits, Unsigned32, mib_2, IpAddress, Counter32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "enterprises", "MibIdentifier", "Gauge32", "iso", "Bits", "Unsigned32", "mib-2", "IpAddress", "Counter32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, trSystem=trSystem, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stCategories=stCategories, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, kRevision=kRevision, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware)
