...
Counter32, MibIdentifier, mib_2, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, NotificationType, Bits, Unsigned32, ObjectIdentity, Gauge32, Counter64, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "mib-2", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "NotificationType", "Bits", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, notifyOriginName=notifyOriginName, stMemConsumed=stMemConsumed, trUser=trUser, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToClient=stHttpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, kProductVersion=kProductVersion, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, mwg=mwg, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, trApplication=trApplication, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount)
