...
IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Counter64, NotificationType, mib_2, iso, Bits, ModuleIdentity, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Counter64", "NotificationType", "mib-2", "iso", "Bits", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, kProductName=kProductName, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToClient=stHttpsBytesToClient, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoad=stCPULoad, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, kRevision=kRevision, trUser=trUser, mwgInfo=mwgInfo, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, mwg=mwg, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS)
