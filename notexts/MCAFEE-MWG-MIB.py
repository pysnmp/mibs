...
Bits, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, NotificationType, ObjectIdentity, Integer32, mib_2, iso, Unsigned32, IpAddress, Counter64, Counter32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "NotificationType", "ObjectIdentity", "Integer32", "mib-2", "iso", "Unsigned32", "IpAddress", "Counter64", "Counter32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, trUser=trUser, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stCPULoad=stCPULoad, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, mwg=mwg)
