...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, TimeTicks, ModuleIdentity, iso, enterprises, NotificationType, Bits, IpAddress, Counter32, Unsigned32, Counter64, MibIdentifier, NotificationType, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "iso", "enterprises", "NotificationType", "Bits", "IpAddress", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "NotificationType", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, kBuildNumber=kBuildNumber, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwg=mwg, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, trApplication=trApplication, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString)
