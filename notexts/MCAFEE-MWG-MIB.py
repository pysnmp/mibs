...
ModuleIdentity, NotificationType, IpAddress, NotificationType, iso, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, Integer32, Bits, TimeTicks, MibIdentifier, Gauge32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "IpAddress", "NotificationType", "iso", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "Gauge32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwg=mwg, mwgContent=mwgContent, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, kRevision=kRevision, stClientCount=stClientCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, kProductName=kProductName, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, stFtpTraffic=stFtpTraffic, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber)
