...
Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter64, IpAddress, mib_2, Gauge32, MibIdentifier, iso, TimeTicks, Bits, Integer32, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter64", "IpAddress", "mib-2", "Gauge32", "MibIdentifier", "iso", "TimeTicks", "Bits", "Integer32", "ModuleIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, mwg=mwg, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stMimeType=stMimeType, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, pTSDBVersion=pTSDBVersion)
