...
NotificationType, Counter64, enterprises, ModuleIdentity, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, Integer32, NotificationType, TimeTicks, IpAddress, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "enterprises", "ModuleIdentity", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, mwgTraps=mwgTraps, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, trApplication=trApplication, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, stCategories=stCategories, trUser=trUser, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount)
