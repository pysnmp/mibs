...
Bits, mib_2, NotificationType, MibIdentifier, iso, Unsigned32, ObjectIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Counter64, IpAddress, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "ObjectIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Counter64", "IpAddress", "Integer32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, mwgTraps=mwgTraps, kRevision=kRevision, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, stCategories=stCategories, stCPULoad=stCPULoad, stClientCount=stClientCount, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, mwg=mwg, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg)
