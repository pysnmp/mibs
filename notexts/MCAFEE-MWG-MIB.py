...
Gauge32, enterprises, Unsigned32, NotificationType, Bits, Integer32, Counter64, NotificationType, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks, ModuleIdentity, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Unsigned32", "NotificationType", "Bits", "Integer32", "Counter64", "NotificationType", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, kProductVersion=kProductVersion, trSystem=trSystem, trUser=trUser, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, mwgTrapVariables=mwgTrapVariables, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic)
