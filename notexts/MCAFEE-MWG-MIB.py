...
ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Gauge32, Bits, mib_2, TimeTicks, Integer32, Counter64, Unsigned32, iso, IpAddress, enterprises, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Gauge32", "Bits", "mib-2", "TimeTicks", "Integer32", "Counter64", "Unsigned32", "iso", "IpAddress", "enterprises", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, mwgFTP=mwgFTP, kProductName=kProductName, mwgInfo=mwgInfo, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, stHttpTraffic=stHttpTraffic, stMemConsumed=stMemConsumed, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stCategories=stCategories, mwgHttp=mwgHttp, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, trSystem=trSystem, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, kBuildNumber=kBuildNumber, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
