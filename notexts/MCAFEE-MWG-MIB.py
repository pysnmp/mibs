...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter64, IpAddress, Counter32, TimeTicks, ObjectIdentity, iso, mib_2, MibIdentifier, ModuleIdentity, NotificationType, enterprises, Unsigned32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter64", "IpAddress", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "mib-2", "MibIdentifier", "ModuleIdentity", "NotificationType", "enterprises", "Unsigned32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, mwgStatistics=mwgStatistics, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stCategories=stCategories, stCPULoad=stCPULoad, notifySeverity=notifySeverity, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stClientCount=stClientCount, trUser=trUser, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, kProductVersion=kProductVersion, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, mwgContent=mwgContent, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication)
