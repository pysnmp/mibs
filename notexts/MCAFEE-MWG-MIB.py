...
TimeTicks, ModuleIdentity, NotificationType, Bits, iso, ObjectIdentity, enterprises, Integer32, MibIdentifier, mib_2, Unsigned32, Counter64, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "iso", "ObjectIdentity", "enterprises", "Integer32", "MibIdentifier", "mib-2", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, kProductName=kProductName, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, mwgFTP=mwgFTP, notifySeverity=notifySeverity, stCPULoad=stCPULoad, mwgInfo=mwgInfo, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trUser=trUser, stCPULoadRaw=stCPULoadRaw, trApplication=trApplication, trSystem=trSystem, kRevision=kRevision, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter)
