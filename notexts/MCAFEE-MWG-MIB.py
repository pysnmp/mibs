...
Counter64, TimeTicks, NotificationType, Counter32, mib_2, enterprises, IpAddress, ObjectIdentity, iso, ModuleIdentity, Gauge32, MibIdentifier, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "NotificationType", "Counter32", "mib-2", "enterprises", "IpAddress", "ObjectIdentity", "iso", "ModuleIdentity", "Gauge32", "MibIdentifier", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, mwgFTP=mwgFTP, kCompanyName=kCompanyName, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, trUser=trUser, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stMimeType=stMimeType, kProductName=kProductName, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic)
