...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Bits, TimeTicks, ModuleIdentity, MibIdentifier, Counter64, Unsigned32, mib_2, iso, ObjectIdentity, IpAddress, enterprises, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Bits", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter64", "Unsigned32", "mib-2", "iso", "ObjectIdentity", "IpAddress", "enterprises", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, kProductVersion=kProductVersion, mwg=mwg, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, notifyReason=notifyReason, kCustomVersion=kCustomVersion, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stCategories=stCategories, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, kRevision=kRevision, stBadReputation=stBadReputation, stCategoryName=stCategoryName)
