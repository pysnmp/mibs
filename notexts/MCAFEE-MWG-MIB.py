...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Unsigned32, TimeTicks, MibIdentifier, enterprises, NotificationType, Gauge32, IpAddress, NotificationType, ObjectIdentity, Bits, mib_2, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Unsigned32", "TimeTicks", "MibIdentifier", "enterprises", "NotificationType", "Gauge32", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "mib-2", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, kProductName=kProductName, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, mwg=mwg, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, kRevision=kRevision, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, trUser=trUser, notifyOrigin=notifyOrigin)
