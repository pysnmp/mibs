...
iso, Counter32, NotificationType, Counter64, Bits, NotificationType, IpAddress, Integer32, TimeTicks, MibIdentifier, ModuleIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "NotificationType", "Counter64", "Bits", "NotificationType", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, trSystem=trSystem, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, stCategoryCount=stCategoryCount, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost)
