...
NotificationType, iso, ModuleIdentity, Bits, Integer32, TimeTicks, Unsigned32, Counter32, MibIdentifier, enterprises, Counter64, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ModuleIdentity", "Bits", "Integer32", "TimeTicks", "Unsigned32", "Counter32", "MibIdentifier", "enterprises", "Counter64", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, trUser=trUser, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, kRevision=kRevision, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, trSystem=trSystem, mwgFTP=mwgFTP, mwg=mwg, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, stCategories=stCategories, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber)
