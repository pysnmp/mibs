...
NotificationType, Unsigned32, MibIdentifier, enterprises, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, TimeTicks, ObjectIdentity, Counter32, Bits, Counter64, ModuleIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibIdentifier", "enterprises", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "TimeTicks", "ObjectIdentity", "Counter32", "Bits", "Counter64", "ModuleIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stCategories=stCategories, kProductVersion=kProductVersion, stClientCount=stClientCount, mwg=mwg, stFtpBytesToClient=stFtpBytesToClient, stMimeType=stMimeType, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, stCPULoad=stCPULoad, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, kRevision=kRevision, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, kBuildNumber=kBuildNumber)
