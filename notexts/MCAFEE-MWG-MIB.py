...
enterprises, ObjectIdentity, Counter64, ModuleIdentity, mib_2, Unsigned32, IpAddress, iso, Counter32, Bits, NotificationType, NotificationType, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Counter64", "ModuleIdentity", "mib-2", "Unsigned32", "IpAddress", "iso", "Counter32", "Bits", "NotificationType", "NotificationType", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, stCategories=stCategories, trUser=trUser, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stHttpTraffic=stHttpTraffic, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS)
