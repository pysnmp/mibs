...
Counter64, NotificationType, TimeTicks, NotificationType, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, iso, ModuleIdentity, mib_2, ObjectIdentity, enterprises, MibIdentifier, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "NotificationType", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "iso", "ModuleIdentity", "mib-2", "ObjectIdentity", "enterprises", "MibIdentifier", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, mwg=mwg, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw)
