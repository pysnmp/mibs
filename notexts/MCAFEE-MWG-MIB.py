...
Unsigned32, NotificationType, Counter32, IpAddress, iso, Integer32, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, enterprises, mib_2, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Counter32", "IpAddress", "iso", "Integer32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "enterprises", "mib-2", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stCategoriesTable=stCategoriesTable, kRevision=kRevision, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, kMicroVersion=kMicroVersion, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, kCompanyName=kCompanyName, stHttpBytesToClient=stHttpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stMimeType=stMimeType, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, mwg=mwg, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware)
