...
TimeTicks, enterprises, Integer32, Counter32, mib_2, NotificationType, Bits, Counter64, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Integer32", "Counter32", "mib-2", "NotificationType", "Bits", "Counter64", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, trApplication=trApplication, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stClientCount=stClientCount, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, kRevision=kRevision)
