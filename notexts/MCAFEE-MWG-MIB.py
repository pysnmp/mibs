...
Gauge32, Bits, mib_2, IpAddress, NotificationType, iso, MibIdentifier, enterprises, ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "mib-2", "IpAddress", "NotificationType", "iso", "MibIdentifier", "enterprises", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, stBadReputation=stBadReputation, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
