...
Counter32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, iso, Integer32, Unsigned32, IpAddress, MibIdentifier, ModuleIdentity, TimeTicks, ObjectIdentity, mib_2, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "iso", "Integer32", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "mib-2", "Bits", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stCPULoad=stCPULoad, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, kProductName=kProductName, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer)
