...
Counter64, Bits, NotificationType, Unsigned32, Counter32, iso, ModuleIdentity, enterprises, MibIdentifier, mib_2, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "NotificationType", "Unsigned32", "Counter32", "iso", "ModuleIdentity", "enterprises", "MibIdentifier", "mib-2", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, kMinorVersion=kMinorVersion, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, mwgHttps=mwgHttps)
