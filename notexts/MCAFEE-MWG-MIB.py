...
MibIdentifier, mib_2, NotificationType, Unsigned32, Bits, NotificationType, Gauge32, TimeTicks, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, ModuleIdentity, IpAddress, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "NotificationType", "Unsigned32", "Bits", "NotificationType", "Gauge32", "TimeTicks", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "ModuleIdentity", "IpAddress", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, kRevision=kRevision, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, trUser=trUser, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, trApplication=trApplication, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer)
