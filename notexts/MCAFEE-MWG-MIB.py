...
mib_2, IpAddress, NotificationType, iso, Unsigned32, MibIdentifier, Counter32, Bits, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "Counter32", "Bits", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, mwg=mwg, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, kMicroVersion=kMicroVersion, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, kRevision=kRevision, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables)
