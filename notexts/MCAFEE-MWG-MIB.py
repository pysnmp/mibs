...
NotificationType, enterprises, iso, Bits, Integer32, mib_2, Unsigned32, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, NotificationType, IpAddress, Counter64, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "iso", "Bits", "Integer32", "mib-2", "Unsigned32", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, mwgFTP=mwgFTP, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation)
