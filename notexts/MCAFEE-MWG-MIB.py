...
NotificationType, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, IpAddress, mib_2, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, iso, Integer32, Bits, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress", "mib-2", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "iso", "Integer32", "Bits", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, stBadReputation=stBadReputation, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, mwgHttp=mwgHttp, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, kProductVersion=kProductVersion, kProductName=kProductName, stCategoryName=stCategoryName, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, kRevision=kRevision, stClientCount=stClientCount, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, notifySeverity=notifySeverity, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, trApplication=trApplication, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
