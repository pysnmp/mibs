...
IpAddress, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ObjectIdentity, NotificationType, enterprises, Gauge32, Counter32, mib_2, Bits, Integer32, NotificationType, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ObjectIdentity", "NotificationType", "enterprises", "Gauge32", "Counter32", "mib-2", "Bits", "Integer32", "NotificationType", "iso", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, kRevision=kRevision, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, mwg=mwg, stConnectedSockets=stConnectedSockets, trUser=trUser, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stCategories=stCategories, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, mwgInfo=mwgInfo, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, notifySeverity=notifySeverity, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation)
