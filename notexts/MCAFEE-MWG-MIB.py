...
NotificationType, NotificationType, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, mib_2, TimeTicks, ModuleIdentity, IpAddress, Bits, Counter64, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "mib-2", "TimeTicks", "ModuleIdentity", "IpAddress", "Bits", "Counter64", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgStatistics=mwgStatistics, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, kProductName=kProductName, kBuildNumber=kBuildNumber, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, mwgContent=mwgContent, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stMimeType=stMimeType, stCategories=stCategories, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps)
