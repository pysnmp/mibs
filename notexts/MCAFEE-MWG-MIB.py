...
ModuleIdentity, IpAddress, enterprises, mib_2, MibIdentifier, Bits, Counter32, NotificationType, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter64, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "enterprises", "mib-2", "MibIdentifier", "Bits", "Counter32", "NotificationType", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter64", "Unsigned32", "Integer32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trUser=trUser, stClientCount=stClientCount, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stBadReputation=stBadReputation, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, mwg=mwg, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, notifyAdditional=notifyAdditional, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stHttpBytesFromServer=stHttpBytesFromServer)
