...
mib_2, NotificationType, iso, NotificationType, ModuleIdentity, MibIdentifier, Counter32, Gauge32, enterprises, Bits, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "iso", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter32", "Gauge32", "enterprises", "Bits", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, stClientCount=stClientCount, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, trUser=trUser, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg)
