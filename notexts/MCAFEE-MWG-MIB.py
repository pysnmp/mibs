...
enterprises, iso, ObjectIdentity, mib_2, ModuleIdentity, Bits, TimeTicks, NotificationType, Counter32, Gauge32, MibIdentifier, Integer32, Counter64, IpAddress, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "ObjectIdentity", "mib-2", "ModuleIdentity", "Bits", "TimeTicks", "NotificationType", "Counter32", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, kProductVersion=kProductVersion, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, trApplication=trApplication, mwgHttp=mwgHttp, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, kCompanyName=kCompanyName, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, mwgHttps=mwgHttps, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stHttpRequests=stHttpRequests, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
