...
ModuleIdentity, Unsigned32, Integer32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Counter64, enterprises, Bits, TimeTicks, NotificationType, ObjectIdentity, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "enterprises", "Bits", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, kProductName=kProductName, mwgHttps=mwgHttps, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, mwgContent=mwgContent, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, trSystem=trSystem)
