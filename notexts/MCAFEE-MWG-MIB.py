...
TimeTicks, ModuleIdentity, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, MibIdentifier, NotificationType, enterprises, Bits, Unsigned32, Counter64, Gauge32, Counter32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "MibIdentifier", "NotificationType", "enterprises", "Bits", "Unsigned32", "Counter64", "Gauge32", "Counter32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, kProductVersion=kProductVersion, stCategories=stCategories, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, trUser=trUser, kCompanyName=kCompanyName, notifySeverity=notifySeverity, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
