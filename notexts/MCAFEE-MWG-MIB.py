...
MibIdentifier, Counter64, enterprises, Integer32, NotificationType, Gauge32, Unsigned32, NotificationType, IpAddress, Bits, iso, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "enterprises", "Integer32", "NotificationType", "Gauge32", "Unsigned32", "NotificationType", "IpAddress", "Bits", "iso", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, trSystem=trSystem, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic)
