...
Counter32, Unsigned32, NotificationType, iso, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, TimeTicks, Integer32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "NotificationType", "iso", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, trSystem=trSystem, kBuildNumber=kBuildNumber, mwg=mwg, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, mwgHttp=mwgHttp, notifyReason=notifyReason, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, kCustomVersion=kCustomVersion, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPUIOWait=stCPUIOWait, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests)
