...
Counter32, NotificationType, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, mib_2, Integer32, ModuleIdentity, Counter64, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "mib-2", "Integer32", "ModuleIdentity", "Counter64", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "enterprises", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stMemConsumed=stMemConsumed, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, kRevision=kRevision, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stCategories=stCategories, notifyReasonString=notifyReasonString, trSystem=trSystem, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient)
