...
NotificationType, Bits, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, NotificationType, IpAddress, TimeTicks, enterprises, iso, Counter64, ObjectIdentity, MibIdentifier, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "NotificationType", "IpAddress", "TimeTicks", "enterprises", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, notifySeverity=notifySeverity, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, mwgTraps=mwgTraps, mwgHttp=mwgHttp, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, trSystem=trSystem, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, trUser=trUser, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation)
