...
Integer32, Unsigned32, Counter32, NotificationType, enterprises, iso, TimeTicks, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "NotificationType", "enterprises", "iso", "TimeTicks", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stMemConsumed=stMemConsumed, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeForTransaction=stTimeForTransaction, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stMimeType=stMimeType, kProductVersion=kProductVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stCategories=stCategories, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient)
