...
Counter32, MibIdentifier, Integer32, NotificationType, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Unsigned32, Bits, enterprises, Counter64, IpAddress, TimeTicks, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Unsigned32", "Bits", "enterprises", "Counter64", "IpAddress", "TimeTicks", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kProductName=kProductName, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stCategories=stCategories, mwgStatistics=mwgStatistics, kRevision=kRevision, trUser=trUser, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg)
