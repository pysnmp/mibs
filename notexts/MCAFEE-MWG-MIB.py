...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, enterprises, TimeTicks, mib_2, Counter64, Unsigned32, Counter32, Gauge32, IpAddress, NotificationType, MibIdentifier, iso, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "enterprises", "TimeTicks", "mib-2", "Counter64", "Unsigned32", "Counter32", "Gauge32", "IpAddress", "NotificationType", "MibIdentifier", "iso", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, kRevision=kRevision, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, trUser=trUser, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, kProductName=kProductName, mwgStatistics=mwgStatistics)
