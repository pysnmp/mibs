...
mib_2, Bits, TimeTicks, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, Counter32, NotificationType, ObjectIdentity, Integer32, Gauge32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "Counter32", "NotificationType", "ObjectIdentity", "Integer32", "Gauge32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, kRevision=kRevision, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, trUser=trUser, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, stCategories=stCategories, stHttpRequests=stHttpRequests, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, stMemConsumed=stMemConsumed, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, mwg=mwg, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion)
