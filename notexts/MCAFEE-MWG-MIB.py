...
NotificationType, MibIdentifier, Bits, Integer32, ObjectIdentity, NotificationType, Gauge32, Unsigned32, Counter32, enterprises, ModuleIdentity, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Bits", "Integer32", "ObjectIdentity", "NotificationType", "Gauge32", "Unsigned32", "Counter32", "enterprises", "ModuleIdentity", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, trSystem=trSystem, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, stClientCount=stClientCount, mwgContent=mwgContent, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, mwg=mwg, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, mwgHttps=mwgHttps, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter)
