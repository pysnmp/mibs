...
Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, enterprises, NotificationType, Counter64, iso, Counter32, Unsigned32, Bits, ObjectIdentity, NotificationType, TimeTicks, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "enterprises", "NotificationType", "Counter64", "iso", "Counter32", "Unsigned32", "Bits", "ObjectIdentity", "NotificationType", "TimeTicks", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, notifyReasonString=notifyReasonString, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, mwg=mwg, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, kMicroVersion=kMicroVersion, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests)
