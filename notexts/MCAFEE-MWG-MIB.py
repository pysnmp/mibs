...
Integer32, Unsigned32, Gauge32, Counter64, mib_2, IpAddress, TimeTicks, Bits, NotificationType, Counter32, ModuleIdentity, ObjectIdentity, iso, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "Counter64", "mib-2", "IpAddress", "TimeTicks", "Bits", "NotificationType", "Counter32", "ModuleIdentity", "ObjectIdentity", "iso", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stHttpBytesToClient=stHttpBytesToClient, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, trApplication=trApplication, trUser=trUser, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, notifyReason=notifyReason, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, mwg=mwg, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw)
