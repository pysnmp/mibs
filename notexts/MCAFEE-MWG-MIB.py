...
NotificationType, MibIdentifier, Unsigned32, Counter64, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter32, Gauge32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter32", "Gauge32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, kRevision=kRevision, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, mwgInfo=mwgInfo, trUser=trUser)
