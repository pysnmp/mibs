...
Integer32, Counter32, Counter64, NotificationType, TimeTicks, mib_2, enterprises, ObjectIdentity, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, ModuleIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "NotificationType", "TimeTicks", "mib-2", "enterprises", "ObjectIdentity", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "ModuleIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, notifyOrigin=notifyOrigin, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, trSystem=trSystem, mwgFTP=mwgFTP, kProductName=kProductName, stCategories=stCategories, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, mwgContent=mwgContent, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions)
