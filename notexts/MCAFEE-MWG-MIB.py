...
IpAddress, NotificationType, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, ModuleIdentity, NotificationType, Counter32, mib_2, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "ModuleIdentity", "NotificationType", "Counter32", "mib-2", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "Integer32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, kProductName=kProductName, stCategoryName=stCategoryName, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, stCategories=stCategories, mwgTraps=mwgTraps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, mwg=mwg, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, trSystem=trSystem, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, trUser=trUser, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity)
