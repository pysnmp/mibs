...
enterprises, Counter64, MibIdentifier, iso, IpAddress, Bits, NotificationType, ObjectIdentity, Integer32, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "MibIdentifier", "iso", "IpAddress", "Bits", "NotificationType", "ObjectIdentity", "Integer32", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, mwg=mwg, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, trSystem=trSystem, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stCategories=stCategories, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, trUser=trUser, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps)
