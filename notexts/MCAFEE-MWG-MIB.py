...
Integer32, ModuleIdentity, Counter32, mib_2, IpAddress, NotificationType, MibIdentifier, TimeTicks, Bits, ObjectIdentity, iso, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter32", "mib-2", "IpAddress", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "iso", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, mwgTraps=mwgTraps, trSystem=trSystem, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, kProductVersion=kProductVersion, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation)
