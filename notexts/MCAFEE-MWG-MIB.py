...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Gauge32, Counter64, mib_2, NotificationType, enterprises, ObjectIdentity, Unsigned32, IpAddress, Counter32, NotificationType, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Gauge32", "Counter64", "mib-2", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "MibIdentifier", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, trUser=trUser, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, notifyOriginName=notifyOriginName, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, kRevision=kRevision, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost)
