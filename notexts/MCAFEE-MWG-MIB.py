...
NotificationType, ModuleIdentity, Integer32, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, NotificationType, mib_2, enterprises, Bits, Unsigned32, MibIdentifier, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "mib-2", "enterprises", "Bits", "Unsigned32", "MibIdentifier", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, mwg=mwg, stCategoryName=stCategoryName, kProductVersion=kProductVersion, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, kProductName=kProductName, trApplication=trApplication, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
