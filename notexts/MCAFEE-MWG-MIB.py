...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, mib_2, Counter32, Integer32, Unsigned32, Gauge32, NotificationType, iso, ModuleIdentity, NotificationType, MibIdentifier, TimeTicks, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "mib-2", "Counter32", "Integer32", "Unsigned32", "Gauge32", "NotificationType", "iso", "ModuleIdentity", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, mwg=mwg, kHotfixVersion=kHotfixVersion, trUser=trUser, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, kProductName=kProductName, mwgHttp=mwgHttp, notifyReason=notifyReason, stFtpTraffic=stFtpTraffic, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
