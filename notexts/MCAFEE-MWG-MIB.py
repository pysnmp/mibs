...
Gauge32, NotificationType, ObjectIdentity, iso, Unsigned32, Counter64, enterprises, IpAddress, NotificationType, ModuleIdentity, Integer32, TimeTicks, mib_2, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ObjectIdentity", "iso", "Unsigned32", "Counter64", "enterprises", "IpAddress", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "mib-2", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, mwg=mwg, kBuildNumber=kBuildNumber, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReason=notifyReason, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
