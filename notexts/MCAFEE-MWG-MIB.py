...
Gauge32, Counter32, NotificationType, iso, Integer32, ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, mib_2, Bits, MibIdentifier, TimeTicks, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "NotificationType", "iso", "Integer32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "mib-2", "Bits", "MibIdentifier", "TimeTicks", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, trApplication=trApplication, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stCategories=stCategories, stMemConsumed=stMemConsumed)
