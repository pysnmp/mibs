...
Gauge32, Counter64, ModuleIdentity, Bits, mib_2, NotificationType, Integer32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, enterprises, Counter32, IpAddress, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ModuleIdentity", "Bits", "mib-2", "NotificationType", "Integer32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "enterprises", "Counter32", "IpAddress", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stCategories=stCategories, kMajorVersion=kMajorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, trSystem=trSystem, stMimeType=stMimeType, mwgTraps=mwgTraps, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, kProductName=kProductName, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, mwg=mwg, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP)
