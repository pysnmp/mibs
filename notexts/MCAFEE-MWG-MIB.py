...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, MibIdentifier, Gauge32, ModuleIdentity, Unsigned32, NotificationType, NotificationType, Counter64, mib_2, enterprises, ObjectIdentity, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "MibIdentifier", "Gauge32", "ModuleIdentity", "Unsigned32", "NotificationType", "NotificationType", "Counter64", "mib-2", "enterprises", "ObjectIdentity", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, kProductName=kProductName, stClientCount=stClientCount, stHttpBytesToClient=stHttpBytesToClient, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, kMicroVersion=kMicroVersion, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, kRevision=kRevision, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, notifyReason=notifyReason, notifyOrigin=notifyOrigin, stFtpBytesToClient=stFtpBytesToClient, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic)
