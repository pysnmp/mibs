...
MibIdentifier, TimeTicks, ObjectIdentity, ModuleIdentity, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, enterprises, Bits, Gauge32, Counter64, Integer32, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "enterprises", "Bits", "Gauge32", "Counter64", "Integer32", "iso", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, trUser=trUser, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, trSystem=trSystem, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, stMimeType=stMimeType, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stCPULoad=stCPULoad)
