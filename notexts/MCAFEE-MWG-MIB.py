...
IpAddress, NotificationType, Bits, MibIdentifier, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Counter32, ModuleIdentity, iso, mib_2, TimeTicks, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Bits", "MibIdentifier", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Counter32", "ModuleIdentity", "iso", "mib-2", "TimeTicks", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, notifyAdditional=notifyAdditional, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, trUser=trUser, notifyOrigin=notifyOrigin, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, mwg=mwg, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics)
