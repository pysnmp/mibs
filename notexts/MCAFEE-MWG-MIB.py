...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, Unsigned32, NotificationType, ObjectIdentity, enterprises, ModuleIdentity, Gauge32, Counter64, Bits, mib_2, TimeTicks, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "NotificationType", "ObjectIdentity", "enterprises", "ModuleIdentity", "Gauge32", "Counter64", "Bits", "mib-2", "TimeTicks", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, trUser=trUser, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stMimeType=stMimeType, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, mwgHttp=mwgHttp, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, kMicroVersion=kMicroVersion, stClientCount=stClientCount, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, stCategories=stCategories, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
