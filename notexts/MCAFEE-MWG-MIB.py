...
Integer32, IpAddress, Counter32, enterprises, TimeTicks, MibIdentifier, Bits, NotificationType, ObjectIdentity, mib_2, Gauge32, Counter64, iso, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "mib-2", "Gauge32", "Counter64", "iso", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, trApplication=trApplication, kProductName=kProductName, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, notifySeverity=notifySeverity, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stMimeType=stMimeType, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps)
