...
NotificationType, enterprises, Bits, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, NotificationType, Integer32, ModuleIdentity, Unsigned32, Counter32, mib_2, iso, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Bits", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "Unsigned32", "Counter32", "mib-2", "iso", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stClientCount=stClientCount, notifyReasonString=notifyReasonString, kCompanyName=kCompanyName, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, notifyReason=notifyReason, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, kRevision=kRevision, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, stCPULoad=stCPULoad, trUser=trUser, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity)
