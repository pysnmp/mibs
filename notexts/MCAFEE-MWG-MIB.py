...
Counter64, mib_2, NotificationType, Bits, Integer32, TimeTicks, NotificationType, MibIdentifier, IpAddress, ObjectIdentity, Unsigned32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "NotificationType", "Bits", "Integer32", "TimeTicks", "NotificationType", "MibIdentifier", "IpAddress", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, trUser=trUser, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, kProductName=kProductName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, trSystem=trSystem, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, kMajorVersion=kMajorVersion, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber)
