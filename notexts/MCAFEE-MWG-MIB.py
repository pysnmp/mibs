...
iso, Integer32, NotificationType, MibIdentifier, Counter32, mib_2, Unsigned32, IpAddress, NotificationType, Gauge32, Counter64, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "mib-2", "Unsigned32", "IpAddress", "NotificationType", "Gauge32", "Counter64", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, mwgContent=mwgContent, stCategories=stCategories, notifyReason=notifyReason, trUser=trUser, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, notifyAdditional=notifyAdditional, stCPULoad=stCPULoad, mwgInfo=mwgInfo, trSystem=trSystem, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient)
