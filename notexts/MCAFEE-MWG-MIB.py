...
Unsigned32, mib_2, NotificationType, MibIdentifier, NotificationType, iso, TimeTicks, Counter64, ObjectIdentity, Gauge32, ModuleIdentity, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "NotificationType", "MibIdentifier", "NotificationType", "iso", "TimeTicks", "Counter64", "ObjectIdentity", "Gauge32", "ModuleIdentity", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, trSystem=trSystem, mwg=mwg, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, kRevision=kRevision, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAdditional=notifyAdditional, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, trUser=trUser, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, trApplication=trApplication, mwgHttp=mwgHttp, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer)
