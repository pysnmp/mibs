...
Bits, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, Counter64, ModuleIdentity, NotificationType, Gauge32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Counter32, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "ModuleIdentity", "NotificationType", "Gauge32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Counter32", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, mwg=mwg, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, mwgEngineVersions=mwgEngineVersions, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName)
