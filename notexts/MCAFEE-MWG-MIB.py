...
iso, Gauge32, Counter64, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, IpAddress, Unsigned32, mib_2, enterprises, NotificationType, TimeTicks, Counter32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter64", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "IpAddress", "Unsigned32", "mib-2", "enterprises", "NotificationType", "TimeTicks", "Counter32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stMimeType=stMimeType, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stClientCount=stClientCount, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, kHotfixVersion=kHotfixVersion)
