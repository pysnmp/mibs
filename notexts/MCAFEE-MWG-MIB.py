...
ModuleIdentity, Gauge32, NotificationType, IpAddress, Integer32, MibIdentifier, Counter32, TimeTicks, Counter64, enterprises, Unsigned32, mib_2, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "NotificationType", "IpAddress", "Integer32", "MibIdentifier", "Counter32", "TimeTicks", "Counter64", "enterprises", "Unsigned32", "mib-2", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, stMemConsumed=stMemConsumed, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, trSystem=trSystem, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, kRevision=kRevision, trUser=trUser, notifyAdditional=notifyAdditional, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, notifyReason=notifyReason, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost)
