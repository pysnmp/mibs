...
MibIdentifier, Bits, NotificationType, IpAddress, ModuleIdentity, Integer32, enterprises, mib_2, Unsigned32, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "ModuleIdentity", "Integer32", "enterprises", "mib-2", "Unsigned32", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, trSystem=trSystem, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, mwgInfo=mwgInfo, trUser=trUser, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, notifyReason=notifyReason, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, stCategories=stCategories, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stClientCount=stClientCount, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion)
