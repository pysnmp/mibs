...
enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, MibIdentifier, Counter32, NotificationType, Unsigned32, ObjectIdentity, Gauge32, IpAddress, mib_2, Counter64, ModuleIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "MibIdentifier", "Counter32", "NotificationType", "Unsigned32", "ObjectIdentity", "Gauge32", "IpAddress", "mib-2", "Counter64", "ModuleIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, trApplication=trApplication, stMimeType=stMimeType, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, mwg=mwg, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, trUser=trUser, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, kProductName=kProductName, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
