...
Unsigned32, Bits, MibIdentifier, Gauge32, iso, Integer32, enterprises, mib_2, NotificationType, ObjectIdentity, IpAddress, Counter32, TimeTicks, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "MibIdentifier", "Gauge32", "iso", "Integer32", "enterprises", "mib-2", "NotificationType", "ObjectIdentity", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, stBadReputation=stBadReputation, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, stCategories=stCategories, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName)
