...
NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, mib_2, Bits, ObjectIdentity, ModuleIdentity, Counter32, Gauge32, enterprises, Integer32, IpAddress, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "mib-2", "Bits", "ObjectIdentity", "ModuleIdentity", "Counter32", "Gauge32", "enterprises", "Integer32", "IpAddress", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stCPULoad=stCPULoad, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, trSystem=trSystem, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, notifySeverity=notifySeverity, mwgHttp=mwgHttp, trUser=trUser, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, stCategories=stCategories, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, trApplication=trApplication, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient)
