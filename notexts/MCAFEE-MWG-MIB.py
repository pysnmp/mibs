...
Bits, NotificationType, Integer32, enterprises, ObjectIdentity, IpAddress, iso, TimeTicks, Counter64, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, NotificationType, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "enterprises", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "Counter64", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, notifyReason=notifyReason, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, mwg=mwg, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stHttpRequests=stHttpRequests, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, mwgContent=mwgContent, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg)
