...
Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter32, NotificationType, MibIdentifier, iso, Unsigned32, Gauge32, NotificationType, ModuleIdentity, IpAddress, TimeTicks, mib_2, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter32", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "NotificationType", "ModuleIdentity", "IpAddress", "TimeTicks", "mib-2", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, stHttpBytesToServer=stHttpBytesToServer, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, pAMSignatureVersion=pAMSignatureVersion)
