...
Integer32, NotificationType, Bits, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, Unsigned32, enterprises, Counter32, Counter64, IpAddress, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "Counter64", "IpAddress", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, trApplication=trApplication, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stClientCount=stClientCount, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, mwgHttps=mwgHttps, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, stCategories=stCategories, notifyAdditional=notifyAdditional, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, trSystem=trSystem, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent)
