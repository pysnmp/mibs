...
Unsigned32, TimeTicks, iso, ModuleIdentity, mib_2, NotificationType, Bits, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Integer32, NotificationType, Gauge32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "iso", "ModuleIdentity", "mib-2", "NotificationType", "Bits", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Integer32", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, mwg=mwg, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stMimeType=stMimeType, notifyAdditional=notifyAdditional, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, trApplication=trApplication, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo)
