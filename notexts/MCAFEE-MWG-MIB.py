...
TimeTicks, mib_2, Unsigned32, enterprises, Integer32, Counter64, IpAddress, NotificationType, MibIdentifier, ObjectIdentity, Counter32, iso, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "Unsigned32", "enterprises", "Integer32", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "iso", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, trApplication=trApplication, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, trUser=trUser, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, kCompanyName=kCompanyName, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stBadReputation=stBadReputation, notifyReason=notifyReason, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stConnectedSockets=stConnectedSockets, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, mwg=mwg, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity)
