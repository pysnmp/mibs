...
Counter32, ModuleIdentity, Integer32, IpAddress, NotificationType, iso, Bits, MibIdentifier, Unsigned32, enterprises, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "NotificationType", "iso", "Bits", "MibIdentifier", "Unsigned32", "enterprises", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, kProductVersion=kProductVersion, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, kProductName=kProductName, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
