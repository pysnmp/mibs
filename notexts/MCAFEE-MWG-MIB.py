...
Integer32, Unsigned32, Gauge32, enterprises, iso, mib_2, Bits, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, TimeTicks, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "enterprises", "iso", "mib-2", "Bits", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, mwgFTP=mwgFTP, kRevision=kRevision, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber)
