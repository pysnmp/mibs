...
mib_2, MibIdentifier, ModuleIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, IpAddress, NotificationType, Bits, Unsigned32, TimeTicks, Integer32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "IpAddress", "NotificationType", "Bits", "Unsigned32", "TimeTicks", "Integer32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, stCategories=stCategories, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber)
