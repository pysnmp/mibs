...
ModuleIdentity, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter64, IpAddress, ObjectIdentity, enterprises, iso, MibIdentifier, Gauge32, Counter32, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "enterprises", "iso", "MibIdentifier", "Gauge32", "Counter32", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, kMajorVersion=kMajorVersion, stClientCount=stClientCount, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, trSystem=trSystem, trUser=trUser, mwgFTP=mwgFTP, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, kHotfixVersion=kHotfixVersion, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS)
