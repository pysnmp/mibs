...
TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, ModuleIdentity, iso, NotificationType, MibIdentifier, Counter64, NotificationType, Counter32, mib_2, enterprises, IpAddress, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "iso", "NotificationType", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "mib-2", "enterprises", "IpAddress", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, trApplication=trApplication, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, notifyReason=notifyReason, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, stCategories=stCategories, stConnectedSockets=stConnectedSockets, stCPULoadRaw=stCPULoadRaw, notifyReasonString=notifyReasonString, kRevision=kRevision, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryName=stCategoryName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, trUser=trUser, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, trSystem=trSystem, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed)
