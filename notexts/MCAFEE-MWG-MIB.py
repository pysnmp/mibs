...
Unsigned32, NotificationType, Integer32, enterprises, Gauge32, iso, IpAddress, MibIdentifier, mib_2, Counter32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Integer32", "enterprises", "Gauge32", "iso", "IpAddress", "MibIdentifier", "mib-2", "Counter32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, stMemConsumed=stMemConsumed, kProductName=kProductName, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, trUser=trUser, kRevision=kRevision, notifySeverity=notifySeverity)
