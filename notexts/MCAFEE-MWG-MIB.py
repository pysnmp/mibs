...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, enterprises, NotificationType, Integer32, Counter64, mib_2, Unsigned32, Counter32, NotificationType, IpAddress, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "enterprises", "NotificationType", "Integer32", "Counter64", "mib-2", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "Bits", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, notifyOriginName=notifyOriginName, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, notifyReason=notifyReason, stCPULoad=stCPULoad, mwgTraps=mwgTraps, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, kProductName=kProductName, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, trUser=trUser, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion)
