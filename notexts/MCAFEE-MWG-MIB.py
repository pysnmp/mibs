...
Unsigned32, Integer32, iso, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Counter64, mib_2, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "iso", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Counter64", "mib-2", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, mwg=mwg, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, kProductName=kProductName, kRevision=kRevision, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, trSystem=trSystem, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg)
