...
Gauge32, IpAddress, NotificationType, TimeTicks, MibIdentifier, mib_2, Integer32, Unsigned32, ModuleIdentity, Counter32, enterprises, ObjectIdentity, NotificationType, Bits, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "NotificationType", "TimeTicks", "MibIdentifier", "mib-2", "Integer32", "Unsigned32", "ModuleIdentity", "Counter32", "enterprises", "ObjectIdentity", "NotificationType", "Bits", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, stBadReputation=stBadReputation, stMemConsumed=stMemConsumed, trSystem=trSystem, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoad=stCPULoad, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion)
