...
mib_2, ObjectIdentity, iso, IpAddress, Integer32, ModuleIdentity, MibIdentifier, TimeTicks, Bits, Counter64, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "iso", "IpAddress", "Integer32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "Counter64", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, mwgHttp=mwgHttp, trUser=trUser, kCompanyName=kCompanyName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion)
