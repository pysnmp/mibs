...
enterprises, Gauge32, Counter64, Unsigned32, NotificationType, Bits, IpAddress, ObjectIdentity, MibIdentifier, NotificationType, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter64", "Unsigned32", "NotificationType", "Bits", "IpAddress", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "mib-2", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, notifySeverity=notifySeverity, stCategories=stCategories, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware)
