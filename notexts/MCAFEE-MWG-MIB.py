...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, mib_2, MibIdentifier, Integer32, Unsigned32, enterprises, Counter32, TimeTicks, NotificationType, ObjectIdentity, ModuleIdentity, Bits, Counter64, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "mib-2", "MibIdentifier", "Integer32", "Unsigned32", "enterprises", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter64", "IpAddress", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, stCategories=stCategories, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, trSystem=trSystem, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, trApplication=trApplication, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, stFtpTraffic=stFtpTraffic, kRevision=kRevision, kProductName=kProductName, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, mwg=mwg, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, trUser=trUser, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, kCompanyName=kCompanyName, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer)
