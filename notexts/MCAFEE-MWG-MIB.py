...
iso, ObjectIdentity, TimeTicks, MibIdentifier, enterprises, Gauge32, IpAddress, Integer32, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, mib_2, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "enterprises", "Gauge32", "IpAddress", "Integer32", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "mib-2", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, trUser=trUser, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, stHttpsRequests=stHttpsRequests, kRevision=kRevision, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, stCategories=stCategories, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, kProductVersion=kProductVersion, mwg=mwg, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stMemConsumed=stMemConsumed)
