...
IpAddress, NotificationType, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Gauge32, enterprises, iso, Bits, TimeTicks, mib_2, ModuleIdentity, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Gauge32", "enterprises", "iso", "Bits", "TimeTicks", "mib-2", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stCPUIOWait=stCPUIOWait, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, stMimeType=stMimeType, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, stClientCount=stClientCount, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic)
