...
Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, iso, Gauge32, enterprises, NotificationType, Bits, Unsigned32, ModuleIdentity, TimeTicks, IpAddress, Counter32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "iso", "Gauge32", "enterprises", "NotificationType", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, mwg=mwg, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, kRevision=kRevision, trUser=trUser, kMicroVersion=kMicroVersion, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, trSystem=trSystem, notifyReason=notifyReason, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
