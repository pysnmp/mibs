...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, Counter32, IpAddress, NotificationType, MibIdentifier, enterprises, iso, ObjectIdentity, ModuleIdentity, Unsigned32, Bits, Gauge32, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "enterprises", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Bits", "Gauge32", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, kRevision=kRevision, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, kProductVersion=kProductVersion, trUser=trUser, trSystem=trSystem, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient)
