...
Unsigned32, iso, ModuleIdentity, MibIdentifier, Counter64, Gauge32, Counter32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, mib_2, IpAddress, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "mib-2", "IpAddress", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, kProductVersion=kProductVersion, mwgFTP=mwgFTP, notifyReason=notifyReason, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, mwg=mwg, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, kBuildNumber=kBuildNumber, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, trUser=trUser, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, kProductName=kProductName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion)
