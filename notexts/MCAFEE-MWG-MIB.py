...
Integer32, Gauge32, mib_2, ModuleIdentity, Unsigned32, NotificationType, Bits, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises, iso, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "mib-2", "ModuleIdentity", "Unsigned32", "NotificationType", "Bits", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises", "iso", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, trUser=trUser, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, notifyReason=notifyReason, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient)
