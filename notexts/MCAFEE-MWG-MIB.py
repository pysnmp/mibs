...
Gauge32, mib_2, ObjectIdentity, Integer32, enterprises, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Bits, TimeTicks, IpAddress, Unsigned32, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "ObjectIdentity", "Integer32", "enterprises", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Bits", "TimeTicks", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, trApplication=trApplication, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName)
