...
ObjectIdentity, TimeTicks, MibIdentifier, Gauge32, iso, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, NotificationType, Bits, mib_2, Counter32, Integer32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Gauge32", "iso", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "NotificationType", "Bits", "mib-2", "Counter32", "Integer32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, mwg=mwg, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, trUser=trUser, stClientCount=stClientCount, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional)
