...
IpAddress, Integer32, Counter32, NotificationType, Gauge32, ObjectIdentity, Counter64, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, enterprises, iso, MibIdentifier, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "enterprises", "iso", "MibIdentifier", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stClientCount=stClientCount, trUser=trUser, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stCPULoad=stCPULoad, stCategoryName=stCategoryName, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, mwg=mwg, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, mwgHttps=mwgHttps, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, kRevision=kRevision, notifySeverity=notifySeverity, stMimeType=stMimeType)
