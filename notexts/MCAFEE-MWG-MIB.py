...
iso, enterprises, ObjectIdentity, Counter64, Integer32, MibIdentifier, NotificationType, Counter32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Unsigned32, mib_2, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "ObjectIdentity", "Counter64", "Integer32", "MibIdentifier", "NotificationType", "Counter32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Unsigned32", "mib-2", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, trSystem=trSystem, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stCategories=stCategories, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, notifyReason=notifyReason, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient)
