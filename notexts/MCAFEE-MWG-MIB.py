...
IpAddress, mib_2, enterprises, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, iso, Bits, Integer32, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "mib-2", "enterprises", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "iso", "Bits", "Integer32", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, stCategories=stCategories, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, trApplication=trApplication, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, mwg=mwg, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, trUser=trUser, kProductVersion=kProductVersion, kProductName=kProductName, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS)
