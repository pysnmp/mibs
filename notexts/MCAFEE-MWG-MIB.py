...
ModuleIdentity, enterprises, IpAddress, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks, Gauge32, NotificationType, Integer32, Unsigned32, Counter32, Counter64, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "IpAddress", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "NotificationType", "Integer32", "Unsigned32", "Counter32", "Counter64", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trUser=trUser, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, kHotfixVersion=kHotfixVersion, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer)
