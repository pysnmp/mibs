...
mib_2, NotificationType, IpAddress, Counter64, Counter32, NotificationType, iso, MibIdentifier, Integer32, TimeTicks, ObjectIdentity, Bits, ModuleIdentity, Gauge32, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "IpAddress", "Counter64", "Counter32", "NotificationType", "iso", "MibIdentifier", "Integer32", "TimeTicks", "ObjectIdentity", "Bits", "ModuleIdentity", "Gauge32", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, trUser=trUser, kCustomVersion=kCustomVersion, mwgContent=mwgContent, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, kProductName=kProductName, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReasonString=notifyReasonString, stCategories=stCategories, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, kProductVersion=kProductVersion, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
