...
Integer32, ModuleIdentity, Counter64, Bits, mib_2, NotificationType, iso, TimeTicks, NotificationType, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, enterprises, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter64", "Bits", "mib-2", "NotificationType", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "enterprises", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, trApplication=trApplication, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, kRevision=kRevision, stMalwareDetected=stMalwareDetected, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets)
