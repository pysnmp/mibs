...
Bits, TimeTicks, Unsigned32, Counter64, mib_2, NotificationType, Integer32, MibIdentifier, Gauge32, ModuleIdentity, IpAddress, Counter32, iso, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "Counter64", "mib-2", "NotificationType", "Integer32", "MibIdentifier", "Gauge32", "ModuleIdentity", "IpAddress", "Counter32", "iso", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, stHttpBytesFromServer=stHttpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, mwgTraps=mwgTraps, stCategories=stCategories, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, mwg=mwg, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stMimeType=stMimeType, notifySeverity=notifySeverity, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, trUser=trUser, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin)
