...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso, Integer32, ObjectIdentity, MibIdentifier, Counter64, Unsigned32, NotificationType, enterprises, Bits, IpAddress, mib_2, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "enterprises", "Bits", "IpAddress", "mib-2", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReason=notifyReason, notifySeverity=notifySeverity, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, trSystem=trSystem, kMinorVersion=kMinorVersion, trApplication=trApplication, notifyAdditional=notifyAdditional, stClientCount=stClientCount, kProductName=kProductName, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision)
