...
iso, Counter32, Counter64, mib_2, enterprises, TimeTicks, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, Bits, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Counter64", "mib-2", "enterprises", "TimeTicks", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, trUser=trUser, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, trSystem=trSystem, kRevision=kRevision, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, mwgContent=mwgContent, stMemConsumed=stMemConsumed, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stCategories=stCategories, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests)
