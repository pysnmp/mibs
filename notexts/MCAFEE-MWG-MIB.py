...
ModuleIdentity, iso, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, Bits, IpAddress, enterprises, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "Bits", "IpAddress", "enterprises", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stClientCount=stClientCount, kProductVersion=kProductVersion, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, trUser=trUser, kProductName=kProductName, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, mwgContent=mwgContent, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason)
