...
Unsigned32, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, IpAddress, iso, Bits, Counter64, NotificationType, Gauge32, ModuleIdentity, enterprises, NotificationType, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "IpAddress", "iso", "Bits", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "enterprises", "NotificationType", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stHttpTraffic=stHttpTraffic, mwg=mwg, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, notifyReason=notifyReason, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, mwgFTP=mwgFTP, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, trUser=trUser, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, mwgContent=mwgContent)
