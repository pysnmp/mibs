...
NotificationType, ModuleIdentity, ObjectIdentity, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Unsigned32, Counter32, NotificationType, IpAddress, mib_2, enterprises, Gauge32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "mib-2", "enterprises", "Gauge32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, mwgContent=mwgContent, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, stCategories=stCategories, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, kProductName=kProductName, notifyOrigin=notifyOrigin, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed)
