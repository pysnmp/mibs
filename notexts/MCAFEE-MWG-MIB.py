...
NotificationType, enterprises, mib_2, TimeTicks, Integer32, Unsigned32, Bits, MibIdentifier, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ObjectIdentity, Counter32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "mib-2", "TimeTicks", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ObjectIdentity", "Counter32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, stHttpRequests=stHttpRequests, trSystem=trSystem, kMajorVersion=kMajorVersion, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, stMimeType=stMimeType, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, mwg=mwg, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent)
