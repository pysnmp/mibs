...
Unsigned32, Bits, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, TimeTicks, Counter64, MibIdentifier, IpAddress, iso, ObjectIdentity, Integer32, ModuleIdentity, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "TimeTicks", "Counter64", "MibIdentifier", "IpAddress", "iso", "ObjectIdentity", "Integer32", "ModuleIdentity", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, stMimeType=stMimeType, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, kRevision=kRevision, kMajorVersion=kMajorVersion, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, trSystem=trSystem, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName)
