...
Counter32, iso, Bits, ObjectIdentity, Counter64, enterprises, Unsigned32, Gauge32, Integer32, MibIdentifier, NotificationType, NotificationType, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Bits", "ObjectIdentity", "Counter64", "enterprises", "Unsigned32", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "NotificationType", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stBadReputation=stBadReputation, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwg=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, mwgFTP=mwgFTP, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, mwgInfo=mwgInfo, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, kRevision=kRevision, stHttpsRequests=stHttpsRequests, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, trSystem=trSystem, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, stCategories=stCategories, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
