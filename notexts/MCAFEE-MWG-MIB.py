...
iso, IpAddress, NotificationType, Gauge32, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ModuleIdentity, TimeTicks, Counter64, Bits, Unsigned32, enterprises, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Gauge32", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter64", "Bits", "Unsigned32", "enterprises", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, stCategories=stCategories, trSystem=trSystem, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, stClientCount=stClientCount, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, kRevision=kRevision, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion)
