...
TimeTicks, NotificationType, mib_2, Integer32, Bits, MibIdentifier, Gauge32, enterprises, IpAddress, ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "mib-2", "Integer32", "Bits", "MibIdentifier", "Gauge32", "enterprises", "IpAddress", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stClientCount=stClientCount, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, mwgContent=mwgContent, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, kRevision=kRevision, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, stCPUIOWait=stCPUIOWait, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous)
