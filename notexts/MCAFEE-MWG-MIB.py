...
MibIdentifier, enterprises, Gauge32, Integer32, mib_2, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, TimeTicks, NotificationType, Unsigned32, NotificationType, Counter64, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Gauge32", "Integer32", "mib-2", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32", "NotificationType", "Counter64", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, kMinorVersion=kMinorVersion, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, mwg=mwg, kProductVersion=kProductVersion, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stCategories=stCategories, stHttpsRequests=stHttpsRequests, trSystem=trSystem, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, kRevision=kRevision, mwgStatistics=mwgStatistics, trUser=trUser, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, kProductName=kProductName, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
