...
ModuleIdentity, ObjectIdentity, Integer32, mib_2, MibIdentifier, TimeTicks, Counter64, Unsigned32, Counter32, Gauge32, NotificationType, enterprises, iso, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Integer32", "mib-2", "MibIdentifier", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "enterprises", "iso", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stCategories=stCategories, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, trUser=trUser, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stMimeType=stMimeType, kProductName=kProductName, kBuildNumber=kBuildNumber, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount)
