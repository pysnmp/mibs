...
enterprises, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, Counter64, ObjectIdentity, ModuleIdentity, Counter32, TimeTicks, NotificationType, IpAddress, Unsigned32, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "Counter32", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, kRevision=kRevision, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, mwgContent=mwgContent, stCategories=stCategories, stCPULoad=stCPULoad, stClientCount=stClientCount, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed)
