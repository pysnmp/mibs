...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter64, MibIdentifier, ObjectIdentity, enterprises, Gauge32, NotificationType, ModuleIdentity, NotificationType, iso, Bits, Integer32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity", "enterprises", "Gauge32", "NotificationType", "ModuleIdentity", "NotificationType", "iso", "Bits", "Integer32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, trSystem=trSystem, stMemConsumed=stMemConsumed, mwg=mwg, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, mwgContent=mwgContent, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, stCategories=stCategories, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, pMFEDATVersion=pMFEDATVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer)
