...
Integer32, Unsigned32, enterprises, mib_2, TimeTicks, NotificationType, NotificationType, ModuleIdentity, IpAddress, Counter32, iso, ObjectIdentity, Gauge32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "enterprises", "mib-2", "TimeTicks", "NotificationType", "NotificationType", "ModuleIdentity", "IpAddress", "Counter32", "iso", "ObjectIdentity", "Gauge32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, trApplication=trApplication, kMicroVersion=kMicroVersion, stCategories=stCategories, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesEntry=stCategoriesEntry, stMemConsumed=stMemConsumed, pAMEngineVersion=pAMEngineVersion, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, trUser=trUser, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion)
