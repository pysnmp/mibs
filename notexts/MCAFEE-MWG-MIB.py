...
ModuleIdentity, mib_2, TimeTicks, enterprises, ObjectIdentity, Counter32, Bits, Unsigned32, NotificationType, IpAddress, MibIdentifier, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "TimeTicks", "enterprises", "ObjectIdentity", "Counter32", "Bits", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stCategories=stCategories, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, stMimeType=stMimeType, kMinorVersion=kMinorVersion, mwg=mwg, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests)
