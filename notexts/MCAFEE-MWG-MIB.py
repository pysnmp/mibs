...
Unsigned32, NotificationType, ModuleIdentity, Counter64, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, ObjectIdentity, IpAddress, Bits, iso, Counter32, Integer32, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter64", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "ObjectIdentity", "IpAddress", "Bits", "iso", "Counter32", "Integer32", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, trSystem=trSystem, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, stClientCount=stClientCount, trUser=trUser, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, kMajorVersion=kMajorVersion, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous)
