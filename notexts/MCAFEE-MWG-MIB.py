...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, IpAddress, ModuleIdentity, Counter64, NotificationType, NotificationType, Bits, Integer32, TimeTicks, ObjectIdentity, MibIdentifier, iso, enterprises, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "NotificationType", "NotificationType", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, mwg=mwg, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, mwgInfo=mwgInfo, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, trApplication=trApplication, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kMinorVersion=kMinorVersion, pAMSignatureVersion=pAMSignatureVersion)
