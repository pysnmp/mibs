...
Unsigned32, mib_2, Gauge32, enterprises, NotificationType, Bits, iso, NotificationType, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "Gauge32", "enterprises", "NotificationType", "Bits", "iso", "NotificationType", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, trApplication=trApplication, kBuildNumber=kBuildNumber, trUser=trUser, mwgHttps=mwgHttps, mwgContent=mwgContent, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, stCategories=stCategories, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, stClientCount=stClientCount, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic)
