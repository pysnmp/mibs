...
ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, Gauge32, iso, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, Bits, Unsigned32, Integer32, enterprises, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "Gauge32", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "Integer32", "enterprises", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, mwg=mwg, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, kRevision=kRevision, notifyOrigin=notifyOrigin, stClientCount=stClientCount, notifyAdditional=notifyAdditional, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, trSystem=trSystem, trUser=trUser, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, trApplication=trApplication, kProductName=kProductName, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, mwgFTP=mwgFTP, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stMimeType=stMimeType)
