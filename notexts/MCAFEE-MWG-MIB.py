...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, TimeTicks, IpAddress, enterprises, Gauge32, ModuleIdentity, Unsigned32, Integer32, ObjectIdentity, Counter64, mib_2, NotificationType, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "TimeTicks", "IpAddress", "enterprises", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "ObjectIdentity", "Counter64", "mib-2", "NotificationType", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, stMimeType=stMimeType, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stCategories=stCategories, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, mwg=mwg, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity)
