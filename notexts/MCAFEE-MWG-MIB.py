...
NotificationType, ModuleIdentity, Integer32, NotificationType, enterprises, IpAddress, iso, Unsigned32, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter32, MibIdentifier, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "NotificationType", "enterprises", "IpAddress", "iso", "Unsigned32", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter32", "MibIdentifier", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, mwg=mwg, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stMimeType=stMimeType, stBadReputation=stBadReputation, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, trSystem=trSystem, mwgInfo=mwgInfo, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stCategoryName=stCategoryName, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, notifySeverity=notifySeverity, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, kRevision=kRevision, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, mwgFTP=mwgFTP, mwgTraps=mwgTraps, kProductName=kProductName, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString)
