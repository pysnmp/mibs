...
IpAddress, NotificationType, Counter32, iso, NotificationType, Bits, MibIdentifier, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, mib_2, ObjectIdentity, enterprises, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Counter32", "iso", "NotificationType", "Bits", "MibIdentifier", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "mib-2", "ObjectIdentity", "enterprises", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, stClientCount=stClientCount, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, kRevision=kRevision, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, trSystem=trSystem, stBadReputation=stBadReputation, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, mwgHttp=mwgHttp, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter)
