...
Counter64, ModuleIdentity, IpAddress, NotificationType, iso, mib_2, TimeTicks, Integer32, Bits, enterprises, MibIdentifier, NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "iso", "mib-2", "TimeTicks", "Integer32", "Bits", "enterprises", "MibIdentifier", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, stCategories=stCategories, kCustomVersion=kCustomVersion, kRevision=kRevision, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, trApplication=trApplication, kBuildNumber=kBuildNumber, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, stClientCount=stClientCount, mwgInfo=mwgInfo, mwgFTP=mwgFTP, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stHandleConnectToServer=stHandleConnectToServer)
