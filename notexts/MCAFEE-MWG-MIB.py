...
Counter64, TimeTicks, Integer32, IpAddress, mib_2, enterprises, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, iso, MibIdentifier, Counter32, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Integer32", "IpAddress", "mib-2", "enterprises", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "iso", "MibIdentifier", "Counter32", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, trUser=trUser, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, stClientCount=stClientCount, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, kProductName=kProductName, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stBadReputation=stBadReputation, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, mwg=mwg, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer)
