...
enterprises, MibIdentifier, NotificationType, mib_2, NotificationType, iso, Unsigned32, ObjectIdentity, Gauge32, Counter64, Integer32, Counter32, Bits, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "NotificationType", "mib-2", "NotificationType", "iso", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "Integer32", "Counter32", "Bits", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, trApplication=trApplication, kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, stCategories=stCategories, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion)
