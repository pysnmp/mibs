...
enterprises, TimeTicks, NotificationType, Integer32, Counter32, ModuleIdentity, Counter64, mib_2, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, iso, MibIdentifier, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "Integer32", "Counter32", "ModuleIdentity", "Counter64", "mib-2", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "iso", "MibIdentifier", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, trUser=trUser, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, notifyOriginName=notifyOriginName, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, stHttpTraffic=stHttpTraffic, trSystem=trSystem, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry)
