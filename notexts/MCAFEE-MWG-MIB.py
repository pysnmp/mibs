...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, Unsigned32, mib_2, NotificationType, enterprises, NotificationType, Bits, MibIdentifier, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "Unsigned32", "mib-2", "NotificationType", "enterprises", "NotificationType", "Bits", "MibIdentifier", "Integer32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, trUser=trUser, trSystem=trSystem, mwgHttps=mwgHttps, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, kMinorVersion=kMinorVersion, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, mwgInfo=mwgInfo, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, kCompanyName=kCompanyName)
