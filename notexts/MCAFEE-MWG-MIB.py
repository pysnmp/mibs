...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, TimeTicks, Integer32, ObjectIdentity, ModuleIdentity, iso, enterprises, Gauge32, MibIdentifier, IpAddress, Unsigned32, Bits, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "TimeTicks", "Integer32", "ObjectIdentity", "ModuleIdentity", "iso", "enterprises", "Gauge32", "MibIdentifier", "IpAddress", "Unsigned32", "Bits", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, kProductName=kProductName, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stMimeType=stMimeType, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMEngineVersion=pAMEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, trApplication=trApplication, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion)
