...
Integer32, Gauge32, TimeTicks, Counter32, mib_2, Bits, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, NotificationType, iso, Unsigned32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "TimeTicks", "Counter32", "mib-2", "Bits", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, trUser=trUser, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, stClientCount=stClientCount, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, mwgFTP=mwgFTP, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion)
