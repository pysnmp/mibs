...
iso, ModuleIdentity, Counter64, NotificationType, Unsigned32, mib_2, Counter32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ObjectIdentity, MibIdentifier, enterprises, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter64", "NotificationType", "Unsigned32", "mib-2", "Counter32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, trApplication=trApplication, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, mwgHttp=mwgHttp, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, kRevision=kRevision, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, mwg=mwg, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer)
