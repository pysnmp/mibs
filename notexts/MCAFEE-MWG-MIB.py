...
Bits, Integer32, MibIdentifier, Unsigned32, ModuleIdentity, Counter64, NotificationType, NotificationType, enterprises, Gauge32, iso, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "NotificationType", "enterprises", "Gauge32", "iso", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, trUser=trUser, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stCategoryCount=stCategoryCount, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, stCategories=stCategories, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, kRevision=kRevision, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem)
