...
iso, IpAddress, Counter64, Integer32, mib_2, Unsigned32, Bits, Gauge32, ObjectIdentity, enterprises, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter64", "Integer32", "mib-2", "Unsigned32", "Bits", "Gauge32", "ObjectIdentity", "enterprises", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stHttpRequests=stHttpRequests, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stCategoryName=stCategoryName, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, notifyOrigin=notifyOrigin)
