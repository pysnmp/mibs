...
iso, Unsigned32, IpAddress, Bits, Integer32, NotificationType, TimeTicks, enterprises, Counter32, MibIdentifier, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "IpAddress", "Bits", "Integer32", "NotificationType", "TimeTicks", "enterprises", "Counter32", "MibIdentifier", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, mwg=mwg, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, mwgTraps=mwgTraps, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, kProductName=kProductName, trApplication=trApplication, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoad=stCPULoad, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, mwgFTP=mwgFTP, kRevision=kRevision, kMinorVersion=kMinorVersion, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, stClientCount=stClientCount, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, mwgStatistics=mwgStatistics, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer)
