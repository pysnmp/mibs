...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, IpAddress, NotificationType, Bits, Integer32, Gauge32, ModuleIdentity, NotificationType, ObjectIdentity, TimeTicks, MibIdentifier, enterprises, iso, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "IpAddress", "NotificationType", "Bits", "Integer32", "Gauge32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "TimeTicks", "MibIdentifier", "enterprises", "iso", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, trUser=trUser, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, trApplication=trApplication, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount)
