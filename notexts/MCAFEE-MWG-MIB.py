...
ModuleIdentity, mib_2, iso, Unsigned32, Counter32, ObjectIdentity, Integer32, MibIdentifier, Bits, enterprises, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "iso", "Unsigned32", "Counter32", "ObjectIdentity", "Integer32", "MibIdentifier", "Bits", "enterprises", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, kRevision=kRevision, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, mwg=mwg, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stCategories=stCategories, notifySeverity=notifySeverity, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic)
