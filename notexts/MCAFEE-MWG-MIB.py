...
mib_2, Integer32, Unsigned32, iso, TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, NotificationType, ModuleIdentity, Bits, Counter32, Counter64, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "Unsigned32", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "NotificationType", "ModuleIdentity", "Bits", "Counter32", "Counter64", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, stClientCount=stClientCount, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAffectedHost=notifyAffectedHost, stHttpsTraffic=stHttpsTraffic, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, mwg=mwg, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation)
