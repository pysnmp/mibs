...
Counter32, NotificationType, ModuleIdentity, Gauge32, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, ObjectIdentity, MibIdentifier, Unsigned32, enterprises, Integer32, Counter64, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "Gauge32", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "ObjectIdentity", "MibIdentifier", "Unsigned32", "enterprises", "Integer32", "Counter64", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stCategoryName=stCategoryName, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, mwgContent=mwgContent, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, notifyReason=notifyReason, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, stCPULoad=stCPULoad, kRevision=kRevision, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
