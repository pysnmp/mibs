...
NotificationType, NotificationType, Counter32, Counter64, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Bits, Gauge32, enterprises, iso, Integer32, ModuleIdentity, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Counter32", "Counter64", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Bits", "Gauge32", "enterprises", "iso", "Integer32", "ModuleIdentity", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, kRevision=kRevision, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, mwg=mwg, stHttpRequests=stHttpRequests, trSystem=trSystem, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, trUser=trUser, notifyOriginName=notifyOriginName, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, mwgTrapVariables=mwgTrapVariables, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, kProductVersion=kProductVersion)
