...
Counter64, NotificationType, iso, NotificationType, Unsigned32, Integer32, Counter32, Bits, ModuleIdentity, TimeTicks, IpAddress, mib_2, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "NotificationType", "Unsigned32", "Integer32", "Counter32", "Bits", "ModuleIdentity", "TimeTicks", "IpAddress", "mib-2", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, kRevision=kRevision, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, trUser=trUser, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, pAMSignatureVersion=pAMSignatureVersion)
