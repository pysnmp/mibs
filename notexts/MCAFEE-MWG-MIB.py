...
IpAddress, Unsigned32, TimeTicks, Bits, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, NotificationType, Integer32, Gauge32, ModuleIdentity, Counter64, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "NotificationType", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion)
