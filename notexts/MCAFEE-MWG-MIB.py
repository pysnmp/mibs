...
ModuleIdentity, Bits, Counter64, Unsigned32, NotificationType, Counter32, TimeTicks, mib_2, NotificationType, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter64", "Unsigned32", "NotificationType", "Counter32", "TimeTicks", "mib-2", "NotificationType", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectedSockets=stConnectedSockets, trUser=trUser, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stClientCount=stClientCount, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, kProductName=kProductName, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName)
