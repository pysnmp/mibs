...
ModuleIdentity, iso, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, mib_2, Bits, TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "mib-2", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, notifyReason=notifyReason, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, mwg=mwg, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stCategories=stCategories, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, stCPULoad=stCPULoad, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, pAMSignatureVersion=pAMSignatureVersion)
