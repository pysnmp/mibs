...
ObjectIdentity, NotificationType, MibIdentifier, mib_2, TimeTicks, Integer32, Counter32, Unsigned32, Counter64, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "MibIdentifier", "mib-2", "TimeTicks", "Integer32", "Counter32", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Bits", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, stCPULoad=stCPULoad, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgInfo=mwgInfo, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, kProductVersion=kProductVersion, stCategories=stCategories, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgContent=mwgContent, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, trApplication=trApplication, trUser=trUser, mwgTraps=mwgTraps, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber)
