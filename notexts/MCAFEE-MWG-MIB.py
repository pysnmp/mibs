...
Gauge32, ObjectIdentity, Counter32, TimeTicks, Counter64, ModuleIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, iso, MibIdentifier, Bits, NotificationType, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter32", "TimeTicks", "Counter64", "ModuleIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "iso", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, stBadReputation=stBadReputation, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, notifyReason=notifyReason, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kProductName=kProductName, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount)
