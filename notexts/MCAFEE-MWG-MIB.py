...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, mib_2, Unsigned32, enterprises, MibIdentifier, Bits, ModuleIdentity, Integer32, TimeTicks, ObjectIdentity, iso, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "mib-2", "Unsigned32", "enterprises", "MibIdentifier", "Bits", "ModuleIdentity", "Integer32", "TimeTicks", "ObjectIdentity", "iso", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, trApplication=trApplication, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stClientCount=stClientCount, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed)
