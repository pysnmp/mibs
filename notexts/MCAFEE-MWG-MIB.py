...
ModuleIdentity, enterprises, iso, Unsigned32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, mib_2, Integer32, NotificationType, Counter32, Bits, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "iso", "Unsigned32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "mib-2", "Integer32", "NotificationType", "Counter32", "Bits", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, trUser=trUser, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, trSystem=trSystem, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, mwgContent=mwgContent)
