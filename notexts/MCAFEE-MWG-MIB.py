...
Unsigned32, Gauge32, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, mib_2, Counter32, enterprises, Counter64, Bits, iso, NotificationType, NotificationType, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "mib-2", "Counter32", "enterprises", "Counter64", "Bits", "iso", "NotificationType", "NotificationType", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpTraffic=stHttpTraffic, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, kProductName=kProductName, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, trUser=trUser, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, mwg=mwg, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stCategoryName=stCategoryName)
