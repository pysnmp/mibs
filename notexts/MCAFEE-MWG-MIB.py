...
mib_2, enterprises, MibIdentifier, Counter64, IpAddress, Gauge32, Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, TimeTicks, iso, Integer32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "MibIdentifier", "Counter64", "IpAddress", "Gauge32", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Integer32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, notifyOriginName=notifyOriginName, notifyReason=notifyReason, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToServer=stHttpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPUIOWait=stCPUIOWait, trUser=trUser, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductName=kProductName, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, kMajorVersion=kMajorVersion, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion)
