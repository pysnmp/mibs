...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Bits, IpAddress, NotificationType, iso, NotificationType, Counter64, MibIdentifier, ModuleIdentity, TimeTicks, enterprises, Integer32, mib_2, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Bits", "IpAddress", "NotificationType", "iso", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity", "TimeTicks", "enterprises", "Integer32", "mib-2", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, mwgTraps=mwgTraps, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, kRevision=kRevision, mwgContent=mwgContent, kCompanyName=kCompanyName, stCategories=stCategories, mwgHttps=mwgHttps, stClientCount=stClientCount, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, trApplication=trApplication, kCustomVersion=kCustomVersion, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, kBuildNumber=kBuildNumber, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests)
