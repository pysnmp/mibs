...
Gauge32, MibIdentifier, Unsigned32, enterprises, Counter64, Integer32, mib_2, iso, TimeTicks, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Unsigned32", "enterprises", "Counter64", "Integer32", "mib-2", "iso", "TimeTicks", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, notifyReason=notifyReason, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName)
