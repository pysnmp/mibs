...
Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, ModuleIdentity, Bits, Counter64, Gauge32, iso, TimeTicks, ObjectIdentity, Counter32, NotificationType, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "Gauge32", "iso", "TimeTicks", "ObjectIdentity", "Counter32", "NotificationType", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, kRevision=kRevision, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, trSystem=trSystem, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, mwg=mwg, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity)
