...
NotificationType, mib_2, enterprises, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, Bits, TimeTicks, Integer32, ModuleIdentity, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "enterprises", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, mwg=mwg, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stCategories=stCategories, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, trSystem=trSystem, trUser=trUser, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer)
