...
NotificationType, IpAddress, Unsigned32, enterprises, NotificationType, iso, Gauge32, ModuleIdentity, Counter32, Counter64, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Unsigned32", "enterprises", "NotificationType", "iso", "Gauge32", "ModuleIdentity", "Counter32", "Counter64", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, mwgHttp=mwgHttp, notifyReason=notifyReason, stBadReputation=stBadReputation, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stCategoryCount=stCategoryCount, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, kMajorVersion=kMajorVersion)
