...
TimeTicks, enterprises, mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Bits, ModuleIdentity, Integer32, Gauge32, NotificationType, IpAddress, NotificationType, ObjectIdentity, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Bits", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "IpAddress", "NotificationType", "ObjectIdentity", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, trUser=trUser, mwg=mwg, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, stClientCount=stClientCount, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, notifyReason=notifyReason, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, kProductVersion=kProductVersion, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, stMimeType=stMimeType, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion)
