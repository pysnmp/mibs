...
Unsigned32, ModuleIdentity, Integer32, Counter64, IpAddress, enterprises, mib_2, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, NotificationType, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Integer32", "Counter64", "IpAddress", "enterprises", "mib-2", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgFTP=mwgFTP, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, trApplication=trApplication, mwgContent=mwgContent, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, trUser=trUser, stClientCount=stClientCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked)
