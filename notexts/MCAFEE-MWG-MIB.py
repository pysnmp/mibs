...
Integer32, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, MibIdentifier, iso, TimeTicks, Gauge32, ModuleIdentity, NotificationType, enterprises, Bits, Unsigned32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "MibIdentifier", "iso", "TimeTicks", "Gauge32", "ModuleIdentity", "NotificationType", "enterprises", "Bits", "Unsigned32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsTraffic=stHttpsTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, kRevision=kRevision, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, mwgContent=mwgContent, kProductVersion=kProductVersion, notifyReason=notifyReason, mwg=mwg, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stMimeType=stMimeType, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer)
