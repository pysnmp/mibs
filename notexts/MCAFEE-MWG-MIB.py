...
iso, Bits, Integer32, MibIdentifier, TimeTicks, ModuleIdentity, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Counter64, NotificationType, NotificationType, ObjectIdentity, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Counter64", "NotificationType", "NotificationType", "ObjectIdentity", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stCategories=stCategories, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, mwg=mwg, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, kProductName=kProductName, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stMimeType=stMimeType, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kRevision=kRevision, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps)
