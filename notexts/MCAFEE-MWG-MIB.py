...
NotificationType, Integer32, MibIdentifier, Gauge32, Counter32, Unsigned32, mib_2, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, enterprises, TimeTicks, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibIdentifier", "Gauge32", "Counter32", "Unsigned32", "mib-2", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "enterprises", "TimeTicks", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, kProductName=kProductName, notifyOrigin=notifyOrigin, stCategories=stCategories, notifyReason=notifyReason, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stMimeType=stMimeType, stClientCount=stClientCount, stCPULoad=stCPULoad, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, stMemConsumed=stMemConsumed, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stHttpRequests=stHttpRequests, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, mwgTraps=mwgTraps, stCategoryName=stCategoryName, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic)
