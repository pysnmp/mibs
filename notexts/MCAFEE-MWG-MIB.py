...
IpAddress, Unsigned32, mib_2, Gauge32, NotificationType, TimeTicks, Counter32, Counter64, NotificationType, Integer32, Bits, ModuleIdentity, MibIdentifier, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "mib-2", "Gauge32", "NotificationType", "TimeTicks", "Counter32", "Counter64", "NotificationType", "Integer32", "Bits", "ModuleIdentity", "MibIdentifier", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, trApplication=trApplication, notifyReason=notifyReason, trUser=trUser, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, kRevision=kRevision, trSystem=trSystem, kMinorVersion=kMinorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic)
