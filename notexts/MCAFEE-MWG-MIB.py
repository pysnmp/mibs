...
ModuleIdentity, IpAddress, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, iso, Counter64, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "iso", "Counter64", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, mwg=mwg, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, stBadReputation=stBadReputation, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, kBuildNumber=kBuildNumber, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stCategoriesTable=stCategoriesTable, kCompanyName=kCompanyName, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, notifySeverity=notifySeverity, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stMimeType=stMimeType)
