...
MibIdentifier, ObjectIdentity, Counter64, NotificationType, iso, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, enterprises, Integer32, Counter32, TimeTicks, ModuleIdentity, Gauge32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Counter64", "NotificationType", "iso", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "enterprises", "Integer32", "Counter32", "TimeTicks", "ModuleIdentity", "Gauge32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, PYSNMP_MODULE_ID=mwg, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, mwg=mwg, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, stClientCount=stClientCount, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, trUser=trUser, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stCategories=stCategories, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, notifyOrigin=notifyOrigin)
