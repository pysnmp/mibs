...
Bits, NotificationType, TimeTicks, MibIdentifier, IpAddress, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32, NotificationType, Gauge32, mib_2, Counter32, enterprises, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "mib-2", "Counter32", "enterprises", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReasonString=notifyReasonString, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, stCategories=stCategories, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, mwgStatistics=mwgStatistics, trApplication=trApplication, stCategoriesTable=stCategoriesTable, trSystem=trSystem, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, notifyReason=notifyReason, notifySeverity=notifySeverity, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP)
