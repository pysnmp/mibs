...
Counter64, MibIdentifier, NotificationType, Integer32, iso, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, TimeTicks, ObjectIdentity, Unsigned32, Bits, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "NotificationType", "Integer32", "iso", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "TimeTicks", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductVersion=kProductVersion, stMimeType=stMimeType, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, kRevision=kRevision, kCompanyName=kCompanyName, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, mwg=mwg, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoad=stCPULoad, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, kBuildNumber=kBuildNumber)
