...
Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, NotificationType, enterprises, iso, TimeTicks, IpAddress, ObjectIdentity, Bits, mib_2, NotificationType, Counter64, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "NotificationType", "enterprises", "iso", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "mib-2", "NotificationType", "Counter64", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, trSystem=trSystem, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, kProductName=kProductName, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stCategories=stCategories, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, trUser=trUser, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, notifyReason=notifyReason, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion)
