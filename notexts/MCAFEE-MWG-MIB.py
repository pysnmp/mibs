...
iso, Unsigned32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, enterprises, mib_2, Integer32, Bits, MibIdentifier, NotificationType, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "enterprises", "mib-2", "Integer32", "Bits", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stClientCount=stClientCount, stCategoryName=stCategoryName, trUser=trUser, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, notifySeverity=notifySeverity, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType)
