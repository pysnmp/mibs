...
ModuleIdentity, ObjectIdentity, enterprises, Unsigned32, Gauge32, IpAddress, TimeTicks, NotificationType, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, iso, Counter64, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "Unsigned32", "Gauge32", "IpAddress", "TimeTicks", "NotificationType", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "iso", "Counter64", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, stCategoryName=stCategoryName, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, kRevision=kRevision, stMimeType=stMimeType, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stMemConsumed=stMemConsumed, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, stCategoriesTable=stCategoriesTable, trUser=trUser, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, mwgHttp=mwgHttp, mwgInfo=mwgInfo, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional)
