...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, iso, Bits, Unsigned32, mib_2, enterprises, Counter32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "iso", "Bits", "Unsigned32", "mib-2", "enterprises", "Counter32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, notifyReasonString=notifyReasonString, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, trUser=trUser, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, trApplication=trApplication, kHotfixVersion=kHotfixVersion, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, notifyReason=notifyReason, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, kProductName=kProductName, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad)
