...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Integer32, enterprises, IpAddress, MibIdentifier, NotificationType, Counter32, mib_2, NotificationType, Unsigned32, TimeTicks, Gauge32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Integer32", "enterprises", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "NotificationType", "Unsigned32", "TimeTicks", "Gauge32", "iso", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAdditional=notifyAdditional, mwg=mwg, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked)
