...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, MibIdentifier, NotificationType, Bits, Gauge32, iso, Unsigned32, TimeTicks, Counter32, Counter64, enterprises, ObjectIdentity, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "Gauge32", "iso", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "enterprises", "ObjectIdentity", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, mwg=mwg, kCompanyName=kCompanyName, stMimeType=stMimeType, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, mwgContent=mwgContent, mwgTraps=mwgTraps, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stClientCount=stClientCount, notifyOriginName=notifyOriginName, pTSDBVersion=pTSDBVersion, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, kMinorVersion=kMinorVersion, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
