...
IpAddress, ModuleIdentity, mib_2, enterprises, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ObjectIdentity, TimeTicks, NotificationType, Bits, Counter64, MibIdentifier, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "mib-2", "enterprises", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ObjectIdentity", "TimeTicks", "NotificationType", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, trSystem=trSystem, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, notifyAdditional=notifyAdditional, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, stCategoryName=stCategoryName, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, trUser=trUser, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stBadReputation=stBadReputation, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, stTimeForTransaction=stTimeForTransaction, stMemConsumed=stMemConsumed, trApplication=trApplication)
