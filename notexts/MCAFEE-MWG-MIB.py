...
MibIdentifier, NotificationType, iso, ObjectIdentity, IpAddress, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, enterprises, Counter64, Gauge32, Bits, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "enterprises", "Counter64", "Gauge32", "Bits", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate, mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stCategoryName=stCategoryName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, mwg=mwg, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stCPULoad=stCPULoad, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, notifyReason=notifyReason, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString)
