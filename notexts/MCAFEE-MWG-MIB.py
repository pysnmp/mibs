...
NotificationType, mib_2, ObjectIdentity, TimeTicks, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Unsigned32, NotificationType, iso, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "ObjectIdentity", "TimeTicks", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Unsigned32", "NotificationType", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromClient=stHttpBytesFromClient, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, stCategoriesEntry=stCategoriesEntry, mwg=mwg, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, mwgTraps=mwgTraps, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, kMajorVersion=kMajorVersion, stCategoriesTable=stCategoriesTable)
