...
ModuleIdentity, Counter32, iso, Unsigned32, NotificationType, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, mib_2, Bits, TimeTicks, MibIdentifier, Gauge32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "iso", "Unsigned32", "NotificationType", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "mib-2", "Bits", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, stBadReputation=stBadReputation, stClientCount=stClientCount, trUser=trUser, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, kProductName=kProductName, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMemConsumed=stMemConsumed, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryName=stCategoryName, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, mwgHttps=mwgHttps, mwgTraps=mwgTraps, stCPULoad=stCPULoad, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient)
