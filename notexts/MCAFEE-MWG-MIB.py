...
NotificationType, Gauge32, NotificationType, ObjectIdentity, iso, Bits, MibIdentifier, Counter32, enterprises, Unsigned32, TimeTicks, Counter64, Integer32, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "NotificationType", "ObjectIdentity", "iso", "Bits", "MibIdentifier", "Counter32", "enterprises", "Unsigned32", "TimeTicks", "Counter64", "Integer32", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, mwgMiscellaneous=mwgMiscellaneous, stCPUIOWait=stCPUIOWait, trSystem=trSystem, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, notifyReason=notifyReason, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, trUser=trUser, trApplication=trApplication, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, mwg=mwg, mwgInfo=mwgInfo, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets)
