...
TimeTicks, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, mib_2, iso, Gauge32, NotificationType, IpAddress, NotificationType, Counter32, ModuleIdentity, Counter64, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "mib-2", "iso", "Gauge32", "NotificationType", "IpAddress", "NotificationType", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, trSystem=trSystem, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, kProductName=kProductName, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwg=mwg, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion)
