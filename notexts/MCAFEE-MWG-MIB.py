...
MibIdentifier, mib_2, ModuleIdentity, Bits, Unsigned32, Counter32, Counter64, IpAddress, iso, enterprises, NotificationType, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "ModuleIdentity", "Bits", "Unsigned32", "Counter32", "Counter64", "IpAddress", "iso", "enterprises", "NotificationType", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stHttpRequests=stHttpRequests, kRevision=kRevision, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, kCompanyName=kCompanyName, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, stCPULoad=stCPULoad, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, mwgTraps=mwgTraps, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw)
