...
Gauge32, iso, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, MibIdentifier, IpAddress, Integer32, NotificationType, ObjectIdentity, Unsigned32, NotificationType, ModuleIdentity, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "ObjectIdentity", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, kRevision=kRevision, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, stClientCount=stClientCount, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, trUser=trUser, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, kProductName=kProductName, stFtpTraffic=stFtpTraffic, notifySeverity=notifySeverity, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, mwg=mwg, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw)
