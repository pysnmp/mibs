...
# ASN.1 source CISCO-VISM-CONN-MIB
# Source digest sha256:1cde321217a9036d7b562072a72f189abfb16e8b29ac5762eb4d61ecab544154
...
if mibBuilder.loadTexts: ciscoVismConnMIB.setLastUpdated('2004-05-03 00:00')
...
vismChanCnfGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: vismChanCnfGrpTable.setStatus('current')
vismChanCnfGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-VISM-CONN-MIB", "vismCnfChanNum"))
...
vismVCCI = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 1, 1, 1, 45), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)).clone(0)).setMaxAccess("readwrite")
...
vismChanPrefRouteId = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 1, 1, 1, 47), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)).clone(0)).setMaxAccess("readwrite")
...
vismChanStateGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: vismChanStateGrpTable.setStatus('current')
vismChanStateGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 5, 3, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-VISM-CONN-MIB", "vismStateChanNum"))
...
mibBuilder.exportSymbols("CISCO-VISM-CONN-MIB", PYSNMP_MODULE_ID=ciscoVismConnMIB, ciscoVismConnCompliance=ciscoVismConnCompliance, ciscoVismConnComplianceRev1=ciscoVismConnComplianceRev1, ciscoVismConnGroup=ciscoVismConnGroup, ciscoVismConnGroupRev1=ciscoVismConnGroupRev1, ciscoVismConnMIB=ciscoVismConnMIB, ciscoVismConnMIBCompliances=ciscoVismConnMIBCompliances, ciscoVismConnMIBConformance=ciscoVismConnMIBConformance, ciscoVismConnMIBGroups=ciscoVismConnMIBGroups, ciscoVismConnStateGroup=ciscoVismConnStateGroup, vismChanActivityState=vismChanActivityState, vismChanAisDelayTime=vismChanAisDelayTime, vismChanAisSuppression=vismChanAisSuppression, vismChanApplication=vismChanApplication, vismChanCdvt=vismChanCdvt, vismChanClrEgress=vismChanClrEgress, vismChanClrIngress=vismChanClrIngress, vismChanCnfGrpEntry=vismChanCnfGrpEntry, vismChanCnfGrpTable=vismChanCnfGrpTable, vismChanConnType=vismChanConnType, vismChanDirectRoute=vismChanDirectRoute, vismChanFallbackLcn=vismChanFallbackLcn, vismChanLocRmtLpbkState=vismChanLocRmtLpbkState, vismChanLockingState=vismChanLockingState, vismChanMbsEgress=vismChanMbsEgress, vismChanMbsIngress=vismChanMbsIngress, vismChanNumNextAvailable=vismChanNumNextAvailable, vismChanPortNum=vismChanPortNum, vismChanPrefRouteId=vismChanPrefRouteId, vismChanPreference=vismChanPreference, vismChanProtection=vismChanProtection, vismChanPvcType=vismChanPvcType, vismChanRTDResult=vismChanRTDResult, vismChanRcvATMState=vismChanRcvATMState, vismChanReroute=vismChanReroute, vismChanRowStatus=vismChanRowStatus, vismChanScrEgress=vismChanScrEgress, vismChanScrIngress=vismChanScrIngress, vismChanState=vismChanState, vismChanStateGrp=vismChanStateGrp, vismChanStateGrpEntry=vismChanStateGrpEntry, vismChanStateGrpTable=vismChanStateGrpTable, vismChanStatusBitMap=vismChanStatusBitMap, vismChanTestState=vismChanTestState, vismChanTestType=vismChanTestType, vismChanUserMaxMbsIngress=vismChanUserMaxMbsIngress, vismChanUserMaxPCRBandwidth=vismChanUserMaxPCRBandwidth, vismChanUserMaxScrIngress=vismChanUserMaxScrIngress, vismChanUserMinPCRBandwidth=vismChanUserMinPCRBandwidth, vismChanUserPcrNumber=vismChanUserPcrNumber, vismChanXmtATMState=vismChanXmtATMState, vismCnfChanNum=vismCnfChanNum, vismConnAdminStatus=vismConnAdminStatus, vismConnPCR=vismConnPCR, vismConnPCREgress=vismConnPCREgress, vismConnPercentUtil=vismConnPercentUtil, vismConnRemotePCR=vismConnRemotePCR, vismConnRemotePercentUtil=vismConnRemotePercentUtil, vismConnServiceType=vismConnServiceType, vismFarEndAddressType=vismFarEndAddressType, vismFarEndE164Address=vismFarEndE164Address, vismFarEndGWIDAddress=vismFarEndGWIDAddress, vismFarEndNSAPAddress=vismFarEndNSAPAddress, vismLocalNSAP=vismLocalNSAP, vismLocalVci=vismLocalVci, vismLocalVpi=vismLocalVpi, vismMastership=vismMastership, vismMaxCost=vismMaxCost, vismRemoteNSAP=vismRemoteNSAP, vismRemoteVci=vismRemoteVci, vismRemoteVpi=vismRemoteVpi, vismRestrictTrunkType=vismRestrictTrunkType, vismRoutingPriority=vismRoutingPriority, vismStateChanNum=vismStateChanNum, vismVCCI=vismVCCI, vismVpcFlag=vismVpcFlag)
