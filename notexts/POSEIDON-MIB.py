...
Counter64, Counter32, ObjectIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, iso, ModuleIdentity, TimeTicks, Unsigned32, IpAddress, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ObjectIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "iso", "ModuleIdentity", "TimeTicks", "Unsigned32", "IpAddress", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, inpTable=inpTable, hwgroup=hwgroup, sensState=sensState, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime, sensEntry=sensEntry, sensUnit=sensUnit, OutputMode=OutputMode, sensLimitMin=sensLimitMin, SensorUnitString=SensorUnitString, poseidon=poseidon, sensHysteresis=sensHysteresis, SensorValue=SensorValue, SensorFlags=SensorFlags, inpName=inpName, sensSetupTable=sensSetupTable, sensFlags=sensFlags, unitType=unitType, outMode=outMode, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, inpValue=inpValue, tsAlarmTable=tsAlarmTable, SensorState=SensorState, sensValueRaw=sensValueRaw, sensSetupEntry=sensSetupEntry, IOName=IOName, sensLimitMax=sensLimitMax, outTable=outTable, inpAlarmStateChanged=inpAlarmStateChanged, SensorID=SensorID, setup=setup, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, InputAlarmState=InputAlarmState, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, outValue=outValue, OnOff=OnOff, inpIndex=inpIndex, sensUnitString=sensUnitString, tsAlarm=tsAlarm, sensSetup=sensSetup, sensIndex=sensIndex, SensorString=SensorString, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmSensName=tsAlarmSensName, tsAlarmId=tsAlarmId, sensName=sensName, SensorName=SensorName, sensValue=sensValue, PositiveInteger=PositiveInteger, outType=outType, infoAddressMAC=infoAddressMAC, charonII=charonII, info=info, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, outName=outName, sensTable=sensTable, inpAlarmState=inpAlarmState, sensID=sensID)
