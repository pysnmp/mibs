...
IpAddress, MibIdentifier, Integer32, NotificationType, Unsigned32, Counter32, Gauge32, iso, ObjectIdentity, Bits, ModuleIdentity, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "Unsigned32", "Counter32", "Gauge32", "iso", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputType=OutputType, SensorString=SensorString, setup=setup, SensorUnitString=SensorUnitString, SensorState=SensorState, hwgroup=hwgroup, inpAlarmState=inpAlarmState, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, sensAlarmStateChanged=sensAlarmStateChanged, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, SensorName=SensorName, sensSetupTable=sensSetupTable, tsAlarmSensName=tsAlarmSensName, tsAlarmId=tsAlarmId, outTable=outTable, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, sensName=sensName, sensValue=sensValue, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, outEntry=outEntry, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensLimitMax=sensLimitMax, outType=outType, UnitType=UnitType, TimeStamp=TimeStamp, inpValue=inpValue, outValue=outValue, inpName=inpName, SensorFlags=SensorFlags, sensUnit=sensUnit, sensHysteresis=sensHysteresis, unitType=unitType, info=info, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, OnOff=OnOff, IOName=IOName, sensString=sensString, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, sensID=sensID, inpTable=inpTable, tsAlarm=tsAlarm, sensSetup=sensSetup, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, charonII=charonII, outMode=outMode, SensorValue=SensorValue, PositiveInteger=PositiveInteger, outIndex=outIndex, sensState=sensState, outName=outName)
