...
Gauge32, enterprises, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, IpAddress, NotificationType, Counter32, TimeTicks, ModuleIdentity, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "Counter32", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupEntry=sensSetupEntry, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, OutputType=OutputType, inpName=inpName, tsTrapAlarmStart=tsTrapAlarmStart, sensUnitString=sensUnitString, SensorValue=SensorValue, tsAlarmSensName=tsAlarmSensName, sensAlarmStateChanged=sensAlarmStateChanged, outMode=outMode, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, outValue=outValue, SensorString=SensorString, sensIndex=sensIndex, charonII=charonII, SensorID=SensorID, sensHysteresis=sensHysteresis, hwgroup=hwgroup, tsAlarmTime=tsAlarmTime, outType=outType, inpEntry=inpEntry, SensorUnitString=SensorUnitString, inpValue=inpValue, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, setup=setup, infoAddressMAC=infoAddressMAC, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, UnitType=UnitType, inpIndex=inpIndex, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, sensID=sensID, sensName=sensName, outTable=outTable, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, InputAlarmSetup=InputAlarmSetup, outEntry=outEntry, outName=outName, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, outIndex=outIndex, OnOff=OnOff, sensString=sensString, SensorName=SensorName, SensorState=SensorState, sensTable=sensTable, sensEntry=sensEntry, tsAlarmIdx=tsAlarmIdx, InputAlarmState=InputAlarmState, OutputMode=OutputMode, sensSetup=sensSetup, tsAlarmDescr=tsAlarmDescr, TimeStamp=TimeStamp, SensorFlags=SensorFlags, info=info, sensSetupName=sensSetupName, sensValue=sensValue, PositiveInteger=PositiveInteger, sensState=sensState, inpAlarmState=inpAlarmState)
