...
ModuleIdentity, Integer32, Gauge32, iso, Counter32, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Counter64, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "iso", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, outTable=outTable, setup=setup, InputAlarmSetup=InputAlarmSetup, UnitType=UnitType, SensorString=SensorString, info=info, outIndex=outIndex, OutputMode=OutputMode, outName=outName, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, sensName=sensName, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, SensorName=SensorName, outEntry=outEntry, outType=outType, unitType=unitType, charonII=charonII, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, sensString=sensString, TimeStamp=TimeStamp, outValue=outValue, inpIndex=inpIndex, sensEntry=sensEntry, tsAlarm=tsAlarm, sensState=sensState, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, tsAlarmDescr=tsAlarmDescr, sensID=sensID, OutputType=OutputType, sensLimitMax=sensLimitMax, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, sensUnit=sensUnit, hwgroup=hwgroup, SensorState=SensorState, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, sensIndex=sensIndex, inpEntry=inpEntry, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, infoAddressMAC=infoAddressMAC, IOName=IOName, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, inpName=inpName, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, SensorFlags=SensorFlags, poseidon=poseidon, sensTable=sensTable, inpValue=inpValue, OnOff=OnOff, inpTable=inpTable, outMode=outMode, sensSetupTable=sensSetupTable)
