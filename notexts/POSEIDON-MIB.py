...
IpAddress, Gauge32, NotificationType, TimeTicks, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, MibIdentifier, ObjectIdentity, Integer32, iso, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "NotificationType", "TimeTicks", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "MibIdentifier", "ObjectIdentity", "Integer32", "iso", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, tsAlarmTable=tsAlarmTable, sensState=sensState, SensorFlags=SensorFlags, outMode=outMode, InputAlarmSetup=InputAlarmSetup, infoAddressMAC=infoAddressMAC, OutputType=OutputType, sensHysteresis=sensHysteresis, SensorName=SensorName, outName=outName, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, sensSetup=sensSetup, PositiveInteger=PositiveInteger, hwgroup=hwgroup, sensUnitString=sensUnitString, TimeStamp=TimeStamp, SensorID=SensorID, tsAlarm=tsAlarm, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensString=sensString, OutputMode=OutputMode, outIndex=outIndex, setup=setup, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, poseidon=poseidon, inpValue=inpValue, sensTable=sensTable, sensLimitMax=sensLimitMax, InputAlarmState=InputAlarmState, SensorState=SensorState, sensIndex=sensIndex, outEntry=outEntry, inpIndex=inpIndex, sensName=sensName, sensAlarmStateChanged=sensAlarmStateChanged, outTable=outTable, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, outType=outType, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, SensorValue=SensorValue, OnOff=OnOff, sensUnit=sensUnit, sensValueRaw=sensValueRaw, outValue=outValue, IOName=IOName, sensSetupName=sensSetupName, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, info=info, sensEntry=sensEntry, sensValue=sensValue, sensSetupEntry=sensSetupEntry, charonII=charonII, tsAlarmSensName=tsAlarmSensName, SensorString=SensorString, unitType=unitType, inpAlarmState=inpAlarmState)
