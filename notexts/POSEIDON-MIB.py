...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, tsAlarmIdx=tsAlarmIdx, outMode=outMode, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, sensName=sensName, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, info=info, tsAlarmId=tsAlarmId, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, SensorValue=SensorValue, outTable=outTable, outName=outName, charonII=charonII, sensTable=sensTable, sensValue=sensValue, outValue=outValue, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, sensSetup=sensSetup, OutputType=OutputType, IOName=IOName, sensEntry=sensEntry, TimeStamp=TimeStamp, inpTable=inpTable, sensString=sensString, InputAlarmState=InputAlarmState, sensUnit=sensUnit, sensSetupTable=sensSetupTable, unitType=unitType, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, tsAlarmEntry=tsAlarmEntry, inpEntry=inpEntry, sensState=sensState, tsAlarmTime=tsAlarmTime, SensorString=SensorString, SensorName=SensorName, UnitType=UnitType, SensorID=SensorID, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, tsAlarmSensName=tsAlarmSensName, sensValueRaw=sensValueRaw, poseidon=poseidon, SensorState=SensorState, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, SensorUnitString=SensorUnitString, setup=setup, sensIndex=sensIndex, inpValue=inpValue, sensHysteresis=sensHysteresis, inpIndex=inpIndex, outEntry=outEntry, sensLimitMin=sensLimitMin, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, OnOff=OnOff)
