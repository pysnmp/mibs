...
enterprises, Integer32, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, Gauge32, TimeTicks, IpAddress, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "Gauge32", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, OutputMode=OutputMode, poseidon=poseidon, inpName=inpName, outEntry=outEntry, charonII=charonII, SensorValue=SensorValue, sensLimitMin=sensLimitMin, inpAlarmSetup=inpAlarmSetup, info=info, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, SensorID=SensorID, unitType=unitType, PositiveInteger=PositiveInteger, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, sensName=sensName, tsAlarmTable=tsAlarmTable, sensState=sensState, sensSetupIndex=sensSetupIndex, sensTable=sensTable, outTable=outTable, outIndex=outIndex, sensUnit=sensUnit, sensIndex=sensIndex, outName=outName, hwgroup=hwgroup, sensUnitString=sensUnitString, OnOff=OnOff, sensAlarmStateChanged=sensAlarmStateChanged, setup=setup, tsAlarmId=tsAlarmId, SensorString=SensorString, outMode=outMode, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorUnitString=SensorUnitString, sensEntry=sensEntry, sensHysteresis=sensHysteresis, tsAlarmDescr=tsAlarmDescr, outValue=outValue, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, InputAlarmState=InputAlarmState, SensorState=SensorState, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, sensSetupTable=sensSetupTable, tsAlarmEntry=tsAlarmEntry, inpEntry=inpEntry, sensLimitMax=sensLimitMax, OutputType=OutputType, IOName=IOName, outType=outType, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, inpValue=inpValue, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, sensSetup=sensSetup, sensString=sensString, sensID=sensID, sensFlags=sensFlags, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent)
