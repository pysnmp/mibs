...
Integer32, Bits, NotificationType, MibIdentifier, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64, TimeTicks, ModuleIdentity, ObjectIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", info=info, SensorID=SensorID, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup, outTable=outTable, sensLimitMin=sensLimitMin, inpTable=inpTable, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, sensIndex=sensIndex, SensorValue=SensorValue, SensorState=SensorState, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, sensSetupName=sensSetupName, unitType=unitType, poseidon=poseidon, OutputType=OutputType, sensID=sensID, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, outType=outType, PositiveInteger=PositiveInteger, OutputMode=OutputMode, sensName=sensName, SensorFlags=SensorFlags, inpEntry=inpEntry, outValue=outValue, sensString=sensString, tsAlarmTable=tsAlarmTable, setup=setup, outEntry=outEntry, sensUnitString=sensUnitString, infoAddressMAC=infoAddressMAC, outIndex=outIndex, tsAlarmId=tsAlarmId, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, sensLimitMax=sensLimitMax, InputAlarmState=InputAlarmState, sensValueRaw=sensValueRaw, UnitType=UnitType, tsAlarm=tsAlarm, OnOff=OnOff, SensorString=SensorString, inpName=inpName, outMode=outMode, sensEntry=sensEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, sensFlags=sensFlags, sensState=sensState, inpValue=inpValue, sensValue=sensValue, tsAlarmEntry=tsAlarmEntry, SensorName=SensorName, IOName=IOName, charonII=charonII, outName=outName)
