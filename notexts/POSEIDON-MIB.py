...
IpAddress, MibIdentifier, Bits, Gauge32, iso, Unsigned32, NotificationType, ModuleIdentity, enterprises, Integer32, ObjectIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "iso", "Unsigned32", "NotificationType", "ModuleIdentity", "enterprises", "Integer32", "ObjectIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, poseidon=poseidon, setup=setup, SensorFlags=SensorFlags, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, sensString=sensString, sensID=sensID, infoAddressMAC=infoAddressMAC, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, sensName=sensName, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, sensTable=sensTable, inpIndex=inpIndex, outValue=outValue, tsAlarm=tsAlarm, sensFlags=sensFlags, SensorString=SensorString, OutputType=OutputType, charonII=charonII, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, inpAlarmState=inpAlarmState, outEntry=outEntry, info=info, sensUnitString=sensUnitString, outMode=outMode, OnOff=OnOff, sensValue=sensValue, sensHysteresis=sensHysteresis, inpName=inpName, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, sensEntry=sensEntry, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, sensLimitMax=sensLimitMax, sensSetupIndex=sensSetupIndex, tsAlarmIdx=tsAlarmIdx, outType=outType, SensorState=SensorState, unitType=unitType, SensorValue=SensorValue, SensorID=SensorID, IOName=IOName, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, sensLimitMin=sensLimitMin, sensIndex=sensIndex, TimeStamp=TimeStamp, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, outTable=outTable, sensSetupName=sensSetupName, outName=outName, inpValue=inpValue, PositiveInteger=PositiveInteger, OutputMode=OutputMode, inpEntry=inpEntry, hwgroup=hwgroup, outIndex=outIndex, sensAlarmStateChanged=sensAlarmStateChanged)
