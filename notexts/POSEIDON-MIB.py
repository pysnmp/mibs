...
TimeTicks, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Gauge32, enterprises, NotificationType, iso, Integer32, ObjectIdentity, IpAddress, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Gauge32", "enterprises", "NotificationType", "iso", "Integer32", "ObjectIdentity", "IpAddress", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValueRaw=sensValueRaw, outValue=outValue, inpName=inpName, sensID=sensID, tsAlarmSensName=tsAlarmSensName, SensorID=SensorID, OutputType=OutputType, PositiveInteger=PositiveInteger, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, sensIndex=sensIndex, sensState=sensState, SensorName=SensorName, tsAlarmTime=tsAlarmTime, tsAlarmId=tsAlarmId, outIndex=outIndex, tsTrapAlarmStart=tsTrapAlarmStart, outName=outName, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, inpTable=inpTable, inpEntry=inpEntry, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, info=info, sensHysteresis=sensHysteresis, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, TimeStamp=TimeStamp, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, outMode=outMode, tsAlarmEntry=tsAlarmEntry, SensorFlags=SensorFlags, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, sensEntry=sensEntry, sensString=sensString, IOName=IOName, hwgroup=hwgroup, SensorState=SensorState, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, outType=outType, inpIndex=inpIndex, outTable=outTable, InputAlarmState=InputAlarmState, sensFlags=sensFlags, sensSetupEntry=sensSetupEntry, sensTable=sensTable, SensorValue=SensorValue, tsAlarm=tsAlarm, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, UnitType=UnitType, OnOff=OnOff, SensorString=SensorString, sensValue=sensValue, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetup=sensSetup, inpValue=inpValue, sensName=sensName, SensorUnitString=SensorUnitString, setup=setup, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName, OutputMode=OutputMode)
