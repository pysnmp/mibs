...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, setup=setup, hwgroup=hwgroup, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, charonII=charonII, sensIndex=sensIndex, tsAlarmId=tsAlarmId, SensorState=SensorState, sensValue=sensValue, outTable=outTable, SensorID=SensorID, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, sensID=sensID, tsAlarmDescr=tsAlarmDescr, sensString=sensString, OnOff=OnOff, tsAlarmTime=tsAlarmTime, InputAlarmState=InputAlarmState, poseidon=poseidon, SensorName=SensorName, sensEntry=sensEntry, sensSetupEntry=sensSetupEntry, sensState=sensState, inpIndex=inpIndex, sensSetupTable=sensSetupTable, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, info=info, SensorValue=SensorValue, IOName=IOName, sensName=sensName, sensSetup=sensSetup, sensLimitMax=sensLimitMax, inpName=inpName, outIndex=outIndex, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, sensUnit=sensUnit, OutputMode=OutputMode, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, UnitType=UnitType, OutputType=OutputType, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, SensorUnitString=SensorUnitString, outEntry=outEntry, inpEntry=inpEntry, outType=outType, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, tsAlarmsPresent=tsAlarmsPresent, outName=outName, sensTable=sensTable)
