...
IpAddress, Counter64, ObjectIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, ModuleIdentity, MibIdentifier, enterprises, NotificationType, Counter32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "ObjectIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "enterprises", "NotificationType", "Counter32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmId=tsAlarmId, hwgroup=hwgroup, sensUnitString=sensUnitString, SensorString=SensorString, inpValue=inpValue, inpName=inpName, outTable=outTable, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, sensLimitMax=sensLimitMax, sensUnit=sensUnit, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, setup=setup, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, SensorState=SensorState, sensEntry=sensEntry, sensState=sensState, tsAlarmIdx=tsAlarmIdx, sensFlags=sensFlags, inpIndex=inpIndex, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, inpTable=inpTable, sensID=sensID, SensorFlags=SensorFlags, SensorValue=SensorValue, sensTable=sensTable, sensSetup=sensSetup, outIndex=outIndex, sensValue=sensValue, tsTrapAlarmEnd=tsTrapAlarmEnd, outType=outType, outMode=outMode, TimeStamp=TimeStamp, outValue=outValue, charonII=charonII, sensIndex=sensIndex, outName=outName, sensSetupTable=sensSetupTable, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, info=info, OnOff=OnOff, sensLimitMin=sensLimitMin, PositiveInteger=PositiveInteger, SensorName=SensorName, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, SensorID=SensorID, outEntry=outEntry, tsAlarmTable=tsAlarmTable, sensHysteresis=sensHysteresis, OutputType=OutputType, UnitType=UnitType, sensString=sensString, InputAlarmState=InputAlarmState, tsAlarm=tsAlarm, sensName=sensName, tsAlarmDescr=tsAlarmDescr, sensSetupEntry=sensSetupEntry, IOName=IOName, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupName=sensSetupName)
