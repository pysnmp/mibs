...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, sensSetupTable=sensSetupTable, SensorName=SensorName, sensIndex=sensIndex, outType=outType, inpTable=inpTable, InputAlarmSetup=InputAlarmSetup, outValue=outValue, SensorString=SensorString, sensValueRaw=sensValueRaw, sensString=sensString, sensSetupIndex=sensSetupIndex, outTable=outTable, setup=setup, tsAlarmId=tsAlarmId, inpEntry=inpEntry, PositiveInteger=PositiveInteger, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensFlags=sensFlags, inpValue=inpValue, sensName=sensName, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, unitType=unitType, OutputMode=OutputMode, IOName=IOName, sensTable=sensTable, UnitType=UnitType, sensID=sensID, sensLimitMax=sensLimitMax, hwgroup=hwgroup, inpAlarmState=inpAlarmState, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, tsAlarmSensName=tsAlarmSensName, OnOff=OnOff, InputAlarmState=InputAlarmState, SensorID=SensorID, SensorFlags=SensorFlags, TimeStamp=TimeStamp, outEntry=outEntry, OutputType=OutputType, sensEntry=sensEntry, charonII=charonII, sensSetupEntry=sensSetupEntry, info=info, inpIndex=inpIndex, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, sensState=sensState, sensHysteresis=sensHysteresis, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, tsAlarmTime=tsAlarmTime, outName=outName, outMode=outMode, sensValue=sensValue, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, sensUnitString=sensUnitString, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr)
