...
Counter64, iso, Unsigned32, Counter32, IpAddress, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Integer32, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Unsigned32", "Counter32", "IpAddress", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputType=OutputType, SensorID=SensorID, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, outMode=outMode, inpTable=inpTable, sensSetupName=sensSetupName, IOName=IOName, inpEntry=inpEntry, sensState=sensState, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, outEntry=outEntry, OutputMode=OutputMode, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, charonII=charonII, setup=setup, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, sensValue=sensValue, SensorValue=SensorValue, sensSetup=sensSetup, OnOff=OnOff, outType=outType, UnitType=UnitType, sensName=sensName, sensString=sensString, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, SensorState=SensorState, InputAlarmSetup=InputAlarmSetup, outValue=outValue, tsAlarmTime=tsAlarmTime, inpName=inpName, unitType=unitType, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, outTable=outTable, sensFlags=sensFlags, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, poseidon=poseidon, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, SensorName=SensorName, sensTable=sensTable, SensorString=SensorString, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, SensorUnitString=SensorUnitString, info=info, hwgroup=hwgroup, sensUnit=sensUnit, sensLimitMin=sensLimitMin, tsAlarmIdx=tsAlarmIdx, inpValue=inpValue, sensID=sensID, InputAlarmState=InputAlarmState)
