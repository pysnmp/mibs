...
MibIdentifier, Counter64, Counter32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, enterprises, Integer32, Bits, ModuleIdentity, IpAddress, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "enterprises", "Integer32", "Bits", "ModuleIdentity", "IpAddress", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorFlags=SensorFlags, outIndex=outIndex, outValue=outValue, tsTrapAlarmEnd=tsTrapAlarmEnd, UnitType=UnitType, tsAlarmId=tsAlarmId, outEntry=outEntry, sensSetupName=sensSetupName, sensValue=sensValue, InputAlarmState=InputAlarmState, OutputType=OutputType, poseidon=poseidon, setup=setup, sensState=sensState, charonII=charonII, sensName=sensName, tsAlarmTable=tsAlarmTable, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, info=info, sensID=sensID, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, outTable=outTable, sensSetup=sensSetup, sensLimitMin=sensLimitMin, tsAlarmsPresent=tsAlarmsPresent, outType=outType, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, sensIndex=sensIndex, PositiveInteger=PositiveInteger, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, sensLimitMax=sensLimitMax, inpAlarmState=inpAlarmState, unitType=unitType, SensorState=SensorState, inpEntry=inpEntry, SensorName=SensorName, TimeStamp=TimeStamp, tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, sensUnitString=sensUnitString, outMode=outMode, tsAlarmTime=tsAlarmTime, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, OnOff=OnOff, SensorString=SensorString, inpName=inpName, outName=outName, hwgroup=hwgroup, sensString=sensString, sensHysteresis=sensHysteresis, sensSetupIndex=sensSetupIndex, IOName=IOName, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, SensorID=SensorID, inpValue=inpValue, inpTable=inpTable)
