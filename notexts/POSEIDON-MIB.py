...
Counter32, IpAddress, Gauge32, TimeTicks, Bits, NotificationType, enterprises, Counter64, ModuleIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Gauge32", "TimeTicks", "Bits", "NotificationType", "enterprises", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, outIndex=outIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputType=OutputType, sensString=sensString, inpEntry=inpEntry, OnOff=OnOff, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, inpIndex=inpIndex, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, sensIndex=sensIndex, outEntry=outEntry, inpTable=inpTable, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, UnitType=UnitType, charonII=charonII, sensValue=sensValue, SensorState=SensorState, outTable=outTable, InputAlarmState=InputAlarmState, SensorValue=SensorValue, SensorName=SensorName, inpName=inpName, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, poseidon=poseidon, sensName=sensName, sensSetupName=sensSetupName, outName=outName, OutputMode=OutputMode, tsAlarmIdx=tsAlarmIdx, SensorString=SensorString, info=info, outMode=outMode, sensTable=sensTable, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmId=tsAlarmId, sensEntry=sensEntry, SensorFlags=SensorFlags, inpValue=inpValue, tsAlarmDescr=tsAlarmDescr, outType=outType, sensSetup=sensSetup, hwgroup=hwgroup, sensID=sensID, tsAlarm=tsAlarm, inpAlarmStateChanged=inpAlarmStateChanged, sensUnit=sensUnit, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, outValue=outValue, sensLimitMin=sensLimitMin, SensorID=SensorID, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, setup=setup, sensState=sensState, unitType=unitType, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, IOName=IOName)
