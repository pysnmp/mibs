...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, enterprises, NotificationType, ObjectIdentity, TimeTicks, MibIdentifier, Counter64, Counter32, Unsigned32, iso, IpAddress, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "enterprises", "NotificationType", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter64", "Counter32", "Unsigned32", "iso", "IpAddress", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, sensName=sensName, sensEntry=sensEntry, outEntry=outEntry, UnitType=UnitType, outIndex=outIndex, info=info, inpAlarmState=inpAlarmState, sensIndex=sensIndex, unitType=unitType, OutputType=OutputType, sensID=sensID, sensLimitMin=sensLimitMin, tsAlarmEntry=tsAlarmEntry, sensSetupIndex=sensSetupIndex, inpTable=inpTable, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, sensValue=sensValue, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, sensString=sensString, tsAlarmTable=tsAlarmTable, charonII=charonII, tsAlarmDescr=tsAlarmDescr, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, IOName=IOName, inpValue=inpValue, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, setup=setup, sensTable=sensTable, tsAlarmTime=tsAlarmTime, outTable=outTable, sensSetupName=sensSetupName, outValue=outValue, tsTrapAlarmStart=tsTrapAlarmStart, SensorValue=SensorValue, SensorString=SensorString, outType=outType, tsAlarmSensName=tsAlarmSensName, OutputMode=OutputMode, SensorState=SensorState, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, outMode=outMode, SensorName=SensorName, SensorID=SensorID, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetup=sensSetup, sensUnit=sensUnit, sensUnitString=sensUnitString, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, hwgroup=hwgroup, sensLimitMax=sensLimitMax, tsAlarm=tsAlarm, outName=outName, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, inpIndex=inpIndex, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, sensFlags=sensFlags, sensSetupEntry=sensSetupEntry)
