...
Bits, Counter64, MibIdentifier, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, NotificationType, Integer32, iso, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibIdentifier", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "NotificationType", "Integer32", "iso", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensID=sensID, unitType=unitType, IOName=IOName, hwgroup=hwgroup, info=info, InputAlarmSetup=InputAlarmSetup, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, sensSetupTable=sensSetupTable, inpIndex=inpIndex, outValue=outValue, outType=outType, tsAlarm=tsAlarm, inpAlarmState=inpAlarmState, outMode=outMode, sensString=sensString, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, SensorID=SensorID, charonII=charonII, inpTable=inpTable, outEntry=outEntry, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, inpName=inpName, sensValueRaw=sensValueRaw, UnitType=UnitType, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, setup=setup, SensorState=SensorState, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, inpEntry=inpEntry, inpValue=inpValue, sensLimitMax=sensLimitMax, sensUnit=sensUnit, sensFlags=sensFlags, SensorName=SensorName, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorFlags=SensorFlags, sensState=sensState, OutputMode=OutputMode, outName=outName, OnOff=OnOff, sensName=sensName, SensorString=SensorString, outTable=outTable, poseidon=poseidon, InputAlarmState=InputAlarmState, outIndex=outIndex, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, sensTable=sensTable, OutputType=OutputType)
