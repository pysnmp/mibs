...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, ObjectIdentity, Unsigned32, IpAddress, Counter32, ModuleIdentity, Integer32, NotificationType, TimeTicks, Bits, Counter64, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks", "Bits", "Counter64", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, sensSetupTable=sensSetupTable, inpName=inpName, sensSetup=sensSetup, sensSetupName=sensSetupName, SensorID=SensorID, inpTable=inpTable, sensTable=sensTable, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, sensEntry=sensEntry, inpEntry=inpEntry, info=info, outTable=outTable, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, setup=setup, outType=outType, sensValueRaw=sensValueRaw, outValue=outValue, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, sensValue=sensValue, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, outName=outName, tsAlarmTable=tsAlarmTable, charonII=charonII, SensorString=SensorString, sensHysteresis=sensHysteresis, sensIndex=sensIndex, SensorFlags=SensorFlags, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, outMode=outMode, tsAlarmEntry=tsAlarmEntry, sensID=sensID, sensUnit=sensUnit, sensLimitMax=sensLimitMax, hwgroup=hwgroup, UnitType=UnitType, tsAlarmIdx=tsAlarmIdx, sensName=sensName, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, SensorValue=SensorValue, outEntry=outEntry, tsAlarm=tsAlarm, tsAlarmSensName=tsAlarmSensName, unitType=unitType, TimeStamp=TimeStamp, poseidon=poseidon, sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, sensState=sensState, SensorName=SensorName, inpAlarmState=inpAlarmState, OutputMode=OutputMode, IOName=IOName, OnOff=OnOff, sensString=sensString)
