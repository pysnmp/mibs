...
Gauge32, enterprises, iso, Counter32, Integer32, NotificationType, Bits, Unsigned32, TimeTicks, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "iso", "Counter32", "Integer32", "NotificationType", "Bits", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, setup=setup, inpName=inpName, sensName=sensName, sensLimitMin=sensLimitMin, OnOff=OnOff, outValue=outValue, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, sensHysteresis=sensHysteresis, OutputMode=OutputMode, inpValue=inpValue, UnitType=UnitType, inpAlarmStateChanged=inpAlarmStateChanged, sensString=sensString, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, SensorFlags=SensorFlags, SensorString=SensorString, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, outTable=outTable, outEntry=outEntry, outType=outType, tsAlarmTable=tsAlarmTable, charonII=charonII, SensorUnitString=SensorUnitString, inpAlarmState=inpAlarmState, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, outMode=outMode, sensFlags=sensFlags, tsAlarmIdx=tsAlarmIdx, OutputType=OutputType, infoAddressMAC=infoAddressMAC, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, sensID=sensID, hwgroup=hwgroup, sensSetup=sensSetup, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, SensorID=SensorID, poseidon=poseidon, sensValueRaw=sensValueRaw, sensUnit=sensUnit, PositiveInteger=PositiveInteger, sensLimitMax=sensLimitMax, outIndex=outIndex, SensorState=SensorState, tsAlarmId=tsAlarmId, info=info, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, sensTable=sensTable, unitType=unitType, sensUnitString=sensUnitString, sensState=sensState, SensorName=SensorName, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensEntry=sensEntry, sensValue=sensValue, SensorValue=SensorValue)
