...
Unsigned32, NotificationType, Counter64, MibIdentifier, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Bits, IpAddress, TimeTicks, Gauge32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Bits", "IpAddress", "TimeTicks", "Gauge32", "enterprises", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, InputAlarmState=InputAlarmState, sensName=sensName, tsAlarmTable=tsAlarmTable, inpValue=inpValue, sensIndex=sensIndex, OutputType=OutputType, sensValue=sensValue, sensFlags=sensFlags, sensState=sensState, outIndex=outIndex, outName=outName, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnitString=sensUnitString, UnitType=UnitType, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, OnOff=OnOff, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC, tsAlarmTime=tsAlarmTime, info=info, sensSetupEntry=sensSetupEntry, IOName=IOName, tsAlarmIdx=tsAlarmIdx, tsAlarmEntry=tsAlarmEntry, inpTable=inpTable, tsAlarm=tsAlarm, SensorValue=SensorValue, SensorID=SensorID, sensTable=sensTable, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, sensSetupIndex=sensSetupIndex, outType=outType, TimeStamp=TimeStamp, outTable=outTable, inpEntry=inpEntry, outValue=outValue, inpAlarmSetup=inpAlarmSetup, charonII=charonII, outEntry=outEntry, sensEntry=sensEntry, SensorState=SensorState, sensHysteresis=sensHysteresis, sensID=sensID, inpName=inpName, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, inpIndex=inpIndex, sensValueRaw=sensValueRaw, setup=setup, SensorUnitString=SensorUnitString, hwgroup=hwgroup, outMode=outMode, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode, sensLimitMin=sensLimitMin, sensString=sensString, sensSetupTable=sensSetupTable, inpAlarmState=inpAlarmState, tsAlarmSensName=tsAlarmSensName, SensorString=SensorString, sensSetup=sensSetup)
