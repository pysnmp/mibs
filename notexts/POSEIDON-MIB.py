...
Bits, TimeTicks, Counter64, IpAddress, ModuleIdentity, iso, NotificationType, Counter32, Unsigned32, ObjectIdentity, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter64", "IpAddress", "ModuleIdentity", "iso", "NotificationType", "Counter32", "Unsigned32", "ObjectIdentity", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, outValue=outValue, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, info=info, sensID=sensID, SensorState=SensorState, sensAlarmStateChanged=sensAlarmStateChanged, sensTable=sensTable, tsAlarmSensName=tsAlarmSensName, inpAlarmSetup=inpAlarmSetup, OutputMode=OutputMode, charonII=charonII, inpName=inpName, tsTrapAlarmStart=tsTrapAlarmStart, outTable=outTable, infoAddressMAC=infoAddressMAC, SensorName=SensorName, tsAlarmTime=tsAlarmTime, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, sensValue=sensValue, SensorFlags=SensorFlags, sensEntry=sensEntry, inpAlarmState=inpAlarmState, TimeStamp=TimeStamp, outIndex=outIndex, inpTable=inpTable, sensUnit=sensUnit, sensUnitString=sensUnitString, PositiveInteger=PositiveInteger, inpValue=inpValue, outName=outName, tsAlarm=tsAlarm, SensorValue=SensorValue, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, setup=setup, IOName=IOName, sensSetupEntry=sensSetupEntry, OutputType=OutputType, InputAlarmState=InputAlarmState, outType=outType, sensName=sensName, sensLimitMax=sensLimitMax, hwgroup=hwgroup, outMode=outMode, UnitType=UnitType, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, sensString=sensString, sensSetupTable=sensSetupTable, OnOff=OnOff, sensSetup=sensSetup, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensFlags=sensFlags, SensorID=SensorID, outEntry=outEntry, unitType=unitType, sensState=sensState, SensorUnitString=SensorUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupName=sensSetupName, tsAlarmId=tsAlarmId)
