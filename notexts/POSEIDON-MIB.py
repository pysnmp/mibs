...
enterprises, Counter64, MibIdentifier, Unsigned32, ModuleIdentity, TimeTicks, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "MibIdentifier", "Unsigned32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outTable=outTable, sensEntry=sensEntry, OutputType=OutputType, SensorString=SensorString, sensLimitMax=sensLimitMax, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, outEntry=outEntry, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, sensString=sensString, charonII=charonII, outName=outName, sensSetupTable=sensSetupTable, info=info, sensLimitMin=sensLimitMin, sensFlags=sensFlags, outMode=outMode, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, sensSetup=sensSetup, outValue=outValue, setup=setup, inpEntry=inpEntry, inpIndex=inpIndex, sensUnit=sensUnit, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, UnitType=UnitType, SensorFlags=SensorFlags, inpTable=inpTable, SensorName=SensorName, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, SensorID=SensorID, OnOff=OnOff, sensState=sensState, tsAlarm=tsAlarm, outType=outType, sensValue=sensValue, sensTable=sensTable, TimeStamp=TimeStamp, IOName=IOName, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, sensIndex=sensIndex, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, inpName=inpName, sensHysteresis=sensHysteresis, SensorState=SensorState, inpValue=inpValue, SensorValue=SensorValue, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, PositiveInteger=PositiveInteger, hwgroup=hwgroup)
