...
iso, Counter64, ObjectIdentity, ModuleIdentity, enterprises, IpAddress, Unsigned32, Integer32, NotificationType, Counter32, TimeTicks, MibIdentifier, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "ObjectIdentity", "ModuleIdentity", "enterprises", "IpAddress", "Unsigned32", "Integer32", "NotificationType", "Counter32", "TimeTicks", "MibIdentifier", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTable=tsAlarmTable, unitType=unitType, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, OnOff=OnOff, inpAlarmState=inpAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorString=SensorString, charonII=charonII, outEntry=outEntry, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, PositiveInteger=PositiveInteger, tsAlarmIdx=tsAlarmIdx, SensorID=SensorID, SensorName=SensorName, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, hwgroup=hwgroup, info=info, TimeStamp=TimeStamp, OutputMode=OutputMode, outName=outName, sensEntry=sensEntry, inpIndex=inpIndex, outTable=outTable, sensTable=sensTable, sensValueRaw=sensValueRaw, poseidon=poseidon, tsAlarmId=tsAlarmId, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, setup=setup, sensSetupIndex=sensSetupIndex, sensID=sensID, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, inpValue=inpValue, SensorState=SensorState, sensString=sensString, sensLimitMax=sensLimitMax, outMode=outMode, tsAlarm=tsAlarm, outValue=outValue, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, UnitType=UnitType, sensName=sensName, SensorUnitString=SensorUnitString, sensUnitString=sensUnitString, sensSetupName=sensSetupName, IOName=IOName, sensSetupTable=sensSetupTable, inpName=inpName, sensState=sensState, sensFlags=sensFlags, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, outIndex=outIndex, inpTable=inpTable, outType=outType, InputAlarmSetup=InputAlarmSetup)
