...
Counter64, Unsigned32, IpAddress, ObjectIdentity, Integer32, enterprises, ModuleIdentity, Counter32, NotificationType, MibIdentifier, TimeTicks, Bits, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "IpAddress", "ObjectIdentity", "Integer32", "enterprises", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, inpEntry=inpEntry, sensSetupEntry=sensSetupEntry, outType=outType, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, unitType=unitType, inpIndex=inpIndex, sensLimitMin=sensLimitMin, outName=outName, inpValue=inpValue, OutputType=OutputType, sensString=sensString, sensSetupTable=sensSetupTable, outMode=outMode, sensEntry=sensEntry, sensName=sensName, sensValue=sensValue, tsAlarmId=tsAlarmId, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, info=info, inpName=inpName, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, sensState=sensState, sensSetupName=sensSetupName, sensID=sensID, sensUnit=sensUnit, OutputMode=OutputMode, tsAlarmDescr=tsAlarmDescr, infoAddressMAC=infoAddressMAC, SensorString=SensorString, SensorState=SensorState, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, poseidon=poseidon, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, TimeStamp=TimeStamp, setup=setup, tsAlarmEntry=tsAlarmEntry, SensorValue=SensorValue, sensSetup=sensSetup, outTable=outTable, sensSetupIndex=sensSetupIndex, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, tsAlarm=tsAlarm, sensTable=sensTable, sensIndex=sensIndex, outEntry=outEntry, outIndex=outIndex, SensorID=SensorID, inpAlarmSetup=inpAlarmSetup, IOName=IOName, InputAlarmState=InputAlarmState, UnitType=UnitType, OnOff=OnOff, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, inpTable=inpTable, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx)
