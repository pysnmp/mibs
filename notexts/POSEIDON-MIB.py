...
ObjectIdentity, Integer32, Unsigned32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Counter32, iso, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Unsigned32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter32", "iso", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupTable=sensSetupTable, setup=setup, SensorString=SensorString, outTable=outTable, outType=outType, OutputType=OutputType, outValue=outValue, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, sensString=sensString, outName=outName, tsAlarmTable=tsAlarmTable, unitType=unitType, sensLimitMin=sensLimitMin, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, inpIndex=inpIndex, inpName=inpName, SensorName=SensorName, sensValueRaw=sensValueRaw, tsAlarmId=tsAlarmId, inpAlarmSetup=inpAlarmSetup, sensHysteresis=sensHysteresis, sensID=sensID, SensorValue=SensorValue, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, OutputMode=OutputMode, IOName=IOName, tsAlarmIdx=tsAlarmIdx, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, sensTable=sensTable, info=info, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, infoAddressMAC=infoAddressMAC, OnOff=OnOff, sensIndex=sensIndex, inpEntry=inpEntry, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, sensValue=sensValue, sensName=sensName, poseidon=poseidon, sensLimitMax=sensLimitMax, SensorID=SensorID, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, outIndex=outIndex, SensorState=SensorState, hwgroup=hwgroup, sensUnitString=sensUnitString, sensFlags=sensFlags, sensUnit=sensUnit, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, outMode=outMode, sensEntry=sensEntry, sensState=sensState, sensSetup=sensSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, UnitType=UnitType, inpTable=inpTable, charonII=charonII)
