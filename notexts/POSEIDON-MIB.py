...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Counter32, Counter64, iso, IpAddress, Bits, Unsigned32, enterprises, ModuleIdentity, ObjectIdentity, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Counter32", "Counter64", "iso", "IpAddress", "Bits", "Unsigned32", "enterprises", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, outTable=outTable, inpName=inpName, sensValue=sensValue, inpAlarmState=inpAlarmState, outEntry=outEntry, hwgroup=hwgroup, sensSetup=sensSetup, SensorValue=SensorValue, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, outValue=outValue, InputAlarmState=InputAlarmState, tsAlarmDescr=tsAlarmDescr, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, sensID=sensID, sensSetupIndex=sensSetupIndex, UnitType=UnitType, SensorFlags=SensorFlags, sensUnit=sensUnit, inpTable=inpTable, sensSetupTable=sensSetupTable, SensorState=SensorState, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, setup=setup, sensLimitMax=sensLimitMax, SensorString=SensorString, charonII=charonII, outName=outName, sensSetupName=sensSetupName, tsAlarmEntry=tsAlarmEntry, SensorID=SensorID, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, poseidon=poseidon, inpValue=inpValue, outIndex=outIndex, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, sensEntry=sensEntry, sensLimitMin=sensLimitMin, outMode=outMode, OutputMode=OutputMode, info=info, tsAlarmsPresent=tsAlarmsPresent, tsAlarm=tsAlarm, SensorName=SensorName, TimeStamp=TimeStamp, sensState=sensState, InputAlarmSetup=InputAlarmSetup, inpIndex=inpIndex, sensString=sensString, sensTable=sensTable, IOName=IOName, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensName=sensName, sensFlags=sensFlags, outType=outType, tsAlarmIdx=tsAlarmIdx, sensUnitString=sensUnitString, OutputType=OutputType, tsAlarmId=tsAlarmId)
