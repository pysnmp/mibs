...
Unsigned32, IpAddress, ObjectIdentity, iso, TimeTicks, Bits, ModuleIdentity, Integer32, MibIdentifier, Counter64, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ObjectIdentity", "iso", "TimeTicks", "Bits", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, SensorState=SensorState, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, IOName=IOName, setup=setup, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, inpTable=inpTable, SensorUnitString=SensorUnitString, sensSetupTable=sensSetupTable, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, charonII=charonII, outTable=outTable, SensorID=SensorID, poseidon=poseidon, sensString=sensString, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, tsAlarmId=tsAlarmId, tsAlarm=tsAlarm, unitType=unitType, sensValueRaw=sensValueRaw, OutputMode=OutputMode, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, outMode=outMode, outIndex=outIndex, sensTable=sensTable, info=info, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, outName=outName, UnitType=UnitType, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, sensUnitString=sensUnitString, outValue=outValue, sensValue=sensValue, hwgroup=hwgroup, inpIndex=inpIndex, sensName=sensName, tsAlarmIdx=tsAlarmIdx, tsAlarmDescr=tsAlarmDescr, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, inpName=inpName, OutputType=OutputType, SensorString=SensorString, SensorFlags=SensorFlags, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, sensLimitMax=sensLimitMax, inpValue=inpValue, sensHysteresis=sensHysteresis, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, outType=outType, PositiveInteger=PositiveInteger)
