...
Bits, Counter32, Counter64, Gauge32, iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, MibIdentifier, enterprises, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Counter64", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "MibIdentifier", "enterprises", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, unitType=unitType, sensSetupEntry=sensSetupEntry, SensorFlags=SensorFlags, outTable=outTable, sensTable=sensTable, sensLimitMax=sensLimitMax, tsAlarmIdx=tsAlarmIdx, info=info, SensorValue=SensorValue, InputAlarmState=InputAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, OutputType=OutputType, SensorName=SensorName, outName=outName, sensFlags=sensFlags, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, setup=setup, inpEntry=inpEntry, poseidon=poseidon, outMode=outMode, OutputMode=OutputMode, sensUnit=sensUnit, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, outValue=outValue, IOName=IOName, outType=outType, SensorString=SensorString, inpAlarmState=inpAlarmState, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, outEntry=outEntry, sensName=sensName, sensSetupIndex=sensSetupIndex, sensState=sensState, tsAlarmTable=tsAlarmTable, UnitType=UnitType, sensID=sensID, SensorUnitString=SensorUnitString, sensHysteresis=sensHysteresis, sensEntry=sensEntry, inpValue=inpValue, inpIndex=inpIndex, inpName=inpName, outIndex=outIndex, PositiveInteger=PositiveInteger, sensString=sensString, SensorID=SensorID, sensValue=sensValue, charonII=charonII, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, tsAlarmId=tsAlarmId, inpTable=inpTable, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, tsAlarm=tsAlarm)
