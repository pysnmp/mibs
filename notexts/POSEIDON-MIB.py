...
Integer32, enterprises, MibIdentifier, Unsigned32, ModuleIdentity, Counter32, iso, Counter64, ObjectIdentity, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "iso", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, tsAlarmTable=tsAlarmTable, inpValue=inpValue, outValue=outValue, sensAlarmStateChanged=sensAlarmStateChanged, setup=setup, tsAlarmId=tsAlarmId, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, outType=outType, sensSetupName=sensSetupName, hwgroup=hwgroup, unitType=unitType, sensIndex=sensIndex, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, outName=outName, sensSetup=sensSetup, SensorID=SensorID, sensEntry=sensEntry, sensValueRaw=sensValueRaw, OutputMode=OutputMode, inpName=inpName, inpAlarmState=inpAlarmState, sensID=sensID, sensSetupEntry=sensSetupEntry, OnOff=OnOff, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, SensorFlags=SensorFlags, outTable=outTable, sensLimitMin=sensLimitMin, inpTable=inpTable, sensName=sensName, UnitType=UnitType, sensState=sensState, sensUnit=sensUnit, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, outIndex=outIndex, poseidon=poseidon, SensorName=SensorName, sensValue=sensValue, sensTable=sensTable, sensString=sensString, sensSetupTable=sensSetupTable, IOName=IOName, inpIndex=inpIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, inpAlarmStateChanged=inpAlarmStateChanged, outMode=outMode, sensFlags=sensFlags, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, info=info, infoAddressMAC=infoAddressMAC, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, sensUnitString=sensUnitString, tsAlarm=tsAlarm)
