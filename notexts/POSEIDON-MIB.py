...
iso, Gauge32, Counter64, NotificationType, MibIdentifier, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, TimeTicks, Unsigned32, ModuleIdentity, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter64", "NotificationType", "MibIdentifier", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "TimeTicks", "Unsigned32", "ModuleIdentity", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, sensString=sensString, inpAlarmState=inpAlarmState, outMode=outMode, sensUnit=sensUnit, sensTable=sensTable, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensValueRaw=sensValueRaw, OutputType=OutputType, SensorID=SensorID, SensorValue=SensorValue, inpValue=inpValue, sensState=sensState, sensValue=sensValue, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, inpTable=inpTable, inpName=inpName, outName=outName, sensLimitMin=sensLimitMin, charonII=charonII, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, sensID=sensID, OutputMode=OutputMode, tsAlarmEntry=tsAlarmEntry, sensName=sensName, outIndex=outIndex, OnOff=OnOff, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmId=tsAlarmId, info=info, inpEntry=inpEntry, unitType=unitType, SensorFlags=SensorFlags, SensorName=SensorName, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, IOName=IOName, sensHysteresis=sensHysteresis, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, setup=setup, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, sensEntry=sensEntry, UnitType=UnitType, tsAlarmTable=tsAlarmTable, outTable=outTable, sensSetupTable=sensSetupTable, PositiveInteger=PositiveInteger, outType=outType, outEntry=outEntry, TimeStamp=TimeStamp)
