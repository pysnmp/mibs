...
Bits, Integer32, Counter32, ObjectIdentity, MibIdentifier, NotificationType, Gauge32, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "Counter32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, poseidon=poseidon, inpTable=inpTable, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, outType=outType, SensorState=SensorState, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, outEntry=outEntry, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, IOName=IOName, tsAlarmDescr=tsAlarmDescr, tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, inpValue=inpValue, UnitType=UnitType, outIndex=outIndex, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, sensIndex=sensIndex, SensorID=SensorID, sensEntry=sensEntry, inpAlarmState=inpAlarmState, sensUnit=sensUnit, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId, SensorFlags=SensorFlags, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, sensID=sensID, sensSetup=sensSetup, InputAlarmState=InputAlarmState, OnOff=OnOff, SensorUnitString=SensorUnitString, sensState=sensState, setup=setup, PositiveInteger=PositiveInteger, SensorString=SensorString, sensName=sensName, unitType=unitType, inpEntry=inpEntry, outTable=outTable, outValue=outValue, outName=outName, inpName=inpName, info=info, sensValue=sensValue, sensValueRaw=sensValueRaw, hwgroup=hwgroup, SensorName=SensorName, charonII=charonII, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, sensTable=sensTable, TimeStamp=TimeStamp, inpIndex=inpIndex, SensorValue=SensorValue, tsAlarmEntry=tsAlarmEntry, outMode=outMode)
