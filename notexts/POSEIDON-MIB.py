...
Integer32, Gauge32, NotificationType, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter32, ObjectIdentity, IpAddress, ModuleIdentity, Counter64, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter64", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, SensorString=SensorString, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, sensFlags=sensFlags, OutputMode=OutputMode, sensLimitMax=sensLimitMax, sensSetupTable=sensSetupTable, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, sensUnitString=sensUnitString, unitType=unitType, setup=setup, outValue=outValue, sensEntry=sensEntry, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, sensID=sensID, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, OutputType=OutputType, tsAlarmSensName=tsAlarmSensName, inpName=inpName, sensLimitMin=sensLimitMin, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, inpTable=inpTable, sensSetupEntry=sensSetupEntry, poseidon=poseidon, SensorUnitString=SensorUnitString, info=info, sensTable=sensTable, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, outMode=outMode, SensorState=SensorState, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, inpEntry=inpEntry, inpValue=inpValue, outType=outType, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, SensorFlags=SensorFlags, sensSetupName=sensSetupName, hwgroup=hwgroup, sensString=sensString, IOName=IOName, SensorID=SensorID, outName=outName, PositiveInteger=PositiveInteger, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, sensState=sensState, InputAlarmState=InputAlarmState, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, sensUnit=sensUnit, inpIndex=inpIndex, SensorName=SensorName, UnitType=UnitType, SensorValue=SensorValue, charonII=charonII, OnOff=OnOff)
