...
Gauge32, iso, ObjectIdentity, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter64, enterprises, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter64", "enterprises", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, hwgroup=hwgroup, SensorValue=SensorValue, outIndex=outIndex, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, outType=outType, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, UnitType=UnitType, sensState=sensState, inpEntry=inpEntry, sensValue=sensValue, sensSetup=sensSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, outMode=outMode, sensName=sensName, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, sensFlags=sensFlags, SensorString=SensorString, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, outEntry=outEntry, sensString=sensString, OutputType=OutputType, inpIndex=inpIndex, sensTable=sensTable, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, info=info, sensLimitMin=sensLimitMin, outValue=outValue, charonII=charonII, inpAlarmSetup=inpAlarmSetup, IOName=IOName, poseidon=poseidon, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmId=tsAlarmId, tsAlarm=tsAlarm, sensSetupName=sensSetupName, infoAddressMAC=infoAddressMAC, SensorName=SensorName, OutputMode=OutputMode, SensorID=SensorID, SensorUnitString=SensorUnitString, inpValue=inpValue, SensorFlags=SensorFlags, sensUnit=sensUnit, inpName=inpName, tsAlarmSensName=tsAlarmSensName, inpTable=inpTable, sensSetupTable=sensSetupTable, InputAlarmSetup=InputAlarmSetup, unitType=unitType, outName=outName, sensID=sensID, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, setup=setup, outTable=outTable)
