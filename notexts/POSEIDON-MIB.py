...
TimeTicks, NotificationType, iso, ObjectIdentity, IpAddress, Bits, Unsigned32, ModuleIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, outEntry=outEntry, sensName=sensName, sensValueRaw=sensValueRaw, inpValue=inpValue, sensString=sensString, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, inpEntry=inpEntry, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, SensorString=SensorString, outIndex=outIndex, TimeStamp=TimeStamp, sensTable=sensTable, outType=outType, sensFlags=sensFlags, SensorState=SensorState, info=info, inpTable=inpTable, sensEntry=sensEntry, sensAlarmStateChanged=sensAlarmStateChanged, sensIndex=sensIndex, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, outValue=outValue, UnitType=UnitType, SensorFlags=SensorFlags, charonII=charonII, setup=setup, outMode=outMode, SensorUnitString=SensorUnitString, tsAlarm=tsAlarm, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, sensHysteresis=sensHysteresis, tsAlarmTime=tsAlarmTime, hwgroup=hwgroup, sensState=sensState, OutputMode=OutputMode, InputAlarmState=InputAlarmState, poseidon=poseidon, outTable=outTable, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, sensID=sensID, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, sensSetupIndex=sensSetupIndex, sensValue=sensValue, SensorName=SensorName, SensorValue=SensorValue, tsAlarmSensName=tsAlarmSensName, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, outName=outName, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, OnOff=OnOff, inpName=inpName, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin)
