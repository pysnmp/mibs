...
iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, NotificationType, ObjectIdentity, Gauge32, Integer32, Bits, Counter32, MibIdentifier, enterprises, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Gauge32", "Integer32", "Bits", "Counter32", "MibIdentifier", "enterprises", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupEntry=sensSetupEntry, sensValueRaw=sensValueRaw, info=info, sensTable=sensTable, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMin=sensLimitMin, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, tsAlarm=tsAlarm, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable, setup=setup, OutputMode=OutputMode, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, outTable=outTable, outMode=outMode, OutputType=OutputType, inpValue=inpValue, inpEntry=inpEntry, outEntry=outEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, IOName=IOName, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmSetup=inpAlarmSetup, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx, sensState=sensState, sensSetupName=sensSetupName, sensSetup=sensSetup, inpAlarmState=inpAlarmState, outType=outType, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, sensUnit=sensUnit, sensHysteresis=sensHysteresis, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, SensorName=SensorName, InputAlarmState=InputAlarmState, outIndex=outIndex, outValue=outValue, SensorID=SensorID, TimeStamp=TimeStamp, poseidon=poseidon, sensSetupTable=sensSetupTable, inpIndex=inpIndex, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, sensName=sensName, UnitType=UnitType, inpTable=inpTable, sensIndex=sensIndex, SensorState=SensorState, sensString=sensString, sensID=sensID, outName=outName, sensEntry=sensEntry, inpName=inpName, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, SensorString=SensorString, sensValue=sensValue)
