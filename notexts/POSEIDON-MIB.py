...
TimeTicks, ObjectIdentity, MibIdentifier, Counter32, ModuleIdentity, enterprises, Integer32, Unsigned32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "Unsigned32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, SensorUnitString=SensorUnitString, sensHysteresis=sensHysteresis, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, inpAlarmState=inpAlarmState, SensorValue=SensorValue, outMode=outMode, sensID=sensID, sensSetupName=sensSetupName, TimeStamp=TimeStamp, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, sensUnit=sensUnit, tsAlarm=tsAlarm, inpAlarmStateChanged=inpAlarmStateChanged, outName=outName, tsAlarmTable=tsAlarmTable, sensSetupEntry=sensSetupEntry, sensSetupTable=sensSetupTable, outEntry=outEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmDescr=tsAlarmDescr, inpValue=inpValue, SensorString=SensorString, InputAlarmState=InputAlarmState, inpTable=inpTable, inpName=inpName, unitType=unitType, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, OutputType=OutputType, tsAlarmsPresent=tsAlarmsPresent, IOName=IOName, SensorID=SensorID, sensSetup=sensSetup, inpAlarmSetup=inpAlarmSetup, setup=setup, sensEntry=sensEntry, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, tsAlarmSensName=tsAlarmSensName, outIndex=outIndex, UnitType=UnitType, sensIndex=sensIndex, sensLimitMax=sensLimitMax, sensValue=sensValue, sensString=sensString, PositiveInteger=PositiveInteger, sensState=sensState, OutputMode=OutputMode, SensorState=SensorState, info=info, sensSetupIndex=sensSetupIndex, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, OnOff=OnOff, charonII=charonII, SensorName=SensorName, hwgroup=hwgroup, sensName=sensName, outTable=outTable, outValue=outValue, outType=outType, poseidon=poseidon)
