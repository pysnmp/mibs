...
Bits, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, enterprises, NotificationType, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "enterprises", "NotificationType", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, sensID=sensID, inpName=inpName, PositiveInteger=PositiveInteger, sensValue=sensValue, tsAlarm=tsAlarm, outName=outName, setup=setup, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, outTable=outTable, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, OutputType=OutputType, tsAlarmTable=tsAlarmTable, tsTrapAlarmStart=tsTrapAlarmStart, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, outValue=outValue, sensFlags=sensFlags, UnitType=UnitType, outType=outType, sensState=sensState, sensSetupIndex=sensSetupIndex, info=info, SensorValue=SensorValue, inpTable=inpTable, outMode=outMode, sensString=sensString, SensorString=SensorString, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, hwgroup=hwgroup, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode, sensSetupTable=sensSetupTable, inpEntry=inpEntry, SensorState=SensorState, inpValue=inpValue, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, unitType=unitType, sensHysteresis=sensHysteresis, sensSetup=sensSetup, SensorID=SensorID, tsAlarmId=tsAlarmId, charonII=charonII, sensName=sensName, infoAddressMAC=infoAddressMAC, inpIndex=inpIndex, poseidon=poseidon, sensValueRaw=sensValueRaw, outEntry=outEntry, sensTable=sensTable, sensUnitString=sensUnitString, SensorName=SensorName, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, tsAlarmEntry=tsAlarmEntry, OnOff=OnOff, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime)
