...
# ASN.1 source POSEIDON-MIB
# Source digest sha256:0e3f355be5933bc7344598cead4eb81eba715495487b8f6a05ef33f43bd0fb1b
...
inpTable = MibTable((1, 3, 6, 1, 4, 1, 21796, 3, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: inpTable.setStatus('current')
inpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 21796, 3, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "POSEIDON-MIB", "inpIndex"))
if mibBuilder.loadTexts: inpEntry.setStatus('current')
inpIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 1, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
outTable = MibTable((1, 3, 6, 1, 4, 1, 21796, 3, 3, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: outTable.setStatus('current')
outEntry = MibTableRow((1, 3, 6, 1, 4, 1, 21796, 3, 3, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "POSEIDON-MIB", "outIndex"))
if mibBuilder.loadTexts: outEntry.setStatus('current')
outIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 2, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
sensTable = MibTable((1, 3, 6, 1, 4, 1, 21796, 3, 3, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sensTable.setStatus('current')
sensEntry = MibTableRow((1, 3, 6, 1, 4, 1, 21796, 3, 3, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "POSEIDON-MIB", "sensIndex"))
if mibBuilder.loadTexts: sensEntry.setStatus('current')
sensIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 3, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
tsAlarmTable = MibTable((1, 3, 6, 1, 4, 1, 21796, 3, 3, 50, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: tsAlarmTable.setStatus('current')
tsAlarmEntry = MibTableRow((1, 3, 6, 1, 4, 1, 21796, 3, 3, 50, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "POSEIDON-MIB", "tsAlarmIdx"))
if mibBuilder.loadTexts: tsAlarmEntry.setStatus('current')
tsAlarmIdx = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 50, 2, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
sensSetupTable = MibTable((1, 3, 6, 1, 4, 1, 21796, 3, 3, 99, 1, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sensSetupTable.setStatus('current')
sensSetupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 21796, 3, 3, 99, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "POSEIDON-MIB", "sensSetupIndex"))
if mibBuilder.loadTexts: sensSetupEntry.setStatus('current')
sensSetupIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 99, 1, 2, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, OnOff=OnOff, OutputMode=OutputMode, OutputType=OutputType, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, SensorID=SensorID, SensorName=SensorName, SensorState=SensorState, SensorString=SensorString, SensorUnitString=SensorUnitString, SensorValue=SensorValue, TimeStamp=TimeStamp, UnitType=UnitType, charonII=charonII, hwgroup=hwgroup, info=info, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, inpIndex=inpIndex, inpName=inpName, inpTable=inpTable, inpValue=inpValue, outEntry=outEntry, outIndex=outIndex, outMode=outMode, outName=outName, outTable=outTable, outType=outType, outValue=outValue, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, sensEntry=sensEntry, sensFlags=sensFlags, sensHysteresis=sensHysteresis, sensID=sensID, sensIndex=sensIndex, sensLimitMax=sensLimitMax, sensLimitMin=sensLimitMin, sensName=sensName, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, sensSetupTable=sensSetupTable, sensState=sensState, sensString=sensString, sensTable=sensTable, sensUnit=sensUnit, sensUnitString=sensUnitString, sensValue=sensValue, sensValueRaw=sensValueRaw, setup=setup, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, tsAlarmTable=tsAlarmTable, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType)
