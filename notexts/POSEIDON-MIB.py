...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, MibIdentifier, iso, Integer32, Counter32, Gauge32, TimeTicks, NotificationType, ModuleIdentity, Bits, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "Integer32", "Counter32", "Gauge32", "TimeTicks", "NotificationType", "ModuleIdentity", "Bits", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmStart=tsTrapAlarmStart, sensID=sensID, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, tsAlarm=tsAlarm, outValue=outValue, sensUnit=sensUnit, OnOff=OnOff, sensString=sensString, charonII=charonII, SensorName=SensorName, SensorUnitString=SensorUnitString, SensorID=SensorID, outName=outName, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, sensLimitMin=sensLimitMin, sensTable=sensTable, sensEntry=sensEntry, sensState=sensState, sensSetupEntry=sensSetupEntry, tsAlarmTime=tsAlarmTime, inpValue=inpValue, PositiveInteger=PositiveInteger, InputAlarmSetup=InputAlarmSetup, inpName=inpName, tsAlarmTable=tsAlarmTable, setup=setup, inpIndex=inpIndex, hwgroup=hwgroup, sensFlags=sensFlags, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, outTable=outTable, sensSetupTable=sensSetupTable, inpAlarmSetup=inpAlarmSetup, inpTable=inpTable, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, sensUnitString=sensUnitString, SensorState=SensorState, SensorValue=SensorValue, OutputType=OutputType, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, outType=outType, tsAlarmEntry=tsAlarmEntry, sensValue=sensValue, unitType=unitType, sensName=sensName, inpEntry=inpEntry, outEntry=outEntry, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, UnitType=UnitType, poseidon=poseidon, info=info, sensSetupName=sensSetupName, SensorString=SensorString, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, sensSetupIndex=sensSetupIndex, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, outIndex=outIndex)
