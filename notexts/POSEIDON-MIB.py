...
Integer32, Gauge32, iso, MibIdentifier, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, enterprises, Counter32, IpAddress, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "MibIdentifier", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "enterprises", "Counter32", "IpAddress", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, tsAlarmTime=tsAlarmTime, OutputType=OutputType, TimeStamp=TimeStamp, outName=outName, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, sensFlags=sensFlags, OnOff=OnOff, SensorFlags=SensorFlags, sensID=sensID, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, OutputMode=OutputMode, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, hwgroup=hwgroup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, SensorString=SensorString, sensIndex=sensIndex, sensTable=sensTable, sensState=sensState, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, SensorState=SensorState, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, outValue=outValue, sensUnitString=sensUnitString, setup=setup, sensLimitMin=sensLimitMin, SensorUnitString=SensorUnitString, unitType=unitType, SensorName=SensorName, inpValue=inpValue, PositiveInteger=PositiveInteger, tsAlarmId=tsAlarmId, tsAlarmTable=tsAlarmTable, outTable=outTable, outMode=outMode, IOName=IOName, info=info, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, UnitType=UnitType, charonII=charonII, SensorValue=SensorValue, poseidon=poseidon, tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, outType=outType, inpName=inpName, outIndex=outIndex, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, sensName=sensName, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, SensorID=SensorID, sensString=sensString)
