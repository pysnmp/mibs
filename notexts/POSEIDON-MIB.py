...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, SensorID=SensorID, hwgroup=hwgroup, info=info, UnitType=UnitType, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, outEntry=outEntry, sensString=sensString, OutputType=OutputType, IOName=IOName, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, outName=outName, sensIndex=sensIndex, inpEntry=inpEntry, SensorName=SensorName, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, SensorState=SensorState, inpAlarmState=inpAlarmState, SensorValue=SensorValue, poseidon=poseidon, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, inpName=inpName, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, sensValue=sensValue, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, sensFlags=sensFlags, outIndex=outIndex, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, sensValueRaw=sensValueRaw, setup=setup, sensName=sensName, infoAddressMAC=infoAddressMAC, sensID=sensID, PositiveInteger=PositiveInteger, outMode=outMode, tsAlarmDescr=tsAlarmDescr, inpValue=inpValue, sensLimitMax=sensLimitMax, outTable=outTable, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, tsAlarmTime=tsAlarmTime, inpTable=inpTable, unitType=unitType, outValue=outValue, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, SensorString=SensorString, outType=outType)
