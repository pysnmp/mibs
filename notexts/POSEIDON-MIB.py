...
IpAddress, Integer32, Unsigned32, Counter32, ModuleIdentity, iso, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter64, Gauge32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Unsigned32", "Counter32", "ModuleIdentity", "iso", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter64", "Gauge32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, OnOff=OnOff, SensorID=SensorID, SensorFlags=SensorFlags, outEntry=outEntry, poseidon=poseidon, SensorState=SensorState, sensSetup=sensSetup, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, sensLimitMax=sensLimitMax, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, sensState=sensState, tsAlarmIdx=tsAlarmIdx, sensFlags=sensFlags, OutputType=OutputType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, SensorUnitString=SensorUnitString, outValue=outValue, sensString=sensString, tsAlarmTime=tsAlarmTime, unitType=unitType, inpTable=inpTable, outMode=outMode, SensorString=SensorString, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, charonII=charonII, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupTable=sensSetupTable, IOName=IOName, sensUnitString=sensUnitString, tsAlarm=tsAlarm, sensEntry=sensEntry, inpValue=inpValue, outType=outType, sensName=sensName, inpName=inpName, outTable=outTable, SensorName=SensorName, tsAlarmTable=tsAlarmTable, tsTrapAlarmStart=tsTrapAlarmStart, info=info, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, SensorValue=SensorValue, OutputMode=OutputMode, outName=outName, sensTable=sensTable, sensValue=sensValue, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, sensHysteresis=sensHysteresis, hwgroup=hwgroup, setup=setup, sensIndex=sensIndex, inpAlarmState=inpAlarmState, sensID=sensID, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged)
