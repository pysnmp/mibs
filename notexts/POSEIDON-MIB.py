...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, NotificationType, ModuleIdentity, TimeTicks, Unsigned32, iso, Integer32, ObjectIdentity, IpAddress, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "Integer32", "ObjectIdentity", "IpAddress", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, SensorFlags=SensorFlags, IOName=IOName, tsAlarmId=tsAlarmId, OutputMode=OutputMode, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, sensString=sensString, OutputType=OutputType, sensSetupEntry=sensSetupEntry, charonII=charonII, sensName=sensName, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, sensSetup=sensSetup, outTable=outTable, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, sensState=sensState, UnitType=UnitType, inpIndex=inpIndex, SensorName=SensorName, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, outName=outName, outType=outType, sensSetupIndex=sensSetupIndex, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, unitType=unitType, sensSetupTable=sensSetupTable, sensAlarmStateChanged=sensAlarmStateChanged, sensEntry=sensEntry, tsAlarm=tsAlarm, hwgroup=hwgroup, InputAlarmSetup=InputAlarmSetup, outValue=outValue, setup=setup, sensFlags=sensFlags, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, sensID=sensID, inpAlarmState=inpAlarmState, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, inpEntry=inpEntry, PositiveInteger=PositiveInteger, SensorString=SensorString, SensorID=SensorID, SensorUnitString=SensorUnitString, outMode=outMode, inpTable=inpTable, sensValue=sensValue, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, poseidon=poseidon, sensHysteresis=sensHysteresis, inpName=inpName, inpValue=inpValue, sensIndex=sensIndex, TimeStamp=TimeStamp, info=info, sensTable=sensTable, sensUnitString=sensUnitString, inpAlarmStateChanged=inpAlarmStateChanged)
