...
Gauge32, NotificationType, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Bits, Integer32, Counter64, Counter32, ObjectIdentity, IpAddress, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Bits", "Integer32", "Counter64", "Counter32", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, sensUnit=sensUnit, tsAlarmId=tsAlarmId, sensString=sensString, inpValue=inpValue, outType=outType, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, OutputType=OutputType, sensTable=sensTable, sensValueRaw=sensValueRaw, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, UnitType=UnitType, tsAlarmTime=tsAlarmTime, info=info, unitType=unitType, SensorState=SensorState, tsAlarm=tsAlarm, sensState=sensState, sensSetupIndex=sensSetupIndex, SensorFlags=SensorFlags, charonII=charonII, outName=outName, sensHysteresis=sensHysteresis, inpName=inpName, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, setup=setup, SensorValue=SensorValue, outIndex=outIndex, sensIndex=sensIndex, sensLimitMin=sensLimitMin, sensValue=sensValue, SensorUnitString=SensorUnitString, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, outValue=outValue, sensName=sensName, infoAddressMAC=infoAddressMAC, outTable=outTable, inpIndex=inpIndex, sensUnitString=sensUnitString, SensorID=SensorID, outMode=outMode, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, sensLimitMax=sensLimitMax, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, SensorName=SensorName, inpTable=inpTable, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTable=tsAlarmTable, OnOff=OnOff, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode)
