...
Gauge32, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, IpAddress, ModuleIdentity, Unsigned32, enterprises, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "enterprises", "iso", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, SensorFlags=SensorFlags, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, sensValue=sensValue, SensorID=SensorID, InputAlarmState=InputAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, outType=outType, sensTable=sensTable, outEntry=outEntry, inpIndex=inpIndex, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, poseidon=poseidon, sensSetupEntry=sensSetupEntry, SensorName=SensorName, sensSetupIndex=sensSetupIndex, sensUnit=sensUnit, OutputMode=OutputMode, inpEntry=inpEntry, outIndex=outIndex, inpValue=inpValue, IOName=IOName, outValue=outValue, outName=outName, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, SensorValue=SensorValue, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, sensLimitMax=sensLimitMax, OnOff=OnOff, PositiveInteger=PositiveInteger, tsAlarmId=tsAlarmId, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, inpName=inpName, outMode=outMode, outTable=outTable, sensID=sensID, TimeStamp=TimeStamp, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, sensName=sensName, UnitType=UnitType, sensLimitMin=sensLimitMin, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, setup=setup, OutputType=OutputType, SensorState=SensorState, SensorString=SensorString, info=info, inpTable=inpTable, sensEntry=sensEntry, charonII=charonII, sensIndex=sensIndex, unitType=unitType, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged)
