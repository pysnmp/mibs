...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter32, TimeTicks, Counter64, iso, IpAddress, Bits, ModuleIdentity, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter32", "TimeTicks", "Counter64", "iso", "IpAddress", "Bits", "ModuleIdentity", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, SensorFlags=SensorFlags, sensTable=sensTable, SensorName=SensorName, OnOff=OnOff, sensID=sensID, tsAlarmDescr=tsAlarmDescr, unitType=unitType, setup=setup, SensorValue=SensorValue, outType=outType, sensValueRaw=sensValueRaw, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, sensName=sensName, inpIndex=inpIndex, sensState=sensState, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, info=info, sensFlags=sensFlags, outName=outName, outIndex=outIndex, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, outValue=outValue, sensUnit=sensUnit, SensorState=SensorState, SensorString=SensorString, sensUnitString=sensUnitString, inpAlarmState=inpAlarmState, hwgroup=hwgroup, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, sensString=sensString, sensLimitMax=sensLimitMax, inpName=inpName, tsAlarmTable=tsAlarmTable, poseidon=poseidon, outEntry=outEntry, SensorID=SensorID, sensValue=sensValue, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, sensSetupIndex=sensSetupIndex, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, inpAlarmSetup=inpAlarmSetup, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId, IOName=IOName, outMode=outMode, sensIndex=sensIndex, InputAlarmState=InputAlarmState, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, UnitType=UnitType, inpValue=inpValue, outTable=outTable, PositiveInteger=PositiveInteger, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable)
