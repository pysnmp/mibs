...
NotificationType, Counter32, ModuleIdentity, enterprises, Bits, MibIdentifier, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Counter64, TimeTicks, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ModuleIdentity", "enterprises", "Bits", "MibIdentifier", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Counter64", "TimeTicks", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, sensFlags=sensFlags, outName=outName, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, sensHysteresis=sensHysteresis, sensEntry=sensEntry, inpTable=inpTable, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, inpEntry=inpEntry, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, sensSetupIndex=sensSetupIndex, sensUnit=sensUnit, inpIndex=inpIndex, TimeStamp=TimeStamp, info=info, setup=setup, PositiveInteger=PositiveInteger, charonII=charonII, infoAddressMAC=infoAddressMAC, outValue=outValue, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, inpAlarmState=inpAlarmState, IOName=IOName, inpName=inpName, hwgroup=hwgroup, outTable=outTable, InputAlarmState=InputAlarmState, SensorValue=SensorValue, sensTable=sensTable, UnitType=UnitType, sensState=sensState, SensorString=SensorString, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, outMode=outMode, sensID=sensID, outEntry=outEntry, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, OutputMode=OutputMode, OnOff=OnOff, SensorID=SensorID, unitType=unitType, inpValue=inpValue, sensValue=sensValue, sensUnitString=sensUnitString, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, sensString=sensString, OutputType=OutputType, sensName=sensName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, outType=outType, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, tsAlarmsPresent=tsAlarmsPresent, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName)
