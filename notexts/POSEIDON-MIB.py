...
Counter32, Unsigned32, NotificationType, iso, MibIdentifier, TimeTicks, IpAddress, Counter64, Integer32, Gauge32, enterprises, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "IpAddress", "Counter64", "Integer32", "Gauge32", "enterprises", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensHysteresis=sensHysteresis, IOName=IOName, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, unitType=unitType, SensorString=SensorString, inpName=inpName, hwgroup=hwgroup, inpEntry=inpEntry, setup=setup, tsAlarmIdx=tsAlarmIdx, tsAlarmTable=tsAlarmTable, tsAlarm=tsAlarm, info=info, outType=outType, sensTable=sensTable, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, outIndex=outIndex, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, SensorValue=SensorValue, inpTable=inpTable, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, outValue=outValue, sensFlags=sensFlags, inpIndex=inpIndex, sensLimitMin=sensLimitMin, sensName=sensName, tsAlarmId=tsAlarmId, outName=outName, outTable=outTable, InputAlarmState=InputAlarmState, OnOff=OnOff, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, SensorState=SensorState, inpValue=inpValue, SensorFlags=SensorFlags, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, outEntry=outEntry, TimeStamp=TimeStamp, sensLimitMax=sensLimitMax, SensorUnitString=SensorUnitString, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, infoAddressMAC=infoAddressMAC, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensString=sensString, tsAlarmSensName=tsAlarmSensName, sensEntry=sensEntry, sensID=sensID, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, OutputMode=OutputMode, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, charonII=charonII, outMode=outMode, sensSetup=sensSetup)
