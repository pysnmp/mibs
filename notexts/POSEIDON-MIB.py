...
Gauge32, Counter32, ModuleIdentity, Unsigned32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, IpAddress, Counter64, ObjectIdentity, iso, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "IpAddress", "Counter64", "ObjectIdentity", "iso", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, outIndex=outIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensIndex=sensIndex, InputAlarmSetup=InputAlarmSetup, infoAddressMAC=infoAddressMAC, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, TimeStamp=TimeStamp, sensID=sensID, sensValueRaw=sensValueRaw, poseidon=poseidon, SensorString=SensorString, sensFlags=sensFlags, inpIndex=inpIndex, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, tsAlarmTime=tsAlarmTime, SensorValue=SensorValue, sensUnit=sensUnit, UnitType=UnitType, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, PositiveInteger=PositiveInteger, inpEntry=inpEntry, tsAlarmId=tsAlarmId, OutputType=OutputType, sensSetup=sensSetup, outValue=outValue, tsAlarmsPresent=tsAlarmsPresent, sensState=sensState, sensSetupIndex=sensSetupIndex, SensorState=SensorState, hwgroup=hwgroup, inpName=inpName, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, unitType=unitType, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, SensorID=SensorID, InputAlarmState=InputAlarmState, outTable=outTable, charonII=charonII, tsAlarmEntry=tsAlarmEntry, info=info, sensSetupTable=sensSetupTable, IOName=IOName, outEntry=outEntry, setup=setup, sensString=sensString, outType=outType, inpAlarmSetup=inpAlarmSetup, sensName=sensName, sensEntry=sensEntry, outName=outName, outMode=outMode, sensHysteresis=sensHysteresis, inpValue=inpValue, OnOff=OnOff, sensSetupEntry=sensSetupEntry, inpTable=inpTable, OutputMode=OutputMode, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, sensTable=sensTable, sensUnitString=sensUnitString)
