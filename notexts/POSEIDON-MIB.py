...
Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, IpAddress, Integer32, Gauge32, ObjectIdentity, Bits, enterprises, NotificationType, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "IpAddress", "Integer32", "Gauge32", "ObjectIdentity", "Bits", "enterprises", "NotificationType", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, unitType=unitType, SensorName=SensorName, outType=outType, inpName=inpName, sensEntry=sensEntry, sensUnit=sensUnit, SensorState=SensorState, SensorUnitString=SensorUnitString, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, OutputMode=OutputMode, sensUnitString=sensUnitString, PositiveInteger=PositiveInteger, inpTable=inpTable, InputAlarmState=InputAlarmState, OutputType=OutputType, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, sensState=sensState, sensFlags=sensFlags, IOName=IOName, inpValue=inpValue, sensHysteresis=sensHysteresis, SensorID=SensorID, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, outIndex=outIndex, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, info=info, sensSetupName=sensSetupName, inpIndex=inpIndex, SensorString=SensorString, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, inpEntry=inpEntry, outEntry=outEntry, OnOff=OnOff, outName=outName, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, SensorValue=SensorValue, sensID=sensID, setup=setup, sensSetup=sensSetup, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, outTable=outTable, sensString=sensString, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, sensTable=sensTable, outValue=outValue, tsAlarmId=tsAlarmId, charonII=charonII, tsAlarmSensName=tsAlarmSensName, outMode=outMode, poseidon=poseidon, TimeStamp=TimeStamp, infoAddressMAC=infoAddressMAC, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags)
