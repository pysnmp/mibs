...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, iso, enterprises, Counter32, Integer32, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, NotificationType, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "iso", "enterprises", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "NotificationType", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMax=sensLimitMax, sensID=sensID, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, hwgroup=hwgroup, sensSetup=sensSetup, UnitType=UnitType, inpAlarmState=inpAlarmState, outMode=outMode, OnOff=OnOff, InputAlarmState=InputAlarmState, tsAlarmTime=tsAlarmTime, OutputMode=OutputMode, inpAlarmSetup=inpAlarmSetup, inpIndex=inpIndex, inpName=inpName, outType=outType, sensName=sensName, unitType=unitType, sensHysteresis=sensHysteresis, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, outValue=outValue, sensState=sensState, setup=setup, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorValue=SensorValue, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, inpTable=inpTable, SensorString=SensorString, PositiveInteger=PositiveInteger, info=info, outName=outName, sensEntry=sensEntry, tsAlarmId=tsAlarmId, sensIndex=sensIndex, sensTable=sensTable, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, tsAlarmTable=tsAlarmTable, OutputType=OutputType, TimeStamp=TimeStamp, outTable=outTable, charonII=charonII, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, sensSetupName=sensSetupName, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, inpValue=inpValue, sensString=sensString, tsAlarm=tsAlarm, sensFlags=sensFlags, tsAlarmEntry=tsAlarmEntry, tsAlarmsPresent=tsAlarmsPresent, SensorState=SensorState, sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, infoAddressMAC=infoAddressMAC, outIndex=outIndex, SensorID=SensorID, sensUnit=sensUnit, sensValue=sensValue, SensorName=SensorName, IOName=IOName)
