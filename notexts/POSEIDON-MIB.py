...
Gauge32, NotificationType, Integer32, Unsigned32, Counter64, MibIdentifier, ObjectIdentity, Bits, TimeTicks, iso, Counter32, ModuleIdentity, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity", "Bits", "TimeTicks", "iso", "Counter32", "ModuleIdentity", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw, poseidon=poseidon, sensEntry=sensEntry, sensSetupTable=sensSetupTable, sensSetupIndex=sensSetupIndex, SensorUnitString=SensorUnitString, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, unitType=unitType, tsAlarmDescr=tsAlarmDescr, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, OnOff=OnOff, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, outIndex=outIndex, outEntry=outEntry, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, sensUnit=sensUnit, OutputMode=OutputMode, UnitType=UnitType, info=info, sensValue=sensValue, SensorValue=SensorValue, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, inpAlarmState=inpAlarmState, SensorName=SensorName, sensSetupName=sensSetupName, outMode=outMode, SensorState=SensorState, sensTable=sensTable, outValue=outValue, sensState=sensState, SensorID=SensorID, SensorFlags=SensorFlags, setup=setup, sensString=sensString, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, sensUnitString=sensUnitString, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, tsAlarmId=tsAlarmId, sensSetup=sensSetup, OutputType=OutputType, sensHysteresis=sensHysteresis, charonII=charonII, IOName=IOName, outName=outName, inpTable=inpTable, outType=outType, SensorString=SensorString, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, sensName=sensName, hwgroup=hwgroup, sensLimitMax=sensLimitMax)
