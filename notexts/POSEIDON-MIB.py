...
enterprises, Bits, NotificationType, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, ModuleIdentity, Unsigned32, Counter32, MibIdentifier, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "NotificationType", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", hwgroup=hwgroup, OutputMode=OutputMode, inpIndex=inpIndex, sensTable=sensTable, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, SensorString=SensorString, outValue=outValue, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, sensEntry=sensEntry, tsAlarmId=tsAlarmId, tsAlarmEntry=tsAlarmEntry, OnOff=OnOff, sensValue=sensValue, SensorID=SensorID, sensValueRaw=sensValueRaw, unitType=unitType, poseidon=poseidon, SensorUnitString=SensorUnitString, SensorValue=SensorValue, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, sensSetup=sensSetup, SensorState=SensorState, charonII=charonII, TimeStamp=TimeStamp, inpTable=inpTable, inpName=inpName, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, sensString=sensString, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, sensID=sensID, outIndex=outIndex, tsAlarmTable=tsAlarmTable, sensHysteresis=sensHysteresis, IOName=IOName, inpAlarmState=inpAlarmState, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupIndex=sensSetupIndex, tsAlarmTime=tsAlarmTime, sensUnit=sensUnit, setup=setup, sensIndex=sensIndex, sensUnitString=sensUnitString, sensFlags=sensFlags, OutputType=OutputType, SensorName=SensorName, outType=outType, sensName=sensName, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, inpEntry=inpEntry, outEntry=outEntry, outMode=outMode, infoAddressMAC=infoAddressMAC, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, info=info, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, inpValue=inpValue, outName=outName)
