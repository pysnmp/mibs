...
TimeTicks, Counter32, iso, enterprises, Counter64, ModuleIdentity, NotificationType, MibIdentifier, IpAddress, Bits, Gauge32, ObjectIdentity, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "iso", "enterprises", "Counter64", "ModuleIdentity", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, SensorState=SensorState, outEntry=outEntry, SensorID=SensorID, sensState=sensState, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, inpEntry=inpEntry, outType=outType, sensIndex=sensIndex, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, inpIndex=inpIndex, outTable=outTable, sensLimitMin=sensLimitMin, SensorName=SensorName, UnitType=UnitType, inpTable=inpTable, infoAddressMAC=infoAddressMAC, setup=setup, outName=outName, unitType=unitType, tsAlarmTime=tsAlarmTime, OutputType=OutputType, SensorString=SensorString, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, sensTable=sensTable, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, sensString=sensString, sensValueRaw=sensValueRaw, OnOff=OnOff, inpName=inpName, sensSetupTable=sensSetupTable, inpAlarmSetup=inpAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTable=tsAlarmTable, sensName=sensName, sensHysteresis=sensHysteresis, tsAlarmsPresent=tsAlarmsPresent, TimeStamp=TimeStamp, sensSetupEntry=sensSetupEntry, IOName=IOName, PositiveInteger=PositiveInteger, charonII=charonII, sensValue=sensValue, sensID=sensID, sensSetupName=sensSetupName, SensorFlags=SensorFlags, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, SensorUnitString=SensorUnitString, SensorValue=SensorValue, outValue=outValue, tsAlarmSensName=tsAlarmSensName, sensSetup=sensSetup, tsAlarm=tsAlarm, inpAlarmState=inpAlarmState, inpValue=inpValue, sensFlags=sensFlags, outMode=outMode, sensEntry=sensEntry, sensUnit=sensUnit, tsAlarmId=tsAlarmId, info=info)
