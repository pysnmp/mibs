...
enterprises, Unsigned32, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, Counter64, Integer32, iso, Counter32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "Counter64", "Integer32", "iso", "Counter32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, sensName=sensName, sensString=sensString, OutputType=OutputType, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, InputAlarmSetup=InputAlarmSetup, setup=setup, tsAlarm=tsAlarm, OutputMode=OutputMode, SensorString=SensorString, OnOff=OnOff, outEntry=outEntry, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, sensID=sensID, inpValue=inpValue, outMode=outMode, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, inpAlarmState=inpAlarmState, SensorID=SensorID, inpAlarmStateChanged=inpAlarmStateChanged, TimeStamp=TimeStamp, sensSetupIndex=sensSetupIndex, infoAddressMAC=infoAddressMAC, outIndex=outIndex, inpEntry=inpEntry, poseidon=poseidon, tsAlarmId=tsAlarmId, SensorFlags=SensorFlags, InputAlarmState=InputAlarmState, PositiveInteger=PositiveInteger, sensIndex=sensIndex, outTable=outTable, tsAlarmTime=tsAlarmTime, IOName=IOName, SensorUnitString=SensorUnitString, sensSetup=sensSetup, sensLimitMin=sensLimitMin, unitType=unitType, sensEntry=sensEntry, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, info=info, sensLimitMax=sensLimitMax, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, UnitType=UnitType, hwgroup=hwgroup, inpName=inpName, SensorState=SensorState, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, outType=outType, SensorValue=SensorValue, sensUnit=sensUnit, outName=outName, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, charonII=charonII, outValue=outValue, sensSetupEntry=sensSetupEntry)
