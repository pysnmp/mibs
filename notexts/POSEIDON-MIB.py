...
NotificationType, TimeTicks, ObjectIdentity, enterprises, Counter32, ModuleIdentity, Counter64, iso, Unsigned32, IpAddress, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ObjectIdentity", "enterprises", "Counter32", "ModuleIdentity", "Counter64", "iso", "Unsigned32", "IpAddress", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", info=info, OutputMode=OutputMode, sensIndex=sensIndex, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, tsAlarmId=tsAlarmId, SensorUnitString=SensorUnitString, inpIndex=inpIndex, inpName=inpName, outEntry=outEntry, outValue=outValue, sensString=sensString, sensLimitMax=sensLimitMax, UnitType=UnitType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensEntry=sensEntry, SensorState=SensorState, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, hwgroup=hwgroup, poseidon=poseidon, SensorString=SensorString, sensUnit=sensUnit, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, outTable=outTable, sensState=sensState, sensValueRaw=sensValueRaw, inpAlarmSetup=inpAlarmSetup, tsAlarmDescr=tsAlarmDescr, sensTable=sensTable, OnOff=OnOff, SensorName=SensorName, outIndex=outIndex, OutputType=OutputType, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, outMode=outMode, infoAddressMAC=infoAddressMAC, SensorID=SensorID, unitType=unitType, SensorFlags=SensorFlags, inpTable=inpTable, outType=outType, sensSetup=sensSetup, charonII=charonII, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, sensID=sensID, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, sensName=sensName, sensValue=sensValue, tsAlarm=tsAlarm, tsAlarmTable=tsAlarmTable, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, setup=setup, outName=outName, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, IOName=IOName, inpValue=inpValue, tsAlarmTime=tsAlarmTime, tsTrapAlarmStart=tsTrapAlarmStart)
