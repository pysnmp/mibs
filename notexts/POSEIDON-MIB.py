...
Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, IpAddress, NotificationType, Bits, Gauge32, TimeTicks, Counter32, Unsigned32, MibIdentifier, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "IpAddress", "NotificationType", "Bits", "Gauge32", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, sensUnitString=sensUnitString, TimeStamp=TimeStamp, SensorID=SensorID, sensUnit=sensUnit, SensorState=SensorState, sensID=sensID, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, unitType=unitType, inpAlarmSetup=inpAlarmSetup, sensString=sensString, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, charonII=charonII, sensSetupEntry=sensSetupEntry, inpIndex=inpIndex, OutputMode=OutputMode, inpName=inpName, sensState=sensState, infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, sensFlags=sensFlags, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, setup=setup, sensValue=sensValue, sensTable=sensTable, tsAlarmId=tsAlarmId, inpEntry=inpEntry, outMode=outMode, tsAlarm=tsAlarm, SensorName=SensorName, outValue=outValue, outEntry=outEntry, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, outType=outType, tsAlarmDescr=tsAlarmDescr, SensorString=SensorString, OnOff=OnOff, UnitType=UnitType, OutputType=OutputType, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, IOName=IOName, outTable=outTable, SensorUnitString=SensorUnitString, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMax=sensLimitMax, inpValue=inpValue, sensEntry=sensEntry, tsTrapAlarmStart=tsTrapAlarmStart, outName=outName, InputAlarmSetup=InputAlarmSetup, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, SensorFlags=SensorFlags, info=info, sensSetupTable=sensSetupTable)
