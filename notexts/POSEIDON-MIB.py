...
Gauge32, Bits, enterprises, NotificationType, ModuleIdentity, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Integer32, iso, MibIdentifier, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "enterprises", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Integer32", "iso", "MibIdentifier", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, unitType=unitType, sensEntry=sensEntry, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, inpEntry=inpEntry, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, inpTable=inpTable, inpName=inpName, sensID=sensID, SensorState=SensorState, tsAlarm=tsAlarm, OutputType=OutputType, charonII=charonII, inpAlarmState=inpAlarmState, outEntry=outEntry, sensSetupEntry=sensSetupEntry, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, UnitType=UnitType, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, sensName=sensName, OnOff=OnOff, inpIndex=inpIndex, sensLimitMin=sensLimitMin, sensState=sensState, SensorFlags=SensorFlags, sensTable=sensTable, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, SensorUnitString=SensorUnitString, info=info, OutputMode=OutputMode, outName=outName, sensSetupTable=sensSetupTable, SensorID=SensorID, sensString=sensString, inpValue=inpValue, tsAlarmDescr=tsAlarmDescr, setup=setup, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, TimeStamp=TimeStamp, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, outValue=outValue, sensValue=sensValue, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, poseidon=poseidon, outIndex=outIndex, sensValueRaw=sensValueRaw, sensSetup=sensSetup, PositiveInteger=PositiveInteger, hwgroup=hwgroup, outMode=outMode, outType=outType, SensorName=SensorName, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex)
