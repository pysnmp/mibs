...
TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, Counter32, MibIdentifier, iso, Gauge32, Integer32, enterprises, ObjectIdentity, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "MibIdentifier", "iso", "Gauge32", "Integer32", "enterprises", "ObjectIdentity", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, hwgroup=hwgroup, TimeStamp=TimeStamp, SensorState=SensorState, inpName=inpName, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, outEntry=outEntry, setup=setup, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensTable=sensTable, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, info=info, outTable=outTable, unitType=unitType, OnOff=OnOff, inpEntry=inpEntry, outType=outType, sensState=sensState, sensUnitString=sensUnitString, SensorID=SensorID, IOName=IOName, SensorValue=SensorValue, outMode=outMode, sensValueRaw=sensValueRaw, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, outName=outName, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, OutputMode=OutputMode, inpIndex=inpIndex, sensIndex=sensIndex, sensString=sensString, poseidon=poseidon, sensUnit=sensUnit, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, OutputType=OutputType, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, sensSetupIndex=sensSetupIndex, SensorString=SensorString, sensName=sensName, sensID=sensID, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState)
