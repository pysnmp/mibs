...
Integer32, Unsigned32, Counter32, TimeTicks, iso, enterprises, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "TimeTicks", "iso", "enterprises", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, sensHysteresis=sensHysteresis, SensorString=SensorString, hwgroup=hwgroup, info=info, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, setup=setup, IOName=IOName, SensorValue=SensorValue, poseidon=poseidon, inpEntry=inpEntry, sensIndex=sensIndex, tsAlarm=tsAlarm, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, SensorFlags=SensorFlags, sensTable=sensTable, inpTable=inpTable, unitType=unitType, TimeStamp=TimeStamp, outTable=outTable, UnitType=UnitType, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, outType=outType, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, OnOff=OnOff, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, charonII=charonII, SensorID=SensorID, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, outName=outName, sensSetup=sensSetup, infoAddressMAC=infoAddressMAC, SensorState=SensorState, SensorUnitString=SensorUnitString, sensSetupName=sensSetupName, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, sensLimitMax=sensLimitMax, outMode=outMode, inpValue=inpValue, outEntry=outEntry, sensString=sensString, OutputType=OutputType, OutputMode=OutputMode, sensSetupEntry=sensSetupEntry, inpAlarmState=inpAlarmState, outValue=outValue, PositiveInteger=PositiveInteger, SensorName=SensorName, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, inpName=inpName, InputAlarmState=InputAlarmState)
