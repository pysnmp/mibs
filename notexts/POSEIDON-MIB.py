...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Gauge32, Bits, IpAddress, MibIdentifier, Counter32, NotificationType, ObjectIdentity, Integer32, enterprises, Counter64, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Gauge32", "Bits", "IpAddress", "MibIdentifier", "Counter32", "NotificationType", "ObjectIdentity", "Integer32", "enterprises", "Counter64", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outTable=outTable, tsAlarm=tsAlarm, sensSetup=sensSetup, sensUnit=sensUnit, SensorValue=SensorValue, sensValue=sensValue, sensSetupName=sensSetupName, outEntry=outEntry, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, outIndex=outIndex, SensorUnitString=SensorUnitString, IOName=IOName, inpIndex=inpIndex, sensUnitString=sensUnitString, unitType=unitType, SensorName=SensorName, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, info=info, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, sensSetupIndex=sensSetupIndex, poseidon=poseidon, outName=outName, tsAlarmTime=tsAlarmTime, hwgroup=hwgroup, sensName=sensName, tsAlarmTable=tsAlarmTable, outType=outType, SensorID=SensorID, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, setup=setup, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, outValue=outValue, inpValue=inpValue, sensTable=sensTable, OutputMode=OutputMode, SensorString=SensorString, inpTable=inpTable, inpAlarmState=inpAlarmState, sensState=sensState, sensFlags=sensFlags, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, charonII=charonII, outMode=outMode, tsAlarmId=tsAlarmId, sensString=sensString, PositiveInteger=PositiveInteger, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, sensID=sensID, sensValueRaw=sensValueRaw, inpName=inpName, sensIndex=sensIndex, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupTable=sensSetupTable, UnitType=UnitType, infoAddressMAC=infoAddressMAC, SensorFlags=SensorFlags, tsAlarmDescr=tsAlarmDescr, OnOff=OnOff)
