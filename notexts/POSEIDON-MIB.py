...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, NotificationType, enterprises, Unsigned32, MibIdentifier, Gauge32, Counter64, IpAddress, iso, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "NotificationType", "enterprises", "Unsigned32", "MibIdentifier", "Gauge32", "Counter64", "IpAddress", "iso", "ModuleIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, SensorString=SensorString, sensIndex=sensIndex, outValue=outValue, inpAlarmSetup=inpAlarmSetup, tsAlarmId=tsAlarmId, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmState=inpAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnitString=sensUnitString, sensValueRaw=sensValueRaw, sensLimitMax=sensLimitMax, inpValue=inpValue, sensValue=sensValue, OutputMode=OutputMode, sensSetup=sensSetup, sensHysteresis=sensHysteresis, tsAlarmIdx=tsAlarmIdx, inpName=inpName, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, SensorState=SensorState, tsAlarmsPresent=tsAlarmsPresent, sensState=sensState, sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, SensorName=SensorName, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, info=info, charonII=charonII, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, hwgroup=hwgroup, outName=outName, infoAddressMAC=infoAddressMAC, SensorID=SensorID, unitType=unitType, sensID=sensID, SensorFlags=SensorFlags, outMode=outMode, OutputType=OutputType, tsAlarmTime=tsAlarmTime, outEntry=outEntry, OnOff=OnOff, poseidon=poseidon, SensorUnitString=SensorUnitString, inpIndex=inpIndex, outIndex=outIndex, UnitType=UnitType, sensLimitMin=sensLimitMin, IOName=IOName, sensTable=sensTable, SensorValue=SensorValue, sensString=sensString, tsAlarmSensName=tsAlarmSensName, setup=setup, inpTable=inpTable, inpEntry=inpEntry, inpAlarmStateChanged=inpAlarmStateChanged, TimeStamp=TimeStamp, sensUnit=sensUnit, sensSetupName=sensSetupName, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, outTable=outTable)
