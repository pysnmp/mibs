...
NotificationType, Gauge32, Bits, IpAddress, Counter32, Integer32, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Bits", "IpAddress", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, sensValueRaw=sensValueRaw, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmState=inpAlarmState, outName=outName, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, poseidon=poseidon, IOName=IOName, tsAlarmTime=tsAlarmTime, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, tsAlarmDescr=tsAlarmDescr, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, OnOff=OnOff, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, sensUnit=sensUnit, sensID=sensID, outValue=outValue, sensSetupIndex=sensSetupIndex, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, sensSetupTable=sensSetupTable, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, inpValue=inpValue, sensName=sensName, inpName=inpName, inpTable=inpTable, unitType=unitType, hwgroup=hwgroup, outType=outType, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, tsAlarm=tsAlarm, sensValue=sensValue, sensLimitMax=sensLimitMax, tsAlarmIdx=tsAlarmIdx, TimeStamp=TimeStamp, outTable=outTable, inpIndex=inpIndex, sensState=sensState, sensString=sensString, SensorName=SensorName, OutputType=OutputType, SensorValue=SensorValue, tsAlarmId=tsAlarmId, outIndex=outIndex, sensTable=sensTable, inpEntry=inpEntry, sensEntry=sensEntry, outMode=outMode, sensIndex=sensIndex, sensUnitString=sensUnitString, SensorState=SensorState, SensorString=SensorString, sensHysteresis=sensHysteresis, charonII=charonII, SensorUnitString=SensorUnitString, info=info, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, OutputMode=OutputMode, InputAlarmSetup=InputAlarmSetup, SensorID=SensorID)
