...
ModuleIdentity, Gauge32, iso, MibIdentifier, ObjectIdentity, enterprises, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "iso", "MibIdentifier", "ObjectIdentity", "enterprises", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, TimeStamp=TimeStamp, inpIndex=inpIndex, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmStart=tsTrapAlarmStart, inpValue=inpValue, tsAlarmTable=tsAlarmTable, IOName=IOName, sensFlags=sensFlags, outValue=outValue, tsAlarmTime=tsAlarmTime, setup=setup, inpEntry=inpEntry, outType=outType, sensHysteresis=sensHysteresis, outMode=outMode, sensValue=sensValue, SensorID=SensorID, OutputType=OutputType, sensName=sensName, charonII=charonII, poseidon=poseidon, hwgroup=hwgroup, sensState=sensState, sensLimitMax=sensLimitMax, OnOff=OnOff, info=info, sensEntry=sensEntry, OutputMode=OutputMode, outIndex=outIndex, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, sensTable=sensTable, SensorState=SensorState, inpTable=inpTable, tsAlarmId=tsAlarmId, sensUnitString=sensUnitString, outTable=outTable, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, sensSetupIndex=sensSetupIndex, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, inpAlarmState=inpAlarmState, unitType=unitType, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, sensIndex=sensIndex, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensString=sensString, infoAddressMAC=infoAddressMAC, tsAlarmSensName=tsAlarmSensName, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, UnitType=UnitType, SensorString=SensorString, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, PositiveInteger=PositiveInteger, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString)
