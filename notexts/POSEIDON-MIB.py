...
Counter64, Bits, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ObjectIdentity, Integer32, enterprises, MibIdentifier, ModuleIdentity, iso, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ObjectIdentity", "Integer32", "enterprises", "MibIdentifier", "ModuleIdentity", "iso", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, inpName=inpName, sensSetupName=sensSetupName, sensSetupIndex=sensSetupIndex, OnOff=OnOff, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, OutputType=OutputType, sensUnitString=sensUnitString, outIndex=outIndex, sensAlarmStateChanged=sensAlarmStateChanged, PositiveInteger=PositiveInteger, SensorString=SensorString, SensorState=SensorState, sensID=sensID, tsAlarmSensName=tsAlarmSensName, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensState=sensState, unitType=unitType, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupEntry=sensSetupEntry, setup=setup, infoAddressMAC=infoAddressMAC, outMode=outMode, SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, inpTable=inpTable, sensValue=sensValue, outType=outType, UnitType=UnitType, InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, outValue=outValue, outName=outName, sensEntry=sensEntry, SensorValue=SensorValue, OutputMode=OutputMode, hwgroup=hwgroup, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, outTable=outTable, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, sensTable=sensTable, sensLimitMin=sensLimitMin, outEntry=outEntry, tsAlarmTime=tsAlarmTime, sensString=sensString, info=info, sensName=sensName, tsAlarmEntry=tsAlarmEntry, sensUnit=sensUnit, poseidon=poseidon, tsAlarmIdx=tsAlarmIdx, IOName=IOName, sensSetupTable=sensSetupTable, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName, charonII=charonII, SensorID=SensorID)
