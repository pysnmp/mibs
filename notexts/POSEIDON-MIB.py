...
ObjectIdentity, iso, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, TimeTicks, Unsigned32, MibIdentifier, Counter32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmStart=tsTrapAlarmStart, infoAddressMAC=infoAddressMAC, sensValue=sensValue, sensFlags=sensFlags, tsAlarmSensName=tsAlarmSensName, outName=outName, sensLimitMin=sensLimitMin, SensorName=SensorName, hwgroup=hwgroup, charonII=charonII, sensName=sensName, outTable=outTable, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, poseidon=poseidon, OutputType=OutputType, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, OnOff=OnOff, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, SensorID=SensorID, SensorValue=SensorValue, tsAlarmTable=tsAlarmTable, UnitType=UnitType, inpIndex=inpIndex, info=info, SensorUnitString=SensorUnitString, sensUnit=sensUnit, sensID=sensID, outIndex=outIndex, sensLimitMax=sensLimitMax, outValue=outValue, sensString=sensString, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, tsAlarm=tsAlarm, SensorState=SensorState, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, IOName=IOName, sensSetupTable=sensSetupTable, sensState=sensState, tsAlarmTime=tsAlarmTime, sensTable=sensTable, inpName=inpName, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, setup=setup, sensEntry=sensEntry, outType=outType, unitType=unitType, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, inpValue=inpValue)
