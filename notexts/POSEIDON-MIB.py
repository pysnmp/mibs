...
Bits, ObjectIdentity, NotificationType, Gauge32, enterprises, Counter32, iso, Unsigned32, Integer32, ModuleIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "NotificationType", "Gauge32", "enterprises", "Counter32", "iso", "Unsigned32", "Integer32", "ModuleIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, outEntry=outEntry, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId, inpEntry=inpEntry, outTable=outTable, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, inpIndex=inpIndex, tsAlarmSensName=tsAlarmSensName, info=info, inpValue=inpValue, inpAlarmState=inpAlarmState, UnitType=UnitType, hwgroup=hwgroup, sensName=sensName, sensEntry=sensEntry, sensSetupTable=sensSetupTable, SensorName=SensorName, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, sensValue=sensValue, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, SensorState=SensorState, sensUnitString=sensUnitString, outName=outName, unitType=unitType, outValue=outValue, sensTable=sensTable, sensSetupEntry=sensSetupEntry, inpName=inpName, sensAlarmStateChanged=sensAlarmStateChanged, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, SensorString=SensorString, poseidon=poseidon, inpTable=inpTable, sensString=sensString, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, OnOff=OnOff, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, TimeStamp=TimeStamp, sensSetup=sensSetup, inpAlarmStateChanged=inpAlarmStateChanged, sensID=sensID, setup=setup, OutputType=OutputType, SensorValue=SensorValue, outIndex=outIndex, outType=outType, sensSetupName=sensSetupName, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, outMode=outMode, charonII=charonII, IOName=IOName, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, OutputMode=OutputMode, SensorID=SensorID)
