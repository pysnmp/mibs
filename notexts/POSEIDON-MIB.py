...
TimeTicks, Gauge32, Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, enterprises, Bits, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "enterprises", "Bits", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpIndex=inpIndex, TimeStamp=TimeStamp, UnitType=UnitType, SensorName=SensorName, inpValue=inpValue, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensFlags=sensFlags, sensName=sensName, IOName=IOName, sensSetupName=sensSetupName, sensID=sensID, sensHysteresis=sensHysteresis, setup=setup, inpAlarmState=inpAlarmState, outValue=outValue, outMode=outMode, SensorValue=SensorValue, poseidon=poseidon, inpEntry=inpEntry, outIndex=outIndex, sensIndex=sensIndex, tsAlarmEntry=tsAlarmEntry, SensorState=SensorState, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, tsAlarm=tsAlarm, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, outEntry=outEntry, OutputType=OutputType, inpTable=inpTable, sensString=sensString, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable, sensValueRaw=sensValueRaw, sensEntry=sensEntry, outName=outName, outTable=outTable, sensUnit=sensUnit, charonII=charonII, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, sensLimitMax=sensLimitMax, sensSetupTable=sensSetupTable, hwgroup=hwgroup, InputAlarmState=InputAlarmState, SensorString=SensorString, tsAlarmDescr=tsAlarmDescr, inpName=inpName, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, SensorUnitString=SensorUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, sensTable=sensTable, tsAlarmId=tsAlarmId, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin, outType=outType, OutputMode=OutputMode, unitType=unitType, sensState=sensState, SensorID=SensorID, info=info, OnOff=OnOff)
