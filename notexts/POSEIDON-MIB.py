...
ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, ModuleIdentity, Integer32, Unsigned32, iso, Counter64, Gauge32, Bits, IpAddress, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "ModuleIdentity", "Integer32", "Unsigned32", "iso", "Counter64", "Gauge32", "Bits", "IpAddress", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, setup=setup, tsAlarmIdx=tsAlarmIdx, outType=outType, tsAlarmEntry=tsAlarmEntry, outValue=outValue, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, inpValue=inpValue, IOName=IOName, PositiveInteger=PositiveInteger, sensName=sensName, inpAlarmState=inpAlarmState, sensTable=sensTable, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, SensorName=SensorName, hwgroup=hwgroup, sensID=sensID, SensorState=SensorState, UnitType=UnitType, outTable=outTable, InputAlarmSetup=InputAlarmSetup, unitType=unitType, sensSetup=sensSetup, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, outEntry=outEntry, info=info, outName=outName, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, inpIndex=inpIndex, SensorString=SensorString, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmSetup=inpAlarmSetup, poseidon=poseidon, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, sensFlags=sensFlags, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmTime=tsAlarmTime, outMode=outMode, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, SensorValue=SensorValue, SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, outIndex=outIndex, sensEntry=sensEntry, sensValue=sensValue, inpEntry=inpEntry, sensString=sensString, sensUnitString=sensUnitString, inpName=inpName, SensorUnitString=SensorUnitString, SensorID=SensorID, tsAlarmTable=tsAlarmTable, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, sensState=sensState, charonII=charonII, inpTable=inpTable, tsAlarm=tsAlarm)
