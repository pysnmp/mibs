...
Unsigned32, Bits, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, Counter32, iso, IpAddress, Integer32, Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "iso", "IpAddress", "Integer32", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, poseidon=poseidon, SensorState=SensorState, inpName=inpName, tsAlarmSensName=tsAlarmSensName, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, outType=outType, inpAlarmSetup=inpAlarmSetup, SensorID=SensorID, outIndex=outIndex, infoAddressMAC=infoAddressMAC, OnOff=OnOff, inpAlarmState=inpAlarmState, unitType=unitType, sensEntry=sensEntry, inpEntry=inpEntry, SensorName=SensorName, tsAlarm=tsAlarm, sensSetupEntry=sensSetupEntry, charonII=charonII, sensSetup=sensSetup, outTable=outTable, sensUnit=sensUnit, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, inpIndex=inpIndex, outValue=outValue, info=info, outName=outName, SensorString=SensorString, sensSetupIndex=sensSetupIndex, setup=setup, inpTable=inpTable, sensTable=sensTable, PositiveInteger=PositiveInteger, outMode=outMode, OutputType=OutputType, inpValue=inpValue, outEntry=outEntry, sensName=sensName, tsAlarmId=tsAlarmId, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, UnitType=UnitType, sensState=sensState, sensID=sensID, IOName=IOName, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, sensString=sensString, InputAlarmState=InputAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensUnitString=sensUnitString, SensorValue=SensorValue, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, sensLimitMax=sensLimitMax, sensValueRaw=sensValueRaw)
