...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, ModuleIdentity, enterprises, IpAddress, MibIdentifier, Bits, Integer32, Counter64, NotificationType, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "enterprises", "IpAddress", "MibIdentifier", "Bits", "Integer32", "Counter64", "NotificationType", "Counter32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, TimeStamp=TimeStamp, sensID=sensID, InputAlarmSetup=InputAlarmSetup, sensSetupTable=sensSetupTable, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, unitType=unitType, sensHysteresis=sensHysteresis, sensIndex=sensIndex, SensorName=SensorName, sensUnit=sensUnit, setup=setup, PositiveInteger=PositiveInteger, outName=outName, inpIndex=inpIndex, sensTable=sensTable, inpValue=inpValue, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, poseidon=poseidon, InputAlarmState=InputAlarmState, outEntry=outEntry, sensUnitString=sensUnitString, tsAlarmDescr=tsAlarmDescr, info=info, SensorString=SensorString, sensName=sensName, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, tsAlarmId=tsAlarmId, hwgroup=hwgroup, IOName=IOName, sensEntry=sensEntry, outTable=outTable, sensValue=sensValue, sensSetup=sensSetup, inpName=inpName, inpTable=inpTable, SensorFlags=SensorFlags, OutputType=OutputType, sensLimitMin=sensLimitMin, sensString=sensString, tsAlarmTable=tsAlarmTable, OutputMode=OutputMode, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, SensorUnitString=SensorUnitString, inpAlarmStateChanged=inpAlarmStateChanged, outType=outType, sensSetupIndex=sensSetupIndex, sensState=sensState, charonII=charonII, sensFlags=sensFlags, OnOff=OnOff, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, UnitType=UnitType, outIndex=outIndex, outValue=outValue, sensValueRaw=sensValueRaw, SensorID=SensorID, infoAddressMAC=infoAddressMAC, outMode=outMode, tsTrapAlarmStart=tsTrapAlarmStart)
