...
TimeTicks, Integer32, NotificationType, iso, Unsigned32, IpAddress, Counter64, MibIdentifier, Gauge32, ModuleIdentity, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "iso", "Unsigned32", "IpAddress", "Counter64", "MibIdentifier", "Gauge32", "ModuleIdentity", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, tsAlarmEntry=tsAlarmEntry, TimeStamp=TimeStamp, UnitType=UnitType, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, charonII=charonII, hwgroup=hwgroup, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, SensorState=SensorState, inpIndex=inpIndex, SensorFlags=SensorFlags, tsAlarmDescr=tsAlarmDescr, IOName=IOName, outMode=outMode, sensEntry=sensEntry, sensSetupIndex=sensSetupIndex, outTable=outTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, OutputMode=OutputMode, SensorUnitString=SensorUnitString, sensFlags=sensFlags, OnOff=OnOff, sensUnit=sensUnit, sensValueRaw=sensValueRaw, sensTable=sensTable, tsAlarmTime=tsAlarmTime, sensString=sensString, info=info, inpAlarmState=inpAlarmState, sensState=sensState, inpValue=inpValue, sensLimitMin=sensLimitMin, outIndex=outIndex, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, poseidon=poseidon, outType=outType, OutputType=OutputType, sensIndex=sensIndex, sensValue=sensValue, sensSetupEntry=sensSetupEntry, tsAlarm=tsAlarm, outName=outName, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, sensID=sensID, outValue=outValue, infoAddressMAC=infoAddressMAC, outEntry=outEntry, inpName=inpName, SensorValue=SensorValue, sensHysteresis=sensHysteresis, sensSetupName=sensSetupName, SensorString=SensorString, sensName=sensName, tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, SensorID=SensorID)
