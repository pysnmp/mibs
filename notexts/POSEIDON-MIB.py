...
Counter32, NotificationType, IpAddress, iso, enterprises, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, Integer32, Bits, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "IpAddress", "iso", "enterprises", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, sensUnit=sensUnit, sensEntry=sensEntry, SensorFlags=SensorFlags, outName=outName, poseidon=poseidon, inpIndex=inpIndex, TimeStamp=TimeStamp, outType=outType, tsAlarmEntry=tsAlarmEntry, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, sensLimitMax=sensLimitMax, sensState=sensState, outTable=outTable, sensString=sensString, sensFlags=sensFlags, PositiveInteger=PositiveInteger, SensorID=SensorID, hwgroup=hwgroup, sensValue=sensValue, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, tsAlarmsPresent=tsAlarmsPresent, inpValue=inpValue, sensName=sensName, sensHysteresis=sensHysteresis, IOName=IOName, info=info, SensorName=SensorName, sensSetupEntry=sensSetupEntry, sensTable=sensTable, SensorUnitString=SensorUnitString, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, sensValueRaw=sensValueRaw, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensID=sensID, SensorString=SensorString, sensSetupIndex=sensSetupIndex, OutputType=OutputType, charonII=charonII, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, outEntry=outEntry, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, OutputMode=OutputMode, OnOff=OnOff, SensorState=SensorState, inpTable=inpTable, inpName=inpName, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, unitType=unitType, outIndex=outIndex, InputAlarmState=InputAlarmState, UnitType=UnitType, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, setup=setup, sensUnitString=sensUnitString)
