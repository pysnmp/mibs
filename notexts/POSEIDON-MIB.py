...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, tsAlarm=tsAlarm, OutputMode=OutputMode, outType=outType, tsAlarmDescr=tsAlarmDescr, SensorValue=SensorValue, InputAlarmState=InputAlarmState, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, OutputType=OutputType, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, poseidon=poseidon, UnitType=UnitType, sensSetupEntry=sensSetupEntry, info=info, sensName=sensName, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, sensUnit=sensUnit, sensSetup=sensSetup, inpAlarmState=inpAlarmState, inpTable=inpTable, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, SensorName=SensorName, inpValue=inpValue, outTable=outTable, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, OnOff=OnOff, outIndex=outIndex, sensEntry=sensEntry, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, inpIndex=inpIndex, sensUnitString=sensUnitString, sensState=sensState, SensorFlags=SensorFlags, outEntry=outEntry, sensIndex=sensIndex, sensValue=sensValue, charonII=charonII, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, hwgroup=hwgroup, inpEntry=inpEntry, sensValueRaw=sensValueRaw, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, SensorID=SensorID, PositiveInteger=PositiveInteger, outValue=outValue, sensID=sensID, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, inpName=inpName, outMode=outMode, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, setup=setup, SensorString=SensorString, outName=outName)
