...
Counter64, MibIdentifier, NotificationType, ObjectIdentity, Counter32, Gauge32, Bits, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Unsigned32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter32", "Gauge32", "Bits", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Unsigned32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", hwgroup=hwgroup, tsAlarm=tsAlarm, OutputType=OutputType, poseidon=poseidon, SensorState=SensorState, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, outTable=outTable, sensTable=sensTable, TimeStamp=TimeStamp, charonII=charonII, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, sensValue=sensValue, sensSetup=sensSetup, setup=setup, inpEntry=inpEntry, SensorID=SensorID, SensorUnitString=SensorUnitString, inpIndex=inpIndex, sensString=sensString, tsAlarmDescr=tsAlarmDescr, SensorFlags=SensorFlags, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, sensEntry=sensEntry, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, PositiveInteger=PositiveInteger, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, UnitType=UnitType, outMode=outMode, OnOff=OnOff, SensorValue=SensorValue, sensSetupTable=sensSetupTable, inpName=inpName, outIndex=outIndex, OutputMode=OutputMode, tsAlarmId=tsAlarmId, outValue=outValue, SensorName=SensorName, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupName=sensSetupName, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, outType=outType, IOName=IOName, info=info, inpTable=inpTable, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, tsAlarmEntry=tsAlarmEntry, unitType=unitType, sensState=sensState, sensFlags=sensFlags, sensLimitMax=sensLimitMax, SensorString=SensorString, inpValue=inpValue, outEntry=outEntry, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent)
