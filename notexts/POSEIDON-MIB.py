...
MibIdentifier, Bits, IpAddress, Gauge32, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks, enterprises, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks", "enterprises", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", PositiveInteger=PositiveInteger, OutputType=OutputType, outValue=outValue, sensValue=sensValue, outEntry=outEntry, outIndex=outIndex, sensSetup=sensSetup, inpEntry=inpEntry, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, SensorID=SensorID, sensSetupTable=sensSetupTable, inpValue=inpValue, sensState=sensState, sensID=sensID, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, sensUnitString=sensUnitString, infoAddressMAC=infoAddressMAC, outTable=outTable, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, sensEntry=sensEntry, sensValueRaw=sensValueRaw, sensTable=sensTable, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, info=info, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, SensorFlags=SensorFlags, tsAlarmEntry=tsAlarmEntry, sensName=sensName, IOName=IOName, sensLimitMin=sensLimitMin, inpAlarmState=inpAlarmState, SensorString=SensorString, inpName=inpName, OutputMode=OutputMode, hwgroup=hwgroup, inpTable=inpTable, tsAlarmTable=tsAlarmTable, sensSetupIndex=sensSetupIndex, outType=outType, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, OnOff=OnOff, poseidon=poseidon, UnitType=UnitType, setup=setup, sensString=sensString, outMode=outMode, inpIndex=inpIndex, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, outName=outName, InputAlarmState=InputAlarmState, tsAlarmsPresent=tsAlarmsPresent)
