...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Counter32, Counter64, NotificationType, ObjectIdentity, Unsigned32, IpAddress, Bits, ModuleIdentity, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, inpName=inpName, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, sensString=sensString, sensValue=sensValue, OnOff=OnOff, tsAlarmsPresent=tsAlarmsPresent, outValue=outValue, SensorValue=SensorValue, info=info, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, poseidon=poseidon, sensFlags=sensFlags, sensSetupName=sensSetupName, SensorID=SensorID, sensState=sensState, SensorFlags=SensorFlags, sensTable=sensTable, hwgroup=hwgroup, SensorName=SensorName, inpValue=inpValue, outName=outName, sensUnit=sensUnit, outIndex=outIndex, SensorString=SensorString, InputAlarmState=InputAlarmState, tsAlarmSensName=tsAlarmSensName, OutputMode=OutputMode, tsAlarmTime=tsAlarmTime, inpIndex=inpIndex, sensID=sensID, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, inpAlarmState=inpAlarmState, SensorState=SensorState, sensIndex=sensIndex, PositiveInteger=PositiveInteger, sensSetup=sensSetup, sensName=sensName, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, inpTable=inpTable, setup=setup, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, tsAlarm=tsAlarm, IOName=IOName, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, charonII=charonII, unitType=unitType, SensorUnitString=SensorUnitString, outType=outType, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, OutputType=OutputType, sensEntry=sensEntry, outMode=outMode, infoAddressMAC=infoAddressMAC, outTable=outTable, UnitType=UnitType)
