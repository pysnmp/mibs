...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ModuleIdentity, MibIdentifier, iso, Integer32, Bits, Counter32, Unsigned32, ObjectIdentity, IpAddress, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "Integer32", "Bits", "Counter32", "Unsigned32", "ObjectIdentity", "IpAddress", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, sensValueRaw=sensValueRaw, OutputMode=OutputMode, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, IOName=IOName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, outMode=outMode, sensUnitString=sensUnitString, inpName=inpName, charonII=charonII, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, SensorID=SensorID, outName=outName, inpTable=inpTable, inpEntry=inpEntry, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, tsAlarmId=tsAlarmId, sensSetup=sensSetup, poseidon=poseidon, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, sensIndex=sensIndex, sensLimitMin=sensLimitMin, TimeStamp=TimeStamp, OnOff=OnOff, sensState=sensState, InputAlarmState=InputAlarmState, sensValue=sensValue, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, SensorFlags=SensorFlags, outValue=outValue, info=info, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, sensString=sensString, UnitType=UnitType, sensSetupEntry=sensSetupEntry, tsAlarmTable=tsAlarmTable, SensorName=SensorName, InputAlarmSetup=InputAlarmSetup, inpIndex=inpIndex, sensUnit=sensUnit, outTable=outTable, outEntry=outEntry, sensName=sensName, outType=outType, infoAddressMAC=infoAddressMAC, outIndex=outIndex, sensEntry=sensEntry, sensTable=sensTable, unitType=unitType, setup=setup, sensSetupTable=sensSetupTable, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, SensorState=SensorState)
