...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorUnitString=SensorUnitString, outTable=outTable, PositiveInteger=PositiveInteger, inpEntry=inpEntry, outValue=outValue, tsAlarmIdx=tsAlarmIdx, sensFlags=sensFlags, OutputMode=OutputMode, info=info, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, poseidon=poseidon, sensSetupIndex=sensSetupIndex, OutputType=OutputType, inpAlarmState=inpAlarmState, sensTable=sensTable, OnOff=OnOff, sensName=sensName, outIndex=outIndex, tsAlarmTime=tsAlarmTime, setup=setup, tsAlarmsPresent=tsAlarmsPresent, tsAlarm=tsAlarm, SensorFlags=SensorFlags, outType=outType, outName=outName, InputAlarmState=InputAlarmState, sensEntry=sensEntry, sensHysteresis=sensHysteresis, SensorValue=SensorValue, infoAddressMAC=infoAddressMAC, inpTable=inpTable, outEntry=outEntry, SensorString=SensorString, unitType=unitType, sensString=sensString, sensID=sensID, sensValue=sensValue, SensorState=SensorState, inpValue=inpValue, inpName=inpName, hwgroup=hwgroup, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, InputAlarmSetup=InputAlarmSetup, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, sensLimitMax=sensLimitMax, inpIndex=inpIndex, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, SensorID=SensorID, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMin=sensLimitMin, UnitType=UnitType, sensState=sensState, IOName=IOName, outMode=outMode, sensValueRaw=sensValueRaw, sensUnit=sensUnit, charonII=charonII)
