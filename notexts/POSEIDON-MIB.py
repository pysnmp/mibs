...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Integer32, iso, Gauge32, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Integer32", "iso", "Gauge32", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", infoAddressMAC=infoAddressMAC, SensorState=SensorState, InputAlarmState=InputAlarmState, sensValue=sensValue, sensState=sensState, sensID=sensID, sensHysteresis=sensHysteresis, tsAlarmsPresent=tsAlarmsPresent, SensorName=SensorName, sensUnitString=sensUnitString, inpValue=inpValue, TimeStamp=TimeStamp, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, sensEntry=sensEntry, SensorUnitString=SensorUnitString, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, PositiveInteger=PositiveInteger, OutputType=OutputType, inpIndex=inpIndex, inpName=inpName, inpAlarmState=inpAlarmState, outValue=outValue, sensFlags=sensFlags, SensorValue=SensorValue, poseidon=poseidon, outEntry=outEntry, outIndex=outIndex, info=info, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, sensSetupEntry=sensSetupEntry, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, SensorID=SensorID, inpEntry=inpEntry, sensValueRaw=sensValueRaw, setup=setup, tsAlarmSensName=tsAlarmSensName, sensName=sensName, IOName=IOName, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, unitType=unitType, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, sensIndex=sensIndex, sensUnit=sensUnit, sensSetupName=sensSetupName, outMode=outMode, inpAlarmSetup=inpAlarmSetup, sensString=sensString, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, outName=outName, inpTable=inpTable, outTable=outTable, outType=outType, charonII=charonII, UnitType=UnitType, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin)
