...
Bits, Counter32, ObjectIdentity, Integer32, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ObjectIdentity", "Integer32", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, outType=outType, tsAlarmTable=tsAlarmTable, unitType=unitType, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, tsAlarmSensName=tsAlarmSensName, inpValue=inpValue, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, OutputType=OutputType, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, sensValue=sensValue, outIndex=outIndex, sensUnit=sensUnit, inpEntry=inpEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, outName=outName, outMode=outMode, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, sensHysteresis=sensHysteresis, poseidon=poseidon, inpName=inpName, IOName=IOName, outTable=outTable, inpTable=inpTable, sensName=sensName, PositiveInteger=PositiveInteger, SensorString=SensorString, sensEntry=sensEntry, tsAlarmIdx=tsAlarmIdx, hwgroup=hwgroup, sensState=sensState, sensAlarmStateChanged=sensAlarmStateChanged, OnOff=OnOff, infoAddressMAC=infoAddressMAC, charonII=charonII, sensUnitString=sensUnitString, sensString=sensString, sensSetup=sensSetup, OutputMode=OutputMode, TimeStamp=TimeStamp, info=info, setup=setup, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, outValue=outValue, sensLimitMin=sensLimitMin, SensorID=SensorID, inpAlarmState=inpAlarmState, tsAlarmTime=tsAlarmTime, sensID=sensID, SensorState=SensorState, sensTable=sensTable, sensIndex=sensIndex, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, SensorName=SensorName, tsAlarmId=tsAlarmId)
