...
TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Gauge32, MibIdentifier, iso, IpAddress, Bits, Counter32, ModuleIdentity, ObjectIdentity, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "iso", "IpAddress", "Bits", "Counter32", "ModuleIdentity", "ObjectIdentity", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensName=sensName, SensorName=SensorName, tsAlarmSensName=tsAlarmSensName, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, IOName=IOName, PositiveInteger=PositiveInteger, SensorString=SensorString, inpTable=inpTable, inpName=inpName, outEntry=outEntry, OutputMode=OutputMode, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId, OutputType=OutputType, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, outName=outName, infoAddressMAC=infoAddressMAC, outTable=outTable, outMode=outMode, sensTable=sensTable, sensIndex=sensIndex, unitType=unitType, SensorID=SensorID, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, sensUnitString=sensUnitString, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, poseidon=poseidon, info=info, setup=setup, charonII=charonII, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, UnitType=UnitType, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, outType=outType, inpEntry=inpEntry, sensString=sensString, sensLimitMax=sensLimitMax, sensEntry=sensEntry, sensID=sensID, outValue=outValue, sensState=sensState, SensorUnitString=SensorUnitString, OnOff=OnOff, tsAlarm=tsAlarm, sensValue=sensValue, SensorValue=SensorValue, inpIndex=inpIndex, sensUnit=sensUnit, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, SensorState=SensorState)
