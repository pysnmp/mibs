...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Unsigned32, Counter32, ObjectIdentity, MibIdentifier, ModuleIdentity, enterprises, IpAddress, NotificationType, Gauge32, Integer32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "enterprises", "IpAddress", "NotificationType", "Gauge32", "Integer32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, OutputMode=OutputMode, SensorID=SensorID, outEntry=outEntry, TimeStamp=TimeStamp, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, sensTable=sensTable, tsAlarmTable=tsAlarmTable, outValue=outValue, inpTable=inpTable, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, sensLimitMin=sensLimitMin, sensString=sensString, sensValueRaw=sensValueRaw, SensorState=SensorState, IOName=IOName, sensHysteresis=sensHysteresis, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, sensValue=sensValue, sensSetup=sensSetup, SensorFlags=SensorFlags, setup=setup, sensSetupTable=sensSetupTable, SensorValue=SensorValue, OutputType=OutputType, inpName=inpName, sensSetupName=sensSetupName, sensID=sensID, tsAlarmDescr=tsAlarmDescr, inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, outName=outName, sensIndex=sensIndex, sensUnit=sensUnit, SensorString=SensorString, sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, charonII=charonII, inpIndex=inpIndex, OnOff=OnOff, hwgroup=hwgroup, outMode=outMode, info=info, PositiveInteger=PositiveInteger, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, outTable=outTable, sensName=sensName, tsAlarm=tsAlarm)
