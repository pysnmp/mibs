...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, enterprises, Integer32, NotificationType, Counter32, IpAddress, ModuleIdentity, Counter64, Unsigned32, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "enterprises", "Integer32", "NotificationType", "Counter32", "IpAddress", "ModuleIdentity", "Counter64", "Unsigned32", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmState=InputAlarmState, sensLimitMin=sensLimitMin, sensFlags=sensFlags, SensorValue=SensorValue, inpEntry=inpEntry, sensValue=sensValue, tsAlarmTime=tsAlarmTime, inpName=inpName, inpIndex=inpIndex, sensIndex=sensIndex, charonII=charonII, inpTable=inpTable, inpValue=inpValue, outName=outName, outMode=outMode, outIndex=outIndex, sensUnit=sensUnit, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, outTable=outTable, sensEntry=sensEntry, OutputMode=OutputMode, sensTable=sensTable, outType=outType, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, SensorID=SensorID, sensLimitMax=sensLimitMax, tsAlarmEntry=tsAlarmEntry, hwgroup=hwgroup, SensorState=SensorState, SensorUnitString=SensorUnitString, UnitType=UnitType, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, poseidon=poseidon, outEntry=outEntry, sensString=sensString, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, SensorString=SensorString, outValue=outValue, unitType=unitType, sensSetupEntry=sensSetupEntry, info=info, SensorFlags=SensorFlags, sensState=sensState, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, sensName=sensName, OnOff=OnOff, setup=setup, SensorName=SensorName, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, tsAlarmId=tsAlarmId, OutputType=OutputType, IOName=IOName, sensID=sensID)
