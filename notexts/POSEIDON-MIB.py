...
ModuleIdentity, Counter64, IpAddress, NotificationType, MibIdentifier, enterprises, Gauge32, Integer32, Unsigned32, ObjectIdentity, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "enterprises", "Gauge32", "Integer32", "Unsigned32", "ObjectIdentity", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, TimeStamp=TimeStamp, sensUnitString=sensUnitString, OutputMode=OutputMode, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, tsAlarmSensName=tsAlarmSensName, sensName=sensName, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, unitType=unitType, hwgroup=hwgroup, sensSetup=sensSetup, inpValue=inpValue, sensString=sensString, tsAlarmTable=tsAlarmTable, tsAlarm=tsAlarm, setup=setup, sensID=sensID, sensSetupName=sensSetupName, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, sensEntry=sensEntry, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, info=info, SensorID=SensorID, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensValueRaw=sensValueRaw, IOName=IOName, UnitType=UnitType, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, outIndex=outIndex, SensorName=SensorName, infoAddressMAC=infoAddressMAC, outValue=outValue, OnOff=OnOff, outTable=outTable, tsAlarmIdx=tsAlarmIdx, inpName=inpName, SensorValue=SensorValue, PositiveInteger=PositiveInteger, inpAlarmSetup=inpAlarmSetup, SensorFlags=SensorFlags, outMode=outMode, poseidon=poseidon, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, outType=outType, tsAlarmId=tsAlarmId, inpTable=inpTable, SensorState=SensorState, sensSetupIndex=sensSetupIndex, OutputType=OutputType, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, inpIndex=inpIndex, outEntry=outEntry, SensorUnitString=SensorUnitString, sensState=sensState)
