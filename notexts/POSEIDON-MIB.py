...
mibBuilder.exportSymbols("POSEIDON-MIB", sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, inpName=inpName, inpIndex=inpIndex, sensName=sensName, charonII=charonII, info=info, sensState=sensState, outName=outName, SensorName=SensorName, IOName=IOName, inpValue=inpValue, InputAlarmState=InputAlarmState, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, sensLimitMin=sensLimitMin, inpEntry=inpEntry, sensIndex=sensIndex, sensHysteresis=sensHysteresis, sensSetupName=sensSetupName, outValue=outValue, SensorString=SensorString, outEntry=outEntry, UnitType=UnitType, SensorID=SensorID, TimeStamp=TimeStamp, unitType=unitType, hwgroup=hwgroup, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, sensUnitString=sensUnitString, sensTable=sensTable, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, outIndex=outIndex, PositiveInteger=PositiveInteger, tsAlarmIdx=tsAlarmIdx, sensString=sensString, SensorUnitString=SensorUnitString, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, sensValue=sensValue, tsAlarm=tsAlarm, outMode=outMode, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, SensorState=SensorState, setup=setup, SensorFlags=SensorFlags, inpTable=inpTable, outTable=outTable, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, inpAlarmState=inpAlarmState, outType=outType, OnOff=OnOff, poseidon=poseidon, tsTrapAlarmStart=tsTrapAlarmStart)
