...
Counter32, ModuleIdentity, Integer32, TimeTicks, iso, Gauge32, Bits, NotificationType, Unsigned32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Integer32", "TimeTicks", "iso", "Gauge32", "Bits", "NotificationType", "Unsigned32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", infoAddressMAC=infoAddressMAC, tsAlarmEntry=tsAlarmEntry, inpIndex=inpIndex, sensID=sensID, outEntry=outEntry, tsAlarm=tsAlarm, charonII=charonII, sensSetup=sensSetup, SensorState=SensorState, sensSetupEntry=sensSetupEntry, sensSetupTable=sensSetupTable, IOName=IOName, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, inpAlarmState=inpAlarmState, outValue=outValue, tsAlarmSensName=tsAlarmSensName, sensState=sensState, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, sensIndex=sensIndex, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, unitType=unitType, outName=outName, outIndex=outIndex, sensTable=sensTable, sensUnit=sensUnit, sensSetupName=sensSetupName, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, sensValue=sensValue, OutputType=OutputType, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, inpName=inpName, SensorName=SensorName, SensorValue=SensorValue, outTable=outTable, sensEntry=sensEntry, OnOff=OnOff, SensorUnitString=SensorUnitString, info=info, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, SensorFlags=SensorFlags, UnitType=UnitType, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, OutputMode=OutputMode, poseidon=poseidon, setup=setup, sensString=sensString, inpValue=inpValue, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, outMode=outMode, tsAlarmIdx=tsAlarmIdx, sensName=sensName, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable)
