...
Bits, IpAddress, TimeTicks, enterprises, Counter64, Counter32, ObjectIdentity, Unsigned32, Gauge32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "TimeTicks", "enterprises", "Counter64", "Counter32", "ObjectIdentity", "Unsigned32", "Gauge32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, charonII=charonII, sensName=sensName, sensState=sensState, sensFlags=sensFlags, sensString=sensString, info=info, outName=outName, tsAlarmId=tsAlarmId, outValue=outValue, inpTable=inpTable, InputAlarmSetup=InputAlarmSetup, outMode=outMode, tsAlarmIdx=tsAlarmIdx, sensEntry=sensEntry, sensUnit=sensUnit, OnOff=OnOff, sensID=sensID, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, inpValue=inpValue, outIndex=outIndex, UnitType=UnitType, OutputType=OutputType, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, sensValue=sensValue, InputAlarmState=InputAlarmState, inpName=inpName, TimeStamp=TimeStamp, sensSetup=sensSetup, hwgroup=hwgroup, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, outTable=outTable, outType=outType, SensorFlags=SensorFlags, unitType=unitType, sensTable=sensTable, setup=setup, SensorState=SensorState, inpEntry=inpEntry, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, SensorValue=SensorValue, SensorName=SensorName, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, sensIndex=sensIndex, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupIndex=sensSetupIndex, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, tsAlarmTime=tsAlarmTime, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, SensorID=SensorID, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState)
