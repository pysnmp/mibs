...
MibIdentifier, enterprises, TimeTicks, Counter64, iso, NotificationType, ObjectIdentity, Unsigned32, Bits, Counter32, Gauge32, IpAddress, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "TimeTicks", "Counter64", "iso", "NotificationType", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "Gauge32", "IpAddress", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, UnitType=UnitType, sensSetup=sensSetup, SensorID=SensorID, OnOff=OnOff, SensorUnitString=SensorUnitString, poseidon=poseidon, SensorState=SensorState, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, sensTable=sensTable, sensEntry=sensEntry, sensID=sensID, sensLimitMin=sensLimitMin, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, sensValueRaw=sensValueRaw, sensState=sensState, outName=outName, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, tsAlarmSensName=tsAlarmSensName, inpEntry=inpEntry, charonII=charonII, OutputMode=OutputMode, sensIndex=sensIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, info=info, IOName=IOName, tsAlarmIdx=tsAlarmIdx, outMode=outMode, inpName=inpName, sensSetupIndex=sensSetupIndex, outValue=outValue, tsAlarm=tsAlarm, outEntry=outEntry, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, SensorFlags=SensorFlags, sensLimitMax=sensLimitMax, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, SensorValue=SensorValue, OutputType=OutputType, outTable=outTable, sensName=sensName, inpValue=inpValue, sensString=sensString, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, setup=setup, outIndex=outIndex, SensorString=SensorString, tsAlarmDescr=tsAlarmDescr, outType=outType, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, SensorName=SensorName, inpAlarmState=inpAlarmState, inpTable=inpTable, tsTrapAlarmStart=tsTrapAlarmStart, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup)
