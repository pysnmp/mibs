...
enterprises, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, Integer32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpIndex=inpIndex, sensFlags=sensFlags, sensLimitMin=sensLimitMin, SensorString=SensorString, sensUnitString=sensUnitString, sensValueRaw=sensValueRaw, sensString=sensString, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmTime=tsAlarmTime, inpTable=inpTable, sensSetup=sensSetup, sensID=sensID, sensLimitMax=sensLimitMax, sensIndex=sensIndex, outValue=outValue, OutputType=OutputType, poseidon=poseidon, sensState=sensState, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, sensValue=sensValue, SensorFlags=SensorFlags, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, TimeStamp=TimeStamp, SensorState=SensorState, charonII=charonII, setup=setup, tsAlarmsPresent=tsAlarmsPresent, inpName=inpName, sensSetupTable=sensSetupTable, tsAlarmSensName=tsAlarmSensName, outIndex=outIndex, sensTable=sensTable, outMode=outMode, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, sensEntry=sensEntry, outName=outName, InputAlarmState=InputAlarmState, info=info, tsAlarmIdx=tsAlarmIdx, UnitType=UnitType, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, SensorUnitString=SensorUnitString, sensSetupName=sensSetupName, tsAlarmId=tsAlarmId, inpEntry=inpEntry, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, SensorValue=SensorValue, unitType=unitType, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, OnOff=OnOff, IOName=IOName, SensorName=SensorName, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType)
