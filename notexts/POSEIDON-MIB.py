...
IpAddress, Bits, Gauge32, ObjectIdentity, iso, MibIdentifier, Counter64, Counter32, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "Counter64", "Counter32", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnitString=sensUnitString, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, outName=outName, SensorID=SensorID, inpTable=inpTable, UnitType=UnitType, sensTable=sensTable, sensValueRaw=sensValueRaw, IOName=IOName, TimeStamp=TimeStamp, tsAlarmTable=tsAlarmTable, poseidon=poseidon, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, outType=outType, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, sensString=sensString, OnOff=OnOff, sensFlags=sensFlags, charonII=charonII, outIndex=outIndex, tsAlarm=tsAlarm, inpValue=inpValue, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, sensSetupEntry=sensSetupEntry, setup=setup, unitType=unitType, hwgroup=hwgroup, OutputMode=OutputMode, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, inpName=inpName, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, inpAlarmState=inpAlarmState, outEntry=outEntry, info=info, sensSetupName=sensSetupName, sensValue=sensValue, SensorState=SensorState, outValue=outValue, inpEntry=inpEntry, SensorUnitString=SensorUnitString, PositiveInteger=PositiveInteger, tsAlarmDescr=tsAlarmDescr, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmId=tsAlarmId, outMode=outMode, sensSetup=sensSetup, sensID=sensID, sensUnit=sensUnit, outTable=outTable, sensIndex=sensIndex, SensorValue=SensorValue, inpIndex=inpIndex, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, sensName=sensName, SensorFlags=SensorFlags, InputAlarmState=InputAlarmState)
