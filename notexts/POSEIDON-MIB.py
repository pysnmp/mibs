...
NotificationType, iso, ObjectIdentity, enterprises, MibIdentifier, Counter64, TimeTicks, ModuleIdentity, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ObjectIdentity", "enterprises", "MibIdentifier", "Counter64", "TimeTicks", "ModuleIdentity", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmEntry=tsAlarmEntry, sensState=sensState, infoAddressMAC=infoAddressMAC, sensTable=sensTable, SensorFlags=SensorFlags, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, PositiveInteger=PositiveInteger, SensorName=SensorName, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, sensID=sensID, SensorState=SensorState, unitType=unitType, sensSetupTable=sensSetupTable, OutputType=OutputType, sensSetupIndex=sensSetupIndex, charonII=charonII, inpTable=inpTable, inpName=inpName, inpEntry=inpEntry, UnitType=UnitType, setup=setup, SensorUnitString=SensorUnitString, poseidon=poseidon, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, IOName=IOName, SensorString=SensorString, sensHysteresis=sensHysteresis, SensorValue=SensorValue, sensUnitString=sensUnitString, sensEntry=sensEntry, OnOff=OnOff, sensSetupEntry=sensSetupEntry, outType=outType, InputAlarmSetup=InputAlarmSetup, sensFlags=sensFlags, outValue=outValue, SensorID=SensorID, tsAlarmId=tsAlarmId, sensSetup=sensSetup, TimeStamp=TimeStamp, inpIndex=inpIndex, sensString=sensString, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, hwgroup=hwgroup, inpAlarmState=inpAlarmState, outTable=outTable, outName=outName, sensIndex=sensIndex, outIndex=outIndex, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, outEntry=outEntry, sensUnit=sensUnit, outMode=outMode, tsAlarm=tsAlarm, info=info, sensValueRaw=sensValueRaw, inpValue=inpValue, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx)
