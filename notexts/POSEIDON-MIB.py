...
IpAddress, enterprises, Integer32, Gauge32, TimeTicks, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, NotificationType, Counter64, ObjectIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Integer32", "Gauge32", "TimeTicks", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, sensHysteresis=sensHysteresis, OutputType=OutputType, outIndex=outIndex, UnitType=UnitType, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx, PositiveInteger=PositiveInteger, unitType=unitType, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, outMode=outMode, IOName=IOName, sensSetupTable=sensSetupTable, inpName=inpName, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, tsAlarmSensName=tsAlarmSensName, sensValue=sensValue, sensIndex=sensIndex, inpTable=inpTable, outTable=outTable, sensName=sensName, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, infoAddressMAC=infoAddressMAC, info=info, inpIndex=inpIndex, tsAlarmTable=tsAlarmTable, setup=setup, SensorID=SensorID, sensEntry=sensEntry, charonII=charonII, sensValueRaw=sensValueRaw, sensID=sensID, sensSetup=sensSetup, sensTable=sensTable, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, sensFlags=sensFlags, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, inpAlarmState=inpAlarmState, TimeStamp=TimeStamp, SensorState=SensorState, outType=outType, sensString=sensString, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, sensUnit=sensUnit, SensorName=SensorName, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, sensAlarmStateChanged=sensAlarmStateChanged, sensLimitMax=sensLimitMax, tsAlarm=tsAlarm, poseidon=poseidon, SensorFlags=SensorFlags, OnOff=OnOff, SensorValue=SensorValue, sensState=sensState, InputAlarmState=InputAlarmState)
