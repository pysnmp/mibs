...
Counter64, IpAddress, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, enterprises, iso, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "enterprises", "iso", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, sensSetupEntry=sensSetupEntry, outMode=outMode, OnOff=OnOff, sensState=sensState, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, charonII=charonII, sensSetup=sensSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, sensFlags=sensFlags, sensID=sensID, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, OutputType=OutputType, sensUnit=sensUnit, sensValue=sensValue, outIndex=outIndex, OutputMode=OutputMode, unitType=unitType, SensorState=SensorState, outName=outName, tsAlarmDescr=tsAlarmDescr, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, tsAlarmId=tsAlarmId, tsAlarmsPresent=tsAlarmsPresent, SensorValue=SensorValue, IOName=IOName, inpIndex=inpIndex, inpAlarmState=inpAlarmState, inpValue=inpValue, sensSetupName=sensSetupName, outEntry=outEntry, sensString=sensString, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, hwgroup=hwgroup, outValue=outValue, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, sensTable=sensTable, inpEntry=inpEntry, poseidon=poseidon, SensorID=SensorID, inpTable=inpTable, inpName=inpName, sensLimitMax=sensLimitMax, SensorUnitString=SensorUnitString, UnitType=UnitType, sensName=sensName, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, sensLimitMin=sensLimitMin, tsAlarmSensName=tsAlarmSensName, outType=outType, sensEntry=sensEntry, info=info, SensorString=SensorString, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, tsAlarm=tsAlarm, TimeStamp=TimeStamp)
