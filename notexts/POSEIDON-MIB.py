...
Unsigned32, ModuleIdentity, ObjectIdentity, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Bits, NotificationType, TimeTicks, IpAddress, Counter64, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Bits", "NotificationType", "TimeTicks", "IpAddress", "Counter64", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, SensorString=SensorString, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, sensTable=sensTable, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensString=sensString, poseidon=poseidon, sensSetupName=sensSetupName, SensorUnitString=SensorUnitString, inpEntry=inpEntry, sensName=sensName, sensValue=sensValue, IOName=IOName, hwgroup=hwgroup, PositiveInteger=PositiveInteger, sensID=sensID, tsAlarmId=tsAlarmId, inpName=inpName, tsAlarmDescr=tsAlarmDescr, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, SensorID=SensorID, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, sensState=sensState, TimeStamp=TimeStamp, outName=outName, tsAlarmTable=tsAlarmTable, OutputMode=OutputMode, setup=setup, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputType=OutputType, outTable=outTable, sensIndex=sensIndex, inpAlarmState=inpAlarmState, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, outType=outType, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, sensUnit=sensUnit, inpTable=inpTable, tsAlarmEntry=tsAlarmEntry, info=info, OnOff=OnOff, charonII=charonII, sensValueRaw=sensValueRaw, outValue=outValue, SensorState=SensorState, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, SensorName=SensorName, infoAddressMAC=infoAddressMAC, outMode=outMode, tsAlarm=tsAlarm, SensorFlags=SensorFlags, UnitType=UnitType, unitType=unitType, sensLimitMax=sensLimitMax, outIndex=outIndex, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, sensSetup=sensSetup, inpIndex=inpIndex)
