...
Counter32, enterprises, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, ObjectIdentity, MibIdentifier, Bits, Counter64, ModuleIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupName=sensSetupName, sensUnitString=sensUnitString, info=info, inpAlarmState=inpAlarmState, inpEntry=inpEntry, sensIndex=sensIndex, sensString=sensString, sensID=sensID, sensLimitMax=sensLimitMax, charonII=charonII, sensState=sensState, inpValue=inpValue, tsAlarmsPresent=tsAlarmsPresent, sensEntry=sensEntry, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, sensValue=sensValue, IOName=IOName, setup=setup, InputAlarmState=InputAlarmState, sensName=sensName, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupTable=sensSetupTable, sensValueRaw=sensValueRaw, SensorString=SensorString, outMode=outMode, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, outType=outType, PositiveInteger=PositiveInteger, OutputMode=OutputMode, SensorID=SensorID, sensTable=sensTable, SensorName=SensorName, poseidon=poseidon, inpTable=inpTable, UnitType=UnitType, outName=outName, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, OutputType=OutputType, unitType=unitType, tsAlarmTime=tsAlarmTime, outValue=outValue, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, SensorState=SensorState, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmId=tsAlarmId, SensorFlags=SensorFlags, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, inpName=inpName, inpIndex=inpIndex, hwgroup=hwgroup, sensSetupIndex=sensSetupIndex, outTable=outTable, sensSetup=sensSetup, SensorValue=SensorValue, sensAlarmStateChanged=sensAlarmStateChanged, outIndex=outIndex, sensHysteresis=sensHysteresis, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp)
