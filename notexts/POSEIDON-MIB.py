...
MibIdentifier, Bits, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, iso, Gauge32, Counter64, NotificationType, ModuleIdentity, ObjectIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "iso", "Gauge32", "Counter64", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarm=tsAlarm, SensorName=SensorName, sensFlags=sensFlags, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, OutputMode=OutputMode, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, outValue=outValue, inpIndex=inpIndex, inpTable=inpTable, UnitType=UnitType, tsAlarmIdx=tsAlarmIdx, outName=outName, poseidon=poseidon, sensName=sensName, sensUnitString=sensUnitString, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, TimeStamp=TimeStamp, infoAddressMAC=infoAddressMAC, charonII=charonII, outType=outType, outIndex=outIndex, sensID=sensID, outTable=outTable, inpValue=inpValue, SensorID=SensorID, sensString=sensString, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, PositiveInteger=PositiveInteger, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, sensHysteresis=sensHysteresis, sensSetupName=sensSetupName, setup=setup, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, info=info, outEntry=outEntry, inpAlarmState=inpAlarmState, sensState=sensState, tsAlarmTime=tsAlarmTime, outMode=outMode, OnOff=OnOff, SensorState=SensorState, sensSetupTable=sensSetupTable, sensValue=sensValue, sensTable=sensTable, sensLimitMin=sensLimitMin, sensUnit=sensUnit, tsAlarmSensName=tsAlarmSensName, tsAlarmId=tsAlarmId, sensSetup=sensSetup, InputAlarmState=InputAlarmState, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, unitType=unitType, inpEntry=inpEntry, tsAlarmEntry=tsAlarmEntry)
