...
ObjectIdentity, IpAddress, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter64, Bits, TimeTicks, enterprises, iso, Unsigned32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter64", "Bits", "TimeTicks", "enterprises", "iso", "Unsigned32", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensName=sensName, poseidon=poseidon, inpName=inpName, sensUnitString=sensUnitString, sensState=sensState, tsAlarm=tsAlarm, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, sensString=sensString, InputAlarmState=InputAlarmState, sensEntry=sensEntry, IOName=IOName, tsAlarmIdx=tsAlarmIdx, sensValueRaw=sensValueRaw, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, outMode=outMode, sensID=sensID, tsAlarmDescr=tsAlarmDescr, sensTable=sensTable, sensIndex=sensIndex, PositiveInteger=PositiveInteger, outValue=outValue, inpAlarmState=inpAlarmState, tsAlarmTime=tsAlarmTime, SensorFlags=SensorFlags, sensSetup=sensSetup, inpValue=inpValue, TimeStamp=TimeStamp, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupName=sensSetupName, tsAlarmSensName=tsAlarmSensName, OutputMode=OutputMode, sensSetupIndex=sensSetupIndex, sensSetupTable=sensSetupTable, SensorName=SensorName, charonII=charonII, OnOff=OnOff, sensLimitMin=sensLimitMin, OutputType=OutputType, sensValue=sensValue, sensUnit=sensUnit, SensorValue=SensorValue, inpEntry=inpEntry, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, outTable=outTable, outName=outName, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, setup=setup, inpIndex=inpIndex, sensLimitMax=sensLimitMax, unitType=unitType, outType=outType, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, infoAddressMAC=infoAddressMAC, SensorID=SensorID, hwgroup=hwgroup, info=info, inpTable=inpTable)
