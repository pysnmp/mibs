...
iso, ObjectIdentity, Bits, enterprises, IpAddress, NotificationType, Gauge32, ModuleIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Bits", "enterprises", "IpAddress", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMax=sensLimitMax, SensorID=SensorID, inpTable=inpTable, sensSetupTable=sensSetupTable, outType=outType, info=info, sensSetupEntry=sensSetupEntry, sensState=sensState, OutputType=OutputType, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, sensValue=sensValue, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, outMode=outMode, sensHysteresis=sensHysteresis, IOName=IOName, outEntry=outEntry, charonII=charonII, tsAlarmTime=tsAlarmTime, outTable=outTable, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, sensName=sensName, sensIndex=sensIndex, sensString=sensString, tsAlarm=tsAlarm, inpEntry=inpEntry, SensorUnitString=SensorUnitString, InputAlarmState=InputAlarmState, inpValue=inpValue, hwgroup=hwgroup, sensFlags=sensFlags, infoAddressMAC=infoAddressMAC, inpName=inpName, outName=outName, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, unitType=unitType, inpAlarmState=inpAlarmState, outValue=outValue, OutputMode=OutputMode, UnitType=UnitType, sensSetupIndex=sensSetupIndex, poseidon=poseidon, sensUnit=sensUnit, SensorName=SensorName, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, sensUnitString=sensUnitString, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, sensValueRaw=sensValueRaw, sensEntry=sensEntry, SensorValue=SensorValue, sensTable=sensTable, setup=setup, sensLimitMin=sensLimitMin, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmSetup=inpAlarmSetup, SensorState=SensorState)
