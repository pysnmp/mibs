...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ObjectIdentity, Counter32, iso, Gauge32, ModuleIdentity, IpAddress, enterprises, TimeTicks, MibIdentifier, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ObjectIdentity", "Counter32", "iso", "Gauge32", "ModuleIdentity", "IpAddress", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, sensState=sensState, inpAlarmState=inpAlarmState, sensID=sensID, sensFlags=sensFlags, SensorString=SensorString, tsAlarmTable=tsAlarmTable, OutputType=OutputType, SensorID=SensorID, outType=outType, sensValueRaw=sensValueRaw, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, outTable=outTable, sensSetupTable=sensSetupTable, OnOff=OnOff, SensorValue=SensorValue, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, outName=outName, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, sensValue=sensValue, sensSetup=sensSetup, inpIndex=inpIndex, charonII=charonII, inpValue=inpValue, poseidon=poseidon, info=info, IOName=IOName, inpAlarmSetup=inpAlarmSetup, sensIndex=sensIndex, sensString=sensString, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, TimeStamp=TimeStamp, SensorState=SensorState, outIndex=outIndex, sensName=sensName, outMode=outMode, tsAlarmsPresent=tsAlarmsPresent, sensTable=sensTable, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, OutputMode=OutputMode, setup=setup, sensSetupName=sensSetupName, sensEntry=sensEntry, sensLimitMax=sensLimitMax, hwgroup=hwgroup, outEntry=outEntry, outValue=outValue, infoAddressMAC=infoAddressMAC, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, unitType=unitType, SensorUnitString=SensorUnitString, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin)
