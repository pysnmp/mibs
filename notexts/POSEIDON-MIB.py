...
ModuleIdentity, iso, Bits, Unsigned32, enterprises, Counter32, ObjectIdentity, MibIdentifier, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "Unsigned32", "enterprises", "Counter32", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpValue=inpValue, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, sensUnit=sensUnit, SensorName=SensorName, sensLimitMax=sensLimitMax, hwgroup=hwgroup, outMode=outMode, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, tsAlarmIdx=tsAlarmIdx, SensorString=SensorString, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, PositiveInteger=PositiveInteger, unitType=unitType, outName=outName, tsAlarmTime=tsAlarmTime, charonII=charonII, OnOff=OnOff, OutputType=OutputType, sensSetupTable=sensSetupTable, SensorState=SensorState, sensLimitMin=sensLimitMin, sensString=sensString, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, outValue=outValue, sensState=sensState, sensFlags=sensFlags, inpTable=inpTable, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, outIndex=outIndex, sensSetupName=sensSetupName, info=info, sensValue=sensValue, inpName=inpName, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, IOName=IOName, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmState=inpAlarmState, outType=outType, poseidon=poseidon, outTable=outTable, sensValueRaw=sensValueRaw, sensSetup=sensSetup, InputAlarmState=InputAlarmState, SensorValue=SensorValue, outEntry=outEntry, inpEntry=inpEntry, OutputMode=OutputMode, SensorFlags=SensorFlags, SensorUnitString=SensorUnitString, sensTable=sensTable, tsAlarmTable=tsAlarmTable, setup=setup, SensorID=SensorID, sensID=sensID, UnitType=UnitType, sensSetupEntry=sensSetupEntry, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry)
