...
Gauge32, enterprises, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, ModuleIdentity, Unsigned32, iso, MibIdentifier, Counter32, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "ModuleIdentity", "Unsigned32", "iso", "MibIdentifier", "Counter32", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outIndex=outIndex, UnitType=UnitType, TimeStamp=TimeStamp, sensSetupIndex=sensSetupIndex, tsAlarmTime=tsAlarmTime, outValue=outValue, tsAlarmSensName=tsAlarmSensName, tsAlarm=tsAlarm, OutputMode=OutputMode, SensorID=SensorID, sensValue=sensValue, inpName=inpName, SensorState=SensorState, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, inpTable=inpTable, sensName=sensName, inpIndex=inpIndex, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, inpValue=inpValue, sensState=sensState, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, SensorFlags=SensorFlags, info=info, hwgroup=hwgroup, sensEntry=sensEntry, sensID=sensID, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, SensorString=SensorString, outType=outType, PositiveInteger=PositiveInteger, outMode=outMode, sensSetupName=sensSetupName, outEntry=outEntry, sensTable=sensTable, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, outTable=outTable, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, setup=setup, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, sensString=sensString, sensFlags=sensFlags, sensUnit=sensUnit, tsAlarmId=tsAlarmId, sensSetup=sensSetup, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, outName=outName, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, IOName=IOName, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, unitType=unitType, SensorUnitString=SensorUnitString, sensHysteresis=sensHysteresis, SensorName=SensorName, tsAlarmIdx=tsAlarmIdx, poseidon=poseidon, SensorValue=SensorValue, sensIndex=sensIndex)
