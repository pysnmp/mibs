...
Unsigned32, Integer32, iso, NotificationType, MibIdentifier, enterprises, Gauge32, Counter32, IpAddress, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "iso", "NotificationType", "MibIdentifier", "enterprises", "Gauge32", "Counter32", "IpAddress", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, InputAlarmState=InputAlarmState, sensValue=sensValue, outValue=outValue, outType=outType, sensIndex=sensIndex, outEntry=outEntry, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, sensLimitMin=sensLimitMin, sensUnitString=sensUnitString, sensSetup=sensSetup, tsAlarmDescr=tsAlarmDescr, sensString=sensString, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, tsAlarm=tsAlarm, sensEntry=sensEntry, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, unitType=unitType, OutputMode=OutputMode, inpTable=inpTable, sensState=sensState, info=info, charonII=charonII, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, SensorString=SensorString, outName=outName, OutputType=OutputType, OnOff=OnOff, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, SensorValue=SensorValue, sensTable=sensTable, sensSetupName=sensSetupName, poseidon=poseidon, inpEntry=inpEntry, sensValueRaw=sensValueRaw, outTable=outTable, sensID=sensID, setup=setup, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, inpName=inpName, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, SensorFlags=SensorFlags, outMode=outMode, sensSetupTable=sensSetupTable, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, inpIndex=inpIndex, TimeStamp=TimeStamp, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, infoAddressMAC=infoAddressMAC, outIndex=outIndex, SensorUnitString=SensorUnitString, tsAlarmId=tsAlarmId, InputAlarmSetup=InputAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMax=sensLimitMax, IOName=IOName, inpValue=inpValue, tsAlarmTime=tsAlarmTime, SensorID=SensorID, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger)
