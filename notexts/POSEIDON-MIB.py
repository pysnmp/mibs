...
ObjectIdentity, IpAddress, ModuleIdentity, Integer32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier, Counter64, NotificationType, Unsigned32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Integer32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier", "Counter64", "NotificationType", "Unsigned32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, inpIndex=inpIndex, sensLimitMin=sensLimitMin, outIndex=outIndex, IOName=IOName, OutputType=OutputType, TimeStamp=TimeStamp, inpAlarmState=inpAlarmState, sensString=sensString, sensID=sensID, sensUnit=sensUnit, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, UnitType=UnitType, inpValue=inpValue, outValue=outValue, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, SensorID=SensorID, sensEntry=sensEntry, outType=outType, unitType=unitType, outName=outName, info=info, inpAlarmSetup=inpAlarmSetup, OutputMode=OutputMode, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, outMode=outMode, sensTable=sensTable, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, inpName=inpName, SensorState=SensorState, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, tsTrapAlarmStart=tsTrapAlarmStart, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, setup=setup, InputAlarmState=InputAlarmState, sensFlags=sensFlags, tsAlarmId=tsAlarmId, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, outTable=outTable, sensValue=sensValue, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, inpEntry=inpEntry, tsAlarm=tsAlarm, SensorString=SensorString, inpTable=inpTable, sensHysteresis=sensHysteresis)
