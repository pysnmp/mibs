...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity, Gauge32, MibIdentifier, Bits, enterprises, Unsigned32, ObjectIdentity, Counter64, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "MibIdentifier", "Bits", "enterprises", "Unsigned32", "ObjectIdentity", "Counter64", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupEntry=sensSetupEntry, sensValue=sensValue, outIndex=outIndex, sensFlags=sensFlags, outType=outType, OnOff=OnOff, SensorUnitString=SensorUnitString, SensorState=SensorState, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, tsAlarmSensName=tsAlarmSensName, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, charonII=charonII, PositiveInteger=PositiveInteger, sensName=sensName, outTable=outTable, outValue=outValue, unitType=unitType, sensIndex=sensIndex, info=info, InputAlarmState=InputAlarmState, setup=setup, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, OutputMode=OutputMode, hwgroup=hwgroup, inpName=inpName, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, inpTable=inpTable, sensSetupTable=sensSetupTable, sensEntry=sensEntry, tsAlarmTime=tsAlarmTime, sensString=sensString, tsAlarmIdx=tsAlarmIdx, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, inpEntry=inpEntry, inpIndex=inpIndex, sensHysteresis=sensHysteresis, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, outEntry=outEntry, outMode=outMode, inpValue=inpValue, sensValueRaw=sensValueRaw, OutputType=OutputType, sensTable=sensTable, sensState=sensState, sensLimitMin=sensLimitMin, poseidon=poseidon, outName=outName, SensorString=SensorString, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, TimeStamp=TimeStamp, sensSetupName=sensSetupName, sensSetup=sensSetup, SensorValue=SensorValue)
