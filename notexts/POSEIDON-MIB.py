...
ObjectIdentity, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, ModuleIdentity, Counter64, iso, Integer32, IpAddress, Counter32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter64", "iso", "Integer32", "IpAddress", "Counter32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, InputAlarmState=InputAlarmState, poseidon=poseidon, info=info, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, sensHysteresis=sensHysteresis, sensFlags=sensFlags, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, sensID=sensID, inpTable=inpTable, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, sensValue=sensValue, setup=setup, outMode=outMode, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensEntry=sensEntry, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, inpIndex=inpIndex, inpName=inpName, sensTable=sensTable, sensState=sensState, OnOff=OnOff, UnitType=UnitType, IOName=IOName, charonII=charonII, sensString=sensString, outName=outName, inpValue=inpValue, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, sensSetupEntry=sensSetupEntry, outType=outType, sensSetupIndex=sensSetupIndex, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, inpEntry=inpEntry, tsAlarm=tsAlarm, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, OutputType=OutputType, SensorState=SensorState, SensorName=SensorName, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, sensUnitString=sensUnitString, hwgroup=hwgroup, SensorValue=SensorValue, outTable=outTable, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, sensIndex=sensIndex, outEntry=outEntry, outValue=outValue, unitType=unitType, SensorUnitString=SensorUnitString, sensName=sensName, SensorID=SensorID)
