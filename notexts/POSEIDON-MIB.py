...
ModuleIdentity, Counter64, Unsigned32, NotificationType, Counter32, IpAddress, MibIdentifier, enterprises, TimeTicks, ObjectIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "NotificationType", "Counter32", "IpAddress", "MibIdentifier", "enterprises", "TimeTicks", "ObjectIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, outName=outName, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, sensIndex=sensIndex, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, inpName=inpName, tsAlarmTable=tsAlarmTable, sensValue=sensValue, SensorValue=SensorValue, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, sensSetup=sensSetup, InputAlarmState=InputAlarmState, SensorID=SensorID, info=info, inpAlarmSetup=inpAlarmSetup, inpIndex=inpIndex, sensFlags=sensFlags, PositiveInteger=PositiveInteger, OnOff=OnOff, InputAlarmSetup=InputAlarmSetup, outType=outType, sensID=sensID, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, sensUnit=sensUnit, outIndex=outIndex, outValue=outValue, sensName=sensName, outTable=outTable, setup=setup, tsAlarmTime=tsAlarmTime, unitType=unitType, sensUnitString=sensUnitString, IOName=IOName, SensorName=SensorName, UnitType=UnitType, charonII=charonII, outEntry=outEntry, outMode=outMode, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, sensSetupEntry=sensSetupEntry, OutputType=OutputType, SensorString=SensorString, inpValue=inpValue, poseidon=poseidon, sensHysteresis=sensHysteresis, tsAlarmEntry=tsAlarmEntry, sensState=sensState, hwgroup=hwgroup, tsAlarm=tsAlarm, inpTable=inpTable, sensEntry=sensEntry, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, SensorFlags=SensorFlags, sensLimitMax=sensLimitMax, inpAlarmState=inpAlarmState, SensorState=SensorState, inpAlarmStateChanged=inpAlarmStateChanged, sensString=sensString)
