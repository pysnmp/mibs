...
ModuleIdentity, Unsigned32, TimeTicks, Gauge32, ObjectIdentity, Bits, Counter32, IpAddress, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, sensFlags=sensFlags, TimeStamp=TimeStamp, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, inpName=inpName, outEntry=outEntry, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, tsAlarmId=tsAlarmId, SensorState=SensorState, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, InputAlarmSetup=InputAlarmSetup, outMode=outMode, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, PositiveInteger=PositiveInteger, sensName=sensName, inpEntry=inpEntry, OutputMode=OutputMode, setup=setup, inpAlarmState=inpAlarmState, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, sensIndex=sensIndex, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, info=info, hwgroup=hwgroup, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, OnOff=OnOff, sensTable=sensTable, sensString=sensString, outIndex=outIndex, SensorString=SensorString, sensID=sensID, SensorID=SensorID, IOName=IOName, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, sensEntry=sensEntry, unitType=unitType, sensSetupEntry=sensSetupEntry, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, inpIndex=inpIndex, SensorName=SensorName, tsTrapAlarmEnd=tsTrapAlarmEnd, inpValue=inpValue, sensValue=sensValue, sensHysteresis=sensHysteresis, outValue=outValue, SensorFlags=SensorFlags, sensState=sensState, sensLimitMin=sensLimitMin, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, outTable=outTable, charonII=charonII, infoAddressMAC=infoAddressMAC, outName=outName)
