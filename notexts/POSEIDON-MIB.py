...
Counter32, Bits, Unsigned32, IpAddress, iso, Integer32, NotificationType, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Unsigned32", "IpAddress", "iso", "Integer32", "NotificationType", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, poseidon=poseidon, setup=setup, inpValue=inpValue, sensTable=sensTable, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, sensIndex=sensIndex, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, outType=outType, SensorState=SensorState, info=info, sensUnit=sensUnit, outIndex=outIndex, sensName=sensName, tsAlarmIdx=tsAlarmIdx, sensValue=sensValue, inpAlarmState=inpAlarmState, sensUnitString=sensUnitString, hwgroup=hwgroup, sensState=sensState, sensLimitMax=sensLimitMax, UnitType=UnitType, charonII=charonII, unitType=unitType, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, IOName=IOName, OutputMode=OutputMode, sensSetupTable=sensSetupTable, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, inpIndex=inpIndex, inpTable=inpTable, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, sensID=sensID, tsAlarm=tsAlarm, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, sensString=sensString, SensorValue=SensorValue, TimeStamp=TimeStamp, sensSetupName=sensSetupName, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, SensorString=SensorString, OnOff=OnOff, outMode=outMode, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, SensorFlags=SensorFlags, SensorName=SensorName, inpName=inpName, PositiveInteger=PositiveInteger, outValue=outValue, OutputType=OutputType, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, sensHysteresis=sensHysteresis, outTable=outTable, sensLimitMin=sensLimitMin)
