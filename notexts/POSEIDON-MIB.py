...
ObjectIdentity, Counter32, IpAddress, MibIdentifier, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, iso, NotificationType, Integer32, TimeTicks, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "iso", "NotificationType", "Integer32", "TimeTicks", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValue=sensValue, TimeStamp=TimeStamp, sensID=sensID, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, outValue=outValue, outIndex=outIndex, SensorState=SensorState, SensorString=SensorString, poseidon=poseidon, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, sensLimitMin=sensLimitMin, outEntry=outEntry, tsAlarmTime=tsAlarmTime, outTable=outTable, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, IOName=IOName, SensorUnitString=SensorUnitString, tsAlarmEntry=tsAlarmEntry, sensTable=sensTable, SensorFlags=SensorFlags, sensFlags=sensFlags, UnitType=UnitType, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, charonII=charonII, sensSetupName=sensSetupName, inpIndex=inpIndex, sensHysteresis=sensHysteresis, inpValue=inpValue, InputAlarmState=InputAlarmState, SensorID=SensorID, SensorName=SensorName, sensIndex=sensIndex, tsAlarmId=tsAlarmId, inpAlarmState=inpAlarmState, tsAlarmSensName=tsAlarmSensName, outMode=outMode, InputAlarmSetup=InputAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, sensSetupTable=sensSetupTable, OutputType=OutputType, info=info, tsAlarm=tsAlarm, sensUnitString=sensUnitString, sensName=sensName, sensState=sensState, OutputMode=OutputMode, OnOff=OnOff, sensEntry=sensEntry, sensValueRaw=sensValueRaw, tsAlarmDescr=tsAlarmDescr, unitType=unitType, inpAlarmSetup=inpAlarmSetup, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensString=sensString, SensorValue=SensorValue, inpTable=inpTable, sensUnit=sensUnit)
