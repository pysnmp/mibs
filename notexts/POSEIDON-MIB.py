...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, tsAlarm=tsAlarm, IOName=IOName, SensorFlags=SensorFlags, outValue=outValue, sensSetupEntry=sensSetupEntry, SensorString=SensorString, UnitType=UnitType, OutputMode=OutputMode, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, outIndex=outIndex, inpIndex=inpIndex, inpName=inpName, InputAlarmState=InputAlarmState, sensName=sensName, sensUnitString=sensUnitString, sensEntry=sensEntry, sensLimitMin=sensLimitMin, info=info, SensorName=SensorName, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, outMode=outMode, OutputType=OutputType, infoAddressMAC=infoAddressMAC, outName=outName, sensUnit=sensUnit, TimeStamp=TimeStamp, tsAlarmIdx=tsAlarmIdx, unitType=unitType, sensSetupTable=sensSetupTable, SensorState=SensorState, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, SensorUnitString=SensorUnitString, sensString=sensString, inpAlarmState=inpAlarmState, sensIndex=sensIndex, inpTable=inpTable, sensID=sensID, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, tsAlarmId=tsAlarmId, SensorID=SensorID, outEntry=outEntry, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, inpAlarmSetup=inpAlarmSetup, inpValue=inpValue, hwgroup=hwgroup, poseidon=poseidon, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, sensFlags=sensFlags, SensorValue=SensorValue, outTable=outTable, sensSetupIndex=sensSetupIndex, setup=setup, sensTable=sensTable)
