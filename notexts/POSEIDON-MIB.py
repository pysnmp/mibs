...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, poseidon=poseidon, inpAlarmSetup=inpAlarmSetup, hwgroup=hwgroup, charonII=charonII, sensValueRaw=sensValueRaw, inpTable=inpTable, inpEntry=inpEntry, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, outName=outName, SensorName=SensorName, setup=setup, sensSetupTable=sensSetupTable, info=info, inpName=inpName, outType=outType, sensName=sensName, tsAlarm=tsAlarm, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, OutputType=OutputType, sensFlags=sensFlags, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, IOName=IOName, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, outIndex=outIndex, OutputMode=OutputMode, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, SensorID=SensorID, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, PositiveInteger=PositiveInteger, sensValue=sensValue, InputAlarmState=InputAlarmState, sensState=sensState, sensID=sensID, OnOff=OnOff, sensSetup=sensSetup, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, sensString=sensString, outTable=outTable, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, outValue=outValue, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, SensorString=SensorString, outEntry=outEntry, inpIndex=inpIndex, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupIndex=sensSetupIndex, UnitType=UnitType, SensorFlags=SensorFlags, TimeStamp=TimeStamp, sensEntry=sensEntry, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis)
