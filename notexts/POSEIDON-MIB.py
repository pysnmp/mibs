...
Unsigned32, Counter64, ObjectIdentity, MibIdentifier, enterprises, Integer32, iso, Counter32, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "enterprises", "Integer32", "iso", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, InputAlarmState=InputAlarmState, info=info, sensUnitString=sensUnitString, tsAlarm=tsAlarm, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, sensSetupIndex=sensSetupIndex, outType=outType, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, IOName=IOName, inpIndex=inpIndex, inpName=inpName, sensUnit=sensUnit, sensTable=sensTable, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, sensName=sensName, sensState=sensState, tsAlarmId=tsAlarmId, unitType=unitType, outValue=outValue, sensValueRaw=sensValueRaw, charonII=charonII, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, inpTable=inpTable, OutputMode=OutputMode, outTable=outTable, TimeStamp=TimeStamp, hwgroup=hwgroup, outName=outName, poseidon=poseidon, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensID=sensID, OnOff=OnOff, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, outMode=outMode, SensorValue=SensorValue, SensorID=SensorID, sensValue=sensValue, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, OutputType=OutputType, SensorFlags=SensorFlags, SensorString=SensorString, inpValue=inpValue, sensString=sensString, SensorName=SensorName, sensIndex=sensIndex, setup=setup, tsAlarmTime=tsAlarmTime, tsAlarmTable=tsAlarmTable, sensLimitMax=sensLimitMax, tsAlarmsPresent=tsAlarmsPresent, outEntry=outEntry, outIndex=outIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, UnitType=UnitType)
