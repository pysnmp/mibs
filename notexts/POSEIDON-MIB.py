...
ObjectIdentity, MibIdentifier, IpAddress, Bits, ModuleIdentity, Integer32, Counter64, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "Counter64", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, sensState=sensState, unitType=unitType, tsAlarmSensName=tsAlarmSensName, tsAlarmTable=tsAlarmTable, OutputMode=OutputMode, SensorName=SensorName, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, inpTable=inpTable, inpAlarmState=inpAlarmState, charonII=charonII, outValue=outValue, sensIndex=sensIndex, setup=setup, sensUnit=sensUnit, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, info=info, outTable=outTable, sensLimitMax=sensLimitMax, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, sensString=sensString, sensHysteresis=sensHysteresis, outIndex=outIndex, sensName=sensName, OutputType=OutputType, inpValue=inpValue, tsAlarm=tsAlarm, hwgroup=hwgroup, sensSetupTable=sensSetupTable, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, sensSetupName=sensSetupName, SensorID=SensorID, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, inpIndex=inpIndex, sensID=sensID, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, TimeStamp=TimeStamp, outEntry=outEntry, SensorUnitString=SensorUnitString, sensValueRaw=sensValueRaw, sensValue=sensValue, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, IOName=IOName, poseidon=poseidon, inpName=inpName, SensorValue=SensorValue, outType=outType, SensorString=SensorString, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, SensorState=SensorState, inpEntry=inpEntry, SensorFlags=SensorFlags)
