...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, OutputMode=OutputMode, inpAlarmState=inpAlarmState, tsAlarmsPresent=tsAlarmsPresent, SensorID=SensorID, sensValue=sensValue, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, sensName=sensName, inpName=inpName, sensTable=sensTable, sensSetup=sensSetup, inpValue=inpValue, outIndex=outIndex, info=info, SensorValue=SensorValue, TimeStamp=TimeStamp, outTable=outTable, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable, SensorState=SensorState, inpEntry=inpEntry, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, sensSetupTable=sensSetupTable, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, outMode=outMode, SensorName=SensorName, inpTable=inpTable, OutputType=OutputType, setup=setup, SensorString=SensorString, sensIndex=sensIndex, outValue=outValue, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, OnOff=OnOff, sensSetupName=sensSetupName, sensString=sensString, sensEntry=sensEntry, tsAlarm=tsAlarm, outEntry=outEntry, sensFlags=sensFlags, unitType=unitType, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, charonII=charonII, sensValueRaw=sensValueRaw, sensState=sensState, IOName=IOName, infoAddressMAC=infoAddressMAC, outName=outName, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, tsAlarmId=tsAlarmId, poseidon=poseidon, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, inpIndex=inpIndex, outType=outType, tsAlarmEntry=tsAlarmEntry, PositiveInteger=PositiveInteger, sensID=sensID)
