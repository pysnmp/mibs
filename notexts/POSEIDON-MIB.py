...
ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, Integer32, Gauge32, IpAddress, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "Integer32", "Gauge32", "IpAddress", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "iso", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, PositiveInteger=PositiveInteger, tsAlarmEntry=tsAlarmEntry, sensValue=sensValue, sensSetupIndex=sensSetupIndex, inpName=inpName, sensValueRaw=sensValueRaw, UnitType=UnitType, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, setup=setup, sensEntry=sensEntry, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName, inpTable=inpTable, sensTable=sensTable, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, outIndex=outIndex, sensName=sensName, poseidon=poseidon, outValue=outValue, sensUnit=sensUnit, hwgroup=hwgroup, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx, outName=outName, sensFlags=sensFlags, SensorValue=SensorValue, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode, SensorState=SensorState, sensHysteresis=sensHysteresis, OutputType=OutputType, SensorID=SensorID, sensState=sensState, sensIndex=sensIndex, InputAlarmState=InputAlarmState, sensString=sensString, infoAddressMAC=infoAddressMAC, unitType=unitType, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, SensorFlags=SensorFlags, sensSetup=sensSetup, IOName=IOName, SensorUnitString=SensorUnitString, outEntry=outEntry, outMode=outMode, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, sensID=sensID, charonII=charonII, SensorName=SensorName, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, OnOff=OnOff, sensSetupEntry=sensSetupEntry, info=info)
