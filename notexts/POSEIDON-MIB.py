...
mibBuilder.exportSymbols("POSEIDON-MIB", unitType=unitType, charonII=charonII, inpValue=inpValue, sensValue=sensValue, SensorState=SensorState, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, OutputType=OutputType, SensorString=SensorString, UnitType=UnitType, inpName=inpName, SensorID=SensorID, outMode=outMode, sensUnit=sensUnit, SensorName=SensorName, sensSetupTable=sensSetupTable, sensString=sensString, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, sensID=sensID, sensTable=sensTable, PositiveInteger=PositiveInteger, hwgroup=hwgroup, setup=setup, tsAlarmTable=tsAlarmTable, InputAlarmSetup=InputAlarmSetup, sensLimitMax=sensLimitMax, outValue=outValue, SensorValue=SensorValue, inpTable=inpTable, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, sensState=sensState, tsAlarm=tsAlarm, sensName=sensName, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, outType=outType, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, IOName=IOName, outEntry=outEntry, outName=outName, sensSetup=sensSetup, InputAlarmState=InputAlarmState, sensLimitMin=sensLimitMin, SensorFlags=SensorFlags, outIndex=outIndex, sensValueRaw=sensValueRaw, inpIndex=inpIndex, sensFlags=sensFlags, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, tsAlarmsPresent=tsAlarmsPresent, OutputMode=OutputMode, inpEntry=inpEntry, sensUnitString=sensUnitString, OnOff=OnOff, info=info)
