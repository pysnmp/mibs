...
Integer32, Bits, Unsigned32, Counter32, NotificationType, ModuleIdentity, iso, IpAddress, MibIdentifier, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Unsigned32", "Counter32", "NotificationType", "ModuleIdentity", "iso", "IpAddress", "MibIdentifier", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMax=sensLimitMax, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, sensName=sensName, outIndex=outIndex, sensState=sensState, inpName=inpName, sensIndex=sensIndex, SensorFlags=SensorFlags, SensorState=SensorState, outName=outName, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, info=info, poseidon=poseidon, sensString=sensString, sensFlags=sensFlags, outEntry=outEntry, sensEntry=sensEntry, sensTable=sensTable, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, sensSetup=sensSetup, outValue=outValue, SensorName=SensorName, outType=outType, OutputType=OutputType, inpAlarmState=inpAlarmState, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, unitType=unitType, tsAlarm=tsAlarm, sensValue=sensValue, SensorString=SensorString, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, inpValue=inpValue, inpTable=inpTable, OnOff=OnOff, PositiveInteger=PositiveInteger, SensorID=SensorID, IOName=IOName, charonII=charonII, outTable=outTable, outMode=outMode, sensSetupTable=sensSetupTable, sensUnit=sensUnit, sensLimitMin=sensLimitMin, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmTable=tsAlarmTable, setup=setup, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, tsAlarmEntry=tsAlarmEntry, InputAlarmState=InputAlarmState, UnitType=UnitType, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, hwgroup=hwgroup)
