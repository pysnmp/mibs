...
Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Gauge32, enterprises, Integer32, Counter32, Unsigned32, ModuleIdentity, Counter64, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Gauge32", "enterprises", "Integer32", "Counter32", "Unsigned32", "ModuleIdentity", "Counter64", "iso", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, OutputType=OutputType, outMode=outMode, info=info, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, outType=outType, OutputMode=OutputMode, UnitType=UnitType, inpValue=inpValue, charonII=charonII, SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, SensorUnitString=SensorUnitString, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, inpTable=inpTable, sensLimitMin=sensLimitMin, outEntry=outEntry, outIndex=outIndex, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, outValue=outValue, unitType=unitType, IOName=IOName, SensorID=SensorID, inpName=inpName, sensIndex=sensIndex, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit, tsAlarmTime=tsAlarmTime, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, hwgroup=hwgroup, poseidon=poseidon, outTable=outTable, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, OnOff=OnOff, sensFlags=sensFlags, sensName=sensName, sensValue=sensValue, tsAlarmEntry=tsAlarmEntry, TimeStamp=TimeStamp, inpIndex=inpIndex, SensorString=SensorString, sensUnitString=sensUnitString, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensID=sensID, SensorName=SensorName, tsAlarmDescr=tsAlarmDescr, outName=outName, InputAlarmSetup=InputAlarmSetup, sensString=sensString, tsAlarmSensName=tsAlarmSensName)
