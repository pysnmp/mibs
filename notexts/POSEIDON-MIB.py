...
enterprises, ModuleIdentity, MibIdentifier, IpAddress, Bits, Gauge32, Counter64, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Counter64", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, SensorID=SensorID, sensLimitMax=sensLimitMax, tsAlarmTable=tsAlarmTable, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, sensName=sensName, sensLimitMin=sensLimitMin, sensString=sensString, IOName=IOName, tsAlarmDescr=tsAlarmDescr, sensEntry=sensEntry, unitType=unitType, OnOff=OnOff, poseidon=poseidon, outMode=outMode, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmSensName=tsAlarmSensName, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, sensAlarmStateChanged=sensAlarmStateChanged, charonII=charonII, sensUnitString=sensUnitString, sensValue=sensValue, sensSetupEntry=sensSetupEntry, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmState=inpAlarmState, outTable=outTable, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, sensID=sensID, tsAlarm=tsAlarm, sensState=sensState, SensorName=SensorName, info=info, outIndex=outIndex, outEntry=outEntry, inpEntry=inpEntry, sensUnit=sensUnit, setup=setup, inpTable=inpTable, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, outValue=outValue, OutputMode=OutputMode, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, outType=outType, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, hwgroup=hwgroup, sensSetupName=sensSetupName, outName=outName, sensHysteresis=sensHysteresis, inpValue=inpValue, sensTable=sensTable, sensSetupTable=sensSetupTable, SensorState=SensorState, SensorUnitString=SensorUnitString, OutputType=OutputType, TimeStamp=TimeStamp, inpName=inpName, SensorValue=SensorValue)
