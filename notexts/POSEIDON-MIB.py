...
ModuleIdentity, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, Counter64, TimeTicks, enterprises, Bits, Gauge32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "TimeTicks", "enterprises", "Bits", "Gauge32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, outTable=outTable, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, SensorName=SensorName, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, SensorString=SensorString, sensName=sensName, sensID=sensID, SensorID=SensorID, hwgroup=hwgroup, inpName=inpName, sensIndex=sensIndex, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, tsAlarmEntry=tsAlarmEntry, setup=setup, InputAlarmSetup=InputAlarmSetup, outType=outType, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, info=info, sensValue=sensValue, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, OutputMode=OutputMode, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, inpIndex=inpIndex, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, inpValue=inpValue, sensTable=sensTable, sensSetup=sensSetup, SensorValue=SensorValue, TimeStamp=TimeStamp, inpEntry=inpEntry, sensUnit=sensUnit, sensFlags=sensFlags, tsAlarm=tsAlarm, IOName=IOName, outName=outName, sensValueRaw=sensValueRaw, sensState=sensState, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, outEntry=outEntry, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, OutputType=OutputType, sensString=sensString, unitType=unitType, charonII=charonII, poseidon=poseidon, InputAlarmState=InputAlarmState, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, PositiveInteger=PositiveInteger, sensSetupEntry=sensSetupEntry, outIndex=outIndex, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName)
