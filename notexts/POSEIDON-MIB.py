...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ObjectIdentity, NotificationType, iso, ModuleIdentity, Bits, Gauge32, Counter64, IpAddress, Integer32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "IpAddress", "Integer32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", charonII=charonII, sensTable=sensTable, outName=outName, tsAlarmsPresent=tsAlarmsPresent, sensValue=sensValue, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, OnOff=OnOff, OutputMode=OutputMode, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, sensID=sensID, tsAlarmId=tsAlarmId, sensString=sensString, sensName=sensName, tsAlarm=tsAlarm, outMode=outMode, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, sensIndex=sensIndex, poseidon=poseidon, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, setup=setup, SensorState=SensorState, sensLimitMin=sensLimitMin, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, inpEntry=inpEntry, outIndex=outIndex, TimeStamp=TimeStamp, outEntry=outEntry, outType=outType, PositiveInteger=PositiveInteger, inpAlarmSetup=inpAlarmSetup, unitType=unitType, infoAddressMAC=infoAddressMAC, inpTable=inpTable, SensorName=SensorName, sensUnit=sensUnit, inpValue=inpValue, tsAlarmSensName=tsAlarmSensName, SensorID=SensorID, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, SensorFlags=SensorFlags, IOName=IOName, outTable=outTable, OutputType=OutputType, tsAlarmIdx=tsAlarmIdx, InputAlarmState=InputAlarmState, sensValueRaw=sensValueRaw, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, sensSetup=sensSetup, SensorUnitString=SensorUnitString, info=info, UnitType=UnitType, inpAlarmState=inpAlarmState, outValue=outValue, inpName=inpName, SensorValue=SensorValue)
