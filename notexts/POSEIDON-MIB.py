...
ModuleIdentity, ObjectIdentity, enterprises, Bits, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter32, iso, MibIdentifier, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "Bits", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter32", "iso", "MibIdentifier", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, tsAlarmTime=tsAlarmTime, tsAlarmDescr=tsAlarmDescr, inpName=inpName, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, outType=outType, tsTrapAlarmStart=tsTrapAlarmStart, sensString=sensString, InputAlarmSetup=InputAlarmSetup, tsAlarmTable=tsAlarmTable, outTable=outTable, sensValueRaw=sensValueRaw, inpAlarmState=inpAlarmState, sensID=sensID, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, inpEntry=inpEntry, outEntry=outEntry, sensSetupIndex=sensSetupIndex, inpValue=inpValue, unitType=unitType, SensorString=SensorString, outIndex=outIndex, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, sensEntry=sensEntry, PositiveInteger=PositiveInteger, poseidon=poseidon, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, charonII=charonII, outMode=outMode, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, sensName=sensName, hwgroup=hwgroup, OnOff=OnOff, SensorID=SensorID, info=info, sensTable=sensTable, tsAlarmIdx=tsAlarmIdx, SensorValue=SensorValue, OutputMode=OutputMode, sensValue=sensValue, UnitType=UnitType, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, SensorState=SensorState, TimeStamp=TimeStamp, setup=setup, outValue=outValue, sensUnit=sensUnit, inpAlarmStateChanged=inpAlarmStateChanged, inpTable=inpTable, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, infoAddressMAC=infoAddressMAC, OutputType=OutputType, inpIndex=inpIndex, sensFlags=sensFlags, tsAlarmsPresent=tsAlarmsPresent, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, sensIndex=sensIndex, IOName=IOName)
