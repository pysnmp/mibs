...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Gauge32, NotificationType, IpAddress, MibIdentifier, Counter32, enterprises, iso, Counter64, Unsigned32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Gauge32", "NotificationType", "IpAddress", "MibIdentifier", "Counter32", "enterprises", "iso", "Counter64", "Unsigned32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, inpIndex=inpIndex, SensorString=SensorString, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, outTable=outTable, SensorID=SensorID, inpName=inpName, sensString=sensString, OutputType=OutputType, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, UnitType=UnitType, sensName=sensName, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, setup=setup, outEntry=outEntry, tsAlarm=tsAlarm, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, tsAlarmDescr=tsAlarmDescr, SensorValue=SensorValue, SensorName=SensorName, sensSetupName=sensSetupName, info=info, outType=outType, sensSetup=sensSetup, sensUnitString=sensUnitString, sensTable=sensTable, charonII=charonII, unitType=unitType, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, OutputMode=OutputMode, sensEntry=sensEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, outIndex=outIndex, sensState=sensState, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, sensUnit=sensUnit, OnOff=OnOff, sensIndex=sensIndex, poseidon=poseidon, SensorUnitString=SensorUnitString, SensorState=SensorState, sensID=sensID, outValue=outValue, SensorFlags=SensorFlags)
