...
Gauge32, iso, TimeTicks, MibIdentifier, NotificationType, Unsigned32, enterprises, IpAddress, Integer32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "TimeTicks", "MibIdentifier", "NotificationType", "Unsigned32", "enterprises", "IpAddress", "Integer32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, SensorID=SensorID, tsAlarm=tsAlarm, InputAlarmSetup=InputAlarmSetup, IOName=IOName, outIndex=outIndex, poseidon=poseidon, outEntry=outEntry, tsAlarmTable=tsAlarmTable, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, SensorUnitString=SensorUnitString, sensString=sensString, tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, OutputType=OutputType, OutputMode=OutputMode, inpAlarmState=inpAlarmState, sensSetup=sensSetup, sensLimitMin=sensLimitMin, sensIndex=sensIndex, sensTable=sensTable, sensState=sensState, sensEntry=sensEntry, UnitType=UnitType, SensorName=SensorName, info=info, outTable=outTable, hwgroup=hwgroup, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, sensFlags=sensFlags, outValue=outValue, sensAlarmStateChanged=sensAlarmStateChanged, sensValueRaw=sensValueRaw, inpTable=inpTable, setup=setup, sensValue=sensValue, tsAlarmIdx=tsAlarmIdx, outType=outType, tsAlarmsPresent=tsAlarmsPresent, outName=outName, SensorFlags=SensorFlags, sensUnit=sensUnit, SensorString=SensorString, outMode=outMode, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, sensSetupTable=sensSetupTable, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, SensorValue=SensorValue, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, sensName=sensName, sensID=sensID, tsAlarmEntry=tsAlarmEntry, inpValue=inpValue, charonII=charonII, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, InputAlarmState=InputAlarmState, tsAlarmSensName=tsAlarmSensName, inpName=inpName)
