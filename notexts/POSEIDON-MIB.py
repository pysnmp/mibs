...
Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Integer32, Gauge32, TimeTicks, Counter64, MibIdentifier, Bits, NotificationType, IpAddress, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Integer32", "Gauge32", "TimeTicks", "Counter64", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensName=sensName, InputAlarmSetup=InputAlarmSetup, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, SensorUnitString=SensorUnitString, unitType=unitType, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, OutputType=OutputType, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmState=inpAlarmState, charonII=charonII, inpIndex=inpIndex, tsAlarm=tsAlarm, sensTable=sensTable, SensorFlags=SensorFlags, inpValue=inpValue, SensorValue=SensorValue, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, inpName=inpName, sensSetup=sensSetup, sensLimitMax=sensLimitMax, OutputMode=OutputMode, info=info, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, hwgroup=hwgroup, poseidon=poseidon, SensorID=SensorID, inpAlarmSetup=inpAlarmSetup, outValue=outValue, sensSetupName=sensSetupName, outType=outType, sensSetupEntry=sensSetupEntry, SensorString=SensorString, PositiveInteger=PositiveInteger, sensIndex=sensIndex, SensorState=SensorState, inpTable=inpTable, tsAlarmDescr=tsAlarmDescr, sensString=sensString, sensSetupIndex=sensSetupIndex, tsAlarmTable=tsAlarmTable, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, SensorName=SensorName, outMode=outMode, UnitType=UnitType, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, OnOff=OnOff, IOName=IOName, sensLimitMin=sensLimitMin, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, inpEntry=inpEntry, sensHysteresis=sensHysteresis, sensUnit=sensUnit, outTable=outTable, outEntry=outEntry, sensEntry=sensEntry)
