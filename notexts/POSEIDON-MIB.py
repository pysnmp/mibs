...
mibBuilder.exportSymbols("POSEIDON-MIB", sensString=sensString, SensorFlags=SensorFlags, sensID=sensID, sensLimitMax=sensLimitMax, OutputType=OutputType, tsAlarmsPresent=tsAlarmsPresent, inpTable=inpTable, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, OutputMode=OutputMode, sensValueRaw=sensValueRaw, charonII=charonII, setup=setup, sensUnitString=sensUnitString, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, sensTable=sensTable, tsAlarmDescr=tsAlarmDescr, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, outEntry=outEntry, IOName=IOName, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, sensState=sensState, PositiveInteger=PositiveInteger, inpName=inpName, tsAlarmTime=tsAlarmTime, tsAlarmIdx=tsAlarmIdx, outName=outName, info=info, outValue=outValue, sensHysteresis=sensHysteresis, outType=outType, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, outTable=outTable, sensLimitMin=sensLimitMin, sensName=sensName, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, SensorState=SensorState, OnOff=OnOff, sensUnit=sensUnit, tsAlarmId=tsAlarmId, inpEntry=inpEntry, sensFlags=sensFlags, poseidon=poseidon, unitType=unitType, UnitType=UnitType, inpIndex=inpIndex, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, outIndex=outIndex, inpAlarmState=inpAlarmState, hwgroup=hwgroup, TimeStamp=TimeStamp, inpValue=inpValue, sensSetup=sensSetup, tsAlarm=tsAlarm, outMode=outMode, tsAlarmSensName=tsAlarmSensName)
