...
Gauge32, Counter32, Unsigned32, ObjectIdentity, NotificationType, Integer32, ModuleIdentity, MibIdentifier, Bits, TimeTicks, IpAddress, iso, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Unsigned32", "ObjectIdentity", "NotificationType", "Integer32", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "IpAddress", "iso", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorUnitString=SensorUnitString, outIndex=outIndex, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, info=info, inpName=inpName, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, IOName=IOName, SensorFlags=SensorFlags, inpValue=inpValue, sensTable=sensTable, inpEntry=inpEntry, outName=outName, sensEntry=sensEntry, sensUnit=sensUnit, UnitType=UnitType, sensLimitMax=sensLimitMax, sensSetupTable=sensSetupTable, OutputMode=OutputMode, inpTable=inpTable, SensorState=SensorState, outTable=outTable, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, tsAlarmIdx=tsAlarmIdx, sensString=sensString, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, SensorID=SensorID, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, outType=outType, sensUnitString=sensUnitString, unitType=unitType, OutputType=OutputType, sensFlags=sensFlags, tsAlarmDescr=tsAlarmDescr, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, sensSetup=sensSetup, sensIndex=sensIndex, SensorString=SensorString, poseidon=poseidon, sensValueRaw=sensValueRaw, sensID=sensID, outMode=outMode, tsAlarmEntry=tsAlarmEntry, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, outValue=outValue, charonII=charonII, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, setup=setup, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, OnOff=OnOff, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, sensState=sensState, sensSetupIndex=sensSetupIndex, outEntry=outEntry)
