...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetup=sensSetup, SensorFlags=SensorFlags, infoAddressMAC=infoAddressMAC, SensorName=SensorName, outTable=outTable, sensString=sensString, sensHysteresis=sensHysteresis, sensID=sensID, sensLimitMin=sensLimitMin, inpValue=inpValue, OutputMode=OutputMode, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, sensUnit=sensUnit, outIndex=outIndex, sensEntry=sensEntry, inpIndex=inpIndex, unitType=unitType, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, setup=setup, tsAlarm=tsAlarm, inpName=inpName, outType=outType, SensorState=SensorState, sensSetupEntry=sensSetupEntry, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, UnitType=UnitType, SensorUnitString=SensorUnitString, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, outValue=outValue, sensValueRaw=sensValueRaw, SensorID=SensorID, inpEntry=inpEntry, sensTable=sensTable, OutputType=OutputType, sensName=sensName, sensUnitString=sensUnitString, tsAlarmTable=tsAlarmTable, outEntry=outEntry, sensSetupIndex=sensSetupIndex, sensValue=sensValue, inpTable=inpTable, SensorValue=SensorValue, sensSetupTable=sensSetupTable, info=info, sensIndex=sensIndex, IOName=IOName, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime, charonII=charonII, sensState=sensState, hwgroup=hwgroup, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, poseidon=poseidon, inpAlarmSetup=inpAlarmSetup, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger)
