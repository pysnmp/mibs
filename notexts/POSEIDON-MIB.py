...
enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Integer32, IpAddress, MibIdentifier, Counter64, Counter32, Unsigned32, iso, TimeTicks, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "Unsigned32", "iso", "TimeTicks", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, sensIndex=sensIndex, SensorValue=SensorValue, sensSetupName=sensSetupName, tsAlarmSensName=tsAlarmSensName, OnOff=OnOff, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, sensString=sensString, sensID=sensID, SensorState=SensorState, sensSetup=sensSetup, unitType=unitType, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, sensEntry=sensEntry, InputAlarmState=InputAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, UnitType=UnitType, sensName=sensName, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, SensorName=SensorName, inpTable=inpTable, sensUnit=sensUnit, sensValueRaw=sensValueRaw, inpName=inpName, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, OutputMode=OutputMode, tsAlarm=tsAlarm, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, SensorID=SensorID, OutputType=OutputType, outTable=outTable, hwgroup=hwgroup, outName=outName, IOName=IOName, inpAlarmState=inpAlarmState, info=info, sensLimitMax=sensLimitMax, outMode=outMode, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, outValue=outValue, outType=outType, setup=setup, sensValue=sensValue, SensorUnitString=SensorUnitString, charonII=charonII, sensHysteresis=sensHysteresis)
