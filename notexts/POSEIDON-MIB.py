...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, sensIndex=sensIndex, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, OutputType=OutputType, SensorValue=SensorValue, sensID=sensID, tsAlarmId=tsAlarmId, outIndex=outIndex, unitType=unitType, sensSetupEntry=sensSetupEntry, outMode=outMode, SensorFlags=SensorFlags, setup=setup, sensLimitMax=sensLimitMax, sensUnit=sensUnit, SensorName=SensorName, TimeStamp=TimeStamp, sensHysteresis=sensHysteresis, sensEntry=sensEntry, charonII=charonII, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, tsTrapAlarmStart=tsTrapAlarmStart, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, outEntry=outEntry, sensString=sensString, sensName=sensName, SensorID=SensorID, outName=outName, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, inpName=inpName, inpAlarmState=inpAlarmState, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, OnOff=OnOff, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, poseidon=poseidon, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, InputAlarmState=InputAlarmState, hwgroup=hwgroup, SensorState=SensorState, sensFlags=sensFlags, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, sensSetupName=sensSetupName, info=info, sensValue=sensValue, sensTable=sensTable, inpValue=inpValue, tsAlarmTime=tsAlarmTime, outTable=outTable, SensorString=SensorString)
