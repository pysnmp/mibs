...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Bits, ObjectIdentity, NotificationType, MibIdentifier, Counter64, ModuleIdentity, TimeTicks, IpAddress, Counter32, Gauge32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Bits", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter64", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter32", "Gauge32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensID=sensID, TimeStamp=TimeStamp, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, OutputMode=OutputMode, SensorUnitString=SensorUnitString, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, sensSetupTable=sensSetupTable, sensName=sensName, inpTable=inpTable, outType=outType, setup=setup, inpAlarmSetup=inpAlarmSetup, outMode=outMode, sensLimitMax=sensLimitMax, hwgroup=hwgroup, sensValue=sensValue, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, charonII=charonII, InputAlarmState=InputAlarmState, poseidon=poseidon, tsAlarm=tsAlarm, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, SensorID=SensorID, sensState=sensState, OutputType=OutputType, SensorName=SensorName, outIndex=outIndex, outName=outName, outTable=outTable, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, sensEntry=sensEntry, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, outValue=outValue, sensTable=sensTable, sensIndex=sensIndex, inpName=inpName, IOName=IOName, unitType=unitType, SensorString=SensorString, info=info, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensValueRaw=sensValueRaw, sensString=sensString, sensSetup=sensSetup, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, OnOff=OnOff, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, SensorFlags=SensorFlags, sensSetupEntry=sensSetupEntry, outEntry=outEntry)
