...
Bits, IpAddress, ModuleIdentity, MibIdentifier, Gauge32, enterprises, Counter32, ObjectIdentity, iso, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "ModuleIdentity", "MibIdentifier", "Gauge32", "enterprises", "Counter32", "ObjectIdentity", "iso", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, PositiveInteger=PositiveInteger, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, inpValue=inpValue, tsTrapAlarmStart=tsTrapAlarmStart, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, outType=outType, sensLimitMin=sensLimitMin, sensString=sensString, OutputType=OutputType, outValue=outValue, unitType=unitType, charonII=charonII, TimeStamp=TimeStamp, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensState=sensState, SensorName=SensorName, sensValueRaw=sensValueRaw, sensEntry=sensEntry, setup=setup, sensTable=sensTable, outTable=outTable, OnOff=OnOff, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, sensSetupEntry=sensSetupEntry, OutputMode=OutputMode, IOName=IOName, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, sensFlags=sensFlags, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, sensIndex=sensIndex, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, SensorState=SensorState, inpTable=inpTable, outName=outName, inpName=inpName, sensName=sensName, info=info, sensUnitString=sensUnitString, SensorString=SensorString, sensSetupTable=sensSetupTable, UnitType=UnitType, outMode=outMode, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, sensID=sensID, SensorID=SensorID, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, InputAlarmState=InputAlarmState, tsAlarmTime=tsAlarmTime)
