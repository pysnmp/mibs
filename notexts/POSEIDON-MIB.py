...
Gauge32, NotificationType, Counter32, ModuleIdentity, Unsigned32, Counter64, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, TimeTicks, enterprises, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter32", "ModuleIdentity", "Unsigned32", "Counter64", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "TimeTicks", "enterprises", "iso", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, SensorValue=SensorValue, sensID=sensID, InputAlarmSetup=InputAlarmSetup, SensorUnitString=SensorUnitString, hwgroup=hwgroup, info=info, sensIndex=sensIndex, sensUnitString=sensUnitString, inpValue=inpValue, UnitType=UnitType, sensString=sensString, sensUnit=sensUnit, outIndex=outIndex, outValue=outValue, sensValue=sensValue, PositiveInteger=PositiveInteger, SensorName=SensorName, poseidon=poseidon, OutputMode=OutputMode, inpTable=inpTable, inpEntry=inpEntry, sensName=sensName, outName=outName, tsAlarmId=tsAlarmId, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, inpAlarmSetup=inpAlarmSetup, setup=setup, unitType=unitType, SensorString=SensorString, inpIndex=inpIndex, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, outType=outType, tsAlarmsPresent=tsAlarmsPresent, SensorID=SensorID, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, sensTable=sensTable, sensState=sensState, sensSetupName=sensSetupName, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, outEntry=outEntry, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, SensorState=SensorState, InputAlarmState=InputAlarmState, OutputType=OutputType, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, sensSetupTable=sensSetupTable, charonII=charonII, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, outMode=outMode, outTable=outTable, infoAddressMAC=infoAddressMAC)
