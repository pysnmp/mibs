...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, Gauge32, ObjectIdentity, NotificationType, enterprises, ModuleIdentity, MibIdentifier, Counter64, TimeTicks, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "NotificationType", "enterprises", "ModuleIdentity", "MibIdentifier", "Counter64", "TimeTicks", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, charonII=charonII, InputAlarmState=InputAlarmState, info=info, UnitType=UnitType, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, outValue=outValue, SensorValue=SensorValue, SensorUnitString=SensorUnitString, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, unitType=unitType, OutputMode=OutputMode, sensTable=sensTable, sensValueRaw=sensValueRaw, SensorFlags=SensorFlags, sensSetupEntry=sensSetupEntry, tsAlarmTable=tsAlarmTable, inpAlarmState=inpAlarmState, hwgroup=hwgroup, PositiveInteger=PositiveInteger, sensName=sensName, tsAlarm=tsAlarm, inpTable=inpTable, SensorID=SensorID, sensEntry=sensEntry, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, SensorName=SensorName, inpName=inpName, outName=outName, sensSetupIndex=sensSetupIndex, IOName=IOName, tsTrapAlarmEnd=tsTrapAlarmEnd, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, OnOff=OnOff, OutputType=OutputType, outMode=outMode, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, sensString=sensString, InputAlarmSetup=InputAlarmSetup, sensID=sensID, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, poseidon=poseidon, SensorString=SensorString, sensState=sensState, sensLimitMax=sensLimitMax, outTable=outTable, inpValue=inpValue, sensIndex=sensIndex, tsAlarmEntry=tsAlarmEntry, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, outEntry=outEntry, outIndex=outIndex, tsAlarmSensName=tsAlarmSensName, setup=setup, inpIndex=inpIndex, SensorState=SensorState, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged)
