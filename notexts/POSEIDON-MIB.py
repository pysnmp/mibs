...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, NotificationType, Counter64, enterprises, MibIdentifier, TimeTicks, ModuleIdentity, ObjectIdentity, Bits, Unsigned32, Integer32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "NotificationType", "Counter64", "enterprises", "MibIdentifier", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Bits", "Unsigned32", "Integer32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, OutputMode=OutputMode, SensorValue=SensorValue, sensString=sensString, SensorFlags=SensorFlags, inpIndex=inpIndex, SensorState=SensorState, outMode=outMode, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, sensUnit=sensUnit, hwgroup=hwgroup, IOName=IOName, outTable=outTable, SensorID=SensorID, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, unitType=unitType, sensID=sensID, sensSetup=sensSetup, sensSetupTable=sensSetupTable, InputAlarmState=InputAlarmState, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, outName=outName, sensFlags=sensFlags, setup=setup, inpName=inpName, sensLimitMin=sensLimitMin, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, OnOff=OnOff, tsAlarmEntry=tsAlarmEntry, poseidon=poseidon, sensSetupIndex=sensSetupIndex, sensState=sensState, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, UnitType=UnitType, info=info, sensValue=sensValue, OutputType=OutputType, outType=outType, tsAlarmTable=tsAlarmTable, sensEntry=sensEntry, sensLimitMax=sensLimitMax, SensorName=SensorName, sensHysteresis=sensHysteresis, sensTable=sensTable, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, inpValue=inpValue, outValue=outValue, sensValueRaw=sensValueRaw, outEntry=outEntry, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmSensName=tsAlarmSensName, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, tsAlarmId=tsAlarmId, sensUnitString=sensUnitString)
