...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTime=tsAlarmTime, OutputType=OutputType, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, outEntry=outEntry, outType=outType, inpValue=inpValue, sensIndex=sensIndex, sensUnit=sensUnit, tsAlarmId=tsAlarmId, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, inpTable=inpTable, inpAlarmState=inpAlarmState, outIndex=outIndex, SensorID=SensorID, sensSetupIndex=sensSetupIndex, outMode=outMode, poseidon=poseidon, tsAlarm=tsAlarm, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensLimitMin=sensLimitMin, infoAddressMAC=infoAddressMAC, tsTrapAlarmEnd=tsTrapAlarmEnd, sensString=sensString, InputAlarmSetup=InputAlarmSetup, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, setup=setup, sensID=sensID, tsAlarmTable=tsAlarmTable, IOName=IOName, sensAlarmStateChanged=sensAlarmStateChanged, inpEntry=inpEntry, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, sensState=sensState, unitType=unitType, sensSetupTable=sensSetupTable, sensTable=sensTable, PositiveInteger=PositiveInteger, UnitType=UnitType, inpName=inpName, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, outName=outName, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, sensName=sensName, sensValueRaw=sensValueRaw, charonII=charonII, sensSetupName=sensSetupName, sensSetup=sensSetup, SensorName=SensorName, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, sensEntry=sensEntry, outTable=outTable, OnOff=OnOff, inpIndex=inpIndex, OutputMode=OutputMode, hwgroup=hwgroup, outValue=outValue, info=info, SensorState=SensorState, TimeStamp=TimeStamp)
