...
IpAddress, Counter64, ModuleIdentity, MibIdentifier, iso, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, ObjectIdentity, enterprises, TimeTicks, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "ModuleIdentity", "MibIdentifier", "iso", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "ObjectIdentity", "enterprises", "TimeTicks", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, sensState=sensState, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, inpTable=inpTable, inpValue=inpValue, sensTable=sensTable, inpIndex=inpIndex, outType=outType, outEntry=outEntry, infoAddressMAC=infoAddressMAC, tsAlarm=tsAlarm, SensorValue=SensorValue, setup=setup, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, unitType=unitType, SensorName=SensorName, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, SensorUnitString=SensorUnitString, UnitType=UnitType, PositiveInteger=PositiveInteger, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, outMode=outMode, outTable=outTable, sensFlags=sensFlags, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, sensIndex=sensIndex, hwgroup=hwgroup, sensValue=sensValue, sensString=sensString, poseidon=poseidon, SensorID=SensorID, TimeStamp=TimeStamp, inpEntry=inpEntry, outIndex=outIndex, inpName=inpName, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, sensSetupIndex=sensSetupIndex, charonII=charonII, outValue=outValue, sensSetupTable=sensSetupTable, tsAlarmTable=tsAlarmTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, sensID=sensID, info=info, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit, SensorState=SensorState, outName=outName, sensUnitString=sensUnitString)
