...
mibBuilder.exportSymbols("POSEIDON-MIB", outIndex=outIndex, inpIndex=inpIndex, sensState=sensState, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, OutputMode=OutputMode, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, inpName=inpName, SensorUnitString=SensorUnitString, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, hwgroup=hwgroup, sensValueRaw=sensValueRaw, outEntry=outEntry, sensSetupEntry=sensSetupEntry, poseidon=poseidon, inpAlarmState=inpAlarmState, OutputType=OutputType, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, unitType=unitType, infoAddressMAC=infoAddressMAC, tsAlarm=tsAlarm, sensString=sensString, sensSetupName=sensSetupName, SensorName=SensorName, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, OnOff=OnOff, SensorID=SensorID, charonII=charonII, UnitType=UnitType, inpValue=inpValue, sensLimitMax=sensLimitMax, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, tsAlarmSensName=tsAlarmSensName, sensTable=sensTable, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, IOName=IOName, outType=outType, SensorFlags=SensorFlags, sensEntry=sensEntry, tsAlarmId=tsAlarmId, info=info, SensorValue=SensorValue, sensUnit=sensUnit, TimeStamp=TimeStamp, inpTable=inpTable, SensorState=SensorState, inpEntry=inpEntry, sensFlags=sensFlags, sensID=sensID, setup=setup, sensValue=sensValue, tsAlarmEntry=tsAlarmEntry, sensUnitString=sensUnitString, outName=outName)
