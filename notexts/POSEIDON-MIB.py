...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, MibIdentifier, iso, TimeTicks, enterprises, Counter64, IpAddress, Bits, NotificationType, Integer32, Unsigned32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "MibIdentifier", "iso", "TimeTicks", "enterprises", "Counter64", "IpAddress", "Bits", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, sensUnitString=sensUnitString, outValue=outValue, sensUnit=sensUnit, tsAlarmId=tsAlarmId, inpName=inpName, sensSetup=sensSetup, info=info, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, SensorFlags=SensorFlags, SensorState=SensorState, sensLimitMax=sensLimitMax, poseidon=poseidon, sensSetupIndex=sensSetupIndex, IOName=IOName, outIndex=outIndex, charonII=charonII, setup=setup, sensID=sensID, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, sensIndex=sensIndex, sensSetupName=sensSetupName, tsAlarmsPresent=tsAlarmsPresent, outMode=outMode, sensHysteresis=sensHysteresis, unitType=unitType, outEntry=outEntry, inpAlarmSetup=inpAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, inpTable=inpTable, inpEntry=inpEntry, inpIndex=inpIndex, inpAlarmState=inpAlarmState, sensName=sensName, sensValue=sensValue, sensSetupEntry=sensSetupEntry, tsAlarmIdx=tsAlarmIdx, sensState=sensState, SensorString=SensorString, InputAlarmState=InputAlarmState, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, SensorName=SensorName, SensorID=SensorID, outTable=outTable, inpValue=inpValue, sensTable=sensTable, sensEntry=sensEntry, sensString=sensString, sensValueRaw=sensValueRaw, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, tsAlarm=tsAlarm, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, UnitType=UnitType, outName=outName, tsAlarmTable=tsAlarmTable, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, OutputType=OutputType)
