...
MibIdentifier, ObjectIdentity, IpAddress, Bits, Unsigned32, Counter32, Counter64, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "IpAddress", "Bits", "Unsigned32", "Counter32", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "enterprises", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, charonII=charonII, outName=outName, tsAlarmTable=tsAlarmTable, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, UnitType=UnitType, outType=outType, sensIndex=sensIndex, PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin, OutputType=OutputType, sensUnit=sensUnit, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, inpTable=inpTable, sensSetupTable=sensSetupTable, OnOff=OnOff, SensorID=SensorID, outValue=outValue, SensorUnitString=SensorUnitString, outIndex=outIndex, sensEntry=sensEntry, sensName=sensName, sensState=sensState, unitType=unitType, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, SensorState=SensorState, sensString=sensString, inpName=inpName, sensID=sensID, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, sensSetup=sensSetup, SensorName=SensorName, tsAlarmTime=tsAlarmTime, outMode=outMode, sensSetupEntry=sensSetupEntry, InputAlarmSetup=InputAlarmSetup, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, setup=setup, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, info=info, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, outTable=outTable, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, poseidon=poseidon, inpEntry=inpEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, outEntry=outEntry, sensUnitString=sensUnitString, inpIndex=inpIndex, hwgroup=hwgroup)
