...
Bits, Unsigned32, iso, IpAddress, Counter32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, enterprises, ModuleIdentity, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "IpAddress", "Counter32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmState=InputAlarmState, SensorValue=SensorValue, sensTable=sensTable, PositiveInteger=PositiveInteger, sensString=sensString, tsAlarmTime=tsAlarmTime, OutputType=OutputType, tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, OutputMode=OutputMode, setup=setup, inpValue=inpValue, outEntry=outEntry, sensState=sensState, tsAlarmTable=tsAlarmTable, outType=outType, inpTable=inpTable, sensFlags=sensFlags, sensEntry=sensEntry, SensorFlags=SensorFlags, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, sensSetupName=sensSetupName, sensUnit=sensUnit, sensSetup=sensSetup, SensorName=SensorName, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, sensLimitMax=sensLimitMax, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, inpAlarmState=inpAlarmState, TimeStamp=TimeStamp, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, outMode=outMode, inpIndex=inpIndex, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, inpEntry=inpEntry, sensName=sensName, inpAlarmStateChanged=inpAlarmStateChanged, sensID=sensID, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, SensorString=SensorString, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, IOName=IOName, outTable=outTable, tsAlarmSensName=tsAlarmSensName, inpName=inpName, outName=outName, sensValue=sensValue, SensorState=SensorState, sensSetupEntry=sensSetupEntry, outValue=outValue, info=info, SensorUnitString=SensorUnitString, unitType=unitType, poseidon=poseidon, tsAlarmId=tsAlarmId, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, sensValueRaw=sensValueRaw, sensIndex=sensIndex)
