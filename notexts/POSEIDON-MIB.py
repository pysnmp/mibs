...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Unsigned32, MibIdentifier, Counter32, enterprises, Integer32, TimeTicks, ObjectIdentity, IpAddress, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter32", "enterprises", "Integer32", "TimeTicks", "ObjectIdentity", "IpAddress", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorUnitString=SensorUnitString, outTable=outTable, sensID=sensID, tsAlarmTime=tsAlarmTime, SensorID=SensorID, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, sensUnit=sensUnit, sensName=sensName, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupTable=sensSetupTable, inpTable=inpTable, sensLimitMax=sensLimitMax, outType=outType, charonII=charonII, sensFlags=sensFlags, OutputMode=OutputMode, inpValue=inpValue, SensorName=SensorName, sensState=sensState, setup=setup, sensSetupEntry=sensSetupEntry, UnitType=UnitType, TimeStamp=TimeStamp, sensTable=sensTable, IOName=IOName, inpName=inpName, sensIndex=sensIndex, sensSetup=sensSetup, tsAlarmEntry=tsAlarmEntry, sensSetupIndex=sensSetupIndex, outMode=outMode, outName=outName, PositiveInteger=PositiveInteger, outValue=outValue, sensValueRaw=sensValueRaw, inpEntry=inpEntry, OnOff=OnOff, info=info, OutputType=OutputType, SensorValue=SensorValue, outEntry=outEntry, sensEntry=sensEntry, tsAlarmDescr=tsAlarmDescr, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, infoAddressMAC=infoAddressMAC, tsAlarm=tsAlarm, inpIndex=inpIndex, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, tsAlarmId=tsAlarmId, hwgroup=hwgroup, outIndex=outIndex, sensUnitString=sensUnitString, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, poseidon=poseidon, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable)
