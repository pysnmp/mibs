...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, IpAddress, MibIdentifier, Gauge32, iso, Unsigned32, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, Counter64, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "IpAddress", "MibIdentifier", "Gauge32", "iso", "Unsigned32", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "Counter64", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", charonII=charonII, UnitType=UnitType, inpName=inpName, sensIndex=sensIndex, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensID=sensID, sensSetupTable=sensSetupTable, sensFlags=sensFlags, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, outName=outName, outType=outType, inpValue=inpValue, SensorID=SensorID, outEntry=outEntry, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, OnOff=OnOff, IOName=IOName, tsAlarmIdx=tsAlarmIdx, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, SensorState=SensorState, inpAlarmSetup=inpAlarmSetup, OutputType=OutputType, sensString=sensString, sensUnitString=sensUnitString, PositiveInteger=PositiveInteger, tsAlarm=tsAlarm, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, InputAlarmState=InputAlarmState, outTable=outTable, tsAlarmEntry=tsAlarmEntry, setup=setup, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, inpIndex=inpIndex, info=info, outMode=outMode, sensTable=sensTable, sensName=sensName, tsAlarmId=tsAlarmId, outIndex=outIndex, SensorUnitString=SensorUnitString, sensLimitMin=sensLimitMin, inpTable=inpTable, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, unitType=unitType, outValue=outValue, SensorValue=SensorValue, inpEntry=inpEntry, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, poseidon=poseidon, sensValue=sensValue, inpAlarmState=inpAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, tsAlarmsPresent=tsAlarmsPresent, SensorName=SensorName, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode)
