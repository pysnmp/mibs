...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, SensorString=SensorString, tsAlarmTime=tsAlarmTime, outTable=outTable, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, inpTable=inpTable, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, SensorID=SensorID, charonII=charonII, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, inpEntry=inpEntry, OutputMode=OutputMode, InputAlarmState=InputAlarmState, outType=outType, SensorName=SensorName, sensFlags=sensFlags, sensSetup=sensSetup, inpValue=inpValue, sensIndex=sensIndex, SensorUnitString=SensorUnitString, UnitType=UnitType, outIndex=outIndex, inpName=inpName, unitType=unitType, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, SensorState=SensorState, outMode=outMode, sensSetupName=sensSetupName, outEntry=outEntry, sensSetupTable=sensSetupTable, info=info, sensState=sensState, outValue=outValue, sensValueRaw=sensValueRaw, setup=setup, inpIndex=inpIndex, sensString=sensString, sensUnit=sensUnit, SensorValue=SensorValue, hwgroup=hwgroup, sensTable=sensTable, outName=outName, tsAlarmTable=tsAlarmTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, OnOff=OnOff, sensSetupEntry=sensSetupEntry, sensID=sensID, SensorFlags=SensorFlags, sensName=sensName, PositiveInteger=PositiveInteger, IOName=IOName, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState)
