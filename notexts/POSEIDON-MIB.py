...
iso, Unsigned32, NotificationType, ObjectIdentity, IpAddress, Bits, Counter32, MibIdentifier, ModuleIdentity, Counter64, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "Counter32", "MibIdentifier", "ModuleIdentity", "Counter64", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, setup=setup, sensUnitString=sensUnitString, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, sensSetup=sensSetup, inpTable=inpTable, outValue=outValue, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, UnitType=UnitType, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, inpValue=inpValue, OutputType=OutputType, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, outTable=outTable, inpName=inpName, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, outEntry=outEntry, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, poseidon=poseidon, OnOff=OnOff, charonII=charonII, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, inpIndex=inpIndex, hwgroup=hwgroup, sensState=sensState, SensorState=SensorState, TimeStamp=TimeStamp, InputAlarmSetup=InputAlarmSetup, SensorID=SensorID, outName=outName, sensID=sensID, sensLimitMin=sensLimitMin, SensorValue=SensorValue, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, inpEntry=inpEntry, OutputMode=OutputMode, outIndex=outIndex, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, SensorString=SensorString, sensTable=sensTable, sensString=sensString, tsAlarm=tsAlarm, outType=outType, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, info=info, IOName=IOName, outMode=outMode)
