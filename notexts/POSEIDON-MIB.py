...
ModuleIdentity, Bits, Gauge32, TimeTicks, NotificationType, Counter64, Unsigned32, Counter32, MibIdentifier, iso, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "NotificationType", "Counter64", "Unsigned32", "Counter32", "MibIdentifier", "iso", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, inpAlarmState=inpAlarmState, outValue=outValue, IOName=IOName, sensEntry=sensEntry, tsAlarmId=tsAlarmId, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, sensUnit=sensUnit, SensorUnitString=SensorUnitString, OnOff=OnOff, sensState=sensState, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, outType=outType, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, PositiveInteger=PositiveInteger, charonII=charonII, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, SensorID=SensorID, outMode=outMode, sensTable=sensTable, inpEntry=inpEntry, info=info, outEntry=outEntry, OutputMode=OutputMode, inpValue=inpValue, tsAlarmTime=tsAlarmTime, sensName=sensName, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, sensID=sensID, sensSetupTable=sensSetupTable, unitType=unitType, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, sensSetupEntry=sensSetupEntry, SensorName=SensorName, OutputType=OutputType, setup=setup, inpIndex=inpIndex, sensIndex=sensIndex, SensorValue=SensorValue, outName=outName, inpName=inpName, sensValue=sensValue, sensSetup=sensSetup, SensorString=SensorString, sensLimitMax=sensLimitMax, tsAlarmsPresent=tsAlarmsPresent, SensorFlags=SensorFlags, sensString=sensString, sensUnitString=sensUnitString, sensValueRaw=sensValueRaw, inpTable=inpTable, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged)
