...
TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Gauge32, Integer32, enterprises, IpAddress, Unsigned32, iso, ObjectIdentity, MibIdentifier, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Gauge32", "Integer32", "enterprises", "IpAddress", "Unsigned32", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnitString=sensUnitString, SensorID=SensorID, setup=setup, poseidon=poseidon, outType=outType, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, unitType=unitType, outEntry=outEntry, outName=outName, SensorName=SensorName, sensFlags=sensFlags, SensorValue=SensorValue, inpName=inpName, sensIndex=sensIndex, sensSetupTable=sensSetupTable, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, inpIndex=inpIndex, sensLimitMin=sensLimitMin, inpAlarmSetup=inpAlarmSetup, info=info, SensorString=SensorString, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, sensUnit=sensUnit, outValue=outValue, outMode=outMode, OutputMode=OutputMode, SensorState=SensorState, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, hwgroup=hwgroup, IOName=IOName, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, sensString=sensString, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName, charonII=charonII, outIndex=outIndex, sensID=sensID, OnOff=OnOff, OutputType=OutputType, inpTable=inpTable, UnitType=UnitType, sensState=sensState, inpEntry=inpEntry, sensValue=sensValue, tsAlarmsPresent=tsAlarmsPresent, sensHysteresis=sensHysteresis, outTable=outTable, sensValueRaw=sensValueRaw, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensAlarmStateChanged=sensAlarmStateChanged, inpValue=inpValue, SensorFlags=SensorFlags, sensSetupIndex=sensSetupIndex, tsAlarm=tsAlarm, sensTable=sensTable)
