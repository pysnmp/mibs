...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Bits, ModuleIdentity, Integer32, ObjectIdentity, NotificationType, MibIdentifier, iso, Gauge32, enterprises, Counter32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Bits", "ModuleIdentity", "Integer32", "ObjectIdentity", "NotificationType", "MibIdentifier", "iso", "Gauge32", "enterprises", "Counter32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmsPresent=tsAlarmsPresent, unitType=unitType, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, sensUnitString=sensUnitString, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, tsTrapAlarmEnd=tsTrapAlarmEnd, inpName=inpName, sensEntry=sensEntry, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, outMode=outMode, outEntry=outEntry, outIndex=outIndex, inpValue=inpValue, sensState=sensState, PositiveInteger=PositiveInteger, sensValueRaw=sensValueRaw, SensorString=SensorString, tsAlarmId=tsAlarmId, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, sensID=sensID, outName=outName, inpAlarmState=inpAlarmState, inpEntry=inpEntry, SensorFlags=SensorFlags, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, OnOff=OnOff, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, tsTrapAlarmStart=tsTrapAlarmStart, IOName=IOName, outTable=outTable, SensorUnitString=SensorUnitString, sensValue=sensValue, tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, UnitType=UnitType, SensorState=SensorState, info=info, outType=outType, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, poseidon=poseidon, tsAlarmDescr=tsAlarmDescr, inpIndex=inpIndex, sensSetup=sensSetup, sensString=sensString, SensorID=SensorID, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, sensHysteresis=sensHysteresis, setup=setup, sensIndex=sensIndex, SensorName=SensorName, charonII=charonII, inpTable=inpTable, outValue=outValue, InputAlarmState=InputAlarmState, OutputType=OutputType, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, sensName=sensName, sensTable=sensTable)
