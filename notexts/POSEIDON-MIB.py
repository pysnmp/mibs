...
TimeTicks, NotificationType, Integer32, ModuleIdentity, Gauge32, IpAddress, Counter64, ObjectIdentity, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "Gauge32", "IpAddress", "Counter64", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarm=tsAlarm, inpTable=inpTable, SensorID=SensorID, TimeStamp=TimeStamp, inpAlarmState=inpAlarmState, outName=outName, outType=outType, sensLimitMax=sensLimitMax, IOName=IOName, sensSetup=sensSetup, OutputMode=OutputMode, sensSetupName=sensSetupName, sensID=sensID, tsAlarmTable=tsAlarmTable, charonII=charonII, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName, sensString=sensString, hwgroup=hwgroup, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, OutputType=OutputType, unitType=unitType, UnitType=UnitType, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, info=info, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, SensorValue=SensorValue, outMode=outMode, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, outIndex=outIndex, InputAlarmSetup=InputAlarmSetup, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, tsAlarmIdx=tsAlarmIdx, sensValue=sensValue, inpValue=inpValue, tsAlarmEntry=tsAlarmEntry, sensUnitString=sensUnitString, poseidon=poseidon, OnOff=OnOff, sensLimitMin=sensLimitMin, inpEntry=inpEntry, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorUnitString=SensorUnitString, sensIndex=sensIndex, sensTable=sensTable, outValue=outValue, sensEntry=sensEntry, setup=setup, sensName=sensName, sensSetupTable=sensSetupTable, inpName=inpName, outEntry=outEntry, PositiveInteger=PositiveInteger, outTable=outTable, SensorState=SensorState)
