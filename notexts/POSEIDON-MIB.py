...
Counter64, ObjectIdentity, Bits, ModuleIdentity, Counter32, NotificationType, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, iso, TimeTicks, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter32", "NotificationType", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "iso", "TimeTicks", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValue=sensValue, outEntry=outEntry, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, outMode=outMode, sensString=sensString, inpValue=inpValue, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, sensValueRaw=sensValueRaw, OutputMode=OutputMode, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, SensorName=SensorName, outName=outName, IOName=IOName, inpName=inpName, setup=setup, sensState=sensState, sensSetupTable=sensSetupTable, OutputType=OutputType, SensorFlags=SensorFlags, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, outTable=outTable, sensUnitString=sensUnitString, poseidon=poseidon, outIndex=outIndex, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, unitType=unitType, hwgroup=hwgroup, outValue=outValue, inpTable=inpTable, inpEntry=inpEntry, sensName=sensName, sensHysteresis=sensHysteresis, sensFlags=sensFlags, SensorID=SensorID, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, UnitType=UnitType, sensLimitMin=sensLimitMin, sensID=sensID, SensorValue=SensorValue, TimeStamp=TimeStamp, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, outType=outType, SensorState=SensorState, tsAlarmTime=tsAlarmTime, tsTrapAlarmStart=tsTrapAlarmStart, PositiveInteger=PositiveInteger, charonII=charonII, SensorString=SensorString, info=info, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, sensTable=sensTable, sensIndex=sensIndex, sensEntry=sensEntry, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, infoAddressMAC=infoAddressMAC)
