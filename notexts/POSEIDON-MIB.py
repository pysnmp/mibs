...
ModuleIdentity, iso, ObjectIdentity, IpAddress, Bits, TimeTicks, MibIdentifier, Counter64, Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, inpEntry=inpEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, PositiveInteger=PositiveInteger, outEntry=outEntry, SensorString=SensorString, sensTable=sensTable, tsAlarm=tsAlarm, OnOff=OnOff, unitType=unitType, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, SensorID=SensorID, SensorValue=SensorValue, outName=outName, sensSetupIndex=sensSetupIndex, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, tsAlarmDescr=tsAlarmDescr, sensName=sensName, inpName=inpName, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, setup=setup, tsAlarmTable=tsAlarmTable, tsAlarmEntry=tsAlarmEntry, outType=outType, SensorFlags=SensorFlags, inpValue=inpValue, inpAlarmState=inpAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, sensSetup=sensSetup, charonII=charonII, InputAlarmState=InputAlarmState, poseidon=poseidon, inpTable=inpTable, sensID=sensID, sensFlags=sensFlags, SensorUnitString=SensorUnitString, TimeStamp=TimeStamp, sensValue=sensValue, sensString=sensString, inpIndex=inpIndex, hwgroup=hwgroup, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, tsAlarmSensName=tsAlarmSensName, outTable=outTable, sensSetupName=sensSetupName, outIndex=outIndex, outMode=outMode, tsAlarmId=tsAlarmId, info=info, sensSetupTable=sensSetupTable, sensState=sensState, sensIndex=sensIndex, IOName=IOName, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, sensEntry=sensEntry)
