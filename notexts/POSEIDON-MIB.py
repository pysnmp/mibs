...
Gauge32, TimeTicks, ObjectIdentity, iso, MibIdentifier, Integer32, Unsigned32, enterprises, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "MibIdentifier", "Integer32", "Unsigned32", "enterprises", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, inpName=inpName, SensorUnitString=SensorUnitString, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, UnitType=UnitType, sensID=sensID, PositiveInteger=PositiveInteger, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, OutputMode=OutputMode, sensSetupEntry=sensSetupEntry, outType=outType, sensSetupTable=sensSetupTable, outEntry=outEntry, outValue=outValue, tsAlarmTable=tsAlarmTable, SensorID=SensorID, IOName=IOName, tsAlarmSensName=tsAlarmSensName, TimeStamp=TimeStamp, unitType=unitType, sensLimitMin=sensLimitMin, info=info, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, OutputType=OutputType, sensName=sensName, sensUnitString=sensUnitString, outName=outName, inpEntry=inpEntry, SensorString=SensorString, sensString=sensString, outMode=outMode, tsAlarmTime=tsAlarmTime, inpTable=inpTable, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, sensHysteresis=sensHysteresis, SensorName=SensorName, tsAlarm=tsAlarm, sensSetupName=sensSetupName, sensState=sensState, poseidon=poseidon, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, hwgroup=hwgroup, setup=setup, sensLimitMax=sensLimitMax, tsAlarmIdx=tsAlarmIdx, sensEntry=sensEntry, SensorFlags=SensorFlags, SensorState=SensorState, outTable=outTable, OnOff=OnOff, tsAlarmId=tsAlarmId, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupIndex=sensSetupIndex, outIndex=outIndex, sensTable=sensTable)
