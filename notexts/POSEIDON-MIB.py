...
ObjectIdentity, IpAddress, Counter64, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, Integer32, iso, Gauge32, ModuleIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "iso", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outEntry=outEntry, sensIndex=sensIndex, tsAlarmId=tsAlarmId, sensID=sensID, sensState=sensState, inpAlarmState=inpAlarmState, outTable=outTable, infoAddressMAC=infoAddressMAC, sensHysteresis=sensHysteresis, OutputType=OutputType, setup=setup, sensSetupEntry=sensSetupEntry, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, outType=outType, sensEntry=sensEntry, outValue=outValue, inpName=inpName, tsAlarm=tsAlarm, tsAlarmIdx=tsAlarmIdx, unitType=unitType, sensLimitMax=sensLimitMax, SensorState=SensorState, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, IOName=IOName, inpTable=inpTable, SensorFlags=SensorFlags, InputAlarmState=InputAlarmState, inpValue=inpValue, sensValue=sensValue, charonII=charonII, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, SensorID=SensorID, sensTable=sensTable, sensSetupName=sensSetupName, poseidon=poseidon, sensSetup=sensSetup, sensString=sensString, PositiveInteger=PositiveInteger, hwgroup=hwgroup, SensorValue=SensorValue, sensName=sensName, OutputMode=OutputMode, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, UnitType=UnitType, outIndex=outIndex, SensorName=SensorName, info=info, inpEntry=inpEntry, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, outMode=outMode, tsAlarmTable=tsAlarmTable, TimeStamp=TimeStamp, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, OnOff=OnOff, outName=outName, SensorUnitString=SensorUnitString)
