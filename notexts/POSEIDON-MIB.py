...
IpAddress, Gauge32, Bits, Unsigned32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter64, iso, enterprises, Integer32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Bits", "Unsigned32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter64", "iso", "enterprises", "Integer32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTable=tsAlarmTable, poseidon=poseidon, sensSetupIndex=sensSetupIndex, setup=setup, inpIndex=inpIndex, outMode=outMode, sensIndex=sensIndex, tsAlarm=tsAlarm, SensorFlags=SensorFlags, tsAlarmsPresent=tsAlarmsPresent, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, infoAddressMAC=infoAddressMAC, SensorName=SensorName, info=info, sensUnit=sensUnit, sensState=sensState, outType=outType, inpName=inpName, sensSetup=sensSetup, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, outValue=outValue, sensValue=sensValue, SensorValue=SensorValue, sensSetupTable=sensSetupTable, OutputMode=OutputMode, inpTable=inpTable, sensSetupName=sensSetupName, SensorString=SensorString, PositiveInteger=PositiveInteger, inpEntry=inpEntry, inpValue=inpValue, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, SensorState=SensorState, charonII=charonII, sensString=sensString, sensUnitString=sensUnitString, UnitType=UnitType, tsAlarmTime=tsAlarmTime, IOName=IOName, unitType=unitType, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, outName=outName, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupEntry=sensSetupEntry, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, sensID=sensID, tsAlarmId=tsAlarmId, sensName=sensName, hwgroup=hwgroup, OnOff=OnOff, sensHysteresis=sensHysteresis, SensorUnitString=SensorUnitString, sensEntry=sensEntry, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, outTable=outTable, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx)
