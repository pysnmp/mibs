...
Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, Gauge32, enterprises, ModuleIdentity, Integer32, iso, Counter64, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "iso", "Counter64", "Counter32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, sensTable=sensTable, sensEntry=sensEntry, tsAlarm=tsAlarm, info=info, sensID=sensID, tsAlarmTable=tsAlarmTable, sensSetupEntry=sensSetupEntry, SensorFlags=SensorFlags, outEntry=outEntry, outName=outName, SensorName=SensorName, outIndex=outIndex, OutputType=OutputType, unitType=unitType, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, OutputMode=OutputMode, sensState=sensState, infoAddressMAC=infoAddressMAC, outTable=outTable, setup=setup, inpName=inpName, outType=outType, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, poseidon=poseidon, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, inpEntry=inpEntry, sensHysteresis=sensHysteresis, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, IOName=IOName, PositiveInteger=PositiveInteger, inpIndex=inpIndex, SensorID=SensorID, SensorValue=SensorValue, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmSensName=tsAlarmSensName, InputAlarmSetup=InputAlarmSetup, sensSetup=sensSetup, hwgroup=hwgroup, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, sensValue=sensValue, UnitType=UnitType, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, sensName=sensName, sensString=sensString, sensValueRaw=sensValueRaw, charonII=charonII, SensorState=SensorState, OnOff=OnOff, SensorString=SensorString, TimeStamp=TimeStamp)
