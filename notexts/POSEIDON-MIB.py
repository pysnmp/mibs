...
Counter32, ModuleIdentity, Unsigned32, MibIdentifier, ObjectIdentity, iso, Bits, Gauge32, Counter64, enterprises, TimeTicks, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "Bits", "Gauge32", "Counter64", "enterprises", "TimeTicks", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outEntry=outEntry, sensID=sensID, OutputMode=OutputMode, sensIndex=sensIndex, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, inpValue=inpValue, charonII=charonII, sensName=sensName, outTable=outTable, outName=outName, sensState=sensState, outMode=outMode, SensorID=SensorID, sensUnit=sensUnit, unitType=unitType, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, IOName=IOName, info=info, tsAlarmId=tsAlarmId, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, SensorName=SensorName, SensorValue=SensorValue, SensorString=SensorString, hwgroup=hwgroup, SensorUnitString=SensorUnitString, sensTable=sensTable, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, sensEntry=sensEntry, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, UnitType=UnitType, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, sensString=sensString, sensSetup=sensSetup, poseidon=poseidon, inpAlarmState=inpAlarmState, inpEntry=inpEntry, sensValue=sensValue, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, InputAlarmSetup=InputAlarmSetup, sensLimitMax=sensLimitMax, OutputType=OutputType, outValue=outValue, inpTable=inpTable, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, outType=outType, OnOff=OnOff, TimeStamp=TimeStamp, setup=setup, inpName=inpName, SensorState=SensorState)
