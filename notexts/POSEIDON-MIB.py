...
ObjectIdentity, Bits, Gauge32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Counter32, ModuleIdentity, IpAddress, Unsigned32, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Counter32", "ModuleIdentity", "IpAddress", "Unsigned32", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outValue=outValue, SensorName=SensorName, SensorString=SensorString, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupIndex=sensSetupIndex, tsAlarmSensName=tsAlarmSensName, sensString=sensString, tsAlarmTime=tsAlarmTime, inpAlarmSetup=inpAlarmSetup, OutputMode=OutputMode, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, OutputType=OutputType, setup=setup, sensValueRaw=sensValueRaw, sensSetup=sensSetup, inpTable=inpTable, SensorFlags=SensorFlags, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, outTable=outTable, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, sensSetupEntry=sensSetupEntry, outMode=outMode, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, UnitType=UnitType, outIndex=outIndex, tsAlarmsPresent=tsAlarmsPresent, SensorState=SensorState, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, sensLimitMax=sensLimitMax, sensIndex=sensIndex, sensID=sensID, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, outType=outType, sensValue=sensValue, sensFlags=sensFlags, SensorID=SensorID, charonII=charonII, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, sensName=sensName, inpValue=inpValue, outName=outName, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, poseidon=poseidon, PositiveInteger=PositiveInteger, info=info, SensorUnitString=SensorUnitString, OnOff=OnOff, TimeStamp=TimeStamp, tsAlarmIdx=tsAlarmIdx, unitType=unitType, inpName=inpName, inpAlarmState=inpAlarmState, outEntry=outEntry, sensTable=sensTable, sensState=sensState, sensSetupTable=sensSetupTable, SensorValue=SensorValue, sensEntry=sensEntry, tsAlarmId=tsAlarmId)
