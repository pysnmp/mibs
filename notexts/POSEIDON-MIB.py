...
ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Unsigned32, Counter64, Bits, ModuleIdentity, Integer32, Gauge32, iso, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "Counter64", "Bits", "ModuleIdentity", "Integer32", "Gauge32", "iso", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorValue=SensorValue, setup=setup, info=info, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, outEntry=outEntry, PositiveInteger=PositiveInteger, SensorName=SensorName, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, sensState=sensState, TimeStamp=TimeStamp, SensorString=SensorString, unitType=unitType, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensFlags=sensFlags, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupTable=sensSetupTable, tsAlarmTime=tsAlarmTime, SensorID=SensorID, hwgroup=hwgroup, inpIndex=inpIndex, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, tsAlarm=tsAlarm, outMode=outMode, inpTable=inpTable, outValue=outValue, outType=outType, sensEntry=sensEntry, sensString=sensString, sensID=sensID, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, outName=outName, sensName=sensName, tsAlarmTable=tsAlarmTable, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, IOName=IOName, InputAlarmState=InputAlarmState, outTable=outTable, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, OutputMode=OutputMode, inpName=inpName, sensLimitMin=sensLimitMin, charonII=charonII, sensUnit=sensUnit, OnOff=OnOff, inpAlarmState=inpAlarmState, SensorState=SensorState, outIndex=outIndex, sensTable=sensTable, sensIndex=sensIndex, inpEntry=inpEntry, inpValue=inpValue, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString)
