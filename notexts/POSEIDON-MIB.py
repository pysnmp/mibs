...
IpAddress, Integer32, ObjectIdentity, Unsigned32, iso, Bits, Gauge32, Counter64, NotificationType, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "Bits", "Gauge32", "Counter64", "NotificationType", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTime=tsAlarmTime, tsAlarm=tsAlarm, tsTrapAlarmEnd=tsTrapAlarmEnd, outEntry=outEntry, OnOff=OnOff, SensorString=SensorString, charonII=charonII, sensValue=sensValue, unitType=unitType, poseidon=poseidon, IOName=IOName, outValue=outValue, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, outTable=outTable, outMode=outMode, SensorState=SensorState, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, inpTable=inpTable, outName=outName, tsAlarmId=tsAlarmId, setup=setup, sensTable=sensTable, sensName=sensName, info=info, inpAlarmState=inpAlarmState, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, sensState=sensState, tsAlarmTable=tsAlarmTable, TimeStamp=TimeStamp, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, sensHysteresis=sensHysteresis, sensString=sensString, sensIndex=sensIndex, inpName=inpName, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, tsAlarmsPresent=tsAlarmsPresent, sensID=sensID, infoAddressMAC=infoAddressMAC, outIndex=outIndex, inpIndex=inpIndex, OutputMode=OutputMode, SensorUnitString=SensorUnitString, sensFlags=sensFlags, SensorName=SensorName, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, SensorID=SensorID, inpValue=inpValue, sensEntry=sensEntry, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, outType=outType, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup)
