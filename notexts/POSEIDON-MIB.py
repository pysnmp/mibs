...
Counter32, ObjectIdentity, IpAddress, Counter64, Unsigned32, Bits, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Integer32, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32", "Bits", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, outMode=outMode, sensLimitMin=sensLimitMin, SensorFlags=SensorFlags, inpValue=inpValue, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, sensTable=sensTable, sensHysteresis=sensHysteresis, setup=setup, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, InputAlarmState=InputAlarmState, IOName=IOName, inpTable=inpTable, sensValue=sensValue, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupIndex=sensSetupIndex, info=info, hwgroup=hwgroup, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, inpName=inpName, PositiveInteger=PositiveInteger, sensFlags=sensFlags, outName=outName, charonII=charonII, inpEntry=inpEntry, SensorValue=SensorValue, sensID=sensID, poseidon=poseidon, outIndex=outIndex, sensString=sensString, tsAlarmTable=tsAlarmTable, outType=outType, sensName=sensName, sensSetupName=sensSetupName, TimeStamp=TimeStamp, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, inpAlarmState=inpAlarmState, outValue=outValue, UnitType=UnitType, sensState=sensState, sensValueRaw=sensValueRaw, sensIndex=sensIndex, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, outTable=outTable, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, SensorState=SensorState, sensSetupEntry=sensSetupEntry, unitType=unitType, tsAlarmIdx=tsAlarmIdx, SensorString=SensorString, SensorName=SensorName, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, SensorUnitString=SensorUnitString, OutputMode=OutputMode, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, OutputType=OutputType, tsAlarmsPresent=tsAlarmsPresent, inpAlarmSetup=inpAlarmSetup)
