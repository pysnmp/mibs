...
Gauge32, Counter64, MibIdentifier, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, iso, Counter32, NotificationType, Unsigned32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibIdentifier", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "iso", "Counter32", "NotificationType", "Unsigned32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, sensState=sensState, sensUnit=sensUnit, unitType=unitType, outType=outType, PositiveInteger=PositiveInteger, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, tsAlarmTime=tsAlarmTime, SensorID=SensorID, OnOff=OnOff, SensorName=SensorName, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, sensEntry=sensEntry, tsAlarm=tsAlarm, UnitType=UnitType, IOName=IOName, inpAlarmState=inpAlarmState, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, sensTable=sensTable, outTable=outTable, sensLimitMax=sensLimitMax, outMode=outMode, tsAlarmId=tsAlarmId, SensorState=SensorState, inpValue=inpValue, sensString=sensString, SensorString=SensorString, setup=setup, inpEntry=inpEntry, OutputType=OutputType, sensID=sensID, sensSetupIndex=sensSetupIndex, sensValue=sensValue, inpName=inpName, outValue=outValue, InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, SensorFlags=SensorFlags, SensorUnitString=SensorUnitString, sensSetupEntry=sensSetupEntry, outName=outName, sensName=sensName, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, hwgroup=hwgroup, sensSetup=sensSetup, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmSetup=inpAlarmSetup, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, info=info, OutputMode=OutputMode, charonII=charonII, poseidon=poseidon, sensHysteresis=sensHysteresis, sensSetupName=sensSetupName, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, inpTable=inpTable)
