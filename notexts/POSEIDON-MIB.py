...
iso, ObjectIdentity, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Integer32, Unsigned32, Counter64, Counter32, IpAddress, Gauge32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "Counter32", "IpAddress", "Gauge32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, SensorState=SensorState, info=info, setup=setup, sensString=sensString, IOName=IOName, SensorString=SensorString, outEntry=outEntry, inpAlarmSetup=inpAlarmSetup, sensTable=sensTable, inpEntry=inpEntry, sensEntry=sensEntry, sensID=sensID, inpIndex=inpIndex, tsAlarmId=tsAlarmId, sensLimitMin=sensLimitMin, sensSetupTable=sensSetupTable, charonII=charonII, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, outTable=outTable, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, sensUnit=sensUnit, SensorFlags=SensorFlags, hwgroup=hwgroup, poseidon=poseidon, sensSetupEntry=sensSetupEntry, outName=outName, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, SensorName=SensorName, sensIndex=sensIndex, sensFlags=sensFlags, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmState=inpAlarmState, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, outValue=outValue, sensName=sensName, OnOff=OnOff, tsAlarm=tsAlarm, OutputType=OutputType, outMode=outMode, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupName=sensSetupName, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, inpValue=inpValue, inpTable=inpTable, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, inpName=inpName, outType=outType, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, SensorID=SensorID, TimeStamp=TimeStamp, UnitType=UnitType, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, PositiveInteger=PositiveInteger, sensValue=sensValue)
