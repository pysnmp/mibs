...
Counter32, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Integer32, Counter64, MibIdentifier, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensHysteresis=sensHysteresis, infoAddressMAC=infoAddressMAC, info=info, outTable=outTable, OutputType=OutputType, OutputMode=OutputMode, sensValueRaw=sensValueRaw, SensorFlags=SensorFlags, SensorName=SensorName, tsAlarmEntry=tsAlarmEntry, sensState=sensState, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, outIndex=outIndex, sensName=sensName, hwgroup=hwgroup, sensUnit=sensUnit, unitType=unitType, sensSetupIndex=sensSetupIndex, SensorString=SensorString, setup=setup, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTable=tsAlarmTable, outEntry=outEntry, inpTable=inpTable, sensUnitString=sensUnitString, outMode=outMode, sensSetupName=sensSetupName, inpValue=inpValue, outName=outName, sensSetup=sensSetup, charonII=charonII, sensLimitMax=sensLimitMax, outType=outType, IOName=IOName, sensID=sensID, SensorState=SensorState, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, SensorValue=SensorValue, outValue=outValue, sensValue=sensValue, tsAlarmIdx=tsAlarmIdx, sensIndex=sensIndex, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, tsAlarmTime=tsAlarmTime, sensTable=sensTable, UnitType=UnitType, inpName=inpName, inpIndex=inpIndex, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensString=sensString, sensLimitMin=sensLimitMin, poseidon=poseidon, sensFlags=sensFlags, OnOff=OnOff, SensorUnitString=SensorUnitString)
