...
enterprises, Counter32, IpAddress, MibIdentifier, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, NotificationType, Integer32, ObjectIdentity, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, sensString=sensString, sensUnitString=sensUnitString, outValue=outValue, SensorValue=SensorValue, outEntry=outEntry, SensorName=SensorName, inpTable=inpTable, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorString=SensorString, OnOff=OnOff, inpValue=inpValue, inpAlarmState=inpAlarmState, outIndex=outIndex, tsAlarmId=tsAlarmId, charonII=charonII, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, OutputMode=OutputMode, tsAlarmTable=tsAlarmTable, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, IOName=IOName, SensorUnitString=SensorUnitString, sensState=sensState, setup=setup, inpName=inpName, UnitType=UnitType, SensorState=SensorState, unitType=unitType, InputAlarmState=InputAlarmState, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, outType=outType, SensorFlags=SensorFlags, outTable=outTable, sensFlags=sensFlags, sensName=sensName, SensorID=SensorID, PositiveInteger=PositiveInteger, info=info, inpEntry=inpEntry, TimeStamp=TimeStamp, sensEntry=sensEntry, sensValueRaw=sensValueRaw, sensID=sensID, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, sensSetupTable=sensSetupTable, poseidon=poseidon, sensSetup=sensSetup, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, tsAlarm=tsAlarm, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMin=sensLimitMin, hwgroup=hwgroup, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, outName=outName, sensIndex=sensIndex)
