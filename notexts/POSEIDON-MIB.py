...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, sensName=sensName, inpEntry=inpEntry, SensorName=SensorName, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, inpTable=inpTable, inpName=inpName, outMode=outMode, sensTable=sensTable, sensUnitString=sensUnitString, inpAlarmSetup=inpAlarmSetup, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmDescr=tsAlarmDescr, inpIndex=inpIndex, inpAlarmState=inpAlarmState, OutputType=OutputType, sensEntry=sensEntry, tsAlarmIdx=tsAlarmIdx, unitType=unitType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensID=sensID, hwgroup=hwgroup, sensValue=sensValue, sensState=sensState, PositiveInteger=PositiveInteger, SensorState=SensorState, sensFlags=sensFlags, SensorFlags=SensorFlags, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, info=info, tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, outName=outName, OnOff=OnOff, inpValue=inpValue, outType=outType, sensString=sensString, sensSetupEntry=sensSetupEntry, outValue=outValue, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, poseidon=poseidon, SensorString=SensorString, InputAlarmState=InputAlarmState, OutputMode=OutputMode, sensSetup=sensSetup, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, SensorUnitString=SensorUnitString, sensSetupIndex=sensSetupIndex, sensSetupTable=sensSetupTable, sensUnit=sensUnit, sensValueRaw=sensValueRaw, outTable=outTable, UnitType=UnitType, SensorID=SensorID, SensorValue=SensorValue, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, InputAlarmSetup=InputAlarmSetup, outEntry=outEntry, outIndex=outIndex)
