...
ObjectIdentity, iso, TimeTicks, IpAddress, Bits, Unsigned32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, ModuleIdentity, enterprises, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, info=info, inpTable=inpTable, SensorString=SensorString, inpIndex=inpIndex, sensSetupName=sensSetupName, sensLimitMin=sensLimitMin, sensID=sensID, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensTable=sensTable, inpAlarmState=inpAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, charonII=charonII, sensValueRaw=sensValueRaw, outType=outType, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, OnOff=OnOff, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, unitType=unitType, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, OutputMode=OutputMode, sensSetupIndex=sensSetupIndex, sensUnitString=sensUnitString, sensSetupTable=sensSetupTable, setup=setup, outEntry=outEntry, sensName=sensName, sensState=sensState, PositiveInteger=PositiveInteger, sensFlags=sensFlags, inpName=inpName, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, sensUnit=sensUnit, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, SensorName=SensorName, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, outMode=outMode, inpEntry=inpEntry, sensString=sensString, tsTrapAlarmStart=tsTrapAlarmStart, SensorUnitString=SensorUnitString, IOName=IOName, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, outName=outName, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, outValue=outValue, sensIndex=sensIndex, poseidon=poseidon, TimeStamp=TimeStamp, SensorFlags=SensorFlags, outTable=outTable, SensorState=SensorState)
