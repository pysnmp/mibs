...
ModuleIdentity, Integer32, ObjectIdentity, Counter32, iso, TimeTicks, Counter64, enterprises, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "Counter64", "enterprises", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorFlags=SensorFlags, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, sensUnitString=sensUnitString, SensorUnitString=SensorUnitString, SensorString=SensorString, hwgroup=hwgroup, outType=outType, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, outEntry=outEntry, OnOff=OnOff, OutputType=OutputType, tsAlarm=tsAlarm, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, sensState=sensState, SensorID=SensorID, sensID=sensID, sensSetupName=sensSetupName, IOName=IOName, SensorName=SensorName, sensName=sensName, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, outIndex=outIndex, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, info=info, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, outTable=outTable, outName=outName, sensSetupEntry=sensSetupEntry, outValue=outValue, setup=setup, inpAlarmState=inpAlarmState, tsAlarmTime=tsAlarmTime, inpName=inpName, OutputMode=OutputMode, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, inpTable=inpTable, inpValue=inpValue, sensValue=sensValue, SensorState=SensorState, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, inpIndex=inpIndex, inpAlarmStateChanged=inpAlarmStateChanged, outMode=outMode, sensLimitMin=sensLimitMin, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmId=tsAlarmId, sensString=sensString, sensIndex=sensIndex, SensorValue=SensorValue, charonII=charonII, InputAlarmState=InputAlarmState, sensTable=sensTable)
