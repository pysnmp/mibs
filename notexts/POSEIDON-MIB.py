...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ModuleIdentity, ObjectIdentity, Unsigned32, enterprises, Integer32, Counter64, NotificationType, MibIdentifier, Gauge32, TimeTicks, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "enterprises", "Integer32", "Counter64", "NotificationType", "MibIdentifier", "Gauge32", "TimeTicks", "Bits", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarm=tsAlarm, outMode=outMode, outEntry=outEntry, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, OutputMode=OutputMode, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, outValue=outValue, sensSetupName=sensSetupName, hwgroup=hwgroup, sensState=sensState, tsAlarmDescr=tsAlarmDescr, outType=outType, sensHysteresis=sensHysteresis, inpName=inpName, UnitType=UnitType, outTable=outTable, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, inpAlarmState=inpAlarmState, sensString=sensString, charonII=charonII, sensSetupTable=sensSetupTable, sensValue=sensValue, info=info, inpEntry=inpEntry, SensorState=SensorState, sensIndex=sensIndex, sensSetup=sensSetup, SensorUnitString=SensorUnitString, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, SensorID=SensorID, SensorName=SensorName, sensFlags=sensFlags, sensName=sensName, sensUnitString=sensUnitString, outIndex=outIndex, sensSetupIndex=sensSetupIndex, OnOff=OnOff, poseidon=poseidon, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, sensLimitMax=sensLimitMax, tsAlarmTime=tsAlarmTime, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, inpTable=inpTable, IOName=IOName, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, sensID=sensID, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, unitType=unitType, tsAlarmId=tsAlarmId, SensorString=SensorString, setup=setup, inpValue=inpValue, OutputType=OutputType, outName=outName)
