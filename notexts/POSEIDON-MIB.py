...
ModuleIdentity, MibIdentifier, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises, Integer32, ObjectIdentity, Unsigned32, Bits, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises", "Integer32", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, setup=setup, sensIndex=sensIndex, hwgroup=hwgroup, sensValueRaw=sensValueRaw, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, tsAlarm=tsAlarm, SensorFlags=SensorFlags, inpAlarmSetup=inpAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, inpTable=inpTable, sensSetupTable=sensSetupTable, unitType=unitType, outMode=outMode, outIndex=outIndex, sensHysteresis=sensHysteresis, sensSetupIndex=sensSetupIndex, sensState=sensState, IOName=IOName, SensorID=SensorID, SensorUnitString=SensorUnitString, outName=outName, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, SensorValue=SensorValue, info=info, SensorName=SensorName, sensAlarmStateChanged=sensAlarmStateChanged, inpValue=inpValue, OutputType=OutputType, outEntry=outEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, SensorString=SensorString, charonII=charonII, infoAddressMAC=infoAddressMAC, tsAlarmSensName=tsAlarmSensName, OnOff=OnOff, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, SensorState=SensorState, outTable=outTable, sensString=sensString, sensLimitMax=sensLimitMax, inpIndex=inpIndex, sensSetup=sensSetup, sensFlags=sensFlags, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, outType=outType, outValue=outValue, tsAlarmId=tsAlarmId, tsTrapAlarmEnd=tsTrapAlarmEnd, sensName=sensName, poseidon=poseidon, sensEntry=sensEntry, InputAlarmSetup=InputAlarmSetup, sensValue=sensValue, PositiveInteger=PositiveInteger, OutputMode=OutputMode, tsAlarmsPresent=tsAlarmsPresent, inpName=inpName, tsAlarmDescr=tsAlarmDescr, sensID=sensID, inpEntry=inpEntry, UnitType=UnitType)
