...
Counter32, Unsigned32, Gauge32, ObjectIdentity, TimeTicks, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter64, Integer32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter64", "Integer32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, outMode=outMode, inpAlarmState=inpAlarmState, setup=setup, sensFlags=sensFlags, UnitType=UnitType, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, sensAlarmStateChanged=sensAlarmStateChanged, outTable=outTable, tsAlarmId=tsAlarmId, SensorState=SensorState, unitType=unitType, outIndex=outIndex, outType=outType, infoAddressMAC=infoAddressMAC, OnOff=OnOff, tsAlarmEntry=tsAlarmEntry, sensUnit=sensUnit, poseidon=poseidon, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, inpName=inpName, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, sensEntry=sensEntry, SensorID=SensorID, sensName=sensName, sensTable=sensTable, inpValue=inpValue, sensSetupEntry=sensSetupEntry, OutputMode=OutputMode, charonII=charonII, tsAlarmSensName=tsAlarmSensName, InputAlarmSetup=InputAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, sensIndex=sensIndex, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, sensLimitMin=sensLimitMin, SensorName=SensorName, SensorUnitString=SensorUnitString, sensState=sensState, outEntry=outEntry, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, OutputType=OutputType, inpTable=inpTable, SensorString=SensorString, sensUnitString=sensUnitString, SensorFlags=SensorFlags, sensString=sensString, sensSetupTable=sensSetupTable, info=info, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, outValue=outValue, SensorValue=SensorValue, outName=outName, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, IOName=IOName, sensHysteresis=sensHysteresis, sensID=sensID)
