...
Counter32, ModuleIdentity, IpAddress, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, enterprises, Counter64, Gauge32, ObjectIdentity, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "enterprises", "Counter64", "Gauge32", "ObjectIdentity", "Integer32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, outValue=outValue, tsAlarm=tsAlarm, tsAlarmTable=tsAlarmTable, sensState=sensState, outMode=outMode, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, inpEntry=inpEntry, sensIndex=sensIndex, sensLimitMin=sensLimitMin, tsAlarmDescr=tsAlarmDescr, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupIndex=sensSetupIndex, OutputType=OutputType, sensID=sensID, SensorUnitString=SensorUnitString, outName=outName, InputAlarmState=InputAlarmState, inpIndex=inpIndex, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, SensorName=SensorName, inpName=inpName, InputAlarmSetup=InputAlarmSetup, tsAlarmEntry=tsAlarmEntry, SensorFlags=SensorFlags, sensTable=sensTable, outIndex=outIndex, outType=outType, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, IOName=IOName, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorState=SensorState, outTable=outTable, tsAlarmId=tsAlarmId, sensValue=sensValue, charonII=charonII, info=info, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, OnOff=OnOff, inpAlarmState=inpAlarmState, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, hwgroup=hwgroup, inpValue=inpValue, sensName=sensName, setup=setup, SensorID=SensorID, UnitType=UnitType, SensorValue=SensorValue, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, tsAlarmsPresent=tsAlarmsPresent, unitType=unitType, sensString=sensString, SensorString=SensorString, inpTable=inpTable)
