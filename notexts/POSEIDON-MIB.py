...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmId=tsAlarmId, outName=outName, inpEntry=inpEntry, outValue=outValue, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, UnitType=UnitType, info=info, poseidon=poseidon, SensorState=SensorState, SensorFlags=SensorFlags, setup=setup, SensorName=SensorName, IOName=IOName, sensTable=sensTable, InputAlarmState=InputAlarmState, sensIndex=sensIndex, inpValue=inpValue, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, inpAlarmState=inpAlarmState, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, hwgroup=hwgroup, sensSetupName=sensSetupName, outMode=outMode, OutputMode=OutputMode, sensName=sensName, sensUnitString=sensUnitString, SensorString=SensorString, sensValueRaw=sensValueRaw, SensorID=SensorID, unitType=unitType, sensSetup=sensSetup, inpTable=inpTable, outType=outType, InputAlarmSetup=InputAlarmSetup, sensID=sensID, PositiveInteger=PositiveInteger, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, sensString=sensString, sensValue=sensValue, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, OutputType=OutputType, sensSetupTable=sensSetupTable, sensEntry=sensEntry, inpName=inpName, charonII=charonII, inpIndex=inpIndex, outEntry=outEntry, sensSetupEntry=sensSetupEntry, tsAlarmTime=tsAlarmTime, outTable=outTable, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, outIndex=outIndex, TimeStamp=TimeStamp)
