...
Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Bits, Counter64, ModuleIdentity, Gauge32, IpAddress, Unsigned32, Integer32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Counter64", "ModuleIdentity", "Gauge32", "IpAddress", "Unsigned32", "Integer32", "enterprises", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, sensName=sensName, info=info, OutputMode=OutputMode, outEntry=outEntry, outType=outType, tsAlarmTime=tsAlarmTime, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, sensID=sensID, tsAlarmTable=tsAlarmTable, IOName=IOName, sensSetupTable=sensSetupTable, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, SensorValue=SensorValue, OnOff=OnOff, SensorUnitString=SensorUnitString, outValue=outValue, tsAlarm=tsAlarm, tsAlarmId=tsAlarmId, OutputType=OutputType, tsAlarmDescr=tsAlarmDescr, outTable=outTable, unitType=unitType, outIndex=outIndex, sensString=sensString, UnitType=UnitType, sensSetupEntry=sensSetupEntry, sensTable=sensTable, sensEntry=sensEntry, sensFlags=sensFlags, PositiveInteger=PositiveInteger, inpValue=inpValue, SensorString=SensorString, inpName=inpName, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, SensorName=SensorName, sensState=sensState, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, sensSetupName=sensSetupName, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, inpTable=inpTable, SensorState=SensorState, sensLimitMax=sensLimitMax, outName=outName, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent, setup=setup, tsAlarmEntry=tsAlarmEntry, inpAlarmState=inpAlarmState, sensSetupIndex=sensSetupIndex, tsAlarmIdx=tsAlarmIdx, charonII=charonII, sensIndex=sensIndex, hwgroup=hwgroup)
