...
iso, Integer32, TimeTicks, Gauge32, ObjectIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, MibIdentifier, IpAddress, ModuleIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "TimeTicks", "Gauge32", "ObjectIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "MibIdentifier", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, UnitType=UnitType, tsAlarmIdx=tsAlarmIdx, SensorName=SensorName, InputAlarmState=InputAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, sensID=sensID, SensorString=SensorString, OnOff=OnOff, tsAlarmTable=tsAlarmTable, inpAlarmState=inpAlarmState, outType=outType, charonII=charonII, outName=outName, sensUnitString=sensUnitString, SensorState=SensorState, TimeStamp=TimeStamp, sensLimitMin=sensLimitMin, tsAlarmEntry=tsAlarmEntry, sensState=sensState, sensUnit=sensUnit, OutputMode=OutputMode, outValue=outValue, tsAlarmId=tsAlarmId, outTable=outTable, sensValue=sensValue, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, inpName=inpName, tsAlarmDescr=tsAlarmDescr, sensIndex=sensIndex, SensorID=SensorID, sensSetup=sensSetup, sensSetupTable=sensSetupTable, PositiveInteger=PositiveInteger, inpTable=inpTable, SensorValue=SensorValue, tsAlarmTime=tsAlarmTime, sensTable=sensTable, OutputType=OutputType, sensString=sensString, sensSetupName=sensSetupName, sensEntry=sensEntry, inpEntry=inpEntry, sensSetupEntry=sensSetupEntry, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, tsAlarmsPresent=tsAlarmsPresent, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, setup=setup, poseidon=poseidon, SensorUnitString=SensorUnitString, inpIndex=inpIndex, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, unitType=unitType, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, info=info, sensName=sensName, sensFlags=sensFlags, sensLimitMax=sensLimitMax, outEntry=outEntry, IOName=IOName, outIndex=outIndex)
