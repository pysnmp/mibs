...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, sensFlags=sensFlags, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, UnitType=UnitType, SensorUnitString=SensorUnitString, inpAlarmState=inpAlarmState, poseidon=poseidon, tsAlarmTable=tsAlarmTable, inpName=inpName, sensTable=sensTable, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, tsAlarmEntry=tsAlarmEntry, outEntry=outEntry, outType=outType, sensUnit=sensUnit, outIndex=outIndex, sensIndex=sensIndex, inpTable=inpTable, SensorValue=SensorValue, SensorName=SensorName, sensLimitMax=sensLimitMax, inpAlarmSetup=inpAlarmSetup, unitType=unitType, sensValueRaw=sensValueRaw, outMode=outMode, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, outTable=outTable, IOName=IOName, sensSetupIndex=sensSetupIndex, sensName=sensName, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, info=info, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, OutputType=OutputType, sensUnitString=sensUnitString, sensSetupTable=sensSetupTable, inpEntry=inpEntry, sensString=sensString, tsAlarmIdx=tsAlarmIdx, hwgroup=hwgroup, sensID=sensID, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, setup=setup, TimeStamp=TimeStamp, sensValue=sensValue, OutputMode=OutputMode, outValue=outValue, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, SensorString=SensorString, infoAddressMAC=infoAddressMAC, tsAlarmDescr=tsAlarmDescr, inpIndex=inpIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensSetup=sensSetup, inpValue=inpValue, OnOff=OnOff)
