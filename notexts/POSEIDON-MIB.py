...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, IpAddress, TimeTicks, Unsigned32, Gauge32, Integer32, Bits, NotificationType, iso, ModuleIdentity, Counter32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32", "Gauge32", "Integer32", "Bits", "NotificationType", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpValue=inpValue, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, SensorUnitString=SensorUnitString, info=info, InputAlarmState=InputAlarmState, sensState=sensState, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, sensString=sensString, sensValue=sensValue, OutputType=OutputType, sensHysteresis=sensHysteresis, tsAlarmIdx=tsAlarmIdx, outTable=outTable, sensSetup=sensSetup, inpEntry=inpEntry, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensFlags=sensFlags, SensorString=SensorString, TimeStamp=TimeStamp, tsAlarmSensName=tsAlarmSensName, SensorState=SensorState, sensEntry=sensEntry, outIndex=outIndex, unitType=unitType, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, tsAlarmTable=tsAlarmTable, SensorName=SensorName, OnOff=OnOff, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, sensName=sensName, tsAlarm=tsAlarm, inpName=inpName, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, UnitType=UnitType, OutputMode=OutputMode, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, charonII=charonII, tsAlarmTime=tsAlarmTime, setup=setup, sensValueRaw=sensValueRaw, outType=outType, hwgroup=hwgroup, SensorID=SensorID, SensorFlags=SensorFlags, sensUnit=sensUnit, PositiveInteger=PositiveInteger, tsAlarmDescr=tsAlarmDescr, outName=outName, sensTable=sensTable, sensID=sensID, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, outMode=outMode, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, outValue=outValue, SensorValue=SensorValue, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry)
