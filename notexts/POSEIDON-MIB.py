...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmDescr=tsAlarmDescr, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, inpName=inpName, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, setup=setup, sensLimitMax=sensLimitMax, outType=outType, sensSetupName=sensSetupName, sensEntry=sensEntry, tsAlarm=tsAlarm, unitType=unitType, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, SensorString=SensorString, sensUnit=sensUnit, outTable=outTable, info=info, OutputType=OutputType, SensorName=SensorName, outEntry=outEntry, sensSetupTable=sensSetupTable, sensSetupIndex=sensSetupIndex, sensIndex=sensIndex, sensID=sensID, OutputMode=OutputMode, tsAlarmSensName=tsAlarmSensName, inpEntry=inpEntry, OnOff=OnOff, inpIndex=inpIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, InputAlarmSetup=InputAlarmSetup, inpTable=inpTable, outMode=outMode, sensName=sensName, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, hwgroup=hwgroup, UnitType=UnitType, sensString=sensString, sensUnitString=sensUnitString, SensorValue=SensorValue, poseidon=poseidon, sensValue=sensValue, InputAlarmState=InputAlarmState, outIndex=outIndex, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, inpValue=inpValue, sensState=sensState, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, IOName=IOName, outValue=outValue, SensorID=SensorID, outName=outName, sensTable=sensTable, SensorState=SensorState, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable, charonII=charonII)
