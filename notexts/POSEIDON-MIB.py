...
mibBuilder.exportSymbols("POSEIDON-MIB", outMode=outMode, SensorValue=SensorValue, SensorString=SensorString, sensID=sensID, SensorName=SensorName, SensorID=SensorID, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, OutputMode=OutputMode, unitType=unitType, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, sensSetupEntry=sensSetupEntry, info=info, charonII=charonII, sensState=sensState, infoAddressMAC=infoAddressMAC, tsAlarmId=tsAlarmId, inpName=inpName, tsAlarmTime=tsAlarmTime, sensValue=sensValue, outValue=outValue, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensName=sensName, sensLimitMax=sensLimitMax, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, OutputType=OutputType, tsAlarmSensName=tsAlarmSensName, sensEntry=sensEntry, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, poseidon=poseidon, OnOff=OnOff, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, outIndex=outIndex, sensIndex=sensIndex, UnitType=UnitType, sensTable=sensTable, inpAlarmSetup=inpAlarmSetup, outTable=outTable, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, outType=outType, SensorFlags=SensorFlags, hwgroup=hwgroup, outName=outName, inpTable=inpTable, sensFlags=sensFlags, sensLimitMin=sensLimitMin, SensorState=SensorState, TimeStamp=TimeStamp, inpIndex=inpIndex, sensSetupTable=sensSetupTable, inpValue=inpValue, outEntry=outEntry, inpAlarmState=inpAlarmState)
