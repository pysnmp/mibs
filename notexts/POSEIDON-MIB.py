...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, MibIdentifier, iso, Gauge32, enterprises, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity, Bits, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "MibIdentifier", "iso", "Gauge32", "enterprises", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, OnOff=OnOff, SensorState=SensorState, setup=setup, outType=outType, sensEntry=sensEntry, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, SensorUnitString=SensorUnitString, PositiveInteger=PositiveInteger, inpTable=inpTable, sensID=sensID, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, outName=outName, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, sensTable=sensTable, sensString=sensString, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, SensorID=SensorID, unitType=unitType, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, tsAlarmId=tsAlarmId, sensState=sensState, TimeStamp=TimeStamp, outTable=outTable, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, sensHysteresis=sensHysteresis, UnitType=UnitType, IOName=IOName, sensValue=sensValue, OutputMode=OutputMode, inpIndex=inpIndex, OutputType=OutputType, tsAlarmSensName=tsAlarmSensName, info=info, SensorFlags=SensorFlags, inpValue=inpValue, charonII=charonII, tsAlarmDescr=tsAlarmDescr, tsAlarm=tsAlarm, poseidon=poseidon, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensFlags=sensFlags, sensName=sensName, tsAlarmIdx=tsAlarmIdx, inpName=inpName, SensorValue=SensorValue, outEntry=outEntry, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, sensLimitMin=sensLimitMin, outValue=outValue)
