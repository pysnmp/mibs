...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter64, Unsigned32, ModuleIdentity, ObjectIdentity, iso, Counter32, MibIdentifier, Gauge32, Bits, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter64", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "iso", "Counter32", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, outIndex=outIndex, outTable=outTable, outName=outName, hwgroup=hwgroup, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupTable=sensSetupTable, UnitType=UnitType, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupIndex=sensSetupIndex, charonII=charonII, SensorID=SensorID, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, outValue=outValue, sensHysteresis=sensHysteresis, inpValue=inpValue, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, sensID=sensID, sensName=sensName, SensorFlags=SensorFlags, outType=outType, SensorState=SensorState, inpEntry=inpEntry, outMode=outMode, poseidon=poseidon, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup, inpName=inpName, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, info=info, sensTable=sensTable, sensUnit=sensUnit, sensString=sensString, OutputMode=OutputMode, inpAlarmState=inpAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, outEntry=outEntry, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, sensState=sensState, SensorName=SensorName, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupName=sensSetupName, IOName=IOName, sensLimitMin=sensLimitMin, SensorString=SensorString, unitType=unitType, PositiveInteger=PositiveInteger, inpTable=inpTable, sensIndex=sensIndex, sensSetup=sensSetup, OnOff=OnOff, sensEntry=sensEntry, sensValue=sensValue, tsAlarmId=tsAlarmId, inpAlarmSetup=inpAlarmSetup, setup=setup, inpIndex=inpIndex)
