...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Gauge32, IpAddress, iso, ModuleIdentity, Unsigned32, enterprises, Bits, ObjectIdentity, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Gauge32", "IpAddress", "iso", "ModuleIdentity", "Unsigned32", "enterprises", "Bits", "ObjectIdentity", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, outMode=outMode, charonII=charonII, sensSetupEntry=sensSetupEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupTable=sensSetupTable, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, sensString=sensString, OnOff=OnOff, inpEntry=inpEntry, outIndex=outIndex, outType=outType, sensState=sensState, OutputMode=OutputMode, outName=outName, tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, outValue=outValue, tsAlarmDescr=tsAlarmDescr, TimeStamp=TimeStamp, SensorState=SensorState, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, outTable=outTable, tsAlarmEntry=tsAlarmEntry, unitType=unitType, sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, UnitType=UnitType, sensFlags=sensFlags, InputAlarmState=InputAlarmState, IOName=IOName, SensorValue=SensorValue, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, sensName=sensName, sensEntry=sensEntry, sensID=sensID, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, poseidon=poseidon, SensorUnitString=SensorUnitString, outEntry=outEntry, info=info, setup=setup, SensorString=SensorString, inpValue=inpValue, sensTable=sensTable, sensIndex=sensIndex, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, OutputType=OutputType, sensValue=sensValue, sensSetup=sensSetup, sensLimitMin=sensLimitMin, inpName=inpName, hwgroup=hwgroup, inpTable=inpTable, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarm=tsAlarm, SensorFlags=SensorFlags, SensorID=SensorID)
