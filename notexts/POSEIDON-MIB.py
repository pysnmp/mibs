...
ModuleIdentity, Counter64, Integer32, NotificationType, iso, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, TimeTicks, Bits, ObjectIdentity, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, SensorID=SensorID, tsAlarmTable=tsAlarmTable, outType=outType, inpValue=inpValue, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, outValue=outValue, sensSetupName=sensSetupName, poseidon=poseidon, SensorString=SensorString, setup=setup, sensUnit=sensUnit, inpAlarmSetup=inpAlarmSetup, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, outIndex=outIndex, sensState=sensState, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, unitType=unitType, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, SensorValue=SensorValue, sensSetupTable=sensSetupTable, sensID=sensID, sensName=sensName, sensTable=sensTable, info=info, OnOff=OnOff, charonII=charonII, sensIndex=sensIndex, hwgroup=hwgroup, InputAlarmState=InputAlarmState, InputAlarmSetup=InputAlarmSetup, sensSetupEntry=sensSetupEntry, SensorState=SensorState, OutputType=OutputType, UnitType=UnitType, inpTable=inpTable, sensFlags=sensFlags, SensorName=SensorName, PositiveInteger=PositiveInteger, sensEntry=sensEntry, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, outMode=outMode, sensString=sensString, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, inpEntry=inpEntry, outName=outName, IOName=IOName, outTable=outTable)
