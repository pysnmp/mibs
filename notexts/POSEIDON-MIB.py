...
TimeTicks, Unsigned32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter64, enterprises, Integer32, NotificationType, ModuleIdentity, Gauge32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter64", "enterprises", "Integer32", "NotificationType", "ModuleIdentity", "Gauge32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, sensID=sensID, sensFlags=sensFlags, sensString=sensString, SensorState=SensorState, sensSetup=sensSetup, sensName=sensName, outTable=outTable, inpTable=inpTable, info=info, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, sensUnitString=sensUnitString, setup=setup, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, tsAlarmsPresent=tsAlarmsPresent, inpValue=inpValue, OnOff=OnOff, SensorString=SensorString, sensLimitMax=sensLimitMax, inpName=inpName, sensIndex=sensIndex, sensValue=sensValue, InputAlarmState=InputAlarmState, outIndex=outIndex, outType=outType, SensorID=SensorID, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, inpAlarmState=inpAlarmState, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, unitType=unitType, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, IOName=IOName, sensHysteresis=sensHysteresis, SensorName=SensorName, sensEntry=sensEntry, poseidon=poseidon, sensLimitMin=sensLimitMin, SensorFlags=SensorFlags, hwgroup=hwgroup, outMode=outMode, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, OutputType=OutputType, tsAlarmId=tsAlarmId, outName=outName, sensState=sensState, outValue=outValue, inpIndex=inpIndex, tsAlarmTable=tsAlarmTable, tsTrapAlarmStart=tsTrapAlarmStart, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, SensorValue=SensorValue, sensTable=sensTable, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit)
