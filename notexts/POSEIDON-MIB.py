...
Unsigned32, ObjectIdentity, NotificationType, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Integer32, Gauge32, TimeTicks, Counter64, iso, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "NotificationType", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Integer32", "Gauge32", "TimeTicks", "Counter64", "iso", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OnOff=OnOff, IOName=IOName, sensName=sensName, tsAlarmId=tsAlarmId, SensorName=SensorName, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, outMode=outMode, tsAlarmTable=tsAlarmTable, info=info, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, inpValue=inpValue, sensLimitMax=sensLimitMax, sensEntry=sensEntry, outName=outName, setup=setup, tsAlarmTime=tsAlarmTime, tsAlarmIdx=tsAlarmIdx, charonII=charonII, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, sensFlags=sensFlags, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, hwgroup=hwgroup, sensSetupTable=sensSetupTable, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, SensorID=SensorID, sensState=sensState, OutputMode=OutputMode, unitType=unitType, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, inpAlarmState=inpAlarmState, OutputType=OutputType, inpTable=inpTable, sensUnit=sensUnit, sensValue=sensValue, outEntry=outEntry, UnitType=UnitType, TimeStamp=TimeStamp, sensSetupEntry=sensSetupEntry, SensorString=SensorString, sensValueRaw=sensValueRaw, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, SensorFlags=SensorFlags, outTable=outTable, sensTable=sensTable, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, outType=outType, outIndex=outIndex, inpEntry=inpEntry, outValue=outValue, SensorState=SensorState, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, inpIndex=inpIndex, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, poseidon=poseidon, sensIndex=sensIndex, sensString=sensString, PositiveInteger=PositiveInteger)
