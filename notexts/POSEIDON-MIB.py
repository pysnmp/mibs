...
Integer32, IpAddress, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Bits, Counter32, Counter64, enterprises, ObjectIdentity, ModuleIdentity, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Bits", "Counter32", "Counter64", "enterprises", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", setup=setup, unitType=unitType, inpIndex=inpIndex, hwgroup=hwgroup, tsAlarmId=tsAlarmId, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, IOName=IOName, inpAlarmState=inpAlarmState, inpTable=inpTable, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, SensorFlags=SensorFlags, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, OnOff=OnOff, sensID=sensID, tsAlarm=tsAlarm, SensorValue=SensorValue, inpAlarmStateChanged=inpAlarmStateChanged, outValue=outValue, SensorString=SensorString, outType=outType, tsAlarmSensName=tsAlarmSensName, sensTable=sensTable, sensState=sensState, SensorState=SensorState, UnitType=UnitType, SensorID=SensorID, InputAlarmState=InputAlarmState, outName=outName, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outEntry=outEntry, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensSetupTable=sensSetupTable, sensSetupIndex=sensSetupIndex, charonII=charonII, TimeStamp=TimeStamp, tsAlarmTime=tsAlarmTime, outMode=outMode, sensIndex=sensIndex, info=info, sensString=sensString, OutputMode=OutputMode, inpValue=inpValue, SensorUnitString=SensorUnitString, sensEntry=sensEntry, inpName=inpName, inpEntry=inpEntry, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, poseidon=poseidon, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName, sensName=sensName, sensLimitMax=sensLimitMax, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, sensSetup=sensSetup, PositiveInteger=PositiveInteger, OutputType=OutputType)
