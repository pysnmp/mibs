...
Counter32, Gauge32, iso, Integer32, NotificationType, ObjectIdentity, IpAddress, Unsigned32, Counter64, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "iso", "Integer32", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter64", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, unitType=unitType, SensorString=SensorString, sensState=sensState, UnitType=UnitType, sensTable=sensTable, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, inpValue=inpValue, sensSetupEntry=sensSetupEntry, inpName=inpName, inpIndex=inpIndex, sensName=sensName, OutputMode=OutputMode, sensEntry=sensEntry, TimeStamp=TimeStamp, inpEntry=inpEntry, OnOff=OnOff, setup=setup, sensID=sensID, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, IOName=IOName, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, hwgroup=hwgroup, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, tsAlarmIdx=tsAlarmIdx, PositiveInteger=PositiveInteger, outMode=outMode, SensorState=SensorState, tsAlarmId=tsAlarmId, SensorName=SensorName, inpAlarmStateChanged=inpAlarmStateChanged, outEntry=outEntry, sensString=sensString, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, outIndex=outIndex, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, inpTable=inpTable, sensSetup=sensSetup, charonII=charonII, sensValue=sensValue, OutputType=OutputType, outValue=outValue, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, sensLimitMax=sensLimitMax, SensorID=SensorID, sensFlags=sensFlags, poseidon=poseidon, InputAlarmState=InputAlarmState, outType=outType, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, outTable=outTable, sensIndex=sensIndex, sensUnit=sensUnit, info=info, outName=outName, SensorUnitString=SensorUnitString)
