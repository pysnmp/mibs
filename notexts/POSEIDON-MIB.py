...
Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, iso, MibIdentifier, Unsigned32, ModuleIdentity, Integer32, Counter64, Bits, Gauge32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "iso", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32", "Counter64", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmEntry=tsAlarmEntry, tsAlarm=tsAlarm, inpName=inpName, tsAlarmsPresent=tsAlarmsPresent, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, sensID=sensID, outValue=outValue, OutputMode=OutputMode, sensUnit=sensUnit, charonII=charonII, poseidon=poseidon, sensString=sensString, OutputType=OutputType, outType=outType, outEntry=outEntry, sensUnitString=sensUnitString, sensName=sensName, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensEntry=sensEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmState=inpAlarmState, outIndex=outIndex, OnOff=OnOff, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, tsAlarmTable=tsAlarmTable, sensValueRaw=sensValueRaw, setup=setup, sensState=sensState, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex, inpIndex=inpIndex, SensorFlags=SensorFlags, IOName=IOName, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, UnitType=UnitType, SensorID=SensorID, inpValue=inpValue, unitType=unitType, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, outName=outName, sensTable=sensTable, SensorString=SensorString, TimeStamp=TimeStamp, inpTable=inpTable, SensorState=SensorState, info=info, sensSetup=sensSetup, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, outMode=outMode, outTable=outTable, sensValue=sensValue, InputAlarmState=InputAlarmState, SensorValue=SensorValue, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName)
