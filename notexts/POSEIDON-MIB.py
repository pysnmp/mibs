...
Integer32, Bits, enterprises, ModuleIdentity, Gauge32, Counter64, TimeTicks, iso, Counter32, ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "enterprises", "ModuleIdentity", "Gauge32", "Counter64", "TimeTicks", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, outType=outType, inpName=inpName, outEntry=outEntry, sensLimitMin=sensLimitMin, sensState=sensState, OutputMode=OutputMode, sensSetupIndex=sensSetupIndex, IOName=IOName, sensSetupName=sensSetupName, tsAlarmTime=tsAlarmTime, outTable=outTable, sensString=sensString, sensValueRaw=sensValueRaw, sensTable=sensTable, outName=outName, OnOff=OnOff, inpValue=inpValue, outValue=outValue, sensName=sensName, PositiveInteger=PositiveInteger, tsAlarmsPresent=tsAlarmsPresent, hwgroup=hwgroup, sensHysteresis=sensHysteresis, SensorString=SensorString, poseidon=poseidon, sensValue=sensValue, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, UnitType=UnitType, SensorState=SensorState, inpAlarmState=inpAlarmState, unitType=unitType, sensIndex=sensIndex, sensSetup=sensSetup, setup=setup, sensSetupEntry=sensSetupEntry, outIndex=outIndex, SensorValue=SensorValue, sensFlags=sensFlags, sensID=sensID, inpTable=inpTable, charonII=charonII, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, outMode=outMode, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, sensEntry=sensEntry, TimeStamp=TimeStamp, info=info, infoAddressMAC=infoAddressMAC, OutputType=OutputType, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, SensorID=SensorID, SensorFlags=SensorFlags)
