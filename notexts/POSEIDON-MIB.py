...
Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, MibIdentifier, Integer32, TimeTicks, iso, ModuleIdentity, Gauge32, Counter32, NotificationType, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "MibIdentifier", "Integer32", "TimeTicks", "iso", "ModuleIdentity", "Gauge32", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, inpIndex=inpIndex, sensString=sensString, tsAlarmId=tsAlarmId, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, SensorID=SensorID, SensorState=SensorState, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, setup=setup, info=info, sensUnitString=sensUnitString, sensID=sensID, OutputMode=OutputMode, sensHysteresis=sensHysteresis, sensValue=sensValue, inpAlarmSetup=inpAlarmSetup, outType=outType, inpTable=inpTable, inpAlarmState=inpAlarmState, inpEntry=inpEntry, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, outValue=outValue, outMode=outMode, sensFlags=sensFlags, sensState=sensState, InputAlarmState=InputAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, OutputType=OutputType, infoAddressMAC=infoAddressMAC, outName=outName, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, sensSetupName=sensSetupName, sensTable=sensTable, tsTrapAlarmStart=tsTrapAlarmStart, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensName=sensName, tsAlarmIdx=tsAlarmIdx, tsAlarm=tsAlarm, unitType=unitType, SensorValue=SensorValue, outTable=outTable, IOName=IOName, sensEntry=sensEntry, sensUnit=sensUnit, charonII=charonII, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, TimeStamp=TimeStamp, inpName=inpName, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, outIndex=outIndex, inpValue=inpValue)
