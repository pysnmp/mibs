...
Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, iso, Integer32, NotificationType, ObjectIdentity, Counter64, enterprises, TimeTicks, MibIdentifier, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "iso", "Integer32", "NotificationType", "ObjectIdentity", "Counter64", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpValue=inpValue, sensUnit=sensUnit, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, hwgroup=hwgroup, sensID=sensID, inpName=inpName, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, OutputType=OutputType, outIndex=outIndex, sensName=sensName, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, outMode=outMode, sensString=sensString, outType=outType, sensHysteresis=sensHysteresis, SensorState=SensorState, SensorValue=SensorValue, tsAlarmTime=tsAlarmTime, sensState=sensState, sensTable=sensTable, SensorFlags=SensorFlags, sensLimitMax=sensLimitMax, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, IOName=IOName, outName=outName, inpIndex=inpIndex, tsAlarm=tsAlarm, SensorString=SensorString, sensFlags=sensFlags, sensAlarmStateChanged=sensAlarmStateChanged, OnOff=OnOff, outValue=outValue, setup=setup, outEntry=outEntry, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, unitType=unitType, inpAlarmState=inpAlarmState, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, SensorID=SensorID, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, sensUnitString=sensUnitString, sensSetup=sensSetup, poseidon=poseidon, sensEntry=sensEntry, SensorUnitString=SensorUnitString, OutputMode=OutputMode, outTable=outTable, charonII=charonII, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, UnitType=UnitType, InputAlarmState=InputAlarmState, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmEnd=tsTrapAlarmEnd, info=info)
