...
IpAddress, Counter32, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Counter64, TimeTicks, Bits, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Counter64", "TimeTicks", "Bits", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, outValue=outValue, sensEntry=sensEntry, sensLimitMax=sensLimitMax, outIndex=outIndex, sensValueRaw=sensValueRaw, sensState=sensState, inpAlarmState=inpAlarmState, OutputMode=OutputMode, sensSetupIndex=sensSetupIndex, sensName=sensName, outType=outType, poseidon=poseidon, outTable=outTable, sensTable=sensTable, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, SensorState=SensorState, inpAlarmStateChanged=inpAlarmStateChanged, sensValue=sensValue, PositiveInteger=PositiveInteger, SensorID=SensorID, sensSetup=sensSetup, SensorUnitString=SensorUnitString, SensorValue=SensorValue, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, sensFlags=sensFlags, OutputType=OutputType, inpName=inpName, tsAlarmTime=tsAlarmTime, tsAlarmIdx=tsAlarmIdx, InputAlarmState=InputAlarmState, inpTable=inpTable, sensID=sensID, SensorName=SensorName, inpIndex=inpIndex, tsAlarmSensName=tsAlarmSensName, outName=outName, info=info, charonII=charonII, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, outMode=outMode, OnOff=OnOff, tsAlarmsPresent=tsAlarmsPresent, setup=setup, sensIndex=sensIndex, sensString=sensString, infoAddressMAC=infoAddressMAC, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, IOName=IOName, tsAlarmTable=tsAlarmTable, tsAlarmEntry=tsAlarmEntry, sensLimitMin=sensLimitMin, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, SensorFlags=SensorFlags, inpValue=inpValue, InputAlarmSetup=InputAlarmSetup, hwgroup=hwgroup, outEntry=outEntry, unitType=unitType, tsAlarmDescr=tsAlarmDescr, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, inpEntry=inpEntry)
