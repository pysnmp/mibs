...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValue=sensValue, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, outValue=outValue, tsTrapAlarmEnd=tsTrapAlarmEnd, outType=outType, infoAddressMAC=infoAddressMAC, outTable=outTable, sensUnit=sensUnit, inpValue=inpValue, inpIndex=inpIndex, UnitType=UnitType, SensorFlags=SensorFlags, hwgroup=hwgroup, sensIndex=sensIndex, outEntry=outEntry, sensEntry=sensEntry, outMode=outMode, inpAlarmState=inpAlarmState, outIndex=outIndex, inpTable=inpTable, inpName=inpName, tsAlarmTime=tsAlarmTime, sensTable=sensTable, tsAlarmDescr=tsAlarmDescr, IOName=IOName, sensLimitMin=sensLimitMin, SensorState=SensorState, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, sensSetup=sensSetup, OnOff=OnOff, unitType=unitType, sensName=sensName, outName=outName, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, info=info, tsAlarmId=tsAlarmId, SensorID=SensorID, sensSetupEntry=sensSetupEntry, OutputMode=OutputMode, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, charonII=charonII, sensFlags=sensFlags, SensorName=SensorName, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, sensAlarmStateChanged=sensAlarmStateChanged, sensString=sensString, OutputType=OutputType, poseidon=poseidon, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, sensID=sensID, sensSetupIndex=sensSetupIndex, SensorString=SensorString, sensHysteresis=sensHysteresis)
