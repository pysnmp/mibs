...
Integer32, ObjectIdentity, Counter64, Unsigned32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Counter32, TimeTicks, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter64", "Unsigned32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter32", "TimeTicks", "iso", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetup=sensSetup, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, sensString=sensString, sensSetupTable=sensSetupTable, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, PositiveInteger=PositiveInteger, charonII=charonII, sensTable=sensTable, sensName=sensName, info=info, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, SensorID=SensorID, outIndex=outIndex, sensLimitMax=sensLimitMax, outName=outName, inpAlarmSetup=inpAlarmSetup, sensID=sensID, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode, outEntry=outEntry, InputAlarmSetup=InputAlarmSetup, infoAddressMAC=infoAddressMAC, sensUnitString=sensUnitString, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, unitType=unitType, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, UnitType=UnitType, sensFlags=sensFlags, outType=outType, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, TimeStamp=TimeStamp, SensorState=SensorState, OutputType=OutputType, OnOff=OnOff, poseidon=poseidon, setup=setup, InputAlarmState=InputAlarmState, inpTable=inpTable, sensValueRaw=sensValueRaw, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, tsAlarmTime=tsAlarmTime, IOName=IOName, inpIndex=inpIndex, tsTrapAlarmStart=tsTrapAlarmStart, inpName=inpName, inpValue=inpValue, SensorUnitString=SensorUnitString, sensLimitMin=sensLimitMin, outValue=outValue, sensEntry=sensEntry, sensValue=sensValue, outTable=outTable)
