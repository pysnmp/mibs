...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, IpAddress, MibIdentifier, Gauge32, enterprises, Counter64, Bits, NotificationType, iso, Unsigned32, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "IpAddress", "MibIdentifier", "Gauge32", "enterprises", "Counter64", "Bits", "NotificationType", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensAlarmStateChanged=sensAlarmStateChanged, SensorValue=SensorValue, OutputMode=OutputMode, tsAlarmDescr=tsAlarmDescr, outTable=outTable, outName=outName, OnOff=OnOff, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, outType=outType, tsAlarmEntry=tsAlarmEntry, outEntry=outEntry, sensSetup=sensSetup, sensName=sensName, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, outIndex=outIndex, TimeStamp=TimeStamp, SensorName=SensorName, sensID=sensID, unitType=unitType, inpName=inpName, sensValue=sensValue, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, sensSetupName=sensSetupName, sensFlags=sensFlags, inpValue=inpValue, sensIndex=sensIndex, SensorString=SensorString, poseidon=poseidon, sensState=sensState, tsAlarmIdx=tsAlarmIdx, UnitType=UnitType, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, outValue=outValue, SensorUnitString=SensorUnitString, tsAlarmSensName=tsAlarmSensName, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, info=info, tsAlarmTable=tsAlarmTable, charonII=charonII, InputAlarmSetup=InputAlarmSetup, sensLimitMin=sensLimitMin, IOName=IOName, tsAlarm=tsAlarm, sensTable=sensTable, sensString=sensString, inpEntry=inpEntry, inpIndex=inpIndex, sensHysteresis=sensHysteresis, SensorState=SensorState, InputAlarmState=InputAlarmState, inpTable=inpTable, sensSetupTable=sensSetupTable, inpAlarmState=inpAlarmState, sensLimitMax=sensLimitMax, outMode=outMode, sensUnitString=sensUnitString, setup=setup, hwgroup=hwgroup, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC)
