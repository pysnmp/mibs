...
MibIdentifier, enterprises, Counter32, Unsigned32, IpAddress, TimeTicks, Gauge32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, NotificationType, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Counter32", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, outName=outName, outValue=outValue, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, sensLimitMin=sensLimitMin, charonII=charonII, sensString=sensString, sensIndex=sensIndex, TimeStamp=TimeStamp, outTable=outTable, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, unitType=unitType, sensSetupName=sensSetupName, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, sensState=sensState, inpValue=inpValue, sensLimitMax=sensLimitMax, outType=outType, inpEntry=inpEntry, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, setup=setup, outIndex=outIndex, sensValue=sensValue, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, sensHysteresis=sensHysteresis, sensValueRaw=sensValueRaw, inpName=inpName, sensID=sensID, PositiveInteger=PositiveInteger, outMode=outMode, SensorID=SensorID, hwgroup=hwgroup, info=info, sensTable=sensTable, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, inpAlarmState=inpAlarmState, SensorFlags=SensorFlags, sensUnitString=sensUnitString, tsAlarmDescr=tsAlarmDescr, InputAlarmSetup=InputAlarmSetup, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputType=OutputType, inpTable=inpTable, SensorState=SensorState, inpIndex=inpIndex, sensName=sensName, tsAlarmIdx=tsAlarmIdx, SensorValue=SensorValue, UnitType=UnitType, outEntry=outEntry, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, sensFlags=sensFlags, sensUnit=sensUnit, poseidon=poseidon, tsAlarmSensName=tsAlarmSensName, IOName=IOName)
