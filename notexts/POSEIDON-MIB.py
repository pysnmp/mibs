...
iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, MibIdentifier, NotificationType, Integer32, Counter64, enterprises, Unsigned32, IpAddress, TimeTicks, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType", "Integer32", "Counter64", "enterprises", "Unsigned32", "IpAddress", "TimeTicks", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outEntry=outEntry, inpName=inpName, sensTable=sensTable, charonII=charonII, info=info, outTable=outTable, tsAlarmTime=tsAlarmTime, setup=setup, inpAlarmSetup=inpAlarmSetup, poseidon=poseidon, sensSetupIndex=sensSetupIndex, outValue=outValue, unitType=unitType, tsAlarmId=tsAlarmId, outType=outType, tsAlarm=tsAlarm, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, inpEntry=inpEntry, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, outMode=outMode, sensID=sensID, inpAlarmState=inpAlarmState, inpTable=inpTable, sensSetup=sensSetup, UnitType=UnitType, sensValue=sensValue, sensLimitMin=sensLimitMin, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, OutputType=OutputType, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, sensSetupTable=sensSetupTable, OnOff=OnOff, InputAlarmState=InputAlarmState, SensorString=SensorString, TimeStamp=TimeStamp, SensorValue=SensorValue, outIndex=outIndex, sensString=sensString, sensUnit=sensUnit, SensorID=SensorID, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, outName=outName, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, SensorUnitString=SensorUnitString, inpIndex=inpIndex, inpValue=inpValue, sensIndex=sensIndex, sensState=sensState, InputAlarmSetup=InputAlarmSetup, IOName=IOName, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, sensName=sensName, sensEntry=sensEntry, SensorState=SensorState)
