...
ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Unsigned32, Integer32, iso, TimeTicks, Counter32, ModuleIdentity, enterprises, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Unsigned32", "Integer32", "iso", "TimeTicks", "Counter32", "ModuleIdentity", "enterprises", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensID=sensID, sensName=sensName, tsAlarmEntry=tsAlarmEntry, IOName=IOName, inpAlarmSetup=inpAlarmSetup, sensHysteresis=sensHysteresis, sensString=sensString, sensSetupIndex=sensSetupIndex, SensorState=SensorState, InputAlarmState=InputAlarmState, inpValue=inpValue, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, SensorUnitString=SensorUnitString, outIndex=outIndex, outName=outName, tsAlarmIdx=tsAlarmIdx, outValue=outValue, sensValue=sensValue, tsAlarm=tsAlarm, OutputType=OutputType, outMode=outMode, sensSetupName=sensSetupName, setup=setup, infoAddressMAC=infoAddressMAC, inpTable=inpTable, sensLimitMax=sensLimitMax, poseidon=poseidon, SensorID=SensorID, SensorValue=SensorValue, TimeStamp=TimeStamp, sensIndex=sensIndex, SensorName=SensorName, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, sensSetup=sensSetup, tsTrapAlarmStart=tsTrapAlarmStart, SensorString=SensorString, sensUnit=sensUnit, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, tsAlarmTime=tsAlarmTime, SensorFlags=SensorFlags, charonII=charonII, outEntry=outEntry, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, sensValueRaw=sensValueRaw, OnOff=OnOff, inpAlarmState=inpAlarmState, tsAlarmDescr=tsAlarmDescr, hwgroup=hwgroup, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, info=info, sensEntry=sensEntry, inpIndex=inpIndex, tsAlarmSensName=tsAlarmSensName, outType=outType, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, inpName=inpName, outTable=outTable, unitType=unitType, sensUnitString=sensUnitString, OutputMode=OutputMode)
