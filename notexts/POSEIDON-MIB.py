...
ObjectIdentity, Integer32, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32, Bits, NotificationType, MibIdentifier, enterprises, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "enterprises", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, tsAlarmsPresent=tsAlarmsPresent, SensorFlags=SensorFlags, inpEntry=inpEntry, sensSetupIndex=sensSetupIndex, SensorString=SensorString, sensSetupName=sensSetupName, sensValue=sensValue, sensSetupTable=sensSetupTable, sensUnit=sensUnit, InputAlarmSetup=InputAlarmSetup, outIndex=outIndex, SensorID=SensorID, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, sensIndex=sensIndex, unitType=unitType, sensID=sensID, inpValue=inpValue, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, hwgroup=hwgroup, outTable=outTable, IOName=IOName, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, outMode=outMode, tsTrapAlarmStart=tsTrapAlarmStart, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, SensorValue=SensorValue, outEntry=outEntry, outValue=outValue, outName=outName, inpIndex=inpIndex, sensUnitString=sensUnitString, OnOff=OnOff, TimeStamp=TimeStamp, SensorState=SensorState, infoAddressMAC=infoAddressMAC, inpTable=inpTable, UnitType=UnitType, setup=setup, sensTable=sensTable, InputAlarmState=InputAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, OutputMode=OutputMode, SensorName=SensorName, sensFlags=sensFlags, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, inpName=inpName, sensName=sensName, tsAlarmIdx=tsAlarmIdx, sensValueRaw=sensValueRaw, sensString=sensString, sensSetup=sensSetup, info=info, inpAlarmState=inpAlarmState, outType=outType, poseidon=poseidon, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime)
