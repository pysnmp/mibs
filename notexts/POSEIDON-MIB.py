...
ObjectIdentity, MibIdentifier, Bits, TimeTicks, Counter32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Integer32, Counter64, Unsigned32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "Counter32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "Unsigned32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, sensSetupName=sensSetupName, OnOff=OnOff, sensUnit=sensUnit, sensString=sensString, sensUnitString=sensUnitString, outEntry=outEntry, sensName=sensName, inpValue=inpValue, SensorState=SensorState, UnitType=UnitType, SensorID=SensorID, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, info=info, inpAlarmSetup=inpAlarmSetup, outTable=outTable, outValue=outValue, sensAlarmStateChanged=sensAlarmStateChanged, outIndex=outIndex, sensHysteresis=sensHysteresis, IOName=IOName, sensValue=sensValue, sensID=sensID, infoAddressMAC=infoAddressMAC, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, PositiveInteger=PositiveInteger, SensorValue=SensorValue, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensEntry=sensEntry, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, TimeStamp=TimeStamp, outName=outName, OutputMode=OutputMode, SensorName=SensorName, hwgroup=hwgroup, outMode=outMode, unitType=unitType, tsAlarmSensName=tsAlarmSensName, sensState=sensState, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, outType=outType, tsAlarm=tsAlarm, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, sensFlags=sensFlags, poseidon=poseidon, sensTable=sensTable, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMax=sensLimitMax, sensSetupIndex=sensSetupIndex, inpTable=inpTable, SensorUnitString=SensorUnitString, sensLimitMin=sensLimitMin, sensValueRaw=sensValueRaw, SensorString=SensorString, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart)
