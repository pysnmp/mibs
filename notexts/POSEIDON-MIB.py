...
ObjectIdentity, iso, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Integer32, Counter64, ModuleIdentity, IpAddress, Bits, Unsigned32, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "Bits", "Unsigned32", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, SensorName=SensorName, charonII=charonII, sensUnitString=sensUnitString, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, sensTable=sensTable, setup=setup, outName=outName, inpAlarmStateChanged=inpAlarmStateChanged, inpEntry=inpEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, sensName=sensName, SensorFlags=SensorFlags, sensEntry=sensEntry, sensString=sensString, PositiveInteger=PositiveInteger, OutputType=OutputType, sensLimitMax=sensLimitMax, inpAlarmState=inpAlarmState, inpIndex=inpIndex, sensSetupName=sensSetupName, inpValue=inpValue, sensSetup=sensSetup, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, inpTable=inpTable, inpName=inpName, outTable=outTable, sensFlags=sensFlags, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, sensValue=sensValue, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, tsAlarmId=tsAlarmId, sensUnit=sensUnit, unitType=unitType, sensAlarmStateChanged=sensAlarmStateChanged, sensIndex=sensIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmsPresent=tsAlarmsPresent, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, OnOff=OnOff, sensID=sensID, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, info=info, outMode=outMode, SensorString=SensorString, outIndex=outIndex, tsAlarmTable=tsAlarmTable, outType=outType, tsAlarmTime=tsAlarmTime, SensorID=SensorID, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, outValue=outValue, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, IOName=IOName)
