...
Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, MibIdentifier, TimeTicks, iso, Counter32, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "MibIdentifier", "TimeTicks", "iso", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", PositiveInteger=PositiveInteger, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, sensState=sensState, SensorID=SensorID, outTable=outTable, sensIndex=sensIndex, poseidon=poseidon, OutputMode=OutputMode, OutputType=OutputType, inpAlarmState=inpAlarmState, tsAlarmId=tsAlarmId, UnitType=UnitType, sensEntry=sensEntry, inpTable=inpTable, inpIndex=inpIndex, SensorFlags=SensorFlags, SensorString=SensorString, inpValue=inpValue, outIndex=outIndex, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, charonII=charonII, outEntry=outEntry, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, inpName=inpName, outName=outName, outType=outType, sensUnitString=sensUnitString, outMode=outMode, SensorValue=SensorValue, tsAlarmEntry=tsAlarmEntry, outValue=outValue, sensName=sensName, setup=setup, unitType=unitType, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, sensUnit=sensUnit, InputAlarmState=InputAlarmState, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, TimeStamp=TimeStamp, sensLimitMin=sensLimitMin, tsAlarmSensName=tsAlarmSensName, sensString=sensString, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, sensID=sensID, inpEntry=inpEntry, sensSetup=sensSetup, sensHysteresis=sensHysteresis, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, sensSetupTable=sensSetupTable, sensTable=sensTable, info=info, sensValueRaw=sensValueRaw, IOName=IOName, SensorState=SensorState)
