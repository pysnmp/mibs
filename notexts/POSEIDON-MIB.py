...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, ObjectIdentity, IpAddress, Bits, Integer32, Gauge32, TimeTicks, Unsigned32, MibIdentifier, ModuleIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "ObjectIdentity", "IpAddress", "Bits", "Integer32", "Gauge32", "TimeTicks", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", setup=setup, inpIndex=inpIndex, OutputType=OutputType, outIndex=outIndex, outType=outType, SensorString=SensorString, inpAlarmState=inpAlarmState, sensUnit=sensUnit, outName=outName, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, TimeStamp=TimeStamp, SensorValue=SensorValue, IOName=IOName, inpEntry=inpEntry, UnitType=UnitType, tsAlarmTime=tsAlarmTime, sensValueRaw=sensValueRaw, poseidon=poseidon, sensIndex=sensIndex, tsAlarm=tsAlarm, sensState=sensState, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, inpValue=inpValue, sensID=sensID, charonII=charonII, InputAlarmSetup=InputAlarmSetup, outValue=outValue, outTable=outTable, PositiveInteger=PositiveInteger, info=info, sensSetup=sensSetup, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, OnOff=OnOff, sensSetupTable=sensSetupTable, tsAlarmId=tsAlarmId, sensTable=sensTable, sensLimitMax=sensLimitMax, outEntry=outEntry, unitType=unitType, SensorState=SensorState, OutputMode=OutputMode, inpName=inpName, InputAlarmState=InputAlarmState, sensName=sensName, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, outMode=outMode, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, tsAlarmTable=tsAlarmTable, SensorFlags=SensorFlags, SensorID=SensorID, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, tsAlarmSensName=tsAlarmSensName, inpTable=inpTable, SensorName=SensorName, sensLimitMin=sensLimitMin, sensValue=sensValue, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, sensEntry=sensEntry, sensString=sensString)
