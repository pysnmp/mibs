...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, NotificationType, Integer32, ModuleIdentity, MibIdentifier, Counter32, Counter64, IpAddress, iso, ObjectIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "NotificationType", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter32", "Counter64", "IpAddress", "iso", "ObjectIdentity", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, sensLimitMin=sensLimitMin, SensorUnitString=SensorUnitString, inpTable=inpTable, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, info=info, outName=outName, outType=outType, InputAlarmSetup=InputAlarmSetup, sensString=sensString, tsTrapAlarmEnd=tsTrapAlarmEnd, PositiveInteger=PositiveInteger, SensorState=SensorState, OutputMode=OutputMode, sensState=sensState, unitType=unitType, SensorName=SensorName, outIndex=outIndex, charonII=charonII, tsAlarmDescr=tsAlarmDescr, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, sensSetup=sensSetup, sensTable=sensTable, outValue=outValue, SensorID=SensorID, IOName=IOName, inpIndex=inpIndex, sensUnit=sensUnit, sensSetupEntry=sensSetupEntry, UnitType=UnitType, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, outMode=outMode, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, sensFlags=sensFlags, sensEntry=sensEntry, poseidon=poseidon, OnOff=OnOff, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, SensorValue=SensorValue, inpAlarmState=inpAlarmState, setup=setup, sensID=sensID, tsAlarmIdx=tsAlarmIdx, inpName=inpName, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, outTable=outTable, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, sensSetupIndex=sensSetupIndex, sensUnitString=sensUnitString, sensLimitMax=sensLimitMax, sensValue=sensValue, inpValue=inpValue, tsAlarmId=tsAlarmId, OutputType=OutputType)
