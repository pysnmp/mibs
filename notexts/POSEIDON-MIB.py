...
Bits, Unsigned32, MibIdentifier, Gauge32, NotificationType, ObjectIdentity, Counter64, Integer32, Counter32, IpAddress, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "MibIdentifier", "Gauge32", "NotificationType", "ObjectIdentity", "Counter64", "Integer32", "Counter32", "IpAddress", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, sensID=sensID, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, setup=setup, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, PositiveInteger=PositiveInteger, outTable=outTable, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, OutputType=OutputType, sensFlags=sensFlags, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, charonII=charonII, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, UnitType=UnitType, tsAlarmTable=tsAlarmTable, SensorState=SensorState, tsAlarmId=tsAlarmId, outType=outType, sensState=sensState, SensorFlags=SensorFlags, SensorID=SensorID, poseidon=poseidon, sensTable=sensTable, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, SensorValue=SensorValue, inpIndex=inpIndex, inpAlarmState=inpAlarmState, sensEntry=sensEntry, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, SensorUnitString=SensorUnitString, inpName=inpName, outIndex=outIndex, outMode=outMode, sensValue=sensValue, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, outName=outName, sensSetupName=sensSetupName, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, inpEntry=inpEntry, sensString=sensString, info=info, sensLimitMin=sensLimitMin, outEntry=outEntry, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, sensSetup=sensSetup, tsAlarmTime=tsAlarmTime, inpTable=inpTable, sensIndex=sensIndex, outValue=outValue, tsAlarmEntry=tsAlarmEntry, IOName=IOName, sensUnit=sensUnit, SensorName=SensorName, tsTrapAlarmStart=tsTrapAlarmStart)
