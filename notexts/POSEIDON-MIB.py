...
NotificationType, IpAddress, iso, Gauge32, enterprises, Counter32, ObjectIdentity, Integer32, Counter64, TimeTicks, Bits, MibIdentifier, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "iso", "Gauge32", "enterprises", "Counter32", "ObjectIdentity", "Integer32", "Counter64", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetup=sensSetup, SensorString=SensorString, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, sensIndex=sensIndex, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, inpTable=inpTable, sensUnit=sensUnit, PositiveInteger=PositiveInteger, outTable=outTable, tsAlarmTime=tsAlarmTime, inpName=inpName, unitType=unitType, sensSetupName=sensSetupName, SensorValue=SensorValue, SensorID=SensorID, tsAlarm=tsAlarm, SensorFlags=SensorFlags, inpIndex=inpIndex, sensTable=sensTable, sensValue=sensValue, sensSetupEntry=sensSetupEntry, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, SensorState=SensorState, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, inpEntry=inpEntry, setup=setup, sensID=sensID, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, outMode=outMode, outType=outType, IOName=IOName, outIndex=outIndex, outValue=outValue, charonII=charonII, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, inpAlarmState=inpAlarmState, outName=outName, sensString=sensString, sensLimitMin=sensLimitMin, sensUnitString=sensUnitString, TimeStamp=TimeStamp, sensFlags=sensFlags, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, OutputMode=OutputMode, outEntry=outEntry, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, tsAlarmTable=tsAlarmTable, OutputType=OutputType, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, inpValue=inpValue, SensorName=SensorName, sensName=sensName, info=info)
