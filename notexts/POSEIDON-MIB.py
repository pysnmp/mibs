...
Bits, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, NotificationType, iso, enterprises, Integer32, Counter64, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "iso", "enterprises", "Integer32", "Counter64", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, sensState=sensState, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, info=info, IOName=IOName, tsAlarm=tsAlarm, tsAlarmId=tsAlarmId, SensorFlags=SensorFlags, outType=outType, sensID=sensID, tsAlarmIdx=tsAlarmIdx, outMode=outMode, sensSetupEntry=sensSetupEntry, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, inpValue=inpValue, outValue=outValue, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, outName=outName, setup=setup, SensorString=SensorString, sensSetup=sensSetup, PositiveInteger=PositiveInteger, sensName=sensName, sensLimitMin=sensLimitMin, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, SensorState=SensorState, TimeStamp=TimeStamp, sensTable=sensTable, sensSetupName=sensSetupName, charonII=charonII, SensorID=SensorID, sensSetupTable=sensSetupTable, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, OutputType=OutputType, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, OnOff=OnOff, outIndex=outIndex, sensEntry=sensEntry, inpIndex=inpIndex, inpName=inpName, inpTable=inpTable, sensIndex=sensIndex, sensUnit=sensUnit, outTable=outTable, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, sensValue=sensValue, tsAlarmTime=tsAlarmTime, tsAlarmDescr=tsAlarmDescr, sensString=sensString, outEntry=outEntry, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, inpEntry=inpEntry, SensorValue=SensorValue, tsTrapAlarmEnd=tsTrapAlarmEnd)
