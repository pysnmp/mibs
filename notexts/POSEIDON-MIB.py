...
ObjectIdentity, iso, NotificationType, Gauge32, Counter64, ModuleIdentity, TimeTicks, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, IpAddress, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "IpAddress", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorUnitString=SensorUnitString, inpIndex=inpIndex, sensIndex=sensIndex, UnitType=UnitType, tsAlarmId=tsAlarmId, unitType=unitType, PositiveInteger=PositiveInteger, inpTable=inpTable, outValue=outValue, sensUnit=sensUnit, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, TimeStamp=TimeStamp, inpName=inpName, inpAlarmSetup=inpAlarmSetup, outTable=outTable, sensValue=sensValue, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, sensName=sensName, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, outIndex=outIndex, sensLimitMax=sensLimitMax, sensValueRaw=sensValueRaw, sensTable=sensTable, outName=outName, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, setup=setup, IOName=IOName, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, tsAlarmSensName=tsAlarmSensName, charonII=charonII, SensorState=SensorState, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, outMode=outMode, sensEntry=sensEntry, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensID=sensID, outType=outType, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, sensSetup=sensSetup, hwgroup=hwgroup, poseidon=poseidon, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, SensorValue=SensorValue, SensorName=SensorName, OutputMode=OutputMode, sensString=sensString, inpAlarmState=inpAlarmState, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, SensorFlags=SensorFlags, SensorID=SensorID, sensSetupName=sensSetupName, info=info, inpValue=inpValue, tsAlarmTime=tsAlarmTime, OnOff=OnOff)
