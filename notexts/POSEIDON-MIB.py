...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, ModuleIdentity, TimeTicks, enterprises, Gauge32, Counter32, IpAddress, Counter64, Integer32, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "enterprises", "Gauge32", "Counter32", "IpAddress", "Counter64", "Integer32", "iso", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, outMode=outMode, inpName=inpName, OutputMode=OutputMode, SensorName=SensorName, outValue=outValue, sensSetupName=sensSetupName, sensSetup=sensSetup, outEntry=outEntry, SensorID=SensorID, sensUnitString=sensUnitString, unitType=unitType, sensIndex=sensIndex, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit, setup=setup, inpTable=inpTable, tsAlarmId=tsAlarmId, inpValue=inpValue, info=info, SensorUnitString=SensorUnitString, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, outIndex=outIndex, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, outTable=outTable, inpAlarmSetup=inpAlarmSetup, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, sensEntry=sensEntry, outType=outType, tsAlarmTime=tsAlarmTime, sensState=sensState, SensorString=SensorString, IOName=IOName, inpAlarmState=inpAlarmState, SensorState=SensorState, InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, sensSetupIndex=sensSetupIndex, sensValue=sensValue, tsAlarmsPresent=tsAlarmsPresent, sensID=sensID, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, sensValueRaw=sensValueRaw, charonII=charonII, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, sensName=sensName, poseidon=poseidon, OutputType=OutputType, inpEntry=inpEntry, sensString=sensString, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, outName=outName, tsAlarm=tsAlarm, SensorFlags=SensorFlags, sensLimitMax=sensLimitMax, UnitType=UnitType, PositiveInteger=PositiveInteger, sensHysteresis=sensHysteresis, infoAddressMAC=infoAddressMAC)
