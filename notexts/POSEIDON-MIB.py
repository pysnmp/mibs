...
MibIdentifier, iso, enterprises, Integer32, Counter32, ModuleIdentity, TimeTicks, NotificationType, Unsigned32, Bits, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "enterprises", "Integer32", "Counter32", "ModuleIdentity", "TimeTicks", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, poseidon=poseidon, SensorString=SensorString, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, OutputMode=OutputMode, sensID=sensID, TimeStamp=TimeStamp, tsAlarm=tsAlarm, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, SensorValue=SensorValue, outTable=outTable, tsAlarmDescr=tsAlarmDescr, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, unitType=unitType, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, outIndex=outIndex, charonII=charonII, setup=setup, outType=outType, inpAlarmSetup=inpAlarmSetup, IOName=IOName, sensTable=sensTable, outMode=outMode, infoAddressMAC=infoAddressMAC, SensorName=SensorName, sensSetupName=sensSetupName, sensUnitString=sensUnitString, info=info, tsAlarmId=tsAlarmId, inpTable=inpTable, sensState=sensState, OutputType=OutputType, sensUnit=sensUnit, OnOff=OnOff, SensorState=SensorState, sensSetupEntry=sensSetupEntry, tsAlarmIdx=tsAlarmIdx, sensString=sensString, SensorUnitString=SensorUnitString, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, inpEntry=inpEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, inpValue=inpValue, sensSetupIndex=sensSetupIndex, sensValue=sensValue, inpName=inpName, InputAlarmState=InputAlarmState, outValue=outValue, UnitType=UnitType, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensSetup=sensSetup, sensSetupTable=sensSetupTable, outName=outName, tsAlarmTime=tsAlarmTime, hwgroup=hwgroup, SensorID=SensorID, sensEntry=sensEntry)
