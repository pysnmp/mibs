...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, Bits, Integer32, iso, TimeTicks, NotificationType, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits", "Integer32", "iso", "TimeTicks", "NotificationType", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, outValue=outValue, PositiveInteger=PositiveInteger, charonII=charonII, setup=setup, sensID=sensID, poseidon=poseidon, sensLimitMax=sensLimitMax, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, inpIndex=inpIndex, unitType=unitType, SensorUnitString=SensorUnitString, outIndex=outIndex, inpTable=inpTable, sensName=sensName, sensIndex=sensIndex, sensState=sensState, sensTable=sensTable, info=info, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, inpEntry=inpEntry, OnOff=OnOff, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, inpAlarmState=inpAlarmState, OutputType=OutputType, SensorID=SensorID, sensFlags=sensFlags, SensorName=SensorName, sensSetupName=sensSetupName, TimeStamp=TimeStamp, SensorState=SensorState, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, sensLimitMin=sensLimitMin, outType=outType, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, tsAlarmTable=tsAlarmTable, sensUnit=sensUnit, tsAlarmDescr=tsAlarmDescr, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorFlags=SensorFlags, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, outTable=outTable, UnitType=UnitType, IOName=IOName, OutputMode=OutputMode, outMode=outMode, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensValue=sensValue, sensSetupEntry=sensSetupEntry, inpValue=inpValue, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, outName=outName)
