...
enterprises, NotificationType, Gauge32, Counter64, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, iso, Integer32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Gauge32", "Counter64", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "iso", "Integer32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensName=sensName, inpAlarmSetup=inpAlarmSetup, sensSetupTable=sensSetupTable, outValue=outValue, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, infoAddressMAC=infoAddressMAC, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorFlags=SensorFlags, UnitType=UnitType, OnOff=OnOff, sensIndex=sensIndex, sensUnit=sensUnit, sensState=sensState, inpAlarmState=inpAlarmState, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, sensValueRaw=sensValueRaw, sensString=sensString, inpEntry=inpEntry, tsAlarmId=tsAlarmId, SensorState=SensorState, SensorUnitString=SensorUnitString, inpIndex=inpIndex, sensSetupIndex=sensSetupIndex, tsAlarm=tsAlarm, unitType=unitType, hwgroup=hwgroup, SensorValue=SensorValue, outMode=outMode, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, sensLimitMin=sensLimitMin, charonII=charonII, OutputMode=OutputMode, SensorString=SensorString, inpTable=inpTable, sensHysteresis=sensHysteresis, OutputType=OutputType, inpName=inpName, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, outType=outType, sensLimitMax=sensLimitMax, info=info, outName=outName, outEntry=outEntry, SensorName=SensorName, sensValue=sensValue, InputAlarmState=InputAlarmState, outTable=outTable, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, sensTable=sensTable, IOName=IOName, sensAlarmStateChanged=sensAlarmStateChanged, sensEntry=sensEntry, poseidon=poseidon, sensID=sensID, tsAlarmSensName=tsAlarmSensName, SensorID=SensorID)
