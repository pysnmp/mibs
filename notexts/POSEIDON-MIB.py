...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, Counter32, Counter64, iso, ModuleIdentity, Integer32, NotificationType, Bits, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32", "Counter64", "iso", "ModuleIdentity", "Integer32", "NotificationType", "Bits", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, tsAlarmId=tsAlarmId, sensUnit=sensUnit, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, outMode=outMode, tsAlarmIdx=tsAlarmIdx, setup=setup, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, InputAlarmSetup=InputAlarmSetup, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, SensorUnitString=SensorUnitString, SensorValue=SensorValue, UnitType=UnitType, sensSetupEntry=sensSetupEntry, outIndex=outIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensID=sensID, outType=outType, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, outValue=outValue, TimeStamp=TimeStamp, OutputMode=OutputMode, tsAlarmTime=tsAlarmTime, outEntry=outEntry, sensIndex=sensIndex, sensEntry=sensEntry, sensString=sensString, sensName=sensName, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, SensorName=SensorName, sensValueRaw=sensValueRaw, unitType=unitType, IOName=IOName, infoAddressMAC=infoAddressMAC, sensValue=sensValue, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, charonII=charonII, SensorFlags=SensorFlags, outTable=outTable, hwgroup=hwgroup, inpTable=inpTable, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, sensSetup=sensSetup, PositiveInteger=PositiveInteger, SensorString=SensorString, sensState=sensState, inpValue=inpValue, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, SensorState=SensorState, SensorID=SensorID, info=info, sensTable=sensTable, sensAlarmStateChanged=sensAlarmStateChanged, inpIndex=inpIndex, OnOff=OnOff)
