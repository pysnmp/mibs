...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, NotificationType, Integer32, Unsigned32, Gauge32, IpAddress, ObjectIdentity, Counter32, enterprises, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "ObjectIdentity", "Counter32", "enterprises", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, charonII=charonII, IOName=IOName, sensHysteresis=sensHysteresis, sensValue=sensValue, sensFlags=sensFlags, outTable=outTable, sensEntry=sensEntry, sensUnit=sensUnit, sensLimitMax=sensLimitMax, outName=outName, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, hwgroup=hwgroup, inpEntry=inpEntry, inpName=inpName, tsAlarmSensName=tsAlarmSensName, OnOff=OnOff, sensTable=sensTable, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, sensSetupEntry=sensSetupEntry, outMode=outMode, infoAddressMAC=infoAddressMAC, sensName=sensName, outIndex=outIndex, tsAlarmIdx=tsAlarmIdx, SensorValue=SensorValue, OutputType=OutputType, inpValue=inpValue, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, sensState=sensState, SensorUnitString=SensorUnitString, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupName=sensSetupName, tsAlarmEntry=tsAlarmEntry, sensIndex=sensIndex, sensString=sensString, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, UnitType=UnitType, inpAlarmState=inpAlarmState, SensorID=SensorID, SensorName=SensorName, setup=setup, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, info=info, outValue=outValue, sensID=sensID, tsAlarmTable=tsAlarmTable, outEntry=outEntry, unitType=unitType, SensorFlags=SensorFlags, outType=outType, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, inpTable=inpTable, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, poseidon=poseidon)
