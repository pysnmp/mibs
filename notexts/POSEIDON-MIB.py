...
Bits, Unsigned32, enterprises, iso, Counter32, Integer32, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "enterprises", "iso", "Counter32", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, SensorValue=SensorValue, sensSetupEntry=sensSetupEntry, tsAlarmTime=tsAlarmTime, info=info, tsAlarmSensName=tsAlarmSensName, unitType=unitType, inpTable=inpTable, TimeStamp=TimeStamp, inpName=inpName, outIndex=outIndex, InputAlarmState=InputAlarmState, SensorID=SensorID, sensValue=sensValue, UnitType=UnitType, outValue=outValue, IOName=IOName, poseidon=poseidon, inpValue=inpValue, sensFlags=sensFlags, tsAlarmEntry=tsAlarmEntry, outMode=outMode, sensState=sensState, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, sensLimitMin=sensLimitMin, outName=outName, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, OnOff=OnOff, sensEntry=sensEntry, inpIndex=inpIndex, SensorUnitString=SensorUnitString, SensorState=SensorState, sensTable=sensTable, SensorFlags=SensorFlags, sensID=sensID, sensHysteresis=sensHysteresis, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, sensName=sensName, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmState=inpAlarmState, sensUnitString=sensUnitString, OutputMode=OutputMode, sensSetup=sensSetup, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, OutputType=OutputType, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupTable=sensSetupTable, hwgroup=hwgroup, setup=setup, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, outEntry=outEntry, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, outTable=outTable, tsAlarm=tsAlarm, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC)
