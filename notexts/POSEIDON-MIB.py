...
enterprises, TimeTicks, Gauge32, ObjectIdentity, iso, NotificationType, MibIdentifier, IpAddress, Bits, Integer32, Counter32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "Integer32", "Counter32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, SensorID=SensorID, charonII=charonII, outIndex=outIndex, inpAlarmState=inpAlarmState, tsAlarm=tsAlarm, sensIndex=sensIndex, inpAlarmSetup=inpAlarmSetup, sensSetupEntry=sensSetupEntry, OnOff=OnOff, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, SensorState=SensorState, sensSetupTable=sensSetupTable, tsAlarmTable=tsAlarmTable, info=info, inpName=inpName, outName=outName, SensorUnitString=SensorUnitString, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, OutputType=OutputType, sensUnit=sensUnit, SensorFlags=SensorFlags, outMode=outMode, sensValueRaw=sensValueRaw, tsAlarmId=tsAlarmId, IOName=IOName, sensID=sensID, sensLimitMax=sensLimitMax, sensSetupName=sensSetupName, sensEntry=sensEntry, outValue=outValue, sensName=sensName, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, sensLimitMin=sensLimitMin, inpValue=inpValue, inpTable=inpTable, SensorName=SensorName, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, sensFlags=sensFlags, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, setup=setup, infoAddressMAC=infoAddressMAC, SensorString=SensorString, sensString=sensString, poseidon=poseidon, unitType=unitType, InputAlarmState=InputAlarmState, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, outType=outType, outEntry=outEntry, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, hwgroup=hwgroup, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, PositiveInteger=PositiveInteger, sensSetup=sensSetup)
