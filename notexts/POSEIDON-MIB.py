...
Integer32, IpAddress, Gauge32, Counter32, TimeTicks, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Bits, MibIdentifier, ObjectIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "Counter32", "TimeTicks", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Bits", "MibIdentifier", "ObjectIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmState=InputAlarmState, inpName=inpName, OutputType=OutputType, hwgroup=hwgroup, sensUnitString=sensUnitString, SensorValue=SensorValue, inpAlarmState=inpAlarmState, sensUnit=sensUnit, sensIndex=sensIndex, SensorName=SensorName, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, OnOff=OnOff, sensEntry=sensEntry, UnitType=UnitType, sensState=sensState, sensString=sensString, sensValueRaw=sensValueRaw, sensID=sensID, tsAlarm=tsAlarm, charonII=charonII, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, sensTable=sensTable, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, outTable=outTable, inpTable=inpTable, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, TimeStamp=TimeStamp, outIndex=outIndex, SensorState=SensorState, sensName=sensName, SensorID=SensorID, setup=setup, SensorFlags=SensorFlags, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, inpValue=inpValue, SensorString=SensorString, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, tsAlarmId=tsAlarmId, SensorUnitString=SensorUnitString, unitType=unitType, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, info=info, inpEntry=inpEntry, outValue=outValue, PositiveInteger=PositiveInteger, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, sensLimitMax=sensLimitMax, outMode=outMode, sensSetupEntry=sensSetupEntry, tsAlarmsPresent=tsAlarmsPresent, outEntry=outEntry, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, outType=outType, tsAlarmSensName=tsAlarmSensName, sensValue=sensValue, outName=outName, tsAlarmIdx=tsAlarmIdx)
