...
Bits, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, enterprises, Integer32, NotificationType, iso, Counter64, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "enterprises", "Integer32", "NotificationType", "iso", "Counter64", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, outEntry=outEntry, sensSetupIndex=sensSetupIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, tsAlarm=tsAlarm, setup=setup, tsAlarmDescr=tsAlarmDescr, outValue=outValue, sensLimitMin=sensLimitMin, sensName=sensName, sensHysteresis=sensHysteresis, inpTable=inpTable, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMax=sensLimitMax, outName=outName, InputAlarmSetup=InputAlarmSetup, outMode=outMode, sensValueRaw=sensValueRaw, OutputType=OutputType, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, hwgroup=hwgroup, tsAlarmEntry=tsAlarmEntry, sensID=sensID, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, OnOff=OnOff, sensSetupTable=sensSetupTable, inpValue=inpValue, infoAddressMAC=infoAddressMAC, unitType=unitType, OutputMode=OutputMode, SensorState=SensorState, sensTable=sensTable, outType=outType, tsAlarmId=tsAlarmId, sensSetup=sensSetup, outIndex=outIndex, inpEntry=inpEntry, sensIndex=sensIndex, sensString=sensString, sensSetupName=sensSetupName, outTable=outTable, SensorUnitString=SensorUnitString, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, inpAlarmState=inpAlarmState, sensUnit=sensUnit, sensValue=sensValue, sensUnitString=sensUnitString, tsAlarmTime=tsAlarmTime, SensorName=SensorName, info=info, SensorValue=SensorValue, sensEntry=sensEntry, TimeStamp=TimeStamp, SensorID=SensorID, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTable=tsAlarmTable, IOName=IOName, PositiveInteger=PositiveInteger, SensorString=SensorString, poseidon=poseidon, charonII=charonII)
