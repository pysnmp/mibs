...
Integer32, ObjectIdentity, NotificationType, IpAddress, ModuleIdentity, Counter64, Gauge32, enterprises, iso, TimeTicks, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "NotificationType", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "enterprises", "iso", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, sensString=sensString, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, tsAlarmDescr=tsAlarmDescr, inpTable=inpTable, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, outIndex=outIndex, sensTable=sensTable, sensValue=sensValue, tsAlarmIdx=tsAlarmIdx, OutputType=OutputType, inpValue=inpValue, inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, InputAlarmState=InputAlarmState, info=info, inpName=inpName, OutputMode=OutputMode, TimeStamp=TimeStamp, charonII=charonII, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, outTable=outTable, outType=outType, sensName=sensName, sensValueRaw=sensValueRaw, outName=outName, tsAlarmTable=tsAlarmTable, SensorID=SensorID, sensSetup=sensSetup, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, IOName=IOName, inpIndex=inpIndex, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, SensorFlags=SensorFlags, sensID=sensID, SensorState=SensorState, SensorValue=SensorValue, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, OnOff=OnOff, sensUnitString=sensUnitString, hwgroup=hwgroup, sensIndex=sensIndex, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, sensState=sensState, sensEntry=sensEntry, setup=setup, outEntry=outEntry, sensFlags=sensFlags, unitType=unitType, tsAlarmEntry=tsAlarmEntry, outValue=outValue, outMode=outMode)
