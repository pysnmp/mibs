...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, inpName=inpName, charonII=charonII, sensValue=sensValue, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, PositiveInteger=PositiveInteger, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, outName=outName, sensState=sensState, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, sensSetupName=sensSetupName, OutputType=OutputType, tsAlarmsPresent=tsAlarmsPresent, SensorState=SensorState, hwgroup=hwgroup, outTable=outTable, info=info, outValue=outValue, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmDescr=tsAlarmDescr, sensID=sensID, sensLimitMax=sensLimitMax, sensName=sensName, outMode=outMode, tsAlarm=tsAlarm, SensorUnitString=SensorUnitString, UnitType=UnitType, outEntry=outEntry, tsAlarmIdx=tsAlarmIdx, sensEntry=sensEntry, IOName=IOName, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, inpValue=inpValue, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, sensSetup=sensSetup, InputAlarmState=InputAlarmState, OnOff=OnOff, infoAddressMAC=infoAddressMAC, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, SensorID=SensorID, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, inpTable=inpTable, sensTable=sensTable, SensorString=SensorString, inpIndex=inpIndex, poseidon=poseidon, inpAlarmState=inpAlarmState, unitType=unitType, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, setup=setup, sensFlags=sensFlags, outType=outType, sensString=sensString)
