...
iso, Unsigned32, Bits, NotificationType, Counter64, MibIdentifier, TimeTicks, Counter32, ModuleIdentity, ObjectIdentity, IpAddress, Integer32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "NotificationType", "Counter64", "MibIdentifier", "TimeTicks", "Counter32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Integer32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, info=info, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, InputAlarmState=InputAlarmState, OutputMode=OutputMode, inpName=inpName, hwgroup=hwgroup, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, SensorName=SensorName, sensLimitMax=sensLimitMax, OutputType=OutputType, inpAlarmState=inpAlarmState, inpValue=inpValue, tsAlarm=tsAlarm, inpIndex=inpIndex, sensString=sensString, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, outMode=outMode, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, sensSetup=sensSetup, sensID=sensID, SensorFlags=SensorFlags, SensorState=SensorState, sensValue=sensValue, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, unitType=unitType, tsAlarmSensName=tsAlarmSensName, setup=setup, inpTable=inpTable, OnOff=OnOff, outEntry=outEntry, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, outType=outType, SensorString=SensorString, sensState=sensState, tsAlarmEntry=tsAlarmEntry, outName=outName, sensUnitString=sensUnitString, charonII=charonII, UnitType=UnitType, sensHysteresis=sensHysteresis, SensorValue=SensorValue, SensorID=SensorID, IOName=IOName, sensName=sensName, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, outIndex=outIndex, PositiveInteger=PositiveInteger, sensEntry=sensEntry, sensFlags=sensFlags, sensLimitMin=sensLimitMin, outTable=outTable, SensorUnitString=SensorUnitString, sensSetupEntry=sensSetupEntry, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, InputAlarmSetup=InputAlarmSetup)
