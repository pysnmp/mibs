...
NotificationType, IpAddress, Counter64, ModuleIdentity, Integer32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter32, Bits, Gauge32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter32", "Bits", "Gauge32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, sensTable=sensTable, SensorState=SensorState, SensorValue=SensorValue, sensHysteresis=sensHysteresis, SensorFlags=SensorFlags, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, sensID=sensID, tsAlarmTime=tsAlarmTime, inpValue=inpValue, SensorUnitString=SensorUnitString, inpTable=inpTable, inpEntry=inpEntry, inpName=inpName, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, tsAlarm=tsAlarm, OutputType=OutputType, sensUnitString=sensUnitString, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, tsAlarmTable=tsAlarmTable, sensLimitMax=sensLimitMax, SensorString=SensorString, sensString=sensString, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, outEntry=outEntry, sensSetupName=sensSetupName, outType=outType, TimeStamp=TimeStamp, outValue=outValue, OnOff=OnOff, SensorName=SensorName, sensSetup=sensSetup, unitType=unitType, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, SensorID=SensorID, sensSetupTable=sensSetupTable, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, sensFlags=sensFlags, info=info, outTable=outTable, hwgroup=hwgroup, outMode=outMode, sensName=sensName, sensValue=sensValue, OutputMode=OutputMode, InputAlarmSetup=InputAlarmSetup, sensValueRaw=sensValueRaw, tsAlarmEntry=tsAlarmEntry, charonII=charonII, outName=outName, inpIndex=inpIndex, sensState=sensState, sensUnit=sensUnit, IOName=IOName, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, outIndex=outIndex, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId)
