...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter64, ModuleIdentity, Bits, IpAddress, TimeTicks, enterprises, NotificationType, Unsigned32, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "TimeTicks", "enterprises", "NotificationType", "Unsigned32", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, outTable=outTable, charonII=charonII, inpValue=inpValue, sensLimitMin=sensLimitMin, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, OnOff=OnOff, sensEntry=sensEntry, sensValueRaw=sensValueRaw, tsAlarmEntry=tsAlarmEntry, info=info, outMode=outMode, sensState=sensState, sensID=sensID, PositiveInteger=PositiveInteger, SensorID=SensorID, setup=setup, SensorState=SensorState, tsAlarm=tsAlarm, tsTrapAlarmStart=tsTrapAlarmStart, poseidon=poseidon, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, SensorUnitString=SensorUnitString, sensTable=sensTable, SensorValue=SensorValue, inpTable=inpTable, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, inpIndex=inpIndex, SensorFlags=SensorFlags, SensorString=SensorString, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, inpName=inpName, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, unitType=unitType, sensString=sensString, outType=outType, outIndex=outIndex, IOName=IOName, outName=outName, tsAlarmId=tsAlarmId, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, UnitType=UnitType, hwgroup=hwgroup, outValue=outValue, tsAlarmDescr=tsAlarmDescr, outEntry=outEntry, sensName=sensName, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, sensAlarmStateChanged=sensAlarmStateChanged, inpEntry=inpEntry, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, sensUnit=sensUnit)
