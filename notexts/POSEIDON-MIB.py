...
ObjectIdentity, enterprises, ModuleIdentity, Counter32, Bits, NotificationType, Unsigned32, Gauge32, MibIdentifier, Counter64, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "Unsigned32", "Gauge32", "MibIdentifier", "Counter64", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, setup=setup, outTable=outTable, inpAlarmSetup=inpAlarmSetup, sensID=sensID, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, inpAlarmState=inpAlarmState, charonII=charonII, inpIndex=inpIndex, inpTable=inpTable, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, SensorName=SensorName, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, sensString=sensString, sensFlags=sensFlags, SensorUnitString=SensorUnitString, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, sensSetup=sensSetup, poseidon=poseidon, TimeStamp=TimeStamp, OnOff=OnOff, hwgroup=hwgroup, tsAlarmId=tsAlarmId, sensTable=sensTable, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, outEntry=outEntry, SensorString=SensorString, inpValue=inpValue, info=info, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, unitType=unitType, sensIndex=sensIndex, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, sensState=sensState, sensValue=sensValue, sensUnitString=sensUnitString, sensEntry=sensEntry, sensSetupIndex=sensSetupIndex, outIndex=outIndex, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, PositiveInteger=PositiveInteger, SensorValue=SensorValue, sensName=sensName, infoAddressMAC=infoAddressMAC, IOName=IOName, sensUnit=sensUnit, OutputType=OutputType, tsAlarmTable=tsAlarmTable, inpName=inpName, sensSetupEntry=sensSetupEntry, SensorID=SensorID, outValue=outValue)
