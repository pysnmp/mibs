...
ModuleIdentity, Gauge32, Counter64, Unsigned32, Counter32, Bits, IpAddress, enterprises, ObjectIdentity, NotificationType, MibIdentifier, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter64", "Unsigned32", "Counter32", "Bits", "IpAddress", "enterprises", "ObjectIdentity", "NotificationType", "MibIdentifier", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetup=sensSetup, sensID=sensID, tsAlarmTable=tsAlarmTable, outType=outType, tsAlarmEntry=tsAlarmEntry, sensSetupIndex=sensSetupIndex, sensUnitString=sensUnitString, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, sensFlags=sensFlags, inpValue=inpValue, inpIndex=inpIndex, PositiveInteger=PositiveInteger, OnOff=OnOff, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, UnitType=UnitType, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, tsAlarm=tsAlarm, sensName=sensName, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, sensString=sensString, inpAlarmState=inpAlarmState, outIndex=outIndex, inpName=inpName, SensorName=SensorName, tsAlarmTime=tsAlarmTime, info=info, sensLimitMin=sensLimitMin, tsAlarmId=tsAlarmId, sensTable=sensTable, sensState=sensState, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, IOName=IOName, inpTable=inpTable, OutputType=OutputType, hwgroup=hwgroup, outTable=outTable, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, outValue=outValue, poseidon=poseidon, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, sensIndex=sensIndex, InputAlarmState=InputAlarmState, charonII=charonII, unitType=unitType, outMode=outMode, sensValue=sensValue, sensLimitMax=sensLimitMax, SensorState=SensorState, inpAlarmSetup=inpAlarmSetup, SensorID=SensorID, inpEntry=inpEntry, SensorValue=SensorValue, setup=setup, sensSetupEntry=sensSetupEntry, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, sensHysteresis=sensHysteresis, outName=outName)
