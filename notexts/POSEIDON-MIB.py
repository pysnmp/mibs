...
MibIdentifier, Bits, Counter64, Gauge32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, ObjectIdentity, enterprises, TimeTicks, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter64", "Gauge32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity", "enterprises", "TimeTicks", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupName=sensSetupName, hwgroup=hwgroup, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, IOName=IOName, sensSetupTable=sensSetupTable, InputAlarmSetup=InputAlarmSetup, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, outValue=outValue, inpValue=inpValue, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, inpTable=inpTable, sensUnitString=sensUnitString, SensorName=SensorName, poseidon=poseidon, SensorState=SensorState, outMode=outMode, TimeStamp=TimeStamp, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, outName=outName, OnOff=OnOff, sensString=sensString, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, UnitType=UnitType, inpEntry=inpEntry, sensValue=sensValue, sensFlags=sensFlags, SensorValue=SensorValue, SensorFlags=SensorFlags, tsAlarmsPresent=tsAlarmsPresent, setup=setup, sensState=sensState, unitType=unitType, InputAlarmState=InputAlarmState, SensorID=SensorID, SensorString=SensorString, outIndex=outIndex, outType=outType, outTable=outTable, sensUnit=sensUnit, sensHysteresis=sensHysteresis, charonII=charonII, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmState=inpAlarmState, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, sensName=sensName, sensID=sensID, PositiveInteger=PositiveInteger, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, SensorUnitString=SensorUnitString, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, inpName=inpName, info=info, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, OutputType=OutputType, sensTable=sensTable)
