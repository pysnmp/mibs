...
Integer32, ModuleIdentity, iso, Bits, Unsigned32, ObjectIdentity, IpAddress, Gauge32, Counter64, MibIdentifier, TimeTicks, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress", "Gauge32", "Counter64", "MibIdentifier", "TimeTicks", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensAlarmStateChanged=sensAlarmStateChanged, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, SensorState=SensorState, outIndex=outIndex, sensUnitString=sensUnitString, infoAddressMAC=infoAddressMAC, SensorID=SensorID, tsTrapAlarmStart=tsTrapAlarmStart, outValue=outValue, OutputType=OutputType, poseidon=poseidon, SensorValue=SensorValue, hwgroup=hwgroup, sensID=sensID, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, InputAlarmState=InputAlarmState, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, setup=setup, PositiveInteger=PositiveInteger, tsAlarmTable=tsAlarmTable, outTable=outTable, tsAlarmTime=tsAlarmTime, sensTable=sensTable, sensSetupTable=sensSetupTable, sensString=sensString, outName=outName, OutputMode=OutputMode, TimeStamp=TimeStamp, sensLimitMax=sensLimitMax, sensValue=sensValue, sensEntry=sensEntry, outType=outType, tsAlarmId=tsAlarmId, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, sensName=sensName, InputAlarmSetup=InputAlarmSetup, unitType=unitType, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, inpIndex=inpIndex, OnOff=OnOff, UnitType=UnitType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, SensorUnitString=SensorUnitString, charonII=charonII, SensorName=SensorName, inpAlarmState=inpAlarmState, outMode=outMode, sensSetup=sensSetup, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, sensState=sensState, SensorString=SensorString, SensorFlags=SensorFlags, inpTable=inpTable, inpValue=inpValue, inpName=inpName, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, info=info, inpEntry=inpEntry, sensHysteresis=sensHysteresis)
