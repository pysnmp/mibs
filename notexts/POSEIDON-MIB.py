...
Gauge32, MibIdentifier, iso, Integer32, ModuleIdentity, enterprises, Bits, IpAddress, TimeTicks, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "enterprises", "Bits", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTime=tsAlarmTime, TimeStamp=TimeStamp, PositiveInteger=PositiveInteger, info=info, outValue=outValue, SensorState=SensorState, outTable=outTable, outName=outName, inpEntry=inpEntry, unitType=unitType, sensSetupEntry=sensSetupEntry, InputAlarmState=InputAlarmState, OutputType=OutputType, inpAlarmState=inpAlarmState, sensName=sensName, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, IOName=IOName, SensorFlags=SensorFlags, poseidon=poseidon, UnitType=UnitType, inpValue=inpValue, SensorUnitString=SensorUnitString, OnOff=OnOff, tsAlarmId=tsAlarmId, sensState=sensState, inpName=inpName, sensTable=sensTable, outEntry=outEntry, sensValue=sensValue, setup=setup, outMode=outMode, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensFlags=sensFlags, inpTable=inpTable, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, sensLimitMin=sensLimitMin, SensorName=SensorName, tsAlarm=tsAlarm, sensString=sensString, sensValueRaw=sensValueRaw, sensID=sensID, tsTrapAlarmEnd=tsTrapAlarmEnd, sensLimitMax=sensLimitMax, sensEntry=sensEntry, sensUnit=sensUnit, hwgroup=hwgroup, sensSetup=sensSetup, outIndex=outIndex)
