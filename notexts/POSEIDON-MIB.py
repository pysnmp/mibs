...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, outTable=outTable, sensName=sensName, poseidon=poseidon, inpAlarmState=inpAlarmState, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent, outMode=outMode, sensSetupTable=sensSetupTable, tsAlarmIdx=tsAlarmIdx, OutputType=OutputType, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, IOName=IOName, tsAlarmDescr=tsAlarmDescr, inpEntry=inpEntry, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, sensSetupEntry=sensSetupEntry, unitType=unitType, sensUnit=sensUnit, charonII=charonII, SensorUnitString=SensorUnitString, sensSetup=sensSetup, sensString=sensString, sensTable=sensTable, inpTable=inpTable, tsAlarmId=tsAlarmId, outValue=outValue, sensValueRaw=sensValueRaw, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, OnOff=OnOff, sensSetupIndex=sensSetupIndex, sensUnitString=sensUnitString, setup=setup, outName=outName, sensEntry=sensEntry, InputAlarmSetup=InputAlarmSetup, UnitType=UnitType, InputAlarmState=InputAlarmState, sensID=sensID, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, SensorID=SensorID, SensorName=SensorName, inpValue=inpValue, PositiveInteger=PositiveInteger, OutputMode=OutputMode, sensState=sensState, tsAlarm=tsAlarm, inpName=inpName, outEntry=outEntry, outIndex=outIndex, infoAddressMAC=infoAddressMAC, SensorState=SensorState, sensIndex=sensIndex, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, sensValue=sensValue, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, info=info)
