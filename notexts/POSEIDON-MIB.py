...
Unsigned32, ModuleIdentity, Bits, TimeTicks, IpAddress, MibIdentifier, Counter64, ObjectIdentity, Gauge32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64", "ObjectIdentity", "Gauge32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, sensID=sensID, sensIndex=sensIndex, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, info=info, sensSetupName=sensSetupName, OnOff=OnOff, sensHysteresis=sensHysteresis, IOName=IOName, tsAlarmId=tsAlarmId, sensTable=sensTable, inpName=inpName, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, inpTable=inpTable, sensValueRaw=sensValueRaw, outName=outName, inpAlarmState=inpAlarmState, SensorValue=SensorValue, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, sensFlags=sensFlags, outMode=outMode, SensorString=SensorString, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, tsAlarmEntry=tsAlarmEntry, outIndex=outIndex, sensSetupEntry=sensSetupEntry, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, OutputMode=OutputMode, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, OutputType=OutputType, PositiveInteger=PositiveInteger, outValue=outValue, charonII=charonII, SensorID=SensorID, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, sensEntry=sensEntry, setup=setup, SensorName=SensorName, SensorState=SensorState, outEntry=outEntry, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, poseidon=poseidon, inpIndex=inpIndex, sensName=sensName, outTable=outTable, sensLimitMin=sensLimitMin, sensValue=sensValue, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, sensString=sensString, sensSetup=sensSetup, UnitType=UnitType, unitType=unitType, infoAddressMAC=infoAddressMAC, tsAlarmSensName=tsAlarmSensName, outType=outType)
