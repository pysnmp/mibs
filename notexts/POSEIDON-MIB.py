...
Integer32, ModuleIdentity, enterprises, NotificationType, IpAddress, Unsigned32, Counter32, Bits, Counter64, ObjectIdentity, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "enterprises", "NotificationType", "IpAddress", "Unsigned32", "Counter32", "Bits", "Counter64", "ObjectIdentity", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorUnitString=SensorUnitString, OutputMode=OutputMode, outIndex=outIndex, tsAlarmTime=tsAlarmTime, poseidon=poseidon, sensHysteresis=sensHysteresis, sensID=sensID, sensTable=sensTable, IOName=IOName, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, sensIndex=sensIndex, SensorString=SensorString, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, tsAlarmEntry=tsAlarmEntry, SensorFlags=SensorFlags, inpName=inpName, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, sensLimitMax=sensLimitMax, inpIndex=inpIndex, outEntry=outEntry, UnitType=UnitType, TimeStamp=TimeStamp, sensFlags=sensFlags, sensEntry=sensEntry, info=info, hwgroup=hwgroup, unitType=unitType, inpTable=inpTable, SensorName=SensorName, outValue=outValue, charonII=charonII, sensSetup=sensSetup, setup=setup, outMode=outMode, OnOff=OnOff, sensUnit=sensUnit, OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, outName=outName, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, sensValueRaw=sensValueRaw, InputAlarmState=InputAlarmState, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, inpEntry=inpEntry, SensorID=SensorID, inpValue=inpValue, outTable=outTable, sensSetupName=sensSetupName, tsAlarmId=tsAlarmId, sensString=sensString, inpAlarmState=inpAlarmState, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, PositiveInteger=PositiveInteger, inpAlarmStateChanged=inpAlarmStateChanged)
