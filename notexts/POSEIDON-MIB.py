...
enterprises, NotificationType, MibIdentifier, Gauge32, Integer32, Bits, Counter64, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, iso, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibIdentifier", "Gauge32", "Integer32", "Bits", "Counter64", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "iso", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValueRaw=sensValueRaw, outName=outName, sensLimitMin=sensLimitMin, unitType=unitType, inpAlarmState=inpAlarmState, outMode=outMode, SensorFlags=SensorFlags, outType=outType, tsAlarmId=tsAlarmId, IOName=IOName, OnOff=OnOff, charonII=charonII, tsAlarm=tsAlarm, sensSetupEntry=sensSetupEntry, outEntry=outEntry, sensTable=sensTable, sensUnit=sensUnit, poseidon=poseidon, tsAlarmDescr=tsAlarmDescr, UnitType=UnitType, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, sensAlarmStateChanged=sensAlarmStateChanged, sensFlags=sensFlags, OutputType=OutputType, setup=setup, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensString=sensString, outTable=outTable, OutputMode=OutputMode, sensSetupTable=sensSetupTable, SensorState=SensorState, outIndex=outIndex, hwgroup=hwgroup, inpIndex=inpIndex, inpValue=inpValue, outValue=outValue, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, info=info, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, inpTable=inpTable, inpName=inpName, sensValue=sensValue, SensorID=SensorID, inpEntry=inpEntry, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, sensID=sensID, SensorValue=SensorValue, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, sensSetup=sensSetup, sensName=sensName, sensSetupIndex=sensSetupIndex, SensorString=SensorString, tsAlarmTable=tsAlarmTable, sensState=sensState, SensorName=SensorName, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, sensIndex=sensIndex)
