...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Integer32, ObjectIdentity, TimeTicks, NotificationType, Unsigned32, IpAddress, ModuleIdentity, Counter32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "NotificationType", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, sensID=sensID, sensValueRaw=sensValueRaw, inpAlarmSetup=inpAlarmSetup, OnOff=OnOff, inpTable=inpTable, outName=outName, tsAlarm=tsAlarm, UnitType=UnitType, SensorID=SensorID, IOName=IOName, outEntry=outEntry, sensString=sensString, sensUnitString=sensUnitString, outValue=outValue, SensorName=SensorName, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, inpValue=inpValue, sensLimitMax=sensLimitMax, info=info, unitType=unitType, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, inpIndex=inpIndex, sensSetupTable=sensSetupTable, InputAlarmSetup=InputAlarmSetup, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, sensName=sensName, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, charonII=charonII, tsAlarmSensName=tsAlarmSensName, tsAlarmIdx=tsAlarmIdx, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, outIndex=outIndex, OutputType=OutputType, sensTable=sensTable, OutputMode=OutputMode, sensIndex=sensIndex, sensSetup=sensSetup, sensFlags=sensFlags, TimeStamp=TimeStamp, sensValue=sensValue, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, SensorUnitString=SensorUnitString, SensorValue=SensorValue, SensorFlags=SensorFlags, inpEntry=inpEntry, outType=outType, sensSetupName=sensSetupName, outTable=outTable, sensEntry=sensEntry, sensState=sensState, sensHysteresis=sensHysteresis, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, inpAlarmState=inpAlarmState, tsAlarmId=tsAlarmId, inpName=inpName, SensorState=SensorState, sensLimitMin=sensLimitMin)
