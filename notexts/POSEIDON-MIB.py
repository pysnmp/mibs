...
Counter64, TimeTicks, NotificationType, enterprises, Gauge32, iso, MibIdentifier, Bits, Counter32, ModuleIdentity, Unsigned32, ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "NotificationType", "enterprises", "Gauge32", "iso", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", charonII=charonII, inpName=inpName, outMode=outMode, infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorFlags=SensorFlags, inpIndex=inpIndex, outTable=outTable, OnOff=OnOff, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, outType=outType, outIndex=outIndex, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, sensIndex=sensIndex, SensorString=SensorString, sensID=sensID, tsAlarm=tsAlarm, SensorValue=SensorValue, sensString=sensString, sensLimitMin=sensLimitMin, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, tsAlarmDescr=tsAlarmDescr, inpAlarmStateChanged=inpAlarmStateChanged, outEntry=outEntry, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, outValue=outValue, outName=outName, info=info, unitType=unitType, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName, tsAlarmsPresent=tsAlarmsPresent, IOName=IOName, SensorUnitString=SensorUnitString, sensUnit=sensUnit, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, sensValue=sensValue, OutputType=OutputType, sensSetupTable=sensSetupTable, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, sensSetup=sensSetup, hwgroup=hwgroup, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, setup=setup, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, inpAlarmSetup=inpAlarmSetup, inpValue=inpValue, inpTable=inpTable, tsAlarmTable=tsAlarmTable, SensorID=SensorID, TimeStamp=TimeStamp, sensEntry=sensEntry, sensTable=sensTable, sensState=sensState, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, OutputMode=OutputMode, InputAlarmState=InputAlarmState, sensSetupEntry=sensSetupEntry, sensName=sensName)
