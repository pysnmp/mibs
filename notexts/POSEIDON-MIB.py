...
Integer32, NotificationType, ObjectIdentity, TimeTicks, Gauge32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Bits, iso, IpAddress, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Bits", "iso", "IpAddress", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, inpName=inpName, unitType=unitType, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmId=tsAlarmId, SensorValue=SensorValue, SensorUnitString=SensorUnitString, sensState=sensState, tsAlarmTime=tsAlarmTime, SensorID=SensorID, outMode=outMode, outEntry=outEntry, info=info, sensValue=sensValue, sensFlags=sensFlags, sensTable=sensTable, SensorString=SensorString, sensIndex=sensIndex, SensorFlags=SensorFlags, outType=outType, outName=outName, tsAlarm=tsAlarm, SensorState=SensorState, inpValue=inpValue, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, setup=setup, tsTrapAlarmEnd=tsTrapAlarmEnd, UnitType=UnitType, charonII=charonII, inpIndex=inpIndex, sensString=sensString, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, OnOff=OnOff, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, hwgroup=hwgroup, outValue=outValue, tsAlarmEntry=tsAlarmEntry, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, sensLimitMax=sensLimitMax, IOName=IOName, PositiveInteger=PositiveInteger, OutputType=OutputType, TimeStamp=TimeStamp, outIndex=outIndex, InputAlarmState=InputAlarmState, sensID=sensID, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, infoAddressMAC=infoAddressMAC, inpTable=inpTable, sensSetup=sensSetup, tsAlarmDescr=tsAlarmDescr, poseidon=poseidon, sensUnit=sensUnit, SensorName=SensorName, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, OutputMode=OutputMode, inpAlarmState=inpAlarmState, inpEntry=inpEntry, sensAlarmStateChanged=sensAlarmStateChanged)
