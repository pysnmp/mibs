...
enterprises, ObjectIdentity, Gauge32, TimeTicks, ModuleIdentity, Counter64, NotificationType, Counter32, Bits, Integer32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "NotificationType", "Counter32", "Bits", "Integer32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, inpAlarmSetup=inpAlarmSetup, inpValue=inpValue, sensName=sensName, charonII=charonII, info=info, outMode=outMode, inpAlarmState=inpAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, tsAlarmIdx=tsAlarmIdx, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupTable=sensSetupTable, sensIndex=sensIndex, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, inpTable=inpTable, sensSetup=sensSetup, SensorValue=SensorValue, sensTable=sensTable, sensLimitMin=sensLimitMin, tsAlarmDescr=tsAlarmDescr, hwgroup=hwgroup, tsAlarmSensName=tsAlarmSensName, InputAlarmSetup=InputAlarmSetup, sensFlags=sensFlags, OnOff=OnOff, sensUnitString=sensUnitString, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, sensString=sensString, outValue=outValue, inpName=inpName, sensHysteresis=sensHysteresis, outIndex=outIndex, poseidon=poseidon, UnitType=UnitType, SensorUnitString=SensorUnitString, setup=setup, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, SensorState=SensorState, TimeStamp=TimeStamp, unitType=unitType, sensID=sensID, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, sensSetupIndex=sensSetupIndex, sensEntry=sensEntry, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, OutputMode=OutputMode, sensValue=sensValue, sensUnit=sensUnit, tsAlarmId=tsAlarmId, outName=outName, SensorID=SensorID, sensSetupEntry=sensSetupEntry, OutputType=OutputType, outEntry=outEntry)
