...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Gauge32, TimeTicks, ModuleIdentity, Unsigned32, Counter64, Bits, MibIdentifier, IpAddress, Integer32, NotificationType, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Gauge32", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter64", "Bits", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "iso", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, OutputType=OutputType, sensUnitString=sensUnitString, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmState=inpAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, sensID=sensID, sensLimitMin=sensLimitMin, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, outIndex=outIndex, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, hwgroup=hwgroup, SensorID=SensorID, sensString=sensString, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, SensorState=SensorState, setup=setup, inpName=inpName, info=info, TimeStamp=TimeStamp, outValue=outValue, outMode=outMode, sensValueRaw=sensValueRaw, SensorString=SensorString, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, unitType=unitType, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, sensIndex=sensIndex, outName=outName, infoAddressMAC=infoAddressMAC, SensorName=SensorName, outEntry=outEntry, tsAlarm=tsAlarm, tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, poseidon=poseidon, SensorValue=SensorValue, inpIndex=inpIndex, sensLimitMax=sensLimitMax, charonII=charonII, outTable=outTable, IOName=IOName, sensName=sensName, sensUnit=sensUnit, tsAlarmId=tsAlarmId, outType=outType, tsAlarmSensName=tsAlarmSensName, sensTable=sensTable, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, OnOff=OnOff, sensSetupIndex=sensSetupIndex, tsAlarmEntry=tsAlarmEntry, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, sensState=sensState)
