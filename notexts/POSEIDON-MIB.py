...
Gauge32, Integer32, Bits, iso, Counter32, ModuleIdentity, Counter64, TimeTicks, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Bits", "iso", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, sensLimitMin=sensLimitMin, IOName=IOName, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, sensID=sensID, inpTable=inpTable, outIndex=outIndex, sensEntry=sensEntry, inpName=inpName, SensorID=SensorID, InputAlarmState=InputAlarmState, OutputMode=OutputMode, OutputType=OutputType, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw, tsAlarmIdx=tsAlarmIdx, outType=outType, setup=setup, charonII=charonII, tsAlarm=tsAlarm, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, SensorValue=SensorValue, sensName=sensName, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, sensFlags=sensFlags, SensorState=SensorState, info=info, outName=outName, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, OnOff=OnOff, outTable=outTable, outEntry=outEntry, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, sensState=sensState, SensorFlags=SensorFlags, inpValue=inpValue, outValue=outValue, sensString=sensString, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, unitType=unitType, PositiveInteger=PositiveInteger, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, sensUnitString=sensUnitString, inpEntry=inpEntry, sensValue=sensValue, sensSetupEntry=sensSetupEntry, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName)
