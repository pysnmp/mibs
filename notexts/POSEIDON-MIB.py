...
Counter64, MibIdentifier, iso, Counter32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, ObjectIdentity, Bits, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "iso", "Counter32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "ObjectIdentity", "Bits", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, outIndex=outIndex, sensUnitString=sensUnitString, sensTable=sensTable, tsAlarmTime=tsAlarmTime, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensState=sensState, sensString=sensString, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, unitType=unitType, inpAlarmState=inpAlarmState, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, sensFlags=sensFlags, SensorID=SensorID, setup=setup, inpValue=inpValue, outEntry=outEntry, sensUnit=sensUnit, sensSetupIndex=sensSetupIndex, inpName=inpName, outType=outType, OutputType=OutputType, inpIndex=inpIndex, hwgroup=hwgroup, sensSetupTable=sensSetupTable, IOName=IOName, tsAlarmDescr=tsAlarmDescr, SensorValue=SensorValue, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, sensIndex=sensIndex, sensName=sensName, sensAlarmStateChanged=sensAlarmStateChanged, OnOff=OnOff, SensorUnitString=SensorUnitString, inpTable=inpTable, PositiveInteger=PositiveInteger, sensValue=sensValue, OutputMode=OutputMode, SensorString=SensorString, outTable=outTable, sensEntry=sensEntry, inpEntry=inpEntry, sensSetupName=sensSetupName, sensSetupEntry=sensSetupEntry, outValue=outValue, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, UnitType=UnitType, outMode=outMode, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, poseidon=poseidon, info=info, sensID=sensID, SensorFlags=SensorFlags, tsAlarm=tsAlarm, inpAlarmStateChanged=inpAlarmStateChanged)
