...
Gauge32, enterprises, Integer32, MibIdentifier, IpAddress, TimeTicks, Counter32, NotificationType, ObjectIdentity, Bits, Counter64, ModuleIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Integer32", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "ObjectIdentity", "Bits", "Counter64", "ModuleIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, SensorState=SensorState, OutputMode=OutputMode, SensorUnitString=SensorUnitString, OnOff=OnOff, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, SensorValue=SensorValue, SensorString=SensorString, sensID=sensID, sensUnitString=sensUnitString, setup=setup, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensIndex=sensIndex, outValue=outValue, info=info, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, sensString=sensString, sensState=sensState, sensSetupEntry=sensSetupEntry, IOName=IOName, unitType=unitType, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, SensorID=SensorID, outIndex=outIndex, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, sensTable=sensTable, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, inpEntry=inpEntry, outName=outName, inpIndex=inpIndex, hwgroup=hwgroup, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputType=OutputType, sensSetup=sensSetup, poseidon=poseidon, inpName=inpName, sensFlags=sensFlags, TimeStamp=TimeStamp, outMode=outMode, sensValue=sensValue, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, inpValue=inpValue, SensorName=SensorName, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, outType=outType, tsAlarmTime=tsAlarmTime, outTable=outTable, tsAlarmDescr=tsAlarmDescr, sensUnit=sensUnit, sensSetupIndex=sensSetupIndex, charonII=charonII)
