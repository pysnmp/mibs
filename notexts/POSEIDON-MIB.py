...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, MibIdentifier, Bits, Counter64, iso, Unsigned32, enterprises, Gauge32, NotificationType, ModuleIdentity, TimeTicks, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "MibIdentifier", "Bits", "Counter64", "iso", "Unsigned32", "enterprises", "Gauge32", "NotificationType", "ModuleIdentity", "TimeTicks", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputType=OutputType, inpAlarmSetup=inpAlarmSetup, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, inpName=inpName, outTable=outTable, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensSetupIndex=sensSetupIndex, tsAlarmId=tsAlarmId, sensValueRaw=sensValueRaw, setup=setup, sensString=sensString, unitType=unitType, outName=outName, info=info, sensFlags=sensFlags, sensTable=sensTable, sensSetupTable=sensSetupTable, outValue=outValue, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, sensSetupEntry=sensSetupEntry, inpIndex=inpIndex, sensName=sensName, sensUnitString=sensUnitString, IOName=IOName, outEntry=outEntry, outMode=outMode, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmEnd=tsTrapAlarmEnd, outIndex=outIndex, OnOff=OnOff, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, poseidon=poseidon, sensSetupName=sensSetupName, sensEntry=sensEntry, sensSetup=sensSetup, sensUnit=sensUnit, SensorFlags=SensorFlags, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, charonII=charonII, sensValue=sensValue, SensorValue=SensorValue, SensorUnitString=SensorUnitString, TimeStamp=TimeStamp, inpValue=inpValue, inpAlarmState=inpAlarmState, sensState=sensState, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, sensIndex=sensIndex, inpTable=inpTable, outType=outType, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, tsAlarmsPresent=tsAlarmsPresent, PositiveInteger=PositiveInteger, SensorState=SensorState, UnitType=UnitType, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode)
