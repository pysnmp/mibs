...
mibBuilder.exportSymbols("POSEIDON-MIB", IOName=IOName, outType=outType, tsAlarmSensName=tsAlarmSensName, hwgroup=hwgroup, sensID=sensID, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, info=info, outTable=outTable, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, TimeStamp=TimeStamp, SensorState=SensorState, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensIndex=sensIndex, sensValue=sensValue, inpTable=inpTable, outMode=outMode, sensState=sensState, SensorName=SensorName, sensName=sensName, SensorValue=SensorValue, sensString=sensString, unitType=unitType, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, tsAlarmIdx=tsAlarmIdx, inpEntry=inpEntry, outName=outName, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, setup=setup, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, OnOff=OnOff, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, SensorFlags=SensorFlags, inpValue=inpValue, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, InputAlarmState=InputAlarmState, inpName=inpName, sensEntry=sensEntry, sensUnit=sensUnit, outIndex=outIndex, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, charonII=charonII, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, sensTable=sensTable, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, tsAlarmTime=tsAlarmTime, OutputType=OutputType, tsAlarmsPresent=tsAlarmsPresent, tsAlarm=tsAlarm, poseidon=poseidon, sensLimitMax=sensLimitMax)
