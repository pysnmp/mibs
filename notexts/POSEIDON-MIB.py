...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Unsigned32, ModuleIdentity, Counter64, Gauge32, Integer32, iso, TimeTicks, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Unsigned32", "ModuleIdentity", "Counter64", "Gauge32", "Integer32", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, SensorValue=SensorValue, inpEntry=inpEntry, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw, SensorID=SensorID, SensorName=SensorName, outTable=outTable, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, outType=outType, inpIndex=inpIndex, sensEntry=sensEntry, OutputMode=OutputMode, sensTable=sensTable, InputAlarmSetup=InputAlarmSetup, outValue=outValue, outName=outName, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, sensName=sensName, sensString=sensString, IOName=IOName, sensValue=sensValue, tsAlarmId=tsAlarmId, sensID=sensID, tsAlarmTable=tsAlarmTable, sensHysteresis=sensHysteresis, tsAlarm=tsAlarm, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, outEntry=outEntry, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, sensIndex=sensIndex, inpValue=inpValue, tsAlarmTime=tsAlarmTime, outIndex=outIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, inpTable=inpTable, unitType=unitType, outMode=outMode, infoAddressMAC=infoAddressMAC, SensorString=SensorString, poseidon=poseidon, setup=setup, inpAlarmState=inpAlarmState, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, sensSetup=sensSetup, sensSetupName=sensSetupName, sensUnit=sensUnit, sensLimitMax=sensLimitMax, OutputType=OutputType, info=info, tsAlarmIdx=tsAlarmIdx, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, OnOff=OnOff, PositiveInteger=PositiveInteger, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, charonII=charonII, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, inpName=inpName)
