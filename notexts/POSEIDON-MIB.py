...
NotificationType, Gauge32, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, Counter64, Integer32, Counter32, TimeTicks, IpAddress, MibIdentifier, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "Integer32", "Counter32", "TimeTicks", "IpAddress", "MibIdentifier", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outValue=outValue, tsAlarmSensName=tsAlarmSensName, inpIndex=inpIndex, outMode=outMode, sensEntry=sensEntry, outEntry=outEntry, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, InputAlarmSetup=InputAlarmSetup, OnOff=OnOff, setup=setup, SensorState=SensorState, poseidon=poseidon, sensValueRaw=sensValueRaw, sensName=sensName, info=info, sensValue=sensValue, IOName=IOName, SensorName=SensorName, tsAlarmTime=tsAlarmTime, outIndex=outIndex, sensSetupEntry=sensSetupEntry, SensorValue=SensorValue, tsAlarmId=tsAlarmId, unitType=unitType, SensorUnitString=SensorUnitString, sensAlarmStateChanged=sensAlarmStateChanged, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, sensHysteresis=sensHysteresis, outType=outType, sensUnit=sensUnit, inpValue=inpValue, charonII=charonII, OutputType=OutputType, outTable=outTable, sensTable=sensTable, inpTable=inpTable, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, outName=outName, sensID=sensID, inpName=inpName, PositiveInteger=PositiveInteger, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, sensState=sensState, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, UnitType=UnitType, hwgroup=hwgroup, sensSetupIndex=sensSetupIndex, sensSetupTable=sensSetupTable, SensorID=SensorID, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMax=sensLimitMax, sensSetup=sensSetup, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, SensorString=SensorString, OutputMode=OutputMode)
