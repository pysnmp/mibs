...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Integer32, NotificationType, Gauge32, iso, IpAddress, Bits, TimeTicks, Counter32, Counter64, ObjectIdentity, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Integer32", "NotificationType", "Gauge32", "iso", "IpAddress", "Bits", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, inpAlarmState=inpAlarmState, sensEntry=sensEntry, sensTable=sensTable, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, IOName=IOName, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, SensorFlags=SensorFlags, setup=setup, sensSetup=sensSetup, OutputType=OutputType, charonII=charonII, sensState=sensState, sensSetupName=sensSetupName, SensorName=SensorName, sensID=sensID, UnitType=UnitType, poseidon=poseidon, sensString=sensString, tsAlarmTable=tsAlarmTable, outName=outName, outType=outType, sensSetupIndex=sensSetupIndex, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, sensValue=sensValue, tsAlarm=tsAlarm, sensUnit=sensUnit, hwgroup=hwgroup, sensFlags=sensFlags, InputAlarmState=InputAlarmState, inpIndex=inpIndex, outEntry=outEntry, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, inpValue=inpValue, inpEntry=inpEntry, SensorValue=SensorValue, sensValueRaw=sensValueRaw, OutputMode=OutputMode, unitType=unitType, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmSetup=InputAlarmSetup, SensorUnitString=SensorUnitString, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, outIndex=outIndex, outMode=outMode, info=info, sensIndex=sensIndex, SensorString=SensorString, sensName=sensName, infoAddressMAC=infoAddressMAC, OnOff=OnOff, outValue=outValue, inpName=inpName, SensorState=SensorState, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, inpTable=inpTable, outTable=outTable, sensHysteresis=sensHysteresis)
