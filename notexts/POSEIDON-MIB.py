...
ModuleIdentity, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, Integer32, Counter32, enterprises, Gauge32, ObjectIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "Integer32", "Counter32", "enterprises", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, inpName=inpName, tsAlarmIdx=tsAlarmIdx, setup=setup, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, poseidon=poseidon, tsAlarmTime=tsAlarmTime, unitType=unitType, outValue=outValue, SensorState=SensorState, OutputMode=OutputMode, sensTable=sensTable, outIndex=outIndex, sensIndex=sensIndex, UnitType=UnitType, outMode=outMode, inpTable=inpTable, sensID=sensID, inpAlarmState=inpAlarmState, inpEntry=inpEntry, SensorName=SensorName, InputAlarmSetup=InputAlarmSetup, outEntry=outEntry, SensorUnitString=SensorUnitString, OutputType=OutputType, sensSetup=sensSetup, tsAlarm=tsAlarm, inpAlarmSetup=inpAlarmSetup, hwgroup=hwgroup, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, IOName=IOName, outTable=outTable, sensState=sensState, sensSetupName=sensSetupName, sensName=sensName, SensorID=SensorID, sensLimitMin=sensLimitMin, inpValue=inpValue, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, TimeStamp=TimeStamp, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, OnOff=OnOff, outName=outName, charonII=charonII, SensorFlags=SensorFlags, sensString=sensString, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, InputAlarmState=InputAlarmState, SensorString=SensorString, tsAlarmsPresent=tsAlarmsPresent, sensValue=sensValue, info=info, PositiveInteger=PositiveInteger)
