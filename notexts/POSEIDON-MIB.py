...
Counter64, IpAddress, iso, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, ObjectIdentity, enterprises, Counter32, TimeTicks, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "iso", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter32", "TimeTicks", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorFlags=SensorFlags, tsAlarmTime=tsAlarmTime, inpIndex=inpIndex, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, charonII=charonII, hwgroup=hwgroup, info=info, inpAlarmSetup=inpAlarmSetup, sensHysteresis=sensHysteresis, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarm=tsAlarm, sensIndex=sensIndex, sensValue=sensValue, unitType=unitType, SensorID=SensorID, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, outEntry=outEntry, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, outType=outType, SensorUnitString=SensorUnitString, infoAddressMAC=infoAddressMAC, OnOff=OnOff, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, SensorString=SensorString, OutputMode=OutputMode, inpTable=inpTable, inpAlarmState=inpAlarmState, outName=outName, tsAlarmEntry=tsAlarmEntry, sensUnit=sensUnit, sensName=sensName, PositiveInteger=PositiveInteger, poseidon=poseidon, inpValue=inpValue, SensorValue=SensorValue, SensorName=SensorName, outValue=outValue, outIndex=outIndex, tsAlarmId=tsAlarmId, sensSetup=sensSetup, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, InputAlarmState=InputAlarmState, OutputType=OutputType, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, SensorState=SensorState, sensState=sensState, sensSetupName=sensSetupName, setup=setup, TimeStamp=TimeStamp, sensID=sensID, inpName=inpName, sensSetupIndex=sensSetupIndex, sensString=sensString, outTable=outTable, outMode=outMode, UnitType=UnitType, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, sensUnitString=sensUnitString)
