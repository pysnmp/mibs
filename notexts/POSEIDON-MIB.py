...
ModuleIdentity, Unsigned32, TimeTicks, Gauge32, MibIdentifier, Bits, enterprises, NotificationType, iso, ObjectIdentity, IpAddress, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "MibIdentifier", "Bits", "enterprises", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, inpValue=inpValue, info=info, setup=setup, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, charonII=charonII, sensString=sensString, tsAlarmEntry=tsAlarmEntry, unitType=unitType, hwgroup=hwgroup, sensSetupTable=sensSetupTable, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, tsAlarmTime=tsAlarmTime, PositiveInteger=PositiveInteger, IOName=IOName, infoAddressMAC=infoAddressMAC, OnOff=OnOff, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensID=sensID, tsAlarmTable=tsAlarmTable, SensorState=SensorState, UnitType=UnitType, sensTable=sensTable, sensIndex=sensIndex, tsAlarmDescr=tsAlarmDescr, inpAlarmStateChanged=inpAlarmStateChanged, sensValue=sensValue, sensSetupEntry=sensSetupEntry, sensSetup=sensSetup, sensUnit=sensUnit, sensUnitString=sensUnitString, sensValueRaw=sensValueRaw, outName=outName, sensHysteresis=sensHysteresis, inpTable=inpTable, SensorID=SensorID, sensName=sensName, sensSetupIndex=sensSetupIndex, poseidon=poseidon, outValue=outValue, outType=outType, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, inpName=inpName, sensFlags=sensFlags, inpEntry=inpEntry, OutputType=OutputType, tsAlarmId=tsAlarmId, SensorUnitString=SensorUnitString, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, outIndex=outIndex, OutputMode=OutputMode, SensorValue=SensorValue, SensorString=SensorString, sensLimitMax=sensLimitMax, sensSetupName=sensSetupName, outTable=outTable, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, SensorName=SensorName, outMode=outMode, InputAlarmState=InputAlarmState, outEntry=outEntry)
