...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, SensorString=SensorString, sensID=sensID, UnitType=UnitType, tsAlarmsPresent=tsAlarmsPresent, outMode=outMode, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensUnitString=sensUnitString, sensTable=sensTable, SensorID=SensorID, SensorFlags=SensorFlags, setup=setup, inpIndex=inpIndex, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarm=tsAlarm, info=info, inpName=inpName, tsAlarmIdx=tsAlarmIdx, inpValue=inpValue, sensValue=sensValue, inpEntry=inpEntry, tsAlarmEntry=tsAlarmEntry, PositiveInteger=PositiveInteger, charonII=charonII, outEntry=outEntry, sensName=sensName, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, SensorState=SensorState, inpAlarmSetup=inpAlarmSetup, outName=outName, sensValueRaw=sensValueRaw, tsAlarmId=tsAlarmId, sensUnit=sensUnit, unitType=unitType, outType=outType, poseidon=poseidon, sensEntry=sensEntry, OutputType=OutputType, OutputMode=OutputMode, sensIndex=sensIndex, SensorValue=SensorValue, sensSetupEntry=sensSetupEntry, sensFlags=sensFlags, outValue=outValue, InputAlarmState=InputAlarmState, sensString=sensString, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, outIndex=outIndex, sensState=sensState, IOName=IOName, sensLimitMin=sensLimitMin, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, OnOff=OnOff, SensorUnitString=SensorUnitString, TimeStamp=TimeStamp, outTable=outTable, inpAlarmState=inpAlarmState)
