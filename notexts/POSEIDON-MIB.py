...
MibIdentifier, enterprises, iso, ObjectIdentity, IpAddress, Counter32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, NotificationType, TimeTicks, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "iso", "ObjectIdentity", "IpAddress", "Counter32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, tsAlarmDescr=tsAlarmDescr, sensHysteresis=sensHysteresis, sensTable=sensTable, UnitType=UnitType, sensSetupEntry=sensSetupEntry, PositiveInteger=PositiveInteger, sensSetup=sensSetup, sensSetupTable=sensSetupTable, inpName=inpName, IOName=IOName, tsAlarmIdx=tsAlarmIdx, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, InputAlarmSetup=InputAlarmSetup, inpTable=inpTable, sensAlarmStateChanged=sensAlarmStateChanged, outValue=outValue, sensName=sensName, outEntry=outEntry, OutputMode=OutputMode, sensUnitString=sensUnitString, charonII=charonII, sensUnit=sensUnit, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, unitType=unitType, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, sensID=sensID, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, OutputType=OutputType, inpAlarmState=inpAlarmState, SensorFlags=SensorFlags, sensState=sensState, sensLimitMin=sensLimitMin, setup=setup, poseidon=poseidon, tsAlarm=tsAlarm, inpIndex=inpIndex, inpValue=inpValue, sensValue=sensValue, infoAddressMAC=infoAddressMAC, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, inpAlarmSetup=inpAlarmSetup, outType=outType, OnOff=OnOff, outMode=outMode, tsAlarmTable=tsAlarmTable, outTable=outTable, sensValueRaw=sensValueRaw, sensIndex=sensIndex, hwgroup=hwgroup, tsTrapAlarmEnd=tsTrapAlarmEnd, inpEntry=inpEntry, TimeStamp=TimeStamp, outName=outName, sensString=sensString, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, outIndex=outIndex, SensorID=SensorID, info=info, sensEntry=sensEntry, SensorName=SensorName)
