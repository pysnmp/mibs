...
Counter32, Counter64, IpAddress, Gauge32, ModuleIdentity, Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, ObjectIdentity, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "ObjectIdentity", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, sensIndex=sensIndex, OnOff=OnOff, OutputMode=OutputMode, sensValue=sensValue, tsAlarmsPresent=tsAlarmsPresent, tsAlarm=tsAlarm, SensorValue=SensorValue, sensSetupEntry=sensSetupEntry, infoAddressMAC=infoAddressMAC, tsAlarmEntry=tsAlarmEntry, IOName=IOName, setup=setup, inpEntry=inpEntry, inpAlarmState=inpAlarmState, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupName=sensSetupName, outType=outType, inpIndex=inpIndex, inpValue=inpValue, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, inpTable=inpTable, sensUnitString=sensUnitString, tsAlarmTable=tsAlarmTable, PositiveInteger=PositiveInteger, sensUnit=sensUnit, outMode=outMode, sensValueRaw=sensValueRaw, outIndex=outIndex, InputAlarmState=InputAlarmState, UnitType=UnitType, SensorName=SensorName, inpName=inpName, sensFlags=sensFlags, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, sensEntry=sensEntry, sensID=sensID, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorFlags=SensorFlags, outValue=outValue, tsAlarmDescr=tsAlarmDescr, sensHysteresis=sensHysteresis, unitType=unitType, sensString=sensString, tsAlarmSensName=tsAlarmSensName, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, poseidon=poseidon, SensorState=SensorState, sensState=sensState, tsAlarmId=tsAlarmId, hwgroup=hwgroup, inpAlarmSetup=inpAlarmSetup, charonII=charonII, outEntry=outEntry, TimeStamp=TimeStamp, sensName=sensName, outTable=outTable, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, info=info, sensSetup=sensSetup, SensorID=SensorID, sensTable=sensTable, InputAlarmSetup=InputAlarmSetup, outName=outName)
