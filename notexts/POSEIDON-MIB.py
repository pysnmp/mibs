...
Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, TimeTicks, ModuleIdentity, enterprises, iso, ObjectIdentity, Bits, Integer32, MibIdentifier, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "TimeTicks", "ModuleIdentity", "enterprises", "iso", "ObjectIdentity", "Bits", "Integer32", "MibIdentifier", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", charonII=charonII, inpName=inpName, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, inpValue=inpValue, sensEntry=sensEntry, sensUnit=sensUnit, UnitType=UnitType, inpEntry=inpEntry, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, OutputType=OutputType, outType=outType, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, OnOff=OnOff, sensFlags=sensFlags, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, sensSetupIndex=sensSetupIndex, SensorValue=SensorValue, outMode=outMode, SensorString=SensorString, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, sensTable=sensTable, SensorFlags=SensorFlags, outEntry=outEntry, outValue=outValue, sensString=sensString, tsAlarmIdx=tsAlarmIdx, setup=setup, infoAddressMAC=infoAddressMAC, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmState=inpAlarmState, inpIndex=inpIndex, SensorName=SensorName, inpAlarmStateChanged=inpAlarmStateChanged, sensUnitString=sensUnitString, PositiveInteger=PositiveInteger, inpAlarmSetup=inpAlarmSetup, SensorState=SensorState, OutputMode=OutputMode, inpTable=inpTable, outName=outName, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, sensState=sensState, sensValue=sensValue, sensLimitMax=sensLimitMax, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, sensName=sensName, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, info=info, IOName=IOName, outTable=outTable, sensSetup=sensSetup, SensorID=SensorID, sensID=sensID, poseidon=poseidon, outIndex=outIndex, InputAlarmState=InputAlarmState, sensLimitMin=sensLimitMin)
