...
ModuleIdentity, TimeTicks, iso, IpAddress, Unsigned32, Bits, Counter32, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, MibIdentifier, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "iso", "IpAddress", "Unsigned32", "Bits", "Counter32", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, SensorUnitString=SensorUnitString, sensString=sensString, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, SensorString=SensorString, sensIndex=sensIndex, SensorState=SensorState, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, outMode=outMode, IOName=IOName, SensorValue=SensorValue, tsAlarmIdx=tsAlarmIdx, outEntry=outEntry, outValue=outValue, outIndex=outIndex, sensSetup=sensSetup, outType=outType, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable, OutputType=OutputType, sensName=sensName, poseidon=poseidon, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, tsAlarm=tsAlarm, sensLimitMin=sensLimitMin, charonII=charonII, TimeStamp=TimeStamp, sensID=sensID, OutputMode=OutputMode, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, sensEntry=sensEntry, inpName=inpName, sensTable=sensTable, OnOff=OnOff, InputAlarmState=InputAlarmState, inpValue=inpValue, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, outTable=outTable, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, tsAlarmSensName=tsAlarmSensName, sensValue=sensValue, info=info, inpTable=inpTable, sensUnitString=sensUnitString, UnitType=UnitType, sensValueRaw=sensValueRaw, sensSetupIndex=sensSetupIndex, infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, setup=setup, outName=outName, SensorFlags=SensorFlags, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex)
