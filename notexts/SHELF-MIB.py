...
mibBuilder.exportSymbols("SHELF-MIB", EOWType=EOWType, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryEntry=softInventoryEntry, shelf=shelf, softInventoryBoard=softInventoryBoard, hardInv=hardInv, hardInventoryNumber=hardInventoryNumber, boardNumber=boardNumber, laserALSRestart90s=laserALSRestart90s, softInventoryTable=softInventoryTable, boardFirstPortIndex=boardFirstPortIndex, hardInventoryEntry=hardInventoryEntry, eowName=eowName, boardListNumber=boardListNumber, boardExpectFamily=boardExpectFamily, boardListTable=boardListTable, hardInventoryDescr=hardInventoryDescr, eowSrcPtr=eowSrcPtr, laserIndex=laserIndex, boardInsertFamily=boardInsertFamily, BoardFailure=BoardFailure, led=led, EOWClockMode=EOWClockMode, laser=laser, laserEntry=laserEntry, boardListType=boardListType, boardFailure=boardFailure, boardMissingSev=boardMissingSev, laserALSRestart2s=laserALSRestart2s, adrHotReset=adrHotReset, boardIndex=boardIndex, softInventoryNumber=softInventoryNumber, boardInsertType=boardInsertType, boardListIndex=boardListIndex, softInv=softInv, boardEntry=boardEntry, softInventoryCode=softInventoryCode, hardInventoryIndex=hardInventoryIndex, laserALSEnable=laserALSEnable, softInventoryType=softInventoryType, ProtectionType=ProtectionType, eowEntry=eowEntry, boardTable=boardTable, eowIndex=eowIndex, PYSNMP_MODULE_ID=shelf, laserTable=laserTable, ledPosition=ledPosition, ledType=ledType, boardExpectType=boardExpectType, eowClockMode=eowClockMode, LedType=LedType, eowSinkType=eowSinkType, ledEntry=ledEntry, boardDefectiveSev=boardDefectiveSev, ledIndex=ledIndex, holdTime=holdTime, ledStatus=ledStatus, eowTable=eowTable, boardList=boardList, hardInventoryBoard=hardInventoryBoard, softInventoryIndex=softInventoryIndex, softInventoryExt=softInventoryExt, HoldTime=HoldTime, laserNumber=laserNumber, hardInventoryTable=hardInventoryTable, ledNumber=ledNumber, boardListSlot=boardListSlot, boardListEntry=boardListEntry, eowSrcType=eowSrcType, boardProtectionType=boardProtectionType, boardSeverity=boardSeverity, boardActive=boardActive, eowSinkPtr=eowSinkPtr, boardSlotName=boardSlotName, laserTxEnable=laserTxEnable, eowNumber=eowNumber, boardMismatchSev=boardMismatchSev, boardMonitor=boardMonitor, ledTable=ledTable, adrFailHoldOnTime=adrFailHoldOnTime, board=board, LedStatus=LedStatus, eow=eow)
