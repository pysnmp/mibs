...
mibBuilder.exportSymbols("SHELF-MIB", laserTxEnable=laserTxEnable, boardEntry=boardEntry, EOWClockMode=EOWClockMode, eowSrcType=eowSrcType, led=led, boardFailure=boardFailure, boardActive=boardActive, boardListSlot=boardListSlot, eowEntry=eowEntry, boardProtectionType=boardProtectionType, ledType=ledType, hardInventoryEntry=hardInventoryEntry, eowSrcPtr=eowSrcPtr, eowSinkPtr=eowSinkPtr, BoardFailure=BoardFailure, HoldTime=HoldTime, softInventoryIndex=softInventoryIndex, LedType=LedType, boardMonitor=boardMonitor, boardMissingSev=boardMissingSev, ledPosition=ledPosition, eowTable=eowTable, boardTable=boardTable, boardSlotName=boardSlotName, eowClockMode=eowClockMode, boardInsertFamily=boardInsertFamily, laserNumber=laserNumber, boardListNumber=boardListNumber, board=board, softInventoryExt=softInventoryExt, softInventoryTable=softInventoryTable, ledTable=ledTable, boardListType=boardListType, laserALSEnable=laserALSEnable, hardInventoryTable=hardInventoryTable, softInv=softInv, eowName=eowName, ledIndex=ledIndex, shelf=shelf, laserALSRestart2s=laserALSRestart2s, laser=laser, holdTime=holdTime, boardExpectType=boardExpectType, boardNumber=boardNumber, eow=eow, softInventoryType=softInventoryType, ledStatus=ledStatus, EOWType=EOWType, LedStatus=LedStatus, boardListIndex=boardListIndex, boardListEntry=boardListEntry, ledEntry=ledEntry, boardFirstPortIndex=boardFirstPortIndex, boardDefectiveSev=boardDefectiveSev, boardExpectFamily=boardExpectFamily, PYSNMP_MODULE_ID=shelf, softInventoryCode=softInventoryCode, hardInventoryIndex=hardInventoryIndex, eowSinkType=eowSinkType, boardIndex=boardIndex, hardInventoryDescr=hardInventoryDescr, softInventoryBoard=softInventoryBoard, laserALSRestart90s=laserALSRestart90s, laserIndex=laserIndex, softInventoryNumber=softInventoryNumber, ProtectionType=ProtectionType, adrFailHoldOffTime=adrFailHoldOffTime, boardList=boardList, ledNumber=ledNumber, laserEntry=laserEntry, boardSeverity=boardSeverity, hardInv=hardInv, hardInventoryNumber=hardInventoryNumber, eowIndex=eowIndex, eowNumber=eowNumber, adrHotReset=adrHotReset, boardListTable=boardListTable, laserTable=laserTable, softInventoryEntry=softInventoryEntry, adrFailHoldOnTime=adrFailHoldOnTime, boardInsertType=boardInsertType, hardInventoryBoard=hardInventoryBoard, boardMismatchSev=boardMismatchSev)
