...
mibBuilder.exportSymbols("SHELF-MIB", softInv=softInv, hardInventoryDescr=hardInventoryDescr, laser=laser, board=board, laserNumber=laserNumber, eowSinkPtr=eowSinkPtr, softInventoryNumber=softInventoryNumber, shelf=shelf, eowEntry=eowEntry, boardListType=boardListType, ledTable=ledTable, boardMonitor=boardMonitor, boardListTable=boardListTable, ledPosition=ledPosition, hardInventoryBoard=hardInventoryBoard, boardListSlot=boardListSlot, boardListEntry=boardListEntry, ledIndex=ledIndex, boardInsertFamily=boardInsertFamily, eowTable=eowTable, boardList=boardList, BoardFailure=BoardFailure, softInventoryCode=softInventoryCode, hardInventoryNumber=hardInventoryNumber, eowIndex=eowIndex, EOWClockMode=EOWClockMode, hardInv=hardInv, led=led, laserEntry=laserEntry, boardListIndex=boardListIndex, softInventoryIndex=softInventoryIndex, laserALSEnable=laserALSEnable, boardListNumber=boardListNumber, holdTime=holdTime, eowNumber=eowNumber, eowSinkType=eowSinkType, eowSrcType=eowSrcType, hardInventoryTable=hardInventoryTable, LedType=LedType, ProtectionType=ProtectionType, boardProtectionType=boardProtectionType, boardEntry=boardEntry, boardIndex=boardIndex, softInventoryBoard=softInventoryBoard, hardInventoryIndex=hardInventoryIndex, adrFailHoldOnTime=adrFailHoldOnTime, boardSlotName=boardSlotName, ledStatus=ledStatus, adrHotReset=adrHotReset, laserALSRestart90s=laserALSRestart90s, laserTable=laserTable, boardDefectiveSev=boardDefectiveSev, laserALSRestart2s=laserALSRestart2s, boardSeverity=boardSeverity, adrFailHoldOffTime=adrFailHoldOffTime, boardTable=boardTable, softInventoryType=softInventoryType, eowSrcPtr=eowSrcPtr, softInventoryTable=softInventoryTable, laserIndex=laserIndex, boardMismatchSev=boardMismatchSev, softInventoryExt=softInventoryExt, HoldTime=HoldTime, boardExpectFamily=boardExpectFamily, ledEntry=ledEntry, boardExpectType=boardExpectType, boardActive=boardActive, boardMissingSev=boardMissingSev, eowName=eowName, eowClockMode=eowClockMode, boardInsertType=boardInsertType, LedStatus=LedStatus, EOWType=EOWType, boardFailure=boardFailure, ledNumber=ledNumber, PYSNMP_MODULE_ID=shelf, boardNumber=boardNumber, eow=eow, boardFirstPortIndex=boardFirstPortIndex, laserTxEnable=laserTxEnable, ledType=ledType, softInventoryEntry=softInventoryEntry, hardInventoryEntry=hardInventoryEntry)
