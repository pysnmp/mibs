...
mibBuilder.exportSymbols("SHELF-MIB", holdTime=holdTime, adrHotReset=adrHotReset, boardMissingSev=boardMissingSev, hardInventoryIndex=hardInventoryIndex, softInv=softInv, boardNumber=boardNumber, laserIndex=laserIndex, boardListTable=boardListTable, boardListEntry=boardListEntry, EOWClockMode=EOWClockMode, BoardFailure=BoardFailure, softInventoryType=softInventoryType, laserNumber=laserNumber, boardSeverity=boardSeverity, PYSNMP_MODULE_ID=shelf, laserEntry=laserEntry, boardActive=boardActive, boardList=boardList, softInventoryBoard=softInventoryBoard, EOWType=EOWType, ProtectionType=ProtectionType, ledStatus=ledStatus, hardInventoryNumber=hardInventoryNumber, eowIndex=eowIndex, eowSinkType=eowSinkType, eowName=eowName, boardSlotName=boardSlotName, ledEntry=ledEntry, eowSrcType=eowSrcType, softInventoryIndex=softInventoryIndex, boardInsertType=boardInsertType, boardFirstPortIndex=boardFirstPortIndex, boardListIndex=boardListIndex, laser=laser, LedStatus=LedStatus, eowNumber=eowNumber, boardFailure=boardFailure, boardProtectionType=boardProtectionType, eowEntry=eowEntry, adrFailHoldOnTime=adrFailHoldOnTime, eowSrcPtr=eowSrcPtr, ledIndex=ledIndex, ledPosition=ledPosition, boardListSlot=boardListSlot, laserTxEnable=laserTxEnable, laserALSRestart90s=laserALSRestart90s, softInventoryExt=softInventoryExt, ledType=ledType, hardInventoryDescr=hardInventoryDescr, softInventoryNumber=softInventoryNumber, boardInsertFamily=boardInsertFamily, ledTable=ledTable, eowClockMode=eowClockMode, softInventoryEntry=softInventoryEntry, boardIndex=boardIndex, laserALSRestart2s=laserALSRestart2s, board=board, boardMismatchSev=boardMismatchSev, boardListType=boardListType, boardExpectFamily=boardExpectFamily, hardInv=hardInv, softInventoryTable=softInventoryTable, eowTable=eowTable, boardTable=boardTable, shelf=shelf, LedType=LedType, ledNumber=ledNumber, boardListNumber=boardListNumber, hardInventoryTable=hardInventoryTable, softInventoryCode=softInventoryCode, HoldTime=HoldTime, boardDefectiveSev=boardDefectiveSev, boardEntry=boardEntry, eowSinkPtr=eowSinkPtr, boardExpectType=boardExpectType, hardInventoryBoard=hardInventoryBoard, laserALSEnable=laserALSEnable, laserTable=laserTable, eow=eow, boardMonitor=boardMonitor, adrFailHoldOffTime=adrFailHoldOffTime, led=led, hardInventoryEntry=hardInventoryEntry)
