...
mibBuilder.exportSymbols("SHELF-MIB", eowIndex=eowIndex, boardListEntry=boardListEntry, boardListType=boardListType, laserALSRestart90s=laserALSRestart90s, boardInsertFamily=boardInsertFamily, HoldTime=HoldTime, hardInventoryBoard=hardInventoryBoard, ledEntry=ledEntry, EOWType=EOWType, eowClockMode=eowClockMode, boardActive=boardActive, BoardFailure=BoardFailure, shelf=shelf, eowSrcType=eowSrcType, boardMonitor=boardMonitor, boardIndex=boardIndex, boardListIndex=boardListIndex, boardSlotName=boardSlotName, softInv=softInv, laserEntry=laserEntry, softInventoryNumber=softInventoryNumber, softInventoryEntry=softInventoryEntry, boardExpectFamily=boardExpectFamily, boardMismatchSev=boardMismatchSev, ledTable=ledTable, laserALSRestart2s=laserALSRestart2s, laserALSEnable=laserALSEnable, laserTxEnable=laserTxEnable, adrFailHoldOnTime=adrFailHoldOnTime, eowName=eowName, boardExpectType=boardExpectType, boardEntry=boardEntry, ProtectionType=ProtectionType, laserIndex=laserIndex, boardListNumber=boardListNumber, boardFirstPortIndex=boardFirstPortIndex, boardList=boardList, ledPosition=ledPosition, softInventoryTable=softInventoryTable, eowSrcPtr=eowSrcPtr, EOWClockMode=EOWClockMode, eowNumber=eowNumber, laserNumber=laserNumber, hardInventoryDescr=hardInventoryDescr, eowSinkPtr=eowSinkPtr, laserTable=laserTable, ledStatus=ledStatus, eowEntry=eowEntry, boardTable=boardTable, hardInventoryEntry=hardInventoryEntry, softInventoryExt=softInventoryExt, boardFailure=boardFailure, hardInv=hardInv, board=board, eowSinkType=eowSinkType, LedStatus=LedStatus, boardNumber=boardNumber, eowTable=eowTable, laser=laser, boardProtectionType=boardProtectionType, hardInventoryIndex=hardInventoryIndex, adrFailHoldOffTime=adrFailHoldOffTime, boardListTable=boardListTable, boardSeverity=boardSeverity, softInventoryType=softInventoryType, softInventoryBoard=softInventoryBoard, led=led, softInventoryCode=softInventoryCode, hardInventoryNumber=hardInventoryNumber, holdTime=holdTime, hardInventoryTable=hardInventoryTable, PYSNMP_MODULE_ID=shelf, boardDefectiveSev=boardDefectiveSev, ledNumber=ledNumber, ledType=ledType, eow=eow, boardInsertType=boardInsertType, boardListSlot=boardListSlot, boardMissingSev=boardMissingSev, LedType=LedType, ledIndex=ledIndex, adrHotReset=adrHotReset, softInventoryIndex=softInventoryIndex)
