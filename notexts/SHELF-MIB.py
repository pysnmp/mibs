...
mibBuilder.exportSymbols("SHELF-MIB", eowSrcPtr=eowSrcPtr, boardExpectFamily=boardExpectFamily, boardListIndex=boardListIndex, HoldTime=HoldTime, ledType=ledType, boardFailure=boardFailure, boardListEntry=boardListEntry, boardListTable=boardListTable, laserIndex=laserIndex, boardFirstPortIndex=boardFirstPortIndex, ledEntry=ledEntry, boardSlotName=boardSlotName, boardDefectiveSev=boardDefectiveSev, eowNumber=eowNumber, holdTime=holdTime, laserNumber=laserNumber, boardListType=boardListType, boardSeverity=boardSeverity, boardExpectType=boardExpectType, eowEntry=eowEntry, boardActive=boardActive, hardInv=hardInv, eow=eow, eowClockMode=eowClockMode, laserALSEnable=laserALSEnable, boardListSlot=boardListSlot, boardEntry=boardEntry, EOWClockMode=EOWClockMode, BoardFailure=BoardFailure, ProtectionType=ProtectionType, boardProtectionType=boardProtectionType, hardInventoryDescr=hardInventoryDescr, softInventoryTable=softInventoryTable, LedStatus=LedStatus, eowSinkType=eowSinkType, boardListNumber=boardListNumber, PYSNMP_MODULE_ID=shelf, eowSinkPtr=eowSinkPtr, shelf=shelf, boardInsertType=boardInsertType, softInventoryType=softInventoryType, softInventoryBoard=softInventoryBoard, led=led, laserTable=laserTable, adrFailHoldOffTime=adrFailHoldOffTime, eowName=eowName, hardInventoryNumber=hardInventoryNumber, boardMonitor=boardMonitor, boardMismatchSev=boardMismatchSev, softInventoryIndex=softInventoryIndex, eowSrcType=eowSrcType, adrFailHoldOnTime=adrFailHoldOnTime, ledIndex=ledIndex, eowIndex=eowIndex, softInv=softInv, boardTable=boardTable, laserALSRestart2s=laserALSRestart2s, laserALSRestart90s=laserALSRestart90s, boardMissingSev=boardMissingSev, adrHotReset=adrHotReset, hardInventoryTable=hardInventoryTable, hardInventoryBoard=hardInventoryBoard, hardInventoryIndex=hardInventoryIndex, boardIndex=boardIndex, boardNumber=boardNumber, ledStatus=ledStatus, softInventoryCode=softInventoryCode, LedType=LedType, boardInsertFamily=boardInsertFamily, softInventoryNumber=softInventoryNumber, laser=laser, eowTable=eowTable, board=board, hardInventoryEntry=hardInventoryEntry, ledPosition=ledPosition, softInventoryExt=softInventoryExt, ledTable=ledTable, softInventoryEntry=softInventoryEntry, EOWType=EOWType, laserTxEnable=laserTxEnable, boardList=boardList, ledNumber=ledNumber, laserEntry=laserEntry)
