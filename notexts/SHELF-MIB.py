...
mibBuilder.exportSymbols("SHELF-MIB", eowSinkPtr=eowSinkPtr, led=led, hardInventoryDescr=hardInventoryDescr, hardInventoryIndex=hardInventoryIndex, boardMismatchSev=boardMismatchSev, hardInv=hardInv, boardListIndex=boardListIndex, softInventoryCode=softInventoryCode, boardListNumber=boardListNumber, boardActive=boardActive, boardListSlot=boardListSlot, ledType=ledType, softInventoryEntry=softInventoryEntry, eow=eow, softInventoryType=softInventoryType, ledIndex=ledIndex, shelf=shelf, eowIndex=eowIndex, boardExpectFamily=boardExpectFamily, eowName=eowName, laserTable=laserTable, boardListTable=boardListTable, boardSeverity=boardSeverity, eowSinkType=eowSinkType, laserEntry=laserEntry, ledPosition=ledPosition, EOWType=EOWType, hardInventoryBoard=hardInventoryBoard, BoardFailure=BoardFailure, eowClockMode=eowClockMode, boardFirstPortIndex=boardFirstPortIndex, adrHotReset=adrHotReset, adrFailHoldOnTime=adrFailHoldOnTime, HoldTime=HoldTime, laserALSEnable=laserALSEnable, eowNumber=eowNumber, laserIndex=laserIndex, laserALSRestart90s=laserALSRestart90s, LedStatus=LedStatus, eowSrcPtr=eowSrcPtr, laserALSRestart2s=laserALSRestart2s, ledNumber=ledNumber, boardSlotName=boardSlotName, laser=laser, softInventoryNumber=softInventoryNumber, ledEntry=ledEntry, ledStatus=ledStatus, laserNumber=laserNumber, EOWClockMode=EOWClockMode, boardInsertType=boardInsertType, hardInventoryEntry=hardInventoryEntry, ledTable=ledTable, ProtectionType=ProtectionType, boardInsertFamily=boardInsertFamily, eowSrcType=eowSrcType, softInv=softInv, boardTable=boardTable, boardMonitor=boardMonitor, boardDefectiveSev=boardDefectiveSev, boardList=boardList, boardListEntry=boardListEntry, adrFailHoldOffTime=adrFailHoldOffTime, PYSNMP_MODULE_ID=shelf, softInventoryBoard=softInventoryBoard, boardNumber=boardNumber, softInventoryExt=softInventoryExt, eowEntry=eowEntry, boardEntry=boardEntry, boardExpectType=boardExpectType, boardListType=boardListType, hardInventoryTable=hardInventoryTable, boardIndex=boardIndex, boardFailure=boardFailure, softInventoryIndex=softInventoryIndex, holdTime=holdTime, boardProtectionType=boardProtectionType, hardInventoryNumber=hardInventoryNumber, eowTable=eowTable, softInventoryTable=softInventoryTable, board=board, laserTxEnable=laserTxEnable, boardMissingSev=boardMissingSev, LedType=LedType)
