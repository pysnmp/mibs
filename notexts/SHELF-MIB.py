...
mibBuilder.exportSymbols("SHELF-MIB", laserEntry=laserEntry, softInventoryNumber=softInventoryNumber, boardListEntry=boardListEntry, laserIndex=laserIndex, laserNumber=laserNumber, eowSrcPtr=eowSrcPtr, led=led, hardInventoryBoard=hardInventoryBoard, hardInv=hardInv, ledEntry=ledEntry, hardInventoryEntry=hardInventoryEntry, boardSlotName=boardSlotName, laserALSEnable=laserALSEnable, boardListIndex=boardListIndex, ledStatus=ledStatus, eowSinkPtr=eowSinkPtr, board=board, boardExpectType=boardExpectType, boardProtectionType=boardProtectionType, boardSeverity=boardSeverity, eowNumber=eowNumber, EOWClockMode=EOWClockMode, LedStatus=LedStatus, boardEntry=boardEntry, ledNumber=ledNumber, boardListSlot=boardListSlot, hardInventoryTable=hardInventoryTable, softInventoryBoard=softInventoryBoard, softInventoryCode=softInventoryCode, boardFirstPortIndex=boardFirstPortIndex, hardInventoryDescr=hardInventoryDescr, ledType=ledType, boardDefectiveSev=boardDefectiveSev, boardMonitor=boardMonitor, boardActive=boardActive, eowTable=eowTable, softInventoryType=softInventoryType, hardInventoryNumber=hardInventoryNumber, laser=laser, HoldTime=HoldTime, eowSinkType=eowSinkType, softInventoryExt=softInventoryExt, ledPosition=ledPosition, boardList=boardList, EOWType=EOWType, LedType=LedType, boardListNumber=boardListNumber, adrFailHoldOnTime=adrFailHoldOnTime, ProtectionType=ProtectionType, eowIndex=eowIndex, adrFailHoldOffTime=adrFailHoldOffTime, boardFailure=boardFailure, boardListType=boardListType, laserTable=laserTable, boardIndex=boardIndex, holdTime=holdTime, eowClockMode=eowClockMode, boardMismatchSev=boardMismatchSev, eowSrcType=eowSrcType, eowEntry=eowEntry, ledIndex=ledIndex, boardNumber=boardNumber, laserALSRestart90s=laserALSRestart90s, softInventoryEntry=softInventoryEntry, boardExpectFamily=boardExpectFamily, eowName=eowName, PYSNMP_MODULE_ID=shelf, adrHotReset=adrHotReset, hardInventoryIndex=hardInventoryIndex, softInventoryIndex=softInventoryIndex, eow=eow, boardMissingSev=boardMissingSev, boardListTable=boardListTable, boardTable=boardTable, shelf=shelf, laserTxEnable=laserTxEnable, BoardFailure=BoardFailure, boardInsertFamily=boardInsertFamily, laserALSRestart2s=laserALSRestart2s, boardInsertType=boardInsertType, softInv=softInv, ledTable=ledTable, softInventoryTable=softInventoryTable)
