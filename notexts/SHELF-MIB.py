...
mibBuilder.exportSymbols("SHELF-MIB", ledTable=ledTable, holdTime=holdTime, boardNumber=boardNumber, eowNumber=eowNumber, hardInventoryNumber=hardInventoryNumber, LedType=LedType, hardInventoryTable=hardInventoryTable, laserNumber=laserNumber, eowSrcPtr=eowSrcPtr, eow=eow, softInventoryIndex=softInventoryIndex, boardListType=boardListType, softInventoryBoard=softInventoryBoard, HoldTime=HoldTime, laserIndex=laserIndex, boardListSlot=boardListSlot, laser=laser, laserEntry=laserEntry, eowClockMode=eowClockMode, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryEntry=hardInventoryEntry, eowName=eowName, boardListEntry=boardListEntry, boardEntry=boardEntry, softInventoryExt=softInventoryExt, boardFirstPortIndex=boardFirstPortIndex, boardTable=boardTable, hardInventoryDescr=hardInventoryDescr, softInv=softInv, BoardFailure=BoardFailure, boardSeverity=boardSeverity, hardInventoryBoard=hardInventoryBoard, boardSlotName=boardSlotName, eowSrcType=eowSrcType, eowSinkType=eowSinkType, softInventoryNumber=softInventoryNumber, boardInsertFamily=boardInsertFamily, eowEntry=eowEntry, laserALSEnable=laserALSEnable, boardInsertType=boardInsertType, eowSinkPtr=eowSinkPtr, boardExpectFamily=boardExpectFamily, EOWClockMode=EOWClockMode, ledStatus=ledStatus, hardInventoryIndex=hardInventoryIndex, laserTable=laserTable, boardListNumber=boardListNumber, adrHotReset=adrHotReset, boardFailure=boardFailure, hardInv=hardInv, led=led, boardMonitor=boardMonitor, ledIndex=ledIndex, ledEntry=ledEntry, eowIndex=eowIndex, ledPosition=ledPosition, laserALSRestart2s=laserALSRestart2s, adrFailHoldOnTime=adrFailHoldOnTime, ProtectionType=ProtectionType, boardExpectType=boardExpectType, boardActive=boardActive, EOWType=EOWType, PYSNMP_MODULE_ID=shelf, boardDefectiveSev=boardDefectiveSev, boardList=boardList, ledNumber=ledNumber, boardListTable=boardListTable, softInventoryType=softInventoryType, softInventoryCode=softInventoryCode, boardListIndex=boardListIndex, boardMissingSev=boardMissingSev, shelf=shelf, laserTxEnable=laserTxEnable, ledType=ledType, eowTable=eowTable, boardProtectionType=boardProtectionType, laserALSRestart90s=laserALSRestart90s, softInventoryEntry=softInventoryEntry, boardIndex=boardIndex, boardMismatchSev=boardMismatchSev, LedStatus=LedStatus, softInventoryTable=softInventoryTable, board=board)
