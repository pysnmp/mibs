...
mibBuilder.exportSymbols("SHELF-MIB", HoldTime=HoldTime, boardFailure=boardFailure, holdTime=holdTime, led=led, boardFirstPortIndex=boardFirstPortIndex, BoardFailure=BoardFailure, boardTable=boardTable, eowSrcPtr=eowSrcPtr, boardListNumber=boardListNumber, boardActive=boardActive, eowIndex=eowIndex, ledIndex=ledIndex, softInventoryExt=softInventoryExt, boardSeverity=boardSeverity, eowSinkPtr=eowSinkPtr, softInv=softInv, softInventoryIndex=softInventoryIndex, eowClockMode=eowClockMode, boardInsertFamily=boardInsertFamily, boardList=boardList, laserALSRestart90s=laserALSRestart90s, boardEntry=boardEntry, eowNumber=eowNumber, boardMonitor=boardMonitor, EOWClockMode=EOWClockMode, boardListType=boardListType, hardInventoryBoard=hardInventoryBoard, laserALSEnable=laserALSEnable, boardExpectFamily=boardExpectFamily, boardMismatchSev=boardMismatchSev, hardInventoryIndex=hardInventoryIndex, laserIndex=laserIndex, PYSNMP_MODULE_ID=shelf, boardMissingSev=boardMissingSev, hardInventoryEntry=hardInventoryEntry, boardIndex=boardIndex, softInventoryNumber=softInventoryNumber, eowSinkType=eowSinkType, ledNumber=ledNumber, eowTable=eowTable, hardInv=hardInv, boardListIndex=boardListIndex, hardInventoryTable=hardInventoryTable, eowEntry=eowEntry, eowName=eowName, LedType=LedType, boardListEntry=boardListEntry, ledType=ledType, boardListTable=boardListTable, ProtectionType=ProtectionType, boardSlotName=boardSlotName, ledStatus=ledStatus, softInventoryTable=softInventoryTable, hardInventoryDescr=hardInventoryDescr, boardDefectiveSev=boardDefectiveSev, laserEntry=laserEntry, hardInventoryNumber=hardInventoryNumber, laserALSRestart2s=laserALSRestart2s, ledEntry=ledEntry, EOWType=EOWType, LedStatus=LedStatus, laserTxEnable=laserTxEnable, laserTable=laserTable, softInventoryEntry=softInventoryEntry, boardExpectType=boardExpectType, softInventoryCode=softInventoryCode, boardInsertType=boardInsertType, adrHotReset=adrHotReset, shelf=shelf, softInventoryType=softInventoryType, ledPosition=ledPosition, adrFailHoldOnTime=adrFailHoldOnTime, boardNumber=boardNumber, boardProtectionType=boardProtectionType, eow=eow, laserNumber=laserNumber, laser=laser, softInventoryBoard=softInventoryBoard, board=board, boardListSlot=boardListSlot, eowSrcType=eowSrcType, ledTable=ledTable, adrFailHoldOffTime=adrFailHoldOffTime)
