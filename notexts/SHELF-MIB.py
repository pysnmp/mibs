...
mibBuilder.exportSymbols("SHELF-MIB", laserTable=laserTable, hardInventoryDescr=hardInventoryDescr, boardListType=boardListType, LedStatus=LedStatus, BoardFailure=BoardFailure, adrHotReset=adrHotReset, eowClockMode=eowClockMode, hardInventoryNumber=hardInventoryNumber, laserEntry=laserEntry, hardInventoryBoard=hardInventoryBoard, softInv=softInv, boardEntry=boardEntry, laserALSRestart2s=laserALSRestart2s, softInventoryEntry=softInventoryEntry, softInventoryNumber=softInventoryNumber, boardSeverity=boardSeverity, boardListNumber=boardListNumber, softInventoryExt=softInventoryExt, boardTable=boardTable, boardMismatchSev=boardMismatchSev, board=board, boardExpectFamily=boardExpectFamily, laserTxEnable=laserTxEnable, ProtectionType=ProtectionType, eowSrcPtr=eowSrcPtr, adrFailHoldOffTime=adrFailHoldOffTime, ledType=ledType, ledStatus=ledStatus, HoldTime=HoldTime, boardList=boardList, eowNumber=eowNumber, ledIndex=ledIndex, hardInventoryIndex=hardInventoryIndex, laserNumber=laserNumber, adrFailHoldOnTime=adrFailHoldOnTime, laserALSEnable=laserALSEnable, boardFailure=boardFailure, softInventoryIndex=softInventoryIndex, ledNumber=ledNumber, boardActive=boardActive, eowEntry=eowEntry, boardListEntry=boardListEntry, hardInventoryTable=hardInventoryTable, ledPosition=ledPosition, softInventoryTable=softInventoryTable, boardNumber=boardNumber, laserIndex=laserIndex, eow=eow, holdTime=holdTime, boardInsertFamily=boardInsertFamily, boardMissingSev=boardMissingSev, EOWClockMode=EOWClockMode, boardInsertType=boardInsertType, boardListIndex=boardListIndex, boardListSlot=boardListSlot, boardMonitor=boardMonitor, eowSinkPtr=eowSinkPtr, ledTable=ledTable, boardProtectionType=boardProtectionType, boardListTable=boardListTable, laser=laser, boardFirstPortIndex=boardFirstPortIndex, eowSrcType=eowSrcType, led=led, PYSNMP_MODULE_ID=shelf, LedType=LedType, eowSinkType=eowSinkType, hardInv=hardInv, boardExpectType=boardExpectType, laserALSRestart90s=laserALSRestart90s, softInventoryType=softInventoryType, boardSlotName=boardSlotName, ledEntry=ledEntry, softInventoryBoard=softInventoryBoard, boardIndex=boardIndex, eowTable=eowTable, eowName=eowName, shelf=shelf, EOWType=EOWType, hardInventoryEntry=hardInventoryEntry, boardDefectiveSev=boardDefectiveSev, softInventoryCode=softInventoryCode, eowIndex=eowIndex)
