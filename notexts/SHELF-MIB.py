...
mibBuilder.exportSymbols("SHELF-MIB", hardInv=hardInv, hardInventoryNumber=hardInventoryNumber, laserNumber=laserNumber, laserTxEnable=laserTxEnable, softInventoryType=softInventoryType, eowEntry=eowEntry, EOWClockMode=EOWClockMode, led=led, boardSlotName=boardSlotName, hardInventoryBoard=hardInventoryBoard, laserALSRestart90s=laserALSRestart90s, adrFailHoldOffTime=adrFailHoldOffTime, boardListIndex=boardListIndex, eowTable=eowTable, ledStatus=ledStatus, softInventoryExt=softInventoryExt, boardInsertFamily=boardInsertFamily, adrHotReset=adrHotReset, laserIndex=laserIndex, boardMonitor=boardMonitor, adrFailHoldOnTime=adrFailHoldOnTime, boardListNumber=boardListNumber, boardExpectType=boardExpectType, boardMissingSev=boardMissingSev, boardListTable=boardListTable, softInventoryCode=softInventoryCode, laserALSEnable=laserALSEnable, softInventoryBoard=softInventoryBoard, ProtectionType=ProtectionType, eowNumber=eowNumber, boardListEntry=boardListEntry, boardFirstPortIndex=boardFirstPortIndex, boardListSlot=boardListSlot, softInventoryNumber=softInventoryNumber, boardIndex=boardIndex, eowName=eowName, softInv=softInv, boardListType=boardListType, boardEntry=boardEntry, ledNumber=ledNumber, ledEntry=ledEntry, HoldTime=HoldTime, boardFailure=boardFailure, boardNumber=boardNumber, hardInventoryEntry=hardInventoryEntry, eowClockMode=eowClockMode, boardMismatchSev=boardMismatchSev, boardInsertType=boardInsertType, boardList=boardList, laserEntry=laserEntry, ledType=ledType, eowIndex=eowIndex, BoardFailure=BoardFailure, hardInventoryDescr=hardInventoryDescr, laserALSRestart2s=laserALSRestart2s, shelf=shelf, hardInventoryIndex=hardInventoryIndex, holdTime=holdTime, eowSinkPtr=eowSinkPtr, boardDefectiveSev=boardDefectiveSev, boardTable=boardTable, laserTable=laserTable, boardExpectFamily=boardExpectFamily, boardSeverity=boardSeverity, board=board, eowSrcPtr=eowSrcPtr, softInventoryIndex=softInventoryIndex, PYSNMP_MODULE_ID=shelf, ledIndex=ledIndex, ledPosition=ledPosition, eow=eow, LedStatus=LedStatus, boardProtectionType=boardProtectionType, EOWType=EOWType, ledTable=ledTable, softInventoryEntry=softInventoryEntry, eowSinkType=eowSinkType, hardInventoryTable=hardInventoryTable, eowSrcType=eowSrcType, softInventoryTable=softInventoryTable, LedType=LedType, laser=laser, boardActive=boardActive)
