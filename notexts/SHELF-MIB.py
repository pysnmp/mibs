...
mibBuilder.exportSymbols("SHELF-MIB", laser=laser, ledIndex=ledIndex, eowTable=eowTable, boardListSlot=boardListSlot, hardInventoryEntry=hardInventoryEntry, boardListNumber=boardListNumber, ProtectionType=ProtectionType, ledTable=ledTable, eowSinkType=eowSinkType, boardMismatchSev=boardMismatchSev, boardListTable=boardListTable, eowIndex=eowIndex, LedType=LedType, boardActive=boardActive, laserALSRestart90s=laserALSRestart90s, hardInventoryNumber=hardInventoryNumber, EOWType=EOWType, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryExt=softInventoryExt, softInventoryEntry=softInventoryEntry, softInventoryType=softInventoryType, laserIndex=laserIndex, boardFailure=boardFailure, boardFirstPortIndex=boardFirstPortIndex, ledPosition=ledPosition, boardIndex=boardIndex, ledStatus=ledStatus, boardSlotName=boardSlotName, laserALSRestart2s=laserALSRestart2s, boardExpectType=boardExpectType, hardInv=hardInv, hardInventoryDescr=hardInventoryDescr, softInv=softInv, laserALSEnable=laserALSEnable, eow=eow, eowSinkPtr=eowSinkPtr, boardEntry=boardEntry, boardSeverity=boardSeverity, eowEntry=eowEntry, hardInventoryBoard=hardInventoryBoard, LedStatus=LedStatus, boardMonitor=boardMonitor, boardDefectiveSev=boardDefectiveSev, HoldTime=HoldTime, boardList=boardList, adrFailHoldOffTime=adrFailHoldOffTime, eowNumber=eowNumber, boardTable=boardTable, ledType=ledType, led=led, adrHotReset=adrHotReset, boardListEntry=boardListEntry, hardInventoryTable=hardInventoryTable, ledEntry=ledEntry, softInventoryTable=softInventoryTable, laserEntry=laserEntry, boardListType=boardListType, holdTime=holdTime, laserTable=laserTable, boardListIndex=boardListIndex, EOWClockMode=EOWClockMode, boardProtectionType=boardProtectionType, boardMissingSev=boardMissingSev, softInventoryIndex=softInventoryIndex, eowClockMode=eowClockMode, eowName=eowName, BoardFailure=BoardFailure, board=board, boardInsertFamily=boardInsertFamily, softInventoryCode=softInventoryCode, boardExpectFamily=boardExpectFamily, eowSrcType=eowSrcType, PYSNMP_MODULE_ID=shelf, softInventoryNumber=softInventoryNumber, softInventoryBoard=softInventoryBoard, hardInventoryIndex=hardInventoryIndex, eowSrcPtr=eowSrcPtr, laserNumber=laserNumber, laserTxEnable=laserTxEnable, ledNumber=ledNumber, shelf=shelf, boardNumber=boardNumber, boardInsertType=boardInsertType)
