...
mibBuilder.exportSymbols("SHELF-MIB", ledTable=ledTable, laserTxEnable=laserTxEnable, ledType=ledType, boardListIndex=boardListIndex, hardInventoryDescr=hardInventoryDescr, softInventoryIndex=softInventoryIndex, ledEntry=ledEntry, shelf=shelf, boardExpectType=boardExpectType, hardInventoryIndex=hardInventoryIndex, laserALSEnable=laserALSEnable, EOWClockMode=EOWClockMode, EOWType=EOWType, laserALSRestart90s=laserALSRestart90s, softInventoryExt=softInventoryExt, boardListTable=boardListTable, boardTable=boardTable, eowIndex=eowIndex, ledPosition=ledPosition, boardProtectionType=boardProtectionType, boardActive=boardActive, hardInventoryBoard=hardInventoryBoard, boardMissingSev=boardMissingSev, eowSinkType=eowSinkType, boardListEntry=boardListEntry, boardListType=boardListType, laser=laser, softInventoryEntry=softInventoryEntry, eowNumber=eowNumber, softInventoryBoard=softInventoryBoard, softInv=softInv, HoldTime=HoldTime, boardSlotName=boardSlotName, boardEntry=boardEntry, eowSrcType=eowSrcType, adrFailHoldOffTime=adrFailHoldOffTime, eowEntry=eowEntry, boardMonitor=boardMonitor, softInventoryType=softInventoryType, laserTable=laserTable, boardFailure=boardFailure, eowClockMode=eowClockMode, ledNumber=ledNumber, led=led, boardList=boardList, hardInventoryTable=hardInventoryTable, boardSeverity=boardSeverity, hardInv=hardInv, LedStatus=LedStatus, BoardFailure=BoardFailure, LedType=LedType, eowTable=eowTable, boardDefectiveSev=boardDefectiveSev, boardNumber=boardNumber, eow=eow, ledStatus=ledStatus, eowSrcPtr=eowSrcPtr, eowSinkPtr=eowSinkPtr, ledIndex=ledIndex, ProtectionType=ProtectionType, laserEntry=laserEntry, boardInsertType=boardInsertType, boardIndex=boardIndex, holdTime=holdTime, boardListSlot=boardListSlot, boardListNumber=boardListNumber, hardInventoryEntry=hardInventoryEntry, laserIndex=laserIndex, boardFirstPortIndex=boardFirstPortIndex, softInventoryNumber=softInventoryNumber, boardInsertFamily=boardInsertFamily, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryNumber=hardInventoryNumber, eowName=eowName, softInventoryCode=softInventoryCode, PYSNMP_MODULE_ID=shelf, softInventoryTable=softInventoryTable, boardExpectFamily=boardExpectFamily, laserALSRestart2s=laserALSRestart2s, boardMismatchSev=boardMismatchSev, laserNumber=laserNumber, board=board, adrHotReset=adrHotReset)
