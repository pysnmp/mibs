...
mibBuilder.exportSymbols("SHELF-MIB", boardTable=boardTable, boardMismatchSev=boardMismatchSev, ledType=ledType, laserTxEnable=laserTxEnable, EOWClockMode=EOWClockMode, softInv=softInv, hardInventoryBoard=hardInventoryBoard, eowSrcPtr=eowSrcPtr, boardSeverity=boardSeverity, boardExpectType=boardExpectType, boardDefectiveSev=boardDefectiveSev, boardProtectionType=boardProtectionType, softInventoryIndex=softInventoryIndex, ledNumber=ledNumber, hardInventoryNumber=hardInventoryNumber, laserNumber=laserNumber, softInventoryType=softInventoryType, laserIndex=laserIndex, boardInsertType=boardInsertType, laserALSRestart2s=laserALSRestart2s, boardListNumber=boardListNumber, laserALSRestart90s=laserALSRestart90s, LedType=LedType, boardList=boardList, softInventoryBoard=softInventoryBoard, boardListTable=boardListTable, laserALSEnable=laserALSEnable, LedStatus=LedStatus, eowSinkType=eowSinkType, boardMissingSev=boardMissingSev, eowClockMode=eowClockMode, ledStatus=ledStatus, ProtectionType=ProtectionType, softInventoryExt=softInventoryExt, PYSNMP_MODULE_ID=shelf, hardInventoryDescr=hardInventoryDescr, ledEntry=ledEntry, board=board, HoldTime=HoldTime, boardExpectFamily=boardExpectFamily, softInventoryNumber=softInventoryNumber, adrFailHoldOnTime=adrFailHoldOnTime, eowTable=eowTable, led=led, hardInventoryIndex=hardInventoryIndex, boardListSlot=boardListSlot, shelf=shelf, laserEntry=laserEntry, softInventoryTable=softInventoryTable, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, eow=eow, softInventoryCode=softInventoryCode, EOWType=EOWType, boardActive=boardActive, softInventoryEntry=softInventoryEntry, eowEntry=eowEntry, boardInsertFamily=boardInsertFamily, eowSrcType=eowSrcType, eowNumber=eowNumber, laser=laser, ledTable=ledTable, boardListType=boardListType, adrFailHoldOffTime=adrFailHoldOffTime, eowSinkPtr=eowSinkPtr, ledIndex=ledIndex, boardSlotName=boardSlotName, ledPosition=ledPosition, adrHotReset=adrHotReset, BoardFailure=BoardFailure, boardListEntry=boardListEntry, laserTable=laserTable, hardInventoryTable=hardInventoryTable, boardFailure=boardFailure, eowName=eowName, boardListIndex=boardListIndex, boardIndex=boardIndex, holdTime=holdTime, hardInventoryEntry=hardInventoryEntry, hardInv=hardInv, boardNumber=boardNumber, boardEntry=boardEntry, eowIndex=eowIndex)
