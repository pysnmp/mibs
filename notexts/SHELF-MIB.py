...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryCode=softInventoryCode, hardInventoryTable=hardInventoryTable, eowIndex=eowIndex, laserALSEnable=laserALSEnable, boardInsertFamily=boardInsertFamily, eowSrcType=eowSrcType, boardFirstPortIndex=boardFirstPortIndex, hardInv=hardInv, boardMismatchSev=boardMismatchSev, boardListSlot=boardListSlot, boardProtectionType=boardProtectionType, eowTable=eowTable, softInventoryType=softInventoryType, laserTable=laserTable, hardInventoryBoard=hardInventoryBoard, ledNumber=ledNumber, boardMonitor=boardMonitor, boardFailure=boardFailure, eow=eow, hardInventoryEntry=hardInventoryEntry, softInventoryIndex=softInventoryIndex, softInventoryTable=softInventoryTable, eowName=eowName, boardExpectFamily=boardExpectFamily, laser=laser, EOWType=EOWType, laserALSRestart90s=laserALSRestart90s, EOWClockMode=EOWClockMode, ProtectionType=ProtectionType, boardIndex=boardIndex, HoldTime=HoldTime, hardInventoryNumber=hardInventoryNumber, boardListNumber=boardListNumber, eowSinkPtr=eowSinkPtr, adrFailHoldOnTime=adrFailHoldOnTime, softInv=softInv, softInventoryNumber=softInventoryNumber, LedStatus=LedStatus, ledStatus=ledStatus, softInventoryBoard=softInventoryBoard, eowSrcPtr=eowSrcPtr, adrFailHoldOffTime=adrFailHoldOffTime, board=board, boardSlotName=boardSlotName, boardMissingSev=boardMissingSev, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, boardListType=boardListType, laserALSRestart2s=laserALSRestart2s, eowEntry=eowEntry, PYSNMP_MODULE_ID=shelf, ledEntry=ledEntry, BoardFailure=BoardFailure, boardListTable=boardListTable, led=led, laserEntry=laserEntry, softInventoryExt=softInventoryExt, boardNumber=boardNumber, laserNumber=laserNumber, adrHotReset=adrHotReset, ledTable=ledTable, ledIndex=ledIndex, boardListEntry=boardListEntry, boardEntry=boardEntry, shelf=shelf, boardList=boardList, boardExpectType=boardExpectType, ledType=ledType, boardInsertType=boardInsertType, softInventoryEntry=softInventoryEntry, laserIndex=laserIndex, laserTxEnable=laserTxEnable, boardListIndex=boardListIndex, eowNumber=eowNumber, eowClockMode=eowClockMode, hardInventoryDescr=hardInventoryDescr, boardSeverity=boardSeverity, ledPosition=ledPosition, boardDefectiveSev=boardDefectiveSev, boardActive=boardActive, LedType=LedType, eowSinkType=eowSinkType, holdTime=holdTime)
