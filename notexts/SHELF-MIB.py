...
mibBuilder.exportSymbols("SHELF-MIB", eowSrcPtr=eowSrcPtr, softInventoryExt=softInventoryExt, boardListType=boardListType, eowTable=eowTable, ProtectionType=ProtectionType, boardListNumber=boardListNumber, softInventoryBoard=softInventoryBoard, eowSinkType=eowSinkType, hardInventoryDescr=hardInventoryDescr, laser=laser, shelf=shelf, boardActive=boardActive, hardInventoryNumber=hardInventoryNumber, eowClockMode=eowClockMode, boardProtectionType=boardProtectionType, boardListEntry=boardListEntry, boardListTable=boardListTable, led=led, boardMonitor=boardMonitor, boardSeverity=boardSeverity, eowEntry=eowEntry, boardListIndex=boardListIndex, eowIndex=eowIndex, ledPosition=ledPosition, ledIndex=ledIndex, eowSinkPtr=eowSinkPtr, ledType=ledType, boardIndex=boardIndex, laserTxEnable=laserTxEnable, LedStatus=LedStatus, softInventoryType=softInventoryType, boardList=boardList, ledEntry=ledEntry, adrFailHoldOnTime=adrFailHoldOnTime, holdTime=holdTime, boardDefectiveSev=boardDefectiveSev, hardInv=hardInv, softInventoryIndex=softInventoryIndex, laserALSEnable=laserALSEnable, adrFailHoldOffTime=adrFailHoldOffTime, boardListSlot=boardListSlot, laserTable=laserTable, LedType=LedType, eowSrcType=eowSrcType, laserIndex=laserIndex, BoardFailure=BoardFailure, boardInsertType=boardInsertType, boardSlotName=boardSlotName, boardFailure=boardFailure, hardInventoryTable=hardInventoryTable, softInventoryCode=softInventoryCode, laserALSRestart2s=laserALSRestart2s, eowName=eowName, EOWType=EOWType, boardTable=boardTable, laserNumber=laserNumber, softInventoryNumber=softInventoryNumber, boardMissingSev=boardMissingSev, adrHotReset=adrHotReset, board=board, boardMismatchSev=boardMismatchSev, ledStatus=ledStatus, hardInventoryBoard=hardInventoryBoard, PYSNMP_MODULE_ID=shelf, laserEntry=laserEntry, softInventoryTable=softInventoryTable, ledTable=ledTable, boardInsertFamily=boardInsertFamily, hardInventoryEntry=hardInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, laserALSRestart90s=laserALSRestart90s, boardNumber=boardNumber, boardExpectType=boardExpectType, HoldTime=HoldTime, softInventoryEntry=softInventoryEntry, boardExpectFamily=boardExpectFamily, hardInventoryIndex=hardInventoryIndex, ledNumber=ledNumber, eow=eow, eowNumber=eowNumber, boardEntry=boardEntry, EOWClockMode=EOWClockMode, softInv=softInv)
