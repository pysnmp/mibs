...
mibBuilder.exportSymbols("SHELF-MIB", boardListIndex=boardListIndex, hardInventoryDescr=hardInventoryDescr, eowIndex=eowIndex, ledType=ledType, ledPosition=ledPosition, hardInventoryTable=hardInventoryTable, softInventoryCode=softInventoryCode, laserALSRestart90s=laserALSRestart90s, eowName=eowName, hardInventoryBoard=hardInventoryBoard, boardListNumber=boardListNumber, board=board, boardNumber=boardNumber, boardSeverity=boardSeverity, eowSinkType=eowSinkType, softInventoryTable=softInventoryTable, boardFirstPortIndex=boardFirstPortIndex, ledNumber=ledNumber, laserTable=laserTable, EOWType=EOWType, shelf=shelf, laserALSEnable=laserALSEnable, boardList=boardList, boardEntry=boardEntry, softInv=softInv, boardMonitor=boardMonitor, softInventoryNumber=softInventoryNumber, hardInv=hardInv, softInventoryIndex=softInventoryIndex, eowSinkPtr=eowSinkPtr, boardSlotName=boardSlotName, boardTable=boardTable, boardDefectiveSev=boardDefectiveSev, softInventoryEntry=softInventoryEntry, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryType=softInventoryType, laserNumber=laserNumber, boardIndex=boardIndex, eowNumber=eowNumber, boardMissingSev=boardMissingSev, boardFailure=boardFailure, ledEntry=ledEntry, eowTable=eowTable, laser=laser, ProtectionType=ProtectionType, eow=eow, boardListType=boardListType, boardExpectFamily=boardExpectFamily, ledStatus=ledStatus, boardMismatchSev=boardMismatchSev, led=led, BoardFailure=BoardFailure, laserEntry=laserEntry, adrHotReset=adrHotReset, LedType=LedType, HoldTime=HoldTime, laserALSRestart2s=laserALSRestart2s, boardProtectionType=boardProtectionType, eowSrcType=eowSrcType, laserIndex=laserIndex, hardInventoryIndex=hardInventoryIndex, ledTable=ledTable, boardListEntry=boardListEntry, PYSNMP_MODULE_ID=shelf, holdTime=holdTime, hardInventoryEntry=hardInventoryEntry, eowEntry=eowEntry, softInventoryBoard=softInventoryBoard, LedStatus=LedStatus, boardActive=boardActive, EOWClockMode=EOWClockMode, boardInsertFamily=boardInsertFamily, boardInsertType=boardInsertType, ledIndex=ledIndex, eowClockMode=eowClockMode, boardListTable=boardListTable, boardListSlot=boardListSlot, eowSrcPtr=eowSrcPtr, boardExpectType=boardExpectType, laserTxEnable=laserTxEnable, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryNumber=hardInventoryNumber, softInventoryExt=softInventoryExt)
