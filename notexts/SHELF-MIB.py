...
mibBuilder.exportSymbols("SHELF-MIB", adrFailHoldOnTime=adrFailHoldOnTime, hardInv=hardInv, hardInventoryNumber=hardInventoryNumber, eowSrcType=eowSrcType, boardList=boardList, ProtectionType=ProtectionType, boardExpectType=boardExpectType, eowIndex=eowIndex, boardTable=boardTable, laserNumber=laserNumber, ledNumber=ledNumber, eow=eow, LedType=LedType, boardMissingSev=boardMissingSev, ledPosition=ledPosition, eowClockMode=eowClockMode, softInventoryBoard=softInventoryBoard, shelf=shelf, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryDescr=hardInventoryDescr, boardListNumber=boardListNumber, laserEntry=laserEntry, softInventoryEntry=softInventoryEntry, holdTime=holdTime, ledStatus=ledStatus, board=board, eowTable=eowTable, softInventoryTable=softInventoryTable, boardFailure=boardFailure, boardIndex=boardIndex, EOWType=EOWType, laserIndex=laserIndex, boardSlotName=boardSlotName, boardMonitor=boardMonitor, boardExpectFamily=boardExpectFamily, hardInventoryTable=hardInventoryTable, boardProtectionType=boardProtectionType, boardNumber=boardNumber, hardInventoryBoard=hardInventoryBoard, softInventoryIndex=softInventoryIndex, ledTable=ledTable, softInv=softInv, hardInventoryIndex=hardInventoryIndex, boardInsertFamily=boardInsertFamily, ledIndex=ledIndex, boardListIndex=boardListIndex, laserALSRestart2s=laserALSRestart2s, eowEntry=eowEntry, boardListTable=boardListTable, laserTable=laserTable, PYSNMP_MODULE_ID=shelf, ledType=ledType, softInventoryType=softInventoryType, softInventoryExt=softInventoryExt, eowSinkType=eowSinkType, softInventoryNumber=softInventoryNumber, boardActive=boardActive, eowNumber=eowNumber, HoldTime=HoldTime, eowSinkPtr=eowSinkPtr, laserALSRestart90s=laserALSRestart90s, BoardFailure=BoardFailure, laser=laser, boardMismatchSev=boardMismatchSev, boardInsertType=boardInsertType, EOWClockMode=EOWClockMode, boardDefectiveSev=boardDefectiveSev, laserTxEnable=laserTxEnable, boardListEntry=boardListEntry, boardListType=boardListType, LedStatus=LedStatus, led=led, ledEntry=ledEntry, adrHotReset=adrHotReset, softInventoryCode=softInventoryCode, eowSrcPtr=eowSrcPtr, boardListSlot=boardListSlot, boardFirstPortIndex=boardFirstPortIndex, eowName=eowName, hardInventoryEntry=hardInventoryEntry, laserALSEnable=laserALSEnable, boardEntry=boardEntry, boardSeverity=boardSeverity)
