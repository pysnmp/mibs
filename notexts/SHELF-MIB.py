...
mibBuilder.exportSymbols("SHELF-MIB", BoardFailure=BoardFailure, softInventoryIndex=softInventoryIndex, softInventoryType=softInventoryType, PYSNMP_MODULE_ID=shelf, boardListSlot=boardListSlot, EOWType=EOWType, eowSinkType=eowSinkType, eowSrcPtr=eowSrcPtr, softInventoryBoard=softInventoryBoard, laserEntry=laserEntry, laserTable=laserTable, holdTime=holdTime, laserIndex=laserIndex, ledNumber=ledNumber, hardInventoryDescr=hardInventoryDescr, eowSinkPtr=eowSinkPtr, eowSrcType=eowSrcType, boardIndex=boardIndex, adrHotReset=adrHotReset, laserALSEnable=laserALSEnable, laser=laser, boardActive=boardActive, boardListNumber=boardListNumber, laserALSRestart90s=laserALSRestart90s, ledPosition=ledPosition, LedStatus=LedStatus, EOWClockMode=EOWClockMode, boardMismatchSev=boardMismatchSev, boardFirstPortIndex=boardFirstPortIndex, ledTable=ledTable, ledType=ledType, hardInventoryEntry=hardInventoryEntry, boardListIndex=boardListIndex, boardProtectionType=boardProtectionType, ledIndex=ledIndex, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, adrFailHoldOnTime=adrFailHoldOnTime, ledStatus=ledStatus, boardMissingSev=boardMissingSev, softInv=softInv, boardSlotName=boardSlotName, adrFailHoldOffTime=adrFailHoldOffTime, boardExpectFamily=boardExpectFamily, laserNumber=laserNumber, hardInventoryBoard=hardInventoryBoard, eowClockMode=eowClockMode, boardNumber=boardNumber, laserALSRestart2s=laserALSRestart2s, laserTxEnable=laserTxEnable, led=led, softInventoryNumber=softInventoryNumber, ledEntry=ledEntry, boardInsertType=boardInsertType, boardList=boardList, hardInv=hardInv, boardEntry=boardEntry, eowNumber=eowNumber, boardMonitor=boardMonitor, board=board, boardFailure=boardFailure, LedType=LedType, softInventoryCode=softInventoryCode, hardInventoryTable=hardInventoryTable, eowIndex=eowIndex, shelf=shelf, hardInventoryNumber=hardInventoryNumber, eowEntry=eowEntry, boardExpectType=boardExpectType, boardListTable=boardListTable, ProtectionType=ProtectionType, boardListEntry=boardListEntry, eowTable=eowTable, boardSeverity=boardSeverity, boardDefectiveSev=boardDefectiveSev, boardListType=boardListType, softInventoryExt=softInventoryExt, HoldTime=HoldTime, eowName=eowName, softInventoryTable=softInventoryTable, eow=eow, softInventoryEntry=softInventoryEntry, boardInsertFamily=boardInsertFamily)
