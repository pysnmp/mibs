...
mibBuilder.exportSymbols("SHELF-MIB", boardDefectiveSev=boardDefectiveSev, boardList=boardList, boardListNumber=boardListNumber, LedType=LedType, laserALSEnable=laserALSEnable, laserTxEnable=laserTxEnable, hardInventoryTable=hardInventoryTable, softInventoryTable=softInventoryTable, hardInventoryIndex=hardInventoryIndex, eowNumber=eowNumber, softInventoryEntry=softInventoryEntry, boardListEntry=boardListEntry, boardInsertType=boardInsertType, boardEntry=boardEntry, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryIndex=softInventoryIndex, adrHotReset=adrHotReset, laserIndex=laserIndex, BoardFailure=BoardFailure, LedStatus=LedStatus, boardMonitor=boardMonitor, boardMismatchSev=boardMismatchSev, boardNumber=boardNumber, laserTable=laserTable, holdTime=holdTime, shelf=shelf, boardActive=boardActive, hardInventoryEntry=hardInventoryEntry, ProtectionType=ProtectionType, laser=laser, laserEntry=laserEntry, boardExpectType=boardExpectType, adrFailHoldOffTime=adrFailHoldOffTime, EOWClockMode=EOWClockMode, boardInsertFamily=boardInsertFamily, softInventoryType=softInventoryType, boardExpectFamily=boardExpectFamily, laserALSRestart2s=laserALSRestart2s, boardFailure=boardFailure, eowTable=eowTable, eowEntry=eowEntry, boardSeverity=boardSeverity, softInventoryNumber=softInventoryNumber, board=board, ledNumber=ledNumber, softInv=softInv, softInventoryExt=softInventoryExt, boardListSlot=boardListSlot, boardFirstPortIndex=boardFirstPortIndex, boardListTable=boardListTable, HoldTime=HoldTime, eowClockMode=eowClockMode, ledEntry=ledEntry, hardInventoryNumber=hardInventoryNumber, hardInventoryBoard=hardInventoryBoard, laserNumber=laserNumber, hardInventoryDescr=hardInventoryDescr, boardSlotName=boardSlotName, hardInv=hardInv, softInventoryBoard=softInventoryBoard, ledPosition=ledPosition, eowName=eowName, softInventoryCode=softInventoryCode, ledIndex=ledIndex, boardListIndex=boardListIndex, laserALSRestart90s=laserALSRestart90s, boardTable=boardTable, ledType=ledType, eowSrcPtr=eowSrcPtr, led=led, boardMissingSev=boardMissingSev, eowSinkType=eowSinkType, eowIndex=eowIndex, eowSrcType=eowSrcType, boardProtectionType=boardProtectionType, ledTable=ledTable, EOWType=EOWType, boardListType=boardListType, PYSNMP_MODULE_ID=shelf, eowSinkPtr=eowSinkPtr, eow=eow, ledStatus=ledStatus, boardIndex=boardIndex)
