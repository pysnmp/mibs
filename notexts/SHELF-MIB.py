...
mibBuilder.exportSymbols("SHELF-MIB", eowSinkPtr=eowSinkPtr, boardInsertFamily=boardInsertFamily, boardFailure=boardFailure, eow=eow, ledPosition=ledPosition, ledType=ledType, hardInventoryDescr=hardInventoryDescr, softInventoryTable=softInventoryTable, boardListTable=boardListTable, ProtectionType=ProtectionType, boardExpectFamily=boardExpectFamily, softInventoryIndex=softInventoryIndex, laser=laser, softInventoryEntry=softInventoryEntry, ledTable=ledTable, softInv=softInv, eowName=eowName, boardListNumber=boardListNumber, board=board, boardProtectionType=boardProtectionType, eowClockMode=eowClockMode, hardInv=hardInv, boardListType=boardListType, boardExpectType=boardExpectType, holdTime=holdTime, eowTable=eowTable, laserNumber=laserNumber, ledIndex=ledIndex, led=led, boardFirstPortIndex=boardFirstPortIndex, ledNumber=ledNumber, eowEntry=eowEntry, EOWClockMode=EOWClockMode, eowSrcPtr=eowSrcPtr, LedStatus=LedStatus, boardSeverity=boardSeverity, laserALSRestart2s=laserALSRestart2s, LedType=LedType, laserALSRestart90s=laserALSRestart90s, eowNumber=eowNumber, softInventoryNumber=softInventoryNumber, hardInventoryTable=hardInventoryTable, eowSrcType=eowSrcType, ledStatus=ledStatus, boardNumber=boardNumber, softInventoryType=softInventoryType, laserEntry=laserEntry, boardSlotName=boardSlotName, BoardFailure=BoardFailure, hardInventoryBoard=hardInventoryBoard, shelf=shelf, laserALSEnable=laserALSEnable, boardEntry=boardEntry, boardMismatchSev=boardMismatchSev, boardMissingSev=boardMissingSev, laserTable=laserTable, softInventoryExt=softInventoryExt, EOWType=EOWType, hardInventoryIndex=hardInventoryIndex, eowSinkType=eowSinkType, laserTxEnable=laserTxEnable, softInventoryBoard=softInventoryBoard, ledEntry=ledEntry, eowIndex=eowIndex, boardDefectiveSev=boardDefectiveSev, softInventoryCode=softInventoryCode, boardActive=boardActive, PYSNMP_MODULE_ID=shelf, boardIndex=boardIndex, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryEntry=hardInventoryEntry, hardInventoryNumber=hardInventoryNumber, boardMonitor=boardMonitor, laserIndex=laserIndex, adrFailHoldOffTime=adrFailHoldOffTime, adrHotReset=adrHotReset, HoldTime=HoldTime, boardInsertType=boardInsertType, boardListEntry=boardListEntry, boardTable=boardTable, boardList=boardList, boardListSlot=boardListSlot, boardListIndex=boardListIndex)
