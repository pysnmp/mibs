...
mibBuilder.exportSymbols("SHELF-MIB", shelf=shelf, laserALSEnable=laserALSEnable, hardInventoryDescr=hardInventoryDescr, boardActive=boardActive, boardMismatchSev=boardMismatchSev, softInventoryBoard=softInventoryBoard, boardExpectType=boardExpectType, ledTable=ledTable, boardEntry=boardEntry, boardExpectFamily=boardExpectFamily, LedStatus=LedStatus, eowEntry=eowEntry, boardListTable=boardListTable, softInventoryNumber=softInventoryNumber, boardMonitor=boardMonitor, boardList=boardList, hardInventoryBoard=hardInventoryBoard, laserALSRestart90s=laserALSRestart90s, hardInventoryEntry=hardInventoryEntry, eowName=eowName, softInventoryType=softInventoryType, eowTable=eowTable, boardListNumber=boardListNumber, softInventoryCode=softInventoryCode, eowNumber=eowNumber, EOWType=EOWType, adrFailHoldOnTime=adrFailHoldOnTime, laserTable=laserTable, softInv=softInv, eowSinkType=eowSinkType, ledEntry=ledEntry, ledType=ledType, boardIndex=boardIndex, softInventoryEntry=softInventoryEntry, adrHotReset=adrHotReset, eowSrcType=eowSrcType, eowSinkPtr=eowSinkPtr, ledIndex=ledIndex, BoardFailure=BoardFailure, adrFailHoldOffTime=adrFailHoldOffTime, boardListEntry=boardListEntry, eowIndex=eowIndex, hardInventoryTable=hardInventoryTable, laser=laser, softInventoryIndex=softInventoryIndex, hardInventoryNumber=hardInventoryNumber, laserTxEnable=laserTxEnable, boardNumber=boardNumber, boardMissingSev=boardMissingSev, ledPosition=ledPosition, softInventoryExt=softInventoryExt, LedType=LedType, boardSlotName=boardSlotName, boardDefectiveSev=boardDefectiveSev, boardListType=boardListType, laserALSRestart2s=laserALSRestart2s, ProtectionType=ProtectionType, eow=eow, boardInsertType=boardInsertType, HoldTime=HoldTime, hardInv=hardInv, boardListSlot=boardListSlot, boardFirstPortIndex=boardFirstPortIndex, holdTime=holdTime, softInventoryTable=softInventoryTable, boardFailure=boardFailure, board=board, eowClockMode=eowClockMode, ledNumber=ledNumber, boardListIndex=boardListIndex, laserIndex=laserIndex, boardTable=boardTable, eowSrcPtr=eowSrcPtr, boardInsertFamily=boardInsertFamily, laserNumber=laserNumber, boardProtectionType=boardProtectionType, boardSeverity=boardSeverity, EOWClockMode=EOWClockMode, PYSNMP_MODULE_ID=shelf, hardInventoryIndex=hardInventoryIndex, laserEntry=laserEntry, led=led, ledStatus=ledStatus)
