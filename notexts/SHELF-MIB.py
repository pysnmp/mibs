...
mibBuilder.exportSymbols("SHELF-MIB", boardTable=boardTable, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryDescr=hardInventoryDescr, hardInventoryNumber=hardInventoryNumber, led=led, softInventoryExt=softInventoryExt, holdTime=holdTime, hardInventoryBoard=hardInventoryBoard, eowSinkPtr=eowSinkPtr, eowTable=eowTable, boardListType=boardListType, BoardFailure=BoardFailure, softInventoryBoard=softInventoryBoard, laserEntry=laserEntry, boardNumber=boardNumber, boardMonitor=boardMonitor, eowNumber=eowNumber, eowSrcType=eowSrcType, laserIndex=laserIndex, hardInventoryTable=hardInventoryTable, eowSrcPtr=eowSrcPtr, eow=eow, boardInsertType=boardInsertType, ledIndex=ledIndex, laserALSEnable=laserALSEnable, boardListSlot=boardListSlot, eowEntry=eowEntry, eowClockMode=eowClockMode, shelf=shelf, laser=laser, eowName=eowName, ledTable=ledTable, eowIndex=eowIndex, boardEntry=boardEntry, laserALSRestart90s=laserALSRestart90s, boardSlotName=boardSlotName, ledType=ledType, board=board, EOWType=EOWType, ledStatus=ledStatus, softInventoryTable=softInventoryTable, hardInv=hardInv, eowSinkType=eowSinkType, boardActive=boardActive, laserTxEnable=laserTxEnable, softInventoryEntry=softInventoryEntry, boardListTable=boardListTable, ledNumber=ledNumber, boardExpectFamily=boardExpectFamily, boardListIndex=boardListIndex, boardMismatchSev=boardMismatchSev, ProtectionType=ProtectionType, boardProtectionType=boardProtectionType, laserALSRestart2s=laserALSRestart2s, ledPosition=ledPosition, adrHotReset=adrHotReset, hardInventoryIndex=hardInventoryIndex, boardFailure=boardFailure, boardDefectiveSev=boardDefectiveSev, softInventoryCode=softInventoryCode, ledEntry=ledEntry, boardSeverity=boardSeverity, EOWClockMode=EOWClockMode, boardInsertFamily=boardInsertFamily, softInventoryNumber=softInventoryNumber, boardFirstPortIndex=boardFirstPortIndex, HoldTime=HoldTime, boardMissingSev=boardMissingSev, LedStatus=LedStatus, LedType=LedType, softInventoryType=softInventoryType, softInventoryIndex=softInventoryIndex, boardListNumber=boardListNumber, boardIndex=boardIndex, softInv=softInv, adrFailHoldOffTime=adrFailHoldOffTime, PYSNMP_MODULE_ID=shelf, hardInventoryEntry=hardInventoryEntry, laserTable=laserTable, boardListEntry=boardListEntry, boardList=boardList, boardExpectType=boardExpectType, laserNumber=laserNumber)
