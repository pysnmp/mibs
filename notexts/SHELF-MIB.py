...
mibBuilder.exportSymbols("SHELF-MIB", ProtectionType=ProtectionType, boardTable=boardTable, boardNumber=boardNumber, eow=eow, eowSinkType=eowSinkType, hardInventoryIndex=hardInventoryIndex, adrHotReset=adrHotReset, boardListSlot=boardListSlot, hardInventoryNumber=hardInventoryNumber, laserALSRestart90s=laserALSRestart90s, hardInventoryBoard=hardInventoryBoard, laserEntry=laserEntry, ledPosition=ledPosition, eowSinkPtr=eowSinkPtr, boardExpectType=boardExpectType, softInventoryExt=softInventoryExt, LedType=LedType, eowClockMode=eowClockMode, hardInventoryTable=hardInventoryTable, softInventoryCode=softInventoryCode, boardMismatchSev=boardMismatchSev, boardIndex=boardIndex, eowName=eowName, boardInsertType=boardInsertType, boardListNumber=boardListNumber, boardMonitor=boardMonitor, boardListTable=boardListTable, hardInv=hardInv, boardFirstPortIndex=boardFirstPortIndex, EOWClockMode=EOWClockMode, boardListEntry=boardListEntry, ledTable=ledTable, boardList=boardList, boardActive=boardActive, eowSrcType=eowSrcType, boardDefectiveSev=boardDefectiveSev, softInventoryType=softInventoryType, boardSeverity=boardSeverity, HoldTime=HoldTime, softInventoryIndex=softInventoryIndex, laser=laser, boardListIndex=boardListIndex, eowEntry=eowEntry, eowNumber=eowNumber, shelf=shelf, boardListType=boardListType, boardProtectionType=boardProtectionType, ledEntry=ledEntry, laserNumber=laserNumber, EOWType=EOWType, laserTxEnable=laserTxEnable, ledNumber=ledNumber, softInventoryNumber=softInventoryNumber, laserIndex=laserIndex, softInventoryTable=softInventoryTable, BoardFailure=BoardFailure, ledType=ledType, eowSrcPtr=eowSrcPtr, LedStatus=LedStatus, laserALSRestart2s=laserALSRestart2s, hardInventoryDescr=hardInventoryDescr, softInventoryBoard=softInventoryBoard, led=led, boardInsertFamily=boardInsertFamily, softInv=softInv, board=board, boardExpectFamily=boardExpectFamily, laserALSEnable=laserALSEnable, ledIndex=ledIndex, ledStatus=ledStatus, PYSNMP_MODULE_ID=shelf, softInventoryEntry=softInventoryEntry, boardSlotName=boardSlotName, eowIndex=eowIndex, holdTime=holdTime, adrFailHoldOnTime=adrFailHoldOnTime, adrFailHoldOffTime=adrFailHoldOffTime, boardMissingSev=boardMissingSev, eowTable=eowTable, boardEntry=boardEntry, laserTable=laserTable, hardInventoryEntry=hardInventoryEntry, boardFailure=boardFailure)
