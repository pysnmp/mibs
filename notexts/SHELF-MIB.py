...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryType=softInventoryType, eowSinkPtr=eowSinkPtr, boardSlotName=boardSlotName, eowSrcPtr=eowSrcPtr, laserALSRestart2s=laserALSRestart2s, ledTable=ledTable, softInventoryExt=softInventoryExt, laserTxEnable=laserTxEnable, eowIndex=eowIndex, softInventoryTable=softInventoryTable, boardSeverity=boardSeverity, LedStatus=LedStatus, boardIndex=boardIndex, hardInventoryTable=hardInventoryTable, boardExpectFamily=boardExpectFamily, laserALSEnable=laserALSEnable, shelf=shelf, boardTable=boardTable, laserTable=laserTable, hardInventoryIndex=hardInventoryIndex, laserEntry=laserEntry, ledPosition=ledPosition, eowClockMode=eowClockMode, boardInsertFamily=boardInsertFamily, eowSrcType=eowSrcType, adrHotReset=adrHotReset, boardListTable=boardListTable, laserNumber=laserNumber, adrFailHoldOffTime=adrFailHoldOffTime, PYSNMP_MODULE_ID=shelf, ledStatus=ledStatus, boardMonitor=boardMonitor, holdTime=holdTime, boardListType=boardListType, boardListNumber=boardListNumber, boardListSlot=boardListSlot, boardMissingSev=boardMissingSev, eowNumber=eowNumber, laserALSRestart90s=laserALSRestart90s, laserIndex=laserIndex, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryDescr=hardInventoryDescr, softInventoryIndex=softInventoryIndex, eowName=eowName, boardExpectType=boardExpectType, softInventoryBoard=softInventoryBoard, boardFailure=boardFailure, boardNumber=boardNumber, hardInv=hardInv, boardDefectiveSev=boardDefectiveSev, ledNumber=ledNumber, boardEntry=boardEntry, LedType=LedType, eowTable=eowTable, ledEntry=ledEntry, ProtectionType=ProtectionType, EOWClockMode=EOWClockMode, softInventoryEntry=softInventoryEntry, hardInventoryNumber=hardInventoryNumber, led=led, softInv=softInv, boardActive=boardActive, board=board, softInventoryCode=softInventoryCode, ledIndex=ledIndex, BoardFailure=BoardFailure, boardListEntry=boardListEntry, eowSinkType=eowSinkType, eowEntry=eowEntry, laser=laser, eow=eow, boardList=boardList, HoldTime=HoldTime, boardMismatchSev=boardMismatchSev, hardInventoryBoard=hardInventoryBoard, hardInventoryEntry=hardInventoryEntry, ledType=ledType, boardInsertType=boardInsertType, boardProtectionType=boardProtectionType, softInventoryNumber=softInventoryNumber, boardFirstPortIndex=boardFirstPortIndex, boardListIndex=boardListIndex, EOWType=EOWType)
