...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryTable=softInventoryTable, boardListType=boardListType, eowClockMode=eowClockMode, hardInventoryDescr=hardInventoryDescr, ProtectionType=ProtectionType, boardListSlot=boardListSlot, PYSNMP_MODULE_ID=shelf, eowIndex=eowIndex, eowSinkPtr=eowSinkPtr, laserTxEnable=laserTxEnable, softInv=softInv, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryNumber=softInventoryNumber, shelf=shelf, ledPosition=ledPosition, LedType=LedType, softInventoryType=softInventoryType, boardDefectiveSev=boardDefectiveSev, hardInventoryBoard=hardInventoryBoard, boardTable=boardTable, softInventoryExt=softInventoryExt, softInventoryEntry=softInventoryEntry, ledType=ledType, eowTable=eowTable, laserTable=laserTable, laser=laser, eowName=eowName, softInventoryBoard=softInventoryBoard, holdTime=holdTime, hardInventoryIndex=hardInventoryIndex, eowEntry=eowEntry, led=led, boardList=boardList, ledIndex=ledIndex, boardExpectType=boardExpectType, boardListNumber=boardListNumber, boardIndex=boardIndex, boardMissingSev=boardMissingSev, eowSrcType=eowSrcType, boardActive=boardActive, laserEntry=laserEntry, board=board, ledTable=ledTable, eow=eow, laserALSEnable=laserALSEnable, ledEntry=ledEntry, laserALSRestart2s=laserALSRestart2s, boardEntry=boardEntry, boardFirstPortIndex=boardFirstPortIndex, boardInsertFamily=boardInsertFamily, boardListEntry=boardListEntry, boardMismatchSev=boardMismatchSev, boardSlotName=boardSlotName, boardFailure=boardFailure, boardListTable=boardListTable, hardInventoryNumber=hardInventoryNumber, boardExpectFamily=boardExpectFamily, eowSrcPtr=eowSrcPtr, hardInv=hardInv, laserIndex=laserIndex, boardMonitor=boardMonitor, EOWType=EOWType, boardNumber=boardNumber, laserNumber=laserNumber, eowNumber=eowNumber, boardListIndex=boardListIndex, ledNumber=ledNumber, softInventoryCode=softInventoryCode, adrHotReset=adrHotReset, hardInventoryEntry=hardInventoryEntry, adrFailHoldOffTime=adrFailHoldOffTime, laserALSRestart90s=laserALSRestart90s, HoldTime=HoldTime, EOWClockMode=EOWClockMode, boardProtectionType=boardProtectionType, eowSinkType=eowSinkType, LedStatus=LedStatus, boardSeverity=boardSeverity, BoardFailure=BoardFailure, hardInventoryTable=hardInventoryTable, ledStatus=ledStatus, boardInsertType=boardInsertType, softInventoryIndex=softInventoryIndex)
