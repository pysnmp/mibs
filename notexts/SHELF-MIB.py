...
mibBuilder.exportSymbols("SHELF-MIB", LedType=LedType, ledType=ledType, boardListSlot=boardListSlot, board=board, boardListEntry=boardListEntry, boardListTable=boardListTable, hardInventoryTable=hardInventoryTable, laserTxEnable=laserTxEnable, EOWType=EOWType, boardFirstPortIndex=boardFirstPortIndex, softInventoryCode=softInventoryCode, eowTable=eowTable, hardInventoryEntry=hardInventoryEntry, eowSinkPtr=eowSinkPtr, softInventoryNumber=softInventoryNumber, boardMonitor=boardMonitor, eowSrcPtr=eowSrcPtr, boardInsertFamily=boardInsertFamily, boardExpectFamily=boardExpectFamily, hardInventoryIndex=hardInventoryIndex, boardMismatchSev=boardMismatchSev, eowSrcType=eowSrcType, shelf=shelf, eowNumber=eowNumber, ledPosition=ledPosition, ProtectionType=ProtectionType, boardListIndex=boardListIndex, eowEntry=eowEntry, softInventoryEntry=softInventoryEntry, laserALSRestart2s=laserALSRestart2s, ledEntry=ledEntry, eowIndex=eowIndex, boardListNumber=boardListNumber, PYSNMP_MODULE_ID=shelf, ledNumber=ledNumber, softInventoryExt=softInventoryExt, ledTable=ledTable, laserEntry=laserEntry, laserALSEnable=laserALSEnable, boardDefectiveSev=boardDefectiveSev, eowClockMode=eowClockMode, eow=eow, ledStatus=ledStatus, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryTable=softInventoryTable, holdTime=holdTime, boardEntry=boardEntry, softInventoryIndex=softInventoryIndex, boardSlotName=boardSlotName, boardListType=boardListType, boardIndex=boardIndex, boardInsertType=boardInsertType, laserNumber=laserNumber, EOWClockMode=EOWClockMode, eowSinkType=eowSinkType, laser=laser, adrHotReset=adrHotReset, laserALSRestart90s=laserALSRestart90s, boardProtectionType=boardProtectionType, softInv=softInv, softInventoryType=softInventoryType, ledIndex=ledIndex, boardList=boardList, hardInventoryNumber=hardInventoryNumber, boardExpectType=boardExpectType, softInventoryBoard=softInventoryBoard, laserTable=laserTable, BoardFailure=BoardFailure, laserIndex=laserIndex, boardSeverity=boardSeverity, boardTable=boardTable, led=led, eowName=eowName, boardActive=boardActive, LedStatus=LedStatus, hardInventoryBoard=hardInventoryBoard, HoldTime=HoldTime, boardMissingSev=boardMissingSev, boardNumber=boardNumber, boardFailure=boardFailure, adrFailHoldOnTime=adrFailHoldOnTime, hardInv=hardInv, hardInventoryDescr=hardInventoryDescr)
