...
Gauge32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, ObjectIdentity, NotificationType, Integer32, IpAddress, iso, TimeTicks, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress", "iso", "TimeTicks", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SHELF-MIB", boardProtectionType=boardProtectionType, laserEntry=laserEntry, ledStatus=ledStatus, hardInventoryTable=hardInventoryTable, ledNumber=ledNumber, board=board, ledTable=ledTable, hardInventoryEntry=hardInventoryEntry, hardInventoryDescr=hardInventoryDescr, adrFailHoldOffTime=adrFailHoldOffTime, boardListNumber=boardListNumber, ledType=ledType, boardMismatchSev=boardMismatchSev, eowSinkPtr=eowSinkPtr, adrHotReset=adrHotReset, ProtectionType=ProtectionType, softInventoryEntry=softInventoryEntry, boardListIndex=boardListIndex, laserTable=laserTable, led=led, boardMissingSev=boardMissingSev, softInventoryBoard=softInventoryBoard, softInventoryCode=softInventoryCode, softInventoryExt=softInventoryExt, LedStatus=LedStatus, hardInventoryIndex=hardInventoryIndex, laser=laser, eowSrcType=eowSrcType, boardNumber=boardNumber, laserTxEnable=laserTxEnable, PYSNMP_MODULE_ID=shelf, shelf=shelf, boardSlotName=boardSlotName, boardFailure=boardFailure, hardInv=hardInv, holdTime=holdTime, boardListTable=boardListTable, eowClockMode=eowClockMode, eowIndex=eowIndex, boardListType=boardListType, boardActive=boardActive, boardTable=boardTable, eowNumber=eowNumber, laserALSRestart2s=laserALSRestart2s, boardFirstPortIndex=boardFirstPortIndex, ledIndex=ledIndex, boardSeverity=boardSeverity, boardListEntry=boardListEntry, hardInventoryBoard=hardInventoryBoard, LedType=LedType, boardEntry=boardEntry, softInventoryNumber=softInventoryNumber, eow=eow, boardDefectiveSev=boardDefectiveSev, boardInsertType=boardInsertType, BoardFailure=BoardFailure, eowTable=eowTable, eowSinkType=eowSinkType, ledPosition=ledPosition, eowSrcPtr=eowSrcPtr, softInv=softInv, boardMonitor=boardMonitor, EOWType=EOWType, laserNumber=laserNumber, boardInsertFamily=boardInsertFamily, boardIndex=boardIndex, softInventoryType=softInventoryType, eowName=eowName, HoldTime=HoldTime, softInventoryIndex=softInventoryIndex, eowEntry=eowEntry, softInventoryTable=softInventoryTable, laserALSRestart90s=laserALSRestart90s, boardListSlot=boardListSlot, EOWClockMode=EOWClockMode, laserALSEnable=laserALSEnable, ledEntry=ledEntry, adrFailHoldOnTime=adrFailHoldOnTime, boardExpectType=boardExpectType, laserIndex=laserIndex, boardList=boardList, boardExpectFamily=boardExpectFamily, hardInventoryNumber=hardInventoryNumber)
