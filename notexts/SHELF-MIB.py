...
mibBuilder.exportSymbols("SHELF-MIB", laserIndex=laserIndex, LedType=LedType, eowName=eowName, eowEntry=eowEntry, boardListType=boardListType, laserEntry=laserEntry, softInventoryEntry=softInventoryEntry, ledNumber=ledNumber, boardMonitor=boardMonitor, boardNumber=boardNumber, eowNumber=eowNumber, softInventoryBoard=softInventoryBoard, ledIndex=ledIndex, laserNumber=laserNumber, boardDefectiveSev=boardDefectiveSev, boardIndex=boardIndex, eowClockMode=eowClockMode, softInventoryExt=softInventoryExt, boardInsertType=boardInsertType, softInv=softInv, boardMismatchSev=boardMismatchSev, LedStatus=LedStatus, boardExpectFamily=boardExpectFamily, adrHotReset=adrHotReset, hardInventoryIndex=hardInventoryIndex, hardInv=hardInv, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryIndex=softInventoryIndex, boardSlotName=boardSlotName, ledEntry=ledEntry, ledType=ledType, laserTxEnable=laserTxEnable, softInventoryTable=softInventoryTable, laserALSRestart90s=laserALSRestart90s, boardExpectType=boardExpectType, boardActive=boardActive, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryEntry=hardInventoryEntry, eowTable=eowTable, softInventoryNumber=softInventoryNumber, PYSNMP_MODULE_ID=shelf, boardSeverity=boardSeverity, eowIndex=eowIndex, softInventoryType=softInventoryType, BoardFailure=BoardFailure, ProtectionType=ProtectionType, eowSrcType=eowSrcType, led=led, EOWClockMode=EOWClockMode, boardListEntry=boardListEntry, ledTable=ledTable, ledPosition=ledPosition, shelf=shelf, boardProtectionType=boardProtectionType, boardFailure=boardFailure, boardMissingSev=boardMissingSev, eow=eow, board=board, eowSinkType=eowSinkType, boardListSlot=boardListSlot, boardListNumber=boardListNumber, hardInventoryTable=hardInventoryTable, eowSinkPtr=eowSinkPtr, HoldTime=HoldTime, boardInsertFamily=boardInsertFamily, boardList=boardList, laserALSEnable=laserALSEnable, boardFirstPortIndex=boardFirstPortIndex, hardInventoryNumber=hardInventoryNumber, holdTime=holdTime, laser=laser, hardInventoryDescr=hardInventoryDescr, EOWType=EOWType, boardListTable=boardListTable, boardListIndex=boardListIndex, ledStatus=ledStatus, boardTable=boardTable, softInventoryCode=softInventoryCode, hardInventoryBoard=hardInventoryBoard, boardEntry=boardEntry, eowSrcPtr=eowSrcPtr, laserTable=laserTable, laserALSRestart2s=laserALSRestart2s)
