...
mibBuilder.exportSymbols("SHELF-MIB", ledStatus=ledStatus, ledIndex=ledIndex, eowSrcType=eowSrcType, eowTable=eowTable, laserALSRestart90s=laserALSRestart90s, LedStatus=LedStatus, boardMonitor=boardMonitor, hardInventoryIndex=hardInventoryIndex, softInventoryExt=softInventoryExt, boardMismatchSev=boardMismatchSev, eowClockMode=eowClockMode, LedType=LedType, softInventoryNumber=softInventoryNumber, hardInventoryEntry=hardInventoryEntry, boardListNumber=boardListNumber, softInv=softInv, eowSinkPtr=eowSinkPtr, EOWClockMode=EOWClockMode, BoardFailure=BoardFailure, hardInv=hardInv, boardList=boardList, EOWType=EOWType, boardMissingSev=boardMissingSev, boardListSlot=boardListSlot, hardInventoryNumber=hardInventoryNumber, eowEntry=eowEntry, boardFailure=boardFailure, softInventoryBoard=softInventoryBoard, boardSlotName=boardSlotName, laser=laser, laserNumber=laserNumber, boardNumber=boardNumber, adrHotReset=adrHotReset, boardExpectType=boardExpectType, hardInventoryDescr=hardInventoryDescr, boardListType=boardListType, ProtectionType=ProtectionType, eow=eow, boardActive=boardActive, softInventoryType=softInventoryType, adrFailHoldOnTime=adrFailHoldOnTime, boardListIndex=boardListIndex, boardListEntry=boardListEntry, softInventoryCode=softInventoryCode, softInventoryIndex=softInventoryIndex, hardInventoryTable=hardInventoryTable, holdTime=holdTime, adrFailHoldOffTime=adrFailHoldOffTime, shelf=shelf, hardInventoryBoard=hardInventoryBoard, laserEntry=laserEntry, softInventoryEntry=softInventoryEntry, ledTable=ledTable, ledType=ledType, laserIndex=laserIndex, ledPosition=ledPosition, led=led, boardTable=boardTable, eowSinkType=eowSinkType, laserTxEnable=laserTxEnable, softInventoryTable=softInventoryTable, eowSrcPtr=eowSrcPtr, boardEntry=boardEntry, boardFirstPortIndex=boardFirstPortIndex, boardListTable=boardListTable, ledEntry=ledEntry, eowName=eowName, boardSeverity=boardSeverity, board=board, boardProtectionType=boardProtectionType, boardInsertType=boardInsertType, eowIndex=eowIndex, boardIndex=boardIndex, laserALSRestart2s=laserALSRestart2s, boardExpectFamily=boardExpectFamily, eowNumber=eowNumber, boardDefectiveSev=boardDefectiveSev, PYSNMP_MODULE_ID=shelf, laserTable=laserTable, ledNumber=ledNumber, HoldTime=HoldTime, laserALSEnable=laserALSEnable, boardInsertFamily=boardInsertFamily)
