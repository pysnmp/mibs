...
mibBuilder.exportSymbols("SHELF-MIB", boardMonitor=boardMonitor, boardProtectionType=boardProtectionType, boardInsertFamily=boardInsertFamily, hardInventoryEntry=hardInventoryEntry, laserALSRestart2s=laserALSRestart2s, laserALSEnable=laserALSEnable, hardInventoryNumber=hardInventoryNumber, LedStatus=LedStatus, eowClockMode=eowClockMode, ledType=ledType, softInventoryType=softInventoryType, laserTxEnable=laserTxEnable, eowTable=eowTable, boardFailure=boardFailure, boardListTable=boardListTable, softInventoryExt=softInventoryExt, boardActive=boardActive, eowSrcPtr=eowSrcPtr, boardList=boardList, laserEntry=laserEntry, hardInventoryIndex=hardInventoryIndex, hardInventoryDescr=hardInventoryDescr, EOWClockMode=EOWClockMode, boardMismatchSev=boardMismatchSev, softInventoryNumber=softInventoryNumber, ledEntry=ledEntry, eowSinkPtr=eowSinkPtr, LedType=LedType, laserNumber=laserNumber, EOWType=EOWType, boardExpectFamily=boardExpectFamily, hardInv=hardInv, ledStatus=ledStatus, laser=laser, softInventoryBoard=softInventoryBoard, eowIndex=eowIndex, boardListEntry=boardListEntry, hardInventoryTable=hardInventoryTable, ledIndex=ledIndex, boardMissingSev=boardMissingSev, boardListSlot=boardListSlot, ProtectionType=ProtectionType, boardSeverity=boardSeverity, boardNumber=boardNumber, adrHotReset=adrHotReset, softInventoryEntry=softInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, BoardFailure=BoardFailure, ledNumber=ledNumber, ledTable=ledTable, softInventoryTable=softInventoryTable, eowNumber=eowNumber, boardDefectiveSev=boardDefectiveSev, boardListType=boardListType, eowSrcType=eowSrcType, adrFailHoldOnTime=adrFailHoldOnTime, laserIndex=laserIndex, shelf=shelf, softInv=softInv, board=board, adrFailHoldOffTime=adrFailHoldOffTime, boardSlotName=boardSlotName, led=led, PYSNMP_MODULE_ID=shelf, eow=eow, eowEntry=eowEntry, boardInsertType=boardInsertType, softInventoryCode=softInventoryCode, HoldTime=HoldTime, ledPosition=ledPosition, boardExpectType=boardExpectType, boardIndex=boardIndex, hardInventoryBoard=hardInventoryBoard, laserTable=laserTable, boardListNumber=boardListNumber, laserALSRestart90s=laserALSRestart90s, eowSinkType=eowSinkType, boardEntry=boardEntry, holdTime=holdTime, boardTable=boardTable, boardListIndex=boardListIndex, softInventoryIndex=softInventoryIndex, eowName=eowName)
