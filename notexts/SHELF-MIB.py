...
mibBuilder.exportSymbols("SHELF-MIB", hardInv=hardInv, boardNumber=boardNumber, boardSeverity=boardSeverity, softInventoryTable=softInventoryTable, ledTable=ledTable, adrFailHoldOffTime=adrFailHoldOffTime, boardListNumber=boardListNumber, laser=laser, eowNumber=eowNumber, shelf=shelf, laserEntry=laserEntry, softInventoryType=softInventoryType, ledPosition=ledPosition, laserIndex=laserIndex, eowClockMode=eowClockMode, boardTable=boardTable, laserALSRestart90s=laserALSRestart90s, eowSrcPtr=eowSrcPtr, boardIndex=boardIndex, ProtectionType=ProtectionType, laserTxEnable=laserTxEnable, hardInventoryBoard=hardInventoryBoard, hardInventoryNumber=hardInventoryNumber, boardListIndex=boardListIndex, boardFirstPortIndex=boardFirstPortIndex, eowIndex=eowIndex, boardExpectFamily=boardExpectFamily, boardFailure=boardFailure, eowSinkType=eowSinkType, hardInventoryDescr=hardInventoryDescr, ledNumber=ledNumber, boardDefectiveSev=boardDefectiveSev, boardListSlot=boardListSlot, laserNumber=laserNumber, ledIndex=ledIndex, eowEntry=eowEntry, boardSlotName=boardSlotName, softInventoryExt=softInventoryExt, ledStatus=ledStatus, boardMonitor=boardMonitor, BoardFailure=BoardFailure, eowTable=eowTable, boardActive=boardActive, ledEntry=ledEntry, boardMismatchSev=boardMismatchSev, boardListEntry=boardListEntry, EOWType=EOWType, LedType=LedType, ledType=ledType, adrFailHoldOnTime=adrFailHoldOnTime, boardProtectionType=boardProtectionType, boardListType=boardListType, eow=eow, PYSNMP_MODULE_ID=shelf, boardInsertFamily=boardInsertFamily, holdTime=holdTime, hardInventoryTable=hardInventoryTable, eowName=eowName, boardListTable=boardListTable, adrHotReset=adrHotReset, eowSinkPtr=eowSinkPtr, hardInventoryEntry=hardInventoryEntry, eowSrcType=eowSrcType, EOWClockMode=EOWClockMode, boardMissingSev=boardMissingSev, laserTable=laserTable, boardList=boardList, softInventoryBoard=softInventoryBoard, softInventoryEntry=softInventoryEntry, softInventoryNumber=softInventoryNumber, softInventoryCode=softInventoryCode, hardInventoryIndex=hardInventoryIndex, led=led, softInv=softInv, boardEntry=boardEntry, board=board, softInventoryIndex=softInventoryIndex, laserALSEnable=laserALSEnable, LedStatus=LedStatus, boardExpectType=boardExpectType, boardInsertType=boardInsertType, HoldTime=HoldTime, laserALSRestart2s=laserALSRestart2s)
