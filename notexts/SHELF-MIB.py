...
mibBuilder.exportSymbols("SHELF-MIB", boardSeverity=boardSeverity, hardInventoryBoard=hardInventoryBoard, laserTable=laserTable, eowSrcType=eowSrcType, boardMonitor=boardMonitor, softInventoryExt=softInventoryExt, hardInventoryEntry=hardInventoryEntry, EOWType=EOWType, laserEntry=laserEntry, boardListSlot=boardListSlot, laserALSEnable=laserALSEnable, ledIndex=ledIndex, eowName=eowName, BoardFailure=BoardFailure, board=board, hardInventoryIndex=hardInventoryIndex, boardMismatchSev=boardMismatchSev, softInventoryTable=softInventoryTable, boardIndex=boardIndex, boardListIndex=boardListIndex, softInventoryCode=softInventoryCode, softInventoryType=softInventoryType, LedType=LedType, softInventoryIndex=softInventoryIndex, boardSlotName=boardSlotName, eowNumber=eowNumber, softInventoryBoard=softInventoryBoard, eowTable=eowTable, hardInventoryDescr=hardInventoryDescr, boardDefectiveSev=boardDefectiveSev, laserNumber=laserNumber, boardFirstPortIndex=boardFirstPortIndex, laserIndex=laserIndex, eowSinkType=eowSinkType, ledEntry=ledEntry, boardMissingSev=boardMissingSev, adrFailHoldOnTime=adrFailHoldOnTime, ledPosition=ledPosition, boardNumber=boardNumber, LedStatus=LedStatus, eowClockMode=eowClockMode, boardEntry=boardEntry, hardInventoryNumber=hardInventoryNumber, boardExpectFamily=boardExpectFamily, eowEntry=eowEntry, holdTime=holdTime, softInventoryNumber=softInventoryNumber, led=led, HoldTime=HoldTime, EOWClockMode=EOWClockMode, eowSrcPtr=eowSrcPtr, eow=eow, boardListType=boardListType, boardInsertFamily=boardInsertFamily, laserALSRestart90s=laserALSRestart90s, laserALSRestart2s=laserALSRestart2s, eowSinkPtr=eowSinkPtr, boardFailure=boardFailure, adrHotReset=adrHotReset, ledStatus=ledStatus, ledNumber=ledNumber, ProtectionType=ProtectionType, hardInv=hardInv, boardExpectType=boardExpectType, adrFailHoldOffTime=adrFailHoldOffTime, boardList=boardList, boardProtectionType=boardProtectionType, boardListNumber=boardListNumber, softInventoryEntry=softInventoryEntry, boardListTable=boardListTable, boardTable=boardTable, softInv=softInv, boardInsertType=boardInsertType, ledTable=ledTable, laser=laser, hardInventoryTable=hardInventoryTable, laserTxEnable=laserTxEnable, eowIndex=eowIndex, boardListEntry=boardListEntry, ledType=ledType, PYSNMP_MODULE_ID=shelf, shelf=shelf, boardActive=boardActive)
