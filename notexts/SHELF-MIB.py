...
mibBuilder.exportSymbols("SHELF-MIB", boardListType=boardListType, eowClockMode=eowClockMode, laserALSRestart90s=laserALSRestart90s, eowIndex=eowIndex, hardInv=hardInv, eowSrcPtr=eowSrcPtr, boardListIndex=boardListIndex, boardListTable=boardListTable, ledPosition=ledPosition, adrHotReset=adrHotReset, hardInventoryBoard=hardInventoryBoard, boardMissingSev=boardMissingSev, laserNumber=laserNumber, laserIndex=laserIndex, laserALSRestart2s=laserALSRestart2s, boardTable=boardTable, boardFailure=boardFailure, boardList=boardList, boardSlotName=boardSlotName, ledIndex=ledIndex, softInventoryBoard=softInventoryBoard, ledTable=ledTable, eowTable=eowTable, boardListEntry=boardListEntry, EOWType=EOWType, hardInventoryIndex=hardInventoryIndex, board=board, shelf=shelf, eowSinkPtr=eowSinkPtr, eowName=eowName, boardDefectiveSev=boardDefectiveSev, hardInventoryEntry=hardInventoryEntry, softInventoryTable=softInventoryTable, boardNumber=boardNumber, adrFailHoldOffTime=adrFailHoldOffTime, EOWClockMode=EOWClockMode, BoardFailure=BoardFailure, led=led, ledStatus=ledStatus, eowEntry=eowEntry, ledEntry=ledEntry, boardMismatchSev=boardMismatchSev, laserTxEnable=laserTxEnable, softInventoryEntry=softInventoryEntry, softInventoryType=softInventoryType, boardExpectFamily=boardExpectFamily, laserTable=laserTable, boardSeverity=boardSeverity, laserALSEnable=laserALSEnable, ledType=ledType, eowSinkType=eowSinkType, LedType=LedType, softInv=softInv, boardFirstPortIndex=boardFirstPortIndex, softInventoryIndex=softInventoryIndex, boardProtectionType=boardProtectionType, boardListSlot=boardListSlot, ProtectionType=ProtectionType, boardMonitor=boardMonitor, HoldTime=HoldTime, hardInventoryTable=hardInventoryTable, eow=eow, PYSNMP_MODULE_ID=shelf, softInventoryExt=softInventoryExt, boardActive=boardActive, ledNumber=ledNumber, laser=laser, boardInsertType=boardInsertType, adrFailHoldOnTime=adrFailHoldOnTime, boardIndex=boardIndex, softInventoryCode=softInventoryCode, boardExpectType=boardExpectType, holdTime=holdTime, laserEntry=laserEntry, boardListNumber=boardListNumber, LedStatus=LedStatus, eowNumber=eowNumber, hardInventoryNumber=hardInventoryNumber, softInventoryNumber=softInventoryNumber, hardInventoryDescr=hardInventoryDescr, boardInsertFamily=boardInsertFamily, boardEntry=boardEntry, eowSrcType=eowSrcType)
