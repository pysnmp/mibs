...
mibBuilder.exportSymbols("SHELF-MIB", ledPosition=ledPosition, HoldTime=HoldTime, hardInv=hardInv, holdTime=holdTime, softInventoryTable=softInventoryTable, boardProtectionType=boardProtectionType, boardIndex=boardIndex, laserIndex=laserIndex, boardFailure=boardFailure, boardSlotName=boardSlotName, boardActive=boardActive, hardInventoryTable=hardInventoryTable, laserNumber=laserNumber, boardTable=boardTable, hardInventoryBoard=hardInventoryBoard, shelf=shelf, boardNumber=boardNumber, laserEntry=laserEntry, laserALSRestart2s=laserALSRestart2s, laserTxEnable=laserTxEnable, led=led, laserALSRestart90s=laserALSRestart90s, eowNumber=eowNumber, hardInventoryDescr=hardInventoryDescr, LedType=LedType, boardList=boardList, boardFirstPortIndex=boardFirstPortIndex, boardInsertType=boardInsertType, laserTable=laserTable, boardDefectiveSev=boardDefectiveSev, boardExpectFamily=boardExpectFamily, boardMissingSev=boardMissingSev, ledType=ledType, eowSinkPtr=eowSinkPtr, softInventoryBoard=softInventoryBoard, boardInsertFamily=boardInsertFamily, adrFailHoldOffTime=adrFailHoldOffTime, eow=eow, hardInventoryNumber=hardInventoryNumber, boardMonitor=boardMonitor, ProtectionType=ProtectionType, EOWClockMode=EOWClockMode, adrHotReset=adrHotReset, eowSrcType=eowSrcType, PYSNMP_MODULE_ID=shelf, softInventoryExt=softInventoryExt, ledEntry=ledEntry, LedStatus=LedStatus, EOWType=EOWType, ledNumber=ledNumber, softInventoryNumber=softInventoryNumber, softInventoryIndex=softInventoryIndex, eowTable=eowTable, softInventoryCode=softInventoryCode, ledStatus=ledStatus, eowClockMode=eowClockMode, boardListEntry=boardListEntry, board=board, eowEntry=eowEntry, eowSinkType=eowSinkType, boardListNumber=boardListNumber, eowName=eowName, boardExpectType=boardExpectType, boardListType=boardListType, eowSrcPtr=eowSrcPtr, BoardFailure=BoardFailure, boardSeverity=boardSeverity, softInv=softInv, boardListIndex=boardListIndex, hardInventoryEntry=hardInventoryEntry, boardMismatchSev=boardMismatchSev, boardEntry=boardEntry, ledIndex=ledIndex, ledTable=ledTable, laser=laser, softInventoryEntry=softInventoryEntry, softInventoryType=softInventoryType, eowIndex=eowIndex, hardInventoryIndex=hardInventoryIndex, boardListSlot=boardListSlot, laserALSEnable=laserALSEnable, adrFailHoldOnTime=adrFailHoldOnTime, boardListTable=boardListTable)
