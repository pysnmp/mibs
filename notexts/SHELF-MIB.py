...
ModuleIdentity, iso, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, MibIdentifier, Counter64, IpAddress, Bits, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter64", "IpAddress", "Bits", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SHELF-MIB", adrFailHoldOffTime=adrFailHoldOffTime, eowNumber=eowNumber, softInventoryTable=softInventoryTable, laserALSEnable=laserALSEnable, EOWType=EOWType, softInventoryCode=softInventoryCode, laserALSRestart90s=laserALSRestart90s, boardDefectiveSev=boardDefectiveSev, BoardFailure=BoardFailure, hardInventoryDescr=hardInventoryDescr, shelf=shelf, hardInventoryTable=hardInventoryTable, boardMissingSev=boardMissingSev, boardProtectionType=boardProtectionType, LedStatus=LedStatus, ledIndex=ledIndex, eowName=eowName, hardInventoryIndex=hardInventoryIndex, boardMonitor=boardMonitor, ledType=ledType, boardSlotName=boardSlotName, ledPosition=ledPosition, eowIndex=eowIndex, laserNumber=laserNumber, softInventoryExt=softInventoryExt, boardIndex=boardIndex, hardInv=hardInv, boardSeverity=boardSeverity, EOWClockMode=EOWClockMode, ledEntry=ledEntry, eowSinkPtr=eowSinkPtr, laserTxEnable=laserTxEnable, boardInsertFamily=boardInsertFamily, laser=laser, eowSrcType=eowSrcType, hardInventoryEntry=hardInventoryEntry, board=board, softInventoryType=softInventoryType, boardActive=boardActive, boardListIndex=boardListIndex, laserALSRestart2s=laserALSRestart2s, ledStatus=ledStatus, eowSrcPtr=eowSrcPtr, softInv=softInv, hardInventoryNumber=hardInventoryNumber, eow=eow, HoldTime=HoldTime, led=led, adrHotReset=adrHotReset, ProtectionType=ProtectionType, PYSNMP_MODULE_ID=shelf, boardExpectFamily=boardExpectFamily, softInventoryEntry=softInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, laserTable=laserTable, eowSinkType=eowSinkType, eowEntry=eowEntry, boardListNumber=boardListNumber, ledTable=ledTable, boardMismatchSev=boardMismatchSev, eowTable=eowTable, laserIndex=laserIndex, boardList=boardList, eowClockMode=eowClockMode, boardExpectType=boardExpectType, softInventoryIndex=softInventoryIndex, boardFailure=boardFailure, LedType=LedType, boardListType=boardListType, boardListEntry=boardListEntry, ledNumber=ledNumber, boardInsertType=boardInsertType, adrFailHoldOnTime=adrFailHoldOnTime, boardNumber=boardNumber, boardEntry=boardEntry, boardTable=boardTable, boardListTable=boardListTable, softInventoryBoard=softInventoryBoard, softInventoryNumber=softInventoryNumber, holdTime=holdTime, hardInventoryBoard=hardInventoryBoard, boardListSlot=boardListSlot, laserEntry=laserEntry)
