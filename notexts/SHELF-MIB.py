...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryDescr=hardInventoryDescr, softInv=softInv, hardInventoryNumber=hardInventoryNumber, boardList=boardList, softInventoryBoard=softInventoryBoard, boardEntry=boardEntry, eowTable=eowTable, softInventoryEntry=softInventoryEntry, ledTable=ledTable, softInventoryIndex=softInventoryIndex, BoardFailure=BoardFailure, adrHotReset=adrHotReset, ledEntry=ledEntry, eowSinkPtr=eowSinkPtr, laserEntry=laserEntry, boardSeverity=boardSeverity, led=led, laser=laser, hardInventoryBoard=hardInventoryBoard, laserTable=laserTable, eow=eow, boardTable=boardTable, ProtectionType=ProtectionType, hardInventoryTable=hardInventoryTable, boardListSlot=boardListSlot, laserALSRestart90s=laserALSRestart90s, laserTxEnable=laserTxEnable, boardExpectType=boardExpectType, eowIndex=eowIndex, laserALSRestart2s=laserALSRestart2s, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, boardDefectiveSev=boardDefectiveSev, boardListTable=boardListTable, boardInsertType=boardInsertType, board=board, shelf=shelf, eowSinkType=eowSinkType, ledStatus=ledStatus, EOWClockMode=EOWClockMode, boardActive=boardActive, eowSrcPtr=eowSrcPtr, ledType=ledType, laserALSEnable=laserALSEnable, hardInventoryEntry=hardInventoryEntry, eowSrcType=eowSrcType, boardListNumber=boardListNumber, softInventoryType=softInventoryType, boardExpectFamily=boardExpectFamily, hardInv=hardInv, boardListEntry=boardListEntry, ledPosition=ledPosition, eowNumber=eowNumber, softInventoryExt=softInventoryExt, boardFailure=boardFailure, boardSlotName=boardSlotName, boardMissingSev=boardMissingSev, boardInsertFamily=boardInsertFamily, boardListIndex=boardListIndex, adrFailHoldOffTime=adrFailHoldOffTime, boardListType=boardListType, adrFailHoldOnTime=adrFailHoldOnTime, eowName=eowName, LedStatus=LedStatus, holdTime=holdTime, laserIndex=laserIndex, hardInventoryIndex=hardInventoryIndex, softInventoryNumber=softInventoryNumber, boardIndex=boardIndex, eowClockMode=eowClockMode, HoldTime=HoldTime, LedType=LedType, laserNumber=laserNumber, ledNumber=ledNumber, boardNumber=boardNumber, softInventoryTable=softInventoryTable, boardMismatchSev=boardMismatchSev, PYSNMP_MODULE_ID=shelf, eowEntry=eowEntry, ledIndex=ledIndex, boardProtectionType=boardProtectionType, softInventoryCode=softInventoryCode, EOWType=EOWType)
