...
mibBuilder.exportSymbols("SHELF-MIB", boardListSlot=boardListSlot, boardSeverity=boardSeverity, boardTable=boardTable, ledStatus=ledStatus, LedStatus=LedStatus, laserALSRestart90s=laserALSRestart90s, boardListIndex=boardListIndex, led=led, boardListNumber=boardListNumber, boardExpectFamily=boardExpectFamily, boardFirstPortIndex=boardFirstPortIndex, hardInventoryTable=hardInventoryTable, boardList=boardList, boardInsertFamily=boardInsertFamily, laserEntry=laserEntry, hardInv=hardInv, softInv=softInv, ledIndex=ledIndex, boardMonitor=boardMonitor, laserTxEnable=laserTxEnable, ledNumber=ledNumber, boardProtectionType=boardProtectionType, boardActive=boardActive, hardInventoryBoard=hardInventoryBoard, shelf=shelf, laser=laser, softInventoryExt=softInventoryExt, laserIndex=laserIndex, softInventoryEntry=softInventoryEntry, BoardFailure=BoardFailure, adrHotReset=adrHotReset, boardDefectiveSev=boardDefectiveSev, hardInventoryDescr=hardInventoryDescr, laserTable=laserTable, boardExpectType=boardExpectType, ProtectionType=ProtectionType, softInventoryTable=softInventoryTable, boardInsertType=boardInsertType, eowEntry=eowEntry, softInventoryNumber=softInventoryNumber, eowClockMode=eowClockMode, eowSinkType=eowSinkType, boardIndex=boardIndex, softInventoryCode=softInventoryCode, ledEntry=ledEntry, hardInventoryEntry=hardInventoryEntry, softInventoryBoard=softInventoryBoard, HoldTime=HoldTime, hardInventoryIndex=hardInventoryIndex, eowSinkPtr=eowSinkPtr, adrFailHoldOffTime=adrFailHoldOffTime, boardNumber=boardNumber, eowNumber=eowNumber, ledType=ledType, LedType=LedType, eowName=eowName, PYSNMP_MODULE_ID=shelf, boardFailure=boardFailure, boardEntry=boardEntry, boardListEntry=boardListEntry, EOWType=EOWType, softInventoryType=softInventoryType, laserNumber=laserNumber, hardInventoryNumber=hardInventoryNumber, laserALSEnable=laserALSEnable, eow=eow, board=board, boardMismatchSev=boardMismatchSev, ledTable=ledTable, eowSrcType=eowSrcType, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryIndex=softInventoryIndex, ledPosition=ledPosition, eowTable=eowTable, boardMissingSev=boardMissingSev, boardSlotName=boardSlotName, holdTime=holdTime, boardListType=boardListType, eowSrcPtr=eowSrcPtr, boardListTable=boardListTable, eowIndex=eowIndex, laserALSRestart2s=laserALSRestart2s, EOWClockMode=EOWClockMode)
