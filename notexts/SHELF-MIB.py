...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryIndex=hardInventoryIndex, EOWClockMode=EOWClockMode, adrFailHoldOffTime=adrFailHoldOffTime, holdTime=holdTime, boardExpectType=boardExpectType, hardInventoryBoard=hardInventoryBoard, ledEntry=ledEntry, boardTable=boardTable, LedStatus=LedStatus, ledPosition=ledPosition, boardEntry=boardEntry, boardList=boardList, softInv=softInv, boardMonitor=boardMonitor, softInventoryEntry=softInventoryEntry, ledType=ledType, ledIndex=ledIndex, HoldTime=HoldTime, hardInv=hardInv, eow=eow, ProtectionType=ProtectionType, softInventoryType=softInventoryType, boardProtectionType=boardProtectionType, BoardFailure=BoardFailure, eowSrcPtr=eowSrcPtr, boardListTable=boardListTable, eowSinkPtr=eowSinkPtr, softInventoryCode=softInventoryCode, softInventoryNumber=softInventoryNumber, hardInventoryNumber=hardInventoryNumber, ledStatus=ledStatus, eowClockMode=eowClockMode, boardInsertType=boardInsertType, laserTxEnable=laserTxEnable, led=led, softInventoryBoard=softInventoryBoard, PYSNMP_MODULE_ID=shelf, boardListSlot=boardListSlot, boardFirstPortIndex=boardFirstPortIndex, eowSrcType=eowSrcType, boardSlotName=boardSlotName, boardIndex=boardIndex, eowNumber=eowNumber, eowIndex=eowIndex, laser=laser, boardListEntry=boardListEntry, eowName=eowName, laserTable=laserTable, boardListNumber=boardListNumber, hardInventoryDescr=hardInventoryDescr, board=board, boardNumber=boardNumber, boardExpectFamily=boardExpectFamily, LedType=LedType, eowEntry=eowEntry, laserALSRestart90s=laserALSRestart90s, boardSeverity=boardSeverity, adrFailHoldOnTime=adrFailHoldOnTime, boardListType=boardListType, laserNumber=laserNumber, boardMismatchSev=boardMismatchSev, shelf=shelf, laserALSRestart2s=laserALSRestart2s, softInventoryExt=softInventoryExt, eowSinkType=eowSinkType, hardInventoryEntry=hardInventoryEntry, boardActive=boardActive, laserIndex=laserIndex, boardListIndex=boardListIndex, hardInventoryTable=hardInventoryTable, boardDefectiveSev=boardDefectiveSev, softInventoryIndex=softInventoryIndex, ledTable=ledTable, EOWType=EOWType, eowTable=eowTable, boardInsertFamily=boardInsertFamily, laserALSEnable=laserALSEnable, laserEntry=laserEntry, softInventoryTable=softInventoryTable, adrHotReset=adrHotReset, boardMissingSev=boardMissingSev, ledNumber=ledNumber, boardFailure=boardFailure)
