...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryNumber=hardInventoryNumber, EOWType=EOWType, LedType=LedType, eowSrcType=eowSrcType, boardEntry=boardEntry, boardSlotName=boardSlotName, eow=eow, adrFailHoldOnTime=adrFailHoldOnTime, ledNumber=ledNumber, hardInventoryDescr=hardInventoryDescr, eowClockMode=eowClockMode, laser=laser, boardListType=boardListType, softInventoryType=softInventoryType, laserNumber=laserNumber, eowEntry=eowEntry, boardInsertFamily=boardInsertFamily, eowName=eowName, softInventoryBoard=softInventoryBoard, boardFirstPortIndex=boardFirstPortIndex, boardListTable=boardListTable, PYSNMP_MODULE_ID=shelf, boardInsertType=boardInsertType, boardTable=boardTable, ledStatus=ledStatus, boardListEntry=boardListEntry, hardInventoryTable=hardInventoryTable, softInventoryNumber=softInventoryNumber, softInventoryCode=softInventoryCode, shelf=shelf, softInventoryEntry=softInventoryEntry, holdTime=holdTime, eowNumber=eowNumber, laserIndex=laserIndex, laserTxEnable=laserTxEnable, laserTable=laserTable, boardExpectFamily=boardExpectFamily, ledIndex=ledIndex, ProtectionType=ProtectionType, BoardFailure=BoardFailure, boardSeverity=boardSeverity, eowTable=eowTable, ledEntry=ledEntry, eowIndex=eowIndex, LedStatus=LedStatus, boardList=boardList, boardListSlot=boardListSlot, laserALSRestart2s=laserALSRestart2s, boardMonitor=boardMonitor, softInventoryIndex=softInventoryIndex, boardIndex=boardIndex, boardFailure=boardFailure, boardExpectType=boardExpectType, hardInventoryEntry=hardInventoryEntry, eowSinkPtr=eowSinkPtr, boardMissingSev=boardMissingSev, HoldTime=HoldTime, boardActive=boardActive, ledTable=ledTable, eowSrcPtr=eowSrcPtr, boardListIndex=boardListIndex, boardListNumber=boardListNumber, softInv=softInv, hardInventoryBoard=hardInventoryBoard, board=board, hardInventoryIndex=hardInventoryIndex, eowSinkType=eowSinkType, led=led, adrFailHoldOffTime=adrFailHoldOffTime, hardInv=hardInv, boardDefectiveSev=boardDefectiveSev, adrHotReset=adrHotReset, softInventoryExt=softInventoryExt, ledType=ledType, EOWClockMode=EOWClockMode, boardMismatchSev=boardMismatchSev, laserEntry=laserEntry, boardProtectionType=boardProtectionType, ledPosition=ledPosition, boardNumber=boardNumber, laserALSEnable=laserALSEnable, softInventoryTable=softInventoryTable, laserALSRestart90s=laserALSRestart90s)
