...
mibBuilder.exportSymbols("SHELF-MIB", ledPosition=ledPosition, softInventoryCode=softInventoryCode, boardEntry=boardEntry, softInv=softInv, led=led, LedStatus=LedStatus, laserEntry=laserEntry, hardInv=hardInv, ledNumber=ledNumber, boardProtectionType=boardProtectionType, eowName=eowName, boardListType=boardListType, boardListNumber=boardListNumber, holdTime=holdTime, laserALSEnable=laserALSEnable, laserALSRestart90s=laserALSRestart90s, hardInventoryIndex=hardInventoryIndex, laserALSRestart2s=laserALSRestart2s, eowSrcPtr=eowSrcPtr, LedType=LedType, boardListIndex=boardListIndex, ledTable=ledTable, eowEntry=eowEntry, boardMonitor=boardMonitor, laserTxEnable=laserTxEnable, PYSNMP_MODULE_ID=shelf, eowSrcType=eowSrcType, eowSinkPtr=eowSinkPtr, boardExpectType=boardExpectType, softInventoryIndex=softInventoryIndex, boardExpectFamily=boardExpectFamily, boardListEntry=boardListEntry, boardTable=boardTable, boardIndex=boardIndex, ledStatus=ledStatus, boardList=boardList, hardInventoryTable=hardInventoryTable, boardSeverity=boardSeverity, softInventoryType=softInventoryType, hardInventoryEntry=hardInventoryEntry, softInventoryBoard=softInventoryBoard, boardInsertFamily=boardInsertFamily, boardFailure=boardFailure, laser=laser, boardDefectiveSev=boardDefectiveSev, boardListSlot=boardListSlot, adrHotReset=adrHotReset, adrFailHoldOnTime=adrFailHoldOnTime, boardFirstPortIndex=boardFirstPortIndex, ledEntry=ledEntry, ledIndex=ledIndex, BoardFailure=BoardFailure, shelf=shelf, ProtectionType=ProtectionType, HoldTime=HoldTime, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryBoard=hardInventoryBoard, eowSinkType=eowSinkType, ledType=ledType, boardMissingSev=boardMissingSev, hardInventoryDescr=hardInventoryDescr, eow=eow, softInventoryExt=softInventoryExt, laserNumber=laserNumber, boardNumber=boardNumber, hardInventoryNumber=hardInventoryNumber, boardActive=boardActive, softInventoryNumber=softInventoryNumber, boardInsertType=boardInsertType, boardSlotName=boardSlotName, laserIndex=laserIndex, eowClockMode=eowClockMode, EOWType=EOWType, softInventoryEntry=softInventoryEntry, EOWClockMode=EOWClockMode, eowIndex=eowIndex, board=board, laserTable=laserTable, boardMismatchSev=boardMismatchSev, boardListTable=boardListTable, eowNumber=eowNumber, eowTable=eowTable, softInventoryTable=softInventoryTable)
