...
mibBuilder.exportSymbols("SHELF-MIB", BoardFailure=BoardFailure, eowClockMode=eowClockMode, boardProtectionType=boardProtectionType, hardInv=hardInv, boardSlotName=boardSlotName, eowName=eowName, eowSinkType=eowSinkType, hardInventoryEntry=hardInventoryEntry, softInventoryBoard=softInventoryBoard, laserALSRestart2s=laserALSRestart2s, boardFirstPortIndex=boardFirstPortIndex, boardListIndex=boardListIndex, boardIndex=boardIndex, hardInventoryIndex=hardInventoryIndex, boardExpectFamily=boardExpectFamily, led=led, boardActive=boardActive, eowSrcPtr=eowSrcPtr, laserEntry=laserEntry, ledStatus=ledStatus, boardListNumber=boardListNumber, boardListType=boardListType, ledTable=ledTable, ledNumber=ledNumber, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryTable=hardInventoryTable, ledType=ledType, boardSeverity=boardSeverity, softInventoryIndex=softInventoryIndex, ledPosition=ledPosition, LedType=LedType, holdTime=holdTime, ProtectionType=ProtectionType, boardListTable=boardListTable, laser=laser, eowSinkPtr=eowSinkPtr, shelf=shelf, PYSNMP_MODULE_ID=shelf, softInventoryExt=softInventoryExt, eowEntry=eowEntry, boardDefectiveSev=boardDefectiveSev, boardFailure=boardFailure, LedStatus=LedStatus, ledEntry=ledEntry, EOWType=EOWType, boardListSlot=boardListSlot, boardList=boardList, ledIndex=ledIndex, hardInventoryDescr=hardInventoryDescr, board=board, boardEntry=boardEntry, boardMonitor=boardMonitor, eow=eow, adrHotReset=adrHotReset, boardNumber=boardNumber, boardInsertFamily=boardInsertFamily, boardListEntry=boardListEntry, softInventoryNumber=softInventoryNumber, eowSrcType=eowSrcType, softInventoryEntry=softInventoryEntry, boardMissingSev=boardMissingSev, eowNumber=eowNumber, laserTable=laserTable, hardInventoryNumber=hardInventoryNumber, adrFailHoldOnTime=adrFailHoldOnTime, boardTable=boardTable, hardInventoryBoard=hardInventoryBoard, EOWClockMode=EOWClockMode, eowIndex=eowIndex, softInv=softInv, laserALSEnable=laserALSEnable, laserIndex=laserIndex, softInventoryTable=softInventoryTable, laserTxEnable=laserTxEnable, softInventoryCode=softInventoryCode, HoldTime=HoldTime, softInventoryType=softInventoryType, laserALSRestart90s=laserALSRestart90s, boardMismatchSev=boardMismatchSev, boardExpectType=boardExpectType, laserNumber=laserNumber, eowTable=eowTable, boardInsertType=boardInsertType)
