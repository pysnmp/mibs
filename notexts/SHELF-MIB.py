...
mibBuilder.exportSymbols("SHELF-MIB", ledType=ledType, LedStatus=LedStatus, boardListEntry=boardListEntry, EOWClockMode=EOWClockMode, softInv=softInv, laserNumber=laserNumber, laserALSRestart2s=laserALSRestart2s, adrFailHoldOnTime=adrFailHoldOnTime, laserIndex=laserIndex, boardActive=boardActive, ledNumber=ledNumber, boardMismatchSev=boardMismatchSev, boardListSlot=boardListSlot, EOWType=EOWType, boardEntry=boardEntry, boardIndex=boardIndex, eowSinkType=eowSinkType, eowClockMode=eowClockMode, softInventoryIndex=softInventoryIndex, eowEntry=eowEntry, boardProtectionType=boardProtectionType, eowNumber=eowNumber, boardExpectFamily=boardExpectFamily, softInventoryCode=softInventoryCode, boardFirstPortIndex=boardFirstPortIndex, hardInv=hardInv, boardDefectiveSev=boardDefectiveSev, ledStatus=ledStatus, eowIndex=eowIndex, hardInventoryBoard=hardInventoryBoard, BoardFailure=BoardFailure, eowSrcPtr=eowSrcPtr, softInventoryExt=softInventoryExt, boardListNumber=boardListNumber, boardSlotName=boardSlotName, eowSrcType=eowSrcType, boardFailure=boardFailure, adrFailHoldOffTime=adrFailHoldOffTime, boardInsertType=boardInsertType, laserALSEnable=laserALSEnable, boardMonitor=boardMonitor, boardExpectType=boardExpectType, boardMissingSev=boardMissingSev, ledTable=ledTable, softInventoryTable=softInventoryTable, softInventoryBoard=softInventoryBoard, laserALSRestart90s=laserALSRestart90s, hardInventoryEntry=hardInventoryEntry, PYSNMP_MODULE_ID=shelf, softInventoryNumber=softInventoryNumber, boardListIndex=boardListIndex, hardInventoryTable=hardInventoryTable, boardList=boardList, eowName=eowName, holdTime=holdTime, adrHotReset=adrHotReset, laser=laser, laserTxEnable=laserTxEnable, hardInventoryDescr=hardInventoryDescr, eow=eow, ledPosition=ledPosition, laserTable=laserTable, led=led, eowSinkPtr=eowSinkPtr, boardNumber=boardNumber, LedType=LedType, laserEntry=laserEntry, shelf=shelf, ProtectionType=ProtectionType, softInventoryType=softInventoryType, boardSeverity=boardSeverity, eowTable=eowTable, ledEntry=ledEntry, boardListTable=boardListTable, boardListType=boardListType, hardInventoryNumber=hardInventoryNumber, HoldTime=HoldTime, boardInsertFamily=boardInsertFamily, ledIndex=ledIndex, boardTable=boardTable, hardInventoryIndex=hardInventoryIndex, board=board, softInventoryEntry=softInventoryEntry)
