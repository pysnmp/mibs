...
mibBuilder.exportSymbols("SHELF-MIB", boardProtectionType=boardProtectionType, softInventoryIndex=softInventoryIndex, eowSinkType=eowSinkType, softInv=softInv, laserALSEnable=laserALSEnable, boardListType=boardListType, hardInventoryDescr=hardInventoryDescr, ledEntry=ledEntry, board=board, eowSrcPtr=eowSrcPtr, laserALSRestart2s=laserALSRestart2s, EOWClockMode=EOWClockMode, PYSNMP_MODULE_ID=shelf, eowNumber=eowNumber, ledType=ledType, laserALSRestart90s=laserALSRestart90s, boardListTable=boardListTable, eowTable=eowTable, boardExpectFamily=boardExpectFamily, LedType=LedType, laserNumber=laserNumber, hardInventoryNumber=hardInventoryNumber, adrHotReset=adrHotReset, eowClockMode=eowClockMode, boardMismatchSev=boardMismatchSev, holdTime=holdTime, laserTxEnable=laserTxEnable, boardMonitor=boardMonitor, boardFailure=boardFailure, ledTable=ledTable, boardTable=boardTable, softInventoryNumber=softInventoryNumber, boardEntry=boardEntry, HoldTime=HoldTime, ProtectionType=ProtectionType, boardExpectType=boardExpectType, boardListSlot=boardListSlot, boardDefectiveSev=boardDefectiveSev, ledNumber=ledNumber, laser=laser, boardMissingSev=boardMissingSev, ledIndex=ledIndex, softInventoryBoard=softInventoryBoard, eowSrcType=eowSrcType, boardFirstPortIndex=boardFirstPortIndex, adrFailHoldOffTime=adrFailHoldOffTime, shelf=shelf, eowName=eowName, BoardFailure=BoardFailure, boardNumber=boardNumber, eowIndex=eowIndex, hardInventoryIndex=hardInventoryIndex, softInventoryCode=softInventoryCode, eow=eow, hardInv=hardInv, EOWType=EOWType, softInventoryTable=softInventoryTable, softInventoryExt=softInventoryExt, laserIndex=laserIndex, boardListIndex=boardListIndex, boardActive=boardActive, boardInsertType=boardInsertType, softInventoryType=softInventoryType, led=led, boardSlotName=boardSlotName, boardListEntry=boardListEntry, ledPosition=ledPosition, eowEntry=eowEntry, boardInsertFamily=boardInsertFamily, boardIndex=boardIndex, hardInventoryTable=hardInventoryTable, eowSinkPtr=eowSinkPtr, hardInventoryBoard=hardInventoryBoard, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryEntry=softInventoryEntry, laserTable=laserTable, hardInventoryEntry=hardInventoryEntry, ledStatus=ledStatus, boardSeverity=boardSeverity, boardListNumber=boardListNumber, LedStatus=LedStatus, boardList=boardList, laserEntry=laserEntry)
