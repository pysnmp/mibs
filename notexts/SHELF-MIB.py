...
mibBuilder.exportSymbols("SHELF-MIB", ledEntry=ledEntry, boardSeverity=boardSeverity, softInventoryEntry=softInventoryEntry, hardInventoryBoard=hardInventoryBoard, eowTable=eowTable, hardInventoryIndex=hardInventoryIndex, ledType=ledType, boardExpectFamily=boardExpectFamily, adrFailHoldOffTime=adrFailHoldOffTime, laserEntry=laserEntry, holdTime=holdTime, hardInventoryEntry=hardInventoryEntry, ledTable=ledTable, eowEntry=eowEntry, eow=eow, shelf=shelf, laserIndex=laserIndex, boardMissingSev=boardMissingSev, EOWClockMode=EOWClockMode, boardListEntry=boardListEntry, boardListIndex=boardListIndex, LedType=LedType, eowName=eowName, softInventoryIndex=softInventoryIndex, boardEntry=boardEntry, boardInsertType=boardInsertType, softInventoryTable=softInventoryTable, ledNumber=ledNumber, boardInsertFamily=boardInsertFamily, softInventoryCode=softInventoryCode, BoardFailure=BoardFailure, eowSrcPtr=eowSrcPtr, boardActive=boardActive, EOWType=EOWType, ProtectionType=ProtectionType, boardExpectType=boardExpectType, eowNumber=eowNumber, board=board, softInventoryExt=softInventoryExt, led=led, boardListSlot=boardListSlot, PYSNMP_MODULE_ID=shelf, boardNumber=boardNumber, softInv=softInv, boardMonitor=boardMonitor, boardFirstPortIndex=boardFirstPortIndex, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryDescr=hardInventoryDescr, boardFailure=boardFailure, laserTxEnable=laserTxEnable, ledIndex=ledIndex, softInventoryType=softInventoryType, laserALSRestart90s=laserALSRestart90s, eowSinkPtr=eowSinkPtr, hardInventoryTable=hardInventoryTable, eowSrcType=eowSrcType, laserALSRestart2s=laserALSRestart2s, adrHotReset=adrHotReset, LedStatus=LedStatus, softInventoryNumber=softInventoryNumber, boardTable=boardTable, eowClockMode=eowClockMode, HoldTime=HoldTime, laser=laser, boardDefectiveSev=boardDefectiveSev, laserTable=laserTable, eowSinkType=eowSinkType, ledPosition=ledPosition, softInventoryBoard=softInventoryBoard, boardIndex=boardIndex, boardProtectionType=boardProtectionType, boardListTable=boardListTable, hardInventoryNumber=hardInventoryNumber, laserNumber=laserNumber, hardInv=hardInv, eowIndex=eowIndex, boardListType=boardListType, laserALSEnable=laserALSEnable, boardMismatchSev=boardMismatchSev, ledStatus=ledStatus, boardSlotName=boardSlotName, boardList=boardList, boardListNumber=boardListNumber)
