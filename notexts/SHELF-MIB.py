...
mibBuilder.exportSymbols("SHELF-MIB", eowIndex=eowIndex, boardExpectType=boardExpectType, holdTime=holdTime, boardInsertType=boardInsertType, adrFailHoldOnTime=adrFailHoldOnTime, boardExpectFamily=boardExpectFamily, boardList=boardList, boardActive=boardActive, softInventoryIndex=softInventoryIndex, softInventoryExt=softInventoryExt, softInv=softInv, hardInventoryIndex=hardInventoryIndex, boardMismatchSev=boardMismatchSev, boardMonitor=boardMonitor, boardListSlot=boardListSlot, eowSinkPtr=eowSinkPtr, boardFirstPortIndex=boardFirstPortIndex, hardInventoryTable=hardInventoryTable, boardProtectionType=boardProtectionType, eowTable=eowTable, boardListTable=boardListTable, laserNumber=laserNumber, laserALSRestart90s=laserALSRestart90s, laser=laser, ledStatus=ledStatus, softInventoryType=softInventoryType, laserEntry=laserEntry, softInventoryCode=softInventoryCode, softInventoryBoard=softInventoryBoard, ledPosition=ledPosition, ledTable=ledTable, boardInsertFamily=boardInsertFamily, boardIndex=boardIndex, eowSrcPtr=eowSrcPtr, laserIndex=laserIndex, boardEntry=boardEntry, boardListEntry=boardListEntry, LedType=LedType, ledNumber=ledNumber, eowSrcType=eowSrcType, eowSinkType=eowSinkType, boardListNumber=boardListNumber, boardDefectiveSev=boardDefectiveSev, softInventoryNumber=softInventoryNumber, softInventoryTable=softInventoryTable, boardSeverity=boardSeverity, HoldTime=HoldTime, LedStatus=LedStatus, laserTable=laserTable, BoardFailure=BoardFailure, eowNumber=eowNumber, laserALSRestart2s=laserALSRestart2s, softInventoryEntry=softInventoryEntry, boardMissingSev=boardMissingSev, ledType=ledType, eowName=eowName, hardInventoryBoard=hardInventoryBoard, ledEntry=ledEntry, adrHotReset=adrHotReset, boardSlotName=boardSlotName, shelf=shelf, eowEntry=eowEntry, EOWClockMode=EOWClockMode, laserTxEnable=laserTxEnable, ledIndex=ledIndex, hardInv=hardInv, hardInventoryDescr=hardInventoryDescr, hardInventoryNumber=hardInventoryNumber, boardNumber=boardNumber, hardInventoryEntry=hardInventoryEntry, ProtectionType=ProtectionType, eowClockMode=eowClockMode, adrFailHoldOffTime=adrFailHoldOffTime, led=led, board=board, PYSNMP_MODULE_ID=shelf, boardFailure=boardFailure, boardListType=boardListType, EOWType=EOWType, laserALSEnable=laserALSEnable, eow=eow, boardListIndex=boardListIndex, boardTable=boardTable)
