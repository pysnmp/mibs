...
mibBuilder.exportSymbols("SHELF-MIB", boardTable=boardTable, boardFirstPortIndex=boardFirstPortIndex, laserIndex=laserIndex, boardIndex=boardIndex, softInventoryTable=softInventoryTable, laser=laser, hardInventoryIndex=hardInventoryIndex, softInventoryIndex=softInventoryIndex, hardInventoryNumber=hardInventoryNumber, eowName=eowName, laserALSRestart90s=laserALSRestart90s, ledEntry=ledEntry, adrFailHoldOnTime=adrFailHoldOnTime, LedType=LedType, boardExpectFamily=boardExpectFamily, softInventoryType=softInventoryType, boardListEntry=boardListEntry, BoardFailure=BoardFailure, boardDefectiveSev=boardDefectiveSev, boardExpectType=boardExpectType, ledTable=ledTable, ledNumber=ledNumber, eowSrcType=eowSrcType, adrHotReset=adrHotReset, PYSNMP_MODULE_ID=shelf, led=led, laserALSEnable=laserALSEnable, softInv=softInv, laserTxEnable=laserTxEnable, eowSrcPtr=eowSrcPtr, hardInventoryBoard=hardInventoryBoard, ledStatus=ledStatus, laserTable=laserTable, boardListType=boardListType, LedStatus=LedStatus, shelf=shelf, laserEntry=laserEntry, softInventoryCode=softInventoryCode, boardActive=boardActive, laserNumber=laserNumber, boardSlotName=boardSlotName, eowNumber=eowNumber, eowSinkType=eowSinkType, eowIndex=eowIndex, HoldTime=HoldTime, laserALSRestart2s=laserALSRestart2s, EOWType=EOWType, boardNumber=boardNumber, boardMismatchSev=boardMismatchSev, ledPosition=ledPosition, eowClockMode=eowClockMode, eowEntry=eowEntry, boardMissingSev=boardMissingSev, hardInventoryEntry=hardInventoryEntry, board=board, ProtectionType=ProtectionType, eowTable=eowTable, hardInventoryTable=hardInventoryTable, boardEntry=boardEntry, hardInventoryDescr=hardInventoryDescr, boardInsertFamily=boardInsertFamily, ledType=ledType, eowSinkPtr=eowSinkPtr, boardSeverity=boardSeverity, boardList=boardList, holdTime=holdTime, eow=eow, boardInsertType=boardInsertType, softInventoryEntry=softInventoryEntry, softInventoryBoard=softInventoryBoard, boardProtectionType=boardProtectionType, boardListNumber=boardListNumber, ledIndex=ledIndex, boardMonitor=boardMonitor, hardInv=hardInv, EOWClockMode=EOWClockMode, boardListIndex=boardListIndex, softInventoryExt=softInventoryExt, boardListTable=boardListTable, boardFailure=boardFailure, softInventoryNumber=softInventoryNumber, boardListSlot=boardListSlot, adrFailHoldOffTime=adrFailHoldOffTime)
