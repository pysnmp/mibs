...
mibBuilder.exportSymbols("SHELF-MIB", boardMonitor=boardMonitor, softInventoryIndex=softInventoryIndex, laserALSRestart90s=laserALSRestart90s, hardInventoryTable=hardInventoryTable, eowSinkType=eowSinkType, PYSNMP_MODULE_ID=shelf, ledTable=ledTable, EOWType=EOWType, boardInsertFamily=boardInsertFamily, hardInventoryEntry=hardInventoryEntry, boardActive=boardActive, eowTable=eowTable, eowEntry=eowEntry, boardListEntry=boardListEntry, hardInventoryBoard=hardInventoryBoard, adrHotReset=adrHotReset, softInventoryTable=softInventoryTable, ledEntry=ledEntry, boardMismatchSev=boardMismatchSev, softInventoryBoard=softInventoryBoard, ProtectionType=ProtectionType, ledType=ledType, eowSrcPtr=eowSrcPtr, boardIndex=boardIndex, boardListSlot=boardListSlot, holdTime=holdTime, eow=eow, boardDefectiveSev=boardDefectiveSev, softInventoryExt=softInventoryExt, softInventoryType=softInventoryType, softInv=softInv, hardInventoryNumber=hardInventoryNumber, boardSlotName=boardSlotName, adrFailHoldOffTime=adrFailHoldOffTime, eowIndex=eowIndex, boardListIndex=boardListIndex, eowNumber=eowNumber, laser=laser, ledIndex=ledIndex, boardList=boardList, hardInventoryIndex=hardInventoryIndex, boardExpectType=boardExpectType, boardTable=boardTable, laserNumber=laserNumber, ledNumber=ledNumber, boardProtectionType=boardProtectionType, shelf=shelf, laserALSEnable=laserALSEnable, hardInv=hardInv, hardInventoryDescr=hardInventoryDescr, LedStatus=LedStatus, laserEntry=laserEntry, boardListTable=boardListTable, boardMissingSev=boardMissingSev, laserTable=laserTable, softInventoryNumber=softInventoryNumber, boardEntry=boardEntry, LedType=LedType, boardExpectFamily=boardExpectFamily, softInventoryEntry=softInventoryEntry, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryCode=softInventoryCode, boardFailure=boardFailure, boardNumber=boardNumber, laserTxEnable=laserTxEnable, boardInsertType=boardInsertType, eowSinkPtr=eowSinkPtr, eowSrcType=eowSrcType, laserIndex=laserIndex, EOWClockMode=EOWClockMode, eowClockMode=eowClockMode, HoldTime=HoldTime, board=board, boardListType=boardListType, boardFirstPortIndex=boardFirstPortIndex, eowName=eowName, boardSeverity=boardSeverity, boardListNumber=boardListNumber, ledStatus=ledStatus, ledPosition=ledPosition, laserALSRestart2s=laserALSRestart2s, led=led, BoardFailure=BoardFailure)
