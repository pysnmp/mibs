...
mibBuilder.exportSymbols("SHELF-MIB", laserALSRestart90s=laserALSRestart90s, laserIndex=laserIndex, LedType=LedType, boardSlotName=boardSlotName, hardInv=hardInv, boardListIndex=boardListIndex, eowSrcType=eowSrcType, boardNumber=boardNumber, boardFailure=boardFailure, eowNumber=eowNumber, boardInsertType=boardInsertType, hardInventoryNumber=hardInventoryNumber, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryBoard=softInventoryBoard, shelf=shelf, eowIndex=eowIndex, adrHotReset=adrHotReset, EOWType=EOWType, boardMissingSev=boardMissingSev, HoldTime=HoldTime, hardInventoryDescr=hardInventoryDescr, boardEntry=boardEntry, eowSinkType=eowSinkType, eowSinkPtr=eowSinkPtr, hardInventoryIndex=hardInventoryIndex, boardExpectFamily=boardExpectFamily, board=board, hardInventoryBoard=hardInventoryBoard, BoardFailure=BoardFailure, adrFailHoldOnTime=adrFailHoldOnTime, boardListType=boardListType, boardIndex=boardIndex, LedStatus=LedStatus, boardActive=boardActive, eowTable=eowTable, boardFirstPortIndex=boardFirstPortIndex, eow=eow, boardListTable=boardListTable, softInventoryTable=softInventoryTable, ProtectionType=ProtectionType, softInventoryEntry=softInventoryEntry, ledPosition=ledPosition, laser=laser, hardInventoryTable=hardInventoryTable, boardDefectiveSev=boardDefectiveSev, boardListSlot=boardListSlot, EOWClockMode=EOWClockMode, eowSrcPtr=eowSrcPtr, softInventoryExt=softInventoryExt, hardInventoryEntry=hardInventoryEntry, ledType=ledType, ledNumber=ledNumber, softInventoryNumber=softInventoryNumber, softInventoryCode=softInventoryCode, eowName=eowName, boardExpectType=boardExpectType, laserNumber=laserNumber, boardInsertFamily=boardInsertFamily, boardProtectionType=boardProtectionType, boardSeverity=boardSeverity, boardList=boardList, laserTable=laserTable, eowClockMode=eowClockMode, laserALSRestart2s=laserALSRestart2s, ledEntry=ledEntry, laserEntry=laserEntry, boardListEntry=boardListEntry, boardMismatchSev=boardMismatchSev, eowEntry=eowEntry, softInv=softInv, led=led, ledStatus=ledStatus, ledTable=ledTable, softInventoryType=softInventoryType, holdTime=holdTime, softInventoryIndex=softInventoryIndex, laserTxEnable=laserTxEnable, PYSNMP_MODULE_ID=shelf, boardListNumber=boardListNumber, ledIndex=ledIndex, boardMonitor=boardMonitor, boardTable=boardTable, laserALSEnable=laserALSEnable)
