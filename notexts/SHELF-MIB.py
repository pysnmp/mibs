...
mibBuilder.exportSymbols("SHELF-MIB", laserALSEnable=laserALSEnable, boardListNumber=boardListNumber, EOWClockMode=EOWClockMode, hardInventoryNumber=hardInventoryNumber, softInventoryNumber=softInventoryNumber, ledType=ledType, boardSeverity=boardSeverity, eowSinkPtr=eowSinkPtr, BoardFailure=BoardFailure, boardDefectiveSev=boardDefectiveSev, laserTxEnable=laserTxEnable, HoldTime=HoldTime, boardListEntry=boardListEntry, softInventoryCode=softInventoryCode, ledStatus=ledStatus, eowSrcPtr=eowSrcPtr, boardInsertType=boardInsertType, eowEntry=eowEntry, boardIndex=boardIndex, softInventoryExt=softInventoryExt, boardTable=boardTable, hardInventoryEntry=hardInventoryEntry, ledTable=ledTable, holdTime=holdTime, laserIndex=laserIndex, softInventoryIndex=softInventoryIndex, softInv=softInv, boardSlotName=boardSlotName, eowSrcType=eowSrcType, boardListTable=boardListTable, eowIndex=eowIndex, boardList=boardList, boardProtectionType=boardProtectionType, boardMonitor=boardMonitor, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryTable=hardInventoryTable, softInventoryType=softInventoryType, laserALSRestart2s=laserALSRestart2s, laserNumber=laserNumber, board=board, hardInventoryDescr=hardInventoryDescr, laserALSRestart90s=laserALSRestart90s, LedStatus=LedStatus, ledIndex=ledIndex, laserTable=laserTable, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryBoard=hardInventoryBoard, boardExpectFamily=boardExpectFamily, eowClockMode=eowClockMode, LedType=LedType, laserEntry=laserEntry, boardMismatchSev=boardMismatchSev, softInventoryBoard=softInventoryBoard, eowTable=eowTable, boardListSlot=boardListSlot, eowNumber=eowNumber, softInventoryEntry=softInventoryEntry, laser=laser, hardInv=hardInv, boardActive=boardActive, led=led, EOWType=EOWType, ledNumber=ledNumber, eowSinkType=eowSinkType, ledEntry=ledEntry, eowName=eowName, boardListType=boardListType, eow=eow, adrHotReset=adrHotReset, boardMissingSev=boardMissingSev, shelf=shelf, PYSNMP_MODULE_ID=shelf, boardNumber=boardNumber, softInventoryTable=softInventoryTable, ProtectionType=ProtectionType, boardFailure=boardFailure, hardInventoryIndex=hardInventoryIndex, boardListIndex=boardListIndex, boardFirstPortIndex=boardFirstPortIndex, boardEntry=boardEntry, ledPosition=ledPosition, boardExpectType=boardExpectType, boardInsertFamily=boardInsertFamily)
