...
mibBuilder.exportSymbols("SHELF-MIB", laserEntry=laserEntry, laserALSRestart2s=laserALSRestart2s, hardInventoryIndex=hardInventoryIndex, ledTable=ledTable, board=board, softInventoryBoard=softInventoryBoard, boardInsertFamily=boardInsertFamily, boardExpectType=boardExpectType, hardInventoryDescr=hardInventoryDescr, BoardFailure=BoardFailure, hardInv=hardInv, eowSrcPtr=eowSrcPtr, LedType=LedType, eow=eow, boardSlotName=boardSlotName, boardInsertType=boardInsertType, boardListNumber=boardListNumber, HoldTime=HoldTime, boardProtectionType=boardProtectionType, laserIndex=laserIndex, ledPosition=ledPosition, ledStatus=ledStatus, boardExpectFamily=boardExpectFamily, hardInventoryBoard=hardInventoryBoard, laser=laser, boardSeverity=boardSeverity, eowName=eowName, hardInventoryTable=hardInventoryTable, eowNumber=eowNumber, eowSrcType=eowSrcType, led=led, eowClockMode=eowClockMode, boardActive=boardActive, boardListIndex=boardListIndex, eowIndex=eowIndex, hardInventoryNumber=hardInventoryNumber, boardListType=boardListType, eowEntry=eowEntry, boardListTable=boardListTable, boardList=boardList, softInventoryNumber=softInventoryNumber, eowSinkType=eowSinkType, softInventoryIndex=softInventoryIndex, LedStatus=LedStatus, softInventoryEntry=softInventoryEntry, boardNumber=boardNumber, boardMismatchSev=boardMismatchSev, PYSNMP_MODULE_ID=shelf, softInventoryTable=softInventoryTable, hardInventoryEntry=hardInventoryEntry, boardListEntry=boardListEntry, ledType=ledType, softInventoryType=softInventoryType, ledIndex=ledIndex, softInv=softInv, boardMissingSev=boardMissingSev, boardTable=boardTable, softInventoryCode=softInventoryCode, ProtectionType=ProtectionType, ledNumber=ledNumber, laserALSEnable=laserALSEnable, boardEntry=boardEntry, laserNumber=laserNumber, adrHotReset=adrHotReset, laserALSRestart90s=laserALSRestart90s, laserTxEnable=laserTxEnable, EOWClockMode=EOWClockMode, eowTable=eowTable, adrFailHoldOffTime=adrFailHoldOffTime, boardFailure=boardFailure, boardDefectiveSev=boardDefectiveSev, EOWType=EOWType, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, adrFailHoldOnTime=adrFailHoldOnTime, laserTable=laserTable, holdTime=holdTime, boardIndex=boardIndex, boardListSlot=boardListSlot, ledEntry=ledEntry, shelf=shelf, eowSinkPtr=eowSinkPtr, softInventoryExt=softInventoryExt)
