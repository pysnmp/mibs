...
mibBuilder.exportSymbols("SHELF-MIB", laserALSRestart2s=laserALSRestart2s, laserALSRestart90s=laserALSRestart90s, led=led, adrFailHoldOffTime=adrFailHoldOffTime, boardEntry=boardEntry, eowSinkPtr=eowSinkPtr, hardInventoryNumber=hardInventoryNumber, boardInsertType=boardInsertType, boardExpectFamily=boardExpectFamily, LedStatus=LedStatus, boardListNumber=boardListNumber, boardListIndex=boardListIndex, softInventoryCode=softInventoryCode, eowSrcPtr=eowSrcPtr, holdTime=holdTime, boardSeverity=boardSeverity, ledIndex=ledIndex, softInventoryNumber=softInventoryNumber, boardExpectType=boardExpectType, ledPosition=ledPosition, laser=laser, PYSNMP_MODULE_ID=shelf, ledNumber=ledNumber, boardMonitor=boardMonitor, softInventoryIndex=softInventoryIndex, ledEntry=ledEntry, boardMismatchSev=boardMismatchSev, softInventoryBoard=softInventoryBoard, EOWClockMode=EOWClockMode, boardSlotName=boardSlotName, ledStatus=ledStatus, laserIndex=laserIndex, boardDefectiveSev=boardDefectiveSev, eowNumber=eowNumber, eowSinkType=eowSinkType, boardTable=boardTable, softInventoryExt=softInventoryExt, board=board, shelf=shelf, EOWType=EOWType, eowClockMode=eowClockMode, boardFirstPortIndex=boardFirstPortIndex, hardInventoryDescr=hardInventoryDescr, boardFailure=boardFailure, ProtectionType=ProtectionType, laserNumber=laserNumber, BoardFailure=BoardFailure, boardIndex=boardIndex, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryTable=softInventoryTable, adrHotReset=adrHotReset, eow=eow, softInventoryEntry=softInventoryEntry, LedType=LedType, eowSrcType=eowSrcType, boardListEntry=boardListEntry, laserALSEnable=laserALSEnable, boardListTable=boardListTable, boardMissingSev=boardMissingSev, ledType=ledType, boardInsertFamily=boardInsertFamily, eowEntry=eowEntry, boardListSlot=boardListSlot, boardNumber=boardNumber, hardInventoryTable=hardInventoryTable, boardList=boardList, HoldTime=HoldTime, hardInventoryIndex=hardInventoryIndex, hardInventoryEntry=hardInventoryEntry, eowTable=eowTable, softInventoryType=softInventoryType, eowName=eowName, laserTable=laserTable, boardListType=boardListType, hardInv=hardInv, laserTxEnable=laserTxEnable, boardActive=boardActive, boardProtectionType=boardProtectionType, ledTable=ledTable, softInv=softInv, hardInventoryBoard=hardInventoryBoard, laserEntry=laserEntry, eowIndex=eowIndex)
