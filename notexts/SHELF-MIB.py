...
mibBuilder.exportSymbols("SHELF-MIB", eowSinkPtr=eowSinkPtr, boardListIndex=boardListIndex, boardExpectFamily=boardExpectFamily, laserALSEnable=laserALSEnable, holdTime=holdTime, ledTable=ledTable, EOWClockMode=EOWClockMode, eowIndex=eowIndex, hardInventoryTable=hardInventoryTable, boardSeverity=boardSeverity, eowNumber=eowNumber, laserALSRestart2s=laserALSRestart2s, softInv=softInv, hardInventoryBoard=hardInventoryBoard, hardInventoryIndex=hardInventoryIndex, hardInventoryNumber=hardInventoryNumber, boardListSlot=boardListSlot, ledIndex=ledIndex, softInventoryEntry=softInventoryEntry, LedType=LedType, boardInsertFamily=boardInsertFamily, ledNumber=ledNumber, eowClockMode=eowClockMode, boardEntry=boardEntry, boardInsertType=boardInsertType, HoldTime=HoldTime, softInventoryIndex=softInventoryIndex, boardFailure=boardFailure, ProtectionType=ProtectionType, eowEntry=eowEntry, laserTable=laserTable, EOWType=EOWType, eowTable=eowTable, softInventoryTable=softInventoryTable, adrHotReset=adrHotReset, shelf=shelf, boardNumber=boardNumber, boardListTable=boardListTable, laserALSRestart90s=laserALSRestart90s, ledStatus=ledStatus, eowSrcType=eowSrcType, laserEntry=laserEntry, boardTable=boardTable, laser=laser, ledEntry=ledEntry, boardListEntry=boardListEntry, BoardFailure=BoardFailure, softInventoryCode=softInventoryCode, softInventoryNumber=softInventoryNumber, laserNumber=laserNumber, eowName=eowName, led=led, adrFailHoldOnTime=adrFailHoldOnTime, softInventoryType=softInventoryType, ledPosition=ledPosition, LedStatus=LedStatus, hardInventoryDescr=hardInventoryDescr, boardMissingSev=boardMissingSev, boardExpectType=boardExpectType, ledType=ledType, laserTxEnable=laserTxEnable, PYSNMP_MODULE_ID=shelf, boardList=boardList, boardListNumber=boardListNumber, boardActive=boardActive, softInventoryExt=softInventoryExt, boardFirstPortIndex=boardFirstPortIndex, eowSinkType=eowSinkType, adrFailHoldOffTime=adrFailHoldOffTime, boardDefectiveSev=boardDefectiveSev, laserIndex=laserIndex, board=board, eow=eow, softInventoryBoard=softInventoryBoard, hardInv=hardInv, eowSrcPtr=eowSrcPtr, boardMismatchSev=boardMismatchSev, boardListType=boardListType, boardIndex=boardIndex, boardMonitor=boardMonitor, hardInventoryEntry=hardInventoryEntry, boardProtectionType=boardProtectionType, boardSlotName=boardSlotName)
