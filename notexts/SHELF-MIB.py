...
mibBuilder.exportSymbols("SHELF-MIB", adrFailHoldOnTime=adrFailHoldOnTime, holdTime=holdTime, LedStatus=LedStatus, boardTable=boardTable, boardInsertType=boardInsertType, boardSlotName=boardSlotName, boardSeverity=boardSeverity, boardDefectiveSev=boardDefectiveSev, BoardFailure=BoardFailure, boardMismatchSev=boardMismatchSev, boardList=boardList, softInventoryBoard=softInventoryBoard, laserTxEnable=laserTxEnable, eowSinkPtr=eowSinkPtr, eowSrcType=eowSrcType, hardInv=hardInv, eowName=eowName, shelf=shelf, boardInsertFamily=boardInsertFamily, boardListSlot=boardListSlot, hardInventoryTable=hardInventoryTable, hardInventoryBoard=hardInventoryBoard, boardActive=boardActive, boardListNumber=boardListNumber, boardListEntry=boardListEntry, eowNumber=eowNumber, eowClockMode=eowClockMode, boardListTable=boardListTable, ledType=ledType, softInv=softInv, adrFailHoldOffTime=adrFailHoldOffTime, boardMonitor=boardMonitor, boardIndex=boardIndex, EOWType=EOWType, hardInventoryEntry=hardInventoryEntry, HoldTime=HoldTime, ledEntry=ledEntry, laserTable=laserTable, ledStatus=ledStatus, ledNumber=ledNumber, eow=eow, LedType=LedType, softInventoryTable=softInventoryTable, boardListIndex=boardListIndex, laserNumber=laserNumber, laserALSEnable=laserALSEnable, ledTable=ledTable, board=board, boardFirstPortIndex=boardFirstPortIndex, boardEntry=boardEntry, ProtectionType=ProtectionType, ledIndex=ledIndex, eowIndex=eowIndex, softInventoryExt=softInventoryExt, eowTable=eowTable, hardInventoryDescr=hardInventoryDescr, laserIndex=laserIndex, softInventoryCode=softInventoryCode, led=led, laserEntry=laserEntry, boardExpectType=boardExpectType, boardFailure=boardFailure, softInventoryIndex=softInventoryIndex, softInventoryEntry=softInventoryEntry, laser=laser, EOWClockMode=EOWClockMode, boardListType=boardListType, ledPosition=ledPosition, eowSinkType=eowSinkType, softInventoryType=softInventoryType, PYSNMP_MODULE_ID=shelf, eowEntry=eowEntry, hardInventoryNumber=hardInventoryNumber, hardInventoryIndex=hardInventoryIndex, eowSrcPtr=eowSrcPtr, boardNumber=boardNumber, adrHotReset=adrHotReset, boardMissingSev=boardMissingSev, laserALSRestart2s=laserALSRestart2s, softInventoryNumber=softInventoryNumber, boardProtectionType=boardProtectionType, boardExpectFamily=boardExpectFamily, laserALSRestart90s=laserALSRestart90s)
