...
mibBuilder.exportSymbols("SHELF-MIB", boardActive=boardActive, ledIndex=ledIndex, boardFailure=boardFailure, boardProtectionType=boardProtectionType, ledTable=ledTable, laserIndex=laserIndex, laserEntry=laserEntry, boardDefectiveSev=boardDefectiveSev, boardExpectFamily=boardExpectFamily, ledType=ledType, ledEntry=ledEntry, boardList=boardList, softInventoryNumber=softInventoryNumber, boardInsertFamily=boardInsertFamily, softInv=softInv, hardInventoryNumber=hardInventoryNumber, eow=eow, hardInventoryBoard=hardInventoryBoard, eowTable=eowTable, ledPosition=ledPosition, eowName=eowName, EOWType=EOWType, eowSinkPtr=eowSinkPtr, boardTable=boardTable, adrFailHoldOffTime=adrFailHoldOffTime, boardListIndex=boardListIndex, eowIndex=eowIndex, EOWClockMode=EOWClockMode, boardIndex=boardIndex, boardMissingSev=boardMissingSev, eowNumber=eowNumber, led=led, hardInventoryDescr=hardInventoryDescr, PYSNMP_MODULE_ID=shelf, laserTxEnable=laserTxEnable, boardListTable=boardListTable, ledStatus=ledStatus, laser=laser, hardInv=hardInv, softInventoryType=softInventoryType, boardSeverity=boardSeverity, laserALSRestart90s=laserALSRestart90s, ProtectionType=ProtectionType, eowSrcPtr=eowSrcPtr, softInventoryCode=softInventoryCode, eowEntry=eowEntry, boardMismatchSev=boardMismatchSev, eowSinkType=eowSinkType, laserALSEnable=laserALSEnable, laserALSRestart2s=laserALSRestart2s, softInventoryTable=softInventoryTable, hardInventoryEntry=hardInventoryEntry, hardInventoryIndex=hardInventoryIndex, boardEntry=boardEntry, boardSlotName=boardSlotName, boardListSlot=boardListSlot, eowClockMode=eowClockMode, ledNumber=ledNumber, boardListType=boardListType, laserNumber=laserNumber, LedStatus=LedStatus, softInventoryBoard=softInventoryBoard, shelf=shelf, boardInsertType=boardInsertType, holdTime=holdTime, hardInventoryTable=hardInventoryTable, boardExpectType=boardExpectType, BoardFailure=BoardFailure, boardListNumber=boardListNumber, boardNumber=boardNumber, softInventoryEntry=softInventoryEntry, HoldTime=HoldTime, laserTable=laserTable, adrHotReset=adrHotReset, softInventoryIndex=softInventoryIndex, LedType=LedType, boardListEntry=boardListEntry, eowSrcType=eowSrcType, adrFailHoldOnTime=adrFailHoldOnTime, board=board, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, softInventoryExt=softInventoryExt)
