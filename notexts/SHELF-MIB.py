...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryBoard=softInventoryBoard, led=led, softInventoryCode=softInventoryCode, softInventoryNumber=softInventoryNumber, softInv=softInv, ledPosition=ledPosition, boardTable=boardTable, eowSinkType=eowSinkType, eow=eow, adrFailHoldOffTime=adrFailHoldOffTime, eowSinkPtr=eowSinkPtr, boardSlotName=boardSlotName, boardFailure=boardFailure, hardInventoryIndex=hardInventoryIndex, softInventoryIndex=softInventoryIndex, laserNumber=laserNumber, HoldTime=HoldTime, ledStatus=ledStatus, boardMismatchSev=boardMismatchSev, LedType=LedType, softInventoryType=softInventoryType, boardEntry=boardEntry, BoardFailure=BoardFailure, laserEntry=laserEntry, laserALSRestart90s=laserALSRestart90s, softInventoryTable=softInventoryTable, eowName=eowName, boardListSlot=boardListSlot, eowTable=eowTable, hardInventoryEntry=hardInventoryEntry, boardProtectionType=boardProtectionType, softInventoryExt=softInventoryExt, shelf=shelf, eowSrcType=eowSrcType, board=board, hardInventoryNumber=hardInventoryNumber, hardInventoryDescr=hardInventoryDescr, boardExpectFamily=boardExpectFamily, boardIndex=boardIndex, ledNumber=ledNumber, boardListNumber=boardListNumber, boardListEntry=boardListEntry, boardSeverity=boardSeverity, eowIndex=eowIndex, boardActive=boardActive, laserALSRestart2s=laserALSRestart2s, boardDefectiveSev=boardDefectiveSev, EOWClockMode=EOWClockMode, hardInv=hardInv, softInventoryEntry=softInventoryEntry, ledIndex=ledIndex, boardListIndex=boardListIndex, boardInsertType=boardInsertType, adrFailHoldOnTime=adrFailHoldOnTime, laser=laser, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, boardExpectType=boardExpectType, EOWType=EOWType, boardList=boardList, PYSNMP_MODULE_ID=shelf, ProtectionType=ProtectionType, hardInventoryTable=hardInventoryTable, eowNumber=eowNumber, boardListType=boardListType, LedStatus=LedStatus, eowEntry=eowEntry, ledTable=ledTable, boardMissingSev=boardMissingSev, ledEntry=ledEntry, adrHotReset=adrHotReset, holdTime=holdTime, eowClockMode=eowClockMode, laserTxEnable=laserTxEnable, hardInventoryBoard=hardInventoryBoard, eowSrcPtr=eowSrcPtr, ledType=ledType, boardListTable=boardListTable, boardNumber=boardNumber, laserIndex=laserIndex, laserTable=laserTable, boardInsertFamily=boardInsertFamily, laserALSEnable=laserALSEnable)
