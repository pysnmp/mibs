...
mibBuilder.exportSymbols("SHELF-MIB", HoldTime=HoldTime, PYSNMP_MODULE_ID=shelf, softInventoryExt=softInventoryExt, laserEntry=laserEntry, boardExpectFamily=boardExpectFamily, ledTable=ledTable, boardActive=boardActive, boardSlotName=boardSlotName, hardInv=hardInv, boardList=boardList, eowTable=eowTable, BoardFailure=BoardFailure, softInventoryEntry=softInventoryEntry, ledIndex=ledIndex, eowSinkPtr=eowSinkPtr, laserALSRestart2s=laserALSRestart2s, board=board, eowIndex=eowIndex, laserALSRestart90s=laserALSRestart90s, hardInventoryEntry=hardInventoryEntry, boardInsertType=boardInsertType, boardInsertFamily=boardInsertFamily, boardListIndex=boardListIndex, boardListSlot=boardListSlot, holdTime=holdTime, boardListEntry=boardListEntry, hardInventoryBoard=hardInventoryBoard, eowNumber=eowNumber, hardInventoryDescr=hardInventoryDescr, eowClockMode=eowClockMode, EOWClockMode=EOWClockMode, boardListTable=boardListTable, boardTable=boardTable, eowSrcType=eowSrcType, laserTable=laserTable, boardFirstPortIndex=boardFirstPortIndex, ProtectionType=ProtectionType, laserTxEnable=laserTxEnable, boardListType=boardListType, led=led, hardInventoryNumber=hardInventoryNumber, laserNumber=laserNumber, shelf=shelf, boardMonitor=boardMonitor, boardSeverity=boardSeverity, boardEntry=boardEntry, softInv=softInv, boardExpectType=boardExpectType, boardMissingSev=boardMissingSev, boardIndex=boardIndex, LedType=LedType, boardDefectiveSev=boardDefectiveSev, eowSrcPtr=eowSrcPtr, ledType=ledType, laserALSEnable=laserALSEnable, adrFailHoldOnTime=adrFailHoldOnTime, boardListNumber=boardListNumber, ledEntry=ledEntry, laser=laser, ledPosition=ledPosition, boardFailure=boardFailure, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryIndex=softInventoryIndex, EOWType=EOWType, hardInventoryTable=hardInventoryTable, hardInventoryIndex=hardInventoryIndex, eowSinkType=eowSinkType, softInventoryType=softInventoryType, eow=eow, boardProtectionType=boardProtectionType, softInventoryNumber=softInventoryNumber, boardNumber=boardNumber, adrHotReset=adrHotReset, softInventoryCode=softInventoryCode, eowName=eowName, ledNumber=ledNumber, laserIndex=laserIndex, boardMismatchSev=boardMismatchSev, eowEntry=eowEntry, softInventoryTable=softInventoryTable, ledStatus=ledStatus, LedStatus=LedStatus, softInventoryBoard=softInventoryBoard)
