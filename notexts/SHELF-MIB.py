...
mibBuilder.exportSymbols("SHELF-MIB", boardMissingSev=boardMissingSev, softInventoryTable=softInventoryTable, boardIndex=boardIndex, ledEntry=ledEntry, boardListType=boardListType, boardListTable=boardListTable, boardNumber=boardNumber, boardInsertType=boardInsertType, boardExpectType=boardExpectType, eowName=eowName, boardFirstPortIndex=boardFirstPortIndex, hardInventoryTable=hardInventoryTable, softInv=softInv, hardInventoryBoard=hardInventoryBoard, LedType=LedType, boardDefectiveSev=boardDefectiveSev, eow=eow, boardProtectionType=boardProtectionType, softInventoryEntry=softInventoryEntry, ledPosition=ledPosition, boardSlotName=boardSlotName, hardInv=hardInv, ledType=ledType, laser=laser, eowClockMode=eowClockMode, boardSeverity=boardSeverity, eowIndex=eowIndex, ledNumber=ledNumber, boardInsertFamily=boardInsertFamily, BoardFailure=BoardFailure, eowTable=eowTable, boardListSlot=boardListSlot, adrFailHoldOffTime=adrFailHoldOffTime, boardTable=boardTable, adrFailHoldOnTime=adrFailHoldOnTime, ledTable=ledTable, laserALSRestart90s=laserALSRestart90s, laserALSEnable=laserALSEnable, HoldTime=HoldTime, EOWType=EOWType, shelf=shelf, softInventoryType=softInventoryType, hardInventoryEntry=hardInventoryEntry, boardListNumber=boardListNumber, softInventoryExt=softInventoryExt, softInventoryCode=softInventoryCode, laserIndex=laserIndex, holdTime=holdTime, ledStatus=ledStatus, eowSrcType=eowSrcType, laserTxEnable=laserTxEnable, ProtectionType=ProtectionType, led=led, adrHotReset=adrHotReset, boardListIndex=boardListIndex, EOWClockMode=EOWClockMode, softInventoryIndex=softInventoryIndex, hardInventoryNumber=hardInventoryNumber, boardListEntry=boardListEntry, eowSrcPtr=eowSrcPtr, eowEntry=eowEntry, laserNumber=laserNumber, laserEntry=laserEntry, hardInventoryIndex=hardInventoryIndex, boardList=boardList, board=board, boardEntry=boardEntry, boardActive=boardActive, boardMonitor=boardMonitor, PYSNMP_MODULE_ID=shelf, softInventoryBoard=softInventoryBoard, eowSinkPtr=eowSinkPtr, softInventoryNumber=softInventoryNumber, boardExpectFamily=boardExpectFamily, hardInventoryDescr=hardInventoryDescr, eowNumber=eowNumber, eowSinkType=eowSinkType, ledIndex=ledIndex, laserALSRestart2s=laserALSRestart2s, boardMismatchSev=boardMismatchSev, boardFailure=boardFailure, LedStatus=LedStatus, laserTable=laserTable)
