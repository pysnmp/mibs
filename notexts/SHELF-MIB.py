...
mibBuilder.exportSymbols("SHELF-MIB", boardActive=boardActive, boardListSlot=boardListSlot, BoardFailure=BoardFailure, boardMonitor=boardMonitor, boardProtectionType=boardProtectionType, eowEntry=eowEntry, softInventoryType=softInventoryType, boardListIndex=boardListIndex, boardList=boardList, softInventoryEntry=softInventoryEntry, softInventoryIndex=softInventoryIndex, laserALSRestart90s=laserALSRestart90s, ledTable=ledTable, holdTime=holdTime, laserALSEnable=laserALSEnable, boardEntry=boardEntry, ProtectionType=ProtectionType, eowClockMode=eowClockMode, board=board, PYSNMP_MODULE_ID=shelf, eowSinkPtr=eowSinkPtr, LedType=LedType, boardMissingSev=boardMissingSev, ledIndex=ledIndex, softInventoryTable=softInventoryTable, EOWType=EOWType, eowSrcType=eowSrcType, HoldTime=HoldTime, softInv=softInv, laserEntry=laserEntry, boardFailure=boardFailure, hardInventoryTable=hardInventoryTable, boardExpectType=boardExpectType, softInventoryBoard=softInventoryBoard, boardIndex=boardIndex, softInventoryNumber=softInventoryNumber, boardListEntry=boardListEntry, eowSinkType=eowSinkType, ledStatus=ledStatus, boardListNumber=boardListNumber, boardListTable=boardListTable, hardInventoryIndex=hardInventoryIndex, led=led, adrFailHoldOnTime=adrFailHoldOnTime, boardExpectFamily=boardExpectFamily, hardInventoryBoard=hardInventoryBoard, eowIndex=eowIndex, eow=eow, laser=laser, boardTable=boardTable, adrHotReset=adrHotReset, softInventoryExt=softInventoryExt, eowTable=eowTable, ledPosition=ledPosition, boardSeverity=boardSeverity, EOWClockMode=EOWClockMode, boardInsertType=boardInsertType, laserNumber=laserNumber, ledType=ledType, laserIndex=laserIndex, boardInsertFamily=boardInsertFamily, boardSlotName=boardSlotName, boardListType=boardListType, boardFirstPortIndex=boardFirstPortIndex, LedStatus=LedStatus, hardInv=hardInv, ledNumber=ledNumber, boardMismatchSev=boardMismatchSev, laserTxEnable=laserTxEnable, laserALSRestart2s=laserALSRestart2s, hardInventoryDescr=hardInventoryDescr, hardInventoryNumber=hardInventoryNumber, shelf=shelf, ledEntry=ledEntry, softInventoryCode=softInventoryCode, eowSrcPtr=eowSrcPtr, hardInventoryEntry=hardInventoryEntry, boardNumber=boardNumber, eowNumber=eowNumber, adrFailHoldOffTime=adrFailHoldOffTime, laserTable=laserTable, eowName=eowName, boardDefectiveSev=boardDefectiveSev)
