...
mibBuilder.exportSymbols("SHELF-MIB", eowSrcType=eowSrcType, eow=eow, eowNumber=eowNumber, boardInsertFamily=boardInsertFamily, softInventoryTable=softInventoryTable, laserALSEnable=laserALSEnable, laserALSRestart90s=laserALSRestart90s, boardInsertType=boardInsertType, ledStatus=ledStatus, boardTable=boardTable, boardActive=boardActive, boardEntry=boardEntry, PYSNMP_MODULE_ID=shelf, hardInventoryTable=hardInventoryTable, shelf=shelf, softInventoryExt=softInventoryExt, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryIndex=hardInventoryIndex, board=board, boardFirstPortIndex=boardFirstPortIndex, boardListTable=boardListTable, boardListEntry=boardListEntry, boardIndex=boardIndex, eowSinkPtr=eowSinkPtr, boardMismatchSev=boardMismatchSev, boardDefectiveSev=boardDefectiveSev, eowIndex=eowIndex, softInventoryIndex=softInventoryIndex, adrHotReset=adrHotReset, softInventoryEntry=softInventoryEntry, hardInventoryEntry=hardInventoryEntry, boardMonitor=boardMonitor, boardMissingSev=boardMissingSev, boardListNumber=boardListNumber, boardExpectType=boardExpectType, boardSeverity=boardSeverity, boardList=boardList, boardListType=boardListType, laserNumber=laserNumber, LedType=LedType, EOWClockMode=EOWClockMode, boardProtectionType=boardProtectionType, ledNumber=ledNumber, BoardFailure=BoardFailure, boardListSlot=boardListSlot, LedStatus=LedStatus, ledTable=ledTable, HoldTime=HoldTime, boardListIndex=boardListIndex, laserALSRestart2s=laserALSRestart2s, softInventoryNumber=softInventoryNumber, eowTable=eowTable, holdTime=holdTime, eowSinkType=eowSinkType, laser=laser, hardInventoryBoard=hardInventoryBoard, ledIndex=ledIndex, adrFailHoldOffTime=adrFailHoldOffTime, boardExpectFamily=boardExpectFamily, hardInventoryDescr=hardInventoryDescr, laserTable=laserTable, eowName=eowName, eowEntry=eowEntry, laserTxEnable=laserTxEnable, softInv=softInv, laserEntry=laserEntry, boardNumber=boardNumber, ledPosition=ledPosition, hardInv=hardInv, softInventoryType=softInventoryType, laserIndex=laserIndex, EOWType=EOWType, ledEntry=ledEntry, hardInventoryNumber=hardInventoryNumber, softInventoryBoard=softInventoryBoard, ProtectionType=ProtectionType, led=led, ledType=ledType, boardSlotName=boardSlotName, eowClockMode=eowClockMode, eowSrcPtr=eowSrcPtr, softInventoryCode=softInventoryCode, boardFailure=boardFailure)
