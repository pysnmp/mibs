...
mibBuilder.exportSymbols("SHELF-MIB", eow=eow, board=board, laserALSEnable=laserALSEnable, eowTable=eowTable, adrFailHoldOnTime=adrFailHoldOnTime, boardList=boardList, boardTable=boardTable, adrHotReset=adrHotReset, ledType=ledType, EOWClockMode=EOWClockMode, softInventoryType=softInventoryType, ledPosition=ledPosition, boardListEntry=boardListEntry, hardInventoryBoard=hardInventoryBoard, eowSrcPtr=eowSrcPtr, boardListSlot=boardListSlot, ledTable=ledTable, boardListType=boardListType, HoldTime=HoldTime, boardListNumber=boardListNumber, hardInv=hardInv, boardSeverity=boardSeverity, softInventoryTable=softInventoryTable, boardFailure=boardFailure, adrFailHoldOffTime=adrFailHoldOffTime, BoardFailure=BoardFailure, eowNumber=eowNumber, PYSNMP_MODULE_ID=shelf, holdTime=holdTime, eowClockMode=eowClockMode, eowSinkType=eowSinkType, boardListTable=boardListTable, boardInsertType=boardInsertType, boardMissingSev=boardMissingSev, LedType=LedType, ledIndex=ledIndex, boardActive=boardActive, laserEntry=laserEntry, boardSlotName=boardSlotName, eowSinkPtr=eowSinkPtr, laserALSRestart2s=laserALSRestart2s, boardDefectiveSev=boardDefectiveSev, hardInventoryDescr=hardInventoryDescr, laserTxEnable=laserTxEnable, hardInventoryTable=hardInventoryTable, laserIndex=laserIndex, laserALSRestart90s=laserALSRestart90s, laser=laser, laserTable=laserTable, boardEntry=boardEntry, ledNumber=ledNumber, ledEntry=ledEntry, hardInventoryEntry=hardInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, shelf=shelf, ledStatus=ledStatus, boardListIndex=boardListIndex, softInv=softInv, softInventoryNumber=softInventoryNumber, softInventoryBoard=softInventoryBoard, EOWType=EOWType, eowEntry=eowEntry, hardInventoryNumber=hardInventoryNumber, boardMismatchSev=boardMismatchSev, softInventoryEntry=softInventoryEntry, boardExpectType=boardExpectType, boardNumber=boardNumber, eowIndex=eowIndex, boardInsertFamily=boardInsertFamily, eowName=eowName, boardExpectFamily=boardExpectFamily, boardProtectionType=boardProtectionType, led=led, softInventoryCode=softInventoryCode, eowSrcType=eowSrcType, boardIndex=boardIndex, softInventoryIndex=softInventoryIndex, softInventoryExt=softInventoryExt, laserNumber=laserNumber, ProtectionType=ProtectionType, boardMonitor=boardMonitor, LedStatus=LedStatus, hardInventoryIndex=hardInventoryIndex)
