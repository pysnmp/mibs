...
mibBuilder.exportSymbols("SHELF-MIB", hardInventoryEntry=hardInventoryEntry, boardSlotName=boardSlotName, eow=eow, boardListIndex=boardListIndex, softInventoryNumber=softInventoryNumber, ledNumber=ledNumber, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryBoard=hardInventoryBoard, laserALSEnable=laserALSEnable, hardInventoryTable=hardInventoryTable, boardListSlot=boardListSlot, board=board, hardInventoryIndex=hardInventoryIndex, ledTable=ledTable, eowSrcPtr=eowSrcPtr, boardIndex=boardIndex, LedType=LedType, boardNumber=boardNumber, boardFailure=boardFailure, boardExpectFamily=boardExpectFamily, laser=laser, softInventoryCode=softInventoryCode, eowSrcType=eowSrcType, adrHotReset=adrHotReset, softInventoryIndex=softInventoryIndex, boardProtectionType=boardProtectionType, laserIndex=laserIndex, PYSNMP_MODULE_ID=shelf, boardMismatchSev=boardMismatchSev, softInventoryType=softInventoryType, laserTxEnable=laserTxEnable, laserEntry=laserEntry, LedStatus=LedStatus, EOWClockMode=EOWClockMode, ProtectionType=ProtectionType, boardTable=boardTable, hardInv=hardInv, boardListEntry=boardListEntry, eowName=eowName, hardInventoryDescr=hardInventoryDescr, softInventoryEntry=softInventoryEntry, eowClockMode=eowClockMode, led=led, boardListNumber=boardListNumber, holdTime=holdTime, hardInventoryNumber=hardInventoryNumber, boardInsertType=boardInsertType, eowIndex=eowIndex, boardSeverity=boardSeverity, ledIndex=ledIndex, shelf=shelf, boardInsertFamily=boardInsertFamily, boardDefectiveSev=boardDefectiveSev, eowTable=eowTable, BoardFailure=BoardFailure, boardActive=boardActive, boardMissingSev=boardMissingSev, boardListType=boardListType, softInv=softInv, softInventoryExt=softInventoryExt, ledStatus=ledStatus, boardEntry=boardEntry, boardListTable=boardListTable, adrFailHoldOnTime=adrFailHoldOnTime, eowSinkType=eowSinkType, ledEntry=ledEntry, softInventoryTable=softInventoryTable, eowNumber=eowNumber, boardMonitor=boardMonitor, laserTable=laserTable, laserALSRestart90s=laserALSRestart90s, ledType=ledType, boardList=boardList, eowSinkPtr=eowSinkPtr, boardExpectType=boardExpectType, laserALSRestart2s=laserALSRestart2s, eowEntry=eowEntry, boardFirstPortIndex=boardFirstPortIndex, EOWType=EOWType, laserNumber=laserNumber, ledPosition=ledPosition, HoldTime=HoldTime, softInventoryBoard=softInventoryBoard)
