...
mibBuilder.exportSymbols("SHELF-MIB", boardTable=boardTable, hardInventoryNumber=hardInventoryNumber, boardIndex=boardIndex, boardFirstPortIndex=boardFirstPortIndex, ledType=ledType, boardExpectFamily=boardExpectFamily, led=led, HoldTime=HoldTime, boardFailure=boardFailure, laserTxEnable=laserTxEnable, boardNumber=boardNumber, eowTable=eowTable, ledNumber=ledNumber, eowNumber=eowNumber, softInventoryExt=softInventoryExt, PYSNMP_MODULE_ID=shelf, ledPosition=ledPosition, softInventoryNumber=softInventoryNumber, EOWType=EOWType, shelf=shelf, laserNumber=laserNumber, boardListEntry=boardListEntry, laser=laser, boardEntry=boardEntry, hardInv=hardInv, softInventoryEntry=softInventoryEntry, boardExpectType=boardExpectType, softInventoryIndex=softInventoryIndex, ledTable=ledTable, hardInventoryIndex=hardInventoryIndex, eow=eow, boardMismatchSev=boardMismatchSev, boardListIndex=boardListIndex, boardListType=boardListType, laserALSRestart2s=laserALSRestart2s, hardInventoryDescr=hardInventoryDescr, boardListNumber=boardListNumber, laserALSEnable=laserALSEnable, ledEntry=ledEntry, laserEntry=laserEntry, boardSlotName=boardSlotName, boardInsertFamily=boardInsertFamily, hardInventoryEntry=hardInventoryEntry, softInventoryTable=softInventoryTable, hardInventoryTable=hardInventoryTable, adrHotReset=adrHotReset, eowName=eowName, boardMonitor=boardMonitor, ProtectionType=ProtectionType, eowSinkPtr=eowSinkPtr, ledIndex=ledIndex, softInventoryType=softInventoryType, laserIndex=laserIndex, boardInsertType=boardInsertType, laserTable=laserTable, eowIndex=eowIndex, LedStatus=LedStatus, boardProtectionType=boardProtectionType, eowSrcPtr=eowSrcPtr, boardActive=boardActive, eowClockMode=eowClockMode, boardList=boardList, boardMissingSev=boardMissingSev, boardListSlot=boardListSlot, board=board, softInventoryCode=softInventoryCode, LedType=LedType, BoardFailure=BoardFailure, adrFailHoldOnTime=adrFailHoldOnTime, hardInventoryBoard=hardInventoryBoard, eowEntry=eowEntry, boardListTable=boardListTable, softInventoryBoard=softInventoryBoard, eowSrcType=eowSrcType, laserALSRestart90s=laserALSRestart90s, boardDefectiveSev=boardDefectiveSev, eowSinkType=eowSinkType, EOWClockMode=EOWClockMode, boardSeverity=boardSeverity, ledStatus=ledStatus, holdTime=holdTime, softInv=softInv, adrFailHoldOffTime=adrFailHoldOffTime)
