...
mibBuilder.exportSymbols("SHELF-MIB", boardFirstPortIndex=boardFirstPortIndex, boardExpectFamily=boardExpectFamily, boardListIndex=boardListIndex, laser=laser, laserTable=laserTable, boardInsertFamily=boardInsertFamily, eowIndex=eowIndex, boardInsertType=boardInsertType, laserNumber=laserNumber, ledIndex=ledIndex, boardFailure=boardFailure, boardMismatchSev=boardMismatchSev, boardMissingSev=boardMissingSev, boardListType=boardListType, EOWType=EOWType, eowClockMode=eowClockMode, led=led, eowSrcType=eowSrcType, laserALSEnable=laserALSEnable, laserALSRestart2s=laserALSRestart2s, shelf=shelf, eow=eow, adrFailHoldOnTime=adrFailHoldOnTime, ledStatus=ledStatus, boardProtectionType=boardProtectionType, eowSinkPtr=eowSinkPtr, adrFailHoldOffTime=adrFailHoldOffTime, boardEntry=boardEntry, hardInventoryTable=hardInventoryTable, hardInventoryIndex=hardInventoryIndex, boardSeverity=boardSeverity, BoardFailure=BoardFailure, boardIndex=boardIndex, boardNumber=boardNumber, ledType=ledType, adrHotReset=adrHotReset, boardActive=boardActive, eowTable=eowTable, board=board, eowName=eowName, boardList=boardList, laserIndex=laserIndex, eowSrcPtr=eowSrcPtr, laserALSRestart90s=laserALSRestart90s, softInv=softInv, eowEntry=eowEntry, laserEntry=laserEntry, ledPosition=ledPosition, softInventoryType=softInventoryType, boardSlotName=boardSlotName, LedStatus=LedStatus, ProtectionType=ProtectionType, softInventoryExt=softInventoryExt, boardTable=boardTable, eowSinkType=eowSinkType, HoldTime=HoldTime, hardInventoryEntry=hardInventoryEntry, softInventoryCode=softInventoryCode, softInventoryTable=softInventoryTable, boardExpectType=boardExpectType, softInventoryEntry=softInventoryEntry, PYSNMP_MODULE_ID=shelf, hardInventoryBoard=hardInventoryBoard, LedType=LedType, hardInv=hardInv, boardDefectiveSev=boardDefectiveSev, boardMonitor=boardMonitor, laserTxEnable=laserTxEnable, hardInventoryDescr=hardInventoryDescr, softInventoryIndex=softInventoryIndex, hardInventoryNumber=hardInventoryNumber, boardListEntry=boardListEntry, softInventoryBoard=softInventoryBoard, softInventoryNumber=softInventoryNumber, EOWClockMode=EOWClockMode, ledEntry=ledEntry, ledNumber=ledNumber, holdTime=holdTime, boardListTable=boardListTable, eowNumber=eowNumber, boardListSlot=boardListSlot, boardListNumber=boardListNumber, ledTable=ledTable)
