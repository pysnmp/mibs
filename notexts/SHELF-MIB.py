...
mibBuilder.exportSymbols("SHELF-MIB", adrFailHoldOffTime=adrFailHoldOffTime, eowNumber=eowNumber, boardActive=boardActive, LedType=LedType, boardSlotName=boardSlotName, softInventoryType=softInventoryType, laserIndex=laserIndex, ledTable=ledTable, boardInsertFamily=boardInsertFamily, softInventoryEntry=softInventoryEntry, hardInventoryBoard=hardInventoryBoard, ledNumber=ledNumber, boardMonitor=boardMonitor, laser=laser, boardMismatchSev=boardMismatchSev, eowSinkType=eowSinkType, hardInv=hardInv, boardExpectFamily=boardExpectFamily, ledStatus=ledStatus, softInventoryCode=softInventoryCode, eowSrcPtr=eowSrcPtr, shelf=shelf, softInv=softInv, EOWType=EOWType, laserALSEnable=laserALSEnable, HoldTime=HoldTime, softInventoryTable=softInventoryTable, softInventoryNumber=softInventoryNumber, laserEntry=laserEntry, boardFailure=boardFailure, boardList=boardList, eowName=eowName, laserTable=laserTable, boardIndex=boardIndex, hardInventoryTable=hardInventoryTable, adrFailHoldOnTime=adrFailHoldOnTime, BoardFailure=BoardFailure, adrHotReset=adrHotReset, boardListIndex=boardListIndex, ledType=ledType, boardProtectionType=boardProtectionType, softInventoryIndex=softInventoryIndex, eowEntry=eowEntry, eowSrcType=eowSrcType, led=led, boardFirstPortIndex=boardFirstPortIndex, eowSinkPtr=eowSinkPtr, PYSNMP_MODULE_ID=shelf, boardListTable=boardListTable, boardTable=boardTable, ProtectionType=ProtectionType, boardEntry=boardEntry, boardMissingSev=boardMissingSev, softInventoryExt=softInventoryExt, boardListEntry=boardListEntry, eowClockMode=eowClockMode, EOWClockMode=EOWClockMode, hardInventoryEntry=hardInventoryEntry, softInventoryBoard=softInventoryBoard, boardListSlot=boardListSlot, hardInventoryDescr=hardInventoryDescr, hardInventoryNumber=hardInventoryNumber, boardInsertType=boardInsertType, holdTime=holdTime, laserALSRestart2s=laserALSRestart2s, laserALSRestart90s=laserALSRestart90s, boardListType=boardListType, boardDefectiveSev=boardDefectiveSev, ledPosition=ledPosition, eowTable=eowTable, eowIndex=eowIndex, board=board, boardNumber=boardNumber, eow=eow, laserTxEnable=laserTxEnable, LedStatus=LedStatus, ledEntry=ledEntry, hardInventoryIndex=hardInventoryIndex, boardExpectType=boardExpectType, laserNumber=laserNumber, ledIndex=ledIndex, boardSeverity=boardSeverity, boardListNumber=boardListNumber)
