...
mibBuilder.exportSymbols("SHELF-MIB", boardExpectType=boardExpectType, boardInsertFamily=boardInsertFamily, hardInventoryTable=hardInventoryTable, eowSinkType=eowSinkType, eowTable=eowTable, boardFailure=boardFailure, hardInventoryEntry=hardInventoryEntry, laserALSEnable=laserALSEnable, eowName=eowName, softInventoryNumber=softInventoryNumber, boardListEntry=boardListEntry, ledStatus=ledStatus, ledIndex=ledIndex, boardFirstPortIndex=boardFirstPortIndex, boardMissingSev=boardMissingSev, boardMismatchSev=boardMismatchSev, ProtectionType=ProtectionType, adrHotReset=adrHotReset, softInventoryIndex=softInventoryIndex, shelf=shelf, boardSeverity=boardSeverity, EOWType=EOWType, boardMonitor=boardMonitor, boardInsertType=boardInsertType, EOWClockMode=EOWClockMode, boardListTable=boardListTable, HoldTime=HoldTime, laserTable=laserTable, ledPosition=ledPosition, laserIndex=laserIndex, hardInventoryDescr=hardInventoryDescr, LedType=LedType, adrFailHoldOnTime=adrFailHoldOnTime, boardDefectiveSev=boardDefectiveSev, eowIndex=eowIndex, eowEntry=eowEntry, ledEntry=ledEntry, boardListNumber=boardListNumber, softInventoryBoard=softInventoryBoard, softInventoryExt=softInventoryExt, softInventoryCode=softInventoryCode, ledTable=ledTable, laser=laser, boardActive=boardActive, eowNumber=eowNumber, laserNumber=laserNumber, softInv=softInv, boardExpectFamily=boardExpectFamily, laserTxEnable=laserTxEnable, laserALSRestart2s=laserALSRestart2s, boardIndex=boardIndex, eowClockMode=eowClockMode, softInventoryType=softInventoryType, boardNumber=boardNumber, ledNumber=ledNumber, laserALSRestart90s=laserALSRestart90s, boardListType=boardListType, boardSlotName=boardSlotName, PYSNMP_MODULE_ID=shelf, boardListIndex=boardListIndex, softInventoryEntry=softInventoryEntry, led=led, board=board, boardEntry=boardEntry, softInventoryTable=softInventoryTable, hardInv=hardInv, laserEntry=laserEntry, ledType=ledType, hardInventoryIndex=hardInventoryIndex, boardListSlot=boardListSlot, eowSrcPtr=eowSrcPtr, adrFailHoldOffTime=adrFailHoldOffTime, hardInventoryBoard=hardInventoryBoard, eowSrcType=eowSrcType, boardProtectionType=boardProtectionType, hardInventoryNumber=hardInventoryNumber, boardTable=boardTable, holdTime=holdTime, BoardFailure=BoardFailure, LedStatus=LedStatus, eow=eow, boardList=boardList, eowSinkPtr=eowSinkPtr)
