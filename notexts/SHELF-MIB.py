...
mibBuilder.exportSymbols("SHELF-MIB", laserALSEnable=laserALSEnable, laserIndex=laserIndex, eowSinkPtr=eowSinkPtr, HoldTime=HoldTime, boardSeverity=boardSeverity, eowName=eowName, laserNumber=laserNumber, boardInsertType=boardInsertType, shelf=shelf, ledIndex=ledIndex, eowSinkType=eowSinkType, board=board, boardMissingSev=boardMissingSev, softInv=softInv, hardInventoryTable=hardInventoryTable, boardEntry=boardEntry, boardProtectionType=boardProtectionType, eowEntry=eowEntry, ledTable=ledTable, softInventoryIndex=softInventoryIndex, eowNumber=eowNumber, ledNumber=ledNumber, hardInventoryEntry=hardInventoryEntry, boardSlotName=boardSlotName, boardActive=boardActive, boardInsertFamily=boardInsertFamily, softInventoryCode=softInventoryCode, boardListIndex=boardListIndex, boardExpectType=boardExpectType, hardInventoryIndex=hardInventoryIndex, PYSNMP_MODULE_ID=shelf, LedStatus=LedStatus, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryBoard=softInventoryBoard, boardListEntry=boardListEntry, adrFailHoldOnTime=adrFailHoldOnTime, boardIndex=boardIndex, boardListNumber=boardListNumber, softInventoryExt=softInventoryExt, boardFirstPortIndex=boardFirstPortIndex, boardMismatchSev=boardMismatchSev, hardInv=hardInv, boardExpectFamily=boardExpectFamily, ledStatus=ledStatus, eow=eow, ProtectionType=ProtectionType, boardListType=boardListType, softInventoryNumber=softInventoryNumber, hardInventoryBoard=hardInventoryBoard, eowTable=eowTable, adrHotReset=adrHotReset, ledPosition=ledPosition, softInventoryType=softInventoryType, laserALSRestart90s=laserALSRestart90s, laserTable=laserTable, softInventoryTable=softInventoryTable, led=led, boardNumber=boardNumber, boardFailure=boardFailure, EOWType=EOWType, holdTime=holdTime, softInventoryEntry=softInventoryEntry, laserEntry=laserEntry, boardList=boardList, laserTxEnable=laserTxEnable, boardTable=boardTable, laser=laser, ledType=ledType, eowIndex=eowIndex, laserALSRestart2s=laserALSRestart2s, boardListTable=boardListTable, BoardFailure=BoardFailure, hardInventoryDescr=hardInventoryDescr, ledEntry=ledEntry, EOWClockMode=EOWClockMode, boardListSlot=boardListSlot, eowSrcPtr=eowSrcPtr, hardInventoryNumber=hardInventoryNumber, eowSrcType=eowSrcType, LedType=LedType, boardMonitor=boardMonitor, boardDefectiveSev=boardDefectiveSev, eowClockMode=eowClockMode)
