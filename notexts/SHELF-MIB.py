...
mibBuilder.exportSymbols("SHELF-MIB", ProtectionType=ProtectionType, adrFailHoldOffTime=adrFailHoldOffTime, softInventoryCode=softInventoryCode, eow=eow, laserALSRestart2s=laserALSRestart2s, laserALSRestart90s=laserALSRestart90s, softInventoryNumber=softInventoryNumber, ledStatus=ledStatus, eowClockMode=eowClockMode, led=led, softInventoryEntry=softInventoryEntry, boardExpectType=boardExpectType, softInventoryBoard=softInventoryBoard, eowNumber=eowNumber, BoardFailure=BoardFailure, boardListNumber=boardListNumber, HoldTime=HoldTime, eowSinkType=eowSinkType, eowSinkPtr=eowSinkPtr, LedStatus=LedStatus, shelf=shelf, eowEntry=eowEntry, boardList=boardList, boardMonitor=boardMonitor, eowSrcType=eowSrcType, boardInsertType=boardInsertType, softInventoryIndex=softInventoryIndex, hardInventoryNumber=hardInventoryNumber, laserTable=laserTable, boardMismatchSev=boardMismatchSev, boardSeverity=boardSeverity, hardInventoryEntry=hardInventoryEntry, boardListType=boardListType, boardInsertFamily=boardInsertFamily, laserEntry=laserEntry, adrFailHoldOnTime=adrFailHoldOnTime, eowSrcPtr=eowSrcPtr, adrHotReset=adrHotReset, laserALSEnable=laserALSEnable, holdTime=holdTime, softInventoryExt=softInventoryExt, ledType=ledType, ledIndex=ledIndex, hardInventoryBoard=hardInventoryBoard, softInventoryType=softInventoryType, hardInv=hardInv, boardActive=boardActive, boardListTable=boardListTable, LedType=LedType, boardListSlot=boardListSlot, boardFirstPortIndex=boardFirstPortIndex, ledPosition=ledPosition, boardDefectiveSev=boardDefectiveSev, boardListIndex=boardListIndex, EOWType=EOWType, ledNumber=ledNumber, laserTxEnable=laserTxEnable, laserIndex=laserIndex, eowTable=eowTable, laser=laser, boardFailure=boardFailure, eowIndex=eowIndex, boardSlotName=boardSlotName, boardMissingSev=boardMissingSev, eowName=eowName, PYSNMP_MODULE_ID=shelf, softInventoryTable=softInventoryTable, boardEntry=boardEntry, ledTable=ledTable, ledEntry=ledEntry, board=board, boardListEntry=boardListEntry, EOWClockMode=EOWClockMode, hardInventoryDescr=hardInventoryDescr, softInv=softInv, hardInventoryIndex=hardInventoryIndex, boardNumber=boardNumber, hardInventoryTable=hardInventoryTable, boardProtectionType=boardProtectionType, laserNumber=laserNumber, boardExpectFamily=boardExpectFamily, boardTable=boardTable, boardIndex=boardIndex)
