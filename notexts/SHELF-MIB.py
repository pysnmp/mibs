...
mibBuilder.exportSymbols("SHELF-MIB", adrFailHoldOffTime=adrFailHoldOffTime, boardMismatchSev=boardMismatchSev, boardListIndex=boardListIndex, led=led, boardActive=boardActive, hardInventoryIndex=hardInventoryIndex, laserALSRestart90s=laserALSRestart90s, LedType=LedType, softInventoryTable=softInventoryTable, HoldTime=HoldTime, boardList=boardList, boardFirstPortIndex=boardFirstPortIndex, holdTime=holdTime, ledTable=ledTable, eowSrcType=eowSrcType, laserIndex=laserIndex, eowNumber=eowNumber, boardFailure=boardFailure, boardTable=boardTable, ledType=ledType, laserALSRestart2s=laserALSRestart2s, ledPosition=ledPosition, laserEntry=laserEntry, boardProtectionType=boardProtectionType, hardInventoryEntry=hardInventoryEntry, eowClockMode=eowClockMode, softInventoryNumber=softInventoryNumber, laserTable=laserTable, laserALSEnable=laserALSEnable, boardSlotName=boardSlotName, softInventoryIndex=softInventoryIndex, softInventoryBoard=softInventoryBoard, EOWClockMode=EOWClockMode, softInventoryEntry=softInventoryEntry, boardListSlot=boardListSlot, boardListEntry=boardListEntry, ledIndex=ledIndex, eowTable=eowTable, eow=eow, eowIndex=eowIndex, BoardFailure=BoardFailure, softInventoryType=softInventoryType, softInv=softInv, boardListTable=boardListTable, ProtectionType=ProtectionType, shelf=shelf, boardExpectFamily=boardExpectFamily, hardInventoryDescr=hardInventoryDescr, laser=laser, eowSinkPtr=eowSinkPtr, laserNumber=laserNumber, hardInventoryNumber=hardInventoryNumber, boardMonitor=boardMonitor, boardListType=boardListType, boardListNumber=boardListNumber, boardIndex=boardIndex, board=board, eowEntry=eowEntry, boardInsertFamily=boardInsertFamily, eowSrcPtr=eowSrcPtr, ledEntry=ledEntry, adrHotReset=adrHotReset, boardDefectiveSev=boardDefectiveSev, hardInventoryBoard=hardInventoryBoard, eowName=eowName, boardNumber=boardNumber, softInventoryExt=softInventoryExt, adrFailHoldOnTime=adrFailHoldOnTime, boardEntry=boardEntry, LedStatus=LedStatus, eowSinkType=eowSinkType, hardInventoryTable=hardInventoryTable, ledNumber=ledNumber, boardSeverity=boardSeverity, softInventoryCode=softInventoryCode, laserTxEnable=laserTxEnable, boardMissingSev=boardMissingSev, hardInv=hardInv, boardInsertType=boardInsertType, ledStatus=ledStatus, PYSNMP_MODULE_ID=shelf, boardExpectType=boardExpectType, EOWType=EOWType)
