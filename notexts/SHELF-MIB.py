...
mibBuilder.exportSymbols("SHELF-MIB", softInventoryNumber=softInventoryNumber, boardListSlot=boardListSlot, softInventoryEntry=softInventoryEntry, boardExpectFamily=boardExpectFamily, boardTable=boardTable, boardExpectType=boardExpectType, hardInventoryEntry=hardInventoryEntry, ledStatus=ledStatus, softInventoryExt=softInventoryExt, laser=laser, boardSlotName=boardSlotName, softInv=softInv, laserALSEnable=laserALSEnable, boardFailure=boardFailure, boardListNumber=boardListNumber, boardMismatchSev=boardMismatchSev, HoldTime=HoldTime, ledTable=ledTable, ledNumber=ledNumber, eowEntry=eowEntry, boardListEntry=boardListEntry, laserIndex=laserIndex, boardSeverity=boardSeverity, laserALSRestart2s=laserALSRestart2s, softInventoryBoard=softInventoryBoard, boardListType=boardListType, board=board, hardInventoryNumber=hardInventoryNumber, eowTable=eowTable, hardInv=hardInv, boardMonitor=boardMonitor, eowClockMode=eowClockMode, eowSinkPtr=eowSinkPtr, eowSinkType=eowSinkType, boardList=boardList, boardListIndex=boardListIndex, boardNumber=boardNumber, laserTxEnable=laserTxEnable, eowIndex=eowIndex, softInventoryIndex=softInventoryIndex, softInventoryType=softInventoryType, laserTable=laserTable, PYSNMP_MODULE_ID=shelf, hardInventoryDescr=hardInventoryDescr, holdTime=holdTime, ledIndex=ledIndex, hardInventoryBoard=hardInventoryBoard, boardFirstPortIndex=boardFirstPortIndex, BoardFailure=BoardFailure, adrFailHoldOnTime=adrFailHoldOnTime, eow=eow, boardDefectiveSev=boardDefectiveSev, laserALSRestart90s=laserALSRestart90s, boardActive=boardActive, EOWType=EOWType, eowNumber=eowNumber, eowName=eowName, hardInventoryIndex=hardInventoryIndex, ledEntry=ledEntry, LedType=LedType, boardEntry=boardEntry, eowSrcType=eowSrcType, LedStatus=LedStatus, softInventoryCode=softInventoryCode, ledType=ledType, led=led, softInventoryTable=softInventoryTable, shelf=shelf, adrHotReset=adrHotReset, adrFailHoldOffTime=adrFailHoldOffTime, boardListTable=boardListTable, ledPosition=ledPosition, eowSrcPtr=eowSrcPtr, boardInsertType=boardInsertType, ProtectionType=ProtectionType, boardIndex=boardIndex, boardMissingSev=boardMissingSev, boardInsertFamily=boardInsertFamily, EOWClockMode=EOWClockMode, laserNumber=laserNumber, boardProtectionType=boardProtectionType, laserEntry=laserEntry, hardInventoryTable=hardInventoryTable)
