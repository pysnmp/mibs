...
mibBuilder.exportSymbols("SHELF-MIB", laserALSEnable=laserALSEnable, boardListSlot=boardListSlot, boardInsertType=boardInsertType, boardTable=boardTable, boardDefectiveSev=boardDefectiveSev, ledStatus=ledStatus, boardMonitor=boardMonitor, adrHotReset=adrHotReset, boardListTable=boardListTable, softInventoryEntry=softInventoryEntry, boardFirstPortIndex=boardFirstPortIndex, boardSeverity=boardSeverity, adrFailHoldOnTime=adrFailHoldOnTime, led=led, boardNumber=boardNumber, laserTable=laserTable, eowSinkType=eowSinkType, hardInventoryBoard=hardInventoryBoard, boardExpectType=boardExpectType, ledIndex=ledIndex, ProtectionType=ProtectionType, ledPosition=ledPosition, adrFailHoldOffTime=adrFailHoldOffTime, boardSlotName=boardSlotName, laserNumber=laserNumber, eowClockMode=eowClockMode, boardProtectionType=boardProtectionType, eowEntry=eowEntry, boardIndex=boardIndex, boardListEntry=boardListEntry, hardInventoryEntry=hardInventoryEntry, softInventoryBoard=softInventoryBoard, eowNumber=eowNumber, boardList=boardList, laserALSRestart90s=laserALSRestart90s, softInventoryCode=softInventoryCode, softInventoryTable=softInventoryTable, boardFailure=boardFailure, eowSinkPtr=eowSinkPtr, eowName=eowName, board=board, hardInv=hardInv, boardInsertFamily=boardInsertFamily, softInventoryType=softInventoryType, laserTxEnable=laserTxEnable, boardListNumber=boardListNumber, laser=laser, laserALSRestart2s=laserALSRestart2s, softInventoryIndex=softInventoryIndex, eowSrcType=eowSrcType, LedStatus=LedStatus, EOWType=EOWType, hardInventoryTable=hardInventoryTable, laserIndex=laserIndex, boardExpectFamily=boardExpectFamily, hardInventoryNumber=hardInventoryNumber, EOWClockMode=EOWClockMode, ledNumber=ledNumber, eowIndex=eowIndex, softInventoryExt=softInventoryExt, eow=eow, boardMissingSev=boardMissingSev, holdTime=holdTime, laserEntry=laserEntry, PYSNMP_MODULE_ID=shelf, boardActive=boardActive, softInventoryNumber=softInventoryNumber, BoardFailure=BoardFailure, hardInventoryIndex=hardInventoryIndex, boardEntry=boardEntry, LedType=LedType, hardInventoryDescr=hardInventoryDescr, boardMismatchSev=boardMismatchSev, ledEntry=ledEntry, boardListType=boardListType, HoldTime=HoldTime, ledType=ledType, boardListIndex=boardListIndex, ledTable=ledTable, softInv=softInv, eowTable=eowTable, shelf=shelf, eowSrcPtr=eowSrcPtr)
