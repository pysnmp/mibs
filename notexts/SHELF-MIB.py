...
mibBuilder.exportSymbols("SHELF-MIB", boardActive=boardActive, ledNumber=ledNumber, boardDefectiveSev=boardDefectiveSev, ledIndex=ledIndex, eowSrcPtr=eowSrcPtr, eowSinkType=eowSinkType, laserEntry=laserEntry, hardInventoryNumber=hardInventoryNumber, eow=eow, EOWType=EOWType, boardFailure=boardFailure, LedType=LedType, softInventoryTable=softInventoryTable, eowSinkPtr=eowSinkPtr, holdTime=holdTime, softInventoryExt=softInventoryExt, boardSlotName=boardSlotName, hardInventoryBoard=hardInventoryBoard, laserTxEnable=laserTxEnable, eowTable=eowTable, boardNumber=boardNumber, boardMonitor=boardMonitor, softInventoryEntry=softInventoryEntry, ledTable=ledTable, softInventoryBoard=softInventoryBoard, boardInsertType=boardInsertType, boardListSlot=boardListSlot, boardExpectType=boardExpectType, EOWClockMode=EOWClockMode, ledEntry=ledEntry, HoldTime=HoldTime, eowName=eowName, softInventoryCode=softInventoryCode, boardListIndex=boardListIndex, hardInventoryTable=hardInventoryTable, eowClockMode=eowClockMode, led=led, hardInventoryIndex=hardInventoryIndex, eowEntry=eowEntry, softInventoryType=softInventoryType, adrHotReset=adrHotReset, boardMissingSev=boardMissingSev, boardListTable=boardListTable, boardTable=boardTable, adrFailHoldOffTime=adrFailHoldOffTime, boardSeverity=boardSeverity, eowIndex=eowIndex, hardInventoryEntry=hardInventoryEntry, softInventoryNumber=softInventoryNumber, ledStatus=ledStatus, laserALSEnable=laserALSEnable, laserALSRestart2s=laserALSRestart2s, hardInventoryDescr=hardInventoryDescr, boardFirstPortIndex=boardFirstPortIndex, PYSNMP_MODULE_ID=shelf, boardMismatchSev=boardMismatchSev, ProtectionType=ProtectionType, boardInsertFamily=boardInsertFamily, shelf=shelf, ledType=ledType, laser=laser, LedStatus=LedStatus, boardProtectionType=boardProtectionType, softInventoryIndex=softInventoryIndex, BoardFailure=BoardFailure, boardListNumber=boardListNumber, boardIndex=boardIndex, boardListType=boardListType, laserNumber=laserNumber, laserIndex=laserIndex, hardInv=hardInv, ledPosition=ledPosition, eowNumber=eowNumber, softInv=softInv, adrFailHoldOnTime=adrFailHoldOnTime, laserTable=laserTable, boardExpectFamily=boardExpectFamily, board=board, boardListEntry=boardListEntry, boardEntry=boardEntry, laserALSRestart90s=laserALSRestart90s, eowSrcType=eowSrcType, boardList=boardList)
