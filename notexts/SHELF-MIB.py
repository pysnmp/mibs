...
mibBuilder.exportSymbols("SHELF-MIB", ledIndex=ledIndex, ProtectionType=ProtectionType, laserALSRestart2s=laserALSRestart2s, shelf=shelf, laser=laser, laserALSEnable=laserALSEnable, adrHotReset=adrHotReset, boardInsertType=boardInsertType, hardInventoryBoard=hardInventoryBoard, softInventoryNumber=softInventoryNumber, softInventoryCode=softInventoryCode, ledPosition=ledPosition, led=led, LedType=LedType, ledStatus=ledStatus, EOWClockMode=EOWClockMode, eowSinkPtr=eowSinkPtr, boardFailure=boardFailure, hardInventoryIndex=hardInventoryIndex, boardExpectType=boardExpectType, laserEntry=laserEntry, boardProtectionType=boardProtectionType, board=board, boardActive=boardActive, boardListType=boardListType, laserNumber=laserNumber, eowSrcPtr=eowSrcPtr, softInventoryIndex=softInventoryIndex, softInventoryTable=softInventoryTable, boardSeverity=boardSeverity, boardEntry=boardEntry, boardExpectFamily=boardExpectFamily, adrFailHoldOffTime=adrFailHoldOffTime, eowClockMode=eowClockMode, boardTable=boardTable, boardNumber=boardNumber, laserTable=laserTable, boardInsertFamily=boardInsertFamily, boardListSlot=boardListSlot, hardInventoryDescr=hardInventoryDescr, laserIndex=laserIndex, softInventoryType=softInventoryType, hardInv=hardInv, adrFailHoldOnTime=adrFailHoldOnTime, softInv=softInv, eowIndex=eowIndex, eowSinkType=eowSinkType, PYSNMP_MODULE_ID=shelf, LedStatus=LedStatus, eowSrcType=eowSrcType, holdTime=holdTime, hardInventoryTable=hardInventoryTable, boardSlotName=boardSlotName, softInventoryExt=softInventoryExt, eowName=eowName, boardMismatchSev=boardMismatchSev, softInventoryEntry=softInventoryEntry, BoardFailure=BoardFailure, boardListIndex=boardListIndex, hardInventoryNumber=hardInventoryNumber, laserALSRestart90s=laserALSRestart90s, eowNumber=eowNumber, eowEntry=eowEntry, boardMissingSev=boardMissingSev, boardListTable=boardListTable, boardList=boardList, HoldTime=HoldTime, boardFirstPortIndex=boardFirstPortIndex, boardMonitor=boardMonitor, ledType=ledType, eow=eow, boardDefectiveSev=boardDefectiveSev, hardInventoryEntry=hardInventoryEntry, laserTxEnable=laserTxEnable, eowTable=eowTable, ledTable=ledTable, boardListEntry=boardListEntry, EOWType=EOWType, boardListNumber=boardListNumber, softInventoryBoard=softInventoryBoard, boardIndex=boardIndex, ledNumber=ledNumber, ledEntry=ledEntry)
