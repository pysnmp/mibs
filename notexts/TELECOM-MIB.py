...
mibBuilder.exportSymbols("TELECOM-MIB", matConCommunicationLost=matConCommunicationLost, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputCurrent=matInvOutputCurrent, matInvLineFreq=matInvLineFreq, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvPulseFault=matInvPulseFault, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matDryContact=matDryContact, matConBatteryLow=matConBatteryLow, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvEEPROMFault=matInvEEPROMFault, matStsInvFail=matStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvRunTime=matInvRunTime, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsCommunity=matTrapTargetsCommunity, matController=matController, matInvHardwareVersion=matInvHardwareVersion, matConfInvInputVoltage=matConfInvInputVoltage, matInvOverLoad=matInvOverLoad, matStsOverLoad=matStsOverLoad, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matSts=matSts, matInvFanFault=matInvFanFault, ppc=ppc, matStsModuleIndex=matStsModuleIndex, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, NonNegativeInteger=NonNegativeInteger, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvSerialNum=matInvSerialNum, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConEEPROMFault=matConEEPROMFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapType=matTrapType, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsControlPowerFail=matStsControlPowerFail, matStsMbsStatus=matStsMbsStatus, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matDryContactString=matDryContactString, matDryContactEntry=matDryContactEntry, matStsHardwareVersion=matStsHardwareVersion, matStsFaultMode=matStsFaultMode, matConWarningState=matConWarningState, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsIndex=matTrapTargetsIndex, matStsEntry=matStsEntry, matInvOutputVoltage=matInvOutputVoltage, matInvEntry=matInvEntry, matInvHardwareError=matInvHardwareError, matStsRuntime=matStsRuntime, matStsSerialNum=matStsSerialNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvOutputShort=matInvOutputShort, matInvSoftStartFail=matInvSoftStartFail, matInvOutputFreq=matInvOutputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsTable=matStsTable, matStsMainInputFreq=matStsMainInputFreq, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matAgent=matAgent, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConCanBusOff=matConCanBusOff, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsOutputVoltage=matStsOutputVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvRunMode=matInvRunMode, matStsMainInputVoltage=matStsMainInputVoltage, matInvModuleNum=matInvModuleNum, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matDryContactNum=matDryContactNum, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matAgentSoftwareVerison=matAgentSoftwareVerison, matInverter=matInverter, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsTemperature=matStsTemperature, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matDryContactIndex=matDryContactIndex, matInvTable=matInvTable, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvTemperature=matInvTemperature, matStsNotRespond=matStsNotRespond, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matDryContactTable=matDryContactTable, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsTemperatureHigh=matStsTemperatureHigh, matStsStatus=matStsStatus, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvInputAbnormal=matInvInputAbnormal, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsRunningMode=matStsRunningMode, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, device=device, matConfInvSysInputVolt=matConfInvSysInputVolt, matObjects=matObjects, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvMBSPosError=matInvMBSPosError, matStsFanFault=matStsFanFault, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsModuleNum=matStsModuleNum, matConfStsFanSpeed=matConfStsFanSpeed, matConTemperature=matConTemperature, matInvPriority=matInvPriority, matTrapTargetsDesc=matTrapTargetsDesc, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLineVoltage=matInvLineVoltage, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvBatteryVoltage=matInvBatteryVoltage, matStsInvInputFreq=matStsInvInputFreq, matInvBypassSCRShort=matInvBypassSCRShort, matConTemperatureHigh=matConTemperatureHigh, matInvPowerLimit=matInvPowerLimit, matInvPhaseType=matInvPhaseType, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvOutputPower=matConfInvOutputPower, matInvOutputPower=matInvOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvNotRespond=matInvNotRespond, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsEEPROMFault=matStsEEPROMFault, matInvMainUnavailable=matInvMainUnavailable, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTraps=matTraps, matTrapSeverityLevel=matTrapSeverityLevel, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvTemperatureHigh=matInvTemperatureHigh, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOutputPower=matStsOutputPower, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvMbsPosition=matInvMbsPosition, matStsInvInputVoltage=matStsInvInputVoltage, matStsMainsFail=matStsMainsFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsOutputFreq=matStsOutputFreq, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfig=matConfig, matConfStsPriority=matConfStsPriority, matInvFault=matInvFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConSerialNum=matConSerialNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsModuleType=matStsModuleType, matTrapTargets=matTrapTargets, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsWarningState=matStsWarningState, matInvFirmwareVersion=matInvFirmwareVersion, matTrapTargetsNum=matTrapTargetsNum, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvOutputFreq=matConfInvOutputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConName=matConName, PositiveInteger=PositiveInteger, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapTargetsEntry=matTrapTargetsEntry, matInvWarningState=matInvWarningState)
