...
mibBuilder.exportSymbols("TELECOM-MIB", matInvNotRespond=matInvNotRespond, matStsOutputPower=matStsOutputPower, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvFault=matReturnFromInvFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsMainInputFreq=matStsMainInputFreq, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvInputAbnormal=matInvInputAbnormal, device=device, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConTemperatureHigh=matConTemperatureHigh, matConfInvInputVoltage=matConfInvInputVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsInvInputFreq=matStsInvInputFreq, matInvPulseFault=matInvPulseFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsOutputVoltage=matStsOutputVoltage, matConfStsFanSpeed=matConfStsFanSpeed, matStsWarningState=matStsWarningState, matInvPhaseType=matInvPhaseType, matTrapType=matTrapType, matInvTable=matInvTable, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvModuleNum=matInvModuleNum, matStsMbsStatus=matStsMbsStatus, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvOutputPower=matConfInvOutputPower, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConSerialNum=matConSerialNum, matInvRunMode=matInvRunMode, matTrapTargets=matTrapTargets, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvOutputVoltage=matInvOutputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matTraps=matTraps, matStsTable=matStsTable, matStsEntry=matStsEntry, matStsInvInputVoltage=matStsInvInputVoltage, matInvOverLoad=matInvOverLoad, matInvEEPROMFault=matInvEEPROMFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvWarningState=matInvWarningState, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvMbsPosition=matInvMbsPosition, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matStsModuleType=matStsModuleType, matInvFanFault=matInvFanFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvOutputShort=matInvOutputShort, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvMainUnavailable=matInvMainUnavailable, matStsMainsFail=matStsMainsFail, matStsMBSPosFault=matStsMBSPosFault, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsStatus=matStsStatus, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matAgent=matAgent, matStsFaultMode=matStsFaultMode, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysPriority=matConfInvSysPriority, matInvTempPowerLimit=matInvTempPowerLimit, matInvSoftStartFail=matInvSoftStartFail, matDryContactNum=matDryContactNum, matConTemperature=matConTemperature, matInvOutputCurrent=matInvOutputCurrent, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsInvBypassMode=matStsInvBypassMode, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, ppc=ppc, matDryContactIndex=matDryContactIndex, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvOutputPower=matInvOutputPower, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matSts=matSts, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsEEPROMFault=matStsEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matObjects=matObjects, matInvHardwareError=matInvHardwareError, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfig=matConfig, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputFreq=matInvOutputFreq, matStsModuleIndex=matStsModuleIndex, matInvRunTime=matInvRunTime, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapTargetsTable=matTrapTargetsTable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfStsPriority=matConfStsPriority, matInvBusSoftFail=matInvBusSoftFail, matInvEntry=matInvEntry, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, PositiveInteger=PositiveInteger, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsOutputFreq=matStsOutputFreq, matInverter=matInverter, matStsTemperature=matStsTemperature, matInvSerialNum=matInvSerialNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, NonNegativeInteger=NonNegativeInteger, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matDryContact=matDryContact, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsOverLoad=matStsOverLoad, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperature=matInvTemperature, matDryContactString=matDryContactString, matInvPriority=matInvPriority, matInvLineVoltage=matInvLineVoltage, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvBypassSCRShort=matInvBypassSCRShort, matInvEPOShutdown=matInvEPOShutdown, matStsFanFault=matStsFanFault, matStsOutputCurrent=matStsOutputCurrent, matDryContactTable=matDryContactTable, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsRunningMode=matStsRunningMode, matTrapTargetsDesc=matTrapTargetsDesc, matConCanBusOff=matConCanBusOff, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsRuntime=matStsRuntime, matInvLineFreq=matInvLineFreq, matTrapTargetsAddress=matTrapTargetsAddress, matInvPowerLimit=matInvPowerLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matController=matController, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsSerialNum=matStsSerialNum, matStsModuleNum=matStsModuleNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConEEPROMFault=matConEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConBatteryLow=matConBatteryLow, matConWarningState=matConWarningState, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOnOffStatus=matInvOnOffStatus, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvFail=matStsInvFail, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactEntry=matDryContactEntry, matInvMBSPosError=matInvMBSPosError, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvModuleIndex=matInvModuleIndex, matStsNotRespond=matStsNotRespond, matInvFault=matInvFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvOutputFreq=matConfInvOutputFreq, matTrapTargetsNum=matTrapTargetsNum, matConName=matConName)
