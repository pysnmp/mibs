...
IpAddress, NotificationType, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, enterprises, Counter32, iso, Bits, Counter64, Unsigned32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "enterprises", "Counter32", "iso", "Bits", "Counter64", "Unsigned32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matSts=matSts, matStsEEPROMFault=matStsEEPROMFault, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputCurrent=matStsOutputCurrent, matConfInvInputVoltage=matConfInvInputVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputPower=matStsOutputPower, matConCommunicationLost=matConCommunicationLost, matInvOnOffStatus=matInvOnOffStatus, matStsMainInputFreq=matStsMainInputFreq, matStsInvInputVoltage=matStsInvInputVoltage, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsIndex=matTrapTargetsIndex, matStsModuleIndex=matStsModuleIndex, matStsInvFail=matStsInvFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsModuleType=matStsModuleType, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvEntry=matInvEntry, matStsRunningMode=matStsRunningMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvSerialNum=matInvSerialNum, matInvWarningState=matInvWarningState, matConTemperatureHigh=matConTemperatureHigh, matStsOutputAbnormal=matStsOutputAbnormal, matConfStsPriority=matConfStsPriority, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOutputVoltage=matStsOutputVoltage, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsEntry=matStsEntry, NonNegativeInteger=NonNegativeInteger, matInverter=matInverter, matInvPowerLimit=matInvPowerLimit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsFaultMode=matStsFaultMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matDryContactIndex=matDryContactIndex, matConfig=matConfig, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matDryContact=matDryContact, matTrapType=matTrapType, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvNotRespond=matInvNotRespond, matTrapTargetsDesc=matTrapTargetsDesc, matConfStsFanSpeed=matConfStsFanSpeed, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matDryContactEntry=matDryContactEntry, matInvEPOShutdown=matInvEPOShutdown, matStsMainsFail=matStsMainsFail, matInvMbsPosition=matInvMbsPosition, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConCanBusOff=matConCanBusOff, matConWarningState=matConWarningState, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvModuleNum=matInvModuleNum, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvOutputPower=matConfInvOutputPower, matInvHardwareError=matInvHardwareError, matInvLineVoltage=matInvLineVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsTable=matTrapTargetsTable, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsNotRespond=matStsNotRespond, matObjects=matObjects, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapSeverityLevel=matTrapSeverityLevel, matStsOutputFreq=matStsOutputFreq, matInvPriority=matInvPriority, matStsTemperature=matStsTemperature, matInvModuleIndex=matInvModuleIndex, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsMBSPosFault=matStsMBSPosFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapTargetsNum=matTrapTargetsNum, matInvPhaseType=matInvPhaseType, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvMainUnavailable=matInvMainUnavailable, matInvBusSoftFail=matInvBusSoftFail, matStsBypassUnavailable=matStsBypassUnavailable, matInvOutputVoltage=matInvOutputVoltage, matConName=matConName, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsMbsStatus=matStsMbsStatus, matInvRunTime=matInvRunTime, matTraps=matTraps, matDryContactTable=matDryContactTable, matInvTable=matInvTable, matStsModuleNum=matStsModuleNum, matController=matController, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsSerialNum=matStsSerialNum, matInvTempPowerLimit=matInvTempPowerLimit, matStsTable=matStsTable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvTemperature=matInvTemperature, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvSoftStartFail=matInvSoftStartFail, matTrapTargets=matTrapTargets, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvOutputPower=matInvOutputPower, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperature=matConTemperature, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvRunMode=matInvRunMode, matDryContactNum=matDryContactNum, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvLineFreq=matInvLineFreq, matConBatteryLow=matConBatteryLow, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvFanFault=matInvFanFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvMBSPosError=matInvMBSPosError, matInvOverLoad=matInvOverLoad, matInvInputAbnormal=matInvInputAbnormal, matStsOutputShortCircuit=matStsOutputShortCircuit, matAgent=matAgent, matStsStatus=matStsStatus, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, device=device, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsTemperatureHigh=matStsTemperatureHigh, PositiveInteger=PositiveInteger, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsWarningState=matStsWarningState, matStsInvInputFreq=matStsInvInputFreq, matStsFanFault=matStsFanFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, ppc=ppc, matInvOutputShort=matInvOutputShort, matConSerialNum=matConSerialNum, matDryContactString=matDryContactString, matStsOverLoad=matStsOverLoad, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConEEPROMFault=matConEEPROMFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargetsEntry=matTrapTargetsEntry, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvFault=matReturnFromInvFault, matInvFault=matInvFault, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsHardwareVersion=matStsHardwareVersion, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvOutputFreq=matInvOutputFreq, matInvEEPROMFault=matInvEEPROMFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvPulseFault=matInvPulseFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsRuntime=matStsRuntime)
