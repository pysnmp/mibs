...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvRunMode=matInvRunMode, matController=matController, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, device=device, matConfStsPriority=matConfStsPriority, matConEEPROMFault=matConEEPROMFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvFanFault=matInvFanFault, matInvOutputCurrent=matInvOutputCurrent, matInvModuleIndex=matInvModuleIndex, matStsOverLoad=matStsOverLoad, matStsRuntime=matStsRuntime, matStsInvInputVoltage=matStsInvInputVoltage, matObjects=matObjects, matStsTable=matStsTable, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfStsFanSpeed=matConfStsFanSpeed, matInvOverLoad=matInvOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsSerialNum=matStsSerialNum, matStsMainInputFreq=matStsMainInputFreq, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvMbsPosition=matInvMbsPosition, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConCommunicationLost=matConCommunicationLost, matStsModuleType=matStsModuleType, matTrapType=matTrapType, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, NonNegativeInteger=NonNegativeInteger, matDryContactTable=matDryContactTable, matConName=matConName, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvLineVoltage=matInvLineVoltage, matInvInputAbnormal=matInvInputAbnormal, matInvRunTime=matInvRunTime, matInvNotRespond=matInvNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvMaintenaceBypass=matInvMaintenaceBypass, PositiveInteger=PositiveInteger, matInvLineFreq=matInvLineFreq, matStsMbsStatus=matStsMbsStatus, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvOutputVoltLow=matInvOutputVoltLow, matInvSoftStartFail=matInvSoftStartFail, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsWarningState=matStsWarningState, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsOutputFreq=matStsOutputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, ppc=ppc, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConTemperature=matConTemperature, matInvModuleNum=matInvModuleNum, matStsTemperature=matStsTemperature, matStsFaultMode=matStsFaultMode, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvEPOShutdown=matInvEPOShutdown, matInvMBSPosError=matInvMBSPosError, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matDryContact=matDryContact, matConBatteryLow=matConBatteryLow, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matSts=matSts, matInvPulseFault=matInvPulseFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsBypassUnavailable=matStsBypassUnavailable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvInputVoltage=matConfInvInputVoltage, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputPower=matConfInvOutputPower, matStsEntry=matStsEntry, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsFanFault=matStsFanFault, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsNum=matTrapTargetsNum, matDryContactNum=matDryContactNum, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOutputCurrent=matStsOutputCurrent, matInvBatteryVoltage=matInvBatteryVoltage, matInvTemperature=matInvTemperature, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsStatus=matStsStatus, matTrapTargets=matTrapTargets, matInvPriority=matInvPriority, matStsMainInputVoltage=matStsMainInputVoltage, matAgent=matAgent, matConSerialNum=matConSerialNum, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matInvHardwareVersion=matInvHardwareVersion, matStsOutputPower=matStsOutputPower, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvFault=matInvFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsModuleIndex=matStsModuleIndex, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvFault=matReturnFromInvFault, matStsMBSPosFault=matStsMBSPosFault, matInverter=matInverter, matInvMainUnavailable=matInvMainUnavailable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsOutputVoltage=matStsOutputVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvPhaseType=matInvPhaseType, matDryContactString=matDryContactString, matInvTable=matInvTable, matInvOutputShort=matInvOutputShort, matInvEEPROMFault=matInvEEPROMFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvTempPowerLimit=matInvTempPowerLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matDryContactEntry=matDryContactEntry, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matTraps=matTraps, matInvPowerLimit=matInvPowerLimit, matInvHardwareError=matInvHardwareError, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvOutputFreq=matInvOutputFreq, matStsControlPowerFail=matStsControlPowerFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfig=matConfig, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMainsFail=matStsMainsFail, matInvLowInputShutdown=matInvLowInputShutdown, matStsInvFail=matStsInvFail, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsModuleNum=matStsModuleNum, matTrapTargetsAddress=matTrapTargetsAddress, matStsOutputShortCircuit=matStsOutputShortCircuit, matDryContactIndex=matDryContactIndex, matStsRunningMode=matStsRunningMode, matConWarningState=matConWarningState, matInvSerialNum=matInvSerialNum, matInvOutputPower=matInvOutputPower, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConCanBusOff=matConCanBusOff, matStsNotRespond=matStsNotRespond, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltage=matInvOutputVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, matInvEntry=matInvEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsInvBypassMode=matStsInvBypassMode, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit)
