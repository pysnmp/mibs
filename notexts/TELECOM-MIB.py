...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsStatus=matStsStatus, matInvLowInputShutdown=matInvLowInputShutdown, matStsOutputPower=matStsOutputPower, matDryContactString=matDryContactString, matController=matController, ppc=ppc, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matDryContactNum=matDryContactNum, matTrapTargetsTable=matTrapTargetsTable, matStsControlPowerFail=matStsControlPowerFail, matInvSerialNum=matInvSerialNum, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContactIndex=matDryContactIndex, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsNotRespond=matStsNotRespond, matInvRunMode=matInvRunMode, matSts=matSts, matConCanBusOff=matConCanBusOff, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matDryContactEntry=matDryContactEntry, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matTraps=matTraps, matInvHardwareError=matInvHardwareError, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvPulseFault=matInvPulseFault, matStsFaultMode=matStsFaultMode, matStsOutputAbnormal=matStsOutputAbnormal, matStsModuleIndex=matStsModuleIndex, matReturnFromStsFanFault=matReturnFromStsFanFault, matConTemperatureHigh=matConTemperatureHigh, matConEEPROMFault=matConEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsOutputFreq=matStsOutputFreq, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsDesc=matTrapTargetsDesc, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvOnOffStatus=matInvOnOffStatus, matTrapType=matTrapType, matInvPriority=matInvPriority, matInvRunTime=matInvRunTime, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matDryContact=matDryContact, matStsMainInputFreq=matStsMainInputFreq, matDryContactTable=matDryContactTable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsFirmwareVersion=matStsFirmwareVersion, matInvLineVoltage=matInvLineVoltage, device=device, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsAddress=matTrapTargetsAddress, matInvModuleNum=matInvModuleNum, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargets=matTrapTargets, matConfStsPriority=matConfStsPriority, matInvNotRespond=matInvNotRespond, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvPowerLimit=matInvPowerLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvInputAbnormal=matInvInputAbnormal, matConCommunicationLost=matConCommunicationLost, matConfig=matConfig, matInvTempPowerLimit=matInvTempPowerLimit, matStsOverLoad=matStsOverLoad, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOutputVoltage=matInvOutputVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsWarningState=matStsWarningState, matStsRuntime=matStsRuntime, matInvFanFault=matInvFanFault, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConBatteryVoltHigh=matConBatteryVoltHigh, matTrapTargetsNum=matTrapTargetsNum, matInvEntry=matInvEntry, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConTemperature=matConTemperature, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvBusSoftFail=matInvBusSoftFail, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvMainUnavailable=matInvMainUnavailable, matTrapSeverityLevel=matTrapSeverityLevel, matInvBypassSCRShort=matInvBypassSCRShort, matInvOverLoad=matInvOverLoad, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvTable=matInvTable, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInverter=matInverter, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMBSPosFault=matStsMBSPosFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConName=matConName, matInvOutputFreq=matInvOutputFreq, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConBatteryLow=matConBatteryLow, matStsTemperature=matStsTemperature, matAgent=matAgent, matInvWarningState=matInvWarningState, matConfInvInputVoltage=matConfInvInputVoltage, matStsModuleType=matStsModuleType, matConSerialNum=matConSerialNum, NonNegativeInteger=NonNegativeInteger, matConfInvSysPriority=matConfInvSysPriority, matInvOutputShort=matInvOutputShort, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapTargetsEntry=matTrapTargetsEntry, matStsSerialNum=matStsSerialNum, matStsOutputCurrent=matStsOutputCurrent, matConfStsFanSpeed=matConfStsFanSpeed, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTemperature=matInvTemperature, matStsOutputVoltage=matStsOutputVoltage, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvMBSPosError=matInvMBSPosError, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsBypassUnavailable=matStsBypassUnavailable, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvOutputVoltLow=matInvOutputVoltLow, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvOutputPower=matInvOutputPower, matInvFault=matInvFault, matStsFanFault=matStsFanFault, matStsMainsFail=matStsMainsFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvModuleIndex=matInvModuleIndex, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsEntry=matStsEntry, matReturnFromInvFault=matReturnFromInvFault, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsRunningMode=matStsRunningMode, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvPhaseType=matInvPhaseType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsModuleNum=matStsModuleNum, matConWarningState=matConWarningState, matReturnFromStsInvFail=matReturnFromStsInvFail, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvSoftStartFail=matInvSoftStartFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfInvOutputPower=matConfInvOutputPower, matStsTable=matStsTable, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMbsPosition=matInvMbsPosition, matObjects=matObjects, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsOutputShortCircuit=matStsOutputShortCircuit, PositiveInteger=PositiveInteger, matStsInvInputFreq=matStsInvInputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsInvFail=matStsInvFail, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsMainInputVoltage=matStsMainInputVoltage, matInvLineFreq=matInvLineFreq)
