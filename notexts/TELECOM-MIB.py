...
ObjectIdentity, Counter32, Integer32, Bits, IpAddress, Unsigned32, iso, NotificationType, MibIdentifier, TimeTicks, NotificationType, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Integer32", "Bits", "IpAddress", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "NotificationType", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvInputVoltage=matStsInvInputVoltage, matStsStatus=matStsStatus, matTrapTargetsIndex=matTrapTargetsIndex, matInvNotRespond=matInvNotRespond, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvHardwareError=matInvHardwareError, matInvSoftStartFail=matInvSoftStartFail, matSts=matSts, matStsEntry=matStsEntry, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvFail=matStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsTable=matTrapTargetsTable, matDryContactNum=matDryContactNum, matStsModuleIndex=matStsModuleIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysOutputVolt=matConfInvSysOutputVolt, PositiveInteger=PositiveInteger, matInvFanFault=matInvFanFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvTemperature=matInvTemperature, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContactIndex=matDryContactIndex, matStsOutputFreq=matStsOutputFreq, matConName=matConName, matTraps=matTraps, matInvOutputPower=matInvOutputPower, matConCanBusOff=matConCanBusOff, matInvPulseFault=matInvPulseFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvBatteryVoltage=matInvBatteryVoltage, matTrapTargets=matTrapTargets, matStsInvBypassMode=matStsInvBypassMode, matStsTable=matStsTable, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvLineFreq=matInvLineFreq, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvBusSoftFail=matInvBusSoftFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsControlPowerFail=matStsControlPowerFail, matDryContactString=matDryContactString, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsModuleType=matStsModuleType, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMainUnavailable=matInvMainUnavailable, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMbsPosition=matInvMbsPosition, matStsRunningMode=matStsRunningMode, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsInvInputFreq=matStsInvInputFreq, matStsTemperature=matStsTemperature, matInverter=matInverter, matReturnFromStsFanFault=matReturnFromStsFanFault, matConTemperatureHigh=matConTemperatureHigh, matStsSerialNum=matStsSerialNum, matStsOutputPower=matStsOutputPower, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsOutputAbnormal=matStsOutputAbnormal, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvRunMode=matInvRunMode, matStsFirmwareVersion=matStsFirmwareVersion, matStsMainInputFreq=matStsMainInputFreq, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvModuleNum=matInvModuleNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsMainsFail=matStsMainsFail, matStsNotRespond=matStsNotRespond, matInvOutputFreq=matInvOutputFreq, matInvOutputShort=matInvOutputShort, matInvBypassSCRShort=matInvBypassSCRShort, matInvTable=matInvTable, matConSerialNum=matConSerialNum, matConfInvOutputPower=matConfInvOutputPower, matTrapSeverityLevel=matTrapSeverityLevel, matInvHardwareVersion=matInvHardwareVersion, matInvEntry=matInvEntry, matStsFaultMode=matStsFaultMode, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfStsPriority=matConfStsPriority, ppc=ppc, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matAgent=matAgent, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsModuleNum=matStsModuleNum, matInvLineVoltage=matInvLineVoltage, matStsTemperatureHigh=matStsTemperatureHigh, device=device, matConBatteryLow=matConBatteryLow, matStsRuntime=matStsRuntime, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvOverLoad=matInvOverLoad, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapType=matTrapType, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConCommunicationLost=matConCommunicationLost, matConEEPROMFault=matConEEPROMFault, matObjects=matObjects, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConTemperature=matConTemperature, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matInvEPOShutdown=matInvEPOShutdown, matStsBypassUnavailable=matStsBypassUnavailable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsFanFault=matStsFanFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvSerialNum=matInvSerialNum, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMBSPosFault=matStsMBSPosFault, matInvRunTime=matInvRunTime, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsWarningState=matStsWarningState, matStsOverLoad=matStsOverLoad, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvOutputVoltLow=matInvOutputVoltLow, matStsMbsStatus=matStsMbsStatus, matInvInputAbnormal=matInvInputAbnormal, NonNegativeInteger=NonNegativeInteger, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvSysPriority=matConfInvSysPriority, matDryContact=matDryContact, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactTable=matDryContactTable, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvFault=matInvFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvPowerLimit=matInvPowerLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvMBSPosError=matInvMBSPosError, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matDryContactEntry=matDryContactEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputCurrent=matInvOutputCurrent, matConfig=matConfig, matStsOutputCurrent=matStsOutputCurrent, matConWarningState=matConWarningState, matConfInvInputVoltage=matConfInvInputVoltage, matInvPhaseType=matInvPhaseType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvWarningState=matInvWarningState, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapTargetsNum=matTrapTargetsNum, matController=matController, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvFirmwareVersion=matInvFirmwareVersion, matInvTempPowerLimit=matInvTempPowerLimit, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvPriority=matInvPriority, matConfInvOutputFreq=matConfInvOutputFreq, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfInvOutputVoltage=matConfInvOutputVoltage)
