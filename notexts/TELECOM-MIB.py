...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvHighLossVoltage=matStsInvHighLossVoltage, matDryContactNum=matDryContactNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsModuleIndex=matStsModuleIndex, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvRunMode=matInvRunMode, matTrapTargetsDesc=matTrapTargetsDesc, matStsNotRespond=matStsNotRespond, matStsTemperature=matStsTemperature, matDryContactString=matDryContactString, matConfInvSysPriority=matConfInvSysPriority, matStsFanFault=matStsFanFault, matStsOutputPower=matStsOutputPower, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputShort=matInvOutputShort, matTrapTargetsTable=matTrapTargetsTable, matTrapTargetsAddress=matTrapTargetsAddress, matConfig=matConfig, matInvOutputCurrent=matInvOutputCurrent, matStsWarningState=matStsWarningState, matStsRuntime=matStsRuntime, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvTable=matInvTable, matInvOutputFreq=matInvOutputFreq, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContact=matDryContact, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matStsOutputCurrent=matStsOutputCurrent, matConEEPROMFault=matConEEPROMFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsInvFail=matStsInvFail, matTrapType=matTrapType, matDryContactIndex=matDryContactIndex, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvSerialNum=matInvSerialNum, PositiveInteger=PositiveInteger, matInvInputAbnormal=matInvInputAbnormal, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInverter=matInverter, matInvOutputVoltage=matInvOutputVoltage, matInvModuleNum=matInvModuleNum, matStsMainsFail=matStsMainsFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargets=matTrapTargets, matStsTemperatureHigh=matStsTemperatureHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsEntry=matStsEntry, matStsRunningMode=matStsRunningMode, matDryContactEntry=matDryContactEntry, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvOutputPower=matInvOutputPower, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTraps=matTraps, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matStsTable=matStsTable, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matInvEntry=matInvEntry, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConCommunicationLost=matConCommunicationLost, matStsOutputFreq=matStsOutputFreq, matInvRunTime=matInvRunTime, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matTrapTargetsNum=matTrapTargetsNum, matStsModuleType=matStsModuleType, matInvEEPROMFault=matInvEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matInvWarningState=matInvWarningState, matStsStatus=matStsStatus, matStsBypassUnavailable=matStsBypassUnavailable, matStsOutputVoltage=matStsOutputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matInvMBSPosError=matInvMBSPosError, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsEEPROMFault=matStsEEPROMFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfStsPriority=matConfStsPriority, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvPowerLimit=matInvPowerLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMbsPosition=matInvMbsPosition, matConWarningState=matConWarningState, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvHardwareError=matInvHardwareError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvHardwareVersion=matInvHardwareVersion, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvFault=matReturnFromInvFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matController=matController, matStsMainInputVoltage=matStsMainInputVoltage, matInvPulseFault=matInvPulseFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvModuleIndex=matInvModuleIndex, matInvPriority=matInvPriority, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConCanBusOff=matConCanBusOff, matConfInvInputVoltage=matConfInvInputVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsModuleNum=matStsModuleNum, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsSerialNum=matStsSerialNum, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvPhaseType=matInvPhaseType, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvFanFault=matInvFanFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matAgent=matAgent, NonNegativeInteger=NonNegativeInteger, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matObjects=matObjects, matTrapTargetsEntry=matTrapTargetsEntry, matInvOverLoad=matInvOverLoad, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsMainInputFreq=matStsMainInputFreq, matInvTemperature=matInvTemperature, matInvLineFreq=matInvLineFreq, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConName=matConName, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapSeverityLevel=matTrapSeverityLevel, matSts=matSts, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvLowInputShutdown=matInvLowInputShutdown, matConBatteryLow=matConBatteryLow, matConSerialNum=matConSerialNum, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvFault=matInvFault, ppc=ppc, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvNotRespond=matInvNotRespond, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsOverLoad=matStsOverLoad, matConTemperature=matConTemperature, matInvLineVoltage=matInvLineVoltage, matInvTempPowerLimit=matInvTempPowerLimit, matDryContactTable=matDryContactTable, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, device=device, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsFaultMode=matStsFaultMode, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvBatteryVoltage=matInvBatteryVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matStsOutputAbnormal=matStsOutputAbnormal)
