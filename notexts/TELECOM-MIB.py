...
mibBuilder.exportSymbols("TELECOM-MIB", matInvOutputVoltage=matInvOutputVoltage, matConName=matConName, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsBypassUnavailable=matStsBypassUnavailable, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvWarningState=matInvWarningState, matConfInvOutputPower=matConfInvOutputPower, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConSerialNum=matConSerialNum, matInvTable=matInvTable, matInvInputAbnormal=matInvInputAbnormal, matStsSerialNum=matStsSerialNum, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvEPOShutdown=matInvEPOShutdown, matStsTemperature=matStsTemperature, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsRunningMode=matStsRunningMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matSts=matSts, matConfStsPriority=matConfStsPriority, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsModuleIndex=matStsModuleIndex, matStsOverLoad=matStsOverLoad, matStsOutputAbnormal=matStsOutputAbnormal, matInvHardwareVersion=matInvHardwareVersion, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTraps=matTraps, matStsOutputPower=matStsOutputPower, matConfInvOutputVoltage=matConfInvOutputVoltage, matDryContactEntry=matDryContactEntry, matStsOutputFreq=matStsOutputFreq, matInvSerialNum=matInvSerialNum, matTrapType=matTrapType, matStsMainsFail=matStsMainsFail, matStsInvInputFreq=matStsInvInputFreq, matConBatteryLow=matConBatteryLow, matStsNotRespond=matStsNotRespond, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvTemperature=matInvTemperature, matConWarningState=matConWarningState, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvOutputFreq=matInvOutputFreq, matTrapTargetsNum=matTrapTargetsNum, matInvOverLoad=matInvOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvFault=matReturnFromInvFault, matConCommunicationLost=matConCommunicationLost, matObjects=matObjects, matStsFaultMode=matStsFaultMode, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvHardwareError=matInvHardwareError, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsMainInputFreq=matStsMainInputFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvEntry=matInvEntry, matInvFault=matInvFault, matInvOutputCurrent=matInvOutputCurrent, matInvPulseFault=matInvPulseFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvOutputVoltLow=matInvOutputVoltLow, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvTempPowerLimit=matInvTempPowerLimit, matInvPriority=matInvPriority, matInvLowInputShutdown=matInvLowInputShutdown, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvModuleNum=matInvModuleNum, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsEntry=matStsEntry, matTrapTargetsEntry=matTrapTargetsEntry, matInvMbsPosition=matInvMbsPosition, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvFanFault=matInvFanFault, PositiveInteger=PositiveInteger, device=device, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matDryContactNum=matDryContactNum, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsFanFault=matReturnFromStsFanFault, ppc=ppc, matStsMbsStatus=matStsMbsStatus, matStsInvFail=matStsInvFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matController=matController, matTrapSeverityLevel=matTrapSeverityLevel, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matInvRunMode=matInvRunMode, matInvLineVoltage=matInvLineVoltage, matConfInvSysPriority=matConfInvSysPriority, matStsStatus=matStsStatus, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsWarningState=matStsWarningState, matInvModuleIndex=matInvModuleIndex, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvEEPROMFault=matInvEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvBusSoftFail=matInvBusSoftFail, matStsOutputVoltage=matStsOutputVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargets=matTrapTargets, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matDryContactString=matDryContactString, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfig=matConfig, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvOutputShort=matInvOutputShort, matConfInvSysInputVolt=matConfInvSysInputVolt, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvMBSPosError=matInvMBSPosError, matConEEPROMFault=matConEEPROMFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvLineFreq=matInvLineFreq, matInverter=matInverter, matDryContactIndex=matDryContactIndex, matConTemperature=matConTemperature, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConCanBusOff=matConCanBusOff, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfStsFanSpeed=matConfStsFanSpeed, matInvPhaseType=matInvPhaseType, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsEEPROMFault=matStsEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsModuleNum=matStsModuleNum, matStsInvBypassMode=matStsInvBypassMode, matStsTable=matStsTable, matInvOutputPower=matInvOutputPower, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matDryContactTable=matDryContactTable, NonNegativeInteger=NonNegativeInteger, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvPowerLimit=matInvPowerLimit, matConfInvInputVoltage=matConfInvInputVoltage, matStsControlPowerFail=matStsControlPowerFail, matDryContact=matDryContact, matInvRunTime=matInvRunTime, matStsFanFault=matStsFanFault, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matAgent=matAgent, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsModuleType=matStsModuleType, matStsRuntime=matStsRuntime, matInvNotRespond=matInvNotRespond, matStsOutputCurrent=matStsOutputCurrent, matStsMainInputVoltage=matStsMainInputVoltage)
