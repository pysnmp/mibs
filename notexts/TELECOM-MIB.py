...
Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, MibIdentifier, NotificationType, Counter64, enterprises, Unsigned32, ModuleIdentity, Bits, NotificationType, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter64", "enterprises", "Unsigned32", "ModuleIdentity", "Bits", "NotificationType", "Gauge32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConTemperature=matConTemperature, matInvModuleIndex=matInvModuleIndex, matTrapType=matTrapType, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysPriority=matConfInvSysPriority, matStsFirmwareVersion=matStsFirmwareVersion, matConWarningState=matConWarningState, ppc=ppc, matInvOutputShort=matInvOutputShort, matTrapTargetsAddress=matTrapTargetsAddress, matStsInvFail=matStsInvFail, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvLineVoltage=matInvLineVoltage, matConSerialNum=matConSerialNum, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOverLoad=matStsOverLoad, matStsOutputPower=matStsOutputPower, matInvLineFreq=matInvLineFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsMBSPosFault=matStsMBSPosFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvOnOffStatus=matInvOnOffStatus, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvTemperature=matInvTemperature, matTrapTargetsTable=matTrapTargetsTable, matStsModuleType=matStsModuleType, matConfInvOutputVoltage=matConfInvOutputVoltage, matDryContact=matDryContact, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matObjects=matObjects, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matDryContactNum=matDryContactNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsRuntime=matStsRuntime, matConfStsFanSpeed=matConfStsFanSpeed, matStsFaultMode=matStsFaultMode, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConName=matConName, matConBatteryLow=matConBatteryLow, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, device=device, matInvEPOShutdown=matInvEPOShutdown, matInvModuleNum=matInvModuleNum, matInvFault=matInvFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConEEPROMFault=matConEEPROMFault, matInvTable=matInvTable, matInvMbsPosition=matInvMbsPosition, matDryContactIndex=matDryContactIndex, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvSerialNum=matInvSerialNum, PositiveInteger=PositiveInteger, matDryContactString=matDryContactString, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsSerialNum=matStsSerialNum, matInvMainUnavailable=matInvMainUnavailable, matDryContactTable=matDryContactTable, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvTemperatureHigh=matInvTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matStsEEPROMFault=matStsEEPROMFault, matInvPowerLimit=matInvPowerLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsNotRespond=matStsNotRespond, matConCanBusOff=matConCanBusOff, matStsOutputVoltage=matStsOutputVoltage, matDryContactEntry=matDryContactEntry, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvBypassSCRShort=matInvBypassSCRShort, matStsBypassUnavailable=matStsBypassUnavailable, matStsControlPowerFail=matStsControlPowerFail, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvRunTime=matInvRunTime, matStsModuleNum=matStsModuleNum, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapTargets=matTrapTargets, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvNotRespond=matInvNotRespond, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsTemperature=matStsTemperature, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsWarningState=matStsWarningState, matInvOutputVoltage=matInvOutputVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsStatus=matStsStatus, matInvEntry=matInvEntry, matReturnFromInvFault=matReturnFromInvFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputPower=matInvOutputPower, matStsEntry=matStsEntry, matInvLowInputShutdown=matInvLowInputShutdown, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOutputCurrent=matInvOutputCurrent, matTrapSeverityLevel=matTrapSeverityLevel, matInvPhaseType=matInvPhaseType, NonNegativeInteger=NonNegativeInteger, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvHardwareError=matInvHardwareError, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsInvBypassMode=matStsInvBypassMode, matStsTemperatureHigh=matStsTemperatureHigh, matInvMBSPosError=matInvMBSPosError, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInverter=matInverter, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvOverLoad=matInvOverLoad, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargetsDesc=matTrapTargetsDesc, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvRunMode=matInvRunMode, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsTable=matStsTable, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsEntry=matTrapTargetsEntry, matInvPulseFault=matInvPulseFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvInputVoltage=matConfInvInputVoltage, matConfStsPriority=matConfStsPriority, matStsOutputFreq=matStsOutputFreq, matInvFanFault=matInvFanFault, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsRunningMode=matStsRunningMode, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConCommunicationLost=matConCommunicationLost, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainInputFreq=matStsMainInputFreq, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputFreq=matInvOutputFreq, matController=matController, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsFanFault=matStsFanFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTraps=matTraps, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsMainInputVoltage=matStsMainInputVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvPriority=matInvPriority, matStsModuleIndex=matStsModuleIndex, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvWarningState=matInvWarningState, matStsMainsFail=matStsMainsFail, matConfig=matConfig, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matSts=matSts, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargetsNum=matTrapTargetsNum, matInvSoftStartFail=matInvSoftStartFail, matAgent=matAgent, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault)
