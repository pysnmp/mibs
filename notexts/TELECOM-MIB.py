...
NotificationType, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, Counter32, Gauge32, ModuleIdentity, iso, Counter64, enterprises, NotificationType, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "Counter32", "Gauge32", "ModuleIdentity", "iso", "Counter64", "enterprises", "NotificationType", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsAddress=matTrapTargetsAddress, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matDryContactNum=matDryContactNum, matStsInvInputVoltage=matStsInvInputVoltage, matInvOutputCurrent=matInvOutputCurrent, matDryContactString=matDryContactString, matConfInvInputVoltage=matConfInvInputVoltage, matStsTemperatureHigh=matStsTemperatureHigh, matInvFanFault=matInvFanFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matObjects=matObjects, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTraps=matTraps, matInvTemperature=matInvTemperature, matStsOutputPower=matStsOutputPower, matInvPhaseType=matInvPhaseType, matInvModuleIndex=matInvModuleIndex, matInvPriority=matInvPriority, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsRuntime=matStsRuntime, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapType=matTrapType, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvLineFreq=matInvLineFreq, matReturnFromStsFaultMode=matReturnFromStsFaultMode, ppc=ppc, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsInvBypassMode=matStsInvBypassMode, matInvModuleNum=matInvModuleNum, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsInvInputFreq=matStsInvInputFreq, matController=matController, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvOutputPower=matConfInvOutputPower, matInvInputAbnormal=matInvInputAbnormal, NonNegativeInteger=NonNegativeInteger, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfStsFanSpeed=matConfStsFanSpeed, matInvFault=matInvFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvHardwareError=matInvHardwareError, matDryContactEntry=matDryContactEntry, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matAgent=matAgent, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsStatus=matStsStatus, matTrapTargetsEntry=matTrapTargetsEntry, matConfig=matConfig, matInvOverLoad=matInvOverLoad, matInvEEPROMFault=matInvEEPROMFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matConTemperatureHigh=matConTemperatureHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvRunTime=matInvRunTime, matStsOutputAbnormal=matStsOutputAbnormal, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsMbsStatus=matStsMbsStatus, matStsSerialNum=matStsSerialNum, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConCommunicationLost=matConCommunicationLost, matConEEPROMFault=matConEEPROMFault, matStsRunningMode=matStsRunningMode, matStsOutputCurrent=matStsOutputCurrent, matStsModuleIndex=matStsModuleIndex, matInvNotRespond=matInvNotRespond, matStsEntry=matStsEntry, matInvWarningState=matInvWarningState, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromConBatteryLow=matReturnFromConBatteryLow, PositiveInteger=PositiveInteger, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matDryContactTable=matDryContactTable, matInvOutputFreq=matInvOutputFreq, matConSerialNum=matConSerialNum, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOverLoad=matStsOverLoad, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapSeverityLevel=matTrapSeverityLevel, matInvPulseFault=matInvPulseFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsNotRespond=matStsNotRespond, matConName=matConName, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsInvFail=matStsInvFail, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConCanBusOff=matConCanBusOff, matStsEEPROMFault=matStsEEPROMFault, device=device, matStsModuleType=matStsModuleType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsMainInputFreq=matStsMainInputFreq, matTrapTargetsNum=matTrapTargetsNum, matStsModuleNum=matStsModuleNum, matStsMainInputVoltage=matStsMainInputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsTemperature=matStsTemperature, matInvTable=matInvTable, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputPower=matInvOutputPower, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvOutputVoltage=matInvOutputVoltage, matStsOutputFreq=matStsOutputFreq, matInvHardwareVersion=matInvHardwareVersion, matDryContactIndex=matDryContactIndex, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvMainUnavailable=matInvMainUnavailable, matInvSerialNum=matInvSerialNum, matTrapTargets=matTrapTargets, matConfStsPriority=matConfStsPriority, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysPriority=matConfInvSysPriority, matConWarningState=matConWarningState, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMainsFail=matStsMainsFail, matStsWarningState=matStsWarningState, matInverter=matInverter, matConTemperature=matConTemperature, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConBatteryLow=matConBatteryLow, matStsTable=matStsTable, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvMBSPosError=matInvMBSPosError, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvLineVoltage=matInvLineVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsFanFault=matStsFanFault, matStsControlPowerFail=matStsControlPowerFail, matTrapTargetsTable=matTrapTargetsTable, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvEPOShutdown=matInvEPOShutdown, matInvMbsPosition=matInvMbsPosition, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matDryContact=matDryContact, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvSoftStartFail=matInvSoftStartFail, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvOutputShort=matInvOutputShort, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvPowerLimit=matInvPowerLimit, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvFault=matReturnFromInvFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvRunMode=matInvRunMode, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsFaultMode=matStsFaultMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matSts=matSts, matInvTemperatureHigh=matInvTemperatureHigh, matInvEntry=matInvEntry)
