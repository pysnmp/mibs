...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMainsFail=matStsMainsFail, matDryContactNum=matDryContactNum, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputFreq=matConfInvOutputFreq, matInvMainUnavailable=matInvMainUnavailable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsTable=matStsTable, matStsTemperatureHigh=matStsTemperatureHigh, matConfStsFanSpeed=matConfStsFanSpeed, matStsMainInputFreq=matStsMainInputFreq, matStsMbsStatus=matStsMbsStatus, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, device=device, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvLineFreq=matInvLineFreq, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matDryContactString=matDryContactString, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsFanFault=matReturnFromStsFanFault, matConEEPROMFault=matConEEPROMFault, matConfInvOutputVoltage=matConfInvOutputVoltage, matConTemperature=matConTemperature, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsNotRespond=matStsNotRespond, matConName=matConName, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvInputAbnormal=matInvInputAbnormal, matDryContact=matDryContact, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsOutputCurrent=matStsOutputCurrent, matInvFirmwareVersion=matInvFirmwareVersion, matStsOutputPower=matStsOutputPower, matStsStatus=matStsStatus, matInvOverLoad=matInvOverLoad, matStsInvFail=matStsInvFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvOnOffStatus=matInvOnOffStatus, matStsModuleNum=matStsModuleNum, matController=matController, matStsOutputVoltage=matStsOutputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOverLoad=matStsOverLoad, matConfInvInputVoltage=matConfInvInputVoltage, matInvSoftStartFail=matInvSoftStartFail, matStsSerialNum=matStsSerialNum, matStsTemperature=matStsTemperature, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvOutputPower=matInvOutputPower, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvBypassSCRShort=matInvBypassSCRShort, matInvPowerLimit=matInvPowerLimit, matConCommunicationLost=matConCommunicationLost, matStsWarningState=matStsWarningState, matReturnFromInvFault=matReturnFromInvFault, matStsRunningMode=matStsRunningMode, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsFanFault=matStsFanFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matDryContactTable=matDryContactTable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsEntry=matStsEntry, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvEPOShutdown=matInvEPOShutdown, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvHardwareVersion=matInvHardwareVersion, matInvEntry=matInvEntry, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsInvInputFreq=matStsInvInputFreq, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsHardwareVersion=matStsHardwareVersion, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvPulseFault=matInvPulseFault, matInvHardwareError=matInvHardwareError, matInvFanFault=matInvFanFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvTemperature=matInvTemperature, matTrapTargetsTable=matTrapTargetsTable, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsFaultMode=matStsFaultMode, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsFirmwareVersion=matStsFirmwareVersion, matTrapTargetsIndex=matTrapTargetsIndex, matStsControlPowerFail=matStsControlPowerFail, matConfig=matConfig, matInvRunTime=matInvRunTime, matSts=matSts, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, ppc=ppc, matInvModuleIndex=matInvModuleIndex, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputFreq=matInvOutputFreq, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConCanBusOff=matConCanBusOff, matDryContactIndex=matDryContactIndex, matInvOutputVoltHigh=matInvOutputVoltHigh, matDryContactEntry=matDryContactEntry, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matStsEEPROMFault=matStsEEPROMFault, matInvNotRespond=matInvNotRespond, matStsInvBypassMode=matStsInvBypassMode, matInvFault=matInvFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matAgent=matAgent, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsOutputAbnormal=matStsOutputAbnormal, matConWarningState=matConWarningState, matInvTemperatureHigh=matInvTemperatureHigh, matInvTable=matInvTable, matStsRuntime=matStsRuntime, matTrapType=matTrapType, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvEEPROMFault=matInvEEPROMFault, matInvWarningState=matInvWarningState, matStsModuleIndex=matStsModuleIndex, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvPriority=matInvPriority, matConfStsPriority=matConfStsPriority, PositiveInteger=PositiveInteger, matTrapTargetsAddress=matTrapTargetsAddress, matInvSerialNum=matInvSerialNum, NonNegativeInteger=NonNegativeInteger, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvOutputVoltLow=matInvOutputVoltLow, matInvRunMode=matInvRunMode, matInvModuleNum=matInvModuleNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsMainInputVoltage=matStsMainInputVoltage, matInvTempPowerLimit=matInvTempPowerLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConSerialNum=matConSerialNum, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvLineVoltage=matInvLineVoltage, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsModuleType=matStsModuleType, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matTraps=matTraps, matConTemperatureHigh=matConTemperatureHigh, matInvPhaseType=matInvPhaseType, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matObjects=matObjects, matInverter=matInverter, matInvOutputShort=matInvOutputShort, matTrapTargetsDesc=matTrapTargetsDesc, matTrapTargets=matTrapTargets, matStsOutputFreq=matStsOutputFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matConBatteryLow=matConBatteryLow, matInvMbsPosition=matInvMbsPosition, matConfInvSysOutputVolt=matConfInvSysOutputVolt)
