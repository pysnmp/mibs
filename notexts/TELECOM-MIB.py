...
TimeTicks, MibIdentifier, IpAddress, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, ObjectIdentity, Unsigned32, enterprises, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "enterprises", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargets=matTrapTargets, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsHardwareVersion=matStsHardwareVersion, matInvOutputFreq=matInvOutputFreq, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matTrapTargetsAddress=matTrapTargetsAddress, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvRunMode=matInvRunMode, matStsEEPROMFault=matStsEEPROMFault, matStsMainsFail=matStsMainsFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matDryContactEntry=matDryContactEntry, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, device=device, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvOutputCurrent=matInvOutputCurrent, matStsOutputCurrent=matStsOutputCurrent, matDryContactIndex=matDryContactIndex, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapSeverityLevel=matTrapSeverityLevel, matStsTemperature=matStsTemperature, matInvTemperature=matInvTemperature, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapType=matTrapType, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConWarningState=matConWarningState, matTraps=matTraps, matDryContactTable=matDryContactTable, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsMainInputVoltage=matStsMainInputVoltage, matInvSoftStartFail=matInvSoftStartFail, matInvEEPROMFault=matInvEEPROMFault, matStsModuleType=matStsModuleType, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matDryContactString=matDryContactString, matStsInvInputVoltage=matStsInvInputVoltage, matInvPowerLimit=matInvPowerLimit, matInvBusSoftFail=matInvBusSoftFail, matConBatteryLow=matConBatteryLow, matInvHardwareVersion=matInvHardwareVersion, matStsTable=matStsTable, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matController=matController, matInvPhaseType=matInvPhaseType, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsMainInputFreq=matStsMainInputFreq, matDryContactNum=matDryContactNum, matTrapTargetsNum=matTrapTargetsNum, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBypassSCRShort=matInvBypassSCRShort, matConSerialNum=matConSerialNum, matInvOutputVoltLow=matInvOutputVoltLow, matInvWarningState=matInvWarningState, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputFreq=matStsOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsRunningMode=matStsRunningMode, matInvLineFreq=matInvLineFreq, matInvOverLoad=matInvOverLoad, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvModuleIndex=matInvModuleIndex, matConfig=matConfig, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfStsPriority=matConfStsPriority, matStsBypassUnavailable=matStsBypassUnavailable, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsOutputPower=matStsOutputPower, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsNotRespond=matStsNotRespond, matStsControlPowerFail=matStsControlPowerFail, matStsStatus=matStsStatus, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matTrapTargetsEntry=matTrapTargetsEntry, matStsMBSPosFault=matStsMBSPosFault, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsFanFault=matStsFanFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvTable=matInvTable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvTemperatureHigh=matInvTemperatureHigh, matInvNegativePowerProtect=matInvNegativePowerProtect, matTrapTargetsTable=matTrapTargetsTable, matInvLowInputShutdown=matInvLowInputShutdown, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsWarningState=matStsWarningState, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvOnOffStatus=matInvOnOffStatus, matDryContact=matDryContact, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvRunTime=matInvRunTime, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvHardwareError=matInvHardwareError, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsModuleNum=matStsModuleNum, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvSerialNum=matInvSerialNum, matConEEPROMFault=matConEEPROMFault, matInverter=matInverter, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, NonNegativeInteger=NonNegativeInteger, matReturnFromInvFault=matReturnFromInvFault, matConCanBusOff=matConCanBusOff, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvFault=matInvFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvFanFault=matInvFanFault, matInvEntry=matInvEntry, matInvPulseFault=matInvPulseFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvModuleNum=matInvModuleNum, matInvTempPowerLimit=matInvTempPowerLimit, matInvEPOShutdown=matInvEPOShutdown, matConTemperatureHigh=matConTemperatureHigh, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvInputVoltage=matConfInvInputVoltage, matStsEntry=matStsEntry, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matConTemperature=matConTemperature, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputShort=matInvOutputShort, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvMBSPosError=matInvMBSPosError, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvNotRespond=matInvNotRespond, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsInvFail=matStsInvFail, matConCommunicationLost=matConCommunicationLost, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsSerialNum=matStsSerialNum, matStsFaultMode=matStsFaultMode, matAgent=matAgent, matStsRuntime=matStsRuntime, matConName=matConName, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsModuleIndex=matStsModuleIndex, PositiveInteger=PositiveInteger, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvMbsPosition=matInvMbsPosition, matInvInputAbnormal=matInvInputAbnormal, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvLineVoltage=matInvLineVoltage, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvPriority=matInvPriority, ppc=ppc, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOverLoad=matStsOverLoad, matInvOutputPower=matInvOutputPower, matObjects=matObjects, matSts=matSts, matInvMainUnavailable=matInvMainUnavailable)
