...
mibBuilder.exportSymbols("TELECOM-MIB", matInvFirmwareVersion=matInvFirmwareVersion, matStsRuntime=matStsRuntime, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvFault=matReturnFromInvFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, PositiveInteger=PositiveInteger, matTrapSeverityLevel=matTrapSeverityLevel, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOutputVoltage=matInvOutputVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvLineVoltage=matInvLineVoltage, matConName=matConName, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matStsMainInputFreq=matStsMainInputFreq, matStsSerialNum=matStsSerialNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsOutputPower=matStsOutputPower, matStsMBSPosFault=matStsMBSPosFault, matConCanBusOff=matConCanBusOff, matInvFault=matInvFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConBatteryLow=matConBatteryLow, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsEntry=matStsEntry, matInvBypassSCRShort=matInvBypassSCRShort, matInvPhaseType=matInvPhaseType, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsTemperatureHigh=matStsTemperatureHigh, matConTemperatureHigh=matConTemperatureHigh, matStsWarningState=matStsWarningState, matStsFaultMode=matStsFaultMode, matInvBatteryVoltage=matInvBatteryVoltage, matStsModuleType=matStsModuleType, matTrapType=matTrapType, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConTemperature=matConTemperature, matInvMBSPosError=matInvMBSPosError, matTrapTargetsDesc=matTrapTargetsDesc, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsTemperature=matStsTemperature, matStsTable=matStsTable, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsModuleNum=matStsModuleNum, matInvNotRespond=matInvNotRespond, matStsOutputAbnormal=matStsOutputAbnormal, matInvRunMode=matInvRunMode, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputPower=matInvOutputPower, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfig=matConfig, matStsControlPowerFail=matStsControlPowerFail, device=device, matConEEPROMFault=matConEEPROMFault, matInvEntry=matInvEntry, matTrapTargetsTable=matTrapTargetsTable, matStsInvFail=matStsInvFail, matStsInvInputFreq=matStsInvInputFreq, matInvEEPROMFault=matInvEEPROMFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, ppc=ppc, matDryContactEntry=matDryContactEntry, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsPriority=matConfStsPriority, matStsHardwareVersion=matStsHardwareVersion, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matTrapTargetsIndex=matTrapTargetsIndex, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matDryContactTable=matDryContactTable, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matAgent=matAgent, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputCurrent=matInvOutputCurrent, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactNum=matDryContactNum, matStsStatus=matStsStatus, matInvTable=matInvTable, matInvPriority=matInvPriority, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsMbsStatus=matStsMbsStatus, matInvFanFault=matInvFanFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matObjects=matObjects, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsNum=matTrapTargetsNum, matInvPowerLimit=matInvPowerLimit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, NonNegativeInteger=NonNegativeInteger, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsOverLoad=matStsOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matTrapTargets=matTrapTargets, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvInputVoltage=matConfInvInputVoltage, matInvMainUnavailable=matInvMainUnavailable, matInvModuleIndex=matInvModuleIndex, matInvOutputFreq=matInvOutputFreq, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matSts=matSts, matInvHardwareError=matInvHardwareError, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvTempPowerLimit=matInvTempPowerLimit, matInvPulseFault=matInvPulseFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvSerialNum=matInvSerialNum, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvOutputShort=matInvOutputShort, matStsRunningMode=matStsRunningMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConWarningState=matConWarningState, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsInvInputVoltage=matStsInvInputVoltage, matStsFanFault=matStsFanFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvWarningState=matInvWarningState, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLineFreq=matInvLineFreq, matConfInvOutputPower=matConfInvOutputPower, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMainsFail=matStsMainsFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvRunTime=matInvRunTime, matInvTemperature=matInvTemperature, matInvOverLoad=matInvOverLoad, matController=matController, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matDryContactString=matDryContactString, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConSerialNum=matConSerialNum, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsOutputFreq=matStsOutputFreq, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInverter=matInverter, matDryContactIndex=matDryContactIndex, matStsNotRespond=matStsNotRespond, matInvModuleNum=matInvModuleNum, matStsModuleIndex=matStsModuleIndex, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvMbsPosition=matInvMbsPosition, matTraps=matTraps, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matDryContact=matDryContact, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvSysPriority=matConfInvSysPriority, matStsInvHighLossVoltage=matStsInvHighLossVoltage)
