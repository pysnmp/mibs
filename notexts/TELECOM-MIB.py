...
ModuleIdentity, Gauge32, iso, Integer32, Counter32, Unsigned32, enterprises, Bits, TimeTicks, NotificationType, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "iso", "Integer32", "Counter32", "Unsigned32", "enterprises", "Bits", "TimeTicks", "NotificationType", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMaintenanceBypass=matStsMaintenanceBypass, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConWarningState=matConWarningState, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, device=device, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvMbsPosition=matInvMbsPosition, matAgent=matAgent, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfStsFanSpeed=matConfStsFanSpeed, matInvInputAbnormal=matInvInputAbnormal, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvSoftStartFail=matInvSoftStartFail, matStsModuleIndex=matStsModuleIndex, matTrapTargets=matTrapTargets, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvTempPowerLimit=matInvTempPowerLimit, matStsStatus=matStsStatus, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputVoltage=matInvOutputVoltage, matConfig=matConfig, matInvBatteryVoltage=matInvBatteryVoltage, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvLineVoltage=matInvLineVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, ppc=ppc, matStsRuntime=matStsRuntime, matConCommunicationLost=matConCommunicationLost, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConCanBusOff=matConCanBusOff, matDryContactEntry=matDryContactEntry, matStsTemperatureHigh=matStsTemperatureHigh, matInvSerialNum=matInvSerialNum, matInvFault=matInvFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConTemperature=matConTemperature, matTrapTargetsIndex=matTrapTargetsIndex, matDryContactIndex=matDryContactIndex, matObjects=matObjects, matStsOverLoad=matStsOverLoad, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvEEPROMFault=matInvEEPROMFault, matInvPowerLimit=matInvPowerLimit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, PositiveInteger=PositiveInteger, matConEEPROMFault=matConEEPROMFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvOnOffStatus=matInvOnOffStatus, matConfInvInputVoltage=matConfInvInputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvHardwareVersion=matInvHardwareVersion, matInvMainUnavailable=matInvMainUnavailable, matTrapType=matTrapType, matStsOutputCurrent=matStsOutputCurrent, matStsSerialNum=matStsSerialNum, matDryContactTable=matDryContactTable, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvRunTime=matInvRunTime, matInvLineFreq=matInvLineFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvFault=matReturnFromInvFault, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMainsFail=matStsMainsFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvPriority=matInvPriority, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsWarningState=matStsWarningState, matInvRunMode=matInvRunMode, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matController=matController, matInvTable=matInvTable, matStsNotRespond=matStsNotRespond, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matInvPulseFault=matInvPulseFault, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsMBSPosFault=matStsMBSPosFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsNum=matTrapTargetsNum, matStsOutputFreq=matStsOutputFreq, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsDesc=matTrapTargetsDesc, matConBatteryLow=matConBatteryLow, matStsRunningMode=matStsRunningMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvEPOShutdown=matInvEPOShutdown, matInvOutputCurrent=matInvOutputCurrent, matInvModuleNum=matInvModuleNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matDryContactString=matDryContactString, matInvTemperature=matInvTemperature, matStsTable=matStsTable, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvBypassMode=matStsInvBypassMode, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvOutputShort=matInvOutputShort, matConName=matConName, matStsInvFail=matStsInvFail, matInverter=matInverter, NonNegativeInteger=NonNegativeInteger, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matSts=matSts, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvHardwareError=matInvHardwareError, matConfInvSysPriority=matConfInvSysPriority, matStsOutputPower=matStsOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matDryContactNum=matDryContactNum, matStsModuleNum=matStsModuleNum, matConfStsPriority=matConfStsPriority, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvOverLoad=matInvOverLoad, matStsInvInputFreq=matStsInvInputFreq, matInvNotRespond=matInvNotRespond, matStsFanFault=matStsFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matDryContact=matDryContact, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainInputFreq=matStsMainInputFreq, matInvWarningState=matInvWarningState, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsFaultMode=matStsFaultMode, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMBSPosError=matInvMBSPosError, matStsModuleType=matStsModuleType, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvEntry=matInvEntry, matStsTemperature=matStsTemperature, matInvModuleIndex=matInvModuleIndex, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsInvInputVoltage=matStsInvInputVoltage, matStsEntry=matStsEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvPhaseType=matInvPhaseType, matInvFanFault=matInvFanFault, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputPower=matInvOutputPower, matTraps=matTraps, matTrapTargetsAddress=matTrapTargetsAddress, matInvBusSoftFail=matInvBusSoftFail, matConSerialNum=matConSerialNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputFreq=matInvOutputFreq, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matTrapTargetsTable=matTrapTargetsTable)
