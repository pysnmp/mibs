...
Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Unsigned32, enterprises, IpAddress, Counter64, MibIdentifier, TimeTicks, NotificationType, ObjectIdentity, Counter32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Unsigned32", "enterprises", "IpAddress", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter32", "iso", "Integer32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsSerialNum=matStsSerialNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvModuleNum=matInvModuleNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvTemperatureHigh=matInvTemperatureHigh, matDryContactIndex=matDryContactIndex, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvWarningState=matInvWarningState, matReturnFromStsInvFail=matReturnFromStsInvFail, matTrapType=matTrapType, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputShort=matInvOutputShort, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsTemperature=matStsTemperature, matConTemperature=matConTemperature, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvPowerLimit=matInvPowerLimit, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOnOffStatus=matInvOnOffStatus, matInvOverLoad=matInvOverLoad, matController=matController, matStsOutputPower=matStsOutputPower, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvNotRespond=matInvNotRespond, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsModuleIndex=matStsModuleIndex, matStsTable=matStsTable, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matTrapSeverityLevel=matTrapSeverityLevel, matDryContactEntry=matDryContactEntry, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConBatteryLow=matConBatteryLow, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsFaultMode=matStsFaultMode, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvFault=matInvFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsMainInputVoltage=matStsMainInputVoltage, matStsMainInputFreq=matStsMainInputFreq, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsNotRespond=matStsNotRespond, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvTempPowerLimit=matInvTempPowerLimit, matInvTable=matInvTable, matTrapTargetsIndex=matTrapTargetsIndex, matStsEntry=matStsEntry, matInvPhaseType=matInvPhaseType, matReturnFromStsFaultMode=matReturnFromStsFaultMode, device=device, matStsInvInputVoltage=matStsInvInputVoltage, matStsFanFault=matStsFanFault, matInvPulseFault=matInvPulseFault, matStsInvBypassMode=matStsInvBypassMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvBypassSCRShort=matInvBypassSCRShort, ppc=ppc, matInvOutputVoltage=matInvOutputVoltage, NonNegativeInteger=NonNegativeInteger, matInvBatteryVoltage=matInvBatteryVoltage, matConCommunicationLost=matConCommunicationLost, matTrapTargets=matTrapTargets, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvRunMode=matInvRunMode, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysPriority=matConfInvSysPriority, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matTrapTargetsTable=matTrapTargetsTable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTraps=matTraps, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfStsFanSpeed=matConfStsFanSpeed, matInvEntry=matInvEntry, matInvMbsPosition=matInvMbsPosition, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsTemperatureHigh=matStsTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matDryContact=matDryContact, matInvHardwareVersion=matInvHardwareVersion, matInvModuleIndex=matInvModuleIndex, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsOutputVoltage=matStsOutputVoltage, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvFanFault=matInvFanFault, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsEntry=matTrapTargetsEntry, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputCurrent=matInvOutputCurrent, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvSoftStartFail=matInvSoftStartFail, matConfStsPriority=matConfStsPriority, matInvPriority=matInvPriority, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvLineVoltage=matInvLineVoltage, matInvOutputPower=matInvOutputPower, matInvMainUnavailable=matInvMainUnavailable, matConfInvOutputFreq=matConfInvOutputFreq, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsMbsStatus=matStsMbsStatus, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsOutputFreq=matStsOutputFreq, matInvInputAbnormal=matInvInputAbnormal, matConCanBusOff=matConCanBusOff, matStsMainsFail=matStsMainsFail, matInvEEPROMFault=matInvEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matSts=matSts, matStsWarningState=matStsWarningState, matDryContactTable=matDryContactTable, matInvTemperature=matInvTemperature, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvInputVoltage=matConfInvInputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfig=matConfig, matStsModuleType=matStsModuleType, matInverter=matInverter, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsRunningMode=matStsRunningMode, matConEEPROMFault=matConEEPROMFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvSerialNum=matInvSerialNum, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsStatus=matStsStatus, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputFreq=matInvOutputFreq, matStsModuleNum=matStsModuleNum, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsEEPROMFault=matStsEEPROMFault, matInvRunTime=matInvRunTime, matStsMaintenanceBypass=matStsMaintenanceBypass, matAgent=matAgent, matConWarningState=matConWarningState, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, PositiveInteger=PositiveInteger, matDryContactString=matDryContactString, matDryContactNum=matDryContactNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvHardwareError=matInvHardwareError, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matObjects=matObjects, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsRuntime=matStsRuntime, matInvEPOShutdown=matInvEPOShutdown, matStsOutputAbnormal=matStsOutputAbnormal, matStsOverLoad=matStsOverLoad, matTrapTargetsDesc=matTrapTargetsDesc, matStsMBSPosFault=matStsMBSPosFault, matConSerialNum=matConSerialNum, matConName=matConName, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsInvFail=matStsInvFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvLineFreq=matInvLineFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvMBSPosError=matInvMBSPosError)
