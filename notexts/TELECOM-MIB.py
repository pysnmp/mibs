...
TimeTicks, iso, NotificationType, Gauge32, enterprises, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, Unsigned32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "NotificationType", "Gauge32", "enterprises", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConName=matConName, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsFirmwareVersion=matStsFirmwareVersion, matInvTemperature=matInvTemperature, matInvEEPROMFault=matInvEEPROMFault, matInvRunMode=matInvRunMode, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputShort=matInvOutputShort, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsOutputVoltage=matStsOutputVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matDryContactIndex=matDryContactIndex, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, ppc=ppc, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsOutputAbnormal=matStsOutputAbnormal, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsMainsFail=matStsMainsFail, matStsStatus=matStsStatus, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsFanFault=matStsFanFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvPulseFault=matInvPulseFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matAgent=matAgent, matInvTable=matInvTable, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMbsStatus=matStsMbsStatus, matStsModuleIndex=matStsModuleIndex, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsModuleType=matStsModuleType, matInvLineVoltage=matInvLineVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvFault=matInvFault, matStsInvFail=matStsInvFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsEntry=matStsEntry, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConWarningState=matConWarningState, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvHardwareError=matInvHardwareError, matTrapSeverityLevel=matTrapSeverityLevel, matInvNotRespond=matInvNotRespond, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsRuntime=matStsRuntime, matInvSoftStartFail=matInvSoftStartFail, matStsMBSPosFault=matStsMBSPosFault, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvInputVoltage=matConfInvInputVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargetsNum=matTrapTargetsNum, matStsOutputPower=matStsOutputPower, matTrapType=matTrapType, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvPowerLimit=matInvPowerLimit, matInvLineFreq=matInvLineFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvOutputPower=matConfInvOutputPower, matInvOutputVoltage=matInvOutputVoltage, matConCanBusOff=matConCanBusOff, matInvBatteryVoltage=matInvBatteryVoltage, matStsTemperature=matStsTemperature, matStsTable=matStsTable, matStsSerialNum=matStsSerialNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvPhaseType=matInvPhaseType, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsTemperatureHigh=matStsTemperatureHigh, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConBatteryLow=matConBatteryLow, matStsFaultMode=matStsFaultMode, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsWarningState=matStsWarningState, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matTrapTargets=matTrapTargets, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsNotRespond=matStsNotRespond, matConfig=matConfig, matObjects=matObjects, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsOverLoad=matStsOverLoad, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysPriority=matConfInvSysPriority, PositiveInteger=PositiveInteger, matInvOutputPower=matInvOutputPower, matInvOverLoad=matInvOverLoad, matSts=matSts, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvSerialNum=matInvSerialNum, matDryContact=matDryContact, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvRunTime=matInvRunTime, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvEntry=matInvEntry, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvFanFault=matInvFanFault, matDryContactTable=matDryContactTable, matStsMainInputFreq=matStsMainInputFreq, matConfStsPriority=matConfStsPriority, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInverter=matInverter, matStsOutputCurrent=matStsOutputCurrent, matInvEPOShutdown=matInvEPOShutdown, matDryContactEntry=matDryContactEntry, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, device=device, matInvInputAbnormal=matInvInputAbnormal, matInvMbsPosition=matInvMbsPosition, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvFault=matReturnFromInvFault, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsOutputFreq=matStsOutputFreq, matTraps=matTraps, matConTemperature=matConTemperature, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMBSPosError=matInvMBSPosError, matTrapTargetsAddress=matTrapTargetsAddress, matDryContactNum=matDryContactNum, matDryContactString=matDryContactString, matInvBusSoftFail=matInvBusSoftFail, matConTemperatureHigh=matConTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matInvModuleIndex=matInvModuleIndex, matStsHardwareVersion=matStsHardwareVersion, matStsRunningMode=matStsRunningMode, matController=matController, matInvMainUnavailable=matInvMainUnavailable, matInvWarningState=matInvWarningState, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputFreq=matInvOutputFreq, matConEEPROMFault=matConEEPROMFault, matInvPriority=matInvPriority, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, NonNegativeInteger=NonNegativeInteger, matTrapTargetsCommunity=matTrapTargetsCommunity, matConSerialNum=matConSerialNum, matStsModuleNum=matStsModuleNum)
