...
mibBuilder.exportSymbols("TELECOM-MIB", matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvLineFreq=matInvLineFreq, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsOutputFreq=matStsOutputFreq, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConBatteryLow=matConBatteryLow, matInvMBSPosError=matInvMBSPosError, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvSerialNum=matInvSerialNum, matInvEPOShutdown=matInvEPOShutdown, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConEEPROMFault=matConEEPROMFault, matConName=matConName, matStsControlPowerFail=matStsControlPowerFail, matStsTable=matStsTable, matInvTempPowerLimit=matInvTempPowerLimit, matStsFanFault=matStsFanFault, matInvPhaseType=matInvPhaseType, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvFault=matReturnFromInvFault, matStsWarningState=matStsWarningState, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConSerialNum=matConSerialNum, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConWarningState=matConWarningState, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvOnOffStatus=matInvOnOffStatus, matDryContactString=matDryContactString, matInvRunTime=matInvRunTime, matStsTemperature=matStsTemperature, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsBypassUnavailable=matStsBypassUnavailable, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvRunMode=matInvRunMode, matStsModuleType=matStsModuleType, matStsOutputVoltage=matStsOutputVoltage, matInvEEPROMFault=matInvEEPROMFault, matInvPriority=matInvPriority, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvMainUnavailable=matInvMainUnavailable, matStsMbsStatus=matStsMbsStatus, matStsEEPROMFault=matStsEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matTrapTargetsAddress=matTrapTargetsAddress, matInvNotRespond=matInvNotRespond, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvModuleNum=matInvModuleNum, matAgent=matAgent, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapTargetsEntry=matTrapTargetsEntry, matStsHardwareVersion=matStsHardwareVersion, matReturnFromConCanBusOff=matReturnFromConCanBusOff, device=device, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOverLoad=matInvOverLoad, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsRunningMode=matStsRunningMode, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvWarningState=matInvWarningState, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsFanFault=matReturnFromStsFanFault, matConCommunicationLost=matConCommunicationLost, matInvEntry=matInvEntry, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputShort=matInvOutputShort, matConfig=matConfig, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvMbsPosition=matInvMbsPosition, matDryContactNum=matDryContactNum, ppc=ppc, matConfInvOutputPower=matConfInvOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConTemperature=matConTemperature, matReturnFromInvFanFault=matReturnFromInvFanFault, matDryContact=matDryContact, matStsInvBypassMode=matStsInvBypassMode, matInvFanFault=matInvFanFault, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContactIndex=matDryContactIndex, matStsInvFail=matStsInvFail, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsMainsFail=matStsMainsFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsNotRespond=matStsNotRespond, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactEntry=matDryContactEntry, matInvTable=matInvTable, matInvFault=matInvFault, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInverter=matInverter, matStsOutputPower=matStsOutputPower, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTraps=matTraps, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvTemperature=matInvTemperature, matConCanBusOff=matConCanBusOff, matStsRuntime=matStsRuntime, matInvOutputFreq=matInvOutputFreq, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matTrapType=matTrapType, NonNegativeInteger=NonNegativeInteger, matInvPulseFault=matInvPulseFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matAgentSoftwareVerison=matAgentSoftwareVerison, matDryContactTable=matDryContactTable, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsFirmwareVersion=matStsFirmwareVersion, matInvOutputCurrent=matInvOutputCurrent, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matObjects=matObjects, matStsOverLoad=matStsOverLoad, matConTemperatureHigh=matConTemperatureHigh, matSts=matSts, matStsInvInputVoltage=matStsInvInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvOutputVoltage=matConfInvOutputVoltage, matTrapTargetsNum=matTrapTargetsNum, matController=matController, matStsModuleNum=matStsModuleNum, matInvModuleIndex=matInvModuleIndex, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvHardwareError=matInvHardwareError, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargets=matTrapTargets, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsSerialNum=matStsSerialNum, matConfStsFanSpeed=matConfStsFanSpeed, matConfStsPriority=matConfStsPriority, matStsModuleIndex=matStsModuleIndex, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsStatus=matStsStatus, matStsInvInputFreq=matStsInvInputFreq, matStsFaultMode=matStsFaultMode, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMBSPosFault=matStsMBSPosFault, matInvPowerLimit=matInvPowerLimit, matInvLineVoltage=matInvLineVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvOutputPower=matInvOutputPower, matStsEntry=matStsEntry, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvTemperatureHigh=matInvTemperatureHigh, PositiveInteger=PositiveInteger, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit)
