...
MibIdentifier, NotificationType, Gauge32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, iso, enterprises, ModuleIdentity, Integer32, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Gauge32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "iso", "enterprises", "ModuleIdentity", "Integer32", "Bits", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matDryContactIndex=matDryContactIndex, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvPowerLimit=matInvPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContactTable=matDryContactTable, matInvBatteryVoltage=matInvBatteryVoltage, matStsRunningMode=matStsRunningMode, matInvRunMode=matInvRunMode, matInvLowInputShutdown=matInvLowInputShutdown, matStsInvBypassMode=matStsInvBypassMode, matInvPhaseType=matInvPhaseType, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsModuleType=matStsModuleType, matStsOverLoad=matStsOverLoad, NonNegativeInteger=NonNegativeInteger, matInvEntry=matInvEntry, matObjects=matObjects, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvTemperatureHigh=matInvTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matInvOutputVoltLow=matInvOutputVoltLow, matInvTable=matInvTable, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapType=matTrapType, matStsModuleNum=matStsModuleNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvNotRespond=matInvNotRespond, matInvFault=matInvFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvInputAbnormal=matInvInputAbnormal, matStsInvFail=matStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matInverter=matInverter, matConSerialNum=matConSerialNum, matTrapTargetsCommunity=matTrapTargetsCommunity, matConCommunicationLost=matConCommunicationLost, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvSoftStartFail=matInvSoftStartFail, matInvLineVoltage=matInvLineVoltage, matStsNotRespond=matStsNotRespond, matConCanBusOff=matConCanBusOff, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matTrapTargetsIndex=matTrapTargetsIndex, matSts=matSts, matTrapSeverityLevel=matTrapSeverityLevel, matConfStsPriority=matConfStsPriority, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvOutputFreq=matInvOutputFreq, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvOutputFreq=matConfInvOutputFreq, matDryContactNum=matDryContactNum, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsOutputFreq=matStsOutputFreq, matInvModuleIndex=matInvModuleIndex, matStsMBSPosFault=matStsMBSPosFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfig=matConfig, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matAgent=matAgent, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvMBSPosError=matInvMBSPosError, matInvOverLoad=matInvOverLoad, matInvOutputPower=matInvOutputPower, matInvModuleNum=matInvModuleNum, matDryContact=matDryContact, matStsTable=matStsTable, matStsModuleIndex=matStsModuleIndex, matController=matController, matTraps=matTraps, matInvPulseFault=matInvPulseFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matTrapTargetsTable=matTrapTargetsTable, matConTemperature=matConTemperature, matInvMainUnavailable=matInvMainUnavailable, matConWarningState=matConWarningState, matInvRunTime=matInvRunTime, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvInputVoltage=matConfInvInputVoltage, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysPriority=matConfInvSysPriority, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsMainInputFreq=matStsMainInputFreq, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvHardwareVersion=matInvHardwareVersion, matInvBusSoftFail=matInvBusSoftFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsTemperature=matStsTemperature, matStsTemperatureHigh=matStsTemperatureHigh, matInvOutputShort=matInvOutputShort, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsOutputPower=matStsOutputPower, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvOutputPower=matConfInvOutputPower, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvWarningState=matInvWarningState, matInvMbsPosition=matInvMbsPosition, matInvFanFault=matInvFanFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, PositiveInteger=PositiveInteger, matStsInvInputVoltage=matStsInvInputVoltage, matTrapTargetsNum=matTrapTargetsNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsStatus=matStsStatus, matStsSerialNum=matStsSerialNum, matStsFaultMode=matStsFaultMode, matStsWarningState=matStsWarningState, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvSerialNum=matInvSerialNum, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargets=matTrapTargets, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConTemperatureHigh=matConTemperatureHigh, matStsOutputCurrent=matStsOutputCurrent, matStsMainsFail=matStsMainsFail, device=device, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsInvInputFreq=matStsInvInputFreq, matStsEntry=matStsEntry, matStsMainInputVoltage=matStsMainInputVoltage, matDryContactString=matDryContactString, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvHardwareError=matInvHardwareError, matInvTemperature=matInvTemperature, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsMbsStatus=matStsMbsStatus, matDryContactEntry=matDryContactEntry, matStsMaintenanceBypass=matStsMaintenanceBypass, matConEEPROMFault=matConEEPROMFault, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConBatteryLow=matConBatteryLow, matStsRuntime=matStsRuntime, matInvLineFreq=matInvLineFreq, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfStsFanSpeed=matConfStsFanSpeed, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, ppc=ppc, matConName=matConName, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsFanFault=matStsFanFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvPriority=matInvPriority)
