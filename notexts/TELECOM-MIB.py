...
mibBuilder.exportSymbols("TELECOM-MIB", matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, device=device, matInvRunMode=matInvRunMode, matInvRunTime=matInvRunTime, matInvOverLoad=matInvOverLoad, matInvLineFreq=matInvLineFreq, matInvOutputShort=matInvOutputShort, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvMBSPosError=matInvMBSPosError, matTrapTargetsNum=matTrapTargetsNum, matInvPowerLimit=matInvPowerLimit, matStsMBSPosFault=matStsMBSPosFault, matStsStatus=matStsStatus, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfStsFanSpeed=matConfStsFanSpeed, matInvHardwareError=matInvHardwareError, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matDryContact=matDryContact, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsModuleNum=matStsModuleNum, matStsOutputFreq=matStsOutputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvWarningState=matInvWarningState, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsInvFail=matReturnFromStsInvFail, matConEEPROMFault=matConEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsNotRespond=matStsNotRespond, matStsFaultMode=matStsFaultMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvEntry=matInvEntry, matInvOutputVoltLow=matInvOutputVoltLow, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matSts=matSts, matStsTemperatureHigh=matStsTemperatureHigh, matStsTable=matStsTable, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfStsPriority=matConfStsPriority, ppc=ppc, matConSerialNum=matConSerialNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsFanFault=matReturnFromStsFanFault, matObjects=matObjects, matStsModuleIndex=matStsModuleIndex, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsWarningState=matStsWarningState, PositiveInteger=PositiveInteger, matInvFanFault=matInvFanFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvFault=matReturnFromInvFault, matTrapType=matTrapType, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvTemperature=matInvTemperature, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsOutputPower=matStsOutputPower, matConfig=matConfig, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsInvBypassMode=matStsInvBypassMode, matController=matController, matInvTemperatureHigh=matInvTemperatureHigh, matInvBypassSCRShort=matInvBypassSCRShort, matStsInvInputFreq=matStsInvInputFreq, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvFirmwareVersion=matInvFirmwareVersion, matInverter=matInverter, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvNotRespond=matInvNotRespond, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvEPOShutdown=matInvEPOShutdown, matStsHardwareVersion=matStsHardwareVersion, matStsTemperature=matStsTemperature, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matDryContactTable=matDryContactTable, matConWarningState=matConWarningState, matStsBypassUnavailable=matStsBypassUnavailable, matInvMbsPosition=matInvMbsPosition, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvFanFault=matReturnFromInvFanFault, matTraps=matTraps, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsFanFault=matStsFanFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsSerialNum=matStsSerialNum, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsFirmwareVersion=matStsFirmwareVersion, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsRuntime=matStsRuntime, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConName=matConName, matDryContactIndex=matDryContactIndex, matStsEntry=matStsEntry, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvEEPROMFault=matInvEEPROMFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConTemperature=matConTemperature, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargets=matTrapTargets, matConfInvOutputPower=matConfInvOutputPower, matStsMainInputFreq=matStsMainInputFreq, matInvModuleNum=matInvModuleNum, matConCanBusOff=matConCanBusOff, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, NonNegativeInteger=NonNegativeInteger, matInvSerialNum=matInvSerialNum, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matDryContactString=matDryContactString, matTrapTargetsAddress=matTrapTargetsAddress, matInvModuleIndex=matInvModuleIndex, matInvTable=matInvTable, matStsMainInputVoltage=matStsMainInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvOutputPower=matInvOutputPower, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsRunningMode=matStsRunningMode, matDryContactNum=matDryContactNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvMainUnavailable=matInvMainUnavailable, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMbsStatus=matStsMbsStatus, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matDryContactEntry=matDryContactEntry, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConBatteryLow=matConBatteryLow, matInvSoftStartFail=matInvSoftStartFail, matInvPriority=matInvPriority, matStsEEPROMFault=matStsEEPROMFault, matInvTempPowerLimit=matInvTempPowerLimit, matInvOutputCurrent=matInvOutputCurrent, matStsMainsFail=matStsMainsFail, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargetsTable=matTrapTargetsTable, matInvPulseFault=matInvPulseFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matAgent=matAgent, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsOutputAbnormal=matStsOutputAbnormal, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsModuleType=matStsModuleType, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsInvFail=matStsInvFail, matConCommunicationLost=matConCommunicationLost, matStsInvInputVoltage=matStsInvInputVoltage, matStsOutputVoltage=matStsOutputVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matConTemperatureHigh=matConTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOverLoad=matStsOverLoad, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputFreq=matInvOutputFreq, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matTrapTargetsDesc=matTrapTargetsDesc, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPhaseType=matInvPhaseType, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvFault=matInvFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvLineVoltage=matInvLineVoltage)
