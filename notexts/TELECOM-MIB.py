...
enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, IpAddress, ModuleIdentity, TimeTicks, Counter32, iso, NotificationType, Gauge32, Unsigned32, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter32", "iso", "NotificationType", "Gauge32", "Unsigned32", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, device=device, matStsTable=matStsTable, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConEEPROMFault=matConEEPROMFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConSerialNum=matConSerialNum, matTraps=matTraps, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsFirmwareVersion=matStsFirmwareVersion, matStsMainInputVoltage=matStsMainInputVoltage, matInvTemperature=matInvTemperature, matStsOutputPower=matStsOutputPower, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsPriority=matConfStsPriority, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConCommunicationLost=matConCommunicationLost, matInvOutputFreq=matInvOutputFreq, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfig=matConfig, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matSts=matSts, matInvModuleIndex=matInvModuleIndex, matStsInvInputFreq=matStsInvInputFreq, matInvOverLoad=matInvOverLoad, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvEntry=matInvEntry, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsHardwareVersion=matStsHardwareVersion, matStsMainsFail=matStsMainsFail, matConBatteryLow=matConBatteryLow, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvInputVoltage=matConfInvInputVoltage, matStsEntry=matStsEntry, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvNotRespond=matInvNotRespond, matTrapTargets=matTrapTargets, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConName=matConName, matInvPriority=matInvPriority, matStsMbsStatus=matStsMbsStatus, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputPower=matInvOutputPower, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsInvBypassMode=matStsInvBypassMode, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputVoltage=matInvOutputVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvTable=matInvTable, matInvMBSPosError=matInvMBSPosError, matInvPhaseType=matInvPhaseType, matInvSoftStartFail=matInvSoftStartFail, matInvHardwareError=matInvHardwareError, matDryContactNum=matDryContactNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsModuleType=matStsModuleType, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInverter=matInverter, matTrapTargetsIndex=matTrapTargetsIndex, matStsFanFault=matStsFanFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsNotRespond=matStsNotRespond, NonNegativeInteger=NonNegativeInteger, matInvRunTime=matInvRunTime, matConTemperature=matConTemperature, matConfInvOutputVoltage=matConfInvOutputVoltage, matAgent=matAgent, matStsOverLoad=matStsOverLoad, matStsStatus=matStsStatus, matInvSerialNum=matInvSerialNum, matStsFaultMode=matStsFaultMode, matStsMainInputFreq=matStsMainInputFreq, matStsRunningMode=matStsRunningMode, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matController=matController, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvModuleNum=matInvModuleNum, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvHardwareVersion=matInvHardwareVersion, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvSysPriority=matConfInvSysPriority, matStsControlPowerFail=matStsControlPowerFail, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvPowerLimit=matInvPowerLimit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvFanFault=matInvFanFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvOutputVoltLow=matInvOutputVoltLow, matConWarningState=matConWarningState, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matObjects=matObjects, matStsOutputFreq=matStsOutputFreq, PositiveInteger=PositiveInteger, matInvBusSoftFail=matInvBusSoftFail, matStsMBSPosFault=matStsMBSPosFault, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, ppc=ppc, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matTrapTargetsAddress=matTrapTargetsAddress, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvFault=matInvFault, matConCanBusOff=matConCanBusOff, matStsWarningState=matStsWarningState, matStsInvInputVoltage=matStsInvInputVoltage, matInvLineVoltage=matInvLineVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvMbsPosition=matInvMbsPosition, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvEPOShutdown=matInvEPOShutdown, matStsRuntime=matStsRuntime, matInvWarningState=matInvWarningState, matStsTemperature=matStsTemperature, matInvTemperatureHigh=matInvTemperatureHigh, matInvBypassSCRShort=matInvBypassSCRShort, matInvOutputShort=matInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matStsOutputAbnormal=matStsOutputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, matDryContact=matDryContact, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvOutputPower=matConfInvOutputPower, matInvOnOffStatus=matInvOnOffStatus, matDryContactTable=matDryContactTable, matStsInvFail=matStsInvFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matDryContactIndex=matDryContactIndex, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvRunMode=matInvRunMode, matStsOutputCurrent=matStsOutputCurrent, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsSerialNum=matStsSerialNum, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvPulseFault=matInvPulseFault, matStsModuleNum=matStsModuleNum, matStsModuleIndex=matStsModuleIndex, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matTrapType=matTrapType, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matDryContactString=matDryContactString, matDryContactEntry=matDryContactEntry, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvEEPROMFault=matInvEEPROMFault, matConTemperatureHigh=matConTemperatureHigh, matInvLineFreq=matInvLineFreq, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode)
