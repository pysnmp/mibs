...
mibBuilder.exportSymbols("TELECOM-MIB", ppc=ppc, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvPowerLimit=matInvPowerLimit, matInvOverLoad=matInvOverLoad, matInvMbsPosition=matInvMbsPosition, matInvPhaseType=matInvPhaseType, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvBusSoftFail=matInvBusSoftFail, matStsOutputVoltage=matStsOutputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvModuleIndex=matInvModuleIndex, matStsMainsFail=matStsMainsFail, matController=matController, matConTemperature=matConTemperature, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConCanBusOff=matConCanBusOff, matStsModuleType=matStsModuleType, matInvMBSPosError=matInvMBSPosError, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsModuleIndex=matStsModuleIndex, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsEntry=matStsEntry, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matTrapType=matTrapType, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsControlPowerFail=matStsControlPowerFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvOutputVoltage=matInvOutputVoltage, device=device, matConfInvSysPriority=matConfInvSysPriority, matInvRunTime=matInvRunTime, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, PositiveInteger=PositiveInteger, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvFirmwareVersion=matInvFirmwareVersion, matInvEntry=matInvEntry, matConSerialNum=matConSerialNum, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapTargetsAddress=matTrapTargetsAddress, matInvPulseFault=matInvPulseFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvModuleNum=matInvModuleNum, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvRunMode=matInvRunMode, matStsStatus=matStsStatus, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvFanFault=matInvFanFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConBatteryLow=matConBatteryLow, matStsOverLoad=matStsOverLoad, matTrapTargetsNum=matTrapTargetsNum, matInvTable=matInvTable, matTrapTargetsDesc=matTrapTargetsDesc, matDryContactNum=matDryContactNum, matConEEPROMFault=matConEEPROMFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvLineFreq=matInvLineFreq, matAgent=matAgent, matReturnFromInvFault=matReturnFromInvFault, NonNegativeInteger=NonNegativeInteger, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsInvFail=matStsInvFail, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvMainUnavailable=matInvMainUnavailable, matConfig=matConfig, matInvEPOShutdown=matInvEPOShutdown, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matStsModuleNum=matStsModuleNum, matInvOutputShort=matInvOutputShort, matInvBypassSCRShort=matInvBypassSCRShort, matInvHardwareError=matInvHardwareError, matStsFaultMode=matStsFaultMode, matDryContact=matDryContact, matTraps=matTraps, matInvFault=matInvFault, matInvBatteryVoltage=matInvBatteryVoltage, matStsTemperature=matStsTemperature, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsMainInputFreq=matStsMainInputFreq, matInvTempPowerLimit=matInvTempPowerLimit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapTargetsEntry=matTrapTargetsEntry, matStsWarningState=matStsWarningState, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputFreq=matConfInvOutputFreq, matStsTemperatureHigh=matStsTemperatureHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsNotRespond=matStsNotRespond, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsTable=matStsTable, matDryContactString=matDryContactString, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsSerialNum=matStsSerialNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvPriority=matInvPriority, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvOutputVoltage=matConfInvOutputVoltage, matDryContactIndex=matDryContactIndex, matStsInvBypassMode=matStsInvBypassMode, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvInputVoltage=matStsInvInputVoltage, matConCommunicationLost=matConCommunicationLost, matInvOutputPower=matInvOutputPower, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvMaintenaceBypass=matInvMaintenaceBypass, matConName=matConName, matSts=matSts, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvLineVoltage=matInvLineVoltage, matStsRunningMode=matStsRunningMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsFanFault=matStsFanFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvNotRespond=matInvNotRespond, matInvSerialNum=matInvSerialNum, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainInputVoltage=matStsMainInputVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matObjects=matObjects, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInverter=matInverter, matTrapTargetsIndex=matTrapTargetsIndex, matInvTemperature=matInvTemperature, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputFreq=matInvOutputFreq, matConTemperatureHigh=matConTemperatureHigh, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsOutputFreq=matStsOutputFreq, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matDryContactTable=matDryContactTable, matStsOutputCurrent=matStsOutputCurrent, matDryContactEntry=matDryContactEntry, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsEEPROMFault=matStsEEPROMFault, matConWarningState=matConWarningState, matConfStsPriority=matConfStsPriority, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvWarningState=matInvWarningState, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMbsStatus=matStsMbsStatus, matInvSoftStartFail=matInvSoftStartFail, matStsOutputPower=matStsOutputPower, matTrapTargets=matTrapTargets, matStsRuntime=matStsRuntime, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOutputCurrent=matInvOutputCurrent, matInvInputAbnormal=matInvInputAbnormal)
