...
mibBuilder.exportSymbols("TELECOM-MIB", matDryContactNum=matDryContactNum, matStsSerialNum=matStsSerialNum, matTrapType=matTrapType, matTrapTargets=matTrapTargets, matInvEntry=matInvEntry, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsMBSPosFault=matStsMBSPosFault, matInvEEPROMFault=matInvEEPROMFault, matSts=matSts, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvSoftStartFail=matInvSoftStartFail, matStsEntry=matStsEntry, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvMbsPosition=matInvMbsPosition, matAgent=matAgent, matStsModuleType=matStsModuleType, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsTemperature=matStsTemperature, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvFault=matReturnFromInvFault, matTrapTargetsAddress=matTrapTargetsAddress, matInvOutputVoltLow=matInvOutputVoltLow, matConTemperatureHigh=matConTemperatureHigh, matInvRunMode=matInvRunMode, matInvMBSPosError=matInvMBSPosError, matConfStsFanSpeed=matConfStsFanSpeed, ppc=ppc, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsNotRespond=matStsNotRespond, matDryContactEntry=matDryContactEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvOutputFreq=matConfInvOutputFreq, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvOutputShort=matInvOutputShort, matInvFault=matInvFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsFanFault=matStsFanFault, matStsInvFail=matStsInvFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapTargetsNum=matTrapTargetsNum, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matController=matController, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvHardwareError=matInvHardwareError, matConfInvSysInputVolt=matConfInvSysInputVolt, matTraps=matTraps, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvBatteryVoltage=matInvBatteryVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMbsStatus=matStsMbsStatus, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matTrapTargetsEntry=matTrapTargetsEntry, matInvLineFreq=matInvLineFreq, matInvSerialNum=matInvSerialNum, matInvNotRespond=matInvNotRespond, matConfInvOutputPower=matConfInvOutputPower, matInvTemperature=matInvTemperature, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvTable=matInvTable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvPhaseType=matInvPhaseType, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputAbnormal=matStsOutputAbnormal, matConName=matConName, NonNegativeInteger=NonNegativeInteger, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInverter=matInverter, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, device=device, matInvOnOffStatus=matInvOnOffStatus, matStsOutputFreq=matStsOutputFreq, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvInputVoltage=matConfInvInputVoltage, matConfInvSysPriority=matConfInvSysPriority, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvModuleIndex=matInvModuleIndex, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvOutputPower=matInvOutputPower, matStsModuleNum=matStsModuleNum, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConCanBusOff=matConCanBusOff, matStsStatus=matStsStatus, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvTemperatureHigh=matInvTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsWarningState=matStsWarningState, matStsFaultMode=matStsFaultMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsOutputVoltage=matStsOutputVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvPowerLimit=matInvPowerLimit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvLineVoltage=matInvLineVoltage, matInvWarningState=matInvWarningState, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConEEPROMFault=matConEEPROMFault, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvHardwareVersion=matInvHardwareVersion, matTrapTargetsTable=matTrapTargetsTable, matStsRuntime=matStsRuntime, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvMainUnavailable=matInvMainUnavailable, matInvRunTime=matInvRunTime, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfStsPriority=matConfStsPriority, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsControlPowerFail=matStsControlPowerFail, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConTemperature=matConTemperature, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsOutputShortCircuit=matStsOutputShortCircuit, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMainInputFreq=matStsMainInputFreq, matInvOutputCurrent=matInvOutputCurrent, matInvOutputFreq=matInvOutputFreq, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvOutputVoltage=matInvOutputVoltage, matDryContact=matDryContact, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsHardwareVersion=matStsHardwareVersion, matConfig=matConfig, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvInputVoltage=matStsInvInputVoltage, matConBatteryLow=matConBatteryLow, matStsOutputPower=matStsOutputPower, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matObjects=matObjects, matDryContactIndex=matDryContactIndex, matInvPriority=matInvPriority, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsRunningMode=matStsRunningMode, matConWarningState=matConWarningState, matStsModuleIndex=matStsModuleIndex, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMainsFail=matStsMainsFail, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOverLoad=matInvOverLoad, matConSerialNum=matConSerialNum, matDryContactTable=matDryContactTable, matStsOverLoad=matStsOverLoad, matInvPulseFault=matInvPulseFault, matStsTemperatureHigh=matStsTemperatureHigh, matConCommunicationLost=matConCommunicationLost, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsTable=matStsTable, matDryContactString=matDryContactString, matInvFanFault=matInvFanFault, matInvBusSoftFail=matInvBusSoftFail, PositiveInteger=PositiveInteger, matStsMainInputVoltage=matStsMainInputVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss)
