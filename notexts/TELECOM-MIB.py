...
Gauge32, Unsigned32, iso, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Bits, Integer32, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "iso", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Bits", "Integer32", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvOverLoad=matInvOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsMaintenanceBypass=matStsMaintenanceBypass, matInverter=matInverter, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matAgent=matAgent, matDryContactNum=matDryContactNum, matInvPhaseType=matInvPhaseType, matInvOutputVoltHigh=matInvOutputVoltHigh, matDryContactString=matDryContactString, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvHardwareVersion=matInvHardwareVersion, matInvLineFreq=matInvLineFreq, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsInvInputVoltage=matStsInvInputVoltage, matStsEEPROMFault=matStsEEPROMFault, matTrapTargetsTable=matTrapTargetsTable, device=device, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsFaultMode=matStsFaultMode, matInvNotRespond=matInvNotRespond, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matConTemperature=matConTemperature, matInvFault=matInvFault, matStsModuleNum=matStsModuleNum, matInvEntry=matInvEntry, matConName=matConName, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvBatteryVoltage=matInvBatteryVoltage, matStsOutputCurrent=matStsOutputCurrent, matStsTemperature=matStsTemperature, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvBusSoftFail=matInvBusSoftFail, matStsMainInputFreq=matStsMainInputFreq, matSts=matSts, matInvPriority=matInvPriority, matReturnFromStsMainFail=matReturnFromStsMainFail, matDryContactIndex=matDryContactIndex, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConTemperatureHigh=matConTemperatureHigh, matConCanBusOff=matConCanBusOff, matInvMBSPosError=matInvMBSPosError, matStsSerialNum=matStsSerialNum, matStsNotRespond=matStsNotRespond, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsHardwareVersion=matStsHardwareVersion, matStsRuntime=matStsRuntime, matStsTemperatureHigh=matStsTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matInvSerialNum=matInvSerialNum, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContactTable=matDryContactTable, matStsMBSPosFault=matStsMBSPosFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsInvBypassMode=matStsInvBypassMode, matTrapType=matTrapType, matInvOutputCurrent=matInvOutputCurrent, matStsOutputAbnormal=matStsOutputAbnormal, matStsModuleType=matStsModuleType, matController=matController, matInvHardwareError=matInvHardwareError, matInvRunTime=matInvRunTime, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvPulseFault=matInvPulseFault, matStsFirmwareVersion=matStsFirmwareVersion, matTrapTargets=matTrapTargets, matConfig=matConfig, matStsTable=matStsTable, matStsOutputFreq=matStsOutputFreq, matConfInvSysPriority=matConfInvSysPriority, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsWarningState=matStsWarningState, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputFreq=matInvOutputFreq, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvRunMode=matInvRunMode, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsMainInputVoltage=matStsMainInputVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matDryContact=matDryContact, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, PositiveInteger=PositiveInteger, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapTargetsEntry=matTrapTargetsEntry, matInvSoftStartFail=matInvSoftStartFail, matInvLineVoltage=matInvLineVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvTempPowerLimit=matInvTempPowerLimit, matStsMbsStatus=matStsMbsStatus, matStsInvFail=matStsInvFail, matStsRunningMode=matStsRunningMode, matInvEPOShutdown=matInvEPOShutdown, matStsOverLoad=matStsOverLoad, matReturnFromInvFault=matReturnFromInvFault, matConfStsPriority=matConfStsPriority, matTrapTargetsDesc=matTrapTargetsDesc, matStsControlPowerFail=matStsControlPowerFail, matConfStsFanSpeed=matConfStsFanSpeed, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matConWarningState=matConWarningState, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsInvInputFreq=matStsInvInputFreq, matStsMainsFail=matStsMainsFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsModuleIndex=matStsModuleIndex, matInvFanFault=matInvFanFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matTraps=matTraps, matInvBypassSCRShort=matInvBypassSCRShort, ppc=ppc, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvMbsPosition=matInvMbsPosition, NonNegativeInteger=NonNegativeInteger, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvModuleNum=matInvModuleNum, matInvOutputPower=matInvOutputPower, matInvTemperature=matInvTemperature, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsOutputPower=matStsOutputPower, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsStatus=matStsStatus, matInvPowerLimit=matInvPowerLimit, matConfInvOutputPower=matConfInvOutputPower, matInvOutputVoltage=matInvOutputVoltage, matConSerialNum=matConSerialNum, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsEntry=matStsEntry, matStsOutputShortCircuit=matStsOutputShortCircuit, matConEEPROMFault=matConEEPROMFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvMainUnavailable=matInvMainUnavailable, matObjects=matObjects, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvModuleIndex=matInvModuleIndex, matInvWarningState=matInvWarningState, matStsFanFault=matStsFanFault, matStsOutputVoltage=matStsOutputVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConBatteryLow=matConBatteryLow, matInvFirmwareVersion=matInvFirmwareVersion, matInvOutputShort=matInvOutputShort, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvLowInputShutdown=matInvLowInputShutdown, matInvTable=matInvTable, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContactEntry=matDryContactEntry)
