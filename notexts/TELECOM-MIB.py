...
Gauge32, Bits, ModuleIdentity, NotificationType, Counter32, TimeTicks, ObjectIdentity, Unsigned32, iso, enterprises, IpAddress, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "ModuleIdentity", "NotificationType", "Counter32", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "IpAddress", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsFaultMode=matStsFaultMode, matStsTemperature=matStsTemperature, matDryContactIndex=matDryContactIndex, matInvNotRespond=matInvNotRespond, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvOutputShort=matInvOutputShort, matStsTable=matStsTable, NonNegativeInteger=NonNegativeInteger, matInvOverLoad=matInvOverLoad, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsModuleIndex=matStsModuleIndex, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvLineVoltage=matInvLineVoltage, matConWarningState=matConWarningState, matStsMainInputVoltage=matStsMainInputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matStsEEPROMFault=matStsEEPROMFault, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsHardwareVersion=matStsHardwareVersion, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargetsCommunity=matTrapTargetsCommunity, matTrapType=matTrapType, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, ppc=ppc, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTrapTargetsEntry=matTrapTargetsEntry, matStsMBSPosFault=matStsMBSPosFault, matStsNotRespond=matStsNotRespond, matInvOutputCurrent=matInvOutputCurrent, matInvHardwareError=matInvHardwareError, matInvMainUnavailable=matInvMainUnavailable, matStsOutputFreq=matStsOutputFreq, matInvSerialNum=matInvSerialNum, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsInvFail=matStsInvFail, matConfInvOutputFreq=matConfInvOutputFreq, matConEEPROMFault=matConEEPROMFault, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matObjects=matObjects, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvOutputPower=matConfInvOutputPower, matInvPriority=matInvPriority, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matController=matController, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargetsNum=matTrapTargetsNum, matInvMBSPosError=matInvMBSPosError, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvMbsPosition=matInvMbsPosition, matInvFault=matInvFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matDryContactString=matDryContactString, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvPulseFault=matInvPulseFault, matConfStsFanSpeed=matConfStsFanSpeed, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsEntry=matStsEntry, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysPriority=matConfInvSysPriority, matSts=matSts, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConCanBusOff=matConCanBusOff, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvFanFault=matInvFanFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, device=device, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsAddress=matTrapTargetsAddress, matDryContactEntry=matDryContactEntry, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsBypassUnavailable=matStsBypassUnavailable, matInvLineFreq=matInvLineFreq, matConBatteryVoltHigh=matConBatteryVoltHigh, matAgent=matAgent, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvRunMode=matInvRunMode, matInvEEPROMFault=matInvEEPROMFault, matInvTable=matInvTable, matStsStatus=matStsStatus, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConName=matConName, PositiveInteger=PositiveInteger, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsWarningState=matStsWarningState, matStsMbsStatus=matStsMbsStatus, matDryContact=matDryContact, matTrapTargetsDesc=matTrapTargetsDesc, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConSerialNum=matConSerialNum, matInvLowInputShutdown=matInvLowInputShutdown, matConfStsPriority=matConfStsPriority, matStsModuleType=matStsModuleType, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matTraps=matTraps, matInverter=matInverter, matConfig=matConfig, matConTemperature=matConTemperature, matStsOverLoad=matStsOverLoad, matInvSoftStartFail=matInvSoftStartFail, matInvEntry=matInvEntry, matInvOutputVoltage=matInvOutputVoltage, matInvInputAbnormal=matInvInputAbnormal, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConTemperatureHigh=matConTemperatureHigh, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvModuleIndex=matInvModuleIndex, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsOutputAbnormal=matStsOutputAbnormal, matStsInvBypassMode=matStsInvBypassMode, matInvEPOShutdown=matInvEPOShutdown, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsOutputVoltage=matStsOutputVoltage, matTrapTargets=matTrapTargets, matStsSerialNum=matStsSerialNum, matInvWarningState=matInvWarningState, matStsRuntime=matStsRuntime, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBypassSCRShort=matInvBypassSCRShort, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPowerLimit=matInvPowerLimit, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsRunningMode=matStsRunningMode, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvFault=matReturnFromInvFault, matInvTemperature=matInvTemperature, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputPower=matStsOutputPower, matDryContactNum=matDryContactNum, matStsFanFault=matStsFanFault, matStsTemperatureHigh=matStsTemperatureHigh, matInvModuleNum=matInvModuleNum, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvPhaseType=matInvPhaseType, matInvRunTime=matInvRunTime, matStsModuleNum=matStsModuleNum, matInvOutputFreq=matInvOutputFreq, matConBatteryLow=matConBatteryLow, matInvOutputPower=matInvOutputPower, matDryContactTable=matDryContactTable, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsInvInputVoltage=matStsInvInputVoltage, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvFirmwareVersion=matInvFirmwareVersion, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainsFail=matStsMainsFail, matConCommunicationLost=matConCommunicationLost, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvTempPowerLimit=matInvTempPowerLimit)
