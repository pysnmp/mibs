...
mibBuilder.exportSymbols("TELECOM-MIB", matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matDryContactTable=matDryContactTable, matStsOverLoad=matStsOverLoad, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsModuleNum=matStsModuleNum, matReturnFromInvFault=matReturnFromInvFault, matInvOutputPower=matInvOutputPower, matTraps=matTraps, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvFirmwareVersion=matInvFirmwareVersion, matDryContactIndex=matDryContactIndex, matStsWarningState=matStsWarningState, NonNegativeInteger=NonNegativeInteger, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBypassSCRShort=matInvBypassSCRShort, matDryContact=matDryContact, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvMbsPosition=matInvMbsPosition, matInvPriority=matInvPriority, matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConBatteryLow=matConBatteryLow, matInvMBSPosError=matInvMBSPosError, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsTemperatureHigh=matStsTemperatureHigh, matInvSerialNum=matInvSerialNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMainInputVoltage=matStsMainInputVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfig=matConfig, matInvFanFault=matInvFanFault, matController=matController, matTrapTargets=matTrapTargets, matConfInvSysPriority=matConfInvSysPriority, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matDryContactString=matDryContactString, matInvWarningState=matInvWarningState, matInvMainUnavailable=matInvMainUnavailable, matInvLineFreq=matInvLineFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvPowerLimit=matInvPowerLimit, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsBypassUnavailable=matStsBypassUnavailable, matStsRunningMode=matStsRunningMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matSts=matSts, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matAgent=matAgent, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvLowInputShutdown=matInvLowInputShutdown, matConWarningState=matConWarningState, matStsModuleType=matStsModuleType, matStsSerialNum=matStsSerialNum, matInverter=matInverter, matStsEntry=matStsEntry, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvFault=matInvFault, matStsFaultMode=matStsFaultMode, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputFreq=matConfInvOutputFreq, matConName=matConName, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, ppc=ppc, matStsModuleIndex=matStsModuleIndex, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsNotRespond=matStsNotRespond, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsOutputPower=matStsOutputPower, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matDryContactNum=matDryContactNum, matInvTable=matInvTable, matInvOverLoad=matInvOverLoad, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsInvInputVoltage=matStsInvInputVoltage, matStsTemperature=matStsTemperature, matInvOutputShort=matInvOutputShort, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvInputVoltage=matConfInvInputVoltage, matStsInvFail=matStsInvFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvOutputFreq=matInvOutputFreq, matDryContactEntry=matDryContactEntry, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsOutputFreq=matStsOutputFreq, matInvLineVoltage=matInvLineVoltage, matStsMBSPosFault=matStsMBSPosFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConSerialNum=matConSerialNum, matInvModuleIndex=matInvModuleIndex, matInvRunMode=matInvRunMode, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, device=device, matTrapTargetsEntry=matTrapTargetsEntry, matInvPulseFault=matInvPulseFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsHardwareVersion=matStsHardwareVersion, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvTemperatureHigh=matInvTemperatureHigh, matStsRuntime=matStsRuntime, matInvPhaseType=matInvPhaseType, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matConCommunicationLost=matConCommunicationLost, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsControlPowerFail=matStsControlPowerFail, matConfInvOutputPower=matConfInvOutputPower, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsIndex=matTrapTargetsIndex, matInvHardwareVersion=matInvHardwareVersion, matTrapSeverityLevel=matTrapSeverityLevel, matInvEntry=matInvEntry, matStsTable=matStsTable, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvTempPowerLimit=matInvTempPowerLimit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOutputVoltLow=matInvOutputVoltLow, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, PositiveInteger=PositiveInteger, matInvNotRespond=matInvNotRespond, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfStsPriority=matConfStsPriority, matTrapTargetsAddress=matTrapTargetsAddress, matConEEPROMFault=matConEEPROMFault, matInvRunTime=matInvRunTime, matStsMainInputFreq=matStsMainInputFreq, matObjects=matObjects, matInvEEPROMFault=matInvEEPROMFault, matInvTemperature=matInvTemperature, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsFanFault=matStsFanFault, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvHardwareError=matInvHardwareError, matConTemperature=matConTemperature, matConCanBusOff=matConCanBusOff, matStsMainsFail=matStsMainsFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsStatus=matStsStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvInputAbnormal=matInvInputAbnormal, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapType=matTrapType, matStsMainHighLossVoltage=matStsMainHighLossVoltage)
