...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvModuleNum=matInvModuleNum, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvBusSoftFail=matInvBusSoftFail, matInvFanFault=matInvFanFault, matStsControlPowerFail=matStsControlPowerFail, matInvLineFreq=matInvLineFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvEEPROMFault=matInvEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matStsEEPROMFault=matStsEEPROMFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsNotRespond=matStsNotRespond, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsTemperatureHigh=matStsTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvOutputPower=matConfInvOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matObjects=matObjects, matInvHardwareError=matInvHardwareError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matDryContactTable=matDryContactTable, matStsTemperature=matStsTemperature, matConTemperature=matConTemperature, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConName=matConName, matInvFault=matInvFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matAgent=matAgent, device=device, matInvPulseFault=matInvPulseFault, matConfInvOutputFreq=matConfInvOutputFreq, matConfig=matConfig, matStsInvInputVoltage=matStsInvInputVoltage, matStsMbsStatus=matStsMbsStatus, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsEntry=matStsEntry, matConWarningState=matConWarningState, matConCommunicationLost=matConCommunicationLost, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matDryContactEntry=matDryContactEntry, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsInvInputFreq=matStsInvInputFreq, matStsWarningState=matStsWarningState, matConfStsPriority=matConfStsPriority, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matInvNotRespond=matInvNotRespond, matStsOutputPower=matStsOutputPower, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMainsFail=matStsMainsFail, matInvOutputVoltage=matInvOutputVoltage, ppc=ppc, matConCanBusOff=matConCanBusOff, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvLineVoltage=matInvLineVoltage, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsRunningMode=matStsRunningMode, matInvOutputCurrent=matInvOutputCurrent, matInvOverLoad=matInvOverLoad, matStsMBSPosFault=matStsMBSPosFault, matInvPowerLimit=matInvPowerLimit, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTrapType=matTrapType, matStsHardwareVersion=matStsHardwareVersion, matConEEPROMFault=matConEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsModuleIndex=matStsModuleIndex, matTrapTargetsTable=matTrapTargetsTable, matInvEntry=matInvEntry, matStsMainInputVoltage=matStsMainInputVoltage, matInvOutputPower=matInvOutputPower, matInvOutputFreq=matInvOutputFreq, matDryContact=matDryContact, matInvPriority=matInvPriority, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsModuleNum=matStsModuleNum, matInvEPOShutdown=matInvEPOShutdown, matConBatteryLow=matConBatteryLow, matStsFanFault=matStsFanFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfStsFanSpeed=matConfStsFanSpeed, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsRuntime=matStsRuntime, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvOutputShort=matInvOutputShort, matTrapTargetsDesc=matTrapTargetsDesc, matDryContactIndex=matDryContactIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvSoftStartFail=matInvSoftStartFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matDryContactString=matDryContactString, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, PositiveInteger=PositiveInteger, matTrapTargetsNum=matTrapTargetsNum, matTrapTargetsAddress=matTrapTargetsAddress, NonNegativeInteger=NonNegativeInteger, matStsMainInputFreq=matStsMainInputFreq, matInvWarningState=matInvWarningState, matStsOutputCurrent=matStsOutputCurrent, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvTemperature=matInvTemperature, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvPhaseType=matInvPhaseType, matStsModuleType=matStsModuleType, matTraps=matTraps, matSts=matSts, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargets=matTrapTargets, matStsTable=matStsTable, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsFaultMode=matStsFaultMode, matDryContactNum=matDryContactNum, matStsStatus=matStsStatus, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTable=matInvTable, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvFail=matStsInvFail, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvMbsPosition=matInvMbsPosition, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsOutputFreq=matStsOutputFreq, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matController=matController, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvOnOffStatus=matInvOnOffStatus, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsOverLoad=matStsOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConSerialNum=matConSerialNum, matInvModuleIndex=matInvModuleIndex, matInvRunTime=matInvRunTime, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapSeverityLevel=matTrapSeverityLevel, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvSerialNum=matInvSerialNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInverter=matInverter, matInvRunMode=matInvRunMode, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matInvInputAbnormal=matInvInputAbnormal, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOutputVoltage=matStsOutputVoltage, matStsSerialNum=matStsSerialNum, matInvMainUnavailable=matInvMainUnavailable, matInvBypassSCRShort=matInvBypassSCRShort, matStsOutputAbnormal=matStsOutputAbnormal, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault)
