...
Bits, MibIdentifier, enterprises, IpAddress, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity, iso, Gauge32, Counter64, Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "enterprises", "IpAddress", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32", "Counter64", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvNegativePowerProtect=matInvNegativePowerProtect, matInverter=matInverter, matInvWarningState=matInvWarningState, matConfInvOutputPower=matConfInvOutputPower, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsModuleIndex=matStsModuleIndex, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConTemperature=matConTemperature, matConEEPROMFault=matConEEPROMFault, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, ppc=ppc, matConName=matConName, matTrapSeverityLevel=matTrapSeverityLevel, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfStsPriority=matConfStsPriority, matStsMBSPosFault=matStsMBSPosFault, matDryContactNum=matDryContactNum, matInvSerialNum=matInvSerialNum, matInvOutputCurrent=matInvOutputCurrent, matConfig=matConfig, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContact=matDryContact, matInvNotRespond=matInvNotRespond, matInvOverLoad=matInvOverLoad, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsOutputPower=matStsOutputPower, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsWarningState=matStsWarningState, matTrapTargetsAddress=matTrapTargetsAddress, matStsModuleNum=matStsModuleNum, matTrapTargetsDesc=matTrapTargetsDesc, matInvBusSoftFail=matInvBusSoftFail, matConSerialNum=matConSerialNum, matInvEntry=matInvEntry, matTrapTargetsNum=matTrapTargetsNum, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsNotRespond=matStsNotRespond, matInvOutputFreq=matInvOutputFreq, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvSysPriority=matConfInvSysPriority, matStsStatus=matStsStatus, matStsFanFault=matStsFanFault, matStsFirmwareVersion=matStsFirmwareVersion, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvPriority=matInvPriority, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsEEPROMFault=matStsEEPROMFault, matInvRunTime=matInvRunTime, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvTable=matInvTable, matInvMainUnavailable=matInvMainUnavailable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsInvInputFreq=matStsInvInputFreq, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsHardwareVersion=matStsHardwareVersion, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matObjects=matObjects, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvLineVoltage=matInvLineVoltage, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsControlPowerFail=matStsControlPowerFail, matStsEntry=matStsEntry, matStsRunningMode=matStsRunningMode, matConCanBusOff=matConCanBusOff, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matDryContactEntry=matDryContactEntry, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMainsFail=matStsMainsFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvPulseFault=matInvPulseFault, matInvLineFreq=matInvLineFreq, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matStsMainInputFreq=matStsMainInputFreq, matSts=matSts, matStsOutputVoltage=matStsOutputVoltage, matConBatteryLow=matConBatteryLow, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsBypassUnavailable=matStsBypassUnavailable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTraps=matTraps, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvInputAbnormal=matInvInputAbnormal, matInvFanFault=matInvFanFault, matInvMbsPosition=matInvMbsPosition, matConTemperatureHigh=matConTemperatureHigh, matInvModuleNum=matInvModuleNum, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvTemperature=matInvTemperature, matStsRuntime=matStsRuntime, matDryContactTable=matDryContactTable, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsTemperature=matStsTemperature, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsTable=matStsTable, matInvFault=matInvFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvHardwareVersion=matInvHardwareVersion, matInvLowInputShutdown=matInvLowInputShutdown, matInvRunMode=matInvRunMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matDryContactIndex=matDryContactIndex, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsSerialNum=matStsSerialNum, matDryContactString=matDryContactString, matStsInvFail=matStsInvFail, matInvPhaseType=matInvPhaseType, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvPowerLimit=matInvPowerLimit, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsOverLoad=matStsOverLoad, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvHardwareError=matInvHardwareError, matInvOutputShort=matInvOutputShort, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConCommunicationLost=matConCommunicationLost, matInvModuleIndex=matInvModuleIndex, matController=matController, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsOutputFreq=matStsOutputFreq, matStsFaultMode=matStsFaultMode, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvOutputPower=matInvOutputPower, matConWarningState=matConWarningState, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsModuleType=matStsModuleType, matTrapType=matTrapType, matAgent=matAgent, device=device, matInvEEPROMFault=matInvEEPROMFault, NonNegativeInteger=NonNegativeInteger, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsMbsStatus=matStsMbsStatus, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvTempPowerLimit=matInvTempPowerLimit, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvBypassMode=matStsInvBypassMode, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromConCanBusOff=matReturnFromConCanBusOff, PositiveInteger=PositiveInteger, matStsOutputAbnormal=matStsOutputAbnormal, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargets=matTrapTargets, matInvMBSPosError=matInvMBSPosError)
