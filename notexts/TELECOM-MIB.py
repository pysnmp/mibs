...
ModuleIdentity, Bits, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, Gauge32, IpAddress, TimeTicks, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "IpAddress", "TimeTicks", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsWarningState=matStsWarningState, matStsRunningMode=matStsRunningMode, matSts=matSts, matInvFanFault=matInvFanFault, matStsModuleType=matStsModuleType, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matTrapTargets=matTrapTargets, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsTable=matStsTable, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsNum=matTrapTargetsNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvFault=matReturnFromInvFault, matDryContactString=matDryContactString, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvModuleNum=matInvModuleNum, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConSerialNum=matConSerialNum, matConfStsPriority=matConfStsPriority, matConCommunicationLost=matConCommunicationLost, matInvLineVoltage=matInvLineVoltage, matInvMbsPosition=matInvMbsPosition, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsFaultMode=matStsFaultMode, matStsEEPROMFault=matStsEEPROMFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matInverter=matInverter, matStsNotRespond=matStsNotRespond, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOutputCurrent=matInvOutputCurrent, matStsMainsFail=matStsMainsFail, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsBypassUnavailable=matStsBypassUnavailable, matController=matController, matInvRunTime=matInvRunTime, matStsTemperature=matStsTemperature, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMBSPosFault=matStsMBSPosFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsStatus=matStsStatus, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvTable=matInvTable, matStsModuleNum=matStsModuleNum, matInvOutputVoltage=matInvOutputVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConWarningState=matConWarningState, matDryContactEntry=matDryContactEntry, matStsOutputPower=matStsOutputPower, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsInvFail=matReturnFromStsInvFail, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvPhaseType=matInvPhaseType, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvBypassMode=matStsInvBypassMode, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvHardwareVersion=matInvHardwareVersion, matStsTemperatureHigh=matStsTemperatureHigh, matAgent=matAgent, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputPower=matConfInvOutputPower, matStsRuntime=matStsRuntime, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvPriority=matInvPriority, matTraps=matTraps, matStsInvFail=matStsInvFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvInputAbnormal=matInvInputAbnormal, matStsFanFault=matStsFanFault, matStsSerialNum=matStsSerialNum, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsEntry=matStsEntry, matInvWarningState=matInvWarningState, matConCanBusOff=matConCanBusOff, matObjects=matObjects, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOutputFreq=matStsOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvInputVoltage=matStsInvInputVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsControlPowerFail=matStsControlPowerFail, matStsMainInputFreq=matStsMainInputFreq, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsDesc=matTrapTargetsDesc, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvMBSPosError=matInvMBSPosError, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, PositiveInteger=PositiveInteger, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsOutputVoltage=matStsOutputVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvNotRespond=matInvNotRespond, matInvTemperature=matInvTemperature, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConTemperature=matConTemperature, matInvPowerLimit=matInvPowerLimit, matInvOnOffStatus=matInvOnOffStatus, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConTemperatureHigh=matConTemperatureHigh, matDryContactIndex=matDryContactIndex, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsModuleIndex=matStsModuleIndex, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOverLoad=matStsOverLoad, matInvRunMode=matInvRunMode, matInvOutputPower=matInvOutputPower, matInvFault=matInvFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvBypassSCRShort=matInvBypassSCRShort, matInvMainUnavailable=matInvMainUnavailable, matConBatteryLow=matConBatteryLow, matDryContactTable=matDryContactTable, matTrapType=matTrapType, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargetsTable=matTrapTargetsTable, matInvEEPROMFault=matInvEEPROMFault, matInvPulseFault=matInvPulseFault, matInvBusSoftFail=matInvBusSoftFail, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfInvOutputFreq=matConfInvOutputFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputShort=matInvOutputShort, matInvLineFreq=matInvLineFreq, matInvSerialNum=matInvSerialNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputVoltLow=matInvOutputVoltLow, matDryContactNum=matDryContactNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, NonNegativeInteger=NonNegativeInteger, matStsMbsStatus=matStsMbsStatus, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConEEPROMFault=matConEEPROMFault, matInvHardwareError=matInvHardwareError, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvOverLoad=matInvOverLoad, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matDryContact=matDryContact, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvEntry=matInvEntry, matTrapTargetsIndex=matTrapTargetsIndex, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, ppc=ppc, matInvOutputFreq=matInvOutputFreq, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvModuleIndex=matInvModuleIndex, device=device, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvInputVoltage=matConfInvInputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfig=matConfig, matConName=matConName, matStsOutputAbnormal=matStsOutputAbnormal)
