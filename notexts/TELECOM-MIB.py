...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputShort=matReturnFromInvOutputShort, PositiveInteger=PositiveInteger, device=device, matConWarningState=matConWarningState, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConTemperatureHigh=matConTemperatureHigh, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvWarningState=matInvWarningState, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvOutputPower=matConfInvOutputPower, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapTargetsDesc=matTrapTargetsDesc, matObjects=matObjects, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContactEntry=matDryContactEntry, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMBSPosFault=matStsMBSPosFault, matConBatteryLow=matConBatteryLow, NonNegativeInteger=NonNegativeInteger, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargets=matTrapTargets, matInvRunMode=matInvRunMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTraps=matTraps, matStsHardwareVersion=matStsHardwareVersion, matInvInputAbnormal=matInvInputAbnormal, matStsInvInputVoltage=matStsInvInputVoltage, matConfStsPriority=matConfStsPriority, matConCanBusOff=matConCanBusOff, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvBusSoftFail=matInvBusSoftFail, matStsSerialNum=matStsSerialNum, matInvHardwareError=matInvHardwareError, matInvPriority=matInvPriority, matTrapTargetsIndex=matTrapTargetsIndex, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfig=matConfig, matInvBatteryVoltage=matInvBatteryVoltage, matInvTemperature=matInvTemperature, matStsOutputCurrent=matStsOutputCurrent, matInverter=matInverter, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOutputVoltage=matStsOutputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvOutputFreq=matInvOutputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsFaultMode=matStsFaultMode, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvPulseFault=matInvPulseFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvSerialNum=matInvSerialNum, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsTemperatureHigh=matStsTemperatureHigh, matSts=matSts, matInvPhaseType=matInvPhaseType, matInvEPOShutdown=matInvEPOShutdown, matInvEntry=matInvEntry, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargetsEntry=matTrapTargetsEntry, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvMbsPosition=matInvMbsPosition, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matDryContactIndex=matDryContactIndex, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvTable=matInvTable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsInvInputFreq=matStsInvInputFreq, matInvPowerLimit=matInvPowerLimit, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainsFail=matStsMainsFail, matDryContactString=matDryContactString, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOutputPower=matStsOutputPower, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvMainUnavailable=matInvMainUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsFanFault=matStsFanFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsRuntime=matStsRuntime, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvLineVoltage=matInvLineVoltage, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContactTable=matDryContactTable, matStsModuleNum=matStsModuleNum, matStsMainInputVoltage=matStsMainInputVoltage, matInvFanFault=matInvFanFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvNotRespond=matInvNotRespond, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMbsStatus=matStsMbsStatus, matDryContact=matDryContact, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvRunTime=matInvRunTime, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConEEPROMFault=matConEEPROMFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsModuleIndex=matStsModuleIndex, matAgent=matAgent, matConfInvInputVoltage=matConfInvInputVoltage, matStsOutputFreq=matStsOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matConName=matConName, matInvNegativePowerProtect=matInvNegativePowerProtect, matConTemperature=matConTemperature, matStsStatus=matStsStatus, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapType=matTrapType, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsTable=matTrapTargetsTable, matInvOverLoad=matInvOverLoad, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConCommunicationLost=matConCommunicationLost, matInvOutputVoltage=matInvOutputVoltage, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, ppc=ppc, matInvMBSPosError=matInvMBSPosError, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matController=matController, matDryContactNum=matDryContactNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvLineFreq=matInvLineFreq, matStsOutputAbnormal=matStsOutputAbnormal, matInvSoftStartFail=matInvSoftStartFail, matInvOutputShort=matInvOutputShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConSerialNum=matConSerialNum, matConfInvSysPriority=matConfInvSysPriority, matStsWarningState=matStsWarningState, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvFault=matInvFault, matInvOutputPower=matInvOutputPower, matStsModuleType=matStsModuleType, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvModuleIndex=matInvModuleIndex, matInvTemperatureHigh=matInvTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matStsNotRespond=matStsNotRespond, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsTemperature=matStsTemperature, matStsRunningMode=matStsRunningMode, matInvModuleNum=matInvModuleNum, matStsEEPROMFault=matStsEEPROMFault, matStsOverLoad=matStsOverLoad, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsInvFail=matStsInvFail, matStsEntry=matStsEntry, matStsTable=matStsTable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit)
