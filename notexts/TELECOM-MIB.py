...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapSeverityLevel=matTrapSeverityLevel, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvHardwareVersion=matInvHardwareVersion, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matObjects=matObjects, matStsMainsFail=matStsMainsFail, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsOutputFreq=matStsOutputFreq, matConCommunicationLost=matConCommunicationLost, matInvFirmwareVersion=matInvFirmwareVersion, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsMbsStatus=matStsMbsStatus, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConBatteryLow=matConBatteryLow, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvHardwareError=matInvHardwareError, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsModuleNum=matStsModuleNum, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOnOffStatus=matInvOnOffStatus, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvInputVoltage=matConfInvInputVoltage, matStsFaultMode=matStsFaultMode, matInvBusSoftFail=matInvBusSoftFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matStsWarningState=matStsWarningState, matTrapTargetsAddress=matTrapTargetsAddress, matDryContact=matDryContact, matStsRunningMode=matStsRunningMode, matTrapTargets=matTrapTargets, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvEntry=matInvEntry, matStsTemperature=matStsTemperature, matInvWarningState=matInvWarningState, matInvSerialNum=matInvSerialNum, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsNotRespond=matStsNotRespond, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInverter=matInverter, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvOutputCurrent=matInvOutputCurrent, matInvRunTime=matInvRunTime, matInvFanFault=matInvFanFault, device=device, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOverLoad=matInvOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvLineFreq=matInvLineFreq, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContactNum=matDryContactNum, matStsTemperatureHigh=matStsTemperatureHigh, matConTemperature=matConTemperature, matInvPriority=matInvPriority, matTrapTargetsDesc=matTrapTargetsDesc, matStsModuleType=matStsModuleType, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsOutputCurrent=matStsOutputCurrent, matInvInputAbnormal=matInvInputAbnormal, matDryContactTable=matDryContactTable, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matController=matController, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsOutputVoltage=matStsOutputVoltage, matStsModuleIndex=matStsModuleIndex, matInvFault=matInvFault, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvEPOShutdown=matInvEPOShutdown, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsMainInputFreq=matStsMainInputFreq, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsOutputPower=matStsOutputPower, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConEEPROMFault=matConEEPROMFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContactEntry=matDryContactEntry, matStsEntry=matStsEntry, matStsFanFault=matStsFanFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, ppc=ppc, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvLowInputShutdown=matInvLowInputShutdown, matAgent=matAgent, matDryContactIndex=matDryContactIndex, matConfig=matConfig, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsSerialNum=matStsSerialNum, matReturnFromInvFanFault=matReturnFromInvFanFault, PositiveInteger=PositiveInteger, matStsInvFail=matStsInvFail, matStsMainInputVoltage=matStsMainInputVoltage, matSts=matSts, matConfStsFanSpeed=matConfStsFanSpeed, matInvEEPROMFault=matInvEEPROMFault, matInvTable=matInvTable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvLineVoltage=matInvLineVoltage, matInvMainUnavailable=matInvMainUnavailable, matInvMBSPosError=matInvMBSPosError, matStsHardwareVersion=matStsHardwareVersion, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsRuntime=matStsRuntime, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputFreq=matInvOutputFreq, matConName=matConName, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsIndex=matTrapTargetsIndex, matStsTable=matStsTable, matConTemperatureHigh=matConTemperatureHigh, matStsInvBypassMode=matStsInvBypassMode, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfStsPriority=matConfStsPriority, matInvTemperature=matInvTemperature, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, NonNegativeInteger=NonNegativeInteger, matStsStatus=matStsStatus, matInvOutputShort=matInvOutputShort, matStsOverLoad=matStsOverLoad, matInvMbsPosition=matInvMbsPosition, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvPulseFault=matInvPulseFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsInvInputFreq=matStsInvInputFreq, matInvRunMode=matInvRunMode, matInvPhaseType=matInvPhaseType, matConSerialNum=matConSerialNum, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvOutputVoltage=matInvOutputVoltage, matConfInvSysPriority=matConfInvSysPriority, matConfInvOutputPower=matConfInvOutputPower, matInvModuleIndex=matInvModuleIndex, matInvOutputPower=matInvOutputPower, matTrapTargetsNum=matTrapTargetsNum, matStsEEPROMFault=matStsEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConCanBusOff=matConCanBusOff, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsControlPowerFail=matStsControlPowerFail, matInvPowerLimit=matInvPowerLimit, matDryContactString=matDryContactString, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapType=matTrapType, matConfInvOutputFreq=matConfInvOutputFreq, matConWarningState=matConWarningState, matReturnFromInvFault=matReturnFromInvFault, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMBSPosFault=matStsMBSPosFault, matTraps=matTraps, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvNotRespond=matInvNotRespond, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matInvSoftStartFail=matInvSoftStartFail)
