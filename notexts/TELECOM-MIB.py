...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMBSPosFault=matStsMBSPosFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matInvSoftStartFail=matInvSoftStartFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsInvInputFreq=matStsInvInputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, NonNegativeInteger=NonNegativeInteger, matInvOutputShort=matInvOutputShort, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputFreq=matConfInvOutputFreq, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOutputVoltage=matInvOutputVoltage, matStsTable=matStsTable, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvSerialNum=matInvSerialNum, matConfStsFanSpeed=matConfStsFanSpeed, matInvMainUnavailable=matInvMainUnavailable, matInvModuleIndex=matInvModuleIndex, matReturnFromInvFanFault=matReturnFromInvFanFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBusSoftFail=matInvBusSoftFail, matStsOverLoad=matStsOverLoad, matStsFanFault=matStsFanFault, matStsOutputPower=matStsOutputPower, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapType=matTrapType, matReturnFromInvFault=matReturnFromInvFault, matStsStatus=matStsStatus, matStsHardwareVersion=matStsHardwareVersion, ppc=ppc, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvLineFreq=matInvLineFreq, matStsEEPROMFault=matStsEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsTemperature=matStsTemperature, matConCanBusOff=matConCanBusOff, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvOutputPower=matConfInvOutputPower, matInvOutputFreq=matInvOutputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvSysPriority=matConfInvSysPriority, matStsBypassUnavailable=matStsBypassUnavailable, matInvTable=matInvTable, matInvHardwareVersion=matInvHardwareVersion, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfStsPriority=matConfStsPriority, matStsRunningMode=matStsRunningMode, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsRuntime=matStsRuntime, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvEntry=matInvEntry, matStsEntry=matStsEntry, matTrapTargetsDesc=matTrapTargetsDesc, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsFaultMode=matStsFaultMode, matInvTempPowerLimit=matInvTempPowerLimit, matStsMainInputVoltage=matStsMainInputVoltage, matDryContactEntry=matDryContactEntry, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsInvFail=matReturnFromStsInvFail, matObjects=matObjects, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputVoltage=matStsOutputVoltage, matTrapTargets=matTrapTargets, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matConName=matConName, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, PositiveInteger=PositiveInteger, matDryContactString=matDryContactString, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matDryContactIndex=matDryContactIndex, matDryContactTable=matDryContactTable, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvInputVoltage=matConfInvInputVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConBatteryLow=matConBatteryLow, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matAgent=matAgent, matConSerialNum=matConSerialNum, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsAddress=matTrapTargetsAddress, matInvOverLoad=matInvOverLoad, matInvFault=matInvFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsModuleNum=matStsModuleNum, matTrapSeverityLevel=matTrapSeverityLevel, matInvFanFault=matInvFanFault, matDryContactNum=matDryContactNum, matStsOutputAbnormal=matStsOutputAbnormal, matInvBatteryVoltage=matInvBatteryVoltage, matInvModuleNum=matInvModuleNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvPowerLimit=matInvPowerLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapTargetsTable=matTrapTargetsTable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsNum=matTrapTargetsNum, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvLowInputShutdown=matInvLowInputShutdown, matStsWarningState=matStsWarningState, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsInvFail=matStsInvFail, matConTemperature=matConTemperature, matConTemperatureHigh=matConTemperatureHigh, matInvRunMode=matInvRunMode, matInvMBSPosError=matInvMBSPosError, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsModuleIndex=matStsModuleIndex, device=device, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matConEEPROMFault=matConEEPROMFault, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsMainsFail=matStsMainsFail, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsSerialNum=matStsSerialNum, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvLineVoltage=matInvLineVoltage, matInvPriority=matInvPriority, matStsNotRespond=matStsNotRespond, matStsModuleType=matStsModuleType, matDryContact=matDryContact, matInvRunTime=matInvRunTime, matInvWarningState=matInvWarningState, matInverter=matInverter, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvHardwareError=matInvHardwareError, matInvNotRespond=matInvNotRespond, matInvMbsPosition=matInvMbsPosition, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvFirmwareVersion=matInvFirmwareVersion, matInvOutputPower=matInvOutputPower, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfig=matConfig, matInvPulseFault=matInvPulseFault, matConWarningState=matConWarningState, matTraps=matTraps, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsOutputFreq=matStsOutputFreq, matStsMainInputFreq=matStsMainInputFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsControlPowerFail=matStsControlPowerFail, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matController=matController, matInvPhaseType=matInvPhaseType, matInvTemperature=matInvTemperature, matTrapTargetsIndex=matTrapTargetsIndex, matSts=matSts)
