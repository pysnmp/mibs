...
iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, NotificationType, IpAddress, TimeTicks, NotificationType, enterprises, ModuleIdentity, Unsigned32, MibIdentifier, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "NotificationType", "IpAddress", "TimeTicks", "NotificationType", "enterprises", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOutputPower=matInvOutputPower, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matTrapTargetsEntry=matTrapTargetsEntry, matInvPriority=matInvPriority, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsRuntime=matStsRuntime, matStsTemperatureHigh=matStsTemperatureHigh, NonNegativeInteger=NonNegativeInteger, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvPulseFault=matInvPulseFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsEntry=matStsEntry, matInvEPOShutdown=matInvEPOShutdown, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matSts=matSts, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsFanFault=matStsFanFault, matAgent=matAgent, matInvOutputFreq=matInvOutputFreq, matStsModuleNum=matStsModuleNum, matConName=matConName, matTraps=matTraps, matStsInvInputVoltage=matStsInvInputVoltage, matInvTable=matInvTable, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsInvFail=matStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matStsOutputVoltage=matStsOutputVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsFirmwareVersion=matStsFirmwareVersion, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matInvFirmwareVersion=matInvFirmwareVersion, matStsRunningMode=matStsRunningMode, matStsTable=matStsTable, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvTemperatureHigh=matInvTemperatureHigh, matInvEntry=matInvEntry, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvLineFreq=matInvLineFreq, matInvMainUnavailable=matInvMainUnavailable, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsOutputFreq=matStsOutputFreq, matInvPhaseType=matInvPhaseType, matInvTempPowerLimit=matInvTempPowerLimit, matStsWarningState=matStsWarningState, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matDryContactIndex=matDryContactIndex, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainsFail=matStsMainsFail, matTrapTargetsIndex=matTrapTargetsIndex, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matDryContactNum=matDryContactNum, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvFanFault=matInvFanFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConTemperature=matConTemperature, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matController=matController, matStsOutputPower=matStsOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvTemperature=matInvTemperature, matInvBusSoftFail=matInvBusSoftFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputVoltage=matInvOutputVoltage, matStsEEPROMFault=matStsEEPROMFault, matInvLineVoltage=matInvLineVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConBatteryLow=matConBatteryLow, matObjects=matObjects, matStsModuleIndex=matStsModuleIndex, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsTemperature=matStsTemperature, matConfStsPriority=matConfStsPriority, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsNum=matTrapTargetsNum, matInvFault=matInvFault, matInvRunTime=matInvRunTime, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, ppc=ppc, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvSysPriority=matConfInvSysPriority, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvPowerLimit=matInvPowerLimit, matDryContact=matDryContact, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvHardwareVersion=matInvHardwareVersion, matTrapTargetsDesc=matTrapTargetsDesc, matInvEEPROMFault=matInvEEPROMFault, device=device, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConTemperatureHigh=matConTemperatureHigh, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsSerialNum=matStsSerialNum, matInvOutputShort=matInvOutputShort, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConEEPROMFault=matConEEPROMFault, matConfig=matConfig, matInvNotRespond=matInvNotRespond, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvModuleNum=matInvModuleNum, matStsModuleType=matStsModuleType, matInvNegativePowerProtect=matInvNegativePowerProtect, matConSerialNum=matConSerialNum, matInvOverLoad=matInvOverLoad, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContactString=matDryContactString, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsInvFail=matReturnFromStsInvFail, matConCanBusOff=matConCanBusOff, matStsStatus=matStsStatus, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsMBSPosFault=matStsMBSPosFault, matDryContactEntry=matDryContactEntry, matStsInvInputFreq=matStsInvInputFreq, matStsOverLoad=matStsOverLoad, matConfInvOutputPower=matConfInvOutputPower, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInverter=matInverter, matInvWarningState=matInvWarningState, matConWarningState=matConWarningState, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsFaultMode=matStsFaultMode, matStsNotRespond=matStsNotRespond, matStsBypassUnavailable=matStsBypassUnavailable, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargets=matTrapTargets, matInvMBSPosError=matInvMBSPosError, matInvHardwareError=matInvHardwareError, matStsOutputCurrent=matStsOutputCurrent, matConCommunicationLost=matConCommunicationLost, matTrapType=matTrapType, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsMainInputFreq=matStsMainInputFreq, matInvSerialNum=matInvSerialNum, matDryContactTable=matDryContactTable, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, PositiveInteger=PositiveInteger, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsOutputAbnormal=matStsOutputAbnormal, matInvMbsPosition=matInvMbsPosition, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvModuleIndex=matInvModuleIndex, matInvRunMode=matInvRunMode, matStsInvBypassMode=matStsInvBypassMode)
