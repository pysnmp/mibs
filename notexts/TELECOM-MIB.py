...
ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ModuleIdentity, Unsigned32, Counter64, Gauge32, NotificationType, Counter32, Integer32, IpAddress, NotificationType, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ModuleIdentity", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "Counter32", "Integer32", "IpAddress", "NotificationType", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsOutputFreq=matStsOutputFreq, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvOutputFreq=matInvOutputFreq, matInvTemperature=matInvTemperature, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConTemperatureHigh=matConTemperatureHigh, matStsRuntime=matStsRuntime, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsNum=matTrapTargetsNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvMBSPosError=matInvMBSPosError, matInvHardwareError=matInvHardwareError, matConBatteryLow=matConBatteryLow, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsFirmwareVersion=matStsFirmwareVersion, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsOutputPower=matStsOutputPower, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvOutputShort=matInvOutputShort, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matSts=matSts, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matDryContactEntry=matDryContactEntry, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsModuleType=matStsModuleType, matConTemperature=matConTemperature, matInvOverLoad=matInvOverLoad, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapTargets=matTrapTargets, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfInvOutputPower=matConfInvOutputPower, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvSerialNum=matInvSerialNum, matStsInvInputVoltage=matStsInvInputVoltage, matInvTemperatureHigh=matInvTemperatureHigh, matInvOutputCurrent=matInvOutputCurrent, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsStatus=matStsStatus, matStsEntry=matStsEntry, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsFaultMode=matStsFaultMode, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvRunTime=matInvRunTime, matStsHardwareVersion=matStsHardwareVersion, matConWarningState=matConWarningState, matConEEPROMFault=matConEEPROMFault, ppc=ppc, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvInputAbnormal=matInvInputAbnormal, matAgent=matAgent, matStsWarningState=matStsWarningState, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsNotRespond=matStsNotRespond, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsEEPROMFault=matStsEEPROMFault, PositiveInteger=PositiveInteger, matConCanBusOff=matConCanBusOff, device=device, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvBatteryVoltage=matInvBatteryVoltage, matStsTemperature=matStsTemperature, matInvMainUnavailable=matInvMainUnavailable, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matStsFanFault=matStsFanFault, matInvModuleNum=matInvModuleNum, matStsMainsFail=matStsMainsFail, matInvNotRespond=matInvNotRespond, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsRunningMode=matStsRunningMode, matDryContactTable=matDryContactTable, matConfig=matConfig, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvPowerLimit=matInvPowerLimit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsInvBypassMode=matStsInvBypassMode, matInvEntry=matInvEntry, matStsMainInputFreq=matStsMainInputFreq, matDryContact=matDryContact, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvLineVoltage=matInvLineVoltage, matDryContactString=matDryContactString, matInvPhaseType=matInvPhaseType, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvFault=matReturnFromInvFault, matStsOutputAbnormal=matStsOutputAbnormal, matConName=matConName, matInvFanFault=matInvFanFault, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputVoltage=matInvOutputVoltage, matTraps=matTraps, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvOutputPower=matInvOutputPower, matInvBypassSCRShort=matInvBypassSCRShort, matObjects=matObjects, matController=matController, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvTable=matInvTable, matInvHardwareVersion=matInvHardwareVersion, matInvRunMode=matInvRunMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMBSPosFault=matStsMBSPosFault, matStsSerialNum=matStsSerialNum, matStsBypassUnavailable=matStsBypassUnavailable, matInvBusSoftFail=matInvBusSoftFail, matInvPriority=matInvPriority, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matTrapType=matTrapType, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matDryContactNum=matDryContactNum, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvFault=matInvFault, matStsInvFail=matStsInvFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matDryContactIndex=matDryContactIndex, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsMbsStatus=matStsMbsStatus, matStsTable=matStsTable, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsModuleNum=matStsModuleNum, matConfStsPriority=matConfStsPriority, matInvPulseFault=matInvPulseFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvLineFreq=matInvLineFreq, matConCommunicationLost=matConCommunicationLost, NonNegativeInteger=NonNegativeInteger, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInverter=matInverter, matStsMainInputVoltage=matStsMainInputVoltage, matInvWarningState=matInvWarningState, matStsOverLoad=matStsOverLoad, matStsModuleIndex=matStsModuleIndex, matInvLowInputShutdown=matInvLowInputShutdown, matInvMbsPosition=matInvMbsPosition, matConfInvInputVoltage=matConfInvInputVoltage, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConSerialNum=matConSerialNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvModuleIndex=matInvModuleIndex, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss)
