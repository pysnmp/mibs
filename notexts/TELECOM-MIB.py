...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvLineFreq=matInvLineFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConCommunicationLost=matConCommunicationLost, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvEntry=matInvEntry, matInvTemperatureHigh=matInvTemperatureHigh, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConName=matConName, matInvPowerLimit=matInvPowerLimit, matInvOutputFreq=matInvOutputFreq, matStsMainInputFreq=matStsMainInputFreq, PositiveInteger=PositiveInteger, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvBatteryVoltage=matInvBatteryVoltage, matTrapTargetsEntry=matTrapTargetsEntry, matDryContactString=matDryContactString, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvSoftStartFail=matInvSoftStartFail, matStsInvFail=matStsInvFail, matInvModuleNum=matInvModuleNum, matDryContactTable=matDryContactTable, matController=matController, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargets=matTrapTargets, matStsStatus=matStsStatus, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapSeverityLevel=matTrapSeverityLevel, matInvMBSPosError=matInvMBSPosError, matTrapTargetsIndex=matTrapTargetsIndex, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvMbsPosition=matInvMbsPosition, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsTemperature=matStsTemperature, matConBatteryLow=matConBatteryLow, matInvLineVoltage=matInvLineVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConEEPROMFault=matConEEPROMFault, matInvOutputVoltLow=matInvOutputVoltLow, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvNotRespond=matInvNotRespond, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsModuleNum=matStsModuleNum, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvOutputShort=matInvOutputShort, matStsMainsFail=matStsMainsFail, matInvHardwareVersion=matInvHardwareVersion, matInvMaintenaceBypass=matInvMaintenaceBypass, matObjects=matObjects, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvFault=matInvFault, matStsMBSPosFault=matStsMBSPosFault, matInvPriority=matInvPriority, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matTraps=matTraps, matStsFaultMode=matStsFaultMode, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsOutputVoltage=matStsOutputVoltage, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, NonNegativeInteger=NonNegativeInteger, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvOutputPower=matConfInvOutputPower, matStsFanFault=matStsFanFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvTable=matInvTable, matStsFirmwareVersion=matStsFirmwareVersion, matStsHardwareVersion=matStsHardwareVersion, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvBypassMode=matStsInvBypassMode, matConWarningState=matConWarningState, matInvTemperature=matInvTemperature, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConTemperatureHigh=matConTemperatureHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsFanSpeed=matConfStsFanSpeed, matDryContactNum=matDryContactNum, matStsOutputFreq=matStsOutputFreq, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputPower=matInvOutputPower, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapType=matTrapType, matInvFanFault=matInvFanFault, matTrapTargetsNum=matTrapTargetsNum, matDryContactIndex=matDryContactIndex, matInvOverLoad=matInvOverLoad, matConTemperature=matConTemperature, matStsInvInputVoltage=matStsInvInputVoltage, matStsOutputPower=matStsOutputPower, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsFaultMode=matReturnFromStsFaultMode, ppc=ppc, matInvBusSoftFail=matInvBusSoftFail, matInvEEPROMFault=matInvEEPROMFault, matInverter=matInverter, matConSerialNum=matConSerialNum, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvInputAbnormal=matInvInputAbnormal, matSts=matSts, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsWarningState=matStsWarningState, matConfInvSysPriority=matConfInvSysPriority, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvHardwareError=matInvHardwareError, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfStsPriority=matConfStsPriority, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsFanFault=matReturnFromStsFanFault, matDryContactEntry=matDryContactEntry, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matDryContact=matDryContact, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvPhaseType=matInvPhaseType, matAgent=matAgent, matStsSerialNum=matStsSerialNum, matInvSerialNum=matInvSerialNum, matStsModuleType=matStsModuleType, matStsInvInputFreq=matStsInvInputFreq, matStsTemperatureHigh=matStsTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvOutputFreq=matConfInvOutputFreq, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsNotRespond=matStsNotRespond, matInvRunMode=matInvRunMode, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfig=matConfig, device=device, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConCanBusOff=matConCanBusOff, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvPulseFault=matInvPulseFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsTable=matStsTable, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvWarningState=matInvWarningState, matStsMainInputVoltage=matStsMainInputVoltage, matStsModuleIndex=matStsModuleIndex, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsControlPowerFail=matStsControlPowerFail, matInvModuleIndex=matInvModuleIndex, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvLowInputShutdown=matInvLowInputShutdown, matStsRunningMode=matStsRunningMode, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsOutputAbnormal=matStsOutputAbnormal, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsOverLoad=matStsOverLoad, matInvTempPowerLimit=matInvTempPowerLimit, matStsEntry=matStsEntry, matInvRunTime=matInvRunTime, matStsRuntime=matStsRuntime)
