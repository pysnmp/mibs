...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, enterprises, Integer32, ModuleIdentity, TimeTicks, Counter64, MibIdentifier, ObjectIdentity, Bits, Counter32, NotificationType, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "enterprises", "Integer32", "ModuleIdentity", "TimeTicks", "Counter64", "MibIdentifier", "ObjectIdentity", "Bits", "Counter32", "NotificationType", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvBypassMode=matStsInvBypassMode, matStsControlPowerFail=matStsControlPowerFail, matInvPhaseType=matInvPhaseType, matConName=matConName, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matTrapTargetsDesc=matTrapTargetsDesc, matStsTable=matStsTable, matInvTempPowerLimit=matInvTempPowerLimit, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvLineFreq=matInvLineFreq, matInvRunTime=matInvRunTime, matInverter=matInverter, matInvHardwareVersion=matInvHardwareVersion, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsIndex=matTrapTargetsIndex, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvInputVoltage=matConfInvInputVoltage, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvPulseFault=matInvPulseFault, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvSerialNum=matInvSerialNum, matInvLineVoltage=matInvLineVoltage, matInvHardwareError=matInvHardwareError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvRunMode=matInvRunMode, matStsNotRespond=matStsNotRespond, matConTemperatureHigh=matConTemperatureHigh, matInvPowerLimit=matInvPowerLimit, matInvOutputShort=matInvOutputShort, matInvModuleNum=matInvModuleNum, matInvBypassSCRShort=matInvBypassSCRShort, matInvEntry=matInvEntry, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matSts=matSts, matInvMBSPosError=matInvMBSPosError, matInvPriority=matInvPriority, matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsInvFail=matStsInvFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvTemperature=matInvTemperature, matInvNotRespond=matInvNotRespond, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsOutputFreq=matStsOutputFreq, matConTemperature=matConTemperature, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matTraps=matTraps, matAgent=matAgent, PositiveInteger=PositiveInteger, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsModuleIndex=matStsModuleIndex, matObjects=matObjects, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsMainInputFreq=matStsMainInputFreq, matTrapType=matTrapType, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsInvLosLossVoltage=matStsInvLosLossVoltage, device=device, matDryContactEntry=matDryContactEntry, matConfInvOutputFreq=matConfInvOutputFreq, matDryContactIndex=matDryContactIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matController=matController, matInvModuleIndex=matInvModuleIndex, matTrapTargets=matTrapTargets, matStsOverLoad=matStsOverLoad, matInvOutputFreq=matInvOutputFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvSoftStartFail=matInvSoftStartFail, matInvMbsPosition=matInvMbsPosition, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsMainInputVoltage=matStsMainInputVoltage, matStsTemperature=matStsTemperature, matStsTemperatureHigh=matStsTemperatureHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matTrapTargetsTable=matTrapTargetsTable, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvOutputVoltage=matInvOutputVoltage, matStsSerialNum=matStsSerialNum, matReturnFromInvFault=matReturnFromInvFault, matStsOutputVoltage=matStsOutputVoltage, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsMainsFail=matStsMainsFail, matStsStatus=matStsStatus, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvLowInputShutdown=matInvLowInputShutdown, matStsFaultMode=matStsFaultMode, matTrapTargetsAddress=matTrapTargetsAddress, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsMBSPosFault=matStsMBSPosFault, matStsRunningMode=matStsRunningMode, matConCanBusOff=matConCanBusOff, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsWarningState=matStsWarningState, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matDryContact=matDryContact, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConWarningState=matConWarningState, matConBatteryLow=matConBatteryLow, matInvOutputPower=matInvOutputPower, matStsBypassUnavailable=matStsBypassUnavailable, matInvOutputCurrent=matInvOutputCurrent, matStsOutputPower=matStsOutputPower, matInvTable=matInvTable, matStsHardwareVersion=matStsHardwareVersion, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsModuleNum=matStsModuleNum, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfig=matConfig, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matDryContactNum=matDryContactNum, matInvWarningState=matInvWarningState, matConfStsPriority=matConfStsPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvFanFault=matInvFanFault, matTrapTargetsEntry=matTrapTargetsEntry, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConEEPROMFault=matConEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matConfStsFanSpeed=matConfStsFanSpeed, matInvInputAbnormal=matInvInputAbnormal, matConSerialNum=matConSerialNum, matStsEntry=matStsEntry, matReturnFromInvHardwareError=matReturnFromInvHardwareError, NonNegativeInteger=NonNegativeInteger, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsInvInputVoltage=matStsInvInputVoltage, matStsRuntime=matStsRuntime, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsFanFault=matStsFanFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContactString=matDryContactString, matStsFirmwareVersion=matStsFirmwareVersion, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvFault=matInvFault, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, ppc=ppc, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matDryContactTable=matDryContactTable, matInvEEPROMFault=matInvEEPROMFault, matConCommunicationLost=matConCommunicationLost, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvOverLoad=matInvOverLoad, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsModuleType=matStsModuleType, matInvMainUnavailable=matInvMainUnavailable)
