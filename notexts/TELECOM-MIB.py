...
ModuleIdentity, iso, MibIdentifier, ObjectIdentity, enterprises, Counter64, Gauge32, NotificationType, Bits, TimeTicks, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter64", "Gauge32", "NotificationType", "Bits", "TimeTicks", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapType=matTrapType, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsHardwareVersion=matStsHardwareVersion, matStsStatus=matStsStatus, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, PositiveInteger=PositiveInteger, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsOverLoad=matStsOverLoad, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matSts=matSts, matInvMainUnavailable=matInvMainUnavailable, matStsInvBypassMode=matStsInvBypassMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matStsFaultMode=matStsFaultMode, matInvOutputVoltLow=matInvOutputVoltLow, matConBatteryLow=matConBatteryLow, matAgent=matAgent, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvBypassSCRShort=matInvBypassSCRShort, matInvSerialNum=matInvSerialNum, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargets=matTrapTargets, matStsTable=matStsTable, matTrapTargetsAddress=matTrapTargetsAddress, matInvFirmwareVersion=matInvFirmwareVersion, matStsMainsFail=matStsMainsFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvPriority=matInvPriority, matInvSoftStartFail=matInvSoftStartFail, matInvMaintenaceBypass=matInvMaintenaceBypass, matConCanBusOff=matConCanBusOff, matStsOutputShortCircuit=matStsOutputShortCircuit, matConCommunicationLost=matConCommunicationLost, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvPhaseType=matInvPhaseType, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, device=device, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOverLoad=matInvOverLoad, matInvOutputPower=matInvOutputPower, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsIndex=matTrapTargetsIndex, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTraps=matTraps, matStsModuleNum=matStsModuleNum, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvRunTime=matInvRunTime, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvWarningState=matInvWarningState, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvModuleIndex=matInvModuleIndex, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMbsStatus=matStsMbsStatus, matStsMainInputFreq=matStsMainInputFreq, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargetsDesc=matTrapTargetsDesc, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConEEPROMFault=matConEEPROMFault, matStsEntry=matStsEntry, matConfInvSysPriority=matConfInvSysPriority, matStsTemperatureHigh=matStsTemperatureHigh, matConWarningState=matConWarningState, matInvLineVoltage=matInvLineVoltage, matConfStsPriority=matConfStsPriority, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matDryContactEntry=matDryContactEntry, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsFanFault=matStsFanFault, matDryContact=matDryContact, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvFault=matInvFault, matStsInvInputFreq=matStsInvInputFreq, matInvEEPROMFault=matInvEEPROMFault, matInvOutputFreq=matInvOutputFreq, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, NonNegativeInteger=NonNegativeInteger, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsMBSPosFault=matStsMBSPosFault, matStsModuleIndex=matStsModuleIndex, matInvModuleNum=matInvModuleNum, matStsOutputPower=matStsOutputPower, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvFault=matReturnFromInvFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsInvFail=matStsInvFail, matInvBusSoftFail=matInvBusSoftFail, matDryContactString=matDryContactString, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputShort=matInvOutputShort, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvPulseFault=matInvPulseFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsRunningMode=matStsRunningMode, matConSerialNum=matConSerialNum, matInvEPOShutdown=matInvEPOShutdown, matInvMBSPosError=matInvMBSPosError, matInvLineFreq=matInvLineFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysInputVolt=matConfInvSysInputVolt, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvTempPowerLimit=matInvTempPowerLimit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputFreq=matStsOutputFreq, matDryContactNum=matDryContactNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvNotRespond=matInvNotRespond, matConfig=matConfig, matInvOutputVoltage=matInvOutputVoltage, matConTemperatureHigh=matConTemperatureHigh, matConfStsFanSpeed=matConfStsFanSpeed, matInvPowerLimit=matInvPowerLimit, matStsOutputCurrent=matStsOutputCurrent, matInvOutputCurrent=matInvOutputCurrent, matStsControlPowerFail=matStsControlPowerFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvHardwareError=matInvHardwareError, matStsModuleType=matStsModuleType, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapTargetsEntry=matTrapTargetsEntry, matStsEEPROMFault=matStsEEPROMFault, matObjects=matObjects, matConName=matConName, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, ppc=ppc, matInvRunMode=matInvRunMode, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsOutputVoltage=matStsOutputVoltage, matController=matController, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsTemperature=matStsTemperature, matInvTemperature=matInvTemperature, matStsFirmwareVersion=matStsFirmwareVersion, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsNotRespond=matStsNotRespond, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvHardwareVersion=matInvHardwareVersion, matConTemperature=matConTemperature, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvFanFault=matInvFanFault, matInvInputAbnormal=matInvInputAbnormal, matStsSerialNum=matStsSerialNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvOnOffStatus=matInvOnOffStatus, matStsOutputAbnormal=matStsOutputAbnormal, matDryContactTable=matDryContactTable, matInvTable=matInvTable, matConfInvOutputFreq=matConfInvOutputFreq, matTrapTargetsTable=matTrapTargetsTable, matStsRuntime=matStsRuntime, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvTemperatureHigh=matInvTemperatureHigh, matDryContactIndex=matDryContactIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvMbsPosition=matInvMbsPosition, matTrapTargetsNum=matTrapTargetsNum, matStsWarningState=matStsWarningState, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvEntry=matInvEntry, matInverter=matInverter, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit)
