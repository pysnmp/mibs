...
MibIdentifier, NotificationType, NotificationType, Counter32, Unsigned32, iso, TimeTicks, ObjectIdentity, Integer32, Gauge32, enterprises, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "NotificationType", "Counter32", "Unsigned32", "iso", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "enterprises", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMbsStatus=matStsMbsStatus, matTrapTargets=matTrapTargets, matStsInvFail=matStsInvFail, matInvOutputVoltage=matInvOutputVoltage, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsModuleType=matStsModuleType, matReturnFromInvFanFault=matReturnFromInvFanFault, NonNegativeInteger=NonNegativeInteger, matStsTable=matStsTable, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matDryContactEntry=matDryContactEntry, matInvMbsPosition=matInvMbsPosition, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfStsFanSpeed=matConfStsFanSpeed, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, ppc=ppc, matInvRunTime=matInvRunTime, matStsOutputPower=matStsOutputPower, matConfStsPriority=matConfStsPriority, matInvHardwareError=matInvHardwareError, matConfInvOutputFreq=matConfInvOutputFreq, matInvWarningState=matInvWarningState, matInvFault=matInvFault, matConWarningState=matConWarningState, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapSeverityLevel=matTrapSeverityLevel, matInvOutputVoltLow=matInvOutputVoltLow, matInvModuleNum=matInvModuleNum, matController=matController, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsFaultMode=matStsFaultMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvBypassSCRShort=matInvBypassSCRShort, matInvFanFault=matInvFanFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConSerialNum=matConSerialNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsTemperature=matStsTemperature, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfig=matConfig, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvTable=matInvTable, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsStatus=matStsStatus, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvLineVoltage=matInvLineVoltage, matInvLineFreq=matInvLineFreq, matInvPhaseType=matInvPhaseType, matInvMainUnavailable=matInvMainUnavailable, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matDryContactNum=matDryContactNum, matTrapType=matTrapType, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvOnOffStatus=matInvOnOffStatus, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsWarningState=matStsWarningState, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsBypassUnavailable=matStsBypassUnavailable, matSts=matSts, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTraps=matTraps, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapTargetsEntry=matTrapTargetsEntry, matStsFanFault=matStsFanFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTempPowerLimit=matInvTempPowerLimit, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvFault=matReturnFromInvFault, matTrapTargetsNum=matTrapTargetsNum, matStsOutputFreq=matStsOutputFreq, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsModuleNum=matStsModuleNum, matStsInvInputVoltage=matStsInvInputVoltage, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matConTemperature=matConTemperature, matInvOutputShort=matInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvInputAbnormal=matInvInputAbnormal, matInvOutputCurrent=matInvOutputCurrent, matConTemperatureHigh=matConTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPulseFault=matInvPulseFault, matTrapTargetsAddress=matTrapTargetsAddress, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputPower=matInvOutputPower, matInvOutputFreq=matInvOutputFreq, matDryContactTable=matDryContactTable, matConEEPROMFault=matConEEPROMFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsMainInputVoltage=matStsMainInputVoltage, matAgent=matAgent, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvHardwareError=matReturnFromInvHardwareError, device=device, matStsRunningMode=matStsRunningMode, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConName=matConName, matInvPriority=matInvPriority, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOverLoad=matStsOverLoad, matStsSerialNum=matStsSerialNum, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInverter=matInverter, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysPriority=matConfInvSysPriority, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsModuleIndex=matStsModuleIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matDryContactString=matDryContactString, matInvRunMode=matInvRunMode, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvHardwareVersion=matInvHardwareVersion, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsEEPROMFault=matStsEEPROMFault, matObjects=matObjects, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvNotRespond=matInvNotRespond, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsOutputVoltage=matStsOutputVoltage, matStsEntry=matStsEntry, matTrapTargetsDesc=matTrapTargetsDesc, matInvOverLoad=matInvOverLoad, matStsInvBypassMode=matStsInvBypassMode, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsTable=matTrapTargetsTable, matConCanBusOff=matConCanBusOff, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainsFail=matStsMainsFail, matStsOutputCurrent=matStsOutputCurrent, matConCommunicationLost=matConCommunicationLost, matDryContactIndex=matDryContactIndex, matInvEntry=matInvEntry, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvMBSPosError=matInvMBSPosError, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsNotRespond=matStsNotRespond, matInvSerialNum=matInvSerialNum, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, PositiveInteger=PositiveInteger, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConBatteryLow=matConBatteryLow, matInvTemperature=matInvTemperature, matInvPowerLimit=matInvPowerLimit, matInvBusSoftFail=matInvBusSoftFail, matDryContact=matDryContact, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsRuntime=matStsRuntime, matInvEPOShutdown=matInvEPOShutdown, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvFirmwareVersion=matInvFirmwareVersion)
