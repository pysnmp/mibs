...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, NotificationType, TimeTicks, Gauge32, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, ModuleIdentity, Counter32, IpAddress, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter32", "IpAddress", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsTemperature=matStsTemperature, matStsOutputShortCircuit=matStsOutputShortCircuit, matConTemperature=matConTemperature, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsOutputPower=matStsOutputPower, matConBatteryLow=matConBatteryLow, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matTrapTargetsIndex=matTrapTargetsIndex, matInverter=matInverter, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvOnOffStatus=matInvOnOffStatus, matStsTemperatureHigh=matStsTemperatureHigh, matTrapTargets=matTrapTargets, matInvPriority=matInvPriority, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsModuleNum=matStsModuleNum, matTraps=matTraps, matInvBatteryVoltage=matInvBatteryVoltage, matDryContactEntry=matDryContactEntry, matConfInvOutputFreq=matConfInvOutputFreq, matInvLowInputShutdown=matInvLowInputShutdown, matStsBypassUnavailable=matStsBypassUnavailable, matStsEEPROMFault=matStsEEPROMFault, matStsEntry=matStsEntry, matConfStsPriority=matConfStsPriority, matInvInputAbnormal=matInvInputAbnormal, matStsInvInputVoltage=matStsInvInputVoltage, matStsOutputCurrent=matStsOutputCurrent, matStsWarningState=matStsWarningState, matInvFirmwareVersion=matInvFirmwareVersion, matStsRunningMode=matStsRunningMode, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysPriority=matConfInvSysPriority, matStsOverLoad=matStsOverLoad, matConEEPROMFault=matConEEPROMFault, matStsInvFail=matStsInvFail, matConSerialNum=matConSerialNum, matStsMainInputFreq=matStsMainInputFreq, matInvEEPROMFault=matInvEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvWarningState=matInvWarningState, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsFanFault=matStsFanFault, device=device, matInvOutputPower=matInvOutputPower, matConfig=matConfig, matInvEntry=matInvEntry, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvOverLoad=matInvOverLoad, matDryContactString=matDryContactString, matInvBusSoftFail=matInvBusSoftFail, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsAddress=matTrapTargetsAddress, matConCanBusOff=matConCanBusOff, matInvOutputShort=matInvOutputShort, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConTemperatureHigh=matConTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvHardwareVersion=matInvHardwareVersion, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvFault=matReturnFromInvFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsInvBypassMode=matStsInvBypassMode, matInvLineVoltage=matInvLineVoltage, matInvSerialNum=matInvSerialNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvRunMode=matInvRunMode, matAgent=matAgent, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvHardwareError=matInvHardwareError, matStsMainsFail=matStsMainsFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsStatus=matStsStatus, matInvNegativePowerProtect=matInvNegativePowerProtect, matDryContactNum=matDryContactNum, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConName=matConName, matDryContact=matDryContact, matStsRuntime=matStsRuntime, matInvLineFreq=matInvLineFreq, matInvPulseFault=matInvPulseFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvModuleNum=matInvModuleNum, matInvBypassSCRShort=matInvBypassSCRShort, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvFanFault=matInvFanFault, matStsMainInputVoltage=matStsMainInputVoltage, matTrapTargetsEntry=matTrapTargetsEntry, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsSerialNum=matStsSerialNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvEPOShutdown=matInvEPOShutdown, matInvMBSPosError=matInvMBSPosError, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapTargetsTable=matTrapTargetsTable, matStsModuleType=matStsModuleType, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matStsMbsStatus=matStsMbsStatus, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvNotRespond=matInvNotRespond, matStsFaultMode=matStsFaultMode, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvOutputFreq=matInvOutputFreq, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsOutputVoltage=matStsOutputVoltage, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltage=matInvOutputVoltage, matStsTable=matStsTable, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvTable=matInvTable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matController=matController, matStsModuleIndex=matStsModuleIndex, matObjects=matObjects, matInvRunTime=matInvRunTime, PositiveInteger=PositiveInteger, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputFreq=matStsOutputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvModuleIndex=matInvModuleIndex, NonNegativeInteger=NonNegativeInteger, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matDryContactIndex=matDryContactIndex, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContactTable=matDryContactTable, matConfStsFanSpeed=matConfStsFanSpeed, matTrapType=matTrapType, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvTemperatureHigh=matInvTemperatureHigh, matSts=matSts, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsMBSPosFault=matStsMBSPosFault, matConCommunicationLost=matConCommunicationLost, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matTrapTargetsNum=matTrapTargetsNum, matInvPowerLimit=matInvPowerLimit, matInvFault=matInvFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, ppc=ppc, matInvTemperature=matInvTemperature, matInvMbsPosition=matInvMbsPosition, matInvPhaseType=matInvPhaseType, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConWarningState=matConWarningState, matStsNotRespond=matStsNotRespond, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass)
