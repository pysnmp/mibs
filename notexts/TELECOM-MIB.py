...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsEEPROMFault=matStsEEPROMFault, matInvFirmwareVersion=matInvFirmwareVersion, matStsOutputCurrent=matStsOutputCurrent, matInvLineVoltage=matInvLineVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvInputFreq=matStsInvInputFreq, matStsModuleType=matStsModuleType, NonNegativeInteger=NonNegativeInteger, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvFault=matReturnFromInvFault, matStsControlPowerFail=matStsControlPowerFail, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsFaultMode=matStsFaultMode, matStsTemperatureHigh=matStsTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsOutputAbnormal=matStsOutputAbnormal, matConCanBusOff=matConCanBusOff, matInvMainUnavailable=matInvMainUnavailable, matInvEntry=matInvEntry, matInvRunMode=matInvRunMode, matConfStsPriority=matConfStsPriority, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvEEPROMFault=matInvEEPROMFault, ppc=ppc, matInvSerialNum=matInvSerialNum, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsModuleNum=matStsModuleNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvOutputShort=matInvOutputShort, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContactTable=matDryContactTable, matInvMbsPosition=matInvMbsPosition, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvMBSPosError=matInvMBSPosError, device=device, matStsOverLoad=matStsOverLoad, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvNotRespond=matInvNotRespond, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfig=matConfig, matStsFanFault=matStsFanFault, matStsRuntime=matStsRuntime, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvTable=matInvTable, matDryContactString=matDryContactString, matInvLineFreq=matInvLineFreq, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOutputPower=matStsOutputPower, matStsMBSPosFault=matStsMBSPosFault, matInvInputAbnormal=matInvInputAbnormal, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConTemperatureHigh=matConTemperatureHigh, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matSts=matSts, matTraps=matTraps, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matObjects=matObjects, matStsWarningState=matStsWarningState, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvOnOffStatus=matInvOnOffStatus, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsFanSpeed=matConfStsFanSpeed, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsMainsFail=matStsMainsFail, matConName=matConName, matInvNegativePowerProtect=matInvNegativePowerProtect, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvPulseFault=matInvPulseFault, matStsOutputFreq=matStsOutputFreq, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvPowerLimit=matInvPowerLimit, matInvHardwareError=matInvHardwareError, matStsInvFail=matStsInvFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvOutputFreq=matInvOutputFreq, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsTable=matStsTable, matInvWarningState=matInvWarningState, matStsEntry=matStsEntry, matStsSerialNum=matStsSerialNum, matInvOutputVoltLow=matInvOutputVoltLow, matStsModuleIndex=matStsModuleIndex, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConSerialNum=matConSerialNum, matStsNotRespond=matStsNotRespond, matStsMbsStatus=matStsMbsStatus, matConEEPROMFault=matConEEPROMFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargets=matTrapTargets, matDryContactEntry=matDryContactEntry, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConBatteryLow=matConBatteryLow, matConTemperature=matConTemperature, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, PositiveInteger=PositiveInteger, matTrapSeverityLevel=matTrapSeverityLevel, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputVoltage=matInvOutputVoltage, matConCommunicationLost=matConCommunicationLost, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsHardwareVersion=matStsHardwareVersion, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvTemperature=matInvTemperature, matTrapTargetsCommunity=matTrapTargetsCommunity, matTrapType=matTrapType, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matStsStatus=matStsStatus, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matAgent=matAgent, matInvOutputPower=matInvOutputPower, matStsMainInputVoltage=matStsMainInputVoltage, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInverter=matInverter, matStsOutputVoltage=matStsOutputVoltage, matInvRunTime=matInvRunTime, matInvFault=matInvFault, matStsFirmwareVersion=matStsFirmwareVersion, matConWarningState=matConWarningState, matDryContact=matDryContact, matDryContactNum=matDryContactNum, matStsTemperature=matStsTemperature, matInvPhaseType=matInvPhaseType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvBypassSCRShort=matInvBypassSCRShort, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvBatteryVoltage=matInvBatteryVoltage, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsRunningMode=matStsRunningMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matController=matController, matTrapTargetsAddress=matTrapTargetsAddress, matInvOverLoad=matInvOverLoad, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvPriority=matInvPriority, matDryContactIndex=matDryContactIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matTrapTargetsTable=matTrapTargetsTable, matStsInvInputVoltage=matStsInvInputVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvModuleIndex=matInvModuleIndex, matInvFanFault=matInvFanFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvSoftStartFail=matInvSoftStartFail, matTrapTargetsDesc=matTrapTargetsDesc)
