...
iso, Integer32, enterprises, TimeTicks, Counter64, Gauge32, NotificationType, Counter32, Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "enterprises", "TimeTicks", "Counter64", "Gauge32", "NotificationType", "Counter32", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsCommunity=matTrapTargetsCommunity, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOutputFreq=matInvOutputFreq, matDryContact=matDryContact, matTrapTargetsNum=matTrapTargetsNum, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matTrapType=matTrapType, matConSerialNum=matConSerialNum, matTrapTargets=matTrapTargets, matStsTemperatureHigh=matStsTemperatureHigh, matStsOutputCurrent=matStsOutputCurrent, matConWarningState=matConWarningState, matConfInvOutputPower=matConfInvOutputPower, matStsEEPROMFault=matStsEEPROMFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matTrapTargetsTable=matTrapTargetsTable, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsDesc=matTrapTargetsDesc, matInvModuleNum=matInvModuleNum, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvInputAbnormal=matInvInputAbnormal, matStsRuntime=matStsRuntime, matInvHardwareVersion=matInvHardwareVersion, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsBypassUnavailable=matStsBypassUnavailable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsNotRespond=matStsNotRespond, matInvMbsPosition=matInvMbsPosition, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsTable=matStsTable, matInvPulseFault=matInvPulseFault, matInvPowerLimit=matInvPowerLimit, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOverLoad=matStsOverLoad, matConBatteryLow=matConBatteryLow, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matStsMainInputFreq=matStsMainInputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvTable=matInvTable, matDryContactString=matDryContactString, matDryContactTable=matDryContactTable, matTraps=matTraps, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusSoftFail=matInvBusSoftFail, matInvSoftStartFail=matInvSoftStartFail, matInvRunTime=matInvRunTime, matStsFaultMode=matStsFaultMode, matConfStsFanSpeed=matConfStsFanSpeed, matInvFanFault=matInvFanFault, matConCommunicationLost=matConCommunicationLost, matInvTempPowerLimit=matInvTempPowerLimit, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsRunningMode=matStsRunningMode, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvRunMode=matInvRunMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvFault=matReturnFromInvFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matAgent=matAgent, matStsControlPowerFail=matStsControlPowerFail, matConTemperature=matConTemperature, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBatteryVoltage=matInvBatteryVoltage, matStsMbsStatus=matStsMbsStatus, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFanFault=matReturnFromStsFanFault, matConCanBusOff=matConCanBusOff, matInvOverLoad=matInvOverLoad, matStsModuleNum=matStsModuleNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvPriority=matInvPriority, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvOutputVoltage=matConfInvOutputVoltage, matInverter=matInverter, matInvPhaseType=matInvPhaseType, matInvOutputVoltLow=matInvOutputVoltLow, matStsWarningState=matStsWarningState, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOutputShortCircuit=matStsOutputShortCircuit, NonNegativeInteger=NonNegativeInteger, matTrapTargetsEntry=matTrapTargetsEntry, ppc=ppc, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, device=device, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsOutputAbnormal=matStsOutputAbnormal, matInvModuleIndex=matInvModuleIndex, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsEntry=matStsEntry, matStsTemperature=matStsTemperature, matInvLineVoltage=matInvLineVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matDryContactNum=matDryContactNum, matStsModuleIndex=matStsModuleIndex, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvOutputCurrent=matInvOutputCurrent, matInvMBSPosError=matInvMBSPosError, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvWarningState=matInvWarningState, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvSysPriority=matConfInvSysPriority, matStsModuleType=matStsModuleType, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsFanFault=matStsFanFault, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsOutputVoltage=matStsOutputVoltage, matStsOutputPower=matStsOutputPower, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvTemperature=matInvTemperature, matInvEntry=matInvEntry, matInvLineFreq=matInvLineFreq, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matController=matController, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvOutputShort=matInvOutputShort, matStsStatus=matStsStatus, matInvEPOShutdown=matInvEPOShutdown, matInvLowInputShutdown=matInvLowInputShutdown, matConfStsPriority=matConfStsPriority, matStsInvInputVoltage=matStsInvInputVoltage, matStsHardwareVersion=matStsHardwareVersion, PositiveInteger=PositiveInteger, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsIndex=matTrapTargetsIndex, matStsFirmwareVersion=matStsFirmwareVersion, matSts=matSts, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOutputPower=matInvOutputPower, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputFreq=matStsOutputFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConName=matConName, matTrapTargetsAddress=matTrapTargetsAddress, matInvFault=matInvFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvNotRespond=matInvNotRespond, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvEEPROMFault=matInvEEPROMFault, matInvSerialNum=matInvSerialNum, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsSerialNum=matStsSerialNum, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matAgentSoftwareVerison=matAgentSoftwareVerison, matConEEPROMFault=matConEEPROMFault, matStsInvFail=matStsInvFail, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matDryContactEntry=matDryContactEntry, matDryContactIndex=matDryContactIndex, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsMainsFail=matStsMainsFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltage=matInvOutputVoltage, matInvHardwareError=matInvHardwareError, matStsMBSPosFault=matStsMBSPosFault, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvFanFault=matReturnFromInvFanFault, matObjects=matObjects, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfig=matConfig, matReturnFromCommunicationLost=matReturnFromCommunicationLost)
