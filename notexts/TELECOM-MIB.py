...
enterprises, Counter64, Unsigned32, MibIdentifier, Integer32, iso, NotificationType, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Gauge32, Counter32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "iso", "NotificationType", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("TELECOM-MIB", matSts=matSts, matObjects=matObjects, matTrapTargets=matTrapTargets, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOutputVoltage=matStsOutputVoltage, matStsTable=matStsTable, matStsOutputPower=matStsOutputPower, matInvLineVoltage=matInvLineVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsSerialNum=matStsSerialNum, matStsWarningState=matStsWarningState, matTrapTargetsNum=matTrapTargetsNum, PositiveInteger=PositiveInteger, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConCanBusOff=matConCanBusOff, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfStsFanSpeed=matConfStsFanSpeed, matInvRunMode=matInvRunMode, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvMainUnavailable=matInvMainUnavailable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvTemperatureHigh=matInvTemperatureHigh, NonNegativeInteger=NonNegativeInteger, matTrapTargetsDesc=matTrapTargetsDesc, matInvOutputVoltage=matInvOutputVoltage, matConfInvInputVoltage=matConfInvInputVoltage, matConfStsPriority=matConfStsPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsEntry=matStsEntry, matInvFirmwareVersion=matInvFirmwareVersion, matStsTemperatureHigh=matStsTemperatureHigh, matStsTemperature=matStsTemperature, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargetsTable=matTrapTargetsTable, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputPower=matInvOutputPower, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMBSPosError=matInvMBSPosError, matInvPriority=matInvPriority, matInvWarningState=matInvWarningState, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvNotRespond=matInvNotRespond, matInvPulseFault=matInvPulseFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMBSPosFault=matStsMBSPosFault, matInvModuleNum=matInvModuleNum, matInvSerialNum=matInvSerialNum, matDryContactString=matDryContactString, matDryContactIndex=matDryContactIndex, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTempPowerLimit=matInvTempPowerLimit, matInvTemperature=matInvTemperature, matConName=matConName, matConSerialNum=matConSerialNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvRunTime=matInvRunTime, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsInvFail=matStsInvFail, device=device, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matDryContactEntry=matDryContactEntry, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsEntry=matTrapTargetsEntry, matInvLineFreq=matInvLineFreq, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContactNum=matDryContactNum, matStsControlPowerFail=matStsControlPowerFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matInvBusSoftFail=matInvBusSoftFail, matStsModuleNum=matStsModuleNum, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsRunningMode=matStsRunningMode, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsInvInputVoltage=matStsInvInputVoltage, matInvHardwareError=matInvHardwareError, matInvFault=matInvFault, matStsOutputFreq=matStsOutputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsRuntime=matStsRuntime, matConfig=matConfig, ppc=ppc, matReturnFromInvFanFault=matReturnFromInvFanFault, matConEEPROMFault=matConEEPROMFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsModuleType=matStsModuleType, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvInputAbnormal=matInvInputAbnormal, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matDryContactTable=matDryContactTable, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConWarningState=matConWarningState, matTrapSeverityLevel=matTrapSeverityLevel, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matDryContact=matDryContact, matInvOutputShort=matInvOutputShort, matStsInvBypassMode=matStsInvBypassMode, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsModuleIndex=matStsModuleIndex, matConBatteryLow=matConBatteryLow, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsMainsFail=matStsMainsFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConTemperature=matConTemperature, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvFault=matReturnFromInvFault, matInvPowerLimit=matInvPowerLimit, matInvEntry=matInvEntry, matInvEEPROMFault=matInvEEPROMFault, matStsNotRespond=matStsNotRespond, matConTemperatureHigh=matConTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matStsEEPROMFault=matStsEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvPhaseType=matInvPhaseType, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvEPOShutdown=matInvEPOShutdown, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInverter=matInverter, matInvBatteryVoltage=matInvBatteryVoltage, matStsHardwareVersion=matStsHardwareVersion, matController=matController, matTraps=matTraps, matStsMainInputFreq=matStsMainInputFreq, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvOverLoad=matInvOverLoad, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysPriority=matConfInvSysPriority, matInvMbsPosition=matInvMbsPosition, matInvOutputCurrent=matInvOutputCurrent, matTrapTargetsIndex=matTrapTargetsIndex, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matAgent=matAgent, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsFaultMode=matStsFaultMode, matInvModuleIndex=matInvModuleIndex, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvTable=matInvTable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsStatus=matStsStatus, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsOverLoad=matStsOverLoad, matStsFanFault=matStsFanFault, matInvOutputFreq=matInvOutputFreq, matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matInvFanFault=matInvFanFault, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapType=matTrapType, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault)
