...
mibBuilder.exportSymbols("TELECOM-MIB", matInvTemperature=matInvTemperature, matTrapTargetsAddress=matTrapTargetsAddress, matInvInputAbnormal=matInvInputAbnormal, matConfInvOutputPower=matConfInvOutputPower, matStsMainInputFreq=matStsMainInputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, device=device, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMBSPosFault=matStsMBSPosFault, matInvEntry=matInvEntry, matInvSerialNum=matInvSerialNum, matStsOverLoad=matStsOverLoad, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matDryContactEntry=matDryContactEntry, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvModuleNum=matInvModuleNum, matStsMainInputVoltage=matStsMainInputVoltage, matDryContactString=matDryContactString, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsInvFail=matStsInvFail, matInvModuleIndex=matInvModuleIndex, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsEntry=matTrapTargetsEntry, matController=matController, matInvOutputFreq=matInvOutputFreq, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvLineFreq=matInvLineFreq, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConTemperatureHigh=matConTemperatureHigh, matDryContactIndex=matDryContactIndex, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvPhaseType=matInvPhaseType, matInvOutputPower=matInvOutputPower, matDryContactNum=matDryContactNum, matStsModuleIndex=matStsModuleIndex, matStsFanFault=matStsFanFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsTable=matStsTable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConCommunicationLost=matConCommunicationLost, matStsEntry=matStsEntry, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvFault=matInvFault, matInvOutputVoltage=matInvOutputVoltage, matStsWarningState=matStsWarningState, matInvMainUnavailable=matInvMainUnavailable, matInvFirmwareVersion=matInvFirmwareVersion, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvOutputShort=matInvOutputShort, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvLowInputShutdown=matInvLowInputShutdown, matStsModuleType=matStsModuleType, matConfInvOutputFreq=matConfInvOutputFreq, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsEEPROMFault=matStsEEPROMFault, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvPriority=matInvPriority, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvBypassSCRShort=matInvBypassSCRShort, matInvHardwareError=matInvHardwareError, matInvTempPowerLimit=matInvTempPowerLimit, matInvLineVoltage=matInvLineVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matSts=matSts, matStsOutputVoltage=matStsOutputVoltage, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvPowerLimit=matInvPowerLimit, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsTemperatureHigh=matStsTemperatureHigh, PositiveInteger=PositiveInteger, matConSerialNum=matConSerialNum, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvWarningState=matInvWarningState, matStsNotRespond=matStsNotRespond, matTrapTargetsNum=matTrapTargetsNum, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matObjects=matObjects, matStsFaultMode=matStsFaultMode, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvOutputCurrent=matInvOutputCurrent, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvRunMode=matInvRunMode, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvEPOShutdown=matInvEPOShutdown, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvInputFreq=matStsInvInputFreq, matInvOnOffStatus=matInvOnOffStatus, matInvPulseFault=matInvPulseFault, matInvEEPROMFault=matInvEEPROMFault, matDryContact=matDryContact, ppc=ppc, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvFanFault=matInvFanFault, matInvNotRespond=matInvNotRespond, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfStsPriority=matConfStsPriority, matStsMainsFail=matStsMainsFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfStsFanSpeed=matConfStsFanSpeed, matStsRuntime=matStsRuntime, matInvOverLoad=matInvOverLoad, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvTable=matInvTable, matConfig=matConfig, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matDryContactTable=matDryContactTable, matAgent=matAgent, matTrapTargets=matTrapTargets, matTrapType=matTrapType, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTraps=matTraps, matStsFirmwareVersion=matStsFirmwareVersion, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsRunningMode=matStsRunningMode, matConName=matConName, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvHardwareVersion=matInvHardwareVersion, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsModuleNum=matStsModuleNum, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvRunTime=matInvRunTime, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, NonNegativeInteger=NonNegativeInteger, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInverter=matInverter, matTrapTargetsTable=matTrapTargetsTable, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOutputPower=matStsOutputPower, matStsOutputFreq=matStsOutputFreq, matConfInvSysPriority=matConfInvSysPriority, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvMBSPosError=matInvMBSPosError, matStsOutputCurrent=matStsOutputCurrent, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMbsStatus=matStsMbsStatus, matInvOutputVoltHigh=matInvOutputVoltHigh, matConCanBusOff=matConCanBusOff, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvMbsPosition=matInvMbsPosition, matStsInvInputVoltage=matStsInvInputVoltage, matStsTemperature=matStsTemperature, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConBatteryLow=matConBatteryLow, matStsSerialNum=matStsSerialNum, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConEEPROMFault=matConEEPROMFault, matConTemperature=matConTemperature, matReturnFromInvFault=matReturnFromInvFault, matConWarningState=matConWarningState, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsStatus=matStsStatus)
