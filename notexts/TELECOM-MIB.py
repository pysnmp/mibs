...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvLowInputShutdown=matInvLowInputShutdown, matStsModuleIndex=matStsModuleIndex, matDryContactTable=matDryContactTable, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvWarningState=matInvWarningState, matDryContact=matDryContact, matTrapType=matTrapType, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvModuleIndex=matInvModuleIndex, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matTraps=matTraps, matStsControlPowerFail=matStsControlPowerFail, device=device, matReturnFromStsInvFail=matReturnFromStsInvFail, matConBatteryLow=matConBatteryLow, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsEntry=matStsEntry, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfig=matConfig, matInvOutputVoltLow=matInvOutputVoltLow, matInvMbsPosition=matInvMbsPosition, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matAgent=matAgent, matInvModuleNum=matInvModuleNum, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvPhaseType=matInvPhaseType, matStsInvInputVoltage=matStsInvInputVoltage, matInvInputAbnormal=matInvInputAbnormal, matTrapTargetsEntry=matTrapTargetsEntry, matInvTemperatureHigh=matInvTemperatureHigh, matDryContactNum=matDryContactNum, matConSerialNum=matConSerialNum, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvHardwareError=matInvHardwareError, NonNegativeInteger=NonNegativeInteger, matConWarningState=matConWarningState, matStsOutputFreq=matStsOutputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsTemperatureHigh=matStsTemperatureHigh, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matSts=matSts, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargets=matTrapTargets, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvOutputShort=matInvOutputShort, matInvLineVoltage=matInvLineVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matDryContactString=matDryContactString, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvFault=matInvFault, matStsOverLoad=matStsOverLoad, matStsTemperature=matStsTemperature, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConCanBusOff=matConCanBusOff, matStsMbsStatus=matStsMbsStatus, matInvEEPROMFault=matInvEEPROMFault, matStsStatus=matStsStatus, matInvPowerLimit=matInvPowerLimit, matInvSerialNum=matInvSerialNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsFanFault=matReturnFromStsFanFault, ppc=ppc, matInvOverLoad=matInvOverLoad, matConTemperatureHigh=matConTemperatureHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvEPOShutdown=matInvEPOShutdown, matStsRunningMode=matStsRunningMode, matStsHardwareVersion=matStsHardwareVersion, matConfInvOutputFreq=matConfInvOutputFreq, matInvFirmwareVersion=matInvFirmwareVersion, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConTemperature=matConTemperature, matConfInvOutputPower=matConfInvOutputPower, matInverter=matInverter, matStsModuleNum=matStsModuleNum, matStsInvInputFreq=matStsInvInputFreq, matInvOutputFreq=matInvOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsNum=matTrapTargetsNum, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputAbnormal=matStsOutputAbnormal, matStsFaultMode=matStsFaultMode, matInvBusSoftFail=matInvBusSoftFail, matController=matController, matConEEPROMFault=matConEEPROMFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsSerialNum=matStsSerialNum, matConfStsPriority=matConfStsPriority, matTrapTargetsIndex=matTrapTargetsIndex, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsAddress=matTrapTargetsAddress, matInvNotRespond=matInvNotRespond, matInvPriority=matInvPriority, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsInvBypassMode=matStsInvBypassMode, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, PositiveInteger=PositiveInteger, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvSysPriority=matConfInvSysPriority, matStsWarningState=matStsWarningState, matInvPulseFault=matInvPulseFault, matDryContactIndex=matDryContactIndex, matStsOutputPower=matStsOutputPower, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConName=matConName, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matTrapTargetsDesc=matTrapTargetsDesc, matStsMainsFail=matStsMainsFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvRunTime=matInvRunTime, matInvOutputPower=matInvOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsInvFail=matStsInvFail, matStsNotRespond=matStsNotRespond, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvTemperature=matInvTemperature, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputVoltage=matStsOutputVoltage, matStsRuntime=matStsRuntime, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsMainInputVoltage=matStsMainInputVoltage, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsFirmwareVersion=matStsFirmwareVersion, matInvLineFreq=matInvLineFreq, matObjects=matObjects, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvFanFault=matInvFanFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvTable=matInvTable, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvEntry=matInvEntry, matInvSoftStartFail=matInvSoftStartFail, matStsModuleType=matStsModuleType, matInvRunMode=matInvRunMode, matStsOutputCurrent=matStsOutputCurrent, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvMBSPosError=matInvMBSPosError, matStsTable=matStsTable, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsFanFault=matStsFanFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOutputVoltage=matInvOutputVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matDryContactEntry=matDryContactEntry, matStsMainInputFreq=matStsMainInputFreq, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvFault=matReturnFromInvFault)
