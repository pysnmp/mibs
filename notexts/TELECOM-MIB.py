...
Bits, enterprises, iso, Unsigned32, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter64, Counter32, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "iso", "Unsigned32", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter64", "Counter32", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvBypassMode=matStsInvBypassMode, matInvHardwareVersion=matInvHardwareVersion, matStsFanFault=matStsFanFault, matTrapTargetsEntry=matTrapTargetsEntry, matStsOutputFreq=matStsOutputFreq, matTrapSeverityLevel=matTrapSeverityLevel, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsAddress=matTrapTargetsAddress, matStsSerialNum=matStsSerialNum, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfig=matConfig, matInvTemperature=matInvTemperature, matStsMainInputVoltage=matStsMainInputVoltage, matConBatteryLow=matConBatteryLow, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matSts=matSts, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsIndex=matTrapTargetsIndex, matInvRunTime=matInvRunTime, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConTemperatureHigh=matConTemperatureHigh, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConSerialNum=matConSerialNum, matDryContactIndex=matDryContactIndex, matConfInvOutputPower=matConfInvOutputPower, matStsModuleIndex=matStsModuleIndex, matStsMainsFail=matStsMainsFail, matStsMainInputFreq=matStsMainInputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsControlPowerFail=matStsControlPowerFail, matController=matController, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvNotRespond=matInvNotRespond, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvMaintenaceBypass=matInvMaintenaceBypass, matConEEPROMFault=matConEEPROMFault, matInvFanFault=matInvFanFault, matStsNotRespond=matStsNotRespond, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvOutputCurrent=matInvOutputCurrent, matDryContactString=matDryContactString, matInvOutputVoltLow=matInvOutputVoltLow, matTrapTargets=matTrapTargets, matStsMbsStatus=matStsMbsStatus, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvFault=matInvFault, matInvModuleIndex=matInvModuleIndex, matStsEEPROMFault=matStsEEPROMFault, matInvWarningState=matInvWarningState, matInvEPOShutdown=matInvEPOShutdown, matConName=matConName, matStsStatus=matStsStatus, matConWarningState=matConWarningState, matInvOutputShort=matInvOutputShort, matInvLineFreq=matInvLineFreq, matInvOutputFreq=matInvOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputPower=matStsOutputPower, matStsRunningMode=matStsRunningMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvBusSoftFail=matInvBusSoftFail, matDryContactEntry=matDryContactEntry, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMainUnavailable=matInvMainUnavailable, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsTable=matStsTable, matInvHardwareError=matInvHardwareError, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvRunMode=matInvRunMode, matInverter=matInverter, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputPower=matInvOutputPower, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvSoftStartFail=matInvSoftStartFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, device=device, matConfInvOutputFreq=matConfInvOutputFreq, matInvBypassSCRShort=matInvBypassSCRShort, matStsOverLoad=matStsOverLoad, matInvPowerLimit=matInvPowerLimit, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matConfStsPriority=matConfStsPriority, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTrapType=matTrapType, NonNegativeInteger=NonNegativeInteger, matStsFaultMode=matStsFaultMode, matStsHardwareVersion=matStsHardwareVersion, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvSerialNum=matInvSerialNum, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsModuleNum=matStsModuleNum, matInvModuleNum=matInvModuleNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConCanBusOff=matConCanBusOff, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvMBSPosError=matInvMBSPosError, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConTemperature=matConTemperature, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvPulseFault=matInvPulseFault, matInvLineVoltage=matInvLineVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matDryContactTable=matDryContactTable, matInvTemperatureHigh=matInvTemperatureHigh, matInvOverLoad=matInvOverLoad, matObjects=matObjects, matStsRuntime=matStsRuntime, matStsModuleType=matStsModuleType, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsMaintenanceBypass=matStsMaintenanceBypass, matConCommunicationLost=matConCommunicationLost, matInvPhaseType=matInvPhaseType, matInvPriority=matInvPriority, matReturnFromInvFault=matReturnFromInvFault, ppc=ppc, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvMbsPosition=matInvMbsPosition, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matDryContactNum=matDryContactNum, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContact=matDryContact, matConfStsFanSpeed=matConfStsFanSpeed, matStsWarningState=matStsWarningState, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvEntry=matInvEntry, matStsEntry=matStsEntry, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvFail=matStsInvFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTraps=matTraps, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfInvInputVoltage=matConfInvInputVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matAgent=matAgent, matInvOutputVoltage=matInvOutputVoltage, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvTable=matInvTable, PositiveInteger=PositiveInteger, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsTemperature=matStsTemperature, matTrapTargetsDesc=matTrapTargetsDesc)
