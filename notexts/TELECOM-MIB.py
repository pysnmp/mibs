...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsOutputFreq=matStsOutputFreq, matStsTable=matStsTable, matStsRuntime=matStsRuntime, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matAgent=matAgent, matConfig=matConfig, matStsOutputPower=matStsOutputPower, matStsOutputVoltage=matStsOutputVoltage, matDryContactString=matDryContactString, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvNegativePowerProtect=matInvNegativePowerProtect, matTrapTargetsIndex=matTrapTargetsIndex, matStsFaultMode=matStsFaultMode, matInvBatteryVoltage=matInvBatteryVoltage, matStsMbsStatus=matStsMbsStatus, matDryContactEntry=matDryContactEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvTable=matInvTable, matInvSerialNum=matInvSerialNum, matInvNotRespond=matInvNotRespond, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsStatus=matStsStatus, matInverter=matInverter, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, device=device, matStsOverLoad=matStsOverLoad, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsSerialNum=matStsSerialNum, matInvFirmwareVersion=matInvFirmwareVersion, matTrapSeverityLevel=matTrapSeverityLevel, matConName=matConName, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvOutputCurrent=matInvOutputCurrent, matConfInvInputVoltage=matConfInvInputVoltage, matStsOutputCurrent=matStsOutputCurrent, matTrapType=matTrapType, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvOutputFreq=matConfInvOutputFreq, matInvOutputFreq=matInvOutputFreq, matStsControlPowerFail=matStsControlPowerFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvRunTime=matInvRunTime, matInvEntry=matInvEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvOutputPower=matInvOutputPower, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactIndex=matDryContactIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvWarningState=matInvWarningState, matStsModuleType=matStsModuleType, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvLineFreq=matInvLineFreq, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConSerialNum=matConSerialNum, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConWarningState=matConWarningState, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvPriority=matInvPriority, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsWarningState=matStsWarningState, matInvOverLoad=matInvOverLoad, matStsEEPROMFault=matStsEEPROMFault, matStsMainInputFreq=matStsMainInputFreq, matInvPhaseType=matInvPhaseType, matInvTemperature=matInvTemperature, matStsInvFail=matStsInvFail, matInvLineVoltage=matInvLineVoltage, NonNegativeInteger=NonNegativeInteger, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvBypassSCRShort=matInvBypassSCRShort, matStsEntry=matStsEntry, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvFanFault=matInvFanFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMainsFail=matStsMainsFail, matInvHardwareVersion=matInvHardwareVersion, matInvPowerLimit=matInvPowerLimit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvRunMode=matInvRunMode, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matTrapTargetsTable=matTrapTargetsTable, matInvOutputVoltLow=matInvOutputVoltLow, matInvOnOffStatus=matInvOnOffStatus, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsBypassUnavailable=matStsBypassUnavailable, matStsInvInputFreq=matStsInvInputFreq, matStsNotRespond=matStsNotRespond, matInvModuleIndex=matInvModuleIndex, matInvOutputShort=matInvOutputShort, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvInputVoltage=matStsInvInputVoltage, matInvEEPROMFault=matInvEEPROMFault, matStsModuleNum=matStsModuleNum, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvFault=matInvFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matObjects=matObjects, matStsModuleIndex=matStsModuleIndex, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConTemperature=matConTemperature, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputVoltage=matInvOutputVoltage, matStsRunningMode=matStsRunningMode, matInvModuleNum=matInvModuleNum, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matSts=matSts, matStsTemperature=matStsTemperature, matInvTempPowerLimit=matInvTempPowerLimit, PositiveInteger=PositiveInteger, matInvMbsPosition=matInvMbsPosition, matConEEPROMFault=matConEEPROMFault, matInvHardwareError=matInvHardwareError, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matController=matController, matDryContact=matDryContact, matStsHardwareVersion=matStsHardwareVersion, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargets=matTrapTargets, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargetsNum=matTrapTargetsNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvMaintenaceBypass=matInvMaintenaceBypass, matConBatteryLow=matConBatteryLow, matConfStsPriority=matConfStsPriority, matInvPulseFault=matInvPulseFault, matInvMBSPosError=matInvMBSPosError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsMainInputVoltage=matStsMainInputVoltage, matDryContactTable=matDryContactTable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, ppc=ppc, matConCanBusOff=matConCanBusOff, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysPriority=matConfInvSysPriority, matDryContactNum=matDryContactNum, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConCommunicationLost=matConCommunicationLost, matTraps=matTraps, matReturnFromInvFault=matReturnFromInvFault, matConTemperatureHigh=matConTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsFanFault=matStsFanFault)
