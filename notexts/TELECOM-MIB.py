...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTraps=matTraps, matStsTable=matStsTable, matDryContactIndex=matDryContactIndex, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsSerialNum=matStsSerialNum, matStsEntry=matStsEntry, matSts=matSts, matDryContact=matDryContact, matConfig=matConfig, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matObjects=matObjects, matStsRunningMode=matStsRunningMode, matInvTempPowerLimit=matInvTempPowerLimit, matInvSerialNum=matInvSerialNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvModuleNum=matInvModuleNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputVoltLow=matInvOutputVoltLow, matInvMainUnavailable=matInvMainUnavailable, matTrapTargetsIndex=matTrapTargetsIndex, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvLineFreq=matInvLineFreq, matDryContactTable=matDryContactTable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConTemperatureHigh=matConTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matConfInvInputVoltage=matConfInvInputVoltage, matStsMainInputFreq=matStsMainInputFreq, matInvPowerLimit=matInvPowerLimit, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConWarningState=matConWarningState, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, device=device, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConEEPROMFault=matConEEPROMFault, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matInvTable=matInvTable, matInvInputAbnormal=matInvInputAbnormal, ppc=ppc, matStsOutputAbnormal=matStsOutputAbnormal, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargets=matTrapTargets, matConfStsPriority=matConfStsPriority, matInvPulseFault=matInvPulseFault, matInvOnOffStatus=matInvOnOffStatus, matInvModuleIndex=matInvModuleIndex, matInvWarningState=matInvWarningState, matDryContactString=matDryContactString, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOverLoad=matInvOverLoad, matInvFirmwareVersion=matInvFirmwareVersion, matStsOutputPower=matStsOutputPower, matDryContactNum=matDryContactNum, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsFaultMode=matStsFaultMode, matConSerialNum=matConSerialNum, matStsNotRespond=matStsNotRespond, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvFanFault=matInvFanFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputFreq=matStsOutputFreq, matStsInvFail=matStsInvFail, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConCommunicationLost=matConCommunicationLost, matStsStatus=matStsStatus, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMBSPosFault=matStsMBSPosFault, matInverter=matInverter, matConfInvOutputFreq=matConfInvOutputFreq, matInvPhaseType=matInvPhaseType, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matInvOutputCurrent=matInvOutputCurrent, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvFault=matReturnFromInvFault, matDryContactEntry=matDryContactEntry, matStsEEPROMFault=matStsEEPROMFault, matConTemperature=matConTemperature, matInvOutputVoltage=matInvOutputVoltage, matInvFault=matInvFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matTrapTargetsTable=matTrapTargetsTable, matStsMbsStatus=matStsMbsStatus, matInvOutputFreq=matInvOutputFreq, matConfInvOutputPower=matConfInvOutputPower, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConCanBusOff=matConCanBusOff, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matStsWarningState=matStsWarningState, matTrapTargetsAddress=matTrapTargetsAddress, matTrapSeverityLevel=matTrapSeverityLevel, matStsModuleType=matStsModuleType, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvLowInputShutdown=matInvLowInputShutdown, matInvEntry=matInvEntry, matStsControlPowerFail=matStsControlPowerFail, matInvOutputPower=matInvOutputPower, NonNegativeInteger=NonNegativeInteger, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConName=matConName, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMbsPosition=matInvMbsPosition, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvTemperature=matInvTemperature, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsInvInputVoltage=matStsInvInputVoltage, matStsInvBypassMode=matStsInvBypassMode, matStsOverLoad=matStsOverLoad, matStsMainsFail=matStsMainsFail, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvRunTime=matInvRunTime, matController=matController, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPriority=matInvPriority, matStsFanFault=matStsFanFault, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvOutputShort=matInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvLineVoltage=matInvLineVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matInvHardwareError=matInvHardwareError, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapType=matTrapType, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsRuntime=matStsRuntime, matStsOutputVoltage=matStsOutputVoltage, matInvBusSoftFail=matInvBusSoftFail, matStsTemperature=matStsTemperature, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsModuleNum=matStsModuleNum, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsDesc=matTrapTargetsDesc, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvSysInputVolt=matConfInvSysInputVolt, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvNotRespond=matInvNotRespond, matAgent=matAgent, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsNum=matTrapTargetsNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConBatteryLow=matConBatteryLow, matStsHardwareVersion=matStsHardwareVersion, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvRunMode=matInvRunMode, PositiveInteger=PositiveInteger)
