...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, ObjectIdentity, iso, TimeTicks, NotificationType, Integer32, Bits, Unsigned32, Counter32, MibIdentifier, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "iso", "TimeTicks", "NotificationType", "Integer32", "Bits", "Unsigned32", "Counter32", "MibIdentifier", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargetsTable=matTrapTargetsTable, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvOverLoad=matInvOverLoad, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputPower=matConfInvOutputPower, matStsInvInputVoltage=matStsInvInputVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsModuleType=matStsModuleType, matStsInvFail=matStsInvFail, matConfInvInputVoltage=matConfInvInputVoltage, matInvModuleNum=matInvModuleNum, matStsModuleIndex=matStsModuleIndex, matTraps=matTraps, matStsInvBypassMode=matStsInvBypassMode, matInvWarningState=matInvWarningState, matStsMainInputVoltage=matStsMainInputVoltage, matInvInputAbnormal=matInvInputAbnormal, matConCanBusOff=matConCanBusOff, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, device=device, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapType=matTrapType, matStsFirmwareVersion=matStsFirmwareVersion, matConName=matConName, matStsBypassUnavailable=matStsBypassUnavailable, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvFault=matInvFault, matStsSerialNum=matStsSerialNum, matInvPulseFault=matInvPulseFault, matInvOutputCurrent=matInvOutputCurrent, matStsTemperature=matStsTemperature, matStsFanFault=matStsFanFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConBatteryLow=matConBatteryLow, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsStatus=matStsStatus, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvOutputShort=matInvOutputShort, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputVoltage=matStsOutputVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMainsFail=matStsMainsFail, matInvModuleIndex=matInvModuleIndex, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsOutputFreq=matStsOutputFreq, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvTemperatureHigh=matInvTemperatureHigh, matStsEntry=matStsEntry, matInvRunMode=matInvRunMode, matTrapTargetsAddress=matTrapTargetsAddress, matInvPhaseType=matInvPhaseType, matReturnFromInvFault=matReturnFromInvFault, matInvLineFreq=matInvLineFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConTemperatureHigh=matConTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvLowInputShutdown=matInvLowInputShutdown, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matAgent=matAgent, matInvTable=matInvTable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConWarningState=matConWarningState, matInvSerialNum=matInvSerialNum, matConfStsPriority=matConfStsPriority, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConCommunicationLost=matConCommunicationLost, matInvPriority=matInvPriority, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysPriority=matConfInvSysPriority, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsMbsStatus=matStsMbsStatus, ppc=ppc, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvBypassSCRShort=matInvBypassSCRShort, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConTemperature=matConTemperature, matInvLineVoltage=matInvLineVoltage, matDryContactString=matDryContactString, matStsNotRespond=matStsNotRespond, matStsRuntime=matStsRuntime, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactNum=matDryContactNum, matController=matController, matInvMbsPosition=matInvMbsPosition, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInverter=matInverter, matInvEEPROMFault=matInvEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsRunningMode=matStsRunningMode, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvBusSoftFail=matInvBusSoftFail, matStsModuleNum=matStsModuleNum, NonNegativeInteger=NonNegativeInteger, matStsMainInputFreq=matStsMainInputFreq, matStsTable=matStsTable, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matDryContact=matDryContact, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactEntry=matDryContactEntry, matConBatteryVoltHigh=matConBatteryVoltHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputPower=matInvOutputPower, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, PositiveInteger=PositiveInteger, matConfInvOutputFreq=matConfInvOutputFreq, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEntry=matInvEntry, matSts=matSts, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfig=matConfig, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvHardwareError=matInvHardwareError, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvRunTime=matInvRunTime, matDryContactTable=matDryContactTable, matDryContactIndex=matDryContactIndex, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapSeverityLevel=matTrapSeverityLevel, matInvOutputFreq=matInvOutputFreq, matStsOutputPower=matStsOutputPower, matStsOverLoad=matStsOverLoad, matInvNotRespond=matInvNotRespond, matStsWarningState=matStsWarningState, matInvTemperature=matInvTemperature, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsFaultMode=matStsFaultMode, matConfStsFanSpeed=matConfStsFanSpeed, matInvPowerLimit=matInvPowerLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConEEPROMFault=matConEEPROMFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matObjects=matObjects, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvOutputVoltage=matInvOutputVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsOutputAbnormal=matStsOutputAbnormal, matInvFanFault=matInvFanFault, matConSerialNum=matConSerialNum, matTrapTargets=matTrapTargets, matStsInvInputFreq=matStsInvInputFreq)
