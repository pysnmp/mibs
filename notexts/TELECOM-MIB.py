...
iso, MibIdentifier, NotificationType, Bits, ObjectIdentity, TimeTicks, Integer32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, Counter32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "Integer32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMainInputFreq=matStsMainInputFreq, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvInputAbnormal=matInvInputAbnormal, matTrapTargetsIndex=matTrapTargetsIndex, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvInputVoltage=matConfInvInputVoltage, matInvPriority=matInvPriority, matInverter=matInverter, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsTemperatureHigh=matStsTemperatureHigh, matInvHardwareError=matInvHardwareError, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvTemperatureHigh=matInvTemperatureHigh, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, matStsModuleType=matStsModuleType, matController=matController, matStsTable=matStsTable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvFanFault=matInvFanFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputVoltage=matInvOutputVoltage, matStsMaintenanceBypass=matStsMaintenanceBypass, matConName=matConName, matConTemperatureHigh=matConTemperatureHigh, matStsEntry=matStsEntry, matInvMainUnavailable=matInvMainUnavailable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvPowerLimit=matInvPowerLimit, matDryContactString=matDryContactString, NonNegativeInteger=NonNegativeInteger, matDryContactEntry=matDryContactEntry, matInvBusSoftFail=matInvBusSoftFail, matInvTable=matInvTable, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMBSPosFault=matStsMBSPosFault, matConCanBusOff=matConCanBusOff, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfStsFanSpeed=matConfStsFanSpeed, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvSoftStartFail=matInvSoftStartFail, matConEEPROMFault=matConEEPROMFault, matStsModuleIndex=matStsModuleIndex, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsInvFail=matStsInvFail, matInvModuleNum=matInvModuleNum, matTrapTargetsDesc=matTrapTargetsDesc, matInvRunTime=matInvRunTime, matStsEEPROMFault=matStsEEPROMFault, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsEntry=matTrapTargetsEntry, matStsOutputCurrent=matStsOutputCurrent, matStsStatus=matStsStatus, matConBatteryLow=matConBatteryLow, matDryContactNum=matDryContactNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matStsOutputPower=matStsOutputPower, matStsFaultMode=matStsFaultMode, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConTemperature=matConTemperature, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvRunMode=matInvRunMode, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputFreq=matInvOutputFreq, matInvWarningState=matInvWarningState, matTrapTargetsNum=matTrapTargetsNum, matStsWarningState=matStsWarningState, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapSeverityLevel=matTrapSeverityLevel, ppc=ppc, matStsFirmwareVersion=matStsFirmwareVersion, matStsFanFault=matStsFanFault, matStsOutputVoltage=matStsOutputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvMbsPosition=matInvMbsPosition, matTrapType=matTrapType, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfig=matConfig, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matObjects=matObjects, matInvFault=matInvFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvModuleIndex=matInvModuleIndex, matInvNotRespond=matInvNotRespond, matAgent=matAgent, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvEntry=matInvEntry, matStsSerialNum=matStsSerialNum, matInvMBSPosError=matInvMBSPosError, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsOverLoad=matStsOverLoad, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matConCommunicationLost=matConCommunicationLost, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, PositiveInteger=PositiveInteger, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvOutputPower=matConfInvOutputPower, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTraps=matTraps, matInvLineVoltage=matInvLineVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapTargets=matTrapTargets, matConfStsPriority=matConfStsPriority, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConSerialNum=matConSerialNum, matStsTemperature=matStsTemperature, device=device, matInvPulseFault=matInvPulseFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matSts=matSts, matConWarningState=matConWarningState, matDryContactIndex=matDryContactIndex, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvTemperature=matInvTemperature, matInvOnOffStatus=matInvOnOffStatus, matStsNotRespond=matStsNotRespond, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvFault=matReturnFromInvFault, matInvEEPROMFault=matInvEEPROMFault, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsBypassUnavailable=matStsBypassUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsOutputFreq=matStsOutputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvOutputShort=matInvOutputShort, matDryContact=matDryContact, matStsMbsStatus=matStsMbsStatus, matStsModuleNum=matStsModuleNum, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsControlPowerFail=matStsControlPowerFail, matInvOutputPower=matInvOutputPower, matStsRuntime=matStsRuntime, matInvLineFreq=matInvLineFreq, matInvOverLoad=matInvOverLoad, matStsMainsFail=matStsMainsFail, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsRunningMode=matStsRunningMode, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputFreq=matConfInvOutputFreq, matInvSerialNum=matInvSerialNum, matInvPhaseType=matInvPhaseType, matInvOutputVoltLow=matInvOutputVoltLow, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContactTable=matDryContactTable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort)
