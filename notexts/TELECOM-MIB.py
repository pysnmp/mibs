...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputFreq=matInvOutputFreq, matTrapTargetsTable=matTrapTargetsTable, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfig=matConfig, matConBatteryLow=matConBatteryLow, matInvLineFreq=matInvLineFreq, matStsInvFail=matStsInvFail, matStsControlPowerFail=matStsControlPowerFail, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConTemperatureHigh=matConTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsOverLoad=matStsOverLoad, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvModuleIndex=matInvModuleIndex, matConfStsFanSpeed=matConfStsFanSpeed, matAgent=matAgent, matStsMbsStatus=matStsMbsStatus, NonNegativeInteger=NonNegativeInteger, matInvTemperatureHigh=matInvTemperatureHigh, matConTemperature=matConTemperature, matInvOutputShort=matInvOutputShort, matInvPriority=matInvPriority, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsFirmwareVersion=matStsFirmwareVersion, matInvOverLoad=matInvOverLoad, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvMaintenaceBypass=matInvMaintenaceBypass, matController=matController, matTrapTargets=matTrapTargets, matConName=matConName, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvLineVoltage=matInvLineVoltage, matStsRuntime=matStsRuntime, matStsInvInputFreq=matStsInvInputFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvPowerLimit=matInvPowerLimit, matStsRunningMode=matStsRunningMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConWarningState=matConWarningState, matStsTable=matStsTable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContactString=matDryContactString, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBatteryVoltage=matInvBatteryVoltage, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvFault=matInvFault, matStsSerialNum=matStsSerialNum, matDryContact=matDryContact, matInvRunTime=matInvRunTime, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsEEPROMFault=matStsEEPROMFault, PositiveInteger=PositiveInteger, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfStsPriority=matConfStsPriority, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvBypassSCRShort=matInvBypassSCRShort, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputPower=matStsOutputPower, matConfInvOutputPower=matConfInvOutputPower, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsMainsFail=matStsMainsFail, matInvSerialNum=matInvSerialNum, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsTemperature=matStsTemperature, matDryContactNum=matDryContactNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvSoftStartFail=matInvSoftStartFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvWarningState=matInvWarningState, matInvPhaseType=matInvPhaseType, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvEPOShutdown=matInvEPOShutdown, matStsMainInputFreq=matStsMainInputFreq, matInvPulseFault=matInvPulseFault, matTrapTargetsNum=matTrapTargetsNum, matStsBypassUnavailable=matStsBypassUnavailable, matInvHardwareError=matInvHardwareError, matStsStatus=matStsStatus, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvMbsPosition=matInvMbsPosition, matConCommunicationLost=matConCommunicationLost, matSts=matSts, matInvFanFault=matInvFanFault, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConSerialNum=matConSerialNum, matStsEntry=matStsEntry, matInvEEPROMFault=matInvEEPROMFault, matInvEntry=matInvEntry, matConCanBusOff=matConCanBusOff, matTrapTargetsDesc=matTrapTargetsDesc, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfInvInputVoltage=matConfInvInputVoltage, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvOnOffStatus=matInvOnOffStatus, matStsMBSPosFault=matStsMBSPosFault, matDryContactIndex=matDryContactIndex, matConfInvOutputFreq=matConfInvOutputFreq, matObjects=matObjects, matTrapTargetsAddress=matTrapTargetsAddress, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvModuleNum=matInvModuleNum, matInvTemperature=matInvTemperature, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvBusSoftFail=matInvBusSoftFail, matStsModuleNum=matStsModuleNum, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsNotRespond=matStsNotRespond, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matInvRunMode=matInvRunMode, matConfInvSysPriority=matConfInvSysPriority, matStsFaultMode=matStsFaultMode, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsModuleType=matStsModuleType, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matDryContactTable=matDryContactTable, matInvTable=matInvTable, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTraps=matTraps, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputFreq=matStsOutputFreq, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsOutputVoltage=matStsOutputVoltage, matInvTempPowerLimit=matInvTempPowerLimit, matTrapType=matTrapType, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConEEPROMFault=matConEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, ppc=ppc, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsIndex=matTrapTargetsIndex, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputPower=matInvOutputPower, matDryContactEntry=matDryContactEntry, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvNotRespond=matInvNotRespond, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsFanFault=matStsFanFault, matStsWarningState=matStsWarningState, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInverter=matInverter, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvOutputCurrent=matInvOutputCurrent, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, device=device, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMBSPosError=matInvMBSPosError, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputVoltage=matInvOutputVoltage, matStsMainInputVoltage=matStsMainInputVoltage)
