...
Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, enterprises, MibIdentifier, Integer32, NotificationType, Unsigned32, Counter32, Bits, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "enterprises", "MibIdentifier", "Integer32", "NotificationType", "Unsigned32", "Counter32", "Bits", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvMainUnavailable=matInvMainUnavailable, matStsOutputVoltage=matStsOutputVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, PositiveInteger=PositiveInteger, matInvPriority=matInvPriority, matStsWarningState=matStsWarningState, matStsInvInputVoltage=matStsInvInputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvEPOShutdown=matInvEPOShutdown, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsMainsFail=matStsMainsFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvOutputCurrent=matInvOutputCurrent, matDryContactNum=matDryContactNum, matStsFanFault=matStsFanFault, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsMainInputVoltage=matStsMainInputVoltage, matStsTable=matStsTable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInverter=matInverter, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConSerialNum=matConSerialNum, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matSts=matSts, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsTemperatureHigh=matStsTemperatureHigh, matInvPhaseType=matInvPhaseType, matInvEntry=matInvEntry, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvMbsPosition=matInvMbsPosition, matInvLowInputShutdown=matInvLowInputShutdown, matConBatteryLow=matConBatteryLow, matStsStatus=matStsStatus, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvFault=matInvFault, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvHardwareVersion=matInvHardwareVersion, matInvTemperature=matInvTemperature, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvModuleNum=matInvModuleNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matDryContactString=matDryContactString, matReturnFromInvFault=matReturnFromInvFault, matDryContactTable=matDryContactTable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matDryContact=matDryContact, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConCanBusOff=matConCanBusOff, matConEEPROMFault=matConEEPROMFault, matInvTable=matInvTable, matConfig=matConfig, matStsMbsStatus=matStsMbsStatus, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matObjects=matObjects, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matTrapTargetsDesc=matTrapTargetsDesc, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsEEPROMFault=matStsEEPROMFault, matInvHardwareError=matInvHardwareError, matInvLineFreq=matInvLineFreq, matStsOverLoad=matStsOverLoad, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvInputFreq=matStsInvInputFreq, matDryContactEntry=matDryContactEntry, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConTemperature=matConTemperature, matTrapTargetsEntry=matTrapTargetsEntry, matInvModuleIndex=matInvModuleIndex, matConfStsFanSpeed=matConfStsFanSpeed, matStsFaultMode=matStsFaultMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConName=matConName, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvPowerLimit=matInvPowerLimit, matStsInvFail=matStsInvFail, matStsFirmwareVersion=matStsFirmwareVersion, matStsTemperature=matStsTemperature, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsBypassUnavailable=matStsBypassUnavailable, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsOutputPower=matStsOutputPower, matInvRunMode=matInvRunMode, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvFanFault=matInvFanFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsRunningMode=matStsRunningMode, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBusSoftFail=matInvBusSoftFail, matStsRuntime=matStsRuntime, matTraps=matTraps, matDryContactIndex=matDryContactIndex, matInvOverLoad=matInvOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matController=matController, matStsSerialNum=matStsSerialNum, matStsControlPowerFail=matStsControlPowerFail, matTrapType=matTrapType, matInvOutputFreq=matInvOutputFreq, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matTrapSeverityLevel=matTrapSeverityLevel, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsModuleType=matStsModuleType, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvOutputShort=matInvOutputShort, matStsModuleIndex=matStsModuleIndex, matInvMBSPosError=matInvMBSPosError, matInvOutputPower=matInvOutputPower, matInvRunTime=matInvRunTime, matStsNotRespond=matStsNotRespond, NonNegativeInteger=NonNegativeInteger, matInvEEPROMFault=matInvEEPROMFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvNotRespond=matInvNotRespond, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfStsPriority=matConfStsPriority, matInvPulseFault=matInvPulseFault, matInvOnOffStatus=matInvOnOffStatus, matStsInvHighLossVoltage=matStsInvHighLossVoltage, ppc=ppc, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsModuleNum=matStsModuleNum, matInvTemperatureHigh=matInvTemperatureHigh, matInvSerialNum=matInvSerialNum, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargets=matTrapTargets, matStsOutputFreq=matStsOutputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainInputFreq=matStsMainInputFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, device=device, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matAgent=matAgent, matStsEntry=matStsEntry, matTrapTargetsAddress=matTrapTargetsAddress, matInvOutputVoltage=matInvOutputVoltage, matConfInvInputVoltage=matConfInvInputVoltage, matInvLineVoltage=matInvLineVoltage, matConTemperatureHigh=matConTemperatureHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvTempPowerLimit=matInvTempPowerLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConWarningState=matConWarningState, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConCommunicationLost=matConCommunicationLost, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvOutputPower=matConfInvOutputPower)
