...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsWarningState=matStsWarningState, matStsInvInputVoltage=matStsInvInputVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matStsNotRespond=matStsNotRespond, matDryContactNum=matDryContactNum, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsPriority=matConfStsPriority, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConTemperature=matConTemperature, matInvPhaseType=matInvPhaseType, matInvLineVoltage=matInvLineVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matStsOverLoad=matStsOverLoad, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvEntry=matInvEntry, matInvBatteryVoltage=matInvBatteryVoltage, matStsStatus=matStsStatus, matTrapTargetsNum=matTrapTargetsNum, matInvBusSoftFail=matInvBusSoftFail, matInvSoftStartFail=matInvSoftStartFail, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsInvFail=matStsInvFail, matConfInvSysPriority=matConfInvSysPriority, matStsEEPROMFault=matStsEEPROMFault, matConName=matConName, matStsInvBypassMode=matStsInvBypassMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvEPOShutdown=matInvEPOShutdown, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvMBSPosError=matInvMBSPosError, matInvOutputShort=matInvOutputShort, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvOutputFreq=matInvOutputFreq, matStsMBSPosFault=matStsMBSPosFault, matInvMbsPosition=matInvMbsPosition, matTraps=matTraps, matConfInvOutputFreq=matConfInvOutputFreq, matInvHardwareVersion=matInvHardwareVersion, matInvTempPowerLimit=matInvTempPowerLimit, matStsMbsStatus=matStsMbsStatus, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInverter=matInverter, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsRunningMode=matStsRunningMode, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsEntry=matTrapTargetsEntry, matAgent=matAgent, matInvTemperature=matInvTemperature, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matSts=matSts, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConWarningState=matConWarningState, matStsSerialNum=matStsSerialNum, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matTrapTargetsAddress=matTrapTargetsAddress, matConCanBusOff=matConCanBusOff, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsControlPowerFail=matStsControlPowerFail, matStsFirmwareVersion=matStsFirmwareVersion, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsTable=matStsTable, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsEntry=matStsEntry, matDryContact=matDryContact, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvWarningState=matInvWarningState, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvFanFault=matInvFanFault, matInvRunMode=matInvRunMode, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConBatteryLow=matConBatteryLow, matTrapTargetsCommunity=matTrapTargetsCommunity, matConSerialNum=matConSerialNum, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvSerialNum=matInvSerialNum, matStsOutputAbnormal=matStsOutputAbnormal, matInvModuleIndex=matInvModuleIndex, PositiveInteger=PositiveInteger, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, NonNegativeInteger=NonNegativeInteger, matInvPriority=matInvPriority, matStsOutputVoltage=matStsOutputVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsRuntime=matStsRuntime, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvNotRespond=matInvNotRespond, matConfInvOutputPower=matConfInvOutputPower, ppc=ppc, matStsOutputFreq=matStsOutputFreq, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matObjects=matObjects, matReturnFromInvFault=matReturnFromInvFault, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvPulseFault=matInvPulseFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsModuleIndex=matStsModuleIndex, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvModuleNum=matInvModuleNum, matInvOutputPower=matInvOutputPower, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargetsIndex=matTrapTargetsIndex, matInvLineFreq=matInvLineFreq, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvTable=matInvTable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matDryContactTable=matDryContactTable, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsFanFault=matStsFanFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvRunTime=matInvRunTime, matInvOutputVoltLow=matInvOutputVoltLow, matController=matController, matInvOutputVoltage=matInvOutputVoltage, matDryContactString=matDryContactString, matInvOutputCurrent=matInvOutputCurrent, matConTemperatureHigh=matConTemperatureHigh, matConfig=matConfig, matStsMainInputFreq=matStsMainInputFreq, matStsTemperature=matStsTemperature, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvFirmwareVersion=matInvFirmwareVersion, matConBatteryVoltHigh=matConBatteryVoltHigh, matDryContactEntry=matDryContactEntry, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvOnOffStatus=matInvOnOffStatus, matStsModuleNum=matStsModuleNum, matInvTemperatureHigh=matInvTemperatureHigh, matStsOutputCurrent=matStsOutputCurrent, matInvMainUnavailable=matInvMainUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matTrapType=matTrapType, matConfInvInputVoltage=matConfInvInputVoltage, matInvFault=matInvFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, device=device, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConCommunicationLost=matConCommunicationLost, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvPowerLimit=matInvPowerLimit, matConEEPROMFault=matConEEPROMFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsModuleType=matStsModuleType, matDryContactIndex=matDryContactIndex, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsFaultMode=matStsFaultMode, matTrapTargets=matTrapTargets, matStsMainsFail=matStsMainsFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsInvInputFreq=matStsInvInputFreq, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOverLoad=matInvOverLoad, matStsOutputPower=matStsOutputPower, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvHardwareError=matInvHardwareError)
