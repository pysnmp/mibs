...
enterprises, Integer32, iso, TimeTicks, ModuleIdentity, Unsigned32, Bits, IpAddress, Counter64, NotificationType, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "iso", "TimeTicks", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "Counter64", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvOverLoad=matInvOverLoad, matTrapTargetsEntry=matTrapTargetsEntry, matStsEntry=matStsEntry, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConName=matConName, matStsInvFail=matStsInvFail, matInvMbsPosition=matInvMbsPosition, device=device, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsRunningMode=matStsRunningMode, matStsTemperature=matStsTemperature, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConSerialNum=matConSerialNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsFanFault=matStsFanFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvPowerLimit=matInvPowerLimit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargetsAddress=matTrapTargetsAddress, matInvRunTime=matInvRunTime, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMainsFail=matStsMainsFail, matStsModuleNum=matStsModuleNum, matInvPhaseType=matInvPhaseType, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matSts=matSts, matConBatteryLow=matConBatteryLow, matInvOutputPower=matInvOutputPower, matStsTable=matStsTable, matStsSerialNum=matStsSerialNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapTargets=matTrapTargets, matInvOnOffStatus=matInvOnOffStatus, matInvTemperature=matInvTemperature, matConEEPROMFault=matConEEPROMFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOutputAbnormal=matStsOutputAbnormal, matInvPriority=matInvPriority, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsInvBypassMode=matStsInvBypassMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvMBSPosError=matInvMBSPosError, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matObjects=matObjects, matInvBusSoftFail=matInvBusSoftFail, matStsOutputVoltage=matStsOutputVoltage, matInvPulseFault=matInvPulseFault, NonNegativeInteger=NonNegativeInteger, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapType=matTrapType, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvInputVoltage=matConfInvInputVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matController=matController, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsInvInputVoltage=matStsInvInputVoltage, matConTemperatureHigh=matConTemperatureHigh, matInvHardwareError=matInvHardwareError, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvTable=matInvTable, matInvHardwareVersion=matInvHardwareVersion, matStsOutputPower=matStsOutputPower, matInvLineVoltage=matInvLineVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsInvInputFreq=matStsInvInputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsStatus=matStsStatus, ppc=ppc, matConWarningState=matConWarningState, matInvRunMode=matInvRunMode, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfig=matConfig, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsFaultMode=matStsFaultMode, matStsWarningState=matStsWarningState, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvWarningState=matInvWarningState, matTrapTargetsTable=matTrapTargetsTable, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvTempPowerLimit=matInvTempPowerLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfStsFanSpeed=matConfStsFanSpeed, matDryContact=matDryContact, matAgentSoftwareVerison=matAgentSoftwareVerison, matTraps=matTraps, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConCanBusOff=matConCanBusOff, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsDesc=matTrapTargetsDesc, matInvLowInputShutdown=matInvLowInputShutdown, matStsOutputFreq=matStsOutputFreq, matInvInputAbnormal=matInvInputAbnormal, PositiveInteger=PositiveInteger, matInvModuleNum=matInvModuleNum, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matDryContactString=matDryContactString, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsRuntime=matStsRuntime, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsModuleIndex=matStsModuleIndex, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matDryContactTable=matDryContactTable, matInvOutputFreq=matInvOutputFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsModuleType=matStsModuleType, matConCommunicationLost=matConCommunicationLost, matConTemperature=matConTemperature, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFault=matReturnFromInvFault, matInvFault=matInvFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsMainInputFreq=matStsMainInputFreq, matDryContactIndex=matDryContactIndex, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvModuleIndex=matInvModuleIndex, matConfStsPriority=matConfStsPriority, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsNotRespond=matStsNotRespond, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matDryContactEntry=matDryContactEntry, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvEntry=matInvEntry, matInvLineFreq=matInvLineFreq, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matAgent=matAgent, matInverter=matInverter, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvSoftStartFail=matInvSoftStartFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsEEPROMFault=matStsEEPROMFault, matInvOutputCurrent=matInvOutputCurrent, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsOverLoad=matStsOverLoad, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsMBSPosFault=matStsMBSPosFault, matInvBypassSCRShort=matInvBypassSCRShort, matInvFanFault=matInvFanFault, matDryContactNum=matDryContactNum, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargetsNum=matTrapTargetsNum, matStsTemperatureHigh=matStsTemperatureHigh, matInvSerialNum=matInvSerialNum, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvNotRespond=matInvNotRespond, matInvOutputShort=matInvOutputShort)
