...
Gauge32, Bits, Unsigned32, ModuleIdentity, NotificationType, NotificationType, TimeTicks, MibIdentifier, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, enterprises, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "NotificationType", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "enterprises", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvRunTime=matInvRunTime, matInvSerialNum=matInvSerialNum, matInvLineVoltage=matInvLineVoltage, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMBSPosError=matInvMBSPosError, matConCanBusOff=matConCanBusOff, matStsModuleType=matStsModuleType, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsTemperature=matStsTemperature, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsModuleNum=matStsModuleNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvOutputFreq=matConfInvOutputFreq, matStsStatus=matStsStatus, PositiveInteger=PositiveInteger, matInvOutputFreq=matInvOutputFreq, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConName=matConName, matConBatteryLow=matConBatteryLow, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMainInputVoltage=matStsMainInputVoltage, matStsFanFault=matStsFanFault, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConCommunicationLost=matConCommunicationLost, matInvPulseFault=matInvPulseFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvInputAbnormal=matInvInputAbnormal, matStsInvBypassMode=matStsInvBypassMode, matInvFirmwareVersion=matInvFirmwareVersion, matStsWarningState=matStsWarningState, matConfInvSysPriority=matConfInvSysPriority, matTraps=matTraps, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matDryContact=matDryContact, matInvModuleIndex=matInvModuleIndex, matInvOverLoad=matInvOverLoad, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matDryContactString=matDryContactString, matStsMbsStatus=matStsMbsStatus, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matTrapType=matTrapType, matStsHardwareVersion=matStsHardwareVersion, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapTargetsEntry=matTrapTargetsEntry, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvInputVoltage=matConfInvInputVoltage, matController=matController, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsOutputFreq=matStsOutputFreq, matDryContactIndex=matDryContactIndex, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsMainsFail=matStsMainsFail, matInvRunMode=matInvRunMode, matConWarningState=matConWarningState, matConfInvOutputPower=matConfInvOutputPower, matStsTable=matStsTable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConSerialNum=matConSerialNum, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, NonNegativeInteger=NonNegativeInteger, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvMbsPosition=matInvMbsPosition, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsEntry=matStsEntry, matInvTemperatureHigh=matInvTemperatureHigh, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvTemperature=matInvTemperature, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsSerialNum=matStsSerialNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsOutputAbnormal=matStsOutputAbnormal, matInvPowerLimit=matInvPowerLimit, matStsModuleIndex=matStsModuleIndex, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvTempPowerLimit=matInvTempPowerLimit, matStsRunningMode=matStsRunningMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputPower=matInvOutputPower, matObjects=matObjects, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsMainFail=matReturnFromStsMainFail, matConTemperature=matConTemperature, matInvOutputShort=matInvOutputShort, matConfig=matConfig, matStsRuntime=matStsRuntime, matInvPhaseType=matInvPhaseType, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matSts=matSts, matTrapTargetsTable=matTrapTargetsTable, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsNotRespond=matStsNotRespond, matStsMainInputFreq=matStsMainInputFreq, matConTemperatureHigh=matConTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsInvFail=matStsInvFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matConEEPROMFault=matConEEPROMFault, matStsControlPowerFail=matStsControlPowerFail, matStsOverLoad=matStsOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapTargetsNum=matTrapTargetsNum, matInvMaintenaceBypass=matInvMaintenaceBypass, device=device, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsFaultMode=matStsFaultMode, matDryContactTable=matDryContactTable, matInvOutputVoltage=matInvOutputVoltage, matInvFault=matInvFault, matInvEntry=matInvEntry, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvOutputCurrent=matInvOutputCurrent, matInvNotRespond=matInvNotRespond, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsFirmwareVersion=matStsFirmwareVersion, matInvModuleNum=matInvModuleNum, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvBatteryVoltage=matInvBatteryVoltage, matStsMBSPosFault=matStsMBSPosFault, matInvOnOffStatus=matInvOnOffStatus, matStsInvInputFreq=matStsInvInputFreq, matInvPriority=matInvPriority, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvTable=matInvTable, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvWarningState=matInvWarningState, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvFault=matReturnFromInvFault, matTrapTargetsDesc=matTrapTargetsDesc, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matAgent=matAgent, matTrapTargetsAddress=matTrapTargetsAddress, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matDryContactNum=matDryContactNum, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInverter=matInverter, matInvLineFreq=matInvLineFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputPower=matStsOutputPower, matInvFanFault=matInvFanFault, matStsOutputVoltage=matStsOutputVoltage, matTrapTargets=matTrapTargets, matStsInvInputVoltage=matStsInvInputVoltage, matDryContactEntry=matDryContactEntry, matConfStsFanSpeed=matConfStsFanSpeed, ppc=ppc, matConfStsPriority=matConfStsPriority, matInvHardwareError=matInvHardwareError)
