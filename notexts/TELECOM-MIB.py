...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, iso, NotificationType, ObjectIdentity, Counter32, NotificationType, TimeTicks, Counter64, Integer32, enterprises, IpAddress, MibIdentifier, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "Counter32", "NotificationType", "TimeTicks", "Counter64", "Integer32", "enterprises", "IpAddress", "MibIdentifier", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvEntry=matInvEntry, matStsInvFail=matStsInvFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBypassSCRShort=matInvBypassSCRShort, matConSerialNum=matConSerialNum, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvFanFault=matInvFanFault, matConfig=matConfig, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvHardwareVersion=matInvHardwareVersion, matStsOutputAbnormal=matStsOutputAbnormal, matStsFirmwareVersion=matStsFirmwareVersion, matStsEntry=matStsEntry, ppc=ppc, matStsTemperatureHigh=matStsTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMBSPosFault=matStsMBSPosFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvTemperature=matInvTemperature, matStsRunningMode=matStsRunningMode, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsRuntime=matStsRuntime, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsModuleNum=matStsModuleNum, matStsStatus=matStsStatus, matInvLineFreq=matInvLineFreq, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapTargetsIndex=matTrapTargetsIndex, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsModuleType=matStsModuleType, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matController=matController, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matDryContact=matDryContact, matInvOutputVoltage=matInvOutputVoltage, matTrapTargetsNum=matTrapTargetsNum, matInvOutputShort=matInvOutputShort, matInvOutputVoltHigh=matInvOutputVoltHigh, matConBatteryLow=matConBatteryLow, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsInvInputVoltage=matStsInvInputVoltage, matSts=matSts, matConCommunicationLost=matConCommunicationLost, matStsMainsFail=matStsMainsFail, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvPriority=matInvPriority, matStsSerialNum=matStsSerialNum, matInvMBSPosError=matInvMBSPosError, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matStsOutputVoltage=matStsOutputVoltage, matStsNotRespond=matStsNotRespond, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvModuleNum=matInvModuleNum, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matConTemperatureHigh=matConTemperatureHigh, matInvFirmwareVersion=matInvFirmwareVersion, matTrapType=matTrapType, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputFreq=matInvOutputFreq, matTrapTargets=matTrapTargets, matInvPhaseType=matInvPhaseType, device=device, matConTemperature=matConTemperature, matStsOverLoad=matStsOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsFaultMode=matStsFaultMode, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvEEPROMFault=matInvEEPROMFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsControlPowerFail=matStsControlPowerFail, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvNotRespond=matInvNotRespond, matInvEPOShutdown=matInvEPOShutdown, matInvTable=matInvTable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargetsAddress=matTrapTargetsAddress, NonNegativeInteger=NonNegativeInteger, matStsOutputPower=matStsOutputPower, matStsMainInputVoltage=matStsMainInputVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matInvTemperatureHigh=matInvTemperatureHigh, matTraps=matTraps, matStsFanFault=matStsFanFault, matInvMainUnavailable=matInvMainUnavailable, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvTempPowerLimit=matInvTempPowerLimit, matConCanBusOff=matConCanBusOff, matDryContactString=matDryContactString, matStsMainInputFreq=matStsMainInputFreq, matInvSoftStartFail=matInvSoftStartFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matObjects=matObjects, matReturnFromInvFault=matReturnFromInvFault, matInvSerialNum=matInvSerialNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConWarningState=matConWarningState, matStsHardwareVersion=matStsHardwareVersion, matInvMbsPosition=matInvMbsPosition, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInverter=matInverter, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matAgent=matAgent, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvFault=matInvFault, matConEEPROMFault=matConEEPROMFault, matInvWarningState=matInvWarningState, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, PositiveInteger=PositiveInteger, matInvHardwareError=matInvHardwareError, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvBatteryVoltage=matInvBatteryVoltage, matInvPowerLimit=matInvPowerLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matDryContactTable=matDryContactTable, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvPulseFault=matInvPulseFault, matStsTemperature=matStsTemperature, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matDryContactEntry=matDryContactEntry, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsWarningState=matStsWarningState, matStsMbsStatus=matStsMbsStatus, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvModuleIndex=matInvModuleIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvRunMode=matInvRunMode, matStsOutputFreq=matStsOutputFreq, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvInputVoltage=matConfInvInputVoltage, matStsInvInputFreq=matStsInvInputFreq, matDryContactIndex=matDryContactIndex, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputCurrent=matInvOutputCurrent, matConfStsPriority=matConfStsPriority, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsTable=matStsTable, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvOutputPower=matInvOutputPower, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matDryContactNum=matDryContactNum, matConName=matConName, matInvLineVoltage=matInvLineVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOverLoad=matInvOverLoad, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvRunTime=matInvRunTime)
