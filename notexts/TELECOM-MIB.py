...
mibBuilder.exportSymbols("TELECOM-MIB", matStsStatus=matStsStatus, matInvFault=matInvFault, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMainInputFreq=matStsMainInputFreq, matInvOutputFreq=matInvOutputFreq, matConSerialNum=matConSerialNum, matStsRuntime=matStsRuntime, matController=matController, matInvTempPowerLimit=matInvTempPowerLimit, matStsModuleType=matStsModuleType, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsModuleIndex=matStsModuleIndex, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsEntry=matStsEntry, matObjects=matObjects, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matAgent=matAgent, matInvLineFreq=matInvLineFreq, matInvOutputPower=matInvOutputPower, matConfInvInputVoltage=matConfInvInputVoltage, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvLineVoltage=matInvLineVoltage, matInvRunMode=matInvRunMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTraps=matTraps, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsTable=matStsTable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConWarningState=matConWarningState, matStsInvFail=matStsInvFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matStsOverLoad=matStsOverLoad, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvRunTime=matInvRunTime, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsInvInputFreq=matStsInvInputFreq, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsWarningState=matStsWarningState, matInvEntry=matInvEntry, matInvNotRespond=matInvNotRespond, matInvHardwareVersion=matInvHardwareVersion, matStsMbsStatus=matStsMbsStatus, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvTemperatureHigh=matInvTemperatureHigh, matInvSerialNum=matInvSerialNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvOutputPower=matConfInvOutputPower, matStsModuleNum=matStsModuleNum, matInvBypassSCRShort=matInvBypassSCRShort, matConCanBusOff=matConCanBusOff, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvMBSPosError=matInvMBSPosError, matInvMainUnavailable=matInvMainUnavailable, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsMainsFail=matStsMainsFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvMbsPosition=matInvMbsPosition, matInvPowerLimit=matInvPowerLimit, matTrapSeverityLevel=matTrapSeverityLevel, ppc=ppc, matInvOutputShort=matInvOutputShort, matReturnFromInvFault=matReturnFromInvFault, matStsFaultMode=matStsFaultMode, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvPriority=matInvPriority, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargetsAddress=matTrapTargetsAddress, matInvEPOShutdown=matInvEPOShutdown, matInverter=matInverter, matConfStsPriority=matConfStsPriority, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsFirmwareVersion=matStsFirmwareVersion, matInvModuleNum=matInvModuleNum, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainInputVoltage=matStsMainInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContact=matDryContact, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsOutputFreq=matStsOutputFreq, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matDryContactNum=matDryContactNum, matStsOutputPower=matStsOutputPower, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfig=matConfig, matInvOutputVoltage=matInvOutputVoltage, matInvModuleIndex=matInvModuleIndex, matInvTable=matInvTable, matConfStsFanSpeed=matConfStsFanSpeed, matStsControlPowerFail=matStsControlPowerFail, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvSoftStartFail=matInvSoftStartFail, matInvOutputCurrent=matInvOutputCurrent, matTrapTargets=matTrapTargets, matConName=matConName, matInvFirmwareVersion=matInvFirmwareVersion, NonNegativeInteger=NonNegativeInteger, matStsSerialNum=matStsSerialNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matDryContactEntry=matDryContactEntry, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsRunningMode=matStsRunningMode, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvBypassMode=matStsInvBypassMode, matInvBatteryVoltage=matInvBatteryVoltage, matDryContactTable=matDryContactTable, matInvTemperature=matInvTemperature, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvFanFault=matReturnFromInvFanFault, matDryContactString=matDryContactString, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matDryContactIndex=matDryContactIndex, matInvPhaseType=matInvPhaseType, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, device=device, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConEEPROMFault=matConEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matInvWarningState=matInvWarningState, matInvOverLoad=matInvOverLoad, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsTemperature=matStsTemperature, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConTemperature=matConTemperature, matInvPulseFault=matInvPulseFault, matConfInvSysPriority=matConfInvSysPriority, matInvEEPROMFault=matInvEEPROMFault, matStsNotRespond=matStsNotRespond, matInvHardwareError=matInvHardwareError, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvFanFault=matInvFanFault, matStsOutputVoltage=matStsOutputVoltage, matConBatteryLow=matConBatteryLow, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvOnOffStatus=matInvOnOffStatus, matConfInvSysPowerLimit=matConfInvSysPowerLimit, PositiveInteger=PositiveInteger, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsHardwareVersion=matStsHardwareVersion, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsFanFault=matStsFanFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matTrapType=matTrapType, matSts=matSts, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMBSPosFault=matStsMBSPosFault)
