...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvLineFreq=matInvLineFreq, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvHardwareVersion=matInvHardwareVersion, matStsMainsFail=matStsMainsFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsInvBypassMode=matStsInvBypassMode, matInvMBSPosError=matInvMBSPosError, matDryContactEntry=matDryContactEntry, matTrapType=matTrapType, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfig=matConfig, ppc=ppc, matTrapTargetsNum=matTrapTargetsNum, matDryContactTable=matDryContactTable, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOverLoad=matStsOverLoad, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMbsPosition=matInvMbsPosition, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOverLoad=matInvOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matAgent=matAgent, matInvFanFault=matInvFanFault, matInvNotRespond=matInvNotRespond, matDryContactNum=matDryContactNum, matInvFirmwareVersion=matInvFirmwareVersion, matStsStatus=matStsStatus, matDryContactIndex=matDryContactIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, NonNegativeInteger=NonNegativeInteger, matStsTemperature=matStsTemperature, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvFault=matReturnFromInvFault, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConBatteryLow=matConBatteryLow, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvTemperatureHigh=matInvTemperatureHigh, matStsSerialNum=matStsSerialNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matTrapTargets=matTrapTargets, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsFirmwareVersion=matStsFirmwareVersion, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConTemperatureHigh=matConTemperatureHigh, matConName=matConName, matStsFaultMode=matStsFaultMode, matStsWarningState=matStsWarningState, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, PositiveInteger=PositiveInteger, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvOutputFreq=matConfInvOutputFreq, matInvOutputShort=matInvOutputShort, matConEEPROMFault=matConEEPROMFault, matInvPriority=matInvPriority, matStsRuntime=matStsRuntime, matInvInputAbnormal=matInvInputAbnormal, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvTemperature=matInvTemperature, device=device, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsModuleNum=matStsModuleNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvMainUnavailable=matInvMainUnavailable, matInvModuleNum=matInvModuleNum, matInvOutputFreq=matInvOutputFreq, matStsBypassUnavailable=matStsBypassUnavailable, matConTemperature=matConTemperature, matInvRunTime=matInvRunTime, matConfInvSysPriority=matConfInvSysPriority, matInvBusSoftFail=matInvBusSoftFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvEntry=matInvEntry, matStsModuleType=matStsModuleType, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvTable=matInvTable, matConCommunicationLost=matConCommunicationLost, matDryContactString=matDryContactString, matInvEEPROMFault=matInvEEPROMFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsOutputFreq=matStsOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matObjects=matObjects, matStsMbsStatus=matStsMbsStatus, matStsMainInputFreq=matStsMainInputFreq, matTraps=matTraps, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsNotRespond=matStsNotRespond, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvWarningState=matInvWarningState, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsFanFault=matStsFanFault, matTrapTargetsAddress=matTrapTargetsAddress, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvModuleIndex=matInvModuleIndex, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvRunMode=matInvRunMode, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvOutputPower=matInvOutputPower, matStsModuleIndex=matStsModuleIndex, matInvPowerLimit=matInvPowerLimit, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsEEPROMFault=matStsEEPROMFault, matStsEntry=matStsEntry, matInverter=matInverter, matController=matController, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsInvFail=matStsInvFail, matStsControlPowerFail=matStsControlPowerFail, matTrapTargetsDesc=matTrapTargetsDesc, matConCanBusOff=matConCanBusOff, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvFault=matInvFault, matInvSerialNum=matInvSerialNum, matTrapSeverityLevel=matTrapSeverityLevel, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsMBSPosFault=matStsMBSPosFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsPriority=matConfStsPriority, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsTable=matStsTable, matConSerialNum=matConSerialNum, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvPulseFault=matInvPulseFault, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsOutputPower=matStsOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvHardwareError=matInvHardwareError, matDryContact=matDryContact, matInvPhaseType=matInvPhaseType, matStsRunningMode=matStsRunningMode, matConfStsFanSpeed=matConfStsFanSpeed, matInvLineVoltage=matInvLineVoltage, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputVoltage=matInvOutputVoltage, matConWarningState=matConWarningState, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matSts=matSts, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvTempPowerLimit=matInvTempPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvOutputPower=matConfInvOutputPower, matStsMainInputVoltage=matStsMainInputVoltage)
