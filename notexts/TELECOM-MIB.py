...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsOverLoad=matReturnFromStsOverLoad, matSts=matSts, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvSysPriority=matConfInvSysPriority, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsDesc=matTrapTargetsDesc, matInvMbsPosition=matInvMbsPosition, matAgent=matAgent, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvTemperatureHigh=matInvTemperatureHigh, matConBatteryLow=matConBatteryLow, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsRuntime=matStsRuntime, matInvMBSPosError=matInvMBSPosError, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvPriority=matInvPriority, matConfig=matConfig, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargetsTable=matTrapTargetsTable, matStsControlPowerFail=matStsControlPowerFail, matStsModuleNum=matStsModuleNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsNotRespond=matStsNotRespond, matInvFanFault=matInvFanFault, matInvHardwareError=matInvHardwareError, matInvHardwareVersion=matInvHardwareVersion, matDryContactString=matDryContactString, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfStsPriority=matConfStsPriority, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvNotRespond=matInvNotRespond, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvSoftStartFail=matInvSoftStartFail, matConSerialNum=matConSerialNum, matInvOutputVoltage=matInvOutputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matInvEntry=matInvEntry, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsCommunity=matTrapTargetsCommunity, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvInputAbnormal=matInvInputAbnormal, matObjects=matObjects, matStsInvFail=matStsInvFail, matConEEPROMFault=matConEEPROMFault, matConCanBusOff=matConCanBusOff, matStsInvInputVoltage=matStsInvInputVoltage, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConName=matConName, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsOutputVoltage=matStsOutputVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainInputFreq=matStsMainInputFreq, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputPower=matConfInvOutputPower, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConWarningState=matConWarningState, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsAddress=matTrapTargetsAddress, matTrapTargetsEntry=matTrapTargetsEntry, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matController=matController, matReturnFromInvFault=matReturnFromInvFault, matInvModuleNum=matInvModuleNum, matStsOutputFreq=matStsOutputFreq, matStsHardwareVersion=matStsHardwareVersion, matInvEPOShutdown=matInvEPOShutdown, matStsMBSPosFault=matStsMBSPosFault, matInvFirmwareVersion=matInvFirmwareVersion, PositiveInteger=PositiveInteger, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsOutputPower=matStsOutputPower, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvRunTime=matInvRunTime, matStsOverLoad=matStsOverLoad, matTrapTargets=matTrapTargets, matInvWarningState=matInvWarningState, matConfStsFanSpeed=matConfStsFanSpeed, matStsModuleType=matStsModuleType, matStsTable=matStsTable, matInverter=matInverter, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvTable=matInvTable, matDryContactTable=matDryContactTable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsRunningMode=matStsRunningMode, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvRunMode=matInvRunMode, matDryContactEntry=matDryContactEntry, matStsTemperatureHigh=matStsTemperatureHigh, matStsFaultMode=matStsFaultMode, matInvMainUnavailable=matInvMainUnavailable, matInvLineVoltage=matInvLineVoltage, matInvOutputPower=matInvOutputPower, matInvOutputVoltLow=matInvOutputVoltLow, matConTemperatureHigh=matConTemperatureHigh, matDryContactIndex=matDryContactIndex, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvSerialNum=matInvSerialNum, matInvBypassSCRShort=matInvBypassSCRShort, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matDryContactNum=matDryContactNum, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvTempPowerLimit=matInvTempPowerLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsFanFault=matStsFanFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsModuleIndex=matStsModuleIndex, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvTemperature=matInvTemperature, matInvOverLoad=matInvOverLoad, matStsOutputAbnormal=matStsOutputAbnormal, matStsSerialNum=matStsSerialNum, matInvPowerLimit=matInvPowerLimit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, NonNegativeInteger=NonNegativeInteger, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConCommunicationLost=matConCommunicationLost, matInvPulseFault=matInvPulseFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsTemperature=matStsTemperature, ppc=ppc, matConfInvOutputFreq=matConfInvOutputFreq, matInvPhaseType=matInvPhaseType, matInvFault=matInvFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsIndex=matTrapTargetsIndex, matDryContact=matDryContact, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvLowInputShutdown=matInvLowInputShutdown, matStsInvInputFreq=matStsInvInputFreq, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvLineFreq=matInvLineFreq, matTraps=matTraps, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsEEPROMFault=matStsEEPROMFault, device=device, matStsStatus=matStsStatus, matStsMainsFail=matStsMainsFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConTemperature=matConTemperature, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsWarningState=matStsWarningState, matInvOutputFreq=matInvOutputFreq, matInvBusSoftFail=matInvBusSoftFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOutputShort=matInvOutputShort, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsEntry=matStsEntry, matTrapType=matTrapType, matStsMainInputVoltage=matStsMainInputVoltage)
