...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, MibIdentifier, IpAddress, Unsigned32, enterprises, NotificationType, iso, Bits, TimeTicks, Counter64, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "MibIdentifier", "IpAddress", "Unsigned32", "enterprises", "NotificationType", "iso", "Bits", "TimeTicks", "Counter64", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMaintenanceBypass=matStsMaintenanceBypass, matConfig=matConfig, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapTargets=matTrapTargets, matInvHardwareVersion=matInvHardwareVersion, matInvMBSPosError=matInvMBSPosError, matInvRunMode=matInvRunMode, matStsEEPROMFault=matStsEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOutputFreq=matInvOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matStsOutputFreq=matStsOutputFreq, matStsEntry=matStsEntry, matConEEPROMFault=matConEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsMainInputVoltage=matStsMainInputVoltage, matInvMainUnavailable=matInvMainUnavailable, matStsFaultMode=matStsFaultMode, matConfStsPriority=matConfStsPriority, matInvOutputPower=matInvOutputPower, matDryContactEntry=matDryContactEntry, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConName=matConName, matStsOverLoad=matStsOverLoad, ppc=ppc, matTrapType=matTrapType, matStsInvFail=matStsInvFail, matStsWarningState=matStsWarningState, NonNegativeInteger=NonNegativeInteger, matStsSerialNum=matStsSerialNum, matDryContact=matDryContact, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConTemperatureHigh=matConTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matController=matController, matDryContactTable=matDryContactTable, matStsModuleNum=matStsModuleNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsOutputAbnormal=matStsOutputAbnormal, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvModuleNum=matInvModuleNum, matInvOutputCurrent=matInvOutputCurrent, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapTargetsNum=matTrapTargetsNum, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvPowerLimit=matInvPowerLimit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConCommunicationLost=matConCommunicationLost, matInvRunTime=matInvRunTime, matSts=matSts, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsEntry=matTrapTargetsEntry, matStsControlPowerFail=matStsControlPowerFail, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsStatus=matStsStatus, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvOutputPower=matConfInvOutputPower, matStsMBSPosFault=matStsMBSPosFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsInvBypassMode=matStsInvBypassMode, matInvFirmwareVersion=matInvFirmwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvModuleIndex=matInvModuleIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvOutputVoltage=matInvOutputVoltage, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputShort=matInvOutputShort, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvOutputVoltage=matConfInvOutputVoltage, matObjects=matObjects, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsFirmwareVersion=matStsFirmwareVersion, matTrapTargetsDesc=matTrapTargetsDesc, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvPulseFault=matInvPulseFault, matStsInvInputVoltage=matStsInvInputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matStsFanFault=matStsFanFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matTraps=matTraps, matInvEntry=matInvEntry, matStsBypassUnavailable=matStsBypassUnavailable, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInverter=matInverter, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsRuntime=matStsRuntime, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConCanBusOff=matConCanBusOff, matConfStsFanSpeed=matConfStsFanSpeed, matStsModuleType=matStsModuleType, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvSerialNum=matInvSerialNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsNotRespond=matStsNotRespond, matStsRunningMode=matStsRunningMode, matStsHardwareVersion=matStsHardwareVersion, matStsOutputVoltage=matStsOutputVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConTemperature=matConTemperature, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvFault=matInvFault, matInvHardwareError=matInvHardwareError, matStsModuleIndex=matStsModuleIndex, matAgent=matAgent, matInvOnOffStatus=matInvOnOffStatus, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matDryContactNum=matDryContactNum, matDryContactString=matDryContactString, matTrapTargetsTable=matTrapTargetsTable, matStsMainsFail=matStsMainsFail, matInvOverLoad=matInvOverLoad, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTemperature=matInvTemperature, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputVoltHigh=matInvOutputVoltHigh, matConSerialNum=matConSerialNum, matConWarningState=matConWarningState, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvFanFault=matInvFanFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConBatteryLow=matConBatteryLow, matDryContactIndex=matDryContactIndex, matInvPhaseType=matInvPhaseType, matInvWarningState=matInvWarningState, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsNotRespond=matReturnFromStsNotRespond, PositiveInteger=PositiveInteger, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvNotRespond=matInvNotRespond, matStsTemperature=matStsTemperature, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsMainInputFreq=matStsMainInputFreq, matStsMbsStatus=matStsMbsStatus, matConfInvInputVoltage=matConfInvInputVoltage, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsTable=matStsTable, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvTable=matInvTable, matInvPriority=matInvPriority, matInvLineFreq=matInvLineFreq, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvLineVoltage=matInvLineVoltage, device=device, matInvMbsPosition=matInvMbsPosition, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsOutputPower=matStsOutputPower, matTrapSeverityLevel=matTrapSeverityLevel, matInvTempPowerLimit=matInvTempPowerLimit)
