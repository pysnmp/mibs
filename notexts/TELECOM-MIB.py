...
TimeTicks, enterprises, Unsigned32, Bits, NotificationType, ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Gauge32, MibIdentifier, IpAddress, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Unsigned32", "Bits", "NotificationType", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Gauge32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matDryContactEntry=matDryContactEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvLineFreq=matInvLineFreq, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvSerialNum=matInvSerialNum, matStsBypassUnavailable=matStsBypassUnavailable, matInvPriority=matInvPriority, matStsHardwareVersion=matStsHardwareVersion, matInvHardwareError=matInvHardwareError, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConBatteryLow=matConBatteryLow, matInvRunTime=matInvRunTime, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvPhaseType=matInvPhaseType, matTrapTargetsNum=matTrapTargetsNum, matConTemperatureHigh=matConTemperatureHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvEEPROMFault=matInvEEPROMFault, matDryContactNum=matDryContactNum, matInvOverLoad=matInvOverLoad, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matDryContactString=matDryContactString, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, ppc=ppc, matStsSerialNum=matStsSerialNum, matStsModuleNum=matStsModuleNum, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsRuntime=matStsRuntime, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matAgent=matAgent, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapTargets=matTrapTargets, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsFaultMode=matStsFaultMode, matStsModuleIndex=matStsModuleIndex, matInvSoftStartFail=matInvSoftStartFail, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOutputPower=matInvOutputPower, matTrapSeverityLevel=matTrapSeverityLevel, matInvEntry=matInvEntry, matStsMbsStatus=matStsMbsStatus, matConfInvOutputPower=matConfInvOutputPower, matInvMBSPosError=matInvMBSPosError, matConWarningState=matConWarningState, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsFanFault=matStsFanFault, matStsOutputCurrent=matStsOutputCurrent, matConCanBusOff=matConCanBusOff, matTrapTargetsDesc=matTrapTargetsDesc, matInvOnOffStatus=matInvOnOffStatus, matConSerialNum=matConSerialNum, matInvFanFault=matInvFanFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargetsAddress=matTrapTargetsAddress, matInvTable=matInvTable, device=device, matInvTempPowerLimit=matInvTempPowerLimit, matInvOutputVoltLow=matInvOutputVoltLow, matStsMainsFail=matStsMainsFail, matInvOutputCurrent=matInvOutputCurrent, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsNotRespond=matStsNotRespond, matStsOutputFreq=matStsOutputFreq, matInvModuleIndex=matInvModuleIndex, matConEEPROMFault=matConEEPROMFault, matInvTemperature=matInvTemperature, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfig=matConfig, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsTable=matStsTable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matDryContactTable=matDryContactTable, matDryContact=matDryContact, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvInputVoltage=matConfInvInputVoltage, matStsEntry=matStsEntry, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConTemperature=matConTemperature, matStsTemperature=matStsTemperature, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvHardwareVersion=matInvHardwareVersion, matConfStsPriority=matConfStsPriority, matTrapTargetsIndex=matTrapTargetsIndex, matStsInvBypassMode=matStsInvBypassMode, matStsModuleType=matStsModuleType, matInvLowInputShutdown=matInvLowInputShutdown, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvOutputFreq=matInvOutputFreq, matStsWarningState=matStsWarningState, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsTemperatureHigh=matStsTemperatureHigh, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsInvInputFreq=matStsInvInputFreq, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsStatus=matStsStatus, matStsFirmwareVersion=matStsFirmwareVersion, matStsEEPROMFault=matStsEEPROMFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matController=matController, matTrapType=matTrapType, matInvFirmwareVersion=matInvFirmwareVersion, matConfStsFanSpeed=matConfStsFanSpeed, matInvMainUnavailable=matInvMainUnavailable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvRunMode=matInvRunMode, matInvInputAbnormal=matInvInputAbnormal, matInvPowerLimit=matInvPowerLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsOverLoad=matStsOverLoad, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvModuleNum=matInvModuleNum, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsTable=matTrapTargetsTable, matInvLineVoltage=matInvLineVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvFault=matInvFault, matInvPulseFault=matInvPulseFault, matConfInvOutputFreq=matConfInvOutputFreq, matTraps=matTraps, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInverter=matInverter, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvBatteryVoltage=matInvBatteryVoltage, matInvMbsPosition=matInvMbsPosition, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsRunningMode=matStsRunningMode, matInvOutputVoltage=matInvOutputVoltage, matStsInvFail=matStsInvFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvNotRespond=matInvNotRespond, matStsMBSPosFault=matStsMBSPosFault, matStsOutputPower=matStsOutputPower, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConName=matConName, matConCommunicationLost=matConCommunicationLost, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvWarningState=matInvWarningState, matDryContactIndex=matDryContactIndex, matStsMainInputVoltage=matStsMainInputVoltage, matInvOutputShort=matInvOutputShort, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOutputVoltage=matStsOutputVoltage, PositiveInteger=PositiveInteger, matObjects=matObjects, NonNegativeInteger=NonNegativeInteger, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matSts=matSts, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable)
