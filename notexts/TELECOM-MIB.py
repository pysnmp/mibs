...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvNotRespond=matInvNotRespond, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsFanFault=matStsFanFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvEntry=matInvEntry, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matDryContactTable=matDryContactTable, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvSoftStartFail=matInvSoftStartFail, matStsHardwareVersion=matStsHardwareVersion, matInvOutputVoltage=matInvOutputVoltage, matInvOutputFreq=matInvOutputFreq, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsModuleNum=matStsModuleNum, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConWarningState=matConWarningState, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInverter=matInverter, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConBatteryLow=matConBatteryLow, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsMbsStatus=matStsMbsStatus, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfStsPriority=matConfStsPriority, matTrapTargetsTable=matTrapTargetsTable, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, device=device, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matController=matController, matStsOverLoad=matStsOverLoad, matInvFault=matInvFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matDryContact=matDryContact, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvPulseFault=matInvPulseFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConCommunicationLost=matConCommunicationLost, matTrapTargets=matTrapTargets, matInvMbsPosition=matInvMbsPosition, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysInputVolt=matConfInvSysInputVolt, matConCanBusOff=matConCanBusOff, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfStsFanSpeed=matConfStsFanSpeed, matStsEntry=matStsEntry, matInvNegativePowerProtect=matInvNegativePowerProtect, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConEEPROMFault=matConEEPROMFault, matConfInvSysPriority=matConfInvSysPriority, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matAgent=matAgent, matStsSerialNum=matStsSerialNum, NonNegativeInteger=NonNegativeInteger, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsRuntime=matStsRuntime, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapType=matTrapType, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMainUnavailable=matInvMainUnavailable, matInvRunTime=matInvRunTime, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvLineFreq=matInvLineFreq, matStsStatus=matStsStatus, ppc=ppc, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matDryContactIndex=matDryContactIndex, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsModuleType=matStsModuleType, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvPhaseType=matInvPhaseType, PositiveInteger=PositiveInteger, matStsInvFail=matStsInvFail, matStsNotRespond=matStsNotRespond, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOutputPower=matStsOutputPower, matDryContactString=matDryContactString, matInvTable=matInvTable, matTraps=matTraps, matStsOutputFreq=matStsOutputFreq, matInvRunMode=matInvRunMode, matStsInvInputFreq=matStsInvInputFreq, matStsOutputVoltage=matStsOutputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matStsMainsFail=matStsMainsFail, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputPower=matInvOutputPower, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvHardwareVersion=matInvHardwareVersion, matStsTemperature=matStsTemperature, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConTemperatureHigh=matConTemperatureHigh, matInvTemperature=matInvTemperature, matTrapTargetsDesc=matTrapTargetsDesc, matDryContactNum=matDryContactNum, matInvFanFault=matInvFanFault, matStsControlPowerFail=matStsControlPowerFail, matInvModuleNum=matInvModuleNum, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputCurrent=matInvOutputCurrent, matConTemperature=matConTemperature, matInvPowerLimit=matInvPowerLimit, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsFaultMode=matStsFaultMode, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsBypassUnavailable=matStsBypassUnavailable, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvFault=matReturnFromInvFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvWarningState=matInvWarningState, matDryContactEntry=matDryContactEntry, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConSerialNum=matConSerialNum, matConfInvOutputFreq=matConfInvOutputFreq, matStsModuleIndex=matStsModuleIndex, matStsTemperatureHigh=matStsTemperatureHigh, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainInputFreq=matStsMainInputFreq, matConfig=matConfig, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matObjects=matObjects, matInvHardwareError=matInvHardwareError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsOutputCurrent=matStsOutputCurrent, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsOutputAbnormal=matStsOutputAbnormal, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargetsEntry=matTrapTargetsEntry, matInvLineVoltage=matInvLineVoltage, matInvMBSPosError=matInvMBSPosError, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOutputShort=matInvOutputShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsWarningState=matStsWarningState, matTrapTargetsIndex=matTrapTargetsIndex, matStsMainInputVoltage=matStsMainInputVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matSts=matSts, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsTable=matStsTable, matStsMBSPosFault=matStsMBSPosFault, matInvSerialNum=matInvSerialNum, matInvPriority=matInvPriority, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConName=matConName, matInvOverLoad=matInvOverLoad, matStsRunningMode=matStsRunningMode)
