...
Integer32, IpAddress, NotificationType, Counter32, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, ObjectIdentity, Gauge32, NotificationType, Bits, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "NotificationType", "Counter32", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Gauge32", "NotificationType", "Bits", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsCommunity=matTrapTargetsCommunity, matInvBatteryVoltage=matInvBatteryVoltage, matDryContactNum=matDryContactNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvHardwareError=matInvHardwareError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvFirmwareVersion=matInvFirmwareVersion, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matDryContactIndex=matDryContactIndex, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matStsMBSPosFault=matStsMBSPosFault, matStsEntry=matStsEntry, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapType=matTrapType, matConTemperature=matConTemperature, matInvPriority=matInvPriority, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsControlPowerFail=matStsControlPowerFail, matInvOverLoad=matInvOverLoad, matStsTemperature=matStsTemperature, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvInputAbnormal=matInvInputAbnormal, matInvPhaseType=matInvPhaseType, matInvLineFreq=matInvLineFreq, matStsOutputAbnormal=matStsOutputAbnormal, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsFaultMode=matStsFaultMode, matInvMBSPosError=matInvMBSPosError, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputVoltage=matConfInvOutputVoltage, ppc=ppc, matTrapTargetsDesc=matTrapTargetsDesc, matStsWarningState=matStsWarningState, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConTemperatureHigh=matConTemperatureHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsRunningMode=matStsRunningMode, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConSerialNum=matConSerialNum, matInvFault=matInvFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvOutputVoltage=matInvOutputVoltage, matInvOutputPower=matInvOutputPower, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvSysPriority=matConfInvSysPriority, matStsModuleType=matStsModuleType, matInvMainUnavailable=matInvMainUnavailable, matInvPulseFault=matInvPulseFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsInvFail=matStsInvFail, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvTemperature=matInvTemperature, matConName=matConName, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvNotRespond=matInvNotRespond, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargets=matTrapTargets, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matInvOnOffStatus=matInvOnOffStatus, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matConCommunicationLost=matConCommunicationLost, matConfStsPriority=matConfStsPriority, matInvEPOShutdown=matInvEPOShutdown, matDryContactString=matDryContactString, matInvModuleIndex=matInvModuleIndex, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConBatteryLow=matConBatteryLow, matTrapTargetsNum=matTrapTargetsNum, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, device=device, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matController=matController, matInvEEPROMFault=matInvEEPROMFault, matInvRunMode=matInvRunMode, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matObjects=matObjects, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvRunTime=matInvRunTime, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOutputCurrent=matStsOutputCurrent, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfig=matConfig, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, PositiveInteger=PositiveInteger, matStsBypassUnavailable=matStsBypassUnavailable, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEntry=matInvEntry, matDryContact=matDryContact, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsStatus=matStsStatus, matSts=matSts, matInvModuleNum=matInvModuleNum, matConfInvOutputPower=matConfInvOutputPower, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvMbsPosition=matInvMbsPosition, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsSerialNum=matStsSerialNum, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsOverLoad=matStsOverLoad, matDryContactEntry=matDryContactEntry, NonNegativeInteger=NonNegativeInteger, matStsOutputPower=matStsOutputPower, matInvPowerLimit=matInvPowerLimit, matStsHardwareVersion=matStsHardwareVersion, matInvLineVoltage=matInvLineVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matDryContactTable=matDryContactTable, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvLowInputShutdown=matInvLowInputShutdown, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConEEPROMFault=matConEEPROMFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTraps=matTraps, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsTable=matStsTable, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvBypassMode=matStsInvBypassMode, matStsMainsFail=matStsMainsFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsModuleNum=matStsModuleNum, matInvTable=matInvTable, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputFreq=matInvOutputFreq, matConCanBusOff=matConCanBusOff, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvWarningState=matInvWarningState, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputCurrent=matInvOutputCurrent, matStsRuntime=matStsRuntime, matInvSerialNum=matInvSerialNum, matConfInvOutputFreq=matConfInvOutputFreq, matAgentSoftwareVerison=matAgentSoftwareVerison, matConWarningState=matConWarningState, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsModuleIndex=matStsModuleIndex, matStsFanFault=matStsFanFault, matAgent=matAgent, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsEEPROMFault=matStsEEPROMFault, matInvFanFault=matInvFanFault, matConfStsFanSpeed=matConfStsFanSpeed, matInverter=matInverter, matStsTemperatureHigh=matStsTemperatureHigh, matInvOutputShort=matInvOutputShort, matInvHardwareVersion=matInvHardwareVersion, matStsOutputFreq=matStsOutputFreq, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsNotRespond=matStsNotRespond, matInvTemperatureHigh=matInvTemperatureHigh)
