...
mibBuilder.exportSymbols("TELECOM-MIB", matInvMbsPosition=matInvMbsPosition, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, PositiveInteger=PositiveInteger, matStsWarningState=matStsWarningState, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, device=device, matStsModuleNum=matStsModuleNum, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvPulseFault=matInvPulseFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfStsPriority=matConfStsPriority, matStsEntry=matStsEntry, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvLowInputShutdown=matInvLowInputShutdown, matStsOutputFreq=matStsOutputFreq, matInvOutputCurrent=matInvOutputCurrent, matAgent=matAgent, matInvOutputVoltage=matInvOutputVoltage, matInvOverLoad=matInvOverLoad, matStsMbsStatus=matStsMbsStatus, matTrapTargetsNum=matTrapTargetsNum, matInvTempPowerLimit=matInvTempPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matDryContactNum=matDryContactNum, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsInvInputVoltage=matStsInvInputVoltage, matStsSerialNum=matStsSerialNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsOutputPower=matStsOutputPower, matInvEPOShutdown=matInvEPOShutdown, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsInvFail=matStsInvFail, matConSerialNum=matConSerialNum, matDryContactEntry=matDryContactEntry, matStsFanFault=matStsFanFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargets=matTrapTargets, matStsRuntime=matStsRuntime, matDryContact=matDryContact, matStsFaultMode=matStsFaultMode, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, ppc=ppc, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvNotRespond=matInvNotRespond, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConName=matConName, matStsTable=matStsTable, matInvPhaseType=matInvPhaseType, matInvFirmwareVersion=matInvFirmwareVersion, matInvBatteryVoltage=matInvBatteryVoltage, matInvTable=matInvTable, matStsRunningMode=matStsRunningMode, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matController=matController, matStsFirmwareVersion=matStsFirmwareVersion, matDryContactString=matDryContactString, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvWarningState=matInvWarningState, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvFanFault=matInvFanFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsTable=matTrapTargetsTable, matConCanBusOff=matConCanBusOff, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputFreq=matInvOutputFreq, matInvPowerLimit=matInvPowerLimit, matInvEEPROMFault=matInvEEPROMFault, matInvLineFreq=matInvLineFreq, matConfInvInputVoltage=matConfInvInputVoltage, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvSerialNum=matInvSerialNum, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matTrapTargetsEntry=matTrapTargetsEntry, matInvBusSoftFail=matInvBusSoftFail, matInvFault=matInvFault, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOverLoad=matStsOverLoad, matInvMainUnavailable=matInvMainUnavailable, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvHardwareError=matInvHardwareError, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConEEPROMFault=matConEEPROMFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsNotRespond=matStsNotRespond, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matSts=matSts, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsMainsFail=matStsMainsFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matTraps=matTraps, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvPriority=matInvPriority, matInvTemperature=matInvTemperature, matStsMainInputVoltage=matStsMainInputVoltage, matInvOutputPower=matInvOutputPower, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvModuleNum=matInvModuleNum, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsModuleIndex=matStsModuleIndex, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsControlPowerFail=matStsControlPowerFail, matInvOutputVoltLow=matInvOutputVoltLow, matInvBypassSCRShort=matInvBypassSCRShort, matStsStatus=matStsStatus, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvLineVoltage=matInvLineVoltage, matReturnFromInvFault=matReturnFromInvFault, matConTemperature=matConTemperature, matStsOutputCurrent=matStsOutputCurrent, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvBypassMode=matStsInvBypassMode, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConCommunicationLost=matConCommunicationLost, matConfInvSysPriority=matConfInvSysPriority, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvOutputPower=matConfInvOutputPower, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvMBSPosError=matInvMBSPosError, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsInvInputFreq=matStsInvInputFreq, matStsBypassUnavailable=matStsBypassUnavailable, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsModuleType=matStsModuleType, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsTemperature=matStsTemperature, matInvModuleIndex=matInvModuleIndex, matInverter=matInverter, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContactIndex=matDryContactIndex, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvRunTime=matInvRunTime, matConWarningState=matConWarningState, matStsMBSPosFault=matStsMBSPosFault, matObjects=matObjects, NonNegativeInteger=NonNegativeInteger, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvEntry=matInvEntry, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfig=matConfig, matDryContactTable=matDryContactTable, matStsOutputAbnormal=matStsOutputAbnormal, matInvRunMode=matInvRunMode, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapType=matTrapType, matConBatteryLow=matConBatteryLow, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvSoftStartFail=matInvSoftStartFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matTrapSeverityLevel=matTrapSeverityLevel, matInvOutputShort=matInvOutputShort, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConTemperatureHigh=matConTemperatureHigh)
