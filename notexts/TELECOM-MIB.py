...
Gauge32, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, Integer32, TimeTicks, Unsigned32, iso, NotificationType, Counter32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "Integer32", "TimeTicks", "Unsigned32", "iso", "NotificationType", "Counter32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvEPOShutdown=matInvEPOShutdown, matInvFanFault=matInvFanFault, matStsOutputCurrent=matStsOutputCurrent, matInvPowerLimit=matInvPowerLimit, matInverter=matInverter, matInvMbsPosition=matInvMbsPosition, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConEEPROMFault=matConEEPROMFault, matStsStatus=matStsStatus, matInvOutputFreq=matInvOutputFreq, matStsModuleNum=matStsModuleNum, matDryContact=matDryContact, matInvWarningState=matInvWarningState, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsMainFail=matReturnFromStsMainFail, matController=matController, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvOutputVoltHigh=matInvOutputVoltHigh, PositiveInteger=PositiveInteger, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfStsPriority=matConfStsPriority, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsEntry=matStsEntry, matInvRunTime=matInvRunTime, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvFirmwareVersion=matInvFirmwareVersion, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContactNum=matDryContactNum, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputFreq=matConfInvOutputFreq, matTrapTargetsDesc=matTrapTargetsDesc, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvTempPowerLimit=matInvTempPowerLimit, matStsOverLoad=matStsOverLoad, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConCommunicationLost=matConCommunicationLost, matConfInvSysPriority=matConfInvSysPriority, matConfig=matConfig, matStsMainInputFreq=matStsMainInputFreq, matDryContactTable=matDryContactTable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matInvSerialNum=matInvSerialNum, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOnOffStatus=matInvOnOffStatus, matTrapTargets=matTrapTargets, matStsFanFault=matStsFanFault, matDryContactIndex=matDryContactIndex, matObjects=matObjects, matInvPulseFault=matInvPulseFault, matStsTemperatureHigh=matStsTemperatureHigh, matInvRunMode=matInvRunMode, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvPriority=matInvPriority, matInvPhaseType=matInvPhaseType, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsOutputPower=matStsOutputPower, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsMainsFail=matStsMainsFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConSerialNum=matConSerialNum, matInvOutputShort=matInvOutputShort, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsMBSPosFault=matStsMBSPosFault, matStsMbsStatus=matStsMbsStatus, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvHardwareVersion=matInvHardwareVersion, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapType=matTrapType, matStsOutputAbnormal=matStsOutputAbnormal, matStsHardwareVersion=matStsHardwareVersion, matTrapSeverityLevel=matTrapSeverityLevel, matTraps=matTraps, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvNotRespond=matInvNotRespond, matConName=matConName, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvFanFault=matReturnFromInvFanFault, matConBatteryLow=matConBatteryLow, matInvBatteryVoltage=matInvBatteryVoltage, matInvMBSPosError=matInvMBSPosError, matStsNotRespond=matStsNotRespond, matStsInvInputVoltage=matStsInvInputVoltage, matInvHardwareError=matInvHardwareError, matInvTemperature=matInvTemperature, matStsFaultMode=matStsFaultMode, matInvFault=matInvFault, matInvMainUnavailable=matInvMainUnavailable, matConCanBusOff=matConCanBusOff, matStsInvFail=matStsInvFail, matStsBypassUnavailable=matStsBypassUnavailable, matInvLineFreq=matInvLineFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsTable=matStsTable, matStsInvBypassMode=matStsInvBypassMode, matInvOutputPower=matInvOutputPower, matDryContactEntry=matDryContactEntry, matAgent=matAgent, matStsOutputFreq=matStsOutputFreq, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvOutputCurrent=matInvOutputCurrent, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConWarningState=matConWarningState, matInvLowInputShutdown=matInvLowInputShutdown, matConTemperatureHigh=matConTemperatureHigh, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsRuntime=matStsRuntime, matInvModuleNum=matInvModuleNum, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsControlPowerFail=matStsControlPowerFail, matInvEntry=matInvEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, NonNegativeInteger=NonNegativeInteger, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsRunningMode=matStsRunningMode, matConTemperature=matConTemperature, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsNum=matTrapTargetsNum, matInvTable=matInvTable, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsMainInputVoltage=matStsMainInputVoltage, matSts=matSts, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvLineVoltage=matInvLineVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsOutputVoltage=matStsOutputVoltage, ppc=ppc, matStsModuleIndex=matStsModuleIndex, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvBusSoftFail=matInvBusSoftFail, matStsWarningState=matStsWarningState, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvModuleIndex=matInvModuleIndex, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsSerialNum=matStsSerialNum, matStsModuleType=matStsModuleType, matStsInvInputFreq=matStsInvInputFreq, device=device, matConfInvInputVoltage=matConfInvInputVoltage, matStsTemperature=matStsTemperature, matReturnFromInvFault=matReturnFromInvFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvOutputVoltage=matInvOutputVoltage, matDryContactString=matDryContactString, matTrapTargetsAddress=matTrapTargetsAddress, matInvOverLoad=matInvOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail)
