...
ObjectIdentity, Counter32, TimeTicks, MibIdentifier, Integer32, Unsigned32, IpAddress, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Gauge32, enterprises, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "IpAddress", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Gauge32", "enterprises", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsModuleNum=matStsModuleNum, device=device, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvHardwareVersion=matInvHardwareVersion, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvTable=matInvTable, matInvLineFreq=matInvLineFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvFault=matReturnFromInvFault, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapTargetsTable=matTrapTargetsTable, matInvHardwareError=matInvHardwareError, matStsStatus=matStsStatus, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matTrapTargetsDesc=matTrapTargetsDesc, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConTemperature=matConTemperature, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactNum=matDryContactNum, matInvPowerLimit=matInvPowerLimit, matStsOutputVoltage=matStsOutputVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matDryContactTable=matDryContactTable, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsTable=matStsTable, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsMainInputFreq=matStsMainInputFreq, matConfInvInputVoltage=matConfInvInputVoltage, matInvEPOShutdown=matInvEPOShutdown, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvOutputFreq=matConfInvOutputFreq, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsFanFault=matStsFanFault, matStsInvFail=matStsInvFail, matStsMBSPosFault=matStsMBSPosFault, matConCanBusOff=matConCanBusOff, matConBatteryLow=matConBatteryLow, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsOutputPower=matStsOutputPower, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfStsPriority=matConfStsPriority, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsRuntime=matStsRuntime, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvOutputVoltage=matInvOutputVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matInvOutputPower=matInvOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsMainInputVoltage=matStsMainInputVoltage, matDryContactString=matDryContactString, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsTemperatureHigh=matStsTemperatureHigh, matInvOutputVoltLow=matInvOutputVoltLow, matConfig=matConfig, matInvOutputVoltHigh=matInvOutputVoltHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvRunMode=matInvRunMode, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvPhaseType=matInvPhaseType, matInvPulseFault=matInvPulseFault, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matSts=matSts, matInvMBSPosError=matInvMBSPosError, matStsInvBypassMode=matStsInvBypassMode, matInvTemperatureHigh=matInvTemperatureHigh, matInvOutputFreq=matInvOutputFreq, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvWarningState=matInvWarningState, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, PositiveInteger=PositiveInteger, matInvModuleIndex=matInvModuleIndex, matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsBypassUnavailable=matStsBypassUnavailable, matController=matController, matInvModuleNum=matInvModuleNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvFault=matInvFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvNotRespond=matInvNotRespond, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvOutputCurrent=matInvOutputCurrent, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvSoftStartFail=matInvSoftStartFail, matStsOutputFreq=matStsOutputFreq, matConName=matConName, matConWarningState=matConWarningState, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvTemperature=matInvTemperature, matInvSerialNum=matInvSerialNum, matStsModuleIndex=matStsModuleIndex, matTrapTargets=matTrapTargets, matStsOverLoad=matStsOverLoad, matStsRunningMode=matStsRunningMode, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvFanFault=matInvFanFault, matInverter=matInverter, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matObjects=matObjects, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsControlPowerFail=matStsControlPowerFail, matInvMbsPosition=matInvMbsPosition, matStsOutputAbnormal=matStsOutputAbnormal, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvEntry=matInvEntry, ppc=ppc, matStsWarningState=matStsWarningState, matStsNotRespond=matStsNotRespond, matInvPriority=matInvPriority, matInvBusSoftFail=matInvBusSoftFail, matStsSerialNum=matStsSerialNum, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvOverLoad=matInvOverLoad, matStsTemperature=matStsTemperature, matStsMainsFail=matStsMainsFail, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matDryContactEntry=matDryContactEntry, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsModuleType=matStsModuleType, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, NonNegativeInteger=NonNegativeInteger, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvOutputShort=matInvOutputShort, matStsEntry=matStsEntry, matInvLineVoltage=matInvLineVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConEEPROMFault=matConEEPROMFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matDryContact=matDryContact, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFaultMode=matStsFaultMode, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConTemperatureHigh=matConTemperatureHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsEntry=matTrapTargetsEntry, matDryContactIndex=matDryContactIndex, matInvInputAbnormal=matInvInputAbnormal, matTrapType=matTrapType, matConCommunicationLost=matConCommunicationLost, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvRunTime=matInvRunTime, matTraps=matTraps, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvFirmwareVersion=matInvFirmwareVersion, matStsInvInputVoltage=matStsInvInputVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matAgent=matAgent, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConSerialNum=matConSerialNum, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvBatteryVoltage=matInvBatteryVoltage, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail)
