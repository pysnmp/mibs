...
NotificationType, ModuleIdentity, Unsigned32, Gauge32, Counter64, enterprises, NotificationType, TimeTicks, IpAddress, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter64", "enterprises", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvRunMode=matInvRunMode, matConTemperature=matConTemperature, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvFault=matReturnFromInvFault, matStsModuleType=matStsModuleType, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsAddress=matTrapTargetsAddress, matStsTemperatureHigh=matStsTemperatureHigh, matInvNotRespond=matInvNotRespond, matInvOutputVoltLow=matInvOutputVoltLow, matConBatteryLow=matConBatteryLow, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matDryContact=matDryContact, matStsFaultMode=matStsFaultMode, matStsEntry=matStsEntry, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMainsFail=matStsMainsFail, matInvMbsPosition=matInvMbsPosition, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvLineVoltage=matInvLineVoltage, matTrapType=matTrapType, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfStsPriority=matConfStsPriority, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConName=matConName, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsOutputCurrent=matStsOutputCurrent, matDryContactNum=matDryContactNum, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matInverter=matInverter, matInvOutputFreq=matInvOutputFreq, matStsInvBypassMode=matStsInvBypassMode, matInvTable=matInvTable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, device=device, matInvOutputVoltage=matInvOutputVoltage, matTrapTargets=matTrapTargets, matSts=matSts, matDryContactTable=matDryContactTable, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsInvFail=matStsInvFail, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOutputPower=matInvOutputPower, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTraps=matTraps, matTrapTargetsNum=matTrapTargetsNum, matAgent=matAgent, matConSerialNum=matConSerialNum, matConWarningState=matConWarningState, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, matStsEEPROMFault=matStsEEPROMFault, NonNegativeInteger=NonNegativeInteger, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvWarningState=matInvWarningState, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsOutputAbnormal=matStsOutputAbnormal, matConEEPROMFault=matConEEPROMFault, matInvEntry=matInvEntry, matInvModuleIndex=matInvModuleIndex, matStsControlPowerFail=matStsControlPowerFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matController=matController, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsInvInputFreq=matStsInvInputFreq, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvBatteryVoltage=matInvBatteryVoltage, matConCommunicationLost=matConCommunicationLost, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvSysInputVolt=matConfInvSysInputVolt, matConTemperatureHigh=matConTemperatureHigh, matInvPriority=matInvPriority, matDryContactString=matDryContactString, matStsRuntime=matStsRuntime, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsWarningState=matStsWarningState, matInvMBSPosError=matInvMBSPosError, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvPulseFault=matInvPulseFault, matInvLineFreq=matInvLineFreq, matConCanBusOff=matConCanBusOff, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsModuleNum=matStsModuleNum, matStsOverLoad=matStsOverLoad, matInvOutputShort=matInvOutputShort, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsSerialNum=matStsSerialNum, matDryContactIndex=matDryContactIndex, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvEPOShutdown=matInvEPOShutdown, matInvHardwareError=matInvHardwareError, matStsFanFault=matStsFanFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvHardwareVersion=matInvHardwareVersion, matStsMbsStatus=matStsMbsStatus, ppc=ppc, matConfig=matConfig, matConfInvSysPriority=matConfInvSysPriority, matInvFault=matInvFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOutputVoltage=matStsOutputVoltage, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvInputVoltage=matConfInvInputVoltage, matStsStatus=matStsStatus, matStsNotRespond=matStsNotRespond, matInvPowerLimit=matInvPowerLimit, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsEntry=matTrapTargetsEntry, matInvOutputCurrent=matInvOutputCurrent, matStsOutputFreq=matStsOutputFreq, matStsTemperature=matStsTemperature, matTrapTargetsIndex=matTrapTargetsIndex, matInvModuleNum=matInvModuleNum, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsRunningMode=matStsRunningMode, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactEntry=matDryContactEntry, matInvOnOffStatus=matInvOnOffStatus, matStsTable=matStsTable, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvTempPowerLimit=matInvTempPowerLimit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvFanFault=matInvFanFault, matStsModuleIndex=matStsModuleIndex, matInvOverLoad=matInvOverLoad, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matObjects=matObjects, matConfInvOutputPower=matConfInvOutputPower, matStsOutputPower=matStsOutputPower, matStsMainInputVoltage=matStsMainInputVoltage, matStsMainInputFreq=matStsMainInputFreq, matInvRunTime=matInvRunTime, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matTrapTargetsDesc=matTrapTargetsDesc, matInvPhaseType=matInvPhaseType, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, PositiveInteger=PositiveInteger, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvTemperature=matInvTemperature, matStsMBSPosFault=matStsMBSPosFault, matInvSerialNum=matInvSerialNum, matConfInvSysFanSpeed=matConfInvSysFanSpeed)
