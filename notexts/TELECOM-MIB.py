...
NotificationType, TimeTicks, Bits, iso, Counter32, NotificationType, enterprises, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, MibIdentifier, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Bits", "iso", "Counter32", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "MibIdentifier", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapSeverityLevel=matTrapSeverityLevel, matConCommunicationLost=matConCommunicationLost, matTrapTargetsCommunity=matTrapTargetsCommunity, matDryContactIndex=matDryContactIndex, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMBSPosFault=matStsMBSPosFault, matInvOutputPower=matInvOutputPower, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvWarningState=matInvWarningState, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConTemperatureHigh=matConTemperatureHigh, matConCanBusOff=matConCanBusOff, matStsSerialNum=matStsSerialNum, matInvNegativePowerProtect=matInvNegativePowerProtect, matController=matController, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTraps=matTraps, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfStsPriority=matConfStsPriority, matDryContactEntry=matDryContactEntry, matStsOutputCurrent=matStsOutputCurrent, matInvModuleIndex=matInvModuleIndex, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMbsPosition=matInvMbsPosition, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matTrapTargetsIndex=matTrapTargetsIndex, matInvOverLoad=matInvOverLoad, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvInputAbnormal=matInvInputAbnormal, matConfInvOutputVoltage=matConfInvOutputVoltage, matDryContactTable=matDryContactTable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsModuleNum=matStsModuleNum, matConfig=matConfig, ppc=ppc, matTrapTargetsDesc=matTrapTargetsDesc, matStsEntry=matStsEntry, matStsFirmwareVersion=matStsFirmwareVersion, matInvBusSoftFail=matInvBusSoftFail, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInverter=matInverter, matInvLineFreq=matInvLineFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvPriority=matInvPriority, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConTemperature=matConTemperature, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsRuntime=matStsRuntime, matStsStatus=matStsStatus, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matDryContact=matDryContact, matStsModuleType=matStsModuleType, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvBypassSCRShort=matInvBypassSCRShort, matDryContactNum=matDryContactNum, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsFanFault=matReturnFromStsFanFault, device=device, matInvOutputFreq=matInvOutputFreq, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsFaultMode=matStsFaultMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvTempPowerLimit=matInvTempPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConBatteryLow=matConBatteryLow, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvTable=matInvTable, matStsControlPowerFail=matStsControlPowerFail, matStsHardwareVersion=matStsHardwareVersion, matStsTable=matStsTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvModuleNum=matInvModuleNum, matInvPhaseType=matInvPhaseType, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsRunningMode=matStsRunningMode, matStsNotRespond=matStsNotRespond, matConfInvOutputPower=matConfInvOutputPower, matDryContactString=matDryContactString, matConfStsFanSpeed=matConfStsFanSpeed, matInvRunMode=matInvRunMode, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matStsWarningState=matStsWarningState, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOverLoad=matStsOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvOutputShort=matInvOutputShort, matStsTemperatureHigh=matStsTemperatureHigh, matStsOutputVoltage=matStsOutputVoltage, matObjects=matObjects, matInvLineVoltage=matInvLineVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvEPOShutdown=matInvEPOShutdown, PositiveInteger=PositiveInteger, matInvEntry=matInvEntry, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainInputFreq=matStsMainInputFreq, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matTrapTargetsNum=matTrapTargetsNum, matStsEEPROMFault=matStsEEPROMFault, matStsTemperature=matStsTemperature, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOutputFreq=matStsOutputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConBatteryVoltHigh=matConBatteryVoltHigh, matTrapTargets=matTrapTargets, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvFanFault=matInvFanFault, matAgent=matAgent, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvNotRespond=matInvNotRespond, matStsMainInputVoltage=matStsMainInputVoltage, matStsMainsFail=matStsMainsFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConEEPROMFault=matConEEPROMFault, matStsInvInputVoltage=matStsInvInputVoltage, matInvMBSPosError=matInvMBSPosError, matStsMbsStatus=matStsMbsStatus, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTrapType=matTrapType, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvHardwareVersion=matInvHardwareVersion, matConName=matConName, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matSts=matSts, matTrapTargetsTable=matTrapTargetsTable, matInvRunTime=matInvRunTime, matInvHardwareError=matInvHardwareError, matStsInvFail=matStsInvFail, matInvFault=matInvFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputVoltage=matInvOutputVoltage, matInvPulseFault=matInvPulseFault, matStsModuleIndex=matStsModuleIndex, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvEEPROMFault=matInvEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvSysInputVolt=matConfInvSysInputVolt, matConWarningState=matConWarningState, matInvSerialNum=matInvSerialNum, matStsOutputPower=matStsOutputPower, matConSerialNum=matConSerialNum, matReturnFromStsFaultMode=matReturnFromStsFaultMode, NonNegativeInteger=NonNegativeInteger, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvFault=matReturnFromInvFault, matInvPowerLimit=matInvPowerLimit, matStsFanFault=matStsFanFault, matInvTemperature=matInvTemperature, matInvSoftStartFail=matInvSoftStartFail, matInvTemperatureHigh=matInvTemperatureHigh)
