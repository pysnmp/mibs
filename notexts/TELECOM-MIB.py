...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Gauge32, MibIdentifier, NotificationType, ModuleIdentity, enterprises, NotificationType, iso, Counter64, TimeTicks, ObjectIdentity, Integer32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Gauge32", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "NotificationType", "iso", "Counter64", "TimeTicks", "ObjectIdentity", "Integer32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvMBSPosError=matInvMBSPosError, matStsOutputPower=matStsOutputPower, matStsEntry=matStsEntry, matStsOutputFreq=matStsOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOverLoad=matStsOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsWarningState=matStsWarningState, matStsInvInputFreq=matStsInvInputFreq, matTrapTargets=matTrapTargets, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvFault=matInvFault, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvTable=matInvTable, matTraps=matTraps, matInvOutputShort=matInvOutputShort, matStsControlPowerFail=matStsControlPowerFail, matInverter=matInverter, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsNum=matTrapTargetsNum, matDryContactIndex=matDryContactIndex, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvRunMode=matInvRunMode, matDryContact=matDryContact, matTrapTargetsTable=matTrapTargetsTable, matStsRuntime=matStsRuntime, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsMbsStatus=matStsMbsStatus, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsMBSPosFault=matStsMBSPosFault, matConName=matConName, matConTemperatureHigh=matConTemperatureHigh, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvHardwareError=matInvHardwareError, matConCanBusOff=matConCanBusOff, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvEntry=matInvEntry, ppc=ppc, matInvNotRespond=matInvNotRespond, matStsRunningMode=matStsRunningMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvMainUnavailable=matInvMainUnavailable, matObjects=matObjects, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOutputPower=matInvOutputPower, PositiveInteger=PositiveInteger, matConfInvOutputVoltage=matConfInvOutputVoltage, matConBatteryLow=matConBatteryLow, matInvPriority=matInvPriority, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfInvOutputPower=matConfInvOutputPower, matInvOutputFreq=matInvOutputFreq, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvFault=matReturnFromInvFault, matInvPulseFault=matInvPulseFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsTemperature=matStsTemperature, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvRunTime=matInvRunTime, matConSerialNum=matConSerialNum, matInvOverLoad=matInvOverLoad, matTrapTargetsIndex=matTrapTargetsIndex, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsSerialNum=matStsSerialNum, matController=matController, matDryContactTable=matDryContactTable, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsInvFail=matStsInvFail, matStsNotRespond=matStsNotRespond, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConTemperature=matConTemperature, matInvPhaseType=matInvPhaseType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matDryContactString=matDryContactString, matTrapTargetsDesc=matTrapTargetsDesc, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsFaultMode=matStsFaultMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvLineFreq=matInvLineFreq, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsOutputCurrent=matStsOutputCurrent, matConfInvInputVoltage=matConfInvInputVoltage, matInvBusSoftFail=matInvBusSoftFail, matConEEPROMFault=matConEEPROMFault, matStsMainsFail=matStsMainsFail, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvHardwareVersion=matInvHardwareVersion, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matAgent=matAgent, matInvLineVoltage=matInvLineVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvTemperatureHigh=matInvTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvEEPROMFault=matInvEEPROMFault, matStsTable=matStsTable, matInvModuleNum=matInvModuleNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsInvBypassMode=matStsInvBypassMode, matInvLowInputShutdown=matInvLowInputShutdown, matInvPowerLimit=matInvPowerLimit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, device=device, matStsEEPROMFault=matStsEEPROMFault, matStsModuleNum=matStsModuleNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsTemperatureHigh=matStsTemperatureHigh, matInvOutputCurrent=matInvOutputCurrent, matStsBypassUnavailable=matStsBypassUnavailable, matInvWarningState=matInvWarningState, matInvOutputVoltage=matInvOutputVoltage, matDryContactEntry=matDryContactEntry, matSts=matSts, matConWarningState=matConWarningState, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvModuleIndex=matInvModuleIndex, matConfig=matConfig, matStsFanFault=matStsFanFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsMainInputFreq=matStsMainInputFreq, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsModuleType=matStsModuleType, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvMbsPosition=matInvMbsPosition, matStsModuleIndex=matStsModuleIndex, matInvOutputVoltLow=matInvOutputVoltLow, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConCommunicationLost=matConCommunicationLost, NonNegativeInteger=NonNegativeInteger, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapType=matTrapType, matStsStatus=matStsStatus, matDryContactNum=matDryContactNum, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matTrapSeverityLevel=matTrapSeverityLevel, matTrapTargetsEntry=matTrapTargetsEntry, matInvSerialNum=matInvSerialNum, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvFanFault=matInvFanFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysPriority=matConfInvSysPriority, matInvTemperature=matInvTemperature, matConfStsFanSpeed=matConfStsFanSpeed, matConfStsPriority=matConfStsPriority, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsHardwareVersion=matStsHardwareVersion, matStsInvLosLossVoltage=matStsInvLosLossVoltage)
