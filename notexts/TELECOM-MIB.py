...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsInvFail=matStsInvFail, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOutputCurrent=matInvOutputCurrent, matInvTempPowerLimit=matInvTempPowerLimit, matInvPowerLimit=matInvPowerLimit, matInvLineFreq=matInvLineFreq, matStsModuleIndex=matStsModuleIndex, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsTemperature=matStsTemperature, matConfInvOutputFreq=matConfInvOutputFreq, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsFaultMode=matStsFaultMode, matInvRunMode=matInvRunMode, matConWarningState=matConWarningState, matInvEPOShutdown=matInvEPOShutdown, matStsOutputPower=matStsOutputPower, matInvPulseFault=matInvPulseFault, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsEntry=matTrapTargetsEntry, matInvNotRespond=matInvNotRespond, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConSerialNum=matConSerialNum, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapTargetsDesc=matTrapTargetsDesc, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEntry=matInvEntry, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsTable=matTrapTargetsTable, matInvEEPROMFault=matInvEEPROMFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsAddress=matTrapTargetsAddress, matConBatteryLow=matConBatteryLow, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsStatus=matStsStatus, matDryContactEntry=matDryContactEntry, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, device=device, matConfStsPriority=matConfStsPriority, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsTemperatureHigh=matStsTemperatureHigh, matConfig=matConfig, matTrapSeverityLevel=matTrapSeverityLevel, matInvModuleNum=matInvModuleNum, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConTemperature=matConTemperature, matStsInvInputFreq=matStsInvInputFreq, matTrapType=matTrapType, matInvBusSoftFail=matInvBusSoftFail, matStsOutputFreq=matStsOutputFreq, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvHardwareError=matInvHardwareError, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvWarningState=matInvWarningState, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvMainUnavailable=matInvMainUnavailable, matStsEEPROMFault=matStsEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matDryContact=matDryContact, matStsRunningMode=matStsRunningMode, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvHardwareVersion=matInvHardwareVersion, matStsMainInputFreq=matStsMainInputFreq, matInvLineVoltage=matInvLineVoltage, matController=matController, matStsWarningState=matStsWarningState, matTraps=matTraps, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsRuntime=matStsRuntime, matInvFault=matInvFault, matConCommunicationLost=matConCommunicationLost, matConCanBusOff=matConCanBusOff, matStsControlPowerFail=matStsControlPowerFail, NonNegativeInteger=NonNegativeInteger, matStsMBSPosFault=matStsMBSPosFault, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputPower=matInvOutputPower, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matDryContactString=matDryContactString, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsFanFault=matStsFanFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOverLoad=matStsOverLoad, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, PositiveInteger=PositiveInteger, matAgent=matAgent, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvRunTime=matInvRunTime, matInvModuleIndex=matInvModuleIndex, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matSts=matSts, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvLowInputShutdown=matInvLowInputShutdown, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInverter=matInverter, matStsEntry=matStsEntry, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvSerialNum=matInvSerialNum, ppc=ppc, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputFreq=matInvOutputFreq, matStsSerialNum=matStsSerialNum, matDryContactIndex=matDryContactIndex, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvPhaseType=matInvPhaseType, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConEEPROMFault=matConEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matConName=matConName, matStsHardwareVersion=matStsHardwareVersion, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsTable=matStsTable, matInvOverLoad=matInvOverLoad, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvMbsPosition=matInvMbsPosition, matStsModuleType=matStsModuleType, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matDryContactTable=matDryContactTable, matObjects=matObjects, matDryContactNum=matDryContactNum, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvOutputShort=matInvOutputShort, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsMainsFail=matStsMainsFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvTemperature=matInvTemperature, matStsNotRespond=matStsNotRespond, matStsOutputCurrent=matStsOutputCurrent, matInvMBSPosError=matInvMBSPosError, matTrapTargets=matTrapTargets, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsMbsStatus=matStsMbsStatus, matInvPriority=matInvPriority, matInvSoftStartFail=matInvSoftStartFail, matConTemperatureHigh=matConTemperatureHigh, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvTable=matInvTable, matStsModuleNum=matStsModuleNum, matInvFanFault=matInvFanFault, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvOutputPower=matConfInvOutputPower, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit)
