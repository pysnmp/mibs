...
mibBuilder.exportSymbols("TELECOM-MIB", matStsTable=matStsTable, matStsRunningMode=matStsRunningMode, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputPower=matInvOutputPower, matStsOverLoad=matStsOverLoad, matInvPhaseType=matInvPhaseType, matInvRunTime=matInvRunTime, matStsFaultMode=matStsFaultMode, matTraps=matTraps, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvPowerLimit=matInvPowerLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsMainsFail=matStsMainsFail, matConTemperature=matConTemperature, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvHardwareVersion=matInvHardwareVersion, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, ppc=ppc, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvPriority=matInvPriority, matStsMainInputFreq=matStsMainInputFreq, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsInvFail=matStsInvFail, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargetsTable=matTrapTargetsTable, matInvTemperatureHigh=matInvTemperatureHigh, matController=matController, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, NonNegativeInteger=NonNegativeInteger, PositiveInteger=PositiveInteger, matInvTemperature=matInvTemperature, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matObjects=matObjects, matStsOutputFreq=matStsOutputFreq, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOnOffStatus=matInvOnOffStatus, matDryContactIndex=matDryContactIndex, matInvEEPROMFault=matInvEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matInvEPOShutdown=matInvEPOShutdown, matInvMainUnavailable=matInvMainUnavailable, matStsOutputPower=matStsOutputPower, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConTemperatureHigh=matConTemperatureHigh, matInvWarningState=matInvWarningState, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsMbsStatus=matStsMbsStatus, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConName=matConName, device=device, matTrapSeverityLevel=matTrapSeverityLevel, matAgent=matAgent, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsHardwareVersion=matStsHardwareVersion, matInvTempPowerLimit=matInvTempPowerLimit, matTrapType=matTrapType, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvModuleNum=matInvModuleNum, matStsStatus=matStsStatus, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactString=matDryContactString, matInvBusSoftFail=matInvBusSoftFail, matInvModuleIndex=matInvModuleIndex, matInvOverLoad=matInvOverLoad, matInvOutputShort=matInvOutputShort, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvInputVoltage=matConfInvInputVoltage, matStsMBSPosFault=matStsMBSPosFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputCurrent=matInvOutputCurrent, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matDryContactTable=matDryContactTable, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConSerialNum=matConSerialNum, matStsModuleIndex=matStsModuleIndex, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConBatteryLow=matConBatteryLow, matTrapTargets=matTrapTargets, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsModuleNum=matStsModuleNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsFanFault=matStsFanFault, matDryContactNum=matDryContactNum, matInvPulseFault=matInvPulseFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvOutputVoltage=matInvOutputVoltage, matStsWarningState=matStsWarningState, matStsBypassUnavailable=matStsBypassUnavailable, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsOutputVoltage=matStsOutputVoltage, matStsTemperatureHigh=matStsTemperatureHigh, matInverter=matInverter, matStsSerialNum=matStsSerialNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvSerialNum=matInvSerialNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsNum=matTrapTargetsNum, matTrapTargetsAddress=matTrapTargetsAddress, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvBypassMode=matStsInvBypassMode, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsNotRespond=matStsNotRespond, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfStsPriority=matConfStsPriority, matInvInputAbnormal=matInvInputAbnormal, matTrapTargetsIndex=matTrapTargetsIndex, matStsEntry=matStsEntry, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvLineVoltage=matInvLineVoltage, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfig=matConfig, matStsTemperature=matStsTemperature, matStsEEPROMFault=matStsEEPROMFault, matConfStsFanSpeed=matConfStsFanSpeed, matInvMBSPosError=matInvMBSPosError, matInvOutputFreq=matInvOutputFreq, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvHardwareError=matInvHardwareError, matInvFanFault=matInvFanFault, matInvEntry=matInvEntry, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvBatteryVoltage=matInvBatteryVoltage, matConWarningState=matConWarningState, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsRuntime=matStsRuntime, matInvOutputVoltLow=matInvOutputVoltLow, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsControlPowerFail=matStsControlPowerFail, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsModuleType=matStsModuleType, matConEEPROMFault=matConEEPROMFault, matSts=matSts, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvMbsPosition=matInvMbsPosition, matInvNotRespond=matInvNotRespond, matTrapTargetsDesc=matTrapTargetsDesc, matStsFirmwareVersion=matStsFirmwareVersion, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvLineFreq=matInvLineFreq, matInvRunMode=matInvRunMode, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsInvFail=matReturnFromStsInvFail, matConCanBusOff=matConCanBusOff, matDryContactEntry=matDryContactEntry, matInvFault=matInvFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvTable=matInvTable, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matDryContact=matDryContact)
