...
NotificationType, IpAddress, Integer32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ObjectIdentity, NotificationType, ModuleIdentity, Counter64, TimeTicks, MibIdentifier, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Integer32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter64", "TimeTicks", "MibIdentifier", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsModuleIndex=matStsModuleIndex, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsOutputVoltage=matStsOutputVoltage, matInvSerialNum=matInvSerialNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsOverLoad=matStsOverLoad, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvMainUnavailable=matInvMainUnavailable, matStsStatus=matStsStatus, matStsRunningMode=matStsRunningMode, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysInputVolt=matConfInvSysInputVolt, matController=matController, matAgent=matAgent, matStsModuleNum=matStsModuleNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfig=matConfig, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvLineFreq=matInvLineFreq, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvOverLoad=matInvOverLoad, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvFanFault=matInvFanFault, matStsModuleType=matStsModuleType, matConfInvOutputFreq=matConfInvOutputFreq, matInvOnOffStatus=matInvOnOffStatus, matInvModuleNum=matInvModuleNum, matInvInputAbnormal=matInvInputAbnormal, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvOutputShort=matInvOutputShort, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvHardwareError=matInvHardwareError, matTrapType=matTrapType, matInvMbsPosition=matInvMbsPosition, matInvModuleIndex=matInvModuleIndex, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matInvOutputCurrent=matInvOutputCurrent, matInvRunTime=matInvRunTime, matObjects=matObjects, matStsMaintenanceBypass=matStsMaintenanceBypass, matTrapTargetsTable=matTrapTargetsTable, matStsNotRespond=matStsNotRespond, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTraps=matTraps, matConfStsFanSpeed=matConfStsFanSpeed, matConBatteryLow=matConBatteryLow, matConfInvOutputPower=matConfInvOutputPower, matInvHardwareVersion=matInvHardwareVersion, matConTemperatureHigh=matConTemperatureHigh, matInvTempPowerLimit=matInvTempPowerLimit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvBypassMode=matStsInvBypassMode, matStsControlPowerFail=matStsControlPowerFail, matStsOutputAbnormal=matStsOutputAbnormal, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsHardwareVersion=matStsHardwareVersion, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsOutputPower=matStsOutputPower, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matDryContactString=matDryContactString, matStsBypassUnavailable=matStsBypassUnavailable, matTrapTargets=matTrapTargets, matStsWarningState=matStsWarningState, matConCanBusOff=matConCanBusOff, matConCommunicationLost=matConCommunicationLost, matConTemperature=matConTemperature, matDryContactTable=matDryContactTable, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputFreq=matInvOutputFreq, NonNegativeInteger=NonNegativeInteger, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsMainsFail=matStsMainsFail, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargetsAddress=matTrapTargetsAddress, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvEntry=matInvEntry, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInverter=matInverter, matDryContactEntry=matDryContactEntry, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvOutputVoltage=matInvOutputVoltage, matStsTemperature=matStsTemperature, matTrapTargetsDesc=matTrapTargetsDesc, matInvPhaseType=matInvPhaseType, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matDryContactNum=matDryContactNum, matInvLineVoltage=matInvLineVoltage, matConName=matConName, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsOutputShortCircuit=matStsOutputShortCircuit, matConWarningState=matConWarningState, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapSeverityLevel=matTrapSeverityLevel, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsOutputFreq=matStsOutputFreq, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputPower=matInvOutputPower, matInvTable=matInvTable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matInvBatteryVoltage=matInvBatteryVoltage, matStsTable=matStsTable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvNotRespond=matInvNotRespond, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMainInputVoltage=matStsMainInputVoltage, matStsInvFail=matStsInvFail, ppc=ppc, matInvWarningState=matInvWarningState, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFaultMode=matStsFaultMode, matInvMBSPosError=matInvMBSPosError, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMBSPosFault=matStsMBSPosFault, matInvBypassSCRShort=matInvBypassSCRShort, matInvPowerLimit=matInvPowerLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvRunMode=matInvRunMode, matStsRuntime=matStsRuntime, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsInvInputVoltage=matStsInvInputVoltage, matStsOutputCurrent=matStsOutputCurrent, matStsFanFault=matStsFanFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matDryContactIndex=matDryContactIndex, matConfStsPriority=matConfStsPriority, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvFault=matInvFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matDryContact=matDryContact, matConEEPROMFault=matConEEPROMFault, matReturnFromInvFanFault=matReturnFromInvFanFault, device=device, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matSts=matSts, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsFirmwareVersion=matStsFirmwareVersion, matInvPulseFault=matInvPulseFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvPriority=matInvPriority, matInvFirmwareVersion=matInvFirmwareVersion, matStsEntry=matStsEntry, matInvOutputVoltHigh=matInvOutputVoltHigh, PositiveInteger=PositiveInteger, matInvSoftStartFail=matInvSoftStartFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEEPROMFault=matInvEEPROMFault, matStsSerialNum=matStsSerialNum, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvTemperature=matInvTemperature, matInvBusSoftFail=matInvBusSoftFail, matConSerialNum=matConSerialNum)
