...
iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, ModuleIdentity, Unsigned32, NotificationType, enterprises, MibIdentifier, IpAddress, Counter64, TimeTicks, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "ModuleIdentity", "Unsigned32", "NotificationType", "enterprises", "MibIdentifier", "IpAddress", "Counter64", "TimeTicks", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMainInputVoltage=matStsMainInputVoltage, matTrapTargetsAddress=matTrapTargetsAddress, matInvSoftStartFail=matInvSoftStartFail, matInvBypassSCRShort=matInvBypassSCRShort, matInvPriority=matInvPriority, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, device=device, matInvOverLoad=matInvOverLoad, matInvHardwareVersion=matInvHardwareVersion, matTrapTargetsNum=matTrapTargetsNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsModuleNum=matStsModuleNum, matInvOutputVoltLow=matInvOutputVoltLow, matInvOutputVoltage=matInvOutputVoltage, matStsTemperature=matStsTemperature, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsEntry=matTrapTargetsEntry, matConCanBusOff=matConCanBusOff, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConWarningState=matConWarningState, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsInvFail=matReturnFromStsInvFail, matController=matController, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvInputVoltage=matConfInvInputVoltage, matObjects=matObjects, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvTable=matInvTable, matStsControlPowerFail=matStsControlPowerFail, matStsNotRespond=matStsNotRespond, matInvRunMode=matInvRunMode, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsOutputFreq=matStsOutputFreq, matInvOnOffStatus=matInvOnOffStatus, matInvPhaseType=matInvPhaseType, matInvPowerLimit=matInvPowerLimit, matStsOutputCurrent=matStsOutputCurrent, matInvEntry=matInvEntry, matStsInvFail=matStsInvFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsInvInputVoltage=matStsInvInputVoltage, matStsInvInputFreq=matStsInvInputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapSeverityLevel=matTrapSeverityLevel, matConEEPROMFault=matConEEPROMFault, matInvLineFreq=matInvLineFreq, matConfStsPriority=matConfStsPriority, matConBatteryLow=matConBatteryLow, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvPulseFault=matInvPulseFault, matSts=matSts, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsMainInputFreq=matStsMainInputFreq, matInvBatteryVoltage=matInvBatteryVoltage, matInvFanFault=matInvFanFault, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsModuleIndex=matStsModuleIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matDryContactEntry=matDryContactEntry, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsFanFault=matStsFanFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matAgent=matAgent, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvOutputCurrent=matInvOutputCurrent, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConName=matConName, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsStatus=matStsStatus, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matTraps=matTraps, matInvHardwareError=matInvHardwareError, matInvRunTime=matInvRunTime, matInverter=matInverter, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContactTable=matDryContactTable, matInvOutputShort=matInvOutputShort, matInvOutputFreq=matInvOutputFreq, matInvFault=matInvFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapType=matTrapType, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsOutputPower=matStsOutputPower, matInvLowInputShutdown=matInvLowInputShutdown, matConSerialNum=matConSerialNum, ppc=ppc, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsTemperatureHigh=matStsTemperatureHigh, matStsModuleType=matStsModuleType, matInvEPOShutdown=matInvEPOShutdown, PositiveInteger=PositiveInteger, matStsTable=matStsTable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputPower=matInvOutputPower, matInvModuleIndex=matInvModuleIndex, matInvInputAbnormal=matInvInputAbnormal, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvNotRespond=matInvNotRespond, matDryContactIndex=matDryContactIndex, matStsEntry=matStsEntry, matAgentSoftwareVerison=matAgentSoftwareVerison, matDryContact=matDryContact, matConCommunicationLost=matConCommunicationLost, matInvEEPROMFault=matInvEEPROMFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsRuntime=matStsRuntime, matInvWarningState=matInvWarningState, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsSerialNum=matStsSerialNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapTargets=matTrapTargets, matInvTemperature=matInvTemperature, matStsOverLoad=matStsOverLoad, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTrapTargetsIndex=matTrapTargetsIndex, matInvModuleNum=matInvModuleNum, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsWarningState=matStsWarningState, matInvMBSPosError=matInvMBSPosError, matStsRunningMode=matStsRunningMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvLineVoltage=matInvLineVoltage, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConTemperature=matConTemperature, matInvTempPowerLimit=matInvTempPowerLimit, matDryContactString=matDryContactString, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvMbsPosition=matInvMbsPosition, matConfig=matConfig, matStsFaultMode=matStsFaultMode, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOutputVoltage=matStsOutputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusSoftFail=matInvBusSoftFail, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsHardwareVersion=matStsHardwareVersion, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMainsFail=matStsMainsFail, NonNegativeInteger=NonNegativeInteger, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvSerialNum=matInvSerialNum, matDryContactNum=matDryContactNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsEEPROMFault=matStsEEPROMFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsMbsStatus=matStsMbsStatus)
