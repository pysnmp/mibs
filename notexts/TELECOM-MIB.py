...
enterprises, MibIdentifier, Integer32, ModuleIdentity, Bits, IpAddress, Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, NotificationType, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "NotificationType", "Counter32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsNum=matTrapTargetsNum, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfInvInputVoltage=matConfInvInputVoltage, matInvModuleNum=matInvModuleNum, matInvInputAbnormal=matInvInputAbnormal, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matInvBusSoftFail=matInvBusSoftFail, matStsSerialNum=matStsSerialNum, matStsStatus=matStsStatus, matTrapTargetsIndex=matTrapTargetsIndex, matConEEPROMFault=matConEEPROMFault, matInvPriority=matInvPriority, matInvEntry=matInvEntry, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvPowerLimit=matInvPowerLimit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matObjects=matObjects, matConfig=matConfig, matTrapTargetsAddress=matTrapTargetsAddress, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapType=matTrapType, matAgent=matAgent, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvBypassMode=matStsInvBypassMode, matDryContactEntry=matDryContactEntry, matConfStsPriority=matConfStsPriority, matStsNotRespond=matStsNotRespond, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvBypassSCRShort=matInvBypassSCRShort, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvPhaseType=matInvPhaseType, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvOverLoad=matInvOverLoad, matStsOutputFreq=matStsOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContact=matDryContact, matInvLineFreq=matInvLineFreq, matInvRunTime=matInvRunTime, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsInvInputFreq=matStsInvInputFreq, matSts=matSts, matStsEntry=matStsEntry, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvRunMode=matInvRunMode, matStsOutputPower=matStsOutputPower, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTraps=matTraps, matConWarningState=matConWarningState, matStsOutputCurrent=matStsOutputCurrent, matInvOutputShort=matInvOutputShort, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsRuntime=matStsRuntime, matStsFaultMode=matStsFaultMode, matConName=matConName, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsEntry=matTrapTargetsEntry, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsInvFail=matReturnFromStsInvFail, NonNegativeInteger=NonNegativeInteger, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvNotRespond=matInvNotRespond, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvLineVoltage=matInvLineVoltage, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvOutputFreq=matInvOutputFreq, matDryContactString=matDryContactString, matInvFanFault=matInvFanFault, ppc=ppc, matStsModuleType=matStsModuleType, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsOverLoad=matStsOverLoad, matStsModuleNum=matStsModuleNum, matStsControlPowerFail=matStsControlPowerFail, matInvFirmwareVersion=matInvFirmwareVersion, PositiveInteger=PositiveInteger, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvEEPROMFault=matInvEEPROMFault, matStsHardwareVersion=matStsHardwareVersion, matInvWarningState=matInvWarningState, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matTrapTargetsTable=matTrapTargetsTable, matStsMainsFail=matStsMainsFail, matInvOutputVoltage=matInvOutputVoltage, matInvSoftStartFail=matInvSoftStartFail, matConBatteryLow=matConBatteryLow, matTrapSeverityLevel=matTrapSeverityLevel, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsMBSPosFault=matStsMBSPosFault, matStsMainInputFreq=matStsMainInputFreq, matInvMainUnavailable=matInvMainUnavailable, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapTargets=matTrapTargets, matConTemperature=matConTemperature, matStsOutputVoltage=matStsOutputVoltage, matInvMbsPosition=matInvMbsPosition, matDryContactIndex=matDryContactIndex, matDryContactTable=matDryContactTable, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvFault=matReturnFromInvFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvOutputPower=matConfInvOutputPower, matDryContactNum=matDryContactNum, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvPulseFault=matInvPulseFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvHardwareVersion=matInvHardwareVersion, matInvOutputVoltLow=matInvOutputVoltLow, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvEPOShutdown=matInvEPOShutdown, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvMBSPosError=matInvMBSPosError, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsModuleIndex=matStsModuleIndex, matInvFault=matInvFault, matInvSerialNum=matInvSerialNum, matStsWarningState=matStsWarningState, matInvTable=matInvTable, matInvModuleIndex=matInvModuleIndex, matController=matController, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvTemperature=matInvTemperature, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvFail=matStsInvFail, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConCanBusOff=matConCanBusOff, matStsMbsStatus=matStsMbsStatus, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConSerialNum=matConSerialNum, device=device, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsTable=matStsTable, matInvHardwareError=matInvHardwareError, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsFanFault=matStsFanFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInverter=matInverter, matStsEEPROMFault=matStsEEPROMFault, matStsTemperature=matStsTemperature, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputPower=matInvOutputPower, matStsRunningMode=matStsRunningMode, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss)
