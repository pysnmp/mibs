...
ModuleIdentity, Bits, Unsigned32, NotificationType, Gauge32, Integer32, iso, ObjectIdentity, MibIdentifier, TimeTicks, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "Gauge32", "Integer32", "iso", "ObjectIdentity", "MibIdentifier", "TimeTicks", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvSysInputVolt=matConfInvSysInputVolt, matObjects=matObjects, matConTemperature=matConTemperature, matInvBypassSCRShort=matInvBypassSCRShort, matInvModuleIndex=matInvModuleIndex, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvPriority=matInvPriority, matDryContactTable=matDryContactTable, matStsRunningMode=matStsRunningMode, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvTable=matInvTable, matInvOutputVoltage=matInvOutputVoltage, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsModuleNum=matStsModuleNum, matConName=matConName, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConTemperatureHigh=matConTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsIndex=matTrapTargetsIndex, matInvLineFreq=matInvLineFreq, matConfig=matConfig, matStsMBSPosFault=matStsMBSPosFault, matInvPulseFault=matInvPulseFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvBatteryVoltage=matInvBatteryVoltage, matStsWarningState=matStsWarningState, matInvOutputFreq=matInvOutputFreq, matInvBusSoftFail=matInvBusSoftFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matDryContact=matDryContact, matConEEPROMFault=matConEEPROMFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matTraps=matTraps, matConBatteryLow=matConBatteryLow, matStsMainsFail=matStsMainsFail, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvOutputVoltHigh=matInvOutputVoltHigh, matTrapTargetsNum=matTrapTargetsNum, matController=matController, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvRunMode=matInvRunMode, matStsEntry=matStsEntry, ppc=ppc, matStsInvInputVoltage=matStsInvInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConWarningState=matConWarningState, matStsTemperature=matStsTemperature, matStsModuleIndex=matStsModuleIndex, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargets=matTrapTargets, matStsFaultMode=matStsFaultMode, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvOutputCurrent=matInvOutputCurrent, matStsOutputVoltage=matStsOutputVoltage, matInvPhaseType=matInvPhaseType, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConCommunicationLost=matConCommunicationLost, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matDryContactEntry=matDryContactEntry, matInverter=matInverter, matInvMbsPosition=matInvMbsPosition, matStsMainHighLossVoltage=matStsMainHighLossVoltage, NonNegativeInteger=NonNegativeInteger, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsStatus=matStsStatus, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvModuleNum=matInvModuleNum, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvRunTime=matInvRunTime, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvInputAbnormal=matInvInputAbnormal, matInvFanFault=matInvFanFault, matConCanBusOff=matConCanBusOff, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapSeverityLevel=matTrapSeverityLevel, matInvSerialNum=matInvSerialNum, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsTable=matStsTable, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvFault=matReturnFromInvFault, matInvOutputPower=matInvOutputPower, matStsOutputFreq=matStsOutputFreq, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsModuleType=matStsModuleType, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsMainInputFreq=matStsMainInputFreq, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvWarningState=matInvWarningState, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matAgent=matAgent, matInvFirmwareVersion=matInvFirmwareVersion, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConSerialNum=matConSerialNum, matTrapTargetsAddress=matTrapTargetsAddress, matDryContactNum=matDryContactNum, matStsControlPowerFail=matStsControlPowerFail, matInvHardwareVersion=matInvHardwareVersion, matInvPowerLimit=matInvPowerLimit, matInvOnOffStatus=matInvOnOffStatus, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, device=device, matInvHardwareError=matInvHardwareError, matConfStsPriority=matConfStsPriority, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matDryContactString=matDryContactString, matInvFault=matInvFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargetsDesc=matTrapTargetsDesc, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvMBSPosError=matInvMBSPosError, matDryContactIndex=matDryContactIndex, matStsInvFail=matStsInvFail, matSts=matSts, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsSerialNum=matStsSerialNum, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsNotRespond=matStsNotRespond, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOverLoad=matStsOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matTrapType=matTrapType, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvSoftStartFail=matInvSoftStartFail, matInvLineVoltage=matInvLineVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvOutputShort=matInvOutputShort, matInvEntry=matInvEntry, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvNotRespond=matInvNotRespond, PositiveInteger=PositiveInteger, matStsInvBypassMode=matStsInvBypassMode, matInvTempPowerLimit=matInvTempPowerLimit, matStsRuntime=matStsRuntime, matInvTemperature=matInvTemperature, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matStsOutputPower=matStsOutputPower, matStsFanFault=matStsFanFault, matStsMainInputVoltage=matStsMainInputVoltage, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvNegativePowerProtect=matInvNegativePowerProtect, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvOverLoad=matInvOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff)
