...
mibBuilder.exportSymbols("TELECOM-MIB", matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsMainsFail=matStsMainsFail, matTrapTargetsAddress=matTrapTargetsAddress, matInvPhaseType=matInvPhaseType, matInvMainUnavailable=matInvMainUnavailable, matConfInvInputVoltage=matConfInvInputVoltage, matTrapType=matTrapType, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsStatus=matStsStatus, matTrapTargetsDesc=matTrapTargetsDesc, matConCanBusOff=matConCanBusOff, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvWarningState=matInvWarningState, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTemperature=matInvTemperature, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matConCommunicationLost=matConCommunicationLost, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvOutputVoltage=matInvOutputVoltage, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysPriority=matConfInvSysPriority, matInverter=matInverter, matStsFanFault=matStsFanFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, PositiveInteger=PositiveInteger, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvPulseFault=matInvPulseFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsModuleIndex=matStsModuleIndex, matInvTable=matInvTable, matInvEntry=matInvEntry, matDryContactTable=matDryContactTable, matStsMbsStatus=matStsMbsStatus, matTrapTargets=matTrapTargets, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvBusSoftFail=matInvBusSoftFail, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matDryContact=matDryContact, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsControlPowerFail=matStsControlPowerFail, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvOutputShort=matInvOutputShort, matTrapTargetsTable=matTrapTargetsTable, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOverLoad=matInvOverLoad, ppc=ppc, matStsWarningState=matStsWarningState, matStsMainInputFreq=matStsMainInputFreq, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvFail=matStsInvFail, matStsEntry=matStsEntry, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsInvBypassMode=matStsInvBypassMode, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputAbnormal=matStsOutputAbnormal, matInvSerialNum=matInvSerialNum, matStsOutputCurrent=matStsOutputCurrent, matInvModuleNum=matInvModuleNum, matStsInvInputVoltage=matStsInvInputVoltage, matInvHardwareError=matInvHardwareError, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsModuleType=matStsModuleType, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsNotRespond=matStsNotRespond, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvRunMode=matInvRunMode, matConWarningState=matConWarningState, NonNegativeInteger=NonNegativeInteger, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvLineFreq=matInvLineFreq, matDryContactString=matDryContactString, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matObjects=matObjects, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsRuntime=matStsRuntime, matConfInvOutputPower=matConfInvOutputPower, matTrapSeverityLevel=matTrapSeverityLevel, matInvPriority=matInvPriority, matConfig=matConfig, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsFaultMode=matStsFaultMode, matAgent=matAgent, matStsSerialNum=matStsSerialNum, matInvOutputFreq=matInvOutputFreq, matInvMbsPosition=matInvMbsPosition, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvHardwareVersion=matInvHardwareVersion, matInvNotRespond=matInvNotRespond, matStsOutputFreq=matStsOutputFreq, matStsEEPROMFault=matStsEEPROMFault, matStsOutputPower=matStsOutputPower, matConfStsFanSpeed=matConfStsFanSpeed, matConBatteryLow=matConBatteryLow, matInvEEPROMFault=matInvEEPROMFault, matController=matController, matTrapTargetsNum=matTrapTargetsNum, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsBypassUnavailable=matStsBypassUnavailable, matStsModuleNum=matStsModuleNum, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBypassSCRShort=matInvBypassSCRShort, matInvLineVoltage=matInvLineVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvRunTime=matInvRunTime, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsTable=matStsTable, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, device=device, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfStsPriority=matConfStsPriority, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvOutputPower=matInvOutputPower, matInvInputAbnormal=matInvInputAbnormal, matStsOverLoad=matStsOverLoad, matDryContactIndex=matDryContactIndex, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsMainFail=matReturnFromStsMainFail, matConName=matConName, matConEEPROMFault=matConEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matInvFirmwareVersion=matInvFirmwareVersion, matStsRunningMode=matStsRunningMode, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMBSPosFault=matStsMBSPosFault, matStsTemperature=matStsTemperature, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvPowerLimit=matInvPowerLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvFault=matInvFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matSts=matSts, matConSerialNum=matConSerialNum, matInvModuleIndex=matInvModuleIndex, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matDryContactEntry=matDryContactEntry, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvFanFault=matInvFanFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTraps=matTraps, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConTemperature=matConTemperature, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matDryContactNum=matDryContactNum)
