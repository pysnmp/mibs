...
mibBuilder.exportSymbols("TELECOM-MIB", matInvMainUnavailable=matInvMainUnavailable, matStsOutputPower=matStsOutputPower, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvOutputPower=matInvOutputPower, matDryContact=matDryContact, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsOutputCurrent=matStsOutputCurrent, matStsMainsFail=matStsMainsFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvInputVoltage=matConfInvInputVoltage, matConTemperatureHigh=matConTemperatureHigh, matInvFault=matInvFault, matStsHardwareVersion=matStsHardwareVersion, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOverLoad=matStsOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConTemperature=matConTemperature, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvEEPROMFault=matInvEEPROMFault, matInvLowInputShutdown=matInvLowInputShutdown, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvFirmwareVersion=matInvFirmwareVersion, matConfig=matConfig, matInvInputAbnormal=matInvInputAbnormal, matInvPulseFault=matInvPulseFault, matInvLineVoltage=matInvLineVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsRuntime=matStsRuntime, matInvOutputShort=matInvOutputShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConCommunicationLost=matConCommunicationLost, matInverter=matInverter, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsModuleNum=matStsModuleNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBusSoftFail=matInvBusSoftFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matInvOverLoad=matInvOverLoad, matInvHardwareVersion=matInvHardwareVersion, matConfInvOutputVoltage=matConfInvOutputVoltage, matTrapTargetsTable=matTrapTargetsTable, matStsFaultMode=matStsFaultMode, matInvSoftStartFail=matInvSoftStartFail, matStsNotRespond=matStsNotRespond, matConfInvOutputPower=matConfInvOutputPower, matConEEPROMFault=matConEEPROMFault, matTrapSeverityLevel=matTrapSeverityLevel, matAgent=matAgent, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsEntry=matStsEntry, matInvPriority=matInvPriority, matInvSerialNum=matInvSerialNum, matInvOutputVoltLow=matInvOutputVoltLow, matConfStsPriority=matConfStsPriority, matInvWarningState=matInvWarningState, matConName=matConName, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsModuleIndex=matStsModuleIndex, PositiveInteger=PositiveInteger, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTraps=matTraps, matConBatteryLow=matConBatteryLow, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapTargets=matTrapTargets, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsWarningState=matStsWarningState, matInvEntry=matInvEntry, matStsInvBypassMode=matStsInvBypassMode, matController=matController, matStsInvInputFreq=matStsInvInputFreq, matInvOnOffStatus=matInvOnOffStatus, matTrapTargetsIndex=matTrapTargetsIndex, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsOutputVoltage=matStsOutputVoltage, matStsControlPowerFail=matStsControlPowerFail, matConfInvOutputFreq=matConfInvOutputFreq, matInvMBSPosError=matInvMBSPosError, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matDryContactIndex=matDryContactIndex, matInvRunTime=matInvRunTime, matStsRunningMode=matStsRunningMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContactString=matDryContactString, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysPriority=matConfInvSysPriority, matStsTemperature=matStsTemperature, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsSerialNum=matStsSerialNum, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputVoltage=matInvOutputVoltage, matInvOutputFreq=matInvOutputFreq, matDryContactTable=matDryContactTable, matStsMbsStatus=matStsMbsStatus, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsFanFault=matStsFanFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matDryContactEntry=matDryContactEntry, matConSerialNum=matConSerialNum, matStsOutputFreq=matStsOutputFreq, matInvHardwareError=matInvHardwareError, matInvFanFault=matInvFanFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConCanBusOff=matConCanBusOff, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvPowerLimit=matInvPowerLimit, matStsStatus=matStsStatus, matInvPhaseType=matInvPhaseType, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOutputCurrent=matInvOutputCurrent, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsModuleType=matStsModuleType, matStsFirmwareVersion=matStsFirmwareVersion, matSts=matSts, matInvModuleNum=matInvModuleNum, matStsMainInputVoltage=matStsMainInputVoltage, matStsMainInputFreq=matStsMainInputFreq, matInvTable=matInvTable, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvLineFreq=matInvLineFreq, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvRunMode=matInvRunMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvMbsPosition=matInvMbsPosition, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matDryContactNum=matDryContactNum, matStsInvInputVoltage=matStsInvInputVoltage, device=device, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsEEPROMFault=matStsEEPROMFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matConWarningState=matConWarningState, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsInvFail=matStsInvFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsTable=matStsTable, NonNegativeInteger=NonNegativeInteger, matObjects=matObjects, matInvTemperature=matInvTemperature, ppc=ppc, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvTempPowerLimit=matInvTempPowerLimit, matStsMBSPosFault=matStsMBSPosFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapType=matTrapType, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvNotRespond=matInvNotRespond, matInvModuleIndex=matInvModuleIndex, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsInvFail=matReturnFromStsInvFail)
