...
Bits, NotificationType, Integer32, NotificationType, MibIdentifier, Counter64, iso, TimeTicks, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, enterprises, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "iso", "TimeTicks", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "enterprises", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matObjects=matObjects, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matDryContact=matDryContact, matConName=matConName, matTrapTargetsNum=matTrapTargetsNum, matInvBusSoftFail=matInvBusSoftFail, matAgent=matAgent, matInvTable=matInvTable, matConfInvOutputFreq=matConfInvOutputFreq, matStsSerialNum=matStsSerialNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvInputAbnormal=matInvInputAbnormal, matConfInvSysOutputVolt=matConfInvSysOutputVolt, device=device, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsRuntime=matStsRuntime, matTrapTargetsEntry=matTrapTargetsEntry, ppc=ppc, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsControlPowerFail=matStsControlPowerFail, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvModuleNum=matInvModuleNum, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvHardwareVersion=matInvHardwareVersion, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvPriority=matInvPriority, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvOutputShort=matInvOutputShort, matInvFirmwareVersion=matInvFirmwareVersion, matStsModuleNum=matStsModuleNum, matDryContactNum=matDryContactNum, matTrapSeverityLevel=matTrapSeverityLevel, matStsOutputFreq=matStsOutputFreq, matDryContactTable=matDryContactTable, matConfStsFanSpeed=matConfStsFanSpeed, matStsMainsFail=matStsMainsFail, matInvModuleIndex=matInvModuleIndex, matInvLineVoltage=matInvLineVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matInvEPOShutdown=matInvEPOShutdown, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvRunMode=matInvRunMode, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvSoftStartFail=matInvSoftStartFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsEntry=matStsEntry, matStsMBSPosFault=matStsMBSPosFault, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConTemperature=matConTemperature, matConBatteryLow=matConBatteryLow, matStsNotRespond=matStsNotRespond, matConfInvOutputPower=matConfInvOutputPower, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvPowerLimit=matInvPowerLimit, matConfInvInputVoltage=matConfInvInputVoltage, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvRunTime=matInvRunTime, matTraps=matTraps, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsTemperature=matStsTemperature, matStsWarningState=matStsWarningState, matInvMainUnavailable=matInvMainUnavailable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfig=matConfig, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, PositiveInteger=PositiveInteger, matStsTable=matStsTable, NonNegativeInteger=NonNegativeInteger, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvBatteryVoltage=matInvBatteryVoltage, matInvEntry=matInvEntry, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConCanBusOff=matConCanBusOff, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsInvBypassMode=matStsInvBypassMode, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsOutputPower=matStsOutputPower, matConfStsPriority=matConfStsPriority, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInverter=matInverter, matDryContactIndex=matDryContactIndex, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsStatus=matStsStatus, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvLineFreq=matInvLineFreq, matTrapType=matTrapType, matStsFanFault=matStsFanFault, matInvWarningState=matInvWarningState, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvFail=matStsInvFail, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matDryContactString=matDryContactString, matInvTemperature=matInvTemperature, matInvFault=matInvFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsRunningMode=matStsRunningMode, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsModuleIndex=matStsModuleIndex, matStsOverLoad=matStsOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matConSerialNum=matConSerialNum, matStsMainInputFreq=matStsMainInputFreq, matStsOutputCurrent=matStsOutputCurrent, matInvHardwareError=matInvHardwareError, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvTempPowerLimit=matInvTempPowerLimit, matInvOverLoad=matInvOverLoad, matDryContactEntry=matDryContactEntry, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConEEPROMFault=matConEEPROMFault, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvOutputFreq=matInvOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsModuleType=matStsModuleType, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvPulseFault=matInvPulseFault, matInvBypassSCRShort=matInvBypassSCRShort, matConWarningState=matConWarningState, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsMainInputVoltage=matStsMainInputVoltage, matInvNotRespond=matInvNotRespond, matStsEEPROMFault=matStsEEPROMFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvInputVoltage=matStsInvInputVoltage, matConTemperatureHigh=matConTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matTrapTargetsDesc=matTrapTargetsDesc, matInvSerialNum=matInvSerialNum, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputCurrent=matInvOutputCurrent, matStsHardwareVersion=matStsHardwareVersion, matInvOutputPower=matInvOutputPower, matAgentSoftwareVerison=matAgentSoftwareVerison, matController=matController, matSts=matSts, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapTargets=matTrapTargets, matInvMbsPosition=matInvMbsPosition, matConfInvSysPriority=matConfInvSysPriority, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvFanFault=matInvFanFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvOutputVoltLow=matInvOutputVoltLow, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOnOffStatus=matInvOnOffStatus, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvPhaseType=matInvPhaseType, matStsFaultMode=matStsFaultMode)
