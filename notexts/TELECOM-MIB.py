...
mibBuilder.exportSymbols("TELECOM-MIB", ppc=ppc, matStsTemperatureHigh=matStsTemperatureHigh, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvEntry=matInvEntry, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matDryContactNum=matDryContactNum, matInvHardwareError=matInvHardwareError, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsMainsFail=matStsMainsFail, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsStatus=matStsStatus, matInvModuleIndex=matInvModuleIndex, matInvRunMode=matInvRunMode, matInvEEPROMFault=matInvEEPROMFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConCanBusOff=matConCanBusOff, matStsRuntime=matStsRuntime, matDryContactTable=matDryContactTable, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapTargetsDesc=matTrapTargetsDesc, matStsNotRespond=matStsNotRespond, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConName=matConName, matConTemperature=matConTemperature, matAgent=matAgent, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfig=matConfig, matTrapSeverityLevel=matTrapSeverityLevel, matStsModuleIndex=matStsModuleIndex, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matDryContact=matDryContact, matStsOutputAbnormal=matStsOutputAbnormal, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputCurrent=matInvOutputCurrent, matStsOutputShortCircuit=matStsOutputShortCircuit, matConBatteryLow=matConBatteryLow, matObjects=matObjects, matStsOutputPower=matStsOutputPower, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsEntry=matStsEntry, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsEEPROMFault=matStsEEPROMFault, matConEEPROMFault=matConEEPROMFault, matInvTemperature=matInvTemperature, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matDryContactIndex=matDryContactIndex, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvBatteryVoltage=matInvBatteryVoltage, matInvPowerLimit=matInvPowerLimit, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matTrapTargetsEntry=matTrapTargetsEntry, matStsTemperature=matStsTemperature, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsTable=matTrapTargetsTable, PositiveInteger=PositiveInteger, matInvEPOShutdown=matInvEPOShutdown, matStsControlPowerFail=matStsControlPowerFail, matInvOutputVoltLow=matInvOutputVoltLow, matConTemperatureHigh=matConTemperatureHigh, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvFanFault=matInvFanFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, device=device, matInvFault=matInvFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConWarningState=matConWarningState, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsInvFail=matStsInvFail, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvPriority=matInvPriority, matInvSoftStartFail=matInvSoftStartFail, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMbsStatus=matStsMbsStatus, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvFirmwareVersion=matInvFirmwareVersion, matStsSerialNum=matStsSerialNum, matStsRunningMode=matStsRunningMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvTable=matInvTable, matStsTable=matStsTable, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsHardwareVersion=matStsHardwareVersion, matInvMainUnavailable=matInvMainUnavailable, matConCommunicationLost=matConCommunicationLost, matStsFanFault=matStsFanFault, matInvOverLoad=matInvOverLoad, matInvNotRespond=matInvNotRespond, matDryContactEntry=matDryContactEntry, matStsFaultMode=matStsFaultMode, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInverter=matInverter, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputFreq=matInvOutputFreq, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfStsPriority=matConfStsPriority, matInvRunTime=matInvRunTime, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsOverLoad=matStsOverLoad, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvMBSPosError=matInvMBSPosError, matConSerialNum=matConSerialNum, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvInputFreq=matStsInvInputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvSerialNum=matInvSerialNum, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matController=matController, matInvModuleNum=matInvModuleNum, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matDryContactString=matDryContactString, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOutputShort=matInvOutputShort, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvInputVoltage=matStsInvInputVoltage, matStsMainInputFreq=matStsMainInputFreq, matSts=matSts, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvTempPowerLimit=matInvTempPowerLimit, matInvLineVoltage=matInvLineVoltage, matConfInvOutputPower=matConfInvOutputPower, NonNegativeInteger=NonNegativeInteger, matTrapType=matTrapType, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvHardwareVersion=matInvHardwareVersion, matInvOutputPower=matInvOutputPower, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matTrapTargetsNum=matTrapTargetsNum, matInvPulseFault=matInvPulseFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputFreq=matStsOutputFreq, matTrapTargetsIndex=matTrapTargetsIndex, matStsWarningState=matStsWarningState, matStsModuleNum=matStsModuleNum, matInvPhaseType=matInvPhaseType, matStsFirmwareVersion=matStsFirmwareVersion, matTraps=matTraps, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matInvWarningState=matInvWarningState, matConfInvSysPriority=matConfInvSysPriority, matInvOutputVoltage=matInvOutputVoltage, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvInputVoltage=matConfInvInputVoltage, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvMbsPosition=matInvMbsPosition, matStsModuleType=matStsModuleType, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvLineFreq=matInvLineFreq, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matTrapTargets=matTrapTargets)
