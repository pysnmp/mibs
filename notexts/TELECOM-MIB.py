...
NotificationType, ObjectIdentity, Integer32, Bits, IpAddress, NotificationType, Gauge32, Counter64, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Counter32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "Bits", "IpAddress", "NotificationType", "Gauge32", "Counter64", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Counter32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TELECOM-MIB", matDryContact=matDryContact, matStsOutputCurrent=matStsOutputCurrent, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvRunTime=matInvRunTime, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfStsPriority=matConfStsPriority, matTrapTargetsEntry=matTrapTargetsEntry, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, matInvModuleIndex=matInvModuleIndex, matDryContactString=matDryContactString, matConfStsFanSpeed=matConfStsFanSpeed, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsMbsStatus=matStsMbsStatus, matInvOnOffStatus=matInvOnOffStatus, matInvWarningState=matInvWarningState, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputVoltLow=matInvOutputVoltLow, matStsModuleIndex=matStsModuleIndex, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConWarningState=matConWarningState, matConEEPROMFault=matConEEPROMFault, matStsOutputVoltage=matStsOutputVoltage, matAgent=matAgent, matInvMbsPosition=matInvMbsPosition, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matDryContactNum=matDryContactNum, matStsInvBypassMode=matStsInvBypassMode, matStsInvInputVoltage=matStsInvInputVoltage, matInvLineFreq=matInvLineFreq, matStsEEPROMFault=matStsEEPROMFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsRuntime=matStsRuntime, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputShort=matInvOutputShort, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBusSoftFail=matInvBusSoftFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsStatus=matStsStatus, matInvOutputPower=matInvOutputPower, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsInvFail=matStsInvFail, matTrapType=matTrapType, matStsOutputAbnormal=matStsOutputAbnormal, matStsOutputFreq=matStsOutputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConTemperatureHigh=matConTemperatureHigh, matInvOutputFreq=matInvOutputFreq, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matSts=matSts, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvInputVoltage=matConfInvInputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvSerialNum=matInvSerialNum, matInvLineVoltage=matInvLineVoltage, matInverter=matInverter, matStsModuleType=matStsModuleType, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvLowInputShutdown=matInvLowInputShutdown, matStsControlPowerFail=matStsControlPowerFail, matStsFanFault=matStsFanFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matObjects=matObjects, matConfInvOutputPower=matConfInvOutputPower, matStsOverLoad=matStsOverLoad, matInvPowerLimit=matInvPowerLimit, matStsWarningState=matStsWarningState, matStsTable=matStsTable, matInvBatteryVoltage=matInvBatteryVoltage, matConBatteryLow=matConBatteryLow, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvEntry=matInvEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsNum=matTrapTargetsNum, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvRunMode=matInvRunMode, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMainsFail=matStsMainsFail, matStsNotRespond=matStsNotRespond, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvTable=matInvTable, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matDryContactTable=matDryContactTable, matDryContactEntry=matDryContactEntry, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContactIndex=matDryContactIndex, matInvHardwareError=matInvHardwareError, matConBatteryVoltHigh=matConBatteryVoltHigh, device=device, matInvOverLoad=matInvOverLoad, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsEntry=matStsEntry, matConfig=matConfig, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsTemperature=matStsTemperature, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matController=matController, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvFault=matInvFault, matInvPhaseType=matInvPhaseType, matConName=matConName, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsSerialNum=matStsSerialNum, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, NonNegativeInteger=NonNegativeInteger, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvSoftStartFail=matInvSoftStartFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, PositiveInteger=PositiveInteger, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsFaultMode=matStsFaultMode, matTrapTargets=matTrapTargets, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsRunningMode=matStsRunningMode, matStsOutputPower=matStsOutputPower, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvNotRespond=matInvNotRespond, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConSerialNum=matConSerialNum, matInvMainUnavailable=matInvMainUnavailable, matInvFanFault=matInvFanFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapTargetsCommunity=matTrapTargetsCommunity, matTrapTargetsDesc=matTrapTargetsDesc, matStsModuleNum=matStsModuleNum, matStsInvInputFreq=matStsInvInputFreq, matInvTempPowerLimit=matInvTempPowerLimit, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, ppc=ppc, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvPulseFault=matInvPulseFault, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConCanBusOff=matConCanBusOff, matInvTemperature=matInvTemperature, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltage=matInvOutputVoltage, matConTemperature=matConTemperature, matInvPriority=matInvPriority, matInvTemperatureHigh=matInvTemperatureHigh, matInvMBSPosError=matInvMBSPosError, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvModuleNum=matInvModuleNum, matTraps=matTraps, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvSysPowerLimit=matConfInvSysPowerLimit)
