...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInverter=matInverter, matTrapSeverityLevel=matTrapSeverityLevel, matObjects=matObjects, matInvOutputCurrent=matInvOutputCurrent, matConfInvSysPriority=matConfInvSysPriority, NonNegativeInteger=NonNegativeInteger, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvInputAbnormal=matInvInputAbnormal, matStsModuleType=matStsModuleType, PositiveInteger=PositiveInteger, matStsTable=matStsTable, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matTrapTargetsIndex=matTrapTargetsIndex, matController=matController, matInvOutputFreq=matInvOutputFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matAgent=matAgent, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsEntry=matStsEntry, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvEPOShutdown=matInvEPOShutdown, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMbsStatus=matStsMbsStatus, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsOutputCurrent=matStsOutputCurrent, matInvOverLoad=matInvOverLoad, matConfInvInputVoltage=matConfInvInputVoltage, matStsTemperature=matStsTemperature, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConName=matConName, matStsOutputVoltage=matStsOutputVoltage, matConCommunicationLost=matConCommunicationLost, matStsFaultMode=matStsFaultMode, matStsControlPowerFail=matStsControlPowerFail, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvPhaseType=matInvPhaseType, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvOutputPower=matInvOutputPower, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvFault=matReturnFromInvFault, matInvTemperature=matInvTemperature, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsMainInputVoltage=matStsMainInputVoltage, matInvTempPowerLimit=matInvTempPowerLimit, matStsStatus=matStsStatus, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsNotRespond=matReturnFromStsNotRespond, device=device, matDryContactEntry=matDryContactEntry, matInvEEPROMFault=matInvEEPROMFault, matStsInvBypassMode=matStsInvBypassMode, matConfStsPriority=matConfStsPriority, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matConBatteryVoltHigh=matConBatteryVoltHigh, matConTemperature=matConTemperature, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConEEPROMFault=matConEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMBSPosError=matInvMBSPosError, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvRunTime=matInvRunTime, matConfig=matConfig, matStsModuleNum=matStsModuleNum, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConBatteryLow=matConBatteryLow, matConSerialNum=matConSerialNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvPulseFault=matInvPulseFault, matDryContact=matDryContact, matConfInvOutputPower=matConfInvOutputPower, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, ppc=ppc, matDryContactIndex=matDryContactIndex, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMBSPosFault=matStsMBSPosFault, matInvLowInputShutdown=matInvLowInputShutdown, matInvEntry=matInvEntry, matStsOverLoad=matStsOverLoad, matInvModuleNum=matInvModuleNum, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsRuntime=matStsRuntime, matInvMbsPosition=matInvMbsPosition, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvModuleIndex=matInvModuleIndex, matInvBypassSCRShort=matInvBypassSCRShort, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsNotRespond=matStsNotRespond, matInvFirmwareVersion=matInvFirmwareVersion, matStsSerialNum=matStsSerialNum, matDryContactString=matDryContactString, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConWarningState=matConWarningState, matInvRunMode=matInvRunMode, matTrapTargetsAddress=matTrapTargetsAddress, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvWarningState=matInvWarningState, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvNotRespond=matInvNotRespond, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matSts=matSts, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsOutputAbnormal=matStsOutputAbnormal, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvOutputShort=matInvOutputShort, matInvLineFreq=matInvLineFreq, matStsOutputFreq=matStsOutputFreq, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matDryContactTable=matDryContactTable, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsFanFault=matStsFanFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvOutputVoltage=matInvOutputVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvSerialNum=matInvSerialNum, matTrapTargetsDesc=matTrapTargetsDesc, matInvBusSoftFail=matInvBusSoftFail, matStsWarningState=matStsWarningState, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConTemperatureHigh=matConTemperatureHigh, matTrapType=matTrapType, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvOnOffStatus=matInvOnOffStatus, matInvTemperatureHigh=matInvTemperatureHigh, matTrapTargetsTable=matTrapTargetsTable, matStsEEPROMFault=matStsEEPROMFault, matConCanBusOff=matConCanBusOff, matConfInvOutputFreq=matConfInvOutputFreq, matInvMainUnavailable=matInvMainUnavailable, matStsMainsFail=matStsMainsFail, matInvLineVoltage=matInvLineVoltage, matStsInvFail=matStsInvFail, matInvPowerLimit=matInvPowerLimit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsModuleIndex=matStsModuleIndex, matTraps=matTraps, matDryContactNum=matDryContactNum, matInvHardwareError=matInvHardwareError, matStsMainInputFreq=matStsMainInputFreq, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvPriority=matInvPriority, matInvFanFault=matInvFanFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsRunningMode=matStsRunningMode, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsOutputPower=matStsOutputPower, matConfStsFanSpeed=matConfStsFanSpeed, matInvTable=matInvTable, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvFault=matInvFault, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargets=matTrapTargets)
