...
enterprises, Counter32, iso, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "iso", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysPriority=matConfInvSysPriority, matConfInvOutputFreq=matConfInvOutputFreq, matInvPowerLimit=matInvPowerLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsRuntime=matStsRuntime, matConfInvOutputPower=matConfInvOutputPower, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsModuleType=matStsModuleType, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvOutputVoltage=matInvOutputVoltage, matInvMBSPosError=matInvMBSPosError, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConName=matConName, matTrapTargetsIndex=matTrapTargetsIndex, matConTemperatureHigh=matConTemperatureHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputShort=matInvOutputShort, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvSoftStartFail=matInvSoftStartFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsMainsFail=matStsMainsFail, matInvRunMode=matInvRunMode, matDryContactEntry=matDryContactEntry, matInvHardwareVersion=matInvHardwareVersion, matDryContact=matDryContact, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvHardwareError=matInvHardwareError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsTable=matTrapTargetsTable, matStsInvBypassMode=matStsInvBypassMode, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvMaintenaceBypass=matInvMaintenaceBypass, matConEEPROMFault=matConEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfStsPriority=matConfStsPriority, matInvOverLoad=matInvOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, device=device, matStsTemperatureHigh=matStsTemperatureHigh, matDryContactNum=matDryContactNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsOutputAbnormal=matStsOutputAbnormal, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvLineFreq=matInvLineFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvTemperature=matInvTemperature, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsOutputCurrent=matStsOutputCurrent, matConSerialNum=matConSerialNum, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConCommunicationLost=matConCommunicationLost, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsFanFault=matStsFanFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, PositiveInteger=PositiveInteger, matInvOutputCurrent=matInvOutputCurrent, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matController=matController, matInvModuleIndex=matInvModuleIndex, matInvEntry=matInvEntry, matInvPriority=matInvPriority, matStsWarningState=matStsWarningState, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsHardwareVersion=matStsHardwareVersion, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInverter=matInverter, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsMainInputFreq=matStsMainInputFreq, matStsOutputFreq=matStsOutputFreq, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvFault=matReturnFromInvFault, matStsMbsStatus=matStsMbsStatus, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matObjects=matObjects, matInvSerialNum=matInvSerialNum, matAgent=matAgent, matConTemperature=matConTemperature, matStsModuleIndex=matStsModuleIndex, matStsOutputVoltage=matStsOutputVoltage, matStsTemperature=matStsTemperature, matDryContactIndex=matDryContactIndex, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConBatteryLow=matConBatteryLow, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsModuleNum=matStsModuleNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsOverLoad=matStsOverLoad, matStsMBSPosFault=matStsMBSPosFault, matStsEntry=matStsEntry, matStsRunningMode=matStsRunningMode, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvPhaseType=matInvPhaseType, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matTraps=matTraps, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matSts=matSts, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvBusSoftFail=matInvBusSoftFail, matStsEEPROMFault=matStsEEPROMFault, matInvOutputPower=matInvOutputPower, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvNotRespond=matInvNotRespond, matInvBypassSCRShort=matInvBypassSCRShort, matStsBypassUnavailable=matStsBypassUnavailable, matInvOutputVoltLow=matInvOutputVoltLow, matInvOutputFreq=matInvOutputFreq, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfig=matConfig, matInvLineVoltage=matInvLineVoltage, matInvRunTime=matInvRunTime, matStsNotRespond=matStsNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapType=matTrapType, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvEPOShutdown=matInvEPOShutdown, matInvMbsPosition=matInvMbsPosition, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsTable=matStsTable, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsFaultMode=matStsFaultMode, matInvFanFault=matInvFanFault, matInvPulseFault=matInvPulseFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOutputPower=matStsOutputPower, matConWarningState=matConWarningState, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvTable=matInvTable, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargetsEntry=matTrapTargetsEntry, matDryContactTable=matDryContactTable, matInvInputAbnormal=matInvInputAbnormal, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapTargets=matTrapTargets, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matDryContactString=matDryContactString, matInvLowInputShutdown=matInvLowInputShutdown, matInvFault=matInvFault, matTrapSeverityLevel=matTrapSeverityLevel, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, NonNegativeInteger=NonNegativeInteger, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsSerialNum=matStsSerialNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsInvFail=matStsInvFail, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvModuleNum=matInvModuleNum, matInvOnOffStatus=matInvOnOffStatus, matStsStatus=matStsStatus, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvWarningState=matInvWarningState, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, ppc=ppc, matConCanBusOff=matConCanBusOff)
