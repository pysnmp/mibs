...
mibBuilder.exportSymbols("TELECOM-MIB", matConName=matConName, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsMainsFail=matStsMainsFail, matInvTemperature=matInvTemperature, matStsFanFault=matStsFanFault, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvHardwareVersion=matInvHardwareVersion, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matTrapTargets=matTrapTargets, matInvTable=matInvTable, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsMainInputFreq=matStsMainInputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matDryContactTable=matDryContactTable, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsFirmwareVersion=matStsFirmwareVersion, matSts=matSts, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapType=matTrapType, matStsInvFail=matStsInvFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConCanBusOff=matConCanBusOff, matStsOutputVoltage=matStsOutputVoltage, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConSerialNum=matConSerialNum, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsStatus=matStsStatus, matStsEEPROMFault=matStsEEPROMFault, matInvOnOffStatus=matInvOnOffStatus, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvOutputPower=matConfInvOutputPower, matStsModuleType=matStsModuleType, matStsOutputFreq=matStsOutputFreq, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvFault=matInvFault, matInvHardwareError=matInvHardwareError, matInvFanFault=matInvFanFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsTable=matStsTable, matInvEntry=matInvEntry, matInvMbsPosition=matInvMbsPosition, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfStsPriority=matConfStsPriority, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matDryContact=matDryContact, PositiveInteger=PositiveInteger, matInvLineFreq=matInvLineFreq, matInvOverLoad=matInvOverLoad, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargetsNum=matTrapTargetsNum, matTrapSeverityLevel=matTrapSeverityLevel, matInvTempPowerLimit=matInvTempPowerLimit, matInvModuleNum=matInvModuleNum, matInvMainUnavailable=matInvMainUnavailable, matTraps=matTraps, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvSoftStartFail=matInvSoftStartFail, matInvWarningState=matInvWarningState, matStsWarningState=matStsWarningState, matConWarningState=matConWarningState, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvPhaseType=matInvPhaseType, matInvPowerLimit=matInvPowerLimit, matInvSerialNum=matInvSerialNum, matConTemperature=matConTemperature, device=device, matInvOutputPower=matInvOutputPower, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvRunTime=matInvRunTime, matInvInputAbnormal=matInvInputAbnormal, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputShort=matInvOutputShort, matInvMBSPosError=matInvMBSPosError, matInvModuleIndex=matInvModuleIndex, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matDryContactIndex=matDryContactIndex, matController=matController, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsSerialNum=matStsSerialNum, matInverter=matInverter, matAgent=matAgent, matInvNotRespond=matInvNotRespond, matInvOutputVoltage=matInvOutputVoltage, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvFault=matReturnFromInvFault, matInvRunMode=matInvRunMode, matStsInvBypassMode=matStsInvBypassMode, matInvOutputFreq=matInvOutputFreq, matConfInvSysOutputFreq=matConfInvSysOutputFreq, NonNegativeInteger=NonNegativeInteger, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsRunningMode=matStsRunningMode, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsInvInputVoltage=matStsInvInputVoltage, matStsFaultMode=matStsFaultMode, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvLineVoltage=matInvLineVoltage, matInvEEPROMFault=matInvEEPROMFault, matStsBypassUnavailable=matStsBypassUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matDryContactString=matDryContactString, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConCommunicationLost=matConCommunicationLost, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsModuleIndex=matStsModuleIndex, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsRuntime=matStsRuntime, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matStsNotRespond=matStsNotRespond, matConEEPROMFault=matConEEPROMFault, matConfig=matConfig, matInvPriority=matInvPriority, matStsOverLoad=matStsOverLoad, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, ppc=ppc, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matTrapTargetsDesc=matTrapTargetsDesc, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvPulseFault=matInvPulseFault, matInvOutputCurrent=matInvOutputCurrent, matDryContactEntry=matDryContactEntry, matStsTemperature=matStsTemperature, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputFreq=matConfInvOutputFreq, matTrapTargetsIndex=matTrapTargetsIndex, matObjects=matObjects, matStsEntry=matStsEntry, matReturnFromInvFanFault=matReturnFromInvFanFault, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvLowInputShutdown=matInvLowInputShutdown, matConfInvSysInputVolt=matConfInvSysInputVolt, matDryContactNum=matDryContactNum, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConBatteryLow=matConBatteryLow, matStsModuleNum=matStsModuleNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvBusSoftFail=matInvBusSoftFail, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsOutputPower=matStsOutputPower, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysPriority=matConfInvSysPriority, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsMBSPosFault=matStsMBSPosFault)
