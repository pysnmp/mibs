...
NotificationType, Integer32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, IpAddress, Counter64, ModuleIdentity, Counter32, Bits, enterprises, Gauge32, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity", "Counter32", "Bits", "enterprises", "Gauge32", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContact=matDryContact, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matSts=matSts, matDryContactEntry=matDryContactEntry, matStsHardwareVersion=matStsHardwareVersion, matInvNegativePowerProtect=matInvNegativePowerProtect, matDryContactTable=matDryContactTable, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvEPOShutdown=matInvEPOShutdown, matStsOutputPower=matStsOutputPower, matConfInvOutputFreq=matConfInvOutputFreq, matStsRunningMode=matStsRunningMode, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matTrapTargetsIndex=matTrapTargetsIndex, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvEEPROMFault=matInvEEPROMFault, matConEEPROMFault=matConEEPROMFault, matTrapTargetsEntry=matTrapTargetsEntry, matConSerialNum=matConSerialNum, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapType=matTrapType, matStsModuleType=matStsModuleType, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOutputPower=matInvOutputPower, matInvPhaseType=matInvPhaseType, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsSerialNum=matStsSerialNum, matStsOutputCurrent=matStsOutputCurrent, matDryContactNum=matDryContactNum, matStsEEPROMFault=matStsEEPROMFault, matInvTempPowerLimit=matInvTempPowerLimit, matInvLineVoltage=matInvLineVoltage, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargetsNum=matTrapTargetsNum, matStsMainInputFreq=matStsMainInputFreq, matStsMBSPosFault=matStsMBSPosFault, matInverter=matInverter, matStsOverLoad=matStsOverLoad, matConfStsPriority=matConfStsPriority, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvRunTime=matInvRunTime, matStsTable=matStsTable, matReturnFromConCanBusOff=matReturnFromConCanBusOff, NonNegativeInteger=NonNegativeInteger, matInvMbsPosition=matInvMbsPosition, matStsTemperature=matStsTemperature, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvPriority=matInvPriority, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsModuleNum=matStsModuleNum, matTrapTargetsTable=matTrapTargetsTable, matInvFanFault=matInvFanFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConCommunicationLost=matConCommunicationLost, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsControlPowerFail=matStsControlPowerFail, matInvInputAbnormal=matInvInputAbnormal, ppc=ppc, matInvLineFreq=matInvLineFreq, matConfInvSysPriority=matConfInvSysPriority, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsFanFault=matStsFanFault, matStsModuleIndex=matStsModuleIndex, device=device, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsInvBypassMode=matStsInvBypassMode, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvMainUnavailable=matInvMainUnavailable, matConWarningState=matConWarningState, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsMbsStatus=matStsMbsStatus, matStsFaultMode=matStsFaultMode, matInvSoftStartFail=matInvSoftStartFail, matStsInvFail=matStsInvFail, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvOutputShort=matInvOutputShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConName=matConName, matInvFault=matInvFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltLow=matInvOutputVoltLow, matInvPowerLimit=matInvPowerLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvEntry=matInvEntry, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsOutputFreq=matStsOutputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matDryContactIndex=matDryContactIndex, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matTrapTargets=matTrapTargets, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matTrapSeverityLevel=matTrapSeverityLevel, matInvOnOffStatus=matInvOnOffStatus, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConTemperatureHigh=matConTemperatureHigh, matStsStatus=matStsStatus, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, PositiveInteger=PositiveInteger, matInvHardwareError=matInvHardwareError, matInvModuleNum=matInvModuleNum, matConTemperature=matConTemperature, matStsOutputAbnormal=matStsOutputAbnormal, matConBatteryLow=matConBatteryLow, matConCanBusOff=matConCanBusOff, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matObjects=matObjects, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matAgent=matAgent, matInvWarningState=matInvWarningState, matInvPulseFault=matInvPulseFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matController=matController, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvInputVoltage=matConfInvInputVoltage, matInvOutputFreq=matInvOutputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvTemperatureHigh=matInvTemperatureHigh, matStsMainInputVoltage=matStsMainInputVoltage, matInvMBSPosError=matInvMBSPosError, matStsEntry=matStsEntry, matInvTemperature=matInvTemperature, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvModuleIndex=matInvModuleIndex, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvRunMode=matInvRunMode, matInvSerialNum=matInvSerialNum, matConfInvOutputVoltage=matConfInvOutputVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsNotRespond=matStsNotRespond, matInvNotRespond=matInvNotRespond, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTraps=matTraps, matInvOverLoad=matInvOverLoad, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvTable=matInvTable, matDryContactString=matDryContactString, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsWarningState=matStsWarningState, matInvOutputVoltage=matInvOutputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsRuntime=matStsRuntime, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfStsFanSpeed=matConfStsFanSpeed, matConfig=matConfig, matInvFirmwareVersion=matInvFirmwareVersion, matStsMainsFail=matStsMainsFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable)
