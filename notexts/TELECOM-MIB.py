...
Counter32, NotificationType, TimeTicks, Bits, ModuleIdentity, ObjectIdentity, IpAddress, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, iso, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "Bits", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "iso", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matSts=matSts, matStsRunningMode=matStsRunningMode, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvLowInputShutdown=matInvLowInputShutdown, matStsRuntime=matStsRuntime, matStsInvInputFreq=matStsInvInputFreq, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOverLoad=matStsOverLoad, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matObjects=matObjects, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsTemperature=matStsTemperature, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvFault=matInvFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvOutputShort=matInvOutputShort, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsOutputVoltage=matStsOutputVoltage, matInvPulseFault=matInvPulseFault, matDryContact=matDryContact, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsTable=matStsTable, matInvOutputVoltLow=matInvOutputVoltLow, matInvLineFreq=matInvLineFreq, matInvLineVoltage=matInvLineVoltage, matConfInvOutputPower=matConfInvOutputPower, matController=matController, matInvEPOShutdown=matInvEPOShutdown, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsInvFail=matStsInvFail, matConBatteryLow=matConBatteryLow, matInvModuleIndex=matInvModuleIndex, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsModuleNum=matStsModuleNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsOutputFreq=matStsOutputFreq, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvTemperatureHigh=matInvTemperatureHigh, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matDryContactTable=matDryContactTable, matInvOverLoad=matInvOverLoad, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvModuleNum=matInvModuleNum, matTrapTargetsAddress=matTrapTargetsAddress, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvOutputVoltage=matInvOutputVoltage, matConfStsFanSpeed=matConfStsFanSpeed, matStsControlPowerFail=matStsControlPowerFail, matConfInvSysInputVolt=matConfInvSysInputVolt, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvEEPROMFault=matInvEEPROMFault, matInvMaintenaceBypass=matInvMaintenaceBypass, matInverter=matInverter, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvFault=matReturnFromInvFault, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvTempPowerLimit=matInvTempPowerLimit, matStsMainInputFreq=matStsMainInputFreq, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvInputVoltage=matConfInvInputVoltage, matStsModuleType=matStsModuleType, matStsEntry=matStsEntry, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConTemperature=matConTemperature, matInvHardwareVersion=matInvHardwareVersion, matStsBypassUnavailable=matStsBypassUnavailable, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvNotRespond=matInvNotRespond, matInvBusSoftFail=matInvBusSoftFail, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainsFail=matStsMainsFail, matInvOutputPower=matInvOutputPower, matInvOnOffStatus=matInvOnOffStatus, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvSysPriority=matConfInvSysPriority, matInvBypassSCRShort=matInvBypassSCRShort, matConSerialNum=matConSerialNum, matInvPowerLimit=matInvPowerLimit, matInvPriority=matInvPriority, matStsSerialNum=matStsSerialNum, matStsFirmwareVersion=matStsFirmwareVersion, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matDryContactEntry=matDryContactEntry, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsFanFault=matReturnFromStsFanFault, matConCommunicationLost=matConCommunicationLost, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsFanFault=matStsFanFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsOutputPower=matStsOutputPower, matDryContactString=matDryContactString, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromConCanBusOff=matReturnFromConCanBusOff, PositiveInteger=PositiveInteger, matStsMainInputVoltage=matStsMainInputVoltage, matInvTemperature=matInvTemperature, matInvSerialNum=matInvSerialNum, matTrapType=matTrapType, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matDryContactNum=matDryContactNum, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, ppc=ppc, matInvPhaseType=matInvPhaseType, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConWarningState=matConWarningState, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConTemperatureHigh=matConTemperatureHigh, matInvMBSPosError=matInvMBSPosError, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matAgent=matAgent, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsMBSPosFault=matStsMBSPosFault, matConCanBusOff=matConCanBusOff, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matTrapTargets=matTrapTargets, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsTable=matTrapTargetsTable, matInvMbsPosition=matInvMbsPosition, matStsModuleIndex=matStsModuleIndex, matTrapTargetsDesc=matTrapTargetsDesc, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvOutputFreq=matConfInvOutputFreq, matConfStsPriority=matConfStsPriority, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsWarningState=matStsWarningState, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvEntry=matInvEntry, matDryContactIndex=matDryContactIndex, matInvSoftStartFail=matInvSoftStartFail, matTrapTargetsIndex=matTrapTargetsIndex, matInvOutputFreq=matInvOutputFreq, matInvRunTime=matInvRunTime, matConfig=matConfig, matStsMbsStatus=matStsMbsStatus, matTraps=matTraps, matConName=matConName, matInvHardwareError=matInvHardwareError, matStsInvBypassMode=matStsInvBypassMode, matConEEPROMFault=matConEEPROMFault, matStsFaultMode=matStsFaultMode, matStsStatus=matStsStatus, device=device, matInvTable=matInvTable, matInvRunMode=matInvRunMode, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsNotRespond=matStsNotRespond, matTrapSeverityLevel=matTrapSeverityLevel, NonNegativeInteger=NonNegativeInteger, matInvFanFault=matInvFanFault, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvWarningState=matInvWarningState)
