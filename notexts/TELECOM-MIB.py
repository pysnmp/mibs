...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvPriority=matInvPriority, matStsTemperature=matStsTemperature, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvBypassSCRShort=matInvBypassSCRShort, matStsModuleIndex=matStsModuleIndex, matStsMbsStatus=matStsMbsStatus, matConCommunicationLost=matConCommunicationLost, ppc=ppc, matInvOutputFreq=matInvOutputFreq, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsWarningState=matStsWarningState, matStsBypassUnavailable=matStsBypassUnavailable, matTrapTargetsNum=matTrapTargetsNum, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matTrapTargets=matTrapTargets, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsAddress=matTrapTargetsAddress, matStsSerialNum=matStsSerialNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysPriority=matConfInvSysPriority, matInvEntry=matInvEntry, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConTemperature=matConTemperature, matInvTemperatureHigh=matInvTemperatureHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOutputCurrent=matStsOutputCurrent, matInvPulseFault=matInvPulseFault, matConfInvOutputPower=matConfInvOutputPower, matStsModuleNum=matStsModuleNum, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTrapTargetsTable=matTrapTargetsTable, matInvInputAbnormal=matInvInputAbnormal, matConTemperatureHigh=matConTemperatureHigh, matInvOverLoad=matInvOverLoad, matStsRuntime=matStsRuntime, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsHardwareVersion=matStsHardwareVersion, matStsFanFault=matStsFanFault, matTrapSeverityLevel=matTrapSeverityLevel, matStsInvFail=matStsInvFail, matAgent=matAgent, matInvMaintenaceBypass=matInvMaintenaceBypass, matDryContactIndex=matDryContactIndex, matInvHardwareError=matInvHardwareError, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvModuleNum=matInvModuleNum, matInvTable=matInvTable, matConfStsFanSpeed=matConfStsFanSpeed, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPhaseType=matInvPhaseType, matStsFirmwareVersion=matStsFirmwareVersion, matStsOutputFreq=matStsOutputFreq, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matTrapTargetsDesc=matTrapTargetsDesc, matConName=matConName, matInvFirmwareVersion=matInvFirmwareVersion, matInvTemperature=matInvTemperature, matInvSoftStartFail=matInvSoftStartFail, matInvFanFault=matInvFanFault, matStsModuleType=matStsModuleType, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvMainUnavailable=matInvMainUnavailable, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvBypassMode=matStsInvBypassMode, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matTrapTargetsEntry=matTrapTargetsEntry, matDryContactEntry=matDryContactEntry, matReturnFromStsInvFail=matReturnFromStsInvFail, matTraps=matTraps, matTrapType=matTrapType, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvInputVoltage=matConfInvInputVoltage, matStsRunningMode=matStsRunningMode, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputVoltage=matStsOutputVoltage, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvOutputShort=matInvOutputShort, matInvWarningState=matInvWarningState, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvMBSPosError=matInvMBSPosError, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConBatteryLow=matConBatteryLow, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsEEPROMFault=matStsEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvBusSoftFail=matInvBusSoftFail, matInvOutputPower=matInvOutputPower, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvNotRespond=matInvNotRespond, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvLineVoltage=matInvLineVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsTable=matStsTable, matConfig=matConfig, matInvOutputVoltHigh=matInvOutputVoltHigh, matConfInvOutputVoltage=matConfInvOutputVoltage, NonNegativeInteger=NonNegativeInteger, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvSerialNum=matInvSerialNum, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvFault=matInvFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputPower=matStsOutputPower, matConCanBusOff=matConCanBusOff, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvEPOShutdown=matInvEPOShutdown, matSts=matSts, matConfStsPriority=matConfStsPriority, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvOnOffStatus=matInvOnOffStatus, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, PositiveInteger=PositiveInteger, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvLowInputShutdown=matInvLowInputShutdown, matStsNotRespond=matStsNotRespond, matInvOutputVoltage=matInvOutputVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matDryContact=matDryContact, matInvMbsPosition=matInvMbsPosition, matController=matController, matInvLineFreq=matInvLineFreq, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsOverLoad=matStsOverLoad, matStsOutputAbnormal=matStsOutputAbnormal, matDryContactNum=matDryContactNum, matStsStatus=matStsStatus, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConEEPROMFault=matConEEPROMFault, matInvOutputVoltLow=matInvOutputVoltLow, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsMainInputFreq=matStsMainInputFreq, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matDryContactString=matDryContactString, matConWarningState=matConWarningState, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvHardwareVersion=matInvHardwareVersion, matStsInvInputFreq=matStsInvInputFreq, matConSerialNum=matConSerialNum, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvModuleIndex=matInvModuleIndex, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsEntry=matStsEntry, device=device, matStsFaultMode=matStsFaultMode, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvPowerLimit=matInvPowerLimit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvRunTime=matInvRunTime, matInvRunMode=matInvRunMode, matInvOutputCurrent=matInvOutputCurrent, matInverter=matInverter, matDryContactTable=matDryContactTable, matObjects=matObjects, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsMainsFail=matStsMainsFail)
