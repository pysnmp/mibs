...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapType=matTrapType, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvMbsPosition=matInvMbsPosition, matConfInvOutputFreq=matConfInvOutputFreq, matStsRuntime=matStsRuntime, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvLowInputShutdown=matInvLowInputShutdown, matStsHardwareVersion=matStsHardwareVersion, matConfStsPriority=matConfStsPriority, matStsModuleNum=matStsModuleNum, matStsModuleType=matStsModuleType, matStsWarningState=matStsWarningState, matReturnFromInvFault=matReturnFromInvFault, matDryContactString=matDryContactString, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvPriority=matInvPriority, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvMBSPosError=matInvMBSPosError, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsOverLoad=matStsOverLoad, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvFanFault=matInvFanFault, matStsStatus=matStsStatus, matConfig=matConfig, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvOutputPower=matInvOutputPower, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matTrapTargetsEntry=matTrapTargetsEntry, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvSerialNum=matInvSerialNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvSoftStartFail=matInvSoftStartFail, matConSerialNum=matConSerialNum, matStsOutputPower=matStsOutputPower, matObjects=matObjects, matInvPulseFault=matInvPulseFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsEEPROMFault=matStsEEPROMFault, matConWarningState=matConWarningState, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvOutputVoltLow=matInvOutputVoltLow, matInvOnOffStatus=matInvOnOffStatus, matSts=matSts, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, PositiveInteger=PositiveInteger, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsMainFail=matReturnFromStsMainFail, matTraps=matTraps, matInvPhaseType=matInvPhaseType, matDryContactIndex=matDryContactIndex, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConTemperature=matConTemperature, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapTargetsAddress=matTrapTargetsAddress, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsMainInputFreq=matStsMainInputFreq, matInvModuleIndex=matInvModuleIndex, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, ppc=ppc, matConBatteryLow=matConBatteryLow, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvRunTime=matInvRunTime, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMainsFail=matStsMainsFail, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConfInvOutputPower=matConfInvOutputPower, matStsOutputFreq=matStsOutputFreq, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsNotRespond=matStsNotRespond, matStsSerialNum=matStsSerialNum, matDryContactEntry=matDryContactEntry, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvRunMode=matInvRunMode, matInvTable=matInvTable, matInvOutputVoltage=matInvOutputVoltage, matInvHardwareError=matInvHardwareError, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvTemperature=matInvTemperature, matStsInvBypassMode=matStsInvBypassMode, matInvLineFreq=matInvLineFreq, matDryContactTable=matDryContactTable, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvEEPROMFault=matInvEEPROMFault, matStsMBSPosFault=matStsMBSPosFault, matConBatteryVoltHigh=matConBatteryVoltHigh, NonNegativeInteger=NonNegativeInteger, matStsOutputVoltage=matStsOutputVoltage, matInvEntry=matInvEntry, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsControlPowerFail=matStsControlPowerFail, matAgent=matAgent, matInvNotRespond=matInvNotRespond, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsOutputCurrent=matStsOutputCurrent, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matDryContact=matDryContact, matConName=matConName, matDryContactNum=matDryContactNum, matInvPowerLimit=matInvPowerLimit, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConCommunicationLost=matConCommunicationLost, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOutputFreq=matInvOutputFreq, matStsTemperature=matStsTemperature, matStsOutputAbnormal=matStsOutputAbnormal, matStsEntry=matStsEntry, matStsMbsStatus=matStsMbsStatus, matController=matController, matReturnFromInvFanFault=matReturnFromInvFanFault, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsTable=matStsTable, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsInvFail=matStsInvFail, matStsFaultMode=matStsFaultMode, matInvLineVoltage=matInvLineVoltage, matInvWarningState=matInvWarningState, matTrapTargetsDesc=matTrapTargetsDesc, matConCanBusOff=matConCanBusOff, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConEEPROMFault=matConEEPROMFault, matStsRunningMode=matStsRunningMode, matInverter=matInverter, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysPriority=matConfInvSysPriority, matInvModuleNum=matInvModuleNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvFault=matInvFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputShort=matInvOutputShort, matStsFanFault=matStsFanFault, matTrapTargets=matTrapTargets, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvOutputCurrent=matInvOutputCurrent, matInvOverLoad=matInvOverLoad, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConTemperatureHigh=matConTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvFirmwareVersion=matInvFirmwareVersion, matInvBusSoftFail=matInvBusSoftFail, device=device, matStsModuleIndex=matStsModuleIndex, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvBatteryVoltage=matInvBatteryVoltage, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapSeverityLevel=matTrapSeverityLevel, matTrapTargetsTable=matTrapTargetsTable, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvInputVoltage=matStsInvInputVoltage, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow)
