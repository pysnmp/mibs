...
mibBuilder.exportSymbols("TELECOM-MIB", matStsStatus=matStsStatus, matInvHardwareError=matInvHardwareError, matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConCommunicationLost=matConCommunicationLost, matController=matController, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matAgent=matAgent, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvRunTime=matInvRunTime, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvOutputCurrent=matInvOutputCurrent, matTrapTargetsTable=matTrapTargetsTable, matInvLowInputShutdown=matInvLowInputShutdown, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvSerialNum=matInvSerialNum, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConName=matConName, matInvRunMode=matInvRunMode, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvOutputVoltHigh=matInvOutputVoltHigh, matDryContact=matDryContact, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvLineFreq=matInvLineFreq, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInverter=matInverter, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matDryContactIndex=matDryContactIndex, matInvFanFault=matInvFanFault, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvModuleNum=matInvModuleNum, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsOutputAbnormal=matStsOutputAbnormal, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsTemperature=matStsTemperature, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsControlPowerFail=matStsControlPowerFail, matStsInvBypassMode=matStsInvBypassMode, matConEEPROMFault=matConEEPROMFault, matConfig=matConfig, NonNegativeInteger=NonNegativeInteger, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsInvFail=matStsInvFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvWarningState=matInvWarningState, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvTemperature=matInvTemperature, matConBatteryVoltHigh=matConBatteryVoltHigh, matConTemperature=matConTemperature, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsMbsStatus=matStsMbsStatus, matStsMainInputFreq=matStsMainInputFreq, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConCanBusOff=matConCanBusOff, matStsInvInputVoltage=matStsInvInputVoltage, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsFanFault=matStsFanFault, matInvOutputShort=matInvOutputShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matTraps=matTraps, matTrapTargetsDesc=matTrapTargetsDesc, matInvModuleIndex=matInvModuleIndex, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matDryContactTable=matDryContactTable, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConWarningState=matConWarningState, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfStsFanSpeed=matConfStsFanSpeed, matInvPulseFault=matInvPulseFault, matStsTemperatureHigh=matStsTemperatureHigh, matStsModuleType=matStsModuleType, matInvPowerLimit=matInvPowerLimit, matInvFault=matInvFault, matStsFaultMode=matStsFaultMode, matStsHardwareVersion=matStsHardwareVersion, matStsWarningState=matStsWarningState, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapTargetsIndex=matTrapTargetsIndex, matTrapTargetsEntry=matTrapTargetsEntry, matInvNotRespond=matInvNotRespond, matInvMBSPosError=matInvMBSPosError, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsNotRespond=matStsNotRespond, matStsMainsFail=matStsMainsFail, matConfInvInputVoltage=matConfInvInputVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matStsRunningMode=matStsRunningMode, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matDryContactNum=matDryContactNum, matInvPriority=matInvPriority, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, device=device, matTrapTargetsNum=matTrapTargetsNum, matInvOnOffStatus=matInvOnOffStatus, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvInputAbnormal=matInvInputAbnormal, matInvFirmwareVersion=matInvFirmwareVersion, matStsTable=matStsTable, matStsOutputFreq=matStsOutputFreq, matStsSerialNum=matStsSerialNum, matStsMainInputVoltage=matStsMainInputVoltage, matConBatteryLow=matConBatteryLow, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matSts=matSts, matInvLineVoltage=matInvLineVoltage, matConfInvSysPriority=matConfInvSysPriority, matInvEPOShutdown=matInvEPOShutdown, matStsModuleIndex=matStsModuleIndex, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matDryContactString=matDryContactString, matConfStsPriority=matConfStsPriority, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, PositiveInteger=PositiveInteger, matStsModuleNum=matStsModuleNum, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsOutputVoltage=matStsOutputVoltage, ppc=ppc, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matStsRuntime=matStsRuntime, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matTrapTargetsAddress=matTrapTargetsAddress, matTrapTargets=matTrapTargets, matInvTemperatureHigh=matInvTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matObjects=matObjects, matInvTable=matInvTable, matInvMbsPosition=matInvMbsPosition, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matTrapSeverityLevel=matTrapSeverityLevel, matInvOutputFreq=matInvOutputFreq, matStsFirmwareVersion=matStsFirmwareVersion, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvPhaseType=matInvPhaseType, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsEntry=matStsEntry, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConSerialNum=matConSerialNum, matInvOverLoad=matInvOverLoad, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsOutputPower=matStsOutputPower, matInvEEPROMFault=matInvEEPROMFault, matStsMBSPosFault=matStsMBSPosFault, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvEntry=matInvEntry, matConfInvOutputFreq=matConfInvOutputFreq, matStsOverLoad=matStsOverLoad, matInvOutputPower=matInvOutputPower, matDryContactEntry=matDryContactEntry, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvHardwareVersion=matInvHardwareVersion, matInvBatteryVoltage=matInvBatteryVoltage, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTrapType=matTrapType)
