...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOverLoad=matInvOverLoad, matConEEPROMFault=matConEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matStsModuleNum=matStsModuleNum, matInvWarningState=matInvWarningState, matStsEntry=matStsEntry, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvOutputShort=matInvOutputShort, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapTargetsDesc=matTrapTargetsDesc, matStsEEPROMFault=matStsEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfig=matConfig, matObjects=matObjects, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matAgent=matAgent, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvPhaseType=matInvPhaseType, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMainUnavailable=matInvMainUnavailable, matDryContactString=matDryContactString, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsOutputCurrent=matStsOutputCurrent, matStsRuntime=matStsRuntime, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsInvInputVoltage=matStsInvInputVoltage, matStsMainInputVoltage=matStsMainInputVoltage, matInvHardwareError=matInvHardwareError, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvBypassSCRShort=matInvBypassSCRShort, matStsOverLoad=matStsOverLoad, matInvTable=matInvTable, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConTemperatureHigh=matConTemperatureHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvPulseFault=matInvPulseFault, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTraps=matTraps, matInvEntry=matInvEntry, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltage=matInvOutputVoltage, matTrapTargets=matTrapTargets, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsInvLosLossVoltage=matStsInvLosLossVoltage, NonNegativeInteger=NonNegativeInteger, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvFault=matReturnFromInvFault, matInvOutputCurrent=matInvOutputCurrent, matDryContactTable=matDryContactTable, matDryContactEntry=matDryContactEntry, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvEPOShutdown=matInvEPOShutdown, matInvRunMode=matInvRunMode, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsBypassUnavailable=matStsBypassUnavailable, device=device, matDryContactNum=matDryContactNum, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsFanFault=matStsFanFault, matStsTable=matStsTable, matInverter=matInverter, matInvModuleIndex=matInvModuleIndex, matInvRunTime=matInvRunTime, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsModuleIndex=matStsModuleIndex, matController=matController, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsRunningMode=matStsRunningMode, matConfInvInputVoltage=matConfInvInputVoltage, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapType=matTrapType, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvOutputFreq=matConfInvOutputFreq, matStsHardwareVersion=matStsHardwareVersion, matInvLowInputShutdown=matInvLowInputShutdown, matInvTemperature=matInvTemperature, matAgentSoftwareVerison=matAgentSoftwareVerison, matConCanBusOff=matConCanBusOff, matInvMbsPosition=matInvMbsPosition, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvModuleNum=matInvModuleNum, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputPower=matInvOutputPower, matDryContactIndex=matDryContactIndex, matTrapTargetsAddress=matTrapTargetsAddress, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltLow=matInvOutputVoltLow, matInvPriority=matInvPriority, matStsWarningState=matStsWarningState, matTrapTargetsEntry=matTrapTargetsEntry, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsControlPowerFail=matStsControlPowerFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsInvBypassMode=matStsInvBypassMode, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsInvInputFreq=matStsInvInputFreq, PositiveInteger=PositiveInteger, matInvSoftStartFail=matInvSoftStartFail, matStsInvFail=matStsInvFail, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsMainInputFreq=matStsMainInputFreq, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperature=matConTemperature, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfStsPriority=matConfStsPriority, matStsOutputAbnormal=matStsOutputAbnormal, matInvPowerLimit=matInvPowerLimit, matConSerialNum=matConSerialNum, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, ppc=ppc, matConBatteryLow=matConBatteryLow, matConWarningState=matConWarningState, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsMBSPosFault=matStsMBSPosFault, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsMainsFail=matStsMainsFail, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvSerialNum=matInvSerialNum, matInvLineVoltage=matInvLineVoltage, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsStatus=matStsStatus, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsModuleType=matStsModuleType, matStsOutputFreq=matStsOutputFreq, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvFault=matInvFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfStsFanSpeed=matConfStsFanSpeed, matInvInputAbnormal=matInvInputAbnormal, matStsOutputPower=matStsOutputPower, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsNotRespond=matStsNotRespond, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvNotRespond=matInvNotRespond, matConCommunicationLost=matConCommunicationLost, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConName=matConName, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargetsTable=matTrapTargetsTable, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsMbsStatus=matStsMbsStatus, matInvLineFreq=matInvLineFreq, matDryContact=matDryContact, matInvFanFault=matInvFanFault, matStsSerialNum=matStsSerialNum, matStsFaultMode=matStsFaultMode, matInvOutputFreq=matInvOutputFreq, matInvMBSPosError=matInvMBSPosError, matStsTemperature=matStsTemperature, matSts=matSts, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOutputVoltage=matStsOutputVoltage)
