...
Bits, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32, IpAddress, NotificationType, NotificationType, MibIdentifier, iso, Gauge32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "NotificationType", "MibIdentifier", "iso", "Gauge32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvTemperature=matInvTemperature, matStsOutputPower=matStsOutputPower, matStsEEPROMFault=matStsEEPROMFault, matConEEPROMFault=matConEEPROMFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, PositiveInteger=PositiveInteger, matInvSoftStartFail=matInvSoftStartFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsTemperature=matStsTemperature, matInvHardwareVersion=matInvHardwareVersion, matInvTable=matInvTable, matStsStatus=matStsStatus, matConfInvOutputPower=matConfInvOutputPower, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvOutputFreq=matInvOutputFreq, matStsInvFail=matStsInvFail, matConTemperature=matConTemperature, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvMainUnavailable=matInvMainUnavailable, matStsMainInputFreq=matStsMainInputFreq, matController=matController, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsTable=matStsTable, matInvMbsPosition=matInvMbsPosition, matStsWarningState=matStsWarningState, matDryContactString=matDryContactString, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapType=matTrapType, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matObjects=matObjects, matStsMbsStatus=matStsMbsStatus, matInvWarningState=matInvWarningState, matInvRunMode=matInvRunMode, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvBypassSCRShort=matInvBypassSCRShort, matStsMBSPosFault=matStsMBSPosFault, matInvNotRespond=matInvNotRespond, matReturnFromInvFanFault=matReturnFromInvFanFault, NonNegativeInteger=NonNegativeInteger, matInvOnOffStatus=matInvOnOffStatus, matInvModuleNum=matInvModuleNum, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matAgent=matAgent, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvOutputVoltage=matInvOutputVoltage, matStsSerialNum=matStsSerialNum, matStsModuleType=matStsModuleType, matStsFaultMode=matStsFaultMode, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvLineVoltage=matInvLineVoltage, matConSerialNum=matConSerialNum, matConfInvSysPriority=matConfInvSysPriority, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputCurrent=matInvOutputCurrent, matInvPhaseType=matInvPhaseType, matInvOutputPower=matInvOutputPower, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsOutputVoltage=matStsOutputVoltage, matStsRuntime=matStsRuntime, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matDryContact=matDryContact, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsIndex=matTrapTargetsIndex, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matTrapTargetsTable=matTrapTargetsTable, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvBusSoftFail=matInvBusSoftFail, matInvPowerLimit=matInvPowerLimit, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvMBSPosError=matInvMBSPosError, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvInputVoltage=matConfInvInputVoltage, matConfStsPriority=matConfStsPriority, matInvFirmwareVersion=matInvFirmwareVersion, matStsModuleNum=matStsModuleNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsTemperatureHigh=matStsTemperatureHigh, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvFault=matInvFault, matStsInvInputVoltage=matStsInvInputVoltage, matDryContactIndex=matDryContactIndex, matStsMainInputVoltage=matStsMainInputVoltage, matInvSerialNum=matInvSerialNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, device=device, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matSts=matSts, matReturnFromInvFault=matReturnFromInvFault, matTraps=matTraps, matStsFirmwareVersion=matStsFirmwareVersion, matInvPulseFault=matInvPulseFault, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsEntry=matStsEntry, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsOverLoad=matStsOverLoad, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvEntry=matInvEntry, matInvFanFault=matInvFanFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvOutputShort=matInvOutputShort, matInvModuleIndex=matInvModuleIndex, matDryContactEntry=matDryContactEntry, matStsInvBypassMode=matStsInvBypassMode, matInvOverLoad=matInvOverLoad, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matTrapTargetsEntry=matTrapTargetsEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvEEPROMFault=matInvEEPROMFault, matInvTempPowerLimit=matInvTempPowerLimit, matStsMainsFail=matStsMainsFail, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matTrapTargetsDesc=matTrapTargetsDesc, matInvLineFreq=matInvLineFreq, matDryContactNum=matDryContactNum, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matTrapTargets=matTrapTargets, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConCanBusOff=matConCanBusOff, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsFanFault=matStsFanFault, matConCommunicationLost=matConCommunicationLost, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsNotRespond=matStsNotRespond, matStsInvInputFreq=matStsInvInputFreq, matInvPriority=matInvPriority, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOutputFreq=matStsOutputFreq, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matConName=matConName, matConWarningState=matConWarningState, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsOutputCurrent=matStsOutputCurrent, matDryContactTable=matDryContactTable, matInvBatteryVoltage=matInvBatteryVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInverter=matInverter, matStsRunningMode=matStsRunningMode, matTrapTargetsAddress=matTrapTargetsAddress, matConfig=matConfig, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsBypassUnavailable=matStsBypassUnavailable, matConBatteryLow=matConBatteryLow, matStsControlPowerFail=matStsControlPowerFail, matStsModuleIndex=matStsModuleIndex, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsMainFail=matReturnFromStsMainFail, ppc=ppc, matInvRunTime=matInvRunTime, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvHardwareError=matInvHardwareError, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError)
