...
ModuleIdentity, Bits, ObjectIdentity, TimeTicks, Unsigned32, Gauge32, IpAddress, iso, NotificationType, Counter32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "Unsigned32", "Gauge32", "IpAddress", "iso", "NotificationType", "Counter32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsPriority=matConfStsPriority, matTrapTargetsNum=matTrapTargetsNum, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsOverLoad=matStsOverLoad, matInvBatteryVoltage=matInvBatteryVoltage, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvSysPriority=matConfInvSysPriority, matInvFault=matInvFault, matStsFanFault=matStsFanFault, matObjects=matObjects, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsFanSpeed=matConfStsFanSpeed, matInvModuleIndex=matInvModuleIndex, matConTemperature=matConTemperature, matInvRunTime=matInvRunTime, matInvMBSPosError=matInvMBSPosError, matDryContactTable=matDryContactTable, matInvNotRespond=matInvNotRespond, matInvLineFreq=matInvLineFreq, matStsEntry=matStsEntry, matTrapTargetsAddress=matTrapTargetsAddress, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapTargetsTable=matTrapTargetsTable, matInvFirmwareVersion=matInvFirmwareVersion, matStsMainInputVoltage=matStsMainInputVoltage, matStsMBSPosFault=matStsMBSPosFault, matStsNotRespond=matStsNotRespond, matInvPowerLimit=matInvPowerLimit, matInvHardwareError=matInvHardwareError, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConBatteryLow=matConBatteryLow, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConCommunicationLost=matConCommunicationLost, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMainsFail=matStsMainsFail, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapSeverityLevel=matTrapSeverityLevel, matInvEEPROMFault=matInvEEPROMFault, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvOutputPower=matInvOutputPower, matStsTemperature=matStsTemperature, matTrapTargets=matTrapTargets, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvMainUnavailable=matInvMainUnavailable, matInvOutputCurrent=matInvOutputCurrent, matAgent=matAgent, matInvMbsPosition=matInvMbsPosition, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvSoftStartFail=matInvSoftStartFail, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsNotRespond=matReturnFromStsNotRespond, NonNegativeInteger=NonNegativeInteger, matConSerialNum=matConSerialNum, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matDryContactNum=matDryContactNum, matStsOutputFreq=matStsOutputFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsModuleNum=matStsModuleNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, PositiveInteger=PositiveInteger, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matDryContactIndex=matDryContactIndex, matStsRuntime=matStsRuntime, matInvEPOShutdown=matInvEPOShutdown, matInverter=matInverter, matConWarningState=matConWarningState, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsModuleType=matStsModuleType, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, ppc=ppc, matInvTable=matInvTable, matTrapType=matTrapType, matConName=matConName, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsInvInputFreq=matStsInvInputFreq, matInvOutputVoltLow=matInvOutputVoltLow, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConEEPROMFault=matConEEPROMFault, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matStsOutputCurrent=matStsOutputCurrent, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsOutputVoltage=matStsOutputVoltage, matStsWarningState=matStsWarningState, matStsEEPROMFault=matStsEEPROMFault, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsOutputPower=matStsOutputPower, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsMainInputFreq=matStsMainInputFreq, matStsSerialNum=matStsSerialNum, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvLineVoltage=matInvLineVoltage, matInvOutputShort=matInvOutputShort, matConfInvOutputVoltage=matConfInvOutputVoltage, matController=matController, matInvTemperature=matInvTemperature, matTraps=matTraps, matInvRunMode=matInvRunMode, matInvFanFault=matInvFanFault, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matSts=matSts, matConTemperatureHigh=matConTemperatureHigh, matStsOutputAbnormal=matStsOutputAbnormal, matDryContact=matDryContact, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvSerialNum=matInvSerialNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matDryContactString=matDryContactString, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsInvFail=matStsInvFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConfInvOutputPower=matConfInvOutputPower, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsFaultMode=matStsFaultMode, matInvMaintenaceBypass=matInvMaintenaceBypass, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvBusSoftFail=matInvBusSoftFail, matStsStatus=matStsStatus, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvEntry=matInvEntry, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsTemperatureHigh=matStsTemperatureHigh, matInvPhaseType=matInvPhaseType, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvInputAbnormal=matInvInputAbnormal, matInvPulseFault=matInvPulseFault, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvWarningState=matInvWarningState, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsTable=matStsTable, matDryContactEntry=matDryContactEntry, matStsRunningMode=matStsRunningMode, matInvOutputFreq=matInvOutputFreq, matConfig=matConfig, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConCanBusOff=matConCanBusOff, matTrapTargetsDesc=matTrapTargetsDesc, matInvPriority=matInvPriority, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvModuleNum=matInvModuleNum, matInvOverLoad=matInvOverLoad, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsModuleIndex=matStsModuleIndex, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvNegativePowerProtect=matInvNegativePowerProtect, device=device)
