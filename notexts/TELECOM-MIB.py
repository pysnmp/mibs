...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvOutputVoltage=matConfInvOutputVoltage, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvRunMode=matInvRunMode, matInvMbsPosition=matInvMbsPosition, matSts=matSts, matInvPhaseType=matInvPhaseType, matStsModuleType=matStsModuleType, matStsInvFail=matStsInvFail, matConEEPROMFault=matConEEPROMFault, matDryContactNum=matDryContactNum, matStsTemperature=matStsTemperature, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matDryContactEntry=matDryContactEntry, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsInvFail=matReturnFromStsInvFail, matDryContactTable=matDryContactTable, matInvSerialNum=matInvSerialNum, matInvTemperature=matInvTemperature, matStsMainInputVoltage=matStsMainInputVoltage, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvBusSoftFail=matInvBusSoftFail, matConBatteryVoltHigh=matConBatteryVoltHigh, matConName=matConName, matConfig=matConfig, matInvNotRespond=matInvNotRespond, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsSerialNum=matStsSerialNum, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsOverLoad=matStsOverLoad, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsModuleIndex=matStsModuleIndex, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsTemperatureHigh=matStsTemperatureHigh, matStsOutputCurrent=matStsOutputCurrent, matStsFaultMode=matStsFaultMode, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsInvInputVoltage=matStsInvInputVoltage, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargetsTable=matTrapTargetsTable, matStsControlPowerFail=matStsControlPowerFail, matInvLowInputShutdown=matInvLowInputShutdown, matInvTemperatureHigh=matInvTemperatureHigh, matInvMainUnavailable=matInvMainUnavailable, matStsMaintenanceBypass=matStsMaintenanceBypass, matConfInvInputVoltage=matConfInvInputVoltage, matInvOutputVoltage=matInvOutputVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matInvSoftStartFail=matInvSoftStartFail, matInvOutputFreq=matInvOutputFreq, matInvInputAbnormal=matInvInputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvOutputShort=matInvOutputShort, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsOutputAbnormal=matStsOutputAbnormal, matConfStsPriority=matConfStsPriority, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvLineFreq=matInvLineFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matTrapTargetsIndex=matTrapTargetsIndex, matConfInvOutputPower=matConfInvOutputPower, matStsMainsFail=matStsMainsFail, matStsFanFault=matStsFanFault, matInvHardwareError=matInvHardwareError, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsMbsStatus=matStsMbsStatus, matConfStsFanSpeed=matConfStsFanSpeed, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapTargets=matTrapTargets, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsOutputFreq=matStsOutputFreq, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvPriority=matInvPriority, matObjects=matObjects, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matTrapTargetsCommunity=matTrapTargetsCommunity, matStsRunningMode=matStsRunningMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, NonNegativeInteger=NonNegativeInteger, matInvModuleNum=matInvModuleNum, matInvPulseFault=matInvPulseFault, matStsStatus=matStsStatus, matTrapSeverityLevel=matTrapSeverityLevel, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsTable=matStsTable, matConWarningState=matConWarningState, matInvFault=matInvFault, matStsInvBypassMode=matStsInvBypassMode, matInvBatteryVoltage=matInvBatteryVoltage, matTrapType=matTrapType, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvModuleIndex=matInvModuleIndex, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsWarningState=matStsWarningState, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, PositiveInteger=PositiveInteger, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargetsEntry=matTrapTargetsEntry, matStsModuleNum=matStsModuleNum, matStsOutputVoltage=matStsOutputVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOnOffStatus=matInvOnOffStatus, matInvOutputVoltLow=matInvOutputVoltLow, matConCanBusOff=matConCanBusOff, matInvBypassSCRShort=matInvBypassSCRShort, matInvEntry=matInvEntry, matReturnFromStsNotRespond=matReturnFromStsNotRespond, device=device, matInvLineVoltage=matInvLineVoltage, matInvWarningState=matInvWarningState, matInvRunTime=matInvRunTime, matStsEntry=matStsEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsMainInputFreq=matStsMainInputFreq, matDryContact=matDryContact, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvPowerLimit=matInvPowerLimit, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsRuntime=matStsRuntime, matDryContactIndex=matDryContactIndex, matStsMBSPosFault=matStsMBSPosFault, matInvEPOShutdown=matInvEPOShutdown, matConBatteryLow=matConBatteryLow, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matDryContactString=matDryContactString, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matController=matController, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvOutputPower=matInvOutputPower, matConTemperature=matConTemperature, matInvOverLoad=matInvOverLoad, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvMBSPosError=matInvMBSPosError, matTraps=matTraps, matStsNotRespond=matStsNotRespond, matAgent=matAgent, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, ppc=ppc, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsInvInputFreq=matStsInvInputFreq, matStsOutputPower=matStsOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConCommunicationLost=matConCommunicationLost, matInverter=matInverter, matTrapTargetsAddress=matTrapTargetsAddress, matInvTable=matInvTable, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvOutputCurrent=matInvOutputCurrent, matConSerialNum=matConSerialNum, matInvFirmwareVersion=matInvFirmwareVersion, matStsEEPROMFault=matStsEEPROMFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvFanFault=matInvFanFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal)
