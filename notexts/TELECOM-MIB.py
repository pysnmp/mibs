...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMainInputVoltage=matStsMainInputVoltage, matTrapTargetsNum=matTrapTargetsNum, matConfStsFanSpeed=matConfStsFanSpeed, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsTemperatureHigh=matStsTemperatureHigh, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsInvBypassMode=matStsInvBypassMode, matConTemperatureHigh=matConTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvOverLoad=matInvOverLoad, matInvOutputFreq=matInvOutputFreq, matTraps=matTraps, device=device, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvWarningState=matInvWarningState, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matDryContactTable=matDryContactTable, matStsInvInputFreq=matStsInvInputFreq, matInvTable=matInvTable, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matInvHardwareVersion=matInvHardwareVersion, matInvEntry=matInvEntry, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, ppc=ppc, matStsMbsStatus=matStsMbsStatus, matStsFirmwareVersion=matStsFirmwareVersion, matConTemperature=matConTemperature, matStsFaultMode=matStsFaultMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvModuleIndex=matInvModuleIndex, matStsTable=matStsTable, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsInvFail=matReturnFromStsInvFail, matConWarningState=matConWarningState, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfig=matConfig, NonNegativeInteger=NonNegativeInteger, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConSerialNum=matConSerialNum, matStsNotRespond=matStsNotRespond, matConCanBusOff=matConCanBusOff, matInvPhaseType=matInvPhaseType, matStsOutputFreq=matStsOutputFreq, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsIndex=matTrapTargetsIndex, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matInvMbsPosition=matInvMbsPosition, matInvBusSoftFail=matInvBusSoftFail, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsRuntime=matStsRuntime, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvOutputVoltage=matConfInvOutputVoltage, matConCommunicationLost=matConCommunicationLost, matStsMainsFail=matStsMainsFail, matInvLineFreq=matInvLineFreq, matObjects=matObjects, matSts=matSts, matInvTempPowerLimit=matInvTempPowerLimit, matStsRunningMode=matStsRunningMode, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsInvFail=matStsInvFail, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsTemperature=matStsTemperature, matInvOutputCurrent=matInvOutputCurrent, matDryContact=matDryContact, matInvSoftStartFail=matInvSoftStartFail, matStsModuleNum=matStsModuleNum, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvRunMode=matInvRunMode, matStsOutputVoltage=matStsOutputVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matInvRunTime=matInvRunTime, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOutputPower=matStsOutputPower, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsWarningState=matStsWarningState, matInvFanFault=matInvFanFault, matConName=matConName, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvTemperature=matInvTemperature, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matDryContactEntry=matDryContactEntry, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsBypassUnavailable=matStsBypassUnavailable, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matDryContactNum=matDryContactNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matTrapType=matTrapType, matConBatteryLow=matConBatteryLow, matInverter=matInverter, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsStatus=matStsStatus, matInvOnOffStatus=matInvOnOffStatus, matStsOutputCurrent=matStsOutputCurrent, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvSerialNum=matInvSerialNum, matInvMBSPosError=matInvMBSPosError, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvFault=matReturnFromInvFault, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matTrapTargetsEntry=matTrapTargetsEntry, matInvEEPROMFault=matInvEEPROMFault, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysPriority=matConfInvSysPriority, matInvInputAbnormal=matInvInputAbnormal, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOutputShort=matInvOutputShort, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvOutputVoltLow=matInvOutputVoltLow, matInvHardwareError=matInvHardwareError, matStsMBSPosFault=matStsMBSPosFault, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsAddress=matTrapTargetsAddress, matDryContactIndex=matDryContactIndex, PositiveInteger=PositiveInteger, matConEEPROMFault=matConEEPROMFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsFanFault=matStsFanFault, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMainInputFreq=matStsMainInputFreq, matStsOverLoad=matStsOverLoad, matStsModuleType=matStsModuleType, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvLineVoltage=matInvLineVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matInvMainUnavailable=matInvMainUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matController=matController, matInvBypassSCRShort=matInvBypassSCRShort, matInvOutputVoltage=matInvOutputVoltage, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvModuleNum=matInvModuleNum, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsModuleIndex=matStsModuleIndex, matInvFault=matInvFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsEntry=matStsEntry, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputAbnormal=matStsOutputAbnormal, matInvPowerLimit=matInvPowerLimit, matStsHardwareVersion=matStsHardwareVersion, matConfInvOutputFreq=matConfInvOutputFreq, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvPriority=matInvPriority, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvInputVoltage=matConfInvInputVoltage, matTrapTargets=matTrapTargets, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matAgent=matAgent, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsPriority=matConfStsPriority, matInvPulseFault=matInvPulseFault, matInvOutputPower=matInvOutputPower, matStsInvInputVoltage=matStsInvInputVoltage, matInvNotRespond=matInvNotRespond, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matDryContactString=matDryContactString, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsSerialNum=matStsSerialNum)
