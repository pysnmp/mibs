...
Bits, NotificationType, TimeTicks, ModuleIdentity, Gauge32, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier, Counter64, iso, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "TimeTicks", "ModuleIdentity", "Gauge32", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier", "Counter64", "iso", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputVoltage=matInvOutputVoltage, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysPowerLimit=matConfInvSysPowerLimit, ppc=ppc, matStsOutputFreq=matStsOutputFreq, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvSysPriority=matConfInvSysPriority, matInvTable=matInvTable, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsModuleNum=matStsModuleNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsMBSPosFault=matStsMBSPosFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matDryContact=matDryContact, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfStsPriority=matConfStsPriority, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvSerialNum=matInvSerialNum, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsWarningState=matStsWarningState, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvHardwareError=matInvHardwareError, matInvTempPowerLimit=matInvTempPowerLimit, matStsStatus=matStsStatus, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsHardwareVersion=matStsHardwareVersion, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConBatteryLow=matConBatteryLow, matConTemperature=matConTemperature, matStsOutputPower=matStsOutputPower, matAgentSoftwareVerison=matAgentSoftwareVerison, matDryContactEntry=matDryContactEntry, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matTrapTargetsNum=matTrapTargetsNum, matTrapTargetsIndex=matTrapTargetsIndex, matInvTemperature=matInvTemperature, matInvOnOffStatus=matInvOnOffStatus, matConfStsFanSpeed=matConfStsFanSpeed, matStsRuntime=matStsRuntime, matInvModuleNum=matInvModuleNum, matTrapSeverityLevel=matTrapSeverityLevel, matDryContactNum=matDryContactNum, matInvLineFreq=matInvLineFreq, matStsFanFault=matStsFanFault, matConSerialNum=matConSerialNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matDryContactIndex=matDryContactIndex, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapType=matTrapType, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvWarningState=matInvWarningState, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsOverLoad=matStsOverLoad, matConTemperatureHigh=matConTemperatureHigh, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsInvFail=matStsInvFail, matConEEPROMFault=matConEEPROMFault, matInvLineVoltage=matInvLineVoltage, matConfig=matConfig, matInverter=matInverter, matInvMBSPosError=matInvMBSPosError, matInvPulseFault=matInvPulseFault, matStsTemperature=matStsTemperature, matInvEntry=matInvEntry, matConCanBusOff=matConCanBusOff, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvRunTime=matInvRunTime, matStsSerialNum=matStsSerialNum, matInvNotRespond=matInvNotRespond, matInvOutputShort=matInvOutputShort, matTrapTargetsEntry=matTrapTargetsEntry, matObjects=matObjects, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvFirmwareVersion=matInvFirmwareVersion, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsEEPROMFault=matStsEEPROMFault, matTrapTargetsDesc=matTrapTargetsDesc, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvFanFault=matInvFanFault, matInvOutputPower=matInvOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, PositiveInteger=PositiveInteger, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvBatteryVoltage=matInvBatteryVoltage, matInvModuleIndex=matInvModuleIndex, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMainInputFreq=matStsMainInputFreq, matController=matController, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsInvInputFreq=matStsInvInputFreq, matConfInvInputVoltage=matConfInvInputVoltage, matConName=matConName, NonNegativeInteger=NonNegativeInteger, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvOutputFreq=matInvOutputFreq, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsFaultMode=matStsFaultMode, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvOutputPower=matConfInvOutputPower, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvMainUnavailable=matInvMainUnavailable, matInvRunMode=matInvRunMode, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsTable=matStsTable, matStsModuleIndex=matStsModuleIndex, matSts=matSts, matStsModuleType=matStsModuleType, matStsEntry=matStsEntry, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvOverLoad=matInvOverLoad, matInvPhaseType=matInvPhaseType, matConCommunicationLost=matConCommunicationLost, matTraps=matTraps, matConWarningState=matConWarningState, matInvOutputCurrent=matInvOutputCurrent, matStsNotRespond=matStsNotRespond, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsBypassUnavailable=matStsBypassUnavailable, matTrapTargets=matTrapTargets, matDryContactString=matDryContactString, matTrapTargetsAddress=matTrapTargetsAddress, matInvSoftStartFail=matInvSoftStartFail, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matAgent=matAgent, matStsMbsStatus=matStsMbsStatus, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsOutputAbnormal=matStsOutputAbnormal, matStsInvBypassMode=matStsInvBypassMode, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvEEPROMFault=matInvEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsRunningMode=matStsRunningMode, matInvInputAbnormal=matInvInputAbnormal, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMainsFail=matStsMainsFail, matStsTemperatureHigh=matStsTemperatureHigh, matInvFault=matInvFault, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsControlPowerFail=matStsControlPowerFail, matDryContactTable=matDryContactTable, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsFirmwareVersion=matStsFirmwareVersion, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, device=device, matInvMbsPosition=matInvMbsPosition, matInvPriority=matInvPriority, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvPowerLimit=matInvPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect)
