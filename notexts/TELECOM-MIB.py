...
mibBuilder.exportSymbols("TELECOM-MIB", matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsMbsStatus=matStsMbsStatus, matDryContactString=matDryContactString, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matTrapTargetsIndex=matTrapTargetsIndex, matStsModuleType=matStsModuleType, matStsMainsFail=matStsMainsFail, matConCommunicationLost=matConCommunicationLost, matInvLineVoltage=matInvLineVoltage, matInvMainUnavailable=matInvMainUnavailable, matConfStsPriority=matConfStsPriority, matInvSoftStartFail=matInvSoftStartFail, matInvEntry=matInvEntry, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsTable=matStsTable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfInvSysPriority=matConfInvSysPriority, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvTable=matInvTable, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvPriority=matInvPriority, matStsOutputVoltage=matStsOutputVoltage, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConfInvOutputPower=matConfInvOutputPower, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matDryContactEntry=matDryContactEntry, matInverter=matInverter, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBatteryVoltage=matInvBatteryVoltage, matInvOutputFreq=matInvOutputFreq, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsOverLoad=matStsOverLoad, matInvOverLoad=matInvOverLoad, matInvNotRespond=matInvNotRespond, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsInvFail=matStsInvFail, matInvRunTime=matInvRunTime, matInvPulseFault=matInvPulseFault, matStsHardwareVersion=matStsHardwareVersion, matStsFaultMode=matStsFaultMode, matInvFanFault=matInvFanFault, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvHardwareVersion=matInvHardwareVersion, matInvRunMode=matInvRunMode, matDryContactIndex=matDryContactIndex, matStsInvBypassMode=matStsInvBypassMode, matStsMBSPosFault=matStsMBSPosFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvOutputVoltage=matInvOutputVoltage, matConTemperatureHigh=matConTemperatureHigh, matInvPhaseType=matInvPhaseType, matAgent=matAgent, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOutputPower=matStsOutputPower, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvInputVoltage=matConfInvInputVoltage, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsTemperatureHigh=matStsTemperatureHigh, matConTemperature=matConTemperature, matTrapTargetsNum=matTrapTargetsNum, matInvModuleNum=matInvModuleNum, matConfStsFanSpeed=matConfStsFanSpeed, matInvBusSoftFail=matInvBusSoftFail, matStsFanFault=matStsFanFault, device=device, matStsRunningMode=matStsRunningMode, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsInvHighLossVoltage=matStsInvHighLossVoltage, PositiveInteger=PositiveInteger, matStsSerialNum=matStsSerialNum, matStsNotRespond=matStsNotRespond, matInvBypassSCRShort=matInvBypassSCRShort, matStsModuleIndex=matStsModuleIndex, matConfInvOutputFreq=matConfInvOutputFreq, matInvEPOShutdown=matInvEPOShutdown, matStsEntry=matStsEntry, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvTemperatureHigh=matInvTemperatureHigh, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvMBSPosError=matInvMBSPosError, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsOutputAbnormal=matStsOutputAbnormal, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvWarningState=matInvWarningState, matInvOutputVoltLow=matInvOutputVoltLow, matInvLineFreq=matInvLineFreq, matStsOutputFreq=matStsOutputFreq, matInvOutputCurrent=matInvOutputCurrent, matController=matController, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperature=matInvTemperature, matConName=matConName, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matDryContactTable=matDryContactTable, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConCanBusOff=matConCanBusOff, matInvPowerLimit=matInvPowerLimit, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvOutputPower=matInvOutputPower, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvSerialNum=matInvSerialNum, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsRuntime=matStsRuntime, matTraps=matTraps, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, NonNegativeInteger=NonNegativeInteger, matReturnFromInvFault=matReturnFromInvFault, matStsStatus=matStsStatus, matTrapTargetsEntry=matTrapTargetsEntry, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvModuleIndex=matInvModuleIndex, matStsModuleNum=matStsModuleNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConSerialNum=matConSerialNum, matStsTemperature=matStsTemperature, matStsMainInputFreq=matStsMainInputFreq, matInvTempPowerLimit=matInvTempPowerLimit, matDryContact=matDryContact, ppc=ppc, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvInputAbnormal=matInvInputAbnormal, matTrapTargets=matTrapTargets, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matObjects=matObjects, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvOutputShort=matInvOutputShort, matStsEEPROMFault=matStsEEPROMFault, matInvFault=matInvFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfig=matConfig, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvEEPROMFault=matInvEEPROMFault, matSts=matSts, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConEEPROMFault=matConEEPROMFault, matDryContactNum=matDryContactNum, matStsWarningState=matStsWarningState, matTrapType=matTrapType, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvMbsPosition=matInvMbsPosition, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConWarningState=matConWarningState, matInvOnOffStatus=matInvOnOffStatus, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsInvInputFreq=matStsInvInputFreq, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConBatteryLow=matConBatteryLow, matStsMainInputVoltage=matStsMainInputVoltage, matInvHardwareError=matInvHardwareError, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss)
