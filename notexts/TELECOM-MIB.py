...
Bits, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Integer32, NotificationType, enterprises, NotificationType, TimeTicks, ObjectIdentity, ModuleIdentity, Gauge32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Integer32", "NotificationType", "enterprises", "NotificationType", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTraps=matTraps, matInvModuleNum=matInvModuleNum, matDryContact=matDryContact, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matTrapTargetsCommunity=matTrapTargetsCommunity, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvHardwareError=matInvHardwareError, matObjects=matObjects, matInvBatteryVoltage=matInvBatteryVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConEEPROMFault=matConEEPROMFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvTemperatureHigh=matInvTemperatureHigh, ppc=ppc, matInvRunTime=matInvRunTime, matStsEntry=matStsEntry, matConTemperatureHigh=matConTemperatureHigh, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsNotRespond=matStsNotRespond, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapSeverityLevel=matTrapSeverityLevel, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matStsRuntime=matStsRuntime, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvRunMode=matInvRunMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvHardwareVersion=matInvHardwareVersion, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsOverLoad=matStsOverLoad, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, PositiveInteger=PositiveInteger, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsRunningMode=matStsRunningMode, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsFanFault=matStsFanFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matInverter=matInverter, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matDryContactTable=matDryContactTable, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsModuleType=matStsModuleType, matController=matController, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsInvBypassMode=matStsInvBypassMode, matConSerialNum=matConSerialNum, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsMainsFail=matStsMainsFail, matStsFirmwareVersion=matStsFirmwareVersion, matInvFault=matInvFault, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsInvInputFreq=matStsInvInputFreq, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvEntry=matInvEntry, matInvMbsPosition=matInvMbsPosition, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysPriority=matConfInvSysPriority, matStsTable=matStsTable, matTrapTargetsNum=matTrapTargetsNum, matStsFaultMode=matStsFaultMode, matStsControlPowerFail=matStsControlPowerFail, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFault=matReturnFromInvFault, matConCanBusOff=matConCanBusOff, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsOutputFreq=matStsOutputFreq, matInvPriority=matInvPriority, matInvOutputShort=matInvOutputShort, matConfig=matConfig, matStsOutputPower=matStsOutputPower, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsMBSPosFault=matStsMBSPosFault, matConBatteryLow=matConBatteryLow, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvEEPROMFault=matInvEEPROMFault, matConCommunicationLost=matConCommunicationLost, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapTargets=matTrapTargets, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvSerialNum=matInvSerialNum, matStsOutputShortCircuit=matStsOutputShortCircuit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matAgentSoftwareVerison=matAgentSoftwareVerison, matStsModuleNum=matStsModuleNum, matInvFanFault=matInvFanFault, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConWarningState=matConWarningState, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConTemperature=matConTemperature, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matDryContactNum=matDryContactNum, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvModuleIndex=matInvModuleIndex, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvLineFreq=matInvLineFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsSerialNum=matStsSerialNum, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOnOffStatus=matInvOnOffStatus, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matDryContactString=matDryContactString, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, NonNegativeInteger=NonNegativeInteger, matConfInvInputVoltage=matConfInvInputVoltage, matInvMainUnavailable=matInvMainUnavailable, matConBatteryVoltHigh=matConBatteryVoltHigh, matConfStsPriority=matConfStsPriority, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvFirmwareVersion=matInvFirmwareVersion, matInvOutputPower=matInvOutputPower, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsWarningState=matStsWarningState, matDryContactEntry=matDryContactEntry, matTrapType=matTrapType, matAgent=matAgent, matStsModuleIndex=matStsModuleIndex, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvPowerLimit=matInvPowerLimit, matStsStatus=matStsStatus, matInvTemperature=matInvTemperature, matInvOutputVoltage=matInvOutputVoltage, matConName=matConName, matConfInvSysOutputVolt=matConfInvSysOutputVolt, device=device, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsBypassUnavailable=matStsBypassUnavailable, matStsOutputVoltage=matStsOutputVoltage, matInvOverLoad=matInvOverLoad, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvBypassSCRShort=matInvBypassSCRShort, matStsTemperature=matStsTemperature, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapTargetsAddress=matTrapTargetsAddress, matInvTable=matInvTable, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvFail=matStsInvFail, matInvOutputFreq=matInvOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvWarningState=matInvWarningState, matInvLineVoltage=matInvLineVoltage, matConfStsFanSpeed=matConfStsFanSpeed, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvMBSPosError=matInvMBSPosError, matInvPhaseType=matInvPhaseType, matDryContactIndex=matDryContactIndex, matTrapTargetsDesc=matTrapTargetsDesc, matInvBusSoftFail=matInvBusSoftFail, matInvPulseFault=matInvPulseFault, matStsHardwareVersion=matStsHardwareVersion, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvNotRespond=matInvNotRespond, matStsInvInputVoltage=matStsInvInputVoltage, matSts=matSts, matStsEEPROMFault=matStsEEPROMFault, matConfInvOutputPower=matConfInvOutputPower, matReturnFromCommunicationLost=matReturnFromCommunicationLost)
