...
ObjectIdentity, Unsigned32, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, NotificationType, enterprises, Counter32, Bits, iso, MibIdentifier, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "NotificationType", "enterprises", "Counter32", "Bits", "iso", "MibIdentifier", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvInputFreq=matStsInvInputFreq, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConWarningState=matConWarningState, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsOutputAbnormal=matStsOutputAbnormal, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvOutputFreq=matConfInvOutputFreq, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matSts=matSts, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matDryContactTable=matDryContactTable, matInvPulseFault=matInvPulseFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvSoftStartFail=matInvSoftStartFail, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsNotRespond=matStsNotRespond, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matTrapTargets=matTrapTargets, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvBatteryVoltage=matInvBatteryVoltage, matDryContactEntry=matDryContactEntry, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvOutputPower=matConfInvOutputPower, matStsFanFault=matStsFanFault, matStsTemperature=matStsTemperature, matStsControlPowerFail=matStsControlPowerFail, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsOutputCurrent=matStsOutputCurrent, matAgent=matAgent, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matController=matController, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matConCanBusOff=matConCanBusOff, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, ppc=ppc, matStsModuleNum=matStsModuleNum, matInvFirmwareVersion=matInvFirmwareVersion, matConfStsPriority=matConfStsPriority, matStsTable=matStsTable, matStsInvInputVoltage=matStsInvInputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matTrapTargetsIndex=matTrapTargetsIndex, matDryContactIndex=matDryContactIndex, matTraps=matTraps, matInvSerialNum=matInvSerialNum, matInvTable=matInvTable, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOverLoad=matStsOverLoad, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvLineVoltage=matInvLineVoltage, matInvInputAbnormal=matInvInputAbnormal, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfig=matConfig, matConfStsFanSpeed=matConfStsFanSpeed, device=device, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matConEEPROMFault=matConEEPROMFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matDryContactString=matDryContactString, matInvMbsPosition=matInvMbsPosition, matStsMainInputFreq=matStsMainInputFreq, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvLineFreq=matInvLineFreq, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matTrapSeverityLevel=matTrapSeverityLevel, matInvBypassSCRShort=matInvBypassSCRShort, matStsMBSPosFault=matStsMBSPosFault, matObjects=matObjects, matDryContactNum=matDryContactNum, matTrapTargetsTable=matTrapTargetsTable, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConCommunicationLost=matConCommunicationLost, matInvPhaseType=matInvPhaseType, matConTemperature=matConTemperature, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsOutputPower=matStsOutputPower, matDryContact=matDryContact, matInvTempPowerLimit=matInvTempPowerLimit, matStsMbsStatus=matStsMbsStatus, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvFault=matReturnFromInvFault, matInvEEPROMFault=matInvEEPROMFault, matInvRunTime=matInvRunTime, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsMainInputVoltage=matStsMainInputVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvRunMode=matInvRunMode, matStsHardwareVersion=matStsHardwareVersion, matInvNotRespond=matInvNotRespond, matStsFaultMode=matStsFaultMode, matStsInvFail=matStsInvFail, matInvOnOffStatus=matInvOnOffStatus, matStsEEPROMFault=matStsEEPROMFault, matStsEntry=matStsEntry, matConfInvSysInputVolt=matConfInvSysInputVolt, matConSerialNum=matConSerialNum, matInvOverLoad=matInvOverLoad, matStsInvBypassMode=matStsInvBypassMode, matInvOutputCurrent=matInvOutputCurrent, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsModuleIndex=matStsModuleIndex, matInvFault=matInvFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvOutputShort=matInvOutputShort, matConTemperatureHigh=matConTemperatureHigh, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsWarningState=matStsWarningState, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matTrapType=matTrapType, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matStsFirmwareVersion=matStsFirmwareVersion, matStsInvLosLossVoltage=matStsInvLosLossVoltage, NonNegativeInteger=NonNegativeInteger, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsStatus=matStsStatus, matInvFanFault=matInvFanFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvHardwareError=matInvHardwareError, matInvPriority=matInvPriority, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvMBSPosError=matInvMBSPosError, matInvLowInputShutdown=matInvLowInputShutdown, matStsRunningMode=matStsRunningMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvPowerLimit=matInvPowerLimit, matInvHardwareVersion=matInvHardwareVersion, matInverter=matInverter, PositiveInteger=PositiveInteger, matConfInvSysPriority=matConfInvSysPriority, matInvOutputFreq=matInvOutputFreq, matStsSerialNum=matStsSerialNum, matConName=matConName, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvTemperature=matInvTemperature, matStsRuntime=matStsRuntime, matInvOutputPower=matInvOutputPower, matTrapTargetsNum=matTrapTargetsNum, matInvMainUnavailable=matInvMainUnavailable, matStsMainsFail=matStsMainsFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsModuleType=matStsModuleType, matStsOutputFreq=matStsOutputFreq, matInvModuleNum=matInvModuleNum, matTrapTargetsDesc=matTrapTargetsDesc, matInvEntry=matInvEntry, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvTemperatureHigh=matInvTemperatureHigh, matInvWarningState=matInvWarningState, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConBatteryLow=matConBatteryLow, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromStsMainFail=matReturnFromStsMainFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsBypassUnavailable=matStsBypassUnavailable, matInvModuleIndex=matInvModuleIndex)
