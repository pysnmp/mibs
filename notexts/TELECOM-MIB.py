...
mibBuilder.exportSymbols("TELECOM-MIB", matStsTable=matStsTable, matInvTemperature=matInvTemperature, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsModuleIndex=matStsModuleIndex, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysPriority=matConfInvSysPriority, matInvOutputVoltLow=matInvOutputVoltLow, ppc=ppc, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsInvFail=matStsInvFail, matConEEPROMFault=matConEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matStsWarningState=matStsWarningState, matStsMainInputFreq=matStsMainInputFreq, matConSerialNum=matConSerialNum, matInvPowerLimit=matInvPowerLimit, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, PositiveInteger=PositiveInteger, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConTemperature=matConTemperature, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvPulseFault=matInvPulseFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvInputVoltage=matConfInvInputVoltage, matStsTemperature=matStsTemperature, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matAgentSoftwareVerison=matAgentSoftwareVerison, matController=matController, matInvSerialNum=matInvSerialNum, matInvEntry=matInvEntry, matReturnFromInvFault=matReturnFromInvFault, matInvHardwareVersion=matInvHardwareVersion, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsFanFault=matStsFanFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromStsInvFail=matReturnFromStsInvFail, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsAddress=matTrapTargetsAddress, matStsMbsStatus=matStsMbsStatus, matInvBusSoftFail=matInvBusSoftFail, matStsRunningMode=matStsRunningMode, matStsEEPROMFault=matStsEEPROMFault, matInvOutputPower=matInvOutputPower, matStsOutputAbnormal=matStsOutputAbnormal, matConfInvSysInputVolt=matConfInvSysInputVolt, NonNegativeInteger=NonNegativeInteger, matDryContact=matDryContact, matConfig=matConfig, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMainInputVoltage=matStsMainInputVoltage, matObjects=matObjects, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargets=matTrapTargets, matStsOutputFreq=matStsOutputFreq, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvNotRespond=matInvNotRespond, matStsNotRespond=matStsNotRespond, matStsBypassUnavailable=matStsBypassUnavailable, matInvLineFreq=matInvLineFreq, matStsEntry=matStsEntry, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfInvOutputPower=matConfInvOutputPower, matInvHardwareError=matInvHardwareError, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsOverLoad=matStsOverLoad, matTrapTargetsCommunity=matTrapTargetsCommunity, matConWarningState=matConWarningState, matInvEPOShutdown=matInvEPOShutdown, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvOutputVoltage=matConfInvOutputVoltage, matDryContactEntry=matDryContactEntry, matDryContactIndex=matDryContactIndex, matStsModuleType=matStsModuleType, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMaintenanceBypass=matStsMaintenanceBypass, matDryContactTable=matDryContactTable, device=device, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvRunMode=matInvRunMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvSoftStartFail=matInvSoftStartFail, matInvTemperatureHigh=matInvTemperatureHigh, matTraps=matTraps, matStsInvBypassMode=matStsInvBypassMode, matStsOutputVoltage=matStsOutputVoltage, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvOutputCurrent=matInvOutputCurrent, matInvModuleNum=matInvModuleNum, matInvOverLoad=matInvOverLoad, matInvOutputShort=matInvOutputShort, matSts=matSts, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvTable=matInvTable, matInvOnOffStatus=matInvOnOffStatus, matConfStsPriority=matConfStsPriority, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matConName=matConName, matStsFaultMode=matStsFaultMode, matInvFirmwareVersion=matInvFirmwareVersion, matInvMainUnavailable=matInvMainUnavailable, matTrapType=matTrapType, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConTemperatureHigh=matConTemperatureHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsFirmwareVersion=matStsFirmwareVersion, matInvEEPROMFault=matInvEEPROMFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matAgent=matAgent, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvTempPowerLimit=matInvTempPowerLimit, matDryContactNum=matDryContactNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContactString=matDryContactString, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsRuntime=matStsRuntime, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvOutputFreq=matInvOutputFreq, matInvMBSPosError=matInvMBSPosError, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsHardwareVersion=matStsHardwareVersion, matInvInputAbnormal=matInvInputAbnormal, matStsOutputCurrent=matStsOutputCurrent, matInvPhaseType=matInvPhaseType, matInvFault=matInvFault, matInvFanFault=matInvFanFault, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsIndex=matTrapTargetsIndex, matInvRunTime=matInvRunTime, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvLineVoltage=matInvLineVoltage, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matStsOutputPower=matStsOutputPower, matInvMbsPosition=matInvMbsPosition, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsControlPowerFail=matStsControlPowerFail, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsSerialNum=matStsSerialNum, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvPriority=matInvPriority, matConBatteryLow=matConBatteryLow, matStsModuleNum=matStsModuleNum, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsStatus=matStsStatus, matTrapSeverityLevel=matTrapSeverityLevel, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvModuleIndex=matInvModuleIndex, matConCanBusOff=matConCanBusOff, matStsMainsFail=matStsMainsFail, matInverter=matInverter)
