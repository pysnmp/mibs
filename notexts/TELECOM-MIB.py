...
mibBuilder.exportSymbols("TELECOM-MIB", matInvOutputVoltage=matInvOutputVoltage, matStsOverLoad=matStsOverLoad, matDryContact=matDryContact, matConName=matConName, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matConTemperature=matConTemperature, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsOutputPower=matStsOutputPower, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matTrapTargetsTable=matTrapTargetsTable, ppc=ppc, matInvFault=matInvFault, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matStsMainInputVoltage=matStsMainInputVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvFanFault=matInvFanFault, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvPowerLimit=matInvPowerLimit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConWarningState=matConWarningState, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConfInvOutputPower=matConfInvOutputPower, matStsControlPowerFail=matStsControlPowerFail, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsTemperatureHigh=matStsTemperatureHigh, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvHardwareVersion=matInvHardwareVersion, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, device=device, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matTrapTargets=matTrapTargets, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMBSPosFault=matStsMBSPosFault, matTraps=matTraps, matInverter=matInverter, matConCanBusOff=matConCanBusOff, matDryContactNum=matDryContactNum, matStsEntry=matStsEntry, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvRunTime=matInvRunTime, matReturnFromInvFault=matReturnFromInvFault, matInvMbsPosition=matInvMbsPosition, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, NonNegativeInteger=NonNegativeInteger, matInvMainUnavailable=matInvMainUnavailable, matConSerialNum=matConSerialNum, matStsInvBypassMode=matStsInvBypassMode, matStsTemperature=matStsTemperature, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConTemperatureHigh=matConTemperatureHigh, matInvModuleIndex=matInvModuleIndex, matInvLineFreq=matInvLineFreq, matStsInvInputFreq=matStsInvInputFreq, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsModuleNum=matStsModuleNum, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matInvSerialNum=matInvSerialNum, matConfInvOutputFreq=matConfInvOutputFreq, matInvInputAbnormal=matInvInputAbnormal, matStsFaultMode=matStsFaultMode, matInvTemperature=matInvTemperature, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matStsModuleType=matStsModuleType, matInvOverLoad=matInvOverLoad, matInvOutputShort=matInvOutputShort, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvEPOShutdown=matInvEPOShutdown, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matDryContactString=matDryContactString, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsOutputFreq=matStsOutputFreq, matConfStsFanSpeed=matConfStsFanSpeed, matConEEPROMFault=matConEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsDesc=matTrapTargetsDesc, matInvOutputPower=matInvOutputPower, matStsRuntime=matStsRuntime, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConBatteryLow=matConBatteryLow, matInvRunMode=matInvRunMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvTable=matInvTable, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsBypassUnavailable=matStsBypassUnavailable, matStsFanFault=matStsFanFault, matConfInvInputVoltage=matConfInvInputVoltage, matStsInvFail=matStsInvFail, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvMBSPosError=matInvMBSPosError, matTrapTargetsEntry=matTrapTargetsEntry, matStsInvInputVoltage=matStsInvInputVoltage, matConfStsPriority=matConfStsPriority, matTrapTargetsNum=matTrapTargetsNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvPulseFault=matInvPulseFault, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsMaintenanceBypass=matStsMaintenanceBypass, matSts=matSts, matStsRunningMode=matStsRunningMode, matConCommunicationLost=matConCommunicationLost, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matController=matController, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvEntry=matInvEntry, matStsEEPROMFault=matStsEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvOutputCurrent=matInvOutputCurrent, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysPriority=matConfInvSysPriority, matDryContactEntry=matDryContactEntry, matStsFirmwareVersion=matStsFirmwareVersion, matStsWarningState=matStsWarningState, matStsStatus=matStsStatus, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, PositiveInteger=PositiveInteger, matConfig=matConfig, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvPhaseType=matInvPhaseType, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsOutputVoltage=matStsOutputVoltage, matObjects=matObjects, matInvModuleNum=matInvModuleNum, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsTable=matStsTable, matDryContactIndex=matDryContactIndex, matDryContactTable=matDryContactTable, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsIndex=matTrapTargetsIndex, matInvNotRespond=matInvNotRespond, matInvHardwareError=matInvHardwareError, matInvLineVoltage=matInvLineVoltage, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsMbsStatus=matStsMbsStatus, matInvOutputFreq=matInvOutputFreq, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvPriority=matInvPriority, matAgent=matAgent, matConfInvSysInputVolt=matConfInvSysInputVolt, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapType=matTrapType, matInvFirmwareVersion=matInvFirmwareVersion, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsInvFail=matReturnFromStsInvFail, matTrapSeverityLevel=matTrapSeverityLevel, matStsMainsFail=matStsMainsFail, matStsNotRespond=matStsNotRespond, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsSerialNum=matStsSerialNum, matStsOutputAbnormal=matStsOutputAbnormal, matStsMainInputFreq=matStsMainInputFreq)
