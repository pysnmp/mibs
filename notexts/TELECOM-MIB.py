...
ObjectIdentity, Bits, TimeTicks, ModuleIdentity, MibIdentifier, Counter32, Gauge32, IpAddress, enterprises, Counter64, Unsigned32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter32", "Gauge32", "IpAddress", "enterprises", "Counter64", "Unsigned32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapType=matTrapType, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvModuleNum=matInvModuleNum, matStsInvInputFreq=matStsInvInputFreq, matInvPulseFault=matInvPulseFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsInvFail=matStsInvFail, matStsEntry=matStsEntry, matStsOverLoad=matStsOverLoad, matInvSoftStartFail=matInvSoftStartFail, matInvWarningState=matInvWarningState, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvOnOffStatus=matInvOnOffStatus, matController=matController, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOverLoad=matInvOverLoad, matInvInputAbnormal=matInvInputAbnormal, matTraps=matTraps, matConWarningState=matConWarningState, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matDryContactString=matDryContactString, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvMBSPosError=matInvMBSPosError, matStsSerialNum=matStsSerialNum, matStsMBSPosFault=matStsMBSPosFault, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvSerialNum=matInvSerialNum, matInvOutputFreq=matInvOutputFreq, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvModuleIndex=matInvModuleIndex, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matDryContactTable=matDryContactTable, matStsInvInputVoltage=matStsInvInputVoltage, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, ppc=ppc, matStsWarningState=matStsWarningState, matDryContactIndex=matDryContactIndex, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsFanFault=matStsFanFault, matInvMbsPosition=matInvMbsPosition, matStsOutputCurrent=matStsOutputCurrent, matDryContactNum=matDryContactNum, matInvFault=matInvFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matConCommunicationLost=matConCommunicationLost, matInvOutputPower=matInvOutputPower, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvEEPROMFault=matInvEEPROMFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsTemperatureHigh=matStsTemperatureHigh, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvOutputShort=matInvOutputShort, matStsBypassUnavailable=matStsBypassUnavailable, matStsModuleNum=matStsModuleNum, matConEEPROMFault=matConEEPROMFault, matInvPowerLimit=matInvPowerLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matTrapTargetsNum=matTrapTargetsNum, matDryContactEntry=matDryContactEntry, matStsFaultMode=matStsFaultMode, matInvLineFreq=matInvLineFreq, matStsMainsFail=matStsMainsFail, matStsMainInputFreq=matStsMainInputFreq, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConName=matConName, matInvTemperature=matInvTemperature, matStsOutputPower=matStsOutputPower, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfInvOutputPower=matConfInvOutputPower, matStsModuleIndex=matStsModuleIndex, matStsRunningMode=matStsRunningMode, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsOutputVoltage=matStsOutputVoltage, matConfInvInputVoltage=matConfInvInputVoltage, matStsTable=matStsTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBypassSCRShort=matInvBypassSCRShort, matInvFanFault=matInvFanFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsMainInputVoltage=matStsMainInputVoltage, matInvFirmwareVersion=matInvFirmwareVersion, matInvTempPowerLimit=matInvTempPowerLimit, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsTable=matTrapTargetsTable, matInvMainUnavailable=matInvMainUnavailable, matInvHardwareError=matInvHardwareError, device=device, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvRunMode=matInvRunMode, matInvNotRespond=matInvNotRespond, matStsOutputFreq=matStsOutputFreq, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matObjects=matObjects, matInvLineVoltage=matInvLineVoltage, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvTable=matInvTable, matInvPhaseType=matInvPhaseType, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvOutputCurrent=matInvOutputCurrent, matStsHardwareVersion=matStsHardwareVersion, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvRunTime=matInvRunTime, matConCanBusOff=matConCanBusOff, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvBusSoftFail=matInvBusSoftFail, matInvOutputVoltage=matInvOutputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContact=matDryContact, matConfig=matConfig, matAgentSoftwareVerison=matAgentSoftwareVerison, matTrapTargetsEntry=matTrapTargetsEntry, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvNegativePowerProtect=matInvNegativePowerProtect, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConTemperatureHigh=matConTemperatureHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvBatteryVoltage=matInvBatteryVoltage, matStsStatus=matStsStatus, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matTrapSeverityLevel=matTrapSeverityLevel, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvEntry=matInvEntry, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvPriority=matInvPriority, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsTemperature=matStsTemperature, matConfStsPriority=matConfStsPriority, matStsRuntime=matStsRuntime, matInverter=matInverter, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvLowInputShutdown=matInvLowInputShutdown, matTrapTargetsAddress=matTrapTargetsAddress, matStsFirmwareVersion=matStsFirmwareVersion, matInvEPOShutdown=matInvEPOShutdown, matStsInvBypassMode=matStsInvBypassMode, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matAgent=matAgent, matStsMbsStatus=matStsMbsStatus, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsIndex=matTrapTargetsIndex, matStsOutputAbnormal=matStsOutputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConTemperature=matConTemperature, NonNegativeInteger=NonNegativeInteger, PositiveInteger=PositiveInteger, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matConBatteryLow=matConBatteryLow, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsNotRespond=matStsNotRespond, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsModuleType=matStsModuleType, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromStsFanFault=matReturnFromStsFanFault, matTrapTargets=matTrapTargets, matSts=matSts, matConSerialNum=matConSerialNum, matStsControlPowerFail=matStsControlPowerFail, matConfInvSysPriority=matConfInvSysPriority)
