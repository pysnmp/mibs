...
Counter32, IpAddress, iso, Counter64, Integer32, Gauge32, enterprises, TimeTicks, NotificationType, Bits, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "iso", "Counter64", "Integer32", "Gauge32", "enterprises", "TimeTicks", "NotificationType", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELECOM-MIB", matTrapTargetsTable=matTrapTargetsTable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargets=matTrapTargets, matStsWarningState=matStsWarningState, matInvTemperatureHigh=matInvTemperatureHigh, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConEEPROMFault=matConEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsStatus=matStsStatus, matTrapTargetsNum=matTrapTargetsNum, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matTrapTargetsDesc=matTrapTargetsDesc, matInvTempPowerLimit=matInvTempPowerLimit, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matInvModuleIndex=matInvModuleIndex, matInvFault=matInvFault, matStsHardwareVersion=matStsHardwareVersion, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputShort=matInvOutputShort, matInvLineVoltage=matInvLineVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsTable=matStsTable, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvEEPROMFault=matInvEEPROMFault, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvOnOffStatus=matInvOnOffStatus, matStsOutputCurrent=matStsOutputCurrent, matStsSerialNum=matStsSerialNum, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvModuleNum=matInvModuleNum, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matConfInvOutputPower=matConfInvOutputPower, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsModuleType=matStsModuleType, PositiveInteger=PositiveInteger, matConfStsFanSpeed=matConfStsFanSpeed, matInvHardwareVersion=matInvHardwareVersion, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matDryContactString=matDryContactString, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsTemperature=matStsTemperature, matStsRuntime=matStsRuntime, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsEEPROMFault=matStsEEPROMFault, matDryContactNum=matDryContactNum, matDryContactIndex=matDryContactIndex, matTraps=matTraps, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvHardwareError=matInvHardwareError, matInvFanFault=matInvFanFault, matStsFaultMode=matStsFaultMode, matInvSerialNum=matInvSerialNum, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, NonNegativeInteger=NonNegativeInteger, matObjects=matObjects, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOverLoad=matInvOverLoad, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargetsIndex=matTrapTargetsIndex, matConBatteryLow=matConBatteryLow, matConCanBusOff=matConCanBusOff, matInvOutputCurrent=matInvOutputCurrent, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvPowerLimit=matInvPowerLimit, matStsModuleIndex=matStsModuleIndex, matStsFanFault=matStsFanFault, matAgent=matAgent, matStsMbsStatus=matStsMbsStatus, matStsModuleNum=matStsModuleNum, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvNotRespond=matInvNotRespond, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvInputVoltage=matStsInvInputVoltage, matInvEntry=matInvEntry, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvOutputPower=matInvOutputPower, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvFault=matReturnFromInvFault, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfInvSysPriority=matConfInvSysPriority, matStsMainInputFreq=matStsMainInputFreq, matInvBatteryVoltage=matInvBatteryVoltage, matConCommunicationLost=matConCommunicationLost, matStsRunningMode=matStsRunningMode, matTrapTargetsEntry=matTrapTargetsEntry, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConTemperature=matConTemperature, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvInputAbnormal=matInvInputAbnormal, matInvSoftStartFail=matInvSoftStartFail, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfStsPriority=matConfStsPriority, matReturnFromStsNotRespond=matReturnFromStsNotRespond, device=device, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matDryContact=matDryContact, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsAddress=matTrapTargetsAddress, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapSeverityLevel=matTrapSeverityLevel, matInvMBSPosError=matInvMBSPosError, matStsOverLoad=matStsOverLoad, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvTemperature=matInvTemperature, matInverter=matInverter, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvFirmwareVersion=matInvFirmwareVersion, matStsMainsFail=matStsMainsFail, matConfig=matConfig, matStsMBSPosFault=matStsMBSPosFault, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConWarningState=matConWarningState, matStsInvBypassMode=matStsInvBypassMode, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matStsEntry=matStsEntry, matSts=matSts, matInvOutputVoltLow=matInvOutputVoltLow, matStsOutputAbnormal=matStsOutputAbnormal, matInvOutputFreq=matInvOutputFreq, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvPhaseType=matInvPhaseType, matInvPulseFault=matInvPulseFault, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConName=matConName, matInvRunTime=matInvRunTime, matStsOutputPower=matStsOutputPower, matConBatteryVoltHigh=matConBatteryVoltHigh, matStsInvFail=matStsInvFail, matInvRunMode=matInvRunMode, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvPriority=matInvPriority, matInvWarningState=matInvWarningState, matInvTable=matInvTable, matController=matController, matTrapType=matTrapType, matDryContactTable=matDryContactTable, matStsInvInputFreq=matStsInvInputFreq, matConfInvInputVoltage=matConfInvInputVoltage, matDryContactEntry=matDryContactEntry, matInvBypassSCRShort=matInvBypassSCRShort, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsNotRespond=matStsNotRespond, matInvBusSoftFail=matInvBusSoftFail, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvLineFreq=matInvLineFreq, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsOutputFreq=matStsOutputFreq, matInvMbsPosition=matInvMbsPosition, ppc=ppc, matStsControlPowerFail=matStsControlPowerFail, matStsMainInputVoltage=matStsMainInputVoltage, matStsOutputVoltage=matStsOutputVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvFanFault=matReturnFromInvFanFault, matConSerialNum=matConSerialNum, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError)
