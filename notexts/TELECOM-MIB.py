...
mibBuilder.exportSymbols("TELECOM-MIB", matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvPowerLimit=matInvPowerLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvRunMode=matInvRunMode, matInvOutputVoltHigh=matInvOutputVoltHigh, matConBatteryLow=matConBatteryLow, matStsNotRespond=matStsNotRespond, matStsOutputFreq=matStsOutputFreq, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matDryContactEntry=matDryContactEntry, matConCommunicationLost=matConCommunicationLost, matStsOverLoad=matStsOverLoad, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvFail=matStsInvFail, matStsModuleIndex=matStsModuleIndex, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matObjects=matObjects, matInvTempPowerLimit=matInvTempPowerLimit, matStsEEPROMFault=matStsEEPROMFault, matTrapType=matTrapType, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConEEPROMFault=matConEEPROMFault, matTrapTargetsEntry=matTrapTargetsEntry, matStsTable=matStsTable, matInvOutputPower=matInvOutputPower, matStsSerialNum=matStsSerialNum, matConfInvInputVoltage=matConfInvInputVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvBatteryVoltage=matInvBatteryVoltage, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvPhaseType=matInvPhaseType, matStsModuleNum=matStsModuleNum, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsFaultMode=matStsFaultMode, matStsControlPowerFail=matStsControlPowerFail, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matAgentSoftwareVerison=matAgentSoftwareVerison, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matTrapTargets=matTrapTargets, matStsStatus=matStsStatus, matStsMBSPosFault=matStsMBSPosFault, matInvOutputFreq=matInvOutputFreq, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputCurrent=matInvOutputCurrent, matController=matController, matInvMBSPosError=matInvMBSPosError, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matInvRunTime=matInvRunTime, matInvOutputVoltage=matInvOutputVoltage, matInvBusSoftFail=matInvBusSoftFail, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInverter=matInverter, matConfStsPriority=matConfStsPriority, matSts=matSts, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvFault=matReturnFromInvFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvFirmwareVersion=matInvFirmwareVersion, matStsRunningMode=matStsRunningMode, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvTemperatureHigh=matInvTemperatureHigh, matConTemperatureHigh=matConTemperatureHigh, matInvOverLoad=matInvOverLoad, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvOnOffStatus=matInvOnOffStatus, matStsTemperatureHigh=matStsTemperatureHigh, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matTrapTargetsTable=matTrapTargetsTable, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, NonNegativeInteger=NonNegativeInteger, matInvLineFreq=matInvLineFreq, device=device, matInvNotRespond=matInvNotRespond, matStsMbsStatus=matStsMbsStatus, matInvHardwareError=matInvHardwareError, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matInvModuleIndex=matInvModuleIndex, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvFanFault=matReturnFromInvFanFault, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matDryContactNum=matDryContactNum, matInvOutputVoltLow=matInvOutputVoltLow, matStsMainInputVoltage=matStsMainInputVoltage, matInvMainUnavailable=matInvMainUnavailable, matTrapTargetsDesc=matTrapTargetsDesc, matStsOutputVoltage=matStsOutputVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvMbsPosition=matInvMbsPosition, matStsInvBypassMode=matStsInvBypassMode, matDryContact=matDryContact, matStsEntry=matStsEntry, matConName=matConName, matInvFanFault=matInvFanFault, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsInvInputFreq=matStsInvInputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsMainsFail=matStsMainsFail, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvEPOShutdown=matInvEPOShutdown, matStsFanFault=matStsFanFault, matInvLineVoltage=matInvLineVoltage, matStsWarningState=matStsWarningState, matConfInvOutputVoltage=matConfInvOutputVoltage, matStsTemperature=matStsTemperature, matConTemperature=matConTemperature, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvModuleNum=matInvModuleNum, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvFault=matInvFault, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConWarningState=matConWarningState, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvTemperature=matInvTemperature, matStsFirmwareVersion=matStsFirmwareVersion, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsModuleType=matStsModuleType, matDryContactIndex=matDryContactIndex, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsMainFail=matReturnFromStsMainFail, matTraps=matTraps, matInvPulseFault=matInvPulseFault, PositiveInteger=PositiveInteger, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matConfInvOutputPower=matConfInvOutputPower, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysPriority=matConfInvSysPriority, matTrapTargetsNum=matTrapTargetsNum, matDryContactString=matDryContactString, ppc=ppc, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvSerialNum=matInvSerialNum, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matInvEntry=matInvEntry, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matInvPriority=matInvPriority, matStsOutputAbnormal=matStsOutputAbnormal, matConCanBusOff=matConCanBusOff, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matAgent=matAgent, matConfig=matConfig, matConSerialNum=matConSerialNum, matDryContactTable=matDryContactTable, matInvOutputShort=matInvOutputShort, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvInputAbnormal=matInvInputAbnormal, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matStsOutputPower=matStsOutputPower, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matConfInvOutputFreq=matConfInvOutputFreq, matStsRuntime=matStsRuntime, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTable=matInvTable)
