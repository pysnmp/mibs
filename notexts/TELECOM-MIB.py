...
Integer32, enterprises, iso, TimeTicks, IpAddress, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32, MibIdentifier, Gauge32, ObjectIdentity, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "iso", "TimeTicks", "IpAddress", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32", "MibIdentifier", "Gauge32", "ObjectIdentity", "Bits", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsMbsStatus=matStsMbsStatus, matStsInvInputFreq=matStsInvInputFreq, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvLineVoltage=matInvLineVoltage, matTrapTargets=matTrapTargets, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matSts=matSts, matStsOutputCurrent=matStsOutputCurrent, matConfInvSysPriority=matConfInvSysPriority, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matTrapTargetsAddress=matTrapTargetsAddress, matInvFanFault=matInvFanFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matObjects=matObjects, matStsModuleType=matStsModuleType, matInverter=matInverter, matDryContactTable=matDryContactTable, matConTemperature=matConTemperature, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matTrapTargetsNum=matTrapTargetsNum, matStsTable=matStsTable, matInvPhaseType=matInvPhaseType, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConSerialNum=matConSerialNum, matStsModuleIndex=matStsModuleIndex, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsRunningMode=matStsRunningMode, matConBatteryLow=matConBatteryLow, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvFault=matReturnFromInvFault, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOutputPower=matInvOutputPower, matStsTemperature=matStsTemperature, matStsOverLoad=matStsOverLoad, matInvSerialNum=matInvSerialNum, matInvHardwareVersion=matInvHardwareVersion, matStsInvBypassMode=matStsInvBypassMode, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsRuntime=matStsRuntime, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOnOffStatus=matInvOnOffStatus, matInvTempPowerLimit=matInvTempPowerLimit, matTrapTargetsDesc=matTrapTargetsDesc, matTrapSeverityLevel=matTrapSeverityLevel, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsWarningState=matStsWarningState, matConfInvOutputPower=matConfInvOutputPower, matInvOutputCurrent=matInvOutputCurrent, matAgent=matAgent, matInvPulseFault=matInvPulseFault, matStsTemperatureHigh=matStsTemperatureHigh, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsMainsFail=matStsMainsFail, matStsOutputAbnormal=matStsOutputAbnormal, matInvOverLoad=matInvOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matController=matController, matInvOutputFreq=matInvOutputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfig=matConfig, matInvMBSPosError=matInvMBSPosError, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvRunMode=matInvRunMode, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvFirmwareVersion=matInvFirmwareVersion, ppc=ppc, NonNegativeInteger=NonNegativeInteger, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvLineFreq=matInvLineFreq, matConfInvInputVoltage=matConfInvInputVoltage, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matDryContactIndex=matDryContactIndex, matStsEEPROMFault=matStsEEPROMFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, device=device, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvMainUnavailable=matInvMainUnavailable, matStsOutputFreq=matStsOutputFreq, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvLowInputShutdown=matInvLowInputShutdown, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConWarningState=matConWarningState, matConCommunicationLost=matConCommunicationLost, matStsFirmwareVersion=matStsFirmwareVersion, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvFault=matInvFault, matConCanBusOff=matConCanBusOff, matInvModuleNum=matInvModuleNum, matTrapType=matTrapType, matStsOutputPower=matStsOutputPower, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvTemperature=matInvTemperature, matDryContactEntry=matDryContactEntry, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMBSPosFault=matStsMBSPosFault, matTrapTargetsEntry=matTrapTargetsEntry, matStsBypassUnavailable=matStsBypassUnavailable, matInvRunTime=matInvRunTime, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvModuleIndex=matInvModuleIndex, matStsOutputVoltage=matStsOutputVoltage, matStsStatus=matStsStatus, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, PositiveInteger=PositiveInteger, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvTable=matInvTable, matInvPriority=matInvPriority, matTraps=matTraps, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOutputVoltage=matInvOutputVoltage, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsSerialNum=matStsSerialNum, matReturnFromStsInvFail=matReturnFromStsInvFail, matConfStsPriority=matConfStsPriority, matInvMbsPosition=matInvMbsPosition, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvEntry=matInvEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matInvHardwareError=matInvHardwareError, matInvOutputShort=matInvOutputShort, matStsFanFault=matStsFanFault, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matDryContactString=matDryContactString, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsHardwareVersion=matStsHardwareVersion, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsMainInputFreq=matStsMainInputFreq, matStsMainInputVoltage=matStsMainInputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsFaultMode=matStsFaultMode, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matInvWarningState=matInvWarningState, matConName=matConName, matConfInvOutputFreq=matConfInvOutputFreq, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matStsNotRespond=matStsNotRespond, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsEntry=matStsEntry, matDryContactNum=matDryContactNum, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvInputAbnormal=matInvInputAbnormal, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConTemperatureHigh=matConTemperatureHigh, matInvMaintenaceBypass=matInvMaintenaceBypass, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvTemperatureHigh=matInvTemperatureHigh, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsInvFail=matStsInvFail, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsModuleNum=matStsModuleNum, matConfStsFanSpeed=matConfStsFanSpeed, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvPowerLimit=matInvPowerLimit, matConEEPROMFault=matConEEPROMFault, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvNotRespond=matInvNotRespond, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matDryContact=matDryContact)
