...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matStsEntry=matStsEntry, matAgent=matAgent, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvMainUnavailable=matInvMainUnavailable, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvEntry=matInvEntry, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsWarningState=matStsWarningState, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConWarningState=matConWarningState, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matDryContactIndex=matDryContactIndex, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matDryContactString=matDryContactString, matStsModuleIndex=matStsModuleIndex, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matInvOutputPower=matInvOutputPower, matInvBypassSCRShort=matInvBypassSCRShort, matTrapTargetsAddress=matTrapTargetsAddress, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matDryContactTable=matDryContactTable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvBusSoftFail=matInvBusSoftFail, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvFanFault=matInvFanFault, matInvPriority=matInvPriority, matConfig=matConfig, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matConCanBusOff=matConCanBusOff, matInvPowerLimit=matInvPowerLimit, matStsTemperature=matStsTemperature, matInvFault=matInvFault, matStsSerialNum=matStsSerialNum, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsFirmwareVersion=matStsFirmwareVersion, matStsMbsStatus=matStsMbsStatus, matInvTable=matInvTable, matStsRuntime=matStsRuntime, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvHardwareError=matInvHardwareError, matStsInvInputFreq=matStsInvInputFreq, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvModuleIndex=matInvModuleIndex, matStsTable=matStsTable, matObjects=matObjects, matConTemperatureHigh=matConTemperatureHigh, matConfInvSysPriority=matConfInvSysPriority, matInvOnOffStatus=matInvOnOffStatus, matStsBypassUnavailable=matStsBypassUnavailable, matStsNotRespond=matStsNotRespond, matInvOutputFreq=matInvOutputFreq, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matDryContactEntry=matDryContactEntry, matInverter=matInverter, matStsOutputCurrent=matStsOutputCurrent, matTrapTargetsTable=matTrapTargetsTable, NonNegativeInteger=NonNegativeInteger, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvRunMode=matInvRunMode, matStsMainInputFreq=matStsMainInputFreq, matStsStatus=matStsStatus, matConTemperature=matConTemperature, matInvLineVoltage=matInvLineVoltage, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConfStsPriority=matConfStsPriority, matConfInvOutputPower=matConfInvOutputPower, matInvSerialNum=matInvSerialNum, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matInvLowInputShutdown=matInvLowInputShutdown, matInvTemperatureHigh=matInvTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvSoftStartFail=matInvSoftStartFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matInvOutputShort=matInvOutputShort, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matDryContactNum=matDryContactNum, matInvNotRespond=matInvNotRespond, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvPulseFault=matInvPulseFault, matInvEPOShutdown=matInvEPOShutdown, matConName=matConName, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapType=matTrapType, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matInvWarningState=matInvWarningState, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvModuleNum=matInvModuleNum, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matSts=matSts, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsOutputVoltage=matStsOutputVoltage, matStsMainsFail=matStsMainsFail, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsFaultMode=matStsFaultMode, matStsOutputAbnormal=matStsOutputAbnormal, matTrapTargetsNum=matTrapTargetsNum, matStsMBSPosFault=matStsMBSPosFault, matInvFirmwareVersion=matInvFirmwareVersion, matDryContact=matDryContact, matStsFanFault=matStsFanFault, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConBatteryLow=matConBatteryLow, matInvTemperature=matInvTemperature, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPhaseType=matInvPhaseType, matInvInputAbnormal=matInvInputAbnormal, matInvMBSPosError=matInvMBSPosError, matTrapTargetsIndex=matTrapTargetsIndex, matStsTemperatureHigh=matStsTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOverLoad=matInvOverLoad, matStsMainInputVoltage=matStsMainInputVoltage, matController=matController, matConSerialNum=matConSerialNum, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, ppc=ppc, matStsEEPROMFault=matStsEEPROMFault, matTraps=matTraps, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvTempPowerLimit=matInvTempPowerLimit, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matInvHardwareVersion=matInvHardwareVersion, matConEEPROMFault=matConEEPROMFault, PositiveInteger=PositiveInteger, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsOutputFreq=matStsOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matInvLineFreq=matInvLineFreq, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matStsControlPowerFail=matStsControlPowerFail, matConfInvInputVoltage=matConfInvInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matTrapTargets=matTrapTargets, matStsModuleNum=matStsModuleNum, matConCommunicationLost=matConCommunicationLost, matStsInvBypassMode=matStsInvBypassMode, matInvRunTime=matInvRunTime, device=device, matConfInvOutputFreq=matConfInvOutputFreq, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsRunningMode=matStsRunningMode, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matStsOverLoad=matStsOverLoad, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsInvFail=matStsInvFail, matTrapTargetsDesc=matTrapTargetsDesc, matStsModuleType=matStsModuleType, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsOutputPower=matStsOutputPower, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvMbsPosition=matInvMbsPosition, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matConBatteryVoltHigh=matConBatteryVoltHigh)
