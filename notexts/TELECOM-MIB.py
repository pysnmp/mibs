...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, MibIdentifier, Integer32, Gauge32, NotificationType, NotificationType, IpAddress, TimeTicks, ModuleIdentity, ObjectIdentity, enterprises, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "NotificationType", "IpAddress", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "enterprises", "Counter64", "Bits")
...
mibBuilder.exportSymbols("TELECOM-MIB", NonNegativeInteger=NonNegativeInteger, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConTemperature=matConTemperature, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matDryContactTable=matDryContactTable, matStsMbsStatus=matStsMbsStatus, matInvOutputVoltage=matInvOutputVoltage, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsRuntime=matStsRuntime, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsOutputAbnormal=matStsOutputAbnormal, matInvFirmwareVersion=matInvFirmwareVersion, matInvFault=matInvFault, matStsFanFault=matStsFanFault, matInvRunMode=matInvRunMode, matStsTemperature=matStsTemperature, matReturnFromInvFanFault=matReturnFromInvFanFault, matAgent=matAgent, matInvTable=matInvTable, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConfStsFanSpeed=matConfStsFanSpeed, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matStsInvFail=matStsInvFail, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvPhaseType=matInvPhaseType, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, ppc=ppc, matInvModuleIndex=matInvModuleIndex, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsFirmwareVersion=matStsFirmwareVersion, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvEPOShutdown=matInvEPOShutdown, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvSoftStartFail=matInvSoftStartFail, matStsTemperatureHigh=matStsTemperatureHigh, matStsEntry=matStsEntry, matInvOutputFreq=matInvOutputFreq, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvOnOffStatus=matInvOnOffStatus, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, device=device, matConTemperatureHigh=matConTemperatureHigh, matInvLineVoltage=matInvLineVoltage, matStsSerialNum=matStsSerialNum, matTrapTargets=matTrapTargets, matInvInputAbnormal=matInvInputAbnormal, matConEEPROMFault=matConEEPROMFault, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContactString=matDryContactString, matInvEEPROMFault=matInvEEPROMFault, matInvOutputVoltLow=matInvOutputVoltLow, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, PositiveInteger=PositiveInteger, matStsOutputPower=matStsOutputPower, matReturnFromInvFault=matReturnFromInvFault, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsInvInputFreq=matStsInvInputFreq, matInvEntry=matInvEntry, matTrapType=matTrapType, matDryContact=matDryContact, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matConName=matConName, matInvMaintenaceBypass=matInvMaintenaceBypass, matConCommunicationLost=matConCommunicationLost, matInvTempPowerLimit=matInvTempPowerLimit, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsRunningMode=matStsRunningMode, matObjects=matObjects, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvMbsPosition=matInvMbsPosition, matConfInvSysPriority=matConfInvSysPriority, matStsOverLoad=matStsOverLoad, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matTrapTargetsEntry=matTrapTargetsEntry, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConfig=matConfig, matConfStsPriority=matConfStsPriority, matInvOutputShort=matInvOutputShort, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvWarningState=matInvWarningState, matController=matController, matConSerialNum=matConSerialNum, matInvRunTime=matInvRunTime, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matStsEEPROMFault=matStsEEPROMFault, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvTemperatureHigh=matInvTemperatureHigh, matInvLineFreq=matInvLineFreq, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvNotRespond=matInvNotRespond, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMaintenanceBypass=matStsMaintenanceBypass, matConWarningState=matConWarningState, matStsOutputCurrent=matStsOutputCurrent, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matStsControlPowerFail=matStsControlPowerFail, matStsInvBypassMode=matStsInvBypassMode, matStsModuleType=matStsModuleType, matInvOutputCurrent=matInvOutputCurrent, matStsMainInputFreq=matStsMainInputFreq, matInvSerialNum=matInvSerialNum, matDryContactNum=matDryContactNum, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matStsOutputFreq=matStsOutputFreq, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matInvNegativePowerProtect=matInvNegativePowerProtect, matDryContactIndex=matDryContactIndex, matTrapTargetsNum=matTrapTargetsNum, matSts=matSts, matStsFaultMode=matStsFaultMode, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matReturnFromStsMainFail=matReturnFromStsMainFail, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matStsModuleNum=matStsModuleNum, matInvPriority=matInvPriority, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsHardwareVersion=matStsHardwareVersion, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInvPulseFault=matInvPulseFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matConCanBusOff=matConCanBusOff, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matStsMainsFail=matStsMainsFail, matTrapTargetsIndex=matTrapTargetsIndex, matStsTable=matStsTable, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matDryContactEntry=matDryContactEntry, matInvMainUnavailable=matInvMainUnavailable, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsWarningState=matStsWarningState, matInvModuleNum=matInvModuleNum, matConfInvOutputVoltage=matConfInvOutputVoltage, matTrapTargetsDesc=matTrapTargetsDesc, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsMBSPosFault=matStsMBSPosFault, matInvFanFault=matInvFanFault, matConfInvInputVoltage=matConfInvInputVoltage, matStsModuleIndex=matStsModuleIndex, matConBatteryLow=matConBatteryLow, matInverter=matInverter, matInvHardwareError=matInvHardwareError, matStsOutputVoltage=matStsOutputVoltage, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvTemperature=matInvTemperature, matConfInvOutputFreq=matConfInvOutputFreq, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsNotRespond=matStsNotRespond, matInvOutputPower=matInvOutputPower, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvMBSPosError=matInvMBSPosError, matInvPowerLimit=matInvPowerLimit, matInvBypassSCRShort=matInvBypassSCRShort, matInvHardwareVersion=matInvHardwareVersion, matTraps=matTraps, matStsStatus=matStsStatus, matStsInvInputVoltage=matStsInvInputVoltage, matStsBypassUnavailable=matStsBypassUnavailable, matInvOverLoad=matInvOverLoad, matReturnFromStsFanFault=matReturnFromStsFanFault, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit)
