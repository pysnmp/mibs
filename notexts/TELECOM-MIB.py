...
iso, Integer32, IpAddress, Bits, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, TimeTicks, Counter64, Unsigned32, Counter32, Gauge32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "IpAddress", "Bits", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfInvOutputPower=matConfInvOutputPower, matStsWarningState=matStsWarningState, matSts=matSts, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matInvPowerLimit=matInvPowerLimit, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvNotRespond=matInvNotRespond, matInvEEPROMFault=matInvEEPROMFault, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsOutputVoltage=matStsOutputVoltage, matInvRunMode=matInvRunMode, matStsTemperature=matStsTemperature, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matTrapTargetsAddress=matTrapTargetsAddress, matConSerialNum=matConSerialNum, matInvLineVoltage=matInvLineVoltage, matAgent=matAgent, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matStsFanFault=matStsFanFault, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvOverLoad=matInvOverLoad, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsOutputShortCircuit=matStsOutputShortCircuit, matInvTemperature=matInvTemperature, matConfStsPriority=matConfStsPriority, device=device, matTrapTargets=matTrapTargets, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvFanFault=matInvFanFault, matStsModuleNum=matStsModuleNum, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matTrapTargetsCommunity=matTrapTargetsCommunity, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsOutputCurrent=matStsOutputCurrent, matTraps=matTraps, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matObjects=matObjects, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConName=matConName, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matStsTemperatureHigh=matStsTemperatureHigh, matController=matController, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContactString=matDryContactString, matInvOnOffStatus=matInvOnOffStatus, matDryContactTable=matDryContactTable, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matConEEPROMFault=matConEEPROMFault, matInvEntry=matInvEntry, matDryContactNum=matDryContactNum, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsSerialNum=matStsSerialNum, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matStsOverLoad=matStsOverLoad, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matConCommunicationLost=matConCommunicationLost, matInvMbsPosition=matInvMbsPosition, matInvOutputPower=matInvOutputPower, matInvLineFreq=matInvLineFreq, matStsInvInputFreq=matStsInvInputFreq, matTrapTargetsTable=matTrapTargetsTable, matDryContactEntry=matDryContactEntry, matStsNotRespond=matStsNotRespond, ppc=ppc, matStsRunningMode=matStsRunningMode, matInvBusSoftFail=matInvBusSoftFail, matInvLowInputShutdown=matInvLowInputShutdown, matConTemperatureHigh=matConTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvPriority=matInvPriority, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConTemperature=matConTemperature, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInvTemperatureHigh=matInvTemperatureHigh, matInvHardwareError=matInvHardwareError, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsMainInputVoltage=matStsMainInputVoltage, matConBatteryVoltHigh=matConBatteryVoltHigh, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvNegativePowerProtect=matInvNegativePowerProtect, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matConfig=matConfig, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matConfInvOutputFreq=matConfInvOutputFreq, matStsEntry=matStsEntry, matStsMBSPosFault=matStsMBSPosFault, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matConBatteryLow=matConBatteryLow, matTrapTargetsEntry=matTrapTargetsEntry, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matStsBypassUnavailable=matStsBypassUnavailable, matStsInvBypassMode=matStsInvBypassMode, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsFaultMode=matStsFaultMode, matStsMainInputFreq=matStsMainInputFreq, matInvFault=matInvFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvModuleNum=matInvModuleNum, matTrapType=matTrapType, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvSoftStartFail=matInvSoftStartFail, matConfStsFanSpeed=matConfStsFanSpeed, matDryContactIndex=matDryContactIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvBatteryVoltage=matInvBatteryVoltage, matStsOutputAbnormal=matStsOutputAbnormal, matStsOutputPower=matStsOutputPower, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matStsFirmwareVersion=matStsFirmwareVersion, matStsHardwareVersion=matStsHardwareVersion, matStsInvFail=matStsInvFail, matConfInvInputVoltage=matConfInvInputVoltage, matInvOutputShort=matInvOutputShort, matDryContact=matDryContact, matTrapTargetsNum=matTrapTargetsNum, matInvHardwareVersion=matInvHardwareVersion, matConWarningState=matConWarningState, matConfInvSysPriority=matConfInvSysPriority, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matInvTempPowerLimit=matInvTempPowerLimit, matInvOutputVoltHigh=matInvOutputVoltHigh, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matInvModuleIndex=matInvModuleIndex, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvMainUnavailable=matInvMainUnavailable, matStsMainsFail=matStsMainsFail, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matInvPulseFault=matInvPulseFault, matConCanBusOff=matConCanBusOff, matInvSerialNum=matInvSerialNum, matInvOutputFreq=matInvOutputFreq, matInvOutputCurrent=matInvOutputCurrent, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvInputAbnormal=matInvInputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, PositiveInteger=PositiveInteger, matStsRuntime=matStsRuntime, matReturnFromInvFault=matReturnFromInvFault, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvRunTime=matInvRunTime, matStsTable=matStsTable, matStsStatus=matStsStatus, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvMBSPosError=matInvMBSPosError, NonNegativeInteger=NonNegativeInteger, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvPhaseType=matInvPhaseType, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsOutputFreq=matStsOutputFreq, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvEPOShutdown=matInvEPOShutdown, matStsModuleType=matStsModuleType, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matInvTable=matInvTable, matInverter=matInverter, matInvWarningState=matInvWarningState, matReturnFromInvHardwareError=matReturnFromInvHardwareError)
