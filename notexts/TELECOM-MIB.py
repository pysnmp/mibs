...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, MibIdentifier, Unsigned32, Bits, IpAddress, enterprises, Gauge32, Integer32, ModuleIdentity, Counter64, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Bits", "IpAddress", "enterprises", "Gauge32", "Integer32", "ModuleIdentity", "Counter64", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matStsInvLosLossVoltage=matStsInvLosLossVoltage, matTrapTargets=matTrapTargets, matStsOutputAbnormal=matStsOutputAbnormal, matInvMainUnavailable=matInvMainUnavailable, matStsOutputPower=matStsOutputPower, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConCommunicationLost=matConCommunicationLost, matConEEPROMFault=matConEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matInvOutputPower=matInvOutputPower, matStsTemperature=matStsTemperature, matInvBusSoftFail=matInvBusSoftFail, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, NonNegativeInteger=NonNegativeInteger, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matObjects=matObjects, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvWarningState=matInvWarningState, matStsModuleIndex=matStsModuleIndex, matConfInvSysPriority=matConfInvSysPriority, matStsFirmwareVersion=matStsFirmwareVersion, matInvEntry=matInvEntry, matStsMbsStatus=matStsMbsStatus, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matTrapSeverityLevel=matTrapSeverityLevel, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapType=matTrapType, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvRunMode=matInvRunMode, matConTemperatureHigh=matConTemperatureHigh, matDryContactTable=matDryContactTable, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsNotRespond=matStsNotRespond, matReturnFromInvHardwareError=matReturnFromInvHardwareError, PositiveInteger=PositiveInteger, matInvPulseFault=matInvPulseFault, matConBatteryLow=matConBatteryLow, matInvFirmwareVersion=matInvFirmwareVersion, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matInvSoftStartFail=matInvSoftStartFail, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matInvOutputVoltLow=matInvOutputVoltLow, matStsInvBypassMode=matStsInvBypassMode, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMBSPosFault=matStsMBSPosFault, device=device, matStsInvInputVoltage=matStsInvInputVoltage, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsSerialNum=matStsSerialNum, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matStsMainsFail=matStsMainsFail, matStsModuleType=matStsModuleType, matStsWarningState=matStsWarningState, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvPhaseType=matInvPhaseType, matStsInvInputFreq=matStsInvInputFreq, matInvRunTime=matInvRunTime, matInvNotRespond=matInvNotRespond, matTrapTargetsDesc=matTrapTargetsDesc, matStsOutputShortCircuit=matStsOutputShortCircuit, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvMbsPosition=matInvMbsPosition, matTrapTargetsNum=matTrapTargetsNum, matStsTable=matStsTable, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvTable=matInvTable, matStsMainInputVoltage=matStsMainInputVoltage, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matStsFaultMode=matStsFaultMode, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matStsInvFail=matStsInvFail, matReturnFromInvFanFault=matReturnFromInvFanFault, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsRunningMode=matStsRunningMode, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matConSerialNum=matConSerialNum, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsEntry=matStsEntry, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matDryContactString=matDryContactString, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matController=matController, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matStsMaintenanceBypass=matStsMaintenanceBypass, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matInvOverLoad=matInvOverLoad, matInvOutputFreq=matInvOutputFreq, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matInvTemperature=matInvTemperature, matStsStatus=matStsStatus, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matTrapTargetsAddress=matTrapTargetsAddress, matInvLineFreq=matInvLineFreq, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matDryContactEntry=matDryContactEntry, matStsBypassUnavailable=matStsBypassUnavailable, matStsMainInputFreq=matStsMainInputFreq, matStsEEPROMFault=matStsEEPROMFault, matStsOutputCurrent=matStsOutputCurrent, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConCanBusOff=matConCanBusOff, matAgent=matAgent, matInvModuleNum=matInvModuleNum, matInvBatteryVoltage=matInvBatteryVoltage, matInvBypassSCRShort=matInvBypassSCRShort, matInvSerialNum=matInvSerialNum, matInvMBSPosError=matInvMBSPosError, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvEPOShutdown=matInvEPOShutdown, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matConfStsFanSpeed=matConfStsFanSpeed, matTraps=matTraps, matConWarningState=matConWarningState, matStsHardwareVersion=matStsHardwareVersion, matInvModuleIndex=matInvModuleIndex, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matConTemperature=matConTemperature, matConfInvSysInputVolt=matConfInvSysInputVolt, matInvFanFault=matInvFanFault, matStsOverLoad=matStsOverLoad, matInvInputAbnormal=matInvInputAbnormal, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matStsTemperatureHigh=matStsTemperatureHigh, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvOutputShort=matInvOutputShort, matConfInvOutputFreq=matConfInvOutputFreq, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matConfig=matConfig, ppc=ppc, matDryContactNum=matDryContactNum, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInverter=matInverter, matInvHardwareError=matInvHardwareError, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromInvFault=matReturnFromInvFault, matConName=matConName, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matConfInvInputVoltage=matConfInvInputVoltage, matInvPriority=matInvPriority, matInvLineVoltage=matInvLineVoltage, matStsModuleNum=matStsModuleNum, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvTemperatureHigh=matInvTemperatureHigh, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputCurrent=matInvOutputCurrent, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matInvFault=matInvFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matDryContactIndex=matDryContactIndex, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matInvEEPROMFault=matInvEEPROMFault, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matInvTempPowerLimit=matInvTempPowerLimit, matStsRuntime=matStsRuntime, matSts=matSts, matConfStsPriority=matConfStsPriority, matInvLowInputShutdown=matInvLowInputShutdown, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matInvPowerLimit=matInvPowerLimit, matStsFanFault=matStsFanFault, matStsOutputFreq=matStsOutputFreq, matDryContact=matDryContact, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matTrapTargetsEntry=matTrapTargetsEntry, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit)
