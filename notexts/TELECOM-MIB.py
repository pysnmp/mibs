...
ObjectIdentity, Integer32, enterprises, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, ModuleIdentity, MibIdentifier, Bits, NotificationType, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "enterprises", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("TELECOM-MIB", matInvPulseFault=matInvPulseFault, matTrapTargetsDesc=matTrapTargetsDesc, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysInputVolt=matConfInvSysInputVolt, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matAgent=matAgent, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matStsWarningState=matStsWarningState, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matInvTemperatureHigh=matInvTemperatureHigh, matDryContactString=matDryContactString, matInvMainUnavailable=matInvMainUnavailable, matStsModuleIndex=matStsModuleIndex, matStsEEPROMFault=matStsEEPROMFault, matInvSoftStartFail=matInvSoftStartFail, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvOutputCurrent=matInvOutputCurrent, NonNegativeInteger=NonNegativeInteger, matStsFaultMode=matStsFaultMode, matInvFirmwareVersion=matInvFirmwareVersion, matInvMaintenaceBypass=matInvMaintenaceBypass, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matConSerialNum=matConSerialNum, matConCommunicationLost=matConCommunicationLost, matConfig=matConfig, matTrapTargetsTable=matTrapTargetsTable, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matInvLineFreq=matInvLineFreq, matStsOutputFreq=matStsOutputFreq, matReturnFromStsFanFault=matReturnFromStsFanFault, matConEEPROMFault=matConEEPROMFault, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matStsNotRespond=matStsNotRespond, matInvTable=matInvTable, matStsOutputPower=matStsOutputPower, matInvBatteryVoltage=matInvBatteryVoltage, matInvOnOffStatus=matInvOnOffStatus, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matInvNegativePowerProtect=matInvNegativePowerProtect, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matDryContactTable=matDryContactTable, matStsTemperatureHigh=matStsTemperatureHigh, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvOutputShort=matInvOutputShort, matInvMBSPosError=matInvMBSPosError, matConTemperature=matConTemperature, matStsModuleType=matStsModuleType, matTrapType=matTrapType, matStsInvFail=matStsInvFail, matInvSerialNum=matInvSerialNum, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matInvBypassSCRShort=matInvBypassSCRShort, matStsSerialNum=matStsSerialNum, matReturnFromStsMainFail=matReturnFromStsMainFail, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvRunTime=matInvRunTime, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matObjects=matObjects, matStsInvBypassMode=matStsInvBypassMode, matConTemperatureHigh=matConTemperatureHigh, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matTrapTargetsNum=matTrapTargetsNum, matInvLineVoltage=matInvLineVoltage, matInverter=matInverter, matInvTempPowerLimit=matInvTempPowerLimit, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matInvOutputPower=matInvOutputPower, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsMainInputVoltage=matStsMainInputVoltage, matTrapTargetsIndex=matTrapTargetsIndex, matStsMBSPosFault=matStsMBSPosFault, matConBatteryLow=matConBatteryLow, matInvPowerLimit=matInvPowerLimit, matConCanBusOff=matConCanBusOff, matDryContactIndex=matDryContactIndex, matConfInvOutputFreq=matConfInvOutputFreq, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfInvOutputVoltage=matConfInvOutputVoltage, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvMbsPosition=matInvMbsPosition, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matInvPriority=matInvPriority, matDryContactNum=matDryContactNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matInvOverLoad=matInvOverLoad, matTrapTargets=matTrapTargets, matStsRunningMode=matStsRunningMode, matInvEntry=matInvEntry, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsEntry=matStsEntry, matStsTemperature=matStsTemperature, matInvWarningState=matInvWarningState, device=device, matTrapSeverityLevel=matTrapSeverityLevel, matInvModuleIndex=matInvModuleIndex, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvEEPROMFault=matInvEEPROMFault, matStsInvInputVoltage=matStsInvInputVoltage, matInvBusSoftFail=matInvBusSoftFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matConfInvOutputPower=matConfInvOutputPower, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matStsStatus=matStsStatus, matInvFanFault=matInvFanFault, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConfStsFanSpeed=matConfStsFanSpeed, matTrapTargetsEntry=matTrapTargetsEntry, matConName=matConName, matStsOutputAbnormal=matStsOutputAbnormal, matInvModuleNum=matInvModuleNum, matTraps=matTraps, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matReturnFromStsInvFail=matReturnFromStsInvFail, matStsInvInputFreq=matStsInvInputFreq, matInvInputAbnormal=matInvInputAbnormal, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matInvOutputVoltHigh=matInvOutputVoltHigh, matStsOutputCurrent=matStsOutputCurrent, matInvNotRespond=matInvNotRespond, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvFault=matInvFault, matSts=matSts, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matStsOutputVoltage=matStsOutputVoltage, matInvRunMode=matInvRunMode, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matAgentSoftwareVerison=matAgentSoftwareVerison, matController=matController, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matStsOverLoad=matStsOverLoad, matConfStsPriority=matConfStsPriority, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsHardwareVersion=matStsHardwareVersion, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matReturnFromInvFanFault=matReturnFromInvFanFault, matInvOutputVoltLow=matInvOutputVoltLow, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvEPOShutdown=matInvEPOShutdown, matConfInvSysPriority=matConfInvSysPriority, matDryContact=matDryContact, matStsFanFault=matStsFanFault, matInvLowInputShutdown=matInvLowInputShutdown, matDryContactEntry=matDryContactEntry, matTrapTargetsAddress=matTrapTargetsAddress, matConWarningState=matConWarningState, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsTable=matStsTable, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, ppc=ppc, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsRuntime=matStsRuntime, matConfInvInputVoltage=matConfInvInputVoltage, matStsMbsStatus=matStsMbsStatus, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvHardwareError=matInvHardwareError, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matStsFirmwareVersion=matStsFirmwareVersion, matStsMainsFail=matStsMainsFail, matInvOutputFreq=matInvOutputFreq, matStsModuleNum=matStsModuleNum, matInvTemperature=matInvTemperature, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, PositiveInteger=PositiveInteger, matInvPhaseType=matInvPhaseType, matReturnFromInvFault=matReturnFromInvFault, matInvHardwareVersion=matInvHardwareVersion, matConfInvSysOutputFreq=matConfInvSysOutputFreq)
