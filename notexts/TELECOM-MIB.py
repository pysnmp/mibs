...
mibBuilder.exportSymbols("TELECOM-MIB", matInvTempPowerLimit=matInvTempPowerLimit, matTrapTargetsAddress=matTrapTargetsAddress, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matStsOutputFreq=matStsOutputFreq, matInvEntry=matInvEntry, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matStsOutputVoltage=matStsOutputVoltage, matInvSerialNum=matInvSerialNum, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matConBatteryLow=matConBatteryLow, matStsEEPROMFault=matStsEEPROMFault, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsMainInputVoltage=matStsMainInputVoltage, matStsFaultMode=matStsFaultMode, matInvMainUnavailable=matInvMainUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsModuleIndex=matStsModuleIndex, matConfInvSysInputVolt=matConfInvSysInputVolt, matStsTemperatureHigh=matStsTemperatureHigh, matStsMbsStatus=matStsMbsStatus, matStsOutputCurrent=matStsOutputCurrent, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matTrapTargetsIndex=matTrapTargetsIndex, matStsModuleNum=matStsModuleNum, matStsMaintenanceBypass=matStsMaintenanceBypass, matInvOnOffStatus=matInvOnOffStatus, ppc=ppc, matInvOutputFreq=matInvOutputFreq, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matAgent=matAgent, matInvRunMode=matInvRunMode, matConTemperature=matConTemperature, matInvRunTime=matInvRunTime, matSts=matSts, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvOutputVoltHigh=matInvOutputVoltHigh, matAgentSoftwareVerison=matAgentSoftwareVerison, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvWarningState=matInvWarningState, matInvFault=matInvFault, matDryContact=matDryContact, matInvLineFreq=matInvLineFreq, matStsOutputPower=matStsOutputPower, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matDryContactTable=matDryContactTable, matConTemperatureHigh=matConTemperatureHigh, matDryContactNum=matDryContactNum, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matConfStsFanSpeed=matConfStsFanSpeed, matInvOutputPower=matInvOutputPower, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matStsInvInputVoltage=matStsInvInputVoltage, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matTrapTargets=matTrapTargets, matStsNotRespond=matStsNotRespond, matStsWarningState=matStsWarningState, matConBatteryVoltHigh=matConBatteryVoltHigh, matConWarningState=matConWarningState, matInvOverLoad=matInvOverLoad, matStsOutputAbnormal=matStsOutputAbnormal, matTrapTargetsTable=matTrapTargetsTable, matConfInvOutputFreq=matConfInvOutputFreq, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matStsInvBypassMode=matStsInvBypassMode, matStsOverLoad=matStsOverLoad, matReturnFromStsFanFault=matReturnFromStsFanFault, matInvTemperature=matInvTemperature, matStsMainInputFreq=matStsMainInputFreq, matStsBypassUnavailable=matStsBypassUnavailable, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matStsEntry=matStsEntry, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvFail=matStsInvFail, matInvLowInputShutdown=matInvLowInputShutdown, matStsFirmwareVersion=matStsFirmwareVersion, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matConfInvOutputVoltage=matConfInvOutputVoltage, matInvPulseFault=matInvPulseFault, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matReturnFromStsFaultMode=matReturnFromStsFaultMode, matTrapTargetsEntry=matTrapTargetsEntry, matStsTable=matStsTable, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, NonNegativeInteger=NonNegativeInteger, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matTrapType=matTrapType, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matInvPhaseType=matInvPhaseType, matInvOutputVoltLow=matInvOutputVoltLow, matInvModuleNum=matInvModuleNum, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matDryContactIndex=matDryContactIndex, matTrapTargetsDesc=matTrapTargetsDesc, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matConEEPROMFault=matConEEPROMFault, matStsMBSPosFault=matStsMBSPosFault, matInvPriority=matInvPriority, matDryContactEntry=matDryContactEntry, matConfInvInputVoltage=matConfInvInputVoltage, device=device, matObjects=matObjects, matInvModuleIndex=matInvModuleIndex, matInvTemperatureHigh=matInvTemperatureHigh, matStsControlPowerFail=matStsControlPowerFail, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvMaintenaceBypass=matInvMaintenaceBypass, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matConfig=matConfig, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matController=matController, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matInvFirmwareVersion=matInvFirmwareVersion, matInvOutputCurrent=matInvOutputCurrent, matInvBusSoftFail=matInvBusSoftFail, matDryContactString=matDryContactString, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matInvLineVoltage=matInvLineVoltage, matStsRunningMode=matStsRunningMode, matInvTable=matInvTable, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matInvNotRespond=matInvNotRespond, matConCommunicationLost=matConCommunicationLost, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvEEPROMFault=matInvEEPROMFault, matStsRuntime=matStsRuntime, matInvMBSPosError=matInvMBSPosError, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matInverter=matInverter, matConSerialNum=matConSerialNum, matInvBatteryVoltage=matInvBatteryVoltage, matInvFanFault=matInvFanFault, matStsModuleType=matStsModuleType, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matStsInvInputFreq=matStsInvInputFreq, matInvMbsPosition=matInvMbsPosition, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matConName=matConName, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matInvOutputShort=matInvOutputShort, matInvHardwareError=matInvHardwareError, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvEPOShutdown=matInvEPOShutdown, matStsFanFault=matStsFanFault, matReturnFromStsInvFail=matReturnFromStsInvFail, matConCanBusOff=matConCanBusOff, matInvPowerLimit=matInvPowerLimit, matTraps=matTraps, matInvBypassSCRShort=matInvBypassSCRShort, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matReturnFromInvFault=matReturnFromInvFault, matTrapTargetsCommunity=matTrapTargetsCommunity, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapTargetsNum=matTrapTargetsNum, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matInvInputAbnormal=matInvInputAbnormal, matConfInvOutputPower=matConfInvOutputPower, matConfInvSysPriority=matConfInvSysPriority, matStsMainsFail=matStsMainsFail, matInvOutputVoltage=matInvOutputVoltage, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matConfStsPriority=matConfStsPriority, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matStsHardwareVersion=matStsHardwareVersion, matReturnFromInvFanFault=matReturnFromInvFanFault, matStsStatus=matStsStatus, PositiveInteger=PositiveInteger, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matStsTemperature=matStsTemperature, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matStsSerialNum=matStsSerialNum, matInvSoftStartFail=matInvSoftStartFail)
