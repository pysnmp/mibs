...
Counter32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, IpAddress, iso, TimeTicks, Integer32, MibIdentifier, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "Integer32", "MibIdentifier", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobComment=backupJobComment, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, mountServerName=mountServerName, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, targetHost=targetHost, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWebDownloadStart=onWebDownloadStart, backup=backup, transferTime=transferTime, products=products, initiatorName=initiatorName, cdpSla=cdpSla, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, backupJobName=backupJobName, onVmBackupCompleted=onVmBackupCompleted, repositoryId=repositoryId, cdpRpoThreshold=cdpRpoThreshold, vmBackupComment=vmBackupComment, sessionId=sessionId, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetDir=targetDir, backupJobResult=backupJobResult, transferStatus=transferStatus, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, traps=traps, veeam=veeam, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, extentName=extentName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
