...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:36:01 2023
...
TimeTicks, Unsigned32, NotificationType, Integer32, Gauge32, Bits, enterprises, Counter32, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "Bits", "enterprises", "Counter32", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, extentStatusList=extentStatusList, cdpPolicyName=cdpPolicyName, vmName=vmName, transferTime=transferTime, initiatorSid=initiatorSid, cdpSla=cdpSla, veeam=veeam, csvReportFilePath=csvReportFilePath, targetHost=targetHost, initiatorName=initiatorName, backupJobComment=backupJobComment, transferStatus=transferStatus, backupJobResult=backupJobResult, transferFileList=transferFileList, backupJobName=backupJobName, mountServerName=mountServerName, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, cdpRpoStatus=cdpRpoStatus, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, extentName=extentName, vmBackupComment=vmBackupComment, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, extentStatus=extentStatus, repositoryId=repositoryId, onSobrOffloadFinished=onSobrOffloadFinished, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, notTransferFileList=notTransferFileList, sessionId=sessionId, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, products=products, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryStatus=repositoryStatus, onBackupJobCompleted=onBackupJobCompleted, onWebDownloadStart=onWebDownloadStart)
