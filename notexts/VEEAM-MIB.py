...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:55:02 2024
...
Gauge32, NotificationType, IpAddress, ModuleIdentity, enterprises, TimeTicks, MibIdentifier, Bits, Counter32, Counter64, NotificationType, iso, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "Counter64", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, onBackupJobCompleted=onBackupJobCompleted, extentStatus=extentStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, traps=traps, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, extentStatusEntry=extentStatusEntry, cdpMaxDelay=cdpMaxDelay, initiatorSid=initiatorSid, backupJobName=backupJobName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryName=repositoryName, extentStatusList=extentStatusList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, csvReportFilePath=csvReportFilePath, cdpPolicyName=cdpPolicyName, transferTime=transferTime, transferStatus=transferStatus, backupJobId=backupJobId, vmName=vmName, onWinFLRMountStarted=onWinFLRMountStarted, extentName=extentName, veeam=veeam, targetDir=targetDir, backupJobComment=backupJobComment, targetHost=targetHost, mountServerName=mountServerName, cdpSla=cdpSla, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupResult=vmBackupResult, initiatorName=initiatorName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, vmRestorePointCreationTime=vmRestorePointCreationTime, onWebDownloadFinished=onWebDownloadFinished, transferFileList=transferFileList, onSobrOffloadFinished=onSobrOffloadFinished, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sourceHostName=sourceHostName, vmRestorePointId=vmRestorePointId, products=products, sessionId=sessionId, backupJobResult=backupJobResult, repositoryId=repositoryId, onWebDownloadStart=onWebDownloadStart, onCdpRpoReport=onCdpRpoReport)
