...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:43:00 2023
...
ModuleIdentity, enterprises, IpAddress, NotificationType, Counter32, iso, Gauge32, Unsigned32, ObjectIdentity, NotificationType, Counter64, MibIdentifier, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "IpAddress", "NotificationType", "Counter32", "iso", "Gauge32", "Unsigned32", "ObjectIdentity", "NotificationType", "Counter64", "MibIdentifier", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, transferStatus=transferStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmRestorePointId=vmRestorePointId, backup=backup, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, transferTime=transferTime, initiatorName=initiatorName, extentStatus=extentStatus, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, extentName=extentName, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, traps=traps, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobResult=backupJobResult, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, onCdpRpoReport=onCdpRpoReport, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, extentStatusList=extentStatusList, backupJobName=backupJobName, repositoryName=repositoryName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpSla=cdpSla, vmBackupResult=vmBackupResult, products=products, cdpRpoThreshold=cdpRpoThreshold, targetHost=targetHost, vmRestorePointCreationTime=vmRestorePointCreationTime, vmName=vmName, transferFileList=transferFileList, veeam=veeam, sessionId=sessionId, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, mountServerName=mountServerName, cdpRpoStatus=cdpRpoStatus)
