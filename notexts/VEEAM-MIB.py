...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:39:00 2023
...
NotificationType, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Unsigned32, IpAddress, iso, MibIdentifier, Gauge32, Integer32, Counter32, ModuleIdentity, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Unsigned32", "IpAddress", "iso", "MibIdentifier", "Gauge32", "Integer32", "Counter32", "ModuleIdentity", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointCreationTime=vmRestorePointCreationTime, cdpMaxDelay=cdpMaxDelay, products=products, traps=traps, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, targetDir=targetDir, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, vmName=vmName, onWebDownloadStart=onWebDownloadStart, targetHost=targetHost, cdpSla=cdpSla, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backup=backup, initiatorSid=initiatorSid, onBackupJobCompleted=onBackupJobCompleted, csvReportFilePath=csvReportFilePath, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, repositoryId=repositoryId, extentStatusEntry=extentStatusEntry, backupJobName=backupJobName, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, mountServerName=mountServerName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, sessionId=sessionId, extentName=extentName, extentStatus=extentStatus, sourceHostName=sourceHostName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, veeam=veeam, backupJobResult=backupJobResult, cdpPolicyName=cdpPolicyName, vmBackupComment=vmBackupComment, vmBackupResult=vmBackupResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorName=initiatorName, extentStatusList=extentStatusList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted)
