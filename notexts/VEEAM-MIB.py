...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:48:20 2022
...
iso, Gauge32, Counter32, IpAddress, ObjectIdentity, Unsigned32, NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, enterprises, Counter64, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter32", "IpAddress", "ObjectIdentity", "Unsigned32", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "enterprises", "Counter64", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", sessionId=sessionId, transferStatus=transferStatus, repositoryStatus=repositoryStatus, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupResult=vmBackupResult, onBackupJobCompleted=onBackupJobCompleted, targetHost=targetHost, notTransferFileList=notTransferFileList, onVmBackupCompleted=onVmBackupCompleted, onWebDownloadFinished=onWebDownloadFinished, transferTime=transferTime, vmName=vmName, backupJobResult=backupJobResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, products=products, repositoryName=repositoryName, initiatorName=initiatorName, extentStatusEntry=extentStatusEntry, extentName=extentName, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, extentStatus=extentStatus, repositoryId=repositoryId, backupJobComment=backupJobComment, sourceHostName=sourceHostName, initiatorSid=initiatorSid, traps=traps, transferFileList=transferFileList, vmBackupComment=vmBackupComment, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backup=backup, mountServerName=mountServerName, targetDir=targetDir, backupJobId=backupJobId, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoStatus=cdpRpoStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, veeam=veeam, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold)
