...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:38:24 2023
...
NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Unsigned32, Integer32, enterprises, IpAddress, Counter64, ObjectIdentity, iso, Bits, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Unsigned32", "Integer32", "enterprises", "IpAddress", "Counter64", "ObjectIdentity", "iso", "Bits", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, targetHost=targetHost, repositoryName=repositoryName, vmBackupResult=vmBackupResult, traps=traps, onWebDownloadFinished=onWebDownloadFinished, vmBackupComment=vmBackupComment, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobName=backupJobName, cdpSla=cdpSla, backupJobResult=backupJobResult, transferTime=transferTime, cdpPolicyName=cdpPolicyName, onWebDownloadStart=onWebDownloadStart, extentStatus=extentStatus, sourceHostName=sourceHostName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, csvReportFilePath=csvReportFilePath, products=products, backup=backup, mountServerName=mountServerName, backupJobId=backupJobId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, sessionId=sessionId, cdpMaxDelay=cdpMaxDelay, vmName=vmName, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, onCdpRpoReport=onCdpRpoReport, initiatorName=initiatorName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorSid=initiatorSid, transferFileList=transferFileList, targetDir=targetDir, vmRestorePointCreationTime=vmRestorePointCreationTime, extentName=extentName, veeam=veeam, repositoryId=repositoryId, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusEntry=extentStatusEntry, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpRpoThreshold=cdpRpoThreshold)
