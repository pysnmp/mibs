...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:52:45 2021
...
enterprises, ModuleIdentity, iso, NotificationType, MibIdentifier, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter32, IpAddress, Counter64, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter32", "IpAddress", "Counter64", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryName=repositoryName, extentStatus=extentStatus, onWinFLRMountStarted=onWinFLRMountStarted, repositoryStatus=repositoryStatus, cdpPolicyName=cdpPolicyName, products=products, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, onSobrOffloadFinished=onSobrOffloadFinished, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, veeam=veeam, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmName=vmName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobId=backupJobId, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, extentName=extentName, backupJobComment=backupJobComment, repositoryId=repositoryId, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, transferTime=transferTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, traps=traps, onBackupJobCompleted=onBackupJobCompleted, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, cdpRpoStatus=cdpRpoStatus, initiatorName=initiatorName, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, transferFileList=transferFileList, backupJobResult=backupJobResult, initiatorSid=initiatorSid, notTransferFileList=notTransferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatusList=extentStatusList, cdpMaxDelay=cdpMaxDelay, extentStatusEntry=extentStatusEntry, targetDir=targetDir, backupJobName=backupJobName)
