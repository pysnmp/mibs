...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:07:37 2023
...
enterprises, NotificationType, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, MibIdentifier, Counter64, IpAddress, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "MibIdentifier", "Counter64", "IpAddress", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", backupJobName=backupJobName, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, transferFileList=transferFileList, traps=traps, sourceHostName=sourceHostName, onVmBackupCompleted=onVmBackupCompleted, transferTime=transferTime, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, products=products, targetDir=targetDir, onBackupJobCompleted=onBackupJobCompleted, cdpPolicyName=cdpPolicyName, vmBackupResult=vmBackupResult, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, backupJobComment=backupJobComment, extentStatus=extentStatus, cdpSla=cdpSla, extentStatusList=extentStatusList, targetHost=targetHost, repositoryId=repositoryId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, cdpRpoStatus=cdpRpoStatus, onCdpRpoReport=onCdpRpoReport, cdpRpoThreshold=cdpRpoThreshold, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, veeam=veeam, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRMountStarted=onWinFLRMountStarted, backupJobId=backupJobId, initiatorSid=initiatorSid, backupJobResult=backupJobResult, vmRestorePointCreationTime=vmRestorePointCreationTime, csvReportFilePath=csvReportFilePath, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, sessionId=sessionId)
