...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:14:32 2022
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupComment=vmBackupComment, backupJobId=backupJobId, targetDir=targetDir, products=products, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, notTransferFileList=notTransferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, extentName=extentName, initiatorSid=initiatorSid, veeam=veeam, cdpPolicyName=cdpPolicyName, traps=traps, onWebDownloadStart=onWebDownloadStart, backupJobName=backupJobName, targetHost=targetHost, vmName=vmName, sourceHostName=sourceHostName, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferTime=transferTime, repositoryId=repositoryId, vmBackupResult=vmBackupResult, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, cdpRpoThreshold=cdpRpoThreshold, extentStatus=extentStatus, backupJobComment=backupJobComment, backupJobResult=backupJobResult, onWinFLRMountStarted=onWinFLRMountStarted, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
