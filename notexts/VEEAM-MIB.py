...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:55:54 2023
...
Bits, Unsigned32, Integer32, ModuleIdentity, NotificationType, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Gauge32, ObjectIdentity, Counter64, iso, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Integer32", "ModuleIdentity", "NotificationType", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Gauge32", "ObjectIdentity", "Counter64", "iso", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentName=extentName, vmName=vmName, onVmBackupCompleted=onVmBackupCompleted, backup=backup, traps=traps, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus, repositoryName=repositoryName, vmBackupComment=vmBackupComment, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, cdpSla=cdpSla, transferFileList=transferFileList, onWebDownloadStart=onWebDownloadStart, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, sessionId=sessionId, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, vmRestorePointId=vmRestorePointId, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult, backupJobName=backupJobName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, mountServerName=mountServerName, cdpPolicyName=cdpPolicyName, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, backupJobId=backupJobId, initiatorSid=initiatorSid, repositoryId=repositoryId, cdpMaxDelay=cdpMaxDelay, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, onBackupJobCompleted=onBackupJobCompleted, products=products, sourceHostName=sourceHostName, targetHost=targetHost, cdpRpoThreshold=cdpRpoThreshold)
