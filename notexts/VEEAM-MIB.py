...
ObjectIdentity, Unsigned32, Gauge32, enterprises, iso, Bits, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "enterprises", "iso", "Bits", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferTime=transferTime, veeam=veeam, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorName=initiatorName, extentStatusList=extentStatusList, backupJobName=backupJobName, products=products, notTransferFileList=notTransferFileList, backupJobId=backupJobId, vmName=vmName, cdpRpoStatus=cdpRpoStatus, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult, extentStatus=extentStatus, onWebDownloadFinished=onWebDownloadFinished, csvReportFilePath=csvReportFilePath, backup=backup, backupJobComment=backupJobComment, extentName=extentName, targetDir=targetDir, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, sessionId=sessionId, targetHost=targetHost, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, mountServerName=mountServerName, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, traps=traps, cdpSla=cdpSla, onWebDownloadStart=onWebDownloadStart, transferFileList=transferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpPolicyName=cdpPolicyName, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupComment=vmBackupComment, initiatorSid=initiatorSid, vmRestorePointCreationTime=vmRestorePointCreationTime)
