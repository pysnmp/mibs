...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:14:47 2021
...
Gauge32, Bits, iso, ModuleIdentity, TimeTicks, NotificationType, Counter64, ObjectIdentity, IpAddress, Integer32, enterprises, NotificationType, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "iso", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "enterprises", "NotificationType", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferTime=transferTime, backupJobId=backupJobId, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, sessionId=sessionId, notTransferFileList=notTransferFileList, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, cdpRpoThreshold=cdpRpoThreshold, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, backup=backup, onSobrOffloadFinished=onSobrOffloadFinished, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpSla=cdpSla, initiatorName=initiatorName, extentStatusList=extentStatusList, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, veeam=veeam, mountServerName=mountServerName, products=products, onWebDownloadFinished=onWebDownloadFinished, targetDir=targetDir, csvReportFilePath=csvReportFilePath, traps=traps, repositoryId=repositoryId, vmBackupComment=vmBackupComment, repositoryStatus=repositoryStatus, extentName=extentName, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, cdpPolicyName=cdpPolicyName, extentStatus=extentStatus, initiatorSid=initiatorSid, vmName=vmName, backupJobName=backupJobName, backupJobComment=backupJobComment)
