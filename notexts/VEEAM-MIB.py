...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:21:47 2024
...
Gauge32, Unsigned32, TimeTicks, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, NotificationType, Integer32, ObjectIdentity, IpAddress, NotificationType, MibIdentifier, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "TimeTicks", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "NotificationType", "Integer32", "ObjectIdentity", "IpAddress", "NotificationType", "MibIdentifier", "iso", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished, products=products, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, onSobrOffloadFinished=onSobrOffloadFinished, repositoryId=repositoryId, onVmBackupCompleted=onVmBackupCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, vmBackupComment=vmBackupComment, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, veeam=veeam, backupJobResult=backupJobResult, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, initiatorName=initiatorName, mountServerName=mountServerName, initiatorSid=initiatorSid, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, csvReportFilePath=csvReportFilePath, traps=traps, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, sourceHostName=sourceHostName, targetDir=targetDir, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, vmBackupResult=vmBackupResult, backup=backup, cdpRpoStatus=cdpRpoStatus, backupJobComment=backupJobComment, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, onWebDownloadFinished=onWebDownloadFinished, backupJobId=backupJobId, vmRestorePointId=vmRestorePointId, notTransferFileList=notTransferFileList, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, cdpRpoThreshold=cdpRpoThreshold, extentName=extentName, backupJobName=backupJobName)
