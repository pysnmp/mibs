...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:16:21 2023
...
Bits, iso, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, Counter64, Counter32, IpAddress, MibIdentifier, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter64", "Counter32", "IpAddress", "MibIdentifier", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadFinished=onWebDownloadFinished, transferTime=transferTime, transferStatus=transferStatus, vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, notTransferFileList=notTransferFileList, backupJobName=backupJobName, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, initiatorSid=initiatorSid, cdpPolicyName=cdpPolicyName, sessionId=sessionId, cdpSla=cdpSla, initiatorName=initiatorName, transferFileList=transferFileList, extentStatusList=extentStatusList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backup=backup, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoThreshold=cdpRpoThreshold, vmBackupResult=vmBackupResult, cdpRpoStatus=cdpRpoStatus, repositoryId=repositoryId, vmBackupComment=vmBackupComment, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backupJobResult=backupJobResult, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetDir=targetDir, cdpMaxDelay=cdpMaxDelay, backupJobComment=backupJobComment, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, products=products, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, onBackupJobCompleted=onBackupJobCompleted, targetHost=targetHost, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentStatusEntry=extentStatusEntry, extentName=extentName, extentStatus=extentStatus)
