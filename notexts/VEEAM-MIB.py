...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:36:51 2022
...
Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, iso, ModuleIdentity, ObjectIdentity, Bits, NotificationType, IpAddress, Counter64, MibIdentifier, enterprises, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "iso", "ModuleIdentity", "ObjectIdentity", "Bits", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "enterprises", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", mountServerName=mountServerName, backupJobResult=backupJobResult, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusEntry=extentStatusEntry, sessionId=sessionId, products=products, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, targetHost=targetHost, cdpSla=cdpSla, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, vmBackupResult=vmBackupResult, traps=traps, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, vmBackupComment=vmBackupComment, transferFileList=transferFileList, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetDir=targetDir, veeam=veeam, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusList=extentStatusList, extentName=extentName, vmName=vmName, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, onWinFLRMountStarted=onWinFLRMountStarted, cdpRpoStatus=cdpRpoStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryStatus=repositoryStatus, backup=backup, initiatorName=initiatorName, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointId=vmRestorePointId, onCdpRpoReport=onCdpRpoReport, initiatorSid=initiatorSid, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferTime=transferTime, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobComment=backupJobComment, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, csvReportFilePath=csvReportFilePath, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, cdpMaxDelay=cdpMaxDelay)
