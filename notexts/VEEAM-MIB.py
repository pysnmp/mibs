...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:02:52 2022
...
ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, TimeTicks, NotificationType, IpAddress, Unsigned32, iso, Counter32, Counter64, ModuleIdentity, MibIdentifier, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "iso", "Counter32", "Counter64", "ModuleIdentity", "MibIdentifier", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointCreationTime=vmRestorePointCreationTime, targetHost=targetHost, products=products, backup=backup, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, traps=traps, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sessionId=sessionId, cdpRpoThreshold=cdpRpoThreshold, onWinFLRCopyToFinished=onWinFLRCopyToFinished, notTransferFileList=notTransferFileList, cdpRpoStatus=cdpRpoStatus, extentStatusEntry=extentStatusEntry, backupJobComment=backupJobComment, extentStatusList=extentStatusList, vmName=vmName, extentName=extentName, initiatorName=initiatorName, veeam=veeam, onWebDownloadFinished=onWebDownloadFinished, mountServerName=mountServerName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferTime=transferTime, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, vmBackupComment=vmBackupComment, transferFileList=transferFileList, onWinFLRMountStarted=onWinFLRMountStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobId=backupJobId, initiatorSid=initiatorSid, repositoryId=repositoryId, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, onWebDownloadStart=onWebDownloadStart, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, repositoryStatus=repositoryStatus, vmBackupResult=vmBackupResult, targetDir=targetDir, backupJobName=backupJobName, backupJobResult=backupJobResult, cdpMaxDelay=cdpMaxDelay)
