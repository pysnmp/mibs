...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:51:55 2021
...
Bits, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, NotificationType, Counter64, Gauge32, Counter32, iso, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "Counter32", "iso", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, vmBackupComment=vmBackupComment, transferTime=transferTime, extentStatus=extentStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, onCdpRpoReport=onCdpRpoReport, products=products, onWebDownloadFinished=onWebDownloadFinished, transferFileList=transferFileList, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult, cdpRpoThreshold=cdpRpoThreshold, targetDir=targetDir, onWinFLRMountStarted=onWinFLRMountStarted, onVmBackupCompleted=onVmBackupCompleted, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, veeam=veeam, vmName=vmName, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, vmBackupResult=vmBackupResult, initiatorSid=initiatorSid, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, repositoryName=repositoryName, repositoryId=repositoryId, initiatorName=initiatorName, mountServerName=mountServerName, vmRestorePointId=vmRestorePointId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobId=backupJobId, sourceHostName=sourceHostName, traps=traps, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetHost=targetHost, extentStatusList=extentStatusList, onSobrOffloadFinished=onSobrOffloadFinished, backupJobName=backupJobName, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus, cdpMaxDelay=cdpMaxDelay, notTransferFileList=notTransferFileList, sessionId=sessionId)
