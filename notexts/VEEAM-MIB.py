...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:17:46 2022
...
iso, TimeTicks, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, MibIdentifier, Counter64, IpAddress, Integer32, Gauge32, ModuleIdentity, Bits, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "MibIdentifier", "Counter64", "IpAddress", "Integer32", "Gauge32", "ModuleIdentity", "Bits", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpPolicyName=cdpPolicyName, targetHost=targetHost, cdpRpoStatus=cdpRpoStatus, products=products, cdpMaxDelay=cdpMaxDelay, repositoryStatus=repositoryStatus, repositoryId=repositoryId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, onWebDownloadFinished=onWebDownloadFinished, extentStatus=extentStatus, vmName=vmName, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, backupJobName=backupJobName, veeam=veeam, csvReportFilePath=csvReportFilePath, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentName=extentName, sessionId=sessionId, notTransferFileList=notTransferFileList, initiatorName=initiatorName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentStatusList=extentStatusList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, traps=traps, onVmBackupCompleted=onVmBackupCompleted, repositoryName=repositoryName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, backupJobResult=backupJobResult, vmRestorePointCreationTime=vmRestorePointCreationTime, targetDir=targetDir, transferFileList=transferFileList, cdpRpoThreshold=cdpRpoThreshold)
