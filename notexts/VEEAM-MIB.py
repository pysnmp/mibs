...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:36:07 2024
...
TimeTicks, Unsigned32, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Bits, Integer32, IpAddress, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Bits", "Integer32", "IpAddress", "iso", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorName=initiatorName, notTransferFileList=notTransferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, sourceHostName=sourceHostName, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, veeam=veeam, traps=traps, onSobrOffloadFinished=onSobrOffloadFinished, transferStatus=transferStatus, transferFileList=transferFileList, backup=backup, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, vmName=vmName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobId=backupJobId, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, transferTime=transferTime, sessionId=sessionId, mountServerName=mountServerName, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, extentStatusList=extentStatusList, products=products, vmRestorePointCreationTime=vmRestorePointCreationTime, csvReportFilePath=csvReportFilePath, vmBackupResult=vmBackupResult, extentName=extentName, onWebDownloadFinished=onWebDownloadFinished, onBackupJobCompleted=onBackupJobCompleted, repositoryStatus=repositoryStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, initiatorSid=initiatorSid, targetDir=targetDir, onVmBackupCompleted=onVmBackupCompleted, cdpSla=cdpSla, cdpPolicyName=cdpPolicyName, backupJobComment=backupJobComment, repositoryName=repositoryName, targetHost=targetHost, cdpMaxDelay=cdpMaxDelay, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished)
