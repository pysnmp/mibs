...
# Produced by pysmi-1.1.12 at Tue May 28 13:42:25 2024
...
Bits, Integer32, IpAddress, TimeTicks, Counter32, Counter64, ObjectIdentity, NotificationType, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, MibIdentifier, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "IpAddress", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "MibIdentifier", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", extentStatus=extentStatus, cdpMaxDelay=cdpMaxDelay, onSobrOffloadFinished=onSobrOffloadFinished, onCdpRpoReport=onCdpRpoReport, vmBackupResult=vmBackupResult, sessionId=sessionId, cdpPolicyName=cdpPolicyName, cdpRpoStatus=cdpRpoStatus, vmRestorePointId=vmRestorePointId, traps=traps, veeam=veeam, extentStatusEntry=extentStatusEntry, transferStatus=transferStatus, backupJobName=backupJobName, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferTime=transferTime, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, repositoryId=repositoryId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, initiatorName=initiatorName, cdpSla=cdpSla, targetDir=targetDir, onWebDownloadFinished=onWebDownloadFinished, products=products, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, backupJobComment=backupJobComment, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, transferFileList=transferFileList, backupJobResult=backupJobResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, repositoryName=repositoryName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, notTransferFileList=notTransferFileList, backup=backup, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadStart=onWebDownloadStart, extentStatusList=extentStatusList, initiatorSid=initiatorSid)
