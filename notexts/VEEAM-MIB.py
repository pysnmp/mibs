...
# Produced by pysmi-1.1.12 at Tue May 21 07:01:41 2024
...
ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, iso, Counter64, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter32, IpAddress, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Counter64", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter32", "IpAddress", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatusEntry=extentStatusEntry, sourceHostName=sourceHostName, csvReportFilePath=csvReportFilePath, vmBackupComment=vmBackupComment, cdpPolicyName=cdpPolicyName, cdpMaxDelay=cdpMaxDelay, traps=traps, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sessionId=sessionId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferTime=transferTime, targetHost=targetHost, backupJobResult=backupJobResult, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, transferStatus=transferStatus, initiatorSid=initiatorSid, vmRestorePointId=vmRestorePointId, backupJobComment=backupJobComment, transferFileList=transferFileList, cdpSla=cdpSla, products=products, vmName=vmName, backup=backup, onWebDownloadFinished=onWebDownloadFinished, onWebDownloadStart=onWebDownloadStart, veeam=veeam, backupJobName=backupJobName, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, notTransferFileList=notTransferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, extentStatusList=extentStatusList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupResult=vmBackupResult, onWinFLRMountStarted=onWinFLRMountStarted, extentStatus=extentStatus, extentName=extentName, onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorName=initiatorName, repositoryId=repositoryId, targetDir=targetDir)
