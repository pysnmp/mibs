...
# Produced by pysmi-1.1.12 at Wed May 29 10:11:32 2024
...
NotificationType, Counter64, TimeTicks, Integer32, ModuleIdentity, IpAddress, Counter32, MibIdentifier, Unsigned32, NotificationType, Gauge32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "TimeTicks", "Integer32", "ModuleIdentity", "IpAddress", "Counter32", "MibIdentifier", "Unsigned32", "NotificationType", "Gauge32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferFileList=transferFileList, repositoryStatus=repositoryStatus, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, onWinFLRCopyToFinished=onWinFLRCopyToFinished, mountServerName=mountServerName, extentName=extentName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, initiatorSid=initiatorSid, cdpMaxDelay=cdpMaxDelay, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backup=backup, notTransferFileList=notTransferFileList, targetDir=targetDir, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, cdpSla=cdpSla, products=products, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, onVmBackupCompleted=onVmBackupCompleted, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryId=repositoryId, traps=traps, cdpRpoStatus=cdpRpoStatus, extentStatusEntry=extentStatusEntry, backupJobResult=backupJobResult, sessionId=sessionId, onSobrOffloadFinished=onSobrOffloadFinished, vmBackupComment=vmBackupComment, backupJobComment=backupJobComment, transferStatus=transferStatus, onBackupJobCompleted=onBackupJobCompleted, initiatorName=initiatorName, extentStatus=extentStatus, veeam=veeam, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, onWinFLRMountStarted=onWinFLRMountStarted, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusList=extentStatusList, vmRestorePointId=vmRestorePointId, onWebDownloadFinished=onWebDownloadFinished, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobId=backupJobId)
