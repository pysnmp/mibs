...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:35:41 2021
...
enterprises, Counter64, ObjectIdentity, NotificationType, MibIdentifier, Bits, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, IpAddress, NotificationType, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "NotificationType", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backup=backup, onWebDownloadFinished=onWebDownloadFinished, vmName=vmName, vmRestorePointId=vmRestorePointId, repositoryStatus=repositoryStatus, csvReportFilePath=csvReportFilePath, onWinFLRMountStarted=onWinFLRMountStarted, backupJobName=backupJobName, transferStatus=transferStatus, targetDir=targetDir, extentName=extentName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobComment=backupJobComment, cdpRpoStatus=cdpRpoStatus, transferTime=transferTime, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, targetHost=targetHost, sessionId=sessionId, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, cdpSla=cdpSla, onBackupJobCompleted=onBackupJobCompleted, initiatorSid=initiatorSid, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, mountServerName=mountServerName, notTransferFileList=notTransferFileList, extentStatus=extentStatus, cdpMaxDelay=cdpMaxDelay, onWebDownloadStart=onWebDownloadStart, cdpRpoThreshold=cdpRpoThreshold, transferFileList=transferFileList, vmBackupResult=vmBackupResult, traps=traps, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, products=products, onVmBackupCompleted=onVmBackupCompleted, cdpPolicyName=cdpPolicyName, repositoryId=repositoryId, vmBackupComment=vmBackupComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryName=repositoryName, veeam=veeam, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
