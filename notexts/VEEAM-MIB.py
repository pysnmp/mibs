...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:33:36 2023
...
MibIdentifier, iso, Integer32, Counter32, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, Unsigned32, IpAddress, TimeTicks, Bits, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Integer32", "Counter32", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "IpAddress", "TimeTicks", "Bits", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, mountServerName=mountServerName, onSobrOffloadFinished=onSobrOffloadFinished, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, transferStatus=transferStatus, vmName=vmName, transferTime=transferTime, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointId=vmRestorePointId, extentStatus=extentStatus, extentName=extentName, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, initiatorSid=initiatorSid, onWinFLRCopyToFinished=onWinFLRCopyToFinished, targetHost=targetHost, onWebDownloadFinished=onWebDownloadFinished, cdpSla=cdpSla, repositoryId=repositoryId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onVmBackupCompleted=onVmBackupCompleted, cdpRpoStatus=cdpRpoStatus, transferFileList=transferFileList, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, cdpPolicyName=cdpPolicyName, backupJobName=backupJobName, backupJobResult=backupJobResult, backup=backup, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupResult=vmBackupResult, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, traps=traps, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, notTransferFileList=notTransferFileList, backupJobId=backupJobId, repositoryName=repositoryName, vmBackupComment=vmBackupComment, targetDir=targetDir, csvReportFilePath=csvReportFilePath, products=products, cdpMaxDelay=cdpMaxDelay, sessionId=sessionId, initiatorName=initiatorName)
