...
NotificationType, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ModuleIdentity, Integer32, MibIdentifier, Counter32, TimeTicks, enterprises, iso, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter32", "TimeTicks", "enterprises", "iso", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferFileList=transferFileList, repositoryStatus=repositoryStatus, cdpPolicyName=cdpPolicyName, notTransferFileList=notTransferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, sessionId=sessionId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentName=extentName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentStatusList=extentStatusList, onWebDownloadStart=onWebDownloadStart, extentStatusEntry=extentStatusEntry, backupJobComment=backupJobComment, vmBackupComment=vmBackupComment, traps=traps, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, mountServerName=mountServerName, onVmBackupCompleted=onVmBackupCompleted, sourceHostName=sourceHostName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, targetDir=targetDir, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupResult=vmBackupResult, extentStatus=extentStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, transferTime=transferTime, repositoryId=repositoryId, backupJobId=backupJobId, onBackupJobCompleted=onBackupJobCompleted, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobName=backupJobName, vmName=vmName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onCdpRpoReport=onCdpRpoReport, products=products, initiatorSid=initiatorSid, targetHost=targetHost, transferStatus=transferStatus, backupJobResult=backupJobResult, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointId=vmRestorePointId, onSobrOffloadFinished=onSobrOffloadFinished, cdpRpoStatus=cdpRpoStatus, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, onWebDownloadFinished=onWebDownloadFinished)
