...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:20:34 2022
...
ObjectIdentity, Bits, NotificationType, iso, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks, Gauge32, NotificationType, Integer32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "NotificationType", "iso", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "Integer32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("VEEAM-MIB", sourceHostName=sourceHostName, extentStatus=extentStatus, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, initiatorSid=initiatorSid, targetDir=targetDir, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, initiatorName=initiatorName, onWinFLRMountStarted=onWinFLRMountStarted, backup=backup, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, onWinFLRCopyToFinished=onWinFLRCopyToFinished, targetHost=targetHost, vmRestorePointId=vmRestorePointId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onSobrOffloadFinished=onSobrOffloadFinished, vmName=vmName, cdpPolicyName=cdpPolicyName, cdpSla=cdpSla, veeam=veeam, extentStatusList=extentStatusList, backupJobResult=backupJobResult, onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, products=products, backupJobName=backupJobName, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, cdpRpoThreshold=cdpRpoThreshold, repositoryName=repositoryName, repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobId=backupJobId, backupJobComment=backupJobComment, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, traps=traps, transferStatus=transferStatus, notTransferFileList=notTransferFileList, extentName=extentName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, vmBackupComment=vmBackupComment)
