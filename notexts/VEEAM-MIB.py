...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:18:01 2023
...
Bits, Counter32, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, iso, Integer32, TimeTicks, NotificationType, enterprises, NotificationType, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "Integer32", "TimeTicks", "NotificationType", "enterprises", "NotificationType", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, sourceHostName=sourceHostName, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, repositoryStatus=repositoryStatus, onCdpRpoReport=onCdpRpoReport, cdpPolicyName=cdpPolicyName, backupJobResult=backupJobResult, repositoryId=repositoryId, onWinFLRMountStarted=onWinFLRMountStarted, traps=traps, initiatorName=initiatorName, onWebDownloadStart=onWebDownloadStart, notTransferFileList=notTransferFileList, vmBackupComment=vmBackupComment, extentName=extentName, backupJobId=backupJobId, mountServerName=mountServerName, sessionId=sessionId, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, vmRestorePointId=vmRestorePointId, repositoryName=repositoryName, backupJobComment=backupJobComment, initiatorSid=initiatorSid, vmRestorePointCreationTime=vmRestorePointCreationTime, csvReportFilePath=csvReportFilePath, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onSobrOffloadFinished=onSobrOffloadFinished, products=products, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, backup=backup, targetHost=targetHost, transferFileList=transferFileList, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, transferStatus=transferStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backupJobName=backupJobName, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmBackupResult=vmBackupResult, transferTime=transferTime)
