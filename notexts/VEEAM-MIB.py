...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:29:37 2023
...
ObjectIdentity, NotificationType, NotificationType, MibIdentifier, Gauge32, enterprises, Integer32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, Counter64, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "NotificationType", "MibIdentifier", "Gauge32", "enterprises", "Integer32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "Counter64", "iso", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferFileList=transferFileList, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, backupJobId=backupJobId, backupJobResult=backupJobResult, initiatorSid=initiatorSid, traps=traps, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, onBackupJobCompleted=onBackupJobCompleted, vmRestorePointId=vmRestorePointId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, notTransferFileList=notTransferFileList, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, transferTime=transferTime, onCdpRpoReport=onCdpRpoReport, transferStatus=transferStatus, onSobrOffloadFinished=onSobrOffloadFinished, extentStatus=extentStatus, vmName=vmName, sourceHostName=sourceHostName, extentName=extentName, cdpSla=cdpSla, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, repositoryStatus=repositoryStatus, repositoryId=repositoryId, backup=backup, backupJobComment=backupJobComment, initiatorName=initiatorName, targetDir=targetDir, extentStatusList=extentStatusList, extentStatusEntry=extentStatusEntry, onWinFLRMountStarted=onWinFLRMountStarted, products=products, vmBackupResult=vmBackupResult, mountServerName=mountServerName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, cdpRpoStatus=cdpRpoStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, onWebDownloadFinished=onWebDownloadFinished, cdpRpoThreshold=cdpRpoThreshold, targetHost=targetHost, cdpPolicyName=cdpPolicyName, sessionId=sessionId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
