...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:39:07 2023
...
Bits, Gauge32, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, Counter32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetDir=targetDir, notTransferFileList=notTransferFileList, products=products, backup=backup, cdpRpoStatus=cdpRpoStatus, vmBackupResult=vmBackupResult, onSobrOffloadFinished=onSobrOffloadFinished, mountServerName=mountServerName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatusEntry=extentStatusEntry, onCdpRpoReport=onCdpRpoReport, cdpSla=cdpSla, onWinFLRCopyToStarted=onWinFLRCopyToStarted, csvReportFilePath=csvReportFilePath, backupJobName=backupJobName, onWebDownloadStart=onWebDownloadStart, onVmBackupCompleted=onVmBackupCompleted, repositoryStatus=repositoryStatus, onLinuxFLRMountStarted=onLinuxFLRMountStarted, sessionId=sessionId, cdpRpoThreshold=cdpRpoThreshold, transferFileList=transferFileList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, onWebDownloadFinished=onWebDownloadFinished, targetHost=targetHost, traps=traps, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, initiatorSid=initiatorSid, backupJobComment=backupJobComment, vmName=vmName, transferTime=transferTime, backupJobId=backupJobId, repositoryId=repositoryId, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, veeam=veeam, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobResult=backupJobResult, sourceHostName=sourceHostName, extentStatusList=extentStatusList, vmBackupComment=vmBackupComment, vmRestorePointId=vmRestorePointId, extentName=extentName, initiatorName=initiatorName)
