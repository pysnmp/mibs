...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:04:38 2023
...
enterprises, Integer32, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, NotificationType, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, ObjectIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "NotificationType", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("VEEAM-MIB", initiatorSid=initiatorSid, repositoryName=repositoryName, cdpRpoThreshold=cdpRpoThreshold, traps=traps, extentStatusEntry=extentStatusEntry, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointId=vmRestorePointId, onWebDownloadFinished=onWebDownloadFinished, sessionId=sessionId, backupJobComment=backupJobComment, notTransferFileList=notTransferFileList, vmBackupComment=vmBackupComment, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, repositoryId=repositoryId, products=products, cdpRpoStatus=cdpRpoStatus, transferFileList=transferFileList, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferTime=transferTime, cdpPolicyName=cdpPolicyName, backupJobResult=backupJobResult, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferStatus=transferStatus, extentStatusList=extentStatusList, onWebDownloadStart=onWebDownloadStart, vmName=vmName, vmBackupResult=vmBackupResult, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, initiatorName=initiatorName, veeam=veeam, repositoryStatus=repositoryStatus, targetDir=targetDir, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobId=backupJobId, backup=backup, targetHost=targetHost, sourceHostName=sourceHostName, onCdpRpoReport=onCdpRpoReport, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onVmBackupCompleted=onVmBackupCompleted, backupJobName=backupJobName, extentStatus=extentStatus, extentName=extentName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted)
