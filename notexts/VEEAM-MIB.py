...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:10:56 2022
...
Gauge32, Counter64, IpAddress, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Counter32, enterprises, NotificationType, NotificationType, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "IpAddress", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Counter32", "enterprises", "NotificationType", "NotificationType", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, products=products, backup=backup, initiatorName=initiatorName, initiatorSid=initiatorSid, extentStatusEntry=extentStatusEntry, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, repositoryId=repositoryId, extentStatusList=extentStatusList, backupJobName=backupJobName, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, vmBackupComment=vmBackupComment, transferStatus=transferStatus, targetHost=targetHost, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, backupJobId=backupJobId, transferTime=transferTime, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, cdpRpoThreshold=cdpRpoThreshold, transferFileList=transferFileList, traps=traps, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoStatus=cdpRpoStatus, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, backupJobResult=backupJobResult, sourceHostName=sourceHostName, sessionId=sessionId, notTransferFileList=notTransferFileList, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, vmName=vmName, vmRestorePointCreationTime=vmRestorePointCreationTime, onCdpRpoReport=onCdpRpoReport, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, targetDir=targetDir, onWebDownloadStart=onWebDownloadStart, mountServerName=mountServerName, veeam=veeam, vmBackupResult=vmBackupResult, extentName=extentName)
