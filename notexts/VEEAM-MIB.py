...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:07:15 2022
...
MibIdentifier, ModuleIdentity, Integer32, ObjectIdentity, IpAddress, enterprises, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks, Gauge32, Counter64, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Integer32", "ObjectIdentity", "IpAddress", "enterprises", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks", "Gauge32", "Counter64", "Counter32", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmName=vmName, backupJobResult=backupJobResult, extentStatusEntry=extentStatusEntry, extentName=extentName, onSobrOffloadFinished=onSobrOffloadFinished, transferFileList=transferFileList, mountServerName=mountServerName, repositoryId=repositoryId, products=products, vmBackupComment=vmBackupComment, onWinFLRCopyToFinished=onWinFLRCopyToFinished, transferStatus=transferStatus, vmRestorePointId=vmRestorePointId, initiatorSid=initiatorSid, repositoryName=repositoryName, onCdpRpoReport=onCdpRpoReport, traps=traps, onBackupJobCompleted=onBackupJobCompleted, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, onWebDownloadStart=onWebDownloadStart, onWebDownloadFinished=onWebDownloadFinished, repositoryStatus=repositoryStatus, extentStatusList=extentStatusList, csvReportFilePath=csvReportFilePath, cdpPolicyName=cdpPolicyName, extentStatus=extentStatus, onWinFLRMountStarted=onWinFLRMountStarted, targetHost=targetHost, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointCreationTime=vmRestorePointCreationTime, notTransferFileList=notTransferFileList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobComment=backupJobComment, veeam=veeam, backupJobName=backupJobName, sessionId=sessionId, transferTime=transferTime, cdpSla=cdpSla, vmBackupResult=vmBackupResult, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, initiatorName=initiatorName, targetDir=targetDir, cdpRpoStatus=cdpRpoStatus)
