...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:19:59 2022
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, TimeTicks, Counter64, enterprises, Integer32, Bits, Unsigned32, Counter32, ModuleIdentity, ObjectIdentity, NotificationType, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "TimeTicks", "Counter64", "enterprises", "Integer32", "Bits", "Unsigned32", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToStarted=onWinFLRCopyToStarted, repositoryStatus=repositoryStatus, targetHost=targetHost, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupComment=vmBackupComment, vmName=vmName, onVmBackupCompleted=onVmBackupCompleted, targetDir=targetDir, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, cdpMaxDelay=cdpMaxDelay, repositoryId=repositoryId, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, onBackupJobCompleted=onBackupJobCompleted, sourceHostName=sourceHostName, transferFileList=transferFileList, extentStatusEntry=extentStatusEntry, backupJobResult=backupJobResult, sessionId=sessionId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, cdpSla=cdpSla, extentStatus=extentStatus, extentStatusList=extentStatusList, backupJobId=backupJobId, vmRestorePointId=vmRestorePointId, mountServerName=mountServerName, backupJobName=backupJobName, products=products, traps=traps, veeam=veeam, transferTime=transferTime, repositoryName=repositoryName, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorSid=initiatorSid, cdpRpoThreshold=cdpRpoThreshold, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadStart=onWebDownloadStart, notTransferFileList=notTransferFileList, onCdpRpoReport=onCdpRpoReport, transferStatus=transferStatus, extentName=extentName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpRpoStatus=cdpRpoStatus, vmBackupResult=vmBackupResult, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpPolicyName=cdpPolicyName, onSobrOffloadFinished=onSobrOffloadFinished)
