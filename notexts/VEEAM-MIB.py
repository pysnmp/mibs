...
# Produced by pysmi-1.1.12 at Tue May 28 12:40:50 2024
...
TimeTicks, Unsigned32, Bits, Counter32, Integer32, Counter64, IpAddress, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, enterprises, iso, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Bits", "Counter32", "Integer32", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "enterprises", "iso", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", backup=backup, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetDir=targetDir, repositoryStatus=repositoryStatus, onSobrOffloadFinished=onSobrOffloadFinished, backupJobResult=backupJobResult, backupJobComment=backupJobComment, transferTime=transferTime, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, notTransferFileList=notTransferFileList, csvReportFilePath=csvReportFilePath, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, onWebDownloadStart=onWebDownloadStart, vmName=vmName, onBackupJobCompleted=onBackupJobCompleted, traps=traps, onWinFLRMountStarted=onWinFLRMountStarted, repositoryId=repositoryId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobName=backupJobName, extentName=extentName, extentStatusList=extentStatusList, cdpMaxDelay=cdpMaxDelay, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, mountServerName=mountServerName, repositoryName=repositoryName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, products=products, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, sessionId=sessionId, transferFileList=transferFileList, onCdpRpoReport=onCdpRpoReport, vmRestorePointId=vmRestorePointId, cdpPolicyName=cdpPolicyName, extentStatus=extentStatus, initiatorName=initiatorName, cdpRpoThreshold=cdpRpoThreshold, extentStatusEntry=extentStatusEntry, cdpSla=cdpSla, targetHost=targetHost, transferStatus=transferStatus, initiatorSid=initiatorSid, onWebDownloadFinished=onWebDownloadFinished, sourceHostName=sourceHostName)
