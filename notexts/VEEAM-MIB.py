...
# Produced by pysmi-1.1.8 at Tue Jan 18 15:16:54 2022
...
Bits, NotificationType, Counter64, Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, iso, enterprises, TimeTicks, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "iso", "enterprises", "TimeTicks", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferStatus=transferStatus, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobName=backupJobName, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, vmRestorePointId=vmRestorePointId, cdpSla=cdpSla, initiatorSid=initiatorSid, products=products, onBackupJobCompleted=onBackupJobCompleted, transferTime=transferTime, repositoryId=repositoryId, mountServerName=mountServerName, onWebDownloadFinished=onWebDownloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentName=extentName, csvReportFilePath=csvReportFilePath, cdpRpoThreshold=cdpRpoThreshold, targetDir=targetDir, cdpPolicyName=cdpPolicyName, vmRestorePointCreationTime=vmRestorePointCreationTime, veeam=veeam, extentStatus=extentStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpRpoStatus=cdpRpoStatus, backup=backup, notTransferFileList=notTransferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmName=vmName, backupJobComment=backupJobComment, sessionId=sessionId, cdpMaxDelay=cdpMaxDelay, backupJobId=backupJobId, targetHost=targetHost, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, backupJobResult=backupJobResult, transferFileList=transferFileList, traps=traps, initiatorName=initiatorName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentStatusList=extentStatusList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, repositoryName=repositoryName)
