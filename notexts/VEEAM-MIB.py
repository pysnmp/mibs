...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:34:41 2023
...
NotificationType, TimeTicks, Unsigned32, ObjectIdentity, Counter64, iso, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, NotificationType, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter64", "iso", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "NotificationType", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRCopyToStarted=onWinFLRCopyToStarted, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatus=extentStatus, cdpPolicyName=cdpPolicyName, sourceHostName=sourceHostName, vmName=vmName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, transferTime=transferTime, cdpSla=cdpSla, transferFileList=transferFileList, csvReportFilePath=csvReportFilePath, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, backupJobName=backupJobName, initiatorName=initiatorName, transferStatus=transferStatus, backupJobId=backupJobId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentName=extentName, onWebDownloadFinished=onWebDownloadFinished, cdpRpoThreshold=cdpRpoThreshold, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, repositoryStatus=repositoryStatus, repositoryName=repositoryName, veeam=veeam, extentStatusList=extentStatusList, products=products, backup=backup, notTransferFileList=notTransferFileList, onWinFLRMountStarted=onWinFLRMountStarted, backupJobResult=backupJobResult, sessionId=sessionId, targetHost=targetHost, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupComment=vmBackupComment, vmBackupResult=vmBackupResult, onWebDownloadStart=onWebDownloadStart, backupJobComment=backupJobComment, vmRestorePointId=vmRestorePointId, repositoryId=repositoryId, extentStatusEntry=extentStatusEntry, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpRpoStatus=cdpRpoStatus, initiatorSid=initiatorSid, onCdpRpoReport=onCdpRpoReport, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, traps=traps)
