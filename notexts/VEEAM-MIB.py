...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:36:23 2022
...
NotificationType, iso, Unsigned32, NotificationType, Integer32, MibIdentifier, ObjectIdentity, Counter32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, enterprises, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Unsigned32", "NotificationType", "Integer32", "MibIdentifier", "ObjectIdentity", "Counter32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "enterprises", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("VEEAM-MIB", veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, extentStatusEntry=extentStatusEntry, vmRestorePointId=vmRestorePointId, transferFileList=transferFileList, products=products, mountServerName=mountServerName, vmName=vmName, initiatorSid=initiatorSid, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, transferTime=transferTime, initiatorName=initiatorName, traps=traps, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusList=extentStatusList, targetDir=targetDir, onWebDownloadFinished=onWebDownloadFinished, cdpMaxDelay=cdpMaxDelay, repositoryId=repositoryId, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, backupJobResult=backupJobResult, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, extentName=extentName, cdpRpoThreshold=cdpRpoThreshold, onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, repositoryStatus=repositoryStatus, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, onWebDownloadStart=onWebDownloadStart, extentStatus=extentStatus, cdpRpoStatus=cdpRpoStatus, cdpSla=cdpSla, backupJobComment=backupJobComment, vmBackupResult=vmBackupResult, targetHost=targetHost, backup=backup, backupJobId=backupJobId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobName=backupJobName)
