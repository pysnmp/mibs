...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:17:01 2021
...
iso, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Bits, TimeTicks, Counter64, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, MibIdentifier, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Bits", "TimeTicks", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRMountStarted=onWinFLRMountStarted, backupJobComment=backupJobComment, onWebDownloadFinished=onWebDownloadFinished, vmRestorePointCreationTime=vmRestorePointCreationTime, extentStatusList=extentStatusList, cdpRpoThreshold=cdpRpoThreshold, onBackupJobCompleted=onBackupJobCompleted, onCdpRpoReport=onCdpRpoReport, transferTime=transferTime, backupJobName=backupJobName, backupJobResult=backupJobResult, mountServerName=mountServerName, backup=backup, repositoryId=repositoryId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, transferFileList=transferFileList, extentName=extentName, extentStatus=extentStatus, sessionId=sessionId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupResult=vmBackupResult, initiatorSid=initiatorSid, notTransferFileList=notTransferFileList, traps=traps, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, veeam=veeam, cdpMaxDelay=cdpMaxDelay, vmName=vmName, onSobrOffloadFinished=onSobrOffloadFinished, vmRestorePointId=vmRestorePointId, targetHost=targetHost, repositoryName=repositoryName, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, cdpSla=cdpSla, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, extentStatusEntry=extentStatusEntry, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, sourceHostName=sourceHostName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, backupJobId=backupJobId, targetDir=targetDir, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, repositoryStatus=repositoryStatus, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupComment=vmBackupComment, onVmBackupCompleted=onVmBackupCompleted)
