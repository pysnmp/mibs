...
# Produced by pysmi-1.1.12 at Tue May 28 14:04:31 2024
...
enterprises, ObjectIdentity, NotificationType, Counter64, Unsigned32, MibIdentifier, Integer32, TimeTicks, Bits, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "TimeTicks", "Bits", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryName=repositoryName, onVmBackupCompleted=onVmBackupCompleted, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointId=vmRestorePointId, transferTime=transferTime, repositoryStatus=repositoryStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, extentName=extentName, traps=traps, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWebDownloadFinished=onWebDownloadFinished, backupJobResult=backupJobResult, mountServerName=mountServerName, vmName=vmName, backupJobName=backupJobName, extentStatusEntry=extentStatusEntry, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, extentStatus=extentStatus, cdpSla=cdpSla, vmBackupResult=vmBackupResult, backupJobId=backupJobId, sessionId=sessionId, targetDir=targetDir, onWebDownloadStart=onWebDownloadStart, vmRestorePointCreationTime=vmRestorePointCreationTime, transferFileList=transferFileList, backupJobComment=backupJobComment, products=products, csvReportFilePath=csvReportFilePath, transferStatus=transferStatus, onSobrOffloadFinished=onSobrOffloadFinished, cdpPolicyName=cdpPolicyName, initiatorSid=initiatorSid, repositoryId=repositoryId, extentStatusList=extentStatusList, cdpRpoStatus=cdpRpoStatus, veeam=veeam, onWinFLRCopyToFinished=onWinFLRCopyToFinished, sourceHostName=sourceHostName, notTransferFileList=notTransferFileList, backup=backup, onWinFLRCopyToStarted=onWinFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onBackupJobCompleted=onBackupJobCompleted)
