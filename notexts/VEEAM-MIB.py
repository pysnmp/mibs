...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:19:13 2024
...
NotificationType, Integer32, Counter64, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, Unsigned32, Gauge32, IpAddress, MibIdentifier, enterprises, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "enterprises", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", csvReportFilePath=csvReportFilePath, onVmBackupCompleted=onVmBackupCompleted, sessionId=sessionId, vmBackupComment=vmBackupComment, backupJobName=backupJobName, vmName=vmName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, mountServerName=mountServerName, backupJobResult=backupJobResult, repositoryId=repositoryId, backupJobComment=backupJobComment, repositoryStatus=repositoryStatus, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmRestorePointCreationTime=vmRestorePointCreationTime, vmBackupResult=vmBackupResult, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, initiatorName=initiatorName, cdpRpoStatus=cdpRpoStatus, onWebDownloadStart=onWebDownloadStart, products=products, veeam=veeam, initiatorSid=initiatorSid, cdpSla=cdpSla, transferStatus=transferStatus, repositoryName=repositoryName, vmRestorePointId=vmRestorePointId, extentStatusList=extentStatusList, onWinFLRMountStarted=onWinFLRMountStarted, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, targetDir=targetDir, traps=traps, cdpRpoThreshold=cdpRpoThreshold, transferFileList=transferFileList, transferTime=transferTime, onSobrOffloadFinished=onSobrOffloadFinished, notTransferFileList=notTransferFileList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobId=backupJobId, sourceHostName=sourceHostName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, backup=backup, targetHost=targetHost, extentStatusEntry=extentStatusEntry, extentStatus=extentStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRCopyToFinished=onWinFLRCopyToFinished, extentName=extentName, cdpMaxDelay=cdpMaxDelay)
