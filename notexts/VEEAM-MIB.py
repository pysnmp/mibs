...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:21:26 2024
...
mibBuilder.exportSymbols("VEEAM-MIB", vmName=vmName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, onSobrOffloadFinished=onSobrOffloadFinished, backup=backup, extentStatusList=extentStatusList, onWebDownloadStart=onWebDownloadStart, backupJobId=backupJobId, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmRestorePointId=vmRestorePointId, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, vmBackupResult=vmBackupResult, backupJobName=backupJobName, vmBackupComment=vmBackupComment, notTransferFileList=notTransferFileList, initiatorSid=initiatorSid, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, mountServerName=mountServerName, extentStatusEntry=extentStatusEntry, targetDir=targetDir, sourceHostName=sourceHostName, backupJobResult=backupJobResult, sessionId=sessionId, cdpRpoThreshold=cdpRpoThreshold, onWebDownloadFinished=onWebDownloadFinished, onVmBackupCompleted=onVmBackupCompleted, onCdpRpoReport=onCdpRpoReport, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, extentStatus=extentStatus, repositoryName=repositoryName, products=products, extentName=extentName, onWinFLRMountStarted=onWinFLRMountStarted, initiatorName=initiatorName, targetHost=targetHost, transferFileList=transferFileList, cdpSla=cdpSla, traps=traps, onWinFLRCopyToStarted=onWinFLRCopyToStarted, transferTime=transferTime, transferStatus=transferStatus, veeam=veeam, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, cdpPolicyName=cdpPolicyName, cdpRpoStatus=cdpRpoStatus, csvReportFilePath=csvReportFilePath)
