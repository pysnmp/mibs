...
# Produced by pysmi-1.1.12 at Mon Apr 22 02:18:27 2024
...
Bits, NotificationType, MibIdentifier, enterprises, Gauge32, NotificationType, IpAddress, Counter32, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "MibIdentifier", "enterprises", "Gauge32", "NotificationType", "IpAddress", "Counter32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "iso", "Integer32")
...
mibBuilder.exportSymbols("VEEAM-MIB", cdpRpoThreshold=cdpRpoThreshold, vmRestorePointId=vmRestorePointId, cdpMaxDelay=cdpMaxDelay, transferTime=transferTime, onVmBackupCompleted=onVmBackupCompleted, mountServerName=mountServerName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, backupJobResult=backupJobResult, extentStatus=extentStatus, extentStatusEntry=extentStatusEntry, cdpSla=cdpSla, sessionId=sessionId, backup=backup, backupJobName=backupJobName, sourceHostName=sourceHostName, transferFileList=transferFileList, initiatorSid=initiatorSid, transferStatus=transferStatus, onWebDownloadStart=onWebDownloadStart, vmRestorePointCreationTime=vmRestorePointCreationTime, vmName=vmName, products=products, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, targetDir=targetDir, extentStatusList=extentStatusList, notTransferFileList=notTransferFileList, cdpPolicyName=cdpPolicyName, repositoryName=repositoryName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onCdpRpoReport=onCdpRpoReport, extentName=extentName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, csvReportFilePath=csvReportFilePath, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onBackupJobCompleted=onBackupJobCompleted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, targetHost=targetHost, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, vmBackupResult=vmBackupResult, backupJobId=backupJobId, repositoryStatus=repositoryStatus, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, vmBackupComment=vmBackupComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, traps=traps)
