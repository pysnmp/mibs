...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:41:20 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, TimeTicks, Counter32, IpAddress, iso, Counter64, NotificationType, enterprises, ModuleIdentity, MibIdentifier, NotificationType, ObjectIdentity, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "iso", "Counter64", "NotificationType", "enterprises", "ModuleIdentity", "MibIdentifier", "NotificationType", "ObjectIdentity", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointCreationTime=vmRestorePointCreationTime, extentName=extentName, traps=traps, transferStatus=transferStatus, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, cdpPolicyName=cdpPolicyName, csvReportFilePath=csvReportFilePath, backupJobId=backupJobId, extentStatus=extentStatus, veeam=veeam, onWinFLRMountStarted=onWinFLRMountStarted, repositoryStatus=repositoryStatus, targetDir=targetDir, sessionId=sessionId, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpRpoThreshold=cdpRpoThreshold, extentStatusEntry=extentStatusEntry, vmBackupResult=vmBackupResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, notTransferFileList=notTransferFileList, cdpSla=cdpSla, initiatorSid=initiatorSid, transferFileList=transferFileList, vmBackupComment=vmBackupComment, repositoryName=repositoryName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, sourceHostName=sourceHostName, backupJobComment=backupJobComment, targetHost=targetHost, cdpRpoStatus=cdpRpoStatus, onCdpRpoReport=onCdpRpoReport, vmRestorePointId=vmRestorePointId, vmName=vmName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadStart=onWebDownloadStart, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, onVmBackupCompleted=onVmBackupCompleted, backupJobResult=backupJobResult, transferTime=transferTime, initiatorName=initiatorName, mountServerName=mountServerName, backup=backup, backupJobName=backupJobName, extentStatusList=extentStatusList, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
