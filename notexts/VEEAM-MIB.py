...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:15:13 2023
...
Gauge32, enterprises, MibIdentifier, NotificationType, TimeTicks, Counter32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, IpAddress, iso, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "IpAddress", "iso", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferFileList=transferFileList, mountServerName=mountServerName, notTransferFileList=notTransferFileList, onCdpRpoReport=onCdpRpoReport, csvReportFilePath=csvReportFilePath, extentName=extentName, sessionId=sessionId, veeam=veeam, extentStatusEntry=extentStatusEntry, transferTime=transferTime, repositoryId=repositoryId, backupJobComment=backupJobComment, onWinFLRMountStarted=onWinFLRMountStarted, vmRestorePointId=vmRestorePointId, onVmBackupCompleted=onVmBackupCompleted, cdpPolicyName=cdpPolicyName, onWebDownloadStart=onWebDownloadStart, onBackupJobCompleted=onBackupJobCompleted, onSobrOffloadFinished=onSobrOffloadFinished, initiatorSid=initiatorSid, traps=traps, products=products, cdpRpoStatus=cdpRpoStatus, onWebDownloadFinished=onWebDownloadFinished, transferStatus=transferStatus, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, targetHost=targetHost, cdpSla=cdpSla, extentStatusList=extentStatusList, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sourceHostName=sourceHostName, cdpRpoThreshold=cdpRpoThreshold, vmName=vmName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobResult=backupJobResult, repositoryStatus=repositoryStatus, backupJobId=backupJobId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, backupJobName=backupJobName, targetDir=targetDir, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryName=repositoryName, cdpMaxDelay=cdpMaxDelay, vmBackupComment=vmBackupComment, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, backup=backup, extentStatus=extentStatus)
