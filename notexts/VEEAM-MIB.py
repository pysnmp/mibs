...
# Produced by pysmi-1.1.12 at Tue May 28 13:14:42 2024
...
IpAddress, Counter64, MibIdentifier, TimeTicks, ModuleIdentity, enterprises, ObjectIdentity, Counter32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibIdentifier", "TimeTicks", "ModuleIdentity", "enterprises", "ObjectIdentity", "Counter32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWebDownloadStart=onWebDownloadStart, sessionId=sessionId, cdpRpoStatus=cdpRpoStatus, extentName=extentName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, vmBackupResult=vmBackupResult, notTransferFileList=notTransferFileList, backup=backup, onVmBackupCompleted=onVmBackupCompleted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmBackupComment=vmBackupComment, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, vmRestorePointId=vmRestorePointId, backupJobName=backupJobName, extentStatus=extentStatus, vmName=vmName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onSobrOffloadFinished=onSobrOffloadFinished, initiatorName=initiatorName, onCdpRpoReport=onCdpRpoReport, backupJobResult=backupJobResult, vmRestorePointCreationTime=vmRestorePointCreationTime, backupJobId=backupJobId, initiatorSid=initiatorSid, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferStatus=transferStatus, cdpRpoThreshold=cdpRpoThreshold, repositoryStatus=repositoryStatus, extentStatusEntry=extentStatusEntry, mountServerName=mountServerName, repositoryId=repositoryId, repositoryName=repositoryName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpSla=cdpSla, backupJobComment=backupJobComment, traps=traps, onWinFLRMountStarted=onWinFLRMountStarted, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, veeam=veeam, cdpMaxDelay=cdpMaxDelay, onBackupJobCompleted=onBackupJobCompleted, products=products, csvReportFilePath=csvReportFilePath, sourceHostName=sourceHostName, transferFileList=transferFileList, onWebDownloadFinished=onWebDownloadFinished, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, targetHost=targetHost, transferTime=transferTime, targetDir=targetDir)
