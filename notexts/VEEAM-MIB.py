...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:33:05 2022
...
ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, enterprises, Bits, MibIdentifier, NotificationType, ObjectIdentity, iso, Integer32, Counter32, Counter64, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "enterprises", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity", "iso", "Integer32", "Counter32", "Counter64", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, initiatorName=initiatorName, initiatorSid=initiatorSid, backup=backup, onVmBackupCompleted=onVmBackupCompleted, products=products, cdpPolicyName=cdpPolicyName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, sourceHostName=sourceHostName, repositoryName=repositoryName, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, backupJobComment=backupJobComment, cdpRpoThreshold=cdpRpoThreshold, onLinuxFLRMountStarted=onLinuxFLRMountStarted, cdpMaxDelay=cdpMaxDelay, backupJobResult=backupJobResult, repositoryStatus=repositoryStatus, vmName=vmName, transferFileList=transferFileList, transferStatus=transferStatus, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, extentName=extentName, targetHost=targetHost, onWinFLRCopyToFinished=onWinFLRCopyToFinished, csvReportFilePath=csvReportFilePath, traps=traps, cdpSla=cdpSla, vmBackupComment=vmBackupComment, cdpRpoStatus=cdpRpoStatus, notTransferFileList=notTransferFileList, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, extentStatusEntry=extentStatusEntry, backupJobId=backupJobId, onBackupJobCompleted=onBackupJobCompleted, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, mountServerName=mountServerName, sessionId=sessionId, veeam=veeam, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, repositoryId=repositoryId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, onWinFLRMountStarted=onWinFLRMountStarted, extentStatus=extentStatus)
