...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:37:13 2024
...
iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, Bits, Counter64, NotificationType, Counter32, TimeTicks, Gauge32, Integer32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "Counter32", "TimeTicks", "Gauge32", "Integer32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointId=vmRestorePointId, extentName=extentName, backupJobResult=backupJobResult, sessionId=sessionId, targetHost=targetHost, cdpPolicyName=cdpPolicyName, repositoryId=repositoryId, initiatorName=initiatorName, mountServerName=mountServerName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, vmName=vmName, cdpRpoThreshold=cdpRpoThreshold, backup=backup, cdpMaxDelay=cdpMaxDelay, onWebDownloadStart=onWebDownloadStart, vmBackupComment=vmBackupComment, vmRestorePointCreationTime=vmRestorePointCreationTime, traps=traps, transferStatus=transferStatus, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, cdpSla=cdpSla, onCdpRpoReport=onCdpRpoReport, repositoryStatus=repositoryStatus, onVmBackupCompleted=onVmBackupCompleted, backupJobId=backupJobId, initiatorSid=initiatorSid, targetDir=targetDir, notTransferFileList=notTransferFileList, transferFileList=transferFileList, repositoryName=repositoryName, extentStatus=extentStatus, csvReportFilePath=csvReportFilePath, cdpRpoStatus=cdpRpoStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, products=products, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferTime=transferTime, onSobrOffloadFinished=onSobrOffloadFinished, extentStatusList=extentStatusList, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backupJobComment=backupJobComment, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onWinFLRMountStarted=onWinFLRMountStarted, veeam=veeam, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, sourceHostName=sourceHostName, onWebDownloadFinished=onWebDownloadFinished, vmBackupResult=vmBackupResult, extentStatusEntry=extentStatusEntry, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished)
