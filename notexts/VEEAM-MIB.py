...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:58:01 2021
...
Counter32, NotificationType, Gauge32, IpAddress, MibIdentifier, ObjectIdentity, Counter64, enterprises, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter64", "enterprises", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("VEEAM-MIB", transferFileList=transferFileList, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmBackupResult=vmBackupResult, traps=traps, onWebDownloadStart=onWebDownloadStart, extentStatusList=extentStatusList, mountServerName=mountServerName, extentName=extentName, backupJobId=backupJobId, vmBackupComment=vmBackupComment, onWinFLRMountStarted=onWinFLRMountStarted, cdpMaxDelay=cdpMaxDelay, onLinuxFLRMountStarted=onLinuxFLRMountStarted, repositoryStatus=repositoryStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, initiatorName=initiatorName, onVmBackupCompleted=onVmBackupCompleted, repositoryId=repositoryId, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobResult=backupJobResult, extentStatusEntry=extentStatusEntry, initiatorSid=initiatorSid, onWinFLRCopyToFinished=onWinFLRCopyToFinished, vmName=vmName, cdpPolicyName=cdpPolicyName, extentStatus=extentStatus, vmRestorePointId=vmRestorePointId, backup=backup, targetHost=targetHost, onBackupJobCompleted=onBackupJobCompleted, notTransferFileList=notTransferFileList, onWebDownloadFinished=onWebDownloadFinished, csvReportFilePath=csvReportFilePath, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onCdpRpoReport=onCdpRpoReport, targetDir=targetDir, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, transferTime=transferTime, products=products, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, transferStatus=transferStatus, repositoryName=repositoryName, backupJobName=backupJobName, onSobrOffloadFinished=onSobrOffloadFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobComment=backupJobComment, sessionId=sessionId, cdpRpoStatus=cdpRpoStatus, cdpRpoThreshold=cdpRpoThreshold, cdpSla=cdpSla, veeam=veeam, onWinFLRCopyToStarted=onWinFLRCopyToStarted, sourceHostName=sourceHostName)
