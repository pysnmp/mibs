...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:01:40 2023
...
TimeTicks, Gauge32, Bits, MibIdentifier, NotificationType, ModuleIdentity, enterprises, Integer32, NotificationType, ObjectIdentity, iso, Counter64, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Bits", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "Integer32", "NotificationType", "ObjectIdentity", "iso", "Counter64", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("VEEAM-MIB", repositoryStatus=repositoryStatus, veeam=veeam, targetDir=targetDir, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onBackupJobCompleted=onBackupJobCompleted, targetHost=targetHost, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, vmRestorePointId=vmRestorePointId, backupJobComment=backupJobComment, csvReportFilePath=csvReportFilePath, initiatorName=initiatorName, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, repositoryId=repositoryId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpMaxDelay=cdpMaxDelay, vmBackupComment=vmBackupComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, transferFileList=transferFileList, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, sourceHostName=sourceHostName, onWebDownloadStart=onWebDownloadStart, extentStatus=extentStatus, cdpSla=cdpSla, onVmBackupCompleted=onVmBackupCompleted, cdpRpoThreshold=cdpRpoThreshold, vmRestorePointCreationTime=vmRestorePointCreationTime, mountServerName=mountServerName, backupJobName=backupJobName, backupJobId=backupJobId, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupResult=vmBackupResult, repositoryName=repositoryName, products=products, extentStatusList=extentStatusList, traps=traps, extentName=extentName, transferTime=transferTime, extentStatusEntry=extentStatusEntry, cdpPolicyName=cdpPolicyName, backup=backup, sessionId=sessionId, initiatorSid=initiatorSid, cdpRpoStatus=cdpRpoStatus, backupJobResult=backupJobResult, vmName=vmName, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, notTransferFileList=notTransferFileList, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, transferStatus=transferStatus)
