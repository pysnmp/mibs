...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:13:39 2022
...
enterprises, NotificationType, Counter32, MibIdentifier, iso, Integer32, ObjectIdentity, IpAddress, Counter64, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "MibIdentifier", "iso", "Integer32", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmRestorePointId=vmRestorePointId, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpPolicyName=cdpPolicyName, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backupJobResult=backupJobResult, transferFileList=transferFileList, vmName=vmName, cdpMaxDelay=cdpMaxDelay, targetDir=targetDir, onWinFLRMountStarted=onWinFLRMountStarted, backup=backup, onVmBackupCompleted=onVmBackupCompleted, extentStatusEntry=extentStatusEntry, initiatorName=initiatorName, transferStatus=transferStatus, vmBackupComment=vmBackupComment, extentName=extentName, onBackupJobCompleted=onBackupJobCompleted, backupJobId=backupJobId, cdpRpoStatus=cdpRpoStatus, vmRestorePointCreationTime=vmRestorePointCreationTime, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, csvReportFilePath=csvReportFilePath, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadFinished=onWebDownloadFinished, onSobrOffloadFinished=onSobrOffloadFinished, backupJobComment=backupJobComment, transferTime=transferTime, targetHost=targetHost, onCdpRpoReport=onCdpRpoReport, extentStatusList=extentStatusList, sourceHostName=sourceHostName, cdpSla=cdpSla, backupJobName=backupJobName, sessionId=sessionId, extentStatus=extentStatus, mountServerName=mountServerName, onWebDownloadStart=onWebDownloadStart, notTransferFileList=notTransferFileList, traps=traps, veeam=veeam, repositoryStatus=repositoryStatus, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, initiatorSid=initiatorSid, repositoryName=repositoryName, onWinFLRCopyToStarted=onWinFLRCopyToStarted, products=products, cdpRpoThreshold=cdpRpoThreshold, repositoryId=repositoryId, vmBackupResult=vmBackupResult)
