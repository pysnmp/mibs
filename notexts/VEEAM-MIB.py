...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:25:39 2023
...
enterprises, Unsigned32, Counter32, ModuleIdentity, IpAddress, NotificationType, Counter64, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, iso, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "Counter64", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "iso", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VEEAM-MIB", onBackupJobCompleted=onBackupJobCompleted, cdpRpoStatus=cdpRpoStatus, products=products, onWebDownloadStart=onWebDownloadStart, transferStatus=transferStatus, cdpPolicyName=cdpPolicyName, backupJobName=backupJobName, extentStatus=extentStatus, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, backup=backup, repositoryStatus=repositoryStatus, repositoryName=repositoryName, veeam=veeam, onLinuxFLRMountStarted=onLinuxFLRMountStarted, onWinFLRCopyToStarted=onWinFLRCopyToStarted, extentStatusList=extentStatusList, cdpSla=cdpSla, cdpRpoThreshold=cdpRpoThreshold, targetDir=targetDir, sourceHostName=sourceHostName, vmBackupResult=vmBackupResult, traps=traps, transferTime=transferTime, initiatorSid=initiatorSid, csvReportFilePath=csvReportFilePath, backupJobId=backupJobId, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, backupJobResult=backupJobResult, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, cdpMaxDelay=cdpMaxDelay, sessionId=sessionId, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, repositoryId=repositoryId, onSobrOffloadFinished=onSobrOffloadFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, onWebDownloadFinished=onWebDownloadFinished, onCdpRpoReport=onCdpRpoReport, targetHost=targetHost, mountServerName=mountServerName, extentName=extentName, vmRestorePointCreationTime=vmRestorePointCreationTime, vmName=vmName, onVmBackupCompleted=onVmBackupCompleted, notTransferFileList=notTransferFileList, vmRestorePointId=vmRestorePointId, onWinFLRMountStarted=onWinFLRMountStarted, vmBackupComment=vmBackupComment, extentStatusEntry=extentStatusEntry, backupJobComment=backupJobComment, transferFileList=transferFileList, initiatorName=initiatorName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished)
