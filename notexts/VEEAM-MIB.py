...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:03:39 2024
...
ObjectIdentity, NotificationType, Integer32, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, enterprises, Counter64, iso, TimeTicks, Counter32, IpAddress, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "enterprises", "Counter64", "iso", "TimeTicks", "Counter32", "IpAddress", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", vmBackupResult=vmBackupResult, vmBackupComment=vmBackupComment, backup=backup, sessionId=sessionId, targetHost=targetHost, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, onWinFLRMountStarted=onWinFLRMountStarted, cdpMaxDelay=cdpMaxDelay, onWebDownloadFinished=onWebDownloadFinished, backupJobComment=backupJobComment, backupJobId=backupJobId, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, veeam=veeam, mountServerName=mountServerName, onCdpRpoReport=onCdpRpoReport, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, extentName=extentName, extentStatus=extentStatus, repositoryId=repositoryId, onBackupJobCompleted=onBackupJobCompleted, backupJobName=backupJobName, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, initiatorName=initiatorName, transferTime=transferTime, extentStatusList=extentStatusList, vmRestorePointCreationTime=vmRestorePointCreationTime, sourceHostName=sourceHostName, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, cdpPolicyName=cdpPolicyName, cdpRpoThreshold=cdpRpoThreshold, cdpRpoStatus=cdpRpoStatus, vmRestorePointId=vmRestorePointId, onSobrOffloadFinished=onSobrOffloadFinished, products=products, targetDir=targetDir, onVmBackupCompleted=onVmBackupCompleted, vmName=vmName, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished, onWebDownloadStart=onWebDownloadStart, initiatorSid=initiatorSid, repositoryName=repositoryName, notTransferFileList=notTransferFileList, cdpSla=cdpSla, onLinuxFLRMountStarted=onLinuxFLRMountStarted, traps=traps, backupJobResult=backupJobResult, transferStatus=transferStatus, transferFileList=transferFileList, onWinFLRCopyToStarted=onWinFLRCopyToStarted)
