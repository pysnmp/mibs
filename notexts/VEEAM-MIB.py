...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:27:52 2021
...
IpAddress, iso, Counter64, Gauge32, Bits, Integer32, NotificationType, ObjectIdentity, enterprises, MibIdentifier, TimeTicks, NotificationType, Counter32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Counter64", "Gauge32", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "enterprises", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VEEAM-MIB", targetHost=targetHost, onWinFLRToOriginalStarted=onWinFLRToOriginalStarted, notTransferFileList=notTransferFileList, extentStatusList=extentStatusList, sessionId=sessionId, cdpMaxDelay=cdpMaxDelay, initiatorName=initiatorName, products=products, backupJobName=backupJobName, initiatorSid=initiatorSid, traps=traps, sourceHostName=sourceHostName, backupJobId=backupJobId, transferStatus=transferStatus, extentStatusEntry=extentStatusEntry, csvReportFilePath=csvReportFilePath, repositoryId=repositoryId, cdpRpoStatus=cdpRpoStatus, cdpPolicyName=cdpPolicyName, backupJobComment=backupJobComment, onLinuxFLRCopyToStarted=onLinuxFLRCopyToStarted, onWinFLRMountStarted=onWinFLRMountStarted, extentName=extentName, extentStatus=extentStatus, onBackupJobCompleted=onBackupJobCompleted, mountServerName=mountServerName, onLinuxFLRMountStarted=onLinuxFLRMountStarted, backup=backup, onWinFLRToOriginalFinished=onWinFLRToOriginalFinished, cdpRpoThreshold=cdpRpoThreshold, transferTime=transferTime, vmRestorePointId=vmRestorePointId, targetDir=targetDir, vmName=vmName, repositoryName=repositoryName, onLinuxFLRToOriginalStarted=onLinuxFLRToOriginalStarted, onLinuxFLRCopyToFinished=onLinuxFLRCopyToFinished, onSobrOffloadFinished=onSobrOffloadFinished, onWebDownloadStart=onWebDownloadStart, vmBackupResult=vmBackupResult, vmRestorePointCreationTime=vmRestorePointCreationTime, cdpSla=cdpSla, backupJobResult=backupJobResult, onCdpRpoReport=onCdpRpoReport, onWebDownloadFinished=onWebDownloadFinished, veeam=veeam, onLinuxFLRToOriginalFinished=onLinuxFLRToOriginalFinished, onWinFLRCopyToStarted=onWinFLRCopyToStarted, vmBackupComment=vmBackupComment, transferFileList=transferFileList, onVmBackupCompleted=onVmBackupCompleted, repositoryStatus=repositoryStatus, onWinFLRCopyToFinished=onWinFLRCopyToFinished)
