...
NotificationType, ModuleIdentity, TimeTicks, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Gauge32, Counter32, MibIdentifier, IpAddress, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Gauge32", "Counter32", "MibIdentifier", "IpAddress", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEntry=dhcpPoolEntry, adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, system=system, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTable=dhcpLeaseTable, dns=dns, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, dhcpLeaseBindState=dhcpLeaseBindState, haService=haService, licenseValid=licenseValid, tftp=tftp, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, dnsDaemonRunning=dnsDaemonRunning, lcdDaemon=lcdDaemon, adonis=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsReferral=dnsStatsReferral, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpStats=dhcpStats, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, trapReplicationFailure=trapReplicationFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, dhcpSubnetTable=dhcpSubnetTable, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, PYSNMP_MODULE_ID=adonis, dhcpFixedIP=dhcpFixedIP, commandServerDaemon=commandServerDaemon, systemDaemon=systemDaemon, dhcp=dhcp, adonisTraps=adonisTraps, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, haServiceRunning=haServiceRunning, haServiceNodeType=haServiceNodeType, dhcpDaemon=dhcpDaemon, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsFailure=dnsStatsFailure, dhcpPoolTable=dhcpPoolTable, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, dnsStatsRecursion=dnsStatsRecursion, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStats=dnsStats, trapSystem=trapSystem, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDNS=trapDNS, dhcpFailOverState=dhcpFailOverState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, systemState=systemState, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNSDaemon=trapDNSDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry)
