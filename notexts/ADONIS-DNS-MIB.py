...
Counter32, Gauge32, Integer32, ObjectIdentity, ModuleIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, NotificationType, MibIdentifier, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Integer32", "ObjectIdentity", "ModuleIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "iso", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCP=trapDHCP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, adonisTraps=adonisTraps, dhcpFixedIP=dhcpFixedIP, dhcpIP=dhcpIP, adonis=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, trapCommandServer=trapCommandServer, haService=haService, dhcp=dhcp, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEntry=dhcpLeaseEntry, lcdDaemon=lcdDaemon, tftp=tftp, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolUsed=dhcpPoolUsed, dns=dns, trapTFTPDaemon=trapTFTPDaemon, systemState=systemState, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, trapTFTP=trapTFTP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemon=tftpDaemon, dhcpConfig=dhcpConfig, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, dnsStatsFailure=dnsStatsFailure, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEntry=dhcpPoolEntry, dnsDaemon=dnsDaemon, ha=ha, dhcpSubnetIP=dhcpSubnetIP, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonRunning=dnsDaemonRunning, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, PYSNMP_MODULE_ID=adonis, dnsStatsReferral=dnsStatsReferral, trapDNS=trapDNS, commandServerDaemon=commandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolTable=dhcpPoolTable, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, trapDNSDaemon=trapDNSDaemon, system=system, dhcpPoolSize=dhcpPoolSize, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, dnsStatsNXDomain=dnsStatsNXDomain, dnsStats=dnsStats, haServiceNodeType=haServiceNodeType, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseBindState=dhcpLeaseBindState, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess)
