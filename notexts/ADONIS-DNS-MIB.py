...
ModuleIdentity, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, iso, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, MibIdentifier, enterprises, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "MibIdentifier", "enterprises", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, dns=dns, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEntry=dhcpLeaseEntry, adonisTraps=adonisTraps, dnsDaemon=dnsDaemon, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonRunning=dnsDaemonRunning, lcd=lcd, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemState=systemState, commandServer=commandServer, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, haService=haService, haServiceRunning=haServiceRunning, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, dhcpFailOverState=dhcpFailOverState, dhcp=dhcp, dhcpStats=dhcpStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, trapReplicationFailure=trapReplicationFailure, systemDaemon=systemDaemon, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpIP=dhcpIP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftp=tftp, licenseValid=licenseValid, trapCommandServer=trapCommandServer, dnsStatsRecursion=dnsStatsRecursion, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEndIP=dhcpPoolEndIP, dnsStats=dnsStats, adonisObjects=adonisObjects, trapSystem=trapSystem)
