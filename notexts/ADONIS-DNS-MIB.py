...
Unsigned32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Counter64, MibIdentifier, iso, IpAddress, Gauge32, ModuleIdentity, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "iso", "IpAddress", "Gauge32", "ModuleIdentity", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolTable=dhcpPoolTable, dhcp=dhcp, trapHAServiceFailOver=trapHAServiceFailOver, licenseExpiry=licenseExpiry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolUsed=dhcpPoolUsed, tftpDaemon=tftpDaemon, licenseValid=licenseValid, dhcpIP=dhcpIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, trapCommandServer=trapCommandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, trapHA=trapHA, haServiceNodeType=haServiceNodeType, ha=ha, trapSystemDaemon=trapSystemDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, trapDNS=trapDNS, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFailOverState=dhcpFailOverState, haService=haService, dhcpPoolSize=dhcpPoolSize, haReplicationBinding=haReplicationBinding, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpStats=dhcpStats, dnsDaemon=dnsDaemon, commandServer=commandServer, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, trapDNSDaemon=trapDNSDaemon, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects, dhcpFixedIPTable=dhcpFixedIPTable, dhcpConfig=dhcpConfig, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, trapDHCP=trapDHCP, tftp=tftp, dns=dns, trapTFTP=trapTFTP, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIP=dhcpFixedIP, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonis=adonis, adonisTraps=adonisTraps, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, dnsStatsFailure=dnsStatsFailure, systemState=systemState, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, system=system, dnsStats=dnsStats, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetEntry=dhcpSubnetEntry, lcdDaemon=lcdDaemon, dhcpLeaseTable=dhcpLeaseTable, dnsStatsSuccess=dnsStatsSuccess, trapReplication=trapReplication, systemDaemon=systemDaemon, dhcpDaemon=dhcpDaemon, commandServerDaemonRunning=commandServerDaemonRunning)
