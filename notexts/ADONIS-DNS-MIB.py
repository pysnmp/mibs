...
Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, enterprises, NotificationType, MibIdentifier, TimeTicks, Bits, ObjectIdentity, Counter64, Unsigned32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "enterprises", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTable=dhcpLeaseTable, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, haReplicationBinding=haReplicationBinding, tftpDaemonRunning=tftpDaemonRunning, system=system, PYSNMP_MODULE_ID=adonis, dhcpPoolSize=dhcpPoolSize, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolEndIP=dhcpPoolEndIP, licenseValid=licenseValid, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetMask=dhcpSubnetMask, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haService=haService, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisObjects=adonisObjects, trapDHCPDaemon=trapDHCPDaemon, licenseExpiry=licenseExpiry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, haServiceRunning=haServiceRunning, dhcpFailOverState=dhcpFailOverState, dnsStatsFailure=dnsStatsFailure, lcd=lcd, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, dns=dns, trapSystemDaemon=trapSystemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dhcpStats=dhcpStats, dhcpFixedIP=dhcpFixedIP, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, commandServer=commandServer, adonis=adonis, dnsStats=dnsStats, adonisTraps=adonisTraps, haServiceNodeType=haServiceNodeType, dnsDaemonRunning=dnsDaemonRunning, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, trapReplicationFailure=trapReplicationFailure, dhcpLeaseHostname=dhcpLeaseHostname, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapReplication=trapReplication, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, ha=ha, trapSystem=trapSystem, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, trapHA=trapHA, dhcp=dhcp, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseStartTime=dhcpLeaseStartTime)
