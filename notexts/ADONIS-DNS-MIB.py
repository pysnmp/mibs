...
ObjectIdentity, enterprises, ModuleIdentity, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Bits, MibIdentifier, Integer32, Counter32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "ModuleIdentity", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Bits", "MibIdentifier", "Integer32", "Counter32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, systemDaemon=systemDaemon, licenseExpiry=licenseExpiry, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, trapReplication=trapReplication, lcd=lcd, commandServerDaemon=commandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemon=dhcpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCP=trapDHCP, dhcpStats=dhcpStats, PYSNMP_MODULE_ID=adonis, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetTable=dhcpSubnetTable, dnsStats=dnsStats, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsFailure=dnsStatsFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolUsed=dhcpPoolUsed, haService=haService, dnsDaemon=dnsDaemon, adonisTraps=adonisTraps, lcdDaemon=lcdDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, dhcpSubnetMask=dhcpSubnetMask, tftpDaemon=tftpDaemon, dhcpFailOverState=dhcpFailOverState, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, dnsStatsRecursion=dnsStatsRecursion, trapTFTP=trapTFTP, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, system=system, trapSystemDaemon=trapSystemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplicationFailure=trapReplicationFailure, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolTable=dhcpPoolTable, trapCommandServerDaemon=trapCommandServerDaemon, adonisObjects=adonisObjects, ha=ha, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftp=tftp, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolSize=dhcpPoolSize, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpConfig=dhcpConfig, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsReferral=dnsStatsReferral, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolAlert=dhcpPoolAlert, dns=dns, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState)
