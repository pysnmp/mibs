...
Gauge32, MibIdentifier, Unsigned32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Bits, TimeTicks, Counter32, enterprises, iso, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Bits", "TimeTicks", "Counter32", "enterprises", "iso", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServer=trapCommandServer, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpIP=dhcpIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsReferral=dnsStatsReferral, dnsStats=dnsStats, ha=ha, trapReplicationFailure=trapReplicationFailure, dhcpConfig=dhcpConfig, trapDNS=trapDNS, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, dhcp=dhcp, dhcpPoolTable=dhcpPoolTable, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPEntry=dhcpFixedIPEntry, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, adonis=adonis, tftp=tftp, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, commandServer=commandServer, licenseExpiry=licenseExpiry, trapDHCP=trapDHCP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, haReplicationBinding=haReplicationBinding, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, dhcpPoolSize=dhcpPoolSize, tftpDaemonRunning=tftpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, system=system, dhcpStats=dhcpStats, dhcpFailOverState=dhcpFailOverState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, adonisTraps=adonisTraps, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXDomain=dnsStatsNXDomain, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, licenseValid=licenseValid, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTP=trapTFTP, tftpDaemon=tftpDaemon, haServiceNodeType=haServiceNodeType, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolUsed=dhcpPoolUsed, trapSystem=trapSystem, dhcpDaemon=dhcpDaemon)
