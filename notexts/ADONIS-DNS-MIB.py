...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter32, enterprises, TimeTicks, Integer32, Counter64, Bits, Gauge32, iso, ModuleIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter32", "enterprises", "TimeTicks", "Integer32", "Counter64", "Bits", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpIP=dhcpIP, adonisTraps=adonisTraps, dhcpSubnetUsed=dhcpSubnetUsed, tftp=tftp, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonRunning=dhcpDaemonRunning, trapDNS=trapDNS, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplication=trapReplication, dnsStatsSuccess=dnsStatsSuccess, trapCommandServer=trapCommandServer, dhcpPoolTable=dhcpPoolTable, dnsStatsFailure=dnsStatsFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetIP=dhcpSubnetIP, adonis=adonis, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, licenseValid=licenseValid, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemon=commandServerDaemon, tftpDaemon=tftpDaemon, trapHA=trapHA, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemon=dhcpDaemon, dns=dns, dnsStatsRecursion=dnsStatsRecursion, systemDaemon=systemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcdDaemon=lcdDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFailOverState=dhcpFailOverState, ha=ha, system=system, dhcpConfig=dhcpConfig, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, haService=haService, dhcpSubnetSize=dhcpSubnetSize, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, adonisObjects=adonisObjects, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEntry=dhcpLeaseEntry, dhcp=dhcp, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, haServiceRunning=haServiceRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, dnsDaemon=dnsDaemon, trapDHCP=trapDHCP, dnsStatsReferral=dnsStatsReferral, dhcpSubnetTable=dhcpSubnetTable, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, systemState=systemState, trapSystemDaemon=trapSystemDaemon, licenseExpiry=licenseExpiry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, lcd=lcd, trapReplicationFailure=trapReplicationFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry)
