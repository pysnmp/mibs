...
IpAddress, MibIdentifier, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, Counter64, enterprises, ModuleIdentity, NotificationType, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "Counter64", "enterprises", "ModuleIdentity", "NotificationType", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, dnsDaemonRunning=dnsDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpPoolSize=dhcpPoolSize, trapSystem=trapSystem, dnsStatsFailure=dnsStatsFailure, adonisTraps=adonisTraps, systemDaemon=systemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, tftpDaemonRunning=tftpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServerDaemon=trapCommandServerDaemon, adonisObjects=adonisObjects, trapHA=trapHA, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, lcdDaemon=lcdDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpIP=dhcpIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpStats=dhcpStats, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetMask=dhcpSubnetMask, haService=haService, PYSNMP_MODULE_ID=adonis, dnsStatsReferral=dnsStatsReferral, dnsStats=dnsStats, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServer=trapCommandServer, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, dhcpPoolTable=dhcpPoolTable, tftpDaemon=tftpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseEndTime=dhcpLeaseEndTime, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, dhcp=dhcp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolUsed=dhcpPoolUsed, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, systemState=systemState, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDNS=trapDNS, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, licenseExpiry=licenseExpiry, trapTFTP=trapTFTP, tftp=tftp, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, haReplicationBinding=haReplicationBinding, dhcpFixedIP=dhcpFixedIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServerDaemon=commandServerDaemon, trapReplication=trapReplication, trapSystemDaemon=trapSystemDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetUsed=dhcpSubnetUsed)
