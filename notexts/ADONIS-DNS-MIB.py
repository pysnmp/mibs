...
Counter32, Gauge32, MibIdentifier, TimeTicks, enterprises, ObjectIdentity, IpAddress, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "TimeTicks", "enterprises", "ObjectIdentity", "IpAddress", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, licenseValid=licenseValid, haService=haService, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHostname=dhcpLeaseHostname, haReplicationBinding=haReplicationBinding, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetMask=dhcpSubnetMask, adonisTraps=adonisTraps, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystem=trapSystem, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, lcd=lcd, tftpDaemon=tftpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, systemState=systemState, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseStartTime=dhcpLeaseStartTime, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolTable=dhcpPoolTable, lcdDaemon=lcdDaemon, trapDNS=trapDNS, dhcpFixedIP=dhcpFixedIP, dnsStatsReferral=dnsStatsReferral, dns=dns, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseExpiry=licenseExpiry, adonisObjects=adonisObjects, trapReplication=trapReplication, dhcp=dhcp, dhcpConfig=dhcpConfig, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, haServiceRunning=haServiceRunning, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, system=system, dhcpStats=dhcpStats, PYSNMP_MODULE_ID=adonis, ha=ha, adonis=adonis, dnsStatsRecursion=dnsStatsRecursion, commandServerDaemon=commandServerDaemon, trapSystemDaemon=trapSystemDaemon)
