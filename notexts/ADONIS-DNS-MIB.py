...
ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ModuleIdentity, Counter32, enterprises, IpAddress, Gauge32, MibIdentifier, NotificationType, iso, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemon=tftpDaemon, trapReplication=trapReplication, dhcpFixedIPTable=dhcpFixedIPTable, dhcpIP=dhcpIP, haReplicationBinding=haReplicationBinding, dhcpSubnetTable=dhcpSubnetTable, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolAlert=dhcpPoolAlert, trapDNSDaemon=trapDNSDaemon, trapDNS=trapDNS, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemon=dnsDaemon, haService=haService, adonisTraps=adonisTraps, tftpDaemonRunning=tftpDaemonRunning, PYSNMP_MODULE_ID=adonis, haServiceNodeType=haServiceNodeType, dhcpPoolEntry=dhcpPoolEntry, trapCommandServer=trapCommandServer, commandServerDaemon=commandServerDaemon, trapSystem=trapSystem, trapDHCPDaemon=trapDHCPDaemon, trapTFTPDaemon=trapTFTPDaemon, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, dns=dns, dhcpSubnetIP=dhcpSubnetIP, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, adonisObjects=adonisObjects, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpStats=dhcpStats, system=system, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, adonis=adonis, licenseExpiry=licenseExpiry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, licenseValid=licenseValid, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemState=systemState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP)
