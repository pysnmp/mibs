...
TimeTicks, IpAddress, Gauge32, enterprises, ObjectIdentity, Counter64, iso, Counter32, MibIdentifier, Integer32, Unsigned32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Gauge32", "enterprises", "ObjectIdentity", "Counter64", "iso", "Counter32", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsFailure=dnsStatsFailure, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCPDaemon=trapDHCPDaemon, dhcpFailOverState=dhcpFailOverState, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, adonisTraps=adonisTraps, dnsDaemon=dnsDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, dnsStats=dnsStats, systemState=systemState, dnsStatsNXDomain=dnsStatsNXDomain, trapDNS=trapDNS, adonis=adonis, dnsStatsReferral=dnsStatsReferral, haReplicationBinding=haReplicationBinding, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolTable=dhcpPoolTable, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEndTime=dhcpLeaseEndTime, system=system, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetAlert=dhcpSubnetAlert, licenseExpiry=licenseExpiry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemon=tftpDaemon, licenseValid=licenseValid, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemon=dhcpDaemon, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, dhcpLeaseTable=dhcpLeaseTable, lcdDaemon=lcdDaemon, trapReplication=trapReplication, trapHA=trapHA, adonisObjects=adonisObjects, trapReplicationFailure=trapReplicationFailure, trapDHCP=trapDHCP, lcd=lcd, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dhcpIP=dhcpIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftp=tftp, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, trapSystem=trapSystem, dhcp=dhcp, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, haService=haService, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon)
