...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemonRunning=commandServerDaemonRunning, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemon=commandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, systemDaemon=systemDaemon, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, PYSNMP_MODULE_ID=adonis, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, trapDHCP=trapDHCP, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNS=trapDNS, trapDHCPDaemon=trapDHCPDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpStats=dhcpStats, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, dhcpConfig=dhcpConfig, haService=haService, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetIP=dhcpSubnetIP, ha=ha, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsReferral=dnsStatsReferral, adonisObjects=adonisObjects, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetAlert=dhcpSubnetAlert, haServiceNodeType=haServiceNodeType, systemState=systemState, dnsDaemon=dnsDaemon, dhcp=dhcp, adonis=adonis, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolUsed=dhcpPoolUsed, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIP=dhcpFixedIP, trapReplication=trapReplication, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, lcd=lcd, trapCommandServer=trapCommandServer, haReplicationBinding=haReplicationBinding, adonisTraps=adonisTraps, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, trapDNSDaemon=trapDNSDaemon, dhcpSubnetSize=dhcpSubnetSize, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, dnsStats=dnsStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones)
