...
Integer32, Unsigned32, Counter64, ObjectIdentity, enterprises, iso, TimeTicks, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "enterprises", "iso", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, system=system, dnsStatsReferral=dnsStatsReferral, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseExpiry=licenseExpiry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, trapDNSDaemon=trapDNSDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, haReplicationBinding=haReplicationBinding, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemon=dhcpDaemon, dhcpPoolTable=dhcpPoolTable, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, ha=ha, systemState=systemState, lcdDaemon=lcdDaemon, systemDaemon=systemDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, dhcpFixedIP=dhcpFixedIP, dhcpConfig=dhcpConfig, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolEntry=dhcpPoolEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCP=trapDHCP, dhcp=dhcp, dhcpSubnetUsed=dhcpSubnetUsed, trapReplicationFailure=trapReplicationFailure, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, trapCommandServer=trapCommandServer, trapDNS=trapDNS, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftp=tftp, haService=haService, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemon=dnsDaemon, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, tftpDaemon=tftpDaemon, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapSystem=trapSystem, adonisTraps=adonisTraps, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcd=lcd, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, dnsStatsRecursion=dnsStatsRecursion, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, haServiceRunning=haServiceRunning, dhcpStats=dhcpStats, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis)
