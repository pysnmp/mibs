...
Integer32, MibIdentifier, ObjectIdentity, IpAddress, NotificationType, Counter32, enterprises, Gauge32, Bits, Counter64, TimeTicks, Unsigned32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "enterprises", "Gauge32", "Bits", "Counter64", "TimeTicks", "Unsigned32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haReplicationBinding=haReplicationBinding, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, adonisObjects=adonisObjects, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, tftp=tftp, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemon=dhcpDaemon, ha=ha, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolUsed=dhcpPoolUsed, dnsDaemon=dnsDaemon, haServiceNodeType=haServiceNodeType, PYSNMP_MODULE_ID=adonis, trapSystem=trapSystem, system=system, dnsStatsFailure=dnsStatsFailure, tftpDaemon=tftpDaemon, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolStartIP=dhcpPoolStartIP, trapReplication=trapReplication, dhcpSubnetIP=dhcpSubnetIP, haService=haService, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, systemDaemon=systemDaemon, commandServer=commandServer, dhcpIP=dhcpIP, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, systemState=systemState, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, licenseValid=licenseValid, lcdDaemon=lcdDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, trapDNS=trapDNS, trapDNSDaemon=trapDNSDaemon, dnsStatsReferral=dnsStatsReferral, dns=dns, dhcpFixedIP=dhcpFixedIP, dhcp=dhcp, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, trapHA=trapHA, lcd=lcd, trapReplicationFailure=trapReplicationFailure, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServerDaemon=trapCommandServerDaemon, haServiceRunning=haServiceRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapCommandServer=trapCommandServer, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, trapDHCPDaemon=trapDHCPDaemon)
