...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, dnsStatsSuccess=dnsStatsSuccess, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, trapDHCP=trapDHCP, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, haServiceRunning=haServiceRunning, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisObjects=adonisObjects, dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcd=lcd, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpIP=dhcpIP, licenseValid=licenseValid, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemDaemon=systemDaemon, commandServerDaemon=commandServerDaemon, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, dns=dns, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetAlert=dhcpSubnetAlert, trapCommandServer=trapCommandServer, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, dhcpStats=dhcpStats, licenseExpiry=licenseExpiry, systemState=systemState, trapSystemDaemon=trapSystemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, trapHA=trapHA, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dnsDaemon=dnsDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, tftp=tftp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolUsed=dhcpPoolUsed, lcdDaemon=lcdDaemon, trapSystem=trapSystem, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, dhcpPoolTable=dhcpPoolTable, ha=ha, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, dnsStats=dnsStats, haService=haService, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSubnetIP=dhcpPoolSubnetIP)
