...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, dnsStatsReferral=dnsStatsReferral, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, licenseValid=licenseValid, dhcpFixedIPTable=dhcpFixedIPTable, PYSNMP_MODULE_ID=adonis, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemon=dhcpDaemon, dnsDaemonRunning=dnsDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, adonis=adonis, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpConfig=dhcpConfig, systemState=systemState, haServiceRunning=haServiceRunning, dhcpPoolTable=dhcpPoolTable, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHA=trapHA, trapSystemDaemon=trapSystemDaemon, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, trapReplication=trapReplication, dhcpPoolUsed=dhcpPoolUsed, lcd=lcd, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system, dns=dns, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServerDaemon=commandServerDaemon, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, trapCommandServer=trapCommandServer, adonisObjects=adonisObjects, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEntry=dhcpPoolEntry, tftp=tftp, dhcpLeaseTable=dhcpLeaseTable, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpPoolSize=dhcpPoolSize, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, dhcpIP=dhcpIP, ha=ha)
