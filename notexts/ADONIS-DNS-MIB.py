...
Unsigned32, iso, Counter32, Integer32, Gauge32, MibIdentifier, Bits, NotificationType, Counter64, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter32", "Integer32", "Gauge32", "MibIdentifier", "Bits", "NotificationType", "Counter64", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, ha=ha, trapDNSDaemon=trapDNSDaemon, dhcpSubnetUsed=dhcpSubnetUsed, adonisObjects=adonisObjects, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFailOverState=dhcpFailOverState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolEntry=dhcpPoolEntry, lcd=lcd, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, systemDaemon=systemDaemon, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcp=dhcp, dhcpLeaseStartTime=dhcpLeaseStartTime, systemState=systemState, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState, haReplicationBinding=haReplicationBinding, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, system=system, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsFailure=dnsStatsFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetTable=dhcpSubnetTable, trapCommandServerDaemon=trapCommandServerDaemon, tftp=tftp, commandServer=commandServer, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, trapHA=trapHA, dhcpIP=dhcpIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, dns=dns, trapCommandServer=trapCommandServer, trapDHCP=trapDHCP, dhcpConfig=dhcpConfig, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, licenseValid=licenseValid, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonis=adonis, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones)
