...
iso, MibIdentifier, ObjectIdentity, Counter32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Unsigned32, Bits, enterprises, IpAddress, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Unsigned32", "Bits", "enterprises", "IpAddress", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsFailure=dnsStatsFailure, lcdDaemon=lcdDaemon, haServiceNodeType=haServiceNodeType, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, trapCommandServer=trapCommandServer, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, dhcpLeaseHostname=dhcpLeaseHostname, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsReferral=dnsStatsReferral, dns=dns, PYSNMP_MODULE_ID=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, trapDNS=trapDNS, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFailOverState=dhcpFailOverState, trapSystem=trapSystem, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, dhcpIP=dhcpIP, dhcpConfig=dhcpConfig, commandServerDaemonRunning=commandServerDaemonRunning, lcd=lcd, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCPDaemon=trapDHCPDaemon, commandServer=commandServer, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStats=dnsStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolTable=dhcpPoolTable, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceRunning=haServiceRunning, dhcpStats=dhcpStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haService=haService, dnsDaemon=dnsDaemon, tftp=tftp, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, licenseValid=licenseValid, tftpDaemon=tftpDaemon, system=system, trapHA=trapHA, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, systemDaemon=systemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemState=systemState, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIP=dhcpFixedIP, dnsStatsSuccess=dnsStatsSuccess, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects)
