...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, ModuleIdentity, IpAddress, MibIdentifier, Counter64, TimeTicks, Counter32, Unsigned32, NotificationType, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "TimeTicks", "Counter32", "Unsigned32", "NotificationType", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, licenseExpiry=licenseExpiry, system=system, haServiceRunning=haServiceRunning, dhcpFixedIP=dhcpFixedIP, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, systemDaemon=systemDaemon, adonis=adonis, dhcpSubnetSize=dhcpSubnetSize, dhcpFailOverState=dhcpFailOverState, dhcpSubnetUsed=dhcpSubnetUsed, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapSystemDaemon=trapSystemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapSystem=trapSystem, dhcpSubnetAlert=dhcpSubnetAlert, adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, commandServer=commandServer, dhcpDaemon=dhcpDaemon, dhcpSubnetTable=dhcpSubnetTable, trapHA=trapHA, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolTable=dhcpPoolTable, lcd=lcd, trapDNS=trapDNS, ha=ha, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, dns=dns, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, haServiceNodeType=haServiceNodeType, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, dhcpLeaseTable=dhcpLeaseTable, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNSDaemon=trapDNSDaemon, dnsStats=dnsStats, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapReplication=trapReplication, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpIP=dhcpIP, dhcpStats=dhcpStats, tftp=tftp, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServerDaemon=trapCommandServerDaemon, licenseValid=licenseValid, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haService=haService, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpConfig=dhcpConfig, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEntry=dhcpPoolEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapTFTP=trapTFTP)
