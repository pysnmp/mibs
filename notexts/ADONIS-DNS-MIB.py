...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcdDaemon=lcdDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetMask=dhcpSubnetMask, dns=dns, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonis=adonis, systemDaemon=systemDaemon, dhcpDaemon=dhcpDaemon, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTP=trapTFTP, dnsStats=dnsStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState, dhcpConfig=dhcpConfig, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetSize=dhcpSubnetSize, commandServerDaemon=commandServerDaemon, haServiceNodeType=haServiceNodeType, systemState=systemState, licenseExpiry=licenseExpiry, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHA=trapHA, tftp=tftp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsFailure=dnsStatsFailure, adonisObjects=adonisObjects, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, trapSystem=trapSystem, trapDNS=trapDNS, tftpDaemon=tftpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcp=dhcp, adonisTraps=adonisTraps, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, system=system, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, haServiceRunning=haServiceRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonRunning=dnsDaemonRunning, commandServer=commandServer, ha=ha, lcd=lcd, haReplicationBinding=haReplicationBinding, dhcpStats=dhcpStats, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFailOverState=dhcpFailOverState, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, tftpDaemonRunning=tftpDaemonRunning)
