...
ModuleIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, NotificationType, IpAddress, Bits, MibIdentifier, Unsigned32, Counter64, ObjectIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "NotificationType", "IpAddress", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetTable=dhcpSubnetTable, dhcpStats=dhcpStats, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dhcpIP=dhcpIP, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, licenseExpiry=licenseExpiry, PYSNMP_MODULE_ID=adonis, dnsStatsNXDomain=dnsStatsNXDomain, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpConfig=dhcpConfig, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTable=dhcpLeaseTable, trapDNS=trapDNS, dhcp=dhcp, system=system, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, trapReplication=trapReplication, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHAServiceFailOver=trapHAServiceFailOver, dns=dns, trapCommandServerDaemon=trapCommandServerDaemon, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, adonisTraps=adonisTraps, trapHA=trapHA, systemState=systemState, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIP=dhcpFixedIP, dnsStatsFailure=dnsStatsFailure, dhcpPoolEndIP=dhcpPoolEndIP, tftp=tftp, haService=haService, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonRunning=dnsDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, trapReplicationFailure=trapReplicationFailure, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSize=dhcpPoolSize, trapCommandServer=trapCommandServer, dhcpPoolTable=dhcpPoolTable, lcdDaemon=lcdDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, ha=ha, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceNodeType=haServiceNodeType, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStats=dnsStats, adonis=adonis)
