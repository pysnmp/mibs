...
IpAddress, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, iso, Bits, Counter32, MibIdentifier, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "iso", "Bits", "Counter32", "MibIdentifier", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemonRunning=commandServerDaemonRunning, PYSNMP_MODULE_ID=adonis, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetSize=dhcpSubnetSize, licenseValid=licenseValid, dnsStatsReferral=dnsStatsReferral, commandServer=commandServer, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, trapHA=trapHA, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd, trapReplicationFailure=trapReplicationFailure, trapCommandServerDaemon=trapCommandServerDaemon, dns=dns, lcdDaemon=lcdDaemon, tftp=tftp, adonisObjects=adonisObjects, adonisTraps=adonisTraps, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpConfig=dhcpConfig, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemon=dhcpDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetIP=dhcpSubnetIP, ha=ha, haServiceRunning=haServiceRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIP=dhcpFixedIP, systemDaemon=systemDaemon, trapDHCP=trapDHCP, system=system, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetMask=dhcpSubnetMask, dhcpStats=dhcpStats, trapReplication=trapReplication, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcp=dhcp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, trapTFTP=trapTFTP, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEntry=dhcpPoolEntry, trapSystemDaemon=trapSystemDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftpDaemon=tftpDaemon, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState)
