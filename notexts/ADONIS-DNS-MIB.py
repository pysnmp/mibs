...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, haReplicationBinding=haReplicationBinding, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceNodeType=haServiceNodeType, adonisTraps=adonisTraps, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStats=dnsStats, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, systemDaemon=systemDaemon, adonisObjects=adonisObjects, systemState=systemState, ha=ha, dhcpLeaseHostname=dhcpLeaseHostname, adonis=adonis, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpConfig=dhcpConfig, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, dnsDaemon=dnsDaemon, lcdDaemon=lcdDaemon, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dns=dns, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcp=dhcp, dhcpStats=dhcpStats, licenseValid=licenseValid, lcd=lcd, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer, trapReplicationFailure=trapReplicationFailure, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsRecursion=dnsStatsRecursion, trapDNSDaemon=trapDNSDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, trapSystem=trapSystem, trapSystemDaemon=trapSystemDaemon, trapDNS=trapDNS, dhcpSubnetSize=dhcpSubnetSize, haService=haService, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning)
