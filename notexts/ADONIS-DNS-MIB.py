...
Gauge32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, ModuleIdentity, NotificationType, iso, MibIdentifier, Counter64, ObjectIdentity, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "MibIdentifier", "Counter64", "ObjectIdentity", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, dnsDaemonRunning=dnsDaemonRunning, dnsStats=dnsStats, dhcpPoolEntry=dhcpPoolEntry, dhcpFailOverState=dhcpFailOverState, dhcpConfig=dhcpConfig, dns=dns, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHA=trapHA, adonis=adonis, dhcpPoolUsed=dhcpPoolUsed, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetEntry=dhcpSubnetEntry, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, systemState=systemState, adonisTraps=adonisTraps, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, systemDaemon=systemDaemon, adonisObjects=adonisObjects, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, trapDNSDaemon=trapDNSDaemon, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsFailure=dnsStatsFailure, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServer=trapCommandServer, ha=ha, haReplicationBinding=haReplicationBinding, trapDNS=trapDNS, trapReplicationFailure=trapReplicationFailure, commandServerDaemon=commandServerDaemon, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemon=dnsDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetTable=dhcpSubnetTable, dhcpIP=dhcpIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCP=trapDHCP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceRunning=haServiceRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, trapReplication=trapReplication, licenseValid=licenseValid, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, system=system, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp)
