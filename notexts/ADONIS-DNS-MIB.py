...
IpAddress, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, enterprises, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "enterprises", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemonRunning=commandServerDaemonRunning, dns=dns, tftp=tftp, lcd=lcd, dnsStatsFailure=dnsStatsFailure, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapReplicationFailure=trapReplicationFailure, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, tftpDaemonRunning=tftpDaemonRunning, haServiceNodeType=haServiceNodeType, systemState=systemState, trapDHCP=trapDHCP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, dhcpStats=dhcpStats, dhcpIP=dhcpIP, adonisObjects=adonisObjects, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS, dhcpFailOverState=dhcpFailOverState, dnsDaemon=dnsDaemon, haService=haService, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, systemDaemon=systemDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpConfig=dhcpConfig, licenseExpiry=licenseExpiry, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystemDaemon=trapSystemDaemon, lcdDaemon=lcdDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNSDaemon=trapDNSDaemon, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, trapCommandServerDaemon=trapCommandServerDaemon, dhcp=dhcp, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, dnsStats=dnsStats, commandServerDaemon=commandServerDaemon, adonis=adonis, trapReplication=trapReplication, adonisTraps=adonisTraps, dhcpLeaseTable=dhcpLeaseTable, PYSNMP_MODULE_ID=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsRecursion=dnsStatsRecursion, ha=ha, tftpDaemon=tftpDaemon, dhcpFixedIP=dhcpFixedIP, dhcpPoolSize=dhcpPoolSize, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemon=dhcpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServer=commandServer, trapHA=trapHA, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState)
