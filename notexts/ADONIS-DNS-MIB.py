...
NotificationType, Unsigned32, Counter64, MibIdentifier, ModuleIdentity, Integer32, iso, Counter32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "MibIdentifier", "ModuleIdentity", "Integer32", "iso", "Counter32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, haReplicationBinding=haReplicationBinding, dnsStats=dnsStats, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapReplication=trapReplication, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, dns=dns, lcdDaemon=lcdDaemon, adonisObjects=adonisObjects, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, adonis=adonis, haService=haService, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, system=system, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, trapCommandServer=trapCommandServer, dhcpPoolSize=dhcpPoolSize, adonisTraps=adonisTraps, trapReplicationFailure=trapReplicationFailure, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsFailure=dnsStatsFailure, dhcpPoolTable=dhcpPoolTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, haServiceNodeType=haServiceNodeType, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, tftpDaemonRunning=tftpDaemonRunning, licenseExpiry=licenseExpiry, ha=ha, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftp=tftp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, lcd=lcd, trapCommandServerDaemon=trapCommandServerDaemon, dhcp=dhcp, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftpDaemon=tftpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState)
