...
ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, iso, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64, TimeTicks, enterprises, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "iso", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64", "TimeTicks", "enterprises", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolSize=dhcpPoolSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, ha=ha, dnsStatsNXDomain=dnsStatsNXDomain, licenseValid=licenseValid, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, systemState=systemState, tftpDaemon=tftpDaemon, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, haService=haService, PYSNMP_MODULE_ID=adonis, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolTable=dhcpPoolTable, lcd=lcd, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolEntry=dhcpPoolEntry, dns=dns, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTP=trapTFTP, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCP=trapDHCP, dhcpPoolUsed=dhcpPoolUsed, adonis=adonis, dhcpLeaseHostname=dhcpLeaseHostname, trapDNSDaemon=trapDNSDaemon, dnsStatsFailure=dnsStatsFailure, haReplicationBinding=haReplicationBinding, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpStats=dhcpStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPTable=dhcpFixedIPTable, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, adonisTraps=adonisTraps, commandServer=commandServer, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIP=dhcpFixedIP, adonisObjects=adonisObjects, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, dnsStats=dnsStats, dhcp=dhcp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, system=system, trapReplication=trapReplication, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetTable=dhcpSubnetTable, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, trapSystem=trapSystem, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, dhcpSubnetIP=dhcpSubnetIP)
