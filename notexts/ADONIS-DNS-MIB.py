...
Gauge32, TimeTicks, Unsigned32, IpAddress, Counter64, Bits, MibIdentifier, Counter32, enterprises, ObjectIdentity, ModuleIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "Counter64", "Bits", "MibIdentifier", "Counter32", "enterprises", "ObjectIdentity", "ModuleIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapDNSDaemon=trapDNSDaemon, licenseExpiry=licenseExpiry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemon=dhcpDaemon, commandServer=commandServer, dhcpSubnetUsed=dhcpSubnetUsed, systemState=systemState, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplicationFailure=trapReplicationFailure, dnsStats=dnsStats, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolAlert=dhcpPoolAlert, dnsDaemon=dnsDaemon, lcd=lcd, tftpDaemon=tftpDaemon, tftp=tftp, trapCommandServer=trapCommandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpStats=dhcpStats, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, adonis=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, trapHA=trapHA, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, ha=ha, dhcpIP=dhcpIP, dnsStatsSuccess=dnsStatsSuccess, lcdDaemon=lcdDaemon, haServiceRunning=haServiceRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseValid=licenseValid, adonisObjects=adonisObjects, haService=haService, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, adonisTraps=adonisTraps, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetTable=dhcpSubnetTable, trapDNS=trapDNS, dhcpFailOverState=dhcpFailOverState, trapTFTP=trapTFTP, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcp=dhcp, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, PYSNMP_MODULE_ID=adonis, trapSystem=trapSystem, dhcpLeaseEndTime=dhcpLeaseEndTime, dns=dns, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, system=system, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHAServiceFailOver=trapHAServiceFailOver)
