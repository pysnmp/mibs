...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcp=dhcp, trapReplicationFailure=trapReplicationFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolAlert=dhcpPoolAlert, lcd=lcd, trapSystemDaemon=trapSystemDaemon, dhcpPoolEndIP=dhcpPoolEndIP, trapDNSDaemon=trapDNSDaemon, licenseValid=licenseValid, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, adonis=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHAServiceFailOver=trapHAServiceFailOver, trapDNS=trapDNS, ha=ha, trapDHCP=trapDHCP, dhcpSubnetMask=dhcpSubnetMask, trapHA=trapHA, dhcpDaemonRunning=dhcpDaemonRunning, dhcpIP=dhcpIP, trapTFTP=trapTFTP, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, adonisObjects=adonisObjects, haService=haService, dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemonRunning=commandServerDaemonRunning, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemon=dnsDaemon, tftp=tftp, PYSNMP_MODULE_ID=adonis, trapReplication=trapReplication, licenseExpiry=licenseExpiry, systemState=systemState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceRunning=haServiceRunning, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIP=dhcpFixedIP, dhcpSubnetTable=dhcpSubnetTable, tftpDaemon=tftpDaemon, adonisTraps=adonisTraps, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStats=dnsStats, dhcpPoolTable=dhcpPoolTable, dnsStatsReferral=dnsStatsReferral, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP)
