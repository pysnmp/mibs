...
NotificationType, TimeTicks, Counter64, ModuleIdentity, Counter32, Bits, ObjectIdentity, Gauge32, enterprises, Unsigned32, iso, IpAddress, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter64", "ModuleIdentity", "Counter32", "Bits", "ObjectIdentity", "Gauge32", "enterprises", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, dnsStatsFailure=dnsStatsFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHostname=dhcpLeaseHostname, commandServer=commandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetSize=dhcpSubnetSize, trapTFTP=trapTFTP, commandServerDaemon=commandServerDaemon, trapHA=trapHA, licenseExpiry=licenseExpiry, haServiceNodeType=haServiceNodeType, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, dhcpDaemon=dhcpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetMask=dhcpSubnetMask, tftpDaemon=tftpDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haService=haService, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEntry=dhcpPoolEntry, system=system, dhcpFixedIP=dhcpFixedIP, dns=dns, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcp=dhcp, haReplicationBinding=haReplicationBinding, trapReplicationFailure=trapReplicationFailure, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetEntry=dhcpSubnetEntry, systemDaemon=systemDaemon, dnsStats=dnsStats, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, trapReplication=trapReplication, adonis=adonis, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning, dhcpPoolEndIP=dhcpPoolEndIP, lcd=lcd, trapDNSDaemon=trapDNSDaemon, dhcpIP=dhcpIP, tftp=tftp, ha=ha, lcdDaemon=lcdDaemon, licenseValid=licenseValid, trapDNS=trapDNS, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, trapSystem=trapSystem, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning)
