...
Gauge32, IpAddress, Counter64, MibIdentifier, Counter32, enterprises, Unsigned32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Counter64", "MibIdentifier", "Counter32", "enterprises", "Unsigned32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, dnsStatsFailure=dnsStatsFailure, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haServiceNodeType=haServiceNodeType, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapTFTP=trapTFTP, lcdDaemon=lcdDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, haReplicationBinding=haReplicationBinding, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseValid=licenseValid, commandServerDaemon=commandServerDaemon, dnsDaemon=dnsDaemon, dnsStats=dnsStats, dhcpConfig=dhcpConfig, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, trapSystemDaemon=trapSystemDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolSize=dhcpPoolSize, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonis=adonis, PYSNMP_MODULE_ID=adonis, commandServer=commandServer, dhcpDaemon=dhcpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetSize=dhcpSubnetSize, dhcpStats=dhcpStats, dhcpFixedIPTable=dhcpFixedIPTable, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, ha=ha, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, system=system, dhcp=dhcp, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetTable=dhcpSubnetTable, trapReplicationFailure=trapReplicationFailure, haServiceRunning=haServiceRunning, dhcpLeaseHostname=dhcpLeaseHostname, tftp=tftp, systemState=systemState, trapSystem=trapSystem, dhcpPoolTable=dhcpPoolTable, lcd=lcd, trapHA=trapHA, haService=haService, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisObjects=adonisObjects, dhcpIP=dhcpIP, trapCommandServer=trapCommandServer, dns=dns, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIP=dhcpFixedIP, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, trapDNS=trapDNS, licenseExpiry=licenseExpiry)
