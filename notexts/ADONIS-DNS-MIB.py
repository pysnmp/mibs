...
iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, MibIdentifier, TimeTicks, Bits, Integer32, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseBindState=dhcpLeaseBindState, licenseValid=licenseValid, lcd=lcd, dhcp=dhcp, dhcpLeaseHostname=dhcpLeaseHostname, dhcpStats=dhcpStats, dnsStats=dnsStats, tftp=tftp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEndTime=dhcpLeaseEndTime, lcdDaemon=lcdDaemon, system=system, adonisTraps=adonisTraps, haServiceNodeType=haServiceNodeType, licenseExpiry=licenseExpiry, dhcpDaemonRunning=dhcpDaemonRunning, trapSystem=trapSystem, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNS=trapDNS, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, dhcpPoolEntry=dhcpPoolEntry, ha=ha, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dhcpConfig=dhcpConfig, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSize=dhcpPoolSize, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, systemDaemon=systemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServer=trapCommandServer, trapReplication=trapReplication, adonis=adonis, trapSystemDaemon=trapSystemDaemon, adonisObjects=adonisObjects, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsRecursion=dnsStatsRecursion, commandServerDaemon=commandServerDaemon, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, trapTFTP=trapTFTP, dnsStatsSuccess=dnsStatsSuccess, dns=dns, PYSNMP_MODULE_ID=adonis, haService=haService, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, dhcpFixedIP=dhcpFixedIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dnsDaemon=dnsDaemon, dhcpPoolTable=dhcpPoolTable, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsFailure=dnsStatsFailure, trapHA=trapHA, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemon=tftpDaemon)
