...
MibIdentifier, Gauge32, NotificationType, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, TimeTicks, ModuleIdentity, ObjectIdentity, enterprises, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "NotificationType", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "enterprises", "Bits", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftpDaemonRunning=tftpDaemonRunning, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dhcpSubnetEntry=dhcpSubnetEntry, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsRecursion=dnsStatsRecursion, dns=dns, haServiceNodeType=haServiceNodeType, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemonRunning=commandServerDaemonRunning, ha=ha, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemon=dnsDaemon, dhcpSubnetSize=dhcpSubnetSize, systemState=systemState, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, haService=haService, lcdDaemon=lcdDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTP=trapTFTP, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, trapSystemDaemon=trapSystemDaemon, dhcpIP=dhcpIP, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, licenseValid=licenseValid, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplicationFailure=trapReplicationFailure, dhcpConfig=dhcpConfig, dnsStats=dnsStats, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftp=tftp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, PYSNMP_MODULE_ID=adonis, dhcpDaemon=dhcpDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpStats=dhcpStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolTable=dhcpPoolTable, dhcpFixedIPTable=dhcpFixedIPTable, adonis=adonis, commandServer=commandServer, haServiceRunning=haServiceRunning, dnsStatsReferral=dnsStatsReferral, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServerDaemon=commandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, haReplicationBinding=haReplicationBinding, dhcp=dhcp, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsSuccess=dnsStatsSuccess, systemDaemon=systemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetUsed=dhcpSubnetUsed)
