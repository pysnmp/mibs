...
IpAddress, Counter32, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, Bits, Counter64, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Bits", "Counter64", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapTFTPDaemon=trapTFTPDaemon, trapReplication=trapReplication, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, lcd=lcd, dnsStatsFailure=dnsStatsFailure, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetTable=dhcpSubnetTable, haServiceRunning=haServiceRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, adonisObjects=adonisObjects, dnsStats=dnsStats, ha=ha, trapTFTP=trapTFTP, licenseExpiry=licenseExpiry, tftp=tftp, lcdDaemon=lcdDaemon, commandServerDaemon=commandServerDaemon, dnsStatsReferral=dnsStatsReferral, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNS=trapDNS, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dns=dns, trapDNSDaemon=trapDNSDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplicationFailure=trapReplicationFailure, adonisTraps=adonisTraps, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceNodeType=haServiceNodeType, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetMask=dhcpSubnetMask, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemon=dhcpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, dhcpPoolTable=dhcpPoolTable, trapDHCP=trapDHCP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonis=adonis, dhcpIP=dhcpIP, dhcpStats=dhcpStats, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolAlert=dhcpPoolAlert, commandServer=commandServer, systemState=systemState, dnsDaemon=dnsDaemon, trapCommandServer=trapCommandServer, system=system, dhcpLeaseBindState=dhcpLeaseBindState, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemon=tftpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, dhcpConfig=dhcpConfig, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIP=dhcpFixedIP, haReplicationBinding=haReplicationBinding, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseValid=licenseValid)
