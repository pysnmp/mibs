...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dhcpFixedIP=dhcpFixedIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystemDaemon=trapSystemDaemon, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, ha=ha, haService=haService, adonisTraps=adonisTraps, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, tftp=tftp, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonis=adonis, tftpDaemon=tftpDaemon, commandServerDaemon=commandServerDaemon, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, dhcp=dhcp, dnsStats=dnsStats, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, system=system, dhcpDaemon=dhcpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolAlert=dhcpPoolAlert, haServiceRunning=haServiceRunning, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dhcpStats=dhcpStats, dhcpPoolUsed=dhcpPoolUsed, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, dns=dns, trapCommandServer=trapCommandServer, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsRecursion=dnsStatsRecursion, systemState=systemState, lcdDaemon=lcdDaemon, trapReplication=trapReplication, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, dhcpPoolEndIP=dhcpPoolEndIP, trapHA=trapHA, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTP=trapTFTP, lcd=lcd, trapDNS=trapDNS, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTPDaemon=trapTFTPDaemon, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime)
