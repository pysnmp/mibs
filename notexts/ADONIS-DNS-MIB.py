...
IpAddress, Gauge32, Counter32, Counter64, ModuleIdentity, Integer32, iso, Unsigned32, ObjectIdentity, enterprises, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "Integer32", "iso", "Unsigned32", "ObjectIdentity", "enterprises", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPTable=dhcpFixedIPTable, trapReplication=trapReplication, dhcpLeaseBindState=dhcpLeaseBindState, haReplicationBinding=haReplicationBinding, tftpDaemon=tftpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, ha=ha, dhcp=dhcp, trapHA=trapHA, dnsDaemonDebugLevel=dnsDaemonDebugLevel, PYSNMP_MODULE_ID=adonis, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemon=dnsDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetSize=dhcpSubnetSize, trapTFTPDaemon=trapTFTPDaemon, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, licenseValid=licenseValid, trapSystem=trapSystem, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsReferral=dnsStatsReferral, dhcpFixedIP=dhcpFixedIP, dnsStatsFailure=dnsStatsFailure, adonisObjects=adonisObjects, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemon=dhcpDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, trapDNSDaemon=trapDNSDaemon, tftpDaemonRunning=tftpDaemonRunning, system=system, licenseExpiry=licenseExpiry, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCP=trapDHCP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, lcd=lcd, trapCommandServer=trapCommandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dhcpPoolTable=dhcpPoolTable, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFailOverState=dhcpFailOverState, dns=dns, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, lcdDaemon=lcdDaemon, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, commandServerDaemon=commandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisTraps=adonisTraps, trapReplicationFailure=trapReplicationFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftp=tftp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpIP=dhcpIP, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolSize=dhcpPoolSize, trapDHCPDaemon=trapDHCPDaemon, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetMask=dhcpSubnetMask)
