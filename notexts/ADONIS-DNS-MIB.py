...
Integer32, Counter64, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, iso, enterprises, Unsigned32, Gauge32, MibIdentifier, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "iso", "enterprises", "Unsigned32", "Gauge32", "MibIdentifier", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemon=commandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, dns=dns, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, tftp=tftp, dnsStats=dnsStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haService=haService, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, PYSNMP_MODULE_ID=adonis, tftpDaemon=tftpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServer=commandServer, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetIP=dhcpSubnetIP, trapSystem=trapSystem, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFailOverState=dhcpFailOverState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, trapTFTP=trapTFTP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, adonis=adonis, trapReplication=trapReplication, dhcpSubnetTable=dhcpSubnetTable, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplicationFailure=trapReplicationFailure, systemState=systemState, dhcpDaemon=dhcpDaemon, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetEntry=dhcpSubnetEntry, dhcpConfig=dhcpConfig, commandServerDaemonRunning=commandServerDaemonRunning, dhcp=dhcp, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNS=trapDNS, dhcpLeaseHostname=dhcpLeaseHostname, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, ha=ha, dnsStatsReferral=dnsStatsReferral, lcdDaemon=lcdDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsSuccess=dnsStatsSuccess, dnsStatsRecursion=dnsStatsRecursion, licenseExpiry=licenseExpiry, dhcpPoolSize=dhcpPoolSize, haReplicationBinding=haReplicationBinding, dhcpSubnetMask=dhcpSubnetMask, dnsStatsFailure=dnsStatsFailure, system=system, systemDaemon=systemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, dhcpIP=dhcpIP, adonisObjects=adonisObjects, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolUsed=dhcpPoolUsed)
