...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, enterprises, ModuleIdentity, Counter64, iso, ObjectIdentity, Unsigned32, Bits, IpAddress, Integer32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "enterprises", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "Unsigned32", "Bits", "IpAddress", "Integer32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServer=trapCommandServer, trapDNSDaemon=trapDNSDaemon, commandServerDaemon=commandServerDaemon, PYSNMP_MODULE_ID=adonis, dhcp=dhcp, trapDNS=trapDNS, trapTFTP=trapTFTP, dnsStatsReferral=dnsStatsReferral, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, dhcpPoolTable=dhcpPoolTable, dhcpPoolAlert=dhcpPoolAlert, dnsStats=dnsStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceRunning=haServiceRunning, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTable=dhcpLeaseTable, dnsStatsFailure=dnsStatsFailure, haService=haService, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, systemState=systemState, dns=dns, adonis=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, dhcpStats=dhcpStats, dhcpDaemon=dhcpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, system=system, dnsDaemon=dnsDaemon, trapReplication=trapReplication, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseValid=licenseValid, dhcpPoolSize=dhcpPoolSize, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetUsed=dhcpSubnetUsed, trapSystem=trapSystem, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dhcpPoolEndIP=dhcpPoolEndIP, haReplicationBinding=haReplicationBinding, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon, tftpDaemon=tftpDaemon, dhcpFixedIPTable=dhcpFixedIPTable, trapReplicationFailure=trapReplicationFailure, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpIP=dhcpIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsSuccess=dnsStatsSuccess, ha=ha, dhcpPoolUsed=dhcpPoolUsed, dnsStatsRecursion=dnsStatsRecursion, lcdDaemon=lcdDaemon, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPEntry=dhcpFixedIPEntry, tftp=tftp, lcd=lcd)
