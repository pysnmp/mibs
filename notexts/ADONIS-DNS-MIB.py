...
Integer32, Counter64, ModuleIdentity, TimeTicks, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Counter32, ObjectIdentity, NotificationType, enterprises, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "TimeTicks", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Counter32", "ObjectIdentity", "NotificationType", "enterprises", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, trapSystemDaemon=trapSystemDaemon, trapTFTP=trapTFTP, dhcpPoolTable=dhcpPoolTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dns=dns, dhcpLeaseTable=dhcpLeaseTable, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, haServiceRunning=haServiceRunning, dhcpFixedIP=dhcpFixedIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemon=commandServerDaemon, licenseValid=licenseValid, haService=haService, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNS=trapDNS, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, system=system, dhcpConfig=dhcpConfig, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFailOverState=dhcpFailOverState, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemon=dhcpDaemon, dhcpPoolSize=dhcpPoolSize, dhcpIP=dhcpIP, tftp=tftp, licenseExpiry=licenseExpiry, trapReplication=trapReplication, trapDHCP=trapDHCP, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTPDaemon=trapTFTPDaemon, trapCommandServer=trapCommandServer, dnsStatsSuccess=dnsStatsSuccess, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisObjects=adonisObjects, PYSNMP_MODULE_ID=adonis, trapDNSDaemon=trapDNSDaemon, dnsStatsReferral=dnsStatsReferral, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCPDaemon=trapDHCPDaemon, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, systemState=systemState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemonRunning=commandServerDaemonRunning, lcd=lcd, dnsStats=dnsStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystem=trapSystem, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, adonisTraps=adonisTraps, trapHA=trapHA, trapReplicationFailure=trapReplicationFailure, dhcp=dhcp, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure)
