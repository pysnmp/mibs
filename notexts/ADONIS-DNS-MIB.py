...
NotificationType, TimeTicks, Counter32, MibIdentifier, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Unsigned32, Bits, ModuleIdentity, Integer32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "MibIdentifier", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Unsigned32", "Bits", "ModuleIdentity", "Integer32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcdDaemon=lcdDaemon, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, trapReplication=trapReplication, ha=ha, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetUsed=dhcpSubnetUsed, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, dhcpIP=dhcpIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemon=tftpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, dns=dns, dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, adonisTraps=adonisTraps, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftp=tftp, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, trapHAServiceFailOver=trapHAServiceFailOver, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, trapDNSDaemon=trapDNSDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dhcp=dhcp, dhcpLeaseBindState=dhcpLeaseBindState, trapReplicationFailure=trapReplicationFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemDaemon=systemDaemon, trapSystem=trapSystem, haServiceNodeType=haServiceNodeType, haReplicationBinding=haReplicationBinding, dhcpPoolTable=dhcpPoolTable, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemon=dnsDaemon, dhcpConfig=dhcpConfig, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, trapHA=trapHA, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, dnsStats=dnsStats, system=system, dhcpPoolSize=dhcpPoolSize, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haService=haService, commandServerDaemon=commandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, licenseExpiry=licenseExpiry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseTable=dhcpLeaseTable)
