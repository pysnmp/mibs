...
ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter32, MibIdentifier, iso, Unsigned32, IpAddress, Bits, Integer32, enterprises, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter32", "MibIdentifier", "iso", "Unsigned32", "IpAddress", "Bits", "Integer32", "enterprises", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetMask=dhcpSubnetMask, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolUsed=dhcpPoolUsed, haServiceNodeType=haServiceNodeType, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, ha=ha, haService=haService, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolSize=dhcpPoolSize, tftp=tftp, dhcpConfig=dhcpConfig, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapHA=trapHA, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, trapReplication=trapReplication, trapCommandServerDaemon=trapCommandServerDaemon, dns=dns, trapDNS=trapDNS, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, adonisTraps=adonisTraps, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPEntry=dhcpFixedIPEntry, systemState=systemState, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, haServiceRunning=haServiceRunning, tftpDaemon=tftpDaemon, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsReferral=dnsStatsReferral, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTP=trapTFTP, dhcpIP=dhcpIP, PYSNMP_MODULE_ID=adonis, dhcpLeaseBindState=dhcpLeaseBindState, dhcpStats=dhcpStats, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsFailure=dnsStatsFailure, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpPoolEndIP=dhcpPoolEndIP, licenseExpiry=licenseExpiry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, dhcpPoolTable=dhcpPoolTable, system=system, dhcpSubnetTable=dhcpSubnetTable, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemon=dhcpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonis=adonis, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolAlert=dhcpPoolAlert, trapCommandServer=trapCommandServer)
