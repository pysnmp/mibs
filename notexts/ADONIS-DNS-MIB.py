...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Unsigned32, TimeTicks, Counter32, MibIdentifier, Integer32, ObjectIdentity, enterprises, Bits, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Unsigned32", "TimeTicks", "Counter32", "MibIdentifier", "Integer32", "ObjectIdentity", "enterprises", "Bits", "NotificationType", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFailOverState=dhcpFailOverState, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, dnsStats=dnsStats, system=system, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, lcdDaemon=lcdDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, adonis=adonis, licenseExpiry=licenseExpiry, dhcpConfig=dhcpConfig, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemState=systemState, dhcpSubnetEntry=dhcpSubnetEntry, trapDNSDaemon=trapDNSDaemon, dhcp=dhcp, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolUsed=dhcpPoolUsed, trapCommandServer=trapCommandServer, trapSystem=trapSystem, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, PYSNMP_MODULE_ID=adonis, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, haServiceNodeType=haServiceNodeType, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dnsStatsReferral=dnsStatsReferral, dhcpPoolSize=dhcpPoolSize, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpIP=dhcpIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, adonisTraps=adonisTraps, trapTFTP=trapTFTP, trapSystemDaemon=trapSystemDaemon, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, haServiceRunning=haServiceRunning, dnsDaemonRunning=dnsDaemonRunning, dnsStatsFailure=dnsStatsFailure, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, licenseValid=licenseValid, ha=ha, dhcpPoolTable=dhcpPoolTable, haService=haService, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCP=trapDHCP, systemDaemon=systemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPEntry=dhcpFixedIPEntry, trapTFTPDaemon=trapTFTPDaemon, trapHA=trapHA, dhcpPoolEntry=dhcpPoolEntry, commandServer=commandServer, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemon=dnsDaemon, dhcpPoolAlert=dhcpPoolAlert)
