...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, IpAddress, NotificationType, MibIdentifier, ModuleIdentity, Gauge32, Counter32, Integer32, Counter64, iso, Unsigned32, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "IpAddress", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter32", "Integer32", "Counter64", "iso", "Unsigned32", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTP=trapTFTP, dhcpStats=dhcpStats, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapCommandServer=trapCommandServer, dhcpPoolUsed=dhcpPoolUsed, trapTFTPDaemon=trapTFTPDaemon, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseTable=dhcpLeaseTable, dhcpConfig=dhcpConfig, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, dnsStats=dnsStats, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolStartIP=dhcpPoolStartIP, lcd=lcd, haReplicationBinding=haReplicationBinding, trapDHCPDaemon=trapDHCPDaemon, dnsStatsRecursion=dnsStatsRecursion, system=system, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapHA=trapHA, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dhcpSubnetSize=dhcpSubnetSize, systemDaemon=systemDaemon, trapDHCP=trapDHCP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsSuccess=dnsStatsSuccess, trapSystem=trapSystem, haServiceRunning=haServiceRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemon=dnsDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHAServiceFailOver=trapHAServiceFailOver, licenseExpiry=licenseExpiry, trapDNS=trapDNS, licenseValid=licenseValid, adonisObjects=adonisObjects, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, trapReplicationFailure=trapReplicationFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpIP=dhcpIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftp=tftp, dns=dns, haServiceNodeType=haServiceNodeType, dhcpFixedIPEntry=dhcpFixedIPEntry, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, commandServerDaemon=commandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haService=haService, ha=ha)
