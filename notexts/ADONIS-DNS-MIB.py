...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, haServiceNodeType=haServiceNodeType, tftpDaemonRunning=tftpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dhcpSubnetEntry=dhcpSubnetEntry, haReplicationBinding=haReplicationBinding, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsFailure=dnsStatsFailure, dhcpFixedIP=dhcpFixedIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFailOverState=dhcpFailOverState, trapReplicationFailure=trapReplicationFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, dhcpIP=dhcpIP, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, systemDaemon=systemDaemon, trapSystem=trapSystem, dnsDaemonRunning=dnsDaemonRunning, system=system, dnsStats=dnsStats, dhcpPoolUsed=dhcpPoolUsed, adonisTraps=adonisTraps, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, haServiceRunning=haServiceRunning, systemState=systemState, dhcpLeaseTable=dhcpLeaseTable, dnsDaemon=dnsDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemon=tftpDaemon, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, commandServerDaemon=commandServerDaemon, dnsStatsReferral=dnsStatsReferral, trapCommandServer=trapCommandServer, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcp=dhcp, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTP=trapTFTP, dhcpDaemon=dhcpDaemon, ha=ha, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonis=adonis, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolStartIP=dhcpPoolStartIP, haService=haService, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, licenseValid=licenseValid, dns=dns, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcd=lcd, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisObjects=adonisObjects)
