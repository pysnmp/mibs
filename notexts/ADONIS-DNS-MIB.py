...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, dhcpPoolStartIP=dhcpPoolStartIP, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, trapTFTPDaemon=trapTFTPDaemon, licenseValid=licenseValid, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, trapDHCPDaemon=trapDHCPDaemon, dnsDaemon=dnsDaemon, trapReplication=trapReplication, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, commandServer=commandServer, trapCommandServerDaemon=trapCommandServerDaemon, haReplicationBinding=haReplicationBinding, dhcpDaemon=dhcpDaemon, trapCommandServer=trapCommandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system, dhcpSubnetIP=dhcpSubnetIP, dhcpConfig=dhcpConfig, tftpDaemonRunning=tftpDaemonRunning, adonisObjects=adonisObjects, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, trapHA=trapHA, adonis=adonis, dnsDaemonDebugLevel=dnsDaemonDebugLevel, PYSNMP_MODULE_ID=adonis, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsReferral=dnsStatsReferral, dnsStatsNXRRSet=dnsStatsNXRRSet, systemDaemon=systemDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, trapTFTP=trapTFTP, tftp=tftp, commandServerDaemon=commandServerDaemon, dns=dns, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, haServiceRunning=haServiceRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetEntry=dhcpSubnetEntry, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, trapReplicationFailure=trapReplicationFailure, dhcpStats=dhcpStats, haService=haService, dhcpPoolTable=dhcpPoolTable, dhcpFixedIP=dhcpFixedIP, haServiceNodeType=haServiceNodeType, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, ha=ha, dnsStats=dnsStats)
