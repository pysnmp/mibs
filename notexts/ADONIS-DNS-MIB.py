...
iso, Gauge32, ModuleIdentity, Counter64, Integer32, Bits, Unsigned32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ObjectIdentity, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "ModuleIdentity", "Counter64", "Integer32", "Bits", "Unsigned32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ObjectIdentity", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemon=tftpDaemon, haServiceRunning=haServiceRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, system=system, trapDHCP=trapDHCP, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapSystemDaemon=trapSystemDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFailOverState=dhcpFailOverState, dhcpIP=dhcpIP, adonisTraps=adonisTraps, trapTFTP=trapTFTP, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, trapDNSDaemon=trapDNSDaemon, tftp=tftp, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, systemDaemon=systemDaemon, dhcpSubnetSize=dhcpSubnetSize, trapHA=trapHA, trapReplication=trapReplication, dnsStatsReferral=dnsStatsReferral, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsFailure=dnsStatsFailure, dhcpPoolSize=dhcpPoolSize, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, trapCommandServer=trapCommandServer, licenseValid=licenseValid, dhcpLeaseBindState=dhcpLeaseBindState, adonisObjects=adonisObjects, commandServer=commandServer, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, lcd=lcd, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpStats=dhcpStats, systemState=systemState, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNS=trapDNS, lcdDaemon=lcdDaemon)
