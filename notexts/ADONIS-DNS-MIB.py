...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, licenseValid=licenseValid, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStats=dnsStats, dhcpSubnetAlert=dhcpSubnetAlert, dhcpIP=dhcpIP, PYSNMP_MODULE_ID=adonis, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, trapTFTPDaemon=trapTFTPDaemon, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsReferral=dnsStatsReferral, trapDHCP=trapDHCP, haReplicationBinding=haReplicationBinding, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSize=dhcpPoolSize, ha=ha, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcp=dhcp, tftp=tftp, system=system, dns=dns, dhcpSubnetIP=dhcpSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, systemState=systemState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, adonisObjects=adonisObjects, dhcpPoolStartIP=dhcpPoolStartIP, trapHAServiceFailOver=trapHAServiceFailOver, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseTable=dhcpLeaseTable, trapDNSDaemon=trapDNSDaemon, trapDNS=trapDNS, tftpDaemon=tftpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, haServiceRunning=haServiceRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haService=haService, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplication=trapReplication, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapReplicationFailure=trapReplicationFailure, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetMask=dhcpSubnetMask, adonis=adonis, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, lcd=lcd, trapSystemDaemon=trapSystemDaemon, haServiceNodeType=haServiceNodeType, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess)
