...
Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Bits, enterprises, Integer32, ModuleIdentity, iso, ObjectIdentity, Counter64, NotificationType, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Bits", "enterprises", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "Counter64", "NotificationType", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisTraps=adonisTraps, trapDNS=trapDNS, haService=haService, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonRunning=dhcpDaemonRunning, PYSNMP_MODULE_ID=adonis, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsSuccess=dnsStatsSuccess, dns=dns, adonisObjects=adonisObjects, dhcpLeaseBindState=dhcpLeaseBindState, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, licenseValid=licenseValid, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, tftpDaemon=tftpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, systemState=systemState, lcd=lcd, dhcpFixedIP=dhcpFixedIP, haServiceNodeType=haServiceNodeType, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolTable=dhcpPoolTable, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetSize=dhcpSubnetSize, system=system, dnsStatsFailure=dnsStatsFailure, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcdDaemon=lcdDaemon, trapSystem=trapSystem, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCP=trapDHCP, dhcpPoolAlert=dhcpPoolAlert, dhcpConfig=dhcpConfig, licenseExpiry=licenseExpiry, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon, trapDNSDaemon=trapDNSDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpStats=dhcpStats, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplication=trapReplication, dhcpFailOverState=dhcpFailOverState, haServiceRunning=haServiceRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpIP=dhcpIP, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, haReplicationBinding=haReplicationBinding, ha=ha, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsReferral=dnsStatsReferral, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, trapHA=trapHA, dnsDaemon=dnsDaemon)
