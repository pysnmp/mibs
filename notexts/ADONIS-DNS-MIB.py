...
iso, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, MibIdentifier, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, enterprises, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "enterprises", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpSubnetUsed=dhcpSubnetUsed, lcdDaemon=lcdDaemon, dns=dns, dhcpPoolStartIP=dhcpPoolStartIP, dhcp=dhcp, haService=haService, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, trapDNSDaemon=trapDNSDaemon, systemState=systemState, dnsStats=dnsStats, trapDHCP=trapDHCP, dhcpPoolSize=dhcpPoolSize, dhcpConfig=dhcpConfig, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, trapTFTPDaemon=trapTFTPDaemon, trapHA=trapHA, trapReplication=trapReplication, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsRecursion=dnsStatsRecursion, PYSNMP_MODULE_ID=adonis, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, trapCommandServer=trapCommandServer, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, lcd=lcd, dhcpPoolTable=dhcpPoolTable, adonisObjects=adonisObjects, haReplicationBinding=haReplicationBinding, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpFailOverState=dhcpFailOverState, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetSize=dhcpSubnetSize, systemDaemon=systemDaemon, dhcpFixedIPTable=dhcpFixedIPTable, system=system, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, dhcpDaemon=dhcpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, dhcpIP=dhcpIP, adonis=adonis, commandServer=commandServer, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred)
