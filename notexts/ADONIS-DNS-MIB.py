...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, MibIdentifier, ObjectIdentity, Counter64, ModuleIdentity, iso, IpAddress, TimeTicks, Counter32, Gauge32, NotificationType, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "MibIdentifier", "ObjectIdentity", "Counter64", "ModuleIdentity", "iso", "IpAddress", "TimeTicks", "Counter32", "Gauge32", "NotificationType", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNSDaemon=trapDNSDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, ha=ha, dhcpPoolAlert=dhcpPoolAlert, system=system, haServiceRunning=haServiceRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, dhcpLeaseBindState=dhcpLeaseBindState, dhcpStats=dhcpStats, lcd=lcd, haService=haService, dhcpFailOverState=dhcpFailOverState, dhcp=dhcp, dhcpIP=dhcpIP, dhcpConfig=dhcpConfig, trapReplicationFailure=trapReplicationFailure, dnsDaemon=dnsDaemon, PYSNMP_MODULE_ID=adonis, dns=dns, dhcpFixedIP=dhcpFixedIP, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, tftp=tftp, dhcpFixedIPTable=dhcpFixedIPTable, trapReplication=trapReplication, dhcpPoolSize=dhcpPoolSize, dhcpDaemonRunning=dhcpDaemonRunning, lcdDaemon=lcdDaemon, adonisObjects=adonisObjects, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsRecursion=dnsStatsRecursion, licenseExpiry=licenseExpiry, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, adonisTraps=adonisTraps, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, tftpDaemon=tftpDaemon, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpPoolStartIP=dhcpPoolStartIP, systemState=systemState, adonis=adonis, trapDNS=trapDNS, trapDHCP=trapDHCP, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemon=dhcpDaemon, trapSystem=trapSystem, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime)
