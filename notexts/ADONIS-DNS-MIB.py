...
MibIdentifier, Gauge32, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, iso, TimeTicks, enterprises, Integer32, Bits, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "iso", "TimeTicks", "enterprises", "Integer32", "Bits", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXDomain=dnsStatsNXDomain, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonRunning=dhcpDaemonRunning, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer, lcdDaemon=lcdDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapTFTP=trapTFTP, systemDaemon=systemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, licenseExpiry=licenseExpiry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystemDaemon=trapSystemDaemon, dhcpIP=dhcpIP, trapSystem=trapSystem, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, tftp=tftp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolUsed=dhcpPoolUsed, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceRunning=haServiceRunning, dhcpDaemon=dhcpDaemon, dns=dns, haService=haService, adonis=adonis, ha=ha, dnsStats=dnsStats, trapReplicationFailure=trapReplicationFailure, commandServerDaemon=commandServerDaemon, trapHA=trapHA, tftpDaemon=tftpDaemon, dhcpPoolEntry=dhcpPoolEntry, PYSNMP_MODULE_ID=adonis, adonisObjects=adonisObjects, dhcpConfig=dhcpConfig, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIP=dhcpFixedIP, trapDNS=trapDNS, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServer=trapCommandServer, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, system=system, lcd=lcd, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress)
