...
ModuleIdentity, Unsigned32, Integer32, Bits, iso, Counter64, NotificationType, TimeTicks, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "Bits", "iso", "Counter64", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, systemState=systemState, dnsStatsRecursion=dnsStatsRecursion, adonisTraps=adonisTraps, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolAlert=dhcpPoolAlert, licenseValid=licenseValid, licenseExpiry=licenseExpiry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd, PYSNMP_MODULE_ID=adonis, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dns=dns, trapSystemDaemon=trapSystemDaemon, trapSystem=trapSystem, trapReplication=trapReplication, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemon=commandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapTFTP=trapTFTP, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsReferral=dnsStatsReferral, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, trapReplicationFailure=trapReplicationFailure, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, dhcp=dhcp, tftpDaemon=tftpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpConfig=dhcpConfig, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIP=dhcpFixedIP, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolStartIP=dhcpPoolStartIP, haServiceNodeType=haServiceNodeType, adonis=adonis, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolUsed=dhcpPoolUsed, tftpDaemonRunning=tftpDaemonRunning, ha=ha, dnsDaemon=dnsDaemon, lcdDaemon=lcdDaemon, trapDNSDaemon=trapDNSDaemon, dhcpDaemon=dhcpDaemon, system=system, dhcpSubnetSize=dhcpSubnetSize, haService=haService, dhcpPoolSize=dhcpPoolSize, dhcpPoolTable=dhcpPoolTable, systemDaemon=systemDaemon, dhcpSubnetMask=dhcpSubnetMask, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServer=trapCommandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpIP=dhcpIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseHostname=dhcpLeaseHostname, tftp=tftp, trapDNS=trapDNS, adonisObjects=adonisObjects, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
