...
Counter32, enterprises, iso, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, IpAddress, Bits, Gauge32, Integer32, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Integer32", "NotificationType", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, dhcpIP=dhcpIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsRecursion=dnsStatsRecursion, haService=haService, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTP=trapTFTP, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemon=commandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, adonisObjects=adonisObjects, trapSystem=trapSystem, dhcpSubnetTable=dhcpSubnetTable, dnsStatsReferral=dnsStatsReferral, trapCommandServer=trapCommandServer, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, dhcpPoolEntry=dhcpPoolEntry, dnsDaemon=dnsDaemon, dhcpPoolSize=dhcpPoolSize, dhcpLeaseHostname=dhcpLeaseHostname, trapReplicationFailure=trapReplicationFailure, commandServer=commandServer, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemonRunning=tftpDaemonRunning, haReplicationBinding=haReplicationBinding, adonis=adonis, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, trapDNS=trapDNS, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, dhcp=dhcp, trapDNSDaemon=trapDNSDaemon, dns=dns, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXDomain=dnsStatsNXDomain, tftp=tftp, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, dhcpLeaseEndTime=dhcpLeaseEndTime, systemDaemon=systemDaemon, ha=ha, lcdDaemon=lcdDaemon, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, haServiceNodeType=haServiceNodeType, dhcpLeaseBindState=dhcpLeaseBindState, dnsStats=dnsStats, tftpDaemon=tftpDaemon, lcd=lcd, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIP=dhcpFixedIP, dhcpPoolTable=dhcpPoolTable, systemState=systemState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsSuccess=dnsStatsSuccess)
