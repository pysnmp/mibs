...
TimeTicks, Unsigned32, IpAddress, enterprises, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Gauge32, Counter64, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "enterprises", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Gauge32", "Counter64", "ModuleIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemon=tftpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStats=dnsStats, dhcpStats=dhcpStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTP=trapTFTP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNSDaemon=trapDNSDaemon, dhcpFailOverState=dhcpFailOverState, haServiceNodeType=haServiceNodeType, trapReplication=trapReplication, commandServer=commandServer, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, lcd=lcd, dhcpSubnetMask=dhcpSubnetMask, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, trapReplicationFailure=trapReplicationFailure, commandServerDaemon=commandServerDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonRunning=dnsDaemonRunning, haServiceRunning=haServiceRunning, system=system, tftp=tftp, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, trapDNS=trapDNS, haService=haService, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisTraps=adonisTraps, licenseValid=licenseValid, dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, adonisObjects=adonisObjects, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemon=dhcpDaemon, dhcpPoolSize=dhcpPoolSize, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcp=dhcp, haReplicationBinding=haReplicationBinding, lcdDaemon=lcdDaemon, dnsStatsSuccess=dnsStatsSuccess, dns=dns, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, dhcpConfig=dhcpConfig, dhcpSubnetAlert=dhcpSubnetAlert, adonis=adonis, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP)
