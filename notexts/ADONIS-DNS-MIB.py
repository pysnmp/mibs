...
MibIdentifier, Counter32, Unsigned32, Gauge32, ModuleIdentity, Counter64, Bits, enterprises, TimeTicks, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "Bits", "enterprises", "TimeTicks", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", licenseValid=licenseValid, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, dnsStatsNXRRSet=dnsStatsNXRRSet, adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, trapTFTP=trapTFTP, lcd=lcd, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDHCP=trapDHCP, adonisObjects=adonisObjects, dnsDaemonRunning=dnsDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, licenseExpiry=licenseExpiry, dhcpPoolTable=dhcpPoolTable, dhcpPoolSize=dhcpPoolSize, haServiceRunning=haServiceRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, tftp=tftp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetUsed=dhcpSubnetUsed, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIP=dhcpFixedIP, PYSNMP_MODULE_ID=adonis, dhcpFailOverState=dhcpFailOverState, dhcp=dhcp, commandServer=commandServer, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisTraps=adonisTraps, trapTFTPDaemon=trapTFTPDaemon, trapSystem=trapSystem, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable, ha=ha, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpIP=dhcpIP, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEntry=dhcpLeaseEntry, systemDaemon=systemDaemon, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, trapDNSDaemon=trapDNSDaemon, trapSystemDaemon=trapSystemDaemon, dns=dns, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemon=dhcpDaemon, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsReferral=dnsStatsReferral, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dhcpPoolStartIP=dhcpPoolStartIP)
