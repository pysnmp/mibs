...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetIP=dhcpSubnetIP, haReplicationBinding=haReplicationBinding, dhcpPoolAlert=dhcpPoolAlert, ha=ha, haService=haService, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, dhcpConfig=dhcpConfig, trapReplicationFailure=trapReplicationFailure, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTP=trapTFTP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXRRSet=dnsStatsNXRRSet, lcd=lcd, tftp=tftp, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemon=dnsDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, adonis=adonis, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, system=system, haServiceNodeType=haServiceNodeType, dhcpFailOverState=dhcpFailOverState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcp=dhcp, dhcpDaemon=dhcpDaemon, dnsStatsReferral=dnsStatsReferral, dhcpSubnetMask=dhcpSubnetMask, trapReplication=trapReplication, tftpDaemon=tftpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolSize=dhcpPoolSize, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsFailure=dnsStatsFailure, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetUsed=dhcpSubnetUsed, licenseValid=licenseValid, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpStats=dhcpStats, dnsStats=dnsStats, commandServerDaemon=commandServerDaemon, trapSystemDaemon=trapSystemDaemon, trapHA=trapHA, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dns=dns, dhcpPoolTable=dhcpPoolTable, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, licenseExpiry=licenseExpiry, adonisTraps=adonisTraps, trapSystem=trapSystem, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, PYSNMP_MODULE_ID=adonis, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, commandServer=commandServer)
