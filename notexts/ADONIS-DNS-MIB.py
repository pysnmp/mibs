...
enterprises, ModuleIdentity, NotificationType, Bits, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, Counter32, Gauge32, MibIdentifier, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dhcpStats=dhcpStats, dhcpConfig=dhcpConfig, dhcpFixedIP=dhcpFixedIP, dnsDaemon=dnsDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapTFTPDaemon=trapTFTPDaemon, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, dhcpIP=dhcpIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, lcd=lcd, lcdDaemon=lcdDaemon, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, ha=ha, trapCommandServer=trapCommandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, adonis=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, systemDaemon=systemDaemon, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, trapDNS=trapDNS, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, adonisObjects=adonisObjects, trapTFTP=trapTFTP, adonisTraps=adonisTraps, haServiceNodeType=haServiceNodeType, dhcpSubnetSize=dhcpSubnetSize, dnsStatsFailure=dnsStatsFailure, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCPDaemon=trapDHCPDaemon, tftp=tftp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapReplicationFailure=trapReplicationFailure, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemon=dhcpDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, system=system, dhcpPoolSize=dhcpPoolSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplication=trapReplication, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dhcpLeaseTable=dhcpLeaseTable, trapCommandServerDaemon=trapCommandServerDaemon, haServiceRunning=haServiceRunning, tftpDaemon=tftpDaemon, licenseExpiry=licenseExpiry)
