...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCP=trapDHCP, dnsStatsRecursion=dnsStatsRecursion, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, systemState=systemState, tftp=tftp, haServiceRunning=haServiceRunning, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, trapDNS=trapDNS, dnsStatsNXDomain=dnsStatsNXDomain, trapDNSDaemon=trapDNSDaemon, dhcpPoolAlert=dhcpPoolAlert, dns=dns, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, trapReplication=trapReplication, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpStats=dhcpStats, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemon=tftpDaemon, dhcpDaemon=dhcpDaemon, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, haServiceNodeType=haServiceNodeType, haReplicationBinding=haReplicationBinding, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcd=lcd, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemonRunning=tftpDaemonRunning, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, licenseValid=licenseValid, commandServer=commandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, trapSystemDaemon=trapSystemDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haService=haService, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcdDaemon=lcdDaemon, dhcp=dhcp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, trapTFTPDaemon=trapTFTPDaemon, trapSystem=trapSystem, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolUsed=dhcpPoolUsed, dnsDaemon=dnsDaemon, trapHA=trapHA, ha=ha, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemon=commandServerDaemon, adonisTraps=adonisTraps, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIP=dhcpFixedIP)
