...
TimeTicks, Counter32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, NotificationType, ModuleIdentity, Unsigned32, Gauge32, iso, Bits, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "Bits", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseBindState=dhcpLeaseBindState, adonisObjects=adonisObjects, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, ha=ha, haReplicationBinding=haReplicationBinding, dhcpSubnetAlert=dhcpSubnetAlert, haServiceNodeType=haServiceNodeType, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonRunning=dhcpDaemonRunning, dhcp=dhcp, dhcpFixedIP=dhcpFixedIP, trapHAServiceFailOver=trapHAServiceFailOver, trapReplicationFailure=trapReplicationFailure, trapDNS=trapDNS, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable, haService=haService, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplication=trapReplication, licenseExpiry=licenseExpiry, dnsStatsFailure=dnsStatsFailure, dhcpStats=dhcpStats, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftp=tftp, systemState=systemState, commandServerDaemon=commandServerDaemon, trapHA=trapHA, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, adonis=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServer=trapCommandServer, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpIP=dhcpIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXRRSet=dnsStatsNXRRSet, lcd=lcd, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, system=system, lcdDaemon=lcdDaemon, adonisTraps=adonisTraps, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, systemDaemon=systemDaemon, dhcpFailOverState=dhcpFailOverState, dhcpSubnetIP=dhcpSubnetIP, dnsStats=dnsStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral, tftpDaemonRunning=tftpDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemon=dhcpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, dhcpLeaseEntry=dhcpLeaseEntry)
