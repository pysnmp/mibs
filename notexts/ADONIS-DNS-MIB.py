...
TimeTicks, Gauge32, iso, enterprises, Counter32, ObjectIdentity, Unsigned32, IpAddress, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "iso", "enterprises", "Counter32", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", systemState=systemState, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, lcd=lcd, tftp=tftp, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, trapDHCPDaemon=trapDHCPDaemon, trapHA=trapHA, commandServer=commandServer, dhcpSubnetAlert=dhcpSubnetAlert, system=system, trapDNSDaemon=trapDNSDaemon, dnsDaemon=dnsDaemon, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dnsStatsSuccess=dnsStatsSuccess, trapSystemDaemon=trapSystemDaemon, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServer=trapCommandServer, licenseExpiry=licenseExpiry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcdDaemon=lcdDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haServiceNodeType=haServiceNodeType, dhcp=dhcp, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, dhcpPoolSize=dhcpPoolSize, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, adonis=adonis, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dns=dns, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, trapReplication=trapReplication, trapHAServiceFailOver=trapHAServiceFailOver, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, dnsStatsReferral=dnsStatsReferral, adonisObjects=adonisObjects, dhcpSubnetIP=dhcpSubnetIP, tftpDaemon=tftpDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, ha=ha, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemon=dhcpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpIP=dhcpIP, dhcpSubnetUsed=dhcpSubnetUsed, licenseValid=licenseValid, haService=haService)
