...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsSuccess=dnsStatsSuccess, dnsDaemon=dnsDaemon, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, haServiceNodeType=haServiceNodeType, dhcpIP=dhcpIP, lcd=lcd, dhcpPoolUsed=dhcpPoolUsed, dhcp=dhcp, tftp=tftp, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, ha=ha, dhcpFailOverState=dhcpFailOverState, dns=dns, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsFailure=dnsStatsFailure, adonisTraps=adonisTraps, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpConfig=dhcpConfig, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseHostname=dhcpLeaseHostname, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, trapCommandServer=trapCommandServer, dhcpPoolTable=dhcpPoolTable, dhcpDaemonRunning=dhcpDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, systemState=systemState, dhcpSubnetTable=dhcpSubnetTable, trapCommandServerDaemon=trapCommandServerDaemon, trapReplicationFailure=trapReplicationFailure, haReplicationBinding=haReplicationBinding, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, systemDaemon=systemDaemon, licenseValid=licenseValid, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemon=commandServerDaemon, dhcpPoolSize=dhcpPoolSize, tftpDaemon=tftpDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIPTable=dhcpFixedIPTable, lcdDaemon=lcdDaemon, dhcpSubnetSize=dhcpSubnetSize, PYSNMP_MODULE_ID=adonis, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsStats=dnsStats, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServer=commandServer, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, dhcpStats=dhcpStats, haService=haService, trapHA=trapHA, trapTFTP=trapTFTP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon)
