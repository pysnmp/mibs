...
Counter64, MibIdentifier, Integer32, IpAddress, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, iso, Bits, enterprises, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "iso", "Bits", "enterprises", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDNS=trapDNS, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, trapHA=trapHA, trapReplication=trapReplication, adonisObjects=adonisObjects, trapDHCP=trapDHCP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpFailOverState=dhcpFailOverState, dhcpSubnetEntry=dhcpSubnetEntry, adonis=adonis, dhcpDaemon=dhcpDaemon, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, dnsStatsFailure=dnsStatsFailure, dhcpSubnetUsed=dhcpSubnetUsed, systemDaemon=systemDaemon, systemState=systemState, haReplicationBinding=haReplicationBinding, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemon=tftpDaemon, dnsStats=dnsStats, dhcpPoolSize=dhcpPoolSize, dns=dns, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTPDaemon=trapTFTPDaemon, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseExpiry=licenseExpiry, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, PYSNMP_MODULE_ID=adonis, dnsDaemon=dnsDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemon=commandServerDaemon, ha=ha, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEntry=dhcpLeaseEntry, dhcpConfig=dhcpConfig, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseTable=dhcpLeaseTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonRunning=dhcpDaemonRunning, dhcpIP=dhcpIP, dhcp=dhcp, lcd=lcd, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetIP=dhcpSubnetIP, haService=haService, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceRunning=haServiceRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, trapSystemDaemon=trapSystemDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, trapHAServiceFailOver=trapHAServiceFailOver, trapCommandServer=trapCommandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServer=commandServer, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonRunning=dnsDaemonRunning, dhcpStats=dhcpStats, haServiceNodeType=haServiceNodeType, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIP=dhcpFixedIP, system=system, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolStartIP=dhcpPoolStartIP)
