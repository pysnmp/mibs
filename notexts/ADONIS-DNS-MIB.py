...
NotificationType, IpAddress, enterprises, ModuleIdentity, Counter32, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Bits, Integer32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "enterprises", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Bits", "Integer32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServer=trapCommandServer, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, trapReplicationFailure=trapReplicationFailure, dhcpDaemonRunning=dhcpDaemonRunning, haServiceNodeType=haServiceNodeType, dhcpDaemon=dhcpDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpFailOverState=dhcpFailOverState, dnsStatsRecursion=dnsStatsRecursion, dhcpConfig=dhcpConfig, commandServerDaemon=commandServerDaemon, trapDNS=trapDNS, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, dhcpIP=dhcpIP, dhcpPoolEndIP=dhcpPoolEndIP, lcdDaemon=lcdDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapReplication=trapReplication, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, systemDaemon=systemDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsReferral=dnsStatsReferral, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonisTraps=adonisTraps, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, dhcpStats=dhcpStats, haReplicationBinding=haReplicationBinding, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetIP=dhcpSubnetIP, dhcp=dhcp, trapDHCPDaemon=trapDHCPDaemon, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCP=trapDHCP, dhcpLeaseStartTime=dhcpLeaseStartTime, trapSystemDaemon=trapSystemDaemon, haService=haService, system=system, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, adonis=adonis, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dns=dns, dnsStats=dnsStats, dhcpPoolSize=dhcpPoolSize, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisObjects=adonisObjects, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, systemState=systemState, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolSubnetIP=dhcpPoolSubnetIP)
