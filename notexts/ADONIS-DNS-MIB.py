...
Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, IpAddress, ModuleIdentity, TimeTicks, Gauge32, Unsigned32, iso, MibIdentifier, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "IpAddress", "ModuleIdentity", "TimeTicks", "Gauge32", "Unsigned32", "iso", "MibIdentifier", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, dhcpFailOverState=dhcpFailOverState, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, trapSystem=trapSystem, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, dhcpStats=dhcpStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, haReplicationBinding=haReplicationBinding, dhcpPoolSize=dhcpPoolSize, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetSize=dhcpSubnetSize, trapDNSDaemon=trapDNSDaemon, dns=dns, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsDaemon=dnsDaemon, licenseValid=licenseValid, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis, dhcp=dhcp, commandServer=commandServer, dhcpIP=dhcpIP, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseExpiry=licenseExpiry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolTable=dhcpPoolTable, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetTable=dhcpSubnetTable, trapReplicationFailure=trapReplicationFailure, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisTraps=adonisTraps, dhcpPoolEndIP=dhcpPoolEndIP, system=system, trapCommandServer=trapCommandServer, systemDaemon=systemDaemon, trapTFTP=trapTFTP, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, adonisObjects=adonisObjects, trapDHCP=trapDHCP, dnsStatsReferral=dnsStatsReferral, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, dhcpConfig=dhcpConfig, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystemDaemon=trapSystemDaemon, tftp=tftp, PYSNMP_MODULE_ID=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, haService=haService, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPTable=dhcpFixedIPTable)
