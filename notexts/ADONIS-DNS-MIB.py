...
enterprises, TimeTicks, Integer32, MibIdentifier, ObjectIdentity, NotificationType, Bits, Counter64, Counter32, Gauge32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Integer32", "MibIdentifier", "ObjectIdentity", "NotificationType", "Bits", "Counter64", "Counter32", "Gauge32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEndIP=dhcpPoolEndIP, trapDNS=trapDNS, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseExpiry=licenseExpiry, systemDaemon=systemDaemon, adonis=adonis, dhcpIP=dhcpIP, dhcpLeaseTable=dhcpLeaseTable, tftp=tftp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, haServiceRunning=haServiceRunning, dnsDaemon=dnsDaemon, adonisObjects=adonisObjects, trapHA=trapHA, lcdDaemon=lcdDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, PYSNMP_MODULE_ID=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapReplicationFailure=trapReplicationFailure, lcd=lcd, dnsStatsSuccess=dnsStatsSuccess, haReplicationBinding=haReplicationBinding, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseStartTime=dhcpLeaseStartTime, dns=dns, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcp=dhcp, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSize=dhcpPoolSize, dnsStatsReferral=dnsStatsReferral, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpStats=dhcpStats, dhcpLeaseEntry=dhcpLeaseEntry, trapSystemDaemon=trapSystemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpConfig=dhcpConfig, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetUsed=dhcpSubnetUsed, commandServer=commandServer, trapDHCP=trapDHCP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolStartIP=dhcpPoolStartIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, dnsStats=dnsStats, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, licenseValid=licenseValid, dhcpDaemon=dhcpDaemon, haService=haService, dhcpFixedIP=dhcpFixedIP, dhcpSubnetIP=dhcpSubnetIP, trapTFTP=trapTFTP, trapSystem=trapSystem, tftpDaemon=tftpDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, system=system, adonisTraps=adonisTraps, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsFailure=dnsStatsFailure, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname)
