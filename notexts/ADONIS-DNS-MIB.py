...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32, iso, NotificationType, Counter64, enterprises, TimeTicks, Unsigned32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32", "iso", "NotificationType", "Counter64", "enterprises", "TimeTicks", "Unsigned32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpStats=dhcpStats, dhcpFailOverState=dhcpFailOverState, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, haServiceRunning=haServiceRunning, tftpDaemon=tftpDaemon, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEndIP=dhcpPoolEndIP, trapCommandServer=trapCommandServer, dhcpConfig=dhcpConfig, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemon=dhcpDaemon, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemDaemon=systemDaemon, trapTFTP=trapTFTP, dhcpPoolStartIP=dhcpPoolStartIP, trapHA=trapHA, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpIP=dhcpIP, adonisObjects=adonisObjects, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisTraps=adonisTraps, dnsStatsRecursion=dnsStatsRecursion, haServiceNodeType=haServiceNodeType, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIP=dhcpFixedIP, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsReferral=dnsStatsReferral, system=system, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHAServiceFailOver=trapHAServiceFailOver, commandServer=commandServer, dhcpPoolTable=dhcpPoolTable, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetAlert=dhcpSubnetAlert, adonis=adonis, lcd=lcd, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, tftp=tftp, dnsStats=dnsStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, licenseExpiry=licenseExpiry, ha=ha, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTPDaemon=trapTFTPDaemon, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState)
