...
Integer32, Bits, TimeTicks, ObjectIdentity, MibIdentifier, NotificationType, Unsigned32, Counter32, Gauge32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "ObjectIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "Counter32", "Gauge32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolTable=dhcpPoolTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHostname=dhcpLeaseHostname, haService=haService, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetIP=dhcpSubnetIP, tftpDaemon=tftpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP, adonisTraps=adonisTraps, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolSize=dhcpPoolSize, tftp=tftp, dhcpFailOverState=dhcpFailOverState, dhcpSubnetAlert=dhcpSubnetAlert, haReplicationBinding=haReplicationBinding, trapHA=trapHA, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemon=commandServerDaemon, adonis=adonis, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemon=dhcpDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonRunning=dnsDaemonRunning, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dnsStatsRecursion=dnsStatsRecursion, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, dnsStatsReferral=dnsStatsReferral, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, haServiceRunning=haServiceRunning, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplicationFailure=trapReplicationFailure, lcdDaemon=lcdDaemon, trapSystem=trapSystem, dhcpLeaseTable=dhcpLeaseTable, trapReplication=trapReplication, dnsDaemon=dnsDaemon, dhcpSubnetMask=dhcpSubnetMask, trapDHCP=trapDHCP, haServiceNodeType=haServiceNodeType, dnsStatsNXDomain=dnsStatsNXDomain, dhcp=dhcp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIP=dhcpFixedIP, systemDaemon=systemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonisObjects=adonisObjects, dhcpLeaseBindState=dhcpLeaseBindState, commandServer=commandServer, dhcpSubnetSize=dhcpSubnetSize, trapCommandServer=trapCommandServer, systemState=systemState, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, system=system, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpConfig=dhcpConfig, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, trapDNSDaemon=trapDNSDaemon, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones)
