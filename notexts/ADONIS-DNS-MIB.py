...
TimeTicks, Counter32, Unsigned32, Integer32, NotificationType, Bits, Counter64, ModuleIdentity, iso, IpAddress, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Unsigned32", "Integer32", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "iso", "IpAddress", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsSuccess=dnsStatsSuccess, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpStats=dhcpStats, haService=haService, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, haServiceRunning=haServiceRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIPEntry=dhcpFixedIPEntry, PYSNMP_MODULE_ID=adonis, lcd=lcd, ha=ha, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolTable=dhcpPoolTable, trapDNS=trapDNS, dns=dns, lcdDaemon=lcdDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dhcpConfig=dhcpConfig, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCPDaemon=trapDHCPDaemon, adonisObjects=adonisObjects, system=system, dhcpPoolSize=dhcpPoolSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetUsed=dhcpSubnetUsed, systemState=systemState, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIP=dhcpFixedIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, trapCommandServer=trapCommandServer, trapTFTP=trapTFTP, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, adonisTraps=adonisTraps, dnsStatsFailure=dnsStatsFailure, trapSystem=trapSystem, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNSDaemon=trapDNSDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, trapSystemDaemon=trapSystemDaemon, licenseExpiry=licenseExpiry, dhcpPoolAlert=dhcpPoolAlert, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, tftpDaemon=tftpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetTable=dhcpSubnetTable, haServiceNodeType=haServiceNodeType, tftp=tftp, haReplicationBinding=haReplicationBinding, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, trapReplication=trapReplication, dhcpPoolStartIP=dhcpPoolStartIP, dnsStats=dnsStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, commandServer=commandServer)
