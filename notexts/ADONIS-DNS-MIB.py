...
IpAddress, ModuleIdentity, Integer32, Gauge32, TimeTicks, Counter64, NotificationType, Counter32, iso, MibIdentifier, ObjectIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Integer32", "Gauge32", "TimeTicks", "Counter64", "NotificationType", "Counter32", "iso", "MibIdentifier", "ObjectIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetSize=dhcpSubnetSize, trapSystemDaemon=trapSystemDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonisObjects=adonisObjects, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, system=system, dnsDaemonRunning=dnsDaemonRunning, trapTFTP=trapTFTP, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDHCPDaemon=trapDHCPDaemon, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, dhcpIP=dhcpIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolSize=dhcpPoolSize, haServiceNodeType=haServiceNodeType, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcp=dhcp, lcd=lcd, tftp=tftp, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, trapCommandServer=trapCommandServer, trapDHCP=trapDHCP, systemState=systemState, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemon=dnsDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, adonis=adonis, dhcpDaemon=dhcpDaemon, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, adonisTraps=adonisTraps, dns=dns, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsReferral=dnsStatsReferral, dnsStats=dnsStats, trapCommandServerDaemon=trapCommandServerDaemon, commandServer=commandServer, trapHA=trapHA, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpStats=dhcpStats, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, haService=haService, dnsStatsRecursion=dnsStatsRecursion, dhcpFailOverState=dhcpFailOverState, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonRunning=dhcpDaemonRunning, PYSNMP_MODULE_ID=adonis, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsSuccess=dnsStatsSuccess, lcdDaemon=lcdDaemon, dhcpFixedIPTable=dhcpFixedIPTable, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNSDaemon=trapDNSDaemon, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplicationFailure=trapReplicationFailure, licenseExpiry=licenseExpiry)
