...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, IpAddress, NotificationType, iso, Counter32, Unsigned32, ObjectIdentity, enterprises, MibIdentifier, Bits, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "IpAddress", "NotificationType", "iso", "Counter32", "Unsigned32", "ObjectIdentity", "enterprises", "MibIdentifier", "Bits", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplicationFailure=trapReplicationFailure, systemDaemon=systemDaemon, dhcpConfig=dhcpConfig, dnsStats=dnsStats, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolStartIP=dhcpPoolStartIP, commandServer=commandServer, commandServerDaemonRunning=commandServerDaemonRunning, haServiceNodeType=haServiceNodeType, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseExpiry=licenseExpiry, PYSNMP_MODULE_ID=adonis, trapDHCPDaemon=trapDHCPDaemon, dhcp=dhcp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemon=dhcpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, system=system, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceRunning=haServiceRunning, dhcpPoolAlert=dhcpPoolAlert, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, adonis=adonis, commandServerDaemon=commandServerDaemon, dhcpSubnetUsed=dhcpSubnetUsed, lcd=lcd, trapTFTP=trapTFTP, trapReplication=trapReplication, trapDNSDaemon=trapDNSDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpStats=dhcpStats, ha=ha, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNS=trapDNS, adonisObjects=adonisObjects, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSize=dhcpPoolSize, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, trapDHCP=trapDHCP, trapSystemDaemon=trapSystemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, systemState=systemState, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, tftp=tftp, trapCommandServer=trapCommandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolUsed=dhcpPoolUsed, dhcpIP=dhcpIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haReplicationBinding=haReplicationBinding, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, haService=haService, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, dns=dns, trapSystem=trapSystem, adonisTraps=adonisTraps, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsReferral=dnsStatsReferral)
