...
Gauge32, ModuleIdentity, TimeTicks, Counter32, Bits, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, iso, enterprises, MibIdentifier, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32", "Bits", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "iso", "enterprises", "MibIdentifier", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, dhcpPoolEndIP=dhcpPoolEndIP, dhcp=dhcp, haReplicationBinding=haReplicationBinding, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsRecursion=dnsStatsRecursion, trapReplication=trapReplication, haServiceNodeType=haServiceNodeType, dhcpStats=dhcpStats, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemon=tftpDaemon, ha=ha, adonisObjects=adonisObjects, dhcpLeaseTable=dhcpLeaseTable, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXRRSet=dnsStatsNXRRSet, systemDaemon=systemDaemon, system=system, dhcpPoolUsed=dhcpPoolUsed, commandServer=commandServer, dnsStatsReferral=dnsStatsReferral, adonis=adonis, lcdDaemon=lcdDaemon, dnsDaemon=dnsDaemon, systemState=systemState, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, haServiceRunning=haServiceRunning, dhcpFixedIP=dhcpFixedIP, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haService=haService, trapCommandServer=trapCommandServer, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsSuccess=dnsStatsSuccess, adonisTraps=adonisTraps, trapHAServiceFailOver=trapHAServiceFailOver, dhcpConfig=dhcpConfig, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXDomain=dnsStatsNXDomain, PYSNMP_MODULE_ID=adonis, dhcpLeaseHostname=dhcpLeaseHostname, trapDNS=trapDNS, dnsStats=dnsStats, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, tftp=tftp, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseValid=licenseValid, dhcpSubnetIP=dhcpSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonRunning=dnsDaemonRunning, trapSystem=trapSystem, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, licenseExpiry=licenseExpiry, dhcpPoolTable=dhcpPoolTable, dns=dns, dhcpDaemon=dhcpDaemon)
