...
ObjectIdentity, Counter64, Integer32, iso, Gauge32, Counter32, ModuleIdentity, Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "iso", "Gauge32", "Counter32", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, tftp=tftp, dnsStatsReferral=dnsStatsReferral, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpConfig=dhcpConfig, trapSystem=trapSystem, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpIP=dhcpIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonRunning=dnsDaemonRunning, lcdDaemon=lcdDaemon, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, trapReplication=trapReplication, dhcpSubnetEntry=dhcpSubnetEntry, adonis=adonis, systemState=systemState, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, trapDNSDaemon=trapDNSDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dnsDaemon=dnsDaemon, PYSNMP_MODULE_ID=adonis, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, trapHA=trapHA, dhcpFixedIP=dhcpFixedIP, adonisObjects=adonisObjects, trapDHCPDaemon=trapDHCPDaemon, adonisTraps=adonisTraps, dhcpLeaseTable=dhcpLeaseTable, tftpDaemon=tftpDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemon=dhcpDaemon, dhcpPoolTable=dhcpPoolTable, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haService=haService, licenseValid=licenseValid, commandServerDaemon=commandServerDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServer=trapCommandServer, systemDaemon=systemDaemon, ha=ha)
