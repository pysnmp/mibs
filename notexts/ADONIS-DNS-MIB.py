...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Integer32, Counter64, iso, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, NotificationType, Gauge32, ModuleIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Integer32", "Counter64", "iso", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", licenseValid=licenseValid, PYSNMP_MODULE_ID=adonis, dhcpIP=dhcpIP, dhcpPoolSize=dhcpPoolSize, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceNodeType=haServiceNodeType, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemDaemon=systemDaemon, systemState=systemState, dhcpConfig=dhcpConfig, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, tftp=tftp, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetEntry=dhcpSubnetEntry, trapSystem=trapSystem, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, system=system, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemon=dnsDaemon, haService=haService, dhcp=dhcp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemon=commandServerDaemon, trapHA=trapHA, dhcpDaemonRunning=dhcpDaemonRunning, adonis=adonis, dhcpSubnetUsed=dhcpSubnetUsed, licenseExpiry=licenseExpiry, trapTFTP=trapTFTP, ha=ha, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, dhcpLeaseTable=dhcpLeaseTable, dnsStatsRecursion=dnsStatsRecursion, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, tftpDaemonRunning=tftpDaemonRunning, commandServer=commandServer, adonisObjects=adonisObjects, dhcpStats=dhcpStats, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolTable=dhcpPoolTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisTraps=adonisTraps, trapReplicationFailure=trapReplicationFailure, dhcpPoolAlert=dhcpPoolAlert, trapCommandServer=trapCommandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, lcd=lcd, haServiceRunning=haServiceRunning, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemon=dhcpDaemon, dnsStatsFailure=dnsStatsFailure, dnsStatsReferral=dnsStatsReferral)
