...
Counter32, NotificationType, ObjectIdentity, ModuleIdentity, enterprises, MibIdentifier, Bits, IpAddress, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "enterprises", "MibIdentifier", "Bits", "IpAddress", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, adonisObjects=adonisObjects, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSize=dhcpPoolSize, adonis=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dns=dns, systemState=systemState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, dhcpSubnetEntry=dhcpSubnetEntry, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, lcdDaemon=lcdDaemon, dhcpPoolUsed=dhcpPoolUsed, trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, dhcpSubnetAlert=dhcpSubnetAlert, haReplicationBinding=haReplicationBinding, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, licenseValid=licenseValid, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXDomain=dnsStatsNXDomain, adonisTraps=adonisTraps, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServer=commandServer, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, trapReplication=trapReplication, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, tftp=tftp, system=system, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsFailure=dnsStatsFailure, trapCommandServer=trapCommandServer, dhcpConfig=dhcpConfig, commandServerDaemon=commandServerDaemon, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPTable=dhcpFixedIPTable, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemon=dhcpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTP=trapTFTP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, lcd=lcd, dhcpLeaseTable=dhcpLeaseTable, haServiceNodeType=haServiceNodeType, trapDNSDaemon=trapDNSDaemon, licenseExpiry=licenseExpiry, haService=haService, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHA=trapHA, dhcpPoolAlert=dhcpPoolAlert, haServiceRunning=haServiceRunning, ha=ha, dnsStatsReferral=dnsStatsReferral)
