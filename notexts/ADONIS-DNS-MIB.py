...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, IpAddress, enterprises, Integer32, Gauge32, ObjectIdentity, Counter32, MibIdentifier, Unsigned32, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "IpAddress", "enterprises", "Integer32", "Gauge32", "ObjectIdentity", "Counter32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftpDaemon=tftpDaemon, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, trapDHCP=trapDHCP, trapHA=trapHA, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, system=system, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftp=tftp, haServiceNodeType=haServiceNodeType, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, adonisTraps=adonisTraps, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, dhcpConfig=dhcpConfig, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEntry=dhcpLeaseEntry, ha=ha, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseValid=licenseValid, dhcpLeaseBindState=dhcpLeaseBindState, adonisObjects=adonisObjects, adonis=adonis, commandServerDaemon=commandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemon=dhcpDaemon, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetTable=dhcpSubnetTable, trapTFTP=trapTFTP, trapCommandServerDaemon=trapCommandServerDaemon, trapSystem=trapSystem, tftpDaemonRunning=tftpDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral, haService=haService, dhcpLeaseTable=dhcpLeaseTable, dnsStatsSuccess=dnsStatsSuccess, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetMask=dhcpSubnetMask, haReplicationBinding=haReplicationBinding, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIP=dhcpFixedIP, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNSDaemon=trapDNSDaemon, haServiceRunning=haServiceRunning, dhcpPoolTable=dhcpPoolTable, dhcpStats=dhcpStats, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServer=commandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServer=trapCommandServer, trapSystemDaemon=trapSystemDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, dhcpPoolAlert=dhcpPoolAlert, trapReplication=trapReplication, lcdDaemon=lcdDaemon, systemDaemon=systemDaemon)
