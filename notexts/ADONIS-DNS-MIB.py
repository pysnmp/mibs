...
Gauge32, enterprises, Unsigned32, TimeTicks, Counter32, iso, ObjectIdentity, MibIdentifier, Counter64, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Unsigned32", "TimeTicks", "Counter32", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftp=tftp, dhcpSubnetTable=dhcpSubnetTable, ha=ha, trapCommandServer=trapCommandServer, systemState=systemState, system=system, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolTable=dhcpPoolTable, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, dns=dns, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, dhcpPoolEndIP=dhcpPoolEndIP, trapSystem=trapSystem, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolEntry=dhcpPoolEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIP=dhcpFixedIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemDaemon=systemDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpIP=dhcpIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetIP=dhcpSubnetIP, commandServerDaemon=commandServerDaemon, dhcpLeaseTable=dhcpLeaseTable, tftpDaemon=tftpDaemon, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, adonis=adonis, adonisObjects=adonisObjects, haServiceNodeType=haServiceNodeType, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSize=dhcpPoolSize, haReplicationBinding=haReplicationBinding, dhcpSubnetSize=dhcpSubnetSize, commandServer=commandServer, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, lcdDaemon=lcdDaemon, haServiceRunning=haServiceRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEndTime=dhcpLeaseEndTime, trapHA=trapHA, licenseValid=licenseValid, trapTFTPDaemon=trapTFTPDaemon, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCP=trapDHCP, dhcpFailOverState=dhcpFailOverState, trapSystemDaemon=trapSystemDaemon, trapHAServiceFailOver=trapHAServiceFailOver, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcp=dhcp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, haService=haService, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral)
