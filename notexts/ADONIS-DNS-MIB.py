...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, Unsigned32, TimeTicks, Counter32, MibIdentifier, Counter64, ObjectIdentity, ModuleIdentity, NotificationType, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "Unsigned32", "TimeTicks", "Counter32", "MibIdentifier", "Counter64", "ObjectIdentity", "ModuleIdentity", "NotificationType", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolUsed=dhcpPoolUsed, dnsStatsFailure=dnsStatsFailure, adonis=adonis, trapReplication=trapReplication, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, haReplicationBinding=haReplicationBinding, dhcpPoolEntry=dhcpPoolEntry, dnsDaemon=dnsDaemon, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, trapHA=trapHA, dhcpStats=dhcpStats, systemDaemon=systemDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStats=dnsStats, commandServerDaemonRunning=commandServerDaemonRunning, tftp=tftp, trapSystemDaemon=trapSystemDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolTable=dhcpPoolTable, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, dhcpConfig=dhcpConfig, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, trapCommandServer=trapCommandServer, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTPDaemon=trapTFTPDaemon, adonisObjects=adonisObjects, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDNS=trapDNS, ha=ha, dhcp=dhcp, dnsStatsSuccess=dnsStatsSuccess, commandServer=commandServer, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, systemState=systemState, PYSNMP_MODULE_ID=adonis, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetUsed=dhcpSubnetUsed, haService=haService, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcdDaemon=lcdDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNSDaemon=trapDNSDaemon, adonisTraps=adonisTraps, dnsStatsRecursion=dnsStatsRecursion, trapSystem=trapSystem, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemon=dhcpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, dhcpIP=dhcpIP, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, system=system, lcd=lcd, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetMask=dhcpSubnetMask)
