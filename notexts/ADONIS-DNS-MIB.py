...
Integer32, MibIdentifier, NotificationType, Counter32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, TimeTicks, ModuleIdentity, Gauge32, iso, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemon=dnsDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTP=trapTFTP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, trapDNSDaemon=trapDNSDaemon, dhcpSubnetMask=dhcpSubnetMask, lcd=lcd, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, tftp=tftp, systemState=systemState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseExpiry=licenseExpiry, dnsStats=dnsStats, adonisTraps=adonisTraps, lcdDaemon=lcdDaemon, adonis=adonis, trapReplicationFailure=trapReplicationFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServer=trapCommandServer, dhcpDaemon=dhcpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetTable=dhcpSubnetTable, dnsStatsSuccess=dnsStatsSuccess, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, commandServer=commandServer, dhcpPoolSize=dhcpPoolSize, dhcpFixedIP=dhcpFixedIP, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonRunning=dnsDaemonRunning, haReplicationBinding=haReplicationBinding, dns=dns, adonisObjects=adonisObjects, trapDHCP=trapDHCP, tftpDaemonRunning=tftpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, dnsStatsFailure=dnsStatsFailure, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, ha=ha, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, trapDNS=trapDNS, dhcpSubnetIP=dhcpSubnetIP, trapHA=trapHA, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcp=dhcp, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, trapReplication=trapReplication)
