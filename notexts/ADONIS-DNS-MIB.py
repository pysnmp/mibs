...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter64, Counter32, IpAddress, ObjectIdentity, MibIdentifier, Integer32, TimeTicks, NotificationType, enterprises, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter64", "Counter32", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "TimeTicks", "NotificationType", "enterprises", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServerDaemon=trapCommandServerDaemon, commandServer=commandServer, trapTFTP=trapTFTP, haService=haService, dhcpStats=dhcpStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, system=system, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, ha=ha, tftp=tftp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPTable=dhcpFixedIPTable, dhcpConfig=dhcpConfig, dhcpSubnetMask=dhcpSubnetMask, systemState=systemState, dhcpSubnetSize=dhcpSubnetSize, dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetAlert=dhcpSubnetAlert, trapSystem=trapSystem, dhcpDaemon=dhcpDaemon, dnsStatsReferral=dnsStatsReferral, adonis=adonis, trapHAServiceFailOver=trapHAServiceFailOver, systemDaemon=systemDaemon, dhcpIP=dhcpIP, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIP=dhcpFixedIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, trapDHCP=trapDHCP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemon=tftpDaemon, trapReplicationFailure=trapReplicationFailure, trapHA=trapHA, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisTraps=adonisTraps, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceRunning=haServiceRunning, PYSNMP_MODULE_ID=adonis, haReplicationBinding=haReplicationBinding, lcd=lcd, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, trapReplication=trapReplication, dhcpSubnetEntry=dhcpSubnetEntry, trapDNS=trapDNS, dhcpPoolAlert=dhcpPoolAlert)
