...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, TimeTicks, MibIdentifier, enterprises, IpAddress, Counter32, Gauge32, ObjectIdentity, ModuleIdentity, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "TimeTicks", "MibIdentifier", "enterprises", "IpAddress", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, adonisTraps=adonisTraps, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemon=commandServerDaemon, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTable=dhcpLeaseTable, tftpDaemon=tftpDaemon, dns=dns, dhcpStats=dhcpStats, dhcpPoolSize=dhcpPoolSize, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseBindState=dhcpLeaseBindState, trapSystem=trapSystem, commandServerDaemonRunning=commandServerDaemonRunning, system=system, trapCommandServerDaemon=trapCommandServerDaemon, systemDaemon=systemDaemon, trapReplication=trapReplication, tftp=tftp, dnsStatsReferral=dnsStatsReferral, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetMask=dhcpSubnetMask, licenseExpiry=licenseExpiry, trapHA=trapHA, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseStartTime=dhcpLeaseStartTime, ha=ha, haServiceRunning=haServiceRunning, licenseValid=licenseValid, adonis=adonis, dhcp=dhcp, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, trapReplicationFailure=trapReplicationFailure, trapSystemDaemon=trapSystemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDHCP=trapDHCP, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetSize=dhcpSubnetSize, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsFailure=dnsStatsFailure, dhcpConfig=dhcpConfig, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServer=trapCommandServer, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haService=haService, trapHAServiceFailOver=trapHAServiceFailOver, adonisObjects=adonisObjects, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpIP=dhcpIP, commandServer=commandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, dnsStatsRecursion=dnsStatsRecursion, trapDNSDaemon=trapDNSDaemon, dnsStatsSuccess=dnsStatsSuccess, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTP=trapTFTP, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStats=dnsStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapDNS=trapDNS, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haReplicationBinding=haReplicationBinding, dhcpFixedIP=dhcpFixedIP, dhcpSubnetIP=dhcpSubnetIP)
