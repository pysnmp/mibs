...
Gauge32, ObjectIdentity, MibIdentifier, IpAddress, Counter32, iso, NotificationType, Bits, enterprises, Unsigned32, Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter32", "iso", "NotificationType", "Bits", "enterprises", "Unsigned32", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplicationFailure=trapReplicationFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEntry=dhcpPoolEntry, ha=ha, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, licenseExpiry=licenseExpiry, trapDNSDaemon=trapDNSDaemon, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, dhcpFailOverState=dhcpFailOverState, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystem=trapSystem, dnsDaemon=dnsDaemon, adonisTraps=adonisTraps, system=system, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftp=tftp, trapReplication=trapReplication, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haReplicationBinding=haReplicationBinding, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolSubnetIP=dhcpPoolSubnetIP, PYSNMP_MODULE_ID=adonis, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIP=dhcpFixedIP, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, commandServer=commandServer, dhcp=dhcp, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, trapSystemDaemon=trapSystemDaemon, systemState=systemState, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, dhcpStats=dhcpStats, systemDaemon=systemDaemon, trapDHCP=trapDHCP, trapCommandServer=trapCommandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolTable=dhcpPoolTable, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, lcdDaemon=lcdDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapTFTPDaemon=trapTFTPDaemon, adonis=adonis, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetTable=dhcpSubnetTable, dns=dns, dhcpDaemon=dhcpDaemon, adonisObjects=adonisObjects, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetUsed=dhcpSubnetUsed, haServiceRunning=haServiceRunning, trapDNS=trapDNS, haService=haService, dhcpIP=dhcpIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsSuccess=dnsStatsSuccess)
