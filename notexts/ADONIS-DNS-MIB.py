...
TimeTicks, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Counter64, enterprises, NotificationType, Bits, Counter32, iso, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Counter64", "enterprises", "NotificationType", "Bits", "Counter32", "iso", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemon=commandServerDaemon, dhcpStats=dhcpStats, haServiceRunning=haServiceRunning, haService=haService, systemState=systemState, trapSystem=trapSystem, PYSNMP_MODULE_ID=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, dnsStatsSuccess=dnsStatsSuccess, dnsStatsRecursion=dnsStatsRecursion, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, systemDaemon=systemDaemon, lcdDaemon=lcdDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, haReplicationBinding=haReplicationBinding, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, trapReplicationFailure=trapReplicationFailure, dhcpDaemon=dhcpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dns=dns, dhcpIP=dhcpIP, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, dhcpFailOverState=dhcpFailOverState, dhcpPoolAlert=dhcpPoolAlert, system=system, dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, trapCommandServer=trapCommandServer, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEntry=dhcpPoolEntry, trapHA=trapHA, lcd=lcd, trapReplication=trapReplication, trapTFTP=trapTFTP, dnsStatsNXRRSet=dnsStatsNXRRSet, adonis=adonis, dnsStats=dnsStats, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIP=dhcpFixedIP, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, dnsStatsNXDomain=dnsStatsNXDomain, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonisObjects=adonisObjects, dnsDaemonRunning=dnsDaemonRunning, commandServer=commandServer, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolTable=dhcpPoolTable, licenseExpiry=licenseExpiry, dhcpPoolSize=dhcpPoolSize, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, ha=ha, dnsDaemon=dnsDaemon)
