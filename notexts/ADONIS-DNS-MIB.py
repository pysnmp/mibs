...
IpAddress, iso, Unsigned32, TimeTicks, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, enterprises, Gauge32, NotificationType, ObjectIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Unsigned32", "TimeTicks", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "enterprises", "Gauge32", "NotificationType", "ObjectIdentity", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemonRunning=dhcpDaemonRunning, dns=dns, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, dhcpSubnetSize=dhcpSubnetSize, trapSystem=trapSystem, tftpDaemon=tftpDaemon, systemState=systemState, systemDaemon=systemDaemon, adonisTraps=adonisTraps, dnsStatsFailure=dnsStatsFailure, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, dhcpLeaseStartTime=dhcpLeaseStartTime, lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemon=dnsDaemon, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsSuccess=dnsStatsSuccess, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dhcpSubnetTable=dhcpSubnetTable, trapHAServiceFailOver=trapHAServiceFailOver, haService=haService, adonisObjects=adonisObjects, trapTFTP=trapTFTP, commandServerDaemon=commandServerDaemon, trapReplicationFailure=trapReplicationFailure, dhcpPoolEndIP=dhcpPoolEndIP, tftp=tftp, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEntry=dhcpPoolEntry, haServiceRunning=haServiceRunning, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, dhcpFailOverState=dhcpFailOverState, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, lcdDaemon=lcdDaemon, dhcpFixedIP=dhcpFixedIP, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, commandServer=commandServer, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXDomain=dnsStatsNXDomain, trapCommandServer=trapCommandServer, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, ha=ha, trapDNS=trapDNS, adonis=adonis, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStats=dnsStats, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, trapDNSDaemon=trapDNSDaemon, system=system)
