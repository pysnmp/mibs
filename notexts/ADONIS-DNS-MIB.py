...
ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, enterprises, TimeTicks, Counter32, iso, MibIdentifier, Bits, Gauge32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "enterprises", "TimeTicks", "Counter32", "iso", "MibIdentifier", "Bits", "Gauge32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, adonisTraps=adonisTraps, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceRunning=haServiceRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolTable=dhcpPoolTable, ha=ha, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, haService=haService, adonis=adonis, dnsStatsReferral=dnsStatsReferral, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, dhcpPoolUsed=dhcpPoolUsed, adonisObjects=adonisObjects, system=system, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haReplicationBinding=haReplicationBinding, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonRunning=dnsDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, commandServer=commandServer, lcdDaemon=lcdDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapCommandServer=trapCommandServer, tftpDaemon=tftpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystemDaemon=trapSystemDaemon, trapHA=trapHA, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, lcd=lcd, dnsStats=dnsStats, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsFailure=dnsStatsFailure, systemState=systemState, dhcpLeaseEntry=dhcpLeaseEntry, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, trapDNS=trapDNS, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseBindState=dhcpLeaseBindState, trapDHCP=trapDHCP, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemon=dhcpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystem=trapSystem, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplicationFailure=trapReplicationFailure, trapDNSDaemon=trapDNSDaemon, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, dnsDaemon=dnsDaemon)
