...
MibIdentifier, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, ModuleIdentity, Unsigned32, TimeTicks, IpAddress, Gauge32, Counter32, Integer32, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks", "IpAddress", "Gauge32", "Counter32", "Integer32", "iso", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetIP=dhcpSubnetIP, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, trapDHCP=trapDHCP, trapCommandServer=trapCommandServer, dhcpPoolSize=dhcpPoolSize, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpIP=dhcpIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, tftp=tftp, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, PYSNMP_MODULE_ID=adonis, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, dhcpFixedIPTable=dhcpFixedIPTable, dns=dns, trapReplicationFailure=trapReplicationFailure, dhcpFailOverState=dhcpFailOverState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonis=adonis, commandServer=commandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcp=dhcp, adonisTraps=adonisTraps, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemon=dhcpDaemon, systemState=systemState, trapDNS=trapDNS, tftpDaemon=tftpDaemon, trapSystem=trapSystem, ha=ha, lcd=lcd, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, haService=haService, dhcpFixedIP=dhcpFixedIP, dhcpPoolTable=dhcpPoolTable, dnsStatsReferral=dnsStatsReferral, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, tftpDaemonRunning=tftpDaemonRunning, dnsDaemon=dnsDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, system=system, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, commandServerDaemonRunning=commandServerDaemonRunning, haServiceRunning=haServiceRunning, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, systemDaemon=systemDaemon, dnsStats=dnsStats, licenseExpiry=licenseExpiry, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolUsed=dhcpPoolUsed, trapDNSDaemon=trapDNSDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEntry=dhcpLeaseEntry, lcdDaemon=lcdDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dhcpConfig=dhcpConfig)
