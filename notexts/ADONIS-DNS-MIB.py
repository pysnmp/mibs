...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Integer32, ModuleIdentity, iso, Gauge32, ObjectIdentity, enterprises, Counter64, MibIdentifier, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Integer32", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity", "enterprises", "Counter64", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisTraps=adonisTraps, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haService=haService, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpLeaseTable=dhcpLeaseTable, PYSNMP_MODULE_ID=adonis, dhcp=dhcp, tftp=tftp, trapReplicationFailure=trapReplicationFailure, licenseExpiry=licenseExpiry, trapDNS=trapDNS, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIP=dhcpFixedIP, systemState=systemState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemonRunning=tftpDaemonRunning, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, commandServer=commandServer, dhcpStats=dhcpStats, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, trapReplication=trapReplication, dhcpSubnetIP=dhcpSubnetIP, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, trapDHCPDaemon=trapDHCPDaemon, trapCommandServerDaemon=trapCommandServerDaemon, adonis=adonis, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolSize=dhcpPoolSize, trapTFTP=trapTFTP, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemon=dhcpDaemon, system=system, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFailOverState=dhcpFailOverState, dhcpIP=dhcpIP, adonisObjects=adonisObjects, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, haServiceNodeType=haServiceNodeType, tftpDaemon=tftpDaemon, dns=dns, dhcpPoolAlert=dhcpPoolAlert, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystemDaemon=trapSystemDaemon, licenseValid=licenseValid, dhcpPoolEndIP=dhcpPoolEndIP)
