...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Gauge32, Bits, NotificationType, MibIdentifier, Unsigned32, TimeTicks, ModuleIdentity, Counter64, Integer32, enterprises, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter64", "Integer32", "enterprises", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolUsed=dhcpPoolUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFailOverState=dhcpFailOverState, commandServer=commandServer, trapReplication=trapReplication, trapReplicationFailure=trapReplicationFailure, systemDaemon=systemDaemon, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapCommandServer=trapCommandServer, haServiceRunning=haServiceRunning, dnsDaemonRunning=dnsDaemonRunning, licenseValid=licenseValid, licenseExpiry=licenseExpiry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemon=dhcpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonRunning=dhcpDaemonRunning, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisTraps=adonisTraps, dns=dns, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolAlert=dhcpPoolAlert, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, dnsStatsFailure=dnsStatsFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, dnsStatsNXRRSet=dnsStatsNXRRSet, tftp=tftp, tftpDaemon=tftpDaemon, trapSystem=trapSystem, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolTable=dhcpPoolTable, commandServerDaemonRunning=commandServerDaemonRunning, haReplicationBinding=haReplicationBinding, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, trapDHCPDaemon=trapDHCPDaemon, system=system, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpConfig=dhcpConfig, dhcpFixedIP=dhcpFixedIP, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNSDaemon=trapDNSDaemon, dnsDaemon=dnsDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, dhcpSubnetMask=dhcpSubnetMask, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, trapTFTP=trapTFTP, trapDNS=trapDNS, haService=haService, systemState=systemState, dhcp=dhcp, dhcpSubnetSize=dhcpSubnetSize, dnsStats=dnsStats, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseEntry=dhcpLeaseEntry, dhcpStats=dhcpStats, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable)
