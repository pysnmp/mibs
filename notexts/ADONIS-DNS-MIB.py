...
Gauge32, IpAddress, NotificationType, Counter64, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, iso, Counter32, Unsigned32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "NotificationType", "Counter64", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "iso", "Counter32", "Unsigned32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetSize=dhcpSubnetSize, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, commandServer=commandServer, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, licenseExpiry=licenseExpiry, systemState=systemState, lcdDaemon=lcdDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetMask=dhcpSubnetMask, dnsDaemon=dnsDaemon, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, adonis=adonis, PYSNMP_MODULE_ID=adonis, adonisTraps=adonisTraps, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIP=dhcpFixedIP, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemon=dhcpDaemon, tftpDaemon=tftpDaemon, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSize=dhcpPoolSize, dhcpStats=dhcpStats, trapReplicationFailure=trapReplicationFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftp=tftp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, dhcpLeaseTable=dhcpLeaseTable, trapTFTP=trapTFTP, dhcpFailOverState=dhcpFailOverState, dnsStatsFailure=dnsStatsFailure, trapDNSDaemon=trapDNSDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolTable=dhcpPoolTable, trapSystem=trapSystem, adonisObjects=adonisObjects, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, trapSystemDaemon=trapSystemDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStats=dnsStats, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemDaemon=systemDaemon, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemon=commandServerDaemon, ha=ha, system=system, dnsStatsReferral=dnsStatsReferral, haServiceRunning=haServiceRunning, haServiceNodeType=haServiceNodeType, haService=haService)
