...
Unsigned32, iso, Bits, Counter64, NotificationType, Counter32, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, ModuleIdentity, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Bits", "Counter64", "NotificationType", "Counter32", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseBindState=dhcpLeaseBindState, trapHAServiceFailOver=trapHAServiceFailOver, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsFailure=dnsStatsFailure, licenseExpiry=licenseExpiry, commandServerDaemon=commandServerDaemon, haService=haService, dhcpPoolStartIP=dhcpPoolStartIP, trapDNSDaemon=trapDNSDaemon, trapSystem=trapSystem, adonis=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolSize=dhcpPoolSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, system=system, dnsStatsReferral=dnsStatsReferral, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolTable=dhcpPoolTable, haServiceRunning=haServiceRunning, trapReplicationFailure=trapReplicationFailure, trapDNS=trapDNS, dhcpDaemon=dhcpDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetAlert=dhcpSubnetAlert, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, trapCommandServer=trapCommandServer, commandServer=commandServer, dhcpConfig=dhcpConfig, lcd=lcd, haServiceNodeType=haServiceNodeType, trapHA=trapHA, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, adonisObjects=adonisObjects, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapReplication=trapReplication, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcp=dhcp, dnsDaemonRunning=dnsDaemonRunning, dnsStats=dnsStats, lcdDaemon=lcdDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetMask=dhcpSubnetMask, systemState=systemState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, tftpDaemonRunning=tftpDaemonRunning, PYSNMP_MODULE_ID=adonis, dhcpSubnetSize=dhcpSubnetSize, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, trapSystemDaemon=trapSystemDaemon, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable)
