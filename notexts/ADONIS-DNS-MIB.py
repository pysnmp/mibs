...
Unsigned32, enterprises, Gauge32, Bits, NotificationType, MibIdentifier, Integer32, Counter32, IpAddress, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "IpAddress", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystemDaemon=trapSystemDaemon, dns=dns, trapTFTPDaemon=trapTFTPDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDNSDaemon=trapDNSDaemon, licenseValid=licenseValid, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, adonis=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetTable=dhcpSubnetTable, lcd=lcd, dnsStatsFailure=dnsStatsFailure, trapTFTP=trapTFTP, trapCommandServerDaemon=trapCommandServerDaemon, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFailOverState=dhcpFailOverState, dhcpFixedIP=dhcpFixedIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, dhcpSubnetEntry=dhcpSubnetEntry, trapDNS=trapDNS, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, trapHA=trapHA, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServer=trapCommandServer, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dhcpIP=dhcpIP, adonisObjects=adonisObjects, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcp=dhcp, trapReplication=trapReplication, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSize=dhcpPoolSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServer=commandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceNodeType=haServiceNodeType, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, systemDaemon=systemDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetUsed=dhcpSubnetUsed, haService=haService, licenseExpiry=licenseExpiry, adonisTraps=adonisTraps, dhcpConfig=dhcpConfig, system=system, ha=ha, dnsStats=dnsStats, tftp=tftp, dhcpLeaseStartTime=dhcpLeaseStartTime, haReplicationBinding=haReplicationBinding, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsReferral=dnsStatsReferral, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess)
