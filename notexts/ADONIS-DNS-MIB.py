...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, Gauge32, Counter64, enterprises, iso, MibIdentifier, Counter32, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "enterprises", "iso", "MibIdentifier", "Counter32", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsRecursion=dnsStatsRecursion, licenseValid=licenseValid, haServiceNodeType=haServiceNodeType, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplication=trapReplication, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, commandServer=commandServer, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, dnsStats=dnsStats, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haService=haService, systemDaemon=systemDaemon, dhcpLeaseHostname=dhcpLeaseHostname, trapReplicationFailure=trapReplicationFailure, trapDHCPDaemon=trapDHCPDaemon, ha=ha, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServer=trapCommandServer, haServiceRunning=haServiceRunning, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dhcpFixedIP=dhcpFixedIP, dhcpSubnetEntry=dhcpSubnetEntry, licenseExpiry=licenseExpiry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEntry=dhcpPoolEntry, dhcpFailOverState=dhcpFailOverState, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemon=tftpDaemon, dhcp=dhcp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, dnsStatsFailure=dnsStatsFailure, dhcpStats=dhcpStats, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpConfig=dhcpConfig, tftpDaemonRunning=tftpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, adonis=adonis, dhcpDaemon=dhcpDaemon, tftp=tftp, system=system, haReplicationBinding=haReplicationBinding, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, trapTFTP=trapTFTP, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, systemState=systemState, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, adonisObjects=adonisObjects, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTable=dhcpLeaseTable, trapSystemDaemon=trapSystemDaemon, dhcpSubnetIP=dhcpSubnetIP, lcd=lcd, dns=dns, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolTable=dhcpPoolTable)
