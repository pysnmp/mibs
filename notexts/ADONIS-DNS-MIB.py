...
TimeTicks, enterprises, iso, ModuleIdentity, Counter64, Bits, Unsigned32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, ObjectIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "iso", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, adonis=adonis, trapSystem=trapSystem, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, dnsStatsRecursion=dnsStatsRecursion, lcdDaemon=lcdDaemon, trapDHCP=trapDHCP, trapTFTP=trapTFTP, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIP=dhcpFixedIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, dhcpPoolSize=dhcpPoolSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, adonisObjects=adonisObjects, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dnsDaemon=dnsDaemon, system=system, haReplicationBinding=haReplicationBinding, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcp=dhcp, dhcpPoolUsed=dhcpPoolUsed, haService=haService, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetMask=dhcpSubnetMask, dnsStatsFailure=dnsStatsFailure, trapHA=trapHA, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFailOverState=dhcpFailOverState, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsReferral=dnsStatsReferral, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, commandServer=commandServer, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolTable=dhcpPoolTable, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, dhcpStats=dhcpStats, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, trapReplication=trapReplication, dhcpConfig=dhcpConfig, dnsStats=dnsStats, licenseValid=licenseValid, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemDaemon=systemDaemon, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd)
