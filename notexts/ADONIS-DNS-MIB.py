...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, iso, Counter64, Bits, NotificationType, IpAddress, TimeTicks, MibIdentifier, ModuleIdentity, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "iso", "Counter64", "Bits", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpIP=dhcpIP, system=system, PYSNMP_MODULE_ID=adonis, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHostname=dhcpLeaseHostname, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dns=dns, trapSystem=trapSystem, lcdDaemon=lcdDaemon, systemDaemon=systemDaemon, dnsStatsRecursion=dnsStatsRecursion, trapDNS=trapDNS, dhcpSubnetUsed=dhcpSubnetUsed, adonis=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemon=dnsDaemon, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcp=dhcp, haServiceNodeType=haServiceNodeType, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, tftpDaemon=tftpDaemon, licenseExpiry=licenseExpiry, dnsStatsReferral=dnsStatsReferral, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, tftp=tftp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, licenseValid=licenseValid, haServiceRunning=haServiceRunning, haReplicationBinding=haReplicationBinding, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplicationFailure=trapReplicationFailure, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, dnsStats=dnsStats, ha=ha, dhcpSubnetTable=dhcpSubnetTable, trapCommandServer=trapCommandServer, trapDHCP=trapDHCP, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemState=systemState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonRunning=dnsDaemonRunning, trapReplication=trapReplication, dhcpStats=dhcpStats, dhcpFailOverState=dhcpFailOverState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetIP=dhcpSubnetIP, adonisObjects=adonisObjects, trapHA=trapHA, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetSize=dhcpSubnetSize, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDHCPDaemon=trapDHCPDaemon, commandServer=commandServer)
