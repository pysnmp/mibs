...
Gauge32, Counter64, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, enterprises, Counter32, ObjectIdentity, iso, Unsigned32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "enterprises", "Counter32", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolUsed=dhcpPoolUsed, commandServer=commandServer, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, licenseExpiry=licenseExpiry, adonis=adonis, systemDaemon=systemDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsFailure=dnsStatsFailure, adonisTraps=adonisTraps, dhcpSubnetUsed=dhcpSubnetUsed, tftp=tftp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, trapSystem=trapSystem, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapReplicationFailure=trapReplicationFailure, lcd=lcd, dhcpDaemon=dhcpDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, haServiceRunning=haServiceRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemState=systemState, dhcpLeaseEndTime=dhcpLeaseEndTime, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, licenseValid=licenseValid, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNSDaemon=trapDNSDaemon, dhcp=dhcp, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning, ha=ha, dhcpPoolTable=dhcpPoolTable, tftpDaemon=tftpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEntry=dhcpPoolEntry, trapHAServiceFailOver=trapHAServiceFailOver, haReplicationBinding=haReplicationBinding, haService=haService, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dnsStatsRecursion=dnsStatsRecursion, adonisObjects=adonisObjects, dhcpFixedIP=dhcpFixedIP, dhcpIP=dhcpIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dns=dns, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHA=trapHA, system=system, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, trapDHCP=trapDHCP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServer=trapCommandServer, dnsStatsReferral=dnsStatsReferral, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFailOverState=dhcpFailOverState, dhcpConfig=dhcpConfig, dnsStats=dnsStats, trapTFTP=trapTFTP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSize=dhcpPoolSize, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, trapDNS=trapDNS, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon, lcdDaemon=lcdDaemon)
