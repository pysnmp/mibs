...
Integer32, MibIdentifier, Gauge32, ModuleIdentity, Counter64, Counter32, TimeTicks, NotificationType, Bits, iso, IpAddress, ObjectIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter64", "Counter32", "TimeTicks", "NotificationType", "Bits", "iso", "IpAddress", "ObjectIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, trapReplicationFailure=trapReplicationFailure, tftp=tftp, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemon=dhcpDaemon, trapDNS=trapDNS, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolTable=dhcpPoolTable, ha=ha, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, trapSystem=trapSystem, dhcpFixedIPEntry=dhcpFixedIPEntry, adonisObjects=adonisObjects, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolUsed=dhcpPoolUsed, dnsDaemon=dnsDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, licenseExpiry=licenseExpiry, system=system, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplication=trapReplication, trapTFTP=trapTFTP, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNSDaemon=trapDNSDaemon, dhcpPoolStartIP=dhcpPoolStartIP, trapHA=trapHA, haServiceRunning=haServiceRunning, dhcpLeaseHostname=dhcpLeaseHostname, licenseValid=licenseValid, lcdDaemon=lcdDaemon, trapSystemDaemon=trapSystemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServer=commandServer, dhcpLeaseTable=dhcpLeaseTable, haService=haService, dnsStats=dnsStats, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCP=trapDHCP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, dhcpPoolEntry=dhcpPoolEntry, dnsStatsFailure=dnsStatsFailure, lcd=lcd, commandServerDaemon=commandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dhcp=dhcp, systemState=systemState, dnsDaemonRunning=dnsDaemonRunning, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpStats=dhcpStats, adonis=adonis, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, haServiceNodeType=haServiceNodeType)
