...
MibIdentifier, enterprises, Bits, Unsigned32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, Counter64, iso, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "Counter64", "iso", "Integer32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseEntry=dhcpLeaseEntry, lcdDaemon=lcdDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, haService=haService, dhcpIP=dhcpIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpStats=dhcpStats, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemon=dnsDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNS=trapDNS, dhcpPoolUsed=dhcpPoolUsed, dnsStatsSuccess=dnsStatsSuccess, system=system, haServiceRunning=haServiceRunning, trapSystem=trapSystem, PYSNMP_MODULE_ID=adonis, dhcpPoolSize=dhcpPoolSize, dns=dns, haReplicationBinding=haReplicationBinding, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, ha=ha, commandServer=commandServer, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpFailOverState=dhcpFailOverState, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, trapHA=trapHA, systemDaemon=systemDaemon, adonisObjects=adonisObjects, lcd=lcd, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTable=dhcpLeaseTable, adonis=adonis, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsFailure=dnsStatsFailure, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, systemState=systemState, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, licenseValid=licenseValid, tftp=tftp, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpConfig=dhcpConfig, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, dnsStatsReferral=dnsStatsReferral, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTP=trapTFTP, dnsStats=dnsStats, trapDHCP=trapDHCP, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceNodeType=haServiceNodeType, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress)
