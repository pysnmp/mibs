...
Bits, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Unsigned32, enterprises, TimeTicks, ObjectIdentity, Counter32, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Unsigned32", "enterprises", "TimeTicks", "ObjectIdentity", "Counter32", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplication=trapReplication, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetTable=dhcpSubnetTable, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServer=trapCommandServer, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsRecursion=dnsStatsRecursion, dnsStatsFailure=dnsStatsFailure, adonis=adonis, dnsStatsNXDomain=dnsStatsNXDomain, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIPTable=dhcpFixedIPTable, licenseValid=licenseValid, adonisTraps=adonisTraps, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, commandServer=commandServer, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapTFTP=trapTFTP, dhcpPoolEntry=dhcpPoolEntry, trapReplicationFailure=trapReplicationFailure, dnsStatsReferral=dnsStatsReferral, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, dnsStatsSuccess=dnsStatsSuccess, trapSystemDaemon=trapSystemDaemon, tftpDaemon=tftpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemState=systemState, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, adonisObjects=adonisObjects, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, ha=ha, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetMask=dhcpSubnetMask, haServiceNodeType=haServiceNodeType, trapDNS=trapDNS, dns=dns, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcp=dhcp, dhcpDaemon=dhcpDaemon, commandServerDaemon=commandServerDaemon, dnsStats=dnsStats, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, PYSNMP_MODULE_ID=adonis, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolSize=dhcpPoolSize, trapHA=trapHA, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, lcdDaemon=lcdDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, system=system, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetEntry=dhcpSubnetEntry, tftp=tftp, haService=haService, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFailOverState=dhcpFailOverState, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, trapHAServiceFailOver=trapHAServiceFailOver)
