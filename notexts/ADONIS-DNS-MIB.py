...
iso, IpAddress, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Gauge32, NotificationType, Bits, TimeTicks, Integer32, Counter64, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType", "Bits", "TimeTicks", "Integer32", "Counter64", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseTable=dhcpLeaseTable, adonisObjects=adonisObjects, systemDaemon=systemDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCPDaemon=trapDHCPDaemon, dns=dns, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, trapDHCP=trapDHCP, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, commandServerDaemonRunning=commandServerDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolTable=dhcpPoolTable, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDNS=trapDNS, dhcpSubnetIP=dhcpSubnetIP, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, trapDNSDaemon=trapDNSDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, commandServer=commandServer, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, ha=ha, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, tftpDaemon=tftpDaemon, trapHA=trapHA, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetMask=dhcpSubnetMask, trapTFTP=trapTFTP, dhcpFailOverState=dhcpFailOverState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcp=dhcp, dhcpSubnetTable=dhcpSubnetTable, licenseExpiry=licenseExpiry, dhcpPoolUsed=dhcpPoolUsed, haService=haService, dnsStatsRecursion=dnsStatsRecursion, system=system, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, trapReplicationFailure=trapReplicationFailure, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, adonis=adonis, dhcpPoolSize=dhcpPoolSize, dhcpFixedIP=dhcpFixedIP, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, adonisTraps=adonisTraps, dnsStatsReferral=dnsStatsReferral, PYSNMP_MODULE_ID=adonis, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpStats=dhcpStats, haServiceRunning=haServiceRunning, dhcpPoolEntry=dhcpPoolEntry, trapSystem=trapSystem, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, licenseValid=licenseValid)
