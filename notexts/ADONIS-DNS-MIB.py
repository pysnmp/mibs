...
MibIdentifier, enterprises, Integer32, IpAddress, Counter32, ObjectIdentity, TimeTicks, Unsigned32, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Integer32", "IpAddress", "Counter32", "ObjectIdentity", "TimeTicks", "Unsigned32", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haServiceNodeType=haServiceNodeType, ha=ha, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpIP=dhcpIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolTable=dhcpPoolTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, PYSNMP_MODULE_ID=adonis, lcd=lcd, commandServer=commandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonis=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, trapHA=trapHA, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetUsed=dhcpSubnetUsed, haService=haService, commandServerDaemonRunning=commandServerDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemon=commandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapSystem=trapSystem, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemon=dhcpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemon=dnsDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolStartIP=dhcpPoolStartIP, systemState=systemState, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCP=trapDHCP, trapReplication=trapReplication, haServiceRunning=haServiceRunning, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolSize=dhcpPoolSize, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetMask=dhcpSubnetMask, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, tftpDaemon=tftpDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIP=dhcpFixedIP, haReplicationBinding=haReplicationBinding, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseBindState=dhcpLeaseBindState, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, tftp=tftp, systemDaemon=systemDaemon, licenseValid=licenseValid, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisObjects=adonisObjects, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFailOverState=dhcpFailOverState, lcdDaemon=lcdDaemon, dns=dns, licenseExpiry=licenseExpiry)
