...
Counter32, iso, ModuleIdentity, Unsigned32, TimeTicks, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter64, enterprises, Gauge32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter64", "enterprises", "Gauge32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftp=tftp, dhcpFixedIPTable=dhcpFixedIPTable, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsReferral=dnsStatsReferral, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolEndIP=dhcpPoolEndIP, system=system, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetSize=dhcpSubnetSize, ha=ha, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServerDaemon=trapCommandServerDaemon, systemDaemon=systemDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpStats=dhcpStats, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSize=dhcpPoolSize, dns=dns, tftpDaemonRunning=tftpDaemonRunning, haService=haService, trapReplication=trapReplication, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNS=trapDNS, haServiceNodeType=haServiceNodeType, dhcpDaemon=dhcpDaemon, commandServer=commandServer, trapHAServiceFailOver=trapHAServiceFailOver, trapHA=trapHA, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetIP=dhcpSubnetIP, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, dhcp=dhcp, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServer=trapCommandServer, haReplicationBinding=haReplicationBinding, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplicationFailure=trapReplicationFailure, dhcpConfig=dhcpConfig, tftpDaemon=tftpDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, dhcpPoolTable=dhcpPoolTable, systemState=systemState, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemonRunning=commandServerDaemonRunning, commandServerDaemon=commandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, adonisObjects=adonisObjects, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolUsed=dhcpPoolUsed, dnsStatsFailure=dnsStatsFailure, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, adonis=adonis, dhcpIP=dhcpIP, dnsStats=dnsStats, licenseExpiry=licenseExpiry, trapSystem=trapSystem, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, trapDHCP=trapDHCP, trapTFTP=trapTFTP, lcd=lcd, dhcpPoolAlert=dhcpPoolAlert, dnsStatsRecursion=dnsStatsRecursion, licenseValid=licenseValid)
