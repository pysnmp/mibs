...
Bits, ModuleIdentity, iso, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ObjectIdentity, Unsigned32, TimeTicks, Counter32, Counter64, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "iso", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, dhcpSubnetMask=dhcpSubnetMask, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseValid=licenseValid, trapDNS=trapDNS, adonisObjects=adonisObjects, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCPDaemon=trapDHCPDaemon, systemDaemon=systemDaemon, haServiceNodeType=haServiceNodeType, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, dhcpSubnetIP=dhcpSubnetIP, trapReplicationFailure=trapReplicationFailure, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, trapDHCP=trapDHCP, trapHAServiceFailOver=trapHAServiceFailOver, system=system, dnsStatsReferral=dnsStatsReferral, tftp=tftp, commandServer=commandServer, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, haService=haService, systemState=systemState, commandServerDaemon=commandServerDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, trapTFTPDaemon=trapTFTPDaemon, haReplicationBinding=haReplicationBinding, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, ha=ha, trapHA=trapHA, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpStats=dhcpStats, dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, trapCommandServer=trapCommandServer, dhcp=dhcp, dhcpSubnetTable=dhcpSubnetTable, tftpDaemon=tftpDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpConfig=dhcpConfig, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolUsed=dhcpPoolUsed, lcd=lcd, PYSNMP_MODULE_ID=adonis, adonis=adonis, dhcpPoolEntry=dhcpPoolEntry, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, trapReplication=trapReplication, dhcpPoolSize=dhcpPoolSize, commandServerDaemonRunning=commandServerDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpDaemon=dhcpDaemon, lcdDaemon=lcdDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDNSDaemon=trapDNSDaemon, trapTFTP=trapTFTP, dnsStatsSuccess=dnsStatsSuccess, adonisTraps=adonisTraps)
