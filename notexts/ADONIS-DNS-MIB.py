...
Gauge32, Counter32, Bits, IpAddress, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ObjectIdentity, Unsigned32, Integer32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Bits", "IpAddress", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTPDaemon=trapTFTPDaemon, trapDNS=trapDNS, commandServer=commandServer, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetIP=dhcpSubnetIP, trapDHCP=trapDHCP, dnsStatsRecursion=dnsStatsRecursion, trapSystemDaemon=trapSystemDaemon, adonis=adonis, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTable=dhcpLeaseTable, trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcp=dhcp, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemon=tftpDaemon, tftp=tftp, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, dnsStatsSuccess=dnsStatsSuccess, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolTable=dhcpPoolTable, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHA=trapHA, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSize=dhcpPoolSize, systemState=systemState, system=system, trapDHCPDaemon=trapDHCPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseValid=licenseValid, haService=haService, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolStartIP=dhcpPoolStartIP, PYSNMP_MODULE_ID=adonis, dhcpDaemon=dhcpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, dnsStats=dnsStats, dhcpPoolAlert=dhcpPoolAlert, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, haReplicationBinding=haReplicationBinding, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServer=trapCommandServer, dnsDaemon=dnsDaemon, commandServerDaemon=commandServerDaemon, dhcpFixedIP=dhcpFixedIP, lcdDaemon=lcdDaemon, trapReplicationFailure=trapReplicationFailure, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseBindState=dhcpLeaseBindState, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemonRunning=tftpDaemonRunning, licenseExpiry=licenseExpiry, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsNXRRSet=dnsStatsNXRRSet, trapTFTP=trapTFTP, dhcpSubnetEntry=dhcpSubnetEntry, trapReplication=trapReplication, dhcpPoolUsed=dhcpPoolUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpIP=dhcpIP, adonisObjects=adonisObjects, dns=dns, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon)
