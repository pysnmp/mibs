...
Bits, IpAddress, iso, Gauge32, ObjectIdentity, Unsigned32, TimeTicks, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Counter32, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Counter32", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", system=system, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer, haServiceNodeType=haServiceNodeType, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServer=commandServer, dns=dns, trapTFTPDaemon=trapTFTPDaemon, trapReplication=trapReplication, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonisObjects=adonisObjects, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonRunning=dnsDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, haService=haService, dhcpLeaseStartTime=dhcpLeaseStartTime, trapHA=trapHA, dhcpSubnetUsed=dhcpSubnetUsed, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, trapSystem=trapSystem, trapDHCP=trapDHCP, dhcpLeaseEntry=dhcpLeaseEntry, licenseExpiry=licenseExpiry, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dhcpPoolAlert=dhcpPoolAlert, lcd=lcd, dhcpSubnetEntry=dhcpSubnetEntry, systemDaemon=systemDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsFailure=dnsStatsFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapReplicationFailure=trapReplicationFailure, dhcpDaemon=dhcpDaemon, tftpDaemon=tftpDaemon, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonRunning=dhcpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, tftp=tftp, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, adonis=adonis, dhcpStats=dhcpStats, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTable=dhcpLeaseTable, PYSNMP_MODULE_ID=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, ha=ha, dhcpIP=dhcpIP, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, trapDNS=trapDNS, trapDHCPDaemon=trapDHCPDaemon, dnsStatsSuccess=dnsStatsSuccess, systemState=systemState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapTFTP=trapTFTP, dhcpSubnetSize=dhcpSubnetSize, dhcpSubnetAlert=dhcpSubnetAlert, tftpDaemonRunning=tftpDaemonRunning, lcdDaemon=lcdDaemon, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState)
