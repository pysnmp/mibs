...
Unsigned32, Gauge32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, enterprises, IpAddress, Bits, ObjectIdentity, NotificationType, Integer32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "enterprises", "IpAddress", "Bits", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsReferral=dnsStatsReferral, adonisTraps=adonisTraps, lcdDaemon=lcdDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, PYSNMP_MODULE_ID=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dns=dns, adonisObjects=adonisObjects, dhcpStats=dhcpStats, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseStartTime=dhcpLeaseStartTime, tftp=tftp, haServiceRunning=haServiceRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, dhcp=dhcp, dhcpIP=dhcpIP, dhcpPoolEntry=dhcpPoolEntry, ha=ha, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsFailure=dnsStatsFailure, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, dnsStatsRecursion=dnsStatsRecursion, trapSystemDaemon=trapSystemDaemon, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, licenseExpiry=licenseExpiry, dhcpDaemon=dhcpDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, trapReplication=trapReplication, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPEntry=dhcpFixedIPEntry, trapCommandServer=trapCommandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, dhcpConfig=dhcpConfig, trapDNSDaemon=trapDNSDaemon, trapCommandServerDaemon=trapCommandServerDaemon, haServiceNodeType=haServiceNodeType, systemDaemon=systemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCPDaemon=trapDHCPDaemon, trapReplicationFailure=trapReplicationFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFailOverState=dhcpFailOverState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolStartIP=dhcpPoolStartIP, tftpDaemon=tftpDaemon, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCP=trapDHCP, dhcpPoolEndIP=dhcpPoolEndIP)
