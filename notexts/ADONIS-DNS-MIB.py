...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIPEntry=dhcpFixedIPEntry, systemState=systemState, trapReplication=trapReplication, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetSize=dhcpSubnetSize, licenseExpiry=licenseExpiry, haService=haService, dhcpPoolTable=dhcpPoolTable, dhcpDaemon=dhcpDaemon, adonisObjects=adonisObjects, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXDomain=dnsStatsNXDomain, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseTable=dhcpLeaseTable, licenseValid=licenseValid, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseEntry=dhcpLeaseEntry, system=system, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, dhcp=dhcp, haReplicationBinding=haReplicationBinding, tftp=tftp, dnsDaemonRunning=dnsDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemon=commandServerDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsFailure=dnsStatsFailure, dhcpSubnetMask=dhcpSubnetMask, adonisTraps=adonisTraps, ha=ha, dns=dns, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, trapDNS=trapDNS, trapDNSDaemon=trapDNSDaemon, trapSystemDaemon=trapSystemDaemon, trapDHCPDaemon=trapDHCPDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, dnsStats=dnsStats, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpIP=dhcpIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftpDaemon=tftpDaemon, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, trapTFTP=trapTFTP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonis=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonRunning=dhcpDaemonRunning, lcd=lcd, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, trapReplicationFailure=trapReplicationFailure, dhcpFailOverState=dhcpFailOverState, systemDaemon=systemDaemon, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetIP=dhcpSubnetIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEndTime=dhcpLeaseEndTime)
