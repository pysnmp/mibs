...
ModuleIdentity, Counter32, Gauge32, Counter64, iso, IpAddress, ObjectIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Integer32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "iso", "IpAddress", "ObjectIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, dnsStats=dnsStats, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcp=dhcp, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetMask=dhcpSubnetMask, haReplicationBinding=haReplicationBinding, haServiceNodeType=haServiceNodeType, PYSNMP_MODULE_ID=adonis, haService=haService, trapDHCP=trapDHCP, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapReplication=trapReplication, adonisObjects=adonisObjects, dnsStatsReferral=dnsStatsReferral, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, trapSystemDaemon=trapSystemDaemon, adonis=adonis, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, trapCommandServer=trapCommandServer, lcd=lcd, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, tftp=tftp, trapTFTP=trapTFTP, trapDNS=trapDNS, lcdDaemon=lcdDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFixedIP=dhcpFixedIP, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, dnsStatsRecursion=dnsStatsRecursion, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, systemState=systemState, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemon=commandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, system=system, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetTable=dhcpSubnetTable, commandServer=commandServer, dhcpIP=dhcpIP, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpStats=dhcpStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, adonisTraps=adonisTraps, dhcpLeaseEndTime=dhcpLeaseEndTime, ha=ha, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState)
