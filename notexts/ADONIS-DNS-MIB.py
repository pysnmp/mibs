...
Integer32, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, IpAddress, Counter64, iso, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter64", "iso", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapCommandServerDaemon=trapCommandServerDaemon, trapTFTP=trapTFTP, haServiceRunning=haServiceRunning, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, commandServer=commandServer, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dhcpPoolSize=dhcpPoolSize, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, adonis=adonis, dhcpFailOverState=dhcpFailOverState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, dhcpPoolEndIP=dhcpPoolEndIP, adonisTraps=adonisTraps, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIP=dhcpFixedIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, commandServerDaemon=commandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, dnsDaemon=dnsDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dns=dns, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, dhcpSubnetUsed=dhcpSubnetUsed, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetSize=dhcpSubnetSize, trapSystemDaemon=trapSystemDaemon, haServiceNodeType=haServiceNodeType, dhcpPoolAlert=dhcpPoolAlert, tftp=tftp, licenseExpiry=licenseExpiry, trapDHCP=trapDHCP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEntry=dhcpPoolEntry, ha=ha, dhcpPoolStartIP=dhcpPoolStartIP, dhcp=dhcp, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, dhcpIP=dhcpIP, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStats=dnsStats, tftpDaemon=tftpDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpConfig=dhcpConfig, dhcpLeaseEntry=dhcpLeaseEntry, trapReplication=trapReplication, trapDHCPDaemon=trapDHCPDaemon, trapSystem=trapSystem, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, trapDNSDaemon=trapDNSDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemon=dhcpDaemon, lcd=lcd, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseTable=dhcpLeaseTable)
