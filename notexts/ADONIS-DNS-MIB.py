...
Counter64, Gauge32, ObjectIdentity, MibIdentifier, Integer32, iso, TimeTicks, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "iso", "TimeTicks", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCPDaemon=trapDHCPDaemon, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, adonis=adonis, dnsStatsReferral=dnsStatsReferral, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetUsed=dhcpSubnetUsed, trapHA=trapHA, trapTFTPDaemon=trapTFTPDaemon, tftpDaemon=tftpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNS=trapDNS, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServer=commandServer, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dns=dns, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemon=dhcpDaemon, dhcp=dhcp, commandServerDaemonRunning=commandServerDaemonRunning, lcdDaemon=lcdDaemon, trapTFTP=trapTFTP, trapHAServiceFailOver=trapHAServiceFailOver, haReplicationBinding=haReplicationBinding, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, system=system, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, dhcpPoolSize=dhcpPoolSize, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpStats=dhcpStats, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, trapDHCP=trapDHCP, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolTable=dhcpPoolTable, dhcpLeaseStartTime=dhcpLeaseStartTime, lcd=lcd, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemonRunning=tftpDaemonRunning, dnsStatsFailure=dnsStatsFailure, licenseExpiry=licenseExpiry, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDNSDaemon=trapDNSDaemon, dhcpLeaseBindState=dhcpLeaseBindState, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, tftp=tftp, adonisTraps=adonisTraps, dhcpPoolSubnetIP=dhcpPoolSubnetIP, ha=ha, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, dhcpIP=dhcpIP, dhcpPoolEntry=dhcpPoolEntry, trapSystem=trapSystem, trapCommandServerDaemon=trapCommandServerDaemon, dnsStats=dnsStats, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIP=dhcpFixedIP, PYSNMP_MODULE_ID=adonis, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPTable=dhcpFixedIPTable, trapCommandServer=trapCommandServer, trapReplication=trapReplication)
