...
MibIdentifier, Counter64, IpAddress, NotificationType, ObjectIdentity, Gauge32, Bits, ModuleIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "IpAddress", "NotificationType", "ObjectIdentity", "Gauge32", "Bits", "ModuleIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, system=system, dhcpPoolSize=dhcpPoolSize, licenseExpiry=licenseExpiry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemon=dnsDaemon, dhcpDaemon=dhcpDaemon, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemon=commandServerDaemon, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, tftp=tftp, trapReplication=trapReplication, dhcpStats=dhcpStats, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, haServiceNodeType=haServiceNodeType, adonis=adonis, lcd=lcd, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseStartTime=dhcpLeaseStartTime, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, tftpDaemon=tftpDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIP=dhcpFixedIP, trapSystemDaemon=trapSystemDaemon, dnsStatsReferral=dnsStatsReferral, dhcp=dhcp, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolUsed=dhcpPoolUsed, dhcpConfig=dhcpConfig, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapReplicationFailure=trapReplicationFailure, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpIP=dhcpIP, dhcpSubnetIP=dhcpSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpSubnetTable=dhcpSubnetTable, haService=haService, dhcpLeaseEntry=dhcpLeaseEntry, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDHCP=trapDHCP, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, dhcpPoolTable=dhcpPoolTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, adonisTraps=adonisTraps, ha=ha, dhcpSubnetMask=dhcpSubnetMask, dns=dns, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceRunning=haServiceRunning, dhcpSubnetUsed=dhcpSubnetUsed, lcdDaemon=lcdDaemon, dnsStats=dnsStats, trapTFTP=trapTFTP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert)
