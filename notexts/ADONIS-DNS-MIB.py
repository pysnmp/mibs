...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, MibIdentifier, IpAddress, NotificationType, Integer32, ObjectIdentity, Gauge32, Bits, TimeTicks, iso, Unsigned32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "MibIdentifier", "IpAddress", "NotificationType", "Integer32", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "iso", "Unsigned32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolStartIP=dhcpPoolStartIP, trapSystem=trapSystem, dhcpDaemonRunning=dhcpDaemonRunning, dhcp=dhcp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEntry=dhcpLeaseEntry, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpStats=dhcpStats, dhcpDaemon=dhcpDaemon, adonisObjects=adonisObjects, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsReferral=dnsStatsReferral, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpConfig=dhcpConfig, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, systemDaemon=systemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetMask=dhcpSubnetMask, trapDNSDaemon=trapDNSDaemon, licenseExpiry=licenseExpiry, haService=haService, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, adonisTraps=adonisTraps, PYSNMP_MODULE_ID=adonis, trapSystemDaemon=trapSystemDaemon, trapReplication=trapReplication, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolUsed=dhcpPoolUsed, tftp=tftp, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTP=trapTFTP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFailOverState=dhcpFailOverState, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, adonis=adonis, trapDNS=trapDNS, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, systemState=systemState, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXDomain=dnsStatsNXDomain, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemon=tftpDaemon, dns=dns, dnsDaemon=dnsDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcd=lcd, system=system, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHA=trapHA, trapHAServiceFailOver=trapHAServiceFailOver, lcdDaemon=lcdDaemon, dhcpPoolTable=dhcpPoolTable, haServiceNodeType=haServiceNodeType, tftpDaemonRunning=tftpDaemonRunning, dnsStatsFailure=dnsStatsFailure, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, licenseValid=licenseValid, dhcpPoolSize=dhcpPoolSize, dhcpSubnetUsed=dhcpSubnetUsed, ha=ha, commandServer=commandServer, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, dhcpLeaseTable=dhcpLeaseTable, dnsStatsNXRRSet=dnsStatsNXRRSet)
