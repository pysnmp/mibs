...
Bits, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, IpAddress, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, Counter64, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "Counter64", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemon=commandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIP=dhcpFixedIP, dnsStatsReferral=dnsStatsReferral, dnsDaemonRunning=dnsDaemonRunning, haReplicationBinding=haReplicationBinding, dhcpDaemon=dhcpDaemon, haServiceNodeType=haServiceNodeType, dnsDaemon=dnsDaemon, tftp=tftp, commandServer=commandServer, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, dhcpFailOverState=dhcpFailOverState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetUsed=dhcpSubnetUsed, adonisObjects=adonisObjects, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServer=trapCommandServer, dnsStats=dnsStats, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseTable=dhcpLeaseTable, dns=dns, trapTFTPDaemon=trapTFTPDaemon, systemDaemon=systemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonRunning=dhcpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dhcpPoolEndIP=dhcpPoolEndIP, haService=haService, haServiceRunning=haServiceRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsSuccess=dnsStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, ha=ha, PYSNMP_MODULE_ID=adonis, dhcpSubnetTable=dhcpSubnetTable, adonis=adonis, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonisTraps=adonisTraps, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, trapTFTP=trapTFTP, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, licenseValid=licenseValid, trapDHCP=trapDHCP, dhcpSubnetSize=dhcpSubnetSize, lcdDaemon=lcdDaemon, trapSystemDaemon=trapSystemDaemon, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, trapSystem=trapSystem, trapHA=trapHA, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, dhcpIP=dhcpIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetMask=dhcpSubnetMask, trapDNS=trapDNS, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, lcd=lcd, trapReplicationFailure=trapReplicationFailure, system=system, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseStartTime=dhcpLeaseStartTime)
