...
Counter32, enterprises, Counter64, iso, Unsigned32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Counter64", "iso", "Unsigned32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", PYSNMP_MODULE_ID=adonis, dhcpPoolEndIP=dhcpPoolEndIP, trapHA=trapHA, haService=haService, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haServiceRunning=haServiceRunning, trapSystemDaemon=trapSystemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dhcpPoolUsed=dhcpPoolUsed, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, trapDNSDaemon=trapDNSDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServerDaemon=commandServerDaemon, commandServer=commandServer, systemState=systemState, dhcpIP=dhcpIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSize=dhcpPoolSize, dns=dns, adonis=adonis, haReplicationBinding=haReplicationBinding, tftp=tftp, haServiceNodeType=haServiceNodeType, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemon=dhcpDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, dhcpDaemonRunning=dhcpDaemonRunning, trapDNS=trapDNS, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolTable=dhcpPoolTable, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseBindState=dhcpLeaseBindState, system=system, trapTFTP=trapTFTP, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemDaemon=systemDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHostname=dhcpLeaseHostname, adonisObjects=adonisObjects, dnsStats=dnsStats, trapSystem=trapSystem, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetTable=dhcpSubnetTable, licenseValid=licenseValid, trapCommandServer=trapCommandServer, dhcp=dhcp, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftpDaemon=tftpDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolAlert=dhcpPoolAlert, adonisTraps=adonisTraps, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dnsDaemon=dnsDaemon, dhcpLeaseEntry=dhcpLeaseEntry, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetMask=dhcpSubnetMask, dnsStatsFailure=dnsStatsFailure)
