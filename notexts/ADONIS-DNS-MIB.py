...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplication=trapReplication, haServiceRunning=haServiceRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, trapHA=trapHA, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonRunning=dhcpDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServer=trapCommandServer, trapSystem=trapSystem, adonisObjects=adonisObjects, dhcpSubnetEntry=dhcpSubnetEntry, PYSNMP_MODULE_ID=adonis, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCP=trapDHCP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolStartIP=dhcpPoolStartIP, commandServer=commandServer, system=system, dnsStatsReferral=dnsStatsReferral, haReplicationBinding=haReplicationBinding, adonisTraps=adonisTraps, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, adonis=adonis, trapTFTP=trapTFTP, dhcp=dhcp, licenseValid=licenseValid, dhcpDaemon=dhcpDaemon, tftpDaemon=tftpDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSize=dhcpPoolSize, systemState=systemState, dhcpSubnetUsed=dhcpSubnetUsed, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, licenseExpiry=licenseExpiry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTable=dhcpLeaseTable, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEntry=dhcpPoolEntry, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpFixedIP=dhcpFixedIP, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, ha=ha, lcd=lcd, dhcpSubnetIP=dhcpSubnetIP, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolTable=dhcpPoolTable, dnsDaemon=dnsDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseBindState=dhcpLeaseBindState, haService=haService, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsFailure=dnsStatsFailure, trapDNS=trapDNS, trapTFTPDaemon=trapTFTPDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsSuccess=dnsStatsSuccess, dhcpFailOverState=dhcpFailOverState, dnsStatsNXRRSet=dnsStatsNXRRSet, dns=dns, tftp=tftp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress)
