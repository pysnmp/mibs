...
Counter64, ObjectIdentity, enterprises, Integer32, Bits, TimeTicks, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, IpAddress, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "enterprises", "Integer32", "Bits", "TimeTicks", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisTraps=adonisTraps, dnsStats=dnsStats, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetIP=dhcpSubnetIP, tftp=tftp, trapSystem=trapSystem, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolTable=dhcpPoolTable, system=system, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseTable=dhcpLeaseTable, haServiceRunning=haServiceRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dns=dns, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, dhcpFixedIP=dhcpFixedIP, trapDHCPDaemon=trapDHCPDaemon, dhcpIP=dhcpIP, dhcpDaemon=dhcpDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, systemState=systemState, trapTFTPDaemon=trapTFTPDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemon=commandServerDaemon, commandServer=commandServer, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHA=trapHA, dhcpSubnetUsed=dhcpSubnetUsed, adonisObjects=adonisObjects, dhcp=dhcp, licenseExpiry=licenseExpiry, dhcpSubnetAlert=dhcpSubnetAlert, licenseValid=licenseValid, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcd=lcd, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsSuccess=dnsStatsSuccess, adonis=adonis, ha=ha, trapDNS=trapDNS, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSize=dhcpPoolSize, dhcpSubnetEntry=dhcpSubnetEntry, systemDaemon=systemDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpConfig=dhcpConfig, dnsStatsRecursion=dnsStatsRecursion, tftpDaemon=tftpDaemon, commandServerDaemonRunning=commandServerDaemonRunning, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, trapCommandServer=trapCommandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetSize=dhcpSubnetSize, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetMask=dhcpSubnetMask, lcdDaemon=lcdDaemon, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, PYSNMP_MODULE_ID=adonis, trapSystemDaemon=trapSystemDaemon, dnsStatsReferral=dnsStatsReferral, haService=haService, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, dhcpLeaseBindState=dhcpLeaseBindState, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure)
