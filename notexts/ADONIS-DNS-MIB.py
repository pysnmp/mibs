...
NotificationType, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, iso, Integer32, Bits, enterprises, ModuleIdentity, ObjectIdentity, Counter32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "iso", "Integer32", "Bits", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcdDaemon=lcdDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, licenseExpiry=licenseExpiry, lcd=lcd, dhcpDaemon=dhcpDaemon, adonis=adonis, haService=haService, dhcpSubnetSize=dhcpSubnetSize, dhcpFailOverState=dhcpFailOverState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haReplicationBinding=haReplicationBinding, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, licenseValid=licenseValid, dnsStatsNXRRSet=dnsStatsNXRRSet, tftpDaemonRunning=tftpDaemonRunning, haServiceRunning=haServiceRunning, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, dnsStatsSuccess=dnsStatsSuccess, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemon=dnsDaemon, systemState=systemState, dhcpPoolSize=dhcpPoolSize, dhcpPoolEndIP=dhcpPoolEndIP, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, haServiceNodeType=haServiceNodeType, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsReferral=dnsStatsReferral, dhcpSubnetMask=dhcpSubnetMask, dnsStatsRecursion=dnsStatsRecursion, dnsStatsFailure=dnsStatsFailure, tftpDaemon=tftpDaemon, adonisObjects=adonisObjects, dns=dns, trapSystem=trapSystem, commandServerDaemon=commandServerDaemon, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHA=trapHA, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, system=system, dhcpPoolAlert=dhcpPoolAlert, trapTFTP=trapTFTP, dhcpLeaseHostname=dhcpLeaseHostname, dhcp=dhcp, ha=ha, dhcpFixedIPTable=dhcpFixedIPTable, tftp=tftp, adonisTraps=adonisTraps, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStats=dnsStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseTable=dhcpLeaseTable)
