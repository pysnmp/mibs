...
Counter64, Integer32, Counter32, iso, Unsigned32, MibIdentifier, enterprises, ModuleIdentity, ObjectIdentity, Gauge32, Bits, IpAddress, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Counter32", "iso", "Unsigned32", "MibIdentifier", "enterprises", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Bits", "IpAddress", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, licenseExpiry=licenseExpiry, dnsStatsFailure=dnsStatsFailure, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, lcdDaemon=lcdDaemon, trapHAServiceFailOver=trapHAServiceFailOver, commandServerDaemon=commandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcp=dhcp, dhcpSubnetTable=dhcpSubnetTable, trapReplication=trapReplication, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, trapHA=trapHA, tftp=tftp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsReferral=dnsStatsReferral, trapSystem=trapSystem, haServiceNodeType=haServiceNodeType, dhcpConfig=dhcpConfig, trapReplicationFailure=trapReplicationFailure, dhcpPoolAlert=dhcpPoolAlert, haReplicationBinding=haReplicationBinding, commandServer=commandServer, trapDHCP=trapDHCP, dnsStatsSuccess=dnsStatsSuccess, systemState=systemState, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpIP=dhcpIP, trapDNS=trapDNS, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseBindState=dhcpLeaseBindState, lcd=lcd, trapDNSDaemon=trapDNSDaemon, dnsStats=dnsStats, adonisObjects=adonisObjects, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolTable=dhcpPoolTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHostname=dhcpLeaseHostname, adonis=adonis, licenseValid=licenseValid, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetEntry=dhcpSubnetEntry, haService=haService, haServiceRunning=haServiceRunning, dhcpSubnetIP=dhcpSubnetIP, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSize=dhcpPoolSize, system=system, adonisTraps=adonisTraps, dns=dns, trapCommandServer=trapCommandServer, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
