...
ObjectIdentity, Unsigned32, iso, IpAddress, TimeTicks, ModuleIdentity, NotificationType, Bits, Counter32, MibIdentifier, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "MibIdentifier", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemon=dhcpDaemon, tftp=tftp, dhcpPoolEndIP=dhcpPoolEndIP, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftpDaemon=tftpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, licenseExpiry=licenseExpiry, system=system, trapCommandServer=trapCommandServer, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpStats=dhcpStats, dhcpConfig=dhcpConfig, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemState=systemState, dhcpSubnetMask=dhcpSubnetMask, dhcp=dhcp, commandServerDaemonRunning=commandServerDaemonRunning, adonisTraps=adonisTraps, dnsStats=dnsStats, dns=dns, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceRunning=haServiceRunning, dhcpSubnetIP=dhcpSubnetIP, dnsStatsFailure=dnsStatsFailure, haReplicationBinding=haReplicationBinding, trapHA=trapHA, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSize=dhcpPoolSize, dhcpIP=dhcpIP, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNS=trapDNS, dhcpSubnetEntry=dhcpSubnetEntry, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, commandServerDaemon=commandServerDaemon, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, dhcpFixedIP=dhcpFixedIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseBindState=dhcpLeaseBindState, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolTable=dhcpPoolTable, dnsStatsReferral=dnsStatsReferral, dhcpSubnetSize=dhcpSubnetSize, dnsStatsSuccess=dnsStatsSuccess, licenseValid=licenseValid, trapDNSDaemon=trapDNSDaemon, haService=haService, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcpFailOverState=dhcpFailOverState, trapReplication=trapReplication, trapSystem=trapSystem, PYSNMP_MODULE_ID=adonis, systemDaemon=systemDaemon, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, adonis=adonis, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseEndTime=dhcpLeaseEndTime)
