...
enterprises, ModuleIdentity, ObjectIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Counter32, Unsigned32, IpAddress, Gauge32, iso, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "ObjectIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "iso", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolSize=dhcpPoolSize, dhcpSubnetIP=dhcpSubnetIP, dnsStatsSuccess=dnsStatsSuccess, dnsStatsNXDomain=dnsStatsNXDomain, adonisObjects=adonisObjects, dhcpStats=dhcpStats, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolUsed=dhcpPoolUsed, trapDHCP=trapDHCP, dhcp=dhcp, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetTable=dhcpSubnetTable, dnsStats=dnsStats, dnsStatsReferral=dnsStatsReferral, haService=haService, dhcpIP=dhcpIP, adonis=adonis, systemDaemon=systemDaemon, PYSNMP_MODULE_ID=adonis, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIP=dhcpFixedIP, dhcpFailOverState=dhcpFailOverState, trapTFTP=trapTFTP, commandServer=commandServer, dns=dns, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetSize=dhcpSubnetSize, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, tftpDaemon=tftpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, haReplicationBinding=haReplicationBinding, trapDNS=trapDNS, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemon=commandServerDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolTable=dhcpPoolTable, trapHAServiceFailOver=trapHAServiceFailOver, lcdDaemon=lcdDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseValid=licenseValid, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplicationFailure=trapReplicationFailure, dhcpDaemon=dhcpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, trapReplication=trapReplication, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, dhcpConfig=dhcpConfig, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, trapDHCPDaemon=trapDHCPDaemon, dnsDaemon=dnsDaemon, adonisTraps=adonisTraps, systemState=systemState, trapSystem=trapSystem, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, system=system, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseStartTime=dhcpLeaseStartTime, ha=ha, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcd=lcd, haServiceRunning=haServiceRunning)
