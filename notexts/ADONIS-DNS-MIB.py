...
Integer32, Counter32, Gauge32, ModuleIdentity, Bits, IpAddress, Unsigned32, MibIdentifier, NotificationType, enterprises, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "ModuleIdentity", "Bits", "IpAddress", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServer=commandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSize=dhcpPoolSize, dhcpPoolTable=dhcpPoolTable, trapHA=trapHA, trapDHCP=trapDHCP, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, tftp=tftp, adonis=adonis, lcdDaemon=lcdDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, trapTFTP=trapTFTP, dnsStatsFailure=dnsStatsFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpFailOverState=dhcpFailOverState, haService=haService, dns=dns, haServiceRunning=haServiceRunning, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, dhcp=dhcp, trapDNSDaemon=trapDNSDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIP=dhcpFixedIP, dhcpStats=dhcpStats, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsReferral=dnsStatsReferral, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpIP=dhcpIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolEndIP=dhcpPoolEndIP, PYSNMP_MODULE_ID=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, haReplicationBinding=haReplicationBinding, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetIP=dhcpSubnetIP, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, trapReplication=trapReplication, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, trapDNS=trapDNS, lcd=lcd, dnsDaemon=dnsDaemon, dhcpPoolUsed=dhcpPoolUsed, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, adonisTraps=adonisTraps, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, licenseExpiry=licenseExpiry, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, dhcpLeaseEndTime=dhcpLeaseEndTime, adonisObjects=adonisObjects, systemDaemon=systemDaemon, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetTable=dhcpSubnetTable, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon)
