...
IpAddress, Bits, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, iso, MibIdentifier, NotificationType, TimeTicks, Unsigned32, enterprises, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "iso", "MibIdentifier", "NotificationType", "TimeTicks", "Unsigned32", "enterprises", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcp=dhcp, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolEndIP=dhcpPoolEndIP, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, licenseValid=licenseValid, trapDNS=trapDNS, dnsStatsReferral=dnsStatsReferral, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpFixedIPTable=dhcpFixedIPTable, trapHAServiceFailOver=trapHAServiceFailOver, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, haService=haService, PYSNMP_MODULE_ID=adonis, tftpDaemonRunning=tftpDaemonRunning, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, dhcpLeaseHostname=dhcpLeaseHostname, trapReplication=trapReplication, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, lcdDaemon=lcdDaemon, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemonRunning=commandServerDaemonRunning, tftpDaemon=tftpDaemon, dnsDaemon=dnsDaemon, dhcpDaemonRunning=dhcpDaemonRunning, licenseExpiry=licenseExpiry, lcd=lcd, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, systemDaemon=systemDaemon, adonisTraps=adonisTraps, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, commandServer=commandServer, dhcpPoolSize=dhcpPoolSize, adonis=adonis, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolAlert=dhcpPoolAlert, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHA=trapHA, dhcpSubnetEntry=dhcpSubnetEntry, dnsStats=dnsStats, dhcpPoolTable=dhcpPoolTable, dhcpSubnetIP=dhcpSubnetIP, haServiceRunning=haServiceRunning, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, dhcpDaemon=dhcpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapSystemDaemon=trapSystemDaemon, tftp=tftp, commandServerDaemon=commandServerDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, dns=dns, trapTFTP=trapTFTP, haReplicationBinding=haReplicationBinding, dhcpFixedIP=dhcpFixedIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpIP=dhcpIP, haServiceNodeType=haServiceNodeType, trapDHCPDaemon=trapDHCPDaemon)
