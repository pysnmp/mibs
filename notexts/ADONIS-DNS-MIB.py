...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dns=dns, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, tftpDaemon=tftpDaemon, trapTFTP=trapTFTP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPTable=dhcpFixedIPTable, system=system, dhcpPoolAlert=dhcpPoolAlert, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, adonisObjects=adonisObjects, dhcpPoolEntry=dhcpPoolEntry, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, dnsDaemon=dnsDaemon, dhcpPoolUsed=dhcpPoolUsed, trapReplicationFailure=trapReplicationFailure, dhcp=dhcp, dhcpStats=dhcpStats, adonisTraps=adonisTraps, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, dhcpSubnetTable=dhcpSubnetTable, trapReplication=trapReplication, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonRunning=dnsDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpIP=dhcpIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, tftp=tftp, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSize=dhcpPoolSize, systemState=systemState, trapSystemDaemon=trapSystemDaemon, lcd=lcd, dhcpPoolTable=dhcpPoolTable, trapCommandServer=trapCommandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsFailure=dnsStatsFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, ha=ha, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, dhcpDaemon=dhcpDaemon, dnsStats=dnsStats, dnsStatsReferral=dnsStatsReferral, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonis=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseEntry=dhcpLeaseEntry, haService=haService, trapDNS=trapDNS, dhcpConfig=dhcpConfig, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXRRSet=dnsStatsNXRRSet, trapHA=trapHA)
