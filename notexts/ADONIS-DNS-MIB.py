...
enterprises, iso, ModuleIdentity, Integer32, Counter64, IpAddress, TimeTicks, MibIdentifier, NotificationType, Gauge32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "ModuleIdentity", "Integer32", "Counter64", "IpAddress", "TimeTicks", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolTable=dhcpPoolTable, dnsStatsRecursion=dnsStatsRecursion, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsFailure=dnsStatsFailure, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIP=dhcpFixedIP, haService=haService, trapCommandServer=trapCommandServer, haServiceRunning=haServiceRunning, trapSystem=trapSystem, trapTFTP=trapTFTP, commandServerDaemon=commandServerDaemon, trapReplication=trapReplication, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcd=lcd, dhcp=dhcp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseBindState=dhcpLeaseBindState, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonisTraps=adonisTraps, commandServer=commandServer, dnsDaemonRunning=dnsDaemonRunning, dhcpStats=dhcpStats, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, trapDNSDaemon=trapDNSDaemon, haReplicationBinding=haReplicationBinding, dhcpSubnetIP=dhcpSubnetIP, dhcpFailOverState=dhcpFailOverState, dnsStatsSuccess=dnsStatsSuccess, adonisObjects=adonisObjects, trapDHCPDaemon=trapDHCPDaemon, dhcpConfig=dhcpConfig, tftp=tftp, lcdDaemon=lcdDaemon, dns=dns, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, ha=ha, dhcpPoolUsed=dhcpPoolUsed, trapDHCP=trapDHCP, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemon=dhcpDaemon, systemDaemon=systemDaemon, trapDNS=trapDNS, adonis=adonis, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, system=system, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsReferral=dnsStatsReferral, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetAlert=dhcpSubnetAlert, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, licenseValid=licenseValid, trapReplicationFailure=trapReplicationFailure, dnsStats=dnsStats, dhcpPoolSize=dhcpPoolSize)
