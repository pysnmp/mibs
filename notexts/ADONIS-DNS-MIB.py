...
Integer32, MibIdentifier, TimeTicks, IpAddress, enterprises, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, ModuleIdentity, iso, Gauge32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "TimeTicks", "IpAddress", "enterprises", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "ModuleIdentity", "iso", "Gauge32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, tftpDaemon=tftpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetTable=dhcpSubnetTable, adonisTraps=adonisTraps, dhcpPoolSize=dhcpPoolSize, PYSNMP_MODULE_ID=adonis, commandServer=commandServer, commandServerDaemonRunning=commandServerDaemonRunning, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, trapDHCPDaemon=trapDHCPDaemon, dhcp=dhcp, tftp=tftp, trapHAServiceFailOver=trapHAServiceFailOver, trapDNS=trapDNS, dhcpFixedIP=dhcpFixedIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceRunning=haServiceRunning, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXRRSet=dnsStatsNXRRSet, lcdDaemon=lcdDaemon, systemDaemon=systemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseValid=licenseValid, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, dhcpDaemon=dhcpDaemon, dhcpIP=dhcpIP, adonis=adonis, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolStartIP=dhcpPoolStartIP, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemon=commandServerDaemon, dhcpLeaseHostname=dhcpLeaseHostname, systemState=systemState, dhcpStats=dhcpStats, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dns=dns, dhcpFailOverState=dhcpFailOverState, haServiceNodeType=haServiceNodeType, dnsStatsRecursion=dnsStatsRecursion, trapTFTP=trapTFTP, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, licenseExpiry=licenseExpiry, trapSystem=trapSystem, dhcpSubnetSize=dhcpSubnetSize, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, trapSystemDaemon=trapSystemDaemon, trapCommandServer=trapCommandServer, haService=haService, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, adonisObjects=adonisObjects, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, dhcpSubnetMask=dhcpSubnetMask, haReplicationBinding=haReplicationBinding, dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolTable=dhcpPoolTable)
