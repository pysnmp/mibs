...
Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Integer32, ModuleIdentity, Bits, Counter64, Counter32, Unsigned32, iso, TimeTicks, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "Counter64", "Counter32", "Unsigned32", "iso", "TimeTicks", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCP=trapDHCP, dhcpPoolUsed=dhcpPoolUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, dhcpLeaseHostname=dhcpLeaseHostname, lcd=lcd, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisObjects=adonisObjects, dns=dns, commandServerDaemon=commandServerDaemon, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemon=tftpDaemon, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, haService=haService, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, systemDaemon=systemDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapSystem=trapSystem, dhcpFixedIP=dhcpFixedIP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapSystemDaemon=trapSystemDaemon, dnsStatsFailure=dnsStatsFailure, dhcpPoolEntry=dhcpPoolEntry, trapCommandServer=trapCommandServer, dnsStats=dnsStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, ha=ha, commandServer=commandServer, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFailOverState=dhcpFailOverState, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapReplicationFailure=trapReplicationFailure, dhcpDaemon=dhcpDaemon, tftp=tftp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetEntry=dhcpSubnetEntry, dhcp=dhcp, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, lcdDaemon=lcdDaemon, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, licenseValid=licenseValid, haReplicationBinding=haReplicationBinding, dhcpSubnetSize=dhcpSubnetSize, commandServerDaemonRunning=commandServerDaemonRunning, haServiceNodeType=haServiceNodeType, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTable=dhcpLeaseTable, trapDHCPDaemon=trapDHCPDaemon, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, trapHA=trapHA, dhcpIP=dhcpIP, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, dhcpConfig=dhcpConfig, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDNS=trapDNS, adonisTraps=adonisTraps, dhcpSubnetMask=dhcpSubnetMask, systemState=systemState, dnsDaemon=dnsDaemon)
