...
ObjectIdentity, Gauge32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, iso, Counter64, TimeTicks, Counter32, IpAddress, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "iso", "Counter64", "TimeTicks", "Counter32", "IpAddress", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapDHCPDaemon=trapDHCPDaemon, systemState=systemState, adonisObjects=adonisObjects, system=system, trapHA=trapHA, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServerDaemon=commandServerDaemon, dhcpStats=dhcpStats, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, dhcpDaemon=dhcpDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, haService=haService, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, dhcpFixedIP=dhcpFixedIP, trapTFTP=trapTFTP, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, trapHAServiceFailOver=trapHAServiceFailOver, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, dhcpFailOverState=dhcpFailOverState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haServiceRunning=haServiceRunning, haServiceNodeType=haServiceNodeType, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, dnsStats=dnsStats, haReplicationBinding=haReplicationBinding, dhcpPoolStartIP=dhcpPoolStartIP, trapDNS=trapDNS, dnsStatsRecursion=dnsStatsRecursion, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonRunning=dnsDaemonRunning, PYSNMP_MODULE_ID=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetIP=dhcpSubnetIP, dhcpDaemonRunning=dhcpDaemonRunning, licenseValid=licenseValid, trapReplication=trapReplication, dhcpPoolEntry=dhcpPoolEntry, adonis=adonis, ha=ha, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, dhcpSubnetAlert=dhcpSubnetAlert, dhcpConfig=dhcpConfig, trapTFTPDaemon=trapTFTPDaemon, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, commandServer=commandServer, dnsDaemon=dnsDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystem=trapSystem, adonisTraps=adonisTraps, dhcp=dhcp, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseExpiry=licenseExpiry)
