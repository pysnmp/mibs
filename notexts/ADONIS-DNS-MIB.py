...
Bits, enterprises, NotificationType, ObjectIdentity, iso, MibIdentifier, Gauge32, Counter64, ModuleIdentity, TimeTicks, Integer32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "NotificationType", "ObjectIdentity", "iso", "MibIdentifier", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks", "Integer32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolUsed=dhcpPoolUsed, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFailOverState=dhcpFailOverState, haService=haService, dnsStats=dnsStats, dnsDaemonRunning=dnsDaemonRunning, ha=ha, dhcpLeaseEntry=dhcpLeaseEntry, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, trapCommandServer=trapCommandServer, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemon=tftpDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, PYSNMP_MODULE_ID=adonis, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsFailure=dnsStatsFailure, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, dhcpConfig=dhcpConfig, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, dhcpStats=dhcpStats, adonisTraps=adonisTraps, commandServer=commandServer, trapReplication=trapReplication, trapDNS=trapDNS, trapHA=trapHA, dhcpIP=dhcpIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTable=dhcpLeaseTable, trapHAServiceFailOver=trapHAServiceFailOver, trapSystem=trapSystem, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, haServiceNodeType=haServiceNodeType, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, system=system, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, trapTFTP=trapTFTP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsReferral=dnsStatsReferral, dhcpSubnetEntry=dhcpSubnetEntry, tftp=tftp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, adonis=adonis, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemon=dhcpDaemon, dns=dns, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, systemDaemon=systemDaemon, commandServerDaemon=commandServerDaemon, lcd=lcd)
