...
Counter64, Unsigned32, IpAddress, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, NotificationType, iso, ModuleIdentity, Bits, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "IpAddress", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "NotificationType", "iso", "ModuleIdentity", "Bits", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcdDaemon=lcdDaemon, dhcpPoolSize=dhcpPoolSize, trapTFTPDaemon=trapTFTPDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, tftpDaemon=tftpDaemon, system=system, dhcpPoolEndIP=dhcpPoolEndIP, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpConfig=dhcpConfig, dhcpDaemonRunning=dhcpDaemonRunning, haServiceNodeType=haServiceNodeType, trapDHCP=trapDHCP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, commandServer=commandServer, lcd=lcd, trapReplication=trapReplication, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, haServiceRunning=haServiceRunning, adonisObjects=adonisObjects, systemDaemon=systemDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, trapSystem=trapSystem, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNSDaemon=trapDNSDaemon, trapHA=trapHA, dhcpSubnetTable=dhcpSubnetTable, ha=ha, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, dhcpFixedIP=dhcpFixedIP, haService=haService, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystemDaemon=trapSystemDaemon, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dhcpPoolUsed=dhcpPoolUsed, dnsStatsFailure=dnsStatsFailure, commandServerDaemon=commandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapHAServiceFailOver=trapHAServiceFailOver, trapTFTP=trapTFTP, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpStats=dhcpStats, trapDNS=trapDNS, dhcpSubnetUsed=dhcpSubnetUsed, haReplicationBinding=haReplicationBinding, systemState=systemState, dnsDaemon=dnsDaemon, licenseValid=licenseValid, PYSNMP_MODULE_ID=adonis, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemon=dhcpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, dnsStatsReferral=dnsStatsReferral, tftp=tftp, dnsStatsRecursion=dnsStatsRecursion, dhcp=dhcp, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dns=dns, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolStartIP=dhcpPoolStartIP, adonisTraps=adonisTraps, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseBindState=dhcpLeaseBindState)
