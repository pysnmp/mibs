...
iso, Gauge32, MibIdentifier, ObjectIdentity, IpAddress, enterprises, ModuleIdentity, Counter64, TimeTicks, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibIdentifier", "ObjectIdentity", "IpAddress", "enterprises", "ModuleIdentity", "Counter64", "TimeTicks", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseBindState=dhcpLeaseBindState, trapDNS=trapDNS, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCPDaemon=trapDHCPDaemon, dnsStatsFailure=dnsStatsFailure, dhcpStats=dhcpStats, dhcp=dhcp, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXDomain=dnsStatsNXDomain, dnsStats=dnsStats, licenseValid=licenseValid, dhcpPoolTable=dhcpPoolTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, haReplicationBinding=haReplicationBinding, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, commandServerDaemon=commandServerDaemon, trapReplication=trapReplication, systemDaemon=systemDaemon, dhcpSubnetMask=dhcpSubnetMask, ha=ha, tftpDaemonRunning=tftpDaemonRunning, tftp=tftp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetTable=dhcpSubnetTable, trapSystem=trapSystem, adonis=adonis, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetSize=dhcpSubnetSize, trapHAServiceFailOver=trapHAServiceFailOver, haService=haService, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFixedIP=dhcpFixedIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapCommandServer=trapCommandServer, dnsStatsRecursion=dnsStatsRecursion, lcd=lcd, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseEntry=dhcpLeaseEntry, haServiceNodeType=haServiceNodeType, dhcpLeaseTable=dhcpLeaseTable, commandServer=commandServer, licenseExpiry=licenseExpiry, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetAlert=dhcpSubnetAlert, trapHA=trapHA, dnsStatsSuccess=dnsStatsSuccess, dhcpIP=dhcpIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemon=dhcpDaemon, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpConfig=dhcpConfig, dhcpPoolEndIP=dhcpPoolEndIP, haServiceRunning=haServiceRunning, trapSystemDaemon=trapSystemDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, dhcpFixedIPTable=dhcpFixedIPTable, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, adonisTraps=adonisTraps, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolSize=dhcpPoolSize, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, system=system, systemState=systemState, dhcpPoolEntry=dhcpPoolEntry, dnsDaemon=dnsDaemon, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, dhcpSubnetIP=dhcpSubnetIP, dnsStatsReferral=dnsStatsReferral, dhcpPoolUsed=dhcpPoolUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns)
