...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, NotificationType, Counter32, TimeTicks, Integer32, Counter64, ModuleIdentity, enterprises, iso, Bits, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "NotificationType", "Counter32", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "enterprises", "iso", "Bits", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsReferral=dnsStatsReferral, licenseValid=licenseValid, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, trapCommandServer=trapCommandServer, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, ha=ha, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsFailure=dnsStatsFailure, commandServer=commandServer, dhcpSubnetIP=dhcpSubnetIP, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, PYSNMP_MODULE_ID=adonis, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapSystem=trapSystem, dhcpSubnetUsed=dhcpSubnetUsed, trapTFTP=trapTFTP, licenseExpiry=licenseExpiry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemDaemon=systemDaemon, dhcpDaemon=dhcpDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, haServiceRunning=haServiceRunning, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolEntry=dhcpPoolEntry, dhcpStats=dhcpStats, lcd=lcd, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCPDaemon=trapDHCPDaemon, system=system, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, tftpDaemon=tftpDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, trapReplication=trapReplication, dhcpFixedIP=dhcpFixedIP, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHA=trapHA, systemState=systemState, dhcpIP=dhcpIP, dhcpConfig=dhcpConfig, dnsStatsNXRRSet=dnsStatsNXRRSet, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpFailOverState=dhcpFailOverState, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetAlert=dhcpSubnetAlert, lcdDaemon=lcdDaemon, dnsStatsRecursion=dnsStatsRecursion, adonisObjects=adonisObjects, dhcpLeaseHostname=dhcpLeaseHostname, adonisTraps=adonisTraps, tftp=tftp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dns=dns, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, tftpDaemonRunning=tftpDaemonRunning, trapDHCP=trapDHCP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, trapDNSDaemon=trapDNSDaemon, trapSystemDaemon=trapSystemDaemon)
