...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", tftpDaemonRunning=tftpDaemonRunning, dhcpConfig=dhcpConfig, trapDHCP=trapDHCP, haServiceNodeType=haServiceNodeType, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseBindState=dhcpLeaseBindState, dns=dns, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, haService=haService, PYSNMP_MODULE_ID=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFailOverState=dhcpFailOverState, adonisObjects=adonisObjects, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServer=commandServer, trapDNS=trapDNS, haServiceRunning=haServiceRunning, trapSystemDaemon=trapSystemDaemon, systemState=systemState, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, trapDHCPDaemon=trapDHCPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, lcdDaemon=lcdDaemon, system=system, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, systemDaemon=systemDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, tftpDaemon=tftpDaemon, dnsStats=dnsStats, dnsDaemon=dnsDaemon, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServer=trapCommandServer, dhcpLeaseHostname=dhcpLeaseHostname, trapReplication=trapReplication, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemon=dhcpDaemon, dhcpPoolSize=dhcpPoolSize, trapTFTP=trapTFTP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, ha=ha, adonisTraps=adonisTraps, trapReplicationFailure=trapReplicationFailure, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIP=dhcpFixedIP, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHA=trapHA, licenseValid=licenseValid, dhcpSubnetTable=dhcpSubnetTable, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, dnsStatsFailure=dnsStatsFailure, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, trapDNSDaemon=trapDNSDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, haReplicationBinding=haReplicationBinding, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, tftp=tftp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, lcd=lcd, adonis=adonis)
