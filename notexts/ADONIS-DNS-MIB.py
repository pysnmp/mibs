...
Integer32, NotificationType, IpAddress, Unsigned32, enterprises, TimeTicks, Bits, Counter64, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "IpAddress", "Unsigned32", "enterprises", "TimeTicks", "Bits", "Counter64", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolStartIP=dhcpPoolStartIP, trapDHCP=trapDHCP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplication=trapReplication, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dnsStats=dnsStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPTable=dhcpFixedIPTable, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServer=commandServer, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetEntry=dhcpSubnetEntry, dhcpFailOverState=dhcpFailOverState, dhcpPoolEntry=dhcpPoolEntry, licenseValid=licenseValid, haReplicationBinding=haReplicationBinding, tftpDaemon=tftpDaemon, haServiceRunning=haServiceRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, dhcpStats=dhcpStats, tftpDaemonRunning=tftpDaemonRunning, adonisObjects=adonisObjects, trapTFTP=trapTFTP, systemDaemon=systemDaemon, dhcpPoolTable=dhcpPoolTable, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpConfig=dhcpConfig, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, dhcpSubnetUsed=dhcpSubnetUsed, dhcp=dhcp, trapSystem=trapSystem, systemState=systemState, lcdDaemon=lcdDaemon, ha=ha, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haService=haService, dhcpDaemon=dhcpDaemon, trapReplicationFailure=trapReplicationFailure, haServiceNodeType=haServiceNodeType, licenseExpiry=licenseExpiry, trapDNSDaemon=trapDNSDaemon, tftp=tftp, lcd=lcd, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsReferral=dnsStatsReferral, adonis=adonis, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystemDaemon=trapSystemDaemon, dnsStatsSuccess=dnsStatsSuccess, trapDNS=trapDNS, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, trapHAServiceFailOver=trapHAServiceFailOver, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapCommandServer=trapCommandServer)
