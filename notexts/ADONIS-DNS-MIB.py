...
Unsigned32, MibIdentifier, IpAddress, Counter64, Gauge32, NotificationType, Bits, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "IpAddress", "Counter64", "Gauge32", "NotificationType", "Bits", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapTFTP=trapTFTP, trapSystemDaemon=trapSystemDaemon, commandServerDaemon=commandServerDaemon, lcd=lcd, system=system, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapCommandServerDaemon=trapCommandServerDaemon, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, dhcpFixedIPTable=dhcpFixedIPTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, licenseValid=licenseValid, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseHostname=dhcpLeaseHostname, trapHA=trapHA, ha=ha, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapReplicationFailure=trapReplicationFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dhcpConfig=dhcpConfig, dhcpSubnetTable=dhcpSubnetTable, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpStats=dhcpStats, dnsStats=dnsStats, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonRunning=dnsDaemonRunning, dhcpFailOverState=dhcpFailOverState, haServiceRunning=haServiceRunning, licenseExpiry=licenseExpiry, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemon=dnsDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplication=trapReplication, haReplicationBinding=haReplicationBinding, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, systemDaemon=systemDaemon, dns=dns, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, commandServer=commandServer, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolUsed=dhcpPoolUsed, adonisObjects=adonisObjects, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsSuccess=dnsStatsSuccess, trapDNSDaemon=trapDNSDaemon, trapDHCP=trapDHCP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemon=dhcpDaemon, tftpDaemon=tftpDaemon, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, dnsStatsReferral=dnsStatsReferral, haServiceNodeType=haServiceNodeType, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseTable=dhcpLeaseTable, dnsStatsNXRRSet=dnsStatsNXRRSet, tftp=tftp, trapCommandServer=trapCommandServer, dhcpLeaseBindState=dhcpLeaseBindState, adonisTraps=adonisTraps, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetIP=dhcpSubnetIP, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, haService=haService, lcdDaemon=lcdDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolSubnetIP=dhcpPoolSubnetIP, adonis=adonis)
