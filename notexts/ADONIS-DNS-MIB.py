...
ObjectIdentity, Integer32, Unsigned32, TimeTicks, Counter32, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, iso, ModuleIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "iso", "ModuleIdentity", "Counter64", "Bits")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapCommandServer=trapCommandServer, adonisTraps=adonisTraps, haReplicationBinding=haReplicationBinding, dhcpStats=dhcpStats, trapDNS=trapDNS, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftp=tftp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsRecursion=dnsStatsRecursion, trapSystemDaemon=trapSystemDaemon, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, haServiceNodeType=haServiceNodeType, dns=dns, lcd=lcd, systemState=systemState, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, dhcp=dhcp, ha=ha, dhcpConfig=dhcpConfig, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemon=commandServerDaemon, dhcpFailOverState=dhcpFailOverState, trapDHCP=trapDHCP, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapReplicationFailure=trapReplicationFailure, trapDHCPDaemon=trapDHCPDaemon, dnsStatsReferral=dnsStatsReferral, dnsStatsSuccess=dnsStatsSuccess, dnsDaemon=dnsDaemon, system=system, trapSystem=trapSystem, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolTable=dhcpPoolTable, dhcpFixedIPEntry=dhcpFixedIPEntry, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseTable=dhcpLeaseTable, trapReplication=trapReplication, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemon=dhcpDaemon, haService=haService, dnsStats=dnsStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetSize=dhcpSubnetSize, trapDNSDaemon=trapDNSDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolStartIP=dhcpPoolStartIP, dnsStatsFailure=dnsStatsFailure, PYSNMP_MODULE_ID=adonis, adonisObjects=adonisObjects, dhcpSubnetTable=dhcpSubnetTable, trapTFTP=trapTFTP, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseExpiry=licenseExpiry, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHA=trapHA, dhcpPoolUsed=dhcpPoolUsed, tftpDaemon=tftpDaemon, haServiceRunning=haServiceRunning, commandServerDaemonRunning=commandServerDaemonRunning, commandServer=commandServer, trapHAServiceFailOver=trapHAServiceFailOver)
