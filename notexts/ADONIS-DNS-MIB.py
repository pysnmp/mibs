...
IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Gauge32, iso, Integer32, enterprises, MibIdentifier, ObjectIdentity, ModuleIdentity, Unsigned32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Gauge32", "iso", "Integer32", "enterprises", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonis=adonis, dhcpSubnetSize=dhcpSubnetSize, trapDNSDaemon=trapDNSDaemon, commandServer=commandServer, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, system=system, trapSystem=trapSystem, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTable=dhcpLeaseTable, dhcpStats=dhcpStats, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, trapReplication=trapReplication, trapTFTP=trapTFTP, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, trapDHCP=trapDHCP, haServiceRunning=haServiceRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, PYSNMP_MODULE_ID=adonis, dhcpDaemon=dhcpDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsFailure=dnsStatsFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpConfig=dhcpConfig, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, systemState=systemState, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetAlert=dhcpSubnetAlert, trapDNS=trapDNS, dnsDaemonRunning=dnsDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, ha=ha, dhcpPoolEndIP=dhcpPoolEndIP, lcd=lcd, dnsStatsSuccess=dnsStatsSuccess, adonisObjects=adonisObjects, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStats=dnsStats, trapSystemDaemon=trapSystemDaemon, dhcpFixedIP=dhcpFixedIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, systemDaemon=systemDaemon, trapHA=trapHA, dhcpPoolSize=dhcpPoolSize, dhcpSubnetMask=dhcpSubnetMask, licenseExpiry=licenseExpiry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetIP=dhcpSubnetIP, dnsStatsRecursion=dnsStatsRecursion, licenseValid=licenseValid, haService=haService, dnsDaemon=dnsDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpFailOverState=dhcpFailOverState, tftpDaemon=tftpDaemon, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemon=commandServerDaemon, trapCommandServer=trapCommandServer, dhcpFixedIPTable=dhcpFixedIPTable, dhcp=dhcp)
