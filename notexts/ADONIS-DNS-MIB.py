...
ModuleIdentity, Bits, Counter32, MibIdentifier, Gauge32, TimeTicks, ObjectIdentity, iso, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "MibIdentifier", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", haServiceNodeType=haServiceNodeType, tftpDaemon=tftpDaemon, dhcp=dhcp, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisObjects=adonisObjects, PYSNMP_MODULE_ID=adonis, systemDaemon=systemDaemon, trapSystem=trapSystem, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, trapDNSDaemon=trapDNSDaemon, dhcpSubnetUsed=dhcpSubnetUsed, tftpDaemonRunning=tftpDaemonRunning, dhcpFixedIPTable=dhcpFixedIPTable, haReplicationBinding=haReplicationBinding, dhcpLeaseBindState=dhcpLeaseBindState, ha=ha, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, licenseValid=licenseValid, dnsStatsReferral=dnsStatsReferral, dhcpFixedIP=dhcpFixedIP, lcd=lcd, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonRunning=dnsDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpStats=dhcpStats, dhcpLeaseStartTime=dhcpLeaseStartTime, commandServerDaemon=commandServerDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTP=trapTFTP, adonis=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system, adonisTraps=adonisTraps, dhcpSubnetMask=dhcpSubnetMask, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetIP=dhcpSubnetIP, trapHAServiceFailOver=trapHAServiceFailOver, haServiceRunning=haServiceRunning, trapCommandServer=trapCommandServer, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, tftp=tftp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dns=dns, dhcpFailOverState=dhcpFailOverState, dnsStats=dnsStats, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSize=dhcpPoolSize, dhcpIP=dhcpIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, lcdDaemon=lcdDaemon, haService=haService, trapHA=trapHA, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, commandServer=commandServer, trapDHCPDaemon=trapDHCPDaemon, systemState=systemState, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolAlert=dhcpPoolAlert, trapSystemDaemon=trapSystemDaemon, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel)
