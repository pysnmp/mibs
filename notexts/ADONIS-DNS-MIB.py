...
Gauge32, enterprises, ModuleIdentity, Counter32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Unsigned32, MibIdentifier, TimeTicks, NotificationType, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEntry=dhcpPoolEntry, trapTFTP=trapTFTP, adonisTraps=adonisTraps, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dns=dns, trapReplicationFailure=trapReplicationFailure, dnsStatsFailure=dnsStatsFailure, dhcpFailOverState=dhcpFailOverState, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, adonis=adonis, dhcpStats=dhcpStats, trapDNSDaemon=trapDNSDaemon, dhcpDaemonRunning=dhcpDaemonRunning, haServiceNodeType=haServiceNodeType, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolSize=dhcpPoolSize, dhcpSubnetIP=dhcpSubnetIP, dnsStatsNXRRSet=dnsStatsNXRRSet, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonDebugLevel=dnsDaemonDebugLevel, commandServer=commandServer, haService=haService, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, trapSystem=trapSystem, system=system, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapHA=trapHA, dhcpPoolEndIP=dhcpPoolEndIP, dnsStats=dnsStats, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, commandServerDaemon=commandServerDaemon, lcdDaemon=lcdDaemon, trapReplication=trapReplication, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonisObjects=adonisObjects, trapTFTPDaemon=trapTFTPDaemon, dhcpFixedIP=dhcpFixedIP, dhcpSubnetMask=dhcpSubnetMask, dnsStatsRecursion=dnsStatsRecursion, dnsStatsReferral=dnsStatsReferral, licenseExpiry=licenseExpiry, dhcpPoolAlert=dhcpPoolAlert, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemon=dhcpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, tftp=tftp, lcd=lcd, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseEndTime=dhcpLeaseEndTime, ha=ha, tftpDaemon=tftpDaemon, PYSNMP_MODULE_ID=adonis, dnsDaemon=dnsDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseStartTime=dhcpLeaseStartTime, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolTable=dhcpPoolTable, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, dhcpSubnetAlert=dhcpSubnetAlert, trapSystemDaemon=trapSystemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState)
