...
enterprises, IpAddress, NotificationType, iso, Bits, TimeTicks, Gauge32, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "NotificationType", "iso", "Bits", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpConfig=dhcpConfig, dnsDaemon=dnsDaemon, dnsDaemonRunning=dnsDaemonRunning, adonisObjects=adonisObjects, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, dhcpPoolAlert=dhcpPoolAlert, haServiceNodeType=haServiceNodeType, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystem=trapSystem, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServerDaemon=trapCommandServerDaemon, dnsStats=dnsStats, dhcpSubnetSize=dhcpSubnetSize, haReplicationBinding=haReplicationBinding, dhcpLeaseHostname=dhcpLeaseHostname, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpStats=dhcpStats, trapHA=trapHA, dhcpDaemon=dhcpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsSuccess=dnsStatsSuccess, licenseValid=licenseValid, lcd=lcd, trapDNS=trapDNS, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetIP=dhcpSubnetIP, trapCommandServer=trapCommandServer, dhcpSubnetUsed=dhcpSubnetUsed, PYSNMP_MODULE_ID=adonis, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPTable=dhcpFixedIPTable, lcdDaemon=lcdDaemon, trapSystemDaemon=trapSystemDaemon, haServiceRunning=haServiceRunning, ha=ha, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapDHCP=trapDHCP, adonisTraps=adonisTraps, dhcpPoolTable=dhcpPoolTable, tftpDaemonRunning=tftpDaemonRunning, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpIP=dhcpIP, dhcpLeaseTable=dhcpLeaseTable, trapTFTP=trapTFTP, haService=haService, dhcpDaemonRunning=dhcpDaemonRunning, commandServer=commandServer, adonis=adonis, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemDaemon=systemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIP=dhcpFixedIP, dhcpLeaseBindState=dhcpLeaseBindState, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, tftpDaemon=tftpDaemon, dhcpSubnetTable=dhcpSubnetTable, systemState=systemState, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, commandServerDaemonRunning=commandServerDaemonRunning, trapDNSDaemon=trapDNSDaemon, trapReplicationFailure=trapReplicationFailure, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dhcpPoolSize=dhcpPoolSize, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, tftp=tftp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDHCPDaemon=trapDHCPDaemon, dhcpFailOverState=dhcpFailOverState, system=system, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain)
