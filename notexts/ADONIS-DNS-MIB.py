...
Counter64, NotificationType, iso, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, Gauge32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Gauge32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, lcd=lcd, system=system, systemDaemon=systemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonRunning=dnsDaemonRunning, adonisTraps=adonisTraps, dnsStatsFailure=dnsStatsFailure, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemon=commandServerDaemon, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapCommandServer=trapCommandServer, commandServer=commandServer, haServiceRunning=haServiceRunning, dhcpPoolTable=dhcpPoolTable, trapDHCP=trapDHCP, trapSystemDaemon=trapSystemDaemon, PYSNMP_MODULE_ID=adonis, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, dhcpPoolSize=dhcpPoolSize, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCPDaemon=trapDHCPDaemon, tftpDaemonRunning=tftpDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonRunning=dhcpDaemonRunning, trapTFTP=trapTFTP, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolAlert=dhcpPoolAlert, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemon=dhcpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, ha=ha, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, lcdDaemon=lcdDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, adonis=adonis, dnsStatsSuccess=dnsStatsSuccess, licenseExpiry=licenseExpiry, dhcpIP=dhcpIP, dhcpFixedIP=dhcpFixedIP, trapReplicationFailure=trapReplicationFailure, haService=haService, dns=dns, dhcp=dhcp, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIPEntry=dhcpFixedIPEntry, haReplicationBinding=haReplicationBinding, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDNS=trapDNS, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapReplication=trapReplication, adonisObjects=adonisObjects, dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetTable=dhcpSubnetTable, dhcpConfig=dhcpConfig, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpStats=dhcpStats, licenseValid=licenseValid, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFailOverState=dhcpFailOverState, systemState=systemState, dhcpLeaseHostname=dhcpLeaseHostname, tftp=tftp, trapHA=trapHA, dhcpSubnetEntry=dhcpSubnetEntry)
