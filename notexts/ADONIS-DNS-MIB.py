...
NotificationType, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, Bits, iso, IpAddress, Gauge32, enterprises, Unsigned32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "Bits", "iso", "IpAddress", "Gauge32", "enterprises", "Unsigned32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsFailure=dnsStatsFailure, dns=dns, systemDaemon=systemDaemon, trapHA=trapHA, dhcpLeaseEntry=dhcpLeaseEntry, tftpDaemonRunning=tftpDaemonRunning, lcd=lcd, dhcpSubnetAlert=dhcpSubnetAlert, dhcpStats=dhcpStats, commandServer=commandServer, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemon=dhcpDaemon, haServiceNodeType=haServiceNodeType, tftpDaemon=tftpDaemon, haService=haService, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseExpiry=licenseExpiry, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonisTraps=adonisTraps, dhcpLeaseEndTime=dhcpLeaseEndTime, systemState=systemState, dnsStatsNXRRSet=dnsStatsNXRRSet, trapReplication=trapReplication, licenseValid=licenseValid, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetSize=dhcpSubnetSize, haServiceRunning=haServiceRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonisObjects=adonisObjects, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, ha=ha, adonis=adonis, dnsStatsNXDomain=dnsStatsNXDomain, PYSNMP_MODULE_ID=adonis, dnsStatsReferral=dnsStatsReferral, trapDNSDaemon=trapDNSDaemon, trapTFTP=trapTFTP, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDNS=trapDNS, dhcp=dhcp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolTable=dhcpPoolTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemon=dnsDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, trapSystem=trapSystem, dhcpIP=dhcpIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsSuccess=dnsStatsSuccess, haReplicationBinding=haReplicationBinding, tftp=tftp, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemon=commandServerDaemon, dnsStats=dnsStats, trapDHCP=trapDHCP, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServer=trapCommandServer, trapReplicationFailure=trapReplicationFailure, dhcpPoolSize=dhcpPoolSize, dhcpFixedIP=dhcpFixedIP, lcdDaemon=lcdDaemon, system=system)
