...
Gauge32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType, Bits, Counter64, ObjectIdentity, TimeTicks, enterprises, ModuleIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType", "Bits", "Counter64", "ObjectIdentity", "TimeTicks", "enterprises", "ModuleIdentity", "iso", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpFixedIPTable=dhcpFixedIPTable, dhcpStats=dhcpStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDHCPDaemon=trapDHCPDaemon, ha=ha, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemon=commandServerDaemon, dnsStatsFailure=dnsStatsFailure, dhcpPoolTable=dhcpPoolTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetTable=dhcpSubnetTable, commandServer=commandServer, PYSNMP_MODULE_ID=adonis, tftpDaemon=tftpDaemon, trapTFTP=trapTFTP, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolEntry=dhcpPoolEntry, adonisObjects=adonisObjects, adonisTraps=adonisTraps, tftp=tftp, dnsStatsNXDomain=dnsStatsNXDomain, trapHA=trapHA, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseEndTime=dhcpLeaseEndTime, trapCommandServer=trapCommandServer, haService=haService, trapDNS=trapDNS, adonis=adonis, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, trapDNSDaemon=trapDNSDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapReplicationFailure=trapReplicationFailure, haReplicationBinding=haReplicationBinding, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcp=dhcp, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseExpiry=licenseExpiry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, systemState=systemState, licenseValid=licenseValid, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolSize=dhcpPoolSize, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetUsed=dhcpSubnetUsed, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, system=system, dnsStatsRecursion=dnsStatsRecursion, dnsStats=dnsStats, dhcpLeaseBindState=dhcpLeaseBindState, lcd=lcd, haServiceRunning=haServiceRunning, trapReplication=trapReplication, dnsStatsReferral=dnsStatsReferral, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemon=dhcpDaemon, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, trapDHCP=trapDHCP, dnsDaemon=dnsDaemon, dhcpIP=dhcpIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure)
