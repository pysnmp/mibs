...
Unsigned32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Bits, Counter32, Integer32, Counter64, iso, ModuleIdentity, Gauge32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Bits", "Counter32", "Integer32", "Counter64", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStats=dnsStats, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, licenseValid=licenseValid, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolUsed=dhcpPoolUsed, systemState=systemState, dns=dns, commandServer=commandServer, dhcpPoolStartIP=dhcpPoolStartIP, dhcpStats=dhcpStats, trapReplicationFailure=trapReplicationFailure, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcp=dhcp, dhcpLeaseBindState=dhcpLeaseBindState, dnsStatsNXRRSet=dnsStatsNXRRSet, haReplicationBinding=haReplicationBinding, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsReferral=dnsStatsReferral, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapTFTP=trapTFTP, dhcpSubnetTable=dhcpSubnetTable, commandServerDaemon=commandServerDaemon, dhcpPoolTable=dhcpPoolTable, dhcpFixedIPTable=dhcpFixedIPTable, ha=ha, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, adonisTraps=adonisTraps, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftp=tftp, dhcpLeaseEntry=dhcpLeaseEntry, trapDHCPDaemon=trapDHCPDaemon, dnsStatsFailure=dnsStatsFailure, dnsDaemon=dnsDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceNodeType=haServiceNodeType, trapReplication=trapReplication, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetUsed=dhcpSubnetUsed, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, trapDHCP=trapDHCP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSize=dhcpPoolSize, trapDNSDaemon=trapDNSDaemon, dhcpIP=dhcpIP, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemonRunning=dhcpDaemonRunning, adonisObjects=adonisObjects, system=system, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, trapCommandServer=trapCommandServer, PYSNMP_MODULE_ID=adonis, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, lcdDaemon=lcdDaemon, licenseExpiry=licenseExpiry, trapSystem=trapSystem, tftpDaemon=tftpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemon=dhcpDaemon, trapHA=trapHA, dhcpPoolEntry=dhcpPoolEntry, dhcpFailOverState=dhcpFailOverState, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEndIP=dhcpPoolEndIP, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemonRunning=tftpDaemonRunning, haService=haService, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetSize=dhcpSubnetSize)
