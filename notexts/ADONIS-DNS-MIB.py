...
TimeTicks, ModuleIdentity, MibIdentifier, Unsigned32, iso, NotificationType, ObjectIdentity, enterprises, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Unsigned32", "iso", "NotificationType", "ObjectIdentity", "enterprises", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsReferral=dnsStatsReferral, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dhcp=dhcp, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTP=trapTFTP, dnsStats=dnsStats, trapDHCP=trapDHCP, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapDNS=trapDNS, dhcpFailOverState=dhcpFailOverState, commandServerDaemon=commandServerDaemon, systemDaemon=systemDaemon, ha=ha, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemon=dhcpDaemon, dhcpSubnetUsed=dhcpSubnetUsed, haReplicationBinding=haReplicationBinding, trapSystemDaemon=trapSystemDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, dhcpPoolTable=dhcpPoolTable, dhcpDaemonRunning=dhcpDaemonRunning, trapReplicationFailure=trapReplicationFailure, adonis=adonis, trapCommandServer=trapCommandServer, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSize=dhcpPoolSize, dnsStatsFailure=dnsStatsFailure, system=system, dhcpIP=dhcpIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetMask=dhcpSubnetMask, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFixedIP=dhcpFixedIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haService=haService, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dhcpSubnetEntry=dhcpSubnetEntry, haServiceRunning=haServiceRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, systemState=systemState, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseBindState=dhcpLeaseBindState, trapHA=trapHA, tftpDaemonRunning=tftpDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEntry=dhcpPoolEntry, trapDNSDaemon=trapDNSDaemon, adonisObjects=adonisObjects, dnsStatsSuccess=dnsStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseTable=dhcpLeaseTable, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dhcpConfig=dhcpConfig, licenseExpiry=licenseExpiry, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, trapSystem=trapSystem, commandServer=commandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, lcd=lcd, lcdDaemon=lcdDaemon, adonisTraps=adonisTraps)
