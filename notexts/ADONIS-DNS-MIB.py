...
Counter64, TimeTicks, Unsigned32, Integer32, iso, Bits, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter32, MibIdentifier, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Unsigned32", "Integer32", "iso", "Bits", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolEndIP=dhcpPoolEndIP, trapSystem=trapSystem, adonis=adonis, dhcpPoolSize=dhcpPoolSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetAlert=dhcpSubnetAlert, dhcp=dhcp, licenseExpiry=licenseExpiry, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolAlert=dhcpPoolAlert, trapDNSDaemon=trapDNSDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, licenseValid=licenseValid, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseEntry=dhcpLeaseEntry, system=system, dnsStatsSuccess=dnsStatsSuccess, trapDNS=trapDNS, dhcpFixedIPEntry=dhcpFixedIPEntry, commandServer=commandServer, trapHA=trapHA, adonisObjects=adonisObjects, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, ha=ha, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, tftpDaemonRunning=tftpDaemonRunning, tftpDaemon=tftpDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseHostname=dhcpLeaseHostname, trapCommandServer=trapCommandServer, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, haReplicationBinding=haReplicationBinding, haServiceNodeType=haServiceNodeType, tftp=tftp, haServiceRunning=haServiceRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpStats=dhcpStats, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, PYSNMP_MODULE_ID=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsStatsRecursion=dnsStatsRecursion, systemState=systemState, dns=dns, haService=haService, lcd=lcd, trapReplication=trapReplication, dhcpIP=dhcpIP, trapTFTP=trapTFTP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, trapSystemDaemon=trapSystemDaemon, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dhcpConfig=dhcpConfig, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStats=dnsStats, dhcpFailOverState=dhcpFailOverState, commandServerDaemon=commandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapReplicationFailure=trapReplicationFailure, dhcpFixedIP=dhcpFixedIP, trapDHCPDaemon=trapDHCPDaemon, trapDHCP=trapDHCP, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain)
