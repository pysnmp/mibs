...
Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Counter32, Integer32, TimeTicks, Bits, MibIdentifier, enterprises, ObjectIdentity, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Counter32", "Integer32", "TimeTicks", "Bits", "MibIdentifier", "enterprises", "ObjectIdentity", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapHA=trapHA, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServerDaemon=trapCommandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapSystem=trapSystem, dhcpIP=dhcpIP, trapSystemDaemon=trapSystemDaemon, adonisTraps=adonisTraps, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, adonisObjects=adonisObjects, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haService=haService, licenseExpiry=licenseExpiry, commandServerDaemon=commandServerDaemon, trapDNS=trapDNS, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonRunning=dnsDaemonRunning, trapReplication=trapReplication, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseBindState=dhcpLeaseBindState, PYSNMP_MODULE_ID=adonis, dhcpConfig=dhcpConfig, haReplicationBinding=haReplicationBinding, trapReplicationFailure=trapReplicationFailure, dhcpFixedIPEntry=dhcpFixedIPEntry, system=system, dhcpFailOverState=dhcpFailOverState, dhcpPoolSize=dhcpPoolSize, dhcpPoolEndIP=dhcpPoolEndIP, systemState=systemState, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, systemDaemon=systemDaemon, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dnsStatsReferral=dnsStatsReferral, ha=ha, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, trapTFTP=trapTFTP, tftp=tftp, haServiceNodeType=haServiceNodeType, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolStartIP=dhcpPoolStartIP, dns=dns, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolAlert=dhcpPoolAlert, dnsStatsFailure=dnsStatsFailure, dhcpPoolUsed=dhcpPoolUsed, dhcp=dhcp, trapTFTPDaemon=trapTFTPDaemon, dnsDaemon=dnsDaemon, dhcpSubnetIP=dhcpSubnetIP, trapDNSDaemon=trapDNSDaemon, dhcpSubnetAlert=dhcpSubnetAlert, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCP=trapDHCP, dhcpDaemon=dhcpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetTable=dhcpSubnetTable, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolTable=dhcpPoolTable, dhcpFixedIP=dhcpFixedIP, haServiceRunning=haServiceRunning, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonis=adonis, tftpDaemon=tftpDaemon, commandServer=commandServer, dnsStatsNXRRSet=dnsStatsNXRRSet)
