...
IpAddress, Gauge32, enterprises, ModuleIdentity, TimeTicks, Counter32, Unsigned32, Bits, iso, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "enterprises", "ModuleIdentity", "TimeTicks", "Counter32", "Unsigned32", "Bits", "iso", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, dhcpDaemon=dhcpDaemon, trapCommandServer=trapCommandServer, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolTable=dhcpPoolTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseTable=dhcpLeaseTable, dhcpIP=dhcpIP, dhcpSubnetSize=dhcpSubnetSize, adonisObjects=adonisObjects, haService=haService, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseEndTime=dhcpLeaseEndTime, trapDHCPDaemon=trapDHCPDaemon, lcd=lcd, dns=dns, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemon=dnsDaemon, trapHA=trapHA, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, trapDNSDaemon=trapDNSDaemon, haServiceRunning=haServiceRunning, commandServer=commandServer, dhcpPoolStartIP=dhcpPoolStartIP, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCP=trapDHCP, trapSystemDaemon=trapSystemDaemon, adonis=adonis, trapTFTP=trapTFTP, system=system, dhcp=dhcp, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, PYSNMP_MODULE_ID=adonis, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, trapDNS=trapDNS, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, dnsStats=dnsStats, trapReplication=trapReplication, dhcpPoolSize=dhcpPoolSize, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetMask=dhcpSubnetMask, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsSuccess=dnsStatsSuccess, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseExpiry=licenseExpiry, systemDaemon=systemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpFailOverState=dhcpFailOverState, ha=ha, tftpDaemon=tftpDaemon, haReplicationBinding=haReplicationBinding, adonisTraps=adonisTraps, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, systemState=systemState, dhcpFixedIP=dhcpFixedIP, lcdDaemon=lcdDaemon, tftp=tftp, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, trapTFTPDaemon=trapTFTPDaemon, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, licenseValid=licenseValid, dnsStatsRecursion=dnsStatsRecursion, dhcpConfig=dhcpConfig)
