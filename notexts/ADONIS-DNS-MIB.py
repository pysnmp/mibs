...
Counter64, enterprises, IpAddress, NotificationType, iso, ObjectIdentity, TimeTicks, Counter32, Gauge32, MibIdentifier, Bits, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "TimeTicks", "Counter32", "Gauge32", "MibIdentifier", "Bits", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapSystem=trapSystem, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, trapHA=trapHA, trapSystemDaemon=trapSystemDaemon, trapDHCP=trapDHCP, dnsStats=dnsStats, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetTable=dhcpSubnetTable, dhcpIP=dhcpIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, dnsStatsSuccess=dnsStatsSuccess, dns=dns, dhcpDaemon=dhcpDaemon, dhcp=dhcp, system=system, dhcpLeaseTable=dhcpLeaseTable, trapDNSDaemon=trapDNSDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsFailure=dnsStatsFailure, dhcpSubnetSize=dhcpSubnetSize, dhcpStats=dhcpStats, trapDNS=trapDNS, dhcpPoolUsed=dhcpPoolUsed, PYSNMP_MODULE_ID=adonis, dhcpPoolEntry=dhcpPoolEntry, trapDHCPDaemon=trapDHCPDaemon, haReplicationBinding=haReplicationBinding, commandServerDaemonRunning=commandServerDaemonRunning, systemDaemon=systemDaemon, dhcpPoolEndIP=dhcpPoolEndIP, adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolSize=dhcpPoolSize, dnsDaemon=dnsDaemon, haService=haService, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolTable=dhcpPoolTable, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpConfig=dhcpConfig, dhcpSubnetMask=dhcpSubnetMask, tftpDaemon=tftpDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, trapReplicationFailure=trapReplicationFailure, dnsDaemonRunning=dnsDaemonRunning, haServiceRunning=haServiceRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, systemState=systemState, dhcpSubnetAlert=dhcpSubnetAlert, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsReferral=dnsStatsReferral, commandServer=commandServer, adonisTraps=adonisTraps, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonis=adonis, ha=ha, dhcpLeaseBindState=dhcpLeaseBindState, licenseExpiry=licenseExpiry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftp=tftp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, lcd=lcd, haServiceNodeType=haServiceNodeType, dhcpFixedIP=dhcpFixedIP, dnsStatsNXDomain=dnsStatsNXDomain, trapTFTPDaemon=trapTFTPDaemon, trapCommandServerDaemon=trapCommandServerDaemon, licenseValid=licenseValid, trapReplication=trapReplication, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, commandServerDaemon=commandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP)
