...
Counter64, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Integer32, Counter32, ModuleIdentity, enterprises, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpIP=dhcpIP, dhcpFixedIPTable=dhcpFixedIPTable, licenseExpiry=licenseExpiry, tftpDaemon=tftpDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpPoolEntry=dhcpPoolEntry, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haServiceNodeType=haServiceNodeType, trapCommandServer=trapCommandServer, dhcpSubnetEntry=dhcpSubnetEntry, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsFailure=dnsStatsFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCPDaemon=trapDHCPDaemon, haServiceRunning=haServiceRunning, dns=dns, dhcpPoolAlert=dhcpPoolAlert, dhcp=dhcp, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseBindState=dhcpLeaseBindState, ha=ha, dhcpSubnetTable=dhcpSubnetTable, trapDNSDaemon=trapDNSDaemon, systemDaemon=systemDaemon, commandServerDaemon=commandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, trapHA=trapHA, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, dnsDaemonRunning=dnsDaemonRunning, haService=haService, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolSize=dhcpPoolSize, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, commandServer=commandServer, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpConfig=dhcpConfig, dhcpPoolTable=dhcpPoolTable, dhcpStats=dhcpStats, licenseValid=licenseValid, adonisObjects=adonisObjects, trapReplication=trapReplication, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIP=dhcpFixedIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFailOverState=dhcpFailOverState, adonisTraps=adonisTraps, trapTFTPDaemon=trapTFTPDaemon, system=system, dnsStats=dnsStats, dhcpSubnetMask=dhcpSubnetMask, dnsStatsReferral=dnsStatsReferral, systemState=systemState, trapSystemDaemon=trapSystemDaemon, lcdDaemon=lcdDaemon, trapTFTP=trapTFTP, trapSystem=trapSystem, dhcpSubnetAlert=dhcpSubnetAlert, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftp=tftp, trapReplicationFailure=trapReplicationFailure, dhcpDaemonRunning=dhcpDaemonRunning, adonis=adonis, dhcpDaemon=dhcpDaemon, trapDHCP=trapDHCP, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemon=dnsDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, PYSNMP_MODULE_ID=adonis)
