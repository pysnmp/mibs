...
ModuleIdentity, Counter32, Gauge32, Counter64, iso, NotificationType, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, IpAddress, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "iso", "NotificationType", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "IpAddress", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpFixedIP=dhcpFixedIP, haReplicationBinding=haReplicationBinding, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEntry=dhcpLeaseEntry, haServiceRunning=haServiceRunning, trapCommandServer=trapCommandServer, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsSuccess=dnsStatsSuccess, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseBindState=dhcpLeaseBindState, trapDHCPDaemon=trapDHCPDaemon, licenseExpiry=licenseExpiry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftp=tftp, system=system, trapSystemDaemon=trapSystemDaemon, lcd=lcd, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, trapDNSDaemon=trapDNSDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpConfig=dhcpConfig, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolTable=dhcpPoolTable, ha=ha, dnsDaemon=dnsDaemon, trapTFTPDaemon=trapTFTPDaemon, adonis=adonis, dhcp=dhcp, systemDaemon=systemDaemon, haServiceNodeType=haServiceNodeType, dhcpSubnetTable=dhcpSubnetTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsRecursion=dnsStatsRecursion, trapTFTP=trapTFTP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpSubnetMask=dhcpSubnetMask, licenseValid=licenseValid, dhcpPoolStartIP=dhcpPoolStartIP, commandServerDaemon=commandServerDaemon, dhcpLeaseTable=dhcpLeaseTable, lcdDaemon=lcdDaemon, commandServer=commandServer, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolAlert=dhcpPoolAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetIP=dhcpSubnetIP, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, adonisTraps=adonisTraps, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpStats=dhcpStats, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, trapDNS=trapDNS, trapHA=trapHA, trapSystem=trapSystem, dhcpPoolSize=dhcpPoolSize, tftpDaemon=tftpDaemon, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplication=trapReplication, dhcpFailOverState=dhcpFailOverState, PYSNMP_MODULE_ID=adonis, haService=haService, dnsDaemonRunning=dnsDaemonRunning, trapDHCP=trapDHCP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, systemState=systemState, dns=dns, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapReplicationFailure=trapReplicationFailure)
