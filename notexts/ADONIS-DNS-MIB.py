...
NotificationType, Unsigned32, ModuleIdentity, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Bits, ObjectIdentity, Integer32, MibIdentifier, enterprises, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ModuleIdentity", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Bits", "ObjectIdentity", "Integer32", "MibIdentifier", "enterprises", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisTraps=adonisTraps, trapDNS=trapDNS, trapTFTPDaemon=trapTFTPDaemon, trapReplication=trapReplication, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, system=system, dhcpPoolSize=dhcpPoolSize, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCPDaemon=trapDHCPDaemon, dnsStats=dnsStats, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetAlert=dhcpSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, lcdDaemon=lcdDaemon, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, dnsDaemon=dnsDaemon, adonis=adonis, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, dhcpStats=dhcpStats, dnsDaemonRunning=dnsDaemonRunning, dnsStatsSuccess=dnsStatsSuccess, trapTFTP=trapTFTP, tftpDaemon=tftpDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcp=dhcp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTable=dhcpLeaseTable, haReplicationBinding=haReplicationBinding, haServiceNodeType=haServiceNodeType, dnsStatsFailure=dnsStatsFailure, dhcpSubnetEntry=dhcpSubnetEntry, trapSystemDaemon=trapSystemDaemon, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFixedIP=dhcpFixedIP, dhcpLeaseStartTime=dhcpLeaseStartTime, haServiceRunning=haServiceRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, dhcpDaemon=dhcpDaemon, ha=ha, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystem=trapSystem, licenseValid=licenseValid, dhcpPoolUsed=dhcpPoolUsed, trapDNSDaemon=trapDNSDaemon, adonisObjects=adonisObjects, dhcpDaemonRunning=dhcpDaemonRunning, haService=haService, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, tftpDaemonRunning=tftpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseExpiry=licenseExpiry, dhcpLeaseHostname=dhcpLeaseHostname, commandServer=commandServer, trapCommandServer=trapCommandServer, dhcpSubnetSize=dhcpSubnetSize, dhcpConfig=dhcpConfig, dnsStatsNXDomain=dnsStatsNXDomain, lcd=lcd, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP)
