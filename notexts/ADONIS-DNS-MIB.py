...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, ObjectIdentity, Unsigned32, iso, ModuleIdentity, Gauge32, TimeTicks, enterprises, NotificationType, Integer32, IpAddress, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "ModuleIdentity", "Gauge32", "TimeTicks", "enterprises", "NotificationType", "Integer32", "IpAddress", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpIP=dhcpIP, dhcpSubnetTable=dhcpSubnetTable, lcd=lcd, trapCommandServer=trapCommandServer, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpConfig=dhcpConfig, dhcpLeaseBindState=dhcpLeaseBindState, adonisTraps=adonisTraps, commandServerDaemon=commandServerDaemon, commandServer=commandServer, trapReplicationFailure=trapReplicationFailure, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonRunning=dnsDaemonRunning, systemState=systemState, dhcpLeaseTable=dhcpLeaseTable, tftp=tftp, trapReplication=trapReplication, dhcp=dhcp, trapDNS=trapDNS, lcdDaemon=lcdDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, dhcpFailOverState=dhcpFailOverState, licenseExpiry=licenseExpiry, dnsStatsReferral=dnsStatsReferral, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetIP=dhcpSubnetIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetAlert=dhcpSubnetAlert, trapHA=trapHA, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime, trapSystemDaemon=trapSystemDaemon, ha=ha, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dhcpPoolTable=dhcpPoolTable, tftpDaemonRunning=tftpDaemonRunning, dnsStats=dnsStats, system=system, dnsStatsFailure=dnsStatsFailure, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, systemDaemon=systemDaemon, dhcpSubnetMask=dhcpSubnetMask, trapHAServiceFailOver=trapHAServiceFailOver, trapDNSDaemon=trapDNSDaemon, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXRRSet=dnsStatsNXRRSet, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseHostname=dhcpLeaseHostname, adonis=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, trapDHCP=trapDHCP, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, tftpDaemon=tftpDaemon, dns=dns, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, trapCommandServerDaemon=trapCommandServerDaemon, trapDHCPDaemon=trapDHCPDaemon, licenseValid=licenseValid, trapTFTP=trapTFTP, dhcpDaemon=dhcpDaemon, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetUsed=dhcpSubnetUsed, PYSNMP_MODULE_ID=adonis, haService=haService, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, dhcpStats=dhcpStats, haServiceNodeType=haServiceNodeType)
