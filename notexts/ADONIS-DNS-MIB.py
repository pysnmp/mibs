...
Integer32, ObjectIdentity, NotificationType, Counter32, IpAddress, Unsigned32, TimeTicks, Counter64, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "NotificationType", "Counter32", "IpAddress", "Unsigned32", "TimeTicks", "Counter64", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, systemDaemon=systemDaemon, dhcpPoolSize=dhcpPoolSize, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haService=haService, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonis=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapSystemDaemon=trapSystemDaemon, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsSuccess=dnsStatsSuccess, dhcpFixedIP=dhcpFixedIP, commandServerDaemonRunning=commandServerDaemonRunning, dhcpDaemon=dhcpDaemon, trapTFTP=trapTFTP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemon=dnsDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsStatsNXDomain=dnsStatsNXDomain, dhcpPoolStartIP=dhcpPoolStartIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, haReplicationBinding=haReplicationBinding, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystem=trapSystem, dhcpLeaseTable=dhcpLeaseTable, lcdDaemon=lcdDaemon, dnsStatsFailure=dnsStatsFailure, dhcpFailOverState=dhcpFailOverState, trapDNSDaemon=trapDNSDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolTable=dhcpPoolTable, PYSNMP_MODULE_ID=adonis, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapReplicationFailure=trapReplicationFailure, trapReplication=trapReplication, trapDHCP=trapDHCP, system=system, dnsStats=dnsStats, trapDNS=trapDNS, dhcpSubnetTable=dhcpSubnetTable, dhcp=dhcp, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseBindState=dhcpLeaseBindState, haServiceNodeType=haServiceNodeType, dhcpConfig=dhcpConfig, dhcpStats=dhcpStats, ha=ha, licenseValid=licenseValid, adonisObjects=adonisObjects, licenseExpiry=licenseExpiry, dhcpFixedIPTable=dhcpFixedIPTable, dhcpLeaseEndTime=dhcpLeaseEndTime, lcd=lcd, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapCommandServer=trapCommandServer, tftpDaemon=tftpDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpPoolEntry=dhcpPoolEntry, dhcpIP=dhcpIP, commandServer=commandServer, dnsStatsReferral=dnsStatsReferral, dhcpFixedIPEntry=dhcpFixedIPEntry, trapHA=trapHA, dns=dns, trapTFTPDaemon=trapTFTPDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCPDaemon=trapDHCPDaemon)
