...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolTable=dhcpPoolTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolUsed=dhcpPoolUsed, trapCommandServerDaemon=trapCommandServerDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcp=dhcp, trapDHCPDaemon=trapDHCPDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, trapHAServiceFailOver=trapHAServiceFailOver, tftpDaemon=tftpDaemon, dhcpSubnetIP=dhcpSubnetIP, trapReplication=trapReplication, dhcpFailOverState=dhcpFailOverState, dhcpSubnetMask=dhcpSubnetMask, dhcpConfig=dhcpConfig, trapDNS=trapDNS, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServer=commandServer, systemDaemon=systemDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, lcdDaemon=lcdDaemon, dhcpFixedIP=dhcpFixedIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolStartIP=dhcpPoolStartIP, trapReplicationFailure=trapReplicationFailure, haService=haService, tftp=tftp, commandServerDaemonRunning=commandServerDaemonRunning, licenseExpiry=licenseExpiry, systemState=systemState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapTFTPDaemon=trapTFTPDaemon, dnsStatsReferral=dnsStatsReferral, lcd=lcd, ha=ha, trapTFTP=trapTFTP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dnsStatsRecursion=dnsStatsRecursion, haServiceRunning=haServiceRunning, haReplicationBinding=haReplicationBinding, tftpDaemonRunning=tftpDaemonRunning, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, licenseValid=licenseValid, dnsDaemonRunning=dnsDaemonRunning, trapHA=trapHA, dhcpSubnetUsed=dhcpSubnetUsed, dns=dns, dhcpIP=dhcpIP, adonisTraps=adonisTraps, dhcpLeaseBindState=dhcpLeaseBindState, commandServerDaemon=commandServerDaemon, dnsStats=dnsStats, dhcpFixedIPTable=dhcpFixedIPTable, system=system, dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemon=dnsDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapDHCP=trapDHCP, adonisObjects=adonisObjects, dhcpSubnetSize=dhcpSubnetSize, PYSNMP_MODULE_ID=adonis, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, adonis=adonis, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, haServiceNodeType=haServiceNodeType, trapCommandServer=trapCommandServer, trapSystem=trapSystem, trapDNSDaemon=trapDNSDaemon, dnsStatsFailure=dnsStatsFailure)
