...
Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, Bits, NotificationType, Unsigned32, ModuleIdentity, Gauge32, enterprises, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "Bits", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "enterprises", "Integer32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisTraps=adonisTraps, dhcpSubnetAlert=dhcpSubnetAlert, dhcpIP=dhcpIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseEntry=dhcpLeaseEntry, PYSNMP_MODULE_ID=adonis, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTP=trapTFTP, dhcpPoolSize=dhcpPoolSize, dns=dns, trapSystemDaemon=trapSystemDaemon, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, trapDNSDaemon=trapDNSDaemon, licenseExpiry=licenseExpiry, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, trapDNS=trapDNS, dnsStats=dnsStats, dnsStatsNXRRSet=dnsStatsNXRRSet, lcdDaemon=lcdDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, adonisObjects=adonisObjects, system=system, dnsStatsSuccess=dnsStatsSuccess, lcd=lcd, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, dhcpPoolAlert=dhcpPoolAlert, trapReplicationFailure=trapReplicationFailure, trapCommandServerDaemon=trapCommandServerDaemon, dhcpFailOverState=dhcpFailOverState, dhcpStats=dhcpStats, dnsStatsReferral=dnsStatsReferral, dnsStatsRecursion=dnsStatsRecursion, dhcpSubnetMask=dhcpSubnetMask, dnsStatsFailure=dnsStatsFailure, systemState=systemState, haReplicationBinding=haReplicationBinding, ha=ha, tftpDaemon=tftpDaemon, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolTable=dhcpPoolTable, tftp=tftp, dhcpConfig=dhcpConfig, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetSize=dhcpSubnetSize, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPEntry=dhcpFixedIPEntry, licenseValid=licenseValid, systemDaemon=systemDaemon, trapDHCPDaemon=trapDHCPDaemon, trapTFTPDaemon=trapTFTPDaemon, trapDHCP=trapDHCP, dnsDaemonRunning=dnsDaemonRunning, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, trapHA=trapHA, adonis=adonis, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haService=haService, trapCommandServer=trapCommandServer, dhcpLeaseTable=dhcpLeaseTable, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, haServiceNodeType=haServiceNodeType, commandServer=commandServer, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, dhcpSubnetUsed=dhcpSubnetUsed, trapSystem=trapSystem, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones)
