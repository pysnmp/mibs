...
Gauge32, ModuleIdentity, NotificationType, Counter64, iso, Bits, ObjectIdentity, Counter32, TimeTicks, Unsigned32, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "iso", "Bits", "ObjectIdentity", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpIP=dhcpIP, dhcpFailOverState=dhcpFailOverState, trapCommandServerDaemon=trapCommandServerDaemon, haServiceNodeType=haServiceNodeType, trapSystem=trapSystem, licenseValid=licenseValid, trapCommandServer=trapCommandServer, trapDHCPDaemon=trapDHCPDaemon, trapTFTPDaemon=trapTFTPDaemon, lcdDaemon=lcdDaemon, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolEntry=dhcpPoolEntry, dhcpFixedIP=dhcpFixedIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseEndTime=dhcpLeaseEndTime, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, trapTFTP=trapTFTP, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolUsed=dhcpPoolUsed, haServiceRunning=haServiceRunning, dnsStats=dnsStats, lcd=lcd, haService=haService, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemon=dhcpDaemon, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcp=dhcp, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dnsStatsRecursion=dnsStatsRecursion, dnsStatsNXDomain=dnsStatsNXDomain, licenseExpiry=licenseExpiry, trapDNSDaemon=trapDNSDaemon, commandServer=commandServer, dnsStatsReferral=dnsStatsReferral, dhcpSubnetIP=dhcpSubnetIP, tftpDaemonRunning=tftpDaemonRunning, trapSystemDaemon=trapSystemDaemon, dhcpStats=dhcpStats, ha=ha, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsSuccess=dnsStatsSuccess, system=system, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpLeaseEntry=dhcpLeaseEntry, adonisTraps=adonisTraps, adonis=adonis, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapReplicationFailure=trapReplicationFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, PYSNMP_MODULE_ID=adonis, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemon=dnsDaemon, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDNS=trapDNS, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetSize=dhcpSubnetSize, tftp=tftp, haReplicationBinding=haReplicationBinding, dhcpDaemonRunning=dhcpDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, trapHA=trapHA, trapReplication=trapReplication, dnsStatsFailure=dnsStatsFailure, dns=dns, systemState=systemState, dhcpSubnetAlert=dhcpSubnetAlert, adonisObjects=adonisObjects, dhcpPoolSize=dhcpPoolSize, systemDaemon=systemDaemon)
