...
ModuleIdentity, Gauge32, TimeTicks, ObjectIdentity, enterprises, iso, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "TimeTicks", "ObjectIdentity", "enterprises", "iso", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, system=system, haServiceNodeType=haServiceNodeType, dhcpLeaseTable=dhcpLeaseTable, dhcpStats=dhcpStats, dhcpSubnetTable=dhcpSubnetTable, dnsStats=dnsStats, adonis=adonis, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, ha=ha, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolAlert=dhcpPoolAlert, PYSNMP_MODULE_ID=adonis, trapDNS=trapDNS, trapDHCPDaemon=trapDHCPDaemon, licenseExpiry=licenseExpiry, adonisTraps=adonisTraps, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFixedIP=dhcpFixedIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetUsed=dhcpSubnetUsed, trapSystem=trapSystem, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFailOverState=dhcpFailOverState, dnsStatsNXDomain=dnsStatsNXDomain, systemState=systemState, haService=haService, adonisObjects=adonisObjects, trapCommandServer=trapCommandServer, trapHA=trapHA, dhcpIP=dhcpIP, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, dhcpSubnetEntry=dhcpSubnetEntry, dhcpLeaseStartTime=dhcpLeaseStartTime, systemDaemon=systemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpConfig=dhcpConfig, dnsStatsRecursion=dnsStatsRecursion, haReplicationBinding=haReplicationBinding, dhcpSubnetIP=dhcpSubnetIP, trapDNSDaemon=trapDNSDaemon, tftpDaemon=tftpDaemon, licenseValid=licenseValid, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetMask=dhcpSubnetMask, dhcpSubnetAlert=dhcpSubnetAlert, dns=dns, trapReplicationFailure=trapReplicationFailure, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpSubnetSize=dhcpSubnetSize, dhcpDaemon=dhcpDaemon, dhcp=dhcp, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, tftp=tftp, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapCommandServerDaemon=trapCommandServerDaemon, trapReplication=trapReplication, commandServerDaemon=commandServerDaemon, tftpDaemonRunning=tftpDaemonRunning, lcd=lcd, dhcpPoolEntry=dhcpPoolEntry, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTP=trapTFTP, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonRunning=dnsDaemonRunning, dnsStatsReferral=dnsStatsReferral, dnsDaemon=dnsDaemon, dhcpLeaseHostname=dhcpLeaseHostname)
