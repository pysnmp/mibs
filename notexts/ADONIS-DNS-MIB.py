...
Counter64, Unsigned32, MibIdentifier, Bits, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, ModuleIdentity, Gauge32, iso, ObjectIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "MibIdentifier", "Bits", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "iso", "ObjectIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsRecursion=dnsStatsRecursion, dnsDaemonRunning=dnsDaemonRunning, haServiceRunning=haServiceRunning, dhcpSubnetAlert=dhcpSubnetAlert, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetMask=dhcpSubnetMask, lcdDaemon=lcdDaemon, dnsStatsReferral=dnsStatsReferral, dhcpPoolTable=dhcpPoolTable, dhcpDaemon=dhcpDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, trapReplicationFailure=trapReplicationFailure, ha=ha, dhcpSubnetTable=dhcpSubnetTable, systemDaemon=systemDaemon, dnsDaemon=dnsDaemon, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolStartIP=dhcpPoolStartIP, haService=haService, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServerDaemon=trapCommandServerDaemon, adonisTraps=adonisTraps, tftpDaemon=tftpDaemon, trapDHCPDaemon=trapDHCPDaemon, tftpDaemonRunning=tftpDaemonRunning, trapDNSDaemon=trapDNSDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapSystemDaemon=trapSystemDaemon, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, tftp=tftp, dhcpSubnetUsed=dhcpSubnetUsed, dhcpStats=dhcpStats, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpConfig=dhcpConfig, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dns=dns, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIP=dhcpFixedIP, commandServerDaemon=commandServerDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, licenseValid=licenseValid, trapDHCP=trapDHCP, PYSNMP_MODULE_ID=adonis, commandServer=commandServer, trapHA=trapHA, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, system=system, dhcpPoolUsed=dhcpPoolUsed, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSize=dhcpPoolSize, trapReplication=trapReplication, adonisObjects=adonisObjects, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStats=dnsStats, systemState=systemState, trapTFTPDaemon=trapTFTPDaemon, dhcp=dhcp, dhcpFailOverState=dhcpFailOverState, trapSystem=trapSystem, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, licenseExpiry=licenseExpiry, dhcpDaemonRunning=dhcpDaemonRunning, trapCommandServer=trapCommandServer, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, adonis=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseHostname=dhcpLeaseHostname, dhcpFixedIPTable=dhcpFixedIPTable, trapTFTP=trapTFTP, lcd=lcd)
