...
Counter64, Unsigned32, Gauge32, iso, ModuleIdentity, TimeTicks, MibIdentifier, IpAddress, enterprises, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Gauge32", "iso", "ModuleIdentity", "TimeTicks", "MibIdentifier", "IpAddress", "enterprises", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", ha=ha, trapHA=trapHA, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dnsStats=dnsStats, trapDHCPDaemon=trapDHCPDaemon, trapSystem=trapSystem, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, tftp=tftp, dhcpFixedIP=dhcpFixedIP, dnsStatsSuccess=dnsStatsSuccess, haServiceNodeType=haServiceNodeType, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseStartTime=dhcpLeaseStartTime, PYSNMP_MODULE_ID=adonis, trapReplication=trapReplication, dnsStatsReferral=dnsStatsReferral, dhcpLeaseBindState=dhcpLeaseBindState, trapDNSDaemon=trapDNSDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, trapTFTPDaemon=trapTFTPDaemon, trapSystemDaemon=trapSystemDaemon, dhcpSubnetTable=dhcpSubnetTable, haServiceRunning=haServiceRunning, dhcpPoolUsed=dhcpPoolUsed, dhcpDaemon=dhcpDaemon, haReplicationBinding=haReplicationBinding, lcd=lcd, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetMask=dhcpSubnetMask, trapCommandServerDaemon=trapCommandServerDaemon, system=system, dhcpSubnetEntry=dhcpSubnetEntry, adonisTraps=adonisTraps, trapDHCP=trapDHCP, dnsStatsRecursion=dnsStatsRecursion, trapDNS=trapDNS, commandServerDaemon=commandServerDaemon, licenseValid=licenseValid, dhcpPoolSize=dhcpPoolSize, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpFailOverState=dhcpFailOverState, dhcpPoolTable=dhcpPoolTable, dns=dns, tftpDaemon=tftpDaemon, dhcpIP=dhcpIP, dhcp=dhcp, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpSubnetUsed=dhcpSubnetUsed, licenseExpiry=licenseExpiry, systemDaemon=systemDaemon, dnsDaemonRunning=dnsDaemonRunning, trapCommandServer=trapCommandServer, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolAlert=dhcpPoolAlert, dhcpPoolStartIP=dhcpPoolStartIP, tftpDaemonRunning=tftpDaemonRunning, trapTFTP=trapTFTP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXDomain=dnsStatsNXDomain, adonis=adonis, trapReplicationFailure=trapReplicationFailure, commandServer=commandServer, dhcpLeaseHostname=dhcpLeaseHostname, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemonRunning=dhcpDaemonRunning, adonisObjects=adonisObjects, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetAlert=dhcpSubnetAlert, dhcpStats=dhcpStats, lcdDaemon=lcdDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, systemState=systemState, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpConfig=dhcpConfig, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpSubnetSize=dhcpSubnetSize, haService=haService)
