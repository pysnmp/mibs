...
Integer32, iso, ObjectIdentity, TimeTicks, MibIdentifier, enterprises, Unsigned32, Gauge32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "enterprises", "Unsigned32", "Gauge32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetAlert=dhcpSubnetAlert, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, lcdDaemon=lcdDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, adonisObjects=adonisObjects, trapHA=trapHA, dhcpSubnetMask=dhcpSubnetMask, tftpDaemon=tftpDaemon, trapReplication=trapReplication, PYSNMP_MODULE_ID=adonis, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFailOverState=dhcpFailOverState, dhcpFixedIP=dhcpFixedIP, dhcpDaemon=dhcpDaemon, licenseExpiry=licenseExpiry, systemDaemon=systemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapReplicationFailure=trapReplicationFailure, dhcpIP=dhcpIP, dhcpPoolStartIP=dhcpPoolStartIP, haService=haService, dhcpPoolEntry=dhcpPoolEntry, trapDNS=trapDNS, adonisTraps=adonisTraps, dhcpPoolSize=dhcpPoolSize, dnsStatsSuccess=dnsStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, trapTFTP=trapTFTP, trapCommandServer=trapCommandServer, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, haReplicationBinding=haReplicationBinding, dns=dns, dhcpPoolEndIP=dhcpPoolEndIP, dhcpStats=dhcpStats, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseTable=dhcpLeaseTable, dnsDaemon=dnsDaemon, haServiceRunning=haServiceRunning, dnsStatsReferral=dnsStatsReferral, dhcpLeaseEndTime=dhcpLeaseEndTime, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dnsStatsNXDomain=dnsStatsNXDomain, trapDHCP=trapDHCP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseStartTime=dhcpLeaseStartTime, trapCommandServerDaemon=trapCommandServerDaemon, trapSystemDaemon=trapSystemDaemon, trapSystem=trapSystem, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseEntry=dhcpLeaseEntry, dhcp=dhcp, commandServer=commandServer, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, system=system, commandServerDaemonRunning=commandServerDaemonRunning, dhcpConfig=dhcpConfig, dhcpPoolTable=dhcpPoolTable, ha=ha, haServiceNodeType=haServiceNodeType, commandServerDaemon=commandServerDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, trapDHCPDaemon=trapDHCPDaemon, dnsStatsRecursion=dnsStatsRecursion, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFixedIPTable=dhcpFixedIPTable, trapDNSDaemon=trapDNSDaemon)
