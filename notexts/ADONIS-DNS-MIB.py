...
Counter64, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ModuleIdentity, enterprises, IpAddress, Counter32, Bits, TimeTicks, Unsigned32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ModuleIdentity", "enterprises", "IpAddress", "Counter32", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStats=dnsStats, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dhcpPoolUsed=dhcpPoolUsed, trapHA=trapHA, haService=haService, trapSystem=trapSystem, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, trapDHCPDaemon=trapDHCPDaemon, commandServerDaemonRunning=commandServerDaemonRunning, systemState=systemState, trapCommandServerDaemon=trapCommandServerDaemon, licenseValid=licenseValid, dhcpConfig=dhcpConfig, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, system=system, trapReplicationFailure=trapReplicationFailure, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, ha=ha, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetTable=dhcpSubnetTable, licenseExpiry=licenseExpiry, trapTFTP=trapTFTP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, dhcpSubnetUsed=dhcpSubnetUsed, dhcpPoolSize=dhcpPoolSize, dhcpSubnetMask=dhcpSubnetMask, trapDNSDaemon=trapDNSDaemon, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetIP=dhcpSubnetIP, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftp=tftp, dhcpLeaseEntry=dhcpLeaseEntry, trapTFTPDaemon=trapTFTPDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServer=trapCommandServer, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, dnsStatsSuccess=dnsStatsSuccess, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, trapDNS=trapDNS, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFailOverState=dhcpFailOverState, dhcpIP=dhcpIP, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, lcd=lcd, commandServer=commandServer, trapDHCP=trapDHCP, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpSubnetEntry=dhcpSubnetEntry, dhcp=dhcp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonRunning=dnsDaemonRunning, systemDaemon=systemDaemon, dhcpDaemon=dhcpDaemon, trapSystemDaemon=trapSystemDaemon, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemon=dnsDaemon, dhcpPoolEndIP=dhcpPoolEndIP, commandServerDaemon=commandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, trapReplication=trapReplication, dhcpLeaseHostname=dhcpLeaseHostname, dns=dns, dhcpDaemonRunning=dhcpDaemonRunning, adonisObjects=adonisObjects, lcdDaemon=lcdDaemon, dhcpPoolTable=dhcpPoolTable, tftpDaemon=tftpDaemon, dhcpFixedIP=dhcpFixedIP, adonisTraps=adonisTraps, haServiceNodeType=haServiceNodeType, dhcpLeaseTable=dhcpLeaseTable, dhcpFixedIPTable=dhcpFixedIPTable)
