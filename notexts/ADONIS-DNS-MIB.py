...
enterprises, Integer32, ModuleIdentity, Bits, Gauge32, Unsigned32, MibIdentifier, Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ModuleIdentity", "Bits", "Gauge32", "Unsigned32", "MibIdentifier", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapDHCP=trapDHCP, haServiceNodeType=haServiceNodeType, dnsStatsReferral=dnsStatsReferral, lcdDaemon=lcdDaemon, commandServer=commandServer, dhcpLeaseHostname=dhcpLeaseHostname, commandServerDaemonRunning=commandServerDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, ha=ha, trapCommandServer=trapCommandServer, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dhcpPoolSize=dhcpPoolSize, dhcpStats=dhcpStats, dhcpLeaseEndTime=dhcpLeaseEndTime, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, PYSNMP_MODULE_ID=adonis, dhcpIP=dhcpIP, tftp=tftp, dhcpPoolTable=dhcpPoolTable, trapDHCPDaemon=trapDHCPDaemon, trapReplication=trapReplication, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseBindState=dhcpLeaseBindState, trapDNSDaemon=trapDNSDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, trapSystemDaemon=trapSystemDaemon, dhcpSubnetSize=dhcpSubnetSize, trapReplicationFailure=trapReplicationFailure, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsSuccess=dnsStatsSuccess, dnsStatsFailure=dnsStatsFailure, trapDNS=trapDNS, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpFixedIPTable=dhcpFixedIPTable, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemon=dhcpDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, haService=haService, dhcpConfig=dhcpConfig, system=system, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, dnsDaemon=dnsDaemon, adonis=adonis, dnsStatsNXRRSet=dnsStatsNXRRSet, trapTFTP=trapTFTP, dnsDaemonRunning=dnsDaemonRunning, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftpDaemonRunning=tftpDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, systemState=systemState, adonisTraps=adonisTraps, dnsStats=dnsStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseTable=dhcpLeaseTable, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetAlert=dhcpSubnetAlert, haReplicationBinding=haReplicationBinding, dns=dns, licenseExpiry=licenseExpiry, dnsStatsNXDomain=dnsStatsNXDomain, trapTFTPDaemon=trapTFTPDaemon, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpFailOverState=dhcpFailOverState, dhcpPoolEntry=dhcpPoolEntry, dhcpSubnetTable=dhcpSubnetTable, trapHA=trapHA, trapSystem=trapSystem, lcd=lcd)
