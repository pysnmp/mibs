...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpLeaseTable=dhcpLeaseTable, trapSystem=trapSystem, trapTFTPDaemon=trapTFTPDaemon, dhcpSubnetMask=dhcpSubnetMask, commandServerDaemon=commandServerDaemon, dhcpSubnetIP=dhcpSubnetIP, ha=ha, haReplicationBinding=haReplicationBinding, trapTFTP=trapTFTP, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsReferral=dnsStatsReferral, dhcpSubnetUsed=dhcpSubnetUsed, dnsStatsSuccess=dnsStatsSuccess, haServiceRunning=haServiceRunning, dns=dns, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, adonisObjects=adonisObjects, dhcpPoolSize=dhcpPoolSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonRunning=dnsDaemonRunning, adonisTraps=adonisTraps, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsFailure=dnsStatsFailure, dhcpFailOverState=dhcpFailOverState, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseStartTime=dhcpLeaseStartTime, system=system, dhcpFixedIPTable=dhcpFixedIPTable, trapHAServiceFailOver=trapHAServiceFailOver, dhcpPoolEndIP=dhcpPoolEndIP, systemDaemon=systemDaemon, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolAlert=dhcpPoolAlert, adonis=adonis, tftpDaemonRunning=tftpDaemonRunning, trapCommandServer=trapCommandServer, dhcpSubnetTable=dhcpSubnetTable, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetEntry=dhcpSubnetEntry, lcdDaemon=lcdDaemon, dnsStatsNXDomain=dnsStatsNXDomain, tftp=tftp, haService=haService, haServiceNodeType=haServiceNodeType, dhcpSubnetSize=dhcpSubnetSize, dhcp=dhcp, dhcpPoolEntry=dhcpPoolEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, licenseValid=licenseValid, dhcpDaemon=dhcpDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dhcpIP=dhcpIP, dnsDaemonDebugLevel=dnsDaemonDebugLevel, systemState=systemState, trapDNSDaemon=trapDNSDaemon, trapHA=trapHA, trapDHCPDaemon=trapDHCPDaemon, dhcpStats=dhcpStats, tftpDaemon=tftpDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPEntry=dhcpFixedIPEntry, lcd=lcd, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpFixedIP=dhcpFixedIP, dhcpConfig=dhcpConfig, commandServer=commandServer, dnsStats=dnsStats, dhcpPoolUsed=dhcpPoolUsed, trapReplication=trapReplication, dhcpPoolTable=dhcpPoolTable, trapDNS=trapDNS, trapReplicationFailure=trapReplicationFailure)
