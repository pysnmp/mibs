...
Gauge32, IpAddress, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, iso, TimeTicks, ObjectIdentity, Unsigned32, ModuleIdentity, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "iso", "TimeTicks", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, dhcpPoolSize=dhcpPoolSize, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, dnsStatsRecursion=dnsStatsRecursion, systemState=systemState, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemonRunning=commandServerDaemonRunning, adonisTraps=adonisTraps, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapCommandServer=trapCommandServer, dhcpIP=dhcpIP, dhcpDaemon=dhcpDaemon, trapDHCPDaemon=trapDHCPDaemon, PYSNMP_MODULE_ID=adonis, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, licenseExpiry=licenseExpiry, trapReplication=trapReplication, dhcpFixedIP=dhcpFixedIP, licenseValid=licenseValid, haReplicationBinding=haReplicationBinding, dns=dns, tftpDaemonRunning=tftpDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, trapReplicationFailure=trapReplicationFailure, trapHAServiceFailOver=trapHAServiceFailOver, trapSystem=trapSystem, dhcpFailOverState=dhcpFailOverState, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetTable=dhcpSubnetTable, trapDHCP=trapDHCP, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolUsed=dhcpPoolUsed, dhcpStats=dhcpStats, dnsStatsSuccess=dnsStatsSuccess, trapSystemDaemon=trapSystemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, system=system, trapDNSDaemon=trapDNSDaemon, dhcp=dhcp, dhcpSubnetMask=dhcpSubnetMask, adonisObjects=adonisObjects, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpDaemonRunning=dhcpDaemonRunning, haService=haService, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, ha=ha, dnsDaemonRunning=dnsDaemonRunning, haServiceRunning=haServiceRunning, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpFixedIPTable=dhcpFixedIPTable, systemDaemon=systemDaemon, commandServerDaemon=commandServerDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsStatsFailure=dnsStatsFailure, dnsStatsReferral=dnsStatsReferral, trapCommandServerDaemon=trapCommandServerDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsStatsNXDomain=dnsStatsNXDomain, dhcpLeaseBindState=dhcpLeaseBindState, haServiceNodeType=haServiceNodeType, dhcpSubnetIP=dhcpSubnetIP, tftpDaemon=tftpDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, adonis=adonis, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetEntry=dhcpSubnetEntry, dhcpSubnetAlert=dhcpSubnetAlert, dnsStats=dnsStats, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolTable=dhcpPoolTable, commandServer=commandServer, dnsDaemon=dnsDaemon, trapHA=trapHA, tftp=tftp, trapTFTP=trapTFTP, trapDNS=trapDNS, dhcpConfig=dhcpConfig)
