...
ModuleIdentity, IpAddress, TimeTicks, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, MibIdentifier, Counter64, Integer32, iso, NotificationType, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "TimeTicks", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "MibIdentifier", "Counter64", "Integer32", "iso", "NotificationType", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsNXDomain=dnsStatsNXDomain, dhcpStats=dhcpStats, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpSubnetIP=dhcpSubnetIP, lcd=lcd, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonis=adonis, dns=dns, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapHAServiceFailOver=trapHAServiceFailOver, adonisObjects=adonisObjects, trapReplication=trapReplication, trapTFTP=trapTFTP, dnsStatsReferral=dnsStatsReferral, commandServerDaemon=commandServerDaemon, licenseExpiry=licenseExpiry, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, trapDHCPDaemon=trapDHCPDaemon, trapDNSDaemon=trapDNSDaemon, licenseValid=licenseValid, commandServer=commandServer, dhcpSubnetMask=dhcpSubnetMask, trapCommandServer=trapCommandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, trapDNS=trapDNS, dnsStatsRecursion=dnsStatsRecursion, dhcp=dhcp, trapSystemDaemon=trapSystemDaemon, dhcpLeaseStartTime=dhcpLeaseStartTime, trapDHCP=trapDHCP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpSubnetTable=dhcpSubnetTable, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemon=dnsDaemon, dhcpPoolSize=dhcpPoolSize, dhcpLeaseBindState=dhcpLeaseBindState, trapCommandServerDaemon=trapCommandServerDaemon, dhcpConfig=dhcpConfig, dhcpDaemonRunning=dhcpDaemonRunning, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolEndIP=dhcpPoolEndIP, tftpDaemon=tftpDaemon, system=system, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, haServiceRunning=haServiceRunning, dhcpLeaseTable=dhcpLeaseTable, trapSystem=trapSystem, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, ha=ha, dhcpSubnetUsed=dhcpSubnetUsed, PYSNMP_MODULE_ID=adonis, adonisTraps=adonisTraps, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpFailOverState=dhcpFailOverState, haReplicationBinding=haReplicationBinding, dhcpPoolStartIP=dhcpPoolStartIP, dnsStats=dnsStats, dnsStatsFailure=dnsStatsFailure, systemState=systemState, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetSize=dhcpSubnetSize, trapReplicationFailure=trapReplicationFailure, trapHA=trapHA, dhcpPoolAlert=dhcpPoolAlert, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dhcpSubnetEntry=dhcpSubnetEntry, systemDaemon=systemDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, tftp=tftp, dhcpPoolTable=dhcpPoolTable, dhcpIP=dhcpIP, dhcpPoolUsed=dhcpPoolUsed, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpFixedIP=dhcpFixedIP, dhcpSubnetAlert=dhcpSubnetAlert, dhcpPoolEntry=dhcpPoolEntry, haServiceNodeType=haServiceNodeType, trapTFTPDaemon=trapTFTPDaemon, dnsStatsSuccess=dnsStatsSuccess)
