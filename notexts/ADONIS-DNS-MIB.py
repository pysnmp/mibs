...
enterprises, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter64, iso, Bits, ObjectIdentity, IpAddress, Counter32, MibIdentifier, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter64", "iso", "Bits", "ObjectIdentity", "IpAddress", "Counter32", "MibIdentifier", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, dhcpStats=dhcpStats, dnsStatsNXDomain=dnsStatsNXDomain, trapReplication=trapReplication, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetTable=dhcpSubnetTable, dhcpConfig=dhcpConfig, dhcpFailOverState=dhcpFailOverState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, licenseValid=licenseValid, tftpDaemonRunning=tftpDaemonRunning, commandServerDaemonRunning=commandServerDaemonRunning, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetEntry=dhcpSubnetEntry, trapDHCPDaemon=trapDHCPDaemon, adonis=adonis, dhcpDaemonRunning=dhcpDaemonRunning, dhcpLeaseTable=dhcpLeaseTable, trapDNSDaemon=trapDNSDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpIP=dhcpIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsStatsReferral=dnsStatsReferral, systemDaemon=systemDaemon, dhcpLeaseHostname=dhcpLeaseHostname, haServiceNodeType=haServiceNodeType, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, tftp=tftp, adonisObjects=adonisObjects, systemState=systemState, dns=dns, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, ha=ha, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseBindState=dhcpLeaseBindState, dnsStats=dnsStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, lcdDaemon=lcdDaemon, trapHAServiceFailOver=trapHAServiceFailOver, haServiceRunning=haServiceRunning, trapDHCP=trapDHCP, trapHA=trapHA, trapSystem=trapSystem, trapReplicationFailure=trapReplicationFailure, trapTFTP=trapTFTP, dhcpSubnetSize=dhcpSubnetSize, trapSystemDaemon=trapSystemDaemon, dhcpPoolSize=dhcpPoolSize, dhcpPoolEntry=dhcpPoolEntry, licenseExpiry=licenseExpiry, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolTable=dhcpPoolTable, tftpDaemon=tftpDaemon, system=system, dnsStatsFailure=dnsStatsFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpDaemon=dhcpDaemon, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolStartIP=dhcpPoolStartIP, haReplicationBinding=haReplicationBinding, haService=haService, dhcpPoolUsed=dhcpPoolUsed, commandServer=commandServer, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpSubnetUsed=dhcpSubnetUsed, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemon=dnsDaemon, PYSNMP_MODULE_ID=adonis, dhcpSubnetMask=dhcpSubnetMask, dhcpLeaseEntry=dhcpLeaseEntry, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, adonisTraps=adonisTraps, trapDNS=trapDNS, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemon=commandServerDaemon, dhcp=dhcp, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, trapCommandServerDaemon=trapCommandServerDaemon, trapCommandServer=trapCommandServer)
