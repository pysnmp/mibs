...
enterprises, TimeTicks, Integer32, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, iso, Gauge32, MibIdentifier, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "Gauge32", "MibIdentifier", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcp=dhcp, lcd=lcd, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, tftpDaemon=tftpDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIPTable=dhcpFixedIPTable, trapDNS=trapDNS, haServiceRunning=haServiceRunning, commandServerDaemon=commandServerDaemon, dhcpSubnetMask=dhcpSubnetMask, dnsStatsFailure=dnsStatsFailure, trapSystem=trapSystem, dhcpStats=dhcpStats, dhcpIP=dhcpIP, dhcpSubnetEntry=dhcpSubnetEntry, trapDNSDaemon=trapDNSDaemon, trapTFTPDaemon=trapTFTPDaemon, haService=haService, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, trapCommandServer=trapCommandServer, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetAlert=dhcpSubnetAlert, trapTFTP=trapTFTP, commandServer=commandServer, licenseValid=licenseValid, trapDHCPDaemon=trapDHCPDaemon, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpConfig=dhcpConfig, dhcpSubnetIP=dhcpSubnetIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolSize=dhcpPoolSize, tftp=tftp, trapReplication=trapReplication, trapSystemDaemon=trapSystemDaemon, adonis=adonis, dhcpPoolAlert=dhcpPoolAlert, trapDHCP=trapDHCP, licenseExpiry=licenseExpiry, dhcpSubnetSize=dhcpSubnetSize, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetUsed=dhcpSubnetUsed, systemDaemon=systemDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseEntry=dhcpLeaseEntry, commandServerDaemonRunning=commandServerDaemonRunning, ha=ha, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsReferral=dnsStatsReferral, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsNXDomain=dnsStatsNXDomain, dnsDaemon=dnsDaemon, trapHA=trapHA, dhcpFixedIPEntry=dhcpFixedIPEntry, haServiceNodeType=haServiceNodeType, lcdDaemon=lcdDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpDaemon=dhcpDaemon, dnsDaemonRunning=dnsDaemonRunning, adonisTraps=adonisTraps, dhcpPoolEntry=dhcpPoolEntry, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, tftpDaemonRunning=tftpDaemonRunning, dns=dns, dhcpLeaseBindState=dhcpLeaseBindState, dhcpLeaseHostname=dhcpLeaseHostname, system=system, dnsStats=dnsStats, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemState=systemState, dhcpPoolTable=dhcpPoolTable, trapReplicationFailure=trapReplicationFailure, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpLeaseTable=dhcpLeaseTable, dnsStatsRecursion=dnsStatsRecursion, trapHAServiceFailOver=trapHAServiceFailOver, dhcpFixedIP=dhcpFixedIP, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetTable=dhcpSubnetTable, dhcpFailOverState=dhcpFailOverState, haReplicationBinding=haReplicationBinding, adonisObjects=adonisObjects)
