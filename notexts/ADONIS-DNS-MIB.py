...
iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Integer32, Gauge32, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, TimeTicks, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Integer32", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dnsStatsSuccess=dnsStatsSuccess, trapDHCP=trapDHCP, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, adonisTraps=adonisTraps, dhcpPoolAlert=dhcpPoolAlert, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, commandServerDaemonRunning=commandServerDaemonRunning, dhcpFixedIP=dhcpFixedIP, dns=dns, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsStatsReferral=dnsStatsReferral, dhcpStats=dhcpStats, haReplicationBinding=haReplicationBinding, dhcpLeaseStartTime=dhcpLeaseStartTime, trapReplication=trapReplication, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetTable=dhcpSubnetTable, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCPDaemon=trapDHCPDaemon, dhcpIP=dhcpIP, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolEndIP=dhcpPoolEndIP, dnsStatsRecursion=dnsStatsRecursion, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, licenseValid=licenseValid, trapCommandServer=trapCommandServer, trapCommandServerDaemon=trapCommandServerDaemon, dhcpPoolSize=dhcpPoolSize, dhcpPoolUsed=dhcpPoolUsed, tftp=tftp, dhcpPoolStartIP=dhcpPoolStartIP, lcdDaemon=lcdDaemon, haService=haService, trapHA=trapHA, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, commandServer=commandServer, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolTable=dhcpPoolTable, dhcpSubnetEntry=dhcpSubnetEntry, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dnsStatsFailure=dnsStatsFailure, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEntry=dhcpPoolEntry, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTP=trapTFTP, trapReplicationFailure=trapReplicationFailure, dnsStatsNXDomain=dnsStatsNXDomain, dhcp=dhcp, dhcpSubnetSize=dhcpSubnetSize, trapDNS=trapDNS, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpConfig=dhcpConfig, trapSystem=trapSystem, haServiceRunning=haServiceRunning, dhcpSubnetUsed=dhcpSubnetUsed, trapSystemDaemon=trapSystemDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpSubnetIP=dhcpSubnetIP, system=system, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, lcd=lcd, dhcpDaemonRunning=dhcpDaemonRunning, dnsDaemon=dnsDaemon, systemDaemon=systemDaemon, tftpDaemon=tftpDaemon, adonisObjects=adonisObjects, adonis=adonis, dnsDaemonRunning=dnsDaemonRunning, commandServerDaemon=commandServerDaemon, systemState=systemState, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpLeaseTable=dhcpLeaseTable, ha=ha, trapHAServiceFailOver=trapHAServiceFailOver, PYSNMP_MODULE_ID=adonis, licenseExpiry=licenseExpiry, dhcpFixedIPTable=dhcpFixedIPTable, dnsStats=dnsStats, tftpDaemonRunning=tftpDaemonRunning, dhcpFailOverState=dhcpFailOverState, dhcpLeaseHostname=dhcpLeaseHostname, dhcpLeaseBindState=dhcpLeaseBindState, dhcpDaemon=dhcpDaemon)
