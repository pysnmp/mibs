...
ModuleIdentity, enterprises, Integer32, Counter64, IpAddress, MibIdentifier, Counter32, ObjectIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Integer32", "Counter64", "IpAddress", "MibIdentifier", "Counter32", "ObjectIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpSubnetEntry=dhcpSubnetEntry, commandServerDaemonRunning=commandServerDaemonRunning, trapTFTP=trapTFTP, adonisObjects=adonisObjects, trapDNS=trapDNS, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, system=system, dhcpFailOverState=dhcpFailOverState, trapDNSDaemon=trapDNSDaemon, dhcpPoolUsed=dhcpPoolUsed, trapSystem=trapSystem, dhcpSubnetMask=dhcpSubnetMask, haService=haService, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolSize=dhcpPoolSize, dhcpDaemonRunning=dhcpDaemonRunning, tftp=tftp, dhcpDaemon=dhcpDaemon, trapCommandServer=trapCommandServer, dhcpConfig=dhcpConfig, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, haServiceNodeType=haServiceNodeType, dhcpIP=dhcpIP, dnsDaemon=dnsDaemon, dhcpPoolTable=dhcpPoolTable, haReplicationBinding=haReplicationBinding, dhcpStats=dhcpStats, trapDHCP=trapDHCP, dnsStatsRecursion=dnsStatsRecursion, dhcpPoolStartIP=dhcpPoolStartIP, dhcpLeaseBindState=dhcpLeaseBindState, dhcpSubnetTable=dhcpSubnetTable, tftpDaemonRunning=tftpDaemonRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonis=adonis, dhcpFixedIP=dhcpFixedIP, dns=dns, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, PYSNMP_MODULE_ID=adonis, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsNXRRSet=dnsStatsNXRRSet, commandServer=commandServer, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, tftpDaemon=tftpDaemon, trapReplication=trapReplication, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCPDaemon=trapDHCPDaemon, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, trapHAServiceFailOver=trapHAServiceFailOver, licenseValid=licenseValid, dhcpPoolSubnetIP=dhcpPoolSubnetIP, systemState=systemState, licenseExpiry=licenseExpiry, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsReferral=dnsStatsReferral, trapHA=trapHA, dhcpLeaseEntry=dhcpLeaseEntry, dnsStatsSuccess=dnsStatsSuccess, dnsStats=dnsStats, dhcpLeaseHostname=dhcpLeaseHostname, lcdDaemon=lcdDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetIP=dhcpSubnetIP, trapCommandServerDaemon=trapCommandServerDaemon, haServiceRunning=haServiceRunning, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, ha=ha, trapSystemDaemon=trapSystemDaemon, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpFixedIPEntry=dhcpFixedIPEntry, trapReplicationFailure=trapReplicationFailure, dhcp=dhcp, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, dhcpPoolEntry=dhcpPoolEntry, commandServerDaemon=commandServerDaemon)
