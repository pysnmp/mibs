...
enterprises, Counter64, Bits, ObjectIdentity, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType, Counter32, iso, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Bits", "ObjectIdentity", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType", "Counter32", "iso", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", lcd=lcd, dhcpLeaseHostname=dhcpLeaseHostname, trapSystemDaemon=trapSystemDaemon, trapCommandServerDaemon=trapCommandServerDaemon, trapTFTP=trapTFTP, dhcpPoolEndIP=dhcpPoolEndIP, dhcpSubnetEntry=dhcpSubnetEntry, dhcpIP=dhcpIP, haServiceNodeType=haServiceNodeType, adonis=adonis, adonisTraps=adonisTraps, dhcpLeaseBindState=dhcpLeaseBindState, trapDNSDaemon=trapDNSDaemon, dnsDaemon=dnsDaemon, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpFixedIP=dhcpFixedIP, tftpDaemon=tftpDaemon, dhcpStats=dhcpStats, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsStats=dnsStats, commandServerDaemonRunning=commandServerDaemonRunning, dhcpSubnetUsed=dhcpSubnetUsed, trapCommandServer=trapCommandServer, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, adonisObjects=adonisObjects, dhcpDaemon=dhcpDaemon, dns=dns, dhcpFixedIPEntry=dhcpFixedIPEntry, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpDaemonRunning=dhcpDaemonRunning, trapReplication=trapReplication, dnsStatsReferral=dnsStatsReferral, dhcpConfig=dhcpConfig, haServiceRunning=haServiceRunning, trapReplicationFailure=trapReplicationFailure, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHAServiceFailOver=trapHAServiceFailOver, trapDHCPDaemon=trapDHCPDaemon, trapHA=trapHA, dhcp=dhcp, dhcpPoolSubnetIP=dhcpPoolSubnetIP, haReplicationBinding=haReplicationBinding, trapDNS=trapDNS, dhcpFixedIPTable=dhcpFixedIPTable, haService=haService, dnsStatsSuccess=dnsStatsSuccess, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolStartIP=dhcpPoolStartIP, dhcpPoolAlert=dhcpPoolAlert, lcdDaemon=lcdDaemon, dhcpSubnetAlert=dhcpSubnetAlert, dhcpSubnetMask=dhcpSubnetMask, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapDHCP=trapDHCP, dhcpPoolTable=dhcpPoolTable, trapTFTPDaemon=trapTFTPDaemon, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXRRSet=dnsStatsNXRRSet, licenseValid=licenseValid, ha=ha, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsStatsNXDomain=dnsStatsNXDomain, dnsStatsFailure=dnsStatsFailure, dnsDaemonDebugLevel=dnsDaemonDebugLevel, system=system, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, dhcpSubnetSize=dhcpSubnetSize, systemState=systemState, PYSNMP_MODULE_ID=adonis, commandServer=commandServer, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonRunning=dnsDaemonRunning, dnsStatsRecursion=dnsStatsRecursion, trapSystem=trapSystem, dhcpLeaseStartTime=dhcpLeaseStartTime, tftpDaemonRunning=tftpDaemonRunning, tftp=tftp, systemDaemon=systemDaemon, dhcpLeaseTable=dhcpLeaseTable, commandServerDaemon=commandServerDaemon, dhcpFailOverState=dhcpFailOverState, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpPoolSize=dhcpPoolSize, licenseExpiry=licenseExpiry, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpPoolUsed=dhcpPoolUsed)
