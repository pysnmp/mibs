...
ModuleIdentity, ObjectIdentity, enterprises, Gauge32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, IpAddress, TimeTicks, NotificationType, iso, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "Gauge32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "IpAddress", "TimeTicks", "NotificationType", "iso", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", trapReplication=trapReplication, dhcpDaemonRunning=dhcpDaemonRunning, systemState=systemState, dhcpPoolUsed=dhcpPoolUsed, dhcpSubnetTable=dhcpSubnetTable, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dnsDaemonRunning=dnsDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dnsStats=dnsStats, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapHAServiceFailOver=trapHAServiceFailOver, licenseExpiry=licenseExpiry, dnsStatsRecursion=dnsStatsRecursion, dhcpDaemon=dhcpDaemon, dnsStatsReferral=dnsStatsReferral, haServiceRunning=haServiceRunning, systemDaemon=systemDaemon, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolAlert=dhcpPoolAlert, trapDHCPDaemon=trapDHCPDaemon, dnsStatsFailure=dnsStatsFailure, dnsStatsNXDomain=dnsStatsNXDomain, haReplicationBinding=haReplicationBinding, system=system, commandServer=commandServer, dhcpPoolSize=dhcpPoolSize, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpPoolEndIP=dhcpPoolEndIP, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, dhcpSubnetSize=dhcpSubnetSize, adonisTraps=adonisTraps, dns=dns, dhcpPoolTable=dhcpPoolTable, haServiceNodeType=haServiceNodeType, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseBindState=dhcpLeaseBindState, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, trapSystem=trapSystem, dhcpLeaseStartTime=dhcpLeaseStartTime, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpConfig=dhcpConfig, dhcpFixedIPTable=dhcpFixedIPTable, dnsStatsSuccess=dnsStatsSuccess, trapTFTPDaemon=trapTFTPDaemon, dhcp=dhcp, licenseValid=licenseValid, tftpDaemon=tftpDaemon, adonis=adonis, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, lcd=lcd, trapHA=trapHA, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, commandServerDaemonRunning=commandServerDaemonRunning, adonisObjects=adonisObjects, haService=haService, dhcpIP=dhcpIP, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetAlert=dhcpSubnetAlert, trapDNSDaemon=trapDNSDaemon, dhcpSubnetMask=dhcpSubnetMask, dhcpPoolStartIP=dhcpPoolStartIP, dhcpFixedIP=dhcpFixedIP, trapReplicationFailure=trapReplicationFailure, dhcpStats=dhcpStats, trapDNS=trapDNS, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, lcdDaemon=lcdDaemon, trapCommandServer=trapCommandServer, dhcpPoolSubnetIP=dhcpPoolSubnetIP, PYSNMP_MODULE_ID=adonis, ha=ha, dhcpSubnetUsed=dhcpSubnetUsed, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetEntry=dhcpSubnetEntry, trapTFTP=trapTFTP, tftp=tftp, trapDHCP=trapDHCP, dnsStatsNXRRSet=dnsStatsNXRRSet, dnsDaemon=dnsDaemon, commandServerDaemon=commandServerDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapCommandServerDaemon=trapCommandServerDaemon)
