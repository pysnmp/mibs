...
Integer32, Counter64, iso, MibIdentifier, Bits, Gauge32, TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, ModuleIdentity, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "iso", "MibIdentifier", "Bits", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "ModuleIdentity", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", system=system, trapTFTP=trapTFTP, trapReplicationFailure=trapReplicationFailure, dnsDaemon=dnsDaemon, dhcpFailOverState=dhcpFailOverState, dhcpFixedIPEntry=dhcpFixedIPEntry, dns=dns, dnsStatsRecursion=dnsStatsRecursion, dnsStatsSuccess=dnsStatsSuccess, licenseValid=licenseValid, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapSystemDaemon=trapSystemDaemon, dhcpLeaseEntry=dhcpLeaseEntry, dhcpPoolSize=dhcpPoolSize, lcd=lcd, dnsStatsNXRRSet=dnsStatsNXRRSet, dhcpSubnetMask=dhcpSubnetMask, dhcpIP=dhcpIP, dhcpDaemon=dhcpDaemon, dhcpSubnetTable=dhcpSubnetTable, tftp=tftp, systemDaemon=systemDaemon, dhcpPoolTable=dhcpPoolTable, dhcpSubnetUsed=dhcpSubnetUsed, trapDHCPDaemon=trapDHCPDaemon, dhcpFixedIPTable=dhcpFixedIPTable, dnsDaemonDebugLevel=dnsDaemonDebugLevel, dhcpSubnetAlert=dhcpSubnetAlert, trapHAServiceFailOver=trapHAServiceFailOver, dhcpLeaseBindState=dhcpLeaseBindState, dhcpPoolAlert=dhcpPoolAlert, dnsDaemonRunning=dnsDaemonRunning, dnsStatsNXDomain=dnsStatsNXDomain, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, haReplicationBinding=haReplicationBinding, trapDNSDaemon=trapDNSDaemon, haServiceNodeType=haServiceNodeType, systemState=systemState, adonisObjects=adonisObjects, tftpDaemon=tftpDaemon, licenseExpiry=licenseExpiry, dhcpPoolEntry=dhcpPoolEntry, commandServer=commandServer, haServiceRunning=haServiceRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, adonisTraps=adonisTraps, trapDHCP=trapDHCP, dhcpSubnetEntry=dhcpSubnetEntry, trapReplication=trapReplication, dhcpPoolSubnetIP=dhcpPoolSubnetIP, ha=ha, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, trapDNS=trapDNS, dnsStatsFailure=dnsStatsFailure, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, trapTFTPDaemon=trapTFTPDaemon, commandServerDaemon=commandServerDaemon, trapCommandServerDaemon=trapCommandServerDaemon, dhcpDaemonRunning=dhcpDaemonRunning, dhcpPoolUsed=dhcpPoolUsed, lcdDaemon=lcdDaemon, trapHA=trapHA, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, trapSystem=trapSystem, dhcpLeaseHostname=dhcpLeaseHostname, dhcpPoolEndIP=dhcpPoolEndIP, dhcpPoolStartIP=dhcpPoolStartIP, dhcpSubnetIP=dhcpSubnetIP, dhcpLeaseTable=dhcpLeaseTable, dnsStats=dnsStats, dnsStatsReferral=dnsStatsReferral, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, adonis=adonis, dhcpStats=dhcpStats, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, trapCommandServer=trapCommandServer, dhcp=dhcp, dhcpFixedIP=dhcpFixedIP, dhcpConfig=dhcpConfig, dhcpLeaseStartTime=dhcpLeaseStartTime, haService=haService, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemonRunning=commandServerDaemonRunning, PYSNMP_MODULE_ID=adonis, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, tftpDaemonRunning=tftpDaemonRunning, dhcpLeaseEndTime=dhcpLeaseEndTime)
