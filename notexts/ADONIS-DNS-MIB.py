...
Gauge32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ObjectIdentity, Counter32, MibIdentifier, Unsigned32, Counter64, ModuleIdentity, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ObjectIdentity", "Counter32", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolEntry=dhcpPoolEntry, trapDNS=trapDNS, haReplicationBinding=haReplicationBinding, trapCommandServerDaemon=trapCommandServerDaemon, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, commandServer=commandServer, trapSystem=trapSystem, dhcp=dhcp, licenseExpiry=licenseExpiry, dhcpFailOverState=dhcpFailOverState, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpPoolEndIP=dhcpPoolEndIP, haServiceNodeType=haServiceNodeType, trapReplicationFailure=trapReplicationFailure, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpPoolUsed=dhcpPoolUsed, dnsStatsReferral=dnsStatsReferral, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, dhcpLeaseHostname=dhcpLeaseHostname, dhcpConfig=dhcpConfig, dnsDaemonRunning=dnsDaemonRunning, trapSystemDaemon=trapSystemDaemon, dnsStatsNXRRSet=dnsStatsNXRRSet, systemState=systemState, dhcpPoolStartIP=dhcpPoolStartIP, adonis=adonis, dnsStats=dnsStats, haServiceRunning=haServiceRunning, haService=haService, dhcpFixedIP=dhcpFixedIP, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, dhcpLeaseStartTime=dhcpLeaseStartTime, dhcpLeaseBindState=dhcpLeaseBindState, dhcpFixedIPTable=dhcpFixedIPTable, dhcpSubnetEntry=dhcpSubnetEntry, tftpDaemon=tftpDaemon, dhcpLeaseTable=dhcpLeaseTable, dhcpSubnetMask=dhcpSubnetMask, dnsStatsSuccess=dnsStatsSuccess, dnsStatsRecursion=dnsStatsRecursion, systemDaemon=systemDaemon, trapHAServiceFailOver=trapHAServiceFailOver, dhcpDaemonRunning=dhcpDaemonRunning, dhcpSubnetTable=dhcpSubnetTable, trapTFTPDaemon=trapTFTPDaemon, lcd=lcd, dns=dns, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess, PYSNMP_MODULE_ID=adonis, dnsStatsFailure=dnsStatsFailure, dhcpPoolSize=dhcpPoolSize, dnsStatsNXDomain=dnsStatsNXDomain, dhcpStats=dhcpStats, trapReplication=trapReplication, dhcpLeaseEndTime=dhcpLeaseEndTime, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, lcdDaemon=lcdDaemon, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapDHCPDaemon=trapDHCPDaemon, adonisTraps=adonisTraps, dhcpSubnetSize=dhcpSubnetSize, dnsDaemonDebugLevel=dnsDaemonDebugLevel, trapTFTP=trapTFTP, dhcpSubnetAlert=dhcpSubnetAlert, trapDHCP=trapDHCP, dhcpDaemon=dhcpDaemon, licenseValid=licenseValid, dhcpPoolAlert=dhcpPoolAlert, dhcpIP=dhcpIP, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpPoolTable=dhcpPoolTable, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, commandServerDaemon=commandServerDaemon, ha=ha, adonisObjects=adonisObjects, trapHA=trapHA, dnsDaemon=dnsDaemon, commandServerDaemonRunning=commandServerDaemonRunning, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetUsed=dhcpSubnetUsed, tftp=tftp, trapCommandServer=trapCommandServer, trapDNSDaemon=trapDNSDaemon, tftpDaemonRunning=tftpDaemonRunning, system=system, dhcpSubnetIP=dhcpSubnetIP)
