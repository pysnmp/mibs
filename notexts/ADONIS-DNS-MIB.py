...
Counter64, ObjectIdentity, Counter32, Unsigned32, TimeTicks, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, enterprises, IpAddress, NotificationType, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "TimeTicks", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "enterprises", "IpAddress", "NotificationType", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("ADONIS-DNS-MIB", dhcpPoolSize=dhcpPoolSize, dhcpLeaseEndTime=dhcpLeaseEndTime, dhcpFailOverState=dhcpFailOverState, dhcpStats=dhcpStats, dhcpLeaseBindState=dhcpLeaseBindState, systemDaemon=systemDaemon, trapReplication=trapReplication, trapHAServiceFailOver=trapHAServiceFailOver, dhcpSubnetEntry=dhcpSubnetEntry, trapSystemDaemon=trapSystemDaemon, dhcpConfig=dhcpConfig, haServiceRunning=haServiceRunning, dnsDaemonSOAQueriesInProgress=dnsDaemonSOAQueriesInProgress, dhcpLeaseTable=dhcpLeaseTable, dhcpPoolEntry=dhcpPoolEntry, dnsStatsNXDomain=dnsStatsNXDomain, dhcpSubnetIP=dhcpSubnetIP, dhcpSubnetAlert=dhcpSubnetAlert, dnsStatsSuccess=dnsStatsSuccess, dnsDaemonZoneTransfersInProgress=dnsDaemonZoneTransfersInProgress, haReplicationBinding=haReplicationBinding, licenseValid=licenseValid, dhcpSubnetTable=dhcpSubnetTable, trapTFTPDaemon=trapTFTPDaemon, adonisTraps=adonisTraps, dnsDaemonNumberOfZones=dnsDaemonNumberOfZones, dnsStatsFailure=dnsStatsFailure, trapCommandServerDaemon=trapCommandServerDaemon, tftp=tftp, trapReplicationFailure=trapReplicationFailure, dnsDaemonQueryLoggingState=dnsDaemonQueryLoggingState, haService=haService, dnsStatsReferral=dnsStatsReferral, dhcpPoolAlert=dhcpPoolAlert, dhcpFixedIP=dhcpFixedIP, dhcpPoolUsed=dhcpPoolUsed, trapDNSDaemon=trapDNSDaemon, adonis=adonis, dnsDaemon=dnsDaemon, dns=dns, dhcp=dhcp, ha=ha, commandServerDaemon=commandServerDaemon, dhcpFixedIPTable=dhcpFixedIPTable, lcd=lcd, dhcpLeaseEntry=dhcpLeaseEntry, dhcpSubnetMask=dhcpSubnetMask, dhcpDaemonRunning=dhcpDaemonRunning, dnsStatsNXRRSet=dnsStatsNXRRSet, trapTFTP=trapTFTP, trapDHCP=trapDHCP, dhcpDaemonSubnetAlert=dhcpDaemonSubnetAlert, PYSNMP_MODULE_ID=adonis, dnsStatsRecursion=dnsStatsRecursion, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpSubnetSize=dhcpSubnetSize, dnsStats=dnsStats, dhcpFixedIPEntry=dhcpFixedIPEntry, dhcpIP=dhcpIP, dhcpDaemon=dhcpDaemon, dnsDaemonDebugLevel=dnsDaemonDebugLevel, haServiceNodeType=haServiceNodeType, trapCommandServer=trapCommandServer, tftpDaemon=tftpDaemon, lcdDaemon=lcdDaemon, dhcpSubnetUsed=dhcpSubnetUsed, commandServer=commandServer, dhcpLeaseTimeStamp=dhcpLeaseTimeStamp, trapHA=trapHA, systemState=systemState, adonisObjects=adonisObjects, dhcpPoolSubnetIP=dhcpPoolSubnetIP, dhcpLeaseHostname=dhcpLeaseHostname, tftpDaemonRunning=tftpDaemonRunning, dhcpPoolTable=dhcpPoolTable, dhcpLeaseStartTime=dhcpLeaseStartTime, dnsDaemonRunning=dnsDaemonRunning, dhcpPoolStartIP=dhcpPoolStartIP, dnsDaemonZoneTransfersDeferred=dnsDaemonZoneTransfersDeferred, trapSystem=trapSystem, system=system, commandServerDaemonRunning=commandServerDaemonRunning, trapDNS=trapDNS, dnsDaemonZoneTransferFailure=dnsDaemonZoneTransferFailure, licenseExpiry=licenseExpiry, trapDHCPDaemon=trapDHCPDaemon, dhcpPoolEndIP=dhcpPoolEndIP, dhcpDaemonLeaseStatsSuccess=dhcpDaemonLeaseStatsSuccess)
