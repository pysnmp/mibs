...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:57:14 2021
...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, enterprises, ObjectIdentity, Unsigned32, Integer32, iso, Bits, Gauge32, MibIdentifier, IpAddress, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "enterprises", "ObjectIdentity", "Unsigned32", "Integer32", "iso", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("RAY-MIB", alarmRfPowerFail=alarmRfPowerFail, duplex=duplex, alarmRss=alarmRss, ServiceState=ServiceState, productName=productName, mac=mac, numDisconnect=numDisconnect, rxDones=rxDones, voltageSource=voltageSource, txChannel=txChannel, tr2WifiOn=tr2WifiOn, ethOutThroughput=ethOutThroughput, rxCodeErrors=rxCodeErrors, speed=speed, rxDroppedPkts=rxDroppedPkts, channelArrangement=channelArrangement, keyEntry=keyEntry, lineStatus=lineStatus, useLogStorage=useLogStorage, txFreq=txFreq, radio=radio, ifEth=ifEth, system=system, rxChannel=rxChannel, securePeerMode=securePeerMode, rfPowerFail=rfPowerFail, rfPowerStatus=rfPowerStatus, rxFalseCarrierErrors=rxFalseCarrierErrors, tr2VoltageLowAlarm=tr2VoltageLowAlarm, systemStatus=systemStatus, fecUncorrectBlockCounter=fecUncorrectBlockCounter, station=station, airDisconnect=airDisconnect, netBitrate=netBitrate, serialNumber=serialNumber, tr2RssAlarm=tr2RssAlarm, snrAlarm=snrAlarm, tr2Eth1LinkDown=tr2Eth1LinkDown, PYSNMP_MODULE_ID=ray, fecBlockCounter=fecBlockCounter, tr2TemperatureAlarm=tr2TemperatureAlarm, AlarmState=AlarmState, rayTraps=rayTraps, peerNumber=peerNumber, alarmSnr=alarmSnr, autonego=autonego, prioritized=prioritized, ethernet=ethernet, tr2SnrAlarm=tr2SnrAlarm, ifRadio=ifRadio, powerAlarm=powerAlarm, telnetd=telnetd, alarmVoltageLow=alarmVoltageLow, txDones=txDones, timeMaxDisconnect=timeMaxDisconnect, swVerRadio=swVerRadio, alarmVoltageHigh=alarmVoltageHigh, PhysAddress=PhysAddress, rxFreq=rxFreq, managementVlanId=managementVlanId, matching=matching, DisplayString=DisplayString, unitType=unitType, rxControlFrames=rxControlFrames, mdix=mdix, alarmEth2Down=alarmEth2Down, ethPeer=ethPeer, reliability=reliability, useMemory=useMemory, eth2InThroughput=eth2InThroughput, ifEthEntry=ifEthEntry, alarmBer=alarmBer, txControlFrames=txControlFrames, asymPause=asymPause, txModulation=txModulation, coding=coding, alarmEth1Down=alarmEth1Down, txLengthCheckErrors=txLengthCheckErrors, ModulationList=ModulationList, deviceName=deviceName, tr2VoltageHighAlarm=tr2VoltageHighAlarm, racom=racom, maxNetBitrate=maxNetBitrate, tr2BerAlarm=tr2BerAlarm, serviceVlanId=serviceVlanId, snr=snr, managementVlan=managementVlan, alarm=alarm, alarmTemperature=alarmTemperature, memoryAlarm=memoryAlarm, rxHCBytes=rxHCBytes, rss=rss, wifiHAP=wifiHAP, peerEthLinkDown=peerEthLinkDown, keyTable=keyTable, voltageUnit=voltageUnit, keyName=keyName, lineStatusII=lineStatusII, rxOutOfRangeErrors=rxOutOfRangeErrors, rxBroadcast=rxBroadcast, httpd=httpd, txHCBytes=txHCBytes, eth1Link=eth1Link, rxModulation=rxModulation, berAlarm=berAlarm, ray2Traps=ray2Traps, txCrcErrors=txCrcErrors, rfPowerCurrent=rfPowerCurrent, alarmNetBitrate=alarmNetBitrate, vlanId=vlanId, bandwidthKHz=bandwidthKHz, txPauseFrames=txPauseFrames, bandwidth=bandwidth, searchModeDisabled=searchModeDisabled, swVer=swVer, airConnect=airConnect, eth2Link=eth2Link, txMulticast=txMulticast, temperatureRadio=temperatureRadio, sshd=sshd, chassis=chassis, temperatureModem=temperatureModem, modemR=modemR, product=product, pause=pause, statistic=statistic, OptionSetting=OptionSetting, txBroadcast=txBroadcast, alarmPeerDisconnected=alarmPeerDisconnected, status=status, rxModulationIndex=rxModulationIndex, timeAllConnect=timeAllConnect, tr2AirConnect=tr2AirConnect, authorization=authorization, tr2RfPowerFail=tr2RfPowerFail, ifEthTable=ifEthTable, ray=ray, ber=ber, tr2NetBitrate=tr2NetBitrate, rxPauseFrames=rxPauseFrames, tr2Eth21LinkDown=tr2Eth21LinkDown, tempAlarm=tempAlarm, tr2AirDisconnect=tr2AirDisconnect, rxCrcErrors=rxCrcErrors, useCpu=useCpu, interface=interface, alarmWifiOn=alarmWifiOn, txModulationIndex=txModulationIndex, airWdog=airWdog, timeAllDisconnect=timeAllDisconnect, access=access, info=info, rssAlarm=rssAlarm, ip=ip, rxMulticast=rxMulticast, txCollisions=txCollisions, eth2OutThroughput=eth2OutThroughput, ethInThroughput=ethInThroughput, linkUptime=linkUptime, rfPowerConfigured=rfPowerConfigured)
