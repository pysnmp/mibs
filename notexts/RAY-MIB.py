...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:01:57 2023
...
mib_2, MibIdentifier, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, NotificationType, enterprises, ObjectIdentity, Counter32, iso, TimeTicks, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", speed=speed, alarmEth2Down=alarmEth2Down, txCollisions=txCollisions, txModulationIndex=txModulationIndex, tr2Eth1LinkDown=tr2Eth1LinkDown, txPauseFrames=txPauseFrames, alarmWifiOn=alarmWifiOn, tr2Eth21LinkDown=tr2Eth21LinkDown, rxHCBytes=rxHCBytes, status=status, bandwidthKHz=bandwidthKHz, securePeerMode=securePeerMode, rxCodeErrors=rxCodeErrors, airConnect=airConnect, duplex=duplex, txModulation=txModulation, txLengthCheckErrors=txLengthCheckErrors, ethOutThroughput=ethOutThroughput, rfPowerConfigured=rfPowerConfigured, rxControlFrames=rxControlFrames, alarmNetBitrate=alarmNetBitrate, ifRadio=ifRadio, info=info, rxModulationIndex=rxModulationIndex, rfPowerCurrent=rfPowerCurrent, temperatureModem=temperatureModem, snrAlarm=snrAlarm, station=station, alarmBer=alarmBer, statistic=statistic, rxDones=rxDones, txControlFrames=txControlFrames, tr2WifiOn=tr2WifiOn, authorization=authorization, access=access, berAlarm=berAlarm, tr2RfPowerFail=tr2RfPowerFail, tr2NetBitrate=tr2NetBitrate, ray2Traps=ray2Traps, ifEthEntry=ifEthEntry, rss=rss, ethInThroughput=ethInThroughput, rssAlarm=rssAlarm, lineStatusII=lineStatusII, tr2AirConnect=tr2AirConnect, rxFreq=rxFreq, linkUptime=linkUptime, alarmRss=alarmRss, asymPause=asymPause, reliability=reliability, alarmPeerDisconnected=alarmPeerDisconnected, OptionSetting=OptionSetting, tr2TemperatureAlarm=tr2TemperatureAlarm, eth2InThroughput=eth2InThroughput, rxPauseFrames=rxPauseFrames, temperatureRadio=temperatureRadio, timeMaxDisconnect=timeMaxDisconnect, mac=mac, coding=coding, keyName=keyName, sshd=sshd, snr=snr, AlarmState=AlarmState, alarmRfPowerFail=alarmRfPowerFail, alarmSnr=alarmSnr, searchModeDisabled=searchModeDisabled, ethernet=ethernet, rxCrcErrors=rxCrcErrors, systemStatus=systemStatus, racom=racom, prioritized=prioritized, tempAlarm=tempAlarm, peerEthLinkDown=peerEthLinkDown, rxModulation=rxModulation, txDones=txDones, lineStatus=lineStatus, serviceVlanId=serviceVlanId, radio=radio, tr2VoltageHighAlarm=tr2VoltageHighAlarm, txFreq=txFreq, eth2Link=eth2Link, mdix=mdix, rxMulticast=rxMulticast, ip=ip, rxChannel=rxChannel, pause=pause, keyEntry=keyEntry, httpd=httpd, rayTraps=rayTraps, wifiHAP=wifiHAP, system=system, telnetd=telnetd, alarmVoltageHigh=alarmVoltageHigh, rxFalseCarrierErrors=rxFalseCarrierErrors, swVer=swVer, txHCBytes=txHCBytes, tr2VoltageLowAlarm=tr2VoltageLowAlarm, txMulticast=txMulticast, tr2SnrAlarm=tr2SnrAlarm, unitType=unitType, interface=interface, memoryAlarm=memoryAlarm, rfPowerStatus=rfPowerStatus, rxOutOfRangeErrors=rxOutOfRangeErrors, modemR=modemR, voltageSource=voltageSource, rfPowerFail=rfPowerFail, useCpu=useCpu, ModulationList=ModulationList, maxNetBitrate=maxNetBitrate, powerAlarm=powerAlarm, DisplayString=DisplayString, peerNumber=peerNumber, useLogStorage=useLogStorage, tr2RssAlarm=tr2RssAlarm, bandwidth=bandwidth, timeAllConnect=timeAllConnect, managementVlan=managementVlan, ethPeer=ethPeer, productName=productName, managementVlanId=managementVlanId, channelArrangement=channelArrangement, fecBlockCounter=fecBlockCounter, useMemory=useMemory, airWdog=airWdog, chassis=chassis, ray=ray, alarm=alarm, swVerRadio=swVerRadio, rxDroppedPkts=rxDroppedPkts, eth1Link=eth1Link, alarmVoltageLow=alarmVoltageLow, netBitrate=netBitrate, matching=matching, voltageUnit=voltageUnit, product=product, deviceName=deviceName, txBroadcast=txBroadcast, alarmTemperature=alarmTemperature, txChannel=txChannel, keyTable=keyTable, PhysAddress=PhysAddress, autonego=autonego, timeAllDisconnect=timeAllDisconnect, vlanId=vlanId, ifEthTable=ifEthTable, ber=ber, alarmEth1Down=alarmEth1Down, tr2BerAlarm=tr2BerAlarm, airDisconnect=airDisconnect, fecUncorrectBlockCounter=fecUncorrectBlockCounter, ServiceState=ServiceState, serialNumber=serialNumber, ifEth=ifEth, numDisconnect=numDisconnect, rxBroadcast=rxBroadcast, eth2OutThroughput=eth2OutThroughput, tr2AirDisconnect=tr2AirDisconnect, PYSNMP_MODULE_ID=ray, txCrcErrors=txCrcErrors)
