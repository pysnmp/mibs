...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:30:00 2022
...
mib_2, Unsigned32, iso, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Integer32, Bits, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Integer32", "Bits", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("RAY-MIB", voltageSource=voltageSource, PhysAddress=PhysAddress, info=info, ray=ray, httpd=httpd, channelArrangement=channelArrangement, useCpu=useCpu, ifRadio=ifRadio, fecUncorrectBlockCounter=fecUncorrectBlockCounter, pause=pause, txModulation=txModulation, ifEthTable=ifEthTable, txChannel=txChannel, tr2BerAlarm=tr2BerAlarm, mdix=mdix, tr2Eth1LinkDown=tr2Eth1LinkDown, txPauseFrames=txPauseFrames, rxDones=rxDones, ethPeer=ethPeer, ip=ip, rfPowerStatus=rfPowerStatus, tempAlarm=tempAlarm, PYSNMP_MODULE_ID=ray, timeMaxDisconnect=timeMaxDisconnect, keyName=keyName, racom=racom, txHCBytes=txHCBytes, fecBlockCounter=fecBlockCounter, tr2RfPowerFail=tr2RfPowerFail, bandwidth=bandwidth, modemR=modemR, productName=productName, netBitrate=netBitrate, txCollisions=txCollisions, tr2WifiOn=tr2WifiOn, system=system, ifEthEntry=ifEthEntry, txBroadcast=txBroadcast, timeAllConnect=timeAllConnect, lineStatusII=lineStatusII, rxHCBytes=rxHCBytes, tr2NetBitrate=tr2NetBitrate, duplex=duplex, ethInThroughput=ethInThroughput, lineStatus=lineStatus, alarmTemperature=alarmTemperature, eth2InThroughput=eth2InThroughput, tr2VoltageHighAlarm=tr2VoltageHighAlarm, maxNetBitrate=maxNetBitrate, chassis=chassis, interface=interface, status=status, rxModulation=rxModulation, DisplayString=DisplayString, txLengthCheckErrors=txLengthCheckErrors, snrAlarm=snrAlarm, vlanId=vlanId, ifEth=ifEth, alarmBer=alarmBer, tr2RssAlarm=tr2RssAlarm, alarmSnr=alarmSnr, swVerRadio=swVerRadio, radio=radio, rssAlarm=rssAlarm, wifiHAP=wifiHAP, powerAlarm=powerAlarm, alarmEth1Down=alarmEth1Down, swVer=swVer, ModulationList=ModulationList, rxChannel=rxChannel, txCrcErrors=txCrcErrors, tr2VoltageLowAlarm=tr2VoltageLowAlarm, alarmRss=alarmRss, useLogStorage=useLogStorage, serviceVlanId=serviceVlanId, managementVlan=managementVlan, txControlFrames=txControlFrames, product=product, eth2OutThroughput=eth2OutThroughput, airWdog=airWdog, coding=coding, alarmRfPowerFail=alarmRfPowerFail, rxMulticast=rxMulticast, tr2TemperatureAlarm=tr2TemperatureAlarm, numDisconnect=numDisconnect, rxBroadcast=rxBroadcast, rfPowerCurrent=rfPowerCurrent, reliability=reliability, telnetd=telnetd, rxFreq=rxFreq, securePeerMode=securePeerMode, rxControlFrames=rxControlFrames, station=station, alarmWifiOn=alarmWifiOn, airConnect=airConnect, rxCodeErrors=rxCodeErrors, airDisconnect=airDisconnect, authorization=authorization, temperatureRadio=temperatureRadio, peerEthLinkDown=peerEthLinkDown, memoryAlarm=memoryAlarm, eth2Link=eth2Link, ber=ber, sshd=sshd, ethOutThroughput=ethOutThroughput, managementVlanId=managementVlanId, autonego=autonego, snr=snr, serialNumber=serialNumber, txMulticast=txMulticast, AlarmState=AlarmState, alarmVoltageLow=alarmVoltageLow, unitType=unitType, tr2SnrAlarm=tr2SnrAlarm, ServiceState=ServiceState, tr2AirConnect=tr2AirConnect, asymPause=asymPause, deviceName=deviceName, txFreq=txFreq, rxFalseCarrierErrors=rxFalseCarrierErrors, ray2Traps=ray2Traps, useMemory=useMemory, txDones=txDones, temperatureModem=temperatureModem, timeAllDisconnect=timeAllDisconnect, rxModulationIndex=rxModulationIndex, txModulationIndex=txModulationIndex, rfPowerFail=rfPowerFail, linkUptime=linkUptime, tr2Eth21LinkDown=tr2Eth21LinkDown, alarmVoltageHigh=alarmVoltageHigh, tr2AirDisconnect=tr2AirDisconnect, statistic=statistic, rxCrcErrors=rxCrcErrors, bandwidthKHz=bandwidthKHz, alarmEth2Down=alarmEth2Down, rayTraps=rayTraps, rxDroppedPkts=rxDroppedPkts, keyTable=keyTable, systemStatus=systemStatus, alarm=alarm, rfPowerConfigured=rfPowerConfigured, rxOutOfRangeErrors=rxOutOfRangeErrors, berAlarm=berAlarm, eth1Link=eth1Link, rxPauseFrames=rxPauseFrames, alarmPeerDisconnected=alarmPeerDisconnected, rss=rss, access=access, mac=mac, voltageUnit=voltageUnit, prioritized=prioritized, ethernet=ethernet, peerNumber=peerNumber, speed=speed, alarmNetBitrate=alarmNetBitrate, searchModeDisabled=searchModeDisabled, matching=matching, OptionSetting=OptionSetting, keyEntry=keyEntry)
