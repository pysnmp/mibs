...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:06:22 2023
...
mib_2, Unsigned32, Integer32, Counter64, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, MibIdentifier, enterprises, iso, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "Integer32", "Counter64", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "MibIdentifier", "enterprises", "iso", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", fecUncorrectBlockCounter=fecUncorrectBlockCounter, swVer=swVer, alarmEth1Down=alarmEth1Down, tr2SnrAlarm=tr2SnrAlarm, temperatureRadio=temperatureRadio, txMulticast=txMulticast, tr2VoltageLowAlarm=tr2VoltageLowAlarm, system=system, airDisconnect=airDisconnect, tr2Eth21LinkDown=tr2Eth21LinkDown, alarm=alarm, statistic=statistic, rxHCBytes=rxHCBytes, rxMulticast=rxMulticast, linkUptime=linkUptime, rxCrcErrors=rxCrcErrors, ethInThroughput=ethInThroughput, ifEthTable=ifEthTable, ifEthEntry=ifEthEntry, rxBroadcast=rxBroadcast, timeAllConnect=timeAllConnect, interface=interface, reliability=reliability, txCrcErrors=txCrcErrors, serviceVlanId=serviceVlanId, rfPowerCurrent=rfPowerCurrent, keyEntry=keyEntry, berAlarm=berAlarm, rss=rss, speed=speed, rssAlarm=rssAlarm, info=info, txControlFrames=txControlFrames, rxModulationIndex=rxModulationIndex, tr2TemperatureAlarm=tr2TemperatureAlarm, PhysAddress=PhysAddress, DisplayString=DisplayString, txFreq=txFreq, channelArrangement=channelArrangement, tr2AirDisconnect=tr2AirDisconnect, bandwidthKHz=bandwidthKHz, peerNumber=peerNumber, rxFreq=rxFreq, useMemory=useMemory, txBroadcast=txBroadcast, alarmBer=alarmBer, rxOutOfRangeErrors=rxOutOfRangeErrors, voltageUnit=voltageUnit, txModulation=txModulation, alarmTemperature=alarmTemperature, rxChannel=rxChannel, duplex=duplex, racom=racom, snrAlarm=snrAlarm, ray2Traps=ray2Traps, rfPowerStatus=rfPowerStatus, tr2Eth1LinkDown=tr2Eth1LinkDown, eth2OutThroughput=eth2OutThroughput, rxDroppedPkts=rxDroppedPkts, rxDones=rxDones, chassis=chassis, eth1Link=eth1Link, tr2WifiOn=tr2WifiOn, voltageSource=voltageSource, tr2RssAlarm=tr2RssAlarm, access=access, rxFalseCarrierErrors=rxFalseCarrierErrors, tr2NetBitrate=tr2NetBitrate, alarmRfPowerFail=alarmRfPowerFail, mdix=mdix, ray=ray, alarmNetBitrate=alarmNetBitrate, rxCodeErrors=rxCodeErrors, tempAlarm=tempAlarm, keyName=keyName, modemR=modemR, memoryAlarm=memoryAlarm, systemStatus=systemStatus, searchModeDisabled=searchModeDisabled, alarmVoltageLow=alarmVoltageLow, alarmRss=alarmRss, AlarmState=AlarmState, txPauseFrames=txPauseFrames, peerEthLinkDown=peerEthLinkDown, OptionSetting=OptionSetting, PYSNMP_MODULE_ID=ray, serialNumber=serialNumber, lineStatus=lineStatus, wifiHAP=wifiHAP, lineStatusII=lineStatusII, securePeerMode=securePeerMode, tr2BerAlarm=tr2BerAlarm, mac=mac, ip=ip, rxModulation=rxModulation, product=product, txModulationIndex=txModulationIndex, txDones=txDones, authorization=authorization, useCpu=useCpu, bandwidth=bandwidth, ifRadio=ifRadio, ethOutThroughput=ethOutThroughput, alarmEth2Down=alarmEth2Down, eth2InThroughput=eth2InThroughput, rayTraps=rayTraps, sshd=sshd, station=station, autonego=autonego, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ethernet=ethernet, rxControlFrames=rxControlFrames, matching=matching, ifEth=ifEth, managementVlanId=managementVlanId, airConnect=airConnect, radio=radio, powerAlarm=powerAlarm, rfPowerFail=rfPowerFail, keyTable=keyTable, alarmPeerDisconnected=alarmPeerDisconnected, alarmSnr=alarmSnr, timeAllDisconnect=timeAllDisconnect, rfPowerConfigured=rfPowerConfigured, ServiceState=ServiceState, prioritized=prioritized, vlanId=vlanId, deviceName=deviceName, txCollisions=txCollisions, pause=pause, ModulationList=ModulationList, numDisconnect=numDisconnect, temperatureModem=temperatureModem, alarmWifiOn=alarmWifiOn, fecBlockCounter=fecBlockCounter, tr2RfPowerFail=tr2RfPowerFail, timeMaxDisconnect=timeMaxDisconnect, httpd=httpd, ber=ber, rxPauseFrames=rxPauseFrames, coding=coding, ethPeer=ethPeer, maxNetBitrate=maxNetBitrate, asymPause=asymPause, txLengthCheckErrors=txLengthCheckErrors, txHCBytes=txHCBytes, swVerRadio=swVerRadio, useLogStorage=useLogStorage, managementVlan=managementVlan, status=status, productName=productName, eth2Link=eth2Link, netBitrate=netBitrate, txChannel=txChannel, tr2AirConnect=tr2AirConnect, snr=snr, airWdog=airWdog, telnetd=telnetd, alarmVoltageHigh=alarmVoltageHigh, unitType=unitType)
