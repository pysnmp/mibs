...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:24:44 2022
...
MibIdentifier, NotificationType, Unsigned32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, IpAddress, Counter32, Counter64, Bits, mib_2, Gauge32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "IpAddress", "Counter32", "Counter64", "Bits", "mib-2", "Gauge32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", timeMaxDisconnect=timeMaxDisconnect, rxCrcErrors=rxCrcErrors, rfPowerFail=rfPowerFail, tr2NetBitrate=tr2NetBitrate, snr=snr, rxPauseFrames=rxPauseFrames, interface=interface, useMemory=useMemory, txBroadcast=txBroadcast, keyName=keyName, tr2VoltageHighAlarm=tr2VoltageHighAlarm, rfPowerCurrent=rfPowerCurrent, mdix=mdix, AlarmState=AlarmState, peerEthLinkDown=peerEthLinkDown, managementVlanId=managementVlanId, rxControlFrames=rxControlFrames, rxFalseCarrierErrors=rxFalseCarrierErrors, airConnect=airConnect, PYSNMP_MODULE_ID=ray, radio=radio, alarm=alarm, rxMulticast=rxMulticast, rxModulationIndex=rxModulationIndex, tr2SnrAlarm=tr2SnrAlarm, lineStatusII=lineStatusII, ip=ip, alarmSnr=alarmSnr, tr2Eth21LinkDown=tr2Eth21LinkDown, txLengthCheckErrors=txLengthCheckErrors, eth2InThroughput=eth2InThroughput, eth2OutThroughput=eth2OutThroughput, rxChannel=rxChannel, unitType=unitType, bandwidthKHz=bandwidthKHz, tr2RfPowerFail=tr2RfPowerFail, txChannel=txChannel, PhysAddress=PhysAddress, alarmTemperature=alarmTemperature, numDisconnect=numDisconnect, keyTable=keyTable, systemStatus=systemStatus, matching=matching, ifRadio=ifRadio, tr2TemperatureAlarm=tr2TemperatureAlarm, txPauseFrames=txPauseFrames, system=system, snrAlarm=snrAlarm, netBitrate=netBitrate, rxDones=rxDones, tr2Eth1LinkDown=tr2Eth1LinkDown, keyEntry=keyEntry, racom=racom, rxBroadcast=rxBroadcast, ifEthEntry=ifEthEntry, txControlFrames=txControlFrames, alarmRss=alarmRss, tr2BerAlarm=tr2BerAlarm, ifEth=ifEth, rxDroppedPkts=rxDroppedPkts, deviceName=deviceName, ethOutThroughput=ethOutThroughput, rxHCBytes=rxHCBytes, swVerRadio=swVerRadio, ray=ray, ray2Traps=ray2Traps, txMulticast=txMulticast, memoryAlarm=memoryAlarm, station=station, txDones=txDones, productName=productName, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rfPowerStatus=rfPowerStatus, eth2Link=eth2Link, alarmVoltageLow=alarmVoltageLow, autonego=autonego, modemR=modemR, ethInThroughput=ethInThroughput, alarmNetBitrate=alarmNetBitrate, vlanId=vlanId, rxCodeErrors=rxCodeErrors, txCrcErrors=txCrcErrors, alarmVoltageHigh=alarmVoltageHigh, serialNumber=serialNumber, searchModeDisabled=searchModeDisabled, channelArrangement=channelArrangement, temperatureRadio=temperatureRadio, txCollisions=txCollisions, asymPause=asymPause, authorization=authorization, httpd=httpd, speed=speed, rxModulation=rxModulation, alarmBer=alarmBer, useCpu=useCpu, ifEthTable=ifEthTable, powerAlarm=powerAlarm, alarmWifiOn=alarmWifiOn, rss=rss, chassis=chassis, txFreq=txFreq, product=product, fecUncorrectBlockCounter=fecUncorrectBlockCounter, DisplayString=DisplayString, tempAlarm=tempAlarm, txHCBytes=txHCBytes, ethPeer=ethPeer, alarmRfPowerFail=alarmRfPowerFail, wifiHAP=wifiHAP, rssAlarm=rssAlarm, fecBlockCounter=fecBlockCounter, ModulationList=ModulationList, alarmEth2Down=alarmEth2Down, sshd=sshd, txModulation=txModulation, info=info, alarmEth1Down=alarmEth1Down, access=access, OptionSetting=OptionSetting, timeAllDisconnect=timeAllDisconnect, tr2AirDisconnect=tr2AirDisconnect, maxNetBitrate=maxNetBitrate, swVer=swVer, status=status, ethernet=ethernet, bandwidth=bandwidth, duplex=duplex, managementVlan=managementVlan, airWdog=airWdog, eth1Link=eth1Link, coding=coding, lineStatus=lineStatus, useLogStorage=useLogStorage, mac=mac, reliability=reliability, tr2RssAlarm=tr2RssAlarm, prioritized=prioritized, serviceVlanId=serviceVlanId, rayTraps=rayTraps, securePeerMode=securePeerMode, txModulationIndex=txModulationIndex, pause=pause, rfPowerConfigured=rfPowerConfigured, rxOutOfRangeErrors=rxOutOfRangeErrors, airDisconnect=airDisconnect, voltageSource=voltageSource, alarmPeerDisconnected=alarmPeerDisconnected, telnetd=telnetd, voltageUnit=voltageUnit, rxFreq=rxFreq, linkUptime=linkUptime, peerNumber=peerNumber, ber=ber, tr2WifiOn=tr2WifiOn, tr2AirConnect=tr2AirConnect, berAlarm=berAlarm, timeAllConnect=timeAllConnect, ServiceState=ServiceState, temperatureModem=temperatureModem, statistic=statistic)
