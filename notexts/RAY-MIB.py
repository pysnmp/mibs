...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:11:55 2022
...
ObjectIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Unsigned32, ModuleIdentity, iso, TimeTicks, IpAddress, mib_2, enterprises, Counter64, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "iso", "TimeTicks", "IpAddress", "mib-2", "enterprises", "Counter64", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", swVerRadio=swVerRadio, ip=ip, snrAlarm=snrAlarm, mdix=mdix, txPauseFrames=txPauseFrames, serialNumber=serialNumber, snr=snr, useCpu=useCpu, managementVlan=managementVlan, authorization=authorization, pause=pause, tempAlarm=tempAlarm, rayTraps=rayTraps, securePeerMode=securePeerMode, radio=radio, powerAlarm=powerAlarm, txCollisions=txCollisions, timeAllConnect=timeAllConnect, rxControlFrames=rxControlFrames, alarmWifiOn=alarmWifiOn, ray2Traps=ray2Traps, ifEth=ifEth, alarmVoltageLow=alarmVoltageLow, rfPowerFail=rfPowerFail, rxCrcErrors=rxCrcErrors, peerNumber=peerNumber, txBroadcast=txBroadcast, mac=mac, eth1Link=eth1Link, status=status, alarmRss=alarmRss, alarmNetBitrate=alarmNetBitrate, linkUptime=linkUptime, useLogStorage=useLogStorage, keyName=keyName, ethOutThroughput=ethOutThroughput, voltageUnit=voltageUnit, sshd=sshd, swVer=swVer, berAlarm=berAlarm, lineStatusII=lineStatusII, eth2InThroughput=eth2InThroughput, maxNetBitrate=maxNetBitrate, DisplayString=DisplayString, reliability=reliability, station=station, interface=interface, lineStatus=lineStatus, rxHCBytes=rxHCBytes, txHCBytes=txHCBytes, txLengthCheckErrors=txLengthCheckErrors, ifEthTable=ifEthTable, timeAllDisconnect=timeAllDisconnect, alarmVoltageHigh=alarmVoltageHigh, rfPowerConfigured=rfPowerConfigured, ber=ber, keyTable=keyTable, tr2WifiOn=tr2WifiOn, tr2NetBitrate=tr2NetBitrate, racom=racom, temperatureRadio=temperatureRadio, netBitrate=netBitrate, eth2OutThroughput=eth2OutThroughput, airDisconnect=airDisconnect, channelArrangement=channelArrangement, fecBlockCounter=fecBlockCounter, temperatureModem=temperatureModem, systemStatus=systemStatus, ethPeer=ethPeer, tr2SnrAlarm=tr2SnrAlarm, rxFalseCarrierErrors=rxFalseCarrierErrors, fecUncorrectBlockCounter=fecUncorrectBlockCounter, matching=matching, tr2BerAlarm=tr2BerAlarm, rxMulticast=rxMulticast, tr2AirDisconnect=tr2AirDisconnect, voltageSource=voltageSource, tr2RfPowerFail=tr2RfPowerFail, rxBroadcast=rxBroadcast, searchModeDisabled=searchModeDisabled, modemR=modemR, timeMaxDisconnect=timeMaxDisconnect, ifEthEntry=ifEthEntry, tr2Eth21LinkDown=tr2Eth21LinkDown, rxDones=rxDones, duplex=duplex, telnetd=telnetd, rxCodeErrors=rxCodeErrors, rxPauseFrames=rxPauseFrames, txMulticast=txMulticast, ModulationList=ModulationList, productName=productName, alarmPeerDisconnected=alarmPeerDisconnected, rfPowerCurrent=rfPowerCurrent, numDisconnect=numDisconnect, tr2VoltageLowAlarm=tr2VoltageLowAlarm, serviceVlanId=serviceVlanId, airWdog=airWdog, tr2TemperatureAlarm=tr2TemperatureAlarm, info=info, deviceName=deviceName, memoryAlarm=memoryAlarm, tr2RssAlarm=tr2RssAlarm, wifiHAP=wifiHAP, txFreq=txFreq, rxOutOfRangeErrors=rxOutOfRangeErrors, rxModulation=rxModulation, OptionSetting=OptionSetting, tr2Eth1LinkDown=tr2Eth1LinkDown, txModulation=txModulation, rfPowerStatus=rfPowerStatus, PhysAddress=PhysAddress, alarmEth2Down=alarmEth2Down, txControlFrames=txControlFrames, eth2Link=eth2Link, PYSNMP_MODULE_ID=ray, alarmSnr=alarmSnr, unitType=unitType, alarmRfPowerFail=alarmRfPowerFail, AlarmState=AlarmState, txChannel=txChannel, rxChannel=rxChannel, keyEntry=keyEntry, product=product, rss=rss, rxModulationIndex=rxModulationIndex, speed=speed, ServiceState=ServiceState, ethInThroughput=ethInThroughput, bandwidth=bandwidth, airConnect=airConnect, tr2AirConnect=tr2AirConnect, vlanId=vlanId, rxFreq=rxFreq, alarmEth1Down=alarmEth1Down, alarm=alarm, asymPause=asymPause, chassis=chassis, system=system, autonego=autonego, prioritized=prioritized, managementVlanId=managementVlanId, peerEthLinkDown=peerEthLinkDown, txDones=txDones, ray=ray, rssAlarm=rssAlarm, ifRadio=ifRadio, alarmBer=alarmBer, ethernet=ethernet, alarmTemperature=alarmTemperature, useMemory=useMemory, coding=coding, statistic=statistic, txCrcErrors=txCrcErrors, rxDroppedPkts=rxDroppedPkts, txModulationIndex=txModulationIndex, httpd=httpd, bandwidthKHz=bandwidthKHz, tr2VoltageHighAlarm=tr2VoltageHighAlarm, access=access)
