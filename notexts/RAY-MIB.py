...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:46:07 2021
...
ObjectIdentity, MibIdentifier, Integer32, NotificationType, TimeTicks, Counter64, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ModuleIdentity, Counter32, IpAddress, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "Counter64", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "iso")
...
mibBuilder.exportSymbols("RAY-MIB", eth2Link=eth2Link, tr2TemperatureAlarm=tr2TemperatureAlarm, fecUncorrectBlockCounter=fecUncorrectBlockCounter, maxNetBitrate=maxNetBitrate, txBroadcast=txBroadcast, rxCrcErrors=rxCrcErrors, rxCodeErrors=rxCodeErrors, tr2SnrAlarm=tr2SnrAlarm, alarmWifiOn=alarmWifiOn, temperatureModem=temperatureModem, rfPowerStatus=rfPowerStatus, timeAllConnect=timeAllConnect, rayTraps=rayTraps, keyName=keyName, snrAlarm=snrAlarm, rxFalseCarrierErrors=rxFalseCarrierErrors, interface=interface, alarm=alarm, timeAllDisconnect=timeAllDisconnect, airConnect=airConnect, alarmTemperature=alarmTemperature, system=system, txControlFrames=txControlFrames, bandwidth=bandwidth, lineStatusII=lineStatusII, tr2VoltageLowAlarm=tr2VoltageLowAlarm, txChannel=txChannel, powerAlarm=powerAlarm, ifEthTable=ifEthTable, systemStatus=systemStatus, bandwidthKHz=bandwidthKHz, rxControlFrames=rxControlFrames, txPauseFrames=txPauseFrames, serialNumber=serialNumber, txModulation=txModulation, tr2VoltageHighAlarm=tr2VoltageHighAlarm, tr2AirDisconnect=tr2AirDisconnect, channelArrangement=channelArrangement, alarmVoltageHigh=alarmVoltageHigh, sshd=sshd, tempAlarm=tempAlarm, alarmBer=alarmBer, numDisconnect=numDisconnect, chassis=chassis, rxPauseFrames=rxPauseFrames, rxChannel=rxChannel, swVerRadio=swVerRadio, managementVlan=managementVlan, wifiHAP=wifiHAP, ber=ber, rfPowerCurrent=rfPowerCurrent, txCollisions=txCollisions, duplex=duplex, AlarmState=AlarmState, deviceName=deviceName, tr2NetBitrate=tr2NetBitrate, alarmRfPowerFail=alarmRfPowerFail, product=product, info=info, productName=productName, airDisconnect=airDisconnect, ifEth=ifEth, peerEthLinkDown=peerEthLinkDown, linkUptime=linkUptime, ethernet=ethernet, mdix=mdix, tr2RssAlarm=tr2RssAlarm, access=access, tr2AirConnect=tr2AirConnect, useLogStorage=useLogStorage, fecBlockCounter=fecBlockCounter, timeMaxDisconnect=timeMaxDisconnect, rxModulationIndex=rxModulationIndex, txHCBytes=txHCBytes, rfPowerConfigured=rfPowerConfigured, racom=racom, rfPowerFail=rfPowerFail, alarmNetBitrate=alarmNetBitrate, httpd=httpd, alarmRss=alarmRss, PYSNMP_MODULE_ID=ray, radio=radio, rxDroppedPkts=rxDroppedPkts, OptionSetting=OptionSetting, eth2InThroughput=eth2InThroughput, ifEthEntry=ifEthEntry, tr2WifiOn=tr2WifiOn, ServiceState=ServiceState, swVer=swVer, pause=pause, mac=mac, station=station, alarmEth1Down=alarmEth1Down, reliability=reliability, airWdog=airWdog, vlanId=vlanId, serviceVlanId=serviceVlanId, txDones=txDones, searchModeDisabled=searchModeDisabled, ethOutThroughput=ethOutThroughput, alarmPeerDisconnected=alarmPeerDisconnected, ethInThroughput=ethInThroughput, rxDones=rxDones, txLengthCheckErrors=txLengthCheckErrors, tr2RfPowerFail=tr2RfPowerFail, matching=matching, asymPause=asymPause, peerNumber=peerNumber, tr2BerAlarm=tr2BerAlarm, useMemory=useMemory, speed=speed, voltageSource=voltageSource, telnetd=telnetd, ray=ray, netBitrate=netBitrate, rxHCBytes=rxHCBytes, ModulationList=ModulationList, txModulationIndex=txModulationIndex, rss=rss, modemR=modemR, tr2Eth21LinkDown=tr2Eth21LinkDown, voltageUnit=voltageUnit, txCrcErrors=txCrcErrors, keyEntry=keyEntry, unitType=unitType, coding=coding, securePeerMode=securePeerMode, temperatureRadio=temperatureRadio, DisplayString=DisplayString, rxBroadcast=rxBroadcast, ip=ip, prioritized=prioritized, tr2Eth1LinkDown=tr2Eth1LinkDown, rxFreq=rxFreq, keyTable=keyTable, alarmVoltageLow=alarmVoltageLow, useCpu=useCpu, memoryAlarm=memoryAlarm, managementVlanId=managementVlanId, snr=snr, alarmEth2Down=alarmEth2Down, txFreq=txFreq, berAlarm=berAlarm, PhysAddress=PhysAddress, ray2Traps=ray2Traps, statistic=statistic, rssAlarm=rssAlarm, rxOutOfRangeErrors=rxOutOfRangeErrors, txMulticast=txMulticast, ethPeer=ethPeer, lineStatus=lineStatus, eth1Link=eth1Link, autonego=autonego, eth2OutThroughput=eth2OutThroughput, rxMulticast=rxMulticast, authorization=authorization, ifRadio=ifRadio, alarmSnr=alarmSnr, status=status, rxModulation=rxModulation)
