...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:45:54 2023
...
iso, Integer32, mib_2, Unsigned32, Counter64, IpAddress, ModuleIdentity, enterprises, Gauge32, NotificationType, Bits, ObjectIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "mib-2", "Unsigned32", "Counter64", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("RAY-MIB", rfPowerCurrent=rfPowerCurrent, txModulation=txModulation, rxFalseCarrierErrors=rxFalseCarrierErrors, txDones=txDones, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ifEth=ifEth, PYSNMP_MODULE_ID=ray, station=station, AlarmState=AlarmState, alarmEth2Down=alarmEth2Down, system=system, alarmPeerDisconnected=alarmPeerDisconnected, mac=mac, systemStatus=systemStatus, temperatureModem=temperatureModem, rxCrcErrors=rxCrcErrors, alarmEth1Down=alarmEth1Down, airDisconnect=airDisconnect, mdix=mdix, info=info, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rfPowerConfigured=rfPowerConfigured, searchModeDisabled=searchModeDisabled, linkUptime=linkUptime, rxFreq=rxFreq, alarmVoltageHigh=alarmVoltageHigh, tr2NetBitrate=tr2NetBitrate, ip=ip, voltageSource=voltageSource, tr2WifiOn=tr2WifiOn, ber=ber, ethPeer=ethPeer, alarmSnr=alarmSnr, ifEthEntry=ifEthEntry, asymPause=asymPause, coding=coding, eth2OutThroughput=eth2OutThroughput, tr2TemperatureAlarm=tr2TemperatureAlarm, radio=radio, rxChannel=rxChannel, rxCodeErrors=rxCodeErrors, timeAllConnect=timeAllConnect, bandwidthKHz=bandwidthKHz, rxDroppedPkts=rxDroppedPkts, tempAlarm=tempAlarm, peerNumber=peerNumber, temperatureRadio=temperatureRadio, unitType=unitType, keyEntry=keyEntry, rxModulationIndex=rxModulationIndex, peerEthLinkDown=peerEthLinkDown, rxPauseFrames=rxPauseFrames, rfPowerFail=rfPowerFail, useCpu=useCpu, memoryAlarm=memoryAlarm, reliability=reliability, swVerRadio=swVerRadio, managementVlan=managementVlan, rxHCBytes=rxHCBytes, txHCBytes=txHCBytes, rxControlFrames=rxControlFrames, chassis=chassis, rfPowerStatus=rfPowerStatus, httpd=httpd, rxOutOfRangeErrors=rxOutOfRangeErrors, tr2RssAlarm=tr2RssAlarm, eth2Link=eth2Link, lineStatus=lineStatus, telnetd=telnetd, ServiceState=ServiceState, interface=interface, snr=snr, snrAlarm=snrAlarm, rxBroadcast=rxBroadcast, speed=speed, alarmWifiOn=alarmWifiOn, productName=productName, eth2InThroughput=eth2InThroughput, tr2Eth1LinkDown=tr2Eth1LinkDown, txChannel=txChannel, ifRadio=ifRadio, swVer=swVer, txModulationIndex=txModulationIndex, rxDones=rxDones, ethOutThroughput=ethOutThroughput, txCollisions=txCollisions, ethInThroughput=ethInThroughput, serialNumber=serialNumber, alarmRss=alarmRss, prioritized=prioritized, pause=pause, eth1Link=eth1Link, rayTraps=rayTraps, tr2SnrAlarm=tr2SnrAlarm, access=access, txPauseFrames=txPauseFrames, powerAlarm=powerAlarm, useMemory=useMemory, serviceVlanId=serviceVlanId, DisplayString=DisplayString, matching=matching, timeMaxDisconnect=timeMaxDisconnect, alarmNetBitrate=alarmNetBitrate, txMulticast=txMulticast, txControlFrames=txControlFrames, airConnect=airConnect, OptionSetting=OptionSetting, txBroadcast=txBroadcast, alarm=alarm, ModulationList=ModulationList, bandwidth=bandwidth, rxMulticast=rxMulticast, fecUncorrectBlockCounter=fecUncorrectBlockCounter, vlanId=vlanId, ray2Traps=ray2Traps, fecBlockCounter=fecBlockCounter, voltageUnit=voltageUnit, tr2AirDisconnect=tr2AirDisconnect, tr2Eth21LinkDown=tr2Eth21LinkDown, berAlarm=berAlarm, txLengthCheckErrors=txLengthCheckErrors, tr2BerAlarm=tr2BerAlarm, statistic=statistic, product=product, txCrcErrors=txCrcErrors, lineStatusII=lineStatusII, rssAlarm=rssAlarm, securePeerMode=securePeerMode, rss=rss, alarmBer=alarmBer, txFreq=txFreq, alarmTemperature=alarmTemperature, channelArrangement=channelArrangement, authorization=authorization, keyName=keyName, rxModulation=rxModulation, duplex=duplex, autonego=autonego, wifiHAP=wifiHAP, PhysAddress=PhysAddress, numDisconnect=numDisconnect, useLogStorage=useLogStorage, status=status, ray=ray, deviceName=deviceName, managementVlanId=managementVlanId, maxNetBitrate=maxNetBitrate, alarmRfPowerFail=alarmRfPowerFail, timeAllDisconnect=timeAllDisconnect, airWdog=airWdog, tr2AirConnect=tr2AirConnect, tr2RfPowerFail=tr2RfPowerFail, alarmVoltageLow=alarmVoltageLow, modemR=modemR, sshd=sshd, keyTable=keyTable, ifEthTable=ifEthTable, netBitrate=netBitrate, ethernet=ethernet, racom=racom)
