...
ModuleIdentity, Counter32, Unsigned32, iso, Bits, Counter64, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, NotificationType, Integer32, enterprises, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "Bits", "Counter64", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "NotificationType", "Integer32", "enterprises", "MibIdentifier", "mib-2")
...
mibBuilder.exportSymbols("RAY-MIB", vlanId=vlanId, rxCrcErrors=rxCrcErrors, PYSNMP_MODULE_ID=ray, serviceVlanId=serviceVlanId, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ethOutThroughput=ethOutThroughput, bandwidth=bandwidth, eth1Link=eth1Link, rxFalseCarrierErrors=rxFalseCarrierErrors, tr2VoltageLowAlarm=tr2VoltageLowAlarm, tr2WifiOn=tr2WifiOn, system=system, ethernet=ethernet, ber=ber, securePeerMode=securePeerMode, alarmVoltageHigh=alarmVoltageHigh, rxCodeErrors=rxCodeErrors, tr2AirDisconnect=tr2AirDisconnect, ServiceState=ServiceState, tr2Eth1LinkDown=tr2Eth1LinkDown, tr2RfPowerFail=tr2RfPowerFail, lineStatusII=lineStatusII, snrAlarm=snrAlarm, peerNumber=peerNumber, mdix=mdix, unitType=unitType, alarmBer=alarmBer, autonego=autonego, wifiHAP=wifiHAP, rfPowerConfigured=rfPowerConfigured, httpd=httpd, rssAlarm=rssAlarm, reliability=reliability, airConnect=airConnect, matching=matching, modemR=modemR, rxOutOfRangeErrors=rxOutOfRangeErrors, temperatureRadio=temperatureRadio, timeAllConnect=timeAllConnect, duplex=duplex, speed=speed, productName=productName, lineStatus=lineStatus, powerAlarm=powerAlarm, txPauseFrames=txPauseFrames, txFreq=txFreq, access=access, alarmWifiOn=alarmWifiOn, voltageSource=voltageSource, rxDones=rxDones, racom=racom, tempAlarm=tempAlarm, systemStatus=systemStatus, ifEthEntry=ifEthEntry, rxHCBytes=rxHCBytes, mac=mac, alarm=alarm, rxBroadcast=rxBroadcast, rxPauseFrames=rxPauseFrames, berAlarm=berAlarm, rfPowerStatus=rfPowerStatus, rxControlFrames=rxControlFrames, rss=rss, telnetd=telnetd, coding=coding, eth2InThroughput=eth2InThroughput, txMulticast=txMulticast, timeMaxDisconnect=timeMaxDisconnect, ifEth=ifEth, txCrcErrors=txCrcErrors, info=info, eth2Link=eth2Link, tr2RssAlarm=tr2RssAlarm, snr=snr, tr2Eth21LinkDown=tr2Eth21LinkDown, alarmSnr=alarmSnr, searchModeDisabled=searchModeDisabled, useMemory=useMemory, alarmEth1Down=alarmEth1Down, swVerRadio=swVerRadio, OptionSetting=OptionSetting, ethPeer=ethPeer, fecBlockCounter=fecBlockCounter, ethInThroughput=ethInThroughput, txChannel=txChannel, txBroadcast=txBroadcast, useCpu=useCpu, swVer=swVer, DisplayString=DisplayString, AlarmState=AlarmState, peerEthLinkDown=peerEthLinkDown, ray2Traps=ray2Traps, txLengthCheckErrors=txLengthCheckErrors, txControlFrames=txControlFrames, product=product, txModulationIndex=txModulationIndex, tr2NetBitrate=tr2NetBitrate, pause=pause, eth2OutThroughput=eth2OutThroughput, airWdog=airWdog, alarmPeerDisconnected=alarmPeerDisconnected, txCollisions=txCollisions, tr2BerAlarm=tr2BerAlarm, temperatureModem=temperatureModem, tr2AirConnect=tr2AirConnect, deviceName=deviceName, keyEntry=keyEntry, voltageUnit=voltageUnit, alarmNetBitrate=alarmNetBitrate, netBitrate=netBitrate, serialNumber=serialNumber, txHCBytes=txHCBytes, ray=ray, asymPause=asymPause, statistic=statistic, rxModulationIndex=rxModulationIndex, keyTable=keyTable, authorization=authorization, maxNetBitrate=maxNetBitrate, radio=radio, txDones=txDones, useLogStorage=useLogStorage, alarmVoltageLow=alarmVoltageLow, tr2SnrAlarm=tr2SnrAlarm, timeAllDisconnect=timeAllDisconnect, keyName=keyName, tr2TemperatureAlarm=tr2TemperatureAlarm, rayTraps=rayTraps, rxMulticast=rxMulticast, rxDroppedPkts=rxDroppedPkts, txModulation=txModulation, status=status, memoryAlarm=memoryAlarm, sshd=sshd, rxModulation=rxModulation, linkUptime=linkUptime, ModulationList=ModulationList, managementVlan=managementVlan, numDisconnect=numDisconnect, rfPowerFail=rfPowerFail, rxFreq=rxFreq, managementVlanId=managementVlanId, rfPowerCurrent=rfPowerCurrent, channelArrangement=channelArrangement, alarmRss=alarmRss, alarmEth2Down=alarmEth2Down, ifEthTable=ifEthTable, alarmRfPowerFail=alarmRfPowerFail, PhysAddress=PhysAddress, chassis=chassis, alarmTemperature=alarmTemperature, ifRadio=ifRadio, ip=ip, bandwidthKHz=bandwidthKHz, fecUncorrectBlockCounter=fecUncorrectBlockCounter, rxChannel=rxChannel, airDisconnect=airDisconnect, prioritized=prioritized, interface=interface, station=station)
