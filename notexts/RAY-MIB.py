...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:13:03 2023
...
Integer32, Counter32, Unsigned32, Bits, NotificationType, ObjectIdentity, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32, MibIdentifier, Counter64, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "Bits", "NotificationType", "ObjectIdentity", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32", "MibIdentifier", "Counter64", "enterprises", "iso")
...
mibBuilder.exportSymbols("RAY-MIB", rxCodeErrors=rxCodeErrors, alarmEth2Down=alarmEth2Down, alarmPeerDisconnected=alarmPeerDisconnected, rxDones=rxDones, alarm=alarm, managementVlan=managementVlan, managementVlanId=managementVlanId, ray2Traps=ray2Traps, fecBlockCounter=fecBlockCounter, temperatureModem=temperatureModem, rxHCBytes=rxHCBytes, alarmWifiOn=alarmWifiOn, txHCBytes=txHCBytes, rxOutOfRangeErrors=rxOutOfRangeErrors, chassis=chassis, alarmRfPowerFail=alarmRfPowerFail, speed=speed, rayTraps=rayTraps, rxChannel=rxChannel, tr2RssAlarm=tr2RssAlarm, system=system, alarmVoltageHigh=alarmVoltageHigh, tr2Eth1LinkDown=tr2Eth1LinkDown, mdix=mdix, txChannel=txChannel, rxFalseCarrierErrors=rxFalseCarrierErrors, rxControlFrames=rxControlFrames, tr2SnrAlarm=tr2SnrAlarm, alarmSnr=alarmSnr, alarmVoltageLow=alarmVoltageLow, tempAlarm=tempAlarm, ethPeer=ethPeer, prioritized=prioritized, airWdog=airWdog, swVer=swVer, eth2OutThroughput=eth2OutThroughput, tr2VoltageHighAlarm=tr2VoltageHighAlarm, product=product, alarmBer=alarmBer, tr2TemperatureAlarm=tr2TemperatureAlarm, ServiceState=ServiceState, httpd=httpd, eth1Link=eth1Link, keyTable=keyTable, rxDroppedPkts=rxDroppedPkts, ray=ray, swVerRadio=swVerRadio, useCpu=useCpu, deviceName=deviceName, keyEntry=keyEntry, timeAllConnect=timeAllConnect, rfPowerFail=rfPowerFail, maxNetBitrate=maxNetBitrate, eth2InThroughput=eth2InThroughput, peerEthLinkDown=peerEthLinkDown, ModulationList=ModulationList, rxBroadcast=rxBroadcast, txBroadcast=txBroadcast, pause=pause, productName=productName, txControlFrames=txControlFrames, tr2BerAlarm=tr2BerAlarm, txModulation=txModulation, searchModeDisabled=searchModeDisabled, lineStatusII=lineStatusII, timeMaxDisconnect=timeMaxDisconnect, alarmEth1Down=alarmEth1Down, temperatureRadio=temperatureRadio, statistic=statistic, lineStatus=lineStatus, bandwidth=bandwidth, tr2RfPowerFail=tr2RfPowerFail, AlarmState=AlarmState, mac=mac, airConnect=airConnect, autonego=autonego, rfPowerConfigured=rfPowerConfigured, PhysAddress=PhysAddress, ifEth=ifEth, txFreq=txFreq, PYSNMP_MODULE_ID=ray, rxFreq=rxFreq, wifiHAP=wifiHAP, eth2Link=eth2Link, berAlarm=berAlarm, tr2AirDisconnect=tr2AirDisconnect, txPauseFrames=txPauseFrames, OptionSetting=OptionSetting, peerNumber=peerNumber, airDisconnect=airDisconnect, station=station, DisplayString=DisplayString, matching=matching, voltageUnit=voltageUnit, ifEthEntry=ifEthEntry, status=status, racom=racom, fecUncorrectBlockCounter=fecUncorrectBlockCounter, netBitrate=netBitrate, info=info, authorization=authorization, ifRadio=ifRadio, txLengthCheckErrors=txLengthCheckErrors, timeAllDisconnect=timeAllDisconnect, duplex=duplex, ethernet=ethernet, telnetd=telnetd, interface=interface, tr2VoltageLowAlarm=tr2VoltageLowAlarm, txCollisions=txCollisions, voltageSource=voltageSource, tr2NetBitrate=tr2NetBitrate, linkUptime=linkUptime, txModulationIndex=txModulationIndex, tr2Eth21LinkDown=tr2Eth21LinkDown, serviceVlanId=serviceVlanId, alarmRss=alarmRss, tr2WifiOn=tr2WifiOn, modemR=modemR, tr2AirConnect=tr2AirConnect, ethInThroughput=ethInThroughput, memoryAlarm=memoryAlarm, rxModulationIndex=rxModulationIndex, serialNumber=serialNumber, asymPause=asymPause, snrAlarm=snrAlarm, alarmNetBitrate=alarmNetBitrate, rfPowerCurrent=rfPowerCurrent, rssAlarm=rssAlarm, vlanId=vlanId, rxCrcErrors=rxCrcErrors, useLogStorage=useLogStorage, radio=radio, unitType=unitType, access=access, ip=ip, securePeerMode=securePeerMode, reliability=reliability, keyName=keyName, rfPowerStatus=rfPowerStatus, txDones=txDones, ifEthTable=ifEthTable, txCrcErrors=txCrcErrors, snr=snr, numDisconnect=numDisconnect, sshd=sshd, ber=ber, alarmTemperature=alarmTemperature, txMulticast=txMulticast, ethOutThroughput=ethOutThroughput, channelArrangement=channelArrangement, powerAlarm=powerAlarm, coding=coding, rxMulticast=rxMulticast, rxModulation=rxModulation, rss=rss, systemStatus=systemStatus, rxPauseFrames=rxPauseFrames, bandwidthKHz=bandwidthKHz, useMemory=useMemory)
