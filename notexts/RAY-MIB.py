...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:59:59 2021
...
ObjectIdentity, Counter32, Gauge32, ModuleIdentity, NotificationType, Counter64, mib_2, Unsigned32, enterprises, iso, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "mib-2", "Unsigned32", "enterprises", "iso", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", lineStatusII=lineStatusII, timeAllConnect=timeAllConnect, rxBroadcast=rxBroadcast, tr2Eth1LinkDown=tr2Eth1LinkDown, interface=interface, systemStatus=systemStatus, temperatureRadio=temperatureRadio, rxDones=rxDones, alarmRfPowerFail=alarmRfPowerFail, eth2Link=eth2Link, reliability=reliability, vlanId=vlanId, swVerRadio=swVerRadio, rxFalseCarrierErrors=rxFalseCarrierErrors, txCrcErrors=txCrcErrors, berAlarm=berAlarm, ethInThroughput=ethInThroughput, duplex=duplex, channelArrangement=channelArrangement, useCpu=useCpu, fecBlockCounter=fecBlockCounter, airDisconnect=airDisconnect, pause=pause, tr2RssAlarm=tr2RssAlarm, telnetd=telnetd, txMulticast=txMulticast, fecUncorrectBlockCounter=fecUncorrectBlockCounter, eth2InThroughput=eth2InThroughput, tr2SnrAlarm=tr2SnrAlarm, alarmEth2Down=alarmEth2Down, eth2OutThroughput=eth2OutThroughput, ifEthTable=ifEthTable, txControlFrames=txControlFrames, managementVlan=managementVlan, PhysAddress=PhysAddress, system=system, rfPowerCurrent=rfPowerCurrent, tr2RfPowerFail=tr2RfPowerFail, ip=ip, keyEntry=keyEntry, httpd=httpd, ethPeer=ethPeer, wifiHAP=wifiHAP, DisplayString=DisplayString, alarmBer=alarmBer, txDones=txDones, txBroadcast=txBroadcast, alarmEth1Down=alarmEth1Down, airConnect=airConnect, ModulationList=ModulationList, rxChannel=rxChannel, txPauseFrames=txPauseFrames, alarmWifiOn=alarmWifiOn, ServiceState=ServiceState, rfPowerConfigured=rfPowerConfigured, tr2AirDisconnect=tr2AirDisconnect, snr=snr, speed=speed, txModulation=txModulation, txCollisions=txCollisions, tr2VoltageLowAlarm=tr2VoltageLowAlarm, linkUptime=linkUptime, chassis=chassis, sshd=sshd, managementVlanId=managementVlanId, rss=rss, swVer=swVer, rxOutOfRangeErrors=rxOutOfRangeErrors, eth1Link=eth1Link, temperatureModem=temperatureModem, airWdog=airWdog, status=status, unitType=unitType, ifEth=ifEth, txFreq=txFreq, txLengthCheckErrors=txLengthCheckErrors, rxMulticast=rxMulticast, access=access, securePeerMode=securePeerMode, tr2TemperatureAlarm=tr2TemperatureAlarm, alarmVoltageLow=alarmVoltageLow, rssAlarm=rssAlarm, ber=ber, timeMaxDisconnect=timeMaxDisconnect, rxModulationIndex=rxModulationIndex, coding=coding, autonego=autonego, alarmRss=alarmRss, alarmVoltageHigh=alarmVoltageHigh, ifEthEntry=ifEthEntry, bandwidthKHz=bandwidthKHz, rxFreq=rxFreq, PYSNMP_MODULE_ID=ray, matching=matching, rxHCBytes=rxHCBytes, rfPowerStatus=rfPowerStatus, txHCBytes=txHCBytes, mdix=mdix, station=station, alarmNetBitrate=alarmNetBitrate, ethOutThroughput=ethOutThroughput, voltageSource=voltageSource, memoryAlarm=memoryAlarm, ethernet=ethernet, tempAlarm=tempAlarm, snrAlarm=snrAlarm, rxCodeErrors=rxCodeErrors, info=info, tr2AirConnect=tr2AirConnect, rxControlFrames=rxControlFrames, alarm=alarm, txChannel=txChannel, alarmTemperature=alarmTemperature, statistic=statistic, ray2Traps=ray2Traps, authorization=authorization, timeAllDisconnect=timeAllDisconnect, voltageUnit=voltageUnit, asymPause=asymPause, radio=radio, ifRadio=ifRadio, serialNumber=serialNumber, tr2WifiOn=tr2WifiOn, rayTraps=rayTraps, alarmSnr=alarmSnr, tr2Eth21LinkDown=tr2Eth21LinkDown, lineStatus=lineStatus, OptionSetting=OptionSetting, keyTable=keyTable, prioritized=prioritized, racom=racom, tr2NetBitrate=tr2NetBitrate, productName=productName, alarmPeerDisconnected=alarmPeerDisconnected, modemR=modemR, rxCrcErrors=rxCrcErrors, numDisconnect=numDisconnect, searchModeDisabled=searchModeDisabled, useMemory=useMemory, ray=ray, mac=mac, peerNumber=peerNumber, tr2BerAlarm=tr2BerAlarm, maxNetBitrate=maxNetBitrate, deviceName=deviceName, tr2VoltageHighAlarm=tr2VoltageHighAlarm, useLogStorage=useLogStorage, bandwidth=bandwidth, peerEthLinkDown=peerEthLinkDown, keyName=keyName, rxPauseFrames=rxPauseFrames, rxDroppedPkts=rxDroppedPkts, netBitrate=netBitrate, powerAlarm=powerAlarm, serviceVlanId=serviceVlanId, rfPowerFail=rfPowerFail, product=product, rxModulation=rxModulation, AlarmState=AlarmState, txModulationIndex=txModulationIndex)
