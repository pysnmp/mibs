...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:23:20 2023
...
ModuleIdentity, Gauge32, Integer32, Unsigned32, IpAddress, enterprises, MibIdentifier, TimeTicks, iso, ObjectIdentity, Bits, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Integer32", "Unsigned32", "IpAddress", "enterprises", "MibIdentifier", "TimeTicks", "iso", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("RAY-MIB", system=system, netBitrate=netBitrate, info=info, vlanId=vlanId, fecBlockCounter=fecBlockCounter, rxMulticast=rxMulticast, tr2Eth1LinkDown=tr2Eth1LinkDown, maxNetBitrate=maxNetBitrate, rxFalseCarrierErrors=rxFalseCarrierErrors, systemStatus=systemStatus, tr2RfPowerFail=tr2RfPowerFail, eth1Link=eth1Link, alarmWifiOn=alarmWifiOn, alarmVoltageHigh=alarmVoltageHigh, swVerRadio=swVerRadio, eth2Link=eth2Link, useCpu=useCpu, mac=mac, channelArrangement=channelArrangement, asymPause=asymPause, ModulationList=ModulationList, useMemory=useMemory, txModulation=txModulation, telnetd=telnetd, PhysAddress=PhysAddress, authorization=authorization, linkUptime=linkUptime, rxOutOfRangeErrors=rxOutOfRangeErrors, temperatureModem=temperatureModem, duplex=duplex, ip=ip, ethPeer=ethPeer, rfPowerConfigured=rfPowerConfigured, txPauseFrames=txPauseFrames, ethInThroughput=ethInThroughput, ber=ber, ifRadio=ifRadio, keyTable=keyTable, productName=productName, alarmVoltageLow=alarmVoltageLow, fecUncorrectBlockCounter=fecUncorrectBlockCounter, unitType=unitType, PYSNMP_MODULE_ID=ray, lineStatus=lineStatus, snr=snr, snrAlarm=snrAlarm, wifiHAP=wifiHAP, txModulationIndex=txModulationIndex, rxChannel=rxChannel, prioritized=prioritized, peerEthLinkDown=peerEthLinkDown, tr2BerAlarm=tr2BerAlarm, rfPowerCurrent=rfPowerCurrent, ethOutThroughput=ethOutThroughput, rfPowerFail=rfPowerFail, tr2WifiOn=tr2WifiOn, alarmSnr=alarmSnr, berAlarm=berAlarm, access=access, lineStatusII=lineStatusII, alarmTemperature=alarmTemperature, txControlFrames=txControlFrames, autonego=autonego, alarmRfPowerFail=alarmRfPowerFail, bandwidth=bandwidth, tempAlarm=tempAlarm, txCrcErrors=txCrcErrors, rxHCBytes=rxHCBytes, rxModulation=rxModulation, rxDroppedPkts=rxDroppedPkts, timeAllDisconnect=timeAllDisconnect, rxDones=rxDones, voltageUnit=voltageUnit, airWdog=airWdog, tr2VoltageHighAlarm=tr2VoltageHighAlarm, station=station, DisplayString=DisplayString, alarm=alarm, AlarmState=AlarmState, modemR=modemR, rxCodeErrors=rxCodeErrors, swVer=swVer, airConnect=airConnect, coding=coding, reliability=reliability, racom=racom, rayTraps=rayTraps, sshd=sshd, powerAlarm=powerAlarm, mdix=mdix, tr2VoltageLowAlarm=tr2VoltageLowAlarm, useLogStorage=useLogStorage, alarmEth1Down=alarmEth1Down, keyName=keyName, alarmRss=alarmRss, rxPauseFrames=rxPauseFrames, txChannel=txChannel, tr2TemperatureAlarm=tr2TemperatureAlarm, txDones=txDones, temperatureRadio=temperatureRadio, httpd=httpd, chassis=chassis, ray=ray, radio=radio, txCollisions=txCollisions, tr2AirDisconnect=tr2AirDisconnect, rfPowerStatus=rfPowerStatus, ServiceState=ServiceState, tr2AirConnect=tr2AirConnect, keyEntry=keyEntry, matching=matching, rxFreq=rxFreq, airDisconnect=airDisconnect, alarmPeerDisconnected=alarmPeerDisconnected, serialNumber=serialNumber, ifEthTable=ifEthTable, serviceVlanId=serviceVlanId, status=status, managementVlanId=managementVlanId, txBroadcast=txBroadcast, peerNumber=peerNumber, ethernet=ethernet, ray2Traps=ray2Traps, txLengthCheckErrors=txLengthCheckErrors, eth2InThroughput=eth2InThroughput, memoryAlarm=memoryAlarm, statistic=statistic, ifEthEntry=ifEthEntry, tr2RssAlarm=tr2RssAlarm, voltageSource=voltageSource, rxBroadcast=rxBroadcast, tr2SnrAlarm=tr2SnrAlarm, deviceName=deviceName, timeAllConnect=timeAllConnect, tr2NetBitrate=tr2NetBitrate, securePeerMode=securePeerMode, speed=speed, pause=pause, searchModeDisabled=searchModeDisabled, rxControlFrames=rxControlFrames, OptionSetting=OptionSetting, rxModulationIndex=rxModulationIndex, alarmNetBitrate=alarmNetBitrate, eth2OutThroughput=eth2OutThroughput, txMulticast=txMulticast, bandwidthKHz=bandwidthKHz, tr2Eth21LinkDown=tr2Eth21LinkDown, managementVlan=managementVlan, interface=interface, alarmEth2Down=alarmEth2Down, rssAlarm=rssAlarm, timeMaxDisconnect=timeMaxDisconnect, txFreq=txFreq, alarmBer=alarmBer, rss=rss, rxCrcErrors=rxCrcErrors, txHCBytes=txHCBytes, numDisconnect=numDisconnect, ifEth=ifEth, product=product)
