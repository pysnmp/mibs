...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:40:56 2023
...
Bits, ModuleIdentity, Counter64, IpAddress, TimeTicks, Gauge32, MibIdentifier, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, NotificationType, ObjectIdentity, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter64", "IpAddress", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "NotificationType", "ObjectIdentity", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", eth1Link=eth1Link, eth2OutThroughput=eth2OutThroughput, txFreq=txFreq, txMulticast=txMulticast, statistic=statistic, useCpu=useCpu, tr2VoltageLowAlarm=tr2VoltageLowAlarm, swVer=swVer, serialNumber=serialNumber, vlanId=vlanId, alarmRfPowerFail=alarmRfPowerFail, temperatureModem=temperatureModem, rxFreq=rxFreq, tr2Eth21LinkDown=tr2Eth21LinkDown, ray2Traps=ray2Traps, eth2InThroughput=eth2InThroughput, access=access, tr2WifiOn=tr2WifiOn, fecBlockCounter=fecBlockCounter, matching=matching, ifEthTable=ifEthTable, radio=radio, tr2TemperatureAlarm=tr2TemperatureAlarm, rxMulticast=rxMulticast, temperatureRadio=temperatureRadio, txCrcErrors=txCrcErrors, rss=rss, maxNetBitrate=maxNetBitrate, sshd=sshd, autonego=autonego, searchModeDisabled=searchModeDisabled, useMemory=useMemory, ifEth=ifEth, eth2Link=eth2Link, txLengthCheckErrors=txLengthCheckErrors, managementVlan=managementVlan, product=product, fecUncorrectBlockCounter=fecUncorrectBlockCounter, rxCrcErrors=rxCrcErrors, berAlarm=berAlarm, useLogStorage=useLogStorage, airConnect=airConnect, swVerRadio=swVerRadio, ray=ray, alarm=alarm, lineStatus=lineStatus, alarmEth2Down=alarmEth2Down, numDisconnect=numDisconnect, airWdog=airWdog, tr2SnrAlarm=tr2SnrAlarm, txChannel=txChannel, ifRadio=ifRadio, rssAlarm=rssAlarm, lineStatusII=lineStatusII, voltageSource=voltageSource, wifiHAP=wifiHAP, rayTraps=rayTraps, ethPeer=ethPeer, timeAllConnect=timeAllConnect, memoryAlarm=memoryAlarm, ethInThroughput=ethInThroughput, rxDroppedPkts=rxDroppedPkts, productName=productName, mdix=mdix, rxOutOfRangeErrors=rxOutOfRangeErrors, peerNumber=peerNumber, linkUptime=linkUptime, txCollisions=txCollisions, DisplayString=DisplayString, alarmBer=alarmBer, unitType=unitType, tr2RfPowerFail=tr2RfPowerFail, txPauseFrames=txPauseFrames, rxModulationIndex=rxModulationIndex, rxControlFrames=rxControlFrames, netBitrate=netBitrate, duplex=duplex, status=status, telnetd=telnetd, alarmPeerDisconnected=alarmPeerDisconnected, tempAlarm=tempAlarm, snr=snr, tr2Eth1LinkDown=tr2Eth1LinkDown, txModulation=txModulation, tr2BerAlarm=tr2BerAlarm, txModulationIndex=txModulationIndex, rxBroadcast=rxBroadcast, timeMaxDisconnect=timeMaxDisconnect, txDones=txDones, rxHCBytes=rxHCBytes, tr2AirDisconnect=tr2AirDisconnect, voltageUnit=voltageUnit, speed=speed, PYSNMP_MODULE_ID=ray, alarmVoltageHigh=alarmVoltageHigh, modemR=modemR, racom=racom, rxCodeErrors=rxCodeErrors, rxFalseCarrierErrors=rxFalseCarrierErrors, station=station, PhysAddress=PhysAddress, rxDones=rxDones, ServiceState=ServiceState, tr2RssAlarm=tr2RssAlarm, prioritized=prioritized, rfPowerStatus=rfPowerStatus, ifEthEntry=ifEthEntry, rxChannel=rxChannel, deviceName=deviceName, ethernet=ethernet, authorization=authorization, reliability=reliability, powerAlarm=powerAlarm, rfPowerFail=rfPowerFail, asymPause=asymPause, managementVlanId=managementVlanId, peerEthLinkDown=peerEthLinkDown, tr2AirConnect=tr2AirConnect, alarmSnr=alarmSnr, rxPauseFrames=rxPauseFrames, rfPowerCurrent=rfPowerCurrent, chassis=chassis, alarmVoltageLow=alarmVoltageLow, ethOutThroughput=ethOutThroughput, httpd=httpd, system=system, ber=ber, keyEntry=keyEntry, airDisconnect=airDisconnect, tr2VoltageHighAlarm=tr2VoltageHighAlarm, tr2NetBitrate=tr2NetBitrate, keyTable=keyTable, interface=interface, alarmNetBitrate=alarmNetBitrate, alarmTemperature=alarmTemperature, bandwidthKHz=bandwidthKHz, rxModulation=rxModulation, alarmEth1Down=alarmEth1Down, coding=coding, alarmRss=alarmRss, txControlFrames=txControlFrames, rfPowerConfigured=rfPowerConfigured, pause=pause, AlarmState=AlarmState, keyName=keyName, securePeerMode=securePeerMode, ip=ip, ModulationList=ModulationList, channelArrangement=channelArrangement, systemStatus=systemStatus, info=info, txBroadcast=txBroadcast, OptionSetting=OptionSetting, serviceVlanId=serviceVlanId, bandwidth=bandwidth, txHCBytes=txHCBytes, snrAlarm=snrAlarm, timeAllDisconnect=timeAllDisconnect, mac=mac, alarmWifiOn=alarmWifiOn)
