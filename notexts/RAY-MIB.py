...
ObjectIdentity, Integer32, ModuleIdentity, TimeTicks, Counter32, Counter64, mib_2, enterprises, NotificationType, Unsigned32, iso, Bits, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "mib-2", "enterprises", "NotificationType", "Unsigned32", "iso", "Bits", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("RAY-MIB", rxFreq=rxFreq, eth1Link=eth1Link, rfPowerConfigured=rfPowerConfigured, productName=productName, rxDroppedPkts=rxDroppedPkts, peerEthLinkDown=peerEthLinkDown, ifEthTable=ifEthTable, memoryAlarm=memoryAlarm, product=product, snrAlarm=snrAlarm, serialNumber=serialNumber, tr2SnrAlarm=tr2SnrAlarm, alarmNetBitrate=alarmNetBitrate, unitType=unitType, rxHCBytes=rxHCBytes, systemStatus=systemStatus, airDisconnect=airDisconnect, asymPause=asymPause, rxCodeErrors=rxCodeErrors, timeAllConnect=timeAllConnect, txChannel=txChannel, temperatureModem=temperatureModem, ifRadio=ifRadio, matching=matching, voltageUnit=voltageUnit, PhysAddress=PhysAddress, timeMaxDisconnect=timeMaxDisconnect, snr=snr, ServiceState=ServiceState, useLogStorage=useLogStorage, chassis=chassis, airConnect=airConnect, securePeerMode=securePeerMode, txHCBytes=txHCBytes, timeAllDisconnect=timeAllDisconnect, tr2VoltageLowAlarm=tr2VoltageLowAlarm, searchModeDisabled=searchModeDisabled, tr2VoltageHighAlarm=tr2VoltageHighAlarm, AlarmState=AlarmState, ray2Traps=ray2Traps, mac=mac, OptionSetting=OptionSetting, telnetd=telnetd, rayTraps=rayTraps, httpd=httpd, prioritized=prioritized, berAlarm=berAlarm, keyTable=keyTable, voltageSource=voltageSource, useCpu=useCpu, alarmTemperature=alarmTemperature, ifEthEntry=ifEthEntry, modemR=modemR, txDones=txDones, rxModulation=rxModulation, rss=rss, rxPauseFrames=rxPauseFrames, station=station, alarmPeerDisconnected=alarmPeerDisconnected, keyEntry=keyEntry, racom=racom, autonego=autonego, rxDones=rxDones, powerAlarm=powerAlarm, rssAlarm=rssAlarm, lineStatusII=lineStatusII, rfPowerStatus=rfPowerStatus, tempAlarm=tempAlarm, maxNetBitrate=maxNetBitrate, vlanId=vlanId, eth2OutThroughput=eth2OutThroughput, speed=speed, alarmEth1Down=alarmEth1Down, ModulationList=ModulationList, keyName=keyName, mdix=mdix, ethInThroughput=ethInThroughput, pause=pause, rfPowerFail=rfPowerFail, rfPowerCurrent=rfPowerCurrent, numDisconnect=numDisconnect, airWdog=airWdog, txPauseFrames=txPauseFrames, txBroadcast=txBroadcast, alarmRss=alarmRss, managementVlan=managementVlan, fecUncorrectBlockCounter=fecUncorrectBlockCounter, ip=ip, alarmEth2Down=alarmEth2Down, tr2AirConnect=tr2AirConnect, DisplayString=DisplayString, alarm=alarm, managementVlanId=managementVlanId, alarmVoltageLow=alarmVoltageLow, radio=radio, tr2BerAlarm=tr2BerAlarm, swVer=swVer, netBitrate=netBitrate, bandwidthKHz=bandwidthKHz, statistic=statistic, txControlFrames=txControlFrames, tr2WifiOn=tr2WifiOn, authorization=authorization, rxChannel=rxChannel, swVerRadio=swVerRadio, ethernet=ethernet, alarmVoltageHigh=alarmVoltageHigh, rxCrcErrors=rxCrcErrors, ber=ber, PYSNMP_MODULE_ID=ray, tr2Eth1LinkDown=tr2Eth1LinkDown, txCrcErrors=txCrcErrors, serviceVlanId=serviceVlanId, eth2InThroughput=eth2InThroughput, tr2AirDisconnect=tr2AirDisconnect, temperatureRadio=temperatureRadio, txModulationIndex=txModulationIndex, tr2NetBitrate=tr2NetBitrate, channelArrangement=channelArrangement, sshd=sshd, rxModulationIndex=rxModulationIndex, rxControlFrames=rxControlFrames, txModulation=txModulation, txFreq=txFreq, bandwidth=bandwidth, interface=interface, ethOutThroughput=ethOutThroughput, lineStatus=lineStatus, eth2Link=eth2Link, coding=coding, ray=ray, tr2RssAlarm=tr2RssAlarm, alarmSnr=alarmSnr, status=status, alarmWifiOn=alarmWifiOn, access=access, wifiHAP=wifiHAP, txLengthCheckErrors=txLengthCheckErrors, alarmRfPowerFail=alarmRfPowerFail, peerNumber=peerNumber, tr2TemperatureAlarm=tr2TemperatureAlarm, duplex=duplex, ifEth=ifEth, rxFalseCarrierErrors=rxFalseCarrierErrors, txCollisions=txCollisions, fecBlockCounter=fecBlockCounter, tr2RfPowerFail=tr2RfPowerFail, ethPeer=ethPeer, reliability=reliability, system=system, linkUptime=linkUptime, tr2Eth21LinkDown=tr2Eth21LinkDown, txMulticast=txMulticast, useMemory=useMemory, alarmBer=alarmBer, rxOutOfRangeErrors=rxOutOfRangeErrors, rxBroadcast=rxBroadcast, deviceName=deviceName, rxMulticast=rxMulticast, info=info)
