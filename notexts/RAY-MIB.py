...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:22:15 2022
...
mib_2, enterprises, Bits, iso, IpAddress, MibIdentifier, NotificationType, TimeTicks, Integer32, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "Bits", "iso", "IpAddress", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("RAY-MIB", swVer=swVer, rxChannel=rxChannel, tr2WifiOn=tr2WifiOn, alarmVoltageHigh=alarmVoltageHigh, rfPowerConfigured=rfPowerConfigured, managementVlanId=managementVlanId, rxModulationIndex=rxModulationIndex, tr2Eth21LinkDown=tr2Eth21LinkDown, managementVlan=managementVlan, prioritized=prioritized, ber=ber, temperatureRadio=temperatureRadio, ModulationList=ModulationList, alarmEth1Down=alarmEth1Down, keyEntry=keyEntry, authorization=authorization, modemR=modemR, eth1Link=eth1Link, ServiceState=ServiceState, peerEthLinkDown=peerEthLinkDown, PhysAddress=PhysAddress, rxCodeErrors=rxCodeErrors, access=access, statistic=statistic, txCrcErrors=txCrcErrors, airConnect=airConnect, tr2AirDisconnect=tr2AirDisconnect, rfPowerCurrent=rfPowerCurrent, keyTable=keyTable, tr2AirConnect=tr2AirConnect, alarmEth2Down=alarmEth2Down, tempAlarm=tempAlarm, useLogStorage=useLogStorage, rayTraps=rayTraps, PYSNMP_MODULE_ID=ray, alarmSnr=alarmSnr, timeMaxDisconnect=timeMaxDisconnect, rssAlarm=rssAlarm, rxOutOfRangeErrors=rxOutOfRangeErrors, voltageSource=voltageSource, telnetd=telnetd, rfPowerStatus=rfPowerStatus, ip=ip, ifEthEntry=ifEthEntry, powerAlarm=powerAlarm, ray=ray, rfPowerFail=rfPowerFail, mdix=mdix, vlanId=vlanId, useCpu=useCpu, alarmNetBitrate=alarmNetBitrate, rxCrcErrors=rxCrcErrors, rxFalseCarrierErrors=rxFalseCarrierErrors, productName=productName, matching=matching, temperatureModem=temperatureModem, rxMulticast=rxMulticast, txLengthCheckErrors=txLengthCheckErrors, rxBroadcast=rxBroadcast, tr2BerAlarm=tr2BerAlarm, speed=speed, numDisconnect=numDisconnect, txHCBytes=txHCBytes, maxNetBitrate=maxNetBitrate, rss=rss, tr2RfPowerFail=tr2RfPowerFail, OptionSetting=OptionSetting, deviceName=deviceName, mac=mac, txFreq=txFreq, coding=coding, racom=racom, airDisconnect=airDisconnect, reliability=reliability, unitType=unitType, eth2OutThroughput=eth2OutThroughput, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rxDones=rxDones, berAlarm=berAlarm, bandwidth=bandwidth, serviceVlanId=serviceVlanId, swVerRadio=swVerRadio, tr2VoltageHighAlarm=tr2VoltageHighAlarm, alarmBer=alarmBer, keyName=keyName, ifEthTable=ifEthTable, radio=radio, alarmRss=alarmRss, txDones=txDones, tr2SnrAlarm=tr2SnrAlarm, timeAllDisconnect=timeAllDisconnect, lineStatus=lineStatus, duplex=duplex, txPauseFrames=txPauseFrames, station=station, txModulationIndex=txModulationIndex, linkUptime=linkUptime, timeAllConnect=timeAllConnect, bandwidthKHz=bandwidthKHz, system=system, channelArrangement=channelArrangement, AlarmState=AlarmState, systemStatus=systemStatus, tr2TemperatureAlarm=tr2TemperatureAlarm, chassis=chassis, netBitrate=netBitrate, ethInThroughput=ethInThroughput, alarmTemperature=alarmTemperature, wifiHAP=wifiHAP, interface=interface, fecUncorrectBlockCounter=fecUncorrectBlockCounter, txCollisions=txCollisions, snrAlarm=snrAlarm, sshd=sshd, pause=pause, status=status, securePeerMode=securePeerMode, airWdog=airWdog, DisplayString=DisplayString, lineStatusII=lineStatusII, useMemory=useMemory, txBroadcast=txBroadcast, txModulation=txModulation, info=info, alarmVoltageLow=alarmVoltageLow, autonego=autonego, rxHCBytes=rxHCBytes, tr2Eth1LinkDown=tr2Eth1LinkDown, alarm=alarm, memoryAlarm=memoryAlarm, rxControlFrames=rxControlFrames, txChannel=txChannel, serialNumber=serialNumber, eth2Link=eth2Link, alarmRfPowerFail=alarmRfPowerFail, rxModulation=rxModulation, searchModeDisabled=searchModeDisabled, fecBlockCounter=fecBlockCounter, ethernet=ethernet, ray2Traps=ray2Traps, eth2InThroughput=eth2InThroughput, peerNumber=peerNumber, ethPeer=ethPeer, asymPause=asymPause, snr=snr, tr2RssAlarm=tr2RssAlarm, txMulticast=txMulticast, rxDroppedPkts=rxDroppedPkts, rxPauseFrames=rxPauseFrames, ethOutThroughput=ethOutThroughput, httpd=httpd, alarmPeerDisconnected=alarmPeerDisconnected, alarmWifiOn=alarmWifiOn, ifEth=ifEth, product=product, txControlFrames=txControlFrames, rxFreq=rxFreq, tr2NetBitrate=tr2NetBitrate, voltageUnit=voltageUnit, ifRadio=ifRadio)
