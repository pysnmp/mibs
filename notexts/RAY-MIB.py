...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:03:27 2023
...
Bits, Unsigned32, Gauge32, Integer32, ObjectIdentity, NotificationType, MibIdentifier, mib_2, iso, Counter64, ModuleIdentity, Counter32, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Gauge32", "Integer32", "ObjectIdentity", "NotificationType", "MibIdentifier", "mib-2", "iso", "Counter64", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("RAY-MIB", rxFalseCarrierErrors=rxFalseCarrierErrors, tr2RssAlarm=tr2RssAlarm, rxPauseFrames=rxPauseFrames, vlanId=vlanId, timeMaxDisconnect=timeMaxDisconnect, txFreq=txFreq, systemStatus=systemStatus, ray2Traps=ray2Traps, ethInThroughput=ethInThroughput, timeAllConnect=timeAllConnect, linkUptime=linkUptime, mac=mac, rxCodeErrors=rxCodeErrors, rfPowerCurrent=rfPowerCurrent, station=station, rayTraps=rayTraps, useCpu=useCpu, asymPause=asymPause, managementVlan=managementVlan, peerNumber=peerNumber, txHCBytes=txHCBytes, PYSNMP_MODULE_ID=ray, alarmNetBitrate=alarmNetBitrate, timeAllDisconnect=timeAllDisconnect, ip=ip, tr2TemperatureAlarm=tr2TemperatureAlarm, swVerRadio=swVerRadio, tr2NetBitrate=tr2NetBitrate, keyEntry=keyEntry, serialNumber=serialNumber, txChannel=txChannel, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rssAlarm=rssAlarm, rfPowerFail=rfPowerFail, serviceVlanId=serviceVlanId, ethernet=ethernet, alarmRfPowerFail=alarmRfPowerFail, txControlFrames=txControlFrames, useLogStorage=useLogStorage, tempAlarm=tempAlarm, peerEthLinkDown=peerEthLinkDown, ifEth=ifEth, mdix=mdix, rxModulation=rxModulation, ray=ray, wifiHAP=wifiHAP, txModulation=txModulation, rxControlFrames=rxControlFrames, rxCrcErrors=rxCrcErrors, rxChannel=rxChannel, berAlarm=berAlarm, airWdog=airWdog, tr2AirDisconnect=tr2AirDisconnect, bandwidth=bandwidth, channelArrangement=channelArrangement, ModulationList=ModulationList, reliability=reliability, product=product, DisplayString=DisplayString, AlarmState=AlarmState, rxOutOfRangeErrors=rxOutOfRangeErrors, numDisconnect=numDisconnect, telnetd=telnetd, txDones=txDones, info=info, lineStatus=lineStatus, PhysAddress=PhysAddress, alarmPeerDisconnected=alarmPeerDisconnected, sshd=sshd, system=system, rxModulationIndex=rxModulationIndex, interface=interface, rxHCBytes=rxHCBytes, netBitrate=netBitrate, txPauseFrames=txPauseFrames, airDisconnect=airDisconnect, tr2WifiOn=tr2WifiOn, swVer=swVer, searchModeDisabled=searchModeDisabled, rxBroadcast=rxBroadcast, access=access, ifEthEntry=ifEthEntry, alarmEth2Down=alarmEth2Down, prioritized=prioritized, eth2OutThroughput=eth2OutThroughput, rxMulticast=rxMulticast, tr2Eth21LinkDown=tr2Eth21LinkDown, rxDones=rxDones, ifEthTable=ifEthTable, autonego=autonego, voltageUnit=voltageUnit, ethPeer=ethPeer, unitType=unitType, deviceName=deviceName, rxFreq=rxFreq, alarmRss=alarmRss, eth2InThroughput=eth2InThroughput, powerAlarm=powerAlarm, ServiceState=ServiceState, duplex=duplex, tr2RfPowerFail=tr2RfPowerFail, lineStatusII=lineStatusII, tr2AirConnect=tr2AirConnect, racom=racom, alarmWifiOn=alarmWifiOn, alarmBer=alarmBer, eth1Link=eth1Link, memoryAlarm=memoryAlarm, securePeerMode=securePeerMode, snrAlarm=snrAlarm, authorization=authorization, alarmEth1Down=alarmEth1Down, pause=pause, tr2SnrAlarm=tr2SnrAlarm, alarmTemperature=alarmTemperature, productName=productName, coding=coding, voltageSource=voltageSource, fecBlockCounter=fecBlockCounter, rfPowerConfigured=rfPowerConfigured, rfPowerStatus=rfPowerStatus, txCollisions=txCollisions, txBroadcast=txBroadcast, alarmSnr=alarmSnr, managementVlanId=managementVlanId, radio=radio, speed=speed, alarmVoltageLow=alarmVoltageLow, useMemory=useMemory, maxNetBitrate=maxNetBitrate, keyTable=keyTable, txMulticast=txMulticast, txCrcErrors=txCrcErrors, rss=rss, ethOutThroughput=ethOutThroughput, status=status, OptionSetting=OptionSetting, modemR=modemR, alarmVoltageHigh=alarmVoltageHigh, bandwidthKHz=bandwidthKHz, ber=ber, tr2BerAlarm=tr2BerAlarm, temperatureModem=temperatureModem, ifRadio=ifRadio, statistic=statistic, temperatureRadio=temperatureRadio, eth2Link=eth2Link, alarm=alarm, rxDroppedPkts=rxDroppedPkts, txModulationIndex=txModulationIndex, tr2Eth1LinkDown=tr2Eth1LinkDown, airConnect=airConnect, httpd=httpd, tr2VoltageHighAlarm=tr2VoltageHighAlarm, txLengthCheckErrors=txLengthCheckErrors, matching=matching, fecUncorrectBlockCounter=fecUncorrectBlockCounter, chassis=chassis, keyName=keyName, snr=snr)
