...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, enterprises, Unsigned32, MibIdentifier, iso, ModuleIdentity, ObjectIdentity, Gauge32, Bits, NotificationType, IpAddress, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "enterprises", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Bits", "NotificationType", "IpAddress", "Counter32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("RAY-MIB", alarmPeerDisconnected=alarmPeerDisconnected, rxFalseCarrierErrors=rxFalseCarrierErrors, alarmEth2Down=alarmEth2Down, tr2RfPowerFail=tr2RfPowerFail, tr2WifiOn=tr2WifiOn, swVerRadio=swVerRadio, coding=coding, DisplayString=DisplayString, rxPauseFrames=rxPauseFrames, ethInThroughput=ethInThroughput, txFreq=txFreq, timeAllConnect=timeAllConnect, ray=ray, alarmEth1Down=alarmEth1Down, chassis=chassis, useLogStorage=useLogStorage, unitType=unitType, sshd=sshd, txModulationIndex=txModulationIndex, rfPowerConfigured=rfPowerConfigured, fecBlockCounter=fecBlockCounter, txDones=txDones, PYSNMP_MODULE_ID=ray, rxMulticast=rxMulticast, ifEthTable=ifEthTable, peerEthLinkDown=peerEthLinkDown, rxModulationIndex=rxModulationIndex, useCpu=useCpu, snr=snr, lineStatusII=lineStatusII, tempAlarm=tempAlarm, rayTraps=rayTraps, txLengthCheckErrors=txLengthCheckErrors, rssAlarm=rssAlarm, tr2AirDisconnect=tr2AirDisconnect, txChannel=txChannel, airWdog=airWdog, reliability=reliability, PhysAddress=PhysAddress, mac=mac, system=system, pause=pause, alarmVoltageLow=alarmVoltageLow, speed=speed, alarmWifiOn=alarmWifiOn, txMulticast=txMulticast, timeAllDisconnect=timeAllDisconnect, AlarmState=AlarmState, rxControlFrames=rxControlFrames, tr2RssAlarm=tr2RssAlarm, rfPowerCurrent=rfPowerCurrent, rfPowerStatus=rfPowerStatus, keyEntry=keyEntry, alarmNetBitrate=alarmNetBitrate, ethPeer=ethPeer, alarmTemperature=alarmTemperature, tr2Eth1LinkDown=tr2Eth1LinkDown, racom=racom, powerAlarm=powerAlarm, useMemory=useMemory, alarmRss=alarmRss, numDisconnect=numDisconnect, tr2VoltageLowAlarm=tr2VoltageLowAlarm, telnetd=telnetd, authorization=authorization, interface=interface, searchModeDisabled=searchModeDisabled, txPauseFrames=txPauseFrames, tr2SnrAlarm=tr2SnrAlarm, lineStatus=lineStatus, temperatureModem=temperatureModem, berAlarm=berAlarm, channelArrangement=channelArrangement, duplex=duplex, maxNetBitrate=maxNetBitrate, ifEthEntry=ifEthEntry, rxCrcErrors=rxCrcErrors, txHCBytes=txHCBytes, eth2Link=eth2Link, asymPause=asymPause, access=access, txCollisions=txCollisions, ber=ber, systemStatus=systemStatus, keyTable=keyTable, ifEth=ifEth, deviceName=deviceName, memoryAlarm=memoryAlarm, status=status, radio=radio, ethOutThroughput=ethOutThroughput, snrAlarm=snrAlarm, product=product, rxDones=rxDones, eth2InThroughput=eth2InThroughput, txBroadcast=txBroadcast, alarmVoltageHigh=alarmVoltageHigh, ip=ip, ifRadio=ifRadio, rxCodeErrors=rxCodeErrors, station=station, tr2BerAlarm=tr2BerAlarm, tr2NetBitrate=tr2NetBitrate, rxOutOfRangeErrors=rxOutOfRangeErrors, serialNumber=serialNumber, txCrcErrors=txCrcErrors, voltageUnit=voltageUnit, modemR=modemR, productName=productName, securePeerMode=securePeerMode, serviceVlanId=serviceVlanId, managementVlanId=managementVlanId, netBitrate=netBitrate, OptionSetting=OptionSetting, rfPowerFail=rfPowerFail, tr2Eth21LinkDown=tr2Eth21LinkDown, autonego=autonego, rxChannel=rxChannel, ServiceState=ServiceState, eth1Link=eth1Link, voltageSource=voltageSource, ethernet=ethernet, wifiHAP=wifiHAP, alarm=alarm, rxHCBytes=rxHCBytes, rxBroadcast=rxBroadcast, temperatureRadio=temperatureRadio, prioritized=prioritized, mdix=mdix, txModulation=txModulation, txControlFrames=txControlFrames, alarmSnr=alarmSnr, timeMaxDisconnect=timeMaxDisconnect, tr2VoltageHighAlarm=tr2VoltageHighAlarm, alarmRfPowerFail=alarmRfPowerFail, ModulationList=ModulationList, swVer=swVer, vlanId=vlanId, linkUptime=linkUptime, fecUncorrectBlockCounter=fecUncorrectBlockCounter, statistic=statistic, matching=matching, airDisconnect=airDisconnect, tr2AirConnect=tr2AirConnect, bandwidth=bandwidth, ray2Traps=ray2Traps, peerNumber=peerNumber, keyName=keyName, tr2TemperatureAlarm=tr2TemperatureAlarm, info=info, rxModulation=rxModulation, bandwidthKHz=bandwidthKHz, alarmBer=alarmBer, rxDroppedPkts=rxDroppedPkts, airConnect=airConnect, rxFreq=rxFreq, managementVlan=managementVlan, rss=rss, httpd=httpd, eth2OutThroughput=eth2OutThroughput)
