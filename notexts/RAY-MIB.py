...
iso, Integer32, IpAddress, Unsigned32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Bits, MibIdentifier, Counter64, mib_2, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "IpAddress", "Unsigned32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "mib-2", "NotificationType", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", swVer=swVer, fecUncorrectBlockCounter=fecUncorrectBlockCounter, ServiceState=ServiceState, vlanId=vlanId, airConnect=airConnect, tr2TemperatureAlarm=tr2TemperatureAlarm, txChannel=txChannel, ifEthTable=ifEthTable, txMulticast=txMulticast, ethernet=ethernet, alarmNetBitrate=alarmNetBitrate, speed=speed, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ethPeer=ethPeer, lineStatus=lineStatus, tr2AirConnect=tr2AirConnect, status=status, ifEth=ifEth, alarmWifiOn=alarmWifiOn, matching=matching, txCrcErrors=txCrcErrors, alarmRfPowerFail=alarmRfPowerFail, deviceName=deviceName, rxModulation=rxModulation, channelArrangement=channelArrangement, system=system, tr2Eth1LinkDown=tr2Eth1LinkDown, tr2NetBitrate=tr2NetBitrate, serviceVlanId=serviceVlanId, chassis=chassis, alarmSnr=alarmSnr, txHCBytes=txHCBytes, ray=ray, DisplayString=DisplayString, txFreq=txFreq, reliability=reliability, rfPowerStatus=rfPowerStatus, keyName=keyName, alarmVoltageLow=alarmVoltageLow, rxCodeErrors=rxCodeErrors, tr2VoltageLowAlarm=tr2VoltageLowAlarm, ray2Traps=ray2Traps, alarmTemperature=alarmTemperature, searchModeDisabled=searchModeDisabled, ethOutThroughput=ethOutThroughput, eth2Link=eth2Link, duplex=duplex, swVerRadio=swVerRadio, timeAllDisconnect=timeAllDisconnect, txCollisions=txCollisions, telnetd=telnetd, rxHCBytes=rxHCBytes, useMemory=useMemory, statistic=statistic, mac=mac, modemR=modemR, alarmVoltageHigh=alarmVoltageHigh, systemStatus=systemStatus, txDones=txDones, rxOutOfRangeErrors=rxOutOfRangeErrors, rayTraps=rayTraps, product=product, ethInThroughput=ethInThroughput, httpd=httpd, rxChannel=rxChannel, tr2AirDisconnect=tr2AirDisconnect, coding=coding, ifRadio=ifRadio, radio=radio, snrAlarm=snrAlarm, ModulationList=ModulationList, tr2Eth21LinkDown=tr2Eth21LinkDown, alarmEth1Down=alarmEth1Down, pause=pause, peerNumber=peerNumber, alarmRss=alarmRss, netBitrate=netBitrate, rxFreq=rxFreq, managementVlanId=managementVlanId, txModulation=txModulation, temperatureRadio=temperatureRadio, airDisconnect=airDisconnect, bandwidth=bandwidth, timeMaxDisconnect=timeMaxDisconnect, rxModulationIndex=rxModulationIndex, rxFalseCarrierErrors=rxFalseCarrierErrors, OptionSetting=OptionSetting, txBroadcast=txBroadcast, ber=ber, lineStatusII=lineStatusII, alarmBer=alarmBer, rfPowerFail=rfPowerFail, txLengthCheckErrors=txLengthCheckErrors, rssAlarm=rssAlarm, useCpu=useCpu, alarmPeerDisconnected=alarmPeerDisconnected, rxDroppedPkts=rxDroppedPkts, rxDones=rxDones, rxBroadcast=rxBroadcast, temperatureModem=temperatureModem, access=access, tr2BerAlarm=tr2BerAlarm, fecBlockCounter=fecBlockCounter, bandwidthKHz=bandwidthKHz, wifiHAP=wifiHAP, eth1Link=eth1Link, PhysAddress=PhysAddress, rxControlFrames=rxControlFrames, rss=rss, rxCrcErrors=rxCrcErrors, rxMulticast=rxMulticast, AlarmState=AlarmState, productName=productName, serialNumber=serialNumber, unitType=unitType, memoryAlarm=memoryAlarm, alarmEth2Down=alarmEth2Down, rxPauseFrames=rxPauseFrames, station=station, prioritized=prioritized, txModulationIndex=txModulationIndex, sshd=sshd, mdix=mdix, timeAllConnect=timeAllConnect, authorization=authorization, txControlFrames=txControlFrames, alarm=alarm, useLogStorage=useLogStorage, snr=snr, rfPowerConfigured=rfPowerConfigured, tr2RfPowerFail=tr2RfPowerFail, peerEthLinkDown=peerEthLinkDown, interface=interface, info=info, txPauseFrames=txPauseFrames, managementVlan=managementVlan, ifEthEntry=ifEthEntry, eth2OutThroughput=eth2OutThroughput, tempAlarm=tempAlarm, tr2SnrAlarm=tr2SnrAlarm, eth2InThroughput=eth2InThroughput, autonego=autonego, rfPowerCurrent=rfPowerCurrent, PYSNMP_MODULE_ID=ray, maxNetBitrate=maxNetBitrate, securePeerMode=securePeerMode, tr2RssAlarm=tr2RssAlarm, voltageUnit=voltageUnit, airWdog=airWdog, powerAlarm=powerAlarm, tr2WifiOn=tr2WifiOn, numDisconnect=numDisconnect, asymPause=asymPause, keyTable=keyTable, keyEntry=keyEntry, ip=ip, berAlarm=berAlarm, racom=racom, voltageSource=voltageSource, linkUptime=linkUptime)
