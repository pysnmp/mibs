...
NotificationType, MibIdentifier, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, mib_2, enterprises, IpAddress, Bits, Counter32, Gauge32, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "mib-2", "enterprises", "IpAddress", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", sshd=sshd, alarmEth1Down=alarmEth1Down, bandwidthKHz=bandwidthKHz, powerAlarm=powerAlarm, txBroadcast=txBroadcast, voltageSource=voltageSource, alarmBer=alarmBer, rxDones=rxDones, httpd=httpd, rxControlFrames=rxControlFrames, txPauseFrames=txPauseFrames, radio=radio, mdix=mdix, useLogStorage=useLogStorage, ServiceState=ServiceState, alarmEth2Down=alarmEth2Down, timeAllDisconnect=timeAllDisconnect, rfPowerConfigured=rfPowerConfigured, alarmPeerDisconnected=alarmPeerDisconnected, ModulationList=ModulationList, channelArrangement=channelArrangement, airWdog=airWdog, ifEth=ifEth, rfPowerCurrent=rfPowerCurrent, PhysAddress=PhysAddress, ip=ip, rssAlarm=rssAlarm, fecBlockCounter=fecBlockCounter, ethernet=ethernet, reliability=reliability, DisplayString=DisplayString, txModulation=txModulation, rxBroadcast=rxBroadcast, keyTable=keyTable, tr2AirConnect=tr2AirConnect, txFreq=txFreq, alarmVoltageLow=alarmVoltageLow, rxHCBytes=rxHCBytes, rxPauseFrames=rxPauseFrames, rxFreq=rxFreq, OptionSetting=OptionSetting, rxCodeErrors=rxCodeErrors, autonego=autonego, securePeerMode=securePeerMode, rxChannel=rxChannel, txControlFrames=txControlFrames, maxNetBitrate=maxNetBitrate, authorization=authorization, txCrcErrors=txCrcErrors, mac=mac, lineStatus=lineStatus, product=product, telnetd=telnetd, rxFalseCarrierErrors=rxFalseCarrierErrors, peerEthLinkDown=peerEthLinkDown, tr2RssAlarm=tr2RssAlarm, temperatureModem=temperatureModem, ifEthEntry=ifEthEntry, tr2BerAlarm=tr2BerAlarm, tr2TemperatureAlarm=tr2TemperatureAlarm, serialNumber=serialNumber, swVer=swVer, status=status, temperatureRadio=temperatureRadio, peerNumber=peerNumber, rfPowerStatus=rfPowerStatus, useCpu=useCpu, speed=speed, alarmWifiOn=alarmWifiOn, ethInThroughput=ethInThroughput, tempAlarm=tempAlarm, pause=pause, tr2VoltageHighAlarm=tr2VoltageHighAlarm, keyEntry=keyEntry, productName=productName, ray=ray, tr2VoltageLowAlarm=tr2VoltageLowAlarm, PYSNMP_MODULE_ID=ray, alarmVoltageHigh=alarmVoltageHigh, rxCrcErrors=rxCrcErrors, alarm=alarm, matching=matching, alarmNetBitrate=alarmNetBitrate, rayTraps=rayTraps, system=system, txLengthCheckErrors=txLengthCheckErrors, airDisconnect=airDisconnect, linkUptime=linkUptime, vlanId=vlanId, rss=rss, timeAllConnect=timeAllConnect, asymPause=asymPause, ethPeer=ethPeer, timeMaxDisconnect=timeMaxDisconnect, wifiHAP=wifiHAP, rxOutOfRangeErrors=rxOutOfRangeErrors, interface=interface, coding=coding, tr2Eth21LinkDown=tr2Eth21LinkDown, modemR=modemR, swVerRadio=swVerRadio, rxModulation=rxModulation, eth2Link=eth2Link, ray2Traps=ray2Traps, ifRadio=ifRadio, ethOutThroughput=ethOutThroughput, ifEthTable=ifEthTable, managementVlan=managementVlan, netBitrate=netBitrate, tr2RfPowerFail=tr2RfPowerFail, voltageUnit=voltageUnit, rxDroppedPkts=rxDroppedPkts, snr=snr, bandwidth=bandwidth, txMulticast=txMulticast, eth2OutThroughput=eth2OutThroughput, alarmTemperature=alarmTemperature, rxModulationIndex=rxModulationIndex, txHCBytes=txHCBytes, eth1Link=eth1Link, unitType=unitType, tr2NetBitrate=tr2NetBitrate, txCollisions=txCollisions, statistic=statistic, fecUncorrectBlockCounter=fecUncorrectBlockCounter, managementVlanId=managementVlanId, rxMulticast=rxMulticast, chassis=chassis, alarmSnr=alarmSnr, serviceVlanId=serviceVlanId, txChannel=txChannel, ber=ber, eth2InThroughput=eth2InThroughput, memoryAlarm=memoryAlarm, station=station, tr2WifiOn=tr2WifiOn, AlarmState=AlarmState, tr2SnrAlarm=tr2SnrAlarm, alarmRfPowerFail=alarmRfPowerFail, tr2AirDisconnect=tr2AirDisconnect, numDisconnect=numDisconnect, txModulationIndex=txModulationIndex, rfPowerFail=rfPowerFail, txDones=txDones, lineStatusII=lineStatusII, info=info, deviceName=deviceName, racom=racom, airConnect=airConnect, alarmRss=alarmRss, tr2Eth1LinkDown=tr2Eth1LinkDown, snrAlarm=snrAlarm, systemStatus=systemStatus, access=access, keyName=keyName, prioritized=prioritized, searchModeDisabled=searchModeDisabled, duplex=duplex, berAlarm=berAlarm, useMemory=useMemory)
