...
Integer32, Counter64, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Gauge32, iso, Unsigned32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Gauge32", "iso", "Unsigned32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("RAY-MIB", alarmEth1Down=alarmEth1Down, txCrcErrors=txCrcErrors, ifEth=ifEth, ifEthTable=ifEthTable, airConnect=airConnect, eth1Link=eth1Link, system=system, rfPowerCurrent=rfPowerCurrent, peerEthLinkDown=peerEthLinkDown, timeMaxDisconnect=timeMaxDisconnect, eth2Link=eth2Link, httpd=httpd, bandwidthKHz=bandwidthKHz, alarmPeerDisconnected=alarmPeerDisconnected, timeAllDisconnect=timeAllDisconnect, txHCBytes=txHCBytes, DisplayString=DisplayString, peerNumber=peerNumber, temperatureModem=temperatureModem, asymPause=asymPause, rxPauseFrames=rxPauseFrames, tr2VoltageHighAlarm=tr2VoltageHighAlarm, alarmBer=alarmBer, rxCrcErrors=rxCrcErrors, tr2AirDisconnect=tr2AirDisconnect, alarmSnr=alarmSnr, ethPeer=ethPeer, modemR=modemR, ifRadio=ifRadio, tr2SnrAlarm=tr2SnrAlarm, serialNumber=serialNumber, txMulticast=txMulticast, txPauseFrames=txPauseFrames, alarmRfPowerFail=alarmRfPowerFail, station=station, rxHCBytes=rxHCBytes, ber=ber, prioritized=prioritized, tr2AirConnect=tr2AirConnect, rss=rss, statistic=statistic, temperatureRadio=temperatureRadio, unitType=unitType, matching=matching, autonego=autonego, alarmVoltageLow=alarmVoltageLow, alarm=alarm, alarmWifiOn=alarmWifiOn, alarmTemperature=alarmTemperature, alarmEth2Down=alarmEth2Down, airDisconnect=airDisconnect, channelArrangement=channelArrangement, rxFreq=rxFreq, ethInThroughput=ethInThroughput, tempAlarm=tempAlarm, lineStatus=lineStatus, sshd=sshd, rxModulationIndex=rxModulationIndex, rxFalseCarrierErrors=rxFalseCarrierErrors, tr2Eth21LinkDown=tr2Eth21LinkDown, useCpu=useCpu, interface=interface, ethernet=ethernet, ServiceState=ServiceState, voltageSource=voltageSource, ethOutThroughput=ethOutThroughput, ray2Traps=ray2Traps, txFreq=txFreq, tr2RssAlarm=tr2RssAlarm, useLogStorage=useLogStorage, keyName=keyName, fecBlockCounter=fecBlockCounter, reliability=reliability, eth2OutThroughput=eth2OutThroughput, rxMulticast=rxMulticast, ray=ray, info=info, tr2RfPowerFail=tr2RfPowerFail, tr2VoltageLowAlarm=tr2VoltageLowAlarm, txBroadcast=txBroadcast, rxChannel=rxChannel, PhysAddress=PhysAddress, rxDones=rxDones, swVer=swVer, rfPowerConfigured=rfPowerConfigured, OptionSetting=OptionSetting, status=status, authorization=authorization, rxDroppedPkts=rxDroppedPkts, rxOutOfRangeErrors=rxOutOfRangeErrors, fecUncorrectBlockCounter=fecUncorrectBlockCounter, coding=coding, swVerRadio=swVerRadio, snr=snr, rfPowerStatus=rfPowerStatus, searchModeDisabled=searchModeDisabled, racom=racom, mdix=mdix, alarmNetBitrate=alarmNetBitrate, lineStatusII=lineStatusII, rxModulation=rxModulation, linkUptime=linkUptime, netBitrate=netBitrate, berAlarm=berAlarm, rxControlFrames=rxControlFrames, rssAlarm=rssAlarm, managementVlan=managementVlan, bandwidth=bandwidth, pause=pause, AlarmState=AlarmState, tr2BerAlarm=tr2BerAlarm, serviceVlanId=serviceVlanId, ifEthEntry=ifEthEntry, powerAlarm=powerAlarm, radio=radio, snrAlarm=snrAlarm, securePeerMode=securePeerMode, PYSNMP_MODULE_ID=ray, txModulation=txModulation, rfPowerFail=rfPowerFail, chassis=chassis, txControlFrames=txControlFrames, tr2WifiOn=tr2WifiOn, vlanId=vlanId, managementVlanId=managementVlanId, duplex=duplex, timeAllConnect=timeAllConnect, numDisconnect=numDisconnect, mac=mac, productName=productName, rxBroadcast=rxBroadcast, eth2InThroughput=eth2InThroughput, txDones=txDones, access=access, tr2Eth1LinkDown=tr2Eth1LinkDown, deviceName=deviceName, speed=speed, ip=ip, txModulationIndex=txModulationIndex, maxNetBitrate=maxNetBitrate, tr2NetBitrate=tr2NetBitrate, systemStatus=systemStatus, telnetd=telnetd, keyTable=keyTable, ModulationList=ModulationList, memoryAlarm=memoryAlarm, product=product, txChannel=txChannel, useMemory=useMemory, alarmRss=alarmRss, txLengthCheckErrors=txLengthCheckErrors, alarmVoltageHigh=alarmVoltageHigh, rxCodeErrors=rxCodeErrors, tr2TemperatureAlarm=tr2TemperatureAlarm, wifiHAP=wifiHAP, airWdog=airWdog, rayTraps=rayTraps, voltageUnit=voltageUnit, keyEntry=keyEntry, txCollisions=txCollisions)
