...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:27:07 2022
...
MibIdentifier, enterprises, NotificationType, Integer32, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, Counter32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Counter32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DIGIPDU-MIB", upsOverloadTrap=upsOverloadTrap, outAPIOperationTrap=outAPIOperationTrap, rfidDetectTime=rfidDetectTime, digipdu=digipdu, trapArg9=trapArg9, inFeedTable=inFeedTable, inFeedFrequency=inFeedFrequency, inFeedOverLoad=inFeedOverLoad, pduPowerFactor=pduPowerFactor, pduBranchOverloadTrap=pduBranchOverloadTrap, deviceOutKind=deviceOutKind, smart=smart, uPSConnectStatus=uPSConnectStatus, testTrap=testTrap, outVoltage=outVoltage, inFeedHighWarning=inFeedHighWarning, inputTimeOutTrap=inputTimeOutTrap, extendTemperatureEntry=extendTemperatureEntry, inFeedBranch1HighWarning=inFeedBranch1HighWarning, extendRHIndex=extendRHIndex, trapArg7=trapArg7, outOverloadTrap=outOverloadTrap, productModel=productModel, extendTemperatureHighWarning=extendTemperatureHighWarning, extendTemperatureLowWarning=extendTemperatureLowWarning, envRHLowTrap=envRHLowTrap, pduStatus=pduStatus, pduFrequency=pduFrequency, uPSBatteryVoltage=uPSBatteryVoltage, trapArg6=trapArg6, inFeedEntry=inFeedEntry, inFeedCurrent=inFeedCurrent, envConnectTrap=envConnectTrap, outSwitchStatus=outSwitchStatus, pduTables=pduTables, extendTemperatureIndex=extendTemperatureIndex, uPSFirmware=uPSFirmware, pduBranchHighCurrentTrap=pduBranchHighCurrentTrap, inFeedBranchLowCurrentTrap=inFeedBranchLowCurrentTrap, inFeedBranch1OverLoad=inFeedBranch1OverLoad, uPSBatteryDate=uPSBatteryDate, outUPSBatteryLowRecoveryOnTrap=outUPSBatteryLowRecoveryOnTrap, uPSBatteryLow=uPSBatteryLow, outUPSBatteryLevelOffTrap=outUPSBatteryLevelOffTrap, vibrationLastDetectTime=vibrationLastDetectTime, inputTable=inputTable, deviceUnitOutTotal=deviceUnitOutTotal, micDetectTimes=micDetectTimes, micDetectPeriod=micDetectPeriod, vibrationDetectTimes=vibrationDetectTimes, deviceInputTotal=deviceInputTotal, outHighCurrentTrap=outHighCurrentTrap, pduBranch1HighWarning=pduBranch1HighWarning, vibrationDetec=vibrationDetec, envTemperatureHighTrap=envTemperatureHighTrap, outPingTrap=outPingTrap, deviceUnitStatus=deviceUnitStatus, deviceExtendTemperatureTotal=deviceExtendTemperatureTotal, extendRHMonitor=extendRHMonitor, uPSUARTId=uPSUARTId, outEntry=outEntry, uPSModel=uPSModel, inFeedBranch2PowerLoad=inFeedBranch2PowerLoad, outUPSACRecoveryOnTrap=outUPSACRecoveryOnTrap, inFeedVoltage=inFeedVoltage, inbuiltTemperature=inbuiltTemperature, extendRHHighWarning=extendRHHighWarning, pduIndex=pduIndex, pduHighWarning=pduHighWarning, micDetec=micDetec, inputTrap=inputTrap, inputIndex=inputIndex, dataLogTable=dataLogTable, outUPSBatteryLowOffTrap=outUPSBatteryLowOffTrap, uPS=uPS, deviceUnitTotal=deviceUnitTotal, outPowerLoad=outPowerLoad, extendRHPort=extendRHPort, inFeedBranch=inFeedBranch, deviceUnitInfeedTotal=deviceUnitInfeedTotal, uPSTemperature=uPSTemperature, upsBatteryReplace=upsBatteryReplace, envTemperatureConnectTrap=envTemperatureConnectTrap, outCurrentStatus=outCurrentStatus, deviceInFeedTotal=deviceInFeedTotal, pduBranchLowCurrentTrap=pduBranchLowCurrentTrap, pduBranch2Overload=pduBranch2Overload, envTemperatureLowTrap=envTemperatureLowTrap, inbuiltTemperatureStatus=inbuiltTemperatureStatus, deviceInFeedKind=deviceInFeedKind, trapArg8=trapArg8, uPSSerial=uPSSerial, trapArg1=trapArg1, upsConnectTrap=upsConnectTrap, inputDefault=inputDefault, pduBranch1Current=pduBranch1Current, deviceDaisyChain=deviceDaisyChain, extendRH=extendRH, trapArg3=trapArg3, pduPowerEnergy=pduPowerEnergy, inputStatus=inputStatus, outDataList=outDataList, outSwitchCtrl=outSwitchCtrl, productTemperatureKind=productTemperatureKind, inputTimeout=inputTimeout, uPSOutputLoad=uPSOutputLoad, devicePDUTotal=devicePDUTotal, outWebOperationTrap=outWebOperationTrap, pduVoltage=pduVoltage, product=product, daisyChainConnectTrap=daisyChainConnectTrap, extendRHTable=extendRHTable, inputEntry=inputEntry, pduBranch2Current=pduBranch2Current, uPSOutputFrequency=uPSOutputFrequency, aTSStatus=aTSStatus, rfidCardNum=rfidCardNum, inbuiltTemperatureIndex=inbuiltTemperatureIndex, inputState=inputState, upsBatteryLowTrap=upsBatteryLowTrap, uPSOutputOnBattery=uPSOutputOnBattery, inFeedBranch1PowerLoad=inFeedBranch1PowerLoad, outScheduleErrorTrap=outScheduleErrorTrap, outPingRebootTrap=outPingRebootTrap, deviceATSKind=deviceATSKind, inbuiltTemperatureEntry=inbuiltTemperatureEntry, aTSIndex=aTSIndex, outHighWarning=outHighWarning, pduBranch1LowWarning=pduBranch1LowWarning, inFeedBranch1Current=inFeedBranch1Current, uPSBatteryReplace=uPSBatteryReplace, aTSVoltage=aTSVoltage, envRHConnectTrap=envRHConnectTrap, deviceUnitTable=deviceUnitTable, productSerialNumber=productSerialNumber, inFeedBranch1LowWarning=inFeedBranch1LowWarning, deviceInbuiltTempTotal=deviceInbuiltTempTotal, outLowCurrentTrap=outLowCurrentTrap, productFirmwareVersion=productFirmwareVersion, pduConnectTrap=pduConnectTrap, rfidReader=rfidReader, outComputerStatus=outComputerStatus, pduHighCurrentTrap=pduHighCurrentTrap, inFeedPowerEnergy=inFeedPowerEnergy, outPanelOperationTrap=outPanelOperationTrap, pduDataList=pduDataList, peripheralTables=peripheralTables, inFeedIndex=inFeedIndex, extendTemperatureTable=extendTemperatureTable, pduBranch2HighWarning=pduBranch2HighWarning, inbuiltTemperatureLowTrap=inbuiltTemperatureLowTrap, trapArg2=trapArg2, uPSOutputOverload=uPSOutputOverload, extendTemperatureDeviceId=extendTemperatureDeviceId, micDetectOccurTrap=micDetectOccurTrap, deviceInFeedBranch=deviceInFeedBranch, inbuiltTemperatureTable=inbuiltTemperatureTable, inFeedPowerFactor=inFeedPowerFactor, inFeedBranch1PowerFactor=inFeedBranch1PowerFactor, pduBranch2LowWarning=pduBranch2LowWarning, envRHHighTrap=envRHHighTrap, inFeedLowCurrentTrap=inFeedLowCurrentTrap, uPSBatteryRunTime=uPSBatteryRunTime, aTSEntry=aTSEntry, pduOverloadTrap=pduOverloadTrap, extendRHLowWarning=extendRHLowWarning, pduBranch1Overload=pduBranch1Overload, micLastDetectTime=micLastDetectTime, outUPSBatteryLevelOnTrap=outUPSBatteryLevelOnTrap, deviceOutTotal=deviceOutTotal, extendRHStatus=extendRHStatus, inFeedOverloadTrap=inFeedOverloadTrap, vibrationDetectPeriod=vibrationDetectPeriod, outScheduleTrap=outScheduleTrap, deviceUnitIndex=deviceUnitIndex, deviceUPS=deviceUPS, outOverload=outOverload, productPartNumber=productPartNumber, uPSOutputCurrent=uPSOutputCurrent, productResetDetector=productResetDetector, inbuiltTemperatureHighWarning=inbuiltTemperatureHighWarning, outConditionCtrlTrap=outConditionCtrlTrap, uPSBatteryLevel=uPSBatteryLevel, pduMonitor=pduMonitor, inFeedBranchHighCurrentTrap=inFeedBranchHighCurrentTrap, inbuiltTemperatureHighTrap=inbuiltTemperatureHighTrap, upsOnBatteryTrap=upsOnBatteryTrap, PYSNMP_MODULE_ID=smart, pduModel=pduModel, pduBranch=pduBranch, uPSInputVoltage=uPSInputVoltage, inFeedPowerLoad=inFeedPowerLoad, outLowWarning=outLowWarning, vibrationDetectOccurTrap=vibrationDetectOccurTrap, inFeedBranch2PowerFactor=inFeedBranch2PowerFactor, trap=trap, pduLowWarning=pduLowWarning, inbuiltTemperatureLowWarning=inbuiltTemperatureLowWarning, trapArg4=trapArg4, pduOverload=pduOverload, inFeedDataList=inFeedDataList, deviceTable=deviceTable, aTSFrequency=aTSFrequency, inFeedBranch2HighWarning=inFeedBranch2HighWarning, arg=arg, outIndex=outIndex, inFeedBranchOverloadTrap=inFeedBranchOverloadTrap, extendRHDeviceId=extendRHDeviceId, uPSOutputVoltage=uPSOutputVoltage, outUPSACFaultOffTrap=outUPSACFaultOffTrap, deviceUnitEntry=deviceUnitEntry, inFeedBranch2OverLoad=inFeedBranch2OverLoad, pduPowerLoad=pduPowerLoad, extendTemperature=extendTemperature, deviceExtendRHTotal=deviceExtendRHTotal, inFeedBranch2Current=inFeedBranch2Current, inFeedBranch2LowWarning=inFeedBranch2LowWarning, smartTraps=smartTraps, inFeedHighCurrentTrap=inFeedHighCurrentTrap, pduLowCurrentTrap=pduLowCurrentTrap, trapArg5=trapArg5, outPowerFactor=outPowerFactor, inputDetectTime=inputDetectTime, extendTemperatureStatus=extendTemperatureStatus, inFeedLowWarning=inFeedLowWarning, pduCurrent=pduCurrent, extendRHEntry=extendRHEntry, outTable=outTable, aTSTable=aTSTable, extendTemperaturePort=extendTemperaturePort, pduEntry=pduEntry, extendTemperatureMonitor=extendTemperatureMonitor, outCurrent=outCurrent, inFeedStatus=inFeedStatus)
