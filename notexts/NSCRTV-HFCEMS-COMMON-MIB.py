...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonNetworkAddress=commonNetworkAddress, commonDeviceResetCause=commonDeviceResetCause, commonMACGroup=commonMACGroup, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceStatus=commonDeviceStatus, commonInternalTemperature=commonInternalTemperature, commonAgentTrapIP=commonAgentTrapIP, commonDeviceInfoEntry=commonDeviceInfoEntry, commonNEModelNumber=commonNEModelNumber, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMacAddress=commonMacAddress, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonBackoffParams=commonBackoffParams, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAgentReset=commonAgentReset, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceReset=commonDeviceReset, commonTime=commonTime, commonAgentGroup=commonAgentGroup, commonAgentTrapCommunity=commonAgentTrapCommunity, commonTrapAck=commonTrapAck, commonDeviceSerialNumber=commonDeviceSerialNumber, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentTrapTable=commonAgentTrapTable, commonDeviceName=commonDeviceName, commonDeviceCraftStatus=commonDeviceCraftStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceTamperStatus=commonDeviceTamperStatus, commonResetCause=commonResetCause, commonPhysAddress=commonPhysAddress, commonAgentTrapIndex=commonAgentTrapIndex, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceFW=commonDeviceFW, commonAgentBootWay=commonAgentBootWay, commonDeviceSlot=commonDeviceSlot, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceGroup=commonDeviceGroup, commonDevicesOID=commonDevicesOID, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceOID=commonDeviceOID, hfcColdStart=hfcColdStart, commonForwardPathFrequency=commonForwardPathFrequency, commonVarBindings=commonVarBindings, commonMacStats=commonMacStats, commonDeviceAcct=commonDeviceAcct, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMaxReturnPower=commonMaxReturnPower, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceVendor=commonDeviceVendor, commonMulticastAddressNumber=commonMulticastAddressNumber, commonNELogicalID=commonNELogicalID, commonMulticastAddressEntry=commonMulticastAddressEntry, commonReset=commonReset, hfcWarmStart=hfcWarmStart, commonAdminUseEthernet=commonAdminUseEthernet, commonRfGroup=commonRfGroup, commonMulticastAddressIndex=commonMulticastAddressIndex, commonCraftStatus=commonCraftStatus, commonDeviceMFD=commonDeviceMFD, commonReturnPathFrequency=commonReturnPathFrequency, commonDevicesID=commonDevicesID, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceModelNumber=commonDeviceModelNumber, commonAgentTrapStatus=commonAgentTrapStatus, commonNEVendor=commonNEVendor, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMulticastAddressTable=commonMulticastAddressTable, commonNEStatus=commonNEStatus, commonAdminUseRf=commonAdminUseRf, commonBackoffPeriod=commonBackoffPeriod, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAdminGroup=commonAdminGroup, commonDeviceNum=commonDeviceNum, commonTrapCommunityString=commonTrapCommunityString, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonCheckCode=commonCheckCode, commonInvalidMacCmds=commonInvalidMacCmds, commonNESerialNumber=commonNESerialNumber, commonTamperStatus=commonTamperStatus, commonDeviceId=commonDeviceId, commonNEVendorInfo=commonNEVendorInfo)
