...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceAcct=commonDeviceAcct, commonDeviceId=commonDeviceId, commonResetCause=commonResetCause, commonDevicesOID=commonDevicesOID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentBootWay=commonAgentBootWay, commonNetworkAddress=commonNetworkAddress, commonPhysAddress=commonPhysAddress, commonMaxPayloadSize=commonMaxPayloadSize, commonRfGroup=commonRfGroup, commonVarBindings=commonVarBindings, commonMulticastAddressEntry=commonMulticastAddressEntry, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonCheckCode=commonCheckCode, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceNum=commonDeviceNum, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonAgentTrapIP=commonAgentTrapIP, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAgentGroup=commonAgentGroup, commonDeviceModelNumber=commonDeviceModelNumber, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentTrapStatus=commonAgentTrapStatus, commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapMinInterval=commonAgentTrapMinInterval, hfcColdStart=hfcColdStart, commonReturnPathFrequency=commonReturnPathFrequency, commonMulticastAddressNumber=commonMulticastAddressNumber, commonNEModelNumber=commonNEModelNumber, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceMFD=commonDeviceMFD, commonAgentMaxTraps=commonAgentMaxTraps, commonNELogicalID=commonNELogicalID, commonDeviceResetCause=commonDeviceResetCause, commonAgentReset=commonAgentReset, commonCraftStatus=commonCraftStatus, commonAdminGroup=commonAdminGroup, commonDeviceFW=commonDeviceFW, commonMacAddress=commonMacAddress, commonNESerialNumber=commonNESerialNumber, commonBackoffParams=commonBackoffParams, commonInvalidMacCmds=commonInvalidMacCmds, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDevicesID=commonDevicesID, commonDeviceCraftStatus=commonDeviceCraftStatus, commonTrapCommunityString=commonTrapCommunityString, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceReset=commonDeviceReset, commonTime=commonTime, commonInternalTemperature=commonInternalTemperature, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceGroup=commonDeviceGroup, commonNEStatus=commonNEStatus, commonNEVendorInfo=commonNEVendorInfo, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceMACAddress=commonDeviceMACAddress, commonDeviceName=commonDeviceName, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonTrapAck=commonTrapAck, commonReset=commonReset, commonDeviceVendor=commonDeviceVendor, commonNEVendor=commonNEVendor, hfcWarmStart=hfcWarmStart, commonDeviceStatus=commonDeviceStatus, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAgentTrapTable=commonAgentTrapTable, commonDeviceSlot=commonDeviceSlot, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceInfoEntry=commonDeviceInfoEntry, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceOID=commonDeviceOID, commonAdminUseRf=commonAdminUseRf, commonMacStats=commonMacStats, commonBackoffPeriod=commonBackoffPeriod, commonTamperStatus=commonTamperStatus, commonAgentTrapCommunity=commonAgentTrapCommunity, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMACGroup=commonMACGroup, commonDeviceInfoTable=commonDeviceInfoTable)
