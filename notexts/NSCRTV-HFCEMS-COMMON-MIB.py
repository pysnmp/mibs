...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceModelNumber=commonDeviceModelNumber, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceNum=commonDeviceNum, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceGroup=commonDeviceGroup, commonBackoffParams=commonBackoffParams, commonDeviceMACAddress=commonDeviceMACAddress, commonMACGroup=commonMACGroup, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceVendor=commonDeviceVendor, commonNESerialNumber=commonNESerialNumber, commonInternalTemperature=commonInternalTemperature, commonNEStatus=commonNEStatus, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMaxPayloadSize=commonMaxPayloadSize, commonAdminUseRf=commonAdminUseRf, commonMacStats=commonMacStats, commonACKTimeoutWindow=commonACKTimeoutWindow, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentTrapTable=commonAgentTrapTable, commonMulticastAddressIndex=commonMulticastAddressIndex, commonBackoffPeriod=commonBackoffPeriod, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonAdminGroup=commonAdminGroup, commonCraftStatus=commonCraftStatus, commonInvalidMacCmds=commonInvalidMacCmds, commonAgentTrapEntry=commonAgentTrapEntry, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceMFD=commonDeviceMFD, commonDeviceName=commonDeviceName, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapCommunity=commonAgentTrapCommunity, commonVarBindings=commonVarBindings, commonDeviceSlot=commonDeviceSlot, commonDeviceResetCause=commonDeviceResetCause, commonMaxReturnPower=commonMaxReturnPower, commonTrapAck=commonTrapAck, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceId=commonDeviceId, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceInfoTable=commonDeviceInfoTable, commonReset=commonReset, commonDeviceAcct=commonDeviceAcct, commonDeviceOID=commonDeviceOID, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonMulticastAddressTable=commonMulticastAddressTable, commonRfGroup=commonRfGroup, commonMacAddress=commonMacAddress, commonDevicesID=commonDevicesID, commonDeviceCraftStatus=commonDeviceCraftStatus, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentReset=commonAgentReset, commonCheckCode=commonCheckCode, commonTrapCommunityString=commonTrapCommunityString, commonDevicesOID=commonDevicesOID, commonAgentBootWay=commonAgentBootWay, commonAgentMaxTraps=commonAgentMaxTraps, commonAdminUseEthernet=commonAdminUseEthernet, commonNEVendor=commonNEVendor, commonNEVendorInfo=commonNEVendorInfo, commonDeviceReset=commonDeviceReset, commonMulticastAddressNumber=commonMulticastAddressNumber, commonResetCause=commonResetCause, commonTime=commonTime, commonDeviceInfoEntry=commonDeviceInfoEntry, hfcWarmStart=hfcWarmStart, commonAgentTrapIP=commonAgentTrapIP, commonDeviceSerialNumber=commonDeviceSerialNumber, commonNEModelNumber=commonNEModelNumber, commonTamperStatus=commonTamperStatus, commonNELogicalID=commonNELogicalID, commonDeviceStatus=commonDeviceStatus, hfcColdStart=hfcColdStart, commonNetworkAddress=commonNetworkAddress, commonAgentGroup=commonAgentGroup, commonPhysAddress=commonPhysAddress, commonDeviceFW=commonDeviceFW)
