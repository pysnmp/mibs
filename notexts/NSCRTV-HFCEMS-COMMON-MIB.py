...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMACGroup=commonMACGroup, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAdminUseEthernet=commonAdminUseEthernet, commonMacStats=commonMacStats, commonNEStatus=commonNEStatus, commonRfGroup=commonRfGroup, commonNEVendor=commonNEVendor, commonDeviceNum=commonDeviceNum, commonDeviceOID=commonDeviceOID, commonNEModelNumber=commonNEModelNumber, commonDeviceGroup=commonDeviceGroup, commonTime=commonTime, commonDeviceFW=commonDeviceFW, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDevicesID=commonDevicesID, commonAgentTrapCommunity=commonAgentTrapCommunity, commonPhysAddress=commonPhysAddress, commonDeviceMFD=commonDeviceMFD, commonAgentGroup=commonAgentGroup, commonDeviceName=commonDeviceName, commonDeviceSerialNumber=commonDeviceSerialNumber, hfcColdStart=hfcColdStart, commonInternalTemperature=commonInternalTemperature, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAdminGroup=commonAdminGroup, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceResetCause=commonDeviceResetCause, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonMulticastAddressNumber=commonMulticastAddressNumber, commonBackoffPeriod=commonBackoffPeriod, commonMulticastAddressTable=commonMulticastAddressTable, commonNELogicalID=commonNELogicalID, commonMaxReturnPower=commonMaxReturnPower, commonMacAddress=commonMacAddress, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonCheckCode=commonCheckCode, commonDeviceCraftStatus=commonDeviceCraftStatus, commonResetCause=commonResetCause, commonDeviceVendor=commonDeviceVendor, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceAcct=commonDeviceAcct, commonDeviceStatus=commonDeviceStatus, commonAgentTrapTable=commonAgentTrapTable, commonDeviceReset=commonDeviceReset, commonDeviceId=commonDeviceId, commonNESerialNumber=commonNESerialNumber, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceInfoTable=commonDeviceInfoTable, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonTrapCommunityString=commonTrapCommunityString, commonAgentTrapIndex=commonAgentTrapIndex, commonInvalidMacCmds=commonInvalidMacCmds, commonTamperStatus=commonTamperStatus, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceSlot=commonDeviceSlot, commonAgentMaxTraps=commonAgentMaxTraps, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonAdminUseRf=commonAdminUseRf, commonAgentBootWay=commonAgentBootWay, commonDevicesOID=commonDevicesOID, commonNetworkAddress=commonNetworkAddress, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapStatus=commonAgentTrapStatus, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceTamperStatus=commonDeviceTamperStatus, commonBackoffParams=commonBackoffParams, commonDeviceVendorInfo=commonDeviceVendorInfo, commonVarBindings=commonVarBindings, commonTrapAck=commonTrapAck, commonACKTimeoutWindow=commonACKTimeoutWindow, commonCraftStatus=commonCraftStatus, commonReset=commonReset, commonDeviceInfoEntry=commonDeviceInfoEntry, hfcWarmStart=hfcWarmStart, commonAgentReset=commonAgentReset, commonMaxPayloadSize=commonMaxPayloadSize)
