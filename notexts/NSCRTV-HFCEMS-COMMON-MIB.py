...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceMACAddress=commonDeviceMACAddress, commonResetCause=commonResetCause, commonDeviceOID=commonDeviceOID, commonDevicesID=commonDevicesID, commonAgentBootWay=commonAgentBootWay, commonDeviceSlot=commonDeviceSlot, commonDeviceName=commonDeviceName, commonNEModelNumber=commonNEModelNumber, commonDeviceGroup=commonDeviceGroup, commonPhysAddress=commonPhysAddress, commonMulticastAddressEntry=commonMulticastAddressEntry, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMacAddress=commonMacAddress, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonAgentTrapTable=commonAgentTrapTable, commonDeviceMFD=commonDeviceMFD, commonDevicesOID=commonDevicesOID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonVarBindings=commonVarBindings, hfcColdStart=hfcColdStart, commonAdminUseRf=commonAdminUseRf, commonTime=commonTime, commonTrapCommunityString=commonTrapCommunityString, commonMACGroup=commonMACGroup, commonNEStatus=commonNEStatus, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMaxReturnPower=commonMaxReturnPower, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceSerialNumber=commonDeviceSerialNumber, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceReset=commonDeviceReset, commonMaxPayloadSize=commonMaxPayloadSize, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceVendorInfo=commonDeviceVendorInfo, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceStatus=commonDeviceStatus, commonBackoffPeriod=commonBackoffPeriod, commonMacStats=commonMacStats, commonNetworkAddress=commonNetworkAddress, commonTamperStatus=commonTamperStatus, commonNEVendorInfo=commonNEVendorInfo, commonInternalTemperature=commonInternalTemperature, commonDeviceCraftStatus=commonDeviceCraftStatus, commonTrapAck=commonTrapAck, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceInfoTable=commonDeviceInfoTable, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentReset=commonAgentReset, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonReset=commonReset, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceVendor=commonDeviceVendor, commonDeviceNum=commonDeviceNum, commonNELogicalID=commonNELogicalID, commonNEVendor=commonNEVendor, commonDeviceResetCause=commonDeviceResetCause, hfcWarmStart=hfcWarmStart, commonAgentTrapCommunity=commonAgentTrapCommunity, commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapIP=commonAgentTrapIP, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentGroup=commonAgentGroup, commonForwardPathFrequency=commonForwardPathFrequency, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAdminGroup=commonAdminGroup, commonBackoffParams=commonBackoffParams, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceFW=commonDeviceFW, commonCraftStatus=commonCraftStatus, commonCheckCode=commonCheckCode, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonInvalidMacCmds=commonInvalidMacCmds, commonNESerialNumber=commonNESerialNumber, commonReturnPathFrequency=commonReturnPathFrequency, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceId=commonDeviceId, commonRfGroup=commonRfGroup, commonDeviceAcct=commonDeviceAcct, commonAgentTrapStatus=commonAgentTrapStatus)
