...
NotificationType, ModuleIdentity, IpAddress, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaxPayloadSize=commonMaxPayloadSize, commonTamperStatus=commonTamperStatus, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressNumber=commonMulticastAddressNumber, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonMACGroup=commonMACGroup, commonDeviceReset=commonDeviceReset, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceResetCause=commonDeviceResetCause, commonAgentTrapCommunity=commonAgentTrapCommunity, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceAcct=commonDeviceAcct, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAdminUseRf=commonAdminUseRf, commonRfGroup=commonRfGroup, commonDeviceTamperStatus=commonDeviceTamperStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceFW=commonDeviceFW, commonDeviceName=commonDeviceName, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceId=commonDeviceId, commonCraftStatus=commonCraftStatus, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentReset=commonAgentReset, commonCheckCode=commonCheckCode, commonBackoffParams=commonBackoffParams, commonNELogicalID=commonNELogicalID, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonNESerialNumber=commonNESerialNumber, commonAgentGroup=commonAgentGroup, commonAgentTrapIP=commonAgentTrapIP, commonDeviceNum=commonDeviceNum, commonBackoffPeriod=commonBackoffPeriod, commonMaxReturnPower=commonMaxReturnPower, commonACKTimeoutWindow=commonACKTimeoutWindow, commonAgentBootWay=commonAgentBootWay, commonInternalTemperature=commonInternalTemperature, commonDeviceSlot=commonDeviceSlot, commonDeviceModelNumber=commonDeviceModelNumber, commonNEStatus=commonNEStatus, commonDeviceGroup=commonDeviceGroup, commonDeviceOID=commonDeviceOID, commonTrapCommunityString=commonTrapCommunityString, commonDeviceVendorInfo=commonDeviceVendorInfo, commonTime=commonTime, commonReturnPathFrequency=commonReturnPathFrequency, commonAdminGroup=commonAdminGroup, commonDeviceStatus=commonDeviceStatus, commonMacAddress=commonMacAddress, commonDeviceMFD=commonDeviceMFD, commonDeviceSerialNumber=commonDeviceSerialNumber, commonNEVendor=commonNEVendor, commonAgentTrapIndex=commonAgentTrapIndex, commonVarBindings=commonVarBindings, hfcWarmStart=hfcWarmStart, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMulticastAddressEntry=commonMulticastAddressEntry, commonTrapAck=commonTrapAck, commonReset=commonReset, commonDeviceInfoTable=commonDeviceInfoTable, commonDevicesOID=commonDevicesOID, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonNEModelNumber=commonNEModelNumber, commonInvalidMacCmds=commonInvalidMacCmds, hfcColdStart=hfcColdStart, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAgentTrapTable=commonAgentTrapTable, commonNEVendorInfo=commonNEVendorInfo, commonPhysAddress=commonPhysAddress, commonDevicesID=commonDevicesID, commonMulticastAddressTable=commonMulticastAddressTable, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceMACAddress=commonDeviceMACAddress, commonDeviceCraftStatus=commonDeviceCraftStatus, commonNetworkAddress=commonNetworkAddress, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMacStats=commonMacStats, commonResetCause=commonResetCause, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceVendor=commonDeviceVendor)
