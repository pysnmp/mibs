...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMulticastAddressIndex=commonMulticastAddressIndex, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentTrapTable=commonAgentTrapTable, commonTime=commonTime, commonNEVendorInfo=commonNEVendorInfo, hfcWarmStart=hfcWarmStart, commonAgentMaxTraps=commonAgentMaxTraps, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonTrapAck=commonTrapAck, commonDeviceAcct=commonDeviceAcct, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceFW=commonDeviceFW, commonDeviceId=commonDeviceId, commonNESerialNumber=commonNESerialNumber, commonPhysAddress=commonPhysAddress, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonReset=commonReset, commonMaxReturnPower=commonMaxReturnPower, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentReset=commonAgentReset, commonDeviceOID=commonDeviceOID, commonDeviceReset=commonDeviceReset, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDevicesID=commonDevicesID, commonAgentTrapIP=commonAgentTrapIP, commonMacAddress=commonMacAddress, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceStatus=commonDeviceStatus, commonAdminUseRf=commonAdminUseRf, commonInternalTemperature=commonInternalTemperature, commonNEVendor=commonNEVendor, commonAgentTrapStatus=commonAgentTrapStatus, commonAlarmDetectionControl=commonAlarmDetectionControl, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceInfoTable=commonDeviceInfoTable, commonAdminGroup=commonAdminGroup, commonResetCause=commonResetCause, commonVarBindings=commonVarBindings, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceVendor=commonDeviceVendor, commonNEStatus=commonNEStatus, commonNEModelNumber=commonNEModelNumber, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonCraftStatus=commonCraftStatus, commonBackoffPeriod=commonBackoffPeriod, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentGroup=commonAgentGroup, commonTamperStatus=commonTamperStatus, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceNum=commonDeviceNum, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapEntry=commonAgentTrapEntry, commonDevicesOID=commonDevicesOID, commonDeviceMFD=commonDeviceMFD, commonDeviceSlot=commonDeviceSlot, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMacStats=commonMacStats, commonDeviceMACAddress=commonDeviceMACAddress, commonMACGroup=commonMACGroup, commonDeviceName=commonDeviceName, commonTrapCommunityString=commonTrapCommunityString, commonAgentBootWay=commonAgentBootWay, hfcColdStart=hfcColdStart, commonRfGroup=commonRfGroup, commonBackoffParams=commonBackoffParams, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonNetworkAddress=commonNetworkAddress, commonNELogicalID=commonNELogicalID, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceResetCause=commonDeviceResetCause, commonDeviceInfoEntry=commonDeviceInfoEntry, commonCheckCode=commonCheckCode, commonDeviceGroup=commonDeviceGroup, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceModelNumber=commonDeviceModelNumber, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaxPayloadSize=commonMaxPayloadSize)
