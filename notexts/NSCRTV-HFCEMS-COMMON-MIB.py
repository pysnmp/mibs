...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceNum=commonDeviceNum, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceId=commonDeviceId, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonCraftStatus=commonCraftStatus, commonDeviceGroup=commonDeviceGroup, commonMulticastAddressIndex=commonMulticastAddressIndex, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceVendor=commonDeviceVendor, commonNEStatus=commonNEStatus, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAdminGroup=commonAdminGroup, commonDeviceModelNumber=commonDeviceModelNumber, commonReturnPathFrequency=commonReturnPathFrequency, commonInvalidMacCmds=commonInvalidMacCmds, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceSlot=commonDeviceSlot, commonResetCause=commonResetCause, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonVarBindings=commonVarBindings, commonMulticastAddressNumber=commonMulticastAddressNumber, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonReset=commonReset, commonTamperStatus=commonTamperStatus, commonAgentTrapStatus=commonAgentTrapStatus, commonDevicesID=commonDevicesID, commonMacStats=commonMacStats, commonDeviceMFD=commonDeviceMFD, commonDevicesOID=commonDevicesOID, commonRfGroup=commonRfGroup, commonACKTimeoutWindow=commonACKTimeoutWindow, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceVendorInfo=commonDeviceVendorInfo, commonMulticastAddressTable=commonMulticastAddressTable, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonNESerialNumber=commonNESerialNumber, commonDeviceAcct=commonDeviceAcct, commonInternalTemperature=commonInternalTemperature, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMACGroup=commonMACGroup, commonDeviceOID=commonDeviceOID, commonBackoffPeriod=commonBackoffPeriod, commonAgentBootWay=commonAgentBootWay, commonPhysAddress=commonPhysAddress, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceFW=commonDeviceFW, commonDeviceReset=commonDeviceReset, commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonNetworkAddress=commonNetworkAddress, commonAgentReset=commonAgentReset, commonDeviceResetCause=commonDeviceResetCause, commonAgentGroup=commonAgentGroup, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceStatus=commonDeviceStatus, commonNELogicalID=commonNELogicalID, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAgentTrapCommunity=commonAgentTrapCommunity, commonTrapAck=commonTrapAck, commonDeviceMACAddress=commonDeviceMACAddress, hfcColdStart=hfcColdStart, commonTime=commonTime, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAgentTrapTable=commonAgentTrapTable, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapEntry=commonAgentTrapEntry, commonNEVendor=commonNEVendor, commonNEModelNumber=commonNEModelNumber, commonMacAddress=commonMacAddress, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceName=commonDeviceName, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceInfoEntry=commonDeviceInfoEntry, commonTrapCommunityString=commonTrapCommunityString, hfcWarmStart=hfcWarmStart, commonNEVendorInfo=commonNEVendorInfo, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentMaxTraps=commonAgentMaxTraps, commonBackoffParams=commonBackoffParams, commonForwardPathFrequency=commonForwardPathFrequency, commonAdminUseRf=commonAdminUseRf, commonCheckCode=commonCheckCode)
