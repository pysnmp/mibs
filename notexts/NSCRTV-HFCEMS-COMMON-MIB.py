...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaxPayloadSize=commonMaxPayloadSize, commonRfGroup=commonRfGroup, commonAgentTrapTable=commonAgentTrapTable, commonPhysAddress=commonPhysAddress, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonForwardPathFrequency=commonForwardPathFrequency, commonResetCause=commonResetCause, commonAdminGroup=commonAdminGroup, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentGroup=commonAgentGroup, commonNEModelNumber=commonNEModelNumber, commonDeviceFW=commonDeviceFW, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceTamperStatus=commonDeviceTamperStatus, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonTamperStatus=commonTamperStatus, commonDeviceInfoTable=commonDeviceInfoTable, commonVarBindings=commonVarBindings, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonForwardPathCRCErrors=commonForwardPathCRCErrors, hfcColdStart=hfcColdStart, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonBackoffParams=commonBackoffParams, commonReset=commonReset, commonDeviceStatus=commonDeviceStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonAgentReset=commonAgentReset, commonAgentTrapIndex=commonAgentTrapIndex, commonNEVendor=commonNEVendor, commonDeviceVendor=commonDeviceVendor, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDevicesID=commonDevicesID, commonCraftStatus=commonCraftStatus, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceNum=commonDeviceNum, commonDeviceVendorInfo=commonDeviceVendorInfo, hfcWarmStart=hfcWarmStart, commonNEVendorInfo=commonNEVendorInfo, commonDeviceSlot=commonDeviceSlot, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonNetworkAddress=commonNetworkAddress, commonInternalTemperature=commonInternalTemperature, commonTrapAck=commonTrapAck, commonDeviceId=commonDeviceId, commonMacStats=commonMacStats, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceGroup=commonDeviceGroup, commonMacAddress=commonMacAddress, commonBackoffPeriod=commonBackoffPeriod, commonDeviceMFD=commonDeviceMFD, commonDeviceName=commonDeviceName, commonAdminUseRf=commonAdminUseRf, commonAgentMaxTraps=commonAgentMaxTraps, commonNEStatus=commonNEStatus, commonDevicesOID=commonDevicesOID, commonTrapCommunityString=commonTrapCommunityString, commonTime=commonTime, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceReset=commonDeviceReset, commonACKTimeoutWindow=commonACKTimeoutWindow, commonMACGroup=commonMACGroup, commonNESerialNumber=commonNESerialNumber, commonNELogicalID=commonNELogicalID, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceOID=commonDeviceOID, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentTrapIP=commonAgentTrapIP, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceResetCause=commonDeviceResetCause, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapEntry=commonAgentTrapEntry, commonCheckCode=commonCheckCode, commonAgentBootWay=commonAgentBootWay, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonMaxReturnPower=commonMaxReturnPower, commonDeviceAcct=commonDeviceAcct, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval)
