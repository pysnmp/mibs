...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceTamperStatus=commonDeviceTamperStatus, commonMulticastAddressNumber=commonMulticastAddressNumber, commonNELogicalID=commonNELogicalID, commonTamperStatus=commonTamperStatus, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceGroup=commonDeviceGroup, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonAgentMaxTraps=commonAgentMaxTraps, commonNEModelNumber=commonNEModelNumber, commonRfGroup=commonRfGroup, commonBackoffParams=commonBackoffParams, commonTime=commonTime, commonDeviceMFD=commonDeviceMFD, commonDeviceStatus=commonDeviceStatus, commonDeviceVendor=commonDeviceVendor, commonReset=commonReset, commonMaxPayloadSize=commonMaxPayloadSize, commonAdminUseRf=commonAdminUseRf, commonAgentTrapCommunity=commonAgentTrapCommunity, commonResetCause=commonResetCause, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceInfoTable=commonDeviceInfoTable, commonInternalTemperature=commonInternalTemperature, commonDeviceSlot=commonDeviceSlot, hfcWarmStart=hfcWarmStart, commonDeviceMACAddress=commonDeviceMACAddress, commonMaxMulticastAddresses=commonMaxMulticastAddresses, hfcColdStart=hfcColdStart, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonTrapAck=commonTrapAck, commonAdminUseEthernet=commonAdminUseEthernet, commonNEStatus=commonNEStatus, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceReset=commonDeviceReset, commonVarBindings=commonVarBindings, commonAgentBootWay=commonAgentBootWay, commonAgentTrapIP=commonAgentTrapIP, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonCraftStatus=commonCraftStatus, commonDevicesOID=commonDevicesOID, commonCheckCode=commonCheckCode, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAgentTrapIndex=commonAgentTrapIndex, commonMacAddress=commonMacAddress, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceOID=commonDeviceOID, commonDevicesID=commonDevicesID, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceName=commonDeviceName, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMACGroup=commonMACGroup, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMaxReturnPower=commonMaxReturnPower, commonNEVendor=commonNEVendor, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceModelNumber=commonDeviceModelNumber, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonACKTimeoutWindow=commonACKTimeoutWindow, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAgentReset=commonAgentReset, commonAgentTrapEntry=commonAgentTrapEntry, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceCraftStatus=commonDeviceCraftStatus, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentGroup=commonAgentGroup, commonDeviceId=commonDeviceId, commonPhysAddress=commonPhysAddress, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonNESerialNumber=commonNESerialNumber, commonDeviceAcct=commonDeviceAcct, commonDeviceResetCause=commonDeviceResetCause, commonAdminGroup=commonAdminGroup, commonAgentTrapTable=commonAgentTrapTable, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceFW=commonDeviceFW, commonMulticastAddressEntry=commonMulticastAddressEntry, commonTrapCommunityString=commonTrapCommunityString, commonMacStats=commonMacStats, commonNEVendorInfo=commonNEVendorInfo, commonDeviceNum=commonDeviceNum, commonBackoffPeriod=commonBackoffPeriod, commonNetworkAddress=commonNetworkAddress, commonAlarmDetectionControl=commonAlarmDetectionControl)
