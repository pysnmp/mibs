...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceReset=commonDeviceReset, commonDeviceNum=commonDeviceNum, commonBackoffParams=commonBackoffParams, commonNEStatus=commonNEStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonResetCause=commonResetCause, commonVarBindings=commonVarBindings, commonDeviceFW=commonDeviceFW, hfcWarmStart=hfcWarmStart, commonAgentTrapEntry=commonAgentTrapEntry, commonMacStats=commonMacStats, commonAgentTrapTable=commonAgentTrapTable, commonNELogicalID=commonNELogicalID, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentTrapIP=commonAgentTrapIP, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMacAddress=commonMacAddress, commonMulticastAddressEntry=commonMulticastAddressEntry, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAgentTrapCommunity=commonAgentTrapCommunity, commonMulticastAddressIndex=commonMulticastAddressIndex, commonNEVendorInfo=commonNEVendorInfo, commonAgentBootWay=commonAgentBootWay, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceMFD=commonDeviceMFD, commonDeviceResetCause=commonDeviceResetCause, commonNESerialNumber=commonNESerialNumber, commonDeviceOID=commonDeviceOID, commonAdminUseEthernet=commonAdminUseEthernet, commonRfGroup=commonRfGroup, commonReset=commonReset, commonAgentTrapStatus=commonAgentTrapStatus, commonAgentReset=commonAgentReset, commonAgentTrapIndex=commonAgentTrapIndex, commonMACGroup=commonMACGroup, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceName=commonDeviceName, commonTrapAck=commonTrapAck, commonMulticastAddressTable=commonMulticastAddressTable, commonTamperStatus=commonTamperStatus, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceInfoEntry=commonDeviceInfoEntry, commonInternalTemperature=commonInternalTemperature, commonNEVendor=commonNEVendor, commonDevicesID=commonDevicesID, commonDevicesOID=commonDevicesOID, commonAdminUseRf=commonAdminUseRf, hfcColdStart=hfcColdStart, commonCheckCode=commonCheckCode, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceId=commonDeviceId, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceTamperStatus=commonDeviceTamperStatus, commonAgentGroup=commonAgentGroup, commonPhysAddress=commonPhysAddress, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceSlot=commonDeviceSlot, commonTrapCommunityString=commonTrapCommunityString, commonDeviceSerialNumber=commonDeviceSerialNumber, commonBackoffPeriod=commonBackoffPeriod, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceVendor=commonDeviceVendor, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceModelNumber=commonDeviceModelNumber, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceMACAddress=commonDeviceMACAddress, commonDeviceGroup=commonDeviceGroup, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentMaxTraps=commonAgentMaxTraps, commonTime=commonTime, commonCraftStatus=commonCraftStatus, commonNetworkAddress=commonNetworkAddress, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonMaxReturnPower=commonMaxReturnPower, commonDeviceAcct=commonDeviceAcct, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceStatus=commonDeviceStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonNEModelNumber=commonNEModelNumber, commonAdminGroup=commonAdminGroup)
