...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonTrapCommunityString=commonTrapCommunityString, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceGroup=commonDeviceGroup, commonResetCause=commonResetCause, commonRfGroup=commonRfGroup, commonDeviceMFD=commonDeviceMFD, commonMacStats=commonMacStats, commonNetworkAddress=commonNetworkAddress, commonDeviceId=commonDeviceId, commonAgentReset=commonAgentReset, commonDeviceSlot=commonDeviceSlot, commonInternalTemperature=commonInternalTemperature, commonDeviceStatus=commonDeviceStatus, commonDeviceTamperStatus=commonDeviceTamperStatus, commonTamperStatus=commonTamperStatus, commonReset=commonReset, commonDeviceModelNumber=commonDeviceModelNumber, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMaxReturnPower=commonMaxReturnPower, commonBackoffPeriod=commonBackoffPeriod, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonAgentTrapStatus=commonAgentTrapStatus, hfcWarmStart=hfcWarmStart, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDevicesOID=commonDevicesOID, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentBootWay=commonAgentBootWay, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonBackoffParams=commonBackoffParams, commonNEStatus=commonNEStatus, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonNELogicalID=commonNELogicalID, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceNum=commonDeviceNum, commonDeviceFW=commonDeviceFW, commonDeviceOID=commonDeviceOID, commonNEModelNumber=commonNEModelNumber, commonDeviceSerialNumber=commonDeviceSerialNumber, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceInfoEntry=commonDeviceInfoEntry, commonTrapAck=commonTrapAck, commonDevicesID=commonDevicesID, commonMacAddress=commonMacAddress, commonVarBindings=commonVarBindings, commonAdminGroup=commonAdminGroup, commonAgentTrapIP=commonAgentTrapIP, commonDeviceReset=commonDeviceReset, commonDeviceName=commonDeviceName, commonInvalidMacCmds=commonInvalidMacCmds, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceResetCause=commonDeviceResetCause, commonCheckCode=commonCheckCode, commonPhysAddress=commonPhysAddress, commonAgentGroup=commonAgentGroup, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceVendorInfo=commonDeviceVendorInfo, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMaxPayloadSize=commonMaxPayloadSize, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonMACGroup=commonMACGroup, commonAgentTrapCommunity=commonAgentTrapCommunity, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceCraftStatus=commonDeviceCraftStatus, commonNESerialNumber=commonNESerialNumber, commonAgentTrapIndex=commonAgentTrapIndex, commonMulticastAddressNumber=commonMulticastAddressNumber, commonTime=commonTime, commonAgentTrapTable=commonAgentTrapTable, commonMulticastAddressTable=commonMulticastAddressTable, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceMACAddress=commonDeviceMACAddress, commonCraftStatus=commonCraftStatus, commonDeviceAcct=commonDeviceAcct, commonMulticastAddressEntry=commonMulticastAddressEntry, commonACKTimeoutWindow=commonACKTimeoutWindow, commonAlarmDetectionControl=commonAlarmDetectionControl, commonNEVendor=commonNEVendor, commonAdminUseRf=commonAdminUseRf, hfcColdStart=hfcColdStart, commonDeviceVendor=commonDeviceVendor)
