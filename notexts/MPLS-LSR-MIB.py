...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsXCEntry=mplsXCEntry, mplsXCOwner=mplsXCOwner, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCUp=mplsXCUp, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInSegmentUp=mplsInSegmentUp, mplsLsrConformance=mplsLsrConformance, mplsXCLspId=mplsXCLspId, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInSegmentPerfTable=mplsInSegmentPerfTable, MplsObjectOwner=MplsObjectOwner, mplsXCDown=mplsXCDown, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentDown=mplsInSegmentDown, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentTable=mplsInSegmentTable, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInterfacePerfEntry=mplsInterfacePerfEntry, MplsBitRate=MplsBitRate, mplsXCIndexNext=mplsXCIndexNext, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsXCIndex=mplsXCIndex, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsLsrGroups=mplsLsrGroups, mplsXCAdminStatus=mplsXCAdminStatus, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, MplsLabel=MplsLabel, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsLsrObjects=mplsLsrObjects, mplsInSegmentOwner=mplsInSegmentOwner, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, MplsBufferSize=MplsBufferSize, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsLabelStackLabel=mplsLabelStackLabel, mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentEntry=mplsInSegmentEntry, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsLsrNotifications=mplsLsrNotifications, mplsLabelStackEntry=mplsLabelStackEntry, mplsXCGroup=mplsXCGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsPerfGroup=mplsPerfGroup, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentOctets=mplsInSegmentOctets, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentPackets=mplsInSegmentPackets, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCTable=mplsXCTable, mplsLsrMIB=mplsLsrMIB, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, MplsBurstSize=MplsBurstSize, mplsInSegmentGroup=mplsInSegmentGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsLsrCompliances=mplsLsrCompliances, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, MplsLSPID=MplsLSPID, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCStorageType=mplsXCStorageType, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsTrafficParamGroup=mplsTrafficParamGroup)
