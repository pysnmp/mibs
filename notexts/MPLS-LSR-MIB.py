...
mibBuilder.exportSymbols("MPLS-LSR-MIB", MplsLSPID=MplsLSPID, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInSegmentErrors=mplsInSegmentErrors, mplsXCUp=mplsXCUp, mplsXCLspId=mplsXCLspId, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsOutSegmentOctets=mplsOutSegmentOctets, MplsObjectOwner=MplsObjectOwner, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLsrMIB=mplsLsrMIB, mplsXCGroup=mplsXCGroup, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentGroup=mplsInSegmentGroup, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentTable=mplsInSegmentTable, mplsInterfacePerfEntry=mplsInterfacePerfEntry, MplsBufferSize=MplsBufferSize, mplsXCTable=mplsXCTable, mplsInSegmentOwner=mplsInSegmentOwner, mplsXCDown=mplsXCDown, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsLsrGroups=mplsLsrGroups, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInSegmentDown=mplsInSegmentDown, mplsXCEntry=mplsXCEntry, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsXCIndex=mplsXCIndex, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsXCOwner=mplsXCOwner, MplsLabel=MplsLabel, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentEntry=mplsInSegmentEntry, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentIfIndex=mplsInSegmentIfIndex, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInterfaceGroup=mplsInterfaceGroup, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsLabelStackTable=mplsLabelStackTable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCOperStatus=mplsXCOperStatus, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentDown=mplsOutSegmentDown, mplsLsrConformance=mplsLsrConformance, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, MplsBitRate=MplsBitRate, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLsrObjects=mplsLsrObjects, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsPerfGroup=mplsPerfGroup, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLabelStackGroup=mplsLabelStackGroup, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInSegmentPackets=mplsInSegmentPackets, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentOctets=mplsInSegmentOctets, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, MplsBurstSize=MplsBurstSize)
