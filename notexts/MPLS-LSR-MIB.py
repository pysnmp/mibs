...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceGroup=mplsInterfaceGroup, mplsLsrGroups=mplsLsrGroups, mplsXCStorageType=mplsXCStorageType, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsXCTable=mplsXCTable, PYSNMP_MODULE_ID=mplsLsrMIB, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsOutSegmentTable=mplsOutSegmentTable, MplsBurstSize=MplsBurstSize, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsLsrMIB=mplsLsrMIB, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsOutSegmentErrors=mplsOutSegmentErrors, MplsLSPID=MplsLSPID, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, MplsObjectOwner=MplsObjectOwner, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLsrConformance=mplsLsrConformance, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsXCOwner=mplsXCOwner, mplsInSegmentPackets=mplsInSegmentPackets, mplsXCEntry=mplsXCEntry, mplsXCIsPersistent=mplsXCIsPersistent, mplsLabelStackTable=mplsLabelStackTable, mplsInSegmentErrors=mplsInSegmentErrors, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInSegmentEntry=mplsInSegmentEntry, mplsPerfGroup=mplsPerfGroup, mplsInSegmentTable=mplsInSegmentTable, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentDown=mplsInSegmentDown, mplsLabelStackEntry=mplsLabelStackEntry, MplsBufferSize=MplsBufferSize, mplsXCLspId=mplsXCLspId, mplsLsrObjects=mplsLsrObjects, mplsXCUp=mplsXCUp, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCIndex=mplsXCIndex, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsXCTrapEnable=mplsXCTrapEnable, MplsBitRate=MplsBitRate, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCDown=mplsXCDown, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLsrCompliances=mplsLsrCompliances, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsTrafficParamTable=mplsTrafficParamTable, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsXCGroup=mplsXCGroup, MplsLabel=MplsLabel, mplsOutSegmentDown=mplsOutSegmentDown)
