...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentTable=mplsInSegmentTable, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, MplsLSPID=MplsLSPID, mplsXCIndex=mplsXCIndex, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCTable=mplsXCTable, mplsXCEntry=mplsXCEntry, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsXCOperStatus=mplsXCOperStatus, mplsLsrCompliances=mplsLsrCompliances, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLabelStackGroup=mplsLabelStackGroup, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsLsrMIB=mplsLsrMIB, mplsInSegmentDown=mplsInSegmentDown, MplsBitRate=MplsBitRate, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsLsrGroups=mplsLsrGroups, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentPackets=mplsInSegmentPackets, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsLabelStackIndex=mplsLabelStackIndex, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsXCOwner=mplsXCOwner, mplsLabelStackEntry=mplsLabelStackEntry, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCLspId=mplsXCLspId, mplsXCUp=mplsXCUp, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, MplsObjectOwner=MplsObjectOwner, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, MplsBurstSize=MplsBurstSize, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, MplsBufferSize=MplsBufferSize, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsOutSegmentUp=mplsOutSegmentUp, mplsXCDown=mplsXCDown, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentErrors=mplsInSegmentErrors, mplsInterfaceGroup=mplsInterfaceGroup, mplsLsrConformance=mplsLsrConformance, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsXCStorageType=mplsXCStorageType, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsXCGroup=mplsXCGroup, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsXCAdminStatus=mplsXCAdminStatus, mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsPerfGroup=mplsPerfGroup, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsLsrObjects=mplsLsrObjects, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsXCLabelStackIndex=mplsXCLabelStackIndex, MplsLabel=MplsLabel, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInterfaceInDiscards=mplsInterfaceInDiscards)
