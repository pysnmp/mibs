...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCIndex=mplsXCIndex, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInterfaceGroup=mplsInterfaceGroup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentTable=mplsOutSegmentTable, mplsXCOperStatus=mplsXCOperStatus, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentUp=mplsInSegmentUp, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentGroup=mplsOutSegmentGroup, MplsLSPID=MplsLSPID, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsXCGroup=mplsXCGroup, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentDown=mplsInSegmentDown, mplsInSegmentPackets=mplsInSegmentPackets, mplsXCLspId=mplsXCLspId, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsXCTable=mplsXCTable, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCEntry=mplsXCEntry, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsLabelStackEntry=mplsLabelStackEntry, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, MplsBitRate=MplsBitRate, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCDown=mplsXCDown, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentUp=mplsOutSegmentUp, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentGroup=mplsInSegmentGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLsrConformance=mplsLsrConformance, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCRowStatus=mplsXCRowStatus, mplsLsrMIB=mplsLsrMIB, mplsXCStorageType=mplsXCStorageType, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsLsrCompliances=mplsLsrCompliances, mplsLsrObjects=mplsLsrObjects, PYSNMP_MODULE_ID=mplsLsrMIB, MplsObjectOwner=MplsObjectOwner, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLabelStackIndex=mplsLabelStackIndex, mplsPerfGroup=mplsPerfGroup, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentErrors=mplsOutSegmentErrors, MplsBurstSize=MplsBurstSize, mplsLsrGroups=mplsLsrGroups, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsXCIndexNext=mplsXCIndexNext, mplsXCOwner=mplsXCOwner, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, MplsLabel=MplsLabel, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInSegmentLabel=mplsInSegmentLabel, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, MplsBufferSize=MplsBufferSize, mplsInSegmentErrors=mplsInSegmentErrors, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLabelStackLabel=mplsLabelStackLabel, mplsXCUp=mplsXCUp, mplsInterfaceConfTable=mplsInterfaceConfTable)
