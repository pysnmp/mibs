...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLsrObjects=mplsLsrObjects, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsXCDown=mplsXCDown, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsLsrConformance=mplsLsrConformance, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentEntry=mplsOutSegmentEntry, MplsBitRate=MplsBitRate, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLabelStackGroup=mplsLabelStackGroup, mplsXCAdminStatus=mplsXCAdminStatus, MplsLabel=MplsLabel, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsXCStorageType=mplsXCStorageType, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInSegmentNPop=mplsInSegmentNPop, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInSegmentOctets=mplsInSegmentOctets, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsXCLspId=mplsXCLspId, mplsLsrMIB=mplsLsrMIB, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentPackets=mplsInSegmentPackets, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsXCGroup=mplsXCGroup, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, MplsLSPID=MplsLSPID, mplsXCIndex=mplsXCIndex, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, MplsBurstSize=MplsBurstSize, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceGroup=mplsInterfaceGroup, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsXCEntry=mplsXCEntry, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsLsrGroups=mplsLsrGroups, mplsXCOperStatus=mplsXCOperStatus, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCUp=mplsXCUp, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentEntry=mplsInSegmentEntry, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsXCTable=mplsXCTable, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsPerfGroup=mplsPerfGroup, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCIndexNext=mplsXCIndexNext, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentUp=mplsOutSegmentUp, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentErrors=mplsInSegmentErrors, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsLabelStackTable=mplsLabelStackTable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCOwner=mplsXCOwner, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLabelStackLabel=mplsLabelStackLabel, MplsObjectOwner=MplsObjectOwner, MplsBufferSize=MplsBufferSize, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCTrapEnable=mplsXCTrapEnable, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLsrNotifications=mplsLsrNotifications, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCRowStatus=mplsXCRowStatus)
