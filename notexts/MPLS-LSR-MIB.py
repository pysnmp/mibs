...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsTrafficParamTable=mplsTrafficParamTable, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsXCDown=mplsXCDown, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsXCUp=mplsXCUp, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsXCLspId=mplsXCLspId, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, MplsBurstSize=MplsBurstSize, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCIndex=mplsXCIndex, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentTable=mplsInSegmentTable, mplsXCRowStatus=mplsXCRowStatus, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsLsrCompliances=mplsLsrCompliances, mplsXCGroup=mplsXCGroup, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsLsrConformance=mplsLsrConformance, mplsInSegmentOctets=mplsInSegmentOctets, mplsLabelStackIndex=mplsLabelStackIndex, MplsBitRate=MplsBitRate, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsLsrObjects=mplsLsrObjects, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsXCIndexNext=mplsXCIndexNext, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, MplsObjectOwner=MplsObjectOwner, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentDown=mplsInSegmentDown, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsXCOwner=mplsXCOwner, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentLabel=mplsInSegmentLabel, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfacePerfEntry=mplsInterfacePerfEntry, MplsLabel=MplsLabel, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentPackets=mplsInSegmentPackets, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceGroup=mplsInterfaceGroup, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsLsrMIB=mplsLsrMIB, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsXCTable=mplsXCTable, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsXCStorageType=mplsXCStorageType, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInSegmentErrors=mplsInSegmentErrors, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsLsrGroups=mplsLsrGroups, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentNPop=mplsInSegmentNPop, mplsLabelStackLabel=mplsLabelStackLabel, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsXCOperStatus=mplsXCOperStatus, mplsXCEntry=mplsXCEntry, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLsrNotifications=mplsLsrNotifications, MplsBufferSize=MplsBufferSize, MplsLSPID=MplsLSPID)
