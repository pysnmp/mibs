...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCRowStatus=mplsXCRowStatus, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCUp=mplsXCUp, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInSegmentGroup=mplsInSegmentGroup, MplsObjectOwner=MplsObjectOwner, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInSegmentPackets=mplsInSegmentPackets, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsLabelStackEntry=mplsLabelStackEntry, MplsBufferSize=MplsBufferSize, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsOutSegmentOwner=mplsOutSegmentOwner, MplsLabel=MplsLabel, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentDown=mplsOutSegmentDown, mplsXCIndexNext=mplsXCIndexNext, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentLabel=mplsInSegmentLabel, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, MplsLSPID=MplsLSPID, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrObjects=mplsLsrObjects, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsXCEntry=mplsXCEntry, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLsrGroups=mplsLsrGroups, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLsrConformance=mplsLsrConformance, mplsLsrCompliances=mplsLsrCompliances, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsXCIndex=mplsXCIndex, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCTable=mplsXCTable, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsXCIsPersistent=mplsXCIsPersistent, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCGroup=mplsXCGroup, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsXCOwner=mplsXCOwner, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCStorageType=mplsXCStorageType, mplsXCOperStatus=mplsXCOperStatus, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentOctets=mplsInSegmentOctets, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsLsrNotifications=mplsLsrNotifications, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsXCDown=mplsXCDown, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentEntry=mplsInSegmentEntry, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLsrMIB=mplsLsrMIB, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsLabelStackLabel=mplsLabelStackLabel, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, MplsBurstSize=MplsBurstSize, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsOutSegmentTable=mplsOutSegmentTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentTable=mplsInSegmentTable, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCLspId=mplsXCLspId, mplsInSegmentUp=mplsInSegmentUp, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLabelStackIndex=mplsLabelStackIndex, MplsBitRate=MplsBitRate)
