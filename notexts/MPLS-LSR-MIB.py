...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCAdminStatus=mplsXCAdminStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, MplsLSPID=MplsLSPID, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentErrors=mplsInSegmentErrors, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentUp=mplsInSegmentUp, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsLabelStackLabel=mplsLabelStackLabel, mplsLsrConformance=mplsLsrConformance, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrGroups=mplsLsrGroups, mplsTrafficParamGroup=mplsTrafficParamGroup, MplsBitRate=MplsBitRate, MplsObjectOwner=MplsObjectOwner, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCIndex=mplsXCIndex, mplsLsrMIB=mplsLsrMIB, mplsXCStorageType=mplsXCStorageType, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentNPop=mplsInSegmentNPop, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsXCIsPersistent=mplsXCIsPersistent, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsLabelStackTable=mplsLabelStackTable, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentDown=mplsOutSegmentDown, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCTable=mplsXCTable, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentHCOctets=mplsInSegmentHCOctets, MplsBurstSize=MplsBurstSize, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCUp=mplsXCUp, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInSegmentDown=mplsInSegmentDown, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCTrapEnable=mplsXCTrapEnable, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsXCGroup=mplsXCGroup, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentTable=mplsOutSegmentTable, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCOwner=mplsXCOwner, mplsLsrNotifications=mplsLsrNotifications, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, MplsLabel=MplsLabel, mplsTrafficParamTable=mplsTrafficParamTable, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInSegmentOctets=mplsInSegmentOctets, mplsInSegmentPackets=mplsInSegmentPackets, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInSegmentTable=mplsInSegmentTable, mplsXCIndexNext=mplsXCIndexNext, mplsXCDown=mplsXCDown, mplsOutSegmentEntry=mplsOutSegmentEntry, PYSNMP_MODULE_ID=mplsLsrMIB, mplsLsrObjects=mplsLsrObjects, MplsBufferSize=MplsBufferSize, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsXCLspId=mplsXCLspId, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsXCEntry=mplsXCEntry)
