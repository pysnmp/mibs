...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentOwner=mplsOutSegmentOwner, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCIsPersistent=mplsXCIsPersistent, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsXCUp=mplsXCUp, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInSegmentPackets=mplsInSegmentPackets, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsXCEntry=mplsXCEntry, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsXCLspId=mplsXCLspId, mplsOutSegmentUp=mplsOutSegmentUp, mplsLsrGroups=mplsLsrGroups, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentDown=mplsOutSegmentDown, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInSegmentTable=mplsInSegmentTable, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCGroup=mplsXCGroup, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsPerfGroup=mplsPerfGroup, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, MplsLSPID=MplsLSPID, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsXCOwner=mplsXCOwner, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInSegmentEntry=mplsInSegmentEntry, mplsInSegmentLabel=mplsInSegmentLabel, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, MplsObjectOwner=MplsObjectOwner, mplsInterfaceConfTable=mplsInterfaceConfTable, MplsBufferSize=MplsBufferSize, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLsrObjects=mplsLsrObjects, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, MplsBitRate=MplsBitRate, mplsXCTable=mplsXCTable, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsLabelStackEntry=mplsLabelStackEntry, MplsLabel=MplsLabel, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLsrMIB=mplsLsrMIB, mplsXCIndexNext=mplsXCIndexNext, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLsrCompliances=mplsLsrCompliances, mplsXCDown=mplsXCDown, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsLsrNotifications=mplsLsrNotifications, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentGroup=mplsInSegmentGroup, mplsXCIndex=mplsXCIndex, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCStorageType=mplsXCStorageType, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentDown=mplsInSegmentDown, MplsBurstSize=MplsBurstSize, mplsXCRowStatus=mplsXCRowStatus, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentErrors=mplsInSegmentErrors, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup)
