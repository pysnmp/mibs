...
mibBuilder.exportSymbols("MPLS-LSR-MIB", MplsBurstSize=MplsBurstSize, mplsXCTable=mplsXCTable, mplsXCRowStatus=mplsXCRowStatus, mplsLsrMIB=mplsLsrMIB, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCLspId=mplsXCLspId, MplsLabel=MplsLabel, mplsLsrCompliances=mplsLsrCompliances, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsXCUp=mplsXCUp, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentUp=mplsOutSegmentUp, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsPerfGroup=mplsPerfGroup, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, MplsBitRate=MplsBitRate, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsXCDown=mplsXCDown, mplsLsrObjects=mplsLsrObjects, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentEntry=mplsInSegmentEntry, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamTable=mplsTrafficParamTable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentDown=mplsInSegmentDown, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentPackets=mplsInSegmentPackets, mplsXCGroup=mplsXCGroup, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, MplsObjectOwner=MplsObjectOwner, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsXCOwner=mplsXCOwner, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCEntry=mplsXCEntry, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentTable=mplsOutSegmentTable, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentDown=mplsOutSegmentDown, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrGroups=mplsLsrGroups, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentUp=mplsInSegmentUp, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, MplsLSPID=MplsLSPID, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLsrNotifications=mplsLsrNotifications, MplsBufferSize=MplsBufferSize, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsXCStorageType=mplsXCStorageType, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsLabelStackEntry=mplsLabelStackEntry, mplsLabelStackIndexNext=mplsLabelStackIndexNext, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInSegmentGroup=mplsInSegmentGroup, mplsInSegmentOwner=mplsInSegmentOwner, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCIndexNext=mplsXCIndexNext, mplsXCIndex=mplsXCIndex, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentOctets=mplsInSegmentOctets, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsLabelStackRowStatus=mplsLabelStackRowStatus)
