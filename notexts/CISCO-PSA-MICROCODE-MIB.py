...
# ASN.1 source CISCO-PSA-MICROCODE-MIB
# Source digest sha256:6d32476d246a4a4bc291060b8aff1d8194e8bd7f801a12dd4ccf7b15fc313a67
...
if mibBuilder.loadTexts: ciscoPsaMicrocodeMIB.setLastUpdated('2002-06-18 00:00')
...
cpmcModulePsaTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 259, 1, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cpmcModulePsaTable.setStatus('current')
cpmcModulePsaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 259, 1, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ENTITY-MIB", "entPhysicalIndex"))
...
cpmcBundleTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 259, 1, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cpmcBundleTable.setStatus('current')
cpmcBundleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 259, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-PSA-MICROCODE-MIB", "cpmcBundleId"))
if mibBuilder.loadTexts: cpmcBundleEntry.setStatus('current')
cpmcBundleId = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 259, 1, 2, 1, 1, 1), PsaMicrocodeBundleId()).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("CISCO-PSA-MICROCODE-MIB", PYSNMP_MODULE_ID=ciscoPsaMicrocodeMIB, PsaMicrocodeBundleId=PsaMicrocodeBundleId, PsaMicrocodeFeatures=PsaMicrocodeFeatures, ciscoPsaMicrocodeMIB=ciscoPsaMicrocodeMIB, ciscoPsaMicrocodeMIBCompliance=ciscoPsaMicrocodeMIBCompliance, ciscoPsaMicrocodeMIBCompliances=ciscoPsaMicrocodeMIBCompliances, ciscoPsaMicrocodeMIBConformance=ciscoPsaMicrocodeMIBConformance, ciscoPsaMicrocodeMIBGroups=ciscoPsaMicrocodeMIBGroups, ciscoPsaMicrocodeMIBNotifs=ciscoPsaMicrocodeMIBNotifs, ciscoPsaMicrocodeMIBObjects=ciscoPsaMicrocodeMIBObjects, ciscoPsaMicrocodeNotifGroup=ciscoPsaMicrocodeNotifGroup, ciscoPsaMicrocodeParamsGroup=ciscoPsaMicrocodeParamsGroup, ciscoPsaMicrocodeReload=ciscoPsaMicrocodeReload, cpmcBundle=cpmcBundle, cpmcBundleEntry=cpmcBundleEntry, cpmcBundleFeatures=cpmcBundleFeatures, cpmcBundleId=cpmcBundleId, cpmcBundleTable=cpmcBundleTable, cpmcModulePsa=cpmcModulePsa, cpmcModulePsaCurrBundleId=cpmcModulePsaCurrBundleId, cpmcModulePsaEntry=cpmcModulePsaEntry, cpmcModulePsaFeaturesDisabled=cpmcModulePsaFeaturesDisabled, cpmcModulePsaFeaturesEnabled=cpmcModulePsaFeaturesEnabled, cpmcModulePsaPrevBundleId=cpmcModulePsaPrevBundleId, cpmcModulePsaTable=cpmcModulePsaTable, cpmcNotif=cpmcNotif, cpmcNotifEnables=cpmcNotifEnables)
