...
mibBuilder.exportSymbols("DOCS-IF-MIB", docsIfCmtsModScdmaSpreaderEnable=docsIfCmtsModScdmaSpreaderEnable, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmtsModType=docsIfCmtsModType, docsIfCmtsUpChnlCtrTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrTotalCntnReqDataMslots, docsIfUpChannelScdmaActiveCodes=docsIfUpChannelScdmaActiveCodes, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfCmtsUpChnlCtrExtTotalCntnReqMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqMslots, docsIfNotification=docsIfNotification, docsIfUpChannelScdmaCodesPerSlot=docsIfUpChannelScdmaCodesPerSlot, docsIfSigQExtUnerroreds=docsIfSigQExtUnerroreds, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsUpChnlCtrCollCntnMslots=docsIfCmtsUpChnlCtrCollCntnMslots, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfBasicGroup=docsIfBasicGroup, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfUpChannelPreEqEnable=docsIfUpChannelPreEqEnable, docsIfQosProfileTable=docsIfQosProfileTable, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfQosProfPriority=docsIfQosProfPriority, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfQosProfMaxTransmitBurst=docsIfQosProfMaxTransmitBurst, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, docsIfCmtsDownChnlCtrId=docsIfCmtsDownChnlCtrId, docsIfCmtsUpChnlCtrExtCollCntnMslots=docsIfCmtsUpChnlCtrExtCollCntnMslots, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmtsCmMac=docsIfCmtsCmMac, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, docsIfCmGroup=docsIfCmGroup, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, TenthdBmV=TenthdBmV, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmtsCmStatusExtUncorrectables=docsIfCmtsCmStatusExtUncorrectables, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfCmtsUpChnlCtrExtTotalCntnMslots=docsIfCmtsUpChnlCtrExtTotalCntnMslots, docsIfSigQEqualizationData=docsIfSigQEqualizationData, TenthdB=TenthdB, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfCmtsCmStatusExtCorrecteds=docsIfCmtsCmStatusExtCorrecteds, docsIfCmtsDownChannelCounterEntry=docsIfCmtsDownChannelCounterEntry, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfCmtsChannelUtilizationEntry=docsIfCmtsChannelUtilizationEntry, docsIfDocsisBaseCapability=docsIfDocsisBaseCapability, docsIfCmtsModByteInterleaverDepth=docsIfCmtsModByteInterleaverDepth, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfCmtsUpChnlCtrCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrCollCntnInitMaintMslots, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfCmtsUpChannelCounterEntry=docsIfCmtsUpChannelCounterEntry, docsIfCmtsUpChnlCtrCollCntnReqDataMslots=docsIfCmtsUpChnlCtrCollCntnReqDataMslots, docsIfDownChannelId=docsIfDownChannelId, docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfCmMacTable=docsIfCmMacTable, docsIfCmCapabilities=docsIfCmCapabilities, docsIfCmStatusEqualizationData=docsIfCmStatusEqualizationData, docsIfDownChannelFrequency=docsIfDownChannelFrequency, docsIfCmtsUpChnlCtrUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrUsedCntnReqDataMslots, docsIfCmCmtsAddress=docsIfCmCmtsAddress, PYSNMP_MODULE_ID=docsIfMib, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmStatusModulationType=docsIfCmStatusModulationType, docsIfUpChannelCloneFrom=docsIfUpChannelCloneFrom, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots, docsIfDownChannelAnnex=docsIfDownChannelAnnex, docsIfSigQExtCorrecteds=docsIfSigQExtCorrecteds, docsIfCmtsCapabilities=docsIfCmtsCapabilities, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmtsUpChnlCtrUcastGrantedMslots=docsIfCmtsUpChnlCtrUcastGrantedMslots, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime, docsIfUpChannelScdmaHoppingSeed=docsIfUpChannelScdmaHoppingSeed, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfCmStatusValue=docsIfCmStatusValue, docsIfCmServiceTable=docsIfCmServiceTable, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, DocsisVersion=DocsisVersion, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfCmtsChannelUtilizationTable=docsIfCmtsChannelUtilizationTable, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfCmtsUpChnlCtrTotalCntnMslots=docsIfCmtsUpChnlCtrTotalCntnMslots, docsIfQosProfStatus=docsIfQosProfStatus, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmtsModScdmaInterleaverStepSize=docsIfCmtsModScdmaInterleaverStepSize, docsIfCmtsUpChnlCtrUsedCntnMslots=docsIfCmtsUpChnlCtrUsedCntnMslots, docsIfCmtsDownChnlCtrExtTotalBytes=docsIfCmtsDownChnlCtrExtTotalBytes, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfCmtsUpChnlCtrTotalCntnReqMslots=docsIfCmtsUpChnlCtrTotalCntnReqMslots, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmtsDownChnlCtrTotalBytes=docsIfCmtsDownChnlCtrTotalBytes, docsIfBasicCompliance=docsIfBasicCompliance, docsIfCmtsCmStatusExtUnerroreds=docsIfCmtsCmStatusExtUnerroreds, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfMibObjects=docsIfMibObjects, docsIfCmtsUpChannelCounterTable=docsIfCmtsUpChannelCounterTable, docsIfCmtsModTcmErrorCorrectionOn=docsIfCmtsModTcmErrorCorrectionOn, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsCmStatusInetAddress=docsIfCmtsCmStatusInetAddress, docsIfDeprecatedGroup=docsIfDeprecatedGroup, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfCmStatusTable=docsIfCmStatusTable, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfSigQExtUncorrectables=docsIfSigQExtUncorrectables, docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmtsModScdmaSubframeCodes=docsIfCmtsModScdmaSubframeCodes, docsIfBaseObjects=docsIfBaseObjects, docsIfUpChannelId=docsIfUpChannelId, docsIfCmtsModControl=docsIfCmtsModControl, docsIfCmtsUpChnlCtrExtCollCntnReqMslots=docsIfCmtsUpChnlCtrExtCollCntnReqMslots, DocsisUpstreamType=DocsisUpstreamType, docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfGroups=docsIfGroups, docsIfCmServiceExtTxSlotsImmed=docsIfCmServiceExtTxSlotsImmed, docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots, docsIfCmtsDownChnlCtrUsedBytes=docsIfCmtsDownChnlCtrUsedBytes, docsIfCmServiceExtTxSlotsDed=docsIfCmServiceExtTxSlotsDed, docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfCmtsUpChnlCtrExtUcastGrantedMslots=docsIfCmtsUpChnlCtrExtUcastGrantedMslots, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmtsUpChnlCtrTotalMslots=docsIfCmtsUpChnlCtrTotalMslots, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfCmtsModPreambleType=docsIfCmtsModPreambleType, docsIfCmtsChannelUtUtilization=docsIfCmtsChannelUtUtilization, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfCmtsChannelUtilizationInterval=docsIfCmtsChannelUtilizationInterval, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfCmtsServiceNewCmStatusIndex=docsIfCmtsServiceNewCmStatusIndex, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfCmtsCmStatusModulationType=docsIfCmtsCmStatusModulationType, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfCmStatusDocsisOperMode=docsIfCmStatusDocsisOperMode, docsIfCompliances=docsIfCompliances, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfUpChannelUpdate=docsIfUpChannelUpdate, docsIfCmtsUpChnlCtrCollCntnReqMslots=docsIfCmtsUpChnlCtrCollCntnReqMslots, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfCmtsUpChnlCtrExtUsedCntnReqMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqMslots, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfCmtsChannelUtId=docsIfCmtsChannelUtId, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfUpChannelScdmaFrameSize=docsIfUpChannelScdmaFrameSize, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, docsIfQosProfIndex=docsIfQosProfIndex, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfCmServiceId=docsIfCmServiceId, docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots, docsIfCmMacEntry=docsIfCmMacEntry, docsIfCmtsCmStatusDocsisRegMode=docsIfCmtsCmStatusDocsisRegMode, docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots, docsIfCmtsDownChannelCounterTable=docsIfCmtsDownChannelCounterTable, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmtsUpChnlCtrId=docsIfCmtsUpChnlCtrId, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, DocsisUpstreamTypeStatus=DocsisUpstreamTypeStatus, DocsisQosVersion=DocsisQosVersion, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfCmtsModByteInterleaverBlockSize=docsIfCmtsModByteInterleaverBlockSize, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfCmtsChannelUtIfType=docsIfCmtsChannelUtIfType, docsIfCmStatusCode=docsIfCmStatusCode, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfDownChannelPower=docsIfDownChannelPower, docsIfCmtsUpChnlCtrUsedCntnReqMslots=docsIfCmtsUpChnlCtrUsedCntnReqMslots, docsIfCmtsDownChnlCtrExtUsedBytes=docsIfCmtsDownChnlCtrExtUsedBytes, docsIfSigQUncorrectables=docsIfSigQUncorrectables, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfMib=docsIfMib, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfCmtsModChannelType=docsIfCmtsModChannelType, docsIfCmObjects=docsIfCmObjects, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfUpChannelType=docsIfUpChannelType, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfCmtsCmStatusValueLastUpdate=docsIfCmtsCmStatusValueLastUpdate, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, docsIfCmtsCmStatusInetAddressType=docsIfCmtsCmStatusInetAddressType, docsIfConformance=docsIfConformance, docsIfCmtsUpChnlCtrExtUsedCntnMslots=docsIfCmtsUpChnlCtrExtUsedCntnMslots, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfCmtsUpChnlCtrExtTotalMslots=docsIfCmtsUpChnlCtrExtTotalMslots, docsIfUpChannelStatus=docsIfUpChannelStatus, docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots=docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots)
