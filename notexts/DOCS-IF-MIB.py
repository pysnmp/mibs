...
# ASN.1 source file:///home/runner/work/mibs/mibs/src/standard/DOCS-IF-MIB
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, Counter32, ObjectIdentity, MibIdentifier, transmission, Bits, TimeTicks, iso, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "Counter32", "ObjectIdentity", "MibIdentifier", "transmission", "Bits", "TimeTicks", "iso", "Integer32", "ModuleIdentity", "NotificationType")
MacAddress, TruthValue, RowStatus, TimeInterval, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TruthValue", "RowStatus", "TimeInterval", "TimeStamp", "TextualConvention", "DisplayString")
docsIfMib = ModuleIdentity((1, 3, 6, 1, 2, 1, 10, 127))
docsIfMib.setRevisions(('2002-12-20 00:00', '1999-08-19 00:00',))
if mibBuilder.loadTexts: docsIfMib.setLastUpdated('200212200000Z')
...
docsIfDownChannelModulation = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("qam64", 3), ("qam256", 4), ("qam512", 5), ("qam1024", 6), ("qpsk", 7), ("qam16", 8)))).setMaxAccess("readwrite")
...
docsIfQosProfPriority = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 7))).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfPriority.setStatus('current')
docsIfQosProfMaxUpBandwidth = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 100000000))).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfMaxUpBandwidth.setStatus('current')
docsIfQosProfGuarUpBandwidth = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 100000000))).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfGuarUpBandwidth.setStatus('current')
docsIfQosProfMaxDownBandwidth = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 100000000))).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfMaxDownBandwidth.setStatus('current')
docsIfQosProfMaxTxBurst = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfMaxTxBurst.setStatus('deprecated')
docsIfQosProfBaselinePrivacy = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 7), TruthValue().clone('false')).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfBaselinePrivacy.setStatus('current')
docsIfQosProfStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 8), RowStatus()).setMaxAccess("readonly")
if mibBuilder.loadTexts: docsIfQosProfStatus.setStatus('current')
docsIfQosProfMaxTransmitBurst = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 1, 3, 1, 9), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
docsIfCmStatusEqualizationData = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 2, 2, 1, 17), OctetString()).setMaxAccess("readonly")
...
docsIfCmtsCmStatusTimingOffset = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 3, 3, 1, 7), Unsigned32()).setMaxAccess("readwrite")
...
docsIfCmtsModType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 3, 5, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("other", 1), ("qpsk", 2), ("qam16", 3), ("qam8", 4), ("qam32", 5), ("qam64", 6), ("qam128", 7), ("qam256", 8))).clone('qpsk')).setMaxAccess("readcreate")
...
docsIfCmtsChannelUtId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 1, 3, 9, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 255)))
...
docsIfDeprecatedGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 10, 127, 3, 2, 5)).setObjects(("DOCS-IF-MIB", "docsIfQosProfMaxTxBurst"), ("DOCS-IF-MIB", "docsIfCmtsCmStatusIpAddress"), ("DOCS-IF-MIB", "docsIfCmtsServiceCmStatusIndex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    docsIfDeprecatedGroup = docsIfDeprecatedGroup.setStatus('deprecated')
mibBuilder.exportSymbols("DOCS-IF-MIB", TenthdBmV=TenthdBmV, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfCmtsModType=docsIfCmtsModType, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfCmtsUpChnlCtrCollCntnMslots=docsIfCmtsUpChnlCtrCollCntnMslots, docsIfDocsisBaseCapability=docsIfDocsisBaseCapability, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfCmtsModScdmaSubframeCodes=docsIfCmtsModScdmaSubframeCodes, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, docsIfCmtsUpChnlCtrExtUcastGrantedMslots=docsIfCmtsUpChnlCtrExtUcastGrantedMslots, docsIfCmtsCmStatusDocsisRegMode=docsIfCmtsCmStatusDocsisRegMode, docsIfCompliances=docsIfCompliances, PYSNMP_MODULE_ID=docsIfMib, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfCmServiceTable=docsIfCmServiceTable, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfCmtsUpChnlCtrExtTotalCntnMslots=docsIfCmtsUpChnlCtrExtTotalCntnMslots, docsIfCmMacEntry=docsIfCmMacEntry, docsIfUpChannelPreEqEnable=docsIfUpChannelPreEqEnable, docsIfCmtsUpChnlCtrTotalMslots=docsIfCmtsUpChnlCtrTotalMslots, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfCmtsDownChannelCounterEntry=docsIfCmtsDownChannelCounterEntry, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfCmtsChannelUtilizationEntry=docsIfCmtsChannelUtilizationEntry, docsIfUpChannelId=docsIfUpChannelId, DocsisUpstreamType=DocsisUpstreamType, docsIfCmStatusTable=docsIfCmStatusTable, docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfCmtsChannelUtIfType=docsIfCmtsChannelUtIfType, docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots, docsIfCmtsCmMac=docsIfCmtsCmMac, docsIfCmtsCmStatusModulationType=docsIfCmtsCmStatusModulationType, docsIfCmtsChannelUtUtilization=docsIfCmtsChannelUtUtilization, docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots, DocsisQosVersion=DocsisQosVersion, docsIfUpChannelStatus=docsIfUpChannelStatus, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfQosProfStatus=docsIfQosProfStatus, TenthdB=TenthdB, docsIfCmtsUpChannelCounterEntry=docsIfCmtsUpChannelCounterEntry, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfCmtsCapabilities=docsIfCmtsCapabilities, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfCmtsDownChnlCtrUsedBytes=docsIfCmtsDownChnlCtrUsedBytes, docsIfCmtsUpChnlCtrCollCntnReqMslots=docsIfCmtsUpChnlCtrCollCntnReqMslots, docsIfCmCapabilities=docsIfCmCapabilities, docsIfCmtsUpChnlCtrTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrTotalCntnReqDataMslots, docsIfUpChannelScdmaFrameSize=docsIfUpChannelScdmaFrameSize, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmtsUpChnlCtrUsedCntnMslots=docsIfCmtsUpChnlCtrUsedCntnMslots, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfSigQUncorrectables=docsIfSigQUncorrectables, docsIfCmtsUpChnlCtrCollCntnReqDataMslots=docsIfCmtsUpChnlCtrCollCntnReqDataMslots, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfMibObjects=docsIfMibObjects, docsIfCmStatusModulationType=docsIfCmStatusModulationType, docsIfDownChannelFrequency=docsIfDownChannelFrequency, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfSigQEqualizationData=docsIfSigQEqualizationData, docsIfQosProfPriority=docsIfQosProfPriority, docsIfCmCmtsAddress=docsIfCmCmtsAddress, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots, docsIfCmtsUpChnlCtrTotalCntnMslots=docsIfCmtsUpChnlCtrTotalCntnMslots, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfCmObjects=docsIfCmObjects, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfCmtsUpChnlCtrExtTotalCntnReqMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqMslots, docsIfCmtsUpChnlCtrUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrUsedCntnReqDataMslots, docsIfCmtsUpChnlCtrExtUsedCntnReqMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqMslots, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfQosProfileTable=docsIfQosProfileTable, docsIfBasicCompliance=docsIfBasicCompliance, docsIfCmtsModByteInterleaverBlockSize=docsIfCmtsModByteInterleaverBlockSize, docsIfCmtsUpChnlCtrExtTotalMslots=docsIfCmtsUpChnlCtrExtTotalMslots, docsIfCmtsModScdmaInterleaverStepSize=docsIfCmtsModScdmaInterleaverStepSize, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfSigQExtCorrecteds=docsIfSigQExtCorrecteds, docsIfCmtsDownChnlCtrId=docsIfCmtsDownChnlCtrId, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfCmtsDownChnlCtrExtUsedBytes=docsIfCmtsDownChnlCtrExtUsedBytes, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfDeprecatedGroup=docsIfDeprecatedGroup, docsIfCmtsModControl=docsIfCmtsModControl, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfUpChannelScdmaActiveCodes=docsIfUpChannelScdmaActiveCodes, docsIfCmtsUpChnlCtrCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrCollCntnInitMaintMslots, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmStatusCode=docsIfCmStatusCode, docsIfCmtsUpChannelCounterTable=docsIfCmtsUpChannelCounterTable, docsIfQosProfMaxTransmitBurst=docsIfQosProfMaxTransmitBurst, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, DocsisVersion=DocsisVersion, docsIfSigQExtUnerroreds=docsIfSigQExtUnerroreds, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfDownChannelAnnex=docsIfDownChannelAnnex, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfCmServiceExtTxSlotsImmed=docsIfCmServiceExtTxSlotsImmed, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfNotification=docsIfNotification, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst, docsIfGroups=docsIfGroups, docsIfCmServiceExtTxSlotsDed=docsIfCmServiceExtTxSlotsDed, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmtsModChannelType=docsIfCmtsModChannelType, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, docsIfCmtsChannelUtilizationInterval=docsIfCmtsChannelUtilizationInterval, docsIfCmtsUpChnlCtrUsedCntnReqMslots=docsIfCmtsUpChnlCtrUsedCntnReqMslots, docsIfConformance=docsIfConformance, docsIfQosProfIndex=docsIfQosProfIndex, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfBaseObjects=docsIfBaseObjects, docsIfUpChannelUpdate=docsIfUpChannelUpdate, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfDownChannelId=docsIfDownChannelId, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots, docsIfSigQExtUncorrectables=docsIfSigQExtUncorrectables, docsIfBasicGroup=docsIfBasicGroup, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, docsIfCmtsCmStatusValueLastUpdate=docsIfCmtsCmStatusValueLastUpdate, docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots=docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots, docsIfCmStatusValue=docsIfCmStatusValue, docsIfUpChannelCloneFrom=docsIfUpChannelCloneFrom, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfCmtsServiceNewCmStatusIndex=docsIfCmtsServiceNewCmStatusIndex, docsIfCmtsCmStatusExtUnerroreds=docsIfCmtsCmStatusExtUnerroreds, docsIfCmtsCmStatusInetAddressType=docsIfCmtsCmStatusInetAddressType, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfCmStatusEqualizationData=docsIfCmStatusEqualizationData, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, docsIfMib=docsIfMib, docsIfUpChannelScdmaCodesPerSlot=docsIfUpChannelScdmaCodesPerSlot, docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, docsIfCmtsCmStatusInetAddress=docsIfCmtsCmStatusInetAddress, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmtsCmStatusExtUncorrectables=docsIfCmtsCmStatusExtUncorrectables, docsIfCmtsDownChnlCtrTotalBytes=docsIfCmtsDownChnlCtrTotalBytes, docsIfCmtsUpChnlCtrExtCollCntnMslots=docsIfCmtsUpChnlCtrExtCollCntnMslots, docsIfCmtsUpChnlCtrUcastGrantedMslots=docsIfCmtsUpChnlCtrUcastGrantedMslots, docsIfCmGroup=docsIfCmGroup, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots, docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfUpChannelType=docsIfUpChannelType, docsIfCmtsUpChnlCtrExtUsedCntnMslots=docsIfCmtsUpChnlCtrExtUsedCntnMslots, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfDownChannelPower=docsIfDownChannelPower, docsIfCmtsChannelUtId=docsIfCmtsChannelUtId, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfCmtsCmStatusExtCorrecteds=docsIfCmtsCmStatusExtCorrecteds, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfCmtsDownChannelCounterTable=docsIfCmtsDownChannelCounterTable, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfCmtsModTcmErrorCorrectionOn=docsIfCmtsModTcmErrorCorrectionOn, DocsisUpstreamTypeStatus=DocsisUpstreamTypeStatus, docsIfCmtsDownChnlCtrExtTotalBytes=docsIfCmtsDownChnlCtrExtTotalBytes, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmtsUpChnlCtrExtCollCntnReqMslots=docsIfCmtsUpChnlCtrExtCollCntnReqMslots, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfCmtsModScdmaSpreaderEnable=docsIfCmtsModScdmaSpreaderEnable, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmtsUpChnlCtrId=docsIfCmtsUpChnlCtrId, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfCmtsModPreambleType=docsIfCmtsModPreambleType, docsIfCmMacTable=docsIfCmMacTable, docsIfCmStatusDocsisOperMode=docsIfCmStatusDocsisOperMode, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfCmtsModByteInterleaverDepth=docsIfCmtsModByteInterleaverDepth, docsIfCmtsChannelUtilizationTable=docsIfCmtsChannelUtilizationTable, docsIfCmtsUpChnlCtrTotalCntnReqMslots=docsIfCmtsUpChnlCtrTotalCntnReqMslots, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, docsIfCmServiceId=docsIfCmServiceId, docsIfUpChannelScdmaHoppingSeed=docsIfUpChannelScdmaHoppingSeed)
