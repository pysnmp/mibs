...
MacAddress, RowStatus, TimeInterval, TextualConvention, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TimeInterval", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-IF-MIB", docsIfCmMacTable=docsIfCmMacTable, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfCmtsUpChnlCtrUcastGrantedMslots=docsIfCmtsUpChnlCtrUcastGrantedMslots, docsIfSigQExtUncorrectables=docsIfSigQExtUncorrectables, docsIfCmStatusValue=docsIfCmStatusValue, docsIfQosProfileTable=docsIfQosProfileTable, PYSNMP_MODULE_ID=docsIfMib, docsIfCmStatusCode=docsIfCmStatusCode, docsIfDownChannelId=docsIfDownChannelId, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfCmtsUpChnlCtrTotalCntnMslots=docsIfCmtsUpChnlCtrTotalCntnMslots, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfUpChannelScdmaCodesPerSlot=docsIfUpChannelScdmaCodesPerSlot, docsIfCmtsChannelUtIfType=docsIfCmtsChannelUtIfType, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfCmGroup=docsIfCmGroup, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfCmServiceTable=docsIfCmServiceTable, docsIfSigQEqualizationData=docsIfSigQEqualizationData, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfCmtsUpChnlCtrExtUcastGrantedMslots=docsIfCmtsUpChnlCtrExtUcastGrantedMslots, docsIfCmtsChannelUtUtilization=docsIfCmtsChannelUtUtilization, docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots, docsIfDownChannelPower=docsIfDownChannelPower, docsIfCmtsCmStatusModulationType=docsIfCmtsCmStatusModulationType, docsIfCmtsCmStatusExtUnerroreds=docsIfCmtsCmStatusExtUnerroreds, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfCmtsUpChannelCounterTable=docsIfCmtsUpChannelCounterTable, DocsisUpstreamType=DocsisUpstreamType, docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfCmtsModType=docsIfCmtsModType, docsIfCmStatusModulationType=docsIfCmStatusModulationType, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmtsModByteInterleaverBlockSize=docsIfCmtsModByteInterleaverBlockSize, docsIfCmtsUpChnlCtrTotalCntnReqMslots=docsIfCmtsUpChnlCtrTotalCntnReqMslots, docsIfCmtsModChannelType=docsIfCmtsModChannelType, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmMacEntry=docsIfCmMacEntry, docsIfCmtsUpChnlCtrUsedCntnReqMslots=docsIfCmtsUpChnlCtrUsedCntnReqMslots, docsIfUpChannelScdmaActiveCodes=docsIfUpChannelScdmaActiveCodes, docsIfCmtsCmStatusValueLastUpdate=docsIfCmtsCmStatusValueLastUpdate, docsIfCmtsUpChnlCtrExtUsedCntnReqMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqMslots, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfSigQExtUnerroreds=docsIfSigQExtUnerroreds, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, TenthdBmV=TenthdBmV, docsIfSigQExtCorrecteds=docsIfSigQExtCorrecteds, docsIfCmtsModByteInterleaverDepth=docsIfCmtsModByteInterleaverDepth, TenthdB=TenthdB, docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmtsDownChannelCounterEntry=docsIfCmtsDownChannelCounterEntry, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots, docsIfMib=docsIfMib, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmtsDownChnlCtrTotalBytes=docsIfCmtsDownChnlCtrTotalBytes, docsIfCmtsUpChnlCtrExtCollCntnReqMslots=docsIfCmtsUpChnlCtrExtCollCntnReqMslots, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmtsDownChnlCtrUsedBytes=docsIfCmtsDownChnlCtrUsedBytes, docsIfCmtsServiceNewCmStatusIndex=docsIfCmtsServiceNewCmStatusIndex, docsIfUpChannelId=docsIfUpChannelId, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfCmtsCmStatusExtUncorrectables=docsIfCmtsCmStatusExtUncorrectables, docsIfCmtsUpChnlCtrId=docsIfCmtsUpChnlCtrId, docsIfCmtsUpChnlCtrExtCollCntnMslots=docsIfCmtsUpChnlCtrExtCollCntnMslots, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfCmtsUpChnlCtrExtUsedCntnMslots=docsIfCmtsUpChnlCtrExtUsedCntnMslots, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfSigQUncorrectables=docsIfSigQUncorrectables, docsIfCmtsUpChannelCounterEntry=docsIfCmtsUpChannelCounterEntry, docsIfCmtsChannelUtilizationInterval=docsIfCmtsChannelUtilizationInterval, docsIfCmtsUpChnlCtrTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrTotalCntnReqDataMslots, docsIfUpChannelCloneFrom=docsIfUpChannelCloneFrom, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmServiceExtTxSlotsImmed=docsIfCmServiceExtTxSlotsImmed, docsIfUpChannelScdmaHoppingSeed=docsIfUpChannelScdmaHoppingSeed, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfCmStatusEqualizationData=docsIfCmStatusEqualizationData, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfDownChannelFrequency=docsIfDownChannelFrequency, docsIfCmtsCmStatusDocsisRegMode=docsIfCmtsCmStatusDocsisRegMode, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, DocsisQosVersion=DocsisQosVersion, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, docsIfCmtsModScdmaInterleaverStepSize=docsIfCmtsModScdmaInterleaverStepSize, docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots, docsIfDownChannelAnnex=docsIfDownChannelAnnex, docsIfCmtsDownChnlCtrExtUsedBytes=docsIfCmtsDownChnlCtrExtUsedBytes, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots, docsIfCmCapabilities=docsIfCmCapabilities, docsIfCmObjects=docsIfCmObjects, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfBasicGroup=docsIfBasicGroup, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfQosProfMaxTransmitBurst=docsIfQosProfMaxTransmitBurst, docsIfCmtsModPreambleType=docsIfCmtsModPreambleType, docsIfQosProfStatus=docsIfQosProfStatus, docsIfCmtsModScdmaSpreaderEnable=docsIfCmtsModScdmaSpreaderEnable, docsIfGroups=docsIfGroups, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfBaseObjects=docsIfBaseObjects, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmtsUpChnlCtrCollCntnMslots=docsIfCmtsUpChnlCtrCollCntnMslots, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfQosProfIndex=docsIfQosProfIndex, docsIfCmtsUpChnlCtrExtTotalMslots=docsIfCmtsUpChnlCtrExtTotalMslots, docsIfDocsisBaseCapability=docsIfDocsisBaseCapability, docsIfCmtsUpChnlCtrCollCntnReqMslots=docsIfCmtsUpChnlCtrCollCntnReqMslots, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfCmServiceId=docsIfCmServiceId, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfCmtsModScdmaSubframeCodes=docsIfCmtsModScdmaSubframeCodes, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfCmCmtsAddress=docsIfCmCmtsAddress, docsIfCmtsUpChnlCtrCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrCollCntnInitMaintMslots, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfCmtsCmStatusExtCorrecteds=docsIfCmtsCmStatusExtCorrecteds, docsIfCompliances=docsIfCompliances, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfBasicCompliance=docsIfBasicCompliance, docsIfDeprecatedGroup=docsIfDeprecatedGroup, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfCmtsUpChnlCtrExtTotalCntnMslots=docsIfCmtsUpChnlCtrExtTotalCntnMslots, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots=docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots, docsIfCmtsUpChnlCtrTotalMslots=docsIfCmtsUpChnlCtrTotalMslots, docsIfUpChannelStatus=docsIfUpChannelStatus, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfCmtsCmStatusInetAddress=docsIfCmtsCmStatusInetAddress, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfConformance=docsIfConformance, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfCmtsUpChnlCtrUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrUsedCntnReqDataMslots, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfQosProfPriority=docsIfQosProfPriority, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfUpChannelPreEqEnable=docsIfUpChannelPreEqEnable, docsIfMibObjects=docsIfMibObjects, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, docsIfUpChannelType=docsIfUpChannelType, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfUpChannelUpdate=docsIfUpChannelUpdate, docsIfCmtsDownChannelCounterTable=docsIfCmtsDownChannelCounterTable, docsIfCmtsChannelUtId=docsIfCmtsChannelUtId, docsIfCmtsChannelUtilizationTable=docsIfCmtsChannelUtilizationTable, docsIfCmtsCmMac=docsIfCmtsCmMac, DocsisVersion=DocsisVersion, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsUpChnlCtrUsedCntnMslots=docsIfCmtsUpChnlCtrUsedCntnMslots, docsIfCmtsChannelUtilizationEntry=docsIfCmtsChannelUtilizationEntry, docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmtsModTcmErrorCorrectionOn=docsIfCmtsModTcmErrorCorrectionOn, docsIfCmtsUpChnlCtrCollCntnReqDataMslots=docsIfCmtsUpChnlCtrCollCntnReqDataMslots, docsIfNotification=docsIfNotification, docsIfCmtsCapabilities=docsIfCmtsCapabilities, docsIfUpChannelScdmaFrameSize=docsIfUpChannelScdmaFrameSize, DocsisUpstreamTypeStatus=DocsisUpstreamTypeStatus, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfCmStatusDocsisOperMode=docsIfCmStatusDocsisOperMode, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime, docsIfCmtsCmStatusInetAddressType=docsIfCmtsCmStatusInetAddressType, docsIfCmtsDownChnlCtrId=docsIfCmtsDownChnlCtrId, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfCmtsModControl=docsIfCmtsModControl, docsIfCmtsUpChnlCtrExtTotalCntnReqMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqMslots, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfCmtsDownChnlCtrExtTotalBytes=docsIfCmtsDownChnlCtrExtTotalBytes, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfCmServiceExtTxSlotsDed=docsIfCmServiceExtTxSlotsDed, docsIfCmStatusTable=docsIfCmStatusTable, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst)
