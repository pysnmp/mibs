...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRpcReconfig=hmRpcReconfig, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRpcEntry=hmRpcEntry, hmSrmEntry=hmSrmEntry, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcTable=hmRpcTable, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRpcConfigOperState=hmRpcConfigOperState, hmRingCplMode=hmRingCplMode, hmSrmRingProtocol=hmSrmRingProtocol, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmSrmRowStatus=hmSrmRowStatus, hmRpcRingName=hmRpcRingName, hmMultiHiperRing=hmMultiHiperRing, hmRpcAdminState=hmRpcAdminState, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingRedTable=hmRingRedTable, hmRingCplOperState=hmRingCplOperState, hmMrpRowStatus=hmMrpRowStatus, hmSrmVlanID=hmSrmVlanID, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRpcRingProtocol=hmRpcRingProtocol, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCouplingTable=hmRingCouplingTable, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmSrmOperState=hmSrmOperState, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCplConfigOperState=hmRingCplConfigOperState, hmSrmTable=hmSrmTable, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpExpectedRole=hmMrpExpectedRole, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRingRedMode=hmRingRedMode, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcRingID=hmRpcRingID, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingRedundancy=hmRingRedundancy, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmSrmNodes=hmSrmNodes, hmRingCplControlMode=hmRingCplControlMode, hmSrmRingID=hmSrmRingID, hmMrpDomainID=hmMrpDomainID, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplReconfig=hmRingCplReconfig, hmMrpTable=hmMrpTable, hmRpcRingOperState=hmRpcRingOperState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpDomainName=hmMrpDomainName, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplConfigSource=hmRingCplConfigSource, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRMPriority=hmMrpMRMPriority, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRingRedOperState=hmRingRedOperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcOperState=hmRpcOperState, hmMrpRedOperState=hmMrpRedOperState, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmSrmReconfig=hmSrmReconfig, hmRingRedReconfig=hmRingRedReconfig, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcVlanID=hmRpcVlanID, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRpcRingport2OperState=hmRpcRingport2OperState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmSrmConfigOperState=hmSrmConfigOperState, hmSrmRingOperState=hmSrmRingOperState, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpConfigOperState=hmMrpConfigOperState, hmSrmRingName=hmSrmRingName, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpReconfig=hmMrpReconfig, hmSrmAdminState=hmSrmAdminState, hmRpcRowStatus=hmRpcRowStatus, hmMrpVlanID=hmMrpVlanID, hmRingRedEntry=hmRingRedEntry, hmMrpEntry=hmMrpEntry, hmRpcNodes=hmRpcNodes, hmRpcRingport1OperState=hmRpcRingport1OperState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex)
