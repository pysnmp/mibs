...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmSrmReconfig=hmSrmReconfig, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingRedOperState=hmRingRedOperState, hmRingRedEntry=hmRingRedEntry, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMPriority=hmMrpMRMPriority, hmRpcVlanID=hmRpcVlanID, hmSrmPartnerMAC=hmSrmPartnerMAC, hmSrmTable=hmSrmTable, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingRedRedGroupID=hmRingRedRedGroupID, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmSrmRingProtocol=hmSrmRingProtocol, hmRingRedundancy=hmRingRedundancy, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmSrmConfigOperState=hmSrmConfigOperState, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMultiHiperRing=hmMultiHiperRing, hmRingRedTable=hmRingRedTable, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcTable=hmRpcTable, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmRingID=hmSrmRingID, hmSrmAdminState=hmSrmAdminState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingCplOperState=hmRingCplOperState, hmMrpVlanID=hmMrpVlanID, hmRingCplMode=hmRingCplMode, hmRpcReconfig=hmRpcReconfig, hmRingRedMode=hmRingRedMode, hmSrmRingOperState=hmSrmRingOperState, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmVlanID=hmSrmVlanID, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmOperState=hmSrmOperState, PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpDomainName=hmMrpDomainName, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmNodes=hmSrmNodes, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRpcRingID=hmRpcRingID, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRingCouplingTable=hmRingCouplingTable, hmSrmEntry=hmSrmEntry, hmRpcAdminState=hmRpcAdminState, hmSrmRingName=hmSrmRingName, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRpcRowStatus=hmRpcRowStatus, hmRpcEntry=hmRpcEntry, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmSrmRowStatus=hmSrmRowStatus, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpRowStatus=hmMrpRowStatus, hmRingCplConfigSource=hmRingCplConfigSource, hmRingRedReconfig=hmRingRedReconfig, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpDomainID=hmMrpDomainID, hmRpcRingName=hmRpcRingName, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRpcNodes=hmRpcNodes, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRingCouplingEntry=hmRingCouplingEntry, hmRpcRingProtocol=hmRpcRingProtocol, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRpcRingOperState=hmRpcRingOperState, hmMrpTable=hmMrpTable, hmMrpReconfig=hmMrpReconfig, hmRpcRingport1OperState=hmRpcRingport1OperState, hmMrpRedOperState=hmMrpRedOperState, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcOperState=hmRpcOperState, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingCplControlMode=hmRingCplControlMode, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplReconfig=hmRingCplReconfig, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpEntry=hmMrpEntry)
