...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplConfigSource=hmRingCplConfigSource, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpTable=hmMrpTable, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcRingProtocol=hmRpcRingProtocol, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpExpectedRole=hmMrpExpectedRole, hmRingRedOperState=hmRingRedOperState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpRowStatus=hmMrpRowStatus, hmSrmRingOperState=hmSrmRingOperState, hmSrmVlanID=hmSrmVlanID, hmMrpEntry=hmMrpEntry, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRingRedEntry=hmRingRedEntry, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingCplControlMode=hmRingCplControlMode, hmRingRedMode=hmRingRedMode, hmRpcEntry=hmRpcEntry, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRingCouplingTable=hmRingCouplingTable, hmRpcOperState=hmRpcOperState, hmMrpDomainID=hmMrpDomainID, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpDomainName=hmMrpDomainName, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRpcNodes=hmRpcNodes, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcConfigOperState=hmRpcConfigOperState, hmRpcVlanID=hmRpcVlanID, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMultiHiperRing=hmMultiHiperRing, hmRingRedundancyEvent=hmRingRedundancyEvent, hmSrmConfigOperState=hmSrmConfigOperState, hmRpcRingName=hmRpcRingName, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRpcAdminState=hmRpcAdminState, hmMrpReconfig=hmMrpReconfig, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmRowStatus=hmSrmRowStatus, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmSrmReconfig=hmSrmReconfig, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRpcReconfig=hmRpcReconfig, hmRpcRingID=hmRpcRingID, hmSrmAdminState=hmSrmAdminState, hmSrmNodes=hmSrmNodes, hmRpcRingOperState=hmRpcRingOperState, hmRingCplMode=hmRingCplMode, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmSrmEntry=hmSrmEntry, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmSrmMaxInstances=hmSrmMaxInstances, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmSrmOperState=hmSrmOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRingCplReconfig=hmRingCplReconfig, hmRingRedTable=hmRingRedTable, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpMRMPriority=hmMrpMRMPriority, hmSrmTable=hmSrmTable, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplRowStatus=hmRingCplRowStatus, hmRingCplControlIfOpState=hmRingCplControlIfOpState, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCplOperState=hmRingCplOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingRedReconfig=hmRingRedReconfig, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpRedOperState=hmMrpRedOperState, hmSrmRingName=hmSrmRingName, hmRpcTable=hmRpcTable, hmMrpVlanID=hmMrpVlanID, hmSrmRingID=hmSrmRingID, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRingRedundancy=hmRingRedundancy)
