...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpExpectedRole=hmMrpExpectedRole, hmRpcRingport2OperState=hmRpcRingport2OperState, hmMrpDomainName=hmMrpDomainName, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMultiHiperRing=hmMultiHiperRing, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingRedOperState=hmRingRedOperState, hmMrpVlanID=hmMrpVlanID, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcRowStatus=hmRpcRowStatus, hmSrmEntry=hmSrmEntry, hmRingRedRedGroupID=hmRingRedRedGroupID, hmSrmOperState=hmSrmOperState, hmRingCplReconfig=hmRingCplReconfig, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRpcTable=hmRpcTable, hmRingCplRowStatus=hmRingCplRowStatus, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmSrmRingOperState=hmSrmRingOperState, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpEntry=hmMrpEntry, hmSrmTable=hmSrmTable, hmMrpReconfig=hmMrpReconfig, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmSrmAdminState=hmSrmAdminState, hmRingCplMode=hmRingCplMode, hmMrpRowStatus=hmMrpRowStatus, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRingID=hmRpcRingID, hmRpcRingProtocol=hmRpcRingProtocol, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcRingOperState=hmRpcRingOperState, hmSrmReconfig=hmSrmReconfig, hmRingCouplingEntry=hmRingCouplingEntry, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRpcAdminState=hmRpcAdminState, hmRingCplOperState=hmRingCplOperState, hmSrmNodes=hmSrmNodes, hmRingCouplingTable=hmRingCouplingTable, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplConfigSource=hmRingCplConfigSource, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpRingport1OperState=hmMrpRingport1OperState, hmSrmVlanID=hmSrmVlanID, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmSrmRingID=hmSrmRingID, hmSrmRingName=hmSrmRingName, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRingRedEntry=hmRingRedEntry, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRpcNodes=hmRpcNodes, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingRedTable=hmRingRedTable, hmRpcReconfig=hmRpcReconfig, hmMrpConfigOperState=hmMrpConfigOperState, hmRingCplControlMode=hmRingCplControlMode, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingRedMode=hmRingRedMode, hmRpcVlanID=hmRpcVlanID, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcOperState=hmRpcOperState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpTable=hmMrpTable, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingRedundancy=hmRingRedundancy, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpDomainID=hmMrpDomainID, hmSrmRowStatus=hmSrmRowStatus, hmRpcRingName=hmRpcRingName, hmRpcRedundancyOperState=hmRpcRedundancyOperState, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedReconfig=hmRingRedReconfig, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRpcEntry=hmRpcEntry, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMrpRedOperState=hmMrpRedOperState)
