...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCouplingTable=hmRingCouplingTable, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmMrpReconfig=hmMrpReconfig, hmRpcOperState=hmRpcOperState, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmVlanID=hmSrmVlanID, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpEntry=hmMrpEntry, hmMrpDomainID=hmMrpDomainID, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRpcVlanID=hmRpcVlanID, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplControlMode=hmRingCplControlMode, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRpcRingProtocol=hmRpcRingProtocol, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmSrmRingName=hmSrmRingName, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingRedMode=hmRingRedMode, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRpcAdminState=hmRpcAdminState, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingRedOperState=hmRingRedOperState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRpcRingName=hmRpcRingName, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingRedReconfig=hmRingRedReconfig, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcRingID=hmRpcRingID, hmRingRedTable=hmRingRedTable, hmSrmEntry=hmSrmEntry, hmRingCplRowStatus=hmRingCplRowStatus, hmRpcRingOperState=hmRpcRingOperState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRingCplReconfig=hmRingCplReconfig, hmRpcReconfig=hmRpcReconfig, hmSrmMaxInstances=hmSrmMaxInstances, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmSrmRingProtocol=hmSrmRingProtocol, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRingCplConfigSource=hmRingCplConfigSource, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmSrmOperState=hmSrmOperState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcEntry=hmRpcEntry, hmSrmRingID=hmSrmRingID, hmRpcNodes=hmRpcNodes, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCplControlGroupID=hmRingCplControlGroupID, hmSrmRowStatus=hmSrmRowStatus, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingRedundancy=hmRingRedundancy, hmMrpExpectedRole=hmMrpExpectedRole, hmRingCplMode=hmRingCplMode, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpDomainName=hmMrpDomainName, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmAdminState=hmSrmAdminState, hmRingRedEntry=hmRingRedEntry, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmSrmRingOperState=hmSrmRingOperState, hmSrmReconfig=hmSrmReconfig, hmSrmTable=hmSrmTable, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmNodes=hmSrmNodes, PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpRedOperState=hmMrpRedOperState, hmRpcRingport1OperState=hmRpcRingport1OperState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMultiHiperRing=hmMultiHiperRing, hmMrpRowStatus=hmMrpRowStatus, hmRingCplOperState=hmRingCplOperState, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmMrpTable=hmMrpTable, hmMrpRingport2OperState=hmMrpRingport2OperState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpVlanID=hmMrpVlanID, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRpcTable=hmRpcTable)
