...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmSrmRingport1OperState=hmSrmRingport1OperState, hmSrmReconfig=hmSrmReconfig, hmMrpRowStatus=hmMrpRowStatus, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmSrmRingName=hmSrmRingName, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmSrmOperState=hmSrmOperState, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRpcConfigOperState=hmRpcConfigOperState, hmSrmRowStatus=hmSrmRowStatus, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRingRedundancy=hmRingRedundancy, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmEntry=hmSrmEntry, hmRpcEntry=hmRpcEntry, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRpcOperState=hmRpcOperState, hmRingRedEntry=hmRingRedEntry, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmSrmRingProtocol=hmSrmRingProtocol, hmSrmMaxInstances=hmSrmMaxInstances, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRpcReconfig=hmRpcReconfig, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpDomainName=hmMrpDomainName, hmRpcRingID=hmRpcRingID, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRpcVlanID=hmRpcVlanID, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCplReconfig=hmRingCplReconfig, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmMrpRedOperState=hmMrpRedOperState, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCouplingTable=hmRingCouplingTable, hmRingCplMode=hmRingCplMode, hmRingRedTable=hmRingRedTable, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcRingName=hmRpcRingName, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpMRMPriority=hmMrpMRMPriority, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRingCplControlGroupID=hmRingCplControlGroupID, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmNodes=hmSrmNodes, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmSrmAdminState=hmSrmAdminState, hmRingCplOperState=hmRingCplOperState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpDomainID=hmMrpDomainID, hmSrmRingID=hmSrmRingID, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingRedMode=hmRingRedMode, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmVlanID=hmSrmVlanID, hmRpcNodes=hmRpcNodes, hmMultiHiperRing=hmMultiHiperRing, hmMrpEntry=hmMrpEntry, hmRingCplControlMode=hmRingCplControlMode, hmRpcRingProtocol=hmRpcRingProtocol, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRpcTable=hmRpcTable, hmRpcRingOperState=hmRpcRingOperState, hmSrmRingOperState=hmSrmRingOperState, hmMrpVlanID=hmMrpVlanID, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRpcAdminState=hmRpcAdminState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmSrmConfigOperState=hmSrmConfigOperState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpTable=hmMrpTable, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmSrmTable=hmSrmTable, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpReconfig=hmMrpReconfig, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingRedReconfig=hmRingRedReconfig, hmRingRedOperState=hmRingRedOperState)
