...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRpcRingName=hmRpcRingName, hmRpcVlanID=hmRpcVlanID, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmSrmMaxInstances=hmSrmMaxInstances, hmSrmConfigOperState=hmSrmConfigOperState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcTable=hmRpcTable, hmRingCplControlGroupID=hmRingCplControlGroupID, hmMrpEntry=hmMrpEntry, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRpcEntry=hmRpcEntry, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRingRedTable=hmRingRedTable, hmMultiHiperRing=hmMultiHiperRing, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingRedOperState=hmRingRedOperState, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, PYSNMP_MODULE_ID=hmRingRedundancy, hmRpcRingOperState=hmRpcRingOperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcNodes=hmRpcNodes, hmRingRedEntry=hmRingRedEntry, hmRingCplRowStatus=hmRingCplRowStatus, hmSrmRingOperState=hmSrmRingOperState, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmSrmVlanID=hmSrmVlanID, hmSrmOperState=hmSrmOperState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmSrmRingID=hmSrmRingID, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpExpectedRole=hmMrpExpectedRole, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcConfigOperState=hmRpcConfigOperState, hmRpcRingProtocol=hmRpcRingProtocol, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmMrpVlanID=hmMrpVlanID, hmRpcRowStatus=hmRpcRowStatus, hmMrpRedOperState=hmMrpRedOperState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpDomainID=hmMrpDomainID, hmMrpReconfig=hmMrpReconfig, hmRpcAdminState=hmRpcAdminState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRingCplConfigSource=hmRingCplConfigSource, hmRingRedReconfig=hmRingRedReconfig, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingRedMode=hmRingRedMode, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRpcRingID=hmRpcRingID, hmRpcRingport1OperState=hmRpcRingport1OperState, hmMrpDomainName=hmMrpDomainName, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcOperState=hmRpcOperState, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRingCplMode=hmRingCplMode, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmRingName=hmSrmRingName, hmMrpTable=hmMrpTable, hmRingRedundancy=hmRingRedundancy, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCouplingTable=hmRingCouplingTable, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmSrmReconfig=hmSrmReconfig, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingCplReconfig=hmRingCplReconfig, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmRingport1OperState=hmSrmRingport1OperState, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmSrmEntry=hmSrmEntry, hmSrmRowStatus=hmSrmRowStatus, hmRpcReconfig=hmRpcReconfig, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmSrmNodes=hmSrmNodes, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingCplOperState=hmRingCplOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmSrmTable=hmSrmTable, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmAdminState=hmSrmAdminState, hmMrpRowStatus=hmMrpRowStatus, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplControlMode=hmRingCplControlMode)
