...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpMRMPriority=hmMrpMRMPriority, hmRpcRingOperState=hmRpcRingOperState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRingRedMode=hmRingRedMode, hmMrpRowStatus=hmMrpRowStatus, hmRingRedReconfig=hmRingRedReconfig, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpDomainID=hmMrpDomainID, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmMrpReconfig=hmMrpReconfig, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpEntry=hmMrpEntry, hmRingCplNetCoupling=hmRingCplNetCoupling, hmSrmRingName=hmSrmRingName, hmRpcEntry=hmRpcEntry, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRpcOperState=hmRpcOperState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmRingport1OperState=hmSrmRingport1OperState, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpTable=hmMrpTable, hmSrmNodes=hmSrmNodes, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcConfigOperState=hmRpcConfigOperState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmMrpRedOperState=hmMrpRedOperState, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedOperState=hmRingRedOperState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmSrmRingOperState=hmSrmRingOperState, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingRedEntry=hmRingRedEntry, hmSrmEntry=hmSrmEntry, hmRpcRingProtocol=hmRpcRingProtocol, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmSrmReconfig=hmSrmReconfig, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmSrmAdminState=hmSrmAdminState, hmRingCplOperState=hmRingCplOperState, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmSrmOperState=hmSrmOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRpcVlanID=hmRpcVlanID, hmSrmTable=hmSrmTable, hmRingCouplingTable=hmRingCouplingTable, hmRingCplControlMode=hmRingCplControlMode, hmRingCplMode=hmRingCplMode, hmSrmRingProtocol=hmSrmRingProtocol, hmSrmMaxInstances=hmSrmMaxInstances, hmSrmRingID=hmSrmRingID, hmMrpVlanID=hmMrpVlanID, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRpcTable=hmRpcTable, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplConfigSource=hmRingCplConfigSource, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCouplingEntry=hmRingCouplingEntry, hmRpcAdminState=hmRpcAdminState, hmRingRedTable=hmRingRedTable, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmRowStatus=hmSrmRowStatus, hmRingCplReconfig=hmRingCplReconfig, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpDomainName=hmMrpDomainName, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcReconfig=hmRpcReconfig, hmRpcNodes=hmRpcNodes, hmRpcRingID=hmRpcRingID, hmRingRedundancy=hmRingRedundancy, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmSrmVlanID=hmSrmVlanID, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMultiHiperRing=hmMultiHiperRing, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRpcRingName=hmRpcRingName, hmMrpConfigOperState=hmMrpConfigOperState)
