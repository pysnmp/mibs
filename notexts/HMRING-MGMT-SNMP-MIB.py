...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedundancy=hmRingRedundancy, hmRingRedMode=hmRingRedMode, hmSrmReconfig=hmSrmReconfig, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRingRedTable=hmRingRedTable, hmSrmRingProtocol=hmSrmRingProtocol, hmSrmVlanID=hmSrmVlanID, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmSrmNodes=hmSrmNodes, hmRpcRowStatus=hmRpcRowStatus, hmSrmMaxInstances=hmSrmMaxInstances, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedOperState=hmRingRedOperState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingProtocol=hmRpcRingProtocol, hmRingRedEntry=hmRingRedEntry, hmRingRedReconfig=hmRingRedReconfig, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpEntry=hmMrpEntry, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmRingID=hmSrmRingID, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingCplNetCoupling=hmRingCplNetCoupling, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRpcRingOperState=hmRpcRingOperState, hmRingCplReconfig=hmRingCplReconfig, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplMode=hmRingCplMode, hmRpcVlanID=hmRpcVlanID, hmSrmAdminState=hmSrmAdminState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpRowStatus=hmMrpRowStatus, hmRingCplConfigSource=hmRingCplConfigSource, hmSrmTable=hmSrmTable, hmMrpRedOperState=hmMrpRedOperState, hmSrmEntry=hmSrmEntry, hmRpcOperState=hmRpcOperState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRpcRingport1OperState=hmRpcRingport1OperState, PYSNMP_MODULE_ID=hmRingRedundancy, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmRingOperState=hmSrmRingOperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcRingName=hmRpcRingName, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRpcEntry=hmRpcEntry, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmSrmOperState=hmSrmOperState, hmMrpDomainName=hmMrpDomainName, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCouplingEntry=hmRingCouplingEntry, hmRpcRingID=hmRpcRingID, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpVlanID=hmMrpVlanID, hmMrpExpectedRole=hmMrpExpectedRole, hmRpcNodes=hmRpcNodes, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpDomainID=hmMrpDomainID, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRingCplOperState=hmRingCplOperState, hmSrmRowStatus=hmSrmRowStatus, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcAdminState=hmRpcAdminState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcReconfig=hmRpcReconfig, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpTable=hmMrpTable, hmMultiHiperRing=hmMultiHiperRing, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmSrmRingName=hmSrmRingName, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplControlMode=hmRingCplControlMode, hmMrpReconfig=hmMrpReconfig, hmRingCouplingTable=hmRingCouplingTable, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRpcTable=hmRpcTable)
