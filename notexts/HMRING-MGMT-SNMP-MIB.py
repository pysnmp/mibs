...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmSrmRingID=hmSrmRingID, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmSrmRingName=hmSrmRingName, hmRpcTable=hmRpcTable, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcConfigOperState=hmRpcConfigOperState, hmRpcRingID=hmRpcRingID, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmRingOperState=hmSrmRingOperState, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcRingOperState=hmRpcRingOperState, hmMrpTable=hmMrpTable, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmSrmAdminState=hmSrmAdminState, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpRowStatus=hmMrpRowStatus, hmSrmEntry=hmSrmEntry, hmSrmOperState=hmSrmOperState, hmMrpReconfig=hmMrpReconfig, hmSrmRingProtocol=hmSrmRingProtocol, hmRingCouplingTable=hmRingCouplingTable, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingRedReconfig=hmRingRedReconfig, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmMultiHiperRing=hmMultiHiperRing, hmRpcNodes=hmRpcNodes, hmMrpMRMPriority=hmMrpMRMPriority, hmRingRedundancy=hmRingRedundancy, hmMrpEntry=hmMrpEntry, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRingCplOperState=hmRingCplOperState, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmSrmConfigOperState=hmSrmConfigOperState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedEntry=hmRingRedEntry, hmSrmVlanID=hmSrmVlanID, hmRpcReconfig=hmRpcReconfig, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpRedOperState=hmMrpRedOperState, hmRpcVlanID=hmRpcVlanID, hmMrpDomainID=hmMrpDomainID, hmRingCplMode=hmRingCplMode, hmRpcRingName=hmRpcRingName, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingRedTable=hmRingRedTable, hmRingRedMode=hmRingRedMode, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmReconfig=hmSrmReconfig, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingRedConfigOperState=hmRingRedConfigOperState, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRpcAdminState=hmRpcAdminState, hmRingRedOperState=hmRingRedOperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmRowStatus=hmSrmRowStatus, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpDomainName=hmMrpDomainName, hmRingCplRowStatus=hmRingCplRowStatus, hmRingCplControlMode=hmRingCplControlMode, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmMrpVlanID=hmMrpVlanID, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRpcOperState=hmRpcOperState, hmSrmTable=hmSrmTable, hmRingCplReconfig=hmRingCplReconfig, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRpcEntry=hmRpcEntry, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRingCplControlGroupID=hmRingCplControlGroupID, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRpcRingProtocol=hmRpcRingProtocol, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmSrmMaxInstances=hmSrmMaxInstances, hmSrmNodes=hmSrmNodes, PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingCplConfigOperState=hmRingCplConfigOperState)
