...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcEntry=hmRpcEntry, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingRedReconfig=hmRingRedReconfig, hmRpcRingProtocol=hmRpcRingProtocol, hmSrmOperState=hmSrmOperState, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingRedTable=hmRingRedTable, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRpcRingport2OperState=hmRpcRingport2OperState, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpVlanID=hmMrpVlanID, hmRingRedundancyEvent=hmRingRedundancyEvent, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingCplConfigSource=hmRingCplConfigSource, hmRpcRowStatus=hmRpcRowStatus, hmSrmReconfig=hmSrmReconfig, hmRingRedMode=hmRingRedMode, hmRpcVlanID=hmRpcVlanID, hmSrmRingID=hmSrmRingID, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingCplOperState=hmRingCplOperState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRpcNodes=hmRpcNodes, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpDomainID=hmMrpDomainID, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingCplControlMode=hmRingCplControlMode, hmMrpReconfig=hmMrpReconfig, hmRpcRingName=hmRpcRingName, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRingCplReconfig=hmRingCplReconfig, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRpcReconfig=hmRpcReconfig, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingRedOperState=hmRingRedOperState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRpcRingOperState=hmRpcRingOperState, hmSrmRingName=hmSrmRingName, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmSrmNodes=hmSrmNodes, hmMrpTable=hmMrpTable, hmMrpDomainName=hmMrpDomainName, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRingCplMode=hmRingCplMode, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpRowStatus=hmMrpRowStatus, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRingCouplingTable=hmRingCouplingTable, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpRedOperState=hmMrpRedOperState, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingCplConfigOperState=hmRingCplConfigOperState, hmSrmVlanID=hmSrmVlanID, hmRpcRingport1OperState=hmRpcRingport1OperState, hmSrmRowStatus=hmSrmRowStatus, hmMrpRingport1OperState=hmMrpRingport1OperState, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmAdminState=hmSrmAdminState, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRpcOperState=hmRpcOperState, hmRingRedEntry=hmRingRedEntry, hmRpcAdminState=hmRpcAdminState, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmSrmTable=hmSrmTable, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcTable=hmRpcTable, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRpcConfigOperState=hmRpcConfigOperState, hmSrmRingOperState=hmSrmRingOperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmMultiHiperRing=hmMultiHiperRing, hmRingRedundancy=hmRingRedundancy, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmSrmEntry=hmSrmEntry, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRpcRingID=hmRpcRingID, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpEntry=hmMrpEntry, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState)
