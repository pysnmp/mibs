...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcEntry=hmRpcEntry, hmMrpVlanID=hmMrpVlanID, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRpcRingProtocol=hmRpcRingProtocol, hmSrmRingID=hmSrmRingID, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingRedundancy=hmRingRedundancy, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmSrmAdminState=hmSrmAdminState, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRpcVlanID=hmRpcVlanID, hmMultiHiperRing=hmMultiHiperRing, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpMRMPriority=hmMrpMRMPriority, hmRingRedTable=hmRingRedTable, hmRpcRingOperState=hmRpcRingOperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCouplingTable=hmRingCouplingTable, hmRingCplMode=hmRingCplMode, hmSrmConfigOperState=hmSrmConfigOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRingRedEntry=hmRingRedEntry, hmSrmOperState=hmSrmOperState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingCplReconfig=hmRingCplReconfig, hmMrpReconfig=hmMrpReconfig, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpEntry=hmMrpEntry, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRpcRingName=hmRpcRingName, hmSrmTable=hmSrmTable, hmRingCplNetCoupling=hmRingCplNetCoupling, hmSrmVlanID=hmSrmVlanID, hmRingRedOperState=hmRingRedOperState, hmRpcOperState=hmRpcOperState, hmRingCplOperState=hmRingCplOperState, hmMrpRedOperState=hmMrpRedOperState, hmRpcConfigOperState=hmRpcConfigOperState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRingCplControlMode=hmRingCplControlMode, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmSrmRingOperState=hmSrmRingOperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpDomainName=hmMrpDomainName, hmRpcTable=hmRpcTable, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmSrmRingport1OperState=hmSrmRingport1OperState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmRowStatus=hmSrmRowStatus, hmRpcNodes=hmRpcNodes, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmSrmReconfig=hmSrmReconfig, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmSrmRingName=hmSrmRingName, hmRingRedundancyEvent=hmRingRedundancyEvent, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmMrpExpectedRole=hmMrpExpectedRole, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRpcReconfig=hmRpcReconfig, hmSrmNodes=hmSrmNodes, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingRedReconfig=hmRingRedReconfig, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpRowStatus=hmMrpRowStatus, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingRedMode=hmRingRedMode, hmRpcAdminState=hmRpcAdminState, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpDomainID=hmMrpDomainID, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcRingID=hmRpcRingID, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmSrmEntry=hmSrmEntry, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpTable=hmMrpTable)
