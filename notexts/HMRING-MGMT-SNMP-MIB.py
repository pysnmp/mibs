...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpTable=hmMrpTable, hmMrpReconfig=hmMrpReconfig, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCouplingTable=hmRingCouplingTable, hmSrmRingOperState=hmSrmRingOperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcReconfig=hmRpcReconfig, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmSrmRingport1OperState=hmSrmRingport1OperState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmSrmRingName=hmSrmRingName, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingCplControlGroupID=hmRingCplControlGroupID, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcRingName=hmRpcRingName, hmSrmRingID=hmSrmRingID, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpRowStatus=hmMrpRowStatus, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedConfigOperState=hmRingRedConfigOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcRingOperState=hmRpcRingOperState, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingRedEntry=hmRingRedEntry, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmSrmMaxInstances=hmSrmMaxInstances, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingRedMode=hmRingRedMode, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMrpDomainID=hmMrpDomainID, hmMrpExpectedRole=hmMrpExpectedRole, hmRingCplMode=hmRingCplMode, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRpcTable=hmRpcTable, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmSrmRingProtocol=hmSrmRingProtocol, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcOperState=hmRpcOperState, hmRingRedundancy=hmRingRedundancy, hmRpcRingProtocol=hmRpcRingProtocol, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmSrmTable=hmSrmTable, hmSrmNodes=hmSrmNodes, hmRpcRingID=hmRpcRingID, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpConfigOperState=hmMrpConfigOperState, hmSrmRowStatus=hmSrmRowStatus, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRMPriority=hmMrpMRMPriority, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplRowStatus=hmRingCplRowStatus, hmRpcNodes=hmRpcNodes, hmMrpVlanID=hmMrpVlanID, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRpcAdminState=hmRpcAdminState, hmMultiHiperRing=hmMultiHiperRing, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingCplOperState=hmRingCplOperState, hmRingCplControlMode=hmRingCplControlMode, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmMrpRedOperState=hmMrpRedOperState, hmSrmOperState=hmSrmOperState, hmMrpEntry=hmMrpEntry, hmSrmVlanID=hmSrmVlanID, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRpcEntry=hmRpcEntry, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRingCplReconfig=hmRingCplReconfig, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpDomainName=hmMrpDomainName, hmRpcVlanID=hmRpcVlanID, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmAdminState=hmSrmAdminState, hmRingRedReconfig=hmRingRedReconfig, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingRedOperState=hmRingRedOperState, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmSrmPartnerMAC=hmSrmPartnerMAC, hmSrmEntry=hmSrmEntry, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmReconfig=hmSrmReconfig, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingRedTable=hmRingRedTable)
