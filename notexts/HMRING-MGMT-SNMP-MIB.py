...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmSrmVlanID=hmSrmVlanID, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmRingID=hmSrmRingID, hmRpcAdminState=hmRpcAdminState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingCplReconfig=hmRingCplReconfig, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpVlanID=hmMrpVlanID, hmMrpDomainName=hmMrpDomainName, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCouplingTable=hmRingCouplingTable, hmSrmNodes=hmSrmNodes, hmRingRedReconfig=hmRingRedReconfig, hmMrpExpectedRole=hmMrpExpectedRole, hmMrpRedOperState=hmMrpRedOperState, hmMultiHiperRing=hmMultiHiperRing, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcVlanID=hmRpcVlanID, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpDomainID=hmMrpDomainID, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcRingOperState=hmRpcRingOperState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRpcRingName=hmRpcRingName, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmSrmRingName=hmSrmRingName, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingCplRowStatus=hmRingCplRowStatus, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmMrpTable=hmMrpTable, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmSrmRowStatus=hmSrmRowStatus, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingCplMode=hmRingCplMode, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmEntry=hmSrmEntry, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpMRMPriority=hmMrpMRMPriority, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpEntry=hmMrpEntry, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRpcRowStatus=hmRpcRowStatus, hmSrmReconfig=hmSrmReconfig, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRpcConfigOperState=hmRpcConfigOperState, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRingCplConfigOperState=hmRingCplConfigOperState, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcEntry=hmRpcEntry, hmRingRedTable=hmRingRedTable, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedOperState=hmRingRedOperState, hmRingCplControlMode=hmRingCplControlMode, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpReconfig=hmMrpReconfig, hmRingRedMode=hmRingRedMode, hmRingRedundancy=hmRingRedundancy, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRpcReconfig=hmRpcReconfig, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingID=hmRpcRingID, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingCplOperState=hmRingCplOperState, hmMrpRingport2OperState=hmMrpRingport2OperState, hmSrmAdminState=hmSrmAdminState, hmRingRedEntry=hmRingRedEntry, hmRpcTable=hmRpcTable, hmRpcNodes=hmRpcNodes, hmMrpRowStatus=hmMrpRowStatus, hmSrmMaxInstances=hmSrmMaxInstances, hmRpcRingProtocol=hmRpcRingProtocol, hmSrmTable=hmSrmTable, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmOperState=hmSrmOperState, hmSrmRingOperState=hmSrmRingOperState, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRpcOperState=hmRpcOperState)
