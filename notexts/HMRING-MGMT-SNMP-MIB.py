...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpRowStatus=hmMrpRowStatus, hmSrmNodes=hmSrmNodes, hmRingRedConfigOperState=hmRingRedConfigOperState, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedRedGroupID=hmRingRedRedGroupID, hmSrmVlanID=hmSrmVlanID, hmRingCplMode=hmRingCplMode, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmMrpDomainID=hmMrpDomainID, hmRingRedTable=hmRingRedTable, hmMrpTable=hmMrpTable, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCplControlMode=hmRingCplControlMode, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpDomainName=hmMrpDomainName, hmMultiHiperRing=hmMultiHiperRing, hmRpcRingOperState=hmRpcRingOperState, hmRpcAdminState=hmRpcAdminState, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpExpectedRole=hmMrpExpectedRole, hmRingRedMode=hmRingRedMode, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmRingID=hmSrmRingID, hmRingCplRowStatus=hmRingCplRowStatus, hmRingRedundancyEvent=hmRingRedundancyEvent, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpConfigOperState=hmMrpConfigOperState, hmMrpReconfig=hmMrpReconfig, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmSrmEntry=hmSrmEntry, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRpcReconfig=hmRpcReconfig, hmRpcRowStatus=hmRpcRowStatus, hmRingCouplingEntry=hmRingCouplingEntry, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingRedOperState=hmRingRedOperState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingRedEntry=hmRingRedEntry, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingCplOperState=hmRingCplOperState, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpRedOperState=hmMrpRedOperState, hmRpcRingID=hmRpcRingID, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRpcVlanID=hmRpcVlanID, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmSrmTable=hmSrmTable, hmRpcConfigOperState=hmRpcConfigOperState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcNodes=hmRpcNodes, hmRingRedundancy=hmRingRedundancy, hmRingCouplingTable=hmRingCouplingTable, hmRingRedReconfig=hmRingRedReconfig, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmSrmAdminState=hmSrmAdminState, hmSrmOperState=hmSrmOperState, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCplReconfig=hmRingCplReconfig, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpEntry=hmMrpEntry, hmRingCplControlGroupID=hmRingCplControlGroupID, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRpcEntry=hmRpcEntry, hmRpcRingName=hmRpcRingName, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmSrmRowStatus=hmSrmRowStatus, hmSrmRingProtocol=hmSrmRingProtocol, hmSrmPartnerMAC=hmSrmPartnerMAC, hmSrmReconfig=hmSrmReconfig, hmMrpMRMPriority=hmMrpMRMPriority, hmRpcRingport2OperState=hmRpcRingport2OperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmSrmRingOperState=hmSrmRingOperState, hmMrpVlanID=hmMrpVlanID, hmSrmRingName=hmSrmRingName, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRpcRingProtocol=hmRpcRingProtocol, hmRpcOperState=hmRpcOperState, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRpcTable=hmRpcTable)
