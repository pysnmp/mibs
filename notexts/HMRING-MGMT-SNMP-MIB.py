...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", PYSNMP_MODULE_ID=hmRingRedundancy, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRingRedEntry=hmRingRedEntry, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmSrmReconfig=hmSrmReconfig, hmSrmEntry=hmSrmEntry, hmMrpRingport2OperState=hmMrpRingport2OperState, hmSrmVlanID=hmSrmVlanID, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmMrpExpectedRole=hmMrpExpectedRole, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcAdminState=hmRpcAdminState, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingCplOperState=hmRingCplOperState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplReconfig=hmRingCplReconfig, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmRingName=hmSrmRingName, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmSrmNodes=hmSrmNodes, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpVlanID=hmMrpVlanID, hmRpcNodes=hmRpcNodes, hmRingCplControlMode=hmRingCplControlMode, hmMrpEntry=hmMrpEntry, hmRingRedTable=hmRingRedTable, hmMrpDomainName=hmMrpDomainName, hmRingRedReconfig=hmRingRedReconfig, hmRpcRingOperState=hmRpcRingOperState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingCplMode=hmRingCplMode, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRpcReconfig=hmRpcReconfig, hmMrpMRMPriority=hmMrpMRMPriority, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmRingRedOperState=hmRingRedOperState, hmSrmRingProtocol=hmSrmRingProtocol, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpRowStatus=hmMrpRowStatus, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRpcConfigOperState=hmRpcConfigOperState, hmRpcRowStatus=hmRpcRowStatus, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingRedMode=hmRingRedMode, hmSrmConfigOperState=hmSrmConfigOperState, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRpcRingName=hmRpcRingName, hmRpcOperState=hmRpcOperState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpReconfig=hmMrpReconfig, hmSrmOperState=hmSrmOperState, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmSrmRowStatus=hmSrmRowStatus, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRpcRingProtocol=hmRpcRingProtocol, hmRingCplConfigSource=hmRingCplConfigSource, hmRingRedRedGroupID=hmRingRedRedGroupID, hmMrpRedOperState=hmMrpRedOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRpcRingport1OperState=hmRpcRingport1OperState, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRpcRingID=hmRpcRingID, hmMrpTable=hmMrpTable, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmMrpConfigOperState=hmMrpConfigOperState, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRpcTable=hmRpcTable, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRingCplConfigOperState=hmRingCplConfigOperState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmSrmAdminState=hmSrmAdminState, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRpcEntry=hmRpcEntry, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmMrpDomainID=hmMrpDomainID, hmSrmTable=hmSrmTable, hmSrmRingID=hmSrmRingID, hmSrmRingOperState=hmSrmRingOperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMultiHiperRing=hmMultiHiperRing, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmSrmMaxInstances=hmSrmMaxInstances, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRpcVlanID=hmRpcVlanID, hmRingCouplingTable=hmRingCouplingTable, hmRingCouplingEntry=hmRingCouplingEntry, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRingRedundancy=hmRingRedundancy)
