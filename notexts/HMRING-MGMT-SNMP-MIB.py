...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmSrmNodes=hmSrmNodes, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRMPriority=hmMrpMRMPriority, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmSrmVlanID=hmSrmVlanID, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmRingRedMode=hmRingRedMode, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpReconfig=hmMrpReconfig, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmSrmTable=hmSrmTable, hmRpcRingID=hmRpcRingID, hmSrmRingProtocol=hmSrmRingProtocol, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcVlanID=hmRpcVlanID, hmSrmAdminState=hmSrmAdminState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRingCplControlMode=hmRingCplControlMode, hmRpcRingport1OperState=hmRpcRingport1OperState, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpDomainName=hmMrpDomainName, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRpcRowStatus=hmRpcRowStatus, hmRingCplMode=hmRingCplMode, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingRedTable=hmRingRedTable, hmRingCplOperState=hmRingCplOperState, hmMrpTable=hmMrpTable, hmMrpRowStatus=hmMrpRowStatus, hmSrmReconfig=hmSrmReconfig, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCplRowStatus=hmRingCplRowStatus, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRpcRingName=hmRpcRingName, hmMrpVlanID=hmMrpVlanID, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRpcEntry=hmRpcEntry, hmRpcReconfig=hmRpcReconfig, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRpcTable=hmRpcTable, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmSrmRingName=hmSrmRingName, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpExpectedRole=hmMrpExpectedRole, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcRingProtocol=hmRpcRingProtocol, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmSrmConfigOperState=hmSrmConfigOperState, hmSrmRowStatus=hmSrmRowStatus, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingCouplingTable=hmRingCouplingTable, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmMrpDomainID=hmMrpDomainID, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpRedOperState=hmMrpRedOperState, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmSrmRingOperState=hmSrmRingOperState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmSrmRingport1OperState=hmSrmRingport1OperState, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmSrmOperState=hmSrmOperState, hmRingRedReconfig=hmRingRedReconfig, hmRpcAdminState=hmRpcAdminState, hmRingCplReconfig=hmRingCplReconfig, hmRpcRingOperState=hmRpcRingOperState, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingRedEntry=hmRingRedEntry, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRpcOperState=hmRpcOperState, hmRingCplConfigSource=hmRingCplConfigSource, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmSrmEntry=hmSrmEntry, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmSrmMaxInstances=hmSrmMaxInstances, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingRedOperState=hmRingRedOperState, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRpcConfigOperState=hmRpcConfigOperState, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCouplingEntry=hmRingCouplingEntry, hmSrmRingID=hmSrmRingID, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmMrpEntry=hmMrpEntry, hmRpcNodes=hmRpcNodes, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRingRedundancy=hmRingRedundancy, hmMultiHiperRing=hmMultiHiperRing, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex)
