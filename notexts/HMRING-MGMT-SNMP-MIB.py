...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmSrmConfigOperState=hmSrmConfigOperState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmRingCplMode=hmRingCplMode, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpRowStatus=hmMrpRowStatus, hmSrmAdminState=hmSrmAdminState, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRpcConfigOperState=hmRpcConfigOperState, hmSrmRingName=hmSrmRingName, hmRingRedOperState=hmRingRedOperState, hmRingCouplingEntry=hmRingCouplingEntry, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRingCouplingTable=hmRingCouplingTable, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRingCplRowStatus=hmRingCplRowStatus, hmRingCplConfigSource=hmRingCplConfigSource, hmSrmMRPDomainID=hmSrmMRPDomainID, hmRpcRingID=hmRpcRingID, hmMrpMRMPriority=hmMrpMRMPriority, hmRingRedundancy=hmRingRedundancy, hmRingRedMode=hmRingRedMode, hmRpcRingName=hmRpcRingName, hmSrmPartnerMAC=hmSrmPartnerMAC, hmSrmEntry=hmSrmEntry, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRpcRingport2OperState=hmRpcRingport2OperState, hmSrmReconfig=hmSrmReconfig, hmMrpReconfig=hmMrpReconfig, hmRpcRingport1OperState=hmRpcRingport1OperState, hmSrmRingOperState=hmSrmRingOperState, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRpcOperState=hmRpcOperState, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcAdminState=hmRpcAdminState, hmSrmRingID=hmSrmRingID, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcReconfig=hmRpcReconfig, hmMrpTable=hmMrpTable, hmMrpDomainName=hmMrpDomainName, hmRingRedundancyEvent=hmRingRedundancyEvent, hmRpcVlanID=hmRpcVlanID, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRpcEntry=hmRpcEntry, hmRingCplReconfig=hmRingCplReconfig, hmMrpExpectedRole=hmMrpExpectedRole, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRpcTable=hmRpcTable, hmRingRedReconfig=hmRingRedReconfig, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmSrmRingProtocol=hmSrmRingProtocol, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRpcNodes=hmRpcNodes, hmMrpDomainID=hmMrpDomainID, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmRingCplNetCoupling=hmRingCplNetCoupling, hmMrpRingport1OperState=hmMrpRingport1OperState, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmRingRedEntry=hmRingRedEntry, hmRpcRingOperState=hmRpcRingOperState, hmMultiHiperRing=hmMultiHiperRing, hmSrmNodes=hmSrmNodes, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmSrmTable=hmSrmTable, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRingCplOperState=hmRingCplOperState, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmSrmOperState=hmSrmOperState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmSrmRowStatus=hmSrmRowStatus, hmSrmVlanID=hmSrmVlanID, hmMrpEntry=hmMrpEntry, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmSrmMaxInstances=hmSrmMaxInstances, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmMrpRedOperState=hmMrpRedOperState, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmRpcRowStatus=hmRpcRowStatus, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpVlanID=hmMrpVlanID, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRingCplControlMode=hmRingCplControlMode, hmRpcRingProtocol=hmRpcRingProtocol, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingRedTable=hmRingRedTable)
