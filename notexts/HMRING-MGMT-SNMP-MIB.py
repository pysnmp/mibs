...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmSrmTable=hmSrmTable, PYSNMP_MODULE_ID=hmRingRedundancy, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmSrmRingOperState=hmSrmRingOperState, hmMrpDomainID=hmMrpDomainID, hmRingRedundancy=hmRingRedundancy, hmRpcTable=hmRpcTable, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmSrmEntry=hmSrmEntry, hmSrmNodes=hmSrmNodes, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, hmMultiHiperRing=hmMultiHiperRing, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmMrpEntry=hmMrpEntry, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmRpcOperState=hmRpcOperState, hmRingCouplingTable=hmRingCouplingTable, hmMrpRowStatus=hmMrpRowStatus, hmRingCplReconfig=hmRingCplReconfig, hmRingCplConfigOperState=hmRingCplConfigOperState, hmMrpReconfig=hmMrpReconfig, hmRingRedConfigOperState=hmRingRedConfigOperState, hmSrmMaxInstances=hmSrmMaxInstances, hmSrmConfigOperState=hmSrmConfigOperState, hmMrpRingport2OperState=hmMrpRingport2OperState, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmSrmRingProtocol=hmSrmRingProtocol, hmRingRedTable=hmRingRedTable, hmSrmRingName=hmSrmRingName, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmRpcRingName=hmRpcRingName, hmSrmRingID=hmSrmRingID, hmRingRedReconfig=hmRingRedReconfig, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingRedMode=hmRingRedMode, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmSrmOperState=hmSrmOperState, hmMrpRedOperState=hmMrpRedOperState, hmSrmRowStatus=hmSrmRowStatus, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmSrmPartnerMAC=hmSrmPartnerMAC, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmRpcEntry=hmRpcEntry, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmSrmReconfig=hmSrmReconfig, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRpcNodes=hmRpcNodes, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRpcRowStatus=hmRpcRowStatus, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmRingRedRedGroupID=hmRingRedRedGroupID, hmRingCplRowStatus=hmRingCplRowStatus, hmRpcVlanID=hmRpcVlanID, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmMrpDomainName=hmMrpDomainName, hmRingRedEntry=hmRingRedEntry, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpMRMPriority=hmMrpMRMPriority, hmRingRedConfigChanged=hmRingRedConfigChanged, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmRingCouplingEntry=hmRingCouplingEntry, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmRpcRingID=hmRpcRingID, hmSrmVlanID=hmSrmVlanID, hmRpcReconfig=hmRpcReconfig, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRingRedOperState=hmRingRedOperState, hmSrmAdminState=hmSrmAdminState, hmRpcRingProtocol=hmRpcRingProtocol, hmRingCplMode=hmRingCplMode, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmMrpConfigOperState=hmMrpConfigOperState, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpTable=hmMrpTable, hmMrpVlanID=hmMrpVlanID, hmSrmMRPDomainID=hmSrmMRPDomainID, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRpcAdminState=hmRpcAdminState, hmRingRedundancyEvent=hmRingRedundancyEvent, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmRpcRingOperState=hmRpcRingOperState, hmRingCplControlMode=hmRingCplControlMode, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRingCplControlGroupID=hmRingCplControlGroupID, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRpcConfigOperState=hmRpcConfigOperState, hmRingCplOperState=hmRingCplOperState, hmRpcRingport1OperState=hmRpcRingport1OperState, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID)
