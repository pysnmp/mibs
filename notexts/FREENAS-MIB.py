...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, ObjectIdentity, Unsigned32, iso, Gauge32, IpAddress, MibIdentifier, Counter64, Bits, NotificationType, enterprises, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "Bits", "NotificationType", "enterprises", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("FREENAS-MIB", zfsZilstatOps10sec=zfsZilstatOps10sec, alertLevel=alertLevel, zpoolReadBytes=zpoolReadBytes, zpoolHealth=zpoolHealth, zfsArcCacheMissRatio=zfsArcCacheMissRatio, zvol=zvol, zfsZilstatOps1sec=zfsZilstatOps1sec, PYSNMP_MODULE_ID=freeNas, zfsArcC=zfsArcC, dataset=dataset, zpoolUsed=zpoolUsed, zpoolReadOps1sec=zpoolReadOps1sec, zvolSize=zvolSize, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zfsL2ArcSize=zfsL2ArcSize, zfsL2ArcHits=zfsL2ArcHits, zpoolTable=zpoolTable, zfsArcMissPercent=zfsArcMissPercent, zfsArcSize=zfsArcSize, zvolAllocationUnits=zvolAllocationUnits, zvolAvailable=zvolAvailable, zfsL2ArcWrite=zfsL2ArcWrite, zfs=zfs, notificationObjects=notificationObjects, zfsL2ArcRead=zfsL2ArcRead, zpoolDescr=zpoolDescr, zpoolEntry=zpoolEntry, zpoolReadOps=zpoolReadOps, zpoolWriteBytes=zpoolWriteBytes, datasetAvailable=datasetAvailable, zpoolWriteOps=zpoolWriteOps, alert=alert, datasetDescr=datasetDescr, datasetAllocationUnits=datasetAllocationUnits, zvolTable=zvolTable, zvolIndex=zvolIndex, freeNas=freeNas, zfsArcHits=zfsArcHits, alertMessage=alertMessage, zvolDescr=zvolDescr, zpool=zpool, AlertLevelType=AlertLevelType, zpoolWriteBytes1sec=zpoolWriteBytes1sec, datasetEntry=datasetEntry, zfsArcP=zfsArcP, alertId=alertId, notificationPrefix=notificationPrefix, zpoolSize=zpoolSize, zpoolAllocationUnits=zpoolAllocationUnits, datasetIndex=datasetIndex, datasetSize=datasetSize, zpoolAvailable=zpoolAvailable, zfsArcData=zfsArcData, zfsL2ArcMisses=zfsL2ArcMisses, zfsZilstatOps5sec=zfsZilstatOps5sec, ZPoolHealthType=ZPoolHealthType, notifications=notifications, arc=arc, zpoolReadBytes1sec=zpoolReadBytes1sec, zvolUsed=zvolUsed, zpoolWriteOps1sec=zpoolWriteOps1sec, zfsArcMeta=zfsArcMeta, datasetUsed=datasetUsed, datasetTable=datasetTable, zvolEntry=zvolEntry, alertCancellation=alertCancellation, zil=zil, zpoolIndex=zpoolIndex, zfsArcMisses=zfsArcMisses, l2arc=l2arc)
