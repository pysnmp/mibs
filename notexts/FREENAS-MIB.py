...
Counter32, Counter64, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, Gauge32, Bits, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("FREENAS-MIB", zpoolUsed=zpoolUsed, zpoolReadBytes=zpoolReadBytes, zpool=zpool, zfsArcData=zfsArcData, zpoolSize=zpoolSize, zfsArcP=zfsArcP, arc=arc, zfsL2ArcSize=zfsL2ArcSize, zfsArcHits=zfsArcHits, notificationObjects=notificationObjects, zil=zil, zpoolEntry=zpoolEntry, zpoolHealth=zpoolHealth, datasetTable=datasetTable, zfsL2ArcMisses=zfsL2ArcMisses, zfsZilstatOps5sec=zfsZilstatOps5sec, zpoolAvailable=zpoolAvailable, zvolAllocationUnits=zvolAllocationUnits, zpoolReadOps1sec=zpoolReadOps1sec, notificationPrefix=notificationPrefix, zvolSize=zvolSize, zfsArcMisses=zfsArcMisses, dataset=dataset, datasetSize=datasetSize, zpoolAllocationUnits=zpoolAllocationUnits, datasetAvailable=datasetAvailable, zfsArcMeta=zfsArcMeta, zpoolReadBytes1sec=zpoolReadBytes1sec, AlertLevelType=AlertLevelType, zpoolIndex=zpoolIndex, datasetDescr=datasetDescr, zvolEntry=zvolEntry, zvolIndex=zvolIndex, zfsArcSize=zfsArcSize, zfsArcCacheHitRatio=zfsArcCacheHitRatio, alertMessage=alertMessage, notifications=notifications, zfsArcC=zfsArcC, zpoolReadOps=zpoolReadOps, zfsL2ArcHits=zfsL2ArcHits, PYSNMP_MODULE_ID=freeNas, zfsL2ArcRead=zfsL2ArcRead, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zpoolDescr=zpoolDescr, zfsArcCacheMissRatio=zfsArcCacheMissRatio, zvolAvailable=zvolAvailable, alert=alert, zvolDescr=zvolDescr, zpoolWriteBytes=zpoolWriteBytes, zpoolWriteOps=zpoolWriteOps, datasetAllocationUnits=datasetAllocationUnits, freeNas=freeNas, datasetUsed=datasetUsed, zpoolWriteOps1sec=zpoolWriteOps1sec, datasetEntry=datasetEntry, zpoolTable=zpoolTable, alertId=alertId, zvolTable=zvolTable, zfsArcMissPercent=zfsArcMissPercent, zvolUsed=zvolUsed, zfs=zfs, zfsL2ArcWrite=zfsL2ArcWrite, zvol=zvol, ZPoolHealthType=ZPoolHealthType, alertLevel=alertLevel, l2arc=l2arc, datasetIndex=datasetIndex, alertCancellation=alertCancellation, zfsZilstatOps10sec=zfsZilstatOps10sec, zfsZilstatOps1sec=zfsZilstatOps1sec)
