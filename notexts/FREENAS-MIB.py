...
Integer32, IpAddress, TimeTicks, NotificationType, Gauge32, Bits, ObjectIdentity, Unsigned32, MibIdentifier, enterprises, ModuleIdentity, iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "TimeTicks", "NotificationType", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("FREENAS-MIB", zpool=zpool, zpoolUsed=zpoolUsed, zpoolHealth=zpoolHealth, zpoolDescr=zpoolDescr, datasetUsed=datasetUsed, zvolAvailable=zvolAvailable, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zfsArcP=zfsArcP, zfsZilstatOps1sec=zfsZilstatOps1sec, zvol=zvol, zvolIndex=zvolIndex, notifications=notifications, zfsL2ArcHits=zfsL2ArcHits, zpoolAllocationUnits=zpoolAllocationUnits, dataset=dataset, zpoolWriteBytes=zpoolWriteBytes, zvolDescr=zvolDescr, datasetAvailable=datasetAvailable, alertLevel=alertLevel, zfsL2ArcRead=zfsL2ArcRead, zfs=zfs, alertMessage=alertMessage, datasetIndex=datasetIndex, zfsArcSize=zfsArcSize, ZPoolHealthType=ZPoolHealthType, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zpoolWriteOps=zpoolWriteOps, alertCancellation=alertCancellation, zvolTable=zvolTable, zfsArcHits=zfsArcHits, datasetSize=datasetSize, zfsArcMissPercent=zfsArcMissPercent, zpoolEntry=zpoolEntry, AlertLevelType=AlertLevelType, zfsArcMisses=zfsArcMisses, zfsL2ArcMisses=zfsL2ArcMisses, zfsArcC=zfsArcC, arc=arc, zpoolReadBytes=zpoolReadBytes, zvolEntry=zvolEntry, zvolAllocationUnits=zvolAllocationUnits, alertId=alertId, datasetAllocationUnits=datasetAllocationUnits, zvolSize=zvolSize, zil=zil, datasetEntry=datasetEntry, zpoolReadOps1sec=zpoolReadOps1sec, zvolUsed=zvolUsed, zfsL2ArcSize=zfsL2ArcSize, zfsZilstatOps10sec=zfsZilstatOps10sec, zpoolIndex=zpoolIndex, zpoolAvailable=zpoolAvailable, alert=alert, zpoolWriteOps1sec=zpoolWriteOps1sec, zpoolSize=zpoolSize, PYSNMP_MODULE_ID=freeNas, zpoolTable=zpoolTable, datasetDescr=datasetDescr, zfsArcCacheMissRatio=zfsArcCacheMissRatio, zfsZilstatOps5sec=zfsZilstatOps5sec, notificationPrefix=notificationPrefix, notificationObjects=notificationObjects, datasetTable=datasetTable, freeNas=freeNas, zfsL2ArcWrite=zfsL2ArcWrite, zfsArcMeta=zfsArcMeta, zfsArcData=zfsArcData, zpoolReadBytes1sec=zpoolReadBytes1sec, l2arc=l2arc, zpoolReadOps=zpoolReadOps)
