...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter32, MibIdentifier, iso, ModuleIdentity, Gauge32, Integer32, ObjectIdentity, IpAddress, Bits, TimeTicks, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "Bits", "TimeTicks", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("FREENAS-MIB", zfsZilstatOps1sec=zfsZilstatOps1sec, zpoolReadOps=zpoolReadOps, datasetUsed=datasetUsed, zfsArcHits=zfsArcHits, alertMessage=alertMessage, zfsZilstatOps5sec=zfsZilstatOps5sec, zvolSize=zvolSize, zfsArcSize=zfsArcSize, zpoolReadOps1sec=zpoolReadOps1sec, PYSNMP_MODULE_ID=freeNas, zfsL2ArcMisses=zfsL2ArcMisses, alert=alert, zpoolWriteOps1sec=zpoolWriteOps1sec, zfsArcMissPercent=zfsArcMissPercent, zpoolIndex=zpoolIndex, zpool=zpool, zvolUsed=zvolUsed, notificationObjects=notificationObjects, zpoolTable=zpoolTable, zpoolAvailable=zpoolAvailable, zfsArcCacheMissRatio=zfsArcCacheMissRatio, datasetIndex=datasetIndex, freeNas=freeNas, zil=zil, arc=arc, zpoolWriteOps=zpoolWriteOps, ZPoolHealthType=ZPoolHealthType, zpoolHealth=zpoolHealth, datasetAllocationUnits=datasetAllocationUnits, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zvolDescr=zvolDescr, notifications=notifications, zpoolReadBytes=zpoolReadBytes, zpoolWriteBytes=zpoolWriteBytes, datasetEntry=datasetEntry, zvolAllocationUnits=zvolAllocationUnits, notificationPrefix=notificationPrefix, datasetSize=datasetSize, zfsArcC=zfsArcC, zfsArcData=zfsArcData, zvolIndex=zvolIndex, zfsL2ArcRead=zfsL2ArcRead, datasetAvailable=datasetAvailable, l2arc=l2arc, zfsArcMeta=zfsArcMeta, zfsL2ArcSize=zfsL2ArcSize, zpoolEntry=zpoolEntry, zvolAvailable=zvolAvailable, zpoolAllocationUnits=zpoolAllocationUnits, zpoolDescr=zpoolDescr, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zfsL2ArcHits=zfsL2ArcHits, zfsZilstatOps10sec=zfsZilstatOps10sec, datasetTable=datasetTable, dataset=dataset, alertId=alertId, alertCancellation=alertCancellation, zvolEntry=zvolEntry, zfs=zfs, zpoolUsed=zpoolUsed, zvol=zvol, zfsArcMisses=zfsArcMisses, zfsL2ArcWrite=zfsL2ArcWrite, zvolTable=zvolTable, zfsArcP=zfsArcP, datasetDescr=datasetDescr, alertLevel=alertLevel, zpoolSize=zpoolSize, zpoolReadBytes1sec=zpoolReadBytes1sec, AlertLevelType=AlertLevelType)
