...
ObjectIdentity, Gauge32, Unsigned32, NotificationType, Counter64, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Bits, iso, TimeTicks, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Bits", "iso", "TimeTicks", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("FREENAS-MIB", zfs=zfs, zpoolTable=zpoolTable, dataset=dataset, zfsArcCacheMissRatio=zfsArcCacheMissRatio, zpoolSize=zpoolSize, zpoolAllocationUnits=zpoolAllocationUnits, zpoolWriteOps1sec=zpoolWriteOps1sec, zfsL2ArcHits=zfsL2ArcHits, alertLevel=alertLevel, zpoolWriteBytes=zpoolWriteBytes, notifications=notifications, zvolSize=zvolSize, zfsArcMissPercent=zfsArcMissPercent, zpoolAvailable=zpoolAvailable, datasetAllocationUnits=datasetAllocationUnits, AlertLevelType=AlertLevelType, zfsArcP=zfsArcP, zvol=zvol, l2arc=l2arc, zfsZilstatOps5sec=zfsZilstatOps5sec, zpoolReadOps1sec=zpoolReadOps1sec, zvolAvailable=zvolAvailable, zpoolUsed=zpoolUsed, zpoolEntry=zpoolEntry, alertMessage=alertMessage, alert=alert, zpool=zpool, datasetSize=datasetSize, zvolIndex=zvolIndex, arc=arc, zfsArcMisses=zfsArcMisses, alertId=alertId, zfsArcHits=zfsArcHits, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zpoolDescr=zpoolDescr, zfsArcSize=zfsArcSize, zvolUsed=zvolUsed, zfsL2ArcRead=zfsL2ArcRead, zfsZilstatOps1sec=zfsZilstatOps1sec, freeNas=freeNas, notificationObjects=notificationObjects, zpoolReadOps=zpoolReadOps, zpoolReadBytes1sec=zpoolReadBytes1sec, zvolEntry=zvolEntry, datasetIndex=datasetIndex, zfsArcC=zfsArcC, zfsL2ArcSize=zfsL2ArcSize, zpoolWriteOps=zpoolWriteOps, zvolTable=zvolTable, zfsL2ArcWrite=zfsL2ArcWrite, alertCancellation=alertCancellation, datasetEntry=datasetEntry, zvolDescr=zvolDescr, zfsArcMeta=zfsArcMeta, datasetTable=datasetTable, ZPoolHealthType=ZPoolHealthType, datasetDescr=datasetDescr, zvolAllocationUnits=zvolAllocationUnits, zfsArcData=zfsArcData, zpoolIndex=zpoolIndex, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zpoolReadBytes=zpoolReadBytes, zfsZilstatOps10sec=zfsZilstatOps10sec, PYSNMP_MODULE_ID=freeNas, datasetAvailable=datasetAvailable, zpoolHealth=zpoolHealth, datasetUsed=datasetUsed, zil=zil, zfsL2ArcMisses=zfsL2ArcMisses, notificationPrefix=notificationPrefix)
