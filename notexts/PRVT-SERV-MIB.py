...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcLastMgmtChange=svcLastMgmtChange, svcAdminStatus=svcAdminStatus, sdpDescription=sdpDescription, prvtCustCreated=prvtCustCreated, sdpOperStatus=sdpOperStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapOperFlags=sapOperFlags, prvtTMSapGroups=prvtTMSapGroups, ServObjDesc=ServObjDesc, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcId=svcId, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSapStatusChanged=prvtSapStatusChanged, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpType=sdpType, svcVpnId=svcVpnId, prvtTMCustObjs=prvtTMCustObjs, prvtTMCustCompliance=prvtTMCustCompliance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSapCreated=prvtSapCreated, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLabelSignaling=sdpLabelSignaling, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpBindVlanTag=sdpBindVlanTag, prvtSdpCreated=prvtSdpCreated, prvtSvcNotif=prvtSvcNotif, sapDescription=sapDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpDelivery=sdpDelivery, prvtTMTstpConformance=prvtTMTstpConformance, sapBaseInfoEntry=sapBaseInfoEntry, svcType=svcType, sapPortId=sapPortId, sdpMtu=sdpMtu, sdpAdminStatus=sdpAdminStatus, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapOperStatus=sapOperStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpRowStatus=sdpRowStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEncapValue=sapEncapValue, prvtSapNotif=prvtSapNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, svcBaseInfoTable=svcBaseInfoTable, sdpOperFlags=sdpOperFlags, svcNumSdps=svcNumSdps, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpNumEntries=sdpNumEntries, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapBaseInfoTable=sapBaseInfoTable, sapLearnMode=sapLearnMode, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custInfoEntry=custInfoEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcRevertTimer=svcRevertTimer, ServiceOperStatus=ServiceOperStatus, ServObjName=ServObjName, sdpLastStatusChange=sdpLastStatusChange, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSapCompliances=prvtTMSapCompliances, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpLastMgmtChange=sdpLastMgmtChange, TSapEgrQueueId=TSapEgrQueueId, prvtTMSapConformance=prvtTMSapConformance, prvtServNotifications=prvtServNotifications, prvtTMServObjs=prvtTMServObjs, custEgrQosSchedName=custEgrQosSchedName, svcCustName=svcCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapNumEntries=sapNumEntries, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosSchedName=sapEgrQosSchedName, sdpTransportTunnelName=sdpTransportTunnelName, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtSdpDeleted=prvtSdpDeleted, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcLastStatusChange=svcLastStatusChange, custContact=custContact, prvtServicesMIB=prvtServicesMIB, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSvcTraps=prvtSvcTraps, sapIngQosSchedName=sapIngQosSchedName, prvtSdpStatusChanged=prvtSdpStatusChanged, sapAdminStatus=sapAdminStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, SdpIdType=SdpIdType, sdpLdpEnabled=sdpLdpEnabled, custLastMgmtChange=custLastMgmtChange, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSvcCreated=prvtSvcCreated, svcNumEntries=svcNumEntries, sdpInfoTable=sdpInfoTable, prvtSvcDeleted=prvtSvcDeleted, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpVCType=sdpVCType, svcVplsMode=svcVplsMode, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSvcCompliance=prvtTMSvcCompliance, PYSNMP_MODULE_ID=prvtServicesMIB, ServiceAdminStatus=ServiceAdminStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMSdpGroups=prvtTMSdpGroups, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapObjs=prvtTMSapObjs, prvtTMSdpConformance=prvtTMSdpConformance, sdpOutInterface=sdpOutInterface, sapRowStatus=sapRowStatus, svcMtu=svcMtu, sapType=sapType, prvtCustTraps=prvtCustTraps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, ServType=ServType, custRowStatus=custRowStatus, sapEgrQosQueueId=sapEgrQosQueueId, prvtSapTraps=prvtSapTraps, custInfoTable=custInfoTable, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcRowStatus=svcRowStatus, custName=custName, sapIngQosCustName=sapIngQosCustName, sdpId=sdpId, svcEnableSecureSaps=svcEnableSecureSaps, TMEncapVal=TMEncapVal, custPhone=custPhone, svcNumSaps=svcNumSaps, svcDescription=svcDescription, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSvcGroups=prvtTMSvcGroups, prvtCustNotif=prvtCustNotif, custIngQosSchedName=custIngQosSchedName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpOperIsBackup=sdpOperIsBackup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSdpNotif=prvtSdpNotif, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, VpnId=VpnId, sdpFarEndIpAddress=sdpFarEndIpAddress, sapLastMgmtChange=sapLastMgmtChange, TSapIngQueueId=TSapIngQueueId, prvtTMCustConformance=prvtTMCustConformance, custNumEntries=custNumEntries, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpInfoEntry=sdpInfoEntry, sapEgrQosCustName=sapEgrQosCustName, prvtSdpTraps=prvtSdpTraps, prvtSapDeleted=prvtSapDeleted, custMultSvcSiteName=custMultSvcSiteName, prvtTMServConformance=prvtTMServConformance, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets)
