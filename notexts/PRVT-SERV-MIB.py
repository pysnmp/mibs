...
TSapEgressPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMTstpConformance=prvtTMTstpConformance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustCompliances=prvtTMCustCompliances, sapNumEntries=sapNumEntries, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapBaseInfoEntry=sapBaseInfoEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpType=sdpType, sapEncapValue=sapEncapValue, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSdpNotif=prvtSdpNotif, sdpVCType=sdpVCType, sdpLdpEnabled=sdpLdpEnabled, svcNumSdps=svcNumSdps, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtServNotifications=prvtServNotifications, sapIngQosSchedCustName=sapIngQosSchedCustName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtCustNotif=prvtCustNotif, sapEgressQosPolicyId=sapEgressQosPolicyId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtServicesMIB=prvtServicesMIB, svcId=svcId, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSapNotif=prvtSapNotif, sapIngressQosPolicyId=sapIngressQosPolicyId, svcVpnId=svcVpnId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpInfoEntry=sdpInfoEntry, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcLastMgmtChange=svcLastMgmtChange, VpnId=VpnId, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSdpObjs=prvtTMSdpObjs, TMEncapVal=TMEncapVal, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSapCompliance=prvtTMSapCompliance, svcType=svcType, sapAdminStatus=sapAdminStatus, custPhone=custPhone, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapType=sapType, svcOperStatus=svcOperStatus, sdpDelivery=sdpDelivery, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, sapRowStatus=sapRowStatus, sdpInfoTable=sdpInfoTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, svcNumSaps=svcNumSaps, prvtCustTraps=prvtCustTraps, prvtTMSapObjs=prvtTMSapObjs, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosCustName=sapIngQosCustName, TSapIngQueueId=TSapIngQueueId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, custContact=custContact, svcRevertTimer=svcRevertTimer, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpBindVlanTag=sdpBindVlanTag, ServObjName=ServObjName, sdpAdminIsBackup=sdpAdminIsBackup, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSvcNotif=prvtSvcNotif, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpOutInterface=sdpOutInterface, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpRowStatus=sdpRowStatus, prvtSdpCreated=prvtSdpCreated, custMultSvcSiteName=custMultSvcSiteName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpNextFreeId=sdpNextFreeId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapOperStatus=sapOperStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSdpGroups=prvtTMSdpGroups, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSapTraps=prvtSapTraps, ServObjDesc=ServObjDesc, sapBaseInfoTable=sapBaseInfoTable, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpLabelSignaling=sdpLabelSignaling, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSvcObjs=prvtTMSvcObjs, SdpIdType=SdpIdType, sapIngQosQueueId=sapIngQosQueueId, svcMtu=svcMtu, prvtSapDeleted=prvtSapDeleted, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMCustCompliance=prvtTMCustCompliance, svcLastStatusChange=svcLastStatusChange, sapOperFlags=sapOperFlags, prvtCustCreated=prvtCustCreated, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSvcCompliance=prvtTMSvcCompliance, custNumEntries=custNumEntries, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcNumEntries=svcNumEntries, sdpNumEntries=sdpNumEntries, sdpAdminStatus=sdpAdminStatus, prvtTMSvcConformance=prvtTMSvcConformance, sdpId=sdpId, prvtTMServConformance=prvtTMServConformance, prvtTMCustObjs=prvtTMCustObjs, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, ServiceAdminStatus=ServiceAdminStatus, sapIngQosSchedName=sapIngQosSchedName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMServObjs=prvtTMServObjs, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpOperFlags=sdpOperFlags, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custInfoEntry=custInfoEntry, ServiceOperStatus=ServiceOperStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSapCreated=prvtSapCreated, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, ServType=ServType, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcDescription=svcDescription, custEgrQosSchedName=custEgrQosSchedName, svcVplsMode=svcVplsMode, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtSdpDeleted=prvtSdpDeleted, sdpLastStatusChange=sdpLastStatusChange, prvtTMCustGroups=prvtTMCustGroups, sdpLastMgmtChange=sdpLastMgmtChange, sapLastMgmtChange=sapLastMgmtChange, prvtSdpTraps=prvtSdpTraps, custInfoTable=custInfoTable, sapEgrQosCustName=sapEgrQosCustName, sdpTransportTunnelName=sdpTransportTunnelName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSvcCreated=prvtSvcCreated, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpMtu=sdpMtu, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgrQosQueueId=sapEgrQosQueueId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcRowStatus=svcRowStatus, svcEnableSecureSaps=svcEnableSecureSaps, custRowStatus=custRowStatus, sapDescription=sapDescription, svcCustName=svcCustName, prvtCustDeleted=prvtCustDeleted, prvtSvcDeleted=prvtSvcDeleted, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcBaseInfoTable=svcBaseInfoTable, sapLearnMode=sapLearnMode, sapPortId=sapPortId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custName=custName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSdpConformance=prvtTMSdpConformance, svcAdminStatus=svcAdminStatus, TSapEgrQueueId=TSapEgrQueueId, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSapGroups=prvtTMSapGroups, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpDescription=sdpDescription, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSdpStatusChanged=prvtSdpStatusChanged)
