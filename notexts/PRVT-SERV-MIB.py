...
TNamedItem, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty")
...
RowStatus, DisplayString, TimeStamp, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSapCompliances=prvtTMSapCompliances, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtCustTraps=prvtCustTraps, sapDescription=sapDescription, sapNumEntries=sapNumEntries, sdpLdpEnabled=sdpLdpEnabled, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpId=sdpId, prvtTMCustConformance=prvtTMCustConformance, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapOperStatus=sapOperStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpType=sdpType, sdpAdminStatus=sdpAdminStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcNumSaps=svcNumSaps, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapRowStatus=sapRowStatus, sapEgrQosCustName=sapEgrQosCustName, prvtTMCustGroups=prvtTMCustGroups, prvtTMCustCompliance=prvtTMCustCompliance, VpnId=VpnId, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSapObjs=prvtTMSapObjs, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSapConformance=prvtTMSapConformance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcBaseInfoTable=svcBaseInfoTable, prvtSvcNotif=prvtSvcNotif, prvtSapNotif=prvtSapNotif, prvtCustCreated=prvtCustCreated, custContact=custContact, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcType=svcType, sdpDelivery=sdpDelivery, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, ServObjName=ServObjName, sdpVCType=sdpVCType, prvtTMSapGroups=prvtTMSapGroups, custMultSvcSiteName=custMultSvcSiteName, sapPortId=sapPortId, ServiceOperStatus=ServiceOperStatus, prvtTMSdpObjs=prvtTMSdpObjs, sdpTransportTunnelName=sdpTransportTunnelName, prvtServicesMIB=prvtServicesMIB, sapBaseInfoTable=sapBaseInfoTable, svcNumEntries=svcNumEntries, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custEgrQosSchedName=custEgrQosSchedName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, SdpIdType=SdpIdType, sdpRowStatus=sdpRowStatus, svcVplsMode=svcVplsMode, sapLearnMode=sapLearnMode, prvtSapCreated=prvtSapCreated, TSapEgrQueueId=TSapEgrQueueId, sdpLastStatusChange=sdpLastStatusChange, prvtSvcTraps=prvtSvcTraps, sdpNextFreeId=sdpNextFreeId, prvtTMSdpGroups=prvtTMSdpGroups, prvtSapTraps=prvtSapTraps, svcId=svcId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custInfoTable=custInfoTable, sapOperFlags=sapOperFlags, prvtSapDeleted=prvtSapDeleted, sdpGroupIdentifier=sdpGroupIdentifier, custNumEntries=custNumEntries, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, svcRowStatus=svcRowStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, svcAdminStatus=svcAdminStatus, svcLastMgmtChange=svcLastMgmtChange, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcDeleted=prvtSvcDeleted, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpAdminIsBackup=sdpAdminIsBackup, sdpInfoEntry=sdpInfoEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpLabelSignaling=sdpLabelSignaling, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpInfoTable=sdpInfoTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, custLastMgmtChange=custLastMgmtChange, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpDescription=sdpDescription, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcMtu=svcMtu, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapLastMgmtChange=sapLastMgmtChange, prvtTMServConformance=prvtTMServConformance, sapAdminStatus=sapAdminStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpOperFlags=sdpOperFlags, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMServObjs=prvtTMServObjs, custRowStatus=custRowStatus, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedName=sapEgrQosSchedName, ServiceAdminStatus=ServiceAdminStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcVpnId=svcVpnId, prvtTMTstpConformance=prvtTMTstpConformance, svcOperStatus=svcOperStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custPhone=custPhone, prvtSdpDeleted=prvtSdpDeleted, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMCustObjs=prvtTMCustObjs, svcCustName=svcCustName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapBaseInfoEntry=sapBaseInfoEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMCustCompliances=prvtTMCustCompliances, sdpNumEntries=sdpNumEntries, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcRevertTimer=svcRevertTimer, TSapIngQueueId=TSapIngQueueId, custInfoEntry=custInfoEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, TMEncapVal=TMEncapVal, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcDescription=svcDescription, sdpMtu=sdpMtu, ServObjDesc=ServObjDesc, ServType=ServType, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpOperStatus=sdpOperStatus, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapType=sapType, svcBaseInfoEntry=svcBaseInfoEntry, PYSNMP_MODULE_ID=prvtServicesMIB, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpOperIsBackup=sdpOperIsBackup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSdpTraps=prvtSdpTraps, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultSvcSiteDescription=custMultSvcSiteDescription, svcLastStatusChange=svcLastStatusChange, prvtCustDeleted=prvtCustDeleted, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtCustNotif=prvtCustNotif, sapEgrQosQueueId=sapEgrQosQueueId, sdpOutInterface=sdpOutInterface, prvtSdpCreated=prvtSdpCreated, sdpBindVlanTag=sdpBindVlanTag, svcNumSdps=svcNumSdps, prvtSvcCreated=prvtSvcCreated, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custName=custName, custMultiServiceSiteTable=custMultiServiceSiteTable, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEncapValue=sapEncapValue, prvtTMSvcObjs=prvtTMSvcObjs)
