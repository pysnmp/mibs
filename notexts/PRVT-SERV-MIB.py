...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TNamedItem, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtServicesMIB=prvtServicesMIB, sdpAdminIsBackup=sdpAdminIsBackup, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSdpCreated=prvtSdpCreated, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpLastMgmtChange=sdpLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcOperStatus=svcOperStatus, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgressQosPolicyId=sapEgressQosPolicyId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custEgrQosSchedName=custEgrQosSchedName, prvtCustNotif=prvtCustNotif, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapLastMgmtChange=sapLastMgmtChange, svcLastMgmtChange=svcLastMgmtChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, ServType=ServType, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, ServObjName=ServObjName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMCustCompliance=prvtTMCustCompliance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMCustGroups=prvtTMCustGroups, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLabelSignaling=sdpLabelSignaling, custNumEntries=custNumEntries, custName=custName, sapType=sapType, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapBaseInfoEntry=sapBaseInfoEntry, custRowStatus=custRowStatus, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcRowStatus=svcRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtCustTraps=prvtCustTraps, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcLastStatusChange=svcLastStatusChange, prvtTMSapCompliance=prvtTMSapCompliance, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcDescription=svcDescription, prvtTMSdpConformance=prvtTMSdpConformance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMCustCompliances=prvtTMCustCompliances, prvtSvcCreated=prvtSvcCreated, sdpOperStatus=sdpOperStatus, prvtTMSapGroups=prvtTMSapGroups, sdpNumEntries=sdpNumEntries, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtSvcDeleted=prvtSvcDeleted, svcVplsMode=svcVplsMode, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSapNotif=prvtSapNotif, prvtTMTstpConformance=prvtTMTstpConformance, custInfoTable=custInfoTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpNextFreeId=sdpNextFreeId, svcId=svcId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpMtu=sdpMtu, sapLearnMode=sapLearnMode, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosCustName=sapEgrQosCustName, svcNumSaps=svcNumSaps, TSapIngQueueId=TSapIngQueueId, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custMultSvcSiteDescription=custMultSvcSiteDescription, svcNumEntries=svcNumEntries, prvtTMSapObjs=prvtTMSapObjs, svcBaseInfoEntry=svcBaseInfoEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpId=sdpId, custMultSvcSiteName=custMultSvcSiteName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSapConformance=prvtTMSapConformance, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpInfoEntry=sdpInfoEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosCustName=sapIngQosCustName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpLastStatusChange=sdpLastStatusChange, sapNumEntries=sapNumEntries, sapEgrQosSchedName=sapEgrQosSchedName, sdpTransportTunnelName=sdpTransportTunnelName, TMEncapVal=TMEncapVal, ServObjDesc=ServObjDesc, custLastMgmtChange=custLastMgmtChange, svcMtu=svcMtu, prvtCustDeleted=prvtCustDeleted, sapRowStatus=sapRowStatus, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueId=sapIngQosQueueId, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtCustCreated=prvtCustCreated, prvtSvcTraps=prvtSvcTraps, prvtSapTraps=prvtSapTraps, sdpRowStatus=sdpRowStatus, prvtTMSvcGroups=prvtTMSvcGroups, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, PYSNMP_MODULE_ID=prvtServicesMIB, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustConformance=prvtTMCustConformance, sdpType=sdpType, prvtSdpNotif=prvtSdpNotif, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpAdminStatus=sdpAdminStatus, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapBaseInfoTable=sapBaseInfoTable, custInfoEntry=custInfoEntry, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpOperIsBackup=sdpOperIsBackup, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSvcObjs=prvtTMSvcObjs, svcType=svcType, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcCustName=svcCustName, TSapEgrQueueId=TSapEgrQueueId, sdpDelivery=sdpDelivery, ServiceAdminStatus=ServiceAdminStatus, sapDescription=sapDescription, SdpIdType=SdpIdType, prvtTMCustObjs=prvtTMCustObjs, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMServConformance=prvtTMServConformance, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcRevertTimer=svcRevertTimer, sapEncapValue=sapEncapValue, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapPortId=sapPortId, prvtServNotifications=prvtServNotifications, prvtTMSdpCompliances=prvtTMSdpCompliances, sapOperStatus=sapOperStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpBindVlanTag=sdpBindVlanTag, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSvcNotif=prvtSvcNotif, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSapCreated=prvtSapCreated, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpInfoTable=sdpInfoTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosSchedName=sapIngQosSchedName, prvtTMSdpObjs=prvtTMSdpObjs, custPhone=custPhone, sapOperFlags=sapOperFlags, prvtSapStatusChanged=prvtSapStatusChanged, VpnId=VpnId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcNumSdps=svcNumSdps, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcVpnId=svcVpnId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpVCType=sdpVCType, sdpOutInterface=sdpOutInterface, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueId=sapEgrQosQueueId, sdpDescription=sdpDescription, svcBaseInfoTable=svcBaseInfoTable, svcAdminStatus=svcAdminStatus, custContact=custContact, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcEnableSecureSaps=svcEnableSecureSaps, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets)
