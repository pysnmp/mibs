...
TextualConvention, RowStatus, MacAddress, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "MacAddress", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceRowStatus=serviceRowStatus, sapLearnEnable=sapLearnEnable, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceVlanEtherType=serviceVlanEtherType, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpOperStatus=sdpOperStatus, sdpType=sdpType, serviceVlanAction=serviceVlanAction, sapEntry=sapEntry, serviceMacAddressSapPortId=serviceMacAddressSapPortId, customerEntry=customerEntry, PYSNMP_MODULE_ID=prvtServicesMIB, sapDeleted=sapDeleted, sapRowStatus=sapRowStatus, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, serviceRevertTimer=serviceRevertTimer, sapOperFlags=sapOperFlags, sapCreated=sapCreated, sdpId=sdpId, sdpEntry=sdpEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpLabelSignaling=sdpLabelSignaling, sdpOutInterface=sdpOutInterface, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sapUntaggedMode=sapUntaggedMode, serviceType=serviceType, sapEgressQosPolicyId=sapEgressQosPolicyId, customerName=customerName, serviceId=serviceId, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sapOperStatus=sapOperStatus, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpSecuredEnable=sdpSecuredEnable, sdpSignalPwStatus=sdpSignalPwStatus, serviceCreated=serviceCreated, serviceAdminStatus=serviceAdminStatus, prvtServicesMIB=prvtServicesMIB, sdpLdpEnabled=sdpLdpEnabled, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceLastMgmtChange=serviceLastMgmtChange, sdpCreated=sdpCreated, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapMacLearningProfileState=sapMacLearningProfileState, serviceTable=serviceTable, sapPortId=sapPortId, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpTransportTunnelName=sdpTransportTunnelName, customerPhone=customerPhone, sapDescription=sapDescription, sdpBindVlanTag=sdpBindVlanTag, sapTable=sapTable, sdpAdminEgressLabel=sdpAdminEgressLabel, customerContact=customerContact, serviceNumSdps=serviceNumSdps, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceMacAddressSapEntry=serviceMacAddressSapEntry, customerRowStatus=customerRowStatus, sdpAdminStatus=sdpAdminStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpGroupIdentifier=sdpGroupIdentifier, serviceNumSaps=serviceNumSaps, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sapLearnMode=sapLearnMode, sapCurrentMacCount=sapCurrentMacCount, serviceVpnId=serviceVpnId, sdpPwActivate=sdpPwActivate, customerTable=customerTable, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceDeleted=serviceDeleted, sapType=sapType, sdpPwPrecedence=sdpPwPrecedence, serviceEntry=serviceEntry, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceDescription=serviceDescription, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpOperFlags=sdpOperFlags, sapProfileName=sapProfileName, sdpDescription=sdpDescription, sdpDelivery=sdpDelivery, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sapEncapValue=sapEncapValue, customerCreated=customerCreated, serviceCustName=serviceCustName, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sdpPwRedundancyEnable=sdpPwRedundancyEnable, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceEnableSecureSaps=serviceEnableSecureSaps, sdpRowStatus=sdpRowStatus, sdpTable=sdpTable, sdpLearnEnable=sdpLearnEnable, sdpDeleted=sdpDeleted, serviceOperStatus=serviceOperStatus, sdpMtu=sdpMtu, serviceMtu=serviceMtu, customerDeleted=customerDeleted, sapAdminStatus=sapAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sdpVCType=sdpVCType, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sapLastMgmtChange=sapLastMgmtChange, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpNextFreeId=sdpNextFreeId)
