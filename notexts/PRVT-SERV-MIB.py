...
TNamedItem, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", ServType=ServType, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapBaseInfoTable=sapBaseInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMCustCompliance=prvtTMCustCompliance, sdpAdminStatus=sdpAdminStatus, prvtCustDeleted=prvtCustDeleted, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpOperFlags=sdpOperFlags, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpRowStatus=sdpRowStatus, sdpDescription=sdpDescription, svcNumEntries=svcNumEntries, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapBaseInfoEntry=sapBaseInfoEntry, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustCreated=prvtCustCreated, prvtSvcTraps=prvtSvcTraps, prvtTMSapCompliance=prvtTMSapCompliance, TMEncapVal=TMEncapVal, sapEncapValue=sapEncapValue, svcLastMgmtChange=svcLastMgmtChange, prvtSdpDeleted=prvtSdpDeleted, svcAdminStatus=svcAdminStatus, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSdpConformance=prvtTMSdpConformance, sdpAdminEgressLabel=sdpAdminEgressLabel, VpnId=VpnId, ServObjName=ServObjName, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSapNotif=prvtSapNotif, custRowStatus=custRowStatus, custIngQosSchedName=custIngQosSchedName, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapDescription=sapDescription, custLastMgmtChange=custLastMgmtChange, prvtTMSapCompliances=prvtTMSapCompliances, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcDescription=svcDescription, svcOperStatus=svcOperStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcRowStatus=svcRowStatus, prvtTMSapConformance=prvtTMSapConformance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpDelivery=sdpDelivery, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtCustTraps=prvtCustTraps, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcGroups=prvtTMSvcGroups, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custContact=custContact, svcLastStatusChange=svcLastStatusChange, TSapIngQueueId=TSapIngQueueId, prvtSapTraps=prvtSapTraps, sdpBindVlanTag=sdpBindVlanTag, custMultSvcSiteName=custMultSvcSiteName, sapOperFlags=sapOperFlags, sdpInfoEntry=sdpInfoEntry, sdpGroupIdentifier=sdpGroupIdentifier, svcRevertTimer=svcRevertTimer, prvtTMSdpCompliance=prvtTMSdpCompliance, svcBaseInfoTable=svcBaseInfoTable, sdpMtu=sdpMtu, svcVplsMode=svcVplsMode, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMTstpConformance=prvtTMTstpConformance, svcVpnId=svcVpnId, sapLearnMode=sapLearnMode, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSdpObjs=prvtTMSdpObjs, ServiceOperStatus=ServiceOperStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpOutInterface=sdpOutInterface, prvtTMSapObjs=prvtTMSapObjs, prvtTMServConformance=prvtTMServConformance, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtSvcCreated=prvtSvcCreated, ServiceAdminStatus=ServiceAdminStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpOperIsBackup=sdpOperIsBackup, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSdpNotif=prvtSdpNotif, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, sapNumEntries=sapNumEntries, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpInfoTable=sdpInfoTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcId=svcId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcEnableSecureSaps=svcEnableSecureSaps, prvtSvcDeleted=prvtSvcDeleted, sapIngQosSchedName=sapIngQosSchedName, prvtTMCustConformance=prvtTMCustConformance, custInfoEntry=custInfoEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpId=sdpId, custMultSvcSiteDescription=custMultSvcSiteDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpLdpEnabled=sdpLdpEnabled, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosSchedName=custEgrQosSchedName, prvtTMSapGroups=prvtTMSapGroups, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpNumEntries=sdpNumEntries, svcMtu=svcMtu, sapType=sapType, sapEgrQosQueueId=sapEgrQosQueueId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, PYSNMP_MODULE_ID=prvtServicesMIB, sdpLastStatusChange=sdpLastStatusChange, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcNumSdps=svcNumSdps, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustGroups=prvtTMCustGroups, sapLastMgmtChange=sapLastMgmtChange, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSapCreated=prvtSapCreated, custPhone=custPhone, sapRowStatus=sapRowStatus, prvtCustNotif=prvtCustNotif, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtServNotifications=prvtServNotifications, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, ServObjDesc=ServObjDesc, sdpLastMgmtChange=sdpLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcType=svcType, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpNextFreeId=sdpNextFreeId, sapEgrQosCustName=sapEgrQosCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSdpCreated=prvtSdpCreated, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpVCType=sdpVCType, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapAdminStatus=sapAdminStatus, prvtTMCustObjs=prvtTMCustObjs, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSapDeleted=prvtSapDeleted, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpTransportTunnelName=sdpTransportTunnelName, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpAdminIsBackup=sdpAdminIsBackup, sapPortId=sapPortId, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtServicesMIB=prvtServicesMIB, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custName=custName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custInfoTable=custInfoTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, TSapEgrQueueId=TSapEgrQueueId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, SdpIdType=SdpIdType, sapOperStatus=sapOperStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMServObjs=prvtTMServObjs, custNumEntries=custNumEntries, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpType=sdpType, svcCustName=svcCustName, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets)
