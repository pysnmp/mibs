...
TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpNextFreeId=sdpNextFreeId, custPhone=custPhone, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custRowStatus=custRowStatus, prvtSvcDeleted=prvtSvcDeleted, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapConformance=prvtTMSapConformance, sdpOperFlags=sdpOperFlags, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, TMEncapVal=TMEncapVal, svcLastStatusChange=svcLastStatusChange, svcVplsMode=svcVplsMode, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpVCType=sdpVCType, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosCustName=sapIngQosCustName, sapOperFlags=sapOperFlags, sdpAdminIsBackup=sdpAdminIsBackup, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpAdminIngressLabel=sdpAdminIngressLabel, ServiceOperStatus=ServiceOperStatus, sapOperStatus=sapOperStatus, SdpIdType=SdpIdType, svcRowStatus=svcRowStatus, prvtServicesMIB=prvtServicesMIB, svcOperStatus=svcOperStatus, prvtServNotifications=prvtServNotifications, svcBaseInfoTable=svcBaseInfoTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, ServObjName=ServObjName, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, sapEncapValue=sapEncapValue, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custName=custName, ServObjDesc=ServObjDesc, prvtCustCreated=prvtCustCreated, sapNumEntries=sapNumEntries, prvtSdpTraps=prvtSdpTraps, svcMtu=svcMtu, sdpDelivery=sdpDelivery, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSapCreated=prvtSapCreated, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosSchedName=sapIngQosSchedName, svcLastMgmtChange=svcLastMgmtChange, sapLearnMode=sapLearnMode, sapEgrQosSchedName=sapEgrQosSchedName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custNumEntries=custNumEntries, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueId=sapIngQosQueueId, sdpInfoTable=sdpInfoTable, svcType=svcType, custInfoEntry=custInfoEntry, prvtCustDeleted=prvtCustDeleted, prvtSdpCreated=prvtSdpCreated, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSvcGroups=prvtTMSvcGroups, sapBaseInfoTable=sapBaseInfoTable, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteName=custMultSvcSiteName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMServConformance=prvtTMServConformance, prvtTMServObjs=prvtTMServObjs, svcAdminStatus=svcAdminStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtCustNotif=prvtCustNotif, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSapObjs=prvtTMSapObjs, TSapIngQueueId=TSapIngQueueId, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMCustGroups=prvtTMCustGroups, custLastMgmtChange=custLastMgmtChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpLdpEnabled=sdpLdpEnabled, prvtSvcNotif=prvtSvcNotif, prvtSapStatusChanged=prvtSapStatusChanged, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtCustTraps=prvtCustTraps, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpOperIsBackup=sdpOperIsBackup, sapPortId=sapPortId, prvtTMCustObjs=prvtTMCustObjs, ServType=ServType, custContact=custContact, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpOperStatus=sdpOperStatus, sdpType=sdpType, svcVPLSUplinkTable=svcVPLSUplinkTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcDescription=svcDescription, sapAdminStatus=sapAdminStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpDescription=sdpDescription, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpGroupIdentifier=sdpGroupIdentifier, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpBindVlanTag=sdpBindVlanTag, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueId=sapEgrQosQueueId, sdpNumEntries=sdpNumEntries, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMCustCompliance=prvtTMCustCompliance, sdpFarEndIpAddress=sdpFarEndIpAddress, sapRowStatus=sapRowStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcNumSaps=svcNumSaps, svcNumSdps=svcNumSdps, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpConformance=prvtTMSdpConformance, prvtSvcCreated=prvtSvcCreated, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtSdpStatusChanged=prvtSdpStatusChanged, svcRevertTimer=svcRevertTimer, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSdpNotif=prvtSdpNotif, VpnId=VpnId, prvtTMSvcCompliance=prvtTMSvcCompliance, svcVpnId=svcVpnId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtSapNotif=prvtSapNotif, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapDescription=sapDescription, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custInfoTable=custInfoTable, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpRowStatus=sdpRowStatus, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcNumEntries=svcNumEntries, sdpOutInterface=sdpOutInterface, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSvcObjs=prvtTMSvcObjs, prvtSvcTraps=prvtSvcTraps, prvtSapTraps=prvtSapTraps, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustConformance=prvtTMCustConformance, sapType=sapType, sdpLabelSignaling=sdpLabelSignaling, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpInfoEntry=sdpInfoEntry, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, svcCustName=svcCustName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSapGroups=prvtTMSapGroups, sdpMtu=sdpMtu, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosSchedName=custEgrQosSchedName, PYSNMP_MODULE_ID=prvtServicesMIB, svcId=svcId, custIngQosSchedName=custIngQosSchedName, sdpId=sdpId)
