...
RowStatus, TruthValue, MacAddress, DisplayString, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "MacAddress", "DisplayString", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapLearnEnable=sapLearnEnable, sapDeleted=sapDeleted, sapMacLearningProfileState=sapMacLearningProfileState, sdpVCType=sdpVCType, prvtServicesMIB=prvtServicesMIB, sapLastMgmtChange=sapLastMgmtChange, sapTable=sapTable, serviceType=serviceType, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpOperStatus=sdpOperStatus, sapEntry=sapEntry, sdpOperFlags=sdpOperFlags, customerContact=customerContact, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpTransportTunnelName=sdpTransportTunnelName, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpId=sdpId, serviceOperStatus=serviceOperStatus, serviceNumSaps=serviceNumSaps, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapIngressQosPolicyId=sapIngressQosPolicyId, customerRowStatus=customerRowStatus, serviceMtu=serviceMtu, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpLearnEnable=sdpLearnEnable, customerTable=customerTable, sapLearnMode=sapLearnMode, sdpLastMgmtChange=sdpLastMgmtChange, sdpDescription=sdpDescription, sdpAdminStatus=sdpAdminStatus, sdpPwPrecedence=sdpPwPrecedence, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceCreated=serviceCreated, sdpPwActivate=sdpPwActivate, sapOperStatus=sapOperStatus, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, customerName=customerName, sapCurrentMacCount=sapCurrentMacCount, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sapUntaggedMode=sapUntaggedMode, sdpSecuredEnable=sdpSecuredEnable, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, serviceId=serviceId, serviceVlanAction=serviceVlanAction, sdpDelivery=sdpDelivery, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, serviceEntry=serviceEntry, sdpMtu=sdpMtu, sapDescription=sapDescription, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapOperFlags=sapOperFlags, serviceDeleted=serviceDeleted, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceVlanEtherType=serviceVlanEtherType, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpRowStatus=sdpRowStatus, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceNumSdps=serviceNumSdps, serviceDescription=serviceDescription, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpCreated=sdpCreated, sapType=sapType, sapRowStatus=sapRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, serviceRevertTimer=serviceRevertTimer, sdpLdpEnabled=sdpLdpEnabled, sdpEntry=sdpEntry, sapEncapValue=sapEncapValue, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, customerEntry=customerEntry, sapPortId=sapPortId, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpLabelSignaling=sdpLabelSignaling, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpTable=sdpTable, customerPhone=customerPhone, sdpOutInterface=sdpOutInterface, customerCreated=customerCreated, serviceVpnId=serviceVpnId, sapAdminStatus=sapAdminStatus, sdpBindVlanTag=sdpBindVlanTag, serviceCustName=serviceCustName, serviceTable=serviceTable, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceAdminStatus=serviceAdminStatus, PYSNMP_MODULE_ID=prvtServicesMIB, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceMacAddressSdpId=serviceMacAddressSdpId, sapCreated=sapCreated, sdpSignalPwStatus=sdpSignalPwStatus, sdpNextFreeId=sdpNextFreeId, customerDeleted=customerDeleted, sdpDeleted=sdpDeleted, serviceLastMgmtChange=serviceLastMgmtChange, sapProfileName=sapProfileName, sdpType=sdpType, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceRowStatus=serviceRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceMacAddressSapEntry=serviceMacAddressSapEntry)
