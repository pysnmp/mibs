...
TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSdpGroups=prvtTMSdpGroups, sdpId=sdpId, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustCompliance=prvtTMCustCompliance, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapEgrQosCustName=sapEgrQosCustName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtCustCreated=prvtCustCreated, svcLastMgmtChange=svcLastMgmtChange, sdpNumEntries=sdpNumEntries, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpInfoTable=sdpInfoTable, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custContact=custContact, svcNumEntries=svcNumEntries, sdpLastMgmtChange=sdpLastMgmtChange, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngressQosPolicyId=sapIngressQosPolicyId, TSapIngQueueId=TSapIngQueueId, prvtTMCustGroups=prvtTMCustGroups, sdpBindVlanTag=sdpBindVlanTag, sapOperFlags=sapOperFlags, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtServNotifications=prvtServNotifications, prvtTMSvcObjs=prvtTMSvcObjs, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpRowStatus=sdpRowStatus, svcVplsMode=svcVplsMode, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, ServType=ServType, sapPortId=sapPortId, svcCustName=svcCustName, TMEncapVal=TMEncapVal, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueId=sapIngQosQueueId, sapOperStatus=sapOperStatus, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpObjs=prvtTMSdpObjs, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpOperFlags=sdpOperFlags, prvtCustNotif=prvtCustNotif, custPhone=custPhone, sapEgrQosQueueId=sapEgrQosQueueId, sdpOperIsBackup=sdpOperIsBackup, sdpMtu=sdpMtu, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMServObjs=prvtTMServObjs, prvtSdpNotif=prvtSdpNotif, svcBaseInfoEntry=svcBaseInfoEntry, sapLastMgmtChange=sapLastMgmtChange, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosSchedName=custEgrQosSchedName, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpTransportTunnelName=sdpTransportTunnelName, prvtCustTraps=prvtCustTraps, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMTstpConformance=prvtTMTstpConformance, ServiceOperStatus=ServiceOperStatus, prvtTMSdpConformance=prvtTMSdpConformance, sdpDescription=sdpDescription, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcMtu=svcMtu, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgrQosSchedName=sapEgrQosSchedName, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSapTraps=prvtSapTraps, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMServConformance=prvtTMServConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpInfoEntry=sdpInfoEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSapNotif=prvtSapNotif, prvtTMCustObjs=prvtTMCustObjs, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtServicesMIB=prvtServicesMIB, svcType=svcType, custRowStatus=custRowStatus, sapLearnMode=sapLearnMode, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpDelivery=sdpDelivery, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcId=svcId, svcLastStatusChange=svcLastStatusChange, sapBaseInfoTable=sapBaseInfoTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSapCompliances=prvtTMSapCompliances, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosCustName=sapIngQosCustName, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpLabelSignaling=sdpLabelSignaling, sdpNextFreeId=sdpNextFreeId, sdpType=sdpType, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custNumEntries=custNumEntries, prvtSvcNotif=prvtSvcNotif, svcRowStatus=svcRowStatus, sdpAdminStatus=sdpAdminStatus, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpVCType=sdpVCType, svcNumSdps=svcNumSdps, sdpOutInterface=sdpOutInterface, prvtSapCreated=prvtSapCreated, sdpLastStatusChange=sdpLastStatusChange, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpGroupIdentifier=sdpGroupIdentifier, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSvcCreated=prvtSvcCreated, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpOperStatus=sdpOperStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtCustDeleted=prvtCustDeleted, svcOperStatus=svcOperStatus, custMultSvcSiteName=custMultSvcSiteName, ServObjDesc=ServObjDesc, sapDescription=sapDescription, prvtTMSvcConformance=prvtTMSvcConformance, prvtSvcTraps=prvtSvcTraps, VpnId=VpnId, prvtTMSapGroups=prvtTMSapGroups, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtSvcDeleted=prvtSvcDeleted, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSdpDeleted=prvtSdpDeleted, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSdpCreated=prvtSdpCreated, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custInfoEntry=custInfoEntry, svcRevertTimer=svcRevertTimer, SdpIdType=SdpIdType, sapNumEntries=sapNumEntries, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedName=sapIngQosSchedName, prvtTMCustConformance=prvtTMCustConformance, svcEnableSecureSaps=svcEnableSecureSaps, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapRowStatus=sapRowStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custName=custName, svcAdminStatus=svcAdminStatus, svcBaseInfoTable=svcBaseInfoTable, ServObjName=ServObjName, svcDescription=svcDescription, svcNumSaps=svcNumSaps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEncapValue=sapEncapValue, ServiceAdminStatus=ServiceAdminStatus, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSdpTraps=prvtSdpTraps, custInfoTable=custInfoTable, sapType=sapType, svcVpnId=svcVpnId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpAdminIsBackup=sdpAdminIsBackup)
