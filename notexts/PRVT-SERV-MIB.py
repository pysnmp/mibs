...
TNamedItem, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpNumEntries=sdpNumEntries, prvtSdpCreated=prvtSdpCreated, svcRowStatus=svcRowStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServConformance=prvtTMServConformance, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteName=custMultSvcSiteName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, prvtTMSapCompliances=prvtTMSapCompliances, svcVpnId=svcVpnId, sdpOutInterface=sdpOutInterface, ServObjDesc=ServObjDesc, prvtSapTraps=prvtSapTraps, sapDescription=sapDescription, svcAdminStatus=svcAdminStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapBaseInfoEntry=sapBaseInfoEntry, prvtCustDeleted=prvtCustDeleted, prvtTMCustObjs=prvtTMCustObjs, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, TSapIngQueueId=TSapIngQueueId, svcBaseInfoTable=svcBaseInfoTable, sdpNextFreeId=sdpNextFreeId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpId=sdpId, custName=custName, sdpRowStatus=sdpRowStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapBaseInfoTable=sapBaseInfoTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpInfoEntry=sdpInfoEntry, svcVplsMode=svcVplsMode, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcCustName=svcCustName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpOperFlags=sdpOperFlags, sapLearnMode=sapLearnMode, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpFarEndIpAddress=sdpFarEndIpAddress, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtSvcTraps=prvtSvcTraps, prvtSdpTraps=prvtSdpTraps, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcOperStatus=svcOperStatus, svcRevertTimer=svcRevertTimer, prvtServNotifications=prvtServNotifications, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpType=sdpType, prvtCustNotif=prvtCustNotif, prvtSdpDeleted=prvtSdpDeleted, prvtSapNotif=prvtSapNotif, custRowStatus=custRowStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, custInfoEntry=custInfoEntry, custLastMgmtChange=custLastMgmtChange, svcType=svcType, sapIngQosSchedCustName=sapIngQosSchedCustName, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMCustConformance=prvtTMCustConformance, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapLastMgmtChange=sapLastMgmtChange, sdpLabelSignaling=sdpLabelSignaling, prvtTMSapObjs=prvtTMSapObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSvcConformance=prvtTMSvcConformance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custContact=custContact, prvtCustCreated=prvtCustCreated, svcMtu=svcMtu, sapOperStatus=sapOperStatus, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMTstpConformance=prvtTMTstpConformance, svcBaseInfoEntry=svcBaseInfoEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custPhone=custPhone, svcDescription=svcDescription, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custMultSvcSiteDescription=custMultSvcSiteDescription, VpnId=VpnId, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custInfoTable=custInfoTable, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcNumSdps=svcNumSdps, prvtSapCreated=prvtSapCreated, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosQueueId=sapEgrQosQueueId, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpVCType=sdpVCType, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServiceAdminStatus=ServiceAdminStatus, svcNumEntries=svcNumEntries, custNumEntries=custNumEntries, sapOperFlags=sapOperFlags, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapPortId=sapPortId, sdpBindVlanTag=sdpBindVlanTag, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpLastMgmtChange=sdpLastMgmtChange, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMCustCompliances=prvtTMCustCompliances, sdpDelivery=sdpDelivery, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcNumSaps=svcNumSaps, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSapStatusChanged=prvtSapStatusChanged, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSdpObjs=prvtTMSdpObjs, prvtSvcDeleted=prvtSvcDeleted, sapEncapValue=sapEncapValue, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcEnableSecureSaps=svcEnableSecureSaps, sapAdminStatus=sapAdminStatus, SdpIdType=SdpIdType, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpLdpEnabled=sdpLdpEnabled, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMCustGroups=prvtTMCustGroups, sdpAdminIsBackup=sdpAdminIsBackup, sapIngQosCustName=sapIngQosCustName, TMEncapVal=TMEncapVal, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosSchedName=custIngQosSchedName, sapIngQosSchedName=sapIngQosSchedName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSapDeleted=prvtSapDeleted, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcId=svcId, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosCustName=sapEgrQosCustName, prvtTMCustCompliance=prvtTMCustCompliance, sapType=sapType, svcLastStatusChange=svcLastStatusChange, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpMtu=sdpMtu, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpDescription=sdpDescription, custEgrQosSchedName=custEgrQosSchedName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpInfoTable=sdpInfoTable, prvtSdpNotif=prvtSdpNotif, ServObjName=ServObjName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMServObjs=prvtTMServObjs, sapNumEntries=sapNumEntries, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtServicesMIB=prvtServicesMIB, sdpGroupIdentifier=sdpGroupIdentifier, prvtSvcNotif=prvtSvcNotif, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpAdminStatus=sdpAdminStatus, ServType=ServType, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapRowStatus=sapRowStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapGroups=prvtTMSapGroups, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup)
