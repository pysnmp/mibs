...
serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcOperStatus=svcOperStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcType=svcType, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpOperFlags=sdpOperFlags, sdpDescription=sdpDescription, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcNumEntries=svcNumEntries, prvtTMSvcObjs=prvtTMSvcObjs, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSvcCompliances=prvtTMSvcCompliances, svcId=svcId, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpNumEntries=sdpNumEntries, prvtTMCustGroups=prvtTMCustGroups, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMCustObjs=prvtTMCustObjs, svcRevertTimer=svcRevertTimer, prvtSvcDeleted=prvtSvcDeleted, prvtTMSvcConformance=prvtTMSvcConformance, prvtSdpStatusChanged=prvtSdpStatusChanged, svcNumSdps=svcNumSdps, sapEncapValue=sapEncapValue, sapType=sapType, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosCustName=sapIngQosCustName, custInfoTable=custInfoTable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosSchedName=sapIngQosSchedName, svcNumSaps=svcNumSaps, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSapNotif=prvtSapNotif, custNumEntries=custNumEntries, ServiceOperStatus=ServiceOperStatus, custMultSvcSiteName=custMultSvcSiteName, sdpType=sdpType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcGroups=prvtTMSvcGroups, svcVpnId=svcVpnId, sapPortId=sapPortId, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpFarEndIpAddress=sdpFarEndIpAddress, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, TSapEgrQueueId=TSapEgrQueueId, sdpOperStatus=sdpOperStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcEnableSecureSaps=svcEnableSecureSaps, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, SdpIdType=SdpIdType, sapRowStatus=sapRowStatus, prvtSapTraps=prvtSapTraps, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcCustName=svcCustName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSdpGroups=prvtTMSdpGroups, ServiceAdminStatus=ServiceAdminStatus, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpInfoTable=sdpInfoTable, sdpAdminStatus=sdpAdminStatus, ServType=ServType, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueId=sapIngQosQueueId, prvtSdpTraps=prvtSdpTraps, custIngQosSchedName=custIngQosSchedName, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpVCType=sdpVCType, sdpNextFreeId=sdpNextFreeId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVplsMode=svcVplsMode, prvtServNotifications=prvtServNotifications, prvtTMSapObjs=prvtTMSapObjs, custPhone=custPhone, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtSapDeleted=prvtSapDeleted, prvtSapCreated=prvtSapCreated, sapDescription=sapDescription, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtSdpCreated=prvtSdpCreated, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSapCompliances=prvtTMSapCompliances, prvtSvcNotif=prvtSvcNotif, prvtCustNotif=prvtCustNotif, prvtTMTstpConformance=prvtTMTstpConformance, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpDelivery=sdpDelivery, prvtTMSdpObjs=prvtTMSdpObjs, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSdpDeleted=prvtSdpDeleted, sapNumEntries=sapNumEntries, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcMtu=svcMtu, ServObjDesc=ServObjDesc, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpId=sdpId, custName=custName, sapBaseInfoEntry=sapBaseInfoEntry, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcDescription=svcDescription, sapIngQosSchedCustName=sapIngQosSchedCustName, custContact=custContact, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtCustCreated=prvtCustCreated, prvtTMCustCompliance=prvtTMCustCompliance, sapBaseInfoTable=sapBaseInfoTable, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSapGroups=prvtTMSapGroups, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapOperStatus=sapOperStatus, prvtSvcStatusChanged=prvtSvcStatusChanged, sapCustMultSvcSiteName=sapCustMultSvcSiteName, TSapIngQueueId=TSapIngQueueId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMServConformance=prvtTMServConformance, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtCustDeleted=prvtCustDeleted, sdpLastMgmtChange=sdpLastMgmtChange, prvtServicesMIB=prvtServicesMIB, ServObjName=ServObjName, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosCustName=sapEgrQosCustName, sdpLastStatusChange=sdpLastStatusChange, svcAdminStatus=svcAdminStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMServObjs=prvtTMServObjs, custEgrQosSchedName=custEgrQosSchedName, prvtCustTraps=prvtCustTraps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpRowStatus=sdpRowStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, TMEncapVal=TMEncapVal, sdpLabelSignaling=sdpLabelSignaling, VpnId=VpnId, svcLastMgmtChange=svcLastMgmtChange, sdpInfoEntry=sdpInfoEntry, svcLastStatusChange=svcLastStatusChange, custRowStatus=custRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMCustConformance=prvtTMCustConformance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcRowStatus=svcRowStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custLastMgmtChange=custLastMgmtChange, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMSapConformance=prvtTMSapConformance, prvtTMSdpConformance=prvtTMSdpConformance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapLearnMode=sapLearnMode, sdpBindVlanTag=sdpBindVlanTag, sapOperFlags=sapOperFlags, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSvcCreated=prvtSvcCreated, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcBaseInfoTable=svcBaseInfoTable, sdpMtu=sdpMtu)
