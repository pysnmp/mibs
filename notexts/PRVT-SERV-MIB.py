...
serviceAccessSwitch, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcLastStatusChange=svcLastStatusChange, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapBaseInfoTable=sapBaseInfoTable, sapIngQosQueueId=sapIngQosQueueId, sdpLastStatusChange=sdpLastStatusChange, prvtSapDeleted=prvtSapDeleted, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSdpDeleted=prvtSdpDeleted, prvtSvcNotif=prvtSvcNotif, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcNumEntries=svcNumEntries, sapEncapValue=sapEncapValue, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpMtu=sdpMtu, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpRowStatus=sdpRowStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapRowStatus=sapRowStatus, sdpLdpEnabled=sdpLdpEnabled, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSdpConformance=prvtTMSdpConformance, sdpId=sdpId, sdpType=sdpType, sdpBindVlanTag=sdpBindVlanTag, sdpAdminIsBackup=sdpAdminIsBackup, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcLastMgmtChange=svcLastMgmtChange, prvtSapTraps=prvtSapTraps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, ServType=ServType, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapType=sapType, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustCompliance=prvtTMCustCompliance, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, ServiceOperStatus=ServiceOperStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, custMultSvcSiteDescription=custMultSvcSiteDescription, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSdpNotif=prvtSdpNotif, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMServConformance=prvtTMServConformance, prvtServNotifications=prvtServNotifications, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSdpGroups=prvtTMSdpGroups, sdpLabelSignaling=sdpLabelSignaling, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, VpnId=VpnId, TMEncapVal=TMEncapVal, custInfoTable=custInfoTable, sapAdminStatus=sapAdminStatus, svcVpnId=svcVpnId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, svcDescription=svcDescription, sdpInfoEntry=sdpInfoEntry, svcVplsMode=svcVplsMode, sdpOperIsBackup=sdpOperIsBackup, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSapNotif=prvtSapNotif, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcOperStatus=svcOperStatus, prvtTMSapObjs=prvtTMSapObjs, TSapIngQueueId=TSapIngQueueId, sapNumEntries=sapNumEntries, prvtCustNotif=prvtCustNotif, svcType=svcType, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapLearnMode=sapLearnMode, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSapGroups=prvtTMSapGroups, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpNumEntries=sdpNumEntries, sdpNextFreeId=sdpNextFreeId, sapIngQosSchedName=sapIngQosSchedName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcNumSdps=svcNumSdps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapOperFlags=sapOperFlags, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custEgrQosSchedName=custEgrQosSchedName, prvtSapCreated=prvtSapCreated, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSvcGroups=prvtTMSvcGroups, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custContact=custContact, custName=custName, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosSchedName=custIngQosSchedName, svcBaseInfoEntry=svcBaseInfoEntry, prvtSvcTraps=prvtSvcTraps, prvtTMSdpObjs=prvtTMSdpObjs, sdpOperStatus=sdpOperStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosCustName=sapIngQosCustName, sdpOutInterface=sdpOutInterface, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, ServObjName=ServObjName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapBaseInfoEntry=sapBaseInfoEntry, svcNumSaps=svcNumSaps, sapOperStatus=sapOperStatus, sdpLastMgmtChange=sdpLastMgmtChange, prvtSapStatusChanged=prvtSapStatusChanged, sdpDelivery=sdpDelivery, prvtTMSvcObjs=prvtTMSvcObjs, prvtSdpCreated=prvtSdpCreated, sdpVCType=sdpVCType, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMSapCompliances=prvtTMSapCompliances, sdpAdminStatus=sdpAdminStatus, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSvcDeleted=prvtSvcDeleted, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, ServObjDesc=ServObjDesc, sdpDescription=sdpDescription, svcAdminStatus=svcAdminStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtCustTraps=prvtCustTraps, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpOperFlags=sdpOperFlags, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcCustName=svcCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, svcId=svcId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custRowStatus=custRowStatus, sdpInfoTable=sdpInfoTable, svcRevertTimer=svcRevertTimer, ServiceAdminStatus=ServiceAdminStatus, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, SdpIdType=SdpIdType, prvtTMServObjs=prvtTMServObjs, custPhone=custPhone, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMCustObjs=prvtTMCustObjs, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapDescription=sapDescription, prvtCustCreated=prvtCustCreated, sapEgrQosCustName=sapEgrQosCustName, prvtSdpTraps=prvtSdpTraps, svcRowStatus=svcRowStatus, sapPortId=sapPortId, prvtTMSvcConformance=prvtTMSvcConformance, custNumEntries=custNumEntries, prvtCustDeleted=prvtCustDeleted, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapLastMgmtChange=sapLastMgmtChange, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtServicesMIB=prvtServicesMIB, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custMultSvcSiteName=custMultSvcSiteName, prvtTMCustConformance=prvtTMCustConformance, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcMtu=svcMtu, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcEnableSecureSaps=svcEnableSecureSaps, svcBaseInfoTable=svcBaseInfoTable, sapIngQosSchedCustName=sapIngQosSchedCustName)
