...
TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone")
...
TextualConvention, RowStatus, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteDescription=custMultSvcSiteDescription, VpnId=VpnId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpTransportTunnelName=sdpTransportTunnelName, prvtSdpNotif=prvtSdpNotif, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMServConformance=prvtTMServConformance, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapRowStatus=sapRowStatus, svcMtu=svcMtu, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcRowStatus=svcRowStatus, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSapObjs=prvtTMSapObjs, svcCustName=svcCustName, sdpLdpEnabled=sdpLdpEnabled, custPhone=custPhone, prvtSvcCreated=prvtSvcCreated, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapOperStatus=sapOperStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEncapValue=sapEncapValue, svcNumEntries=svcNumEntries, svcBaseInfoEntry=svcBaseInfoEntry, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSvcNotif=prvtSvcNotif, prvtSdpCreated=prvtSdpCreated, prvtSapNotif=prvtSapNotif, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgrQosQueueId=sapEgrQosQueueId, svcType=svcType, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custNumEntries=custNumEntries, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSapGroups=prvtTMSapGroups, sdpDelivery=sdpDelivery, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, SdpIdType=SdpIdType, svcAdminStatus=svcAdminStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpLastStatusChange=sdpLastStatusChange, prvtSdpTraps=prvtSdpTraps, prvtSdpDeleted=prvtSdpDeleted, ServType=ServType, prvtSvcDeleted=prvtSvcDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custIngQosSchedName=custIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpOperFlags=sdpOperFlags, prvtCustNotif=prvtCustNotif, svcId=svcId, custEgrQosSchedName=custEgrQosSchedName, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSapDeleted=prvtSapDeleted, prvtCustTraps=prvtCustTraps, custName=custName, svcLastMgmtChange=svcLastMgmtChange, custContact=custContact, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcOperStatus=svcOperStatus, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custMultSvcSiteName=custMultSvcSiteName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpAdminStatus=sdpAdminStatus, sdpType=sdpType, sapPortId=sapPortId, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpVCType=sdpVCType, prvtTMSdpGroups=prvtTMSdpGroups, prvtCustCreated=prvtCustCreated, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVplsMode=svcVplsMode, sapAdminStatus=sapAdminStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapConformance=prvtTMSapConformance, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, ServObjName=ServObjName, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpDescription=sdpDescription, svcRevertTimer=svcRevertTimer, custLastMgmtChange=custLastMgmtChange, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMCustGroups=prvtTMCustGroups, prvtTMCustObjs=prvtTMCustObjs, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMSvcObjs=prvtTMSvcObjs, sdpAdminIngressLabel=sdpAdminIngressLabel, TSapIngQueueId=TSapIngQueueId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapLearnMode=sapLearnMode, sapNumEntries=sapNumEntries, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMServObjs=prvtTMServObjs, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpFarEndIpAddress=sdpFarEndIpAddress, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapIngQosSchedName=sapIngQosSchedName, svcVPLSUplinkPortID=svcVPLSUplinkPortID, TSapEgrQueueId=TSapEgrQueueId, sdpOperStatus=sdpOperStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapLastMgmtChange=sapLastMgmtChange, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtSapCreated=prvtSapCreated, custRowStatus=custRowStatus, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtSapTraps=prvtSapTraps, ServiceOperStatus=ServiceOperStatus, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSdpConformance=prvtTMSdpConformance, svcDescription=svcDescription, custInfoEntry=custInfoEntry, prvtSvcTraps=prvtSvcTraps, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcVpnId=svcVpnId, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpRowStatus=sdpRowStatus, sdpBindVlanTag=sdpBindVlanTag, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtServNotifications=prvtServNotifications, sapBaseInfoTable=sapBaseInfoTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpNumEntries=sdpNumEntries, svcBaseInfoTable=svcBaseInfoTable, sdpLastMgmtChange=sdpLastMgmtChange, svcEnableSecureSaps=svcEnableSecureSaps, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpGroupIdentifier=sdpGroupIdentifier, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMCustCompliances=prvtTMCustCompliances, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtServicesMIB=prvtServicesMIB, prvtTMSvcGroups=prvtTMSvcGroups, svcLastStatusChange=svcLastStatusChange, prvtTMTstpConformance=prvtTMTstpConformance, sapOperFlags=sapOperFlags, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpLabelSignaling=sdpLabelSignaling, sdpAdminIsBackup=sdpAdminIsBackup, sdpMtu=sdpMtu, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, TMEncapVal=TMEncapVal, custInfoTable=custInfoTable, sapIngQosCustName=sapIngQosCustName, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosCustName=sapEgrQosCustName, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpId=sdpId, ServObjDesc=ServObjDesc, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sdpInfoTable=sdpInfoTable, prvtCustDeleted=prvtCustDeleted, sapEgressQosPolicyId=sapEgressQosPolicyId, sapType=sapType, svcNumSdps=svcNumSdps, sapDescription=sapDescription)
