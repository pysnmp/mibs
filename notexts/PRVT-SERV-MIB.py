...
TextualConvention, TimeStamp, RowStatus, DisplayString, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceLastMgmtChange=serviceLastMgmtChange, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpLearnEnable=sdpLearnEnable, sapUntaggedMode=sapUntaggedMode, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpDescription=sdpDescription, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpId=sdpId, sapDeleted=sapDeleted, serviceDescription=serviceDescription, sapCreated=sapCreated, sapMacLearningProfileState=sapMacLearningProfileState, sdpBindVlanTag=sdpBindVlanTag, sapEgressQosPolicyId=sapEgressQosPolicyId, sapCurrentMacCount=sapCurrentMacCount, sdpOutInterface=sdpOutInterface, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceTable=serviceTable, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceVlanAction=serviceVlanAction, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceType=serviceType, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpOperFlags=sdpOperFlags, customerName=customerName, sapProfileName=sapProfileName, sdpOperStatus=sdpOperStatus, sdpType=sdpType, sapEntry=sapEntry, sdpPwActivate=sdpPwActivate, serviceRowStatus=serviceRowStatus, PYSNMP_MODULE_ID=prvtServicesMIB, serviceId=serviceId, sapDescription=sapDescription, serviceOperStatus=serviceOperStatus, serviceCustName=serviceCustName, sapType=sapType, sapLearnEnable=sapLearnEnable, sdpLabelSignaling=sdpLabelSignaling, sapOperStatus=sapOperStatus, customerEntry=customerEntry, sdpSecuredEnable=sdpSecuredEnable, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sapCustMultSvcSiteName=sapCustMultSvcSiteName, customerCreated=customerCreated, serviceDeleted=serviceDeleted, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, customerDeleted=customerDeleted, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapPortId=sapPortId, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sapOperFlags=sapOperFlags, sdpRowStatus=sdpRowStatus, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpLastMgmtChange=sdpLastMgmtChange, serviceVlanEtherType=serviceVlanEtherType, sdpMtu=sdpMtu, sapRowStatus=sapRowStatus, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceAdminStatus=serviceAdminStatus, prvtServicesMIB=prvtServicesMIB, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceMtu=serviceMtu, sapEncapValue=sapEncapValue, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceEntry=serviceEntry, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpVCType=sdpVCType, serviceNumSdps=serviceNumSdps, sapTable=sapTable, customerRowStatus=customerRowStatus, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceNumSaps=serviceNumSaps, sapAdminStatus=sapAdminStatus, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpDeleted=sdpDeleted, customerPhone=customerPhone, customerTable=customerTable, sapLearnMode=sapLearnMode, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpLdpEnabled=sdpLdpEnabled, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpSignalPwStatus=sdpSignalPwStatus, sapLastMgmtChange=sapLastMgmtChange, serviceRevertTimer=serviceRevertTimer, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpTransportTunnelName=sdpTransportTunnelName, sdpPwPrecedence=sdpPwPrecedence, serviceCreated=serviceCreated, prvtServicesMIBObjects=prvtServicesMIBObjects, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceVpnId=serviceVpnId, customerContact=customerContact, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpTable=sdpTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpNextFreeId=sdpNextFreeId, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpEntry=sdpEntry, sdpCreated=sdpCreated, sdpDelivery=sdpDelivery, sdpAdminStatus=sdpAdminStatus)
