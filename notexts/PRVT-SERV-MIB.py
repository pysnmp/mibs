...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpBindVlanTag=sdpBindVlanTag, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSapGroups=prvtTMSapGroups, prvtSvcNotif=prvtSvcNotif, sdpRowStatus=sdpRowStatus, prvtSvcDeleted=prvtSvcDeleted, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSvcCreated=prvtSvcCreated, sapBaseInfoTable=sapBaseInfoTable, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpAdminStatus=sdpAdminStatus, svcBaseInfoTable=svcBaseInfoTable, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMCustConformance=prvtTMCustConformance, svcLastMgmtChange=svcLastMgmtChange, prvtTMSapConformance=prvtTMSapConformance, ServiceAdminStatus=ServiceAdminStatus, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueId=sapIngQosQueueId, sdpOutInterface=sdpOutInterface, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosQueueId=sapEgrQosQueueId, sdpId=sdpId, sapRowStatus=sapRowStatus, custContact=custContact, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtServicesMIB=prvtServicesMIB, sapAdminStatus=sapAdminStatus, prvtSdpNotif=prvtSdpNotif, prvtCustNotif=prvtCustNotif, prvtTMServConformance=prvtTMServConformance, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSdpGroups=prvtTMSdpGroups, sdpOperFlags=sdpOperFlags, TMEncapVal=TMEncapVal, sapLastMgmtChange=sapLastMgmtChange, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSdpObjs=prvtTMSdpObjs, sdpInfoEntry=sdpInfoEntry, sdpOperIsBackup=sdpOperIsBackup, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custIngQosSchedName=custIngQosSchedName, svcNumEntries=svcNumEntries, prvtSvcStatusChanged=prvtSvcStatusChanged, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, custName=custName, svcNumSaps=svcNumSaps, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapNumEntries=sapNumEntries, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custNumEntries=custNumEntries, ServType=ServType, sdpDelivery=sdpDelivery, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLastStatusChange=sdpLastStatusChange, TSapIngQueueId=TSapIngQueueId, sdpTransportTunnelName=sdpTransportTunnelName, VpnId=VpnId, custRowStatus=custRowStatus, prvtCustDeleted=prvtCustDeleted, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpAdminIsBackup=sdpAdminIsBackup, svcBaseInfoEntry=svcBaseInfoEntry, sdpVCType=sdpVCType, svcVplsMode=svcVplsMode, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosSchedName=sapIngQosSchedName, prvtTMSdpCompliance=prvtTMSdpCompliance, sapOperFlags=sapOperFlags, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcRevertTimer=svcRevertTimer, svcMtu=svcMtu, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, SdpIdType=SdpIdType, prvtCustCreated=prvtCustCreated, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSapCompliances=prvtTMSapCompliances, ServObjName=ServObjName, prvtTMSvcConformance=prvtTMSvcConformance, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMCustObjs=prvtTMCustObjs, sapIngressQosPolicyId=sapIngressQosPolicyId, svcEnableSecureSaps=svcEnableSecureSaps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcGroups=prvtTMSvcGroups, prvtSapStatusChanged=prvtSapStatusChanged, sdpNumEntries=sdpNumEntries, svcAdminStatus=svcAdminStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcDescription=svcDescription, prvtSapCreated=prvtSapCreated, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMCustGroups=prvtTMCustGroups, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosCustName=sapIngQosCustName, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSdpCompliances=prvtTMSdpCompliances, svcId=svcId, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpNextFreeId=sdpNextFreeId, prvtSapTraps=prvtSapTraps, svcCustName=svcCustName, sdpGroupIdentifier=sdpGroupIdentifier, sapEgrQosSchedName=sapEgrQosSchedName, custMultSvcSiteName=custMultSvcSiteName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpInfoTable=sdpInfoTable, custEgrQosSchedName=custEgrQosSchedName, ServiceOperStatus=ServiceOperStatus, svcRowStatus=svcRowStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcNumSdps=svcNumSdps, sapPortId=sapPortId, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMServObjs=prvtTMServObjs, prvtSdpDeleted=prvtSdpDeleted, sapEncapValue=sapEncapValue, sapType=sapType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapLearnMode=sapLearnMode, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcType=svcType, sdpType=sdpType, ServObjDesc=ServObjDesc, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSapObjs=prvtTMSapObjs, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtTMTstpConformance=prvtTMTstpConformance, svcLastStatusChange=svcLastStatusChange, prvtSapDeleted=prvtSapDeleted, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapDescription=sapDescription, sdpMtu=sdpMtu, prvtTMSvcObjs=prvtTMSvcObjs, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpAdminIngressLabel=sdpAdminIngressLabel, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSdpCreated=prvtSdpCreated, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpLabelSignaling=sdpLabelSignaling, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSdpTraps=prvtSdpTraps, custPhone=custPhone, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custInfoTable=custInfoTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVpnId=svcVpnId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapOperStatus=sapOperStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custInfoEntry=custInfoEntry, custLastMgmtChange=custLastMgmtChange, prvtSapNotif=prvtSapNotif, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpDescription=sdpDescription, prvtServNotifications=prvtServNotifications, custMultSvcSiteDescription=custMultSvcSiteDescription)
