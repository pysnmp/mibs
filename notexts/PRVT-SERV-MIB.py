...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSdpCreated=prvtSdpCreated, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosSchedName=custEgrQosSchedName, ServiceOperStatus=ServiceOperStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcBaseInfoTable=svcBaseInfoTable, sapRowStatus=sapRowStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpMtu=sdpMtu, prvtTMSvcConformance=prvtTMSvcConformance, custRowStatus=custRowStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, ServObjName=ServObjName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpBindVlanTag=sdpBindVlanTag, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custLastMgmtChange=custLastMgmtChange, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, custName=custName, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpGroupIdentifier=sdpGroupIdentifier, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMCustObjs=prvtTMCustObjs, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapNumEntries=sapNumEntries, prvtSdpTraps=prvtSdpTraps, sdpInfoTable=sdpInfoTable, prvtServicesMIB=prvtServicesMIB, svcVpnId=svcVpnId, prvtTMServConformance=prvtTMServConformance, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtCustCreated=prvtCustCreated, ServType=ServType, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapType=sapType, prvtTMTstpConformance=prvtTMTstpConformance, prvtSvcTraps=prvtSvcTraps, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapLastMgmtChange=sapLastMgmtChange, sapLearnMode=sapLearnMode, sapBaseInfoTable=sapBaseInfoTable, prvtSapTraps=prvtSapTraps, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpAdminStatus=sdpAdminStatus, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueId=sapIngQosQueueId, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSdpConformance=prvtTMSdpConformance, svcType=svcType, svcBaseInfoEntry=svcBaseInfoEntry, sapAdminStatus=sapAdminStatus, sdpLdpEnabled=sdpLdpEnabled, VpnId=VpnId, svcNumSdps=svcNumSdps, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSapGroups=prvtTMSapGroups, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtSvcDeleted=prvtSvcDeleted, sapEncapValue=sapEncapValue, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpTransportTunnelName=sdpTransportTunnelName, prvtServNotifications=prvtServNotifications, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpNumEntries=sdpNumEntries, sapIngQosCustName=sapIngQosCustName, sdpInfoEntry=sdpInfoEntry, custNumEntries=custNumEntries, svcNumEntries=svcNumEntries, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVplsMode=svcVplsMode, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpDescription=sdpDescription, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapPortId=sapPortId, prvtSapDeleted=prvtSapDeleted, sapEgrQosQueueId=sapEgrQosQueueId, sdpLabelSignaling=sdpLabelSignaling, sdpOperStatus=sdpOperStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, PYSNMP_MODULE_ID=prvtServicesMIB, sdpOperIsBackup=sdpOperIsBackup, svcRevertTimer=svcRevertTimer, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpNextFreeId=sdpNextFreeId, prvtTMSapObjs=prvtTMSapObjs, sapOperFlags=sapOperFlags, TSapIngQueueId=TSapIngQueueId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcMtu=svcMtu, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, ServObjDesc=ServObjDesc, custIngQosSchedName=custIngQosSchedName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSapCreated=prvtSapCreated, prvtSapNotif=prvtSapNotif, sdpType=sdpType, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpId=sdpId, custInfoTable=custInfoTable, sdpRowStatus=sdpRowStatus, svcId=svcId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSapCompliances=prvtTMSapCompliances, svcNumSaps=svcNumSaps, prvtCustDeleted=prvtCustDeleted, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpLastStatusChange=sdpLastStatusChange, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpOutInterface=sdpOutInterface, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcOperStatus=svcOperStatus, prvtTMCustGroups=prvtTMCustGroups, prvtTMCustConformance=prvtTMCustConformance, svcLastStatusChange=svcLastStatusChange, svcCustName=svcCustName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMServObjs=prvtTMServObjs, TMEncapVal=TMEncapVal, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosSchedName=sapEgrQosSchedName, svcAdminStatus=svcAdminStatus, sapIngQosSchedName=sapIngQosSchedName, sdpAdminIngressLabel=sdpAdminIngressLabel, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, svcRowStatus=svcRowStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, ServiceAdminStatus=ServiceAdminStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapDescription=sapDescription, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtCustTraps=prvtCustTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcDescription=svcDescription, SdpIdType=SdpIdType, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSdpCompliance=prvtTMSdpCompliance, sapOperStatus=sapOperStatus, sapEgrQosCustName=sapEgrQosCustName, sdpVCType=sdpVCType, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpDelivery=sdpDelivery, custPhone=custPhone, prvtTMSvcGroups=prvtTMSvcGroups, custContact=custContact, prvtSvcNotif=prvtSvcNotif)
