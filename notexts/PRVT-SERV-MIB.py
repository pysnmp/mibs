...
TimeStamp, TruthValue, RowStatus, TextualConvention, DisplayString, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "DisplayString", "MacAddress")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", customerTable=customerTable, serviceVlanAction=serviceVlanAction, sdpMtu=sdpMtu, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpNextFreeId=sdpNextFreeId, serviceVpnId=serviceVpnId, sapEntry=sapEntry, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpRowStatus=sdpRowStatus, sapEncapValue=sapEncapValue, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sapDeleted=sapDeleted, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceCustName=serviceCustName, sdpPwPrecedence=sdpPwPrecedence, sdpType=sdpType, sdpId=sdpId, sdpLdpEnabled=sdpLdpEnabled, customerCreated=customerCreated, sapLastMgmtChange=sapLastMgmtChange, customerContact=customerContact, sdpTable=sdpTable, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapTable=sapTable, serviceVlanEtherType=serviceVlanEtherType, sdpDelivery=sdpDelivery, serviceLastMgmtChange=serviceLastMgmtChange, sdpPwActivate=sdpPwActivate, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceMacAddressSapPriority=serviceMacAddressSapPriority, serviceAdminStatus=serviceAdminStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, customerRowStatus=customerRowStatus, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceId=serviceId, sapPortId=sapPortId, customerDeleted=customerDeleted, sdpLabelSignaling=sdpLabelSignaling, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMtu=serviceMtu, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sapOperFlags=sapOperFlags, customerEntry=customerEntry, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapLearnMode=sapLearnMode, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapUntaggedMode=sapUntaggedMode, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sapLearnEnable=sapLearnEnable, serviceRowStatus=serviceRowStatus, sapOperStatus=sapOperStatus, serviceCreated=serviceCreated, sdpOutInterface=sdpOutInterface, sapCurrentMacCount=sapCurrentMacCount, serviceDeleted=serviceDeleted, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapType=sapType, sdpTransportTunnelName=sdpTransportTunnelName, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpSecuredEnable=sdpSecuredEnable, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpOperFlags=sdpOperFlags, sdpLastMgmtChange=sdpLastMgmtChange, sapRowStatus=sapRowStatus, prvtServicesMIBNotifications=prvtServicesMIBNotifications, prvtServicesMIB=prvtServicesMIB, serviceEntry=serviceEntry, serviceType=serviceType, sdpDescription=sdpDescription, sdpEntry=sdpEntry, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpSignalPwStatus=sdpSignalPwStatus, serviceTable=serviceTable, serviceNumSdps=serviceNumSdps, sapDescription=sapDescription, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapAdminStatus=sapAdminStatus, sapCreated=sapCreated, sdpDeleted=sdpDeleted, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpBindVlanTag=sdpBindVlanTag, serviceOperStatus=serviceOperStatus, sapProfileName=sapProfileName, sapMacLearningProfileState=sapMacLearningProfileState, sdpLearnEnable=sdpLearnEnable, sdpCreated=sdpCreated, sdpOperStatus=sdpOperStatus, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceDescription=serviceDescription, customerPhone=customerPhone, serviceMacAddressSapTable=serviceMacAddressSapTable, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, PYSNMP_MODULE_ID=prvtServicesMIB, serviceRevertTimer=serviceRevertTimer, sdpVCType=sdpVCType, prvtServicesMIBObjects=prvtServicesMIBObjects, customerName=customerName, serviceNumSaps=serviceNumSaps)
