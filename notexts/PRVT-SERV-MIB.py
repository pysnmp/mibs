...
TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSdpStatusChanged=prvtSdpStatusChanged, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, ServType=ServType, TSapEgrQueueId=TSapEgrQueueId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapNumEntries=sapNumEntries, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtCustDeleted=prvtCustDeleted, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcNumSdps=svcNumSdps, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapRowStatus=sapRowStatus, sapOperFlags=sapOperFlags, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgressQosPolicyId=sapEgressQosPolicyId, custName=custName, prvtTMSvcGroups=prvtTMSvcGroups, sdpId=sdpId, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSapStatusChanged=prvtSapStatusChanged, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosSchedName=custEgrQosSchedName, sdpLabelSignaling=sdpLabelSignaling, svcType=svcType, prvtTMSdpObjs=prvtTMSdpObjs, svcRowStatus=svcRowStatus, prvtCustTraps=prvtCustTraps, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtServicesMIB=prvtServicesMIB, svcOperStatus=svcOperStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapLastMgmtChange=sapLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, TMEncapVal=TMEncapVal, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSapGroups=prvtTMSapGroups, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosSchedName=sapIngQosSchedName, sdpVCType=sdpVCType, custMultSvcSiteName=custMultSvcSiteName, sdpOperIsBackup=sdpOperIsBackup, prvtTMSapObjs=prvtTMSapObjs, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, svcCustName=svcCustName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpCreated=prvtSdpCreated, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, ServObjName=ServObjName, prvtSapNotif=prvtSapNotif, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpNumEntries=sdpNumEntries, TSapIngQueueId=TSapIngQueueId, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSvcObjs=prvtTMSvcObjs, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpDescription=sdpDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapPortId=sapPortId, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustCreated=prvtCustCreated, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustObjs=prvtTMCustObjs, prvtSvcTraps=prvtSvcTraps, custContact=custContact, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapType=sapType, ServiceAdminStatus=ServiceAdminStatus, sdpMtu=sdpMtu, prvtSdpNotif=prvtSdpNotif, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpNextFreeId=sdpNextFreeId, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMServObjs=prvtTMServObjs, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, custInfoEntry=custInfoEntry, sapEncapValue=sapEncapValue, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosQueueId=sapIngQosQueueId, sdpOperFlags=sdpOperFlags, prvtTMSdpGroups=prvtTMSdpGroups, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpOperStatus=sdpOperStatus, SdpIdType=SdpIdType, svcMtu=svcMtu, custMultiServiceSiteTable=custMultiServiceSiteTable, sapBaseInfoTable=sapBaseInfoTable, prvtCustNotif=prvtCustNotif, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSapCreated=prvtSapCreated, prvtSapTraps=prvtSapTraps, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpTransportTunnelName=sdpTransportTunnelName, sdpInfoEntry=sdpInfoEntry, sdpOutInterface=sdpOutInterface, custPhone=custPhone, prvtSdpDeleted=prvtSdpDeleted, custMultiServiceSiteEntry=custMultiServiceSiteEntry, ServObjDesc=ServObjDesc, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSdpConformance=prvtTMSdpConformance, sapLearnMode=sapLearnMode, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpRowStatus=sdpRowStatus, svcBaseInfoTable=svcBaseInfoTable, sdpLastStatusChange=sdpLastStatusChange, sdpDelivery=sdpDelivery, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpLdpEnabled=sdpLdpEnabled, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapAdminStatus=sapAdminStatus, sdpType=sdpType, sapEgrQosCustName=sapEgrQosCustName, prvtSapDeleted=prvtSapDeleted, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcDescription=svcDescription, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpGroupIdentifier=sdpGroupIdentifier, svcBaseInfoEntry=svcBaseInfoEntry, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, PYSNMP_MODULE_ID=prvtServicesMIB, VpnId=VpnId, prvtServNotifications=prvtServNotifications, sapBaseInfoEntry=sapBaseInfoEntry, custNumEntries=custNumEntries, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcNumSaps=svcNumSaps, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcVplsMode=svcVplsMode, prvtTMServConformance=prvtTMServConformance, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSdpTraps=prvtSdpTraps, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMCustGroups=prvtTMCustGroups, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMCustCompliance=prvtTMCustCompliance, sdpBindVlanTag=sdpBindVlanTag, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcVpnId=svcVpnId, prvtSvcCreated=prvtSvcCreated, svcNumEntries=svcNumEntries, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custLastMgmtChange=custLastMgmtChange, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapDescription=sapDescription, sdpInfoTable=sdpInfoTable, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcId=svcId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSvcDeleted=prvtSvcDeleted, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpAdminStatus=sdpAdminStatus, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcRevertTimer=svcRevertTimer, ServiceOperStatus=ServiceOperStatus, svcEnableSecureSaps=svcEnableSecureSaps, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosSchedCustName=sapIngQosSchedCustName, custInfoTable=custInfoTable, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custRowStatus=custRowStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, svcLastMgmtChange=svcLastMgmtChange)
