...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItem, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSapTraps=prvtSapTraps, sapOperStatus=sapOperStatus, prvtSvcNotif=prvtSvcNotif, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpOperFlags=sdpOperFlags, sapEgrQosCustName=sapEgrQosCustName, sapDescription=sapDescription, prvtTMSdpGroups=prvtTMSdpGroups, prvtCustTraps=prvtCustTraps, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueId=sapIngQosQueueId, prvtServNotifications=prvtServNotifications, prvtTMSvcConformance=prvtTMSvcConformance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, TSapIngQueueId=TSapIngQueueId, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMCustGroups=prvtTMCustGroups, prvtSvcCreated=prvtSvcCreated, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpBindVlanTag=sdpBindVlanTag, sdpOutInterface=sdpOutInterface, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpOperStatus=sdpOperStatus, sapOperFlags=sapOperFlags, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpId=sdpId, prvtSapNotif=prvtSapNotif, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpNextFreeId=sdpNextFreeId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, TMEncapVal=TMEncapVal, sapLastMgmtChange=sapLastMgmtChange, custInfoTable=custInfoTable, svcRevertTimer=svcRevertTimer, sapLearnMode=sapLearnMode, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpAdminStatus=sdpAdminStatus, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custInfoEntry=custInfoEntry, prvtCustCreated=prvtCustCreated, sdpInfoEntry=sdpInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custPhone=custPhone, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcGroups=prvtTMSvcGroups, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSvcObjs=prvtTMSvcObjs, custMultSvcSiteName=custMultSvcSiteName, prvtSdpDeleted=prvtSdpDeleted, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, ServObjDesc=ServObjDesc, svcType=svcType, sdpRowStatus=sdpRowStatus, svcVPLSUplinkTable=svcVPLSUplinkTable, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSapObjs=prvtTMSapObjs, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcNumEntries=svcNumEntries, sapType=sapType, prvtTMServConformance=prvtTMServConformance, svcDescription=svcDescription, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, ServObjName=ServObjName, svcRowStatus=svcRowStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, svcNumSdps=svcNumSdps, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMTstpConformance=prvtTMTstpConformance, sdpLastMgmtChange=sdpLastMgmtChange, sdpNumEntries=sdpNumEntries, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpAdminEgressLabel=sdpAdminEgressLabel, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcCustName=svcCustName, sapAdminStatus=sapAdminStatus, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultSvcSiteDescription=custMultSvcSiteDescription, svcOperStatus=svcOperStatus, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMCustConformance=prvtTMCustConformance, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpLdpEnabled=sdpLdpEnabled, prvtTMSapCompliance=prvtTMSapCompliance, sdpVCType=sdpVCType, prvtTMSapGroups=prvtTMSapGroups, prvtSdpNotif=prvtSdpNotif, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpLabelSignaling=sdpLabelSignaling, prvtSdpTraps=prvtSdpTraps, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, ServType=ServType, PYSNMP_MODULE_ID=prvtServicesMIB, svcVplsMode=svcVplsMode, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSvcStatusChanged=prvtSvcStatusChanged, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpMtu=sdpMtu, prvtTMSapConformance=prvtTMSapConformance, sapRowStatus=sapRowStatus, sdpTransportTunnelName=sdpTransportTunnelName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEncapValue=sapEncapValue, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcBaseInfoTable=svcBaseInfoTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpOperIsBackup=sdpOperIsBackup, svcMtu=svcMtu, prvtSdpCreated=prvtSdpCreated, custEgrQosSchedName=custEgrQosSchedName, svcId=svcId, prvtSvcDeleted=prvtSvcDeleted, sdpDescription=sdpDescription, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosCustName=sapIngQosCustName, sdpLastStatusChange=sdpLastStatusChange, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMCustObjs=prvtTMCustObjs, sapNumEntries=sapNumEntries, VpnId=VpnId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSdpConformance=prvtTMSdpConformance, custNumEntries=custNumEntries, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueId=sapEgrQosQueueId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtCustDeleted=prvtCustDeleted, svcEnableSecureSaps=svcEnableSecureSaps, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custName=custName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, SdpIdType=SdpIdType, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpType=sdpType, sapEgrQosSchedName=sapEgrQosSchedName, prvtSapDeleted=prvtSapDeleted, svcVpnId=svcVpnId, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSvcTraps=prvtSvcTraps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosSchedName=sapIngQosSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpFarEndIpAddress=sdpFarEndIpAddress, sapPortId=sapPortId, sdpDelivery=sdpDelivery, prvtCustNotif=prvtCustNotif, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custContact=custContact, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosSchedName=custIngQosSchedName, sdpAdminIsBackup=sdpAdminIsBackup, custLastMgmtChange=custLastMgmtChange, prvtServicesMIB=prvtServicesMIB, ServiceOperStatus=ServiceOperStatus, sdpInfoTable=sdpInfoTable, custRowStatus=custRowStatus, prvtSapCreated=prvtSapCreated, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMServObjs=prvtTMServObjs)
