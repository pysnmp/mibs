...
TNamedItemOrEmpty, TNamedItem, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNamedItem", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custEgrQosSchedName=custEgrQosSchedName, prvtSvcCreated=prvtSvcCreated, sdpNumEntries=sdpNumEntries, svcId=svcId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueId=sapEgrQosQueueId, sapEncapValue=sapEncapValue, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, prvtSdpDeleted=prvtSdpDeleted, svcVpnId=svcVpnId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpAdminStatus=sdpAdminStatus, ServiceOperStatus=ServiceOperStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSdpCreated=prvtSdpCreated, prvtTMSapConformance=prvtTMSapConformance, sapIngQosSchedCustName=sapIngQosSchedCustName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosSchedName=sapIngQosSchedName, svcBaseInfoTable=svcBaseInfoTable, prvtTMServConformance=prvtTMServConformance, ServObjName=ServObjName, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcRowStatus=svcRowStatus, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSapNotif=prvtSapNotif, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpAdminIsBackup=sdpAdminIsBackup, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtCustNotif=prvtCustNotif, TMEncapVal=TMEncapVal, sdpInfoEntry=sdpInfoEntry, prvtSdpTraps=prvtSdpTraps, custName=custName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, PYSNMP_MODULE_ID=prvtServicesMIB, ServType=ServType, svcOperStatus=svcOperStatus, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapCompliance=prvtTMSapCompliance, TSapIngQueueId=TSapIngQueueId, svcCustName=svcCustName, prvtSvcTraps=prvtSvcTraps, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapLastMgmtChange=sapLastMgmtChange, prvtTMSdpCompliances=prvtTMSdpCompliances, svcNumSaps=svcNumSaps, sapLearnMode=sapLearnMode, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpId=sdpId, sdpMtu=sdpMtu, sdpLastStatusChange=sdpLastStatusChange, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custInfoEntry=custInfoEntry, SdpIdType=SdpIdType, prvtSapCreated=prvtSapCreated, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosSchedName=sapEgrQosSchedName, custNumEntries=custNumEntries, sapRowStatus=sapRowStatus, svcDescription=svcDescription, prvtSvcStatusChanged=prvtSvcStatusChanged, custMultSvcSiteName=custMultSvcSiteName, sapOperFlags=sapOperFlags, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, sapOperStatus=sapOperStatus, sapPortId=sapPortId, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMCustCompliance=prvtTMCustCompliance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpRowStatus=sdpRowStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcEnableSecureSaps=svcEnableSecureSaps, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custRowStatus=custRowStatus, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtSvcNotif=prvtSvcNotif, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpVCType=sdpVCType, sapNumEntries=sapNumEntries, VpnId=VpnId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpOperFlags=sdpOperFlags, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcType=svcType, sapDescription=sapDescription, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosCustName=sapEgrQosCustName, prvtSdpNotif=prvtSdpNotif, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpOperStatus=sdpOperStatus, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtCustDeleted=prvtCustDeleted, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapGroups=prvtTMSapGroups, prvtTMSapObjs=prvtTMSapObjs, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, prvtSapTraps=prvtSapTraps, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, ServiceAdminStatus=ServiceAdminStatus, prvtTMTstpConformance=prvtTMTstpConformance, custContact=custContact, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, ServObjDesc=ServObjDesc, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custLastMgmtChange=custLastMgmtChange, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpType=sdpType, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapCompliances=prvtTMSapCompliances, sdpDescription=sdpDescription, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcAdminStatus=svcAdminStatus, svcMtu=svcMtu, custPhone=custPhone, sdpInfoTable=sdpInfoTable, svcNumSdps=svcNumSdps, custInfoTable=custInfoTable, prvtServNotifications=prvtServNotifications, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSvcCompliances=prvtTMSvcCompliances, sapType=sapType, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpLabelSignaling=sdpLabelSignaling, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustConformance=prvtTMCustConformance, prvtTMServObjs=prvtTMServObjs, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcLastStatusChange=svcLastStatusChange, sdpBindVlanTag=sdpBindVlanTag, svcRevertTimer=svcRevertTimer, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosSchedName=custIngQosSchedName, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustObjs=prvtTMCustObjs, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpLastMgmtChange=sdpLastMgmtChange, sdpDelivery=sdpDelivery, prvtTMSdpObjs=prvtTMSdpObjs, svcVplsMode=svcVplsMode, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtCustCreated=prvtCustCreated, prvtCustTraps=prvtCustTraps, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpOutInterface=sdpOutInterface, sdpNextFreeId=sdpNextFreeId, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcNumEntries=svcNumEntries, svcLastMgmtChange=svcLastMgmtChange, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSvcDeleted=prvtSvcDeleted, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcBaseInfoEntry=svcBaseInfoEntry, sdpOperIsBackup=sdpOperIsBackup, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSapStatusChanged=prvtSapStatusChanged, prvtServicesMIB=prvtServicesMIB, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMSdpConformance=prvtTMSdpConformance)
