...
TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpLastMgmtChange=sdpLastMgmtChange, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custRowStatus=custRowStatus, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpOperStatus=sdpOperStatus, svcMtu=svcMtu, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueId=sapIngQosQueueId, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSvcTraps=prvtSvcTraps, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSvcDeleted=prvtSvcDeleted, sdpLastStatusChange=sdpLastStatusChange, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapAdminStatus=sapAdminStatus, prvtTMServConformance=prvtTMServConformance, prvtTMSapObjs=prvtTMSapObjs, sdpDescription=sdpDescription, sapLearnMode=sapLearnMode, custEgrQosSchedName=custEgrQosSchedName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapNumEntries=sapNumEntries, PYSNMP_MODULE_ID=prvtServicesMIB, svcNumSdps=svcNumSdps, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpOperIsBackup=sdpOperIsBackup, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSapCompliance=prvtTMSapCompliance, custInfoTable=custInfoTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosSchedCustName=sapIngQosSchedCustName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosSchedName=custIngQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMSdpConformance=prvtTMSdpConformance, prvtSapCreated=prvtSapCreated, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcVpnId=svcVpnId, svcVPLSUplinkTable=svcVPLSUplinkTable, svcRevertTimer=svcRevertTimer, sapLastMgmtChange=sapLastMgmtChange, prvtSapStatusChanged=prvtSapStatusChanged, ServiceAdminStatus=ServiceAdminStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcNumSaps=svcNumSaps, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcCustName=svcCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSvcStatusChanged=prvtSvcStatusChanged, custPhone=custPhone, sdpAdminStatus=sdpAdminStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcOperStatus=svcOperStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcLastStatusChange=svcLastStatusChange, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, ServiceOperStatus=ServiceOperStatus, sdpType=sdpType, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSapGroups=prvtTMSapGroups, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSdpObjs=prvtTMSdpObjs, sdpBindVlanTag=sdpBindVlanTag, sdpNextFreeId=sdpNextFreeId, sdpGroupIdentifier=sdpGroupIdentifier, sapType=sapType, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSvcNotif=prvtSvcNotif, ServObjName=ServObjName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcDescription=svcDescription, SdpIdType=SdpIdType, sapOperFlags=sapOperFlags, prvtTMSapCompliances=prvtTMSapCompliances, sapDescription=sapDescription, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSdpCompliance=prvtTMSdpCompliance, svcAdminStatus=svcAdminStatus, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSapNotif=prvtSapNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosSchedName=sapIngQosSchedName, custNumEntries=custNumEntries, svcBaseInfoTable=svcBaseInfoTable, prvtServicesMIB=prvtServicesMIB, prvtTMTstpConformance=prvtTMTstpConformance, sdpDelivery=sdpDelivery, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtCustDeleted=prvtCustDeleted, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcId=svcId, TSapEgrQueueId=TSapEgrQueueId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSdpGroups=prvtTMSdpGroups, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosCustName=sapIngQosCustName, svcRowStatus=svcRowStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSdpCreated=prvtSdpCreated, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSvcGroups=prvtTMSvcGroups, sdpLabelSignaling=sdpLabelSignaling, sapOperStatus=sapOperStatus, prvtSvcCreated=prvtSvcCreated, sdpMtu=sdpMtu, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custInfoEntry=custInfoEntry, prvtCustNotif=prvtCustNotif, ServType=ServType, custMultSvcSiteName=custMultSvcSiteName, svcVplsMode=svcVplsMode, prvtTMCustGroups=prvtTMCustGroups, prvtSapDeleted=prvtSapDeleted, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSdpDeleted=prvtSdpDeleted, VpnId=VpnId, sdpId=sdpId, prvtServNotifications=prvtServNotifications, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapBaseInfoTable=sapBaseInfoTable, prvtTMCustCompliance=prvtTMCustCompliance, sdpInfoTable=sdpInfoTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpTransportTunnelName=sdpTransportTunnelName, prvtSdpTraps=prvtSdpTraps, sapPortId=sapPortId, sapEgrQosCustName=sapEgrQosCustName, sapRowStatus=sapRowStatus, TSapIngQueueId=TSapIngQueueId, prvtTMCustCompliances=prvtTMCustCompliances, prvtCustTraps=prvtCustTraps, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpNumEntries=sdpNumEntries, prvtSapTraps=prvtSapTraps, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcBaseInfoEntry=svcBaseInfoEntry, svcLastMgmtChange=svcLastMgmtChange, custName=custName, ServObjDesc=ServObjDesc, prvtTMSvcCompliance=prvtTMSvcCompliance, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMServObjs=prvtTMServObjs, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpRowStatus=sdpRowStatus, sdpOperFlags=sdpOperFlags, TMEncapVal=TMEncapVal, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpVCType=sdpVCType, sapEncapValue=sapEncapValue, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcNumEntries=svcNumEntries, svcType=svcType, custLastMgmtChange=custLastMgmtChange, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultSvcSiteDescription=custMultSvcSiteDescription, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custContact=custContact, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpOutInterface=sdpOutInterface, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtCustCreated=prvtCustCreated)
