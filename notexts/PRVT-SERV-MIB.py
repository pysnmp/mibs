...
DisplayString, TextualConvention, TruthValue, RowStatus, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "RowStatus", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sdpTransportTunnelName=sdpTransportTunnelName, sapDeleted=sapDeleted, serviceTable=serviceTable, serviceRevertTimer=serviceRevertTimer, serviceMtu=serviceMtu, sdpId=sdpId, sapDescription=sapDescription, sdpMtu=sdpMtu, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceLastMgmtChange=serviceLastMgmtChange, serviceDescription=serviceDescription, sdpAdminStatus=sdpAdminStatus, sapLastMgmtChange=sapLastMgmtChange, sapPortId=sapPortId, sdpFarEndIpAddress=sdpFarEndIpAddress, sapAdminStatus=sapAdminStatus, sapCreated=sapCreated, customerRowStatus=customerRowStatus, serviceVpnId=serviceVpnId, customerContact=customerContact, serviceDeleted=serviceDeleted, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpSecuredEnable=sdpSecuredEnable, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceCustName=serviceCustName, sapProfileName=sapProfileName, sapOperFlags=sapOperFlags, serviceRowStatus=serviceRowStatus, sapEntry=sapEntry, sdpCreated=sdpCreated, serviceVlanEtherType=serviceVlanEtherType, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceCreated=serviceCreated, sapOperStatus=sapOperStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceVlanAction=serviceVlanAction, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sapEncapValue=sapEncapValue, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceNumSdps=serviceNumSdps, sdpDelivery=sdpDelivery, sdpOperStatus=sdpOperStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpLabelSignaling=sdpLabelSignaling, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceId=serviceId, sdpEntry=sdpEntry, customerName=customerName, sdpOutInterface=sdpOutInterface, sdpDescription=sdpDescription, customerEntry=customerEntry, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, customerTable=customerTable, sdpSignalPwStatus=sdpSignalPwStatus, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sdpPwPrecedence=sdpPwPrecedence, sdpType=sdpType, serviceType=serviceType, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, serviceOperStatus=serviceOperStatus, customerCreated=customerCreated, customerPhone=customerPhone, sapLearnEnable=sapLearnEnable, sdpNextFreeId=sdpNextFreeId, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sapType=sapType, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpLearnEnable=sdpLearnEnable, customerDeleted=customerDeleted, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, serviceEntry=serviceEntry, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpRowStatus=sdpRowStatus, sdpGroupIdentifier=sdpGroupIdentifier, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sapLearnMode=sapLearnMode, sdpPwActivate=sdpPwActivate, serviceMacAddressSapPriority=serviceMacAddressSapPriority, serviceNumSaps=serviceNumSaps, serviceAdminStatus=serviceAdminStatus, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpTable=sdpTable, sapRowStatus=sapRowStatus, sdpLastMgmtChange=sdpLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, sapUntaggedMode=sapUntaggedMode, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapCurrentMacCount=sapCurrentMacCount, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sapMacLearningProfileState=sapMacLearningProfileState, sdpLdpEnabled=sdpLdpEnabled, sdpDeleted=sdpDeleted, prvtServicesMIB=prvtServicesMIB, sapTable=sapTable, sdpVCType=sdpVCType, sdpOperFlags=sdpOperFlags)
