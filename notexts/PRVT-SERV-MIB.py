...
TSapIngressPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custName=custName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosSchedName=custEgrQosSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custInfoTable=custInfoTable, sapLearnMode=sapLearnMode, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMSdpConformance=prvtTMSdpConformance, custContact=custContact, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapOperStatus=sapOperStatus, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpInfoTable=sdpInfoTable, svcCustName=svcCustName, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosCustName=sapEgrQosCustName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultSvcSiteName=custMultSvcSiteName, ServObjName=ServObjName, svcRevertTimer=svcRevertTimer, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpOperStatus=sdpOperStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtSdpCreated=prvtSdpCreated, prvtSvcStatusChanged=prvtSvcStatusChanged, svcAdminStatus=svcAdminStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtCustTraps=prvtCustTraps, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapBaseInfoEntry=sapBaseInfoEntry, svcNumSdps=svcNumSdps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapNumEntries=sapNumEntries, custMultiServiceSiteTable=custMultiServiceSiteTable, custInfoEntry=custInfoEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcRowStatus=svcRowStatus, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMCustConformance=prvtTMCustConformance, prvtSvcDeleted=prvtSvcDeleted, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosCustName=sapIngQosCustName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcNotif=prvtSvcNotif, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMSvcGroups=prvtTMSvcGroups, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, SdpIdType=SdpIdType, sapDescription=sapDescription, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtServNotifications=prvtServNotifications, sdpVCType=sdpVCType, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSdpCompliance=prvtTMSdpCompliance, TSapEgrQueueId=TSapEgrQueueId, prvtTMServConformance=prvtTMServConformance, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, TSapIngQueueId=TSapIngQueueId, sdpType=sdpType, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcNumSaps=svcNumSaps, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpNextFreeId=sdpNextFreeId, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, TMEncapVal=TMEncapVal, sapEgrQosSchedName=sapEgrQosSchedName, svcType=svcType, sapIngQosSchedName=sapIngQosSchedName, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapOperFlags=sapOperFlags, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpFarEndIpAddress=sdpFarEndIpAddress, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcDescription=svcDescription, ServObjDesc=ServObjDesc, sdpLabelSignaling=sdpLabelSignaling, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapBaseInfoTable=sapBaseInfoTable, prvtCustDeleted=prvtCustDeleted, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpBindVlanTag=sdpBindVlanTag, prvtServicesMIB=prvtServicesMIB, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSdpGroups=prvtTMSdpGroups, sdpId=sdpId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, PYSNMP_MODULE_ID=prvtServicesMIB, sdpAdminIsBackup=sdpAdminIsBackup, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSapCompliances=prvtTMSapCompliances, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtCustCreated=prvtCustCreated, sapAdminStatus=sapAdminStatus, sdpAdminStatus=sdpAdminStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custPhone=custPhone, sapEncapValue=sapEncapValue, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpDelivery=sdpDelivery, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtSdpDeleted=prvtSdpDeleted, svcVplsMode=svcVplsMode, sapType=sapType, prvtTMSapObjs=prvtTMSapObjs, svcBaseInfoTable=svcBaseInfoTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpOutInterface=sdpOutInterface, prvtSapCreated=prvtSapCreated, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcOperStatus=svcOperStatus, sdpRowStatus=sdpRowStatus, prvtTMSvcConformance=prvtTMSvcConformance, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpLdpEnabled=sdpLdpEnabled, VpnId=VpnId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMCustGroups=prvtTMCustGroups, svcNumEntries=svcNumEntries, prvtSapDeleted=prvtSapDeleted, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcEnableSecureSaps=svcEnableSecureSaps, sapLastMgmtChange=sapLastMgmtChange, ServiceAdminStatus=ServiceAdminStatus, prvtCustNotif=prvtCustNotif, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custLastMgmtChange=custLastMgmtChange, prvtSvcTraps=prvtSvcTraps, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, ServiceOperStatus=ServiceOperStatus, svcVpnId=svcVpnId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpInfoEntry=sdpInfoEntry, svcLastStatusChange=svcLastStatusChange, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpNumEntries=sdpNumEntries, sdpGroupIdentifier=sdpGroupIdentifier, sdpOperFlags=sdpOperFlags, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosQueueId=sapEgrQosQueueId, prvtSdpNotif=prvtSdpNotif, prvtTMServObjs=prvtTMServObjs, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSdpTraps=prvtSdpTraps, sapRowStatus=sapRowStatus, prvtTMSapCompliance=prvtTMSapCompliance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcId=svcId, prvtSvcCreated=prvtSvcCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpMtu=sdpMtu, sdpAdminEgressLabel=sdpAdminEgressLabel, custRowStatus=custRowStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSapTraps=prvtSapTraps, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcMtu=svcMtu, custNumEntries=custNumEntries, prvtTMSapGroups=prvtTMSapGroups, prvtSapNotif=prvtSapNotif, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapPortId=sapPortId, prvtTMCustObjs=prvtTMCustObjs, sdpDescription=sdpDescription, ServType=ServType)
