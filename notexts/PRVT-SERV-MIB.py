...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosSchedName=sapIngQosSchedName, ServiceAdminStatus=ServiceAdminStatus, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcBaseInfoTable=svcBaseInfoTable, prvtTMCustGroups=prvtTMCustGroups, sapEgressQosPolicyId=sapEgressQosPolicyId, custNumEntries=custNumEntries, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosQueueId=sapIngQosQueueId, prvtTMCustCompliance=prvtTMCustCompliance, prvtCustTraps=prvtCustTraps, prvtTMSapConformance=prvtTMSapConformance, custEgrQosSchedName=custEgrQosSchedName, sdpOutInterface=sdpOutInterface, sdpGroupIdentifier=sdpGroupIdentifier, sdpType=sdpType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpAdminIngressLabel=sdpAdminIngressLabel, sapPortId=sapPortId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpBindVlanTag=sdpBindVlanTag, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapLearnMode=sapLearnMode, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapDescription=sapDescription, sdpLabelSignaling=sdpLabelSignaling, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMCustCompliances=prvtTMCustCompliances, sapBaseInfoEntry=sapBaseInfoEntry, svcNumSaps=svcNumSaps, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcEnableSecureSaps=svcEnableSecureSaps, svcNumEntries=svcNumEntries, sapLastMgmtChange=sapLastMgmtChange, svcMtu=svcMtu, svcDescription=svcDescription, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtSapTraps=prvtSapTraps, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, ServObjName=ServObjName, TSapIngQueueId=TSapIngQueueId, prvtTMSdpConformance=prvtTMSdpConformance, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, ServType=ServType, prvtTMServObjs=prvtTMServObjs, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueId=sapEgrQosQueueId, sdpLastMgmtChange=sdpLastMgmtChange, custPhone=custPhone, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcAdminStatus=svcAdminStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustObjs=prvtTMCustObjs, sapRowStatus=sapRowStatus, prvtSapNotif=prvtSapNotif, prvtTMTstpConformance=prvtTMTstpConformance, svcBaseInfoEntry=svcBaseInfoEntry, custInfoTable=custInfoTable, prvtSapDeleted=prvtSapDeleted, svcLastStatusChange=svcLastStatusChange, prvtSdpTraps=prvtSdpTraps, sapEgrQosCustName=sapEgrQosCustName, sdpInfoEntry=sdpInfoEntry, SdpIdType=SdpIdType, prvtSvcStatusChanged=prvtSvcStatusChanged, svcRowStatus=svcRowStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpOperFlags=sdpOperFlags, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapEncapValue=sapEncapValue, sdpId=sdpId, custMultSvcSiteName=custMultSvcSiteName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSdpCreated=prvtSdpCreated, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, svcCustName=svcCustName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapObjs=prvtTMSapObjs, sapOperStatus=sapOperStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custRowStatus=custRowStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custLastMgmtChange=custLastMgmtChange, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSdpCompliance=prvtTMSdpCompliance, custContact=custContact, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMCustConformance=prvtTMCustConformance, sdpAdminStatus=sdpAdminStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcVPLSUplinkTable=svcVPLSUplinkTable, svcId=svcId, svcType=svcType, prvtTMSdpCompliances=prvtTMSdpCompliances, custInfoEntry=custInfoEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSvcNotif=prvtSvcNotif, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSvcCompliance=prvtTMSvcCompliance, svcRevertTimer=svcRevertTimer, prvtSdpDeleted=prvtSdpDeleted, prvtTMServConformance=prvtTMServConformance, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtSdpNotif=prvtSdpNotif, prvtSvcDeleted=prvtSvcDeleted, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcNumSdps=svcNumSdps, prvtCustNotif=prvtCustNotif, TMEncapVal=TMEncapVal, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, VpnId=VpnId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSvcGroups=prvtTMSvcGroups, svcOperStatus=svcOperStatus, sdpNextFreeId=sdpNextFreeId, svcVplsMode=svcVplsMode, prvtSvcCreated=prvtSvcCreated, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpLastStatusChange=sdpLastStatusChange, sdpInfoTable=sdpInfoTable, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpDescription=sdpDescription, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpLdpEnabled=sdpLdpEnabled, TSapEgrQueueId=TSapEgrQueueId, prvtSapStatusChanged=prvtSapStatusChanged, sdpAdminEgressLabel=sdpAdminEgressLabel, custName=custName, sdpAdminIsBackup=sdpAdminIsBackup, custMultiServiceSiteTable=custMultiServiceSiteTable, sapOperFlags=sapOperFlags, custIngQosSchedName=custIngQosSchedName, PYSNMP_MODULE_ID=prvtServicesMIB, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpVCType=sdpVCType, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcLastMgmtChange=svcLastMgmtChange, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtCustCreated=prvtCustCreated, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpRowStatus=sdpRowStatus, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpDelivery=sdpDelivery, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtSapCreated=prvtSapCreated, sapType=sapType, sdpOperIsBackup=sdpOperIsBackup, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpMtu=sdpMtu, ServObjDesc=ServObjDesc, prvtServicesMIB=prvtServicesMIB, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, ServiceOperStatus=ServiceOperStatus, prvtTMSapCompliances=prvtTMSapCompliances, sapNumEntries=sapNumEntries, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVpnId=svcVpnId, prvtTMSvcObjs=prvtTMSvcObjs, prvtCustDeleted=prvtCustDeleted, sapBaseInfoTable=sapBaseInfoTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSapGroups=prvtTMSapGroups)
