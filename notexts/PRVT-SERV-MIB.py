...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapLearnMode=sapLearnMode, sapCreated=sapCreated, sdpVCType=sdpVCType, sapUntaggedMode=sapUntaggedMode, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpTable=sdpTable, serviceId=serviceId, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceNumSdps=serviceNumSdps, customerEntry=customerEntry, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpPwPrecedence=sdpPwPrecedence, sdpMtu=sdpMtu, sapEncapValue=sapEncapValue, sdpAdminStatus=sdpAdminStatus, sapEntry=sapEntry, sdpCreated=sdpCreated, sapDescription=sapDescription, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, serviceLastMgmtChange=serviceLastMgmtChange, customerCreated=customerCreated, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMtu=serviceMtu, prvtServicesMIBObjects=prvtServicesMIBObjects, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceEntry=serviceEntry, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpOperStatus=sdpOperStatus, sdpSignalPwStatus=sdpSignalPwStatus, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceCustName=serviceCustName, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpPwActivate=sdpPwActivate, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, customerDeleted=customerDeleted, sapType=sapType, serviceCreated=serviceCreated, serviceVlanAction=serviceVlanAction, sapOperFlags=sapOperFlags, serviceTable=serviceTable, sapCurrentMacCount=sapCurrentMacCount, serviceVpnId=serviceVpnId, customerPhone=customerPhone, sdpLearnEnable=sdpLearnEnable, serviceVlanEtherType=serviceVlanEtherType, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpTransportTunnelName=sdpTransportTunnelName, sdpType=sdpType, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpSecuredEnable=sdpSecuredEnable, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sapProfileName=sapProfileName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpDescription=sdpDescription, sdpLabelSignaling=sdpLabelSignaling, sapDeleted=sapDeleted, sdpOutInterface=sdpOutInterface, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sapAdminStatus=sapAdminStatus, prvtServicesMIB=prvtServicesMIB, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpEntry=sdpEntry, serviceNumSaps=serviceNumSaps, serviceType=serviceType, sapLastMgmtChange=sapLastMgmtChange, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpDeleted=sdpDeleted, sdpAdminEgressLabel=sdpAdminEgressLabel, sapMacLearningProfileState=sapMacLearningProfileState, sdpGroupIdentifier=sdpGroupIdentifier, serviceOperStatus=serviceOperStatus, sdpLdpEnabled=sdpLdpEnabled, customerTable=customerTable, sdpId=sdpId, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sdpOperFlags=sdpOperFlags, sapTable=sapTable, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceRevertTimer=serviceRevertTimer, serviceRowStatus=serviceRowStatus, sapRowStatus=sapRowStatus, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sapIngressQosPolicyId=sapIngressQosPolicyId, customerName=customerName, sapLearnEnable=sapLearnEnable, sdpNextFreeId=sdpNextFreeId, serviceDeleted=serviceDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, customerContact=customerContact, sdpRowStatus=sdpRowStatus, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, PYSNMP_MODULE_ID=prvtServicesMIB, serviceAdminStatus=serviceAdminStatus, serviceDescription=serviceDescription, serviceEnableSecureSaps=serviceEnableSecureSaps, sapPortId=sapPortId, sdpLastMgmtChange=sdpLastMgmtChange, sapOperStatus=sapOperStatus, customerRowStatus=customerRowStatus, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpDelivery=sdpDelivery)
