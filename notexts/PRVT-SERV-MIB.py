...
MacAddress, TimeStamp, TruthValue, DisplayString, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapAdminStatus=sapAdminStatus, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, customerTable=customerTable, sdpOutInterface=sdpOutInterface, sapTable=sapTable, serviceMacAddressSapEntry=serviceMacAddressSapEntry, customerName=customerName, sdpAdminIngressLabel=sdpAdminIngressLabel, customerContact=customerContact, sdpType=sdpType, sdpPwActivate=sdpPwActivate, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sapDescription=sapDescription, serviceId=serviceId, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sapLearnEnable=sapLearnEnable, sdpMtu=sdpMtu, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpOperFlags=sdpOperFlags, sapMacLearningProfileState=sapMacLearningProfileState, serviceNumSdps=serviceNumSdps, serviceLastMgmtChange=serviceLastMgmtChange, sdpRowStatus=sdpRowStatus, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpDelivery=sdpDelivery, sapEgressQosPolicyId=sapEgressQosPolicyId, sapPortId=sapPortId, sapRowStatus=sapRowStatus, sapType=sapType, sapLearnMode=sapLearnMode, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapLastMgmtChange=sapLastMgmtChange, customerCreated=customerCreated, sdpNextFreeId=sdpNextFreeId, sdpLearnEnable=sdpLearnEnable, customerRowStatus=customerRowStatus, serviceVpnId=serviceVpnId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, serviceCustName=serviceCustName, prvtServicesMIBNotifications=prvtServicesMIBNotifications, serviceMtu=serviceMtu, sdpDescription=sdpDescription, serviceMacAddressSapPriority=serviceMacAddressSapPriority, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sdpBindVlanTag=sdpBindVlanTag, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpSecuredEnable=sdpSecuredEnable, sapEntry=sapEntry, sdpAdminStatus=sdpAdminStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, PYSNMP_MODULE_ID=prvtServicesMIB, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceDeleted=serviceDeleted, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpDeleted=sdpDeleted, serviceVlanEtherType=serviceVlanEtherType, serviceRevertTimer=serviceRevertTimer, sapCurrentMacCount=sapCurrentMacCount, serviceAdminStatus=serviceAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, sapProfileName=sapProfileName, sdpPwPrecedence=sdpPwPrecedence, serviceRowStatus=serviceRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpCreated=sdpCreated, prvtServicesMIB=prvtServicesMIB, customerPhone=customerPhone, sapDeleted=sapDeleted, sapEncapValue=sapEncapValue, sdpGroupIdentifier=sdpGroupIdentifier, sdpSignalPwStatus=sdpSignalPwStatus, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpAdminEgressLabel=sdpAdminEgressLabel, customerDeleted=customerDeleted, serviceOperStatus=serviceOperStatus, sapCreated=sapCreated, sdpEntry=sdpEntry, serviceNumSaps=serviceNumSaps, sapOperStatus=sapOperStatus, serviceDescription=serviceDescription, serviceType=serviceType, sdpLabelSignaling=sdpLabelSignaling, sapOperFlags=sapOperFlags, sdpTransportTunnelName=sdpTransportTunnelName, customerEntry=customerEntry, serviceVlanAction=serviceVlanAction, sdpOperStatus=sdpOperStatus, sdpLdpEnabled=sdpLdpEnabled, serviceTable=serviceTable, serviceEnableSecureSaps=serviceEnableSecureSaps, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpId=sdpId, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpTable=sdpTable, serviceCreated=serviceCreated, sdpVCType=sdpVCType, sapUntaggedMode=sapUntaggedMode, serviceEntry=serviceEntry, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress)
