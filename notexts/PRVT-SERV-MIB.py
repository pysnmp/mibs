...
RowStatus, TruthValue, TimeStamp, TextualConvention, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "TextualConvention", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapLastMgmtChange=sapLastMgmtChange, serviceVlanAction=serviceVlanAction, prvtServicesMIB=prvtServicesMIB, customerName=customerName, serviceRevertTimer=serviceRevertTimer, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpAdminStatus=sdpAdminStatus, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceEntry=serviceEntry, sdpCreated=sdpCreated, sapProfileName=sapProfileName, PYSNMP_MODULE_ID=prvtServicesMIB, sdpNextFreeId=sdpNextFreeId, sapTable=sapTable, serviceDeleted=serviceDeleted, sapIngressQosPolicyId=sapIngressQosPolicyId, sapDescription=sapDescription, sdpLabelSignaling=sdpLabelSignaling, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, serviceRowStatus=serviceRowStatus, serviceNumSaps=serviceNumSaps, sapRowStatus=sapRowStatus, sapCreated=sapCreated, sdpTransportTunnelName=sdpTransportTunnelName, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceId=serviceId, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sapLearnEnable=sapLearnEnable, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpEntry=sdpEntry, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpId=sdpId, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpMtu=sdpMtu, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpGroupIdentifier=sdpGroupIdentifier, sapUntaggedMode=sapUntaggedMode, customerPhone=customerPhone, serviceOperStatus=serviceOperStatus, sdpDescription=sdpDescription, serviceTable=serviceTable, sdpRowStatus=sdpRowStatus, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceCreated=serviceCreated, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sdpPwPrecedence=sdpPwPrecedence, customerRowStatus=customerRowStatus, serviceDescription=serviceDescription, sdpPwActivate=sdpPwActivate, customerCreated=customerCreated, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceNumSdps=serviceNumSdps, sapDeleted=sapDeleted, sapMacLearningProfileState=sapMacLearningProfileState, sapEncapValue=sapEncapValue, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSapPortId=serviceMacAddressSapPortId, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpLearnEnable=sdpLearnEnable, sdpLastMgmtChange=sdpLastMgmtChange, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sapLearnMode=sapLearnMode, customerDeleted=customerDeleted, sapEntry=sapEntry, sapType=sapType, customerEntry=customerEntry, sdpVCType=sdpVCType, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapAdminStatus=sapAdminStatus, sapOperFlags=sapOperFlags, sdpSignalPwStatus=sdpSignalPwStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpOutInterface=sdpOutInterface, sdpType=sdpType, sdpSecuredEnable=sdpSecuredEnable, serviceMacAddressSapEntry=serviceMacAddressSapEntry, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceEnableSecureSaps=serviceEnableSecureSaps, sapCurrentMacCount=sapCurrentMacCount, sdpDeleted=sdpDeleted, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sdpLdpEnabled=sdpLdpEnabled, sdpOperFlags=sdpOperFlags, serviceMacAddressSapPriority=serviceMacAddressSapPriority, serviceMtu=serviceMtu, serviceType=serviceType, customerTable=customerTable, serviceVlanEtherType=serviceVlanEtherType, serviceCustName=serviceCustName, sapPortId=sapPortId, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceVpnId=serviceVpnId, sdpOperStatus=sdpOperStatus, serviceLastMgmtChange=serviceLastMgmtChange, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapOperStatus=sapOperStatus, sdpTable=sdpTable, serviceAdminStatus=serviceAdminStatus, sdpDelivery=sdpDelivery, customerContact=customerContact)
