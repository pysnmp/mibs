...
TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custInfoTable=custInfoTable, sapIngressQosPolicyId=sapIngressQosPolicyId, sapNumEntries=sapNumEntries, sapOperFlags=sapOperFlags, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtCustNotif=prvtCustNotif, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMServObjs=prvtTMServObjs, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSdpGroups=prvtTMSdpGroups, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcNumEntries=svcNumEntries, sdpNextFreeId=sdpNextFreeId, sdpDescription=sdpDescription, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpAdminStatus=sdpAdminStatus, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSapTraps=prvtSapTraps, sapPortId=sapPortId, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, sdpLastStatusChange=sdpLastStatusChange, svcRevertTimer=svcRevertTimer, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpNumEntries=sdpNumEntries, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSvcConformance=prvtTMSvcConformance, prvtSapNotif=prvtSapNotif, svcMtu=svcMtu, sdpOutInterface=sdpOutInterface, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtServNotifications=prvtServNotifications, prvtSdpStatusChanged=prvtSdpStatusChanged, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosSchedName=sapIngQosSchedName, custPhone=custPhone, prvtTMTstpConformance=prvtTMTstpConformance, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, SdpIdType=SdpIdType, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, ServObjName=ServObjName, sdpOperIsBackup=sdpOperIsBackup, sdpVCType=sdpVCType, prvtSdpTraps=prvtSdpTraps, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcCustName=svcCustName, sapType=sapType, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultSvcSiteName=custMultSvcSiteName, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpBindVlanTag=sdpBindVlanTag, prvtSvcTraps=prvtSvcTraps, prvtTMSapObjs=prvtTMSapObjs, svcOperStatus=svcOperStatus, sdpInfoTable=sdpInfoTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSdpConformance=prvtTMSdpConformance, prvtCustDeleted=prvtCustDeleted, prvtSapCreated=prvtSapCreated, sapEgrQosCustName=sapEgrQosCustName, svcRowStatus=svcRowStatus, sdpLdpEnabled=sdpLdpEnabled, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custInfoEntry=custInfoEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSapStatusChanged=prvtSapStatusChanged, prvtSdpCreated=prvtSdpCreated, VpnId=VpnId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSvcCreated=prvtSvcCreated, sapEgrQosQueueId=sapEgrQosQueueId, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, svcId=svcId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpLastMgmtChange=sdpLastMgmtChange, svcType=svcType, prvtTMSapCompliances=prvtTMSapCompliances, prvtSvcNotif=prvtSvcNotif, custRowStatus=custRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custIngQosSchedName=custIngQosSchedName, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustGroups=prvtTMCustGroups, prvtTMSdpCompliances=prvtTMSdpCompliances, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSdpNotif=prvtSdpNotif, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, TSapIngQueueId=TSapIngQueueId, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpOperFlags=sdpOperFlags, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpAdminIsBackup=sdpAdminIsBackup, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEncapValue=sapEncapValue, prvtTMSapGroups=prvtTMSapGroups, ServObjDesc=ServObjDesc, prvtTMCustConformance=prvtTMCustConformance, custMultiServiceSiteTable=custMultiServiceSiteTable, sapLearnMode=sapLearnMode, TSapEgrQueueId=TSapEgrQueueId, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custName=custName, PYSNMP_MODULE_ID=prvtServicesMIB, sdpId=sdpId, prvtCustTraps=prvtCustTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, TMEncapVal=TMEncapVal, svcAdminStatus=svcAdminStatus, prvtTMServConformance=prvtTMServConformance, sapRowStatus=sapRowStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpTransportTunnelName=sdpTransportTunnelName, sapAdminStatus=sapAdminStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSvcCompliances=prvtTMSvcCompliances, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpLabelSignaling=sdpLabelSignaling, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcDescription=svcDescription, prvtServicesMIB=prvtServicesMIB, svcBaseInfoTable=svcBaseInfoTable, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpAdminEgressLabel=sdpAdminEgressLabel, sapDescription=sapDescription, sdpDelivery=sdpDelivery, ServiceOperStatus=ServiceOperStatus, svcNumSdps=svcNumSdps, ServType=ServType, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcLastStatusChange=svcLastStatusChange, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSvcGroups=prvtTMSvcGroups, svcNumSaps=svcNumSaps, sapBaseInfoTable=sapBaseInfoTable, sdpGroupIdentifier=sdpGroupIdentifier, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapOperStatus=sapOperStatus, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMCustObjs=prvtTMCustObjs, prvtSapDeleted=prvtSapDeleted, sdpMtu=sdpMtu, custEgrQosSchedName=custEgrQosSchedName, custNumEntries=custNumEntries, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpOperStatus=sdpOperStatus, prvtCustCreated=prvtCustCreated, ServiceAdminStatus=ServiceAdminStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapLastMgmtChange=sapLastMgmtChange, sapIngQosCustName=sapIngQosCustName, prvtTMSdpCompliance=prvtTMSdpCompliance, svcVpnId=svcVpnId, sdpType=sdpType, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpRowStatus=sdpRowStatus, sdpInfoEntry=sdpInfoEntry, custContact=custContact, prvtSvcDeleted=prvtSvcDeleted)
