...
TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custName=custName, prvtSvcTraps=prvtSvcTraps, prvtSapNotif=prvtSapNotif, svcAdminStatus=svcAdminStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapLastMgmtChange=sapLastMgmtChange, prvtSdpNotif=prvtSdpNotif, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSapConformance=prvtTMSapConformance, sdpLdpEnabled=sdpLdpEnabled, prvtTMServConformance=prvtTMServConformance, ServObjDesc=ServObjDesc, prvtTMCustObjs=prvtTMCustObjs, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSvcGroups=prvtTMSvcGroups, sdpDescription=sdpDescription, sapOperFlags=sapOperFlags, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpObjs=prvtTMSdpObjs, svcRevertTimer=svcRevertTimer, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSdpGroups=prvtTMSdpGroups, sdpDelivery=sdpDelivery, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSapCreated=prvtSapCreated, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcBaseInfoTable=svcBaseInfoTable, svcLastStatusChange=svcLastStatusChange, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpTransportTunnelName=sdpTransportTunnelName, sdpType=sdpType, prvtTMSapCompliance=prvtTMSapCompliance, TMEncapVal=TMEncapVal, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpInfoEntry=sdpInfoEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpBindVlanTag=sdpBindVlanTag, custContact=custContact, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpNumEntries=sdpNumEntries, prvtTMServObjs=prvtTMServObjs, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapPortId=sapPortId, prvtServicesMIB=prvtServicesMIB, sapOperStatus=sapOperStatus, sdpOutInterface=sdpOutInterface, ServObjName=ServObjName, svcId=svcId, custEgrQosSchedName=custEgrQosSchedName, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtCustCreated=prvtCustCreated, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtTMCustConformance=prvtTMCustConformance, prvtSvcNotif=prvtSvcNotif, custInfoTable=custInfoTable, svcNumSaps=svcNumSaps, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custIngQosSchedName=custIngQosSchedName, custLastMgmtChange=custLastMgmtChange, svcMtu=svcMtu, svcDescription=svcDescription, sapNumEntries=sapNumEntries, sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapType=sapType, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapLearnMode=sapLearnMode, prvtSdpTraps=prvtSdpTraps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcNumSdps=svcNumSdps, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosSchedCustName=sapIngQosSchedCustName, svcVplsMode=svcVplsMode, sdpRowStatus=sdpRowStatus, sdpAdminStatus=sdpAdminStatus, prvtSdpDeleted=prvtSdpDeleted, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapDescription=sapDescription, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtCustDeleted=prvtCustDeleted, sapBaseInfoTable=sapBaseInfoTable, sdpId=sdpId, sdpVCType=sdpVCType, prvtSdpStatusChanged=prvtSdpStatusChanged, custNumEntries=custNumEntries, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcRowStatus=svcRowStatus, sdpInfoTable=sdpInfoTable, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSapCompliances=prvtTMSapCompliances, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtCustNotif=prvtCustNotif, prvtSvcStatusChanged=prvtSvcStatusChanged, svcBaseInfoEntry=svcBaseInfoEntry, SdpIdType=SdpIdType, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custInfoEntry=custInfoEntry, ServType=ServType, svcOperStatus=svcOperStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, ServiceOperStatus=ServiceOperStatus, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcNumEntries=svcNumEntries, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, TSapEgrQueueId=TSapEgrQueueId, prvtServNotifications=prvtServNotifications, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpOperFlags=sdpOperFlags, prvtSdpCreated=prvtSdpCreated, TSapIngQueueId=TSapIngQueueId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapAdminStatus=sapAdminStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, PYSNMP_MODULE_ID=prvtServicesMIB, sdpOperStatus=sdpOperStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSapDeleted=prvtSapDeleted, svcVpnId=svcVpnId, prvtTMCustCompliances=prvtTMCustCompliances, sapBaseInfoEntry=sapBaseInfoEntry, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtSapTraps=prvtSapTraps, custMultSvcSiteName=custMultSvcSiteName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpMtu=sdpMtu, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapRowStatus=sapRowStatus, sapEncapValue=sapEncapValue, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSdpConformance=prvtTMSdpConformance, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpGroupIdentifier=sdpGroupIdentifier, VpnId=VpnId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedName=sapIngQosSchedName, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustGroups=prvtTMCustGroups, prvtTMSapGroups=prvtTMSapGroups, sdpOperIsBackup=sdpOperIsBackup, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSapStatusChanged=prvtSapStatusChanged, svcType=svcType, prvtSvcCreated=prvtSvcCreated, prvtTMCustCompliance=prvtTMCustCompliance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcCustName=svcCustName, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, ServiceAdminStatus=ServiceAdminStatus, custPhone=custPhone, prvtSvcDeleted=prvtSvcDeleted, prvtCustTraps=prvtCustTraps, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSapObjs=prvtTMSapObjs, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custRowStatus=custRowStatus)
