...
serviceAccessSwitch, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMCustGroups=prvtTMCustGroups, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custName=custName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpNumEntries=sdpNumEntries, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpId=sdpId, sdpType=sdpType, prvtTMSapCompliances=prvtTMSapCompliances, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMCustConformance=prvtTMCustConformance, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpOperIsBackup=sdpOperIsBackup, prvtSvcTraps=prvtSvcTraps, sdpBindVlanTag=sdpBindVlanTag, sapOperStatus=sapOperStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpOutInterface=sdpOutInterface, prvtCustCreated=prvtCustCreated, sapLastMgmtChange=sapLastMgmtChange, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosSchedName=sapEgrQosSchedName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, ServiceAdminStatus=ServiceAdminStatus, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpLabelSignaling=sdpLabelSignaling, svcVPLSUplinkTable=svcVPLSUplinkTable, svcId=svcId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcDescription=svcDescription, prvtSdpDeleted=prvtSdpDeleted, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtSvcDeleted=prvtSvcDeleted, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosCustName=sapIngQosCustName, svcNumEntries=svcNumEntries, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpOperFlags=sdpOperFlags, ServType=ServType, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultSvcSiteDescription=custMultSvcSiteDescription, sapPortId=sapPortId, sdpMtu=sdpMtu, sdpDelivery=sdpDelivery, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapDescription=sapDescription, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSdpCreated=prvtSdpCreated, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosCustName=sapEgrQosCustName, sdpInfoEntry=sdpInfoEntry, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMServObjs=prvtTMServObjs, custContact=custContact, custIngQosSchedName=custIngQosSchedName, sapType=sapType, TSapEgrQueueId=TSapEgrQueueId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custNumEntries=custNumEntries, sdpAdminIsBackup=sdpAdminIsBackup, prvtSapNotif=prvtSapNotif, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, ServObjName=ServObjName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosSchedCustName=sapIngQosSchedCustName, svcBaseInfoEntry=svcBaseInfoEntry, svcNumSdps=svcNumSdps, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, SdpIdType=SdpIdType, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, ServObjDesc=ServObjDesc, svcOperStatus=svcOperStatus, sdpFarEndIpAddress=sdpFarEndIpAddress, sapNumEntries=sapNumEntries, sapRowStatus=sapRowStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, ServiceOperStatus=ServiceOperStatus, prvtTMSapObjs=prvtTMSapObjs, svcNumSaps=svcNumSaps, sdpLastStatusChange=sdpLastStatusChange, prvtServNotifications=prvtServNotifications, svcCustName=svcCustName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSdpCompliance=prvtTMSdpCompliance, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSapConformance=prvtTMSapConformance, prvtSapDeleted=prvtSapDeleted, custPhone=custPhone, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpInfoTable=sdpInfoTable, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapLearnMode=sapLearnMode, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSapTraps=prvtSapTraps, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMCustObjs=prvtTMCustObjs, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSdpNotif=prvtSdpNotif, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custInfoEntry=custInfoEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpAdminEgressLabel=sdpAdminEgressLabel, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapBaseInfoTable=sapBaseInfoTable, VpnId=VpnId, prvtCustTraps=prvtCustTraps, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpTransportTunnelName=sdpTransportTunnelName, sapAdminStatus=sapAdminStatus, sapIngQosSchedName=sapIngQosSchedName, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custEgrQosSchedName=custEgrQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpNextFreeId=sdpNextFreeId, prvtSapCreated=prvtSapCreated, TSapIngQueueId=TSapIngQueueId, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSdpConformance=prvtTMSdpConformance, custRowStatus=custRowStatus, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcBaseInfoTable=svcBaseInfoTable, prvtTMServConformance=prvtTMServConformance, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcType=svcType, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSapGroups=prvtTMSapGroups, svcMtu=svcMtu, svcAdminStatus=svcAdminStatus, prvtTMTstpConformance=prvtTMTstpConformance, prvtServicesMIB=prvtServicesMIB, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEncapValue=sapEncapValue, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcVpnId=svcVpnId, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcRowStatus=svcRowStatus, svcVplsMode=svcVplsMode, svcLastStatusChange=svcLastStatusChange, sdpAdminStatus=sdpAdminStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtCustNotif=prvtCustNotif, custInfoTable=custInfoTable, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapOperFlags=sapOperFlags, custMultSvcSiteName=custMultSvcSiteName, sdpVCType=sdpVCType, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtSapStatusChanged=prvtSapStatusChanged, prvtSvcNotif=prvtSvcNotif, svcRevertTimer=svcRevertTimer, sdpOperStatus=sdpOperStatus, prvtTMSvcGroups=prvtTMSvcGroups, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpDescription=sdpDescription, TMEncapVal=TMEncapVal)
