...
TNamedItemOrEmpty, TNamedItem, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNamedItem", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpRowStatus=sdpRowStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custLastMgmtChange=custLastMgmtChange, custPhone=custPhone, custInfoEntry=custInfoEntry, custRowStatus=custRowStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSvcConformance=prvtTMSvcConformance, sdpNumEntries=sdpNumEntries, prvtTMCustConformance=prvtTMCustConformance, sdpFarEndIpAddress=sdpFarEndIpAddress, svcLastMgmtChange=svcLastMgmtChange, sapOperFlags=sapOperFlags, prvtSapStatusChanged=prvtSapStatusChanged, sdpOutInterface=sdpOutInterface, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSdpConformance=prvtTMSdpConformance, sdpId=sdpId, svcLastStatusChange=svcLastStatusChange, sdpBindVlanTag=sdpBindVlanTag, svcAdminStatus=svcAdminStatus, svcNumSaps=svcNumSaps, prvtSdpDeleted=prvtSdpDeleted, ServObjDesc=ServObjDesc, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, TSapIngQueueId=TSapIngQueueId, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSapGroups=prvtTMSapGroups, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, TMEncapVal=TMEncapVal, prvtSapDeleted=prvtSapDeleted, sapRowStatus=sapRowStatus, sdpInfoTable=sdpInfoTable, sdpVCType=sdpVCType, custIngQosSchedName=custIngQosSchedName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSdpCreated=prvtSdpCreated, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcGroups=prvtTMSvcGroups, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custInfoTable=custInfoTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMServObjs=prvtTMServObjs, prvtSapTraps=prvtSapTraps, prvtTMSapObjs=prvtTMSapObjs, sdpLdpEnabled=sdpLdpEnabled, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapBaseInfoEntry=sapBaseInfoEntry, svcNumSdps=svcNumSdps, prvtSapCreated=prvtSapCreated, prvtServicesMIB=prvtServicesMIB, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpAdminIngressLabel=sdpAdminIngressLabel, ServType=ServType, svcNumEntries=svcNumEntries, sapPortId=sapPortId, svcType=svcType, sapAdminStatus=sapAdminStatus, sdpAdminStatus=sdpAdminStatus, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcMtu=svcMtu, prvtTMSvcCompliances=prvtTMSvcCompliances, custEgrQosSchedName=custEgrQosSchedName, prvtCustTraps=prvtCustTraps, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSdpObjs=prvtTMSdpObjs, prvtCustDeleted=prvtCustDeleted, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpDescription=sdpDescription, sapEgrQosCustName=sapEgrQosCustName, prvtSapNotif=prvtSapNotif, prvtTMSvcObjs=prvtTMSvcObjs, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sdpNextFreeId=sdpNextFreeId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSvcCreated=prvtSvcCreated, prvtSvcDeleted=prvtSvcDeleted, sapBaseInfoTable=sapBaseInfoTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, ServiceOperStatus=ServiceOperStatus, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpLastStatusChange=sdpLastStatusChange, custContact=custContact, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSvcStatusChanged=prvtSvcStatusChanged, custMultSvcSiteName=custMultSvcSiteName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpTransportTunnelName=sdpTransportTunnelName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapIngQosSchedName=sapIngQosSchedName, sdpInfoEntry=sdpInfoEntry, prvtCustCreated=prvtCustCreated, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedName=sapEgrQosSchedName, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSdpGroups=prvtTMSdpGroups, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapOperStatus=sapOperStatus, svcDescription=svcDescription, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMServConformance=prvtTMServConformance, sdpMtu=sdpMtu, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcBaseInfoTable=svcBaseInfoTable, ServiceAdminStatus=ServiceAdminStatus, ServObjName=ServObjName, custName=custName, sdpOperFlags=sdpOperFlags, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapDescription=sapDescription, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngressQosPolicyId=sapIngressQosPolicyId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpGroupIdentifier=sdpGroupIdentifier, svcId=svcId, sapIngQosCustName=sapIngQosCustName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcOperStatus=svcOperStatus, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcRowStatus=svcRowStatus, prvtTMSdpCompliances=prvtTMSdpCompliances, sapNumEntries=sapNumEntries, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpDelivery=sdpDelivery, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMTstpConformance=prvtTMTstpConformance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcEnableSecureSaps=svcEnableSecureSaps, svcVplsMode=svcVplsMode, sapIngQosQueueId=sapIngQosQueueId, prvtTMSapCompliances=prvtTMSapCompliances, sapLearnMode=sapLearnMode, SdpIdType=SdpIdType, sapType=sapType, prvtTMSvcCompliance=prvtTMSvcCompliance, svcVpnId=svcVpnId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, TSapEgrQueueId=TSapEgrQueueId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueId=sapEgrQosQueueId, VpnId=VpnId, prvtTMSapConformance=prvtTMSapConformance, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpType=sdpType, prvtSdpTraps=prvtSdpTraps, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtServNotifications=prvtServNotifications, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpOperStatus=sdpOperStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtCustNotif=prvtCustNotif, prvtTMCustCompliance=prvtTMCustCompliance, svcCustName=svcCustName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcRevertTimer=svcRevertTimer, sapEncapValue=sapEncapValue, prvtTMCustObjs=prvtTMCustObjs, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSdpNotif=prvtSdpNotif, custNumEntries=custNumEntries, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpLastMgmtChange=sdpLastMgmtChange, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets)
