...
MacAddress, TruthValue, DisplayString, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TruthValue", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceMacAddressSapPriority=serviceMacAddressSapPriority, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceVlanEtherType=serviceVlanEtherType, customerTable=customerTable, serviceId=serviceId, sdpNextFreeId=sdpNextFreeId, sdpDescription=sdpDescription, serviceCustName=serviceCustName, serviceBackupVlanEtherType=serviceBackupVlanEtherType, customerDeleted=customerDeleted, serviceEnableSecureSaps=serviceEnableSecureSaps, sdpDelivery=sdpDelivery, sdpAdminStatus=sdpAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceMacAddressSdpId=serviceMacAddressSdpId, sapDescription=sapDescription, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpVCType=sdpVCType, customerName=customerName, serviceVpnId=serviceVpnId, serviceLastMgmtChange=serviceLastMgmtChange, customerEntry=customerEntry, sdpLabelSignaling=sdpLabelSignaling, sapCreated=sapCreated, sdpOperStatus=sdpOperStatus, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, serviceAdminStatus=serviceAdminStatus, serviceTable=serviceTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEncapValue=sapEncapValue, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sapOperFlags=sapOperFlags, serviceCreated=serviceCreated, serviceType=serviceType, sdpId=sdpId, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapUntaggedMode=sapUntaggedMode, serviceNumSaps=serviceNumSaps, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpOutInterface=sdpOutInterface, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpEntry=sdpEntry, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceRevertTimer=serviceRevertTimer, sapTable=sapTable, customerContact=customerContact, sapCustMultSvcSiteName=sapCustMultSvcSiteName, serviceDescription=serviceDescription, sapCurrentMacCount=sapCurrentMacCount, PYSNMP_MODULE_ID=prvtServicesMIB, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpPwPrecedence=sdpPwPrecedence, serviceNumSdps=serviceNumSdps, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapProfileName=sapProfileName, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceVlanAction=serviceVlanAction, sdpMtu=sdpMtu, sdpOperFlags=sdpOperFlags, sdpRowStatus=sdpRowStatus, sapEntry=sapEntry, serviceMtu=serviceMtu, customerPhone=customerPhone, sdpTransportTunnelName=sdpTransportTunnelName, sapLearnMode=sapLearnMode, sdpLdpEnabled=sdpLdpEnabled, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpType=sdpType, serviceRowStatus=serviceRowStatus, sapDeleted=sapDeleted, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceEntry=serviceEntry, sapMacLearningProfileState=sapMacLearningProfileState, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, customerCreated=customerCreated, serviceOperStatus=serviceOperStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapIngressQosPolicyId=sapIngressQosPolicyId, sapOperStatus=sapOperStatus, sdpSecuredEnable=sdpSecuredEnable, customerRowStatus=customerRowStatus, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpTable=sdpTable, sdpDeleted=sdpDeleted, sapRowStatus=sapRowStatus, sdpSignalPwStatus=sdpSignalPwStatus, sdpCreated=sdpCreated, serviceDeleted=serviceDeleted, sapLearnEnable=sapLearnEnable, prvtServicesMIB=prvtServicesMIB, sapPortId=sapPortId, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapType=sapType, sapLastMgmtChange=sapLastMgmtChange, sapAdminStatus=sapAdminStatus, sdpLearnEnable=sdpLearnEnable, sdpPwActivate=sdpPwActivate, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpGroupIdentifier=sdpGroupIdentifier)
