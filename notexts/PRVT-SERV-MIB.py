...
TNamedItem, TNamedItemOrEmpty, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custContact=custContact, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcDescription=svcDescription, sapLastMgmtChange=sapLastMgmtChange, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSdpConformance=prvtTMSdpConformance, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpInfoTable=sdpInfoTable, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtCustNotif=prvtCustNotif, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSvcConformance=prvtTMSvcConformance, sapEncapValue=sapEncapValue, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapOperFlags=sapOperFlags, sapLearnMode=sapLearnMode, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcVpnId=svcVpnId, sdpBindVlanTag=sdpBindVlanTag, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcMtu=svcMtu, prvtTMTstpConformance=prvtTMTstpConformance, sdpVCType=sdpVCType, custInfoEntry=custInfoEntry, svcNumSdps=svcNumSdps, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpInfoEntry=sdpInfoEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSapCompliances=prvtTMSapCompliances, prvtServicesMIB=prvtServicesMIB, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosCustName=sapIngQosCustName, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustCompliances=prvtTMCustCompliances, ServiceOperStatus=ServiceOperStatus, svcLastMgmtChange=svcLastMgmtChange, ServObjDesc=ServObjDesc, TMEncapVal=TMEncapVal, sdpOperFlags=sdpOperFlags, svcNumSaps=svcNumSaps, svcCustName=svcCustName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSapCompliance=prvtTMSapCompliance, prvtCustTraps=prvtCustTraps, sapBaseInfoTable=sapBaseInfoTable, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMServConformance=prvtTMServConformance, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSapConformance=prvtTMSapConformance, custLastMgmtChange=custLastMgmtChange, prvtServNotifications=prvtServNotifications, ServiceAdminStatus=ServiceAdminStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultSvcSiteName=custMultSvcSiteName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSdpDeleted=prvtSdpDeleted, custNumEntries=custNumEntries, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustConformance=prvtTMCustConformance, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustDeleted=prvtCustDeleted, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, svcVplsMode=svcVplsMode, sapAdminStatus=sapAdminStatus, prvtTMCustGroups=prvtTMCustGroups, svcOperStatus=svcOperStatus, prvtTMSdpGroups=prvtTMSdpGroups, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSapGroups=prvtTMSapGroups, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSapDeleted=prvtSapDeleted, svcType=svcType, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtCustCreated=prvtCustCreated, sapOperStatus=sapOperStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpOperIsBackup=sdpOperIsBackup, sdpNumEntries=sdpNumEntries, sdpTransportTunnelName=sdpTransportTunnelName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMCustObjs=prvtTMCustObjs, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapRowStatus=sapRowStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMServObjs=prvtTMServObjs, sdpType=sdpType, custMultSvcSiteDescription=custMultSvcSiteDescription, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custInfoTable=custInfoTable, custRowStatus=custRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpLastStatusChange=sdpLastStatusChange, prvtSvcDeleted=prvtSvcDeleted, custName=custName, svcLastStatusChange=svcLastStatusChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, SdpIdType=SdpIdType, svcEnableSecureSaps=svcEnableSecureSaps, sdpId=sdpId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapPortId=sapPortId, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSdpTraps=prvtSdpTraps, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpNextFreeId=sdpNextFreeId, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSapCreated=prvtSapCreated, sapIngQosQueueId=sapIngQosQueueId, sapType=sapType, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSapNotif=prvtSapNotif, prvtSvcTraps=prvtSvcTraps, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapBaseInfoEntry=sapBaseInfoEntry, svcRevertTimer=svcRevertTimer, sdpRowStatus=sdpRowStatus, sdpDescription=sdpDescription, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpMtu=sdpMtu, sdpDelivery=sdpDelivery, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosSchedName=custEgrQosSchedName, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapDescription=sapDescription, sdpLabelSignaling=sdpLabelSignaling, sdpAdminIsBackup=sdpAdminIsBackup, svcRowStatus=svcRowStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSdpCreated=prvtSdpCreated, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcNumEntries=svcNumEntries, sapNumEntries=sapNumEntries, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpAdminStatus=sdpAdminStatus, svcBaseInfoTable=svcBaseInfoTable, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custPhone=custPhone, svcId=svcId, prvtSvcNotif=prvtSvcNotif, ServObjName=ServObjName, prvtTMSdpObjs=prvtTMSdpObjs, custIngQosSchedName=custIngQosSchedName, prvtSapTraps=prvtSapTraps, custMultiServiceSiteEntry=custMultiServiceSiteEntry, VpnId=VpnId, TSapIngQueueId=TSapIngQueueId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpOperStatus=sdpOperStatus, ServType=ServType, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosCustName=sapEgrQosCustName)
