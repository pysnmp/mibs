...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpOperFlags=sdpOperFlags, svcVplsMode=svcVplsMode, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSdpConformance=prvtTMSdpConformance, svcAdminStatus=svcAdminStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custInfoTable=custInfoTable, prvtSvcDeleted=prvtSvcDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcVpnId=svcVpnId, prvtCustDeleted=prvtCustDeleted, sdpInfoTable=sdpInfoTable, svcNumEntries=svcNumEntries, custRowStatus=custRowStatus, svcOperStatus=svcOperStatus, svcLastStatusChange=svcLastStatusChange, prvtTMCustGroups=prvtTMCustGroups, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpBindVlanTag=sdpBindVlanTag, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSdpObjs=prvtTMSdpObjs, custName=custName, svcCustName=svcCustName, custIngQosSchedName=custIngQosSchedName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSapCreated=prvtSapCreated, sdpTransportTunnelName=sdpTransportTunnelName, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, TMEncapVal=TMEncapVal, prvtTMCustObjs=prvtTMCustObjs, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpDescription=sdpDescription, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpId=sdpId, prvtServNotifications=prvtServNotifications, sdpAdminIsBackup=sdpAdminIsBackup, custLastMgmtChange=custLastMgmtChange, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSapStatusChanged=prvtSapStatusChanged, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, sapEncapValue=sapEncapValue, prvtTMSapCompliance=prvtTMSapCompliance, prvtCustNotif=prvtCustNotif, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpOperStatus=sdpOperStatus, prvtCustCreated=prvtCustCreated, sapAdminStatus=sapAdminStatus, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueId=sapIngQosQueueId, svcRowStatus=svcRowStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpOutInterface=sdpOutInterface, prvtTMSapGroups=prvtTMSapGroups, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpInfoEntry=sdpInfoEntry, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, SdpIdType=SdpIdType, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpAdminIngressLabel=sdpAdminIngressLabel, custInfoEntry=custInfoEntry, custPhone=custPhone, svcEnableSecureSaps=svcEnableSecureSaps, sapDescription=sapDescription, prvtTMTstpConformance=prvtTMTstpConformance, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedName=sapIngQosSchedName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapType=sapType, svcRevertTimer=svcRevertTimer, sapIngQosSchedCustName=sapIngQosSchedCustName, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSvcConformance=prvtTMSvcConformance, ServiceAdminStatus=ServiceAdminStatus, svcDescription=svcDescription, sapPortId=sapPortId, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpType=sdpType, sdpRowStatus=sdpRowStatus, sdpNumEntries=sdpNumEntries, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSvcCompliances=prvtTMSvcCompliances, sapNumEntries=sapNumEntries, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosSchedName=sapEgrQosSchedName, prvtSapDeleted=prvtSapDeleted, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSvcNotif=prvtSvcNotif, custNumEntries=custNumEntries, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMCustCompliances=prvtTMCustCompliances, sdpOperIsBackup=sdpOperIsBackup, sdpLabelSignaling=sdpLabelSignaling, ServObjName=ServObjName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcNumSdps=svcNumSdps, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcType=svcType, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custEgrQosSchedName=custEgrQosSchedName, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSapObjs=prvtTMSapObjs, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMCustConformance=prvtTMCustConformance, prvtTMSapConformance=prvtTMSapConformance, VpnId=VpnId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, TSapIngQueueId=TSapIngQueueId, sapOperFlags=sapOperFlags, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtSdpTraps=prvtSdpTraps, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapLearnMode=sapLearnMode, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, PYSNMP_MODULE_ID=prvtServicesMIB, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpNextFreeId=sdpNextFreeId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpMtu=sdpMtu, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpLastStatusChange=sdpLastStatusChange, sdpLastMgmtChange=sdpLastMgmtChange, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultSvcSiteName=custMultSvcSiteName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcBaseInfoTable=svcBaseInfoTable, prvtSapNotif=prvtSapNotif, sapRowStatus=sapRowStatus, prvtSvcCreated=prvtSvcCreated, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSvcTraps=prvtSvcTraps, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpAdminStatus=sdpAdminStatus, sdpDelivery=sdpDelivery, custContact=custContact, svcId=svcId, ServObjDesc=ServObjDesc, sdpLdpEnabled=sdpLdpEnabled, prvtCustTraps=prvtCustTraps, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcNumSaps=svcNumSaps, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapOperStatus=sapOperStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcMtu=svcMtu, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosCustName=sapIngQosCustName, sapEgrQosCustName=sapEgrQosCustName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSdpNotif=prvtSdpNotif, sapBaseInfoTable=sapBaseInfoTable, prvtSapTraps=prvtSapTraps, sapBaseInfoEntry=sapBaseInfoEntry, prvtSdpCreated=prvtSdpCreated, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, ServType=ServType, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosQueueId=sapEgrQosQueueId, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpVCType=sdpVCType, prvtSvcStatusChanged=prvtSvcStatusChanged, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapLastMgmtChange=sapLastMgmtChange, prvtServicesMIB=prvtServicesMIB, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpDeleted=prvtSdpDeleted, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, ServiceOperStatus=ServiceOperStatus)
