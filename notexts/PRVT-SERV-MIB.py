...
TSapIngressPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosCustName=sapEgrQosCustName, prvtSapTraps=prvtSapTraps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, svcVplsMode=svcVplsMode, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtSdpNotif=prvtSdpNotif, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, ServiceAdminStatus=ServiceAdminStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMCustGroups=prvtTMCustGroups, TMEncapVal=TMEncapVal, VpnId=VpnId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSdpCreated=prvtSdpCreated, svcType=svcType, sdpOutInterface=sdpOutInterface, SdpIdType=SdpIdType, prvtSvcDeleted=prvtSvcDeleted, prvtTMCustConformance=prvtTMCustConformance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSapObjs=prvtTMSapObjs, svcNumEntries=svcNumEntries, svcRevertTimer=svcRevertTimer, custMultiServiceSiteTable=custMultiServiceSiteTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSapConformance=prvtTMSapConformance, custInfoEntry=custInfoEntry, prvtTMSvcObjs=prvtTMSvcObjs, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosSchedCustName=sapIngQosSchedCustName, sapDescription=sapDescription, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custInfoTable=custInfoTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMServObjs=prvtTMServObjs, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMCustCompliances=prvtTMCustCompliances, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapNumEntries=sapNumEntries, sdpType=sdpType, sdpMtu=sdpMtu, prvtSapStatusChanged=prvtSapStatusChanged, TSapIngQueueId=TSapIngQueueId, prvtSvcCreated=prvtSvcCreated, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMCustCompliance=prvtTMCustCompliance, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapBaseInfoTable=sapBaseInfoTable, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSvcCompliances=prvtTMSvcCompliances, custNumEntries=custNumEntries, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapRowStatus=sapRowStatus, prvtCustTraps=prvtCustTraps, sdpOperStatus=sdpOperStatus, sdpLabelSignaling=sdpLabelSignaling, sapBaseInfoEntry=sapBaseInfoEntry, prvtSdpTraps=prvtSdpTraps, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sdpInfoTable=sdpInfoTable, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpId=sdpId, prvtCustNotif=prvtCustNotif, svcCustName=svcCustName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpVCType=sdpVCType, sapLearnMode=sapLearnMode, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, PYSNMP_MODULE_ID=prvtServicesMIB, ServObjName=ServObjName, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMServConformance=prvtTMServConformance, svcBaseInfoEntry=svcBaseInfoEntry, svcVpnId=svcVpnId, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcRowStatus=svcRowStatus, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEncapValue=sapEncapValue, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, ServObjDesc=ServObjDesc, sapIngQosSchedName=sapIngQosSchedName, custPhone=custPhone, prvtTMSvcGroups=prvtTMSvcGroups, prvtServicesMIB=prvtServicesMIB, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSvcCompliance=prvtTMSvcCompliance, svcAdminStatus=svcAdminStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtCustDeleted=prvtCustDeleted, svcNumSdps=svcNumSdps, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueId=sapIngQosQueueId, ServType=ServType, svcLastMgmtChange=svcLastMgmtChange, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custLastMgmtChange=custLastMgmtChange, sdpBindVlanTag=sdpBindVlanTag, TSapEgrQueueId=TSapEgrQueueId, svcMtu=svcMtu, sapOperFlags=sapOperFlags, sapAdminStatus=sapAdminStatus, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMSvcConformance=prvtTMSvcConformance, custIngQosSchedName=custIngQosSchedName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpDescription=sdpDescription, sdpLastStatusChange=sdpLastStatusChange, prvtTMCustObjs=prvtTMCustObjs, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpTransportTunnelName=sdpTransportTunnelName, sdpAdminIsBackup=sdpAdminIsBackup, prvtSapCreated=prvtSapCreated, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcEnableSecureSaps=svcEnableSecureSaps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcOperStatus=svcOperStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapType=sapType, sdpNextFreeId=sdpNextFreeId, sdpOperFlags=sdpOperFlags, custRowStatus=custRowStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpDelivery=sdpDelivery, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpInfoEntry=sdpInfoEntry, custContact=custContact, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultSvcSiteName=custMultSvcSiteName, sdpNumEntries=sdpNumEntries, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpLastMgmtChange=sdpLastMgmtChange, prvtSdpDeleted=prvtSdpDeleted, svcBaseInfoTable=svcBaseInfoTable, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custName=custName, svcNumSaps=svcNumSaps, ServiceOperStatus=ServiceOperStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapPortId=sapPortId, prvtSvcTraps=prvtSvcTraps, prvtTMSdpConformance=prvtTMSdpConformance, prvtSapDeleted=prvtSapDeleted, sdpOperIsBackup=sdpOperIsBackup, prvtTMSdpCompliances=prvtTMSdpCompliances, svcId=svcId, svcDescription=svcDescription, sapOperStatus=sapOperStatus, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSapGroups=prvtTMSapGroups, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpRowStatus=sdpRowStatus, custEgrQosSchedName=custEgrQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtCustCreated=prvtCustCreated, sdpAdminStatus=sdpAdminStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtSapNotif=prvtSapNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosCustName=sapIngQosCustName)
