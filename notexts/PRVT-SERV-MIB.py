...
TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpBindVlanTag=sdpBindVlanTag, prvtSapNotif=prvtSapNotif, svcNumSdps=svcNumSdps, sapIngQosSchedName=sapIngQosSchedName, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosSchedName=custEgrQosSchedName, svcMtu=svcMtu, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapIngQosCustName=sapIngQosCustName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcAdminStatus=svcAdminStatus, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpInfoEntry=sdpInfoEntry, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, PYSNMP_MODULE_ID=prvtServicesMIB, svcRevertTimer=svcRevertTimer, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpOperIsBackup=sdpOperIsBackup, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustGroups=prvtTMCustGroups, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustObjs=prvtTMCustObjs, prvtSapDeleted=prvtSapDeleted, TSapIngQueueId=TSapIngQueueId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, ServObjDesc=ServObjDesc, custRowStatus=custRowStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgressQosPolicyId=sapEgressQosPolicyId, VpnId=VpnId, prvtTMCustCompliance=prvtTMCustCompliance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custInfoTable=custInfoTable, custContact=custContact, sapBaseInfoTable=sapBaseInfoTable, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSapConformance=prvtTMSapConformance, svcId=svcId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpLastMgmtChange=sdpLastMgmtChange, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtServNotifications=prvtServNotifications, sdpLdpEnabled=sdpLdpEnabled, sdpId=sdpId, svcLastMgmtChange=svcLastMgmtChange, custLastMgmtChange=custLastMgmtChange, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapOperStatus=sapOperStatus, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapLearnMode=sapLearnMode, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtCustDeleted=prvtCustDeleted, prvtServicesMIB=prvtServicesMIB, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpDeleted=prvtSdpDeleted, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcConformance=prvtTMSvcConformance, ServiceOperStatus=ServiceOperStatus, sapType=sapType, prvtTMServConformance=prvtTMServConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapCreated=prvtSapCreated, sdpVCType=sdpVCType, svcBaseInfoEntry=svcBaseInfoEntry, svcVplsMode=svcVplsMode, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpDelivery=sdpDelivery, prvtSapTraps=prvtSapTraps, prvtTMSapCompliances=prvtTMSapCompliances, svcEnableSecureSaps=svcEnableSecureSaps, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtCustCreated=prvtCustCreated, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, svcCustName=svcCustName, prvtTMTstpConformance=prvtTMTstpConformance, svcNumEntries=svcNumEntries, prvtSvcCreated=prvtSvcCreated, custName=custName, sapEncapValue=sapEncapValue, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosQueueId=sapEgrQosQueueId, sdpInfoTable=sdpInfoTable, sdpOperFlags=sdpOperFlags, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSdpNotif=prvtSdpNotif, sapBaseInfoEntry=sapBaseInfoEntry, svcRowStatus=svcRowStatus, custInfoEntry=custInfoEntry, svcType=svcType, sdpAdminStatus=sdpAdminStatus, prvtTMServObjs=prvtTMServObjs, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSapGroups=prvtTMSapGroups, custPhone=custPhone, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtSvcTraps=prvtSvcTraps, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custNumEntries=custNumEntries, sapOperFlags=sapOperFlags, sapIngQosQueueId=sapIngQosQueueId, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapRowStatus=sapRowStatus, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcDescription=svcDescription, sdpNumEntries=sdpNumEntries, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpOutInterface=sdpOutInterface, prvtTMSdpObjs=prvtTMSdpObjs, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcNumSaps=svcNumSaps, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcBaseInfoTable=svcBaseInfoTable, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpRowStatus=sdpRowStatus, sapPortId=sapPortId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcVpnId=svcVpnId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpOperStatus=sdpOperStatus, sdpTransportTunnelName=sdpTransportTunnelName, prvtSvcNotif=prvtSvcNotif, sdpDescription=sdpDescription, TSapEgrQueueId=TSapEgrQueueId, svcLastStatusChange=svcLastStatusChange, sapDescription=sapDescription, sapAdminStatus=sapAdminStatus, sapLastMgmtChange=sapLastMgmtChange, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtCustTraps=prvtCustTraps, sdpAdminIngressLabel=sdpAdminIngressLabel, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultSvcSiteName=custMultSvcSiteName, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpType=sdpType, sapNumEntries=sapNumEntries, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtCustNotif=prvtCustNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpLastStatusChange=sdpLastStatusChange, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSapStatusChanged=prvtSapStatusChanged, ServObjName=ServObjName, prvtTMSvcGroups=prvtTMSvcGroups, sdpMtu=sdpMtu, prvtSdpCreated=prvtSdpCreated, SdpIdType=SdpIdType, prvtTMSapObjs=prvtTMSapObjs, TMEncapVal=TMEncapVal, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, ServType=ServType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals)
