...
TNamedItemOrEmpty, serviceAccessSwitch, TNetworkPolicyIdOrNone, TNamedItem, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custLastMgmtChange=custLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtCustNotif=prvtCustNotif, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, TSapIngQueueId=TSapIngQueueId, sdpOperStatus=sdpOperStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpDelivery=sdpDelivery, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcMtu=svcMtu, sdpAdminStatus=sdpAdminStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapNumEntries=sapNumEntries, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSapCreated=prvtSapCreated, prvtTMServConformance=prvtTMServConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, TMEncapVal=TMEncapVal, prvtCustCreated=prvtCustCreated, sapEgrQosQueueId=sapEgrQosQueueId, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapObjs=prvtTMSapObjs, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSapDeleted=prvtSapDeleted, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, ServiceOperStatus=ServiceOperStatus, prvtTMCustCompliance=prvtTMCustCompliance, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcEnableSecureSaps=svcEnableSecureSaps, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMCustObjs=prvtTMCustObjs, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngressQosPolicyId=sapIngressQosPolicyId, svcNumSdps=svcNumSdps, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, PYSNMP_MODULE_ID=prvtServicesMIB, ServObjDesc=ServObjDesc, svcCustName=svcCustName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcGroups=prvtTMSvcGroups, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSvcCreated=prvtSvcCreated, sapLearnMode=sapLearnMode, custName=custName, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpOutInterface=sdpOutInterface, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSvcConformance=prvtTMSvcConformance, custInfoTable=custInfoTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSapNotif=prvtSapNotif, sapIngQosSchedName=sapIngQosSchedName, svcVpnId=svcVpnId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSapTraps=prvtSapTraps, svcBaseInfoTable=svcBaseInfoTable, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtServNotifications=prvtServNotifications, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSapCompliances=prvtTMSapCompliances, custInfoEntry=custInfoEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSapGroups=prvtTMSapGroups, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMCustCompliances=prvtTMCustCompliances, sapEncapValue=sapEncapValue, prvtTMSdpConformance=prvtTMSdpConformance, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultSvcSiteName=custMultSvcSiteName, sapPortId=sapPortId, sapAdminStatus=sapAdminStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcBaseInfoEntry=svcBaseInfoEntry, sdpBindVlanTag=sdpBindVlanTag, prvtCustDeleted=prvtCustDeleted, sapBaseInfoEntry=sapBaseInfoEntry, sdpLabelSignaling=sdpLabelSignaling, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, ServObjName=ServObjName, prvtTMCustGroups=prvtTMCustGroups, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosCustName=sapIngQosCustName, sapLastMgmtChange=sapLastMgmtChange, svcRowStatus=svcRowStatus, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcType=svcType, sdpType=sdpType, sdpGroupIdentifier=sdpGroupIdentifier, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, ServiceAdminStatus=ServiceAdminStatus, prvtTMSapConformance=prvtTMSapConformance, svcId=svcId, svcRevertTimer=svcRevertTimer, sapDescription=sapDescription, sapOperFlags=sapOperFlags, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtCustTraps=prvtCustTraps, sdpDescription=sdpDescription, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custEgrQosSchedName=custEgrQosSchedName, prvtTMServObjs=prvtTMServObjs, custIngQosSchedName=custIngQosSchedName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSvcNotif=prvtSvcNotif, custPhone=custPhone, custNumEntries=custNumEntries, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpLastMgmtChange=sdpLastMgmtChange, custRowStatus=custRowStatus, custMultSvcSiteDescription=custMultSvcSiteDescription, svcLastMgmtChange=svcLastMgmtChange, svcVplsMode=svcVplsMode, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpVCType=sdpVCType, sapType=sapType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSdpDeleted=prvtSdpDeleted, sdpMtu=sdpMtu, prvtTMSdpGroups=prvtTMSdpGroups, svcNumEntries=svcNumEntries, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, ServType=ServType, sdpInfoEntry=sdpInfoEntry, prvtSdpCreated=prvtSdpCreated, svcAdminStatus=svcAdminStatus, sdpNextFreeId=sdpNextFreeId, prvtServicesMIB=prvtServicesMIB, sdpOperFlags=sdpOperFlags, custContact=custContact, sdpInfoTable=sdpInfoTable, sdpLastStatusChange=sdpLastStatusChange, svcLastStatusChange=svcLastStatusChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpId=sdpId, sdpRowStatus=sdpRowStatus, prvtSvcDeleted=prvtSvcDeleted, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpLdpEnabled=sdpLdpEnabled, sapOperStatus=sapOperStatus, VpnId=VpnId, sapRowStatus=sapRowStatus, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpAdminIsBackup=sdpAdminIsBackup, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSapCompliance=prvtTMSapCompliance, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosCustName=sapEgrQosCustName, svcDescription=svcDescription, SdpIdType=SdpIdType, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSvcTraps=prvtSvcTraps, svcNumSaps=svcNumSaps, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable)
