...
TruthValue, DisplayString, RowStatus, TextualConvention, TimeStamp, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "TextualConvention", "TimeStamp", "MacAddress")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpDelivery=sdpDelivery, sdpOperStatus=sdpOperStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpLabelSignaling=sdpLabelSignaling, prvtServicesMIBNotifications=prvtServicesMIBNotifications, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpLdpEnabled=sdpLdpEnabled, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpPwPrecedence=sdpPwPrecedence, customerRowStatus=customerRowStatus, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sapUntaggedMode=sapUntaggedMode, customerEntry=customerEntry, serviceVpnId=serviceVpnId, serviceCustName=serviceCustName, serviceTable=serviceTable, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapEgressQosPolicyId=sapEgressQosPolicyId, sapMacLearningProfileState=sapMacLearningProfileState, sdpPwActivate=sdpPwActivate, serviceEntry=serviceEntry, sdpAdminStatus=sdpAdminStatus, sdpType=sdpType, customerDeleted=customerDeleted, customerName=customerName, serviceNumSaps=serviceNumSaps, sdpSignalPwStatus=sdpSignalPwStatus, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceCreated=serviceCreated, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceMacAddressSapTable=serviceMacAddressSapTable, sapLearnEnable=sapLearnEnable, sdpMtu=sdpMtu, serviceMtu=serviceMtu, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sapLearnMode=sapLearnMode, customerPhone=customerPhone, serviceVlanEtherType=serviceVlanEtherType, sapRowStatus=sapRowStatus, sapDescription=sapDescription, serviceDeleted=serviceDeleted, customerTable=customerTable, sdpCreated=sdpCreated, sapEntry=sapEntry, serviceMacAddressSapPriority=serviceMacAddressSapPriority, serviceAdminStatus=serviceAdminStatus, sapOperFlags=sapOperFlags, sapOperStatus=sapOperStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, serviceRowStatus=serviceRowStatus, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceDescription=serviceDescription, customerCreated=customerCreated, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sapCreated=sapCreated, sdpSecuredEnable=sdpSecuredEnable, sdpDeleted=sdpDeleted, sdpGroupIdentifier=sdpGroupIdentifier, sapTable=sapTable, sdpLearnEnable=sdpLearnEnable, sdpId=sdpId, sdpTable=sdpTable, sdpOutInterface=sdpOutInterface, serviceOperStatus=serviceOperStatus, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sapType=sapType, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapDeleted=sapDeleted, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpTransportTunnelName=sdpTransportTunnelName, serviceType=serviceType, sapCurrentMacCount=sapCurrentMacCount, serviceVlanAction=serviceVlanAction, PYSNMP_MODULE_ID=prvtServicesMIB, serviceLastMgmtChange=serviceLastMgmtChange, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpEntry=sdpEntry, serviceNumSdps=serviceNumSdps, sdpRowStatus=sdpRowStatus, customerContact=customerContact, serviceId=serviceId, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapPortId=sapPortId, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sapAdminStatus=sapAdminStatus, sdpVCType=sdpVCType, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpBindVlanTag=sdpBindVlanTag, sapProfileName=sapProfileName, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSdpId=serviceMacAddressSdpId, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtServicesMIB=prvtServicesMIB, sdpDescription=sdpDescription, sapLastMgmtChange=sapLastMgmtChange, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceRevertTimer=serviceRevertTimer, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpNextFreeId=sdpNextFreeId, sdpOperFlags=sdpOperFlags, sdpLastMgmtChange=sdpLastMgmtChange, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEncapValue=sapEncapValue, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress)
