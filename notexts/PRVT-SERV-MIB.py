...
serviceAccessSwitch, TNamedItem, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtServNotifications=prvtServNotifications, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcAdminStatus=svcAdminStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpOperFlags=sdpOperFlags, svcOperStatus=svcOperStatus, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custInfoEntry=custInfoEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custRowStatus=custRowStatus, prvtSvcDeleted=prvtSvcDeleted, sapLearnMode=sapLearnMode, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpNextFreeId=sdpNextFreeId, svcLastMgmtChange=svcLastMgmtChange, custNumEntries=custNumEntries, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custContact=custContact, svcRevertTimer=svcRevertTimer, SdpIdType=SdpIdType, prvtServicesMIB=prvtServicesMIB, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpType=sdpType, prvtSdpStatusChanged=prvtSdpStatusChanged, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, prvtTMServConformance=prvtTMServConformance, TMEncapVal=TMEncapVal, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpOperIsBackup=sdpOperIsBackup, custEgrQosSchedName=custEgrQosSchedName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, ServObjDesc=ServObjDesc, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcId=svcId, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpDescription=sdpDescription, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpLastMgmtChange=sdpLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custName=custName, svcNumSaps=svcNumSaps, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEncapValue=sapEncapValue, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMTstpConformance=prvtTMTstpConformance, svcLastStatusChange=svcLastStatusChange, sapRowStatus=sapRowStatus, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcNumSdps=svcNumSdps, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custInfoTable=custInfoTable, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcBaseInfoTable=svcBaseInfoTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSapCreated=prvtSapCreated, custIngQosSchedName=custIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapBaseInfoTable=sapBaseInfoTable, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosCustName=sapIngQosCustName, prvtCustCreated=prvtCustCreated, sdpLabelSignaling=sdpLabelSignaling, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMServObjs=prvtTMServObjs, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSapConformance=prvtTMSapConformance, prvtCustDeleted=prvtCustDeleted, sdpOutInterface=sdpOutInterface, prvtTMSvcGroups=prvtTMSvcGroups, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpMtu=sdpMtu, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapDescription=sapDescription, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapAdminStatus=sapAdminStatus, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueId=sapIngQosQueueId, sdpDelivery=sdpDelivery, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSapObjs=prvtTMSapObjs, prvtTMSvcObjs=prvtTMSvcObjs, sdpLdpEnabled=sdpLdpEnabled, prvtCustTraps=prvtCustTraps, prvtSvcNotif=prvtSvcNotif, sapOperFlags=sapOperFlags, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpInfoTable=sdpInfoTable, VpnId=VpnId, custPhone=custPhone, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSdpConformance=prvtTMSdpConformance, ServType=ServType, svcNumEntries=svcNumEntries, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcMtu=svcMtu, svcVPLSUplinkPortID=svcVPLSUplinkPortID, TSapIngQueueId=TSapIngQueueId, prvtSdpDeleted=prvtSdpDeleted, ServiceOperStatus=ServiceOperStatus, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcType=svcType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, ServiceAdminStatus=ServiceAdminStatus, sdpId=sdpId, svcVpnId=svcVpnId, sapNumEntries=sapNumEntries, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSapNotif=prvtSapNotif, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpVCType=sdpVCType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcCustName=svcCustName, svcDescription=svcDescription, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtCustNotif=prvtCustNotif, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSapCompliances=prvtTMSapCompliances, prvtSapTraps=prvtSapTraps, sdpLastStatusChange=sdpLastStatusChange, sapBaseInfoEntry=sapBaseInfoEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpBindVlanTag=sdpBindVlanTag, sdpOperStatus=sdpOperStatus, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpRowStatus=sdpRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcRowStatus=svcRowStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpNumEntries=sdpNumEntries, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMCustConformance=prvtTMCustConformance, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, TSapEgrQueueId=TSapEgrQueueId, ServObjName=ServObjName, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosSchedName=sapIngQosSchedName, sdpTransportTunnelName=sdpTransportTunnelName, svcEnableSecureSaps=svcEnableSecureSaps, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapPortId=sapPortId, sapType=sapType, sapEgrQosCustName=sapEgrQosCustName, prvtSdpCreated=prvtSdpCreated, sdpAdminStatus=sdpAdminStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpGroupIdentifier=sdpGroupIdentifier, sapLastMgmtChange=sapLastMgmtChange, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpAdminIsBackup=sdpAdminIsBackup)
