...
TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteDescription=custMultSvcSiteDescription, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpFarEndIpAddress=sdpFarEndIpAddress, svcId=svcId, sdpAdminStatus=sdpAdminStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcRevertTimer=svcRevertTimer, sapIngQosCustName=sapIngQosCustName, prvtSdpTraps=prvtSdpTraps, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSapCreated=prvtSapCreated, svcMtu=svcMtu, sdpRowStatus=sdpRowStatus, sdpVCType=sdpVCType, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpId=sdpId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSdpCreated=prvtSdpCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpLdpEnabled=sdpLdpEnabled, prvtSapNotif=prvtSapNotif, custIngQosSchedName=custIngQosSchedName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpNumEntries=sdpNumEntries, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custInfoTable=custInfoTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpBindVlanTag=sdpBindVlanTag, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosSchedName=custEgrQosSchedName, sapEncapValue=sapEncapValue, prvtTMSvcObjs=prvtTMSvcObjs, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, SdpIdType=SdpIdType, sdpLastStatusChange=sdpLastStatusChange, svcCustName=svcCustName, prvtTMCustGroups=prvtTMCustGroups, sapType=sapType, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcRowStatus=svcRowStatus, sapDescription=sapDescription, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpType=sdpType, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, PYSNMP_MODULE_ID=prvtServicesMIB, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custContact=custContact, custInfoEntry=custInfoEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtCustTraps=prvtCustTraps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpAdminEgressLabel=sdpAdminEgressLabel, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custNumEntries=custNumEntries, sapLearnMode=sapLearnMode, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapOperFlags=sapOperFlags, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosQueueId=sapEgrQosQueueId, svcLastStatusChange=svcLastStatusChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSvcGroups=prvtTMSvcGroups, VpnId=VpnId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpLabelSignaling=sdpLabelSignaling, sapPortId=sapPortId, svcEnableSecureSaps=svcEnableSecureSaps, TSapEgrQueueId=TSapEgrQueueId, sdpOperFlags=sdpOperFlags, prvtTMTstpConformance=prvtTMTstpConformance, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtCustDeleted=prvtCustDeleted, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMServObjs=prvtTMServObjs, prvtTMSdpObjs=prvtTMSdpObjs, sapOperStatus=sapOperStatus, sdpMtu=sdpMtu, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapNumEntries=sapNumEntries, prvtTMSapGroups=prvtTMSapGroups, ServType=ServType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpDescription=sdpDescription, svcVpnId=svcVpnId, sdpDelivery=sdpDelivery, sdpGroupIdentifier=sdpGroupIdentifier, sdpTransportTunnelName=sdpTransportTunnelName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpInfoTable=sdpInfoTable, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustCompliances=prvtTMCustCompliances, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapCompliance=prvtTMSapCompliance, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpAdminIsBackup=sdpAdminIsBackup, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapBaseInfoEntry=sapBaseInfoEntry, custName=custName, prvtTMServConformance=prvtTMServConformance, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtSvcNotif=prvtSvcNotif, prvtSvcStatusChanged=prvtSvcStatusChanged, svcAdminStatus=svcAdminStatus, prvtSvcDeleted=prvtSvcDeleted, sdpOutInterface=sdpOutInterface, sdpNextFreeId=sdpNextFreeId, prvtTMSvcCompliance=prvtTMSvcCompliance, TMEncapVal=TMEncapVal, prvtServNotifications=prvtServNotifications, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custPhone=custPhone, sapEgrQosCustName=sapEgrQosCustName, prvtCustCreated=prvtCustCreated, custMultSvcSiteName=custMultSvcSiteName, svcType=svcType, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcDescription=svcDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, ServObjDesc=ServObjDesc, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, ServiceAdminStatus=ServiceAdminStatus, svcOperStatus=svcOperStatus, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSapConformance=prvtTMSapConformance, sdpLastMgmtChange=sdpLastMgmtChange, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, TSapIngQueueId=TSapIngQueueId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapRowStatus=sapRowStatus, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMCustObjs=prvtTMCustObjs, svcNumSdps=svcNumSdps, custRowStatus=custRowStatus, prvtCustNotif=prvtCustNotif, sdpOperStatus=sdpOperStatus, prvtTMCustConformance=prvtTMCustConformance, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSvcConformance=prvtTMSvcConformance, ServObjName=ServObjName, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosSchedName=sapIngQosSchedName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSapDeleted=prvtSapDeleted, ServiceOperStatus=ServiceOperStatus, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, svcNumSaps=svcNumSaps, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSapObjs=prvtTMSapObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcBaseInfoEntry=svcBaseInfoEntry, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcLastMgmtChange=svcLastMgmtChange, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueId=sapIngQosQueueId, prvtSapStatusChanged=prvtSapStatusChanged, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtServicesMIB=prvtServicesMIB, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtSvcTraps=prvtSvcTraps, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, svcNumEntries=svcNumEntries, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapLastMgmtChange=sapLastMgmtChange, prvtSapTraps=prvtSapTraps, sapAdminStatus=sapAdminStatus, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgressQosPolicyId=sapEgressQosPolicyId)
