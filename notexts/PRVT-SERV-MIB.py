...
TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, serviceAccessSwitch, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "serviceAccessSwitch", "TNamedItem", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSvcConformance=prvtTMSvcConformance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, ServiceOperStatus=ServiceOperStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custPhone=custPhone, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpOperIsBackup=sdpOperIsBackup, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSdpConformance=prvtTMSdpConformance, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSapObjs=prvtTMSapObjs, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgressQosPolicyId=sapEgressQosPolicyId, custRowStatus=custRowStatus, prvtTMSapGroups=prvtTMSapGroups, svcNumEntries=svcNumEntries, sdpFarEndIpAddress=sdpFarEndIpAddress, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSapConformance=prvtTMSapConformance, prvtTMSapCompliances=prvtTMSapCompliances, prvtCustDeleted=prvtCustDeleted, svcEnableSecureSaps=svcEnableSecureSaps, svcVPLSUplinkTable=svcVPLSUplinkTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMSvcObjs=prvtTMSvcObjs, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueId=sapIngQosQueueId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapDescription=sapDescription, prvtSdpNotif=prvtSdpNotif, sdpOperStatus=sdpOperStatus, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapLastMgmtChange=sapLastMgmtChange, sdpDescription=sdpDescription, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcRevertTimer=svcRevertTimer, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtServicesMIB=prvtServicesMIB, TSapEgrQueueId=TSapEgrQueueId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcAdminStatus=svcAdminStatus, prvtTMSapCompliance=prvtTMSapCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtSdpCreated=prvtSdpCreated, custEgrQosSchedName=custEgrQosSchedName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtServNotifications=prvtServNotifications, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtSvcTraps=prvtSvcTraps, prvtCustNotif=prvtCustNotif, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustObjs=prvtTMCustObjs, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSapNotif=prvtSapNotif, prvtSdpTraps=prvtSdpTraps, sapRowStatus=sapRowStatus, sdpId=sdpId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpInfoEntry=sdpInfoEntry, svcLastStatusChange=svcLastStatusChange, sdpGroupIdentifier=sdpGroupIdentifier, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, svcType=svcType, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosSchedName=sapIngQosSchedName, VpnId=VpnId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcDescription=svcDescription, svcOperStatus=svcOperStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapOperStatus=sapOperStatus, custInfoEntry=custInfoEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custLastMgmtChange=custLastMgmtChange, prvtTMServObjs=prvtTMServObjs, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcId=svcId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcMtu=svcMtu, sdpVCType=sdpVCType, sdpNextFreeId=sdpNextFreeId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcVplsMode=svcVplsMode, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSapCreated=prvtSapCreated, ServObjDesc=ServObjDesc, svcCustName=svcCustName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtSapDeleted=prvtSapDeleted, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosCustName=sapIngQosCustName, sdpInfoTable=sdpInfoTable, prvtSvcDeleted=prvtSvcDeleted, ServObjName=ServObjName, sdpNumEntries=sdpNumEntries, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, ServiceAdminStatus=ServiceAdminStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMTstpConformance=prvtTMTstpConformance, prvtCustCreated=prvtCustCreated, svcNumSaps=svcNumSaps, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpType=sdpType, sdpLdpEnabled=sdpLdpEnabled, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSapTraps=prvtSapTraps, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcGroups=prvtTMSvcGroups, prvtSdpStatusChanged=prvtSdpStatusChanged, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custIngQosSchedName=custIngQosSchedName, TSapIngQueueId=TSapIngQueueId, sapEncapValue=sapEncapValue, sapBaseInfoEntry=sapBaseInfoEntry, prvtSapStatusChanged=prvtSapStatusChanged, SdpIdType=SdpIdType, sdpDelivery=sdpDelivery, prvtTMServConformance=prvtTMServConformance, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcRowStatus=svcRowStatus, sapLearnMode=sapLearnMode, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custName=custName, sdpLastStatusChange=sdpLastStatusChange, sapPortId=sapPortId, svcLastMgmtChange=svcLastMgmtChange, prvtSdpDeleted=prvtSdpDeleted, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMCustGroups=prvtTMCustGroups, PYSNMP_MODULE_ID=prvtServicesMIB, svcNumSdps=svcNumSdps, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSdpObjs=prvtTMSdpObjs, custInfoTable=custInfoTable, sdpOperFlags=sdpOperFlags, custContact=custContact, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcBaseInfoTable=svcBaseInfoTable, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpMtu=sdpMtu, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpBindVlanTag=sdpBindVlanTag, svcVpnId=svcVpnId, sapType=sapType, TMEncapVal=TMEncapVal, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustCompliances=prvtTMCustCompliances, sdpAdminStatus=sdpAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, prvtSvcNotif=prvtSvcNotif, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSvcCreated=prvtSvcCreated, sapOperFlags=sapOperFlags, sdpRowStatus=sdpRowStatus, custNumEntries=custNumEntries, sapAdminStatus=sapAdminStatus, ServType=ServType, sapNumEntries=sapNumEntries, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpOutInterface=sdpOutInterface)
