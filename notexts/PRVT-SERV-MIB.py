...
TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcRevertTimer=svcRevertTimer, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSdpObjs=prvtTMSdpObjs, ServiceAdminStatus=ServiceAdminStatus, svcId=svcId, svcDescription=svcDescription, sdpAdminStatus=sdpAdminStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSvcNotif=prvtSvcNotif, prvtTMSvcGroups=prvtTMSvcGroups, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSvcObjs=prvtTMSvcObjs, ServiceOperStatus=ServiceOperStatus, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custInfoEntry=custInfoEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosSchedName=sapIngQosSchedName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custPhone=custPhone, svcMtu=svcMtu, custMultSvcSiteDescription=custMultSvcSiteDescription, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcOperStatus=svcOperStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosQueueId=sapEgrQosQueueId, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapType=sapType, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpMtu=sdpMtu, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtSvcTraps=prvtSvcTraps, sapBaseInfoTable=sapBaseInfoTable, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custInfoTable=custInfoTable, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpOperStatus=sdpOperStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpLastStatusChange=sdpLastStatusChange, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpDescription=sdpDescription, sdpNumEntries=sdpNumEntries, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcNumSaps=svcNumSaps, prvtTMSvcCompliance=prvtTMSvcCompliance, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtServNotifications=prvtServNotifications, sdpLabelSignaling=sdpLabelSignaling, prvtSdpCreated=prvtSdpCreated, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpLastMgmtChange=sdpLastMgmtChange, sapEgrQosCustName=sapEgrQosCustName, svcAdminStatus=svcAdminStatus, prvtCustNotif=prvtCustNotif, svcNumSdps=svcNumSdps, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosCustName=sapIngQosCustName, prvtTMCustCompliances=prvtTMCustCompliances, svcRowStatus=svcRowStatus, prvtTMSapCompliance=prvtTMSapCompliance, ServObjName=ServObjName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, TSapIngQueueId=TSapIngQueueId, prvtSvcDeleted=prvtSvcDeleted, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custName=custName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSapCreated=prvtSapCreated, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpGroupIdentifier=sdpGroupIdentifier, prvtSvcCreated=prvtSvcCreated, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapPortId=sapPortId, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtSapTraps=prvtSapTraps, sapLearnMode=sapLearnMode, prvtSdpTraps=prvtSdpTraps, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSapNotif=prvtSapNotif, ServObjDesc=ServObjDesc, custNumEntries=custNumEntries, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, TMEncapVal=TMEncapVal, prvtCustTraps=prvtCustTraps, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustGroups=prvtTMCustGroups, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpBindVlanTag=sdpBindVlanTag, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtTMSapConformance=prvtTMSapConformance, sapEncapValue=sapEncapValue, prvtTMTstpConformance=prvtTMTstpConformance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, svcNumEntries=svcNumEntries, TSapEgrQueueId=TSapEgrQueueId, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpDeleted=prvtSdpDeleted, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpOutInterface=sdpOutInterface, prvtTMServObjs=prvtTMServObjs, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSapCompliances=prvtTMSapCompliances, sapOperFlags=sapOperFlags, sapNumEntries=sapNumEntries, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMCustConformance=prvtTMCustConformance, custIngQosSchedName=custIngQosSchedName, svcCustName=svcCustName, svcVplsMode=svcVplsMode, prvtTMSapObjs=prvtTMSapObjs, sapAdminStatus=sapAdminStatus, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosSchedName=custEgrQosSchedName, sdpLdpEnabled=sdpLdpEnabled, prvtTMSvcConformance=prvtTMSvcConformance, custContact=custContact, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueId=sapIngQosQueueId, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpAdminIsBackup=sdpAdminIsBackup, custRowStatus=custRowStatus, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpInfoTable=sdpInfoTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpVCType=sdpVCType, prvtTMCustObjs=prvtTMCustObjs, custLastMgmtChange=custLastMgmtChange, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, SdpIdType=SdpIdType, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpType=sdpType, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtServicesMIB=prvtServicesMIB, sapRowStatus=sapRowStatus, sapOperStatus=sapOperStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcLastStatusChange=svcLastStatusChange, svcBaseInfoTable=svcBaseInfoTable, svcBaseInfoEntry=svcBaseInfoEntry, sapLastMgmtChange=sapLastMgmtChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSdpNotif=prvtSdpNotif, sdpDelivery=sdpDelivery, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtCustCreated=prvtCustCreated, prvtTMSvcCompliances=prvtTMSvcCompliances, svcType=svcType, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpNextFreeId=sdpNextFreeId, sapDescription=sapDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, svcVpnId=svcVpnId, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, ServType=ServType, sdpId=sdpId, VpnId=VpnId, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapBaseInfoEntry=sapBaseInfoEntry, custMultSvcSiteName=custMultSvcSiteName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpOperFlags=sdpOperFlags)
