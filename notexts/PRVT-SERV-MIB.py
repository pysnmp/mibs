...
TNamedItem, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtCustTraps=prvtCustTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSapCreated=prvtSapCreated, svcId=svcId, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEncapValue=sapEncapValue, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, ServiceOperStatus=ServiceOperStatus, svcMtu=svcMtu, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpOperIsBackup=sdpOperIsBackup, svcLastStatusChange=svcLastStatusChange, sdpInfoEntry=sdpInfoEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, TSapIngQueueId=TSapIngQueueId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sdpVCType=sdpVCType, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgressQosPolicyId=sapEgressQosPolicyId, ServObjDesc=ServObjDesc, svcOperStatus=svcOperStatus, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosQueueId=sapEgrQosQueueId, custMultSvcSiteDescription=custMultSvcSiteDescription, custInfoTable=custInfoTable, svcLastMgmtChange=svcLastMgmtChange, svcVpnId=svcVpnId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosSchedName=custIngQosSchedName, svcNumSaps=svcNumSaps, sdpId=sdpId, sdpMtu=sdpMtu, prvtSvcNotif=prvtSvcNotif, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, ServiceAdminStatus=ServiceAdminStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, sapPortId=sapPortId, sapNumEntries=sapNumEntries, svcRevertTimer=svcRevertTimer, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custLastMgmtChange=custLastMgmtChange, prvtSvcCreated=prvtSvcCreated, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueId=sapIngQosQueueId, prvtTMCustObjs=prvtTMCustObjs, sdpDescription=sdpDescription, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpBindVlanTag=sdpBindVlanTag, sdpType=sdpType, sdpNextFreeId=sdpNextFreeId, prvtCustCreated=prvtCustCreated, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtServNotifications=prvtServNotifications, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMCustGroups=prvtTMCustGroups, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSvcDeleted=prvtSvcDeleted, prvtTMServObjs=prvtTMServObjs, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSvcConformance=prvtTMSvcConformance, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMSvcCompliance=prvtTMSvcCompliance, custEgrQosSchedName=custEgrQosSchedName, prvtSvcStatusChanged=prvtSvcStatusChanged, svcAdminStatus=svcAdminStatus, prvtTMSapConformance=prvtTMSapConformance, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpInfoTable=sdpInfoTable, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcRowStatus=svcRowStatus, svcType=svcType, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, SdpIdType=SdpIdType, sapLearnMode=sapLearnMode, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMSdpConformance=prvtTMSdpConformance, prvtCustDeleted=prvtCustDeleted, sapOperFlags=sapOperFlags, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcNumEntries=svcNumEntries, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapOperStatus=sapOperStatus, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosCustName=sapIngQosCustName, prvtCustNotif=prvtCustNotif, prvtTMCustCompliance=prvtTMCustCompliance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, TMEncapVal=TMEncapVal, prvtSdpCreated=prvtSdpCreated, svcNumSdps=svcNumSdps, prvtTMSdpGroups=prvtTMSdpGroups, svcCustName=svcCustName, prvtSdpTraps=prvtSdpTraps, custNumEntries=custNumEntries, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMServConformance=prvtTMServConformance, sdpOperStatus=sdpOperStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapCompliances=prvtTMSapCompliances, sdpLabelSignaling=sdpLabelSignaling, sapRowStatus=sapRowStatus, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, TSapEgrQueueId=TSapEgrQueueId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapBaseInfoTable=sapBaseInfoTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapType=sapType, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpOperFlags=sdpOperFlags, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosCustName=sapEgrQosCustName, sdpLdpEnabled=sdpLdpEnabled, sapIngressQosPolicyId=sapIngressQosPolicyId, VpnId=VpnId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custInfoEntry=custInfoEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosSchedName=sapEgrQosSchedName, sdpDelivery=sdpDelivery, sdpLastStatusChange=sdpLastStatusChange, prvtSdpNotif=prvtSdpNotif, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, ServType=ServType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custContact=custContact, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMTstpConformance=prvtTMTstpConformance, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSapNotif=prvtSapNotif, prvtTMSapObjs=prvtTMSapObjs, sdpRowStatus=sdpRowStatus, prvtSdpDeleted=prvtSdpDeleted, sdpAdminIngressLabel=sdpAdminIngressLabel, custPhone=custPhone, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpOutInterface=sdpOutInterface, sdpNumEntries=sdpNumEntries, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custRowStatus=custRowStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSvcObjs=prvtTMSvcObjs, sdpGroupIdentifier=sdpGroupIdentifier, svcVplsMode=svcVplsMode, prvtSapStatusChanged=prvtSapStatusChanged, custName=custName, svcDescription=svcDescription, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSapTraps=prvtSapTraps, sapAdminStatus=sapAdminStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, ServObjName=ServObjName, sdpAdminStatus=sdpAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, svcBaseInfoTable=svcBaseInfoTable, sapDescription=sapDescription, sapIngQosSchedName=sapIngQosSchedName, prvtServicesMIB=prvtServicesMIB, sdpAdminIsBackup=sdpAdminIsBackup, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSvcTraps=prvtSvcTraps, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName)
