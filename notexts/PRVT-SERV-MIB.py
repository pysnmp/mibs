...
TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcLastStatusChange=svcLastStatusChange, sapPortId=sapPortId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosCustName=sapEgrQosCustName, sdpInfoTable=sdpInfoTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcDescription=svcDescription, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcVpnId=svcVpnId, prvtSapStatusChanged=prvtSapStatusChanged, sapEncapValue=sapEncapValue, sdpOperStatus=sdpOperStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSvcGroups=prvtTMSvcGroups, svcRowStatus=svcRowStatus, prvtSapDeleted=prvtSapDeleted, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, TSapIngQueueId=TSapIngQueueId, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, TMEncapVal=TMEncapVal, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpLabelSignaling=sdpLabelSignaling, sdpVCType=sdpVCType, sdpType=sdpType, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapOperStatus=sapOperStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSdpCreated=prvtSdpCreated, prvtCustDeleted=prvtCustDeleted, prvtServicesMIB=prvtServicesMIB, prvtTMSapCompliance=prvtTMSapCompliance, sdpNextFreeId=sdpNextFreeId, custIngQosSchedName=custIngQosSchedName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpDelivery=sdpDelivery, SdpIdType=SdpIdType, TSapEgrQueueId=TSapEgrQueueId, custContact=custContact, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSapNotif=prvtSapNotif, custInfoEntry=custInfoEntry, VpnId=VpnId, prvtTMTstpConformance=prvtTMTstpConformance, custRowStatus=custRowStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpInfoEntry=sdpInfoEntry, svcMtu=svcMtu, svcRevertTimer=svcRevertTimer, sdpAdminEgressLabel=sdpAdminEgressLabel, ServiceAdminStatus=ServiceAdminStatus, custEgrQosSchedName=custEgrQosSchedName, sdpOutInterface=sdpOutInterface, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtCustNotif=prvtCustNotif, sdpLdpEnabled=sdpLdpEnabled, prvtSvcTraps=prvtSvcTraps, prvtSdpNotif=prvtSdpNotif, svcOperStatus=svcOperStatus, custInfoTable=custInfoTable, prvtTMSdpConformance=prvtTMSdpConformance, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcNumSaps=svcNumSaps, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSapCompliances=prvtTMSapCompliances, ServType=ServType, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcBaseInfoTable=svcBaseInfoTable, sapBaseInfoTable=sapBaseInfoTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, svcId=svcId, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapType=sapType, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapNumEntries=sapNumEntries, sapOperFlags=sapOperFlags, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapRowStatus=sapRowStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMServObjs=prvtTMServObjs, custLastMgmtChange=custLastMgmtChange, sdpMtu=sdpMtu, prvtSdpTraps=prvtSdpTraps, sdpBindVlanTag=sdpBindVlanTag, sdpAdminStatus=sdpAdminStatus, prvtTMCustGroups=prvtTMCustGroups, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpLastMgmtChange=sdpLastMgmtChange, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMServConformance=prvtTMServConformance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapBaseInfoEntry=sapBaseInfoEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosCustName=sapIngQosCustName, custName=custName, sapIngQosSchedCustName=sapIngQosSchedCustName, svcNumEntries=svcNumEntries, sdpId=sdpId, prvtTMCustObjs=prvtTMCustObjs, prvtServNotifications=prvtServNotifications, custPhone=custPhone, sapEgrQosQueueId=sapEgrQosQueueId, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtCustCreated=prvtCustCreated, prvtSapTraps=prvtSapTraps, prvtSapCreated=prvtSapCreated, sapLastMgmtChange=sapLastMgmtChange, ServObjDesc=ServObjDesc, prvtTMSapGroups=prvtTMSapGroups, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSvcNotif=prvtSvcNotif, sapAdminStatus=sapAdminStatus, svcBaseInfoEntry=svcBaseInfoEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpOperFlags=sdpOperFlags, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpDescription=sdpDescription, svcType=svcType, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSdpDeleted=prvtSdpDeleted, prvtTMSdpGroups=prvtTMSdpGroups, svcCustName=svcCustName, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpRowStatus=sdpRowStatus, prvtTMSvcObjs=prvtTMSvcObjs, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcNumSdps=svcNumSdps, prvtTMSapObjs=prvtTMSapObjs, svcVplsMode=svcVplsMode, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapDescription=sapDescription, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpNumEntries=sdpNumEntries, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultSvcSiteName=custMultSvcSiteName, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgressQosPolicyId=sapEgressQosPolicyId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, ServObjName=ServObjName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custNumEntries=custNumEntries, svcAdminStatus=svcAdminStatus, prvtSvcDeleted=prvtSvcDeleted, PYSNMP_MODULE_ID=prvtServicesMIB, sapLearnMode=sapLearnMode, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtCustTraps=prvtCustTraps, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, sdpOperIsBackup=sdpOperIsBackup, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMCustCompliances=prvtTMCustCompliances, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable)
