...
TNamedItemOrEmpty, TNamedItem, serviceAccessSwitch, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNamedItem", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMServConformance=prvtTMServConformance, prvtSapTraps=prvtSapTraps, prvtSapNotif=prvtSapNotif, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSdpDeleted=prvtSdpDeleted, svcVpnId=svcVpnId, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSvcDeleted=prvtSvcDeleted, prvtServNotifications=prvtServNotifications, prvtCustDeleted=prvtCustDeleted, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcGroups=prvtTMSvcGroups, ServiceAdminStatus=ServiceAdminStatus, sdpFarEndIpAddress=sdpFarEndIpAddress, svcVplsMode=svcVplsMode, ServObjDesc=ServObjDesc, ServiceOperStatus=ServiceOperStatus, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custInfoTable=custInfoTable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtServicesMIB=prvtServicesMIB, custNumEntries=custNumEntries, prvtTMCustGroups=prvtTMCustGroups, prvtSdpTraps=prvtSdpTraps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpInfoTable=sdpInfoTable, PYSNMP_MODULE_ID=prvtServicesMIB, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpType=sdpType, sdpNumEntries=sdpNumEntries, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, ServType=ServType, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpId=sdpId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosCustName=sapEgrQosCustName, sapIngQosSchedName=sapIngQosSchedName, sdpOutInterface=sdpOutInterface, sdpLdpEnabled=sdpLdpEnabled, svcOperStatus=svcOperStatus, custContact=custContact, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, TSapEgrQueueId=TSapEgrQueueId, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosCustName=sapIngQosCustName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapOperFlags=sapOperFlags, custMultSvcSiteName=custMultSvcSiteName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapOperStatus=sapOperStatus, prvtTMSapObjs=prvtTMSapObjs, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpDescription=sdpDescription, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtCustTraps=prvtCustTraps, prvtTMCustConformance=prvtTMCustConformance, prvtTMSdpConformance=prvtTMSdpConformance, svcDescription=svcDescription, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapNumEntries=sapNumEntries, sdpDelivery=sdpDelivery, custRowStatus=custRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, svcNumEntries=svcNumEntries, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtSvcNotif=prvtSvcNotif, sdpLastStatusChange=sdpLastStatusChange, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMCustCompliances=prvtTMCustCompliances, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngressQosPolicyId=sapIngressQosPolicyId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServObjs=prvtTMServObjs, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtCustCreated=prvtCustCreated, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapAdminStatus=sapAdminStatus, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapPortId=sapPortId, prvtTMSapConformance=prvtTMSapConformance, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, VpnId=VpnId, sdpGroupIdentifier=sdpGroupIdentifier, sapEncapValue=sapEncapValue, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcMtu=svcMtu, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcAdminStatus=svcAdminStatus, TSapIngQueueId=TSapIngQueueId, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMCustObjs=prvtTMCustObjs, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpMtu=sdpMtu, SdpIdType=SdpIdType, custEgrQosSchedName=custEgrQosSchedName, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, svcBaseInfoTable=svcBaseInfoTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcLastMgmtChange=svcLastMgmtChange, sdpOperFlags=sdpOperFlags, svcNumSaps=svcNumSaps, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSvcTraps=prvtSvcTraps, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueId=sapIngQosQueueId, sdpVCType=sdpVCType, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapRowStatus=sapRowStatus, sdpNextFreeId=sdpNextFreeId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSapCompliance=prvtTMSapCompliance, svcBaseInfoEntry=svcBaseInfoEntry, svcNumSdps=svcNumSdps, sapIngQosSchedCustName=sapIngQosSchedCustName, custLastMgmtChange=custLastMgmtChange, ServObjName=ServObjName, prvtTMSapCompliances=prvtTMSapCompliances, svcId=svcId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcRowStatus=svcRowStatus, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSapGroups=prvtTMSapGroups, sdpLastMgmtChange=sdpLastMgmtChange, prvtSapCreated=prvtSapCreated, TMEncapVal=TMEncapVal, sdpLabelSignaling=sdpLabelSignaling, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtCustNotif=prvtCustNotif, sdpAdminStatus=sdpAdminStatus, svcCustName=svcCustName, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpOperStatus=sdpOperStatus, sapLearnMode=sapLearnMode, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, prvtSdpCreated=prvtSdpCreated, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMSdpObjs=prvtTMSdpObjs, custPhone=custPhone, sapType=sapType, prvtTMSdpGroups=prvtTMSdpGroups, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcRevertTimer=svcRevertTimer, sapEgrQosSchedName=sapEgrQosSchedName, sdpBindVlanTag=sdpBindVlanTag, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSvcCreated=prvtSvcCreated, sapDescription=sapDescription, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custName=custName, custInfoEntry=custInfoEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcType=svcType, prvtSdpNotif=prvtSdpNotif)
