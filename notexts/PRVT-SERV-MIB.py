...
TNamedItemOrEmpty, serviceAccessSwitch, TNamedItem, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "serviceAccessSwitch", "TNamedItem", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpInfoEntry=sdpInfoEntry, prvtSvcCreated=prvtSvcCreated, prvtTMSvcObjs=prvtTMSvcObjs, svcDescription=svcDescription, svcNumEntries=svcNumEntries, prvtTMServConformance=prvtTMServConformance, sapLearnMode=sapLearnMode, prvtCustCreated=prvtCustCreated, sapPortId=sapPortId, prvtTMSapGroups=prvtTMSapGroups, ServObjName=ServObjName, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, PYSNMP_MODULE_ID=prvtServicesMIB, sapEncapValue=sapEncapValue, prvtTMCustConformance=prvtTMCustConformance, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueId=sapIngQosQueueId, ServiceAdminStatus=ServiceAdminStatus, prvtTMSapCompliances=prvtTMSapCompliances, sdpLastMgmtChange=sdpLastMgmtChange, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSapDeleted=prvtSapDeleted, custIngQosSchedName=custIngQosSchedName, svcMtu=svcMtu, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcAdminStatus=svcAdminStatus, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapDescription=sapDescription, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosCustName=sapIngQosCustName, custMultSvcSiteName=custMultSvcSiteName, custContact=custContact, custPhone=custPhone, svcId=svcId, prvtSapStatusChanged=prvtSapStatusChanged, custInfoEntry=custInfoEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpTransportTunnelName=sdpTransportTunnelName, custMultSvcSiteDescription=custMultSvcSiteDescription, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custEgrQosSchedName=custEgrQosSchedName, prvtSapCreated=prvtSapCreated, sdpBindVlanTag=sdpBindVlanTag, svcBaseInfoTable=svcBaseInfoTable, sapOperStatus=sapOperStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcLastStatusChange=svcLastStatusChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpDescription=sdpDescription, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcOperStatus=svcOperStatus, prvtTMSdpObjs=prvtTMSdpObjs, svcNumSdps=svcNumSdps, sdpOperIsBackup=sdpOperIsBackup, sapIngQosSchedCustName=sapIngQosSchedCustName, sapType=sapType, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcCustName=svcCustName, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueId=sapEgrQosQueueId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtServNotifications=prvtServNotifications, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpNextFreeId=sdpNextFreeId, svcBaseInfoEntry=svcBaseInfoEntry, svcVplsMode=svcVplsMode, sdpMtu=sdpMtu, sapBaseInfoTable=sapBaseInfoTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapRowStatus=sapRowStatus, prvtTMCustGroups=prvtTMCustGroups, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpOutInterface=sdpOutInterface, sdpNumEntries=sdpNumEntries, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapAdminStatus=sapAdminStatus, sdpLdpEnabled=sdpLdpEnabled, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMSapObjs=prvtTMSapObjs, sdpAdminStatus=sdpAdminStatus, prvtTMSapConformance=prvtTMSapConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, ServType=ServType, sapLastMgmtChange=sapLastMgmtChange, ServiceOperStatus=ServiceOperStatus, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcTraps=prvtSvcTraps, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custNumEntries=custNumEntries, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpDelivery=sdpDelivery, TMEncapVal=TMEncapVal, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpRowStatus=sdpRowStatus, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtCustTraps=prvtCustTraps, svcLastMgmtChange=svcLastMgmtChange, prvtSapNotif=prvtSapNotif, custRowStatus=custRowStatus, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSvcGroups=prvtTMSvcGroups, SdpIdType=SdpIdType, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcType=svcType, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtSdpTraps=prvtSdpTraps, VpnId=VpnId, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapEgrQosCustName=sapEgrQosCustName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSapTraps=prvtSapTraps, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, ServObjDesc=ServObjDesc, sdpLabelSignaling=sdpLabelSignaling, prvtCustNotif=prvtCustNotif, prvtSdpDeleted=prvtSdpDeleted, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpType=sdpType, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSvcDeleted=prvtSvcDeleted, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpAdminIsBackup=sdpAdminIsBackup, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpOperFlags=sdpOperFlags, sdpOperStatus=sdpOperStatus, sdpInfoTable=sdpInfoTable, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSdpConformance=prvtTMSdpConformance, custName=custName, svcRowStatus=svcRowStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapOperFlags=sapOperFlags, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custLastMgmtChange=custLastMgmtChange, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custInfoTable=custInfoTable, sdpLastStatusChange=sdpLastStatusChange, TSapEgrQueueId=TSapEgrQueueId, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMSdpGroups=prvtTMSdpGroups, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMCustObjs=prvtTMCustObjs, prvtSdpStatusChanged=prvtSdpStatusChanged, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMServObjs=prvtTMServObjs, prvtSdpCreated=prvtSdpCreated, svcRevertTimer=svcRevertTimer, prvtServicesMIB=prvtServicesMIB, svcVpnId=svcVpnId, svcNumSaps=svcNumSaps, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpId=sdpId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, TSapIngQueueId=TSapIngQueueId, prvtSvcNotif=prvtSvcNotif, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpVCType=sdpVCType, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapNumEntries=sapNumEntries, prvtCustDeleted=prvtCustDeleted)
