...
TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcVpnId=svcVpnId, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, ServObjDesc=ServObjDesc, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtCustDeleted=prvtCustDeleted, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpType=sdpType, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtCustCreated=prvtCustCreated, VpnId=VpnId, sdpInfoEntry=sdpInfoEntry, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSvcObjs=prvtTMSvcObjs, ServiceOperStatus=ServiceOperStatus, sdpDescription=sdpDescription, svcOperStatus=svcOperStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, TSapIngQueueId=TSapIngQueueId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosCustName=sapIngQosCustName, sapDescription=sapDescription, prvtTMSdpConformance=prvtTMSdpConformance, sapIngressQosPolicyId=sapIngressQosPolicyId, custRowStatus=custRowStatus, custMultSvcSiteDescription=custMultSvcSiteDescription, svcNumSaps=svcNumSaps, prvtTMTstpConformance=prvtTMTstpConformance, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpAdminStatus=sdpAdminStatus, sdpBindVlanTag=sdpBindVlanTag, prvtSapCreated=prvtSapCreated, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpRowStatus=sdpRowStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapType=sapType, prvtSvcTraps=prvtSvcTraps, sdpLdpEnabled=sdpLdpEnabled, prvtCustNotif=prvtCustNotif, TSapEgrQueueId=TSapEgrQueueId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpLastMgmtChange=sdpLastMgmtChange, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMServConformance=prvtTMServConformance, prvtSdpDeleted=prvtSdpDeleted, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpOperIsBackup=sdpOperIsBackup, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMCustCompliance=prvtTMCustCompliance, svcRevertTimer=svcRevertTimer, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpOperFlags=sdpOperFlags, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpLastStatusChange=sdpLastStatusChange, prvtTMSdpObjs=prvtTMSdpObjs, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpMtu=sdpMtu, svcCustName=svcCustName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSapDeleted=prvtSapDeleted, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpOperStatus=sdpOperStatus, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSapGroups=prvtTMSapGroups, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcMtu=svcMtu, prvtTMCustObjs=prvtTMCustObjs, custInfoTable=custInfoTable, prvtTMSapCompliance=prvtTMSapCompliance, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSvcNotif=prvtSvcNotif, prvtCustTraps=prvtCustTraps, prvtTMSvcGroups=prvtTMSvcGroups, svcVplsMode=svcVplsMode, prvtTMSapConformance=prvtTMSapConformance, svcNumEntries=svcNumEntries, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEncapValue=sapEncapValue, custEgrQosSchedName=custEgrQosSchedName, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMCustConformance=prvtTMCustConformance, sapLastMgmtChange=sapLastMgmtChange, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMServObjs=prvtTMServObjs, sdpNextFreeId=sdpNextFreeId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, sdpId=sdpId, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapNumEntries=sapNumEntries, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcBaseInfoEntry=svcBaseInfoEntry, svcAdminStatus=svcAdminStatus, sapPortId=sapPortId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgrQosSchedName=sapEgrQosSchedName, prvtServicesMIB=prvtServicesMIB, sapRowStatus=sapRowStatus, TMEncapVal=TMEncapVal, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custLastMgmtChange=custLastMgmtChange, sapOperFlags=sapOperFlags, custContact=custContact, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosCustName=sapEgrQosCustName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpGroupIdentifier=sdpGroupIdentifier, ServObjName=ServObjName, svcId=svcId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpDelivery=sdpDelivery, svcBaseInfoTable=svcBaseInfoTable, sapLearnMode=sapLearnMode, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcLastStatusChange=svcLastStatusChange, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custName=custName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustGroups=prvtTMCustGroups, sapIngQosSchedName=sapIngQosSchedName, sdpVCType=sdpVCType, sdpInfoTable=sdpInfoTable, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcDescription=svcDescription, sdpNumEntries=sdpNumEntries, custPhone=custPhone, svcNumSdps=svcNumSdps, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSapNotif=prvtSapNotif, ServiceAdminStatus=ServiceAdminStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSdpCreated=prvtSdpCreated, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, ServType=ServType, sdpTransportTunnelName=sdpTransportTunnelName, SdpIdType=SdpIdType, sapAdminStatus=sapAdminStatus, prvtSvcCreated=prvtSvcCreated, custMultSvcSiteName=custMultSvcSiteName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custNumEntries=custNumEntries, svcType=svcType, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custInfoEntry=custInfoEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSapTraps=prvtSapTraps, sapBaseInfoEntry=sapBaseInfoEntry, prvtSvcDeleted=prvtSvcDeleted, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, PYSNMP_MODULE_ID=prvtServicesMIB, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpLabelSignaling=sdpLabelSignaling, svcRowStatus=svcRowStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpOutInterface=sdpOutInterface, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueId=sapIngQosQueueId)
