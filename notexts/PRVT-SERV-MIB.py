...
TSapEgressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtCustTraps=prvtCustTraps, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpRowStatus=sdpRowStatus, ServObjDesc=ServObjDesc, svcMtu=svcMtu, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapDescription=sapDescription, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcDescription=svcDescription, prvtSdpDeleted=prvtSdpDeleted, sapIngQosSchedName=sapIngQosSchedName, prvtTMTstpConformance=prvtTMTstpConformance, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custIngQosSchedName=custIngQosSchedName, prvtSdpNotif=prvtSdpNotif, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custContact=custContact, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custLastMgmtChange=custLastMgmtChange, prvtCustDeleted=prvtCustDeleted, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSapTraps=prvtSapTraps, sapOperFlags=sapOperFlags, svcNumSdps=svcNumSdps, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMServConformance=prvtTMServConformance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMCustObjs=prvtTMCustObjs, sdpDelivery=sdpDelivery, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcOperStatus=svcOperStatus, custMultSvcSiteDescription=custMultSvcSiteDescription, svcLastStatusChange=svcLastStatusChange, sdpFarEndIpAddress=sdpFarEndIpAddress, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSapCreated=prvtSapCreated, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpOperIsBackup=sdpOperIsBackup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultiServiceSiteTable=custMultiServiceSiteTable, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcVPLSUplinkTable=svcVPLSUplinkTable, svcRowStatus=svcRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, ServiceOperStatus=ServiceOperStatus, prvtTMSapConformance=prvtTMSapConformance, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueId=sapEgrQosQueueId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, ServType=ServType, TSapIngQueueId=TSapIngQueueId, svcNumEntries=svcNumEntries, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustGroups=prvtTMCustGroups, prvtTMSdpCompliances=prvtTMSdpCompliances, sapRowStatus=sapRowStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueId=sapIngQosQueueId, sdpOutInterface=sdpOutInterface, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSapCompliances=prvtTMSapCompliances, custInfoEntry=custInfoEntry, svcCustName=svcCustName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpLabelSignaling=sdpLabelSignaling, sdpAdminIsBackup=sdpAdminIsBackup, ServObjName=ServObjName, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpLastStatusChange=sdpLastStatusChange, sdpDescription=sdpDescription, sdpLdpEnabled=sdpLdpEnabled, prvtSvcNotif=prvtSvcNotif, prvtServicesMIB=prvtServicesMIB, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpGroups=prvtTMSdpGroups, custInfoTable=custInfoTable, svcVplsMode=svcVplsMode, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapPortId=sapPortId, svcRevertTimer=svcRevertTimer, svcVpnId=svcVpnId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSvcDeleted=prvtSvcDeleted, sapLearnMode=sapLearnMode, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcBaseInfoTable=svcBaseInfoTable, sapOperStatus=sapOperStatus, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapBaseInfoTable=sapBaseInfoTable, sdpBindVlanTag=sdpBindVlanTag, sapType=sapType, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapNumEntries=sapNumEntries, sapBaseInfoEntry=sapBaseInfoEntry, PYSNMP_MODULE_ID=prvtServicesMIB, sdpType=sdpType, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpNextFreeId=sdpNextFreeId, TMEncapVal=TMEncapVal, sdpMtu=sdpMtu, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultSvcSiteName=custMultSvcSiteName, TSapEgrQueueId=TSapEgrQueueId, custNumEntries=custNumEntries, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custRowStatus=custRowStatus, sdpNumEntries=sdpNumEntries, sdpInfoTable=sdpInfoTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosCustName=sapEgrQosCustName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custPhone=custPhone, prvtCustCreated=prvtCustCreated, custEgrQosSchedName=custEgrQosSchedName, sdpAdminStatus=sdpAdminStatus, sapLastMgmtChange=sapLastMgmtChange, prvtSdpCreated=prvtSdpCreated, prvtSvcCreated=prvtSvcCreated, prvtTMSvcGroups=prvtTMSvcGroups, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpGroupIdentifier=sdpGroupIdentifier, prvtSdpTraps=prvtSdpTraps, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custName=custName, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpVCType=sdpVCType, prvtSdpStatusChanged=prvtSdpStatusChanged, svcId=svcId, prvtSapNotif=prvtSapNotif, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapAdminStatus=sapAdminStatus, svcBaseInfoEntry=svcBaseInfoEntry, sdpInfoEntry=sdpInfoEntry, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSapDeleted=prvtSapDeleted, prvtTMCustCompliances=prvtTMCustCompliances, sdpOperFlags=sdpOperFlags, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtServNotifications=prvtServNotifications, sdpTransportTunnelName=sdpTransportTunnelName, sapEncapValue=sapEncapValue, sdpId=sdpId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, VpnId=VpnId, svcNumSaps=svcNumSaps, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSapGroups=prvtTMSapGroups, prvtTMServObjs=prvtTMServObjs, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, ServiceAdminStatus=ServiceAdminStatus, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcLastMgmtChange=svcLastMgmtChange, prvtCustNotif=prvtCustNotif, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, SdpIdType=SdpIdType, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, svcType=svcType, sapIngQosSchedCustName=sapIngQosSchedCustName)
