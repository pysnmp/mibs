...
MacAddress, RowStatus, TruthValue, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceId=serviceId, sapMacLearningProfileState=sapMacLearningProfileState, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sapType=sapType, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpOperStatus=sdpOperStatus, serviceDescription=serviceDescription, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceVlanEtherType=serviceVlanEtherType, prvtServicesMIB=prvtServicesMIB, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceType=serviceType, sdpSignalPwStatus=sdpSignalPwStatus, sdpTable=sdpTable, customerName=customerName, sdpOperFlags=sdpOperFlags, sapDescription=sapDescription, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, serviceDeleted=serviceDeleted, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, customerRowStatus=customerRowStatus, sapDeleted=sapDeleted, serviceLastMgmtChange=serviceLastMgmtChange, serviceMacAddressSapEntry=serviceMacAddressSapEntry, serviceRevertTimer=serviceRevertTimer, sdpType=sdpType, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceNumSdps=serviceNumSdps, serviceEntry=serviceEntry, sdpTransportTunnelName=sdpTransportTunnelName, sdpNextFreeId=sdpNextFreeId, sdpGroupIdentifier=sdpGroupIdentifier, sapCustMultSvcSiteName=sapCustMultSvcSiteName, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sapOperStatus=sapOperStatus, sapTable=sapTable, sdpEntry=sdpEntry, sapEncapValue=sapEncapValue, sdpLabelSignaling=sdpLabelSignaling, sdpSecuredEnable=sdpSecuredEnable, prvtServicesMIBNotifications=prvtServicesMIBNotifications, serviceVlanAction=serviceVlanAction, serviceRowStatus=serviceRowStatus, customerContact=customerContact, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, sapCreated=sapCreated, sdpLastMgmtChange=sdpLastMgmtChange, sdpAdminStatus=sdpAdminStatus, serviceMacAddressSapPriority=serviceMacAddressSapPriority, serviceTable=serviceTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sapPortId=sapPortId, sdpCreated=sdpCreated, sdpPwActivate=sdpPwActivate, customerTable=customerTable, sdpId=sdpId, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpDeleted=sdpDeleted, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpLdpEnabled=sdpLdpEnabled, sdpLearnEnable=sdpLearnEnable, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sapOperFlags=sapOperFlags, sdpBindVlanTag=sdpBindVlanTag, sdpVCType=sdpVCType, customerDeleted=customerDeleted, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpPwPrecedence=sdpPwPrecedence, customerPhone=customerPhone, customerCreated=customerCreated, serviceMtu=serviceMtu, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceCustName=serviceCustName, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpDescription=sdpDescription, sdpOutInterface=sdpOutInterface, serviceNumSaps=serviceNumSaps, serviceAdminStatus=serviceAdminStatus, sapCurrentMacCount=sapCurrentMacCount, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEntry=sapEntry, serviceOperStatus=serviceOperStatus, sdpDelivery=sdpDelivery, PYSNMP_MODULE_ID=prvtServicesMIB, sapLearnMode=sapLearnMode, serviceCreated=serviceCreated, customerEntry=customerEntry, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapRowStatus=sapRowStatus, sdpMtu=sdpMtu, sdpRowStatus=sdpRowStatus, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, prvtServicesMIBObjects=prvtServicesMIBObjects, sapProfileName=sapProfileName, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceVpnId=serviceVpnId, sapUntaggedMode=sapUntaggedMode, sapLastMgmtChange=sapLastMgmtChange, sapLearnEnable=sapLearnEnable, sapAdminStatus=sapAdminStatus, serviceEnableSecureSaps=serviceEnableSecureSaps)
