...
serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone")
...
TextualConvention, TruthValue, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtCustTraps=prvtCustTraps, sdpBindVlanTag=sdpBindVlanTag, prvtTMServObjs=prvtTMServObjs, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcType=svcType, custLastMgmtChange=custLastMgmtChange, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMCustCompliances=prvtTMCustCompliances, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServiceAdminStatus=ServiceAdminStatus, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSdpObjs=prvtTMSdpObjs, custPhone=custPhone, prvtTMCustConformance=prvtTMCustConformance, custName=custName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSapObjs=prvtTMSapObjs, svcNumSdps=svcNumSdps, svcVplsMode=svcVplsMode, custMultiServiceSiteEntry=custMultiServiceSiteEntry, TSapEgrQueueId=TSapEgrQueueId, sapType=sapType, sdpLastMgmtChange=sdpLastMgmtChange, sdpMtu=sdpMtu, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custIngQosSchedName=custIngQosSchedName, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapBaseInfoTable=sapBaseInfoTable, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapLearnMode=sapLearnMode, prvtTMServConformance=prvtTMServConformance, sapOperStatus=sapOperStatus, prvtTMCustGroups=prvtTMCustGroups, svcOperStatus=svcOperStatus, sapLastMgmtChange=sapLastMgmtChange, sdpOperIsBackup=sdpOperIsBackup, VpnId=VpnId, sapEncapValue=sapEncapValue, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSapNotif=prvtSapNotif, svcVpnId=svcVpnId, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custRowStatus=custRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpNotif=prvtSdpNotif, prvtCustDeleted=prvtCustDeleted, sdpOutInterface=sdpOutInterface, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSvcCompliance=prvtTMSvcCompliance, svcRowStatus=svcRowStatus, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcId=svcId, ServObjName=ServObjName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosSchedName=sapEgrQosSchedName, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custContact=custContact, prvtSapDeleted=prvtSapDeleted, prvtTMSvcCompliances=prvtTMSvcCompliances, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, TMEncapVal=TMEncapVal, prvtSvcCreated=prvtSvcCreated, svcCustName=svcCustName, sdpId=sdpId, sdpLastStatusChange=sdpLastStatusChange, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueId=sapEgrQosQueueId, sdpAdminIsBackup=sdpAdminIsBackup, prvtSvcTraps=prvtSvcTraps, sapEgrQosCustName=sapEgrQosCustName, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcEnableSecureSaps=svcEnableSecureSaps, sdpType=sdpType, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosSchedName=custEgrQosSchedName, prvtSapTraps=prvtSapTraps, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpNextFreeId=sdpNextFreeId, custInfoEntry=custInfoEntry, prvtSdpDeleted=prvtSdpDeleted, sdpLdpEnabled=sdpLdpEnabled, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpGroupIdentifier=sdpGroupIdentifier, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpInfoTable=sdpInfoTable, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapOperFlags=sapOperFlags, prvtSapStatusChanged=prvtSapStatusChanged, sdpDescription=sdpDescription, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, ServObjDesc=ServObjDesc, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcNumEntries=svcNumEntries, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtCustNotif=prvtCustNotif, prvtSdpCreated=prvtSdpCreated, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSdpConformance=prvtTMSdpConformance, sdpRowStatus=sdpRowStatus, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSdpTraps=prvtSdpTraps, sdpLabelSignaling=sdpLabelSignaling, prvtCustCreated=prvtCustCreated, sdpVCType=sdpVCType, sdpTransportTunnelName=sdpTransportTunnelName, sdpDelivery=sdpDelivery, prvtTMSapGroups=prvtTMSapGroups, custInfoTable=custInfoTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, custNumEntries=custNumEntries, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMTstpConformance=prvtTMTstpConformance, sapPortId=sapPortId, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSapCreated=prvtSapCreated, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, svcMtu=svcMtu, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapAdminStatus=sapAdminStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, TSapIngQueueId=TSapIngQueueId, sapRowStatus=sapRowStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSvcDeleted=prvtSvcDeleted, sapDescription=sapDescription, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtSvcNotif=prvtSvcNotif, prvtTMCustObjs=prvtTMCustObjs, sdpInfoEntry=sdpInfoEntry, ServType=ServType, SdpIdType=SdpIdType, sapIngQosCustName=sapIngQosCustName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcBaseInfoTable=svcBaseInfoTable, custMultiServiceSiteTable=custMultiServiceSiteTable, svcBaseInfoEntry=svcBaseInfoEntry, ServiceOperStatus=ServiceOperStatus, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcNumSaps=svcNumSaps, prvtTMSdpGroups=prvtTMSdpGroups, prvtServNotifications=prvtServNotifications, PYSNMP_MODULE_ID=prvtServicesMIB, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngQosQueueId=sapIngQosQueueId, svcRevertTimer=svcRevertTimer, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpOperFlags=sdpOperFlags, prvtServicesMIB=prvtServicesMIB, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcDescription=svcDescription, sapNumEntries=sapNumEntries, sapEgressQosPolicyId=sapEgressQosPolicyId)
