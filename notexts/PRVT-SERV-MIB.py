...
serviceAccessSwitch, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteName=custMultSvcSiteName, TSapIngQueueId=TSapIngQueueId, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpAdminIsBackup=sdpAdminIsBackup, sapBaseInfoTable=sapBaseInfoTable, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpMtu=sdpMtu, sapAdminStatus=sapAdminStatus, prvtTMSdpObjs=prvtTMSdpObjs, SdpIdType=SdpIdType, prvtTMSapConformance=prvtTMSapConformance, TMEncapVal=TMEncapVal, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpOperIsBackup=sdpOperIsBackup, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpVCType=sdpVCType, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcOperStatus=svcOperStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosQueueId=sapEgrQosQueueId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcNumSaps=svcNumSaps, prvtTMSvcObjs=prvtTMSvcObjs, prvtSvcDeleted=prvtSvcDeleted, ServObjDesc=ServObjDesc, svcNumSdps=svcNumSdps, svcAdminStatus=svcAdminStatus, svcVplsMode=svcVplsMode, sapType=sapType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpNextFreeId=sdpNextFreeId, svcBaseInfoEntry=svcBaseInfoEntry, prvtServicesMIB=prvtServicesMIB, sapIngQosSchedName=sapIngQosSchedName, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtCustTraps=prvtCustTraps, sapIngQosQueueId=sapIngQosQueueId, svcLastMgmtChange=svcLastMgmtChange, sapLearnMode=sapLearnMode, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, ServType=ServType, sdpAdminStatus=sdpAdminStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapDescription=sapDescription, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVpnId=svcVpnId, prvtSvcNotif=prvtSvcNotif, sdpBindVlanTag=sdpBindVlanTag, prvtTMCustObjs=prvtTMCustObjs, VpnId=VpnId, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMServObjs=prvtTMServObjs, sapIngQosCustName=sapIngQosCustName, svcBaseInfoTable=svcBaseInfoTable, sapOperFlags=sapOperFlags, sdpLastStatusChange=sdpLastStatusChange, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custInfoEntry=custInfoEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSapGroups=prvtTMSapGroups, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosSchedName=sapEgrQosSchedName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, ServiceAdminStatus=ServiceAdminStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpLdpEnabled=sdpLdpEnabled, ServiceOperStatus=ServiceOperStatus, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcLastStatusChange=svcLastStatusChange, prvtCustNotif=prvtCustNotif, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSvcGroups=prvtTMSvcGroups, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSdpGroups=prvtTMSdpGroups, sdpOutInterface=sdpOutInterface, sapNumEntries=sapNumEntries, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, TSapEgrQueueId=TSapEgrQueueId, prvtTMCustConformance=prvtTMCustConformance, PYSNMP_MODULE_ID=prvtServicesMIB, custIngQosSchedName=custIngQosSchedName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtCustDeleted=prvtCustDeleted, svcEnableSecureSaps=svcEnableSecureSaps, custInfoTable=custInfoTable, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSdpCompliance=prvtTMSdpCompliance, sapRowStatus=sapRowStatus, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSapCompliance=prvtTMSapCompliance, sdpInfoEntry=sdpInfoEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcDescription=svcDescription, svcMtu=svcMtu, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSapCreated=prvtSapCreated, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtServNotifications=prvtServNotifications, custContact=custContact, sdpDelivery=sdpDelivery, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSapCompliances=prvtTMSapCompliances, prvtSvcCreated=prvtSvcCreated, sdpId=sdpId, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpDescription=sdpDescription, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcNumEntries=svcNumEntries, custName=custName, sdpOperFlags=sdpOperFlags, prvtSapDeleted=prvtSapDeleted, prvtTMSapObjs=prvtTMSapObjs, prvtSdpDeleted=prvtSdpDeleted, prvtSapStatusChanged=prvtSapStatusChanged, ServObjName=ServObjName, svcCustName=svcCustName, sapPortId=sapPortId, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpOperStatus=sdpOperStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMCustGroups=prvtTMCustGroups, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapLastMgmtChange=sapLastMgmtChange, sdpLabelSignaling=sdpLabelSignaling, prvtSapNotif=prvtSapNotif, sapEncapValue=sapEncapValue, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSvcTraps=prvtSvcTraps, custNumEntries=custNumEntries, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosSchedName=custEgrQosSchedName, sapEgrQosCustName=sapEgrQosCustName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpType=sdpType, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSapTraps=prvtSapTraps, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpLastMgmtChange=sdpLastMgmtChange, custLastMgmtChange=custLastMgmtChange, sdpRowStatus=sdpRowStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpNumEntries=sdpNumEntries, sdpInfoTable=sdpInfoTable, prvtSdpNotif=prvtSdpNotif, prvtSdpCreated=prvtSdpCreated, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custPhone=custPhone, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapOperStatus=sapOperStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcRowStatus=svcRowStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcType=svcType, svcId=svcId, svcRevertTimer=svcRevertTimer, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtCustCreated=prvtCustCreated, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, custRowStatus=custRowStatus)
