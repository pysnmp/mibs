...
TimeStamp, RowStatus, DisplayString, TextualConvention, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "DisplayString", "TextualConvention", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapOperStatus=sapOperStatus, sdpOperFlags=sdpOperFlags, sdpNextFreeId=sdpNextFreeId, sdpVCType=sdpVCType, customerName=customerName, sdpDelivery=sdpDelivery, serviceDeleted=serviceDeleted, customerDeleted=customerDeleted, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpDescription=sdpDescription, sapEncapValue=sapEncapValue, sdpPwActivate=sdpPwActivate, sdpOutInterface=sdpOutInterface, customerContact=customerContact, serviceVpnId=serviceVpnId, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpLabelSignaling=sdpLabelSignaling, sapLastMgmtChange=sapLastMgmtChange, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, serviceEntry=serviceEntry, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpLearnEnable=sdpLearnEnable, sapRowStatus=sapRowStatus, sapCurrentMacCount=sapCurrentMacCount, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sapDescription=sapDescription, sapLearnMode=sapLearnMode, serviceCustName=serviceCustName, serviceRevertTimer=serviceRevertTimer, serviceVlanEtherType=serviceVlanEtherType, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpSecuredEnable=sdpSecuredEnable, sdpId=sdpId, serviceEnableSecureSaps=serviceEnableSecureSaps, sapOperFlags=sapOperFlags, sdpAdminStatus=sdpAdminStatus, sapCreated=sapCreated, sapType=sapType, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpTable=sdpTable, sapPortId=sapPortId, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceDescription=serviceDescription, sapUntaggedMode=sapUntaggedMode, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapAdminStatus=sapAdminStatus, sdpSignalPwStatus=sdpSignalPwStatus, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpLdpEnabled=sdpLdpEnabled, sapCustMultSvcSiteName=sapCustMultSvcSiteName, customerPhone=customerPhone, sdpPwPrecedence=sdpPwPrecedence, customerCreated=customerCreated, serviceLastMgmtChange=serviceLastMgmtChange, prvtServicesMIB=prvtServicesMIB, sdpAdminEgressLabel=sdpAdminEgressLabel, sapProfileName=sapProfileName, sapTable=sapTable, serviceCreated=serviceCreated, sapDeleted=sapDeleted, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpMtu=sdpMtu, sdpType=sdpType, serviceRowStatus=serviceRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, customerRowStatus=customerRowStatus, serviceId=serviceId, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSdpTable=serviceMacAddressSdpTable, serviceVlanAction=serviceVlanAction, serviceNumSaps=serviceNumSaps, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sdpCreated=sdpCreated, serviceType=serviceType, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sapLearnEnable=sapLearnEnable, serviceOperStatus=serviceOperStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpLastMgmtChange=sdpLastMgmtChange, serviceAdminStatus=serviceAdminStatus, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, serviceNumSdps=serviceNumSdps, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMtu=serviceMtu, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEntry=sapEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, customerTable=customerTable, sapMacLearningProfileState=sapMacLearningProfileState, customerEntry=customerEntry, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpTransportTunnelName=sdpTransportTunnelName, sdpRowStatus=sdpRowStatus, serviceTable=serviceTable, PYSNMP_MODULE_ID=prvtServicesMIB, sdpEntry=sdpEntry, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpOperStatus=sdpOperStatus, sdpDeleted=sdpDeleted)
