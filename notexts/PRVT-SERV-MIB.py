...
TNamedItem, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpLabelSignaling=sdpLabelSignaling, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpAdminIsBackup=sdpAdminIsBackup, sapLastMgmtChange=sapLastMgmtChange, sdpRowStatus=sdpRowStatus, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSapCompliance=prvtTMSapCompliance, ServObjDesc=ServObjDesc, prvtTMSdpCompliance=prvtTMSdpCompliance, custContact=custContact, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustCompliance=prvtTMCustCompliance, custInfoEntry=custInfoEntry, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcEnableSecureSaps=svcEnableSecureSaps, svcVplsMode=svcVplsMode, prvtSapDeleted=prvtSapDeleted, sdpLastStatusChange=sdpLastStatusChange, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custRowStatus=custRowStatus, sdpGroupIdentifier=sdpGroupIdentifier, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSapCompliances=prvtTMSapCompliances, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpDelivery=sdpDelivery, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcLastStatusChange=svcLastStatusChange, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcRevertTimer=svcRevertTimer, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSvcDeleted=prvtSvcDeleted, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpLdpEnabled=sdpLdpEnabled, svcRowStatus=svcRowStatus, svcType=svcType, sapOperFlags=sapOperFlags, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSvcNotif=prvtSvcNotif, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpId=sdpId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapAdminStatus=sapAdminStatus, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcCreated=prvtSvcCreated, sapDescription=sapDescription, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtSdpTraps=prvtSdpTraps, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcBaseInfoTable=svcBaseInfoTable, sapIngQosSchedName=sapIngQosSchedName, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpDescription=sdpDescription, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustObjs=prvtTMCustObjs, ServiceOperStatus=ServiceOperStatus, sdpOutInterface=sdpOutInterface, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, TMEncapVal=TMEncapVal, sapLearnMode=sapLearnMode, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpNumEntries=sdpNumEntries, custMultSvcSiteName=custMultSvcSiteName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtCustNotif=prvtCustNotif, sdpInfoEntry=sdpInfoEntry, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpType=sdpType, prvtSdpNotif=prvtSdpNotif, prvtTMSdpGroups=prvtTMSdpGroups, SdpIdType=SdpIdType, prvtSapTraps=prvtSapTraps, prvtTMCustGroups=prvtTMCustGroups, sdpMtu=sdpMtu, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgrQosSchedName=sapEgrQosSchedName, TSapIngQueueId=TSapIngQueueId, prvtTMSdpConformance=prvtTMSdpConformance, svcId=svcId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSdpObjs=prvtTMSdpObjs, sdpVCType=sdpVCType, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtSdpDeleted=prvtSdpDeleted, prvtTMServObjs=prvtTMServObjs, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMSapConformance=prvtTMSapConformance, prvtTMSvcConformance=prvtTMSvcConformance, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEncapValue=sapEncapValue, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custInfoTable=custInfoTable, prvtSvcTraps=prvtSvcTraps, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custNumEntries=custNumEntries, prvtTMServConformance=prvtTMServConformance, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosCustName=sapIngQosCustName, sdpAdminStatus=sdpAdminStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtCustTraps=prvtCustTraps, custName=custName, sapType=sapType, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, PYSNMP_MODULE_ID=prvtServicesMIB, svcMtu=svcMtu, svcNumSdps=svcNumSdps, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpNextFreeId=sdpNextFreeId, ServObjName=ServObjName, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosSchedName=custEgrQosSchedName, svcAdminStatus=svcAdminStatus, custLastMgmtChange=custLastMgmtChange, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgrQosCustName=sapEgrQosCustName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapBaseInfoTable=sapBaseInfoTable, svcDescription=svcDescription, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcBaseInfoEntry=svcBaseInfoEntry, svcCustName=svcCustName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapPortId=sapPortId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcOperStatus=svcOperStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custMultiServiceSiteTable=custMultiServiceSiteTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcNumSaps=svcNumSaps, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, TSapEgrQueueId=TSapEgrQueueId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustCompliances=prvtTMCustCompliances, svcNumEntries=svcNumEntries, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSapNotif=prvtSapNotif, sapNumEntries=sapNumEntries, prvtCustCreated=prvtCustCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpOperStatus=sdpOperStatus, custPhone=custPhone, svcLastMgmtChange=svcLastMgmtChange, custIngQosSchedName=custIngQosSchedName, prvtSapStatusChanged=prvtSapStatusChanged, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpOperFlags=sdpOperFlags, sdpBindVlanTag=sdpBindVlanTag, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSapCreated=prvtSapCreated, prvtServNotifications=prvtServNotifications, sdpInfoTable=sdpInfoTable, ServiceAdminStatus=ServiceAdminStatus, svcVpnId=svcVpnId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, ServType=ServType, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpOperIsBackup=sdpOperIsBackup, prvtServicesMIB=prvtServicesMIB, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSdpCreated=prvtSdpCreated, sapRowStatus=sapRowStatus, VpnId=VpnId, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapOperStatus=sapOperStatus, prvtTMCustConformance=prvtTMCustConformance)
