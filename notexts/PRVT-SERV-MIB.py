...
TNamedItem, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosSchedName=sapEgrQosSchedName, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMCustCompliances=prvtTMCustCompliances, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpType=sdpType, prvtSdpTraps=prvtSdpTraps, custPhone=custPhone, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSapCompliance=prvtTMSapCompliance, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpLdpEnabled=sdpLdpEnabled, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, TSapIngQueueId=TSapIngQueueId, sdpLabelSignaling=sdpLabelSignaling, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSdpCreated=prvtSdpCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMCustConformance=prvtTMCustConformance, sapIngQosSchedCustName=sapIngQosSchedCustName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSapObjs=prvtTMSapObjs, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, TMEncapVal=TMEncapVal, prvtSvcNotif=prvtSvcNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, ServType=ServType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcBaseInfoEntry=svcBaseInfoEntry, sapType=sapType, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosCustName=sapEgrQosCustName, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpAdminIngressLabel=sdpAdminIngressLabel, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtCustDeleted=prvtCustDeleted, prvtSapCreated=prvtSapCreated, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpId=sdpId, custLastMgmtChange=custLastMgmtChange, svcVpnId=svcVpnId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, svcNumEntries=svcNumEntries, prvtCustTraps=prvtCustTraps, prvtCustCreated=prvtCustCreated, sdpBindVlanTag=sdpBindVlanTag, sdpDescription=sdpDescription, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMServObjs=prvtTMServObjs, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sdpInfoTable=sdpInfoTable, custRowStatus=custRowStatus, ServObjName=ServObjName, sdpAdminStatus=sdpAdminStatus, custMultSvcSiteName=custMultSvcSiteName, prvtTMSapGroups=prvtTMSapGroups, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapAdminStatus=sapAdminStatus, sdpNextFreeId=sdpNextFreeId, svcMtu=svcMtu, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, ServiceOperStatus=ServiceOperStatus, svcType=svcType, sapNumEntries=sapNumEntries, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosSchedName=custEgrQosSchedName, sapBaseInfoTable=sapBaseInfoTable, prvtSvcCreated=prvtSvcCreated, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapPortId=sapPortId, sdpRowStatus=sdpRowStatus, sdpVCType=sdpVCType, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpNumEntries=sdpNumEntries, sdpAdminIsBackup=sdpAdminIsBackup, ServObjDesc=ServObjDesc, prvtTMSdpGroups=prvtTMSdpGroups, prvtSdpDeleted=prvtSdpDeleted, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custNumEntries=custNumEntries, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustGroups=prvtTMCustGroups, custMultSvcSiteDescription=custMultSvcSiteDescription, ServiceAdminStatus=ServiceAdminStatus, svcLastStatusChange=svcLastStatusChange, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSapStatusChanged=prvtSapStatusChanged, SdpIdType=SdpIdType, custName=custName, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSvcDeleted=prvtSvcDeleted, sdpDelivery=sdpDelivery, sapLearnMode=sapLearnMode, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSdpCompliance=prvtTMSdpCompliance, sapDescription=sapDescription, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSapDeleted=prvtSapDeleted, prvtSvcStatusChanged=prvtSvcStatusChanged, svcRevertTimer=svcRevertTimer, svcId=svcId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapOperFlags=sapOperFlags, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custInfoTable=custInfoTable, custInfoEntry=custInfoEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sdpOperStatus=sdpOperStatus, prvtSvcTraps=prvtSvcTraps, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSapTraps=prvtSapTraps, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, TSapEgrQueueId=TSapEgrQueueId, custIngQosSchedName=custIngQosSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custContact=custContact, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcRowStatus=svcRowStatus, prvtTMCustObjs=prvtTMCustObjs, svcLastMgmtChange=svcLastMgmtChange, sapIngQosCustName=sapIngQosCustName, prvtTMSdpConformance=prvtTMSdpConformance, sdpOperFlags=sdpOperFlags, sdpLastStatusChange=sdpLastStatusChange, prvtServNotifications=prvtServNotifications, prvtCustNotif=prvtCustNotif, prvtTMSvcConformance=prvtTMSvcConformance, svcCustName=svcCustName, sdpInfoEntry=sdpInfoEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSapNotif=prvtSapNotif, prvtTMServConformance=prvtTMServConformance, svcNumSdps=svcNumSdps, prvtSdpNotif=prvtSdpNotif, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcNumSaps=svcNumSaps, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtServicesMIB=prvtServicesMIB, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, svcDescription=svcDescription, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpTransportTunnelName=sdpTransportTunnelName, sapRowStatus=sapRowStatus, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcOperStatus=svcOperStatus, sdpMtu=sdpMtu, sapIngQosSchedName=sapIngQosSchedName, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, VpnId=VpnId, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcVplsMode=svcVplsMode, prvtTMSvcGroups=prvtTMSvcGroups, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcBaseInfoTable=svcBaseInfoTable, sapEncapValue=sapEncapValue, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpOutInterface=sdpOutInterface)
