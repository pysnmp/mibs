...
TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapPortId=sapPortId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcType=svcType, sdpInfoEntry=sdpInfoEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcObjs=prvtTMSvcObjs, sapOperFlags=sapOperFlags, prvtCustTraps=prvtCustTraps, sdpVCType=sdpVCType, custContact=custContact, sdpOperStatus=sdpOperStatus, svcVplsMode=svcVplsMode, svcBaseInfoEntry=svcBaseInfoEntry, sapNumEntries=sapNumEntries, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSapCompliance=prvtTMSapCompliance, prvtSvcTraps=prvtSvcTraps, prvtTMSvcGroups=prvtTMSvcGroups, sdpBindVlanTag=sdpBindVlanTag, prvtTMSapCompliances=prvtTMSapCompliances, custRowStatus=custRowStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcVpnId=svcVpnId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMCustConformance=prvtTMCustConformance, sapLearnMode=sapLearnMode, sdpLabelSignaling=sdpLabelSignaling, prvtServNotifications=prvtServNotifications, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSapNotif=prvtSapNotif, svcEnableSecureSaps=svcEnableSecureSaps, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSdpConformance=prvtTMSdpConformance, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosSchedName=sapIngQosSchedName, sdpFarEndIpAddress=sdpFarEndIpAddress, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpNumEntries=sdpNumEntries, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtSdpNotif=prvtSdpNotif, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueId=sapIngQosQueueId, prvtCustDeleted=prvtCustDeleted, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSapGroups=prvtTMSapGroups, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpMtu=sdpMtu, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, ServiceAdminStatus=ServiceAdminStatus, sdpRowStatus=sdpRowStatus, sdpLdpEnabled=sdpLdpEnabled, sapIngQosCustName=sapIngQosCustName, sdpInfoTable=sdpInfoTable, sdpDelivery=sdpDelivery, prvtTMCustObjs=prvtTMCustObjs, prvtTMSdpGroups=prvtTMSdpGroups, prvtSapStatusChanged=prvtSapStatusChanged, custPhone=custPhone, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSvcCompliance=prvtTMSvcCompliance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMServObjs=prvtTMServObjs, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcMtu=svcMtu, prvtSdpStatusChanged=prvtSdpStatusChanged, sapAdminStatus=sapAdminStatus, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, svcRevertTimer=svcRevertTimer, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpOperFlags=sdpOperFlags, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMCustGroups=prvtTMCustGroups, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sdpAdminIsBackup=sdpAdminIsBackup, sapRowStatus=sapRowStatus, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcNumSaps=svcNumSaps, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapBaseInfoTable=sapBaseInfoTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosSchedName=sapEgrQosSchedName, svcId=svcId, prvtSapDeleted=prvtSapDeleted, custInfoTable=custInfoTable, svcNumEntries=svcNumEntries, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEncapValue=sapEncapValue, svcRowStatus=svcRowStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custIngQosSchedName=custIngQosSchedName, svcOperStatus=svcOperStatus, custLastMgmtChange=custLastMgmtChange, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapObjs=prvtTMSapObjs, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMCustCompliances=prvtTMCustCompliances, custMultiServiceSiteTable=custMultiServiceSiteTable, svcNumSdps=svcNumSdps, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpId=sdpId, sapType=sapType, prvtSdpCreated=prvtSdpCreated, prvtTMTstpConformance=prvtTMTstpConformance, custName=custName, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpNextFreeId=sdpNextFreeId, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapOperStatus=sapOperStatus, svcAdminStatus=svcAdminStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpLastStatusChange=sdpLastStatusChange, svcVPLSUplinkTable=svcVPLSUplinkTable, TSapIngQueueId=TSapIngQueueId, sdpDescription=sdpDescription, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, TSapEgrQueueId=TSapEgrQueueId, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, TMEncapVal=TMEncapVal, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSvcNotif=prvtSvcNotif, prvtSdpDeleted=prvtSdpDeleted, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpOutInterface=sdpOutInterface, prvtTMCustCompliance=prvtTMCustCompliance, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtCustNotif=prvtCustNotif, sapDescription=sapDescription, prvtTMServConformance=prvtTMServConformance, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcCustName=svcCustName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpAdminStatus=sdpAdminStatus, ServObjDesc=ServObjDesc, prvtSdpTraps=prvtSdpTraps, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgressQosPolicyId=sapEgressQosPolicyId, custMultSvcSiteDescription=custMultSvcSiteDescription, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcLastMgmtChange=svcLastMgmtChange, prvtTMSdpCompliances=prvtTMSdpCompliances, custNumEntries=custNumEntries, sdpType=sdpType, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosSchedName=custEgrQosSchedName, svcDescription=svcDescription, prvtSapCreated=prvtSapCreated, custInfoEntry=custInfoEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteName=custMultSvcSiteName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, ServType=ServType, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpLastMgmtChange=sdpLastMgmtChange, prvtServicesMIB=prvtServicesMIB, prvtCustCreated=prvtCustCreated, svcLastStatusChange=svcLastStatusChange, SdpIdType=SdpIdType, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSvcDeleted=prvtSvcDeleted, sdpTransportTunnelName=sdpTransportTunnelName, ServObjName=ServObjName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, VpnId=VpnId, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueId=sapEgrQosQueueId, prvtSapTraps=prvtSapTraps)
