...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Gauge32, ModuleIdentity, Counter64, iso, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("DSR4410MD-MIB", audio2Output=audio2Output, contrast=contrast, aspectRatioOutput=aspectRatioOutput, transponderNumber=transponderNumber, psk8CodeRate=psk8CodeRate, channelMib=channelMib, subtitleLanguage=subtitleLanguage, testSignals=testSignals, frequencyOffset=frequencyOffset, dvbS2codeRate=dvbS2codeRate, port2=port2, video=video, textSetup=textSetup, acpEncryptMode=acpEncryptMode, giMIB=giMIB, channelNumber=channelNumber, signalPower=signalPower, port2Polarity=port2Polarity, pmtMsgCount=pmtMsgCount, retuneMsgVirtChannel=retuneMsgVirtChannel, videoOutput625Lines=videoOutput625Lines, clearCounters=clearCounters, signalStatus=signalStatus, satelliteName=satelliteName, downloadLED=downloadLED, codeDownloadBit=codeDownloadBit, audio1LeftGain=audio1LeftGain, fingerPrintMessageCount=fingerPrintMessageCount, signalLED=signalLED, acquisitionState=acquisitionState, subtitleMsgCount=subtitleMsgCount, clearrserror=clearrserror, serviceNumber=serviceNumber, audio2RightLanguageStatus=audio2RightLanguageStatus, defaultGateway=defaultGateway, audio1RightGain=audio1RightGain, gigEsubnetMask=gigEsubnetMask, retuneMsgActivationTime=retuneMsgActivationTime, symbolRate=symbolRate, macAddr=macAddr, cueToneSignal=cueToneSignal, resetIRD=resetIRD, primaryAudioPID=primaryAudioPID, videoOutput525Lines=videoOutput525Lines, firmwareVersion=firmwareVersion, org=org, acpAuthState=acpAuthState, channelStatus=channelStatus, audio2LeftLanguage=audio2LeftLanguage, retuneMonitorMIB=retuneMonitorMIB, retuneMsgVirtNetworkIDindex=retuneMsgVirtNetworkIDindex, lnbPower=lnbPower, audio1TestPattern=audio1TestPattern, lostlockcount=lostlockcount, caMsgCount=caMsgCount, dataStatus=dataStatus, extHardwareMib=extHardwareMib, acpMib=acpMib, videoTestPattern=videoTestPattern, polarization=polarization, channelNum=channelNum, statusMib=statusMib, dsr=dsr, audio2RightLanguage=audio2RightLanguage, tvPasscard=tvPasscard, signalQuality=signalQuality, private=private, secondaryAudioLock=secondaryAudioLock, screenDisplay=screenDisplay, audio2DownMix=audio2DownMix, audio1Compression=audio1Compression, channelSelect=channelSelect, freq=freq, audio1GainControl=audio1GainControl, rserror=rserror, mode=mode, muxStatus=muxStatus, identUnitModel=identUnitModel, ethernet10_100=ethernet10_100, diagnosticMib=diagnosticMib, audio2GainControl=audio2GainControl, unitControlMib=unitControlMib, satelliteStatus=satelliteStatus, identificationGroup=identificationGroup, subtitleLanguageStatus=subtitleLanguageStatus, uimMsgCount=uimMsgCount, dod=dod, irdStatus=irdStatus, snr=snr, ber=ber, gigEmode=gigEmode, vctID=vctID, retuneMsgCnt=retuneMsgCnt, ethernetIP=ethernetIP, retuneMsgVCTid=retuneMsgVCTid, audio1Output=audio1Output, audio2LeftLanguageStatus=audio2LeftLanguageStatus, unitAddress=unitAddress, ethernetGigE=ethernetGigE, retuneMonitorEnable=retuneMonitorEnable, rfPortsMib=rfPortsMib, niMsgCount=niMsgCount, virtualChannelMsgCount=virtualChannelMsgCount, secondaryAudioPID=secondaryAudioPID, audio1LeftLanguage=audio1LeftLanguage, unitControl=unitControl, asiEnable=asiEnable, dvbS2symbolRate=dvbS2symbolRate, coMsgCount=coMsgCount, audio1RightLanguage=audio1RightLanguage, enterprises=enterprises, port1SetupMode=port1SetupMode, alarmTrigger=alarmTrigger, accessControl=accessControl, audio1Config=audio1Config, audio1RightLanguageStatus=audio1RightLanguageStatus, messages=messages, testMib=testMib, mptsIpAddr=mptsIpAddr, subnetMask=subnetMask, ipAddress=ipAddress, PYSNMP_MODULE_ID=dsr, alarmConditionLED=alarmConditionLED, authorizedLED=authorizedLED, aspectRatioInput=aspectRatioInput, bootVersion=bootVersion, frequency=frequency, audioOutput=audioOutput, psk8SymbolRate=psk8SymbolRate, alarmLEDBlinkStatus=alarmLEDBlinkStatus, audio2DiagNorm=audio2DiagNorm, activePort=activePort, unitAddr=unitAddr, acpProgram=acpProgram, videoLock=videoLock, line=line, clearlostlockcount=clearlostlockcount, internet=internet, port2SetupMode=port2SetupMode, gigEmacAddr=gigEmacAddr, firmware=firmware, audio2LeftGain=audio2LeftGain, audio1DiagNorm=audio1DiagNorm, acpIndex=acpIndex, encryptionMode=encryptionMode, codeDownload=codeDownload, audio1DownMix=audio1DownMix, audio=audio, alarms=alarms, port2Satellite=port2Satellite, symbolCodeBit=symbolCodeBit, acpMode=acpMode, upgradeFirmwareVersion=upgradeFirmwareVersion, diagnosticScreen=diagnosticScreen, networkTextMsgCount=networkTextMsgCount, fecRate=fecRate, retuneMsgStatistic=retuneMsgStatistic, ebno=ebno, ebNo=ebNo, dvbCodeRate=dvbCodeRate, audio1LeftLanguageStatus=audio1LeftLanguageStatus, dataMib=dataMib, falseLock=falseLock, retuneMsgCRC=retuneMsgCRC, waveform=waveform, primaryAudioLock=primaryAudioLock, gigEipAddress=gigEipAddress, subtitleDisplay=subtitleDisplay, dwnldMsgCount=dwnldMsgCount, ledStatus=ledStatus, audio2Compression=audio2Compression, source=source, videoMib=videoMib, authorizationState=authorizationState, patMsgCount=patMsgCount, dwnldPreMsgCount=dwnldPreMsgCount, port1Polarity=port1Polarity, field=field, port1Satellite=port1Satellite, modulationMode=modulationMode, vctIDFast=vctIDFast, fpgaVersion=fpgaVersion, formatRate=formatRate, evenBlkoutMsgCount=evenBlkoutMsgCount, giproducts=giproducts, rfPortsSetup=rfPortsSetup, mpegServiceNumber=mpegServiceNumber, audio2RightGain=audio2RightGain, audio2TestPattern=audio2TestPattern, alarmLedStatus=alarmLedStatus, audioConfig=audioConfig, serviceSelectionMib=serviceSelectionMib, emmMsgCount=emmMsgCount, mptsPort=mptsPort, audio2Config=audio2Config, alarmTest=alarmTest, acpUnitAddress=acpUnitAddress, xpndrNumber=xpndrNumber, videoPID=videoPID, identMIBVersion=identMIBVersion, acpKeyStream=acpKeyStream, port1=port1, vits=vits, hcmMsgCount=hcmMsgCount, manualTune=manualTune, rf=rf, dvbSymbolRate=dvbSymbolRate, transponder=transponder, falseLockStatus=falseLockStatus, audioMib=audioMib, gigEgateway=gigEgateway)
