...
# ASN.1 source DISMAN-SCHEDULE-MIB
# Source digest sha256:f50858be6395545ab476c3620ffcc89070156ab4aa45289d56326a55811a8adc
...
DateAndTime, DisplayString, RowStatus, StorageType, TextualConvention, VariablePointer = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "RowStatus", "StorageType", "TextualConvention", "VariablePointer")
schedMIB = ModuleIdentity((1, 3, 6, 1, 2, 1, 63))
schedMIB.setRevisions(('2002-01-07 00:00', '1998-11-17 18:00',))
if mibBuilder.loadTexts: schedMIB.setLastUpdated('2002-01-07 00:00')
...
schedTable = MibTable((1, 3, 6, 1, 2, 1, 63, 1, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: schedTable.setStatus('current')
schedEntry = MibTableRow((1, 3, 6, 1, 2, 1, 63, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DISMAN-SCHEDULE-MIB", "schedOwner"), (0, "DISMAN-SCHEDULE-MIB", "schedName"))
if mibBuilder.loadTexts: schedEntry.setStatus('current')
schedOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 63, 1, 2, 1, 1), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(0, 32))).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: schedOwner.setStatus('current')
schedName = MibTableColumn((1, 3, 6, 1, 2, 1, 63, 1, 2, 1, 2), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32))).setMaxAccess("notaccessible")
...
schedInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 63, 1, 2, 1, 4), Unsigned32().clone(0)).setUnits('seconds').setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("DISMAN-SCHEDULE-MIB", PYSNMP_MODULE_ID=schedMIB, SnmpPduErrorStatus=SnmpPduErrorStatus, schedActionFailure=schedActionFailure, schedAdminStatus=schedAdminStatus, schedCalendarGroup=schedCalendarGroup, schedCompliance2=schedCompliance2, schedCompliance=schedCompliance, schedCompliances=schedCompliances, schedConformance=schedConformance, schedContextName=schedContextName, schedDay=schedDay, schedDescr=schedDescr, schedEntry=schedEntry, schedFailures=schedFailures, schedGroup2=schedGroup2, schedGroup=schedGroup, schedGroups=schedGroups, schedHour=schedHour, schedInterval=schedInterval, schedLastFailed=schedLastFailed, schedLastFailure=schedLastFailure, schedLocalTime=schedLocalTime, schedMIB=schedMIB, schedMinute=schedMinute, schedMonth=schedMonth, schedName=schedName, schedNotifications=schedNotifications, schedNotificationsGroup=schedNotificationsGroup, schedObjects=schedObjects, schedOperStatus=schedOperStatus, schedOwner=schedOwner, schedRowStatus=schedRowStatus, schedStorageType=schedStorageType, schedTable=schedTable, schedTraps=schedTraps, schedTriggers=schedTriggers, schedType=schedType, schedValue=schedValue, schedVariable=schedVariable, schedWeekDay=schedWeekDay)
