...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortTable=stgCurCfgPortTable, layer2Oper=layer2Oper, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbState=fdbState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanMaxEnt=vlanMaxEnt, vlanInfo=vlanInfo, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCreates=fdbStatsCreates, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortTable=cistInfoPortTable, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgState=vlanNewCfgState, lacpCurPortState=lacpCurPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, layer2Configs=layer2Configs, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfo=portTeamInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgIndex=stgCurCfgIndex, cistInfo=cistInfo, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoLearn=vlanInfoLearn, lacpNewSystemPriority=lacpNewSystemPriority, fdbStats=fdbStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, PYSNMP_MODULE_ID=layer2, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbInfo=fdbInfo, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortState=stgNewCfgPortState, fdbTable=fdbTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCfg=portTeamCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, cistRootPort=cistRootPort, BridgeId=BridgeId, vlanCurCfgLearn=vlanCurCfgLearn, fdbClear=fdbClear, layer2Info=layer2Info, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, vlanMaxVlanID=vlanMaxVlanID, mirroring=mirroring, stgStatsPortTable=stgStatsPortTable, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlan=vlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTable=stpInfoTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTableEntry=stpInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortPathCost=stpInfoPortPathCost, layer2Stats=layer2Stats, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgState=portTeamNewCfgState, cistRootPathCost=cistRootPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCfg=stgCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCfg=mstCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbSrcPort=fdbSrcPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoState=portTeamInfoState, portTeamInfoTable=portTeamInfoTable, lacp=lacp, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgState=vlanCurCfgState, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCfg=mstCistCfg, layer2=layer2, stgNewCfgTable=stgNewCfgTable, stgNewCfgState=stgNewCfgState, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortTable=lacpInfoPortTable, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgState=mstCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortLinkType=cistInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgState=stgCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoIndex=stpInfoIndex, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, vlanInfoName=vlanInfoName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbRefSps=fdbRefSps, stpInfo=stpInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewPortState=lacpNewPortState, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, mirrPortMirr=mirrPortMirr, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistRoot=cistRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbEntry=fdbEntry, fdbStatsOverflows=fdbStatsOverflows, lacpInfo=lacpInfo, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsLookups=fdbStatsLookups, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbVlan=fdbVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortLinkType=stpInfoPortLinkType)
