...
MibIdentifier, TimeTicks, iso, ObjectIdentity, Gauge32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, Bits, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "iso", "ObjectIdentity", "Gauge32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "Bits", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbEntry=fdbEntry, stgCurCfgTable=stgCurCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgTable=stgNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCfg=mstCistCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsCreates=fdbStatsCreates, stgCfg=stgCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPathCost=cistRootPathCost, vlanInfoName=vlanInfoName, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacp=lacp, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, mirroring=mirroring, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCfg=mstCfg, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoId=vlanInfoId, stpInfoIndex=stpInfoIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfo=portTeamInfo, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortState=lacpNewPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoTable=portTeamInfoTable, layer2Configs=layer2Configs, vlanNewCfgState=vlanNewCfgState, fdbInfo=fdbInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, vlanInfoJumbo=vlanInfoJumbo, cistRegionalRoot=cistRegionalRoot, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortTable=cistInfoPortTable, stpInfoHoldTime=stpInfoHoldTime, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, layer2Stats=layer2Stats, vlanInfo=vlanInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRoot=cistRoot, vlanMaxVlanID=vlanMaxVlanID, cistBridgeMaxAge=cistBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoRootPort=stpInfoRootPort, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgVlanId=vlanNewCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpStats=stpStats, fdbVlan=fdbVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortRole=stpInfoPortRole, fdbStatsFinds=fdbStatsFinds, layer2=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, mstGeneralCfg=mstGeneralCfg, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, layer2Info=layer2Info, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortRole=cistInfoPortRole, cistInfo=cistInfo, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, PYSNMP_MODULE_ID=layer2, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, BridgeId=BridgeId, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoPorts=vlanInfoPorts, vlanInfoStatus=vlanInfoStatus, fdbStatsDeletes=fdbStatsDeletes, trunkgroup=trunkgroup, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgStg=vlanCurCfgStg, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfo=stpInfo, fdbLearnedPort=fdbLearnedPort, cistInfoPortState=cistInfoPortState, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgTable=vlanNewCfgTable, fdbSrcPort=fdbSrcPort, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStats=fdbStats, fdbRefSps=fdbRefSps, fdbTable=fdbTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortState=stgNewCfgPortState, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgState=stgNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbClear=fdbClear, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoRootCost=stpInfoRootCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortIndex=cistInfoPortIndex, vlanMaxEnt=vlanMaxEnt, stgCurCfgState=stgCurCfgState, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgState=mstNewCfgState, vlanCurCfgState=vlanCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgState=mstCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, layer2Oper=layer2Oper, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPriority=stgNewCfgPriority, lacpInfo=lacpInfo, stgCurCfgPortState=stgCurCfgPortState, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCfg=portTeamCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoState=portTeamInfoState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlan=vlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsCurrent=fdbStatsCurrent)
