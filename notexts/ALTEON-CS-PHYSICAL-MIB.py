...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Oper=layer2Oper, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgTable=stgNewCfgTable, fdbStats=fdbStats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxEnt=vlanMaxEnt, stpInfo=stpInfo, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTable=portTeamInfoTable, fdbClear=fdbClear, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2=layer2, cistRoot=cistRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgState=vlanNewCfgState, mirrPortMirr=mirrPortMirr, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCfg=stgCfg, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbSrcTrunk=fdbSrcTrunk, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, vlan=vlan, mstNewCfgState=mstNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, BridgeId=BridgeId, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortTable=cistInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfo=lacpInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, fdbLearnedPort=fdbLearnedPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortRole=stpInfoPortRole, mstCfg=mstCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgState=portTeamCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsLookups=fdbStatsLookups, stgStatsPortTable=stgStatsPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortTable=lacpInfoPortTable, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkgroup=trunkgroup, lacpCurSystemPriority=lacpCurSystemPriority, stpStats=stpStats, fdbRefSps=fdbRefSps, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, PYSNMP_MODULE_ID=layer2, stpInfoRootPort=stpInfoRootPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoIndex=stpInfoIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbInfo=fdbInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoState=portTeamInfoState, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoMaxAge=stpInfoMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCfg=portTeamCfg, vlanInfoTable=vlanInfoTable, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbTable=fdbTable, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRootPort=cistRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, vlanInfo=vlanInfo, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, fdbEntry=fdbEntry, vlanInfoPorts=vlanInfoPorts, mstCurCfgState=mstCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Configs=layer2Configs, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfo=cistInfo, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsHiwat=fdbStatsHiwat, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Info=layer2Info, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoStatus=vlanInfoStatus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, fdbVlan=fdbVlan, portTeamInfo=portTeamInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoPortsState=portTeamInfoPortsState, mstGeneralCfg=mstGeneralCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgState=stgCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortState=lacpCurPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortState=lacpNewPortState, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, cistRegionalRoot=cistRegionalRoot, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgStg=vlanNewCfgStg, stpInfoHelloTime=stpInfoHelloTime, fdbMacAddr=fdbMacAddr, stpInfoRootCost=stpInfoRootCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgState=stgNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCfg=mstCistCfg, stpInfoPortState=stpInfoPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoName=vlanInfoName, layer2Stats=layer2Stats, lacp=lacp, fdbSrcPort=fdbSrcPort, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTable=stpInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortMoved=lacpInfoPortMoved, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgRemovePort=vlanNewCfgRemovePort)
