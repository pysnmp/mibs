...
Gauge32, Integer32, NotificationType, Unsigned32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, MibIdentifier, TimeTicks, ObjectIdentity, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "NotificationType", "Unsigned32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortRole=stpInfoPortRole, portTeamInfoTable=portTeamInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, portTeamCfg=portTeamCfg, fdbMacAddr=fdbMacAddr, vlan=vlan, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanMaxVlanID=vlanMaxVlanID, stpInfoTopChanges=stpInfoTopChanges, cistRootPathCost=cistRootPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortTable=stpInfoPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeHelloTime=cistBridgeHelloTime, PYSNMP_MODULE_ID=layer2, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbSrcTrunk=fdbSrcTrunk, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbRefSps=fdbRefSps, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbInfo=fdbInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoIndex=stpInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortTable=lacpInfoPortTable, BridgeId=BridgeId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, lacp=lacp, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoPorts=vlanInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoState=portTeamInfoState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanMaxEnt=vlanMaxEnt, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbState=fdbState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRootPort=cistRootPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStats=fdbStats, layer2Info=layer2Info, vlanInfo=vlanInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbTable=fdbTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistGeneralInfo=cistGeneralInfo, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgState=mstCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortState=stpInfoPortState, mstNewCfgState=mstNewCfgState, cistRoot=cistRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbClear=fdbClear, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTable=stpInfoTable, lacpInfo=lacpInfo, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRegionalPathCost=cistRegionalPathCost, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoName=vlanInfoName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCfg=mstCistCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable, layer2=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoId=vlanInfoId, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, cistRegionalRoot=cistRegionalRoot, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoMaxAge=stpInfoMaxAge, layer2Stats=layer2Stats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, stpInfo=stpInfo, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpStats=stpStats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Oper=layer2Oper, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoRootCost=stpInfoRootCost, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsCreates=fdbStatsCreates, fdbVlan=fdbVlan, cistInfoPortTable=cistInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCfg=mstCfg, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortState=lacpCurPortState, stgStatsStpIndex=stgStatsStpIndex, fdbEntry=fdbEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsHiwat=fdbStatsHiwat, layer2Configs=layer2Configs, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbSrcPort=fdbSrcPort, cistInfoPortPathCost=cistInfoPortPathCost, mirroring=mirroring, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg)
