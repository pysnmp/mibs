...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortTableEntry=cistInfoPortTableEntry, BridgeId=BridgeId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbVlan=fdbVlan, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoState=portTeamInfoState, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbLearnedPort=fdbLearnedPort, vlanInfoStatus=vlanInfoStatus, fdbInfo=fdbInfo, vlanMaxEnt=vlanMaxEnt, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, trunkgroup=trunkgroup, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortPriority=cistInfoPortPriority, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, mstNewCfgStpMode=mstNewCfgStpMode, mstNewCfgState=mstNewCfgState, fdbStats=fdbStats, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfo=lacpInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, cistGeneralInfo=cistGeneralInfo, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortState=stpInfoPortState, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgRegionName=mstNewCfgRegionName, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, mirroring=mirroring, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbSrcPort=fdbSrcPort, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbEntry=fdbEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfoTable=portTeamInfoTable, cistRegionalRoot=cistRegionalRoot, fdbStatsLookups=fdbStatsLookups, stgCurCfgIndex=stgCurCfgIndex, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stpInfo=stpInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgTable=vlanNewCfgTable, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfo=portTeamInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlan=vlan, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCfg=stgCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortRole=cistInfoPortRole, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbState=fdbState, stgCurCfgPortEdge=stgCurCfgPortEdge, cistRootPathCost=cistRootPathCost, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbRefSps=fdbRefSps, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCfg=portTeamCfg, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacp=lacp, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgState=stgCurCfgState, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfo=cistInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoName=vlanInfoName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCfg=mstCfg, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfo=vlanInfo, fdbClear=fdbClear, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpStats=stpStats, cistInfoPortLinkType=cistInfoPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Stats=layer2Stats, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoTable=stpInfoTable, layer2Oper=layer2Oper, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoRootPort=stpInfoRootPort, layer2Configs=layer2Configs, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2=layer2, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Info=layer2Info, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortRole=stpInfoPortRole, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, PYSNMP_MODULE_ID=layer2, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsCreates=fdbStatsCreates, cistRoot=cistRoot, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgStg=vlanCurCfgStg, mstCistCfg=mstCistCfg, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortState=lacpNewPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoIndex=stpInfoIndex, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortMoved=lacpInfoPortMoved, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoTable=vlanInfoTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortTable=cistInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoMaxAge=stpInfoMaxAge, vlanInfoId=vlanInfoId, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRootPort=cistRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortState=stgNewCfgPortState)
