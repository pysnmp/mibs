...
ObjectIdentity, Unsigned32, Counter32, Counter64, Bits, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter32", "Counter64", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTable=portTeamNewCfgTable, PYSNMP_MODULE_ID=layer2, fdbClear=fdbClear, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfo=portTeamInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxVlanID=vlanMaxVlanID, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfo=stpInfo, stpInfoPortEdge=stpInfoPortEdge, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistDefaultCfg=mstCistDefaultCfg, cistRegionalRoot=cistRegionalRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoState=portTeamInfoState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoRootCost=stpInfoRootCost, portTeamCfg=portTeamCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpStats=stpStats, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbSrcPort=fdbSrcPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfo=vlanInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTable=portTeamInfoTable, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortRole=cistInfoPortRole, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbMacAddr=fdbMacAddr, mstGeneralCfg=mstGeneralCfg, fdbRefSps=fdbRefSps, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoPorts=portTeamInfoPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortTable=cistInfoPortTable, fdbStats=fdbStats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoId=vlanInfoId, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgState=vlanNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, fdbStatsFinds=fdbStatsFinds, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, stpInfoIndex=stpInfoIndex, fdbVlan=fdbVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortTable=lacpInfoPortTable, vlanInfoLearn=vlanInfoLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCfg=stgCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortLink=stgNewCfgPortLink, layer2=layer2, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Configs=layer2Configs, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortTable=stpInfoPortTable, cistRootPort=cistRootPort, vlan=vlan, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortState=lacpCurPortState, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgStg=vlanCurCfgStg, stpInfoTable=stpInfoTable, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacp=lacp, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookups=fdbStatsLookups, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgState=stgCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbInfo=fdbInfo, fdbStatsCreates=fdbStatsCreates, cistInfoPortState=cistInfoPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Oper=layer2Oper, vlanInfoName=vlanInfoName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Stats=layer2Stats, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRoot=cistRoot, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortRole=stpInfoPortRole, trunkgroup=trunkgroup, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbEntry=fdbEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgState=mstCurCfgState, cistInfo=cistInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, BridgeId=BridgeId, lacpInfo=lacpInfo, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCfg=mstCistCfg, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortState=stpInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTopChanges=stpInfoTopChanges)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgState=mstNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbState=fdbState, layer2Info=layer2Info, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirroring=mirroring, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, mstCfg=mstCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurSystemPriority=lacpCurSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex)
