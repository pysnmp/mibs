...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbSrcPort=fdbSrcPort, vlanInfoStatus=vlanInfoStatus, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfo=vlanInfo, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsOverflows=fdbStatsOverflows, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortState=lacpCurPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRoot=cistRoot, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoName=vlanInfoName, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortRole=stpInfoPortRole, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, layer2Info=layer2Info, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkgroup=trunkgroup, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbSrcTrunk=fdbSrcTrunk, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortState=cistInfoPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfo=lacpInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2=layer2, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCfg=mstCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortState=stgCurCfgPortState, portTeamInfo=portTeamInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgState=stgNewCfgState, stgCurCfgState=stgCurCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTable=stgCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgState=mstCurCfgState, stpInfoRootCost=stpInfoRootCost, fdbInfo=fdbInfo, layer2Configs=layer2Configs, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsDeletes=fdbStatsDeletes, BridgeId=BridgeId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortState=lacpNewPortState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRegionalRoot=cistRegionalRoot, fdbTable=fdbTable, fdbEntry=fdbEntry, lacp=lacp, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgTable=portTeamCurCfgTable, PYSNMP_MODULE_ID=layer2, stpStats=stpStats, vlanNewCfgState=vlanNewCfgState, stgStatsPortTable=stgStatsPortTable, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortIndex=stpInfoPortIndex, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mirrPortMirr=mirrPortMirr, vlanInfoId=vlanInfoId, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTable=stpInfoPortTable, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortState=stpInfoPortState, fdbMacAddr=fdbMacAddr, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Oper=layer2Oper, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCfg=mstCistCfg, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTable=portTeamInfoTable, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFinds=fdbStatsFinds, fdbState=fdbState, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgLearn=vlanCurCfgLearn, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortTable=cistInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, cistRootPathCost=cistRootPathCost, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoIndex=stpInfoIndex, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoIndex=portTeamInfoIndex, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsFindFails=fdbStatsFindFails, layer2Stats=layer2Stats, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbRefSps=fdbRefSps, portTeamCfg=portTeamCfg, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoHelloTime=stpInfoHelloTime, fdbVlan=fdbVlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTrunks=portTeamNewCfgTrunks)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionName=mstNewCfgRegionName, cistRootPort=cistRootPort, stpInfo=stpInfo, stgNewCfgPortState=stgNewCfgPortState, lacpCurSystemPriority=lacpCurSystemPriority, vlanMaxEnt=vlanMaxEnt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfo=cistInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStats=fdbStats, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mirroring=mirroring, stgCfg=stgCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlan=vlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoPorts=vlanInfoPorts)
