...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbState=fdbState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStats=fdbStats, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionName=mstCurCfgRegionName, cistRootPort=cistRootPort, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgState=stgCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCfg=mstCistCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxVlanID=vlanMaxVlanID, stgCfg=stgCfg, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfo=vlanInfo, stpInfoForwardDelay=stpInfoForwardDelay, layer2Stats=layer2Stats, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgState=vlanNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, vlan=vlan, fdbStatsCreates=fdbStatsCreates, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbMacAddr=fdbMacAddr, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoId=vlanInfoId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mirrPortMirr=mirrPortMirr, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, layer2=layer2, layer2Configs=layer2Configs, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortState=stpInfoPortState, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortPriority=cistInfoPortPriority, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbRefSps=fdbRefSps, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, mstCfg=mstCfg, fdbInfo=fdbInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortIndex=cistInfoPortIndex, stpInfoRootCost=stpInfoRootCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRoot=cistRoot, layer2Info=layer2Info, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsLookups=fdbStatsLookups, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortSelected=lacpInfoPortSelected, stpInfo=stpInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortState=lacpCurPortState, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortTable=stpInfoPortTable, mirroring=mirroring, BridgeId=BridgeId, stpStats=stpStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbEntry=fdbEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanMaxEnt=vlanMaxEnt, cistGeneralInfo=cistGeneralInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoTable=vlanInfoTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistRegionalRoot=cistRegionalRoot, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoIndex=stpInfoIndex, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgStg=vlanCurCfgStg, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgTable=stgNewCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsHiwat=fdbStatsHiwat, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortRole=cistInfoPortRole, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortState=lacpNewPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortTable=cistInfoPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, layer2Oper=layer2Oper, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbTable=fdbTable, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfo=lacpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortEdge=stpInfoPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, fdbClear=fdbClear, stgNewCfgPortLink=stgNewCfgPortLink, PYSNMP_MODULE_ID=layer2, stpInfoPortIndex=stpInfoPortIndex, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgState=stgNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, cistInfo=cistInfo, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortState=cistInfoPortState, vlanInfoStatus=vlanInfoStatus, fdbSrcPort=fdbSrcPort, lacp=lacp, stpInfoHoldTime=stpInfoHoldTime, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, portTeamCfg=portTeamCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoState=portTeamInfoState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, fdbVlan=fdbVlan, portTeamInfo=portTeamInfo, trunkgroup=trunkgroup, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoName=vlanInfoName, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType)
