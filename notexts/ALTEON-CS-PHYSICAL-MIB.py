...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbMacAddr=fdbMacAddr, vlanInfoName=vlanInfoName, lacpNewPortState=lacpNewPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgStg=vlanCurCfgStg, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoIndex=portTeamInfoIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfo=lacpInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoTable=stpInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbInfo=fdbInfo, layer2Oper=layer2Oper, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsCreates=fdbStatsCreates, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpStats=stpStats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortState=cistInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgState=stgNewCfgState, mstNewCfgState=mstNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortTable=cistInfoPortTable, stgCurCfgTable=stgCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoRootCost=stpInfoRootCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfo=vlanInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortTable=stgStatsPortTable, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoTable=vlanInfoTable, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbTable=fdbTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, fdbVlan=fdbVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2Stats=layer2Stats, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRootPathCost=cistRootPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortPriority=cistInfoPortPriority, PYSNMP_MODULE_ID=layer2, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortIndex=stgStatsPortIndex, mirroring=mirroring, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCfg=stgCfg, fdbClear=fdbClear, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2=layer2, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalRoot=cistRegionalRoot, layer2Configs=layer2Configs, stgNewCfgPriority=stgNewCfgPriority, portTeamCfg=portTeamCfg, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfo=stpInfo, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCfg=mstCistCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfo=portTeamInfo, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsHiwat=fdbStatsHiwat, fdbStats=fdbStats, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTable=portTeamInfoTable, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoState=portTeamInfoState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoId=vlanInfoId, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTableEntry=vlanInfoTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortState=lacpCurPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgTable=vlanNewCfgTable, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, BridgeId=BridgeId, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbSrcPort=fdbSrcPort, stpInfoPortState=stpInfoPortState, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, cistRootPort=cistRootPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfo=cistInfo, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Info=layer2Info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistGeneralInfo=cistGeneralInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgState=stgCurCfgState, portTeamCurCfgState=portTeamCurCfgState, fdbEntry=fdbEntry, fdbState=fdbState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoIndex=stpInfoIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgAddVlan=pmNewCfgAddVlan, vlan=vlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgState=mstCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, fdbRefSps=fdbRefSps, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortLink=stgCurCfgPortLink, lacp=lacp, fdbStatsFinds=fdbStatsFinds, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsLookups=fdbStatsLookups, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistBridgeCfg=mstCistBridgeCfg, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, cistRoot=cistRoot, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCfg=mstCfg, vlanMaxEnt=vlanMaxEnt)
