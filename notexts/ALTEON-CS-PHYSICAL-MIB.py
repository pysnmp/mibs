...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, fdbInfo=fdbInfo, vlanCurCfgState=vlanCurCfgState, stgCfg=stgCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgState=portTeamCurCfgState, fdbTable=fdbTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCfg=mstCfg, portTeamInfoTable=portTeamInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, PYSNMP_MODULE_ID=layer2, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgState=vlanNewCfgState, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCfg=portTeamCfg, mstCistCfg=mstCistCfg, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortIndex=stpInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortRole=cistInfoPortRole, stpInfoPortState=stpInfoPortState, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbEntry=fdbEntry, trunkgroup=trunkgroup, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfo=cistInfo, layer2=layer2, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgState=portTeamNewCfgState, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistDefaultCfg=mstCistDefaultCfg, mstCistBridgeCfg=mstCistBridgeCfg, mstNewCfgState=mstNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoTable=stpInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRoot=cistRoot, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStats=fdbStats, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlanInfoName=vlanInfoName, lacp=lacp, stpInfoRootCost=stpInfoRootCost, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindFails=fdbStatsFindFails, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbRefSps=fdbRefSps, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortState=cistInfoPortState, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, fdbMacAddr=fdbMacAddr, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPorts=portTeamInfoPorts, lacpInfo=lacpInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortPathCost=stpInfoPortPathCost, fdbSrcPort=fdbSrcPort, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRootPort=cistRootPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, fdbStatsOverflows=fdbStatsOverflows, cistRegionalRoot=cistRegionalRoot, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsStpIndex=stgStatsStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortState=lacpNewPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortState=lacpCurPortState, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsCreates=fdbStatsCreates, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, layer2Info=layer2Info, fdbVlan=fdbVlan, stpInfo=stpInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, mirrPortMirr=mirrPortMirr, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, layer2Configs=layer2Configs, lacpNewSystemPriority=lacpNewSystemPriority, fdbState=fdbState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfo=vlanInfo, BridgeId=BridgeId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirroring=mirroring, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoPorts=vlanInfoPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookups=fdbStatsLookups, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Oper=layer2Oper, stgStatsPortIndex=stgStatsPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoIndex=stpInfoIndex, vlanInfoTable=vlanInfoTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortTable=stgStatsPortTable, stpStats=stpStats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Stats=layer2Stats, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortTable=cistInfoPortTable, vlanInfoId=vlanInfoId, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbClear=fdbClear, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfo=portTeamInfo, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoRootPort=stpInfoRootPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlan=vlan, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
