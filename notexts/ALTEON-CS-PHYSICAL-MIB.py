...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRootPathCost=cistRootPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpStats=stpStats, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStats=fdbStats, portTeamNewCfgPorts=portTeamNewCfgPorts, lacp=lacp, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortState=stpInfoPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoState=portTeamInfoState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgState=mstNewCfgState, stpInfoIndex=stpInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, fdbClear=fdbClear, fdbSrcPort=fdbSrcPort, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Oper=layer2Oper, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortTable=stgStatsPortTable, fdbTable=fdbTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, cistRootPort=cistRootPort, fdbMacAddr=fdbMacAddr, vlan=vlan, layer2=layer2, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, PYSNMP_MODULE_ID=layer2, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgStg=vlanNewCfgStg, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortState=lacpNewPortState, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsLookups=fdbStatsLookups, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, BridgeId=BridgeId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, stpInfoRootPort=stpInfoRootPort, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, layer2Info=layer2Info, portTeamCurCfgState=portTeamCurCfgState, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortRole=cistInfoPortRole, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCfg=mstCistCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTable=vlanInfoTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortRole=stpInfoPortRole, vlanInfoLearn=vlanInfoLearn, cistRegionalRoot=cistRegionalRoot, lacpInfo=lacpInfo, fdbState=fdbState, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFinds=fdbStatsFinds, cistInfoPortIndex=cistInfoPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortState=lacpCurPortState, cistInfoPortPriority=cistInfoPortPriority, cistGeneralInfo=cistGeneralInfo, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoName=vlanInfoName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPathCost=cistInfoPortPathCost, trunkgroup=trunkgroup, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoTable=stpInfoTable, vlanInfo=vlanInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCfg=stgCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirroring=mirroring, stpInfoPortIndex=stpInfoPortIndex, vlanInfoPorts=vlanInfoPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortState=cistInfoPortState, fdbInfo=fdbInfo, stgCurCfgState=stgCurCfgState, fdbStatsCurrent=fdbStatsCurrent, fdbVlan=fdbVlan, layer2Configs=layer2Configs, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortTable=cistInfoPortTable, vlanInfoId=vlanInfoId, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfo=cistInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTable=portTeamInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgState=mstCurCfgState, fdbRefSps=fdbRefSps, stpInfoPortEdge=stpInfoPortEdge, cistRoot=cistRoot, layer2Stats=layer2Stats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfo=portTeamInfo, stpInfo=stpInfo, fdbEntry=fdbEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime)
