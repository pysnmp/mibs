...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Info=layer2Info, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkgroup=trunkgroup, lacpInfoPortMoved=lacpInfoPortMoved, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mirroring=mirroring, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPathCost=cistRootPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCfg=mstCfg, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoState=portTeamInfoState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfo=portTeamInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortTable=cistInfoPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbMacAddr=fdbMacAddr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTopChanges=stpInfoTopChanges, layer2=layer2, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoTable=portTeamInfoTable, stpInfoTable=stpInfoTable, vlanInfoPorts=vlanInfoPorts, stpStats=stpStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamCurCfgState=portTeamCurCfgState, cistRootPort=cistRootPort, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRoot=cistRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbLearnedPort=fdbLearnedPort, lacpCurPortState=lacpCurPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortState=lacpNewPortState, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfo=vlanInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbInfo=fdbInfo, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsLookups=fdbStatsLookups, fdbStatsLookupFails=fdbStatsLookupFails, vlanMaxEnt=vlanMaxEnt, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStats=fdbStats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Configs=layer2Configs, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgState=mstCurCfgState, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, fdbTable=fdbTable, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlan=vlan, lacp=lacp, stgNewCfgState=stgNewCfgState, fdbSrcPort=fdbSrcPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoName=vlanInfoName, stpInfo=stpInfo, portTeamCfg=portTeamCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortState=stpInfoPortState, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTrunks=portTeamInfoTrunks, PYSNMP_MODULE_ID=layer2, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCfg=mstCistCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPriority=cistInfoPortPriority, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewSystemPriority=lacpNewSystemPriority, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoIndex=stpInfoIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortRole=stpInfoPortRole, layer2Oper=layer2Oper, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgStg=vlanNewCfgStg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgState=stgCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoStatus=vlanInfoStatus, layer2Stats=layer2Stats, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbRefSps=fdbRefSps, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbState=fdbState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfo=cistInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFinds=fdbStatsFinds, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbEntry=fdbEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoForwardDelay=stpInfoForwardDelay, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoBwmContract=vlanInfoBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortRole=cistInfoPortRole, vlanInfoTable=vlanInfoTable, cistGeneralInfo=cistGeneralInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortIndex=stpInfoPortIndex, fdbVlan=fdbVlan, mstNewCfgState=mstNewCfgState, stpInfoPortTableEntry=stpInfoPortTableEntry, BridgeId=BridgeId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoLearn=vlanInfoLearn, vlanInfoId=vlanInfoId, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfo=lacpInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, fdbClear=fdbClear, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
