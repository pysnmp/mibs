...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2Info=layer2Info, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkgroup=trunkgroup, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgState=vlanNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfo=vlanInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgTable=portTeamNewCfgTable, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbLearnedPort=fdbLearnedPort, fdbStatsHiwat=fdbStatsHiwat, stpInfoHoldTime=stpInfoHoldTime, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgState=portTeamNewCfgState, vlanInfoName=vlanInfoName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, mstNewCfgState=mstNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfo=lacpInfo, stpInfoPortState=stpInfoPortState, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortState=lacpNewPortState, stpInfoHelloTime=stpInfoHelloTime, vlanInfoPorts=vlanInfoPorts, stgCurCfgState=stgCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, mstGeneralCfg=mstGeneralCfg, fdbState=fdbState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistGeneralInfo=cistGeneralInfo, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacp=lacp, vlanCurCfgLearn=vlanCurCfgLearn, fdbEntry=fdbEntry, vlanMaxEnt=vlanMaxEnt, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfo=stpInfo, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpStats=stpStats, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoState=portTeamInfoState, cistRoot=cistRoot, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCfg=portTeamCfg, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsCreates=fdbStatsCreates, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoId=vlanInfoId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, BridgeId=BridgeId, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCfg=mstCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStats=fdbStats, mirrPortMirr=mirrPortMirr, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCfg=mstCistCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortRole=cistInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, fdbInfo=fdbInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCfg=stgCfg, fdbTable=fdbTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoIndex=stpInfoIndex, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortIndex=cistInfoPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbRefSps=fdbRefSps, vlanInfoLearn=vlanInfoLearn, fdbStatsDeletes=fdbStatsDeletes, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfo=portTeamInfo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortEdge=stpInfoPortEdge, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortState=lacpCurPortState, cistInfoPortState=cistInfoPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoTableEntry=stpInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgStg=vlanCurCfgStg, cistInfo=cistInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgState=mstCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbVlan=fdbVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoTable=portTeamInfoTable, layer2Stats=layer2Stats, layer2Configs=layer2Configs, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2Oper=layer2Oper, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlan=vlan, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsStpIndex=stgStatsStpIndex, fdbClear=fdbClear, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortRole=stpInfoPortRole, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTable=vlanInfoTable, mirroring=mirroring, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, layer2=layer2, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, stpInfoTable=stpInfoTable, stpInfoTopChanges=stpInfoTopChanges, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount)
