...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, stpInfoTopChanges=stpInfoTopChanges, cistGeneralInfo=cistGeneralInfo, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, mstCistBridgeCfg=mstCistBridgeCfg, trunkgroup=trunkgroup, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsCreates=fdbStatsCreates, fdbState=fdbState, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsFindFails=fdbStatsFindFails, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamCfg=portTeamCfg, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsHiwat=fdbStatsHiwat, mstCurCfgState=mstCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoJumbo=vlanInfoJumbo, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstGeneralCfg=mstGeneralCfg, stgStatsPortTable=stgStatsPortTable, fdbSrcPort=fdbSrcPort, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfo=cistInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRootPort=cistRootPort, layer2=layer2, layer2Oper=layer2Oper, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbVlan=fdbVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbEntry=fdbEntry, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, BridgeId=BridgeId, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTable=portTeamInfoTable, layer2Stats=layer2Stats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortLink=stgCurCfgPortLink, fdbStats=fdbStats, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoStatus=vlanInfoStatus, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mirrPortMirr=mirrPortMirr, vlanCurCfgState=vlanCurCfgState, portTeamInfoPorts=portTeamInfoPorts, stpInfo=stpInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfo=vlanInfo, cistRoot=cistRoot, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlan=vlan, cistBridgeHelloTime=cistBridgeHelloTime, fdbInfo=fdbInfo, lacpCurPortState=lacpCurPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortRole=stpInfoPortRole, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgDelete=vlanNewCfgDelete, mirroring=mirroring, stgCurCfgState=stgCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgState=mstNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCfg=mstCistCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpStats=stpStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacp=lacp, portTeamInfo=portTeamInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortPriority=cistInfoPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRootPathCost=cistRootPathCost, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoTable=vlanInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgState=vlanNewCfgState, vlanInfoLearn=vlanInfoLearn, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbTable=fdbTable, stgNewCfgTable=stgNewCfgTable, cistInfoPortState=cistInfoPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCfg=stgCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsStpIndex=stgStatsStpIndex, cistRegionalPathCost=cistRegionalPathCost, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTable=stpInfoTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbRefSps=fdbRefSps, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRegionalRoot=cistRegionalRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortTable=stgNewCfgPortTable, fdbMacAddr=fdbMacAddr, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortState=lacpNewPortState, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbClear=fdbClear, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortTable=cistInfoPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, layer2Info=layer2Info, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPriority=stgNewCfgPriority, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoState=portTeamInfoState, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTable=stgCurCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoId=vlanInfoId, vlanInfoName=vlanInfoName, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoIndex=portTeamInfoIndex, stpInfoIndex=stpInfoIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2Configs=layer2Configs)
