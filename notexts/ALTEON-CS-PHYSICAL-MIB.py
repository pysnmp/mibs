...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPorts=portTeamInfoPorts, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfo=vlanInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2Info=layer2Info, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoTable=vlanInfoTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgState=mstCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mirrPortMirr=mirrPortMirr, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortIndex=stpInfoPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mirroring=mirroring, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, cistGeneralInfo=cistGeneralInfo, fdbStatsCreates=fdbStatsCreates, cistRoot=cistRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoRootPort=stpInfoRootPort, stgCfg=stgCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoTable=stpInfoTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgPorts=vlanCurCfgPorts, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfo=portTeamInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, BridgeId=BridgeId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbState=fdbState, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoRootCost=stpInfoRootCost, stgNewCfgTable=stgNewCfgTable, lacp=lacp, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbTable=fdbTable, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgState=portTeamNewCfgState, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsDeletes=fdbStatsDeletes, fdbRefSps=fdbRefSps, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortCfgTable=lacpCurPortCfgTable, mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFinds=fdbStatsFinds, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortRole=cistInfoPortRole, lacpCurPortState=lacpCurPortState, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortState=stpInfoPortState, trunkgroup=trunkgroup, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlan=vlan, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, fdbInfo=fdbInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortTable=stgStatsPortTable, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgState=stgCurCfgState, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsCurrent=fdbStatsCurrent, portTeamCfg=portTeamCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanMaxEnt=vlanMaxEnt, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortRole=stpInfoPortRole, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbEntry=fdbEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoId=vlanInfoId, stpInfoIndex=stpInfoIndex, layer2Configs=layer2Configs, cistInfoPortTable=cistInfoPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoStatus=vlanInfoStatus, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCfg=mstCistCfg, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfo=cistInfo, portTeamInfoTrunks=portTeamInfoTrunks, layer2Stats=layer2Stats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, fdbClear=fdbClear, vlanInfoPorts=vlanInfoPorts, mstCfg=mstCfg, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoName=vlanInfoName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, stpStats=stpStats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbLearnedPort=fdbLearnedPort, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, fdbStats=fdbStats, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfo=stpInfo, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRootPort=cistRootPort, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfo=lacpInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortLinkType=stpInfoPortLinkType, fdbSrcPort=fdbSrcPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookups=fdbStatsLookups, fdbMacAddr=fdbMacAddr, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbVlan=fdbVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortState=lacpNewPortState, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgState=vlanNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, layer2=layer2, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2Oper=layer2Oper)
