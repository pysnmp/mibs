...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, stpInfoRootCost=stpInfoRootCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortTable=stpInfoPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortState=lacpNewPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbClear=fdbClear, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistGeneralInfo=cistGeneralInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoTable=stpInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoIndex=stpInfoIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgState=stgCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpInfoPortMoved=lacpInfoPortMoved, PYSNMP_MODULE_ID=layer2, cistInfoPortState=cistInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfo=stpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Info=layer2Info, fdbStatsOverflows=fdbStatsOverflows, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcPort=fdbSrcPort, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgState=mstCurCfgState, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfo=lacpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRootPort=cistRootPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsFinds=fdbStatsFinds, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, fdbRefSps=fdbRefSps, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirroring=mirroring, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsCreates=fdbStatsCreates, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Configs=layer2Configs, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgIndex=stgNewCfgIndex, fdbTable=fdbTable, cistInfoPortTable=cistInfoPortTable, cistInfo=cistInfo, fdbState=fdbState, cistInfoPortRole=cistInfoPortRole, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortState=stpInfoPortState, lacpInfoPortIndex=lacpInfoPortIndex, lacp=lacp, mstNewCfgState=mstNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCfg=mstCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, cistRootPathCost=cistRootPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStats=fdbStats, layer2Oper=layer2Oper, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortRole=stpInfoPortRole, fdbVlan=fdbVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, BridgeId=BridgeId, trunkgroup=trunkgroup, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoPorts=vlanInfoPorts, fdbMacAddr=fdbMacAddr, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfo=portTeamInfo, lacpCurPortState=lacpCurPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsCurrent=fdbStatsCurrent, vlan=vlan, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, layer2=layer2, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoLearn=vlanInfoLearn, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoJumbo=vlanInfoJumbo, fdbEntry=fdbEntry, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoTable=vlanInfoTable, stpStats=stpStats, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoTableEntry=stpInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoName=vlanInfoName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoState=portTeamInfoState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2Stats=layer2Stats, portTeamCfg=portTeamCfg, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCfg=mstCistCfg, vlanInfoId=vlanInfoId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfo=vlanInfo, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrPortMirr=mirrPortMirr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRoot=cistRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortTable=stgStatsPortTable, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap)
