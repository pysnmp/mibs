...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsHiwat=fdbStatsHiwat, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistRootPathCost=cistRootPathCost, cistRegionalRoot=cistRegionalRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFinds=fdbStatsFinds, PYSNMP_MODULE_ID=layer2, fdbLearnedPort=fdbLearnedPort, portTeamCfg=portTeamCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbEntry=fdbEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirroring=mirroring, stpInfoPortIndex=stpInfoPortIndex, layer2Stats=layer2Stats, stpInfo=stpInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, fdbVlan=fdbVlan, layer2Oper=layer2Oper, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoRootPort=stpInfoRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoIndex=portTeamInfoIndex, cistInfo=cistInfo, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoPorts=vlanInfoPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Configs=layer2Configs, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbClear=fdbClear, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanId=vlanNewCfgVlanId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoTable=vlanInfoTable, vlanInfoName=vlanInfoName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortPriority=cistInfoPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoRootCost=stpInfoRootCost, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlan=vlan, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoStatus=vlanInfoStatus, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgIndex=stgCurCfgIndex, fdbTable=fdbTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacp=lacp, stgCurCfgTable=stgCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRootPort=cistRootPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistBridgeCfg=mstCistBridgeCfg, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbInfo=fdbInfo, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, mstCistCfg=mstCistCfg, fdbState=fdbState, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoIndex=stpInfoIndex, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfo=vlanInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortTable=cistInfoPortTable, stpStats=stpStats, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgTable=vlanCurCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfo=lacpInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCfg=stgCfg, lacpCurSystemPriority=lacpCurSystemPriority, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRoot=cistRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcTrunk=fdbSrcTrunk, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, mirrPortMirr=mirrPortMirr, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortState=cistInfoPortState, fdbStatsLookups=fdbStatsLookups, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgState=portTeamNewCfgState, layer2=layer2, portTeamInfoTableEntry=portTeamInfoTableEntry, BridgeId=BridgeId, portTeamCurCfgPorts=portTeamCurCfgPorts, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, fdbStats=fdbStats, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTable=stpInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbRefSps=fdbRefSps, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHelloTime=stpInfoHelloTime, lacpNewPortState=lacpNewPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Info=layer2Info, vlanInfoId=vlanInfoId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortTable=stpInfoPortTable, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfo=portTeamInfo, trunkgroup=trunkgroup, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts)
