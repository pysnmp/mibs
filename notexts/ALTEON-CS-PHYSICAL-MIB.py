...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Stats=layer2Stats, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbMacAddr=fdbMacAddr, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsFinds=fdbStatsFinds, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, cistInfo=cistInfo, fdbInfo=fdbInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlan=vlan, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, fdbClear=fdbClear, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortState=cistInfoPortState, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoIndex=portTeamInfoIndex, mstCurCfgState=mstCurCfgState, portTeamInfo=portTeamInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkgroup=trunkgroup, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortState=stpInfoPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCfg=mstCfg, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortState=lacpNewPortState, vlanInfoTableEntry=vlanInfoTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirroring=mirroring, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfo=lacpInfo, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgState=stgCurCfgState, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortTable=lacpInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStats=fdbStats, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, layer2=layer2, stgNewCfgPriority=stgNewCfgPriority, cistRoot=cistRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgState=stgNewCfgState, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgState=mstNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRegionalRoot=cistRegionalRoot, mirrPortMirr=mirrPortMirr, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoName=vlanInfoName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTable=vlanInfoTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbEntry=fdbEntry, vlanInfoJumbo=vlanInfoJumbo, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoState=portTeamInfoState, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsCreates=fdbStatsCreates, stpInfoRootCost=stpInfoRootCost, fdbState=fdbState, lacpInfoPortNtt=lacpInfoPortNtt, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRootPort=cistRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfo=stpInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbTable=fdbTable, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Configs=layer2Configs, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, lacp=lacp, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, PYSNMP_MODULE_ID=layer2, vlanCurCfgLearn=vlanCurCfgLearn, layer2Info=layer2Info, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2Oper=layer2Oper, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCfg=portTeamCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoIndex=stpInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoHelloTime=stpInfoHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoTable=portTeamInfoTable, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfo=vlanInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, cistGeneralInfo=cistGeneralInfo, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbVlan=fdbVlan, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbSrcPort=fdbSrcPort, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortTable=cistInfoPortTable, vlanInfoId=vlanInfoId, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgTable=stgCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, fdbRefSps=fdbRefSps, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpStats=stpStats, mstCistCfg=mstCistCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgPorts=portTeamCurCfgPorts, BridgeId=BridgeId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoLearn=vlanInfoLearn, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
