...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsOverflows=fdbStatsOverflows, stgCfg=stgCfg, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlan=vlan, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortState=stpInfoPortState, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTableEntry=stpInfoTableEntry, mirroring=mirroring, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, mstCurCfgState=mstCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2=layer2, mstNewCfgStpMode=mstNewCfgStpMode, vlanMaxEnt=vlanMaxEnt, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Configs=layer2Configs, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, BridgeId=BridgeId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbEntry=fdbEntry, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsCurrent=fdbStatsCurrent, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoIndex=portTeamInfoIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoId=vlanInfoId, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortTable=stpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, fdbStats=fdbStats, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgState=stgCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, portTeamInfoState=portTeamInfoState, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRootPathCost=cistRootPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbState=fdbState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCfg=mstCistCfg, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, mstCfg=mstCfg, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, fdbInfo=fdbInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfo=lacpInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, fdbRefSps=fdbRefSps, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortState=stgCurCfgPortState, vlanInfoPorts=vlanInfoPorts, portTeamInfoTable=portTeamInfoTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgState=mstNewCfgState, stpStats=stpStats, cistRoot=cistRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortRole=stpInfoPortRole, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoName=vlanInfoName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, trunkgroup=trunkgroup, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgState=vlanCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbVlan=fdbVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbSrcPort=fdbSrcPort, stgNewCfgIndex=stgNewCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacp=lacp, stpInfo=stpInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsLookups=fdbStatsLookups, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgState=stgNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortState=lacpCurPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbMacAddr=fdbMacAddr, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, layer2Stats=layer2Stats, stpInfoHoldTime=stpInfoHoldTime, fdbSrcTrunk=fdbSrcTrunk, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgLearn=vlanCurCfgLearn, cistRootPort=cistRootPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortState=lacpNewPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, mirrPortMirr=mirrPortMirr, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortState=cistInfoPortState, layer2Info=layer2Info, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbClear=fdbClear, fdbTable=fdbTable, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortTable=cistInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCfg=portTeamCfg, cistGeneralInfo=cistGeneralInfo, stgCurCfgTable=stgCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, vlanInfo=vlanInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, vlanInfoTable=vlanInfoTable, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortPriority=stgNewCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbLearnedPort=fdbLearnedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfo=cistInfo, lacpCurSystemPriority=lacpCurSystemPriority, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgState=portTeamCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoRootCost=stpInfoRootCost, cistRegionalRoot=cistRegionalRoot, layer2Oper=layer2Oper, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTable=stpInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfo=portTeamInfo, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort)
