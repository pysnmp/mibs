...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTable=stpInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfo=cistInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbSrcPort=fdbSrcPort, vlanCurCfgState=vlanCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCfg=mstCfg, portTeamInfoPorts=portTeamInfoPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, PYSNMP_MODULE_ID=layer2, stpInfoHelloTime=stpInfoHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgAgingTime=stgNewCfgAgingTime, lacp=lacp, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, fdbState=fdbState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortIndex=stpInfoPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTable=vlanInfoTable, vlanMaxEnt=vlanMaxEnt, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpStats=stpStats, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortState=stgCurCfgPortState, fdbClear=fdbClear, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbTable=fdbTable, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, layer2Info=layer2Info, mstCistCfg=mstCistCfg, layer2Configs=layer2Configs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Oper=layer2Oper, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgState=mstNewCfgState, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stpInfoPortRole=stpInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRoot=cistRoot, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgTable=stgNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfo=lacpInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkgroup=trunkgroup, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfo=stpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortState=cistInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, fdbStats=fdbStats, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortState=stpInfoPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, stpInfoRootPort=stpInfoRootPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoName=vlanInfoName, stgNewCfgState=stgNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgState=stgCurCfgState, cistRegionalRoot=cistRegionalRoot, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbRefSps=fdbRefSps, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortTable=cistInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, fdbEntry=fdbEntry, cistRootPort=cistRootPort, mstCurCfgState=mstCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoId=vlanInfoId, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgState=portTeamNewCfgState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgVlanName=vlanNewCfgVlanName, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgState=vlanNewCfgState, fdbStatsLookups=fdbStatsLookups, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2=layer2, fdbMacAddr=fdbMacAddr, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, portTeamCfg=portTeamCfg, lacpNewPortState=lacpNewPortState, stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, BridgeId=BridgeId, stpInfoHoldTime=stpInfoHoldTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortRole=cistInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, fdbVlan=fdbVlan, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbLearnedPort=fdbLearnedPort, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTableEntry=stpInfoTableEntry, layer2Stats=layer2Stats, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistRegionalPathCost=cistRegionalPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistRootPathCost=cistRootPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfo=portTeamInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCreates=fdbStatsCreates, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCfg=stgCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortLinkType=stpInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistBridgeHelloTime=cistBridgeHelloTime, vlan=vlan, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoState=portTeamInfoState, stpInfoRootCost=stpInfoRootCost, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfo=vlanInfo, fdbInfo=fdbInfo)
