...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTable=portTeamCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, vlanMaxEnt=vlanMaxEnt, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortState=lacpNewPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, layer2Info=layer2Info, layer2Oper=layer2Oper, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2Configs=layer2Configs, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpStats=stpStats, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfo=portTeamInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgState=vlanCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoId=vlanInfoId, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoPorts=vlanInfoPorts, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirroring=mirroring, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbMacAddr=fdbMacAddr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortTable=stpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbLearnedPort=fdbLearnedPort, vlanCurCfgTable=vlanCurCfgTable, cistRegionalRoot=cistRegionalRoot, fdbEntry=fdbEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTable=stgStatsPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFinds=fdbStatsFinds, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbInfo=fdbInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfo=lacpInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortState=lacpCurPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgRegionName=mstNewCfgRegionName, fdbTable=fdbTable, stpInfoTopChanges=stpInfoTopChanges, vlanInfoLearn=vlanInfoLearn, portTeamInfoTable=portTeamInfoTable, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortState=stgNewCfgPortState, BridgeId=BridgeId, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortState=cistInfoPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, layer2Stats=layer2Stats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistBridgeCfg=mstCistBridgeCfg, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistRegionalPathCost=cistRegionalPathCost, fdbVlan=fdbVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgState=mstCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortState=stpInfoPortState, fdbStats=fdbStats, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFindFails=fdbStatsFindFails, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbSrcPort=fdbSrcPort, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistGeneralInfo=cistGeneralInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbRefSps=fdbRefSps, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortPathCost=stpInfoPortPathCost, fdbClear=fdbClear, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanInfoTable=vlanInfoTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgState=portTeamNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortRole=stpInfoPortRole, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistRoot=cistRoot, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgState=vlanNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkgroup=trunkgroup, vlan=vlan, stpInfoRootCost=stpInfoRootCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCfg=portTeamCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, lacp=lacp, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgState=stgNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfo=vlanInfo, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, stgNewCfgTable=stgNewCfgTable, cistRootPathCost=cistRootPathCost, cistInfo=cistInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, layer2=layer2)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfo=stpInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoIndex=stpInfoIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoName=vlanInfoName, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbState=fdbState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCfg=mstCistCfg, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgState=mstNewCfgState, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoIndex=portTeamInfoIndex, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTable=stpInfoTable, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry)
