...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortLinkType=stpInfoPortLinkType, fdbState=fdbState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTable=portTeamInfoTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgState=stgCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbEntry=fdbEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Stats=layer2Stats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpStats=stpStats, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurSystemPriority=lacpCurSystemPriority, cistRoot=cistRoot, fdbSrcPort=fdbSrcPort, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoTable=vlanInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgIndex=stgNewCfgIndex, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbInfo=fdbInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsDeletes=fdbStatsDeletes, cistRootPort=cistRootPort, vlanNewCfgState=vlanNewCfgState, stgCfg=stgCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortState=stpInfoPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2Oper=layer2Oper, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortPriority=cistInfoPortPriority, layer2Configs=layer2Configs, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, fdbMacAddr=fdbMacAddr, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCfg=mstCistCfg, fdbStatsFindFails=fdbStatsFindFails, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, mirrPortMirr=mirrPortMirr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortRole=stpInfoPortRole, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortState=stgNewCfgPortState, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgTable=stgCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgState=mstCurCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkgroup=trunkgroup, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, BridgeId=BridgeId, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoTable=stpInfoTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoLearn=vlanInfoLearn, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoPorts=vlanInfoPorts, vlanCurCfgStg=vlanCurCfgStg, stgStatsPortIndex=stgStatsPortIndex, fdbClear=fdbClear, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfo=stpInfo, fdbStats=fdbStats, vlanInfo=vlanInfo, PYSNMP_MODULE_ID=layer2, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortTable=cistInfoPortTable, cistInfo=cistInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsLookups=fdbStatsLookups, vlanCurCfgState=vlanCurCfgState, vlanInfoStatus=vlanInfoStatus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortRole=cistInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortNtt=lacpInfoPortNtt, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCfg=portTeamCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewPortState=lacpNewPortState, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortTable=stpInfoPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfo=portTeamInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbRefSps=fdbRefSps, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoId=vlanInfoId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbVlan=fdbVlan, vlan=vlan, mirroring=mirroring)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCfg=mstCfg, vlanMaxEnt=vlanMaxEnt, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, lacp=lacp, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsFinds=fdbStatsFinds, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbLearnedPort=fdbLearnedPort, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgTable=vlanNewCfgTable, stpInfoRootCost=stpInfoRootCost, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRootPathCost=cistRootPathCost, vlanInfoName=vlanInfoName, lacpInfo=lacpInfo, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortTable=stgStatsPortTable, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink)
