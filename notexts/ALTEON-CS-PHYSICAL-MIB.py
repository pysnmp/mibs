...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoRootCost=stpInfoRootCost, lacpInfo=lacpInfo, vlanInfoJumbo=vlanInfoJumbo, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlan=vlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewSystemPriority=lacpNewSystemPriority, fdbInfo=fdbInfo, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPriority=stgCurCfgPriority, vlanMaxVlanID=vlanMaxVlanID, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, fdbSrcPort=fdbSrcPort, mstCfg=mstCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoState=portTeamInfoState, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoId=vlanInfoId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsLookups=fdbStatsLookups, mstCistCfg=mstCistCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbLearnedPort=fdbLearnedPort, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindFails=fdbStatsFindFails, layer2=layer2, fdbStatsCreates=fdbStatsCreates, cistRegionalRoot=cistRegionalRoot, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRootPathCost=cistRootPathCost, fdbEntry=fdbEntry, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, vlanInfo=vlanInfo, mstGeneralCfg=mstGeneralCfg, fdbTable=fdbTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Configs=layer2Configs, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoTable=portTeamInfoTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfo=portTeamInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, vlanInfoName=vlanInfoName, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, BridgeId=BridgeId, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, layer2Info=layer2Info, mstCurCfgRegionName=mstCurCfgRegionName, layer2Stats=layer2Stats, stpInfoTable=stpInfoTable, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortTable=cistInfoPortTable, cistInfo=cistInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgState=stgNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistGeneralInfo=cistGeneralInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStats=fdbStats, cistRootPort=cistRootPort, stgCurCfgIndex=stgCurCfgIndex, mirroring=mirroring, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoStatus=vlanInfoStatus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortState=stpInfoPortState, vlanCurCfgState=vlanCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortTable=stgStatsPortTable, cistRoot=cistRoot, stgCurCfgPortTable=stgCurCfgPortTable, lacp=lacp, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoIndex=stpInfoIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2Oper=layer2Oper, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbRefSps=fdbRefSps, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgState=mstCurCfgState, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortState=lacpNewPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoRootPort=stpInfoRootPort, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgTable=stgNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCfg=stgCfg, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortIndex=stgStatsPortIndex, vlanInfoTable=vlanInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgState=portTeamCurCfgState, stpStats=stpStats, stpInfo=stpInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbState=fdbState, fdbClear=fdbClear, stgCurCfgTable=stgCurCfgTable, portTeamCfg=portTeamCfg, stpInfoPortRole=stpInfoPortRole, mirrPortMirr=mirrPortMirr, fdbVlan=fdbVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxEnt=vlanMaxEnt, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, PYSNMP_MODULE_ID=layer2, mstNewCfgState=mstNewCfgState, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbMacAddr=fdbMacAddr, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, cistInfoPortState=cistInfoPortState)
