...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, fdbVlan=fdbVlan, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoBwmContract=vlanInfoBwmContract, fdbRefSps=fdbRefSps, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoState=portTeamInfoState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRegionalPathCost=cistRegionalPathCost, fdbState=fdbState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, fdbSrcTrunk=fdbSrcTrunk, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRootPort=cistRootPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCfg=stgCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortState=cistInfoPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoMaxAge=stpInfoMaxAge, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortState=stgNewCfgPortState, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortState=stpInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacp=lacp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, BridgeId=BridgeId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoId=vlanInfoId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, layer2Info=layer2Info, stgCurCfgPortState=stgCurCfgPortState, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoJumbo=vlanInfoJumbo, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlan=vlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2=layer2, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoTable=vlanInfoTable, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortIndex=stpInfoPortIndex, portTeamInfo=portTeamInfo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbEntry=fdbEntry, cistInfoPortRole=cistInfoPortRole, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgState=vlanCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistRegionalRoot=cistRegionalRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoIndex=portTeamInfoIndex, fdbSrcPort=fdbSrcPort, cistRootPathCost=cistRootPathCost, layer2Configs=layer2Configs, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortTable=stgStatsPortTable, stpInfoPortTable=stpInfoPortTable, fdbLearnedPort=fdbLearnedPort, lacpInfoPortIndex=lacpInfoPortIndex, cistInfo=cistInfo, fdbInfo=fdbInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgState=vlanNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgStpMode=mstNewCfgStpMode, fdbTable=fdbTable, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgState=stgNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTable=vlanNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgState=mstCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCreates=fdbStatsCreates, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, mstGeneralCfg=mstGeneralCfg, vlanInfoLearn=vlanInfoLearn, stpInfoHoldTime=stpInfoHoldTime, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCfg=mstCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Stats=layer2Stats, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCfg=portTeamCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCfg=mstCistCfg, mstNewCfgState=mstNewCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRoot=cistRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgTable=stgCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortRole=stpInfoPortRole, lacpInfo=lacpInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, vlanInfo=vlanInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stpStats=stpStats, trunkgroup=trunkgroup, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgState=portTeamCurCfgState, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPriority=stgCurCfgPriority, mirroring=mirroring, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, vlanInfoName=vlanInfoName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTable=stpInfoTable, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2Oper=layer2Oper, vlanCurCfgLearn=vlanCurCfgLearn, fdbMacAddr=fdbMacAddr, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStats=fdbStats, stgNewCfgPortEdge=stgNewCfgPortEdge)
