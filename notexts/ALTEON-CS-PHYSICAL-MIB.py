...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, layer2Oper=layer2Oper, stpInfoIndex=stpInfoIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbInfo=fdbInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoRootCost=stpInfoRootCost, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortTable=cistInfoPortTable, vlanInfoName=vlanInfoName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbClear=fdbClear, mstNewCfgState=mstNewCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgState=stgNewCfgState, layer2Configs=layer2Configs, layer2Info=layer2Info, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoId=vlanInfoId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, cistRootPathCost=cistRootPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, stpInfoTable=stpInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, mstCfg=mstCfg, fdbSrcPort=fdbSrcPort, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlan=vlan, vlanInfoLearn=vlanInfoLearn, stpStats=stpStats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgState=stgCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortIndex=stgStatsPortIndex, fdbState=fdbState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRoot=cistRoot, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfo=portTeamInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCfg=stgCfg, fdbVlan=fdbVlan, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoState=portTeamInfoState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgState=portTeamNewCfgState, vlanMaxEnt=vlanMaxEnt, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgPorts=portTeamNewCfgPorts, layer2Stats=layer2Stats, cistInfoPortPriority=cistInfoPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCfg=mstCistCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTable=portTeamInfoTable, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgState=vlanNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbRefSps=fdbRefSps, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfo=cistInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootPort=stpInfoRootPort, BridgeId=BridgeId, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortState=lacpNewPortState, lacpInfoPortTable=lacpInfoPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsStpIndex=stgStatsStpIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanMaxVlanID=vlanMaxVlanID, fdbStats=fdbStats, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, mirroring=mirroring, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2=layer2, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbEntry=fdbEntry, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsLookups=fdbStatsLookups, stpInfoPortState=stpInfoPortState, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfo=vlanInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCfg=portTeamCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoTable=vlanInfoTable, cistInfoPortLinkType=cistInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortState=stgNewCfgPortState, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsOverflows=fdbStatsOverflows, fdbTable=fdbTable, cistInfoPortPathCost=cistInfoPortPathCost, lacp=lacp, fdbMacAddr=fdbMacAddr, stgCurCfgStgIndex=stgCurCfgStgIndex)
