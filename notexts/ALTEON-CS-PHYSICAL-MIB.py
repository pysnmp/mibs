...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, BridgeId=BridgeId, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStats=fdbStats, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoRootPort=stpInfoRootPort, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCfg=stgCfg, portTeamInfoState=portTeamInfoState, fdbStatsFinds=fdbStatsFinds, stpInfoPortState=stpInfoPortState, fdbStatsFindFails=fdbStatsFindFails, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortState=stgCurCfgPortState, cistRootPort=cistRootPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortTable=stpInfoPortTable, lacp=lacp, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbRefSps=fdbRefSps, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfo=stpInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, fdbTable=fdbTable, stpInfoPortEdge=stpInfoPortEdge, vlanInfoStatus=vlanInfoStatus, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsDeletes=fdbStatsDeletes, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbClear=fdbClear, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoLearn=vlanInfoLearn, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortLink=stgCurCfgPortLink, cistBridgeMaxAge=cistBridgeMaxAge, cistInfo=cistInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgTable=stgCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbEntry=fdbEntry, PYSNMP_MODULE_ID=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlan=vlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgState=mstNewCfgState, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortTable=stgStatsPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHelloTime=stpInfoHelloTime, layer2Stats=layer2Stats, layer2Info=layer2Info, cistRootPathCost=cistRootPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCfg=mstCistCfg, stgCurCfgState=stgCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewPortState=lacpNewPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortTable=cistInfoPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgTable=vlanNewCfgTable, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsLookups=fdbStatsLookups, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, lacpInfo=lacpInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoRootCost=stpInfoRootCost, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRoot=cistRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCfg=portTeamCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfo=portTeamInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortLink=stgNewCfgPortLink, stpStats=stpStats, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPriority=stgCurCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkgroup=trunkgroup, vlanInfo=vlanInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCfg=mstCfg, lacpCurPortState=lacpCurPortState, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbState=fdbState, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgTable=stgNewCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirroring=mirroring, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcPort=fdbSrcPort, fdbLearnedPort=fdbLearnedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortIndex=stpInfoPortIndex, fdbInfo=fdbInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgJumbo=vlanCurCfgJumbo, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, mstCurCfgState=mstCurCfgState, fdbVlan=fdbVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoIndex=stpInfoIndex, layer2=layer2, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoHoldTime=stpInfoHoldTime, stpInfoTopChanges=stpInfoTopChanges, vlanInfoName=vlanInfoName, stgNewCfgVlanBmap=stgNewCfgVlanBmap, layer2Configs=layer2Configs, cistInfoPortRole=cistInfoPortRole, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoId=vlanInfoId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoTable=stpInfoTable, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgState=vlanNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2Oper=layer2Oper, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgStg=vlanCurCfgStg, portTeamInfoTable=portTeamInfoTable)
