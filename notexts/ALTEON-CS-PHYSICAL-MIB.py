...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoId=vlanInfoId, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, cistGeneralInfo=cistGeneralInfo, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoMaxAge=stpInfoMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, BridgeId=BridgeId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgRegionName=mstNewCfgRegionName, fdbStats=fdbStats, stgStatsStpIndex=stgStatsStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgTable=stgCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, cistRegionalRoot=cistRegionalRoot, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfo=stpInfo, vlanInfo=vlanInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgState=vlanNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootPort=stpInfoRootPort, vlanInfoTable=vlanInfoTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookups=fdbStatsLookups, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbRefSps=fdbRefSps, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTable=stgStatsPortTable, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, mstCfg=mstCfg, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbTable=fdbTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsFinds=fdbStatsFinds, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRootPathCost=cistRootPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoName=vlanInfoName, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, fdbEntry=fdbEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortTable=stpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgState=stgCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacp=lacp, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Stats=layer2Stats, portTeamInfoTrunks=portTeamInfoTrunks, stpStats=stpStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPriority=stgNewCfgPriority, fdbVlan=fdbVlan, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortState=lacpCurPortState, fdbClear=fdbClear, portTeamInfo=portTeamInfo, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoTable=portTeamInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgStg=vlanNewCfgStg, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, stgCurCfgPriority=stgCurCfgPriority, cistInfo=cistInfo, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoState=portTeamInfoState, mstGeneralCfg=mstGeneralCfg, vlanCurCfgState=vlanCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, mirroring=mirroring, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPriority=cistInfoPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsCurrent=fdbStatsCurrent, portTeamCfg=portTeamCfg, vlanInfoLearn=vlanInfoLearn, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootCost=stpInfoRootCost, lacpInfo=lacpInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, fdbInfo=fdbInfo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbMacAddr=fdbMacAddr, mstCistCfg=mstCistCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlan=vlan, stpInfoTable=stpInfoTable, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, layer2Oper=layer2Oper, stgCfg=stgCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortState=cistInfoPortState, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamTableMaxSize=portTeamTableMaxSize, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbState=fdbState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrPortMirr=mirrPortMirr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortRole=stpInfoPortRole, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortState=stgNewCfgPortState, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkgroup=trunkgroup, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, cistRoot=cistRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgState=portTeamNewCfgState, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortState=stpInfoPortState, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgState=stgNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoIndex=stpInfoIndex, mstNewCfgState=mstNewCfgState, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, cistRootPort=cistRootPort, portTeamCurCfgPorts=portTeamCurCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Info=layer2Info, layer2Configs=layer2Configs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry)
