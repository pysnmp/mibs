...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemPriority=lacpNewSystemPriority, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgIndex=stgNewCfgIndex, trunkgroup=trunkgroup, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mirrPortMirr=mirrPortMirr, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortTable=stgCurCfgPortTable, fdbSrcPort=fdbSrcPort, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoName=vlanInfoName, mstNewCfgState=mstNewCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgState=vlanCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, stgCurCfgIndex=stgCurCfgIndex, cistRoot=cistRoot, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStats=fdbStats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortTable=stgStatsPortTable, vlanInfoStatus=vlanInfoStatus, fdbState=fdbState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgState=vlanNewCfgState, stpInfoRootPort=stpInfoRootPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoIndex=stpInfoIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, stgNewCfgTable=stgNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpStats=stpStats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoRootCost=stpInfoRootCost, fdbStatsCreates=fdbStatsCreates, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoTable=portTeamInfoTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgState=stgCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbMacAddr=fdbMacAddr, fdbInfo=fdbInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoLearn=vlanInfoLearn, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortRole=stpInfoPortRole, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCfg=stgCfg, mstCfg=mstCfg, vlanNewCfgDelete=vlanNewCfgDelete, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgTable=vlanNewCfgTable, mstCistCfg=mstCistCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfo=vlanInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoId=vlanInfoId, layer2Stats=layer2Stats, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTable=stpInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTable=stgNewCfgPortTable, fdbTable=fdbTable, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortState=cistInfoPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mirroring=mirroring, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, stgStatsStpIndex=stgStatsStpIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPriority=stgNewCfgPriority, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortTable=cistInfoPortTable, vlan=vlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortState=lacpNewPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTopChanges=stpInfoTopChanges, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgState=portTeamNewCfgState, fdbRefSps=fdbRefSps, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoMaxAge=stpInfoMaxAge, cistRootPort=cistRootPort, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgState=portTeamCurCfgState, cistRegionalRoot=cistRegionalRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbSrcTrunk=fdbSrcTrunk, layer2Info=layer2Info, cistGeneralInfo=cistGeneralInfo, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacp=lacp, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoTable=vlanInfoTable, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCfg=portTeamCfg, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoState=portTeamInfoState, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgState=stgNewCfgState, layer2Oper=layer2Oper, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortIndex=stpInfoPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgTable=stgCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Configs=layer2Configs, lacpNewPortCfgTable=lacpNewPortCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, fdbVlan=fdbVlan, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, fdbLearnedPort=fdbLearnedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfo=cistInfo, PYSNMP_MODULE_ID=layer2, mstCurCfgState=mstCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoPorts=portTeamInfoPorts, BridgeId=BridgeId, stpInfoPortState=stpInfoPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection)
