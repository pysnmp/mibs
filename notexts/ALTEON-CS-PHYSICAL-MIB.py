...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgStgIndex=stgNewCfgStgIndex, stgCfg=stgCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCfg=mstCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkgroup=trunkgroup, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoTable=portTeamInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortState=lacpNewPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRootPathCost=cistRootPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, mirroring=mirroring, mstCistCfg=mstCistCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbTable=fdbTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgState=vlanCurCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoName=vlanInfoName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbRefSps=fdbRefSps, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPort=cistRootPort, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlan=vlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Oper=layer2Oper, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, portTeamCfg=portTeamCfg, fdbStatsLookups=fdbStatsLookups, fdbEntry=fdbEntry, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortTable=stgStatsPortTable, mstCurCfgRegionName=mstCurCfgRegionName, fdbState=fdbState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacp=lacp, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfo=vlanInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgState=mstCurCfgState, portTeamInfoPorts=portTeamInfoPorts, layer2Stats=layer2Stats, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxEnt=vlanMaxEnt, stpInfo=stpInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgState=mstNewCfgState, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoPorts=vlanInfoPorts, stgNewCfgTable=stgNewCfgTable, mirrPortMirr=mirrPortMirr, stpInfoIndex=stpInfoIndex, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoId=vlanInfoId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, layer2=layer2, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfo=lacpInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortState=lacpCurPortState, stpInfoPortTable=stpInfoPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoMaxAge=stpInfoMaxAge, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistRoot=cistRoot, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoTableEntry=vlanInfoTableEntry, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsFinds=fdbStatsFinds, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoJumbo=vlanInfoJumbo, cistInfo=cistInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgState=stgNewCfgState, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoRootPort=stpInfoRootPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbVlan=fdbVlan, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2Info=layer2Info, portTeamCurCfgPorts=portTeamCurCfgPorts, BridgeId=BridgeId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbMacAddr=fdbMacAddr, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortTable=cistInfoPortTable, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgVlanId=vlanNewCfgVlanId, cistGeneralInfo=cistGeneralInfo, cistInfoPortState=cistInfoPortState, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoIndex=portTeamInfoIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, PYSNMP_MODULE_ID=layer2, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoState=portTeamInfoState, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortState=stgNewCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookupFails=fdbStatsLookupFails, fdbInfo=fdbInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoTable=vlanInfoTable, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortRole=stpInfoPortRole, stpStats=stpStats, stpInfoTable=stpInfoTable, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistRegionalRoot=cistRegionalRoot, stpInfoTopChanges=stpInfoTopChanges, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, fdbClear=fdbClear, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStats=fdbStats, vlanCurCfgPorts=vlanCurCfgPorts)
