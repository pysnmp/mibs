...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlan=vlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstGeneralCfg=mstGeneralCfg, vlanMaxVlanID=vlanMaxVlanID, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsStpIndex=stgStatsStpIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgTable=stgCurCfgTable, stpInfoPortState=stpInfoPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsDeletes=fdbStatsDeletes, fdbLearnedPort=fdbLearnedPort, mstCfg=mstCfg, portTeamCfg=portTeamCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbState=fdbState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortTable=stpInfoPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortTable=cistInfoPortTable, stpInfoIndex=stpInfoIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoState=portTeamInfoState, vlanCurCfgTable=vlanCurCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbInfo=fdbInfo, mstNewCfgState=mstNewCfgState, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsLookups=fdbStatsLookups, fdbEntry=fdbEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistGeneralInfo=cistGeneralInfo, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoForwardDelay=stpInfoForwardDelay, stgCfg=stgCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgTable=stgNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, fdbClear=fdbClear, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Info=layer2Info, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortRole=cistInfoPortRole, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2=layer2, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoTable=stpInfoTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, mstCurCfgState=mstCurCfgState, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, layer2Oper=layer2Oper, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacp=lacp, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfo=lacpInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkgroup=trunkgroup, vlanInfo=vlanInfo, portTeamInfoTable=portTeamInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpStats=stpStats, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortMoved=lacpInfoPortMoved, cistRoot=cistRoot, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgState=vlanNewCfgState, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbSrcPort=fdbSrcPort, vlanInfoName=vlanInfoName, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCfg=mstCistCfg, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfo=portTeamInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Configs=layer2Configs, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbVlan=fdbVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsCreates=fdbStatsCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortEdge=stpInfoPortEdge, cistRootPort=cistRootPort, lacpNewPortState=lacpNewPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mirrPortMirr=mirrPortMirr, stpInfo=stpInfo, vlanInfoId=vlanInfoId, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortState=cistInfoPortState, lacpCurPortState=lacpCurPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, BridgeId=BridgeId, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoStatus=vlanInfoStatus, cistInfo=cistInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortIndex=stgStatsPortIndex, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, fdbRefSps=fdbRefSps, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, mirroring=mirroring)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, stpInfoHelloTime=stpInfoHelloTime, PYSNMP_MODULE_ID=layer2, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTableEntry=stpInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgTable=vlanNewCfgTable, fdbTable=fdbTable, vlanInfoTable=vlanInfoTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, layer2Stats=layer2Stats, vlanCurCfgBwmContract=vlanCurCfgBwmContract)
