...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxEnt=vlanMaxEnt, fdbMacAddr=fdbMacAddr, mstCistDefaultCfg=mstCistDefaultCfg, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortState=lacpCurPortState, mirroring=mirroring, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortIndex=cistInfoPortIndex, vlanInfoName=vlanInfoName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbSrcPort=fdbSrcPort, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTable=portTeamNewCfgTable, lacp=lacp, fdbVlan=fdbVlan, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Oper=layer2Oper, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, vlanInfoId=vlanInfoId, mstCistCfg=mstCistCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRootPort=cistRootPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortLinkType=cistInfoPortLinkType, cistRoot=cistRoot, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mirrPortMirr=mirrPortMirr, lacpInfoPortTable=lacpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortRole=stpInfoPortRole, vlanInfo=vlanInfo, portTeamInfoIndex=portTeamInfoIndex, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFinds=fdbStatsFinds, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbRefSps=fdbRefSps, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgTable=stgCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsStpIndex=stgStatsStpIndex, fdbState=fdbState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortState=stpInfoPortState, fdbStatsLookups=fdbStatsLookups, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, fdbTable=fdbTable, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortState=cistInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkgroup=trunkgroup, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCfg=mstCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Info=layer2Info, lacpInfo=lacpInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsHiwat=fdbStatsHiwat, stpInfoRootCost=stpInfoRootCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, PYSNMP_MODULE_ID=layer2, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2=layer2, stpInfoTable=stpInfoTable, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoState=portTeamInfoState, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, stpInfoRootPort=stpInfoRootPort, fdbInfo=fdbInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, BridgeId=BridgeId, fdbStats=fdbStats, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsCurrent=fdbStatsCurrent, fdbLearnedPort=fdbLearnedPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddPort=portTeamNewCfgAddPort, layer2Stats=layer2Stats, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoMaxAge=stpInfoMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, cistInfo=cistInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, vlan=vlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbEntry=fdbEntry, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfo=portTeamInfo, stgNewCfgTable=stgNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTable=stpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgState=mstCurCfgState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistRootPathCost=cistRootPathCost, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoTable=portTeamInfoTable, stpStats=stpStats, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgTable=vlanCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoIndex=stpInfoIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortEdge=stpInfoPortEdge, mstNewCfgState=mstNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfo=stpInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoTable=vlanInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsCreates=fdbStatsCreates, stgStatsPortTable=stgStatsPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCfg=stgCfg, cistInfoPortRole=cistInfoPortRole, stgCurCfgState=stgCurCfgState, layer2Configs=layer2Configs, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCfg=portTeamCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbClear=fdbClear)
