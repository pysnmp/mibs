...
Bits, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Gauge32, Counter64, NotificationType, MibIdentifier, ObjectIdentity, ModuleIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Gauge32", "Counter64", "NotificationType", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgLearn=vlanNewCfgLearn, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTable=stpInfoPortTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoTopChanges=stpInfoTopChanges, vlanInfoName=vlanInfoName, stgCurCfgState=stgCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, layer2Oper=layer2Oper, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgState=mstCurCfgState, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2Stats=layer2Stats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstGeneralCfg=mstGeneralCfg, vlanInfo=vlanInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoState=portTeamInfoState, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbVlan=fdbVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoLearn=vlanInfoLearn, vlan=vlan, vlanCurCfgVlanName=vlanCurCfgVlanName, layer2Info=layer2Info, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfo=stpInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, fdbState=fdbState, fdbStatsFinds=fdbStatsFinds, stpInfoPortIndex=stpInfoPortIndex, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCfg=stgCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, cistInfo=cistInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortTable=cistInfoPortTable, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, fdbSrcTrunk=fdbSrcTrunk, stpStats=stpStats, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbMacAddr=fdbMacAddr, stpInfoRootCost=stpInfoRootCost, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, BridgeId=BridgeId, vlanNewCfgPorts=vlanNewCfgPorts, cistRoot=cistRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRootPort=cistRootPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortMoved=lacpInfoPortMoved, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbInfo=fdbInfo, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgState=stgNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbSrcPort=fdbSrcPort, cistBridgeHelloTime=cistBridgeHelloTime, cistGeneralInfo=cistGeneralInfo, vlanCurCfgState=vlanCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStats=fdbStats, vlanCurCfgTable=vlanCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTable=stpInfoTable, cistInfoPortIndex=cistInfoPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCfg=mstCfg, portTeamNewCfgTable=portTeamNewCfgTable, vlanMaxEnt=vlanMaxEnt, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfo=portTeamInfo, mirroring=mirroring, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortState=stgCurCfgPortState, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPriority=stgCurCfgPriority, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgStg=vlanNewCfgStg, mirrPortMirr=mirrPortMirr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbTable=fdbTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbEntry=fdbEntry, vlanInfoId=vlanInfoId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbRefSps=fdbRefSps, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortPriority=cistInfoPortPriority, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoPorts=vlanInfoPorts, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkgroup=trunkgroup, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacp=lacp, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortState=cistInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRootPathCost=cistRootPathCost, stpInfoPortState=stpInfoPortState, lacpInfo=lacpInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurSystemPriority=lacpCurSystemPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2=layer2, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgStg=vlanCurCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCfg=portTeamCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, layer2Configs=layer2Configs, stpInfoRootPort=stpInfoRootPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbClear=fdbClear, fdbLearnedPort=fdbLearnedPort, lacpNewPortState=lacpNewPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgTable=stgCurCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgState=portTeamNewCfgState)
