...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRoot=cistRoot, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbClear=fdbClear, fdbVlan=fdbVlan, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgState=vlanCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortEdge=stpInfoPortEdge, cistRootPort=cistRootPort, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Configs=layer2Configs, stgNewCfgTable=stgNewCfgTable, vlanMaxEnt=vlanMaxEnt, vlanMaxVlanID=vlanMaxVlanID, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpStats=stpStats, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgState=stgNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfo=lacpInfo, mstCurCfgState=mstCurCfgState, layer2Stats=layer2Stats, vlanInfoTable=vlanInfoTable, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoHoldTime=stpInfoHoldTime, portTeamInfo=portTeamInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCfg=portTeamCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfo=vlanInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortTable=stpInfoPortTable, stgStatsPortTable=stgStatsPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbSrcPort=fdbSrcPort, stpInfoRootCost=stpInfoRootCost, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFinds=fdbStatsFinds, lacp=lacp, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, stpInfoPortState=stpInfoPortState, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortEdge=stgCurCfgPortEdge, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, stpInfoHelloTime=stpInfoHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbMacAddr=fdbMacAddr, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortRole=stpInfoPortRole, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbLearnedPort=fdbLearnedPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoStatus=vlanInfoStatus, portTeamInfoTable=portTeamInfoTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCfg=mstCfg, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbState=fdbState, fdbTable=fdbTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoIndex=stpInfoIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCfg=stgCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, cistRegionalRoot=cistRegionalRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsOverflows=fdbStatsOverflows, fdbStats=fdbStats, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortMoved=lacpInfoPortMoved, vlan=vlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoIndex=portTeamInfoIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoName=vlanInfoName, fdbStatsCreates=fdbStatsCreates, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbInfo=fdbInfo, mstCistCfg=mstCistCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, BridgeId=BridgeId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsHiwat=fdbStatsHiwat, fdbRefSps=fdbRefSps, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Oper=layer2Oper, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkgroup=trunkgroup, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfo=cistInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFindFails=fdbStatsFindFails, stpInfoTable=stpInfoTable, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mirroring=mirroring, portTeamInfoPorts=portTeamInfoPorts, vlanInfoId=vlanInfoId, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfo=stpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoLearn=vlanInfoLearn, lacpCurPortState=lacpCurPortState, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, layer2Info=layer2Info, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgAddPort=vlanNewCfgAddPort, mstGeneralCfg=mstGeneralCfg, cistRootPathCost=cistRootPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgState=mstNewCfgState)
