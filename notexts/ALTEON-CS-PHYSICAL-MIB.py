...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgIndex=stgNewCfgIndex, fdbEntry=fdbEntry, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRootPort=cistRootPort, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortIndex=lacpInfoPortIndex, cistGeneralInfo=cistGeneralInfo, vlanCurCfgState=vlanCurCfgState, layer2Info=layer2Info, fdbVlan=fdbVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Oper=layer2Oper, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfo=portTeamInfo, cistInfoPortLinkType=cistInfoPortLinkType, layer2Stats=layer2Stats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsLookups=fdbStatsLookups, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortNtt=lacpInfoPortNtt, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, lacp=lacp, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsDeletes=fdbStatsDeletes, cistInfo=cistInfo, stpInfoIndex=stpInfoIndex, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbTable=fdbTable, stpInfoPortRole=stpInfoPortRole, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTable=cistInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, fdbState=fdbState, vlanInfoTable=vlanInfoTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoId=vlanInfoId, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTable=stpInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoRootCost=stpInfoRootCost, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbClear=fdbClear, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Configs=layer2Configs, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRoot=cistRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgTable=stgCurCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbInfo=fdbInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortState=stgCurCfgPortState, mirrPortMirr=mirrPortMirr, stgCfg=stgCfg, PYSNMP_MODULE_ID=layer2, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, stpInfoRootPort=stpInfoRootPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortRole=cistInfoPortRole, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbMacAddr=fdbMacAddr, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortTable=stgCurCfgPortTable, fdbStats=fdbStats, vlan=vlan, stpStats=stpStats, layer2=layer2, trunkgroup=trunkgroup, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfo=stpInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, BridgeId=BridgeId, portTeamCfg=portTeamCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirroring=mirroring, stpInfoForwardDelay=stpInfoForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortState=cistInfoPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgState=mstCurCfgState, stgNewCfgTable=stgNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgState=mstNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoTableEntry=stpInfoTableEntry, vlanInfoStatus=vlanInfoStatus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfo=vlanInfo, lacpInfo=lacpInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoName=vlanInfoName, fdbRefSps=fdbRefSps, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbLearnedPort=fdbLearnedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, mstCfg=mstCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCfg=mstCistCfg, stpInfoPortState=stpInfoPortState, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgState=stgCurCfgState, fdbSrcPort=fdbSrcPort, vlanNewCfgState=vlanNewCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanMaxEnt=vlanMaxEnt, portTeamInfoPorts=portTeamInfoPorts, cistRootPathCost=cistRootPathCost, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgStg=vlanNewCfgStg)
