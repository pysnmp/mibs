...
TimeTicks, Bits, Unsigned32, IpAddress, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Integer32, ModuleIdentity, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Integer32", "ModuleIdentity", "iso", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRoot=cistRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortTable=stpInfoPortTable, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbState=fdbState, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCfg=mstCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoIndex=stpInfoIndex, cistInfoPortPriority=cistInfoPortPriority, vlanInfoName=vlanInfoName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mirrPortMirr=mirrPortMirr, PYSNMP_MODULE_ID=layer2, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsOverflows=fdbStatsOverflows, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, layer2Oper=layer2Oper, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacp=lacp, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoPorts=vlanInfoPorts, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCfg=portTeamCfg, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStats=fdbStats, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoState=portTeamInfoState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTableEntry=stgCurCfgTableEntry, BridgeId=BridgeId, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, fdbStatsFinds=fdbStatsFinds, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRootPort=cistRootPort, fdbInfo=fdbInfo, cistInfoPortIndex=cistInfoPortIndex, lacpInfo=lacpInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfo=cistInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbTable=fdbTable, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortRole=cistInfoPortRole, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanMaxVlanID=vlanMaxVlanID, fdbRefSps=fdbRefSps, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpStats=stpStats, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfo=vlanInfo, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistGeneralInfo=cistGeneralInfo, portTeamInfoTrunks=portTeamInfoTrunks, mstCurCfgState=mstCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortState=lacpCurPortState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoId=vlanInfoId, stpInfoRootCost=stpInfoRootCost, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanMaxEnt=vlanMaxEnt, layer2Stats=layer2Stats, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsHiwat=fdbStatsHiwat, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortTable=lacpInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortTable=cistInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfo=portTeamInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfo=stpInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, stpInfoTable=stpInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortState=stgCurCfgPortState, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCfg=mstCistCfg, stgStatsPortTable=stgStatsPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortState=stpInfoPortState, layer2Configs=layer2Configs, fdbVlan=fdbVlan, vlanNewCfgLearn=vlanNewCfgLearn, fdbSrcPort=fdbSrcPort, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgState=vlanCurCfgState, fdbLearnedPort=fdbLearnedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkgroup=trunkgroup, cistRegionalPathCost=cistRegionalPathCost, layer2Info=layer2Info, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsLookups=fdbStatsLookups, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, fdbClear=fdbClear, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortIndex=stpInfoPortIndex, mstNewCfgState=mstNewCfgState, stpInfoTopChanges=stpInfoTopChanges, fdbEntry=fdbEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlan=vlan, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoMaxAge=stpInfoMaxAge, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoTable=vlanInfoTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstGeneralCfg=mstGeneralCfg, stgCfg=stgCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2=layer2, lacpNewPortState=lacpNewPortState, fdbMacAddr=fdbMacAddr, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates)
