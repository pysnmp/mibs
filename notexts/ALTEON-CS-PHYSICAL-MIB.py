...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfo=portTeamInfo, stgNewCfgIndex=stgNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortTable=stpInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, BridgeId=BridgeId, stpInfoRootCost=stpInfoRootCost, vlanCurCfgState=vlanCurCfgState, stpInfoTable=stpInfoTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbClear=fdbClear, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortRole=cistInfoPortRole, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoIndex=stpInfoIndex, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpStats=stpStats, stgNewCfgState=stgNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoMaxAge=stpInfoMaxAge, cistRootPort=cistRootPort, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgPorts=vlanNewCfgPorts, trunkgroup=trunkgroup, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgTable=stgNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgState=stgCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgState=mstNewCfgState, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoPorts=portTeamInfoPorts, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgState=mstCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTable=vlanInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortTable=stgStatsPortTable, fdbRefSps=fdbRefSps, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCfg=stgCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlan=vlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgTable=stgCurCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfo=cistInfo, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbState=fdbState, layer2Oper=layer2Oper, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbTable=fdbTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbMacAddr=fdbMacAddr, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoState=portTeamInfoState, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoHoldTime=stpInfoHoldTime, fdbSrcPort=fdbSrcPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbEntry=fdbEntry, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, fdbVlan=fdbVlan, stpInfoPortIndex=stpInfoPortIndex, mirroring=mirroring, mstCfg=mstCfg, lacpNewPortState=lacpNewPortState, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoId=vlanInfoId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfo=vlanInfo, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCfg=mstCistCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbSrcTrunk=fdbSrcTrunk, mirrPortMirr=mirrPortMirr, lacp=lacp, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPriority=stgNewCfgPriority, fdbInfo=fdbInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHelloTime=stpInfoHelloTime, lacpInfo=lacpInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoPorts=vlanInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, cistRootPathCost=cistRootPathCost, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Configs=layer2Configs, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortState=stpInfoPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoName=vlanInfoName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsCreates=fdbStatsCreates, layer2=layer2, stgNewCfgPortTable=stgNewCfgPortTable, layer2Stats=layer2Stats, fdbStatsLookups=fdbStatsLookups, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStats=fdbStats, PYSNMP_MODULE_ID=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortState=cistInfoPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgState=vlanNewCfgState, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortState=stgCurCfgPortState, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry)
