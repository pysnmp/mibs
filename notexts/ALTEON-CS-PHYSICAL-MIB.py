...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoTable=vlanInfoTable, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoId=vlanInfoId, cistRootPathCost=cistRootPathCost, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistRootPort=cistRootPort, fdbStatsCreates=fdbStatsCreates, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootPort=stpInfoRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Stats=layer2Stats, layer2=layer2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbVlan=fdbVlan, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgState=mstCurCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortState=stgCurCfgPortState, layer2Configs=layer2Configs, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsLookups=fdbStatsLookups, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortLinkType=cistInfoPortLinkType, PYSNMP_MODULE_ID=layer2, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfo=lacpInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRoot=cistRoot, layer2Oper=layer2Oper, portTeamInfo=portTeamInfo, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTable=stgStatsPortTable, trunkgroup=trunkgroup, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoJumbo=vlanInfoJumbo, mirrPortMirr=mirrPortMirr, vlanMaxEnt=vlanMaxEnt, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, stpInfoIndex=stpInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoTable=portTeamInfoTable, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfo=vlanInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgState=stgCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, fdbStats=fdbStats, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Info=layer2Info, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTable=stpInfoPortTable, vlanInfoLearn=vlanInfoLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbInfo=fdbInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoStatus=vlanInfoStatus, lacpNewPortState=lacpNewPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoTrunks=portTeamInfoTrunks, stpInfo=stpInfo, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoPorts=portTeamInfoPorts, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoName=vlanInfoName, stgCfg=stgCfg, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbState=fdbState, vlanMaxVlanID=vlanMaxVlanID, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootCost=stpInfoRootCost, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsFinds=fdbStatsFinds, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortState=lacpCurPortState, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortPathCost=stpInfoPortPathCost, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlan=vlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, mstCistCfg=mstCistCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbClear=fdbClear, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, mirroring=mirroring, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortTable=cistInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsFindFails=fdbStatsFindFails, lacp=lacp, cistInfoPortState=cistInfoPortState, cistGeneralInfo=cistGeneralInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCfg=mstCfg, vlanNewCfgPorts=vlanNewCfgPorts, BridgeId=BridgeId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, cistInfo=cistInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortState=stpInfoPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpStats=stpStats, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoState=portTeamInfoState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbSrcPort=fdbSrcPort, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbTable=fdbTable, fdbEntry=fdbEntry, fdbRefSps=fdbRefSps, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
