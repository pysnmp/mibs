...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortPriority=cistInfoPortPriority, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge, cistRootPort=cistRootPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoHoldTime=stpInfoHoldTime, fdbEntry=fdbEntry, cistInfoPortTable=cistInfoPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortRole=stpInfoPortRole, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPathCost=cistRootPathCost, cistInfoPortState=cistInfoPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfo=portTeamInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgState=stgNewCfgState, cistRoot=cistRoot, fdbState=fdbState, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, layer2Oper=layer2Oper, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanMaxEnt=vlanMaxEnt, trunkgroup=trunkgroup, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbVlan=fdbVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoName=vlanInfoName, mstCfg=mstCfg, cistBridgeMaxAge=cistBridgeMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgStpMode=mstCurCfgStpMode, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoJumbo=vlanInfoJumbo, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbTable=fdbTable, fdbRefSps=fdbRefSps, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgIndex=portTeamCurCfgIndex, mirroring=mirroring, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgState=vlanNewCfgState, fdbStatsFinds=fdbStatsFinds, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2=layer2, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistGeneralInfo=cistGeneralInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsHiwat=fdbStatsHiwat, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortRole=cistInfoPortRole, fdbInfo=fdbInfo, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Configs=layer2Configs, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mirrPortMirr=mirrPortMirr, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortTable=stpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Info=layer2Info, mstNewCfgState=mstNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Stats=layer2Stats, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTable=stpInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgState=stgCurCfgState, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortState=stpInfoPortState, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoId=vlanInfoId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfo=vlanInfo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfo=stpInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlan=vlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoIndex=stpInfoIndex, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortState=lacpCurPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCfg=mstCistCfg, stgCurCfgPortLink=stgCurCfgPortLink, cistInfo=cistInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoTable=vlanInfoTable, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCfg=stgCfg, lacpInfoPortTable=lacpInfoPortTable, BridgeId=BridgeId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, mstGeneralCfg=mstGeneralCfg, portTeamTableMaxSize=portTeamTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortTable=stgStatsPortTable, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stpStats=stpStats, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacp=lacp, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbClear=fdbClear, fdbMacAddr=fdbMacAddr, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTableEntry=stpInfoTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStats=fdbStats, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbLearnedPort=fdbLearnedPort, vlanInfoPorts=vlanInfoPorts, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry)
