...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgState=portTeamNewCfgState, stpInfoMaxAge=stpInfoMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeHelloTime=cistBridgeHelloTime, stpStats=stpStats, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCurCfgState=mstCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCfg=mstCfg, stpInfoRootCost=stpInfoRootCost, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoIndex=stpInfoIndex, cistInfoPortIndex=cistInfoPortIndex, vlanInfoId=vlanInfoId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Info=layer2Info, fdbSrcPort=fdbSrcPort, lacp=lacp, vlanNewCfgPorts=vlanNewCfgPorts, PYSNMP_MODULE_ID=layer2, lacpCurPortState=lacpCurPortState, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTable=stgNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortLinkType=cistInfoPortLinkType, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbClear=fdbClear, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoPortsState=portTeamInfoPortsState, cistRootPort=cistRootPort, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgIndex=portTeamCurCfgIndex, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, fdbRefSps=fdbRefSps, stpInfo=stpInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortState=stpInfoPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, cistInfo=cistInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistBridgeForwardDelay=cistBridgeForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfo=portTeamInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootPort=stpInfoRootPort, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, stgNewCfgState=stgNewCfgState, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgTable=vlanNewCfgTable, vlanInfo=vlanInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPriority=stgNewCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, fdbState=fdbState, mirroring=mirroring, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfo=lacpInfo, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, layer2Configs=layer2Configs, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoPorts=vlanInfoPorts, stgCfg=stgCfg, BridgeId=BridgeId, portTeamCfg=portTeamCfg, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTable=stpInfoTable, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCfg=mstCistCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgState=vlanCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoIndex=portTeamInfoIndex, vlan=vlan, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbTable=fdbTable, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgState=stgCurCfgState, fdbMacAddr=fdbMacAddr, layer2=layer2, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoState=portTeamInfoState, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2Oper=layer2Oper, stpInfoHelloTime=stpInfoHelloTime, layer2Stats=layer2Stats, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoTable=vlanInfoTable, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTable=portTeamInfoTable, stgStatsPortTable=stgStatsPortTable, cistInfoPortState=cistInfoPortState, fdbInfo=fdbInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbVlan=fdbVlan, lacpNewPortState=lacpNewPortState, portTeamCurCfgTable=portTeamCurCfgTable, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgState=vlanNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStats=fdbStats, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsCreates=fdbStatsCreates, cistRegionalRoot=cistRegionalRoot, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsFinds=fdbStatsFinds, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkgroup=trunkgroup, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortRole=cistInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRoot=cistRoot, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, vlanInfoName=vlanInfoName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsLookups=fdbStatsLookups, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortLink=stgNewCfgPortLink, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority)
