...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoPorts=vlanInfoPorts, layer2Stats=layer2Stats, portTeamCfg=portTeamCfg, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsDeletes=fdbStatsDeletes, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbLearnedPort=fdbLearnedPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCfg=mstCistCfg, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Configs=layer2Configs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgRegionName=mstCurCfgRegionName, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfo=stpInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsOverflows=fdbStatsOverflows, fdbMacAddr=fdbMacAddr, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbClear=fdbClear, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTable=stgCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortState=lacpCurPortState, cistRegionalRoot=cistRegionalRoot, vlanCurCfgStg=vlanCurCfgStg, fdbStatsFinds=fdbStatsFinds, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTable=portTeamNewCfgTable, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsLookups=fdbStatsLookups, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgTable=stgNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRootPort=cistRootPort, fdbSrcTrunk=fdbSrcTrunk, mstCurCfgState=mstCurCfgState, vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbVlan=fdbVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, stgCfg=stgCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStats=fdbStats, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfo=cistInfo, layer2=layer2, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgState=stgCurCfgState, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbState=fdbState, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, cistRoot=cistRoot, mstCfg=mstCfg, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, mirrPortMirr=mirrPortMirr, lacpNewPortState=lacpNewPortState, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortIndex=stgStatsPortIndex, fdbTable=fdbTable, stpInfoRootPort=stpInfoRootPort, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTable=portTeamInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfo=vlanInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortState=cistInfoPortState, layer2Oper=layer2Oper, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfo=portTeamInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mirroring=mirroring, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoState=portTeamInfoState, vlanInfoId=vlanInfoId, cistInfoPortTable=cistInfoPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortState=stpInfoPortState, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlan=vlan, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortIndex=stpInfoPortIndex, fdbRefSps=fdbRefSps, portTeamCurCfgPorts=portTeamCurCfgPorts, lacp=lacp, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoRootCost=stpInfoRootCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoLearn=vlanInfoLearn, stgNewCfgState=stgNewCfgState, fdbEntry=fdbEntry, fdbSrcPort=fdbSrcPort, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, BridgeId=BridgeId, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoName=vlanInfoName, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoTable=stpInfoTable, layer2Info=layer2Info, lacpInfo=lacpInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpStats=stpStats, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgState=mstNewCfgState, trunkgroup=trunkgroup, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortLinkType=cistInfoPortLinkType, fdbInfo=fdbInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort)
