...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortState=stgCurCfgPortState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Configs=layer2Configs, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbTable=fdbTable, portTeamInfoState=portTeamInfoState, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortState=cistInfoPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgState=vlanCurCfgState, stgCfg=stgCfg, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsHiwat=fdbStatsHiwat, layer2Stats=layer2Stats, stgStatsPortTable=stgStatsPortTable, fdbSrcPort=fdbSrcPort, mirroring=mirroring, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgState=stgCurCfgState, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbVlan=fdbVlan, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortState=lacpCurPortState, cistRootPort=cistRootPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, fdbStats=fdbStats, vlanMaxVlanID=vlanMaxVlanID, mstCfg=mstCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoTable=stpInfoTable, stpInfoRootPort=stpInfoRootPort, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgLearn=vlanCurCfgLearn, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgTable=stgNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, mstNewCfgState=mstNewCfgState, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgState=mstCurCfgState, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpStats=stpStats, stpInfo=stpInfo, portTeamInfoIndex=portTeamInfoIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoTable=vlanInfoTable, fdbMacAddr=fdbMacAddr, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfo=lacpInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCfg=portTeamCfg, stpInfoPortState=stpInfoPortState, vlanMaxEnt=vlanMaxEnt, stpInfoPortRole=stpInfoPortRole, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbInfo=fdbInfo, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbEntry=fdbEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, PYSNMP_MODULE_ID=layer2, fdbStatsCreates=fdbStatsCreates, lacpNewPortState=lacpNewPortState, cistGeneralInfo=cistGeneralInfo, cistRootPathCost=cistRootPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Info=layer2Info, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortLinkType=stpInfoPortLinkType, layer2=layer2, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsFinds=fdbStatsFinds, fdbStatsFindFails=fdbStatsFindFails, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgAddPort=vlanNewCfgAddPort, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfo=portTeamInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstGeneralCfg=mstGeneralCfg, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Oper=layer2Oper, fdbLearnedPort=fdbLearnedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCfg=mstCistCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTable=portTeamInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortSelected=lacpInfoPortSelected, fdbState=fdbState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbClear=fdbClear, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgTable=stgCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, portTeamNewCfgTable=portTeamNewCfgTable, trunkgroup=trunkgroup, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfo=cistInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRoot=cistRoot, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, vlanInfoLearn=vlanInfoLearn, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlan=vlan, vlanInfoName=vlanInfoName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacp=lacp, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, lacpInfoPortTable=lacpInfoPortTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbRefSps=fdbRefSps, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, BridgeId=BridgeId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoStatus=vlanInfoStatus, stpInfoPortTable=stpInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState)
