...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortTable=stpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Info=layer2Info, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbState=fdbState, layer2Oper=layer2Oper, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoTable=vlanInfoTable, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgState=stgCurCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, stpInfo=stpInfo, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortTable=cistInfoPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mirroring=mirroring, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortState=lacpCurPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, vlanInfo=vlanInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgTable=stgNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoRootCost=stpInfoRootCost, vlan=vlan, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistGeneralInfo=cistGeneralInfo, stgCurCfgTable=stgCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoLearn=vlanInfoLearn, lacpInfo=lacpInfo, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCurrent=fdbStatsCurrent, mirrPortMirr=mirrPortMirr, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgState=stgNewCfgState, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfo=portTeamInfo, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, layer2Stats=layer2Stats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbTable=fdbTable, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgTable=vlanCurCfgTable, vlanInfoId=vlanInfoId, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, mstNewCfgState=mstNewCfgState, portTeamInfoState=portTeamInfoState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbLearnedPort=fdbLearnedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, vlanNewCfgState=vlanNewCfgState, fdbStatsLookups=fdbStatsLookups, vlanInfoName=vlanInfoName, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgState=portTeamCurCfgState, fdbStats=fdbStats, BridgeId=BridgeId, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, mstCfg=mstCfg, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, PYSNMP_MODULE_ID=layer2, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortTable=stgStatsPortTable, fdbRefSps=fdbRefSps, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2=layer2, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfo=cistInfo, vlanInfoStatus=vlanInfoStatus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTable=stpInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoPorts=vlanInfoPorts, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanMaxEnt=vlanMaxEnt, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, lacp=lacp, fdbSrcPort=fdbSrcPort, cistRoot=cistRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbInfo=fdbInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortState=stpInfoPortState, cistRootPort=cistRootPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortState=lacpNewPortState, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, fdbEntry=fdbEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgStg=vlanCurCfgStg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoHelloTime=stpInfoHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCfg=portTeamCfg, stgCfg=stgCfg, fdbStatsCreates=fdbStatsCreates, stpInfoTableEntry=stpInfoTableEntry, cistRootPathCost=cistRootPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, mstCurCfgState=mstCurCfgState, fdbClear=fdbClear, stpInfoRootPort=stpInfoRootPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCfg=mstCistCfg, stgCurCfgPriority=stgCurCfgPriority, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortState=cistInfoPortState, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkgroup=trunkgroup, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoTableEntry=vlanInfoTableEntry, stpStats=stpStats, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable)
