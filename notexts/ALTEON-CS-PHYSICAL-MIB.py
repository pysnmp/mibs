...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgIndex=stgNewCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoName=vlanInfoName, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, portTeamCurCfgState=portTeamCurCfgState, fdbRefSps=fdbRefSps, stpInfoTable=stpInfoTable, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, fdbLearnedPort=fdbLearnedPort, fdbState=fdbState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTable=stpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgState=mstCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbVlan=fdbVlan, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, cistRoot=cistRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Configs=layer2Configs, layer2Stats=layer2Stats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, fdbEntry=fdbEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortIndex=cistInfoPortIndex, mirrPortMirr=mirrPortMirr, cistInfo=cistInfo, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpStats=stpStats, mstCistCfg=mstCistCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgState=mstNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbClear=fdbClear, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCfg=portTeamCfg, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistRootPort=cistRootPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoStatus=vlanInfoStatus, trunkgroup=trunkgroup, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, BridgeId=BridgeId, cistInfoPortState=cistInfoPortState, vlanInfo=vlanInfo, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCfg=stgCfg, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbMacAddr=fdbMacAddr, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoId=vlanInfoId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgState=stgNewCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgStg=vlanCurCfgStg, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, fdbInfo=fdbInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoLearn=vlanInfoLearn, stgNewCfgTable=stgNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, PYSNMP_MODULE_ID=layer2, portTeamInfoTable=portTeamInfoTable, portTeamInfo=portTeamInfo, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortRole=cistInfoPortRole, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, layer2Info=layer2Info, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistGeneralInfo=cistGeneralInfo, cistRegionalPathCost=cistRegionalPathCost, lacpInfo=lacpInfo, vlanNewCfgState=vlanNewCfgState, cistRegionalRoot=cistRegionalRoot, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortState=lacpNewPortState, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, layer2=layer2, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootPort=stpInfoRootPort, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortNtt=lacpInfoPortNtt, mirroring=mirroring, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTable=stgStatsPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortTable=cistInfoPortTable, mstGeneralCfg=mstGeneralCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlan=vlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCfg=mstCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcPort=fdbSrcPort, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoTable=vlanInfoTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortPathCost=stpInfoPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortState=stpInfoPortState, layer2Oper=layer2Oper, stpInfo=stpInfo, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgLearn=vlanCurCfgLearn)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgTable=vlanNewCfgTable, fdbStats=fdbStats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacp=lacp, cistRootPathCost=cistRootPathCost, stpInfoIndex=stpInfoIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgPortState=stgNewCfgPortState)
