...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxVlanID=vlanMaxVlanID, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCfg=mstCfg, stgCurCfgTable=stgCurCfgTable, mirroring=mirroring, vlanCurCfgLearn=vlanCurCfgLearn, fdbInfo=fdbInfo, stgCfg=stgCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoHelloTime=stpInfoHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfo=portTeamInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFindFails=fdbStatsFindFails, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkgroup=trunkgroup, fdbTable=fdbTable, cistRegionalRoot=cistRegionalRoot, portTeamTableMaxSize=portTeamTableMaxSize, fdbStats=fdbStats, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoTable=vlanInfoTable, stgNewCfgState=stgNewCfgState, stpInfoPortState=stpInfoPortState, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, mirrPortMirr=mirrPortMirr, fdbStatsCreates=fdbStatsCreates, fdbStatsHiwat=fdbStatsHiwat, stpInfoIndex=stpInfoIndex, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlan=vlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbEntry=fdbEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfo=vlanInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCfg=mstCistCfg, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCfg=portTeamCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, fdbVlan=fdbVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortState=lacpNewPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRootPathCost=cistRootPathCost, stpInfoTable=stpInfoTable, cistInfo=cistInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Configs=layer2Configs, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgTable=stgNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgVlanBmap=stgCurCfgVlanBmap, BridgeId=BridgeId, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Info=layer2Info, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookups=fdbStatsLookups, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortTable=cistInfoPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2=layer2, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoPorts=vlanInfoPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortTable=stgStatsPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbClear=fdbClear, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbState=fdbState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTable=lacpInfoPortTable, lacpCurSystemPriority=lacpCurSystemPriority, cistGeneralInfo=cistGeneralInfo, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbLearnedPort=fdbLearnedPort, layer2Oper=layer2Oper, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPriority=stgNewCfgPriority, fdbStatsOverflows=fdbStatsOverflows, layer2Stats=layer2Stats, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortLinkType=stpInfoPortLinkType, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPriority=stgCurCfgPriority, fdbMacAddr=fdbMacAddr, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoPorts=portTeamInfoPorts, stpInfoRootPort=stpInfoRootPort, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootCost=stpInfoRootCost, vlanInfoId=vlanInfoId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRootPort=cistRootPort, vlanInfoName=vlanInfoName, lacp=lacp, lacpCurPortState=lacpCurPortState, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, stpInfo=stpInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgLearn=vlanNewCfgLearn, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamInfoState=portTeamInfoState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpStats=stpStats, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoStatus=vlanInfoStatus, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbRefSps=fdbRefSps, lacpNewSystemPriority=lacpNewSystemPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsFinds=fdbStatsFinds, vlanNewCfgStg=vlanNewCfgStg)
