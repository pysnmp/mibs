...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoName=vlanInfoName, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, fdbRefSps=fdbRefSps, lacpInfo=lacpInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbEntry=fdbEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, vlanInfoStatus=vlanInfoStatus, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoMaxAge=stpInfoMaxAge, mstNewCfgState=mstNewCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPriority=stgNewCfgPriority, layer2Stats=layer2Stats, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortState=lacpNewPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoRootCost=stpInfoRootCost, vlanInfo=vlanInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoTable=vlanInfoTable, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCreates=fdbStatsCreates, mstCfg=mstCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoTable=stpInfoTable, vlanNewCfgState=vlanNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsOverflows=fdbStatsOverflows, cistRoot=cistRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkgroup=trunkgroup, vlanCurCfgState=vlanCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgState=portTeamNewCfgState, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCfg=portTeamCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCfg=stgCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfo=cistInfo, portTeamInfo=portTeamInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacp=lacp, vlanCurCfgVlanId=vlanCurCfgVlanId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, BridgeId=BridgeId, layer2=layer2, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootPort=stpInfoRootPort, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoState=portTeamInfoState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamCurCfgIndex=portTeamCurCfgIndex, cistGeneralInfo=cistGeneralInfo, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStats=fdbStats, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxEnt=vlanMaxEnt, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbVlan=fdbVlan, fdbStatsLookupFails=fdbStatsLookupFails, stpInfo=stpInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsStpIndex=stgStatsStpIndex, fdbTable=fdbTable, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrPortMirr=mirrPortMirr, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, stpInfoHoldTime=stpInfoHoldTime, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCfg=mstCistCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortLink=stgNewCfgPortLink, layer2Oper=layer2Oper, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistRegionalRoot=cistRegionalRoot, layer2Info=layer2Info, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbInfo=fdbInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgState=mstCurCfgState, fdbClear=fdbClear, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlan=vlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsFinds=fdbStatsFinds, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortRole=cistInfoPortRole, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, fdbMacAddr=fdbMacAddr, mirroring=mirroring, vlanNewCfgTable=vlanNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortState=stpInfoPortState, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", PYSNMP_MODULE_ID=layer2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortState=lacpCurPortState, stgCurCfgPortLink=stgCurCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, cistRootPort=cistRootPort, stpStats=stpStats, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortRole=stpInfoPortRole, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbState=fdbState, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPriority=cistInfoPortPriority, layer2Configs=layer2Configs, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
