...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRootPort=cistRootPort, stpInfoIndex=stpInfoIndex, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfo=cistInfo, mstCistCfg=mstCistCfg, cistInfoPortIndex=cistInfoPortIndex, fdbEntry=fdbEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCfg=portTeamCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoId=vlanInfoId, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoTable=vlanInfoTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, cistGeneralInfo=cistGeneralInfo, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Info=layer2Info, stgCurCfgState=stgCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbInfo=fdbInfo, stpInfoPortEdge=stpInfoPortEdge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, stpInfo=stpInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgState=portTeamNewCfgState, stpInfoHelloTime=stpInfoHelloTime, fdbStatsCreates=fdbStatsCreates, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCfg=stgCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsHiwat=fdbStatsHiwat, lacp=lacp, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortState=lacpCurPortState, stpStats=stpStats, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsLookups=fdbStatsLookups, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mirrPortMirr=mirrPortMirr, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbMacAddr=fdbMacAddr, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRoot=cistRoot, fdbTable=fdbTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCfg=mstCfg, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoRootCost=stpInfoRootCost, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, lacpInfo=lacpInfo, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mirroring=mirroring, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistBridgeMaxAge=cistBridgeMaxAge, BridgeId=BridgeId, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgState=mstCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgTable=vlanCurCfgTable, layer2=layer2, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, PYSNMP_MODULE_ID=layer2, stpInfoPortIndex=stpInfoPortIndex, cistRootPathCost=cistRootPathCost, fdbStats=fdbStats, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTableEntry=stpInfoTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfo=portTeamInfo, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, vlan=vlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRegionalRoot=cistRegionalRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTable=stpInfoTable, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, mstGeneralCfg=mstGeneralCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfo=vlanInfo, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortTable=stpInfoPortTable, fdbRefSps=fdbRefSps, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoState=portTeamInfoState, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortState=cistInfoPortState, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbLearnedPort=fdbLearnedPort, trunkgroup=trunkgroup, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, vlanInfoName=vlanInfoName, portTeamInfoPorts=portTeamInfoPorts, fdbVlan=fdbVlan, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortTable=stgNewCfgPortTable, layer2Stats=layer2Stats, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoPorts=vlanInfoPorts, stgCurCfgTable=stgCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortState=lacpNewPortState, cistRegionalPathCost=cistRegionalPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortState=stpInfoPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Configs=layer2Configs, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry)
