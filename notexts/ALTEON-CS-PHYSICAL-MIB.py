...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfo=lacpInfo, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, layer2Configs=layer2Configs, stgNewCfgState=stgNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortLinkType=stpInfoPortLinkType, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, vlanCurCfgStg=vlanCurCfgStg, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, layer2=layer2, BridgeId=BridgeId, cistGeneralInfo=cistGeneralInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgState=vlanCurCfgState, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, mirrPortMirr=mirrPortMirr, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbVlan=fdbVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgState=mstCurCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortPathCost=stpInfoPortPathCost, cistRootPort=cistRootPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Oper=layer2Oper, fdbTable=fdbTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, stpInfo=stpInfo, cistInfo=cistInfo, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortState=stpInfoPortState, cistInfoPortIndex=cistInfoPortIndex, trunkgroup=trunkgroup, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mirroring=mirroring, fdbInfo=fdbInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoName=vlanInfoName, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, PYSNMP_MODULE_ID=layer2, vlanInfoId=vlanInfoId, stpInfoHoldTime=stpInfoHoldTime, cistRootPathCost=cistRootPathCost, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgState=portTeamNewCfgState, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsLookups=fdbStatsLookups, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgTable=vlanCurCfgTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgState=vlanNewCfgState, layer2Info=layer2Info, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCfg=mstCistCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoState=portTeamInfoState, vlanCurCfgVlanName=vlanCurCfgVlanName, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcPort=fdbSrcPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsFinds=fdbStatsFinds, lacpNewPortState=lacpNewPortState, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsOverflows=fdbStatsOverflows, fdbEntry=fdbEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTable=vlanInfoTable, vlan=vlan, vlanInfo=vlanInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTable=stpInfoTable, cistRoot=cistRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbMacAddr=fdbMacAddr, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStats=fdbStats, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCfg=portTeamCfg, cistInfoPortTable=cistInfoPortTable, fdbRefSps=fdbRefSps, portTeamInfo=portTeamInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, stpInfoPortIndex=stpInfoPortIndex, lacp=lacp, vlanInfoBwmContract=vlanInfoBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, stpStats=stpStats, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbClear=fdbClear, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoLearn=vlanInfoLearn, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortState=cistInfoPortState, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortTable=stpInfoPortTable, layer2Stats=layer2Stats, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbState=fdbState, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCfg=mstCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
