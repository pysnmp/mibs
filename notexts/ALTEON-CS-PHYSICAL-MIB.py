...
TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, Bits, Counter32, Counter64, Integer32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "Bits", "Counter32", "Counter64", "Integer32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbTable=fdbTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mirrPortMirr=mirrPortMirr, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPriority=stgCurCfgPriority, BridgeId=BridgeId, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfo=portTeamInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortState=cistInfoPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortStpIndex=stpInfoPortStpIndex, layer2Oper=layer2Oper, mstCurCfgState=mstCurCfgState, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbRefSps=fdbRefSps, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTable=stgCurCfgTable, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortNtt=lacpInfoPortNtt, cistInfo=cistInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortPriority=cistInfoPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbLearnedPort=fdbLearnedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfo=stpInfo, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgTable=vlanNewCfgTable, PYSNMP_MODULE_ID=layer2, cistRoot=cistRoot, stgCurCfgIndex=stgCurCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortTable=cistInfoPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfo=lacpInfo, vlanInfoStatus=vlanInfoStatus, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortSelected=lacpInfoPortSelected, layer2=layer2, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, vlanMaxEnt=vlanMaxEnt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCfg=portTeamCfg, lacpNewPortState=lacpNewPortState, fdbSrcPort=fdbSrcPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Stats=layer2Stats, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTable=portTeamInfoTable, fdbVlan=fdbVlan, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgState=vlanNewCfgState, fdbStatsLookups=fdbStatsLookups, mstNewCfgStpMode=mstNewCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortRole=cistInfoPortRole, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgIndex=portTeamNewCfgIndex, lacp=lacp, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCfg=mstCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgState=stgNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStats=fdbStats, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFinds=fdbStatsFinds, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, mirroring=mirroring, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortState=lacpCurPortState, stgCurCfgState=stgCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstGeneralCfg=mstGeneralCfg, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoState=portTeamInfoState, vlanCurCfgVlanName=vlanCurCfgVlanName, cistRootPathCost=cistRootPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPriority=stgNewCfgPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbState=fdbState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistGeneralInfo=cistGeneralInfo, fdbEntry=fdbEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCfg=stgCfg, layer2Info=layer2Info, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoIndex=stpInfoIndex, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoId=vlanInfoId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, stpStats=stpStats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, cistRootPort=cistRootPort, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoRootPort=stpInfoRootPort, vlanInfoName=vlanInfoName, stpInfoTable=stpInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlan=vlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortIndex=stpInfoPortIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortState=stpInfoPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsCurrent=fdbStatsCurrent, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCfg=mstCistCfg, fdbMacAddr=fdbMacAddr, fdbInfo=fdbInfo, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbClear=fdbClear, stpInfoRootCost=stpInfoRootCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfo=vlanInfo, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Configs=layer2Configs, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortTable=stpInfoPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry)
