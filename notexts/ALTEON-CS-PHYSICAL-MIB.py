...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortIndex=stgStatsPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, BridgeId=BridgeId, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortTable=stpInfoPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalPathCost=cistRegionalPathCost, portTeamInfo=portTeamInfo, vlanInfo=vlanInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgState=stgNewCfgState, stpInfoMaxAge=stpInfoMaxAge, fdbInfo=fdbInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoRootCost=stpInfoRootCost, layer2Configs=layer2Configs, layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbRefSps=fdbRefSps, fdbSrcPort=fdbSrcPort, fdbEntry=fdbEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoName=vlanInfoName, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfo=stpInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacp=lacp, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsHiwat=fdbStatsHiwat, mirrPortMirr=mirrPortMirr, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRegionalRoot=cistRegionalRoot, vlanCurCfgState=vlanCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbClear=fdbClear, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoHelloTime=stpInfoHelloTime, vlanInfoStatus=vlanInfoStatus, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCfg=mstCistCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortIndex=stpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoIndex=portTeamInfoIndex, stpInfoRootPort=stpInfoRootPort, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCfg=portTeamCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgVlanName=vlanNewCfgVlanName, mstNewCfgState=mstNewCfgState, fdbStatsOverflows=fdbStatsOverflows, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortState=cistInfoPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsCreates=fdbStatsCreates, stpInfoHoldTime=stpInfoHoldTime, stpInfoTable=stpInfoTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgState=stgCurCfgState, stgCurCfgIndex=stgCurCfgIndex, vlanInfoPorts=vlanInfoPorts, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCurCfgRegionName=mstCurCfgRegionName, PYSNMP_MODULE_ID=layer2, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistRootPathCost=cistRootPathCost, cistInfoPortRole=cistInfoPortRole, layer2Info=layer2Info, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mirroring=mirroring, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortRole=stpInfoPortRole, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortState=stgNewCfgPortState, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoState=portTeamInfoState, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCfg=mstCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanMaxEnt=vlanMaxEnt, fdbMacAddr=fdbMacAddr, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkgroup=trunkgroup, fdbStatsLookups=fdbStatsLookups, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCfg=stgCfg, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbVlan=fdbVlan, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortTable=cistInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortEdge=stpInfoPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStats=fdbStats, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortState=lacpNewPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, layer2=layer2, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, fdbTable=fdbTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoIndex=stpInfoIndex, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoId=vlanInfoId, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgJumbo=vlanNewCfgJumbo, vlan=vlan, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfo=lacpInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTable=portTeamInfoTable, mstCurCfgState=mstCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgStg=vlanCurCfgStg, fdbStatsFinds=fdbStatsFinds, cistRoot=cistRoot, cistRootPort=cistRootPort, fdbState=fdbState, lacpCurPortState=lacpCurPortState, cistInfo=cistInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Oper=layer2Oper, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
