...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTable=vlanNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCfg=mstCistCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfo=vlanInfo, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoState=portTeamInfoState, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsLookups=fdbStatsLookups, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRoot=cistRoot, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Stats=layer2Stats, fdbLearnedPort=fdbLearnedPort, stpInfoPortEdge=stpInfoPortEdge, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfo=cistInfo, lacpNewPortState=lacpNewPortState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbTable=fdbTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoStatus=vlanInfoStatus, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortRole=cistInfoPortRole, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortTable=stpInfoPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrPortMirr=mirrPortMirr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2=layer2, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbVlan=fdbVlan, vlanInfoName=vlanInfoName, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgState=portTeamCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Info=layer2Info, cistRootPort=cistRootPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfo=stpInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirroring=mirroring, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoRootCost=stpInfoRootCost, cistRegionalRoot=cistRegionalRoot, cistInfoPortLinkType=cistInfoPortLinkType, vlanMaxVlanID=vlanMaxVlanID, cistGeneralInfo=cistGeneralInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortState=lacpCurPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTable=stpInfoTable, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbRefSps=fdbRefSps, lacp=lacp, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgPorts=vlanCurCfgPorts, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, layer2Oper=layer2Oper, stpInfoIndex=stpInfoIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbState=fdbState, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgState=mstCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, mstCfg=mstCfg, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsHiwat=fdbStatsHiwat, cistBridgeHelloTime=cistBridgeHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, fdbSrcPort=fdbSrcPort, stpInfoHoldTime=stpInfoHoldTime, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortRole=stpInfoPortRole, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfo=lacpInfo, BridgeId=BridgeId, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbInfo=fdbInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpStats=stpStats, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgState=stgCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoRootPort=stpInfoRootPort, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortState=cistInfoPortState, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbEntry=fdbEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoId=vlanInfoId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbClear=fdbClear, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkgroup=trunkgroup, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlan=vlan, fdbStatsCurrent=fdbStatsCurrent)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2Configs=layer2Configs, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, fdbMacAddr=fdbMacAddr, stgCurCfgTable=stgCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortIndex=cistInfoPortIndex, stgCfg=stgCfg, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoLearn=vlanInfoLearn, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoTable=vlanInfoTable, fdbStats=fdbStats, cistRootPathCost=cistRootPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgTable=stgNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsOverflows=fdbStatsOverflows, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
