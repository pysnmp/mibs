...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgTable=stgNewCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookupFails=fdbStatsLookupFails, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfo=vlanInfo, portTeamNewCfgTable=portTeamNewCfgTable, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTable=stpInfoTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, BridgeId=BridgeId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortTableEntry=stpInfoPortTableEntry, mstGeneralCfg=mstGeneralCfg, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbTable=fdbTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsOverflows=fdbStatsOverflows, mstCistCfg=mstCistCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortState=cistInfoPortState, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlan=vlan, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortRole=cistInfoPortRole, layer2Stats=layer2Stats, stgCfg=stgCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfo=cistInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, mirroring=mirroring, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPriority=stgCurCfgPriority, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpInfo=lacpInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortState=stpInfoPortState, fdbStatsFinds=fdbStatsFinds, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgState=stgCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoStatus=vlanInfoStatus, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCfg=mstCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbLearnedPort=fdbLearnedPort, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortState=stgNewCfgPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, layer2Configs=layer2Configs, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgState=stgNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsDeletes=fdbStatsDeletes, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, mstNewCfgState=mstNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mirrPortMirr=mirrPortMirr, fdbClear=fdbClear, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTable=portTeamInfoTable, cistRoot=cistRoot, layer2Oper=layer2Oper, stpInfoPortIndex=stpInfoPortIndex, cistRootPort=cistRootPort, vlanInfoName=vlanInfoName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgState=mstCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, fdbInfo=fdbInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortTable=stpInfoPortTable, lacpCurPortState=lacpCurPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTopChanges=stpInfoTopChanges, portTeamInfo=portTeamInfo, stpInfoRootPort=stpInfoRootPort, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgState=vlanNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPriority=stgNewCfgPriority, cistRegionalRoot=cistRegionalRoot, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortTable=stgStatsPortTable, vlanInfoId=vlanInfoId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgStg=vlanNewCfgStg, PYSNMP_MODULE_ID=layer2, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpStats=stpStats, layer2Info=layer2Info, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCfg=portTeamCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoState=portTeamInfoState, fdbEntry=fdbEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, stpInfo=stpInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2=layer2, mstCurCfgStpMode=mstCurCfgStpMode, fdbStats=fdbStats, fdbRefSps=fdbRefSps, fdbState=fdbState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbVlan=fdbVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgTable=stgCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRootPathCost=cistRootPathCost, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortEdge=stpInfoPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortState=stgCurCfgPortState, lacpNewSystemPriority=lacpNewSystemPriority, trunkgroup=trunkgroup, lacp=lacp)
