...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkgroup=trunkgroup, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mirrPortMirr=mirrPortMirr, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewPortState=lacpNewPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbVlan=fdbVlan, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortPathCost=stpInfoPortPathCost, fdbRefSps=fdbRefSps, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfo=stpInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbClear=fdbClear, vlanInfo=vlanInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, BridgeId=BridgeId, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortMoved=lacpInfoPortMoved, lacp=lacp, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgState=vlanCurCfgState, fdbStatsLookups=fdbStatsLookups, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, fdbInfo=fdbInfo, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortTable=stgStatsPortTable, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortIndex=stpInfoPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTable=portTeamInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbState=fdbState, layer2Configs=layer2Configs, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStats=fdbStats, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgState=stgCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstNewCfgState=mstNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, stpStats=stpStats, vlanInfoTable=vlanInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCfg=mstCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, mirroring=mirroring, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRootPathCost=cistRootPathCost, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTable=stpInfoTable, portTeamInfo=portTeamInfo, mstGeneralCfg=mstGeneralCfg, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortRole=stpInfoPortRole, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortTable=cistInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, layer2Stats=layer2Stats, fdbEntry=fdbEntry, portTeamCfg=portTeamCfg, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgState=stgNewCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoName=vlanInfoName, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, fdbTable=fdbTable, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortEdge=stpInfoPortEdge, cistRoot=cistRoot, cistGeneralInfo=cistGeneralInfo, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalPathCost=cistRegionalPathCost, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortState=lacpCurPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistRootPort=cistRootPort, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, vlan=vlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Oper=layer2Oper, cistInfoPortRole=cistInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoState=portTeamInfoState, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoMaxAge=stpInfoMaxAge, layer2Info=layer2Info, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCfg=mstCistCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, stgStatsStpIndex=stgStatsStpIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfo=lacpInfo, vlanInfoId=vlanInfoId, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortIndex=stgNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, stpInfoRootCost=stpInfoRootCost, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2=layer2, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbMacAddr=fdbMacAddr, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfo=cistInfo, stgCfg=stgCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
