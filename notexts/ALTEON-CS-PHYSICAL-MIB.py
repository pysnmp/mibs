...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRoot=cistRoot, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoState=portTeamInfoState, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTable=stpInfoTable, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, mirrPortMirr=mirrPortMirr, stgNewCfgTable=stgNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlan=vlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbClear=fdbClear, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCfg=stgCfg, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, layer2Oper=layer2Oper, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, vlanMaxEnt=vlanMaxEnt, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, trunkgroup=trunkgroup, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, BridgeId=BridgeId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfo=portTeamInfo, fdbStatsLookups=fdbStatsLookups, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortPriority=cistInfoPortPriority, stpInfoIndex=stpInfoIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortState=cistInfoPortState, stgCurCfgTable=stgCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgPorts=vlanCurCfgPorts, layer2Stats=layer2Stats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, stpInfoRootPort=stpInfoRootPort, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbLearnedPort=fdbLearnedPort, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, vlanInfoId=vlanInfoId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoIndex=portTeamInfoIndex, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortState=lacpCurPortState, mstCfg=mstCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbMacAddr=fdbMacAddr, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgStg=vlanCurCfgStg, mstGeneralCfg=mstGeneralCfg, lacpInfo=lacpInfo, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortState=stpInfoPortState, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortTable=stgStatsPortTable, layer2=layer2, fdbStats=fdbStats, stgNewCfgState=stgNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoName=vlanInfoName, mirroring=mirroring, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbEntry=fdbEntry, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgState=vlanNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, PYSNMP_MODULE_ID=layer2, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTable=portTeamInfoTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgIndex=stgCurCfgIndex, stpInfo=stpInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpStats=stpStats, lacp=lacp, cistGeneralInfo=cistGeneralInfo, portTeamCfg=portTeamCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTable=stpInfoPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfo=vlanInfo, layer2Info=layer2Info, cistRootPathCost=cistRootPathCost, cistInfo=cistInfo, layer2Configs=layer2Configs, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCfg=mstCistCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbInfo=fdbInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbRefSps=fdbRefSps, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgState=mstNewCfgState, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbSrcPort=fdbSrcPort, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRootPort=cistRootPort, mstCistBridgeCfg=mstCistBridgeCfg, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbState=fdbState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbTable=fdbTable, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgState=mstCurCfgState, fdbStatsFinds=fdbStatsFinds, cistInfoPortTable=cistInfoPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPriority=stgNewCfgPriority)
