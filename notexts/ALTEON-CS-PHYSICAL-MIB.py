...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCurrent=fdbStatsCurrent, fdbLearnedPort=fdbLearnedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgState=mstNewCfgState, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoTable=vlanInfoTable, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgState=mstCurCfgState, cistRoot=cistRoot, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTable=portTeamInfoTable, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortTable=stpInfoPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgTable=stgCurCfgTable, layer2Info=layer2Info, cistInfoPortState=cistInfoPortState, fdbTable=fdbTable, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCfg=stgCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Oper=layer2Oper, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStats=fdbStats, vlanInfoStatus=vlanInfoStatus, layer2Stats=layer2Stats, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacp=lacp, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfo=vlanInfo, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoState=portTeamInfoState, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewSystemPriority=lacpNewSystemPriority, BridgeId=BridgeId, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2=layer2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCfg=portTeamCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, fdbClear=fdbClear, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfo=lacpInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRegionalRoot=cistRegionalRoot, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkgroup=trunkgroup, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortPriority=stgNewCfgPortPriority, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistGeneralInfo=cistGeneralInfo, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgIndex=stgCurCfgIndex, stpStats=stpStats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoRootCost=stpInfoRootCost, stpInfoPortState=stpInfoPortState, stgCurCfgState=stgCurCfgState, fdbState=fdbState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoName=vlanInfoName, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgState=portTeamNewCfgState, fdbVlan=fdbVlan, vlanInfoPorts=vlanInfoPorts, cistRootPort=cistRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCfg=mstCistCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsFinds=fdbStatsFinds, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Configs=layer2Configs, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamInfo=portTeamInfo, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbEntry=fdbEntry, lacpInfoPortTable=lacpInfoPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, fdbRefSps=fdbRefSps, fdbMacAddr=fdbMacAddr, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbInfo=fdbInfo, lacpCurPortState=lacpCurPortState, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoPortsState=portTeamInfoPortsState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCreates=fdbStatsCreates, mstCfg=mstCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsHiwat=fdbStatsHiwat)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, stpInfoTable=stpInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgAgingTime=stgNewCfgAgingTime, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlan=vlan, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoIndex=stpInfoIndex, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortIndex=lacpInfoPortIndex, stpInfo=stpInfo, mirroring=mirroring, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortTable=cistInfoPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgTable=vlanNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg)
