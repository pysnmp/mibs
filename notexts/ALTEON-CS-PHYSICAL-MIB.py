...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfo=vlanInfo, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2Info=layer2Info, fdbMacAddr=fdbMacAddr, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStats=fdbStats, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsLookups=fdbStatsLookups, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoHoldTime=stpInfoHoldTime, lacpCurSystemPriority=lacpCurSystemPriority, mstCfg=mstCfg, stpInfoTable=stpInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgIndex=stgCurCfgIndex, cistRootPort=cistRootPort, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgState=stgNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpStats=stpStats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbInfo=fdbInfo, fdbState=fdbState, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsOverflows=fdbStatsOverflows, stpInfoTableEntry=stpInfoTableEntry, fdbVlan=fdbVlan, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoRootPort=stpInfoRootPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortState=lacpCurPortState, layer2=layer2, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTable=portTeamInfoTable, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCfg=mstCistCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortEdge=stgCurCfgPortEdge, lacp=lacp, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2Configs=layer2Configs, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortTable=lacpInfoPortTable, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoRootCost=stpInfoRootCost, stgStatsPortTable=stgStatsPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbLearnedPort=fdbLearnedPort, PYSNMP_MODULE_ID=layer2, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, cistRegionalPathCost=cistRegionalPathCost, layer2Oper=layer2Oper, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsDeletes=fdbStatsDeletes, cistRoot=cistRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistRegionalRoot=cistRegionalRoot, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoTable=vlanInfoTable, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, vlanInfoName=vlanInfoName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortEdge=stpInfoPortEdge, vlanInfoId=vlanInfoId, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, BridgeId=BridgeId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoState=portTeamInfoState, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortRole=stpInfoPortRole, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgTable=stgNewCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfo=portTeamInfo, stgCfg=stgCfg, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortState=lacpNewPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgTable=stgCurCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkgroup=trunkgroup, lacpInfo=lacpInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, mirrPortMirr=mirrPortMirr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, cistGeneralInfo=cistGeneralInfo, layer2Stats=layer2Stats, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, vlan=vlan, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoLearn=vlanInfoLearn, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgState=vlanNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mirroring=mirroring, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfo=cistInfo, mstNewCfgState=mstNewCfgState, fdbEntry=fdbEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoMaxAge=stpInfoMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbClear=fdbClear, fdbTable=fdbTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortState=stpInfoPortState, fdbRefSps=fdbRefSps, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfo=stpInfo, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, fdbStatsCreates=fdbStatsCreates, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgState=vlanCurCfgState, fdbStatsFinds=fdbStatsFinds, mstCurCfgState=mstCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortState=cistInfoPortState, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort)
