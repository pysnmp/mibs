...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbRefSps=fdbRefSps, portTeamInfoState=portTeamInfoState, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfo=stpInfo, cistGeneralInfo=cistGeneralInfo, fdbClear=fdbClear, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlan=vlan, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfo=portTeamInfo, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortRole=stpInfoPortRole, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistRoot=cistRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Info=layer2Info, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortLinkType=cistInfoPortLinkType, fdbStats=fdbStats, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortTable=stpInfoPortTable, cistInfoPortState=cistInfoPortState, fdbInfo=fdbInfo, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortIndex=stpInfoPortIndex, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsFindFails=fdbStatsFindFails, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCfg=mstCistCfg, mirrPortMirr=mirrPortMirr, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgAddPort=vlanNewCfgAddPort, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbEntry=fdbEntry, stpInfoIndex=stpInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTable=stpInfoTable, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgTable=stgCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfo=lacpInfo, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, portTeamCurCfgState=portTeamCurCfgState, vlanInfoName=vlanInfoName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, lacpInfoPortTable=lacpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, layer2=layer2, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTable=portTeamNewCfgTable, PYSNMP_MODULE_ID=layer2, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoPorts=portTeamInfoPorts, vlanInfoPorts=vlanInfoPorts, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkgroup=trunkgroup, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoRootCost=stpInfoRootCost, lacpInfoPortNtt=lacpInfoPortNtt, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTable=portTeamInfoTable, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortState=lacpCurPortState, stgNewCfgIndex=stgNewCfgIndex, vlanInfoLearn=vlanInfoLearn, cistInfoPortTable=cistInfoPortTable, cistInfoPortPriority=cistInfoPortPriority, fdbTable=fdbTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortIndex=stgStatsPortIndex, stpInfoRootPort=stpInfoRootPort, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortState=lacpNewPortState, stgNewCfgState=stgNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTableEntry=stpInfoTableEntry, vlanInfoStatus=vlanInfoStatus, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoId=vlanInfoId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirroring=mirroring, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, cistInfo=cistInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbSrcTrunk=fdbSrcTrunk, fdbStatsCreates=fdbStatsCreates, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTable=vlanInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCfg=portTeamCfg, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, lacp=lacp, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsDeletes=fdbStatsDeletes, fdbVlan=fdbVlan, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCfg=mstCfg, stgStatsPortTable=stgStatsPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortMoved=lacpInfoPortMoved)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Configs=layer2Configs, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgState=mstCurCfgState, cistRegionalRoot=cistRegionalRoot, vlanInfo=vlanInfo, vlanNewCfgState=vlanNewCfgState, stgCfg=stgCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpStats=stpStats, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortState=stgNewCfgPortState, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortRole=cistInfoPortRole, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgStg=vlanNewCfgStg, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, BridgeId=BridgeId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortLink=stgNewCfgPortLink, layer2Stats=layer2Stats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoHoldTime=stpInfoHoldTime)
