...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, mirroring=mirroring, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, stpInfoForwardDelay=stpInfoForwardDelay, cistRootPort=cistRootPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoTable=vlanInfoTable, fdbStatsFinds=fdbStatsFinds, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortTable=stpInfoPortTable, fdbStats=fdbStats, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCfg=mstCistCfg, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Info=layer2Info, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortState=lacpCurPortState, fdbStatsLookups=fdbStatsLookups, fdbRefSps=fdbRefSps, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortTable=lacpInfoPortTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortPriority=cistInfoPortPriority, vlanMaxEnt=vlanMaxEnt, fdbSrcPort=fdbSrcPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortIndex=cistInfoPortIndex, stgCfg=stgCfg, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkgroup=trunkgroup, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfo=cistInfo, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanInfoPorts=vlanInfoPorts, cistRoot=cistRoot, stgNewCfgPortTable=stgNewCfgPortTable, fdbEntry=fdbEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortState=lacpNewPortState, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbInfo=fdbInfo, vlanInfoId=vlanInfoId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoStatus=vlanInfoStatus, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Configs=layer2Configs, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsStpIndex=stgStatsStpIndex, portTeamInfoIndex=portTeamInfoIndex, layer2Oper=layer2Oper, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfo=lacpInfo, layer2=layer2, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, cistRootPathCost=cistRootPathCost, mstCfg=mstCfg, stpInfoPortState=stpInfoPortState, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoIndex=stpInfoIndex, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbClear=fdbClear, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, cistGeneralInfo=cistGeneralInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortPathCost=stpInfoPortPathCost, layer2Stats=layer2Stats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoRootCost=stpInfoRootCost, cistInfoPortPathCost=cistInfoPortPathCost, PYSNMP_MODULE_ID=layer2, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoState=portTeamInfoState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortTable=cistInfoPortTable, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortState=cistInfoPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfo=vlanInfo, stpStats=stpStats, stgNewCfgTable=stgNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbMacAddr=fdbMacAddr, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbState=fdbState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, lacp=lacp, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgTable=stgCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortLinkType=cistInfoPortLinkType, BridgeId=BridgeId, stpInfoTable=stpInfoTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstGeneralCfg=mstGeneralCfg, fdbStatsCreates=fdbStatsCreates, stpInfo=stpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCfg=portTeamCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgState=vlanCurCfgState, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgState=stgCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRegionalRoot=cistRegionalRoot, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTopChanges=stpInfoTopChanges, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTable=portTeamInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoName=vlanInfoName, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbTable=fdbTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, fdbVlan=fdbVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, vlan=vlan, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfo=portTeamInfo, lacpInfoPortIndex=lacpInfoPortIndex)
