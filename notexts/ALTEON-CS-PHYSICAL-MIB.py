...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoName=vlanInfoName, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpCurPortCfgTable=lacpCurPortCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Oper=layer2Oper, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoId=vlanInfoId, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortState=stpInfoPortState, stgStatsPortTable=stgStatsPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortTable=cistInfoPortTable, fdbStatsLookups=fdbStatsLookups, portTeamInfoPorts=portTeamInfoPorts, cistGeneralInfo=cistGeneralInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoIndex=stpInfoIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbMacAddr=fdbMacAddr, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Configs=layer2Configs, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfo=cistInfo, vlan=vlan, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortRole=stpInfoPortRole, mirrPortMirr=mirrPortMirr, cistInfoPortIndex=cistInfoPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, fdbEntry=fdbEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfo=stpInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTable=portTeamInfoTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCfg=mstCfg, fdbSrcPort=fdbSrcPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbState=fdbState, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbTable=fdbTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRoot=cistRoot, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortState=lacpNewPortState, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbVlan=fdbVlan, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortPriority=cistInfoPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, mstGeneralCfg=mstGeneralCfg, mirroring=mirroring, vlanInfo=vlanInfo, vlanCurCfgTable=vlanCurCfgTable, portTeamCfg=portTeamCfg, layer2Stats=layer2Stats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStats=fdbStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfo=lacpInfo, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFinds=fdbStatsFinds, vlanCurCfgState=vlanCurCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, lacp=lacp, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoTable=stpInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortTable=lacpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCfg=mstCistCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, BridgeId=BridgeId, portTeamInfo=portTeamInfo, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortIndex=stpInfoPortIndex, stpInfoHoldTime=stpInfoHoldTime, fdbInfo=fdbInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoMaxAge=stpInfoMaxAge, stpInfoRootCost=stpInfoRootCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgState=stgNewCfgState, portTeamCurCfgState=portTeamCurCfgState, fdbLearnedPort=fdbLearnedPort, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgState=vlanNewCfgState, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, stgCurCfgState=stgCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, stpStats=stpStats, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgState=mstCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCfg=stgCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoState=portTeamInfoState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanMaxEnt=vlanMaxEnt, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbRefSps=fdbRefSps, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPathCost=cistRootPathCost, cistRootPort=cistRootPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkgroup=trunkgroup, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoRootPort=stpInfoRootPort, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoStatus=vlanInfoStatus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgState=mstNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortRole=cistInfoPortRole, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, layer2Info=layer2Info, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgIndex=stgCurCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
