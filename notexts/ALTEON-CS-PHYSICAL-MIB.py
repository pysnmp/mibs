...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", layer2Configs=layer2Configs, lacp=lacp, mstCurCfgStpMode=mstCurCfgStpMode, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, stgStatsPortTable=stgStatsPortTable, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, trunkgroup=trunkgroup, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, mirroring=mirroring, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortTable=stgCurCfgPortTable, stgCfg=stgCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbSrcPort=fdbSrcPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgIndex=stgCurCfgIndex, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortState=stpInfoPortState, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgDelete=vlanNewCfgDelete, fdbTable=fdbTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortState=lacpCurPortState, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoRootPort=stpInfoRootPort, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlan=vlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPriority=stgCurCfgPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfo=vlanInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsLookups=fdbStatsLookups, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsCreates=fdbStatsCreates, cistRootPort=cistRootPort, vlanNewCfgStg=vlanNewCfgStg, lacpInfo=lacpInfo, fdbInfo=fdbInfo, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoPorts=vlanInfoPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoId=vlanInfoId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoRootCost=stpInfoRootCost, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoLearn=vlanInfoLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortState=cistInfoPortState, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, layer2Info=layer2Info, cistRootPathCost=cistRootPathCost, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Stats=layer2Stats, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, fdbRefSps=fdbRefSps, stpInfoTable=stpInfoTable, stpStats=stpStats, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoStatus=vlanInfoStatus, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, fdbState=fdbState, BridgeId=BridgeId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfo=cistInfo, vlanInfoTable=vlanInfoTable, fdbClear=fdbClear, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2=layer2, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsCurrent=fdbStatsCurrent, stpInfo=stpInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCfg=mstCfg, portTeamInfoIndex=portTeamInfoIndex, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgState=stgCurCfgState, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalRoot=cistRegionalRoot, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbLearnedPort=fdbLearnedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoIndex=stpInfoIndex, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortTable=stpInfoPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsDeletes=fdbStatsDeletes, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStats=fdbStats, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, fdbVlan=fdbVlan, lacpCurSystemPriority=lacpCurSystemPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoName=vlanInfoName, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Oper=layer2Oper, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoHoldTime=stpInfoHoldTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRoot=cistRoot, fdbEntry=fdbEntry, stgNewCfgState=stgNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCfg=mstCistCfg, fdbStatsFinds=fdbStatsFinds, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgState=mstNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoState=portTeamInfoState, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgState=mstCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCfg=portTeamCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts)
