...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgState=portTeamNewCfgState, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Info=layer2Info, vlanInfoName=vlanInfoName, mstNewCfgState=mstNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfo=cistInfo, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbTable=fdbTable, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTableEntry=vlanInfoTableEntry, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, cistGeneralInfo=cistGeneralInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgState=vlanNewCfgState, cistRootPathCost=cistRootPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCfg=mstCistCfg, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoState=portTeamInfoState, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortState=cistInfoPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, trunkgroup=trunkgroup, stgCurCfgState=stgCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, layer2Configs=layer2Configs, BridgeId=BridgeId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamInfoPorts=portTeamInfoPorts, mirroring=mirroring, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCfg=portTeamCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStats=fdbStats, PYSNMP_MODULE_ID=layer2, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbVlan=fdbVlan, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortState=stgCurCfgPortState, stpInfo=stpInfo, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbState=fdbState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCfg=mstCfg, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsLookups=fdbStatsLookups, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoIndex=stpInfoIndex, stpInfoPortIndex=stpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRoot=cistRoot, vlanInfoTable=vlanInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, cistBridgeHelloTime=cistBridgeHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortState=lacpCurPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortState=stpInfoPortState, layer2Oper=layer2Oper, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRootPort=cistRootPort, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacp=lacp, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoRootCost=stpInfoRootCost, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfo=lacpInfo, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2=layer2, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortRole=cistInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbEntry=fdbEntry, stpStats=stpStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbInfo=fdbInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTableEntry=stpInfoPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Stats=layer2Stats, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsCreates=fdbStatsCreates, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTable=stpInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfo=vlanInfo, lacpNewPortState=lacpNewPortState, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, vlan=vlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgTable=stgNewCfgTable, vlanInfoStatus=vlanInfoStatus, vlanInfoId=vlanInfoId, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgState=stgNewCfgState, cistInfoPortTable=cistInfoPortTable)
