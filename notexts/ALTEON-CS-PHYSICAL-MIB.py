...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, layer2Info=layer2Info, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stpInfo=stpInfo, vlan=vlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbSrcPort=fdbSrcPort, layer2=layer2, vlanInfoTable=vlanInfoTable, vlanCurCfgState=vlanCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgState=mstCurCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgState=stgCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbState=fdbState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortPriority=cistInfoPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanMaxEnt=vlanMaxEnt, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbClear=fdbClear, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootCost=stpInfoRootCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrPortMirr=mirrPortMirr, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbEntry=fdbEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkgroup=trunkgroup, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRegionalRoot=cistRegionalRoot, mirroring=mirroring, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfo=cistInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortState=stpInfoPortState, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoId=vlanInfoId, portTeamCfg=portTeamCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewPortState=lacpNewPortState, cistRoot=cistRoot, vlanInfoName=vlanInfoName, mstCfg=mstCfg, cistInfoPortTable=cistInfoPortTable, fdbVlan=fdbVlan, cistInfoPortRole=cistInfoPortRole, layer2Stats=layer2Stats, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPort=cistRootPort, BridgeId=BridgeId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoRootPort=stpInfoRootPort, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortRole=stpInfoPortRole, stpStats=stpStats, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoState=portTeamInfoState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgTable=stgCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPathCost=cistRootPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgState=mstNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoPorts=vlanInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, fdbRefSps=fdbRefSps, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStats=fdbStats, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortPriority=stgCurCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoJumbo=vlanInfoJumbo, stpInfoTable=stpInfoTable, PYSNMP_MODULE_ID=layer2, stpInfoPortLinkType=stpInfoPortLinkType, fdbTable=fdbTable, stgStatsPortTable=stgStatsPortTable, lacpInfo=lacpInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, stpInfoTableEntry=stpInfoTableEntry, stgCfg=stgCfg, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgState=stgNewCfgState, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfo=vlanInfo, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsStpIndex=stgStatsStpIndex, mstCistCfg=mstCistCfg, cistGeneralInfo=cistGeneralInfo, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, fdbMacAddr=fdbMacAddr, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgState=vlanNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoIndex=stpInfoIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgTable=stgNewCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, lacp=lacp, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfo=portTeamInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Configs=layer2Configs)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbInfo=fdbInfo, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbLearnedPort=fdbLearnedPort, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortState=cistInfoPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortEdge=stgNewCfgPortEdge)
