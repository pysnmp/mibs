...
Integer32, Counter32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter64", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortLink=stgCurCfgPortLink, cistRootPort=cistRootPort, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpStats=stpStats, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, layer2Info=layer2Info, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCfg=mstCistCfg, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoPorts=portTeamInfoPorts, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistInfo=cistInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgState=vlanCurCfgState, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFinds=fdbStatsFinds, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortRole=cistInfoPortRole, vlanInfoTable=vlanInfoTable, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPathCost=cistRootPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStats=fdbStats, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCfg=stgCfg, fdbTable=fdbTable, stpInfoHelloTime=stpInfoHelloTime, trunkgroup=trunkgroup, fdbMacAddr=fdbMacAddr, stpInfoRootCost=stpInfoRootCost, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoLearn=vlanInfoLearn, cistInfoPortIndex=cistInfoPortIndex, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbRefSps=fdbRefSps, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgState=stgNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgTable=stgCurCfgTable, vlanInfoId=vlanInfoId, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgStg=vlanNewCfgStg, portTeamCfg=portTeamCfg, layer2Configs=layer2Configs, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlan=vlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortState=cistInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, PYSNMP_MODULE_ID=layer2, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mirrPortMirr=mirrPortMirr, stpInfoPortState=stpInfoPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsLookups=fdbStatsLookups, cistInfoPortPriority=cistInfoPortPriority, mirroring=mirroring, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortState=lacpNewPortState, layer2Stats=layer2Stats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistBridgeMaxAge=cistBridgeMaxAge, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, mstCurCfgState=mstCurCfgState, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRoot=cistRoot, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgState=trunkGroupNewCfgState, lacp=lacp, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoState=portTeamInfoState, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgState=stgCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbEntry=fdbEntry, fdbStatsCreates=fdbStatsCreates, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoName=vlanInfoName, stpInfo=stpInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbClear=fdbClear, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortTable=stgNewCfgPortTable, fdbVlan=fdbVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoRootPort=stpInfoRootPort, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortIndex=stpInfoPortIndex, stpInfoTable=stpInfoTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbInfo=fdbInfo, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortTable=stgStatsPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfo=lacpInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2=layer2, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortState=lacpCurPortState, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortIndex=stgStatsPortIndex, mstNewCfgState=mstNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoIndex=stpInfoIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTable=portTeamInfoTable, fdbState=fdbState, cistInfoPortTable=cistInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, fdbSrcPort=fdbSrcPort, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, cistRegionalRoot=cistRegionalRoot, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgTable=vlanCurCfgTable, vlanInfo=vlanInfo, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfo=portTeamInfo)
