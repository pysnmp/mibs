...
Bits, Integer32, ObjectIdentity, Unsigned32, IpAddress, Gauge32, ModuleIdentity, NotificationType, Counter64, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ObjectIdentity", "Unsigned32", "IpAddress", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbEntry=fdbEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookups=fdbStatsLookups, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgTable=stgCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbState=fdbState, BridgeId=BridgeId, fdbSrcTrunk=fdbSrcTrunk, fdbInfo=fdbInfo, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfo=portTeamInfo, portTeamInfoTrunks=portTeamInfoTrunks, cistRootPort=cistRootPort, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortPathCost=stpInfoPortPathCost, cistGeneralInfo=cistGeneralInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoTable=vlanInfoTable, cistInfo=cistInfo, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgState=vlanNewCfgState, trunkgroup=trunkgroup, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Configs=layer2Configs, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoHoldTime=stpInfoHoldTime, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortState=cistInfoPortState, stpInfo=stpInfo, mstCistCfg=mstCistCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsOverflows=fdbStatsOverflows, stpInfoRootPort=stpInfoRootPort, stpInfoPortRole=stpInfoPortRole, stpInfoPortTable=stpInfoPortTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortIndex=stpInfoPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRoot=cistRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoTable=stpInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoState=portTeamInfoState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsFindFails=fdbStatsFindFails, fdbSrcPort=fdbSrcPort, cistInfoPortRole=cistInfoPortRole, portTeamInfoTable=portTeamInfoTable, cistRegionalRoot=cistRegionalRoot, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfo=vlanInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2Info=layer2Info, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbTable=fdbTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbRefSps=fdbRefSps, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCfg=mstCfg, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsFinds=fdbStatsFinds, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCurCfgState=mstCurCfgState, mirrPortMirr=mirrPortMirr, fdbLearnedPort=fdbLearnedPort, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacp=lacp, mstGeneralCfg=mstGeneralCfg, lacpInfo=lacpInfo, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbClear=fdbClear, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirroring=mirroring, stgCfg=stgCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgState=stgCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCfg=portTeamCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Oper=layer2Oper, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoName=vlanInfoName, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsCurrent=fdbStatsCurrent, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortState=lacpCurPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbMacAddr=fdbMacAddr, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgTable=stgNewCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoIndex=stpInfoIndex, vlanInfoId=vlanInfoId, fdbVlan=fdbVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Stats=layer2Stats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoPorts=vlanInfoPorts, layer2=layer2, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortTable=cistInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgDelete=vlanNewCfgDelete, stpStats=stpStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortMoved=lacpInfoPortMoved, vlan=vlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry)
