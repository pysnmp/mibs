...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTable=portTeamNewCfgTable, mstGeneralCfg=mstGeneralCfg, cistGeneralInfo=cistGeneralInfo, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalRoot=cistRegionalRoot, PYSNMP_MODULE_ID=layer2, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortRole=cistInfoPortRole, lacpCurPortState=lacpCurPortState, vlanInfoId=vlanInfoId, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpStats=stpStats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsOverflows=fdbStatsOverflows, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbSrcTrunk=fdbSrcTrunk, vlanMaxVlanID=vlanMaxVlanID, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, BridgeId=BridgeId, stgNewCfgPriority=stgNewCfgPriority, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRoot=cistRoot, mstCurCfgState=mstCurCfgState, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgAddVlan=stgNewCfgAddVlan, layer2Stats=layer2Stats, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirrPortMirr=mirrPortMirr, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, portTeamCfg=portTeamCfg, vlanCurCfgStg=vlanCurCfgStg, stgStatsStpIndex=stgStatsStpIndex, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Info=layer2Info, fdbEntry=fdbEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortIndex=stgStatsPortIndex, stpInfoHelloTime=stpInfoHelloTime, cistRootPort=cistRootPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCfg=mstCistCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, fdbStats=fdbStats, mstNewCfgState=mstNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoStatus=vlanInfoStatus, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbInfo=fdbInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkgroup=trunkgroup, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCfg=mstCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortState=cistInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTable=stpInfoTable, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPathCost=cistRootPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacp=lacp, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoName=vlanInfoName, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2=layer2, fdbTable=fdbTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbClear=fdbClear, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoTable=vlanInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfo=portTeamInfo, vlan=vlan, mirroring=mirroring, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortPriority=cistInfoPortPriority, layer2Oper=layer2Oper, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgState=stgNewCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortRole=stpInfoPortRole, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbVlan=fdbVlan, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsCreates=fdbStatsCreates, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Configs=layer2Configs, lacpInfo=lacpInfo, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortState=lacpNewPortState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfo=cistInfo, portTeamCurCfgState=portTeamCurCfgState, cistBridgeHelloTime=cistBridgeHelloTime, stgCfg=stgCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbMacAddr=fdbMacAddr, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortTableEntry=stgStatsPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, vlanInfo=vlanInfo, stpInfoMaxAge=stpInfoMaxAge, fdbRefSps=fdbRefSps, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgStg=vlanNewCfgStg, fdbState=fdbState, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfo=stpInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey)
