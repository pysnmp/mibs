...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortTable=stpInfoPortTable, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoStatus=vlanInfoStatus, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, lacp=lacp, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCfg=mstCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootCost=stpInfoRootCost, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfo=stpInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpNewPortState=lacpNewPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCfg=portTeamCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbInfo=fdbInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoMaxAge=stpInfoMaxAge, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRegionalRoot=cistRegionalRoot, fdbStatsDeletes=fdbStatsDeletes, fdbMacAddr=fdbMacAddr, stpInfoIndex=stpInfoIndex, layer2Stats=layer2Stats, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbLearnedPort=fdbLearnedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgStpMode=mstNewCfgStpMode, stgCfg=stgCfg, stpInfoPortEdge=stpInfoPortEdge, layer2Configs=layer2Configs, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbClear=fdbClear, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfo=vlanInfo, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStats=fdbStats, lacpInfo=lacpInfo, cistRootPathCost=cistRootPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanMaxVlanID=vlanMaxVlanID, stgStatsStpIndex=stgStatsStpIndex, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsFinds=fdbStatsFinds, mirroring=mirroring, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortMoved=lacpInfoPortMoved, BridgeId=BridgeId, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoPorts=vlanInfoPorts, stpStats=stpStats, mstNewCfgRegionName=mstNewCfgRegionName, fdbRefSps=fdbRefSps, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, fdbTable=fdbTable, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTable=stgNewCfgTable, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgState=mstCurCfgState, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, fdbState=fdbState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortPathCost=cistInfoPortPathCost, fdbEntry=fdbEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkgroup=trunkgroup, vlanCurCfgState=vlanCurCfgState, lacpInfoPortTable=lacpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTable=portTeamInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlan=vlan, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoName=vlanInfoName, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortTable=stgStatsPortTable, stpInfoHelloTime=stpInfoHelloTime, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, cistInfo=cistInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortState=lacpCurPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCfg=mstCistCfg, mstNewCfgState=mstNewCfgState, fdbSrcPort=fdbSrcPort, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoState=portTeamInfoState, stpInfoTable=stpInfoTable, mirrPortMirr=mirrPortMirr, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortState=cistInfoPortState, stgCurCfgPortTable=stgCurCfgPortTable, cistGeneralInfo=cistGeneralInfo, stpInfoRootPort=stpInfoRootPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfo=portTeamInfo, fdbVlan=fdbVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortState=stpInfoPortState, stgCurCfgState=stgCurCfgState, layer2Info=layer2Info, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, cistRoot=cistRoot, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgIndex=stgCurCfgIndex, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgTable=stgCurCfgTable, cistInfoPortTable=cistInfoPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgDelete=vlanNewCfgDelete)
