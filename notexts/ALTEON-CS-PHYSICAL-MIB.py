...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCfg=mstCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcPort=fdbSrcPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfo=lacpInfo, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortTable=cistInfoPortTable, vlanNewCfgState=vlanNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbTable=fdbTable, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoState=portTeamInfoState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2Info=layer2Info, fdbVlan=fdbVlan, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortState=stpInfoPortState, portTeamInfoPortsState=portTeamInfoPortsState, layer2=layer2, mirrPortMirr=mirrPortMirr, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRoot=cistRoot, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCfg=mstCistCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoIndex=stpInfoIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbMacAddr=fdbMacAddr, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoHelloTime=stpInfoHelloTime, fdbStatsFinds=fdbStatsFinds, stgNewCfgTable=stgNewCfgTable, cistRootPort=cistRootPort, mirroring=mirroring, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, fdbStats=fdbStats, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Stats=layer2Stats, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoStatus=vlanInfoStatus, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCfg=stgCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortState=stgNewCfgPortState, fdbStatsLookups=fdbStatsLookups, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, PYSNMP_MODULE_ID=layer2, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacp=lacp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbClear=fdbClear, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoRootPort=stpInfoRootPort, vlanInfoName=vlanInfoName, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgIndex=stgNewCfgIndex, fdbRefSps=fdbRefSps, vlanInfoLearn=vlanInfoLearn, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfo=stpInfo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgState=stgNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Configs=layer2Configs, stpInfoRootCost=stpInfoRootCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbState=fdbState, stpInfoPortEdge=stpInfoPortEdge, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgState=trunkGroupNewCfgState, BridgeId=BridgeId, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfoPorts=vlanInfoPorts, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoTable=stpInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfo=vlanInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Oper=layer2Oper, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanMaxEnt=vlanMaxEnt, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortTable=stpInfoPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCfg=portTeamCfg, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfo=cistInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, vlan=vlan, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgStpMode=mstNewCfgStpMode, cistRootPathCost=cistRootPathCost, stgCurCfgTable=stgCurCfgTable, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbEntry=fdbEntry, cistInfoPortLinkType=cistInfoPortLinkType, trunkgroup=trunkgroup, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, mstCurCfgState=mstCurCfgState, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortIndex=stgStatsPortIndex, cistRegionalRoot=cistRegionalRoot, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgState=mstNewCfgState, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpStats=stpStats, portTeamInfo=portTeamInfo, stgCurCfgState=stgCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbInfo=fdbInfo, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortTable=stgNewCfgPortTable)
