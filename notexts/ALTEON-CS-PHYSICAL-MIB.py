...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgState=mstNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStats=fdbStats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2=layer2, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoMaxAge=stpInfoMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoPorts=vlanInfoPorts, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstGeneralCfg=mstGeneralCfg, vlanCurCfgStg=vlanCurCfgStg, stpInfoTopChanges=stpInfoTopChanges, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortPathCost=stpInfoPortPathCost, cistRegionalRoot=cistRegionalRoot, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Configs=layer2Configs, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoName=vlanInfoName, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbState=fdbState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbClear=fdbClear, vlanNewCfgLearn=vlanNewCfgLearn, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, cistGeneralInfo=cistGeneralInfo, fdbStatsFinds=fdbStatsFinds, fdbStatsDeletes=fdbStatsDeletes, mstCistCfg=mstCistCfg, BridgeId=BridgeId, lacpCurPortState=lacpCurPortState, stgCurCfgState=stgCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTable=stpInfoTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsLookups=fdbStatsLookups, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, fdbTable=fdbTable, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCfg=portTeamCfg, portTeamInfo=portTeamInfo, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortState=lacpNewPortState, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfo=vlanInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoJumbo=vlanInfoJumbo, layer2Oper=layer2Oper, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, cistInfoPortState=cistInfoPortState, stpInfoIndex=stpInfoIndex, vlanMaxVlanID=vlanMaxVlanID, lacpInfoPortSelected=lacpInfoPortSelected, mirrPortMirr=mirrPortMirr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortLink=stgCurCfgPortLink, stgCfg=stgCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgState=mstCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgTable=stgNewCfgTable, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortTable=lacpInfoPortTable, cistRegionalPathCost=cistRegionalPathCost, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCfg=mstCfg, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTable=portTeamInfoTable, stpInfoPortRole=stpInfoPortRole, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpStats=stpStats, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortState=stpInfoPortState, cistInfoPortPriority=cistInfoPortPriority, fdbVlan=fdbVlan, fdbInfo=fdbInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortTable=stgStatsPortTable, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgTable=stgCurCfgTable, vlanNewCfgState=vlanNewCfgState, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, cistInfo=cistInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, vlanInfoId=vlanInfoId, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbLearnedPort=fdbLearnedPort, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgTable=trunkGroupCurCfgTable, PYSNMP_MODULE_ID=layer2, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbRefSps=fdbRefSps, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPriority=stgCurCfgPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2Stats=layer2Stats, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbEntry=fdbEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Info=layer2Info, vlan=vlan, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, cistRoot=cistRoot, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mirroring=mirroring, lacpInfo=lacpInfo, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRootPathCost=cistRootPathCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHelloTime=stpInfoHelloTime, lacp=lacp, stgNewCfgAgingTime=stgNewCfgAgingTime)
