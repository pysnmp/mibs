...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoPorts=vlanInfoPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStats=fdbStats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, fdbTable=fdbTable, mstCfg=mstCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTableEntry=stpInfoTableEntry, layer2=layer2, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbEntry=fdbEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, vlanInfoId=vlanInfoId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortRole=cistInfoPortRole, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgStg=vlanNewCfgStg, BridgeId=BridgeId, fdbRefSps=fdbRefSps, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoRootPort=stpInfoRootPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCfg=stgCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfo=lacpInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCfg=mstCistCfg, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRootPort=cistRootPort, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgState=vlanCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfo=vlanInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfo=stpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbSrcPort=fdbSrcPort, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortTable=cistInfoPortTable, cistInfoPortIndex=cistInfoPortIndex, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsFinds=fdbStatsFinds, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpStats=stpStats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, cistInfo=cistInfo, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, fdbState=fdbState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortState=stpInfoPortState, stgNewCfgTable=stgNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsLookups=fdbStatsLookups, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoLearn=vlanInfoLearn, vlan=vlan, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, cistRegionalRoot=cistRegionalRoot, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortState=cistInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgState=mstNewCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoRootCost=stpInfoRootCost, vlanMaxVlanID=vlanMaxVlanID, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoName=vlanInfoName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoTable=portTeamInfoTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, portTeamNewCfgState=portTeamNewCfgState, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortTable=stpInfoPortTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, layer2Info=layer2Info, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoHoldTime=stpInfoHoldTime, fdbVlan=fdbVlan, mirroring=mirroring, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2Stats=layer2Stats, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortLinkType=stpInfoPortLinkType, fdbInfo=fdbInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsHiwat=fdbStatsHiwat, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacp=lacp, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsCreates=fdbStatsCreates, stgCurCfgStgIndex=stgCurCfgStgIndex, layer2Oper=layer2Oper, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgState=stgCurCfgState, stgNewCfgState=stgNewCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCfg=portTeamCfg, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, cistRootPathCost=cistRootPathCost, vlanNewCfgPorts=vlanNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbClear=fdbClear, stpInfoHelloTime=stpInfoHelloTime, layer2Configs=layer2Configs, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortState=lacpCurPortState, lacpNewPortState=lacpNewPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, stpInfoTable=stpInfoTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, cistRoot=cistRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamInfo=portTeamInfo, portTeamCurCfgState=portTeamCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay)
