...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgState=stgNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCfg=portTeamCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoId=vlanInfoId, vlanNewCfgState=vlanNewCfgState, fdbStatsFindFails=fdbStatsFindFails, fdbState=fdbState, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoIndex=stpInfoIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxEnt=vlanMaxEnt, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbTable=fdbTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcPort=fdbSrcPort, stgNewCfgPortTable=stgNewCfgPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgState=mstCurCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, vlanInfoPorts=vlanInfoPorts, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortTable=stgCurCfgPortTable, fdbMacAddr=fdbMacAddr, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbVlan=fdbVlan, stpStats=stpStats, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfo=vlanInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfo=stpInfo, stpInfoRootCost=stpInfoRootCost, BridgeId=BridgeId, mirrPortMirr=mirrPortMirr, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, mstCistCfg=mstCistCfg, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortIndex=stpInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfo=cistInfo, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortLink=stgNewCfgPortLink, mstCfg=mstCfg, lacpCurPortState=lacpCurPortState, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoName=vlanInfoName, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortState=stpInfoPortState, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfo=portTeamInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsLookups=fdbStatsLookups, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoState=portTeamInfoState, fdbEntry=fdbEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortSelected=lacpInfoPortSelected, fdbInfo=fdbInfo, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, layer2Configs=layer2Configs, stpInfoHoldTime=stpInfoHoldTime, fdbRefSps=fdbRefSps, mstCistNewCfgPortTable=mstCistNewCfgPortTable, layer2Oper=layer2Oper, fdbStatsCurrent=fdbStatsCurrent, vlanInfoStatus=vlanInfoStatus, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, stgCfg=stgCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstGeneralCfg=mstGeneralCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpNewPortState=lacpNewPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgTable=stgCurCfgTable, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgTable=vlanCurCfgTable, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacp=lacp, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoTable=vlanInfoTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Stats=layer2Stats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, PYSNMP_MODULE_ID=layer2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfo=lacpInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFinds=fdbStatsFinds, stgCurCfgState=stgCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTable=stpInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortRole=stpInfoPortRole, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlan=vlan, trunkgroup=trunkgroup, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsDeletes=fdbStatsDeletes, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, cistRoot=cistRoot, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, layer2Info=layer2Info, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, fdbLearnedPort=fdbLearnedPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRootPort=cistRootPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgState=mstNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbClear=fdbClear, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStats=fdbStats, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk)
