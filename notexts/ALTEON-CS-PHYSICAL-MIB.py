...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgTable=stgCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookups=fdbStatsLookups, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsFinds=fdbStatsFinds, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTable=portTeamInfoTable, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgIndex=stgCurCfgIndex, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgState=stgCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRoot=cistRoot, cistInfoPortState=cistInfoPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCfg=portTeamCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfo=cistInfo, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoIndex=stpInfoIndex, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCfg=mstCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgStpMode=mstCurCfgStpMode, layer2=layer2, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoTable=vlanInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkgroup=trunkgroup, cistInfoPortTable=cistInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCfg=stgCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortTable=stgStatsPortTable, BridgeId=BridgeId, portTeamInfoPortsState=portTeamInfoPortsState, mstNewCfgStpMode=mstNewCfgStpMode, vlan=vlan, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mirroring=mirroring, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfo=lacpInfo, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortRole=cistInfoPortRole, vlanInfoPorts=vlanInfoPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanInfoId=vlanInfoId, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpStats=stpStats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortIndex=stgStatsPortIndex, mirrPortMirr=mirrPortMirr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistBridgeHelloTime=cistBridgeHelloTime, fdbState=fdbState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortTable=stpInfoPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortPriority=cistInfoPortPriority, layer2Stats=layer2Stats, PYSNMP_MODULE_ID=layer2, mstCurCfgState=mstCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, cistGeneralInfo=cistGeneralInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoState=portTeamInfoState, stpInfoPortEdge=stpInfoPortEdge, layer2Oper=layer2Oper, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRootPort=cistRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, stpInfo=stpInfo, vlanInfo=vlanInfo, stpInfoTopChanges=stpInfoTopChanges, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCfg=mstCistCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStats=fdbStats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfo=portTeamInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPriority=stgNewCfgPriority, mstGeneralCfg=mstGeneralCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbTable=fdbTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbClear=fdbClear, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacp=lacp, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRegionalRoot=cistRegionalRoot, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, fdbInfo=fdbInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, layer2Info=layer2Info, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbVlan=fdbVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsStpIndex=stgStatsStpIndex, vlanMaxEnt=vlanMaxEnt, stpInfoTable=stpInfoTable, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoHelloTime=stpInfoHelloTime, fdbEntry=fdbEntry, lacpCurPortState=lacpCurPortState, stpInfoRootPort=stpInfoRootPort, lacpNewPortState=lacpNewPortState, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMirrState=pmNewCfgPortMirrState)
