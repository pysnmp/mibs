...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbLearnedPort=fdbLearnedPort, fdbVlan=fdbVlan, cistInfo=cistInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoState=portTeamInfoState, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoLearn=vlanInfoLearn, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoName=vlanInfoName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacp=lacp, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Stats=layer2Stats, stgCurCfgState=stgCurCfgState, mstCurCfgState=mstCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsCreates=fdbStatsCreates, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgState=mstNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgState=stgNewCfgState, cistRegionalRoot=cistRegionalRoot, cistInfoPortPathCost=cistInfoPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCfg=mstCfg, stpInfoRootPort=stpInfoRootPort, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortRole=cistInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCfg=mstCistCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpStats=stpStats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCfg=stgCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfo=portTeamInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbMacAddr=fdbMacAddr, portTeamInfoTrunks=portTeamInfoTrunks, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPriority=stgCurCfgPriority, stpInfo=stpInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCfg=portTeamCfg, stpInfoTable=stpInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortState=lacpNewPortState, cistInfoPortTable=cistInfoPortTable, cistGeneralInfo=cistGeneralInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbSrcTrunk=fdbSrcTrunk, vlanInfoBwmContract=vlanInfoBwmContract, mirrPortMirr=mirrPortMirr, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkgroup=trunkgroup, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, PYSNMP_MODULE_ID=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortTable=lacpInfoPortTable, fdbTable=fdbTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbClear=fdbClear, vlan=vlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortTable=stpInfoPortTable, vlanInfoId=vlanInfoId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortRole=stpInfoPortRole, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanMaxVlanID=vlanMaxVlanID, mirroring=mirroring, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgState=vlanNewCfgState, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortState=lacpCurPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsHiwat=fdbStatsHiwat, vlanInfoPorts=vlanInfoPorts, vlanInfo=vlanInfo, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Info=layer2Info, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, layer2=layer2, layer2Oper=layer2Oper, stgNewCfgPortLink=stgNewCfgPortLink, cistRoot=cistRoot, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortLinkType=cistInfoPortLinkType, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbSrcPort=fdbSrcPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortTable=stgStatsPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRootPort=cistRootPort, lacpInfo=lacpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Configs=layer2Configs, cistRootPathCost=cistRootPathCost, vlanInfoStatus=vlanInfoStatus, stpInfoRootCost=stpInfoRootCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbEntry=fdbEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfoTable=vlanInfoTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, BridgeId=BridgeId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortPriority=cistInfoPortPriority, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbState=fdbState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStats=fdbStats, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
