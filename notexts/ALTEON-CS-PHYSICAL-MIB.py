...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRootPort=cistRootPort, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTable=cistInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoId=vlanInfoId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, vlanInfoTable=vlanInfoTable, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbVlan=fdbVlan, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortLink=stgNewCfgPortLink, fdbInfo=fdbInfo, layer2Configs=layer2Configs, mstCistCfg=mstCistCfg, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoName=vlanInfoName, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbClear=fdbClear, cistRootPathCost=cistRootPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistBridgeCfg=mstCistBridgeCfg, layer2Oper=layer2Oper, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoRootPort=stpInfoRootPort, stgNewCfgAgingTime=stgNewCfgAgingTime, PYSNMP_MODULE_ID=layer2, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, cistGeneralInfo=cistGeneralInfo, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, fdbMacAddr=fdbMacAddr, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoPorts=vlanInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFinds=fdbStatsFinds, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsStpIndex=stgStatsStpIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfo=vlanInfo, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbRefSps=fdbRefSps, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfo=portTeamInfo, cistInfoPortState=cistInfoPortState, fdbStatsLookupFails=fdbStatsLookupFails, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, stpInfoTable=stpInfoTable, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortState=stpInfoPortState, stpInfoHoldTime=stpInfoHoldTime, stpStats=stpStats, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbEntry=fdbEntry, vlan=vlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbTable=fdbTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgState=mstCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStats=fdbStats, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortEdge=stpInfoPortEdge, vlanInfoJumbo=vlanInfoJumbo, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgTable=vlanCurCfgTable, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoState=portTeamInfoState, lacpCurPortState=lacpCurPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCfg=stgCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Info=layer2Info, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Stats=layer2Stats, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRoot=cistRoot, portTeamInfoIndex=portTeamInfoIndex, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, trunkgroup=trunkgroup, stpInfoPortTable=stpInfoPortTable, mstCfg=mstCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortIndex=stgStatsPortIndex, lacp=lacp, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanMaxEnt=vlanMaxEnt, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgState=stgCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanMaxVlanID=vlanMaxVlanID, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfo=stpInfo, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfo=lacpInfo, layer2=layer2, BridgeId=BridgeId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortState=lacpNewPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfo=cistInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcPort=fdbSrcPort, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, fdbStatsCreates=fdbStatsCreates)
