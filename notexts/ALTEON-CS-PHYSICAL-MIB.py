...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCfg=mstCfg, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortRole=cistInfoPortRole, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, layer2Oper=layer2Oper, stgNewCfgTable=stgNewCfgTable, lacp=lacp, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2Configs=layer2Configs, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortRole=stpInfoPortRole, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistGeneralInfo=cistGeneralInfo, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgIndex=stgNewCfgIndex, layer2Stats=layer2Stats, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTable=portTeamNewCfgTable, BridgeId=BridgeId, fdbStats=fdbStats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbTable=fdbTable, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortState=cistInfoPortState, layer2Info=layer2Info, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfo=lacpInfo, lacpInfoPortIndex=lacpInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoTopChanges=stpInfoTopChanges, stpInfoTable=stpInfoTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortTable=stpInfoPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mirroring=mirroring, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortIndex=stpInfoPortIndex, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfo=portTeamInfo, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortState=lacpCurPortState, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRoot=cistRoot, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgState=mstNewCfgState, vlanInfoPorts=vlanInfoPorts, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCfg=stgCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, PYSNMP_MODULE_ID=layer2, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootCost=stpInfoRootCost, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsCurrent=fdbStatsCurrent, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortNtt=lacpInfoPortNtt, layer2=layer2, vlanInfo=vlanInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRegionalRoot=cistRegionalRoot, stpStats=stpStats, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoName=vlanInfoName, fdbStatsDeletes=fdbStatsDeletes, vlanInfoStatus=vlanInfoStatus, fdbVlan=fdbVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mirrPortMirr=mirrPortMirr, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortState=lacpNewPortState, stgStatsPortTable=stgStatsPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPort=cistRootPort, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlan=vlan, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoRootPort=stpInfoRootPort, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortPriority=cistInfoPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoTable=vlanInfoTable, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCfg=portTeamCfg, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxEnt=vlanMaxEnt, portTeamInfoState=portTeamInfoState, fdbClear=fdbClear, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsLookups=fdbStatsLookups, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortState=stpInfoPortState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgStg=vlanNewCfgStg, fdbEntry=fdbEntry, fdbInfo=fdbInfo, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsCreates=fdbStatsCreates, cistBridgeMaxAge=cistBridgeMaxAge, trunkgroup=trunkgroup, fdbRefSps=fdbRefSps, vlanNewCfgPorts=vlanNewCfgPorts, vlanInfoId=vlanInfoId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgState=stgNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoIndex=stpInfoIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbSrcPort=fdbSrcPort, mstGeneralCfg=mstGeneralCfg, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfo=cistInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, stpInfo=stpInfo, mstCistCfg=mstCistCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId)
