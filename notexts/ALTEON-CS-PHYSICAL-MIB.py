...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkgroup=trunkgroup, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mirroring=mirroring, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbLearnedPort=fdbLearnedPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgPorts=vlanNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortEdge=stpInfoPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsCurrent=fdbStatsCurrent, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mirrPortMirr=mirrPortMirr, cistInfoPortState=cistInfoPortState, vlanInfoName=vlanInfoName, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbClear=fdbClear, stgCurCfgState=stgCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbRefSps=fdbRefSps, vlanInfo=vlanInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortState=stpInfoPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Configs=layer2Configs, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortRole=cistInfoPortRole, stpStats=stpStats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, BridgeId=BridgeId, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbVlan=fdbVlan, stpInfoPortRole=stpInfoPortRole, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoIndex=stpInfoIndex, stgNewCfgTable=stgNewCfgTable, vlanInfoStatus=vlanInfoStatus, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfo=lacpInfo, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstGeneralCfg=mstGeneralCfg, PYSNMP_MODULE_ID=layer2, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCfg=mstCistCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCurCfgState=mstCurCfgState, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortState=lacpNewPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoBwmContract=vlanInfoBwmContract, cistRoot=cistRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbInfo=fdbInfo, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbSrcPort=fdbSrcPort, layer2Oper=layer2Oper, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsStpIndex=stgStatsStpIndex, vlanInfoId=vlanInfoId, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbStats=fdbStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCfg=stgCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistGeneralInfo=cistGeneralInfo, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, mstCfg=mstCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacp=lacp, portTeamCurCfgState=portTeamCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgIndex=stgCurCfgIndex, cistRegionalPathCost=cistRegionalPathCost, fdbStatsCreates=fdbStatsCreates, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsLookups=fdbStatsLookups, fdbEntry=fdbEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRegionalRoot=cistRegionalRoot, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgState=vlanCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistRootPort=cistRootPort, portTeamCfg=portTeamCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTable=stpInfoTable, stpInfoHoldTime=stpInfoHoldTime, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoTable=vlanInfoTable, layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlan=vlan, cistInfo=cistInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, stpInfo=stpInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfo=portTeamInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoState=portTeamInfoState, fdbTable=fdbTable, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, stgCurCfgPriority=stgCurCfgPriority, layer2Info=layer2Info, vlanNewCfgStg=vlanNewCfgStg, layer2=layer2, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbMacAddr=fdbMacAddr)
