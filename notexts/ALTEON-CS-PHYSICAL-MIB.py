...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbVlan=fdbVlan, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, vlanMaxVlanID=vlanMaxVlanID, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCfg=mstCistCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTable=portTeamInfoTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, lacpNewPortState=lacpNewPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRootPathCost=cistRootPathCost, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistBridgeHelloTime=cistBridgeHelloTime, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgState=vlanCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsCreates=fdbStatsCreates, stpInfoPortTable=stpInfoPortTable, lacpCurPortState=lacpCurPortState, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamTableMaxSize=portTeamTableMaxSize, fdbEntry=fdbEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoTable=stpInfoTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfo=cistInfo, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfo=portTeamInfo, mstNewCfgState=mstNewCfgState, vlanNewCfgStg=vlanNewCfgStg, vlanInfoPorts=vlanInfoPorts, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfo=vlanInfo, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgStpMode=mstCurCfgStpMode, layer2Oper=layer2Oper, mirrPortMirr=mirrPortMirr, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbClear=fdbClear, stgCfg=stgCfg, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoId=vlanInfoId, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbTable=fdbTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRoot=cistRoot, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRootPort=cistRootPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistBridgeCfg=mstCistBridgeCfg, vlan=vlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoName=vlanInfoName, layer2Stats=layer2Stats, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortState=stpInfoPortState, vlanNewCfgTable=vlanNewCfgTable, stpStats=stpStats, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfo=lacpInfo, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgState=stgNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgStg=vlanCurCfgStg, mstCfg=mstCfg, stgStatsStpIndex=stgStatsStpIndex, vlanInfoStatus=vlanInfoStatus, stpInfo=stpInfo, fdbInfo=fdbInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookups=fdbStatsLookups, mstGeneralCfg=mstGeneralCfg, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsFinds=fdbStatsFinds, layer2=layer2, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbRefSps=fdbRefSps, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCfg=portTeamCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoTable=vlanInfoTable, mirroring=mirroring, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbLearnedPort=fdbLearnedPort, stgCurCfgState=stgCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, cistGeneralInfo=cistGeneralInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPriority=stgCurCfgPriority, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, trunkgroup=trunkgroup, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, BridgeId=BridgeId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTable=stgCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgState=vlanNewCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortRole=stpInfoPortRole, lacp=lacp, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, layer2Info=layer2Info, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgTrunks=portTeamNewCfgTrunks, PYSNMP_MODULE_ID=layer2, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgTable=vlanCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoLearn=vlanInfoLearn, layer2Configs=layer2Configs, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbState=fdbState, fdbSrcPort=fdbSrcPort, fdbStats=fdbStats, vlanMaxEnt=vlanMaxEnt)
