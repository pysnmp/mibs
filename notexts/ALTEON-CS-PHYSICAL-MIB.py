...
ObjectIdentity, ModuleIdentity, Gauge32, TimeTicks, Counter32, Integer32, Unsigned32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter32", "Integer32", "Unsigned32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoStatus=vlanInfoStatus, mstCurCfgState=mstCurCfgState, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbMacAddr=fdbMacAddr, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoId=vlanInfoId, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgState=mstNewCfgState, portTeamInfoIndex=portTeamInfoIndex, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistBridgeHelloTime=cistBridgeHelloTime, stgCfg=stgCfg, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoHoldTime=stpInfoHoldTime, cistInfo=cistInfo, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoState=portTeamInfoState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, fdbTable=fdbTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoTable=stpInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbEntry=fdbEntry, portTeamInfoPortsState=portTeamInfoPortsState, vlan=vlan, cistRegionalRoot=cistRegionalRoot, stgNewCfgIndex=stgNewCfgIndex, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgState=stgCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamInfo=portTeamInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbInfo=fdbInfo, fdbRefSps=fdbRefSps, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfo=lacpInfo, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, vlanInfo=vlanInfo, cistRootPathCost=cistRootPathCost, cistInfoPortPriority=cistInfoPortPriority, stpInfoRootPort=stpInfoRootPort, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStatsHiwat=fdbStatsHiwat, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCfg=mstCistCfg, stpInfoPortTable=stpInfoPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgState=stgNewCfgState, vlanNewCfgState=vlanNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, fdbStatsFinds=fdbStatsFinds, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbClear=fdbClear, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortTable=stgStatsPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, PYSNMP_MODULE_ID=layer2, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoHelloTime=stpInfoHelloTime, portTeamCfg=portTeamCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2Configs=layer2Configs, mstNewCfgStpMode=mstNewCfgStpMode, fdbStats=fdbStats, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbState=fdbState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortState=cistInfoPortState, trunkgroup=trunkgroup, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgTable=vlanNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfo=stpInfo, vlanInfoTable=vlanInfoTable, stpInfoIndex=stpInfoIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgTable=vlanCurCfgTable, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCfg=mstCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbVlan=fdbVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortIndex=stpInfoPortIndex, vlanInfoPorts=vlanInfoPorts, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTable=stgNewCfgTable, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbSrcPort=fdbSrcPort, cistRoot=cistRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortRole=stpInfoPortRole, vlanMaxEnt=vlanMaxEnt, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsFindFails=fdbStatsFindFails, stpStats=stpStats, vlanInfoName=vlanInfoName, mstGeneralCfg=mstGeneralCfg, stpInfoRootCost=stpInfoRootCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgTable=stgCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, BridgeId=BridgeId, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortState=stpInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, layer2Oper=layer2Oper, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, cistRootPort=cistRootPort, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortState=lacpNewPortState, vlanCurCfgState=vlanCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, lacp=lacp, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Stats=layer2Stats, layer2Info=layer2Info, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort)
