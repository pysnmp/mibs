...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoHelloTime=stpInfoHelloTime, portTeamCfg=portTeamCfg, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortRole=stpInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoPorts=vlanInfoPorts, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionName=mstNewCfgRegionName, fdbClear=fdbClear, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoStatus=vlanInfoStatus, mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoState=portTeamInfoState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortState=lacpNewPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Configs=layer2Configs, portTeamInfoTable=portTeamInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgState=mstNewCfgState, lacp=lacp, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgState=portTeamCurCfgState, vlanInfoName=vlanInfoName, vlanMaxEnt=vlanMaxEnt, stpInfoPortState=stpInfoPortState, mstCfg=mstCfg, cistInfoPortPathCost=cistInfoPortPathCost, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpCurPortState=lacpCurPortState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mirroring=mirroring, vlanInfo=vlanInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistGeneralInfo=cistGeneralInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbRefSps=fdbRefSps, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfo=portTeamInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoIndex=stpInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCfg=mstCistCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbTable=fdbTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgTable=stgNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoMaxAge=stpInfoMaxAge, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, fdbVlan=fdbVlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRegionalRoot=cistRegionalRoot, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpStats=stpStats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoLearn=vlanInfoLearn, BridgeId=BridgeId, stpInfoTable=stpInfoTable, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Stats=layer2Stats, stgStatsPortTable=stgStatsPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbSrcPort=fdbSrcPort, fdbSrcTrunk=fdbSrcTrunk, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRoot=cistRoot, vlanMaxVlanID=vlanMaxVlanID, cistRootPort=cistRootPort, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortTable=cistInfoPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Info=layer2Info, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbEntry=fdbEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoId=vlanInfoId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfo=stpInfo, fdbStats=fdbStats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsDeletes=fdbStatsDeletes, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfo=lacpInfo, trunkgroup=trunkgroup, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbState=fdbState, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCfg=stgCfg, layer2Oper=layer2Oper, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfo=cistInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgState=vlanCurCfgState, vlanInfoTable=vlanInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbInfo=fdbInfo, stgCurCfgState=stgCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, stpInfoRootPort=stpInfoRootPort, vlanNewCfgState=vlanNewCfgState, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, vlan=vlan, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPriority=stgNewCfgPriority, stpInfoRootCost=stpInfoRootCost)
