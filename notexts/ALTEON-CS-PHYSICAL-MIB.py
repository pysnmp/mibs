...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCfg=mstCistCfg, lacpNewPortState=lacpNewPortState, trunkgroup=trunkgroup, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, mstNewCfgState=mstNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRootPort=cistRootPort, portTeamCfg=portTeamCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoIndex=portTeamInfoIndex, fdbSrcPort=fdbSrcPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, fdbLearnedPort=fdbLearnedPort, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, portTeamInfoState=portTeamInfoState, vlanInfoLearn=vlanInfoLearn, fdbVlan=fdbVlan, vlanInfo=vlanInfo, vlanMaxEnt=vlanMaxEnt, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2Configs=layer2Configs, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsHiwat=fdbStatsHiwat, lacp=lacp, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoIndex=stpInfoIndex, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbEntry=fdbEntry, cistInfo=cistInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgStg=vlanCurCfgStg, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStats=fdbStats, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistRegionalRoot=cistRegionalRoot, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortTable=stpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgState=vlanNewCfgState, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbMacAddr=fdbMacAddr, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Oper=layer2Oper, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistGeneralInfo=cistGeneralInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbTable=fdbTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoRootPort=stpInfoRootPort, layer2Stats=layer2Stats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistBridgeForwardDelay=cistBridgeForwardDelay, vlan=vlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgState=stgCurCfgState, BridgeId=BridgeId, mirroring=mirroring, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortRole=stpInfoPortRole, vlanInfoPorts=vlanInfoPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoMaxAge=stpInfoMaxAge, fdbInfo=fdbInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoId=vlanInfoId, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTable=stpInfoTable, mstCurCfgRegionName=mstCurCfgRegionName, mstGeneralCfg=mstGeneralCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortState=stpInfoPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgState=stgNewCfgState, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTable=portTeamInfoTable, portTeamInfo=portTeamInfo, fdbStatsDeletes=fdbStatsDeletes, layer2=layer2, cistInfoPortPathCost=cistInfoPortPathCost, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsCreates=fdbStatsCreates, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortTable=cistInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoName=vlanInfoName, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbClear=fdbClear, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCfg=mstCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortState=lacpCurPortState, stpStats=stpStats, lacpInfo=lacpInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistRoot=cistRoot, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTable=vlanInfoTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2Info=layer2Info, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, fdbStatsCurrent=fdbStatsCurrent, fdbState=fdbState, fdbRefSps=fdbRefSps, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfo=stpInfo)
