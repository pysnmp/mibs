...
Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, iso, ModuleIdentity, Bits, NotificationType, Unsigned32, IpAddress, Gauge32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "iso", "ModuleIdentity", "Bits", "NotificationType", "Unsigned32", "IpAddress", "Gauge32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgState=stgCurCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTable=stpInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, fdbEntry=fdbEntry, stpInfoIndex=stpInfoIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoName=vlanInfoName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoStatus=vlanInfoStatus, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewPortState=lacpNewPortState, BridgeId=BridgeId, portTeamCurCfgTable=portTeamCurCfgTable, cistGeneralInfo=cistGeneralInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoTableEntry=stpInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortPathCost=cistInfoPortPathCost, layer2Stats=layer2Stats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortState=stpInfoPortState, mstCurCfgRegionName=mstCurCfgRegionName, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, fdbRefSps=fdbRefSps, stpInfoPortRole=stpInfoPortRole, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTable=stgNewCfgTable, cistInfo=cistInfo, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgStg=vlanCurCfgStg, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, trunkgroup=trunkgroup, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCfg=mstCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbMacAddr=fdbMacAddr, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlan=vlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoLearn=vlanInfoLearn, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, portTeamInfo=portTeamInfo, vlanCurCfgState=vlanCurCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanMaxEnt=vlanMaxEnt, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, stgCfg=stgCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpStats=stpStats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsLookups=fdbStatsLookups, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortState=cistInfoPortState, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbState=fdbState, lacp=lacp, layer2Configs=layer2Configs, portTeamNewCfgPorts=portTeamNewCfgPorts, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCfg=mstCistCfg, cistRegionalRoot=cistRegionalRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCfg=portTeamCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoIndex=portTeamInfoIndex, stpInfo=stpInfo, mirroring=mirroring, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStats=fdbStats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTable=vlanInfoTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgIndex=stgNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, cistInfoPortTable=cistInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbClear=fdbClear, cistInfoPortIndex=cistInfoPortIndex, vlanInfoPorts=vlanInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsFinds=fdbStatsFinds, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbInfo=fdbInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfo=vlanInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbSrcTrunk=fdbSrcTrunk, fdbVlan=fdbVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoRootPort=stpInfoRootPort, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPriority=stgCurCfgPriority, layer2=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, PYSNMP_MODULE_ID=layer2, cistRootPort=cistRootPort, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRoot=cistRoot, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcPort=fdbSrcPort, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoState=portTeamInfoState, lacpInfo=lacpInfo, vlanInfoId=vlanInfoId, fdbTable=fdbTable)
