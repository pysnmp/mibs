...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgTable=stgNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfo=portTeamInfo, portTeamCurCfgState=portTeamCurCfgState, fdbClear=fdbClear, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFindFails=fdbStatsFindFails, vlanInfoPorts=vlanInfoPorts, mstCistDefaultCfg=mstCistDefaultCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortState=cistInfoPortState, fdbStats=fdbStats, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, mirrPortMirr=mirrPortMirr, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanMaxEnt=vlanMaxEnt, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTable=cistInfoPortTable, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortTable=stgCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbLearnedPort=fdbLearnedPort, vlan=vlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, mstCfg=mstCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgStg=vlanNewCfgStg, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoJumbo=vlanInfoJumbo, trunkgroup=trunkgroup, lacpNewSystemPriority=lacpNewSystemPriority, cistGeneralInfo=cistGeneralInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstNewCfgState=mstNewCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortEdge=stpInfoPortEdge, vlanInfo=vlanInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTable=stpInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, vlanCurCfgTable=vlanCurCfgTable, fdbState=fdbState, stpInfoPortPathCost=stpInfoPortPathCost, layer2Info=layer2Info, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortState=stpInfoPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, lacp=lacp, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoTable=portTeamInfoTable, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbEntry=fdbEntry, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortRole=stpInfoPortRole, stpStats=stpStats, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgState=mstCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgTable=stgCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsDeletes=fdbStatsDeletes, cistInfo=cistInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfo=stpInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFinds=fdbStatsFinds, cistRoot=cistRoot, fdbSrcPort=fdbSrcPort, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortPriority=cistInfoPortPriority, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, BridgeId=BridgeId, stgNewCfgState=stgNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortState=lacpNewPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, mirroring=mirroring, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbTable=fdbTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortPathCost=cistInfoPortPathCost, fdbStatsCreates=fdbStatsCreates, stgCfg=stgCfg, portTeamCfg=portTeamCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoRootPort=stpInfoRootPort, lacpCurPortState=lacpCurPortState, lacpInfo=lacpInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbMacAddr=fdbMacAddr, stpInfoPortTable=stpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, layer2Stats=layer2Stats, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPathCost=cistRootPathCost, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Oper=layer2Oper, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsStpIndex=stgStatsStpIndex, layer2=layer2, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbVlan=fdbVlan, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoName=vlanInfoName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRootPort=cistRootPort, fdbInfo=fdbInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgState=stgCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoIndex=stpInfoIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoId=vlanInfoId, stgNewCfgPortState=stgNewCfgPortState, mstCistCfg=mstCistCfg, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, layer2Configs=layer2Configs, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex)
