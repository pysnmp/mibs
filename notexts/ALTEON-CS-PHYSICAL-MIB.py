...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCfg=mstCfg, stpInfoTableEntry=stpInfoTableEntry, layer2Info=layer2Info, stpInfoForwardDelay=stpInfoForwardDelay, fdbStats=fdbStats, stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Stats=layer2Stats, stgNewCfgIndex=stgNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, fdbEntry=fdbEntry, vlanInfoName=vlanInfoName, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbMacAddr=fdbMacAddr, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsCurrent=fdbStatsCurrent, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, lacpInfoPortTable=lacpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoIndex=stpInfoIndex, vlanInfoId=vlanInfoId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, PYSNMP_MODULE_ID=layer2, trunkgroup=trunkgroup, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortRole=cistInfoPortRole, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookups=fdbStatsLookups, lacpInfoPortIndex=lacpInfoPortIndex, mirrPortMirr=mirrPortMirr, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistRoot=cistRoot, stgCurCfgStgIndex=stgCurCfgStgIndex, vlan=vlan, portTeamInfoTable=portTeamInfoTable, stpInfoTable=stpInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoLearn=vlanInfoLearn, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, cistRegionalRoot=cistRegionalRoot, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortTable=stgStatsPortTable, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbTable=fdbTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFinds=fdbStatsFinds, stpInfo=stpInfo, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, stpStats=stpStats, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfo=vlanInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTable=vlanCurCfgTable, fdbState=fdbState, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortIndex=cistInfoPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewPortState=lacpNewPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbRefSps=fdbRefSps, cistInfoPortTable=cistInfoPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoState=portTeamInfoState, cistInfo=cistInfo, stgNewCfgPortLink=stgNewCfgPortLink, fdbLearnedPort=fdbLearnedPort, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, BridgeId=BridgeId, layer2Oper=layer2Oper, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacp=lacp, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbVlan=fdbVlan, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortMoved=lacpInfoPortMoved, mstGeneralCfg=mstGeneralCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTable=stgCurCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCfg=mstCistCfg, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbClear=fdbClear, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRootPathCost=cistRootPathCost, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbSrcPort=fdbSrcPort, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, fdbInfo=fdbInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsCreates=fdbStatsCreates, lacpCurPortState=lacpCurPortState, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgState=mstNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Configs=layer2Configs, lacpInfo=lacpInfo, portTeamInfo=portTeamInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgState=vlanCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortState=stgCurCfgPortState, stpInfoRootPort=stpInfoRootPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRootPort=cistRootPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2=layer2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection)
