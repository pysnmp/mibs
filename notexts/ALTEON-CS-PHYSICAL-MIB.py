...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, layer2Oper=layer2Oper, lacp=lacp, stgCurCfgPriority=stgCurCfgPriority, vlanInfo=vlanInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstGeneralCfg=mstGeneralCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Configs=layer2Configs, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsFinds=fdbStatsFinds, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbClear=fdbClear, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, fdbInfo=fdbInfo, stpInfoPortState=stpInfoPortState, mstNewCfgState=mstNewCfgState, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoIndex=stpInfoIndex, vlanInfoLearn=vlanInfoLearn, cistInfoPortRole=cistInfoPortRole, fdbEntry=fdbEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortState=cistInfoPortState, cistRootPathCost=cistRootPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfo=portTeamInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlan=vlan, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgIndex=stgCurCfgIndex, vlanMaxEnt=vlanMaxEnt, cistInfo=cistInfo, stgStatsPortIndex=stgStatsPortIndex, vlanInfoId=vlanInfoId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCfg=mstCistCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbSrcPort=fdbSrcPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, vlanMaxVlanID=vlanMaxVlanID, stpInfoRootPort=stpInfoRootPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoTable=vlanInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, BridgeId=BridgeId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfo=stpInfo, vlanCurCfgStg=vlanCurCfgStg, fdbRefSps=fdbRefSps, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCfg=stgCfg, cistInfoPortPriority=cistInfoPortPriority, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgState=portTeamNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoState=portTeamInfoState, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoIndex=portTeamInfoIndex, stpInfoTopChanges=stpInfoTopChanges, fdbStatsOverflows=fdbStatsOverflows, vlanInfoName=vlanInfoName, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Stats=layer2Stats, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsStpIndex=stgStatsStpIndex, fdbState=fdbState, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, lacpInfoPortReadyN=lacpInfoPortReadyN, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgState=stgCurCfgState, portTeamCfg=portTeamCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgTable=stgCurCfgTable, stpInfoTable=stpInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbTable=fdbTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgStg=vlanNewCfgStg, stpInfoRootCost=stpInfoRootCost, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanInfoJumbo=vlanInfoJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2=layer2, fdbVlan=fdbVlan, cistRoot=cistRoot, mirrPortMirr=mirrPortMirr, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, lacpNewPortState=lacpNewPortState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfo=lacpInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStats=fdbStats, portTeamCurCfgTable=portTeamCurCfgTable, mstCfg=mstCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2Info=layer2Info, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpStats=stpStats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsHiwat=fdbStatsHiwat, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgState=vlanNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbSrcTrunk=fdbSrcTrunk)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortState=lacpCurPortState, cistRegionalRoot=cistRegionalRoot, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsFindFails=fdbStatsFindFails, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortEdge=stpInfoPortEdge, vlanInfoPorts=vlanInfoPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRootPort=cistRootPort, portTeamInfoTable=portTeamInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable)
