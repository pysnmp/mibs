...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoRootPort=stpInfoRootPort, layer2Stats=layer2Stats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCurCfgState=mstCurCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, BridgeId=BridgeId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, mirroring=mirroring, mstCistCfg=mstCistCfg, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgJumbo=vlanNewCfgJumbo, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPriority=stgCurCfgPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, lacp=lacp, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsCurrent=fdbStatsCurrent, cistRoot=cistRoot, cistGeneralInfo=cistGeneralInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoId=vlanInfoId, lacpNewPortState=lacpNewPortState, fdbStats=fdbStats, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stpStats=stpStats, trunkGroupCurCfgState=trunkGroupCurCfgState, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoTable=vlanInfoTable, vlanInfoName=vlanInfoName, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlan=vlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, fdbEntry=fdbEntry, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstGeneralCfg=mstGeneralCfg, PYSNMP_MODULE_ID=layer2, stgNewCfgState=stgNewCfgState, fdbInfo=fdbInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgTable=stgNewCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTable=stpInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPort=cistRootPort, stpInfo=stpInfo, fdbLearnedPort=fdbLearnedPort, fdbSrcTrunk=fdbSrcTrunk, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbVlan=fdbVlan, fdbClear=fdbClear, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mirrPortMirr=mirrPortMirr, mstNewCfgState=mstNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, mstCfg=mstCfg, vlanNewCfgStg=vlanNewCfgStg, portTeamInfo=portTeamInfo, fdbTable=fdbTable, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoRootCost=stpInfoRootCost, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgState=stgCurCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCfg=stgCfg, fdbSrcPort=fdbSrcPort, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsLookups=fdbStatsLookups, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, layer2=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Info=layer2Info, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortState=cistInfoPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgTable=vlanCurCfgTable, lacpInfo=lacpInfo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfo=cistInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkgroup=trunkgroup, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanInfo=vlanInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbState=fdbState, cistInfoPortRole=cistInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortState=stpInfoPortState, cistRootPathCost=cistRootPathCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoDesignatedRoot=stpInfoDesignatedRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortRole=stpInfoPortRole, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgLearn=vlanCurCfgLearn, layer2Configs=layer2Configs, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsFinds=fdbStatsFinds, stpInfoIndex=stpInfoIndex, layer2Oper=layer2Oper, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortLink=stgCurCfgPortLink, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgTable=stgCurCfgTable, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCfg=portTeamCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState)
