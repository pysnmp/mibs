...
Gauge32, NotificationType, IpAddress, Counter64, MibIdentifier, iso, Bits, ModuleIdentity, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortIndex=stgCurCfgPortIndex, fdbSrcPort=fdbSrcPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCfg=portTeamCfg, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, cistRootPort=cistRootPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, mstNewCfgState=mstNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbTable=fdbTable, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoPorts=vlanInfoPorts, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Stats=layer2Stats, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortState=cistInfoPortState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortState=stgNewCfgPortState, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortState=stpInfoPortState, fdbStatsFinds=fdbStatsFinds, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortTable=stpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, BridgeId=BridgeId, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, fdbRefSps=fdbRefSps, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkgroup=trunkgroup, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCreates=fdbStatsCreates, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootPort=stpInfoRootPort, portTeamInfoIndex=portTeamInfoIndex, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, layer2Oper=layer2Oper, stgCurCfgTable=stgCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgLearn=vlanCurCfgLearn, PYSNMP_MODULE_ID=layer2, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfo=lacpInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, layer2Configs=layer2Configs, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirroring=mirroring, fdbLearnedPort=fdbLearnedPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbInfo=fdbInfo, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortTable=lacpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfo=stpInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlan=vlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, cistRoot=cistRoot, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfo=vlanInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgIndex=stgNewCfgIndex, stpStats=stpStats, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCfg=mstCistCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoTable=stpInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgState=mstCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbState=fdbState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgStatsPortTable=stgStatsPortTable, vlanInfoName=vlanInfoName, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, fdbClear=fdbClear, vlanInfoId=vlanInfoId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, cistInfoPortTable=cistInfoPortTable, fdbSrcTrunk=fdbSrcTrunk, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbEntry=fdbEntry, mstCfg=mstCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgState=stgCurCfgState, lacp=lacp, stgCfg=stgCfg, stpInfoPortEdge=stpInfoPortEdge, cistRootPathCost=cistRootPathCost, lacpNewPortState=lacpNewPortState, fdbStatsLookupFails=fdbStatsLookupFails)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, fdbStatsDeletes=fdbStatsDeletes, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortIndex=cistInfoPortIndex, cistRegionalPathCost=cistRegionalPathCost, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortPriority=cistInfoPortPriority, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfo=portTeamInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Info=layer2Info, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
