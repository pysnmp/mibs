...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbRefSps=fdbRefSps, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfo=lacpInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRoot=cistRoot, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, lacp=lacp, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbState=fdbState, mstNewCfgState=mstNewCfgState, cistRootPort=cistRootPort, stpInfoPortStpIndex=stpInfoPortStpIndex, vlan=vlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCfg=portTeamCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, BridgeId=BridgeId, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTable=stgCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfo=cistInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, fdbMacAddr=fdbMacAddr, layer2Stats=layer2Stats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgState=vlanNewCfgState, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbEntry=fdbEntry, stgCfg=stgCfg, stpInfoMaxAge=stpInfoMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirroring=mirroring, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgState=portTeamNewCfgState, vlanInfo=vlanInfo, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkgroup=trunkgroup, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, stpStats=stpStats, mstCurCfgState=mstCurCfgState, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortRole=stpInfoPortRole, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, layer2Info=layer2Info, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoRootCost=stpInfoRootCost, stpInfoIndex=stpInfoIndex, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortIndex=cistInfoPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortPriority=cistInfoPortPriority, fdbLearnedPort=fdbLearnedPort, lacpCurPortState=lacpCurPortState, mstGeneralCfg=mstGeneralCfg, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortTable=stpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoName=vlanInfoName, stpInfo=stpInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2=layer2, mirrPortMirr=mirrPortMirr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgTable=stgNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfo=portTeamInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgState=stgNewCfgState, stgStatsPortIndex=stgStatsPortIndex, vlanInfoId=vlanInfoId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortPathCost=cistInfoPortPathCost, PYSNMP_MODULE_ID=layer2, fdbInfo=fdbInfo, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, layer2Configs=layer2Configs, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoStatus=vlanInfoStatus, vlanInfoPorts=vlanInfoPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgIndex=stgCurCfgIndex, stpInfoTopChanges=stpInfoTopChanges, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortState=lacpNewPortState, cistInfoPortState=cistInfoPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortTable=stgStatsPortTable, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTable=vlanInfoTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRegionalRoot=cistRegionalRoot, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindFails=fdbStatsFindFails, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCfg=mstCistCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStats=fdbStats, portTeamInfoPorts=portTeamInfoPorts, stpInfoTableEntry=stpInfoTableEntry, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgState=stgCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCfg=mstCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortState=stpInfoPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, stpInfoTable=stpInfoTable, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Oper=layer2Oper, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbTable=fdbTable, mstCurCfgRegionName=mstCurCfgRegionName, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, fdbVlan=fdbVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, stpInfoHelloTime=stpInfoHelloTime, vlanMaxEnt=vlanMaxEnt, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsStpIndex=stgStatsStpIndex)
