...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStats=fdbStats, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, mirroring=mirroring, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortState=lacpNewPortState, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkgroup=trunkgroup, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortTable=stpInfoPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Info=layer2Info, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, PYSNMP_MODULE_ID=layer2, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortIndex=stgStatsPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgState=mstCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgState=stgCurCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoTableEntry=stpInfoTableEntry, stpInfoIndex=stpInfoIndex, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoHoldTime=stpInfoHoldTime, lacpInfo=lacpInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoTable=vlanInfoTable, fdbTable=fdbTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoPortRole=stpInfoPortRole, vlanInfoId=vlanInfoId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, layer2Stats=layer2Stats, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpStats=stpStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoTable=stpInfoTable, layer2Configs=layer2Configs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortIndex=cistInfoPortIndex, layer2=layer2, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, fdbInfo=fdbInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCfg=mstCistCfg, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsHiwat=fdbStatsHiwat, mirrPortMirr=mirrPortMirr, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCfg=mstCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortState=stpInfoPortState, stpInfoPortIndex=stpInfoPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbClear=fdbClear, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistRegionalRoot=cistRegionalRoot, mstNewCfgState=mstNewCfgState, stgCurCfgPriority=stgCurCfgPriority, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortState=stgNewCfgPortState, cistGeneralInfo=cistGeneralInfo, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFinds=fdbStatsFinds, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanInfo=vlanInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoHelloTime=stpInfoHelloTime, fdbState=fdbState, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortPathCost=stpInfoPortPathCost, cistRegionalPathCost=cistRegionalPathCost, lacp=lacp, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbEntry=fdbEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgState=vlanNewCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbMacAddr=fdbMacAddr, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsLookupFails=fdbStatsLookupFails, cistRoot=cistRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, stgCfg=stgCfg, fdbStatsCreates=fdbStatsCreates, cistInfoPortState=cistInfoPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, cistRootPort=cistRootPort, stpInfo=stpInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoPorts=vlanInfoPorts, layer2Oper=layer2Oper, portTeamInfo=portTeamInfo, stgNewCfgTable=stgNewCfgTable, mstGeneralCfg=mstGeneralCfg, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, BridgeId=BridgeId, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, fdbRefSps=fdbRefSps, vlanInfoName=vlanInfoName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbVlan=fdbVlan, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgTable=stgCurCfgTable, cistInfo=cistInfo, mstNewCfgStpMode=mstNewCfgStpMode, cistRootPathCost=cistRootPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortState=lacpCurPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCfg=portTeamCfg, vlan=vlan, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgState=stgNewCfgState)
