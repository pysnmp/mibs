...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, fdbEntry=fdbEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgState=vlanCurCfgState, layer2Oper=layer2Oper, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCfg=mstCistCfg, stpInfoPortPathCost=stpInfoPortPathCost, portTeamCfg=portTeamCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortIndex=cistInfoPortIndex, mirrPortMirr=mirrPortMirr, lacpInfoPortIndex=lacpInfoPortIndex, vlanMaxEnt=vlanMaxEnt, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAgingTime=stgNewCfgAgingTime, BridgeId=BridgeId, vlanInfo=vlanInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgTable=stgCurCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlan=vlan, fdbStats=fdbStats, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistRootPathCost=cistRootPathCost, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfo=cistInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgState=stgNewCfgState, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfo=stpInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCreates=fdbStatsCreates, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortState=stpInfoPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgState=mstCurCfgState, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbVlan=fdbVlan, fdbSrcPort=fdbSrcPort, vlanInfoTable=vlanInfoTable, stgStatsPortIndex=stgStatsPortIndex, vlanInfoJumbo=vlanInfoJumbo, mstCfg=mstCfg, stpInfoPortEdge=stpInfoPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortTable=cistInfoPortTable, cistInfoPortState=cistInfoPortState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoTable=stpInfoTable, trunkgroup=trunkgroup, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoIndex=stpInfoIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, layer2Info=layer2Info, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfo=lacpInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbState=fdbState, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Stats=layer2Stats, cistRegionalRoot=cistRegionalRoot, stpStats=stpStats, cistRoot=cistRoot, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortTable=stgStatsPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortLink=stgCurCfgPortLink, mirroring=mirroring, stpInfoPortRole=stpInfoPortRole, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2=layer2, portTeamInfo=portTeamInfo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoId=vlanInfoId, PYSNMP_MODULE_ID=layer2, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbClear=fdbClear, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgState=stgCurCfgState, vlanCurCfgStg=vlanCurCfgStg, fdbRefSps=fdbRefSps, lacpCurPortState=lacpCurPortState, fdbInfo=fdbInfo, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoStatus=vlanInfoStatus, cistRootPort=cistRootPort, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoState=portTeamInfoState, portTeamNewCfgState=portTeamNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbTable=fdbTable, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbSrcTrunk=fdbSrcTrunk, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortRole=cistInfoPortRole, layer2Configs=layer2Configs, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortTable=stpInfoPortTable, vlanInfoName=vlanInfoName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry)
