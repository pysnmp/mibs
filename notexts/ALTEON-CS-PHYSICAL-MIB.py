...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortState=lacpNewPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Configs=layer2Configs, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbInfo=fdbInfo, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgState=portTeamNewCfgState, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPriority=stgCurCfgPriority, vlanInfoTable=vlanInfoTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpCurPortState=lacpCurPortState, fdbStatsOverflows=fdbStatsOverflows, vlan=vlan, portTeamInfo=portTeamInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgTable=stgNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, mstGeneralCfg=mstGeneralCfg, stpInfoRootCost=stpInfoRootCost, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindFails=fdbStatsFindFails, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCfg=portTeamCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgState=mstNewCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTable=stpInfoTable, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, layer2Info=layer2Info, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoPorts=vlanInfoPorts, portTeamInfoState=portTeamInfoState, fdbState=fdbState, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortRole=stpInfoPortRole, vlanCurCfgStg=vlanCurCfgStg, PYSNMP_MODULE_ID=layer2, mstCfg=mstCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortTable=lacpInfoPortTable, stpInfoRootPort=stpInfoRootPort, mirrPortMirr=mirrPortMirr, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoBwmContract=vlanInfoBwmContract, cistRootPort=cistRootPort, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsFinds=fdbStatsFinds, vlanNewCfgLearn=vlanNewCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortState=stgNewCfgPortState, fdbClear=fdbClear, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbEntry=fdbEntry, lacpInfoPortIndex=lacpInfoPortIndex, fdbStats=fdbStats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfo=stpInfo, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2=layer2, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfo=vlanInfo, cistGeneralInfo=cistGeneralInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkgroup=trunkgroup, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbRefSps=fdbRefSps, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, mirroring=mirroring, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoMaxAge=stpInfoMaxAge, vlanInfoLearn=vlanInfoLearn, fdbVlan=fdbVlan, layer2Stats=layer2Stats, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgState=vlanNewCfgState, portTeamInfoTable=portTeamInfoTable, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortEdge=stpInfoPortEdge, mstCistCfg=mstCistCfg, stgCurCfgState=stgCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortTable=stpInfoPortTable, lacpInfo=lacpInfo, layer2Oper=layer2Oper, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookups=fdbStatsLookups, cistInfoPortState=cistInfoPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoName=vlanInfoName, vlanCurCfgState=vlanCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistRootPathCost=cistRootPathCost, vlanInfoStatus=vlanInfoStatus, vlanMaxEnt=vlanMaxEnt, cistInfoPortIndex=cistInfoPortIndex, stgCfg=stgCfg, fdbSrcTrunk=fdbSrcTrunk, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTableEntry=stpInfoTableEntry, cistRegionalRoot=cistRegionalRoot, stpInfoTopChanges=stpInfoTopChanges, stpStats=stpStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacp=lacp, cistInfoPortTableEntry=cistInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortState=stpInfoPortState, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortIndex=stgNewCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoIndex=stpInfoIndex, fdbTable=fdbTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoId=vlanInfoId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoPorts=portTeamInfoPorts, BridgeId=BridgeId, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfo=cistInfo)
