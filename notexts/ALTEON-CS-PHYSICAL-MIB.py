...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoIndex=stpInfoIndex, stgNewCfgState=stgNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsDeletes=fdbStatsDeletes, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, layer2Stats=layer2Stats, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2Oper=layer2Oper, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoLearn=vlanInfoLearn, vlanInfoTable=vlanInfoTable, lacpInfo=lacpInfo, fdbStatsHiwat=fdbStatsHiwat, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbLearnedPort=fdbLearnedPort, stgCfg=stgCfg, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCfg=mstCfg, stpInfoTableEntry=stpInfoTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, layer2=layer2, vlan=vlan, mstCistCfg=mstCistCfg, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbClear=fdbClear, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoRootPort=stpInfoRootPort, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkgroup=trunkgroup, portTeamNewCfgState=portTeamNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbEntry=fdbEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoPorts=vlanInfoPorts, mirrPortMirr=mirrPortMirr, cistInfo=cistInfo, vlanCurCfgTable=vlanCurCfgTable, PYSNMP_MODULE_ID=layer2, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, BridgeId=BridgeId, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortTable=stgStatsPortTable, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbState=fdbState, vlanCurCfgState=vlanCurCfgState, stpInfoPortTable=stpInfoPortTable, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoRootCost=stpInfoRootCost, vlanMaxVlanID=vlanMaxVlanID, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCfg=portTeamCfg, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfo=vlanInfo, mstCurCfgState=mstCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortState=cistInfoPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoId=vlanInfoId, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortLinkType=stpInfoPortLinkType, cistRoot=cistRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoPorts=portTeamInfoPorts, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbRefSps=fdbRefSps, portTeamInfoTable=portTeamInfoTable, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTable=cistInfoPortTable, lacpNewPortState=lacpNewPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirroring=mirroring, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgState=stgCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTable=stpInfoTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortRole=cistInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgState=vlanNewCfgState, cistRegionalRoot=cistRegionalRoot, mstNewCfgRegionName=mstNewCfgRegionName, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistGeneralInfo=cistGeneralInfo, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpStats=stpStats, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, layer2Info=layer2Info, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, mstGeneralCfg=mstGeneralCfg, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, stpInfo=stpInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Configs=layer2Configs, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoState=portTeamInfoState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbSrcPort=fdbSrcPort, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookups=fdbStatsLookups, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStats=fdbStats, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortLink=stgNewCfgPortLink, cistRootPathCost=cistRootPathCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamInfo=portTeamInfo, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, lacp=lacp, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRootPort=cistRootPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbVlan=fdbVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbMacAddr=fdbMacAddr, lacpCurPortState=lacpCurPortState, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoName=vlanInfoName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPriority=stgNewCfgPortPriority)
