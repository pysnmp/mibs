...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfo=portTeamInfo, cistInfo=cistInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgStg=vlanCurCfgStg, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookups=fdbStatsLookups, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistBridgeMaxAge=cistBridgeMaxAge, layer2=layer2, stpInfoPortRole=stpInfoPortRole, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, fdbEntry=fdbEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mirroring=mirroring, portTeamInfoPorts=portTeamInfoPorts, mstCfg=mstCfg, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgStg=vlanNewCfgStg, mstCurCfgState=mstCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbClear=fdbClear, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanMaxEnt=vlanMaxEnt, fdbStatsCreates=fdbStatsCreates, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgIndex=stgNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, cistRootPathCost=cistRootPathCost, vlanInfo=vlanInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, mstCistCfg=mstCistCfg, lacp=lacp, stpInfo=stpInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoRootPort=stpInfoRootPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsFinds=fdbStatsFinds, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoLearn=vlanInfoLearn, stpInfoTable=stpInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoStatus=vlanInfoStatus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbMacAddr=fdbMacAddr, cistInfoPortState=cistInfoPortState, fdbTable=fdbTable, vlanInfoTable=vlanInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgState=stgNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoId=vlanInfoId, vlanInfoName=vlanInfoName, lacpCurPortState=lacpCurPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgStpMode=mstCurCfgStpMode, fdbSrcTrunk=fdbSrcTrunk, fdbStats=fdbStats, stpInfoPortStpIndex=stpInfoPortStpIndex, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, layer2Oper=layer2Oper, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCfg=portTeamCfg, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanMaxVlanID=vlanMaxVlanID, cistRegionalPathCost=cistRegionalPathCost, vlan=vlan, layer2Stats=layer2Stats, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgState=mstNewCfgState, cistInfoPortIndex=cistInfoPortIndex, layer2Info=layer2Info, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTable=portTeamInfoTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRoot=cistRoot, fdbInfo=fdbInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkgroup=trunkgroup, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, BridgeId=BridgeId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoState=portTeamInfoState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgTable=vlanNewCfgTable, fdbLearnedPort=fdbLearnedPort, stgStatsPortTable=stgStatsPortTable, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsHiwat=fdbStatsHiwat, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcPort=fdbSrcPort, fdbState=fdbState, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRootPort=cistRootPort, vlanInfoPorts=vlanInfoPorts, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, lacpNewPortState=lacpNewPortState, cistGeneralInfo=cistGeneralInfo, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Configs=layer2Configs, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbRefSps=fdbRefSps, stgCfg=stgCfg, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgState=vlanNewCfgState, stpInfoPortState=stpInfoPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge)
