...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfo=cistInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanMaxEnt=vlanMaxEnt, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, layer2Configs=layer2Configs, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistRootPort=cistRootPort, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoTable=vlanInfoTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkgroup=trunkgroup, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgState=stgNewCfgState, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortLinkType=stpInfoPortLinkType, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortRole=cistInfoPortRole, vlanNewCfgStg=vlanNewCfgStg, stgCfg=stgCfg, mstCistCfg=mstCistCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortState=lacpNewPortState, fdbVlan=fdbVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoRootPort=stpInfoRootPort, PYSNMP_MODULE_ID=layer2, cistRootPathCost=cistRootPathCost, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRoot=cistRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortState=cistInfoPortState, vlanInfoId=vlanInfoId, mstCurCfgState=mstCurCfgState, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, layer2Stats=layer2Stats, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortRole=stpInfoPortRole, stpInfoTopChanges=stpInfoTopChanges, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoPorts=vlanInfoPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCfg=mstCfg, layer2=layer2, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, mirroring=mirroring, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlan=vlan, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbMacAddr=fdbMacAddr, stpInfoIndex=stpInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStats=fdbStats, layer2Info=layer2Info, lacpInfo=lacpInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, cistGeneralInfo=cistGeneralInfo, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortTable=stgStatsPortTable, fdbTable=fdbTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsHiwat=fdbStatsHiwat, portTeamCfg=portTeamCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortTable=stpInfoPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortTable=cistInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbInfo=fdbInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgState=mstNewCfgState, layer2Oper=layer2Oper, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, BridgeId=BridgeId, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsFindFails=fdbStatsFindFails, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTable=stpInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortState=stpInfoPortState, cistRegionalRoot=cistRegionalRoot, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrPortMirr=mirrPortMirr, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgState=vlanCurCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoName=vlanInfoName, stpStats=stpStats, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbSrcPort=fdbSrcPort, lacp=lacp, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbClear=fdbClear, fdbRefSps=fdbRefSps, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortState=lacpCurPortState, portTeamInfo=portTeamInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgTable=stgNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbState=fdbState, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortMoved=lacpInfoPortMoved, fdbLearnedPort=fdbLearnedPort, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoLearn=vlanInfoLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState)
