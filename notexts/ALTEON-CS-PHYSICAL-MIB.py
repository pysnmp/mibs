...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfo=cistInfo, stgCurCfgState=stgCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbEntry=fdbEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCfg=portTeamCfg, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgState=vlanNewCfgState, vlanInfoLearn=vlanInfoLearn, layer2Stats=layer2Stats, fdbVlan=fdbVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistGeneralInfo=cistGeneralInfo, BridgeId=BridgeId, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoTable=stpInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoPorts=vlanInfoPorts, stgNewCfgState=stgNewCfgState, fdbStatsFindFails=fdbStatsFindFails, fdbStatsDeletes=fdbStatsDeletes, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCfg=mstCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortTable=stpInfoPortTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCurrent=fdbStatsCurrent, cistRoot=cistRoot, layer2Oper=layer2Oper, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTable=stgStatsPortTable, stgCurCfgPriority=stgCurCfgPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Configs=layer2Configs, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortState=stgCurCfgPortState, layer2=layer2, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortEdge=stpInfoPortEdge, layer2Info=layer2Info, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, lacpCurPortState=lacpCurPortState, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoIndex=stpInfoIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortState=cistInfoPortState, fdbInfo=fdbInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpStats=stpStats, vlanCurCfgTable=vlanCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTable=portTeamInfoTable, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoState=portTeamInfoState, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoStatus=vlanInfoStatus, fdbSrcTrunk=fdbSrcTrunk, vlanInfoId=vlanInfoId, mstCistCfg=mstCistCfg, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStats=fdbStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, lacp=lacp, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, cistRootPort=cistRootPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mirroring=mirroring, vlan=vlan, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbClear=fdbClear, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFinds=fdbStatsFinds, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoName=vlanInfoName, lacpInfoPortIndex=lacpInfoPortIndex, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbLearnedPort=fdbLearnedPort, mstCurCfgState=mstCurCfgState, stgCfg=stgCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgIndex=stgNewCfgIndex, fdbState=fdbState, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbTable=fdbTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbRefSps=fdbRefSps, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfo=vlanInfo, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgTable=stgCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfo=portTeamInfo, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstGeneralCfg=mstGeneralCfg, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoJumbo=vlanInfoJumbo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbSrcPort=fdbSrcPort, fdbMacAddr=fdbMacAddr, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, stpInfoPortPathCost=stpInfoPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgAgingTime=stgCurCfgAgingTime, cistRegionalRoot=cistRegionalRoot, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfo=lacpInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfo=stpInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortState=stpInfoPortState, vlanInfoTable=vlanInfoTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost)
