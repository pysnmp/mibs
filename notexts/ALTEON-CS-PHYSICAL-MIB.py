...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, fdbState=fdbState, cistRootPort=cistRootPort, fdbVlan=fdbVlan, fdbInfo=fdbInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFinds=fdbStatsFinds, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsLookups=fdbStatsLookups, cistRoot=cistRoot, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoState=portTeamInfoState, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbSrcPort=fdbSrcPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStats=fdbStats, stgCfg=stgCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgTable=portTeamCurCfgTable, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortState=lacpCurPortState, lacp=lacp, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortState=lacpNewPortState, stpStats=stpStats, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTable=lacpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Configs=layer2Configs, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbEntry=fdbEntry, stgCurCfgState=stgCurCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbLearnedPort=fdbLearnedPort, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbClear=fdbClear, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, stpInfo=stpInfo, stgCurCfgTable=stgCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCfg=mstCistCfg, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkgroup=trunkgroup, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortSelected=lacpInfoPortSelected, mirroring=mirroring, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTable=stgNewCfgTable, stpInfoRootPort=stpInfoRootPort, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoTableEntry=stpInfoTableEntry, cistGeneralInfo=cistGeneralInfo, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgState=vlanNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlan=vlan, vlanNewCfgDelete=vlanNewCfgDelete, mirrPortMirr=mirrPortMirr, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsCurrent=fdbStatsCurrent, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoRootCost=stpInfoRootCost, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, layer2Oper=layer2Oper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCfg=mstCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortTable=stpInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2=layer2, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortEdge=stpInfoPortEdge, fdbMacAddr=fdbMacAddr, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, fdbRefSps=fdbRefSps, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanInfoName=vlanInfoName, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsLookupFails=fdbStatsLookupFails, cistInfo=cistInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgState=mstCurCfgState, portTeamCfg=portTeamCfg, vlanNewCfgPorts=vlanNewCfgPorts, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfo=vlanInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgStg=vlanCurCfgStg, cistRegionalRoot=cistRegionalRoot, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Info=layer2Info, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTable=stpInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgRegionVersion=mstNewCfgRegionVersion, PYSNMP_MODULE_ID=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortRole=stpInfoPortRole, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortState=stpInfoPortState, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTopChanges=stpInfoTopChanges)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoTable=vlanInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPriority=stgNewCfgPriority, lacpInfo=lacpInfo, portTeamInfo=portTeamInfo, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsCreates=fdbStatsCreates, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoPorts=vlanInfoPorts, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, layer2Stats=layer2Stats, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan)
