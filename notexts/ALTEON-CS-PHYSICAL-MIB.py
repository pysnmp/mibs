...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfo=portTeamInfo, fdbStatsFinds=fdbStatsFinds, mstCurCfgState=mstCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortPriority=cistInfoPortPriority, fdbClear=fdbClear, stpInfoRootCost=stpInfoRootCost, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgState=stgCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortState=lacpNewPortState, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortTable=stgStatsPortTable, fdbVlan=fdbVlan, stpInfoIndex=stpInfoIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortState=cistInfoPortState, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, fdbStatsFindFails=fdbStatsFindFails, vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoTable=stpInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistGeneralInfo=cistGeneralInfo, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgRegionName=mstCurCfgRegionName, trunkgroup=trunkgroup, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgState=vlanNewCfgState, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, layer2Stats=layer2Stats, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Info=layer2Info, PYSNMP_MODULE_ID=layer2, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgPorts=portTeamNewCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCfg=portTeamCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgState=vlanCurCfgState, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpStats=stpStats, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCurCfgState=portTeamCurCfgState, mstNewCfgState=mstNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, BridgeId=BridgeId, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoName=vlanInfoName, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistRootPathCost=cistRootPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Configs=layer2Configs, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, fdbStatsLookups=fdbStatsLookups, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoId=vlanInfoId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirroring=mirroring, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoTable=vlanInfoTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfo=lacpInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoRootPort=stpInfoRootPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCfg=mstCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortTable=stgNewCfgPortTable, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortIndex=stgNewCfgPortIndex, vlan=vlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoIndex=portTeamInfoIndex, mstCistCfg=mstCistCfg, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbRefSps=fdbRefSps, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStats=fdbStats, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, lacp=lacp, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbEntry=fdbEntry, fdbInfo=fdbInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfo=stpInfo, stgCfg=stgCfg, vlanInfo=vlanInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfo=cistInfo, layer2Oper=layer2Oper, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortSelected=lacpInfoPortSelected, cistRoot=cistRoot, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, vlanInfoStatus=vlanInfoStatus, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRootPort=cistRootPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanMaxVlanID=vlanMaxVlanID, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortState=lacpCurPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbTable=fdbTable, vlanNewCfgPorts=vlanNewCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsDeletes=fdbStatsDeletes, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgTable=vlanNewCfgTable, layer2=layer2, portTeamInfoState=portTeamInfoState, stgNewCfgIndex=stgNewCfgIndex, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgState=trunkGroupCurCfgState)
