...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, fdbInfo=fdbInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, PYSNMP_MODULE_ID=layer2, mirroring=mirroring, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortState=stgCurCfgPortState, cistInfo=cistInfo, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, layer2Oper=layer2Oper, stgCurCfgState=stgCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRoot=cistRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbClear=fdbClear, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortIndex=lacpInfoPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortEdge=stpInfoPortEdge, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, BridgeId=BridgeId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbMacAddr=fdbMacAddr, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpCurPortState=lacpCurPortState, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortState=cistInfoPortState, stgCurCfgTable=stgCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPorts=portTeamInfoPorts, stpInfoIndex=stpInfoIndex, layer2=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkgroup=trunkgroup, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTable=stpInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbState=fdbState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCfg=portTeamCfg, vlan=vlan, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbEntry=fdbEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHoldTime=stpInfoHoldTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortTable=stgStatsPortTable, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCfg=stgCfg, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstGeneralCfg=mstGeneralCfg, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoPorts=vlanInfoPorts, stpInfoPortIndex=stpInfoPortIndex, layer2Configs=layer2Configs, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTopChanges=stpInfoTopChanges, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoTable=portTeamInfoTable, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoTable=vlanInfoTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbSrcPort=fdbSrcPort, mirrPortMirr=mirrPortMirr, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFinds=fdbStatsFinds, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Stats=layer2Stats, vlanMaxEnt=vlanMaxEnt, mstCistCfg=mstCistCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortState=stpInfoPortState, lacp=lacp, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfo=vlanInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode, stpStats=stpStats, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfo=stpInfo, vlanInfoName=vlanInfoName, layer2Info=layer2Info, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoId=vlanInfoId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortRole=cistInfoPortRole, fdbStatsOverflows=fdbStatsOverflows, mstCurCfgState=mstCurCfgState, cistRootPathCost=cistRootPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoMaxAge=stpInfoMaxAge, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoStatus=vlanInfoStatus, fdbStats=fdbStats, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCfg=mstCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortLink=stgCurCfgPortLink, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbVlan=fdbVlan, portTeamInfo=portTeamInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbTable=fdbTable, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookups=fdbStatsLookups, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, cistRegionalRoot=cistRegionalRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortTable=cistInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistGeneralInfo=cistGeneralInfo, vlanCurCfgState=vlanCurCfgState, stgCurCfgPriority=stgCurCfgPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfo=lacpInfo, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortRole=stpInfoPortRole, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbRefSps=fdbRefSps, vlanNewCfgState=vlanNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoState=portTeamInfoState, cistRootPort=cistRootPort, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortState=lacpNewPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount)
