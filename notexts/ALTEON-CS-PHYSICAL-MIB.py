...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2=layer2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFinds=fdbStatsFinds, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Info=layer2Info, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanMaxVlanID=vlanMaxVlanID, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortTable=stgStatsPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkgroup=trunkgroup, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCurCfgState=mstCurCfgState, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoRootCost=stpInfoRootCost, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortTable=lacpInfoPortTable, cistRootPathCost=cistRootPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistBridgeMaxAge=cistBridgeMaxAge, mstNewCfgState=mstNewCfgState, cistRegionalRoot=cistRegionalRoot, fdbStatsLookups=fdbStatsLookups, layer2Oper=layer2Oper, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoTopChanges=stpInfoTopChanges, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCfg=mstCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoTable=vlanInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, vlanInfoPorts=vlanInfoPorts, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbInfo=fdbInfo, cistRootPort=cistRootPort, cistInfoPortState=cistInfoPortState, mirrPortMirr=mirrPortMirr, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, fdbRefSps=fdbRefSps, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortRole=stpInfoPortRole, cistRegionalPathCost=cistRegionalPathCost, vlanInfoId=vlanInfoId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgState=stgCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTable=stpInfoTable, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfo=portTeamInfo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbClear=fdbClear, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stpInfoPortTable=stpInfoPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfo=vlanInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, cistRoot=cistRoot, layer2Stats=layer2Stats, lacpInfoPortReadyN=lacpInfoPortReadyN, layer2Configs=layer2Configs, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, cistGeneralInfo=cistGeneralInfo, PYSNMP_MODULE_ID=layer2, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoForwardDelay=stpInfoForwardDelay, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootPort=stpInfoRootPort, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortEdge=stpInfoPortEdge, BridgeId=BridgeId, stpInfo=stpInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgState=stgNewCfgState, stgCurCfgPortState=stgCurCfgPortState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mirroring=mirroring, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfo=lacpInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCfg=mstCistCfg, vlan=vlan, fdbVlan=fdbVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, stpStats=stpStats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTable=portTeamInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortNtt=lacpInfoPortNtt, cistInfo=cistInfo, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanMaxEnt=vlanMaxEnt, lacp=lacp, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCfg=stgCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortState=lacpNewPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStats=fdbStats, vlanCurCfgState=vlanCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoState=portTeamInfoState, lacpCurPortState=lacpCurPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbEntry=fdbEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCfg=portTeamCfg, vlanInfoStatus=vlanInfoStatus, fdbMacAddr=fdbMacAddr)
