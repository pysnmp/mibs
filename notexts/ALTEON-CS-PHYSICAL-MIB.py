...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfo=stpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCfg=mstCfg, mirroring=mirroring, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbEntry=fdbEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewSystemPriority=lacpNewSystemPriority, fdbTable=fdbTable, trunkgroup=trunkgroup, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoTableEntry=stpInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoTable=vlanInfoTable, stpStats=stpStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStats=fdbStats, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbSrcTrunk=fdbSrcTrunk, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbVlan=fdbVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacp=lacp, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbState=fdbState, mstNewCfgState=mstNewCfgState, fdbInfo=fdbInfo, stgNewCfgTable=stgNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoPorts=vlanInfoPorts, portTeamInfoState=portTeamInfoState, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoTable=stpInfoTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortRole=stpInfoPortRole, cistInfo=cistInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortState=cistInfoPortState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPriority=stgCurCfgPriority, mstCistCfg=mstCistCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoId=vlanInfoId, layer2=layer2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgState=mstCurCfgState, cistBridgeMaxAge=cistBridgeMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoTable=portTeamInfoTable, cistInfoPortRole=cistInfoPortRole, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgTable=stgCurCfgTable, lacpInfo=lacpInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgIndex=stgCurCfgIndex, vlan=vlan, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRoot=cistRoot, stgCurCfgPortState=stgCurCfgPortState, vlanInfoJumbo=vlanInfoJumbo, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgState=stgCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Oper=layer2Oper, mstGeneralCfg=mstGeneralCfg, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, layer2Configs=layer2Configs, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoLearn=vlanInfoLearn, layer2Stats=layer2Stats, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfo=portTeamInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoRootPort=stpInfoRootPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Info=layer2Info, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortPathCost=cistInfoPortPathCost, fdbLearnedPort=fdbLearnedPort, lacpInfoPortSelected=lacpInfoPortSelected, PYSNMP_MODULE_ID=layer2, cistGeneralInfo=cistGeneralInfo, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortTable=stpInfoPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbClear=fdbClear, BridgeId=BridgeId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsCreates=fdbStatsCreates, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortState=stpInfoPortState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mirrPortMirr=mirrPortMirr, portTeamInfoIndex=portTeamInfoIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortTable=cistInfoPortTable, vlanInfo=vlanInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsOverflows=fdbStatsOverflows, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbMacAddr=fdbMacAddr, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCfg=stgCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortState=lacpCurPortState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, fdbStatsLookups=fdbStatsLookups, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRootPort=cistRootPort, stpInfoIndex=stpInfoIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoName=vlanInfoName)
