...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgState=mstNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgTable=stgCurCfgTable, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbEntry=fdbEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, fdbState=fdbState, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoId=vlanInfoId, stpInfoPortRole=stpInfoPortRole, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2=layer2, stgCurCfgState=stgCurCfgState, fdbMacAddr=fdbMacAddr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, layer2Oper=layer2Oper, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoTable=portTeamInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortState=lacpCurPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoBwmContract=vlanInfoBwmContract, lacp=lacp, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrPortMirr=mirrPortMirr, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoName=vlanInfoName, mstCistCfg=mstCistCfg, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbClear=fdbClear, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, BridgeId=BridgeId, stgCurCfgPortState=stgCurCfgPortState, fdbStatsCreates=fdbStatsCreates, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2Configs=layer2Configs, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortIndex=stpInfoPortIndex, cistRegionalRoot=cistRegionalRoot, vlanNewCfgPorts=vlanNewCfgPorts, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCfg=portTeamCfg, fdbInfo=fdbInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbRefSps=fdbRefSps, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortState=stpInfoPortState, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgState=vlanNewCfgState, lacpInfo=lacpInfo, fdbSrcPort=fdbSrcPort, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, stpInfoTable=stpInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoPorts=portTeamInfoPorts, cistRootPathCost=cistRootPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoIndex=stpInfoIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortState=cistInfoPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCfg=mstCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsDeletes=fdbStatsDeletes, fdbVlan=fdbVlan, cistRoot=cistRoot, mstCistDefaultCfg=mstCistDefaultCfg, fdbTable=fdbTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfo=portTeamInfo, stgCfg=stgCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCurCfgState=mstCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsOverflows=fdbStatsOverflows, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistGeneralInfo=cistGeneralInfo, trunkgroup=trunkgroup, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfo=cistInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoState=portTeamInfoState, vlanCurCfgStg=vlanCurCfgStg, layer2Info=layer2Info, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfo=stpInfo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRootPort=cistRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoTable=vlanInfoTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, mirroring=mirroring)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPriority=stgNewCfgPriority, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoRootCost=stpInfoRootCost, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsLookups=fdbStatsLookups, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlan=vlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsCurrent=fdbStatsCurrent, stpStats=stpStats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsFinds=fdbStatsFinds, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfo=vlanInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, layer2Stats=layer2Stats, fdbLearnedPort=fdbLearnedPort, vlanInfoJumbo=vlanInfoJumbo)
