...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbState=fdbState, fdbStatsLookups=fdbStatsLookups, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoJumbo=vlanInfoJumbo, stpInfoTableEntry=stpInfoTableEntry, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, mstCurCfgState=mstCurCfgState, mstNewCfgState=mstNewCfgState, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirroring=mirroring, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgState=stgCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgLearn=vlanCurCfgLearn, fdbRefSps=fdbRefSps, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoPorts=vlanInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTable=vlanInfoTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCfg=stgCfg, stpInfoRootPort=stpInfoRootPort, stgCurCfgIndex=stgCurCfgIndex, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlan=vlan, vlanInfoName=vlanInfoName, fdbVlan=fdbVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacp=lacp, cistInfo=cistInfo, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, fdbStatsFindFails=fdbStatsFindFails, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanCurCfgState=vlanCurCfgState, fdbMacAddr=fdbMacAddr, mstCfg=mstCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgStg=vlanCurCfgStg, trunkgroup=trunkgroup, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoState=portTeamInfoState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortState=cistInfoPortState, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfo=portTeamInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTable=vlanCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsHiwat=fdbStatsHiwat, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoIndex=stpInfoIndex, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRootPathCost=cistRootPathCost, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoLearn=vlanInfoLearn, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, stpInfo=stpInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstGeneralCfg=mstGeneralCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCfg=portTeamCfg, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfo=vlanInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortRole=cistInfoPortRole, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCfg=mstCistCfg, lacpCurPortState=lacpCurPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortTable=cistInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2Stats=layer2Stats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTable=stpInfoTable, lacpInfoPortNtt=lacpInfoPortNtt, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbInfo=fdbInfo, vlanNewCfgStg=vlanNewCfgStg, mstCistBridgeCfg=mstCistBridgeCfg, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbClear=fdbClear, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRoot=cistRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxEnt=vlanMaxEnt, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpStats=stpStats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortTable=lacpInfoPortTable, fdbStats=fdbStats, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPort=cistRootPort, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfo=lacpInfo, fdbTable=fdbTable, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTable=stpInfoPortTable, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistGeneralInfo=cistGeneralInfo, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsStpIndex=stgStatsStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFinds=fdbStatsFinds, fdbStatsCreates=fdbStatsCreates, layer2Oper=layer2Oper, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortState=stpInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgState=vlanNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2Configs=layer2Configs, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortTable=stgStatsPortTable, fdbSrcPort=fdbSrcPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTable=stgCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, layer2Info=layer2Info, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, BridgeId=BridgeId)
