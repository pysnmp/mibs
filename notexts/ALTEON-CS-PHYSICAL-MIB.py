...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, stpInfoRootCost=stpInfoRootCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoRootPort=stpInfoRootPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortIndex=stgNewCfgPortIndex, layer2Configs=layer2Configs, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgState=vlanNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstNewCfgState=mstNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfo=cistInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoHoldTime=stpInfoHoldTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortState=cistInfoPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistGeneralInfo=cistGeneralInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkgroup=trunkgroup, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgStpMode=mstCurCfgStpMode, mstCfg=mstCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoTable=vlanInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbInfo=fdbInfo, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfo=vlanInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, stpStats=stpStats, portTeamCfg=portTeamCfg, lacpNewPortState=lacpNewPortState, cistBridgeMaxAge=cistBridgeMaxAge, fdbStats=fdbStats, stpInfo=stpInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbRefSps=fdbRefSps, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortIndex=stgStatsPortIndex, mstCistCfg=mstCistCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgState=mstCurCfgState, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoLearn=vlanInfoLearn, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgDelete=portTeamNewCfgDelete, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTable=cistInfoPortTable, mirrPortMirr=mirrPortMirr, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirroring=mirroring, vlanInfoPorts=vlanInfoPorts, portTeamInfoState=portTeamInfoState, fdbState=fdbState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoName=vlanInfoName, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbVlan=fdbVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortLinkType=cistInfoPortLinkType, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfo=portTeamInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbEntry=fdbEntry, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, PYSNMP_MODULE_ID=layer2, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoId=vlanInfoId, BridgeId=BridgeId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbClear=fdbClear, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortLinkType=stpInfoPortLinkType, cistRoot=cistRoot, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoStatus=vlanInfoStatus, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, vlanCurCfgState=vlanCurCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgTable=vlanNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, fdbSrcPort=fdbSrcPort, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoIndex=stpInfoIndex, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRootPort=cistRootPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacp=lacp, stpInfoPortEdge=stpInfoPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, vlan=vlan, fdbStatsFindFails=fdbStatsFindFails, stpInfoTable=stpInfoTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Info=layer2Info, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCfg=stgCfg, portTeamInfoTable=portTeamInfoTable, fdbTable=fdbTable, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfo=lacpInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Stats=layer2Stats, lacpCurPortState=lacpCurPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortState=stpInfoPortState, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortTable=stpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbMacAddr=fdbMacAddr, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
