...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortState=cistInfoPortState, portTeamInfoIndex=portTeamInfoIndex, fdbMacAddr=fdbMacAddr, stgNewCfgState=stgNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, vlanInfoName=vlanInfoName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistRootPort=cistRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcPort=fdbSrcPort, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfo=vlanInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTable=lacpInfoPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgTable=stgCurCfgTable, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoId=vlanInfoId, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbEntry=fdbEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoTable=vlanInfoTable, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, BridgeId=BridgeId, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoRootPort=stpInfoRootPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTable=stgStatsPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxEnt=vlanMaxEnt, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Info=layer2Info, mirrPortMirr=mirrPortMirr, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlan=vlan, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbInfo=fdbInfo, vlanNewCfgTable=vlanNewCfgTable, mstCistCfg=mstCistCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfo=stpInfo, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgStg=vlanNewCfgStg, stpInfoTable=stpInfoTable, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortTable=stgNewCfgPortTable, layer2Stats=layer2Stats, portTeamCfg=portTeamCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortPriority=cistInfoPortPriority, vlanInfoJumbo=vlanInfoJumbo, vlanInfoStatus=vlanInfoStatus, cistInfo=cistInfo, stpStats=stpStats, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfo=lacpInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, layer2Oper=layer2Oper, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgState=mstCurCfgState, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfo=portTeamInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFinds=fdbStatsFinds, stpInfoTableEntry=stpInfoTableEntry, cistRoot=cistRoot, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsStpIndex=stgStatsStpIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRootPathCost=cistRootPathCost, fdbStatsCreates=fdbStatsCreates, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacp=lacp, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbVlan=fdbVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsLookups=fdbStatsLookups, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Configs=layer2Configs, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbTable=fdbTable, vlanNewCfgState=vlanNewCfgState, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbClear=fdbClear, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCfg=stgCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTable=stgNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, fdbSrcTrunk=fdbSrcTrunk, mstCfg=mstCfg, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbRefSps=fdbRefSps, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStats=fdbStats, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2=layer2, mirroring=mirroring, stpInfoHoldTime=stpInfoHoldTime, trunkgroup=trunkgroup, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgState=vlanCurCfgState)
