...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortRole=stpInfoPortRole, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortTable=stpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbState=fdbState, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgTable=stgCurCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsLookups=fdbStatsLookups, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeMaxAge=cistBridgeMaxAge, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfo=vlanInfo, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoTable=vlanInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2=layer2, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, PYSNMP_MODULE_ID=layer2, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistRoot=cistRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stpInfoTopChanges=stpInfoTopChanges, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsFinds=fdbStatsFinds, vlanInfoBwmContract=vlanInfoBwmContract, mirrPortMirr=mirrPortMirr, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, mstCfg=mstCfg, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortTable=cistInfoPortTable, stpInfoTable=stpInfoTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortState=cistInfoPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRootPort=cistRootPort, stgCurCfgPortState=stgCurCfgPortState, stpInfoIndex=stpInfoIndex, fdbStats=fdbStats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfo=stpInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, vlanInfoStatus=vlanInfoStatus, lacp=lacp, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbMacAddr=fdbMacAddr, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, cistInfoPortRole=cistInfoPortRole, fdbInfo=fdbInfo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Info=layer2Info, stgCfg=stgCfg, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgState=stgCurCfgState, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfo=portTeamInfo, stgNewCfgState=stgNewCfgState, fdbSrcTrunk=fdbSrcTrunk, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbVlan=fdbVlan, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoId=vlanInfoId, fdbRefSps=fdbRefSps, lacpInfoPortNtt=lacpInfoPortNtt, stpStats=stpStats, layer2Stats=layer2Stats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortState=lacpCurPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoState=portTeamInfoState, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPathCost=cistRootPathCost, fdbClear=fdbClear, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCfg=mstCistCfg, mstCurCfgState=mstCurCfgState, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCfg=portTeamCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfo=cistInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkgroup=trunkgroup, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, fdbSrcPort=fdbSrcPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbLearnedPort=fdbLearnedPort, stpInfoPortEdge=stpInfoPortEdge, vlanInfoName=vlanInfoName, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTableEntry=stpInfoPortTableEntry, BridgeId=BridgeId, stgCurCfgPortEdge=stgCurCfgPortEdge, mstGeneralCfg=mstGeneralCfg, lacpInfo=lacpInfo, stpInfoPortState=stpInfoPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortPriority=cistInfoPortPriority, layer2Configs=layer2Configs, mirroring=mirroring, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRegionalRoot=cistRegionalRoot, vlanMaxEnt=vlanMaxEnt, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, fdbTable=fdbTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, fdbEntry=fdbEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgTable=vlanNewCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortTable=stgStatsPortTable, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, stpInfoMaxAge=stpInfoMaxAge, vlan=vlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgDelete=vlanNewCfgDelete, layer2Oper=layer2Oper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot)
