...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgState=mstNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfo=vlanInfo, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, cistGeneralInfo=cistGeneralInfo, vlanNewCfgState=vlanNewCfgState, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortState=stgCurCfgPortState, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, fdbLearnedPort=fdbLearnedPort, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortLinkType=stpInfoPortLinkType, stpInfo=stpInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbSrcPort=fdbSrcPort, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgState=stgCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbState=fdbState, stpInfoPortState=stpInfoPortState, fdbEntry=fdbEntry, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsLookups=fdbStatsLookups, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlan=vlan, mstNewCfgStpMode=mstNewCfgStpMode, PYSNMP_MODULE_ID=layer2, stgNewCfgState=stgNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbRefSps=fdbRefSps, trunkgroup=trunkgroup, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortIndex=stgStatsPortIndex, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoLearn=vlanInfoLearn, layer2Info=layer2Info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoName=vlanInfoName, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfo=cistInfo, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgTable=vlanNewCfgTable, portTeamCfg=portTeamCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoIndex=stpInfoIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbClear=fdbClear, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRootPathCost=cistRootPathCost, mstCistCfg=mstCistCfg, portTeamInfoState=portTeamInfoState, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortState=lacpNewPortState, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoStatus=vlanInfoStatus, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortState=lacpCurPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortTable=stpInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, fdbStatsCreates=fdbStatsCreates, fdbVlan=fdbVlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgState=vlanCurCfgState, lacpInfoPortTable=lacpInfoPortTable, mstCfg=mstCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCfg=stgCfg, lacpInfo=lacpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgTable=stgNewCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, BridgeId=BridgeId, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2=layer2, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRoot=cistRoot, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, portTeamInfo=portTeamInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacp=lacp, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortRole=stpInfoPortRole, vlanInfoPorts=vlanInfoPorts, portTeamInfoTable=portTeamInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbMacAddr=fdbMacAddr, cistInfoPortState=cistInfoPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirroring=mirroring, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, fdbTable=fdbTable, mstCurCfgStpMode=mstCurCfgStpMode, fdbInfo=fdbInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Oper=layer2Oper, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgState=portTeamCurCfgState, fdbStatsOverflows=fdbStatsOverflows, cistRootPort=cistRootPort, lacpInfoPortReadyN=lacpInfoPortReadyN, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTable=stpInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, layer2Stats=layer2Stats, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Configs=layer2Configs, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortIndex=stpInfoPortIndex, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistRegionalRoot=cistRegionalRoot, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStats=fdbStats, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection)
