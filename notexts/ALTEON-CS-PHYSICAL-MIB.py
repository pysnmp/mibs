...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortLinkType=cistInfoPortLinkType, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPriority=stgCurCfgPriority, fdbTable=fdbTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgState=portTeamNewCfgState, vlanInfoId=vlanInfoId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortTable=stgStatsPortTable, mstCistCfg=mstCistCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, mirroring=mirroring, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoRootCost=stpInfoRootCost, cistRoot=cistRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortIndex=stpInfoPortIndex, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlan=vlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mirrPortMirr=mirrPortMirr, portTeamInfoTable=portTeamInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcPort=fdbSrcPort, stpInfoTopChanges=stpInfoTopChanges, fdbVlan=fdbVlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbClear=fdbClear, stpInfoIndex=stpInfoIndex, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortEdge=stpInfoPortEdge, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRegionalRoot=cistRegionalRoot, stpInfoTableEntry=stpInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfo=lacpInfo, cistBridgeMaxAge=cistBridgeMaxAge, lacp=lacp, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, fdbState=fdbState, vlanInfoPorts=vlanInfoPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfo=vlanInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCfg=portTeamCfg, mstCfg=mstCfg, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgTable=stgCurCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbInfo=fdbInfo, vlanCurCfgState=vlanCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsLookups=fdbStatsLookups, fdbRefSps=fdbRefSps, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortLinkType=stpInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, BridgeId=BridgeId, stpInfoMaxAge=stpInfoMaxAge, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoState=portTeamInfoState, stpInfoPortTable=stpInfoPortTable, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, layer2Oper=layer2Oper, stpInfo=stpInfo, fdbStatsOverflows=fdbStatsOverflows, trunkgroup=trunkgroup, vlanNewCfgStg=vlanNewCfgStg, layer2Info=layer2Info, stgNewCfgState=stgNewCfgState, stpStats=stpStats, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgTable=vlanNewCfgTable, cistInfo=cistInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsCurrent=fdbStatsCurrent, stgCfg=stgCfg, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortState=stpInfoPortState, layer2Configs=layer2Configs, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, fdbMacAddr=fdbMacAddr, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, layer2=layer2, lacpNewPortState=lacpNewPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortState=stgNewCfgPortState, fdbStats=fdbStats, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoName=vlanInfoName, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2Stats=layer2Stats, stpInfoTable=stpInfoTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgState=vlanNewCfgState, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfo=portTeamInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpCurPortState=lacpCurPortState, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbEntry=fdbEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, vlanInfoLearn=vlanInfoLearn, cistInfoPortState=cistInfoPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortTable=cistInfoPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortRole=cistInfoPortRole, cistRootPort=cistRootPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost)
