...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortIndex=stgStatsPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfo=vlanInfo, stpInfoRootPort=stpInfoRootPort, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoId=vlanInfoId, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, PYSNMP_MODULE_ID=layer2, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRootPathCost=cistRootPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, cistRoot=cistRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortRole=cistInfoPortRole, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTable=stgCurCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortState=stpInfoPortState, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, layer2Info=layer2Info, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionName=mstCurCfgRegionName, fdbLearnedPort=fdbLearnedPort, fdbEntry=fdbEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoName=vlanInfoName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortState=lacpCurPortState, mstCfg=mstCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbClear=fdbClear, layer2Configs=layer2Configs, stpInfoPortEdge=stpInfoPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsFinds=fdbStatsFinds, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortTable=stpInfoPortTable, mstNewCfgState=mstNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfoState=portTeamInfoState, fdbVlan=fdbVlan, stpInfoTable=stpInfoTable, portTeamCfg=portTeamCfg, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfo=cistInfo, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mirrPortMirr=mirrPortMirr, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, layer2Stats=layer2Stats, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgState=stgNewCfgState, fdbSrcPort=fdbSrcPort, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbTable=fdbTable, cistRootPort=cistRootPort, lacpInfo=lacpInfo, portTeamInfo=portTeamInfo, mstNewCfgStpMode=mstNewCfgStpMode, BridgeId=BridgeId, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoRootCost=stpInfoRootCost, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistBridgeMaxAge=cistBridgeMaxAge, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkgroup=trunkgroup, lacpCurSystemPriority=lacpCurSystemPriority, stgCfg=stgCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortState=cistInfoPortState, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfo=stpInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, fdbMacAddr=fdbMacAddr, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbRefSps=fdbRefSps, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Oper=layer2Oper, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortPriority=stgNewCfgPortPriority, cistRegionalRoot=cistRegionalRoot, stpInfoIndex=stpInfoIndex, fdbStatsFindFails=fdbStatsFindFails, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlan=vlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2=layer2, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgState=mstCurCfgState, mstCistCfg=mstCistCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsDeletes=fdbStatsDeletes)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStats=fdbStats, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpStats=stpStats, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistGeneralInfo=cistGeneralInfo, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacp=lacp, stgNewCfgIndex=stgNewCfgIndex, fdbInfo=fdbInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbState=fdbState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeHelloTime=cistBridgeHelloTime, mstGeneralCfg=mstGeneralCfg, lacpInfoPortReadyN=lacpInfoPortReadyN, mirroring=mirroring, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgState=stgCurCfgState, stgStatsPortTable=stgStatsPortTable)
