...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mirroring=mirroring, fdbStatsOverflows=fdbStatsOverflows, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoState=portTeamInfoState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsCurrent=fdbStatsCurrent, vlan=vlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortTable=stgNewCfgPortTable, fdbVlan=fdbVlan, fdbStatsFinds=fdbStatsFinds, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortIndex=cistInfoPortIndex, stpInfo=stpInfo, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTopChanges=stpInfoTopChanges, vlanInfoPorts=vlanInfoPorts, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfo=cistInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistRegionalPathCost=cistRegionalPathCost, portTeamCfg=portTeamCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mirrPortMirr=mirrPortMirr, fdbMacAddr=fdbMacAddr, fdbState=fdbState, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, stpStats=stpStats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortState=cistInfoPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfo=lacpInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortLink=stgNewCfgPortLink, fdbInfo=fdbInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortState=stpInfoPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgState=stgNewCfgState, layer2Oper=layer2Oper, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, cistGeneralInfo=cistGeneralInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgTable=portTeamCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, layer2Configs=layer2Configs, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Info=layer2Info, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbLearnedPort=fdbLearnedPort, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRootPathCost=cistRootPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortIndex=stgStatsPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortState=lacpCurPortState, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpInfoPortTable=lacpInfoPortTable, vlanInfoId=vlanInfoId, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoLearn=vlanInfoLearn, PYSNMP_MODULE_ID=layer2, stpInfoTable=stpInfoTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, stpInfoIndex=stpInfoIndex, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgPriority=stgCurCfgPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoTable=vlanInfoTable, lacpNewPortState=lacpNewPortState, stgCfg=stgCfg, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRoot=cistRoot, trunkgroup=trunkgroup, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbTable=fdbTable, lacpCurSystemPriority=lacpCurSystemPriority, fdbEntry=fdbEntry, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacp=lacp, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgStg=vlanNewCfgStg, cistRootPort=cistRootPort, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoName=vlanInfoName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, layer2=layer2, vlanInfo=vlanInfo, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistDefaultCfg=mstCistDefaultCfg, BridgeId=BridgeId, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortRole=cistInfoPortRole, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgState=stgCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoTable=portTeamInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortRole=stpInfoPortRole, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCfg=mstCistCfg, fdbStats=fdbStats, mstNewCfgState=mstNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsFindFails=fdbStatsFindFails, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbRefSps=fdbRefSps, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortEdge=stpInfoPortEdge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortLinkType=cistInfoPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsDeletes=fdbStatsDeletes, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCfg=mstCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgState=portTeamNewCfgState, fdbClear=fdbClear, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbSrcPort=fdbSrcPort, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortTable=stgStatsPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, layer2Stats=layer2Stats, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgStg=vlanCurCfgStg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus)
