...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, stpStats=stpStats, mstNewCfgState=mstNewCfgState, fdbStatsDeletes=fdbStatsDeletes, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgStg=vlanNewCfgStg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpNewPortState=lacpNewPortState, stgNewCfgState=stgNewCfgState, fdbStatsLookups=fdbStatsLookups, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, vlanInfoStatus=vlanInfoStatus, mirrPortMirr=mirrPortMirr, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, cistInfo=cistInfo, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoPorts=vlanInfoPorts, portTeamInfoPortsState=portTeamInfoPortsState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Stats=layer2Stats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbInfo=fdbInfo, stgNewCfgPortState=stgNewCfgPortState, fdbStats=fdbStats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistRootPathCost=cistRootPathCost, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, cistGeneralInfo=cistGeneralInfo, layer2Info=layer2Info, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTable=portTeamInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCreates=fdbStatsCreates, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanInfo=vlanInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPriority=cistInfoPortPriority, mstCfg=mstCfg, cistInfoPortIndex=cistInfoPortIndex, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgState=mstCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoName=vlanInfoName, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortRole=cistInfoPortRole, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Configs=layer2Configs, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, fdbClear=fdbClear, cistRoot=cistRoot, cistInfoPortState=cistInfoPortState, vlanInfoTable=vlanInfoTable, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortState=stpInfoPortState, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortTable=stgStatsPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCfg=stgCfg, fdbStatsCurrent=fdbStatsCurrent, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgState=portTeamCurCfgState, stpInfoIndex=stpInfoIndex, PYSNMP_MODULE_ID=layer2, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcPort=fdbSrcPort, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbVlan=fdbVlan, stpInfoRootCost=stpInfoRootCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsStpIndex=stgStatsStpIndex, fdbRefSps=fdbRefSps, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgRegionName=mstCurCfgRegionName, lacp=lacp, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbTable=fdbTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRegionalRoot=cistRegionalRoot, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoTable=stpInfoTable, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoId=vlanInfoId, mstCistCfg=mstCistCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRegionalPathCost=cistRegionalPathCost, lacpInfo=lacpInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTable=stgCurCfgPortTable, cistBridgeMaxAge=cistBridgeMaxAge, trunkgroup=trunkgroup, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortState=lacpCurPortState, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoState=portTeamInfoState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, layer2Oper=layer2Oper, cistRootPort=cistRootPort, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTable=portTeamCurCfgTable, vlan=vlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoPorts=portTeamInfoPorts, stpInfo=stpInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, BridgeId=BridgeId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, stgCurCfgTable=stgCurCfgTable, cistInfoPortTable=cistInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTopChanges=stpInfoTopChanges, fdbState=fdbState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mirroring=mirroring, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistDefaultCfg=mstCistDefaultCfg, fdbEntry=fdbEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfo=portTeamInfo, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootPort=stpInfoRootPort, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgState=stgCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgState=portTeamNewCfgState, portTeamCfg=portTeamCfg)
