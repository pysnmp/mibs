...
ObjectIdentity, MibIdentifier, Counter64, NotificationType, Integer32, iso, Bits, ModuleIdentity, Counter32, Unsigned32, IpAddress, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType", "Integer32", "iso", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookups=fdbStatsLookups, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoState=portTeamInfoState, stgStatsPortIndex=stgStatsPortIndex, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRegionalRoot=cistRegionalRoot, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortEdge=stpInfoPortEdge, vlanMaxEnt=vlanMaxEnt, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgState=stgNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbVlan=fdbVlan, stpInfoPortTable=stpInfoPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgState=stgCurCfgState, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbRefSps=fdbRefSps, layer2Stats=layer2Stats, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2=layer2, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, vlanInfoTable=vlanInfoTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoMaxAge=stpInfoMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgState=mstCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, fdbStats=fdbStats, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCfg=mstCistCfg, stgCurCfgPortState=stgCurCfgPortState, layer2Configs=layer2Configs, fdbStatsFindFails=fdbStatsFindFails, fdbState=fdbState, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Oper=layer2Oper, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfo=vlanInfo, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, layer2Info=layer2Info, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfo=portTeamInfo, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpNewPortState=lacpNewPortState, PYSNMP_MODULE_ID=layer2, vlanNewCfgState=vlanNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbInfo=fdbInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbSrcPort=fdbSrcPort, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistRootPathCost=cistRootPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoRootPort=stpInfoRootPort, cistRoot=cistRoot, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, fdbLearnedPort=fdbLearnedPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoName=vlanInfoName, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTable=lacpInfoPortTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mirroring=mirroring, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, cistRootPort=cistRootPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, BridgeId=BridgeId, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, fdbTable=fdbTable, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgTable=stgNewCfgTable, cistInfoPortState=cistInfoPortState, trunkgroup=trunkgroup, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurPortState=lacpCurPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlan=vlan, stpInfoPortIndex=stpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbClear=fdbClear, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoJumbo=vlanInfoJumbo, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfo=cistInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPriority=stgCurCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoTable=stpInfoTable, lacp=lacp, lacpInfoPortNtt=lacpInfoPortNtt, stpStats=stpStats, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortRole=cistInfoPortRole, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfoStatus=vlanInfoStatus, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfo=stpInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgStg=vlanCurCfgStg, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCfg=mstCfg, stgCfg=stgCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoId=vlanInfoId, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsCreates=fdbStatsCreates, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamCfg=portTeamCfg, stgStatsPortTable=stgStatsPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTopChanges=stpInfoTopChanges)
