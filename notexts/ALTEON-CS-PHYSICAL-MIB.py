...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTable=stpInfoTable, fdbSrcTrunk=fdbSrcTrunk, cistGeneralInfo=cistGeneralInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbRefSps=fdbRefSps, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsCreates=fdbStatsCreates, vlanMaxVlanID=vlanMaxVlanID, lacpInfo=lacpInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlan=vlan, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacp=lacp, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortState=stpInfoPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoIndex=stpInfoIndex, mstCurCfgState=mstCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, fdbMacAddr=fdbMacAddr, cistRegionalPathCost=cistRegionalPathCost, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoId=vlanInfoId, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCfg=mstCistCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoName=vlanInfoName, layer2Oper=layer2Oper, stpInfo=stpInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoTable=vlanInfoTable, vlanInfoStatus=vlanInfoStatus, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsFinds=fdbStatsFinds, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, PYSNMP_MODULE_ID=layer2, mstCistDefaultCfg=mstCistDefaultCfg, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2=layer2, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, BridgeId=BridgeId, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortIndex=stpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgStpMode=mstNewCfgStpMode, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfo=vlanInfo, layer2Configs=layer2Configs, trunkgroup=trunkgroup, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortTable=cistInfoPortTable, cistInfoPortState=cistInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfo=portTeamInfo, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortTable=stpInfoPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbTable=fdbTable, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCfg=stgCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgState=stgCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, fdbVlan=fdbVlan, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbState=fdbState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRoot=cistRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoLearn=vlanInfoLearn, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoTable=portTeamInfoTable, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRootPort=cistRootPort, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, cistInfoPortLinkType=cistInfoPortLinkType, cistRootPathCost=cistRootPathCost, portTeamInfoState=portTeamInfoState, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgState=stgNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortIndex=lacpInfoPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, fdbInfo=fdbInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirroring=mirroring, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgIndex=stgCurCfgIndex, fdbEntry=fdbEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStats=fdbStats, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoTableEntry=stpInfoTableEntry, fdbStatsLookups=fdbStatsLookups, cistInfoPortRole=cistInfoPortRole, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbClear=fdbClear, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortRole=stpInfoPortRole, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCfg=portTeamCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfo=cistInfo, stgCurCfgPriority=stgCurCfgPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortState=lacpCurPortState, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsDeletes=fdbStatsDeletes, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCfg=mstCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, stpStats=stpStats, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2Info=layer2Info, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTrunks=portTeamInfoTrunks, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2Stats=layer2Stats, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay)
