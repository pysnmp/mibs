...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemPriority=lacpCurSystemPriority, mirroring=mirroring, stgNewCfgPriority=stgNewCfgPriority, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgState=vlanCurCfgState, stgCurCfgPriority=stgCurCfgPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortTable=cistInfoPortTable, vlan=vlan, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbMacAddr=fdbMacAddr, fdbState=fdbState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbTable=fdbTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoTable=vlanInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, stpInfoIndex=stpInfoIndex, stpInfoPortRole=stpInfoPortRole, fdbInfo=fdbInfo, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, BridgeId=BridgeId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsDeletes=fdbStatsDeletes, cistRegionalPathCost=cistRegionalPathCost, cistRoot=cistRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStats=fdbStats, stgCurCfgState=stgCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsFinds=fdbStatsFinds, stpInfoPortLinkType=stpInfoPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTable=portTeamInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgTable=stgNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgTable=vlanNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, lacp=lacp, cistInfo=cistInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Configs=layer2Configs, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2Oper=layer2Oper, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanInfo=vlanInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortState=stpInfoPortState, PYSNMP_MODULE_ID=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRootPort=cistRootPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, layer2Stats=layer2Stats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortIndex=cistInfoPortIndex, fdbClear=fdbClear, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCfg=portTeamCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstGeneralCfg=mstGeneralCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgState=stgNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsOverflows=fdbStatsOverflows, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoStatus=vlanInfoStatus, portTeamInfoPorts=portTeamInfoPorts, layer2=layer2, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgState=mstNewCfgState, cistInfoPortPriority=cistInfoPortPriority, trunkgroup=trunkgroup, stpInfo=stpInfo, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoName=vlanInfoName, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, cistRegionalRoot=cistRegionalRoot, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTable=stpInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpStats=stpStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgState=portTeamCurCfgState, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCfg=mstCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, stgCfg=stgCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsLookups=fdbStatsLookups, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbEntry=fdbEntry, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCfg=mstCistCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbVlan=fdbVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortTable=stpInfoPortTable, lacpInfo=lacpInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortRole=cistInfoPortRole, stgNewCfgIndex=stgNewCfgIndex, stpInfoRootCost=stpInfoRootCost, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgState=vlanNewCfgState, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, layer2Info=layer2Info, fdbSrcPort=fdbSrcPort, fdbStatsFindFails=fdbStatsFindFails, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortState=stgCurCfgPortState, fdbRefSps=fdbRefSps, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistGeneralInfo=cistGeneralInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfo=portTeamInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoId=vlanInfoId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mirrPortMirr=mirrPortMirr, cistRootPathCost=cistRootPathCost, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode)
