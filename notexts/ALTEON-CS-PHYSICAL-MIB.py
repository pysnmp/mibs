...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortState=cistInfoPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpInfo=lacpInfo, mstCfg=mstCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRoot=cistRoot, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Stats=layer2Stats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, fdbClear=fdbClear, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoForwardDelay=stpInfoForwardDelay, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortTable=stgStatsPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkgroup=trunkgroup, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoIndex=stpInfoIndex, layer2Oper=layer2Oper, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortEdge=stpInfoPortEdge, cistRootPort=cistRootPort, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortState=stpInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTable=stpInfoTable, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoLearn=vlanInfoLearn, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsHiwat=fdbStatsHiwat, fdbSrcPort=fdbSrcPort, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistGeneralInfo=cistGeneralInfo, stpInfoPortRole=stpInfoPortRole, stgNewCfgState=stgNewCfgState, vlanInfoTable=vlanInfoTable, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgState=vlanNewCfgState, vlanCurCfgStg=vlanCurCfgStg, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoTopChanges=stpInfoTopChanges, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortRole=cistInfoPortRole, vlanInfoId=vlanInfoId, stpStats=stpStats, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbInfo=fdbInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsCreates=fdbStatsCreates, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsFinds=fdbStatsFinds, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgState=stgCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoRootPort=stpInfoRootPort, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfo=portTeamInfo, stpInfoRootCost=stpInfoRootCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbState=fdbState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortTable=cistInfoPortTable, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfo=stpInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgState=vlanCurCfgState, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, fdbLearnedPort=fdbLearnedPort, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgTable=stgCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstNewCfgState=mstNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortLinkType=stpInfoPortLinkType, layer2Info=layer2Info, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbEntry=fdbEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfoStatus=vlanInfoStatus, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsFindFails=fdbStatsFindFails, vlanInfoName=vlanInfoName, stgNewCfgPriority=stgNewCfgPriority, lacp=lacp, fdbTable=fdbTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, BridgeId=BridgeId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfo=vlanInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsLookups=fdbStatsLookups, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, layer2=layer2, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, layer2Configs=layer2Configs, vlan=vlan, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, cistInfo=cistInfo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortState=lacpCurPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbVlan=fdbVlan, stgCurCfgPriority=stgCurCfgPriority, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCfg=stgCfg, mirroring=mirroring, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRootPathCost=cistRootPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstGeneralCfg=mstGeneralCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoState=portTeamInfoState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbRefSps=fdbRefSps, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortPriority=cistInfoPortPriority, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCfg=mstCistCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStats=fdbStats, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgIndex=stgNewCfgIndex, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoPortsState=portTeamInfoPortsState)
