...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortIndex=cistInfoPortIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCfg=mstCistCfg, fdbSrcPort=fdbSrcPort, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanMaxEnt=vlanMaxEnt, vlanNewCfgState=vlanNewCfgState, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortState=stpInfoPortState, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRootPort=cistRootPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, layer2Oper=layer2Oper, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbInfo=fdbInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Configs=layer2Configs, lacpCurPortState=lacpCurPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgState=mstCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortState=stgCurCfgPortState, mirroring=mirroring, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfo=portTeamInfo, vlanNewCfgStg=vlanNewCfgStg, stgCfg=stgCfg, layer2=layer2, cistInfoPortRole=cistInfoPortRole, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbMacAddr=fdbMacAddr, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortIndex=stpInfoPortIndex, mstGeneralCfg=mstGeneralCfg, layer2Stats=layer2Stats, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStats=fdbStats, fdbEntry=fdbEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode, cistRootPathCost=cistRootPathCost, stgNewCfgState=stgNewCfgState, vlan=vlan, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCfg=portTeamCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoLearn=vlanInfoLearn, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfo=cistInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, mstCfg=mstCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortEdge=stpInfoPortEdge, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, cistRoot=cistRoot, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoTable=vlanInfoTable, lacp=lacp, portTeamInfoTable=portTeamInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Info=layer2Info, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoTable=stpInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, BridgeId=BridgeId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbLearnedPort=fdbLearnedPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfo=lacpInfo, fdbVlan=fdbVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoRootPort=stpInfoRootPort, trunkgroup=trunkgroup, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsCreates=fdbStatsCreates, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfo=stpInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTable=stpInfoPortTable, cistRegionalRoot=cistRegionalRoot, vlanInfoId=vlanInfoId, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoState=portTeamInfoState, stgStatsPortTable=stgStatsPortTable, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfo=vlanInfo, fdbRefSps=fdbRefSps, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootCost=stpInfoRootCost, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoPorts=vlanInfoPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamCurCfgState=portTeamCurCfgState, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortState=lacpNewPortState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbTable=fdbTable, cistInfoPortTable=cistInfoPortTable, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbClear=fdbClear, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpStats=stpStats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgVlanName=vlanNewCfgVlanName, mstNewCfgState=mstNewCfgState, portTeamNewCfgState=portTeamNewCfgState, fdbState=fdbState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgState=stgCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort)
