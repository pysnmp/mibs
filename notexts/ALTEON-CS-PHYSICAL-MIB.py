...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbMacAddr=fdbMacAddr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfo=lacpInfo, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, BridgeId=BridgeId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortState=lacpNewPortState, fdbRefSps=fdbRefSps, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Configs=layer2Configs, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfo=vlanInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortState=stgNewCfgPortState, mstCistCfg=mstCistCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgIndex=stgNewCfgIndex, stpInfoTable=stpInfoTable, cistRoot=cistRoot, mstCurCfgState=mstCurCfgState, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, layer2=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTable=portTeamInfoTable, stpStats=stpStats, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoRootPort=stpInfoRootPort, mirroring=mirroring, portTeamInfo=portTeamInfo, stgStatsPortIndex=stgStatsPortIndex, mstCfg=mstCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortState=stpInfoPortState, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgStg=vlanCurCfgStg, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgTable=stgNewCfgTable, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsCurrent=fdbStatsCurrent, PYSNMP_MODULE_ID=layer2, stpInfoPortRole=stpInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbInfo=fdbInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbSrcPort=fdbSrcPort, cistInfoPortState=cistInfoPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, trunkgroup=trunkgroup, layer2Stats=layer2Stats, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgTable=stgCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, fdbStatsLookups=fdbStatsLookups, portTeamInfoState=portTeamInfoState, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistBridgeHelloTime=cistBridgeHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, cistGeneralInfo=cistGeneralInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoTableEntry=vlanInfoTableEntry, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgState=vlanNewCfgState, layer2Info=layer2Info, lacpInfoPortIndex=lacpInfoPortIndex, cistRootPort=cistRootPort, cistRootPathCost=cistRootPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbStatsCreates=fdbStatsCreates, fdbTable=fdbTable, fdbEntry=fdbEntry, stpInfoRootCost=stpInfoRootCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgState=portTeamNewCfgState, mirrPortMirr=mirrPortMirr, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoIndex=stpInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoId=vlanInfoId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoName=vlanInfoName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCfg=stgCfg, lacpInfoPortNtt=lacpInfoPortNtt, cistInfo=cistInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCfg=portTeamCfg, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgStpMode=mstNewCfgStpMode, fdbLearnedPort=fdbLearnedPort, lacp=lacp, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, fdbStatsFinds=fdbStatsFinds, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Oper=layer2Oper, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfo=stpInfo, fdbStats=fdbStats, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRegionalRoot=cistRegionalRoot, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortState=lacpCurPortState, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPriority=cistInfoPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, vlanMaxEnt=vlanMaxEnt, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbClear=fdbClear, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamInfoPorts=portTeamInfoPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsStpIndex=stgStatsStpIndex, stpInfoForwardDelay=stpInfoForwardDelay, fdbState=fdbState, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbVlan=fdbVlan, vlanInfoPorts=vlanInfoPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgState=stgCurCfgState, vlanCurCfgState=vlanCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoTable=vlanInfoTable, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, vlan=vlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstGeneralCfg=mstGeneralCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime)
