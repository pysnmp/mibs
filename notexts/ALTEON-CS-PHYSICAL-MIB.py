...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfo=cistInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, PYSNMP_MODULE_ID=layer2, stpInfoMaxAge=stpInfoMaxAge, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgTable=stgNewCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortState=stpInfoPortState, fdbStatsFinds=fdbStatsFinds, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsCreates=fdbStatsCreates, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgCfg=stgCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpStats=stpStats, trunkgroup=trunkgroup, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbMacAddr=fdbMacAddr, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortRole=stpInfoPortRole, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTopChanges=stpInfoTopChanges, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCfg=portTeamCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoRootPort=stpInfoRootPort, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, layer2=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoPorts=portTeamInfoPorts, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbSrcPort=fdbSrcPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistRegionalPathCost=cistRegionalPathCost, fdbStatsOverflows=fdbStatsOverflows, fdbVlan=fdbVlan, cistRootPathCost=cistRootPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortIndex=cistInfoPortIndex, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, stpInfoPortIndex=stpInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbTable=fdbTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoId=vlanInfoId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbState=fdbState, vlan=vlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortState=lacpNewPortState, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Stats=layer2Stats, stpInfoHoldTime=stpInfoHoldTime, vlanInfoStatus=vlanInfoStatus, layer2Info=layer2Info, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgState=vlanNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, lacp=lacp, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTable=portTeamInfoTable, fdbClear=fdbClear, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistRegionalRoot=cistRegionalRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortRole=cistInfoPortRole, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortState=stgNewCfgPortState, fdbLearnedPort=fdbLearnedPort, portTeamInfo=portTeamInfo, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTable=stpInfoTable, fdbInfo=fdbInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoName=vlanInfoName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirrPortMirr=mirrPortMirr, layer2Configs=layer2Configs, stgNewCfgPriority=stgNewCfgPriority, BridgeId=BridgeId, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanMaxEnt=vlanMaxEnt, mstCurCfgState=mstCurCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstNewCfgState=mstNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortState=cistInfoPortState, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCfg=mstCistCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbRefSps=fdbRefSps, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, stgCurCfgIndex=stgCurCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoRootCost=stpInfoRootCost, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRoot=cistRoot, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCfg=mstCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortTable=lacpInfoPortTable, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortTable=cistInfoPortTable, fdbStats=fdbStats, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfo=stpInfo, stpInfoPortTable=stpInfoPortTable, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbEntry=fdbEntry, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoIndex=stpInfoIndex, vlanInfo=vlanInfo, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgPorts=vlanNewCfgPorts, lacpInfo=lacpInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRootPort=cistRootPort, lacpInfoPortNtt=lacpInfoPortNtt, cistGeneralInfo=cistGeneralInfo)
