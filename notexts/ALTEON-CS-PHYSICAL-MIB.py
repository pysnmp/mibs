...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirroring=mirroring, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoId=vlanInfoId, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTable=stpInfoTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStats=fdbStats, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsDeletes=fdbStatsDeletes, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsLookups=fdbStatsLookups, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortPriority=cistInfoPortPriority, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortIndex=cistInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortRole=cistInfoPortRole, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbEntry=fdbEntry, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistRootPort=cistRootPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, cistRoot=cistRoot, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgState=vlanNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortState=lacpNewPortState, fdbRefSps=fdbRefSps, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbMacAddr=fdbMacAddr, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfo=stpInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgStatsPortTable=stgStatsPortTable, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbTable=fdbTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoRootCost=stpInfoRootCost, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbVlan=fdbVlan, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcTrunk=fdbSrcTrunk, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrPortMirr=mirrPortMirr, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortSelected=lacpInfoPortSelected, layer2Info=layer2Info, portTeamInfoState=portTeamInfoState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbInfo=fdbInfo, layer2Stats=layer2Stats, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoPorts=vlanInfoPorts, mstNewCfgState=mstNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoTable=portTeamInfoTable, layer2=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortRole=stpInfoPortRole, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoName=vlanInfoName, portTeamCurCfgPorts=portTeamCurCfgPorts, mstGeneralCfg=mstGeneralCfg, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbState=fdbState, vlanInfoTable=vlanInfoTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, vlan=vlan, stgCurCfgState=stgCurCfgState, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfo=lacpInfo, stpStats=stpStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortTable=stpInfoPortTable, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfo=cistInfo, trunkgroup=trunkgroup, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgAgingTime=stgNewCfgAgingTime, lacp=lacp, vlanCurCfgLearn=vlanCurCfgLearn, mstCfg=mstCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, BridgeId=BridgeId, portTeamCurCfgState=portTeamCurCfgState, stpInfoTopChanges=stpInfoTopChanges, mstCistCfg=mstCistCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoHoldTime=stpInfoHoldTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgState=mstCurCfgState, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortTable=cistInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTable=stgNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgPortLink=stgNewCfgPortLink, layer2Configs=layer2Configs, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoIndex=stpInfoIndex, fdbClear=fdbClear, portTeamCfg=portTeamCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfo=portTeamInfo, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcPort=fdbSrcPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgRegionName=mstNewCfgRegionName, layer2Oper=layer2Oper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfo=vlanInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPriority=stgNewCfgPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgStg=vlanNewCfgStg, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTable=stgCurCfgTable, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTable=lacpInfoPortTable, cistRegionalRoot=cistRegionalRoot, lacpCurPortState=lacpCurPortState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortState=stpInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgState=stgNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoRootPort=stpInfoRootPort)
