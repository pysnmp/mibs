...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, fdbClear=fdbClear, mirroring=mirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, stgCfg=stgCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, stpInfoRootCost=stpInfoRootCost, fdbStatsOverflows=fdbStatsOverflows, layer2=layer2, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgIndex=stgNewCfgIndex, portTeamInfoTable=portTeamInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewPortState=lacpNewPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, layer2Configs=layer2Configs, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbVlan=fdbVlan, stgNewCfgState=stgNewCfgState, fdbSrcPort=fdbSrcPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, BridgeId=BridgeId, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortState=cistInfoPortState, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsCreates=fdbStatsCreates, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, layer2Info=layer2Info, mstCistBridgeCfg=mstCistBridgeCfg, stpStats=stpStats, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCfg=portTeamCfg, portTeamInfoState=portTeamInfoState, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgTable=stgNewCfgTable, vlanMaxVlanID=vlanMaxVlanID, vlan=vlan, cistInfo=cistInfo, stpInfoTableEntry=stpInfoTableEntry, fdbEntry=fdbEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsDeletes=fdbStatsDeletes, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbMacAddr=fdbMacAddr, fdbState=fdbState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, mirrPortMirr=mirrPortMirr, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStats=fdbStats, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistGeneralInfo=cistGeneralInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgState=mstCurCfgState, lacpInfoPortTable=lacpInfoPortTable, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoJumbo=vlanInfoJumbo, vlanInfoName=vlanInfoName, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoId=vlanInfoId, mstCistCfg=mstCistCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortIndex=cistInfoPortIndex, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFindFails=fdbStatsFindFails, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, mstCfg=mstCfg, layer2Oper=layer2Oper, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoIndex=stpInfoIndex, stpInfoPortTable=stpInfoPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, fdbTable=fdbTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfo=lacpInfo, lacpInfoPortNtt=lacpInfoPortNtt, fdbRefSps=fdbRefSps, stpInfoTable=stpInfoTable, cistRootPort=cistRootPort, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgState=vlanNewCfgState, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoPorts=vlanInfoPorts, cistInfoPortTable=cistInfoPortTable, stpInfo=stpInfo, vlanMaxEnt=vlanMaxEnt, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortSelected=lacpInfoPortSelected, fdbLearnedPort=fdbLearnedPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgState=stgCurCfgState, fdbStatsLookups=fdbStatsLookups, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortState=lacpCurPortState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgState=vlanCurCfgState, stpInfoRootPort=stpInfoRootPort, vlanInfoStatus=vlanInfoStatus, vlanInfo=vlanInfo, layer2Stats=layer2Stats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, cistRoot=cistRoot, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgStpMode=mstCurCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortIndex=stpInfoPortIndex, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortEdge=stpInfoPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPriority=stgNewCfgPriority, fdbInfo=fdbInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacp=lacp, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, portTeamInfo=portTeamInfo, cistRootPathCost=cistRootPathCost, cistRegionalRoot=cistRegionalRoot, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay)
