...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoTrunks=portTeamInfoTrunks, layer2=layer2, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, fdbSrcTrunk=fdbSrcTrunk, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortIndex=cistInfoPortIndex, cistInfo=cistInfo, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfo=lacpInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoRootPort=stpInfoRootPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2Oper=layer2Oper, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgTable=stgCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfo=portTeamInfo, mstCistBridgeCfg=mstCistBridgeCfg, fdbClear=fdbClear, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Stats=layer2Stats, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpCurPortState=lacpCurPortState, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgState=stgNewCfgState, stpInfoIndex=stpInfoIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortState=stpInfoPortState, stpInfoTable=stpInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, stpStats=stpStats, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoState=portTeamInfoState, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCfg=mstCistCfg, vlanInfoName=vlanInfoName, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortRole=cistInfoPortRole, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortTable=stgNewCfgPortTable, fdbEntry=fdbEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTable=cistInfoPortTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCfg=stgCfg, fdbState=fdbState, stpInfoTableEntry=stpInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortState=cistInfoPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRoot=cistRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoLearn=vlanInfoLearn, fdbStatsLookups=fdbStatsLookups, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanInfoPorts=vlanInfoPorts, vlanNewCfgState=vlanNewCfgState, layer2Configs=layer2Configs, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistGeneralInfo=cistGeneralInfo, portTeamCfg=portTeamCfg, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCurCfgRegionName=mstCurCfgRegionName, fdbLearnedPort=fdbLearnedPort, stgNewCfgPriority=stgNewCfgPriority, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, cistRegionalRoot=cistRegionalRoot, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgTable=vlanCurCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, BridgeId=BridgeId, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mirrPortMirr=mirrPortMirr, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanMaxEnt=vlanMaxEnt, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoPorts=portTeamInfoPorts, vlanInfoTable=vlanInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCfg=mstCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfo=stpInfo, fdbInfo=fdbInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, fdbStatsCurrent=fdbStatsCurrent, fdbVlan=fdbVlan, trunkgroup=trunkgroup, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStats=fdbStats, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbTable=fdbTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRootPort=cistRootPort, fdbRefSps=fdbRefSps, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfo=vlanInfo, layer2Info=layer2Info, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistRootPathCost=cistRootPathCost, vlan=vlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsDeletes=fdbStatsDeletes, cistBridgeForwardDelay=cistBridgeForwardDelay, lacp=lacp, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgState=mstCurCfgState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortIndex=stgStatsPortIndex, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoId=vlanInfoId, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoJumbo=vlanInfoJumbo, vlanInfoTableEntry=vlanInfoTableEntry, PYSNMP_MODULE_ID=layer2, fdbSrcPort=fdbSrcPort, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgTable=stgNewCfgTable, stpInfoRootCost=stpInfoRootCost, lacpNewPortState=lacpNewPortState, fdbStatsCreates=fdbStatsCreates, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
