...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTopChanges=stpInfoTopChanges, portTeamCfg=portTeamCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoIndex=stpInfoIndex, fdbStatsLookups=fdbStatsLookups, stpInfoHelloTime=stpInfoHelloTime, vlanInfoLearn=vlanInfoLearn, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgStpMode=mstCurCfgStpMode, layer2=layer2, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoState=portTeamInfoState, mirroring=mirroring, vlanNewCfgTable=vlanNewCfgTable, layer2Configs=layer2Configs, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgState=vlanNewCfgState, stpInfoTable=stpInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpStats=stpStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbInfo=fdbInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacp=lacp, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsStpIndex=stgStatsStpIndex, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortTable=stpInfoPortTable, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbRefSps=fdbRefSps, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkgroup=trunkgroup, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, layer2Info=layer2Info, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistGeneralInfo=cistGeneralInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbClear=fdbClear, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCfg=mstCistCfg, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTable=portTeamInfoTable, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbVlan=fdbVlan, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoPorts=vlanInfoPorts, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistRoot=cistRoot, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mirrPortMirr=mirrPortMirr, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfo=lacpInfo, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoRootPort=stpInfoRootPort, fdbStatsDeletes=fdbStatsDeletes, fdbSrcTrunk=fdbSrcTrunk, mstCfg=mstCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortRole=cistInfoPortRole, fdbLearnedPort=fdbLearnedPort, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgTable=stgNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, PYSNMP_MODULE_ID=layer2, mstCurCfgState=mstCurCfgState, cistInfoPortState=cistInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoTableEntry=vlanInfoTableEntry, BridgeId=BridgeId, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcPort=fdbSrcPort, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbTable=fdbTable, vlanInfoName=vlanInfoName, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfo=vlanInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlan=vlan, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2Stats=layer2Stats, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoId=vlanInfoId, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTable=vlanInfoTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsOverflows=fdbStatsOverflows, fdbState=fdbState, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStats=fdbStats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsFinds=fdbStatsFinds, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfo=stpInfo, fdbEntry=fdbEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfo=cistInfo, portTeamInfo=portTeamInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistRootPort=cistRootPort, fdbStatsCreates=fdbStatsCreates)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Oper=layer2Oper, vlanMaxEnt=vlanMaxEnt, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortNtt=lacpInfoPortNtt, mstGeneralCfg=mstGeneralCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgState=portTeamNewCfgState, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfoBwmContract=vlanInfoBwmContract, stgCfg=stgCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortState=lacpCurPortState, mstNewCfgState=mstNewCfgState)
