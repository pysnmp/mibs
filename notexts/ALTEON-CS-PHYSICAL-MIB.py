...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlan=vlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoTrunks=portTeamInfoTrunks, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoIndex=stpInfoIndex, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCfg=portTeamCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfo=cistInfo, lacpCurPortState=lacpCurPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortTable=stpInfoPortTable, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortPathCost=cistInfoPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbLearnedPort=fdbLearnedPort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Configs=layer2Configs, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, fdbMacAddr=fdbMacAddr, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, PYSNMP_MODULE_ID=layer2, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfo=vlanInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfo=lacpInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpStats=stpStats, portTeamInfoState=portTeamInfoState, stpInfoRootPort=stpInfoRootPort, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoId=vlanInfoId, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoRootCost=stpInfoRootCost, fdbStatsDeletes=fdbStatsDeletes, fdbVlan=fdbVlan, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgState=stgCurCfgState, mstCistCfg=mstCistCfg, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, mstGeneralCfg=mstGeneralCfg, cistRootPathCost=cistRootPathCost, fdbClear=fdbClear, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbEntry=fdbEntry, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, lacp=lacp, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortNtt=lacpInfoPortNtt, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgState=mstNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, BridgeId=BridgeId, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfoPortSelected=lacpInfoPortSelected, cistGeneralInfo=cistGeneralInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoMaxAge=stpInfoMaxAge, stpInfo=stpInfo, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortState=stpInfoPortState, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgStg=vlanNewCfgStg, trunkgroup=trunkgroup, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbState=fdbState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsFinds=fdbStatsFinds, cistRootPort=cistRootPort, layer2=layer2, stpInfoPortLinkType=stpInfoPortLinkType, fdbInfo=fdbInfo, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortState=cistInfoPortState, layer2Stats=layer2Stats, layer2Info=layer2Info, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsCreates=fdbStatsCreates, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoPorts=vlanInfoPorts, mirroring=mirroring, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoTable=stpInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoLearn=vlanInfoLearn, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, fdbRefSps=fdbRefSps, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPorts=portTeamInfoPorts, vlanInfoName=vlanInfoName, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, stgCfg=stgCfg, fdbSrcPort=fdbSrcPort, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortRole=stpInfoPortRole, fdbStats=fdbStats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Oper=layer2Oper, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTable=portTeamInfoTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPriority=stgNewCfgPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsFindFails=fdbStatsFindFails, portTeamInfo=portTeamInfo, lacpNewPortState=lacpNewPortState, fdbTable=fdbTable, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoTable=vlanInfoTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRoot=cistRoot, mstCfg=mstCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCurCfgPorts=portTeamCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistBridgeCfg=mstCistBridgeCfg, mirrPortMirr=mirrPortMirr)
