...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHoldTime=stpInfoHoldTime, portTeamInfo=portTeamInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortRole=stpInfoPortRole, layer2Stats=layer2Stats, stpInfoTopChanges=stpInfoTopChanges, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfo=vlanInfo, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortIndex=cistInfoPortIndex, stpStats=stpStats, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCurCfgState=mstCurCfgState, portTeamInfoState=portTeamInfoState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, cistRootPort=cistRootPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbClear=fdbClear, fdbInfo=fdbInfo, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfoPorts=vlanInfoPorts, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbSrcPort=fdbSrcPort, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistDefaultCfg=mstCistDefaultCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortTable=stgStatsPortTable, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsCurrent=fdbStatsCurrent, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbRefSps=fdbRefSps, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCfg=stgCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCfg=mstCistCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, layer2Info=layer2Info, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoName=vlanInfoName, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfo=lacpInfo, stpInfoIndex=stpInfoIndex, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgTable=stgNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, mstCfg=mstCfg, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRoot=cistRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoRootCost=stpInfoRootCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistBridgeCfg=mstCistBridgeCfg, portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxVlanID=vlanMaxVlanID, lacp=lacp, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstNewCfgState=mstNewCfgState, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsOverflows=fdbStatsOverflows, fdbTable=fdbTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2Configs=layer2Configs, lacpNewPortState=lacpNewPortState, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfo=cistInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTable=stpInfoTable, fdbVlan=fdbVlan, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoHelloTime=stpInfoHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mirrPortMirr=mirrPortMirr, vlanMaxEnt=vlanMaxEnt, lacpCurPortState=lacpCurPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, cistRootPathCost=cistRootPathCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortRole=cistInfoPortRole, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortEdge=stpInfoPortEdge, layer2Oper=layer2Oper, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCfg=portTeamCfg, mstGeneralCfg=mstGeneralCfg, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoId=vlanInfoId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoRootPort=stpInfoRootPort, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsLookups=fdbStatsLookups, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortState=cistInfoPortState, fdbStatsDeletes=fdbStatsDeletes, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgState=stgCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, fdbStats=fdbStats, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCurCfgRegionVersion=mstCurCfgRegionVersion)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, stpInfo=stpInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, PYSNMP_MODULE_ID=layer2, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, vlanInfoTable=vlanInfoTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStatsCreates=fdbStatsCreates, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlan=vlan, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkgroup=trunkgroup, fdbEntry=fdbEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgState=stgNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
