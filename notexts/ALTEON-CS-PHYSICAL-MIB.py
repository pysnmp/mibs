...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbVlan=fdbVlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoId=vlanInfoId, layer2Info=layer2Info, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkgroup=trunkgroup, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoRootPort=stpInfoRootPort, cistRoot=cistRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortIndex=cistInfoPortIndex, fdbStatsFinds=fdbStatsFinds, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbInfo=fdbInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbRefSps=fdbRefSps, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortMoved=lacpInfoPortMoved, cistRootPathCost=cistRootPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCfg=portTeamCfg, vlanInfoTable=vlanInfoTable, mstCfg=mstCfg, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, vlanInfoLearn=vlanInfoLearn, fdbStatsDeletes=fdbStatsDeletes, portTeamInfo=portTeamInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoIndex=stpInfoIndex, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, cistRegionalRoot=cistRegionalRoot, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgStg=vlanCurCfgStg, fdbMacAddr=fdbMacAddr, stgCfg=stgCfg, stpInfo=stpInfo, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortState=lacpNewPortState, cistInfoPortPathCost=cistInfoPortPathCost, PYSNMP_MODULE_ID=layer2, cistInfoPortState=cistInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoRootCost=stpInfoRootCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mirrPortMirr=mirrPortMirr, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbState=fdbState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgState=stgCurCfgState, cistInfo=cistInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, layer2Configs=layer2Configs, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsCreates=fdbStatsCreates, vlanInfo=vlanInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortTable=stpInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, vlanMaxVlanID=vlanMaxVlanID, cistGeneralInfo=cistGeneralInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, layer2Stats=layer2Stats, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, mstCurCfgState=mstCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, vlanMaxEnt=vlanMaxEnt, fdbEntry=fdbEntry, cistRootPort=cistRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbSrcPort=fdbSrcPort, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortLink=stgNewCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortRole=cistInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, vlan=vlan, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2Oper=layer2Oper, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgState=mstNewCfgState, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoState=portTeamInfoState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpStats=stpStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacp=lacp, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStats=fdbStats, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgState=portTeamCurCfgState, stpInfoTable=stpInfoTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortTable=stgStatsPortTable, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfo=lacpInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCfg=mstCistCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, BridgeId=BridgeId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortState=lacpCurPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoName=vlanInfoName, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mirroring=mirroring, cistBridgeMaxAge=cistBridgeMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstGeneralCfg=mstGeneralCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbClear=fdbClear, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex)
