...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgDelete=portTeamNewCfgDelete, mstCfg=mstCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Oper=layer2Oper, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoRootPort=stpInfoRootPort, mstCistCfg=mstCistCfg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpStats=stpStats, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortRole=cistInfoPortRole, lacpCurPortState=lacpCurPortState, PYSNMP_MODULE_ID=layer2, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTable=stpInfoPortTable, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRegionalRoot=cistRegionalRoot, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortState=stgNewCfgPortState, vlan=vlan, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgState=mstNewCfgState, portTeamInfo=portTeamInfo, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, lacp=lacp, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, BridgeId=BridgeId, stgCfg=stgCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfoPortTable=cistInfoPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoIndex=stpInfoIndex, portTeamInfoPorts=portTeamInfoPorts, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirroring=mirroring, vlanNewCfgState=vlanNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoState=portTeamInfoState, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRootPort=cistRootPort, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbEntry=fdbEntry, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbInfo=fdbInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgState=stgCurCfgState, vlanCurCfgStg=vlanCurCfgStg, vlanMaxEnt=vlanMaxEnt, stgCurCfgIndex=stgCurCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbClear=fdbClear, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgState=portTeamCurCfgState, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootCost=stpInfoRootCost, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfo=lacpInfo, trunkgroup=trunkgroup, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoStatus=vlanInfoStatus, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstGeneralCfg=mstGeneralCfg, fdbRefSps=fdbRefSps, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, layer2Configs=layer2Configs, vlanCurCfgState=vlanCurCfgState, stpInfo=stpInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbSrcPort=fdbSrcPort, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgState=stgNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistGeneralInfo=cistGeneralInfo, layer2Stats=layer2Stats, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeMaxAge=cistBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfo=vlanInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, fdbStats=fdbStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Info=layer2Info, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortRole=stpInfoPortRole, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortState=cistInfoPortState, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgState=mstCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamInfoIndex=portTeamInfoIndex, fdbState=fdbState, stpInfoTableEntry=stpInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, mirrPortMirr=mirrPortMirr, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbLearnedPort=fdbLearnedPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfo=cistInfo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbVlan=fdbVlan, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTable=vlanInfoTable, portTeamCfg=portTeamCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortPathCost=stpInfoPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFinds=fdbStatsFinds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsHiwat=fdbStatsHiwat, layer2=layer2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, vlanInfoId=vlanInfoId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortIndex=cistInfoPortIndex, vlanInfoName=vlanInfoName, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, fdbTable=fdbTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex)
