...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Configs=layer2Configs, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistRootPort=cistRootPort, fdbInfo=fdbInfo, fdbMacAddr=fdbMacAddr, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortTable=lacpInfoPortTable, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgState=stgCurCfgState, cistBridgeMaxAge=cistBridgeMaxAge, layer2Info=layer2Info, cistRegionalRoot=cistRegionalRoot, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFinds=fdbStatsFinds, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCurCfgState=mstCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortTable=stpInfoPortTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortTable=cistInfoPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbRefSps=fdbRefSps, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, mstCfg=mstCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoRootPort=stpInfoRootPort, stgNewCfgStgIndex=stgNewCfgStgIndex, BridgeId=BridgeId, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistGeneralInfo=cistGeneralInfo, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgState=vlanNewCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortState=stpInfoPortState, cistRegionalPathCost=cistRegionalPathCost, cistRoot=cistRoot, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTable=stpInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoIndex=stpInfoIndex, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoTable=vlanInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, mstCurCfgRegionName=mstCurCfgRegionName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCfg=mstCistCfg, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoState=portTeamInfoState, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stpStats=stpStats, stpInfo=stpInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2=layer2, cistInfo=cistInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mirroring=mirroring, cistRootPathCost=cistRootPathCost, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortState=lacpNewPortState, stgCurCfgPriority=stgCurCfgPriority, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoStatus=vlanInfoStatus, vlanCurCfgState=vlanCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbState=fdbState, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Stats=layer2Stats, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoName=vlanInfoName, vlanNewCfgTable=vlanNewCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgIndex=stgNewCfgIndex, portTeamCfg=portTeamCfg, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStats=fdbStats, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, fdbClear=fdbClear, stgNewCfgTable=stgNewCfgTable, fdbTable=fdbTable, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlan=vlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, fdbVlan=fdbVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfo=vlanInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbEntry=fdbEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgState=mstNewCfgState, stgStatsPortIndex=stgStatsPortIndex, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortState=cistInfoPortState, fdbStatsLookups=fdbStatsLookups, mirrPortMirr=mirrPortMirr, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTable=portTeamInfoTable, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCfg=stgCfg, layer2Oper=layer2Oper, lacpInfo=lacpInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfo=portTeamInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoPorts=vlanInfoPorts, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgTable=stgCurCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortIndex=lacpInfoPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortState=lacpCurPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgPorts=vlanNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgState=stgNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortIndex=stpInfoPortIndex, vlanInfoId=vlanInfoId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkgroup=trunkgroup, lacp=lacp, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoTableEntry=stpInfoTableEntry, vlanInfoLearn=vlanInfoLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxEnt=vlanMaxEnt, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost)
