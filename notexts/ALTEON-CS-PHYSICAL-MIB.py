...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortTable=stpInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoStatus=vlanInfoStatus, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, BridgeId=BridgeId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortState=stpInfoPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkgroup=trunkgroup, fdbState=fdbState, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbTable=fdbTable, stpStats=stpStats, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgLearn=vlanCurCfgLearn, portTeamCurCfgState=portTeamCurCfgState, vlanInfoName=vlanInfoName, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrPortMirr=mirrPortMirr, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, portTeamCfg=portTeamCfg, cistRootPathCost=cistRootPathCost, mstCfg=mstCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortIndex=stgStatsPortIndex, stpInfoIndex=stpInfoIndex, stpInfoHelloTime=stpInfoHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoId=vlanInfoId, cistInfo=cistInfo, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2=layer2, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTable=stpInfoTable, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, layer2Oper=layer2Oper, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbMacAddr=fdbMacAddr, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, lacpCurPortState=lacpCurPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbVlan=fdbVlan, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, fdbLearnedPort=fdbLearnedPort, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoState=portTeamInfoState, portTeamInfo=portTeamInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgState=mstCurCfgState, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirroring=mirroring, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortState=cistInfoPortState, lacpNewPortState=lacpNewPortState, vlanInfo=vlanInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbInfo=fdbInfo, stgCfg=stgCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsLookups=fdbStatsLookups, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoRootPort=stpInfoRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsCurrent=fdbStatsCurrent, fdbSrcPort=fdbSrcPort, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindFails=fdbStatsFindFails, cistRoot=cistRoot, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Info=layer2Info, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewPortCfgTable=lacpNewPortCfgTable, layer2Stats=layer2Stats, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, PYSNMP_MODULE_ID=layer2, vlanCurCfgState=vlanCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTrunksState=portTeamInfoTrunksState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoRootCost=stpInfoRootCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgState=stgNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortIndex=cistInfoPortIndex, layer2Configs=layer2Configs, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCfg=mstCistCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRegionalRoot=cistRegionalRoot, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStats=fdbStats, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsStpIndex=stgStatsStpIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsOverflows=fdbStatsOverflows, vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoTable=portTeamInfoTable, fdbRefSps=fdbRefSps, stgNewCfgTable=stgNewCfgTable, cistRegionalPathCost=cistRegionalPathCost, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbClear=fdbClear, vlan=vlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeMaxAge=cistBridgeMaxAge, stpInfo=stpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsFinds=fdbStatsFinds, fdbEntry=fdbEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable, lacp=lacp, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRootPort=cistRootPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsHiwat=fdbStatsHiwat, lacpInfo=lacpInfo)
