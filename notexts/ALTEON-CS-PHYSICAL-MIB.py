...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkgroup=trunkgroup, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoIndex=stpInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgState=mstCurCfgState, vlan=vlan, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgLearn=vlanCurCfgLearn, mirrPortMirr=mirrPortMirr, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, mstNewCfgState=mstNewCfgState, cistInfoPortRole=cistInfoPortRole, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsFinds=fdbStatsFinds, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, fdbState=fdbState, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortRole=stpInfoPortRole, vlanCurCfgState=vlanCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortSelected=lacpInfoPortSelected, cistRoot=cistRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, layer2Stats=layer2Stats, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoJumbo=vlanInfoJumbo, fdbMacAddr=fdbMacAddr, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortEdge=stpInfoPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortIndex=cistInfoPortIndex, cistGeneralInfo=cistGeneralInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbTable=fdbTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, BridgeId=BridgeId, mstCistCfg=mstCistCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortState=lacpCurPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCfg=mstCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, PYSNMP_MODULE_ID=layer2, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoTable=stpInfoTable, cistRootPort=cistRootPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortLinkType=cistInfoPortLinkType, fdbRefSps=fdbRefSps, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoStatus=vlanInfoStatus, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamCfg=portTeamCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStats=fdbStats, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgState=vlanNewCfgState, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, layer2=layer2, vlanInfoId=vlanInfoId, fdbStatsOverflows=fdbStatsOverflows, vlanInfo=vlanInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfo=lacpInfo, portTeamInfoState=portTeamInfoState, stgCurCfgPriority=stgCurCfgPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2Info=layer2Info, mirroring=mirroring, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoIndex=portTeamInfoIndex, fdbSrcPort=fdbSrcPort, fdbStatsLookups=fdbStatsLookups, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgPorts=portTeamCurCfgPorts, layer2Oper=layer2Oper, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoTable=portTeamInfoTable, stgStatsPortTable=stgStatsPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistRegionalRoot=cistRegionalRoot, cistRegionalPathCost=cistRegionalPathCost, vlanInfoLearn=vlanInfoLearn, mstGeneralCfg=mstGeneralCfg, cistInfoPortTable=cistInfoPortTable, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTable=portTeamNewCfgTable, cistRootPathCost=cistRootPathCost, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortState=cistInfoPortState, lacpNewPortState=lacpNewPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoPorts=vlanInfoPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsDeletes=fdbStatsDeletes, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbVlan=fdbVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, lacp=lacp, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, fdbClear=fdbClear, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoName=vlanInfoName, vlanNewCfgLearn=vlanNewCfgLearn, stpInfo=stpInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoBwmContract=vlanInfoBwmContract, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Configs=layer2Configs, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoTable=vlanInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgState=portTeamNewCfgState, cistInfo=cistInfo, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoRootPort=stpInfoRootPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoPortsState=portTeamInfoPortsState, fdbInfo=fdbInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCfg=stgCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoRootCost=stpInfoRootCost, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfo=portTeamInfo)
