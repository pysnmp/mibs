...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortState=stgCurCfgPortState, cistRootPathCost=cistRootPathCost, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanInfo=vlanInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgTable=vlanCurCfgTable, fdbStatsCurrent=fdbStatsCurrent, vlanInfoTable=vlanInfoTable, stgNewCfgPriority=stgNewCfgPriority, lacpInfo=lacpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, layer2Info=layer2Info, fdbVlan=fdbVlan, fdbState=fdbState, cistInfoPortRole=cistInfoPortRole, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortRole=stpInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgState=mstCurCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgPorts=portTeamCurCfgPorts, layer2Configs=layer2Configs, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortIndex=stpInfoPortIndex, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanInfoLearn=vlanInfoLearn, mirrPortMirr=mirrPortMirr, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgTable=portTeamCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStats=fdbStats, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbSrcPort=fdbSrcPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortEdge=stpInfoPortEdge, cistRegionalRoot=cistRegionalRoot, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfo=portTeamInfo, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, lacp=lacp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbMacAddr=fdbMacAddr, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoTable=stpInfoTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbLearnedPort=fdbLearnedPort, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortTable=cistInfoPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgStg=vlanCurCfgStg, mirroring=mirroring, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoIndex=stpInfoIndex, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbClear=fdbClear, fdbEntry=fdbEntry, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCfg=stgCfg, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCfg=mstCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, BridgeId=BridgeId, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoRootCost=stpInfoRootCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRoot=cistRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoStatus=vlanInfoStatus, fdbTable=fdbTable, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCfg=mstCistCfg, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgState=mstNewCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortTable=stgStatsPortTable, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortTable=stpInfoPortTable, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgState=stgCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsStpIndex=stgStatsStpIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsLookups=fdbStatsLookups, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortState=lacpNewPortState, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgTable=vlanNewCfgTable, vlan=vlan, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2Stats=layer2Stats, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsCreates=fdbStatsCreates, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoId=vlanInfoId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfo=stpInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, stpStats=stpStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCurCfgState=portTeamCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoIndex=portTeamInfoIndex, trunkgroup=trunkgroup, cistGeneralInfo=cistGeneralInfo, cistInfoPortState=cistInfoPortState, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Oper=layer2Oper, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbRefSps=fdbRefSps, portTeamInfoState=portTeamInfoState, stpInfoPortStpIndex=stpInfoPortStpIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoName=vlanInfoName, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgDelete=vlanNewCfgDelete, PYSNMP_MODULE_ID=layer2, fdbInfo=fdbInfo, cistInfo=cistInfo, stgNewCfgTable=stgNewCfgTable, portTeamCfg=portTeamCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoHoldTime=stpInfoHoldTime, stpInfoRootPort=stpInfoRootPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgAgingTime=stgNewCfgAgingTime, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable)
