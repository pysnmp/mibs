...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoJumbo=vlanInfoJumbo, vlanInfo=vlanInfo, mstCfg=mstCfg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstGeneralCfg=mstGeneralCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, trunkgroup=trunkgroup, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRoot=cistRoot, cistRootPathCost=cistRootPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlan=vlan, vlanCurCfgStg=vlanCurCfgStg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, stpInfoIndex=stpInfoIndex, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbSrcPort=fdbSrcPort, stpInfoRootPort=stpInfoRootPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbInfo=fdbInfo, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoTable=stpInfoTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbEntry=fdbEntry, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbClear=fdbClear, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortTable=stgCurCfgPortTable, cistInfo=cistInfo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoName=vlanInfoName, cistRootPort=cistRootPort, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpStats=stpStats, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortState=lacpNewPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Info=layer2Info, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacp=lacp, vlanNewCfgTable=vlanNewCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoId=vlanInfoId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsFinds=fdbStatsFinds, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamInfoState=portTeamInfoState, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, layer2Configs=layer2Configs, stgCfg=stgCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, vlanInfoLearn=vlanInfoLearn, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortIndex=lacpInfoPortIndex, mirroring=mirroring, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, BridgeId=BridgeId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoTopChanges=stpInfoTopChanges, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoStatus=vlanInfoStatus, vlanMaxEnt=vlanMaxEnt, fdbStats=fdbStats, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbVlan=fdbVlan, stpInfoPortTable=stpInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbTable=fdbTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTableEntry=stpInfoTableEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbMacAddr=fdbMacAddr, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgIndex=stgCurCfgIndex, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortState=stpInfoPortState, stgCurCfgState=stgCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgState=stgNewCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTable=lacpCurPortCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, PYSNMP_MODULE_ID=layer2, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, layer2Oper=layer2Oper, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbLearnedPort=fdbLearnedPort, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCfg=portTeamCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoPorts=vlanInfoPorts, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgState=portTeamNewCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbStatsOverflows=fdbStatsOverflows)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistGeneralInfo=cistGeneralInfo, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamInfo=portTeamInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, layer2Stats=layer2Stats, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbRefSps=fdbRefSps, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfo=stpInfo, cistInfoPortState=cistInfoPortState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoTable=portTeamInfoTable, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCfg=mstCistCfg, vlanNewCfgVlanId=vlanNewCfgVlanId)
