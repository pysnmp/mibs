...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanId=vlanCurCfgVlanId, cistRootPathCost=cistRootPathCost, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortTable=stpInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTable=stgNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCfg=portTeamCfg, fdbState=fdbState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpInfo=lacpInfo, fdbStatsDeletes=fdbStatsDeletes, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTopChanges=stpInfoTopChanges, fdbInfo=fdbInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgIndex=stgNewCfgIndex, BridgeId=BridgeId, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgState=portTeamNewCfgState, fdbTable=fdbTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCfg=mstCistCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, fdbSrcPort=fdbSrcPort, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgTable=stgCurCfgTable, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgState=vlanNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbMacAddr=fdbMacAddr, vlan=vlan, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoTable=vlanInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoIndex=stpInfoIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Info=layer2Info, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgStpMode=mstNewCfgStpMode, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTable=lacpInfoPortTable, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortLink=stgNewCfgPortLink, mstCistDefaultCfg=mstCistDefaultCfg, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgState=stgCurCfgState, stpInfoPortState=stpInfoPortState, cistRootPort=cistRootPort, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2=layer2, lacp=lacp, trunkgroup=trunkgroup, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsFinds=fdbStatsFinds, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbClear=fdbClear, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoBwmContract=vlanInfoBwmContract, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPriority=stgNewCfgPriority, vlanInfoPorts=vlanInfoPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoState=portTeamInfoState, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortState=lacpCurPortState, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTableEntry=portTeamInfoTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStats=fdbStats, fdbStatsCreates=fdbStatsCreates, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRoot=cistRoot, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, fdbEntry=fdbEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfo=stpInfo, stgStatsPortTable=stgStatsPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Configs=layer2Configs, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCfg=stgCfg, vlanInfoStatus=vlanInfoStatus, mstNewCfgRegionName=mstNewCfgRegionName, layer2Stats=layer2Stats, stpInfoRootCost=stpInfoRootCost, mstCurCfgStpMode=mstCurCfgStpMode, mirroring=mirroring, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTable=stpInfoTable, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfo=vlanInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoLearn=vlanInfoLearn, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgState=mstCurCfgState, fdbRefSps=fdbRefSps, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoRootPort=stpInfoRootPort, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTable=portTeamCurCfgTable, stpStats=stpStats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistGeneralInfo=cistGeneralInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCfg=mstCfg, cistInfoPortTable=cistInfoPortTable, portTeamInfo=portTeamInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortState=cistInfoPortState, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgState=stgNewCfgState, PYSNMP_MODULE_ID=layer2, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbVlan=fdbVlan, vlanInfoJumbo=vlanInfoJumbo, layer2Oper=layer2Oper, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfo=cistInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTable=stgCurCfgPortTable)
