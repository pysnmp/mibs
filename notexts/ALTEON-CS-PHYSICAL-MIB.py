...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Gauge32, Integer32, Counter32, Unsigned32, TimeTicks, iso, Bits, ObjectIdentity, MibIdentifier, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Gauge32", "Integer32", "Counter32", "Unsigned32", "TimeTicks", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortIndex=stgCurCfgPortIndex, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoPorts=vlanInfoPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Oper=layer2Oper, vlanMaxVlanID=vlanMaxVlanID, vlanInfoStatus=vlanInfoStatus, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoName=vlanInfoName, portTeamInfoState=portTeamInfoState, mirroring=mirroring, cistRegionalRoot=cistRegionalRoot, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortIndex=stpInfoPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsHiwat=fdbStatsHiwat, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoTable=stpInfoTable, mstCistCfg=mstCistCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbState=fdbState, cistBridgeHelloTime=cistBridgeHelloTime, stpInfo=stpInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Configs=layer2Configs, stpStats=stpStats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCfg=portTeamCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRootPathCost=cistRootPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstGeneralCfg=mstGeneralCfg, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTable=portTeamInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortState=stpInfoPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, fdbStats=fdbStats, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortRole=cistInfoPortRole, cistInfoPortState=cistInfoPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTable=stgNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbRefSps=fdbRefSps, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortState=lacpCurPortState, fdbInfo=fdbInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortTable=cistInfoPortTable, layer2Stats=layer2Stats, stgCurCfgStgIndex=stgCurCfgStgIndex, cistRoot=cistRoot, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, layer2=layer2, fdbSrcTrunk=fdbSrcTrunk, vlanInfoId=vlanInfoId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfo=vlanInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCfg=stgCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgPorts=vlanNewCfgPorts, stgStatsPortTable=stgStatsPortTable, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfo=lacpInfo, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, cistInfo=cistInfo, fdbTable=fdbTable, vlanInfoTable=vlanInfoTable, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgState=portTeamCurCfgState, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistGeneralInfo=cistGeneralInfo, stgNewCfgState=stgNewCfgState, mstNewCfgRegionName=mstNewCfgRegionName, fdbEntry=fdbEntry, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortTable=stgCurCfgPortTable, vlan=vlan, vlanNewCfgDelete=vlanNewCfgDelete, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, layer2Info=layer2Info, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCfg=mstCfg, mstCurCfgState=mstCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, fdbVlan=fdbVlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbSrcPort=fdbSrcPort, lacp=lacp, BridgeId=BridgeId, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgStg=vlanNewCfgStg, trunkgroup=trunkgroup, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortIndex=cistInfoPortIndex, portTeamInfo=portTeamInfo, stpInfoIndex=stpInfoIndex, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsCreates=fdbStatsCreates, stpInfoRootPort=stpInfoRootPort, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgIndex=stgCurCfgIndex, cistRootPort=cistRootPort)
