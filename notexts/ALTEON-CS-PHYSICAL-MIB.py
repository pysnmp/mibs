...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTable=portTeamInfoTable, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortTable=lacpInfoPortTable, portTeamInfoPorts=portTeamInfoPorts, fdbSrcPort=fdbSrcPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortEdge=stpInfoPortEdge, vlanInfoId=vlanInfoId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, layer2Configs=layer2Configs, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortRole=stpInfoPortRole, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfo=lacpInfo, mstCurCfgStpMode=mstCurCfgStpMode, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoMaxAge=stpInfoMaxAge, cistRootPort=cistRootPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCfg=mstCfg, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbRefSps=fdbRefSps, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortState=stpInfoPortState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortIndex=stpInfoPortIndex, vlanCurCfgTable=vlanCurCfgTable, stpInfoHoldTime=stpInfoHoldTime, vlanInfoBwmContract=vlanInfoBwmContract, fdbEntry=fdbEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPriority=stgCurCfgPriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfo=portTeamInfo, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsLookups=fdbStatsLookups, trunkgroup=trunkgroup, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbMacAddr=fdbMacAddr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoState=portTeamInfoState, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortTable=stpInfoPortTable, lacp=lacp, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge, cistRegionalRoot=cistRegionalRoot, layer2Info=layer2Info, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbTable=fdbTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbVlan=fdbVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistRegionalPathCost=cistRegionalPathCost, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgState=stgNewCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCurCfgState=mstCurCfgState, fdbState=fdbState, cistRootPathCost=cistRootPathCost, PYSNMP_MODULE_ID=layer2, stpInfoTable=stpInfoTable, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortRole=cistInfoPortRole, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, cistRoot=cistRoot, vlanNewCfgState=vlanNewCfgState, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbSrcTrunk=fdbSrcTrunk, stpInfoIndex=stpInfoIndex, stgCfg=stgCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoStatus=vlanInfoStatus, cistInfo=cistInfo, vlanMaxEnt=vlanMaxEnt, fdbInfo=fdbInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortTable=stgStatsPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgState=mstNewCfgState, lacpInfoPortNtt=lacpInfoPortNtt, stpStats=stpStats, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, BridgeId=BridgeId, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, layer2Stats=layer2Stats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Oper=layer2Oper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortTable=cistInfoPortTable, fdbStatsCreates=fdbStatsCreates, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, vlan=vlan, vlanCurCfgStg=vlanCurCfgStg, cistGeneralInfo=cistGeneralInfo, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootCost=stpInfoRootCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbLearnedPort=fdbLearnedPort, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortState=cistInfoPortState, lacpNewPortState=lacpNewPortState, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfo=vlanInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgIndex=stgCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, mirrPortMirr=mirrPortMirr, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgState=stgCurCfgState, stgNewCfgTable=stgNewCfgTable, stgNewCfgPriority=stgNewCfgPriority, fdbClear=fdbClear, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCfg=portTeamCfg, fdbStatsHiwat=fdbStatsHiwat)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2=layer2, stpInfo=stpInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoLearn=vlanInfoLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCfg=mstCistCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mirroring=mirroring, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoName=vlanInfoName, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortMoved=lacpInfoPortMoved, fdbStats=fdbStats, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgVlanId=vlanNewCfgVlanId)
