...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoState=portTeamInfoState, vlanInfoId=vlanInfoId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsCreates=fdbStatsCreates, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFinds=fdbStatsFinds, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortTable=lacpInfoPortTable, cistGeneralInfo=cistGeneralInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortState=stgNewCfgPortState, layer2Oper=layer2Oper, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlan=vlan, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsLookups=fdbStatsLookups, stpInfoPortRole=stpInfoPortRole, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRootPort=cistRootPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCfg=portTeamCfg, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfo=lacpInfo, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortLinkType=stpInfoPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbVlan=fdbVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfo=portTeamInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbRefSps=fdbRefSps, stpInfoRootPort=stpInfoRootPort, fdbStats=fdbStats, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoTopChanges=stpInfoTopChanges, fdbStatsFindFails=fdbStatsFindFails, cistRegionalRoot=cistRegionalRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortState=cistInfoPortState, fdbEntry=fdbEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoForwardDelay=stpInfoForwardDelay, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpStats=stpStats, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, fdbState=fdbState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2Stats=layer2Stats, lacpNewPortState=lacpNewPortState, trunkgroup=trunkgroup, layer2Configs=layer2Configs, PYSNMP_MODULE_ID=layer2, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortRole=cistInfoPortRole, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoHelloTime=stpInfoHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCfg=stgCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, layer2Info=layer2Info, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsHiwat=fdbStatsHiwat, fdbClear=fdbClear, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbLearnedPort=fdbLearnedPort, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgTable=stgNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoLearn=vlanInfoLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortPriority=cistInfoPortPriority, stpInfoIndex=stpInfoIndex, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, BridgeId=BridgeId, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortState=lacpCurPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortTable=stpInfoPortTable, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTable=stgCurCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgState=portTeamCurCfgState, vlanInfo=vlanInfo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsCurrent=fdbStatsCurrent, mstCurCfgState=mstCurCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgTable=vlanCurCfgTable, fdbSrcPort=fdbSrcPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgState=stgNewCfgState, portTeamInfoIndex=portTeamInfoIndex, mirrPortMirr=mirrPortMirr, lacp=lacp, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirroring=mirroring, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoTrunks=portTeamInfoTrunks, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTable=stpInfoTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbInfo=fdbInfo, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPriority=stgCurCfgPriority, cistRoot=cistRoot, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbTable=fdbTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgState=stgCurCfgState, vlanInfoName=vlanInfoName, stpInfoRootCost=stpInfoRootCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRootPathCost=cistRootPathCost, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortState=stpInfoPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPriority=stgNewCfgPriority, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCfg=mstCfg, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCfg=mstCistCfg)
