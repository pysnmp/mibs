...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbEntry=fdbEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortState=stpInfoPortState, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlan=vlan, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, cistRoot=cistRoot, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, fdbState=fdbState, fdbStats=fdbStats, stgCurCfgPortTable=stgCurCfgPortTable, cistRootPathCost=cistRootPathCost, cistInfoPortPathCost=cistInfoPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpStats=stpStats, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCfg=mstCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkgroup=trunkgroup, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoRootCost=stpInfoRootCost, mstCistCfg=mstCistCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, layer2Info=layer2Info, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookups=fdbStatsLookups, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoIndex=stpInfoIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsFinds=fdbStatsFinds, fdbMacAddr=fdbMacAddr, fdbSrcPort=fdbSrcPort, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoName=vlanInfoName, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, BridgeId=BridgeId, mirroring=mirroring, vlanInfo=vlanInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortRole=cistInfoPortRole, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgIndex=stgNewCfgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoMaxAge=stpInfoMaxAge, cistRootPort=cistRootPort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgState=stgNewCfgState, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbTable=fdbTable, fdbRefSps=fdbRefSps, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionName=mstCurCfgRegionName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortState=cistInfoPortState, cistInfoPortTable=cistInfoPortTable, vlanInfoId=vlanInfoId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, lacp=lacp, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Oper=layer2Oper, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRegionalRoot=cistRegionalRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgState=vlanNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, portTeamCfg=portTeamCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortLinkType=stpInfoPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortTable=stgStatsPortTable, lacpCurPortState=lacpCurPortState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgState=mstCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Stats=layer2Stats, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortIndex=stpInfoPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable, layer2=layer2, layer2Configs=layer2Configs, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgState=stgCurCfgState, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfo=portTeamInfo, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfo=cistInfo, fdbInfo=fdbInfo, cistBridgeMaxAge=cistBridgeMaxAge, fdbLearnedPort=fdbLearnedPort, fdbStatsFindFails=fdbStatsFindFails, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, PYSNMP_MODULE_ID=layer2, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortTable=stpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, mirrPortMirr=mirrPortMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgTable=vlanNewCfgTable, stpInfoTable=stpInfoTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoStatus=vlanInfoStatus, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfo=stpInfo, vlanInfoLearn=vlanInfoLearn, stgCfg=stgCfg, lacpNewPortState=lacpNewPortState, fdbStatsLookupFails=fdbStatsLookupFails, fdbClear=fdbClear, fdbVlan=fdbVlan, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfo=lacpInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoHelloTime=stpInfoHelloTime)
