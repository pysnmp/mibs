...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, vlanInfoId=vlanInfoId, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsFindFails=fdbStatsFindFails, trunkgroup=trunkgroup, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortState=cistInfoPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, stpInfoIndex=stpInfoIndex, fdbEntry=fdbEntry, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, layer2Oper=layer2Oper, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Stats=layer2Stats, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCfg=mstCfg, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsLookups=fdbStatsLookups, vlanInfoTable=vlanInfoTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoState=portTeamInfoState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlan=vlan, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortTable=stpInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfo=lacpInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgPortTable=stgCurCfgPortTable, fdbVlan=fdbVlan, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, layer2Configs=layer2Configs, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewSystemPriority=lacpNewSystemPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFinds=fdbStatsFinds, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoStatus=vlanInfoStatus, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfo=portTeamInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgState=mstNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2=layer2, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, mstGeneralCfg=mstGeneralCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgTable=stgNewCfgTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCfg=mstCistCfg, fdbInfo=fdbInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoPorts=vlanInfoPorts, lacpCurPortState=lacpCurPortState, layer2Info=layer2Info, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortState=lacpNewPortState, stgCfg=stgCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoRootCost=stpInfoRootCost, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbMacAddr=fdbMacAddr, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, stpStats=stpStats, stgCurCfgState=stgCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, lacp=lacp, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbTable=fdbTable, portTeamInfoTable=portTeamInfoTable, stpInfo=stpInfo, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbLearnedPort=fdbLearnedPort, vlanInfoLearn=vlanInfoLearn, vlanMaxVlanID=vlanMaxVlanID, cistRoot=cistRoot, stgNewCfgIndex=stgNewCfgIndex, fdbRefSps=fdbRefSps, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfo=cistInfo, BridgeId=BridgeId, fdbClear=fdbClear, stpInfoTable=stpInfoTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfo=vlanInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStats=fdbStats, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistGeneralInfo=cistGeneralInfo, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mirroring=mirroring, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistRootPathCost=cistRootPathCost, cistRegionalRoot=cistRegionalRoot, mstCurCfgState=mstCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, vlanInfoName=vlanInfoName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootPort=stpInfoRootPort, fdbState=fdbState, portTeamCfg=portTeamCfg, portTeamNewCfgState=portTeamNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbSrcPort=fdbSrcPort, vlanMaxEnt=vlanMaxEnt, PYSNMP_MODULE_ID=layer2, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgState=vlanNewCfgState, stpInfoPortRole=stpInfoPortRole, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
