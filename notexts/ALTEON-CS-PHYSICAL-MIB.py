...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgState=stgCurCfgState, lacpCurPortState=lacpCurPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, BridgeId=BridgeId, vlanNewCfgAddPort=vlanNewCfgAddPort, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoTable=portTeamInfoTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanInfoPorts=vlanInfoPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfo=vlanInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkgroup=trunkgroup, vlanMaxVlanID=vlanMaxVlanID, stgCfg=stgCfg, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, stgNewCfgPriority=stgNewCfgPriority, stpStats=stpStats, fdbRefSps=fdbRefSps, fdbStats=fdbStats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, layer2=layer2, fdbStatsOverflows=fdbStatsOverflows, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoId=vlanInfoId, mirroring=mirroring, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortRole=cistInfoPortRole, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoPorts=portTeamInfoPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlan=vlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, mstCistCfg=mstCistCfg, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoTable=stpInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgPorts=vlanNewCfgPorts, portTeamCfg=portTeamCfg, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Oper=layer2Oper, stgNewCfgState=stgNewCfgState, fdbClear=fdbClear, mstCurCfgState=mstCurCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsLookups=fdbStatsLookups, stpInfoPortRole=stpInfoPortRole, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRegionalPathCost=cistRegionalPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, fdbTable=fdbTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, lacp=lacp, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbVlan=fdbVlan, portTeamInfoIndex=portTeamInfoIndex, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoHoldTime=stpInfoHoldTime, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbMacAddr=fdbMacAddr, cistInfoPortState=cistInfoPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortIndex=cistInfoPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoTopChanges=stpInfoTopChanges, stpInfoRootCost=stpInfoRootCost, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbState=fdbState, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, portTeamInfo=portTeamInfo, stpInfo=stpInfo, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoRootPort=stpInfoRootPort, vlanCurCfgState=vlanCurCfgState, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortState=lacpNewPortState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPort=cistRootPort, cistRootPathCost=cistRootPathCost, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxEnt=vlanMaxEnt, cistBridgeHelloTime=cistBridgeHelloTime, fdbInfo=fdbInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Info=layer2Info, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortState=stpInfoPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRegionalRoot=cistRegionalRoot, vlanNewCfgStg=vlanNewCfgStg, fdbLearnedPort=fdbLearnedPort, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoLearn=vlanInfoLearn, fdbSrcTrunk=fdbSrcTrunk, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Stats=layer2Stats, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstGeneralCfg=mstGeneralCfg, stpInfoIndex=stpInfoIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTable=vlanInfoTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgState=mstNewCfgState, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTable=stgStatsPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCfg=mstCfg, stgCurCfgPortPriority=stgCurCfgPortPriority)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoForwardDelay=stpInfoForwardDelay, lacpInfo=lacpInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfo=cistInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoName=vlanInfoName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgState=vlanNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Configs=layer2Configs, fdbStatsDeletes=fdbStatsDeletes, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry)
