...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, fdbVlan=fdbVlan, portTeamCfg=portTeamCfg, fdbRefSps=fdbRefSps, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgState=portTeamNewCfgState, stpInfoRootPort=stpInfoRootPort, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoJumbo=vlanInfoJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoStatus=vlanInfoStatus, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortTable=lacpInfoPortTable, stpInfoTable=stpInfoTable, fdbTable=fdbTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfo=portTeamInfo, stpInfoPortIndex=stpInfoPortIndex, lacpInfo=lacpInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPort=cistRootPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkgroup=trunkgroup, layer2Configs=layer2Configs, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCfg=mstCfg, mstCistCfg=mstCistCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortRole=cistInfoPortRole, mstCurCfgStpMode=mstCurCfgStpMode, PYSNMP_MODULE_ID=layer2, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgTable=stgCurCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfo=cistInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortState=cistInfoPortState, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfo=vlanInfo, portTeamTableMaxSize=portTeamTableMaxSize, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoLearn=vlanInfoLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, BridgeId=BridgeId, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistRoot=cistRoot, mstNewCfgState=mstNewCfgState, vlanCurCfgStg=vlanCurCfgStg, fdbStats=fdbStats, vlanCurCfgPorts=vlanCurCfgPorts, stgStatsPortTable=stgStatsPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsCreates=fdbStatsCreates, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, fdbEntry=fdbEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, cistRegionalRoot=cistRegionalRoot, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgState=stgCurCfgState, vlan=vlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortState=lacpCurPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamCurCfgIndex=portTeamCurCfgIndex, cistGeneralInfo=cistGeneralInfo, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, fdbLearnedPort=fdbLearnedPort, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTable=cistInfoPortTable, vlanInfoName=vlanInfoName, stgCfg=stgCfg, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortRole=stpInfoPortRole, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacp=lacp, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgPorts=portTeamCurCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, cistRootPathCost=cistRootPathCost, stpInfoIndex=stpInfoIndex, layer2=layer2, mirrPortMirr=mirrPortMirr, stgNewCfgTable=stgNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, layer2Oper=layer2Oper, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortPriority=cistInfoPortPriority, stpInfo=stpInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgTable=portTeamNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortEdge=stpInfoPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgState=stgNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, layer2Stats=layer2Stats, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoPorts=vlanInfoPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanCurCfgState=vlanCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoRootCost=stpInfoRootCost, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortTable=stpInfoPortTable, lacpInfoPortSelected=lacpInfoPortSelected, cistRegionalPathCost=cistRegionalPathCost)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoId=vlanInfoId, portTeamInfoTable=portTeamInfoTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortState=stpInfoPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgState=mstCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbSrcPort=fdbSrcPort, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbInfo=fdbInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, fdbClear=fdbClear, stpInfoPortStpIndex=stpInfoPortStpIndex, stpStats=stpStats, cistInfoPortIndex=cistInfoPortIndex, layer2Info=layer2Info, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsLookups=fdbStatsLookups)
