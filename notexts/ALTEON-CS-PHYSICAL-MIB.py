...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoIndex=stpInfoIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCfg=portTeamCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgAgingTime=stgCurCfgAgingTime, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanMaxVlanID=vlanMaxVlanID, stpStats=stpStats, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortTable=stpInfoPortTable, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamInfoState=portTeamInfoState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamNewCfgState=portTeamNewCfgState, fdbRefSps=fdbRefSps, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPriority=stgCurCfgPriority, fdbLearnedPort=fdbLearnedPort, fdbStatsFindFails=fdbStatsFindFails, stpInfoTable=stpInfoTable, vlanInfo=vlanInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgTable=vlanNewCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgTable=stgNewCfgTable, BridgeId=BridgeId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortTable=stgStatsPortTable, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstNewCfgRegionName=mstNewCfgRegionName, mirrPortMirr=mirrPortMirr, vlanCurCfgState=vlanCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, cistRegionalRoot=cistRegionalRoot, vlanInfoBwmContract=vlanInfoBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbInfo=fdbInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstGeneralCfg=mstGeneralCfg, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoForwardDelay=stpInfoForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoId=vlanInfoId, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsFinds=fdbStatsFinds, vlanInfoName=vlanInfoName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcPort=fdbSrcPort, lacpNewPortState=lacpNewPortState, fdbStats=fdbStats, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mirroring=mirroring, trunkgroup=trunkgroup, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCfg=mstCistCfg, portTeamInfoTable=portTeamInfoTable, fdbState=fdbState, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgDelete=vlanNewCfgDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbClear=fdbClear, stgCfg=stgCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTable=vlanInfoTable, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlan=vlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfo=cistInfo, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, layer2Info=layer2Info, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfo=lacpInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2=layer2, stpInfoPortRole=stpInfoPortRole, fdbVlan=fdbVlan, cistGeneralInfo=cistGeneralInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortState=stgNewCfgPortState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamInfoPorts=portTeamInfoPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, layer2Oper=layer2Oper, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootPort=stpInfoRootPort, stpInfoTopChanges=stpInfoTopChanges, stpInfo=stpInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgStg=vlanNewCfgStg, PYSNMP_MODULE_ID=layer2, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfo=portTeamInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, lacp=lacp, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRootPort=cistRootPort, vlanInfoStatus=vlanInfoStatus, stgCurCfgTable=stgCurCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Stats=layer2Stats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgState=mstCurCfgState, fdbEntry=fdbEntry, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortState=cistInfoPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgState=mstNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Configs=layer2Configs, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortRole=cistInfoPortRole, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCfg=mstCfg, cistInfoPortTable=cistInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbMacAddr=fdbMacAddr, vlanInfoPorts=vlanInfoPorts, cistRootPathCost=cistRootPathCost, stpInfoPortState=stpInfoPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId)
