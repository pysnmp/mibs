...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortLink=stgCurCfgPortLink, cistRootPort=cistRootPort, fdbRefSps=fdbRefSps, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoLearn=vlanInfoLearn, portTeamInfoTable=portTeamInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgState=mstCurCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoId=vlanInfoId, stgStatsPortTable=stgStatsPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortEdge=stpInfoPortEdge, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstGeneralCfg=mstGeneralCfg, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgState=mstNewCfgState, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortIndex=cistInfoPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTable=vlanInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgState=stgCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, layer2=layer2, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortIndex=lacpInfoPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, cistRoot=cistRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbTable=fdbTable, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoStatus=vlanInfoStatus, mstCistCfg=mstCistCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortTable=stpInfoPortTable, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgIndex=stgNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfo=lacpInfo, vlanInfo=vlanInfo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCfg=stgCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoJumbo=vlanInfoJumbo, fdbVlan=fdbVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoHelloTime=stpInfoHelloTime, stpStats=stpStats, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortState=lacpCurPortState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgStgIndex=stgNewCfgStgIndex, BridgeId=BridgeId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, mstCfg=mstCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortIndex=stpInfoPortIndex, fdbInfo=fdbInfo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPriority=stgNewCfgPriority, layer2Stats=layer2Stats, stgNewCfgPortState=stgNewCfgPortState, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacp=lacp, fdbStatsCurrent=fdbStatsCurrent, cistRegionalRoot=cistRegionalRoot, fdbStats=fdbStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, fdbState=fdbState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, layer2Configs=layer2Configs, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfo=cistInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Oper=layer2Oper, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgPorts=portTeamNewCfgPorts, vlan=vlan, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, PYSNMP_MODULE_ID=layer2, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortTable=cistInfoPortTable, mirroring=mirroring, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoName=vlanInfoName, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgState=vlanNewCfgState, stgNewCfgTable=stgNewCfgTable, stpInfo=stpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbClear=fdbClear, portTeamNewCfgState=portTeamNewCfgState, stpInfoTable=stpInfoTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsLookups=fdbStatsLookups, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortState=stgCurCfgPortState, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbLearnedPort=fdbLearnedPort, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamInfoTrunks=portTeamInfoTrunks, portTeamTableMaxSize=portTeamTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCfg=portTeamCfg, cistInfoPortPriority=cistInfoPortPriority, portTeamCurCfgState=portTeamCurCfgState, layer2Info=layer2Info, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgState=vlanCurCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoState=portTeamInfoState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, vlanNewCfgVlanId=vlanNewCfgVlanId, cistInfoPortState=cistInfoPortState, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfo=portTeamInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanMaxEnt=vlanMaxEnt, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgState=stgNewCfgState)
