...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoId=vlanInfoId, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCfg=mstCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbEntry=fdbEntry, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamCurCfgState=portTeamCurCfgState, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortState=cistInfoPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCfg=stgCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfo=cistInfo, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, fdbSrcTrunk=fdbSrcTrunk, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgTable=stgNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRegionalPathCost=cistRegionalPathCost, stpStats=stpStats, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgState=portTeamNewCfgState, cistGeneralInfo=cistGeneralInfo, lacpInfo=lacpInfo, trunkgroup=trunkgroup, lacp=lacp, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortState=stpInfoPortState, fdbSrcPort=fdbSrcPort, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbInfo=fdbInfo, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbRefSps=fdbRefSps, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoTable=stpInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRoot=cistRoot, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoRootCost=stpInfoRootCost, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsOverflows=fdbStatsOverflows, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortRole=stpInfoPortRole, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortTable=stpInfoPortTable, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgState=vlanNewCfgState, layer2Stats=layer2Stats, stgCurCfgState=stgCurCfgState, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortRole=cistInfoPortRole, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistDefaultCfg=mstCistDefaultCfg, mstGeneralCfg=mstGeneralCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortTableEntry=lacpInfoPortTableEntry, layer2Info=layer2Info, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortTable=stgStatsPortTable, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfo=vlanInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRootPathCost=cistRootPathCost, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootPort=stpInfoRootPort, layer2Oper=layer2Oper, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfo=portTeamInfo, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortIndex=lacpInfoPortIndex, vlanMaxEnt=vlanMaxEnt, cistRootPort=cistRootPort, portTeamInfoTable=portTeamInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCfg=portTeamCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbClear=fdbClear, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbTable=fdbTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsFindFails=fdbStatsFindFails, vlanInfoTableEntry=vlanInfoTableEntry, portTeamInfoIndex=portTeamInfoIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoIndex=stpInfoIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlan=vlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRegionalRoot=cistRegionalRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsFinds=fdbStatsFinds, vlanInfoStatus=vlanInfoStatus, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortState=lacpCurPortState, layer2Configs=layer2Configs, fdbStats=fdbStats, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoName=vlanInfoName, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsLookups=fdbStatsLookups, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mirroring=mirroring, PYSNMP_MODULE_ID=layer2)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbMacAddr=fdbMacAddr, stpInfoPortIndex=stpInfoPortIndex, fdbVlan=fdbVlan, fdbState=fdbState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, BridgeId=BridgeId, layer2=layer2, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgState=mstCurCfgState, portTeamInfoState=portTeamInfoState, fdbStatsCreates=fdbStatsCreates, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfo=stpInfo, mirrPortMirr=mirrPortMirr, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry)
