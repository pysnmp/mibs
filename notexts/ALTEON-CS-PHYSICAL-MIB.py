...
Integer32, iso, TimeTicks, NotificationType, IpAddress, ObjectIdentity, ModuleIdentity, Gauge32, Counter64, Unsigned32, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter64", "Unsigned32", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbClear=fdbClear, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbSrcTrunk=fdbSrcTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCfg=mstCfg, fdbLearnedPort=fdbLearnedPort, portTeamInfo=portTeamInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoRootCost=stpInfoRootCost, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfo=vlanInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortRole=cistInfoPortRole, lacpInfoPortMoved=lacpInfoPortMoved, fdbMacAddr=fdbMacAddr, vlanCurCfgVlanName=vlanCurCfgVlanName, cistRoot=cistRoot, fdbSrcPort=fdbSrcPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Oper=layer2Oper, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoLearn=vlanInfoLearn, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgState=mstCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, BridgeId=BridgeId, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsStpIndex=stgStatsStpIndex, vlanMaxEnt=vlanMaxEnt, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, layer2Configs=layer2Configs, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgTable=stgCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2=layer2, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCfg=portTeamCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbInfo=fdbInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortTable=stgStatsPortTable, stpInfoPortState=stpInfoPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortIndex=stpInfoPortIndex, trunkgroup=trunkgroup, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Info=layer2Info, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgLearn=vlanCurCfgLearn, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbState=fdbState, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbRefSps=fdbRefSps, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPriority=stgCurCfgPriority, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoTable=stpInfoTable, lacpNewPortState=lacpNewPortState, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortState=lacpCurPortState, stgNewCfgPortLink=stgNewCfgPortLink, stpStats=stpStats, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, lacpInfo=lacpInfo, fdbStatsFinds=fdbStatsFinds, stpInfoMaxAge=stpInfoMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoId=vlanInfoId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, mirroring=mirroring, mstCistCfg=mstCistCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTopChanges=stpInfoTopChanges, PYSNMP_MODULE_ID=layer2, cistGeneralInfo=cistGeneralInfo, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlan=vlan, portTeamInfoState=portTeamInfoState, vlanNewCfgTable=vlanNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2Stats=layer2Stats, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoTable=vlanInfoTable, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStats=fdbStats, vlanNewCfgState=vlanNewCfgState, stgNewCfgState=stgNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbEntry=fdbEntry, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoStatus=vlanInfoStatus, portTeamInfoPortsState=portTeamInfoPortsState, cistRegionalRoot=cistRegionalRoot, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfo=stpInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgState=vlanCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoRootPort=stpInfoRootPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgStg=vlanNewCfgStg, cistInfo=cistInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, fdbVlan=fdbVlan, lacp=lacp, stpInfoIndex=stpInfoIndex, stpInfoPortTable=stpInfoPortTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRootPort=cistRootPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCfg=stgCfg, portTeamCurCfgState=portTeamCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoName=vlanInfoName, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortIndex=stgStatsPortIndex, fdbTable=fdbTable, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortPathCost=stpInfoPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRootPathCost=cistRootPathCost, stpInfoPortRole=stpInfoPortRole, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay)
