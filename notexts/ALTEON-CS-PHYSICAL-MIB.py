...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgState=mstNewCfgState, fdbMacAddr=fdbMacAddr, lacpNewPortState=lacpNewPortState, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgState=mstCurCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, mstGeneralCfg=mstGeneralCfg, fdbStatsLookups=fdbStatsLookups, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoState=portTeamInfoState, stpInfoIndex=stpInfoIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortState=cistInfoPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistRoot=cistRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoPorts=vlanInfoPorts, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbState=fdbState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, PYSNMP_MODULE_ID=layer2, vlanInfoName=vlanInfoName, stgCurCfgIndex=stgCurCfgIndex, fdbStatsCurrent=fdbStatsCurrent, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortState=stpInfoPortState, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortTable=lacpInfoPortTable, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortLinkType=stpInfoPortLinkType, layer2Oper=layer2Oper, vlanInfoLearn=vlanInfoLearn, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfo=lacpInfo, stgNewCfgPortTable=stgNewCfgPortTable, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistGeneralInfo=cistGeneralInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoId=vlanInfoId, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoRootCost=stpInfoRootCost, portTeamInfo=portTeamInfo, fdbClear=fdbClear, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbSrcPort=fdbSrcPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTable=stgStatsPortTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCfg=portTeamCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortLinkType=cistInfoPortLinkType, fdbLearnedPort=fdbLearnedPort, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgState=vlanNewCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Info=layer2Info, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortState=stgNewCfgPortState, stpStats=stpStats, fdbEntry=fdbEntry, cistRegionalRoot=cistRegionalRoot, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgTable=vlanCurCfgTable, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgState=portTeamNewCfgState, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortPathCost=stpInfoPortPathCost, trunkgroup=trunkgroup, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, BridgeId=BridgeId, stpInfo=stpInfo, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTable=stpInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, mirroring=mirroring, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCfg=mstCistCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgState=vlanCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootPort=stpInfoRootPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Configs=layer2Configs, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpInfoPortMoved=lacpInfoPortMoved, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbRefSps=fdbRefSps, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortRole=stpInfoPortRole, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Stats=layer2Stats, mstCurCfgStpMode=mstCurCfgStpMode, vlanInfoStatus=vlanInfoStatus, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfo=vlanInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRootPort=cistRootPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbVlan=fdbVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacp=lacp, fdbInfo=fdbInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2=layer2, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTable=cistInfoPortTable, vlan=vlan, vlanMaxEnt=vlanMaxEnt, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfoJumbo=vlanInfoJumbo, mstCfg=mstCfg, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbTable=fdbTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStats=fdbStats, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgTable=stgCurCfgTable)
