...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTable=stpInfoTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCfg=portTeamCfg, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, stpInfo=stpInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbRefSps=fdbRefSps, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoId=vlanInfoId, vlanInfoPorts=vlanInfoPorts, mstCfg=mstCfg, stgStatsPortTable=stgStatsPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStats=fdbStats, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, cistGeneralInfo=cistGeneralInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewPortState=lacpNewPortState, stgNewCfgPriority=stgNewCfgPriority, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, mstGeneralCfg=mstGeneralCfg, fdbSrcPort=fdbSrcPort, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCfg=mstCistCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbInfo=fdbInfo, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbTable=fdbTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanInfoTable=vlanInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortState=stgNewCfgPortState, layer2Info=layer2Info, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2Configs=layer2Configs, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoState=portTeamInfoState, stpInfoPortTable=stpInfoPortTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgState=stgNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgState=mstCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, fdbClear=fdbClear, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, PYSNMP_MODULE_ID=layer2, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, BridgeId=BridgeId, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, fdbState=fdbState, trunkgroup=trunkgroup, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootPort=stpInfoRootPort, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfo=lacpInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, layer2=layer2, portTeamInfoTable=portTeamInfoTable, fdbStatsFinds=fdbStatsFinds, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortState=stpInfoPortState, cistRootPort=cistRootPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRootPathCost=cistRootPathCost, lacpCurPortState=lacpCurPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfo=portTeamInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfo=cistInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgTable=stgCurCfgTable, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoMaxAge=stpInfoMaxAge, fdbVlan=fdbVlan, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRoot=cistRoot, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbMacAddr=fdbMacAddr, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortTable=cistInfoPortTable, stgCurCfgState=stgCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbEntry=fdbEntry, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortRole=cistInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, mirroring=mirroring, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoTopChanges=stpInfoTopChanges, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoIndex=stpInfoIndex, layer2Oper=layer2Oper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanInfoStatus=vlanInfoStatus, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpStats=stpStats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanInfoName=vlanInfoName, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoPortsState=portTeamInfoPortsState, vlan=vlan, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2Stats=layer2Stats, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortLink=stgCurCfgPortLink, portTeamInfoPorts=portTeamInfoPorts, stgCfg=stgCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfo=vlanInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgState=trunkGroupNewCfgState, lacp=lacp, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex)
