...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstNewCfgState=mstNewCfgState, portTeamInfoPorts=portTeamInfoPorts, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbTable=fdbTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoBwmContract=vlanInfoBwmContract, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCfg=mstCfg, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCurrent=fdbStatsCurrent, fdbStats=fdbStats, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgRegionName=mstNewCfgRegionName, fdbClear=fdbClear, cistRootPort=cistRootPort, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoJumbo=vlanInfoJumbo, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, stpInfoPortTable=stpInfoPortTable, stpInfoIndex=stpInfoIndex, stpInfoPortRole=stpInfoPortRole, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistRoot=cistRoot, vlanInfoLearn=vlanInfoLearn, lacpCurPortState=lacpCurPortState, fdbStatsDeletes=fdbStatsDeletes, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacp=lacp, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbState=fdbState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoId=vlanInfoId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, layer2Info=layer2Info, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, portTeamInfo=portTeamInfo, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgState=stgNewCfgState, vlanInfoStatus=vlanInfoStatus, fdbStatsLookups=fdbStatsLookups, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlan=vlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoPortState=stpInfoPortState, stpStats=stpStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, layer2Oper=layer2Oper, mirroring=mirroring, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfo=vlanInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCfg=stgCfg, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFinds=fdbStatsFinds, stpInfoHelloTime=stpInfoHelloTime, PYSNMP_MODULE_ID=layer2, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcPort=fdbSrcPort, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgState=mstCurCfgState, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, fdbStatsHiwat=fdbStatsHiwat, stpInfoTable=stpInfoTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortRole=cistInfoPortRole, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgState=vlanCurCfgState, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoPorts=vlanInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgState=stgCurCfgState, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, layer2Stats=layer2Stats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbEntry=fdbEntry, stpInfoPortEdge=stpInfoPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2=layer2, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbRefSps=fdbRefSps, cistInfo=cistInfo, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoTable=vlanInfoTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbInfo=fdbInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortState=cistInfoPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgStpMode=mstNewCfgStpMode, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortState=lacpNewPortState, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRegionalRoot=cistRegionalRoot, cistRootPathCost=cistRootPathCost, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoState=portTeamInfoState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTable=lacpInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfo=stpInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCfg=mstCistCfg, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, fdbMacAddr=fdbMacAddr, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortIndex=stgStatsPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistGeneralInfo=cistGeneralInfo, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, BridgeId=BridgeId, vlanInfoName=vlanInfoName, layer2Configs=layer2Configs, portTeamCurCfgTable=portTeamCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgTable=stgCurCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, fdbLearnedPort=fdbLearnedPort, lacpInfo=lacpInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCfg=portTeamCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgStatsPortTable=stgStatsPortTable, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPriority=stgNewCfgPriority)
