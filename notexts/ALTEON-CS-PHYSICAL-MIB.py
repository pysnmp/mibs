...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfo=portTeamInfo, cistInfoPortTable=cistInfoPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbEntry=fdbEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsFindFails=fdbStatsFindFails, mstCurCfgState=mstCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPriority=stgNewCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstNewCfgState=mstNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoTable=stpInfoTable, layer2Oper=layer2Oper, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsStpIndex=stgStatsStpIndex, layer2=layer2, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfoName=vlanInfoName, stpInfoTopChanges=stpInfoTopChanges, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoRootCost=stpInfoRootCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoLearn=vlanInfoLearn, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistRoot=cistRoot, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgStpMode=mstNewCfgStpMode, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, BridgeId=BridgeId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbMacAddr=fdbMacAddr, fdbStatsOverflows=fdbStatsOverflows, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, lacp=lacp, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortTable=stpInfoPortTable, mirrPortMirr=mirrPortMirr, mstGeneralCfg=mstGeneralCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsLookupFails=fdbStatsLookupFails, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoId=vlanInfoId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoRootPort=stpInfoRootPort, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlan=vlan, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStats=fdbStats, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistRegionalRoot=cistRegionalRoot, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortRole=stpInfoPortRole, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2Stats=layer2Stats, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfo=cistInfo, mstCfg=mstCfg, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxEnt=vlanMaxEnt, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsDeletes=fdbStatsDeletes, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortState=cistInfoPortState, stgCfg=stgCfg, layer2Info=layer2Info, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoTable=vlanInfoTable, stgStatsPortIndex=stgStatsPortIndex, vlanCurCfgState=vlanCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcPort=fdbSrcPort, fdbLearnedPort=fdbLearnedPort, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, cistRegionalPathCost=cistRegionalPathCost, fdbTable=fdbTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTable=portTeamInfoTable, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoState=portTeamInfoState, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbClear=fdbClear, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, cistRootPathCost=cistRootPathCost, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgStg=vlanCurCfgStg, fdbStatsHiwat=fdbStatsHiwat, fdbRefSps=fdbRefSps, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgState=portTeamCurCfgState, portTeamCfg=portTeamCfg, vlanMaxVlanID=vlanMaxVlanID, vlanInfo=vlanInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfo=stpInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgTable=stgNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCfg=mstCistCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistDefaultCfg=mstCistDefaultCfg, layer2Configs=layer2Configs, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbVlan=fdbVlan, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgState=stgCurCfgState, stgNewCfgState=stgNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurPortState=lacpCurPortState, lacpInfo=lacpInfo, stgNewCfgPortState=stgNewCfgPortState, stpStats=stpStats)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoIndex=stpInfoIndex, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortTable=stgStatsPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortMoved=lacpInfoPortMoved, fdbInfo=fdbInfo, fdbState=fdbState, vlanInfoPorts=vlanInfoPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkgroup=trunkgroup, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortRole=cistInfoPortRole, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates)
