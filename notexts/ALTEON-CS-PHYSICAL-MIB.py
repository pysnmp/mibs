...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfo=stpInfo, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mirroring=mirroring, mstCistCfg=mstCistCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoIndex=portTeamInfoIndex, stgStatsPortTable=stgStatsPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsOverflows=fdbStatsOverflows, layer2=layer2, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfo=cistInfo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, vlanMaxVlanID=vlanMaxVlanID, layer2Oper=layer2Oper, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRoot=cistRoot, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, PYSNMP_MODULE_ID=layer2, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortState=lacpCurPortState, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbState=fdbState, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgState=portTeamNewCfgState, fdbSrcPort=fdbSrcPort, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPriority=stgNewCfgPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStatsLookups=fdbStatsLookups, cistGeneralInfo=cistGeneralInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbRefSps=fdbRefSps, stpInfoPortState=stpInfoPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistBridgeMaxAge=cistBridgeMaxAge, layer2Info=layer2Info, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Configs=layer2Configs, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgState=vlanNewCfgState, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbLearnedPort=fdbLearnedPort, mstNewCfgState=mstNewCfgState, fdbStatsFindFails=fdbStatsFindFails, fdbInfo=fdbInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, BridgeId=BridgeId, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, vlanInfoPorts=vlanInfoPorts, vlanInfo=vlanInfo, fdbVlan=fdbVlan, stpInfoRootCost=stpInfoRootCost, fdbClear=fdbClear, mirrPortMirr=mirrPortMirr, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsFinds=fdbStatsFinds, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgState=stgCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbTable=fdbTable, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, cistRootPort=cistRootPort, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgState=mstCurCfgState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoRootPort=stpInfoRootPort, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortTable=stpInfoPortTable, cistInfoPortRole=cistInfoPortRole, vlanInfoStatus=vlanInfoStatus, portTeamInfoState=portTeamInfoState, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCfg=stgCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTable=stpInfoTable, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsDeletes=fdbStatsDeletes, fdbMacAddr=fdbMacAddr, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, vlanInfoId=vlanInfoId, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsCreates=fdbStatsCreates, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Stats=layer2Stats, portTeamCfg=portTeamCfg, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoPorts=portTeamInfoPorts, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPathCost=cistRootPathCost, fdbStats=fdbStats, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortState=cistInfoPortState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortLinkType=stpInfoPortLinkType, mstCfg=mstCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortPathCost=stpInfoPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacp=lacp, portTeamInfo=portTeamInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, fdbEntry=fdbEntry, vlanInfoName=vlanInfoName, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbSrcTrunk=fdbSrcTrunk, stpInfoIndex=stpInfoIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlan=vlan, stgNewCfgStgIndex=stgNewCfgStgIndex)
