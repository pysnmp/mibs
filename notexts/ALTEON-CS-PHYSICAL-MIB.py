...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacp=lacp, fdbRefSps=fdbRefSps, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfo=lacpInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsCurrent=fdbStatsCurrent, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, mirrPortMirr=mirrPortMirr, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbEntry=fdbEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoPorts=vlanInfoPorts, stgStatsPortTable=stgStatsPortTable, lacpNewPortState=lacpNewPortState, vlanInfo=vlanInfo, stpInfoTable=stpInfoTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoRootPort=stpInfoRootPort, mstGeneralCfg=mstGeneralCfg, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, BridgeId=BridgeId, stpStats=stpStats, fdbState=fdbState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgState=mstNewCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoTableEntry=stpInfoTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, layer2=layer2, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, portTeamInfo=portTeamInfo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortState=lacpCurPortState, fdbStatsOverflows=fdbStatsOverflows, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, fdbStatsLookupFails=fdbStatsLookupFails, mirroring=mirroring, fdbStatsDeletes=fdbStatsDeletes, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortIndex=stpInfoPortIndex, fdbStats=fdbStats, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCfg=stgCfg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortRole=cistInfoPortRole, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgIndex=stgCurCfgIndex, cistRoot=cistRoot, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbClear=fdbClear, lacpInfoPortSelected=lacpInfoPortSelected, layer2Stats=layer2Stats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanInfoStatus=vlanInfoStatus, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStatsFinds=fdbStatsFinds, vlan=vlan, portTeamInfoTrunksState=portTeamInfoTrunksState, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgState=mstCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortTable=stpInfoPortTable, fdbStatsLookups=fdbStatsLookups, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgStgIndex=stgCurCfgStgIndex, layer2Configs=layer2Configs, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortState=stpInfoPortState, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, cistRootPort=cistRootPort, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCfg=mstCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbLearnedPort=fdbLearnedPort, mstCistCfg=mstCistCfg, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoTable=vlanInfoTable, vlanInfoId=vlanInfoId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoLearn=vlanInfoLearn, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Info=layer2Info, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfo=stpInfo, layer2Oper=layer2Oper, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsCreates=fdbStatsCreates, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, fdbMacAddr=fdbMacAddr, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoRootCost=stpInfoRootCost, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoState=portTeamInfoState, vlanNewCfgPorts=vlanNewCfgPorts, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortRole=stpInfoPortRole, cistGeneralInfo=cistGeneralInfo, stgStatsPortIndex=stgStatsPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, PYSNMP_MODULE_ID=layer2, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoName=vlanInfoName, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortEdge=stpInfoPortEdge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoHelloTime=stpInfoHelloTime, trunkgroup=trunkgroup, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortState=cistInfoPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfo=cistInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, fdbSrcPort=fdbSrcPort, stpInfoPortLinkType=stpInfoPortLinkType, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoTable=portTeamInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCfg=portTeamCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbVlan=fdbVlan, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortIndex=cistInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgState=stgCurCfgState, cistRootPathCost=cistRootPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbTable=fdbTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap)
