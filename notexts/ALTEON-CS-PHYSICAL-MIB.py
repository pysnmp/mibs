...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoName=vlanInfoName, stpInfoTable=stpInfoTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortState=lacpNewPortState, stpInfo=stpInfo, lacpInfo=lacpInfo, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRootPort=cistRootPort, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStats=fdbStats, fdbStatsOverflows=fdbStatsOverflows, BridgeId=BridgeId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortTable=stpInfoPortTable, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCfg=mstCistCfg, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacp=lacp, stpInfoTopChanges=stpInfoTopChanges, fdbTable=fdbTable, layer2Stats=layer2Stats, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbClear=fdbClear, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbRefSps=fdbRefSps, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortIndex=cistInfoPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTable=stgCurCfgTable, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFinds=fdbStatsFinds, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortTable=lacpInfoPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, cistInfo=cistInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoIndex=stpInfoIndex, layer2Oper=layer2Oper, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortRole=cistInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTable=portTeamInfoTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcPort=fdbSrcPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoLearn=vlanInfoLearn, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamInfoState=portTeamInfoState, stgCurCfgState=stgCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, mstCfg=mstCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanMaxEnt=vlanMaxEnt, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoRootPort=stpInfoRootPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkgroup=trunkgroup, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mirroring=mirroring, vlanNewCfgState=vlanNewCfgState, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgState=stgNewCfgState, stgCfg=stgCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHelloTime=stpInfoHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortTable=cistInfoPortTable, vlanNewCfgPorts=vlanNewCfgPorts, fdbState=fdbState, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoTable=vlanInfoTable, PYSNMP_MODULE_ID=layer2, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRootPathCost=cistRootPathCost, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgTable=stgNewCfgTable, fdbStatsLookups=fdbStatsLookups, fdbSrcTrunk=fdbSrcTrunk, fdbEntry=fdbEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanInfoId=vlanInfoId, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpStats=stpStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfo=vlanInfo, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoTableEntry=stpInfoTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbMacAddr=fdbMacAddr, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgState=vlanCurCfgState, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortRole=stpInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, layer2Configs=layer2Configs, vlan=vlan, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoPortEdge=stpInfoPortEdge, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortState=cistInfoPortState, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgLearn=vlanCurCfgLearn, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgState=mstCurCfgState, portTeamCurCfgState=portTeamCurCfgState, portTeamCfg=portTeamCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsCreates=fdbStatsCreates, stgStatsPortTable=stgStatsPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRegionalRoot=cistRegionalRoot, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistRoot=cistRoot, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Info=layer2Info, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfo=portTeamInfo, mstNewCfgState=mstNewCfgState, fdbVlan=fdbVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbLearnedPort=fdbLearnedPort, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbInfo=fdbInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstGeneralCfg=mstGeneralCfg, fdbStatsDeletes=fdbStatsDeletes)
