...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsDeletes=fdbStatsDeletes, cistInfo=cistInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistBridgeMaxAge=cistBridgeMaxAge, vlan=vlan, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, vlanInfoTable=vlanInfoTable, portTeamInfoState=portTeamInfoState, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgState=stgCurCfgState, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbTable=fdbTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoName=vlanInfoName, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTable=stgNewCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCfg=portTeamCfg, mstNewCfgState=mstNewCfgState, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgJumbo=vlanNewCfgJumbo, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortIndex=cistInfoPortIndex, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortIndex=stpInfoPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, fdbVlan=fdbVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortRole=stpInfoPortRole, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbStats=fdbStats, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanMaxEnt=vlanMaxEnt, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortPathCost=stpInfoPortPathCost, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfo=lacpInfo, mstNewCfgStpMode=mstNewCfgStpMode, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoIndex=stpInfoIndex, cistInfoPortRole=cistInfoPortRole, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfo=portTeamInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgState=stgNewCfgState, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsHiwat=fdbStatsHiwat, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPriority=stgNewCfgPriority, trunkgroup=trunkgroup, vlanNewCfgDelete=vlanNewCfgDelete, cistRoot=cistRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortLink=stgNewCfgPortLink, stpStats=stpStats, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, portTeamTableMaxSize=portTeamTableMaxSize, lacp=lacp, mstCistCfg=mstCistCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgState=vlanCurCfgState, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgPorts=vlanNewCfgPorts, cistRootPathCost=cistRootPathCost, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, layer2Stats=layer2Stats, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, layer2Configs=layer2Configs, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPriority=stgNewCfgPortPriority, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortTableEntry=stpInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsCurrent=fdbStatsCurrent, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mstCfg=mstCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortTable=stpInfoPortTable, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbRefSps=fdbRefSps, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbInfo=fdbInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoId=vlanInfoId, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpCurPortState=lacpCurPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, PYSNMP_MODULE_ID=layer2, layer2Info=layer2Info, fdbSrcPort=fdbSrcPort, fdbEntry=fdbEntry, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfo=vlanInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfo=stpInfo, stpInfoTable=stpInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsFindFails=fdbStatsFindFails, fdbState=fdbState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortState=lacpNewPortState, cistInfoPortLinkType=cistInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, mstGeneralCfg=mstGeneralCfg, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2Oper=layer2Oper)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoRootCost=stpInfoRootCost, vlanInfoPorts=vlanInfoPorts, BridgeId=BridgeId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCurCfgState=mstCurCfgState, stgCurCfgTable=stgCurCfgTable, fdbClear=fdbClear, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgRegionName=mstCurCfgRegionName, mirrPortMirr=mirrPortMirr, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2=layer2, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, stgCfg=stgCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortTable=stgStatsPortTable)
