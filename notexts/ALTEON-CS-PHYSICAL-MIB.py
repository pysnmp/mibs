...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoState=portTeamInfoState, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkgroup=trunkgroup, vlan=vlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbMacAddr=fdbMacAddr, fdbVlan=fdbVlan, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgState=vlanCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgState=mstNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRoot=cistRoot, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpStats=stpStats, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortTable=cistInfoPortTable, BridgeId=BridgeId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgTable=stgNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgState=stgNewCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Info=layer2Info, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoTable=portTeamInfoTable, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoRootCost=stpInfoRootCost, lacpCurSystemPriority=lacpCurSystemPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortTable=stgStatsPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTable=stpInfoTable, fdbStats=fdbStats, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbSrcTrunk=fdbSrcTrunk, cistInfo=cistInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortState=cistInfoPortState, stpInfoIndex=stpInfoIndex, fdbClear=fdbClear, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgState=vlanNewCfgState, lacpCurPortState=lacpCurPortState, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsCreates=fdbStatsCreates, vlanInfoStatus=vlanInfoStatus, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirroring=mirroring, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfo=portTeamInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPriority=stgCurCfgPriority, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoId=vlanInfoId, layer2Oper=layer2Oper, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbSrcPort=fdbSrcPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCurrent=fdbStatsCurrent, mstCfg=mstCfg, cistRootPathCost=cistRootPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbEntry=fdbEntry, stpInfoTableEntry=stpInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanInfo=vlanInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, mirrPortMirr=mirrPortMirr, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistRootPort=cistRootPort, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCfg=mstCistCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, lacpNewPortState=lacpNewPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfo=stpInfo, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortState=stpInfoPortState, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoName=vlanInfoName, fdbTable=fdbTable, fdbRefSps=fdbRefSps, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2Stats=layer2Stats, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, layer2=layer2, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbInfo=fdbInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgState=mstCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, lacp=lacp, portTeamCfg=portTeamCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsLookups=fdbStatsLookups, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2Configs=layer2Configs, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoLearn=vlanInfoLearn, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortReadyN=lacpInfoPortReadyN, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgState=portTeamNewCfgState, lacpInfo=lacpInfo, fdbStatsFinds=fdbStatsFinds, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortRole=cistInfoPortRole, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPriority=stgNewCfgPriority, stgCfg=stgCfg, portTeamInfoIndex=portTeamInfoIndex, cistRegionalRoot=cistRegionalRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistBridgeForwardDelay=cistBridgeForwardDelay)
