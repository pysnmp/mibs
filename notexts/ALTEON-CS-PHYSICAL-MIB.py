...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortIndex=lacpInfoPortIndex, cistRegionalRoot=cistRegionalRoot, portTeamCfg=portTeamCfg, portTeamInfo=portTeamInfo, mstCurCfgState=mstCurCfgState, fdbStatsLookupFails=fdbStatsLookupFails, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoTopChanges=stpInfoTopChanges, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortState=stpInfoPortState, lacpNewPortState=lacpNewPortState, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanMaxVlanID=vlanMaxVlanID, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgState=stgNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Configs=layer2Configs, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTable=lacpNewPortCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTable=stpInfoTable, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbTable=fdbTable, cistInfoPortPathCost=cistInfoPortPathCost, mstGeneralCfg=mstGeneralCfg, mirroring=mirroring, fdbStats=fdbStats, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCfg=mstCfg, fdbVlan=fdbVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsLookups=fdbStatsLookups, stgStatsStpIndex=stgStatsStpIndex, stpInfoRootCost=stpInfoRootCost, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanInfoStatus=vlanInfoStatus, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, fdbInfo=fdbInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoTable=vlanInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlan=vlan, cistGeneralInfo=cistGeneralInfo, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgState=vlanCurCfgState, fdbClear=fdbClear, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgIndex=portTeamNewCfgIndex, BridgeId=BridgeId, stgCurCfgState=stgCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgTable=stgCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortLink=stgCurCfgPortLink, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpStats=stpStats, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfo=cistInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgState=mstNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Info=layer2Info, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCfg=stgCfg, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbMacAddr=fdbMacAddr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistRootPort=cistRootPort, cistRootPathCost=cistRootPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbStatsOverflows=fdbStatsOverflows, vlanInfoId=vlanInfoId, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortState=lacpCurPortState, fdbStatsFindFails=fdbStatsFindFails, portTeamInfoState=portTeamInfoState, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfo=lacpInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbState=fdbState, layer2Oper=layer2Oper, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistInfoPortTable=cistInfoPortTable, fdbEntry=fdbEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkgroup=trunkgroup, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRoot=cistRoot, stpInfoHelloTime=stpInfoHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpInfoPortTable=lacpInfoPortTable, stpInfoIndex=stpInfoIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2=layer2, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanMaxEnt=vlanMaxEnt, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbRefSps=fdbRefSps, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortRole=stpInfoPortRole, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfo=stpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Stats=layer2Stats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, lacp=lacp, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCfg=mstCistCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgTable=vlanNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoMaxAge=stpInfoMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsCreates=fdbStatsCreates, vlanInfoName=vlanInfoName, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbSrcPort=fdbSrcPort, stpInfoHoldTime=stpInfoHoldTime, vlanInfo=vlanInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgState=portTeamNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortState=cistInfoPortState, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoRootPort=stpInfoRootPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamCurCfgTable=portTeamCurCfgTable)
