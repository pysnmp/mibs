...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, BridgeId=BridgeId, vlanInfoId=vlanInfoId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCfg=stgCfg, lacp=lacp, stpInfoRootPort=stpInfoRootPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortTable=stpInfoPortTable, stgNewCfgPortState=stgNewCfgPortState, portTeamCfg=portTeamCfg, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkgroup=trunkgroup, cistRegionalPathCost=cistRegionalPathCost, stpInfoIndex=stpInfoIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbSrcPort=fdbSrcPort, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoPorts=vlanInfoPorts, cistInfoPortTable=cistInfoPortTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgTable=stgNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbInfo=fdbInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbRefSps=fdbRefSps, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortRole=cistInfoPortRole, stpInfoTable=stpInfoTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbSrcTrunk=fdbSrcTrunk, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgState=vlanCurCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfo=portTeamInfo, layer2Oper=layer2Oper, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortState=lacpNewPortState, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurSystemPriority=lacpCurSystemPriority, mstNewCfgStpMode=mstNewCfgStpMode, stpStats=stpStats, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoRootCost=stpInfoRootCost, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, layer2=layer2, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlan=vlan, cistInfo=cistInfo, mstCurCfgState=mstCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoStatus=vlanInfoStatus, stgCurCfgIndex=stgCurCfgIndex, cistRootPort=cistRootPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistGeneralInfo=cistGeneralInfo, portTeamInfoTrunks=portTeamInfoTrunks, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortState=lacpCurPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTableId=lacpNewPortCfgTableId, fdbStats=fdbStats, fdbStatsLookupFails=fdbStatsLookupFails, fdbClear=fdbClear, mstNewCfgState=mstNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfo=stpInfo, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortIndex=stpInfoPortIndex, fdbStatsLookups=fdbStatsLookups, portTeamInfoPorts=portTeamInfoPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRootPathCost=cistRootPathCost, vlanInfoJumbo=vlanInfoJumbo, lacpInfo=lacpInfo, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsFindFails=fdbStatsFindFails, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistCfg=mstCistCfg, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortState=cistInfoPortState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, mstCfg=mstCfg, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortStpIndex=stpInfoPortStpIndex, mirrPortMirr=mirrPortMirr, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoTable=portTeamInfoTable, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbTable=fdbTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfo=vlanInfo, vlanNewCfgStg=vlanNewCfgStg, fdbLearnedPort=fdbLearnedPort, layer2Configs=layer2Configs, layer2Stats=layer2Stats, stgCurCfgPortState=stgCurCfgPortState, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbState=fdbState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamInfoState=portTeamInfoState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalRoot=cistRegionalRoot)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbVlan=fdbVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCreates=fdbStatsCreates, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoTable=vlanInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoTopChanges=stpInfoTopChanges, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgTable=vlanNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbEntry=fdbEntry, stgCurCfgState=stgCurCfgState, layer2Info=layer2Info, mirroring=mirroring, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoName=vlanInfoName)
