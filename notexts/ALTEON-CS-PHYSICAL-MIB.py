...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoIndex=stpInfoIndex, BridgeId=BridgeId, layer2=layer2, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortRole=stpInfoPortRole, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortState=cistInfoPortState, fdbStatsCreates=fdbStatsCreates, mstCfg=mstCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Oper=layer2Oper, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCfg=portTeamCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamInfoState=portTeamInfoState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoTableEntry=vlanInfoTableEntry, mstNewCfgState=mstNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRegionalRoot=cistRegionalRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgTable=vlanNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgPortState=stgCurCfgPortState, cistGeneralInfo=cistGeneralInfo, fdbSrcPort=fdbSrcPort, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbMacAddr=fdbMacAddr, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsDeletes=fdbStatsDeletes, cistInfoPortRole=cistInfoPortRole, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoPorts=portTeamInfoPorts, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoRootCost=stpInfoRootCost, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortTable=cistInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, PYSNMP_MODULE_ID=layer2, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsFinds=fdbStatsFinds, fdbVlan=fdbVlan, fdbTable=fdbTable, fdbStats=fdbStats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortTable=stpInfoPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanInfoPorts=vlanInfoPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCfg=stgCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbEntry=fdbEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortEdge=stpInfoPortEdge, mstCistCfg=mstCistCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgIndex=stgCurCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, cistRootPort=cistRootPort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgStatsPortTable=stgStatsPortTable, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfo=portTeamInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, cistRoot=cistRoot, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2Configs=layer2Configs, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Stats=layer2Stats, fdbStatsLookups=fdbStatsLookups, vlanInfoStatus=vlanInfoStatus, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbInfo=fdbInfo, lacpCurPortState=lacpCurPortState, vlanInfoName=vlanInfoName, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, mirrPortMirr=mirrPortMirr, stpInfoTable=stpInfoTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoId=vlanInfoId, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, mstGeneralCfg=mstGeneralCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpCurPortCfgTable=lacpCurPortCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionName=mstCurCfgRegionName, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoTable=vlanInfoTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbSrcTrunk=fdbSrcTrunk, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfo=vlanInfo, stpInfoPortIndex=stpInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbState=fdbState, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRootPathCost=cistRootPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgStpMode=mstCurCfgStpMode, lacp=lacp, fdbRefSps=fdbRefSps, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortState=stpInfoPortState, stpInfoTopChanges=stpInfoTopChanges, stgStatsStpIndex=stgStatsStpIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPriority=stgCurCfgPriority, fdbLearnedPort=fdbLearnedPort, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgState=mstCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortState=lacpNewPortState, fdbStatsFindFails=fdbStatsFindFails, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfo=cistInfo, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfo=lacpInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanMaxEnt=vlanMaxEnt, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfo=stpInfo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgTable=stgCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgState=stgCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoHelloTime=stpInfoHelloTime, stpStats=stpStats, vlanCurCfgTable=vlanCurCfgTable, fdbClear=fdbClear, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, layer2Info=layer2Info, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlan=vlan, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mirroring=mirroring, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort)
