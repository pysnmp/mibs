...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgState=mstNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoTableEntry=stpInfoTableEntry, mstGeneralCfg=mstGeneralCfg, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbRefSps=fdbRefSps, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsCurrent=fdbStatsCurrent, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCurCfgState=mstCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanInfoStatus=vlanInfoStatus, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortReadyN=lacpInfoPortReadyN, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgState=stgCurCfgState, fdbEntry=fdbEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mirrPortMirr=mirrPortMirr, layer2Info=layer2Info, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgTable=stgCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoState=portTeamInfoState, stpInfo=stpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanInfoId=vlanInfoId, lacpCurPortState=lacpCurPortState, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoTable=vlanInfoTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortIndex=stgStatsPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacp=lacp, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoRootPort=stpInfoRootPort, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgState=vlanCurCfgState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Configs=layer2Configs, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPorts=portTeamInfoPorts, trunkgroup=trunkgroup, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortState=cistInfoPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortTable=stpInfoPortTable, stpInfoTable=stpInfoTable, lacpNewPortCfgTable=lacpNewPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCfg=mstCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbTable=fdbTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortState=stgCurCfgPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, fdbInfo=fdbInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbStatsCreates=fdbStatsCreates, vlanNewCfgState=vlanNewCfgState, stpInfoPortRole=stpInfoPortRole, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTable=vlanCurCfgTable, lacpNewPortState=lacpNewPortState, stpInfoHelloTime=stpInfoHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfo=cistInfo, stgCfg=stgCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, portTeamCurCfgState=portTeamCurCfgState, fdbStatsFindFails=fdbStatsFindFails, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsStpIndex=stgStatsStpIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamInfo=portTeamInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoForwardDelay=stpInfoForwardDelay, layer2=layer2, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoIndex=portTeamInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpInfo=lacpInfo, vlanInfoPorts=vlanInfoPorts, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortTable=lacpInfoPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, stpInfoIndex=stpInfoIndex, vlanMaxEnt=vlanMaxEnt, fdbSrcPort=fdbSrcPort, portTeamInfoTable=portTeamInfoTable, fdbState=fdbState, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamCfg=portTeamCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStats=fdbStats, stgNewCfgState=stgNewCfgState, fdbVlan=fdbVlan, vlan=vlan, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistInfoPortRole=cistInfoPortRole, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgAddPort=vlanNewCfgAddPort, cistRootPort=cistRootPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoHoldTime=stpInfoHoldTime, vlanInfoName=vlanInfoName, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgTable=stgNewCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsFinds=fdbStatsFinds, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, stpInfoRootCost=stpInfoRootCost, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCurCfgStpMode=mstCurCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, mirroring=mirroring, BridgeId=BridgeId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbClear=fdbClear, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, mstNewCfgRegionName=mstNewCfgRegionName, cistRoot=cistRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCfg=mstCistCfg, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookups=fdbStatsLookups, stgNewCfgAgingTime=stgNewCfgAgingTime, layer2Oper=layer2Oper, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfo=vlanInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap)
