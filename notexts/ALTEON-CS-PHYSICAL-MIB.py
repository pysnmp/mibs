...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxEnt=vlanMaxEnt, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortTable=cistInfoPortTable, stpInfo=stpInfo, lacpNewSystemPriority=lacpNewSystemPriority, fdbEntry=fdbEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, layer2Configs=layer2Configs, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortRole=stpInfoPortRole, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortState=lacpCurPortState, portTeamInfoTableEntry=portTeamInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, layer2Oper=layer2Oper, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgState=vlanNewCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistRegionalRoot=cistRegionalRoot, vlanInfo=vlanInfo, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCfg=mstCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoTable=stpInfoTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortState=stgNewCfgPortState, fdbLearnedPort=fdbLearnedPort, PYSNMP_MODULE_ID=layer2, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstNewCfgState=mstNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, portTeamCfg=portTeamCfg, fdbClear=fdbClear, fdbState=fdbState, stpInfoRootCost=stpInfoRootCost, layer2=layer2, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbTable=fdbTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortIndex=lacpInfoPortIndex, layer2Stats=layer2Stats, stpInfoPortState=stpInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPort=cistRootPort, stpInfoPortTable=stpInfoPortTable, mirroring=mirroring, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoIndex=stpInfoIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlan=vlan, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, fdbVlan=fdbVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgPorts=portTeamNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoHelloTime=stpInfoHelloTime, fdbSrcPort=fdbSrcPort, stpInfoRootPort=stpInfoRootPort, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfo=lacpInfo, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, BridgeId=BridgeId, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoPorts=vlanInfoPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, cistRoot=cistRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, stgStatsStpIndex=stgStatsStpIndex, cistRootPathCost=cistRootPathCost, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbInfo=fdbInfo, fdbStats=fdbStats, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTableEntry=stpInfoTableEntry, cistGeneralInfo=cistGeneralInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoTable=vlanInfoTable, cistInfo=cistInfo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoId=vlanInfoId, lacpNewPortState=lacpNewPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortPathCost=stpInfoPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortRole=cistInfoPortRole, fdbRefSps=fdbRefSps, fdbStatsOverflows=fdbStatsOverflows, stpInfoHoldTime=stpInfoHoldTime, portTeamInfo=portTeamInfo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoName=vlanInfoName, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mirrPortMirr=mirrPortMirr, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbMacAddr=fdbMacAddr, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgVlanBmap=stgCurCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkgroup=trunkgroup, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgRegionName=mstCurCfgRegionName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoPorts=portTeamInfoPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, cistInfoPortPriority=cistInfoPortPriority, mstGeneralCfg=mstGeneralCfg, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Info=layer2Info, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoState=portTeamInfoState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, stpStats=stpStats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacp=lacp, stgCfg=stgCfg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCfg=mstCistCfg, fdbStatsCreates=fdbStatsCreates, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortTable=stgStatsPortTable)
