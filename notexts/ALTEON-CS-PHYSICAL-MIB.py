...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortState=lacpNewPortState, fdbMacAddr=fdbMacAddr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCurCfgState=mstCurCfgState, layer2Oper=layer2Oper, portTeamNewCfgTable=portTeamNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, cistRootPort=cistRootPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortRole=stpInfoPortRole, vlan=vlan, vlanInfo=vlanInfo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgTable=vlanCurCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsCreates=fdbStatsCreates, layer2Stats=layer2Stats, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbInfo=fdbInfo, stgStatsPortIndex=stgStatsPortIndex, fdbSrcPort=fdbSrcPort, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbEntry=fdbEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortState=stpInfoPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Info=layer2Info, cistInfoPortIndex=cistInfoPortIndex, fdbLearnedPort=fdbLearnedPort, vlanCurCfgState=vlanCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoName=vlanInfoName, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgIndex=stgNewCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgVlanBmap=stgNewCfgVlanBmap, layer2=layer2, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbStats=fdbStats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgStg=vlanNewCfgStg, stpInfoRootCost=stpInfoRootCost, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsOverflows=fdbStatsOverflows, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbVlan=fdbVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfo=portTeamInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgStpMode=mstCurCfgStpMode, trunkgroup=trunkgroup, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfoPortState=cistInfoPortState, lacp=lacp, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCfg=mstCistCfg, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgState=stgCurCfgState, stpStats=stpStats, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpCurPortState=lacpCurPortState, mirroring=mirroring, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbTable=fdbTable, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsFindFails=fdbStatsFindFails, fdbStatsFinds=fdbStatsFinds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoRootPort=stpInfoRootPort, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortPriority=cistInfoPortPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfo=lacpInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, vlanInfoJumbo=vlanInfoJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbState=fdbState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoTopChanges=stpInfoTopChanges, vlanInfoTableEntry=vlanInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfoId=vlanInfoId, fdbSrcTrunk=fdbSrcTrunk, mstGeneralCfg=mstGeneralCfg, stgNewCfgState=stgNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoTable=portTeamInfoTable, cistInfo=cistInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamCfg=portTeamCfg, portTeamInfoIndex=portTeamInfoIndex, vlanInfoPorts=vlanInfoPorts, cistRootPathCost=cistRootPathCost, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTableEntry=stpInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTable=vlanInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsLookups=fdbStatsLookups, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstNewCfgState=mstNewCfgState, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortTable=stpInfoPortTable, layer2Configs=layer2Configs, portTeamInfoState=portTeamInfoState, stgNewCfgPortState=stgNewCfgPortState, cistInfoPortTable=cistInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCfg=stgCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoTable=stpInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfo=stpInfo, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCfg=mstCfg, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRoot=cistRoot, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, BridgeId=BridgeId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, cistRegionalRoot=cistRegionalRoot, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbRefSps=fdbRefSps, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgRegionName=mstNewCfgRegionName, mstCistDefaultCfg=mstCistDefaultCfg)
