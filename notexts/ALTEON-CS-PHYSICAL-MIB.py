...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgState=stgNewCfgState, mstCurCfgState=mstCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgState=vlanCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoRootPort=stpInfoRootPort, mirroring=mirroring, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoName=vlanInfoName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortNtt=lacpInfoPortNtt, cistRootPathCost=cistRootPathCost, lacp=lacp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpStats=stpStats, mstCurCfgStpMode=mstCurCfgStpMode, cistRoot=cistRoot, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbSrcTrunk=fdbSrcTrunk, stpInfoRootCost=stpInfoRootCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoLearn=vlanInfoLearn, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgIndex=stgNewCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, portTeamCfg=portTeamCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStats=fdbStats, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfo=cistInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, BridgeId=BridgeId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoState=portTeamInfoState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortState=stpInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoTableEntry=stpInfoTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfo=lacpInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTable=stpInfoTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoIndex=stpInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Info=layer2Info, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsStpIndex=stgStatsStpIndex, fdbTable=fdbTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbSrcPort=fdbSrcPort, stpInfoPortPathCost=stpInfoPortPathCost, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortRole=cistInfoPortRole, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortRole=stpInfoPortRole, stpInfo=stpInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsCurrent=fdbStatsCurrent, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortTable=stpInfoPortTable, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoPortsState=portTeamInfoPortsState, cistRootPort=cistRootPort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsFinds=fdbStatsFinds, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCfg=stgCfg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPriority=stgNewCfgPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgStatsPortIndex=stgStatsPortIndex, fdbClear=fdbClear, fdbVlan=fdbVlan, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2Oper=layer2Oper, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2Configs=layer2Configs, fdbMacAddr=fdbMacAddr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortState=lacpNewPortState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortTable=cistInfoPortTable, vlanInfoTable=vlanInfoTable, stgCurCfgPriority=stgCurCfgPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCfg=mstCistCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTable=portTeamNewCfgTable, vlan=vlan, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTable=stgStatsPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortState=cistInfoPortState, trunkgroup=trunkgroup, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, fdbStatsLookups=fdbStatsLookups, layer2=layer2, portTeamInfoIndex=portTeamInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbState=fdbState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfo=vlanInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCfg=mstCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamInfo=portTeamInfo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistGeneralInfo=cistGeneralInfo, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, vlanInfoJumbo=vlanInfoJumbo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbEntry=fdbEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbRefSps=fdbRefSps, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgState=mstNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeHelloTime=cistBridgeHelloTime, mirrPortMirr=mirrPortMirr, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortMoved=lacpInfoPortMoved, layer2Stats=layer2Stats, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoForwardDelay=stpInfoForwardDelay, vlanInfoId=vlanInfoId)
