...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfo=portTeamInfo, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanMaxVlanID=vlanMaxVlanID, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbTable=fdbTable, cistRoot=cistRoot, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbInfo=fdbInfo, stgNewCfgState=stgNewCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbVlan=fdbVlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2Oper=layer2Oper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPort=cistRootPort, vlanCurCfgState=vlanCurCfgState, portTeamCfg=portTeamCfg, fdbClear=fdbClear, stpInfoPortRole=stpInfoPortRole, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortTable=stpInfoPortTable, fdbRefSps=fdbRefSps, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCfg=stgCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStats=fdbStats, cistBridgeHelloTime=cistBridgeHelloTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstGeneralCfg=mstGeneralCfg, layer2Info=layer2Info, mstCurCfgState=mstCurCfgState, fdbState=fdbState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanMaxEnt=vlanMaxEnt, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgIndex=stgNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgState=vlanNewCfgState, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgPortState=stgCurCfgPortState, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpStats=stpStats, trunkgroup=trunkgroup, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoTable=stpInfoTable, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgTable=portTeamNewCfgTable, fdbEntry=fdbEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfo=lacpInfo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortState=lacpNewPortState, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgLearn=vlanCurCfgLearn, mirrPortMirr=mirrPortMirr, layer2Configs=layer2Configs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoState=portTeamInfoState, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsCreates=fdbStatsCreates, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistGeneralInfo=cistGeneralInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, cistRootPathCost=cistRootPathCost, stpInfoIndex=stpInfoIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgState=mstNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, fdbSrcPort=fdbSrcPort, cistInfoPortState=cistInfoPortState, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoTrunks=portTeamInfoTrunks, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoIndex=portTeamInfoIndex, stpInfo=stpInfo, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbMacAddr=fdbMacAddr, cistInfoPortTable=cistInfoPortTable, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFinds=fdbStatsFinds, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, mstNewCfgRegionName=mstNewCfgRegionName, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoRootPort=stpInfoRootPort, mstCistBridgeCfg=mstCistBridgeCfg, cistRegionalRoot=cistRegionalRoot, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCfg=mstCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsOverflows=fdbStatsOverflows, vlanInfoTable=vlanInfoTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortTable=lacpInfoPortTable, fdbStatsLookups=fdbStatsLookups, layer2Stats=layer2Stats, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfo=cistInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCfg=mstCistCfg, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlan=vlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanInfoName=vlanInfoName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mirroring=mirroring, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoPorts=portTeamInfoPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoId=vlanInfoId, fdbStatsCurrent=fdbStatsCurrent, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortState=lacpCurPortState, vlanNewCfgDelete=vlanNewCfgDelete, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoPorts=vlanInfoPorts, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoPortPathCost=stpInfoPortPathCost, BridgeId=BridgeId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortState=stpInfoPortState, vlanInfoLearn=vlanInfoLearn, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortPriority=cistInfoPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortRole=cistInfoPortRole, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfo=vlanInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgTable=stgNewCfgTable, lacp=lacp)
