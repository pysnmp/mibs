...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortPriority=cistInfoPortPriority, stpStats=stpStats, cistInfoPortRole=cistInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgState=vlanCurCfgState, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPriority=stgNewCfgPriority, PYSNMP_MODULE_ID=layer2, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, fdbInfo=fdbInfo, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbVlan=fdbVlan, vlanInfoName=vlanInfoName, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistDefaultCfg=mstCistDefaultCfg, lacpInfoPortMoved=lacpInfoPortMoved, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCfg=mstCistCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsFinds=fdbStatsFinds, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacp=lacp, stpInfo=stpInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgState=stgCurCfgState, mirroring=mirroring, stgNewCfgState=stgNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Info=layer2Info, stpInfoIndex=stpInfoIndex, portTeamInfoState=portTeamInfoState, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgTable=stgCurCfgTable, cistInfoPortState=cistInfoPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgState=mstCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, layer2=layer2, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTable=stpInfoTable, stpInfoMaxAge=stpInfoMaxAge, cistGeneralInfo=cistGeneralInfo, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortState=stpInfoPortState, cistInfoPortTable=cistInfoPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, cistInfo=cistInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfo=lacpInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpInfoPortSelected=lacpInfoPortSelected, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, layer2Configs=layer2Configs, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoStatus=vlanInfoStatus, lacpNewPortState=lacpNewPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbClear=fdbClear, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgState=vlanNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbTable=fdbTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcPort=fdbSrcPort, portTeamInfo=portTeamInfo, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoPorts=vlanInfoPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortTable=stpInfoPortTable, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCfg=portTeamCfg, vlanMaxVlanID=vlanMaxVlanID, layer2Oper=layer2Oper, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsLookups=fdbStatsLookups, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkgroup=trunkgroup, stgNewCfgIndex=stgNewCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbLearnedPort=fdbLearnedPort, vlanInfoTable=vlanInfoTable, stgCfg=stgCfg, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortState=lacpCurPortState, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCurCfgStpMode=mstCurCfgStpMode, cistRoot=cistRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCfg=mstCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, BridgeId=BridgeId, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoIndex=portTeamInfoIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsCreates=fdbStatsCreates, fdbMacAddr=fdbMacAddr, fdbState=fdbState, stpInfoRootCost=stpInfoRootCost, vlanInfoId=vlanInfoId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbEntry=fdbEntry, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, vlanInfo=vlanInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoLearn=vlanInfoLearn, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanNewCfgStg=vlanNewCfgStg, vlan=vlan, vlanMaxEnt=vlanMaxEnt, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRootPort=cistRootPort, fdbStatsHiwat=fdbStatsHiwat)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, layer2Stats=layer2Stats, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstGeneralCfg=mstGeneralCfg, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbRefSps=fdbRefSps, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsOverflows=fdbStatsOverflows, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoRootPort=stpInfoRootPort, fdbStats=fdbStats, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
