...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgVlanName=vlanNewCfgVlanName, cistRegionalPathCost=cistRegionalPathCost, fdbStatsDeletes=fdbStatsDeletes, cistRootPathCost=cistRootPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mirroring=mirroring, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, fdbVlan=fdbVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbRefSps=fdbRefSps, stpInfoHoldTime=stpInfoHoldTime, vlan=vlan, stgNewCfgStgIndex=stgNewCfgStgIndex, mstGeneralCfg=mstGeneralCfg, stpStats=stpStats, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, layer2Info=layer2Info, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortTable=stgStatsPortTable, cistGeneralInfo=cistGeneralInfo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortLinkType=stpInfoPortLinkType, mstCistDefaultCfg=mstCistDefaultCfg, cistRegionalRoot=cistRegionalRoot, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoName=vlanInfoName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, layer2Stats=layer2Stats, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortLink=stgCurCfgPortLink, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCurCfgState=mstCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, PYSNMP_MODULE_ID=layer2, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoTable=vlanInfoTable, lacp=lacp, stgCurCfgPriority=stgCurCfgPriority, lacpInfoPortIndex=lacpInfoPortIndex, vlanInfo=vlanInfo, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoPorts=portTeamInfoPorts, vlanInfoJumbo=vlanInfoJumbo, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTable=portTeamInfoTable, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTable=lacpCurPortCfgTable, BridgeId=BridgeId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTableEntry=stpInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortIndex=stgStatsPortIndex, stpInfoTable=stpInfoTable, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgState=stgCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbEntry=fdbEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, stpInfoIndex=stpInfoIndex, mstCistCfg=mstCistCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfo=cistInfo, fdbStatsCreates=fdbStatsCreates, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbSrcTrunk=fdbSrcTrunk, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoHelloTime=stpInfoHelloTime, stpInfoMaxAge=stpInfoMaxAge, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpInfo=lacpInfo, stgCurCfgTable=stgCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfoIndex=portTeamInfoIndex, trunkgroup=trunkgroup, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbState=fdbState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortState=stpInfoPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortRole=stpInfoPortRole, lacpNewPortState=lacpNewPortState, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcPort=fdbSrcPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoLearn=vlanInfoLearn, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, lacpInfoPortMoved=lacpInfoPortMoved, mirrPortMirr=mirrPortMirr, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortTable=cistInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsLookups=fdbStatsLookups, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgStpMode=mstCurCfgStpMode, cistInfoPortState=cistInfoPortState, vlanInfoStatus=vlanInfoStatus, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsLookupFails=fdbStatsLookupFails, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsFindFails=fdbStatsFindFails, cistBridgeForwardDelay=cistBridgeForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortIndex=stpInfoPortIndex, stgCfg=stgCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, fdbTable=fdbTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgTable=stgNewCfgTable, stgNewCfgState=stgNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbInfo=fdbInfo, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgIndex=portTeamCurCfgIndex, cistRoot=cistRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortState=lacpCurPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoRootCost=stpInfoRootCost, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgState=mstNewCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCfg=mstCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCfg=portTeamCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortState=stgNewCfgPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgState=portTeamCurCfgState, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRootPort=cistRootPort, vlanInfoPorts=vlanInfoPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgDelete=vlanNewCfgDelete, layer2Configs=layer2Configs, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamInfo=portTeamInfo, stpInfoPortTable=stpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, layer2Oper=layer2Oper, stgCurCfgPortTable=stgCurCfgPortTable, vlanInfoId=vlanInfoId, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfo=stpInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, fdbStats=fdbStats, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, layer2=layer2, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry)
