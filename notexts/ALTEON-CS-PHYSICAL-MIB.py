...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCfg=portTeamCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTable=portTeamInfoTable, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgState=mstCurCfgState, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgStg=vlanCurCfgStg, vlanInfoId=vlanInfoId, vlan=vlan, stpInfoRootCost=stpInfoRootCost, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgIndex=stgNewCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortState=lacpNewPortState, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgState=portTeamNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbEntry=fdbEntry, stpInfoTable=stpInfoTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mirrPortMirr=mirrPortMirr, vlanInfo=vlanInfo, vlanCurCfgPorts=vlanCurCfgPorts, mstGeneralCfg=mstGeneralCfg, stpInfoHelloTime=stpInfoHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoRootPort=stpInfoRootPort, lacpInfoPortTable=lacpInfoPortTable, cistInfoPortState=cistInfoPortState, vlanInfoName=vlanInfoName, vlanInfoStatus=vlanInfoStatus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortIndex=stgStatsPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgTable=stgCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Stats=layer2Stats, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, BridgeId=BridgeId, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, fdbMacAddr=fdbMacAddr, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsLookups=fdbStatsLookups, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgStg=vlanNewCfgStg, vlanInfoPorts=vlanInfoPorts, fdbSrcPort=fdbSrcPort, layer2Configs=layer2Configs, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, layer2=layer2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoPortStpIndex=stpInfoPortStpIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpStats=stpStats, stpInfoPortRole=stpInfoPortRole, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCfg=mstCfg, stpInfoIndex=stpInfoIndex, cistRegionalRoot=cistRegionalRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbTable=fdbTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpInfo=lacpInfo, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbClear=fdbClear, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbRefSps=fdbRefSps, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgState=vlanCurCfgState, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Oper=layer2Oper, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortPathCost=stgCurCfgPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, cistInfo=cistInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, lacpCurPortState=lacpCurPortState, layer2Info=layer2Info, stpInfoPortTableEntry=stpInfoPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortState=stpInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanInfoTable=vlanInfoTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortTable=cistInfoPortTable, fdbStatsCreates=fdbStatsCreates, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbVlan=fdbVlan, vlanMaxVlanID=vlanMaxVlanID, mirroring=mirroring, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgStpMode=mstNewCfgStpMode, fdbLearnedPort=fdbLearnedPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgState=mstNewCfgState, fdbState=fdbState, fdbInfo=fdbInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCfg=mstCistCfg, cistRootPathCost=cistRootPathCost, stpInfo=stpInfo, vlanInfoLearn=vlanInfoLearn, trunkgroup=trunkgroup, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsCurrent=fdbStatsCurrent, cistRootPort=cistRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgNewCfgState=stgNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgPortTable=stgCurCfgPortTable, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortTable=stgStatsPortTable, cistInfoPortRole=cistInfoPortRole, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfo=portTeamInfo, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, PYSNMP_MODULE_ID=layer2, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCfg=stgCfg, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortTable=stpInfoPortTable, lacp=lacp, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsFinds=fdbStatsFinds, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistBridgeCfg=mstCistBridgeCfg, cistRoot=cistRoot, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxEnt=vlanMaxEnt, fdbStats=fdbStats)
