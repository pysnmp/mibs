...
Integer32, NotificationType, ObjectIdentity, iso, MibIdentifier, Bits, Gauge32, Counter64, TimeTicks, IpAddress, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ObjectIdentity", "iso", "MibIdentifier", "Bits", "Gauge32", "Counter64", "TimeTicks", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgTable=portTeamNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFinds=fdbStatsFinds, layer2Oper=layer2Oper, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortRole=cistInfoPortRole, mstNewCfgState=mstNewCfgState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbSrcPort=fdbSrcPort, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoRootCost=stpInfoRootCost, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mirrPortMirr=mirrPortMirr, layer2Info=layer2Info, portTeamCurCfgPorts=portTeamCurCfgPorts, BridgeId=BridgeId, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfo=portTeamInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoTable=vlanInfoTable, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistRootPort=cistRootPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, PYSNMP_MODULE_ID=layer2, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbStats=fdbStats, stpInfo=stpInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoPortsState=portTeamInfoPortsState, trunkgroup=trunkgroup, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgLearn=vlanCurCfgLearn, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortState=stpInfoPortState, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgPorts=vlanNewCfgPorts, mstCurCfgState=mstCurCfgState, cistRoot=cistRoot, fdbStatsFindFails=fdbStatsFindFails, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbEntry=fdbEntry, mstCfg=mstCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortMoved=lacpInfoPortMoved, mstNewCfgStpMode=mstNewCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbVlan=fdbVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, stpInfoRootPort=stpInfoRootPort, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgPortState=stgCurCfgPortState, cistRegionalPathCost=cistRegionalPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTable=stgCurCfgTable, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfo=cistInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbTable=fdbTable, cistInfoPortIndex=cistInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsCreates=fdbStatsCreates, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoHelloTime=stpInfoHelloTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoId=vlanInfoId, fdbInfo=fdbInfo, stgNewCfgState=stgNewCfgState, cistInfoPortState=cistInfoPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfo=vlanInfo, vlanInfoTableEntry=vlanInfoTableEntry, stpStats=stpStats, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoName=vlanInfoName, fdbRefSps=fdbRefSps, stgNewCfgPortPriority=stgNewCfgPortPriority, cistBridgeForwardDelay=cistBridgeForwardDelay, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistBridgeMaxAge=cistBridgeMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoIndex=stpInfoIndex, fdbClear=fdbClear, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbMacAddr=fdbMacAddr, mstCurCfgStpMode=mstCurCfgStpMode, vlan=vlan, layer2=layer2, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCfg=mstCistCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookups=fdbStatsLookups, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstGeneralCfg=mstGeneralCfg, stpInfoTopChanges=stpInfoTopChanges, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgState=vlanCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortRole=stpInfoPortRole, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsHiwat=fdbStatsHiwat, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, cistInfoPortTable=cistInfoPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, layer2Stats=layer2Stats, lacpNewPortState=lacpNewPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoTable=portTeamInfoTable, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTable=stpInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoHoldTime=stpInfoHoldTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoTableEntry=stpInfoTableEntry, vlanInfoStatus=vlanInfoStatus, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgState=stgCurCfgState, lacpInfo=lacpInfo, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortEdge=stpInfoPortEdge, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanMaxEnt=vlanMaxEnt, layer2Configs=layer2Configs, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCfg=portTeamCfg, lacp=lacp, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortState=lacpCurPortState)
