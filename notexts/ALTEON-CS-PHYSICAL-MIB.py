...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortState=stgNewCfgPortState, stpStats=stpStats, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Stats=layer2Stats, vlanInfoStatus=vlanInfoStatus, fdbStats=fdbStats, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbClear=fdbClear, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoId=vlanInfoId, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, cistInfoPortRole=cistInfoPortRole, stgNewCfgPriority=stgNewCfgPriority, layer2Configs=layer2Configs, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCfg=portTeamCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanMaxVlanID=vlanMaxVlanID, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, mstCistBridgeCfg=mstCistBridgeCfg, cistBridgeHelloTime=cistBridgeHelloTime, stgCfg=stgCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortState=stpInfoPortState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoName=vlanInfoName, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortTable=lacpInfoPortTable, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbEntry=fdbEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlan=vlan, BridgeId=BridgeId, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamInfoState=portTeamInfoState, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfo=cistInfo, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoPortRole=stpInfoPortRole, cistInfoPortPriority=cistInfoPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsDeletes=fdbStatsDeletes, PYSNMP_MODULE_ID=layer2, layer2Oper=layer2Oper, stgCurCfgState=stgCurCfgState, mstCfg=mstCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgTable=stgNewCfgTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoPorts=portTeamInfoPorts, vlanInfoPorts=vlanInfoPorts, stgStatsStpIndex=stgStatsStpIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, layer2=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgState=portTeamNewCfgState, layer2Info=layer2Info, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoTable=stpInfoTable, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgState=mstCurCfgState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgIndex=stgNewCfgIndex, fdbTable=fdbTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoRootPort=stpInfoRootPort, stgNewCfgState=stgNewCfgState, stpInfoHoldTime=stpInfoHoldTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfo=vlanInfo, fdbInfo=fdbInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbMacAddr=fdbMacAddr, stpInfoHelloTime=stpInfoHelloTime, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacp=lacp, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsFindFails=fdbStatsFindFails, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoTableEntry=stpInfoTableEntry, lacpInfo=lacpInfo, vlanNewCfgTable=vlanNewCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortLink=stgNewCfgPortLink, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfo=portTeamInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoRootCost=stpInfoRootCost, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoIndex=stpInfoIndex, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsFinds=fdbStatsFinds, fdbStatsOverflows=fdbStatsOverflows, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPort=cistRootPort, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRoot=cistRoot, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanMaxEnt=vlanMaxEnt, stpInfo=stpInfo, portTeamInfoIndex=portTeamInfoIndex, fdbState=fdbState, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, fdbLearnedPort=fdbLearnedPort, cistRootPathCost=cistRootPathCost, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortState=cistInfoPortState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkgroup=trunkgroup, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCfg=mstCistCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, fdbRefSps=fdbRefSps, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpCurPortState=lacpCurPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortTable=cistInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortTable=stpInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbSrcPort=fdbSrcPort, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpNewPortState=lacpNewPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, mstNewCfgState=mstNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgState=vlanNewCfgState, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirroring=mirroring, vlanInfoTable=vlanInfoTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstGeneralCfg=mstGeneralCfg, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoLearn=vlanInfoLearn)
