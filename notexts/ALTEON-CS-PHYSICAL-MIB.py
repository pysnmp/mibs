...
TimeTicks, iso, Bits, IpAddress, Gauge32, Unsigned32, Integer32, Counter64, ObjectIdentity, NotificationType, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "IpAddress", "Gauge32", "Unsigned32", "Integer32", "Counter64", "ObjectIdentity", "NotificationType", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoPorts=vlanInfoPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortState=stgCurCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoIndex=stpInfoIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgRegionVersion=mstNewCfgRegionVersion, PYSNMP_MODULE_ID=layer2, stgCurCfgPortLink=stgCurCfgPortLink, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoTable=stpInfoTable, cistRoot=cistRoot, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistInfoPortState=cistInfoPortState, cistInfo=cistInfo, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, layer2=layer2, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbEntry=fdbEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoStatus=vlanInfoStatus, portTeamInfoState=portTeamInfoState, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortState=lacpCurPortState, fdbVlan=fdbVlan, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbLearnedPort=fdbLearnedPort, stpInfoPortEdge=stpInfoPortEdge, lacpInfo=lacpInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, fdbStatsLookups=fdbStatsLookups, stpInfoRootPort=stpInfoRootPort, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortIndex=stpInfoPortIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortState=stpInfoPortState, fdbStatsOverflows=fdbStatsOverflows, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, mstCfg=mstCfg, cistRootPathCost=cistRootPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, portTeamInfo=portTeamInfo, vlan=vlan, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanInfoLearn=vlanInfoLearn, stgCfg=stgCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Stats=layer2Stats, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoTopChanges=stpInfoTopChanges, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoRootCost=stpInfoRootCost, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCfg=mstCistCfg, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortTable=stpInfoPortTable, stpStats=stpStats, fdbSrcPort=fdbSrcPort, stgCurCfgTable=stgCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRegionalPathCost=cistRegionalPathCost, portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoTable=vlanInfoTable, stgCurCfgPriority=stgCurCfgPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Configs=layer2Configs, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, portTeamCurCfgTable=portTeamCurCfgTable, trunkgroup=trunkgroup, fdbStats=fdbStats, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbTable=fdbTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, layer2Oper=layer2Oper, mirroring=mirroring, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbState=fdbState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistRootPort=cistRootPort, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbMacAddr=fdbMacAddr, mstNewCfgState=mstNewCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanNewCfgLearn=vlanNewCfgLearn, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2Info=layer2Info, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamCfg=portTeamCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortRole=stpInfoPortRole, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsCreates=fdbStatsCreates, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortIndex=stgCurCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoHoldTime=stpInfoHoldTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgStatsPortTable=stgStatsPortTable, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanInfoName=vlanInfoName, cistGeneralInfo=cistGeneralInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanInfoId=vlanInfoId, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfo=stpInfo, vlanInfo=vlanInfo, mstCurCfgState=mstCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsLookupFails=fdbStatsLookupFails, portTeamInfoPortsState=portTeamInfoPortsState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbClear=fdbClear, BridgeId=BridgeId, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgStpMode=mstNewCfgStpMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoIndex=portTeamInfoIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbRefSps=fdbRefSps, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortState=lacpNewPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgState=stgNewCfgState)
