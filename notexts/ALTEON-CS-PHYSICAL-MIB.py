...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfo=stpInfo, lacpCurPortState=lacpCurPortState, fdbStatsFinds=fdbStatsFinds, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoTable=vlanInfoTable, stpInfoTable=stpInfoTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCfg=mstCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpInfoPortTable=lacpInfoPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2=layer2, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgState=vlanCurCfgState, fdbSrcPort=fdbSrcPort, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfo=lacpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgIndex=stgNewCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, layer2Stats=layer2Stats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Configs=layer2Configs, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTable=lacpCurPortCfgTable, cistRegionalPathCost=cistRegionalPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortState=cistInfoPortState, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mirroring=mirroring, stgCurCfgState=stgCurCfgState, mstNewCfgState=mstNewCfgState, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoPortTable=stpInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacp=lacp, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgTable=portTeamNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortState=lacpNewPortState, layer2Oper=layer2Oper, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoPorts=portTeamInfoPorts, fdbStatsOverflows=fdbStatsOverflows, mstCistCfg=mstCistCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoIndex=portTeamInfoIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, fdbStatsLookups=fdbStatsLookups, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCurCfgState=mstCurCfgState, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoIndex=stpInfoIndex, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgPorts=vlanCurCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, vlanMaxEnt=vlanMaxEnt, stpInfoPortState=stpInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, cistInfo=cistInfo, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistRootPort=cistRootPort, vlanNewCfgPorts=vlanNewCfgPorts, cistGeneralInfo=cistGeneralInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbState=fdbState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpStats=stpStats, stgCurCfgTable=stgCurCfgTable, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgStatsPortTable=stgStatsPortTable, vlan=vlan, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortRole=cistInfoPortRole, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbVlan=fdbVlan, fdbRefSps=fdbRefSps, mstGeneralCfg=mstGeneralCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoRootPort=stpInfoRootPort, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoLearn=vlanInfoLearn, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoName=vlanInfoName, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamCfg=portTeamCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbMacAddr=fdbMacAddr, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, fdbTable=fdbTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoRootCost=stpInfoRootCost, portTeamInfo=portTeamInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbInfo=fdbInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, fdbStats=fdbStats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mirrPortMirr=mirrPortMirr, PYSNMP_MODULE_ID=layer2, vlanNewCfgStg=vlanNewCfgStg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoHoldTime=stpInfoHoldTime, stpInfoHelloTime=stpInfoHelloTime, vlanInfoId=vlanInfoId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsCreates=fdbStatsCreates, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanMaxVlanID=vlanMaxVlanID)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamTableMaxSize=portTeamTableMaxSize, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbClear=fdbClear, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgTable=stgNewCfgTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCfg=stgCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, BridgeId=BridgeId, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanInfo=vlanInfo, vlanInfoBwmContract=vlanInfoBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgIndex=stgCurCfgIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortPriority=cistInfoPortPriority, trunkgroup=trunkgroup, stpInfoPortPathCost=stpInfoPortPathCost, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, layer2Info=layer2Info, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey)
