...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortState=lacpCurPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbMacAddr=fdbMacAddr, vlanCurCfgState=vlanCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbLearnedPort=fdbLearnedPort, vlanMaxEnt=vlanMaxEnt, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoForwardDelay=stpInfoForwardDelay, layer2Oper=layer2Oper, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgStg=vlanNewCfgStg, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgState=mstCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoName=vlanInfoName, portTeamCurCfgState=portTeamCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortTable=stgStatsPortTable, portTeamInfoPortsState=portTeamInfoPortsState, mstCfg=mstCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCfg=stgCfg, stgStatsStpIndex=stgStatsStpIndex, stpStats=stpStats, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, layer2Info=layer2Info, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsDeletes=fdbStatsDeletes, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbTable=fdbTable, mstCistCfg=mstCistCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, layer2=layer2, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, vlanInfo=vlanInfo, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, layer2Stats=layer2Stats, lacp=lacp, vlanCurCfgVlanName=vlanCurCfgVlanName, mirroring=mirroring, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewSystemPriority=lacpNewSystemPriority, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortState=stpInfoPortState, lacpInfoPortNtt=lacpInfoPortNtt, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTable=vlanInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistGeneralInfo=cistGeneralInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgIndex=stgNewCfgIndex, portTeamCfg=portTeamCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgState=stgNewCfgState, fdbStatsFindFails=fdbStatsFindFails, fdbVlan=fdbVlan, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbEntry=fdbEntry, layer2Configs=layer2Configs, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoJumbo=vlanInfoJumbo, fdbInfo=fdbInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, vlanMaxVlanID=vlanMaxVlanID, mirrPortMirr=mirrPortMirr, fdbRefSps=fdbRefSps, fdbClear=fdbClear, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortIndex=cistInfoPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoLearn=vlanInfoLearn, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamInfoState=portTeamInfoState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortState=cistInfoPortState, vlanNewCfgState=vlanNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgStpMode=mstCurCfgStpMode, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoIndex=stpInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistRootPort=cistRootPort, cistInfoPortTable=cistInfoPortTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanInfoId=vlanInfoId, portTeamInfo=portTeamInfo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbSrcPort=fdbSrcPort, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, cistInfo=cistInfo, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoRootCost=stpInfoRootCost, cistRoot=cistRoot, vlanInfoStatus=vlanInfoStatus, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstGeneralCfg=mstGeneralCfg, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoTable=stpInfoTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoTableEntry=stpInfoTableEntry, vlanInfoPorts=vlanInfoPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, BridgeId=BridgeId, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoMaxAge=stpInfoMaxAge, fdbState=fdbState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortTable=stpInfoPortTable, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlan=vlan)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortTable=lacpInfoPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfo=stpInfo, vlanNewCfgPorts=vlanNewCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstNewCfgState=mstNewCfgState, stgCurCfgPriority=stgCurCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfo=lacpInfo, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, PYSNMP_MODULE_ID=layer2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortRole=cistInfoPortRole, fdbStats=fdbStats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsFinds=fdbStatsFinds, trunkgroup=trunkgroup, trunkGroupNewCfgState=trunkGroupNewCfgState)
