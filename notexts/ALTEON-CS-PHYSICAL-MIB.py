...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistRegionalRoot=cistRegionalRoot, portTeamInfo=portTeamInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTable=stpInfoTable, stpInfoPortPathCost=stpInfoPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, lacpInfo=lacpInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, lacp=lacp, stgNewCfgTable=stgNewCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbClear=fdbClear, PYSNMP_MODULE_ID=layer2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoTable=vlanInfoTable, stgStatsPortTable=stgStatsPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbSrcPort=fdbSrcPort, fdbStatsLookups=fdbStatsLookups, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoTable=portTeamInfoTable, portTeamInfoState=portTeamInfoState, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCfg=portTeamCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgState=stgNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCfg=stgCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Info=layer2Info, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbStats=fdbStats, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgIndex=stgCurCfgIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistGeneralInfo=cistGeneralInfo, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCfg=mstCfg, cistRegionalPathCost=cistRegionalPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoIndex=stpInfoIndex, stpInfoPortEdge=stpInfoPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortState=stgNewCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoRootCost=stpInfoRootCost, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoName=vlanInfoName, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoHelloTime=stpInfoHelloTime, vlanMaxEnt=vlanMaxEnt, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, mirroring=mirroring, stpInfoPortTable=stpInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbTable=fdbTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortState=cistInfoPortState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstNewCfgState=mstNewCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgState=stgCurCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, cistInfo=cistInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoRootPort=stpInfoRootPort, stpInfo=stpInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, layer2Configs=layer2Configs, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbEntry=fdbEntry, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgState=vlanCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgTable=stgCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgTable=portTeamNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbMacAddr=fdbMacAddr, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortPriority=cistInfoPortPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbVlan=fdbVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfo=vlanInfo, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Oper=layer2Oper, mstCistCfg=mstCistCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortTable=cistInfoPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanInfoPorts=vlanInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgIndex=stgNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpStats=stpStats, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, cistRoot=cistRoot, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortState=stpInfoPortState, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, cistRootPathCost=cistRootPathCost, stpInfoPortRole=stpInfoPortRole, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCurrent=fdbStatsCurrent, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, lacpInfoPortTable=lacpInfoPortTable, vlan=vlan, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpNewPortState=lacpNewPortState, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbInfo=fdbInfo, stgCurCfgPriority=stgCurCfgPriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortState=stgCurCfgPortState, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbRefSps=fdbRefSps, mirrPortMirr=mirrPortMirr, portTeamInfoPorts=portTeamInfoPorts, fdbLearnedPort=fdbLearnedPort, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, layer2=layer2, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, BridgeId=BridgeId, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoId=vlanInfoId, stgNewCfgStgIndex=stgNewCfgStgIndex, layer2Stats=layer2Stats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPort=cistRootPort)
