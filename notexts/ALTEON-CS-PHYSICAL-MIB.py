...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCfg=portTeamCfg, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoState=portTeamInfoState, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgTable=stgCurCfgTable, fdbClear=fdbClear, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalPathCost=cistRegionalPathCost, trunkgroup=trunkgroup, vlanMaxVlanID=vlanMaxVlanID, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoRootPort=stpInfoRootPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortIndex=stpInfoPortIndex, fdbRefSps=fdbRefSps, lacpInfoPortNtt=lacpInfoPortNtt, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortTable=lacpInfoPortTable, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamInfo=portTeamInfo, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFinds=fdbStatsFinds, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoTable=stpInfoTable, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgState=stgNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbStatsCreates=fdbStatsCreates, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamCurCfgState=portTeamCurCfgState, fdbMacAddr=fdbMacAddr, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoStatus=vlanInfoStatus, stgNewCfgTableEntry=stgNewCfgTableEntry, lacp=lacp, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCfg=mstCfg, stgNewCfgIndex=stgNewCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistBridgeMaxAge=cistBridgeMaxAge, fdbTable=fdbTable, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgState=stgCurCfgState, stgCurCfgPriority=stgCurCfgPriority, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfo=lacpInfo, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTable=cistInfoPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoJumbo=vlanInfoJumbo, lacpCurPortState=lacpCurPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortState=lacpNewPortState, lacpInfoPortMoved=lacpInfoPortMoved, layer2Stats=layer2Stats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCurCfgState=mstCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistGeneralInfo=cistGeneralInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoHelloTime=stpInfoHelloTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfo=stpInfo, layer2Oper=layer2Oper, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortState=stgNewCfgPortState, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfo=cistInfo, BridgeId=BridgeId, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortLink=stgCurCfgPortLink, layer2Configs=layer2Configs, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoTable=vlanInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortRole=stpInfoPortRole, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgState=mstNewCfgState, mstCistCfg=mstCistCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortState=stpInfoPortState, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, fdbEntry=fdbEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Info=layer2Info, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, stgCfg=stgCfg, fdbInfo=fdbInfo, vlanInfo=vlanInfo, mirroring=mirroring, mirrPortMirr=mirrPortMirr, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoName=vlanInfoName, stpStats=stpStats, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, vlanMaxEnt=vlanMaxEnt, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortTable=stgStatsPortTable, vlanNewCfgStg=vlanNewCfgStg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, layer2=layer2, fdbVlan=fdbVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgState=trunkGroupNewCfgState, cistRootPort=cistRootPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoId=vlanInfoId, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoPorts=vlanInfoPorts, vlan=vlan, lacpCurSystemPriority=lacpCurSystemPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStats=fdbStats, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTable=portTeamInfoTable, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, PYSNMP_MODULE_ID=layer2, cistRoot=cistRoot, cistInfoPortState=cistInfoPortState, fdbStatsHiwat=fdbStatsHiwat)
