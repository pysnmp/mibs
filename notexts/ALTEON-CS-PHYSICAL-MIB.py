...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCfg=mstCistCfg, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, lacpInfo=lacpInfo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbRefSps=fdbRefSps, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbLearnedPort=fdbLearnedPort, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortTable=stgStatsPortTable, mstCfg=mstCfg, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstGeneralCfg=mstGeneralCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCurCfgStpMode=mstCurCfgStpMode, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, stpInfoTopChanges=stpInfoTopChanges, PYSNMP_MODULE_ID=layer2, stpInfoHelloTime=stpInfoHelloTime, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoName=vlanInfoName, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, cistInfo=cistInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2Oper=layer2Oper, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoLearn=vlanInfoLearn, vlanNewCfgLearn=vlanNewCfgLearn, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stpStats=stpStats, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgIndex=stgNewCfgIndex, cistRootPathCost=cistRootPathCost, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortEdge=stpInfoPortEdge, vlanInfoTable=vlanInfoTable, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbMacAddr=fdbMacAddr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoId=vlanInfoId, fdbVlan=fdbVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Stats=layer2Stats, fdbEntry=fdbEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfo=stpInfo, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgTable=stgCurCfgTable, cistRegionalRoot=cistRegionalRoot, stpInfoPortPathCost=stpInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mirrPortMirr=mirrPortMirr, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsCreates=fdbStatsCreates, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfo=portTeamInfo, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamInfoState=portTeamInfoState, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortState=stgCurCfgPortState, mstCistBridgeCfg=mstCistBridgeCfg, fdbStatsCurrent=fdbStatsCurrent, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortStpIndex=stpInfoPortStpIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, stgNewCfgTableEntry=stgNewCfgTableEntry, cistGeneralInfo=cistGeneralInfo, mstCurCfgState=mstCurCfgState, fdbTable=fdbTable, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoIndex=stpInfoIndex, portTeamInfoIndex=portTeamInfoIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsFindFails=fdbStatsFindFails, vlan=vlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, BridgeId=BridgeId, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStats=fdbStats, portTeamCfg=portTeamCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, cistRoot=cistRoot, layer2Info=layer2Info, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsHiwat=fdbStatsHiwat, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFinds=fdbStatsFinds, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Configs=layer2Configs, lacpNewPortState=lacpNewPortState, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortTable=cistInfoPortTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgState=stgCurCfgState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortState=stpInfoPortState, fdbInfo=fdbInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortState=lacpCurPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgState=vlanCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbSrcPort=fdbSrcPort, fdbState=fdbState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgState=portTeamNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbClear=fdbClear, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanMaxVlanID=vlanMaxVlanID, cistBridgeHelloTime=cistBridgeHelloTime, stgCfg=stgCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgState=mstNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfo=vlanInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoPorts=vlanInfoPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTableEntry=stpInfoPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRootPort=cistRootPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoPorts=portTeamInfoPorts, layer2=layer2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoTable=stpInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgStg=vlanNewCfgStg, trunkgroup=trunkgroup, vlanInfoStatus=vlanInfoStatus, lacp=lacp, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoRootCost=stpInfoRootCost, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTable=portTeamInfoTable, cistInfoPortRole=cistInfoPortRole, stpInfoPortTable=stpInfoPortTable, stgNewCfgAgingTime=stgNewCfgAgingTime)
