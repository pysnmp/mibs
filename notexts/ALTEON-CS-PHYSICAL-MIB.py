...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mirroring=mirroring, fdbClear=fdbClear, vlanInfoPorts=vlanInfoPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbTable=fdbTable, stpInfoPortState=stpInfoPortState, layer2=layer2, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoForwardDelay=stpInfoForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCfg=stgCfg, cistRootPathCost=cistRootPathCost, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanId=vlanNewCfgVlanId, cistRoot=cistRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamCfg=portTeamCfg, portTeamInfoPorts=portTeamInfoPorts, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbRefSps=fdbRefSps, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrPortMirr=mirrPortMirr, vlanNewCfgState=vlanNewCfgState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbSrcPort=fdbSrcPort, stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, mstCistCfg=mstCistCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortLinkType=stpInfoPortLinkType, layer2Stats=layer2Stats, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTable=stpInfoTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfo=portTeamInfo, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, PYSNMP_MODULE_ID=layer2, lacpNewPortState=lacpNewPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgState=mstNewCfgState, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortTable=stgStatsPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCfg=mstCfg, fdbStatsCreates=fdbStatsCreates, lacp=lacp, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortState=cistInfoPortState, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortRole=stpInfoPortRole, fdbStatsFinds=fdbStatsFinds, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistRootPort=cistRootPort, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoName=vlanInfoName, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoId=vlanInfoId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbEntry=fdbEntry, lacpInfo=lacpInfo, vlanNewCfgLearn=vlanNewCfgLearn, cistGeneralInfo=cistGeneralInfo, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortState=stgNewCfgPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgStpMode=mstNewCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStats=fdbStats, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbStatsLookupFails=fdbStatsLookupFails, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoTable=vlanInfoTable, stpInfoPortTable=stpInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgState=stgNewCfgState, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, mstGeneralCfg=mstGeneralCfg, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortTable=cistInfoPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamInfoTable=portTeamInfoTable, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCurCfgState=mstCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortLink=stgCurCfgPortLink, BridgeId=BridgeId, stgNewCfgPriority=stgNewCfgPriority, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoIndex=stpInfoIndex, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortState=lacpCurPortState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlan=vlan, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTable=lacpNewPortCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoRootPort=stpInfoRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Info=layer2Info, stpStats=stpStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, layer2Configs=layer2Configs, portTeamInfoState=portTeamInfoState, stpInfo=stpInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgState=portTeamNewCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoMaxAge=stpInfoMaxAge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgState=vlanCurCfgState, cistInfoPortIndex=cistInfoPortIndex, cistInfo=cistInfo, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbInfo=fdbInfo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRegionalRoot=cistRegionalRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoDesignatedRoot=stpInfoDesignatedRoot, fdbStatsHiwat=fdbStatsHiwat, layer2Oper=layer2Oper, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCurCfgStpMode=mstCurCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgState=portTeamCurCfgState, fdbStatsLookups=fdbStatsLookups, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbState=fdbState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanMaxEnt=vlanMaxEnt, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgTable=portTeamNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgTable=stgNewCfgTable, stgCurCfgState=stgCurCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortTable=lacpInfoPortTable, fdbStatsFindFails=fdbStatsFindFails, trunkgroup=trunkgroup, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbVlan=fdbVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbMacAddr=fdbMacAddr, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanInfo=vlanInfo)
