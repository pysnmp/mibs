...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCfg=stgCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpStats=stpStats, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCfg=portTeamCfg, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoStatus=vlanInfoStatus, layer2Stats=layer2Stats, vlanInfo=vlanInfo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFinds=fdbStatsFinds, stgStatsPortTable=stgStatsPortTable, stgCurCfgTable=stgCurCfgTable, portTeamInfoPorts=portTeamInfoPorts, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, cistRegionalRoot=cistRegionalRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortState=stpInfoPortState, vlanInfoPorts=vlanInfoPorts, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsCurrent=fdbStatsCurrent, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Configs=layer2Configs, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, mirroring=mirroring, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoRootPort=stpInfoRootPort, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoName=vlanInfoName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, fdbRefSps=fdbRefSps, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgState=mstNewCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, layer2Info=layer2Info, cistInfoPortRole=cistInfoPortRole, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCfg=mstCfg, cistInfoPortState=cistInfoPortState, stgCurCfgState=stgCurCfgState, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStats=fdbStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortTable=stpInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistRegionalPathCost=cistRegionalPathCost, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamNewCfgState=portTeamNewCfgState, fdbLearnedPort=fdbLearnedPort, mirrPortMirr=mirrPortMirr, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoJumbo=vlanInfoJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbSrcPort=fdbSrcPort, stpInfoTable=stpInfoTable, lacpInfo=lacpInfo, fdbStatsLookupFails=fdbStatsLookupFails, vlanMaxVlanID=vlanMaxVlanID, stpInfoIndex=stpInfoIndex, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbState=fdbState, vlanNewCfgStg=vlanNewCfgStg, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, PYSNMP_MODULE_ID=layer2, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbMacAddr=fdbMacAddr, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortEdge=stpInfoPortEdge, layer2=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistRootPathCost=cistRootPathCost, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpCurSystemPriority=lacpCurSystemPriority, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoState=portTeamInfoState, stgNewCfgIndex=stgNewCfgIndex, portTeamInfo=portTeamInfo, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsCreates=fdbStatsCreates, cistInfoPortPathCost=cistInfoPortPathCost, fdbSrcTrunk=fdbSrcTrunk, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistInfo=cistInfo, vlan=vlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgTable=vlanNewCfgTable, stpInfoRootCost=stpInfoRootCost, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgState=vlanCurCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacp=lacp, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, BridgeId=BridgeId, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgRegionName=mstCurCfgRegionName, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Oper=layer2Oper, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstGeneralCfg=mstGeneralCfg, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoId=vlanInfoId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTable=cistInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsLookups=fdbStatsLookups, stgStatsStpIndex=stgStatsStpIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbVlan=fdbVlan, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistRootPort=cistRootPort, lacpNewPortState=lacpNewPortState, cistGeneralInfo=cistGeneralInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsFindFails=fdbStatsFindFails, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortIndex=stgStatsPortIndex, fdbClear=fdbClear, vlanInfoTable=vlanInfoTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbInfo=fdbInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbTable=fdbTable, fdbEntry=fdbEntry, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfo=stpInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCfg=mstCistCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistRoot=cistRoot, lacpCurPortState=lacpCurPortState, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanMaxEnt=vlanMaxEnt, cistInfoPortPriority=cistInfoPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, trunkgroup=trunkgroup)
