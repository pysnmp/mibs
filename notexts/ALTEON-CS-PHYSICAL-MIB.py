...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstNewCfgStpMode=mstNewCfgStpMode, layer2Configs=layer2Configs, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHoldTime=stpInfoHoldTime, cistInfoPortTable=cistInfoPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, mstCistCfg=mstCistCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, mstNewCfgState=mstNewCfgState, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoTable=stpInfoTable, cistInfoPortPriority=cistInfoPortPriority, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCfg=mstCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbMacAddr=fdbMacAddr, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPortsState=portTeamInfoPortsState, fdbRefSps=fdbRefSps, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgState=stgNewCfgState, fdbTable=fdbTable, lacpCurPortState=lacpCurPortState, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, lacpInfo=lacpInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistRootPort=cistRootPort, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkgroup=trunkgroup, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfo=vlanInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortState=lacpNewPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbStatsLookupFails=fdbStatsLookupFails, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbSrcPort=fdbSrcPort, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTable=stgCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, layer2=layer2, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistRootPathCost=cistRootPathCost, mstCistDefaultCfg=mstCistDefaultCfg, fdbState=fdbState, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCfg=stgCfg, portTeamInfoTable=portTeamInfoTable, fdbLearnedPort=fdbLearnedPort, fdbStatsFinds=fdbStatsFinds, vlanInfoId=vlanInfoId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgIndex=stgCurCfgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCurCfgState=mstCurCfgState, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRegionalRoot=cistRegionalRoot, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfo=stpInfo, stgCurCfgPortLink=stgCurCfgPortLink, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mirroring=mirroring, cistInfoPortIndex=cistInfoPortIndex, layer2Oper=layer2Oper, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbInfo=fdbInfo, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortState=stgCurCfgPortState, cistInfo=cistInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsFindFails=fdbStatsFindFails, BridgeId=BridgeId, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStatsOverflows=fdbStatsOverflows, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2Stats=layer2Stats, vlanInfoPorts=vlanInfoPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistRoot=cistRoot, layer2Info=layer2Info, portTeamInfo=portTeamInfo, portTeamCurCfgState=portTeamCurCfgState, stpInfoRootPort=stpInfoRootPort, vlanNewCfgStg=vlanNewCfgStg, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortState=cistInfoPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgState=stgCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemPriority=lacpNewSystemPriority, lacp=lacp, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortTable=stpInfoPortTable, vlan=vlan, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbClear=fdbClear, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbEntry=fdbEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortRole=cistInfoPortRole, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbVlan=fdbVlan, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortCfgTable=lacpCurPortCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsLookups=fdbStatsLookups, PYSNMP_MODULE_ID=layer2, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortPathCost=stpInfoPortPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoLearn=vlanInfoLearn, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortState=stpInfoPortState, fdbStats=fdbStats, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortTable=lacpInfoPortTable, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stpStats=stpStats, portTeamCfg=portTeamCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanInfoName=vlanInfoName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry)
