...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, NotificationType, IpAddress, Integer32, ModuleIdentity, Counter64, Counter32, TimeTicks, Bits, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "NotificationType", "IpAddress", "Integer32", "ModuleIdentity", "Counter64", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoId=vlanInfoId, PYSNMP_MODULE_ID=layer2, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgTable=portTeamCurCfgTable, fdbMacAddr=fdbMacAddr, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, fdbEntry=fdbEntry, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, cistRootPort=cistRootPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTableEntry=stpInfoTableEntry, fdbStats=fdbStats, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, cistBridgeMaxAge=cistBridgeMaxAge, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfo=vlanInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacp=lacp, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, layer2Configs=layer2Configs, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortTable=stgStatsPortTable, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortRole=cistInfoPortRole, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbVlan=fdbVlan, vlanNewCfgState=vlanNewCfgState, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortMoved=lacpInfoPortMoved, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfo=portTeamInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, mirrPortMirr=mirrPortMirr, stpInfoRootCost=stpInfoRootCost, fdbStatsFinds=fdbStatsFinds, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbRefSps=fdbRefSps, mirroring=mirroring, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, layer2Stats=layer2Stats, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCfg=mstCistCfg, vlanCurCfgState=vlanCurCfgState, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfo=stpInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsStpIndex=stgStatsStpIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpStats=stpStats, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCfg=stgCfg, vlanInfoLearn=vlanInfoLearn, stgCurCfgPriority=stgCurCfgPriority, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbSrcPort=fdbSrcPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoName=vlanInfoName, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgPortState=stgNewCfgPortState, fdbInfo=fdbInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpNewPortState=lacpNewPortState, portTeamInfoState=portTeamInfoState, fdbState=fdbState, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoHelloTime=stpInfoHelloTime, mstGeneralCfg=mstGeneralCfg, fdbStatsOverflows=fdbStatsOverflows, stpInfoIndex=stpInfoIndex, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlan=vlan, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRoot=cistRoot, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, BridgeId=BridgeId, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTable=stpInfoTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, mstCfg=mstCfg, cistInfoPortPriority=cistInfoPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgTable=stgCurCfgTable, layer2Oper=layer2Oper, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTable=portTeamInfoTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbStatsCreates=fdbStatsCreates, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortRole=stpInfoPortRole, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortTable=lacpInfoPortTable, portTeamCfg=portTeamCfg, mstNewCfgRegionName=mstNewCfgRegionName, mstCurCfgStpMode=mstCurCfgStpMode, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbStatsHiwat=fdbStatsHiwat, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgPortTable=stgCurCfgPortTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistDefaultCfg=mstCistDefaultCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgVlanName=vlanNewCfgVlanName, layer2Info=layer2Info, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortIndex=stpInfoPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgIndex=stgCurCfgIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, layer2=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgState=stgCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfo=lacpInfo, fdbTable=fdbTable, cistRootPathCost=cistRootPathCost, trunkgroup=trunkgroup, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoPortTable=stpInfoPortTable, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortState=stpInfoPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCurCfgState=mstCurCfgState, vlanInfoPorts=vlanInfoPorts, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, cistGeneralInfo=cistGeneralInfo, vlanInfoTableEntry=vlanInfoTableEntry, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfo=cistInfo)
