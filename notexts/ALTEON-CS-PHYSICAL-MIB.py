...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsPortTable=stgStatsPortTable, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortState=stgCurCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbInfo=fdbInfo, vlanCurCfgTable=vlanCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanInfoPorts=vlanInfoPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbTable=fdbTable, lacpInfo=lacpInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkgroup=trunkgroup, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanInfoTableEntry=vlanInfoTableEntry, layer2=layer2, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, mirrPortMirr=mirrPortMirr, cistGeneralInfo=cistGeneralInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortLinkType=stpInfoPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamCfg=portTeamCfg, PYSNMP_MODULE_ID=layer2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgState=stgCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewSystemPriority=lacpNewSystemPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbStatsCreates=fdbStatsCreates, layer2Configs=layer2Configs, mstNewCfgRegionName=mstNewCfgRegionName, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoId=vlanInfoId, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortPathCost=cistInfoPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgState=portTeamNewCfgState, fdbStats=fdbStats, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsCurrent=fdbStatsCurrent, fdbStatsFinds=fdbStatsFinds, stgNewCfgIndex=stgNewCfgIndex, fdbStatsOverflows=fdbStatsOverflows, fdbRefSps=fdbRefSps, stpInfoPortEdge=stpInfoPortEdge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoTable=portTeamInfoTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoTopChanges=stpInfoTopChanges, portTeamInfoState=portTeamInfoState, layer2Info=layer2Info, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCfg=mstCistCfg, fdbState=fdbState, lacpNewPortState=lacpNewPortState, vlanNewCfgTable=vlanNewCfgTable, fdbStatsHiwat=fdbStatsHiwat, vlanInfo=vlanInfo, cistInfoPortTable=cistInfoPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRootPathCost=cistRootPathCost, stpStats=stpStats, vlanCurCfgPorts=vlanCurCfgPorts, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistInfoPortState=cistInfoPortState, vlanInfoName=vlanInfoName, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamCurCfgPorts=portTeamCurCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoRootCost=stpInfoRootCost, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpCurPortState=lacpCurPortState, portTeamInfo=portTeamInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfoTableEntry=stpInfoTableEntry, cistRegionalRoot=cistRegionalRoot, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCfg=stgCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbVlan=fdbVlan, stpInfoTable=stpInfoTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoPorts=portTeamInfoPorts, mstCfg=mstCfg, vlanInfoLearn=vlanInfoLearn, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgState=stgNewCfgState, stpInfo=stpInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, mirroring=mirroring, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, lacp=lacp, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbClear=fdbClear, stpInfoIndex=stpInfoIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, fdbEntry=fdbEntry, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortRole=stpInfoPortRole, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbSrcPort=fdbSrcPort, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRoot=cistRoot, vlanInfoTable=vlanInfoTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Oper=layer2Oper, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbMacAddr=fdbMacAddr, stpInfoPortTable=stpInfoPortTable, cistInfo=cistInfo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgPorts=portTeamNewCfgPorts, cistRootPort=cistRootPort, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRegionalPathCost=cistRegionalPathCost, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Stats=layer2Stats, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgState=vlanNewCfgState, vlan=vlan, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortPathCost=stpInfoPortPathCost, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsLookupFails=fdbStatsLookupFails, vlanInfoStatus=vlanInfoStatus, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgCurCfgPortTable=stgCurCfgPortTable, BridgeId=BridgeId, cistInfoPortRole=cistInfoPortRole, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgStgIndex=stgCurCfgStgIndex)
