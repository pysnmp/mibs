...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortTable=cistInfoPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbClear=fdbClear, layer2=layer2, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTable=stpInfoTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoPortTable=stpInfoPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoIndex=portTeamInfoIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortState=lacpNewPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgRegionName=mstNewCfgRegionName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, BridgeId=BridgeId, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoForwardDelay=stpInfoForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortState=stpInfoPortState, vlanMaxVlanID=vlanMaxVlanID, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbStatsLookups=fdbStatsLookups, lacpCurSystemPriority=lacpCurSystemPriority, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, cistRootPort=cistRootPort, layer2Configs=layer2Configs, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, cistRegionalRoot=cistRegionalRoot, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoRootPort=stpInfoRootPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortState=stgCurCfgPortState, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoIndex=stpInfoIndex, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanInfoId=vlanInfoId, fdbRefSps=fdbRefSps, mstNewCfgStpMode=mstNewCfgStpMode, lacpInfoPortMoved=lacpInfoPortMoved, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfo=portTeamInfo, stgNewCfgState=stgNewCfgState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mirrPortMirr=mirrPortMirr, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbVlan=fdbVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsFinds=fdbStatsFinds, layer2Info=layer2Info, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgStatsPortTable=stgStatsPortTable, fdbTable=fdbTable, mstCistCfg=mstCistCfg, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, stgStatsPortTableEntry=stgStatsPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStats=fdbStats, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgIndex=stgNewCfgIndex, stpInfoTableEntry=stpInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, fdbEntry=fdbEntry, stpInfoRootCost=stpInfoRootCost, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirroring=mirroring, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCfg=mstCfg, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbSrcPort=fdbSrcPort, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbMacAddr=fdbMacAddr, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstNewCfgState=mstNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortEdge=stpInfoPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgPortEdge=stgCurCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanMaxEnt=vlanMaxEnt, vlanInfoName=vlanInfoName, stpInfoPortLinkType=stpInfoPortLinkType, stpInfo=stpInfo, stgCurCfgPriority=stgCurCfgPriority, stpInfoHoldTime=stpInfoHoldTime, cistInfo=cistInfo, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCfg=portTeamCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortLinkType=cistInfoPortLinkType, vlanInfoTable=vlanInfoTable, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpStats=stpStats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRootPathCost=cistRootPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2Stats=layer2Stats, vlan=vlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacp=lacp, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgState=vlanCurCfgState, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoLearn=vlanInfoLearn, vlanNewCfgDelete=vlanNewCfgDelete, layer2Oper=layer2Oper, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortIndex=stpInfoPortIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortLink=stgCurCfgPortLink, fdbState=fdbState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfo=lacpInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamInfoState=portTeamInfoState, fdbStatsLookupFails=fdbStatsLookupFails, fdbStatsDeletes=fdbStatsDeletes, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, vlanInfo=vlanInfo, lacpCurPortState=lacpCurPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCfg=stgCfg, mstGeneralCfg=mstGeneralCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, PYSNMP_MODULE_ID=layer2, trunkgroup=trunkgroup, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoTopChanges=stpInfoTopChanges, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgState=vlanNewCfgState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgState=portTeamCurCfgState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgState=mstCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbInfo=fdbInfo)
