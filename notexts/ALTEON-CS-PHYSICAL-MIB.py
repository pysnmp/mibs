...
Counter32, MibIdentifier, iso, Unsigned32, ObjectIdentity, Integer32, ModuleIdentity, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "Unsigned32", "ObjectIdentity", "Integer32", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, lacpNewPortState=lacpNewPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoHoldTime=stpInfoHoldTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCfg=stgCfg, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPriority=stgNewCfgPriority, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoMaxAge=stpInfoMaxAge, fdbRefSps=fdbRefSps, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, lacp=lacp, layer2Stats=layer2Stats, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortTable=lacpInfoPortTable, mirroring=mirroring, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, fdbTable=fdbTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortIndex=cistInfoPortIndex, vlanInfoTable=vlanInfoTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfo=stpInfo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanInfoName=vlanInfoName, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortRole=stpInfoPortRole, portTeamInfoTable=portTeamInfoTable, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, vlanNewCfgStg=vlanNewCfgStg, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgAddVlan=pmNewCfgAddVlan, fdbEntry=fdbEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCurCfgState=mstCurCfgState, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoId=vlanInfoId, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgTable=stgCurCfgTable, vlan=vlan, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpInfo=lacpInfo, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStats=fdbStats, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbState=fdbState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortTable=stpInfoPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, cistInfoPortRole=cistInfoPortRole, lacpCurSystemPriority=lacpCurSystemPriority, mstCurCfgRegionName=mstCurCfgRegionName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTable=portTeamNewCfgTable, mstCfg=mstCfg, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgIndex=stgCurCfgIndex, fdbStatsFinds=fdbStatsFinds, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbClear=fdbClear, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanMaxVlanID=vlanMaxVlanID, stpInfoTable=stpInfoTable, stpInfoPortLinkType=stpInfoPortLinkType, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfo=portTeamInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, mstGeneralCfg=mstGeneralCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRoot=cistRoot, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPriority=stgCurCfgPriority, vlanInfoBwmContract=vlanInfoBwmContract, layer2Info=layer2Info, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoState=portTeamInfoState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, fdbStatsFindFails=fdbStatsFindFails, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgStg=vlanCurCfgStg, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoRootPort=stpInfoRootPort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgState=vlanNewCfgState, BridgeId=BridgeId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbLearnedPort=fdbLearnedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgAddPort=vlanNewCfgAddPort, cistBridgeMaxAge=cistBridgeMaxAge, layer2Oper=layer2Oper, vlanInfoLearn=vlanInfoLearn, vlanInfoPorts=vlanInfoPorts, fdbVlan=fdbVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistRootPathCost=cistRootPathCost, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoStatus=vlanInfoStatus, lacpCurPortState=lacpCurPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, stpStats=stpStats, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCfg=mstCistCfg, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsOverflows=fdbStatsOverflows, portTeamInfoPorts=portTeamInfoPorts, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRegionalRoot=cistRegionalRoot, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortState=cistInfoPortState, fdbInfo=fdbInfo, cistGeneralInfo=cistGeneralInfo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgState=mstNewCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgJumbo=vlanCurCfgJumbo, layer2Configs=layer2Configs, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoRootCost=stpInfoRootCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkgroup=trunkgroup, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgState=stgNewCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistInfo=cistInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamCfg=portTeamCfg, vlanCurCfgState=vlanCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortTable=stgStatsPortTable, stgStatsStpIndex=stgStatsStpIndex, vlanInfo=vlanInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, cistRootPort=cistRootPort, mstCistBridgeCfg=mstCistBridgeCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortSelected=lacpInfoPortSelected, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgAddVlan=stgNewCfgAddVlan)
