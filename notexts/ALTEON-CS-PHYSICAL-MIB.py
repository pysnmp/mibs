...
TimeTicks, Counter64, iso, ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, Unsigned32, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgState=trunkGroupCurCfgState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoRootPort=stpInfoRootPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpStats=stpStats, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfo=vlanInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortState=stpInfoPortState, portTeamNewCfgState=portTeamNewCfgState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortState=stgCurCfgPortState, fdbClear=fdbClear, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbTable=fdbTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkgroup=trunkgroup, stpInfoHoldTime=stpInfoHoldTime, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTable=portTeamInfoTable, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, lacp=lacp, PYSNMP_MODULE_ID=layer2, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, cistInfo=cistInfo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistInfoPortRole=cistInfoPortRole, vlanInfoTable=vlanInfoTable, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortTable=lacpInfoPortTable, fdbStats=fdbStats, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgVlanName=vlanCurCfgVlanName, stpInfoHelloTime=stpInfoHelloTime, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortTable=cistInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, BridgeId=BridgeId, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgState=stgNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstGeneralCfg=mstGeneralCfg, stpInfoRootCost=stpInfoRootCost, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistInfoPortPathCost=cistInfoPortPathCost, layer2=layer2, mstNewCfgState=mstNewCfgState, vlanInfoId=vlanInfoId, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, fdbEntry=fdbEntry, cistRegionalRoot=cistRegionalRoot, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfo=portTeamInfo, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTable=stgStatsPortTable, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortState=cistInfoPortState, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoState=portTeamInfoState, stgNewCfgPortState=stgNewCfgPortState, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mirrPortMirr=mirrPortMirr, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgDelete=portTeamNewCfgDelete, vlan=vlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCfg=portTeamCfg, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbSrcPort=fdbSrcPort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbRefSps=fdbRefSps, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistGeneralInfo=cistGeneralInfo, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgLearn=vlanNewCfgLearn, vlanCurCfgState=vlanCurCfgState, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfo=stpInfo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoPorts=vlanInfoPorts, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mirroring=mirroring, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoStatus=vlanInfoStatus, layer2Oper=layer2Oper, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbInfo=fdbInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoTable=stpInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsLookups=fdbStatsLookups, stpInfoIndex=stpInfoIndex, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurPortState=lacpCurPortState, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRootPort=cistRootPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2Configs=layer2Configs, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCfg=mstCfg, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbLearnedPort=fdbLearnedPort, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpInfoPortSelected=lacpInfoPortSelected, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, cistRoot=cistRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoName=vlanInfoName, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCfg=mstCistCfg, layer2Stats=layer2Stats, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbVlan=fdbVlan, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCfg=stgCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoPorts=portTeamInfoPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbMacAddr=fdbMacAddr, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfo=lacpInfo, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, fdbState=fdbState, stgNewCfgPriority=stgNewCfgPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoLearn=vlanInfoLearn, portTeamCurCfgTable=portTeamCurCfgTable)
