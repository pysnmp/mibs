...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoTable=stpInfoTable, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortState=stgCurCfgPortState, cistGeneralInfo=cistGeneralInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortTableEntry=stgStatsPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoForwardDelay=stpInfoForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortSelected=lacpInfoPortSelected, stpStats=stpStats, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortTable=lacpInfoPortTable, fdbEntry=fdbEntry, portTeamCurCfgTable=portTeamCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, trunkgroup=trunkgroup, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoState=portTeamInfoState, lacpCurPortState=lacpCurPortState, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbRefSps=fdbRefSps, stgNewCfgTable=stgNewCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTableEntry=stpInfoTableEntry, cistRootPort=cistRootPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbMacAddr=fdbMacAddr, cistRegionalPathCost=cistRegionalPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbLearnedPort=fdbLearnedPort, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgTable=stgCurCfgTable, stpInfo=stpInfo, mstCistCfg=mstCistCfg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortTable=stgStatsPortTable, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortRole=cistInfoPortRole, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamInfoTableEntry=portTeamInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, PYSNMP_MODULE_ID=layer2, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, stgCfg=stgCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoTable=vlanInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgIndex=stgCurCfgIndex, vlanInfoName=vlanInfoName, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortPriority=cistInfoPortPriority, cistRoot=cistRoot, portTeamInfoPorts=portTeamInfoPorts, portTeamCfg=portTeamCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortIndex=stgStatsPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbVlan=fdbVlan, stpInfoPortRole=stpInfoPortRole, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortState=lacpNewPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbSrcPort=fdbSrcPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, layer2Oper=layer2Oper, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoPortTable=stpInfoPortTable, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbState=fdbState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCurCfgState=mstCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portTeamInfoTable=portTeamInfoTable, layer2=layer2, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgAddVlan=pmNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfo=vlanInfo, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoLearn=vlanInfoLearn, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortLink=stgNewCfgPortLink, mirrPortMirr=mirrPortMirr, vlan=vlan, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortTable=stgNewCfgPortTable, BridgeId=BridgeId, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgState=stgCurCfgState, fdbInfo=fdbInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, portTeamInfoIndex=portTeamInfoIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoId=vlanInfoId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoRootCost=stpInfoRootCost, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgTable=vlanNewCfgTable, lacpNewSystemPriority=lacpNewSystemPriority, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsDeletes=fdbStatsDeletes, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCfg=mstCfg, fdbStatsCreates=fdbStatsCreates, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamInfo=portTeamInfo, fdbClear=fdbClear, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoPorts=vlanInfoPorts, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPriority=stgCurCfgPriority, layer2Stats=layer2Stats, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoIndex=stpInfoIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRegionalRoot=cistRegionalRoot, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstNewCfgRegionName=mstNewCfgRegionName, lacp=lacp, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Configs=layer2Configs, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgAgingTime=stgNewCfgAgingTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoJumbo=vlanInfoJumbo, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoMaxAge=stpInfoMaxAge, fdbTable=fdbTable, stpInfoTopChanges=stpInfoTopChanges, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortState=cistInfoPortState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsLookupFails=fdbStatsLookupFails, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortState=stpInfoPortState, fdbStats=fdbStats, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2Info=layer2Info, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfo=cistInfo, mstGeneralCfg=mstGeneralCfg, lacpInfo=lacpInfo)
