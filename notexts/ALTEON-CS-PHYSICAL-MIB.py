...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, cistRootPort=cistRootPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortRole=cistInfoPortRole, portTeamInfo=portTeamInfo, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgStatsStpIndex=stgStatsStpIndex, layer2=layer2, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbEntry=fdbEntry, cistInfoPortState=cistInfoPortState, vlanInfoTableEntry=vlanInfoTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortLink=stgNewCfgPortLink, fdbStats=fdbStats, portTeamInfoIndex=portTeamInfoIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanInfoName=vlanInfoName, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoTable=stpInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortNtt=lacpInfoPortNtt, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoTable=vlanInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortState=lacpNewPortState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, BridgeId=BridgeId, portTeamCfg=portTeamCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamTableMaxSize=portTeamTableMaxSize, fdbInfo=fdbInfo, stgCfg=stgCfg, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanMaxVlanID=vlanMaxVlanID, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortTable=stpInfoPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortLink=stgCurCfgPortLink, mstCfg=mstCfg, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfo=cistInfo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbTable=fdbTable, fdbVlan=fdbVlan, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoHelloTime=stpInfoHelloTime, vlanInfoPorts=vlanInfoPorts, lacp=lacp, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoIndex=stpInfoIndex, portTeamInfoTable=portTeamInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpInfoPortIndex=lacpInfoPortIndex, layer2Oper=layer2Oper, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, stpInfoRootCost=stpInfoRootCost, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortState=stgCurCfgPortState, mirroring=mirroring, mstNewCfgRegionVersion=mstNewCfgRegionVersion, PYSNMP_MODULE_ID=layer2, vlanCurCfgLearn=vlanCurCfgLearn, stpStats=stpStats, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mirrPortMirr=mirrPortMirr, portTeamInfoTrunks=portTeamInfoTrunks, cistGeneralInfo=cistGeneralInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoId=vlanInfoId, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpInfo=lacpInfo, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbClear=fdbClear, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgIndex=stgNewCfgIndex, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbSrcPort=fdbSrcPort, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfo=vlanInfo, vlanNewCfgDelete=vlanNewCfgDelete, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Stats=layer2Stats, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortIndex=cistInfoPortIndex, vlan=vlan, fdbStatsCreates=fdbStatsCreates, cistInfoPortTable=cistInfoPortTable, lacpCurPortState=lacpCurPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgState=stgCurCfgState, trunkgroup=trunkgroup, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoTableEntry=stpInfoTableEntry, vlanInfoLearn=vlanInfoLearn, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistRoot=cistRoot, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoTopChanges=stpInfoTopChanges, stpInfoForwardDelay=stpInfoForwardDelay, fdbMacAddr=fdbMacAddr, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCurCfgState=mstCurCfgState, stpInfoPortRole=stpInfoPortRole, layer2Info=layer2Info, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgIndex=portTeamNewCfgIndex, cistRegionalRoot=cistRegionalRoot, cistRootPathCost=cistRootPathCost, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortState=stpInfoPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortPathCost=cistInfoPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgTable=stgCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstNewCfgState=mstNewCfgState, mstCurCfgStpMode=mstCurCfgStpMode)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortStpIndex=stpInfoPortStpIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbState=fdbState, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Configs=layer2Configs, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbLearnedPort=fdbLearnedPort, stpInfo=stpInfo, fdbRefSps=fdbRefSps, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsFinds=fdbStatsFinds, cistInfoPortPriority=cistInfoPortPriority, cistBridgeHelloTime=cistBridgeHelloTime, mstGeneralCfg=mstGeneralCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, stgStatsPortTable=stgStatsPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewSystemPriority=lacpNewSystemPriority, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts)
