...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamTableMaxSize=portTeamTableMaxSize, vlanMaxVlanID=vlanMaxVlanID, stpInfoRootCost=stpInfoRootCost, layer2Stats=layer2Stats, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistCfg=mstCistCfg, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, stpStats=stpStats, fdbEntry=fdbEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, lacpInfo=lacpInfo, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbVlan=fdbVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbState=fdbState, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortRole=cistInfoPortRole, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoPorts=portTeamInfoPorts, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbSrcTrunk=fdbSrcTrunk, vlan=vlan, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTable=stgStatsPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, mstCurCfgStpMode=mstCurCfgStpMode, fdbStats=fdbStats, vlanCurCfgState=vlanCurCfgState, cistInfoPortState=cistInfoPortState, vlanNewCfgLearn=vlanNewCfgLearn, PYSNMP_MODULE_ID=layer2, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbSrcPort=fdbSrcPort, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbTable=fdbTable, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbMacAddr=fdbMacAddr, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgState=stgNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpInfoPortTableEntry=lacpInfoPortTableEntry, fdbClear=fdbClear, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoIndex=stpInfoIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, lacp=lacp, layer2Oper=layer2Oper, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgPriority=stgNewCfgPriority, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbRefSps=fdbRefSps, mirrPortMirr=mirrPortMirr, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortState=lacpNewPortState, cistRoot=cistRoot, cistRootPathCost=cistRootPathCost, cistGeneralInfo=cistGeneralInfo, stgCurCfgIndex=stgCurCfgIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstNewCfgState=mstNewCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoPortRole=stpInfoPortRole, vlanNewCfgTable=vlanNewCfgTable, vlanInfoTable=vlanInfoTable, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfo=vlanInfo, BridgeId=BridgeId, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCfg=mstCfg, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfo=stpInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamInfoTable=portTeamInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamInfoPortsState=portTeamInfoPortsState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkgroup=trunkgroup, fdbStatsCreates=fdbStatsCreates, stpInfoPortTable=stpInfoPortTable, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstNewCfgRegionName=mstNewCfgRegionName, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistInfo=cistInfo, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsHiwat=fdbStatsHiwat, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTable=stpInfoTable, mirroring=mirroring, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbInfo=fdbInfo, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfoStatus=vlanInfoStatus, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstCurCfgRegionName=mstCurCfgRegionName, cistRegionalRoot=cistRegionalRoot, layer2=layer2, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTable=stgCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoJumbo=vlanInfoJumbo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgAddPort=portTeamNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortTable=cistInfoPortTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanInfoId=vlanInfoId, portTeamCfg=portTeamCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCfg=stgCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookups=fdbStatsLookups, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsFinds=fdbStatsFinds, portTeamInfo=portTeamInfo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortPathCost=stgCurCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoRootPort=stpInfoRootPort, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgStg=vlanCurCfgStg, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortState=stpInfoPortState, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgTable=stgNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoHoldTime=stpInfoHoldTime, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoName=vlanInfoName, stgNewCfgIndex=stgNewCfgIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Info=layer2Info, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoMaxAge=stpInfoMaxAge, stgStatsStpIndex=stgStatsStpIndex, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpInfoPortTable=lacpInfoPortTable, cistRootPort=cistRootPort, stpInfoForwardDelay=stpInfoForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, mstGeneralCfg=mstGeneralCfg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortEdge=stpInfoPortEdge, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortIndex=stpInfoPortIndex, layer2Configs=layer2Configs, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoState=portTeamInfoState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgState=stgCurCfgState, fdbLearnedPort=fdbLearnedPort)
