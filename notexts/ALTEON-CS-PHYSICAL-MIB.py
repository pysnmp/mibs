...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfoPortLinkType=cistInfoPortLinkType, layer2=layer2, stgCurCfgPortPriority=stgCurCfgPortPriority, portTeamInfoTrunks=portTeamInfoTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsDeletes=fdbStatsDeletes, stpInfoTable=stpInfoTable, trunkgroup=trunkgroup, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2Info=layer2Info, stpInfoRootPort=stpInfoRootPort, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCurCfgRegionName=mstCurCfgRegionName, BridgeId=BridgeId, vlanCurCfgVlanName=vlanCurCfgVlanName, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbClear=fdbClear, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCfg=portTeamCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoIndex=stpInfoIndex, lacpInfoPortNtt=lacpInfoPortNtt, PYSNMP_MODULE_ID=layer2, fdbRefSps=fdbRefSps, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbState=fdbState, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, layer2Configs=layer2Configs, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgState=mstCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamInfoPortsState=portTeamInfoPortsState, vlan=vlan, lacpCurPortState=lacpCurPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoRootCost=stpInfoRootCost, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgState=stgNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamTableMaxSize=portTeamTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoName=vlanInfoName, stgNewCfgTable=stgNewCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortEdge=stgCurCfgPortEdge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgLearn=vlanNewCfgLearn, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbSrcTrunk=fdbSrcTrunk, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgTable=stgCurCfgTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbVlan=fdbVlan, cistGeneralInfo=cistGeneralInfo, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgPriority=stgNewCfgPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfo=vlanInfo, vlanInfoPorts=vlanInfoPorts, mstCistCfg=mstCistCfg, stgCurCfgPortState=stgCurCfgPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, cistRoot=cistRoot, fdbTable=fdbTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpNewSystemPriority=lacpNewSystemPriority, fdbSrcPort=fdbSrcPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortTable=stpInfoPortTable, portTeamInfo=portTeamInfo, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortState=stgNewCfgPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacp=lacp, stpInfo=stpInfo, vlanInfoTable=vlanInfoTable, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamNewCfgState=portTeamNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Oper=layer2Oper, fdbMacAddr=fdbMacAddr, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfo=cistInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTopChanges=stpInfoTopChanges, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, cistInfoPortState=cistInfoPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStats=fdbStats, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPriority=stgCurCfgPriority, portTeamInfoIndex=portTeamInfoIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRootPathCost=cistRootPathCost, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanMaxVlanID=vlanMaxVlanID, vlanCurCfgStg=vlanCurCfgStg, cistRootPort=cistRootPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgAgingTime=stgNewCfgAgingTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCfg=stgCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mirroring=mirroring, lacpCurPortCfgTableId=lacpCurPortCfgTableId, vlanInfoId=vlanInfoId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpNewPortState=lacpNewPortState, vlanInfoJumbo=vlanInfoJumbo, vlanMaxEnt=vlanMaxEnt, fdbLearnedPort=fdbLearnedPort, fdbEntry=fdbEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbInfo=fdbInfo, stgCurCfgIndex=stgCurCfgIndex, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRegionalPathCost=cistRegionalPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority, lacpInfo=lacpInfo, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFinds=fdbStatsFinds, mstGeneralCfg=mstGeneralCfg, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, stgStatsPortTable=stgStatsPortTable, portTeamInfoState=portTeamInfoState, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mirrPortMirr=mirrPortMirr, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortTable=cistInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgTable=vlanNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, mstCfg=mstCfg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, layer2Stats=layer2Stats, stgCurCfgState=stgCurCfgState, stpInfoPortState=stpInfoPortState, vlanNewCfgPorts=vlanNewCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanInfoStatus=vlanInfoStatus, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstNewCfgState=mstNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTable=portTeamInfoTable, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoLearn=vlanInfoLearn, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpStats=stpStats, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortIndex=stpInfoPortIndex, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState)
