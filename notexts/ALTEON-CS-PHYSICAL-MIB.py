...
Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, ObjectIdentity, iso, ModuleIdentity, IpAddress, MibIdentifier, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoTable=stpInfoTable, fdbStatsFinds=fdbStatsFinds, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgTable=stgNewCfgTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortRole=cistInfoPortRole, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortState=cistInfoPortState, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, layer2Info=layer2Info, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgIndex=stgNewCfgIndex, cistInfoPortIndex=cistInfoPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoRootPort=stpInfoRootPort, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpInfoPortTable=lacpInfoPortTable, fdbVlan=fdbVlan, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfo=portTeamInfo, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, lacp=lacp, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpNewSystemPriority=lacpNewSystemPriority, mstGeneralCfg=mstGeneralCfg, stgCurCfgPriority=stgCurCfgPriority, stpInfoRootCost=stpInfoRootCost, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, fdbStats=fdbStats, trunkGroupNewCfgState=trunkGroupNewCfgState, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamNewCfgState=portTeamNewCfgState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgState=stgCurCfgState, mstNewCfgState=mstNewCfgState, stpStats=stpStats, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsDeletes=fdbStatsDeletes, stpInfoIndex=stpInfoIndex, portTeamInfoState=portTeamInfoState, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortTable=stpInfoPortTable, portTeamInfoTable=portTeamInfoTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanInfoPorts=vlanInfoPorts, lacpInfo=lacpInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbClear=fdbClear, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoStatus=vlanInfoStatus, stpInfoTopChanges=stpInfoTopChanges, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortState=stpInfoPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoHelloTime=stpInfoHelloTime, cistRootPathCost=cistRootPathCost, lacpCurPortState=lacpCurPortState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoMaxAge=stpInfoMaxAge, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, vlanInfoId=vlanInfoId, stgNewCfgTableEntry=stgNewCfgTableEntry, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpNewPortState=lacpNewPortState, fdbInfo=fdbInfo, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Oper=layer2Oper, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanMaxVlanID=vlanMaxVlanID, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistBridgeCfg=mstCistBridgeCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoForwardDelay=stpInfoForwardDelay, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRoot=cistRoot, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoLearn=vlanInfoLearn, portTeamCfg=portTeamCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbSrcPort=fdbSrcPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbMacAddr=fdbMacAddr, mstNewCfgRegionName=mstNewCfgRegionName, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, cistRootPort=cistRootPort, vlanCurCfgState=vlanCurCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, PYSNMP_MODULE_ID=layer2, vlanInfo=vlanInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2=layer2, fdbRefSps=fdbRefSps, vlanNewCfgStg=vlanNewCfgStg, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlan=vlan, mstCistDefaultCfg=mstCistDefaultCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbStatsLookups=fdbStatsLookups, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbEntry=fdbEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgState=mstCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortPathCost=stpInfoPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanNewCfgLearn=vlanNewCfgLearn, cistGeneralInfo=cistGeneralInfo, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortNtt=lacpInfoPortNtt, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, layer2Stats=layer2Stats, cistRegionalPathCost=cistRegionalPathCost, cistInfo=cistInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfo=stpInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, mstCistCfg=mstCistCfg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgStatsStpIndex=stgStatsStpIndex, fdbStatsLookupFails=fdbStatsLookupFails, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCfg=stgCfg, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgIndex=stgCurCfgIndex, layer2Configs=layer2Configs, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoTableEntry=portTeamInfoTableEntry, BridgeId=BridgeId, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgVlanBmap=stgNewCfgVlanBmap, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgTable=portTeamNewCfgTable, fdbTable=fdbTable, mstCfg=mstCfg, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortRole=stpInfoPortRole, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCurCfgStpMode=mstCurCfgStpMode, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsHiwat=fdbStatsHiwat, vlanInfoTable=vlanInfoTable, stgCurCfgAgingTime=stgCurCfgAgingTime, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkgroup=trunkgroup, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanCurCfgTable=vlanCurCfgTable, cistInfoPortTable=cistInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoName=vlanInfoName, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mstNewCfgStpMode=mstNewCfgStpMode)
