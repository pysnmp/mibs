...
MibIdentifier, ModuleIdentity, iso, ObjectIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Integer32, Gauge32, Unsigned32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Integer32", "Gauge32", "Unsigned32", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgIndex=stgCurCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, PYSNMP_MODULE_ID=layer2, vlanMaxVlanID=vlanMaxVlanID, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, vlan=vlan, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCfg=mstCfg, stgNewCfgState=stgNewCfgState, fdbStatsCreates=fdbStatsCreates, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgStatsStpIndex=stgStatsStpIndex, vlanInfoLearn=vlanInfoLearn, layer2Configs=layer2Configs, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbTable=fdbTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamInfoTable=portTeamInfoTable, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortIndex=stpInfoPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoHelloTime=stpInfoHelloTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRegionalRoot=cistRegionalRoot, lacpNewPortCfgTable=lacpNewPortCfgTable, cistInfo=cistInfo, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpInfo=lacpInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgState=mstCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, portTeamCurCfgState=portTeamCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, vlanNewCfgLearn=vlanNewCfgLearn, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgState=mstNewCfgState, fdbInfo=fdbInfo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamInfoIndex=portTeamInfoIndex, fdbEntry=fdbEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgStg=vlanCurCfgStg, cistGeneralInfo=cistGeneralInfo, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbRefSps=fdbRefSps, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, cistInfoPortState=cistInfoPortState, mirrPortMirr=mirrPortMirr, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfo=portTeamInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2=layer2, portTeamInfoTrunks=portTeamInfoTrunks, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbVlan=fdbVlan, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamCfg=portTeamCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbLearnedPort=fdbLearnedPort, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfo=vlanInfo, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mirroring=mirroring, stpInfoRootCost=stpInfoRootCost, stpInfo=stpInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistRootPathCost=cistRootPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoId=vlanInfoId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, fdbStats=fdbStats, fdbSrcPort=fdbSrcPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsFinds=fdbStatsFinds, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistRoot=cistRoot, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgState=vlanCurCfgState, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortRole=stpInfoPortRole, mstCistCfg=mstCistCfg, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbStatsFindFails=fdbStatsFindFails, layer2Stats=layer2Stats, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortState=lacpCurPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, fdbState=fdbState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgState=vlanNewCfgState, stpInfoPortState=stpInfoPortState, fdbStatsCurrent=fdbStatsCurrent, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgState=stgCurCfgState, stpInfoTable=stpInfoTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCfg=stgCfg, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortEdge=stgNewCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoPorts=portTeamInfoPorts, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortRole=cistInfoPortRole, cistRootPort=cistRootPort, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortTable=stgCurCfgPortTable, mstGeneralCfg=mstGeneralCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, fdbStatsLookups=fdbStatsLookups, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoRootPort=stpInfoRootPort, vlanInfoName=vlanInfoName, vlanInfoStatus=vlanInfoStatus, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, stpInfoIndex=stpInfoIndex, cistInfoPortPriority=cistInfoPortPriority, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stpStats=stpStats)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacp=lacp, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, layer2Info=layer2Info, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoState=portTeamInfoState, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortTable=cistInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortTable=stpInfoPortTable, mstNewCfgStpMode=mstNewCfgStpMode, layer2Oper=layer2Oper, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgStatsPortIndex=stgStatsPortIndex, BridgeId=BridgeId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, lacpNewPortState=lacpNewPortState, stgCurCfgPortState=stgCurCfgPortState)
