...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgStatsPortTable=stgStatsPortTable, stpStats=stpStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortIndex=stgStatsPortIndex, fdbStatsCreates=fdbStatsCreates, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortRole=stpInfoPortRole, fdbClear=fdbClear, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgState=mstNewCfgState, portTeamCfg=portTeamCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, layer2Stats=layer2Stats, stpInfoRootCost=stpInfoRootCost, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbMacAddr=fdbMacAddr, vlan=vlan, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbRefSps=fdbRefSps, layer2=layer2, portTeamInfoTable=portTeamInfoTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortState=cistInfoPortState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoPortIndex=stpInfoPortIndex, vlanInfoId=vlanInfoId, layer2Configs=layer2Configs, lacp=lacp, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistRootPathCost=cistRootPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, fdbSrcTrunk=fdbSrcTrunk, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, lacpInfoPortIndex=lacpInfoPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoState=portTeamInfoState, fdbStatsDeletes=fdbStatsDeletes, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamNewCfgTable=portTeamNewCfgTable, cistRootPort=cistRootPort, cistGeneralInfo=cistGeneralInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacpCurPortState=lacpCurPortState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpInfo=lacpInfo, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgPortLink=stgCurCfgPortLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoPortState=stpInfoPortState, fdbTable=fdbTable, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoName=vlanInfoName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbVlan=fdbVlan, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsLookups=fdbStatsLookups, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistInfoPortTable=cistInfoPortTable, portTeamTableMaxSize=portTeamTableMaxSize, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanInfoTableEntry=vlanInfoTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, cistInfoPortRole=cistInfoPortRole, vlanNewCfgVlanName=vlanNewCfgVlanName, cistRoot=cistRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, PYSNMP_MODULE_ID=layer2, stpInfoHoldTime=stpInfoHoldTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfo=portTeamInfo, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCfg=stgCfg, cistInfo=cistInfo, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbStatsOverflows=fdbStatsOverflows, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortIndex=cistInfoPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgIndex=portTeamNewCfgIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgLearn=vlanCurCfgLearn, cistBridgeForwardDelay=cistBridgeForwardDelay, mirroring=mirroring, portTeamInfoPortsState=portTeamInfoPortsState, mstCfg=mstCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoTableEntry=stpInfoTableEntry, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortTable=stpInfoPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCurCfgState=mstCurCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoIndex=stpInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbInfo=fdbInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistCfg=mstCistCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanNewCfgStg=vlanNewCfgStg, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgIndex=stgNewCfgIndex, fdbLearnedPort=fdbLearnedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbEntry=fdbEntry, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Oper=layer2Oper, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortEdge=stpInfoPortEdge, lacpInfoPortSelected=lacpInfoPortSelected, fdbStatsFindOrCreates=fdbStatsFindOrCreates, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfo=stpInfo, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoTable=vlanInfoTable, vlanInfoStatus=vlanInfoStatus, stpInfoTopChanges=stpInfoTopChanges, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanInfoLearn=vlanInfoLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Info=layer2Info, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgState=stgCurCfgState, mstCistBridgeCfg=mstCistBridgeCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoTable=stpInfoTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortTable=lacpInfoPortTable, portTeamNewCfgPorts=portTeamNewCfgPorts, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbState=fdbState, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStats=fdbStats, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfo=vlanInfo, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRegionalRoot=cistRegionalRoot, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanMaxVlanID=vlanMaxVlanID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, BridgeId=BridgeId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry)
