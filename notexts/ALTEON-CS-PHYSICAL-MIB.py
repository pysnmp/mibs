...
Gauge32, MibIdentifier, TimeTicks, Integer32, NotificationType, ObjectIdentity, iso, Bits, IpAddress, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "NotificationType", "ObjectIdentity", "iso", "Bits", "IpAddress", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortRole=cistInfoPortRole, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, fdbRefSps=fdbRefSps, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortState=stpInfoPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsCreates=fdbStatsCreates, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfo=portTeamInfo, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfo=cistInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoTable=vlanInfoTable, stpInfoPortRole=stpInfoPortRole, fdbState=fdbState, vlanInfoName=vlanInfoName, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoRootPort=stpInfoRootPort, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgStg=vlanCurCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstNewCfgRegionVersion=mstNewCfgRegionVersion, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpInfo=lacpInfo, cistGeneralInfo=cistGeneralInfo, mirrPortMirr=mirrPortMirr, cistRootPort=cistRootPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTable=stgCurCfgTable, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgState=vlanCurCfgState, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoPortTable=stpInfoPortTable, stgNewCfgIndex=stgNewCfgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, stpInfo=stpInfo, vlanNewCfgTable=vlanNewCfgTable, stpInfoPortIndex=stpInfoPortIndex, vlanInfoPorts=vlanInfoPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoTopChanges=stpInfoTopChanges, stpInfoTable=stpInfoTable, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCfg=mstCistCfg, fdbInfo=fdbInfo, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbEntry=fdbEntry, BridgeId=BridgeId, lacpNewPortState=lacpNewPortState, fdbSrcPort=fdbSrcPort, vlanNewCfgJumbo=vlanNewCfgJumbo, layer2Stats=layer2Stats, vlanMaxEnt=vlanMaxEnt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoMaxAge=stpInfoMaxAge, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgState=stgNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgIndex=stgCurCfgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, layer2Configs=layer2Configs, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpInfoPortNtt=lacpInfoPortNtt, fdbStatsCurrent=fdbStatsCurrent, portTeamInfoIndex=portTeamInfoIndex, vlan=vlan, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoId=vlanInfoId, layer2Oper=layer2Oper, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanInfoJumbo=vlanInfoJumbo, mstCurCfgState=mstCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoState=portTeamInfoState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCfg=stgCfg, lacpNewSystemPriority=lacpNewSystemPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, layer2Info=layer2Info, vlanMaxVlanID=vlanMaxVlanID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemPriority=lacpCurSystemPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, lacpInfoPortMoved=lacpInfoPortMoved, cistInfoPortState=cistInfoPortState, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, lacpCurPortState=lacpCurPortState, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgPorts=vlanCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoStatus=vlanInfoStatus, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistDefaultCfg=mstCistDefaultCfg, fdbClear=fdbClear, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbSrcTrunk=fdbSrcTrunk, fdbLearnedPort=fdbLearnedPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbVlan=fdbVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgStatsStpIndex=stgStatsStpIndex, fdbMacAddr=fdbMacAddr, cistRoot=cistRoot, cistBridgeMaxAge=cistBridgeMaxAge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgState=stgCurCfgState, vlanInfo=vlanInfo, portTeamCfg=portTeamCfg, fdbStats=fdbStats, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTable=portTeamInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistRegionalRoot=cistRegionalRoot, mstCfg=mstCfg, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortState=stgNewCfgPortState, mstGeneralCfg=mstGeneralCfg, mstNewCfgRegionName=mstNewCfgRegionName, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mirroring=mirroring, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacp=lacp, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortIndex=lacpInfoPortIndex, cistRootPathCost=cistRootPathCost, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkgroup=trunkgroup, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoRootCost=stpInfoRootCost, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoTableEntry=vlanInfoTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, stpStats=stpStats, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStatsLookups=fdbStatsLookups, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsFinds=fdbStatsFinds, PYSNMP_MODULE_ID=layer2, mstNewCfgState=mstNewCfgState, vlanNewCfgState=vlanNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanInfoLearn=vlanInfoLearn, fdbTable=fdbTable, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoPortsState=portTeamInfoPortsState, cistInfoPortTableEntry=cistInfoPortTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistBridgeCfg=mstCistBridgeCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry)
