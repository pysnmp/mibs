...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookups=fdbStatsLookups, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoName=vlanInfoName, layer2Info=layer2Info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgStatsPortTable=stgStatsPortTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanNewCfgState=vlanNewCfgState, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgState=stgCurCfgState, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortPriority=cistInfoPortPriority, portTeamInfo=portTeamInfo, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFinds=fdbStatsFinds, fdbClear=fdbClear, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortTable=cistInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurSystemPriority=lacpCurSystemPriority, portTeamInfoPortsState=portTeamInfoPortsState, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortState=cistInfoPortState, stpInfoTable=stpInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpInfoPortIndex=lacpInfoPortIndex, vlanCurCfgState=vlanCurCfgState, vlanNewCfgStg=vlanNewCfgStg, fdbTable=fdbTable, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgTable=stgCurCfgTable, mstNewCfgState=mstNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgStg=vlanCurCfgStg, stpInfoPortRole=stpInfoPortRole, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacp=lacp, cistInfo=cistInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbInfo=fdbInfo, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbSrcPort=fdbSrcPort, lacpInfoPortSelected=lacpInfoPortSelected, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCfg=stgCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoIndex=stpInfoIndex, cistInfoPortIndex=cistInfoPortIndex, fdbVlan=fdbVlan, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbStatsCreates=fdbStatsCreates, stpInfoTableEntry=stpInfoTableEntry, stpInfo=stpInfo, vlanCurCfgPorts=vlanCurCfgPorts, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalRoot=cistRegionalRoot, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoPortTable=stpInfoPortTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurPortState=lacpCurPortState, portTeamInfoTable=portTeamInfoTable, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPriority=stgCurCfgPriority, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, fdbState=fdbState, stgStatsPortIndex=stgStatsPortIndex, trunkgroup=trunkgroup, fdbStats=fdbStats, stgCurCfgPortState=stgCurCfgPortState, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, mstCurCfgState=mstCurCfgState, stgNewCfgTable=stgNewCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstNewCfgStpMode=mstNewCfgStpMode, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mirrPortMirr=mirrPortMirr, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortState=stpInfoPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbLearnedPort=fdbLearnedPort, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbRefSps=fdbRefSps, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCfg=portTeamCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stpInfoHoldTime=stpInfoHoldTime, layer2Stats=layer2Stats, mstCistCfg=mstCistCfg, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoIndex=portTeamInfoIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbEntry=fdbEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfo=lacpInfo, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxEnt=vlanMaxEnt, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistRootPort=cistRootPort, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgTable=vlanNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoMaxAge=stpInfoMaxAge, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoRootPort=stpInfoRootPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, layer2=layer2, stpStats=stpStats, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoTable=vlanInfoTable, portTeamInfoPorts=portTeamInfoPorts, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, BridgeId=BridgeId, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgState=trunkGroupCurCfgState, stgStatsStpIndex=stgStatsStpIndex, PYSNMP_MODULE_ID=layer2, lacpNewPortState=lacpNewPortState, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortLinkType=stpInfoPortLinkType, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTrunks=portTeamInfoTrunks, cistRegionalPathCost=cistRegionalPathCost, vlanInfoStatus=vlanInfoStatus, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbSrcTrunk=fdbSrcTrunk, cistRootPathCost=cistRootPathCost, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoRootCost=stpInfoRootCost, stpInfoPortPathCost=stpInfoPortPathCost, mirroring=mirroring, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoTableEntry=portTeamInfoTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCfg=mstCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanInfoId=vlanInfoId, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoState=portTeamInfoState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgTable=vlanCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Configs=layer2Configs, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, layer2Oper=layer2Oper, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanInfo=vlanInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgNewCfgPortTable=stgNewCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, cistRoot=cistRoot, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlan=vlan)
