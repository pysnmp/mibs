...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgTable=portTeamNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, mstCfg=mstCfg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoTable=vlanInfoTable, fdbMacAddr=fdbMacAddr, vlanNewCfgState=vlanNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoHoldTime=stpInfoHoldTime, stpInfoRootCost=stpInfoRootCost, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgIndex=stgNewCfgIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCurCfgState=mstCurCfgState, lacpCurPortState=lacpCurPortState, vlanInfo=vlanInfo, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, layer2Info=layer2Info, lacpInfoPortMoved=lacpInfoPortMoved, fdbSrcPort=fdbSrcPort, fdbRefSps=fdbRefSps, cistInfoPortState=cistInfoPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortTable=stgStatsPortTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoTableEntry=stpInfoTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbTable=fdbTable, stgNewCfgTable=stgNewCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortIndex=lacpInfoPortIndex, cistInfoPortPriority=cistInfoPortPriority, mstCurCfgRegionName=mstCurCfgRegionName, cistInfoPortPathCost=cistInfoPortPathCost, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistRootPathCost=cistRootPathCost, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistGeneralInfo=cistGeneralInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanInfoId=vlanInfoId, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoBwmContract=vlanInfoBwmContract, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstNewCfgState=mstNewCfgState, fdbStats=fdbStats, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgCurCfgStgIndex=stgCurCfgStgIndex, cistInfo=cistInfo, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbEntry=fdbEntry, portTeamCfg=portTeamCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsLookups=fdbStatsLookups, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsOverflows=fdbStatsOverflows, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsCreates=fdbStatsCreates, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstNewCfgStpMode=mstNewCfgStpMode, portTeamInfoState=portTeamInfoState, stpInfoMaxAge=stpInfoMaxAge, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTableEntry=portTeamInfoTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsHiwat=fdbStatsHiwat, fdbVlan=fdbVlan, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamInfo=portTeamInfo, vlanInfoStatus=vlanInfoStatus, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, lacp=lacp, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbStatsCurrent=fdbStatsCurrent, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPriority=stgNewCfgPriority, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoIndex=stpInfoIndex, vlanCurCfgStg=vlanCurCfgStg, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, cistInfoPortRole=cistInfoPortRole, lacpInfo=lacpInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTable=stpInfoTable, layer2Configs=layer2Configs, stpInfoPortLinkType=stpInfoPortLinkType, stgNewCfgAgingTime=stgNewCfgAgingTime, vlan=vlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoLearn=vlanInfoLearn, stpStats=stpStats, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgState=portTeamCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewPortState=lacpNewPortState, stgCurCfgPortTable=stgCurCfgPortTable, fdbLearnedPort=fdbLearnedPort, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortTable=stpInfoPortTable, cistInfoPortTable=cistInfoPortTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbState=fdbState, fdbInfo=fdbInfo, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrPortMirr=mirrPortMirr, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortRole=stpInfoPortRole, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgStgIndex=stgNewCfgStgIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, cistRegionalRoot=cistRegionalRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortEdge=stpInfoPortEdge, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, trunkgroup=trunkgroup, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPriority=stgCurCfgPriority, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFinds=fdbStatsFinds, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistDefaultCfg=mstCistDefaultCfg, vlanInfoPorts=vlanInfoPorts, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbClear=fdbClear, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, cistRoot=cistRoot, stpInfo=stpInfo, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoIndex=portTeamInfoIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortIndex=stgNewCfgPortIndex, cistRootPort=cistRootPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanMaxVlanID=vlanMaxVlanID, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpCurPortCfgTableId=lacpCurPortCfgTableId, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoRootPort=stpInfoRootPort, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoPortState=stpInfoPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstGeneralCfg=mstGeneralCfg)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgState=stgCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCfg=stgCfg, mirroring=mirroring, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgPortLink=stgNewCfgPortLink, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoName=vlanInfoName, mstCistCfg=mstCistCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2=layer2, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoTable=portTeamInfoTable, vlanCurCfgPorts=vlanCurCfgPorts, BridgeId=BridgeId, layer2Stats=layer2Stats, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsFindOrCreates=fdbStatsFindOrCreates)
