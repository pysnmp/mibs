...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurSystemPriority=lacpCurSystemPriority, trunkgroup=trunkgroup, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgState=portTeamCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamInfoState=portTeamInfoState, lacpInfoPortMoved=lacpInfoPortMoved, fdbStatsDeletes=fdbStatsDeletes, vlan=vlan, vlanNewCfgStg=vlanNewCfgStg, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoLearn=vlanInfoLearn, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgTable=stgNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanInfoName=vlanInfoName, portTeamCfg=portTeamCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbRefSps=fdbRefSps, fdbStatsHiwat=fdbStatsHiwat, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewSystemPriority=lacpNewSystemPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistCfg=mstCistCfg, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCfg=stgCfg, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortState=lacpNewPortState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, cistInfoPortState=cistInfoPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortIndex=stpInfoPortIndex, fdbSrcPort=fdbSrcPort, stpInfoRootCost=stpInfoRootCost, portTeamInfo=portTeamInfo, fdbMacAddr=fdbMacAddr, stgNewCfgPortTable=stgNewCfgPortTable, fdbInfo=fdbInfo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbClear=fdbClear, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsOverflows=fdbStatsOverflows, layer2Info=layer2Info, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stpInfoTableEntry=stpInfoTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoPortEdge=stpInfoPortEdge, vlanInfoJumbo=vlanInfoJumbo, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Configs=layer2Configs, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCfg=mstCfg, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgState=stgCurCfgState, portTeamNewCfgState=portTeamNewCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoRootPort=stpInfoRootPort, stpInfoHelloTime=stpInfoHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortState=stpInfoPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, layer2Stats=layer2Stats, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsFindFails=fdbStatsFindFails, mstNewCfgState=mstNewCfgState, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortIndex=cistInfoPortIndex, lacpInfo=lacpInfo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoTopChanges=stpInfoTopChanges, cistRootPathCost=cistRootPathCost, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortLink=stgNewCfgPortLink, stgStatsStpIndex=stgStatsStpIndex, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortTable=stgStatsPortTable, cistRootPort=cistRootPort, lacp=lacp, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortPriority=cistInfoPortPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, mirroring=mirroring, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsFinds=fdbStatsFinds, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCurCfgState=mstCurCfgState, fdbVlan=fdbVlan, lacpInfoPortNtt=lacpInfoPortNtt, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfo=cistInfo, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamInfoIndex=portTeamInfoIndex, BridgeId=BridgeId, PYSNMP_MODULE_ID=layer2, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpStats=stpStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbEntry=fdbEntry, vlanNewCfgLearn=vlanNewCfgLearn, fdbStatsCreates=fdbStatsCreates, vlanInfoStatus=vlanInfoStatus, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stgCurCfgPriority=stgCurCfgPriority, stpInfoIndex=stpInfoIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mirrPortMirr=mirrPortMirr, fdbStats=fdbStats, stgNewCfgState=stgNewCfgState, fdbTable=fdbTable, stgCurCfgTable=stgCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgState=vlanCurCfgState, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTable=portTeamInfoTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortTable=cistInfoPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistBridgeForwardDelay=cistBridgeForwardDelay, layer2=layer2, layer2Oper=layer2Oper)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPriority=stgNewCfgPriority, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfo=stpInfo, fdbSrcTrunk=fdbSrcTrunk, vlanInfoTable=vlanInfoTable, lacpCurPortState=lacpCurPortState, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoTable=stpInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, cistRoot=cistRoot, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoHoldTime=stpInfoHoldTime, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortLinkType=stpInfoPortLinkType, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoId=vlanInfoId, vlanInfoPorts=vlanInfoPorts, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortRole=stpInfoPortRole, vlanInfo=vlanInfo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgTableEntry=stgNewCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstGeneralCfg=mstGeneralCfg)
