...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbTable=fdbTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanInfoPorts=vlanInfoPorts, vlanNewCfgPorts=vlanNewCfgPorts, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, layer2Stats=layer2Stats, stpInfoRootCost=stpInfoRootCost, mstCistCfg=mstCistCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoIndex=stpInfoIndex, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoForwardDelay=stpInfoForwardDelay, fdbStatsCreates=fdbStatsCreates, fdbEntry=fdbEntry, stgCurCfgPortLink=stgCurCfgPortLink, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgState=mstNewCfgState, stgNewCfgIndex=stgNewCfgIndex, stpInfoTopChanges=stpInfoTopChanges, lacpInfoPortTable=lacpInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamInfo=portTeamInfo, lacpInfoPortSelected=lacpInfoPortSelected, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbInfo=fdbInfo, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsDeletes=fdbStatsDeletes, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistGeneralInfo=cistGeneralInfo, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfo=stpInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoName=vlanInfoName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpStats=stpStats, cistRootPathCost=cistRootPathCost, stpInfoPortState=stpInfoPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPriority=stgNewCfgPriority, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgState=stgCurCfgState, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortTable=stgStatsPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgState=stgNewCfgState, stgNewCfgTable=stgNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPriority=stgCurCfgPriority, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, fdbState=fdbState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTable=portTeamInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistInfoPortTable=cistInfoPortTable, vlanInfoStatus=vlanInfoStatus, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortState=lacpNewPortState, fdbLearnedPort=fdbLearnedPort, stpInfoPortTable=stpInfoPortTable, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, BridgeId=BridgeId, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoId=vlanInfoId, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbRefSps=fdbRefSps, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, portTeamNewCfgAddPort=portTeamNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortRole=stpInfoPortRole, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, trunkgroup=trunkgroup, mstNewCfgRegionName=mstNewCfgRegionName, lacpInfoPortMoved=lacpInfoPortMoved, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, layer2Configs=layer2Configs, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamInfoPorts=portTeamInfoPorts, fdbStatsFinds=fdbStatsFinds, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, vlanCurCfgStg=vlanCurCfgStg, fdbMacAddr=fdbMacAddr, fdbStatsLookupFails=fdbStatsLookupFails, mstCfg=mstCfg, fdbVlan=fdbVlan, stgStatsPortIndex=stgStatsPortIndex, cistRoot=cistRoot, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacp=lacp, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsLookups=fdbStatsLookups, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, cistInfoPortIndex=cistInfoPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgIndex=portTeamNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Oper=layer2Oper, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfoPortRole=cistInfoPortRole, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgLearn=vlanNewCfgLearn, vlanInfo=vlanInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Info=layer2Info, lacpInfo=lacpInfo, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, layer2=layer2, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, PYSNMP_MODULE_ID=layer2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamInfoState=portTeamInfoState, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgState=mstCurCfgState, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortIndex=stpInfoPortIndex, cistInfoPortLinkType=cistInfoPortLinkType, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeHelloTime=cistBridgeHelloTime, fdbStatsFindFails=fdbStatsFindFails, stgStatsStpIndex=stgStatsStpIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanInfoTable=vlanInfoTable, stgCfg=stgCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoLearn=vlanInfoLearn, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlan=vlan, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgNewCfgPortPriority=stgNewCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbSrcPort=fdbSrcPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, vlanCurCfgLearn=vlanCurCfgLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurSystemPriority=lacpCurSystemPriority, fdbStatsHiwat=fdbStatsHiwat, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortPriority=cistInfoPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanCurCfgState=vlanCurCfgState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoTrunksState=portTeamInfoTrunksState, cistRegionalRoot=cistRegionalRoot, cistInfoPortState=cistInfoPortState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistRootPort=cistRootPort, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpCurPortState=lacpCurPortState, fdbSrcTrunk=fdbSrcTrunk, stpInfoRootPort=stpInfoRootPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbStats=fdbStats, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTable=stpInfoTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamCfg=portTeamCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgState=portTeamNewCfgState, cistRegionalPathCost=cistRegionalPathCost, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirroring=mirroring, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, cistInfo=cistInfo)
