...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsCreates=fdbStatsCreates, portTeamCurCfgState=portTeamCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoMaxAge=stpInfoMaxAge, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortState=stpInfoPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsCurrent=fdbStatsCurrent, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2Stats=layer2Stats, fdbMacAddr=fdbMacAddr, layer2=layer2, stpInfoPortPathCost=stpInfoPortPathCost, mstCurCfgState=mstCurCfgState, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbTable=fdbTable, fdbSrcTrunk=fdbSrcTrunk, vlanCurCfgTable=vlanCurCfgTable, vlanInfoName=vlanInfoName, vlanInfoLearn=vlanInfoLearn, mirroring=mirroring, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsStpIndex=stgStatsStpIndex, vlanInfo=vlanInfo, vlanInfoPorts=vlanInfoPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgPorts=vlanNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, fdbInfo=fdbInfo, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpCurPortState=lacpCurPortState, cistInfoPortTable=cistInfoPortTable, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, layer2Oper=layer2Oper, mstCfg=mstCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, BridgeId=BridgeId, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortTable=stgStatsPortTable, stpInfoTable=stpInfoTable, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamNewCfgState=portTeamNewCfgState, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurSystemPriority=lacpCurSystemPriority, cistInfoPortPriority=cistInfoPortPriority, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, cistRootPathCost=cistRootPathCost, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, vlanNewCfgState=vlanNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, portTeamInfoPorts=portTeamInfoPorts, fdbVlan=fdbVlan, fdbStats=fdbStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgAddVlan=pmNewCfgAddVlan, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortRole=stpInfoPortRole, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanCurCfgPorts=vlanCurCfgPorts, stpInfoPortTable=stpInfoPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgState=stgCurCfgState, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, mstCistDefaultCfg=mstCistDefaultCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, trunkgroup=trunkgroup, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, fdbSrcPort=fdbSrcPort, fdbRefSps=fdbRefSps, portTeamInfoIndex=portTeamInfoIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTableEntry=portTeamInfoTableEntry, vlan=vlan, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortMoved=lacpInfoPortMoved, fdbLearnedPort=fdbLearnedPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, mstNewCfgState=mstNewCfgState, fdbEntry=fdbEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewPortState=lacpNewPortState, cistRootPort=cistRootPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortState=cistInfoPortState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamInfo=portTeamInfo, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistRegionalRoot=cistRegionalRoot, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsHiwat=fdbStatsHiwat, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistGeneralInfo=cistGeneralInfo, stgCfg=stgCfg, stgStatsPortTableEntry=stgStatsPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, PYSNMP_MODULE_ID=layer2, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCurCfgRegionName=mstCurCfgRegionName, stpInfoIndex=stpInfoIndex, stpInfoRootPort=stpInfoRootPort, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbClear=fdbClear, lacpInfo=lacpInfo, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrPortMirr=mirrPortMirr, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPriority=stgCurCfgPriority, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanCurCfgVlanId=vlanCurCfgVlanId, layer2Info=layer2Info, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortEdge=stpInfoPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistRoot=cistRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, fdbState=fdbState, cistBridgeHelloTime=cistBridgeHelloTime, stpStats=stpStats, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistCfg=mstCistCfg, stpInfo=stpInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortPriority=stgCurCfgPortPriority, layer2Configs=layer2Configs, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgRegionName=mstNewCfgRegionName, cistInfoPortIndex=cistInfoPortIndex, vlanInfoStatus=vlanInfoStatus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanInfoTable=vlanInfoTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfo=cistInfo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookups=fdbStatsLookups, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortLinkType=cistInfoPortLinkType, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortLinkType=stpInfoPortLinkType, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoRootCost=stpInfoRootCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamInfoTrunksState=portTeamInfoTrunksState, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanInfoId=vlanInfoId, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoState=portTeamInfoState, vlanInfoJumbo=vlanInfoJumbo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacp=lacp, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamCfg=portTeamCfg, stgCurCfgTable=stgCurCfgTable, cistBridgeMaxAge=cistBridgeMaxAge)
