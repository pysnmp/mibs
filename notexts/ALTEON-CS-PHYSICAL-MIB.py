...
Counter32, ObjectIdentity, MibIdentifier, NotificationType, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Integer32, Bits, Counter64, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Integer32", "Bits", "Counter64", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, cistGeneralInfo=cistGeneralInfo, mstNewCfgStpMode=mstNewCfgStpMode, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfo=portTeamInfo, pmCurCfgPortMirrState=pmCurCfgPortMirrState, layer2Stats=layer2Stats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, stgNewCfgAddVlan=stgNewCfgAddVlan, lacpInfoPortIndex=lacpInfoPortIndex, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgTable=stgNewCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRoot=cistRoot, fdbVlan=fdbVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistBridgeCfg=mstCistBridgeCfg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkgroup=trunkgroup, portTeamCurCfgPorts=portTeamCurCfgPorts, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfo=vlanInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistRootPathCost=cistRootPathCost, fdbStatsFinds=fdbStatsFinds, layer2Info=layer2Info, stpInfoPortStpIndex=stpInfoPortStpIndex, layer2Configs=layer2Configs, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgVlanBmap=stgCurCfgVlanBmap, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamInfoState=portTeamInfoState, fdbStatsHiwat=fdbStatsHiwat, cistRootPort=cistRootPort, vlanNewCfgJumbo=vlanNewCfgJumbo, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsStpIndex=stgStatsStpIndex, stpInfoRootCost=stpInfoRootCost, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfo=stpInfo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanInfoId=vlanInfoId, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, lacp=lacp, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpCurPortState=lacpCurPortState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mirrPortMirr=mirrPortMirr, vlanInfoJumbo=vlanInfoJumbo, fdbRefSps=fdbRefSps, mstGeneralCfg=mstGeneralCfg, stpInfoPortRole=stpInfoPortRole, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlan=vlan, stgNewCfgPriority=stgNewCfgPriority, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistInfoPortTable=cistInfoPortTable, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stpInfoHelloTime=stpInfoHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, fdbStats=fdbStats, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, layer2Oper=layer2Oper, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbLearnedPort=fdbLearnedPort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, BridgeId=BridgeId, stpStats=stpStats, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, stgStatsPortTable=stgStatsPortTable, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, fdbSrcPort=fdbSrcPort, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgIndex=stgNewCfgIndex, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookups=fdbStatsLookups, stgStatsPortIndex=stgStatsPortIndex, portTeamCfg=portTeamCfg, vlanCurCfgPorts=vlanCurCfgPorts, cistRegionalRoot=cistRegionalRoot, stgCurCfgState=stgCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgState=mstCurCfgState, stpInfoPortTable=stpInfoPortTable, PYSNMP_MODULE_ID=layer2, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirroring=mirroring, stpInfoMaxAge=stpInfoMaxAge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurSystemPriority=lacpCurSystemPriority, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanInfoPorts=vlanInfoPorts, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoTable=portTeamInfoTable, portTeamInfoIndex=portTeamInfoIndex, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanInfoStatus=vlanInfoStatus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, lacpNewPortState=lacpNewPortState, cistInfoPortPathCost=cistInfoPortPathCost, mstCfg=mstCfg, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgLearn=vlanCurCfgLearn, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stpInfoIndex=stpInfoIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCfg=stgCfg, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortState=cistInfoPortState, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPortState=stgCurCfgPortState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, fdbInfo=fdbInfo, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfoBwmContract=vlanInfoBwmContract, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortIndex=cistInfoPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, fdbEntry=fdbEntry, vlanInfoLearn=vlanInfoLearn, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoRootPort=stpInfoRootPort, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, stpInfoTable=stpInfoTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfo=lacpInfo, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbMacAddr=fdbMacAddr, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbSrcTrunk=fdbSrcTrunk, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCfg=mstCistCfg, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistInfoPortRole=cistInfoPortRole, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsOverflows=fdbStatsOverflows, fdbClear=fdbClear, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2=layer2, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgTable=stgCurCfgTable)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortState=stpInfoPortState, lacpNewSystemPriority=lacpNewSystemPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, lacpInfoPortMoved=lacpInfoPortMoved, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortTable=stgCurCfgPortTable, fdbTable=fdbTable, stpInfoPortIndex=stpInfoPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stpInfoTopChanges=stpInfoTopChanges, fdbState=fdbState, cistInfoPortPriority=cistInfoPortPriority, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfo=cistInfo, stgNewCfgPortLink=stgNewCfgPortLink, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgState=vlanNewCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanInfoName=vlanInfoName, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpCurPortCfgTable=lacpCurPortCfgTable, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay)
