...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoPortStpIndex=stpInfoPortStpIndex, portTeamInfoTable=portTeamInfoTable, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoState=portTeamInfoState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstGeneralCfg=mstGeneralCfg, cistRootPort=cistRootPort, layer2Info=layer2Info, cistBridgeHelloTime=cistBridgeHelloTime, stgCurCfgPortIndex=stgCurCfgPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamCurCfgState=portTeamCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistRegionalPathCost=cistRegionalPathCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortTable=cistInfoPortTable, fdbStatsFinds=fdbStatsFinds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgTable=portTeamCurCfgTable, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCfg=mstCfg, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanInfoId=vlanInfoId, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgStatsPortTable=stgStatsPortTable, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgTableEntry=stgCurCfgTableEntry, cistBridgeMaxAge=cistBridgeMaxAge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirrPortMirr=mirrPortMirr, stgCfg=stgCfg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, fdbState=fdbState, stgNewCfgPortTable=stgNewCfgPortTable, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, vlanInfoJumbo=vlanInfoJumbo, layer2Oper=layer2Oper, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstNewCfgState=mstNewCfgState, cistInfoPortState=cistInfoPortState, stgNewCfgTable=stgNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoRootCost=stpInfoRootCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamInfoPorts=portTeamInfoPorts, stpInfoPortTable=stpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgState=vlanCurCfgState, BridgeId=BridgeId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistRegionalRoot=cistRegionalRoot, stpInfoTopChanges=stpInfoTopChanges, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, mstCistCfg=mstCistCfg, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPortState=stgCurCfgPortState, layer2=layer2, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, fdbRefSps=fdbRefSps, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirroring=mirroring, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortCfgTable=lacpCurPortCfgTable, fdbInfo=fdbInfo, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, fdbLearnedPort=fdbLearnedPort, stgNewCfgTableEntry=stgNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistDefaultCfg=mstCistDefaultCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, layer2Stats=layer2Stats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgIndex=stgNewCfgIndex, cistRoot=cistRoot, layer2Configs=layer2Configs, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfo=cistInfo, fdbStats=fdbStats, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPortMirrState=pmNewCfgPortMirrState, fdbTable=fdbTable, vlanInfoName=vlanInfoName, stpInfo=stpInfo, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgStgIndex=stgNewCfgStgIndex, cistRootPathCost=cistRootPathCost, vlanNewCfgState=vlanNewCfgState, stgNewCfgState=stgNewCfgState, stpInfoForwardDelay=stpInfoForwardDelay, mstNewCfgRegionName=mstNewCfgRegionName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTable=stpInfoTable, cistGeneralInfo=cistGeneralInfo, vlanCurCfgLearn=vlanCurCfgLearn, trunkgroup=trunkgroup, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbMacAddr=fdbMacAddr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoHoldTime=stpInfoHoldTime, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stpInfoRootPort=stpInfoRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbSrcPort=fdbSrcPort, portTeamCfg=portTeamCfg, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgState=stgCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgTable=vlanNewCfgTable, stpStats=stpStats, vlanInfoTableEntry=vlanInfoTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanInfoPorts=vlanInfoPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPriority=stgNewCfgPriority, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortIndex=stpInfoPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, vlan=vlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortPriority=cistInfoPortPriority, lacpNewSystemPriority=lacpNewSystemPriority, cistInfoPortPathCost=cistInfoPortPathCost, portTeamNewCfgTable=portTeamNewCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortState=stpInfoPortState, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbVlan=fdbVlan, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortIndex=cistInfoPortIndex, vlanInfo=vlanInfo, fdbStatsLookups=fdbStatsLookups, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsCreates=fdbStatsCreates, stgStatsStpIndex=stgStatsStpIndex, portTeamTableMaxSize=portTeamTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, vlanMaxVlanID=vlanMaxVlanID, vlanInfoStatus=vlanInfoStatus, vlanInfoLearn=vlanInfoLearn, lacpInfoPortNtt=lacpInfoPortNtt, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgPortEdge=stgCurCfgPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacp=lacp, fdbSrcTrunk=fdbSrcTrunk, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbEntry=fdbEntry, stpInfoPortRole=stpInfoPortRole, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCurCfgState=mstCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, vlanMaxEnt=vlanMaxEnt, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgLearn=vlanNewCfgLearn, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpInfo=lacpInfo, fdbStatsDeletes=fdbStatsDeletes, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgTable=vlanCurCfgTable, portTeamInfo=portTeamInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgStg=vlanNewCfgStg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount)
