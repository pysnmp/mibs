...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortNtt=lacpInfoPortNtt, portTeamCfg=portTeamCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlan=vlan, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoStatus=vlanInfoStatus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistInfoPortTable=cistInfoPortTable, stpInfoPortState=stpInfoPortState, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbInfo=fdbInfo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoRootCost=stpInfoRootCost, trunkgroup=trunkgroup, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgState=stgNewCfgState, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgState=vlanNewCfgState, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortState=cistInfoPortState, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsDeletes=fdbStatsDeletes, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanCurCfgState=vlanCurCfgState, fdbStatsCreates=fdbStatsCreates, stpInfoPortEdge=stpInfoPortEdge, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamCurCfgState=portTeamCurCfgState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgState=mstCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgTable=vlanCurCfgTable, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, lacp=lacp, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortLinkType=cistInfoPortLinkType, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTable=stgCurCfgTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgStatsPortTable=stgStatsPortTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, cistRoot=cistRoot, vlanCurCfgJumbo=vlanCurCfgJumbo, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsHiwat=fdbStatsHiwat, fdbStatsFinds=fdbStatsFinds, stpInfoTable=stpInfoTable, layer2Oper=layer2Oper, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoTable=vlanInfoTable, mstNewCfgRegionName=mstNewCfgRegionName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortPriority=cistInfoPortPriority, stpInfoPortRole=stpInfoPortRole, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgDelete=portTeamNewCfgDelete, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRegionalRoot=cistRegionalRoot, vlanInfoLearn=vlanInfoLearn, mirrPortMirr=mirrPortMirr, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistBridgeCfg=mstCistBridgeCfg, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoMaxAge=stpInfoMaxAge, stgNewCfgTable=stgNewCfgTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunks=portTeamInfoTrunks, fdbSrcTrunk=fdbSrcTrunk, layer2Info=layer2Info, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, cistInfoPortRole=cistInfoPortRole, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, portTeamTableMaxSize=portTeamTableMaxSize, portTeamInfoPorts=portTeamInfoPorts, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpCurPortState=lacpCurPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbLearnedPort=fdbLearnedPort, mirroring=mirroring, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgPortLink=stgNewCfgPortLink, mstCurCfgRegionName=mstCurCfgRegionName, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoHelloTime=stpInfoHelloTime, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoForwardDelay=stpInfoForwardDelay, layer2=layer2, fdbMacAddr=fdbMacAddr, stpInfo=stpInfo, portTeamNewCfgAddPort=portTeamNewCfgAddPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfo=lacpInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgState=stgCurCfgState, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbVlan=fdbVlan, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoTopChanges=stpInfoTopChanges, fdbState=fdbState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalPathCost=cistRegionalPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCurCfgPortState=stgCurCfgPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistRootPort=cistRootPort, stgNewCfgPriority=stgNewCfgPriority, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoState=portTeamInfoState, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, fdbRefSps=fdbRefSps, stgStatsPortIndex=stgStatsPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCfg=stgCfg, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfo=portTeamInfo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamInfoIndex=portTeamInfoIndex, fdbStatsOverflows=fdbStatsOverflows, stpInfoIndex=stpInfoIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoRootPort=stpInfoRootPort, fdbEntry=fdbEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoTableEntry=vlanInfoTableEntry, cistBridgeForwardDelay=cistBridgeForwardDelay, cistInfo=cistInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, layer2Configs=layer2Configs, lacpNewPortState=lacpNewPortState, lacpInfoPortTable=lacpInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, stpInfoTableEntry=stpInfoTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfo=vlanInfo, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, PYSNMP_MODULE_ID=layer2, mstCistCfg=mstCistCfg, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, BridgeId=BridgeId, mstGeneralCfg=mstGeneralCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanInfoBwmContract=vlanInfoBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortSelected=lacpInfoPortSelected, stgCurCfgPortPriority=stgCurCfgPortPriority, lacpInfoPortIndex=lacpInfoPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, fdbTable=fdbTable, portTeamInfoPortsState=portTeamInfoPortsState, portTeamCurCfgTable=portTeamCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, cistRootPathCost=cistRootPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbStats=fdbStats, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPriority=stgCurCfgPriority, stpInfoPortPathCost=stpInfoPortPathCost, stgNewCfgTableEntry=stgNewCfgTableEntry, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgPortLink=stgCurCfgPortLink, cistGeneralInfo=cistGeneralInfo, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgStpMode=mstCurCfgStpMode, vlanMaxEnt=vlanMaxEnt, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgState=portTeamNewCfgState, vlanInfoId=vlanInfoId, vlanInfoPorts=vlanInfoPorts, fdbClear=fdbClear, stpInfoHoldTime=stpInfoHoldTime, mstCfg=mstCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsLookups=fdbStatsLookups, fdbStatsFindFails=fdbStatsFindFails, cistInfoPortPathCost=cistInfoPortPathCost, layer2Stats=layer2Stats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanInfoName=vlanInfoName, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stpInfoPortTable=stpInfoPortTable, stpStats=stpStats, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan)
