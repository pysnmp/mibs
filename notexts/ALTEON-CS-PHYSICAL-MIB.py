...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbRefSps=fdbRefSps, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortPathCost=stpInfoPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, cistInfoPortPriority=cistInfoPortPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCfg=stgCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoRootCost=stpInfoRootCost, fdbStatsOverflows=fdbStatsOverflows, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbStatsFinds=fdbStatsFinds, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbVlan=fdbVlan, stgNewCfgTable=stgNewCfgTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanCurCfgStg=vlanCurCfgStg, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstCfg=mstCfg, cistInfoPortTableEntry=cistInfoPortTableEntry, mirroring=mirroring, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgPortLink=stgNewCfgPortLink, fdbStatsLookups=fdbStatsLookups, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stpInfoPortRole=stpInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpStats=stpStats, stgStatsPortTable=stgStatsPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbInfo=fdbInfo, lacpNewPortState=lacpNewPortState, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgStgIndex=stgNewCfgStgIndex, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, cistRoot=cistRoot, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoPortTable=stpInfoPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, cistInfoPortRole=cistInfoPortRole, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, BridgeId=BridgeId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoRootPort=stpInfoRootPort, vlanInfoTable=vlanInfoTable, lacpInfoPortSelected=lacpInfoPortSelected, mstNewCfgStpMode=mstNewCfgStpMode, fdbTable=fdbTable, fdbMacAddr=fdbMacAddr, stpInfoTable=stpInfoTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbStatsHiwat=fdbStatsHiwat, mstCistCfg=mstCistCfg, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfo=cistInfo, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortState=stpInfoPortState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Info=layer2Info, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkgroup=trunkgroup, layer2Stats=layer2Stats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfo=vlanInfo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoTable=portTeamInfoTable, vlanInfoLearn=vlanInfoLearn, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTable=stgCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, portTeamCurCfgState=portTeamCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgState=vlanCurCfgState, vlanNewCfgState=vlanNewCfgState, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoPortsState=portTeamInfoPortsState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, layer2Oper=layer2Oper, cistInfoPortIndex=cistInfoPortIndex, portTeamCfg=portTeamCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacpInfo=lacpInfo, cistInfoPortState=cistInfoPortState, stgNewCfgPortTable=stgNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRegionalRoot=cistRegionalRoot, cistInfoPortTable=cistInfoPortTable, stgCurCfgState=stgCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfo=stpInfo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgState=portTeamNewCfgState, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbStatsCreates=fdbStatsCreates, fdbState=fdbState, stpInfoPortEdge=stpInfoPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamTableMaxSize=portTeamTableMaxSize, mirrPortMirr=mirrPortMirr, lacpCurPortState=lacpCurPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, layer2=layer2, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgNewCfgIndex=stgNewCfgIndex, cistBridgeMaxAge=cistBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoId=vlanInfoId, vlanInfoName=vlanInfoName, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgState=stgNewCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgTable=vlanCurCfgTable, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortState=stgCurCfgPortState, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoTableEntry=vlanInfoTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, vlan=vlan, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgState=mstCurCfgState, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgRegionName=mstNewCfgRegionName, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, layer2Configs=layer2Configs, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgJumbo=vlanNewCfgJumbo, stpInfoIndex=stpInfoIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamInfo=portTeamInfo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsStpIndex=stgStatsStpIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbClear=fdbClear, cistGeneralInfo=cistGeneralInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamInfoState=portTeamInfoState, lacpCurSystemPriority=lacpCurSystemPriority, fdbStats=fdbStats, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoPorts=portTeamInfoPorts, lacp=lacp, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortTableEntry=stpInfoPortTableEntry, cistRootPort=cistRootPort, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsPortIndex=stgStatsPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoTopChanges=stpInfoTopChanges)
