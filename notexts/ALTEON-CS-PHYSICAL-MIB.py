...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpInfo=lacpInfo, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgLearn=vlanCurCfgLearn, portTeamInfoIndex=portTeamInfoIndex, stpInfo=stpInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgDelete=portTeamNewCfgDelete, lacpCurPortState=lacpCurPortState, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoPortState=stpInfoPortState, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRegionalRoot=cistRegionalRoot, stgCurCfgPortLink=stgCurCfgPortLink, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgTable=stgCurCfgTable, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbTable=fdbTable, fdbSrcTrunk=fdbSrcTrunk, stpInfoHelloTime=stpInfoHelloTime, vlanNewCfgDelete=vlanNewCfgDelete, lacpInfoPortTable=lacpInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortState=stgCurCfgPortState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoPortLinkType=stpInfoPortLinkType, fdbClear=fdbClear, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortTable=stgStatsPortTable, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoPortTable=stpInfoPortTable, stgStatsPortIndex=stgStatsPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, layer2Oper=layer2Oper, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbStatsCreates=fdbStatsCreates, vlanNewCfgState=vlanNewCfgState, layer2Configs=layer2Configs, fdbSrcPort=fdbSrcPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbEntry=fdbEntry, portTeamCfg=portTeamCfg, stgCurCfgPriority=stgCurCfgPriority, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, fdbStatsLookupFails=fdbStatsLookupFails, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbLearnedPort=fdbLearnedPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanCurCfgState=vlanCurCfgState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoPorts=vlanInfoPorts, mstNewCfgRegionName=mstNewCfgRegionName, fdbStatsCurrent=fdbStatsCurrent, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortIndex=lacpInfoPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsFindOrCreates=fdbStatsFindOrCreates, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCfg=mstCistCfg, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsHiwat=fdbStatsHiwat, portTeamNewCfgIndex=portTeamNewCfgIndex, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stpInfoRootPort=stpInfoRootPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistInfoPortRole=cistInfoPortRole, vlanInfoName=vlanInfoName, vlanInfoTableEntry=vlanInfoTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfoPorts=portTeamInfoPorts, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookups=fdbStatsLookups, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, fdbMacAddr=fdbMacAddr, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTable=vlanNewCfgTable, cistInfo=cistInfo, fdbVlan=fdbVlan, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamNewCfgState=portTeamNewCfgState, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, fdbState=fdbState, mstCurCfgStpMode=mstCurCfgStpMode, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, PYSNMP_MODULE_ID=layer2, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTable=portTeamInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, lacpInfoPortMoved=lacpInfoPortMoved, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoIndex=stpInfoIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgState=stgCurCfgState, vlanMaxVlanID=vlanMaxVlanID, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, cistRegionalPathCost=cistRegionalPathCost, portTeamInfo=portTeamInfo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgIndex=stgCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, BridgeId=BridgeId, stpInfoPortRole=stpInfoPortRole, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamNewCfgTable=portTeamNewCfgTable, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbRefSps=fdbRefSps, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanInfoStatus=vlanInfoStatus, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, fdbStats=fdbStats, stgCfg=stgCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamInfoPortsState=portTeamInfoPortsState, vlanNewCfgStg=vlanNewCfgStg, trunkgroup=trunkgroup, stpInfoTopChanges=stpInfoTopChanges, lacp=lacp, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoTable=vlanInfoTable, mirrPortMirr=mirrPortMirr, vlanCurCfgJumbo=vlanCurCfgJumbo, cistRootPort=cistRootPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoTableEntry=stpInfoTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, mstCfg=mstCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistRoot=cistRoot, stgNewCfgPriority=stgNewCfgPriority, vlan=vlan, vlanCurCfgStg=vlanCurCfgStg, fdbInfo=fdbInfo, cistBridgeMaxAge=cistBridgeMaxAge, cistGeneralInfo=cistGeneralInfo, portTeamInfoState=portTeamInfoState, cistInfoPortTable=cistInfoPortTable, cistRootPathCost=cistRootPathCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoBwmContract=vlanInfoBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoLearn=vlanInfoLearn, layer2Stats=layer2Stats, vlanInfoId=vlanInfoId)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, layer2=layer2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mirroring=mirroring, mstCurCfgRegionName=mstCurCfgRegionName, vlanMaxEnt=vlanMaxEnt, vlanInfo=vlanInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoTable=stpInfoTable, mstCurCfgState=mstCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgPortLink=stgNewCfgPortLink, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, lacpCurSystemPriority=lacpCurSystemPriority, stpStats=stpStats, stgNewCfgState=stgNewCfgState, stpInfoPortIndex=stpInfoPortIndex, layer2Info=layer2Info, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortState=cistInfoPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, cistInfoPortLinkType=cistInfoPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistInfoPortPriority=cistInfoPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex)
