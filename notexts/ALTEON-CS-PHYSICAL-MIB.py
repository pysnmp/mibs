...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mirroring=mirroring, vlan=vlan, portTeamInfo=portTeamInfo, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgState=stgCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsFinds=fdbStatsFinds, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCfg=mstCfg, cistBridgeHelloTime=cistBridgeHelloTime, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortState=cistInfoPortState, layer2Oper=layer2Oper, lacpNewPortCfgTable=lacpNewPortCfgTable, stpInfoRootPort=stpInfoRootPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCurCfgStpMode=mstCurCfgStpMode, fdbVlan=fdbVlan, stgNewCfgIndex=stgNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, mstGeneralCfg=mstGeneralCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, cistRegionalPathCost=cistRegionalPathCost, vlanCurCfgLearn=vlanCurCfgLearn, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, cistInfoPortPriority=cistInfoPortPriority, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbSrcPort=fdbSrcPort, stgCurCfgPortEdge=stgCurCfgPortEdge, fdbStats=fdbStats, cistRootPort=cistRootPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoIndex=stpInfoIndex, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoPortTable=stpInfoPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgState=mstNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, fdbClear=fdbClear, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stpInfoPortRole=stpInfoPortRole, fdbTable=fdbTable, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoPorts=vlanInfoPorts, fdbStatsCreates=fdbStatsCreates, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpInfoPortSelected=lacpInfoPortSelected, lacpNewPortCfgTableId=lacpNewPortCfgTableId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTable=portTeamInfoTable, cistRoot=cistRoot, fdbStatsCurrent=fdbStatsCurrent, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, pmNewCfgAddVlan=pmNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpNewPortState=lacpNewPortState, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoTable=stpInfoTable, fdbState=fdbState, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacp=lacp, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamCurCfgTrunks=portTeamCurCfgTrunks, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stpInfoPortEdge=stpInfoPortEdge, mstNewCfgStpMode=mstNewCfgStpMode, mstCistBridgeCfg=mstCistBridgeCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpCurPortState=lacpCurPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamCurCfgState=portTeamCurCfgState, stpInfoHoldTime=stpInfoHoldTime, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgTable=portTeamNewCfgTable, portTeamInfoTrunks=portTeamInfoTrunks, vlanInfoJumbo=vlanInfoJumbo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, layer2=layer2, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, trunkgroup=trunkgroup, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgIndex=stgCurCfgIndex, fdbStatsDeletes=fdbStatsDeletes, fdbStatsOverflows=fdbStatsOverflows, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoStatus=vlanInfoStatus, vlanNewCfgState=vlanNewCfgState, stpInfoPortPathCost=stpInfoPortPathCost, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgAddVlan=stgNewCfgAddVlan, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistCfg=mstCistCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, vlanInfoName=vlanInfoName, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, stpStats=stpStats, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stpInfoRootCost=stpInfoRootCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortLink=stgCurCfgPortLink, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortState=stpInfoPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortTable=stgNewCfgPortTable, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistInfoPortTable=cistInfoPortTable, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgCfg=stgCfg, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamCfg=portTeamCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCurCfgRegionName=mstCurCfgRegionName, portTeamCurCfgIndex=portTeamCurCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, fdbRefSps=fdbRefSps, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTableEntry=stpInfoTableEntry, fdbStatsFindFails=fdbStatsFindFails, vlanInfoId=vlanInfoId, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortEdge=stgNewCfgPortEdge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbEntry=fdbEntry, mstNewCfgRegionName=mstNewCfgRegionName, mirrPortMirr=mirrPortMirr, cistGeneralInfo=cistGeneralInfo, vlanNewCfgTable=vlanNewCfgTable, mstCurCfgState=mstCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, portTeamNewCfgState=portTeamNewCfgState, stgStatsPortTable=stgStatsPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgLearn=vlanNewCfgLearn, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoState=portTeamInfoState, stpInfoPortIndex=stpInfoPortIndex, fdbInfo=fdbInfo, BridgeId=BridgeId, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgStg=vlanCurCfgStg, vlanInfo=vlanInfo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsStpIndex=stgStatsStpIndex, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfo=stpInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortTable=stgCurCfgPortTable, lacpInfo=lacpInfo, mstNewCfgRegionVersion=mstNewCfgRegionVersion, fdbMacAddr=fdbMacAddr, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpInfoPortIndex=lacpInfoPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, cistInfo=cistInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoIndex=portTeamInfoIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgVlanId=vlanNewCfgVlanId)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoTable=vlanInfoTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, layer2Info=layer2Info, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, layer2Configs=layer2Configs, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, PYSNMP_MODULE_ID=layer2, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortRole=cistInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsLookups=fdbStatsLookups, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, fdbLearnedPort=fdbLearnedPort, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, layer2Stats=layer2Stats, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay)
