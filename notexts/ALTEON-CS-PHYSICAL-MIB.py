...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamInfoPorts=portTeamInfoPorts, fdbStatsFindOrCreates=fdbStatsFindOrCreates, PYSNMP_MODULE_ID=layer2, mstNewCfgState=mstNewCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoPortTable=stpInfoPortTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, vlanCurCfgVlanId=vlanCurCfgVlanId, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, fdbStatsFindFails=fdbStatsFindFails, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, fdbStatsCreates=fdbStatsCreates, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stgCurCfgAgingTime=stgCurCfgAgingTime, portTeamCurCfgTable=portTeamCurCfgTable, stgStatsPortTable=stgStatsPortTable, stpStats=stpStats, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanInfoJumbo=vlanInfoJumbo, mstCurCfgRegionName=mstCurCfgRegionName, cistRoot=cistRoot, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamInfoTrunksState=portTeamInfoTrunksState, fdbMacAddr=fdbMacAddr, vlanInfoName=vlanInfoName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgTable=stgNewCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTable=stgCurCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, cistInfoPortState=cistInfoPortState, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortIndex=stpInfoPortIndex, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpInfoPortTable=lacpInfoPortTable, stgCfg=stgCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, fdbStatsDeletes=fdbStatsDeletes, fdbEntry=fdbEntry, mstCfg=mstCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanMaxEnt=vlanMaxEnt, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortIndex=stgCurCfgPortIndex, portTeamNewCfgTable=portTeamNewCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stpInfoPortState=stpInfoPortState, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkgroup=trunkgroup, stgCurCfgState=stgCurCfgState, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanMaxVlanID=vlanMaxVlanID, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, lacpInfo=lacpInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoIndex=portTeamInfoIndex, portTeamInfo=portTeamInfo, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortRole=stpInfoPortRole, stgNewCfgPortTable=stgNewCfgPortTable, mirroring=mirroring, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbSrcPort=fdbSrcPort, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbRefSps=fdbRefSps, stpInfoIndex=stpInfoIndex, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanInfoLearn=vlanInfoLearn, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortPathCost=cistInfoPortPathCost, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoTable=vlanInfoTable, cistInfoPortRole=cistInfoPortRole, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, mstGeneralCfg=mstGeneralCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoRootPort=stpInfoRootPort, portTeamInfoTableEntry=portTeamInfoTableEntry, layer2Configs=layer2Configs, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpInfoPortMoved=lacpInfoPortMoved, fdbClear=fdbClear, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoRootCost=stpInfoRootCost, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbVlan=fdbVlan, fdbStatsLookupFails=fdbStatsLookupFails, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, cistRootPathCost=cistRootPathCost, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, BridgeId=BridgeId, portTeamCurCfgState=portTeamCurCfgState, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortState=stgNewCfgPortState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoTopChanges=stpInfoTopChanges, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbLearnedPort=fdbLearnedPort, stpInfoPortStpIndex=stpInfoPortStpIndex, lacp=lacp, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Stats=layer2Stats, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistBridgeCfg=mstCistBridgeCfg, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlan=vlan, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanInfoTableEntry=vlanInfoTableEntry, vlanInfoStatus=vlanInfoStatus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoId=vlanInfoId, stgNewCfgState=stgNewCfgState, cistInfoPortPriority=cistInfoPortPriority, mirrPortMirr=mirrPortMirr, lacpCurPortState=lacpCurPortState, vlanCurCfgLearn=vlanCurCfgLearn, fdbStats=fdbStats, layer2Info=layer2Info, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, portTeamInfoState=portTeamInfoState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgPortTable=mstCistCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgPorts=portTeamCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, fdbStatsLookups=fdbStatsLookups, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamCfg=portTeamCfg, cistRootPort=cistRootPort, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stpInfo=stpInfo, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortIndex=cistInfoPortIndex, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, layer2=layer2, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoPorts=vlanInfoPorts, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgPortTable=stgCurCfgPortTable, mstCistCfg=mstCistCfg, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortIndex=lacpInfoPortIndex, mstCurCfgState=mstCurCfgState, fdbState=fdbState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgState=portTeamNewCfgState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgCurCfgPortPriority=stgCurCfgPortPriority, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfo=cistInfo, vlanCurCfgState=vlanCurCfgState, portTeamInfoTable=portTeamInfoTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, vlanCurCfgTable=vlanCurCfgTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgNewCfgIndex=stgNewCfgIndex, layer2Oper=layer2Oper, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpInfoPortReadyN=lacpInfoPortReadyN, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortTable=cistInfoPortTable, vlanInfo=vlanInfo, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTable=stpInfoTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbStatsOverflows=fdbStatsOverflows, lacpNewPortState=lacpNewPortState, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbInfo=fdbInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoForwardDelay=stpInfoForwardDelay, fdbTable=fdbTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex)
