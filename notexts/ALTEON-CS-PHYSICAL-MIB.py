...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortState=cistInfoPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, lacpNewPortState=lacpNewPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirroring=mirroring, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbStatsLookups=fdbStatsLookups, stpInfoPortTableEntry=stpInfoPortTableEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoHelloTime=stpInfoHelloTime, stpInfoMaxAge=stpInfoMaxAge, stgCfg=stgCfg, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistBridgeCfg=mstCistBridgeCfg, cistGeneralInfo=cistGeneralInfo, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, cistRootPort=cistRootPort, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMirrState=pmCurCfgPortMirrState, layer2Configs=layer2Configs, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortReadyN=lacpInfoPortReadyN, fdbStatsCurrent=fdbStatsCurrent, layer2Oper=layer2Oper, cistRegionalRoot=cistRegionalRoot, stpInfoTableEntry=stpInfoTableEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2=layer2, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, layer2Stats=layer2Stats, vlanCurCfgState=vlanCurCfgState, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgLearn=vlanNewCfgLearn, fdbState=fdbState, stgNewCfgIndex=stgNewCfgIndex, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, fdbEntry=fdbEntry, fdbInfo=fdbInfo, vlanMaxEnt=vlanMaxEnt, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoTable=stpInfoTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoId=vlanInfoId, stgCurCfgTableEntry=stgCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, trunkgroup=trunkgroup, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStats=fdbStats, lacpInfoPortMoved=lacpInfoPortMoved, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortRole=cistInfoPortRole, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanMaxVlanID=vlanMaxVlanID, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgDelete=portTeamNewCfgDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortLinkType=stpInfoPortLinkType, BridgeId=BridgeId, stgStatsPortTable=stgStatsPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfo=cistInfo, vlanNewCfgPorts=vlanNewCfgPorts, cistRootPathCost=cistRootPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoTopChanges=stpInfoTopChanges, cistBridgeForwardDelay=cistBridgeForwardDelay, portTeamCfg=portTeamCfg, stgCurCfgIndex=stgCurCfgIndex, vlanInfoBwmContract=vlanInfoBwmContract, cistInfoPortPathCost=cistInfoPortPathCost, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgTable=vlanNewCfgTable, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortIndex=stpInfoPortIndex, vlanInfoTable=vlanInfoTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamInfoPortsState=portTeamInfoPortsState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbStatsOverflows=fdbStatsOverflows, vlanInfoJumbo=vlanInfoJumbo, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstNewCfgRegionName=mstNewCfgRegionName, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoRootCost=stpInfoRootCost, mirrPortMirr=mirrPortMirr, portTeamInfo=portTeamInfo, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stgCurCfgState=stgCurCfgState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsStpIndex=stgStatsStpIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, lacpInfo=lacpInfo, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, fdbStatsDeletes=fdbStatsDeletes, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgState=portTeamNewCfgState, PYSNMP_MODULE_ID=layer2, layer2Info=layer2Info, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistCfg=mstCistCfg, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortTable=stpInfoPortTable, portTeamCurCfgState=portTeamCurCfgState, vlanInfoName=vlanInfoName, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortTable=stgCurCfgPortTable, portTeamCurCfgTable=portTeamCurCfgTable, vlan=vlan, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbVlan=fdbVlan, mstCfg=mstCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanInfoStatus=vlanInfoStatus, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoDesignatedRoot=stpInfoDesignatedRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoHoldTime=stpInfoHoldTime, mstGeneralCfg=mstGeneralCfg, stgCurCfgPortLink=stgCurCfgPortLink, mstNewCfgState=mstNewCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistBridgeMaxAge=cistBridgeMaxAge, vlanInfoLearn=vlanInfoLearn, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portTeamInfoPorts=portTeamInfoPorts, mstCurCfgRegionName=mstCurCfgRegionName, fdbLearnedPort=fdbLearnedPort, cistInfoPortTable=cistInfoPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoIndex=stpInfoIndex, lacpInfoPortSelected=lacpInfoPortSelected, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortCfgTable=lacpNewPortCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpInfoPortState=stpInfoPortState, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamInfoState=portTeamInfoState, vlanInfoPorts=vlanInfoPorts, vlanInfoTableEntry=vlanInfoTableEntry, fdbClear=fdbClear, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbRefSps=fdbRefSps, stpInfoPortEdge=stpInfoPortEdge, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsFinds=fdbStatsFinds, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsFindFails=fdbStatsFindFails, fdbTable=fdbTable, fdbSrcPort=fdbSrcPort, stpInfoRootPort=stpInfoRootPort, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfo=stpInfo, vlanNewCfgState=vlanNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortRole=stpInfoPortRole, fdbStatsLookupFails=fdbStatsLookupFails, cistRoot=cistRoot, cistInfoPortLinkType=cistInfoPortLinkType, stgStatsPortIndex=stgStatsPortIndex, fdbMacAddr=fdbMacAddr, vlanInfo=vlanInfo, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, lacp=lacp, stpStats=stpStats, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortState=lacpCurPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, lacpCurSystemPriority=lacpCurSystemPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry)
