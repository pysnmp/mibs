...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoTableEntry=portTeamInfoTableEntry, vlanInfoTable=vlanInfoTable, portTeamCurCfgIndex=portTeamCurCfgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamNewCfgState=portTeamNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsPortTable=stgStatsPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbSrcPort=fdbSrcPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfoId=vlanInfoId, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbStatsLookupFails=fdbStatsLookupFails, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoPorts=vlanInfoPorts, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgPortState=stgCurCfgPortState, lacp=lacp, fdbVlan=fdbVlan, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanMaxVlanID=vlanMaxVlanID, stpInfoTable=stpInfoTable, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgState=stgCurCfgState, cistRegionalPathCost=cistRegionalPathCost, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mirroring=mirroring, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, lacpNewPortState=lacpNewPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistInfoPortTableEntry=cistInfoPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistDefaultCfg=mstCistDefaultCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbEntry=fdbEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPriority=stgNewCfgPriority, stgCurCfgIndex=stgCurCfgIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stpInfoPortIndex=stpInfoPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortTable=stgCurCfgPortTable, mirrPortMirr=mirrPortMirr, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTrunksState=portTeamInfoTrunksState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCfg=stgCfg, mstCistCfg=mstCistCfg, vlanNewCfgPorts=vlanNewCfgPorts, lacpNewPortCfgTable=lacpNewPortCfgTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbMacAddr=fdbMacAddr, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgTable=portTeamNewCfgTable, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, fdbStatsOverflows=fdbStatsOverflows, stpInfoHoldTime=stpInfoHoldTime, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgLearn=vlanCurCfgLearn, cistInfoPortState=cistInfoPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanInfoTableEntry=vlanInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, cistBridgeHelloTime=cistBridgeHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, fdbStatsFindFails=fdbStatsFindFails, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamInfoIndex=portTeamInfoIndex, fdbSrcTrunk=fdbSrcTrunk, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortRole=stpInfoPortRole, cistInfoPortRole=cistInfoPortRole, layer2Stats=layer2Stats, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortLinkType=cistInfoPortLinkType, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanInfoStatus=vlanInfoStatus, vlanNewCfgStg=vlanNewCfgStg, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoIndex=stpInfoIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portTeamTableMaxSize=portTeamTableMaxSize, fdbState=fdbState, stpInfoPortState=stpInfoPortState, stgNewCfgTable=stgNewCfgTable, vlanInfo=vlanInfo, lacpInfoPortIndex=lacpInfoPortIndex, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, fdbStats=fdbStats, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, cistRootPathCost=cistRootPathCost, lacpCurSystemPriority=lacpCurSystemPriority, layer2Oper=layer2Oper, stgCurCfgPriority=stgCurCfgPriority, fdbRefSps=fdbRefSps, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoTopChanges=stpInfoTopChanges, portTeamInfo=portTeamInfo, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfoName=vlanInfoName, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoRootPort=stpInfoRootPort, stpInfoRootCost=stpInfoRootCost, vlanNewCfgTable=vlanNewCfgTable, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, cistGeneralInfo=cistGeneralInfo, fdbStatsDeletes=fdbStatsDeletes, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanMaxEnt=vlanMaxEnt, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2=layer2, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, fdbLearnedPort=fdbLearnedPort, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgStatsPortIndex=stgStatsPortIndex, stpStats=stpStats, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, vlan=vlan, stgNewCfgState=stgNewCfgState, cistInfo=cistInfo, portTeamInfoTable=portTeamInfoTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoPortEdge=stpInfoPortEdge, vlanInfoBwmContract=vlanInfoBwmContract, fdbInfo=fdbInfo, stpInfoPortLinkType=stpInfoPortLinkType, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, layer2Configs=layer2Configs, cistInfoPortTable=cistInfoPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstNewCfgState=mstNewCfgState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbTable=fdbTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCfg=mstCfg, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, fdbClear=fdbClear, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistRootPort=cistRootPort, vlanNewCfgState=vlanNewCfgState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, BridgeId=BridgeId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, mstCurCfgStpMode=mstCurCfgStpMode, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCurCfgState=mstCurCfgState, fdbStatsHiwat=fdbStatsHiwat, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortTable=stpInfoPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistRoot=cistRoot, stgNewCfgAgingTime=stgNewCfgAgingTime, mstCurCfgRegionName=mstCurCfgRegionName, vlanInfoLearn=vlanInfoLearn, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfo=lacpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgTable=stgCurCfgTable, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, vlanNewCfgDelete=vlanNewCfgDelete, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamInfoState=portTeamInfoState, cistRegionalRoot=cistRegionalRoot, stgNewCfgVlanBmap=stgNewCfgVlanBmap)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCfg=portTeamCfg, layer2Info=layer2Info, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, cistInfoPortIndex=cistInfoPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsStpIndex=stgStatsStpIndex, fdbStatsCreates=fdbStatsCreates, mstCistCurCfgPortTable=mstCistCurCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewSystemPriority=lacpNewSystemPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsFinds=fdbStatsFinds, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, fdbStatsLookups=fdbStatsLookups, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoJumbo=vlanInfoJumbo, stpInfo=stpInfo, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanCurCfgJumbo=vlanCurCfgJumbo, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, stpInfoTableEntry=stpInfoTableEntry, trunkgroup=trunkgroup)
