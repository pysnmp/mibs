...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgIndex=portTeamCurCfgIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, fdbStats=fdbStats, stgCurCfgPortLink=stgCurCfgPortLink, portTeamCfg=portTeamCfg, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoTable=portTeamInfoTable, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbSrcPort=fdbSrcPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsFinds=fdbStatsFinds, cistInfoPortState=cistInfoPortState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoId=vlanInfoId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbTable=fdbTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, layer2Oper=layer2Oper, cistInfoPortLinkType=cistInfoPortLinkType, cistRootPort=cistRootPort, stgNewCfgState=stgNewCfgState, stgNewCfgPriority=stgNewCfgPriority, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCfg=mstCistCfg, portTeamInfo=portTeamInfo, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, fdbMacAddr=fdbMacAddr, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, cistRootPathCost=cistRootPathCost, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortTable=stgStatsPortTable, fdbEntry=fdbEntry, trunkgroup=trunkgroup, stpInfoIndex=stpInfoIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, mstNewCfgState=mstNewCfgState, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoPortTable=stpInfoPortTable, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgCurCfgPriority=stgCurCfgPriority, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpInfoPortState=stpInfoPortState, fdbRefSps=fdbRefSps, fdbStatsFindFails=fdbStatsFindFails, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortIndex=stpInfoPortIndex, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoState=portTeamInfoState, fdbState=fdbState, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortRole=cistInfoPortRole, mstNewCfgStpMode=mstNewCfgStpMode, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgState=portTeamNewCfgState, cistInfo=cistInfo, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCurCfgState=mstCurCfgState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanInfoLearn=vlanInfoLearn, fdbLearnedPort=fdbLearnedPort, fdbStatsLookups=fdbStatsLookups, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCreates=fdbStatsCreates, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgStg=vlanNewCfgStg, cistRegionalRoot=cistRegionalRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoStatus=vlanInfoStatus, vlanNewCfgDelete=vlanNewCfgDelete, lacpNewPortState=lacpNewPortState, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbClear=fdbClear, stgCurCfgTable=stgCurCfgTable, stpInfoHelloTime=stpInfoHelloTime, portTeamInfoTrunksState=portTeamInfoTrunksState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgNewCfgPortTable=stgNewCfgPortTable, cistInfoPortTable=cistInfoPortTable, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, layer2Configs=layer2Configs, stgNewCfgIndex=stgNewCfgIndex, lacpInfo=lacpInfo, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanNewCfgJumbo=vlanNewCfgJumbo, fdbSrcTrunk=fdbSrcTrunk, lacpInfoPortTable=lacpInfoPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, layer2Stats=layer2Stats, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, BridgeId=BridgeId, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgPortState=stgCurCfgPortState, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortIndex=lacpInfoPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgLearn=vlanCurCfgLearn, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpStats=stpStats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbVlan=fdbVlan, cistInfoPortIndex=cistInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanInfoName=vlanInfoName, cistGeneralInfo=cistGeneralInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, layer2Info=layer2Info, cistRoot=cistRoot, stgStatsStpIndex=stgStatsStpIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanMaxEnt=vlanMaxEnt, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, lacp=lacp, stpInfoPortEdge=stpInfoPortEdge, stpInfoHoldTime=stpInfoHoldTime, vlanInfoTable=vlanInfoTable, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgState=stgCurCfgState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortState=stgNewCfgPortState, stpInfoPortPathCost=stpInfoPortPathCost, vlanInfo=vlanInfo, vlanInfoBwmContract=vlanInfoBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, fdbInfo=fdbInfo, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoPorts=portTeamInfoPorts, layer2=layer2, fdbStatsHiwat=fdbStatsHiwat, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgVlanName=vlanCurCfgVlanName, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, stgCfg=stgCfg, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoIndex=portTeamInfoIndex, stpInfoMaxAge=stpInfoMaxAge, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkGroupCurCfgState=trunkGroupCurCfgState, cistRegionalPathCost=cistRegionalPathCost, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamTableMaxSize=portTeamTableMaxSize, portTeamCurCfgTable=portTeamCurCfgTable, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoTableEntry=stpInfoTableEntry, stpInfo=stpInfo, vlanMaxVlanID=vlanMaxVlanID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoTable=stpInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgPortPriority=stgNewCfgPortPriority, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpCurPortState=lacpCurPortState, cistBridgeHelloTime=cistBridgeHelloTime, mirroring=mirroring, pmNewCfgAddVlan=pmNewCfgAddVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamNewCfgIndex=portTeamNewCfgIndex, fdbStatsDeletes=fdbStatsDeletes, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamInfoPortsState=portTeamInfoPortsState, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoRootCost=stpInfoRootCost, cistInfoPortPathCost=cistInfoPortPathCost, vlan=vlan, vlanCurCfgState=vlanCurCfgState, vlanCurCfgStg=vlanCurCfgStg, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgPortLink=stgNewCfgPortLink, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, lacpNewPortCfgTableId=lacpNewPortCfgTableId, mstCfg=mstCfg, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoRootPort=stpInfoRootPort, vlanNewCfgState=vlanNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanInfoPorts=vlanInfoPorts)
