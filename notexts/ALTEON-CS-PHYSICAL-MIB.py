...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoJumbo=vlanInfoJumbo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, layer2Stats=layer2Stats, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortIndex=stpInfoPortIndex, portTeamInfo=portTeamInfo, stgCurCfgPriority=stgCurCfgPriority, lacpInfo=lacpInfo, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortTable=cistInfoPortTable, fdbStatsOverflows=fdbStatsOverflows, stpInfoTable=stpInfoTable, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgTable=portTeamNewCfgTable, cistInfoPortIndex=cistInfoPortIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortTable=stgNewCfgPortTable, layer2Configs=layer2Configs, lacpCurPortState=lacpCurPortState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgStg=vlanNewCfgStg, portTeamInfoTrunks=portTeamInfoTrunks, vlanCurCfgTable=vlanCurCfgTable, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgTable=stgCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbLearnedPort=fdbLearnedPort, lacp=lacp, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stpStats=stpStats, fdbInfo=fdbInfo, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortLink=stgNewCfgPortLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, portTeamInfoTable=portTeamInfoTable, fdbEntry=fdbEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoTableEntry=stpInfoTableEntry, fdbStatsLookups=fdbStatsLookups, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpInfoPortNtt=lacpInfoPortNtt, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstNewCfgRegionName=mstNewCfgRegionName, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, portTeamCurCfgTable=portTeamCurCfgTable, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, fdbMacAddr=fdbMacAddr, stgStatsStpIndex=stgStatsStpIndex, fdbSrcPort=fdbSrcPort, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, layer2=layer2, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, cistInfoPortRole=cistInfoPortRole, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCurCfgRegionVersion=mstCurCfgRegionVersion, fdbStatsCurrent=fdbStatsCurrent, stgStatsPortTableEntry=stgStatsPortTableEntry, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbTable=fdbTable, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPriority=cistInfoPortPriority, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, mstCurCfgRegionName=mstCurCfgRegionName, PYSNMP_MODULE_ID=layer2, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCfg=stgCfg, fdbStatsLookupFails=fdbStatsLookupFails, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, fdbStatsFindOrCreates=fdbStatsFindOrCreates, lacpInfoPortSelected=lacpInfoPortSelected, stpInfoPortEdge=stpInfoPortEdge, fdbClear=fdbClear, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbVlan=fdbVlan, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCfg=mstCistCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, fdbState=fdbState, stpInfoPortTable=stpInfoPortTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistRoot=cistRoot, vlanNewCfgVlanName=vlanNewCfgVlanName, cistBridgeHelloTime=cistBridgeHelloTime, stgNewCfgTable=stgNewCfgTable, mstCfg=mstCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, cistInfoPortState=cistInfoPortState, fdbStatsCreates=fdbStatsCreates, stpInfo=stpInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, portTeamInfoPorts=portTeamInfoPorts, layer2Info=layer2Info, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoMaxAge=stpInfoMaxAge, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoHoldTime=stpInfoHoldTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFinds=fdbStatsFinds, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgPriority=stgNewCfgPriority, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgCurCfgPortState=stgCurCfgPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, lacpNewPortState=lacpNewPortState, mirroring=mirroring, cistRegionalRoot=cistRegionalRoot, pmNewCfgAddVlan=pmNewCfgAddVlan, vlan=vlan, vlanMaxEnt=vlanMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgNewCfgVlanBmap=stgNewCfgVlanBmap, portTeamNewCfgState=portTeamNewCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, stpInfoForwardDelay=stpInfoForwardDelay, lacpInfoPortMoved=lacpInfoPortMoved, vlanInfoId=vlanInfoId, stpInfoPortState=stpInfoPortState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoRootPort=stpInfoRootPort, portTeamCfg=portTeamCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoState=portTeamInfoState, fdbRefSps=fdbRefSps, mirrPortMirr=mirrPortMirr, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgStgIndex=stgNewCfgStgIndex, cistGeneralInfo=cistGeneralInfo, stgNewCfgState=stgNewCfgState, mstNewCfgState=mstNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoPortLinkType=stpInfoPortLinkType, lacpInfoPortReadyN=lacpInfoPortReadyN, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstGeneralCfg=mstGeneralCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortPathCost=stpInfoPortPathCost, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortTable=mstCistNewCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsHiwat=fdbStatsHiwat, trunkgroup=trunkgroup, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoIndex=stpInfoIndex, vlanInfoTable=vlanInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, portTeamTableMaxSize=portTeamTableMaxSize)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortEdge=stgCurCfgPortEdge, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoStatus=vlanInfoStatus, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, cistInfoPortTableEntry=cistInfoPortTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2Oper=layer2Oper, vlanInfo=vlanInfo, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, BridgeId=BridgeId, portTeamInfoIndex=portTeamInfoIndex, vlanInfoName=vlanInfoName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStats=fdbStats, vlanCurCfgState=vlanCurCfgState, cistInfo=cistInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoLearn=vlanInfoLearn, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistRegionalPathCost=cistRegionalPathCost, vlanInfoPorts=vlanInfoPorts, cistRootPort=cistRootPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stpInfoPortRole=stpInfoPortRole, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay)
