...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbState=fdbState, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoLearn=vlanInfoLearn, vlanMaxVlanID=vlanMaxVlanID, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgStg=vlanCurCfgStg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgLearn=vlanNewCfgLearn, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, cistGeneralInfo=cistGeneralInfo, mirrPortMirr=mirrPortMirr, lacpCurPortState=lacpCurPortState, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbLearnedPort=fdbLearnedPort, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistRegionalPathCost=cistRegionalPathCost, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoRootCost=stpInfoRootCost, vlan=vlan, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, lacpNewPortState=lacpNewPortState, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, mstGeneralCfg=mstGeneralCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgStatsPortIndex=stgStatsPortIndex, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoRootPort=stpInfoRootPort, stgStatsStpIndex=stgStatsStpIndex, vlanInfoPorts=vlanInfoPorts, portTeamInfoTrunks=portTeamInfoTrunks, portTeamCurCfgPorts=portTeamCurCfgPorts, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamCfg=portTeamCfg, stgNewCfgPriority=stgNewCfgPriority, layer2Info=layer2Info, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgPortState=stgNewCfgPortState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStats=fdbStats, portTeamNewCfgState=portTeamNewCfgState, portTeamInfo=portTeamInfo, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgStgIndex=stgCurCfgStgIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortState=cistInfoPortState, stgNewCfgState=stgNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortIndex=stgCurCfgPortIndex, fdbStatsFindFails=fdbStatsFindFails, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoPortState=stpInfoPortState, cistInfoPortRole=cistInfoPortRole, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCurCfgState=mstCurCfgState, portTeamInfoIndex=portTeamInfoIndex, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistBridgeMaxAge=cistBridgeMaxAge, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Oper=layer2Oper, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, cistInfo=cistInfo, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoTable=vlanInfoTable, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoIndex=stpInfoIndex, cistRootPort=cistRootPort, fdbTable=fdbTable, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRoot=cistRoot, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoStatus=vlanInfoStatus, lacpInfo=lacpInfo, lacpNewSystemPriority=lacpNewSystemPriority, stpInfoPortEdge=stpInfoPortEdge, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPriority=stgCurCfgPriority, fdbEntry=fdbEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoMaxAge=stpInfoMaxAge, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortTable=cistInfoPortTable, PYSNMP_MODULE_ID=layer2, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, fdbStatsCreates=fdbStatsCreates, fdbClear=fdbClear, fdbRefSps=fdbRefSps, lacpInfoPortReadyN=lacpInfoPortReadyN, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stpInfoTable=stpInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpInfoPortSelected=lacpInfoPortSelected, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, cistRootPathCost=cistRootPathCost, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfo=stpInfo, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTableEntry=stpInfoTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, stgCurCfgAgingTime=stgCurCfgAgingTime, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanInfoName=vlanInfoName, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkgroup=trunkgroup, lacp=lacp, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortLinkType=stpInfoPortLinkType, portTeamCurCfgState=portTeamCurCfgState, layer2=layer2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortEdge=stgCurCfgPortEdge, cistInfoPortTableEntry=cistInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgTable=vlanNewCfgTable, BridgeId=BridgeId, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgTable=stgCurCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, stpInfoPortRole=stpInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, fdbInfo=fdbInfo, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewPortCfgTable=lacpNewPortCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamInfoState=portTeamInfoState, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stpInfoPortIndex=stpInfoPortIndex, fdbStatsCurrent=fdbStatsCurrent, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortStpIndex=stpInfoPortStpIndex, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgVlanId=vlanNewCfgVlanId, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, lacpInfoPortIndex=lacpInfoPortIndex, portTeamInfoTable=portTeamInfoTable, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, fdbStatsHiwat=fdbStatsHiwat, mstNewCfgRegionName=mstNewCfgRegionName, fdbMacAddr=fdbMacAddr, fdbStatsFinds=fdbStatsFinds, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamNewCfgTrunks=portTeamNewCfgTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanNewCfgState=vlanNewCfgState, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortIndex=cistInfoPortIndex, stgCurCfgIndex=stgCurCfgIndex, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgCfg=stgCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgState=trunkGroupNewCfgState, fdbStatsLookups=fdbStatsLookups, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgPorts=vlanCurCfgPorts, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoTopChanges=stpInfoTopChanges, fdbVlan=fdbVlan, cistRegionalRoot=cistRegionalRoot, cistInfoPortPriority=cistInfoPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, fdbSrcPort=fdbSrcPort, portTeamInfoTrunksState=portTeamInfoTrunksState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgStpMode=mstCurCfgStpMode, fdbStatsDeletes=fdbStatsDeletes, vlanInfoTableEntry=vlanInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, cistInfoPortPathCost=cistInfoPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamNewCfgAddPort=portTeamNewCfgAddPort)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, mstCfg=mstCfg, mirroring=mirroring, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstNewCfgState=mstNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCfg=mstCistCfg, fdbSrcTrunk=fdbSrcTrunk, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, layer2Stats=layer2Stats, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, cistBridgeHelloTime=cistBridgeHelloTime, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, mstNewCfgStpMode=mstNewCfgStpMode, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stpStats=stpStats, vlanInfoId=vlanInfoId, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanInfo=vlanInfo, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, layer2Configs=layer2Configs, pmNewCfgAddVlan=pmNewCfgAddVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFindOrCreates=fdbStatsFindOrCreates, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgStatsPortTable=stgStatsPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName)
