...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgLearn=vlanCurCfgLearn, fdbEntry=fdbEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, BridgeId=BridgeId, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoTable=stpInfoTable, fdbStatsOverflows=fdbStatsOverflows, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkgroup=trunkgroup, portTeamNewCfgPorts=portTeamNewCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlan=vlan, vlanNewCfgState=vlanNewCfgState, stpInfo=stpInfo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamTableMaxSize=portTeamTableMaxSize, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootPort=stpInfoRootPort, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewPortState=lacpNewPortState, stpInfoTopChanges=stpInfoTopChanges, fdbStatsHiwat=fdbStatsHiwat, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgVlanName=vlanCurCfgVlanName, fdbStats=fdbStats, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCfg=stgCfg, stgNewCfgPortState=stgNewCfgPortState, fdbClear=fdbClear, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbMacAddr=fdbMacAddr, stpInfoPortState=stpInfoPortState, portTeamInfoState=portTeamInfoState, fdbInfo=fdbInfo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgTable=stgNewCfgTable, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortIndex=stpInfoPortIndex, stpInfoRootCost=stpInfoRootCost, fdbStatsDeletes=fdbStatsDeletes, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgState=portTeamNewCfgState, cistInfo=cistInfo, stpInfoForwardDelay=stpInfoForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, mstNewCfgStpMode=mstNewCfgStpMode, cistGeneralInfo=cistGeneralInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamInfoTable=portTeamInfoTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewSystemPriority=lacpNewSystemPriority, fdbStatsLookups=fdbStatsLookups, fdbTable=fdbTable, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanNewCfgTable=vlanNewCfgTable, cistInfoPortPriority=cistInfoPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamInfoIndex=portTeamInfoIndex, vlanInfoId=vlanInfoId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpCurPortCfgTable=lacpCurPortCfgTable, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamCfg=portTeamCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistRoot=cistRoot, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgVlanId=vlanNewCfgVlanId, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanInfoTable=vlanInfoTable, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, fdbStatsFinds=fdbStatsFinds, cistInfoPortPathCost=cistInfoPortPathCost, mstCistCfg=mstCistCfg, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanInfoTableEntry=vlanInfoTableEntry, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, fdbRefSps=fdbRefSps, vlanInfoBwmContract=vlanInfoBwmContract, vlanInfoLearn=vlanInfoLearn, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2=layer2, stpInfoPortRole=stpInfoPortRole, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamCurCfgTable=portTeamCurCfgTable, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistInfoPortTable=cistInfoPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoDesignatedRoot=stpInfoDesignatedRoot, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, lacp=lacp, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortPriority=stgNewCfgPortPriority, vlanInfo=vlanInfo, lacpCurPortCfgTableId=lacpCurPortCfgTableId, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbVlan=fdbVlan, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgStatsPortTableEntry=stgStatsPortTableEntry, layer2Oper=layer2Oper, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, stpInfoPortTable=stpInfoPortTable, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstNewCfgRegionName=mstNewCfgRegionName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamInfoTrunksState=portTeamInfoTrunksState, mstGeneralCfg=mstGeneralCfg, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, layer2Info=layer2Info, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortTable=stgStatsPortTable, layer2Stats=layer2Stats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgState=stgNewCfgState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, fdbLearnedPort=fdbLearnedPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstNewCfgState=mstNewCfgState, cistInfoPortRole=cistInfoPortRole, lacpInfo=lacpInfo, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgNewCfgVlanBmap=stgNewCfgVlanBmap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, cistRegionalRoot=cistRegionalRoot, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stpStats=stpStats, fdbSrcTrunk=fdbSrcTrunk, stgCurCfgPortState=stgCurCfgPortState, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCurCfgState=mstCurCfgState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgStpMode=mstCurCfgStpMode, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgState=stgCurCfgState, fdbSrcPort=fdbSrcPort, mirrPortMirr=mirrPortMirr, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, layer2Configs=layer2Configs, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpCurSystemPriority=lacpCurSystemPriority, stpInfoTableEntry=stpInfoTableEntry, cistInfoPortIndex=cistInfoPortIndex, vlanInfoName=vlanInfoName, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanInfoJumbo=vlanInfoJumbo, stgNewCfgAgingTime=stgNewCfgAgingTime, vlanInfoStatus=vlanInfoStatus, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCfg=mstCfg, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbState=fdbState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, fdbStatsFindFails=fdbStatsFindFails, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanMaxEnt=vlanMaxEnt, stgStatsPortIndex=stgStatsPortIndex, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortState=lacpCurPortState, stgNewCfgPriority=stgNewCfgPriority, lacpInfoPortNtt=lacpInfoPortNtt, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, cistRootPathCost=cistRootPathCost, portTeamInfoPortsState=portTeamInfoPortsState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortState=cistInfoPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortLink=stgCurCfgPortLink, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfo=portTeamInfo, portTeamCurCfgState=portTeamCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStatsCreates=fdbStatsCreates, stpInfoPortPathCost=stpInfoPortPathCost, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistRootPort=cistRootPort, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, portTeamInfoTrunks=portTeamInfoTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mirroring=mirroring, stpInfoIndex=stpInfoIndex, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgPortPathCost=stgNewCfgPortPathCost)
