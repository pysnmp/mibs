...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, stgNewCfgPortPathCost=stgNewCfgPortPathCost, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbStatsCurrent=fdbStatsCurrent, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfo=portTeamInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRegionalRoot=cistRegionalRoot, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, vlan=vlan, stgCurCfgPortState=stgCurCfgPortState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsCreates=fdbStatsCreates, lacpInfoPortTableEntry=lacpInfoPortTableEntry, vlanInfoLearn=vlanInfoLearn, vlanCurCfgState=vlanCurCfgState, stpInfoRootPort=stpInfoRootPort, vlanInfoTableEntry=vlanInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, stpInfo=stpInfo, stgCurCfgState=stgCurCfgState, stpInfoTable=stpInfoTable, cistInfoPortIndex=cistInfoPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbTable=fdbTable, layer2Info=layer2Info, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoJumbo=vlanInfoJumbo, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTable=portTeamCurCfgTable, stgCurCfgPriority=stgCurCfgPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, fdbState=fdbState, stgNewCfgPortLink=stgNewCfgPortLink, mirrPortMirr=mirrPortMirr, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, portTeamCurCfgIndex=portTeamCurCfgIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamNewCfgIndex=portTeamNewCfgIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortRole=cistInfoPortRole, stgCfg=stgCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, lacpNewPortState=lacpNewPortState, vlanNewCfgLearn=vlanNewCfgLearn, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoHelloTime=stpInfoHelloTime, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortIndex=stpInfoPortIndex, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfo=vlanInfo, stpInfoTableEntry=stpInfoTableEntry, lacpInfo=lacpInfo, fdbStatsFindOrCreates=fdbStatsFindOrCreates, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stpInfoIndex=stpInfoIndex, cistInfoPortState=cistInfoPortState, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamInfoIndex=portTeamInfoIndex, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCurCfgRegionName=mstCurCfgRegionName, fdbStatsDeletes=fdbStatsDeletes, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanInfoStatus=vlanInfoStatus, fdbStatsOverflows=fdbStatsOverflows, lacp=lacp, vlanNewCfgRemovePort=vlanNewCfgRemovePort, lacpNewSystemPriority=lacpNewSystemPriority, vlanInfoTable=vlanInfoTable, fdbStatsFinds=fdbStatsFinds, lacpInfoPortMoved=lacpInfoPortMoved, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamInfoPortsState=portTeamInfoPortsState, fdbClear=fdbClear, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanMaxVlanID=vlanMaxVlanID, stpInfoRootCost=stpInfoRootCost, vlanInfoPorts=vlanInfoPorts, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgStpMode=mstNewCfgStpMode, stgNewCfgPortPriority=stgNewCfgPortPriority, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbSrcTrunk=fdbSrcTrunk, stpInfoPortPathCost=stpInfoPortPathCost, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portTeamCurCfgState=portTeamCurCfgState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, mstCistCfg=mstCistCfg, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stpInfoTopChanges=stpInfoTopChanges, stpInfoHoldTime=stpInfoHoldTime, vlanNewCfgState=vlanNewCfgState, portTeamTableMaxSize=portTeamTableMaxSize, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgState=stgNewCfgState, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgState=mstNewCfgState, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsStpIndex=stgStatsStpIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanNewCfgVlanId=vlanNewCfgVlanId, BridgeId=BridgeId, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgNewCfgPriority=stgNewCfgPriority, portTeamInfoState=portTeamInfoState, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgAgingTime=stgCurCfgAgingTime, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortPriority=cistInfoPortPriority, fdbInfo=fdbInfo, stgNewCfgVlanBmap=stgNewCfgVlanBmap, fdbLearnedPort=fdbLearnedPort, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbVlan=fdbVlan, portTeamInfoTable=portTeamInfoTable, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortLink=stgCurCfgPortLink, mstGeneralCfg=mstGeneralCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbStats=fdbStats, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgStg=vlanNewCfgStg, stpInfoPortTable=stpInfoPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, trunkgroup=trunkgroup, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, portTeamInfoPorts=portTeamInfoPorts, fdbStatsLookupFails=fdbStatsLookupFails, cistRoot=cistRoot, mirroring=mirroring, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstNewCfgRegionName=mstNewCfgRegionName, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanInfoName=vlanInfoName, stpInfoPortLinkType=stpInfoPortLinkType, cistInfo=cistInfo, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbSrcPort=fdbSrcPort, portTeamCfg=portTeamCfg, cistRootPathCost=cistRootPathCost, portTeamCurCfgPorts=portTeamCurCfgPorts, cistBridgeHelloTime=cistBridgeHelloTime, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgIndex=stgNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRootPort=cistRootPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, lacpInfoPortReadyN=lacpInfoPortReadyN, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgPorts=portTeamNewCfgPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortIndex=lacpInfoPortIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTable=cistInfoPortTable, cistInfoPortLinkType=cistInfoPortLinkType, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbMacAddr=fdbMacAddr, layer2Stats=layer2Stats, fdbRefSps=fdbRefSps, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortState=stpInfoPortState, layer2=layer2, cistGeneralInfo=cistGeneralInfo, vlanCurCfgVlanName=vlanCurCfgVlanName, layer2Configs=layer2Configs, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgDelete=portTeamNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", lacpInfoPortSelected=lacpInfoPortSelected, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgTable=stgNewCfgTable, fdbEntry=fdbEntry, cistRegionalPathCost=cistRegionalPathCost, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, fdbStatsLookups=fdbStatsLookups, vlanCurCfgLearn=vlanCurCfgLearn, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortCfgTableId=lacpCurPortCfgTableId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, portTeamNewCfgTable=portTeamNewCfgTable, stpInfoPortRole=stpInfoPortRole, vlanInfoId=vlanInfoId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, layer2Oper=layer2Oper, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamInfoTableEntry=portTeamInfoTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCfg=mstCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbStatsFindFails=fdbStatsFindFails, stgStatsPortIndex=stgStatsPortIndex, stpStats=stpStats, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurPortState=lacpCurPortState, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus)
