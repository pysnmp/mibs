...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpStats=stpStats, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanInfoTable=vlanInfoTable, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, layer2Oper=layer2Oper, fdbStats=fdbStats, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgNewCfgPortPathCost=stgNewCfgPortPathCost, layer2Info=layer2Info, stpInfoRootPort=stpInfoRootPort, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortTableEntry=cistInfoPortTableEntry, cistInfoPortRole=cistInfoPortRole, vlanInfoPorts=vlanInfoPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbSrcPort=fdbSrcPort, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamCurCfgState=portTeamCurCfgState, stgStatsStpIndex=stgStatsStpIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgNewCfgPortPriority=stgNewCfgPortPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgCfg=stgCfg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpNewPortCfgTable=lacpNewPortCfgTable, fdbStatsOverflows=fdbStatsOverflows, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, portTeamInfoState=portTeamInfoState, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgBwmContract=vlanCurCfgBwmContract, cistInfo=cistInfo, stgNewCfgAgingTime=stgNewCfgAgingTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbState=fdbState, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoPortRole=stpInfoPortRole, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstCistCfg=mstCistCfg, lacpInfoPortNtt=lacpInfoPortNtt, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanInfoName=vlanInfoName, vlanInfoId=vlanInfoId, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stpInfoPortState=stpInfoPortState, stpInfoPortPathCost=stpInfoPortPathCost, cistGeneralInfo=cistGeneralInfo, fdbLearnedPort=fdbLearnedPort, fdbSrcTrunk=fdbSrcTrunk, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsDeletes=fdbStatsDeletes, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stpInfoHelloTime=stpInfoHelloTime, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, portTeamNewCfgDelete=portTeamNewCfgDelete, portTeamInfoPorts=portTeamInfoPorts, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stpInfoRootCost=stpInfoRootCost, vlanMaxEnt=vlanMaxEnt, vlanInfoBwmContract=vlanInfoBwmContract, lacp=lacp, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortState=stgNewCfgPortState, cistRegionalPathCost=cistRegionalPathCost, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortState=cistInfoPortState, stpInfoPortEdge=stpInfoPortEdge, vlanInfoStatus=vlanInfoStatus, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, fdbStatsLookupFails=fdbStatsLookupFails, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpNewPortState=lacpNewPortState, fdbEntry=fdbEntry, stpInfo=stpInfo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsCurrent=fdbStatsCurrent, cistInfoPortTable=cistInfoPortTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, cistBridgeHelloTime=cistBridgeHelloTime, mstNewCfgState=mstNewCfgState, stpInfoTopChanges=stpInfoTopChanges, fdbStatsCreates=fdbStatsCreates, vlanNewCfgStg=vlanNewCfgStg, lacpInfoPortSelected=lacpInfoPortSelected, portTeamInfoIndex=portTeamInfoIndex, mstCfg=mstCfg, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, fdbRefSps=fdbRefSps, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistDefaultCfg=mstCistDefaultCfg, mstNewCfgStpMode=mstNewCfgStpMode, vlanInfo=vlanInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsFindFails=fdbStatsFindFails, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgRegionName=mstCurCfgRegionName, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgIndex=stgCurCfgIndex, mstGeneralCfg=mstGeneralCfg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTable=stpInfoPortTable, cistInfoPortPathCost=cistInfoPortPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPriority=stgCurCfgPriority, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanCurCfgVlanId=vlanCurCfgVlanId, BridgeId=BridgeId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanCurCfgLearn=vlanCurCfgLearn, fdbTable=fdbTable, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, cistRoot=cistRoot, cistBridgeMaxAge=cistBridgeMaxAge, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mirrPortMirr=mirrPortMirr, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoTableEntry=stpInfoTableEntry, layer2Stats=layer2Stats, vlanMaxVlanID=vlanMaxVlanID, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkgroup=trunkgroup, stpInfoTable=stpInfoTable, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbStatsFinds=fdbStatsFinds, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpInfoPortTable=lacpInfoPortTable, stgCurCfgPortPriority=stgCurCfgPortPriority, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, fdbMacAddr=fdbMacAddr, cistRootPort=cistRootPort, cistInfoPortLinkType=cistInfoPortLinkType, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCfg=portTeamCfg, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortIndex=stpInfoPortIndex, layer2=layer2, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoLearn=vlanInfoLearn, vlanCurCfgStg=vlanCurCfgStg, PYSNMP_MODULE_ID=layer2, lacpInfo=lacpInfo, portTeamInfo=portTeamInfo, stgCurCfgState=stgCurCfgState, lacpCurPortState=lacpCurPortState, stgNewCfgPortEdge=stgNewCfgPortEdge, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCurCfgStpMode=mstCurCfgStpMode, fdbVlan=fdbVlan, portTeamInfoTable=portTeamInfoTable, lacpInfoPortMoved=lacpInfoPortMoved, mstCurCfgState=mstCurCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortIndex=stgStatsPortIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, fdbClear=fdbClear, lacpInfoPortIndex=lacpInfoPortIndex, mirroring=mirroring, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbStatsHiwat=fdbStatsHiwat, vlanInfoTableEntry=vlanInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portTeamTableMaxSize=portTeamTableMaxSize, stgNewCfgTable=stgNewCfgTable, layer2Configs=layer2Configs, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, vlan=vlan, vlanCurCfgState=vlanCurCfgState, stgNewCfgPriority=stgNewCfgPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbInfo=fdbInfo, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamInfoPortsState=portTeamInfoPortsState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, cistInfoPortPriority=cistInfoPortPriority, cistRootPathCost=cistRootPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, cistInfoPortIndex=cistInfoPortIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus)
