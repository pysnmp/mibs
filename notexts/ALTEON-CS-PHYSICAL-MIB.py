...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlan=vlan, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfoPortSelected=lacpInfoPortSelected, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, vlanInfo=vlanInfo, portTeamCurCfgTrunks=portTeamCurCfgTrunks, lacpInfo=lacpInfo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, vlanInfoLearn=vlanInfoLearn, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, cistInfoPortRole=cistInfoPortRole, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, fdbStatsLookupFails=fdbStatsLookupFails, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, fdbStatsFinds=fdbStatsFinds, fdbStats=fdbStats, trunkgroup=trunkgroup, portTeamCurCfgIndex=portTeamCurCfgIndex, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stgCurCfgTable=stgCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, mstCistCfg=mstCistCfg, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoTable=portTeamInfoTable, portTeamInfoIndex=portTeamInfoIndex, portTeamInfoTrunks=portTeamInfoTrunks, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortTable=stgNewCfgPortTable, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRootPort=cistRootPort, stpInfoHoldTime=stpInfoHoldTime, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgStatsPortTable=stgStatsPortTable, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, fdbInfo=fdbInfo, cistBridgeForwardDelay=cistBridgeForwardDelay, cistRegionalRoot=cistRegionalRoot, lacpCurPortCfgTable=lacpCurPortCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirroring=mirroring, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortPriority=stgNewCfgPortPriority, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, cistRootPathCost=cistRootPathCost, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stgNewCfgStgIndex=stgNewCfgStgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfoState=portTeamInfoState, lacpCurPortCfgTableId=lacpCurPortCfgTableId, fdbStatsHiwat=fdbStatsHiwat, vlanInfoJumbo=vlanInfoJumbo, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortPriority=cistInfoPortPriority, stgNewCfgIndex=stgNewCfgIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, stpInfoForwardDelay=stpInfoForwardDelay, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamInfo=portTeamInfo, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpCurPortState=lacpCurPortState, fdbState=fdbState, stgCfg=stgCfg, portTeamNewCfgTable=portTeamNewCfgTable, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, fdbRefSps=fdbRefSps, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoTopChanges=stpInfoTopChanges, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPriority=stgCurCfgPriority, PYSNMP_MODULE_ID=layer2, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, fdbLearnedPort=fdbLearnedPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgState=mstCurCfgState, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortEdge=stpInfoPortEdge, vlanMaxVlanID=vlanMaxVlanID, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamCurCfgState=portTeamCurCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpInfoPortIndex=stpInfoPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoPortTableEntry=stpInfoPortTableEntry, layer2Stats=layer2Stats, mirrPortMirr=mirrPortMirr, vlanCurCfgStg=vlanCurCfgStg, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgAgingTime=stgNewCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portTeamNewCfgState=portTeamNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanInfoTable=vlanInfoTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgState=vlanCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgPortPriority=stgCurCfgPortPriority, vlanNewCfgVlanName=vlanNewCfgVlanName, cistBridgeHelloTime=cistBridgeHelloTime, fdbSrcPort=fdbSrcPort, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, fdbMacAddr=fdbMacAddr, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mstCistNewCfgPortTable=mstCistNewCfgPortTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stpStats=stpStats, lacpNewPortState=lacpNewPortState, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanInfoStatus=vlanInfoStatus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortState=cistInfoPortState, portTeamInfoPortsState=portTeamInfoPortsState, lacpInfoPortTableEntry=lacpInfoPortTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, fdbTable=fdbTable, lacpInfoPortMoved=lacpInfoPortMoved, mstGeneralCfg=mstGeneralCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsDeletes=fdbStatsDeletes, mstCfg=mstCfg, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgPortEdge=stgNewCfgPortEdge, fdbVlan=fdbVlan, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, layer2Oper=layer2Oper, vlanCurCfgVlanName=vlanCurCfgVlanName, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstCistCurCfgPortTable=mstCistCurCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, layer2Configs=layer2Configs, BridgeId=BridgeId, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, vlanInfoName=vlanInfoName, cistRegionalPathCost=cistRegionalPathCost, vlanInfoTableEntry=vlanInfoTableEntry, layer2=layer2, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistRoot=cistRoot, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, cistInfoPortTable=cistInfoPortTable, layer2Info=layer2Info, lacpNewSystemPriority=lacpNewSystemPriority, fdbEntry=fdbEntry, portTeamInfoTableEntry=portTeamInfoTableEntry, stpInfoIndex=stpInfoIndex, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortIndex=cistInfoPortIndex, stpInfo=stpInfo, mstCurCfgRegionName=mstCurCfgRegionName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPortLink=stgCurCfgPortLink, lacp=lacp, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, portTeamTableMaxSize=portTeamTableMaxSize, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, portTeamCfg=portTeamCfg, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stpInfoPortState=stpInfoPortState, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoId=vlanInfoId, vlanNewCfgStg=vlanNewCfgStg, stpInfoTable=stpInfoTable, lacpInfoPortIndex=lacpInfoPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stgNewCfgPortIndex=stgNewCfgPortIndex, stpInfoRootCost=stpInfoRootCost, vlanInfoBwmContract=vlanInfoBwmContract, vlanCurCfgPorts=vlanCurCfgPorts)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoMaxAge=stpInfoMaxAge, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, stpInfoPortTable=stpInfoPortTable, portTeamInfoPorts=portTeamInfoPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, mstNewCfgRegionName=mstNewCfgRegionName, mstNewCfgState=mstNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbClear=fdbClear, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsOverflows=fdbStatsOverflows, stpInfoPortStpIndex=stpInfoPortStpIndex, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, stpInfoPortRole=stpInfoPortRole, cistInfo=cistInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgState=stgNewCfgState, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, stpInfoRootPort=stpInfoRootPort, cistBridgeMaxAge=cistBridgeMaxAge, mstCistBridgeCfg=mstCistBridgeCfg, cistGeneralInfo=cistGeneralInfo, mstCurCfgRegionVersion=mstCurCfgRegionVersion)
