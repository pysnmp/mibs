...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCfg=portTeamCfg, portTeamCurCfgTable=portTeamCurCfgTable, lacpCurPortCfgTable=lacpCurPortCfgTable, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, fdbStats=fdbStats, fdbStatsFinds=fdbStatsFinds, cistRegionalPathCost=cistRegionalPathCost, PYSNMP_MODULE_ID=layer2, stgNewCfgPortEdge=stgNewCfgPortEdge, vlanCurCfgState=vlanCurCfgState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stpInfoHoldTime=stpInfoHoldTime, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortPriority=stgCurCfgPortPriority, stgNewCfgPortState=stgNewCfgPortState, fdbInfo=fdbInfo, vlanNewCfgPorts=vlanNewCfgPorts, trunkgroup=trunkgroup, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, cistRegionalRoot=cistRegionalRoot, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stgCurCfgPortEdge=stgCurCfgPortEdge, stgNewCfgAddVlan=stgNewCfgAddVlan, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portTeamCurCfgPorts=portTeamCurCfgPorts, cistGeneralInfo=cistGeneralInfo, mstCurCfgState=mstCurCfgState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbState=fdbState, stpInfoDesignatedRoot=stpInfoDesignatedRoot, vlanInfoTable=vlanInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanInfoId=vlanInfoId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgState=stgCurCfgState, portTeamNewCfgPorts=portTeamNewCfgPorts, fdbStatsLookups=fdbStatsLookups, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stpInfoForwardDelay=stpInfoForwardDelay, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpCurPortState=lacpCurPortState, layer2Configs=layer2Configs, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoPorts=vlanInfoPorts, stgCurCfgPortPathCost=stgCurCfgPortPathCost, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsHiwat=fdbStatsHiwat, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, vlanNewCfgStg=vlanNewCfgStg, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mirroring=mirroring, portTeamNewCfgState=portTeamNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfo=vlanInfo, fdbStatsOverflows=fdbStatsOverflows, mstCistCfg=mstCistCfg, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgState=vlanNewCfgState, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgNewCfgPortTable=stgNewCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, layer2=layer2, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, cistInfoPortIndex=cistInfoPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mirrPortMirr=mirrPortMirr, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, cistInfoPortTable=cistInfoPortTable, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, vlanInfoBwmContract=vlanInfoBwmContract, portTeamInfoTable=portTeamInfoTable, layer2Info=layer2Info, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, vlanCurCfgLearn=vlanCurCfgLearn, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, stgCfg=stgCfg, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortNtt=lacpInfoPortNtt, portTeamInfoPorts=portTeamInfoPorts, BridgeId=BridgeId, cistRootPathCost=cistRootPathCost, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistNewCfgPortTable=mstCistNewCfgPortTable, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsCurrent=fdbStatsCurrent, vlanMaxEnt=vlanMaxEnt, fdbLearnedPort=fdbLearnedPort, mstNewCfgState=mstNewCfgState, mstCistDefaultCfg=mstCistDefaultCfg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgNewCfgPortIndex=stgNewCfgPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, fdbRefSps=fdbRefSps, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortEdge=stpInfoPortEdge, lacpNewPortState=lacpNewPortState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, fdbStatsDeletes=fdbStatsDeletes, portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcPort=fdbSrcPort, stgStatsStpIndex=stgStatsStpIndex, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgPorts=vlanCurCfgPorts, portTeamCurCfgState=portTeamCurCfgState, vlanInfoStatus=vlanInfoStatus, vlanCurCfgStg=vlanCurCfgStg, portTeamInfoState=portTeamInfoState, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoPortRole=stpInfoPortRole, mstNewCfgRegionName=mstNewCfgRegionName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, vlanInfoTableEntry=vlanInfoTableEntry, fdbVlan=fdbVlan, lacp=lacp, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistBridgeHelloTime=cistBridgeHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgState=stgNewCfgState, cistBridgeMaxAge=cistBridgeMaxAge, vlan=vlan, stpInfoIndex=stpInfoIndex, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortPathCost=stgNewCfgPortPathCost, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamNewCfgDelete=portTeamNewCfgDelete, layer2Stats=layer2Stats, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstGeneralCfg=mstGeneralCfg, portTeamInfo=portTeamInfo, stpInfoTableEntry=stpInfoTableEntry, stpInfoTopChanges=stpInfoTopChanges, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbClear=fdbClear, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, layer2Oper=layer2Oper, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, fdbMacAddr=fdbMacAddr, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpNewSystemPriority=lacpNewSystemPriority, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstCistCurCfgPortTable=mstCistCurCfgPortTable, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoRootPort=stpInfoRootPort, stpInfoPortState=stpInfoPortState, portTeamInfoIndex=portTeamInfoIndex, cistInfoPortState=cistInfoPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfo=lacpInfo, vlanNewCfgLearn=vlanNewCfgLearn, mstCfg=mstCfg, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoTable=stpInfoTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stpInfo=stpInfo, fdbTable=fdbTable, stpInfoPortIndex=stpInfoPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, stpStats=stpStats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpInfoPortTable=lacpInfoPortTable, vlanInfoLearn=vlanInfoLearn, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portTeamTableMaxSize=portTeamTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTable=stgCurCfgPortTable, mstCurCfgStpMode=mstCurCfgStpMode, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, lacpInfoPortReadyN=lacpInfoPortReadyN, portTeamInfoTrunks=portTeamInfoTrunks, fdbEntry=fdbEntry, stgStatsPortTable=stgStatsPortTable, vlanNewCfgDelete=vlanNewCfgDelete)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRootPort=cistRootPort, lacpInfoPortIndex=lacpInfoPortIndex, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, cistInfoPortPriority=cistInfoPortPriority, stgCurCfgPortLink=stgCurCfgPortLink, vlanInfoName=vlanInfoName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, stpInfoPortTableEntry=stpInfoPortTableEntry, stpInfoPortTable=stpInfoPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, cistInfo=cistInfo, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stpInfoHelloTime=stpInfoHelloTime, stgCurCfgStgIndex=stgCurCfgStgIndex, stpInfoPortLinkType=stpInfoPortLinkType, stpInfoPortStpIndex=stpInfoPortStpIndex, stgCurCfgVlanBmap=stgCurCfgVlanBmap, cistInfoPortRole=cistInfoPortRole, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPriority=stgNewCfgPriority)
