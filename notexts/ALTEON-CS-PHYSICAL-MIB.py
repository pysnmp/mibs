...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPortsState=portTeamInfoPortsState, fdbSrcTrunk=fdbSrcTrunk, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistInfoPortLinkType=cistInfoPortLinkType, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgPorts=vlanNewCfgPorts, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoHelloTime=stpInfoHelloTime, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsOverflows=fdbStatsOverflows, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortTableEntry=stgStatsPortTableEntry, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanInfoPorts=vlanInfoPorts, layer2Info=layer2Info, stgNewCfgPortEdge=stgNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgNewCfgVlanBmap=stgNewCfgVlanBmap, cistRegionalRoot=cistRegionalRoot, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stpInfoPortTable=stpInfoPortTable, vlanCurCfgPorts=vlanCurCfgPorts, lacpInfoPortTable=lacpInfoPortTable, vlanInfoLearn=vlanInfoLearn, mstGeneralCfg=mstGeneralCfg, fdbStatsFindFails=fdbStatsFindFails, stgCurCfgTable=stgCurCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrPortMirr=mirrPortMirr, portTeamInfoPorts=portTeamInfoPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpCurSystemPriority=lacpCurSystemPriority, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, cistRoot=cistRoot, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgStatsPortIndex=stgStatsPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistRootPathCost=cistRootPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgNewCfgState=stgNewCfgState, stgNewCfgPortState=stgNewCfgPortState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, mstNewCfgRegionName=mstNewCfgRegionName, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgAgingTime=stgCurCfgAgingTime, layer2=layer2, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpInfoPortReadyN=lacpInfoPortReadyN, stpInfoPortLinkType=stpInfoPortLinkType, fdbSrcPort=fdbSrcPort, cistRootPort=cistRootPort, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTable=stpInfoTable, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanNewCfgRemovePort=vlanNewCfgRemovePort, fdbStatsLookups=fdbStatsLookups, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCurCfgState=mstCurCfgState, fdbVlan=fdbVlan, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRegionalPathCost=cistRegionalPathCost, stgStatsPortTable=stgStatsPortTable, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, lacpInfoPortNtt=lacpInfoPortNtt, stpInfoPortEdge=stpInfoPortEdge, cistInfoPortRole=cistInfoPortRole, stpInfoTableEntry=stpInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, vlanInfoJumbo=vlanInfoJumbo, vlanCurCfgTable=vlanCurCfgTable, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgAddPort=vlanNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, layer2Stats=layer2Stats, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCfg=mstCistCfg, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCurCfgPriority=stgCurCfgPriority, cistGeneralInfo=cistGeneralInfo, stgNewCfgPortPriority=stgNewCfgPortPriority, BridgeId=BridgeId, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamNewCfgState=portTeamNewCfgState, stpInfoIndex=stpInfoIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, fdbRefSps=fdbRefSps, portTeamInfoTable=portTeamInfoTable, fdbStatsCreates=fdbStatsCreates, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbState=fdbState, portTeamInfoState=portTeamInfoState, lacpNewSystemPriority=lacpNewSystemPriority, stpInfo=stpInfo, vlanInfoBwmContract=vlanInfoBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoId=vlanInfoId, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgIndex=portTeamNewCfgIndex, stpInfoHoldTime=stpInfoHoldTime, stpStats=stpStats, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortPathCost=stpInfoPortPathCost, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistBridgeHelloTime=cistBridgeHelloTime, portTeamNewCfgDelete=portTeamNewCfgDelete, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, fdbMacAddr=fdbMacAddr, lacpCurPortCfgTableId=lacpCurPortCfgTableId, layer2Configs=layer2Configs, vlanMaxVlanID=vlanMaxVlanID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mstNewCfgRegionVersion=mstNewCfgRegionVersion, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamTableMaxSize=portTeamTableMaxSize, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, vlanNewCfgJumbo=vlanNewCfgJumbo, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vlanInfoTable=vlanInfoTable, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortState=lacpNewPortState, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistDefaultCfg=mstCistDefaultCfg, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, cistInfo=cistInfo, portTeamInfoIndex=portTeamInfoIndex, stpInfoRootPort=stpInfoRootPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, portTeamCurCfgTable=portTeamCurCfgTable, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfoPortPriority=cistInfoPortPriority, portTeamCfg=portTeamCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgTable=stgNewCfgTable, PYSNMP_MODULE_ID=layer2, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, portTeamNewCfgTable=portTeamNewCfgTable, vlanInfoTableEntry=vlanInfoTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, portTeamInfoTrunks=portTeamInfoTrunks, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbEntry=fdbEntry, cistBridgeMaxAge=cistBridgeMaxAge, mstCurCfgStpMode=mstCurCfgStpMode, fdbInfo=fdbInfo, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbTable=fdbTable, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortState=cistInfoPortState, vlanInfoName=vlanInfoName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stpInfoPortStpIndex=stpInfoPortStpIndex, vlanNewCfgState=vlanNewCfgState, fdbStatsLookupFails=fdbStatsLookupFails, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, fdbClear=fdbClear, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, mstNewCfgState=mstNewCfgState, stgStatsStpIndex=stgStatsStpIndex, mirroring=mirroring, fdbStatsHiwat=fdbStatsHiwat, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stpInfoPortRole=stpInfoPortRole, vlanCurCfgState=vlanCurCfgState, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoTopChanges=stpInfoTopChanges, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, lacpCurPortState=lacpCurPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortLink=stgNewCfgPortLink, stgCurCfgTableEntry=stgCurCfgTableEntry, fdbStats=fdbStats, vlan=vlan, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, portTeamCurCfgTrunks=portTeamCurCfgTrunks, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortState=stpInfoPortState, vlanInfo=vlanInfo, layer2Oper=layer2Oper, mstCurCfgRegionName=mstCurCfgRegionName, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCurCfgRegionVersion=mstCurCfgRegionVersion, trunkgroup=trunkgroup, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoRootCost=stpInfoRootCost, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgIndex=portTeamCurCfgIndex, stpInfoMaxAge=stpInfoMaxAge, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, cistInfoPortIndex=cistInfoPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mstCfg=mstCfg, lacpInfoPortIndex=lacpInfoPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanMaxEnt=vlanMaxEnt, vlanInfoStatus=vlanInfoStatus, lacp=lacp, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, fdbStatsCurrent=fdbStatsCurrent, stpInfoPortIndex=stpInfoPortIndex, stgCfg=stgCfg, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbLearnedPort=fdbLearnedPort, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpInfo=lacpInfo, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamInfo=portTeamInfo, portTeamInfoTableEntry=portTeamInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
